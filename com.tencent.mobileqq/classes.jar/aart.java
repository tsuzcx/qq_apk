...
public class aart
{
  ...
  public aart(BaseChatPie paramBaseChatPie)
  {
  ...
  public aasj a()
  {
    return this.jdField_a_of_type_Aasj;
  }
  ...
  public void a()
  {
    if ((this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel != null) && (this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel.a()))
    {
      ...
      amuf.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "GiftPanel_flower", false);
    }
  }
  
  public void a(int paramInt)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioPlusPanel == null) || (paramInt != this.jdField_a_of_type_ComTencentMobileqqActivityAioPlusPanel.a) || (this.jdField_a_of_type_Aasj == null)) {
      return;
    }
    long l1 = System.currentTimeMillis();
    long l2 = this.jdField_a_of_type_Aasj.jdField_a_of_type_Long;
    if ((this.jdField_a_of_type_Aasj.jdField_a_of_type_Boolean) && (l1 >= this.jdField_a_of_type_Aasj.jdField_a_of_type_Long) && (l1 <= l2 + 2592000000L) && (!((bfst)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(113)).a())) {}
    for (paramInt = 1;; paramInt = 0)
    {
      ...
      {
        bcst.b(null, "dc00899", "Grp_flower", "", "aio_mall", "exp_plus", 0, 0, str2, str1, "0", "" + muc.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a));
        return;
      }
    }
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Aasj != null))
    {
  ...
  public void a(boolean paramBoolean, int paramInt)
  {
    ...
    amuf.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "GiftPanel_flower", true);
    ...
    {
      label175:
      this.jdField_a_of_type_Aasj = aasj.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext, i, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.b);
      label219:
      label233:
      Object localObject2;
      if (this.jdField_a_of_type_Aasj != null)
      {
        this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel.setGiftData(this.jdField_a_of_type_Aasj, true);
        a(paramInt, i);
        this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel.b(paramInt);
        if (this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel == null) {
          break label615;
        }
        paramBoolean = njo.a().a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a);
      ...
      for (localObject1 = "#878B99";; localObject1 = "#000000")
      {
        ...
        return;
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof ahzo))
        {
        ...
        if (!(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aift)) {
          break;
        }
