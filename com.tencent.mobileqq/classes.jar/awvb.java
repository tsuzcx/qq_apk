...
public class awvb
{
  public static final String g = anvx.a(2131713394);
  ...
  public awvb(Context paramContext, QQAppInterface paramQQAppInterface)
  {
  ...
  private void a()
  {
    AbsShareMsg localAbsShareMsg = new bdnr(StructMsgForGeneralShare.class).c(114).a(this.b).e(this.jdField_a_of_type_JavaLangString).a();
    localAbsShareMsg.mSourceName = this.e;
    localAbsShareMsg.mSourceAction = "web";
    localAbsShareMsg.mSourceUrl = this.f;
    Object localObject = bdoe.a(2);
    ((bdnv)localObject).a(this.d, this.b, this.c);
  ...
  {
    if (!a()) {
      QQToast.a(this.jdField_a_of_type_AndroidContentContext, anvx.a(2131713395), 0).a();
    }
    do
    {
      for (;;)
      {
        ...
        {
          awvc localawvc = new awvc(this);
          paramOnDismissListener = new awvd(this, paramOnDismissListener);
          ...
          this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder.setItemClickListener(localawvc);
