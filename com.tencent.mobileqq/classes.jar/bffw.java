...
{
  private anyz jdField_a_of_type_Anyz = new bffx(this);
  private bfgd jdField_a_of_type_Bfgd;
  ...
  private void a(MessageRecord paramMessageRecord, TroopAioKeywordTipInfo paramTroopAioKeywordTipInfo)
  {
    ...
    this.jdField_d_of_type_Int = this.jdField_a_of_type_Afqz.a(paramMessageRecord.uniseq);
    if (this.jdField_a_of_type_Bfgd == null)
    {
      this.jdField_a_of_type_Bfgd = new bfgd(this);
      this.jdField_a_of_type_Bfgd.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560629, null));
      this.jdField_a_of_type_Bfgd.jdField_a_of_type_AndroidViewViewGroup.setOnClickListener(this);
      this.jdField_a_of_type_Bfgd.jdField_a_of_type_ComTencentWidgetURLThemeImageView = ((URLThemeImageView)this.jdField_a_of_type_Bfgd.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131379393));
      this.jdField_a_of_type_Bfgd.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_Bfgd.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131379396));
      this.jdField_a_of_type_Bfgd.b = ((TextView)this.jdField_a_of_type_Bfgd.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131379395));
      this.jdField_a_of_type_Bfgd.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_Bfgd.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131379392));
      this.jdField_a_of_type_Bfgd.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130850744);
    }
    this.jdField_a_of_type_Bfgd.jdField_a_of_type_AndroidViewViewGroup.setBackgroundResource(2130843939);
    for (;;)
    {
      try
      {
        ...
        this.jdField_a_of_type_Bfgd.jdField_a_of_type_ComTencentWidgetURLThemeImageView.setImageDrawable((Drawable)localObject1);
        if (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipInfo.title))
        {
          this.jdField_a_of_type_Bfgd.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
          if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipInfo.summary)) {
            break label689;
          }
          this.jdField_a_of_type_Bfgd.b.setVisibility(8);
          if (this.jdField_a_of_type_AndroidWidgetRelativeLayout.indexOfChild(this.jdField_a_of_type_Bfgd.jdField_a_of_type_AndroidViewViewGroup) < 0)
          {
            ...
            this.jdField_a_of_type_AndroidWidgetRelativeLayout.addView(this.jdField_a_of_type_Bfgd.jdField_a_of_type_AndroidViewViewGroup, (ViewGroup.LayoutParams)localObject1);
          }
          localObject1 = (RelativeLayout.LayoutParams)this.jdField_a_of_type_Bfgd.jdField_a_of_type_AndroidViewViewGroup.getLayoutParams();
          int i = bfyo.a(this.jdField_a_of_type_AndroidWidgetRelativeLayout, new int[] { 2131379581, 2131374261, 2131374375, 2131374370 });
          if (i > 0) {
            ((RelativeLayout.LayoutParams)localObject1).addRule(3, i);
          }
          this.jdField_a_of_type_Bfgd.jdField_a_of_type_AndroidViewViewGroup.setVisibility(0);
          localObject1 = new TranslateAnimation(2, 1.0F, 2, 0.0F, 2, 0.0F, 2, 0.0F);
          ((Animation)localObject1).setDuration(500L);
          this.jdField_b_of_type_Boolean = true;
          ((Animation)localObject1).setAnimationListener(new bffy(this));
          if (this.jdField_a_of_type_Bfgd.jdField_a_of_type_AndroidViewViewGroup.getAnimation() == null) {
            this.jdField_a_of_type_Bfgd.jdField_a_of_type_AndroidViewViewGroup.startAnimation((Animation)localObject1);
          }
          localObject2 = new bdlf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_AIO").c("notice_center_new");
          if (!paramMessageRecord.isSend()) {
            break label720;
          }
          localObject1 = "exp_keyword_input";
          ((bdlf)localObject2).d((String)localObject1).a(new String[] { paramMessageRecord.frienduin, String.valueOf(paramTroopAioKeywordTipInfo.ruleId), paramMessageRecord.getExtInfoFromExtStr("key_aio_keyword") }).a();
          return;
        }
      }
      ...
      this.jdField_a_of_type_Bfgd.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
      this.jdField_a_of_type_Bfgd.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipInfo.title);
      continue;
      label689:
      this.jdField_a_of_type_Bfgd.b.setVisibility(0);
      this.jdField_a_of_type_Bfgd.b.setText(this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipInfo.summary);
      continue;
      label720:
  ...
  private boolean a(MessageRecord paramMessageRecord)
  {
    ...
    return a(this.jdField_a_of_type_Afqz.b(paramMessageRecord.uniseq));
  }
  
  private void b(boolean paramBoolean)
  {
    if ((!this.jdField_a_of_type_Boolean) || (this.jdField_a_of_type_Bfgd == null) || (!this.jdField_b_of_type_Boolean) || (this.jdField_a_of_type_AndroidWidgetRelativeLayout.indexOfChild(this.jdField_a_of_type_Bfgd.jdField_a_of_type_AndroidViewViewGroup) < 0)) {}
    ...
    do
    {
      ...
      localTranslateAnimation.setAnimationListener(new bffz(this, paramBoolean));
    } while (this.jdField_a_of_type_Bfgd.jdField_a_of_type_AndroidViewViewGroup.getAnimation() != null);
    this.jdField_a_of_type_Bfgd.jdField_a_of_type_AndroidViewViewGroup.startAnimation(localTranslateAnimation);
  }
  ...
  private boolean b()
  {
    ...
    do
    {
      ...
      return false;
      if ((this.jdField_a_of_type_Bfgl == null) || (!this.jdField_a_of_type_Bfgl.g())) {
        break label129;
      }
    } while (!QLog.isColorLevel());
  ...
  {
    if (this.jdField_a_of_type_Bfgd != null) {
      return this.jdField_a_of_type_Bfgd.jdField_a_of_type_AndroidViewViewGroup;
    }
    return null;
  }
  ...
  protected void d()
  {
    ...
    if ((this.jdField_a_of_type_AndroidWidgetRelativeLayout != null) && (this.jdField_a_of_type_Bfgd != null) && (this.jdField_a_of_type_AndroidWidgetRelativeLayout.indexOfChild(this.jdField_a_of_type_Bfgd.jdField_a_of_type_AndroidViewViewGroup) >= 0))
    {
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.removeView(this.jdField_a_of_type_Bfgd.jdField_a_of_type_AndroidViewViewGroup);
      this.jdField_a_of_type_Bfgd = null;
    }
  ...
  public void e()
  {
    ...
    {
      return;
      i = this.jdField_a_of_type_Afqz.a().size();
      if (i != this.e) {
        break;
      }
    } while (!QLog.isColorLevel());
  ...
  public void f()
  {
    ...
    this.jdField_d_of_type_Int = this.jdField_a_of_type_Afqz.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.uniseq);
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = ((String)localObject1).replace("$TEXT$", bhcu.encodeToString(((MessageForText)this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord).sb.toString().getBytes(), 0));
        localObject2 = localObject1;
        if (this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipInfo.url.contains("$KEYWORD$")) {
          localObject2 = ((String)localObject1).replace("$KEYWORD$", bhcu.encodeToString(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.getExtInfoFromExtStr("key_aio_keyword").getBytes(), 0));
        }
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.isSend())
      {
        ...
        ((bdlf)localObject2).d((String)localObject1).a(new String[] { this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.frienduin, String.valueOf(this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipInfo.ruleId), this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.getExtInfoFromExtStr("key_aio_keyword") }).a();
        b(true);
        break;
        ...
        localObject1 = ((String)localObject1).replace("$TEXT$", bhcu.encodeToString(((AbsShareMsg)((MessageForStructing)localObject2).structingMsg).mContentTitle.getBytes(), 0));
        continue;
        if (!((String)localObject2).startsWith("mqqapi")) {
          continue;
        }
        localObject1 = bhey.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, (String)localObject2);
