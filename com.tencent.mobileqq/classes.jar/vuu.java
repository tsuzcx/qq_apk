  ...
  extends vuq
{
  ...
  private void a(DecodeConfig paramDecodeConfig, avza paramavza, int paramInt)
  {
    if (paramInt != 0)
    {
      paramavza.h = paramInt;
      paramavza.g = 0;
    }
    paramInt = Math.min(paramavza.jdField_a_of_type_Int, paramavza.b);
    int i = Math.max(paramavza.jdField_a_of_type_Int, paramavza.b);
    paramavza.jdField_a_of_type_Int = paramInt;
    paramavza.b = i;
    paramDecodeConfig.width = paramavza.jdField_a_of_type_Int;
    paramDecodeConfig.height = paramavza.b;
  }
  
  private boolean a(vun paramvun)
  {
    if (paramvun.jdField_b_of_type_Boolean) {}
    while (!paramvun.c) {
      return false;
    }
    return true;
  ...
  public void a(vun paramvun)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("VideoToVideo", 2, "[runLocalVideo2Video]run begin, taskid:" + paramvun.jdField_b_of_type_Long + " run:" + paramvun.d);
    }
    if (a(paramvun))
    {
      vei.a("actVideo2VideoResult", new String[] { "9" });
      a(9, paramvun.jdField_a_of_type_JavaLangString, null, null, paramvun.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramvun);
      return;
    }
    ...
    localObject1 = null;
    Object localObject2 = new File(paramvun.jdField_a_of_type_JavaLangString);
    ...
    if (vyf.e((String)localObject1))
    {
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "before,getPCMFromFile[Have audio File]:  " + paramvun.jdField_b_of_type_Long + " audioPath: " + (String)localObject1 + " audioFileSize=" + apvd.a((String)localObject1));
      }
      localObject2 = new vyc();
      l1 = System.currentTimeMillis();
      ((vyc)localObject2).a(paramvun.jdField_a_of_type_JavaLangString, paramvun.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo);
      l2 = System.currentTimeMillis();
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "run,getMetaDataFromFile:  " + paramvun.jdField_b_of_type_Long + " cost=" + (l2 - l1) + " ms audioTrack: " + paramvun.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Boolean + " mSampleRate: " + paramvun.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_c_of_type_Int);
      }
    }
    for (;;)
    {
      ...
      localLocalMediaInfo.path = paramvun.jdField_a_of_type_JavaLangString;
      localLocalMediaInfo.mDuration = paramvun.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Long;
      l1 = System.currentTimeMillis();
      bool = ((vyc)localObject2).a(localLocalMediaInfo, 0, (int)paramvun.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Long, (String)localObject1, paramvun.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo);
      l2 = System.currentTimeMillis();
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "run,getPCMFromFile:  " + paramvun.jdField_b_of_type_Long + " cost=" + (l2 - l1) + " ms audioTrack: " + paramvun.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Boolean);
      }
      if (paramvun.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Boolean)
      {
        if ((!bool) || (!vyf.e((String)localObject1)))
        {
          if (QLog.isColorLevel()) {
            QLog.d("VideoToVideo", 2, "run,getPCMFromFile: failed " + paramvun.jdField_b_of_type_Long + " path=" + (String)localObject1 + " success=" + bool);
          }
          vyf.g((String)localObject1);
          vei.a("actVideo2VideoResult", new String[] { "8" });
          a(8, paramvun.jdField_a_of_type_JavaLangString, null, null, paramvun.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramvun);
        }
      }
      else
      {
        vyf.g((String)localObject1);
        vyc.a((String)localObject1, (int)paramvun.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Long);
        if (!vyf.e((String)localObject1))
        {
          if (QLog.isColorLevel()) {
            QLog.d("VideoToVideo", 2, "run[video convert],createSilentPCMFile: failed " + paramvun.jdField_b_of_type_Long + " path=" + (String)localObject1);
          }
          vei.a("actVideo2VideoResult", new String[] { "8" });
          a(8, paramvun.jdField_a_of_type_JavaLangString, null, null, paramvun.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramvun);
          return;
      ...
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "After,getPCMFromFile: hasAudioTrack= " + paramvun.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Boolean + " path=" + (String)localObject1 + " success=" + bool + " audioFileSize=" + apvd.a((String)localObject1));
      }
    }
    paramvun.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_c_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
    if (a(paramvun))
    {
      vei.a("actVideo2VideoResult", new String[] { "9" });
      a(9, paramvun.jdField_a_of_type_JavaLangString, null, null, paramvun.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramvun);
    ...
    boolean bool = a(paramvun.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramvun);
    ...
    vei.a("actVideo2VideoTime", new String[] { l3 - l4 + "" });
    if ((bool) && (apvd.a(this.jdField_a_of_type_JavaLangString)))
    {
      l3 = apvd.a(this.jdField_a_of_type_JavaLangString);
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "runLocalVideo2Video, file exist, size:" + l3 + " file:" + this.jdField_a_of_type_JavaLangString);
      }
      this.jdField_a_of_type_Int = 0;
      vei.a("actVideo2VideoResult", new String[] { "0" });
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "runLocalVideo2Video, taskid:" + paramvun.jdField_b_of_type_Long + " run:" + paramvun.d + " cost:" + (l2 - l1) + " ms successVideo:" + bool);
      }
      if (!paramvun.d) {
        break;
      }
      a(this.jdField_a_of_type_Int, paramvun.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString, null, paramvun.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramvun);
      return;
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "runLocalVideo2Video, [failed]file not exist:" + paramvun.jdField_b_of_type_Long + " file:" + this.jdField_a_of_type_JavaLangString);
      }
      this.jdField_a_of_type_Int = 7;
      vei.a("actVideo2VideoResult", new String[] { "7" });
      vyf.g(this.jdField_a_of_type_JavaLangString);
    }
  }
  
  /* Error */
  public boolean a(SlideItemInfo arg1, vun paramvun)
  {
    // Byte code:
    //   0: aload_1
    //   1: ifnull +10 -> 11
    ...
    //   33: new 291	bkxx
    //   36: dup
    //   37: invokespecial 292	bkxx:<init>	()V
    //   40: putfield 294	vuu:jdField_a_of_type_Bkxx	Lbkxx;
    ...
    //   165: invokevirtual 325	vuu:a	(Lcom/tencent/mobileqq/activity/photo/LocalMediaInfo;)I
    //   168: istore 5
    //   170: new 22	avza
    //   173: dup
    //   174: aload 13
    ...
    //   194: invokespecial 333	avza:<init>	(Ljava/lang/String;IIIIZI)V
    //   197: astore 14
    //   199: aload 14
    //   201: sipush 720
    //   204: putfield 31	avza:jdField_a_of_type_Int	I
    //   207: aload 14
    //   209: sipush 1280
    //   212: putfield 34	avza:b	I
    //   215: aload_1
    ...
    //   292: sipush 720
    //   295: sipush 1280
    //   298: invokestatic 339	vzu:a	(IIII)Z
    //   301: ifeq +9 -> 310
    //   304: aload 14
    //   306: iconst_1
    //   307: putfield 340	avza:c	Z
    ...
    //   340: aload 14
    //   342: iload 5
    //   344: invokespecial 345	vuu:a	(Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;Lavza;I)V
    //   347: aload 15
    //   349: iconst_1
    ...
    //   372: invokevirtual 64	vuu:a	(Lcom/tencent/mobileqq/activity/photo/LocalMediaInfo;)Z
    ...
    //   488: aload_0
    //   489: getfield 294	vuu:jdField_a_of_type_Bkxx	Lbkxx;
    //   492: aload 15
    //   494: aload 14
    //   496: new 370	vuv
    //   499: dup
    //   500: aload_0
    //   501: aload_2
    //   502: invokespecial 373	vuv:<init>	(Lvuu;Lvun;)V
    //   505: aconst_null
    //   506: invokevirtual 376	bkxx:a	(Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;Lavza;Lavzm;Lbkxy;)V
    //   509: aload_0
    //   510: getfield 17	vuu:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   513: astore_1
    //   514: aload_1
    //   515: monitorenter
    ...
    //   538: aload_2
    //   539: getfield 57	vun:jdField_b_of_type_Boolean	Z
    ...
    //   564: aload_2
    //   565: getfield 383	vun:jdField_a_of_type_Boolean	Z
    ...
    //   577: aload_2
    //   578: getfield 57	vun:jdField_b_of_type_Boolean	Z
    //   581: ifne +84 -> 665
    //   584: aload_2
    //   585: getfield 60	vun:c	Z
    //   588: ifne +77 -> 665
    //   591: aload_2
    //   592: getfield 383	vun:jdField_a_of_type_Boolean	Z
    //   595: istore 6
    //   597: iload 6
    //   599: ifne +66 -> 665
    //   602: aload_0
    //   603: getfield 17	vuu:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    ...
    //   667: aload_0
    //   668: aload_2
    //   669: invokespecial 391	vuu:a	(Lvun;)Z
    //   672: istore 7
    //   674: iload 7
    //   676: istore 6
  ...
  public void b(vun paramvun)
  {
    ...
    {
      paramvun.jdField_b_of_type_Boolean = true;
