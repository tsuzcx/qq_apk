  ...
  extends vut
{
  ...
  private bjqq a(int paramInt1, int paramInt2)
  {
    boolean bool1;
    switch (paramInt1)
    {
    ...
    {
      return new bjqs().a(false).e(bool1).f(bool2).g(true).h(true).j(true).b(false).k(true).d(false).c(2).a();
      return new bjqs().a(true).f(false).g(true).h(true).j(true).b(true).k(false).d(false).c(2).a();
      bool1 = false;
      break;
    }
  }
  
  public void a(vuv paramvuv)
  {
    if (QLog.isColorLevel()) {
      QLog.i("VideoMerger", 2, "start combine");
    }
    if (paramvuv.jdField_a_of_type_JavaUtilList == null) {}
    for (;;)
    {
      return;
      Object localObject2 = new way();
      Object localObject1 = new ArrayList(paramvuv.jdField_a_of_type_JavaUtilList.size());
      Object localObject5 = new ArrayList(paramvuv.jdField_a_of_type_JavaUtilList.size());
      Object localObject3 = (vuj)QQStoryContext.a().getBusinessHandler(1);
      Object localObject6 = new ArrayList();
      Object localObject4 = paramvuv.jdField_a_of_type_JavaUtilList.iterator();
      Object localObject7;
      Object localObject8;
      for (boolean bool1 = false; ((Iterator)localObject4).hasNext(); bool1 = bool2)
      {
        localObject7 = (SlideItemInfo)((Iterator)localObject4).next();
        localObject8 = ((vuj)localObject3).a(((SlideItemInfo)localObject7).jdField_b_of_type_JavaLangString);
        bool2 = bool1;
      ...
      if (a(paramvuv))
      {
        a(9, "", null, null, null, paramvuv);
        return;
      }
      if (this.jdField_a_of_type_AndroidMediaMediaFormat == null) {
        if (((vuj)localObject3).a() != null)
        {
          this.jdField_a_of_type_AndroidMediaMediaFormat = ((vuj)localObject3).a();
          if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        if (paramvuv.jdField_a_of_type_Vuw != null) {
          paramvuv.jdField_a_of_type_Vuw.a(bool1);
        }
        localObject4 = vuf.a();
        ...
        {
          this.jdField_a_of_type_AndroidMediaMediaFormat = vum.a((String)((List)localObject1).get(0));
          if (QLog.isColorLevel()) {
        ...
        if (this.jdField_a_of_type_AndroidMediaMediaFormat == null)
        {
          this.jdField_a_of_type_AndroidMediaMediaFormat = vum.a();
          if (QLog.isColorLevel())
          {
      ...
      label770:
      for (boolean bool2 = ((way)localObject2).a((List)localObject6, (String)localObject3);; bool2 = true)
      {
        label627:
      ...
      if (bool2)
      {
        ...
        bool2 = ((way)localObject2).a((List)localObject1, (String)localObject4, 720, 1280, this.jdField_a_of_type_AndroidMediaMediaFormat);
        ...
        ((LocalMediaInfo)localObject5).mTransferPosList = ((way)localObject2).b((List)localObject1, (String)localObject4);
        localObject2 = agmi.a(BaseApplicationImpl.getContext());
      }
      try
      {
        ((agmi)localObject2).b((LocalMediaInfo)localObject5);
        if (bool2)
        {
          l1 = System.currentTimeMillis();
          l2 = this.jdField_a_of_type_Long;
          vel.a("actAlbumTime", new String[] { l1 - l2 + "", paramvuv.jdField_a_of_type_JavaUtilList.size() + "" });
          ...
          if (bool1)
          {
            ...
            localObject1 = null;
            localObject2 = paramvuv.jdField_a_of_type_AndroidAppActivity.getIntent();
            if (localObject2 != null) {
              localObject1 = bizv.a((Intent)localObject2);
            }
            localObject2 = localObject1;
            if (localObject1 == null) {
              localObject2 = new Bundle();
            }
            localObject3 = paramvuv.jdField_a_of_type_AndroidAppActivity.getIntent().getExtras();
            localObject1 = localObject3;
            if (localObject3 == null) {
              localObject1 = new Bundle();
            }
            localObject3 = paramvuv.jdField_a_of_type_AndroidAppActivity.getIntent();
            ...
            localObject7 = a(vuc.a().a(), i);
            j = ((Bundle)localObject1).getInt("qq_sub_business_id", 1);
            localObject3 = new bjqm(((Bundle)localObject1).getInt("edit_video_type", 10002), i, j);
            ((bjqm)localObject3).a((bjqq)localObject7);
            ((bjqm)localObject3).a(2);
            ...
            ((Bundle)localObject1).putInt("extra_slide_entrance", paramvuv.jdField_a_of_type_Int);
            ((Bundle)localObject1).putInt("extra_slide_sticker_id", paramvuv.jdField_b_of_type_Int);
            ((Bundle)localObject1).putString("extra_slide_sticker_str", paramvuv.jdField_a_of_type_JavaLangString);
            if (paramvuv.jdField_a_of_type_JavaUtilList.size() > 0)
            {
              ((Bundle)localObject1).putString("extra_transiton_default", ((SlideItemInfo)paramvuv.jdField_a_of_type_JavaUtilList.get(0)).e);
              if (QLog.isColorLevel()) {
                QLog.d("VideoMerger", 2, "doMerge mTransId=" + ((SlideItemInfo)paramvuv.jdField_a_of_type_JavaUtilList.get(0)).e);
              }
              if (((SlideItemInfo)paramvuv.jdField_a_of_type_JavaUtilList.get(0)).jdField_a_of_type_Sqb != null)
              {
                ((Bundle)localObject1).putInt("extra_ablum_type", ((SlideItemInfo)paramvuv.jdField_a_of_type_JavaUtilList.get(0)).jdField_a_of_type_Sqb.jdField_a_of_type_Int);
                if (QLog.isColorLevel()) {
                  QLog.d("VideoMerger", 2, "doMerge mAlbumType=" + ((SlideItemInfo)paramvuv.jdField_a_of_type_JavaUtilList.get(0)).jdField_a_of_type_Sqb.jdField_a_of_type_Int);
                }
              }
              localObject7 = vtz.a(paramvuv.jdField_a_of_type_AndroidAppActivity).a(((SlideItemInfo)paramvuv.jdField_a_of_type_JavaUtilList.get(0)).e);
              if ((localObject7 != null) && (((List)localObject7).size() > 0))
              {
                localObject7 = ((QIMMusicConfigManager)bjae.a(2)).a(((vua)((List)localObject7).get(0)).jdField_a_of_type_Int, ((vua)((List)localObject7).get(0)).jdField_b_of_type_Int);
            ...
            paramvuv.jdField_a_of_type_AndroidOsHandler.post(new VideoMerger.1(this, paramvuv, (CameraCaptureView.VideoCaptureResult)localObject6, (LocalMediaInfo)localObject5, (bjqm)localObject3, (Bundle)localObject2, (Bundle)localObject1));
            localObject1 = paramvuv.jdField_a_of_type_JavaUtilList.iterator();
            i = 0;
            ...
            break label917;
            label1934:
            ((LocalMediaInfo)localObject5).mTransferPosList = ((way)localObject2).b((List)localObject1);
          }
        }
      }
      catch (Throwable localThrowable2)
      {
        ...
        for (;;)
        {
          ...
          continue;
          int k = paramvuv.jdField_a_of_type_JavaUtilList.size();
          if (this.jdField_a_of_type_Boolean)
          {
            j = 0;
            vel.a("video_edit_slides", "suc_compose", j, 0, new String[] { "", paramvuv.jdField_a_of_type_JavaUtilList.size() + "", k - i + "", i + "" });
            vel.a("actAlbumResult", new String[] { "0" });
            if (!bihg.z)
            {
              bihg.z = true;
              i = 0;
              if (bihg.jdField_a_of_type_Long != -1L) {
                i = (int)(System.currentTimeMillis() - bihg.jdField_a_of_type_Long);
              }
            }
          }
          for (;;)
          {
            try
            {
              l1 = awaf.a((String)localObject4);
              vel.a("time_shoot", 10002, i, new String[] { String.valueOf(2), String.valueOf(l1), "", "" });
              if (paramvuv.jdField_a_of_type_Vuw != null) {
                paramvuv.jdField_a_of_type_Vuw.j();
              }
              if (!QLog.isColorLevel()) {
                break;
              }
            ...
            paramvuv.jdField_a_of_type_AndroidOsHandler.post(new VideoMerger.2(this, paramvuv));
          }
        }
      }
    }
