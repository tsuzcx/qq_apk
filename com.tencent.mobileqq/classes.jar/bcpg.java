  ...
  implements Manager
{
  ...
  protected Handler a;
  protected ArrayMap<Long, ArrayList<bcpf>> a;
  protected AppInterface a;
  protected String a;
  public WeakReference<bcpp> a;
  protected ArrayList<String> a;
  protected HashMap<Long, MessageForUniteGrayTip> a;
  protected List<bcpq> a;
  public boolean a;
  protected ArrayMap<Long, ArrayList<bcpf>> b;
  public String b;
  ...
  public bcpg(AppInterface paramAppInterface)
  {
    ...
    this.jdField_c_of_type_JavaUtilList.add(alud.a(2131716153));
    this.jdField_d_of_type_JavaUtilList.add(alud.a(2131716139));
  ...
  private void a(QQAppInterface paramQQAppInterface)
  {
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (this.jdField_a_of_type_JavaUtilArrayList == null)
      {
        ...
        this.jdField_a_of_type_JavaUtilArrayList = bclg.a(paramQQAppInterface);
        if (this.jdField_a_of_type_JavaUtilArrayList == null) {
  ...
  public static void a(MessageRecord paramMessageRecord)
  {
    ...
    {
      Object localObject = bdix.d.matcher(paramMessageRecord.msg);
  ...
  private void a(MessageRecord paramMessageRecord, String paramString1, String paramString2, String paramString3)
  {
    ...
    b(Long.parseLong(paramMessageRecord.frienduin), Long.parseLong(paramString1), paramString3, new bcpl(this, paramString3));
  }
  ...
  private void a(String paramString)
  {
    ...
    bdne.c(localQQAppInterface.getApplication(), localQQAppInterface.c(), paramString, false);
  }
  ...
  {
    azqs.b(null, "dc00899", "Grp_robot", "", paramString1, paramString2, 0, 0, paramString3, paramString4, paramString5, paramString6);
  }
  ...
  public static boolean a(TextView paramTextView, MessageRecord paramMessageRecord)
  {
    ...
    if (!TextUtils.isEmpty(str1))
    {
      ...
      String str2 = alud.a(2131716141);
      SpannableString localSpannableString = new SpannableString(str2);
      localSpannableString.setSpan(new bcpi(str1, paramMessageRecord), 0, str2.length(), 33);
  ...
  public static String b(MessageRecord paramMessageRecord)
  {
    if (b(paramMessageRecord))
    {
      ...
      if ((!TextUtils.isEmpty(str)) && (!TextUtils.isEmpty(paramMessageRecord))) {
        return paramMessageRecord + alud.a(2131716149);
      }
    }
    return null;
  }
  ...
  private void b()
  {
    if ((this.jdField_a_of_type_Altm != null) || (this.jdField_a_of_type_ComTencentCommonAppAppInterface == null) || (!(this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof QQAppInterface))) {
      return;
    }
    this.jdField_a_of_type_Altm = new bcpj(this);
  ...
  private void c()
  {
    if ((this.jdField_a_of_type_Altm != null) && (this.jdField_a_of_type_ComTencentCommonAppAppInterface != null))
    {
  ...
  private void d()
  {
    Object localObject1 = bdne.f(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin());
    if (!TextUtils.isEmpty((CharSequence)localObject1)) {
      try
      {
        ...
        localObject2 = bdne.g(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin());
      }
    ...
    try
    {
      ...
      if (localObject2 != null) {
        a(((aowb)localObject2).a(), ((aowb)localObject2).a());
      }
      return;
    }
  ...
  public bcpe a(long paramLong)
  {
    bcpe localbcpe = new bcpe();
    localbcpe.jdField_a_of_type_JavaUtilArrayList = a(paramLong);
    localbcpe.b = b(paramLong);
    localbcpe.jdField_a_of_type_Int = a(paramLong);
    return localbcpe;
  }
  ...
  public ArrayList<bcpf> a(long paramLong)
  {
    ...
    if (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap != null) {
      synchronized (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap)
      {
        if (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap.containsKey(Long.valueOf(paramLong)))
        {
          ...
          while (localIterator.hasNext())
          {
            bcpf localbcpf = (bcpf)localIterator.next();
            if (localbcpf.a()) {
              localArrayList.add(localbcpf);
            }
          }
        }
      }
  ...
  public void a(int paramInt1, long paramLong1, long paramLong2, int paramInt2, bcpo parambcpo)
  {
    ...
    mzy.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bcpm(this, parambcpo), localReqBody.toByteArray(), "OidbSvc.0x934_1", 2356, 1, new Bundle(), 12000L);
  }
  
  public void a(int paramInt, long paramLong1, long paramLong2, String paramString, bcpo parambcpo)
  {
    cmd0x934.ReqBody localReqBody = new cmd0x934.ReqBody();
    ...
    localReqBody.robot_uin.set(paramLong2);
    mzy.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bcpn(this, parambcpo), localReqBody.toByteArray(), "OidbSvc.0x934_1", 2356, 1, new Bundle(), 12000L);
  }
  
  public void a(long paramLong, int paramInt, bcpo parambcpo)
  {
    a(4, 0L, paramLong, paramInt, parambcpo);
  }
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    if (localMessageForUniteGrayTip != null)
    {
      ...
      aspz.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, localMessageForUniteGrayTip);
    }
  }
      ...
      for (;;)
      {
        synchronized (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap)
        {
          if (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap.containsKey(Long.valueOf(paramLong1)))
          {
            ...
            bcpf localbcpf = (bcpf)((Iterator)localObject1).next();
            if (localbcpf.a() != paramLong2) {
              continue;
            }
            ...
            if (!localbcpf.a())
            {
              localObject1 = localObject4;
              if (paramInt == 1) {
                localObject1 = localbcpf;
              }
            }
            localbcpf.a(paramInt);
            if (localObject1 != null)
            {
              localArrayList.remove(localObject1);
              localArrayList.add(0, localObject1);
              if (QLog.isColorLevel()) {
                QLog.d("TroopRobotManager", 2, "onSetTroopRobot move position " + ((bcpf)localObject1).a());
              }
            }
          }
          return;
  ...
  public void a(long paramLong1, long paramLong2, int paramInt, bcpo parambcpo)
  {
    a(1, paramLong1, paramLong2, paramInt, parambcpo);
  }
  
  public void a(long paramLong1, long paramLong2, String paramString, bcpo parambcpo)
  {
    a(3, paramLong1, paramLong2, paramString, parambcpo);
  }
  
  public void a(long paramLong, String paramString, bcpo parambcpo)
  {
    a(Long.valueOf("1").longValue(), paramLong, paramString, parambcpo);
  }
  
  public void a(long paramLong, ArrayList<bcpf> paramArrayList)
  {
  ...
  public void a(long paramLong, ArrayList<bcpf> arg3, int paramInt)
  {
    StringBuilder localStringBuilder;
    if (QLog.isColorLevel())
    {
  ...
  {
    String str = bdgc.h(paramQQAppInterface, paramChatMessage.frienduin, paramChatMessage.senderuin);
    paramEditText = bciq.a(paramQQAppInterface, paramContext, paramSessionInfo.jdField_a_of_type_JavaLangString, paramChatMessage.senderuin, str, false, paramEditText, true, true);
    paramContext = new ArrayList();
    paramEditText = bciq.a(paramEditText, paramContext);
    ...
    try
    {
      ...
      new azqx(paramQQAppInterface).a("dc00899").b("Grp_robot").c("sub_page").d("next_msg_clk").a(new String[] { paramChatMessage.frienduin, paramSessionInfo }).a();
      return;
    }
  ...
  public void a(bcpp parambcpp)
  {
    ...
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambcpp);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, long paramLong, ArrayList<String> paramArrayList)
  {
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      localArrayList = bclg.b(paramQQAppInterface);
      if (localArrayList == null)
      {
        ...
        if ((paramArrayList == null) || (paramArrayList.size() == 0))
        {
          ...
          bclg.a(paramQQAppInterface, this.jdField_a_of_type_JavaUtilArrayList);
          bclg.a(paramQQAppInterface, false);
    ...
    for (;;)
    {
      ...
      {
        bclg.a(paramQQAppInterface, this.jdField_a_of_type_JavaUtilArrayList);
        bclg.b(paramQQAppInterface, localArrayList);
        if (paramArrayList.size() <= 0) {
          break label392;
        }
        bclg.a(paramQQAppInterface, true);
        bclg.c(paramQQAppInterface, true);
        break label392;
        break;
        i -= 1;
        break label182;
    ...
    try
    {
      ...
      if (paramRobot.uin_range.has())
      {
        ...
        while ((i < paramRobot.uin_range.size()) && (i < 5))
        {
          ...
          bcpq localbcpq = new bcpq();
          localbcpq.a = localUinRange.start_uin.get();
          localbcpq.b = localUinRange.end_uin.get();
          this.jdField_a_of_type_JavaUtilList.add(localbcpq);
          i += 1;
        }
      }
  ...
  public void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    try
    {
      b(Long.parseLong(paramString1), Long.parseLong(paramString2), paramString3, new bcpk(this, paramString3));
      a();
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    if (localJSONArray != null) {
      bdne.f(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), localJSONArray.toString());
    }
    paramJSONObject = paramJSONObject.optJSONObject("robot_voice_tail");
    if (paramJSONObject != null) {
      bdne.g(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), paramJSONObject.toString());
    }
    d();
  }
  ...
  public boolean a(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      {
        bcpq localbcpq = (bcpq)this.jdField_a_of_type_JavaUtilList.get(i);
        if ((localbcpq != null) && (paramLong >= localbcpq.a) && (paramLong <= localbcpq.b)) {
          bool1 = true;
        }
      }
      else
  ...
  public boolean a(Context paramContext, String paramString, long paramLong)
  {
    if (a(paramLong))
    {
      bclg.a(paramContext, paramString, String.valueOf(paramLong));
      return true;
    }
    return false;
  }
  ...
  {
    boolean bool2 = false;
    if (!bclg.d(paramQQAppInterface, paramString2))
    {
  ...
  public boolean a(MessageRecord paramMessageRecord)
  {
    ...
    if ((paramMessageRecord.atInfoList != null) && (paramMessageRecord.atInfoList.size() > 0))
    {
      ...
      for (;;)
      {
        ...
        if (a(((MessageForText.AtTroopMemberInfo)localObject).uin))
        {
          ...
          str1 = bdgc.h((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, paramMessageRecord.frienduin, "" + ((MessageForText.AtTroopMemberInfo)localObject).uin);
          ...
          for (;;)
          {
            ...
            if (str2.equals(((String)this.jdField_c_of_type_JavaUtilList.get(j)).replace("$ROBOTNICK$", str1)))
            {
              ...
              azqs.b((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, "dc00899", "Grp_robot", "", "msg", "conti_dialog_msg", 0, 0, paramMessageRecord.frienduin, this.jdField_a_of_type_JavaLangString, (String)this.jdField_c_of_type_JavaUtilList.get(i), "");
              return true;
            }
            j += 1;
          }
    ...
    while (i < this.jdField_b_of_type_JavaUtilList.size())
    {
      ...
      for (localObject = "";; localObject = ((String)localObject).toUpperCase().replaceAll(" ", ""))
      {
        ...
        azqs.b((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, "dc00899", "Grp_robot", "", "msg", "keyword_msg", 0, 0, paramMessageRecord.frienduin, this.jdField_a_of_type_JavaLangString, (String)this.jdField_b_of_type_JavaUtilList.get(i), "");
        return true;
      }
      i += 1;
    }
  ...
  {
    boolean bool2 = false;
    paramString2 = bdgc.h((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, paramString3, "" + paramString2);
  ...
  public byte[] a()
  {
    return bdhb.a(BaseApplication.getContext().getFileStreamPath("troop_robot_config"));
  }
  
  public byte[] a(String paramString1, String paramString2)
  {
    return bdhb.a(BaseApplication.getContext().getFileStreamPath("troop_robot_panel_data_" + paramString1 + "_" + paramString2));
  }
  
  public ArrayList<bcpf> b(long paramLong)
  {
    ArrayList localArrayList = new ArrayList(0);
    if (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap != null) {
      synchronized (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap)
  ...
  public void b(int paramInt, long paramLong1, long paramLong2, String paramString, bcpo parambcpo)
  {
    cmd0x934.ReqBody localReqBody = new cmd0x934.ReqBody();
    localReqBody.cmd.set(paramInt, true);
    localReqBody.group_id.set(paramLong1, true);
    localReqBody.keyword.set(paramString, true);
    localReqBody.robot_uin.set(paramLong2);
    mzy.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bcph(this, parambcpo), localReqBody.toByteArray(), "OidbSvc.0x934_1", 2356, 1, new Bundle(), 12000L);
  }
  
  public void b(long paramLong1, long paramLong2, String paramString, bcpo parambcpo)
  {
    b(2, paramLong1, paramLong2, paramString, parambcpo);
  }
  
  public void b(long paramLong, String paramString, bcpo parambcpo)
  {
    b(2, Long.valueOf("1").longValue(), paramLong, paramString, parambcpo);
  }
