  ...
  extends arxg
{
  ...
  public static List<arxg> a(int[] paramArrayOfInt)
  {
    ...
    {
      asdb localasdb = new asdb();
      localasdb.jdField_a_of_type_Int = paramArrayOfInt[i];
      localasdb.jdField_c_of_type_Int = 1;
      localArrayList.add(localasdb);
      i += 1;
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (j < m)
        {
          ...
          if ((n < 0) || (n >= bdnh.jdField_a_of_type_Int)) {
            break label218;
          }
          int k = i + 1;
          paramAppRuntime[i] = n;
  ...
  {
    return bdol.a(this.jdField_a_of_type_Int, false);
  }
  
  public void a(QQAppInterface paramQQAppInterface, Context paramContext, EditText paramEditText, SessionInfo paramSessionInfo)
  {
    if (this.d == 1) {
      bcst.b(null, "CliOper", "", "", "0X8005507", "0X8005507", 0, 0, "", "", "", "");
    }
    for (;;)
    {
      int i = paramEditText.getSelectionStart();
      int j = paramEditText.getSelectionEnd();
      paramEditText.getEditableText().replace(i, j, bdol.b(this.jdField_a_of_type_Int));
      paramEditText.requestFocus();
      return;
      if (this.d == 2) {
        bcst.b(null, "CliOper", "", "", "0X8005508", "0X8005508", 0, 0, "", "", "", "");
      }
    }
  }
  ...
  {
    return bdol.a(this.jdField_a_of_type_Int, true);
  }
}
