  ...
  extends AsyncTask<Void, Void, Integer>
{
  ...
  private axmd jdField_a_of_type_Axmd;
  ...
  public axfh(QQAppInterface paramQQAppInterface, Context paramContext, MessageForShortVideo paramMessageForShortVideo, axfk paramaxfk)
  {
  ...
  private int a(String paramString1, String paramString2)
  {
    ...
    Object localObject1 = axfc.a((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get());
    axff localaxff = axfc.a(paramString1);
    axfg.a(localaxff);
    boolean bool = axfc.a(localaxff, (axfe)localObject1);
    this.jdField_b_of_type_Boolean = bool;
    if (QLog.isColorLevel()) {
      QLog.d("VideoCompressProcessor", 1, "CompressTask, isNeedCompress = " + bool);
    }
    if (this.jdField_a_of_type_Axfk != null) {
      bfnh.a(new VideoCompressProcessor.CompressTask.1(this, bool));
    }
    if (!bool) {
      return -1;
    }
    localObject1 = axfc.a(localaxff, (axfe)localObject1, this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo.sendRawVideo);
    int i = axhl.a((Context)this.jdField_b_of_type_JavaLangRefWeakReference.get());
    Object localObject2;
    label290:
    label380:
    long l1;
    ...
    if ((Build.VERSION.SDK_INT >= 18) && ((i & 0x1) > 0) && ((i & 0x2) > 0))
    {
      ...
      localObject2 = new axfl(this.jdField_a_of_type_JavaLangRefWeakReference, paramString1, paramString2, (axfd)localObject1, new axfi(this));
      this.jdField_a_of_type_Axmd = new axmd();
      if ((!this.jdField_a_of_type_Axmd.a(new File(paramString1), (axme)localObject2, true)) || (((axfl)localObject2).a != null)) {
        break label567;
      }
      if (QLog.isColorLevel()) {
      ...
      localObject2 = new axfj(this);
      i = ShortVideoTrimmer.a((Context)this.jdField_b_of_type_JavaLangRefWeakReference.get(), paramString1, paramString2, (QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), (axlp)localObject2, (axfd)localObject1, localaxff);
      if (i != 0) {
        break label626;
      }
    ...
    {
      axfg.a(bool, l3, localaxff, (axfd)localObject1, l2);
      if (QLog.isColorLevel()) {
      ...
      label586:
      if (this.jdField_a_of_type_Axfk != null) {
        this.jdField_a_of_type_Axfk.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, 1.0F);
      }
      if (QLog.isColorLevel()) {
      ...
      axrl.a(BaseApplication.getContext()).a(null, "initVideoTrimError", true, 0L, 0L, null, "", false);
      break label380;
  ...
  protected Integer a(Void... paramVarArgs)
  {
    ...
    if ((TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo.videoFileName)) || (!bbdj.b(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo.videoFileName)))
    {
      if (QLog.isColorLevel()) {
    ...
    if ((TextUtils.isEmpty(this.c)) || (!bbdj.b(this.c)))
    {
    ...
    for (;;)
    {
      ...
      try
      {
        this.jdField_b_of_type_JavaLangString = bbdm.a(MD5.toMD5Byte(new FileInputStream(paramVarArgs), this.jdField_a_of_type_Long));
      ...
      catch (Exception paramVarArgs)
      {
        ...
        if (this.jdField_a_of_type_Long < 104345600L)
        {
          ...
          bbdj.a(new File(this.c), new File(ShortVideoUtils.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, "mp4")));
        }
      }
    }
  ...
  public void a(axfk paramaxfk)
  {
    ...
    do
    {
      do
      {
        ...
        } while (this.jdField_a_of_type_Axfk == null);
        this.jdField_a_of_type_Axfk.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, 1);
        return;
        if (!isCancelled()) {
          break;
        }
      } while (this.jdField_a_of_type_Axfk == null);
      this.jdField_a_of_type_Axfk.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, 3);
      return;
    } while (this.jdField_a_of_type_Axfk == null);
    this.jdField_a_of_type_Axfk.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, this.jdField_b_of_type_Boolean);
  }
  ...
  protected void a(Integer paramInteger)
  {
    ...
    if (this.jdField_a_of_type_Axfk != null)
    {
      axfk localaxfk = this.jdField_a_of_type_Axfk;
      MessageForShortVideo localMessageForShortVideo = this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo;
      if (paramInteger.intValue() == 1) {
        i = 1;
      }
      localaxfk.a(localMessageForShortVideo, i);
    }
    while (paramInteger.intValue() == 1)
    {
      adzh.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, (QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), (Context)this.jdField_b_of_type_JavaLangRefWeakReference.get());
      return;
      if (QLog.isColorLevel()) {
        QLog.d("VideoCompressProcessor", 2, "onPostExecute, mListener is null ," + b());
      }
    }
    adzh.b(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, (QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), (Context)this.jdField_b_of_type_JavaLangRefWeakReference.get());
  }
  
  public boolean a()
  {
    if (this.jdField_a_of_type_Axmd != null) {}
    for (boolean bool = this.jdField_a_of_type_Axmd.a();; bool = false) {
      try
      {
        if (this.jdField_a_of_type_JavaLangProcess != null) {
          this.jdField_a_of_type_JavaLangProcess.destroy();
  ...
  protected void onCancelled()
  {
    ...
    if (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)
    {
      ...
      if (!TextUtils.isEmpty(localMessageForShortVideo.md5)) {
        bbdj.d(ShortVideoUtils.a(localMessageForShortVideo, "mp4"));
      }
      ...
      awan.a((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), localMessageForShortVideo.frienduin, localMessageForShortVideo.uniseq);
    ...
    for (Object localObject = ShortVideoUtils.d(this.jdField_a_of_type_JavaLangString, "mp4");; localObject = ShortVideoUtils.c(this.jdField_a_of_type_JavaLangString, "mp4"))
    {
      if (!TextUtils.isEmpty((CharSequence)localObject)) {
        bbdj.d((String)localObject);
      }
      axfg.a().a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo.uniseq);
      if (QLog.isColorLevel()) {
