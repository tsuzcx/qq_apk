  ...
  implements IThirdAppOpenReport
{
  public static void a()
  {
    ...
    if ((localObject != null) && (((acsw)localObject).d == 1) && (!AppInterface.isAppOnForeground(BaseApplicationImpl.getContext())))
    {
    ...
    for (bool1 = true;; bool1 = false)
    {
      ...
      for (;;)
      {
        ...
        for (paramIntent = "ThirdAppInstall";; paramIntent = "ThirdAppOpen")
        {
          ...
          axrn.a(BaseApplicationImpl.getContext()).a(paramString1, paramIntent, true, 0L, 0L, (HashMap)localObject2, null);
          return;
          paramIntent = "";
          break;
  ...
  public void startActivityForResult(Activity paramActivity, Intent paramIntent, int paramInt, Bundle paramBundle)
  {
    ...
    aqve.a(paramActivity, paramIntent, paramInt, paramBundle);
  }
}
