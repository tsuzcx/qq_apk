...
public class bhgr
{
  ...
  public bhgr(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_b_of_type_JavaLangObject = bhep.a("com.tencent.rtmp.WXLivePlayConfig", null, new Object[0]);
    this.jdField_c_of_type_JavaLangObject = bhep.a("com.tencent.rtmp.WXLivePlayer", bhep.a(new Class[] { Context.class }), new Object[] { this.jdField_a_of_type_AndroidContentContext });
    a(Boolean.valueOf(true));
    try
    {
      bhep.a(this.jdField_c_of_type_JavaLangObject, "setConfig", false, bhep.a(new Class[] { Class.forName("com.tencent.rtmp.WXLivePlayConfig") }), new Object[] { this.jdField_b_of_type_JavaLangObject });
      paramContext = Class.forName("com.tencent.rtmp.ITXLivePlayListener");
      Object localObject = new bhgx(this);
      c(Proxy.newProxyInstance(bhgr.class.getClassLoader(), new Class[] { paramContext }, (InvocationHandler)localObject));
      paramContext = Class.forName("com.tencent.rtmp.TXLivePlayer$ITXAudioVolumeEvaluationListener");
      localObject = new bhgv(this);
      e(Proxy.newProxyInstance(bhgr.class.getClassLoader(), new Class[] { paramContext }, (InvocationHandler)localObject));
      return;
    }
  ...
  {
    paramBoolean = bhep.a(this.jdField_c_of_type_JavaLangObject, "stopPlay", false, bhep.a(new Class[] { Boolean.TYPE }), new Object[] { paramBoolean });
  ...
  {
    paramString = bhep.a(this.jdField_c_of_type_JavaLangObject, "startPlay", false, bhep.a(new Class[] { String.class, Integer.TYPE }), new Object[] { paramString, Integer.valueOf(paramInt) });
    if (paramString != null) {
  ...
  private void a()
  {
    bhep.a(this.jdField_c_of_type_JavaLangObject, "resume", false, null, new Object[0]);
  }
  
  private void a(float paramFloat)
  {
    bhep.a(this.jdField_b_of_type_JavaLangObject, "setCacheTime", false, bhep.a(new Class[] { Float.TYPE }), new Object[] { Float.valueOf(paramFloat) });
  }
  
  private void a(int paramInt)
  {
    bhep.a(this.jdField_c_of_type_JavaLangObject, "setRenderRotation", false, bhep.a(new Class[] { Integer.TYPE }), new Object[] { Integer.valueOf(paramInt) });
  }
  ...
  {
    bhep.a(this.jdField_c_of_type_JavaLangObject, "enableHardwareDecode", false, bhep.a(new Class[] { Boolean.TYPE }), new Object[] { paramBoolean });
  }
  ...
  private void a(Object paramObject)
  {
    try
    {
      bhep.a(this.jdField_c_of_type_JavaLangObject, "setPlayerView", false, bhep.a(new Class[] { Class.forName("com.tencent.rtmp.ui.TXCloudVideoView") }), new Object[] { paramObject });
      return;
    }
  ...
  private boolean a()
  {
    Object localObject = bhep.a(this.jdField_c_of_type_JavaLangObject, "isPlaying", false, null, new Object[0]);
    if (localObject != null) {
  ...
  private void b()
  {
    bhep.a(this.jdField_c_of_type_JavaLangObject, "pause", false, null, new Object[0]);
  }
  
  private void b(float paramFloat)
  {
    bhep.a(this.jdField_b_of_type_JavaLangObject, "setMinAutoAdjustCacheTime", false, bhep.a(new Class[] { Float.TYPE }), new Object[] { Float.valueOf(paramFloat) });
  }
  
  private void b(int paramInt)
  {
    bhep.a(this.jdField_c_of_type_JavaLangObject, "setRenderMode", false, bhep.a(new Class[] { Integer.TYPE }), new Object[] { Integer.valueOf(paramInt) });
  }
  
  private void b(Boolean paramBoolean)
  {
    bhep.a(this.jdField_b_of_type_JavaLangObject, "setAutoAdjustCacheTime", false, bhep.a(new Class[] { Boolean.TYPE }), new Object[] { paramBoolean });
  }
  ...
  private void b(Object paramObject)
  {
    try
    {
      bhep.a(this.jdField_c_of_type_JavaLangObject, "snapshot", false, bhep.a(new Class[] { Class.forName("com.tencent.rtmp.TXLivePlayer$ITXSnapshotListener") }), new Object[] { paramObject });
      return;
    }
    catch (ClassNotFoundException paramObject)
    {
  ...
  {
    bhep.a(this.jdField_b_of_type_JavaLangObject, "setMaxAutoAdjustCacheTime", false, bhep.a(new Class[] { Float.TYPE }), new Object[] { Float.valueOf(paramFloat) });
  }
  
  private void c(int paramInt)
  {
    bhep.a(this.jdField_c_of_type_JavaLangObject, "setAudioRoute", false, bhep.a(new Class[] { Integer.TYPE }), new Object[] { Integer.valueOf(paramInt) });
  }
  
  private void c(Boolean paramBoolean)
  {
    bhep.a(this.jdField_b_of_type_JavaLangObject, "setEnableMessage", false, bhep.a(new Class[] { Boolean.TYPE }), new Object[] { paramBoolean });
  }
  ...
  private void c(Object paramObject)
  {
    try
    {
      bhep.a(this.jdField_c_of_type_JavaLangObject, "setPlayListener", false, bhep.a(new Class[] { Class.forName("com.tencent.rtmp.ITXLivePlayListener") }), new Object[] { paramObject });
      return;
    }
    catch (ClassNotFoundException paramObject)
    {
  ...
  {
    bhep.a(this.jdField_c_of_type_JavaLangObject, "enableAudioVolumeEvaluation", false, bhep.a(new Class[] { Integer.TYPE }), new Object[] { Integer.valueOf(paramInt) });
  }
  
  private void d(Boolean paramBoolean)
  {
    bhep.a(this.jdField_a_of_type_JavaLangObject, "disableLog", false, bhep.a(new Class[] { Boolean.TYPE }), new Object[] { paramBoolean });
  }
  ...
  private void d(Object paramObject)
  {
    try
    {
      bhep.a(this.jdField_c_of_type_JavaLangObject, "setConfig", false, bhep.a(new Class[] { Class.forName("com.tencent.rtmp.WXLivePlayConfig") }), new Object[] { paramObject });
      return;
    }
    catch (ClassNotFoundException paramObject)
    {
  ...
  {
    bhep.a(this.jdField_c_of_type_JavaLangObject, "showDebugLog", false, bhep.a(new Class[] { Boolean.TYPE }), new Object[] { paramBoolean });
  }
  ...
  private void e(Object paramObject)
  {
    try
    {
      bhep.a(this.jdField_c_of_type_JavaLangObject, "setAudioVolumeEvaluationListener", false, bhep.a(new Class[] { Class.forName("com.tencent.rtmp.TXLivePlayer$ITXAudioVolumeEvaluationListener") }), new Object[] { paramObject });
      return;
    }
    catch (ClassNotFoundException paramObject)
    {
  ...
  {
    bhep.a(this.jdField_c_of_type_JavaLangObject, "muteAudio", false, bhep.a(new Class[] { Boolean.TYPE }), new Object[] { paramBoolean });
  }
  
  private void g(Boolean paramBoolean)
  {
    bhep.a(this.jdField_c_of_type_JavaLangObject, "muteVideo", false, bhep.a(new Class[] { Boolean.TYPE }), new Object[] { paramBoolean });
  }
  ...
  public bhgp a(Bundle paramBundle)
  {
    ...
    if (!this.jdField_a_of_type_Boolean) {
      return new bhgp(-3, "uninited livePlayer");
    }
  ...
  public bhgp a(Object paramObject, JSONObject paramJSONObject)
  {
    if (QMLog.isColorLevel()) {
  ...
  public bhgp a(JSONObject paramJSONObject)
  {
    if (QMLog.isColorLevel()) {
  ...
  public void a(bhgs parambhgs)
  {
    this.jdField_a_of_type_Bhgs = parambhgs;
  }
  
  public void a(bhgt parambhgt)
  {
  ...
  public void a(boolean paramBoolean)
  {
    ...
    try
    {
      ...
      localbhgw.a(paramBoolean);
      b(Proxy.newProxyInstance(bhgr.class.getClassLoader(), new Class[] { localClass }, localbhgw));
      return;
    }
