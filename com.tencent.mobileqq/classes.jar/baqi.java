  ...
  implements IRequestCallback
{
  ...
  public void onResponse(HwResponse paramHwResponse)
  {
    ...
    if (paramHwResponse.retCode == 0)
    {
      if (paramHwResponse.segmentResp.uint32_cache_addr.has())
      {
        ...
        if (i != 0)
        {
          ...
          if ((baqf.a(this.a) != 0) && (baqf.a(this.a) != i)) {
      ...
      if ((localObject1 != null) && (localObject1.length > 0)) {
        try
        {
          ...
          {
            if ((baqf.jdField_a_of_type_Boolean) || (!QLog.isColorLevel())) {
              return;
            }
    ...
    else
    {
      ...
      bddw.a(String.valueOf(this.a.jdField_a_of_type_Baub.a), "svrcomp_r", "sendAckToBDHServer success!  MD5:" + HexUtil.bytes2HexStr((byte[])localObject3));
      this.a.jdField_a_of_type_Baub.f = HexUtil.bytes2HexStr((byte[])localObject3);
      this.a.jdField_a_of_type_Baub.i = ShortVideoUtils.a(baqf.a(this.a), "mp4");
      this.a.c = this.a.jdField_a_of_type_Baub.f;
