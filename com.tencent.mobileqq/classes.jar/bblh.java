...
class bblh
{
  ...
  public bblh(im_msg_body.RichText paramRichText, String paramString, ArrayList<MessageForText.AtTroopMemberInfo> paramArrayList, int paramInt1, int paramInt2, StringBuilder paramStringBuilder, int paramInt3)
  {
  ...
  private void a()
  {
    if (this.jdField_a_of_type_JavaLangStringBuilder.length() > 0)
    {
      ...
      bblf.a(this.jdField_a_of_type_TencentImMsgIm_msg_body$RichText, (String)localObject1);
    ...
    int[] arrayOfInt = aqyy.a((char[])localObject4);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localObject1 != null)
        {
          ...
          localObject1 = ((avsq)localObject1).a(Integer.toString(arrayOfInt[0]), Integer.toString(arrayOfInt[1]));
          if (localObject1 != null)
          {
  ...
  private void a(MessageForText.AtTroopMemberInfo paramAtTroopMemberInfo)
  {
    if (this.jdField_a_of_type_JavaLangStringBuilder.length() > 0)
    {
      ...
      bblf.a(this.jdField_a_of_type_TencentImMsgIm_msg_body$RichText, (String)localObject);
      this.jdField_a_of_type_JavaLangStringBuilder.delete(0, this.jdField_a_of_type_JavaLangStringBuilder.length());
      this.jdField_a_of_type_Int += 1;
    }
    ...
    localObject = bblf.a(this.jdField_a_of_type_TencentImMsgIm_msg_body$RichText, (String)localObject);
    this.b += 1;
