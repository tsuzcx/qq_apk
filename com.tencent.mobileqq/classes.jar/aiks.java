...
public class aiks
{
  ...
  public aiks(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      do
      {
        ...
        i = localSharedPreferences.getInt(paramQQAppInterface.getCurrentAccountUin() + "_count_" + ApolloUtil.a(), 0);
  ...
  public int a(aisu paramaisu, int paramInt1, int paramInt2, AppInterface paramAppInterface, Context paramContext)
  {
    ...
    for (paramInt1 = 14;; paramInt1 = 5)
    {
      ...
      aisl.a(paramaisu, paramInt1, paramAppInterface);
      return 0;
    }
  }
  ...
  protected void a(Context paramContext, QQAppInterface paramQQAppInterface)
  {
    ...
    paramContext = (String)localObject1 + ApolloUtil.a();
