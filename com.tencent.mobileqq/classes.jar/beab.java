...
public class beab
{
  private static beab jdField_a_of_type_Beab;
  public static boolean a;
  public static boolean b = true;
  public static boolean c;
  private static boolean e;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new beac(this);
  private WindowManager jdField_a_of_type_AndroidViewWindowManager;
  private bead jdField_a_of_type_Bead = new bead();
  ...
  /* Error */
  public static beab a()
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 40	beab:jdField_a_of_type_Beab	Lbeab;
    //   6: ifnonnull +19 -> 25
    //   9: ldc 2
    //   11: monitorenter
    //   12: new 2	beab
    //   15: dup
    //   16: invokespecial 41	beab:<init>	()V
    //   19: putstatic 40	beab:jdField_a_of_type_Beab	Lbeab;
    //   22: ldc 2
    //   24: monitorexit
    //   25: ldc 2
    //   27: monitorexit
    //   28: getstatic 40	beab:jdField_a_of_type_Beab	Lbeab;
    //   31: areturn
    //   32: astore_0
    //   33: ldc 2
    //   35: monitorexit
  ...
  public int a(beaa parambeaa)
  {
    ...
    return this.jdField_a_of_type_ComTencentMobileqqTablequeryTableQueryViewer.a(parambeaa);
  }
  ...
  {
    if (jdField_a_of_type_Boolean) {
      this.jdField_a_of_type_ComTencentMobileqqTablequeryTableQueryViewer.a(parambeaa);
    }
  }
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        catch (Exception localException1)
        {
          for (;;)
          {
            QQToast.a(localBaseApplication, 1, localBaseApplication.getString(2131690617), 0).a();
          }
        }
      }
    }
