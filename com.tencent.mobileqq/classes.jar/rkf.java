  ...
  extends AsyncTask<String, Void, Integer>
{
  ...
  public rkf(Context paramContext, boolean paramBoolean1, boolean paramBoolean2, rkh paramrkh)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Boolean = paramBoolean1;
    this.jdField_b_of_type_Boolean = paramBoolean2;
    this.jdField_a_of_type_Rkh = paramrkh;
  }
  ...
  private HashMap<String, String> a(String paramString, Context paramContext)
  {
    ...
    bdev localbdev = ShortVideoTrimmer.a(paramString);
    long l1;
    int i;
    if ((localbdev != null) && (localbdev.jdField_a_of_type_Boolean))
    {
      l1 = new File(paramString).length();
      i = a(localbdev.jdField_a_of_type_Int, localbdev.jdField_b_of_type_Int);
      if ((l1 <= 52428800L) && (i > 0) && (localbdev.jdField_b_of_type_Long * 1024L / i < 1.3D))
      {
        localbdev.jdField_a_of_type_Boolean = false;
    ...
    for (;;)
    {
      try
      {
        ...
        if (((i & 0x1) > 0) && ((i & 0x2) > 0))
        {
          ...
          localObject2 = new rkg(this, str2, (int)(localbdev.jdField_b_of_type_Long * 1024L), (int)localbdev.jdField_a_of_type_Long, 0L, l1);
          if ((!new bdfk().a((File)localObject1, (bdfl)localObject2, true)) || (((rkg)localObject2).a != null)) {
            continue;
          }
          if (QLog.isColorLevel()) {
          ...
          {
            j = 0;
            if ((!"90".equals(localbdev.jdField_a_of_type_JavaLangString)) && (!"270".equals(localbdev.jdField_a_of_type_JavaLangString))) {
              break label585;
            }
            i = 1;
            if (i == 0) {
            ...
            localHashMap.put("outWidth", String.valueOf(localbdev.d));
            localHashMap.put("outHeight", String.valueOf(localbdev.c));
          }
          return localHashMap;
        }
      }
      ...
      if ((localbdev != null) && (!localbdev.jdField_a_of_type_Boolean))
      {
        ...
        label585:
        i = j;
        if ("0".equals(localbdev.jdField_a_of_type_JavaLangString))
        {
          ...
          if (paramString != null)
          {
            ...
            if (paramString.length == 5) {
              ...
              else
              {
                ...
                continue;
                label647:
                localHashMap.put("outWidth", String.valueOf(localbdev.c));
                localHashMap.put("outHeight", String.valueOf(localbdev.d));
                return localHashMap;
              }
            }
          }
  ...
  private void a(int paramInt)
  {
    ...
    {
      localbdmc.a(str, "actReadInJoyDeliverVideoCompressVideo", bool, this.jdField_b_of_type_Long - this.jdField_a_of_type_Long, 0L, localHashMap, "");
      return;
    }
  }
  ...
  protected Integer a(String... paramVarArgs)
  {
    ...
    this.jdField_a_of_type_Rkh.a(0.0F);
    ...
    if (localObject != null)
    {
      i = a(((bdev)localObject).jdField_a_of_type_Int, ((bdev)localObject).jdField_b_of_type_Int);
      this.jdField_c_of_type_JavaLangLong = Long.valueOf(((bdev)localObject).jdField_b_of_type_Long);
      this.jdField_d_of_type_JavaLangLong = Long.valueOf(i);
      if ((i <= 0) || (((bdev)localObject).jdField_b_of_type_Long * 1024L / i <= 1.3D)) {}
    }
    for (int i = 1;; i = 0)
    {
      if ((localFile.exists()) && (localFile.length() <= 52428800L) && (i == 0))
      {
        ...
        {
          i = j;
          if (!"90".equals(((bdev)localObject).jdField_a_of_type_JavaLangString))
          {
            if (!"270".equals(((bdev)localObject).jdField_a_of_type_JavaLangString)) {
              break label289;
            }
            i = j;
          }
          ...
          this.jdField_a_of_type_Int = ((bdev)localObject).jdField_b_of_type_Int;
        }
        for (this.jdField_b_of_type_Int = ((bdev)localObject).jdField_a_of_type_Int;; this.jdField_b_of_type_Int = ((bdev)localObject).jdField_b_of_type_Int)
        {
          return Integer.valueOf(0);
          label289:
          if ("0".equals(((bdev)localObject).jdField_a_of_type_JavaLangString))
          {
          ...
          break;
          label343:
          this.jdField_a_of_type_Int = ((bdev)localObject).jdField_a_of_type_Int;
        }
      }
      localObject = new File(antf.ba + "shortvideo");
  ...
  protected void a(Integer paramInteger)
  {
    ...
    if (paramInteger.intValue() != 0) {
      if (!this.jdField_a_of_type_Boolean)
      {
        ...
        if (this.jdField_a_of_type_Rkh != null) {
          this.jdField_a_of_type_Rkh.a(1, this.jdField_a_of_type_JavaLangLong.longValue(), this.jdField_b_of_type_JavaLangLong.longValue(), null, null, 0L);
        }
        i = 1004;
      }
    }
    for (;;)
    {
      ...
      if (!this.jdField_b_of_type_Boolean)
      {
        ...
        if (this.jdField_a_of_type_Rkh != null) {
          this.jdField_a_of_type_Rkh.a(2, this.jdField_a_of_type_JavaLangLong.longValue(), this.jdField_b_of_type_JavaLangLong.longValue(), null, null, 0L);
        }
        i = 1004;
      }
      else
      {
        ...
        if (this.jdField_a_of_type_Rkh != null) {
          this.jdField_a_of_type_Rkh.a(3, this.jdField_a_of_type_JavaLangLong.longValue(), this.jdField_b_of_type_JavaLangLong.longValue(), null, null, 0L);
        }
        i = 1004;
        continue;
        if (TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {}
        for (paramInteger = this.jdField_a_of_type_JavaLangString;; paramInteger = this.jdField_b_of_type_JavaLangString)
        {
          ...
          if (this.jdField_a_of_type_Rkh != null) {
            this.jdField_a_of_type_Rkh.a(4, this.jdField_a_of_type_JavaLangLong.longValue(), this.jdField_b_of_type_JavaLangLong.longValue(), this.jdField_c_of_type_JavaLangString, this.jdField_d_of_type_JavaLangString, this.jdField_c_of_type_JavaLangLong.longValue());
          }
          i = 1005;
          break;
        }
        label382:
        if (this.jdField_a_of_type_Rkh != null) {
          this.jdField_a_of_type_Rkh.a(0, this.jdField_a_of_type_JavaLangLong.longValue(), this.jdField_b_of_type_JavaLangLong.longValue(), this.jdField_c_of_type_JavaLangString, this.jdField_d_of_type_JavaLangString, this.jdField_d_of_type_JavaLangLong.longValue());
        }
        i = 0;
      }
    }
