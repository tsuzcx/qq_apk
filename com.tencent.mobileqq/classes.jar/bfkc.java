...
public class bfkc
{
  ...
  private HashMap<Integer, List<bfke>> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  
  public bfkc(bfjt parambfjt, bfji parambfji)
  {
    this.jdField_a_of_type_Bfjt = parambfjt;
    this.jdField_a_of_type_Bfji = parambfji;
    this.jdField_a_of_type_Bfjt.a(new bfkd(this));
  }
  
  private bfke a(byte[] paramArrayOfByte)
  {
    int j = -1;
    boolean bool = true;
    int i;
    ...
    for (;;)
    {
      ...
      if ((i == 0) || (i == QSecFramework.a().a()))
      {
        ...
        for (;;)
        {
          if ((TextUtils.isEmpty(paramArrayOfByte)) || (paramArrayOfByte.equalsIgnoreCase(bfhs.c())))
          {
            paramArrayOfByte = new bfke(null);
  ...
  {
    if (parambfke.jdField_a_of_type_Int == 0)
    {
      c(parambfke);
      return;
    }
  ...
  {
    int i = this.jdField_a_of_type_Bfjt.a(parambfke.jdField_a_of_type_Int, parambfke.b, parambfke.c, new Object[] { parambfke.jdField_a_of_type_ArrayOfByte }, null);
    if (((i == 17) || (i == 7) || (i == 4)) && (parambfke.jdField_a_of_type_Boolean)) {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        if (this.jdField_a_of_type_Int < 50)
        {
          List localList = (List)this.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(parambfke.jdField_a_of_type_Int));
          Object localObject1 = localList;
          if (localList == null)
          {
            localObject1 = new LinkedList();
            this.jdField_a_of_type_JavaUtilHashMap.put(Integer.valueOf(parambfke.jdField_a_of_type_Int), localObject1);
          }
          ((List)localObject1).add(parambfke);
  ...
  private void c(bfke parambfke)
  {
    ...
    do
    {
      ...
      {
        return;
        this.jdField_a_of_type_Bfji.a(true);
        return;
        try
        {
          parambfke = (QQAppInterface)BaseApplicationImpl.sMobileQQ.waitAppRuntime(null);
          if (parambfke != null)
          {
            ((bfkr)parambfke.getManager(194)).b(0);
            return;
          }
        }
        catch (Exception parambfke)
        {
          return;
        }
      }
      parambfke = parambfke.jdField_a_of_type_ArrayOfByte;
    } while (!bfit.a().a(parambfke));
    bfit.a().a();
  }
