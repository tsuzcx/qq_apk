  ...
  implements akvz, Handler.Callback, View.OnClickListener
{
  ...
  public akvu(RelativeLayout paramRelativeLayout, boolean paramBoolean, int paramInt)
  {
  ...
  private ImageView a(int paramInt)
  {
    ...
    if (2 == paramInt) {
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidWidgetRelativeLayout.getContext().getResources().getDrawable(2130838393));
    }
    do
    {
      ...
      if (1 == paramInt)
      {
        localImageView.setImageDrawable(this.jdField_a_of_type_AndroidWidgetRelativeLayout.getContext().getResources().getDrawable(2130838387));
        return localImageView;
      }
    } while (3 != paramInt);
  ...
  private void a(double paramDouble, LinearLayout paramLinearLayout)
  {
    ...
    for (int i = 1;; i = 0)
    {
      int j = aekt.a(15.0F, this.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources());
      LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(j, j);
      j = 0;
      if (j < n)
      {
        if (j == 0) {}
        for (localLayoutParams.leftMargin = 0;; localLayoutParams.leftMargin = aekt.a(3.0F, this.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources()))
        {
  ...
  private boolean a()
  {
    if (this.jdField_a_of_type_Akvq == null) {}
    while ((this.jdField_a_of_type_Akvq.jdField_a_of_type_Int != 585) && (this.jdField_a_of_type_Akvq.jdField_a_of_type_Int != 565)) {
      return false;
    }
    return true;
  }
  ...
  private void j()
  {
    ...
    {
      i = 1;
      m = this.jdField_a_of_type_Akwa.a();
      i1 = this.jdField_a_of_type_Akwa.b();
    ...
    for (int k = Math.max(((DisplayMetrics)localObject).widthPixels, ((DisplayMetrics)localObject).heightPixels);; k = Math.min(((DisplayMetrics)localObject).widthPixels, ((DisplayMetrics)localObject).heightPixels))
    {
      ...
      this.jdField_c_of_type_AndroidWidgetImageView.setImageDrawable(URLDrawable.getDrawable(this.jdField_a_of_type_Akvq.h, (URLDrawable.URLDrawableOptions)localObject));
  ...
  private void k()
  {
    ...
    if (this.jdField_c_of_type_Boolean) {
      this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.jdField_a_of_type_AndroidWidgetRelativeLayout.getContext().getResources().getDrawable(2130838374));
    }
    View localView;
    for (;;)
    {
      localView = this.jdField_a_of_type_Akwa.a();
      if (localView != null) {
        break;
      }
    ...
    try
    {
      Object localObject = (RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131379593);
      ...
      l();
      localView.setOnClickListener(new akvy(this));
      return;
    }
    catch (Throwable localThrowable)
    {
  ...
  private void l()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Akvq.jdField_a_of_type_Int == 185)
        {
          ...
          {
            if (TextUtils.isEmpty(this.jdField_a_of_type_Akvq.f)) {
              break label852;
            }
            ...
            ((URLDrawable.URLDrawableOptions)localObject7).mLoadingDrawable = ((Resources)localObject8).getDrawable(2130845013);
            ((URLDrawable.URLDrawableOptions)localObject7).mFailedDrawable = ((Resources)localObject8).getDrawable(2130845013);
            localObject7 = URLDrawable.getDrawable(this.jdField_a_of_type_Akvq.f, (URLDrawable.URLDrawableOptions)localObject7);
            ((URLDrawable)localObject7).setTag(bcuq.b(xod.a(BaseApplicationImpl.getContext(), 200.0F), xod.a(BaseApplicationImpl.getContext(), 200.0F), bcwh.a(this.jdField_a_of_type_AndroidWidgetRelativeLayout.getContext(), 12.0F)));
            ((URLDrawable)localObject7).setDecodeHandler(bcuq.c);
            ((ImageView)localObject4).setImageDrawable((Drawable)localObject7);
          }
          if (localObject6 != null) {
            ((TextView)localObject6).setText(this.jdField_a_of_type_Akvq.d);
          }
          if (localObject3 != null)
          {
            localObject6 = this.jdField_a_of_type_Akvq.e;
            ...
            ((TextView)localObject3).setText(alpo.a(2131702521) + (String)localObject4);
          }
          if (localObject5 != null)
          {
            if ((this.jdField_a_of_type_Akvq.jdField_b_of_type_Int != 12) && (this.jdField_a_of_type_Akvq.jdField_b_of_type_Int != 19)) {
              break label862;
            }
            ((Button)localObject5).setText(alpo.a(2131702519));
            ((Button)localObject5).setOnClickListener(this);
          }
          if (localTextView == null) {
            break;
          }
          this.jdField_a_of_type_Akvq.jdField_a_of_type_Double /= 2.0D;
          localObject3 = new StringBuilder(500);
          if ((Double.compare(this.jdField_a_of_type_Akvq.jdField_a_of_type_Double, 0.0D) != 0) && (this.jdField_a_of_type_Akvq.jdField_a_of_type_Double >= 3.0D)) {
            break label876;
          }
          ...
          if ((0L != this.jdField_a_of_type_Akvq.jdField_a_of_type_Long) && (this.jdField_a_of_type_Akvq.jdField_a_of_type_Long >= 100000L)) {
            break label931;
          }
      ...
      if (a())
      {
        ...
        ((RelativeLayout.LayoutParams)localObject8).height = aekt.a(157.0F, this.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources());
      ...
      for (;;)
      {
        ...
        ((RelativeLayout.LayoutParams)localObject8).height = aekt.a(104.0F, this.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources());
      }
      label852:
      ((ImageView)localObject4).setImageResource(2130838399);
      continue;
      label862:
      ((Button)localObject5).setText(alpo.a(2131702516));
      continue;
      label876:
      if (localObject2 != null) {
        ((LinearLayout)localObject2).setVisibility(0);
      }
      a(this.jdField_a_of_type_Akvq.jdField_a_of_type_Double, (LinearLayout)localObject2);
      ((StringBuilder)localObject3).append(new DecimalFormat("0.0").format(this.jdField_a_of_type_Akvq.jdField_a_of_type_Double)).append("分 ");
      continue;
      label931:
      if (this.jdField_a_of_type_Akvq.jdField_a_of_type_Long < 1000000L) {
        ((StringBuilder)localObject3).append(this.jdField_a_of_type_Akvq.jdField_a_of_type_Long);
      }
      for (;;)
      {
        if ((this.jdField_a_of_type_Akvq.jdField_b_of_type_Int != 12) && (this.jdField_a_of_type_Akvq.jdField_b_of_type_Int != 19)) {
        ...
        break;
        if (this.jdField_a_of_type_Akvq.jdField_a_of_type_Long < 100000000L) {
          ((StringBuilder)localObject3).append(new BigDecimal(this.jdField_a_of_type_Akvq.jdField_a_of_type_Long / 10000.0D).setScale(0, 4)).append("万");
        } else {
          ((StringBuilder)localObject3).append(new BigDecimal(this.jdField_a_of_type_Akvq.jdField_a_of_type_Long / 100000000.0D).setScale(0, 4)).append("亿");
        }
      }
      label1082:
  ...
  public void a()
  {
    ...
    do
    {
      do
      {
        ...
        try
        {
          akro.a().callbackFromRequest(this.jdField_a_of_type_Akvq.jdField_b_of_type_Long, 0, "cs.xy_life_cycle_event_disactivity.local", "{}");
          if (!this.g)
          {
            ...
            this.g = true;
            this.jdField_a_of_type_Akwa.a(this.jdField_c_of_type_Boolean);
            this.jdField_b_of_type_Int = ((int)((float)this.jdField_a_of_type_Akwa.a() / 1000.0F));
            return;
          }
        }
    ...
    this.jdField_a_of_type_Bhow.obtainMessage(4).sendToTarget();
  }
  ...
  {
    if ((this.jdField_a_of_type_Akvq == null) || (this.jdField_a_of_type_Akwa == null)) {}
    while ((this.jdField_a_of_type_Boolean) && (!paramBoolean)) {
      return;
    }
    VipUtils.a(null, "cmshow", "Apollo", "video_SPA", this.jdField_a_of_type_Akvq.jdField_c_of_type_Int, paramInt1, new String[] { Integer.toString(this.jdField_c_of_type_Int), Long.toString(this.jdField_b_of_type_Int), Integer.toString(paramInt2), Integer.toString(this.jdField_a_of_type_Akvq.jdField_a_of_type_Int) });
  }
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    for (;;)
    {
      ...
      if (paramLong1 == paramLong2)
      {
        ...
        this.jdField_b_of_type_AndroidWidgetTextView.setText(alpo.a(2131702515) + l);
      ...
      for (;;)
      {
        ...
        akro.a().callbackFromRequest(this.jdField_a_of_type_Akvq.jdField_b_of_type_Long, 0, "sc.game_ad_video_end.local", "{}");
        return;
        ...
        continue;
        label245:
        this.jdField_b_of_type_AndroidWidgetTextView.setText(alpo.a(2131702522) + paramLong1);
        this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
      }
    }
  }
  ...
  public void a(akvq paramakvq)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Akvq = paramakvq;
    } while (this.jdField_a_of_type_Bhow == null);
    this.jdField_a_of_type_Bhow.obtainMessage(0).sendToTarget();
  }
  ...
  public void a(String paramString)
  {
    ...
    try
    {
      GdtHandler.a(a((qq_ad_get.QQAdGetRsp.AdInfo)qq_ad_get.QQAdGetRsp.AdInfo.class.cast(aano.a(new qq_ad_get.QQAdGetRsp.AdInfo(), new JSONObject(paramString)))));
      return;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramBoolean)
        {
          ...
          this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131364330));
          ...
          this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131372054));
          ...
          this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131379668));
          this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(this);
          this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
          this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new akvv(this));
          return;
        }
      }
      catch (Throwable localThrowable)
  ...
  public void b()
  {
    ...
    if (!this.jdField_a_of_type_Boolean)
    {
      a(8, this.jdField_a_of_type_Akwa.a());
      a(1, 100, false);
    }
    if (!this.jdField_d_of_type_Boolean) {
      akro.a().callbackFromRequest(this.jdField_a_of_type_Akvq.jdField_b_of_type_Long, 0, "sc.game_ad_video_end.local", "{}");
  ...
  public void b(boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_AndroidWidgetRelativeLayout == null) || (this.jdField_a_of_type_Akwa == null) || (this.jdField_a_of_type_Akvq == null)) {}
    RelativeLayout localRelativeLayout;
    View localView;
    do
    {
      return;
      localRelativeLayout = (RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131379593);
      localView = this.jdField_a_of_type_Akwa.a();
    } while (localView == null);
    if (paramBoolean) {}
    try
    {
      akro.a().callbackFromRequest(this.jdField_a_of_type_Akvq.jdField_b_of_type_Long, 0, "sc.game_ad_video_view_close.local", "{}");
      label100:
      ...
      try
      {
        akro.a().callbackFromRequest(this.jdField_a_of_type_Akvq.jdField_b_of_type_Long, 0, "cs.xy_life_cycle_event_activity.local", "{}");
        return;
      }
      catch (Exception localException)
      {
  ...
  public void e()
  {
    ...
    this.jdField_a_of_type_Akwa.a(this.jdField_a_of_type_AndroidWidgetRelativeLayout.getContext(), akro.a());
    this.jdField_a_of_type_Akwa.a(this);
  }
  ...
  public void f()
  {
    if (this.jdField_a_of_type_Akwa != null)
    {
      if (this.jdField_a_of_type_Akwa.c() != 5) {
        this.jdField_a_of_type_Akwa.b();
      }
      if (this.jdField_a_of_type_Bhow != null) {
        this.jdField_a_of_type_Bhow.obtainMessage(3).sendToTarget();
      }
    }
  }
  ...
  public void g()
  {
    if ((this.jdField_a_of_type_Akwa != null) && (!this.f) && (this.jdField_a_of_type_Bhow != null) && (this.jdField_a_of_type_Akwa.c() != 5)) {
      this.jdField_a_of_type_Akwa.a();
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 1: 
      do
      {
        ...
        {
          return false;
        } while (this.jdField_a_of_type_Akvq == null);
        b(false);
        m();
        e();
        k();
        if (this.jdField_a_of_type_Akwa != null) {
          this.jdField_a_of_type_Akwa.a(this.jdField_a_of_type_Akvq.j, "sd", 0);
        }
        akro.a().callbackFromRequest(this.jdField_a_of_type_Akvq.jdField_b_of_type_Long, 0, "sc.game_ad_video_start.local", "{}");
        return false;
      } while ((this.jdField_a_of_type_Akwa == null) || (this.jdField_a_of_type_Akwa.a() == null));
      j();
      return false;
    case 2: 
      this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
      ...
      for (;;)
      {
        try
        {
          ...
          if (this.jdField_b_of_type_Int > 15)
          {
            ...
            bdcd.a(localContext, 0, null, paramView, alpo.a(2131702518), alpo.a(2131702517), new akvw(this), new akvx(this)).show();
            return;
          }
        }
