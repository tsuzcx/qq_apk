...
public abstract class bgyv
{
  int jdField_a_of_type_Int;
  bgys jdField_a_of_type_Bgys;
  ...
  public bgyv(bgys parambgys, int paramInt)
  {
    this.jdField_a_of_type_ComTencentMobileqqHighwayApiITransactionCallback = new bgyw(this);
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_JavaLangString = getClass().getSimpleName();
    this.jdField_a_of_type_Bgys = parambgys;
  }
