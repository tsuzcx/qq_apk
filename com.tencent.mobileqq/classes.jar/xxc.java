...
public class xxc
  implements Runnable
{
  public xxc(CameraFilterGLView paramCameraFilterGLView, SVFilterEncodeDoubleCache.SharedMemoryCache paramSharedMemoryCache) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          ThreadManager.getUIHandler().post(new xxd(this, localFile));
    ...
    label279:
    ThreadManager.getUIHandler().post(new xxe(this));
  }
}
