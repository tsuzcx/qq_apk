...
public class mpv
{
  ...
  public static Bitmap a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    Bitmap localBitmap = baxi.a(paramString, localOptions);
    if (localBitmap == null) {
  ...
  public static moz a(VideoAppInterface paramVideoAppInterface)
  {
    return (moz)paramVideoAppInterface.a(7);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          paramBundle = new aqvb((String)localObject, paramQQAppInterface.getCurrentAccountUin(), paramBundle, i, -5040, 65560, 0L);
  ...
  public static boolean a()
  {
    ...
    if ((!lpu.a(4, 1800000L)) && (!lpu.a(8, 1400000L))) {}
    for (;;)
    {
  ...
  {
    boolean bool = muc.a(paramVideoAppInterface).getBoolean("qav_userguide_for_recever", true);
    if (QLog.isColorLevel()) {
