...
public class aooa
  implements apxc
{
  public aooa(FilePreviewActivity paramFilePreviewActivity) {}
  ...
  public void openFile(String paramString1, String paramString2, long paramLong, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        bbcv.a(this.a, 233, this.a.getString(2131718872), "是否下载文件:\n" + paramString1 + "(" + apvb.a(paramLong) + ")", new aoob(this, paramString2, (apcy)localObject2, (Bundle)localObject3), new aooc(this)).show();
        return;
      ...
      localObject1 = localObject2;
    } while (!apvb.b(((FileManagerEntity)localObject3).getFilePath()));
    paramString1 = new apud();
    paramString1.jdField_b_of_type_JavaLangString = "file_viewer_in";
    paramString1.jdField_a_of_type_Int = 73;
    paramString1.c = apvb.a(((FileManagerEntity)localObject3).fileName);
    paramString1.jdField_a_of_type_Long = ((FileManagerEntity)localObject3).fileSize;
    apuc.a(this.a.app.getCurrentAccountUin(), paramString1);
    apuc.a("0X8004AE4");
