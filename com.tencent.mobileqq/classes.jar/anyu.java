  ...
  extends MSFServlet
{
  private void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      notifyObserver(paramIntent, 1, bool1, localBundle, anyt.class);
      return;
      boolean bool1 = false;
      continue;
      bool1 = bool2;
  ...
  private void a(anys paramanys, ArrayList<BusinessCard> paramArrayList, Oidb_0x43c.ResponseCardList paramResponseCardList)
  {
  ...
  {
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApp(), anyu.class);
  ...
  private void b(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramFromServiceMsg = (anys)((QQAppInterface)getAppRuntime()).getManager(112);
      ...
      notifyObserver(paramIntent, 2, bool1, localBundle, anyt.class);
      return;
      bool1 = false;
    }
  }
  ...
  private void c(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      notifyObserver(paramIntent, 3, bool1, localBundle, anyt.class);
      return;
      bool1 = false;
    }
  }
  ...
  private void d(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (bool2)
    {
      try
      {
        ...
        paramFromServiceMsg = (QQAppInterface)getAppRuntime();
        localObject1 = (anys)paramFromServiceMsg.getManager(112);
        ...
        if (((Oidb_0x43c.CardInfo)localObject2).ocr_info.has()) {
          ((anys)localObject1).b((BusinessCard)localObject3);
        }
        if (TextUtils.isEmpty(((BusinessCard)localObject3).bindUin)) {
          break label366;
        }
        if (!((alto)paramFromServiceMsg.getManager(51)).b(((BusinessCard)localObject3).bindUin)) {
          break label446;
        }
        ((anys)localObject1).a(((BusinessCard)localObject3).bindUin, (BusinessCard)localObject3);
      }
      catch (Exception paramFromServiceMsg)
      {
        for (;;)
        {
          ...
          bool1 = false;
          continue;
          ((anys)localObject1).b(((BusinessCard)localObject3).bindUin);
          continue;
          bool1 = false;
        }
      }
    ...
    for (;;)
    {
      notifyObserver(paramIntent, 5, bool1, localBundle, anyt.class);
      return;
      label416:
      ...
      try
      {
        ...
        if ((j == 0) && (((oidb_sso.OIDBSSOPkg)localObject2).bytes_bodybuffer.has()) && (((oidb_sso.OIDBSSOPkg)localObject2).bytes_bodybuffer.get() != null))
        {
          ...
          if (j == i)
          {
            ...
            notifyObserver(paramIntent, 4, false, null, anyt.class);
            return;
          }
          ...
          if (bool)
          {
            ...
            if (((Oidb_0x43c.ResponseCardList)localObject2).mine.has())
            {
              ...
              localBusinessCard.cardType = 1;
              ((anys)localObject1).a(localBusinessCard);
              ((ArrayList)localObject3).add(localBusinessCard);
            }
          }
          a((anys)localObject1, (ArrayList)localObject3, (Oidb_0x43c.ResponseCardList)localObject2);
          ((anys)localObject1).a((List)localObject3, false);
          ...
          ((anys)localObject1).a(j);
          notifyObserver(paramIntent, 4, true, null, anyt.class);
          return;
        }
      }
      catch (Exception paramFromServiceMsg)
