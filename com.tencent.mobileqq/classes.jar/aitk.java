...
public class aitk
{
  ...
  public aitk(ApolloRenderDriver paramApolloRenderDriver, ApolloRender paramApolloRender)
  {
  ...
  public int a(int paramInt, String paramString, int[] paramArrayOfInt, ajkq paramajkq)
  {
    int j = 0;
    if (QLog.isColorLevel()) {
      QLog.d(jdField_a_of_type_JavaLangString, 2, new Object[] { "[onChangeDress] apolloId=", paramString, ", roleType=", Integer.valueOf(paramInt), ", dressId=", paramArrayOfInt, ", callback=", paramajkq });
    }
    int i;
    ...
    paramInt = this.jdField_a_of_type_ComTencentMobileqqApolloApolloRenderDriver.a(paramInt, paramString, paramArrayOfInt, paramajkq);
    this.jdField_a_of_type_ComTencentMobileqqApolloApolloRenderDriver.a();
    return paramInt;
  }
