  ...
  extends awum
{
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    {
      if (!((awul)((Iterator)localObject1).next() instanceof awwi)) {
        break label944;
      }
      i += 1;
    }
    ...
    for (;;)
    {
      ...
      if ((paramView != null) && ((paramView instanceof LinearLayout)))
      {
        ...
        paramView = (awul)this.jdField_a_of_type_JavaUtilArrayList.get(j);
      ...
      for (;;)
      {
        ...
        if ("button".equals(localObject2))
        {
          ...
          if (i == 0)
          {
            ...
            if (m < n)
            {
              localObject2 = (awul)this.jdField_a_of_type_JavaUtilArrayList.get(m);
              ((awul)localObject2).jdField_a_of_type_JavaLangRefWeakReference = this.jdField_a_of_type_JavaLangRefWeakReference;
              str = ((awul)localObject2).jdField_a_of_type_JavaLangString;
            ...
            ((awul)localObject2).jdField_a_of_type_JavaLangRefWeakReference = this.jdField_a_of_type_JavaLangRefWeakReference;
            localObject2 = ((awul)localObject2).a(paramContext, null, paramBundle);
            j = 0;
            if (m == 0)
            {
              j = 2131310763;
            ...
            for (;;)
            {
              ...
              if ("button".equals(str))
              {
                ...
                for (;;)
                {
                  ...
                  return paramView;
                  j = aciy.a(5.0F, localResources);
                  break;
                  label888:
                  k = aciy.a(5.0F, localResources);
                  m = i;
                  n = j;
                  j = k;
                  k = n;
