  ...
  implements View.OnClickListener
{
  ...
  public rkv(rku paramrku, Context paramContext, View paramView, BaseData paramBaseData)
  {
    super(paramView, paramBaseData);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368614));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131363277));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131363289));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131378244));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131363280));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131365912));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131363287));
    ...
    this.jdField_a_of_type_Osm = new rkw(this, paramrku);
    paramView.addOnAttachStateChangeListener(new rkx(this, paramrku));
  }
  
  private int a(int paramInt)
  {
    return (int)Math.floor(((int)bbdh.a(true) - this.jdField_a_of_type_AndroidViewView.getContext().getResources().getDimensionPixelSize(2131298538) * 2 - (paramInt - 1) * this.jdField_a_of_type_AndroidViewView.getContext().getResources().getDimensionPixelSize(2131298539)) * 1.0D / paramInt);
  }
  ...
  private void a(Context paramContext)
  {
    if (rlz.a().b())
    {
      ...
      paramContext = rlz.a().a(paramContext);
      this.jdField_b_of_type_AndroidWidgetTextView.setText(paramContext);
      this.e = vpm.b(BaseApplicationImpl.getApplication().getBaseContext(), 71.0F);
    ...
    catch (Exception paramContext)
    {
      for (;;)
      {
        if (QLog.isColorLevel()) {
          QLog.e(rku.a(), 1, paramContext.toString());
        }
      }
    }
  }
  ...
  private void a(FastWebArticleInfo paramFastWebArticleInfo)
  {
    ...
    this.jdField_a_of_type_AndroidViewAnimationAnimation.setAnimationListener(new rkz(this, paramFastWebArticleInfo));
  ...
  private void a(String paramString)
  {
    ...
    ono localono = rno.a(localArticleInfo);
    for (;;)
    {
      try
      {
        ...
        localono.k();
        localono.l();
        localono.a(localArticleInfo.mAlgorithmID);
        localono.b(localArticleInfo.mStrategyId);
        ...
        rno.a(localArticleInfo, paramString, localono.a());
        return;
      }
      ...
      QLog.e(rku.a(), 2, "parseR5 has error !", paramString);
      return;
      label226:
      int i = 0;
      continue;
  ...
  private void a(boolean paramBoolean)
  {
    ...
    {
      localValueAnimator.addUpdateListener(new rky(this));
  ...
  private void a(boolean paramBoolean, long paramLong, int paramInt, String paramString)
  {
    if (rlz.a().b()) {
      if (paramBoolean)
      {
        ...
        this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130841214);
      }
    }
    try
    {
  ...
  private void b()
  {
    if ((rlz.a().b()) && (this.jdField_a_of_type_ComTencentMobileqqDiniflyLottieDrawable != null))
    {
  ...
  {
    if ((rlz.a().b()) && (!this.jdField_b_of_type_Boolean))
    {
      this.jdField_c_of_type_AndroidWidgetImageView.setVisibility(8);
      this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
    }
    ...
    if (paramBaseData1 != null)
    {
      ...
      this.jdField_a_of_type_AndroidViewView.findViewById(2131369405).setBackgroundColor(0);
      this.jdField_a_of_type_AndroidViewView.findViewById(2131369378).setBackgroundColor(0);
      this.jdField_a_of_type_AndroidViewView.findViewById(2131369441).setBackgroundColor(0);
    ...
    label350:
    label358:
    for (int i = 2130842307;; i = 2130841222)
    {
      paramBaseData2.setImageResource(i);
      ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369379)).setImageResource(2130841209);
      ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369442)).setImageResource(2130842115);
      this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(Color.parseColor("#737373"));
      ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369380)).setTextColor(Color.parseColor("#737373"));
      ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369443)).setTextColor(Color.parseColor("#737373"));
      if (!onh.n())
      {
        paramBaseData1 = (LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131365911);
        this.jdField_a_of_type_AndroidViewView.findViewById(2131365911).setPadding(paramBaseData1.getPaddingLeft(), bbll.b(10.5F), paramBaseData1.getPaddingRight(), paramBaseData1.getPaddingBottom());
      }
      this.jdField_a_of_type_AndroidViewView.findViewById(2131369405).getLayoutParams().height = -2;
      this.jdField_a_of_type_AndroidViewView.findViewById(2131369378).getLayoutParams().height = -2;
      this.jdField_a_of_type_AndroidViewView.findViewById(2131369441).getLayoutParams().height = -2;
      return;
      i = 2130841204;
      break;
    }
    ...
    if (paramBaseData1.jdField_a_of_type_Boolean)
    {
      i = 2130842306;
      paramBaseData2.setImageResource(i);
      this.jdField_a_of_type_AndroidWidgetTextView.setText(bhvy.a(paramBaseData1.jdField_a_of_type_Int, 99990000L, "9999万+", rku.b()));
      if (!paramBaseData1.jdField_a_of_type_Boolean) {
        break label481;
      }
    ...
    label481:
    label489:
    for (paramBaseData1 = this.jdField_a_of_type_AndroidViewView.getResources().getDrawable(2130848410);; paramBaseData1 = this.jdField_a_of_type_AndroidViewView.getResources().getDrawable(2130848409))
    {
      this.jdField_a_of_type_AndroidViewView.findViewById(2131369405).setBackgroundDrawable(paramBaseData1);
      return;
      i = 2130841221;
      break;
      i = -16777216;
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      do
      {
        do
        {
          do
          {
            ...
            {
              actj.a(rku.a(), "", new IllegalArgumentException());
              return;
            }
          ...
          rlz.a().a((FastWebActivity)this.jdField_a_of_type_AndroidViewView.getContext(), this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataBaseData.b.fusionBiuInfo.a, 1, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataBaseData.b.innerUniqueID);
          return;
          if (!rlz.a().b()) {
            break label247;
          }
        ...
        rlz.a().a(this.jdField_a_of_type_AndroidViewView.getContext(), onh.a(), 1, 4, localArticleInfo, 1, localArticleInfo.innerUniqueID);
        return;
      } while (localArticleInfo.fusionBiuInfo == null);
      rlz.a().a(this.jdField_a_of_type_AndroidViewView.getContext(), localArticleInfo.fusionBiuInfo.a, onh.a(), localArticleInfo.mFeedType, 1, localArticleInfo.innerUniqueID);
      return;
      if (localFastWebArticleInfo.jdField_a_of_type_Boolean)
      {
        ...
        rno.b(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataBaseData.b, "0X8009765", "2");
      }
      for (;;)
      {
        a(localFastWebArticleInfo);
        osj.a().c();
        osg.a().a(onh.a(), localFastWebArticleInfo.jdField_a_of_type_Boolean, localFastWebArticleInfo);
        return;
        localFastWebArticleInfo.jdField_a_of_type_Boolean = true;
        localFastWebArticleInfo.jdField_a_of_type_Int += 1;
        rno.b(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataBaseData.b, "0X8009764", "2");
      }
