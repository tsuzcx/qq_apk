...
public abstract class aacm
  extends zxu<CertifiedAccountMeta.StFeed>
  implements aalt, zwr
{
  ...
  private void a(SubscribeFeedsEvent paramSubscribeFeedsEvent)
  {
        ...
        do
        {
          do
          {
            ...
            case 1: 
              if (zzz.a() != null)
              {
                paramSubscribeFeedsEvent.mSingleFakeFeed.poster.icon.set(zzz.a().icon.get());
                paramSubscribeFeedsEvent.mSingleFakeFeed.poster.nick.set(zzz.a().nick.get());
              }
          ...
          localObject = aaaf.a((CertifiedAccountMeta.StFeed)getDataList().get(i));
    ...
    if (zzz.a() != null)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        {
          localStFeed.poster.icon.set(zzz.a().icon.get());
          localStFeed.poster.nick.set(zzz.a().nick.get());
        }
      }
    }
