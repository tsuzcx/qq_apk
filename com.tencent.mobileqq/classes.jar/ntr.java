  ...
  implements View.OnClickListener
{
  ...
  private static boolean jdField_b_of_type_Boolean = ((Boolean)bhvy.a(jdField_a_of_type_JavaLangString, Boolean.valueOf(false))).booleanValue();
  ...
  public ntr(Activity paramActivity)
  {
    super(paramActivity);
    this.jdField_a_of_type_Osm = new nts(this);
    this.jdField_a_of_type_Qtr = new qtr(paramActivity);
  }
  ...
  private void b(ListView paramListView, ram paramram)
  {
    TemplateBean localTemplateBean = null;
    JSONObject localJSONObject = oou.a();
    try
    {
      ...
      localObject = rpr.a("default_feeds", true);
      if (localObject != null) {
        localTemplateBean = ((rpr)localObject).getTemplateBean(localJSONObject);
      }
      if (localTemplateBean != null)
      {
        paramram = paramram.a();
        paramram = paramram.getViewFactory().inflate(paramram, localTemplateBean);
        olo.a(paramram, null, localTemplateBean);
        paramram.setTag(localTemplateBean);
        paramListView.addFooterView(paramram);
        if ((paramListView instanceof ReadInJoyDailyXListView)) {
          ((ReadInJoyDailyXListView)paramListView).setPTSFooterView(paramram);
        }
      }
      else
      {
  ...
  private void l()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetDailyDianDianEntranceView = ((DailyDianDianEntranceView)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyBaseListViewGroup.findViewById(2131365720));
    ...
    {
      return;
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetDailyDianDianEntranceView.a(qzo.a().a(a(), this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetDailyDianDianEntranceView, this));
    } while (qzo.a().a() != 1);
  ...
  private void m()
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyDailyPullToZoomHeaderXListView.a(new rcb());
  }
  
  private void n()
  {
    ozo localozo = osg.a().a();
    if ((localozo != null) && (!jdField_b_of_type_Boolean)) {
      localozo.a(new ntt(this, localozo));
    }
  }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyDailyPullToZoomHeaderXListView = ((ReadInJoyDailyPullToZoomHeaderXListView)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyBaseListViewGroup.findViewById(2131376714));
    l();
    m();
    n();
    ...
    this.jdField_a_of_type_Qva = new qva((FrameLayout)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyBaseListViewGroup.findViewById(2131379077), this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyDailyPullToZoomHeaderXListView, this.jdField_a_of_type_AndroidAppActivity);
  ...
  public void a(ListView paramListView, ram paramram)
  {
    if ((paramListView != null) && (a() != 2)) {
      b(paramListView, paramram);
    }
  }
