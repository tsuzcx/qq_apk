...
public class akwx
{
  ...
  {
    if (azzu.a()) {
      return ajed.aU + "iar" + File.separator;
    }
  ...
  public static void a(Context paramContext, QQAppInterface paramQQAppInterface)
  {
        ...
        do
        {
          do
          {
            do
            {
              ...
              paramQQAppInterface = (aknw)paramQQAppInterface.getManager(168);
            } while (paramQQAppInterface == null);
    ...
    for (;;)
    {
      ...
      if (!bool)
      {
        ...
        localTVK_PlayerVideoInfo.setVid(bcdu.d((String)localObject2));
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        for (;;)
        {
          ...
          localTVK_PlayerVideoInfo.setConfigMap("cache_duration", "60");
          localTVK_PlayerVideoInfo.setConfigMap("cache_servers_type", "20161009");
          localTVK_PlayerVideoInfo.setVid(bcdu.d(paramArVideoResourceInfo));
