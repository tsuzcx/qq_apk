...
public class bila
  extends Dialog
  implements Handler.Callback, View.OnClickListener, bepj, bipy
{
  private float jdField_a_of_type_Float;
  public int a;
  Context jdField_a_of_type_AndroidContentContext;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new bilc(this);
  public View a;
  public ViewGroup a;
  ...
  public boolean a;
  private InputFilter[] jdField_a_of_type_ArrayOfAndroidTextInputFilter = { new bilo(20) };
  ...
  private int j = 580;
  private int k;
  private int l = bhna.jdField_b_of_type_Int;
  private int m;
  private int n;
  
  public bila(Context paramContext, boolean paramBoolean)
  {
    super(paramContext, 2131689640);
    this.jdField_b_of_type_Int = -1;
    this.jdField_c_of_type_Int = bixz.a();
    this.jdField_a_of_type_Bikk = new bikk();
  ...
  private void a()
  {
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)LayoutInflater.from(getContext()).inflate(2131493438, null));
    this.jdField_a_of_type_AndroidViewViewTreeObserver$OnGlobalLayoutListener = new biln(this, null);
    this.jdField_a_of_type_AndroidViewViewGroup.getViewTreeObserver().addOnGlobalLayoutListener(new bilm(this, null));
    this.jdField_a_of_type_ComTencentWidgetFitSystemWindowsRelativeLayout = ((FitSystemWindowsRelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131309756));
    this.jdField_a_of_type_ComTencentWidgetFitSystemWindowsRelativeLayout.setFitsSystemWindows(true);
    this.jdField_a_of_type_ComTencentWidgetFitSystemWindowsRelativeLayout.setOnTouchListener(new bilb(this));
    ...
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131311297);
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiPanelEditTextPanel = ((EditTextPanel)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131299957).findViewById(2131305536));
    ...
    this.jdField_a_of_type_DovComQqImCaptureViewPressScaleTextView = ((PressScaleTextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131311271));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131311272));
    if (this.jdField_d_of_type_Boolean)
    {
      this.jdField_a_of_type_DovComQqImCaptureViewPressScaleTextView.setVisibility(0);
      this.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
      this.jdField_a_of_type_DovComQqImCaptureViewPressScaleTextView.setOnClickListener(new bild(this));
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new bile(this));
    }
    this.jdField_a_of_type_DovComQqImCaptureTextEditTextPreView = ((EditTextPreView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131311309));
    this.jdField_a_of_type_DovComQqImCaptureTextEditTextPreView.setOnClickListener(new bilf(this));
    this.jdField_a_of_type_AndroidWidgetEditText.setFocusableInTouchMode(true);
    this.jdField_a_of_type_AndroidWidgetEditText.setFocusable(true);
    this.jdField_a_of_type_AndroidWidgetEditText.setOnFocusChangeListener(new bilg(this));
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new bilh(this));
    this.jdField_a_of_type_AndroidWidgetEditText.setOnTouchListener(new bili(this));
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout = ((HorizontalSelectColorLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131305103));
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout.setStrokeStrategy(new bixz(), false, 0);
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout.setSelectedStrokeWithColor(bixz.a());
    ...
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout.setOnStrokeSelectedListener(new bilj(this));
  }
  ...
  private void b()
  {
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      if (bjeh.f())
      {
        arrayOfInt = bjeh.a(this.jdField_a_of_type_AndroidContentContext);
  ...
  private void c()
  {
    ...
    getWindow().getDecorView().setOnSystemUiVisibilityChangeListener(new bilk(this));
  }
  ...
  {
    this.jdField_a_of_type_Bhlz = parambhlz;
  }
  
  public void a(bill parambill)
  {
    this.jdField_a_of_type_Bill = parambill;
  }
  ...
  public void a(DynamicTextConfigManager.DynamicTextConfigBean paramDynamicTextConfigBean, int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem != null) && (this.jdField_a_of_type_AndroidWidgetEditText != null) && (paramDynamicTextConfigBean != null))
    {
      ...
      paramDynamicTextConfigBean = this.jdField_a_of_type_Bhlz.a(paramDynamicTextConfigBean.text_id, (List)localObject);
      ...
      if (!(paramDynamicTextConfigBean instanceof bhna)) {
        break label391;
      }
      ((bhna)paramDynamicTextConfigBean).a(this.jdField_c_of_type_Int);
      ...
      if (!this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem.a().equals(bhlz.a(this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem.c(), this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem.b()))) {
        break label427;
      }
    ...
    for (;;)
    {
      ...
      return;
      label357:
      localObject = bhlz.a(bhlz.a(paramDynamicTextConfigBean.text_id), this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem);
  ...
  public void a(DynamicTextItem paramDynamicTextItem, int paramInt)
  {
    ...
    urk.b("EditTextDialog", "setTextInfo:" + paramDynamicTextItem + " index:" + paramInt + " text:" + str1);
    this.jdField_a_of_type_Bikk.jdField_a_of_type_JavaLangString = str1;
    this.jdField_a_of_type_AndroidWidgetEditText.setText(this.jdField_a_of_type_Bikk.jdField_a_of_type_JavaLangString);
    if (this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem.c() != 0)
    {
      if (this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem.a() == null) {
        this.jdField_a_of_type_AndroidWidgetEditText.setFilters(this.jdField_a_of_type_ArrayOfAndroidTextInputFilter);
    ...
    for (;;)
    {
      paramInt = this.jdField_a_of_type_Bhlz.a(paramDynamicTextItem);
      ...
      if (!(this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem instanceof bhna)) {
        break label494;
      }
      paramDynamicTextItem = (bhna)this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem;
  ...
  public void a(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Bill.a(false);
    this.jdField_a_of_type_Bill.a(c(), d());
    this.jdField_a_of_type_DovComQqImCaptureTextEditTextPreView.setPreViewDrawer(null);
    localObject = this.jdField_a_of_type_Bill;
    DynamicTextItem localDynamicTextItem = this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem;
    if (!paramBoolean) {}
    for (paramBoolean = true;; paramBoolean = false)
    {
      ((bill)localObject).a(localDynamicTextItem, paramBoolean, this.g, this.jdField_c_of_type_Boolean);
  ...
  public void b(int paramInt1, int paramInt2)
  {
    ...
    if (paramInt2 == 34)
    {
      ...
      {
        int i1 = this.jdField_a_of_type_Bhlz.a(this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem);
  ...
  public int c()
  {
    ...
    urk.b("EditTextDialog", "getPreViewCenterX:" + i1);
    return i1;
  }
  ...
  public int d()
  {
    ...
    urk.b("EditTextDialog", "getPreViewCenterY()=" + i1);
    return i1;
  }
  ...
  {
    this.jdField_a_of_type_Int = aciy.a(100.0F, getContext().getResources());
    b();
    a();
