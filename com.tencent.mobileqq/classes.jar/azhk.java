  ...
  public static void a(AppRuntime paramAppRuntime)
  {
    ...
    for (;;)
    {
      ...
      if (i < paramAppRuntime.length())
      {
        ...
        localObject1 = new azhl();
        ((azhl)localObject1).jdField_a_of_type_JavaLangString = ((JSONObject)localObject2).optString("title");
        ((azhl)localObject1).b = ((JSONObject)localObject2).optString("subtitle");
        ((azhl)localObject1).c = ((JSONObject)localObject2).optString("bannerLink");
        ((azhl)localObject1).d = ((JSONObject)localObject2).optString("reportName");
        ((azhl)localObject1).jdField_a_of_type_JavaUtilVector = new Vector();
      ...
      for (;;)
      {
        if (j < ((JSONArray)localObject2).length())
        {
          ...
          ((azhl)localObject1).jdField_a_of_type_JavaUtilVector.add(str);
          break label442;
