...
public class anzi
{
  ...
  public static anzi a(String paramString, boolean paramBoolean)
  {
    ...
    do
    {
      try
      {
        paramString = new anzi().a(new JSONObject(paramString));
        return paramString;
      }
    ...
    paramString = new anzi();
    paramString.jdField_a_of_type_Boolean = true;
    return paramString;
  }
  
  private anzi a(JSONObject paramJSONObject)
  {
