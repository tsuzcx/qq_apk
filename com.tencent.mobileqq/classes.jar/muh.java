...
public class muh
{
  private static BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new mui();
  static String jdField_a_of_type_JavaLangString = "actAVGSensorCaseReport";
  int jdField_a_of_type_Int = 0;
  private long jdField_a_of_type_Long;
  ArrayList<muj> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  muj jdField_a_of_type_Muj = null;
  ...
  private void a(int paramInt, ArrayList<muj> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          muj localmuj = (muj)paramArrayList.next();
          JSONObject localJSONObject = new JSONObject();
          localJSONObject.put("i", localmuj.jdField_a_of_type_Int);
          localJSONObject.put("off", localmuj.jdField_a_of_type_Long);
          localJSONObject.put("on", localmuj.jdField_b_of_type_Long);
          localJSONObject.put("why", localmuj.jdField_c_of_type_Long);
  ...
  void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, int paramInt, boolean paramBoolean4, VideoController paramVideoController)
  {
    ...
    long l = System.currentTimeMillis();
    paramVideoController = this.jdField_a_of_type_Muj;
    this.jdField_a_of_type_Muj = null;
    if (paramVideoController != null)
    {
  ...
  void c()
  {
    this.jdField_a_of_type_Muj = new muj(this);
    this.jdField_a_of_type_Muj.jdField_a_of_type_Int = this.h;
    this.h += 1;
    this.jdField_a_of_type_Muj.jdField_a_of_type_Long = System.currentTimeMillis();
    this.jdField_a_of_type_JavaUtilArrayList.add(this.jdField_a_of_type_Muj);
  }
