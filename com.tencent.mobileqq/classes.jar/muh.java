      ...
      for (;;)
      {
        ...
        if (paramNetResp.mResult == 0)
        {
          ...
          try
          {
            ...
            apmw.a(this.a.c, paramNetResp.getParentFile().getAbsolutePath() + File.separator);
            if (QLog.isColorLevel()) {
              QLog.i("ScoreManager", 1, "onDownloadComplete  path : " + paramNetResp.getParentFile().getAbsolutePath());
            }
            if (QLog.isColorLevel())
            {
              QLog.i("ScoreManager", 1, "qav_score_good : " + msw.a("qav_score_good.jpg") + ", qav_score_normal : " + msw.a("qav_score_normal.jpg") + ", qav_score_bad : " + msw.a("qav_score_bad.jpg"));
              return;
            }
          }
