...
public class rsa
{
  ...
  public rsa(int paramInt)
  {
    this.jdField_a_of_type_Int = paramInt;
  }
  
  public static rsa a(oidb_cmd0xbc9.BannerItem paramBannerItem)
  {
    rsa localrsa = null;
    if (paramBannerItem.uint32_banner_type.has())
    {
      if (paramBannerItem.uint32_banner_type.get() == 2) {
        localrsa = rse.b(paramBannerItem);
      }
    }
    else {
      return localrsa;
    }
    return rsc.b(paramBannerItem);
  }
  
  protected static void a(rsa paramrsa, oidb_cmd0xbc9.BannerItem paramBannerItem)
  {
    boolean bool = true;
    if (paramrsa != null)
    {
      ...
      for (;;)
      {
        paramrsa.jdField_a_of_type_Boolean = bool;
        paramrsa.jdField_a_of_type_Long = paramBannerItem.uint64_banner_id.get();
        localObject = paramBannerItem.msg_ad_click_report.get();
        if ((localObject == null) || (((List)localObject).size() <= 0)) {
          break;
        }
        paramrsa.jdField_a_of_type_JavaUtilList = new ArrayList();
        localObject = ((List)localObject).iterator();
        while (((Iterator)localObject).hasNext())
        {
          oidb_cmd0xbc9.AdReport localAdReport = (oidb_cmd0xbc9.AdReport)((Iterator)localObject).next();
          paramrsa.jdField_a_of_type_JavaUtilList.add(rrz.a(localAdReport));
        }
        bool = false;
      }
      ...
      {
        paramrsa.jdField_b_of_type_JavaUtilList = new ArrayList();
        ...
        while (paramBannerItem.hasNext())
        {
          ...
          paramrsa.jdField_b_of_type_JavaUtilList.add(rrz.a((oidb_cmd0xbc9.AdReport)localObject));
        }
      }
    }
  }
  
  public static void a(oidb_cmd0xbc9.BannerItem paramBannerItem, rsa paramrsa)
  {
    if (paramBannerItem.bytes_superscript_color.has()) {
      paramrsa.jdField_a_of_type_JavaLangString = paramBannerItem.bytes_superscript_color.get().toStringUtf8();
    }
    if (paramBannerItem.bytes_superscript_text.has()) {
      paramrsa.jdField_b_of_type_JavaLangString = paramBannerItem.bytes_superscript_text.get().toStringUtf8();
    }
    if (paramBannerItem.bytes_banner_title.has()) {
      paramrsa.d = paramBannerItem.bytes_banner_title.get().toStringUtf8();
    }
  }
  
  public List<String> a(List<rrz> paramList)
  {
    ...
    while (paramList.hasNext()) {
      localArrayList.add(((rrz)paramList.next()).jdField_a_of_type_JavaLangString);
    }
  ...
  protected void a(oidb_cmd0xbc9.BannerItem paramBannerItem)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      while (localIterator.hasNext()) {
        ((List)localObject).add(((rrz)localIterator.next()).a());
      }
    }
