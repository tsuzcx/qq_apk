  ...
  extends ReportDialog
{
  ...
  public rsa(@NotNull Activity paramActivity, @NotNull View paramView, @NotNull RelativeLayout.LayoutParams paramLayoutParams)
  {
  ...
  {
    findViewById(2131365007).setOnTouchListener((View.OnTouchListener)new rsc(this));
    RelativeLayout localRelativeLayout = this.jdField_a_of_type_AndroidWidgetRelativeLayout;
    if (localRelativeLayout == null) {
      Intrinsics.throwUninitializedPropertyAccessException("rootView");
    }
    localRelativeLayout.setOnTouchListener((View.OnTouchListener)rsd.a);
  }
  ...
  private final void a(View paramView, float paramFloat1, float paramFloat2, long paramLong, Function0<Unit> paramFunction0)
  {
    ...
    localValueAnimator.addUpdateListener((ValueAnimator.AnimatorUpdateListener)new rse(paramView));
    if (paramFunction0 != null) {
      localValueAnimator.addListener((Animator.AnimatorListener)new rsf(paramFunction0));
    }
  ...
  protected void onCreate(@Nullable Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_AndroidViewView.setId(2131376036);
    paramBundle = findViewById(2131363525);
    localObject = findViewById(2131376793);
    ...
    a();
    findViewById(2131364112).setOnClickListener((View.OnClickListener)new rsb(this));
    b();
  }
}
