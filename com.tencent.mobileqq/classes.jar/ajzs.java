  ...
  extends WebViewClient
{
  ...
  ajzs(WebViewWrapper paramWebViewWrapper) {}
  ...
  WebResourceResponse a(WebView paramWebView, String paramString)
  {
    ...
    for (;;)
    {
      ...
      this.b.jdField_a_of_type_ComTencentBizUiTouchWebView.post(new ajzt(this, localWebViewPluginEngine, (String)localObject1));
