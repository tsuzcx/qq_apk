...
public class bhld
{
  ...
  public static int a(ShortVideoResourceManager.SVConfigItem paramSVConfigItem)
  {
    ...
    for (int i = 0;; i = -1)
    {
      VideoEnvironment.LogDownLoad("QuicDownProcess", "[checkResourceLowLimitVersion]limitVer=3 downVer=" + paramSVConfigItem.versionCode + " errCode=" + i, null);
      return i;
    }
  }
    ...
    if ((paramString != null) && (paramString.length > 0))
    {
      ...
      while (i < j)
      {
        ...
        if ((localObject.isFile()) && (localObject.exists()))
        {
          ...
          VideoEnvironment.LogDownLoad("QuicDownProcess", "[cleanDirector] delete filename=" + str + " ret=" + bool, null);
        }
        i += 1;
      }
    }
  ...
  public static boolean a(AppInterface paramAppInterface, ShortVideoResourceManager.SVConfigItem paramSVConfigItem)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        VideoEnvironment.LogDownLoad("QuicDownProcess", "[userCheckNeedDownload][checkUncompressedResourceIsOK]Before Uncompresses checkOK=" + bool2, null);
        if (!bool2) {
          continue;
        }
      }
      ...
      {
        i = 4;
        VideoEnvironment.LogDownLoad("QuicDownProcess", "userCheckNeedDownload " + paramAppInterface.getMessage(), paramAppInterface);
        continue;
      }
      VideoEnvironment.LogDownLoad("QuicDownProcess", "userCheckNeedDownload arm_url=" + paramSVConfigItem.arm_url + " " + paramSVConfigItem.armv7a_url + " reason=" + i + " needDownload=" + bool1, null);
      return bool1;
      bool1 = true;
      i = 2;
      continue;
  ...
  private static boolean a(AppInterface paramAppInterface, String paramString, int paramInt)
  {
    ...
    //   34: iconst_0
    //   35: ireturn
    //   36: new 151	java/util/Properties
    //   39: dup
    //   40: invokespecial 152	java/util/Properties:<init>	()V
    //   43: astore 7
    //   45: new 154	java/io/FileInputStream
    //   48: dup
    //   49: aload_0
    //   50: invokespecial 157	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   53: astore 6
    //   55: aload 6
    //   57: astore_0
    //   58: aload 7
    //   60: aload 6
    //   62: invokevirtual 161	java/util/Properties:load	(Ljava/io/InputStream;)V
    //   65: aload 6
    //   67: invokevirtual 164	java/io/FileInputStream:close	()V
    //   70: aload 7
    //   72: ldc 166
    //   74: invokevirtual 170	java/util/Properties:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   77: checkcast 107	java/lang/String
    //   80: invokestatic 176	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   83: istore_3
    //   84: aload 7
    //   86: ldc 178
    //   88: invokevirtual 170	java/util/Properties:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   91: checkcast 107	java/lang/String
    //   94: invokestatic 176	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   97: istore 4
    ...
    //   119: aload 7
    //   121: ldc 180
    //   123: invokevirtual 170	java/util/Properties:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   126: checkcast 107	java/lang/String
    //   129: invokestatic 176	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   132: istore 5
    ...
    //   173: iload_3
    //   174: invokestatic 186	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    ...
    //   192: aconst_null
    //   193: invokestatic 49	com/tencent/mobileqq/shortvideo/VideoEnvironment:LogDownLoad	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   196: iconst_0
    //   197: ireturn
    //   198: astore 7
    //   200: aconst_null
    ...
    //   206: ldc 193
    //   208: aload 7
    //   210: invokestatic 49	com/tencent/mobileqq/shortvideo/VideoEnvironment:LogDownLoad	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   213: aload_1
    //   214: invokevirtual 164	java/io/FileInputStream:close	()V
    //   217: iconst_0
    //   218: ireturn
    //   219: astore_1
    //   220: aconst_null
    //   221: astore_0
    //   222: aload_0
    //   223: invokevirtual 164	java/io/FileInputStream:close	()V
    //   226: aload_1
    //   227: athrow
    //   228: iload 4
    //   230: ifle +82 -> 312
    //   233: new 51	java/io/File
    //   236: dup
    //   237: aload_0
    //   238: invokespecial 58	java/io/File:<init>	(Ljava/lang/String;)V
    //   241: astore_0
    //   242: aload_0
    //   243: invokevirtual 62	java/io/File:exists	()Z
    //   246: ifeq +14 -> 260
    //   249: aload_0
    //   250: invokevirtual 197	java/io/File:length	()J
    //   253: iload 4
    //   255: i2l
    //   256: lcmp
    //   257: ifeq +55 -> 312
    ...
    //   284: aload_0
    //   285: invokevirtual 197	java/io/File:length	()J
    //   288: invokevirtual 204	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   291: ldc 206
    //   293: invokevirtual 34	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   296: aload_0
    //   297: invokevirtual 209	java/io/File:getAbsolutePath	()Ljava/lang/String;
    ...
    //   306: aconst_null
    //   307: invokestatic 49	com/tencent/mobileqq/shortvideo/VideoEnvironment:LogDownLoad	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   310: iconst_0
    //   311: ireturn
    //   312: iload 5
    //   314: ifle +113 -> 427
    //   317: new 51	java/io/File
    //   320: dup
    //   321: aload_1
    //   322: invokespecial 58	java/io/File:<init>	(Ljava/lang/String;)V
    //   325: astore_0
    //   326: aload_0
    //   327: invokevirtual 62	java/io/File:exists	()Z
    //   330: ifeq +14 -> 344
    //   333: aload_0
    //   334: invokevirtual 197	java/io/File:length	()J
    //   337: iload 5
    //   339: i2l
    //   340: lcmp
    //   341: ifeq +86 -> 427
    ...
    //   368: aload_0
    //   369: invokevirtual 197	java/io/File:length	()J
    //   372: invokevirtual 204	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   375: ldc 206
    //   377: invokevirtual 34	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   380: aload_0
    //   381: invokevirtual 209	java/io/File:getAbsolutePath	()Ljava/lang/String;
    ...
    //   390: aconst_null
    //   391: invokestatic 49	com/tencent/mobileqq/shortvideo/VideoEnvironment:LogDownLoad	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   394: iconst_0
    //   395: ireturn
    //   396: astore_0
    //   397: ldc 25
    ...
    //   411: aload_0
    //   412: invokevirtual 147	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   421: aload_0
    //   422: invokestatic 49	com/tencent/mobileqq/shortvideo/VideoEnvironment:LogDownLoad	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   425: iconst_0
    //   426: ireturn
    //   427: iconst_1
    //   428: ireturn
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    VideoEnvironment.LogDownLoad("QuicDownProcess", "isFilterSoExist confVer=" + i, null);
    return i >= 3;
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    for (;;)
    {
      VideoEnvironment.LogDownLoad("QuicDownProcess", "[uncompressResource]loadDir=" + str + " destDir=" + paramString1 + " confVer=" + i + " zipVer=" + paramInt, null);
      if (paramInt > i) {
        break;
      }
      return false;
    ...
    for (;;)
    {
      try
      {
        ...
        VideoEnvironment.LogDownLoad("QuicDownProcess", "[uncompressResource][checkUncompressedResourceIsOK]Before Uncompresses checkOK=" + bool, null);
        if (bool) {
          return false;
        }
        VideoEnvironment.LogDownLoad("QuicDownProcess", "[uncompressResource]clean director=" + paramString1, null);
        a(paramString1);
        FileUtils.uncompressZip(paramString2, paramString1, false);
        bool = a(paramQQAppInterface, paramString1, paramInt);
        VideoEnvironment.LogDownLoad("QuicDownProcess", "[uncompressResource][checkUncompressedResourceIsOK]After Uncompresses checkOK=" + bool, null);
        if (!bool) {
          continue;
        }
      ...
      catch (Exception paramQQAppInterface)
      {
        ...
        VideoEnvironment.LogDownLoad("QuicDownProcess", "exp=", paramQQAppInterface);
        bool = true;
        a.unlock();
        continue;
      }
