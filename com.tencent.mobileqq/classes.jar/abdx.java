...
public class abdx
  implements bfoq
{
  public abdx(FriendProfileCardActivity paramFriendProfileCardActivity, PhoneContactManagerImp paramPhoneContactManagerImp, boolean paramBoolean, bfol parambfol) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      return;
      Object localObject;
      if (bbev.d(this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.app.getApplication().getApplicationContext()))
      {
        ...
        aqbc.a(this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity, (Intent)localObject, 21);
        if (this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.a.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_Int == 53) {
          axqw.b(this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.app, "CliOper", "", "", "0X8007016", "0X8007016", 0, 0, "", "", "", "");
        } else {
          axqw.b(this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.app, "CliOper", "", "", "0X8007168", "0X8007168", 0, 0, "", "", "", "");
        }
      }
      else
      {
        bcpw.a(this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity, 1, ajyc.a(2131704912), 1000).a();
        continue;
        if (bbev.d(this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.app.getApplication().getApplicationContext()))
        {
          ...
          {
            axqw.b(localQQAppInterface, "CliOper", "", "", paramView, (String)localObject, 0, 0, "", "", "", "");
            break;
            bool = false;
            break label472;
            paramView = "0X800603D";
        ...
        bcpw.a(this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity, 1, ajyc.a(2131704897), 1000).a();
      }
    }
  }
}
