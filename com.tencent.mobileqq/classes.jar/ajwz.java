...
public class ajwz
  implements ahml
{
  public ajwz(FrameHelperActivity paramFrameHelperActivity) {}
  ...
  public void a(int paramInt)
  {
    ...
    ahml[] arrayOfahml = this.a.jdField_a_of_type_ArrayOfAhml;
    int j = arrayOfahml.length;
    while (i < j)
    {
      ahml localahml = arrayOfahml[i];
      if (localahml != null) {
        localahml.a(paramInt);
      }
      i += 1;
    }
    this.a.d(true);
  ...
  public void a(int paramInt, float paramFloat)
  {
    ...
    if ((!this.a.getActivity().isFinishing()) && (FrameHelperActivity.a(this.a) != null) && (bfmo.a()))
    {
      localObject1 = FrameHelperActivity.a(this.a).a(bfmo.a);
      if (localObject1 != null) {
        ((bfwg)localObject1).c();
      }
    }
    if (Build.VERSION.SDK_INT >= 11) {}
    Object localObject1 = this.a.jdField_a_of_type_ArrayOfAhml;
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    {
      if (Build.VERSION.SDK_INT < 11) {}
      localObject1 = this.a.jdField_a_of_type_ArrayOfAhml;
      int j = localObject1.length;
      int i = 0;
      while (i < j)
      {
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    ...
    while (i < j)
    {
      ahml localahml = arrayOfahml[i];
      if (localahml != null) {
        localahml.a(paramInt, paramBoolean);
      }
      i += 1;
    }
    if (paramBoolean) {
  ...
  public void b(int paramInt1, int paramInt2)
  {
    ...
    if (this.a.jdField_a_of_type_AndroidViewViewGroup != null) {
      ((ImageView)this.a.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131378653)).setImageResource(0);
    }
    Object localObject1 = this.a.jdField_a_of_type_ArrayOfAhml;
    int j = localObject1.length;
    int i = 0;
