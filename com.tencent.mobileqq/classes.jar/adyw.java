  ...
  extends adoe
{
  ...
  adyw(QQAppInterface paramQQAppInterface, String paramString)
  {
  ...
  public void a(int paramInt1, int paramInt2, String paramString)
  {
    ...
    do
    {
      ...
      this.jdField_c_of_type_Int = 0;
      paramString = this.jdField_a_of_type_Adtf;
      this.jdField_a_of_type_Adtf = null;
  ...
  public boolean b(String paramString)
  {
    ...
    WeakReference localWeakReference = new WeakReference(this);
    if (!((altn)localObject).a(str, paramString, this.jdField_a_of_type_Int, i, new adyx(this, localWeakReference)))
    {
