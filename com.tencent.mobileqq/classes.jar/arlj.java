...
public class arlj
{
  private static arll a = new arll(null);
  ...
  public static void a()
  {
    try
    {
      ...
      JavaHookBridge.findAndHookMethod(localClass1, "setView", new Object[] { View.class, WindowManager.LayoutParams.class, View.class, new arlk(localClass1) });
    }
    catch (NoSuchMethodException localNoSuchMethodException1)
    {
      for (;;)
      {
        ...
        catch (ClassNotFoundException localClassNotFoundException2)
        {
          Class localClass1;
          Class localClass2;
          bbbd.a(localClassNotFoundException2);
          return;
        }
        try
        {
        ...
        {
          bbbd.a(localClassNotFoundException3);
          return;
        }
    ...
    catch (ClassNotFoundException localClassNotFoundException1)
    {
      for (;;)
      {
        bbbd.a(localClassNotFoundException1);
      }
    }
    try
    {
