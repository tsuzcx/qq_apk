  ...
  implements TextWatcher, View.OnClickListener, View.OnTouchListener
{
  ...
  private wux jdField_a_of_type_Wux;
  
  public wuy(NewStyleCountryActivity paramNewStyleCountryActivity, Context paramContext)
  {
    super(paramContext);
    ...
    this.jdField_a_of_type_Wux = new wux(paramNewStyleCountryActivity, null);
    this.jdField_a_of_type_ComTencentWidgetListView.setAdapter(this.jdField_a_of_type_Wux);
  ...
  void a(String paramString)
  {
    ...
    this.jdField_a_of_type_Wux.a(paramString);
    if (this.jdField_a_of_type_Wux.getCount() == 0) {
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    }
    for (;;)
    {
      this.jdField_a_of_type_Wux.notifyDataSetChanged();
      return;
