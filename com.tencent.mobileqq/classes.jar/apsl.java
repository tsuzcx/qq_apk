  ...
  implements Handler.Callback
{
  ...
  private void a(View paramView1, View paramView2, View paramView3)
  {
    ...
    if (this.jdField_a_of_type_ComNineoldandroidsAnimationValueAnimator == null)
    {
      ...
      this.jdField_a_of_type_ComNineoldandroidsAnimationValueAnimator.addUpdateListener(new apsp(this, paramView2, paramView1, paramView3));
      this.jdField_a_of_type_ComNineoldandroidsAnimationAnimator$AnimatorListener = new apsq(this, paramView3);
    }
  ...
  public void j()
  {
    if (this.jdField_a_of_type_AndroidWidgetImageView == null) {
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131368034));
    }
    if (QLog.isColorLevel()) {
  ...
  public void k()
  {
    ...
    localAlphaAnimation.setAnimationListener(new apsm(this));
    ...
    localTranslateAnimation.setAnimationListener(new apsn(this));
    localAnimationSet.addAnimation(localTranslateAnimation);
    localAnimationSet.addAnimation(localAlphaAnimation);
    localAlphaAnimation = new AlphaAnimation(1.0F, 0.0F);
    localAlphaAnimation.setDuration(500L);
    localAlphaAnimation.setStartOffset(1000L);
    localAlphaAnimation.setAnimationListener(new apso(this));
    localAnimationSet.addAnimation(localAlphaAnimation);
