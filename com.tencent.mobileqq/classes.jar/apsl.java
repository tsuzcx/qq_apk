  ...
  implements ark.ModuleCallbackWrapper
{
  ...
  private Map<String, Set<apwd>> jdField_a_of_type_JavaUtilMap = new HashMap();
  private long jdField_b_of_type_Long = 1L;
  public String b;
  private final HashMap<String, apsr> jdField_b_of_type_JavaUtilHashMap = new HashMap();
  public String c;
  ...
  protected apsl(ark.Application paramApplication, long paramLong)
  {
  ...
  {
    return apuh.a(paramSessionInfo);
  }
  ...
  private void a()
  {
    ...
    if (arrayOfapsr != null)
    {
      int j = arrayOfapsr.length;
      int i = 0;
      while (i < j)
      {
        apsr localapsr = arrayOfapsr[i];
        this.jdField_b_of_type_JavaUtilHashMap.put(localapsr.a(), localapsr);
        i += 1;
      }
    }
  }
  ...
  private boolean a(apsr paramapsr)
  {
    if (paramapsr.a()) {}
  ...
  private boolean b(apsr paramapsr)
  {
    if (a()) {
      return true;
    }
  ...
  private boolean c(apsr paramapsr)
  {
    return apqx.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, paramapsr.b());
  }
  ...
  {
    paramString = (apsr)this.jdField_b_of_type_JavaUtilHashMap.get(paramString);
    if (paramString == null) {
      return false;
    }
    if (!a(paramString))
  ...
  {
    apsr localapsr = (apsr)this.jdField_b_of_type_JavaUtilHashMap.get(paramString);
    if (localapsr == null) {
      return false;
    }
    if (!a(paramString))
    ...
    if ((a()) || (localapsr.b()))
    {
      localapsr.a(this, paramArrayOfVariantWrapper, paramVariantWrapper);
      return true;
    }
    QLog.i("ArkApp.ArkAppModuleBase", 1, "Invoke, method not support multiprocess, method=" + localapsr);
    return false;
  }
  ...
  protected void a(String paramString, long paramLong1, long paramLong2)
  {
    if ((!TextUtils.isEmpty(paramString)) && (paramLong2 > 0L))
    {
      ...
      ((Set)localObject).add(new apwd(paramLong1, paramLong2));
    }
  }
  ...
  public void a(List<apwm> paramList)
  {
    if (paramList != null)
    {
      ...
      {
        apwm localapwm = (apwm)paramList.next();
        a(localapwm.jdField_a_of_type_JavaLangString, localapwm.jdField_a_of_type_Long, localapwm.jdField_b_of_type_Long);
      }
    }
  }
  ...
  protected boolean a(String paramString)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      {
        apwd localapwd = (apwd)((Iterator)localObject).next();
        if (!localapwd.a())
        {
          QLog.i("ArkApp", 2, String.format("ModuleBase.checkFrequency.Refuse:%s,%s ", new Object[] { paramString, localapwd.toString() }));
          return false;
        }
      }
      return true;
