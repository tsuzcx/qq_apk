...
public class azep
{
  ...
  public static azem a(Intent paramIntent)
  {
    ...
    azem localazem = azen.a(paramIntent.getStringExtra("q_qssistant_openaction"));
    localazem.jdField_a_of_type_JavaLangString = paramIntent.getStringExtra("q_qssistant_str_name");
    localazem.b = paramIntent.getStringExtra("q_qssistant_str_scheme");
    localazem.e = paramIntent.getStringExtra("q_qssistant_str_package");
    localazem.c = paramIntent.getStringExtra("q_qssistant_str_server");
    localazem.d = paramIntent.getStringExtra("q_qssistant_str_action");
    localazem.jdField_a_of_type_Boolean = paramIntent.getBooleanExtra("q_qssistant_openenable", false);
    localazem.g = paramIntent.getStringExtra("q_qssistant_jump_host");
    if (paramIntent.hasExtra("q_qssistant_extra_field_key"))
    {
      ...
      {
        HashMap localHashMap = localazem.jdField_a_of_type_JavaUtilHashMap;
  ...
  public static azem a(JSONObject paramJSONObject)
  {
    int i = 0;
    ...
    azem localazem = azen.a(str5);
    localazem.jdField_a_of_type_JavaLangString = ((String)localObject);
    ...
    localazem.jdField_a_of_type_Boolean = bool;
    ...
    for (;;)
    {
      ...
      {
        localazem.jdField_a_of_type_JavaUtilHashMap.put(str2, str1);
        i += 1;
        break;
        return localazem;
      }
  ...
  public static List<azem> a(String paramString, List<String> paramList)
  {
    int j = 0;
    Object localObject1;
    if (StringUtil.isEmpty(paramString))
    ...
    for (;;)
    {
      try
      {
        ...
        if (((JSONObject)localObject2).has("qassistantconfigs"))
        {
          ...
          {
            azem localazem = a(((JSONArray)localObject1).getJSONObject(i));
            if (localazem == null) {
              break label230;
            }
            localArrayList.add(localazem);
            break label230;
          }
        }
  ...
  public static void a(azem paramazem, boolean paramBoolean, Intent paramIntent)
  {
    if ((paramazem == null) || (paramIntent == null)) {
      return;
    }
    paramIntent.putExtra("q_qssistant_debug_mode", paramBoolean);
    if (paramazem.jdField_a_of_type_JavaLangString == null)
    {
      localObject = "";
      label29:
      ...
      paramIntent.putExtra("q_qssistant_openenable", paramazem.jdField_a_of_type_Boolean);
      if (paramazem.f != null) {
        break label327;
      }
      localObject = "";
    ...
    label327:
    label336:
    for (Object localObject = "";; localObject = paramazem.g)
    {
      paramIntent.putExtra("q_qssistant_jump_host", (String)localObject);
      int i = paramazem.jdField_a_of_type_JavaUtilHashMap.size();
      if (i <= 0) {
        break;
      }
      arrayOfString1 = new String[i];
      arrayOfString2 = new String[i];
      Iterator localIterator = paramazem.jdField_a_of_type_JavaUtilHashMap.entrySet().iterator();
      i = 0;
      while (localIterator.hasNext())
      {
        localObject = (Map.Entry)localIterator.next();
        paramazem = (String)((Map.Entry)localObject).getKey();
        localObject = (String)((Map.Entry)localObject).getValue();
        arrayOfString1[i] = paramazem;
        paramazem = (azem)localObject;
        if (localObject == null) {
          paramazem = "";
        }
        arrayOfString2[i] = paramazem;
        i += 1;
      }
      localObject = paramazem.jdField_a_of_type_JavaLangString;
      break label29;
      localObject = paramazem.b;
      break label49;
      localObject = paramazem.e;
      break label69;
      localObject = paramazem.c;
      break label89;
      localObject = paramazem.d;
      break label109;
      localObject = paramazem.f;
      break label140;
    }
  ...
  public static void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        bcef.b(null, "dc00898", "", "", "0X800A99A", "0X800A99A", 0, 0, str2, "", paramString, Build.MODEL);
        return;
      }
    }
  }
