  ...
  extends wla
{
  ...
  public wyh(ErrorMessage paramErrorMessage)
  {
    super(paramErrorMessage.errorCode, paramErrorMessage.errorMsg);
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
  }
  
  public wyh(qqstory_service.RspBatchFeedLike paramRspBatchFeedLike)
  {
    ...
    while (paramRspBatchFeedLike.hasNext())
    {
      ...
      wyi localwyi = new wyi();
      localwyi.jdField_a_of_type_JavaLangString = ((qqstory_struct.FeedLikeInfo)localObject).feed_id.get().toStringUtf8();
      localwyi.b = ((qqstory_struct.FeedLikeInfo)localObject).has_like.get();
      localwyi.jdField_a_of_type_Int = ((qqstory_struct.FeedLikeInfo)localObject).like_total_count.get();
      localwyi.jdField_a_of_type_JavaUtilList = new ArrayList();
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        localLikeEntry.feedId = localwyi.jdField_a_of_type_JavaLangString;
        localwyi.jdField_a_of_type_JavaUtilList.add(localLikeEntry);
      }
      this.jdField_a_of_type_JavaUtilList.add(localwyi);
    }
  }
}
