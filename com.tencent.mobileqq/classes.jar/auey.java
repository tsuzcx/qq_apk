  ...
  implements Handler.Callback
{
  ...
  auez jdField_a_of_type_Auez;
  EglHandlerThread jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecEncoderEglHandlerThread;
  String jdField_a_of_type_JavaLangString;
  List<aned> jdField_a_of_type_JavaUtilList = new ArrayList();
  private CopyOnWriteArrayList<WeakReference<aufb>> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList;
  ...
  public auey(Context paramContext, int paramInt1, int paramInt2, int paramInt3)
  {
  ...
  private int a()
  {
    ...
    localaufa.jdField_a_of_type_Int = this.jdField_d_of_type_Int;
    localaufa.jdField_b_of_type_Int = 256;
    localaufa.jdField_c_of_type_Int = 256;
    localaufa.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
    localaufa.jdField_c_of_type_JavaLangString = this.jdField_c_of_type_JavaLangString;
    localaufa.jdField_a_of_type_JavaLangString = auex.a(this.jdField_b_of_type_JavaLangString);
    localaufa.jdField_d_of_type_JavaLangString = this.jdField_d_of_type_JavaLangString;
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append("runType").append("=").append(localaufa.jdField_a_of_type_Int).append("\n");
    localStringBuilder.append("netHeight").append("=").append(localaufa.jdField_b_of_type_Int).append("\n");
    localStringBuilder.append("netWidth").append("=").append(localaufa.jdField_c_of_type_Int).append("\n");
    localStringBuilder.append("paramPath").append("=").append(localaufa.jdField_b_of_type_JavaLangString).append("\n");
    localStringBuilder.append("anchorPath").append("=").append(localaufa.jdField_c_of_type_JavaLangString).append("\n");
    localStringBuilder.append("kernelBinaryIndex").append("=").append(localaufa.jdField_d_of_type_JavaLangString).append("\n");
    localStringBuilder.append("modelString").append("=").append(localaufa.jdField_a_of_type_JavaLangString).append("\n");
    if (QLog.isColorLevel()) {
      QLog.i("MiniRecog.detector", 2, localStringBuilder.toString());
    }
    if ((this.jdField_b_of_type_Int > 0) && (this.jdField_c_of_type_Int > 0)) {
      this.jdField_a_of_type_Int = auev.a(this.jdField_b_of_type_Int, this.jdField_c_of_type_Int);
    }
    this.jdField_a_of_type_Auez = new auez(localaufa);
    if (this.jdField_a_of_type_Auez.a()) {
      return 1;
    }
    return 0;
  }
  ...
  private static void a(int paramInt, Bitmap paramBitmap)
  {
    ...
    auev.a("glBindTexture");
    GLES20.glTexParameterf(3553, 10241, 9729.0F);
    GLES20.glTexParameterf(3553, 10240, 9729.0F);
    GLES20.glTexParameteri(3553, 10242, 33071);
    GLES20.glTexParameteri(3553, 10243, 33071);
    auev.a("glTexParameteri");
  ...
  private boolean a(long paramLong, boolean paramBoolean)
  {
    ...
    if ((((Bitmap)localObject).getWidth() != this.jdField_b_of_type_Int) || (((Bitmap)localObject).getHeight() != this.jdField_c_of_type_Int) || (this.jdField_a_of_type_Int < 0))
    {
      ...
      try
      {
        int j = axuq.a(3553, (Bitmap)localObject);
        i = j;
      }
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Auez != null) {
        break;
      }
      if (QLog.isColorLevel()) {
    ...
    if (this.jdField_a_of_type_Int >= 0)
    {
      List localList = this.jdField_a_of_type_Auez.a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, this.jdField_c_of_type_Int, paramLong, paramBoolean);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_b_of_type_AndroidOsHandler != null)
      {
        ...
        boolean bool1 = auew.jdField_b_of_type_Boolean;
        ...
        if ((this.jdField_b_of_type_AndroidOsHandler != null) && (bool1))
        {
          ...
          {
            localaufb = (aufb)((WeakReference)((Iterator)localObject).next()).get();
            if (localaufb != null) {
              localaufb.a(this.jdField_a_of_type_JavaUtilList, ((Long)paramMessage[1]).longValue());
            }
          }
          this.jdField_b_of_type_Boolean = false;
          return false;
          ...
          {
            localObject = (aufb)((WeakReference)paramMessage.next()).get();
            if (localObject != null) {
              ((aufb)localObject).a(i);
            }
          }
          paramMessage = (Object[])paramMessage.obj;
          ...
          while (((Iterator)localObject).hasNext())
          {
            localaufb = (aufb)((WeakReference)((Iterator)localObject).next()).get();
            if (localaufb != null) {
              localaufb.a(((Long)paramMessage[0]).longValue());
            }
          }
        }
      }
