  ...
  extends FilterOutputStream
{
  ...
  private static bjrc jdField_b_of_type_Bjrc;
  private static int c;
  protected int a;
  private bjrc jdField_a_of_type_Bjrc;
  private boolean jdField_a_of_type_Boolean;
  protected byte[] a;
  private final int jdField_b_of_type_Int = 4;
  
  private bjrc(@NonNull OutputStream paramOutputStream)
  {
    this(paramOutputStream, 8192);
  }
  
  private bjrc(@NonNull OutputStream paramOutputStream, int paramInt)
  {
  ...
  public static bjrc a(@NonNull OutputStream paramOutputStream)
  {
    bjrc localbjrc = null;
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (jdField_b_of_type_Bjrc != null)
      {
        localbjrc = jdField_b_of_type_Bjrc;
        jdField_b_of_type_Bjrc = localbjrc.jdField_a_of_type_Bjrc;
        localbjrc.jdField_a_of_type_Bjrc = null;
        c -= 1;
      }
      if (localbjrc != null)
      {
        localbjrc.out = paramOutputStream;
        localbjrc.jdField_a_of_type_Boolean = true;
        return localbjrc;
      }
    }
    return new bjrc(paramOutputStream);
  }
  ...
  private void a()
  {
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (c < 4)
      {
        this.jdField_a_of_type_Bjrc = jdField_b_of_type_Bjrc;
        jdField_b_of_type_Bjrc = this;
        c += 1;
      }
      return;
    }
