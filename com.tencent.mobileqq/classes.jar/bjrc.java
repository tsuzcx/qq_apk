...
public class bjrc
{
  ...
  public static int a()
  {
    return bjjo.a().a().getSharedPreferences("qzoneappcenter", 4).getInt("appTabVersionCode", -1);
  }
  ...
  public static String a(WebView paramWebView, HashMap<String, awfw> paramHashMap, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (i < localJSONArray2.length())
        {
          ...
          bjtx.c("Common", "nameSpace:" + paramString + ",methodName=" + str1 + ",paramsStr=" + paramWebView);
      ...
      catch (UnsupportedEncodingException paramWebView)
      {
        try
        {
          ...
          {
            paramWebView = (Class)bjrk.jdField_a_of_type_JavaUtilHashMap.get(paramString);
            if (bjrk.jdField_a_of_type_JavaUtilArrayList.contains(str1)) {
            ...
            if (paramWebView != null)
            {
              ...
              if (j < k)
              {
                ...
                if ((paramWebView.getName().equals(str1)) && (paramWebView.getParameterTypes().length == ((List)localObject).size()))
                {
                  ...
                  try
                  {
                    bjtx.c("Common", "callBatch <call> class : " + paramString.getClass().getName() + " , method : " + str1 + "\n , args : " + localObject.toString());
                  ...
                  {
                    bjtx.c("Common", "callBatch error", paramWebView);
                  }
                  paramWebView = paramWebView;
                  bjtx.b("Common", "callBatch decode params format err", paramWebView);
        ...
        {
          bjtx.e("Common", "callBatch args error : " + paramWebView.toString());
        }
      }
      catch (JSONException paramWebView)
      {
        bjtx.b("Common", "callBatch request params format err", paramWebView);
        continue;
        j += 1;
        continue;
        ...
        else if ((paramString instanceof Boolean))
        {
          ...
          localJSONObject.put("data", localJSONArray1);
          bjtx.c("Common", "Response<callBatch> syncCallBatch result : " + localJSONObject);
        }
        else
        {
          paramWebView = "";
  ...
  public static void a()
  {
    try
    {
      bjtx.b("Common", "<initSystemFolder> begin to init system file... ");
  ...
  {
    SharedPreferences.Editor localEditor = bjjo.a().a().getSharedPreferences("qzoneappcenter", 4).edit();
  ...
  {
    bjtx.c("Common", "setResourceMD5=" + paramString);
    SharedPreferences.Editor localEditor = bjjo.a().a().getSharedPreferences("qzoneappcenter", 4).edit();
  ...
  public static long[] a()
  {
    SharedPreferences localSharedPreferences = bjjo.a().a().getSharedPreferences("qzoneappcenter", 4);
  ...
  public static String[] a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      bjtx.c("Common", "url params= " + str2 + " " + paramString);
  ...
  {
    bjtx.c("Common", "setLastResourceZipMd5=" + paramString);
    SharedPreferences.Editor localEditor = bjjo.a().a().getSharedPreferences("qzoneappcenter", 4).edit();
  ...
  {
    return bjjo.a().a().getSharedPreferences("qzoneappcenter", 4).getBoolean("appstoreclearcache", false);
  }
  ...
  {
    String str = q();
    bjtx.b("Common", "<getSDResDir> getSDResDir=" + str);
    if (TextUtils.isEmpty(str)) {
      return "";
    }
  ...
  {
    return bjjo.a().a().getSharedPreferences("qzoneappcenter", 4).getString("relastmd5", "");
  }
  
  public static String o()
  {
    return bjjo.a().a().getSharedPreferences("qzoneappcenter", 4).getString("lastresourcezipmd5", "");
  }
  
  public static String p()
  {
    return bjjo.a().a().getSharedPreferences("qzoneappcenter", 4).getString("appstoreagentversion", "");
  }
  
  public static String q()
  {
    return bjjo.a().a().getSharedPreferences("qzoneappcenter", 4).getString("sdhtmldir", "");
  }
  ...
  public static String r()
  {
    ...
    {
      bjtx.c("Common", "exception happened!");
      return "";
    }
    return "";
  }
