  ...
  extends aeoo
{
  private boolean Y;
  private boolean Z;
  private ajtq jdField_a_of_type_Ajtq = new aemq(this);
  public ajvs a;
  ajxn jdField_a_of_type_Ajxn;
  protected akav a;
  private akdo jdField_a_of_type_Akdo = new aemv(this);
  private akgi jdField_a_of_type_Akgi = new aemw(this);
  public Handler a;
  bdto jdField_a_of_type_Bdto;
  public bduv a;
  ...
  public aemj(QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, FragmentActivity paramFragmentActivity, Context paramContext)
  {
    super(paramQQAppInterface, paramViewGroup, paramFragmentActivity, paramContext);
    this.jdField_g_of_type_JavaLangString = "BusinessChatPie";
    this.jdField_g_of_type_Long = 0L;
    this.jdField_a_of_type_AndroidOsHandler = new aemk(this);
    this.jdField_b_of_type_JavaUtilList = null;
    this.jdField_a_of_type_Akav = new aemy(this);
    this.jdField_a_of_type_Ajvs = new aemn(this);
    this.jdField_b_of_type_Akav = new aemp(this);
    this.jdField_a_of_type_Bduv = new aemr(this);
  }
  
  private void C(int paramInt)
  {
    MessageForGrayTips localMessageForGrayTips = (MessageForGrayTips)axaq.a(2024);
    ...
    String str = ((Resources)localObject2).getString(2131694080);
    localObject2 = ((Resources)localObject2).getString(2131694081);
  ...
  private void bA()
  {
    if (this.jdField_a_of_type_Bdto.f(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString))
    {
      this.jdField_d_of_type_AndroidWidgetLinearLayout.setVisibility(8);
      if (this.jdField_a_of_type_ComTencentWidgetXEditTextEx != null)
      {
        actn.a(this.jdField_a_of_type_ComTencentWidgetXEditTextEx, 2130848771);
        n();
      }
      ...
      if (this.jdField_a_of_type_ComTencentWidgetXEditTextEx != null)
      {
        ...
        localLayoutParams.leftMargin = actn.a(8.0F, (Resources)localObject);
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_ComTencentWidgetXEditTextEx != null)
      {
        actn.a(this.jdField_a_of_type_ComTencentWidgetXEditTextEx, 2130848912);
        if (CustomMenuBar.a()) {
  ...
  private void bB()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioPanelPanelIconLinearLayout == null) || (this.jdField_a_of_type_ComTencentMobileqqActivityAioPanelPanelIconLinearLayout.getVisibility() != 0) || (this.jdField_a_of_type_ComTencentMobileqqActivityAioPanelPanelIconLinearLayout.jdField_a_of_type_Int <= 0)) {
      i = actn.a(8.0F, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources());
    }
  ...
  private void bC()
  {
    ...
    this.jdField_a_of_type_ComTencentBizUiCustomMenuBar = ((CustomMenuBar)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131365816));
    Object localObject = this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131365815);
    ((View)localObject).setOnClickListener(new aemz(this));
    this.jdField_a_of_type_ComTencentBizUiCustomMenuBar.setCoverView((View)localObject);
    this.jdField_a_of_type_ComTencentBizUiCustomMenuBar.setOnMenuItemClickListener(new aeml(this));
    this.jdField_a_of_type_ComTencentBizUiCustomMenuBar.setOnBackClickListner(new aemm(this));
    if (this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getIntent().getBooleanExtra("crm_ivr_aio_video_action_sheet", false)) {
      nbc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
    }
    for (;;)
    {
      ...
      ((FrameLayout.LayoutParams)localObject).gravity = 16;
      this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setLayoutParams((ViewGroup.LayoutParams)localObject);
      this.jdField_p_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_d_of_type_AndroidWidgetLinearLayout.findViewById(2131365817));
      ...
      if (CustomMenuBar.a())
      {
        ...
        this.jdField_a_of_type_ComTencentBizUiCustomMenuBar.setMinimumHeight(actn.a(48.0F, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources()));
      }
      this.s = ((ImageView)this.jdField_d_of_type_AndroidWidgetLinearLayout.findViewById(2131371783));
      this.s.setOnClickListener(this);
      this.jdField_r_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_d_of_type_AndroidWidgetLinearLayout.findViewById(2131365561));
      this.jdField_r_of_type_AndroidWidgetImageView.setOnClickListener(this);
      if (!CustomMenuBar.a())
      {
        this.jdField_r_of_type_AndroidWidgetImageView.setImageResource(2130846982);
  ...
  private void bD()
  {
    ...
    PubAccountNavigationMenu localPubAccountNavigationMenu = ((bduy)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(105)).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    ...
    {
      localbduw.a(l1, l2, i, this.jdField_r_of_type_Int, false);
      return;
    }
  }
  ...
  protected boolean D()
  {
    akdi localakdi;
    long l1;
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1024) && (!myy.b(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)))
    {
      boolean bool = this.jdField_a_of_type_Bdto.f(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      if (QLog.isColorLevel()) {
        QLog.i("ChatActivity", 2, "showOrHideFollow isQidianMasterInCache: " + bool);
      }
      if (bool) {
        return !this.jdField_a_of_type_Ajxn.b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      }
    ...
    if (!localakdi.a(Long.valueOf(l1))) {
      return true;
    }
    return false;
  }
  ...
  public void G()
  {
    ...
    if ((this.jdField_a_of_type_Bdto != null) && (this.jdField_a_of_type_Bdto.f(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString))) {
      ((bduw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(85)).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, null, true);
    }
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioInputLinearLayout != null) {
      this.jdField_a_of_type_ComTencentMobileqqActivityAioInputLinearLayout.setPadding(this.jdField_a_of_type_ComTencentMobileqqActivityAioInputLinearLayout.getPaddingLeft(), this.jdField_a_of_type_ComTencentMobileqqActivityAioInputLinearLayout.getPaddingTop(), this.jdField_a_of_type_ComTencentMobileqqActivityAioInputLinearLayout.getPaddingRight(), 0);
    }
  ...
  public void M()
  {
    ...
    j = i;
    if (this.I) {
      j = i - actn.a(3.0F, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getResources());
    }
  ...
  public void a(PubAccountNavigationMenu paramPubAccountNavigationMenu)
  {
    ...
    while (!QLog.isColorLevel()) {
      try
      {
        ...
        paramPubAccountNavigationMenu = axuy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, Long.parseLong(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString), paramPubAccountNavigationMenu.xml.getBytes(), 0);
        if (paramPubAccountNavigationMenu != null)
        {
          long l1 = awyl.jdField_a_of_type_Int;
          paramPubAccountNavigationMenu = axaq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, l1, paramPubAccountNavigationMenu);
          if (paramPubAccountNavigationMenu != null)
          {
  ...
  public boolean a(boolean paramBoolean)
  {
    ...
    {
      bC();
      if (!this.jdField_a_of_type_Bdto.f(a()))
      {
        bt();
        aoee.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, a(), false);
      }
    }
    this.Y = this.jdField_a_of_type_Bdto.f(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    bv();
    Object localObject;
    if (!this.jdField_a_of_type_Bdto.f(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString))
    {
      ...
      nbc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, (BusinessObserver)localObject);
      if (this.jdField_a_of_type_ComTencentMobileqqActivityAioPanelPanelIconLinearLayout != null)
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityAioPanelPanelIconLinearLayout.setCustomHeight(0);
        bB();
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Bdto.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, (BmqqAccountType)localObject);
    }
  }
  ...
  public void afterTextChanged(Editable paramEditable)
  {
    ...
    if (!bdto.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) {
      a(paramEditable);
    }
  }
  ...
  public void an()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Ajvs);
  ...
  public void ao()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Ajvs);
  ...
  public void b(int paramInt1, int paramInt2)
  {
    ...
    aefv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "0X8008AAA", "C_Master_PTT", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, a(paramInt1), paramInt2);
  }
  ...
  public void b(List<StructMsg.ButtonInfo> paramList)
  {
    ...
    for (;;)
    {
      ...
      while ((i < j) && (i <= 2))
      {
        ...
        xee localxee = new xee(((StructMsg.ButtonInfo)localObject).key.get(), ((StructMsg.ButtonInfo)localObject).name.get(), null, ((StructMsg.ButtonInfo)localObject).id.get());
        if (((StructMsg.ButtonInfo)localObject).sub_button.get().size() > 0)
        {
          ...
          while (((Iterator)localObject).hasNext())
          {
            ...
            localxee.a(new xee(localButtonInfo.key.get(), localButtonInfo.name.get(), null, localButtonInfo.id.get()));
          }
        }
        this.jdField_a_of_type_ComTencentBizUiCustomMenuBar.a(localxee, a());
        i += 1;
      }
    }
  }
  ...
  protected void bo()
  {
    if (!this.jdField_a_of_type_Bdto.g(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString))
    {
      if (QLog.isColorLevel()) {
  ...
  protected void bp()
  {
    ...
    if (this.jdField_c_of_type_AndroidWidgetLinearLayout == null)
    {
      ...
      this.o.findViewById(2131369930).setVisibility(8);
      this.l = ((TextView)this.o.findViewById(2131369933));
      ...
      ((ImageView)this.o.findViewById(2131369920)).setImageResource(2130841293);
      this.o.setOnClickListener(localaemt);
      ...
      this.m = ((TextView)localView.findViewById(2131369933));
      ...
      ((ImageView)localView.findViewById(2131369920)).setImageResource(2130841193);
      localView.setTag(Integer.valueOf(3));
      localView.setOnClickListener(localaemt);
    ...
    for (;;)
    {
      if ((this.m != null) && (this.jdField_a_of_type_Bdto.f(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString))) {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_AndroidViewView != null)
        {
          ...
          int i = j;
          if (this.I) {
            i = j - actn.a(3.0F, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getResources());
          }
  ...
  protected void bq()
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_AndroidViewView != null)
      {
        ...
        if (this.I)
        {
          i -= actn.a(3.0F, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getResources());
          RelativeLayout.LayoutParams localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_a_of_type_AndroidViewView.getLayoutParams();
  ...
  void br()
  {
    ...
    this.jdField_a_of_type_MqqAppNewIntent = new NewIntent(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getApplicationContext(), nou.class);
  ...
  protected void bs()
  {
    ...
    do
    {
      ...
      this.jdField_r_of_type_AndroidWidgetImageView.setImageResource(2130844022);
    ...
    if (this.f == 2)
    {
      ...
      {
        if (CustomMenuBar.a()) {
          this.jdField_r_of_type_AndroidWidgetImageView.setImageResource(2130848809);
        }
        for (;;)
        {
          this.jdField_r_of_type_AndroidWidgetImageView.setContentDescription(this.jdField_a_of_type_AndroidContentContext.getString(2131698460));
          return;
          this.jdField_r_of_type_AndroidWidgetImageView.setImageResource(2130849202);
        }
      }
      if (CustomMenuBar.a()) {
        this.jdField_r_of_type_AndroidWidgetImageView.setImageResource(2130848808);
      }
      for (;;)
      {
        this.jdField_r_of_type_AndroidWidgetImageView.setContentDescription(this.jdField_a_of_type_AndroidContentContext.getString(2131698459));
        return;
        this.jdField_r_of_type_AndroidWidgetImageView.setImageResource(2130849203);
      }
    }
    this.jdField_r_of_type_AndroidWidgetImageView.setEnabled(true);
    if (this.jdField_a_of_type_ComTencentWidgetXPanelContainer.a() == 3)
  ...
  public void bt()
  {
    ...
    List localList = aoee.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, a());
  ...
  public void bu()
  {
    ...
    if (!this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getIntent().getBooleanExtra("isforceRequestDetail", false))
    {
      ...
      if (localObject != null) {
        this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo = ((akdi)localObject).c(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      }
    }
    ...
    for (;;)
    {
      ...
      return;
      localObject = new NewIntent(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getApplicationContext(), mxh.class);
      ...
      try
      {
        ...
        ((NewIntent)localObject).setObserver(new aemo(this));
        if (QLog.isColorLevel()) {
  ...
  public void bw()
  {
    ...
    do
    {
      ...
      this.Z = false;
    } while (!this.jdField_a_of_type_Bdto.c(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, false));
    bD();
  }
  ...
  public void c(int paramInt1, int paramInt2)
  {
    ...
    if (paramInt2 == 8) {
      if (this.s != null)
      {
        ...
        this.s.setImageResource(2130848858);
      }
    }
    label40:
    while (this.s == null)
    {
      return;
      this.s.setImageResource(2130848780);
      return;
    }
    if (CustomMenuBar.a())
    {
      this.s.setImageResource(2130848857);
      return;
    }
    this.s.setImageResource(2130848779);
  }
  ...
  public void d(Intent paramIntent)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("BusinessChatPie", 2, "From chatActivity : buinessCrm Sigt--->" + bbdm.a(paramIntent));
    }
    if (paramIntent != null)
    {
  ...
  public void f(String paramString)
  {
    ...
    {
      localPubAccountNavigationMenu = ((bduy)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(105)).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      if (!"1".equals(paramString)) {
        break label108;
      }
      l1 = Long.parseLong(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      paramString = (bduw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(85);
  ...
  {
    if (paramView.getId() == 2131365817) {
      t(true);
    }
    if ((paramView.getId() == 2131365561) && (this.f != 1))
    {
      if (this.jdField_a_of_type_ComTencentWidgetXPanelContainer.a() == 3)
      {
        this.jdField_a_of_type_ComTencentWidgetXPanelContainer.a(1);
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "ep_mall", "0X8005796", 0, 0, "", "", "", "");
      }
    }
    ...
    for (;;)
    {
      ...
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "ep_mall", "0X8005795", 0, 0, "", "", "", "");
      break;
      label231:
      ah();
  ...
  public void s()
  {
    if (this.jdField_a_of_type_Bdto.c(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString))
    {
      this.jdField_d_of_type_AndroidWidgetImageView.setOnClickListener(new aemx(this));
  ...
  public void x()
  {
    ...
    if (this.jdField_a_of_type_Bdto.f(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString))
    {
      ...
      if (this.jdField_a_of_type_Ajxn.b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) {}
      for (;;)
      {
    ...
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "Biz_card", "Open_biz_card", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "", "", "");
    nbc.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, null, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, true, -1, true, 2000);
  }
