  ...
  public void a(Context paramContext, ColorNote paramColorNote)
  {
    ...
    do
    {
      try
      {
        ...
        bizm.a(paramContext, bizt.a(), Long.valueOf(l).toString(), i + "", paramColorNote, (String)localObject1, 0, localBundle, true, true);
        return;
      }
      ...
      if (((String)localObject1).startsWith("qzone_userhome")) {
        try
        {
          ...
          bizm.a(paramContext, bizt.a(), paramColorNote, 0, 0, 0, null, null, true);
          return;
        }
        catch (JSONException paramContext)
        {
    ...
    try
    {
      ...
      bizm.a(paramContext, bizt.a(), paramColorNote, 0, 0, null, (String)localObject1, true);
      return;
    }
    catch (JSONException paramContext)
    {
