...
class ahyn
{
  ...
  public ahyn(String paramString, float paramFloat1, int paramInt, float paramFloat2, float paramFloat3, Typeface paramTypeface)
  {
    this.jdField_a_of_type_Int = -1;
    this.jdField_a_of_type_Ahzi = new ahzi(paramString, paramFloat1, paramInt, paramFloat2, -1.0F, 1, -1.0F, paramTypeface);
    this.b = new ahzi(paramString, paramFloat1, -1, paramFloat2, -1.0F, 1, paramFloat3, paramTypeface);
  ...
  private void b(String paramString)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_AndroidGraphicsBitmap = ahyq.a(this.b.jdField_a_of_type_Float + 5.0F, this.b.b);
    ...
    this.jdField_a_of_type_Ahzi.a(paramString, 0.0F, 0.0F);
  }
  ...
  public void a(Canvas paramCanvas, float paramFloat1, float paramFloat2)
  {
    ...
    if (this.jdField_a_of_type_AndroidGraphicsBitmap == null)
    {
      ...
      this.jdField_a_of_type_Ahzi.a(paramCanvas, paramFloat1, paramFloat2);
      return;
    }
  ...
  public void a(RenderBuffer paramRenderBuffer, float paramFloat1, float paramFloat2)
  {
    ...
    ahyq.a(paramRenderBuffer, this.jdField_a_of_type_Int, this.b.jdField_a_of_type_Float, this.b.b, null, paramFloat1, paramFloat2);
  }
  ...
  public void a(String paramString)
  {
    ...
    {
      this.jdField_a_of_type_Boolean = bool;
      if (!a(paramString, this.jdField_a_of_type_Ahzi.jdField_a_of_type_JavaLangString))
      {
