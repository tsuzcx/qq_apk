...
public class amad
  implements amai, Handler.Callback, View.OnClickListener
{
  private int jdField_a_of_type_Int = 0;
  long jdField_a_of_type_Long;
  private alzx jdField_a_of_type_Alzx;
  ...
  public amad(RelativeLayout paramRelativeLayout, boolean paramBoolean, int paramInt)
  {
  ...
  private ImageView a(int paramInt)
  {
    ...
    if (2 == paramInt) {
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidWidgetRelativeLayout.getContext().getResources().getDrawable(2130838537));
    }
    do
    {
      ...
      if (1 == paramInt)
      {
        localImageView.setImageDrawable(this.jdField_a_of_type_AndroidWidgetRelativeLayout.getContext().getResources().getDrawable(2130838525));
        return localImageView;
      }
    } while (3 != paramInt);
    localImageView.setImageDrawable(this.jdField_a_of_type_AndroidWidgetRelativeLayout.getContext().getResources().getDrawable(2130838526));
    return localImageView;
  }
  ...
  private boolean a()
  {
    if (this.jdField_a_of_type_Alzx == null) {}
    while ((this.jdField_a_of_type_Alzx.jdField_a_of_type_Int != 585) && (this.jdField_a_of_type_Alzx.jdField_a_of_type_Int != 565)) {
      return false;
    }
    return true;
  }
  ...
  private void j()
  {
    ...
    {
      i = 1;
      m = this.jdField_a_of_type_Amaj.a();
      i1 = this.jdField_a_of_type_Amaj.b();
    ...
    for (int k = Math.max(((DisplayMetrics)localObject).widthPixels, ((DisplayMetrics)localObject).heightPixels);; k = Math.min(((DisplayMetrics)localObject).widthPixels, ((DisplayMetrics)localObject).heightPixels))
    {
      ...
      this.jdField_c_of_type_AndroidWidgetImageView.setImageDrawable(URLDrawable.getDrawable(this.jdField_a_of_type_Alzx.h, (URLDrawable.URLDrawableOptions)localObject));
  ...
  private void k()
  {
    ...
    if (this.jdField_c_of_type_Boolean) {
      this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.jdField_a_of_type_AndroidWidgetRelativeLayout.getContext().getResources().getDrawable(2130838512));
    }
    View localView;
    for (;;)
    {
      localView = this.jdField_a_of_type_Amaj.a();
      if (localView != null) {
        break;
      }
      QLog.w("cmgame_process.CmGameVideoViewController", 1, "[setViewStatus], videoView is null.");
      return;
      this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.jdField_a_of_type_AndroidWidgetRelativeLayout.getContext().getResources().getDrawable(2130838513));
    }
    try
    {
      Object localObject = (RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131380510);
      ...
      l();
      localView.setOnClickListener(new amah(this));
      return;
    }
    catch (Throwable localThrowable)
    {
  ...
  private void l()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        Object localObject1 = (RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131363624);
        localObject7 = (RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131363625);
        ((RelativeLayout)localObject7).setOnClickListener(this);
        ((RelativeLayout)localObject1).setOnClickListener(this);
        if (this.jdField_a_of_type_Alzx.jdField_a_of_type_Int == 185)
        {
          ...
          {
            if (TextUtils.isEmpty(this.jdField_a_of_type_Alzx.f)) {
              break label852;
            }
            ...
            ((URLDrawable.URLDrawableOptions)localObject7).mLoadingDrawable = ((Resources)localObject8).getDrawable(2130845375);
            ((URLDrawable.URLDrawableOptions)localObject7).mFailedDrawable = ((Resources)localObject8).getDrawable(2130845375);
            localObject7 = URLDrawable.getDrawable(this.jdField_a_of_type_Alzx.f, (URLDrawable.URLDrawableOptions)localObject7);
            ((URLDrawable)localObject7).setTag(bfol.b(UIUtils.dip2px(BaseApplicationImpl.getContext(), 200.0F), UIUtils.dip2px(BaseApplicationImpl.getContext(), 200.0F), DisplayUtil.dip2px(this.jdField_a_of_type_AndroidWidgetRelativeLayout.getContext(), 12.0F)));
            ((URLDrawable)localObject7).setDecodeHandler(bfol.c);
            ((ImageView)localObject4).setImageDrawable((Drawable)localObject7);
          }
          if (localObject6 != null) {
            ((TextView)localObject6).setText(this.jdField_a_of_type_Alzx.d);
          }
          if (localObject3 != null)
          {
            localObject6 = this.jdField_a_of_type_Alzx.e;
            ...
            ((TextView)localObject3).setText(amtj.a(2131701295) + (String)localObject4);
          }
          if (localObject5 != null)
          {
            if ((this.jdField_a_of_type_Alzx.jdField_b_of_type_Int != 12) && (this.jdField_a_of_type_Alzx.jdField_b_of_type_Int != 19)) {
              break label862;
            }
            ((Button)localObject5).setText(amtj.a(2131701293));
            ((Button)localObject5).setOnClickListener(this);
          }
          if (localTextView == null) {
            break;
          }
          this.jdField_a_of_type_Alzx.jdField_a_of_type_Double /= 2.0D;
          localObject3 = new StringBuilder(500);
          if ((Double.compare(this.jdField_a_of_type_Alzx.jdField_a_of_type_Double, 0.0D) != 0) && (this.jdField_a_of_type_Alzx.jdField_a_of_type_Double >= 3.0D)) {
            break label876;
          }
          ...
          if ((0L != this.jdField_a_of_type_Alzx.jdField_a_of_type_Long) && (this.jdField_a_of_type_Alzx.jdField_a_of_type_Long >= 100000L)) {
            break label931;
          }
      ...
      Object localObject3 = (TextView)localThrowable.findViewById(2131362033);
      ...
      continue;
      label646:
      Object localObject7 = (RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131363624);
      ...
      localObject3 = (TextView)((RelativeLayout)localObject7).findViewById(2131362033);
      ...
      label852:
      ((ImageView)localObject4).setImageResource(2130838543);
      continue;
      label862:
      ((Button)localObject5).setText(amtj.a(2131701290));
      continue;
      label876:
      if (localObject2 != null) {
        ((LinearLayout)localObject2).setVisibility(0);
      }
      a(this.jdField_a_of_type_Alzx.jdField_a_of_type_Double, (LinearLayout)localObject2);
      ((StringBuilder)localObject3).append(new DecimalFormat("0.0").format(this.jdField_a_of_type_Alzx.jdField_a_of_type_Double)).append("分 ");
      continue;
      label931:
      if (this.jdField_a_of_type_Alzx.jdField_a_of_type_Long < 1000000L) {
        ((StringBuilder)localObject3).append(this.jdField_a_of_type_Alzx.jdField_a_of_type_Long);
      }
      for (;;)
      {
        if ((this.jdField_a_of_type_Alzx.jdField_b_of_type_Int != 12) && (this.jdField_a_of_type_Alzx.jdField_b_of_type_Int != 19)) {
        ...
        break;
        if (this.jdField_a_of_type_Alzx.jdField_a_of_type_Long < 100000000L) {
          ((StringBuilder)localObject3).append(new BigDecimal(this.jdField_a_of_type_Alzx.jdField_a_of_type_Long / 10000.0D).setScale(0, 4)).append("万");
        } else {
          ((StringBuilder)localObject3).append(new BigDecimal(this.jdField_a_of_type_Alzx.jdField_a_of_type_Long / 100000000.0D).setScale(0, 4)).append("亿");
        }
      }
      label1082:
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Amaj = new amaa();
    this.jdField_a_of_type_Amaj.a(this.jdField_a_of_type_AndroidWidgetRelativeLayout.getContext(), alvx.a());
    this.jdField_a_of_type_Amaj.a(this);
  }
  ...
  {
    if ((this.jdField_a_of_type_Alzx == null) || (this.jdField_a_of_type_Amaj == null)) {}
    while ((this.jdField_a_of_type_Boolean) && (!paramBoolean)) {
      return;
    }
    VipUtils.a(null, "cmshow", "Apollo", "video_SPA", this.jdField_a_of_type_Alzx.jdField_c_of_type_Int, paramInt1, new String[] { Integer.toString(this.jdField_c_of_type_Int), Long.toString(this.jdField_b_of_type_Int), Integer.toString(paramInt2), Integer.toString(this.jdField_a_of_type_Alzx.jdField_a_of_type_Int) });
  }
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    for (;;)
    {
      ...
      if (paramLong1 == paramLong2)
      {
        ...
        this.jdField_b_of_type_AndroidWidgetTextView.setText(amtj.a(2131701289) + l);
      ...
      for (;;)
      {
        ...
        alvx.a().callbackFromRequest(this.jdField_a_of_type_Alzx.jdField_b_of_type_Long, 0, "sc.game_ad_video_end.local", "{}");
        return;
        ...
        continue;
        label245:
        this.jdField_b_of_type_AndroidWidgetTextView.setText(amtj.a(2131701296) + paramLong1);
        this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
      }
    }
  }
  ...
  public void a(alzx paramalzx)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Alzx = paramalzx;
    } while (this.jdField_a_of_type_Bjng == null);
    this.jdField_a_of_type_Bjng.obtainMessage(0).sendToTarget();
  }
  ...
  public void a(String paramString)
  {
    ...
    try
    {
      GdtHandler.a(a((qq_ad_get.QQAdGetRsp.AdInfo)qq_ad_get.QQAdGetRsp.AdInfo.class.cast(abrk.a(new qq_ad_get.QQAdGetRsp.AdInfo(), new JSONObject(paramString)))));
      return;
    }
  ...
  public void a(boolean paramBoolean)
  {
    for (;;)
    {
      try
      {
        ...
        if (paramBoolean)
        {
          this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localLayoutInflater.inflate(2131558669, null));
          this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131364620));
          ...
          this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131363031));
          this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131372724));
          ...
          this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131380586));
          this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(this);
          this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
          this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new amae(this));
          return;
        }
      }
      catch (Throwable localThrowable)
      ...
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localThrowable.inflate(2131558668, null));
    }
  }
  ...
  public void b()
  {
    if (this.jdField_a_of_type_Amaj != null)
    {
      if (this.jdField_a_of_type_Amaj.c() != 5) {
        this.jdField_a_of_type_Amaj.b();
      }
      if (this.jdField_a_of_type_Bjng != null) {
        this.jdField_a_of_type_Bjng.obtainMessage(3).sendToTarget();
      }
    }
  }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_AndroidWidgetRelativeLayout == null) || (this.jdField_a_of_type_Amaj == null) || (this.jdField_a_of_type_Alzx == null)) {}
    RelativeLayout localRelativeLayout;
    View localView;
    do
    {
      return;
      localRelativeLayout = (RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131380510);
      localView = this.jdField_a_of_type_Amaj.a();
    } while (localView == null);
    if (paramBoolean) {}
    try
    {
      alvx.a().callbackFromRequest(this.jdField_a_of_type_Alzx.jdField_b_of_type_Long, 0, "sc.game_ad_video_view_close.local", "{}");
      label100:
      ...
      try
      {
        alvx.a().callbackFromRequest(this.jdField_a_of_type_Alzx.jdField_b_of_type_Long, 0, "cs.xy_life_cycle_event_activity.local", "{}");
        return;
      }
  ...
  public void c()
  {
    if ((this.jdField_a_of_type_Amaj != null) && (!this.f) && (this.jdField_a_of_type_Bjng != null) && (this.jdField_a_of_type_Amaj.c() != 5)) {
  ...
  public void e()
  {
    ...
    do
    {
      do
      {
        ...
        try
        {
          alvx.a().callbackFromRequest(this.jdField_a_of_type_Alzx.jdField_b_of_type_Long, 0, "cs.xy_life_cycle_event_disactivity.local", "{}");
          if (!this.g)
          {
            if (this.jdField_a_of_type_Bjng != null) {
            ...
            this.jdField_a_of_type_Amaj.a();
            this.g = true;
            this.jdField_a_of_type_Amaj.a(this.jdField_c_of_type_Boolean);
            this.jdField_b_of_type_Int = ((int)((float)this.jdField_a_of_type_Amaj.a() / 1000.0F));
            return;
          }
        }
        catch (Exception localException)
    ...
    this.jdField_a_of_type_Bjng.obtainMessage(4).sendToTarget();
  }
  ...
  public void g()
  {
    ...
    if (!this.jdField_a_of_type_Boolean)
    {
      a(8, this.jdField_a_of_type_Amaj.a());
      a(1, 100, false);
    }
    if (!this.jdField_d_of_type_Boolean) {
      alvx.a().callbackFromRequest(this.jdField_a_of_type_Alzx.jdField_b_of_type_Long, 0, "sc.game_ad_video_end.local", "{}");
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 1: 
      do
      {
        ...
        {
          return false;
        } while (this.jdField_a_of_type_Alzx == null);
        b(false);
        m();
        a();
        k();
        if (this.jdField_a_of_type_Amaj != null) {
          this.jdField_a_of_type_Amaj.a(this.jdField_a_of_type_Alzx.j, "sd", 0);
        }
        alvx.a().callbackFromRequest(this.jdField_a_of_type_Alzx.jdField_b_of_type_Long, 0, "sc.game_ad_video_start.local", "{}");
        return false;
      } while ((this.jdField_a_of_type_Amaj == null) || (this.jdField_a_of_type_Amaj.a() == null));
      j();
      return false;
    case 2: 
      this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
      ...
      else
      {
        for (;;)
        {
          try
          {
            ...
            bfur.a(localContext, 0, null, str1, amtj.a(2131701292), amtj.a(2131701291), new amaf(this), new amag(this)).show();
          }
          catch (Throwable localThrowable)
          {
