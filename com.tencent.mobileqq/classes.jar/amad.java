  ...
  extends AsyncTask<Void, Void, Integer>
{
  ...
  public amad(BaseActivity paramBaseActivity, Intent paramIntent)
  {
  ...
  {
    QQCustomDialog localQQCustomDialog = bhdj.a(paramBaseActivity, 232, null, paramBaseActivity.getString(paramInt), new amae(paramBoolean, paramBaseActivity), null);
  ...
  public int a()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 35	amad:jdField_a_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    ...
    //   20: ireturn
    //   21: aload_0
    //   22: getfield 65	amad:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   25: ifnull +60 -> 85
    //   28: aload_0
    //   29: getfield 65	amad:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   32: invokevirtual 206	java/util/ArrayList:isEmpty	()Z
    //   35: ifne +50 -> 85
    //   38: aload_0
    //   39: getfield 35	amad:jdField_a_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    ...
    //   51: aload_0
    //   52: getfield 65	amad:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   55: aload_0
    //   56: getfield 81	amad:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   59: aload_0
    //   60: getfield 89	amad:jdField_a_of_type_Int	I
    //   63: invokestatic 215	bhhm:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/util/List;Ljava/lang/String;I)V
    //   66: aload_0
    //   67: getfield 57	amad:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   70: ifnull +12 -> 82
    //   73: aload_0
    //   74: getfield 57	amad:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   77: ldc 217
    //   79: if_acmpne +6 -> 85
    //   82: bipush 9
    //   84: ireturn
    ...
    //   114: invokestatic 238	bhhr:p	(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    //   117: astore 7
    //   119: iload_2
    //   120: istore_1
    //   121: aload 7
    ...
    //   242: aload 11
    //   244: aload_0
    //   245: getfield 57	amad:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   248: iload_1
    ...
    //   274: aload_0
    //   275: getfield 274	amad:jdField_a_of_type_AndroidGraphicsBitmap	Landroid/graphics/Bitmap;
    //   278: ifnull +201 -> 479
    //   281: aload_0
    //   282: getfield 274	amad:jdField_a_of_type_AndroidGraphicsBitmap	Landroid/graphics/Bitmap;
    //   285: astore 8
    //   287: aload_0
    //   288: aload 8
    //   290: invokevirtual 279	android/graphics/Bitmap:getWidth	()I
    //   293: putfield 281	amad:jdField_b_of_type_Int	I
    //   296: aload_0
    //   297: aload 8
    //   299: invokevirtual 284	android/graphics/Bitmap:getHeight	()I
    //   302: putfield 286	amad:jdField_c_of_type_Int	I
    //   305: aload_0
    //   306: getfield 281	amad:jdField_b_of_type_Int	I
    //   309: ifeq +10 -> 319
    //   312: aload_0
    //   313: getfield 286	amad:jdField_c_of_type_Int	I
    //   316: ifne +201 -> 517
    ...
    //   568: invokestatic 329	com/tencent/mobileqq/utils/FileUtils:createFileIfNotExits	(Ljava/lang/String;)V
    //   571: new 331	java/io/File
    //   574: dup
    //   575: aload 12
    //   577: invokespecial 333	java/io/File:<init>	(Ljava/lang/String;)V
    //   580: astore 13
    //   582: new 331	java/io/File
    //   585: dup
    //   586: aload 13
    //   588: invokevirtual 336	java/io/File:getParent	()Ljava/lang/String;
    //   591: invokespecial 333	java/io/File:<init>	(Ljava/lang/String;)V
    //   594: astore 7
    //   596: aload 7
    //   598: invokevirtual 339	java/io/File:exists	()Z
    //   601: ifeq +11 -> 612
    //   604: aload 7
    //   606: invokevirtual 342	java/io/File:isDirectory	()Z
    //   609: ifne +9 -> 618
    //   612: aload 7
    //   614: invokevirtual 345	java/io/File:mkdirs	()Z
    //   617: pop
    //   618: aload 13
    //   620: invokevirtual 339	java/io/File:exists	()Z
    //   623: ifeq +11 -> 634
    //   626: aload 13
    //   628: invokevirtual 348	java/io/File:isFile	()Z
    //   631: ifne +9 -> 640
    //   634: aload 13
    //   636: invokevirtual 351	java/io/File:createNewFile	()Z
    //   639: pop
    //   640: new 300	java/io/BufferedOutputStream
    //   643: dup
    //   644: new 353	java/io/FileOutputStream
    //   647: dup
    //   648: aload 13
    //   650: invokespecial 356	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   653: invokespecial 359	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   656: astore 7
    //   658: aload 8
    //   660: getstatic 365	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   663: bipush 80
    //   665: aload 7
    //   667: invokevirtual 369	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   670: pop
    //   671: aload 7
    //   673: invokevirtual 372	java/io/BufferedOutputStream:flush	()V
    //   676: new 305	java/io/FileInputStream
    //   679: dup
    //   680: aload 13
    //   682: invokespecial 373	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   685: astore 10
    //   687: aload 7
    //   689: astore 9
    //   691: aload 10
    //   693: astore 8
    //   695: aload 13
    //   697: invokevirtual 375	java/io/File:length	()J
    //   700: lstore 5
    //   702: aload 7
    //   704: astore 9
    //   706: aload 10
    ...
    //   711: aload 10
    //   713: lload 5
    //   715: invokestatic 381	com/tencent/qphone/base/util/MD5:toMD5Byte	(Ljava/io/InputStream;J)[B
    //   718: invokestatic 387	com/qq/taf/jce/HexUtil:bytes2HexStr	([B)Ljava/lang/String;
    //   721: putfield 389	amad:g	Ljava/lang/String;
    //   724: aload 7
    //   726: astore 9
    //   728: aload 10
    //   730: astore 8
    //   732: aload_0
    //   733: getfield 389	amad:g	Ljava/lang/String;
    //   736: invokestatic 394	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   739: ifeq +88 -> 827
    //   742: aload 7
    //   744: astore 9
    //   746: aload 10
    ...
    //   780: aload_0
    //   781: getfield 389	amad:g	Ljava/lang/String;
    ...
    //   835: aload_0
    //   836: aload_0
    //   837: getfield 389	amad:g	Ljava/lang/String;
    //   840: ldc_w 314
    ...
    //   846: putfield 398	amad:f	Ljava/lang/String;
    //   849: aload 7
    //   851: astore 9
    //   853: aload 10
    //   855: astore 8
    //   857: aload 12
    //   859: aload_0
    //   860: getfield 398	amad:f	Ljava/lang/String;
    //   863: invokestatic 402	com/tencent/mobileqq/utils/FileUtils:rename	(Ljava/lang/String;Ljava/lang/String;)Z
    //   866: istore 4
    //   868: iload 4
    //   870: ifne +37 -> 907
    //   873: iconst_0
    ...
    //   915: aload 11
    //   917: lload 5
    //   919: invokestatic 408	android/text/format/Formatter:formatFileSize	(Landroid/content/Context;J)Ljava/lang/String;
    //   922: astore 11
    //   924: aload 7
    //   926: astore 9
    //   928: aload 10
    ...
    //   979: astore 8
    //   981: aload_0
    //   982: getfield 73	amad:jdField_b_of_type_Long	J
    //   985: lconst_0
    //   986: lcmp
    //   987: ifne +22 -> 1009
    //   990: aload 7
    ...
    //   998: aload_0
    //   999: aload_0
    //   1000: getfield 57	amad:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   1003: invokestatic 413	com/tencent/mobileqq/shortvideo/ShortVideoUtils:getDuration	(Ljava/lang/String;)J
    //   1006: putfield 73	amad:jdField_b_of_type_Long	J
    //   1009: iconst_0
    //   1010: ifeq +11 -> 1021
  ...
  public void a()
  {
    ...
    if ((this.jdField_a_of_type_JavaLangString != null) && (this.jdField_a_of_type_JavaLangString.equals(ShortVideoPreviewActivity.class.getName())))
    {
      ...
      localObject1 = bcwz.a(0, 2);
      ((bcxr)localObject1).a(bcwz.a(2, localIntent, (bcxr)localObject1));
      bcwz.a((bcxr)localObject1, ((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).app);
    }
    for (;;)
    {
      ...
      Object localObject2 = bcwz.a(0, 0);
      localObject1 = bcwz.a(0, localIntent, (bcxr)localObject2);
      ...
      if (((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).app != null) {
        ((bbob)((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).app.getManager(QQManagerFactory.MEDIA_MSG_ORDER_SEND_MANAGER)).a(((MessageRecord)localObject1).frienduin, ((MessageRecord)localObject1).uniseq);
      }
  ...
  protected void a(Integer paramInteger)
  {
    ...
    case 2: 
    case 6: 
      a((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get(), 2131718874, this.jdField_a_of_type_Boolean);
      return;
    case 3: 
      a((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get(), 2131718869, this.jdField_a_of_type_Boolean);
      return;
    case 4: 
      a((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get(), 2131718840, this.jdField_a_of_type_Boolean);
      return;
    case 5: 
      a((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get(), 2131718866, this.jdField_a_of_type_Boolean);
      return;
    }
    ((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).finish();
  }
