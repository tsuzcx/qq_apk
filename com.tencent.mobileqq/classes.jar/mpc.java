...
public class mpc
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = "zimage." + mpc.class.getSimpleName();
  }
  
  public mpc(int paramInt)
  {
    ...
    this.jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache = new mpd(this, 2008, paramInt);
    paramInt = i;
    while (paramInt < 5)
    {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewImageloaderReleaser = new mpe(this);
  }
