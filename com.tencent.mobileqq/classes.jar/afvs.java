  ...
  implements View.OnClickListener
{
  ...
  private bclp jdField_a_of_type_Bclp;
  ...
  public afvs(bjqu parambjqu, bjqt parambjqt)
  {
  ...
  private void l()
  {
    ...
    this.jdField_d_of_type_AndroidWidgetButton.setText(2131699016);
  ...
  public View a()
  {
    ...
    ((TextView)localView.findViewById(2131363852)).setOnClickListener(this);
    ...
    this.jdField_d_of_type_AndroidWidgetButton = ((Button)localView.findViewById(2131372762));
    this.jdField_c_of_type_Int = 0;
    this.jdField_d_of_type_AndroidWidgetButton.setEnabled(false);
    this.jdField_d_of_type_AndroidWidgetButton.setText(2131699016);
    this.jdField_d_of_type_AndroidWidgetButton.setOnClickListener(this);
    this.jdField_d_of_type_Int = 0;
    this.jdField_c_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localView.findViewById(2131366409));
    this.jdField_d_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localView.findViewById(2131365884));
    int i = actn.a(this.e, a().getResources());
    this.jdField_a_of_type_Bclp = new bclp();
    this.jdField_a_of_type_Bclp.a(actn.a(this.e + this.f, a().getResources()));
    this.jdField_a_of_type_Bclp.a(i);
    this.jdField_a_of_type_Bclp.b(1);
    if (Build.VERSION.SDK_INT > 15) {
      this.jdField_d_of_type_AndroidWidgetRelativeLayout.setBackground(this.jdField_a_of_type_Bclp);
    }
    for (;;)
    {
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131376442));
      this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)localView.findViewById(2131375035));
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131365887));
      this.jdField_c_of_type_AndroidWidgetTextView.setText(this.jdField_c_of_type_JavaLangString);
      return localView;
      this.jdField_d_of_type_AndroidWidgetRelativeLayout.setBackgroundDrawable(this.jdField_a_of_type_Bclp);
    }
  }
  ...
  public void a(Bundle paramBundle)
  {
    ...
    super.a(paramBundle);
    this.jdField_c_of_type_JavaLangString = this.jdField_a_of_type_Bjqu.a().getIntent().getStringExtra("key_face_unlock_code");
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      if (this.jdField_c_of_type_Int == 0)
      {
        ...
        this.jdField_d_of_type_AndroidWidgetButton.setText(2131699019);
