...
public class aryw
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    aryx.a(paramQQAppInterface, 0, paramString, false);
    a(paramQQAppInterface, 0, paramString, false);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, boolean paramBoolean, azmj paramazmj)
  {
    if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      if (paramazmj != null) {}
      for (paramQQAppInterface = paramazmj.a;; paramQQAppInterface = paramMsg.msg_head.to_uin.get() + "") {
        break;
      }
      if (QLog.isColorLevel()) {
        paramStringBuilder.append("elemType:LbsShareMsg;\n");
      }
      paramList = (MessageForLocationShare)axaq.a(-2076);
      paramList.msgtype = -2076;
      paramList.msg = BaseApplicationImpl.context.getString(2131719742);
  ...
  {
    aryx.a(paramQQAppInterface, 1, paramString, false);
