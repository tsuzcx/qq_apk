  ...
  public static MessageRecord a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, MsgInfo paramMsgInfo)
  {
    if (paramArrayOfByte != null)
    {
      try
      {
        ...
        paramArrayOfByte = (MessageForYanZhi)bcsa.a(-2070);
        ...
        paramArrayOfByte.msg = (localMsgBody.uint32_like_count.get() + BaseApplicationImpl.getContext().getString(2131694136));
