  ...
  extends attg
{
  ...
  atso(atsi paramatsi, MessageRecord paramMessageRecord)
  {
    super(paramatsi);
  ...
  void a(String paramString, int paramInt, atte paramatte)
  {
    ...
    atsi.a(this.jdField_a_of_type_Atsi).a().a().a(paramString, paramInt, this.b, this.c, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, 102, new atsp(this, paramString, paramatte));
  }
}
