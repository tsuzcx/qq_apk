  ...
  implements FounderBaseLayout.FounderHighlightInterface
{
  ...
  private void a(int paramInt1, int paramInt2, CharSequence paramCharSequence)
  {
    ...
    int i4 = (int)f2;
    FastColorFontHelper.a().a(this.jdField_a_of_type_ComEtrumpMixlayoutETFont.mFontId, (int[])localObject, i4, this.jdField_k_of_type_ArrayOfInt);
    paramInt1 = 0;
    int i1;
    if (paramInt1 < i2)
    {
      ...
      for (;;)
      {
        n = (int)(f1 * FastColorFontCache.d(this.jdField_a_of_type_ComEtrumpMixlayoutETFont.mFontId) / FastColorFontCache.e(this.jdField_a_of_type_ComEtrumpMixlayoutETFont.mFontId));
    ...
    if ((paramCharSequence instanceof Spanned))
    {
      ...
      this.jdField_a_of_type_ComVasColorFontExpressionLayout$SpanComparator.a((Spanned)localObject);
      Arrays.sort(arrayOfCharacterStyle, this.jdField_a_of_type_ComVasColorFontExpressionLayout$SpanComparator);
    }
    for (;;)
    {
      ...
      this.jdField_l_of_type_Int = ((int)(FastColorFontCache.d(this.jdField_a_of_type_ComEtrumpMixlayoutETFont.mFontId) * f2 / FastColorFontCache.e(this.jdField_a_of_type_ComEtrumpMixlayoutETFont.mFontId)));
        ...
        if (n < arrayOfCharacterStyle.length)
        {
          ...
          if (i2 == ((Spanned)localObject).length())
          {
            ...
            if ((i4 > paramInt1) && (i2 > i4)) {
              a(null, ETLayout.a(paramCharSequence, paramInt1, i4), paramInt1, (int)f2, 0, this.jdField_l_of_type_Int);
            }
            if (!(localCharacterStyle instanceof ClickableSpan)) {
              break label694;
            }
            a(null, ETLayout.a(paramCharSequence, i4, i2), i4, (int)f2, 1, this.jdField_l_of_type_Int);
          }
          for (;;)
          {
            if ((n == arrayOfCharacterStyle.length - 1) && (i1 == 0)) {
              a(null, ETLayout.a(paramCharSequence, i2, ((Spanned)localObject).length()), i2, (int)f2, 0, this.jdField_l_of_type_Int);
            }
            n += 1;
            paramInt1 = i2;
            break;
            ...
            if (((localCharacterStyle instanceof EmoticonSpan)) || ((localCharacterStyle instanceof SignatureActionSpan))) {
              ...
              a((RelativeSizeSpan)localCharacterStyle, ETLayout.a(paramCharSequence, i4, i2), i4, (int)f2, 3, this.jdField_l_of_type_Int);
            } else {
              FastColorFontLog.b(a(), "Un Know CharacterStyle   start:" + i4 + "  end:" + i2);
            }
          }
        }
      }
  ...
  private boolean b()
  {
    ...
    if (i1 < i2)
    {
      ModelFastColorFont localModelFastColorFont = (ModelFastColorFont)this.jdField_c_of_type_JavaUtilList.get(i1);
  ...
  private void l()
  {
    ...
    while (n < this.jdField_a_of_type_ArrayOfInt.length)
    {
      ...
      localModelFastColorFont2.jdField_d_of_type_Int = (this.jdField_b_of_type_ArrayOfInt[n] - this.jdField_d_of_type_ArrayOfInt[n] / 2);
      localModelFastColorFont2.jdField_e_of_type_Int = (this.jdField_c_of_type_ArrayOfInt[n] - this.jdField_e_of_type_ArrayOfInt[n] / 2);
      localModelFastColorFont2.jdField_b_of_type_Int = this.jdField_d_of_type_ArrayOfInt[n];
      localModelFastColorFont2.jdField_c_of_type_Int = this.jdField_e_of_type_ArrayOfInt[n];
  ...
  private void m()
  {
    ...
    for (;;)
    {
      ...
      while (n < this.m.length)
      {
        ...
        this.jdField_c_of_type_AndroidGraphicsCanvas.drawText(String.valueOf(localModelFastColorFont.jdField_a_of_type_Char), i2, i3 + (f1 - f2), this.jdField_b_of_type_AndroidGraphicsPaint);
        n += 5;
      }
  ...
  private void n()
  {
    ...
    if (this.jdField_b_of_type_AndroidGraphicsCanvas == null)
    {
      ...
      switch (((ModelFastColorFont)localObject).jdField_a_of_type_Int)
      {
      }
    }
    for (;;)
    {
      ...
      {
        ((EmoticonSpan)((ModelFastColorFont)localObject).jdField_a_of_type_AndroidTextStyleCharacterStyle).draw(this.jdField_b_of_type_AndroidGraphicsCanvas, null, 0, 0, i5, i6, i6 + i4, i6 + i4, this.jdField_a_of_type_ComEtrumpMixlayoutETTextView.getPaint());
      }
      else if ((((ModelFastColorFont)localObject).jdField_a_of_type_AndroidTextStyleCharacterStyle instanceof SignatureActionSpan))
      {
        ...
        ((SignatureActionSpan)localObject).draw(this.jdField_b_of_type_AndroidGraphicsCanvas, null, 0, 0, i5, i6, i6, i6 + i4, this.jdField_a_of_type_ComEtrumpMixlayoutETTextView.getPaint());
      }
    }
  }
  ...
  public int a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      for (n = 0; ((Iterator)localObject2).hasNext(); n = localModelFastColorFont.jdField_c_of_type_Int + (i1 + i5) + n)
      {
        localModelFastColorFont = (ModelFastColorFont)((Iterator)localObject2).next();
        i1 = this.jdField_c_of_type_Int;
        i5 = localModelFastColorFont.jdField_e_of_type_Int;
      }
      i1 = i2;
      ...
      else
      {
        while (i1 < ((List)localObject1).size())
        {
          ...
          n = ((ModelFastColorFont)localObject2).jdField_d_of_type_Int;
          if (i3 <= ((ModelFastColorFont)localObject2).jdField_b_of_type_Int + (paramInt2 + n)) {
            return paramInt1 + i1;
          }
          i1 += 1;
        }
  ...
  public int a(int paramInt1, int paramInt2, TextGraphMap paramTextGraphMap)
  {
    ...
    while (n < this.jdField_b_of_type_JavaUtilList.size())
    {
      ...
      if ((paramInt1 >= paramTextGraphMap.jdField_d_of_type_Int) && (paramInt1 <= paramTextGraphMap.jdField_d_of_type_Int + paramTextGraphMap.jdField_b_of_type_Int) && (paramInt2 >= paramTextGraphMap.jdField_e_of_type_Int))
      {
        int i1 = paramTextGraphMap.jdField_e_of_type_Int;
        if (paramInt2 <= paramTextGraphMap.jdField_c_of_type_Int + i1) {
          return n;
        }
      }
      n += 1;
  ...
  protected Bitmap a(int paramInt1, int paramInt2)
  {
    ...
    if (localBitmap2 == null)
    {
      ...
      FastColorFontHelper.a().a(this.jdField_a_of_type_ComEtrumpMixlayoutETFont.mFontId, localBitmap2, null, this.jdField_a_of_type_ComEtrumpMixlayoutETFont.mComboIndex);
      ...
      {
        FastColorFontLog.a(a(), "create new under line bitmap.... width:" + paramInt1 + "  height:" + paramInt2);
        localBitmap1 = localBitmap2;
      }
    }
    return localBitmap1;
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if (n < i1)
    {
      ...
      for (;;)
      {
        ...
        int i3 = localModelFastColorFont.jdField_e_of_type_Int;
        localPath.addRect(f1, f2, f3, localModelFastColorFont.jdField_c_of_type_Int + (i2 + i3), Path.Direction.CW);
      }
    }
  ...
  public void a(int paramInt, int[] paramArrayOfInt, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      i1 = localModelFastColorFont.jdField_e_of_type_Int;
      paramArrayOfInt[1] = (localModelFastColorFont.jdField_c_of_type_Int + (n + i1) + paramInt);
      return;
    }
    ...
    paramInt = paramArrayOfInt[1];
    n = this.jdField_c_of_type_Int;
    int i1 = localModelFastColorFont.jdField_e_of_type_Int;
    paramArrayOfInt[1] = (localModelFastColorFont.jdField_c_of_type_Int + (n + i1) + paramInt);
  }
  ...
  public int[] a(int paramInt1, int paramInt2, long paramLong, boolean paramBoolean, ETFont paramETFont)
  {
    ...
    long l1 = System.nanoTime();
    if (FastColorFontHelper.jdField_a_of_type_Boolean) {
      FastColorFontLog.a(a(), "字数：" + paramETFont.length() + "   字号：" + this.jdField_a_of_type_ComEtrumpMixlayoutETTextView.getTextSize() + "px   排版耗时：" + (float)(l1 - paramLong) / 1000000.0F + "ms");
    }
    if (a())
    {
      this.jdField_j_of_type_ArrayOfInt[0] = n;
  ...
  public void b()
  {
    ...
    if (FastColorFontHelper.jdField_a_of_type_Boolean) {
      FastColorFontLog.a(a(), "StartAnimation......animInfo:" + Arrays.toString(this.jdField_i_of_type_ArrayOfInt));
    }
    this.jdField_e_of_type_Int = 0;
    ...
    FastColorFontLog.b(a(), "StartAnimation......动画帧数和帧间隔数据异常 animInfo:" + Arrays.toString(this.jdField_i_of_type_ArrayOfInt));
  }
