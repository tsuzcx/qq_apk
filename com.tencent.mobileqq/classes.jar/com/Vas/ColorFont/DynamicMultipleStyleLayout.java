  ...
  extends FounderColorLayout
{
  ...
  public DynamicMultipleStyleLayout(ETTextView paramETTextView, ETFont paramETFont)
  {
  ...
  private void k()
  {
    ...
    if (this.jdField_c_of_type_AndroidGraphicsCanvas == null)
    {
      ...
      localModelFastColorFont = (ModelFastColorFont)this.jdField_b_of_type_JavaUtilList.get(i);
  ...
  public boolean a(Canvas paramCanvas)
  {
    if (b())
    {
      FastColorFontLog.b(this.jdField_a_of_type_JavaLangString, "DynamicMultipleStyleLayout::onDraw view宽高为0或超过屏幕尺寸......");
      return false;
    }
    if (!a())
    {
      FastColorFontLog.b(this.jdField_a_of_type_JavaLangString, "DynamicMultipleStyleLayout::onDraw 创建bitmap失败！");
      return false;
    }
    if ((this.jdField_a_of_type_JavaUtilList == null) || (this.jdField_a_of_type_JavaUtilList.isEmpty()))
    {
      FastColorFontLog.b(this.jdField_a_of_type_JavaLangString, "DynamicMultipleStyleLayout::onDraw 行数为零！");
      return false;
    }
    if (this.jdField_a_of_type_ArrayOfInt.length <= 0)
    {
      FastColorFontLog.b(this.jdField_a_of_type_JavaLangString, "DynamicMultipleStyleLayout::onDraw 字数为零！");
      return false;
    }
    ...
    for (;;)
    {
      if (FastColorFontHelper.jdField_a_of_type_Boolean)
      {
        ...
        FastColorFontLog.b(this.jdField_a_of_type_JavaLangString, "动画帧耗时 frameIndex:" + this.jdField_e_of_type_Int + "  行：" + this.jdField_h_of_type_Int + "  列：" + this.jdField_i_of_type_Int + "  耗时：" + (float)(l2 - l1) / 1000000.0F + "ms");
        if (this.jdField_e_of_type_Int == 0) {
          a("drawAnimationText.....");
        }
      }
  ...
  public void b()
  {
    ...
    do
    {
      ...
      {
        FastColorFontLog.b(this.jdField_a_of_type_JavaLangString, "0行或超过5行或全EMOJI不支持播放动画..." + this.jdField_a_of_type_ComEtrumpMixlayoutETFont.mFontPath);
        return;
      }
    ...
    if (FastColorFontHelper.jdField_a_of_type_Boolean) {
      FastColorFontLog.a(this.jdField_a_of_type_JavaLangString, "StartAnimation......animInfo:" + Arrays.toString(this.jdField_i_of_type_ArrayOfInt));
    }
    ...
    if ((this.jdField_i_of_type_ArrayOfInt[0] <= 0) || (this.jdField_i_of_type_ArrayOfInt[1] <= 0))
    {
      FastColorFontLog.b(this.jdField_a_of_type_JavaLangString, "StartAnimation......动画帧数和帧间隔数据异常 animInfo:" + Arrays.toString(this.jdField_i_of_type_ArrayOfInt));
      return;
    }
    h();
  }
  ...
  protected void b_()
  {
    ...
    for (;;)
    {
      ...
      break;
      Object localObject = a(localModelFastColorFont.jdField_b_of_type_Int, j);
      this.jdField_b_of_type_AndroidGraphicsCanvas.drawBitmap((Bitmap)localObject, localModelFastColorFont.jdField_d_of_type_Int, localModelFastColorFont.jdField_e_of_type_Int + localModelFastColorFont.jdField_c_of_type_Int - j, this.jdField_a_of_type_ComEtrumpMixlayoutETTextView.getPaint());
      continue;
