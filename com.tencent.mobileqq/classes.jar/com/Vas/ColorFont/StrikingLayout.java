  ...
  extends FounderColorLayout
{
  ...
  public StrikingLayout(ETTextView paramETTextView, ETFont paramETFont)
  {
  ...
  public boolean a(Canvas paramCanvas)
  {
    ...
    {
      a(HardCodeUtil.a(2131714449));
      return false;
    }
    if (this.jdField_a_of_type_ArrayOfInt.length <= 0)
    {
      a(HardCodeUtil.a(2131714450));
      return false;
    }
  ...
  public void b()
  {
    ...
    do
    {
      ...
      {
        FastColorFontLog.b(a(), "0行或超过5行或全EMOJI不支持播放动画..." + this.jdField_a_of_type_ComEtrumpMixlayoutETFont.mFontPath);
        return;
      }
