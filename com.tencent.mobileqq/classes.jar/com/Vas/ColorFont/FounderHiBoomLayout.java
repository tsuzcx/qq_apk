  ...
  extends FounderBaseLayout
{
  ...
  {
    FastColorFontLog.a("HiBoomFont.FounderHiBoomLayout", "drawMissingWord....char:" + String.valueOf((char)paramInt1) + "  code:" + paramInt1 + "  x:" + paramInt2 + "  y:" + paramInt3 + "  width:" + paramInt4 + "  height:" + paramInt5);
  ...
  public boolean a(Canvas paramCanvas)
  {
    ...
    if (a())
    {
      ...
      int j;
      switch (FounderHiBoomLayout.2.jdField_a_of_type_ArrayOfInt[this.jdField_a_of_type_ComTencentMobileqqHiboomHiBoomTextView.getScaleType().ordinal()])
      {
      default: 
  ...
  public void b()
  {
    ...
    FastColorFontLog.a("HiBoomFont.FounderHiBoomLayout", "该字体不支持动画....animInfo:" + Arrays.toString(this.i) + "  ttf path:" + this.jdField_a_of_type_ComEtrumpMixlayoutETFont.mFontPath);
  }
