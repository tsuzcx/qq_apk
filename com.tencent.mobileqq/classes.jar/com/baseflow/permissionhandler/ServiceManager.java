...
final class ServiceManager
{
  ...
  private boolean b(Context paramContext)
  {
    if (Build.VERSION.SDK_INT >= 28)
    {
      ...
      return paramContext.isLocationEnabled();
    }
    if (Build.VERSION.SDK_INT >= 19) {
  ...
  void a(int paramInt, Context paramContext, ServiceManager.SuccessCallback paramSuccessCallback, ErrorCallback paramErrorCallback)
  {
 ...
 * Qualified Name:     com.baseflow.permissionhandler.ServiceManager
