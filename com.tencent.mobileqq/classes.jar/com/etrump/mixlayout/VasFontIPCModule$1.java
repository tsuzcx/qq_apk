...
public class VasFontIPCModule$1
  implements Runnable
{
  public VasFontIPCModule$1(gm paramgm, int paramInt, QQAppInterface paramQQAppInterface) {}
  
  public void run()
  {
    Object localObject;
    if (new File(bgtl.a() + "libvipfont808.so").exists())
    {
    ...
    do
    {
      ...
      {
        return;
        gm.a(this.this$0).add(Integer.valueOf(this.jdField_a_of_type_Int));
      } while (!gm.a(this.this$0).compareAndSet(false, true));
