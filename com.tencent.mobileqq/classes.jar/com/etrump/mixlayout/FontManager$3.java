  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    default: 
      ...
      {
        if (!bbkv.a((String)localObject2, bbkv.a() + File.separator, (String)localObject1)) {
          break label390;
        }
        if (bbkv.a(bbkv.a(), (String)localObject1) != 0) {
          break label377;
        }
        hy.a().a(this.a, 0);
        switch (this.a)
    ...
    for (;;)
    {
      ...
      aqwz.a().a();
      continue;
      if ((!TextUtils.isEmpty(this.this$0.e)) && (this.this$0.jdField_a_of_type_Bbwm != null))
      {
        localObject1 = new Bundle();
        ((Bundle)localObject1).putString("callbackId", this.this$0.e);
        ((Bundle)localObject1).putInt("srcType", 9);
        this.this$0.jdField_a_of_type_Bbwm.a(0L, 0, (Bundle)localObject1);
        this.this$0.e = null;
      }
