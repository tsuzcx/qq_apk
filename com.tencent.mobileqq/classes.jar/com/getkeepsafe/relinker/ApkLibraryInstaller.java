  ...
  implements ReLinker.LibraryInstaller
{
  ...
  private ApkLibraryInstaller.ZipFileInZipEntry a(Context paramContext, String[] paramArrayOfString, String paramString, ReLinkerInstance paramReLinkerInstance)
  {
        ...
        if (paramContext != null)
        {
          ...
          while (j < 5)
          {
            ...
            while (m < i1)
            {
              ...
              localObject2[1] = str;
              paramReLinkerInstance.a("Looking for %s in APK %s...", (Object[])localObject2);
  ...
  /* Error */
  public void a(Context paramContext, String[] paramArrayOfString, String paramString, File paramFile, ReLinkerInstance paramReLinkerInstance)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 13
    ...
    //   6: aload_3
    //   7: aload 5
    //   9: invokespecial 122	com/getkeepsafe/relinker/ApkLibraryInstaller:a	(Landroid/content/Context;[Ljava/lang/String;Ljava/lang/String;Lcom/getkeepsafe/relinker/ReLinkerInstance;)Lcom/getkeepsafe/relinker/ApkLibraryInstaller$ZipFileInZipEntry;
    //   12: astore 12
    //   14: aload 12
    //   16: ifnull +262 -> 278
    //   19: iconst_0
    ...
    //   38: aload_3
    //   39: aastore
    //   40: invokevirtual 71	com/getkeepsafe/relinker/ReLinkerInstance:a	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   43: aload 4
    //   45: invokevirtual 128	java/io/File:exists	()Z
    //   48: ifne +18 -> 66
    //   51: aload 4
    //   53: invokevirtual 131	java/io/File:createNewFile	()Z
    //   56: istore 7
    //   58: iload 7
    //   60: ifne +6 -> 66
    //   63: goto +312 -> 375
 ...
 * Qualified Name:     com.getkeepsafe.relinker.ApkLibraryInstaller
