...
public final class Opcodes
{
  ...
  public static int extractOpcodeFromUnit(int paramInt)
  {
    int i = paramInt & 0xFF;
    if ((i == 0) || (i == 255)) {
      return paramInt;
  ...
  public static boolean isValidShape(int paramInt)
  {
    boolean bool2 = true;
    boolean bool1;
    if (paramInt < -1) {
 ...
 * Qualified Name:     com.android.dx.io.Opcodes
