  ...
  extends InsnFormat
{
  ...
  public boolean isCompatible(DalvInsn paramDalvInsn)
  {
    ...
    return ((paramDalvInsn instanceof SimpleInsn)) && (localRegisterSpecList.size() == 2) && (unsignedFitsInByte(localRegisterSpecList.get(0).getReg())) && (unsignedFitsInShort(localRegisterSpecList.get(1).getReg()));
  }
  
  public void writeTo(AnnotatedOutput paramAnnotatedOutput, DalvInsn paramDalvInsn)
  {
    RegisterSpecList localRegisterSpecList = paramDalvInsn.getRegisters();
    write(paramAnnotatedOutput, opcodeUnit(paramDalvInsn, localRegisterSpecList.get(0).getReg()), (short)localRegisterSpecList.get(1).getReg());
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes6.jar
 * Qualified Name:     com.android.dx.dex.code.form.Form22x
