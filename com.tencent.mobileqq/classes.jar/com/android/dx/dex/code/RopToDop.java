...
public final class RopToDop
{
  ...
  {
    Rop localRop = paramInsn.getOpcode();
    Dop localDop = (Dop)MAP.get(localRop);
    if (localDop != null) {
      return localDop;
    }
    ...
    do
    {
      for (;;)
      {
        throw new RuntimeException("unknown rop: " + localRop);
        ...
        paramInsn = paramInsn.getResult();
        if (paramInsn == null) {
          return Dops.NOP;
        }
        switch (paramInsn.getBasicType())
        {
        default: 
        ...
        switch (((CstFieldRef)((ThrowingCstInsn)paramInsn).getConstant()).getBasicType())
        {
        case 4: 
        case 5: 
        case 7: 
      ...
      return Dops.SPUT;
      paramInsn = ((ThrowingCstInsn)paramInsn).getConstant();
      if ((paramInsn instanceof CstType)) {
        return Dops.CONST_CLASS;
      }
    } while (!(paramInsn instanceof CstString));
 ...
 * Qualified Name:     com.android.dx.dex.code.RopToDop
