...
public class AesCbcKS
{
  ...
  public static byte[] decrypt(String paramString, byte[] paramArrayOfByte)
  {
    ...
    byte[] arrayOfByte2 = Arrays.copyOf(paramArrayOfByte, 16);
    try
    {
      Cipher localCipher = Cipher.getInstance("AES/CBC/PKCS7Padding");
      localCipher.init(2, paramString, new IvParameterSpec(arrayOfByte2));
  ...
  private static SecretKey e(String paramString)
  {
    for (;;)
    {
      ...
      ((KeyGenerator)localObject).init(new KeyGenParameterSpec.Builder(paramString, 3).setBlockModes(new String[] { "CBC" }).setEncryptionPaddings(new String[] { "PKCS7Padding" }).setKeySize(256).build());
  ...
  public static byte[] encrypt(String paramString, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      localObject7 = Cipher.getInstance("AES/CBC/PKCS7Padding");
