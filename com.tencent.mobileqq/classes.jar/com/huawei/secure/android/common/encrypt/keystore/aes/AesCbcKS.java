...
public class AesCbcKS
{
  ...
  public static String decrypt(String paramString1, String paramString2)
  {
    ...
    try
    {
      paramString1 = new String(decrypt(paramString1, paramString2), "UTF-8");
      return paramString1;
    }
  ...
  public static byte[] decrypt(String paramString, byte[] paramArrayOfByte)
  {
    ...
    if ((!TextUtils.isEmpty(paramString)) && (paramArrayOfByte != null))
    {
      ...
      Object localObject = Arrays.copyOf(paramArrayOfByte, 16);
      try
      {
        Cipher localCipher = Cipher.getInstance("AES/CBC/PKCS7Padding");
        localCipher.init(2, paramString, new IvParameterSpec((byte[])localObject));
        paramString = localCipher.doFinal(paramArrayOfByte, 16, paramArrayOfByte.length - 16);
        return paramString;
      }
  ...
  private static javax.crypto.SecretKey e(String paramString)
  {
    ...
    //   4: astore_1
    //   5: ldc 8
    //   7: invokestatic 168	java/security/KeyStore:getInstance	(Ljava/lang/String;)Ljava/security/KeyStore;
    //   10: astore_2
    //   11: aload_2
    //   12: aconst_null
    //   13: invokevirtual 172	java/security/KeyStore:load	(Ljava/security/KeyStore$LoadStoreParameter;)V
    //   16: aload_2
    //   17: aload_0
    //   18: aconst_null
    //   19: invokevirtual 176	java/security/KeyStore:getKey	(Ljava/lang/String;[C)Ljava/security/Key;
    //   22: astore_2
    //   23: aload_2
    //   24: ifnull +18 -> 42
    //   27: aload_2
    ...
    //   31: ifeq +11 -> 42
    //   34: aload_2
    //   35: checkcast 178	javax/crypto/SecretKey
    //   38: astore_0
    //   39: goto +402 -> 441
    //   42: ldc 180
    //   44: ldc 8
    //   46: invokestatic 185	javax/crypto/KeyGenerator:getInstance	(Ljava/lang/String;Ljava/lang/String;)Ljavax/crypto/KeyGenerator;
    //   49: astore_2
    //   50: aload_2
    //   51: new 187	android/security/keystore/KeyGenParameterSpec$Builder
    //   54: dup
    //   55: aload_0
    //   56: iconst_3
    //   57: invokespecial 190	android/security/keystore/KeyGenParameterSpec$Builder:<init>	(Ljava/lang/String;I)V
    //   60: iconst_1
    ...
    //   66: ldc 192
    //   68: aastore
    //   69: invokevirtual 196	android/security/keystore/KeyGenParameterSpec$Builder:setBlockModes	([Ljava/lang/String;)Landroid/security/keystore/KeyGenParameterSpec$Builder;
    //   72: iconst_1
    ...
    //   78: ldc 198
    //   80: aastore
    //   81: invokevirtual 201	android/security/keystore/KeyGenParameterSpec$Builder:setEncryptionPaddings	([Ljava/lang/String;)Landroid/security/keystore/KeyGenParameterSpec$Builder;
    //   84: sipush 256
    //   87: invokevirtual 205	android/security/keystore/KeyGenParameterSpec$Builder:setKeySize	(I)Landroid/security/keystore/KeyGenParameterSpec$Builder;
    //   90: invokevirtual 209	android/security/keystore/KeyGenParameterSpec$Builder:build	()Landroid/security/keystore/KeyGenParameterSpec;
    //   93: invokevirtual 212	javax/crypto/KeyGenerator:init	(Ljava/security/spec/AlgorithmParameterSpec;)V
    //   96: aload_2
    //   97: invokevirtual 216	javax/crypto/KeyGenerator:generateKey	()Ljavax/crypto/SecretKey;
    //   100: astore_0
    //   101: goto +340 -> 441
    //   104: astore_0
    //   105: goto +341 -> 446
    //   108: astore_0
    //   109: getstatic 56	com/huawei/secure/android/common/encrypt/keystore/aes/AesCbcKS:TAG	Ljava/lang/String;
    //   112: astore_2
    ...
    //   121: aload_3
    //   122: ldc 124
    //   124: invokevirtual 128	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   127: pop
    //   128: aload_3
    //   129: aload_0
    //   130: invokevirtual 132	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   142: invokestatic 64	com/huawei/secure/android/common/encrypt/utils/b:f	(Ljava/lang/String;Ljava/lang/String;)V
    //   145: aload_1
    //   146: astore_0
    //   147: goto +294 -> 441
    //   150: astore_0
    //   151: getstatic 56	com/huawei/secure/android/common/encrypt/keystore/aes/AesCbcKS:TAG	Ljava/lang/String;
    //   154: astore_2
    //   155: new 121	java/lang/StringBuilder
    //   158: dup
    //   159: invokespecial 122	java/lang/StringBuilder:<init>	()V
    //   162: astore_3
    //   163: aload_3
    //   164: ldc 218
    ...
    //   170: aload_3
    //   171: aload_0
    //   172: invokevirtual 219	java/security/NoSuchProviderException:getMessage	()Ljava/lang/String;
    ...
    //   184: invokestatic 64	com/huawei/secure/android/common/encrypt/utils/b:f	(Ljava/lang/String;Ljava/lang/String;)V
    //   187: aload_1
    //   188: astore_0
    //   189: goto +252 -> 441
    //   192: astore_0
    //   193: getstatic 56	com/huawei/secure/android/common/encrypt/keystore/aes/AesCbcKS:TAG	Ljava/lang/String;
    //   196: astore_2
    //   197: new 121	java/lang/StringBuilder
    //   200: dup
    //   201: invokespecial 122	java/lang/StringBuilder:<init>	()V
    //   204: astore_3
    //   205: aload_3
    //   206: ldc 143
    ...
    //   212: aload_3
    //   213: aload_0
    //   214: invokevirtual 144	java/security/InvalidAlgorithmParameterException:getMessage	()Ljava/lang/String;
    //   217: invokevirtual 128	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   220: pop
    //   221: aload_2
    //   222: aload_3
    //   223: invokevirtual 135	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   226: invokestatic 64	com/huawei/secure/android/common/encrypt/utils/b:f	(Ljava/lang/String;Ljava/lang/String;)V
    //   229: aload_1
    //   230: astore_0
    //   231: goto +210 -> 441
    //   234: astore_0
    //   235: getstatic 56	com/huawei/secure/android/common/encrypt/keystore/aes/AesCbcKS:TAG	Ljava/lang/String;
    //   238: astore_2
    //   239: new 121	java/lang/StringBuilder
    //   242: dup
    //   243: invokespecial 122	java/lang/StringBuilder:<init>	()V
    //   246: astore_3
    //   247: aload_3
    //   248: ldc 221
    ...
    //   254: aload_3
    //   255: aload_0
    //   256: invokevirtual 222	java/security/UnrecoverableKeyException:getMessage	()Ljava/lang/String;
    ...
    //   268: invokestatic 64	com/huawei/secure/android/common/encrypt/utils/b:f	(Ljava/lang/String;Ljava/lang/String;)V
    //   271: aload_1
    //   272: astore_0
    //   273: goto +168 -> 441
    //   276: astore_0
    //   277: getstatic 56	com/huawei/secure/android/common/encrypt/keystore/aes/AesCbcKS:TAG	Ljava/lang/String;
    //   280: astore_2
    ...
    //   296: aload_3
    //   297: aload_0
    //   298: invokevirtual 153	java/security/NoSuchAlgorithmException:getMessage	()Ljava/lang/String;
    //   301: invokevirtual 128	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   304: pop
    //   305: aload_2
    //   306: aload_3
    //   307: invokevirtual 135	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   310: invokestatic 64	com/huawei/secure/android/common/encrypt/utils/b:f	(Ljava/lang/String;Ljava/lang/String;)V
    //   313: aload_1
    //   314: astore_0
    //   315: goto +126 -> 441
    //   318: astore_0
    //   319: getstatic 56	com/huawei/secure/android/common/encrypt/keystore/aes/AesCbcKS:TAG	Ljava/lang/String;
    //   322: astore_2
    //   323: new 121	java/lang/StringBuilder
    //   326: dup
    //   327: invokespecial 122	java/lang/StringBuilder:<init>	()V
    //   330: astore_3
    //   331: aload_3
    //   332: ldc 224
    ...
    //   338: aload_3
    //   339: aload_0
    //   340: invokevirtual 225	java/security/cert/CertificateException:getMessage	()Ljava/lang/String;
    //   343: invokevirtual 128	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   346: pop
    //   347: aload_2
    //   348: aload_3
    //   349: invokevirtual 135	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   352: invokestatic 64	com/huawei/secure/android/common/encrypt/utils/b:f	(Ljava/lang/String;Ljava/lang/String;)V
    //   355: aload_1
    //   356: astore_0
    //   357: goto +84 -> 441
    //   360: astore_0
    //   361: getstatic 56	com/huawei/secure/android/common/encrypt/keystore/aes/AesCbcKS:TAG	Ljava/lang/String;
    //   364: astore_2
    ...
    //   380: aload_3
    //   381: aload_0
    //   382: invokevirtual 228	java/io/IOException:getMessage	()Ljava/lang/String;
    //   385: invokevirtual 128	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   388: pop
    //   389: aload_2
    //   390: aload_3
    //   391: invokevirtual 135	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   394: invokestatic 64	com/huawei/secure/android/common/encrypt/utils/b:f	(Ljava/lang/String;Ljava/lang/String;)V
    //   397: aload_1
    //   398: astore_0
    //   399: goto +42 -> 441
    //   402: astore_0
    //   403: getstatic 56	com/huawei/secure/android/common/encrypt/keystore/aes/AesCbcKS:TAG	Ljava/lang/String;
    //   406: astore_2
    ...
    //   422: aload_3
    //   423: aload_0
    //   424: invokevirtual 231	java/security/KeyStoreException:getMessage	()Ljava/lang/String;
    //   427: invokevirtual 128	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   430: pop
    //   431: aload_2
    //   432: aload_3
    //   433: invokevirtual 135	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   436: invokestatic 64	com/huawei/secure/android/common/encrypt/utils/b:f	(Ljava/lang/String;Ljava/lang/String;)V
    //   439: aload_1
    //   440: astore_0
    //   441: ldc 2
    //   443: monitorexit
  ...
  public static byte[] encrypt(String paramString, byte[] paramArrayOfByte)
  {
    ...
    if ((!TextUtils.isEmpty(paramString)) && (paramArrayOfByte != null))
    {
      ...
      try
      {
        Object localObject8 = Cipher.getInstance("AES/CBC/PKCS7Padding");
 ...
 * Qualified Name:     com.huawei.secure.android.common.encrypt.keystore.aes.AesCbcKS
