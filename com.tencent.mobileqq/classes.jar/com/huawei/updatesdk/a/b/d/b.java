  ...
  extends AsyncTask<c, Void, d>
{
  ...
  public b(c paramc, com.huawei.updatesdk.a.b.d.a.a parama)
  {
    this.a = paramc;
    this.c = parama;
  }
  ...
  private void a(d paramd, Throwable paramThrowable, String paramString)
  {
    ...
    for (;;)
    {
      ...
      else if (((paramThrowable instanceof InterruptedException)) || ((paramThrowable instanceof InterruptedIOException)))
      {
  ...
  {
    executeOnExecutor(paramExecutor, new c[] { this.a });
  }
