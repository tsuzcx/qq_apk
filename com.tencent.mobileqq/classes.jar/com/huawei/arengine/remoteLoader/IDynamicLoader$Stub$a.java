...
class IDynamicLoader$Stub$a
  implements IDynamicLoader
{
  private IBinder a;
  
  IDynamicLoader$Stub$a(IBinder paramIBinder)
  {
    this.a = paramIBinder;
  }
  ...
  public boolean checkUpdate(long paramLong, boolean paramBoolean)
  {
    ...
    //   20: aload 6
    //   22: lload_1
    //   23: invokevirtual 36	android/os/Parcel:writeLong	(J)V
    //   26: iload_3
    //   27: ifeq +61 -> 88
    //   30: iconst_1
    //   31: istore 4
    ...
    //   40: aload_0
    //   41: getfield 15	com/huawei/arengine/remoteLoader/IDynamicLoader$Stub$a:a	Landroid/os/IBinder;
    //   44: iconst_3
    //   45: aload 6
    //   47: aload 7
    //   49: iconst_0
    ...
    //   61: aload 7
    //   63: invokevirtual 53	android/os/Parcel:readInt	()I
    //   66: istore 4
    //   68: iload 4
    //   70: ifeq +24 -> 94
    //   73: iload 5
 ...
 * Qualified Name:     com.huawei.arengine.remoteLoader.IDynamicLoader.Stub.a
