  ...
  implements Callable<f>
{
  ...
  public j(String paramString1, int paramInt, a parama, Context paramContext, String paramString2, GrsBaseInfo paramGrsBaseInfo, c paramc)
  {
    super(paramString1, paramInt, parama, paramContext, paramString2, paramGrsBaseInfo, paramc);
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ...
          l1 = l2;
          localObject4 = ((c)localObject4).a("services", "");
          l1 = l2;
          ((OutputStream)localObject3).write(((String)localObject4).getBytes("UTF-8"));
          l1 = l2;
      ...
      Logger.w(i, "RequestCallableV2 run task catch IOException", localIOException2);
 ...
 * Qualified Name:     com.huawei.hms.framework.network.grs.c.j
