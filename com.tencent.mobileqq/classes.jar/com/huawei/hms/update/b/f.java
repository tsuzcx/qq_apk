  ...
  extends SSLSocketFactory
{
  ...
  public static SocketFactory a(Context paramContext)
  {
    ...
    //   4: aload_1
    //   5: monitorenter
    //   6: getstatic 61	com/huawei/hms/update/b/f:b	Ljavax/net/SocketFactory;
    //   9: ifnonnull +14 -> 23
    //   12: new 2	com/huawei/hms/update/b/f
    //   15: dup
    //   16: aload_0
    //   17: invokespecial 62	com/huawei/hms/update/b/f:<init>	(Landroid/content/Context;)V
    //   20: putstatic 61	com/huawei/hms/update/b/f:b	Ljavax/net/SocketFactory;
    //   23: getstatic 61	com/huawei/hms/update/b/f:b	Ljavax/net/SocketFactory;
    //   26: astore_0
    //   27: aload_1
    //   28: monitorexit
    //   29: aload_0
    ...
    //   36: dup
    //   37: invokespecial 67	java/lang/StringBuilder:<init>	()V
    //   40: ldc 69
    //   42: invokevirtual 73	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   45: aload_0
    //   46: invokevirtual 79	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   49: invokevirtual 73	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   52: invokevirtual 82	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   55: invokestatic 88	com/huawei/hms/support/log/HMSLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   58: invokestatic 92	javax/net/ssl/SSLSocketFactory:getDefault	()Ljavax/net/SocketFactory;
    //   61: astore_0
    //   62: aload_1
    //   63: monitorexit
    //   64: aload_0
  ...
  public static void a(SSLSocket paramSSLSocket)
  {
    ...
    paramSSLSocket.setEnabledCipherSuites((String[])localArrayList.toArray(new String[0]));
  }
