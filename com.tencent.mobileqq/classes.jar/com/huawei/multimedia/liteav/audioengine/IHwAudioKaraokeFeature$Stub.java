...
public abstract class IHwAudioKaraokeFeature$Stub
  extends Binder
  implements IHwAudioKaraokeFeature
{
  ...
  public IHwAudioKaraokeFeature$Stub()
  {
    attachInterface(this, "com.huawei.multimedia.audioengine.IHwAudioKaraokeFeature");
  }
  
  public static IHwAudioKaraokeFeature asInterface(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("com.huawei.multimedia.audioengine.IHwAudioKaraokeFeature");
    if ((localIInterface != null) && ((localIInterface instanceof IHwAudioKaraokeFeature))) {
      return (IHwAudioKaraokeFeature)localIInterface;
    }
    return new IHwAudioKaraokeFeature.Stub.Proxy(paramIBinder);
  }
 ...
 * Qualified Name:     com.huawei.multimedia.liteav.audioengine.IHwAudioKaraokeFeature.Stub
