...
public abstract class IHwAudioEngine$Stub
  extends Binder
  implements IHwAudioEngine
{
  ...
  public IHwAudioEngine$Stub()
  {
    attachInterface(this, "com.huawei.multimedia.audioengine.IHwAudioEngine");
  }
  
  public static IHwAudioEngine asInterface(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("com.huawei.multimedia.audioengine.IHwAudioEngine");
    if ((localIInterface != null) && ((localIInterface instanceof IHwAudioEngine))) {
      return (IHwAudioEngine)localIInterface;
    }
    return new IHwAudioEngine.Stub.Proxy(paramIBinder);
  }
 ...
 * Qualified Name:     com.huawei.multimedia.liteav.audioengine.IHwAudioEngine.Stub
