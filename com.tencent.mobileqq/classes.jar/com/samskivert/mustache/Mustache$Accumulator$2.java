...
class Mustache$Accumulator$2
  extends Mustache.Accumulator
{
  Mustache$Accumulator$2(Mustache.Accumulator paramAccumulator1, Mustache.Compiler paramCompiler, boolean paramBoolean, String paramString, int paramInt, Mustache.Accumulator paramAccumulator2)
  {
  ...
  protected Mustache.Accumulator addCloseSectionSegment(String paramString, int paramInt)
  {
    ...
    this.val$outer._segs.add(new Mustache.InvertedSegment(this._comp, paramString, super.finish(), this.val$tagLine));
 ...
 * Qualified Name:     com.samskivert.mustache.Mustache.Accumulator.2
