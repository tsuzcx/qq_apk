  ...
  implements WebSocket
{
  ...
  public RealWebSocket(boolean paramBoolean, BufferedSource paramBufferedSource, BufferedSink paramBufferedSink, Random paramRandom, Executor paramExecutor, WebSocketListener paramWebSocketListener, String paramString)
  {
    this.listener = paramWebSocketListener;
    this.writer = new WebSocketWriter(paramBoolean, paramBufferedSink, paramRandom);
    this.reader = new WebSocketReader(paramBoolean, paramBufferedSource, new RealWebSocket.1(this, paramWebSocketListener, paramExecutor, paramString));
  }
