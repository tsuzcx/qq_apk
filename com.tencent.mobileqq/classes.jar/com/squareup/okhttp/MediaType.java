...
public final class MediaType
{
  ...
  public static MediaType parse(String paramString)
  {
    ...
    for (;;)
    {
      ...
      for (localObject1 = localMatcher.group(2); (localObject2 != null) && (!((String)localObject1).equalsIgnoreCase(localObject2)); localObject1 = localMatcher.group(3)) {
        throw new IllegalArgumentException("Multiple different charsets: " + paramString);
      }
    }
    return new MediaType(paramString, str1, str2, localObject2);
  }
