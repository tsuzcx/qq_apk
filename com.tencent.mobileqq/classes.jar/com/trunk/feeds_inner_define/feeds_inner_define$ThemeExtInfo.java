  ...
  extends MessageMicro<ThemeExtInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "rpt_talker_uins", "uint64_open_uin", "uint32_msg_count" }, new Object[] { localLong, localLong, Integer.valueOf(0) }, ThemeExtInfo.class);
  }
}
