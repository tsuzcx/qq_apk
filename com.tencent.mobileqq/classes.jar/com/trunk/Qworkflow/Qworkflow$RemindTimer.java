  ...
  extends MessageMicro<RemindTimer>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 42, 48, 56, 66 }, new String[] { "uint64_start_time", "uint64_end_time", "enum_remind_offset_type", "uint32_remind_offset", "rpt_msg_observers", "enum_repeat_type", "uint32_remind_flag", "rpt_msg_repeated_effective_timespan" }, new Object[] { localLong, localLong, localInteger2, localInteger1, null, localInteger2, localInteger1, null }, RemindTimer.class);
  }
}
