  ...
  extends MessageMicro<UserSource>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "enum_source_type", "uint64_source_code", "uint64_root_id" }, new Object[] { Integer.valueOf(1), localLong, localLong }, UserSource.class);
  }
}
