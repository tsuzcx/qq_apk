  ...
  extends UnpackingSoSource
{
    ...
    extends UnpackingSoSource.Unpacker
  {
      ...
      throws IOException
    {
      ...
      //   48	48	12	localFile1	File
      //   71	16	13	arrayOfString	String[]
      //   101	283	14	localFile2	File
      //   66	454	15	localLinkedHashSet	java.util.LinkedHashSet
      //   57	487	16	localArrayList	java.util.ArrayList
