  ...
  extends y
{
  ...
  protected final void a(o paramo)
  {
    ...
    if ((localArrayList1.size() > 0) || (localArrayList3.size() > 0))
    {
      ...
      m.b(new i(this, j, localArrayList1, localArrayList3, str1));
    }
    if ((localArrayList2.size() > 0) || (localArrayList4.size() > 0))
    {
      if (localArrayList2.size() > 0) {
        e.a().c(localArrayList2);
      }
      e.a().a(paramo.g(), j);
      m.b(new j(this, j, localArrayList2, localArrayList4, str1));
    }
  }
}
 ...
 * Qualified Name:     com.vivo.push.c.h
