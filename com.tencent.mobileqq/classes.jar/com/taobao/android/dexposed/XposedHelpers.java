...
{
  private static final String TAG = XposedHelpers.class.getSimpleName();
  ...
  public static Class<?> findClass(String paramString, ClassLoader paramClassLoader)
  {
    ...
    if (paramClassLoader == null) {
      localClassLoader = DexposedBridge.BOOT_CLASSLOADER;
    }
    try
    {
  ...
  public static String getParametersString(Class<?>... paramVarArgs)
  {
 ...
 * Qualified Name:     com.taobao.android.dexposed.XposedHelpers
