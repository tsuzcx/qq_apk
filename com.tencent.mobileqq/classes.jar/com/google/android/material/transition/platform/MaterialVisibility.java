...
abstract class MaterialVisibility<P extends VisibilityAnimatorProvider>
  extends Visibility
{
  private final P jdField_a_of_type_ComGoogleAndroidMaterialTransitionPlatformVisibilityAnimatorProvider;
  ...
  {
    this.jdField_a_of_type_ComGoogleAndroidMaterialTransitionPlatformVisibilityAnimatorProvider = paramP;
  ...
  private Animator a(ViewGroup paramViewGroup, View paramView, boolean paramBoolean)
  {
    ...
    a(localArrayList, this.jdField_a_of_type_ComGoogleAndroidMaterialTransitionPlatformVisibilityAnimatorProvider, paramViewGroup, paramView, paramBoolean);
