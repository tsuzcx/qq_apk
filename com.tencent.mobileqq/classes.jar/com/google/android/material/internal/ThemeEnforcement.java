...
public final class ThemeEnforcement
{
  ...
  private static final int[] b = { R.attr.m };
  ...
  public static TintTypedArray a(@NonNull Context paramContext, AttributeSet paramAttributeSet, @NonNull @StyleableRes int[] paramArrayOfInt1, @AttrRes int paramInt1, @StyleRes int paramInt2, @StyleableRes int... paramVarArgs)
  {
    a(paramContext, paramAttributeSet, paramInt1, paramInt2);
    a(paramContext, paramAttributeSet, paramArrayOfInt1, paramInt1, paramInt2, paramVarArgs);
  ...
  {
    paramAttributeSet = paramContext.obtainStyledAttributes(paramAttributeSet, R.styleable.aB, paramInt1, paramInt2);
    boolean bool = paramAttributeSet.getBoolean(R.styleable.gE, false);
    paramAttributeSet.recycle();
    if (bool)
    {
      paramAttributeSet = new TypedValue();
      if ((!paramContext.getTheme().resolveAttribute(R.attr.s, paramAttributeSet, true)) || ((paramAttributeSet.type == 18) && (paramAttributeSet.data == 0))) {
        b(paramContext);
      }
    }
    a(paramContext);
  ...
  private static void a(@NonNull Context paramContext, AttributeSet paramAttributeSet, @NonNull @StyleableRes int[] paramArrayOfInt1, @AttrRes int paramInt1, @StyleRes int paramInt2, @Nullable @StyleableRes int... paramVarArgs)
  {
    TypedArray localTypedArray = paramContext.obtainStyledAttributes(paramAttributeSet, R.styleable.aB, paramInt1, paramInt2);
    if (!localTypedArray.getBoolean(R.styleable.gF, false))
    {
    ...
    } else if (localTypedArray.getResourceId(R.styleable.gD, -1) != -1) {
      bool = true;
    } else {
      bool = false;
    }
  ...
  private static boolean a(@NonNull Context paramContext, AttributeSet paramAttributeSet, @NonNull @StyleableRes int[] paramArrayOfInt1, @AttrRes int paramInt1, @StyleRes int paramInt2, @NonNull @StyleableRes int... paramVarArgs)
  {
