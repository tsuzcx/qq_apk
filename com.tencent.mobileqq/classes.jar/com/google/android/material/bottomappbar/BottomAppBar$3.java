  ...
  implements ViewUtils.OnApplyWindowInsetsListener
{
  ...
  {
    if (BottomAppBar.c(this.a)) {
      BottomAppBar.a(this.a, paramWindowInsetsCompat.getSystemWindowInsetBottom());
    }
    boolean bool = BottomAppBar.d(this.a);
    int m = 0;
    int k = 0;
    int j;
    if (bool)
    {
      if (BottomAppBar.b(this.a) != paramWindowInsetsCompat.getSystemWindowInsetLeft()) {
        i = 1;
      } else {
        i = 0;
      }
    ...
    {
      i = k;
      if (BottomAppBar.c(this.a) != paramWindowInsetsCompat.getSystemWindowInsetRight()) {
        i = 1;
      }
    ...
    if ((j != 0) || (i != 0))
    {
      ...
      BottomAppBar.b(this.a);
      BottomAppBar.c(this.a);
    }
