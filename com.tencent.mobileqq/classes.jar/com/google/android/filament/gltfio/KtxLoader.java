...
public class KtxLoader
{
  ...
  @Nullable
  public static IndirectLight createIndirectLight(@NonNull Engine paramEngine, @NonNull Buffer paramBuffer, @NonNull KtxLoader.Options paramOptions)
  {
    try
    {
  ...
  @Nullable
  public static Skybox createSkybox(@NonNull Engine paramEngine, @NonNull Buffer paramBuffer, @NonNull KtxLoader.Options paramOptions)
  {
    try
    {
  ...
  @Nullable
  public static Texture createTexture(@NonNull Engine paramEngine, @NonNull Buffer paramBuffer, @NonNull KtxLoader.Options paramOptions)
  {
    try
    {
