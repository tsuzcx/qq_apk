  ...
  implements GLSurfaceView.Renderer
{
  ...
  {
    paramGL10 = (VpxOutputBuffer)this.pendingOutputBufferReference.getAndSet(null);
    ...
    VpxOutputBuffer localVpxOutputBuffer = this.renderedOutputBuffer;
    float[] arrayOfFloat = kColorConversion709;
    paramGL10 = arrayOfFloat;
    int i;
    switch (localVpxOutputBuffer.colorspace)
    {
    default: 
      paramGL10 = arrayOfFloat;
    case 2: 
    ...
    for (int j = localVpxOutputBuffer.height;; j = (localVpxOutputBuffer.height + 1) / 2)
    {
      GLES20.glActiveTexture(33984 + i);
      GLES20.glBindTexture(3553, this.yuvTextures[i]);
      GLES20.glPixelStorei(3317, 1);
      GLES20.glTexImage2D(3553, 0, 6409, localVpxOutputBuffer.yuvStrides[i], j, 0, 6409, 5121, localVpxOutputBuffer.yuvPlanes[i]);
      i += 1;
      break label108;
    ...
    label218:
    if ((this.previousWidth != localVpxOutputBuffer.width) || (this.previousStride != localVpxOutputBuffer.yuvStrides[0]))
    {
      float f = localVpxOutputBuffer.width / localVpxOutputBuffer.yuvStrides[0];
      ...
      this.previousWidth = localVpxOutputBuffer.width;
      this.previousStride = localVpxOutputBuffer.yuvStrides[0];
    }
  ...
  public void setFrame(VpxOutputBuffer paramVpxOutputBuffer)
  {
    paramVpxOutputBuffer = (VpxOutputBuffer)this.pendingOutputBufferReference.getAndSet(paramVpxOutputBuffer);
    if (paramVpxOutputBuffer != null) {
      paramVpxOutputBuffer.release();
    }
  }
}
 ...
 * Qualified Name:     com.google.android.exoplayer2.ext.vp9.VpxRenderer
