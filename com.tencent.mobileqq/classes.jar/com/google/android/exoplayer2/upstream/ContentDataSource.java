  ...
  implements DataSource
{
  ...
  public void close()
  {
    ...
    //   73: goto +13 -> 86
    //   76: astore_1
    //   77: new 68	com/google/android/exoplayer2/upstream/ContentDataSource$ContentDataSourceException
    //   80: dup
    //   81: aload_1
    //   82: invokespecial 71	com/google/android/exoplayer2/upstream/ContentDataSource$ContentDataSourceException:<init>	(Ljava/io/IOException;)V
    //   85: athrow
    //   86: aload_0
    //   87: aconst_null
    //   88: putfield 55	com/google/android/exoplayer2/upstream/ContentDataSource:assetFileDescriptor	Landroid/content/res/AssetFileDescriptor;
    //   91: aload_0
    //   92: getfield 60	com/google/android/exoplayer2/upstream/ContentDataSource:opened	Z
    //   95: ifeq +24 -> 119
    //   98: aload_0
    //   99: iconst_0
    //   100: putfield 60	com/google/android/exoplayer2/upstream/ContentDataSource:opened	Z
    //   103: aload_0
    //   104: getfield 40	com/google/android/exoplayer2/upstream/ContentDataSource:listener	Lcom/google/android/exoplayer2/upstream/TransferListener;
    //   107: astore_2
    //   108: aload_2
    //   109: ifnull +10 -> 119
    //   112: aload_2
    ...
    //   122: goto +13 -> 135
    //   125: astore_1
    //   126: new 68	com/google/android/exoplayer2/upstream/ContentDataSource$ContentDataSourceException
    //   129: dup
    //   130: aload_1
    //   131: invokespecial 71	com/google/android/exoplayer2/upstream/ContentDataSource$ContentDataSourceException:<init>	(Ljava/io/IOException;)V
    //   134: athrow
    //   135: aload_0
    //   136: aconst_null
    //   137: putfield 49	com/google/android/exoplayer2/upstream/ContentDataSource:inputStream	Ljava/io/FileInputStream;
    //   140: aload_0
    //   141: getfield 55	com/google/android/exoplayer2/upstream/ContentDataSource:assetFileDescriptor	Landroid/content/res/AssetFileDescriptor;
    //   144: ifnull +10 -> 154
    //   147: aload_0
    //   148: getfield 55	com/google/android/exoplayer2/upstream/ContentDataSource:assetFileDescriptor	Landroid/content/res/AssetFileDescriptor;
    //   151: invokevirtual 58	android/content/res/AssetFileDescriptor:close	()V
    //   154: aload_0
    //   155: aconst_null
    //   156: putfield 55	com/google/android/exoplayer2/upstream/ContentDataSource:assetFileDescriptor	Landroid/content/res/AssetFileDescriptor;
    //   159: aload_0
    //   160: getfield 60	com/google/android/exoplayer2/upstream/ContentDataSource:opened	Z
    //   163: ifeq +24 -> 187
    //   166: aload_0
    //   167: iconst_0
    //   168: putfield 60	com/google/android/exoplayer2/upstream/ContentDataSource:opened	Z
    //   171: aload_0
    //   172: getfield 40	com/google/android/exoplayer2/upstream/ContentDataSource:listener	Lcom/google/android/exoplayer2/upstream/TransferListener;
    //   175: astore_2
    //   176: aload_2
    //   177: ifnull +10 -> 187
    //   180: aload_2
    //   181: aload_0
    //   182: invokeinterface 66 2 0
    //   187: aload_1
    //   188: athrow
    //   189: astore_1
    //   190: goto +13 -> 203
    //   193: astore_1
    //   194: new 68	com/google/android/exoplayer2/upstream/ContentDataSource$ContentDataSourceException
    //   197: dup
    //   198: aload_1
    //   199: invokespecial 71	com/google/android/exoplayer2/upstream/ContentDataSource$ContentDataSourceException:<init>	(Ljava/io/IOException;)V
    //   202: athrow
    //   203: aload_0
    //   204: aconst_null
    //   205: putfield 55	com/google/android/exoplayer2/upstream/ContentDataSource:assetFileDescriptor	Landroid/content/res/AssetFileDescriptor;
    //   208: aload_0
    //   209: getfield 60	com/google/android/exoplayer2/upstream/ContentDataSource:opened	Z
    //   212: ifeq +24 -> 236
    //   215: aload_0
    //   216: iconst_0
    //   217: putfield 60	com/google/android/exoplayer2/upstream/ContentDataSource:opened	Z
    //   220: aload_0
    //   221: getfield 40	com/google/android/exoplayer2/upstream/ContentDataSource:listener	Lcom/google/android/exoplayer2/upstream/TransferListener;
    //   224: astore_2
    //   225: aload_2
    //   226: ifnull +10 -> 236
    //   229: aload_2
    //   230: aload_0
    //   231: invokeinterface 66 2 0
    //   236: aload_1
    //   237: athrow
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	238	0	this	ContentDataSource
