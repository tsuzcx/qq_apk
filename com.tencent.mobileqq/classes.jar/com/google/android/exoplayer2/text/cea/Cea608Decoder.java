  ...
  extends CeaDecoder
{
  ...
  private final ArrayList<Cea608Decoder.CueBuilder> cueBuilders = new ArrayList();
  ...
  static
  {
    ...
    COLORS = new int[] { -1, -16711936, -16776961, -16711681, -65536, -256, -65281 };
  }
  ...
  private List<Cue> getDisplayCues()
  {
    ...
    {
      Cue localCue = ((Cea608Decoder.CueBuilder)this.cueBuilders.get(i)).build();
      if (localCue != null) {
