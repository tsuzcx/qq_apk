  ...
  implements BoolValueOrBuilder
{
  ...
  private BoolValue$Builder(GeneratedMessageV3.BuilderParent paramBuilderParent)
  {
  ...
  public Builder a(BoolValue paramBoolValue)
  {
    if (paramBoolValue == BoolValue.getDefaultInstance()) {
      return this;
    }
    if (paramBoolValue.getValue()) {
      a(paramBoolValue.getValue());
    }
    b(paramBoolValue.unknownFields);
    onChanged();
    return this;
  }
  ...
  public Builder a(CodedInputStream paramCodedInputStream, ExtensionRegistryLite paramExtensionRegistryLite)
  {
    ...
    //   0: aconst_null
    //   1: astore_3
    //   2: invokestatic 68	com/google/protobuf/BoolValue:access$400	()Lcom/google/protobuf/Parser;
    //   5: aload_1
    //   6: aload_2
    //   7: invokeinterface 74 3 0
    //   12: checkcast 39	com/google/protobuf/BoolValue
    //   15: astore_1
    //   16: aload_1
    //   17: ifnull +9 -> 26
    //   20: aload_0
    //   21: aload_1
    //   22: invokevirtual 76	com/google/protobuf/BoolValue$Builder:a	(Lcom/google/protobuf/BoolValue;)Lcom/google/protobuf/BoolValue$Builder;
    //   25: pop
    //   26: aload_0
    //   27: areturn
    //   28: astore_2
    ...
    //   39: checkcast 39	com/google/protobuf/BoolValue
    //   42: astore_1
    //   43: aload_2
    ...
    //   53: aload_0
    //   54: aload_1
    //   55: invokevirtual 76	com/google/protobuf/BoolValue$Builder:a	(Lcom/google/protobuf/BoolValue;)Lcom/google/protobuf/BoolValue$Builder;
    //   58: pop
    //   59: aload_2
    //   60: athrow
  ...
  {
    if ((paramMessage instanceof BoolValue)) {
      return a((BoolValue)paramMessage);
    }
  ...
  public BoolValue c()
  {
    BoolValue localBoolValue = d();
    if (localBoolValue.isInitialized()) {
      return localBoolValue;
    }
    throw newUninitializedMessageException(localBoolValue);
  }
  
  public BoolValue d()
  {
    BoolValue localBoolValue = new BoolValue(this, null);
    BoolValue.access$302(localBoolValue, this.a);
    onBuilt();
    return localBoolValue;
  }
  ...
  {
    return WrappersProto.n.a(BoolValue.class, Builder.class);
  }
 ...
 * Qualified Name:     com.google.protobuf.BoolValue.Builder
