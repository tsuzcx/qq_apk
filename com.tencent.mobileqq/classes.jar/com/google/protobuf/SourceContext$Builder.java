  ...
  implements SourceContextOrBuilder
{
  ...
  private SourceContext$Builder(GeneratedMessageV3.BuilderParent paramBuilderParent)
  {
  ...
  public Builder a(CodedInputStream paramCodedInputStream, ExtensionRegistryLite paramExtensionRegistryLite)
  {
    ...
    //   0: aconst_null
    //   1: astore_3
    //   2: invokestatic 48	com/google/protobuf/SourceContext:access$400	()Lcom/google/protobuf/Parser;
    //   5: aload_1
    //   6: aload_2
    //   7: invokeinterface 54 3 0
    //   12: checkcast 44	com/google/protobuf/SourceContext
    //   15: astore_1
    //   16: aload_1
    //   17: ifnull +9 -> 26
    //   20: aload_0
    //   21: aload_1
    //   22: invokevirtual 57	com/google/protobuf/SourceContext$Builder:a	(Lcom/google/protobuf/SourceContext;)Lcom/google/protobuf/SourceContext$Builder;
    //   25: pop
    //   26: aload_0
    //   27: areturn
    //   28: astore_2
    ...
    //   39: checkcast 44	com/google/protobuf/SourceContext
    //   42: astore_1
    //   43: aload_2
    ...
    //   53: aload_0
    //   54: aload_1
    //   55: invokevirtual 57	com/google/protobuf/SourceContext$Builder:a	(Lcom/google/protobuf/SourceContext;)Lcom/google/protobuf/SourceContext$Builder;
    //   58: pop
    //   59: aload_2
    //   60: athrow
  ...
  {
    if ((paramMessage instanceof SourceContext)) {
      return a((SourceContext)paramMessage);
    }
  ...
  {
    if (paramSourceContext == SourceContext.getDefaultInstance()) {
      return this;
    }
    if (!paramSourceContext.getFileName().isEmpty())
    {
      this.a = SourceContext.access$300(paramSourceContext);
      onChanged();
    }
    b(paramSourceContext.unknownFields);
    onChanged();
    return this;
  }
  ...
  {
    SourceContext localSourceContext = d();
    if (localSourceContext.isInitialized()) {
      return localSourceContext;
    }
    throw newUninitializedMessageException(localSourceContext);
  }
  
  public SourceContext d()
  {
    SourceContext localSourceContext = new SourceContext(this, null);
    SourceContext.access$302(localSourceContext, this.a);
    onBuilt();
    return localSourceContext;
  }
  ...
  {
    return SourceContextProto.b.a(SourceContext.class, Builder.class);
  }
 ...
 * Qualified Name:     com.google.protobuf.SourceContext.Builder
