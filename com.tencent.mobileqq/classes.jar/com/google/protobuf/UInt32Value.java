  ...
  implements UInt32ValueOrBuilder
{
  ...
  private static final Parser<UInt32Value> b = new UInt32Value.1();
  ...
  /* Error */
  private UInt32Value(CodedInputStream paramCodedInputStream, ExtensionRegistryLite paramExtensionRegistryLite)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokespecial 26	com/google/protobuf/UInt32Value:<init>	()V
    //   4: aload_2
    //   5: ifnull +118 -> 123
    ...
    //   41: aload_2
    //   42: iload 4
    //   44: invokevirtual 56	com/google/protobuf/UInt32Value:parseUnknownField	(Lcom/google/protobuf/CodedInputStream;Lcom/google/protobuf/UnknownFieldSet$Builder;Lcom/google/protobuf/ExtensionRegistryLite;I)Z
    //   47: ifne -32 -> 15
    //   50: goto +14 -> 64
    //   53: aload_0
    //   54: aload_1
    //   55: invokevirtual 59	com/google/protobuf/CodedInputStream:m	()I
    //   58: putfield 61	com/google/protobuf/UInt32Value:value_	I
    //   61: goto -46 -> 15
    //   64: iconst_1
    //   65: istore_3
    //   66: goto -51 -> 15
    ...
    //   100: putfield 77	com/google/protobuf/UInt32Value:unknownFields	Lcom/google/protobuf/UnknownFieldSet;
    //   103: aload_0
    //   104: invokevirtual 80	com/google/protobuf/UInt32Value:makeExtensionsImmutable	()V
    //   107: aload_1
    //   108: athrow
    //   109: aload_0
    //   110: aload 5
    //   112: invokevirtual 73	com/google/protobuf/UnknownFieldSet$Builder:a	()Lcom/google/protobuf/UnknownFieldSet;
    //   115: putfield 77	com/google/protobuf/UInt32Value:unknownFields	Lcom/google/protobuf/UnknownFieldSet;
    //   118: aload_0
    //   119: invokevirtual 80	com/google/protobuf/UInt32Value:makeExtensionsImmutable	()V
    //   122: return
  ...
  public static UInt32Value.Builder newBuilder(UInt32Value paramUInt32Value)
  {
    return a.toBuilder().a(paramUInt32Value);
  }
  ...
  {
    return (UInt32Value)GeneratedMessageV3.parseDelimitedWithIOException(b, paramInputStream);
  }
  ...
  {
    return (UInt32Value)GeneratedMessageV3.parseDelimitedWithIOException(b, paramInputStream, paramExtensionRegistryLite);
  }
  
  public static UInt32Value parseFrom(ByteString paramByteString)
  {
    return (UInt32Value)b.parseFrom(paramByteString);
  }
  
  public static UInt32Value parseFrom(ByteString paramByteString, ExtensionRegistryLite paramExtensionRegistryLite)
  {
    return (UInt32Value)b.parseFrom(paramByteString, paramExtensionRegistryLite);
  }
  
  public static UInt32Value parseFrom(CodedInputStream paramCodedInputStream)
  {
    return (UInt32Value)GeneratedMessageV3.parseWithIOException(b, paramCodedInputStream);
  }
  ...
  {
    return (UInt32Value)GeneratedMessageV3.parseWithIOException(b, paramCodedInputStream, paramExtensionRegistryLite);
  }
  
  public static UInt32Value parseFrom(InputStream paramInputStream)
  {
    return (UInt32Value)GeneratedMessageV3.parseWithIOException(b, paramInputStream);
  }
  
  public static UInt32Value parseFrom(InputStream paramInputStream, ExtensionRegistryLite paramExtensionRegistryLite)
  {
    return (UInt32Value)GeneratedMessageV3.parseWithIOException(b, paramInputStream, paramExtensionRegistryLite);
  }
  
  public static UInt32Value parseFrom(ByteBuffer paramByteBuffer)
  {
    return (UInt32Value)b.parseFrom(paramByteBuffer);
  }
  
  public static UInt32Value parseFrom(ByteBuffer paramByteBuffer, ExtensionRegistryLite paramExtensionRegistryLite)
  {
    return (UInt32Value)b.parseFrom(paramByteBuffer, paramExtensionRegistryLite);
  }
  
  public static UInt32Value parseFrom(byte[] paramArrayOfByte)
  {
    return (UInt32Value)b.parseFrom(paramArrayOfByte);
  }
  
  public static UInt32Value parseFrom(byte[] paramArrayOfByte, ExtensionRegistryLite paramExtensionRegistryLite)
  {
    return (UInt32Value)b.parseFrom(paramArrayOfByte, paramExtensionRegistryLite);
  }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    paramObject = (UInt32Value)paramObject;
  ...
  {
    return WrappersProto.l.a(UInt32Value.class, UInt32Value.Builder.class);
  }
  ...
  protected UInt32Value.Builder newBuilderForType(GeneratedMessageV3.BuilderParent paramBuilderParent)
  {
    return new UInt32Value.Builder(paramBuilderParent, null);
  }
  ...
  public UInt32Value.Builder toBuilder()
  {
    ...
    return new UInt32Value.Builder(null).a(this);
  }
 ...
 * Qualified Name:     com.google.protobuf.UInt32Value
