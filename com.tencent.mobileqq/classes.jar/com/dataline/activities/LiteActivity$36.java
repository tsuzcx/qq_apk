  ...
  public void run()
  {
    ...
    if (((this.jdField_a_of_type_ComTencentImcoreMessageMessage.senderuin == null) || (!this.jdField_a_of_type_ComTencentImcoreMessageMessage.senderuin.equalsIgnoreCase(this.this$0.app.getCurrentAccountUin()))) && (!this.this$0.jdField_b_of_type_Boolean))
    {
      if (this.this$0.jdField_b_of_type_AndroidWidgetTextView == null)
      {
        ...
        this.this$0.jdField_b_of_type_AndroidWidgetTextView.setId(2131371967);
        this.this$0.jdField_b_of_type_AndroidWidgetTextView.setSingleLine();
        this.this$0.jdField_b_of_type_AndroidWidgetTextView.setBackgroundDrawable(this.this$0.getResources().getDrawable(2130839252));
        ...
        this.this$0.jdField_b_of_type_AndroidWidgetTextView.setBackgroundResource(2130839252);
        this.this$0.jdField_b_of_type_AndroidWidgetTextView.setTextColor(this.this$0.getResources().getColorStateList(2131167109));
        ...
        localObject = new RelativeLayout.LayoutParams(-1, (int)this.this$0.getResources().getDimension(2131297098));
    ...
    for (;;)
    {
      try
      {
        ...
        break;
        label510:
        if (this.jdField_a_of_type_ComTencentImcoreMessageMessage.msgtype == -2011)
        {
        ...
        if ((1010 == this.jdField_a_of_type_ComTencentImcoreMessageMessage.istroop) || (1001 == this.jdField_a_of_type_ComTencentImcoreMessageMessage.istroop) || (10002 == this.jdField_a_of_type_ComTencentImcoreMessageMessage.istroop))
        {
          if (String.valueOf(AppConstants.LBS_HELLO_UIN).equals(this.jdField_a_of_type_ComTencentImcoreMessageMessage.frienduin))
          {
            str2 = ContactUtils.q(this.this$0.app, this.jdField_a_of_type_ComTencentImcoreMessageMessage.senderuin);
            str1 = str2;
            ...
            localObject = String.format(this.this$0.getResources().getString(2131698673), new Object[] { str1 });
            break label388;
          }
          str2 = ContactUtils.q(this.this$0.app, this.jdField_a_of_type_ComTencentImcoreMessageMessage.frienduin);
          str1 = str2;
          if (!TextUtils.isEmpty(str2)) {
            continue;
          }
