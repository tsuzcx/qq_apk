  ...
  implements Observer
{
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (i == 0)
        {
          ...
          if (j != 0)
          {
            this.rightViewText.setText(getString(2131693740));
            return;
          }
          this.rightViewText.setText(getString(2131693739));
          return;
        }
  ...
  private void b()
  {
    ...
    for (;;)
    {
      ...
      this.leftView.setText(getString(2131693826));
      a();
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    setContentView(2131559114);
    getWindow().setBackgroundDrawable(null);
    b();
    findViewById(2131366960);
    this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)findViewById(2131366959));
    ...
    paramBundle = LayoutInflater.from(getActivity()).inflate(2131559007, null);
    this.jdField_a_of_type_ComTencentWidgetXListView.setOverscrollHeader(getActivity().getResources().getDrawable(2130844927));
  ...
  public void update(Observable paramObservable, Object paramObject)
  {
    ...
    do
    {
      ...
      } while (!((Message)paramObject).frienduin.endsWith(String.valueOf(AppConstants.DATALINE_PC_UIN)));
      this.jdField_a_of_type_ComDatalineUtilDatalineFilesAdapter.notifyDataSetChanged();
      a();
      return;
