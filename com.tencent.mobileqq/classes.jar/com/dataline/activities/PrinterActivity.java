  ...
  implements View.OnClickListener
{
  ...
  private amqk jdField_a_of_type_Amqk = new cu(this);
  public ViewGroup a;
  ...
  private void a(Object paramObject)
  {
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout == null)
    {
      LayoutInflater.from(this).inflate(2131559060, this.jdField_a_of_type_AndroidViewViewGroup, true);
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131363515));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131363516));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131363513));
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131363514));
      this.jdField_a_of_type_ComDatalineUtilWidgetAsyncImageView = ((AsyncImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131366632));
      Drawable localDrawable = super.getResources().getDrawable(2130840362);
    ...
    abdm.a();
    abdm.a(this.app, this.jdField_a_of_type_Long, "printer_hp", 1, 0, 0);
  }
  ...
  public void doOnActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if (paramInt1 == 56) {
      if (paramInt2 == -1)
      {
        ...
        ((Intent)localObject1).putExtra(bftk.h, paramInt1);
    ...
    for (paramInt1 = 1;; paramInt1 = 0)
    {
      ...
      localObject3 = this.jdField_a_of_type_Amqd.jdField_a_of_type_Dk.a;
      ...
      if (((dj)localObject3).jdField_a_of_type_Int == 2)
      {
        if (bool)
        {
          ...
          if (localObject4 != null)
          {
            ...
            localObject4 = ((aara)localObject2).a(((DeviceInfo)localObject4).productId);
            if (localObject4 != null) {
            ...
            ((aara)localObject2).a((Bundle)localObject3);
          }
          finish();
        }
        label362:
        switch (paramIntent.getIntExtra(bftk.h, 0))
        {
        default: 
      ...
      while (paramIntent.hasNext())
      {
        ...
        if (bieq.a(((FileInfo)localObject1).d().toLowerCase(), new String[] { ".txt" }))
        {
          bcef.b(this.app, "CliOper", "", "", "0X800401A", "0X800401A", 0, 0, "", "", "", "");
          continue;
          if ((((dj)localObject3).jdField_a_of_type_Int != 1) || (!bool)) {
            break label362;
          }
          break label362;
          bcef.b(this.app, "CliOper", "", "", "0X800405C", "0X800405C", 0, 0, "", "", "", "");
          break label396;
          bcef.b(this.app, "CliOper", "", "", "0X800405A", "0X800405A", 0, 0, "", "", "", "");
          break label396;
          bcef.b(this.app, "CliOper", "", "", "0X800405B", "0X800405B", 0, 0, "", "", "", "");
          break label396;
        }
        if (bieq.a(((FileInfo)localObject1).d().toLowerCase(), new String[] { ".doc", ".docx" })) {
          bcef.b(this.app, "CliOper", "", "", "0X800401B", "0X800401B", 0, 0, "", "", "", "");
        } else if (bieq.a(((FileInfo)localObject1).d().toLowerCase(), new String[] { ".ppt", ".pptx" })) {
          bcef.b(this.app, "CliOper", "", "", "0X800401C", "0X800401C", 0, 0, "", "", "", "");
        } else if (bieq.a(((FileInfo)localObject1).d().toLowerCase(), new String[] { ".xls", ".xlsx" })) {
          bcef.b(this.app, "CliOper", "", "", "0X800401D", "0X800401D", 0, 0, "", "", "", "");
        } else if (bieq.a(((FileInfo)localObject1).d().toLowerCase(), new String[] { ".jpg", ".png", ".jpeg", ".bmp" })) {
          bcef.b(this.app, "CliOper", "", "", "0X800401E", "0X800401E", 0, 0, "", "", "", "");
        } else if (bieq.a(((FileInfo)localObject1).d().toLowerCase(), new String[] { ".pdf" })) {
          bcef.b(this.app, "CliOper", "", "", "0X800401F", "0X800401F", 0, 0, "", "", "", "");
        } else {
          bcef.b(this.app, "CliOper", "", "", "0X8004020", "0X8004020", 0, 0, "", "", "", "");
        }
      }
    }
  }
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    super.setContentView(2131559055);
    super.setTitle(2131691255);
    super.getWindow().setBackgroundDrawable(null);
    this.jdField_a_of_type_AndroidViewViewGroup = ((FrameLayout)super.findViewById(2131365296));
    this.jdField_a_of_type_AndroidViewViewGroup.setTag(2131361807, "n/a");
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)super.findViewById(2131378378));
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
    this.jdField_b_of_type_AndroidWidgetButton = ((Button)super.findViewById(2131378379));
    this.jdField_b_of_type_AndroidWidgetButton.setOnClickListener(this);
    this.jdField_a_of_type_Amqd = ((amqd)this.app.getBusinessHandler(8));
    this.jdField_a_of_type_Amqd.jdField_a_of_type_Amxk.a = new es(this, this.jdField_a_of_type_Amqd);
    this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)super.findViewById(2131370072));
    ...
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Amqd.jdField_a_of_type_Amxk.a);
    paramBundle = LayoutInflater.from(this).inflate(2131558939, null);
    this.jdField_a_of_type_ComTencentWidgetXListView.setOverscrollHeader(super.getResources().getDrawable(2130844697));
    ...
    this.app.addObserver(this.jdField_a_of_type_Amqk);
    paramBundle = (amxn)this.app.getBusinessHandler(74);
    if (a()) {
      paramBundle.b();
    }
    return true;
  ...
  {
    this.jdField_a_of_type_Amqd.jdField_a_of_type_Amxk.a = null;
    this.jdField_a_of_type_Amqd.jdField_a_of_type_Amxk.b();
    if (this.jdField_a_of_type_ComTencentMobileqqWidgetScrollerRunnable != null) {
      this.jdField_a_of_type_ComTencentMobileqqWidgetScrollerRunnable.b();
    }
    this.app.removeObserver(this.jdField_a_of_type_Amqk);
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null) {
      this.jdField_a_of_type_AndroidViewViewGroup.removeView(this.jdField_a_of_type_AndroidWidgetRelativeLayout);
    }
  }
  ...
  public void doOnResume()
  {
    ...
    this.jdField_a_of_type_Amqd.jdField_a_of_type_Amxk.a.notifyDataSetChanged();
    ...
    int i = ((Intent)localObject1).getIntExtra(bftk.h, -1);
    if ((55 == i) || (i == 57))
    {
      ((Intent)localObject1).removeExtra(bftk.h);
      ...
      if (((ArrayList)localObject1).size() > 0)
      {
        ...
        ((Intent)localObject2).putExtra(bftk.h, i);
  ...
  public void onClick(View paramView)
  {
    ...
    if (i == 2131378378)
    {
      ...
      localIntent.putExtra(bftk.h, 56);
      localIntent.putExtra("STRING_Show_Within_Suffixs", this.jdField_a_of_type_Amqd.jdField_a_of_type_Amxk.a());
      super.startActivityForResult(localIntent, 56);
      AlbumUtil.anim(this, false, true);
      bcef.b(this.app, "CliOper", "", "", "0X8004018", "0X8004018", 0, 0, "", "", "", "");
    }
    do
    {
      for (;;)
      {
        ...
        localIntent.putExtra(bftk.h, 57);
        ...
        AlbumUtil.anim(this, false, true);
        bcef.b(this.app, "CliOper", "", "", "0X8004019", "0X8004019", 0, 0, "", "", "", "");
      }
    } while (i != 2131363515);
    ...
    if (TextUtils.isEmpty(this.jdField_c_of_type_JavaLangString))
    {
      ...
      localIntent.putExtra("title", amtj.a(2131707529));
      localIntent.putExtra("webStyle", "noBottomBar");
      localIntent.putExtra("hide_more_button", true);
      localIntent.putExtra("selfSet_leftViewText", amtj.a(2131707530));
      localIntent.putExtra("leftViewText", amtj.a(2131707531));
      abdm.a();
      abdm.a(this.app, this.jdField_a_of_type_Long, "printer_hp", 3, 0, 0);
    }
    for (;;)
    {
      a(this, localIntent);
      a();
      abdm.a();
      abdm.a(this.app, this.jdField_a_of_type_Long, "printer_hp", 2, 0, 0);
      break;
      ...
      abdm.a();
      abdm.a(this.app, this.jdField_a_of_type_Long, "printer_hp", 4, 0, 0);
    }
  }
