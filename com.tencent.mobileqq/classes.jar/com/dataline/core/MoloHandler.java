...
public class MoloHandler
{
  ...
  private PCPushProxy.OnDownloadListener a;
  
  public MoloHandler(DataLineHandler paramDataLineHandler)
  {
    this.jdField_a_of_type_ComTencentOpenPcpushPCPushProxy$OnDownloadListener = new ct(this);
    ...
    for (;;)
    {
      try
      {
        ...
        if (localPkgEntry != null)
        {
          ...
          paramArrayOfByte.msg = this.jdField_a_of_type_ComTencentMobileqqAppDataLineHandler.a().getApp().getString(2131427507);
