...
public class XTextInputPlugin
{
  ...
  @NonNull
  private XTextInputPlugin.InputTarget inputTarget = new XTextInputPlugin.InputTarget(XTextInputPlugin.InputTarget.Type.NO_TARGET, 0);
  ...
  public XTextInputPlugin(View paramView, @NonNull TextInputChannel paramTextInputChannel, @NonNull PlatformViewsController paramPlatformViewsController)
  {
  ...
  private void clearTextInputClient()
  {
    ...
    this.inputTarget = new XTextInputPlugin.InputTarget(XTextInputPlugin.InputTarget.Type.NO_TARGET, 0);
  ...
  private void setPlatformViewTextInputClient(int paramInt)
  {
    ...
    this.inputTarget = new XTextInputPlugin.InputTarget(XTextInputPlugin.InputTarget.Type.PLATFORM_VIEW, paramInt);
  ...
  {
    this.inputTarget = new XTextInputPlugin.InputTarget(XTextInputPlugin.InputTarget.Type.FRAMEWORK_CLIENT, paramInt);
  ...
  {
    if ((this.inputTarget.type == XTextInputPlugin.InputTarget.Type.PLATFORM_VIEW) && (this.inputTarget.id == paramInt))
    {
      this.inputTarget = new XTextInputPlugin.InputTarget(XTextInputPlugin.InputTarget.Type.NO_TARGET, 0);
  ...
  public InputConnection createInputConnection(View paramView, EditorInfo paramEditorInfo)
  {
    ...
    for (;;)
    {
      ...
      paramView = new XInputConnectionAdaptor(paramView, this.inputTarget.id, this.textInputChannel, this.mEditable);
  ...
  {
    this.textInputChannel.setTextInputMethodHandler(new XTextInputPlugin.1(this));
  }
