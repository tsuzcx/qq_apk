  ...
  implements FlutterRenderer.RenderSurface
{
  ...
  private final TextureView.SurfaceTextureListener surfaceTextureListener = new XFlutterTextureView.1(this);
  
  public XFlutterTextureView(@NonNull Context paramContext)
  {
    this(paramContext, (AttributeSet)null);
  }
  
  public XFlutterTextureView(@NonNull Context paramContext, @Nullable AttributeSet paramAttributeSet)
  {
  ...
  private void connectSurfaceToRenderer()
  {
    ...
    {
      Surface localSurface = new Surface(getSurfaceTexture());
      this.flutterRenderer.surfaceCreated(localSurface);
 ...
 * Qualified Name:     com.idlefish.flutterboost.XFlutterTextureView
