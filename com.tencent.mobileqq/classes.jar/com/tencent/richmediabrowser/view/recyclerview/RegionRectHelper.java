...
public class RegionRectHelper
{
  ...
  protected void onShowAreaChanged(View paramView, RegionDrawableData paramRegionDrawableData)
  {
    if (this.mMainBrowserPresenter != null) {
      this.mMainBrowserPresenter.onShowAreaChanged(paramView, paramRegionDrawableData);
    }
  }
  ...
  {
    if ((paramView == null) || (paramMatrix == null)) {}
    int i;
    int j;
    Rect localRect;
    do
    {
      ...
      {
        return;
        i = ScreenUtils.getScreenWidth(paramView.getContext());
        j = ScreenUtils.getScreenHeight(paramView.getContext());
      } while ((i == 0) || (j == 0));
      localRect = new Rect();
