  ...
  implements AbstractProgressView
{
  ...
  private void initDrawable(Activity paramActivity)
  {
    ...
    try
    {
      localObject2 = BitmapFactory.decodeResource(paramActivity.getResources(), 2130841582);
  ...
  {
    this.progressBar = ((ImageView)((RelativeLayout)paramBrowserBaseScene.getRootView()).findViewById(2131373047));
    initDrawable(paramActivity);
  }
