  ...
  implements AbstractProgressView
{
  ...
  private void initDrawable(Activity paramActivity)
  {
    ...
    try
    {
      localObject2 = BitmapFactory.decodeResource(paramActivity.getResources(), 2130841232);
  ...
  {
    this.progressBar = ((ImageView)((RelativeLayout)paramBrowserBaseScene.getRootView()).findViewById(2131372351));
    initDrawable(paramActivity);
  }
