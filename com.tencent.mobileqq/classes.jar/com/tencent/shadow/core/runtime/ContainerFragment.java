  ...
  implements IContainerFragment
{
  ...
  private static ShadowFragment instantiatePluginFragment(ContainerFragment paramContainerFragment, Context paramContext)
  {
    Object localObject = new StringBuilder();
    ((StringBuilder)localObject).append(paramContainerFragment.getClass().getName());
    ((StringBuilder)localObject).append("_");
    String str = ((StringBuilder)localObject).toString();
    localObject = (Constructor)constructorMap.get(str);
    paramContainerFragment = (ContainerFragment)localObject;
    if (localObject == null)
    {
      paramContainerFragment = ((PluginActivity)((PluginContainerActivity)paramContext).getPluginActivity()).getClassLoader();
      try
      {
        paramContainerFragment = paramContainerFragment.loadClass(str).getConstructor(new Class[0]);
        constructorMap.put(str, paramContainerFragment);
      }
      catch (Exception paramContainerFragment)
      {
        paramContext = new StringBuilder();
        paramContext.append("无法构造");
        paramContext.append(str);
        throw new Fragment.InstantiationException(paramContext.toString(), paramContainerFragment);
      }
    }
    try
    {
      paramContainerFragment = (ShadowFragment)ShadowFragment.class.cast(paramContainerFragment.newInstance(new Object[0]));
      return paramContainerFragment;
    }
    catch (Exception paramContainerFragment)
    {
      paramContext = new StringBuilder();
  ...
  public void bindPluginFragment(ShadowFragment paramShadowFragment)
  {
    ...
    this.mPluginFragment = paramShadowFragment;
  }
  ...
  public void onAttach(Activity paramActivity)
  {
    ...
    {
      paramActivity = (ShadowActivity)((PluginContainerActivity)paramActivity).getPluginActivity();
      this.mPluginFragment.onAttach(paramActivity);
    }
  }
  ...
  public void onInflate(AttributeSet paramAttributeSet, Bundle paramBundle)
  {
    ...
    this.mOnInflateParams = new ContainerFragment.OnInflateParams(paramAttributeSet, paramBundle, null);
    ShadowFragment localShadowFragment = this.mPluginFragment;
    if (localShadowFragment != null) {
      localShadowFragment.onInflate(paramAttributeSet, paramBundle);
    }
  }
 ...
 * Qualified Name:     com.tencent.shadow.core.runtime.ContainerFragment
