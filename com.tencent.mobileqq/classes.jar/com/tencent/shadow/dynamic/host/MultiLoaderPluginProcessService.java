  ...
  extends BasePluginProcessService
{
  ...
  PpsStatus getPpsStatusForPlugin(String paramString)
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 40	com/tencent/shadow/dynamic/host/MultiLoaderPluginProcessService:mUuidMap	Ljava/util/HashMap;
    //   8: aload_1
    ...
    //   17: aload_0
    //   18: aload_1
    //   19: invokespecial 153	com/tencent/shadow/dynamic/host/MultiLoaderPluginProcessService:isRuntimeLoaded	(Ljava/lang/String;)Z
    //   22: istore 4
    //   24: aload_0
    //   25: getfield 44	com/tencent/shadow/dynamic/host/MultiLoaderPluginProcessService:mPluginLoaderMap	Ljava/util/HashMap;
    //   28: aload_1
    ...
    //   36: istore_2
    //   37: aload_0
    //   38: getfield 42	com/tencent/shadow/dynamic/host/MultiLoaderPluginProcessService:mUuidManagerMap	Ljava/util/HashMap;
    //   41: aload_1
  ...
  void loadPluginLoaderForPlugin(String paramString1, String paramString2)
  {
    ...
    for (paramString1 = paramString1.getCause().getMessage();; paramString1 = paramString1.getMessage())
    {
      ...
      paramString2 = new LoaderImplLoader().load(localInstalledApk, paramString2, getApplicationContext());
