  ...
  implements CoverPreviewBar.OnPreviewBarSlideListener
{
  ...
  {
    if ((CoverSelectView.access$400(this.this$0) == null) || (CoverSelectView.access$400(this.this$0).getDuration() == null)) {
      return;
    }
    float f = Float.valueOf((int)(1.0F * paramFloat / 100.0F * (float)CoverSelectView.access$400(this.this$0).getDuration().getValue() / 1000.0F)).floatValue();
    if (CoverSelectView.access$500(this.this$0) != null) {
      CoverSelectView.access$500(this.this$0).seekToTime(new CMTime(f));
    }
