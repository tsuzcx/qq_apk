...
public class BitmapUtil
{
  ...
  public static Bitmap decodeFileWithBuffer(String paramString, BitmapFactory.Options paramOptions)
  {
    ...
    //   84: aload_0
    //   85: astore_2
    //   86: getstatic 134	com/tencent/tavcut/util/BitmapUtil:TAG	Ljava/lang/String;
    //   89: aload_1
    //   90: invokevirtual 206	java/lang/Exception:toString	()Ljava/lang/String;
    //   93: invokestatic 208	com/tencent/tavcut/util/Logger:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   96: aload_0
    //   97: ifnull +8 -> 105
    //   100: aload_3
    //   101: astore_1
  ...
  public static boolean saveBitmap(Bitmap paramBitmap, Bitmap.CompressFormat paramCompressFormat, int paramInt, String paramString, ExifInterface paramExifInterface)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokestatic 37	com/tencent/tavcut/util/BitmapUtil:isValidBitmap	(Landroid/graphics/Bitmap;)Z
    //   4: istore 7
    //   6: iconst_0
    //   7: istore 5
    //   9: iload 7
    //   11: ifne +14 -> 25
    //   14: getstatic 134	com/tencent/tavcut/util/BitmapUtil:TAG	Ljava/lang/String;
    //   17: ldc_w 289
    //   20: invokestatic 208	com/tencent/tavcut/util/Logger:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   23: iconst_0
    //   24: ireturn
    //   25: aconst_null
    //   26: astore 10
    ...
    //   97: astore 8
    //   99: aload_1
    //   100: invokestatic 90	com/tencent/tavcut/util/Logger:e	(Ljava/lang/Throwable;)V
    //   103: aload_0
    //   104: ifnull +19 -> 123
    //   107: aload_0
    ...
    //   118: astore_0
    //   119: aload_0
    //   120: invokestatic 90	com/tencent/tavcut/util/Logger:e	(Ljava/lang/Throwable;)V
    //   123: iconst_0
    //   124: istore 7
    //   126: aload 4
    //   128: ifnull +117 -> 245
    ...
    //   240: astore_0
    //   241: aload_0
    //   242: invokestatic 90	com/tencent/tavcut/util/Logger:e	(Ljava/lang/Throwable;)V
    //   245: iload 7
    //   247: ireturn
    //   248: aload 8
    //   250: ifnull +21 -> 271
    ...
    //   266: astore_1
    //   267: aload_1
    //   268: invokestatic 90	com/tencent/tavcut/util/Logger:e	(Ljava/lang/Throwable;)V
    //   271: goto +5 -> 276
    //   274: aload_0
    //   275: athrow
    //   276: goto -2 -> 274
