...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/tavcut/composition/model/component/Camera;", "Lcom/squareup/wire/AndroidMessage;", "Lcom/tencent/tavcut/composition/model/component/Camera$Builder;", "componentID", "", "enabled", "", "entityId", "renderTargetKey", "", "type", "version", "unknownFields", "Lokio/ByteString;", "(Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/Integer;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Integer;Lokio/ByteString;)V", "Ljava/lang/Integer;", "Ljava/lang/Boolean;", "copy", "(Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/Integer;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Integer;Lokio/ByteString;)Lcom/tencent/tavcut/composition/model/component/Camera;", "equals", "other", "", "hashCode", "newBuilder", "toString", "Builder", "Companion", "lib_tavcut_model_release"}, k=1, mv={1, 1, 16})
public final class Camera
  extends AndroidMessage<Camera, Camera.Builder>
{
  @JvmField
  @NotNull
  public static final ProtoAdapter<Camera> ADAPTER = (ProtoAdapter)new Camera.Companion.ADAPTER.1(FieldEncoding.LENGTH_DELIMITED, Reflection.getOrCreateKotlinClass(Camera.class), "type.googleapis.com/publisher.Camera");
  @JvmField
  @NotNull
  public static final Parcelable.Creator<Camera> CREATOR = AndroidMessage.Companion.newCreator(ADAPTER);
  public static final Camera.Companion Companion = new Camera.Companion(null);
  ...
  public Camera(@Nullable Integer paramInteger1, @Nullable Boolean paramBoolean, @Nullable Integer paramInteger2, @Nullable String paramString1, @Nullable String paramString2, @Nullable Integer paramInteger3, @NotNull ByteString paramByteString)
  {
    super(ADAPTER, paramByteString);
    this.componentID = paramInteger1;
    this.enabled = paramBoolean;
    this.entityId = paramInteger2;
    this.renderTargetKey = paramString1;
    this.type = paramString2;
    this.version = paramInteger3;
  }
  
  @NotNull
  public final Camera copy(@Nullable Integer paramInteger1, @Nullable Boolean paramBoolean, @Nullable Integer paramInteger2, @Nullable String paramString1, @Nullable String paramString2, @Nullable Integer paramInteger3, @NotNull ByteString paramByteString)
  {
    Intrinsics.checkParameterIsNotNull(paramByteString, "unknownFields");
    return new Camera(paramInteger1, paramBoolean, paramInteger2, paramString1, paramString2, paramInteger3, paramByteString);
  }
  
  public boolean equals(@Nullable Object paramObject)
  {
    if (paramObject == (Camera)this) {
      return true;
    }
  ...
  @NotNull
  public Camera.Builder newBuilder()
  {
    Camera.Builder localBuilder = new Camera.Builder();
  ...
  public String toString()
  {
    ...
    Object localObject2 = (CharSequence)"Camera{";
 ...
 * Qualified Name:     com.tencent.tavcut.composition.model.component.Camera
