  ...
  implements Runnable
{
  ...
  public void run()
  {
    this.this$0.resetAEKitModelForAI(this.this$0.getMediaModel(), TAVCutVideoSession.access$000(this.this$0), this.val$lutPath, this.val$lutStrength, this.val$adjustParams, this.val$smoothLevel, this.val$glowAlpha, this.this$0.getDuration().getTimeUs() / 1000L);
    this.this$0.refresh();
  }
}
