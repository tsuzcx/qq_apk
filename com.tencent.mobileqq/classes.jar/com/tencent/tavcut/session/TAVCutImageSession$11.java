  ...
  implements Runnable
{
  ...
  public void run()
  {
    this.this$0.clearAEKitModel((MediaModel)this.this$0.mediaModels.get(this.val$index), (VideoRenderChainManager)this.this$0.renderChainManagers.get(this.val$index));
