...
{
  TAVCutVideoSession$11(TAVCutVideoSession paramTAVCutVideoSession) {}
  ...
  public void buildCompleted(int paramInt, VideoRenderChainManager paramVideoRenderChainManager, MediaBuilderOutput paramMediaBuilderOutput)
  {
    ...
    TAVCutVideoSession.access$100(this.this$0).setRenderSize(new CGSize(1280.0F, 1280.0F));
    TAVCutVideoSession.access$100(this.this$0).setRenderLayoutMode(VideoComposition.RenderLayoutMode.aspectFit);
  }
}
