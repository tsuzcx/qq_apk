...
public class Common
{
  ...
  {
    zph.a("KingKongCommon", "Evil Report " + paramString1 + ", " + paramString2);
  ...
  {
    zph.a("KingKongCommon", "Notification From Native " + paramInt1 + ", " + paramInt2 + ", " + paramInt3);
  ...
  public static void SetContext(Context paramContext)
  {
    if ((paramContext != null) && (jdField_a_of_type_AndroidContentContext == null))
    {
      ...
      zpj.a(jdField_a_of_type_AndroidContentContext);
    }
  }
  ...
  public static int a(String paramString, ArrayList<String> paramArrayList)
  {
    ...
    {
      zph.a("KingKongCommon", "Library count mismatch " + j + ", " + paramArrayList.size());
      return -1;
    }
    int i = 0;
    while (i < j)
    {
      ...
      {
        zph.a("KingKongCommon", "Library name mismatch " + str1 + ", " + (String)paramArrayList.get(i));
        return -1;
      }
      String str2 = zpu.b(str1);
      if (TextUtils.isEmpty(str2))
      {
        zph.a("KingKongCommon", "Unable to get file SHA1 " + str1);
        return -1;
      }
      String str3 = jdField_a_of_type_AndroidContentSharedPreferences.getString(a("FINGERPRINT_LIB_SHA1", paramString, i), "");
      if (!str3.equals(str2))
      {
        zph.a("KingKongCommon", "Library SHA1 mismatch " + str1 + ", " + str3 + ", " + str2);
        return -1;
      }
      i += 1;
    }
  ...
  {
    zph.a("KingKongCommon", "Do patch " + paramInt + ", " + paramString1 + ", " + paramString2 + ", " + paramString3 + ", " + paramString4);
  ...
  public static void a(String paramString, int paramInt, int[] paramArrayOfInt1, int[] paramArrayOfInt2)
  {
    ...
    {
      zph.a("KingKongCommon", "Params count mismatch : " + paramArrayOfInt1.length + ", " + paramArrayOfInt2.length + ", " + paramInt);
      return;
    }
    int i = 0;
    while (i < paramInt)
  ...
  public static void b()
  {
    ...
    //   209: invokespecial 346	zpv:<init>	(Ljava/lang/String;)V
    //   212: putstatic 348	com/tencent/kingkong/Common:jdField_a_of_type_Zpv	Lzpv;
    //   215: goto -204 -> 11
    //   218: astore_1
    //   219: ldc 2
    //   221: monitorexit
