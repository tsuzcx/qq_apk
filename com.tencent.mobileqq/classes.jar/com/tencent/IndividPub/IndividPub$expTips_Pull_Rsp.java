  ...
  extends MessageMicro<expTips_Pull_Rsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 32, 42, 48 }, new String[] { "expFlag", "content", "clickText", "action", "url", "itemId" }, new Object[] { localInteger, "", "", localInteger, "", localInteger }, expTips_Pull_Rsp.class);
  }
}
