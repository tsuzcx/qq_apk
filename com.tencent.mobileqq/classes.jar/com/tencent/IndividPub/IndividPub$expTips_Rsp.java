  ...
  extends MessageMicro<expTips_Rsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 42, 50 }, new String[] { "ret", "errmsg", "cmd", "packet_seq", "comm", "rspcmd_0x01" }, new Object[] { localLong, "", Integer.valueOf(0), localLong, null, null }, expTips_Rsp.class);
  }
}
