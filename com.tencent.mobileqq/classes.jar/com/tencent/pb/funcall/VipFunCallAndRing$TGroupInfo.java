  ...
  extends MessageMicro<TGroupInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 42 }, new String[] { "i32_group_id", "str_group_name", "i32_ring_id", "u64_group_uins", "st_src_info" }, new Object[] { localInteger, "", localInteger, Long.valueOf(0L), null }, TGroupInfo.class);
  }
}
