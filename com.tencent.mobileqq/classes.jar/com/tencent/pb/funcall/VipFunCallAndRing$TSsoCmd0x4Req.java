  ...
  extends MessageMicro<TSsoCmd0x4Req>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "i32_funcall_id", "i32_ring_id", "rpt_uins" }, new Object[] { localInteger, localInteger, Long.valueOf(0L) }, TSsoCmd0x4Req.class);
  }
}
