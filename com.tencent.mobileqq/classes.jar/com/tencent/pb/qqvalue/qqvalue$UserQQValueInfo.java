  ...
  extends MessageMicro<UserQQValueInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 42, 48, 58, 64, 74 }, new String[] { "score", "level", "trend", "xy_id", "url", "on_off", "material_id", "uin", "ext_info" }, new Object[] { localInteger, localInteger, localInteger, localInteger, "", localInteger, "", Long.valueOf(0L), null }, UserQQValueInfo.class);
  }
}
