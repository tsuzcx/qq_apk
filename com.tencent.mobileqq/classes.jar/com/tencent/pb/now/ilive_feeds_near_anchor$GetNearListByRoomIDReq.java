  ...
  extends MessageMicro<GetNearListByRoomIDReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 13, 21, 24, 32, 40, 48, 56 }, new String[] { "longitude", "latitude", "roomid", "num", "source", "gender", "gender_filter" }, new Object[] { localFloat, localFloat, localInteger, localInteger, localInteger, localInteger, localInteger }, GetNearListByRoomIDReq.class);
  }
}
