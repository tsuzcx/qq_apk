...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32, 42, 48 }, new String[] { "uin", "version", "deviceType", "clientType", "strVersion", "key" }, new Object[] { Long.valueOf(0L), Integer.valueOf(0), "", Integer.valueOf(0), "", Integer.valueOf(0) }, GreyInterfaceReq.class);
