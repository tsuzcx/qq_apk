  ...
  extends MessageMicro<GetCommentListReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 40 }, new String[] { "feed_type", "feed_id", "page", "count", "filter" }, new Object[] { localLong, "", localLong, localLong, localLong }, GetCommentListReq.class);
  }
}
