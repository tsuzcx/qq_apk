  ...
  extends MessageMicro<RecommondItem>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 32, 42 }, new String[] { "id", "start_time", "end_time", "recom_pos", "uin_lists_key" }, new Object[] { "", localInteger, localInteger, localInteger, "" }, RecommondItem.class);
  }
}
