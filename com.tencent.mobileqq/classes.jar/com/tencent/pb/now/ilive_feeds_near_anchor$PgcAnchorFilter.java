  ...
  extends MessageMicro<PgcAnchorFilter>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40 }, new String[] { "uin2gender", "interest_bit", "constellation", "home_town", "profession" }, new Object[] { localInteger, localInteger, localInteger, localInteger, localInteger }, PgcAnchorFilter.class);
  }
}
