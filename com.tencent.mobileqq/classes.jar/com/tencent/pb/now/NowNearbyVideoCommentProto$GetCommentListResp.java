  ...
  extends MessageMicro<GetCommentListResp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32 }, new String[] { "result", "lists", "total_num", "end_flag" }, new Object[] { localLong, null, localLong, localLong }, GetCommentListResp.class);
  }
}
