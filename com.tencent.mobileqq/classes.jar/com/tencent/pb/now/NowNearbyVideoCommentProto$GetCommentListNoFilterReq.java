  ...
  extends MessageMicro<GetCommentListNoFilterReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 40, 48 }, new String[] { "feed_type", "feed_id", "page", "count", "filter", "need_usrinfo" }, new Object[] { localLong, "", localLong, localLong, localLong, localLong }, GetCommentListNoFilterReq.class);
  }
}
