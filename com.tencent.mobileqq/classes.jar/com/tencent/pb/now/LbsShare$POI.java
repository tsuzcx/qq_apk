  ...
  extends MessageMicro<POI>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 32, 40, 48, 58, 66, 74, 80, 90, 98, 106, 114 }, new String[] { "name", "addr", "shop_url", "lat", "lng", "coordinate", "id", "shop_url_quan", "dpid", "shop_count", "shangquan_url", "shangquan_wording", "POI_preview_url", "city" }, new Object[] { "", "", "", localInteger, localInteger, localInteger, "", "", "", localInteger, "", "", "", "" }, POI.class);
  }
}
