  ...
  extends MessageMicro<GetNearAnchorRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32, 40 }, new String[] { "ret", "anchor_num", "anchor_infos", "allow_repeated", "gender_filter" }, new Object[] { localInteger, localInteger, null, localInteger, localInteger }, GetNearAnchorRsp.class);
  }
}
