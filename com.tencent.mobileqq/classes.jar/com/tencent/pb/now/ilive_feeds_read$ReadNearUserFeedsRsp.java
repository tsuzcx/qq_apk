  ...
  extends MessageMicro<ReadNearUserFeedsRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 34, 40, 48 }, new String[] { "result", "err_msg", "end_flag", "infos", "total", "pos" }, new Object[] { localInteger, "", localInteger, null, localInteger, localInteger }, ReadNearUserFeedsRsp.class);
  }
}
