  ...
  extends MessageMicro<FeedDetailByIdRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32 }, new String[] { "result", "media_infos", "is_end", "total" }, new Object[] { localInteger, null, localInteger, localInteger }, FeedDetailByIdRsp.class);
  }
}
