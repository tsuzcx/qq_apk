  ...
  extends MessageMicro<ReadFollowFeedsReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "start_time", "num", "load_num" }, new Object[] { Long.valueOf(0L), localInteger, localInteger }, ReadFollowFeedsReq.class);
  }
}
