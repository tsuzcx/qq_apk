  ...
  extends MessageMicro<GetNearMicroAnchorReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 13, 21, 24, 32, 40, 48 }, new String[] { "longitude", "latitude", "start", "num", "source", "gender" }, new Object[] { localFloat, localFloat, localInteger, localInteger, localInteger, localInteger }, GetNearMicroAnchorReq.class);
  }
}
