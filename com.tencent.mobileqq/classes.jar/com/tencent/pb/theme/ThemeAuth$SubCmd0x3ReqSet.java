  ...
  extends MessageMicro<SubCmd0x3ReqSet>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34 }, new String[] { "uint32_theme_id", "uint32_suit_id", "uint32_diy_theme_flag", "diy_theme_info" }, new Object[] { localInteger, localInteger, localInteger, null }, SubCmd0x3ReqSet.class);
  }
}
