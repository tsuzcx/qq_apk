  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32, 42, 50, 58 }, new String[] { "uint32_sub_cmd", "int32_plat_id", "str_qq_version", "uint32_qq_version", "msg_subcmd0x1_req_auth", "msg_subcmd0x2_req_check", "msg_subcmd0x3_req_set" }, new Object[] { localInteger, localInteger, "", localInteger, null, null, null }, ReqBody.class);
  }
}
