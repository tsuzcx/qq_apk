  ...
  extends MessageMicro<MsgAuthReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "appid", "src_uid", "dst_uid" }, new Object[] { Integer.valueOf(0), localLong, localLong }, MsgAuthReq.class);
  }
}
