  ...
  extends MessageMicro<STGameTagInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32, 40 }, new String[] { "game_id", "tag_type", "tag_url", "tag_beg_ts", "tag_end_ts" }, new Object[] { localInteger, localInteger, "", localInteger, localInteger }, STGameTagInfo.class);
  }
}
