  ...
  extends MessageMicro<PadId>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 32 }, new String[] { "uint32_domainid", "bytes_localpadid", "bytes_pad_url", "uint32_retcode" }, new Object[] { localInteger, localByteStringMicro1, localByteStringMicro2, localInteger }, PadId.class);
  }
}
