  ...
  extends MessageMicro<GetSharedPadListRspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 40, 48 }, new String[] { "uint32_retcode", "uint32_total_count", "uint32_timestamp", "rpt_msg_pad_list", "uint32_offset", "bool_endflag" }, new Object[] { localInteger, localInteger, localInteger, null, localInteger, Boolean.valueOf(false) }, GetSharedPadListRspBody.class);
  }
}
