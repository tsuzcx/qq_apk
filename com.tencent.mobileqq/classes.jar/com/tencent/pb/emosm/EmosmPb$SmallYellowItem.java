  ...
  extends MessageMicro<SmallYellowItem>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "id", "type", "count", "ts" }, new Object[] { localInteger, localInteger, localInteger, Long.valueOf(0L) }, SmallYellowItem.class);
  }
}
