  ...
  extends MessageMicro
{
  ...
  public final PBRepeatMessageField bookList = PBField.initRepeatMessage(ComicIPSite.Book.class);
  public final PBRepeatMessageField comicList = PBField.initRepeatMessage(ComicIPSite.Comic.class);
  public final PBInt32Field extId = PBField.initInt32(0);
  public final PBStringField extStr = PBField.initString("");
  public final PBRepeatMessageField gameList = PBField.initRepeatMessage(ComicIPSite.Game.class);
  public final PBInt32Field goodSize = PBField.initInt32(0);
  public final PBRepeatMessageField goodsList = PBField.initRepeatMessage(ComicIPSite.Goods.class);
  public final PBRepeatMessageField gxzbList = PBField.initRepeatMessage(ComicIPSite.Gxzb.class);
  ...
  public final PBRepeatMessageField videoList = PBField.initRepeatMessage(ComicIPSite.Video.class);
}
