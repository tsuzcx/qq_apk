  ...
  extends MessageMicro<SubCmd0x14ReqFetchTabMac>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 13, 16, 29, 32 }, new String[] { "fixed32_timestamp_ios", "int32_segment_flag_ios", "fixed32_timestamp_android", "int32_segment_flag_android" }, new Object[] { localInteger, localInteger, localInteger, localInteger }, SubCmd0x14ReqFetchTabMac.class);
  }
}
