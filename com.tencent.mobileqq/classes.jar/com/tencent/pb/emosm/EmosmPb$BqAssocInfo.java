  ...
  extends MessageMicro<BqAssocInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 40, 50, 58, 66, 74, 82, 88, 98, 106, 114 }, new String[] { "u32_tab_id", "str_tab_name", "u32_tab_feetype", "i32_tab_type", "i32_tab_ringtype", "str_item_id", "str_item_name", "str_item_key", "rpt_str_item_keyword", "rpt_support_size", "uint32_emoji_type", "rpt_apng_support_size", "str_ipsite_url", "str_ipsite_name" }, new Object[] { localInteger, "", localInteger, localInteger, localInteger, "", "", "", "", null, localInteger, null, "", "" }, BqAssocInfo.class);
  }
}
