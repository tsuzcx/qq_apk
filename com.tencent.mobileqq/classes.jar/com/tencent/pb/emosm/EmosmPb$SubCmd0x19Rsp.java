  ...
  extends MessageMicro<SubCmd0x19Rsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 34, 42, 50, 61 }, new String[] { "uint32_package_id", "str_ip_url", "str_ip_name", "str_ip_detail", "str_op_name", "str_jump_url", "fixed32_time" }, new Object[] { localInteger, "", "", "", "", "", localInteger }, SubCmd0x19Rsp.class);
  }
}
