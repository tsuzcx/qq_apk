  ...
  extends MessageMicro<STRecommendTabInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 40, 50, 58, 66, 74, 80, 88 }, new String[] { "u32_tab_id", "str_tab_name", "i32_tab_type", "i32_feetype", "i32_price", "str_button_url", "str_thumb_nail_url", "str_bg_color", "str_title_color", "i32_recommend_mode", "int32_red_point_flag" }, new Object[] { localInteger, "", localInteger, localInteger, localInteger, "", "", "", "", localInteger, localInteger }, STRecommendTabInfo.class);
  }
}
