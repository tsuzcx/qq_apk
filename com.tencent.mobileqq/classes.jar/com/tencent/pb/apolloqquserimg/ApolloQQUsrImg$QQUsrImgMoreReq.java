...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32 }, new String[] { "uin", "attach_info", "type", "is_dynamic" }, new Object[] { Long.valueOf(0L), "", Long.valueOf(0L), Long.valueOf(0L) }, QQUsrImgMoreReq.class);
