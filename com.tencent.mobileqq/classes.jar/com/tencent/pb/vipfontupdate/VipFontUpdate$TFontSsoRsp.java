  ...
  extends MessageMicro<TFontSsoRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = initFieldMap(new int[] { 8, 18, 24, 32, 42, 50, 58, 66, 82, 90, 98 }, new String[] { "i32_ret", "str_msg", "u32_cmd", "u64_seq", "st_fresh_rsp", "st_md5_check_rsp", "st_poster_rsp", "st_check_rsp", "st_diyfont_rsp", "st_getposterfont_rsp", "st_setposterfont_rsp" }, new Object[] { localInteger, "", localInteger, Long.valueOf(0L), null, null, null, null, null, null, null }, TFontSsoRsp.class);
  }
}
