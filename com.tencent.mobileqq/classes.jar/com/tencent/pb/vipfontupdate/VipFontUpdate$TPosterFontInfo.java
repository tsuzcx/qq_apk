...
{
  static final MessageMicro.FieldMap __fieldMap__ = initFieldMap(new int[] { 8, 16 }, new String[] { "i32_font_id", "u64_ts" }, new Object[] { Integer.valueOf(0), Long.valueOf(0L) }, TPosterFontInfo.class);
