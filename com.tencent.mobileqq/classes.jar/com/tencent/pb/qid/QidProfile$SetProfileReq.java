  ...
  extends MessageMicro<SetProfileReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 26, 32 }, new String[] { "imgurl", "qid_type", "resource", "res_id" }, new Object[] { "", localInteger, "", localInteger }, SetProfileReq.class);
  }
}
