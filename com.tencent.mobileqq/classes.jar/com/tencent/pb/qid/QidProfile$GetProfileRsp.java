...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 26, 32 }, new String[] { "imgurl", "qid_type", "resource", "res_id" }, new Object[] { "", Integer.valueOf(0), "", Integer.valueOf(0) }, GetProfileRsp.class);
