  ...
  extends MessageMicro<STUserTrackReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 32, 42 }, new String[] { "strFrom", "gameId", "roomId", "playts", "userClick" }, new Object[] { "", localInteger, Long.valueOf(0L), localInteger, null }, STUserTrackReq.class);
  }
}
