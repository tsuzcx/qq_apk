  ...
  extends MessageMicro<STClickInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 48, 56, 64, 72 }, new String[] { "posx", "posy", "rotx", "roty", "velx", "vely", "angularvel", "btnstate", "time" }, new Object[] { localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger }, STClickInfo.class);
  }
}
