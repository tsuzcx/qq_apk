  ...
  extends MessageMicro<ReqUpdateTable>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16 }, new String[] { "uint32_item_id", "uint32_version" }, new Object[] { localInteger, localInteger }, ReqUpdateTable.class);
  }
}
