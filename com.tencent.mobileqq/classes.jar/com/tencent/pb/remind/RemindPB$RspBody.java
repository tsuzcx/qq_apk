  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34, 42, 48 }, new String[] { "int32_ret", "uint32_method", "msg_result", "msg_quota", "rep_set_info", "rep_clear_uin" }, new Object[] { localInteger, localInteger, "", null, null, Long.valueOf(0L) }, RspBody.class);
  }
}
