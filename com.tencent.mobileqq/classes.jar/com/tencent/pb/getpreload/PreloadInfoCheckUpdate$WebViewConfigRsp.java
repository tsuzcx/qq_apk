  ...
  extends MessageMicro<WebViewConfigRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 26, 32, 40 }, new String[] { "head", "url_check", "url_list", "js_report", "interval" }, new Object[] { null, localBoolean, "", localBoolean, Integer.valueOf(0) }, WebViewConfigRsp.class);
  }
}
