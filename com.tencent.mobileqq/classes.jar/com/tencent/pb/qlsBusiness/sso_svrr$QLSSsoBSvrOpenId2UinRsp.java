  ...
  extends MessageMicro<QLSSsoBSvrOpenId2UinRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 26, 32, 40 }, new String[] { "header", "appid", "openid", "result", "qquin" }, new Object[] { null, localInteger, "", localInteger, localInteger }, QLSSsoBSvrOpenId2UinRsp.class);
  }
}
