  ...
  extends MessageMicro<PageCookie>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32 }, new String[] { "uint32_start_idx", "bytes_attach_info", "uint32_last_ad_index", "uint32_ad_cnt" }, new Object[] { Integer.valueOf(0), localByteStringMicro, Integer.valueOf(0), Integer.valueOf(0) }, PageCookie.class);
  }
}
