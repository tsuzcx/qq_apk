  ...
  extends MessageMicro<schoolInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 32, 40 }, new String[] { "str_school_id", "str_school_name", "uint64_state", "uint32_idx", "uint32_category" }, new Object[] { "", "", Long.valueOf(0L), localInteger, localInteger }, schoolInfo.class);
  }
}
