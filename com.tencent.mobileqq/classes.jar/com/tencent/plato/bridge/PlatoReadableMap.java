  ...
  implements IReadableMap
{
  ...
  PlatoReadableMap(IFunction.CallbackInvoker paramCallbackInvoker, int paramInt, JSONObject paramJSONObject)
  {
  ...
  public IReadableArray getReadableArray(String paramString)
  {
    ...
    if (paramString != null) {
      return new PlatoReadableArray(this.mCallbackInvoker, this.mCallId, paramString);
    }
    return null;
  }
  ...
  public IReadableMap getReadableMap(String paramString)
  {
    ...
    if (paramString != null) {
      return new PlatoReadableMap(this.mCallbackInvoker, this.mCallId, paramString);
    }
    return null;
  }
 ...
 * Qualified Name:     com.tencent.plato.bridge.PlatoReadableMap
