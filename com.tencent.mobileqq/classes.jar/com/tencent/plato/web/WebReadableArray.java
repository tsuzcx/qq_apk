  ...
  implements IReadableArray
{
  ...
  WebReadableArray(IFunction.CallbackInvoker paramCallbackInvoker, int paramInt, String paramString)
  {
  ...
  WebReadableArray(IFunction.CallbackInvoker paramCallbackInvoker, int paramInt, JSONArray paramJSONArray)
  {
    this.mCallbackInvoker = paramCallbackInvoker;
    this.mCallId = paramInt;
  ...
  public IReadableArray getReadableArray(int paramInt)
  {
    ...
    if (localJSONArray != null) {
      return new WebReadableArray(this.mCallbackInvoker, this.mCallId, localJSONArray);
    }
    return null;
  }
  ...
  public IReadableMap getReadableMap(int paramInt)
  {
    ...
    if (localJSONObject != null) {
      return new WebReadableMap(this.mCallbackInvoker, this.mCallId, localJSONObject);
    }
    return null;
  }
 ...
 * Qualified Name:     com.tencent.plato.web.WebReadableArray
