...
{
  public static HashMap<String, Class<?>> Ec = new HashMap();
  public static HashMap<Class<?>, HashMap<String, Field>> Fc = new HashMap();
  public static HashMap<Class<?>, HashMap<String, Method>> Gc = new HashMap();
  ...
  public static Object a(Class<?> paramClass, String paramString, Object paramObject)
  {
    ...
    else
    {
      ...
      try
      {
        localObject2 = (HashMap)Fc.get(paramClass);
        localObject1 = localObject2;
        if (localObject2 == null)
        {
          localObject1 = new HashMap();
          Fc.put(paramClass, localObject1);
        }
  ...
  public static Method a(Class<?> paramClass, String paramString, Class<?>... paramVarArgs)
  {
    ...
    do
    {
      try
      {
        ...
        localObject2 = (HashMap)Gc.get(paramClass);
        localObject1 = localObject2;
        if (localObject2 == null)
        {
          localObject1 = new HashMap();
          Gc.put(paramClass, localObject1);
        }
  ...
  public static Object c(String paramString1, String paramString2)
  {
    ...
    try
    {
      Class localClass2 = (Class)Ec.get(paramString1);
    ...
    Ec.put(paramString1, localClass1);
    for (;;)
    {
      try
      {
 ...
 * Qualified Name:     com.tencent.tfd.sdk.wxa.extends
