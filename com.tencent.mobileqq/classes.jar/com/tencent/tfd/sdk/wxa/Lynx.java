...
public class Lynx
  extends LeoMinor
{
  public static final String Kd = const.get(const.wa);
  ...
  public String a(IBinder paramIBinder)
  {
    ...
    str2 = const.get(const.xa);
    localObject3 = Parcel.obtain();
    localParcel = Parcel.obtain();
    try
    {
      ((Parcel)localObject3).writeInterfaceToken(Kd);
 ...
 * Qualified Name:     com.tencent.tfd.sdk.wxa.Lynx
