...
public class CommonBadgeUtilImpl
{
  ...
  public static boolean isMIUI6()
  {
    ...
    //   19: aconst_null
    //   20: astore_3
    //   21: new 356	java/io/BufferedReader
    //   24: dup
    //   25: new 358	java/io/InputStreamReader
    //   28: dup
    //   29: new 360	java/lang/ProcessBuilder
    //   32: dup
    //   33: iconst_2
    ...
    //   45: ldc_w 364
    //   48: aastore
    //   49: invokespecial 367	java/lang/ProcessBuilder:<init>	([Ljava/lang/String;)V
    //   52: invokevirtual 371	java/lang/ProcessBuilder:start	()Ljava/lang/Process;
    //   55: invokevirtual 377	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    //   58: invokespecial 380	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   61: sipush 1024
    //   64: invokespecial 383	java/io/BufferedReader:<init>	(Ljava/io/Reader;I)V
    //   67: astore_2
    //   68: aload_2
    //   69: invokevirtual 386	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   72: astore_3
    //   73: aload_2
    //   74: invokevirtual 389	java/io/BufferedReader:close	()V
    //   77: aload_2
    //   78: ifnull +7 -> 85
    //   81: aload_2
    //   82: invokevirtual 389	java/io/BufferedReader:close	()V
    //   85: aload_3
    //   86: invokestatic 295	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   89: ifne +44 -> 133
    //   92: aload_3
    //   93: invokestatic 393	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   96: istore_0
    //   97: iload_0
    //   98: iconst_3
    //   99: if_icmple +34 -> 133
    //   102: ldc_w 395
    //   105: new 194	java/lang/StringBuilder
    //   108: dup
    //   109: invokespecial 195	java/lang/StringBuilder:<init>	()V
    //   112: ldc_w 397
    //   115: invokevirtual 199	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   118: iload_0
    //   119: invokevirtual 202	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   122: invokevirtual 206	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   125: invokestatic 288	android/util/Log:d	(Ljava/lang/String;Ljava/lang/String;)I
    //   128: pop
    //   129: iconst_1
    ...
    //   142: astore_2
    //   143: aload_2
    //   144: invokevirtual 398	java/lang/NumberFormatException:printStackTrace	()V
    //   147: iconst_0
    //   148: istore_0
    //   149: goto -52 -> 97
    //   152: astore_2
    ...
    //   159: ifnull +7 -> 166
    //   162: aload_2
    //   163: invokevirtual 389	java/io/BufferedReader:close	()V
    //   166: aload_3
    //   167: invokestatic 295	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   170: ifne -37 -> 133
    //   173: aload_3
    //   174: invokestatic 393	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   177: istore_0
    //   178: iload_0
    //   179: iconst_3
    ...
    //   199: iload_0
    //   200: invokevirtual 202	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   203: invokevirtual 206	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   206: invokestatic 288	android/util/Log:d	(Ljava/lang/String;Ljava/lang/String;)I
    //   209: pop
    //   210: iconst_1
    ...
    //   217: astore_2
    //   218: aload_2
    //   219: invokevirtual 398	java/lang/NumberFormatException:printStackTrace	()V
    //   222: iconst_0
    //   223: istore_0
    //   224: goto -46 -> 178
    //   227: astore_2
    ...
    //   231: ifnull +7 -> 238
    //   234: aload_2
    //   235: invokevirtual 389	java/io/BufferedReader:close	()V
    //   238: aload 4
    //   240: invokestatic 295	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   243: ifne -110 -> 133
    //   246: aload 4
    //   248: invokestatic 393	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   251: istore_0
    //   252: iload_0
    //   253: iconst_3
    //   254: if_icmple -121 -> 133
    //   257: ldc_w 395
    //   260: new 194	java/lang/StringBuilder
    //   263: dup
    //   264: invokespecial 195	java/lang/StringBuilder:<init>	()V
    //   267: ldc_w 397
    //   270: invokevirtual 199	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   273: iload_0
    //   274: invokevirtual 202	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   277: invokevirtual 206	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   280: invokestatic 288	android/util/Log:d	(Ljava/lang/String;Ljava/lang/String;)I
    //   283: pop
    //   284: iconst_1
    ...
    //   291: astore_2
    //   292: aload_2
    //   293: invokevirtual 398	java/lang/NumberFormatException:printStackTrace	()V
    //   296: iconst_0
    //   297: istore_0
    //   298: goto -46 -> 252
    //   301: astore_2
    ...
    //   306: ifnull +7 -> 313
    //   309: aload_3
    //   310: invokevirtual 389	java/io/BufferedReader:close	()V
    //   313: aload 4
    //   315: invokestatic 295	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   318: ifne +47 -> 365
    //   321: aload 4
    //   323: invokestatic 393	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   326: istore_1
    //   327: iload_1
    //   328: istore_0
    //   329: iload_0
    ...
    //   344: ldc_w 397
    //   347: invokevirtual 199	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   350: iload_0
    //   351: invokevirtual 202	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   354: invokevirtual 206	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   357: invokestatic 288	android/util/Log:d	(Ljava/lang/String;Ljava/lang/String;)I
    //   360: pop
    //   361: iconst_1
    ...
    //   367: astore_3
    //   368: aload_3
    //   369: invokevirtual 398	java/lang/NumberFormatException:printStackTrace	()V
    //   372: goto -43 -> 329
    //   375: iconst_0
    //   376: ireturn
    //   377: astore_2
  ...
  public static void setLenovoBadge(Context paramContext, int paramInt)
  {
    ...
    //   0: aconst_null
    //   1: astore_2
    //   2: new 504	android/content/ContentValues
    //   5: dup
    //   6: invokespecial 505	android/content/ContentValues:<init>	()V
    //   9: astore 4
    //   11: aload_0
    //   12: invokestatic 254	com/tencent/commonsdk/badge/CommonBadgeUtilImpl:getLauncherClassName	(Landroid/content/Context;)Ljava/lang/String;
    //   15: astore_3
    //   16: aload_3
    //   17: ifnonnull +4 -> 21
    //   20: return
    ...
    //   23: ldc_w 490
    //   26: aload_0
    //   27: invokevirtual 261	android/content/Context:getPackageName	()Ljava/lang/String;
    //   30: invokevirtual 508	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   33: aload 4
    //   35: ldc_w 496
    //   38: aload_3
    //   39: invokevirtual 508	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   42: aload 4
    //   44: ldc_w 510
    //   47: iload_1
    //   48: invokestatic 159	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   51: invokevirtual 513	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Integer;)V
    //   54: aload 4
    //   56: ldc_w 515
    //   59: ldc 99
    //   61: invokevirtual 508	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   64: aload_0
    //   65: invokevirtual 228	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   68: astore_3
    //   69: ldc 56
    //   71: invokestatic 236	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   74: astore 5
    //   76: aload_0
    //   77: invokevirtual 261	android/content/Context:getPackageName	()Ljava/lang/String;
    //   80: astore 6
    //   82: aload_3
    //   83: aload 5
    //   85: iconst_4
    ...
    //   124: aastore
    //   125: aconst_null
    //   126: invokevirtual 521	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   129: astore_3
    //   130: aload_3
    //   131: astore_2
    //   132: aload_2
    //   133: ifnull +61 -> 194
    //   136: aload_2
    //   137: invokeinterface 527 1 0
    //   142: ifle +52 -> 194
    //   145: aload_2
    //   146: invokeinterface 530 1 0
    //   151: ifeq +32 -> 183
    //   154: aload_0
    //   155: invokevirtual 228	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   158: ldc 56
    //   160: invokestatic 236	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   163: aload 4
    //   165: ldc_w 517
    //   168: iconst_1
    ...
    //   173: iconst_0
    //   174: aload_0
    //   175: invokevirtual 261	android/content/Context:getPackageName	()Ljava/lang/String;
    //   178: aastore
    //   179: invokevirtual 534	android/content/ContentResolver:update	(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    //   182: pop
    //   183: aload_2
    //   184: ifnull -164 -> 20
    //   187: aload_2
    //   188: invokeinterface 535 1 0
    //   193: return
    //   194: ldc 29
    //   196: ldc_w 537
    //   199: invokestatic 288	android/util/Log:d	(Ljava/lang/String;Ljava/lang/String;)I
    //   202: pop
    //   203: aload_0
    //   204: invokevirtual 228	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   207: ldc 56
    //   209: invokestatic 236	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   212: aload 4
    //   214: invokevirtual 541	android/content/ContentResolver:insert	(Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    //   217: pop
    //   218: aload_2
    //   219: ifnull -199 -> 20
    //   222: aload_2
    //   223: invokeinterface 535 1 0
    //   228: return
    //   229: astore_0
    //   230: aconst_null
    //   231: astore_2
    ...
    //   233: ifnull -213 -> 20
    //   236: aload_2
    //   237: invokeinterface 535 1 0
    //   242: return
    //   243: astore_0
    //   244: aload_2
    //   245: ifnull +9 -> 254
    //   248: aload_2
    //   249: invokeinterface 535 1 0
    //   254: aload_0
    //   255: athrow
    //   256: astore_0
    //   257: goto -13 -> 244
  ...
  public static void setSamsungBadge(Context paramContext, int paramInt)
  {
    ...
    //   6: ifnonnull +265 -> 271
    //   9: ldc_w 557
    //   12: invokestatic 236	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   15: astore_3
    //   16: aload_0
    //   17: invokevirtual 228	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   20: aload_3
    //   21: aconst_null
    //   22: aconst_null
    //   23: aconst_null
    //   24: aconst_null
    //   25: invokevirtual 521	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   28: astore_3
    //   29: aload_3
    //   30: ifnonnull +27 -> 57
    //   33: aload_3
    ...
    //   61: astore 5
    //   63: iconst_1
    //   64: invokestatic 562	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    ...
    //   79: invokevirtual 565	java/lang/Boolean:booleanValue	()Z
    //   82: ifeq +138 -> 220
    //   85: aload_3
    //   86: astore 4
    //   88: aload_3
    //   89: astore 5
    //   91: aload_0
    //   92: invokestatic 254	com/tencent/commonsdk/badge/CommonBadgeUtilImpl:getLauncherClassName	(Landroid/content/Context;)Ljava/lang/String;
    //   95: astore 6
    //   97: aload 6
    //   99: ifnonnull +14 -> 113
    //   102: aload_3
    ...
    //   141: aload_3
    //   142: astore 5
    //   144: new 183	android/content/Intent
    //   147: dup
    //   148: ldc_w 567
    //   151: invokespecial 186	android/content/Intent:<init>	(Ljava/lang/String;)V
    //   154: astore 7
    //   156: aload_3
    //   157: astore 4
    //   159: aload_3
    ...
    //   164: ldc_w 569
    //   167: iload_2
    //   168: invokevirtual 268	android/content/Intent:putExtra	(Ljava/lang/String;I)Landroid/content/Intent;
    //   171: pop
    //   172: aload_3
    //   173: astore 4
    //   175: aload_3
    ...
    //   180: ldc_w 571
    //   183: aload_0
    //   184: invokevirtual 261	android/content/Context:getPackageName	()Ljava/lang/String;
    //   187: invokevirtual 192	android/content/Intent:putExtra	(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    //   190: pop
    //   191: aload_3
    //   192: astore 4
    //   194: aload_3
    ...
    //   199: ldc_w 573
    //   202: aload 6
    //   204: invokevirtual 192	android/content/Intent:putExtra	(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    //   207: pop
    //   208: aload_3
    //   209: astore 4
    //   211: aload_3
    ...
    //   214: aload_0
    //   215: aload 7
    //   217: invokevirtual 212	android/content/Context:sendBroadcast	(Landroid/content/Intent;)V
    //   220: aload_3
    //   221: ifnull -165 -> 56
    //   224: aload_3
    //   225: invokeinterface 535 1 0
    //   230: return
    //   231: astore_0
    //   232: aconst_null
    //   233: astore 5
