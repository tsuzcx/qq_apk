  ...
  extends MessageMicro<GetWeatherByLbsReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 32, 40 }, new String[] { "pbReqMsgHead", "uin", "lat", "lng", "adcode_from_mapsdk" }, new Object[] { null, Long.valueOf(0L), localInteger, localInteger, localInteger }, GetWeatherByLbsReq.class);
  }
}
