  ...
  implements HippyTKDInvalidateCallback, IRecyclerViewFooter
{
  ...
  private int ballColor = ResourceUtil.getColor(2131167218);
  ...
  public HippyTKDDefaultFooter(Context paramContext)
  {
    ...
    setFocusable(true);
    setBallColor(0);
    setTextSize(ImmersiveUtils.a(12.0F));
    setTextMargins(this.mPullDownToRefreshDistanceBetweenIconText, 0, 0, 0);
    setLayoutParams(new ViewGroup.LayoutParams(-1, ImmersiveUtils.a(36.0F)));
    setFocusable(true);
  ...
  public void setBallColor(int paramInt)
  {
    ...
    for (this.ballColor = this.mCustomBallColor.intValue();; this.ballColor = ResourceUtil.getColor(2131167218))
    {
      this.mBallColorId = 0;
      paramInt = i;
      break;
    }
    this.mPullDownToRefreshSucIcon = UIBitmapUtils.getColorImage(ResourceUtil.getBitmap(2130850621), this.ballColor);
  ...
  public void setLoadingStatus(int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      {
        stopLoading();
        setText(ResourceUtil.getString(2131717403));
      ...
      {
        stopLoading();
        setText(ResourceUtil.getString(2131717410));
        setImageDrawable(this.mPullDownToRefreshFailIcon);
        return;
      }
      ...
      {
        stopLoading();
        setText(ResourceUtil.getString(2131717404));
        setImageDrawable(null);
        return;
      }
      ...
      {
        stopLoading();
        setText(ResourceUtil.getString(2131717405));
        setImageDrawable(null);
        return;
      }
      ...
      {
        stopLoading();
        setText(ResourceUtil.getString(2131717402));
        setImageDrawable(null);
        return;
      }
