...
public class HippyTKDListView$OuterScroll
  extends HippyViewEvent
{
  ...
  public HippyTKDListView$OuterScroll(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, HippyArray paramHippyArray)
  {
    super("onOuterScroll");
 ...
 * Qualified Name:     com.tencent.hippy.qq.view.tkd.listview.HippyTKDListView.OuterScroll
