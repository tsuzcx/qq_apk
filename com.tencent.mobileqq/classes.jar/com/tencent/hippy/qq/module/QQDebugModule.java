  ...
  extends QQBaseModule
{
  ...
  public void detailLog(String paramString)
  {
    ...
    localObject2 = ((QBaseFragment)localObject2).getQBaseActivity();
    if (localObject2 == null)
    {
    ...
    try
    {
      VasCommonJsPlugin.webLog((AppInterface)localObject1, (Activity)localObject2, new JSONObject(paramString));
      return;
    }
    catch (JSONException paramString)
    {
      localObject1 = new StringBuilder();
      ((StringBuilder)localObject1).append("detailLog error:");
      ((StringBuilder)localObject1).append(paramString);
      QLog.e("QQDebugModule", 1, ((StringBuilder)localObject1).toString());
    }
  }
