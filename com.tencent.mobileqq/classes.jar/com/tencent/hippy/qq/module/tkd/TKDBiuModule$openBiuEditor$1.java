  ...
  implements TKDBiuModule.ParamsFetcher
{
  ...
  public void onGetParams(@NotNull ArticleInfo paramArticleInfo, int paramInt1, int paramInt2, @NotNull String paramString)
  {
    ...
    paramArticleInfo = pqv.a(new Intent((Context)this.$activity, ReadInJoyDeliverBiuActivity.class), paramArticleInfo, paramInt2, this.$comment, this.$uin, this.$nickname, 0, paramInt1);
