...
public final class TKDCommentDispatcher
{
  ...
  public final void addEventListener(@Nullable TKDCommentDispatcher.HippyCommentEvent paramHippyCommentEvent)
  {
    if (paramHippyCommentEvent == null) {}
    while (hippyCommentEvents.contains(paramHippyCommentEvent)) {
      return;
    }
  ...
  public final void removeEventListener(@Nullable TKDCommentDispatcher.HippyCommentEvent paramHippyCommentEvent)
  {
    if (paramHippyCommentEvent != null) {
