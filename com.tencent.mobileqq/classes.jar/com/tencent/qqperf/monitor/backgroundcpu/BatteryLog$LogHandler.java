  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    if (paramMessage.what == 0)
    {
      if (BatteryLog.a() == null) {
        BatteryLog.a(VFSAssistantUtils.getSDKPrivatePath(Environment.getExternalStorageDirectory().getPath() + "/tencent/msflogs/" + "com.tencent.mobileqq".replace(".", File.separator) + "/battery/"));
      }
      ...
      try
      {
        ...
        try
        {
          localObject3 = MobileQQ.getContext().getPackageManager();
          paramMessage = (Message)localObject1;
          ...
          paramMessage = (Message)localObject1;
          localObject3 = ((PackageManager)localObject3).getApplicationInfo("com.tencent.mobileqq", 128).metaData.get("com.tencent.qapm.uuid").toString();
        ...
        BatteryLog.a(new Object[] { "header", localObject3, AppSetting.g(), "pub", localObject1, Build.MANUFACTURER, Build.MODEL, Integer.valueOf(Build.VERSION.SDK_INT), Long.valueOf(BatteryLog.a()), "1.3" });
        return;
      }
    ...
    else
    {
      ...
      {
        if (BatteryLog.a() == null) {
          BatteryLog.a(VFSAssistantUtils.getSDKPrivatePath(Environment.getExternalStorageDirectory().getPath() + "/tencent/msflogs/com/tencent/mobileqq/battery/"));
        }
        label831:
        for (;;)
        {
