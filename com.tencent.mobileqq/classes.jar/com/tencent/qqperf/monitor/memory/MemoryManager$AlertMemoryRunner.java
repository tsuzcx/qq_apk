  ...
  public void run()
  {
    for (;;)
    {
      ...
      catch (Throwable localThrowable)
      {
        ...
        QLog.e("Q.Memory.MemoryManager", 2, "AlertMemoryRunner exception, actionType=" + this.b, localThrowable);
        ...
        return;
        Object localObject1 = MobileQQ.getContext().getSharedPreferences("MemoryManagerMemoryStat", 0);
      ...
      localIntent = new Intent(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangClass);
      localIntent.putExtra("type", this.jdField_a_of_type_Int);
