  ...
  extends BaseUploadRunnable
{
  ...
  private boolean a()
  {
    ...
    for (;;)
    {
      ...
      FileUtils.f(this.jdField_a_of_type_JavaLangString, (String)localObject);
    }
    return false;
    return false;
  }
  ...
  public void run()
  {
    ...
    //   46: return
    //   47: aload_0
    //   48: getfield 25	com/tencent/qqperf/repoter/QCloudFileUploadRunnable:jdField_a_of_type_JavaNetURL	Ljava/net/URL;
    ...
    //   152: aload 6
    //   154: aload_0
    //   155: getfield 33	com/tencent/qqperf/repoter/QCloudFileUploadRunnable:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   158: invokevirtual 258	java/io/DataOutputStream:writeBytes	(Ljava/lang/String;)V
    //   161: aload 6
    //   163: astore 5
    //   165: aload_0
    //   166: getfield 41	com/tencent/qqperf/repoter/QCloudFileUploadRunnable:jdField_a_of_type_JavaIoFileInputStream	Ljava/io/FileInputStream;
    ...
    //   189: astore 5
    //   191: aload_0
    //   192: getfield 41	com/tencent/qqperf/repoter/QCloudFileUploadRunnable:jdField_a_of_type_JavaIoFileInputStream	Ljava/io/FileInputStream;
    //   195: aload 8
    //   197: iconst_0
    //   198: iload_2
    ...
    //   222: astore 5
    //   224: aload_0
    //   225: getfield 41	com/tencent/qqperf/repoter/QCloudFileUploadRunnable:jdField_a_of_type_JavaIoFileInputStream	Ljava/io/FileInputStream;
    ...
    //   239: astore 5
    //   241: aload_0
    //   242: getfield 41	com/tencent/qqperf/repoter/QCloudFileUploadRunnable:jdField_a_of_type_JavaIoFileInputStream	Ljava/io/FileInputStream;
    //   245: aload 8
    //   247: iconst_0
    //   248: iload_2
    ...
    //   274: aload 6
    //   276: astore 5
    //   278: invokestatic 59	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   281: ifeq +18 -> 299
    //   284: aload 6
    //   286: astore 5
    //   288: ldc 78
    ...
    //   291: ldc_w 280
    //   294: aload 7
    //   296: invokestatic 83	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   299: iload_3
    //   300: istore 4
    //   302: aload 6
    //   304: ifnull +11 -> 315
    ...
    //   312: iload_3
    //   313: istore 4
    //   315: invokestatic 59	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   318: ifeq +43 -> 361
    //   321: ldc 78
    //   323: iconst_2
    //   324: new 90	java/lang/StringBuilder
    //   327: dup
    //   328: invokespecial 150	java/lang/StringBuilder:<init>	()V
    //   331: ldc_w 283
    //   334: invokevirtual 99	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   337: iload 4
    //   339: invokevirtual 286	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   342: ldc_w 288
    //   345: invokevirtual 99	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   348: aload_0
    //   349: getfield 43	com/tencent/qqperf/repoter/QCloudFileUploadRunnable:jdField_a_of_type_Int	I
    ...
    //   363: ifne +289 -> 652
    //   366: aload_0
    //   367: getfield 43	com/tencent/qqperf/repoter/QCloudFileUploadRunnable:jdField_a_of_type_Int	I
    //   370: ifle +282 -> 652
    //   373: aload_0
    //   374: iconst_0
    //   375: invokespecial 170	com/tencent/qqperf/repoter/QCloudFileUploadRunnable:a	(Z)V
    //   378: aload_0
    //   379: aload_0
    //   380: getfield 47	com/tencent/qqperf/repoter/QCloudFileUploadRunnable:jdField_b_of_type_Int	I
    //   383: iconst_1
    //   384: iadd
    //   385: putfield 47	com/tencent/qqperf/repoter/QCloudFileUploadRunnable:jdField_b_of_type_Int	I
    //   388: aload_0
    //   389: aload_0
    //   390: getfield 43	com/tencent/qqperf/repoter/QCloudFileUploadRunnable:jdField_a_of_type_Int	I
    //   393: iconst_1
    //   394: isub
    //   395: putfield 43	com/tencent/qqperf/repoter/QCloudFileUploadRunnable:jdField_a_of_type_Int	I
    //   398: aload_0
    //   399: getfield 51	com/tencent/qqperf/repoter/QCloudFileUploadRunnable:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   402: aload_0
    //   403: ldc2_w 292
    ...
    //   415: aload 6
    //   417: aload_0
    //   418: getfield 35	com/tencent/qqperf/repoter/QCloudFileUploadRunnable:d	Ljava/lang/String;
    //   421: invokevirtual 258	java/io/DataOutputStream:writeBytes	(Ljava/lang/String;)V
    //   424: aload 6
    //   426: astore 5
    //   428: aload 6
    //   430: aload_0
    //   431: getfield 37	com/tencent/qqperf/repoter/QCloudFileUploadRunnable:e	Ljava/lang/String;
    ...
    //   460: invokevirtual 316	com/tencent/qqperf/repoter/QCloudFileUploadRunnable:a	(Ljava/lang/String;)Z
    //   463: istore_3
    //   464: aload 6
    //   466: astore 5
    //   468: aload_0
    //   469: getfield 45	com/tencent/qqperf/repoter/QCloudFileUploadRunnable:jdField_a_of_type_ComTencentQqperfRepoterIReporter$ReportResultCallback	Lcom/tencent/qqperf/repoter/IReporter$ReportResultCallback;
    //   472: ifnull +24 -> 496
    //   475: iload_3
    //   476: ifeq +20 -> 496
    //   479: aload 6
    //   481: astore 5
    //   483: aload_0
    //   484: getfield 45	com/tencent/qqperf/repoter/QCloudFileUploadRunnable:jdField_a_of_type_ComTencentQqperfRepoterIReporter$ReportResultCallback	Lcom/tencent/qqperf/repoter/IReporter$ReportResultCallback;
    //   487: aload_0
    //   488: getfield 49	com/tencent/qqperf/repoter/QCloudFileUploadRunnable:jdField_c_of_type_Int	I
    ...
    //   534: aload_0
    //   535: iconst_0
    //   536: putfield 43	com/tencent/qqperf/repoter/QCloudFileUploadRunnable:jdField_a_of_type_Int	I
    //   539: iload_3
    //   540: istore 4
    //   542: aload 6
    //   544: ifnull -229 -> 315
    ...
    //   577: aload_0
    //   578: iconst_0
    //   579: putfield 43	com/tencent/qqperf/repoter/QCloudFileUploadRunnable:jdField_a_of_type_Int	I
    //   582: aload 6
    //   584: astore 5
    //   586: invokestatic 59	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   589: ifeq +18 -> 607
    //   592: aload 6
    //   594: astore 5
    //   596: ldc 78
    ...
    //   599: ldc_w 280
    //   602: aload 7
    //   604: invokestatic 83	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   607: iload_3
    //   608: istore 4
    //   610: aload 6
    //   612: ifnull -297 -> 315
    ...
    //   652: aload_0
    //   653: iconst_0
    //   654: invokespecial 170	com/tencent/qqperf/repoter/QCloudFileUploadRunnable:a	(Z)V
    //   657: return
    //   658: astore 5
    //   660: iload_3
    //   661: istore 4
