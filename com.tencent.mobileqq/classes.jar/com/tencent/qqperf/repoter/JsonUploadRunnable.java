  ...
  extends BaseUploadRunnable
{
  ...
  public void run()
  {
    ...
    //   9: astore 6
    //   11: aload_0
    //   12: getfield 18	com/tencent/qqperf/repoter/JsonUploadRunnable:jdField_a_of_type_JavaNetURL	Ljava/net/URL;
    ...
    //   143: aload 7
    //   145: aload_0
    //   146: getfield 20	com/tencent/qqperf/repoter/JsonUploadRunnable:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    ...
    //   174: aload_3
    //   175: astore 4
    //   177: invokestatic 34	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   180: ifeq +34 -> 214
    //   183: aload_2
    //   184: astore 5
    //   186: aload_3
    ...
    //   202: iconst_1
    //   203: aload_0
    //   204: getfield 20	com/tencent/qqperf/repoter/JsonUploadRunnable:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    ...
    //   245: aload_0
    //   246: aload 7
    //   248: invokevirtual 162	com/tencent/qqperf/repoter/JsonUploadRunnable:a	(Ljava/lang/String;)Z
    //   251: istore_1
    //   252: aload_2
    //   253: astore 5
    //   255: aload_3
    //   256: astore 4
    //   258: invokestatic 34	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   261: ifeq +44 -> 305
    //   264: aload_2
    //   265: astore 5
    //   267: aload_3
    ...
    //   327: astore 4
    //   329: aload_0
    //   330: getfield 26	com/tencent/qqperf/repoter/JsonUploadRunnable:jdField_a_of_type_ComTencentQqperfRepoterIReporter$ReportResultCallback	Lcom/tencent/qqperf/repoter/IReporter$ReportResultCallback;
    //   333: ifnull +483 -> 816
    //   336: aload_3
    //   337: astore 4
    //   339: aload_0
    //   340: getfield 26	com/tencent/qqperf/repoter/JsonUploadRunnable:jdField_a_of_type_ComTencentQqperfRepoterIReporter$ReportResultCallback	Lcom/tencent/qqperf/repoter/IReporter$ReportResultCallback;
    //   343: aload_0
    //   344: getfield 28	com/tencent/qqperf/repoter/JsonUploadRunnable:b	I
    ...
    //   378: astore 4
    //   380: aload_0
    //   381: getfield 22	com/tencent/qqperf/repoter/JsonUploadRunnable:jdField_a_of_type_Int	I
    //   384: ifle +115 -> 499
    //   387: aload_2
    //   388: astore 5
    //   390: aload_3
    ...
    //   393: aload_0
    //   394: aload_0
    //   395: getfield 22	com/tencent/qqperf/repoter/JsonUploadRunnable:jdField_a_of_type_Int	I
    //   398: iconst_1
    //   399: isub
    //   400: putfield 22	com/tencent/qqperf/repoter/JsonUploadRunnable:jdField_a_of_type_Int	I
    //   403: aload_2
    //   404: astore 5
    //   406: aload_3
    //   407: astore 4
    //   409: aload_0
    //   410: getfield 24	com/tencent/qqperf/repoter/JsonUploadRunnable:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   413: aload_0
    //   414: ldc2_w 191
    ...
    //   434: aload 4
    //   436: astore_3
    //   437: invokestatic 34	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   440: ifeq +13 -> 453
    //   443: ldc 137
    //   445: iconst_2
    //   446: ldc 200
    ...
    //   453: aload_0
    //   454: getfield 22	com/tencent/qqperf/repoter/JsonUploadRunnable:jdField_a_of_type_Int	I
    //   457: ifle +113 -> 570
    //   460: aload_0
    //   461: aload_0
    //   462: getfield 22	com/tencent/qqperf/repoter/JsonUploadRunnable:jdField_a_of_type_Int	I
    //   465: iconst_1
    //   466: isub
    //   467: putfield 22	com/tencent/qqperf/repoter/JsonUploadRunnable:jdField_a_of_type_Int	I
    //   470: aload_0
    //   471: getfield 24	com/tencent/qqperf/repoter/JsonUploadRunnable:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   474: aload_0
    //   475: ldc2_w 191
    ...
    //   506: astore 4
    //   508: aload_0
    //   509: getfield 26	com/tencent/qqperf/repoter/JsonUploadRunnable:jdField_a_of_type_ComTencentQqperfRepoterIReporter$ReportResultCallback	Lcom/tencent/qqperf/repoter/IReporter$ReportResultCallback;
    //   512: ifnull -157 -> 355
    //   515: aload_2
    //   516: astore 5
    //   518: aload_3
    //   519: astore 4
    //   521: aload_0
    //   522: getfield 26	com/tencent/qqperf/repoter/JsonUploadRunnable:jdField_a_of_type_ComTencentQqperfRepoterIReporter$ReportResultCallback	Lcom/tencent/qqperf/repoter/IReporter$ReportResultCallback;
    //   525: aload_0
    //   526: getfield 28	com/tencent/qqperf/repoter/JsonUploadRunnable:b	I
    ...
    //   548: aload_0
    //   549: iconst_0
    //   550: putfield 22	com/tencent/qqperf/repoter/JsonUploadRunnable:jdField_a_of_type_Int	I
    //   553: aload_3
    //   554: ifnull +7 -> 561
    //   557: aload_3
    ...
    //   569: return
    //   570: aload_0
    //   571: getfield 26	com/tencent/qqperf/repoter/JsonUploadRunnable:jdField_a_of_type_ComTencentQqperfRepoterIReporter$ReportResultCallback	Lcom/tencent/qqperf/repoter/IReporter$ReportResultCallback;
    //   574: ifnull -92 -> 482
    //   577: aload_0
    //   578: getfield 26	com/tencent/qqperf/repoter/JsonUploadRunnable:jdField_a_of_type_ComTencentQqperfRepoterIReporter$ReportResultCallback	Lcom/tencent/qqperf/repoter/IReporter$ReportResultCallback;
    //   581: aload_0
    //   582: getfield 28	com/tencent/qqperf/repoter/JsonUploadRunnable:b	I
    ...
    //   628: aload_0
    //   629: iconst_0
    //   630: putfield 22	com/tencent/qqperf/repoter/JsonUploadRunnable:jdField_a_of_type_Int	I
    //   633: invokestatic 34	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   636: ifeq +13 -> 649
    //   639: ldc 137
    //   641: iconst_2
    //   642: ldc 206
