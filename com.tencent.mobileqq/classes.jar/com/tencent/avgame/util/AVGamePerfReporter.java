...
{
  private static AVGamePerfReporter jdField_a_of_type_ComTencentAvgameUtilAVGamePerfReporter = null;
  ...
  {
    if (jdField_a_of_type_ComTencentAvgameUtilAVGamePerfReporter == null) {}
    try
    {
      if (jdField_a_of_type_ComTencentAvgameUtilAVGamePerfReporter == null) {
        jdField_a_of_type_ComTencentAvgameUtilAVGamePerfReporter = new AVGamePerfReporter();
      }
      return jdField_a_of_type_ComTencentAvgameUtilAVGamePerfReporter;
    }
    finally {}
  }
  ...
  {
    str2 = "";
    Object localObject = VoiceRecogEngineFactory.a();
    if (localObject == VoiceRecogEngineFactory.VoiceRecogEngineType.REMOTE_ENGINE_TYPE) {
      return "s2";
    }
    if (localObject == VoiceRecogEngineFactory.VoiceRecogEngineType.WX_ENGINE_TYPE)
    {
      localObject = "AVGameVoiceRecogModel";
      ResInfo localResInfo = ResMgr.a().a((String)localObject);
      localObject = str2;
      if (localResInfo != null) {
        localObject = localResInfo.resZipUrl;
      }
    }
    for (;;)
    {
      ...
      return localObject;
      localObject = "AVGameVoiceRecogAILabModel";
      break;
      i = 0;
      continue;
      j = 0;
  ...
  public void a(boolean paramBoolean, String paramString1, String paramString2, long paramLong1, String paramString3, String paramString4, String paramString5, long paramLong2)
  {
    ...
    for (paramString5 = "1";; paramString5 = "0")
    {
      ...
      localHashMap.put("ai_denoise", String.valueOf(VoiceRecogEngineFactory.a()));
      if (VoiceRecogEngineFactory.a() == VoiceRecogEngineFactory.VoiceRecogEngineType.AILAB_ENGINE_TYPE) {
        localHashMap.put("score", String.valueOf(AILabVoiceRecogEngine.b()));
      }
 ...
 * Qualified Name:     com.tencent.avgame.util.AVGamePerfReporter
