  ...
  extends View
{
  ...
  private nhf jdField_a_of_type_Nhf = new nhf();
  ...
  public static Typeface a()
  {
    ...
    try
    {
      jdField_a_of_type_AndroidGraphicsTypeface = Typeface.createFromFile(mzu.d() + "GameFont.ttf");
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    if ((this.jdField_a_of_type_Nhf == null) || (!this.jdField_a_of_type_Nhf.a())) {
      return;
    }
    ...
    this.jdField_a_of_type_AndroidGraphicsPaint.setColor(Color.parseColor(this.jdField_a_of_type_Nhf.b));
    ...
    this.jdField_a_of_type_AndroidGraphicsPaint.setStyle(Paint.Style.FILL_AND_STROKE);
    this.jdField_a_of_type_AndroidGraphicsPaint.setColor(Color.parseColor(this.jdField_a_of_type_Nhf.jdField_a_of_type_JavaLangString));
  ...
  {
    this.jdField_a_of_type_Nhf.jdField_a_of_type_JavaLangString = paramString1;
    this.jdField_a_of_type_Nhf.b = paramString2;
  }
