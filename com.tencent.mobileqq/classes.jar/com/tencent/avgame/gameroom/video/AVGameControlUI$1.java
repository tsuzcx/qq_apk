  ...
  implements QQPermissionCallback
{
  ...
  {
    QLog.w(this.jdField_a_of_type_ComTencentAvgameGameroomVideoAVGameControlUI.jdField_a_of_type_JavaLangString, 1, "onClick_Camera, deny, i[" + paramInt + "], mRequestPermissionIng[" + this.jdField_a_of_type_ComTencentAvgameGameroomVideoAVGameControlUI.jdField_a_of_type_Boolean + "], permissions[" + AudioHelper.a(paramArrayOfString) + "], grantResults[" + AudioHelper.a(paramArrayOfInt) + "]");
    this.jdField_a_of_type_ComTencentAvgameGameroomVideoAVGameControlUI.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_ComTencentAvgameGameroomVideoAVGameControlUI.a(this.jdField_a_of_type_Long, this.jdField_a_of_type_JavaLangString);
  }
  
  public void grant(int paramInt, String[] paramArrayOfString, int[] paramArrayOfInt)
  {
    QLog.w(this.jdField_a_of_type_ComTencentAvgameGameroomVideoAVGameControlUI.jdField_a_of_type_JavaLangString, 1, "onClick_Camera, grant, i[" + paramInt + "], mRequestPermissionIng[" + this.jdField_a_of_type_ComTencentAvgameGameroomVideoAVGameControlUI.jdField_a_of_type_Boolean + "], permissions[" + AudioHelper.a(paramArrayOfString) + "], grantResults[" + AudioHelper.a(paramArrayOfInt) + "]");
    this.jdField_a_of_type_ComTencentAvgameGameroomVideoAVGameControlUI.jdField_a_of_type_Boolean = false;
