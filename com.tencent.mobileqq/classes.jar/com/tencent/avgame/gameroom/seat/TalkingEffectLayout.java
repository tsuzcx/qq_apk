  ...
  extends RelativeLayout
{
  ...
  private void c()
  {
    ...
    this.jdField_b_of_type_AndroidWidgetImageView.setImageDrawable(getResources().getDrawable(2130838765));
    this.jdField_a_of_type_AndroidWidgetImageView = new ImageView(getContext());
    this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(getResources().getDrawable(2130838766));
  ...
  private void d()
  {
    ...
    this.jdField_a_of_type_AndroidAnimationAnimatorSet.addListener(new neb(this));
  }
