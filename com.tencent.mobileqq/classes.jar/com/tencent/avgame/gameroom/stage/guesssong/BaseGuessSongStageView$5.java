  ...
  implements ViewTreeObserver.OnGlobalLayoutListener
{
  ...
  public void onGlobalLayout()
  {
    ...
    {
      QLog.d("BaseGuessSongStageView", 2, "onShowGameTopicTips tip = " + this.jdField_a_of_type_JavaLangString);
      QLog.d("BaseGuessSongStageView", 2, "onShowGameTopicTips tipWidth  = " + this.jdField_a_of_type_ComTencentAvgameGameroomStageGuesssongBaseGuessSongStageView.b.getWidth());
      QLog.d("BaseGuessSongStageView", 2, "onShowGameTopicTips caluWidth  = " + i);
    }
    ...
    if (i > 0)
    {
      ...
      localLayoutParams = this.jdField_a_of_type_ComTencentAvgameGameroomStageGuesssongBaseGuessSongStageView.jdField_a_of_type_AndroidViewView.getLayoutParams();
      localLayoutParams.width = this.jdField_a_of_type_ComTencentAvgameGameroomStageGuesssongBaseGuessSongStageView.jdField_a_of_type_AndroidViewView.getWidth();
      localLayoutParams.height = (localLayoutParams.width * 130 / 478);
      this.jdField_a_of_type_ComTencentAvgameGameroomStageGuesssongBaseGuessSongStageView.jdField_a_of_type_AndroidViewView.setLayoutParams(localLayoutParams);
      if (QLog.isColorLevel()) {
        QLog.d("BaseGuessSongStageView", 2, "onShowMosaicImageGameTopicTips 130 w = " + localLayoutParams.width + ", h = " + localLayoutParams.height);
      }
    }
    label284:
    do
    ...
    QLog.d("BaseGuessSongStageView", 2, "onShowMosaicImageGameTopicTips 110 w = " + localLayoutParams.width + ", h = " + localLayoutParams.height);
  }
}
