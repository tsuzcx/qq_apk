  ...
  implements Runnable
{
  ...
  public void run()
  {
    if ((this.this$0.jdField_a_of_type_JavaUtilArrayList != null) && (this.this$0.jdField_a_of_type_Int < this.this$0.jdField_a_of_type_JavaUtilArrayList.size()))
    {
      ...
      ((BaseGuessStarStageView)localObject).a((String)((Pair)((BaseGuessStarStageView)localObject).jdField_a_of_type_JavaUtilArrayList.get(this.this$0.jdField_a_of_type_Int)).second);
