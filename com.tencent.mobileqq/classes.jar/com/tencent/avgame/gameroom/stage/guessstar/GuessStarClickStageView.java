  ...
  extends BaseGuessStarStageView
{
  ...
  public Bitmap a(EngineData paramEngineData)
  {
    ...
    for (paramEngineData = ((TopicOperGuessVideo)paramEngineData).jdField_a_of_type_ComTencentAvgameGamelogicDataAVRes.a;; paramEngineData = null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("GuessStarClickStageView", 2, "showVideoBg ,videoUrl = " + paramEngineData);
      }
  ...
  public Bitmap a(String paramString)
  {
    ...
    try
    {
      localMediaMetadataRetriever.setDataSource(paramString, new HashMap());
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("GuessStarClickStageView", 2, "onUpdateCurTopic topic = " + paramITopic);
    }
    if (paramITopic == null) {}
    do
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.i("GuessStarClickStageView", 2, "onUpdateCurTopic() businessAdsTips:" + paramITopic);
      }
    } while (TextUtils.isEmpty(paramITopic));
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("GuessStarClickStageView", 2, "showTopicTips tip = " + paramString);
    }
    this.jdField_a_of_type_AndroidWidgetTextView.setText(getResources().getText(2131690416) + paramString);
  }
  
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    if (QLog.isColorLevel()) {
      QLog.d("GuessStarClickStageView", 2, "onShowGameBottomWidget ,isPlayerSelf = " + paramBoolean1 + ",show = " + paramBoolean2);
    }
  ...
  protected void b()
  {
    LayoutInflater.from(getContext()).inflate(2131558770, this, true);
    ...
    this.jdField_d_of_type_AndroidViewView = findViewById(2131379697);
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131364800));
