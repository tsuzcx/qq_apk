  ...
  implements IGameStagePresenter
{
  IStagePresenter a;
  IGameStageView b;
  private ArrayList<Pair<GuessTextClickStagePresenter.MixGraphicContent, Boolean>> c = new ArrayList(20);
  ...
  public void b(EngineData paramEngineData)
  {
    ...
    if (localITopic != null) {
      this.c.add(new Pair(new GuessTextClickStagePresenter.MixGraphicContent(localITopic.e(), localITopic.c()), Boolean.valueOf(false)));
    }
  }
  ...
  public void d(EngineData paramEngineData)
  {
    ...
    if ((localObject != null) && (!this.c.isEmpty()))
    {
      ...
      this.c.add(new Pair(new GuessTextClickStagePresenter.MixGraphicContent(((ITopic)localObject).e(), ((ITopic)localObject).c()), Boolean.valueOf(true)));
