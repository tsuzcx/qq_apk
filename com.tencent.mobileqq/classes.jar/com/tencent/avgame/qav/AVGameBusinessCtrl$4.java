...
public class AVGameBusinessCtrl$4
  implements Runnable
{
  public AVGameBusinessCtrl$4(ndt paramndt, Intent paramIntent, String paramString) {}
  ...
  public void run()
  {
    ...
    if ("android.bluetooth.headset.profile.action.AUDIO_STATE_CHANGED".equals(this.jdField_a_of_type_AndroidContentIntent.getAction()))
    {
      ...
      if (j == 12) {
        if (ndt.b(this.this$0))
        {
          ndt.c(this.this$0, false);
          ndt.a(this.this$0, 2, i);
        }
      }
    }
    label179:
