...
public class BroadcastCenter
{
  ...
  private void a(AccountReceiver.AccountListener paramAccountListener, String paramString)
  {
    ...
    while (i < j)
    {
      ...
      if (!TextUtils.isEmpty(str)) {
        paramAccountListener.addAction(str);
      }
      i += 1;
    }
    try
    {
      paramAccountListener = BaseApplicationImpl.getApplication().registerReceiver(this.jdField_a_of_type_ComTencentAvgameIpcAccountReceiver, paramAccountListener, "com.tencent.msg.permission.pushnotify", null);
      if (paramAccountListener == null) {
        this.jdField_a_of_type_ComTencentAvgameIpcAccountReceiver = null;
      }
      if (QLog.isColorLevel()) {
        QLog.i("BroadcastCenter", 2, "registerAccountReceiver, packageName[" + paramString + "], intent[" + paramAccountListener + "]");
      }
      return;
    }
  ...
  public void a()
  {
    ...
    if ((localAppRuntime instanceof AVGameAppInterface))
    {
      ...
      a((AccountReceiver.AccountListener)localObject2, ((AVGameAppInterface)localObject2).getApp().getPackageName());
    }
