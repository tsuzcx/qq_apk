      ...
      do
      {
        do
        {
          do
          {
            ...
            return;
            if ((paramObject != null) && ((paramObject instanceof Object[])) && (((Object[])paramObject).length == 8))
            {
              paramObject = (Object[])paramObject;
              a(paramBoolean, ((Long)paramObject[0]).longValue(), (List)paramObject[1], (AVGameRoomCenterFragment.RandomMatchInfo)paramObject[2], (List)paramObject[3], (List)paramObject[4], (List)paramObject[5], ((Integer)paramObject[6]).intValue(), (String)paramObject[7]);
              return;
            }
