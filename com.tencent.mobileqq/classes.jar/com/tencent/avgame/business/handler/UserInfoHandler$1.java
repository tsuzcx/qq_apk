...
public class UserInfoHandler$1
  implements Runnable
{
  public UserInfoHandler$1(ndl paramndl, HashMap paramHashMap, List paramList1, List paramList2) {}
  
  public void run()
  {
    ndl.a(this.this$0, this.jdField_a_of_type_JavaUtilHashMap, this.jdField_a_of_type_JavaUtilList, this.b);
    this.this$0.notifyUI(2, true, new Object[] { Integer.valueOf(0), this.jdField_a_of_type_JavaUtilHashMap });
    if (this.b.size() > 0) {
      ndl.a(this.this$0, 0, this.b);
    }
  }
}
