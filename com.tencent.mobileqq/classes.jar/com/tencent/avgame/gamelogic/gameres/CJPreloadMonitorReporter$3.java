  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    do
    {
      ...
      {
        localObject1 = ((IPreloadService)localObject1).getModuleByName("2021_cjavgame");
        if (localObject1 != null)
        {
          ...
          if (((List)localObject2).size() > 0)
          {
            ...
            CJPreloadMonitorReporter.a(bool, i, localQQAppInterface, this.a);
          }
        }
      }
    } while (!QLog.isColorLevel());
    QLog.i("CJPreloadMonitorReporter", 2, "[checkResCover] finished cost:" + (System.currentTimeMillis() - l));
  }
}
