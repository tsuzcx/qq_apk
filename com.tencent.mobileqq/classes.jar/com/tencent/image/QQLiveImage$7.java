  ...
  implements Runnable
{
  ...
  public void run()
  {
    if (!QQLiveImage.access$200())
    {
      ...
      QQLiveImage.access$202(true);
    }
    if (!TVK_SDKMgr.isInstalled(this.val$context))
    {
      if (URLDrawable.depImp.mLog.isColorLevel()) {
        URLDrawable.depImp.mLog.e(QQLiveImage.TAG + this.this$0.ID, 2, "initAndStartPlayer(): TVK_SDKMgr not install, mInstallProgress = " + QQLiveImage.access$400());
      }
      if (QQLiveImage.access$400().get()) {}
    }
    ...
    do
    {
      ...
      catch (Exception localException1)
      {
        ...
        URLDrawable.depImp.mLog.e(QQLiveImage.TAG + this.this$0.ID, 2, "initAndStartPlayer(): Exception happens in TVK_SDKMgr.installPlugin", localException1);
        return;
      }
    ...
    if (localQQLiveDrawableParams.mDataSourceType == 2)
    {
      ...
      synchronized (this.this$0)
      {
        ...
        if (URLDrawable.depImp.mLog.isColorLevel()) {
          URLDrawable.depImp.mLog.d(QQLiveImage.TAG + this.this$0.ID, 2, "initAndStartPlayer(): DATA_SOURCE_TYPE_THIRD，status = " + i);
        }
        if (i == 0)
        {
          localQQLiveDrawableParams.mDataSourceAdapter.requestPrepare(localQQLiveDrawableParams.mDataSource, new QQLiveImage.7.1(this, localQQLiveDrawableParams));
          return;
        }
      }
      if (i == 1)
      {
        ...
        label388:
        if (URLDrawable.depImp.mLog.isColorLevel()) {
          URLDrawable.depImp.mLog.e(QQLiveImage.TAG + this.this$0.ID, 2, "initAndStartPlayer(): DATA_SOURCE_TYPE_THIRD，mParams.mDataSourceAdapter == null 1 ");
        }
        return;
      }
    }
    ...
    if (QQLiveImage.access$700(this.this$0) == null) {
      synchronized (this.this$0)
      {
        if (QQLiveImage.access$700(this.this$0) == null)
        {
          ...
          if (URLDrawable.depImp.mLog.isColorLevel()) {
            URLDrawable.depImp.mLog.d(QQLiveImage.TAG + this.this$0.ID, 2, "initAndStartPlayer(): Runnable start ====> startPosi = " + this.val$startPosi);
          }
          ...
          label769:
          if (URLDrawable.depImp.mLog.isColorLevel()) {
            URLDrawable.depImp.mLog.d(QQLiveImage.TAG, 2, "initAndStartPlayer(): report tag=" + localObject1.mReportTag);
          }
    ...
    for (;;)
    {
      try
      {
        ...
        else
        {
          ...
          URLDrawable.depImp.mLog.e(QQLiveImage.TAG + this.this$0.ID, 2, "initAndStartPlayer(): DATA_SOURCE_TYPE_THIRD，mParams.mDataSourceAdapter == null 2");
          return;
          if (URLDrawable.depImp.mLog.isColorLevel()) {
            URLDrawable.depImp.mLog.w(QQLiveImage.TAG + this.this$0.ID, 2, "initAndStartPlayer(): mVideoPlayer has been initialed, 1 just return");
          }
          return;
          ...
          URLDrawable.depImp.mLog.w(QQLiveImage.TAG + this.this$0.ID, 2, "initAndStartPlayer(): mVideoPlayer has been initialed, 2 just return");
          return;
          label1220:
          l = -1L;
          break label636;
      ...
      catch (Exception localException2)
      {
        ...
        URLDrawable.depImp.mLog.e(QQLiveImage.TAG + this.this$0.ID, 2, "initAndStartPlayer(): error happens in openMediaPlayer ", localException2);
        this.this$0.onError(QQLiveImage.access$700(this.this$0), 0, 0, 0, "inner error when openMediaPlayer", null);
        URLDrawable.depImp.mLog.d(QQLiveImage.TAG + this.this$0.ID, 1, "initAndStartPlayer(): <==== runnable end ");
        continue;
