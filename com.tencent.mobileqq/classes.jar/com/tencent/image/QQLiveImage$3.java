  ...
  public void run()
  {
      ...
      if (QQLiveImage.access$000() != null)
      {
        ...
        while (i < QQLiveImage.access$000().size())
        {
          ...
          if (localQQLiveImage != null)
          {
            ...
            URLDrawable.depImp.mLog.i(QQLiveImage.TAG, 1, "pauseAll().... i " + i + ", ID: " + localQQLiveImage.ID);
          }
          i += 1;
        }
      }
    ...
    catch (Exception localException)
    {
      if (URLDrawable.depImp.mLog.isColorLevel()) {
        URLDrawable.depImp.mLog.e(QQLiveImage.TAG, 2, "pauseAll()", localException);
      }
      return;
    }
    finally
