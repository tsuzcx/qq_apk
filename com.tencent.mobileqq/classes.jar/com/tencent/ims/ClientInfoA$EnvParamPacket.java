  ...
  extends MessageMicro<EnvParamPacket>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 32, 42, 50 }, new String[] { "u32_platform", "str_sysversion", "str_qqversion", "u32_appid", "bytes_guid", "str_uin" }, new Object[] { localInteger, "", "", localInteger, localByteStringMicro, "" }, EnvParamPacket.class);
  }
}
