  ...
  extends MessageMicro<ButtonAction>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32 }, new String[] { "uint32_cmd", "uint32_button_id", "str_package_name", "uint32_app_id" }, new Object[] { localInteger, localInteger, "", localInteger }, ButtonAction.class);
  }
}
