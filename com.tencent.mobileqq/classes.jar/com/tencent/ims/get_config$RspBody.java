  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 40, 48, 58, 66 }, new String[] { "u64_uin", "u32_seq", "u32_proto_version", "str_config_name", "u32_config_version", "u32_effect_time", "str_md5", "str_download_link" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, "", localInteger, localInteger, "", "" }, RspBody.class);
  }
}
