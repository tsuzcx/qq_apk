  ...
  extends MessageMicro<DetectProjectResultPacket>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 32, 42, 50, 58 }, new String[] { "envParam", "u32_version", "u32_id", "u32_business", "result", "str_trunk", "str_extra" }, new Object[] { null, localInteger, localInteger, localInteger, null, "", "" }, DetectProjectResultPacket.class);
  }
}
