  ...
  extends MessageMicro<ReqMQScanRequest>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34, 40 }, new String[] { "uint32_check_uid", "uint32_check_type", "string_check_target", "string_check_parameters", "uint32_check_condition" }, new Object[] { localInteger, localInteger, "", "", localInteger }, ReqMQScanRequest.class);
  }
}
