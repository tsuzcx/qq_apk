  ...
  extends MessageMicro<RspMQScanReport>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26 }, new String[] { "uint32_check_uid", "uint32_check_count", "rpt_check_item" }, new Object[] { localInteger, localInteger, null }, RspMQScanReport.class);
  }
}
