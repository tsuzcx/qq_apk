  ...
  extends MessageMicro<EnvParamPacket>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 34, 42, 50, 56, 64, 74, 82, 90, 98 }, new String[] { "u32_platform", "str_sysversion", "u32_appid", "bytes_guid", "bytes_imei", "bytes_androidid", "u32_network", "u32_root", "bytes_imsi", "str_wifimac", "str_cpuarch", "str_rominfo" }, new Object[] { localInteger, "", localInteger, localByteStringMicro1, localByteStringMicro2, localByteStringMicro3, localInteger, localInteger, localByteStringMicro4, "", "", "" }, EnvParamPacket.class);
  }
}
