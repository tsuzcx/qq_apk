  ...
  extends MessageMicro<QQProtectRisksRequest>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24 }, new String[] { "uint32_sec_cmd", "str_package_name", "uint32_app_id" }, new Object[] { localInteger, "", localInteger }, QQProtectRisksRequest.class);
  }
}
