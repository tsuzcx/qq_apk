  ...
  extends MessageMicro<RequestPack>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 40, 48, 56, 64, 72, 80, 88 }, new String[] { "u32_app_type", "str_url", "i32_xoffset", "i32_yoffset", "u32_ctrl_width", "u32_ctrl_height", "u64_input_uin", "u32_account_type", "u32_cli_url_ver", "u32_seq", "u32_proto_ver" }, new Object[] { localInteger, "", localInteger, localInteger, localInteger, localInteger, Long.valueOf(0L), localInteger, localInteger, localInteger, localInteger }, RequestPack.class);
  }
}
