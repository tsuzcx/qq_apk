  ...
  extends MessageMicro<UpdateQueryResponse>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 42, 50, 56 }, new String[] { "uint32_sec_cmd", "int32_status", "uint32_file_id", "uint32_file_version", "string_file_hash", "string_file_url", "uint32_zip_flag" }, new Object[] { localInteger, localInteger, localInteger, localInteger, "", "", localInteger }, UpdateQueryResponse.class);
  }
}
