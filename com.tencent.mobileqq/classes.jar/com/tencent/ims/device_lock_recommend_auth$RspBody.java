  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34 }, new String[] { "uint64_uin", "uint32_seq", "uint32_ret", "rpt_msg_devicelist" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, null }, RspBody.class);
  }
}
