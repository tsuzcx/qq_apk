  ...
  extends MessageMicro<QSecCbResp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34 }, new String[] { "u32_status", "u32_time_interval", "str_cbstr", "str_extra" }, new Object[] { localInteger, localInteger, "", "" }, QSecCbResp.class);
  }
}
