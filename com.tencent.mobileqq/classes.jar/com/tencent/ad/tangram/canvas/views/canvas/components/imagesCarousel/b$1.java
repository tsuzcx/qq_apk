  ...
  implements ViewPager.OnPageChangeListener
{
  ...
  public void onPageScrollStateChanged(int paramInt)
  {
    ...
    if (paramInt == 0)
    {
      ...
      AdLog.i("AdCanvasImagesCarouselComponentView", "onPageScrollStateChanged: mCurrentPosition=" + b.access$100(this.this$0));
  ...
  public void onPageSelected(int paramInt)
  {
    ...
    if (paramInt < i) {
      b.access$102(this.this$0, b.access$000(this.this$0).imageList.size() + paramInt);
    }
    for (;;)
    {
      AdLog.i("AdCanvasImagesCarouselComponentView", "onPageSelected: mCurrentPosition=" + b.access$100(this.this$0) + " index=" + paramInt);
      return;
      if (paramInt >= j + k) {
        b.access$102(this.this$0, paramInt - b.access$000(this.this$0).imageList.size());
      }
    }
  }
}
