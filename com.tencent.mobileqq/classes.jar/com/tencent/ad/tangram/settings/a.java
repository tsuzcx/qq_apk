...
public enum a
{
  ...
  private static final String TAG = "AdAnalysisSettingsUtil";
  ...
  private static boolean isValid(gdt_settings.Settings paramSettings)
  {
    ...
    for (;;)
    {
      ...
      {
        AdLog.e("AdAnalysisSettingsUtil", "isValid", paramSettings);
      }
    }
    return false;
  }
  ...
  {
    AdLog.i("AdAnalysisSettingsUtil", String.format("load %s", new Object[] { paramString }));
    if (TextUtils.isEmpty(paramString)) {}
    for (;;)
    {
      AdLog.e("AdAnalysisSettingsUtil", String.format("load error %s", new Object[] { paramString }));
      return null;
      ...
      if (paramContext.canSend())
      {
        ...
        if ((paramContext.isSuccess()) && (paramContext.responseData != null)) {
          ...
          {
            AdLog.e("AdAnalysisSettingsUtil", "load", paramContext);
          }
        }
      }
    }
  ...
  private static gdt_settings.Settings toObject(String paramString)
  {
    ...
    {
      AdLog.e("AdAnalysisSettingsUtil", "toObject", paramString);
    }
    return null;
  }
  ...
  public void update(Context paramContext)
  {
    ...
    do
    {
      ...
      i = 1800000;
      break;
      str = "https://i.gtimg.cn/ams-web/public/tangram-report/settings-android-qq-8-2-0-hotfix.json";
      break label30;
      try
      {
        if ((this.loadSettingsTimeMillis != -2147483648L) && (System.currentTimeMillis() - this.loadSettingsTimeMillis < i)) {
