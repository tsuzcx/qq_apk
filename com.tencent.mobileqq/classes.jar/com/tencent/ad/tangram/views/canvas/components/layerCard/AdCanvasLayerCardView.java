  ...
  implements AdImageViewAdapter.Callback
{
  ...
  private com.tencent.ad.tangram.views.canvas.components.imagesCarousel.b adCanvasImagesCarouselComponentView;
  ...
  private void init(Context paramContext, a parama, Handler paramHandler)
  {
    if ((paramContext != null) && (parama != null))
    {
      ...
      this.adCanvasImagesCarouselComponentView = new com.tencent.ad.tangram.views.canvas.components.imagesCarousel.b(paramContext, this.canvasViewListener, this.value.adCanvasImagesCarouselComponentData, paramHandler);
      ...
      if (this.value.downloadCount != 0L)
      {
        ...
        parama.append("(");
        parama.append(AdUIUtils.formatNumberToChineseUnit(this.value.downloadCount));
        parama.append(")");
  ...
  public com.tencent.ad.tangram.views.canvas.components.imagesCarousel.b getAdCanvasImagesCarouselComponentView()
  {
  ...
  public void onLocationChanged()
  {
    ...
    Object localObject = this.adCanvasImagesCarouselComponentView;
    if ((localObject != null) && (((com.tencent.ad.tangram.views.canvas.components.imagesCarousel.b)localObject).getAdCanvasPictureComponentViews() != null))
    {
      localObject = this.adCanvasImagesCarouselComponentView.getAdCanvasPictureComponentViews().iterator();
 ...
 * Qualified Name:     com.tencent.ad.tangram.views.canvas.components.layerCard.AdCanvasLayerCardView
