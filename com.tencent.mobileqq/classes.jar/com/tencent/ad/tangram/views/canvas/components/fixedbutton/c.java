  ...
  implements AdImageViewAdapter.Callback
{
  ...
  private void notifyLoaded(boolean paramBoolean)
  {
    ...
    {
      long l = this.loadTimeStatistics.getTime();
      if (l < 0L) {
        return;
      }
  ...
  public void doClick()
  {
    d locald = this.gdtCanvasAppBtnComponentView;
    if (locald != null) {
      locald.doClick();
    }
  }
 ...
 * Qualified Name:     com.tencent.ad.tangram.views.canvas.components.fixedbutton.c
