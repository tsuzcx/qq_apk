  ...
  extends AdCanvasComponentView
{
  ...
  private void init(Context paramContext, a parama, Handler paramHandler)
  {
    if (parama != null)
    {
      ...
      {
        Object localObject = (com.tencent.ad.tangram.views.canvas.components.picture.a)parama.next();
        if (localObject != null)
        {
          b.a locala = new b.a(this, (com.tencent.ad.tangram.views.canvas.components.picture.a)localObject);
          localObject = new com.tencent.ad.tangram.views.canvas.components.picture.b(getContext(), this.canvasViewListener, (com.tencent.ad.tangram.views.canvas.components.picture.a)com.tencent.ad.tangram.views.canvas.components.picture.a.class.cast(localObject), locala, paramHandler);
 ...
 * Qualified Name:     com.tencent.ad.tangram.views.canvas.components.pictures.b
