  ...
  extends MessageMicro<CrossBidProxyCopyFileToOtherBidMsgReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 160, 168, 176, 242, 250, 800, 810, 818, 826, 1600, 1608, 2402 }, new String[] { "user_type", "src_bid", "src_uin", "src_group", "src_pdir_key", "src_file_id", "file_size", "file_md5", "file_name", "file_sha", "dst_bid", "dst_uin", "extension_req" }, new Object[] { localInteger, localInteger, localLong, localLong, localByteStringMicro1, "", localLong, localByteStringMicro2, "", localByteStringMicro3, localInteger, localLong, null }, CrossBidProxyCopyFileToOtherBidMsgReq.class);
  }
}
