  ...
  extends MessageMicro<DiskPicBackupRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 32, 42, 48, 58, 64, 72, 82, 90, 98, 104, 114, 122, 138, 170, 178, 240, 248 }, new String[] { "file_id", "filename", "file_ctime", "pdir_mtime", "server_name", "server_port", "check_key", "file_exist", "file_version", "file_key", "pdir_key", "ppdir_key", "file_backup", "inside_upload_ip", "outside_upload_ip", "backup_path", "ext_info", "dup_item", "channel_count", "coupon_count" }, new Object[] { "", "", Long.valueOf(0L), Long.valueOf(0L), "", localInteger, localByteStringMicro1, localBoolean, localInteger, localByteStringMicro2, localByteStringMicro3, localByteStringMicro4, localBoolean, "10.130.69.41", "", "", null, null, localInteger, localInteger }, DiskPicBackupRsp.class);
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes9.jar
 * Qualified Name:     com.tencent.mobileqq.weiyun.pb.WeiyunPB.DiskPicBackupRsp
