  ...
  implements Serializable
{
  ...
  public static SoConfig readConfig()
  {
    ...
    //   26: monitorenter
    //   27: aload 4
    //   29: invokestatic 80	albw:a	(Ljava/lang/String;)Ljava/lang/Object;
  ...
  public void update(bdgp parambdgp)
  {
    HashMap localHashMap = new HashMap();
    if ((parambdgp != null) && (parambdgp.a != null))
    {
      try
      {
        localObject = new LinkedList(Arrays.asList(parambdgp.a));
        Collections.sort((List)localObject, new bdgk(this));
        parambdgp = (bdgp)localObject;
      }
      catch (Throwable localThrowable1)
      {
        for (;;)
        {
          ...
          {
            Object localObject;
            JSONArray localJSONArray = new JSONObject(((aqxa)localObject).jdField_a_of_type_JavaLangString).optJSONArray("so_info_list");
            ...
            else
            {
              ...
              parambdgp = new LinkedList(Arrays.asList(parambdgp.a));
              continue;
            }
      ...
      parambdgp = parambdgp.iterator();
      do
      {
        if (!parambdgp.hasNext()) {
          break;
        }
        localObject = (aqxa)parambdgp.next();
      } while (TextUtils.isEmpty(((aqxa)localObject).jdField_a_of_type_JavaLangString));
    }
    label295:
