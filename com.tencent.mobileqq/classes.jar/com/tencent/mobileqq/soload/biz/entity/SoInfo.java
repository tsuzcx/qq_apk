  ...
  implements Serializable
{
  ...
  public static SoInfo create(JSONObject paramJSONObject)
  {
    ...
    Object localObject = RelatedFileInfo.create(paramJSONObject.optJSONObject("relatedFile"));
    int i = paramJSONObject.optInt("testFlag");
    if (paramJSONObject.optInt("flowControl") == 1) {}
    SoDetailInfo localSoDetailInfo;
    for (;;)
    {
      localSoDetailInfo = SoDetailInfo.create(paramJSONObject.optJSONObject("arm32"), str2, (RelatedFileInfo)localObject, i, bool);
      paramJSONObject = SoDetailInfo.create(paramJSONObject.optJSONObject("arm64"), str2, (RelatedFileInfo)localObject, i, bool);
