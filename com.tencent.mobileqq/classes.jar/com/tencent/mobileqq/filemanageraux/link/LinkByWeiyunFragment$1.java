  ...
  implements Runnable
{
  ...
  public void run()
  {
    this.jdField_a_of_type_AndroidWidgetTextView.setText(aunj.a(this.jdField_a_of_type_JavaLangString, true, this.jdField_a_of_type_AndroidWidgetTextView.getMeasuredWidth(), this.jdField_a_of_type_AndroidWidgetTextView.getPaint(), 1));
  }
}
