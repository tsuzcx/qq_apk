  ...
  implements Handler.Callback
{
  ...
  WeiyunShareQrController(IShareRouter paramIShareRouter, ViewGroup paramViewGroup)
  {
    ...
    this.jdField_a_of_type_AndroidViewView = paramIShareRouter.a().getLayoutInflater().inflate(2131560941, paramViewGroup, false);
    int i = View.MeasureSpec.makeMeasureSpec(0, 0);
    this.jdField_a_of_type_AndroidViewView.measure(i, i);
    TextView localTextView1 = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131375147);
    TextView localTextView2 = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131375145);
    paramViewGroup = (AsyncImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131375146);
    ...
    for (;;)
    {
      ...
      ((AsyncImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131375126)).setSupportMaskView(false);
      this.jdField_a_of_type_AndroidViewView.measure(i, i);
  ...
  private Bitmap a(Bitmap paramBitmap, int paramInt, String paramString)
  {
    ...
    localAsyncImageView = (AsyncImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131375126);
    localAsyncImageView.setImageBitmap(paramBitmap);
    TextView localTextView = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131375149);
    BaseApplicationImpl localBaseApplicationImpl = BaseApplicationImpl.sApplication;
    if (TextUtils.isEmpty(paramString))
    {
      paramBitmap = new StringBuilder().append(BaseApplicationImpl.sApplication.getString(2131698202)).append(":");
      paramString = BaseApplicationImpl.sApplication;
      if (paramInt == 1) {
        paramInt = 2131698200;
      }
    }
    for (paramBitmap = paramString.getString(paramInt);; paramBitmap = BaseApplicationImpl.sApplication.getString(2131698203) + ":" + paramString)
    {
      localTextView.setText(localBaseApplicationImpl.getString(2131698193, new Object[] { paramBitmap }));
      try
      {
  ...
  private static String a(Bitmap paramBitmap)
  {
    ...
    try
    {
      paramBitmap = QRUtils.a(BaseApplicationImpl.sApplication, str, paramBitmap);
      return paramBitmap;
    }
  ...
  private void a(ShareActionSheetBuilder.ActionSheetItem paramActionSheetItem, Bitmap paramBitmap, String paramString)
  {
    ...
    do
    {
      ...
      localObject = this.jdField_a_of_type_ComTencentMobileqqFilemanagerauxLinkIShareRouter.a();
    ...
    {
      LinkUtils.a(1, 2131696461, true);
      return;
    }
    if (paramString == null)
    {
      if (i == 39) {}
      for (i = 2131717052;; i = 2131696460)
      {
    ...
    case 3: 
      ...
      for (paramActionSheetItem.nickname = ((VideoAppInterface)paramBitmap).a(0, paramBitmap.getCurrentAccountUin(), null);; paramActionSheetItem.nickname = null)
      {
        QZoneHelper.forwardToPublishMood((Activity)localObject, paramActionSheetItem, paramString, ((BaseActivity)localObject).getString(2131692179), ((BaseActivity)localObject).getString(2131698193, new Object[] { "" }), 2);
        return;
      }
    case 9: 
    case 10: 
    ...
    case 39: 
      ...
      LinkUtils.a(2, ((BaseActivity)localObject).getString(2131717054, new Object[] { paramString }), true);
      return;
    }
  ...
  private static String b(Bitmap paramBitmap)
  {
    ...
    //   9: ifnull +365 -> 374
    //   12: aload_0
    //   13: invokevirtual 460	android/graphics/Bitmap:isRecycled	()Z
    //   16: ifne +358 -> 374
    //   19: new 462	com/tencent/mm/vfs/VFSFile
    //   22: dup
    //   23: getstatic 467	com/tencent/mobileqq/app/AppConstants:SDCARD_IMG_SAVE	Ljava/lang/String;
    //   26: invokespecial 468	com/tencent/mm/vfs/VFSFile:<init>	(Ljava/lang/String;)V
    //   29: astore_3
    //   30: aload_3
    //   31: invokevirtual 471	com/tencent/mm/vfs/VFSFile:mkdirs	()Z
    //   34: pop
    //   35: aload_3
    //   36: invokevirtual 474	com/tencent/mm/vfs/VFSFile:canWrite	()Z
    //   39: ifeq +335 -> 374
    //   42: invokestatic 236	java/lang/System:currentTimeMillis	()J
    //   45: invokestatic 478	java/lang/Long:toString	(J)Ljava/lang/String;
    //   48: astore_3
    //   49: new 462	com/tencent/mm/vfs/VFSFile
    //   52: dup
    //   53: new 169	java/lang/StringBuilder
    //   56: dup
    //   57: invokespecial 170	java/lang/StringBuilder:<init>	()V
    //   60: getstatic 467	com/tencent/mobileqq/app/AppConstants:SDCARD_IMG_SAVE	Ljava/lang/String;
    ...
    //   87: invokespecial 468	com/tencent/mm/vfs/VFSFile:<init>	(Ljava/lang/String;)V
    //   90: astore 5
    //   92: aload 5
    //   94: invokevirtual 485	com/tencent/mm/vfs/VFSFile:exists	()Z
    //   97: ifeq +68 -> 165
    //   100: iload_1
    //   101: ldc_w 486
    //   104: if_icmpge +61 -> 165
    //   107: new 462	com/tencent/mm/vfs/VFSFile
    //   110: dup
    //   111: new 169	java/lang/StringBuilder
    //   114: dup
    //   115: invokespecial 170	java/lang/StringBuilder:<init>	()V
    //   118: getstatic 467	com/tencent/mobileqq/app/AppConstants:SDCARD_IMG_SAVE	Ljava/lang/String;
    ...
    //   140: iload_1
    //   141: invokevirtual 491	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   144: ldc_w 493
    ...
    //   153: invokespecial 468	com/tencent/mm/vfs/VFSFile:<init>	(Ljava/lang/String;)V
    //   156: astore 5
    //   158: iload_1
    //   159: iconst_1
    //   160: iadd
    //   161: istore_1
    //   162: goto -70 -> 92
    //   165: new 495	java/io/BufferedOutputStream
    //   168: dup
    //   169: new 497	com/tencent/mm/vfs/VFSFileOutputStream
    //   172: dup
    //   173: aload 5
    //   175: invokespecial 500	com/tencent/mm/vfs/VFSFileOutputStream:<init>	(Lcom/tencent/mm/vfs/VFSFile;)V
    //   178: invokespecial 503	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   181: astore_3
    //   182: aload_3
    //   183: astore 4
    //   185: aload_0
    //   186: getstatic 509	android/graphics/Bitmap$CompressFormat:PNG	Landroid/graphics/Bitmap$CompressFormat;
    //   189: bipush 100
    //   191: aload_3
    //   192: invokevirtual 513	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   195: istore_2
    //   196: aload_3
    //   197: ifnull +172 -> 369
    //   200: aload_3
    //   201: invokevirtual 516	java/io/BufferedOutputStream:close	()V
    //   204: aconst_null
    //   205: astore_0
    //   206: iload_2
    //   207: ifne +120 -> 327
    //   210: aload 5
    //   212: invokevirtual 485	com/tencent/mm/vfs/VFSFile:exists	()Z
    //   215: ifeq +112 -> 327
    //   218: aload 5
    //   220: invokevirtual 519	com/tencent/mm/vfs/VFSFile:delete	()Z
    //   223: pop
    //   224: aload_0
    //   225: areturn
    //   226: astore_0
    ...
    //   253: ifnull +109 -> 362
    //   256: aload_0
    //   257: invokevirtual 516	java/io/BufferedOutputStream:close	()V
    //   260: iconst_0
    //   261: istore_2
    //   262: aload_3
    //   263: astore_0
    ...
    //   292: ifnull +63 -> 355
    //   295: aload_3
    //   296: invokevirtual 516	java/io/BufferedOutputStream:close	()V
    //   299: aconst_null
    //   300: astore_0
    //   301: iconst_0
    //   302: istore_2
    ...
    //   317: ifnull +8 -> 325
    //   320: aload 4
    //   322: invokevirtual 516	java/io/BufferedOutputStream:close	()V
    //   325: aload_0
    //   326: athrow
    //   327: aload 5
    //   329: invokevirtual 524	com/tencent/mm/vfs/VFSFile:getAbsolutePath	()Ljava/lang/String;
    //   332: areturn
    //   333: astore_3
    //   334: goto -9 -> 325
    //   337: astore_0
  ...
  void a(ShareActionSheetBuilder.ActionSheetItem paramActionSheetItem)
  {
    ...
    do
    {
      do
      {
        return;
        i = paramActionSheetItem.action;
        if ((i == 39) || (NetworkUtil.d(this.jdField_a_of_type_ComTencentMobileqqFilemanagerauxLinkIShareRouter.a()))) {
          break;
        }
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog == null)
    {
      this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog = new QQProgressDialog(this.jdField_a_of_type_ComTencentMobileqqFilemanagerauxLinkIShareRouter.a());
  ...
  boolean a(Bitmap paramBitmap, int paramInt, String paramString)
  {
    ...
    if (paramBitmap == null)
    {
      LinkUtils.a(1, BaseApplicationImpl.sApplication.getResources().getString(2131698187, new Object[] { Integer.valueOf(-2) }), true);
      return false;
    }
