...
public final class LinkUtils
{
  ...
  public static Bitmap a(String paramString, int paramInt)
  {
    ...
    do
    {
      ...
      localBitmap = BitmapManager.a(BaseApplicationImpl.sApplication.getResources(), 2130844496);
  ...
  public static void a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    {
      QQToast.a(localBaseApplicationImpl, paramInt1, str, paramInt2).b(localBaseApplicationImpl.getResources().getDimensionPixelSize(2131299166));
      return;
    }
  }
  ...
  public static void a(int paramInt, String paramString, boolean paramBoolean)
  {
    ...
    for (int i = 1;; i = 0)
    {
      QQToast.a(localBaseApplicationImpl, paramInt, paramString, i).b(localBaseApplicationImpl.getResources().getDimensionPixelSize(2131299166));
      return;
    }
  }
