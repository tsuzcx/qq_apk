    ...
    for (int i = paramCrossBidProxyOfflineFileGetListMsgRsp.rpt_msg_recv_offline_file.size() + 0;; i = 0)
    {
      ...
      if ((this.jdField_a_of_type_Int == 0) || (this.jdField_a_of_type_Int == 2))
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          localOfflineFileInfo1.b = localOfflineFileInfo.uint64_file_size.get();
          localOfflineFileInfo1.jdField_c_of_type_Long = (MessageCache.a() * 1000L + localOfflineFileInfo.uint32_life_time.get() * 1000L);
          localOfflineFileInfo1.d = (localOfflineFileInfo.uint32_upload_time.get() * 1000L);
          localOfflineFileInfo1.jdField_c_of_type_JavaLangString = localOfflineFileInfo.str_file_name.get();
