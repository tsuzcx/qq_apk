  ...
  implements IWeiyunCallback<WeiyunPB.CrossBidProxyOfflineFileGetListMsgRsp>
{
  public void a(int paramInt, String paramString, WeiyunPB.CrossBidProxyOfflineFileGetListMsgRsp paramCrossBidProxyOfflineFileGetListMsgRsp)
  {
    ...
    WeiYunLogicCenter.a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerauxCoreWeiYunLogicCenter).getFileManagerNotifyCenter().a(false, 32, new Object[] { Integer.valueOf(paramInt), paramString });
  }
  ...
  public void a(WeiyunPB.CrossBidProxyOfflineFileGetListMsgRsp paramCrossBidProxyOfflineFileGetListMsgRsp)
  {
    ...
    if ((i == 0) || (i == 2))
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        localOfflineFileInfo.jdField_a_of_type_Int = ((WeiyunPB.OfflineFileInfo)localObject2).uint32_danger_evel.get();
        localOfflineFileInfo.b = ((WeiyunPB.OfflineFileInfo)localObject2).uint64_file_size.get();
        localOfflineFileInfo.jdField_c_of_type_Long = (MessageCache.a() * 1000L + ((WeiyunPB.OfflineFileInfo)localObject2).uint32_life_time.get() * 1000L);
        localOfflineFileInfo.d = (((WeiyunPB.OfflineFileInfo)localObject2).uint32_upload_time.get() * 1000L);
        localOfflineFileInfo.jdField_c_of_type_JavaLangString = ((WeiyunPB.OfflineFileInfo)localObject2).str_file_name.get();
        localOfflineFileInfo.jdField_a_of_type_JavaLangString = new String(((WeiyunPB.OfflineFileInfo)localObject2).bytes_uuid.get().toByteArray());
        localOfflineFileInfo.jdField_a_of_type_Long = ((WeiyunPB.OfflineFileInfo)localObject2).uint64_uin.get();
    ...
    label700:
    WeiYunLogicCenter.a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerauxCoreWeiYunLogicCenter).getFileManagerNotifyCenter().a(true, 32, new Object[] { Boolean.valueOf(bool), localArrayList });
  }
}
