...
class WeiyunDownloadService$WeiyunDownloadServiceQIPCModule
  extends QIPCModule
{
  public WeiyunDownloadService$WeiyunDownloadServiceQIPCModule(WeiyunDownloadService paramWeiyunDownloadService, String paramString)
  {
    super(paramString);
  }
  ...
  {
    LogUtility.c("WeiyunDownloadServiceIPC", "onCall action|" + paramString + " params|" + paramBundle + " callbackId|" + paramInt);
    Object localObject;
    ...
    if (paramBundle == null)
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject)) {
        WeiyunDownloadService.a = (String)localObject;
      }
      if (!TextUtils.isEmpty(paramString))
      {
        localQQAppInterface = WeiyunDownloadService.a(this.a);
    ...
    do
    {
      ...
      localObject = FileManagerUtil.a(paramBundle);
      localQQAppInterface.getFileManagerEngine().c((FileManagerEntity)localObject);
      ...
      WeiyunDownloadService.a(this.a).put(paramString, Long.valueOf(((FileManagerEntity)localObject).nSessionId));
      if (FileManagerUtil.b(((FileManagerEntity)localObject).getFilePath()))
      {
        ...
        QIPCServerHelper.getInstance().callClient(WeiyunDownloadService.a, "Module_WeiyunDownloadClient", "WeiyunDownloadClientIPC_Action__Suc", paramString, null);
        paramString = new Bundle();
        paramString.putString("taskId", ((FileManagerEntity)localObject).miniAppDownloadId);
        paramString.putInt("retCode", 1);
        paramString.putString("retMsg", "");
        QIPCServerHelper.getInstance().callClient(WeiyunDownloadService.a, "Module_WeiyunDownloadClient", "WeiyunDownloadClientIPC_Action__Complete", paramString, null);
        return null;
      }
    ...
    localQQAppInterface.getFileManagerEngine().a(((Long)WeiyunDownloadService.a(this.a).get(paramString)).longValue());
    return null;
  }
}
 ...
 * Qualified Name:     com.tencent.mobileqq.filemanageraux.core.WeiyunDownloadService.WeiyunDownloadServiceQIPCModule
