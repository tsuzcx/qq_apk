  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    Object localObject1 = ReceiptMessageReadMemberListContainerFragment.a(this.this$0).getApp();
    Object localObject2 = new StringBuilder();
    ((StringBuilder)localObject2).append("last_update_time");
    ((StringBuilder)localObject2).append(ReceiptMessageReadMemberListContainerFragment.a(this.this$0).getCurrentAccountUin());
    ...
    ((StringBuilder)localObject2).append(ReceiptMessageReadMemberListContainerFragment.a(this.this$0));
    if (((SharedPreferences)localObject1).getLong(((StringBuilder)localObject2).toString(), 0L) - ReceiptMessageReadMemberListContainerFragment.b(this.this$0) * 1000L > 60000L)
    {
      ReceiptMessageReadMemberListContainerFragment.a(this.this$0).sendEmptyMessage(4);
      return;
    }
    localObject1 = (ITroopMemberListHandler)ReceiptMessageReadMemberListContainerFragment.a(this.this$0).getBusinessHandler(BusinessHandlerFactory.TROOP_MEMBER_LIST_HANDLER);
    localObject2 = ((TroopManager)ReceiptMessageReadMemberListContainerFragment.a(this.this$0).getManager(QQManagerFactory.TROOP_MANAGER)).b(Long.toString(ReceiptMessageReadMemberListContainerFragment.a(this.this$0)));
