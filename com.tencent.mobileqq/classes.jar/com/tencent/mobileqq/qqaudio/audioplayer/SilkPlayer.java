  ...
  implements Handler.Callback, IAudioFilePlayer
{
  ...
  public void a(int paramInt1, int paramInt2, String paramString)
  {
    ...
    paramString.put("errCode", paramInt1 + "");
    paramString.put("param_version", Build.VERSION.SDK_INT + "");
    paramString.put("param_deviceName", Build.MANUFACTURER + "_" + Build.MODEL);
  ...
  public boolean a()
  {
    return (this.jdField_a_of_type_ComTencentMobileqqQqaudioAudioplayerSilkPlayer$SilkPlayerThread != null) && (SilkPlayer.SilkPlayerThread.a(this.jdField_a_of_type_ComTencentMobileqqQqaudioAudioplayerSilkPlayer$SilkPlayerThread));
  }
  ...
  public void c()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqQqaudioAudioplayerSilkPlayer$SilkPlayerThread != null) && (this.jdField_a_of_type_ComTencentMobileqqQqaudioAudioplayerSilkPlayer$SilkPlayerThread.isAlive()))
    {
  ...
  public void c(int paramInt)
  {
    ...
    Message localMessage = this.jdField_a_of_type_ComTencentUtilWeakReferenceHandler.obtainMessage(3, Integer.valueOf(paramInt));
    this.jdField_a_of_type_ComTencentUtilWeakReferenceHandler.sendMessage(localMessage);
    this.jdField_a_of_type_Long = System.currentTimeMillis();
  }
  ...
  public void g()
  {
    ...
    //   49: astore_1
    //   50: aload_0
    //   51: getfield 31	com/tencent/mobileqq/qqaudio/audioplayer/SilkPlayer:b	I
    //   54: iconst_m1
    //   55: if_icmpne +17 -> 72
    //   58: aload_2
    //   59: astore_1
    //   60: aload_0
    //   61: aload_0
    //   62: getfield 39	com/tencent/mobileqq/qqaudio/audioplayer/SilkPlayer:jdField_a_of_type_Byte	B
    //   65: aload_2
    //   66: invokestatic 315	com/tencent/mobileqq/qqaudio/QQAudioUtils:a	(BLjava/io/InputStream;)I
    //   69: putfield 31	com/tencent/mobileqq/qqaudio/audioplayer/SilkPlayer:b	I
    //   72: aload_2
    //   73: ifnull +7 -> 80
    //   76: aload_2
    //   77: invokevirtual 318	java/io/FileInputStream:close	()V
    //   80: return
    //   81: aload_2
    //   82: astore_1
    //   83: aload_2
    //   84: ldc2_w 319
    //   87: invokevirtual 324	java/io/FileInputStream:skip	(J)J
    //   90: pop2
    //   91: goto -43 -> 48
    //   94: astore_3
    //   95: aload_2
    ...
    //   135: ifnull -55 -> 80
    //   138: aload_2
    //   139: invokevirtual 318	java/io/FileInputStream:close	()V
    //   142: return
    //   143: astore_1
    //   144: return
    //   145: astore_2
    ...
    //   149: ifnull +7 -> 156
    //   152: aload_1
    //   153: invokevirtual 318	java/io/FileInputStream:close	()V
    //   156: aload_2
    //   157: athrow
    //   158: astore_1
    //   159: return
  ...
  public boolean handleMessage(Message paramMessage)
  {
    if (paramMessage.what == 1) {
      if (this.jdField_a_of_type_ComTencentMobileqqQqaudioAudioplayerIAudioFilePlayerListener != null) {
        this.jdField_a_of_type_ComTencentMobileqqQqaudioAudioplayerIAudioFilePlayerListener.a(this, paramMessage.arg1, 0, (String)paramMessage.obj);
      }
    }
    do
    {
      ...
      return true;
    } while ((paramMessage.what != 3) || (this.jdField_a_of_type_ComTencentMobileqqQqaudioAudioplayerIAudioFilePlayerListener == null));
    this.jdField_a_of_type_ComTencentMobileqqQqaudioAudioplayerIAudioFilePlayerListener.c(((Integer)paramMessage.obj).intValue());
    return true;
  }
}
