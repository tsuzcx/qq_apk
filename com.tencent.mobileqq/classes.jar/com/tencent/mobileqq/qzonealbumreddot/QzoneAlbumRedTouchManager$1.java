...
public class QzoneAlbumRedTouchManager$1
  implements Runnable
{
  public QzoneAlbumRedTouchManager$1(azkd paramazkd) {}
  ...
  public void run()
  {
    ...
    BusinessInfoCheckUpdate.AppInfo localAppInfo = ((azvi)localObject).a(str);
    if ((localAppInfo != null) && (localAppInfo.iNewFlag.get() == 1))
    {
      ((azvi)localObject).c(str);
    ...
    localObject = new NewIntent(this.this$0.a.getApplication(), azkf.class);
