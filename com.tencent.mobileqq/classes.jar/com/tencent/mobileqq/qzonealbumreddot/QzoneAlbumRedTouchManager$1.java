...
public class QzoneAlbumRedTouchManager$1
  implements Runnable
{
  public QzoneAlbumRedTouchManager$1(azxi paramazxi) {}
  ...
  public void run()
  {
    ...
    Object localObject = (baif)this.this$0.a.getManager(36);
    String str = String.valueOf(100180);
    BusinessInfoCheckUpdate.AppInfo localAppInfo = ((baif)localObject).a(str);
    if ((localAppInfo != null) && (localAppInfo.iNewFlag.get() == 1))
    {
      ((baif)localObject).c(str);
    ...
    localObject = new NewIntent(this.this$0.a.getApplication(), azxk.class);
