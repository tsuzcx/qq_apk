  ...
  extends MessageMicro<BNRConfigMsg>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 82, 90 }, new String[] { "uin", "cmd", "seq", "ext_info", "msg_req_body", "msg_rsp_body" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, null, null, null }, BNRConfigMsg.class);
  }
}
