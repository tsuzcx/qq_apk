  ...
  implements IWXAPIEventHandler
{
  ...
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new bjie(this);
  ...
  private ArrayList<bjig> jdField_a_of_type_JavaUtilArrayList = new ArrayList(1);
  private BroadcastReceiver jdField_b_of_type_AndroidContentBroadcastReceiver = new bjif(this);
  private IWXAPI jdField_b_of_type_ComTencentMmOpensdkOpenapiIWXAPI;
  private IWXAPI c;
  
  static
  {
    jdField_a_of_type_JavaLangString = bigv.a(antf.ba + "photo/");
  }
  ...
  private WXShareHelper()
  {
    ...
    a();
    this.jdField_b_of_type_ComTencentMmOpensdkOpenapiIWXAPI = WXAPIFactory.createWXAPI(BaseApplicationImpl.getApplication(), "wxcb89b8fc34e4e304", true);
    ...
    this.jdField_b_of_type_ComTencentMmOpensdkOpenapiIWXAPI.registerApp("wxcb89b8fc34e4e304");
    this.c = WXAPIFactory.createWXAPI(BaseApplicationImpl.getApplication(), "wx1d0f5457c7556472", true);
    BaseApplication.getContext().registerReceiver(this.jdField_b_of_type_AndroidContentBroadcastReceiver, new IntentFilter("com.tencent.mobileqq.action.ACTION_WECHAT_RESPONSE"), "com.tencent.msg.permission.pushnotify", null);
  ...
  private static void a(File paramFile1, File paramFile2)
  {
    ...
    //   5: dup
    //   6: aload_0
    //   7: invokespecial 222	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   10: invokevirtual 226	java/io/FileInputStream:getChannel	()Ljava/nio/channels/FileChannel;
    //   13: astore_2
    //   14: new 228	java/io/FileOutputStream
    //   17: dup
    //   18: aload_1
    //   19: invokespecial 229	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   22: invokevirtual 230	java/io/FileOutputStream:getChannel	()Ljava/nio/channels/FileChannel;
    //   25: astore_1
    //   26: aload_1
    //   27: aload_2
    //   28: lconst_0
    //   29: aload_2
    //   30: invokevirtual 235	java/nio/channels/FileChannel:size	()J
    //   33: invokevirtual 239	java/nio/channels/FileChannel:transferFrom	(Ljava/nio/channels/ReadableByteChannel;JJ)J
    //   36: pop2
    //   37: aload_2
    //   38: invokevirtual 242	java/nio/channels/FileChannel:close	()V
    //   41: aload_1
    //   42: invokevirtual 242	java/nio/channels/FileChannel:close	()V
    //   45: return
    //   46: astore_0
    //   47: aconst_null
    //   48: astore_1
    ...
    //   50: astore_2
    //   51: aload_2
    //   52: invokevirtual 242	java/nio/channels/FileChannel:close	()V
    //   55: aload_1
    //   56: invokevirtual 242	java/nio/channels/FileChannel:close	()V
    //   59: aload_0
    //   60: athrow
    //   61: astore_0
    //   62: aconst_null
  ...
  public void a(bjig parambjig)
  {
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      if (!this.jdField_a_of_type_JavaUtilArrayList.contains(parambjig)) {
        this.jdField_a_of_type_JavaUtilArrayList.add(parambjig);
      }
      return;
    }
  }
  ...
  public void a(String paramString, Bitmap paramBitmap)
  {
    ...
    for (localObject = paramString;; localObject = ((Uri)localObject).toString())
    {
      ...
      paramBitmap.title = aunj.a(paramString);
  ...
  public void a(String paramString, byte[] paramArrayOfByte, int paramInt)
  {
    ...
    if (!paramString.contains(antf.ba + "photo/")) {
  ...
  public void b(bjig parambjig)
  {
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      if (this.jdField_a_of_type_JavaUtilArrayList.contains(parambjig)) {
        this.jdField_a_of_type_JavaUtilArrayList.remove(parambjig);
      }
      return;
    }
  }
  ...
  public void onReq(BaseReq paramBaseReq)
  {
    ...
    try
    {
      paramBaseReq = bcup.b(((ShowMessageFromWX.Req)paramBaseReq).message.messageExt);
  ...
  public void onResp(BaseResp paramBaseResp)
  {
    ...
    try
    {
      synchronized (this.jdField_a_of_type_JavaUtilArrayList)
      {
        ...
        while (i >= 0)
        {
          ((bjig)this.jdField_a_of_type_JavaUtilArrayList.get(i)).onWXShareResp(paramBaseResp);
          i -= 1;
        }
        return;
      }
