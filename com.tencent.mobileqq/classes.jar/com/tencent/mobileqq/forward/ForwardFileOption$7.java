  ...
  implements View.OnTouchListener
{
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    {
      paramMotionEvent = paramView.findViewById(2131367404);
      ...
      do
      {
        do
        {
          do
          {
            ...
            paramView = (ImageView)paramView.findViewById(2131367410);
          } while (paramView == null);
          paramView.setImageResource(2130840277);
          return false;
    ...
    paramView.setImageResource(2130840276);
    return false;
  }
}
