  ...
  implements Runnable
{
  public void run()
  {
    ...
    aqeq.a(this.this$0, "KEY_STAGE_1_CHANGE_IMG_URL");
    Object localObject1 = bdhy.a(this.a, this.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
    ...
    for (;;)
    {
      aqgh.a("KEY_STAGE_1_CHANGE_IMG_URL", (String)localObject2, (HashMap)localObject1, bool1);
      ...
      if (bool2)
      {
        ...
        bded.a().a((Bundle)localObject2, "" + this.this$0.jdField_a_of_type_Long, this.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), false);
        if ((i != 0) || (TextUtils.isEmpty(str))) {}
      }
      try
      {
        this.this$0.jdField_a_of_type_AndroidOsBundle.putByte("struct_share_key_image_url_status", (byte)3);
        bdhy.a(false, this.a, this.a, str);
        ...
        if (this.this$0.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg != null)
        {
          ...
          aqeq.a(this.this$0).sendEmptyMessage(2);
        }
        return;
        bool1 = false;
        continue;
