  ...
  public void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    ...
    do
    {
      do
      {
        ...
        if ((!"com.tencent.qqavchat".equalsIgnoreCase(this.a.jdField_a_of_type_AndroidOsBundle.getString("forward_ark_app_name"))) || (this.a.j()) || (!ShareChat.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_AndroidOsBundle.getString("forward_ark_app_meta"), str, k))) {
          break;
        }
      ...
      while (ForwardBaseOption.a(this.a, paramDialogInterface)) {
        for (;;)
        {
