  ...
  implements Handler.Callback
{
  ...
  private String a(String paramString, long paramLong)
  {
    ...
    for (;;)
    {
      return this.jdField_a_of_type_AndroidContentContext.getString(2131435643) + paramString + "\n" + this.jdField_a_of_type_AndroidContentContext.getString(2131435644) + (String)localObject;
  ...
  {
    this.g = true;
    ThreadManager.post(new adsw(this, paramString, paramInputStream, paramLong, paramUri), 5, null, true);
    if (this.b == null)
    {
      this.b = DialogUtil.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidContentContext.getString(2131436315), "取消", new adsx(this));
      this.b.setOnDismissListener(new adsy(this));
    }
    this.b.show();
  }
  ...
  private String c(Uri paramUri)
  {
    ...
    //   433: aload_0
    //   434: aload 8
    //   436: invokespecial 337	adsz:<init>	(Lcom/tencent/mobileqq/forward/ForwardFileBaseOption;Ljava/io/InputStream;)V
    ...
    //   463: aload 8
    //   465: lload 4
    //   467: invokespecial 346	adta:<init>	(Lcom/tencent/mobileqq/forward/ForwardFileBaseOption;Landroid/net/Uri;Ljava/lang/String;Ljava/io/InputStream;J)V
  ...
  private void d(String paramString)
  {
    ...
    localQQCustomDialog.setTitle(this.jdField_a_of_type_AndroidContentContext.getString(2131434797));
    localQQCustomDialog.setMessage(paramString);
    localQQCustomDialog.setCanceledOnTouchOutside(false);
    localQQCustomDialog.setCancelable(false);
    localQQCustomDialog.setNegativeButton(this.jdField_a_of_type_AndroidContentContext.getString(2131433712), new adsu(this));
  ...
  protected String a(Uri paramUri)
  {
    ...
    if ((VersionUtils.j()) && ("com.android.fileexplorer.fileprovider".equalsIgnoreCase(paramUri.getAuthority())))
    {
      ...
      {
        paramUri = paramUri.getPath().replaceFirst("\\/external_files", AppConstants.aJ);
        if (QLog.isColorLevel()) {
  ...
  protected boolean a(Uri paramUri)
  {
    ...
    if ((!this.g) && (!this.h) && (l == 0L))
    {
      ...
      {
        d(this.jdField_a_of_type_AndroidContentContext.getString(2131436308));
        return false;
      }
      d(this.jdField_a_of_type_AndroidContentContext.getString(2131436307));
      return false;
    }
    if ((true == this.jdField_a_of_type_AndroidOsBundle.getBoolean("forward_from_jump")) && (true == this.jdField_a_of_type_AndroidOsBundle.getBoolean("isFromShare")) && (b(str)))
    {
      ...
      paramUri.setContentView(2130968855);
      paramUri.setTitle(this.jdField_a_of_type_AndroidContentContext.getString(2131434797));
      paramUri.setMessage(this.jdField_a_of_type_AndroidContentContext.getString(2131436309));
      paramUri.setCanceledOnTouchOutside(false);
      paramUri.setCancelable(false);
      paramUri.setNegativeButton(this.jdField_a_of_type_AndroidContentContext.getString(2131433712), new adsv(this));
      paramUri.show();
      return false;
    }
