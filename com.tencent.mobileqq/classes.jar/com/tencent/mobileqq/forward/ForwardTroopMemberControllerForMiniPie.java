...
public class ForwardTroopMemberControllerForMiniPie
{
  ...
  private void d()
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetTextView == null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setText(HardCodeUtil.a(2131704876));
      int j = (int)(16.0D / this.jdField_a_of_type_Float);
      this.jdField_a_of_type_AndroidWidgetTextView.setTextSize(2, j);
      this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131167129));
    }
    if (this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView == null)
    {
      ...
      i = AIOUtils.a(i, this.jdField_a_of_type_AndroidContentContext.getResources());
