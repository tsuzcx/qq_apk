  ...
  implements DialogInterface.OnDismissListener, ForwardAbility, ForwardAbility.ForwardAbilityType, ForwardConstants, ForwardDialogBuilder
{
  ...
  DiscussionObserver jdField_a_of_type_ComTencentMobileqqAppDiscussionObserver = new adsr(this);
  ...
  protected final DialogInterface.OnClickListener a()
  {
    if (this.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener == null) {
      this.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener = new adsg(this);
    }
  ...
  {
    this.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new adsm(this, paramDrawable, paramBoolean1, paramInt, paramBoolean2));
  }
  ...
  protected boolean a(Intent paramIntent)
  {
    ...
    if (!bool2)
    {
      ...
      {
        bool1 = bool2;
        if (str.equals(this.jdField_a_of_type_AndroidAppActivity.getString(2131431628))) {
          bool1 = true;
        }
      }
    }
  ...
  protected final DialogInterface.OnClickListener b()
  {
    if (this.jdField_b_of_type_AndroidContentDialogInterface$OnClickListener == null) {
      this.jdField_b_of_type_AndroidContentDialogInterface$OnClickListener = new adsi(this);
    }
  ...
  public void b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      for (paramInt = localDataLineHandler.a().a(str, localBundle, localadso);; paramInt = localDataLineHandler.a().b(str, localBundle, localadso))
      {
        if ((localadso.jdField_a_of_type_Boolean) && (paramInt != 0)) {
          break label340;
        }
        DirectForwarder.b(this.jdField_a_of_type_AndroidAppActivity, paramInt);
        if (localadso.jdField_a_of_type_Boolean) {
          break;
        }
  ...
  protected final void b(String paramString, QQCustomDialog paramQQCustomDialog)
  {
    ...
    ThreadManager.post(new adsn(this, paramString, paramQQCustomDialog), 8, null, false);
    if (QLog.isColorLevel()) {
  ...
  protected final DialogInterface.OnClickListener c()
  {
    if (this.jdField_c_of_type_AndroidContentDialogInterface$OnClickListener == null) {
      this.jdField_c_of_type_AndroidContentDialogInterface$OnClickListener = new adsj(this);
    }
  ...
  public String c()
  {
    ...
    {
      String str = this.jdField_a_of_type_AndroidAppActivity.getString(2131432329);
  ...
  protected void d(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_ComTencentBizWidgetsShareResultDialog.a((String)localObject, localadsq);
      ...
      if (paramInt == 0)
      {
        ...
        this.jdField_a_of_type_ComTencentBizWidgetsShareResultDialog.a(2131431613);
        this.jdField_a_of_type_ComTencentBizWidgetsShareResultDialog.b(0);
        this.jdField_a_of_type_ComTencentBizWidgetsShareResultDialog.c(2131431612);
        this.jdField_a_of_type_ComTencentBizWidgetsShareResultDialog.b(this.jdField_a_of_type_AndroidAppActivity.getString(2131431616), localadsq);
      }
      try
      {
  ...
  public final void j()
  {
    ...
    if (i == 0) {
      if (this.jdField_a_of_type_AndroidOsBundle.getBoolean("is_ark_display_share", false))
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setNegativeButton(2131433029, b());
        this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setPositiveButton(2131433645, a());
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((!TextUtils.isEmpty((CharSequence)localObject1)) && (!TextUtils.isEmpty((CharSequence)localObject2)) && (!TextUtils.isEmpty((CharSequence)localObject3))) {
          ArkAppDataReport.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject1, "AIOArkSdkSelectSend", 1, 0, 0L, 0L, 0L, (String)localObject2, "");
        }
        label493:
        this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setMessage("");
        this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setNegativeButton(2131433029, b());
        ...
        if (i == 4)
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = DialogUtil.a(this.jdField_a_of_type_AndroidAppActivity, c(), (String)localObject1, (String)localObject2, (ArrayList)localObject3, null, a(), b(), 36, false);
          continue;
        }
        if (i == 5)
        {
          i = this.jdField_a_of_type_AndroidOsBundle.getInt("key_hiboom_id");
          this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = DialogUtil.b(this.jdField_a_of_type_AndroidAppActivity, 230, c(), "", a(), b(), a(), b());
          localObject1 = new HiBoomTextView(this.jdField_a_of_type_AndroidAppActivity);
          ((HiBoomTextView)localObject1).setHiBoom(i, 1, HiBoomManager.a);
  ...
  protected void p()
  {
    ...
    if ((this.jdField_a_of_type_AndroidViewView$OnClickListener == null) && (!bool)) {
      this.jdField_a_of_type_AndroidViewView$OnClickListener = new adsk(this, str);
    }
