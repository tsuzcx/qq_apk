...
public class ForwardShareCardOption
  extends auxu
{
  anwo jdField_a_of_type_Anwo;
  private aojs jdField_a_of_type_Aojs = new avcr(this);
  private bkia jdField_a_of_type_Bkia = new avcs(this);
  ...
  {
    super(paramIntent);
    this.jdField_b_of_type_Anwt = new avct(this);
  }
  ...
  private void I()
  {
    ...
    {
      QQToast.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidAppActivity.getString(2131691989), 0).b(this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131299011));
    ...
    if (TroopInfo.isQidianPrivateTroop(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.k))
    {
      ...
      ((bkib)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(85)).b(this.k, ((TroopInfo)localObject).troopowneruin);
      return;
    }
  ...
  public static final AbsShareMsg a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    if (paramString2 == null)
    {
      ...
      paramString2 = ((bdoi)localObject1).c(84).a(2).a(anzj.a(2131703701) + paramQQAppInterface).a("plugin", "", "AppCmd://OpenContactInfo/?uin=", (String)localObject2, (String)localObject2).d(paramActivity.getResources().getString(2131717390)).a();
      localObject1 = new bdre();
      ((bdom)localObject1).b(1);
      ((bdom)localObject1).a(new bdqo((String)localObject2));
      ((bdom)localObject1).a(new StructMsgItemTitle(paramQQAppInterface));
    ...
    {
      if (paramBoolean) {}
      for (paramActivity = anzj.a(2131703724);; paramActivity = anzj.a(2131703706))
      {
        paramQQAppInterface = new bdtj(paramActivity + paramQQAppInterface);
        paramQQAppInterface.d(paramActivity + paramString1);
        ((bdom)localObject1).a(paramQQAppInterface);
        paramString2.addItem(a(anzj.a(2131703731)));
        paramString2.addItem((bdol)localObject1);
        return paramString2;
        paramQQAppInterface = paramString2.trim();
        break;
        paramString2 = "&headtext=" + URLEncoder.encode(bhlg.a(paramQQAppInterface));
        break label47;
      }
    }
  }
  ...
  private void a(CardOCRInfo paramCardOCRInfo)
  {
    ...
    for (;;)
    {
      ...
      localObject2 = ((bdoi)localObject2).c(73).a(this.jdField_a_of_type_AndroidAppActivity.getString(2131697872, new Object[] { paramCardOCRInfo.a })).a(2).a("shareBusinessCard", "", (String)localObject3, (String)localObject3, (String)localObject3).d(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131718009)).a();
      localObject3 = new bdso();
      ((bdom)localObject3).b(1);
      ((bdom)localObject3).a(this.jdField_a_of_type_AndroidAppActivity.getString(2131697870));
      bdre localbdre = new bdre();
      localbdre.b(3);
      localbdre.a(new bdqo(paramCardOCRInfo.jdField_b_of_type_JavaLangString + "/?02"));
      localbdre.a(new StructMsgItemTitle(paramCardOCRInfo.a));
      localbdre.a(new bdtj((String)localObject1));
      ((AbsShareMsg)localObject2).addItem((bdol)localObject3);
      ((AbsShareMsg)localObject2).addItem(localbdre);
      ...
      aqoj.a(paramCardOCRInfo.jdField_b_of_type_JavaLangString);
      this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg = bdow.a(((StructMsgForImageShare)bdow.a((Bundle)localObject1)).getBytes());
  ...
  {
    if (!bkgt.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1)) {}
    do
    {
      return;
      localObject1 = ((anyw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).b(paramString1);
    ...
    Object localObject1 = bkgt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1);
    if (TextUtils.isEmpty((CharSequence)localObject1)) {}
    for (;;)
    {
      localObject1 = ((bdoi)localObject2).c(14).a(2).a(1).a(anzj.a(2131703721) + paramString2).a("plugin", str4, "", str2, str3).d(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131717385)).a();
      localObject2 = new bdre();
      ((bdom)localObject2).b(1);
      ((bdom)localObject2).a(new bdqo(str1));
      ((bdom)localObject2).a(new StructMsgItemTitle(paramString2));
      ((bdom)localObject2).a(new bdtj(anzj.a(2131703733) + bkgt.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1)));
      ((AbsShareMsg)localObject1).addItem(a(anzj.a(2131703725)));
  ...
  private void a(String paramString, boolean paramBoolean)
  {
    ...
    int i1 = ((anws)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).a(paramString);
    ...
    z();
    QQToast.a(this.jdField_a_of_type_AndroidAppActivity, -1, anzj.a(2131703729), 0).b(this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131299011));
  }
  ...
  private View b()
  {
    ...
    {
      new RelativeLayout.LayoutParams(-1, -2).setMargins(agej.a(-15.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), 0, agej.a(-15.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), 0);
      if (QLog.isColorLevel()) {
  ...
  private void b(String paramString1, String paramString2)
  {
    ...
    Object localObject1 = bhlg.i(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1);
    if (TextUtils.isEmpty((CharSequence)localObject1)) {}
    for (;;)
    {
      localObject1 = ((bdoi)localObject2).c(14).a(2).a(1).a(anzj.a(2131703719) + paramString2).a("plugin", "", str2, str1, str1).d(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131717385)).a();
      localObject2 = new bdre();
      ((bdom)localObject2).b(1);
      ((bdom)localObject2).a(new bdqo(str1));
      ((bdom)localObject2).a(new StructMsgItemTitle(paramString2));
      ((bdom)localObject2).a(new bdtj(anzj.a(2131703685) + paramString1));
      ((AbsShareMsg)localObject1).addItem(a(anzj.a(2131703695)));
      ((AbsShareMsg)localObject1).addItem((bdol)localObject2);
      this.jdField_a_of_type_AndroidOsBundle.putByteArray("stuctmsg_bytes", ((AbsShareMsg)localObject1).getBytes());
      this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg = ((AbsShareMsg)localObject1);
      m();
  ...
  {
    AbsShareMsg localAbsShareMsg = new bdoi(StructMsgForGeneralShare.class).c(15).a(anzj.a(2131703711) + this.jdField_l_of_type_JavaLangString).e(this.jdField_j_of_type_JavaLangString).a();
    Object localObject = (anws)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53);
    if (localObject != null)
    {
      localObject = ((anws)localObject).a(paramString1);
      if (localObject == null) {}
    }
    for (paramString1 = bhlg.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1, ((DiscussionInfo)localObject).ownerUin);; paramString1 = null)
    {
      localObject = paramString1;
      if (TextUtils.isEmpty(paramString1)) {
        localObject = anzj.a(2131703707);
      }
      paramString1 = bdov.a(2);
      paramString1.a(paramString2, this.jdField_l_of_type_JavaLangString, anzj.a(2131703730) + (String)localObject, 1);
      localAbsShareMsg.addItem(a(anzj.a(2131703691)));
  ...
  private void e()
  {
    ...
    for (;;)
    {
      String str2 = bgpj.a("", this.k, 0) + "100";
      AbsShareMsg localAbsShareMsg = new bdoi(StructMsgForGeneralShare.class).c(15).a(this.jdField_a_of_type_AndroidAppActivity.getString(2131717392) + str1).e(this.jdField_h_of_type_JavaLangString).a();
      bdom localbdom = bdov.a(2);
      Object localObject1 = this.jdField_a_of_type_AndroidAppActivity.getString(2131718172);
      ...
      for (;;)
      {
        localbdom.a(str2, str1, (String)localObject1, 1);
        localAbsShareMsg.addItem(a(anzj.a(2131703693)));
  ...
  public View a()
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg != null)
      {
        ...
        continue;
        localView1 = a(String.format("[%s]%s", new Object[] { anzj.a(2131703709), this.q }), aoot.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1, this.p));
        continue;
        localView1 = a(String.format("[%s]%s", new Object[] { anzj.a(2131703734), this.q }), aoot.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 11, this.p));
        continue;
        localView1 = a(String.format("[%s]%s", new Object[] { anzj.a(2131703704), this.q }), aoot.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 4, this.p));
        continue;
        localView1 = a(String.format("[%s]%s", new Object[] { anzj.a(2131703718), this.q }), aoot.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 101, this.p));
        continue;
        localView1 = b();
      }
    }
  ...
  public void a()
  {
    ...
    int i1 = ((axfr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(11)).d();
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Anwo.a(Long.parseLong(this.p), true);
      a(2131694176);
      continue;
      this.k = null;
      this.jdField_l_of_type_JavaLangString = null;
  ...
  public boolean a()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_b_of_type_Anwt);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Bkia);
    this.jdField_a_of_type_Anwo = ((anwo)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6));
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg != null) {
      parambhpc.addView(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.getPreDialogView(this.jdField_a_of_type_AndroidAppActivity, null));
    }
    for (;;)
    {
      return true;
      if (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg != null)
      {
        ...
        localLayoutParams.setMargins(agej.a(-15.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), 0, agej.a(-15.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), 0);
        if (QLog.isColorLevel()) {
          QLog.d("ForwardOption.ForwardShareCardOption", 2, "updateImageView addStructView");
        }
  ...
  public String b()
  {
    return this.jdField_a_of_type_AndroidAppActivity.getString(2131718010);
  }
  ...
  public void d()
  {
    bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X80056B4", "0X80056B4", 0, 0, "", "", "", "");
    super.d();
    if (this.jdField_i_of_type_Boolean) {
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8007013", "0X8007013", 0, 0, "", "", "", "");
    }
  }
  ...
  public void s()
  {
    super.s();
    if (this.jdField_i_of_type_Boolean) {
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8007012", "0X8007012", 0, 0, "", "", "", "");
    }
  }
  ...
  public void y()
  {
    ...
    if (this.jdField_b_of_type_Anwt != null) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_b_of_type_Anwt);
    }
