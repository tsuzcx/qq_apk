  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        this.a.F();
        break;
        ForwardPreviewMixedMsgController localForwardPreviewMixedMsgController = new ForwardPreviewMixedMsgController(this.a.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        localForwardPreviewMixedMsgController.a(this.a.jdField_a_of_type_AndroidAppActivity.getString(2131692691), this.a.jdField_a_of_type_ComTencentMobileqqDataMessageForMixedMsg);
        this.a.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.addPreviewView(localForwardPreviewMixedMsgController.b());
      }
