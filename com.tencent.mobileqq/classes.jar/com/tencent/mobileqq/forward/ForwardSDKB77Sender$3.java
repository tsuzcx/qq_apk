  ...
  extends ProtoUtils.TroopProtocolObserver
{
  ...
  public void onResult(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    if (bool)
    {
      ForwardSDKB77Sender.a(this.c, new Object[] { Integer.valueOf(0), "", HardCodeUtil.a(2131902785), "" }, -6);
      return;
    }
    if (paramBundle != null)
    {
      long l = paramBundle.getLong("0xb77_9_sendTime", -1L);
      if ((l == -1L) || (l != ForwardSDKB77Sender.a(this.c)))
      {
        paramArrayOfByte = new StringBuilder();
        paramArrayOfByte.append("handleGetMessageState currentRequestTime =");
        paramArrayOfByte.append(ForwardSDKB77Sender.a(this.c));
    ...
    paramBundle = SdkShareReporter.b(this.b.getInt("req_type"));
    Object localObject = SdkShareReporter.c(this.b.getInt("uintype"));
    String str = this.b.getString("title");
    ...
    if ((i == 0) && (paramArrayOfByte != null)) {
      ForwardSDKB77Sender.a(this.c, this.b);
    }
    paramBundle = this.c;
