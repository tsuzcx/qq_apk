...
public class GalleryJumpUtils
{
  ...
  public static void a(Context paramContext, String paramString, int paramInt, RichMediaBrowserInfo paramRichMediaBrowserInfo)
  {
    ...
    localIntent.putExtra("extra.EXTRA_CURRENT_IMAGE", DataUtils.a((AIOBrowserBaseData)paramRichMediaBrowserInfo.baseData));
    localIntent.putExtra("leftViewText", paramContext.getString(2131690946));
