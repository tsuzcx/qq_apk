...
public class AIOGalleryUtils
{
  ...
  public static void a(Activity paramActivity, File paramFile, String paramString, AIOGalleryUtils.OnSavePhoto paramOnSavePhoto)
  {
    ...
    {
      str = FileUtils.b(paramFile.getAbsolutePath());
      str = paramString + "." + str;
    }
    ...
    DialogUtil.a(paramActivity, 230).setTitle(paramActivity.getString(2131718675)).setMessage(paramActivity.getString(2131694917)).setPositiveButton(paramActivity.getString(2131718540), new AIOGalleryUtils.2(paramActivity, paramFile, paramString, paramOnSavePhoto)).setNegativeButton(paramActivity.getString(2131694495), new AIOGalleryUtils.1()).show();
  }
  ...
  public static void a(Activity paramActivity, String paramString, ArrayList<String> paramArrayList, int paramInt)
  {
    ...
    QZoneHelper.forwardToUploadPhoto(paramActivity, paramString, 0, 0, paramArrayList, paramActivity.getResources().getString(2131717989), paramInt);
  }
