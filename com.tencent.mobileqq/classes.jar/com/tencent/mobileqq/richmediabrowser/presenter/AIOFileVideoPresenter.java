  ...
  extends AIOBrowserBasePresenter
{
  ...
  public long a()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqRichmediabrowserViewAIOFileVideoView != null) && (this.jdField_a_of_type_ComTencentMobileqqRichmediabrowserViewAIOFileVideoView.a != null)) {
      return this.jdField_a_of_type_ComTencentMobileqqRichmediabrowserViewAIOFileVideoView.a.getCurPlayingPos();
    }
    return 0L;
  }
  ...
  public void a(long paramLong, int paramInt1, int paramInt2, int paramInt3, String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      if (paramInt2 == 269484034)
      {
        ...
        if ((paramString != null) && ((paramString.baseData instanceof AIOBrowserBaseData)) && (((AIOBrowserBaseData)paramString.baseData).jdField_a_of_type_Long == paramLong)) {
          if (paramBoolean)
          {
            ...
            QQToast.a(this.jdField_a_of_type_ComTencentMobileqqRichmediabrowserViewAIOFileVideoView.mContext, 2, this.jdField_a_of_type_ComTencentMobileqqRichmediabrowserViewAIOFileVideoView.mContext.getString(2131718661), 0).a();
          }
        }
      }
      for (;;)
      {
        ...
        label283:
        if (paramInt3 == 2) {
          QQToast.a(this.jdField_a_of_type_ComTencentMobileqqRichmediabrowserViewAIOFileVideoView.mContext, 1, this.jdField_a_of_type_ComTencentMobileqqRichmediabrowserViewAIOFileVideoView.mContext.getString(2131718676), 0).a();
        }
      }
      paramBoolean = false;
    }
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqRichmediabrowserViewAIOFileVideoView.a(paramLong, paramInt1, paramInt2, paramString1, paramArrayOfString, paramString2, paramMessageForShortVideo, paramInt3, paramBundle);
  }
  ...
  public void b()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqRichmediabrowserPresenterAIOBrowserPresenter != null) && (this.jdField_a_of_type_ComTencentMobileqqRichmediabrowserPresenterAIOBrowserPresenter.a != null) && (this.jdField_a_of_type_ComTencentMobileqqRichmediabrowserPresenterAIOBrowserPresenter.a() != null))
    {
      ...
      if (localAIOFileVideoData != null) {
        bool = FileUtils.b(localAIOFileVideoData.jdField_c_of_type_JavaLangString);
      }
      if (bool)
      {
        if (!LiuHaiUtils.b()) {
        ...
        this.jdField_a_of_type_ComTencentMobileqqRichmediabrowserPresenterAIOBrowserPresenter.a().a((int)AIOUtils.a(LiuHaiUtils.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqRichmediabrowserViewAIOFileVideoView.mContext.getResources()) + 46);
      }
    }
    for (;;)
    {
  ...
  public void setGalleryView(BrowserBaseView paramBrowserBaseView)
  {
    ...
    if ((paramBrowserBaseView instanceof AIOFileVideoView)) {
      this.jdField_a_of_type_ComTencentMobileqqRichmediabrowserViewAIOFileVideoView = ((AIOFileVideoView)paramBrowserBaseView);
    }
  }
}
