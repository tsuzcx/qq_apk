...
public class AIOFileVideoView$5
  implements Runnable
{
  public AIOFileVideoView$5(axvm paramaxvm) {}
  
  public void run()
  {
    Object localObject = this.this$0.jdField_a_of_type_Axuk.getSelectedItem();
    int i;
    long l1;
    ...
    if (i == 3)
    {
      l2 = this.this$0.jdField_a_of_type_Ailt.c();
      if (l2 > 0L)
      {
    ...
    label340:
    for (float f = (int)((float)this.this$0.jdField_a_of_type_Ailt.d() / (float)l1 * 10000.0F);; f = 10000.0F)
    {
      this.this$0.jdField_a_of_type_AndroidWidgetSeekBar.setSecondaryProgress((int)f);
      this.this$0.jdField_a_of_type_Axuk.a.postDelayed(this.this$0.b, 100L);
      return;
      this.this$0.c.setVisibility(8);
      break;
      l2 = this.this$0.jdField_a_of_type_Ailt.a();
      i = (int)(l2 / this.this$0.jdField_a_of_type_Ailt.b() * 10000.0D);
