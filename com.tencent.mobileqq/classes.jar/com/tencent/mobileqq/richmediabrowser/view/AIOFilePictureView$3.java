...
public class AIOFilePictureView$3
  implements Runnable
{
  public AIOFilePictureView$3(bbqq parambbqq, File paramFile, ArrayList paramArrayList) {}
  ...
  public void run()
  {
    try
    {
      if (this.jdField_a_of_type_JavaIoFile != null)
      {
        ...
        bbqq.a(this.this$0, localUri, this.jdField_a_of_type_JavaUtilArrayList);
      }
      return;
    }
