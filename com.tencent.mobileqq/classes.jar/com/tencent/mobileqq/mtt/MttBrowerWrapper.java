...
public class MttBrowerWrapper
{
  ...
  public static void a(Context paramContext, String paramString1, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4, MessageRecord paramMessageRecord, String paramString2)
  {
    ...
    if ((!TextUtils.isEmpty(paramString1)) && (ViolaAccessHelper.b(paramString1)))
    {
      ViolaAccessHelper.a(paramContext, null, ViolaAccessHelper.c(paramString1), null);
      return;
    }
    ...
    for (;;)
    {
      ...
      if ((paramString2 instanceof QQAppInterface)) {
        AIOOpenWebMonitor.a(localIntent, (QQAppInterface)paramString2, paramMessageRecord);
      }
      WebAccelerator.a(paramContext, localIntent, paramString1);
