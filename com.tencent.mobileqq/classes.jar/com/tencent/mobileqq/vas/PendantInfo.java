  ...
  implements VipPendantDrawable.MutilePlayInfo
{
  ...
  public PendantInfo(long paramLong)
  {
    ...
    this.jdField_a_of_type_MqqOsMqqHandler = new akpg(this, Looper.getMainLooper(), null);
  ...
  protected Bitmap a(int paramInt1, Object paramObject, int paramInt2)
  {
    ...
    //   715: dup
    //   716: aload_2
    //   717: getfield 461	akpi:jdField_a_of_type_JavaLangString	Ljava/lang/String;
  ...
  public Drawable a(int paramInt1, long paramLong, String paramString, int paramInt2)
  {
    ...
    for (;;)
    {
      ThreadManager.post(new akph(this, paramInt1, paramLong, paramString), 8, null, true);
      return paramString;
  ...
  public void d()
  {
    try
    {
      if (((this.jdField_a_of_type_JavaLangObject instanceof akpi)) && (a()))
      {
        if ((this.jdField_a_of_type_JavaLangObject != null) && (((akpi)this.jdField_a_of_type_JavaLangObject).jdField_a_of_type_JavaLangString != null) && (((akpi)this.jdField_a_of_type_JavaLangObject).jdField_a_of_type_JavaLangString.equals(this.jdField_b_of_type_JavaLangString))) {
          return;
        }
    ...
    this.jdField_a_of_type_JavaLangObject = new akpi(this, this.jdField_b_of_type_JavaLangString);
    this.r = 0;
