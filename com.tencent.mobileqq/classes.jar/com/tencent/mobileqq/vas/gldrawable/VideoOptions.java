...
{
  public static final VideoOptions.Companion a;
  ...
  static
  {
    jdField_a_of_type_ComTencentMobileqqVasGldrawableVideoOptions$Companion = new VideoOptions.Companion(null);
  }
  
  public VideoOptions(@NotNull String paramString, boolean paramBoolean1, int paramInt, boolean paramBoolean2)
  {
  ...
  public boolean equals(@Nullable Object paramObject)
  {
    if (this != paramObject)
    {
      if ((paramObject instanceof VideoOptions))
      {
        paramObject = (VideoOptions)paramObject;
 ...
 * Qualified Name:     com.tencent.mobileqq.vas.gldrawable.VideoOptions
