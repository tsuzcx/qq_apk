...
public class ColorNickManager$2
  implements Runnable
{
  public ColorNickManager$2(bdnm parambdnm, int paramInt) {}
  
  public void run()
  {
    Object localObject = new File(bdnm.a(String.valueOf(this.a)));
    if (((File)localObject).exists())
    {
      localObject = bdnm.a(this.this$0, (File)localObject, this.a);
      if (localObject != null)
      {
