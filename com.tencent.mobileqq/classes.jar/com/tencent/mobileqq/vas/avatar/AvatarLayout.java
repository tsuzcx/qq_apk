  ...
  extends FrameLayout
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, ListView paramListView, Collection<String> paramCollection)
  {
    ...
    if (i < paramListView.getChildCount())
    {
      ...
      {
        localacju = (acju)aciy.a((View)localObject);
        localChatMessage = aciy.a((View)localObject);
        if ((localacju != null) && (localChatMessage != null) && (localChatMessage.senderuin != null) && (paramCollection.contains(localChatMessage.senderuin)))
        {
          ...
          localObject = azwp.a(paramQQAppInterface, 200, (String)localObject, true);
        }
      }
    }
    for (;;)
    {
      localacju.a.setHeaderIcon(localObject);
      i += 1;
      break label7;
      break;
      label186:
      ...
      break label124;
      label196:
      azwp localazwp = azwp.a(paramQQAppInterface, 1, (String)localObject);
      localObject = new baqk((String)localObject, -1, "small", localChatMessage.uniseq);
      ((baqk)localObject).a = localazwp;
    }
  }
  ...
  public void a(int paramInt1, int paramInt2, String paramString, ImageView.ScaleType paramScaleType)
  {
    ...
    localVasAvatar1.setLoader(this, new baqk(paramInt1, paramInt2, paramString, false));
  ...
  public void a(String paramString1, int paramInt, String paramString2, ImageView.ScaleType paramScaleType)
  {
    ...
    for (;;)
    {
      localVasAvatar.setLoader(this, new baqk(paramString1, paramInt, paramString2, 0L));
  ...
  public void setFaceDrawable(AppInterface paramAppInterface, int paramInt1, int paramInt2, String paramString, byte paramByte, int paramInt3, boolean paramBoolean1, Drawable paramDrawable1, Drawable paramDrawable2, azwq paramazwq, int paramInt4, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4, boolean paramBoolean5, int paramInt5)
  {
    ...
    localDynamicAvatarView.setFaceDrawable(paramAppInterface, paramInt1, paramInt2, paramString, paramByte, paramInt3, paramBoolean1, paramDrawable1, paramDrawable2, paramazwq, paramInt4, paramBoolean2, paramBoolean3, paramBoolean4, paramBoolean5, baqj.a(paramInt5));
  ...
  {
    DynamicAvatarView localDynamicAvatarView = (DynamicAvatarView)a(0);
    localDynamicAvatarView.setFaceDrawable(paramAppInterface, paramDrawable, paramInt1, paramInt2, paramString, paramInt3, paramBoolean1, paramDynamicAvatar, paramBoolean2, paramBoolean3, paramBoolean4, paramBoolean5, baqj.a(paramInt4));
    if (VasAvatar.a(paramInt1, paramInt2)) {
