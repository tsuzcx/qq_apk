...
public class VasUpdateEngineV2$1
  implements Runnable
{
  public VasUpdateEngineV2$1(bids parambids, VasQuickUpdateManager.QueryItemVersionCallback paramQueryItemVersionCallback, int paramInt, String paramString) {}
  
  public void run()
  {
    Object localObject = VasUpdateWrapper.getDbManager();
    if ((localObject == null) || (!(localObject instanceof bidy)) || (this.jdField_a_of_type_ComTencentMobileqqVasVasQuickUpdateManager$QueryItemVersionCallback == null))
    {
      QLog.e("VasUpdate_VasUpdateEngineV2", 1, "setWeakHandler cmdManager == null or != VasCmdImpl or callback == null");
      return;
    }
    localObject = ((bidy)localObject).selectItem(0, CommonUtil.sComposeItemId(this.jdField_a_of_type_Int, this.jdField_a_of_type_JavaLangString));
