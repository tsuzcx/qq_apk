...
public class VasResController$2
  implements Runnable
{
  public VasResController$2(bbsa parambbsa, String paramString, int paramInt1, int paramInt2) {}
  ...
  public void run()
  {
    ...
    {
      return;
      localObject1 = bbdx.a(this.jdField_a_of_type_JavaLangString);
    ...
    localObject1 = bbsa.a(this.this$0).obtainMessage();
    ...
    bbsa.a(this.this$0).sendMessage((Message)localObject1);
  }
}
