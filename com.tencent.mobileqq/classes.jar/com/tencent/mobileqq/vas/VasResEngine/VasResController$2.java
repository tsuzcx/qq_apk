...
public class VasResController$2
  implements Runnable
{
  public VasResController$2(bbrm parambbrm, String paramString, int paramInt1, int paramInt2) {}
  ...
  public void run()
  {
    ...
    {
      return;
      localObject1 = bbdj.a(this.jdField_a_of_type_JavaLangString);
    ...
    localObject1 = bbrm.a(this.this$0).obtainMessage();
    ...
    bbrm.a(this.this$0).sendMessage((Message)localObject1);
  }
}
