...
public class VasResController$2
  implements Runnable
{
  public VasResController$2(bapp parambapp, String paramString, int paramInt1, int paramInt2) {}
  ...
  public void run()
  {
    ...
    {
      return;
      localObject1 = bace.a(this.jdField_a_of_type_JavaLangString);
    ...
    localObject1 = bapp.a(this.this$0).obtainMessage();
    ...
    bapp.a(this.this$0).sendMessage((Message)localObject1);
  }
}
