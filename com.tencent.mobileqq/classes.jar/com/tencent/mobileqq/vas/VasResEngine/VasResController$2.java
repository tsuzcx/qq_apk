...
public class VasResController$2
  implements Runnable
{
  public VasResController$2(bdqu parambdqu, String paramString, int paramInt1, int paramInt2) {}
  ...
  public void run()
  {
    ...
    {
      return;
      localObject1 = bdcs.a(this.jdField_a_of_type_JavaLangString);
    ...
    localObject1 = bdqu.a(this.this$0).obtainMessage();
    ...
    bdqu.a(this.this$0).sendMessage((Message)localObject1);
  }
}
