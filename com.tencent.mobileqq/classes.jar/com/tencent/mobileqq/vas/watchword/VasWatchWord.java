...
public final class VasWatchWord
{
  public static final VasWatchWord a = new VasWatchWord();
  ...
  public final Integer a(@NotNull String paramString)
  {
    ...
    if ((!TextUtils.isEmpty((CharSequence)paramString)) && (StringsKt.contains$default((CharSequence)paramString, (CharSequence)"?", false, 2, null)))
    {
      ...
      paramString = Common.a(((String[])paramString)[1]);
  ...
  public final void a()
  {
    RIJWatchWordShareManager.a.a().a((RIJWatchWordShareManager.OnWatchWordCheck)new VasWatchWord.addObserver.1());
  }
  ...
  public final void a(@NotNull GetWatchWordShareRsp paramGetWatchWordShareRsp)
  {
    ...
    localObject = new VipWatchWordJumpDialog((ViewGroup)localObject, str1, str2, (Function1)new VasWatchWord.showContentDialog.jumpDialog.1(paramGetWatchWordShareRsp, i));
    str1 = paramGetWatchWordShareRsp.itemmsg;
    Intrinsics.checkExpressionValueIsNotNull(str1, "rsp.itemmsg");
    ((VipWatchWordJumpDialog)localObject).a(str1);
    ...
    ((VipWatchWordJumpDialog)localObject).a(j, paramGetWatchWordShareRsp);
    ((VipWatchWordJumpDialog)localObject).a();
    ReportController.b(null, "dc00898", "", "", "qq_vip", "0X800AF79", i, 0, "", "", "", "");
  }
  ...
  public final void a(@Nullable Context paramContext, @NotNull String paramString)
  {
    ...
    paramString = Common.a(((String[])paramContext)[1]);
    ...
    ReportController.b(null, "dc00898", "", "", "qq_vip", "0X800AF78", Integer.parseInt(paramString), 0, paramContext, "", "", "");
    ...
    ((IWatchWordProtocol)localObject).a(paramString, paramContext, null, -1, (EIPCResultCallback)new VasWatchWord.shareWatchWord.1(paramString, paramContext));
  }
  ...
  public final void c(@NotNull Context paramContext, @NotNull String paramString)
  {
    ...
    DialogUtil.a(paramContext, 230, paramContext.getString(2131720639), (CharSequence)paramString, null, paramContext.getString(2131720638), (DialogInterface.OnClickListener)new DialogUtil.DialogOnClickAdapter(), null).show();
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes11.jar
 * Qualified Name:     com.tencent.mobileqq.vas.watchword.VasWatchWord
