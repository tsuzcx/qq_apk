...
import com.tencent.mobileqq.config.business.qvip.QVipPrettyAccountConfig;
...
public class PrettyAccountUtil
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, ProfileCardInfo paramProfileCardInfo, boolean paramBoolean)
  {
    if ((paramQQAppInterface == null) || (paramProfileCardInfo == null) || (paramProfileCardInfo.jdField_a_of_type_ComTencentMobileqqDataCard == null)) {}
    do
    {
      return;
      if (paramBoolean) {
    ...
    if (TextUtils.isEmpty(paramProfileCardInfo.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.d)) {
      if (paramProfileCardInfo.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.a.equals(paramQQAppInterface.getCurrentAccountUin())) {
        if (paramBoolean) {
    ...
    for (;;)
    {
      a(paramQQAppInterface, a(paramProfileCardInfo.jdField_a_of_type_ComTencentMobileqqDataCard), paramProfileCardInfo.jdField_a_of_type_ComTencentMobileqqDataCard.lhLevel);
      return;
  ...
  public static void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    ReportController.b((QQAppInterface)localAppRuntime, "dc00898", "", "", "", paramString, paramInt2, 0, "", "", "", "");
  }
  ...
  public static boolean a()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("PrettyAccountUtil", 2, "pretty_account manageOpen:" + localQVipPrettyAccountConfig.a);
    }
 ...
 * Qualified Name:     com.tencent.mobileqq.vas.PrettyAccountUtil
