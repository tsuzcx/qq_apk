  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    Object localObject = bbcm.b(this.this$0.jdField_a_of_type_Long, this.jdField_a_of_type_Int);
    if (2 == this.jdField_a_of_type_Int) {
      localObject = bbcm.b(this.this$0.jdField_a_of_type_Long, 8);
    }
      ...
      if (2 == this.jdField_a_of_type_Int)
      {
        ...
        do
        {
          do
          {
            ...
            return;
            localObject = new File(bbcm.b(this.this$0.jdField_a_of_type_Long, 4));
