...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"com/tencent/mobileqq/vas/adv/base/service/VasAdvService$requestAd$innerCallback$1", "Lcom/tencent/mobileqq/vas/adv/base/support/app/VasAdvCallback;", "onError", "", "errMsg", "", "e", "", "onRsp", "rspBytes", "", "vas-adv-impl_release"}, k=1, mv={1, 1, 16})
public final class VasAdvService$requestAd$innerCallback$1
  implements VasAdvCallback
{
  VasAdvService$requestAd$innerCallback$1(VasAdvBizCallback paramVasAdvBizCallback) {}
  ...
  public void a(@NotNull String paramString, @Nullable Throwable paramThrowable)
  {
    ...
    localStringBuilder.append("request ad onError: ");
  ...
  public void a(@NotNull byte[] paramArrayOfByte)
  {
    ...
    catch (Exception paramArrayOfByte)
    {
      ...
      StringBuilder localStringBuilder = new StringBuilder();
      localStringBuilder.append("parse rsp exception: ");
 ...
 * Qualified Name:     com.tencent.mobileqq.vas.adv.base.service.VasAdvService.requestAd.innerCallback.1
