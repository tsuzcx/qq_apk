...
public abstract interface VasAdvGdtInterface
{
  ...
  public abstract boolean a(@NotNull Context paramContext, @Nullable String paramString, @Nullable qq_ad_get.QQAdGetRsp.AdInfo paramAdInfo, int paramInt);
  
  @Nullable
  public abstract qq_ad_get.QQAdGet.DeviceInfo b(@NotNull String paramString);
  
  @Nullable
  public abstract String c(@NotNull String paramString);
  
  public abstract int d(@Nullable String paramString);
  
  public abstract void e();
  
  @Nullable
  public abstract String[] e(@Nullable String paramString);
  
  @NotNull
  public abstract String f();
  
  @Nullable
  public abstract String f(@Nullable String paramString);
}
