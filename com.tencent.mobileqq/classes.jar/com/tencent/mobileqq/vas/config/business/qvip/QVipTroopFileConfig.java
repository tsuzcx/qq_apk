...
public class QVipTroopFileConfig
{
  ...
  QVipTroopFileConfig.Info jdField_a_of_type_ComTencentMobileqqVasConfigBusinessQvipQVipTroopFileConfig$Info = new QVipTroopFileConfig.Info();
  private String jdField_a_of_type_JavaLangString = "";
  boolean jdField_a_of_type_Boolean = true;
  QVipTroopFileConfig.Info jdField_b_of_type_ComTencentMobileqqVasConfigBusinessQvipQVipTroopFileConfig$Info = new QVipTroopFileConfig.Info();
  private String jdField_b_of_type_JavaLangString = "";
  QVipTroopFileConfig.Info jdField_c_of_type_ComTencentMobileqqVasConfigBusinessQvipQVipTroopFileConfig$Info = new QVipTroopFileConfig.Info();
  ...
  @NonNull
  public static QVipTroopFileConfig a()
  {
    return a("{\"enable\":1,\"cacheFlag\":\"20200403\",\"intructionPageUrl\":\"https://act.qzone.qq.com/vip/meteor/blockly/p/4136x48826\",\"fullSpaceMessage\":{\"nonVIP\":\"当前群文件容量已满，新上传文件仅保留10天，开通超级会员可延长至30天。\",\"VIP\":\"当前群文件容量已满，会员新上传的文件仅保留20天，开通超级会员可延长至30天。\",\"SVIP\":\"当前群文件容量已满，你已享受超级会员特权，新上传的文件可保留30天。\"},\"redSubString\":{\"nonVIP\":\"容量已满\",\"VIP\":\"容量已满\",\"SVIP\":\"容量已满\"},\"blueSubString\":{\"nonVIP\":\"开通超级会员\",\"VIP\":\"开通超级会员\",\"SVIP\":\"超级会员特权\"},\"blueActionUrl\":{\"nonVIP\":\"https://h5.vip.qq.com/p/pay/index?_wv=17301507&_wwv=8192&aid=mvip.n.group.qwj_list&month=&type=svip&isAskFriendPay=0\",\"VIP\":\"https://h5.vip.qq.com/p/pay/index?_wv=17301507&_wwv=8192&aid=mvip.n.group.qwj_list&month=&type=svip&isAskFriendPay=0\",\"SVIP\":\"https://act.qzone.qq.com/vip/meteor/blockly/p/4136x48826\"},\"fullAlertMessage\":{\"nonVIP\":\"当前群文件容量已满，新上传的文件仅保留10天，超级会员可延长至30天。\",\"VIP\":\"当前群文件容量已满，会员新上传的文件仅保留20天，超级会员可延长至30天。\",\"SVIP\":\"\"},\"bigFileAlertMessage\":{\"nonVIP\":\"临时文件有效期10天，开通超级会员可将保存时间延长至30天\",\"VIP\":\"会员上传的临时文件有效期20天，开通超级会员可将保存时间延长至30天。\",\"SVIP\":\"\"},\"alertButtonTitle\":{\"nonVIP\":\"开通超级会员\",\"VIP\":\"开通超级会员\",\"SVIP\":\"\"},\"buttonActionUrl\":{\"nonVIP\":\"https://h5.vip.qq.com/p/pay/index?_wv=17301507&_wwv=8192&aid=mvip.n.group.qwj_tf&month=&type=svip&isAskFriendPay=0\",\"VIP\":\"https://h5.vip.qq.com/p/pay/index?_wv=17301507&_wwv=8192&aid=mvip.n.group.qwj_tf&month=&type=svip&isAskFriendPay=0\",\"SVIP\":\"\"},\"AIObuttonActionUrl\":{\"nonVIP\":\"https://h5.vip.qq.com/p/pay/index?_wv=17301507&_wwv=8192&aid=mvip.n.group.qwj_aio&month=&type=svip&isAskFriendPay=0\",\"VIP\":\"https://h5.vip.qq.com/p/pay/index?_wv=17301507&_wwv=8192&aid=mvip.n.group.qwj_aio&month=&type=svip&isAskFriendPay=0\",\"SVIP\":\"\"}}");
  }
  
  @NonNull
  public static QVipTroopFileConfig a(@Nullable String paramString)
  {
    ...
    try
    {
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        localQVipTroopFileConfig.jdField_a_of_type_Int = paramString.optInt("enable", localQVipTroopFileConfig.jdField_a_of_type_Int);
        localQVipTroopFileConfig.jdField_a_of_type_JavaLangString = paramString.optString("cacheFlag", localQVipTroopFileConfig.jdField_a_of_type_JavaLangString);
        localQVipTroopFileConfig.jdField_b_of_type_JavaLangString = paramString.optString("intructionPageUrl", localQVipTroopFileConfig.jdField_b_of_type_JavaLangString);
        localQVipTroopFileConfig.jdField_a_of_type_ComTencentMobileqqVasConfigBusinessQvipQVipTroopFileConfig$Info = QVipTroopFileConfig.Info.a(paramString.getJSONObject("fullSpaceMessage"));
        localQVipTroopFileConfig.jdField_b_of_type_ComTencentMobileqqVasConfigBusinessQvipQVipTroopFileConfig$Info = QVipTroopFileConfig.Info.a(paramString.getJSONObject("redSubString"));
        localQVipTroopFileConfig.jdField_c_of_type_ComTencentMobileqqVasConfigBusinessQvipQVipTroopFileConfig$Info = QVipTroopFileConfig.Info.a(paramString.getJSONObject("blueSubString"));
  ...
  private static void b(String paramString1, String paramString2, String paramString3)
  {
    ...
    ReportController.b(null, "dc00898", "", "", "qq_vip", paramString1, j, 1, 0, "", "", paramString3, "");
  }
  
  public SpannableString a(String paramString)
  {
    String str1 = this.jdField_a_of_type_ComTencentMobileqqVasConfigBusinessQvipQVipTroopFileConfig$Info.a(paramString);
    String str2 = this.jdField_b_of_type_ComTencentMobileqqVasConfigBusinessQvipQVipTroopFileConfig$Info.a(paramString);
    String str3 = this.jdField_c_of_type_ComTencentMobileqqVasConfigBusinessQvipQVipTroopFileConfig$Info.a(paramString);
    ...
    j = str1.indexOf(str3);
    if (j > -1) {
      localSpannableString.setSpan(new QVipTroopFileConfig.1(this, str4, paramString), j, str3.length() + j, 33);
    }
  ...
  {
    paramContext = DialogUtil.a(paramContext, 230, "", paramString1, this.jdField_c_of_type_JavaLangString, this.g.a(paramString2), new QVipTroopFileConfig.3(this, paramContext, paramBoolean1, paramString2, paramBoolean2), new QVipTroopFileConfig.4(this, paramRunnable, paramBoolean1, paramString2, paramBoolean2));
  ...
  public boolean a(@NonNull SpannableString paramSpannableString, @NonNull String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      int m = str.indexOf(paramString1);
      if ((k > 10) && (m > -1))
      {
        paramSpannableString.setSpan(new QVipTroopFileConfig.2(this, paramString2), m, paramString1.length() + m + j, 33);
  ...
  boolean b()
  {
    ...
    boolean bool = TextUtils.equals(this.jdField_a_of_type_JavaLangString, localSharedPreferences.getString("vas_guide_troop_file", null)) ^ true;
    if (bool) {
  ...
  public String toString()
  {
    ...
    localStringBuilder.append(this.jdField_a_of_type_ComTencentMobileqqVasConfigBusinessQvipQVipTroopFileConfig$Info);
    localStringBuilder.append(", redSubString=");
    localStringBuilder.append(this.jdField_b_of_type_ComTencentMobileqqVasConfigBusinessQvipQVipTroopFileConfig$Info);
    localStringBuilder.append(", blueSubString=");
    localStringBuilder.append(this.jdField_c_of_type_ComTencentMobileqqVasConfigBusinessQvipQVipTroopFileConfig$Info);
