...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/mobileqq/vas/troopgift/TroopGiftComboView;", "Lcom/tencent/mobileqq/vas/ui/VasPagView;", "context", "Landroid/content/Context;", "attrs", "Landroid/util/AttributeSet;", "(Landroid/content/Context;Landroid/util/AttributeSet;)V", "(Landroid/content/Context;)V", "defStyleAttr", "", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "TAG", "", "getTAG", "()Ljava/lang/String;", "comboState", "Lcom/tencent/mobileqq/vas/troopgift/TroopGiftComboView$PlayState;", "pagState", "textAnimationDuration", "", "<set-?>", "wholeState", "getWholeState$AQQLiteApp_release", "()Lcom/tencent/mobileqq/vas/troopgift/TroopGiftComboView$PlayState;", "getDefDuration", "comboTimes", "setAvatars", "", "senderAvatar", "Landroid/graphics/Bitmap;", "receiverAvatar", "setPAGResource", "pagPath", "fontPath", "setReceiverAvatar", "setSenderAvatar", "startComboAnimation", "PlayState", "AQQLiteApp_release"}, k=1, mv={1, 1, 16})
public final class TroopGiftComboView
  extends VasPagView
{
  private long jdField_a_of_type_Long;
  @NotNull
  private TroopGiftComboView.PlayState jdField_a_of_type_ComTencentMobileqqVasTroopgiftTroopGiftComboView$PlayState = TroopGiftComboView.PlayState.PLAY_NONE;
  @NotNull
  private final String jdField_a_of_type_JavaLangString = "TroopGiftComboView";
  private TroopGiftComboView.PlayState b = TroopGiftComboView.PlayState.PLAY_NONE;
  private TroopGiftComboView.PlayState c = TroopGiftComboView.PlayState.PLAY_NONE;
  ...
  @NotNull
  public final TroopGiftComboView.PlayState a()
  {
    return this.jdField_a_of_type_ComTencentMobileqqVasTroopgiftTroopGiftComboView$PlayState;
  }
  ...
  public final void a(int paramInt)
  {
    ...
    a((Function1)new TroopGiftComboView.startComboAnimation.2(this, localValueAnimator, paramInt));
  ...
  public final void setAvatars(@NotNull Bitmap paramBitmap1, @NotNull Bitmap paramBitmap2)
  {
    ...
    a((Function1)new TroopGiftComboView.setAvatars.1(this, paramBitmap1, paramBitmap2));
  }
  ...
  public final void setPAGResource(@NotNull String paramString1, @NotNull String paramString2)
  {
    ...
    a((Function1)new TroopGiftComboView.setPAGResource.1(this, paramString1, paramString2));
  }
  ...
  public final void setReceiverAvatar(@NotNull Bitmap paramBitmap)
  {
    ...
    a((Function1)new TroopGiftComboView.setReceiverAvatar.1(this, paramBitmap));
  }
  
  public final void setSenderAvatar(@NotNull Bitmap paramBitmap)
  {
    Intrinsics.checkParameterIsNotNull(paramBitmap, "senderAvatar");
    a((Function1)new TroopGiftComboView.setSenderAvatar.1(this, paramBitmap));
  }
}
