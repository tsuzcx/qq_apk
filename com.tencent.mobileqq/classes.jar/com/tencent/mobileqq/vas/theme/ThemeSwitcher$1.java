  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (!ThemeSwitcher.a(this.this$0).a().b())
    {
      ...
      ((StringBuilder)localObject2).append(ThemeSwitcher.a(this.this$0).d());
      QLog.e("ThemeSwitcher", 1, ((StringBuilder)localObject2).toString());
      VasFileUtils.a(((AppRuntime)localObject1).getApp(), "999_540", ThemeSwitcher.a(this.this$0).d());
      int i = ThemeUtil.getFileNumInFile(new File(ThemeSwitcher.a(this.this$0).d()));
