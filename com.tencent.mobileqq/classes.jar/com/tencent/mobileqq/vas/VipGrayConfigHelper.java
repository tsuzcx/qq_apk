...
public class VipGrayConfigHelper
{
  ...
  private static final Runnable jdField_a_of_type_JavaLangRunnable = new ajub();
  ...
  private static final Map jdField_b_of_type_JavaUtilMap;
  ...
  private void a(AppRuntime paramAppRuntime, JSONArray paramJSONArray, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (a(paramAppRuntime, (JSONObject)localObject))
      {
        ...
        ((CommercialDrainageManager)paramAppRuntime.getManager(199)).a(l);
        if (QLog.isColorLevel()) {
  ...
  private void b()
  {
    try
    {
      ...
      if (j > 0)
      {
        ...
        while (i < j)
        {
          ((VipGrayConfigHelper.VipGrayConfigListener)this.jdField_b_of_type_JavaUtilList.get(i)).a();
          i += 1;
        }
      }
      return;
  ...
  public void a(URLImageView paramURLImageView, boolean paramBoolean1, long paramLong1, long paramLong2, int paramInt, boolean paramBoolean2, String paramString)
  {
    ...
    paramURLImageView.setURLDrawableDownListener(new ajuc(this, paramString, paramURLImageView));
  }
  ...
  public void a(VipGrayConfigHelper.VipGrayConfigListener paramVipGrayConfigListener)
  {
    ...
    try
    {
      if (!this.jdField_b_of_type_JavaUtilList.contains(paramVipGrayConfigListener)) {
        this.jdField_b_of_type_JavaUtilList.add(paramVipGrayConfigListener);
      }
      return;
    }
    finally
    {
      paramVipGrayConfigListener = finally;
  ...
  public void a(AppRuntime paramAppRuntime, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localObject = VasQuickUpdateManager.a(paramAppRuntime, "vip_personal_card.json", true, null);
        if (localObject == null)
        {
          if (!QLog.isColorLevel()) {
            continue;
  ...
  public boolean a(AppRuntime paramAppRuntime, JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      if ((TextUtils.isEmpty(str)) || (IndividuationConfigInfo.a(str, "7.6.0.3525"))) {
        break label434;
      }
      i = 0;
    }
    ...
    if (i != 0)
    {
      ...
      if (paramJSONObject.has("maxVersion"))
      {
        ...
        {
          j = i;
          if (!IndividuationConfigInfo.a("7.6.0.3525", str)) {
            j = 0;
          }
        }
      }
