...
public class JceImpl
  ...
  implements IJce
{
  private static String SVIP_HANDLER = ((ISVIPHandlerProxy)QRoute.api(ISVIPHandlerProxy.class)).getImplClassName();
  private static final String TAG = "JceProtocol";
  private String mCmd;
  ...
  public JceImpl(String paramString1, String paramString2)
  {
    ...
    if (!Cmd2HandlerMapHelper.a(paramString2)) {
      Cmd2HandlerMapHelper.a(paramString2, new String[] { SVIP_HANDLER });
    }
  }
  ...
  public JceImpl(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    this.mCmd = paramString2;
    this.mServantName = paramString1;
    Cmd2HandlerMapHelper.a(paramString2, SVIP_HANDLER);
  ...
  public void request(String paramString, JceStruct paramJceStruct1, JceStruct paramJceStruct2, BusinessObserver paramBusinessObserver, boolean paramBoolean)
  {
    ...
    localObject = VasUtil.a();
    paramBusinessObserver = ((ISVIPHandler)((AppInterface)localObject).getBusinessHandler(SVIP_HANDLER)).createToServiceMsg(this.mCmd, paramBusinessObserver, paramBoolean);
