  ...
  extends PagerAdapter
{
  ...
  public Object instantiateItem(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    {
      IHeaderView localIHeaderView = QQVipPubHeaderFactory.a(localQQVipMsgInfo, this.a.getActivity());
      ...
      if (localQQVipMsgInfo != null)
      {
        ...
        localTextView.setText(TimeFormatterUtils.a(this.a.getActivity(), 3, localQQVipMsgInfo.msgTime * 1000L));
        ...
        if (localLayoutParams1 == null) {
          localObject = new RelativeLayout.LayoutParams(-2, AIOUtils.a(14.0F, this.a.getResources()));
        }
      ...
      for (;;)
      {
        ...
        if ((localIHeaderView != null) && (localQQVipMsgInfo != null)) {
          localIHeaderView.a(localQQVipMsgInfo, this.a.getActivity(), paramInt);
        }
