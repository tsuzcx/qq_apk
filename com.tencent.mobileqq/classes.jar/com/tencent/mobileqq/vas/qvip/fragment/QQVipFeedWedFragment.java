...
public class QQVipFeedWedFragment
  ...
  implements View.OnClickListener, bhsm
{
  ...
  private bhsq jdField_a_of_type_Bhsq;
  ...
  private boolean a()
  {
    return this.jdField_a_of_type_AndroidViewView.getContext().getSharedPreferences("QQVipFeedWedFragment", 0).getBoolean(bhsf.a().getCurrentAccountUin(), true);
  }
  
  private void c()
  {
    this.jdField_a_of_type_ComTencentMobileqqVasQvipViewQQVipHeadLayout = ((QQVipHeadLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131374743));
    this.jdField_a_of_type_ComTencentMobileqqVasQvipViewQQVipWebview = ((QQVipWebview)this.jdField_a_of_type_AndroidViewView.findViewById(2131374746));
  ...
  private void d()
  {
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131370784));
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_AndroidViewView.getContext().getSharedPreferences("QQVipFeedWedFragment", 0).edit().putBoolean(bhsf.a().getCurrentAccountUin(), false).commit();
  }
  
  private void f()
  {
    this.jdField_a_of_type_ComTencentMobileqqGamecenterViewQQGamePubViewpager = ((QQGamePubViewpager)this.jdField_a_of_type_ComTencentMobileqqVasQvipViewQQVipHeadLayout.findViewById(2131366721));
    this.jdField_a_of_type_ComTencentMobileqqVasQvipViewQQVipIndicator = ((QQVipIndicator)this.jdField_a_of_type_ComTencentMobileqqVasQvipViewQQVipHeadLayout.findViewById(2131372397));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_ComTencentMobileqqVasQvipViewQQVipHeadLayout.findViewById(2131364147));
    this.jdField_a_of_type_AndroidWidgetButton.setClickable(true);
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_ComTencentMobileqqVasQvipViewQQVipHeadLayout.findViewById(2131368095));
    this.jdField_d_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqVasQvipViewQQVipHeadLayout.findViewById(2131379243);
    Object localObject = getResources().getDrawable(2130849775);
    ...
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() >= 1))
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        {
          albi.a().a(localQQVipMsgInfo.arkAppName);
          this.jdField_b_of_type_JavaUtilList.add(localQQVipMsgInfo.arkAppName);
        }
      }
      albi.a().a(this.jdField_b_of_type_JavaUtilList);
      this.jdField_d_of_type_AndroidViewView.setVisibility(8);
      this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(0);
      this.jdField_a_of_type_Bhse = new bhse(this, null);
      this.jdField_a_of_type_ComTencentMobileqqGamecenterViewQQGamePubViewpager.setAdapter(this.jdField_a_of_type_Bhse);
      ...
      this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqVasQvipViewQQVipHeadLayout.findViewById(2131374742);
  ...
  private void g()
  {
    ...
    this.jdField_a_of_type_Bhsq = new bhsc(this, this.jdField_a_of_type_AndroidViewView.getContext(), getActivity(), bhsf.a(), this.jdField_a_of_type_ComTencentMobileqqVasQvipViewQQVipWebview);
    this.jdField_a_of_type_Bhsq.setmTimeBeforeLoadUrl(System.currentTimeMillis());
    new bieb(this.jdField_a_of_type_Bhsq).a(null, amwn.a(), null);
    this.jdField_a_of_type_ComTencentMobileqqVasQvipViewQQVipWebview = ((QQVipWebview)this.jdField_a_of_type_Bhsq.getWebView());
  ...
  {
    if ((this.jdField_a_of_type_Bhse != null) && (paramInt == this.jdField_a_of_type_Bhse.getCount() - 1)) {
      b();
    }
  ...
  public void a(View paramView)
  {
    ...
    this.c = paramView.findViewById(2131369933);
    paramView = getResources().getDrawable(2130850150);
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(2131694992);
    ...
    this.jdField_a_of_type_ComTencentMobileqqGamecenterViewNavBarQQGamePub.setOnItemSelectListener(new bhsd(this));
  }
  ...
  public void b()
  {
    try
    {
      ...
      localIntent.putExtra("uinname", getString(2131694992));
  ...
  {
    this.jdField_a_of_type_AndroidViewView = paramLayoutInflater.inflate(2131561936, paramViewGroup, false);
  ...
  public void onDestroy()
  {
    ...
    for (;;)
    {
      ...
      catch (Throwable localThrowable)
      {
        ...
        if (this.jdField_a_of_type_Bhsq == null) {
          continue;
        }
        this.jdField_a_of_type_Bhsq.a();
  ...
  {
    if (this.jdField_b_of_type_JavaUtilList != null) {
      albi.a().b(this.jdField_b_of_type_JavaUtilList);
    }
    super.onDestroyView();
  }
  ...
  {
    super.onResume();
    if ((this.jdField_a_of_type_Bhse != null) && (this.jdField_a_of_type_ComTencentMobileqqGamecenterViewQQGamePubViewpager != null) && (this.jdField_a_of_type_ComTencentMobileqqGamecenterViewQQGamePubViewpager.getCurrentItem() == this.jdField_a_of_type_Bhse.getCount() - 1) && (this.jdField_a_of_type_Bhse.getCount() >= 2)) {
      this.jdField_a_of_type_ComTencentMobileqqGamecenterViewQQGamePubViewpager.setCurrentItem(this.jdField_a_of_type_Bhse.getCount() - 2);
    }
  }
