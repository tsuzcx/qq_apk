  ...
  implements bhsh
{
  ...
  private void a(Activity paramActivity, int paramInt, QQVipMsgInfo paramQQVipMsgInfo)
  {
    ...
    try
    {
      bhsf.a(118, paramQQVipMsgInfo, paramInt);
      return;
    }
  ...
  public void a(QQVipMsgInfo paramQQVipMsgInfo, Activity paramActivity, int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)LayoutInflater.from(getContext()).inflate(2131561881, this, false));
    ...
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131378658));
    this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_b_of_type_JavaLangString);
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131370784);
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131365549).setOnClickListener(new bhso(this, paramActivity, paramInt, paramQQVipMsgInfo));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(new bhsp(this, paramActivity, paramInt, paramQQVipMsgInfo));
