...
public class ExtendFriendResourceUtil
{
  ...
  public static android.graphics.Bitmap a(String paramString, android.graphics.BitmapFactory.Options paramOptions)
  {
    ...
    //   5: astore_2
    //   6: aload_0
    //   7: invokestatic 74	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   10: ifne +58 -> 68
    //   13: new 76	java/io/File
    //   16: dup
    //   17: aload_0
    //   18: invokespecial 79	java/io/File:<init>	(Ljava/lang/String;)V
    //   21: astore_2
    //   22: aload_2
    //   23: invokevirtual 83	java/io/File:exists	()Z
    //   26: ifeq +139 -> 165
    //   29: new 85	java/io/BufferedInputStream
    //   32: dup
    //   33: new 87	java/io/FileInputStream
    //   36: dup
    //   37: aload_2
    //   38: invokespecial 90	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   41: invokespecial 93	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   44: astore_3
    //   45: aload_3
    //   46: astore_2
    //   47: aload_3
    //   48: aconst_null
    //   49: aload_1
    //   50: invokestatic 99	android/graphics/BitmapFactory:decodeStream	(Ljava/io/InputStream;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   53: astore_1
    //   54: aload_1
    //   55: astore_0
    //   56: aload_0
    ...
    //   59: ifnull +9 -> 68
    //   62: aload_3
    //   63: invokevirtual 104	java/io/InputStream:close	()V
    //   66: aload_0
    //   67: astore_2
    //   68: aload_2
    //   69: areturn
    ...
    //   86: aload_0
    //   87: aastore
    //   88: invokestatic 112	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   91: aload_1
    //   92: invokestatic 117	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   95: aload 4
    //   97: astore_2
    //   98: aload_3
    //   99: ifnull -31 -> 68
    //   102: aload_3
    //   103: invokevirtual 104	java/io/InputStream:close	()V
    //   106: aconst_null
    //   107: areturn
    //   108: astore_0
    //   109: aconst_null
    ...
    //   127: aload_0
    //   128: aastore
    //   129: invokestatic 112	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   132: aload_1
    //   133: invokestatic 117	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   136: aload 4
    //   138: astore_2
    //   139: aload_3
    //   140: ifnull -72 -> 68
    //   143: aload_3
    //   144: invokevirtual 104	java/io/InputStream:close	()V
    //   147: aconst_null
    //   148: areturn
    //   149: astore_0
    //   150: aconst_null
    ...
    //   156: ifnull +7 -> 163
    //   159: aload_2
    //   160: invokevirtual 104	java/io/InputStream:close	()V
    //   163: aload_0
    //   164: athrow
    //   165: ldc 106
    //   167: iconst_1
    ...
    //   176: aload_0
    //   177: aastore
    //   178: invokestatic 112	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   181: invokestatic 122	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   184: aconst_null
    //   185: areturn
    //   186: astore_1
    //   187: aload_0
