  ...
  implements IPullToRefresh<T>
{
  ...
  private PullToRefreshBase.OnPullEventListener<T> jdField_a_of_type_ComTencentMobileqqExtendfriendPulltorefreshPullToRefreshBase$OnPullEventListener;
  private PullToRefreshBase.OnRefreshListener2<T> jdField_a_of_type_ComTencentMobileqqExtendfriendPulltorefreshPullToRefreshBase$OnRefreshListener2;
  private PullToRefreshBase.OnRefreshListener<T> jdField_a_of_type_ComTencentMobileqqExtendfriendPulltorefreshPullToRefreshBase$OnRefreshListener;
  ...
  {
    switch (PullToRefreshBase.5.a[a().ordinal()])
    {
    default: 
  ...
  private final void a(int paramInt, long paramLong1, long paramLong2, PullToRefreshBase.OnSmoothScrollFinishedListener paramOnSmoothScrollFinishedListener)
  {
    ...
    for (int i = getScrollY();; i = getScrollX())
    {
      ...
      if (i != paramInt)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqExtendfriendPulltorefreshPullToRefreshBase$SmoothScrollRunnable = new PullToRefreshBase.SmoothScrollRunnable(this, i, paramInt, paramLong1, paramOnSmoothScrollFinishedListener);
        if (paramLong2 <= 0L) {
          break;
        }
  ...
  private boolean e()
  {
    switch (PullToRefreshBase.5.c[this.jdField_a_of_type_ComTencentMobileqqExtendfriendPulltorefreshPullToRefreshBase$Mode.ordinal()])
    {
    }
    do
    {
  ...
  private void i()
  {
    ...
    default: 
      ...
      switch (PullToRefreshBase.5.c[this.jdField_b_of_type_ComTencentMobileqqExtendfriendPulltorefreshPullToRefreshBase$Mode.ordinal()])
      {
      default: 
        if (this.g)
        {
  ...
  final void a(PullToRefreshBase.State paramState, boolean... paramVarArgs)
  {
    ...
    switch (PullToRefreshBase.5.b[this.jdField_a_of_type_ComTencentMobileqqExtendfriendPulltorefreshPullToRefreshBase$State.ordinal()])
    {
    }
    for (;;)
    {
