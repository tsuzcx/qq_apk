  ...
  implements Runnable
{
  ...
  private aqgs jdField_a_of_type_Aqgs;
  private boolean jdField_a_of_type_Boolean = true;
  private final int jdField_b_of_type_Int;
  private long jdField_b_of_type_Long = -1L;
  private int c = -1;
  
  public PullToRefreshBase$SmoothScrollRunnable(PullToRefreshBase paramPullToRefreshBase, int paramInt1, int paramInt2, long paramLong, aqgs paramaqgs)
  {
    this.jdField_b_of_type_Int = paramInt1;
    this.jdField_a_of_type_Int = paramInt2;
    this.jdField_a_of_type_AndroidViewAnimationInterpolator = PullToRefreshBase.a(paramPullToRefreshBase);
    this.jdField_a_of_type_Long = paramLong;
    this.jdField_a_of_type_Aqgs = paramaqgs;
  }
  ...
  public void run()
  {
    if (this.jdField_b_of_type_Long == -1L)
    {
      ...
      aqgw.a(this.this$0, this);
    }
    label128:
    while (this.jdField_a_of_type_Aqgs == null)
    {
      return;
