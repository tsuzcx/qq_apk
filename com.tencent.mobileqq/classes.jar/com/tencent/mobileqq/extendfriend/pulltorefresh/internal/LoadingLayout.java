  ...
  extends LoadingLayoutBase
{
  ...
  public LoadingLayout(Context paramContext, PullToRefreshBase.Mode paramMode, PullToRefreshBase.Orientation paramOrientation, TypedArray paramTypedArray)
  {
    ...
    {
    default: 
      LayoutInflater.from(paramContext).inflate(2131559707, this);
      this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)findViewById(2131367079));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131373711));
      this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131373709));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131373710));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131373706));
      ...
      default: 
        if (paramOrientation == PullToRefreshBase.Orientation.VERTICAL)
        {
          ...
          this.jdField_a_of_type_JavaLangCharSequence = paramContext.getString(2131695281);
          this.jdField_b_of_type_JavaLangCharSequence = paramContext.getString(2131695282);
          this.c = paramContext.getString(2131695283);
    ...
    for (;;)
    {
      ...
      g();
      return;
      LayoutInflater.from(paramContext).inflate(2131559706, this);
      break;
      if (paramOrientation == PullToRefreshBase.Orientation.VERTICAL) {}
      for (i = 48;; i = 3)
      {
        localLayoutParams.gravity = i;
        this.jdField_a_of_type_JavaLangCharSequence = paramContext.getString(2131695278);
        this.jdField_b_of_type_JavaLangCharSequence = paramContext.getString(2131695279);
        this.c = paramContext.getString(2131695280);
        break;
      }
      i = 5;
      break label179;
  ...
  public final int a()
  {
    switch (LoadingLayout.1.a[this.jdField_a_of_type_ComTencentMobileqqExtendfriendPulltorefreshPullToRefreshBase$Orientation.ordinal()])
    {
    default: 
