  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      localObject = assx.a("expand_voice_animation.json");
    ...
    for (int i = ViewUtils.dip2px(19.0F);; i = ViewUtils.dip2px(17.0F))
    {
      try
      {
        ...
        LottieComposition.Factory.fromInputStream(this.this$0.getContext(), (InputStream)localObject, new asup(this, j, i));
        return;
      }
      ...
      localObject = asrl.a("expand_voice_animation2.json");
