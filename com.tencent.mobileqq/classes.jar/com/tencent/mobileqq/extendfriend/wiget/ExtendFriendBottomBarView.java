  ...
  extends FrameLayout
{
  ...
  public ExtendFriendBottomBarView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    inflate(paramContext, 2131561198, this);
    a();
  }
  
  private void a()
  {
    this.jdField_a_of_type_Int = AIOUtils.a(66.0F, getResources());
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131363788));
    ...
    ImageView localImageView = (ImageView)findViewById(2131363030);
  ...
  private void b()
  {
    ...
    ReportController.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009E2E", "0X8009E2E", 0, 0, "", "", "", "");
  }
  ...
  void a(View paramView)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWidgetQQBlurView.setDisableBlurDrawableRes(2130851407);
      ...
      if (j > 0)
      {
        ...
        if (i < k)
        {
          ...
          if (i < j)
          {
            ...
            localImageView.setImageDrawable(Util.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str));
