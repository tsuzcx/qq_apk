  ...
  implements View.OnTouchListener
{
  ...
  public ExtendFriendFeedView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    LayoutInflater.from(paramContext).inflate(2131561084, this, true);
    this.jdField_a_of_type_Float = AIOUtils.dp2px(4.0F, getResources());
  }
  
  private Bitmap a(String paramString)
  {
    Object localObject1 = aror.c;
    if ((localObject1 != null) && (localObject1.length > 0)) {
      for (;;)
      {
        try
        {
          ...
          if (i == -1)
          {
            str = aror.a("expand_feed_bg_default.png");
        ...
        try
        {
          if (paramString.isRecycled())
          {
            ...
            localObject1 = paramString;
            localObject2 = aror.a(str, (BitmapFactory.Options)localObject2);
  ...
  private GradientDrawable a(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_AndroidGraphicsDrawableGradientDrawable == null) {
      this.jdField_a_of_type_AndroidGraphicsDrawableGradientDrawable = arpd.a(paramInt, 0.0F, 0.0F, this.jdField_a_of_type_Float, this.jdField_a_of_type_Float);
    }
    for (;;)
    {
