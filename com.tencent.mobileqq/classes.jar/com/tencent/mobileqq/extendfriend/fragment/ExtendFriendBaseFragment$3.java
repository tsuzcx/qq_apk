  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    while (((Iterator)localObject3).hasNext()) {
      ((ArrayList)localObject2).add(((ExtendFriendBaseFragment.ExposureFeedInfo)((Iterator)localObject3).next()).jdField_a_of_type_ComTencentMobileqqExtendfriendBeanStrangerInfo.mUin);
    }
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      localObject3 = ((ExtendFriendBaseFragment.ExposureFeedInfo)localObject2).jdField_a_of_type_ComTencentMobileqqExtendfriendBeanStrangerInfo.mUin;
