  ...
  implements Runnable
{
  ...
  public void run()
  {
    if ((this.this$0.jdField_a_of_type_Askg == null) || (this.this$0.jdField_a_of_type_Askg.a() <= 0) || (this.this$0.jdField_a_of_type_AndroidSupportV4AppFragmentActivity == null) || (this.this$0.jdField_a_of_type_AndroidSupportV7WidgetLinearLayoutManager == null) || (this.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null) || (this.this$0.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.isFinishing())) {
      return;
    }
    ...
    while (((Iterator)localObject3).hasNext()) {
      ((ArrayList)localObject2).add(((asid)((Iterator)localObject3).next()).jdField_a_of_type_Asht.mUin);
    }
    ...
    {
      localObject2 = (asid)((Iterator)localObject1).next();
      localObject3 = ((asid)localObject2).jdField_a_of_type_Asht.mUin;
      if (!ExtendFriendBaseFragment.a(this.this$0).containsKey(localObject3))
      {
        ((asid)localObject2).jdField_a_of_type_Long = System.currentTimeMillis();
