  ...
  implements View.OnClickListener
{
  ...
  TextWatcher jdField_a_of_type_AndroidTextTextWatcher = new anre(this);
  private View jdField_a_of_type_AndroidViewView;
  private CompoundButton.OnCheckedChangeListener jdField_a_of_type_AndroidWidgetCompoundButton$OnCheckedChangeListener = new anri(this);
  public EditText a;
  private ImageView jdField_a_of_type_AndroidWidgetImageView;
  private RelativeLayout jdField_a_of_type_AndroidWidgetRelativeLayout;
  private TextView jdField_a_of_type_AndroidWidgetTextView;
  private ayls jdField_a_of_type_Ayls;
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean, mmn parammmn)
  {
    for (int i = 1;; i = 0) {
      try
      {
  ...
  private void d()
  {
    Object localObject = ((anoe)getActivity().app.getManager(264)).a();
    if (localObject != null)
    {
      this.jdField_a_of_type_AndroidWidgetEditText.setHint(((anoh)localObject).jdField_f_of_type_JavaLangString);
      this.jdField_a_of_type_Int = ((anoh)localObject).jdField_f_of_type_Int;
    }
    localObject = getActivity().app;
    String str = ((QQAppInterface)localObject).c();
    this.jdField_b_of_type_AndroidWidgetImageView.setImageDrawable(azwp.a((AppInterface)localObject, 1, str));
  }
  
  private void e()
  {
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)this.jdField_a_of_type_AndroidViewView.findViewById(2131300159));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131309655));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131298012));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131311633));
    this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131300744);
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131304137);
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = new BitmapDrawable(antw.a(aciy.a(27.0F, getResources()), -15550475, 1.0F));
    this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = new BitmapDrawable(antw.a(aciy.a(27.0F, getResources()), -16777216, 0.08F));
    ...
    this.jdField_d_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131311632);
    this.jdField_e_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131313441);
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131302353));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131312661));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131302345));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131312664));
    this.jdField_a_of_type_ComTencentWidgetSwitch = ((Switch)this.jdField_a_of_type_AndroidViewView.findViewById(2131313432));
    this.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131313431));
    ...
    this.jdField_a_of_type_ComTencentMobileqqExtendfriendWigetExtendFriendVoiceView = ((ExtendFriendVoiceView)this.jdField_a_of_type_AndroidViewView.findViewById(2131302401));
    ...
    this.jdField_a_of_type_ComTencentMobileqqExtendfriendWigetExtendFriendVoiceView.setDeleteIconEnable(true, new anrf(this));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setOnTouchListener(new anrg(this));
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidViewView.getViewTreeObserver().addOnGlobalLayoutListener(new anrh(this));
  ...
  private void h()
  {
    ...
    int n = aciy.a(96.0F, getResources());
  ...
  private void l()
  {
    a(aciy.a(114.0F, getResources()) - ImmersiveUtils.getStatusBarHeight(getActivity()));
  }
  ...
  public ExtendFriendProfileEditFragment.ExtendFriendInfo a()
  {
    ...
    if ((this.jdField_a_of_type_Ayls != null) && ((this.jdField_a_of_type_Ayls instanceof AudioInfo)))
    {
      localExtendFriendInfo.jdField_b_of_type_Int = (((AudioInfo)this.jdField_a_of_type_Ayls).duration / 1000);
  ...
  public void a(QQAppInterface paramQQAppInterface, anpv paramanpv)
  {
    Object localObject;
    boolean bool;
    if ((bajr.a()) && (bajr.b(paramQQAppInterface)))
    {
      ...
      if (paramanpv.mVipHide) {
        break label164;
      }
      bool = true;
      ((Switch)localObject).setChecked(bool);
      this.jdField_a_of_type_ComTencentWidgetSwitch.setOnCheckedChangeListener(this.jdField_a_of_type_AndroidWidgetCompoundButton$OnCheckedChangeListener);
      this.jdField_b_of_type_AndroidWidgetTextView.setText(paramanpv.mNickName);
      this.jdField_c_of_type_AndroidWidgetTextView.setText(String.valueOf(paramanpv.mPopularity));
    ...
    label164:
    label170:
    for (int i = 2130844209;; i = 2130844210)
    {
      ((ImageView)localObject).setImageResource(i);
      bajr.a(paramanpv, this.jdField_d_of_type_AndroidWidgetImageView);
      this.jdField_d_of_type_AndroidWidgetImageView.setTag(paramanpv);
      this.jdField_e_of_type_AndroidViewView.setVisibility(0);
      this.jdField_d_of_type_AndroidViewView.setVisibility(0);
      awqx.b(paramQQAppInterface, "dc00898", "", "", "0X8009F0E", "0X8009F0E", 0, 0, "", "", "", "");
      return;
      bool = false;
      break;
    }
  ...
  public void a(ExtendFriendProfileEditFragment.ExtendFriendInfo paramExtendFriendInfo)
  {
    ...
    if (this.jdField_c_of_type_Boolean)
    {
      ...
      if (this.jdField_b_of_type_JavaLangString.indexOf("file_md5=") <= 0) {
        this.jdField_a_of_type_ComTencentMobileqqExtendfriendWigetExtendFriendVoiceView.setVoiceFileMD5(bcdu.a(this.jdField_b_of_type_JavaLangString));
      }
    }
  ...
  {
    this.jdField_a_of_type_Ayls = paramAudioInfo;
  ...
  public void b()
  {
    Object localObject = ((anoe)getActivity().app.getManager(264)).a();
    if (localObject == null) {}
    for (int i = 11000;; i = ((anoh)localObject).jdField_c_of_type_Int * 1000)
    {
      ...
      abju.a(getActivity(), (Intent)localObject, PublicTransFragmentActivity.class, AudioRecordFragment.class, 1003);
      return;
    }
  }
  ...
  {
    this.jdField_a_of_type_AndroidViewView = paramLayoutInflater.inflate(2131495163, paramViewGroup, false);
    e();
    d();
