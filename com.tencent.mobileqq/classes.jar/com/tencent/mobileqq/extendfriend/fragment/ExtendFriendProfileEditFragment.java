  ...
  implements View.OnClickListener
{
  ...
  TextWatcher jdField_a_of_type_AndroidTextTextWatcher = new aqee(this);
  public View a;
  private CompoundButton.OnCheckedChangeListener jdField_a_of_type_AndroidWidgetCompoundButton$OnCheckedChangeListener = new aqei(this);
  public ImageView a;
  public LinearLayout a;
  private RelativeLayout jdField_a_of_type_AndroidWidgetRelativeLayout;
  private TextView jdField_a_of_type_AndroidWidgetTextView;
  private bbpc jdField_a_of_type_Bbpc;
  public ETTextView a;
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean, nac paramnac)
  {
    for (int i = 1;; i = 0) {
      try
      {
        ...
        bdqa.a(arrayOfByte, 0, l);
        arrayOfByte[4] = 0;
        bdqa.a(arrayOfByte, 5, (short)1);
        bdqa.a(arrayOfByte, 7, 42276);
        bdqa.a(arrayOfByte, 9, (short)2);
        if (paramBoolean)
        {
          bdqa.a(arrayOfByte, 11, (short)i);
  ...
  private void d()
  {
    Object localObject = ((aqbg)getActivity().app.getManager(264)).a();
    if (localObject != null)
    {
      this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setHint(((aqbj)localObject).jdField_f_of_type_JavaLangString);
      this.jdField_a_of_type_Int = ((aqbj)localObject).jdField_f_of_type_Int;
    }
    localObject = getActivity().app;
    String str = ((QQAppInterface)localObject).c();
    this.jdField_d_of_type_AndroidWidgetImageView.setImageDrawable(bdbk.a((AppInterface)localObject, 1, str));
  }
  
  private void e()
  {
    this.jdField_a_of_type_ComTencentWidgetXEditTextEx = ((XEditTextEx)this.jdField_b_of_type_AndroidViewView.findViewById(2131365843));
    this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setVisibility(8);
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_b_of_type_AndroidViewView.findViewById(2131375948));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131363607));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131378038));
    this.jdField_d_of_type_AndroidViewView = this.jdField_b_of_type_AndroidViewView.findViewById(2131366464);
    this.jdField_c_of_type_AndroidViewView = this.jdField_b_of_type_AndroidViewView.findViewById(2131370092);
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = new BitmapDrawable(aqgy.a(aepi.a(27.0F, getResources()), -15550475, 1.0F));
    this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = new BitmapDrawable(aqgy.a(aepi.a(27.0F, getResources()), -16777216, 0.08F));
    ...
    this.jdField_e_of_type_AndroidViewView = this.jdField_b_of_type_AndroidViewView.findViewById(2131378037);
    this.jdField_f_of_type_AndroidViewView = this.jdField_b_of_type_AndroidViewView.findViewById(2131380039);
    this.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131368121));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131379160));
    this.jdField_e_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131368113));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131379163));
    this.jdField_a_of_type_ComTencentWidgetSwitch = ((Switch)this.jdField_b_of_type_AndroidViewView.findViewById(2131380030));
    this.jdField_f_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131380029));
    this.jdField_a_of_type_ComEtrumpMixlayoutETTextView = ((ETTextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131365860));
    ...
    this.jdField_a_of_type_AndroidViewView = this.jdField_b_of_type_AndroidViewView.findViewById(2131379484);
    ...
    this.jdField_a_of_type_ComTencentMobileqqExtendfriendWigetExtendFriendVoiceView = ((ExtendFriendVoiceView)this.jdField_b_of_type_AndroidViewView.findViewById(2131368170));
    ...
    this.jdField_a_of_type_ComTencentMobileqqExtendfriendWigetExtendFriendVoiceView.setDeleteIconEnable(true, new aqef(this));
    ...
    this.jdField_c_of_type_AndroidWidgetImageView.setOnTouchListener(new aqeg(this));
    this.jdField_c_of_type_AndroidWidgetImageView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_b_of_type_AndroidViewView.findViewById(2131369612));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_b_of_type_AndroidViewView.findViewById(2131375966));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131368692));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131368702));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131378984));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131378660));
    ...
    this.jdField_b_of_type_AndroidViewView.getViewTreeObserver().addOnGlobalLayoutListener(new aqeh(this));
  ...
  private void h()
  {
    ...
    int n = aepi.a(96.0F, getResources());
  ...
  private void l()
  {
    a(aepi.a(114.0F, getResources()) - ImmersiveUtils.getStatusBarHeight(getActivity()));
  }
  ...
  public ExtendFriendProfileEditFragment.ExtendFriendInfo a()
  {
    ...
    if ((this.jdField_a_of_type_Bbpc != null) && ((this.jdField_a_of_type_Bbpc instanceof AudioInfo)))
    {
      localExtendFriendInfo.jdField_b_of_type_Int = (((AudioInfo)this.jdField_a_of_type_Bbpc).duration / 1000);
  ...
  public void a(QQAppInterface paramQQAppInterface, aqcx paramaqcx)
  {
    Object localObject;
    boolean bool;
    if ((VipUtils.a()) && (VipUtils.b(paramQQAppInterface)))
    {
      ...
      this.jdField_a_of_type_ComTencentWidgetSwitch.setOnCheckedChangeListener(this.jdField_a_of_type_AndroidWidgetCompoundButton$OnCheckedChangeListener);
      this.jdField_d_of_type_AndroidWidgetTextView.setText(paramaqcx.mNickName);
      this.jdField_e_of_type_AndroidWidgetTextView.setText(String.valueOf(paramaqcx.mPopularity));
    ...
    label164:
    label170:
    for (int i = 2130844708;; i = 2130844709)
    {
      ((ImageView)localObject).setImageResource(i);
      VipUtils.a(paramaqcx, this.jdField_f_of_type_AndroidWidgetImageView);
      this.jdField_f_of_type_AndroidWidgetImageView.setTag(paramaqcx);
      this.jdField_f_of_type_AndroidViewView.setVisibility(0);
      this.jdField_e_of_type_AndroidViewView.setVisibility(0);
      azqs.b(paramQQAppInterface, "dc00898", "", "", "0X8009F0E", "0X8009F0E", 0, 0, "", "", "", "");
      return;
      bool = false;
      break;
    }
  ...
  public void a(ExtendFriendProfileEditFragment.ExtendFriendInfo paramExtendFriendInfo)
  {
    if (this.jdField_c_of_type_Boolean)
    {
      ...
      if (!TextUtils.isEmpty(paramExtendFriendInfo.jdField_a_of_type_JavaLangString))
      {
        ...
        this.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setText(new bamp(bkaw.d(paramExtendFriendInfo.jdField_a_of_type_JavaLangString), 3, 24));
        ...
        if (this.jdField_b_of_type_JavaLangString.indexOf("file_md5=") <= 0) {
          this.jdField_a_of_type_ComTencentMobileqqExtendfriendWigetExtendFriendVoiceView.setVoiceFileMD5(bflr.a(this.jdField_b_of_type_JavaLangString));
        }
      }
  ...
  {
    this.jdField_a_of_type_Bbpc = paramAudioInfo;
  ...
  public void b()
  {
    Object localObject = ((aqbg)getActivity().app.getManager(264)).a();
    if (localObject == null) {}
    for (int i = 11000;; i = ((aqbj)localObject).jdField_c_of_type_Int * 1000)
    {
      ...
      adpn.a(getActivity(), (Intent)localObject, PublicTransFragmentActivity.class, AudioRecordFragment.class, 1003);
      return;
    }
  }
  ...
  public void b(ExtendFriendProfileEditFragment.ExtendFriendInfo paramExtendFriendInfo)
  {
    ...
    if ((TextUtils.isEmpty(paramExtendFriendInfo.jdField_c_of_type_JavaLangString)) || (TextUtils.isEmpty(paramExtendFriendInfo.jdField_d_of_type_JavaLangString)))
    {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130844703);
      this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new aqek(this));
      this.jdField_a_of_type_ComTencentMobileqqExtendfriendFragmentExtendFriendProfileEditFragment$ExtendFriendInfo = paramExtendFriendInfo;
      return;
    }
    ...
    if (paramExtendFriendInfo.jdField_a_of_type_Long == 2L)
    {
      i = 2130844751;
      label132:
      localTextView.setText(bddf.a(str, false, i, 2131298187, 2131298186, getActivity(), getActivity().app, null));
      if (paramExtendFriendInfo.jdField_a_of_type_Long != 2L) {
        break label224;
      }
      this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(new aqel(this, paramExtendFriendInfo));
      break;
      i = 2130844752;
      break label132;
      label224:
      if (paramExtendFriendInfo.jdField_a_of_type_Long == 0L)
      {
        ...
        this.jdField_b_of_type_AndroidWidgetTextView.setText(2131699267);
        a(true);
      }
      else if (paramExtendFriendInfo.jdField_a_of_type_Long == 1L)
      {
        this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
        this.jdField_b_of_type_AndroidWidgetTextView.setText(2131699268);
        a(false);
      }
      else
      {
  ...
  public void onClick(View paramView)
  {
    ...
    aqgz.a(getActivity(), this.jdField_a_of_type_ComTencentMobileqqExtendfriendFragmentExtendFriendProfileEditFragment$ExtendFriendInfo.g, this.jdField_a_of_type_ComTencentMobileqqExtendfriendFragmentExtendFriendProfileEditFragment$ExtendFriendInfo.jdField_d_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqExtendfriendFragmentExtendFriendProfileEditFragment$ExtendFriendInfo.jdField_c_of_type_JavaLangString);
  }
  
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    this.jdField_b_of_type_AndroidViewView = paramLayoutInflater.inflate(2131560939, paramViewGroup, false);
    e();
    d();
    if ((getActivity() != null) && (aqgz.c(getActivity().app)))
    {
      aqgz.b(getActivity().app, false);
