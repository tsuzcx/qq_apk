...
public class CacheData
{
  ...
  private int a()
  {
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      ...
      for (int i = 0;; i = ((CacheData.TagCache)localIterator.next()).jdField_a_of_type_JavaUtilList.size() + i)
      {
        j = i;
  ...
  public CacheData.TagCache a()
  {
    ...
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      ...
      if (this.jdField_a_of_type_JavaUtilList.size() > 0) {
        localObject1 = (CacheData.TagCache)this.jdField_a_of_type_JavaUtilList.get(0);
      }
    }
    return localObject1;
  }
  ...
  public void a(CacheData.TagCache paramTagCache, boolean paramBoolean1, boolean paramBoolean2, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilList.contains(paramTagCache)) {
      this.jdField_a_of_type_JavaUtilList.remove(paramTagCache);
    }
    if ((paramTagCache == null) || (paramTagCache.jdField_a_of_type_JavaUtilList.size() == 0)) {}
    for (;;)
    {
      return;
  ...
  public String toString()
  {
    ...
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      ...
      while (i < this.jdField_a_of_type_JavaUtilList.size())
      {
        ...
        localStringBuilder.append("index_").append(i).append("=").append(localTagCache.toString());
        i += 1;
      }
    }
    localStringBuilder.append("]");
 ...
 * Qualified Name:     com.tencent.mobileqq.extendfriend.fragment.CacheData
