...
class ExtendFriendProfileEditFragment$1
  implements TextWatcher
{
  int jdField_a_of_type_Int = 0;
  String jdField_a_of_type_JavaLangString;
  
  ExtendFriendProfileEditFragment$1(ExtendFriendProfileEditFragment paramExtendFriendProfileEditFragment) {}
  ...
  public void afterTextChanged(Editable paramEditable)
  {
    ...
    for (;;)
    {
      ...
      if (!ExtendFriendProfileEditFragment.a(this.jdField_a_of_type_ComTencentMobileqqExtendfriendFragmentExtendFriendProfileEditFragment).d()) {
 ...
 * Qualified Name:     com.tencent.mobileqq.extendfriend.fragment.ExtendFriendProfileEditFragment.1
