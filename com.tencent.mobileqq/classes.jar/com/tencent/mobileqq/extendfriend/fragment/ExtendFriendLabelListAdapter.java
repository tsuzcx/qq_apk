  ...
  extends BaseAdapter
{
  ...
  private List<LabelInfo> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      return localView;
      localObject = (ExtendFriendLabelListAdapter.ViewHolder)paramView.getTag();
      localView = paramView;
      paramView = (View)localObject;
      break;
      label249:
      i = Color.parseColor(localLabelInfo.b);
      if (TextUtils.isEmpty(localLabelInfo.c)) {
        paramView.jdField_a_of_type_AndroidWidgetTextView.setBackgroundDrawable(a(a(0.2F, i), a(0.2F, i)));
      } else {
        paramView.jdField_a_of_type_AndroidWidgetTextView.setBackgroundDrawable(a(Color.parseColor(localLabelInfo.c), Color.parseColor(localLabelInfo.c)));
      }
    }
  }
}
 ...
 * Qualified Name:     com.tencent.mobileqq.extendfriend.fragment.ExtendFriendLabelListAdapter
