  ...
  extends BusinessHandler
{
  ...
  private void a(oidb_0xe03.MatchUinData paramMatchUinData, ChatFriendInfo paramChatFriendInfo)
  {
      ...
      while (i < paramMatchUinData.rpt_school_info.size())
      {
        if (((oidb_0xe03.schoolInfo)paramMatchUinData.rpt_school_info.get(i)).str_school_name.has())
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.d("ExtendFriendHandlerExtendFriendLimitChat", 2, "schoolInfo. " + ((SchoolInfo)localObject2).toString());
          }
        }
        i += 1;
      }
    ...
    if (paramMatchUinData.rpt_tag.has())
    {
      ...
      while (i < paramMatchUinData.rpt_tag.size())
      {
        if (((oidb_0xe03.ProfileTagInfo)paramMatchUinData.rpt_tag.get(i)).bytes_tag.has())
        {
          ...
          localPersonalTag.jdField_a_of_type_Int = k;
          localPersonalTag.jdField_a_of_type_JavaLangString = ((String)localObject2);
          ((ArrayList)localObject1).add(localPersonalTag);
        }
        i += 1;
      }
    }
    ...
    {
      paramChatFriendInfo.k = paramMatchUinData;
      if (!QLog.isColorLevel()) {
        break;
      }
      QLog.d("ExtendFriendHandlerExtendFriendLimitChat", 2, "ChatFriendInfo. " + paramChatFriendInfo.toString());
      return;
      i = -1;
      break label751;
      localObject1 = "";
  ...
  private boolean a(List<Long> paramList1, int paramInt1, int paramInt2, List<Long> paramList2, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localMessageCache = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache();
        localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin();
      }
      ...
      if (localIterator.hasNext())
      {
        ...
        localObject3 = localMessageCache.c(String.valueOf(localLong), (String)localObject1);
        localObject2 = localObject3;
        if (localObject3 == null) {
          localObject2 = localMessageCache.a(String.valueOf(localLong), (String)localObject1, false);
        }
  ...
  private void g(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      paramFromServiceMsg = (ExtendFriendManager)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(QQManagerFactory.EXTEND_FRIEND_MANAGER);
  ...
  private void i(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      paramObject = (ExtendFriendManager)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(QQManagerFactory.EXTEND_FRIEND_MANAGER);
      if (paramObject != null) {
  ...
  private void j(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    try
    {
      localObject = new oidb_0xe09.RspBody();
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = (Integer)paramToServiceMsg.getAttribute("reqTag");
      ...
      a(paramObject, j + k, k, paramToServiceMsg, ((Integer)localObject).intValue());
      return;
      if (!QLog.isColorLevel()) {
        break label404;
      }
    ...
    notifyUI(19, true, new Object[] { paramToServiceMsg, localObject, paramObject });
  }
  ...
  private void k(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    try
    {
      ...
      if (i == 0)
      {
        ...
        {
          this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().a(paramObject, paramFromServiceMsg, (byte[])localObject, false);
          if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      try
      {
        ...
        if (localRspBody.uint32_flare_switch.has())
        {
          ...
          if ((k == 1) && (i == 1))
          {
            if (((ExtendFriendManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.EXTEND_FRIEND_MANAGER)).c())
            {
              paramToServiceMsg = "1";
  ...
  private void m(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((j == 0) || (j == 33))
    {
      ...
      if (j == 33)
      {
        ...
        localColdPalaceHelper.a(1, paramObject);
        localColdPalaceHelper.a(2, str2);
        localColdPalaceHelper.a(0, paramToServiceMsg);
        ...
        if (j == 0) {
          this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().a(AppConstants.MATCH_CHAT_UIN, i, str1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
        }
        if (j != 0) {
          break label456;
        }
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    if ((paramMessageRecord != null) && ((paramMessageRecord instanceof MessageForLimitChatConfirm)))
    {
      ...
      {
        localObject1 = new MatchNotifyInfo();
        ((MatchNotifyInfo)localObject1).jdField_a_of_type_Boolean = paramMessageRecord.bEnterMsg;
        ((MatchNotifyInfo)localObject1).jdField_a_of_type_Int = paramMessageRecord.leaveChatType;
        ((MatchNotifyInfo)localObject1).jdField_a_of_type_Long = paramMessageRecord.timeStamp;
        ((MatchNotifyInfo)localObject1).jdField_a_of_type_JavaLangString = paramMessageRecord.frienduin;
        ((MatchNotifyInfo)localObject1).jdField_b_of_type_JavaLangString = paramMessageRecord.SenderNickName;
        ((MatchNotifyInfo)localObject1).d = paramMessageRecord.c2cExpiredTime;
        ((MatchNotifyInfo)localObject1).jdField_b_of_type_Int = paramMessageRecord.leftChatTime;
        ((MatchNotifyInfo)localObject1).jdField_c_of_type_JavaLangString = paramMessageRecord.tipsWording;
        ((MatchNotifyInfo)localObject1).jdField_c_of_type_Int = paramMessageRecord.matchExpiredTime;
        ((MatchNotifyInfo)localObject1).jdField_b_of_type_Long = paramMessageRecord.readyTs;
        QLog.i("ExtendFriendHandlerExtendFriendLimitChat", 2, "HandleC2CConfirmOrCancelMsg  info：" + ((MatchNotifyInfo)localObject1).toString());
        i = 1;
        j = i;
    ...
    for (;;)
    {
      ...
      if (l2 != -1L)
      {
        ...
        localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgHandler().a().a();
        if (localObject2 != null) {
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgHandler().a("c2c_processor").a(paramMessageRecord);
        for (j = i;; j = 0)
        {
          if (j != 0) {
            break label406;
  ...
  public void a(String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 1, 2131694457, 0).a();
    ...
    new JceProtocol("QC.UniBusinessLogicServer.UniBusinessLogicObj", "QCUniBusinessLogic.UniSetExtFriend").a("UniSetExtFriend", new UniSetExtFriendReq(JceProtocol.a(), new UniBusinessItem(304, paramInt4, ""), new ExtendFriend(paramInt2)), new UniSetExtFriendRsp(), new ExtendFriendHandler.1(this, paramString1, paramInt4, paramInt2), true);
    try
    {
  ...
  public void a(String paramString1, byte[] paramArrayOfByte, int paramInt, String paramString2, long paramLong, String paramString3, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      localReqBody.bytes_req_buff.set(ByteStringMicro.copyFrom(GdtGeneralManager.a().a()));
  ...
  public void a(submsgtype0x128.MsgBody paramMsgBody, long paramLong)
  {
    boolean bool;
    Object localObject;
    label73:
    ...
    if (paramLong == 296L)
    {
      ...
      ((MatchInfo)localObject).jdField_a_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin();
      ((MatchInfo)localObject).jdField_a_of_type_ArrayOfByte = paramMsgBody.bytes_sig.get().toByteArray();
      if (!paramMsgBody.uint64_match_uin.has()) {
        break label413;
      }
      str = String.valueOf(paramMsgBody.uint64_match_uin.get());
      ((MatchInfo)localObject).jdField_b_of_type_JavaLangString = str;
      if (!paramMsgBody.bytes_tips_wording.has()) {
        break label421;
      }
      str = paramMsgBody.bytes_tips_wording.get().toStringUtf8();
      ((MatchInfo)localObject).jdField_c_of_type_JavaLangString = str;
      if (!paramMsgBody.uint64_time_stamp.has()) {
        break label428;
      }
      paramLong = paramMsgBody.uint64_time_stamp.get();
      ((MatchInfo)localObject).jdField_a_of_type_Long = paramLong;
      if (!paramMsgBody.uint32_match_expired_time.has()) {
        break label433;
      }
      i = paramMsgBody.uint32_match_expired_time.get();
      label152:
      ((MatchInfo)localObject).jdField_a_of_type_Int = i;
      if (!paramMsgBody.bytes_nick.has()) {
        break label439;
      }
      str = paramMsgBody.bytes_nick.get().toStringUtf8();
      label181:
      ((MatchInfo)localObject).d = str;
      if ((!paramMsgBody.msg_tag.has()) || (!paramMsgBody.msg_tag.uint32_tag_id.has())) {
        break label453;
      }
      ((MatchInfo)localObject).jdField_b_of_type_Int = paramMsgBody.msg_tag.uint32_tag_id.get();
      if (!paramMsgBody.msg_tag.bytes_tag.has()) {
        break label446;
      }
      str = paramMsgBody.msg_tag.bytes_tag.get().toStringUtf8();
      label254:
      ((MatchInfo)localObject).jdField_f_of_type_JavaLangString = str;
      label261:
      if (!paramMsgBody.msg_match_uin_data.has()) {
        break label489;
      }
      ((MatchInfo)localObject).jdField_a_of_type_ComTencentMobileqqExtendfriendBeanChatFriendInfo = new ChatFriendInfo();
      ((MatchInfo)localObject).jdField_a_of_type_ComTencentMobileqqExtendfriendBeanChatFriendInfo.jdField_a_of_type_JavaLangString = ((MatchInfo)localObject).jdField_b_of_type_JavaLangString;
      a(paramMsgBody.msg_match_uin_data, ((MatchInfo)localObject).jdField_a_of_type_ComTencentMobileqqExtendfriendBeanChatFriendInfo);
      label309:
      if ((!((ExtendFriendManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.EXTEND_FRIEND_MANAGER)).f()) || (((MatchInfo)localObject).jdField_b_of_type_Int == 10000)) {
        break label555;
      }
      localObject = (ExtendFriendLimitChatManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.EXTEND_FRIEND_LIMIT_CHAT_MANAGER);
      if (!paramMsgBody.uint64_match_uin.has()) {
        break label519;
      }
    }
    label519:
    for (String str = String.valueOf(paramMsgBody.uint64_match_uin.get());; str = "0")
    {
      paramMsgBody = paramMsgBody.bytes_sig.get().toByteArray();
      if (paramMsgBody == null) {
        break label527;
      }
      ((ExtendFriendLimitChatManager)localObject).a(str, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramMsgBody);
      return;
      bool = false;
      break;
      label413:
      ...
      break label254;
      label453:
      ((MatchInfo)localObject).jdField_b_of_type_Int = 1;
      QLog.e("ExtendFriendHandlerExtendFriendLimitChat", 2, "msg_tag id empty in push bUnlimitMatchPush：" + bool);
      break label261;
      label489:
      QLog.e("ExtendFriendHandlerExtendFriendLimitChat", 2, "msg_match_uin_data in push bUnlimitMatchPush：" + bool);
      break label309;
    }
    label527:
    QLog.e("ExtendFriendHandlerExtendFriendLimitChat", 1, "signature is null in push , matchUin = " + str);
    return;
    label555:
    str = "";
    ...
    {
      paramMsgBody = "0";
      QLog.d("ExtendFriendHandlerExtendFriendLimitChat", 2, "string_report_id EMPTY bUnlimitMatchPush：" + bool);
    }
    ((MatchInfo)localObject).e = paramMsgBody;
    if (QLog.isColorLevel()) {
      QLog.d("ExtendFriendHandlerExtendFriendLimitChat", 2, new Object[] { "handleGetUnlimitMatchOfflinePush push matchInfo = ", localObject + "bUnlimitMatchPush：" + bool });
    }
    paramMsgBody = (ExtendFriendLimitChatManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.EXTEND_FRIEND_LIMIT_CHAT_MANAGER);
    if (paramMsgBody != null) {
      paramMsgBody.a();
    }
    if (bool)
    {
      notifyUI(16, true, new Object[] { localObject });
      return;
    }
    ((ExtendFriendManager)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(QQManagerFactory.EXTEND_FRIEND_MANAGER)).a((MatchInfo)localObject);
    notifyUI(23, true, new Object[] { ((MatchInfo)localObject).jdField_b_of_type_JavaLangString });
    return;
    label760:
    QLog.e("ExtendFriendHandlerExtendFriendLimitChat", 2, "handleGetUnlimitMatchOfflinePush failed bUnlimitMatchPush ：" + bool);
    if (bool)
    {
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    try
    {
      ...
      for (int i = 1;; i = 0)
      {
        ...
        ((PBUInt32Field)localObject2).set(i);
        localObject2 = (ExtendFriendManager)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(QQManagerFactory.EXTEND_FRIEND_MANAGER);
        if (localObject2 != null)
        {
          localObject2 = ((ExtendFriendManager)localObject2).a();
          if (localObject2 != null)
          {
  ...
  {
    ExtendFriendLocationInfo localExtendFriendLocationInfo = paramExtendFriendLocationInfo;
    if (paramExtendFriendLocationInfo == null) {
      localExtendFriendLocationInfo = ((ExtendFriendManager)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(QQManagerFactory.EXTEND_FRIEND_MANAGER)).a();
    }
    ...
    try
    {
      ...
      paramExtendFriendLocationInfo.uint64_uin.set(a((String)localObject, "openSignalBomb"));
      ...
      if (((ExtendFriendManager)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(QQManagerFactory.EXTEND_FRIEND_MANAGER) != null) && (localExtendFriendLocationInfo != null))
      {
        localObject = new oidb_0xe03.LBSInfo();
        oidb_0xe03.GPS localGPS = new oidb_0xe03.GPS();
        localGPS.int32_lon.set(localExtendFriendLocationInfo.jdField_b_of_type_Int);
        localGPS.int32_lat.set(localExtendFriendLocationInfo.jdField_a_of_type_Int);
        localGPS.int32_alt.set(localExtendFriendLocationInfo.jdField_c_of_type_Int);
        localGPS.int32_type.set(localExtendFriendLocationInfo.d);
        ((oidb_0xe03.LBSInfo)localObject).msg_gps.set(localGPS);
        paramExtendFriendLocationInfo.msg_lbs_info.set((MessageMicro)localObject);
    ...
    {
      QLog.d("ExtendFriendHandlerExtendFriendLimitChat", 2, "openSignalBomb. error = " + paramExtendFriendLocationInfo);
    }
    return false;
  }
  ...
  public boolean a(ExtendFriendLocationInfo paramExtendFriendLocationInfo)
  {
    try
    {
      ...
      paramExtendFriendLocationInfo = makeOIDBPkg("OidbSvc.0xe67", 3687, 1, localReqBody.toByteArray());
    ...
    {
      QLog.d("ExtendFriendHandlerExtendFriendLimitChat", 2, "EnterExtendFriend. error = " + paramExtendFriendLocationInfo);
    }
    return false;
  }
  ...
  public boolean a(List<Long> paramList, int paramInt)
  {
    boolean bool = false;
    if (paramList != null) {
      bool = a(paramList, 0, 50, null, paramInt);
    }
    return bool;
  }
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      for (;;)
      {
        StrangerInfo localStrangerInfo1;
        try
        {
          ...
          localStrangerInfo1 = new StrangerInfo();
          localStrangerInfo1.mUin = String.valueOf(localStrangerInfo.uint64_uin.get());
          localStrangerInfo1.mNickName = localStrangerInfo.bytes_nick.get().toStringUtf8();
          localStrangerInfo1.mGender = localStrangerInfo.uint32_gender.get();
          if (localStrangerInfo.uint32_is_my_like.get() != 1) {
            break label1730;
          }
          bool4 = true;
          localStrangerInfo1.mLiked = bool4;
          localStrangerInfo1.mAvailLikeCount = localStrangerInfo.uint32_my_left_like_count.get();
          if (localStrangerInfo.uint32_addfri_status.get() != 1) {
            break label1736;
          }
          bool4 = true;
          localStrangerInfo1.mAddFriendVerified = bool4;
          localStrangerInfo1.mPopularity = localStrangerInfo.uint32_popularity.get();
          localStrangerInfo1.mDeclaration = localStrangerInfo.bytes_declaration.get().toStringUtf8();
          localStrangerInfo1.mVoiceUrl = localStrangerInfo.bytes_voice_url.get().toStringUtf8();
          localStrangerInfo1.mVoiceDuration = localStrangerInfo.uint32_voice_duration.get();
          if (localStrangerInfo.uint32_vote_switch.get() != 0) {
            break label1742;
          }
          bool4 = true;
          localStrangerInfo1.mbAllowStrangerVote = bool4;
          localStrangerInfo1.mStrRecomTrace = localStrangerInfo.str_recom_trace.get();
          localStrangerInfo1.voiceCode = localStrangerInfo.bytes_voice_code.get().toByteArray();
          ...
          localStrangerInfo1.fontId = paramToServiceMsg.fontid.get();
          localStrangerInfo1.fontType = paramToServiceMsg.fonttype.get();
          localStrangerInfo1.clothesId = paramToServiceMsg.itemid.get();
          if (!TextUtils.isEmpty(localStrangerInfo1.mDeclaration))
          {
            localStrangerInfo1.mDeclaration = localStrangerInfo1.mDeclaration.replace('\n', ' ');
            localStrangerInfo1.mDeclaration = localStrangerInfo1.mDeclaration.trim();
          }
          if (localStrangerInfo.uint32_show_vip_info_flag.get() != 0) {
            break label1748;
          }
          bool4 = true;
          localStrangerInfo1.mVipHide = bool4;
          if (localStrangerInfo.uint32_bigvip_open.get() != 0) {
            break label1754;
          }
          bool4 = true;
          localStrangerInfo1.mBigVipHide = bool4;
          localStrangerInfo1.mBigVipLevel = localStrangerInfo.uint32_bigvip_level.get();
          localStrangerInfo1.mVipType = localStrangerInfo.uint32_vip_flag.get();
          localStrangerInfo1.mVipLevel = localStrangerInfo.uint32_svip_level.get();
          localStrangerInfo1.mTemplateId = localStrangerInfo.uint32_vipicon_id.get();
          ...
          label659:
          localStrangerInfo1.mAlumbasicdata = paramToServiceMsg;
          localStrangerInfo1.mAge = localStrangerInfo.uint32_age.get();
          localStrangerInfo1.mLabelInfos = new ArrayList();
          Object localObject3;
          if (localStrangerInfo.rpt_label_info.has())
          {
            ...
            {
              localObject3 = new StrangerInfo.LabelInfo();
              ((StrangerInfo.LabelInfo)localObject3).jdField_a_of_type_Long = ((ExtendFriendSquareInfo.labelInfo)localStrangerInfo.rpt_label_info.get().get(i)).uint64_label_id.get();
              ...
              label812:
              ((StrangerInfo.LabelInfo)localObject3).jdField_a_of_type_JavaLangString = paramToServiceMsg;
              localStrangerInfo1.mLabelInfos.add(localObject3);
              i += 1;
              continue;
            }
          }
          localStrangerInfo1.mSchoolInfos = new ArrayList();
          if (localStrangerInfo.rpt_school_info.has())
          {
            i = 0;
            if (i < localStrangerInfo.rpt_school_info.get().size())
            {
              localObject3 = new StrangerInfo.SchoolInfo();
              ((StrangerInfo.SchoolInfo)localObject3).jdField_a_of_type_JavaLangString = ((ExtendFriendSquareInfo.schoolInfo)localStrangerInfo.rpt_school_info.get().get(i)).str_school_id.get();
              ((StrangerInfo.SchoolInfo)localObject3).jdField_a_of_type_Long = ((ExtendFriendSquareInfo.schoolInfo)localStrangerInfo.rpt_school_info.get().get(i)).uint64_state.get();
              ...
              ((StrangerInfo.SchoolInfo)localObject3).jdField_b_of_type_JavaLangString = paramToServiceMsg;
              if (QLog.isColorLevel()) {
                QLog.d("ExtendFriendHandler", 2, "handleGetSquareStrangerList: schoolId " + ((StrangerInfo.SchoolInfo)localObject3).jdField_a_of_type_JavaLangString + " schoolName " + ((StrangerInfo.SchoolInfo)localObject3).jdField_b_of_type_JavaLangString + " authState " + ((StrangerInfo.SchoolInfo)localObject3).jdField_a_of_type_Long);
              }
              localStrangerInfo1.mSchoolInfos.add(localObject3);
              i += 1;
              continue;
            }
          }
          if (QLog.isColorLevel()) {
            QLog.d("ExtendFriendHandler", 2, "handleGetSquareStrangerList: " + localStrangerInfo1.mUin + " " + localStrangerInfo.uint32_vip_flag.get() + " " + localStrangerInfo.uint32_svip_level.get());
          }
          if ((TextUtils.isEmpty(localStrangerInfo1.mNickName)) && (localStrangerInfo1.mAlumbasicdata == null)) {
            break label1252;
          }
          localArrayList.add(localStrangerInfo1);
          continue;
          ExtendFriendReport.a().c(paramFromServiceMsg.isSuccess(), paramFromServiceMsg.getResultCode());
        }
        catch (Exception paramToServiceMsg)
        {
          if (QLog.isColorLevel()) {
        ...
        return;
        if (QLog.isColorLevel()) {
          QLog.w("ExtendFriendHandler", 2, String.format("handleGetSquareStrangerList nick name is empty, uin=%s", new Object[] { localStrangerInfo1.mUin }));
        }
      }
      paramToServiceMsg = new MatchFeedInfo();
      ...
      if (n <= 12)
      {
        ...
        {
          paramToServiceMsg.jdField_a_of_type_JavaUtilList.add(((StrangerInfo)((List)localObject1).get(i)).mUin);
          i += 1;
        }
      }
    ...
    for (;;)
    {
      ...
      if (i < n)
      {
        ...
        break label1781;
        if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
          ((ExtendFriendLimitChatManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.EXTEND_FRIEND_LIMIT_CHAT_MANAGER)).a(true, paramToServiceMsg);
        }
        if (QLog.isColorLevel()) {
  ...
  public boolean b()
  {
    try
    {
      ...
      Object localObject2 = (ExtendFriendManager)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(QQManagerFactory.EXTEND_FRIEND_MANAGER);
      if (localObject2 != null)
      {
        localObject2 = ((ExtendFriendManager)localObject2).a();
        if (localObject2 != null)
  ...
  public boolean b(String paramString)
  {
    ...
    try
    {
      ...
      paramString = (ExtendFriendManager)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(QQManagerFactory.EXTEND_FRIEND_MANAGER);
      if (paramString != null)
      {
        ...
        if (paramString != null)
        {
          ...
          localGPS.int32_type.set(paramString.d);
          localLBSInfo.msg_gps.set(localGPS);
          localReqBody.msg_lbs_info.set(localLBSInfo);
      ...
      catch (InvalidProtocolBufferMicroException paramObject)
      {
        try
        {
          ...
          if ((!TextUtils.isEmpty((CharSequence)localObject3)) || (!TextUtils.isEmpty((CharSequence)localObject4)))
          {
            ...
            paramFromServiceMsg = new StrangerInfo.SchoolInfo();
          ...
          if (localRspBody.rpt_label_info.has())
          {
            ...
            if (i < localRspBody.rpt_label_info.get().size())
            {
              ...
              ((StrangerInfo.LabelInfo)localObject1).jdField_a_of_type_JavaLangString = paramFromServiceMsg;
          ...
          if (!paramToServiceMsg.extraData.getBoolean("onlyStrangerInfo", false))
          {
            ...
            notifyUI(3, bool2, new Object[] { paramObject, Integer.valueOf(paramToServiceMsg.extraData.getInt("getStrangerInfoSeq", 0)) });
          }
  ...
  public void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int i = parseOIDBPkg(paramFromServiceMsg, paramObject, localRspBody);
    if (QLog.isColorLevel()) {
      QLog.d("ExtendFriendHandlerexpand.enter.", 2, new Object[] { "handlePlusSettingResponse. result = ", Integer.valueOf(i) });
    }
    if (paramToServiceMsg != null) {}
    for (boolean bool1 = paramToServiceMsg.extraData.getBoolean("request_from_login", false);; bool1 = false)
    {
      ...
      if (i == 0) {
        if (localRspBody.uint64_allow_kuolie.has())
        {
          ...
          if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
          {
            ...
            ExpandFriendChatUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, bool2, j, i, paramToServiceMsg, l2);
            if (bool2)
            {
              notifyUI(18, true, null);
              QLog.i("ExtendFriendHandlerexpand.enter.", 1, " refresh entry");
              ((ExtendFriendManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.EXTEND_FRIEND_MANAGER)).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
            }
          }
          ...
          if (QLog.isColorLevel()) {
            QLog.d("ExtendFriendHandlerexpand.enter.", 2, "handlePlusSettingResponse. lShow = " + l1 + " leftCount = " + i + " funcName = " + paramToServiceMsg + " expireTime=" + l2 + " chatTime:" + j + " voiceMatch: " + l3 + " FromLogginStep " + bool1);
          }
      ...
      do
      {
        ...
        bool2 = false;
        break label184;
        QLog.d("ExtendFriendHandlerexpand.enter.", 2, "handlePlusSettingResponse.  by voicematch not notify");
        break label257;
        l3 = -1L;
        break label278;
        bool3 = false;
      ...
      label513:
      QLog.d("ExtendFriendHandlerexpand.enter.", 2, "handlePlusSettingResponse.  false result：" + i);
      return;
    }
  }
  ...
  public void f(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (localRspBody.enum_matchopcode.has())
    {
      ...
      paramToServiceMsg = (ExtendFriendManager)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(QQManagerFactory.EXTEND_FRIEND_MANAGER);
      if (paramToServiceMsg != null) {
      ...
      ((MatchInfo)localObject2).jdField_a_of_type_ArrayOfByte = ((oidb_0xe03.MatchInfo)localObject1).bytes_sig.get().toByteArray();
    ...
    for (paramToServiceMsg = ((oidb_0xe03.MatchInfo)localObject1).string_report_id.get();; paramToServiceMsg = "")
    {
      ...
      if (localRspBody.msg_match_info.msg_tag.has()) {
        if (localRspBody.msg_match_info.msg_tag.uint32_tag_id.has())
        {
          ...
          if (((MatchInfo)localObject2).jdField_a_of_type_ComTencentMobileqqExtendfriendBeanChatFriendInfo == null)
          {
            ((MatchInfo)localObject2).jdField_a_of_type_ComTencentMobileqqExtendfriendBeanChatFriendInfo = new ChatFriendInfo();
            ((MatchInfo)localObject2).jdField_a_of_type_ComTencentMobileqqExtendfriendBeanChatFriendInfo.jdField_a_of_type_JavaLangString = ((MatchInfo)localObject2).jdField_b_of_type_JavaLangString;
          }
          a(localRspBody.msg_match_info.msg_match_uin_data, ((MatchInfo)localObject2).jdField_a_of_type_ComTencentMobileqqExtendfriendBeanChatFriendInfo);
          label695:
          if (QLog.isColorLevel()) {
            QLog.d("ExtendFriendHandlerExtendFriendLimitChat", 2, new Object[] { "handleMatchResponse type =" + m, " uin = ", str, ", match_op = ", Integer.valueOf(i), " retCode = ", Integer.valueOf(j), " matchInfo = ", ((MatchInfo)localObject2).toString(), " errMsg = ", paramObject });
          }
      ...
      for (;;)
      {
        ...
        {
          ((ExtendFriendManager)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(QQManagerFactory.EXTEND_FRIEND_MANAGER)).i();
          if (QLog.isColorLevel()) {
 ...
 * Qualified Name:     com.tencent.mobileqq.extendfriend.network.ExtendFriendHandler
