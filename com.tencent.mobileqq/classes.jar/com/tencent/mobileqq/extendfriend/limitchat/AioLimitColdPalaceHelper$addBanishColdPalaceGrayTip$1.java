...
public final class AioLimitColdPalaceHelper$addBanishColdPalaceGrayTip$1
  implements Runnable
{
  public AioLimitColdPalaceHelper$addBanishColdPalaceGrayTip$1(armh paramarmh) {}
  ...
  public final void run()
  {
    ...
    for (Object localObject1 = ((SessionInfo)localObject1).curFriendUin;; localObject1 = null)
    {
      ...
      localObject2 = ((BaseActivity)localObject2).getResources().getString(2131698128);
      BaseActivity localBaseActivity = this.this$0.a();
      if (localBaseActivity == null) {
        Intrinsics.throwNpe();
      }
      auyo.a(localQQAppInterface, (String)localObject1, i, str, (String)localObject2, 459802, localBaseActivity.getResources().getString(2131698129), 57, false, null, -1);
      bcef.b(null, "dc00898", "", "", "0X800B2C2", "0X800B2C2", 0, 0, "", "", "", "");
      return;
    }
  }
}
