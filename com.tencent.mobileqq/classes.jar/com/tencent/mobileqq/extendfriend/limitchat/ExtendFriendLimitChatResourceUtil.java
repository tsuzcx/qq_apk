...
public class ExtendFriendLimitChatResourceUtil
{
  ...
  public static void a(String paramString)
  {
    ...
    SharedPreUtils.u(BaseApplicationImpl.getApplication().getBaseContext(), str, paramString);
    if (QLog.isColorLevel())
    {
      if (paramString != null) {
  ...
  public static boolean a(ExtendFriendConfig paramExtendFriendConfig)
  {
    boolean bool = false;
    if ((paramExtendFriendConfig != null) && (paramExtendFriendConfig.a != null))
    {
      String str = a();
      paramExtendFriendConfig = (ExpandConfigManager.LimitChatRes)paramExtendFriendConfig.a.get(str);
      if (paramExtendFriendConfig != null)
      {
        paramExtendFriendConfig = paramExtendFriendConfig.c;
        str = b();
        if (TextUtils.isEmpty(str))
        {
          bool = true;
          if ((!TextUtils.isEmpty(paramExtendFriendConfig)) && (!paramExtendFriendConfig.equalsIgnoreCase(str))) {
            bool = true;
          }
        }
      }
    ...
    for (;;)
    {
      if ((bool) && (paramExtendFriendConfig != null)) {
        a(paramExtendFriendConfig);
      }
      if (QLog.isColorLevel()) {
      ...
      bool = false;
      break;
      paramExtendFriendConfig = null;
    }
  }
  
  private static boolean a(String[] paramArrayOfString)
  {
    return ExtendFriendResourceUtil.a(a(paramArrayOfString));
  }
  ...
  {
    String str = BaseApplicationImpl.getApplication().getRuntime().getAccount();
    str = SharedPreUtils.s(BaseApplicationImpl.getApplication().getBaseContext(), str);
    if (QLog.isColorLevel())
    {
      if (str != null) {
  ...
  {
    return String.format("%s/matchChat", new Object[] { ExtendFriendResourceDownloader.a() });
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.extendfriend.limitchat.ExtendFriendLimitChatResourceUtil
