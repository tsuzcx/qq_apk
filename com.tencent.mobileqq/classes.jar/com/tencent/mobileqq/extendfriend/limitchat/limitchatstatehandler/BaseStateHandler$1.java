...
public class BaseStateHandler$1
  implements Runnable
{
  public BaseStateHandler$1(atbi paramatbi, String paramString1, String paramString2) {}
  
  public void run()
  {
    atbf.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), this.a, this.b);
  }
}
