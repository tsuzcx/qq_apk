...
public class BaseStateHandler$1
  implements Runnable
{
  public BaseStateHandler$1(asrw paramasrw, String paramString1, String paramString2) {}
  
  public void run()
  {
    asrt.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), this.a, this.b);
  }
}
