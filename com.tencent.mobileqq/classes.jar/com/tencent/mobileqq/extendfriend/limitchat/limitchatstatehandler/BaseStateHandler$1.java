...
public class BaseStateHandler$1
  implements Runnable
{
  public BaseStateHandler$1(aqbx paramaqbx, String paramString1, String paramString2) {}
  
  public void run()
  {
    aqbv.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), this.a, this.b);
  }
}
