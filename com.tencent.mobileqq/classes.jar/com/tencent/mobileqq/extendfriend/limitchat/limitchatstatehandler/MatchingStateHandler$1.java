...
public class MatchingStateHandler$1
  implements Runnable
{
  public MatchingStateHandler$1(aslp paramaslp) {}
  
  public void run()
  {
    Object localObject = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
    avsr.b((QQAppInterface)localObject, this.this$0.a.jdField_b_of_type_JavaLangString);
    avsr.a((QQAppInterface)localObject, this.this$0.a, this.this$0.a.a, 2);
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (this.this$0.a.jdField_b_of_type_Int >= 2)
      {
        ...
        ((bajk)localObject).b(this.this$0.a.jdField_b_of_type_JavaLangString);
        ((bajk)localObject).d();
      }
