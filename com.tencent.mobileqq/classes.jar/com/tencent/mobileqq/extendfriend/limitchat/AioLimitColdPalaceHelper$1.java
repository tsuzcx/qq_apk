  ...
  extends MessageObserver
{
  public void onMessageRecordAdded(@Nullable List<MessageRecord> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if (!ExpandFriendChatUtil.a((MessageRecord)localObject1))
      {
        ...
        {
          localObject1 = this.a;
          ((AioLimitColdPalaceHelper)localObject1).a(((AioLimitColdPalaceHelper)localObject1).b() + 1);
  ...
  public void onUpdateSendMsgError(@Nullable String paramString1, int paramInt1, int paramInt2, @Nullable SendMessageHandler paramSendMessageHandler, long paramLong1, long paramLong2, @Nullable String paramString2)
  {
 ...
 * Qualified Name:     com.tencent.mobileqq.extendfriend.limitchat.AioLimitColdPalaceHelper.1
