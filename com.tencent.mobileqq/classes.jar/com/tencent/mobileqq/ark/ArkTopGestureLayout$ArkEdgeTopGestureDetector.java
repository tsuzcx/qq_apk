  ...
  extends TopGestureLayout.TopGestureDetector
{
  ...
  {
    if (!this.a.isGestureIdle())
    {
      if (this.a.isGestureEnd()) {
        return false;
      }
      ...
      {
        if ((paramFloat1 < 0.0F) && (paramFloat2 < 0.5F) && (this.a.mOnFlingGesture != null))
        {
          this.a.setGestureFlag(-1);
          if (!ArkTopGestureLayout.a(this.a))
          {
      ...
      else if ((this.a.hasGestureFlag(2)) && (paramFloat1 > 0.0F) && (paramFloat2 < 0.5F) && (this.a.mOnFlingGesture != null))
      {
        this.a.setGestureFlag(-1);
        if (!ArkTopGestureLayout.b(this.a)) {
