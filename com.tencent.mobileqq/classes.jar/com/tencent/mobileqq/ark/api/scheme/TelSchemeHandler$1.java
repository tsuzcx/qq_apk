  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    localQQCustomDialog.setPositiveButton(2131691600, new TelSchemeHandler.1.1(this, localQQCustomDialog));
    localQQCustomDialog.setNegativeButton(2131690728, new TelSchemeHandler.1.2(this, localQQCustomDialog));
    try
    {
