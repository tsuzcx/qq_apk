  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if ((localObject1 != null) && (((WeakReference)localObject1).get() != null) && (!TextUtils.isEmpty(this.b)))
    {
      try
      {
        localObject1 = new JSONObject(this.b).optJSONObject("params");
      ...
      Object localObject2 = GdtDeviceInfoHelper.a((Context)this.a.get(), localParams);
      if ((localObject2 != null) && (((GdtDeviceInfoHelper.Result)localObject2).a != null))
      {
        ...
        {
          ((IArkAPIService)QRoute.api(IArkAPIService.class)).postArkNotify(this.c, "get_device_info_callback", localObject2.toString());
