...
final class ArkMultiProcUtil$6
  extends IArkDelegateNet
{
  public void download(String paramString, boolean paramBoolean1, boolean paramBoolean2, HashMap<String, String> paramHashMap, File paramFile, IArkDelegateNetCallback paramIArkDelegateNetCallback)
  {
    ...
    for (paramFile = paramFile.getAbsolutePath();; paramFile = "")
    {
      ...
      ChooseImageIPCModule.a().a("callDownload", (Bundle)localObject, new ArkMultiProcUtil.6.3(this, paramString, paramIArkDelegateNetCallback));
      return;
      str = "";
      break;
      paramHashMap = "";
    ...
    label175:
    Object localObject = ((DownloaderFactory)BaseApplicationImpl.getApplication().getRuntime().getManager(QQManagerFactory.DOWNLOADER_FACTORY)).a(1);
    paramFile = new DownloadTask(paramString, new File(paramFile));
    ...
    ((DownloaderInterface)localObject).a(paramFile, new ArkMultiProcUtil.6.4(this, paramString, paramIArkDelegateNetCallback), paramHashMap);
  }
  ...
  public void sendAppMsg(String paramString1, String paramString2, int paramInt1, int paramInt2, IArkDelegateNetCallback paramIArkDelegateNetCallback)
  {
    ...
    if (1 != BaseApplicationImpl.sProcessId)
    {
      ...
      ChooseImageIPCModule.a().a("callSendAppMsg", (Bundle)localObject, new ArkMultiProcUtil.6.1(this, paramString1, paramString2, paramIArkDelegateNetCallback, paramInt2));
      return;
    }
    ...
    ((ArkAppSSO)localObject).a(paramString1, paramString2, paramInt1, paramInt2, new ArkMultiProcUtil.6.2(this, paramIArkDelegateNetCallback));
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes8.jar
 * Qualified Name:     com.tencent.mobileqq.ark.multiproc.ArkMultiProcUtil.6
