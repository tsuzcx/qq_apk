  ...
  implements IPreCreatePluginChecker
{
  ...
  protected void a(String paramString)
  {
    ...
    if (this.jdField_a_of_type_AndroidAppDialog == null)
    {
      ...
      localTextView4.setOnClickListener(new ArkPlugin.1(this));
      localTextView3.setOnClickListener(new ArkPlugin.2(this));
      ...
      for (;;)
      {
        ...
        for (i = j;; i = 1)
        {
          ...
          if (((String)localObject1).equals("ask"))
          {
            ...
            a(paramString.getString(2131690241));
  ...
  protected void b()
  {
    ...
    QQToast.a(localActivity, HardCodeUtil.a(2131700795), 0).a();
  }
