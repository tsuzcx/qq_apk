  ...
  extends BaseAdapter
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      ...
      paramViewGroup.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130842202);
    ...
    for (;;)
    {
      ...
      if ((localArkAiInfo != null) && (!TextUtils.isEmpty(localArkAiInfo.d))) {
        ArkAppCenter.a(localArkAiInfo.d, new aakt(this, paramViewGroup));
      }
      return paramView;
