...
public class ArkAiScrollBar
{
  ...
  private Runnable jdField_a_of_type_JavaLangRunnable = new aazo(this);
  ...
  public boolean a()
  {
    ...
    {
      BaseChatPie localBaseChatPie = this.jdField_a_of_type_ComTencentMobileqqArkArkRecommendController.a();
      this.jdField_a_of_type_AndroidWidgetHorizontalScrollView = ((HorizontalScrollView)LayoutInflater.from(localBaseChatPie.jdField_a_of_type_AndroidContentContext).inflate(2130968711, null));
      this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidWidgetHorizontalScrollView.findViewById(2131363342));
      this.jdField_a_of_type_AndroidViewView = localBaseChatPie.c.findViewById(2131363513);
      this.jdField_a_of_type_AndroidViewView.addOnLayoutChangeListener(new aazp(this));
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localBaseChatPie.c.findViewById(2131363511));
