  ...
  implements ArkAppContainer.ArkAppModuleCallback
{
  ...
  public void a(ArkHorizontalListViewAdapter.ItemViewHolder paramItemViewHolder, ArkAdapterItemInterface paramArkAdapterItemInterface)
  {
    ...
    paramArkAdapterItemInterface.clickTail(paramItemViewHolder, null, this.jdField_a_of_type_AndroidContentContext);
    if (localObject != null)
    {
      ArkAppCenter.a((String)localObject, new abbd(this, paramItemViewHolder));
      ArkAppCenter.a().post(new abbe(this, (String)localObject, paramItemViewHolder));
    }
    do
    {
      return;
    ...
    ((ArkAppCenter)paramArkAdapterItemInterface.getManager(120)).a().a(str, "0.0.0.1", null, new abbg(this, paramItemViewHolder));
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (getItemViewType(paramInt) == 1)
    {
      if (paramView == null)
      {
        ...
        localObject = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130968708, paramViewGroup, false);
        paramView.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)((View)localObject).findViewById(2131363327));
        paramView.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppRootLayout = ((ArkAppRootLayout)((View)localObject).findViewById(2131363325));
        paramView.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)((View)localObject).findViewById(2131363328));
        paramView.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppLoadLayout = ((ArkAppLoadLayout)((View)localObject).findViewById(2131363330));
        paramView.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppView = ((ArkAppView)((View)localObject).findViewById(2131363329));
        paramView.jdField_a_of_type_AndroidViewView = ((View)localObject).findViewById(2131363332);
        paramView.jdField_a_of_type_AndroidWidgetButton = ((Button)((View)localObject).findViewById(2131363333));
        paramView.b = ((LinearLayout)((View)localObject).findViewById(2131363334));
        paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)((View)localObject).findViewById(2131363335));
        paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)((View)localObject).findViewById(2131363336));
