...
public class ArkAppDownloadModule$1$1
  implements Runnable
{
  public ArkAppDownloadModule$1$1(aphj paramaphj, ArrayList paramArrayList) {}
  
  public void run()
  {
    ark.VariantWrapper localVariantWrapper1 = this.jdField_a_of_type_Aphj.jdField_a_of_type_Aphi.a(this.jdField_a_of_type_Aphj.jdField_a_of_type_Long);
    ...
    JSONArray localJSONArray = aphi.a(this.jdField_a_of_type_Aphj.jdField_a_of_type_Aphi, this.jdField_a_of_type_JavaUtilArrayList, "QueryPackageState");
    String str = "";
