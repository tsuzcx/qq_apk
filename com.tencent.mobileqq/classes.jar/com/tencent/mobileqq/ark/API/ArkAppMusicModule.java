...
{
  private static aaxh jdField_a_of_type_Aaxh = new aaxh(null);
  ...
  {
    QQPlayerService.c(jdField_a_of_type_Aaxh);
  ...
  public boolean Invoke(String paramString, ark.VariantWrapper[] paramArrayOfVariantWrapper, ark.VariantWrapper paramVariantWrapper)
  {
    ...
    {
      ArkAppCenter.a().postToMainThread(new aaxe(this));
      return true;
    }
    if (paramString.equals("Pause"))
    {
      ArkAppCenter.a().postToMainThread(new aaxf(this));
      return true;
    }
    if (paramString.equals("Resume"))
    {
      ArkAppCenter.a().postToMainThread(new aaxg(this));
      return true;
    }
    double d1;
    ...
    if (paramString.equals("SetCallback"))
    {
      ...
      QQPlayerService.b(jdField_a_of_type_Aaxh);
      QQPlayerService.a(null);
      return true;
    }
  ...
  protected void a(ark.VariantWrapper[] paramArrayOfVariantWrapper)
  {
    ...
    try
    {
      ...
      ArkAppCenter.a().postToMainThread(new aaxd(this, localSongInfo));
      return;
    }
