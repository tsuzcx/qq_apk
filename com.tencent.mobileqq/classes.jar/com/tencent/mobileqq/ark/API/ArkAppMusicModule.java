...
{
  private static ArkAppMusicModule.GlobalMusicCallback jdField_a_of_type_ComTencentMobileqqArkAPIArkAppMusicModule$GlobalMusicCallback;
  ...
  public ArkAppMusicModule(ark.Application paramApplication, long paramLong)
  {
    super(paramApplication, paramLong);
    jdField_a_of_type_ComTencentMobileqqArkAPIArkAppMusicModule$GlobalMusicCallback = new ArkAppMusicModule.GlobalMusicCallback(this.jdField_a_of_type_JavaLangString);
  ...
  {
    QQPlayerService.c(jdField_a_of_type_ComTencentMobileqqArkAPIArkAppMusicModule$GlobalMusicCallback);
  ...
  public boolean Invoke(String paramString, ark.VariantWrapper[] paramArrayOfVariantWrapper, ark.VariantWrapper paramVariantWrapper)
  {
    ...
    if (paramString.equals("SetCallback"))
    {
      ...
      QQPlayerService.b(jdField_a_of_type_ComTencentMobileqqArkAPIArkAppMusicModule$GlobalMusicCallback);
      QQPlayerService.a(null);
      return true;
    }
