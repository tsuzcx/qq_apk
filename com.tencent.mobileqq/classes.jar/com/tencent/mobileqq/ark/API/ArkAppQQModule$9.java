...
public class ArkAppQQModule$9
  implements Runnable
{
  public ArkAppQQModule$9(aoqa paramaoqa, String paramString1, String paramString2, String paramString3, long paramLong) {}
  ...
  public void run()
  {
    ...
    {
      aovl.a(null, this.this$0.jdField_a_of_type_JavaLangString, "FullScreenOrH5Show", 0, 0, 0L, 0L, 0L, "", "");
      localObject1 = aopk.a();
      if ((localObject1 instanceof FragmentActivity))
      {
        localObject1 = (FragmentActivity)localObject1;
        aovl.a(null, this.this$0.jdField_a_of_type_JavaLangString, "FullScreenOrH5ShowForAI", 0, 0, 0L, 0L, 0L, "", "");
        ...
        do
        {
          do
          {
            ...
            do
            {
              ...
              localObject3 = new aouk();
              ((aouk)localObject3).jdField_a_of_type_JavaLangString = this.this$0.b;
              ((aouk)localObject3).d = this.this$0.c;
              ((aouk)localObject3).f = this.c;
              ((aouk)localObject3).b = this.b;
            ...
            if (aoqa.a(this.this$0) != null)
            {
              localObject3 = (QQCustomDialog)aoqa.a(this.this$0).get();
              if ((localObject3 != null) && (((QQCustomDialog)localObject3).isShowing())) {
                ((QQCustomDialog)localObject3).dismiss();
              }
            }
            localObject1 = bfur.a((Context)localObject1, null, (Bundle)localObject2);
            ((QQCustomDialog)localObject1).setNegativeButton(2131690620, null);
            ((QQCustomDialog)localObject1).setPositiveButton(2131694201, null);
            aoqa.a(this.this$0, new WeakReference(localObject1));
            ((QQCustomDialog)localObject1).show();
            aovl.a(null, "ShowView", this.this$0.jdField_a_of_type_JavaLangString, null, aovl.i, 0, 0);
            return;
          ...
          localObject1 = (afvi)afvi.a((ark.Container)localObject1).get();
        } while (localObject1 == null);
        ((afvi)localObject1).a(this.b, this.c);
        return;
