...
public class ArkAppNotifyCenter$GdtNotify$1
  implements Runnable
{
  public ArkAppNotifyCenter$GdtNotify$1(albi paramalbi, JSONObject paramJSONObject, String paramString1, String paramString2) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject2 = ((ChatFragment)localObject2).a.jdField_a_of_type_Acka.a();
        ...
        localObject3 = (ArkAppView)((View)localObject3).findViewById(2131297229);
        if (localObject3 == null) {
          break label396;
        }
        ...
        if (localObject4 != null)
        {
          localJSONObject1.put("left", vms.a(((ArkAppView)localObject3).getContext(), ((Rect)localObject4).left));
          localJSONObject1.put("top", vms.a(((ArkAppView)localObject3).getContext(), ((Rect)localObject4).top));
          localJSONObject1.put("right", vms.a(((ArkAppView)localObject3).getContext(), ((Rect)localObject4).right));
          localJSONObject1.put("bottom", vms.a(((ArkAppView)localObject3).getContext(), ((Rect)localObject4).bottom));
        }
      }
