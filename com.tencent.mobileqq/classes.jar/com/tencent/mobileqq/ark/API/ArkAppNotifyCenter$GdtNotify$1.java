...
public class ArkAppNotifyCenter$GdtNotify$1
  implements Runnable
{
  public ArkAppNotifyCenter$GdtNotify$1(alpw paramalpw, JSONObject paramJSONObject, String paramString1, String paramString2) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject2 = ((ChatFragment)localObject2).a.jdField_a_of_type_Acut.a();
        ...
        localObject3 = (ArkAppView)((View)localObject3).findViewById(2131362769);
        if (localObject3 == null) {
          break label396;
        }
        ...
        if (localObject4 != null)
        {
          localJSONObject1.put("left", vzo.a(((ArkAppView)localObject3).getContext(), ((Rect)localObject4).left));
          localJSONObject1.put("top", vzo.a(((ArkAppView)localObject3).getContext(), ((Rect)localObject4).top));
          localJSONObject1.put("right", vzo.a(((ArkAppView)localObject3).getContext(), ((Rect)localObject4).right));
          localJSONObject1.put("bottom", vzo.a(((ArkAppView)localObject3).getContext(), ((Rect)localObject4).bottom));
        }
      }
