  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    String str = BuddyTransfileProcessor.getTransferFilePath(BaseApplicationImpl.sApplication.getRuntime().getCurrentAccountUin(), MD5.toMD5(this.a), 23, null);
 ...
 * Qualified Name:     com.tencent.mobileqq.ark.API.SilkAudioPlayer.2
