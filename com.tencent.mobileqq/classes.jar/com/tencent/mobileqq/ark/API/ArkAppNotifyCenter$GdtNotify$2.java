...
public class ArkAppNotifyCenter$GdtNotify$2
  implements Runnable
{
  public ArkAppNotifyCenter$GdtNotify$2(alpv paramalpv, String paramString1, WeakReference paramWeakReference, String paramString2) {}
  ...
  public void run()
  {
    for (;;)
    {
      try
      {
        ...
        localObject1 = (qq_ad_get.QQAdGetRsp.AdInfo)qq_ad_get.QQAdGetRsp.AdInfo.class.cast(yxo.a(new qq_ad_get.QQAdGetRsp.AdInfo(), ((JSONObject)localObject1).getJSONObject("adInfo")));
        ...
        if (bool3)
        {
          ...
          localParams.jdField_a_of_type_AndroidOsBundle = new Bundle();
          localParams.jdField_a_of_type_AndroidOsBundle.putString("big_brother_ref_source_key", sgg.b("3026775809"));
          continue;
        }
