  ...
  extends ArkAppModuleBase
{
  ...
  private ArkAppDownloadModule.DownloadStateListener jdField_a_of_type_ComTencentMobileqqArkAPIArkAppDownloadModule$DownloadStateListener;
  private ArkAppDownloadModule.QueryPackageStateListener jdField_a_of_type_ComTencentMobileqqArkAPIArkAppDownloadModule$QueryPackageStateListener;
  private ArkAppDownloadModule.QueryPackageStateViaListener jdField_a_of_type_ComTencentMobileqqArkAPIArkAppDownloadModule$QueryPackageStateViaListener;
  ...
  ArkAppDownloadModule(ark.Application paramApplication, long paramLong)
  {
  ...
  private int a(Context paramContext, double paramDouble, WadlParams paramWadlParams)
  {
    ...
    for (boolean bool = localSharedPreferences.getBoolean(str1, true);; bool = true)
    {
      ...
      if ((bool) && (NetworkUtil.g(paramContext)) && (NetworkUtil.b(paramContext) != 1))
      {
        String str2 = String.format(paramContext.getString(2131690238), new Object[] { FileSizeFormat.a(paramDouble) });
        String str3 = paramContext.getString(2131690237);
  ...
  private String a(int paramInt)
  {
    ...
    case 2: 
    default: 
      str = localBaseActivity.getString(2131690235);
      return str;
    case 1: 
      return localBaseActivity.getString(2131690233);
    }
    return localBaseActivity.getString(2131690234);
  }
  ...
  private JSONObject a(WadlResult paramWadlResult, String paramString)
  {
    try
    {
      ...
      {
        JSONObject localJSONObject2 = a(paramWadlResult.jdField_a_of_type_ComTencentGamecenterWadlBizEntityWadlParams, paramString);
      ...
      localJSONObject1.put("errCode", WadlJsBridgeUtil.b(paramWadlResult.jdField_c_of_type_Int));
  ...
  public void Destruct()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqArkAPIArkAppDownloadModule$QueryPackageStateListener = null;
    this.jdField_a_of_type_ComTencentMobileqqArkAPIArkAppDownloadModule$QueryPackageStateViaListener = null;
  ...
  {
    if (!ArkAPIPermission.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.DOWNLOAD"))
    {
    ...
    if (paramString.equals("QueryPackageState"))
    {
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 2) && (paramArrayOfVariantWrapper[0].IsString()))
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqArkAPIArkAppDownloadModule$QueryPackageStateListener = new ArkAppDownloadModule.1(this, l);
    ...
    if (paramString.equals("QueryPackageInfo"))
    {
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 1) && (paramArrayOfVariantWrapper[0].IsString())) {
        try
        {
          ...
          localObject2 = GameCenterUtils.a((String)localObject1);
          i = 0;
          ...
          if (localObject2 != null)
          {
            ...
            paramString = GameCenterUtils.b(GameCenterUtils.a((String)localObject1));
          }
    ...
    if (paramString.equals("QueryPackageStateVia"))
    {
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 2) && (paramArrayOfVariantWrapper[0].IsString()))
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqArkAPIArkAppDownloadModule$QueryPackageStateViaListener = new ArkAppDownloadModule.2(this, a(paramArrayOfVariantWrapper[1].Copy()));
    ...
    if (paramString.equals("DownloadInit"))
    {
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 1))
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqArkAPIArkAppDownloadModule$DownloadStateListener = new ArkAppDownloadModule.3(this);
    ...
    {
      if (this.jdField_a_of_type_ComTencentMobileqqArkAPIArkAppDownloadModule$DownloadStateListener == null)
      {
      ...
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 2) && (paramArrayOfVariantWrapper[0].IsString()))
      {
        ...
        if (paramArrayOfVariantWrapper.jdField_b_of_type_Int == 12)
        {
          ...
          boolean bool2 = true;
          localObject1 = ArkConfProcessor.b(380).a();
          bool1 = bool2;
          if (localObject1 != null)
          {
            bool1 = bool2;
            if (((ArkConfBean.ArkPlatformConfigBean)localObject1).a() != null)
            {
              localObject1 = ((ArkConfBean.ArkPlatformConfigBean)localObject1).a();
              bool1 = bool2;
              if (((ArkManageConfig.ArkPlatformConfig)localObject1).c != null)
              {
                bool1 = bool2;
                if (((ArkManageConfig.ArkPlatformConfig)localObject1).c.contains(this.jdField_a_of_type_JavaLangString)) {
                  bool1 = false;
                }
              }
            }
          ...
          ArkDownloadController.a().a(this.jdField_a_of_type_JavaLangString, paramArrayOfVariantWrapper.jdField_a_of_type_JavaLangString, paramArrayOfVariantWrapper.j, paramArrayOfVariantWrapper.k, new ArkAppDownloadModule.4(this, paramArrayOfVariantWrapper, paramString, d));
          i = 2;
        }
      }
      for (;;)
    ...
    if (paramString.equals("ContinueDownload"))
    {
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 2) && (paramArrayOfVariantWrapper[1].IsString()))
      {
        ...
        if ((bool1) && (paramArrayOfVariantWrapper != null) && (NetworkUtil.g(paramArrayOfVariantWrapper)) && (NetworkUtil.b(paramArrayOfVariantWrapper) != 1))
        {
          String str1 = paramArrayOfVariantWrapper.getString(2131690230);
          String str2 = paramArrayOfVariantWrapper.getString(2131690237);
 ...
 * Qualified Name:     com.tencent.mobileqq.ark.API.ArkAppDownloadModule
