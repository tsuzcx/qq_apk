...
public class ArkAppEventObserverManager
{
  ...
  private SensorEventListener jdField_a_of_type_AndroidHardwareSensorEventListener = new aawa(this);
  private SosoInterface.OnLocationListener jdField_a_of_type_ComTencentMobileqqAppSosoSosoInterface$OnLocationListener = new aavo(this, 3, true, true, 0L, true, true, "ArkAppEventObserverManager");
  ...
  private void a(SensorEvent paramSensorEvent)
  {
    ...
    ArkAppCenter.a().post(new aavr(this, paramSensorEvent, l));
  }
  ...
  {
    long l = System.currentTimeMillis();
    ArkAppCenter.a().post(new aavs(this, l, paramSensorEvent));
  }
  ...
  public void a(ArkAppEventObserverManager.ObserverCallback paramObserverCallback, long paramLong)
  {
    ...
    do
    {
      ...
      } while (this.jdField_a_of_type_Aavt != null);
      this.jdField_a_of_type_Aavt = new aavt(this);
      AppNetConnInfo.registerConnectionChangeReceiver(BaseApplicationImpl.getApplication(), this.jdField_a_of_type_Aavt);
      return;
  ...
  public void a(String paramString)
  {
    ...
    {
      AppNetConnInfo.unregisterNetInfoHandler(this.jdField_a_of_type_Aavt);
      this.jdField_a_of_type_Aavt = null;
    }
    if ((this.jdField_d_of_type_Long != 0L) && (this.jdField_a_of_type_ComTencentMobileqqArkAPIArkAppEventObserverManager$ConnectionCallback != null)) {
      this.jdField_a_of_type_ComTencentMobileqqArkAPIArkAppEventObserverManager$ConnectionCallback.a(this.jdField_d_of_type_Long);
    }
