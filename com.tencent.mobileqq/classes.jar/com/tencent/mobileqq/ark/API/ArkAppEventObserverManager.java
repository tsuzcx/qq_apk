...
public class ArkAppEventObserverManager
{
  ...
  private ArkAppEventObserverManager.ArkConnectionHandler jdField_a_of_type_ComTencentMobileqqArkAPIArkAppEventObserverManager$ArkConnectionHandler = null;
  private ArkAppEventObserverManager.ConnectionCallback jdField_a_of_type_ComTencentMobileqqArkAPIArkAppEventObserverManager$ConnectionCallback = null;
  private ArkAppEventObserverManager.GetCurrentPositionCallback jdField_a_of_type_ComTencentMobileqqArkAPIArkAppEventObserverManager$GetCurrentPositionCallback = null;
  private ArkAppEventObserverManager.MotionCallback jdField_a_of_type_ComTencentMobileqqArkAPIArkAppEventObserverManager$MotionCallback = null;
  private ArkAppEventObserverManager.OrientationCallback jdField_a_of_type_ComTencentMobileqqArkAPIArkAppEventObserverManager$OrientationCallback = null;
  private ArkAppEventObserverManager.PositionCallback jdField_a_of_type_ComTencentMobileqqArkAPIArkAppEventObserverManager$PositionCallback = null;
  ...
  public void a(ArkAppEventObserverManager.ObserverCallback paramObserverCallback, long paramLong)
  {
    ...
    do
    {
      ...
      } while (this.jdField_a_of_type_ComTencentMobileqqArkAPIArkAppEventObserverManager$ArkConnectionHandler != null);
      this.jdField_a_of_type_ComTencentMobileqqArkAPIArkAppEventObserverManager$ArkConnectionHandler = new ArkAppEventObserverManager.ArkConnectionHandler(this);
      AppNetConnInfo.registerConnectionChangeReceiver(BaseApplicationImpl.getApplication(), this.jdField_a_of_type_ComTencentMobileqqArkAPIArkAppEventObserverManager$ArkConnectionHandler);
      return;
  ...
  public void a(String paramString)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqArkAPIArkAppEventObserverManager$ArkConnectionHandler != null)
    {
      AppNetConnInfo.unregisterNetInfoHandler(this.jdField_a_of_type_ComTencentMobileqqArkAPIArkAppEventObserverManager$ArkConnectionHandler);
      this.jdField_a_of_type_ComTencentMobileqqArkAPIArkAppEventObserverManager$ArkConnectionHandler = null;
    }
    if ((this.jdField_d_of_type_Long != 0L) && (this.jdField_a_of_type_ComTencentMobileqqArkAPIArkAppEventObserverManager$ConnectionCallback != null)) {
      this.jdField_a_of_type_ComTencentMobileqqArkAPIArkAppEventObserverManager$ConnectionCallback.a(this.jdField_d_of_type_Long);
    }
