...
public class ArkAppSchemeCenter$TelSchemeHandler$2
  implements Runnable
{
  public ArkAppSchemeCenter$TelSchemeHandler$2(anlh paramanlh, String paramString1, String paramString2, long paramLong, String paramString3) {}
  ...
  public void run()
  {
    ...
    if (!anjy.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, (ark.Application)localObject1, "permission.TELEPHONE"))
    {
    ...
    try
    {
      Object localObject3 = anla.a(new JSONObject(this.c)).get("number");
      localObject1 = str;
