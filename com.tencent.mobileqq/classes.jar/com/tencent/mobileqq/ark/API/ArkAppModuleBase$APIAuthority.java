...
public class ArkAppModuleBase$APIAuthority
{
  ...
  public static void a(String paramString1, String paramString2, String paramString3, String paramString4, ArkAppModuleBase.APIAuthority.AuthDialogEventHandler paramAuthDialogEventHandler)
  {
    ...
    do
    {
      do
      {
        ...
        {
          ArkAppCenter.a().postToMainThread(new ArkAppModuleBase.APIAuthority.1((String)localObject1, paramString4, paramString2, paramAuthDialogEventHandler, paramString3, paramString1));
      ...
      } while (paramAuthDialogEventHandler == null);
      paramAuthDialogEventHandler.a();
      return;
    } while (paramAuthDialogEventHandler == null);
 ...
 * Qualified Name:     com.tencent.mobileqq.ark.API.ArkAppModuleBase.APIAuthority
