  ...
  extends ArkAppModuleBase
{
  ...
  public ArkAppQQModule(ark.Application paramApplication, long paramLong)
  {
    super(paramApplication, paramLong);
    this.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppLocationManager = new ArkAppLocationManager(this.jdField_a_of_type_JavaLangString, 30000L);
  }
  ...
  public void Destruct()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqArkAPIArkSilkAudioPlayerWrapper != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqArkAPIArkSilkAudioPlayerWrapper.a();
      this.jdField_a_of_type_ComTencentMobileqqArkAPIArkSilkAudioPlayerWrapper = null;
  ...
  public boolean Invoke(String paramString, ark.VariantWrapper[] paramArrayOfVariantWrapper, ark.VariantWrapper paramVariantWrapper)
  {
    ...
    if (paramString.equals("NavigateTo"))
    {
      ...
      if ((paramString != null) && (paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 1)) {
        ArkCommonUtil.a(paramString, paramArrayOfVariantWrapper[0].GetString(), true, 0L, null, null, 3, this.jdField_a_of_type_JavaLangString, null);
      }
      return true;
    }
    ...
    if (localObject5 != null)
    {
      ...
      localObject4 = ((IPublicAccountUtil)QRoute.api(IPublicAccountUtil.class)).getSourceId(((BaseChatPie)localObject3).a.jdField_a_of_type_JavaLangString);
      ...
      paramArrayOfVariantWrapper = (ArkAppContainer)ArkAppContainer.a(paramArrayOfVariantWrapper).get();
      if ((paramArrayOfVariantWrapper == null) || (!(paramArrayOfVariantWrapper instanceof ArkAioContainerWrapper))) {
        break label7978;
      }
      localMessageForArkApp = (MessageForArkApp)((ArkAioContainerWrapper)paramArrayOfVariantWrapper).jdField_a_of_type_JavaLangRefWeakReference.get();
      label410:
      if (!ArkAppSchemeCenter.a(paramString, (String)localObject1, (JSONObject)localObject5, this.jdField_a_of_type_Long, this.jdField_a_of_type_JavaLangString)) {
        break label614;
      }
      ArkAppDataReport.a(null, this.jdField_a_of_type_JavaLangString, "FullScreenOrH5ShowForAI", 0, 0, 0L, 0L, 0L, "", "");
      ...
      else
      {
        ...
        if (localMessageForArkApp != null)
        {
          ...
          label525:
          ReportController.b(null, "dc00898", "", "", "0X800A86C", "0X800A86C", 0, 0, paramArrayOfVariantWrapper, "", "", "");
          paramArrayOfVariantWrapper = paramString;
        }
      }
    }
    ...
    for (;;)
    {
      ...
      ArkAppDataReport.a(null, this.jdField_a_of_type_JavaLangString, "FullScreenOrH5Show", 0, 0, 0L, 0L, 0L, "", "");
      return true;
      ...
      {
        if (!ArkAPIPermission.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.BROWSER"))
        {
        ...
        for (bool1 = true;; bool1 = false)
        {
          ...
          QLog.e("ArkApp.ArkAppQQModule", 1, new Object[] { "ArkSafe.UrlCheck.setDisable.OpenUrl.http appName=", this.jdField_a_of_type_JavaLangString, ",url=", Util.b(paramString, new String[0]), ", isValid set=true" });
          j = 1;
          i = 2;
          label865:
          a();
          label869:
          ArkSecurityReporter.b(this.jdField_a_of_type_JavaLangString, paramString, k, i, ArkAppContainer.c);
          ArkAppDataReport.b(a(), this.jdField_a_of_type_JavaLangString, paramString, 2);
          if (j != 0) {
            break label955;
          }
          QLog.d("ArkApp.ArkAppQQModule", 1, new Object[] { "ArkSafe.OpenUrl check url invalid!, url=", Util.b(paramString, new String[0]), ", app=", this.jdField_a_of_type_JavaLangString });
          return false;
          i = 0;
          break;
        }
        ...
        for (;;)
        {
          ...
          catch (JSONException paramArrayOfVariantWrapper)
          {
            ...
            paramArrayOfVariantWrapper = String.valueOf(l1);
            continue;
            ArkCommonUtil.a(localActivity, paramString, true, 0L, null, (String)localObject2, 0, this.jdField_a_of_type_JavaLangString, (String)localObject4);
            continue;
          }
          if (!(localObject3 instanceof PublicAccountChatPie)) {
            continue;
          ...
          l1 = ParseUtil.a(localMessageForArkApp.ark_app_message.getAppIdFromMeta(), 0L);
          ArkCommonUtil.a(localActivity, paramString, true, l1, localMessageForArkApp, (String)localObject2, 0, this.jdField_a_of_type_JavaLangString, (String)localObject4);
      ...
      if (this.jdField_a_of_type_Long == 0L)
      {
        paramVariantWrapper = JumpParser.a(a(), localActivity, paramString);
        paramArrayOfVariantWrapper = paramString;
        if (paramVariantWrapper != null)
        {
          ...
          for (bool1 = true;; bool1 = false)
          {
            ...
            QLog.e("ArkApp.ArkAppQQModule", 1, new Object[] { "ArkSafe.UrlCheck.setDisable.OpenUrl.jump appName=", this.jdField_a_of_type_JavaLangString, ",url=", Util.b(paramString, new String[0]), ", isValid set=true" });
            i = 1;
            j = 2;
            ArkSecurityReporter.b(this.jdField_a_of_type_JavaLangString, paramString, k, j, ArkAppContainer.c);
            if (i == 0) {
              break label1667;
            }
          ...
          label1667:
          QLog.e("ArkApp.ArkAppQQModule", 1, new Object[] { "ArkSafe.OpenUrl check url invalid, url=", Util.b(paramString, new String[0]), ", app=", this.jdField_a_of_type_JavaLangString });
          paramArrayOfVariantWrapper = paramString;
        }
      }
    }
    if (paramString.equals("OpenVideo"))
    {
      ...
      try
      {
        ...
        if ((!TextUtils.isEmpty((CharSequence)localObject1)) && ((((String)localObject1).equalsIgnoreCase("http")) || (((String)localObject1).equalsIgnoreCase("https"))))
        {
          ...
          ArkAppDataReport.a(a(), this.jdField_a_of_type_JavaLangString, "AIOArkOpenVideo", 1, 0, 0L, 0L, 0L, paramArrayOfVariantWrapper, "");
        }
        return true;
      }
    ...
    if (paramString.equals("Report"))
    {
      ...
      for (;;)
      {
        try
        {
          ...
          ArkAppDataReport.a(paramString, this.jdField_a_of_type_JavaLangString, paramArrayOfVariantWrapper, i);
          return true;
        }
    ...
    if (paramString.equals("ReportEx"))
    {
      ...
      try
      {
        ...
        UserAction.onUserActionToTunnel(paramArrayOfVariantWrapper, paramVariantWrapper, bool1, l1, l2, (HashMap)new Gson().fromJson(((JSONObject)localObject1).toString(), HashMap.class), bool2, true);
        return false;
      }
      catch (JSONException paramArrayOfVariantWrapper)
      {
        for (;;)
        {
          ArkAppCenter.c("ArkApp.ArkAppQQModule", "QQ.ReportEx.Beacon, invalid report data, data=" + paramString);
        }
      }
    }
      ...
      for (paramString = paramArrayOfVariantWrapper[0].GetString();; paramString = ((QQAppInterface)localObject2).getCurrentAccountUin())
      {
        ...
        if (!TextUtils.isEmpty(paramString))
        {
          ...
          else
          {
            ...
            paramArrayOfVariantWrapper = (ark.VariantWrapper[])localObject1;
            if (TextUtils.isEmpty((CharSequence)localObject1)) {
              paramArrayOfVariantWrapper = ContactUtils.a((QQAppInterface)localObject2, paramString, 0);
            }
          }
    ...
    else
    {
      ...
      {
        paramVariantWrapper.CreateObject("DataRequest", new ArkDataRequestObj(a(), this.jdField_a_of_type_JavaLangString));
        return true;
      }
      ...
      if (paramString.equals("GetCurrentPosition"))
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppLocationManager.b(new ArkAppQQModule.1(this, l1));
        return true;
      }
      if (paramString.equals("WatchPosition"))
      {
        ...
        l1 = a(paramArrayOfVariantWrapper[0].Copy());
        this.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppLocationManager.a(new ArkAppQQModule.2(this, l1));
        return true;
      }
      ...
      if (paramString.equals("GetCurrentAddress"))
      {
        ...
        l1 = a(paramArrayOfVariantWrapper[0].Copy());
        this.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppLocationManager.a(new ArkAppQQModule.3(this, l1), true);
        return true;
      }
      if (paramString.equals("SendMessage"))
      {
        ...
        do
        {
          try
          {
            ...
            if (TextUtils.isEmpty(((ArkAppMessage)localObject2).promptText)) {
              ((ArkAppMessage)localObject2).promptText = String.format(HardCodeUtil.a(2131700721), new Object[] { ((ArkAppMessage)localObject2).appDesc });
            }
            ...
            if (bool1)
            {
              if (paramString != null)
              {
                ChatActivityFacade.b(a(), paramString, (ArkAppMessage)localObject2);
                if (QLog.isColorLevel()) {
        ...
        if (bool1)
        {
          ...
          paramString = MessageRecordFactory.a(a(), a().getCurrentUin(), paramString.jdField_a_of_type_JavaLangString, paramString.b, paramString.jdField_a_of_type_Int, (byte)1, (byte)0, (short)0, paramVariantWrapper);
          paramArrayOfVariantWrapper.getMessageFacade().a(paramString, null);
          if (!QLog.isColorLevel()) {
            break label8018;
          }
      ...
      else
      {
        ...
        {
          if (!ArkAPIPermission.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.LOGIN"))
          {
          ...
          for (;;)
          {
            try
            {
              ...
              if (paramString == null)
              {
                ...
                ArkAppModuleBase.APIAuthority.a(paramString, this.jdField_a_of_type_JavaLangString, "ark_authority_api_login", BaseApplicationImpl.getContext().getString(2131690211), new ArkAppQQModule.7(this, l2, paramString, l1));
                return true;
              }
            }
        ...
        {
          if (!ArkAPIPermission.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.USER_INFORMATION"))
          {
          ...
          {
            ArkAppModuleBase.APIAuthority.a(paramString, this.jdField_a_of_type_JavaLangString, "ark_authority_api_user_info", BaseApplicationImpl.getContext().getString(2131690212), new ArkAppQQModule.8(this, l1, paramString));
            return true;
          }
        }
        if (paramString.equals("TestGetJson")) {
        ...
        {
          if (!ArkAPIPermission.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.OPENVIEW")) {
            return false;
          }
        ...
        {
          if (!ArkAPIPermission.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.SHARE")) {
            return false;
          }
        ...
        {
          if (!ArkAPIPermission.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.STATUSBAR")) {
            return false;
          }
            ...
            for (;;)
            {
              ...
              if (localObject1 != null)
              {
                ...
                if (((ArkConfBean.ArkPlatformConfigBean)localObject1).a() != null) {
                  paramString = ((ArkConfBean.ArkPlatformConfigBean)localObject1).a().b;
                }
              }
              localObject1 = a();
              paramArrayOfVariantWrapper = paramString;
              if (TextUtils.isEmpty(paramString))
              {
                paramArrayOfVariantWrapper = paramString;
                if (localObject1 != null) {
                  paramArrayOfVariantWrapper = ((Activity)localObject1).getString(2131690250);
                }
              }
      ...
      else if (paramString.equals("GetNickNameByView"))
      {
        ...
        if (localObject2 != null)
        {
          ...
          while (!TextUtils.isEmpty((CharSequence)localObject1))
          {
            ...
            {
              paramArrayOfVariantWrapper = ContactUtils.q((QQAppInterface)localObject2, (String)localObject1);
              paramString = paramArrayOfVariantWrapper;
              if (TextUtils.isEmpty(paramArrayOfVariantWrapper)) {
                paramString = ContactUtils.a((QQAppInterface)localObject2, (String)localObject1, 0);
              }
            }
            paramVariantWrapper.SetString(paramString);
      ...
      else
      {
        if (paramString.equals("GetAppInfo"))
        {
          ...
          try
          {
            ...
            ((JSONObject)localObject1).put("name", BaseApplicationImpl.getApplication().getString(2131690175));
            paramArrayOfVariantWrapper = DeviceInfoUtil.c();
            paramString = paramArrayOfVariantWrapper;
            if (TextUtils.isEmpty(paramArrayOfVariantWrapper)) {
              paramString = "8.5.5";
  ...
  protected void a(long paramLong, boolean paramBoolean, SosoLbsInfo paramSosoLbsInfo)
  {
    ...
    catch (JSONException paramSosoLbsInfo)
    {
      for (;;)
      {
        ...
        paramSosoLbsInfo = (SosoLbsInfo)localObject;
      }
    }
  }
  ...
  {
    return new ArkAppModuleBase.ModuleMethod[] { new ArkAppQQModule.MethodGetUIN(null), new ArkAppQQModule.MethodGetSKey(null), new ArkAppQQModule.MethodGetPSKey(null), new ArkAppQQModule.MethodReplyMessage(null), new ArkAppQQModule.MethodPlaySilkAudio(this, null), new ArkAppQQModule.MethodStopSilkAudio(this, null) };
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes8.jar
 * Qualified Name:     com.tencent.mobileqq.ark.API.ArkAppQQModule
