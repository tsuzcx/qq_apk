  ...
  extends TopGestureLayout
{
  ...
  {
    this.jdField_a_of_type_AndroidViewGestureDetector$SimpleOnGestureListener = new appp(this, paramContext);
  ...
  {
    boolean bool = false;
    if (paramMotionEvent.getX() <= this.jdField_a_of_type_Int / 100.0F * (float)bgln.i()) {}
    for (int i = 1;; i = 0)
    {
      if (i != 0) {
