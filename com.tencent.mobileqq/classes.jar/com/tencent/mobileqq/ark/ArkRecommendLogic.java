...
public class ArkRecommendLogic
{
  ...
  public static Handler a()
  {
    try
    {
      if (jdField_a_of_type_AndroidOsHandlerThread == null)
      {
        ...
        jdField_a_of_type_AndroidOsHandler.post(new abeq());
      }
  ...
  private void a(ArrayList paramArrayList, RecommendCommonMessage paramRecommendCommonMessage, WeakReference paramWeakReference, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      localObject1 = new abez(this, localArrayList, localArkAiInfo, paramRecommendCommonMessage, localQQAppInterface, (String)localObject1, localException, (ArkRecommendLogic.SemanticAnalysisResult)localObject2);
  ...
  public void a(RecommendCommonMessage paramRecommendCommonMessage, ArkRecommendLogic.SemanticAnalysisResult paramSemanticAnalysisResult)
  {
    ...
    ArkMessageServerLogic.a(a(paramRecommendCommonMessage), null, new abeu(this, localWeakReference, paramSemanticAnalysisResult, paramRecommendCommonMessage));
  }
  ...
  public void a(String paramString, SessionInfo paramSessionInfo, ArkRecommendLogic.SemanticAnalysisResult paramSemanticAnalysisResult)
  {
    ...
    ArkMessageServerLogic.a(paramString, null, new abew(this, new WeakReference(this), new WeakReference(paramSemanticAnalysisResult), paramSessionInfo));
  }
  ...
  public void a(String paramString, AtTroopMemberSpan[] paramArrayOfAtTroopMemberSpan, ArkRecommendLogic.SemanticAnalysisResult paramSemanticAnalysisResult)
  {
    ...
    //   64: invokespecial 501	aber:<init>	(Lcom/tencent/mobileqq/ark/ArkRecommendLogic;Ljava/lang/ref/WeakReference;Ljava/lang/ref/WeakReference;)V
    ...
    //   363: invokespecial 560	abet:<init>	(Lcom/tencent/mobileqq/ark/ArkRecommendLogic;Ljava/lang/ref/WeakReference;)V
  ...
  public boolean a(RecommendCommonMessage paramRecommendCommonMessage, ArkRecommendLogic.SemanticAnalysisResult paramSemanticAnalysisResult)
  {
    ...
    for (boolean bool = false;; bool = true)
    {
      ...
      paramSemanticAnalysisResult = new WeakReference(paramSemanticAnalysisResult);
      c = false;
      ArkMessageServerLogic.a(localArrayList1, true, l, new abey(this, paramRecommendCommonMessage, paramSemanticAnalysisResult));
      return c;
    }
  }
}
