...
{
  private static final String[] a = { BusinessHandlerFactory.ARKAPP_HANDLER };
  ...
  private void a(String paramString, boolean paramBoolean, byte[] paramArrayOfByte, int paramInt1, int paramInt2, BusinessObserver paramBusinessObserver)
  {
    ...
    if (!Cmd2HandlerMapHelper.a(paramString)) {
      Cmd2HandlerMapHelper.a(paramString, a);
    }
  ...
  public boolean a(String paramString)
  {
    ...
    paramString = new ToServiceMsg("mobileqq.service", this.appRuntime.getAccount(), "ArkAppPanel.Report");
