...
import com.tencent.mobileqq.config.business.ArkConfBean.ArkMsgAIDisableConfBean;
import com.tencent.mobileqq.config.business.ArkConfProcessor;
import com.tencent.mobileqq.config.business.ArkManageConfig.ArkMsgAIDisableConfig;
import com.tencent.mobileqq.config.business.ArkManageConfig.DialogConfig;
...
public class ArkAiAppCenter
{
  ...
  public static Map<String, List<ArkAiAppCenter.ApiFrequencyConfig>> a;
  ...
  private ArkAiDictUpdateMgr jdField_a_of_type_ComTencentMobileqqArkArkAiDictUpdateMgr;
  ...
  public ArkAiAppCenter(ArkAppCenter paramArkAppCenter)
  {
    ...
    Object localObject = ArkConfProcessor.b(159).a();
    if ((localObject != null) && (((ArkConfBean.ArkMsgAIDisableConfBean)localObject).a() != null))
    {
      localObject = ((ArkConfBean.ArkMsgAIDisableConfBean)localObject).a();
      jdField_a_of_type_Boolean = ((ArkManageConfig.ArkMsgAIDisableConfig)localObject).jdField_a_of_type_Boolean;
      f = ((ArkManageConfig.ArkMsgAIDisableConfig)localObject).jdField_b_of_type_Boolean;
    }
    this.jdField_a_of_type_ComTencentMobileqqArkArkAiDictMgr = new ArkAiDictMgr(paramArkAppCenter.b());
    this.jdField_a_of_type_ComTencentMobileqqArkArkAiDictUpdateMgr = new ArkAiDictUpdateMgr(paramArkAppCenter.b());
    d();
    a();
    paramArkAppCenter = ArkConfProcessor.b(186).a();
  ...
  {
    return SharePreferenceUtils.a(BaseApplication.getContext(), paramString + a());
  }
  
  public static void a(String paramString1, String paramString2)
  {
    SharePreferenceUtils.a(BaseApplication.getContext(), paramString1 + a(), paramString2);
  }
  ...
  public static void a(boolean paramBoolean)
  {
    ...
    {
      SharePreferenceUtils.a(BaseApplication.getContext(), "ark_use_android_http_" + a(), str);
      return;
    }
  }
  ...
  public static boolean a()
  {
    try
    {
      boolean bool = "open".equals(SharePreferenceUtils.a(BaseApplication.getContext(), "ark_use_android_http_" + a()));
      return bool;
    }
  ...
  public static void b(boolean paramBoolean)
  {
    ...
    for (String str = "open";; str = "close") {
      try
      {
        SharePreferenceUtils.a(BaseApplication.getContext(), "ark_support_android9_emoji", str);
        return;
      }
      catch (Exception localException)
      {
  ...
  public static boolean b()
  {
    try
    {
      boolean bool = "open".equals(SharePreferenceUtils.a(BaseApplication.getContext(), "ark_support_android9_emoji"));
      return bool;
    }
    catch (Exception localException)
    {
  ...
  private void d()
  {
    ArkAiDictMgr.a(this.jdField_a_of_type_ComTencentMobileqqArkArkAppCenter.b());
  }
  
  public void a()
  {
    this.jdField_a_of_type_ComTencentMobileqqArkArkAiDictUpdateMgr.a();
  }
  
  public void a(ArkManageConfig.DialogConfig paramDialogConfig)
  {
    ...
    e = paramDialogConfig.jdField_a_of_type_Boolean;
    d = this.jdField_a_of_type_ComTencentMobileqqArkArkAiDictUpdateMgr.a(paramDialogConfig.jdField_b_of_type_JavaLangString);
    g = paramDialogConfig.jdField_b_of_type_Boolean;
    a(g);
    if (ArkAppCenter.jdField_b_of_type_Boolean) {
      ark.SetUseAndroidHTTP(g);
    }
    h = paramDialogConfig.c;
    b(h);
    if (ArkAppCenter.jdField_b_of_type_Boolean) {
      ark.arkSetAndroid9EmojiFeatureSupport(h);
    }
    i = paramDialogConfig.d;
    Object localObject;
    if (i) {
      localObject = "true";
    }
  ...
  public void b()
  {
    ArkAiDictMgr localArkAiDictMgr = this.jdField_a_of_type_ComTencentMobileqqArkArkAiDictMgr;
    ArkAiDictMgr.b(this.jdField_a_of_type_ComTencentMobileqqArkArkAppCenter.a());
  }
