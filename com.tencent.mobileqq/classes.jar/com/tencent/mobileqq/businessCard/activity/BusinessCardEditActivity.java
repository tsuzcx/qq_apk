...
{
  public int a;
  amsu jdField_a_of_type_Amsu = new apgq(this);
  public Dialog a;
  ...
  public apgi a;
  apgj jdField_a_of_type_Apgj = new apgr(this);
  apha jdField_a_of_type_Apha;
  ...
  private void a(BusinessCard paramBusinessCard)
  {
    ...
    if (paramBusinessCard != null)
    {
      ...
      if (!a())
      {
        ...
        if (a((ArrayList)localObject4, (ArrayList)localObject3, (ArrayList)localObject2, (ArrayList)localObject1))
        {
          ...
          while (((Iterator)localObject4).hasNext())
          {
            ...
            localObject5 = LayoutInflater.from(this).inflate(2131560984, null);
            localObject7 = (ImageView)((View)localObject5).findViewById(2131368236);
            ...
            ((TextView)((View)localObject5).findViewById(2131371777)).setText(ContactUtils.getFriendShowName(this.app, (String)localObject6));
            ((TextView)((View)localObject5).findViewById(2131380108)).setText((CharSequence)localObject6);
            ((ImageView)((View)localObject5).findViewById(2131362976)).setVisibility(0);
            localObject7 = new apgz(this);
            ((apgz)localObject7).jdField_a_of_type_JavaLangString = ((String)localObject6);
            ((apgz)localObject7).jdField_b_of_type_JavaLangString = ContactUtils.getFriendShowName(this.app, (String)localObject6);
            ((apgz)localObject7).jdField_a_of_type_Boolean = false;
            ((View)localObject5).setTag(localObject7);
            ((View)localObject5).setOnClickListener(new apgv(this));
          ...
          while (((Iterator)localObject3).hasNext())
          {
            ...
            localObject4 = LayoutInflater.from(this).inflate(2131560984, null);
            localObject6 = (ImageView)((View)localObject4).findViewById(2131368236);
            ...
            localObject6 = (TextView)((View)localObject4).findViewById(2131371777);
            ((TextView)((View)localObject4).findViewById(2131380108)).setText((CharSequence)localObject5);
            localObject7 = (Button)((View)localObject4).findViewById(2131362165);
            ((Button)localObject7).setVisibility(0);
            localObject8 = new apgz(this);
            ((apgz)localObject8).jdField_a_of_type_JavaLangString = ((String)localObject5);
            ((apgz)localObject8).jdField_b_of_type_JavaLangString = ContactUtils.getBuddyNickName(this.app, (String)localObject5, true);
            ((apgz)localObject8).jdField_a_of_type_Boolean = false;
            ((View)localObject4).setTag(localObject8);
            ((TextView)localObject6).setText(((apgz)localObject8).jdField_b_of_type_JavaLangString);
            ((Button)localObject7).setTag(localObject8);
            ((Button)localObject7).setOnClickListener(new apgw(this));
          ...
          if (((Iterator)localObject2).hasNext())
          {
            ...
            localObject3 = LayoutInflater.from(this).inflate(2131560984, null);
            localObject4 = (ImageView)((View)localObject3).findViewById(2131368236);
            localObject5 = (TextView)((View)localObject3).findViewById(2131371777);
            localObject8 = (TextView)((View)localObject3).findViewById(2131380108);
            ...
            localapgz.jdField_a_of_type_Boolean = true;
            if (localObject8 != null)
            {
              ...
              localapgz.jdField_a_of_type_JavaLangString = ((CardMobileInfo)localObject8).d;
            }
            for (localapgz.jdField_b_of_type_JavaLangString = ((CardMobileInfo)localObject8).jdField_c_of_type_JavaLangString;; localapgz.jdField_b_of_type_JavaLangString = ((String)localObject7))
            {
              ((View)localObject3).setTag(localapgz);
              ((TextView)localObject5).setText(localapgz.jdField_b_of_type_JavaLangString);
              ((Button)localObject6).setTag(localapgz);
              ((Button)localObject6).setOnClickListener(new apgx(this));
              ...
              break;
              localapgz.jdField_a_of_type_JavaLangString = ((String)localObject7);
            }
          }
      ...
      localObject1 = (LinearLayout)this.jdField_c_of_type_AndroidWidgetRelativeLayout.findViewById(2131365450);
      Object localObject2 = this.jdField_c_of_type_AndroidWidgetRelativeLayout.findViewById(2131365432);
  ...
  private void a(BusinessCard paramBusinessCard, boolean paramBoolean)
  {
    ...
    while (i < this.jdField_c_of_type_AndroidWidgetLinearLayout.getChildCount())
    {
      ...
      {
        localObject = (EditText)((View)localObject).findViewById(2131374144);
        if (localObject != null)
        {
    ...
    if (paramBoolean)
    {
      ...
      bcef.b(this.app, "CliOper", "", "", "0X80064E7", "0X80064E7", 0, 0, (String)localObject, "", "", "");
      localObject = "0";
      if (TextUtils.isEmpty(paramBusinessCard.company)) {
        localObject = "1";
      }
      bcef.b(this.app, "CliOper", "", "", "0X80064E8", "0X80064E8", 0, 0, (String)localObject, "", "", "");
      localObject = paramBusinessCard.qqNum.size() + "";
      bcef.b(this.app, "CliOper", "", "", "0X80064E9", "0X80064E9", 0, 0, (String)localObject, "", "", "");
      paramBusinessCard = paramBusinessCard.descs.size() + "";
      bcef.b(this.app, "CliOper", "", "", "0X80064EA", "0X80064EA", 0, 0, paramBusinessCard, "", "", "");
    }
    for (;;)
    {
      return;
      ...
      if (getIntent().getIntExtra("source_activity", 0) == 1)
      {
        ...
        if (!TextUtils.isEmpty(paramBusinessCard.cardName))
        {
          bcef.b(this.app, "CliOper", "", "", "0X8007749", "0X8007749", this.jdField_d_of_type_Int, 0, "", "", "", "");
          localObject = "1";
        }
        bcef.b(this.app, "CliOper", "", "", "0X80064EF", "0X80064EF", 0, 0, (String)localObject, "", "", "");
        localObject = "0";
        if (!TextUtils.isEmpty(paramBusinessCard.company))
        {
          bcef.b(this.app, "CliOper", "", "", "0X800774A", "0X800774A", this.jdField_d_of_type_Int, 0, "", "", "", "");
          localObject = "1";
        }
        bcef.b(this.app, "CliOper", "", "", "0X80064F0", "0X80064F0", 0, 0, (String)localObject, "", "", "");
        localObject = paramBusinessCard.qqNum.size() + "";
        bcef.b(this.app, "CliOper", "", "", "0X80064F1", "0X80064F1", 0, 0, (String)localObject, "", "", "");
        int j = paramBusinessCard.descs.size();
        i = 0;
        while (i < j)
        {
          if (!TextUtils.isEmpty((CharSequence)paramBusinessCard.descs.get(i))) {
            bcef.b(this.app, "CliOper", "", "", "0X800774E", "0X800774E", this.jdField_d_of_type_Int, 0, "", "", "", "");
          }
          i += 1;
        }
        localObject = paramBusinessCard.descs.size() + "";
        bcef.b(this.app, "CliOper", "", "", "0X80064F2", "0X80064F2", 0, 0, (String)localObject, "", "", "");
        j = paramBusinessCard.mobilesNum.size();
        i = 0;
        while (i < j)
        {
          if ((i == 0) && (!TextUtils.isEmpty((CharSequence)paramBusinessCard.mobilesNum.get(i)))) {
            bcef.b(this.app, "CliOper", "", "", "0X800774B", "0X800774B", this.jdField_d_of_type_Int, 0, "", "", "", "");
          }
          if ((i == 1) && (!TextUtils.isEmpty((CharSequence)paramBusinessCard.mobilesNum.get(i)))) {
            bcef.b(this.app, "CliOper", "", "", "0X800774C", "0X800774C", this.jdField_d_of_type_Int, 0, "", "", "", "");
          }
          if ((i == 2) && (!TextUtils.isEmpty((CharSequence)paramBusinessCard.mobilesNum.get(i)))) {
            bcef.b(this.app, "CliOper", "", "", "0X800774D", "0X800774D", this.jdField_d_of_type_Int, 0, "", "", "", "");
          }
          i += 1;
        }
      }
  ...
  private void a(CardOCRInfo paramCardOCRInfo)
  {
    if (paramCardOCRInfo != null)
    {
      ...
      if (!a())
      {
        ...
        if (a((ArrayList)localObject2, (ArrayList)localObject1, (ArrayList)localObject3, paramCardOCRInfo))
        {
          ...
          while (((Iterator)localObject2).hasNext())
          {
            ...
            localObject3 = LayoutInflater.from(this).inflate(2131560984, null);
            localObject5 = (ImageView)((View)localObject3).findViewById(2131368236);
            ...
            ((TextView)((View)localObject3).findViewById(2131371777)).setText(ContactUtils.getFriendShowName(this.app, (String)localObject4));
            ((TextView)((View)localObject3).findViewById(2131380108)).setText((CharSequence)localObject4);
            ((ImageView)((View)localObject3).findViewById(2131362976)).setVisibility(0);
            localObject5 = new apgz(this);
            ((apgz)localObject5).jdField_a_of_type_JavaLangString = ((String)localObject4);
            ((apgz)localObject5).jdField_b_of_type_JavaLangString = ContactUtils.getFriendShowName(this.app, (String)localObject4);
            ((apgz)localObject5).jdField_a_of_type_Boolean = false;
            ((View)localObject3).setTag(localObject5);
            ((View)localObject3).setOnClickListener(new apgt(this));
            localObject4 = new LinearLayout.LayoutParams(-1, DisplayUtil.dip2px(this, 70.0F));
            this.jdField_c_of_type_AndroidWidgetLinearLayout.addView((View)localObject3, (ViewGroup.LayoutParams)localObject4);
          }
          localObject1 = ((ArrayList)localObject1).iterator();
          while (((Iterator)localObject1).hasNext())
          {
            ...
            localObject2 = LayoutInflater.from(this).inflate(2131560984, null);
            localObject4 = (ImageView)((View)localObject2).findViewById(2131368236);
            ...
            localObject4 = (TextView)((View)localObject2).findViewById(2131371777);
            ((TextView)((View)localObject2).findViewById(2131380108)).setText((CharSequence)localObject3);
            localObject5 = (Button)((View)localObject2).findViewById(2131362165);
            ((Button)localObject5).setVisibility(0);
            localObject6 = new apgz(this);
            ((apgz)localObject6).jdField_a_of_type_JavaLangString = ((String)localObject3);
            ((apgz)localObject6).jdField_b_of_type_JavaLangString = ContactUtils.getBuddyNickName(this.app, (String)localObject3, true);
            ((apgz)localObject6).jdField_a_of_type_Boolean = false;
            ((View)localObject2).setTag(localObject6);
            ((TextView)localObject4).setText(((apgz)localObject6).jdField_b_of_type_JavaLangString);
            ((Button)localObject5).setTag(localObject6);
            ((Button)localObject5).setOnClickListener(new apgu(this));
      ...
      this.jdField_d_of_type_AndroidWidgetLinearLayout.removeAllViews();
      paramCardOCRInfo = (LinearLayout)this.jdField_c_of_type_AndroidWidgetRelativeLayout.findViewById(2131365450);
      localObject1 = this.jdField_c_of_type_AndroidWidgetRelativeLayout.findViewById(2131365432);
  ...
  private void a(String paramString1, String paramString2, List<String> paramList)
  {
    ...
    bcef.b(this.app, "CliOper", "", "", "0X80064E4", "0X80064E4", 0, 0, "", "", "", "");
  }
  ...
  private void a(String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      if ((!this.jdField_a_of_type_Apha.jdField_b_of_type_Boolean) && (((String)localObject2).equals(localObject1)) && (this.jdField_d_of_type_Boolean)) {}
      for (localObject1 = "";; localObject1 = localObject2)
      {
        ...
        return;
        localObject1 = localamsw.b(paramString);
        break;
        label148:
        if (localamsw == null) {}
        for (localObject1 = null;; localObject1 = localamsw.e(paramString))
        {
  ...
  private boolean a(ArrayList<String> paramArrayList1, ArrayList<String> paramArrayList2, ArrayList<String> paramArrayList3, ArrayList<String> paramArrayList4)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqBusinessCardDataBusinessCard != null)
    {
      if ((!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqBusinessCardDataBusinessCard.bindUin)) && ((((amsw)this.app.getManager(51)).b(this.jdField_a_of_type_ComTencentMobileqqBusinessCardDataBusinessCard.bindUin)) || (this.jdField_a_of_type_ComTencentMobileqqBusinessCardDataBusinessCard.cardType == 1))) {
  ...
  private void b(CardOCRInfo paramCardOCRInfo)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        aphs.a(this.app.getCurrentAccountUin(), i);
        return;
        if ((!paramCardOCRInfo.jdField_b_of_type_JavaUtilList.isEmpty()) || (!((ArrayList)localObject).isEmpty())) {
          break label247;
        }
  ...
  {
    RelativeLayout localRelativeLayout1 = (RelativeLayout)findViewById(2131364255);
    RelativeLayout localRelativeLayout2 = (RelativeLayout)findViewById(2131364231);
    Object localObject = (TextView)findViewById(2131371626);
    if (this.jdField_a_of_type_Int == 2)
    {
      ((TextView)localObject).setText(super.getResources().getString(2131693103));
      if (paramBoolean) {}
    }
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        if (this.jdField_a_of_type_Int == 2) {
          this.jdField_a_of_type_ComTencentMobileqqBusinessCardViewsClearEllipsisEditText.setHint(2131698044);
        }
        for (;;)
        {
          this.jdField_a_of_type_Apha = new apha(this, 96, this.jdField_a_of_type_ComTencentMobileqqBusinessCardViewsClearEllipsisEditText, 1);
          this.jdField_a_of_type_ComTencentMobileqqBusinessCardViewsClearEllipsisEditText.addTextChangedListener(this.jdField_a_of_type_Apha);
          ...
          this.jdField_b_of_type_ComTencentMobileqqBusinessCardViewsClearEllipsisEditText.setHint(2131698031);
          paramString1 = new apha(this, 30, this.jdField_b_of_type_ComTencentMobileqqBusinessCardViewsClearEllipsisEditText);
          ...
          paramString1 = (amsw)this.app.getManager(51);
          Card localCard;
          ...
          this.jdField_d_of_type_Boolean = true;
          break;
          ((TextView)localObject).setText(super.getResources().getString(2131698041));
          break;
          this.jdField_a_of_type_ComTencentMobileqqBusinessCardViewsClearEllipsisEditText.setHint(2131698042);
        }
      }
      ...
      this.jdField_a_of_type_ComTencentMobileqqBusinessCardViewsClearEllipsisEditText.setHint(amtj.a(2131700403));
      ...
      this.jdField_b_of_type_ComTencentMobileqqBusinessCardViewsClearEllipsisEditText.setHint(amtj.a(2131700398));
      return;
      label530:
      paramString1 = "";
    }
  ...
  private void c(String paramString)
  {
    if ((paramString != null) && (paramString.length() > 0))
    {
      ...
      try
      {
        ...
        paramString.mLoadingDrawable = super.getResources().getDrawable(2130844833);
        paramString.mFailedDrawable = super.getResources().getDrawable(2130844833);
    ...
    findViewById(2131372622).setVisibility(8);
  ...
  private void d()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqBusinessCardDataBusinessCard = this.jdField_a_of_type_Apgi.a(this.jdField_a_of_type_JavaLangString);
      if (this.jdField_a_of_type_ComTencentMobileqqBusinessCardDataBusinessCard == null) {
        ThreadManager.post(new BusinessCardEditActivity.1(this), 8, null, true);
      }
      if (this.jdField_a_of_type_Int != 3)
      {
        apgk.a(this.app, this.jdField_a_of_type_JavaLangString, false, 3);
    ...
    for (;;)
    {
      ...
      return;
      apgk.a(this.app, this.jdField_a_of_type_JavaLangString, true, 3);
      break;
      if (this.jdField_a_of_type_ComTencentMobileqqBusinessCardDataBusinessCard == null) {
        break;
      }
  ...
  {
    this.jdField_a_of_type_AndroidAppDialog = bfur.a(this, paramString, 2131692726, 2131693045, new apgn(this), new apgo(this));
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131376699));
    if (ImmersiveUtils.isSupporImmersive() == 1) {
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setFitsSystemWindows(true);
    }
    a();
    f();
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131364263));
    this.jdField_a_of_type_ComTencentMobileqqBusinessCardViewsClearEllipsisEditText = ((ClearEllipsisEditText)findViewById(2131364254));
    ...
    this.jdField_b_of_type_ComTencentMobileqqBusinessCardViewsClearEllipsisEditText = ((ClearEllipsisEditText)findViewById(2131364230));
    ...
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131365898));
    this.jdField_c_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131365654));
    if (this.jdField_a_of_type_ComTencentMobileqqBusinessCardDataBusinessCard != null)
    {
      c(this.jdField_a_of_type_ComTencentMobileqqBusinessCardDataBusinessCard.picUrl);
      b(this.jdField_a_of_type_ComTencentMobileqqBusinessCardDataBusinessCard.cardName, this.jdField_a_of_type_ComTencentMobileqqBusinessCardDataBusinessCard.company, true);
  ...
  private void f()
  {
    if (this.jdField_a_of_type_Boolean) {
      if (this.jdField_a_of_type_Int == 2)
      {
        this.jdField_a_of_type_AndroidWidgetTextView.setText(2131698037);
        this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
        this.jdField_c_of_type_AndroidWidgetTextView.setText(2131692310);
        this.jdField_b_of_type_AndroidWidgetTextView.setBackgroundDrawable(super.getResources().getDrawable(2130850593));
    ...
    do
    {
      do
      {
        ...
        if (this.jdField_a_of_type_Int == 3)
        {
          this.jdField_a_of_type_AndroidWidgetTextView.setText(2131698040);
          break;
        }
        this.jdField_a_of_type_AndroidWidgetTextView.setText(2131698036);
        break;
        if (this.jdField_a_of_type_Int == 3) {
          this.jdField_a_of_type_AndroidWidgetTextView.setText(2131698040);
        }
        for (;;)
        {
          this.jdField_c_of_type_AndroidWidgetTextView.setText(2131691727);
          if (this.jdField_b_of_type_Int == 2) {
            this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
          }
          this.jdField_b_of_type_AndroidWidgetTextView.setBackgroundDrawable(super.getResources().getDrawable(2130850593));
          this.jdField_a_of_type_AndroidWidgetButton.setText(2131698047);
          ...
          this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
          return;
          this.jdField_a_of_type_AndroidWidgetTextView.setText(2131698035);
        }
  ...
  private void g()
  {
    try
    {
      this.jdField_a_of_type_AndroidDatabaseContentObserver = new apgp(this, new Handler(this.app.getApp().getMainLooper()));
  ...
  protected void a()
  {
    ...
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131369099));
    this.jdField_c_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131363615));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)findViewById(2131363634));
  ...
  public void a(LinearLayout paramLinearLayout, String paramString, int paramInt)
  {
    ...
    localTextView.setHint(amtj.a(2131700419));
    localTextView.setTextColor(super.getResources().getColor(2131167012));
    localTextView.setGravity(16);
    localTextView.setBackgroundDrawable(super.getResources().getDrawable(2130850291));
    ...
    if (paramInt == 1)
    {
      ...
      localTextView.setOnClickListener(new apgy(this));
  ...
  public void a(LinearLayout paramLinearLayout, String paramString, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if (paramInt1 != 2)
    {
      ...
      ((EditText)localObject).setHint(2131698038);
      ((EditText)localObject).setBackgroundDrawable(super.getResources().getDrawable(2130850291));
    ...
    for (;;)
    {
      ...
      ((EditText)localObject).setTextColor(super.getResources().getColor(2131167012));
      ((EditText)localObject).setHintTextColor(super.getResources().getColor(2131165438));
      ((EditText)localObject).setGravity(16);
      paramLinearLayout.addView((View)localObject, localLayoutParams);
      ((EditText)localObject).addTextChangedListener(new apha(this, paramInt2, (EditText)localObject));
      if (paramBoolean)
      {
      ...
      ((EditText)localObject).setHint(2131698033);
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    localbjnw.b(2131698028);
    localbjnw.b(2131698049);
    localbjnw.c(2131690620);
    localbjnw.a(new apgm(this, paramString, localbjnw));
    localbjnw.show();
  }
  
  public void a(String paramString, int paramInt)
  {
    View localView = LayoutInflater.from(this).inflate(2131560983, null);
    localView.setTag(Integer.valueOf(paramInt));
    EditText localEditText = (EditText)localView.findViewById(2131374144);
    localEditText.addTextChangedListener(new apha(this, 15, localEditText));
    ...
    paramString.setOnClickListener(new apgs(this));
  ...
  public void a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    bcef.b(this.app, "CliOper", "", "", "0X80064E6", "0X80064E6", 0, 0, "", "", "", "");
  }
  ...
  public void a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131371303));
      this.jdField_c_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131374146));
      this.jdField_d_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131365437));
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131371297));
      this.jdField_d_of_type_AndroidWidgetTextView.setVisibility(0);
      this.jdField_d_of_type_AndroidWidgetTextView.setOnClickListener(this);
      this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131373953));
      this.jdField_e_of_type_AndroidWidgetTextView.setVisibility(0);
      this.jdField_e_of_type_AndroidWidgetTextView.setOnClickListener(this);
      this.jdField_f_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131365430));
      this.jdField_f_of_type_AndroidWidgetTextView.setVisibility(8);
      this.jdField_f_of_type_AndroidWidgetTextView.setOnClickListener(this);
      if (a())
      {
        this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131374147).setVisibility(8);
        this.jdField_e_of_type_AndroidWidgetTextView.setVisibility(8);
      }
      if (paramBoolean) {
    ...
    do
    {
      do
      {
        ...
        this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_c_of_type_AndroidWidgetRelativeLayout.findViewById(2131371303));
        this.jdField_c_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_c_of_type_AndroidWidgetRelativeLayout.findViewById(2131374146));
        this.jdField_d_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_c_of_type_AndroidWidgetRelativeLayout.findViewById(2131365437));
        if (a())
        {
          this.jdField_c_of_type_AndroidWidgetRelativeLayout.findViewById(2131374147).setVisibility(8);
          if (QLog.isColorLevel()) {
  ...
  public void doOnResume()
  {
    ...
    if (this.jdField_d_of_type_Int != 0) {
      bcef.b(this.app, "CliOper", "", "", "0X8007751", "0X8007751", this.jdField_d_of_type_Int, 0, "", "", "", "");
    }
  }
  ...
  public boolean onBackEvent()
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      {
        d(super.getResources().getString(2131694624));
        return true;
      }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        {
          ((apgi)this.app.getManager(112)).a(((BusinessCard)localObject2).bindUin, (BusinessCard)localObject2);
          if (!isFinishing())
          {
        ...
        {
          bcef.b(this.app, "CliOper", "", "", "0X8007754", "0X8007754", this.jdField_d_of_type_Int, 0, "", "", "", "");
          break;
          ...
          if (a((BusinessCard)localObject2, this.jdField_a_of_type_ComTencentMobileqqBusinessCardDataBusinessCard))
          {
            ...
            {
              apgk.b(this.app, (BusinessCard)localObject2, ((Boolean)localObject1).booleanValue());
              b(amtj.a(2131700399));
              continue;
            }
            apgk.a(this.app, (BusinessCard)localObject2, ((Boolean)localObject1).booleanValue());
            b(amtj.a(2131700393));
            continue;
          }
          if ((this.jdField_a_of_type_Boolean) && (this.jdField_b_of_type_Boolean) && (!isFinishing())) {
      ...
      a(true, false, true);
      bcef.b(this.app, "CliOper", "", "", "0X80064E2", "0X80064E2", 0, 0, "", "", "", "");
      continue;
      if ((this.jdField_a_of_type_ComTencentMobileqqBusinessCardDataBusinessCard != null) || (this.jdField_a_of_type_ComTencentMobileqqBusinessCardDataCardOCRInfo != null))
      {
        ...
        requestPermissions(new apgl(this), 1, new String[] { "android.permission.WRITE_CONTACTS" });
        continue;
        a(this.jdField_b_of_type_AndroidWidgetLinearLayout, null, 1, 15);
        this.jdField_e_of_type_Int += 1;
        if (this.jdField_e_of_type_Int >= 3) {
        ...
        if (this.jdField_d_of_type_Int != 0)
        {
          bcef.b(this.app, "CliOper", "", "", "0X8007752", "0X8007752", this.jdField_d_of_type_Int, 0, "", "", "", "");
          continue;
          ...
          if (this.jdField_f_of_type_Int >= 2)
          {
            ...
            if (this.jdField_g_of_type_Int >= 2)
            {
              ...
              overridePendingTransition(2130772309, 0);
            }
          }
        }
      }
