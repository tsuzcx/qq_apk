  ...
  extends BusinessCardObserver
{
  ...
  public void a(boolean paramBoolean, String paramString)
  {
    ...
    if (paramBoolean)
    {
      QQToast.a(this.a.getActivity(), 2, HardCodeUtil.a(2131701334), 0).b(this.a.getTitleBarHeight());
      this.a.finish();
      return;
    }
    QQToast.a(this.a.getActivity(), 1, HardCodeUtil.a(2131701329), 0).b(this.a.getTitleBarHeight());
  }
  ...
  public void b(boolean paramBoolean, String paramString)
  {
    ...
    if (paramBoolean)
    {
      this.a.b(HardCodeUtil.a(2131701331));
      ReportController.b(this.a.app, "CliOper", "", "", "0X8007748", "0X8007748", this.a.d, 0, "", "", "", "");
      return;
    }
    QQToast.a(this.a.getActivity(), 2, HardCodeUtil.a(2131701339), 0).b(this.a.getTitleBarHeight());
  }
  ...
  public void b(boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      localObject = ((Resources)localObject).getString(2131698589);
    ...
    paramString = ((Resources)localObject).getString(2131698587);
    if (paramInt == 66) {
      paramString = ((Resources)localObject).getString(2131698588);
    }
