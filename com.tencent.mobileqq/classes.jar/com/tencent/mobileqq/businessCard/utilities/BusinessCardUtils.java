...
public class BusinessCardUtils
{
  ...
  {
    BusinessCardManager localBusinessCardManager = (BusinessCardManager)paramQQAppInterface.getManager(QQManagerFactory.BUSINESS_CARD_MANAGER);
    ...
    for (;;)
    {
      ...
      {
        paramQQAppInterface = a(paramProfileCardInfo.jdField_a_of_type_ComTencentMobileqqDataCard.bCardInfo);
        if ((paramProfileCardInfo.jdField_a_of_type_ComTencentMobileqqDataCard.bCardInfo != null) && (!TextUtils.isEmpty(paramQQAppInterface.cardId))) {
  ...
  public static void a(String paramString, URLImageView paramURLImageView, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        localURLDrawableOptions.mLoadingDrawable = paramURLImageView.getContext().getResources().getDrawable(2130845068);
