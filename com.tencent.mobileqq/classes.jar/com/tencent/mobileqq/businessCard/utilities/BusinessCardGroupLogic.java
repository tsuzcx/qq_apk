  ...
  implements View.OnClickListener
{
  ...
  public BusinessCardGroupLogic(BusinessCardListActivity paramBusinessCardListActivity, View paramView)
  {
    ...
    a(this.jdField_a_of_type_AndroidWidgetTextView, 2130843732, 10);
  }
  ...
  private void b()
  {
    ...
    this.jdField_a_of_type_AndroidViewView = ((ViewStub)this.jdField_a_of_type_ComTencentMobileqqBusinessCardActivityBusinessCardListActivity.findViewById(2131368592)).inflate();
    View localView = this.jdField_a_of_type_AndroidViewView.findViewById(2131368630);
    SwipListView localSwipListView = (SwipListView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368631);
    if (VersionUtils.c()) {
    ...
    localView.setOnClickListener(new abho(this));
    ...
    localSwipListView.setOnItemClickListener(new abhp(this));
  }
  ...
  public void a()
  {
    ...
    a(this.jdField_a_of_type_AndroidWidgetTextView, 2130843733, 10);
  }
