...
public abstract class ReportLogHelper
{
  ...
  public static void a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    //   6: dup
    //   7: getstatic 85	com/tencent/mobileqq/app/AppConstants:LOG_PATH_SDCARD	Ljava/lang/String;
    ...
    //   41: getstatic 85	com/tencent/mobileqq/app/AppConstants:LOG_PATH_SDCARD	Ljava/lang/String;
    ...
    //   109: invokestatic 104	com/tencent/common/config/AppSetting:b	()Ljava/lang/String;
    ...
    //   118: invokevirtual 107	java/io/FileWriter:write	(Ljava/lang/String;)V
    //   121: aload_3
    //   122: ldc 109
    //   124: invokevirtual 107	java/io/FileWriter:write	(Ljava/lang/String;)V
    //   127: new 111	android/text/format/Time
    //   130: dup
    //   131: invokespecial 112	android/text/format/Time:<init>	()V
    //   134: astore 4
    //   136: aload 4
    //   138: invokevirtual 115	android/text/format/Time:setToNow	()V
    //   141: aload_3
    ...
    //   149: aload 4
    //   151: ldc 117
    //   153: invokevirtual 121	android/text/format/Time:format	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   167: invokevirtual 107	java/io/FileWriter:write	(Ljava/lang/String;)V
    //   170: aload_3
    //   171: ldc 125
    //   173: invokevirtual 107	java/io/FileWriter:write	(Ljava/lang/String;)V
    //   176: aload_3
    //   177: ldc 109
    //   179: invokevirtual 107	java/io/FileWriter:write	(Ljava/lang/String;)V
    //   182: aload_0
    //   183: ifnull +31 -> 214
    //   186: aload_3
    //   187: new 49	java/lang/StringBuilder
    //   190: dup
    ...
    //   211: invokevirtual 107	java/io/FileWriter:write	(Ljava/lang/String;)V
    //   214: aload_3
    //   215: aload_1
    //   216: invokevirtual 107	java/io/FileWriter:write	(Ljava/lang/String;)V
    //   219: aload_3
    //   220: ldc 109
    //   222: invokevirtual 107	java/io/FileWriter:write	(Ljava/lang/String;)V
    //   225: aload_3
    //   226: invokevirtual 132	java/io/FileWriter:close	()V
    //   229: iconst_0
    //   230: ifeq +11 -> 241
    //   233: new 134	java/lang/NullPointerException
    //   236: dup
    //   237: invokespecial 135	java/lang/NullPointerException:<init>	()V
    //   240: athrow
    //   241: return
    //   242: astore_1
    //   243: aload 4
    //   245: astore_0
    //   246: aload_1
    //   247: invokevirtual 138	java/lang/Exception:printStackTrace	()V
    //   250: aload_0
    //   251: ifnull -10 -> 241
    //   254: aload_0
    //   255: invokevirtual 132	java/io/FileWriter:close	()V
    //   258: return
    //   259: astore_0
    //   260: return
    //   261: astore_0
    ...
    //   265: ifnull +7 -> 272
    //   268: aload_1
    //   269: invokevirtual 132	java/io/FileWriter:close	()V
    //   272: aload_0
    //   273: athrow
    //   274: astore_0
    //   275: return
