...
{
  WebInputHandler$2(WebInputHandler paramWebInputHandler, String paramString, BaseJsPluginEngine paramBaseJsPluginEngine, PageWebview paramPageWebview) {}
  ...
  {
    if ((WebInputHandler.access$100(this.this$0).containsKey(Integer.valueOf(WebInputHandler.access$000(this.this$0)))) && (paramCharSequence.toString().equals(WebInputHandler.access$100(this.this$0).get(Integer.valueOf(WebInputHandler.access$000(this.this$0)))))) {
      return;
    }
    WebInputHandler.access$100(this.this$0).remove(Integer.valueOf(WebInputHandler.access$000(this.this$0)));
    JSONObject localJSONObject = new JSONObject();
    try
    {
      localJSONObject.put("inputId", WebInputHandler.access$000(this.this$0));
      if (paramInt3 == 0)
      {
