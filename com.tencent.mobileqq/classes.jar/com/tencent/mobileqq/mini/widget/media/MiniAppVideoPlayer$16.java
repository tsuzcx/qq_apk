  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    MiniAppVideoPlayer.access$5202(this.this$0, MiniAppVideoPlayer.access$800(this.this$0));
    MiniAppVideoPlayer.access$5302(this.this$0, MiniAppVideoPlayer.access$800(this.this$0).getCurrentPostion());
    ...
    if ((this.this$0.webviewContainer != null) && (this.this$0.webviewContainer.appBrandRuntime != null) && (this.this$0.webviewContainer.appBrandRuntime.getCurPage() != null))
    {
      if (this.this$0.webviewContainer.appBrandRuntime.getCurPage().getNavBar() != null) {
        this.this$0.webviewContainer.appBrandRuntime.getCurPage().getNavBar().setVisibility(MiniAppVideoPlayer.access$4300(this.this$0));
      }
      if (this.this$0.webviewContainer.appBrandRuntime.getCurPage().getTabBar() != null) {
        this.this$0.webviewContainer.appBrandRuntime.getCurPage().getTabBar().setVisibility(MiniAppVideoPlayer.access$4400(this.this$0));
      }
    }
