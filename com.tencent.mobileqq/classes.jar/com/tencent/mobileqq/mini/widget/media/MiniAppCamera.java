  ...
  extends GlCameraHolderSurfaceView
{
  ...
  {
    if (this.ffmpeg == null) {
      this.ffmpeg = wae.a(BaseApplicationImpl.getApplication());
    }
    paramWebviewContainer.showLoading(ajyc.a(2131706780));
  ...
  private static String saveJpeg(Bitmap paramBitmap, File paramFile, String paramString)
  {
    ...
    //   68: iload_3
    //   69: invokestatic 416	bbdr:a	(Ljava/lang/String;Ljava/lang/String;III)Ljava/lang/String;
    //   72: astore_0
    //   73: aload 5
    //   75: ifnull +8 -> 83
    //   78: aload 5
