  ...
  extends GlCameraHolderSurfaceView
{
  ...
  {
    if (this.ffmpeg == null) {
      this.ffmpeg = vni.a(BaseApplicationImpl.getApplication());
    }
    paramWebviewContainer.showLoading(ajjy.a(2131640995));
  ...
  private static String saveJpeg(Bitmap paramBitmap, File paramFile, String paramString)
  {
    ...
    //   68: iload_3
    //   69: invokestatic 416	bacm:a	(Ljava/lang/String;Ljava/lang/String;III)Ljava/lang/String;
    //   72: astore_0
    //   73: aload 5
    //   75: ifnull +8 -> 83
    //   78: aload 5
