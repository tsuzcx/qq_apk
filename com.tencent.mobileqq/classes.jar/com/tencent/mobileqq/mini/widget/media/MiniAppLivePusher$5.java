...
{
  MiniAppLivePusher$5(MiniAppLivePusher paramMiniAppLivePusher, String paramString1, String paramString2, String paramString3, JSONObject paramJSONObject, String paramString4) {}
  
  public void onDownloadCanceled(String paramString)
  {
    MiniAppLivePusher.access$200(this.this$0).remove(this.val$downloadId, this.val$BGMUrl);
  ...
  {
    if (MiniAppLivePusher.access$300(this.this$0))
    {
  ...
  public void onDownloadSucceed(String paramString, DownloadResult paramDownloadResult)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
          ...
          if (localFile.exists())
          {
            ...
            if (localFile.isFile())
            {
              ...
              if (localFile.length() > 0L)
              {
                ...
                localObject = bbdj.a(this.val$BGMFilePath);
        ...
        try
        {
          if ((!bbdj.a(localFile, paramString)) || (!paramString.exists()) || (paramString.length() != localFile.length())) {
            continue;
          }
      ...
      MiniAppLivePusher.access$200(this.this$0).remove(this.val$downloadId);
