  ...
  implements TXLivePushListenerReflect.ITXLivePushListener, TXLivePushListenerReflect.OnBGMNotify
{
  ...
  {
    bjue.a(paramObject, "disableLog", false, bjue.a(new Class[] { Boolean.TYPE }), new Object[] { paramBoolean });
  }
  
  private void txLivePlayer_setVisibility(int paramInt, Object paramObject)
  {
    bjue.a(paramObject, "setVisibility", false, bjue.a(new Class[] { Integer.TYPE }), new Object[] { Integer.valueOf(paramInt) });
  }
  ...
  public TXJSAdapterError updateLivePusher(Bundle paramBundle)
  {
    if (paramBundle == null) {
      return new TXJSAdapterError(-1, "invalid params");
    }
    printJSParams("updateLivePusher", paramBundle);
    if (!this.mInited) {
      return new TXJSAdapterError(-3, "uninited livePusher");
    }
    parseAndApplyParams(paramBundle, false);
    String str = paramBundle.getString("pushUrl", this.mPusherUrl);
