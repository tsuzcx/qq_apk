...
class MiniAppVideoPlayer$20
  implements TVK_IMediaPlayer.OnCaptureImageListener
{
  private boolean hasCallImageFailed;
  private boolean hasCallImageSucceed;
  
  MiniAppVideoPlayer$20(MiniAppVideoPlayer paramMiniAppVideoPlayer, TVK_IMediaPlayer.OnCaptureImageListener paramOnCaptureImageListener) {}
  ...
  public void onCaptureImageFailed(TVK_IMediaPlayer paramTVK_IMediaPlayer, int paramInt1, int paramInt2)
  {
    ...
    try
    {
      MiniAppVideoPlayer.access$1100(this.this$0).setOnCaptureImageListener(null);
  ...
  public void onCaptureImageSucceed(TVK_IMediaPlayer paramTVK_IMediaPlayer, int paramInt1, int paramInt2, int paramInt3, Bitmap paramBitmap)
  {
    ...
    ThreadManagerV2.getUIHandlerV2().post(new MiniAppVideoPlayer.20.1(this, localCanvas, paramTVK_IMediaPlayer, paramInt1, paramInt2, paramInt3, paramBitmap));
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes8.jar
 * Qualified Name:     com.tencent.mobileqq.mini.widget.media.MiniAppVideoPlayer.20
