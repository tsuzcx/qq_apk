  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (this.this$0.webviewContainer == null)
    {
      localObject = new RelativeLayout.LayoutParams(DisplayUtil.getRealHeight(this.this$0.getContext()), ImmersiveUtils.a());
    ...
    for (;;)
    {
      ...
      return;
      localObject = new FrameLayout.LayoutParams(DisplayUtil.getRealHeight(this.this$0.getContext()), ImmersiveUtils.a());
