...
class MiniAppVideoPlayer$19$1
  implements Runnable
{
  MiniAppVideoPlayer$19$1(MiniAppVideoPlayer.19 param19, Canvas paramCanvas, TVK_IMediaPlayer paramTVK_IMediaPlayer, int paramInt1, int paramInt2, int paramInt3, Bitmap paramBitmap) {}
  ...
  public void run()
  {
    ...
    try
    {
      ...
      MiniAppVideoPlayer.19.access$5902(this.this$1, true);
      return;
    }
