...
class PayJsPlugin$4
  implements Runnable
{
  PayJsPlugin$4(PayJsPlugin paramPayJsPlugin, String paramString1, String paramString2, boolean paramBoolean, int paramInt, String paramString3, Activity paramActivity) {}
  ...
  public void run()
  {
    ...
    {
      MiniAppController.getInstance().setActivityResultListener(new PayJsPlugin.4.1(this));
      localIntent = new Intent();
      localIntent.putExtras(localBundle);
      localIntent.putExtra("mini_event_seq", this.val$seq);
      localIntent.putExtra("mini_event_name", this.val$eventName);
      abtq.a(this.val$activity, localIntent, PublicTransFragmentActivityForTool.class, MiniGamePayFragment.class, 3002);
    }
