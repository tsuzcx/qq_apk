  ...
  implements Runnable
{
  ...
  public void run()
  {
    if ((AudioJsPlugin.InnerAudioManager.access$1700(this.this$1) != null) && (AudioJsPlugin.InnerAudioManager.access$1700(this.this$1).isPlaying())) {
      AudioJsPlugin.InnerAudioManager.access$1700(this.this$1).pause();
    }
  }
}
