...
class DataJsPlugin$25$1
  implements zrt
{
  DataJsPlugin$25$1(DataJsPlugin.25 param25) {}
  ...
  public void onFailure(int paramInt, String paramString)
  {
    synchronized (DataJsPlugin.access$200(this.this$1.this$0))
    {
      ...
      if (localIterator.hasNext()) {
        ((zrt)localIterator.next()).onFailure(paramInt, paramString);
      }
    }
  ...
  public void onPermission(int paramInt)
  {
    synchronized (DataJsPlugin.access$200(this.this$1.this$0))
    {
      ...
      Iterator localIterator = DataJsPlugin.access$200(this.this$1.this$0).iterator();
      if (localIterator.hasNext()) {
        ((zrt)localIterator.next()).onPermission(paramInt);
      }
    }
    DataJsPlugin.access$200(this.this$1.this$0).clear();
  }
  ...
  public void onSuccess(JSONObject paramJSONObject)
  {
    synchronized (DataJsPlugin.access$200(this.this$1.this$0))
    {
      ...
      Iterator localIterator = DataJsPlugin.access$200(this.this$1.this$0).iterator();
      if (localIterator.hasNext()) {
        ((zrt)localIterator.next()).onSuccess(paramJSONObject);
      }
    }
    DataJsPlugin.access$200(this.this$1.this$0).clear();
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.mini.appbrand.jsapi.plugins.DataJsPlugin.25.1
