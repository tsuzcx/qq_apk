...
{
  PayJsPlugin$3(PayJsPlugin paramPayJsPlugin, JSONObject paramJSONObject, String paramString, int paramInt) {}
  ...
  public void onCmdListener(boolean paramBoolean, JSONObject paramJSONObject)
  {
    if (paramBoolean)
    {
      ...
      AppBrandTask.runTaskOnUiThread(new PayJsPlugin.3.1(this, str1));
