...
{
  FileJsPlugin$18(FileJsPlugin paramFileJsPlugin, String paramString1, JsRuntime paramJsRuntime, String paramString2, int paramInt, boolean paramBoolean) {}
  ...
  public String run()
  {
    ...
    Object localObject3 = new VFSFile((String)localObject1);
    if (!((VFSFile)localObject3).exists()) {
    ...
    Object localObject2;
    if ((this.val$recursive) && (((VFSFile)localObject3).isDirectory()))
    {
      try
      {
