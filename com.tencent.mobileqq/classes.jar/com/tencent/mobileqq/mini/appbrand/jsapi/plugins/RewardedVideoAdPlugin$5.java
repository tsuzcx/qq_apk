...
{
  RewardedVideoAdPlugin$5(RewardedVideoAdPlugin paramRewardedVideoAdPlugin, String paramString1, JsRuntime paramJsRuntime, String paramString2, int paramInt1, int paramInt2) {}
    ...
    if (paramBoolean)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          yju.a().a(RewardedVideoAdPlugin.access$900(this.this$0));
