...
{
  BookShelfJsPlugin$5(BookShelfJsPlugin paramBookShelfJsPlugin, String paramString, JsRuntime paramJsRuntime, int paramInt) {}
  ...
  public void onCmdListener(boolean paramBoolean, JSONObject paramJSONObject)
  {
    ...
    QLog.e("BookShelfJsPlugin", 1, "handleQueryBookshelf fail");
    paramJSONObject = ApiUtil.wrapCallbackFail(this.val$eventName, null);
    this.val$webview.evaluateCallbackJs(this.val$callbackId, paramJSONObject.toString());
    return;
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.mini.appbrand.jsapi.plugins.BookShelfJsPlugin.5
