...
class UIJsPlugin$35
  implements Runnable
{
  UIJsPlugin$35(UIJsPlugin paramUIJsPlugin, JsRuntime paramJsRuntime, JSONObject paramJSONObject, String paramString, int paramInt) {}
  ...
  public void run()
  {
    ...
    for (localObject = ((AbsAppBrandPage)localObject).getCurrentWebviewContainer();; localObject = null)
    {
      if (localObject != null)
      {
        ((WebviewContainer)localObject).insertScrollView(this.val$jsonObject);
