...
{
  FileJsPlugin$4(FileJsPlugin paramFileJsPlugin, long paramLong, String paramString1, JsRuntime paramJsRuntime, String paramString2, JSONObject paramJSONObject) {}
  ...
  public void onDownloadSucceed(String paramString, DownloadResult paramDownloadResult)
  {
    ...
    for (;;)
    {
        ...
        if (((File)localObject8).exists())
        {
          ...
          if (((File)localObject8).isFile())
          {
            ...
            if (((File)localObject8).length() > 0L)
            {
              ...
              localObject3 = bace.a(this.val$filePath);
      ...
      try
      {
        if ((!bace.a((File)localObject8, (File)localObject1)) || (!((File)localObject1).exists()) || (((File)localObject1).length() != ((File)localObject8).length())) {
          continue;
        }
      ...
      try
      {
        ...
        if (!bace.d(this.val$filePath, (String)localObject1)) {
          continue;
        }
        bace.d(this.val$filePath);
