...
class MapViewJsPlugin$14
  implements Runnable
{
  MapViewJsPlugin$14(MapViewJsPlugin paramMapViewJsPlugin, JsRuntime paramJsRuntime, String paramString1, String paramString2, int paramInt) {}
  ...
  public void run()
  {
    ...
    for (localObject1 = ((AbsAppBrandPage)localObject1).getCurrentWebviewContainer(); localObject1 != null; localObject2 = null) {
      try
      {
        ...
        if (localObject1 != null)
        {
          ((MapContext)localObject1).addMapControls(localJSONObject);
 ...
 * Qualified Name:     com.tencent.mobileqq.mini.appbrand.jsapi.plugins.MapViewJsPlugin.14
