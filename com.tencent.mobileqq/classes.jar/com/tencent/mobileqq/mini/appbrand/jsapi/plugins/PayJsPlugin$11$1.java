...
class PayJsPlugin$11$1
  implements MiniAppController.ActivityResultListener
{
  PayJsPlugin$11$1(PayJsPlugin.11 param11) {}
    ...
    if (paramInt1 == 3002)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          PayJsPlugin.access$500(this.this$1.this$0, paramInt1, str1, paramIntent);
 ...
 * Qualified Name:     com.tencent.mobileqq.mini.appbrand.jsapi.plugins.PayJsPlugin.11.1
