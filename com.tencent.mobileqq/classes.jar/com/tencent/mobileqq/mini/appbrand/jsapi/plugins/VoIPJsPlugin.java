  ...
  extends BaseJsPlugin
{
  ...
  public String handleNativeRequest(String paramString1, String paramString2, JsRuntime paramJsRuntime, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      paramJsRuntime.evaluateCallbackJs(paramInt, ApiUtil.wrapCallbackFail(paramString1, (JSONObject)localObject2, ajjy.a(2131651068)).toString());
  ...
  {
    bcnw.a().a(BaseApplicationImpl.getContext());
  ...
  public void onPause()
  {
    ...
    try
    {
      ...
      localJSONObject.put("errMsg", ajjy.a(2131651067));
