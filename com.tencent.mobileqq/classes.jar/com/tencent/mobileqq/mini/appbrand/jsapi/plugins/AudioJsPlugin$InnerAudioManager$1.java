  ...
  implements MiniAppAudioPlayer.OnPreparedListener
{
  ...
  public void onPrepared()
  {
    ...
    if ((this.val$autoPlay) && (AudioJsPlugin.InnerAudioManager.access$1700(this.this$1) != null))
    {
      AudioJsPlugin.InnerAudioManager.access$1700(this.this$1).setLooping(this.val$loop);
      AudioJsPlugin.InnerAudioManager.access$1700(this.this$1).setVolume((float)this.val$volume);
      localMiniAppAudioPlayer = AudioJsPlugin.InnerAudioManager.access$1700(this.this$1);
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      AudioJsPlugin.InnerAudioManager.access$1700(this.this$1).start();
