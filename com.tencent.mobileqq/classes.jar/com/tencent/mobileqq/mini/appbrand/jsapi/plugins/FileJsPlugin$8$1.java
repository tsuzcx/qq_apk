  ...
  public void onReceiveValue(String paramString)
  {
    ...
    if ((paramString != null) && (paramString.startsWith("http")))
    {
      if (aome.a().a() == null)
      {
        ...
        paramString.putString("_filename_from_dlg", this.this$1.this$0.jsPluginEngine.getActivityContext().getString(2131629108));
    ...
    apck.c(this.this$1.this$0.jsPluginEngine.getActivityContext(), "http://appchannel.html5.qq.com/directdown?app=qqbrowser&channel=10386");
  }
}
