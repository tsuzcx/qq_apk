  ...
  extends BaseJsPlugin
{
  ...
  public String handleNativeRequest(String paramString1, String paramString2, JsRuntime paramJsRuntime, int paramInt)
  {
    ...
    if (("getStorage".equals(paramString1)) || ("getStorageSync".equals(paramString1))) {
      ...
      {
        paramString2 = new JSONObject(paramString2);
        return execStorageTask(paramString1, new StoragePlugin.3(this, bhos.a(paramString2.optString("key")), paramJsRuntime, paramString1, paramInt));
      }
    ...
    if (("removeStorage".equals(paramString1)) || ("removeStorageSync".equals(paramString1))) {
      ...
      {
        paramString2 = new JSONObject(paramString2);
        return execStorageTask(paramString1, new StoragePlugin.5(this, bhos.a(paramString2.optString("key")), paramJsRuntime, paramString1, paramInt));
      }
      catch (Throwable paramString2)
      {
        for (;;)
    ...
    if ("getGlobalStorage".equals(paramString1)) {
      ...
      {
        paramString2 = new JSONObject(paramString2);
        return execStorageTask(paramString1, new StoragePlugin.7(this, bhos.a(paramString2.optString("key")), paramJsRuntime, paramString1, paramInt));
      }
      catch (Throwable paramString2)
      {
        for (;;)
    ...
    if ("setGlobalStorage".equals(paramString1)) {
      ...
      {
        paramString2 = new JSONObject(paramString2);
        return execStorageTask(paramString1, new StoragePlugin.8(this, bhos.a(paramString2.optString("key")), paramString2.optString("data"), paramJsRuntime, paramString1, paramInt));
      }
      catch (Throwable paramString2)
      {
        for (;;)
