  ...
  implements FileJsPlugin.FileTask
{
  ...
  public String run()
  {
    ...
    {
      l3 = FileUtils.getFileSizes(MiniAppFileManager.getInstance().getSaveStorePath(this.val$tempFilePath));
      if (!MiniAppFileManager.getInstance().isFolderCanWrite(1, l2 - l3))
      {
      ...
      {
        MiniAppFileManager.getInstance().updateFolderSize(1, l2 - l3);
    ...
    if (!MiniAppFileManager.getInstance().isFolderCanWrite(2, l2 - l3))
    {
      FileJsPlugin.access$100(this.this$0, this.val$event, false, this.val$startMS, l1, (String)localObject);
      return FileJsPlugin.access$200(this.this$0, this.val$webview, this.val$event, null, "the maximum size of the file storage is exceeded", this.val$callbackId);
    }
    ...
    try
    {
      MiniAppFileManager.getInstance().updateFolderSize(2, l2 - l3);
