  ...
  public void onCmdListener(boolean paramBoolean, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      if (paramBoolean)
      {
        ...
        {
          this.this$0.jsPluginEngine.callbackJsEventFail(this.val$webview, this.val$event, null, this.this$0.jsPluginEngine.activityContext.getString(2131693678), this.val$callbackId);
          return;
        }
        try
        {
