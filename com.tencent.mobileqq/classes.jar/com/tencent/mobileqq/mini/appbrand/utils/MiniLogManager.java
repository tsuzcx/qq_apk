...
public class MiniLogManager
{
  ...
  {
    if ((baip.a(paramString1)) || (baip.a(paramString2)) || (!new File(paramString2).exists())) {
      return;
    }
    agkg.a(new GetMiniAppReq(paramString1, paramInt2, paramInt1, ""), new MiniLogManager.6(paramString2, paramInt1));
  }
