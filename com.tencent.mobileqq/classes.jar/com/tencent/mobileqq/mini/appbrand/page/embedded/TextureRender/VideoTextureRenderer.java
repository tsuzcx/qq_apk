  ...
  implements SurfaceTexture.OnFrameAvailableListener
{
  ...
  private void adjustViewport()
  {
    ...
    if ("contain".equals(this.objectFit))
    {
      ...
      QLog.d("miniapp-embedded", 2, "contain scale : " + f1);
    ...
    for (;;)
    {
      ...
      else if ("cover".equals(this.objectFit))
      {
        ...
        QLog.d("miniapp-embedded", 2, "cover scale : " + f1);
        f2 = Math.round((this.width - this.videoWidth * f1) * 0.5F);
        f3 = Math.round((this.height - this.videoHeight * f1) * 0.5F);
        GLES20.glViewport((int)f2, (int)f3, (int)(this.videoWidth * f1), (int)(f1 * this.videoHeight));
      }
  ...
  public void checkGlError(String paramString)
  {
    for (;;)
    {
      ...
      QLog.d("miniapp-embedded", 1, paramString + ": glError " + GLUtils.getEGLErrorString(i));
    }
  }
  ...
  {
    QLog.d("miniapp-embedded", 1, "initGLComponents ： " + Thread.currentThread());
    setupVertexBuffer();
  ...
  {
    QLog.e("miniapp-embedded", 2, "setSurfaceSize " + paramInt1 + "; " + paramInt2);
  ...
  {
    QLog.e("miniapp-embedded", 2, "setVideoSize " + paramInt1 + "; " + paramInt2 + "; " + paramString);
 ...
 * Qualified Name:     com.tencent.mobileqq.mini.appbrand.page.embedded.TextureRender.VideoTextureRenderer
