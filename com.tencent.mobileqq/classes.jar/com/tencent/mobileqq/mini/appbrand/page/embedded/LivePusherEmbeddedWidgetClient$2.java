  ...
  implements TXLivePushListenerReflect.OnBGMNotify
{
  ...
  public void onBGMComplete(int paramInt)
  {
    ...
    try
    {
      ...
      LivePusherEmbeddedWidgetClient.access$300(this.this$0, this.val$webview, "onXWebLivePusherBGMComplete", localJSONObject.toString(), LivePusherEmbeddedWidgetClient.access$200(this.this$0));
      return;
    }
  ...
  public void onBGMProgress(long paramLong1, long paramLong2)
  {
    ...
    try
    {
      ...
      LivePusherEmbeddedWidgetClient.access$300(this.this$0, this.val$webview, "onXWebLivePusherBGMProgress", localJSONObject.toString(), LivePusherEmbeddedWidgetClient.access$200(this.this$0));
      return;
    }
    catch (JSONException localJSONException)
    {
  ...
  public void onBGMStart()
  {
    ...
    {
      localJSONObject.put("viewId", LivePusherEmbeddedWidgetClient.access$100(this.this$0));
      LivePusherEmbeddedWidgetClient.access$300(this.this$0, this.val$webview, "onXWebLivePusherBGMStart", localJSONObject.toString(), LivePusherEmbeddedWidgetClient.access$200(this.this$0));
      return;
    }
    catch (JSONException localJSONException)
    {
