  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (AppBrandPageContainer.access$100(this.this$0) != null)
    {
      this.this$0.appBrandRuntime.webviewPool.recyclePageWebview(AppBrandPageContainer.access$100(this.this$0).getCurrentPageWebview(), BaseApplicationImpl.sApplication);
      AppBrandPageContainer.access$100(this.this$0).cleanup();
      this.this$0.pageLinkedList.remove(AppBrandPageContainer.access$100(this.this$0));
      AppBrandPageContainer.access$102(this.this$0, null);
    }
    Object localObject;
