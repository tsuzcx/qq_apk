...
public class BrandPagePool
{
  ...
  public View getLoadingRootView()
  {
    ...
    if (localView2 == null) {
      localView1 = LayoutInflater.from(BaseApplicationImpl.getContext()).inflate(2131559290, null);
    }
    return localView1;
  }
  ...
  public void preloadLoadingUI()
  {
    ...
    this.mLoadingRootView = LayoutInflater.from(BaseApplicationImpl.getContext()).inflate(2131559290, null);
  }
}
