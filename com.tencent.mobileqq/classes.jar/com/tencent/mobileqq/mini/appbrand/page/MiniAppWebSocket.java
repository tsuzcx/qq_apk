  ...
  extends BaseMiniWebSocket
{
  ...
  private ConcurrentLinkedQueue<MiniAppWebSocket.EvaluateData> mEvaluateDatas = new ConcurrentLinkedQueue();
  ...
  public void evaluateJs(String paramString, ValueCallback paramValueCallback)
  {
    if (this.hasSetupContextResult)
    {
      ...
      {
        MiniAppWebSocket.EvaluateData localEvaluateData = (MiniAppWebSocket.EvaluateData)this.mEvaluateDatas.poll();
    ...
    this.mEvaluateDatas.add(new MiniAppWebSocket.EvaluateData(this, paramString, paramValueCallback));
  }
  ...
  public String getDefaultConfigScript()
  {
    try
    {
      ...
      str2 = String.format("if (typeof __qqConfig === 'undefined') var __qqConfig = {};var __tempConfig = JSON.parse('%1$s'); Object.assign(__qqConfig, __tempConfig);__qqConfig.accountInfo=JSON.parse('%2$s'); __qqConfig.envVersion='" + str1 + "';__qqConfig.QUA='" + bfpk.a() + "';var __wxIndexPage = 'page/index/index.html';", new Object[] { localJSONObject2.toString(), localJSONObject1.toString() });
      str1 = str2;
  ...
  public JSONObject getDeviceInfo()
  {
    try
    {
      ...
      localJSONObject.put("qq_version", "8.2.6");
      localJSONObject.put("pixel_ratio", "3");
      localJSONObject.put("screen_width", bajq.a());
