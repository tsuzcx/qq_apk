  ...
  public void loadBaselib(Context paramContext, bdno parambdno)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramContext = new bdnn();
        str2 = StorageUtil.getPreference().getString("downloadUrl", "");
        str1 = StorageUtil.getPreference().getString("version", "1.10.0.00173");
      ...
      try
      {
        if (!BaseLibInfo.needUpdateVersion("1.10.0.00173", str1)) {
          break label507;
        }
        QLog.e("minisdk-start", 1, "download baselib invalid! use assert baselib. download_version=" + str1 + " assert_version=" + "1.10.0.00173");
        if ((!paramContext.a()) && (i != 0))
        {
          QLog.d("minisdk-start", 1, "readJsFromFile from download.");
          paramContext.a = bdgo.a(new File(str2, "QView.js"));
          paramContext.b = bdgo.a(new File(str2, "QLogic.js"));
          paramContext.h = (str2 + File.separator + "QLogic.js");
          paramContext.c = bdgo.a(new File(str2, "QVConsole.js"));
          paramContext.d = bdgo.a(new File(str2, "QRemoteDebug.js"));
          paramContext.e = bdgo.a(new File(str2, "QWebview.js"));
          paramContext.f = bdgo.a(new File(str2, "QWorker.js"));
          paramContext.g = bdgo.a(new File(str2, "QPageFrame.html"));
        }
        if (!paramContext.a())
        {
