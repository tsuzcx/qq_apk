  ...
  implements Handler.Callback
{
  ...
  public boolean doOnCreate(BaseActivity paramBaseActivity, Bundle paramBundle)
  {
    ...
    this.mLoadingLayout = this.mActivity.findViewById(2131303826);
    this.mLoadingLayout.setVisibility(8);
    this.mRootView = this.mActivity.findViewById(2131304526);
    return bool;
  }
  ...
  public void startLoading(BaseActivity paramBaseActivity, Bundle paramBundle)
  {
    ...
    {
      Toast.makeText(paramBaseActivity, ajjy.a(2131640016), 1).show();
      paramBaseActivity.finish();
      return;
    }
    ...
    localObject = (ViewGroup)this.mLoadingLayout.findViewById(2131299128);
    ...
    for (;;)
    {
      ...
      localObject = (ImageView)this.mLoadingLayout.findViewById(2131297953);
      if (!TextUtils.isEmpty(MiniAppGlobal.CAPSULE_CLOSE_URL)) {
        ((ImageView)localObject).setImageDrawable(MiniAppUtils.getIcon(paramBaseActivity, MiniAppGlobal.CAPSULE_CLOSE_URL, true, 2130840808, 40, 30));
      }
