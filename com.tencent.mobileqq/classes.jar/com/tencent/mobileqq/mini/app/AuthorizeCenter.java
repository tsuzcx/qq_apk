...
public class AuthorizeCenter
{
  ...
  private static void staticInit()
  {
    ...
    catch (Throwable localThrowable)
    {
      ...
      scopeTitleMap.put("scope.userLocation", amtj.a(2131699961));
      scopeTitleMap.put("scope.userInfo", amtj.a(2131699960));
      scopeTitleMap.put("scope.address", amtj.a(2131699967));
      scopeTitleMap.put("scope.invoiceTitle", amtj.a(2131699972));
      scopeTitleMap.put("scope.invoice", "获取你的发票信息");
      scopeTitleMap.put("scope.qqrun", amtj.a(2131693801));
      scopeTitleMap.put("scope.record", amtj.a(2131699973));
      scopeTitleMap.put("scope.writePhotosAlbum", amtj.a(2131699975));
      scopeTitleMap.put("scope.camera", amtj.a(2131699981));
      scopeTitleMap.put("scope.personalize", amtj.a(2131699969));
      scopeTitleMap.put("setting.appMsgSubscribed", amtj.a(2131699985));
      scopeTitleMap.put("setting.addFriend", amtj.a(2131699983));
      scopeTitleMap.put("scope.getPhoneNumber", amtj.a(2131693800));
      scopeTitleMap.put("scope.insertBookShelf", amtj.a(2131693793));
      scopeDescMap.put("scope.userLocation", "");
      scopeDescMap.put("scope.userInfo", amtj.a(2131693795));
      ...
      scopeDescMap.put("setting.appMsgSubscribed", amtj.a(2131699968));
      scopeDescMap.put("setting.addFriend", "");
      scopeDescMap.put("scope.getPhoneNumber", "");
      scopeDescMap.put("scope.insertBookShelf", amtj.a(2131693794));
      ...
      settingScopeTitleMap.put("scope.userLocation", amtj.a(2131699962));
      settingScopeTitleMap.put("scope.userInfo", amtj.a(2131699963));
      settingScopeTitleMap.put("scope.address", amtj.a(2131699958));
      settingScopeTitleMap.put("scope.invoiceTitle", amtj.a(2131699979));
      settingScopeTitleMap.put("scope.invoice", "发票信息");
      settingScopeTitleMap.put("scope.qqrun", amtj.a(2131699959));
      settingScopeTitleMap.put("scope.record", amtj.a(2131699980));
      settingScopeTitleMap.put("scope.writePhotosAlbum", amtj.a(2131699986));
      settingScopeTitleMap.put("scope.camera", amtj.a(2131699971));
      settingScopeTitleMap.put("scope.personalize", amtj.a(2131699964));
      settingScopeTitleMap.put("setting.appMsgSubscribed", amtj.a(2131693796));
      settingScopeTitleMap.put("setting.addFriend", amtj.a(2131699984));
      negativeButtonDesMap.put("setting.appMsgSubscribed", amtj.a(2131699974));
