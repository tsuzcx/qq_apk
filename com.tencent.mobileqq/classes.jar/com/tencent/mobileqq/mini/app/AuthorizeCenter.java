...
public class AuthorizeCenter
{
  ...
  private static void staticInit()
  {
    ...
    catch (Throwable localThrowable)
    {
      ...
      scopeTitleMap.put("scope.userLocation", anvx.a(2131700312));
      scopeTitleMap.put("scope.userInfo", anvx.a(2131700311));
      scopeTitleMap.put("scope.address", anvx.a(2131700318));
      scopeTitleMap.put("scope.invoiceTitle", anvx.a(2131700323));
      scopeTitleMap.put("scope.invoice", "获取你的发票信息");
      scopeTitleMap.put("scope.qqrun", anvx.a(2131693989));
      scopeTitleMap.put("scope.record", anvx.a(2131700324));
      scopeTitleMap.put("scope.writePhotosAlbum", anvx.a(2131700326));
      scopeTitleMap.put("scope.camera", anvx.a(2131700332));
      scopeTitleMap.put("scope.personalize", anvx.a(2131700320));
      scopeTitleMap.put("setting.appMsgSubscribed", anvx.a(2131700336));
      scopeTitleMap.put("setting.addFriend", anvx.a(2131700334));
      scopeTitleMap.put("scope.getPhoneNumber", anvx.a(2131693988));
      scopeTitleMap.put("scope.insertBookShelf", anvx.a(2131693977));
      scopeTitleMap.put("scope.cmshowInfo", anvx.a(2131693979));
      scopeTitleMap.put("scope.recentColorSign", anvx.a(2131693983));
      scopeDescMap.put("scope.userLocation", "");
      scopeDescMap.put("scope.userInfo", anvx.a(2131693981));
      ...
      scopeDescMap.put("setting.appMsgSubscribed", anvx.a(2131700319));
      scopeDescMap.put("setting.addFriend", "");
      scopeDescMap.put("scope.getPhoneNumber", "");
      scopeDescMap.put("scope.insertBookShelf", anvx.a(2131693978));
      scopeDescMap.put("scope.cmshowInfo", anvx.a(2131693980));
      scopeDescMap.put("scope.recentColorSign", anvx.a(2131693984));
      ...
      settingScopeTitleMap.put("scope.userLocation", anvx.a(2131700313));
      settingScopeTitleMap.put("scope.userInfo", anvx.a(2131700314));
      settingScopeTitleMap.put("scope.address", anvx.a(2131700309));
      settingScopeTitleMap.put("scope.invoiceTitle", anvx.a(2131700330));
      settingScopeTitleMap.put("scope.invoice", "发票信息");
      settingScopeTitleMap.put("scope.qqrun", anvx.a(2131700310));
      settingScopeTitleMap.put("scope.record", anvx.a(2131700331));
      settingScopeTitleMap.put("scope.writePhotosAlbum", anvx.a(2131700337));
      settingScopeTitleMap.put("scope.camera", anvx.a(2131700322));
      settingScopeTitleMap.put("scope.personalize", anvx.a(2131700315));
      settingScopeTitleMap.put("setting.appMsgSubscribed", anvx.a(2131693982));
      settingScopeTitleMap.put("setting.addFriend", anvx.a(2131700335));
      settingScopeTitleMap.put("scope.cmshowInfo", anvx.a(2131693980));
      settingScopeTitleMap.put("scope.insertBookShelf", anvx.a(2131693994));
      settingScopeTitleMap.put("scope.recentColorSign", anvx.a(2131693995));
      negativeButtonDesMap.put("setting.appMsgSubscribed", anvx.a(2131700325));
