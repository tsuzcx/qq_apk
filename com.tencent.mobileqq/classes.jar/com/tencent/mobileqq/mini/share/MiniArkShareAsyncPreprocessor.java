  ...
  implements alhz
{
  ...
  private void handleArkShareNewImageUrl(boolean paramBoolean, Bundle paramBundle, JSONObject paramJSONObject, alia paramalia, Object paramObject)
  {
    ...
    try
    {
      ...
      this.bundle.clear();
      if (paramalia != null) {
        paramalia.a(paramBoolean, paramJSONObject, paramObject);
      }
      return;
    }
  ...
  public void process(JSONObject paramJSONObject, alia paramalia, Object paramObject)
  {
    if (paramJSONObject == null) {
      if (paramalia != null) {
        paramalia.a(true, paramJSONObject, paramObject);
      }
    }
    String str1;
    do
    {
      ...
      if (TextUtils.isEmpty(str2))
      {
        ...
        if ((localObject instanceof QQAppInterface))
        {
          ...
          if (localObject != null)
          {
            localObject = ((atmp)localObject).a(MiniProgramArkShareLocalImageEntity.class, "arkPath = ?", new String[] { MiniProgramShareUtils.getLocalImagePathFromArkMeta(paramJSONObject.optString("forward_ark_app_meta")) });
            str1 = str2;
    ...
    } while (paramalia == null);
    paramalia.a(true, paramJSONObject, paramObject);
    return;
    if ((URLUtil.isHttpsUrl(str1)) || (URLUtil.isHttpUrl(str1))) {}
    for (int i = 1; i != 0; i = 0)
    {
      MiniArkShareAsyncManager.performChangeArkShareImageUrl(str1, new MiniArkShareAsyncPreprocessor.1(this, paramJSONObject, paramalia, paramObject, str1));
      return;
    }
    MiniArkShareAsyncManager.performUploadArkShareImage(str1, new MiniArkShareAsyncPreprocessor.2(this, paramJSONObject, paramalia, paramObject, str1));
  }
}
