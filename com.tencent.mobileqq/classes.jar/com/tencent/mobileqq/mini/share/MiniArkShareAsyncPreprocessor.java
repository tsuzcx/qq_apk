  ...
  implements aoyy
{
  ...
  private void handleArkShareNewImageUrl(boolean paramBoolean, Bundle paramBundle, JSONObject paramJSONObject, aoyz paramaoyz, Object paramObject)
  {
    ...
    try
    {
      ...
      this.bundle.clear();
      if (paramaoyz != null) {
        paramaoyz.a(paramBoolean, paramJSONObject, paramObject);
      }
      return;
    }
  ...
  public void process(JSONObject paramJSONObject, aoyz paramaoyz, Object paramObject)
  {
    if (paramJSONObject == null) {
      if (paramaoyz != null) {
        paramaoyz.a(true, paramJSONObject, paramObject);
      }
    }
    String str1;
    do
    ...
    } while (paramaoyz == null);
    paramaoyz.a(true, paramJSONObject, paramObject);
    return;
    if ((URLUtil.isHttpsUrl(str1)) || (URLUtil.isHttpUrl(str1))) {}
    for (int i = 1; i != 0; i = 0)
    {
      MiniArkShareAsyncManager.performChangeArkShareImageUrl(str1, new MiniArkShareAsyncPreprocessor.1(this, paramJSONObject, paramaoyz, paramObject, str1));
      return;
    }
    MiniArkShareAsyncManager.performUploadArkShareImage(str1, new MiniArkShareAsyncPreprocessor.2(this, paramJSONObject, paramaoyz, paramObject, str1));
  }
}
