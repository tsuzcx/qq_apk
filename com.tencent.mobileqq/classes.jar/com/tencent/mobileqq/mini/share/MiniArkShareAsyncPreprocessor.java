  ...
  implements IArkMessagePreprocessor
{
  ...
  private void handleArkShareNewImageUrl(boolean paramBoolean, Bundle paramBundle, JSONObject paramJSONObject, IArkMessagePreprocessorCallback paramIArkMessagePreprocessorCallback, Object paramObject)
  {
    ...
    try
    {
      ...
      this.bundle.clear();
      if (paramIArkMessagePreprocessorCallback != null) {
        paramIArkMessagePreprocessorCallback.a(paramBoolean, paramJSONObject, paramObject);
      }
      return;
    }
  ...
  public void process(JSONObject paramJSONObject, IArkMessagePreprocessorCallback paramIArkMessagePreprocessorCallback, Object paramObject)
  {
    if (paramJSONObject == null) {
      if (paramIArkMessagePreprocessorCallback != null) {
        paramIArkMessagePreprocessorCallback.a(true, paramJSONObject, paramObject);
      }
    }
    String str1;
    do
    ...
    } while (paramIArkMessagePreprocessorCallback == null);
    paramIArkMessagePreprocessorCallback.a(true, paramJSONObject, paramObject);
    return;
    if ((URLUtil.isHttpsUrl(str1)) || (URLUtil.isHttpUrl(str1))) {}
    for (int i = 1; i != 0; i = 0)
    {
      MiniArkShareAsyncManager.performChangeArkShareImageUrl(str1, new MiniArkShareAsyncPreprocessor.1(this, paramJSONObject, paramIArkMessagePreprocessorCallback, paramObject, str1));
      return;
    }
    MiniArkShareAsyncManager.performUploadArkShareImage(str1, new MiniArkShareAsyncPreprocessor.2(this, paramJSONObject, paramIArkMessagePreprocessorCallback, paramObject, str1));
  }
}
