...
public class MiniArkShareAsyncManager
{
  ...
  public static void performShareArkAsyncMessage(Bundle paramBundle, CmdCallback paramCmdCallback)
  {
    ...
    label262:
    for (String str1 = anob.a(str3, str2);; str1 = str2)
    {
      ...
      if ((localObject1 instanceof QQAppInterface))
      {
        ...
        if (localObject2 != null)
        {
          ...
          if (localObject2 != null) {
            ((anrr)localObject2).a(str3, new MiniArkShareAsyncPreprocessor(paramBundle));
          }
        }
        if (i != 0)
        {
  ...
  public static void performUploadArkShareImage(String paramString, CmdCallback paramCmdCallback)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      if ((localObject instanceof QQAppInterface))
      {
        ...
        localbayk.jdField_c_of_type_Int = 62;
        ...
        localbayk.jdField_a_of_type_JavaLangString = "miniAppArkShareUploadPicHit";
        ...
        paramString.addFilter(new Class[] { baqy.class });
        if (((QQAppInterface)localObject).a() != null)
        {
          ((QQAppInterface)localObject).a().a(paramString);
          ((QQAppInterface)localObject).a().a(localbayk);
        }
      }
    }
    do
  ...
  public static void registerMiniArkShareMessageProcessorAfterProcessRestart()
  {
    ...
    if ((localObject instanceof QQAppInterface))
    {
      ...
      if (localObject != null)
      {
        ...
        if (localObject != null)
        {
          ((anrr)localObject).a("com.tencent.miniapp", new MiniArkShareAsyncPreprocessor(new Bundle()));
