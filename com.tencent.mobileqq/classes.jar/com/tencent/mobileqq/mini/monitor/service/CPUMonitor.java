...
public class CPUMonitor
{
  ...
  private static void getCpuTime()
  {
    ...
    //   3: aconst_null
    //   4: astore_3
    //   5: new 146	java/io/BufferedReader
    //   8: dup
    //   9: new 148	java/io/InputStreamReader
    //   12: dup
    //   13: new 150	java/io/FileInputStream
    //   16: dup
    //   17: ldc 152
    //   19: invokespecial 153	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   22: invokespecial 156	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   25: sipush 1000
    //   28: invokespecial 159	java/io/BufferedReader:<init>	(Ljava/io/Reader;I)V
    //   31: astore_1
    //   32: aload_1
    //   33: invokevirtual 162	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   36: astore_2
    //   37: aload_2
    //   38: ifnonnull +231 -> 269
    //   41: ldc 164
    //   43: astore_2
    //   44: getstatic 166	com/tencent/mobileqq/mini/monitor/service/CPUMonitor:pid	I
    //   47: ifne +9 -> 56
    //   50: invokestatic 172	android/os/Process:myPid	()I
    //   53: putstatic 166	com/tencent/mobileqq/mini/monitor/service/CPUMonitor:pid	I
    //   56: new 146	java/io/BufferedReader
    //   59: dup
    //   60: new 148	java/io/InputStreamReader
    //   63: dup
    //   64: new 150	java/io/FileInputStream
    //   67: dup
    ...
    //   80: getstatic 166	com/tencent/mobileqq/mini/monitor/service/CPUMonitor:pid	I
    //   83: invokevirtual 177	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   86: ldc 179
    ...
    //   94: invokespecial 153	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   97: invokespecial 156	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   100: sipush 1000
    //   103: invokespecial 159	java/io/BufferedReader:<init>	(Ljava/io/Reader;I)V
    //   106: astore_0
    //   107: aload_0
    //   108: invokevirtual 162	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   111: astore 4
    //   113: aload 4
    //   115: astore_3
    //   116: aload 4
    ...
    //   124: aload_2
    //   125: aload_3
    //   126: invokestatic 183	com/tencent/mobileqq/mini/monitor/service/CPUMonitor:parseCPURate	(Ljava/lang/String;Ljava/lang/String;)V
    //   129: iconst_0
    //   130: putstatic 72	com/tencent/mobileqq/mini/monitor/service/CPUMonitor:isError	Z
    //   133: aload_1
    //   134: ifnull +7 -> 141
    //   137: aload_1
    //   138: invokevirtual 186	java/io/BufferedReader:close	()V
    //   141: aload_0
    //   142: ifnull +7 -> 149
    //   145: aload_0
    //   146: invokevirtual 186	java/io/BufferedReader:close	()V
    //   149: return
    //   150: astore_0
    //   151: aload_0
    //   152: invokevirtual 189	java/io/IOException:printStackTrace	()V
    //   155: return
    //   156: astore_2
    //   157: aconst_null
    //   158: astore_0
    ...
    //   160: astore_1
    //   161: iconst_1
    //   162: putstatic 72	com/tencent/mobileqq/mini/monitor/service/CPUMonitor:isError	Z
    //   165: aload_2
    //   166: invokevirtual 190	java/lang/Throwable:printStackTrace	()V
    //   169: aload_0
    //   170: ifnull +7 -> 177
    //   173: aload_0
    //   174: invokevirtual 186	java/io/BufferedReader:close	()V
    //   177: aload_1
    //   178: ifnull -29 -> 149
    //   181: aload_1
    //   182: invokevirtual 186	java/io/BufferedReader:close	()V
    //   185: return
    //   186: astore_0
    //   187: aload_0
    //   188: invokevirtual 189	java/io/IOException:printStackTrace	()V
    //   191: return
    //   192: astore_0
    //   193: aconst_null
    //   194: astore_1
    ...
    //   199: ifnull +7 -> 206
    //   202: aload_1
    //   203: invokevirtual 186	java/io/BufferedReader:close	()V
    //   206: aload_2
    //   207: ifnull +7 -> 214
    //   210: aload_2
    //   211: invokevirtual 186	java/io/BufferedReader:close	()V
    //   214: aload_0
    //   215: athrow
    //   216: astore_1
    //   217: aload_1
    //   218: invokevirtual 189	java/io/IOException:printStackTrace	()V
    //   221: goto -7 -> 214
    //   224: astore_0
    //   225: aload 4
    //   227: astore_2
 ...
 * Qualified Name:     com.tencent.mobileqq.mini.monitor.service.CPUMonitor
