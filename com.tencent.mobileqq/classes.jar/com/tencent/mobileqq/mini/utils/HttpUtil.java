...
public class HttpUtil
{
  ...
  private HttpHost detectProxy()
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        try
        {
          j = localWifiManager.getConnectionInfo().getIpAddress();
          if (j != 0) {
            break label98;
          }
          bool1 = false;
  ...
  private Bundle doHttp(int paramInt, String paramString)
  {
    ...
    //   32: dup
    //   33: invokespecial 180	android/os/Bundle:<init>	()V
    //   36: astore 16
    //   38: aload_0
    //   39: invokespecial 182	com/tencent/mobileqq/mini/utils/HttpUtil:createHttpClient	()Lorg/apache/http/client/HttpClient;
    //   42: astore 5
    //   44: aload 6
    //   46: astore 7
    //   48: aload 12
    ...
    //   65: astore 10
    //   67: aload_0
    //   68: invokespecial 184	com/tencent/mobileqq/mini/utils/HttpUtil:detectProxy	()Lorg/apache/http/HttpHost;
    //   71: astore 17
    //   73: aload 17
    //   75: ifnull +1016 -> 1091
    //   78: aload 6
    ...
    //   140: aload 15
    //   142: astore 10
    //   144: new 200	org/apache/http/client/methods/HttpGet
    //   147: dup
    //   148: aload_2
    //   149: invokespecial 203	org/apache/http/client/methods/HttpGet:<init>	(Ljava/lang/String;)V
    //   152: astore 11
    //   154: aload 6
    //   156: astore 7
    //   158: aload 12
    ...
    //   227: invokevirtual 223	java/net/URI:getHost	()Ljava/lang/String;
    //   230: invokeinterface 226 3 0
    //   235: aload 6
    //   237: astore 7
    //   239: aload 12
    //   241: astore 8
    ...
    //   324: astore 10
    //   326: aload 6
    //   328: invokeinterface 238 1 0
    //   333: invokeinterface 243 1 0
    //   338: istore_1
    //   339: aload 6
    //   341: astore 7
    //   343: aload 6
    ...
    //   364: ldc 15
    //   366: iload_1
    //   367: invokevirtual 246	android/os/Bundle:putInt	(Ljava/lang/String;I)V
    //   370: iload_1
    //   371: sipush 200
    ...
    //   405: astore 10
    //   407: aload 11
    //   409: invokeinterface 249 1 0
    //   414: aload 5
    //   416: ifnull +15 -> 431
    //   419: aload 5
    //   421: invokeinterface 253 1 0
    //   426: invokeinterface 258 1 0
    //   431: aload 6
    //   433: ifnull +3 -> 436
    //   436: aload 16
    //   438: areturn
    ...
    //   458: aload 15
    //   460: astore 10
    //   462: new 200	org/apache/http/client/methods/HttpGet
    //   465: dup
    //   466: aload_2
    //   467: invokespecial 203	org/apache/http/client/methods/HttpGet:<init>	(Ljava/lang/String;)V
    //   470: astore 11
    //   472: goto -318 -> 154
    //   475: astore_2
    //   476: aload 7
    ...
    //   481: astore 4
    //   483: aload_2
    //   484: invokevirtual 261	org/apache/http/client/ClientProtocolException:printStackTrace	()V
    //   487: aload 5
    //   489: ifnull +15 -> 504
    //   492: aload 5
    //   494: invokeinterface 253 1 0
    //   499: invokeinterface 258 1 0
    //   504: aload 7
    //   506: ifnull -70 -> 436
    //   509: aload 16
    //   511: areturn
    ...
    //   531: aload 15
    //   533: astore 10
    //   535: new 263	org/apache/http/client/methods/HttpPost
    //   538: dup
    //   539: aload_2
    //   540: invokespecial 264	org/apache/http/client/methods/HttpPost:<init>	(Ljava/lang/String;)V
    //   543: astore 11
    //   545: goto -391 -> 154
    //   548: astore_2
    //   549: aload 8
    ...
    //   554: astore 4
    //   556: aload_2
    //   557: invokevirtual 265	java/net/SocketTimeoutException:printStackTrace	()V
    //   560: aload 5
    //   562: ifnull +15 -> 577
    //   565: aload 5
    //   567: invokeinterface 253 1 0
    //   572: invokeinterface 258 1 0
    //   577: aload 8
    //   579: ifnull -143 -> 436
    //   582: aload 16
    //   584: areturn
    ...
    //   729: ldc_w 275
    //   732: ldc_w 277
    //   735: invokestatic 283	android/util/Log:d	(Ljava/lang/String;Ljava/lang/String;)I
    //   738: pop
    //   739: aload 6
    //   741: astore 7
    //   743: aload 6
    ...
    //   794: astore 10
    //   796: aload 6
    //   798: invokeinterface 238 1 0
    //   803: invokeinterface 243 1 0
    //   808: istore_1
    //   809: aload 6
    //   811: astore_2
    //   812: iload_1
    ...
    //   861: ifnull +15 -> 876
    //   864: aload 5
    //   866: invokeinterface 253 1 0
    //   871: invokeinterface 258 1 0
    //   876: aload 6
    //   878: ifnull -442 -> 436
    //   881: aload 16
    //   883: areturn
    ...
    //   903: aload 16
    //   905: aload_2
    //   906: invokespecial 285	com/tencent/mobileqq/mini/utils/HttpUtil:addHttpHeader	(Landroid/os/Bundle;Lorg/apache/http/HttpResponse;)V
    //   909: aload_2
    //   910: astore 7
    //   912: aload_2
    //   913: astore 8
    ...
    //   928: aload 16
    //   930: aload_2
    //   931: invokespecial 287	com/tencent/mobileqq/mini/utils/HttpUtil:addHttpBody	(Landroid/os/Bundle;Lorg/apache/http/HttpResponse;)V
    //   934: aload 5
    //   936: ifnull +15 -> 951
    //   939: aload 5
    //   941: invokeinterface 253 1 0
    //   946: invokeinterface 258 1 0
    //   951: aload_2
    //   952: ifnull -516 -> 436
    //   955: aload 16
    //   957: areturn
    ...
    //   967: astore 4
    //   969: aload_2
    //   970: invokevirtual 288	java/net/SocketException:printStackTrace	()V
    //   973: aload 5
    //   975: ifnull +15 -> 990
    //   978: aload 5
    //   980: invokeinterface 253 1 0
    //   985: invokeinterface 258 1 0
    //   990: aload 10
    //   992: ifnull -556 -> 436
    //   995: aload 16
    //   997: areturn
    ...
    //   1007: astore 4
    //   1009: aload_2
    //   1010: invokevirtual 289	java/io/IOException:printStackTrace	()V
    //   1013: aload 5
    //   1015: ifnull +15 -> 1030
    //   1018: aload 5
    //   1020: invokeinterface 253 1 0
    //   1025: invokeinterface 258 1 0
    //   1030: aload 9
    //   1032: ifnull -596 -> 436
    //   1035: aload 16
    //   1037: areturn
    ...
    //   1044: ifnull +15 -> 1059
    //   1047: aload 4
    //   1049: invokeinterface 253 1 0
    //   1054: invokeinterface 258 1 0
    //   1059: aload_3
    //   1060: ifnull +3 -> 1063
    //   1063: aload_2
    //   1064: athrow
