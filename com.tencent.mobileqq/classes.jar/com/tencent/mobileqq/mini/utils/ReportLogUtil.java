...
public class ReportLogUtil
{
  ...
  public static void uploadLog(String paramString, ReportLogUtil.UploadLogListener paramUploadLogListener)
  {
    ...
    do
    {
      ...
      localbayk.jdField_c_of_type_Int = 65;
      localbayk.jdField_a_of_type_Long = ((Math.random() * 1000000.0D));
      localbayk.jdField_c_of_type_JavaLangString = "0";
      localbayk.jdField_b_of_type_JavaLangString = String.valueOf(bfbm.a().a());
      localbayk.jdField_b_of_type_Int = 24;
      localbayk.jdField_a_of_type_JavaLangString = "miniAppUserLog";
      ...
      localbayk.jdField_a_of_type_ArrayOfByte = paramString.toByteArray();
    ...
    paramUploadLogListener.addFilter(new Class[] { baqy.class });
    paramString.a().a(paramUploadLogListener);
    paramString.a().a(localbayk);
  }
  ...
  public static void zipFiles(java.util.ArrayList<com.tencent.mobileqq.mini.appbrand.utils.MiniLogManager.LogFile> paramArrayList, String paramString)
  {
    ...
    //   16: invokespecial 248	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   19: invokespecial 251	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   22: astore_1
    //   23: new 253	java/util/zip/ZipOutputStream
    //   26: dup
    //   27: aload_1
    //   28: invokespecial 254	java/util/zip/ZipOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   31: astore 11
    //   33: iconst_0
    //   34: istore_2
    //   35: aload_0
    //   36: invokevirtual 260	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   39: astore_0
    //   40: aload_0
    //   41: invokeinterface 265 1 0
    //   46: ifeq +255 -> 301
    //   49: aload_0
    //   50: invokeinterface 269 1 0
    //   55: checkcast 271	com/tencent/mobileqq/mini/appbrand/utils/MiniLogManager$LogFile
    //   58: astore 12
    //   60: aload 12
    //   62: invokevirtual 272	com/tencent/mobileqq/mini/appbrand/utils/MiniLogManager$LogFile:exists	()Z
    //   65: ifeq +312 -> 377
    //   68: aload 11
    //   70: new 274	java/util/zip/ZipEntry
    //   73: dup
    //   74: new 138	java/lang/StringBuilder
    //   77: dup
    //   78: invokespecial 139	java/lang/StringBuilder:<init>	()V
    //   81: aload 12
    //   83: invokevirtual 277	com/tencent/mobileqq/mini/appbrand/utils/MiniLogManager$LogFile:getName	()Ljava/lang/String;
    //   86: invokevirtual 153	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   89: aload 12
    //   91: getfield 280	com/tencent/mobileqq/mini/appbrand/utils/MiniLogManager$LogFile:stuffix	Ljava/lang/String;
    ...
    //   100: invokespecial 281	java/util/zip/ZipEntry:<init>	(Ljava/lang/String;)V
    //   103: invokevirtual 285	java/util/zip/ZipOutputStream:putNextEntry	(Ljava/util/zip/ZipEntry;)V
    //   106: aload 11
    //   108: bipush 9
    //   110: invokevirtual 288	java/util/zip/ZipOutputStream:setLevel	(I)V
    //   113: aload 12
    //   115: invokevirtual 289	com/tencent/mobileqq/mini/appbrand/utils/MiniLogManager$LogFile:length	()J
    //   118: lstore 9
    //   120: new 291	java/io/FileInputStream
    //   123: dup
    //   124: aload 12
    //   126: invokespecial 292	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   129: astore 12
    //   131: sipush 20480
    //   134: newarray byte
    //   136: astore 13
    ...
    //   145: iconst_0
    //   146: sipush 20480
    //   149: invokevirtual 296	java/io/FileInputStream:read	([BII)I
    //   152: istore 4
    //   154: iload 4
    //   156: iconst_m1
    ...
    //   164: iconst_0
    //   165: iload 4
    //   167: invokevirtual 300	java/util/zip/ZipOutputStream:write	([BII)V
    //   170: iconst_1
    //   171: istore_3
    //   172: iconst_1
    //   173: istore_2
    ...
    //   195: istore_2
    //   196: aload 12
    //   198: invokevirtual 303	java/io/FileInputStream:close	()V
    //   201: aload 11
    //   203: invokevirtual 306	java/util/zip/ZipOutputStream:flush	()V
    //   206: aload 11
    //   208: invokevirtual 309	java/util/zip/ZipOutputStream:closeEntry	()V
    //   211: goto +166 -> 377
    //   214: astore_0
    //   215: aload 12
    //   217: invokevirtual 303	java/io/FileInputStream:close	()V
    //   220: aload 11
    //   222: invokevirtual 306	java/util/zip/ZipOutputStream:flush	()V
    //   225: aload 11
    //   227: invokevirtual 309	java/util/zip/ZipOutputStream:closeEntry	()V
    //   230: aload_0
    //   231: athrow
    //   232: astore_0
    //   233: invokestatic 312	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   236: ifeq +30 -> 266
    //   239: ldc 8
    //   241: iconst_2
    //   242: new 138	java/lang/StringBuilder
    //   245: dup
    //   246: invokespecial 139	java/lang/StringBuilder:<init>	()V
    //   249: ldc_w 314
    //   252: invokevirtual 153	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   255: aload_0
    //   256: invokevirtual 317	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   259: invokevirtual 156	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   262: aload_0
    //   263: invokestatic 320	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   266: aload_1
    //   267: invokevirtual 321	java/io/BufferedOutputStream:close	()V
    //   270: invokestatic 312	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   273: ifeq +12 -> 285
    //   276: ldc 8
    //   278: iconst_2
    //   279: ldc_w 323
    //   282: invokestatic 68	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   285: invokestatic 312	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   288: ifeq +12 -> 300
    //   291: ldc 8
    //   293: iconst_2
    //   294: ldc_w 325
    //   297: invokestatic 327	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   300: return
    //   301: iload_2
    //   302: ifeq +8 -> 310
    //   305: aload 11
    //   307: invokevirtual 328	java/util/zip/ZipOutputStream:close	()V
    //   310: invokestatic 312	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   313: ifeq +12 -> 325
    //   316: ldc 8
    //   318: iconst_2
    //   319: ldc_w 330
    ...
    //   325: aload_1
    //   326: invokevirtual 321	java/io/BufferedOutputStream:close	()V
    //   329: invokestatic 312	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   332: ifeq -47 -> 285
    //   335: ldc 8
    //   337: iconst_2
    //   338: ldc_w 323
    ...
    //   347: astore_0
    //   348: aload_0
    //   349: invokevirtual 333	java/io/IOException:printStackTrace	()V
    //   352: goto -67 -> 285
    //   355: astore_0
    //   356: aload_1
    //   357: invokevirtual 321	java/io/BufferedOutputStream:close	()V
    //   360: invokestatic 312	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   363: ifeq +12 -> 375
    //   366: ldc 8
    //   368: iconst_2
    //   369: ldc_w 323
