...
public class ReportLogUtil
{
  ...
  {
    // Byte code:
    //   0: new 254	java/io/BufferedOutputStream
    //   3: dup
    //   4: new 256	java/io/FileOutputStream
    //   7: dup
    //   8: new 55	java/io/File
    //   11: dup
    //   12: aload_1
    //   13: invokespecial 56	java/io/File:<init>	(Ljava/lang/String;)V
    //   16: invokespecial 259	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   19: invokespecial 262	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   22: astore_1
    //   23: new 264	java/util/zip/ZipOutputStream
    //   26: dup
    //   27: aload_1
    //   28: invokespecial 265	java/util/zip/ZipOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   31: astore 8
    //   33: aload_0
    //   34: invokevirtual 271	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   37: astore_0
    //   38: iconst_0
    //   39: istore_2
    //   40: aload_0
    ...
    //   46: ifeq +196 -> 242
    //   49: aload_0
    //   50: invokeinterface 280 1 0
    //   55: checkcast 282	com/tencent/mobileqq/mini/appbrand/utils/MiniLogManager$LogFile
    //   58: astore 9
    //   60: iload_2
    //   61: istore_3
    //   62: aload 9
    //   64: invokevirtual 283	com/tencent/mobileqq/mini/appbrand/utils/MiniLogManager$LogFile:exists	()Z
    //   67: ifeq +324 -> 391
    //   70: new 145	java/lang/StringBuilder
    //   73: dup
    //   74: invokespecial 146	java/lang/StringBuilder:<init>	()V
    //   77: astore 10
    //   79: aload 10
    //   81: aload 9
    //   83: invokevirtual 286	com/tencent/mobileqq/mini/appbrand/utils/MiniLogManager$LogFile:getName	()Ljava/lang/String;
    //   86: invokevirtual 160	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   89: pop
    //   90: aload 10
    //   92: aload 9
    //   94: getfield 289	com/tencent/mobileqq/mini/appbrand/utils/MiniLogManager$LogFile:stuffix	Ljava/lang/String;
    //   97: invokevirtual 160	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   100: pop
    //   101: aload 8
    //   103: new 291	java/util/zip/ZipEntry
    //   106: dup
    //   107: aload 10
    //   109: invokevirtual 163	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   112: invokespecial 292	java/util/zip/ZipEntry:<init>	(Ljava/lang/String;)V
    //   115: invokevirtual 296	java/util/zip/ZipOutputStream:putNextEntry	(Ljava/util/zip/ZipEntry;)V
    //   118: aload 8
    //   120: bipush 9
    //   122: invokevirtual 299	java/util/zip/ZipOutputStream:setLevel	(I)V
    //   125: aload 9
    //   127: invokevirtual 300	com/tencent/mobileqq/mini/appbrand/utils/MiniLogManager$LogFile:length	()J
    //   130: lstore 6
    //   132: new 302	java/io/FileInputStream
    //   135: dup
    //   136: aload 9
    //   138: invokespecial 303	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   141: astore 9
    //   143: sipush 20480
    //   146: newarray byte
    //   148: astore 10
    ...
    //   157: iconst_0
    //   158: sipush 20480
    //   161: invokevirtual 307	java/io/FileInputStream:read	([BII)I
    //   164: istore_3
    //   165: iload_3
    //   166: iconst_m1
    ...
    //   174: iconst_0
    //   175: iload_3
    //   176: invokevirtual 311	java/util/zip/ZipOutputStream:write	([BII)V
    //   179: lload 4
    //   181: iload_3
    //   182: i2l
    //   183: ladd
    ...
    //   201: goto -48 -> 153
    //   204: aload 9
    //   206: invokevirtual 314	java/io/FileInputStream:close	()V
    //   209: aload 8
    //   211: invokevirtual 317	java/util/zip/ZipOutputStream:flush	()V
    //   214: aload 8
    //   216: invokevirtual 320	java/util/zip/ZipOutputStream:closeEntry	()V
    //   219: iload_2
    //   220: istore_3
    //   221: goto +170 -> 391
    //   224: astore_0
    //   225: aload 9
    //   227: invokevirtual 314	java/io/FileInputStream:close	()V
    //   230: aload 8
    //   232: invokevirtual 317	java/util/zip/ZipOutputStream:flush	()V
    //   235: aload 8
    //   237: invokevirtual 320	java/util/zip/ZipOutputStream:closeEntry	()V
    //   240: aload_0
    //   241: athrow
    //   242: iload_2
    //   243: ifeq +8 -> 251
    //   246: aload 8
    //   248: invokevirtual 321	java/util/zip/ZipOutputStream:close	()V
    //   251: invokestatic 324	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   254: ifeq +12 -> 266
    //   257: ldc 8
    //   259: iconst_2
    //   260: ldc_w 326
    ...
    //   266: aload_1
    //   267: invokevirtual 327	java/io/BufferedOutputStream:close	()V
    ...
    //   296: ifeq +40 -> 336
    //   299: new 145	java/lang/StringBuilder
    //   302: dup
    //   303: invokespecial 146	java/lang/StringBuilder:<init>	()V
    //   306: astore 8
    //   308: aload 8
    //   310: ldc_w 331
    ...
    //   317: aload 8
    //   319: aload_0
    //   320: invokevirtual 334	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   323: pop
    //   324: ldc 8
    //   326: iconst_2
    //   327: aload 8
    ...
    //   332: aload_0
    //   333: invokestatic 338	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   336: aload_1
    //   337: invokevirtual 327	java/io/BufferedOutputStream:close	()V
    //   340: invokestatic 324	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   343: ifeq +32 -> 375
    //   346: goto -70 -> 276
    //   349: aload_1
    //   350: invokevirtual 327	java/io/BufferedOutputStream:close	()V
    //   353: invokestatic 324	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   356: ifeq +12 -> 368
    //   359: ldc 8
    //   361: iconst_2
    //   362: ldc_w 329
    ...
    //   370: astore_0
    //   371: aload_0
    //   372: invokevirtual 341	java/io/IOException:printStackTrace	()V
    //   375: invokestatic 324	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   378: ifeq +12 -> 390
    //   381: ldc 8
    //   383: iconst_2
    //   384: ldc_w 343
    //   387: invokestatic 345	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   390: return
    //   391: iload_3
    //   392: istore_2
    //   393: goto -353 -> 40
