  ...
  extends OneDReader
{
  ...
  static
  {
    ...
    int[] arrayOfInt8 = { 2, 3, 1, 2, 1, 2 };
    int[] arrayOfInt9 = { 1, 1, 2, 2, 3, 2 };
    int[] arrayOfInt10 = { 1, 1, 3, 2, 2, 2 };
    int[] arrayOfInt11 = { 1, 2, 3, 1, 2, 2 };
    int[] arrayOfInt12 = { 2, 2, 3, 2, 1, 1 };
    int[] arrayOfInt13 = { 2, 2, 1, 2, 3, 1 };
    int[] arrayOfInt14 = { 2, 1, 3, 2, 1, 2 };
    int[] arrayOfInt15 = { 2, 2, 3, 1, 1, 2 };
    int[] arrayOfInt16 = { 3, 1, 2, 1, 3, 1 };
    int[] arrayOfInt17 = { 3, 1, 1, 2, 2, 2 };
    int[] arrayOfInt18 = { 3, 2, 1, 1, 2, 2 };
    int[] arrayOfInt19 = { 3, 2, 1, 2, 2, 1 };
    ...
    int[] arrayOfInt26 = { 1, 1, 2, 1, 3, 3 };
    int[] arrayOfInt27 = { 1, 1, 2, 3, 3, 1 };
    int[] arrayOfInt28 = { 1, 1, 3, 1, 2, 3 };
    int[] arrayOfInt29 = { 1, 1, 3, 3, 2, 1 };
    int[] arrayOfInt30 = { 1, 3, 3, 1, 2, 1 };
    int[] arrayOfInt31 = { 3, 1, 3, 1, 2, 1 };
    int[] arrayOfInt32 = { 2, 1, 1, 3, 3, 1 };
    int[] arrayOfInt33 = { 2, 3, 1, 1, 3, 1 };
    int[] arrayOfInt34 = { 2, 1, 3, 1, 1, 3 };
    int[] arrayOfInt35 = { 2, 1, 3, 3, 1, 1 };
    int[] arrayOfInt36 = { 3, 1, 1, 3, 2, 1 };
    int[] arrayOfInt37 = { 3, 3, 1, 1, 2, 1 };
    int[] arrayOfInt38 = { 3, 1, 2, 1, 1, 3 };
    int[] arrayOfInt39 = { 3, 1, 2, 3, 1, 1 };
    int[] arrayOfInt40 = { 2, 2, 1, 4, 1, 1 };
    int[] arrayOfInt41 = { 4, 3, 1, 1, 1, 1 };
    int[] arrayOfInt42 = { 1, 2, 1, 1, 2, 4 };
    int[] arrayOfInt43 = { 1, 4, 1, 1, 2, 2 };
    int[] arrayOfInt44 = { 1, 1, 2, 2, 1, 4 };
    int[] arrayOfInt45 = { 1, 1, 2, 4, 1, 2 };
    int[] arrayOfInt46 = { 1, 2, 2, 4, 1, 1 };
    int[] arrayOfInt47 = { 1, 4, 2, 1, 1, 2 };
    int[] arrayOfInt48 = { 1, 4, 2, 2, 1, 1 };
    int[] arrayOfInt49 = { 2, 4, 1, 1, 1, 2 };
    int[] arrayOfInt50 = { 1, 3, 4, 1, 1, 1 };
    int[] arrayOfInt51 = { 1, 2, 1, 1, 4, 2 };
    int[] arrayOfInt52 = { 1, 2, 1, 2, 4, 1 };
    int[] arrayOfInt53 = { 1, 1, 4, 2, 1, 2 };
    int[] arrayOfInt54 = { 1, 2, 4, 2, 1, 1 };
    int[] arrayOfInt55 = { 4, 1, 1, 2, 1, 2 };
    int[] arrayOfInt56 = { 4, 2, 1, 2, 1, 1 };
    int[] arrayOfInt57 = { 4, 1, 2, 1, 2, 1 };
    int[] arrayOfInt58 = { 1, 1, 1, 1, 4, 3 };
    int[] arrayOfInt59 = { 1, 1, 1, 3, 4, 1 };
    int[] arrayOfInt60 = { 1, 1, 4, 1, 1, 3 };
    int[] arrayOfInt61 = { 4, 1, 1, 3, 1, 1 };
    int[] arrayOfInt62 = { 1, 1, 3, 1, 4, 1 };
    int[] arrayOfInt63 = { 4, 1, 1, 1, 3, 1 };
    int[] arrayOfInt64 = { 2, 1, 1, 2, 3, 2 };
    int[] arrayOfInt65 = { 2, 3, 3, 1, 1, 1, 2 };
    CODE_PATTERNS = new int[][] { { 2, 1, 2, 2, 2, 2 }, arrayOfInt1, arrayOfInt2, arrayOfInt3, arrayOfInt4, arrayOfInt5, arrayOfInt6, { 1, 2, 2, 3, 1, 2 }, { 1, 3, 2, 2, 1, 2 }, arrayOfInt7, { 2, 2, 1, 3, 1, 2 }, arrayOfInt8, arrayOfInt9, { 1, 2, 2, 1, 3, 2 }, { 1, 2, 2, 2, 3, 1 }, arrayOfInt10, arrayOfInt11, { 1, 2, 3, 2, 2, 1 }, arrayOfInt12, { 2, 2, 1, 1, 3, 2 }, arrayOfInt13, arrayOfInt14, arrayOfInt15, arrayOfInt16, arrayOfInt17, arrayOfInt18, arrayOfInt19, { 3, 1, 2, 2, 1, 2 }, { 3, 2, 2, 1, 1, 2 }, arrayOfInt20, { 2, 1, 2, 1, 2, 3 }, { 2, 1, 2, 3, 2, 1 }, { 2, 3, 2, 1, 2, 1 }, { 1, 1, 1, 3, 2, 3 }, arrayOfInt21, arrayOfInt22, { 1, 1, 2, 3, 1, 3 }, arrayOfInt23, arrayOfInt24, { 2, 1, 1, 3, 1, 3 }, arrayOfInt25, { 2, 3, 1, 3, 1, 1 }, arrayOfInt26, arrayOfInt27, { 1, 3, 2, 1, 3, 1 }, arrayOfInt28, arrayOfInt29, arrayOfInt30, arrayOfInt31, arrayOfInt32, arrayOfInt33, arrayOfInt34, arrayOfInt35, { 2, 1, 3, 1, 3, 1 }, { 3, 1, 1, 1, 2, 3 }, arrayOfInt36, arrayOfInt37, arrayOfInt38, arrayOfInt39, { 3, 3, 2, 1, 1, 1 }, { 3, 1, 4, 1, 1, 1 }, arrayOfInt40, arrayOfInt41, { 1, 1, 1, 2, 2, 4 }, { 1, 1, 1, 4, 2, 2 }, arrayOfInt42, { 1, 2, 1, 4, 2, 1 }, arrayOfInt43, { 1, 4, 1, 2, 2, 1 }, arrayOfInt44, arrayOfInt45, { 1, 2, 2, 1, 1, 4 }, arrayOfInt46, arrayOfInt47, arrayOfInt48, { 2, 4, 1, 2, 1, 1 }, { 2, 2, 1, 1, 1, 4 }, { 4, 1, 3, 1, 1, 1 }, arrayOfInt49, arrayOfInt50, { 1, 1, 1, 2, 4, 2 }, arrayOfInt51, arrayOfInt52, arrayOfInt53, { 1, 2, 4, 1, 1, 2 }, arrayOfInt54, arrayOfInt55, { 4, 2, 1, 1, 1, 2 }, arrayOfInt56, { 2, 1, 2, 1, 4, 1 }, { 2, 1, 4, 1, 2, 1 }, arrayOfInt57, arrayOfInt58, arrayOfInt59, { 1, 3, 1, 1, 4, 1 }, arrayOfInt60, { 1, 1, 4, 3, 1, 1 }, { 4, 1, 1, 1, 1, 3 }, arrayOfInt61, arrayOfInt62, { 1, 1, 4, 1, 3, 1 }, { 3, 1, 1, 1, 4, 1 }, arrayOfInt63, { 2, 1, 1, 4, 1, 2 }, { 2, 1, 1, 2, 1, 4 }, arrayOfInt64, arrayOfInt65 };
  }
