...
public class MiniAppReportManager
{
  ...
  private static void deleteReportDcDataFromDB(MiniAppReportEntity paramMiniAppReportEntity)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          ((atmp)localObject).b(paramMiniAppReportEntity);
          return;
        }
      }
  ...
  private static void insertReportDcDataToDB(List<MiniAppReportEntity> paramList)
  {
    ...
    //   50: return
    //   51: aload_1
    //   52: invokevirtual 226	com/tencent/common/app/AppInterface:getEntityManagerFactory	()Latmq;
    //   55: invokevirtual 232	atmq:createEntityManager	()Latmp;
    //   58: astore_2
    //   59: aload_2
    //   60: ifnull -10 -> 50
    //   63: aload_2
    //   64: invokevirtual 394	atmp:a	()Latmr;
    //   67: astore_1
    //   68: aload_1
    //   69: invokevirtual 398	atmr:a	()V
    //   72: aload_0
    ...
    //   98: aload_2
    //   99: aload_3
    //   100: invokestatic 415	com/tencent/mobileqq/mini/report/MiniAppReportManager:updateEntity	(Latmp;Latmo;)Z
    //   103: pop
    ...
    //   153: aload_1
    //   154: invokevirtual 422	atmr:b	()V
    //   157: return
    //   158: astore_0
    //   159: ldc 45
    //   161: iconst_1
    ...
    //   169: return
    //   170: aload_1
    //   171: invokevirtual 427	atmr:c	()V
    //   174: aload_1
    //   175: invokevirtual 422	atmr:b	()V
    //   178: return
    //   179: astore_0
    //   180: aload_1
    //   181: invokevirtual 422	atmr:b	()V
    //   184: aload_0
    //   185: athrow
    ...
    for (;;)
    {
      ...
      try
      {
        if (((AppInterface)localObject1).getAccount() != null)
        {
          ...
          localObject1 = ((atmp)localObject1).a(MiniAppReportEntity.class, MiniAppReportEntity.class.getSimpleName(), false, null, null, null, null, null, null);
        }
      }
      catch (Throwable localThrowable)
      {
  ...
  private static void report(MiniAppConfig paramMiniAppConfig, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, boolean paramBoolean)
  {
    ...
    for (paramString7 = paramString8;; paramString7 = str1)
    {
      ...
      {
        paramString8.addAll(MiniProgramReportHelper.newBusinessEntries(paramMiniAppConfig, str1, paramString3, paramString4, paramString5, paramString6, paramString1, paramString7, null, null, paramString2, str2));
  ...
  private static boolean updateEntity(atmp paramatmp, atmo paramatmo)
  {
    boolean bool2 = false;
    boolean bool1 = false;
    if (paramatmp.a()) {
    ...
    QLog.d("MiniAppReportManager", 2, "updateEntity em closed e=" + paramatmo.getTableName());
    return false;
  }
