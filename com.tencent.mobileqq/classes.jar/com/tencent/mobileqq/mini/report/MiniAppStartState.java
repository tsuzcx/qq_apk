...
{
  public static ConcurrentHashMap<String, MiniAppStartState.StartState> startStateMap = new ConcurrentHashMap();
  ...
  public static MiniAppStartState.StartState getState(String paramString)
  {
    if (startStateMap.containsKey(paramString)) {
      return (MiniAppStartState.StartState)startStateMap.get(paramString);
    }
    MiniAppStartState.StartState localStartState = new MiniAppStartState.StartState();
