...
public class MiniProgramReportHelper
{
  ...
  public static List<COMM.Entry> newBusinessEntries(MiniAppConfig paramMiniAppConfig, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, String paramString9, String paramString10, String paramString11)
  {
    ...
    if ((paramMiniAppConfig != null) && (paramMiniAppConfig.config != null))
    {
      COMM.Entry localEntry1 = newEntry("launchid", paramString11);
      ...
      paramString11 = "1";
      COMM.Entry localEntry6 = newEntry("isPkgDownloaed", paramString11);
      if (paramMiniAppConfig == null) {
        break label490;
      }
      paramString11 = paramMiniAppConfig.config;
      label112:
      if (!EnvUtils.isX5Enabled(paramString11)) {
        break label496;
      }
      paramString11 = "1";
      label125:
      localArrayList.addAll(Arrays.asList(new COMM.Entry[] { localEntry1, localEntry2, localEntry3, localEntry4, localEntry5, localEntry6, newEntry("isX5Enabled", paramString11), newEntry("app_status", String.valueOf(paramMiniAppConfig.config.verType)) }));
  ...
  public static List<COMM.Entry> newReportEntries(Map<String, String> paramMap)
  {
    ArrayList localArrayList = new ArrayList();
    ...
    while (paramMap.hasNext())
    {
      ...
      localArrayList.add(newEntry((String)localEntry.getKey(), (String)localEntry.getValue()));
    }
    return localArrayList;
  }
