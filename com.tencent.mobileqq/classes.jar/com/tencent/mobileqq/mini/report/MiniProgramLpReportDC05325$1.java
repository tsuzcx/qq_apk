  ...
  public void run()
  {
    for (;;)
    {
      ...
      try
      {
        ...
        localObject3 = MiniProgramReportHelper.newEntry("uid", String.valueOf(bjjo.a().a()));
        ...
        localObject6 = MiniProgramReportHelper.newEntry("qua", bmsw.a());
        Object localObject7 = MiniProgramReportHelper.newEntry("deviceinfo", bmsv.a().c());
