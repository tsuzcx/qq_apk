  ...
  public void run()
  {
    for (;;)
    {
      ...
      try
      {
        ...
        localObject3 = MiniProgramReportHelper.newEntry("uid", String.valueOf(CommonDataAdapter.a().a()));
        ...
        Object localObject7 = MiniProgramReportHelper.newEntry("deviceinfo", PlatformInfor.g().getDeviceInfor());
