...
final class MiniProgramLpReportDC05325$1
  implements Runnable
{
  MiniProgramLpReportDC05325$1(MiniAppConfig paramMiniAppConfig, DownloadResult paramDownloadResult, int paramInt) {}
  ...
  public void run()
  {
    for (;;)
    {
      try
      {
        ...
        COMM.Entry localEntry1 = MiniProgramReportHelper.newEntry("uid", String.valueOf(bbtm.a().a()));
        ...
        COMM.Entry localEntry4 = MiniProgramReportHelper.newEntry("qua", bfpk.a());
        COMM.Entry localEntry5 = MiniProgramReportHelper.newEntry("deviceinfo", bfpj.a().c());
