  ...
  public void run()
  {
    for (;;)
    {
      ...
      try
      {
        ...
        localObject3 = MiniProgramReportHelper.newEntry("uid", String.valueOf(biip.a().a()));
        ...
        localObject6 = MiniProgramReportHelper.newEntry("qua", blru.a());
        Object localObject7 = MiniProgramReportHelper.newEntry("deviceinfo", blrt.a().c());
