...
public class InnerAppReportDc4239
{
  ...
  public static void innerAppReport(MiniAppConfig paramMiniAppConfig, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    MiniProgramReporter.getInstance().getReportHandler().post(new InnerAppReportDc4239.1(paramMiniAppConfig, paramString1, paramString2, paramString3, paramString4));
  }
}
