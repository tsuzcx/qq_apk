  ...
  extends MSFServlet
{
  ...
  private static void sendRequest(int paramInt1, String paramString, int paramInt2, byte[] paramArrayOfByte, BusinessObserver paramBusinessObserver)
  {
    ...
    paramArrayOfByte = new NewIntent(BaseApplicationImpl.getApplication(), bccl.class);
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (localObject2 = bguc.b(paramFromServiceMsg.getWupBuffer());; localObject2 = null)
    {
