  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      catch (Throwable localThrowable)
      {
        ...
        QLog.e("GetPotentialFriendListServlet", 1, localThrowable + "onReceive error");
      ...
      return;
      if (QLog.isColorLevel()) {
        QLog.d("GetPotentialFriendListServlet", 2, "onReceive. getUserInteractiveStorage rsp = " + localStQWebRsp);
      }
      notifyObserver(paramIntent, 1060, false, localBundle, MiniAppObserver.class);
    }
  }
