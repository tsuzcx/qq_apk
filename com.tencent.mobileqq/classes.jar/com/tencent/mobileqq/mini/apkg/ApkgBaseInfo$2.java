  ...
  implements Runnable
{
  ...
  public void run()
  {
    Toast.makeText(BaseApplicationImpl.getContext(), ApkgBaseInfo.access$000()[this.val$domainType] + HardCodeUtil.a(2131700363) + this.val$requestDomainConfig, 1).show();
  }
}
