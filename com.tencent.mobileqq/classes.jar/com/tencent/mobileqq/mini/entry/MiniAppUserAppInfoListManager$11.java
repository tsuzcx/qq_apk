  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      atmp localatmp = ((AppInterface)localObject1).getEntityManagerFactory().createEntityManager();
      if (localatmp == null) {
        continue;
      }
      ...
      try
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          MiniAppUserAppInfoListManager.access$1100(this.this$0, localatmp, localMiniAppEntity);
          i += 1;
