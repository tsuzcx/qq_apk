  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      MiniAppCmdUtil.getInstance().useUserApp(this.val$appConfig.config.appId, this.val$appConfig.config.verType, i, str1, str2, null, new MiniAppUtils.8.1(this, str1, str2, bool));
      return;
      label124:
      i = 0;
      break;
