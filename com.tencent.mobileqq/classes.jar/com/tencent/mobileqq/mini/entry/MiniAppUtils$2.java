  ...
  implements Runnable
{
  ...
  public void run()
  {
    Object localObject2 = Storage.open(this.val$jsPluginEngine.activityContext, String.valueOf(bjjo.a().a()), this.val$jsPluginEngine.appBrandRuntime.getApkgInfo().appId);
