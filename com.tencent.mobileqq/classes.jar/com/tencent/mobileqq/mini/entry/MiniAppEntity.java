  ...
  extends Entity
{
  ...
  private byte[] packMiniAppInfo(MiniAppInfo paramMiniAppInfo)
  {
    ...
    //   6: aload_3
    //   7: iconst_0
    //   8: invokevirtual 50	android/os/Parcel:setDataPosition	(I)V
    //   11: aload_3
    //   12: astore_2
    //   13: aload_3
    //   14: aload_1
    //   15: iconst_0
    //   16: invokevirtual 54	android/os/Parcel:writeParcelable	(Landroid/os/Parcelable;I)V
    //   19: aload_3
    //   20: astore_2
    //   21: aload_3
    //   22: invokevirtual 58	android/os/Parcel:marshall	()[B
    //   25: astore_1
    //   26: aload_3
    //   27: ifnull +7 -> 34
    //   30: aload_3
    //   31: invokevirtual 61	android/os/Parcel:recycle	()V
    //   34: aload_1
    //   35: areturn
    //   36: astore_1
    //   37: goto +76 -> 113
    ...
    //   62: dup
    //   63: invokespecial 64	java/lang/StringBuilder:<init>	()V
    //   66: astore 4
    //   68: aload_1
    //   69: astore_2
    //   70: aload 4
    ...
    //   100: invokestatic 86	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   103: aload_1
    //   104: ifnull +7 -> 111
    //   107: aload_1
    ...
    //   114: ifnull +7 -> 121
    //   117: aload_2
    //   118: invokevirtual 61	android/os/Parcel:recycle	()V
    //   121: aload_1
    //   122: athrow
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	123	0	this	MiniAppEntity
    ...
    //   66	30	4	localStringBuilder	java.lang.StringBuilder
    // Exception table:
    //   from	to	target	type
    //   6	11	36	finally
    //   13	19	36	finally
  ...
  public MiniAppInfo createFromBuffer(byte[] paramArrayOfByte)
  {
    ...
    //   90: aload 4
    //   92: aload_3
    //   93: invokestatic 76	android/util/Log:getStackTraceString	(Ljava/lang/Throwable;)Ljava/lang/String;
    ...
    //   110: invokestatic 86	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   113: aload_1
    //   114: ifnull +24 -> 138
    //   117: goto +17 -> 134
    //   120: aload_1
    ...
    //   124: iconst_1
    //   125: ldc 108
    //   127: invokestatic 86	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   130: aload_1
    //   131: ifnull +7 -> 138
    //   134: aload_1
    //   135: invokevirtual 61	android/os/Parcel:recycle	()V
    //   138: aconst_null
    //   139: areturn
    //   140: aload_2
    //   141: ifnull +7 -> 148
    //   144: aload_2
    //   145: invokevirtual 61	android/os/Parcel:recycle	()V
    //   148: aload_1
    //   149: athrow
    //   150: astore_1
    //   151: goto +9 -> 160
    ...
    //   76	30	4	localStringBuilder	java.lang.StringBuilder
    // Exception table:
    //   from	to	target	type
    //   6	14	46	finally
    //   16	21	46	finally
