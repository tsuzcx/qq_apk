  ...
  implements agzy, bega, MiniAppPullInterface, BusinessObserver
{
  ...
  private static final int OFFSET_NODE_OPEN = bajq.a(-50.0F);
  private static final int OFFSET_NODE_SCROLL = bajq.a(-50.0F);
  private static final int OFFSET_NODE_SCROLL_FAST = bajq.a(-100.0F);
  private static final int OVER_FLING_DISTANCE = 70;
  private static final float SPEED_2 = 1.5F;
  private static final int STORY_TRANSLATE = bajq.a(-70.0F);
  ...
  private void setNightMode()
  {
    try
    {
      ...
      int i = this.mContext.getResources().getColor(2131101357);
      this.mChatTopRefresh.setTextColor(i, i, i, i, i);
      TextView localTextView = (TextView)this.mChatTopRefresh.findViewById(2131309308);
  ...
  private void setNormalMode()
  {
    try
    {
      this.mListView.setOverscrollHeader(this.mContext.getResources().getDrawable(2130849472));
      int i = this.mContext.getResources().getColor(2131101319);
      this.mChatTopRefresh.setTextColor(i, i, i, i, i);
      TextView localTextView = (TextView)this.mChatTopRefresh.findViewById(2131309308);
      if (localTextView != null) {
        localTextView.setTextColor(i);
  ...
  private void updateRefreshTheme()
  {
    for (;;)
    {
      try
      {
        ...
        Object localObject1 = (agtk)this.mApp.getManager(342);
        if ((localObject1 != null) && (((agtk)localObject1).h()))
        {
          ...
          if ((localHongBaoResBuilder.getRefreshTextColor() != 2147483647) && (this.mChatTopRefresh != null))
          {
            ...
            this.mChatTopRefresh.setTextColor(i, i, i, i, i);
            localObject3 = (TextView)this.mChatTopRefresh.findViewById(2131309308);
          ...
          if ((((agtk)localObject1).a() != null) || (localHongBaoResBuilder.getBackgroundUrl() != null) || (localHongBaoResBuilder.getBackgroundResId() != -1) || (this.mListView == null)) {
            break;
          }
        ...
        {
          localObject1 = this.mContext.getResources().getDrawable(2130839117);
  ...
  public View getSpringEntryView()
  {
    ...
    if (this.mContentView != null) {
      localView = this.mContentView.findViewById(2131310616);
    }
    return localView;
  }
  ...
  public void initUI(Activity paramActivity)
  {
    ...
    if (this.mChatTopRefresh != null)
    {
      ...
      if (this.mChatTopRefresh.indexOfChild(this.mContentView) < 0)
      {
        ...
        localLayoutParams.addRule(3, 2131309304);
  ...
  {
    if ((this.mContentView != null) && (amda.l())) {
  ...
  public void onTouchMoving(ARMapHongBaoListView paramARMapHongBaoListView, boolean paramBoolean, MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (paramARMapHongBaoListView.mForStory)
      {
        ...
        {
          paramMotionEvent = (TextView)this.mChatTopRefresh.findViewById(2131309308);
          if ((paramMotionEvent.getText().toString() != null) && (paramMotionEvent.getText().toString().contains(ajjy.a(2131644670)))) {}
