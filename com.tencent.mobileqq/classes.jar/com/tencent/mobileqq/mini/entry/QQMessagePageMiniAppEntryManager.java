  ...
  implements ajij, bhto, MiniAppPullInterface, BusinessObserver
{
  ...
  private void setNightMode()
  {
    try
    {
      ...
      int i = this.mContext.getResources().getColor(2131167002);
      this.mChatTopRefresh.setTextColor(i, i, i, i, i);
      TextView localTextView = (TextView)this.mChatTopRefresh.findViewById(2131375587);
  ...
  private void setNormalMode()
  {
    try
    {
      this.mListView.setOverscrollHeader(this.mContext.getResources().getDrawable(2130850260));
      int i = this.mContext.getResources().getColor(2131166963);
      this.mChatTopRefresh.setTextColor(i, i, i, i, i);
      TextView localTextView = (TextView)this.mChatTopRefresh.findViewById(2131375587);
      if (localTextView != null) {
        localTextView.setTextColor(i);
  ...
  private void updateRefreshTheme()
  {
    try
    {
      ...
      {
        Drawable localDrawable = this.mContext.getResources().getDrawable(2130839229);
  ...
  {
    if ((this.mContentView != null) && (aoom.l())) {
  ...
  public void onTouchMoving(ARMapHongBaoListView paramARMapHongBaoListView, boolean paramBoolean, MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (paramARMapHongBaoListView.mForStory)
      {
        ...
        {
          paramMotionEvent = (TextView)this.mChatTopRefresh.findViewById(2131375587);
          if ((paramMotionEvent.getText().toString() != null) && (paramMotionEvent.getText().toString().contains(alud.a(2131710850)))) {}
