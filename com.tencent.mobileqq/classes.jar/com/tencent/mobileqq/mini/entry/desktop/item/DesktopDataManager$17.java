  ...
  implements Runnable
{
  ...
  public void run()
  {
    if ((this.val$miniAppInfo != null) && (DesktopDataManager.access$1500(this.this$0) != null)) {
    ...
    for (;;)
    {
      ...
      return;
      Object localObject = DesktopDataManager.access$1500(this.this$0).iterator();
      ...
      for (;;)
      {
        ...
        localDesktopItemInfo = (DesktopItemInfo)DesktopDataManager.access$1500(this.this$0).get(i);
        if (((localDesktopItemInfo instanceof DesktopAppModuleInfo)) && (localDesktopItemInfo.getModuleType() == 3))
        {
          DesktopDataManager.access$1500(this.this$0).add(i + 1, localObject);
          break;
        }
        i += 1;
      }
