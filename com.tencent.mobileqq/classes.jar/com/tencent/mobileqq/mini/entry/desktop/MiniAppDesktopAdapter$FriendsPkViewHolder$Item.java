...
class MiniAppDesktopAdapter$FriendsPkViewHolder$Item
{
  ...
  MiniAppDesktopAdapter$FriendsPkViewHolder$Item(MiniAppDesktopAdapter.FriendsPkViewHolder paramFriendsPkViewHolder, View paramView)
  {
    ...
    this.mIcon = ((ImageView)paramView.findViewById(2131304518));
    this.mCrown = ((ImageView)paramView.findViewById(2131304519));
    this.mName = ((TextView)paramView.findViewById(2131304521));
    this.mRanking = ((TextView)paramView.findViewById(2131304522));
    this.mScore = ((TextView)paramView.findViewById(2131304523));
    this.mUnit = ((TextView)paramView.findViewById(2131304514));
  }
  ...
  public void setData(INTERFACE.StRankingList paramStRankingList)
  {
    ...
    try
    {
      Object localObject = this.this$0.itemView.getResources().getDrawable(2130839687);
      ...
      ((URLDrawable)localObject).setTag(azue.a(bajq.a(30.0F), bajq.a(30.0F)));
