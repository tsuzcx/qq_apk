...
class DesktopDataManager$24
  implements Runnable
{
  DesktopDataManager$24(DesktopDataManager paramDesktopDataManager, MiniAppInfo paramMiniAppInfo) {}
  ...
  public void run()
  {
    ...
    if (i == -1) {
      DesktopDataManager.access$1300(this.this$0).add(localDesktopAppInfo);
    }
    for (;;)
    {
      ...
      return;
      DesktopDataManager.access$1300(this.this$0).add(i, localDesktopAppInfo);
    }
  }
}
