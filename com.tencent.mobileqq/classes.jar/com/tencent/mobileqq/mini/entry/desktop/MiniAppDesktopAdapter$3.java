    ...
    for (;;)
    {
      try
      {
        ...
        try
        {
          ...
          paramView = ((qq_ad_get.QQAdGetRsp.AdInfo)qq_ad_get.QQAdGetRsp.AdInfo.class.cast(ynv.a(new qq_ad_get.QQAdGetRsp.AdInfo(), paramView))).report_info.click_url.get();
