  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    try
    {
      Object localObject2 = new DesktopDataManager.14.1(this, DesktopDataManager.access$2600(this.this$0, localAppInterface));
    ...
    Object localObject1 = (akie)localThrowable.getBusinessHandler(148);
    if (localObject1 != null) {
      ((akie)localObject1).c();
    }
    localObject1 = amda.a("miniappgetpskeydomain", "qzone.qq.com");
    if (!TextUtils.isEmpty((CharSequence)localObject1))
    {
      ...
      {
        localObject1 = ((TicketManager)BaseApplicationImpl.getApplication().getRuntime().getManager(2)).GetPskey(BaseApplicationImpl.getApplication().getRuntime().getAccount(), 16L, (String[])localObject1, new DesktopDataManager.14.2(this));
