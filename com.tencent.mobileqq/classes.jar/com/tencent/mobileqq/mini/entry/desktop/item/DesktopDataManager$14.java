  ...
  public void run()
  {
    try
    {
      ...
      if (localArrayList.size() > 0) {
        DesktopDataManager.access$1502(this.this$0, new ArrayList(localArrayList));
      }
      MiniAppUtils.updateMiniAppList(2);
      QLog.e("DesktopDataManager", 1, "useLocalDataIfRequestFailed, " + localStringBuilder.toString());
      return;
    }
