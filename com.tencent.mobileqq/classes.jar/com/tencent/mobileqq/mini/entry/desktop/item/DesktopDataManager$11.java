...
{
  DesktopDataManager$11(DesktopDataManager paramDesktopDataManager) {}
  
  public void onCmdListener(boolean paramBoolean, JSONObject paramJSONObject)
  {
    long l = 0L;
    DesktopDataManager.access$2002(this.this$0, false);
    if ((paramBoolean) && (paramJSONObject != null))
    {
      ...
      if (paramJSONObject != null)
      {
        ...
        for (int i = paramJSONObject.modules.get().size();; i = 0)
        {
          ...
          DesktopDataManager.access$2200(this.this$0, paramJSONObject.modules.get());
          DesktopDataManager.access$2302(this.this$0, (COMM.StCommonExt)paramJSONObject.extInfo.get());
