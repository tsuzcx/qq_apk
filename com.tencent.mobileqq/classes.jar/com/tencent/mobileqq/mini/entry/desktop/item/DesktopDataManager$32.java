...
class DesktopDataManager$32
  implements Runnable
{
  DesktopDataManager$32(DesktopDataManager paramDesktopDataManager, MiniAppRedDotEntity paramMiniAppRedDotEntity) {}
  ...
  public void run()
  {
    ...
    if (localObject != null)
    {
      if (DesktopDataManager.access$3500(this.this$0, (EntityManager)localObject, this.val$entity))
      {
