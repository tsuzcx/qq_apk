...
class DesktopDataManager$25
  implements Runnable
{
  DesktopDataManager$25(DesktopDataManager paramDesktopDataManager, int paramInt1, int paramInt2) {}
  
  public void run()
  {
    int i = DesktopDataManager.access$3300(this.this$0);
    DesktopItemInfo localDesktopItemInfo = (DesktopItemInfo)DesktopDataManager.access$1300(this.this$0).remove(this.val$old_order + i);
    DesktopDataManager.access$1300(this.this$0).add(i + this.val$new_order, localDesktopItemInfo);
