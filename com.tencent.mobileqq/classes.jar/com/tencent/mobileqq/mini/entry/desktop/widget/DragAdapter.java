  ...
  implements DragRecyclerView.OnItemChangeListener
{
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          if (this.mDragMirrorMarkImage != null)
          {
            ...
            label538:
            if ((Math.abs(paramInt1 - this.lastDragLeft) > bdkf.b(5.0F)) || (Math.abs(paramInt2 - this.lastDragTop) > bdkf.b(5.0F)))
            {
          ...
          try
          {
            if (this.mIntertTarget < 0)
            {
              ...
              if ((i != 0) || ((localObject1 != null) && (paramInt1 - ((RecyclerView.ViewHolder)localObject1).itemView.getLeft() >= bdkf.b(20.0F)) && (paramInt2 - ((RecyclerView.ViewHolder)localObject1).itemView.getTop() >= bdkf.b(5.0F))))
              {
  ...
  protected boolean isDragCancel()
  {
    ...
    for (int j = this.mDragViewHolder.itemView.getTop();; j = 0)
    {
      ...
      {
        bool1 = bool2;
        if (Math.abs(this.startDragX - i) < bdkf.b(15.0F))
        {
          bool1 = bool2;
          if (Math.abs(this.startDragY - j) >= bdkf.b(15.0F)) {}
        }
      }
      else
      {
  ...
  public void onDragMoveImpl(int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 >= this.mRecyclerView.getRight() - bdkf.a(80.0F))
    {
  ...
  public void onItemPrepared(int paramInt)
  {
    ...
    if (paramInt >= 0) {
      if (!this.mDeletePrepared)
      {
        ...
        if (this.mDragMirrorMarkImage != null)
        {
          this.mDragMirrorMarkImage.setImageResource(2130840723);
          this.mDragMirrorMarkImage.setVisibility(0);
        }
      }
    }
  ...
  public void setDragMirrorView(View paramView)
  {
    ...
    if (paramView != null)
    {
      this.mDragMirrorImage = ((ImageView)paramView.findViewById(2131370444));
      this.mDragMirrorMarkImage = ((ImageView)paramView.findViewById(2131370446));
      this.mDragMirrorMarkImage.setVisibility(4);
    }
  }
