  ...
  extends RecyclerView.ViewHolder
{
  ...
  {
    super(paramView);
    this.mRecycleView = ((DragRecyclerView)paramView.findViewById(2131375020));
    ...
    paramView = new aolm(MiniAppDesktopAdapter.access$3300(paramMiniAppDesktopAdapter), 0, false);
