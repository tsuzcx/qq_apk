  ...
  extends RecyclerView.ViewHolder
{
  ...
  {
    super(paramView);
    this.mRecycleView = ((DragRecyclerView)paramView.findViewById(2131376174));
    ...
    paramView = new arrk(MiniAppDesktopAdapter.access$3500(paramMiniAppDesktopAdapter), 0, false);
