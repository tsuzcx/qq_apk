  ...
  extends RecyclerView.ViewHolder
{
  ...
  {
    super(paramView);
    this.mRecycleView = ((DragRecyclerView)paramView.findViewById(2131309276));
    ...
    paramView = new anux(MiniAppDesktopAdapter.access$3300(paramMiniAppDesktopAdapter), 0, false);
