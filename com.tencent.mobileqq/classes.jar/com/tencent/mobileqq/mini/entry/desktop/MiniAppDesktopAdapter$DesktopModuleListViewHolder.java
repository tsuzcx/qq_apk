  ...
  extends RecyclerView.ViewHolder
{
  ...
  {
    super(paramView);
    this.mRecycleView = ((DragRecyclerView)paramView.findViewById(2131375492));
    ...
    paramView = new aqep(MiniAppDesktopAdapter.access$3400(paramMiniAppDesktopAdapter), 0, false);
