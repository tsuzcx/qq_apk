  ...
  extends RecyclerView.ViewHolder
{
  ...
  {
    super(paramView);
    this.mRecycleView = ((DragRecyclerView)paramView.findViewById(2131376407));
    ...
    paramView = new atfc(MiniAppDesktopAdapter.access$3500(paramMiniAppDesktopAdapter), 0, false);
