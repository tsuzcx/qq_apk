...
class DesktopDataManager$18
  implements Runnable
{
  DesktopDataManager$18(DesktopDataManager paramDesktopDataManager) {}
  ...
  public void run()
  {
    ...
    try
    {
      Object localObject2 = new DesktopDataManager.18.1(this, DesktopDataManager.access$2900(this.this$0, (AppInterface)localObject1));
      ...
      if ((localObject2 != null) && (((List)localObject2).size() > 0))
      {
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          if ((localMiniAppRedDotEntity != null) && (!TextUtils.isEmpty(localMiniAppRedDotEntity.appId))) {
            DesktopDataManager.access$3100(this.this$0).put(localMiniAppRedDotEntity.appId, Integer.valueOf(localMiniAppRedDotEntity.wnsPushRedDotNum));
          }
        }
      }
      DesktopDataManager.access$3200(this.this$0);
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject1))
      {
        ...
        {
          localObject1 = ((TicketManager)BaseApplicationImpl.getApplication().getRuntime().getManager(2)).getPskey(BaseApplicationImpl.getApplication().getRuntime().getAccount(), 16L, (String[])localObject1, new DesktopDataManager.18.2(this));
      ...
      DesktopDataManager.access$3302(this.this$0, true);
      return;
    }
