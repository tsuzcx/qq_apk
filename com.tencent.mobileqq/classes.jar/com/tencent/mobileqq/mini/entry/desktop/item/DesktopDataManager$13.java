  ...
  public void run()
  {
    try
    {
      ...
      while (i < ((JSONArray)localObject1).length())
      {
        ...
        localObject2 = MiniAppInfo.from((INTERFACE.StApiAppInfo)INTERFACE.StApiAppInfo.class.cast(ynv.a(new INTERFACE.StApiAppInfo(), localObject2)));
      ...
      if (localArrayList.size() > 0) {
        DesktopDataManager.access$1302(this.this$0, new ArrayList(localArrayList));
      }
