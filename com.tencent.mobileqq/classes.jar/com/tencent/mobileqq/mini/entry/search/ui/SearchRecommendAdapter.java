  ...
  implements MiniAppSearchDataManager.HotSearchDataChangedListener
{
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    default: 
      return null;
    case 1: 
      return new SearchRecommendAdapter.TitleViewHolder(LayoutInflater.from(paramViewGroup.getContext()).inflate(2131559412, paramViewGroup, false));
    case 2: 
      return new SearchRecommendAdapter.PlayingViewHolder(LayoutInflater.from(paramViewGroup.getContext()).inflate(2131559410, paramViewGroup, false));
    }
    return new SearchRecommendAdapter.LiveViewHolder(LayoutInflater.from(paramViewGroup.getContext()).inflate(2131559409, paramViewGroup, false));
  }
