...
{
  MiniAppSearchFragment$4(MiniAppSearchFragment paramMiniAppSearchFragment, TextView paramTextView, MiniAppSearchDataManager paramMiniAppSearchDataManager) {}
  
  public void onClick(View paramView)
  {
    String str = this.val$tv.getText().toString();
    MiniAppSearchFragment.access$000(this.this$0).setText(this.val$tv.getText());
    MiniAppSearchFragment.access$000(this.this$0).setSelection(this.val$tv.getText().length());
