  ...
  implements MiniAppCmdInterface
{
  ...
  public void onCmdListener(boolean paramBoolean, JSONObject arg2)
  {
    ...
    if ((paramBoolean) && (??? != null))
    {
      ...
      QLog.d("MiniAppSearchDataManager", 1, "sendSearchAppRequest, retCode = " + l + ", errMsg = " + (String)localObject1);
      if (l != 0L) {
        return;
      }
    ...
    for (;;)
    {
      ...
      QLog.e("MiniAppSearchDataManager", 1, "sendSearchAppRequest, isSuccess = " + paramBoolean + ", ret = " + ???);
    }
  }
}
