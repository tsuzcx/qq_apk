...
public class MapActivity
  ...
  implements View.OnClickListener, bbmr
{
  ...
  protected begh mOnSearchScrollListener = new MapActivity.5(this);
  TencentMap map;
  MapHelper mapHelper;
  QQMapView mapView;
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    paramBundle = LayoutInflater.from(this).inflate(2131495999, null);
    ...
    this.dialog = new bafb(this, 2131690181);
    this.dialog.setContentView(2131493345);
    this.dialog.setCanceledOnTouchOutside(false);
    this.mapHelper = new MapHelper(this);
    Intent localIntent = getIntent();
    this.type = localIntent.getIntExtra("key_type", 0);
    this.titleView = ((TextView)findViewById(2131302847));
    this.leftBtnView = ((TextView)findViewById(2131302804));
    this.rightBtnView = ((TextView)findViewById(2131302833));
    this.mapView = ((QQMapView)findViewById(2131304094));
    this.mapView.setContentDescription(getString(2131629551));
    ...
    this.poiLocationView = ((ImageView)findViewById(2131306118));
    this.pinView = ((ImageView)findViewById(2131306017));
    this.poiLayout = ((RelativeLayout)findViewById(2131306112));
    this.routeLayout = findViewById(2131309776);
    this.routeBtn = ((Button)findViewById(2131309772));
    ...
    try
    {
      paramBundle = BitmapFactory.decodeResource(getResources(), 2130846568);
    }
    ...
    try
    {
      localObject2 = BitmapFactory.decodeResource(getResources(), 2130841777);
    ...
    if (this.type == 1)
    {
      this.leftBtnView.setText(ajjy.a(2131640665));
      ...
      localObject1 = (TextView)this.routeLayout.findViewById(2131296589);
      localObject2 = (TextView)this.routeLayout.findViewById(2131299485);
    ...
    this.noResultView = ((TextView)findViewById(2131305203));
    this.poiAdapter = new POIAdapter(this);
    this.poiListView = ((XListView)findViewById(2131309910));
    ...
    this.leftBtnView.setText(ajjy.a(2131640662));
    this.rightBtnView.setVisibility(0);
    this.rightBtnView.setText(ajjy.a(2131640658));
  ...
  public void onClick(View paramView)
  {
    ...
    {
      return;
      if (paramView.getId() == 2131306118)
      {
        location(true);
        return;
      }
      if (paramView.getId() == 2131309772)
      {
        this.mapHelper.showActionSheet(this.fromLatLng, this.targetLatLng, null, this.targetName);
        return;
      }
    } while (paramView.getId() != 2131302833);
    paramView = this.poiAdapter.getItem(this.poiAdapter.selectPos);
    if (paramView == null)
    {
      bbmy.a(this, 0, ajjy.a(2131640664), 1).b(getResources().getDimensionPixelSize(2131167766));
      return;
    }
