  ...
  extends BaseAdapter
{
  ...
  public POIAdapter(Context paramContext)
  {
    ...
    this.textGray = paramContext.getResources().getColor(2131167106);
    this.textBlack = paramContext.getResources().getColor(2131167026);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramView = this.mInflater.inflate(2131561996, null);
      ((POIAdapter.PoiItemViewHolder)localObject).nameTextView = ((TextView)paramView.findViewById(2131371815));
      ((POIAdapter.PoiItemViewHolder)localObject).addrTextView = ((TextView)paramView.findViewById(2131362211));
      ((POIAdapter.PoiItemViewHolder)localObject).chooseView = paramView.findViewById(2131377301);
