  ...
  extends BaseAdapter
{
  ...
  public POIAdapter(Context paramContext)
  {
    ...
    this.textGray = paramContext.getResources().getColor(2131167113);
    this.textBlack = paramContext.getResources().getColor(2131167033);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramView = this.mInflater.inflate(2131562133, null);
      ((POIAdapter.PoiItemViewHolder)localObject).nameTextView = ((TextView)paramView.findViewById(2131372127));
      ((POIAdapter.PoiItemViewHolder)localObject).addrTextView = ((TextView)paramView.findViewById(2131362229));
      ((POIAdapter.PoiItemViewHolder)localObject).chooseView = paramView.findViewById(2131377721);
