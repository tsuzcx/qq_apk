  ...
  implements View.OnLongClickListener
{
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    if (paramView.getBoolean("persistent", false))
    {
      ...
      Toast.makeText(this.this$0.getActivity(), this.this$0.getResources().getString(2131628620), 1).show();
      return false;
    }
    paramView.edit().putBoolean("persistent", true).apply();
    QLog.e("MainPageFragment", 1, "open persistent debug version");
    Toast.makeText(this.this$0.getActivity(), this.this$0.getResources().getString(2131628621), 1).show();
    return false;
  }
}
