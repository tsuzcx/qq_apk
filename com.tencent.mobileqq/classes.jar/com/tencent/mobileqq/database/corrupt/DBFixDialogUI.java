  ...
  implements DBFixLoadingDialog.onDBFixCall
{
  ...
  public Context a;
  DialogInterface.OnCancelListener jdField_a_of_type_AndroidContentDialogInterface$OnCancelListener = new abou(this);
  ...
  private void a(Dialog paramDialog, String paramString)
  {
    ...
    this.h = paramString;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.runOnUiThread(new abow(this, paramDialog));
  }
  ...
  private void d()
  {
    jdField_a_of_type_AndroidAppDialog = DialogUtil.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage("修复成功，请重启QQ。").setPositiveButton("强制关闭", new aboz(this));
    jdField_a_of_type_AndroidAppDialog.setOnKeyListener(new abpa(this));
    jdField_a_of_type_AndroidAppDialog.setOnCancelListener(this.jdField_a_of_type_AndroidContentDialogInterface$OnCancelListener);
  ...
  private void e()
  {
    jdField_a_of_type_AndroidAppDialog = DialogUtil.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage("修复失败，重启QQ重试。").setPositiveButton("重启QQ", new abpb(this));
    jdField_a_of_type_AndroidAppDialog.setOnCancelListener(this.jdField_a_of_type_AndroidContentDialogInterface$OnCancelListener);
  ...
  private void f()
  {
    jdField_a_of_type_AndroidAppDialog = DialogUtil.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage("手机空间不足，无法修复聊天记录，请清理手机中的缓存垃圾，释放空间后再修复聊天记录。").setPositiveButton("空间清理", new abov(this)).setNegativeButton("取消", new abpd(this));
    jdField_a_of_type_AndroidAppDialog.setOnCancelListener(this.jdField_a_of_type_AndroidContentDialogInterface$OnCancelListener);
  ...
  public void a(int paramInt)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.runOnUiThread(new abpc(this, paramInt));
  }
  
  public void b()
  {
    jdField_a_of_type_AndroidAppDialog = DialogUtil.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage("检测到你的聊天记录出现异常，请立即修复，否则聊天记录将丢失").setPositiveButton("确定", new aboy(this)).setNegativeButton("取消", new abox(this));
    jdField_a_of_type_AndroidAppDialog.setOnCancelListener(this.jdField_a_of_type_AndroidContentDialogInterface$OnCancelListener);
