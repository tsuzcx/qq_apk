...
public class MineFragment
{
  public static void a(NearbyAppInterface paramNearbyAppInterface)
  {
    ...
    if ((NearbyHandler)paramNearbyAppInterface.getBusinessHandler(NearbyConstants.a) != null)
    {
      oidb_0x91f.ReqBody localReqBody = new oidb_0x91f.ReqBody();
      localReqBody.uint32_state.set(0);
      ProtoUtils.a(paramNearbyAppInterface, new MineFragment.1(paramNearbyAppInterface), localReqBody.toByteArray(), "OidbSvc.0x91f", 2335, 5, null, 0L);
    }
