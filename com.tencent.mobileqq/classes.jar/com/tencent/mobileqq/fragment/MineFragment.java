...
public class MineFragment
{
  public static void a(NearbyAppInterface paramNearbyAppInterface)
  {
    ...
    if ((NearbyHandler)paramNearbyAppInterface.a(3) != null)
    {
      ...
      ProtoUtils.a(paramNearbyAppInterface, new advd(paramNearbyAppInterface), localReqBody.toByteArray(), "OidbSvc.0x91f", 2335, 5, null, 0L);
    }
    ...
    ThreadManager.post(new adve(paramNearbyAppInterface), 10, null, true);
  }
