  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      {
        ChatActivityFacade.b(this.this$0.getActivity().app, this.this$0.getActivity(), this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, String.valueOf(i));
        try
        {
          Thread.sleep(20L);
          i += 1;
