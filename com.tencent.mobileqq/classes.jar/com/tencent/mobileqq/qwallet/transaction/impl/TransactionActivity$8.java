  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    TransactionActivity.access$100(this.this$0).dispatchTouchEvent(localMotionEvent1);
    MotionEvent localMotionEvent2 = MotionEvent.obtain(SystemClock.uptimeMillis(), SystemClock.uptimeMillis(), 1, 0.0F, 0.0F, 0);
    TransactionActivity.access$100(this.this$0).dispatchTouchEvent(localMotionEvent2);
 ...
 * Qualified Name:     com.tencent.mobileqq.qwallet.transaction.impl.TransactionActivity.8
