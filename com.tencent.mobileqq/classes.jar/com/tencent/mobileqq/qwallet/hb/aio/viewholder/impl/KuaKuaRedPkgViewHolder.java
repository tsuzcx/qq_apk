  ...
  extends BaseViewHolder
{
  ...
  public KuaKuaRedPkgViewHolder(BaseQQAppInterface paramBaseQQAppInterface, IQWalletMsgHolder paramIQWalletMsgHolder, QQWalletBaseMsgElem paramQQWalletBaseMsgElem, int paramInt, ICustomizeStrategyFactory.OnCustomizeListener paramOnCustomizeListener)
  {
  ...
  public boolean a()
  {
    ...
    this.jdField_a_of_type_ComQwalletTempIQWalletMsgHolder.a().setText("夸夸红包");
    return true;
  }
  ...
  public void e()
  {
    ...
    try
    {
      this.jdField_a_of_type_ComQwalletTempIQWalletMsgHolder.c().setTextColor(Color.parseColor("#FFDDB2"));
 ...
 * Qualified Name:     com.tencent.mobileqq.qwallet.hb.aio.viewholder.impl.KuaKuaRedPkgViewHolder
