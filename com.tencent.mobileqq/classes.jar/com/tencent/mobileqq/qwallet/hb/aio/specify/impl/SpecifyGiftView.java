  ...
  extends RelativeLayout
{
  ...
  private ISpriteVideoViewTemp jdField_a_of_type_ComQwalletTempISpriteVideoViewTemp;
  ...
  public SpecifyGiftView(Context paramContext, MessageForQQWalletMsg paramMessageForQQWalletMsg)
  {
    ...
    this.jdField_a_of_type_ComQwalletTempISpriteVideoViewTemp = ((ISpriteVideoViewTemp)QRoute.api(ISpriteVideoViewTemp.class));
    this.jdField_a_of_type_Int = DisplayUtil.a(paramContext, 325.0F);
    this.b = DisplayUtil.a(paramContext, 350.0F);
    this.jdField_a_of_type_ComQwalletTempISpriteVideoViewTemp.setPivotX(this.jdField_a_of_type_Int / 2);
    this.jdField_a_of_type_ComQwalletTempISpriteVideoViewTemp.setPivotY(this.b / 2);
    paramContext = new RelativeLayout(paramContext);
    paramContext.addView(this.jdField_a_of_type_ComQwalletTempISpriteVideoViewTemp.getView());
    ...
    this.jdField_a_of_type_ComQwalletTempISpriteVideoViewTemp.setId(R.id.jdField_a_of_type_Int);
    ...
    paramContext.addRule(7, R.id.jdField_a_of_type_Int);
    paramContext.addRule(6, R.id.jdField_a_of_type_Int);
  ...
  private View a(MessageForQQWalletMsg paramMessageForQQWalletMsg, LinearLayout paramLinearLayout)
  {
    ...
    paramLinearLayout.setBackgroundResource(R.drawable.an);
    ...
    localImageView.setBackgroundResource(R.drawable.am);
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      ((ImageView)localObject2).setBackgroundResource(R.drawable.am);
    ...
    if (i >= 2)
    {
      ...
      paramLinearLayout.append(HardCodeUtil.a(R.string.cN));
      paramLinearLayout.append(i);
      paramLinearLayout.append(HardCodeUtil.a(R.string.cO));
    ...
    localTextView2.setText(HardCodeUtil.a(R.string.cP));
    ...
    localView.setBackgroundResource(R.drawable.al);
    return localRelativeLayout;
  }
  
  public void a()
  {
    ISpriteVideoViewTemp localISpriteVideoViewTemp = this.jdField_a_of_type_ComQwalletTempISpriteVideoViewTemp;
  ...
  public void a(String paramString, ISpriteVideoViewTemp.OnFrameEndListener paramOnFrameEndListener, View.OnClickListener paramOnClickListener)
  {
    ...
    {
      this.jdField_a_of_type_ComQwalletTempISpriteVideoViewTemp.play(paramString, paramOnFrameEndListener);
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new SpecifyGiftView.1(this, paramOnFrameEndListener, paramOnClickListener));
    QWalletTools.a(this.jdField_a_of_type_AndroidWidgetImageView, 0.6F);
  }
}
