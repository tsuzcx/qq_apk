  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    {
      ((IPasswdRedBagService)localObject1).createPasswdRedBagAnonymousTips(this.a.sessionInfo.jdField_a_of_type_JavaLangString, 2);
    ...
    if (this.a.sessionInfo.jdField_a_of_type_Int == 1)
    {
      ...
      boolean bool = ((ITroopGagMgr)localObject2).isTroopMemberGag(this.a.sessionInfo.jdField_a_of_type_JavaLangString, this.a.mAppInterface.getCurrentAccountUin());
      localObject2 = ((ITroopGagMgr)localObject2).getSelfGagInfo(this.a.sessionInfo.jdField_a_of_type_JavaLangString, false);
      if ((bool) || ((localObject2 != null) && (((SelfGagInfo)localObject2).jdField_a_of_type_Boolean)))
      {
        ((IPasswdRedBagService)localObject1).createPasswdRedBagBanTips(this.a.sessionInfo.jdField_a_of_type_JavaLangString, 2);
        if (QLog.isColorLevel()) {
    ...
    {
      ((IPasswdRedBagService)localObject1).setPasswdRedBagOpen(localQQWalletRedPacketMsg.redPacketId, this.a.sessionInfo.jdField_a_of_type_JavaLangString, this.a.sessionInfo.jdField_a_of_type_Int);
      ...
      ((IPasswdRedBagService)localObject1).openPasswdBagByTenpay(this.a.sessionInfo, (PasswdRedBagInfo)localObject2, l, 65536, paramView, localMessageForQQWalletMsg.mQQWalletRedPacketMsg.elem.i, localMessageForQQWalletMsg.fromHBList, null);
      if (QLog.isColorLevel())
      {
