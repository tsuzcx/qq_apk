...
class RedPacketProxyImpl$1
  extends ResultReceiver
{
  RedPacketProxyImpl$1(RedPacketProxyImpl paramRedPacketProxyImpl, Handler paramHandler, IRedPacket.OnGetSkinListener paramOnGetSkinListener)
  {
    super(paramHandler);
  }
  ...
  protected void onReceiveResult(int paramInt, Bundle paramBundle)
  {
    ...
    if (localAppRuntime != null) {
      localAppRuntime.runOnUiThread(new RedPacketProxyImpl.1.1(this, paramBundle));
    }
  }
}
 ...
 * Qualified Name:     com.tencent.mobileqq.qwallet.hb.impl.RedPacketProxyImpl.1
