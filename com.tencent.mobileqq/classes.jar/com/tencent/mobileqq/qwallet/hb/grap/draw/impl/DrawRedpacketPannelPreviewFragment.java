  ...
  implements View.OnClickListener
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new DrawRedpacketPannelPreviewFragment.1(this, Looper.getMainLooper());
  private View jdField_a_of_type_AndroidViewView;
  private Button jdField_a_of_type_AndroidWidgetButton;
  private ImageView jdField_a_of_type_AndroidWidgetImageView;
  public TextView a;
  private DoodleLayout jdField_a_of_type_ComTencentMobileqqQwalletHbGrapDrawImplDoodleLayout;
  ...
  private Bitmap a()
  {
    Bitmap localBitmap = Bitmap.createBitmap(this.jdField_a_of_type_ComTencentMobileqqQwalletHbGrapDrawImplDoodleLayout.getWidth(), this.jdField_a_of_type_ComTencentMobileqqQwalletHbGrapDrawImplDoodleLayout.getHeight() + DisplayUtil.a(getQBaseActivity(), 50.0F), Bitmap.Config.ARGB_8888);
    Canvas localCanvas = new Canvas(localBitmap);
    Drawable localDrawable = this.jdField_a_of_type_ComTencentMobileqqQwalletHbGrapDrawImplDoodleLayout.getBackground();
    ...
    localCanvas.drawColor(-1);
    this.jdField_a_of_type_ComTencentMobileqqQwalletHbGrapDrawImplDoodleLayout.draw(localCanvas);
    return a(getQBaseActivity(), localBitmap, this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg.mQQWalletRedPacketMsg.elem.jdField_a_of_type_JavaLangString, 40, Color.parseColor("#878B99"));
  }
  ...
  public static String a(Bitmap paramBitmap, String paramString1, String paramString2)
  {
    ...
    //   6: aload 5
    //   8: astore_3
    //   9: new 231	java/io/File
    //   12: dup
    //   13: aload_2
    //   14: invokespecial 234	java/io/File:<init>	(Ljava/lang/String;)V
    //   17: astore 6
    //   19: aload 5
    //   21: astore_3
    //   22: aload 6
    //   24: invokevirtual 238	java/io/File:exists	()Z
    //   27: ifne +12 -> 39
    //   30: aload 5
    //   32: astore_3
    //   33: aload 6
    //   35: invokevirtual 241	java/io/File:mkdirs	()Z
    //   38: pop
    //   39: aload 5
    //   41: astore_3
    //   42: new 231	java/io/File
    //   45: dup
    //   46: aload_2
    //   47: aload_1
    ...
    //   54: astore_3
    //   55: aload_1
    //   56: invokevirtual 238	java/io/File:exists	()Z
    //   59: ifne +11 -> 70
    //   62: aload 5
    //   64: astore_3
    //   65: aload_1
    //   66: invokevirtual 247	java/io/File:createNewFile	()Z
    //   69: pop
    //   70: aload 5
    //   72: astore_3
    //   73: new 249	java/io/BufferedOutputStream
    //   76: dup
    //   77: new 251	java/io/FileOutputStream
    //   80: dup
    //   81: aload_1
    //   82: invokespecial 254	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   85: invokespecial 257	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   88: astore_2
    //   89: aload_0
    //   90: getstatic 263	android/graphics/Bitmap$CompressFormat:PNG	Landroid/graphics/Bitmap$CompressFormat;
    //   93: bipush 80
    //   95: aload_2
    //   96: invokevirtual 267	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   99: pop
    //   100: aload_2
    //   101: invokevirtual 270	java/io/BufferedOutputStream:flush	()V
    //   104: aload_2
    //   105: invokevirtual 273	java/io/BufferedOutputStream:close	()V
    //   108: aload_1
    //   109: astore_2
    //   110: goto +52 -> 162
    //   113: astore_0
    ...
    //   145: astore_3
    //   146: aload_2
    //   147: invokevirtual 276	java/lang/Throwable:printStackTrace	()V
    //   150: aload_1
    //   151: astore_2
    //   152: aload_0
    //   153: ifnull +9 -> 162
    //   156: aload_0
    //   157: invokevirtual 273	java/io/BufferedOutputStream:close	()V
    //   160: aload_1
    //   161: astore_2
    //   162: aload_2
    //   163: ifnull +8 -> 171
    //   166: aload_2
    //   167: invokevirtual 279	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   170: areturn
    //   171: ldc_w 281
    //   174: areturn
    //   175: aload_3
    //   176: ifnull +7 -> 183
    //   179: aload_3
    //   180: invokevirtual 273	java/io/BufferedOutputStream:close	()V
    //   183: aload_0
    //   184: athrow
  ...
  private void a()
  {
    ...
    this.f.setText(HardCodeUtil.a(R.string.aw));
    this.jdField_a_of_type_AndroidWidgetButton.setVisibility(4);
    String str1 = this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg.mQQWalletRedPacketMsg.elem.jdField_a_of_type_JavaLangString;
  ...
  private void b()
  {
    DrawClassifier.a().a(this.jdField_a_of_type_ComTencentMobileqqQwalletHbGrapDrawImplDoodleLayout.a(), new DrawRedpacketPannelPreviewFragment.4(this));
  }
  ...
  private void d()
  {
    ...
    if (localObject != null)
    {
      ...
      {
        PasswdRedBagInfo localPasswdRedBagInfo = ((IPasswdRedBagService)localObject).getPasswdRedBagInfoById(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg.mQQWalletRedPacketMsg.redPacketId);
        ((IPasswdRedBagService)localObject).setPasswdRedBagOpen(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg.mQQWalletRedPacketMsg.redPacketId, this.jdField_a_of_type_ComTencentMobileqqActivityAioBaseSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioBaseSessionInfo.jdField_a_of_type_Int);
        ...
        ((IPasswdRedBagService)localObject).openPasswdBagByTenpay(this.jdField_a_of_type_ComTencentMobileqqActivityAioBaseSessionInfo, localPasswdRedBagInfo, 0L, 1000001, "", this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg.mQQWalletRedPacketMsg.elem.i, this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg.fromHBList, localBundle);
      }
    }
  }
  ...
  protected void a(View paramView)
  {
    ...
    super.a(paramView);
    ((ViewStub)paramView.findViewById(R.id.bY)).inflate();
    String str = c();
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)getQBaseActivity().findViewById(R.id.cA));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(R.id.ab));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(R.id.ad));
    this.f = ((TextView)paramView.findViewById(R.id.ac));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(R.id.J));
    this.jdField_c_of_type_AndroidWidgetImageView.setOnClickListener(this);
    QWalletTools.a(this.jdField_c_of_type_AndroidWidgetImageView, 0.3F);
    this.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(R.id.B));
    a(this.jdField_d_of_type_AndroidWidgetImageView);
    this.jdField_a_of_type_AndroidViewView = paramView.findViewById(R.id.bM);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(R.id.m));
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(R.id.n));
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
    QWalletTools.a(this.jdField_a_of_type_AndroidWidgetButton, 0.3F);
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(R.id.bO));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(R.id.bG));
    this.h = ((ImageView)paramView.findViewById(R.id.ao));
    Drawable localDrawable = getResources().getDrawable(R.drawable.q);
    this.h.setBackgroundDrawable(localDrawable);
    ((Animatable)localDrawable).start();
    this.jdField_g_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(R.id.al));
    this.jdField_g_of_type_AndroidWidgetImageView.setOnClickListener(this);
    this.jdField_g_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(R.id.aW));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(R.id.o));
    this.jdField_b_of_type_AndroidWidgetImageView.setOnClickListener(this);
    LottieComposition.Factory.fromJsonString(b(), new DrawRedpacketPannelPreviewFragment.6(this));
    this.jdField_a_of_type_ComTencentMobileqqQwalletHbGrapDrawImplDoodleLayout = ((DoodleLayout)paramView.findViewById(R.id.A));
    this.jdField_a_of_type_ComTencentMobileqqQwalletHbGrapDrawImplDoodleLayout.setColor(Color.parseColor(str));
    this.jdField_a_of_type_ComTencentMobileqqQwalletHbGrapDrawImplDoodleLayout.setDoodleLayoutListener(new DrawRedpacketPannelPreviewFragment.7(this));
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = new QQCustomDialog(getQBaseActivity(), R.style.b);
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setContentView(R.layout.jdField_a_of_type_Int);
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setTitle(HardCodeUtil.a(R.string.az));
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setMessage(HardCodeUtil.a(R.string.au));
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setNegativeButton(HardCodeUtil.a(R.string.ax), new DrawRedpacketPannelPreviewFragment.8(this));
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setPositiveButton(HardCodeUtil.a(R.string.aA), new DrawRedpacketPannelPreviewFragment.9(this));
    this.i = ((ImageView)paramView.findViewById(R.id.i));
    this.i.setOnClickListener(this);
  }
  
  public void a(boolean paramBoolean, View paramView1, View paramView2, float paramFloat1, float paramFloat2)
  {
    float f1 = this.jdField_b_of_type_AndroidWidgetRelativeLayout.getWidth() / 2.0F;
    float f2 = this.jdField_b_of_type_AndroidWidgetRelativeLayout.getHeight() / 2.0F;
    ...
    this.jdField_b_of_type_AndroidWidgetRelativeLayout.startAnimation(localAnimation);
  }
  ...
  protected boolean a()
  {
    ...
    this.jdField_e_of_type_AndroidViewView.setBackgroundDrawable(getResources().getDrawable(R.drawable.j));
    ...
    localObject1 = QWalletTools.a(getQBaseActivity(), (String)localObject1, 135.0F, this.jdField_d_of_type_AndroidWidgetTextView.getPaint());
    Object localObject2 = this.jdField_d_of_type_AndroidWidgetTextView;
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append((String)localObject1);
    localStringBuilder.append(HardCodeUtil.a(R.string.av));
    ((TextView)localObject2).setText(localStringBuilder.toString());
    localObject1 = this.jdField_g_of_type_AndroidWidgetTextView;
    localObject2 = new StringBuilder();
  ...
  public void onActivityCreated(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setOnLongClickListener(new DrawRedpacketPannelPreviewFragment.3(this));
  }
  ...
  public void onClick(View paramView)
  {
    ...
    if (j == R.id.m)
    {
      paramView = this.jdField_a_of_type_ComTencentMobileqqQwalletHbGrapDrawImplDoodleLayout;
      if (paramView != null)
      {
        if (paramView.a(false, false) == 0) {
          return;
        }
        this.jdField_a_of_type_ComTencentMobileqqQwalletHbGrapDrawImplDoodleLayout.a();
        e();
      }
      this.jdField_a_of_type_Boolean = false;
      this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(Color.parseColor("#878B99"));
      this.jdField_b_of_type_AndroidWidgetTextView.setText(HardCodeUtil.a(R.string.as));
      b();
    ...
    if (j == R.id.J)
    {
      ...
      if (!((IQWalletHbApi)QRoute.api(IQWalletHbApi.class)).isValideToDoAction(jdField_a_of_type_Long, l)) {
        return;
      }
      ...
      if (!((IQWalletPreferenceApi)QRoute.api(IQWalletPreferenceApi.class)).getBoolean(getQBaseActivity().getAppRuntime().getCurrentAccountUin(), "", false))
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqQwalletHbGrapDrawImplDoodleLayout.setVisibility(8);
        this.jdField_g_of_type_AndroidWidgetImageView.setVisibility(0);
        LottieComposition.Factory.fromJsonString(a(), new DrawRedpacketPannelPreviewFragment.10(this));
      }
      else
      {
        this.jdField_g_of_type_AndroidWidgetImageView.setVisibility(8);
        this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
        this.jdField_a_of_type_ComTencentMobileqqQwalletHbGrapDrawImplDoodleLayout.setVisibility(0);
      }
