  ...
  extends DownloadListener
{
  ...
  public void onDoneFile(DownloadTask paramDownloadTask)
  {
    ...
    if (QLog.isColorLevel())
    {
      ...
      localStringBuilder.append(this.jdField_a_of_type_ComTencentMobileqqQwalletPreloadImplPreloadResourceImpl.mResId);
  ...
  public void onProgress(DownloadTask paramDownloadTask)
  {
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        paramDownloadTask.append(this.jdField_a_of_type_ComTencentMobileqqQwalletPreloadImplPreloadResourceImpl.mResId);
