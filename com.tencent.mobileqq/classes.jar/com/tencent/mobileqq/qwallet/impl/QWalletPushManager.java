...
{
  private static ArrayList<IQWalletPayApi.PCPayData> a = new ArrayList();
  private static HashMap<String, Integer> b = new HashMap(16);
  private static long c;
  private static long d;
  private static final long[] e = { 100L, 200L, 200L, 100L };
  ...
  public static int a()
  {
    ...
    {
      localObject = (IQWalletPayApi.PCPayData)a.get(i);
      k = j;
      if (localObject != null)
      {
        k = j;
        if (((IQWalletPayApi.PCPayData)localObject).h == 0) {
          k = j + 1;
        }
      }
      i += 1;
  ...
  public static IQWalletPayApi.PCPayData a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      {
        localObject = (IQWalletPayApi.PCPayData)a.get(i);
        if ((localObject != null) && (((IQWalletPayApi.PCPayData)localObject).h == 0)) {
          return localObject;
        }
        i -= 1;
      }
  ...
  {
    if ((paramBaseQQAppInterface != null) && (a != null) && (paramPCPayData != null) && (paramPCPayData.c >= 1) && (paramPCPayData.c <= 7) && (!TextUtils.isEmpty(paramPCPayData.d)))
    {
      if (paramPCPayData.c == 1) {
        d = VACDReportUtil.a(null, "qqwallet", "pay-pcpush", "payinvoke", null, 0, null);
      }
      synchronized (a)
      {
        a.add(paramPCPayData);
        if (d(paramBaseQQAppInterface))
        {
          if (d != 0L) {
            VACDReportUtil.a(d, null, "startForegroundPay", null, 0, null);
          }
        ...
        {
          if (d != 0L) {
            VACDReportUtil.a(d, null, "startBackgroundPay", null, 0, null);
          }
        ...
        if (paramInt1 != 1)
        {
            ...
            if (paramInt1 != 4) {
              ...
              else
              {
                try
                {
                  ...
                  paramArrayOfByte.f = System.currentTimeMillis();
                  localObject = new JSONObject((String)localObject);
                  paramArrayOfByte.a = ((JSONObject)localObject).optLong("tradeTime", 0L);
                  paramArrayOfByte.b = ((JSONObject)localObject).optInt("expTime", 0);
                  paramArrayOfByte.c = ((JSONObject)localObject).optInt("payType", 0);
                  paramArrayOfByte.e = ((JSONObject)localObject).optString("notifyText");
                  ...
                  paramArrayOfByte.d = localJSONObject1.toString();
          ...
          try
          {
            ...
            if (!TextUtils.isEmpty((CharSequence)localObject))
            {
              ...
              if (localObject != null) {
                paramArrayOfByte.d = ((JSONObject)localObject).toString();
              }
              a(paramBaseQQAppInterface, paramArrayOfByte);
              return;
            }
  ...
  protected static boolean a(long paramLong1, int paramInt1, long paramLong2, int paramInt2)
  {
    ...
    synchronized (b)
    {
      if (Math.abs(paramLong1 - c) > 1800000L) {
        b.clear();
  ...
  public static void b()
  {
    ...
    {
      localObject = (IQWalletPayApi.PCPayData)a.get(i);
      if ((localObject == null) || (((IQWalletPayApi.PCPayData)localObject).h == 1)) {
        a.remove(i);
      }
      i -= 1;
    }
  ...
  private static void b(BaseQQAppInterface paramBaseQQAppInterface, IQWalletPayApi.PCPayData paramPCPayData)
  {
    if (((IQWalletTemp)QRoute.api(IQWalletTemp.class)).QQUtils$isScreenLocked(paramBaseQQAppInterface.getApp()))
    {
      ...
      String str2 = String.format(BaseApplication.getContext().getString(R.string.dq), new Object[] { Integer.valueOf(a()) });
      String str1;
      if (!TextUtils.isEmpty(paramPCPayData.e)) {
        str1 = paramPCPayData.e;
      } else {
        str1 = BaseApplication.getContext().getString(R.string.dp);
      }
      ...
      localIntent.putExtra("time", TimeFormatterUtils.c(BaseApplication.getContext(), paramPCPayData.f));
    ...
    if ((bool5) && (!bool2) && (!bool1) && (!bool3) && (!bool4))
    {
      ...
      if (bool2)
      {
        ...
        if (paramBaseQQAppInterface != null) {
          paramBaseQQAppInterface.vibrate(e, -1);
        }
      }
      if (bool1)
      {
  ...
  public static void b(BaseQQAppInterface paramBaseQQAppInterface, byte[] paramArrayOfByte, long paramLong1, int paramInt1, long paramLong2, int paramInt2)
  {
    ...
    //   0: aload_1
    //   1: ifnonnull +19 -> 20
    //   4: invokestatic 107	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   7: ifeq +12 -> 19
    //   10: ldc 125
    //   12: iconst_2
    //   13: ldc_w 616
    //   16: invokestatic 132	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   19: return
    //   20: lload_2
    //   21: iload 4
    //   23: lload 5
    //   25: iload 7
    //   27: invokestatic 273	com/tencent/mobileqq/qwallet/impl/QWalletPushManager:a	(JIJI)Z
    //   30: ifeq +19 -> 49
    //   33: invokestatic 107	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   36: ifeq +12 -> 48
    //   39: ldc 125
    //   41: iconst_2
    //   42: ldc_w 618
    //   45: invokestatic 132	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   48: return
    //   49: ldc_w 275
    //   52: invokestatic 281	com/tencent/mobileqq/qroute/QRoute:api	(Ljava/lang/Class;)Lcom/tencent/mobileqq/qroute/QRouteApi;
    //   55: checkcast 275	com/qwallet/temp/IQWalletPBTemp
    //   58: aload_1
    //   59: invokeinterface 622 2 0
    //   64: astore 13
    //   66: aload 13
    //   68: ifnull +752 -> 820
    //   71: aload 13
    //   73: getfield 626	com/tencent/mobileqq/data/QWalletSubmsgtype0x7e$MsgBody$OnlinePush:action	I
    //   76: istore 7
    //   78: aload 13
    //   80: getfield 629	com/tencent/mobileqq/data/QWalletSubmsgtype0x7e$MsgBody$OnlinePush:timestamp	I
    //   83: istore 8
    //   85: aload 13
    //   87: getfield 632	com/tencent/mobileqq/data/QWalletSubmsgtype0x7e$MsgBody$OnlinePush:extend	Ljava/lang/String;
    //   90: astore_1
    //   91: aload 13
    //   93: getfield 635	com/tencent/mobileqq/data/QWalletSubmsgtype0x7e$MsgBody$OnlinePush:serialno	Ljava/lang/String;
    //   96: astore 10
    //   98: aload 13
    //   100: getfield 638	com/tencent/mobileqq/data/QWalletSubmsgtype0x7e$MsgBody$OnlinePush:billno	Ljava/lang/String;
    //   103: astore 11
    //   105: aload 13
    //   107: getfield 641	com/tencent/mobileqq/data/QWalletSubmsgtype0x7e$MsgBody$OnlinePush:appinfo	Ljava/lang/String;
    //   110: astore 12
    //   112: aload 13
    //   114: getfield 644	com/tencent/mobileqq/data/QWalletSubmsgtype0x7e$MsgBody$OnlinePush:amount	I
    //   117: istore 9
    //   119: aload 13
    //   121: getfield 647	com/tencent/mobileqq/data/QWalletSubmsgtype0x7e$MsgBody$OnlinePush:jumpurl	Ljava/lang/String;
    //   124: astore 13
    //   126: new 139	org/json/JSONObject
    //   129: dup
    //   130: invokespecial 361	org/json/JSONObject:<init>	()V
    //   133: astore 14
    //   135: new 139	org/json/JSONObject
    //   138: dup
    //   139: invokespecial 361	org/json/JSONObject:<init>	()V
    //   142: astore 15
    //   144: new 139	org/json/JSONObject
    //   147: dup
    //   148: aload_1
    //   149: invokespecial 142	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   152: astore 16
    //   154: aload 15
    //   156: ldc 150
    //   158: iload 7
    ...
    //   177: ldc_w 650
    //   180: aload_0
    //   181: invokevirtual 191	com/tencent/common/app/business/BaseQQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    ...
    //   232: dup
    //   233: invokespecial 110	java/lang/StringBuilder:<init>	()V
    //   236: astore 16
    //   238: aload 16
    //   240: ldc_w 656
    ...
    //   247: aload 16
    //   249: aload 14
    //   251: invokevirtual 119	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   254: pop
    //   255: ldc 125
    //   257: iconst_2
    //   258: aload 16
    //   260: invokevirtual 129	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   263: invokestatic 132	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   266: goto +31 -> 297
    //   269: astore 16
    //   271: invokestatic 659	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   274: ifeq +8 -> 282
    //   277: aload 16
    //   279: invokevirtual 295	java/lang/Exception:printStackTrace	()V
    //   282: invokestatic 107	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   285: ifeq +12 -> 297
    //   288: ldc 125
    //   290: iconst_2
    //   291: ldc_w 661
    //   294: invokestatic 132	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   297: aload_0
    //   298: invokevirtual 156	com/tencent/common/app/business/BaseQQAppInterface:getApp	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   301: astore 16
    //   303: getstatic 161	android/os/Build$VERSION:SDK_INT	I
    //   306: istore 4
    //   308: iload 4
    //   310: bipush 10
    //   312: if_icmple +9 -> 321
    ...
    //   326: ldc 163
    //   328: iload 4
    //   330: invokevirtual 169	com/tencent/qphone/base/util/BaseApplication:getSharedPreferences	(Ljava/lang/String;I)Landroid/content/SharedPreferences;
    //   333: astore 16
    //   335: aload 16
    //   337: ifnull +484 -> 821
    //   340: aload_0
    //   341: invokevirtual 191	com/tencent/common/app/business/BaseQQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   344: astore_0
    //   345: new 109	java/lang/StringBuilder
    //   348: dup
    //   349: invokespecial 110	java/lang/StringBuilder:<init>	()V
    //   352: astore 17
    //   354: aload 17
    //   356: ldc_w 663
    //   359: invokevirtual 116	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   362: pop
    //   363: aload 17
    //   365: aload_0
    //   366: invokevirtual 116	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   369: pop
    //   370: aload 16
    //   372: aload 17
    //   374: invokevirtual 129	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   377: lconst_0
    //   378: invokeinterface 666 4 0
    //   383: lstore_2
    //   384: invokestatic 671	com/tencent/mobileqq/msf/core/NetConnInfoCenter:getServerTimeMillis	()J
    //   387: ldc2_w 672
    //   390: ldiv
    //   391: lstore 5
    //   393: lload 5
    ...
    //   397: ifge +54 -> 451
    //   400: aload 16
    //   402: invokeinterface 175 1 0
    //   407: astore 15
    //   409: new 109	java/lang/StringBuilder
    //   412: dup
    //   413: invokespecial 110	java/lang/StringBuilder:<init>	()V
    //   416: astore 16
    //   418: aload 16
    //   420: ldc_w 663
    //   423: invokevirtual 116	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   426: pop
    //   427: aload 16
    //   429: aload_0
    //   430: invokevirtual 116	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   433: pop
    //   434: aload 15
    //   436: aload 16
    //   438: invokevirtual 129	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   441: lconst_0
    //   442: invokeinterface 677 4 0
    //   447: pop
    //   448: goto +101 -> 549
    //   451: lload 5
    //   453: lload_2
    ...
    //   458: lcmp
    //   459: ifge +90 -> 549
    //   462: new 139	org/json/JSONObject
    //   465: dup
    ...
    //   508: goto +16 -> 524
    //   511: astore 15
    //   513: invokestatic 659	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   516: ifeq +8 -> 524
    //   519: aload 15
    //   521: invokevirtual 295	java/lang/Exception:printStackTrace	()V
    //   524: ldc_w 434
    //   527: invokestatic 281	com/tencent/mobileqq/qroute/QRoute:api	(Ljava/lang/Class;)Lcom/tencent/mobileqq/qroute/QRouteApi;
    //   530: checkcast 434	com/qwallet/temp/IQWalletTemp
    //   533: iconst_4
    //   534: ldc_w 689
    //   537: aload_0
    //   538: invokevirtual 391	org/json/JSONObject:toString	()Ljava/lang/String;
    //   541: invokeinterface 693 4 0
    //   546: goto +3 -> 549
    //   549: new 695	android/os/Bundle
    //   552: dup
    //   553: invokespecial 696	android/os/Bundle:<init>	()V
    //   556: astore_0
    //   557: aload_0
    //   558: ldc_w 698
    //   561: aload 14
    //   563: invokevirtual 391	org/json/JSONObject:toString	()Ljava/lang/String;
    //   566: invokevirtual 702	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   569: aload_0
    //   570: ldc_w 704
    //   573: ldc_w 706
    //   576: invokevirtual 702	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   579: new 487	android/content/Intent
    //   582: dup
    ...
    //   586: ldc_w 708
    //   589: invokespecial 492	android/content/Intent:<init>	(Landroid/content/Context;Ljava/lang/Class;)V
    //   592: astore 15
    //   594: aload 15
    //   596: ldc_w 498
    //   599: invokevirtual 497	android/content/Intent:addFlags	(I)Landroid/content/Intent;
    //   602: pop
    //   603: aload 15
    //   605: aload_0
    //   606: invokevirtual 712	android/content/Intent:putExtras	(Landroid/os/Bundle;)Landroid/content/Intent;
    //   609: pop
    //   610: aload 15
    //   612: ldc_w 714
    //   615: iconst_5
    //   616: invokevirtual 717	android/content/Intent:putExtra	(Ljava/lang/String;I)Landroid/content/Intent;
    //   619: pop
    ...
    //   623: aload 15
    //   625: invokevirtual 519	com/tencent/qphone/base/util/BaseApplication:startActivity	(Landroid/content/Intent;)V
    //   628: invokestatic 659	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   631: ifeq +189 -> 820
    //   634: new 109	java/lang/StringBuilder
    //   637: dup
    //   638: invokespecial 110	java/lang/StringBuilder:<init>	()V
    //   641: astore_0
    //   642: aload_0
    //   643: ldc_w 719
    //   646: invokevirtual 116	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   649: pop
    //   650: aload_0
    //   651: iload 7
    //   653: invokevirtual 302	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   656: pop
    //   657: aload_0
    //   658: ldc_w 721
    ...
    //   665: aload_0
    //   666: iload 8
    //   668: invokevirtual 302	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   671: pop
    //   672: aload_0
    //   673: ldc_w 723
    //   676: invokevirtual 116	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   679: pop
    //   680: aload_0
    //   681: aload_1
    //   682: invokevirtual 116	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   685: pop
    //   686: aload_0
    //   687: ldc_w 725
    //   690: invokevirtual 116	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   693: pop
    //   694: aload_0
    //   695: aload 10
    //   697: invokevirtual 116	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   700: pop
    //   701: aload_0
    //   702: ldc_w 727
    //   705: invokevirtual 116	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   708: pop
    //   709: aload_0
    //   710: aload 11
    ...
    //   716: aload_0
    //   717: ldc_w 729
    //   720: invokevirtual 116	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   723: pop
    //   724: aload_0
    //   725: aload 12
    ...
    //   731: aload_0
    //   732: ldc_w 731
    //   735: invokevirtual 116	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   738: pop
    //   739: aload_0
    //   740: iload 9
    //   742: invokevirtual 302	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   745: pop
    //   746: aload_0
    //   747: ldc_w 733
    //   750: invokevirtual 116	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   753: pop
    //   754: aload_0
    //   755: aload 13
    ...
    //   775: invokevirtual 116	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   778: pop
    //   779: aload_0
    //   780: invokevirtual 129	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   783: astore_0
    //   784: ldc 125
    //   786: iconst_4
    //   787: aload_0
    //   788: invokestatic 738	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   791: return
    //   792: astore_0
    //   793: goto +8 -> 801
    //   796: astore_0
    ...
    //   800: astore_0
    //   801: aload_0
    //   802: invokevirtual 295	java/lang/Exception:printStackTrace	()V
    //   805: invokestatic 107	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   808: ifeq +12 -> 820
    //   811: ldc 125
    //   813: iconst_2
    //   814: ldc_w 661
    //   817: invokestatic 132	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   820: return
    //   821: goto -272 -> 549
  ...
  private static void c(BaseQQAppInterface paramBaseQQAppInterface)
  {
    if (paramBaseQQAppInterface != null)
    {
      if (a == null) {
      ...
      if (localObject == null)
      {
        if (a.size() > 0)
        {
          localObject = (IQWalletPayApi.PCPayData)a.get(0);
          if (localObject == null)
          {
            a.remove(0);
            c(paramBaseQQAppInterface);
          ...
          int i = a(((IQWalletPayApi.PCPayData)localObject).c);
          if (i == 0)
          {
            a.remove(0);
            c(paramBaseQQAppInterface);
          ...
          ((IQWalletPayApi.PCPayData)localObject).h = 1;
          try
          {
            ...
            paramBaseQQAppInterface.putExtra("json", ((IQWalletPayApi.PCPayData)localObject).d);
            ...
            paramBaseQQAppInterface.putExtra("vacreport_key_seq", d);
            BaseApplication.getContext().startActivity(paramBaseQQAppInterface);
            return;
          }
          catch (Exception paramBaseQQAppInterface)
          {
            ((IQWalletPayApi.PCPayData)localObject).h = 2;
            if (!QLog.isColorLevel()) {
              return;
            }
          }
      ...
      else
      {
        ...
        if (bool1)
        {
          ...
          if (((IQWalletPayApi.PCPayData)localObject).g + 43200000L > l) {
            bool1 = bool2;
          }
        }
        if (!bool1)
  ...
  private static void c(BaseQQAppInterface paramBaseQQAppInterface, IQWalletPayApi.PCPayData paramPCPayData)
  {
    ...
    if ((paramBaseQQAppInterface != null) && (paramBaseQQAppInterface.getApp() != null))
    {
      ...
      String str = String.format(BaseApplication.getContext().getString(R.string.dq), new Object[] { Integer.valueOf(a()) });
      Object localObject = paramPCPayData.e;
      paramPCPayData = (IQWalletPayApi.PCPayData)localObject;
      if (TextUtils.isEmpty((CharSequence)localObject)) {
        paramPCPayData = BaseApplication.getContext().getString(R.string.dp);
      }
      ...
      ((Bundle)localObject).putLong("vacreport_key_seq", d);
  ...
  private static IQWalletPayApi.PCPayData d()
  {
    if (a == null) {
      return null;
    }
    ...
    while (i < a.size())
    {
      IQWalletPayApi.PCPayData localPCPayData = (IQWalletPayApi.PCPayData)a.get(i);
      if ((localPCPayData != null) && (localPCPayData.h == 1)) {
  ...
  private static boolean d(BaseQQAppInterface paramBaseQQAppInterface)
  {
