...
class PtvTemplateManager$12
  implements Runnable
{
  PtvTemplateManager$12(PtvTemplateManager paramPtvTemplateManager, File paramFile, boolean paramBoolean1, bbpx parambbpx, boolean paramBoolean2) {}
  ...
  public void run()
  {
    ...
    synchronized (this.this$0.jdField_d_of_type_JavaLangObject)
    {
      ...
      if (this.jdField_a_of_type_Bbpx != null) {
        this.jdField_a_of_type_Bbpx.a();
      }
      if ((this.b) && (bbxj.a())) {
        this.this$0.b();
      }
