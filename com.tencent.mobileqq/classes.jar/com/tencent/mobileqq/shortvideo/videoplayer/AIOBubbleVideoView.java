...
public class AIOBubbleVideoView
  extends QQliveVideoView
  implements acjt
{
  private static volatile awnb jdField_a_of_type_Awnb;
  ...
  public AIOBubbleVideoView(Context paramContext, long paramLong, boolean paramBoolean)
  {
  ...
  public static void setOnVideoPreparedListener(awnb paramawnb)
  {
    jdField_a_of_type_Awnb = paramawnb;
  }
  ...
  {
    awnb localawnb = jdField_a_of_type_Awnb;
    if ((localawnb != null) && (localawnb.a(this, paramTVK_IMediaPlayer)))
    {
 ...
 * Qualified Name:     com.tencent.mobileqq.shortvideo.videoplayer.AIOBubbleVideoView
