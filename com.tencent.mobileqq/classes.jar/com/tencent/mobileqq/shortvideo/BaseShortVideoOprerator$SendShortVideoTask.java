    ...
    for (;;)
    {
      ...
      while (localObject != null)
      {
        ...
        if ((((MessageRecord)localObject).istroop == 0) || (((MessageRecord)localObject).istroop == 1008))
        {
          ...
          localTransferRequest.mLocalPath = (localShortVideoUploadInfo.h + "QQ_&_MoblieQQ_&_QQ" + localShortVideoUploadInfo.j + "QQ_&_MoblieQQ_&_QQ" + localShortVideoUploadInfo.f + "QQ_&_MoblieQQ_&_QQ" + localShortVideoUploadInfo.jdField_g_of_type_JavaLangString);
          ...
          if ((!localShortVideoUploadInfo.jdField_e_of_type_Boolean) && (!localShortVideoUploadInfo.jdField_g_of_type_Boolean))
          {
            if (localShortVideoUploadInfo.b) {
              break label473;
            }
        ...
        for (;;)
        {
          Logger.a(this.this$0.jdField_g_of_type_JavaLangString, this.this$0.f, "doSendShortVideo", "cost:" + (System.currentTimeMillis() - l));
          Logger.a(this.this$0.jdField_g_of_type_JavaLangString, this.this$0.f, "doSendShortVideo.start", "TransferRequest: " + localTransferRequest.toString());
          return;
