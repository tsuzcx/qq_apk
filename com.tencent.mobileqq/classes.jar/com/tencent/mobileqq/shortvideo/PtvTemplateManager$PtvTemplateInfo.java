...
public class PtvTemplateManager$PtvTemplateInfo
{
  ...
  public static List<PtvTemplateInfo> convertFrom(JSONArray paramJSONArray)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        PtvTemplateInfo localPtvTemplateInfo = (PtvTemplateInfo)bghp.a(paramJSONArray.getJSONObject(i), PtvTemplateInfo.class);
  ...
  public void doDownloadDataReport()
  {
    ...
    bctj.a(VideoEnvironment.a()).a(null, "sv_filter_download_time", true, 0L, 0L, localHashMap, "");
  }
