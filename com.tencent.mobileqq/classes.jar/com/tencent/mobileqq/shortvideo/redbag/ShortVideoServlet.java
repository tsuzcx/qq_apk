...
public class ShortVideoServlet
  extends MSFServlet
{
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
          ...
          try
          {
            if (paramFromServiceMsg.isSuccess())
            {
              ...
              if (i == 0)
              {
                ...
                ((ShortVideoHandler)((QQAppInterface)paramIntent).getBusinessHandler(BusinessHandlerFactory.SHORT_VIDEO_HANDLER)).notifyUI(1, true, new Object[] { Integer.valueOf(i) });
                return;
              }
            }
          }
    ...
    for (;;)
    {
      ...
      continue;
      DanceGameVideoManager.a().a(paramFromServiceMsg, arrayOfByte);
      return;
      DanceGameVideoManager.a().b(paramFromServiceMsg, arrayOfByte);
      return;
      label462:
      if (paramIntent == null) {
        paramIntent = "no pkg";
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    do
    {
      ...
      case 1: 
        ...
        return;
      case 2: 
        DanceGameVideoManager.a().a(paramPacket, str);
        return;
      }
      i = paramIntent.getIntExtra("key_dance_score", 0);
    } while (i <= 0);
    DanceGameVideoManager.a().a(paramPacket, str, i);
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes10.jar
 * Qualified Name:     com.tencent.mobileqq.shortvideo.redbag.ShortVideoServlet
