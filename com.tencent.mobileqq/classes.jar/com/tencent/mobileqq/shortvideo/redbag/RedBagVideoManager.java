  ...
  implements Manager
{
  ...
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new ahot(this);
  ...
  private CustomFrameAnimationDrawable a(String paramString)
  {
    ...
    //   24: invokespecial 175	java/io/File:<init>	(Ljava/lang/String;)V
    //   27: astore_1
    //   28: aload_1
    //   29: invokevirtual 179	java/io/File:exists	()Z
    //   32: ifeq +220 -> 252
    //   35: aload_1
    //   36: invokevirtual 183	java/io/File:listFiles	()[Ljava/io/File;
    //   39: astore_1
    //   40: new 185	java/util/ArrayList
    //   43: dup
    //   44: invokespecial 186	java/util/ArrayList:<init>	()V
    //   47: astore 4
    //   49: aload_1
    //   50: ifnull +202 -> 252
    //   53: aload_1
    ...
    //   78: aload 4
    //   80: aload 5
    //   82: invokeinterface 192 2 0
    //   87: pop
    //   88: goto +166 -> 254
    //   91: aload 4
    //   93: invokeinterface 195 1 0
    //   98: iconst_1
    //   99: if_icmple +129 -> 228
    //   102: aload 4
    //   104: invokestatic 201	java/util/Collections:sort	(Ljava/util/List;)V
    //   107: new 203	android/graphics/BitmapFactory$Options
    //   110: dup
    //   111: invokespecial 204	android/graphics/BitmapFactory$Options:<init>	()V
    //   114: astore_1
    //   115: aload_1
    //   116: iconst_1
    //   117: putfield 207	android/graphics/BitmapFactory$Options:inSampleSize	I
    //   120: aload_1
    //   121: iconst_1
    //   122: putfield 210	android/graphics/BitmapFactory$Options:inMutable	Z
    //   125: aload 4
    //   127: ifnull +125 -> 252
    //   130: aload 4
    //   132: invokeinterface 195 1 0
    //   137: ifle +115 -> 252
    //   140: aload 4
    //   142: iconst_0
    //   143: invokeinterface 214 2 0
    //   148: checkcast 48	java/io/File
    //   151: invokevirtual 217	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   154: aload_1
    //   155: invokestatic 222	com/tencent/mobileqq/utils/ImageUtil:a	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   158: astore_1
    //   159: new 140	com/tencent/mobileqq/activity/aio/item/CustomFrameAnimationDrawable
    //   162: dup
    //   163: invokestatic 225	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   166: invokevirtual 226	com/tencent/qphone/base/util/BaseApplication:getResources	()Landroid/content/res/Resources;
    //   169: aload_1
    //   170: aload_0
    //   171: getfield 228	com/tencent/mobileqq/shortvideo/redbag/RedBagVideoManager:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   174: invokespecial 231	com/tencent/mobileqq/activity/aio/item/CustomFrameAnimationDrawable:<init>	(Landroid/content/res/Resources;Landroid/graphics/Bitmap;Lmqq/os/MqqHandler;)V
    //   177: astore_1
    //   178: iconst_0
    //   179: istore_2
    //   180: iload_2
    //   181: aload 4
    //   183: invokeinterface 195 1 0
    ...
    //   211: bipush 40
    //   213: aload 5
    //   215: invokevirtual 217	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   218: invokevirtual 234	com/tencent/mobileqq/activity/aio/item/CustomFrameAnimationDrawable:a	(IILjava/lang/String;)V
    //   221: iload_2
    //   222: iconst_1
    //   223: iadd
    //   224: istore_2
    //   225: goto -45 -> 180
    //   228: invokestatic 236	com/tencent/mobileqq/shortvideo/redbag/RedBagVideoManager:c	()V
    //   231: goto -124 -> 107
    //   234: astore 4
    //   236: aconst_null
    //   237: astore_1
    //   238: aload 4
    //   240: invokevirtual 239	java/lang/Exception:printStackTrace	()V
    //   243: aload_1
    //   244: areturn
    //   245: astore 4
    //   247: goto -9 -> 238
  ...
  public static void a(View paramView, ShortVideoRealItemBuilder.Holder paramHolder, ChatMessage paramChatMessage, Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (j != 0)
        {
          if (paramView.findViewById(2131362282) != null)
          {
            paramView.findViewById(2131362283).setVisibility(0);
            paramHolder = (ImageView)paramView.findViewById(2131362282);
            if (j == 1) {
              paramHolder.setImageResource(2130845437);
            }
            for (;;)
            {
              paramHolder.setVisibility(0);
              paramView = (RelativeLayout.LayoutParams)((ImageView)paramView.findViewById(2131362283)).getLayoutParams();
              if (!paramChatMessage.isSend()) {
                break label213;
              }
              ...
              break;
              if (j == 2) {
                paramHolder.setImageResource(2130845438);
              } else if (j == 3) {
                paramHolder.setImageResource(2130845436);
              }
            }
          ...
          paramHolder.setBackgroundDrawable(paramContext.getResources().getDrawable(2130845435));
          ...
          for (;;)
          {
            ...
            paramChatMessage.addRule(8, 2131366616);
        ...
        paramView.findViewById(2131362282).setVisibility(4);
        paramView.findViewById(2131362283).setVisibility(4);
        return;
        j = 0;
      }
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    ThreadManager.post(new ahoz(paramQQAppInterface), 5, null, true);
  }
  ...
  private void b(AIOShortVideoData paramAIOShortVideoData)
  {
    ...
    if (paramAIOShortVideoData.g == 0)
    {
      ...
      new ahpi(this).execute(new String[] { paramAIOShortVideoData.jdField_c_of_type_JavaLangString });
    }
    for (;;)
    {
  ...
  private static boolean b(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    if (SharedPreUtils.f(paramQQAppInterface.getApp()))
    {
      if (QLog.isColorLevel()) {
  ...
  public static void c()
  {
    try
    {
      if (!jdField_a_of_type_Boolean) {
        SharedPreUtils.f(BaseApplication.getContext(), true);
      }
      return;
    }
    finally {}
  ...
  private void c(AIOShortVideoData paramAIOShortVideoData)
  {
    ...
    {
      this.jdField_c_of_type_AndroidWidgetImageView.setBackgroundResource(2130845439);
    ...
    if (paramAIOShortVideoData.g == 0)
    {
      ...
      {
        this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130845449);
        this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      }
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidOsHandler.postDelayed(new ahpf(this), 120L);
      break;
      label207:
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130845450);
      c();
    }
  }
  ...
  private void d()
  {
    ...
    do
    {
      for (;;)
      {
        ...
        if (!"查看详情".trim().equals(localObject)) {
          break;
        }
    ...
    } while (!"赏他红包".trim().equals(localObject));
  ...
  private void g()
  {
    if ((this.jdField_a_of_type_AndroidWidgetTextView != null) && (this.jdField_a_of_type_AndroidAppActivity != null))
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColorStateList(2131494194));
      this.jdField_a_of_type_AndroidWidgetTextView.setTextSize(14.0F);
      this.jdField_a_of_type_AndroidWidgetTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130845440, 0);
  ...
  private void h()
  {
    if ((this.jdField_a_of_type_AndroidWidgetTextView != null) && (this.jdField_a_of_type_AndroidAppActivity != null))
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setText("红包已发");
      this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(0);
  ...
  private void i()
  {
    ...
    if (localCustomFrameAnimationDrawable != null)
    {
      ...
      localCustomFrameAnimationDrawable.c();
      localCustomFrameAnimationDrawable.a(new ahpg(this));
      if (this.jdField_a_of_type_AndroidOsHandler == null) {
        this.jdField_a_of_type_AndroidOsHandler = new Handler();
      }
      this.jdField_a_of_type_AndroidOsHandler.postDelayed(new ahph(this), 880L);
    }
    for (;;)
    {
      if (this.jdField_a_of_type_AndroidOsHandler == null) {
      ...
      this.jdField_a_of_type_AndroidOsHandler.postDelayed(new ahou(this), 1120L);
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      return;
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130845443);
      k();
      c();
    }
  }
  ...
  private void k()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColorStateList(2131494195));
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130845445);
    this.jdField_a_of_type_AndroidWidgetTextView.bringToFront();
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    ObjectAnimator.ofFloat(this.jdField_a_of_type_AndroidWidgetTextView, "alpha", new float[] { 0.0F, 1.0F }).setDuration(180L).start();
  }
  ...
  private void l()
  {
    ...
    if (localCustomFrameAnimationDrawable != null)
    {
      ...
      localCustomFrameAnimationDrawable.c();
      this.jdField_c_of_type_Int = 0;
      localCustomFrameAnimationDrawable.a(new ahov(this, localCustomFrameAnimationDrawable));
      return;
    }
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130845443);
    c();
  ...
  private void n()
  {
    ...
    for (;;)
    {
      ...
      h();
      return;
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130845448);
      c();
    }
  }
  ...
  public ImageView a(Activity paramActivity, ViewGroup paramViewGroup, String paramString)
  {
    ...
    ((TextView)localObject).setId(2131362280);
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new ahpc(this));
    e();
    return paramString;
  }
  ...
  public void a()
  {
    ThreadManager.post(new ahpd(this), 5, null, true);
  }
  ...
  public void a(int paramInt)
  {
    if (paramInt == -1)
    {
      ...
      localCustomFrameAnimationDrawable.c();
      localCustomFrameAnimationDrawable.a(new ahow(this));
    }
    for (;;)
    {
      ThreadManager.post(new ahoy(this), 5, null, true);
      return;
      label131:
      if (this.jdField_a_of_type_AndroidWidgetImageView != null) {
        this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130845448);
  ...
  public void a(Activity paramActivity)
  {
    ...
    if (a())
    {
      ...
      if (bool)
      {
        CameraCaptureActivity.a(paramActivity, QuickShootEffectsCameraCaptureFragment.class.getName(), AIOEffectsCameraCaptureFragment.a(null, 10004, null, 0L, false), 9010);
        if (QLog.isColorLevel()) {
          QLog.d("RedBagVideoManager", 2, "launch CameraCaptureActivity");
        }
    ...
    Intent localIntent = CameraCaptureActivity.a(paramActivity, QuickShootEffectsCameraCaptureFragment.class.getName(), AIOEffectsCameraCaptureFragment.a(null, 10004, null, 0L, false));
    CaptureSoDownloadActivity.a(paramActivity, QuickShootEffectsCameraCaptureFragment.class.getName(), localIntent.getExtras(), 9010);
  ...
  public void a(AIORichMediaData paramAIORichMediaData)
  {
    ...
    do
    {
      ...
      } while ((paramAIORichMediaData.g == 0) || (this.jdField_e_of_type_Boolean));
      n();
      return;
    ...
    if ((paramAIORichMediaData instanceof AIOShortVideoData))
    {
      ...
      if (localAIOShortVideoData.e == LocalMediaInfo.REDBAG_TYPE_GET)
      {
        ...
        for (;;)
        {
          ...
          this.jdField_a_of_type_AndroidOsHandler.postDelayed(new ahpe(this, paramAIORichMediaData), localAIOShortVideoData.a * 1000);
          return;
