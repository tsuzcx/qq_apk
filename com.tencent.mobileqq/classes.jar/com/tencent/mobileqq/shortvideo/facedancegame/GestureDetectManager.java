...
public class GestureDetectManager
{
  ...
  private boolean c()
  {
    ...
    try
    {
      ...
      AVGestureWrapper.setAVGestureReport(new aifv(this));
  ...
  {
    paramArrayOfByte = new Thread(new aifw(this, paramArrayOfByte, paramInt1, paramInt2, paramIGestureDetectCallBack));
