  ...
  extends azbp
{
  ...
  {
    a(paramazcu, new int[] { 1, 2, 3, 4, 5, 6, 7, 8, 9 });
  }
  ...
  void a(byte[] paramArrayOfByte, int paramInt1, long paramLong, boolean paramBoolean, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      if ((paramArrayOfByte != null) && (paramInt1 > 0))
      {
        ...
        azdx.a().a().handleAudio(arrayOfByte, (AVIOStruct)localObject, (int)paramLong);
        paramArrayOfByte = (SVHwEncoder)this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicReference.get();
        if (paramArrayOfByte != null)
        {
          localObject = new azcp();
          ((azcp)localObject).jdField_a_of_type_ArrayOfByte = arrayOfByte;
          ((azcp)localObject).jdField_a_of_type_Int = 0;
          ((azcp)localObject).jdField_b_of_type_Int = arrayOfByte.length;
          ((azcp)localObject).jdField_a_of_type_Long = SystemClock.elapsedRealtime();
          ((azcp)localObject).jdField_a_of_type_Boolean = false;
          ((azcp)localObject).jdField_b_of_type_Boolean = false;
          paramArrayOfByte.a((azcp)localObject, false);
        }
  ...
  void b(byte[] paramArrayOfByte, int paramInt1, long paramLong, boolean paramBoolean, int paramInt2)
  {
    if ((paramArrayOfByte != null) && (paramInt1 > 0) && (paramInt1 <= paramArrayOfByte.length))
    {
      ...
      ((azfm)this.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicReference.get()).a(paramArrayOfByte, 0, paramInt1);
    }
    for (;;)
    {
      a(paramInt2, new Object[] { Integer.valueOf(0) });
  ...
  public boolean b()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          if (azdx.a().a().a(this, 3, "init audio failed")) {
            break label187;
          }
  ...
  public void c()
  {
    ...
    while (!QLog.isColorLevel())
    {
      try
      {
        ...
        {
          a(5, new Object[] { alpo.a(2131701158) });
          return;
        }
      }
      catch (Exception localException)
      {
        ...
        a(5, new Object[] { alpo.a(2131701161) });
        return;
      }
  ...
  public void d()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        a(6, new Object[] { alpo.a(2131701162) });
      }
      catch (Exception localException)
      {
        for (;;)
