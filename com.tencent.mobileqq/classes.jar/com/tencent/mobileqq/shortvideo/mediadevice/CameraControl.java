  ...
  extends Observable
{
      ...
      try
      {
        for (;;)
        {
          ...
          if (VersionUtils.c())
          {
            ...
            AEQLog.b(jdField_b_of_type_JavaLangString, "【Real Old openCamera】:" + this.jdField_a_of_type_Int);
            AEQLog.b(jdField_b_of_type_JavaLangString, "【Real Old openCamera】:currentCount= " + j);
          }
  ...
  public CameraControl.CustomSize a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    CameraControl.CustomSize localCustomSize = new CameraControl.CustomSize();
    Object localObject1 = CameraAbility.a().b();
    ...
    if ((localArrayList.isEmpty()) && (((CameraControl.CustomSize)localObject2).jdField_a_of_type_Int >= paramInt1))
    {
      if (QLog.isColorLevel()) {
        QLog.i(jdField_b_of_type_JavaLangString, 2, "getPictureSize: width=" + ((CameraControl.CustomSize)localObject2).jdField_a_of_type_Int + " height=" + ((CameraControl.CustomSize)localObject2).jdField_b_of_type_Int + " w/h=" + ((CameraControl.CustomSize)localObject2).jdField_a_of_type_Int / ((CameraControl.CustomSize)localObject2).jdField_b_of_type_Int);
      }
      return localObject2;
    }
    if ((localArrayList.isEmpty()) && (((List)localObject1).size() > 0))
    {
      localCustomSize.jdField_a_of_type_Int = ((Camera.Size)((List)localObject1).get(0)).width;
      localCustomSize.jdField_b_of_type_Int = ((Camera.Size)((List)localObject1).get(0)).height;
      return localCustomSize;
    }
    ...
    while (localCustomSize.jdField_a_of_type_Int == 0)
    {
      return null;
      localCustomSize = a(paramInt3, paramInt4, paramInt5, localArrayList);
    }
    return localCustomSize;
  }
  ...
  public CameraControl.CustomSize b(int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean)
  {
    ...
    CameraControl.CustomSize localCustomSize = a((List)localObject, paramInt1, paramInt2, 2600, 1500, (int)f1, 1000);
    if (localCustomSize != null)
    {
      if (QLog.isColorLevel()) {
        QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewSizeGuaranteeOK: DEFAULT resolution os OK.");
    ...
    do
    {
      ...
      localCustomSize = a((List)localObject, paramInt1, paramInt2, 2600, 1500, (int)f1, 700);
      if (localCustomSize == null) {
        break;
      }
      if (QLog.isColorLevel()) {
  ...
  public boolean b()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 351	com/tencent/mobileqq/shortvideo/mediadevice/CameraControl:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   4: ifnonnull +5 -> 9
    //   7: iconst_0
    //   8: ireturn
    //   9: aload_0
    //   10: getfield 529	com/tencent/mobileqq/shortvideo/mediadevice/CameraControl:jdField_a_of_type_Boolean	Z
    //   13: ifne +5 -> 18
    //   16: iconst_1
    //   17: ireturn
    //   18: aload_0
    //   19: iconst_0
    //   20: putfield 529	com/tencent/mobileqq/shortvideo/mediadevice/CameraControl:jdField_a_of_type_Boolean	Z
    //   23: aload_0
    //   24: invokespecial 595	com/tencent/mobileqq/shortvideo/mediadevice/CameraControl:h	()Z
    //   27: istore_1
    //   28: iload_1
    //   29: ifeq +10 -> 39
    //   32: aload_0
    //   33: getfield 351	com/tencent/mobileqq/shortvideo/mediadevice/CameraControl:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   36: invokevirtual 598	android/hardware/Camera:cancelAutoFocus	()V
    //   39: aload_0
    //   40: getfield 351	com/tencent/mobileqq/shortvideo/mediadevice/CameraControl:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   43: invokevirtual 750	android/hardware/Camera:stopPreview	()V
    //   46: aload_0
    //   47: getfield 351	com/tencent/mobileqq/shortvideo/mediadevice/CameraControl:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   50: aconst_null
    //   51: invokevirtual 621	android/hardware/Camera:setPreviewCallback	(Landroid/hardware/Camera$PreviewCallback;)V
    //   54: aload_0
    //   55: getfield 351	com/tencent/mobileqq/shortvideo/mediadevice/CameraControl:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   58: aconst_null
    ...
    for (;;)
    {
      try
      {
        if (this.jdField_a_of_type_Int == 1)
        {
          ...
          bool2 = CameraCompatibleList.b(CameraCompatibleList.f);
          if (bool1) {
            break label405;
          }
          if (!bool2) {
          ...
          if (QLog.isColorLevel()) {
            QLog.i(jdField_b_of_type_JavaLangString, 2, "setDisplayOrientation degrees=" + i + " blackPhone=" + bool1 + " camera=" + FlowCameraConstant.jdField_a_of_type_Int + " rom_black=" + bool2);
          }
          return true;
          i = 0;
          break;
        ...
        boolean bool1 = CameraCompatibleList.d(CameraCompatibleList.g);
        if (bool1)
        {
          i += 180;
          bool2 = false;
