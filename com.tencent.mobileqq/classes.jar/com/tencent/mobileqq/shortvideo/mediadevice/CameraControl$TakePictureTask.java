  ...
  extends AsyncTask<Void, Void, String>
{
  ...
  {
    boolean bool2 = false;
    Object localObject4 = this.jdField_a_of_type_ComTencentMobileqqShortvideoMediadeviceCameraControl$TakePictureData.jdField_a_of_type_ArrayOfByte;
    Object localObject1 = this.jdField_a_of_type_ComTencentMobileqqShortvideoMediadeviceCameraControl$TakePictureData.jdField_a_of_type_JavaIoFile;
    LogTag.a();
    ...
    {
      i = CameraUtils.a(this.jdField_a_of_type_ComTencentMobileqqShortvideoMediadeviceCameraControl.jdField_a_of_type_ComTencentMobileqqCameraCameraHolder, this.jdField_a_of_type_ComTencentMobileqqShortvideoMediadeviceCameraControl.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqShortvideoMediadeviceCameraControl$TakePictureData.jdField_a_of_type_Int);
      if (QLog.isColorLevel()) {
        QLog.i(CameraControl.b, 2, "[onPictureTaken] mirror=" + this.jdField_a_of_type_ComTencentMobileqqShortvideoMediadeviceCameraControl$TakePictureData.jdField_a_of_type_Boolean + " frontFlip=" + this.jdField_a_of_type_ComTencentMobileqqShortvideoMediadeviceCameraControl.jdField_a_of_type_ComTencentMobileqqCameraCameraHolder.a().b() + " jpegRotation=" + i);
      }
    }
    for (;;)
    {
      try
      {
        boolean bool3 = CameraControl.a(this.jdField_a_of_type_ComTencentMobileqqShortvideoMediadeviceCameraControl, this.jdField_a_of_type_ComTencentMobileqqShortvideoMediadeviceCameraControl$TakePictureData.jdField_a_of_type_AndroidHardwareCamera$Size.width, this.jdField_a_of_type_ComTencentMobileqqShortvideoMediadeviceCameraControl$TakePictureData.jdField_a_of_type_AndroidHardwareCamera$Size.height, this.jdField_a_of_type_ComTencentMobileqqShortvideoMediadeviceCameraControl$TakePictureData.jdField_a_of_type_AndroidGraphicsRect.width(), this.jdField_a_of_type_ComTencentMobileqqShortvideoMediadeviceCameraControl$TakePictureData.jdField_a_of_type_AndroidGraphicsRect.height());
        boolean bool1 = bool2;
        if (this.jdField_a_of_type_ComTencentMobileqqShortvideoMediadeviceCameraControl$TakePictureData.jdField_a_of_type_Boolean)
        {
          bool1 = bool2;
        ...
        localObject4 = CameraUtils.b((byte[])localObject4, this.jdField_a_of_type_ComTencentMobileqqShortvideoMediadeviceCameraControl$TakePictureData.jdField_a_of_type_AndroidGraphicsRect, bool1, i);
        NewFlowCameraReporter.a("clip_rotate;");
        ImageUtil.b((Bitmap)localObject4, this.jdField_a_of_type_ComTencentMobileqqShortvideoMediadeviceCameraControl$TakePictureData.c, (File)localObject1);
        NewFlowCameraReporter.a(false, this.jdField_a_of_type_ComTencentMobileqqShortvideoMediadeviceCameraControl$TakePictureData.jdField_a_of_type_AndroidHardwareCamera$Size.width, this.jdField_a_of_type_ComTencentMobileqqShortvideoMediadeviceCameraControl$TakePictureData.jdField_a_of_type_AndroidHardwareCamera$Size.height, this.jdField_a_of_type_ComTencentMobileqqShortvideoMediadeviceCameraControl$TakePictureData.jdField_a_of_type_AndroidGraphicsRect.width(), this.jdField_a_of_type_ComTencentMobileqqShortvideoMediadeviceCameraControl$TakePictureData.jdField_a_of_type_AndroidGraphicsRect.height(), bool3, i, bool1);
        NewFlowCameraReporter.a("save jpg;");
        if (0 == 0) {}
      }
      catch (OutOfMemoryError localOutOfMemoryError)
      {
        QLog.e(CameraControl.b, 2, "[onPictureTaken] createBitmap failed orientation:" + this.jdField_a_of_type_ComTencentMobileqqShortvideoMediadeviceCameraControl$TakePictureData.jdField_a_of_type_Int + ", " + localOutOfMemoryError.getMessage(), localOutOfMemoryError);
        CameraUtils.a(null);
        if (0 == 0) {
          continue;
        }
      ...
      try
      {
        ...
        try
        {
          ...
          GlobalImageCache.a.put(((File)localObject1).getAbsolutePath() + "#short_video_camera_preview_cache", null);
        }
        catch (Exception localException)
        {
          ...
          GlobalImageCache.a.put(localObject2.getAbsolutePath() + "#short_video_camera_preview_cache", null);
          continue;
          CameraUtils.a(null);
          continue;
        }
  ...
  private String b()
  {
    ...
    int i = j;
    switch (this.jdField_a_of_type_ComTencentMobileqqShortvideoMediadeviceCameraControl$TakePictureData.jdField_a_of_type_Int % 360)
    {
    default: 
      i = j;
    }
