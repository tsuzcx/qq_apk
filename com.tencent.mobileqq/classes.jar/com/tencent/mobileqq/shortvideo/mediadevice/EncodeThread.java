  ...
  implements MaxVideoConst, Runnable
{
  ...
  private int a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    try
    {
      ...
      urp.b("take_video", "create_mp4_result", 0, i, new String[0]);
      if (i == 0)
      {
        long l2 = SystemClock.uptimeMillis();
        urp.b("take_video", "create_mp4_time", 0, 0, new String[] { "" + (l2 - l1) });
        sis.a(paramString4, this.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry);
      }
      awje.J = 0;
      awje.C = 23;
      if ((this.jdField_a_of_type_ArrayOfByte != null) && (this.jdField_c_of_type_Int != 0)) {
  ...
  public void run()
  {
    ...
    if (TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString))
    {
      ...
      bghf.a(awha.jdField_a_of_type_Long + "", "qzone_video_record", "9", null);
      label66:
      return;
    }
    ...
    if ((!bace.a(localObject2)) || (!bace.a(localObject1)) || (!bace.a(str1)))
    {
      if (QLog.isColorLevel()) {
    ...
    if (this.f)
    {
      ...
      i = awjg.a(localObject2, localObject1, this.jdField_b_of_type_Int, str1);
      ...
      if ((i == 0) && (this.jdField_c_of_type_Boolean)) {
        bace.a(this.jdField_b_of_type_JavaLangString);
      }
      if (i == 0) {}
      for (i = 0;; i = 5109)
      {
    ...
    try
    {
      ...
      if ((!((File)localObject4).mkdirs()) && (!((File)localObject4).isDirectory()))
      {
        ...
        a(this.jdField_a_of_type_Int, null);
        bghf.a(awha.jdField_a_of_type_Long + "", "qzone_video_record", "10", null);
        return;
      }
    }
    ...
    Object localObject4 = awmp.a(localFile);
    ...
    if (this.jdField_b_of_type_Boolean) {
      localObject4 = new awhr(localObject2, localIOException, this.jdField_b_of_type_JavaLangString);
    }
    for (;;)
    {
      try
      {
        i = ((awhr)localObject4).a();
        if (i == 0)
        {
          this.jdField_a_of_type_JavaLangString = ((awhr)localObject4).a();
          boolean bool = bace.b(this.jdField_a_of_type_JavaLangString);
          if (QLog.isColorLevel()) {
          ...
          bghf.a(awha.jdField_a_of_type_Long + "", "qzone_video_record", "record_hw_success", "0", null);
          if (QLog.isColorLevel()) {
          ...
          if (j == -1)
          {
            ...
            bghf.a(awha.jdField_a_of_type_Long + "", "qzone_video_record", "record_sw_success", "0", null);
          }
          if (QLog.isColorLevel())
          {
          ...
          bghf.a(awha.jdField_a_of_type_Long + "", "qzone_video_record", "record_success", "0", null);
          switch (i)
          {
          default: 
      ...
      catch (NoSuchMethodError localNoSuchMethodError)
      {
        ...
        i = -1;
        continue;
        bghf.a(awha.jdField_a_of_type_Long + "", "qzone_video_record", "record_hw_success", "1", i + "_" + Build.MODEL);
        continue;
        localObject4 = localIOException;
        continue;
        bghf.a(awha.jdField_a_of_type_Long + "", "qzone_video_record", "record_sw_success", "1", i + "_" + Build.MODEL);
        continue;
        bghf.a(awha.jdField_a_of_type_Long + "", "qzone_video_record", "record_success", "1", i + "_" + Build.MODEL);
        continue;
        this.jdField_a_of_type_Int = 0;
