  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      int j = localShortVideoForwardInfo.p;
      Object localObject;
      int i;
      ...
      {
        ForwardOrderManager.a().a(((MessageRecord)localObject).uniseq, l, j);
        ...
        if (i != 0) {
          this.this$0.a((MessageRecord)localObject, localShortVideoForwardInfo.b);
        }
        Logger.a(this.this$0.g, this.this$0.f, "doForwardShortVideo", "cost:" + (System.currentTimeMillis() - l));
        Logger.a(this.this$0.g, this.this$0.f, "doForwardShortVideo.start", "TransferRequest: " + localTransferRequest.toString());
        return;
