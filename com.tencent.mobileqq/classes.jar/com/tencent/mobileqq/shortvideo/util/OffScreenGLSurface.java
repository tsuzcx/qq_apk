  ...
  implements Handler.Callback
{
  ...
  private aiim jdField_a_of_type_Aiim = new aiim(null);
  ...
  {
    this.jdField_a_of_type_Aiim.jdField_a_of_type_Int = paramAVIOStruct.pFrameIndex;
    paramAVIOStruct.pFrameIndex = 0;
    this.jdField_a_of_type_Aiim.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Aiim.jdField_b_of_type_Int = 0;
    GLSurfaceUtil.a("handleMessage:writeVideoFrame[false]  mThumbPicControl.mSendThumbOKIndex=" + this.jdField_a_of_type_Aiim.jdField_a_of_type_Int);
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        this.jdField_a_of_type_Aiim.jdField_b_of_type_Int = 0;
        this.jdField_a_of_type_Aiim.jdField_a_of_type_Boolean = false;
        this.jdField_a_of_type_Aiim.jdField_a_of_type_Int = -1;
        h();
      } while (!QLog.isColorLevel());
    ...
    if (paramMessage.obj != null)
    {
      ...
      if (localTextureDataPipe != null)
      {
        ...
        {
          this.jdField_a_of_type_Aiim.jdField_a_of_type_Boolean = true;
          localObject = localAVIOStruct;
        }
        label713:
        ...
        GLSurfaceUtil.a("handleMessage:writeVideoFrame  mNewSession=" + this.jdField_a_of_type_Aiim.jdField_a_of_type_Boolean + "  Make data ready: frameIndex= " + ((AVIOStruct)localObject).pFrameIndex + "  hasRenaderFrame=" + bool1);
        if (!bool1)
        {
          if (this.jdField_a_of_type_Aiim.jdField_a_of_type_Boolean) {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqShortvideoMediadevicePreviewContext != null) && (this.jdField_a_of_type_ComTencentMobileqqShortvideoMediadevicePreviewContext.notifyFirstFrame)) {
        this.jdField_a_of_type_AndroidOsHandler.post(new aiil(this));
      }
      if (this.jdField_a_of_type_ComTencentMobileqqShortvideoUtilPtvFilterOpenglFrameBuffer == null) {
        break;
      }
