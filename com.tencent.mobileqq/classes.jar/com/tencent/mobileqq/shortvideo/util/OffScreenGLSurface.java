  ...
  implements Handler.Callback
{
  ...
  private OffScreenGLSurface.ThumbPicSessionCtl jdField_a_of_type_ComTencentMobileqqShortvideoUtilOffScreenGLSurface$ThumbPicSessionCtl = new OffScreenGLSurface.ThumbPicSessionCtl(null);
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqShortvideoUtilOffScreenGLSurface$ThumbPicSessionCtl.jdField_a_of_type_Int = paramAVIOStruct.pFrameIndex;
    paramAVIOStruct.pFrameIndex = 0;
    this.jdField_a_of_type_ComTencentMobileqqShortvideoUtilOffScreenGLSurface$ThumbPicSessionCtl.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_ComTencentMobileqqShortvideoUtilOffScreenGLSurface$ThumbPicSessionCtl.jdField_b_of_type_Int = 0;
    GLSurfaceUtil.a("handleMessage:writeVideoFrame[false]  mThumbPicControl.mSendThumbOKIndex=" + this.jdField_a_of_type_ComTencentMobileqqShortvideoUtilOffScreenGLSurface$ThumbPicSessionCtl.jdField_a_of_type_Int);
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqShortvideoUtilOffScreenGLSurface$ThumbPicSessionCtl.jdField_b_of_type_Int = 0;
        this.jdField_a_of_type_ComTencentMobileqqShortvideoUtilOffScreenGLSurface$ThumbPicSessionCtl.jdField_a_of_type_Boolean = false;
        this.jdField_a_of_type_ComTencentMobileqqShortvideoUtilOffScreenGLSurface$ThumbPicSessionCtl.jdField_a_of_type_Int = -1;
        h();
      } while (!QLog.isColorLevel());
    ...
    if (paramMessage.obj != null)
    {
      ...
      if (localTextureDataPipe != null)
      {
        ...
        {
          this.jdField_a_of_type_ComTencentMobileqqShortvideoUtilOffScreenGLSurface$ThumbPicSessionCtl.jdField_a_of_type_Boolean = true;
          localObject = localAVIOStruct;
        }
        label713:
        ...
        GLSurfaceUtil.a("handleMessage:writeVideoFrame  mNewSession=" + this.jdField_a_of_type_ComTencentMobileqqShortvideoUtilOffScreenGLSurface$ThumbPicSessionCtl.jdField_a_of_type_Boolean + "  Make data ready: frameIndex= " + ((AVIOStruct)localObject).pFrameIndex + "  hasRenaderFrame=" + bool1);
        if (!bool1)
        {
          if (this.jdField_a_of_type_ComTencentMobileqqShortvideoUtilOffScreenGLSurface$ThumbPicSessionCtl.jdField_a_of_type_Boolean) {
