...
public class StorageManager
{
  ...
  public static long a(String paramString)
  {
    try
    {
      ...
      int m = paramString.getBlockSize();
      return l * m;
    }
  ...
  {
    // Byte code:
    //   0: invokestatic 136	java/lang/Thread:currentThread	()Ljava/lang/Thread;
    //   3: invokevirtual 140	java/lang/Thread:getId	()J
    //   6: lstore_1
    //   7: new 142	java/lang/StringBuilder
    //   10: dup
    //   11: invokespecial 143	java/lang/StringBuilder:<init>	()V
    //   14: astore 5
    //   16: aload 5
    //   18: aload_0
    ...
    //   23: aload 5
    //   25: ldc 149
    //   27: invokevirtual 147	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   30: pop
    //   31: aload 5
    //   33: lload_1
    //   34: invokevirtual 152	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   37: pop
    //   38: new 154	java/io/File
    //   41: dup
    //   42: aload 5
    //   44: invokevirtual 158	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   47: invokespecial 159	java/io/File:<init>	(Ljava/lang/String;)V
    //   50: astore_0
    //   51: iconst_0
    //   52: istore 4
    //   54: aload_0
    ...
    //   68: ifeq +34 -> 102
    //   71: aload_0
    //   72: invokevirtual 168	java/io/File:createNewFile	()Z
    //   75: istore_3
    //   76: goto +26 -> 102
    //   79: aload_0
    //   80: invokevirtual 168	java/io/File:createNewFile	()Z
    //   83: istore_3
    //   84: goto +18 -> 102
    //   87: astore 5
    //   89: goto +20 -> 109
    //   92: astore 5
    //   94: aload 5
    //   96: invokevirtual 171	java/lang/Throwable:printStackTrace	()V
    //   99: iload 4
    //   101: istore_3
    //   102: aload_0
    //   103: invokevirtual 165	java/io/File:delete	()Z
    //   106: pop
    //   107: iload_3
    //   108: ireturn
    //   109: aload_0
    //   110: invokevirtual 165	java/io/File:delete	()Z
    //   113: pop
    //   114: aload 5
    //   116: athrow
  ...
  {
    this.j = paramOnSdCardChangedListener;
  }
  ...
  public void b()
  {
    if (this.i)
    {
      VideoEnvironment.getContext().unregisterReceiver(this.k);
      this.i = false;
    }
  }
    ...
    synchronized (this.c)
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        try
        {
          ...
          if ((((File)localObject3).exists()) && (((File)localObject3).canWrite()) && (b(str)))
          {
