...
public class PtvFilterUtils
{
  ...
  public static int a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, ByteBuffer paramByteBuffer, AVIOStruct paramAVIOStruct)
  {
    ...
    xvv.a("PtvFilterUtils", "sharedMemoryGLReadPixels %d, width=%d, height=%d", Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Integer.valueOf(paramInt3));
    if (paramInt1 != 0)
    {
    ...
    for (;;)
    {
      ...
      if ((b) && (paramAVIOStruct != null))
      {
        ...
        if (paramInt1 == 0)
        {
          ...
          if (paramInt4 != 0) {
            xvv.e("PtvFilterUtils", "getGLFrameBufferDataPBO:err=" + Integer.toHexString(paramInt4));
          }
          GLES30.glBindTexture(3553, 0);
          xvv.a("PtvFilterUtils", "getGLFrameBufferDataPBO request pack pixel to PBO frame=%d, PBO=%d, cost=%d", Integer.valueOf(paramInt1), Integer.valueOf(paramInt1 % jdField_a_of_type_ArrayOfInt.length), Long.valueOf(SystemClock.elapsedRealtime() - l1));
          if (paramInt1 < 1) {
            break label450;
          }
          ...
          paramInt4 = GLES20.glGetError();
          if (paramInt4 != 0) {
            xvv.e("PtvFilterUtils", "glMapBufferRange:err=" + Integer.toHexString(paramInt4));
          }
        ...
        for (;;)
        {
          ...
          break label134;
          label440:
          xvv.d("PtvFilterUtils", "getGLFrameBufferDataPBO glMapBufferRange failed");
        }
        label450:
        GLES30.glBindBuffer(35051, 0);
        GLES20.glReadPixels(0, 0, paramInt2, paramInt3, i, 5121, paramByteBuffer);
