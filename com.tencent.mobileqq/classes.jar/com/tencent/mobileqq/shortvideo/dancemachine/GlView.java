...
public abstract class GlView
{
  ...
  public GlView(GLViewContext paramGLViewContext, String paramString)
  {
    ...
    this.jdField_a_of_type_Ahml = GLShaderManager.a(paramString);
    this.k = false;
    this.l = false;
  ...
  protected void aj_()
  {
    int i1 = ((Integer)this.jdField_a_of_type_Ahml.jdField_a_of_type_JavaUtilHashMap.get("a_position")).intValue();
    GLES20.glVertexAttribPointer(i1, 3, 5126, false, 0, 0);
    GLES20.glEnableVertexAttribArray(i1);
    i1 = ((Integer)this.jdField_a_of_type_Ahml.jdField_a_of_type_JavaUtilHashMap.get("a_texCoord")).intValue();
    GLES20.glVertexAttribPointer(i1, 2, 5126, false, 0, this.jdField_a_of_type_Ahml.b() * this.jdField_i_of_type_Int * 4);
    GLES20.glEnableVertexAttribArray(i1);
    i1 = ((Integer)this.jdField_a_of_type_Ahml.jdField_a_of_type_JavaUtilHashMap.get("a_color")).intValue();
    GLES20.glVertexAttribPointer(i1, 4, 5126, false, 0, this.jdField_a_of_type_Ahml.c() * this.jdField_i_of_type_Int * 4);
    GLES20.glEnableVertexAttribArray(i1);
    i1 = ((Integer)this.jdField_a_of_type_Ahml.b.get("u_texture")).intValue();
  ...
  public void f(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      a(this.jdField_a_of_type_Ahml.a() * this.jdField_i_of_type_Int);
  ...
  public final void r()
  {
    ...
    GLES20.glUseProgram(this.jdField_a_of_type_Ahml.jdField_a_of_type_Int);
    GLES20.glUniformMatrix4fv(((Integer)this.jdField_a_of_type_Ahml.b.get("u_projectionMatrix")).intValue(), 1, false, this.jdField_a_of_type_ComTencentMobileqqShortvideoDancemachineGLViewContext.a(), 0);
