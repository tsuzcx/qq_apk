...
public class ID3
{
  ...
  static
  {
    jdField_a_of_type_ComTencentMobileqqShortvideoMlDecisiontreeID3$ImpurityFunction = new ID3.1();
    jdField_b_of_type_ComTencentMobileqqShortvideoMlDecisiontreeID3$ImpurityFunction = new ID3.2();
  ...
  public static Node a(List<Instance> paramList, ID3.ImpurityFunction paramImpurityFunction)
  {
  ...
  public void a(List<Instance> paramList)
  {
