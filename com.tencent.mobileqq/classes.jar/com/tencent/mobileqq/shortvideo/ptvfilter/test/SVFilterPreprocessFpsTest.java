...
public class SVFilterPreprocessFpsTest
{
  ...
  public static void a()
  {
    if ((jdField_c_of_type_Int == 20) && (!jdField_a_of_type_Boolean))
    {
      ...
      if (i != 0) {
        PerformenceDataTag.a("sv_preprocess_frame_buffer", d1);
      }
      long l = 0L;
      int j = 0;
      ...
      if (i != 0) {
        PerformenceDataTag.a("sv_preprocess_clip_video", d1);
      }
      l = 0L;
      j = 0;
      while (j < 20)
      ...
      if (i != 0) {
        PerformenceDataTag.a("sv_preprocess_total_time", d1);
      }
 ...
 * Qualified Name:     com.tencent.mobileqq.shortvideo.ptvfilter.test.SVFilterPreprocessFpsTest
