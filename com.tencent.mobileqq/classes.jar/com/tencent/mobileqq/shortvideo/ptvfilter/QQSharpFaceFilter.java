  ...
  public AESticker createFilterWithSharpFace(AESticker paramAESticker, VideoPreviewFaceOutlineDetector paramVideoPreviewFaceOutlineDetector, int paramInt1, int paramInt2, double paramDouble)
  {
    if (paramAESticker != null)
    {
      ...
      if (this.mSharpFaceFilter == null)
      {
        ...
        paramAESticker.getFilters().add(this.mSharpFaceFilter);
        paramAESticker.getTransformFilters().add(this.mSharpFaceFilter);
        paramVideoPreviewFaceOutlineDetector = paramAESticker;
      }
    }
    while (this.mSharpFaceFilter != null)
    {
      ...
      for (;;)
      {
        if (paramInt1 < this.originalDistortionStrengthList.length)
        {
          ...
          paramVideoPreviewFaceOutlineDetector.getFilters().clear();
          paramVideoPreviewFaceOutlineDetector.getFilters().add(this.mSharpFaceFilter);
          paramVideoPreviewFaceOutlineDetector.getTransformFilters().clear();
          paramVideoPreviewFaceOutlineDetector.getTransformFilters().add(this.mSharpFaceFilter);
          break;
        }
      }
