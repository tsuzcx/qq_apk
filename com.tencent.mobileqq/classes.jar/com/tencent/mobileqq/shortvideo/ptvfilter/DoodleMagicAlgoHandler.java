  ...
  public static void renderToTemp(int paramInt, float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, float[] paramArrayOfFloat3)
  {
    ...
    if ((mFilter != null) && (mFilter.get() != null))
    {
      ...
      if (localVideoFilterBase != null)
      {
        ...
        if (!(localVideoFilterBase instanceof xhi)) {
          break label108;
        }
        ((xhi)localVideoFilterBase).a(localRenderPoint);
      }
    }
    label108:
    while (!(localVideoFilterBase instanceof bmvl)) {
      return;
    }
    ((bmvl)localVideoFilterBase).a(localRenderPoint);
  }
