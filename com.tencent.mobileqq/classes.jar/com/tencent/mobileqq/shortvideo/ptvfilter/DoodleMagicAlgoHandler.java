  ...
  public static void renderToTemp(int paramInt, float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, float[] paramArrayOfFloat3)
  {
    ...
    if ((mFilter != null) && (mFilter.get() != null))
    {
      ...
      if (localVideoFilterBase != null)
      {
        ...
        if (!(localVideoFilterBase instanceof zeo)) {
          break label108;
        }
        ((zeo)localVideoFilterBase).a(localRenderPoint);
      }
    }
    label108:
    while (!(localVideoFilterBase instanceof bqom)) {
      return;
    }
    ((bqom)localVideoFilterBase).a(localRenderPoint);
  }
