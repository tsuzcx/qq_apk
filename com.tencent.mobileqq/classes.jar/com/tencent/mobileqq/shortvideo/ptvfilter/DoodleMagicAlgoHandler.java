  ...
  public static void renderToTemp(int paramInt, float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, float[] paramArrayOfFloat3)
  {
    ...
    if ((mFilter != null) && (mFilter.get() != null))
    {
      ...
      if (localVideoFilterBase != null)
      {
        ...
        if (!(localVideoFilterBase instanceof zat)) {
          break label108;
        }
        ((zat)localVideoFilterBase).a(localRenderPoint);
      }
    }
    label108:
    while (!(localVideoFilterBase instanceof bpmr)) {
      return;
    }
    ((bpmr)localVideoFilterBase).a(localRenderPoint);
  }
