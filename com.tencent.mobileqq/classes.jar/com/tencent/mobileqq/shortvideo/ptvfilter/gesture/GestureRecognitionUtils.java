...
public class GestureRecognitionUtils
{
  ...
  public static Drawable a(Context paramContext, String paramString)
  {
    ...
    if (paramString.equals("fivea")) {
      paramContext = paramContext.getResources().getDrawable(2130842308);
    }
    for (;;)
    {
      ...
      {
        paramContext = paramContext.getResources().getDrawable(2130842309);
      }
      else if (paramString.equals("qheart"))
      {
        paramContext = paramContext.getResources().getDrawable(2130842310);
      }
      else
      {
