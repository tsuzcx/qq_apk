...
final class MiniScanReport$7
  implements Runnable
{
  MiniScanReport$7(int paramInt1, int paramInt2) {}
  ...
  public void run()
  {
    ...
    StatisticCollector.getInstance(MobileQQ.getContext()).collectPerformance("", "report_tag_detect_init_cost", true, 0L, 0L, localHashMap, "");
 ...
 * Qualified Name:     com.tencent.mobileqq.qrscan.minicode.MiniScanReport.7
