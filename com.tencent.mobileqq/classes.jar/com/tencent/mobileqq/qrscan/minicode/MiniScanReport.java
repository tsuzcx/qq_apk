  ...
  implements IQRScanReportConst
{
  ...
  private static MiniScanReport.ScanInfoReport jdField_a_of_type_ComTencentMobileqqQrscanMinicodeMiniScanReport$ScanInfoReport;
  ...
  {
    jdField_a_of_type_ComTencentMobileqqQrscanMinicodeMiniScanReport$ScanInfoReport = new MiniScanReport.ScanInfoReport(null);
    jdField_a_of_type_ComTencentMobileqqQrscanMinicodeMiniScanReport$ScanInfoReport.jdField_a_of_type_Long = System.currentTimeMillis();
  }
  
  public static void a(int paramInt)
  {
    MiniScanReport.ScanInfoReport localScanInfoReport = jdField_a_of_type_ComTencentMobileqqQrscanMinicodeMiniScanReport$ScanInfoReport;
    if (localScanInfoReport == null) {
      return;
    }
    jdField_a_of_type_ComTencentMobileqqQrscanMinicodeMiniScanReport$ScanInfoReport = null;
    long l = System.currentTimeMillis() - localScanInfoReport.jdField_a_of_type_Long;
    if (l <= 600000L)
    {
      if (localScanInfoReport.jdField_a_of_type_Int <= 0) {
        return;
      }
    ...
    if ((localScanInfoReport != null) && (paramInt1 > 1))
    {
      ...
      if (paramInt2 != 0)
      {
        if (paramInt2 != 1)
        {
          ...
          localScanInfoReport = jdField_a_of_type_ComTencentMobileqqQrscanMinicodeMiniScanReport$ScanInfoReport;
