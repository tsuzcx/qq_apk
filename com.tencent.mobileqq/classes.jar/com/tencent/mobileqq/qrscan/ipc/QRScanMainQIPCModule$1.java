  ...
  implements QRScanResDownloadManager.DownloadCallback
{
  ...
  public void a(int paramInt1, int paramInt2)
  {
    if (paramInt1 == this.a)
    {
      ...
      QIPCServerHelper.getInstance().callClient(this.b, "QRScanSubQIPCModule", "action_notify_download_process", localBundle, null);
    }
  }
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    if (paramInt == this.a)
    {
      ...
      QIPCServerHelper.getInstance().callClient(this.b, "QRScanSubQIPCModule", "action_notify_download_result", localBundle, null);
    }
  }
}
