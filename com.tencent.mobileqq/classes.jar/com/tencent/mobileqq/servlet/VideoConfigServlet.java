  ...
  extends MSFServlet
{
  ...
  private void a(VideoCallMsg paramVideoCallMsg)
  {
    ...
    {
      AVLog.d("VideoConfigServlet", "handleVideoConfigMessage error videoMsg = null");
      return;
    }
    int[] arrayOfInt;
    int i;
    ...
    {
      arrayOfInt = ConfigSystemImpl.a(paramVideoCallMsg.vMsg);
      if (arrayOfInt != null)
      {
        i = arrayOfInt[0];
        j = arrayOfInt[1];
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      bool1 = ConfigSystemImpl.a(String.valueOf(AppSetting.a), getAppRuntime().getApplication(), paramVideoCallMsg.vMsg);
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (paramIntent != null)
    {
      ...
      AVLog.c("VideoConfigServlet", "VideoConfigServlet receive resp: result = success");
    }
    label59:
    label67:
    do
    {
      do
      {
        ...
        {
          return;
          AVLog.c("VideoConfigServlet", "VideoConfigServlet receive resp: result = failed");
          return;
        ...
        try
        {
          ...
          {
            AVLog.c("VideoConfigServlet", "cmd0xa02 onReceive uint32_result = " + paramFromServiceMsg.uint32_result.get());
            return;
          }
        }
      ...
      AVLog.c("VideoConfigServlet", "cmd0xa02 onReceive list = " + paramIntent.toString());
      new ArrayList();
    ...
    return;
    AVLog.c("VideoConfigServlet", "cmd0xa02 onReceive not success!");
  }
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    AVLog.c("VideoConfigServlet", "cmd0xa02 onSend");
    return;
