  ...
  implements WebEventListener
{
  ...
  public static int b;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new ahjs(this);
  private Runnable jdField_a_of_type_JavaLangRunnable = new ahjr(this);
      ...
      for (;;)
      {
        ...
        else
        {
          if (str1 != null)
          {
            ...
            str1 = localQQAppInterface.getApp().getApplicationContext().getString(2131434673) + i + localQQAppInterface.getApp().getApplicationContext().getString(2131434674);
          }
          label845:
          label855:
          for (;;)
