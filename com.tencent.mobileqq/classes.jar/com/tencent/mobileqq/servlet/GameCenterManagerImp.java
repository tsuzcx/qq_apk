...
public class GameCenterManagerImp
  implements WadlCmdListener, Manager
{
  ...
  public void a(JSONArray paramJSONArray)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        arrayOfString = GameCenterSpUtils.a("APPOINTMENT_DOWNLOAD_LIST").split("\\|");
        i = 0;
        ...
        GameCenterSpUtils.a("APPID_PKGNAME_" + str1, str2);
        if (bool) {
          GameCenterUtils.b(str1, "APPOINTMENT_RES_LIST");
        }
      }
      ...
      for (j = 1;; j = 0)
      {
        ...
        GameCenterUtils.b(str1, "APPOINTMENT_LIST");
        GameCenterUtils.a(str1, paramJSONArray.get(i).toString(), "APPOINT_APPID_DETAIL_");
        break label234;
        j += 1;
        break;
      }
    ...
    do
    {
      for (;;)
      {
        ...
        case 2: 
          try
          {
            l = new JSONObject(paramMsgBody.bytes_data.get().toStringUtf8()).optLong("version", -1L);
            ((IQQGameConfigService)QRoute.api(IQQGameConfigService.class)).checkConfigUpdate(true, l);
            return;
          }
        ...
        case 3: 
          try
          {
            ...
            paramMsgBody = new GameCenterManagerImp.2(this, i);
            if (i == 1)
            {
      ...
      try
      {
        ...
        GameMsgGrayTipsHandler.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMsgBody);
        return;
      }
      catch (Throwable paramMsgBody)
      {
        QLog.e(GameMsgChatPie.g, 1, "onReceivePushMsg gameMsgTips push e=" + paramMsgBody.toString());
        return;
      }
    } while (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null);
    if (QLog.isColorLevel()) {
      QLog.d("hippyUpdateAction-GameCenterManagerImp", 2, "onReceivePushMsg preload Hippy");
    }
    HippyUpdateManager.getInstance().predownloadHippy(2);
  }
    ...
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      if (m < paramList.size())
      {
        ...
        do
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.d("GameCenterManagerImp", 2, "setNewUnread.i=" + m + ",before unreaddata:" + localUnreadData.toString());
          }
          ...
          do
          {
            ...
            if (QLog.isColorLevel())
            {
              QLog.d("GameCenterManagerImp", 2, "setNewUnread.i=" + m + ",unreaddata:" + localUnreadData.toString());
              k = j;
              bool3 = bool2;
            }
            bool1 = bool3;
  ...
  public void onCmdRsp(Intent paramIntent, String paramString, long paramLong, JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      GameCenterUtils.a(paramJSONObject.optLong("res_valid") * 1000L);
