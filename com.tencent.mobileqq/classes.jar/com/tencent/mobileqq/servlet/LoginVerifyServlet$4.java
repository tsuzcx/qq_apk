...
public final class LoginVerifyServlet$4
  implements Runnable
{
  public LoginVerifyServlet$4(String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3, bbos parambbos) {}
  ...
  public void run()
  {
    try
    {
      ...
      Object localObject1 = new bbor(this, (URL)localObject5);
      ...
      ((HttpsURLConnection)localObject2).setRequestProperty("User-Agent", "android" + "_" + Build.VERSION.SDK + "_" + Build.DEVICE + "_" + Build.VERSION.RELEASE + "_" + "8.4.8" + "_" + "QQ/" + "8.4.84810");
