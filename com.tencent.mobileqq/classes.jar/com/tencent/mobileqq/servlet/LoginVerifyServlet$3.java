...
public final class LoginVerifyServlet$3
  implements Runnable
{
  public LoginVerifyServlet$3(String paramString1, String paramString2, String paramString3, awcu paramawcu) {}
  ...
  public void run()
  {
    try
    {
      ...
      Object localObject1 = new awct(this, (URL)localObject5);
      ...
      ((HttpsURLConnection)localObject2).setRequestProperty("User-Agent", "android" + "_" + Build.VERSION.SDK + "_" + Build.DEVICE + "_" + Build.VERSION.RELEASE + "_" + "8.2.6" + "_" + "QQ/" + "8.2.64370");
