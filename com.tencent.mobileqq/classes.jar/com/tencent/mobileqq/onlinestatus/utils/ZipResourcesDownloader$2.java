  ...
  implements HttpEngineTask.IHttpEngineTask
{
  ...
  public void onResp(NetResp paramNetResp)
  {
    ...
    if (i != 0)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqOnlinestatusUtilsZipResourcesDownloader.a != null) {
        paramNetResp = (IPreDownloadController)this.jdField_a_of_type_ComTencentMobileqqOnlinestatusUtilsZipResourcesDownloader.a.get();
      }
      if (paramNetResp != null) {
        paramNetResp.preDownloadSuccess(str, -1L);
      }
      ZipResourcesDownloader.a(this.jdField_a_of_type_ComTencentMobileqqOnlinestatusUtilsZipResourcesDownloader, str, this.jdField_a_of_type_JavaLangString, false, this.jdField_a_of_type_ComTencentMobileqqOnlinestatusUtilsZipResourcesDownloader$OnZipResourcesDownloadCallback);
      return;
    }
    localObject1 = localObject2;
    if (this.jdField_a_of_type_ComTencentMobileqqOnlinestatusUtilsZipResourcesDownloader.a != null) {
      localObject1 = (IPreDownloadController)this.jdField_a_of_type_ComTencentMobileqqOnlinestatusUtilsZipResourcesDownloader.a.get();
    }
    ...
    {
      localObject1 = new File(ZipResourcesDownloader.b(this.jdField_a_of_type_JavaLangString));
      if (!((File)localObject1).exists()) {
        ((File)localObject1).mkdirs();
      }
      boolean bool1 = ZipResourcesDownloader.b(paramNetResp.mOutPath, ZipResourcesDownloader.b(this.jdField_a_of_type_JavaLangString));
      ...
      ZipResourcesDownloader.a(this.jdField_a_of_type_ComTencentMobileqqOnlinestatusUtilsZipResourcesDownloader, str, this.jdField_a_of_type_JavaLangString, bool2, this.jdField_a_of_type_ComTencentMobileqqOnlinestatusUtilsZipResourcesDownloader$OnZipResourcesDownloadCallback);
      return;
    }
    if (QLog.isColorLevel()) {
