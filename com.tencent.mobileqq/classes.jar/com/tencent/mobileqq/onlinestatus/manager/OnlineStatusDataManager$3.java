  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (QLog.isColorLevel())
    {
      ...
      QLog.d("OnlineStatusDataManagerImpl", 2, new Object[] { "SyncBusinessInfoRunnable app.isRunning=", localObject, " mSyncPause:", Boolean.valueOf(OnlineStatusDataManager.c(this.this$0)) });
    }
    if ((OnlineStatusDataManager.a(this.this$0) != null) && (OnlineStatusDataManager.a(this.this$0).isRunning()))
    {
      int i = OnLineStatusHelper.a().c(OnlineStatusDataManager.a(this.this$0));
      if (i == 1)
      {
        localObject = OnLineStatusHelper.a().b(OnlineStatusDataManager.a(this.this$0));
      ...
      {
        if (!OnlineStatusDataManager.c(this.this$0)) {
          this.this$0.b(7);
        }
      }
      else if (i == 3)
      {
        boolean bool1 = ConstellationUtilKt.i(OnlineStatusDataManager.a(this.this$0));
        boolean bool2 = ConstellationUtilKt.h(OnlineStatusDataManager.a(this.this$0));
        if (QLog.isColorLevel()) {
        ...
        if ((bool1) && (bool2))
        {
          localObject = ConstellationUtilKt.d(OnlineStatusDataManager.a(this.this$0), OnlineStatusDataManager.a(this.this$0).getCurrentAccountUin());
