  ...
  implements View.OnClickListener
{
  ...
  public final void onClick(View paramView)
  {
    ...
    {
      QQToast.a((Context)this.a.a(), 1, 2131719505, 0).a();
      this.a.a.a(1030);
      this.a.dismiss();
    ...
    Object localObject = WeatherView.a(this.a).getManager(QQManagerFactory.ONLINE_STATUS_MANAGER);
    if (localObject == null) {
    ...
    if (!WeatherView.a(this.a)) {}
    for (boolean bool = true;; bool = false)
    {
      localIntent.putExtra("from_modify", bool);
      if (QLog.isColorLevel()) {
        QLog.d("WeatherView", 2, new Object[] { "bindView: called. ", "needSwitchOnlineStatus: " + WeatherView.a(this.a) });
      }
      ((OnlineStatusManager)localObject).b(8, localIntent);
      break;
    }
  }
}
