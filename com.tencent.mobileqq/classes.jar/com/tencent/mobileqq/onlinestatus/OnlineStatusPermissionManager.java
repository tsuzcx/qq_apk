  ...
  implements Manager
{
  ...
  public OnlineStatusPermissionManager(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    paramQQAppInterface.registObserver(this.jdField_a_of_type_ComTencentMobileqqOnlinestatusOnlineStatusPermissionObserver);
  ...
  private Pair<Boolean, List<Integer>> a(List<Integer> paramList)
  {
    ...
    if (paramList.hasNext())
    {
      ...
      if (localIterator.hasNext())
      {
        ...
        if (localInteger.intValue() != localAutoStatusItem.a) {
          break label208;
        }
  ...
  private void a()
  {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        Object localObject1 = SharePreferenceUtils.a(BaseApplication.getContext(), "smart_selected_list" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin());
  ...
  private void a(OnlineStatusPermissionManager.ReceiveDataListener paramReceiveDataListener)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 42	com/tencent/mobileqq/onlinestatus/OnlineStatusPermissionManager:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   6: invokevirtual 228	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   9: astore_2
    //   10: aload_2
    ...
    //   25: checkcast 230	mqq/util/WeakReference
    //   28: astore_3
    //   29: aload_3
    //   30: invokevirtual 233	mqq/util/WeakReference:get	()Ljava/lang/Object;
    //   33: ifnull -23 -> 10
    //   36: aload_1
    //   37: aload_3
    //   38: invokevirtual 233	mqq/util/WeakReference:get	()Ljava/lang/Object;
    //   41: if_acmpne -31 -> 10
    ...
    //   71: return
    //   72: aload_0
    //   73: getfield 42	com/tencent/mobileqq/onlinestatus/OnlineStatusPermissionManager:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   76: new 230	mqq/util/WeakReference
    //   79: dup
    //   80: aload_1
    //   81: invokespecial 238	mqq/util/WeakReference:<init>	(Ljava/lang/Object;)V
    ...
    //   0	96	0	this	OnlineStatusPermissionManager
    //   0	96	1	paramReceiveDataListener	OnlineStatusPermissionManager.ReceiveDataListener
  ...
  private boolean c(List<Integer> paramList)
  {
    if (paramList.size() == 0)
    {
      SharePreferenceUtils.a(BaseApplication.getContext(), "smart_selected_list" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin());
      return true;
    }
    ...
    SharePreferenceUtils.a(BaseApplication.getContext(), "smart_selected_list" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin(), localStringBuilder.toString());
    return true;
  }
  ...
  public OnlineStatusFriendsPermissionItem a(long paramLong, boolean paramBoolean, OnlineStatusPermissionManager.ReceiveDataListener paramReceiveDataListener)
  {
    ...
    //   23: iconst_1
    //   24: lload_1
    //   25: invokestatic 287	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   28: aastore
    //   29: dup
    //   30: iconst_2
    //   31: ldc_w 289
    ...
    //   36: iconst_3
    //   37: aload_0
    //   38: getfield 22	com/tencent/mobileqq/onlinestatus/OnlineStatusPermissionManager:jdField_a_of_type_Int	I
    ...
    //   61: aload_0
    //   62: getfield 52	com/tencent/mobileqq/onlinestatus/OnlineStatusPermissionManager:jdField_a_of_type_ComTencentMobileqqOnlinestatusOnlineStatusFriendsPermissionItem	Lcom/tencent/mobileqq/onlinestatus/OnlineStatusFriendsPermissionItem;
    //   65: ifnull +14 -> 79
    //   68: aload_0
    //   69: getfield 52	com/tencent/mobileqq/onlinestatus/OnlineStatusPermissionManager:jdField_a_of_type_ComTencentMobileqqOnlinestatusOnlineStatusFriendsPermissionItem	Lcom/tencent/mobileqq/onlinestatus/OnlineStatusFriendsPermissionItem;
    //   72: astore 4
    //   74: aload_0
    //   75: monitorexit
    //   76: aload 4
    ...
    //   106: aload_0
    //   107: aload 4
    //   109: invokespecial 295	com/tencent/mobileqq/onlinestatus/OnlineStatusPermissionManager:a	(Lcom/tencent/mobileqq/onlinestatus/OnlineStatusPermissionManager$ReceiveDataListener;)V
    //   112: iload_3
    //   113: ifeq +9 -> 122
    //   116: aload_0
    //   117: lload_1
    //   118: iconst_0
    //   119: invokevirtual 298	com/tencent/mobileqq/onlinestatus/OnlineStatusPermissionManager:a	(JZ)V
    //   122: aconst_null
    //   123: astore 4
    //   125: goto -51 -> 74
    //   128: astore 4
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	135	0	this	OnlineStatusPermissionManager
    //   0	135	1	paramLong	long
    //   0	135	3	paramBoolean	boolean
    //   0	135	4	paramReceiveDataListener	OnlineStatusPermissionManager.ReceiveDataListener
    // Exception table:
    //   from	to	target	type
    //   2	61	128	finally
    //   61	74	128	finally
  ...
  {
    OnlineStatusPermissionServlet.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramLong, paramBoolean, false);
  }
  ...
  public boolean a()
  {
    return !TextUtils.isEmpty(SharePreferenceUtils.a(BaseApplication.getContext(), "smart_selected_list" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin()));
  }
  ...
  public boolean a(OnlineStatusPermissionChecker.OnlineStatusPermissionItem paramOnlineStatusPermissionItem, OnlineStatusPermissionManager.ReceiveDataListener paramReceiveDataListener)
  {
    ...
    } while (paramReceiveDataListener.permissionUins.containsAll(paramOnlineStatusPermissionItem.getPermissionUins()));
    if (QLog.isColorLevel()) {
  ...
  public boolean a(ArrayList<OnlineStatusItem> paramArrayList)
  {
    ...
    for (;;)
    {
      if (paramArrayList.hasNext())
      {
        ...
        } while (localOnlineStatusItem.a != localInteger.intValue());
      }
      for (int i = 1; i == 0; i = 0)
      {
        return true;
 ...
 * Qualified Name:     com.tencent.mobileqq.onlinestatus.OnlineStatusPermissionManager
