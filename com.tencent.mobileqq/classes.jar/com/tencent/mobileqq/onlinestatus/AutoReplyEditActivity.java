  ...
  implements SoftInputDetectView.OnImStateChangedListener
{
  ...
  private static EmoticonMainPanel a(@NonNull QQAppInterface paramQQAppInterface, @NonNull BaseActivity paramBaseActivity, @NonNull View paramView, int paramInt, @NonNull EditText paramEditText)
  {
    ...
    paramView.setCallBack(new AutoReplyEditActivity.12(paramEditText, paramQQAppInterface, paramBaseActivity));
    ...
    paramView.init(paramQQAppInterface, 100002, paramBaseActivity, paramBaseActivity.getTitleBarHeight(), null, null, false, new AutoReplyEditActivity.13());
  ...
  private void a()
  {
    QQCustomDialog localQQCustomDialog = DialogUtil.a(getActivity(), 230).setMessage(getString(2131690329));
    localQQCustomDialog.setPositiveButton(2131694615, new AutoReplyEditActivity.10(this));
    localQQCustomDialog.setNegativeButton(2131690800, new AutoReplyEditActivity.11(this));
  ...
  private void a(Bundle paramBundle)
  {
    ...
    setTitle(getString(2131690318));
    setLeftButton(2131690800, new AutoReplyEditActivity.2(this));
    setRightButton(2131692534, new AutoReplyEditActivity.3(this));
    ((SoftInputDetectView)this.mContentView.findViewById(2131369156)).setOnImStateChangedListener(this);
    ...
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)this.mContentView.findViewById(2131363149));
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonMainPanel = a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, getActivity(), this.mContentView, 2131366267, this.jdField_a_of_type_AndroidWidgetEditText);
      ...
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.mContentView.findViewById(2131366294));
      this.jdField_a_of_type_AndroidWidgetImageView.setOnTouchListener(this.jdField_a_of_type_AndroidViewView$OnTouchListener);
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.mContentView.findViewById(2131366297));
      this.jdField_b_of_type_AndroidWidgetImageView.setOnTouchListener(this.jdField_a_of_type_AndroidViewView$OnTouchListener);
      this.jdField_b_of_type_AndroidWidgetImageView.setOnClickListener(new AutoReplyEditActivity.6(this));
      if (!ThemeUtil.isDefaultTheme())
      {
        this.mContentView.findViewById(2131379661).setVisibility(8);
        this.mContentView.findViewById(2131363808).setVisibility(8);
      }
      return;
  ...
  private void b()
  {
    if ((this.jdField_b_of_type_Boolean) || (this.jdField_a_of_type_Boolean))
    {
      ...
      this.jdField_b_of_type_AndroidWidgetImageView.setContentDescription(getActivity().getString(2131690327));
      return;
    }
    this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130837507);
    this.jdField_b_of_type_AndroidWidgetImageView.setContentDescription(getActivity().getString(2131690330));
  }
  ...
  private void b(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130850288);
    this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(getActivity().getString(2131690325));
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new AutoReplyEditActivity.9(this));
    this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonMainPanel.setVisibility(8);
  ...
  public void initWindowStyleAndAnimation(Activity paramActivity)
  {
    ...
    paramActivity.getWindow().getDecorView().setBackgroundResource(2130838979);
  }
