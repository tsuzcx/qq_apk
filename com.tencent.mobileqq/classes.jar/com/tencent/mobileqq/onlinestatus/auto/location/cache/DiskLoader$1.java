  ...
  implements PoiLoader.OnPoiLoadListener
{
  ...
  public void a(PoiBean paramPoiBean)
  {
    if (QLog.isColorLevel()) {
      QLog.d(Loader.a, 2, "[status][poiLoader][" + this.jdField_a_of_type_ComTencentMobileqqOnlinestatusAutoLocationCacheDiskLoader.b + "] diskPut [fail already exist]. latLng: " + this.jdField_a_of_type_ComTencentTencentmapMapsdkMapsModelLatLng + " acceptAccuracy: " + this.jdField_a_of_type_Int + " put: " + this.jdField_a_of_type_ComTencentMobileqqOnlinestatusAutoLocationCachePoiBean + " cache: " + paramPoiBean);
    }
  }
}
