...
public class AutoStatus
{
  ...
  {
    return "AutoStatus{status=" + Constant.a(this.jdField_a_of_type_Int) + ", updateTime=" + new SimpleDateFormat("HH:mm:ss", Locale.getDefault()).format(new Date(this.jdField_a_of_type_Long)) + '}';
  }
}
