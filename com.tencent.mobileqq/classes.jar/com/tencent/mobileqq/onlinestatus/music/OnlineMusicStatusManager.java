...
public class OnlineMusicStatusManager
  implements Handler.Callback, QQPlayerService.QQPlayerCallback
{
  private static OnlineMusicStatusManager jdField_a_of_type_ComTencentMobileqqOnlinestatusMusicOnlineMusicStatusManager;
  ...
  public OnlineMusicStatusManager()
  {
  ...
  public static OnlineMusicStatusManager a()
  {
    if (jdField_a_of_type_ComTencentMobileqqOnlinestatusMusicOnlineMusicStatusManager == null) {}
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (jdField_a_of_type_ComTencentMobileqqOnlinestatusMusicOnlineMusicStatusManager == null) {
        jdField_a_of_type_ComTencentMobileqqOnlinestatusMusicOnlineMusicStatusManager = new OnlineMusicStatusManager();
      }
      return jdField_a_of_type_ComTencentMobileqqOnlinestatusMusicOnlineMusicStatusManager;
    }
  }
  ...
  public static String a(QQAppInterface paramQQAppInterface, Friends paramFriends, TextView paramTextView)
  {
    ...
    if ((!TextUtils.isEmpty(paramFriends.songName)) && (System.currentTimeMillis() < paramFriends.songEndTime))
    {
      ...
      {
        paramQQAppInterface = String.format(paramQQAppInterface.getString(2131698432), new Object[] { paramFriends.songName, paramFriends.singerName });
        if (!(paramTextView instanceof OnlineStatusLyricView)) {
          break label152;
        }
        ((OnlineStatusHandler)CaptureContext.a().getBusinessHandler(BusinessHandlerFactory.ONLINE_STATUS_HANDLER)).a(paramFriends);
      ...
      for (;;)
      {
        ...
        paramQQAppInterface = String.format(paramQQAppInterface.getString(2131698433), new Object[] { paramFriends.songName });
        break;
        label152:
        paramQQAppInterface = DanmuUtil.a(paramTextView.getPaint(), paramQQAppInterface, ViewUtils.a(200.0F));
      }
    }
    return paramQQAppInterface.getString(2131698434);
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    default: 
      return false;
    case 1: 
      ((OnlineStatusHandler)a().getBusinessHandler(BusinessHandlerFactory.ONLINE_STATUS_HANDLER)).a(null);
      return false;
    case 2: 
      localOnlineStatusHandler = (OnlineStatusHandler)a().getBusinessHandler(BusinessHandlerFactory.ONLINE_STATUS_HANDLER);
      localObject = (MusicInfo)QQMusicPlayService.a();
      int j = QQMusicPlayService.a() - QQMusicPlayService.b();
      ListenTogetherManager localListenTogetherManager = (ListenTogetherManager)a().getManager(QQManagerFactory.LISTEN_TOGETHER_MANAGER);
      if (localListenTogetherManager.a() != null)
      {
        if (localListenTogetherManager.a().f == 1)
        {
          i = 3;
      ...
      {
        localOnlineStatusHandler.a((MusicInfo)localObject, j, bool, QQMusicPlayService.a());
    ...
    OnlineStatusHandler localOnlineStatusHandler = (OnlineStatusHandler)a().getBusinessHandler(BusinessHandlerFactory.ONLINE_STATUS_HANDLER);
    Object localObject = QQPlayerService.b();
    if (paramMessage.arg1 == 1) {}
    for (boolean bool = true;; bool = false)
    {
      localOnlineStatusHandler.a((SongInfo)localObject, i, bool, QQPlayerService.d());
 ...
 * Qualified Name:     com.tencent.mobileqq.onlinestatus.music.OnlineMusicStatusManager
