...
public final class ConstellationUtilKt
{
  ...
  public static final long a(@NotNull QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface = SharedPreUtils.a((Context)BaseApplicationImpl.context, paramQQAppInterface.getCurrentAccountUin(), "key_ext_info_request_interval_second", Long.valueOf(0L));
  ...
  @NotNull
  public static final String a(@NotNull FriendsManager paramFriendsManager, @NotNull String paramString)
  {
    Intrinsics.checkParameterIsNotNull(paramFriendsManager, "$this$todayTrendFromEntity");
    Intrinsics.checkParameterIsNotNull(paramString, "uin");
    paramFriendsManager = paramFriendsManager.d(paramString).constellationTodayTrend;
    if (paramFriendsManager != null) {}
    for (;;)
    {
      if (QLog.isColorLevel()) {
        QLog.d("ConstellationUtil", 2, new Object[] { "todayTrendFromEntity: called. ", "trend: " + paramFriendsManager });
      }
  ...
  {
    Intrinsics.checkParameterIsNotNull(paramQQAppInterface, "app");
    paramQQAppInterface = SharedPreUtils.a((Context)BaseApplicationImpl.context, paramQQAppInterface.getCurrentAccountUin(), "key_today_constellation_trends_json", "");
    if (paramQQAppInterface == null) {
  ...
  public static final String a(@NotNull QQAppInterface paramQQAppInterface, @NotNull String paramString)
  {
    ...
    paramQQAppInterface = ((FriendsManager)paramQQAppInterface).d(paramString);
  ...
  {
    Intrinsics.checkParameterIsNotNull(paramQQAppInterface, "app");
    SharedPreUtils.a((Context)BaseApplicationImpl.context, paramQQAppInterface.getCurrentAccountUin(), true, "key_ext_info_request_interval_second", Integer.valueOf(paramInt));
  }
  
  public static final void a(@NotNull QQAppInterface paramQQAppInterface, long paramLong)
  {
    Intrinsics.checkParameterIsNotNull(paramQQAppInterface, "app");
    SharedPreUtils.a((Context)BaseApplicationImpl.context, paramQQAppInterface.getCurrentAccountUin(), true, "key_constellation_last_request_second", Long.valueOf(paramLong));
  }
  ...
  public static final void a(@NotNull QQAppInterface paramQQAppInterface, @Nullable String paramString)
  {
    ...
    for (;;)
    {
      SharedPreUtils.a(localContext, paramQQAppInterface, true, "key_today_constellation_trends_json", paramString);
      return;
      paramString = "";
    }
  }
  ...
  {
    Intrinsics.checkParameterIsNotNull(paramQQAppInterface, "app");
    paramQQAppInterface = SharedPreUtils.a((Context)BaseApplicationImpl.context, paramQQAppInterface.getCurrentAccountUin(), "key_constellation_last_request_second", Long.valueOf(0L));
    if (paramQQAppInterface == null) {
      throw new TypeCastException("null cannot be cast to non-null type kotlin.Long");
    }
    return ((Long)paramQQAppInterface).longValue();
  ...
  @NotNull
  public static final String b(@NotNull FriendsManager paramFriendsManager, @NotNull String paramString)
  {
    Intrinsics.checkParameterIsNotNull(paramFriendsManager, "$this$tomorrowTrendFromEntity");
    Intrinsics.checkParameterIsNotNull(paramString, "uin");
    paramFriendsManager = paramFriendsManager.d(paramString).constellationTomorrowTrend;
    if (paramFriendsManager != null) {
      return paramFriendsManager;
    }
    return "";
  ...
  public static final String b(@NotNull QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface = ((FriendsManager)localManager).d(paramQQAppInterface.getCurrentUin()).constellationIconUrl;
    if (paramQQAppInterface != null) {
  ...
  public static final String b(@NotNull QQAppInterface paramQQAppInterface, @NotNull String paramString)
  {
    Intrinsics.checkParameterIsNotNull(paramQQAppInterface, "app");
    Intrinsics.checkParameterIsNotNull(paramString, "uin");
    paramQQAppInterface = NearbyProfileUtil.c(ProfileCardUtil.a(paramQQAppInterface, paramString).constellation);
  ...
  public static final void b(@NotNull QQAppInterface paramQQAppInterface, @NotNull String paramString)
  {
    ...
    SharedPreUtils.a((Context)BaseApplicationImpl.context, paramQQAppInterface.getCurrentAccountUin(), true, "key_constellation_text_color", paramString);
  }
  ...
  public static final String c(@NotNull QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface = ((FriendsManager)localManager).d(paramQQAppInterface.getCurrentUin()).constellationBgImageUrl;
    if (paramQQAppInterface != null) {
      return paramQQAppInterface;
    }
    return "";
  ...
  {
    Intrinsics.checkParameterIsNotNull(paramQQAppInterface, "app");
    paramQQAppInterface = SharedPreUtils.a((Context)BaseApplicationImpl.context, paramQQAppInterface.getCurrentAccountUin(), "key_constellation_text_color", "");
    if (paramQQAppInterface == null) {
      throw new TypeCastException("null cannot be cast to non-null type kotlin.String");
    }
    return (String)paramQQAppInterface;
  ...
  public static final String e(@NotNull QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface = ((FriendsManager)localManager).d(paramQQAppInterface.getCurrentUin()).constellationJumpUrl;
    if (paramQQAppInterface != null) {
      return paramQQAppInterface;
    }
    return "";
