...
public final class ConstellationTrend
{
  @NotNull
  ...
  public ConstellationTrend(@NotNull String paramString, @NotNull List<String> paramList)
  {
  ...
  public boolean equals(@Nullable Object paramObject)
  {
    if (this != paramObject)
    {
      if ((paramObject instanceof ConstellationTrend))
      {
        paramObject = (ConstellationTrend)paramObject;
