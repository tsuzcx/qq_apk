  ...
  extends MSFServlet
{
  ...
  {
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApplication(), OnlineStatusWeatherServlet.class);
  ...
  private void a(oidb_0xca6.RspBody paramRspBody, Intent paramIntent, int paramInt)
  {
    ...
    if ((getAppRuntime() instanceof QQAppInterface))
    {
      ...
      localFriends = localFriendsManager.d(localQQAppInterface.getCurrentUin());
      ...
      if (!OnlineStatusUtil.c(localFriends)) {
        break label351;
      }
    }
    label351:
    for (i = 0;; i = 1)
    {
      ...
      ((OnlineStatusManager)localQQAppInterface.getManager(QQManagerFactory.ONLINE_STATUS_MANAGER)).b(paramInt, paramIntent);
      return;
    }
  }
  ...
  public void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    //   203: aload_1
    //   204: iload_3
    //   205: invokespecial 373	com/tencent/mobileqq/onlinestatus/weather/OnlineStatusWeatherServlet:a	(Ltencent/im/oidb/cmd0xca6/oidb_0xca6$RspBody;Landroid/content/Intent;I)V
    ...
    //   227: aload_2
    //   228: ldc_w 381
    //   231: invokevirtual 385	com/tencent/mobileqq/onlinestatus/weather/OnlineStatusWeatherServlet:notifyObserver	(Landroid/content/Intent;IZLandroid/os/Bundle;Ljava/lang/Class;)V
    //   234: return
    //   235: astore 5
    //   237: aconst_null
    //   238: astore_2
    ...
    //   286: aconst_null
    //   287: ldc_w 381
    //   290: invokevirtual 385	com/tencent/mobileqq/onlinestatus/weather/OnlineStatusWeatherServlet:notifyObserver	(Landroid/content/Intent;IZLandroid/os/Bundle;Ljava/lang/Class;)V
    //   293: return
    ...
    //   0	344	0	this	OnlineStatusWeatherServlet
