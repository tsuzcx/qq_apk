  ...
  implements IFTSDBRuntimeService
{
  ...
  private void init()
  {
    ...
    //   4: iconst_0
    //   5: invokestatic 174	com/tencent/mobileqq/fts/utils/FTSUtils:a	(Lmqq/app/AppRuntime;Z)V
    //   8: aload_0
    //   9: getfield 47	com/tencent/mobileqq/fts/api/impl/FTSDBRuntimeServiceImpl:isInit	Z
    //   12: ifne +837 -> 849
    //   15: invokestatic 159	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   18: ifeq +311 -> 329
    //   21: aconst_null
    //   22: astore 4
    //   24: aconst_null
    ...
    //   33: ldc 176
    //   35: aconst_null
    //   36: invokestatic 182	android/database/sqlite/SQLiteDatabase:openOrCreateDatabase	(Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase$CursorFactory;)Landroid/database/sqlite/SQLiteDatabase;
    //   39: astore_3
    //   40: aload 7
    //   42: astore 4
    //   44: aload 6
    ...
    //   49: ldc 184
    //   51: aconst_null
    //   52: invokevirtual 188	android/database/sqlite/SQLiteDatabase:rawQuery	(Ljava/lang/String;[Ljava/lang/String;)Landroid/database/Cursor;
    //   55: astore 6
    //   57: ldc 190
    //   59: astore 7
    //   61: aload 6
    ...
    //   67: astore 5
    //   69: aload 6
    //   71: invokeinterface 195 1 0
    //   76: ifeq +76 -> 152
    //   79: aload 6
    //   81: astore 4
    //   83: aload 6
    //   85: astore 5
    //   87: new 197	java/lang/StringBuilder
    //   90: dup
    //   91: invokespecial 198	java/lang/StringBuilder:<init>	()V
    //   94: astore 8
    //   96: aload 6
    //   98: astore 4
    //   100: aload 6
    ...
    //   130: invokevirtual 202	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   133: pop
    //   134: aload 6
    //   136: astore 4
    //   138: aload 6
    ...
    //   156: aload 6
    //   158: astore 5
    //   160: new 197	java/lang/StringBuilder
    //   163: dup
    //   164: invokespecial 198	java/lang/StringBuilder:<init>	()V
    //   167: astore 8
    //   169: aload 6
    //   171: astore 4
    //   173: aload 6
    ...
    //   191: astore 5
    //   193: aload 8
    //   195: invokestatic 217	com/tencent/mobileqq/utils/DeviceInfoUtil:g	()Ljava/lang/String;
    //   198: invokevirtual 202	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   201: pop
    //   202: aload 6
    //   204: astore 4
    //   206: aload 6
    ...
    //   226: aload 8
    //   228: aload 7
    //   230: invokevirtual 202	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   233: pop
    //   234: aload 6
    //   236: astore 4
    //   238: aload 6
    ...
    //   244: iconst_2
    //   245: aload 8
    //   247: invokevirtual 210	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   250: invokestatic 165	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   253: aload 6
    //   255: ifnull +10 -> 265
    //   258: aload 6
    ...
    //   297: ifnull +7 -> 304
    //   300: aload_3
    //   301: invokevirtual 223	android/database/sqlite/SQLiteDatabase:close	()V
    //   304: aload 5
    //   306: athrow
    //   307: aconst_null
    //   308: astore_3
    ...
    //   311: ifnull +10 -> 321
    //   314: aload 5
    //   316: invokeinterface 222 1 0
    //   321: aload_3
    //   322: ifnull +7 -> 329
    //   325: aload_3
    //   326: invokevirtual 223	android/database/sqlite/SQLiteDatabase:close	()V
    //   329: getstatic 228	android/os/Build$VERSION:SDK_INT	I
    //   332: bipush 18
    //   334: if_icmpge +122 -> 456
    //   337: aload_0
    //   338: getfield 71	com/tencent/mobileqq/fts/api/impl/FTSDBRuntimeServiceImpl:mApp	Lmqq/app/AppRuntime;
    //   341: invokestatic 231	com/tencent/mobileqq/fts/utils/FTSUtils:c	(Lmqq/app/AppRuntime;)I
    //   344: istore_2
    //   345: aload_0
    ...
    //   350: iconst_1
    //   351: iadd
    //   352: invokestatic 235	com/tencent/mobileqq/fts/utils/FTSUtils:b	(Lmqq/app/AppRuntime;I)V
    //   355: new 197	java/lang/StringBuilder
    //   358: dup
    //   359: invokespecial 198	java/lang/StringBuilder:<init>	()V
    //   362: astore_3
    //   363: aload_3
    //   364: ldc 237
    ...
    //   370: aload_3
    //   371: iload_2
    //   372: invokevirtual 240	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   375: pop
    //   376: ldc 15
    //   378: iconst_1
    //   379: aload_3
    //   380: invokevirtual 210	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   383: invokestatic 165	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   386: iload_2
    //   387: iconst_5
    ...
    //   398: new 197	java/lang/StringBuilder
    //   401: dup
    //   402: invokespecial 198	java/lang/StringBuilder:<init>	()V
    //   405: astore_3
    //   406: aload_3
    //   407: ldc 242
    //   409: invokevirtual 202	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   412: pop
    //   413: aload_3
    //   414: iload_2
    //   415: invokevirtual 240	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   418: pop
    //   419: ldc 15
    //   421: iconst_1
    //   422: aload_3
    //   423: invokevirtual 210	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   426: invokestatic 245	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   429: iconst_0
    //   430: putstatic 247	com/tencent/mobileqq/fts/api/impl/FTSDBRuntimeServiceImpl:ENABLE	Z
    //   433: return
    //   434: iload_2
    //   435: istore_1
    //   436: iload_2
    ...
    //   447: iconst_0
    //   448: invokestatic 235	com/tencent/mobileqq/fts/utils/FTSUtils:b	(Lmqq/app/AppRuntime;I)V
    //   451: iload_2
    //   452: istore_1
    //   453: goto +5 -> 458
    //   456: iconst_0
    ...
    //   464: ifnull +7 -> 471
    //   467: aload_3
    //   468: invokevirtual 154	com/tencent/mobileqq/fts/FTSDatabase:e	()V
    //   471: aload_0
    ...
    //   477: ifnull +7 -> 484
    //   480: aload_3
    //   481: invokevirtual 147	com/tencent/mobileqq/persistence/fts/FTSDatatbase:c	()V
    //   484: ldc 15
    //   486: iconst_1
    //   487: ldc 249
    //   489: invokestatic 165	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   492: aload_0
    ...
    //   501: invokespecial 251	com/tencent/mobileqq/persistence/fts/FTSDatatbase:<init>	(Lmqq/app/AppRuntime;)V
    ...
    //   507: new 253	com/tencent/mobileqq/fts/v2/logger/QLogger
    //   510: dup
    //   511: invokespecial 254	com/tencent/mobileqq/fts/v2/logger/QLogger:<init>	()V
    //   514: invokestatic 257	com/tencent/mobileqq/fts/FTSDatabase:a	(Lcom/tencent/mobileqq/fts/v2/logger/ILogger;)V
    //   517: aload_0
    //   518: new 259	com/tencent/mobileqq/fts/v2/QFTSDatabase
    //   521: dup
    //   522: invokespecial 260	com/tencent/mobileqq/fts/v2/QFTSDatabase:<init>	()V
    ...
    //   532: invokevirtual 262	com/tencent/mobileqq/persistence/fts/FTSDatatbase:b	()V
    //   535: new 197	java/lang/StringBuilder
    //   538: dup
    //   539: invokespecial 198	java/lang/StringBuilder:<init>	()V
    //   542: astore_3
    //   543: aload_3
    //   544: aload_0
    //   545: getfield 71	com/tencent/mobileqq/fts/api/impl/FTSDBRuntimeServiceImpl:mApp	Lmqq/app/AppRuntime;
    //   548: invokevirtual 268	mqq/app/AppRuntime:getApplication	()Lmqq/app/MobileQQ;
    //   551: invokevirtual 274	mqq/app/MobileQQ:getFilesDir	()Ljava/io/File;
    //   554: invokevirtual 279	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   557: ldc_w 281
    //   560: ldc_w 283
    //   563: invokevirtual 289	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   566: invokevirtual 202	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   569: pop
    //   570: aload_3
    //   571: getstatic 292	java/io/File:separator	Ljava/lang/String;
    ...
    //   583: invokevirtual 295	mqq/app/AppRuntime:getCurrentAccountUin	()Ljava/lang/String;
    //   586: invokevirtual 202	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   589: pop
    //   590: aload_3
    //   591: ldc_w 297
    ...
    //   597: pop
    //   598: aload_3
    //   599: invokevirtual 210	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   602: astore_3
    //   603: aload_0
    ...
    //   607: aload_3
    //   608: invokevirtual 300	com/tencent/mobileqq/fts/FTSDatabase:a	(Ljava/lang/String;)V
    //   611: aload_0
    //   612: getfield 71	com/tencent/mobileqq/fts/api/impl/FTSDBRuntimeServiceImpl:mApp	Lmqq/app/AppRuntime;
    //   615: iconst_1
    //   616: invokestatic 302	com/tencent/mobileqq/fts/utils/FTSUtils:b	(Lmqq/app/AppRuntime;Z)V
    //   619: getstatic 228	android/os/Build$VERSION:SDK_INT	I
    //   622: bipush 18
    //   624: if_icmpge +43 -> 667
    //   627: new 197	java/lang/StringBuilder
    //   630: dup
    //   631: invokespecial 198	java/lang/StringBuilder:<init>	()V
    //   634: astore_3
    //   635: aload_3
    //   636: ldc_w 304
    //   639: invokevirtual 202	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   642: pop
    //   643: aload_3
    //   644: iload_1
    //   645: invokevirtual 240	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   648: pop
    //   649: ldc 15
    //   651: iconst_1
    //   652: aload_3
    //   653: invokevirtual 210	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   656: invokestatic 245	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   659: aload_0
    //   660: getfield 71	com/tencent/mobileqq/fts/api/impl/FTSDBRuntimeServiceImpl:mApp	Lmqq/app/AppRuntime;
    //   663: iconst_0
    //   664: invokestatic 235	com/tencent/mobileqq/fts/utils/FTSUtils:b	(Lmqq/app/AppRuntime;I)V
    //   667: aload_0
    ...
    //   723: invokestatic 159	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   726: ifeq +45 -> 771
    //   729: ldc 15
    //   731: iconst_2
    //   732: iconst_4
    ...
    //   761: invokevirtual 311	java/util/concurrent/ConcurrentHashMap:size	()I
    //   764: invokestatic 131	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   767: aastore
    //   768: invokestatic 314	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   771: return
    //   772: aload 4
    //   774: aload_0
    ...
    //   782: invokevirtual 317	com/tencent/mobileqq/fts/operator/FTSIndexOperator:a	(Lcom/tencent/mobileqq/persistence/fts/FTSDatatbase;Lcom/tencent/mobileqq/fts/FTSDatabase;)Z
    //   785: ifne -105 -> 680
    //   788: invokestatic 159	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   791: ifeq +30 -> 821
    //   794: ldc 15
    //   796: iconst_2
    //   797: iconst_2
    ...
    //   808: iconst_1
    //   809: aload 4
    //   811: invokevirtual 323	java/lang/Object:getClass	()Ljava/lang/Class;
    //   814: invokevirtual 328	java/lang/Class:getSimpleName	()Ljava/lang/String;
    //   817: aastore
    //   818: invokestatic 314	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   821: return
    //   822: aload_0
    //   823: iconst_1
    ...
    //   827: return
    //   828: astore_3
    //   829: invokestatic 159	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   832: ifeq +13 -> 845
    //   835: ldc 15
    //   837: iconst_2
    //   838: ldc_w 330
    //   841: aload_3
    //   842: invokestatic 333	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   845: iconst_0
    //   846: putstatic 247	com/tencent/mobileqq/fts/api/impl/FTSDBRuntimeServiceImpl:ENABLE	Z
    //   849: return
    //   850: astore_3
    //   851: goto -544 -> 307
    //   854: astore 4
