  ...
  extends Tokenizer
{
  ...
  private final Token b()
  {
    if (this.d > 0)
    {
      ...
      for (;;)
      {
        return new Token(new String(this.jdField_a_of_type_ArrayOfChar, 0, this.d), this.e, this.e + this.d, str1);
        str1 = "num";
        continue;
        str1 = "en";
        continue;
 ...
 * Qualified Name:     com.tencent.mobileqq.fts.tokenizer.cn.ChineseTokenizer
