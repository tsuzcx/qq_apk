  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      FTSTroopOperator.b(this.this$0);
      if (FTSTroopOperator.c(this.this$0) >= 5)
      {
        ...
        this.this$0.d.postDelayed(this, 5000L);
      }
    }
    else
    {
      ...
      ArrayList localArrayList = FTSTroopOperator.d(this.this$0).getUiTroopList();
      ...
      ((ITroopManagerService)this.this$0.a.getRuntimeService(ITroopManagerService.class, "")).getTroopsMemberList();
      localObject = this.this$0.a.getApp().getSharedPreferences(this.this$0.a.getCurrentAccountUin(), 0);
      ...
      if (i == 0)
      {
        ...
        if (FTSTroopOperator.e(this.this$0) == null) {
          FTSTroopOperator.a(this.this$0, new FTSTroopOperator.1.1(this));
        }
        this.this$0.d.postDelayed(FTSTroopOperator.e(this.this$0), 86400000L);
      }
      else
      {
        if (i == 1) {
        ...
        if (FTSTroopOperator.e(this.this$0) != null)
        {
          this.this$0.d.removeCallbacks(FTSTroopOperator.e(this.this$0));
          FTSTroopOperator.a(this.this$0, null);
        }
      }
      this.this$0.d.obtainMessage(1, this.this$0).sendToTarget();
      localObject = (IFTSDBRuntimeService)this.this$0.a.getRuntimeService(IFTSDBRuntimeService.class, "");
      this.this$0.d.obtainMessage(1, ((IFTSDBRuntimeService)localObject).getOperator(4)).sendToTarget();
    }
  }
}
