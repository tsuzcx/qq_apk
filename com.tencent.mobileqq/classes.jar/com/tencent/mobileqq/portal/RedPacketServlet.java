  ...
  extends mmi
{
  ...
  {
    if ((paramInt6 < 2) || (!badq.g(BaseApplicationImpl.sApplication))) {
      return;
    }
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (bool2)
    {
      Object localObject1 = bakc.b(paramFromServiceMsg.getWupBuffer());
      switch (m)
      {
      case 3: 
      case 5: 
        ...
        try
        {
          ...
          else
          {
            ...
            if (i == -1)
            {
              ...
              localObject7 = attn.a((byte[])localObject3);
        ...
        try
        {
          for (;;)
          {
            ...
            if (localObject3 != null)
            {
              ...
              ((JSONObject)localObject7).put("key", attn.a((String)localObject6, ((PackRanking.RankingInfo)localObject3).uin.get()));
              ...
              if (((PackRanking.RankingInfo)localObject3).elems.has())
              {
                ...
                if (((List)localObject7).size() > 0)
                {
                  ...
                  while (((Iterator)localObject7).hasNext())
                  {
                    ...
                    localJSONObject.put("key", attn.a((String)localObject6, ((PackRanking.RankingElem)localObject8).uin.get()));
                    localJSONObject.put("ranking", i);
                    localJSONObject.put("count", ((PackRanking.RankingElem)localObject8).count.get());
                    localJSONObject.put("nick", babh.j((QQAppInterface)localObject4, String.valueOf(((PackRanking.RankingElem)localObject8).uin.get())));
            ...
            if (localObject2 != null)
            {
              ...
              ((JSONObject)localObject3).put("key", attn.a((String)localObject6, ((PackRanking.RankingInfo)localObject2).uin.get()));
              ...
              if (((PackRanking.RankingInfo)localObject2).elems.has())
              {
                ...
                if (((List)localObject3).size() > 0)
                {
                  ...
                  while (((Iterator)localObject3).hasNext())
                  {
                    ...
                    ((JSONObject)localObject8).put("key", attn.a((String)localObject6, ((PackRanking.RankingElem)localObject7).uin.get()));
                    ((JSONObject)localObject8).put("ranking", i);
                    ((JSONObject)localObject8).put("count", ((PackRanking.RankingElem)localObject7).count.get());
                    ((JSONObject)localObject8).put("nick", babh.j((QQAppInterface)localObject4, String.valueOf(((PackRanking.RankingElem)localObject7).uin.get())));
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        do
        {
          do
          {
            do
            {
              ...
              ((PackServer.PkgReq)localObject2).net_type.set(badq.a(BaseApplicationImpl.sApplication));
              ...
              localObject1 = bakc.a(((Unisso.UniSsoServerReq)localObject1).toByteArray());
              ...
              localObject1 = bakc.a(((ConfigurationService.ReqGetConfigByPage)localObject1).toByteArray());
              ...
              localObject1 = bakc.a(((ConfigurationService.ReqReportConfig)localObject1).toByteArray());
              paramIntent.putExtra("k_retry", 2);
              break;
              localObject1 = new Unisso.UniSsoServerReq();
        ...
        localObject1 = bakc.a(((Unisso.UniSsoServerReq)localObject2).toByteArray());
      ...
      localObject1 = bakc.a(((subcmd0x501.ReqBody)localObject2).toByteArray());
