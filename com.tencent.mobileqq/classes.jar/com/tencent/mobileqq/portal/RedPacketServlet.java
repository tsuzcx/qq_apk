  ...
  extends nta
{
  ...
  {
    if ((paramInt6 < 2) || (!NetworkUtil.isNetworkAvailable(BaseApplicationImpl.sApplication))) {
      return;
    }
  ...
  {
    int m = paramIntent.getIntExtra("k_cmd", -1);
    if (QLog.isColorLevel()) {
      QLog.d("PortalManager.Servlet", 2, "onReceive, cmd = " + m);
    }
    int n = paramIntent.getIntExtra("k_retry", 0);
        ...
        for (;;)
        {
          ...
          try
          {
            ...
            try
            {
              ...
              {
                localObject3 = (PortalManager)((QQAppInterface)getAppRuntime()).getManager(QQManagerFactory.MGR_PORTAL);
          ...
          break label2594;
          localObject4 = (PortalManager)((QQAppInterface)getAppRuntime()).getManager(QQManagerFactory.MGR_PORTAL);
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          else
          {
            ...
            i1 = paramIntent.getIntExtra("k_offset", 0);
            if (!QLog.isColorLevel()) {
              continue;
            }
            QLog.d("PortalManager.Servlet", 1, "onReceive, " + i1 + ", " + i + ", " + j);
            continue;
            ((PortalManager)localObject4).c();
            paramFromServiceMsg.putInt("k_code", 3);
            ...
            if (i == -1)
            {
              ...
              localObject7 = aznv.a((byte[])localObject3);
              ...
              if (i != 0) {
                if (TextUtils.equals((CharSequence)localObject7, (CharSequence)localObject2))
                {
                  ...
                  if (localObject2 == null)
                  {
                    a(1004, j, ((ConfigurationService.PageRespInfo)((ConfigurationService.RespGetConfigByPage)localObject5).page_info.get()).task_id.get(), 1, 4, 2);
                    bool1 = bool2;
                  }
                  else
                  {
                    ...
                    if (localObject2 == null)
                    {
                      a(1004, j, ((ConfigurationService.PageRespInfo)((ConfigurationService.RespGetConfigByPage)localObject5).page_info.get()).task_id.get(), 1, 5, n);
                      bool1 = false;
                    }
                    else
                    {
                      a(1004, j, ((ConfigurationService.PageRespInfo)((ConfigurationService.RespGetConfigByPage)localObject5).page_info.get()).task_id.get(), 1, 0, 2);
                ...
                {
                  bool1 = false;
                  a(1004, j, ((ConfigurationService.PageRespInfo)((ConfigurationService.RespGetConfigByPage)localObject5).page_info.get()).task_id.get(), 1, 6, n);
                }
              }
            }
            else
        ...
        try
        {
          for (;;)
          {
            ...
            if (localObject3 != null)
            {
              ...
              ((JSONObject)localObject7).put("key", aznv.a((String)localObject6, ((PackRanking.RankingInfo)localObject3).uin.get()));
              ...
              if (((PackRanking.RankingInfo)localObject3).elems.has())
              {
                ...
                if (((List)localObject7).size() > 0)
                {
                  ...
                  while (((Iterator)localObject7).hasNext())
                  {
                    ...
                    localJSONObject.put("key", aznv.a((String)localObject6, ((PackRanking.RankingElem)localObject8).uin.get()));
                    localJSONObject.put("ranking", i);
                    localJSONObject.put("count", ((PackRanking.RankingElem)localObject8).count.get());
                    localJSONObject.put("nick", ContactUtils.getFriendDisplayName((QQAppInterface)localObject4, String.valueOf(((PackRanking.RankingElem)localObject8).uin.get())));
            ...
            if (localObject2 != null)
            {
              ...
              ((JSONObject)localObject3).put("key", aznv.a((String)localObject6, ((PackRanking.RankingInfo)localObject2).uin.get()));
              ...
              if (((PackRanking.RankingInfo)localObject2).elems.has())
              {
                ...
                if (((List)localObject3).size() > 0)
                {
                  ...
                  while (((Iterator)localObject3).hasNext())
                  {
                    ...
                    ((JSONObject)localObject8).put("key", aznv.a((String)localObject6, ((PackRanking.RankingElem)localObject7).uin.get()));
                    ((JSONObject)localObject8).put("ranking", i);
                    ((JSONObject)localObject8).put("count", ((PackRanking.RankingElem)localObject7).count.get());
                    ((JSONObject)localObject8).put("nick", ContactUtils.getFriendDisplayName((QQAppInterface)localObject4, String.valueOf(((PackRanking.RankingElem)localObject7).uin.get())));
            ...
            try
            {
              ...
              paramFromServiceMsg = (PortalManager)((QQAppInterface)getAppRuntime()).getManager(QQManagerFactory.MGR_PORTAL);
          ...
          notifyObserver(paramIntent, m, bool1, (Bundle)localObject2, PortalManager.class);
          if (m != 10) {
            break label182;
          }
          return;
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        do
        {
          do
          {
            do
            {
              ...
              ((PackServer.PkgReq)localObject2).net_type.set(NetworkUtil.getSystemNetwork(BaseApplicationImpl.sApplication));
              ...
              localObject1 = bhjl.a(((Unisso.UniSsoServerReq)localObject1).toByteArray());
              ...
              ((ConfigurationService.Screen)localObject3).width.set((int)DeviceInfoUtil.getDispalyWidth());
              ((ConfigurationService.Screen)localObject3).height.set((int)DeviceInfoUtil.getDispalyHeight());
              ((ConfigurationService.Screen)localObject3).dpi.set(DeviceInfoUtil.getDispalyDpi());
              ((ConfigurationService.Screen)localObject3).multi_touch.set(DeviceInfoUtil.isSupportMultiTouch());
              ...
              localObject1 = bhjl.a(((ConfigurationService.ReqGetConfigByPage)localObject1).toByteArray());
              ...
              localObject1 = bhjl.a(((ConfigurationService.ReqReportConfig)localObject1).toByteArray());
              paramIntent.putExtra("k_retry", 2);
              break;
              localObject1 = new Unisso.UniSsoServerReq();
        ...
        localObject1 = bhjl.a(((Unisso.UniSsoServerReq)localObject2).toByteArray());
      ...
      localObject1 = bhjl.a(((subcmd0x501.ReqBody)localObject2).toByteArray());
