    ...
    if (i < this.jdField_a_of_type_AndroidSupportV4UtilSparseArrayCompat.size())
    {
      ...
      while (((Iterator)localObject3).hasNext())
      {
        ...
        for (j = 1000;; j = 60000)
        {
          ...
          if (((bjmo)localObject2).a(l) == null) {
            break label171;
          }
          ((bjmo)localObject2).a(l, Integer.valueOf(((Integer)((bjmo)localObject2).a(l)).intValue() + 1));
          break;
        }
        ((bjmo)localObject2).a(l, Integer.valueOf(1));
      }
      k = 0;
      j = 0;
      while (k < ((bjmo)localObject2).a())
      {
        localObject3 = new RedPacketServlet.BrashReportItem();
        l = ((bjmo)localObject2).a(k);
        ((RedPacketServlet.BrashReportItem)localObject3).time = l;
        ((RedPacketServlet.BrashReportItem)localObject3).count = ((int)((Integer)((bjmo)localObject2).a(l)).intValue());
