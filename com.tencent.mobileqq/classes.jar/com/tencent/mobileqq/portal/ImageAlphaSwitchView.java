  ...
  extends View
{
  ...
  public ImageAlphaSwitchView(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Bbky = null;
  ...
  private void a()
  {
    bbky localbbky = new bbky(Float.valueOf(0.0F), Float.valueOf(255.0F), new aurc(this));
      ...
      for (;;)
      {
        ...
        for (k = (this.jdField_b_of_type_Int - j) / 2;; k = 0)
        {
          ...
          for (;;)
          {
            ...
            if (this.jdField_a_of_type_Bbky != null) {
              bool = this.jdField_a_of_type_Bbky.getTransformation(AnimationUtils.currentAnimationTimeMillis(), this.jdField_a_of_type_AndroidViewAnimationTransformation);
            }
            if (bool) {
              invalidate();
            }
