  ...
  public void a(ValueAnimation<Float> paramValueAnimation, float paramFloat, Float paramFloat1, Transformation paramTransformation)
  {
    if (this.a.jdField_a_of_type_Boolean)
    {
      if (paramFloat1.floatValue() < 180.0F)
      {
        ...
        this.a.b = (paramFloat1.floatValue() * 0.02F / 180.0F + 1.0F);
        return;
      }
      if (paramFloat1.floatValue() < 360.0F)
      {
        paramValueAnimation = Float.valueOf(paramFloat1.floatValue() - 180.0F);
        this.a.jdField_a_of_type_Float = (paramValueAnimation.floatValue() * 0.03F / 180.0F + 0.99F);
      ...
      if (paramFloat1.floatValue() < 540.0F)
      {
        ...
        this.a.jdField_a_of_type_Float = (1.02F - paramValueAnimation.floatValue() * 0.03F / 180.0F);
      ...
      this.a.jdField_a_of_type_Float = (paramValueAnimation.floatValue() * 0.01F / 180.0F + 0.99F);
      this.a.b = (1.01F - paramValueAnimation.floatValue() * 0.01F / 180.0F);
      return;
    }
    if (paramFloat1.floatValue() < 120.0F)
    {
      this.a.jdField_a_of_type_Float = (1.0F - paramFloat1.floatValue() * 0.02F / 120.0F);
    ...
    if (paramFloat1.floatValue() < 380.0F)
    {
      ...
      this.a.jdField_a_of_type_Float = (paramValueAnimation.floatValue() * 0.04F / 260.0F + 0.98F);
    ...
    this.a.jdField_a_of_type_Float = (1.02F - paramValueAnimation.floatValue() * 0.02F / 120.0F);
