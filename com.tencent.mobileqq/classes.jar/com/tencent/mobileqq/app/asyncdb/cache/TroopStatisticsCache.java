  ...
  extends FullCache
{
  ...
  public TroopStatisticsCache(com.tencent.common.app.AppInterface paramAppInterface, com.tencent.mobileqq.app.asyncdb.DBDelayManager paramDBDelayManager)
  {
    ...
    //   19: lstore 4
    //   21: lload 4
    //   23: getstatic 37	com/tencent/mobileqq/pic/PreDownloadStrategyBeta:a	Ljava/lang/String;
    //   26: lconst_0
    //   27: invokestatic 42	com/tencent/mobileqq/pic/PicPreDownloadUtils:a	(Ljava/lang/String;J)J
    //   30: lsub
    //   31: ldc2_w 43
    //   34: lcmp
    //   35: ifle +42 -> 77
    //   38: getstatic 37	com/tencent/mobileqq/pic/PreDownloadStrategyBeta:a	Ljava/lang/String;
    //   41: lload 4
    //   43: invokestatic 47	com/tencent/mobileqq/pic/PicPreDownloadUtils:a	(Ljava/lang/String;J)V
    //   46: aload_1
    //   47: ldc 10
    //   49: invokevirtual 53	com/tencent/mobileqq/persistence/EntityManager:drop	(Ljava/lang/Class;)Z
    //   52: pop
    //   53: aload_0
    //   54: getfield 57	com/tencent/mobileqq/app/asyncdb/cache/TroopStatisticsCache:cacheMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   57: invokevirtual 63	java/util/concurrent/ConcurrentHashMap:clear	()V
    //   60: invokestatic 69	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   63: ifeq +162 -> 225
    //   66: ldc 71
    //   68: iconst_2
    //   69: ldc 73
    //   71: invokestatic 77	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   74: goto +151 -> 225
    //   77: aload_1
    //   78: ldc 10
    //   80: invokevirtual 81	com/tencent/mobileqq/persistence/EntityManager:query	(Ljava/lang/Class;)Ljava/util/List;
    //   83: astore_2
    //   84: aload_2
    //   85: ifnull +59 -> 144
    //   88: aload_0
    //   89: getfield 57	com/tencent/mobileqq/app/asyncdb/cache/TroopStatisticsCache:cacheMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   92: invokevirtual 63	java/util/concurrent/ConcurrentHashMap:clear	()V
    //   95: aload_2
    ...
    //   123: astore 7
    //   125: aload_0
    //   126: getfield 57	com/tencent/mobileqq/app/asyncdb/cache/TroopStatisticsCache:cacheMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   129: aload_0
    //   130: aload 7
    //   132: invokevirtual 100	com/tencent/mobileqq/app/asyncdb/cache/TroopStatisticsCache:getKey	(Lcom/tencent/mobileqq/persistence/Entity;)Ljava/lang/String;
    //   135: aload 7
    //   137: invokevirtual 104	java/util/concurrent/ConcurrentHashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   140: pop
    //   141: goto -38 -> 103
    //   144: invokestatic 69	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   147: ifeq +78 -> 225
    //   150: new 106	java/lang/StringBuilder
    //   153: dup
    //   154: invokespecial 108	java/lang/StringBuilder:<init>	()V
    //   157: astore 6
    //   159: aload 6
    //   161: ldc 110
    ...
    //   198: invokestatic 77	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   201: goto +24 -> 225
    //   204: astore_2
    //   205: goto +25 -> 230
    //   208: astore_2
    ...
    //   222: invokestatic 131	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   225: aload_1
    //   226: invokevirtual 134	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   229: return
    //   230: aload_1
    //   231: invokevirtual 134	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   234: goto +5 -> 239
    //   237: aload_2
    //   238: athrow
    //   239: goto -2 -> 237
