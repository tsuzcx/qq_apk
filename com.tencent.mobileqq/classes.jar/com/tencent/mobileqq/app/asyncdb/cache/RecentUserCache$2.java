    ...
    for (;;)
    {
      synchronized (RecentUserCache.a(this.this$0))
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          if ((localatmo == null) || (!ajed.D.equals(((RecentUser)localatmo).uin))) {
            break label381;
          }
          localObject1 = (RecentUser)localatmo;
          break label381;
        }
      }
      try
