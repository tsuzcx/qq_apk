...
public class RecentUserCache$5
  implements Runnable
{
  public RecentUserCache$5(aolh paramaolh, String paramString, RecentUser paramRecentUser, long paramLong) {}
  
  public void run()
  {
    Object localObject3 = alni.a().a(this.jdField_a_of_type_JavaLangString);
    Object localObject1;
    if (localObject3 == null)
    {
      ...
      localObject3 = almc.a(this.jdField_a_of_type_ComTencentMobileqqDataRecentUser, (QQAppInterface)this.this$0.app, ((QQAppInterface)this.this$0.app).getApp());
      localObject1 = localObject3;
      if (localObject3 != null)
      {
        alni.a().a((RecentBaseData)localObject3, this.jdField_a_of_type_JavaLangString);
        localObject1 = localObject3;
      }
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        catch (Throwable localThrowable2)
        {
          ...
          alok.a(((QQAppInterface)this.this$0.app).getApp(), false, localThrowable2);
          continue;
        }
        aolh.k(this.this$0).put(this.jdField_a_of_type_JavaLangString, Long.valueOf(this.jdField_a_of_type_Long));
        if (QLog.isColorLevel()) {
        ...
        {
          bdkh.a(localConcurrentModificationException, "Multi Recent Handle Report");
          Object localObject2 = localObject3;
        }
        catch (Throwable localThrowable1)
        {
          alok.a(((QQAppInterface)this.this$0.app).getApp(), false, localThrowable1);
