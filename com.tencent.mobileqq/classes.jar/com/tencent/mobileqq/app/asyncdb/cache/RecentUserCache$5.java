  ...
  implements Runnable
{
  ...
  public void run()
  {
    Object localObject2 = ahay.a().a(this.jdField_a_of_type_JavaLangString);
    Object localObject1;
    if (localObject2 == null)
    {
      ...
      localObject2 = agzt.a(this.jdField_a_of_type_ComTencentMobileqqDataRecentUser, RecentUserCache.e(this.this$0), RecentUserCache.f(this.this$0).getApp());
      localObject1 = localObject2;
      if (localObject2 != null)
      {
        ahay.a().a((RecentBaseData)localObject2, this.jdField_a_of_type_JavaLangString);
        localObject1 = localObject2;
      }
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        catch (Throwable localThrowable2)
        {
          ...
          ahca.a(RecentUserCache.j(this.this$0).getApp(), false, localThrowable2);
          continue;
        }
        ...
        {
          ahca.a(RecentUserCache.i(this.this$0).getApp(), false, localThrowable1);
