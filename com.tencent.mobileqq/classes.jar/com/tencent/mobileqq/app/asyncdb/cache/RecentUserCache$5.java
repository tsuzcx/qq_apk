  ...
  implements Runnable
{
  ...
  public void run()
  {
    Object localObject2 = ajjj.a().a(this.jdField_a_of_type_JavaLangString);
    Object localObject1;
    if (localObject2 == null)
    {
      ...
      localObject2 = ajie.a(this.jdField_a_of_type_ComTencentMobileqqDataRecentUser, RecentUserCache.e(this.this$0), RecentUserCache.f(this.this$0).getApp());
      localObject1 = localObject2;
      if (localObject2 != null)
      {
        ajjj.a().a((RecentBaseData)localObject2, this.jdField_a_of_type_JavaLangString);
        localObject1 = localObject2;
      }
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        catch (Throwable localThrowable2)
        {
          ...
          ajkl.a(RecentUserCache.j(this.this$0).getApp(), false, localThrowable2);
          continue;
        }
        ...
        {
          ajkl.a(RecentUserCache.i(this.this$0).getApp(), false, localThrowable1);
