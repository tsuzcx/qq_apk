...
public class ProcReporter
{
  ...
  CopyOnWriteArraySet jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArraySet = new CopyOnWriteArraySet();
  private int b;
  ...
  private ProcReporter()
  {
    ...
    for (;;)
    {
      ...
      if ((Math.abs(l2 - l1) > 86400000L) && (this.b > 2))
      {
        ...
        StatisticCollector.a(BaseApplicationImpl.getApplication()).a(null, "ProcReporter", true, 0L, this.b, (HashMap)localObject2, null);
        this.b = 0;
  ...
  public void a(ArrayList paramArrayList)
  {
    ...
    while (paramArrayList.hasNext())
    {
      ...
      StatisticCollector.a(BaseApplicationImpl.getApplication()).a(null, "ProcKillFailed", true, 0L, 0L, localHashMap, null);
 ...
 * Qualified Name:     com.tencent.mobileqq.app.memory.ProcReporter
