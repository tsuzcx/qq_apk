...
public class QLogReporter$1
  implements Runnable
{
  public QLogReporter$1(amkg paramamkg, SharedPreferences paramSharedPreferences, long paramLong) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject5 = amkg.a.format(((Calendar)localObject1).getTime());
        ((Calendar)localObject1).setTimeInMillis(l - 86400000L);
        localObject1 = amkg.a.format(((Calendar)localObject1).getTime());
        i = 0;
    ...
    for (;;)
    {
      if (j < m)
      {
        ...
        azri.a(BaseApplicationImpl.getContext()).a("", "YesterdayLogSizeCollection", true, 0L, 0L, (HashMap)localObject2, "");
