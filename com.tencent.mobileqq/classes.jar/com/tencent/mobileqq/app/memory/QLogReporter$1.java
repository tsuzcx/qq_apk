...
public class QLogReporter$1
  implements Runnable
{
  public QLogReporter$1(akod paramakod, SharedPreferences paramSharedPreferences, long paramLong) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject5 = akod.a.format(((Calendar)localObject1).getTime());
        ((Calendar)localObject1).setTimeInMillis(l - 86400000L);
        localObject1 = akod.a.format(((Calendar)localObject1).getTime());
        i = 0;
    ...
    for (;;)
    {
      if (j < m)
      {
        ...
        axrn.a(BaseApplicationImpl.getContext()).a("", "YesterdayLogSizeCollection", true, 0L, 0L, (HashMap)localObject2, "");
