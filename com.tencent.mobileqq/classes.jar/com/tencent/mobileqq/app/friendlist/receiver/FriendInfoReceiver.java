  ...
  extends BaseHandlerReceiver
{
  ...
  private void a(FromServiceMsg paramFromServiceMsg, CheckUpdateResp paramCheckUpdateResp)
  {
    ...
    if ((FTSDBManager.a) && (SQLiteFTSUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))) {
      if (!SearchConfigUtils.b()) {
        break label161;
      }
    }
    label161:
    ...
    SQLiteFTSUtils.e(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false);
  }
  ...
  private void f(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (j == 0)
    {
      ...
      paramFromServiceMsg = (PhoneContactManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.CONTACT_MANAGER);
      if (paramFromServiceMsg != null) {
    ...
    for (;;)
    {
      ...
      {
        a(120, bool, new Object[] { Integer.valueOf(i), paramToServiceMsg });
        return;
          ...
          if (k == -1)
          {
            ...
            if (i < j)
            {
              ...
              if (QLog.isColorLevel())
              {
                ...
                paramObject.append(MessageRecordUtil.a((String)localObject));
              }
  ...
  private void h(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if ((l == 1L) && (paramFromServiceMsg.result == 0)) {
        ((PhoneContactManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.CONTACT_MANAGER)).a(paramToServiceMsg, paramFromServiceMsg);
      }
    }
  }
