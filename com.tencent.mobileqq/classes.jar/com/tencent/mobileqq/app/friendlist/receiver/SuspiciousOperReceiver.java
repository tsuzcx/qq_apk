  ...
  extends BaseHandlerReceiver
{
  ...
  private void a(ToServiceMsg paramToServiceMsg, oidb_cmd0xd69.RspBody paramRspBody, int paramInt, StringBuilder paramStringBuilder, NewFriendManager paramNewFriendManager)
  {
    ...
    if (paramRspBody.msg_get_list_body.has()) {
      if (paramRspBody.msg_get_list_body.bytes_cookies.has())
      {
        ...
        if (localGetListRspBody.rpt_msg_list.has())
        {
          ...
          bool = true;
          paramNewFriendManager.a(localArrayList, bool);
        }
      }
    }
    for (paramRspBody = paramToServiceMsg;; paramRspBody = null)
    {
      paramNewFriendManager = paramStringBuilder.append("CMD_GET_LIST unread=").append("|");
      if (localArrayList != null)
      {
        paramToServiceMsg = Integer.valueOf(localArrayList.size());
        label180:
        paramNewFriendManager.append(paramToServiceMsg);
      ...
      for (paramToServiceMsg = " has cookie";; paramToServiceMsg = " no cookie")
      {
        ...
        a(124, true, new Object[] { Integer.valueOf(paramInt), localArrayList, paramRspBody, localObject });
        return;
        bool = false;
        break;
  ...
  public void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (k == 0)
    {
      paramObject = (NewFriendManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.NEW_FRIEND_MANAGER);
      if (m == 2) {
    ...
    for (int i = ((oidb_cmd0xd69.GetUnreadNumRspBody)localRspBody.msg_get_unread_num_body.get()).doubt_unread_num.get();; i = 0)
    {
      ...
      paramObject.b(i);
      a(123, true, new Object[] { Integer.valueOf(k), Integer.valueOf(i) });
      for (;;)
      {
        ...
        else
        {
          ...
          if (m == 3)
          {
            ...
            paramObject.a(l);
            a(125, true, new Object[] { Integer.valueOf(k), Long.valueOf(l) });
          }
          else if (m == 4)
          {
            if (QLog.isColorLevel()) {
            ...
            paramObject.l();
            a(126, true, new Object[] { Integer.valueOf(k) });
          }
          else if (m == 5)
          {
            ...
            if (m == 2)
            {
              ...
              a(123, false, new Object[] { Integer.valueOf(k), Integer.valueOf(0) });
            }
            else if (m == 1)
            {
              paramFromServiceMsg.append("CMD_GET_LIST failed");
              a(124, false, new Object[] { Integer.valueOf(k), null, null, paramToServiceMsg.getAttribute("exactData") });
            }
            else if (m == 3)
            {
              l = ((Long)paramToServiceMsg.getAttribute("uin", Long.valueOf(0L))).longValue();
              paramFromServiceMsg.append("CMD_DELETE failed ").append(l);
              a(125, false, new Object[] { Integer.valueOf(k), Long.valueOf(l) });
            }
            else if (m == 4)
            {
              paramFromServiceMsg.append("CMD_CLEAR failed");
              a(126, false, new Object[] { Integer.valueOf(k) });
            }
            else if (m == 5)
            {
  ...
  public void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      ...
      ((NewFriendManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.NEW_FRIEND_MANAGER)).a(l);
      a(128, true, new Object[] { Integer.valueOf(i), Long.valueOf(l) });
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.i("FriendListHandler.BaseHandlerReceiver", 2, "handleAgreeSuspiciousMsg failed result:" + i);
    }
    a(128, false, new Object[] { Integer.valueOf(i), Long.valueOf(l) });
  }
}
