  ...
  extends BaseHandlerReceiver
{
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("FriendListHandler.BaseHandlerReceiver", 2, "handleCondSearchFriendNewProto resultCode = " + i);
    }
    if ((paramFromServiceMsg.isSuccess()) && (i == 0)) {}
    for (boolean bool = true;; bool = false)
    {
      a(73, bool, new Object[] { Long.valueOf(paramToServiceMsg.extraData.getLong("search_seq")), localRspBody, Integer.valueOf(i), Integer.valueOf(paramToServiceMsg.extraData.getInt("param_search_from")) });
      return;
    }
  }
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    } while (!"OidbSvc.0x972_5".equals(str));
