  ...
  extends BaseHandlerReceiver
{
  ...
  private void a(FromServiceMsg paramFromServiceMsg, DelFriendResp paramDelFriendResp)
  {
    ...
    IceBreakingUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramDelFriendResp.deluin + "");
    TofuHelper.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramDelFriendResp.deluin + "");
    ...
    paramFromServiceMsg = (NearbyCardManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.NEARBY_CARD_MANAGER);
    if (paramFromServiceMsg != null) {
  ...
  private void a(AddFriendResp paramAddFriendResp, ToServiceMsg paramToServiceMsg)
  {
    ...
    if (paramAddFriendResp.result == 0)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          for (;;)
          {
            ((FriendsManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER)).a().a((String)localObject);
            if (QLog.isColorLevel())
            {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("FriendListHandler.BaseHandlerReceiver", 2, "ErrorString " + paramAddFriendResp.ErrorString + "resultCode " + paramAddFriendResp.result + "errorCode " + paramAddFriendResp.errorCode);
    }
    a(11, true, localBundle);
  }
