    ...
    while (paramList.hasNext())
    {
      ...
      if ((localFriends2 != null) && (QQProfileItem.a(localFriends1.name, localFriends2.name)))
      {
        if (QLog.isColorLevel())
        {
          ...
          localStringBuilder.append("handleGetFriendList friend Name changed.oldName ");
          localStringBuilder.append(localFriends2.name);
          localStringBuilder.append(",newName ");
          localStringBuilder.append(localFriends1.name);
          localStringBuilder.append(",oldRemark ");
          localStringBuilder.append(localFriends2.remark);
          localStringBuilder.append(",newRemark =");
          localStringBuilder.append(localFriends1.remark);
      ...
      if ((localFriends2 != null) && (!TextUtils.isEmpty(((FriendInfo)localObject4).nick)) && (!((FriendInfo)localObject4).nick.equals(((FriendInfo)localObject4).remark)) && (QQProfileItem.b(localFriends1.remark, localFriends2.remark)))
      {
        ...
        {
          localStringBuilder = new StringBuilder();
          localStringBuilder.append("handleGetFriendList friend remark changed.oldName ");
          localStringBuilder.append(localFriends2.name);
          localStringBuilder.append(",newName ");
          localStringBuilder.append(localFriends1.name);
          localStringBuilder.append(",oldRemark ");
