...
public class LimitChatConfirmRichTextAndMsgViaProvider
  implements IRichTextAndMsgViaProvider
{
  public Object[] a(AppInterface paramAppInterface, MessageRecord paramMessageRecord, im_msg_body.RichText paramRichText, int paramInt)
  {
    if (paramMessageRecord.msgtype == -7005) {
      paramRichText = MessageProtoCodec.b((MessageForLimitChatConfirm)paramMessageRecord);
    }
 ...
 * Qualified Name:     com.tencent.mobileqq.app.richtext.LimitChatConfirmRichTextAndMsgViaProvider
