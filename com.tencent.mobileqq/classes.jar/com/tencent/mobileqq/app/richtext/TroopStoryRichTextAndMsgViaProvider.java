...
public class TroopStoryRichTextAndMsgViaProvider
  implements IRichTextAndMsgViaProvider
{
  ...
  {
    if (paramMessageRecord.msgtype == -2057) {
      paramRichText = MessageProtoCodec.a((MessageForTroopStory)paramMessageRecord);
    }
 ...
 * Qualified Name:     com.tencent.mobileqq.app.richtext.TroopStoryRichTextAndMsgViaProvider
