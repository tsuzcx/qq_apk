...
public class PokeEmoMsgRichTextAndMsgViaProvider
  implements IRichTextAndMsgViaProvider
{
  ...
  {
    if (paramMessageRecord.msgtype == -5018) {
      paramRichText = MessageProtoCodec.f((MessageForPokeEmo)paramMessageRecord);
    }
 ...
 * Qualified Name:     com.tencent.mobileqq.app.richtext.PokeEmoMsgRichTextAndMsgViaProvider
