...
public class DataLineHandler$7
  implements Runnable
{
  public DataLineHandler$7(ajgm paramajgm, FromServiceMsg paramFromServiceMsg, int paramInt, long paramLong) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentQphoneBaseRemoteFromServiceMsg.getWupBuffer() != null)
      {
        ...
        if (i >= 0)
        {
          ...
          bakz.a((byte[])localObject, 0, this.jdField_a_of_type_ComTencentQphoneBaseRemoteFromServiceMsg.getWupBuffer(), 4, i);
        }
      }
    ...
    ajgm.a(this.this$0, localInvalidProtocolBufferMicroException);
  }
}
