  ...
  implements aofq, Manager
{
  ...
  private amab jdField_a_of_type_Amab = new alzn(this);
  ...
  public String a;
  ArrayList<awbv> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  protected ConcurrentHashMap<String, awbv> a;
  ...
  protected Map<String, List<WeakReference<alzv>>> b;
  protected Set<String> b;
  public ConcurrentHashMap<String, awbv> b;
  ...
  protected ConcurrentHashMap<String, awbv> c;
  protected boolean c;
  LruCache<alzy, Drawable> d;
  ...
  public TroopManager()
  {
    ...
    this.jdField_a_of_type_Bbuv = null;
  ...
  public TroopManager(QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Amab, true);
    bckj.a();
    this.jdField_a_of_type_Bbuv = new bbuv(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentAccountUin());
    this.jdField_a_of_type_Bbwz = new bbwz(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentAccountUin());
    this.jdField_a_of_type_Yqe = new yqe(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentAccountUin());
  ...
  private ConcurrentHashMap<String, awbv> a()
  {
    for (;;)
    {
      try
      {
        ...
        {
          localObject1 = (ArrayList)this.jdField_a_of_type_Awbw.a(CommonlyUsedTroop.class, false, null, null, null, null, null, null);
  ...
  public static void a(MessageRemindRsp paramMessageRemindRsp, QQAppInterface paramQQAppInterface, String paramString, Context paramContext, TroopChatPie paramTroopChatPie, agwa paramagwa)
  {
    ...
    do
    {
      ...
      localQVipBigTroopExpiredConfig = aoql.c();
    ...
    for (;;)
    {
      if (paramMessageRemindRsp.isFreezed)
      {
        ...
        switch (alzo.a[localObject1.ordinal()])
        {
        default: 
        case 1: 
        case 2: 
          for (;;)
          {
            ...
            {
              paramTroopChatPie.a = new aguq(paramQQAppInterface, paramContext, paramagwa);
              paramagwa.a(paramTroopChatPie.a);
            }
            switch (alzo.a[localObject1.ordinal()])
            {
            default: 
            ...
            case 2: 
              for (;;)
              {
                ...
                paramagwa.a(paramTroopChatPie.a, new Object[0]);
                azmj.b(paramQQAppInterface, "dc00898", "", "", "qq_vip", "0X8009E33", 2, 0, "", "", "", "");
                continue;
                paramTroopChatPie.a.a(paramString, VipUtils.a((int)paramMessageRemindRsp.iGroupExpiredTime, 2), 1, 1);
                paramagwa.a(paramTroopChatPie.a, new Object[0]);
                azmj.b(paramQQAppInterface, "dc00898", "", "", "qq_vip", "0X8009E33", 1, 0, "", "", "", "");
              }
            }
            localObject2 = paramTroopChatPie.a;
            i1 = paramMessageRemindRsp.iLhGroupExpiredTime;
            if (alzw.b(paramMessageRemindRsp.iGroupType)) {}
            for (m = 11;; m = 12)
            {
              ((aguq)localObject2).a(paramString, VipUtils.a(i1, m), 1, 4);
              paramagwa.a(paramTroopChatPie.a, new Object[0]);
              azmj.b(paramQQAppInterface, "dc00898", "", "", "qq_vip", "0X800A57B", 0, 0, "", "", "", "");
              break;
            }
            VipUtils.a(paramContext, paramString, VipUtils.a((int)paramMessageRemindRsp.iSVIPExpiredTime, 7).toString(), alpo.a(2131715881), new alzp(localTroopManager, paramString), "0X8009E36", 2);
            azmj.b(paramQQAppInterface, "dc00898", "", "", "qq_vip", "0X8009E35", 2, 0, "", "", "", "");
            continue;
            VipUtils.a(paramContext, paramString, VipUtils.a((int)paramMessageRemindRsp.iGroupExpiredTime, 6).toString(), alpo.a(2131715918), new alzq(localTroopManager, paramString), "0X8009E36", 1);
            azmj.b(paramQQAppInterface, "dc00898", "", "", "qq_vip", "0X8009E35", 1, 0, "", "", "", "");
          }
        }
        if (alzw.b(paramMessageRemindRsp.iGroupType)) {}
        for (m = 13;; m = 14)
        {
          VipUtils.a(paramContext, paramString, VipUtils.a(0, m).toString(), alpo.a(2131715864), new alzr(localTroopManager, paramString, paramQQAppInterface), "0X800A57E", 1, true);
          azmj.b(paramQQAppInterface, "dc00898", "", "", "qq_vip", "0X800A57D", 0, 0, "", "", "", "");
          break;
        }
      }
      if ((paramMessageRemindRsp.eRemindLevel < 3) || (alzw.a(paramMessageRemindRsp.iGroupType))) {
        break;
      }
      switch (alzo.a[localObject1.ordinal()])
      {
      ...
      if (i1 < localQVipBigTroopExpiredConfig.mNotifyTipsMaxCount)
      {
        ...
        a(paramQQAppInterface, paramTroopChatPie, paramagwa, paramContext, localTroopManager, paramString, paramMessageRemindRsp, n, localQVipBigTroopExpiredConfig, i1, 0, (TroopManager.EXPIRED_TYPE)localObject1);
      }
      int i2;
      for (;;)
      {
        ...
        if (i2 < localQVipBigTroopExpiredConfig.mNotifyTipsPerDay) {
          a(paramQQAppInterface, paramTroopChatPie, paramagwa, paramContext, localTroopManager, paramString, paramMessageRemindRsp, n, localQVipBigTroopExpiredConfig, i1, i2, (TroopManager.EXPIRED_TYPE)localObject1);
        }
      }
  ...
  private void a(amjk paramamjk, CommonlyUsedTroop paramCommonlyUsedTroop, boolean paramBoolean)
  {
    RecentUser localRecentUser = paramamjk.b(paramCommonlyUsedTroop.troopUin, 1);
  ...
  {
    switch (alzo.a[paramEXPIRED_TYPE.ordinal()])
    {
    }
    int m;
    do
    {
      ...
      VipUtils.a(paramContext, paramString, VipUtils.a((int)paramMessageRemindRsp.iSVIPExpiredTime, 5).toString(), alpo.a(2131715892), new alzs(), "0X8009E36", 1);
      ...
      azmj.b(null, "dc00898", "", "", "qq_vip", "0X8009E35", 1, 0, "", "", "", "");
      return;
      m = VipUtils.a(paramInt1, (int)paramMessageRemindRsp.iGroupExpiredTime);
    } while (((m > paramQVipBigTroopExpiredConfig.mNotifyDialogMaxDay) || (m < paramQVipBigTroopExpiredConfig.mNotifyDialogMinDay)) && (m != 0));
    VipUtils.a(paramContext, paramString, VipUtils.a((int)paramMessageRemindRsp.iGroupExpiredTime, 4).toString(), alpo.a(2131715898), new alzt(), "0X8009E36", 1);
    paramTroopManager.g(paramString, paramInt2 + 1);
    paramTroopManager.h(paramString, paramInt1);
    paramTroopManager.i(paramString, paramInt3 + 1);
    azmj.b(null, "dc00898", "", "", "qq_vip", "0X8009E35", 1, 0, "", "", "", "");
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (jdField_c_of_type_JavaUtilArrayList.isEmpty()) {
      jdField_c_of_type_JavaUtilArrayList.addAll(Arrays.asList(new String[] { alpo.a(2131715919), alpo.a(2131715905), alpo.a(2131715901), alpo.a(2131715912), alpo.a(2131715884), alpo.a(2131715890), alpo.a(2131715909) }));
    }
    if (jdField_d_of_type_JavaUtilArrayList.isEmpty()) {
      jdField_d_of_type_JavaUtilArrayList.addAll(Arrays.asList(new String[] { alpo.a(2131715921), alpo.a(2131715894), alpo.a(2131715920), alpo.a(2131715906), alpo.a(2131715922), alpo.a(2131715911), alpo.a(2131715875), alpo.a(2131715871), alpo.a(2131715888) }));
    }
  }
  
  private static void a(QQAppInterface paramQQAppInterface, TroopChatPie paramTroopChatPie, agwa paramagwa, Context paramContext, TroopManager paramTroopManager, String paramString, MessageRemindRsp paramMessageRemindRsp, int paramInt1, QVipBigTroopExpiredConfig paramQVipBigTroopExpiredConfig, int paramInt2, int paramInt3, TroopManager.EXPIRED_TYPE paramEXPIRED_TYPE)
  {
    switch (alzo.a[paramEXPIRED_TYPE.ordinal()])
    {
    }
    ...
    paramTroopManager.d(paramString, paramInt1);
    paramTroopManager.e(paramString, paramInt3 + 1);
    azmj.b(paramQQAppInterface, "dc00898", "", "", "qq_vip", "0X800A579", 0, 0, "", "", "", "");
  }
      ...
      for (;;)
      {
        if ((SearchConfigManager.troopMemberUpdateConfigs != null) && (!SearchConfigManager.troopMemberUpdateConfigs.isEmpty()))
        {
          ...
          for (;;)
          {
            ...
            {
              ayqz localayqz = (ayqz)localIterator.next();
              if (m != 0)
              {
                localObject3 = localayqz;
                if (localObject1 != null)
                {
                  if (localObject1.b <= localayqz.b) {
                    break label729;
                  }
                  localObject3 = localayqz;
                }
              ...
              if ((paramTroopInfo.wMemberNum > localayqz.jdField_a_of_type_Int) && (paramTroopInfo.wMemberNum < localayqz.b))
              {
                localObject1 = localayqz;
                if (localObject1 == null)
                {
                  bool = false;
                  paramBoolean = bool;
                  ...
                  n = 0;
                  l1 = amjr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramTroopInfo.troopuin);
                  bool = paramBoolean;
                  m = n;
                  if (paramBoolean)
                  {
                    l1 = Math.abs(System.currentTimeMillis() - l1);
                    if (bdee.h(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()))
                    {
  ...
  private ConcurrentHashMap<String, awbv> b()
  {
    int n = 0;
    if (this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap == null)
    {
      ArrayList localArrayList = (ArrayList)this.jdField_a_of_type_Awbw.a(ShowExternalTroop.class, false, null, null, null, null, null, null);
    ...
    for (;;)
    {
      try
      {
        ...
        if (m < paramArrayList.size())
        {
          ...
          {
            Object localObject = (awbv)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(localTroopInfo.troopuin);
  ...
  private void h()
  {
    ...
    localObject2 = (ArrayList)this.jdField_a_of_type_Awbw.a(TroopInfo.class, false, null, null, null, null, null, null);
  ...
  private void i()
  {
    ...
    if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap != null)
    {
      ...
      if (m > 0)
      {
          ...
          if (localTroopInfo.eliminated != 1)
          {
            ...
            for (;;)
            {
              synchronized (this.jdField_a_of_type_JavaUtilList)
              {
                ...
                {
                  localalzf.g(localTroopInfo.troopuin, false);
        ...
        if (m > 1) {
          Collections.sort(localList2, allu.a);
        }
      }
    }
  ...
  private void p(String paramString)
  {
    ...
    bckr.a(paramString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    atwd.a().b(paramString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(paramString, 1);
    b(paramString, true);
    ((alzf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).notifyUI(63, true, paramString);
    f(paramString);
    try
    {
  ...
  public alzu a()
  {
    if (this.jdField_a_of_type_Alzu == null) {
      this.jdField_a_of_type_Alzu = new alzu(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    }
    return this.jdField_a_of_type_Alzu;
  }
  
  public alzx a(String paramString1, String paramString2)
  {
    paramString1 = b(paramString1, paramString2);
    long l1 = 0L;
    ...
    return new alzx(this, paramString2, l1);
  }
  
  public amme a()
  {
    if (this.jdField_a_of_type_Amme == null) {
      this.jdField_a_of_type_Amme = new amme(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    }
    return this.jdField_a_of_type_Amme;
  }
  
  public Drawable a(int paramInt, String paramString)
  {
    alzy localalzy = new alzy(this);
    localalzy.jdField_a_of_type_Int = paramInt;
    localalzy.jdField_a_of_type_JavaLangString = paramString;
    return (Drawable)this.jdField_d_of_type_AndroidSupportV4UtilLruCache.get(localalzy);
  }
  ...
  public MessageRecord a(String paramString1, String paramString2)
  {
    if (awnj.a != null)
    {
      ...
      if (n > 0)
      {
        ...
        while (m < n)
        {
          ((StringBuilder)localObject).append(awnj.a[m]);
          if (m < n - 1) {
    ...
    for (Object localObject = ((StringBuilder)localObject).toString();; localObject = null)
    {
      ...
      paramString1 = localawbw.a(MessageRecord.class, MessageRecord.getTableName(paramString1, 1), false, String.format("shmsgseq < %d and senderuin = ? and extLong & 3 <> 3 and msgtype in (%s)", new Object[] { Long.valueOf(9223372036854775807L), localObject }), new String[] { paramString2 }, null, null, "shmsgseq DESC", String.valueOf(1));
      localawbw.a();
      ...
      do
      {
        ...
        if (localObject2 == null)
        {
          ...
          if (!this.jdField_a_of_type_Boolean)
          {
            ...
            if (paramBoolean2)
            {
              localObject2 = (TroopInfo)this.jdField_a_of_type_Awbw.a(TroopInfo.class, paramString);
              localObject1 = localObject2;
              if (localObject2 != null)
              {
  ...
  public String a(TroopMemberInfo paramTroopMemberInfo)
  {
    ...
    Object localObject1 = ((aloz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).b(paramTroopMemberInfo.memberuin);
  ...
  {
    return bdbt.h(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1, paramString2);
  }
  
  public ArrayList<awbv> a()
  {
    if (!this.jdField_a_of_type_Boolean) {
      b();
    }
  ...
  public List<TroopNotificationCache> a(String paramString)
  {
    ...
    do
    {
      return null;
      localArrayList = new ArrayList();
      paramString = this.jdField_a_of_type_Awbw.a(TroopNotificationCache.class, true, "troopUin=? and read=? and currentUin=?", new String[] { paramString, "0", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }, null, null, "time ASC", null);
  ...
  public void a(int paramInt, String paramString, Drawable paramDrawable)
  {
    ...
    localalzy.jdField_a_of_type_Int = paramInt;
    localalzy.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_d_of_type_AndroidSupportV4UtilLruCache.put(localalzy, paramDrawable);
  }
  ...
  public void a(alzz paramalzz)
  {
    try
    {
      this.jdField_f_of_type_JavaUtilArrayList.add(paramalzz);
      return;
    }
    finally
    {
  ...
  {
    if ((paramaofp != null) && ("batch_add_friend_for_troop_config".equals(paramString))) {
      a().a(paramaofp.jdField_a_of_type_JavaLangString);
    }
  }
  ...
  public void a(String paramString1, long paramLong1, int paramInt, long paramLong2, long paramLong3, String paramString2)
  {
    ...
    for (;;)
    {
      MessageForGrayTips localMessageForGrayTips = (MessageForGrayTips)ayvw.a(-1013);
      ...
      if ((0x2 & paramLong2) == 2L) {
        if ((0x2 & paramLong3) == 2L) {
          paramString2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131698098);
        } else {
          paramString2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131698099);
        }
      }
    }
  }
  ...
  public void a(String paramString, long paramLong1, long paramLong2, int paramInt)
  {
    ...
    do
    {
      while (TextUtils.isEmpty(str))
      {
        return;
        if (paramInt == 131080) {
          str = alpo.a(2131715897);
        }
      }
      Object localObject = new aslp(paramString, paramString, str, 1, -5040, paramInt, paramLong1);
  ...
  public void a(String paramString, amaa paramamaa)
  {
    if ((TextUtils.isEmpty(paramString)) || (paramamaa == null))
    {
      if (QLog.isColorLevel()) {
    ...
    ThreadManager.post(new TroopManager.12(this, paramString, paramamaa), 8, null, false);
  }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    {
      ((alzz)this.jdField_f_of_type_JavaUtilArrayList.get(m)).b(paramString1, paramString2);
      m += 1;
    }
  }
  ...
  public void a(String paramString1, String paramString2, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        ((bcjl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(48)).a(paramString1);
        return;
  ...
  public void a(String paramString1, String paramString2, alzv paramalzv)
  {
    if (Looper.myLooper() != Looper.getMainLooper()) {
      if (paramalzv != null)
      {
        ...
        paramalzv.a((TroopMemberInfo)localObject);
      }
    }
    label35:
    do
    {
      return;
      paramalzv.a(c(paramString1, paramString2));
      return;
    ...
    {
      ((List)localObject).add(new WeakReference(paramalzv));
      bckm.a(new TroopManager.10(this, paramString1, paramString2));
      return;
    }
    ((List)localObject).add(new WeakReference(paramalzv));
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3, int paramInt, String paramString4, String paramString5)
  {
    ...
    {
      return;
      TroopMemberCardInfo localTroopMemberCardInfo = bdbx.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1, paramString2);
      int m = 0;
      int i1 = 0;
      if (paramInt != -100)
      {
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      a(paramString);
      this.jdField_a_of_type_Awbw.b(localTroopInfo);
      p(paramString);
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {}
      try
      {
        ((aujf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(329)).a(Long.parseLong(paramString), null);
  ...
  public void a(String paramString, byte[] paramArrayOfByte)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getSharedPreferences(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + "_" + paramString, 0).edit().putString("troop_app_list_data", bdbi.encodeToString(paramArrayOfByte, 2)).commit();
  }
  
  public void a(ArrayList<String> paramArrayList)
  {
    bhxr.a("queryTroops_" + paramArrayList.size());
    if (paramArrayList.size() > 0)
    {
      ...
      paramArrayList = this.jdField_a_of_type_Awbw.a(TroopInfo.class, true, ((StringBuilder)localObject).toString(), (String[])paramArrayList.toArray(new String[paramArrayList.size()]), null, null, null, null);
      if (paramArrayList != null)
      {
  ...
  public void a(oidb_cmd0xb36.RspBody paramRspBody)
  {
    ...
    for (;;)
    {
      a();
      return;
      QLog.e(".troop.survey", 1, new Object[] { "[TroopManager]updateTroopSurveyList() IllegaleArgument! body is :", xnh.a(paramRspBody) });
      continue;
      if (QLog.isColorLevel()) {
        QLog.d(".troop.survey", 2, new Object[] { "[TroopManager]updateTroopSurveyList() body ready!", xnh.a(paramRspBody) });
      }
  ...
  public void a(structmsg.StructMsg paramStructMsg)
  {
    ...
    if (l1 < l2)
    {
      m = -1;
      a(str);
      bdbx.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp());
      bckr.a(str, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      i();
      ((aujf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(329)).a(paramStructMsg.msg.group_code.get(), null);
      if (n != 8) {
        break label416;
      }
    ...
    for (;;)
    {
      ...
      ((alzf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).notifyUI(126, true, new Object[] { str, Integer.valueOf(m) });
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  public boolean a()
  {
    ...
    {
      return false;
      localArrayList = (ArrayList)this.jdField_a_of_type_Awbw.a(TroopInfo.class, false, null, null, null, null, null, String.valueOf("1"));
  ...
  public boolean a(awbv paramawbv)
  {
    ...
    do
    {
      ...
      } while (paramawbv.getStatus() != 1001);
      return true;
  ...
  public boolean a(String paramString)
  {
    ...
    //   15: invokevirtual 209	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lawbx;
    //   18: invokevirtual 215	awbx:createEntityManager	()Lawbw;
    //   21: astore 5
    //   23: aload 5
    //   25: invokevirtual 951	awbw:a	()Lawby;
    //   28: astore 4
    //   30: aload 4
    //   32: astore_3
    //   33: aload_3
    //   34: invokevirtual 955	awby:a	()V
    //   37: aload 5
    //   39: ldc_w 1150
    //   42: iconst_0
    //   43: ldc_w 1779
    ...
    //   56: aconst_null
    //   57: aconst_null
    //   58: invokevirtual 319	awbw:a	(Ljava/lang/Class;ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    //   61: astore 4
    //   63: aload 4
    //   65: ifnull +15 -> 80
    //   68: aload 4
    ...
    //   121: invokevirtual 1740	awbw:b	(Lawbv;)Z
    //   124: pop
    //   125: goto -26 -> 99
    //   128: astore 4
    //   130: ldc_w 942
    ...
    //   143: ifnull +7 -> 150
    //   146: aload_3
    //   147: invokevirtual 972	awby:b	()V
    //   150: aload 5
    //   152: invokevirtual 1234	awbw:a	()V
    //   155: aload_0
    //   156: aload_1
    ...
    //   161: ireturn
    //   162: aload_3
    //   163: invokevirtual 976	awby:c	()V
    //   166: aload_3
    //   167: ifnull -17 -> 150
    //   170: aload_3
    //   171: invokevirtual 972	awby:b	()V
    //   174: goto -24 -> 150
    //   177: astore_1
    //   178: aconst_null
    //   179: astore_3
    ...
    //   181: ifnull +7 -> 188
    //   184: aload_3
    //   185: invokevirtual 972	awby:b	()V
    //   188: aload_1
    //   189: athrow
    //   190: astore_1
    //   191: goto -11 -> 180
  ...
  public boolean a(String paramString, long paramLong)
  {
    ...
    if (localCommonlyUsedTroop == null)
    {
      ...
      a(localamjk, localCommonlyUsedTroop, true);
  ...
  public boolean a(String paramString1, String paramString2, byte paramByte)
  {
    ...
    for (;;)
    {
      ...
      for (paramByte = 1;; paramByte = 0)
      {
        ...
        {
          a(paramString1, paramString2, localTroopMemberInfo);
          localawbw.b(localTroopMemberInfo);
        }
        for (;;)
        {
          localawbw.a();
          ...
          break;
          localawbw.a(localTroopMemberInfo);
        }
      }
    }
  }
  ...
  public boolean a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    awbw localawbw = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getEntityManagerFactory().createEntityManager();
    TroopManager localTroopManager = (TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52);
    if ((localawbw == null) || (localTroopManager == null)) {
      return false;
    }
    ...
    TroopMemberInfo localTroopMemberInfo = (TroopMemberInfo)localawbw.a(TroopMemberInfo.class, "troopuin=? and memberuin=?", new String[] { paramString1, paramString2 });
    if (localTroopMemberInfo != null)
    {
      localawbw.b(localTroopMemberInfo);
    ...
    if (paramBoolean) {
      ((alzf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).c(paramString1, paramString2);
    }
    return true;
  }
  ...
  public boolean a(List<TroopMemberInfo> paramList)
  {
    ...
    //   34: astore 5
    //   36: aload_0
    //   37: getfield 217	com/tencent/mobileqq/app/TroopManager:jdField_a_of_type_Awbw	Lawbw;
    //   40: invokevirtual 951	awbw:a	()Lawby;
    //   43: astore 6
    //   45: aload 6
    //   47: astore 5
    //   49: iload 4
    ...
    //   231: istore_3
    //   232: aload 5
    //   234: invokevirtual 976	awby:c	()V
    //   237: iload_2
    //   238: istore_3
    //   239: aload 5
    //   241: ifnull -226 -> 15
    //   244: aload 5
    //   246: invokevirtual 972	awby:b	()V
    //   249: iload_2
    //   250: ireturn
    //   251: astore 6
    //   253: iload_3
    ...
    //   283: ifnull -268 -> 15
    //   286: aload_1
    //   287: invokevirtual 972	awby:b	()V
    //   290: iload_2
    //   291: ireturn
    //   292: astore_1
    //   293: aconst_null
    ...
    //   298: ifnull +8 -> 306
    //   301: aload 5
    //   303: invokevirtual 972	awby:b	()V
    //   306: aload_1
    //   307: athrow
    //   308: astore_1
    //   309: goto -13 -> 296
  ...
  {
    return bdbt.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1, paramString2, false);
  }
  ...
  {
    return this.jdField_a_of_type_Awbw.a(TroopMemberInfo.class, false, "troopuin=?", new String[] { paramString }, null, null, null, null);
  }
  ...
  public void b(alzz paramalzz)
  {
    try
    {
      this.jdField_f_of_type_JavaUtilArrayList.remove(paramalzz);
      return;
    }
    finally
    {
  ...
  public void b(String paramString1, String paramString2)
  {
    ...
    while (m < this.jdField_f_of_type_JavaUtilArrayList.size())
    {
      ((alzz)this.jdField_f_of_type_JavaUtilArrayList.get(m)).a(paramString1, paramString2);
      m += 1;
    }
  }
  ...
  public void b(ArrayList<String> paramArrayList)
  {
    ...
    while (m < this.jdField_f_of_type_JavaUtilArrayList.size())
    {
      ((alzz)this.jdField_f_of_type_JavaUtilArrayList.get(m)).a(paramArrayList);
      m += 1;
    }
  }
      ...
      try
      {
        ...
        for (;;)
        {
          ...
          if (localTroopInfo != null)
          {
            ...
            localObject = localawby;
            this.jdField_a_of_type_Awbw.a(localTroopInfo);
          }
        }
        if (localObject == null) {}
      }
  ...
  public boolean b(String paramString, long paramLong)
  {
    ...
    {
      localShowExternalTroop = ShowExternalTroop.createShowExternalTroop(paramString, bdbt.g(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString), paramLong);
  ...
  public TroopInfo c(String paramString)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("Q.contacttab.", 2, bdje.a(new Object[] { "TroopManger getTroopInfo()", paramString, Long.valueOf(((TroopInfo)localObject2).dwGroupFlagExt) }));
      }
      return localObject2;
      ...
      {
        localObject1 = new TroopInfo();
        ((TroopInfo)localObject1).troopname = bdak.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), paramString);
        ((TroopInfo)localObject1).dwGroupFlagExt = bdak.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), paramString);
      }
      localObject2 = localObject1;
  ...
  public TroopMemberInfo c(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      List localList = ((awbw)localObject).a(TroopMemberInfo.class, false, "troopuin=? AND memberuin=?", new String[] { paramString1, paramString2 }, null, null, null, null);
      ((awbw)localObject).a();
      ...
      for (localObject = "1";; localObject = "0")
      {
        ...
        azmz.a(BaseApplicationImpl.getContext()).a(null, "actFriendSqliteOpt", true, l1, 0L, localHashMap, null, false);
  ...
  public String c(String paramString)
  {
    ...
    {
      TroopInfo localTroopInfo = (TroopInfo)this.jdField_a_of_type_Awbw.a(TroopInfo.class, "troopcode=?", new String[] { paramString });
      if (localTroopInfo == null) {
        return null;
      }
  ...
  /* Error */
  public ArrayList<alzx> c(String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 4
    ...
    //   10: astore 6
    //   12: aload_0
    //   13: getfield 217	com/tencent/mobileqq/app/TroopManager:jdField_a_of_type_Awbw	Lawbw;
    //   16: invokevirtual 951	awbw:a	()Lawby;
    //   19: astore 5
    //   21: aload 5
    //   23: astore 4
    //   25: aload 4
    //   27: ifnull +139 -> 166
    //   30: aload 4
    //   32: invokevirtual 955	awby:a	()V
    //   35: invokestatic 1377	com/tencent/mobileqq/msf/core/NetConnInfoCenter:getServerTime	()J
    //   38: lstore_2
    //   39: aload_0
    //   40: getfield 217	com/tencent/mobileqq/app/TroopManager:jdField_a_of_type_Awbw	Lawbw;
    //   43: ldc_w 1150
    //   46: iconst_0
    //   47: ldc_w 1779
    //   50: iconst_1
    ...
    //   60: aconst_null
    //   61: aconst_null
    //   62: invokevirtual 319	awbw:a	(Ljava/lang/Class;ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    //   65: astore_1
    //   66: aload_1
    //   67: ifnull +99 -> 166
    //   70: aload_1
    ...
    //   142: invokespecial 1189	alzx:<init>	(Lcom/tencent/mobileqq/app/TroopManager;Ljava/lang/String;J)V
    ...
    //   155: ifnull +8 -> 163
    //   158: aload 4
    //   160: invokevirtual 972	awby:b	()V
    //   163: aload 6
    //   165: areturn
    //   166: aload 4
    //   168: ifnull -5 -> 163
    //   171: aload 4
    //   173: invokevirtual 972	awby:b	()V
    //   176: aload 6
    //   178: areturn
    //   179: astore_1
    //   180: aconst_null
    ...
    //   185: ifnull +8 -> 193
    //   188: aload 4
    //   190: invokevirtual 972	awby:b	()V
    //   193: aload_1
    //   194: athrow
    //   195: astore_1
    //   196: goto -13 -> 183
  ...
  {
    this.jdField_a_of_type_Awbw.b("update TroopNotificationCache set read=1 where troopUin=" + paramString);
  }
  ...
  public boolean c(String paramString)
  {
    ...
    if (localCommonlyUsedTroop != null)
    {
      ...
      this.jdField_a_of_type_Awbw.b(localCommonlyUsedTroop);
      return true;
    }
    return false;
  }
  ...
  public String d(String paramString)
  {
    ...
    {
      localObject3 = (TroopInfo)this.jdField_a_of_type_Awbw.a(TroopInfo.class, "troopuin=?", new String[] { paramString });
  ...
  public void d()
  {
    ...
    //   7: astore 6
    //   9: aload_0
    //   10: getfield 217	com/tencent/mobileqq/app/TroopManager:jdField_a_of_type_Awbw	Lawbw;
    //   13: invokevirtual 951	awbw:a	()Lawby;
    //   16: astore 5
    //   18: aload 5
    //   20: astore 4
    //   22: aload 4
    ...
    //   101: invokestatic 2284	bdiv:a	(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    //   104: aload 7
    ...
    //   214: ifnull +8 -> 222
    //   217: aload 4
    //   219: invokevirtual 972	awby:b	()V
    //   222: return
    //   223: aload_0
    ...
    //   230: invokevirtual 993	com/tencent/mobileqq/app/proxy/ProxyManager:a	()Lamjk;
    //   233: astore 5
    //   235: aload 6
    ...
    //   286: aload 8
    //   288: iconst_0
    //   289: invokespecial 1900	com/tencent/mobileqq/app/TroopManager:a	(Lamjk;Lcom/tencent/mobileqq/data/CommonlyUsedTroop;Z)V
    //   292: goto -45 -> 247
    //   295: astore 6
    //   297: aload 4
    //   299: astore 5
    ...
    //   307: ifnull +8 -> 315
    //   310: aload 5
    //   312: invokevirtual 972	awby:b	()V
    //   315: aload 4
    //   317: athrow
    //   318: aload_0
    //   319: getfield 217	com/tencent/mobileqq/app/TroopManager:jdField_a_of_type_Awbw	Lawbw;
    //   322: ldc_w 314
    //   325: invokevirtual 2294	awbw:a	(Ljava/lang/Class;)Z
    //   328: pop
    ...
    //   553: aload 10
    //   555: iconst_0
    //   556: invokespecial 1900	com/tencent/mobileqq/app/TroopManager:a	(Lamjk;Lcom/tencent/mobileqq/data/CommonlyUsedTroop;Z)V
    //   559: aload_0
    //   560: aload 10
    //   562: invokevirtual 969	com/tencent/mobileqq/app/TroopManager:a	(Lawbv;)Z
    //   565: pop
    //   566: goto -198 -> 368
    //   569: aload_0
    //   570: aload 5
    //   572: aload 10
    //   574: iconst_1
    //   575: invokespecial 1900	com/tencent/mobileqq/app/TroopManager:a	(Lamjk;Lcom/tencent/mobileqq/data/CommonlyUsedTroop;Z)V
    //   578: goto -19 -> 559
    //   581: aload 4
    //   583: invokevirtual 976	awby:c	()V
    //   586: aload 4
    //   588: ifnull -366 -> 222
    //   591: aload 4
    //   593: invokevirtual 972	awby:b	()V
    //   596: return
    //   597: astore 4
    //   599: aconst_null
    //   600: astore 5
  ...
  public void e()
  {
    ...
    //   6: astore_3
    //   7: aload_0
    //   8: getfield 217	com/tencent/mobileqq/app/TroopManager:jdField_a_of_type_Awbw	Lawbw;
    //   11: invokevirtual 951	awbw:a	()Lawby;
    //   14: astore_2
    //   15: aload_2
    //   16: astore_1
    //   17: aload_1
    //   18: ifnull +130 -> 148
    //   21: aload_1
    //   22: invokevirtual 955	awby:a	()V
    //   25: aload_0
    //   26: getfield 217	com/tencent/mobileqq/app/TroopManager:jdField_a_of_type_Awbw	Lawbw;
    //   29: ldc_w 939
    //   32: invokevirtual 2294	awbw:a	(Ljava/lang/Class;)Z
    //   35: pop
    //   36: aload_3
    ...
    //   85: getfield 203	com/tencent/mobileqq/app/TroopManager:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   88: aload 4
    //   90: invokestatic 2148	bdbt:g	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;)Ljava/lang/String;
    //   93: aload_0
    ...
    //   124: aload_0
    //   125: aload 5
    //   127: invokevirtual 969	com/tencent/mobileqq/app/TroopManager:a	(Lawbv;)Z
    //   130: pop
    //   131: goto -69 -> 62
    //   134: astore_2
    //   135: aload_1
    //   136: ifnull +7 -> 143
    //   139: aload_1
    //   140: invokevirtual 972	awby:b	()V
    //   143: return
    //   144: aload_1
    //   145: invokevirtual 976	awby:c	()V
    //   148: aload_1
    //   149: ifnull -6 -> 143
    //   152: aload_1
    //   153: invokevirtual 972	awby:b	()V
    //   156: return
    //   157: astore_1
    //   158: aconst_null
    //   159: astore_3
    ...
    //   163: ifnull +7 -> 170
    //   166: aload_3
    //   167: invokevirtual 972	awby:b	()V
    //   170: aload_2
    //   171: athrow
    //   172: astore_2
    //   173: aload_1
  ...
  public void e(String paramString)
  {
    ...
    ((alzf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).y(paramString);
  }
    ...
    for (int n = 0;; n = i3)
    {
      ...
      else
      {
        ...
        while (n > 0)
        {
          ...
          azmz.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "tMSearchUpdateReq", false, 0L, 0L, localHashMap, "");
          return;
  ...
  public void f(String paramString)
  {
    ...
    while (m < this.jdField_f_of_type_JavaUtilArrayList.size())
    {
      ((alzz)this.jdField_f_of_type_JavaUtilArrayList.get(m)).b(paramString);
      m += 1;
    }
  }
  ...
  public void g(String paramString)
  {
    ...
    while (m < this.jdField_f_of_type_JavaUtilArrayList.size())
    {
      ((alzz)this.jdField_f_of_type_JavaUtilArrayList.get(m)).a(paramString);
      m += 1;
    }
  }
  ...
  {
    if (!aoqh.c().jdField_a_of_type_Boolean)
    {
      TroopInfo localTroopInfo = b(paramString);
