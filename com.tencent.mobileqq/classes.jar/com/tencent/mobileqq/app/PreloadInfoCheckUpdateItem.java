  ...
  implements CheckUpdateItemInterface
{
  ...
  public ReqItem a(int paramInt)
  {
    ...
    if ((j - i > paramInt) || (j < i))
    {
      ...
      ((PreloadInfoCheckUpdate.ControlReqHead)localObject3).client_ver.set("8.5.5");
      ...
      ((PreloadInfoCheckUpdate.ControlReqHead)localObject3).mem.set((int)DeviceInfoUtil.a() / 1048576);
      ...
      {
        localObject3 = (GameCenterManagerImp)this.a.getManager(QQManagerFactory.GAMECENTER_MANAGER);
