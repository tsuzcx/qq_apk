  ...
  extends BusinessHandler
{
  ...
  {
    ToServiceMsg localToServiceMsg = new ToServiceMsg("mobileqq.service", this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "NearfieldGroupSvr.ReqExit");
  ...
  {
    ToServiceMsg localToServiceMsg = new ToServiceMsg("mobileqq.service", this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "NearfieldGroupSvr.ReqJoinGroup");
    nearfield_group.BusiReqHead localBusiReqHead = new nearfield_group.BusiReqHead();
    localBusiReqHead.int32_seq.set(paramInt);
    localBusiReqHead.int32_version.set(1);
  ...
  {
    boolean bool = true;
    ToServiceMsg localToServiceMsg = new ToServiceMsg("mobileqq.service", this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "NearfieldGroupSvr.ReqGetGroupList");
  ...
  protected boolean a(String paramString)
  {
    if (this.jdField_b_of_type_JavaUtilSet == null)
    {
      ...
      this.jdField_b_of_type_JavaUtilSet.add("NearfieldGroupSvr.ReqGetGroupList");
      this.jdField_b_of_type_JavaUtilSet.add("NearfieldGroupSvr.ReqExit");
      this.jdField_b_of_type_JavaUtilSet.add("NearfieldGroupSvr.ReqJoinGroup");
    }
