...
public class RoamSettingManager$1
  implements Runnable
{
  public RoamSettingManager$1(amby paramamby) {}
  
  public void run()
  {
    int i = 0;
    ArrayList localArrayList = (ArrayList)this.this$0.jdField_a_of_type_Awgf.a(RoamSetting.class, false, null, null, null, null, null, null);
    ...
    for (;;)
    {
      try
      {
        if (i < localArrayList.size())
        {
          ...
          if (bdmq.a(localRoamSetting.path) == 1) {
