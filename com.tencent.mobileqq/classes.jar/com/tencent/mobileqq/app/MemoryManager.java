...
public class MemoryManager
{
  ...
  private ConcurrentHashMap<String, ajmd> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap(0);
  ...
  private ajmc a()
  {
    ...
    {
      this.jdField_a_of_type_Ajmc = new ajmc();
      this.jdField_a_of_type_Ajmc.a();
    }
  ...
  public static void a(int paramInt, ajma paramajma)
  {
    try
    {
      Debug.MemoryInfo[] arrayOfMemoryInfo = ((ActivityManager)BaseApplicationImpl.getContext().getSystemService("activity")).getProcessMemoryInfo(new int[] { paramInt });
      if ((arrayOfMemoryInfo != null) && (arrayOfMemoryInfo.length > 0))
      {
        paramajma.jdField_a_of_type_Long = (arrayOfMemoryInfo[0].getTotalPss() * 1024L);
        paramajma.jdField_b_of_type_Long = (arrayOfMemoryInfo[0].nativePss * 1024L);
        paramajma.jdField_c_of_type_Long = (arrayOfMemoryInfo[0].dalvikPss * 1024L);
        return;
      }
    }
    catch (Exception localException)
    {
      ...
      paramajma.jdField_a_of_type_Long = 62914560L;
      paramajma.jdField_b_of_type_Long = 31457280L;
      paramajma.jdField_c_of_type_Long = 31457280L;
      return;
    }
    catch (OutOfMemoryError localOutOfMemoryError)
    {
  ...
  public void a()
  {
    ...
    try
    {
      ...
      for (long l1 = l2;; l1 = 0L)
      {
        ...
        localSharedPreferences.edit().putString("key_top_act", ajox.a());
        localSharedPreferences.edit().putString("key_mem_usg", awri.a().a());
  ...
  public void a(long paramLong)
  {
    ...
    do
    {
      ...
      if (localSharedPreferences.getFloat("heap_level", -1.0F) > 0.0F)
      {
        ...
        awrn.a(BaseApplicationImpl.getApplication()).a(null, "HeapLevel", true, 0L, 0L, (HashMap)localObject, null);
    ...
    } while ((Math.abs(System.currentTimeMillis() - l1) <= 86400000L) || (!ajlz.a().d));
  ...
  protected void a(long paramLong1, long paramLong2)
  {
    ...
    {
      ajmc localajmc = a();
      localajmc.jdField_a_of_type_Long += paramLong2;
      localajmc.jdField_b_of_type_Long += paramLong1;
      localajmc.jdField_a_of_type_Int += 1;
      localajmc.c();
      return;
    }
  }
  
  public void a(ajmb paramajmb)
  {
    this.jdField_a_of_type_Ajmb = paramajmb;
  }
  
  public void a(Context paramContext, QQAppInterface paramQQAppInterface)
  {
    if ((paramQQAppInterface == null) || (paramQQAppInterface.l)) {}
    while (!ajlz.a().jdField_a_of_type_Boolean) {
      return;
    }
  ...
  public void a(Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      while (paramObject != null)
      {
        ...
        awrn.a(BaseApplicationImpl.getContext()).a("", "actLeakMem", true, 0L, 0L, localHashMap, "");
        return;
  ...
  {
    if ((this.jdField_a_of_type_Ajmb != null) && ("BG_GUARD".equals(paramString))) {
      this.jdField_a_of_type_Ajmb.a();
    }
  ...
  public final void b()
  {
    ...
    for (String str = str.substring(0, 1);; str = "")
    {
      ...
      awrn.a(BaseApplicationImpl.getApplication()).a(null, "oomInfo", true, 0L, 0L, localHashMap, null);
  ...
  protected void b(long paramLong1, long paramLong2)
  {
    ...
    {
      ajmc localajmc = a();
      localajmc.jdField_c_of_type_Long += paramLong2;
      localajmc.d += paramLong1;
      localajmc.jdField_b_of_type_Int += 1;
      localajmc.c();
      return;
    }
  }
  ...
  protected void b(String paramString)
  {
    ...
    {
      localajmd = new ajmd();
      localajmd.a("LITE_GUARD");
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put("LITE_GUARD", localajmd);
    }
    if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get("BG_GUARD") == null)
    {
      localajmd = new ajmd();
      localajmd.a("BG_GUARD");
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put("BG_GUARD", localajmd);
    }
    if ("LITE_GUARD".equals(paramString))
    {
      localajmd = (ajmd)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get("LITE_GUARD");
      if (localajmd != null) {
        break label173;
      }
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      localajmd = (ajmd)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get("BG_GUARD");
      break;
      l3 = babp.e();
      localObject2 = new ajma();
      a(Process.myPid(), (ajma)localObject2);
      long l4 = ((ajma)localObject2).jdField_a_of_type_Long;
      l1 = 0L;
      try
      {
        ...
        {
          localajmd.jdField_a_of_type_Long += l3;
          localajmd.jdField_b_of_type_Long += l2;
          localajmd.jdField_c_of_type_Long += l4;
          localajmd.g += ((ajma)localObject2).jdField_c_of_type_Long;
          localajmd.f += ((ajma)localObject2).jdField_b_of_type_Long;
          localajmd.h += Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory();
          localajmd.jdField_a_of_type_Int += 1;
          localObject1 = BaseApplicationImpl.sImageCache;
          localajmd.d += ((MQLruCache)localObject1).maxSize();
          localajmd.e += ((MQLruCache)localObject1).size();
          localajmd.jdField_c_of_type_Int += ((MQLruCache)localObject1).hitCount();
          i = localajmd.jdField_b_of_type_Int;
          localajmd.jdField_b_of_type_Int = (((MQLruCache)localObject1).missCount() + i);
          ...
          for (;;)
          {
            ...
            localObject4 = (ajmd)((Map.Entry)localObject1).getValue();
            i = ((ajmd)localObject4).jdField_a_of_type_Int;
            if (i > 0) {
              break;
            }
            ((ajmd)localObject4).a();
    ...
    l1 = ((ajmd)localObject4).d / (i * 1024);
    if (l1 < 0L) {
      throw new IllegalStateException("imageCacheMax illegal");
    }
    localHashMap.put("imageCacheMax", String.valueOf(l1));
    l1 = ((ajmd)localObject4).e / (i * 1024);
    if (l1 < 0L) {
      throw new IllegalStateException("imageCacheUsed illegal");
    }
    localHashMap.put("imageCacheUsed", String.valueOf(l1));
    l1 = ((ajmd)localObject4).jdField_c_of_type_Int / i;
    if (l1 < 0L) {
      throw new IllegalStateException("imageHitCount illegal");
    }
    localHashMap.put("imageHitCount", String.valueOf(l1));
    if (((ajmd)localObject4).jdField_c_of_type_Int + ((ajmd)localObject4).jdField_b_of_type_Int != 0)
    {
      i = ((ajmd)localObject4).jdField_c_of_type_Int * 100 / (((ajmd)localObject4).jdField_c_of_type_Int + ((ajmd)localObject4).jdField_b_of_type_Int);
      label1321:
      l1 = i;
      if (l1 < 0L) {
      ...
      localHashMap.put("guardConfigId", ajjv.a().a());
      localHashMap.put("memoryConfigId", ajlz.a().jdField_a_of_type_JavaLangString);
      localHashMap.put("osVersion", Build.VERSION.RELEASE);
      localHashMap.put("resolution", babp.l());
    ...
    for (int i = 1;; i = 0)
    {
      ...
      awrn.a(BaseApplicationImpl.getApplication()).a(null, "actMemory", true, 0L, 0L, localHashMap, null);
      ((ajmd)localObject4).a();
      ((ajmd)localObject4).b();
      break label591;
      label1492:
      ...
      if (QLog.isColorLevel())
      {
        ...
        ((StringBuilder)localObject1).append("reportMemoryInfo, start mode =").append(paramString).append("sysTotalMemory=").append(babp.d()).append(",statCount=").append(localajmd.jdField_a_of_type_Int).append(",sysClassMemory=").append(babp.f()).append(",sysAvailableMemory=").append(localajmd.jdField_a_of_type_Long).append(",qqOtherUsedMemory=").append(localajmd.jdField_b_of_type_Long).append(",qqUsedMemory=").append(localajmd.jdField_c_of_type_Long).append(",imageCacheMax=").append(localajmd.d).append(",imageCacheUsed=").append(localajmd.e).append(",imageHitCount=").append(localajmd.jdField_c_of_type_Int).append(",imageHitTotal=").append(localajmd.jdField_c_of_type_Int + localajmd.jdField_b_of_type_Int).append("\n");
  ...
  protected void c()
  {
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      for (;;)
      {
        try
        {
          i = localajmc.jdField_a_of_type_Int;
          j = localajmc.jdField_b_of_type_Int;
          HashMap localHashMap = new HashMap();
          localHashMap.put("sysTotalMemory", String.valueOf(babp.d() / 1024L));
          if (i != 0) {
            continue;
          }
          str = "0";
          ...
          awrn.a(BaseApplicationImpl.getApplication()).a(null, "LowMemoryStat", true, 0L, 0L, localHashMap, null);
          if (QLog.isColorLevel()) {
            QLog.d("Q.Memory.MemoryManager", 2, "reportLowMemory, sysTotalMemory=" + String.valueOf(babp.d() / 1024L) + ", lowWarningMemory=" + localajmc.jdField_b_of_type_Long + ", lowRemainMemory=" + localajmc.jdField_a_of_type_Long + ", lowMemoryCount=" + i + ", clearWarningMemory=" + localajmc.d + ", clearRemainMemory=" + localajmc.jdField_c_of_type_Long + ",clearCount=" + j);
          }
        }
        catch (Exception localException)
        {
        ...
        localajmc.c();
        return;
        str = String.valueOf(localajmc.jdField_b_of_type_Long / (i * 1024));
        continue;
        str = String.valueOf(localajmc.jdField_a_of_type_Long / (i * 1024));
        continue;
        str = String.valueOf(localajmc.d / (j * 1024));
      }
      l2 = localajmc.jdField_c_of_type_Long / (j * 1024);
