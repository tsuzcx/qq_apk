  ...
  extends BusinessHandler
{
  ...
  private CopyOnWriteArrayList<EmojiManager.SyncFetchEmoticonKeyObserver> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  ...
  private void a(int paramInt, EmosmPb.RspBody paramRspBody)
  {
    ...
    if (paramRspBody.msg_subcmd0x19_rsp.has())
    {
      ...
      localEmoticonPackage = localEmoticonManager.a(String.valueOf(i), paramInt);
      if (localEmoticonPackage != null)
      {
        ...
        if (TextUtils.isEmpty(str)) {
          paramRspBody = HardCodeUtil.a(2131704111);
        }
  ...
  private void a(int paramInt, EmosmPb.RspBody paramRspBody, EmoticonManager paramEmoticonManager)
  {
    ...
    if (bool1)
    {
      ...
      SharedPreferences.Editor localEditor = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getSharedPreferences("recommendEmotion_sp_name", 0).edit();
      localEditor.putInt("recommendEmotion_sp_lastversion" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), i);
      ...
      paramEmoticonManager.a(paramRspBody, paramInt);
    }
    if (QLog.isColorLevel()) {
  ...
  private void a(EmosmPb.RspBody paramRspBody)
  {
    ...
    if ((paramRspBody != null) && (paramRspBody.size() > 1))
    {
      ...
      ((CommonUsedSystemEmojiManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.COMMONUSED_SYSTEM_EMOJI_MANAGERT)).updateItemInfo(paramRspBody);
      return;
    }
  ...
  private void a(FromServiceMsg paramFromServiceMsg, boolean paramBoolean, int paramInt1, int paramInt2, EmoticonResp paramEmoticonResp)
  {
    ...
    if (paramInt1 == 2)
    {
      if (paramBoolean)
      {
        ThreadManagerV2.excute(new EmoticonHandler.1(this, localEmoticonManager, paramEmoticonResp, paramInt2), 32, null, true);
        return;
      }
    ...
    if (paramInt1 == 3)
    {
      ...
      while (paramFromServiceMsg.hasNext())
      {
        ...
        localEmoticonManager.a(localEmoticon);
        if (QLog.isColorLevel())
        {
      ...
      while (paramFromServiceMsg.hasNext()) {
        ((EmojiManager.SyncFetchEmoticonKeyObserver)paramFromServiceMsg.next()).a(paramBoolean, paramInt1, paramEmoticonResp);
      }
    }
    notifyUI(paramInt1, paramBoolean, paramEmoticonResp);
  }
  
  private void a(ToServiceMsg paramToServiceMsg, int paramInt, EmoticonResp paramEmoticonResp, EmoticonManager paramEmoticonManager)
  {
    ...
    for (;;)
    {
      ...
      while (paramToServiceMsg.hasNext())
      {
        ...
        paramEmoticonManager.g(paramEmoticonResp, paramInt);
        paramEmoticonResp = paramEmoticonManager.a(paramEmoticonResp, paramInt);
        EmojiListenerManager.a().b(paramEmoticonResp);
      }
    }
  }
    ...
    if ((paramFromServiceMsg.isSuccess()) && (paramObject != null))
    {
      ...
      if (i != 0)
      {
        ...
        if (i < j)
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getSharedPreferences("mobileQQ", 0).edit().putBoolean("emosm_has_download_emosmpackage_kandian_tag_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), bool).commit();
          break label468;
        }
      }
    }
    ...
    for (;;)
    {
      ...
      catch (Exception paramArrayOfByte)
      {
        ...
        case 1: 
          ...
          ((EmoticonManager)localObject).g(paramToServiceMsg, j);
          paramToServiceMsg = ((EmoticonManager)localObject).a(paramToServiceMsg, j);
          EmojiListenerManager.a().b(paramToServiceMsg);
          break;
        case 17: 
          a(paramToServiceMsg, j, localEmoticonResp, (EmoticonManager)localObject);
          break;
        case 2: 
      ...
      if (paramToServiceMsg.extraData.getBoolean("EmosmSubCmdFllow"))
      {
        ...
        a(j, paramArrayOfByte, (EmoticonManager)localObject);
        continue;
        a(paramArrayOfByte);
        continue;
    ...
    for (;;)
    {
      try
      {
        ...
        case 1: 
          ...
          {
            localObject3 = (EmoticonManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.EMOTICON_MANAGER);
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramToServiceMsg.uint32_result.get() == 0)
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getSharedPreferences("mobileQQ", 0).edit().putBoolean("emosm_has_download_emosmpackage_tag_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), bool).commit();
          if (QLog.isColorLevel()) {
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    localReqBody.uint64_uin.set(Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).longValue());
    localReqBody.msg_subcmd0x2_req_fetchtab.set((MessageMicro)localObject);
    localReqBody.int32_plat_id.set(109);
    localReqBody.str_app_version.set("8.5.5");
    ...
    for (;;)
    {
      localObject = new ToServiceMsg("mobileqq.service", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "BQMallSvc.TabOpReq");
  ...
  public void a(int paramInt, ArrayList<Emoticon> paramArrayList, String paramString)
  {
    ...
    ((EmosmPb.ReqBody)localObject1).uint64_uin.set(Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).longValue());
    ...
    localObject2 = new ToServiceMsg("mobileqq.service", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "BQMallSvc.TabOpReq");
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    paramString.uint64_uin.set(Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).longValue());
    paramString.int32_plat_id.set(109);
    paramString.str_app_version.set("8.5.5");
  ...
  public void a(String paramString, List<String> paramList1, List<String> paramList2)
  {
    ...
    paramList2.uint64_uin.set(Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).longValue());
    paramList2.int32_plat_id.set(109);
    paramList2.uint32_sub_cmd.set(9);
    paramList2.str_app_version.set("8.5.5");
    ...
    paramString = new ToServiceMsg("mobileqq.service", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "BQMallSvc.TabOpReq");
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    localModuleReq.mqqver.set("8.5.5");
    localModuleReq.uin.set(Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin()).longValue());
    localModuleReq.sub_cmd.set(1);
    localModuleReq.moduleInfo.set((MessageMicro)localObject);
    localObject = new ToServiceMsg("mobileqq.service", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "gxzbIpsit.ipsite");
  ...
  public void a(List<String> paramList, boolean paramBoolean, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramList)
      {
        ...
        paramList.uint64_uin.set(Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).longValue());
        paramList.int32_plat_id.set(109);
        paramList.str_app_version.set("8.5.5");
  ...
  public void b()
  {
    ...
    localReqBody.str_app_version.set("8.5.5");
    Object localObject1 = ((CommonUsedSystemEmojiManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.COMMONUSED_SYSTEM_EMOJI_MANAGERT)).getLocalSystemEmojiInfoFromFile();
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localObject1 = new ToServiceMsg("mobileqq.service", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "BQMallSvc.TabOpReq");
  ...
  public void c()
  {
    Object localObject1 = VasUpdateUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "watch_focus.json", true, null);
    if (localObject1 != null)
    {
      ...
      if ((localJSONArray != null) && (localJSONArray.length() > 0))
      {
        ...
        localObject2 = (EmoticonManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.EMOTICON_MANAGER);
  ...
  public void c(int paramInt)
  {
    ...
    int j = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getSharedPreferences("recommendEmotion_sp_name", 0).getInt("recommendEmotion_sp_lastversion" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), -1);
    if (!new File(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getFilesDir(), "recommemd_emotion_file__" + paramInt + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).exists()) {}
  ...
  public void d(int paramInt)
  {
    ...
    ((oidb_0x5eb.ReqBody)localObject).rpt_uint64_uins.add(Long.valueOf(Long.parseLong(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())));
