  ...
  extends BusinessHandler
{
  ...
  private void a(int paramInt1, int paramInt2, String paramString1, String paramString2)
  {
    ...
    BaseActivity.sTopActivity.overridePendingTransition(2130772314, 2130771992);
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      localObject = this.appRuntime.getAccount() + ":" + SimpleDateFormat.getDateInstance().format(new Date());
