...
{
  private static GuardConfig jdField_a_of_type_ComTencentMobileqqAppGuardConfig;
  ...
  {
    if (jdField_a_of_type_ComTencentMobileqqAppGuardConfig == null) {}
    try
    {
      if (jdField_a_of_type_ComTencentMobileqqAppGuardConfig == null) {
        jdField_a_of_type_ComTencentMobileqqAppGuardConfig = new GuardConfig();
      }
      return jdField_a_of_type_ComTencentMobileqqAppGuardConfig;
    }
    finally {}
  }
  ...
  private String[] a()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("GuardManager", 2, "config = " + (String)localObject);
    }
    ...
    for (localObject = localObject[(((IDPCApi)QRoute.api(IDPCApi.class)).getAbRamdom() % localObject.length)];; localObject = localObject[0])
    {
 ...
 * Qualified Name:     com.tencent.mobileqq.app.GuardConfig
