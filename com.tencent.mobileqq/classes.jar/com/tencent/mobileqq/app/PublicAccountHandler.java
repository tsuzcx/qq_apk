  ...
  extends BusinessHandler
{
    ...
    for (;;)
    {
      ...
      if (localObject1 != null)
      {
        ...
        for (boolean bool = true;; bool = false)
        {
          ...
          ThreadManager.getUIHandler().post(new zgu(this, l, bool));
  ...
  private void c(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    if ((paramIntent != null) && (paramFromServiceMsg != null) && (paramFromServiceMsg.isSuccess()) && (paramArrayOfByte != null))
    {
      localzha.jdField_a_of_type_Int = 0;
      ...
      for (;;)
      {
        try
        {
          ...
          localzha.jdField_a_of_type_Int = i;
          if (QLog.isColorLevel()) {
          ...
          localzha.jdField_a_of_type_Boolean = true;
          bool1 = false;
          i = 1;
        }
        catch (Exception paramIntent)
        {
          ...
          long l5;
          label494:
          localzha.jdField_a_of_type_Int = -1;
          localzha.jdField_a_of_type_Boolean = true;
          bool1 = false;
          i = 1;
          continue;
        ...
        else
        {
          ...
          localzha.jdField_a_of_type_JavaUtilList = paramFromServiceMsg;
    ...
    for (;;)
    {
      localzha.jdField_a_of_type_Boolean = bool1;
      localzha.jdField_a_of_type_Long = l3;
      paramIntent = (PublicAccountDataManager)this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getManager(55);
      a(paramFromServiceMsg, l1, bool2, localzha.jdField_a_of_type_Boolean);
      if (localzha.jdField_a_of_type_Boolean)
      {
        ...
        paramIntent = new zgy(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, paramIntent);
        ThreadManager.getSubThreadHandler().postDelayed(paramIntent, 15000L);
        ThreadManager.getSubThreadHandler().postDelayed(new zgv(this), 500L);
      }
      if (!localzha.jdField_a_of_type_Boolean)
      {
        if (bool2) {
      ...
      QLog.d("PublicAccountHandler", 2, "<<---handleGetUserFollowList " + localzha.jdField_a_of_type_Int);
      bool1 = bool2;
      i = j;
      break;
      label840:
  ...
  public void a(int paramInt, PublicAccountHandler.IWeatherInfoListener paramIWeatherInfoListener)
  {
    ...
    SosoInterface.a(new zgw(this, 0, false, true, 60000L, true, false, "PublicAccountHandler", paramInt, paramIWeatherInfoListener));
  }
  ...
  {
    zgz localzgz = new zgz();
    localzgz.jdField_a_of_type_Int = 0;
    ...
    {
      localzgz.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo = PublicAccountInfo.createPublicAccount((AccountDetail)paramObject, l);
      ((PublicAccountDataManager)localObject).a((AccountDetail)paramObject);
      ((PublicAccountDataManager)localObject).a(localzgz.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo);
      ...
      if ((paramObject instanceof AccountDetail)) {
        ServiceAccountFolderManager.a().a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, localzgz.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.getUin());
      }
      localObject = (EcShopAssistantManager)this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getManager(87);
      if (localObject != null) {
        if (localzgz.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo != null) {
          break label183;
        }
      }
    }
    label183:
    for (paramObject = null;; paramObject = localzgz.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.getUin())
    {
      ...
      localzgz.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo = PublicAccountInfo.createPublicAccount((EqqDetail)paramObject, l);
      break;
    }
  }
  ...
  public void b(Object paramObject)
  {
    ...
    if ((paramObject instanceof AccountDetail))
    {
      ...
      ((PublicAccountDataManager)localObject).b(localzgz.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo);
      if ((paramObject instanceof EqqDetail))
      {
