    ...
    for (;;)
    {
      try
      {
        ...
        try
        {
          ...
          this.b.getSubAccountKey(this.b.getAccount(), ((SubAccountBackProtocData)localObject).c, new zuf(this, (SubAccountBackProtocData)localObject, paramFromServiceMsg, bool2));
          i = 0;
        }
        catch (Exception paramToServiceMsg)
        {
