...
public class DynamicSplashManager
{
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        SharedPreUtils.a(BaseApplicationImpl.getContext(), paramInt, j, k, m, (String)localObject1, (String)localObject3, paramString);
        if (QLog.isColorLevel()) {
  ...
  private static boolean a(String paramString1, String paramString2)
  {
    ...
    //   47: iconst_1
    //   48: ldc_w 265
    //   51: invokestatic 36	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   54: iload 7
    //   56: istore 8
    //   58: iconst_0
    //   59: ifeq -31 -> 28
    ...
    //   101: iconst_1
    //   102: ldc_w 270
    //   105: invokestatic 36	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   108: iload 7
    //   110: istore 8
    //   112: iconst_0
    //   113: ifeq -85 -> 28
    ...
    //   151: ldc 30
    //   153: iconst_1
    //   154: new 38	java/lang/StringBuilder
    //   157: dup
    //   158: invokespecial 39	java/lang/StringBuilder:<init>	()V
    //   161: ldc_w 272
    //   164: invokevirtual 45	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   167: aload 10
    ...
    //   178: invokestatic 36	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   181: iload_2
    //   182: iconst_1
    //   183: iadd
    //   184: istore_2
    ...
    //   188: ldc 30
    //   190: iconst_1
    //   191: new 38	java/lang/StringBuilder
    //   194: dup
    //   195: invokespecial 39	java/lang/StringBuilder:<init>	()V
    //   198: ldc_w 277
    //   201: invokevirtual 45	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   204: aload 11
    //   206: arraylength
    //   207: invokevirtual 48	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   210: invokevirtual 52	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   213: invokestatic 36	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   216: aload 11
    //   218: arraylength
    //   219: ifgt +31 -> 250
    //   222: ldc 30
    //   224: iconst_1
    //   225: ldc_w 279
    //   228: invokestatic 36	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   231: iload 7
    //   233: istore 8
    //   235: iconst_0
    //   236: ifeq -208 -> 28
    ...
    //   267: ldc_w 281
    //   270: invokevirtual 45	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   273: iload 4
    //   275: invokevirtual 48	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   278: invokevirtual 52	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   281: invokestatic 36	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    ...
    //   328: ldc 30
    //   330: iconst_1
    //   331: new 38	java/lang/StringBuilder
    //   334: dup
    //   335: invokespecial 39	java/lang/StringBuilder:<init>	()V
    //   338: ldc_w 299
    ...
    //   352: invokestatic 36	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   355: aload 10
    //   357: astore_0
    //   358: aload 11
    ...
    //   372: iload_2
    //   373: iload 4
    //   375: if_icmpeq +405 -> 780
    //   378: aload 10
    //   380: astore_0
    //   381: ldc 30
    //   383: iconst_1
    //   384: ldc_w 304
    //   387: invokestatic 36	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   390: iload 9
    //   392: istore 7
    //   394: iload 7
    //   396: istore 8
    ...
    //   444: aload 10
    //   446: astore_0
    //   447: new 38	java/lang/StringBuilder
    //   450: dup
    //   451: invokespecial 39	java/lang/StringBuilder:<init>	()V
    //   454: aload_1
    //   455: invokevirtual 45	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   458: ldc 216
    //   460: invokevirtual 45	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   463: aload 11
    //   465: iconst_0
    //   466: aaload
    ...
    //   478: ldc 30
    //   480: iconst_1
    //   481: new 38	java/lang/StringBuilder
    //   484: dup
    //   485: invokespecial 39	java/lang/StringBuilder:<init>	()V
    //   488: ldc_w 315
    //   491: invokevirtual 45	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   494: aload 12
    //   496: invokevirtual 45	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   499: invokevirtual 52	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   502: invokestatic 36	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   505: aload 10
    //   507: astore_0
    ...
    //   535: iconst_1
    //   536: ldc_w 317
    //   539: invokestatic 36	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   542: iconst_0
    //   543: istore 7
    //   545: goto -173 -> 372
    //   548: aload 10
    ...
    //   617: aload 11
    //   619: iconst_1
    //   620: new 38	java/lang/StringBuilder
    //   623: dup
    //   624: invokespecial 39	java/lang/StringBuilder:<init>	()V
    //   627: ldc_w 319
    //   630: invokevirtual 45	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   633: aload 11
    //   635: iconst_1
    //   636: aaload
    //   637: invokevirtual 45	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   640: invokevirtual 52	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   643: aastore
    //   644: iload_3
    //   645: iconst_1
    //   646: iadd
    ...
    //   698: ldc 30
    //   700: iconst_1
    //   701: new 38	java/lang/StringBuilder
    //   704: dup
    //   705: invokespecial 39	java/lang/StringBuilder:<init>	()V
    //   708: ldc_w 321
    //   711: invokevirtual 45	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   714: aload_1
    ...
    //   733: ifnull -705 -> 28
    //   736: aload 10
    //   738: invokevirtual 307	java/io/BufferedReader:close	()V
    //   741: iload 7
    //   743: ireturn
    //   744: astore_0
    //   745: iload 7
    ...
    //   752: ifnull +7 -> 759
    //   755: aload_0
    //   756: invokevirtual 307	java/io/BufferedReader:close	()V
    //   759: aload_1
    //   760: athrow
    //   761: astore_0
    //   762: goto -3 -> 759
    ...
    //   0	789	0	paramString1	String
    //   0	789	1	paramString2	String
    //   139	546	2	i	int
    //   137	511	3	j	int
    //   255	121	4	k	int
    //   589	22	5	m	int
    //   601	10	6	n	int
    //   4	781	7	bool1	boolean
    //   8	722	8	bool2	boolean
    //   1	390	9	bool3	boolean
    //   81	656	10	localObject1	Object
    //   132	530	11	localObject2	Object
    ...
    //   736	741	744	java/lang/Exception
    //   31	54	748	finally
    //   73	99	748	finally
    //   99	108	748	finally
    //   127	138	748	finally
    ...
    //   188	231	748	finally
    //   250	308	748	finally
    //   755	759	761	java/lang/Exception
    //   313	320	765	finally
    //   328	355	765	finally
    //   358	364	765	finally
    //   381	390	765	finally
    ...
    //   659	670	765	finally
    //   698	727	765	finally
    //   313	320	769	java/lang/Exception
    //   328	355	769	java/lang/Exception
    //   358	364	769	java/lang/Exception
    //   418	428	769	java/lang/Exception
    //   431	438	769	java/lang/Exception
    //   447	475	769	java/lang/Exception
    //   478	505	769	java/lang/Exception
    //   508	519	769	java/lang/Exception
    //   522	530	769	java/lang/Exception
    //   533	542	769	java/lang/Exception
    //   551	558	769	java/lang/Exception
    //   566	581	769	java/lang/Exception
    //   584	591	769	java/lang/Exception
    //   594	603	769	java/lang/Exception
    //   617	644	769	java/lang/Exception
    //   659	670	769	java/lang/Exception
    //   381	390	776	java/lang/Exception
  }
