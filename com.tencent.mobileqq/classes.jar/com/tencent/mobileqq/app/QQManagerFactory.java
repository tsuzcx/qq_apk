...
import com.tencent.mobileqq.profilecard.bussiness.anonymous.manager.AnonymousManager;
...
public final class QQManagerFactory
{
  ...
  public static final int GAME_PUB_ACCOUNT_MSG_MANAGER;
  ...
  public static final int RED_POINT_INFO_MANAGER;
  ...
  static
  {
    ...
    i = sManagerStart;
    sManagerStart = i + 1;
    RED_POINT_INFO_MANAGER = i;
    i = sManagerStart;
    sManagerStart = i + 1;
    TROOP_LUCKY_CHARACTER_MANAGER = i;
    i = sManagerStart;
    sManagerStart = i + 1;
    GAME_PUB_ACCOUNT_MSG_MANAGER = i;
    i = sManagerStart;
    sManagerStart = i + 1;
    ...
    for (;;)
    {
      ...
      catch (Exception paramQQAppInterface)
      {
        ...
        if ((paramQQAppInterface instanceof InvocationTargetException))
        {
          ...
          CaughtExceptionReport.a(((InvocationTargetException)paramQQAppInterface).getTargetException());
        }
        paramQQAppInterface = localManager;
      }
    }
  ...
  private static void lazyLoadManager()
  {
    ...
    sManagerArrays.put(EMOTICON_MANAGER, EmoticonManager.class);
    sManagerArrays.put(SHIELD_LIST_MANAGER, ShieldMsgManger.class);
    sManagerArrays.put(STT_MANAGER, SliceSttManager.class);
    sManagerArrays.put(RECOMMEND_TROOP_MANAGER, RecommendTroopManagerImp.class);
    sManagerArrays.put(MGR_FILE_TRANS, FileTransferManager.class);
    sManagerArrays.put(MGR_MEDIA_PLAYER, MediaPlayerManager.class);
    sManagerArrays.put(MGR_TROOP_CREATE, TroopCreateLogic.class);
    ...
    sManagerArrays.put(CHAT_EMOTION_MANAGER, EmojiManager.class);
    ...
    sManagerArrays.put(PTT_CFG_MANAGER, PttConfigController.class);
    ...
    sManagerArrays.put(PA_REPORT_MANAGER, PAReportManager.class);
    sManagerArrays.put(PHONE_UNITY_MANAGER, PhoneUnityManager.class);
    sManagerArrays.put(FAV_ROAMING_MANAGER, FavroamingManager.class);
    ...
    sManagerArrays.put(TROOP_APP_MGR, TroopAppMgr.class);
    ...
    sManagerArrays.put(NEARBY_CARD_MANAGER, NearbyCardManager.class);
    sManagerArrays.put(ODPROXY_MGR, ODProxy.class);
    sManagerArrays.put(TROOP_GIFT_MANAGER, TroopGiftManager.class);
    sManagerArrays.put(WEATHER_MANAGER, WeatherManager.class);
    sManagerArrays.put(NEARBY_PROXY_MANAGER, NearbyProxy.class);
    ...
    sManagerArrays.put(PTT_PRE_SEND_MANAGER, PttPreSendManager.class);
    sManagerArrays.put(PTT_PRE_DOWNLOAD_MANAGER, PTTPreDownloader.class);
    sManagerArrays.put(ARK_APP_CENTER_MANAGER, ArkAppCenter.class);
    sManagerArrays.put(PASSWD_RED_BAG_MANAGER, PasswdRedBagManager.class);
    sManagerArrays.put(HOTCHAT_SCENE_CONFIG_MANAGER, HotchatSCMng.class);
    sManagerArrays.put(BUSINESS_CARD_MANAGER, BusinessCardManager.class);
    sManagerArrays.put(FTSDB_MANAGER, FTSDBManager.class);
    sManagerArrays.put(QR_PROCESS_MANAGER, QRProcessManager.class);
    ...
    sManagerArrays.put(PUBLIC_QUICK_PAY_MANAGER, PublicQuickPayManager.class);
    sManagerArrays.put(LBS_REPORT_MANAGER, LbsInfoReportManager.class);
    sManagerArrays.put(APOLLO_RECENTMANAGER, ApolloRecentManager.class);
    sManagerArrays.put(QCALLCARD_MANAGER, QCallCardManager.class);
    sManagerArrays.put(MQQ_COMIC_MANAGER, VipComicMqqManager.class);
    sManagerArrays.put(QQCOMIC_PRELOAD_MANAGER, QQComicPreloadManager.class);
    sManagerArrays.put(TROOP_REWARD_MGR, TroopRewardMgr.class);
    sManagerArrays.put(FAVROAMING_DB_MANAGER, FavroamingDBManager.class);
    sManagerArrays.put(CAMERA_EMOTION_DB_MANAGER, CameraEmotionRoamingDBManager.class);
    sManagerArrays.put(EMOFROMGROUP_DB_MANAGER, EmoticonFromGroupDBManager.class);
    sManagerArrays.put(PULL_ACTIVE_MANAGER, PullActiveManager.class);
    sManagerArrays.put(NEARBY_GENERAL_MANAGER, NearByGeneralManager.class);
    sManagerArrays.put(QQCOMIC_UPLOAD_MANAGER, VipComicEmoticonUploadManager.class);
    ...
    sManagerArrays.put(READINJOY_ACT_DAU_REPORT_MANAGER, ReadInJoyDAUStatistic.class);
    sManagerArrays.put(READINJOY_LOGIC_MANAGER, ReadInJoyLogicManager.class);
    ...
    sManagerArrays.put(ONLINE_STATUS_PERMISSION_MANAGER, OnlineStatusPermissionManager.class);
    sManagerArrays.put(QZONE_PLUGIN_MANAGER, QZonePluginManager.class);
    sManagerArrays.put(VOICE_CHANGE_MANAGER, VoiceChangeManager.class);
    sManagerArrays.put(FUNCTION_MODULE_MANAGER, FunctionModuleConfigManager.class);
    sManagerArrays.put(PRECOVER_MANAGER, PrecoverManager.class);
    sManagerArrays.put(THEME_MANAGER, ThemeSwitchManager.class);
    ...
    sManagerArrays.put(AIO_GROUP_APPS_MANAGER, AioGroupAppsManager.class);
    ...
    sManagerArrays.put(COMMERCIAL_DRAINAGE_MANAGER, CommercialDrainageManager.class);
    ...
    sManagerArrays.put(FACE_SCORE_MANAGER, NearbyFaceScoreManager.class);
    sManagerArrays.put(HOT_PIC_MANAGER, HotPicManager.class);
    sManagerArrays.put(EMOTION_SEARCH_MANAGER, EmotionSearchManager.class);
    sManagerArrays.put(NEARBY_LIKE_LIMIT_MANAGER, NearbyLikeLimitManager.class);
    ...
    sManagerArrays.put(APOLLO_GAME_MANAGER, ApolloGameManager.class);
    sManagerArrays.put(COMIC_RED_TOUCH_MANAGER, QQComicRedTouchManager.class);
    sManagerArrays.put(DOUTU_MAGAGER, DoutuManager.class);
    ...
    sManagerArrays.put(HIBOOM_MANAGER, HiBoomManager.class);
    ...
    sManagerArrays.put(READINJOY_VIDEO_UPLOAD_MANAGER, VideoUploadManager.class);
    sManagerArrays.put(OCR_MANAGER, OCRManager.class);
    ...
    sManagerArrays.put(TROOP_ONLINE_MEMBER_MANAGER, TroopOnlineMemberManager.class);
    ...
    sManagerArrays.put(QR_MAIN_PROC_MANAGER, QrMainProcManager.class);
    sManagerArrays.put(WEREWOLVES_MANAGER, WerewolvesDataManager.class);
    sManagerArrays.put(AV_REDPACKET_CONFIG_MGR, AVRedPacketConfigManager.class);
    sManagerArrays.put(BUSINESS_COMMON_CONFIG_MANAGER, BusinessCommonConfig.class);
    sManagerArrays.put(QWALLET_CONFIG_MANAGER, QWalletConfigManager.class);
    sManagerArrays.put(KANDIAN_NATIVE_AD_PRELOAD_MANAGER, NativeAdPreloadManager.class);
    ...
    sManagerArrays.put(SPORT_MANAGER, SportManager.class);
    ...
    sManagerArrays.put(READ_INJOY_SKIN_MANAGER, ReadInJoySkinManager.class);
    sManagerArrays.put(NEARBY_MOMENT_MANAGER, NearbyMomentManager.class);
    ...
    sManagerArrays.put(READ_INJOY_REFRESH_MANAGER, ReadInJoyRefreshManager.class);
    sManagerArrays.put(READ_IN_JOY_OPERATION_MANAGER, ReadInJoyOperationManager.class);
    ...
    sManagerArrays.put(QWALLET_RED_MANAGER, QWalletRedManager.class);
    ...
    sManagerArrays.put(NOW_DYNAMIC_MANAGER, DynamicNowManager.class);
    sManagerArrays.put(PUSH_NOTIFICATION_MANAGER, PushNotificationManager.class);
    sManagerArrays.put(KANDIAN_AD_EXPOSURE_MANAGER, ReadInjoyADExposureManager.class);
    ...
    sManagerArrays.put(STICKER_RECOMMEND_MANAGER, StickerRecManager.class);
    ...
    sManagerArrays.put(AUTO_REPLY_MANAGER, AutoReplyManager.class);
    sManagerArrays.put(MULTI_CHOOSE_SAVE_MANAGER, MultiRichMediaSaveManager.class);
    sManagerArrays.put(MEDIA_MSG_ORDER_SEND_MANAGER, OrderMediaMsgManager.class);
    ...
    sManagerArrays.put(CAMERA_EMOTION_MANAGER, CameraEmoRoamingManager.class);
    sManagerArrays.put(READINJOY_AD_MATERIAL_MANAGER, AdMaterialResManager.class);
    sManagerArrays.put(QASSISTANT_MANAGER, QAssistantManager.class);
    sManagerArrays.put(WATCH_LIVE_TOGETHER, WatchTogetherManager.class);
    sManagerArrays.put(READER_RED_TOUCH_MANAGER, ReaderRedTouchManager.class);
    ...
    sManagerArrays.put(PIC_OCR_MANAGER, PicOcrManager.class);
    sManagerArrays.put(TROOP_SHORTCUTBAR_MANAGER, TroopShortcutBarManager.class);
    sManagerArrays.put(STUDY_ROOM_MANAGER, StudyRoomManager.class);
    sManagerArrays.put(AUDIO_DEVICE_MANAGER, AudioDeviceManager.class);
    sManagerArrays.put(RIJ_UGC_VIDEO_PUBLISH_MANAGER, RIJUgcVideoPublishManager.class);
    ...
    sManagerArrays.put(GAME_CENTER_MSG_MANAGER, GameMsgManager.class);
    sManagerArrays.put(QWALLET_GDT_AD_MANAGER, QWalletGdtAdManager.class);
    ...
    sManagerArrays.put(VOICE_ASSISTANT_MANAGER, VoiceAssistantManager.class);
    sManagerArrays.put(ANONYMOUS_ANSWER_MANAGER, AnonymousManager.class);
    sManagerArrays.put(ILIVE_GROUP_TIPS_MANAGER, IliveGroupTipsManager.class);
    sManagerArrays.put(MINI_CARD_MANAGER, MiniCardManager.class);
    sManagerArrays.put(RED_POINT_INFO_MANAGER, RedPointInfoManager.class);
    sManagerArrays.put(TROOP_LUCKY_CHARACTER_MANAGER, TroopLuckyCharacterManager.class);
    sManagerArrays.put(GAME_PUB_ACCOUNT_MSG_MANAGER, GamePubAccountMsgManager.class);
