  ...
  implements Manager
{
  ...
  private void a(int paramInt, long paramLong, byte[] paramArrayOfByte)
  {
    try
    {
      ...
      else
      {
        ...
        {
          ThreadManager.post(new zsw(this, paramLong, paramArrayOfByte), 8, null, true);
          return;
        }
      }
    }
  ...
  public static void a(AppInterface paramAppInterface, int paramInt, String paramString)
  {
    ...
    ThreadManager.post(new zsx(paramAppInterface, paramInt, paramString), 5, null, true);
  }
  ...
  {
    a(2, paramLong, paramInt, new zsv(this, paramLong));
  }
