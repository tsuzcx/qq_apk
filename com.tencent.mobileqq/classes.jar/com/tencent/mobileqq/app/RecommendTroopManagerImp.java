  ...
  implements Manager
{
  ...
  private SosoInterfaceOnLocationListener jdField_a_of_type_ComTencentMobileqqSosoLocationSosoInterfaceOnLocationListener = new RecommendTroopManagerImp.2(this, 3, true, true, 60000L, false, false, "TroopNotifyAndRecommendView");
  protected Object a;
  ...
  {
    paramQQAppInterface = paramQQAppInterface.getMessageFacade().b(AppConstants.RECOMMEND_TROOP_UIN, 4001);
    int j;
  ...
  private void a(long paramLong, oidb_0x935.RspBody paramRspBody)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppTroopHandler.notifyUI(TroopNotificationConstants.D, true, this.jdField_b_of_type_JavaUtilList);
  }
      ...
      try
      {
        ...
        if (j < this.jdField_a_of_type_JavaUtilList.size())
        {
          ...
          if (k == 0)
          {
            ...
            localObject = MessageRecordFactory.a(-1039);
    ...
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      while (k >= 0)
      {
        ...
        if (paramHashMap.msgtype == -1039)
        {
          ...
          if (j > paramInt)
          {
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().b(paramHashMap.frienduin, paramHashMap.istroop, paramHashMap.uniseq);
  ...
  private void e()
  {
    ...
    try
    {
      ...
      if ((localObject == null) || (!((TroopNotificationEntryConfig)localObject).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())))
      {
        ...
        localObject = (RecentManagerFor3rdPart)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.RECENT_MANAGER_FOR_3RDPART);
        MessageRecord localMessageRecord = a();
        if ((localMessageRecord != null) && (!((RecentManagerFor3rdPart)localObject).a(AppConstants.TROOP_NOTIFICATION_UIN, 9000, localMessageRecord.time))) {
          ((RecentManagerFor3rdPart)localObject).a(AppConstants.TROOP_NOTIFICATION_UIN, 9000, HardCodeUtil.a(2131691181), localMessageRecord.time, localMessageRecord.time);
        }
        if (QLog.isColorLevel()) {
  ...
  public MessageRecord a()
  {
    try
    {
      List localList = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().b(AppConstants.RECOMMEND_TROOP_UIN, 4001);
      if ((localList != null) && (localList.size() > 0))
      {
        int i = localList.size() - 1;
        while (i >= 0)
  ...
  public String a()
  {
    try
    {
      Object localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().b(AppConstants.RECOMMEND_TROOP_UIN, 4001);
  ...
  {
    a(2, paramGPS, paramInt, new RecommendTroopManagerImp.1(this, paramLong));
  }
  ...
  public void a(List<group_activity.GroupAct> paramList)
  {
    ...
    for (;;)
    {
      ...
      if (localObject != null)
      {
        paramList = MessageRecordFactory.a(-1040);
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().b(-1040);
      }
      ...
      if ((localArrayList.size() >= 1) || ((localArrayList.size() == 1) && (localObject == null)))
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().b(-1039);
      }
      for (;;)
      {
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().a(localArrayList, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount());
        this.jdField_a_of_type_JavaUtilList.clear();
        f();
        e();
        return;
        label396:
        a(paramList, i, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().b(AppConstants.RECOMMEND_TROOP_UIN, 4001));
      }
      paramList = null;
    }
  }
  ...
  public void b()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().a(-1039);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().a(-1040);
