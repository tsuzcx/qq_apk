...
public class TroopHandler$6
  implements Runnable
{
  public TroopHandler$6(ajtg paramajtg, String paramString) {}
  
  public void run()
  {
    Object localObject = (azrx)this.this$0.app.getManager(234);
    if ((((azrx)localObject).a(this.a) != 3) && (NetConnInfoCenter.getServerTime() < ((azrx)localObject).c(this.a)))
    {
      if (QLog.isColorLevel()) {
        QLog.i("TroopHandler", 2, "getAllOnlineMemberList, too frequency");
      }
      localObject = ((azrx)localObject).b(this.a);
    ...
    for (;;)
    {
      try
      {
        if (((azrx)localObject).a(this.a) == 3)
        {
          i = 4;
