  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      ((aukp)localObject1).b(this.jdField_a_of_type_ComTencentMobileqqDataSetting);
      ((aukp)localObject1).a();
      if (this.jdField_a_of_type_AvatarInfoQQHeadInfo.dstUsrType == 32)
      {
        ...
        if (localObject1 != null) {
          ((bazf)localObject1).a(32, this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo.b);
        }
      }
    ...
    for (;;)
    {
      try
      {
        int j = bbfj.b(QQHeadDownloadHandler.a(this.this$0).getApp());
      ...
      catch (Throwable localThrowable)
      {
        ...
        bbac.a((String)localObject1);
        bbac.b((String)localObject1);
        bbac.a(QQHeadDownloadHandler.a(this.this$0), (String)localObject1);
        continue;
        bbac.a((String)localObject1);
        bbac.b((String)localObject1);
        bbac.a(QQHeadDownloadHandler.a(this.this$0), (String)localObject1);
      ...
      ((aukp)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqDataSetting);
      break;
