  ...
  public void run()
  {
    for (;;)
    {
      ...
      catch (Throwable localThrowable)
      {
        ...
        l3 = akag.a().jdField_a_of_type_Int * l2 / 100L;
        if (l1 < l3) {
          continue;
        }
        return;
        ...
        l4 = l5 - l4;
        l5 = akag.a().jdField_a_of_type_Long;
        if (l4 >= l5) {
          continue;
        }
        return;
        ...
        ((ArrayList)localObject4).add(Pair.create(str, Long.valueOf(bbdh.a(localRunningAppProcessInfo.pid))));
        continue;
      }
      finally
      {
      ...
      l2 = l2 * akag.a().jdField_a_of_type_Int / 100L;
      if (l1 >= l2)
      {
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = null;
        this.jdField_a_of_type_AndroidContentContext = null;
      ...
      ((axrn)localObject3).a("", "MemoryClear", true, 0L, 0L, (HashMap)localObject4, "");
    }
  }
}
