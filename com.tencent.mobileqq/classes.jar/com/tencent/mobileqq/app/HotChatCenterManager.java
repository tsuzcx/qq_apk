  ...
  implements Manager
{
  ...
  private HotChatItemData a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (localObject2 == null)
    {
      ...
      localObject2 = ((HotChatManager)paramQQAppInterface.getManager(59)).a(paramString);
      if (localObject2 != null)
      {
        ((HotChatItemData)localObject1).mHotChatCode = ((HotChatInfo)localObject2).name;
        if (((HotChatInfo)localObject2).apolloGameId <= 0)
        {
          ApolloGameData localApolloGameData = ((ApolloDaoManager)paramQQAppInterface.getManager(154)).a(((HotChatInfo)localObject2).name);
  ...
  private void d()
  {
    ...
    do
    {
      ...
      try
      {
        localRecentUserProxy = localQQAppInterface.a().a();
        ...
        if ((localObject2 != null) && (((List)localObject2).size() > 0))
        {
          ...
          while (((Iterator)localObject2).hasNext())
          {
            ...
            if ((((RecentUser)localObject3).type == 1) && ((((RecentUser)localObject3).lFlag & 1L) != 0L)) {
  ...
  private void d(String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        paramString = ((HotChatManager)((QQAppInterface)localObject).getManager(59)).a(paramString);
        if ((paramString != null) && (paramString.apolloGameId > 0))
        {
          localHotChatItemData.mGameId = paramString.apolloGameId;
          return;
        }
        localObject = ((ApolloDaoManager)((QQAppInterface)localObject).getManager(154)).a(localHotChatItemData.mHotChatCode);
  ...
  private void g()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 41	com/tencent/mobileqq/app/HotChatCenterManager:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   4: invokevirtual 250	java/util/concurrent/CopyOnWriteArrayList:size	()I
    //   7: ifne +4 -> 11
    //   10: return
    //   11: aload_0
    //   12: invokevirtual 315	com/tencent/mobileqq/app/HotChatCenterManager:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   15: astore_3
    //   16: aload_3
    //   17: ifnull -7 -> 10
    //   20: aload_3
    //   21: bipush 59
    //   23: invokevirtual 119	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   26: checkcast 121	com/tencent/mobileqq/app/HotChatManager
    //   29: astore 4
    //   31: aload_0
    //   32: getfield 41	com/tencent/mobileqq/app/HotChatCenterManager:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   35: invokevirtual 250	java/util/concurrent/CopyOnWriteArrayList:size	()I
    //   38: istore_1
    //   39: aconst_null
    //   40: astore_2
    //   41: aload_3
    //   42: invokevirtual 461	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lcom/tencent/mobileqq/persistence/EntityManagerFactory;
    //   45: invokevirtual 467	com/tencent/mobileqq/persistence/EntityManagerFactory:createEntityManager	()Lcom/tencent/mobileqq/persistence/EntityManager;
    //   48: astore_3
    //   49: aload_3
    //   50: astore_2
    //   51: iload_1
    ...
    //   56: iflt +107 -> 163
    //   59: aload_0
    //   60: getfield 41	com/tencent/mobileqq/app/HotChatCenterManager:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   63: iload_1
    //   64: invokevirtual 253	java/util/concurrent/CopyOnWriteArrayList:get	(I)Ljava/lang/Object;
    //   67: checkcast 110	com/tencent/mobileqq/data/HotChatItemData
    //   70: astore_3
    //   71: aload_0
    //   72: aload_3
    //   73: getfield 115	com/tencent/mobileqq/data/HotChatItemData:mTroopUin	Ljava/lang/String;
    //   76: invokespecial 469	com/tencent/mobileqq/app/HotChatCenterManager:d	(Ljava/lang/String;)V
    //   79: aload 4
    //   81: aload_3
    //   82: getfield 115	com/tencent/mobileqq/data/HotChatItemData:mTroopUin	Ljava/lang/String;
    //   85: invokevirtual 472	com/tencent/mobileqq/app/HotChatManager:b	(Ljava/lang/String;)Z
    //   88: ifne +68 -> 156
    //   91: aload_3
    //   92: getfield 149	com/tencent/mobileqq/data/HotChatItemData:mGameId	I
    //   95: ifne +61 -> 156
    //   98: ldc 21
    //   100: iconst_1
    //   101: new 177	java/lang/StringBuilder
    //   104: dup
    //   105: invokespecial 178	java/lang/StringBuilder:<init>	()V
    //   108: aload_3
    //   109: getfield 132	com/tencent/mobileqq/data/HotChatItemData:mHotChatCode	Ljava/lang/String;
    //   112: invokevirtual 184	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   115: ldc_w 474
    ...
    //   124: invokestatic 29	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   127: aload_0
    //   128: getfield 52	com/tencent/mobileqq/app/HotChatCenterManager:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   131: aload_3
    //   132: getfield 115	com/tencent/mobileqq/data/HotChatItemData:mTroopUin	Ljava/lang/String;
    //   135: invokeinterface 476 2 0
    //   140: pop
    //   141: aload_0
    //   142: getfield 41	com/tencent/mobileqq/app/HotChatCenterManager:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   145: iload_1
    //   146: invokevirtual 478	java/util/concurrent/CopyOnWriteArrayList:remove	(I)Ljava/lang/Object;
    //   149: pop
    //   150: aload_2
    //   151: aload_3
    //   152: invokevirtual 483	com/tencent/mobileqq/persistence/EntityManager:b	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   155: pop
    //   156: iload_1
    //   157: iconst_1
    //   158: isub
    ...
    //   164: ifnull -154 -> 10
    //   167: aload_2
    //   168: invokevirtual 485	com/tencent/mobileqq/persistence/EntityManager:a	()V
    //   171: return
    //   172: astore_3
    //   173: ldc 21
    //   175: iconst_1
    ...
    //   181: invokestatic 360	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   184: aload_2
    //   185: ifnull -175 -> 10
    //   188: aload_2
    //   189: invokevirtual 485	com/tencent/mobileqq/persistence/EntityManager:a	()V
    //   192: return
    //   193: astore_3
    //   194: aconst_null
    //   195: astore_2
    ...
    //   197: ifnull +7 -> 204
    //   200: aload_2
    //   201: invokevirtual 485	com/tencent/mobileqq/persistence/EntityManager:a	()V
    //   204: aload_3
    //   205: athrow
    //   206: astore_3
    //   207: goto -11 -> 196
    ...
    //   0	218	0	this	HotChatCenterManager
    //   38	122	1	i	int
  ...
  public boolean a(String paramString, int paramInt)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      {
        ((VasExtensionHandler)localQQAppInterface.a(71)).a(localHotChatItemData.mGameId, "android.aio", false, 2, localHotChatItemData.mHotChatCode);
  ...
  public boolean b(String paramString)
  {
    ...
    //   3: istore 4
    //   5: aload_0
    //   6: invokevirtual 315	com/tencent/mobileqq/app/HotChatCenterManager:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   9: astore 6
    //   11: aload 6
    //   13: ifnull +10 -> 23
    //   16: aload_1
    //   17: invokestatic 219	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   20: ifeq +9 -> 29
    //   23: iconst_0
    //   24: istore 4
    //   26: iload 4
    //   28: ireturn
    //   29: aload 6
    //   31: invokevirtual 461	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lcom/tencent/mobileqq/persistence/EntityManagerFactory;
    //   34: invokevirtual 467	com/tencent/mobileqq/persistence/EntityManagerFactory:createEntityManager	()Lcom/tencent/mobileqq/persistence/EntityManager;
    //   37: astore 5
    //   39: aload_0
    //   40: getfield 52	com/tencent/mobileqq/app/HotChatCenterManager:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   43: aload_1
    //   44: invokeinterface 476 2 0
    //   49: checkcast 110	com/tencent/mobileqq/data/HotChatItemData
    //   52: astore 7
    //   54: invokestatic 153	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   57: ifeq +259 -> 316
    //   60: ldc 21
    //   62: iconst_2
    //   63: iconst_4
    ...
    //   84: iconst_3
    //   85: aload 7
    //   87: getfield 132	com/tencent/mobileqq/data/HotChatItemData:mHotChatCode	Ljava/lang/String;
    //   90: aastore
    //   91: invokestatic 167	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   94: goto +222 -> 316
    //   97: iload_2
    //   98: aload_0
    //   99: getfield 41	com/tencent/mobileqq/app/HotChatCenterManager:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   102: invokevirtual 250	java/util/concurrent/CopyOnWriteArrayList:size	()I
    //   105: if_icmpge +36 -> 141
    //   108: aload_1
    //   109: aload_0
    //   110: getfield 41	com/tencent/mobileqq/app/HotChatCenterManager:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   113: iload_2
    //   114: invokevirtual 253	java/util/concurrent/CopyOnWriteArrayList:get	(I)Ljava/lang/Object;
    //   117: checkcast 110	com/tencent/mobileqq/data/HotChatItemData
    //   120: getfield 115	com/tencent/mobileqq/data/HotChatItemData:mTroopUin	Ljava/lang/String;
    //   123: invokevirtual 243	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   126: ifeq +195 -> 321
    //   129: aload_0
    //   130: getfield 41	com/tencent/mobileqq/app/HotChatCenterManager:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   133: iload_2
    //   134: invokevirtual 478	java/util/concurrent/CopyOnWriteArrayList:remove	(I)Ljava/lang/Object;
    //   137: pop
    //   138: goto +183 -> 321
    //   141: aload 7
    //   143: ifnull +167 -> 310
    ...
    //   160: aconst_null
    //   161: iconst_0
    //   162: invokestatic 491	com/tencent/mobileqq/app/ThreadManager:post	(Ljava/lang/Runnable;ILcom/tencent/mobileqq/app/ThreadExcutor$IThreadListener;Z)V
    //   165: aload_0
    //   166: aload_1
    //   167: aload 6
    //   169: invokespecial 673	com/tencent/mobileqq/app/HotChatCenterManager:a	(Ljava/lang/String;Lcom/tencent/mobileqq/app/QQAppInterface;)V
    //   172: iload 4
    //   174: istore_3
    //   175: aload_0
    //   176: getfield 41	com/tencent/mobileqq/app/HotChatCenterManager:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   179: invokevirtual 250	java/util/concurrent/CopyOnWriteArrayList:size	()I
    //   182: ifne +39 -> 221
    //   185: iload 4
    //   187: istore_3
    //   188: aload_0
    ...
    //   200: istore_3
    //   201: aload_0
    //   202: invokevirtual 315	com/tencent/mobileqq/app/HotChatCenterManager:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   205: ldc 169
    //   207: ldc 171
    //   209: ldc_w 675
    //   212: iconst_1
    //   213: iconst_0
    //   214: iconst_0
    //   215: anewarray 175	java/lang/String
    //   218: invokestatic 195	com/tencent/mobileqq/utils/VipUtils:a	(Lcom/tencent/common/app/AppInterface;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;II[Ljava/lang/String;)V
    //   221: aload 5
    //   223: ifnull +84 -> 307
    //   226: aload 5
    //   228: invokevirtual 485	com/tencent/mobileqq/persistence/EntityManager:a	()V
    //   231: iload 4
    //   233: ireturn
    //   234: astore_1
    //   235: aconst_null
    ...
    //   241: iconst_1
    //   242: ldc 180
    //   244: invokestatic 677	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   247: iload_3
    //   248: istore 4
    //   250: aload_1
    //   251: ifnull -225 -> 26
    //   254: aload_1
    //   255: invokevirtual 485	com/tencent/mobileqq/persistence/EntityManager:a	()V
    //   258: iload_3
    //   259: ireturn
    //   260: astore_1
    //   261: aconst_null
    ...
    //   266: ifnull +8 -> 274
    //   269: aload 5
    //   271: invokevirtual 485	com/tencent/mobileqq/persistence/EntityManager:a	()V
    //   274: aload_1
    //   275: athrow
    //   276: astore_1
    //   277: goto -13 -> 264
  ...
  public void c()
  {
    ...
    //   3: astore 4
    //   5: aload_0
    //   6: getfield 41	com/tencent/mobileqq/app/HotChatCenterManager:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   9: invokevirtual 250	java/util/concurrent/CopyOnWriteArrayList:size	()I
    //   12: ifle +4 -> 16
    //   15: return
    //   16: invokestatic 153	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   19: ifeq +31 -> 50
    //   22: ldc 21
    //   24: iconst_2
    //   25: iconst_2
    ...
    //   35: dup
    //   36: iconst_1
    //   37: invokestatic 506	java/lang/Thread:currentThread	()Ljava/lang/Thread;
    //   40: invokevirtual 509	java/lang/Thread:getId	()J
    //   43: invokestatic 456	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   46: aastore
    //   47: invokestatic 167	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   50: aload_0
    //   51: invokevirtual 315	com/tencent/mobileqq/app/HotChatCenterManager:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   54: astore_2
    //   55: aload_2
    //   56: ifnull -41 -> 15
    //   59: aload_2
    //   60: invokevirtual 461	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lcom/tencent/mobileqq/persistence/EntityManagerFactory;
    //   63: invokevirtual 467	com/tencent/mobileqq/persistence/EntityManagerFactory:createEntityManager	()Lcom/tencent/mobileqq/persistence/EntityManager;
    //   66: astore_2
    //   67: aload_2
    //   68: ldc 110
    //   70: iconst_0
    ...
    //   75: ldc_w 681
    //   78: aconst_null
    //   79: invokevirtual 684	com/tencent/mobileqq/persistence/EntityManager:a	(Ljava/lang/Class;ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    //   82: astore_1
    //   83: aload_1
    //   84: ifnull +276 -> 360
    //   87: aload_1
    //   88: invokeinterface 348 1 0
    //   93: ifle +267 -> 360
    //   96: aload_1
    //   97: checkcast 344	java/util/ArrayList
    //   100: astore_1
    //   101: aload_1
    //   102: invokevirtual 685	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   105: astore_3
    //   106: aload_3
    //   107: invokeinterface 235 1 0
    //   112: ifeq +50 -> 162
    //   115: aload_3
    //   116: invokeinterface 239 1 0
    //   121: checkcast 110	com/tencent/mobileqq/data/HotChatItemData
    //   124: astore 4
    //   126: aload_0
    //   127: getfield 41	com/tencent/mobileqq/app/HotChatCenterManager:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   130: aload 4
    //   132: invokevirtual 437	java/util/concurrent/CopyOnWriteArrayList:add	(Ljava/lang/Object;)Z
    //   135: pop
    //   136: goto -30 -> 106
    //   139: astore_3
    //   140: aload_2
    ...
    //   150: invokestatic 360	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   153: aload_2
    //   154: ifnull -139 -> 15
    //   157: aload_2
    //   158: invokevirtual 485	com/tencent/mobileqq/persistence/EntityManager:a	()V
    //   161: return
    //   162: aload_0
    //   163: invokespecial 664	com/tencent/mobileqq/app/HotChatCenterManager:f	()V
    //   166: aload_0
    //   167: getfield 52	com/tencent/mobileqq/app/HotChatCenterManager:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   170: invokeinterface 686 1 0
    //   175: aload_1
    //   176: invokevirtual 685	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   179: astore_1
    //   180: aload_1
    //   181: invokeinterface 235 1 0
    //   186: ifeq +46 -> 232
    //   189: aload_1
    //   190: invokeinterface 239 1 0
    //   195: checkcast 110	com/tencent/mobileqq/data/HotChatItemData
    //   198: astore_3
    //   199: aload_0
    //   200: getfield 52	com/tencent/mobileqq/app/HotChatCenterManager:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   203: aload_3
    //   204: getfield 115	com/tencent/mobileqq/data/HotChatItemData:mTroopUin	Ljava/lang/String;
    //   207: aload_3
    //   208: invokeinterface 223 3 0
    //   213: pop
    //   214: goto -34 -> 180
    //   217: astore_1
    //   218: aload_2
    ...
    //   223: ifnull +7 -> 230
    //   226: aload_3
    //   227: invokevirtual 485	com/tencent/mobileqq/persistence/EntityManager:a	()V
    //   230: aload_2
    //   231: athrow
    //   232: aload_0
    //   233: invokespecial 688	com/tencent/mobileqq/app/HotChatCenterManager:g	()V
    //   236: invokestatic 153	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   239: ifeq +121 -> 360
    //   242: ldc 21
    //   244: iconst_2
    //   245: new 177	java/lang/StringBuilder
    //   248: dup
    //   249: invokespecial 178	java/lang/StringBuilder:<init>	()V
    //   252: ldc_w 690
    //   255: invokevirtual 184	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   258: aload_0
    //   259: getfield 41	com/tencent/mobileqq/app/HotChatCenterManager:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   262: invokevirtual 250	java/util/concurrent/CopyOnWriteArrayList:size	()I
    //   265: invokevirtual 187	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   268: invokevirtual 190	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   271: invokestatic 692	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   274: aload_0
    //   275: getfield 41	com/tencent/mobileqq/app/HotChatCenterManager:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   278: invokevirtual 230	java/util/concurrent/CopyOnWriteArrayList:iterator	()Ljava/util/Iterator;
    //   281: astore_1
    //   282: aload_1
    //   283: invokeinterface 235 1 0
    //   288: ifeq +72 -> 360
    //   291: aload_1
    //   292: invokeinterface 239 1 0
    //   297: checkcast 110	com/tencent/mobileqq/data/HotChatItemData
    //   300: astore_3
    //   301: ldc 21
    //   303: iconst_2
    //   304: bipush 6
    ...
    //   316: iconst_1
    //   317: aload_3
    //   318: getfield 149	com/tencent/mobileqq/data/HotChatItemData:mGameId	I
    //   321: invokestatic 163	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   324: aastore
    //   325: dup
    //   326: iconst_2
    //   327: ldc_w 614
    ...
    //   332: iconst_3
    //   333: aload_3
    //   334: getfield 651	com/tencent/mobileqq/data/HotChatItemData:mState	I
    //   337: invokestatic 163	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   340: aastore
    //   341: dup
    //   342: iconst_4
    //   343: ldc_w 696
    ...
    //   348: iconst_5
    //   349: aload_3
    //   350: getfield 132	com/tencent/mobileqq/data/HotChatItemData:mHotChatCode	Ljava/lang/String;
    //   353: aastore
    //   354: invokestatic 167	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   357: goto -75 -> 282
    //   360: aload_2
    //   361: ifnull -346 -> 15
    //   364: aload_2
    //   365: invokevirtual 485	com/tencent/mobileqq/persistence/EntityManager:a	()V
    //   368: return
    //   369: astore_2
    //   370: aload_1
    //   371: astore_3
