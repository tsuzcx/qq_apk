...
public class PrinterHandler
{
  ...
  private DataLineObserver jdField_a_of_type_ComTencentMobileqqAppDataLineObserver = new zqn(this);
  ...
  public void a(int paramInt, Session paramSession, double paramDouble, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      localObject = new zqm(this, paramSession.uSessionID, (Timer)localObject);
      l2 = MessageCache.a();
  ...
  public void a(BaseActivity paramBaseActivity, String paramString)
  {
    if (FileManagerUtil.a())
    {
      ...
      {
        FMDialogUtil.a(paramBaseActivity, 2131428241, 2131428237, new zqo(this, paramBaseActivity, paramString));
        return;
      }
  ...
  public void a(DataLineHandler paramDataLineHandler)
  {
    ...
    if ((((RegisterProxySvcPackHandler)localObject).a() == 0) || (((RegisterProxySvcPackHandler)localObject).h() != 1))
    {
      paramDataLineHandler.b(12, false, null);
      if (this.jdField_a_of_type_JavaUtilHashMap.size() > 0)
      {
        localObject = new Timer();
        ((Timer)localObject).schedule(new zql(this, paramDataLineHandler, (Timer)localObject), 5000L);
      }
    }
  }
  ...
  public void a(DataLineHandler paramDataLineHandler, msg_comm.Msg paramMsg, C2CType0x211_SubC2CType0x9.MsgBody paramMsgBody)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        paramDataLineHandler.a(19, true, new Object[] { Long.valueOf(paramMsg.uint64_printer_din.get()), paramMsg.str_printer_qr_pic_url.get(), paramMsg.str_printer_qr_open_url.get(), paramMsg.str_printer_tip_url.get() });
        return;
      }
      label579:
      l = 0L;
