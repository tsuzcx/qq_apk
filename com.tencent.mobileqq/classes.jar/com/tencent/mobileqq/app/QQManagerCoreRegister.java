...
public class QQManagerCoreRegister
{
  static void a(SparseArray<Class<? extends Manager>> paramSparseArray)
  {
    ...
    paramSparseArray.put(QQManagerFactory.MGR_TROOP_FILTER, RoamSettingController.class);
    paramSparseArray.put(QQManagerFactory.NEW_FRIEND_MANAGER, NewFriendManager.class);
    paramSparseArray.put(QQManagerFactory.MGR_RED_TOUCH, RedTouchManager.class);
    paramSparseArray.put(QQManagerFactory.RECENT_CALL_FACADE, QCallFacade.class);
    paramSparseArray.put(QQManagerFactory.ROAM_SETTING_MANAGER, RoamSettingManager.class);
    ...
    paramSparseArray.put(QQManagerFactory.PUBLICACCOUNTDATA_MANAGER, PublicAccountDataManager.class);
    paramSparseArray.put(QQManagerFactory.HOT_CHAT_MANAGER, HotChatManager.class);
    paramSparseArray.put(QQManagerFactory.SUB_ACCOUNT_MANAGER, SubAccountManager.class);
    ...
    paramSparseArray.put(QQManagerFactory.LOCAL_REDTOUCH_MANAGER, LocalRedTouchManager.class);
    ...
    paramSparseArray.put(QQManagerFactory.EXTEND_FRIEND_MANAGER, ExtendFriendManager.class);
    ...
    paramSparseArray.put(QQManagerFactory.NEW_FRIEND_VERIFICATION_MANAGER, NewFriendVerificationManager.class);
    ...
    paramSparseArray.put(QQManagerFactory.MGR_SUB_ACNT, SubAccountProtocManager.class);
    ...
    paramSparseArray.put(QQManagerFactory.SUB_ACCOUNT_CONTROLL, SubAccountControll.class);
    paramSparseArray.put(QQManagerFactory.CHAT_BACKGROUND_MANAGER, ChatBackgroundManager.class);
    paramSparseArray.put(QQManagerFactory.PICTURE_STATISTICS_MANAGER, PicStatisticsManager.class);
    paramSparseArray.put(QQManagerFactory.VIP_GIF_MANAGER, VipGiftManager.class);
    paramSparseArray.put(QQManagerFactory.EARLY_DOWNLOAD_MANAGER, EarlyDownloadManager.class);
    ...
    paramSparseArray.put(QQManagerFactory.SCRIBBLE_DOWNLOAD_MANAGER, ScribbleDownloader.class);
    paramSparseArray.put(QQManagerFactory.TROOP_BIND_PUBACCOUNT_MANAGER, TroopBindPublicAccountMgr.class);
    paramSparseArray.put(QQManagerFactory.ONLINE_STATUS_MANAGER, OnlineStatusManager.class);
    paramSparseArray.put(QQManagerFactory.MESSAGE_NOTIFICATION_SETTING_MANAGER, MessageNotificationSettingManager.class);
    paramSparseArray.put(QQManagerFactory.GROUP_VIDEO_PLUGIN_MANAGER, GroupVideoManager.class);
    ...
    paramSparseArray.put(QQManagerFactory.EXTEND_FRIEND_LIMIT_CHAT_MANAGER, ExtendFriendLimitChatManager.class);
    ...
    paramSparseArray.put(QQManagerFactory.AV_GAME_MANAGER, AvGameManager.class);
    paramSparseArray.put(QQManagerFactory.TEMP_MSG_BOX, TempMsgBoxManager.class);
    paramSparseArray.put(QQManagerFactory.TEMP_CHAT_PLUGIN_MANAGER, TempChatPluginManager.class);
    paramSparseArray.put(QQManagerFactory.VAS_QUICKUPDATE_MANAGER, VasQuickUpdateManager.class);
    paramSparseArray.put(QQManagerFactory.TROOP_NOTIFICATION_MANAGER, TroopNotificationManager.class);
