  ...
  extends BusinessHandler
{
    ...
    do
    {
      ...
      do
      {
        ...
        for (;;)
        {
          ...
          if (bool == true) {
            ThreadManager.getUIHandler().post(new zug(this));
          }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    else
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("Theme.ThemeHandler", 2, "sendThemeAuth init: themeId:" + paramString1 + ", version=" + paramString2 + ", skThemeId:" + ((Bundle)localObject4).getString("themeId") + ", skVersion:" + ((Bundle)localObject4).getString("version") + ", qqVersion:" + "7.6.8");
      }
      str = paramString2;
    ...
    do
    {
      ...
      paramString1 = new File(AppConstants.bU);
      ...
      ((ThemeAuth.ReqBody)localObject6).str_qq_version.set("7.6.8.3615");
      ((ThemeAuth.ReqBody)localObject6).uint32_qq_version.set(Integer.parseInt("3615"));
  ...
  public void a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramString1.str_qq_version.set("7.6.8.3615");
        paramString1.uint32_qq_version.set(Integer.parseInt("3615"));
