...
{
  AVGameShareUtil$6(AVGameShareUtil paramAVGameShareUtil, long paramLong1, Map paramMap, QQAppInterface paramQQAppInterface, int paramInt, String paramString1, String paramString2, long paramLong2, long paramLong3) {}
  ...
  private void a(boolean paramBoolean, String paramString)
  {
    if ((paramBoolean) && (!TextUtils.isEmpty(paramString)))
    {
      ...
      {
        paramString = new ArkAppMessage(str, "com.tencent.avgame", null, "invite", "1.0.0.1", AVGameShareEntry.a(String.valueOf(this.jdField_b_of_type_Long), Long.valueOf(this.jdField_c_of_type_Long).longValue(), paramString), null, null);
        ChatActivityFacade.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localSessionInfo, paramString);
        return;
      }
    }
  ...
  public void a(boolean paramBoolean, String paramString, long paramLong)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(localAvGameRoomListObserver);
    try
    {
