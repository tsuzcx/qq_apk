...
class AVGameShareResultPic$3
  implements Runnable
{
  AVGameShareResultPic$3(AVGameShareResultPic paramAVGameShareResultPic, Map paramMap, Runnable paramRunnable) {}
  ...
  public void run()
  {
    try
    {
      ...
      Bitmap localBitmap = BitmapFactory.decodeFile(AVGameShareResultPic.a(this.this$0));
