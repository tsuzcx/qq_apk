...
public class AVGameShareUtil
{
  ...
  public void a(Activity paramActivity, String paramString, int paramInt)
  {
    ...
    new AVGameShareResultPic(paramActivity, paramString, paramInt).b();
  }
  ...
  public void a(BaseAVGameAppInterface paramBaseAVGameAppInterface, Activity paramActivity, long paramLong1, long paramLong2, String paramString1, String paramString2, int paramInt)
  {
    ...
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append("shareAVGameResultLink currentUin: ");
    ...
    localStringBuilder.append(" roundId: ");
  ...
  public void a(BaseAVGameAppInterface paramBaseAVGameAppInterface, QBaseActivity paramQBaseActivity, long paramLong1, long paramLong2, String paramString, int paramInt)
  {
    ...
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append("sinviteCallbackhareAVGameEntry currentUin: ");
    localStringBuilder.append(paramLong2);
    localStringBuilder.append(" roomId: ");
    localStringBuilder.append(paramLong1);
    localStringBuilder.append(" shareUin: ");
    ...
    localStringBuilder.append(" shareName: ");
    localStringBuilder.append(paramString);
    localStringBuilder.append(" gameSerType:");
    localStringBuilder.append(paramInt);
    QLog.d("AVGameShareUtil", 1, localStringBuilder.toString());
  ...
  {
    Object localObject = new StringBuilder();
    ((StringBuilder)localObject).append("requestShareUrlAndSendMsg roomId: ");
    ((StringBuilder)localObject).append(paramLong1);
    ...
    QLog.d("AVGameShareUtil", 1, ((StringBuilder)localObject).toString());
    localObject = (IAvGameManager)paramBaseQQAppInterface.getRuntimeService(IAvGameManager.class, "");
    long l = System.currentTimeMillis();
    HashMap localHashMap = new HashMap();
    paramString1 = new AVGameShareUtil.6(this, l, localHashMap, paramBaseQQAppInterface, paramInt1, paramString1, paramString2, paramLong2, paramLong1);
    localHashMap.put(Long.valueOf(l), paramString1);
    paramBaseQQAppInterface.addObserver(paramString1);
    if (localObject != null) {
      ((IAvGameManager)localObject).requestGetShareLink(paramLong1, paramLong2, paramString2, paramInt2, paramString3, paramInt3, l);
    }
  }
