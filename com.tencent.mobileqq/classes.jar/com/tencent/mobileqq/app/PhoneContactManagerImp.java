  ...
  implements aufv
{
  ...
  private awhv jdField_a_of_type_Awhv;
  private awhw jdField_a_of_type_Awhw = new alyk(this);
  private awhx jdField_a_of_type_Awhx = new alym(this);
  ...
  private LinkedList<aufw> jdField_a_of_type_JavaUtilLinkedList = new LinkedList();
  ...
  public PhoneContactManagerImp(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Awhx);
  ...
  private ArrayList<PhoneContact> a(ArrayList<AddressBookItem> paramArrayList1, ArrayList<AddressBookItem> paramArrayList2)
  {
    ...
    //   95: astore 7
    //   97: aload_0
    //   98: getfield 270	com/tencent/mobileqq/app/PhoneContactManagerImp:jdField_a_of_type_Awgf	Lawgf;
    //   101: invokevirtual 451	awgf:a	()Lawgh;
    //   104: astore 9
    //   106: aload 9
    //   108: astore 7
    //   110: aload 7
    //   112: invokevirtual 455	awgh:a	()V
    //   115: aload 8
    ...
    //   149: invokestatic 473	alye:a	(Ljava/lang/String;)Ljava/lang/String;
    //   152: astore 10
    //   154: aload 8
    //   156: aload 8
    //   158: ldc 71
    ...
    //   284: ifnull +8 -> 292
    //   287: aload 7
    //   289: invokevirtual 485	awgh:b	()V
    //   292: aload 8
    ...
    //   478: invokestatic 534	alye:b	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   498: aload 9
    //   500: aload 10
    //   502: invokestatic 543	alye:a	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    //   553: ifnull +8 -> 561
    //   556: aload 7
    //   558: invokevirtual 485	awgh:b	()V
    //   561: aload 8
    ...
    //   601: aload 10
    //   603: invokestatic 543	alye:a	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    //   914: invokestatic 534	alye:b	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   937: aload 14
    //   939: aload 10
    //   941: invokestatic 543	alye:a	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    //   1068: aload_0
    //   1069: getfield 270	com/tencent/mobileqq/app/PhoneContactManagerImp:jdField_a_of_type_Awgf	Lawgf;
    //   1072: aload 12
    //   1074: invokevirtual 608	awgf:b	(Lawge;)Z
    //   1077: pop
    //   1078: aload_2
    ...
    //   1105: goto -109 -> 996
    //   1108: aload 7
    //   1110: invokevirtual 613	awgh:c	()V
    //   1113: aload 7
    //   1115: ifnull +8 -> 1123
    //   1118: aload 7
    //   1120: invokevirtual 485	awgh:b	()V
    //   1123: aload 8
  ...
  private void a(int paramInt, boolean paramBoolean)
  {
    ...
    label106:
    for (String str = alud.a(2131708391); Thread.currentThread() == Looper.getMainLooper().getThread(); str = alud.a(2131708385))
    {
      a(paramBoolean, str);
      return;
    }
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2, long paramLong)
  {
    for (;;)
    {
      try
      {
        ...
        ((alys)localQQAppInterface.getManager(102)).jdField_a_of_type_Boolean = true;
    ...
    Object localObject2 = new NewIntent(localObject1.getApplication(), awhy.class);
  ...
  private boolean a(String paramString, ArrayList<AddressBookItem> paramArrayList1, ArrayList<AddressBookItem> paramArrayList2, ArrayList<PhoneContact> paramArrayList, boolean paramBoolean)
  {
    ...
    {
      localNewIntent = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), awhy.class);
      if (!paramBoolean) {
        break label255;
      }
    }
  ...
  private void b(boolean paramBoolean, List<PhoneContact> paramList)
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        try
        {
          ...
          if (((Iterator)localObject2).hasNext())
          {
            ...
            this.jdField_a_of_type_Awgf.b(localContactMatch);
            if (!QLog.isColorLevel()) {
              continue;
            }
      ...
      ((ContactMatch)localObject2).timestamp = ayzl.a();
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqDataContactBinded.timestamp = ayzl.a();
    ...
    for (;;)
    {
      ...
      if (bool2)
      {
        if (this.jdField_a_of_type_AndroidContentSharedPreferences.getInt("key_bind_style", 0) == 0)
        {
          ...
          azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006EF7", "0X8006EF7", 0, 0, "", "", "", "");
          continue;
        }
        if (this.jdField_a_of_type_AndroidContentSharedPreferences.getInt("key_bind_style", 0) == 1)
        {
          ...
          azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006EF8", "0X8006EF8", 0, 0, "", "", "", "");
          continue;
            ...
            if ((!e()) && (localObject1 != null) && (!((RespondQueryQQBindingStat)localObject1).isStopFindMatch))
            {
              ...
              if (bool2)
              {
                ...
                for (;;)
                {
                  ...
                  ((AppActivity)localObject2).overridePendingTransition(2130772293, 2130771990);
  ...
  {
    Object localObject1 = "";
    String str = bhsp.a("73f9b3");
    if (!bhtb.k()) {
      localObject1 = bhsp.c("73f9b3");
    }
  ...
  private ArrayList<AddressBookItem> d()
  {
    ...
    //   130: astore 5
    //   132: aload_0
    //   133: getfield 270	com/tencent/mobileqq/app/PhoneContactManagerImp:jdField_a_of_type_Awgf	Lawgf;
    //   136: invokevirtual 451	awgf:a	()Lawgh;
    //   139: astore 8
    //   141: aload 8
    //   143: astore 6
    //   145: aload 8
    //   147: astore 5
    //   149: aload 8
    //   151: invokevirtual 455	awgh:a	()V
    //   154: aload 8
    //   156: astore 6
    //   158: aload 8
    //   160: astore 5
    ...
    //   212: invokestatic 473	alye:a	(Ljava/lang/String;)Ljava/lang/String;
    //   215: astore 10
    //   217: aload 8
    //   219: astore 6
    //   221: aload 8
    ...
    //   422: ifnull +8 -> 430
    //   425: aload 6
    //   427: invokevirtual 485	awgh:b	()V
    //   430: aload 7
    ...
    //   675: invokestatic 534	alye:b	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   691: aload 9
    //   693: aload 10
    //   695: invokestatic 543	alye:a	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    //   748: astore 5
    //   750: aload_0
    //   751: getfield 270	com/tencent/mobileqq/app/PhoneContactManagerImp:jdField_a_of_type_Awgf	Lawgf;
    //   754: aload 14
    //   756: invokevirtual 1316	awgf:b	(Lawge;)V
    //   759: goto -384 -> 375
    //   762: astore 6
    //   764: aload 5
    //   766: ifnull +8 -> 774
    //   769: aload 5
    //   771: invokevirtual 485	awgh:b	()V
    //   774: aload 7
    ...
    //   790: astore 5
    //   792: aload 8
    //   794: invokevirtual 613	awgh:c	()V
    //   797: aload 8
    //   799: ifnull +8 -> 807
    //   802: aload 8
    //   804: invokevirtual 485	awgh:b	()V
    //   807: aload 7
      ...
      if (!this.jdField_g_of_type_JavaUtilConcurrentConcurrentHashMap.isEmpty())
      {
        ...
        try
        {
          ...
          while (localIterator.hasNext())
          {
            ...
            this.jdField_a_of_type_Awgf.a(localPhoneContact);
          }
  ...
  private void g(boolean paramBoolean)
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Awhv == null) {
        this.jdField_a_of_type_Awhv = ((awhv)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(134));
      }
      azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80095EE", "0X80095EE", 0, 0, "", "", "", "");
      this.jdField_a_of_type_Awhv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
      return;
    }
    catch (Exception localException)
    {
  ...
  private void h(boolean paramBoolean)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Awhv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), paramBoolean);
      return;
    }
    catch (Exception localException)
    {
  ...
  private void m()
  {
    ...
    if (localObject2 != null) {
      localObject1 = ((awgf)localObject2).a(LastLoginPhoneInfo.class);
    }
  ...
  private boolean m()
  {
    if (!"8.3.5".equals(this.jdField_a_of_type_AndroidContentSharedPreferences.getString("last_phone_version_popped_notbind", ""))) {}
  ...
  private void n()
  {
    try
    {
      this.jdField_a_of_type_Alyq = new alyq(new Handler(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getMainLooper()));
      this.jdField_a_of_type_Alyq.a(this);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getContentResolver().registerContentObserver(ContactsContract.CommonDataKinds.Phone.CONTENT_URI, true, this.jdField_a_of_type_Alyq);
      return;
    }
    catch (Throwable localThrowable)
    {
  ...
  private boolean n()
  {
    if (!"8.3.5".equals(this.jdField_a_of_type_AndroidContentSharedPreferences.getString("last_phone_version_popped", ""))) {}
    for (boolean bool = true;; bool = false)
    {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        if ((this.jdField_a_of_type_Int >= 9) && (b() == 1))
        {
          ...
          awgh localawgh1 = this.jdField_a_of_type_Awgf.a();
          try
          {
            localawgh1.a();
      ...
      if (this.jdField_a_of_type_JavaUtilArrayList != null)
      {
        awgh localawgh2 = this.jdField_a_of_type_Awgf.a();
  ...
  private void t()
  {
    this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putString("last_phone_version_popped_notbind", "8.3.5").commit();
  }
  
  private void u()
  {
    this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putString("last_phone_version_popped", "8.3.5").commit();
  }
  ...
  public int a(List<String> paramList)
  {
    ...
    if (this.jdField_a_of_type_Alyn != null) {
      this.jdField_a_of_type_Alyn.cancel(true);
    }
    this.jdField_a_of_type_Alyn = new alyn(this, null);
    this.jdField_a_of_type_Alyn.a(paramList);
    this.jdField_a_of_type_Alyn.execute(new RespondQueryQQBindingStat[] { localRespondQueryQQBindingStat });
  ...
  public int a(boolean paramBoolean, int paramInt, long paramLong1, long paramLong2, ArrayList<NotBindContactFriendInfo> paramArrayList, ArrayList<NotBindContactNotFriendInfo> paramArrayList1)
  {
    ...
    else
    {
      ...
      paramArrayList1 = this.jdField_a_of_type_Awgf.a();
    ...
    for (;;)
    {
      try
      {
        ...
        {
          localObject3 = ((alto)localObject1).e(paramArrayList.uin);
          ...
          ((alto)localObject1).a(paramArrayList.unifiedCode, false);
        }
        ...
        this.jdField_a_of_type_Awgf.a(paramArrayList);
        paramBoolean = bool1;
        if (!QLog.isColorLevel()) {
          continue;
        }
    ...
    for (;;)
    {
      if ((this.jdField_l_of_type_JavaUtilList != null) && (this.jdField_l_of_type_JavaUtilList.size() > 0))
      {
        ...
        paramArrayList = this.jdField_a_of_type_Awgf.a();
      }
      for (;;)
      {
        try
        {
          ...
          if (((Iterator)localObject1).hasNext())
          {
            ...
            if (localObject3 != null)
            {
              ...
              this.jdField_a_of_type_Awgf.a((awge)localObject3);
              bool2 = paramBoolean;
              if (!QLog.isColorLevel()) {
                break label1382;
              }
  ...
  public int a(boolean paramBoolean1, int paramInt, long paramLong1, boolean paramBoolean2, long paramLong2, long paramLong3, List<MobileContactsFriendInfo> paramList, List<MobileContactsNotFriendInfo> paramList1)
  {
    ...
    else
    {
      ...
      if (!paramBoolean2) {}
      paramList1 = this.jdField_a_of_type_Awgf.a();
      localObject1 = (alto)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
    }
    Object localObject2;
    Object localObject3;
    ...
    for (;;)
    {
      try
      {
        ...
        {
          localObject3 = ((alto)localObject1).e(paramList.uin);
          if (localObject3 != null) {
          ...
          ((alto)localObject1).a(paramList.unifiedCode, false);
        }
        ...
        this.jdField_a_of_type_Awgf.a(paramList);
        paramBoolean1 = bool1;
        if (!QLog.isColorLevel()) {
          continue;
        }
    ...
    for (;;)
    {
      if ((this.jdField_d_of_type_JavaUtilList != null) && (this.jdField_d_of_type_JavaUtilList.size() > 0))
      {
        ...
        paramList = this.jdField_a_of_type_Awgf.a();
      }
      for (;;)
      {
        try
  ...
  public akii a(List<PhoneContact> paramList)
  {
    ThreadManager.getSubThreadHandler().post(new PhoneContactManagerImp.8(this, paramList));
    return this.jdField_a_of_type_Akii;
  }
  
  public aozx a()
  {
    if (this.jdField_a_of_type_Aozx == null) {
      this.jdField_a_of_type_Aozx = new aozx();
    }
    return this.jdField_a_of_type_Aozx;
  }
  ...
  public String a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (paramString != null)
      {
        ...
        label95:
        for (awgf localawgf = null; localawgf != null; localawgf = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getEntityManagerFactory().createEntityManager())
        {
          PhoneNumInfo localPhoneNumInfo = (PhoneNumInfo)localawgf.a(PhoneNumInfo.class, paramString);
  ...
  public ArrayList<PhoneContact> a()
  {
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      if ((localObject2 != null) && (((PhoneContact)localObject2).samFriend > 0) && (!localalto.a(((PhoneContact)localObject2).unifiedCode, true))) {
    ...
    for (;;)
    {
      try
      {
        ...
        Collections.sort((List)localObject1, new alyd(new int[] { 3, 4 }, (Set)localObject2, localalto));
        if (QLog.isColorLevel()) {
  ...
  public List<PhoneContact> a(Map<String, PhoneContact> paramMap, boolean paramBoolean)
  {
    ...
    if (!paramBoolean) {
      Collections.sort((List)localObject, new alyj(this));
    }
    ArrayList localArrayList = new ArrayList();
    alto localalto = (alto)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
    label198:
        ...
        if (localIterator.hasNext())
        {
          ...
          if ((str1 == null) || (!str1.endsWith(((PhoneContact)localObject).mobileNo.trim())))
          {
            ...
            if (paramMap == null)
            {
              ...
              {
                break;
                paramMap = localalto.e(((PhoneContact)localObject).uin);
                break label198;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        break label379;
        label494:
        localFriends = localalto.e(((PhoneContact)localObject).uin);
        break label387;
        label509:
        i3 = 0;
        break label403;
        ...
        if (((PhoneContact)localObject).uin.equals("0")) {}
        for (paramMap = null;; paramMap = localalto.e(((PhoneContact)localObject).uin))
        {
          if ((paramMap == null) || (paramMap.groupid < 0)) {
            break label639;
          }
        ...
        c(localArrayList);
        Collections.sort(localArrayList, new alyl(this));
        if (QLog.isColorLevel()) {
  ...
  public List<PhoneContact> a(boolean paramBoolean)
  {
    ...
    if (paramBoolean) {
      Collections.sort((List)localObject2, new alyd(new int[] { 1, 4 }, null, null));
    }
    if (QLog.isColorLevel()) {
  ...
  public List<PhoneContact> a(int[] paramArrayOfInt)
  {
    ...
    try
    {
      Collections.sort((List)localObject, new alyd(paramArrayOfInt, this.jdField_a_of_type_JavaUtilSet, (alto)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)));
      if (QLog.isColorLevel()) {
    ...
    catch (Exception localException)
    {
      try
      {
        ...
        for (;;)
        {
          ...
          str2 = alye.a(localCursor.getString(localCursor.getColumnIndex("data1")));
      ...
      catch (StaleDataException localStaleDataException)
      {
        for (;;)
        {
          ...
          localPhoneContact.pinyinFirst = alye.b(localPhoneContact.pinyinInitial);
          localPhoneContact.md5 = alye.a(localStaleDataException, str2);
  ...
  void a()
  {
    if (this.jdField_a_of_type_Alyq != null)
    {
      try
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getContentResolver().unregisterContentObserver(this.jdField_a_of_type_Alyq);
        this.jdField_a_of_type_Alyq.a(null);
      }
      catch (Throwable localThrowable)
      {
        for (;;)
  ...
  public void a(aufw paramaufw)
  {
    ...
    {
      if (!this.jdField_a_of_type_JavaUtilLinkedList.contains(paramaufw)) {
        this.jdField_a_of_type_JavaUtilLinkedList.add(paramaufw);
      }
      return;
    }
  }
  ...
  public void a(ContactMatch paramContactMatch)
  {
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      if (this.jdField_a_of_type_JavaUtilArrayList != null)
      {
        ...
        this.jdField_a_of_type_Awgf.b(paramContactMatch);
      }
      return;
    }
  }
  ...
  public void a(PhoneContactAdd paramPhoneContactAdd)
  {
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      if (this.jdField_b_of_type_JavaUtilArrayList != null)
      {
        ...
        this.jdField_a_of_type_Awgf.b(paramPhoneContactAdd);
      }
      return;
    }
  }
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        try
        {
          ...
          localPhoneContactAdd.timestamp = ayzl.a();
          ...
          if (n != 0)
          {
            ...
            ((PhoneContactAdd)localObject2).timestamp = ayzl.a();
            if (paramInt != 1) {
              break label355;
            }
            ((PhoneContactAdd)localObject2).remindInfo = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext().getResources().getString(2131695189);
            if (this.jdField_b_of_type_JavaUtilArrayList == null) {
      ...
      if (paramInt == 4)
      {
        ((PhoneContactAdd)localObject2).remindInfo = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext().getResources().getString(2131695190);
        continue;
        n = 1;
      }
    }
  ...
  public void a(String paramString, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    NewIntent localNewIntent = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), awhy.class);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramArrayList1.hasNext())
        {
          ...
          ((PhoneContactAdd)localObject5).timestamp = ayzl.a();
          a((awge)localObject5);
          paramInt = 0;
          if (paramInt == 0) {
            continue;
          ...
          ((PhoneContactAdd)localObject4).timestamp = ayzl.a();
          ((PhoneContactAdd)localObject4).remindInfo = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext().getResources().getString(2131695189);
      ...
      if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (!this.jdField_a_of_type_JavaUtilArrayList.isEmpty()))
      {
        ...
        for (;;)
        {
          ...
          if (((Iterator)localObject3).hasNext())
          {
            ...
            this.jdField_a_of_type_Awgf.b(paramArrayList1);
          }
        }
      }
      label660:
  ...
  public void a(Set<String> paramSet)
  {
    ...
    //   44: invokevirtual 262	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lawgg;
    //   47: invokevirtual 268	awgg:createEntityManager	()Lawgf;
    //   50: astore_3
    //   51: aload_3
    //   52: ifnonnull +13 -> 65
    //   55: ldc 234
    ...
    //   64: return
    //   65: aload_3
    //   66: invokevirtual 451	awgf:a	()Lawgh;
    //   69: astore_2
    //   70: aload_2
    //   71: invokevirtual 455	awgh:a	()V
    //   74: aload_3
    //   75: ldc_w 2080
    //   78: aconst_null
    //   79: aconst_null
    //   80: invokevirtual 2081	awgf:a	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    //   83: pop
    //   84: aload_1
    ...
    //   135: aload_3
    //   136: aload 5
    //   138: invokevirtual 1316	awgf:b	(Lawge;)V
    //   141: goto -50 -> 91
    //   144: astore_1
    //   145: ldc 234
    //   147: iconst_1
    ...
    //   155: aload_2
    //   156: invokevirtual 485	awgh:b	()V
    //   159: return
    //   160: aload_2
    //   161: invokevirtual 613	awgh:c	()V
    //   164: aload_2
    //   165: invokevirtual 485	awgh:b	()V
    //   168: return
    //   169: astore_1
    //   170: aload_2
    //   171: invokevirtual 485	awgh:b	()V
    //   174: aload_1
    //   175: athrow
    // Local variable table:
    //   start	length	slot	name	signature
    ...
    //   69	102	2	localawgh	awgh
    //   50	86	3	localawgf	awgf
    //   109	22	4	str	String
  ...
  protected boolean a(awge paramawge)
  {
    ...
    QLog.d("PhoneContact.Manager", 2, "updateEntity em closed e=" + paramawge.getTableName());
    return false;
  }
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (localPhoneContactAdd.unifiedCode.equals(paramString))
        {
          ...
          this.jdField_a_of_type_Awgf.b(localPhoneContactAdd);
          return true;
        }
      }
      return false;
  ...
  public boolean a(String paramString1, String paramString2)
  {
    ...
    //   313: invokestatic 473	alye:a	(Ljava/lang/String;)Ljava/lang/String;
    //   316: astore 7
    //   318: aload_1
    //   319: invokestatic 473	alye:a	(Ljava/lang/String;)Ljava/lang/String;
    //   322: astore 6
    //   324: aload 6
    //   326: astore_1
    //   327: aload 7
  ...
  public PhoneContact b(String paramString)
  {
    ...
    if (this.jdField_a_of_type_Awgf != null) {
      return (PhoneContact)this.jdField_a_of_type_Awgf.a(PhoneContact.class, paramString);
    }
    return null;
  }
  ...
  public String b(String paramString)
  {
    ...
    paramString = (PhoneNumInfo)((awgf)localObject).a(PhoneNumInfo.class, "uin=?", new String[] { paramString });
    if (paramString != null) {
  ...
  public List<PhoneContact> b()
  {
    ...
    try
    {
      localObject2 = this.jdField_a_of_type_JavaUtilSet;
      alto localalto = (alto)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
      Collections.sort((List)localObject1, new alyd(new int[] { 6, 5, 1, 4 }, (Set)localObject2, localalto));
      if (QLog.isColorLevel()) {
  ...
  public void b(aufw paramaufw)
  {
    synchronized (this.jdField_a_of_type_JavaUtilLinkedList)
    {
      this.jdField_a_of_type_JavaUtilLinkedList.remove(paramaufw);
      return;
    }
  }
  ...
  public void b(String paramString, boolean paramBoolean)
  {
    ...
    if ((paramString != null) && (paramString.isHiden != paramBoolean))
    {
      ...
      this.jdField_a_of_type_Awgf.a(paramString);
    }
  }
  ...
  public PhoneContact c(String paramString)
  {
    ...
    return (PhoneContact)this.jdField_a_of_type_Awgf.a(PhoneContact.class, "mobileCode=?", new String[] { paramString });
  }
  ...
  public void c()
  {
    if (!this.jdField_d_of_type_Boolean)
    {
      ...
      this.jdField_d_of_type_JavaUtilConcurrentConcurrentHashMap.clear();
      this.jdField_f_of_type_JavaUtilConcurrentConcurrentHashMap.clear();
      ??? = this.jdField_a_of_type_Awgf.a(PhoneContact.class);
      if (??? != null)
      {
        ??? = ((List)???).iterator();
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      this.jdField_a_of_type_JavaUtilArrayList = ((ArrayList)this.jdField_a_of_type_Awgf.a(ContactMatch.class, false, null, null, null, null, null, null));
      this.jdField_b_of_type_JavaUtilArrayList = ((ArrayList)this.jdField_a_of_type_Awgf.a(PhoneContactAdd.class, false, null, null, null, null, null, null));
  ...
  public void c(String paramString1, String paramString2)
  {
    ...
    if ((localObject == null) || (!((String)localObject).equals(paramString2)))
    {
      ...
      if (localObject != null)
      {
        ((awgf)localObject).b(localPhoneNumInfo);
        ((awgf)localObject).a();
      }
    }
  }
  ...
  public List<PhoneContact> d()
  {
    if (this.jdField_d_of_type_Boolean)
    {
      ...
      catch (Exception localException)
      {
        ...
        return this.jdField_a_of_type_Awgf.a(PhoneContact.class);
      }
    }
    return this.jdField_a_of_type_Awgf.a(PhoneContact.class);
  }
  ...
  public List<List<PhoneContact>> e()
  {
    ...
    do
    {
      ...
      do
      {
        ...
        Collections.sort((List)localObject2, new alyf(this));
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((str == null) || (!str.endsWith(((PhoneContact)localObject2).mobileNo.trim())))
        {
          ...
          for (;;)
          {
            ...
            break;
            localObject2 = localalto.e(localPhoneContact.uin);
            break label352;
  ...
  public List<PhoneContact> f()
  {
    ...
    if ((this.jdField_i_of_type_JavaUtilList == null) || (this.jdField_i_of_type_JavaUtilList.size() <= 0))
    {
      ...
      if (localArrayList.size() > 0)
      {
        ...
        Collections.sort(localArrayList, new alyh(this));
      }
  ...
  public void f()
  {
    ...
    //   6: monitorenter
    //   7: aload_0
    //   8: getfield 270	com/tencent/mobileqq/app/PhoneContactManagerImp:jdField_a_of_type_Awgf	Lawgf;
    //   11: invokevirtual 451	awgf:a	()Lawgh;
    //   14: astore_2
    //   15: aload_2
    //   16: invokevirtual 455	awgh:a	()V
    //   19: aload_0
    ...
    //   85: aload_0
    //   86: aload 4
    //   88: invokevirtual 1090	com/tencent/mobileqq/app/PhoneContactManagerImp:a	(Lawge;)Z
    //   91: pop
    //   92: goto -33 -> 59
    //   95: astore_3
    ...
    //   112: aload_2
    //   113: invokevirtual 485	awgh:b	()V
    //   116: aload_1
    //   117: monitorexit
    //   118: return
    //   119: aload_2
    //   120: invokevirtual 613	awgh:c	()V
    //   123: aload_2
    //   124: invokevirtual 485	awgh:b	()V
    //   127: goto -11 -> 116
    //   130: astore_2
    //   131: aload_1
    //   132: monitorexit
    ...
    //   135: astore_3
    //   136: aload_2
    //   137: invokevirtual 485	awgh:b	()V
    //   140: aload_3
    //   141: athrow
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  public List<PhoneContact> g()
  {
    ...
    if ((this.jdField_j_of_type_JavaUtilList == null) || (this.jdField_j_of_type_JavaUtilList.size() <= 0))
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        if (TextUtils.isEmpty(localPhoneContact.uin)) {
          localArrayList.add(localPhoneContact);
        } else if ((!localPhoneContact.uin.equals("0")) && (((alto)localObject1).e(localPhoneContact.uin) != null)) {
          localArrayList.add(localPhoneContact);
        }
      }
      if (localArrayList.size() > 0)
      {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          if (((PhoneContact)localObject2).pinyinFirst == null) {
            ((PhoneContact)localObject2).pinyinFirst = alye.b(((PhoneContact)localObject2).pinyinInitial);
          }
        }
        Collections.sort(localArrayList, new alyi(this));
      }
  ...
  {
    if (bhtb.k()) {
      this.jdField_a_of_type_JavaLangBoolean = Boolean.valueOf(aozx.a("android.permission.READ_CONTACTS"));
    }
    for (;;)
    {
      ThreadManager.excute(new PhoneContactManagerImp.21(this), 16, null, true);
      if (QLog.isColorLevel()) {
        QLog.d("contact.PermissionChecker", 2, String.format("hasReadContactPermissionForUI isM=%b has=%b", new Object[] { Boolean.valueOf(bhtb.k()), this.jdField_a_of_type_JavaLangBoolean }));
      }
  ...
  public boolean j()
  {
    ...
    if (bhtb.k())
    {
      bool1 = aozx.a("android.permission.READ_CONTACTS");
      if (!bool1) {
        break label75;
      }
      bool1 = g();
  ...
  public void onDestroy()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Awhx);
    ThreadManager.getSubThreadHandler().removeCallbacks(this.jdField_a_of_type_JavaLangRunnable);
    if (QLog.isColorLevel()) {
