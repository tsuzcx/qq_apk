  ...
  implements Comparator<RecentBaseData>
{
  ...
  private int a(RecentUserBaseData paramRecentUserBaseData, int paramInt)
  {
    ...
    if (paramRecentUserBaseData.mUnreadNum > 0)
    {
      ...
      {
        i = j;
        if (QvipSpecialCareManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + paramRecentUserBaseData.mUser.uin))
        {
          i = j;
  ...
  private boolean a(RecentUserBaseData paramRecentUserBaseData)
  {
    ...
    if ((paramRecentUserBaseData.mUser.getType() == 1) && (!HotChatUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramRecentUserBaseData.mUser))) {
      ...
      else
      {
        ...
        for (;;)
        {
          ...
          if (localRecentUser.getType() == 3000)
          {
            ...
            DiscussionInfo localDiscussionInfo = ((DiscussionManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.DISCUSSION_MANAGER)).a(localRecentUser.uin);
