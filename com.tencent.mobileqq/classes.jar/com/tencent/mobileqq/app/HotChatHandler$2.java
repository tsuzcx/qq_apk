...
public class HotChatHandler$2
  implements Runnable
{
  public HotChatHandler$2(ajyi paramajyi, boolean paramBoolean, List paramList) {}
  
  public void run()
  {
    if ((!atcf.a().jdField_a_of_type_Boolean) && (!atcf.a().c))
    {
    ...
    while (atcf.a().a() != 1) {
      try
      {
        ...
        atcf.a().a(1, null, l, localHotChatInfo.name);
        return;
      }
