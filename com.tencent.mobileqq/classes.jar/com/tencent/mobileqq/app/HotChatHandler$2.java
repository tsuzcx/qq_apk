...
public class HotChatHandler$2
  implements Runnable
{
  public HotChatHandler$2(anzp paramanzp, boolean paramBoolean, List paramList) {}
  
  public void run()
  {
    if ((!axxr.a().jdField_a_of_type_Boolean) && (!axxr.a().c))
    {
    ...
    while (axxr.a().a() != 1) {
      try
      {
        ...
        axxr.a().a(1, null, l, localHotChatInfo.name);
        return;
      }
