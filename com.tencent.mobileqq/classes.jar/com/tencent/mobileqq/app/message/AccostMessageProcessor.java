  ...
  extends BaseMessageProcessor
{
  ...
  private void a(long paramLong1, ArrayList paramArrayList1, ArrayList paramArrayList2, ArrayList paramArrayList3, long paramLong2, String paramString)
  {
    ...
    for (SvcGetMsgInfo localSvcGetMsgInfo = (SvcGetMsgInfo)paramArrayList3.get(i);; localSvcGetMsgInfo = null)
    {
      ...
      {
        a(paramLong1, new zym(paramLong2, j, localAccostMsg.uMsgID, localAccostMsg.iMsgTime, localArrayList, ((RichMsg)localObject).sAction), localSvcGetMsgInfo, false);
        break;
      }
      return;
    }
  ...
  private void a(long paramLong, zym paramzym)
  {
    ArrayList localArrayList = paramzym.jdField_a_of_type_JavaUtilArrayList;
    int i = 0;
    try
    {
          ...
          if (PushType.PUSH_TYPE_VOTE_INCR.value() == ((PushCardMsg)localObject2).ePushType)
          {
            ...
            if (((PushVoteIncreaseInfo)localObject1).iIncrement > 0)
            {
              ...
              if (localObject2 != null) {
                ((CardHandler)localObject2).a((PushVoteIncreaseInfo)localObject1, String.valueOf(paramLong), String.valueOf(paramzym.jdField_a_of_type_Long));
              }
            }
          }
        }
    ...
    catch (Exception paramzym)
    {
      paramzym.printStackTrace();
    }
  }
  
  private void a(long paramLong, zym paramzym, SvcGetMsgInfo paramSvcGetMsgInfo, boolean paramBoolean)
  {
    ArrayList localArrayList1 = new ArrayList();
    ArrayList localArrayList2 = paramzym.jdField_a_of_type_JavaUtilArrayList;
    String str2 = paramzym.jdField_a_of_type_JavaLangString;
    int m = 0;
    int i = -1000;
    Object localObject3;
    String str1;
    ...
    for (;;)
    {
      ...
      catch (Exception localException)
      {
        ...
        j = i;
        continue;
        if (paramzym.jdField_a_of_type_Int != 201) {
          continue;
        }
        ...
        l1 = l2;
        continue;
        if (paramzym.jdField_a_of_type_Int != 6) {
          continue;
        }
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.BaseMessageProcessor", 2, "----------handleAccostMsgItemResp accostMsg.eAccostType" + paramzym.jdField_a_of_type_Int + "accostMsg.msgId: " + paramzym.jdField_b_of_type_Long + " accostMsg.time" + paramzym.c + " msgConten: " + Utils.a((String)localObject3));
        }
        l2 = paramzym.jdField_a_of_type_Long;
        if (paramzym.jdField_a_of_type_Int != 1) {
          continue;
        }
        l1 = 9999L;
        i = j;
        ...
        ((MessageRecord)localObject3).init(paramLong, l1, paramzym.jdField_a_of_type_Long, (String)localObject1, paramzym.c, i, 1001, 0L);
        ((MessageRecord)localObject3).shmsgseq = paramzym.jdField_b_of_type_Long;
      ...
      if (((MsgItem)localObject3).MsgContent != null)
      {
        ...
        i = -2002;
        continue;
        a(paramLong, paramBoolean, paramzym);
        return;
        ...
        paramzym = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
        if ((bool1) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackground_Stop)) {}
        for (paramBoolean = true;; paramBoolean = false)
        {
          paramzym.a(localArrayList1, String.valueOf(paramLong), paramBoolean);
  ...
  private void a(long paramLong, boolean paramBoolean, zym paramzym)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      int j = 0;
      while (j < paramzym.jdField_a_of_type_JavaUtilArrayList.size())
      {
        ((StringBuffer)localObject).append(new String(((MsgItem)paramzym.jdField_a_of_type_JavaUtilArrayList.get(j)).MsgContent));
        if (j < paramzym.jdField_a_of_type_JavaUtilArrayList.size() - 1) {
    ...
    localSystemMsg.auth = paramzym.jdField_a_of_type_ArrayOfByte;
    localSystemMsg.lToMobile = paramzym.e;
    localSystemMsg.strNickName = paramzym.jdField_b_of_type_JavaLangString;
    if (QLog.isColorLevel()) {
      QLog.d("MessageHandler", 2, "addFriendRequestByOldVersion, addUin=" + paramzym.d + ", msgUid=" + paramzym.jdField_b_of_type_Long + ", msg=" + localSystemMsg.sMsg);
    }
    ...
    if (localObject != null)
    {
      ...
      localSystemMsg.message = (l + BaseApplication.getContext().getString(2131434684));
      ...
      if (localObject != null)
      {
        ...
        localMessageRecord.init(paramLong, 9998L, l, (String)localObject, 0L, -1011, 0, paramzym.c);
        localMessageRecord.shmsgseq = 187L;
        localMessageRecord.msgUid = paramzym.jdField_b_of_type_Long;
        if (paramBoolean) {
    ...
    for (;;)
    {
      ...
      break;
      label558:
      localSystemMsg.message = ((String)localObject + BaseApplication.getContext().getString(2131434684));
      break label320;
      label593:
      i = 0;
      break label427;
      label599:
      if (QLog.isColorLevel()) {
        QLog.d("MessageHandler", 2, "addFriendRequestByOldVersion, the message is remove by msgFilter, addUin=" + paramzym.d + ", msgUid=" + localMessageRecord.msgUid + ", msg=" + localSystemMsg.sMsg);
      }
    }
  }
    ...
    for (;;)
    {
      ...
      if ((paramObject.bResend != 1) || (!a(paramToServiceMsg, String.valueOf(paramObject.stMsg.lFromMID), paramObject.stMsg.uMsgID)))
      {
        ...
        if ((paramFromServiceMsg != null) && (paramFromServiceMsg.VecMsg != null))
        {
          ...
          localObject = new zym(paramObject.stMsg.lFromMID, paramObject.stMsg.eAccostType, paramObject.stMsg.uMsgID, paramObject.stMsg.iMsgTime, (ArrayList)localObject, paramFromServiceMsg.sAction);
          if (paramFromServiceMsg.stSender != null)
          {
            if (QLog.isColorLevel()) {
              QLog.d("Q.msg.BaseMessageProcessor", 2, "handlePushAccostMsg richMsg.stSender is null");
            }
            ((zym)localObject).d = paramFromServiceMsg.stSender.lMobileUin;
            ((zym)localObject).jdField_a_of_type_ArrayOfByte = paramFromServiceMsg.stSender.sig;
            ((zym)localObject).jdField_b_of_type_JavaLangString = paramFromServiceMsg.stSender.nickname;
          }
          ((zym)localObject).e = paramObject.stMsg.lFromMID;
          a(Long.valueOf(paramToServiceMsg).longValue(), (zym)localObject, null, false);
          continue;
          paramFromServiceMsg = a(paramObject.stMsg.strMsg);
          if (paramFromServiceMsg != null)
          {
            paramFromServiceMsg = new zym(paramObject.stMsg.lFromMID, paramFromServiceMsg.VecMsg);
  ...
  public void a(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    a(false, false, false, 0L, new zyl(this, paramArrayOfByte, paramInt));
  }
