  ...
  implements PermissionMonitor.Listener
{
  ...
  ParcelHooker$9(ParcelHooker paramParcelHooker) {}
  ...
  public void onMethodEntry(String paramString1, String paramString2, String paramString3, Object[] paramArrayOfObject)
  {
    ...
    while ((!ParcelHooker.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHookparcelParcelHooker)) || (paramArrayOfObject.length != 3)) {
      return;
    }
    if ((!jdField_a_of_type_Boolean) && (paramArrayOfObject[1] != ParcelHooker.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHookparcelParcelHooker))) {
      throw new AssertionError();
    }
    ShadowParcel.a((int)ParcelHooker.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHookparcelParcelHooker), (String)paramArrayOfObject[2]);
 ...
 * Qualified Name:     com.tencent.mobileqq.app.message.hookparcel.ParcelHooker.9
