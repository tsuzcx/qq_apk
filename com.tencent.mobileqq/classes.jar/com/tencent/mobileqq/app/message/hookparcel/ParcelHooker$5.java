  ...
  implements PermissionMonitor.Listener
{
  ...
  ParcelHooker$5(ParcelHooker paramParcelHooker) {}
  ...
  public void onMethodEntry(String paramString1, String paramString2, String paramString3, Object[] paramArrayOfObject)
  {
    ...
    ShadowParcel.b((int)ParcelHooker.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHookparcelParcelHooker), ((Integer)paramArrayOfObject[1]).intValue());
 ...
 * Qualified Name:     com.tencent.mobileqq.app.message.hookparcel.ParcelHooker.5
