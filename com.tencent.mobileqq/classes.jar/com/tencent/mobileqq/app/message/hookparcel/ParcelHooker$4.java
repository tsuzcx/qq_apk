  ...
  implements PermissionMonitor.Listener
{
  ...
  ParcelHooker$4(ParcelHooker paramParcelHooker) {}
  ...
  public void onMethodEntry(String paramString1, String paramString2, String paramString3, Object[] paramArrayOfObject)
  {
    ...
    ShadowParcel.a((int)ParcelHooker.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHookparcelParcelHooker), (byte[])paramArrayOfObject[1], ((Integer)paramArrayOfObject[2]).intValue(), ((Integer)paramArrayOfObject[3]).intValue());
 ...
 * Qualified Name:     com.tencent.mobileqq.app.message.hookparcel.ParcelHooker.4
