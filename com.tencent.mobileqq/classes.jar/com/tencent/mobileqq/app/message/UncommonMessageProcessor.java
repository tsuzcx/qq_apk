  ...
  extends BaseMessageProcessor
{
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.b(8019, false, new Object[] { Integer.valueOf(i2), Long.valueOf(0L), Boolean.valueOf(false) });
  }
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    boolean bool3 = paramToServiceMsg.extraData.getBoolean(MessageConstants.h);
    ...
    try
    {
      ...
      if ((paramToServiceMsg == null) || (!paramToServiceMsg.result.has()))
      {
        ...
        bool1 = true;
        this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.b(8019, bool1, new Object[] { Integer.valueOf(i1), Long.valueOf(l1), Boolean.valueOf(bool3) });
        if (QLog.isColorLevel()) {
  ...
  public static void b(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    StatisticCollector.a(BaseApplication.getContext()).a(localAppInterface.getCurrentAccountUin(), "revokeMsgErrorTag", false, 0L, 0L, localHashMap, "");
    if (QLog.isColorLevel()) {
  ...
  public ToServiceMsg a(List paramList, int paramInt)
  {
    ...
    if ((paramInt == 1) && (!((MessageRecord)localObject1).isSend()) && (!TroopUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageRecord)localObject1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())))
    {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
            ...
            while (((Iterator)localObject5).hasNext())
            {
              ...
              for (localObject2 = ((MessageRecord)localObject6).senderuin;; localObject2 = ((MessageRecord)localObject6).selfuin) {
                try
                {
                  ...
                  if (((MessageRecord)localObject6).msgtype == -2005)
                  {
                  ...
                  if (MessageProtoCodec.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageRecord)localObject6, (msg_svc.RoutingHead)localObject2)) {
                    ((msg_svc.PbC2CMsgWithDrawReq.MsgInfo)localObject7).routing_head.set((MessageMicro)localObject2);
                  }
        ...
        msg_svc.PbGroupMsgWithDrawReq localPbGroupMsgWithDrawReq = new msg_svc.PbGroupMsgWithDrawReq();
        ...
        if (((Iterator)localObject3).hasNext())
        {
          ...
          if (((MessageRecord)localObject5).msgtype == -2005)
          {
          ...
          localPbGroupMsgWithDrawReq.msg_list.add((MessageMicro)localObject6);
          localObject6 = new RevokeMsgInfo((MessageRecord)localObject5);
          ((RevokeMsgInfo)localObject6).e = 0;
          if ((i2 == 1) && (!TextUtils.equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), ((MessageRecord)localObject5).senderuin)))
          {
            if (!TroopUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((MessageRecord)localObject5).frienduin, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())) {
              break label1277;
            }
            ((RevokeMsgInfo)localObject6).e = 2;
          }
          for (;;)
          {
            ...
            break;
            label1277:
            if (TroopUtils.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((MessageRecord)localObject5).frienduin, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())) {
              ((RevokeMsgInfo)localObject6).e = 1;
            }
          }
        }
        localPbGroupMsgWithDrawReq.uint32_sub_cmd.set(paramInt);
        if (i2 == 1)
        {
          localPbGroupMsgWithDrawReq.uint32_group_type.set(0);
          label1332:
          localPbGroupMsgWithDrawReq.uint64_group_code.set(Long.valueOf(((MessageRecord)paramList.get(0)).frienduin).longValue());
        ...
        for (;;)
        {
          localPbGroupMsgWithDrawReq.bytes_userdef.set(ByteStringMicro.copyFrom(((msgrevoke_userdef.MsgInfoUserDef)localObject1).toByteArray()));
          paramList = localPbGroupMsgWithDrawReq;
          localObject1 = null;
          break;
          if (i2 != 3000) {
            break label1332;
          }
          localPbGroupMsgWithDrawReq.uint32_group_type.set(1);
          break label1332;
          label1450:
    ...
    for (;;)
    {
      ...
      if ((!MsgProxyUtils.a(paramMessageRecord)) && (MsgProxyUtils.f(paramMessageRecord.msgtype)))
      {
        ...
        for (;;)
        {
          ...
          int i2 = MobileQQService.jdField_a_of_type_Int;
          MobileQQService.jdField_a_of_type_Int = i2 + 1;
          long l1 = i2;
          ...
          while (i2 < 12)
          {
            localSendMessageHandler.a(new aaax(this, localMessageRecord, l1));
            i2 += 1;
          }
          i2 = 0;
          if (i2 < 6)
  ...
  public void a(MessageRecord paramMessageRecord, ArrayList paramArrayList, ChatActivityFacade.HongbaoParams paramHongbaoParams)
  {
    ...
    if (paramArrayList == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.b(8019, false, new Object[] { Integer.valueOf(0), Long.valueOf(0L), Boolean.valueOf(false) });
      return;
    }
    ...
    {
      a(false, true, true, 0L, new aaav(this, paramMessageRecord, bool, paramArrayList));
      return;
    }
  }
  ...
  public void a(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      if (this.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerRecallListener != null) {
        this.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerRecallListener.a(false);
      }
  ...
  public void a(List paramList)
  {
    ...
    for (;;)
    {
      ...
      localSendMessageHandler.a(new aaaw(this, paramList));
      i1 += 1;
    }
    label93:
    if (i2 < 6) {
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerRecallListener != null) {
      this.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerRecallListener.a(true);
    }
