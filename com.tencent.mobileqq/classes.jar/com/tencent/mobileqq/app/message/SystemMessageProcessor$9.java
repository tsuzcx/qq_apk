  ...
  implements ProtoReqManagerImpl.IProtoRespBack
{
  ...
  public void onProtoResp(ProtoReqManagerImpl.ProtoResp paramProtoResp, ProtoReqManagerImpl.ProtoReq paramProtoReq)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localObject1 = (FriendsManager)SystemMessageProcessor.b(this.a).getManager(QQManagerFactory.FRIENDS_MANAGER);
        paramProtoReq = SystemMessageProcessor.c(this.a).getAccount();
      ...
      else if (paramProtoResp.size() > 0)
      {
        ...
        l3 = FriendSystemMsgController.a().a(SystemMessageProcessor.d(this.a));
        localObject2 = SystemMessageProcessor.e(this.a).getMessageFacade().a(AppConstants.FRIEND_SYSTEM_MSG_UIN, 0, l3).iterator();
        while (((Iterator)localObject2).hasNext())
        {
          ...
          {
            SystemMessageProcessor.f(this.a).getMessageFacade().b(AppConstants.FRIEND_SYSTEM_MSG_UIN, 0, ((ChatMessage)localObject3).uniseq, false);
          ...
          else if ((localObject3 instanceof MessageForSystemMsg))
          {
            ...
            {
              SystemMessageProcessor.g(this.a).getMessageFacade().b(AppConstants.FRIEND_SYSTEM_MSG_UIN, 0, ((ChatMessage)localObject3).uniseq, false);
              ((Iterator)localObject2).remove();
            }
          }
        }
        FriendSystemMsgController.a().a(SystemMessageProcessor.h(this.a), l2);
        if (paramProtoResp.size() < 20) {
          FriendSystemMsgController.a().a(true, SystemMessageProcessor.i(this.a));
        }
        l2 = localRspNextSystemMsg.following_friend_seq.get();
        l1 = l2;
        if (l2 <= 0L) {
          l1 = SystemMessageProcessor.j(this.a).getMsgCache().e("following_friend_seq_47");
        }
        if (QLog.isColorLevel()) {
          QLog.e("Q.systemmsg.", 2, "<---sendGetNextFriendSystemMsg : decode pb following_friend_seq" + l1);
        }
        SystemMessageProcessor.k(this.a).getMsgCache().e("following_friend_seq_47", l1);
        localObject1 = SystemMessageProcessor.m(this.a).getMessageFacade();
        paramProtoReq = String.valueOf(paramProtoReq);
        if ((!MessageHandlerUtils.a(paramProtoResp)) || (!SystemMessageProcessor.l(this.a).isBackgroundStop)) {
          break label866;
        }
      }
    }
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      for (;;)
      {
        ...
        return;
        FriendSystemMsgController.a().a(true, SystemMessageProcessor.n(this.a));
      }
      i = 0;
      break;
    }
