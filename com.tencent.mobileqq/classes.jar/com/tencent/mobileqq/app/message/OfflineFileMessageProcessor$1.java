  ...
  implements BaseMessageProcessor.RequestBuilder
{
  ...
  {
    ToServiceMsg localToServiceMsg = OfflineFileMessageProcessor.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageOfflineFileMessageProcessor).createToServiceMsg("MessageSvc.PbSendMsg");
    ...
    localToServiceMsg.putWupBuffer(MessageProtoCodec.a(OfflineFileMessageProcessor.b(this.jdField_a_of_type_ComTencentMobileqqAppMessageOfflineFileMessageProcessor), this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_ArrayOfByte, this.jdField_b_of_type_Int, this.c, localTransMsgContext, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFMTransC2CMsgInfo.msgSeq, MessageUtils.b(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFMTransC2CMsgInfo.msgUid)).toByteArray());
