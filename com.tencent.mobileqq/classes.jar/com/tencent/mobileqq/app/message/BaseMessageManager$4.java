...
public class BaseMessageManager$4
  implements Runnable
{
  public BaseMessageManager$4(akoj paramakoj, MessageRecord paramMessageRecord, long paramLong) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      return;
      this.this$0.a.a().a().a(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.frienduin, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.istroop, akrh.e, akrh.m);
    }
  }
}
 ...
 * Qualified Name:     com.tencent.mobileqq.app.message.BaseMessageManager.4
