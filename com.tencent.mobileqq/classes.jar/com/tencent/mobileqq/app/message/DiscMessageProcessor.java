  ...
  extends BaseMessageProcessorForTroopAndDisc
{
  ...
  private MessageRecord a(MsgInfo paramMsgInfo, long paramLong)
  {
    ...
    case 9: 
      do
      {
        do
        {
          ...
          i = ((DiscussionManager)localObject7).a(l1 + "");
        ...
        if ((TextUtils.isEmpty((CharSequence)localObject1)) || (ContactUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1))))
        {
          if (QLog.isColorLevel()) {
        ...
        localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131433987, new Object[] { localObject1 });
        ...
        k = PkgTools.a((byte[])localObject6, 13);
        localObject3 = new ArrayList();
        j = 15;
        for (i = 1; i < k + 1; i = (short)(i + 1))
        {
          localObject7 = (String)((ArrayList)localObject1).get(i);
          l3 = PkgTools.a((byte[])localObject6, j);
          j += 4;
          ((List)localObject5).add(String.valueOf(l3));
          ((ArrayList)localObject3).add(new Pair(String.valueOf(l3), localObject7));
        }
        localObject6 = new DiscussionHandler.ReqDiscussInfo();
        ((DiscussionHandler.ReqDiscussInfo)localObject6).jdField_b_of_type_Int = ((ArrayList)localObject1).size();
        ((DiscussionHandler.ReqDiscussInfo)localObject6).jdField_a_of_type_JavaLangString = String.valueOf(l1);
        ((DiscussionHandler)localObject4).a((DiscussionHandler.ReqDiscussInfo)localObject6);
        ...
        if (((RecentUserProxy)localObject6).b(Long.toString(l1), 3000) != null)
        {
          ...
          if (ContactUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1)))
          {
        ...
        i = PkgTools.a((byte[])localObject6, 17);
        localObject1 = new byte[i];
        PkgTools.b((byte[])localObject6, 19, (byte[])localObject1, i);
        ...
        if (l2 == paramLong)
        {
          localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131435905, new Object[] { localObject5 });
          ((DiscussionHandler)localObject4).a(String.valueOf(l1), (String)localObject5);
          a(paramMsgInfo, paramLong, l1, l2, (String)localObject1);
          return null;
        }
        localObject3 = "";
        localObject1 = ((DiscussionManager)localObject7).a(String.valueOf(l1));
        if ((localObject1 != null) && (((DiscussionInfo)localObject1).isDiscussHrMeeting())) {
          localObject1 = QAVHrMeeting.a((DiscussionManager)localObject7, ((DiscussionInfo)localObject1).uin, String.valueOf(l2));
        }
        for (;;)
        {
          ...
          localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131435906, new Object[] { localObject3, localObject5 });
          break;
          localObject1 = localObject3;
          if (paramMsgInfo.vNickName != null)
          {
      ...
      k = PkgTools.a((byte[])localObject6, 7);
      localObject4 = new ArrayList();
      i = 9;
      j = 0;
      while (j < k)
      {
        l3 = PkgTools.a((byte[])localObject6, i);
        localObject3 = "";
        localObject1 = localObject3;
        if (paramMsgInfo.vNickName != null)
        {
      ...
      j = PkgTools.a((byte[])localObject6, i);
      localObject1 = new byte[j];
      PkgTools.b((byte[])localObject6, i + 2, (byte[])localObject1, j);
      ...
      this.jdField_a_of_type_AndroidOsHandler.postDelayed(new zpy(this, (ArrayList)localObject4, paramLong, l1, (String)localObject1, paramMsgInfo, l2), 2000L);
      return null;
    case 22: 
      l3 = PkgTools.a((byte[])localObject6, 5);
    ...
    for (int i = 1;; i = 0)
    {
      ...
      case 1: 
      case 2: 
        k = PkgTools.a((byte[])localObject6, 25);
        j = 27;
        localObject3 = "";
        localObject1 = localObject3;
        if (i != 0)
        ...
        localObject1 = new DiscussionHandler.ReqDiscussInfo();
        ((DiscussionHandler.ReqDiscussInfo)localObject1).jdField_b_of_type_Int = k;
        ((DiscussionHandler.ReqDiscussInfo)localObject1).jdField_a_of_type_JavaLangString = String.valueOf(l1);
        ((DiscussionHandler)localObject4).a((DiscussionHandler.ReqDiscussInfo)localObject1);
        ...
        for (i = 1;; i = 0)
        {
          ...
          while (i < k)
          {
            String str = String.valueOf(PkgTools.a((byte[])localObject6, j));
            localObject3 = "";
            localObject1 = localObject3;
            if (paramMsgInfo.vNickName != null)
            {
        ...
        for (;;)
        {
          ((DiscussionHandler)localObject4).a(l1, String.valueOf(l3), (List)localObject5, i);
          if (this.jdField_a_of_type_AndroidOsHandler == null) {
            this.jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManager.getSubThreadLooper());
          }
          this.jdField_a_of_type_AndroidOsHandler.postDelayed(new zpz(this, l3, paramLong, (Pair)localObject7, paramMsgInfo, l1, l2, b, l4, (Pair)localObject8, (ArrayList)localObject9), 2000L);
          break;
          if (l4 == 1L) {
            i = 10006;
          } else if (l4 == 2L) {
      ...
      localObject1 = new byte[i];
      PkgTools.b((byte[])localObject6, 5, (byte[])localObject1, i);
      localObject3 = new oidb_0x858.NotifyMsgBody();
      paramMsgInfo = (MessageForQQWalletTips)MessageRecordFactory.a(-2029);
      try
      {
        ...
        paramMsgInfo.init(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), l2 + "", "", "[QQWallet Tips]", MessageCache.a(), -2029, 3000, MessageCache.a());
      ...
      i = PkgTools.a(localObject6[13]);
      PkgTools.a((byte[])localObject6, 14, i);
      i += 14;
      k = PkgTools.a((byte[])localObject6, i);
      j = i + 2;
      Object localObject2 = new HashSet();
      i = 0;
      while (i < k)
      {
        l5 = PkgTools.a((byte[])localObject6, j);
        j += 4;
      ...
      {
        ((DiscussionHandler)localObject3).a(paramLong);
        break;
      }
      ...
      for (;;)
      {
        ...
        while (i < k)
        {
          l4 = PkgTools.a((byte[])localObject6, j);
          if (QLog.isColorLevel()) {
        ...
        for (localObject3 = ((StringBuffer)localObject3).deleteCharAt(((StringBuffer)localObject3).toString().length() - 1).toString();; localObject3 = "")
        {
          ...
          localObject3 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131433988, new Object[] { localObject3 });
          ...
          return null;
          i = (int)PkgTools.a((byte[])localObject6, 5);
          localObject2 = new byte[i];
          PkgTools.b((byte[])localObject6, 9, (byte[])localObject2, i);
          ...
          try
          {
            ...
            case 2: 
              ...
              ((BizTroopHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(22)).a(42, true, new Object[] { Integer.valueOf(2131429856), localObject3, localObject2, Boolean.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c().equals(paramMsgInfo)) });
            }
          }
  ...
  private void a(MsgInfo paramMsgInfo, long paramLong1, long paramLong2, long paramLong3, int paramInt)
  {
    ...
    String str = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131433030);
    switch (paramInt)
    {
    default: 
      if (QLog.isColorLevel()) {
    ...
    for (int i = 2131433028;; i = 2131433029)
    {
  ...
  private void a(MsgInfo paramMsgInfo, long paramLong1, long paramLong2, long paramLong3, String paramString)
  {
    ...
    localMessageRecord.isread = true;
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.DiscMsgPc", 2, "----------handleC2COnlinePushMsgResp after analysis friendUin: " + paramLong2 + " msgType: " + -1004 + " friendType: " + 3000 + " shMsgSeq: " + paramMsgInfo.shMsgSeq + " msgContent: " + Utils.a(paramString));
    }
  ...
  private void a(Pair paramPair1, MsgInfo paramMsgInfo, long paramLong1, long paramLong2, long paramLong3, byte paramByte, long paramLong4, Pair paramPair2)
  {
    ...
    for (;;)
    {
      ...
      if (paramLong4 == 0L) {
        paramPair1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131434002, new Object[] { paramPair1 });
      }
      for (;;)
      {
        ...
        return;
        if (paramLong4 == 1L) {
          paramPair1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131434004, new Object[] { paramPair1, paramPair2 });
        } else if (paramLong4 == 2L) {
          paramPair1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131437158, new Object[] { paramPair1 });
        } else {
          paramPair1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131433986, new Object[] { paramPair1 });
        }
      }
    }
  }
  ...
  private void a(Pair paramPair, MsgInfo paramMsgInfo, ArrayList paramArrayList, long paramLong1, String paramString, byte paramByte, long paramLong2, boolean paramBoolean)
  {
    ...
    if (m > 50)
    {
      ...
      paramPair = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131433995);
    ...
    paramPair = "";
    if (paramByte == 11) {
      paramPair = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131434001);
    }
    if (paramByte == 22)
    {
      if (paramLong2 == 0L) {
      ...
      for (;;)
      {
        ...
        return;
        if (paramLong2 == 1L) {
          paramPair = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131434003);
        } else if (paramLong2 == 2L) {
          paramPair = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131437159, new Object[] { localStringBuffer.toString() });
        }
      }
    }
    if (l == paramLong1)
    {
      ...
      paramPair = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131433994);
    }
    for (;;)
    {
      paramPair = paramPair + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131433986, new Object[] { localStringBuffer.toString() });
      break;
      j = 0;
      break label644;
      label721:
      ...
      paramPair = paramPair + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131433993);
      continue;
      label841:
      paramPair = "";
    }
  ...
  private void a(Pair paramPair, MsgInfo paramMsgInfo, ArrayList paramArrayList, long paramLong, String paramString, byte paramByte, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.postDelayed(new zqa(this, paramPair, paramMsgInfo, paramArrayList, paramLong, paramString, paramByte, paramBoolean), 2000L);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, int paramInt, MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    PkgTools.b(paramArrayOfByte, paramInt, paramMessageRecord, i);
  ...
  private void a(ToServiceMsg paramToServiceMsg, ArrayList paramArrayList, msg_svc.PbGetDiscussMsgResp paramPbGetDiscussMsgResp)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      {
        paramToServiceMsg = (DiscussionHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6);
        ...
        if (paramToServiceMsg.size() > 0)
        {
          ...
          j = MsgProxyUtils.a(paramToServiceMsg, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        ...
        for (;;)
        {
          if ((i != 0) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(str) == 1))
          {
            ...
            if (paramToServiceMsg != null)
            {
              ...
              ((BaseMessageManagerForTroopAndDisc)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(3000)).b(str, 3000, l1);
            }
          }
          return;
          bool1 = false;
  ...
  private void a(ToServiceMsg paramToServiceMsg, ArrayList paramArrayList, msg_svc.PbGetDiscussMsgResp paramPbGetDiscussMsgResp, String paramString)
  {
    ...
    for (paramArrayList = ((msg_comm.DiscussInfo)localObject3).discuss_remark.get().toByteArray();; paramArrayList = null)
    {
      for (;;)
      {
        ...
        localPBDecodeContext.jdField_c_of_type_Int = 3000;
        ...
        try
        {
          a((msg_comm.Msg)localObject2, localArrayList3, localPBDecodeContext, true, localMessageInfo);
          ...
          localObject2 = HexUtil.a(paramArrayList) + ":" + (String)localObject3;
          if (((HashSet)localObject1).contains(localObject2)) {
            break;
          }
          paramArrayList = ((DiscussionManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52)).a(paramArrayList, String.valueOf(l5), (String)localObject3, false);
          if (paramArrayList == null) {
            break;
          }
      ...
      paramArrayList = (DiscussionHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6);
      ...
      ((VasExtensionManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(234)).a.a(localArrayList1);
      return;
    }
  }
  ...
  private void a(ArrayList paramArrayList, String paramString1, String paramString2, String paramString3)
  {
    ...
    if ((paramArrayList != null) && (paramArrayList.size() > 1))
    {
      ...
      paramArrayList = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131433027, new Object[] { localStringBuilder });
      localMessageRecord.init(paramString2, paramString1, paramString3, paramArrayList + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131435936), l, -1016, 3000, l);
  ...
  private void a(ArrayList paramArrayList1, ArrayList paramArrayList2)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("Q.msg.DiscMsgPc", 2, "<---discussionMsgRecordHandle_PB : fromUin:" + l4 + ",toUin:" + l2 + ",msgTime:" + i + ",msgSeq:" + l3 + ",msgUid:" + l5 + ",userActive:" + j + ",fromInstid:" + k + ",disUin:" + l1 + ",disType:" + m + ",disSeq:" + l6 + ",remarkSender:" + Arrays.toString(paramArrayList1) + ",hasAppShare:" + localMsg.appshare_info.has() + ",hasMsgBody:" + localMsg.msg_body.has());
      }
  ...
  private void a(msg_comm.Msg paramMsg, FromServiceMsg paramFromServiceMsg, msg_onlinepush.PbPushMsg paramPbPushMsg, boolean paramBoolean)
  {
    ...
    for (localObject1 = ((msg_comm.DiscussInfo)localObject2).discuss_remark.get().toByteArray();; localObject1 = null)
    {
      ...
      for (;;)
      {
        ...
        {
          this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a(l3, paramPbPushMsg.svrip.get(), i3);
          return;
        ...
        ((PBDecodeContext)localObject2).jdField_c_of_type_Int = 3000;
        ((PBDecodeContext)localObject2).d = i2;
          ...
          if (i < j)
          {
            ...
            if ((((MessageRecord)localObject5).senderuin != null) && (((MessageRecord)localObject5).senderuin.equalsIgnoreCase(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())))
            {
              ...
              if (localObject6 != null)
              {
                ...
                this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().g(((MessageRecord)localObject5).frienduin, ((MessageRecord)localObject5).shmsgseq);
              }
            }
            for (;;)
            {
              ...
              if ((i == 0) && (localObject1 != null) && (localObject1.length > 0))
              {
                ...
                localObject6 = HexUtil.a((byte[])localObject1) + ":" + str;
        ...
        if (paramFromServiceMsg.size() > 0)
        {
          ...
          i = MsgProxyUtils.a(paramFromServiceMsg, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          ...
          for (;;)
          {
            ...
            if (((MessageRecord)localObject3).istroop == 3000)
            {
              ...
              ((Map)localObject1).put(((MessageRecord)localObject3).frienduin, Long.valueOf(Math.max(((MessageRecord)localObject3).shmsgseq, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().g(((MessageRecord)localObject3).frienduin))));
            }
          }
          label1655:
          ...
          while (((Iterator)localObject2).hasNext())
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().g((String)localObject3, ((Long)((Map)localObject1).get(localObject3)).longValue());
          }
        ...
        for (boolean bool1 = true;; bool1 = false)
        {
          ...
          ((VasExtensionManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(234)).a.a(paramMsg);
          return;
        }
        i = 0;
        j = 0;
  ...
  private boolean a(long paramLong1, long paramLong2, short paramShort)
  {
    ...
    //   5: dup
    //   6: invokespecial 69	java/lang/StringBuilder:<init>	()V
    //   9: lload_1
    //   10: invokevirtual 83	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   13: ldc_w 1526
    //   16: invokevirtual 75	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   19: lload_3
    //   20: invokevirtual 83	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   23: ldc_w 1526
    //   26: invokevirtual 75	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   29: iload 5
    //   31: invokevirtual 78	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    ...
    //   43: invokevirtual 977	com/tencent/mobileqq/app/QQAppInterface:a	()Lcom/tencent/mobileqq/service/message/MessageCache;
    //   46: invokevirtual 1528	com/tencent/mobileqq/service/message/MessageCache:a	()Ljava/util/ArrayList;
    //   49: aload 7
    //   51: invokevirtual 1529	java/util/ArrayList:contains	(Ljava/lang/Object;)Z
    //   54: ifeq +45 -> 99
    //   57: invokestatic 64	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   60: ifeq +31 -> 91
    //   63: ldc_w 536
    //   66: iconst_2
    ...
    //   88: invokestatic 1533	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   91: iconst_1
    //   92: istore 6
    //   94: aload_0
    //   95: monitorexit
    ...
    //   103: invokevirtual 977	com/tencent/mobileqq/app/QQAppInterface:a	()Lcom/tencent/mobileqq/service/message/MessageCache;
    //   106: aload 7
    //   108: invokevirtual 1534	com/tencent/mobileqq/service/message/MessageCache:a	(Ljava/lang/String;)V
    //   111: iconst_0
    //   112: istore 6
    //   114: goto -20 -> 94
    //   117: astore 7
  ...
  private void b(Pair paramPair, MsgInfo paramMsgInfo, ArrayList paramArrayList, long paramLong, String paramString, byte paramByte, boolean paramBoolean)
  {
  ...
  public static void b(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, int paramInt, MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    try
    {
      paramArrayOfByte.mergeFrom(paramMessageRecord);
      paramInt = paramArrayOfByte.opt_enum_type.get();
      l = paramArrayOfByte.opt_uint64_conf_uin.get();
      if (paramInt == 11)
      {
        if (QLog.isColorLevel()) {
        ...
        ((ApolloGameManager)paramQQAppInterface.getManager(210)).a(0, 3000, Long.toString(l), paramArrayOfByte);
        return;
      }
      if (paramInt == 12)
      {
        ...
        ((ApolloPushManager)paramQQAppInterface.getManager(226)).a(3000, paramArrayOfByte);
        return;
      }
    }
    catch (Exception paramQQAppInterface)
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("GoldMsgChatHelper", 2, "goldmsg push, [Discussion].");
      }
      if (paramArrayOfByte.opt_msg_goldtips.has())
      {
        ...
        GoldMsgDbManager.a(3000, Long.toString(l), null, (oidb_0x858.GoldMsgTipsElem)paramArrayOfByte.opt_msg_goldtips.get());
      }
    }
  }
  ...
  public List a(msg_comm.Msg paramMsg, PBDecodeContext paramPBDecodeContext)
  {
    ...
    try
    {
      ...
      ((TroopInfoManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36)).a(String.valueOf(l) + "&" + 3000, localMessageInfo);
  ...
  public zqm a(int paramInt, MsgInfo paramMsgInfo, SvcReqPushMsg paramSvcReqPushMsg)
  {
    ...
    for (;;)
    {
      ...
      if ((paramMsgInfo != null) && (paramSvcReqPushMsg != null)) {
        return new zqm(a(paramMsgInfo, paramSvcReqPushMsg), false);
      }
