  ...
  extends C2CMessageProcessor
{
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    else
    {
      ...
      StatisticCollector.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "actSBGetMsg", false, 0L, 0L, paramToServiceMsg, "");
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          continue;
          localSubAccountBackProtocData.jdField_a_of_type_Int = 1006;
          continue;
                        ...
                        for (List localList1 = localSubAccountManager.a(Long.toString(l3));; localList1 = null)
                        {
                          ...
                          for (;;)
                          {
                            ...
                            if (m < localList2.size())
                            {
                              ...
                              Collections.sort(paramObject, new zqt(this));
                                ...
                                if (localObject2 != null)
                                {
                                  ...
                                  for (;;)
                                  {
                                    for (;;)
                                    {
                                      ...
                                      paramObject.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131435924);
                                      paramObject.msgtype = 193;
                                      paramFromServiceMsg.add(paramObject);
                                      continue;
                                      if ((MessageUtils.c(i)) && (((msg_comm.MsgHead)localObject3).c2c_cmd.has()) && ((i1 == 169) || (i1 == 241) || (i1 == 242) || (i1 == 243) || (i1 == 129) || (i1 == 131) || (i1 == 133)))
                                      {
                                          ...
                                          catch (Exception paramObject)
                                          {
                                            try
                                            {
                                              ...
                                              if (TextUtils.isEmpty(paramObject)) {
                                                paramFromServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131435555);
                                              }
                                  ...
                                  try
                                  {
                                    ...
                                    if (String.valueOf(AppConstants.F).equalsIgnoreCase(((MessageRecord)localObject4).frienduin))
                                    {
                                      paramFromServiceMsg = SubAccountControll.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramObject, ((MessageRecord)localObject4).msgtype, ((MessageRecord)localObject4).senderuin);
                                      if (paramFromServiceMsg == null)
                                      {
                                        i = 1;
                              ...
                              for (;;)
                              {
                                try
                                {
                                  if (!ActionMsgUtil.a(((MessageRecord)localObject4).msgtype)) {
                                    continue;
                                  }
                                  localObject4 = ActionMsgUtil.a(((MessageRecord)localObject4).msg);
                                  paramFromServiceMsg = paramObject;
                                ...
                                paramFromServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131436459);
                                continue;
                                if (FlashPicHelper.a((MessageRecord)localObject4))
                                {
                                  paramFromServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131435551);
                                }
                                else
                                {
                                  paramFromServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131435550);
                                  continue;
                                  ...
                                  catch (Exception paramObject)
                                  {
                                    ...
                                    continue;
                                    paramFromServiceMsg = paramObject;
                                    if (paramObject.equalsIgnoreCase(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131435555))) {
                                      continue;
                                    }
                                    paramFromServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131435555) + paramObject;
                                    continue;
                                  }
                                  if (TextUtils.isEmpty(paramObject))
                                  {
                                  ...
                                  {
                                    paramFromServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131435553);
                                    continue;
                                    paramFromServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131436259);
                                    continue;
                                    paramFromServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131436260);
                                    continue;
                                    ...
                                    paramFromServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131435917) + paramFromServiceMsg.messagetail + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131435918);
                                    continue;
                                    paramFromServiceMsg = paramObject;
                                    if (!ActionMsgUtil.b(((MessageRecord)localObject4).msgtype))
                                    {
                                      ...
                                      if (((MessageRecord)localObject4).msg != null)
                                      {
                                        ...
                                        {
                                          localObject4 = MessageUtils.a(((MessageRecord)localObject4).msg);
                                          paramObject = "";
                                          paramFromServiceMsg = paramObject;
                                          if (localObject4 != null)
                                          {
                                          ...
                                          paramFromServiceMsg = "[" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131433822) + "] " + paramFromServiceMsg;
                                        }
                                      }
                                    }
                                  }
                              ...
                              if ((paramFromServiceMsg != null) && (paramFromServiceMsg.from_nick.has()))
                              {
                                ...
                                if (i != 0) {
                                  paramFromServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131434926);
                                }
                                if (QLog.isColorLevel()) {
                                ...
                                if (i != 0)
                                {
                                  ((SubAccountMessage)localObject2).frienduin = String.valueOf(AppConstants.F);
                                  if (!bool1) {
                                    break label4777;
                                  }
                                  bool2 = true;
                                ...
                                for (l4 = System.currentTimeMillis() / 1000L;; l4 = l5)
                                {
                                  ...
                                  ((SubAccountMessage)localObject2).mTimeString = TimeFormatterUtils.a(1000L * l5, true, SubAccountControll.jdField_a_of_type_JavaLangString);
                                  ...
                                  SubAccountControll.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str1, 6);
                                  localSubAccountBackProtocData.d = true;
                                  paramFromServiceMsg = MessageRecordFactory.a(((MessageRecord)localObject3).msgtype);
                                  ...
                                  i = 0;
                                  if (localSubAccountManager != null) {
                                    i = localSubAccountManager.c(str1);
                                  }
                                  int i2 = i - i1;
                                  if (i2 != 0) {
                            ...
                            else
                            {
                              if ((localList1 != null) && (localList1.size() > 0) && (k != 0))
                              {
                                ...
                                if (i < localList1.size())
                                {
                                  ...
                                  for (;;)
                                  {
                                    i += 1;
                                    break;
                                    if (!paramFromServiceMsg.frienduin.equals(String.valueOf(AppConstants.F)))
                                    {
                                      m = 0;
                              ...
                              for (;;)
                              {
                                ...
                                StatisticCollector.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "actSBGetMsg", true, 0L, 0L, paramFromServiceMsg, "");
                                if (b <= 0) {
                                  break label5257;
                                }
                                if (l3 <= 0L) {
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    return;
    new zqu(this, paramObject, str, (String)localObject, i, j).execute(new Void[0]);
  }
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a(8024, false, paramToServiceMsg);
  }
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a(8024, true, paramFromServiceMsg);
  }
  ...
  public void a(boolean paramBoolean, ArrayList paramArrayList)
  {
    ...
    for (int i = 0;; i = paramArrayList.size())
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a(8024, false, paramArrayList);
      return;
    }
      ...
      while (paramArrayList.hasNext())
      {
        ...
        if (localObject2 != null)
        {
          try
          {
            ...
            localThirdQQReqInfo.third_uin_sig.set(ByteStringMicro.copyFrom(PkgTools.a((String)localObject3)));
  ...
  public boolean a(SubAccountInfo paramSubAccountInfo)
  {
    ...
    for (;;)
    {
      ...
      ((Oidb_0x5d0.ReqBody)localObject1).uint32_start_time.set(SubAccountControll.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), paramSubAccountInfo.subuin));
      try
      {
        ...
        localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a("OidbSvc.0x5d0_1");
