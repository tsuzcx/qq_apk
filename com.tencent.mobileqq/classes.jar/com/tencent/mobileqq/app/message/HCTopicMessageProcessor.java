...
{
  public Comparator b = new zqb(this);
  ...
  private ArrayList a(ArrayList paramArrayList, String paramString)
  {
    ...
    localPBDecodeContext.e = Long.valueOf(paramString).longValue();
    localPBDecodeContext.c = 1026;
    ...
    while (paramArrayList.hasNext())
    {
      ...
      if (paramString != null)
      {
        ...
        localPBDecodeContext.d = ((msg_comm.GroupInfo)((msg_comm.MsgHead)localObject).group_info.get()).group_type.get();
        try
        {
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    ...
    //   38: iconst_1
    //   39: aaload
    //   40: checkcast 209	java/lang/String
    //   43: astore_2
    //   44: aload 9
    //   46: getfield 213	msf/msgcomm/msg_comm$Msg:appshare_info	Lmsf/msgcomm/msg_comm$AppShareInfo;
    //   49: iconst_0
    //   50: invokevirtual 219	msf/msgcomm/msg_comm$AppShareInfo:setHasFlag	(Z)V
    //   53: iconst_1
    //   54: istore_3
    //   55: iload_3
    //   56: ifeq +28 -> 84
    ...
    //   60: aload 9
    //   62: aload_2
    //   63: invokevirtual 222	com/tencent/mobileqq/app/message/HCTopicMessageProcessor:a	(Lmsf/msgcomm/msg_comm$Msg;Ljava/lang/String;)V
    //   66: return
    //   67: astore 10
    //   69: aconst_null
    //   70: astore 9
    ...
    //   73: astore_2
    //   74: aload 10
    //   76: invokevirtual 225	java/lang/Exception:printStackTrace	()V
    //   79: iconst_0
    //   80: istore_3
    //   81: goto -26 -> 55
    //   84: aload_0
    //   85: aload_0
    //   86: invokevirtual 229	java/lang/Object:getClass	()Ljava/lang/Class;
    //   89: invokevirtual 234	java/lang/Class:getName	()Ljava/lang/String;
    //   92: iload_1
    //   93: invokevirtual 237	com/tencent/mobileqq/app/message/HCTopicMessageProcessor:a	(Ljava/lang/String;I)V
    //   96: return
    //   97: aconst_null
    //   98: astore 12
    //   100: lconst_0
    ...
    //   119: aload 10
    //   121: invokespecial 239	com/tencent/mobileqq/app/message/HCTopicMessageProcessor:a	(Ljava/util/List;Ljava/util/List;)V
    //   124: aload_2
    //   125: iconst_1
    //   126: aaload
    //   127: checkcast 209	java/lang/String
    //   130: astore 9
    //   132: aload_2
    //   133: iconst_2
    //   134: aaload
    //   135: checkcast 209	java/lang/String
    //   138: astore 11
    //   140: aload_2
    //   141: iconst_3
    //   142: aaload
    ...
    //   180: iconst_1
    //   181: iload 8
    //   183: invokestatic 244	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   186: aastore
    //   187: dup
    //   188: iconst_2
    //   189: aload_2
    ...
    //   197: iconst_4
    //   198: lload 4
    //   200: invokestatic 247	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   203: aastore
    //   204: dup
    //   205: iconst_5
    //   206: aload 10
    ...
    //   239: aload 11
    //   241: lload 4
    //   243: invokevirtual 250	com/tencent/mobileqq/app/message/HCTopicMessageProcessor:a	(ZLjava/lang/String;Ljava/util/ArrayList;Ljava/lang/String;J)V
    //   246: return
    //   247: astore 9
    //   249: aconst_null
    //   250: astore_2
    ...
    //   256: astore 11
    //   258: aload 9
    //   260: invokevirtual 225	java/lang/Exception:printStackTrace	()V
    //   263: iconst_0
    //   264: istore 8
    //   266: goto -105 -> 161
    //   269: iconst_0
    ...
    //   275: aload_0
    //   276: aload_0
    //   277: invokevirtual 229	java/lang/Object:getClass	()Ljava/lang/Class;
    //   280: invokevirtual 234	java/lang/Class:getName	()Ljava/lang/String;
    //   283: iload_1
    //   284: invokevirtual 237	com/tencent/mobileqq/app/message/HCTopicMessageProcessor:a	(Ljava/lang/String;I)V
    //   287: return
    //   288: astore 9
    //   290: aconst_null
    //   291: astore_2
  ...
  protected void a(msg_comm.Msg paramMsg, String paramString)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        ((PBDecodeContext)localObject3).e = l3;
        ((PBDecodeContext)localObject3).c = 1026;
        ((PBDecodeContext)localObject3).d = j;
        try
        {
    ...
    for (paramArrayList = a(paramArrayList, paramString1);; paramArrayList = null)
    {
      ...
      for (;;)
      {
        if ((i != 0) && (localMessageCacheItem.a(paramString1) == 1))
        {
          ...
          ((BaseMessageManagerForTroopAndDisc)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(1026)).b(paramString1, 1026, paramLong);
        }
