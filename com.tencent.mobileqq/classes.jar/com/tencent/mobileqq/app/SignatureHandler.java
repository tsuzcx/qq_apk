  ...
  extends ajtd
{
  ...
  private boolean a(String[] paramArrayOfString, byte[] paramArrayOfByte)
  {
    ...
    paramArrayOfString = new NewIntent(this.app.getApp(), akgq.class);
  ...
  private void c(Intent paramIntent, oidb_sso.OIDBSSOPkg paramOIDBSSOPkg)
  {
    ...
    if (i == 0) {
      if ((localRspBody.stInfos.has()) && (localRspBody.stInfos.get().size() > 0))
      {
        ...
        paramIntent = ((ajxn)this.app.getManager(51)).a(paramOIDBSSOPkg);
        if (paramIntent == null) {
          break label426;
        }
    ...
    for (;;)
    {
      ...
      {
        awcj localawcj = new awcj();
        oidb_0x798.Info localInfo = (oidb_0x798.Info)localList.get(i);
        localawcj.jdField_a_of_type_JavaLangString = str;
        localawcj.b = localInfo.uint32_count.get();
        localawcj.jdField_a_of_type_Int = localInfo.uint32_type.get();
        localawcj.c = localInfo.uint32_flag.get();
        paramIntent.sigZanInfo.put(Integer.valueOf(localawcj.jdField_a_of_type_Int), localawcj);
        i += 1;
      }
  ...
  private void d(Intent paramIntent, oidb_sso.OIDBSSOPkg paramOIDBSSOPkg)
  {
    ...
    ExtensionInfo localExtensionInfo = ((ajxn)this.app.getManager(51)).a(str2);
    ...
    if (localExtensionInfo != null)
    {
      ...
      if (str1.equals(localExtensionInfo.getRichStatus().feedsId))
      {
        ...
        {
          paramOIDBSSOPkg = (awcj)localExtensionInfo.getRichStatus().sigZanInfo.get(Integer.valueOf(255));
          paramIntent = paramOIDBSSOPkg;
    ...
    if (QLog.isColorLevel()) {
      QLog.i("SignatureHandler", 2, String.format("handleInteractiveSigature[%s %s %d %d]", new Object[] { bbjw.e(str2), str1, Integer.valueOf(k), Integer.valueOf(j) }));
    }
  ...
  {
    Friends localFriends = ((ajxn)this.app.getManager(51)).e(String.valueOf(paramLong));
  ...
  public List<CommentItem> a(List<oidb_0xde8.CommentItem> paramList, String paramString)
  {
    ...
    if (paramList.hasNext())
    {
      ...
      localCommentItem1.user = new awew(String.valueOf(l), a(l));
      if (localCommentItem1.targetId != 0L) {
        l = localCommentItem.uint64_target_uin.get();
      }
      for (localCommentItem1.toReplyUser = new awew(String.valueOf(l), a(l));; localCommentItem1.toReplyUser = null)
      {
  ...
  public void a()
  {
    ...
    localObject = new NewIntent(this.app.getApp(), akgq.class);
  ...
  public void a(long paramLong1, String paramString1, long paramLong2, long paramLong3, String paramString2)
  {
    ...
    paramString2 = new NewIntent(this.app.getApp(), akgq.class);
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("SignatureHandler", 2, String.format("InteractiveSignature[%s %s %d %d]", new Object[] { bbjw.e(paramString1), paramString2, Integer.valueOf(paramInt1), Integer.valueOf(paramInt2) }));
    }
    if ((TextUtils.isEmpty(paramString2)) || (TextUtils.isEmpty(paramString1))) {}
    do
    {
      return;
      localObject1 = ((ajxn)this.app.getManager(51)).a(paramString1);
    ...
    localObject1 = new NewIntent(this.app.getApp(), akgq.class);
  ...
  public void a(String paramString1, String paramString2, int paramInt, boolean paramBoolean)
  {
    ...
    localObject2 = new NewIntent(this.app.getApp(), akgq.class);
  ...
  public List<awev> b(List<oidb_0xde8.lightCommentItem> paramList)
  {
    if ((paramList == null) || (paramList.size() <= 0)) {
      return new ArrayList();
    }
    ...
    while (paramList.hasNext())
    {
      ...
      localawev.jdField_a_of_type_Long = locallightCommentItem.uint64_time.get();
      long l = locallightCommentItem.uint64_uin.get();
      localawev.jdField_a_of_type_Awew = new awew(String.valueOf(l), a(l));
      localArrayList.add(localawev);
    }
    return localArrayList;
  }
