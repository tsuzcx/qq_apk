...
public class CardHandler$2
  implements Runnable
{
  public CardHandler$2(amov paramamov, Bundle paramBundle) {}
  ...
  public void run()
  {
    ...
    Object localObject = ((amsw)this.this$0.app.getManager(51)).c(this.this$0.app.getCurrentAccountUin());
    ampa localampa = new ampa(this.this$0, null);
    amov.a(this.this$0, localampa, this.a);
    amov.b(this.this$0, localampa, this.a);
    if (QLog.isColorLevel()) {
      QLog.d("CardHandler", 2, "set detail card, field count = " + localampa.jdField_a_of_type_Int);
    }
    if (localampa.jdField_a_of_type_Int == 0)
    {
      this.this$0.notifyUI(31, true, new Object[] { Integer.valueOf(0), localObject });
      return;
    }
    localObject = ByteBuffer.allocate(localampa.b + 7);
    ((ByteBuffer)localObject).putInt((int)Long.parseLong(this.this$0.app.getCurrentAccountUin()));
    ((ByteBuffer)localObject).put((byte)0);
    ((ByteBuffer)localObject).putShort((short)localampa.jdField_a_of_type_Int);
    ((ByteBuffer)localObject).put(localampa.jdField_a_of_type_JavaNioByteBuffer.array(), 0, localampa.b);
    ...
    ((ToServiceMsg)localObject).extraData.putLong("fieldFlag", localampa.jdField_a_of_type_Long);
