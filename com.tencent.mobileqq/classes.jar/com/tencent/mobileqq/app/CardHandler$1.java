...
public class CardHandler$1
  implements Runnable
{
  public CardHandler$1(alkv paramalkv, int paramInt, ArrayList paramArrayList) {}
  
  public void run()
  {
    String str = this.this$0.app.getCurrentAccountUin();
    aloz localaloz = (aloz)this.this$0.app.getManager(51);
    Card localCard = localaloz.b(str);
    if (localCard != null)
    {
    ...
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0)) {
      alkv.a(str, this.jdField_a_of_type_JavaUtilArrayList);
    }
  }
}
