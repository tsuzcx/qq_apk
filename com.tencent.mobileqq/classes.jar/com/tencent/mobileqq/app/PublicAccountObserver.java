  ...
  implements BusinessObserver
{
  ...
  public final void onUpdate(int paramInt, boolean paramBoolean, Object paramObject)
  {
    if (100 == paramInt)
    {
      paramObject = (PublicAccountObserver.GetUserFollowListRet)paramObject;
    ...
    do
    {
      ...
      if (101 == paramInt)
      {
        if ((paramObject instanceof PublicAccountObserver.FollowRet))
        {
          paramObject = (PublicAccountObserver.FollowRet)paramObject;
      ...
      if (109 == paramInt)
      {
        onUpdateFunctionFlag(paramBoolean, (PaConfigAttr.PaConfigInfo)paramObject);
        return;
      }
      if (108 == paramInt)
      {
