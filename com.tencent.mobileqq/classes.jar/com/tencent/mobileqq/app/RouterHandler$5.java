  ...
  public void run()
  {
    ...
    if (localObject1 == null)
    {
      ...
      if (localIterator.hasNext())
      {
        ...
        localObject2 = this.this$0.jdField_a_of_type_ComTencentLitetransfersdkProtocolHelper.genSession(0, localRouterMsgRecord.filename, null, ajgm.b(localRouterMsgRecord.msgtype), 0, this.a, 0, 0, 0);
