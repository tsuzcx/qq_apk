  ...
  extends BusinessHandler
{
  ...
  ShieldListHandler(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_JavaLangString = paramQQAppInterface.getApplication().getString(2131719338);
    this.jdField_b_of_type_JavaLangString = paramQQAppInterface.getApplication().getString(2131719339);
    this.c = paramQQAppInterface.getApplication().getString(2131719336);
    this.d = paramQQAppInterface.getApplication().getString(2131719340);
    this.f = paramQQAppInterface.getApplication().getString(2131719334);
    this.g = paramQQAppInterface.getApplication().getString(2131719332);
    this.h = paramQQAppInterface.getApplication().getString(2131719335);
    this.e = paramQQAppInterface.getApplication().getString(2131719337);
    this.i = paramQQAppInterface.getApplication().getString(2131719333);
  }
  ...
  private String a(boolean paramBoolean, long paramLong, int paramInt, String paramString)
  {
    ...
    if (paramInt != 1006) {
      if (paramBoolean)
      {
        ...
        if ((localQidianManager != null) && ((localQidianManager.a(paramString)) || (localQidianManager.f(paramString)))) {
          break label298;
        }
        str = this.d;
      }
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    Object localObject2 = Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    int j = a();
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, sso2sns_0x3_blocklist.RspBody paramRspBody)
  {
    ...
    ((ShieldMsgManger)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.SHIELD_LIST_MANAGER)).a(paramFromServiceMsg);
  ...
  private void a(boolean paramBoolean, int paramInt, long[] paramArrayOfLong)
  {
    ...
    for (;;)
    {
      if (j < m)
      {
        ...
        if (k == 1006) {
          localObject = ContactUtils.f(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1));
        }
        ...
        else
        {
          ...
          localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().b((String)localObject, k);
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    if (paramInt == 1006)
    {
      paramString = ContactUtils.e(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString);
