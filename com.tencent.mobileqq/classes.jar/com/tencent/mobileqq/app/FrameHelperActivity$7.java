  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    RandomCoverView localRandomCoverView = (RandomCoverView)this.this$0.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131378992);
    Object localObject = this.a.getCurrentAccountUin();
    localObject = bghy.a(this.a, (String)localObject);
    ...
    if ((!TextUtils.isEmpty(str)) && (!bkfq.b()))
    {
      ...
      if ((!bkfq.a(this.a, (Card)localObject)) && (((Card)localObject).isNoCover()))
      {
      ...
      FrameHelperActivity.a(this.this$0, bkfq.a(this.this$0.getActivity(), this.a, (Card)localObject, localRandomCoverView, str, FrameHelperActivity.a(this.this$0), this.this$0.jdField_a_of_type_ComTencentMobileqqActivityRecentDrawerFrame.a()));
      return;
    }
