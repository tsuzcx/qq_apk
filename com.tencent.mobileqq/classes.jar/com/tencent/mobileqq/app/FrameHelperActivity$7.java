  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    RandomCoverView localRandomCoverView = (RandomCoverView)this.this$0.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131379220);
    Object localObject = this.a.getCurrentAccountUin();
    localObject = bhaa.a(this.a, (String)localObject);
    ...
    if ((!TextUtils.isEmpty(str)) && (!bkxw.b()))
    {
      ...
      if ((!bkxw.a(this.a, (Card)localObject)) && (((Card)localObject).isNoCover()))
      {
      ...
      FrameHelperActivity.a(this.this$0, bkxw.a(this.this$0.getActivity(), this.a, (Card)localObject, localRandomCoverView, str, FrameHelperActivity.a(this.this$0), this.this$0.jdField_a_of_type_ComTencentMobileqqActivityRecentDrawerFrame.a()));
      return;
    }
