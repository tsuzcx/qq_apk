...
public class HotChatShare
{
  ...
  public HotChatShare(BaseActivity paramBaseActivity, QQAppInterface paramQQAppInterface, HotChatInfo paramHotChatInfo)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppFriendListObserver = new zmj(this);
    ...
    ThreadManager.post(new zmk(this, paramQQAppInterface), 8, null, true);
  }
  ...
  public void a(HotChatInfo paramHotChatInfo)
  {
    ...
    b();
    ThreadManager.post(new zml(this), 8, null, false);
    new Handler().postDelayed(new zmn(this), 30000L);
  }
