...
class RegisterProxyHandler$CheckTroopMsgComplete
{
  ...
  public CheckTroopMsgComplete a()
  {
    ...
    this.b = this.jdField_a_of_type_ComTencentMobileqqAppHandlerRegisterProxyHandler.jdField_a_of_type_JavaUtilHashMap.size();
    ...
    Iterator localIterator = this.jdField_a_of_type_ComTencentMobileqqAppHandlerRegisterProxyHandler.jdField_a_of_type_JavaUtilHashMap.keySet().iterator();
    int i;
    for (;;)
    {
      ...
      if (((localMessageCache.a(false)) || (((Boolean)this.jdField_a_of_type_ComTencentMobileqqAppHandlerRegisterProxyHandler.jdField_a_of_type_JavaUtilHashMap.get(str)).booleanValue())) && (l2 < l1))
      {
    ...
    if (localArrayList.size() > 0)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppHandlerRegisterProxyHandler.jdField_a_of_type_ArrayOfJavaLangString = new String[this.jdField_a_of_type_Int];
      while (i < this.jdField_a_of_type_Int)
      {
        this.jdField_a_of_type_ComTencentMobileqqAppHandlerRegisterProxyHandler.jdField_a_of_type_ArrayOfJavaLangString[i] = ((String)localArrayList.get(i));
        i += 1;
      }
    }
    this.jdField_a_of_type_ComTencentMobileqqAppHandlerRegisterProxyHandler.jdField_a_of_type_JavaUtilHashMap.clear();
    return this;
  }
