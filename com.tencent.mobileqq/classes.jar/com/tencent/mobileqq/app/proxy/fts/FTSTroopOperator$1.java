...
public class FTSTroopOperator$1
  implements Runnable
{
  public FTSTroopOperator$1(apbd paramapbd) {}
  
  public void run()
  {
    if (!apbd.a(this.this$0))
    {
      apbd.a(this.this$0);
      if (apbd.b(this.this$0) >= 5)
      {
    ...
    apbd.a(this.this$0, localArrayList, localList);
    apbd.a(this.this$0).f();
    ...
    if (i == 0)
    {
      ...
      if (apbd.a(this.this$0) == null) {
        apbd.a(this.this$0, new FTSTroopOperator.1.1(this));
      }
      this.this$0.jdField_a_of_type_Apbc.postDelayed(apbd.a(this.this$0), 86400000L);
    }
    for (;;)
    {
      this.this$0.jdField_a_of_type_Apbc.obtainMessage(1, this.this$0).sendToTarget();
      this.this$0.jdField_a_of_type_Apbc.obtainMessage(1, this.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(4)).sendToTarget();
      return;
      if (i == 1) {
      ...
      if (apbd.a(this.this$0) != null)
      {
        this.this$0.jdField_a_of_type_Apbc.removeCallbacks(apbd.a(this.this$0));
        apbd.a(this.this$0, null);
      }
    }
  }
}
