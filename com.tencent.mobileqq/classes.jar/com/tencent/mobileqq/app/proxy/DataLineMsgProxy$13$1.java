  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      i = j;
      if (aoxv.a(this.jdField_a_of_type_ComTencentMobileqqAppProxyDataLineMsgProxy$13.this$0) != null)
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          if (!aoxv.a(this.jdField_a_of_type_ComTencentMobileqqAppProxyDataLineMsgProxy$13.this$0).insertFrontToList(localDataLineMsgRecord)) {
            break label107;
          }
          i += 1;
        }
