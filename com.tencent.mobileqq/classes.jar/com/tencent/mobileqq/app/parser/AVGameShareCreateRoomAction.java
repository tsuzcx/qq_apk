  ...
  extends JumpActionBase
{
  ...
  public AVGameShareCreateRoomAction(QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
  ...
  public AVGameShareCreateRoomAction(QQAppInterface paramQQAppInterface, Context paramContext)
  {
  ...
  public void a(int paramInt)
  {
    ...
    do
    {
      ...
      try
      {
        localAvGameManager.a(this.jdField_a_of_type_AndroidAppActivity, paramInt, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), Integer.parseInt(str));
        return;
      }
    ...
    return;
    QQToast.a(this.jdField_a_of_type_AndroidAppActivity, 2, 2131690566, 0).a();
  }
