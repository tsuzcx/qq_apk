...
class LightAppOpenAction$1
  implements ArkAppMgr.IGetAppPathByNameCallback
{
  LightAppOpenAction$1(LightAppOpenAction paramLightAppOpenAction, QQProgressDialog paramQQProgressDialog, String paramString1, String paramString2, String paramString3) {}
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (paramInt != 0)
        {
          ...
          if (this.jdField_a_of_type_ComTencentMobileqqAppParserLightAppOpenAction.a != null) {
            ArkFullScreenAppActivity.a(this.jdField_a_of_type_ComTencentMobileqqAppParserLightAppOpenAction.a, this.c, paramAppPathInfo, "0.0.0.1", paramObject, ArkAppCenterUtil.a(), null, 1);
          }
        }
        do
        {
          ...
          } while (this.jdField_a_of_type_ComTencentMobileqqAppParserLightAppOpenAction.a == null);
          this.jdField_a_of_type_ComTencentMobileqqAppParserLightAppOpenAction.a.startActivity(paramObject);
          return;
          QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppParserLightAppOpenAction.a, 2131690208, 0).a();
 ...
 * Qualified Name:     com.tencent.mobileqq.app.parser.LightAppOpenAction.1
