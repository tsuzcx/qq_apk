  ...
  extends BusinessHandler
{
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((paramToServiceMsg != null) && (paramFromServiceMsg != null) && (paramFromServiceMsg.isSuccess()) && (paramObject != null))
    {
      ...
      if (i != 1000)
      {
        ((IPublicAccountObserver.GetUserFollowListRet)localObject).a = -1;
        ((IPublicAccountObserver.GetUserFollowListRet)localObject).c = true;
        return;
      }
    ...
    for (;;)
    {
      try
      {
        ...
        ((IPublicAccountObserver.GetUserFollowListRet)localObject).a = i;
        if (i != 0)
        {
          ((IPublicAccountObserver.GetUserFollowListRet)localObject).c = true;
          bool1 = bool2;
        ...
        else
        {
          ...
          ((IPublicAccountObserver.GetUserFollowListRet)localObject).d = paramFromServiceMsg;
          if ((!paramToServiceMsg.is_over.has()) || (!paramToServiceMsg.is_over.get())) {
            break label641;
          }
          bool1 = true;
          ((IPublicAccountObserver.GetUserFollowListRet)localObject).c = bool1;
          paramObject = (List)((IPublicAccountDataManager)this.b.getRuntimeService(IPublicAccountDataManager.class, "all")).saveEqqAccountInfos(paramFromServiceMsg, l2);
          paramFromServiceMsg = this.b.getProxyManager().g();
          paramObject = paramObject.iterator();
          i = 0;
          if (paramObject.hasNext())
          {
            RecentUser localRecentUser = paramFromServiceMsg.c(((PublicAccountInfo)paramObject.next()).getUin(), 0);
          ...
          if (!((IPublicAccountObserver.GetUserFollowListRet)localObject).c)
          {
      ...
      ((IPublicAccountHandler)this.b.getBusinessHandler(BusinessHandlerFactory.HANDLER_PUBLIC_ACCOUNT)).notifyUI(100, true, localObject);
      return;
      ((IPublicAccountObserver.GetUserFollowListRet)localObject).a = -1;
      ((IPublicAccountObserver.GetUserFollowListRet)localObject).c = true;
      if (QLog.isColorLevel()) {
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    //   8: iconst_2
    //   9: ldc_w 400
    //   12: invokestatic 68	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   15: aload_1
    //   16: ifnull +104 -> 120
    //   19: aload_2
    //   20: ifnonnull +4 -> 24
    //   23: return
    //   24: aload_2
    //   25: invokevirtual 173	com/tencent/qphone/base/remote/FromServiceMsg:getResultCode	()I
    //   28: sipush 1000
    //   31: if_icmpne +89 -> 120
    //   34: iconst_m1
    //   35: istore 4
    ...
    //   56: pop
    //   57: aload_1
    //   58: getfield 405	com/tencent/crmqq/structmsg/StructMsg$SendMenuEventResponse:ret_info	Lcom/tencent/crmqq/structmsg/StructMsg$RetInfo;
    //   61: invokevirtual 365	com/tencent/crmqq/structmsg/StructMsg$RetInfo:has	()Z
    //   64: ifeq +56 -> 120
    //   67: aload_1
    //   68: getfield 405	com/tencent/crmqq/structmsg/StructMsg$SendMenuEventResponse:ret_info	Lcom/tencent/crmqq/structmsg/StructMsg$RetInfo;
    //   71: invokevirtual 366	com/tencent/crmqq/structmsg/StructMsg$RetInfo:get	()Lcom/tencent/mobileqq/pb/MessageMicro;
    //   74: checkcast 364	com/tencent/crmqq/structmsg/StructMsg$RetInfo
    //   77: astore_1
    //   78: aload_1
    //   79: getfield 367	com/tencent/crmqq/structmsg/StructMsg$RetInfo:ret_code	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   82: invokevirtual 214	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   85: ifeq +12 -> 97
    //   88: aload_1
    //   89: getfield 367	com/tencent/crmqq/structmsg/StructMsg$RetInfo:ret_code	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   92: invokevirtual 216	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   95: istore 4
    //   97: iload 4
    //   99: ifeq +21 -> 120
    //   102: aload_1
    //   103: getfield 371	com/tencent/crmqq/structmsg/StructMsg$RetInfo:err_info	Lcom/tencent/mobileqq/pb/PBStringField;
    //   106: invokevirtual 374	com/tencent/mobileqq/pb/PBStringField:has	()Z
    //   109: ifeq +11 -> 120
    //   112: aload_1
    //   113: getfield 371	com/tencent/crmqq/structmsg/StructMsg$RetInfo:err_info	Lcom/tencent/mobileqq/pb/PBStringField;
    //   116: invokevirtual 376	com/tencent/mobileqq/pb/PBStringField:get	()Ljava/lang/String;
    //   119: pop
    //   120: return
    //   121: astore_1
    //   122: return
  ...
  public void a(String paramString, int paramInt1, int paramInt2, int paramInt3, mqq.observer.BusinessObserver paramBusinessObserver)
  {
    ...
    {
      long l = Long.valueOf(paramString).longValue();
      paramString = new NewIntent(this.b.getApplication().getApplicationContext(), ((IPublicAccountServlet)QRoute.api(IPublicAccountServlet.class)).getServletClass());
