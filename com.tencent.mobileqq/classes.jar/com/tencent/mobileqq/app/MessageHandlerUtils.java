...
public class MessageHandlerUtils
{
  ...
  {
    return TinyMsgCodec.a(a(paramQQAppInterface, paramLong1, paramLong2, paramLong3), paramUinPairMsg, paramQQAppInterface);
  }
  ...
  public static String a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    if ((str != null) && (str.equals(paramString1))) {
      return HardCodeUtil.a(2131706635);
    }
    paramString2 = ContactUtils.a(paramQQAppInterface, paramString1, paramString2, 1, 0);
    if (paramString2 == paramString1)
    {
      paramQQAppInterface = ((FriendsManager)paramQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER)).e(paramString1);
  ...
  {
    Object localObject2 = new MessageHandlerUtils.GetRichTextAndMsgVia(paramQQAppInterface, paramMessageRecord, null, 0).a();
    Object localObject1 = ((MessageHandlerUtils.GetRichTextAndMsgVia)localObject2).a();
    int i = ((MessageHandlerUtils.GetRichTextAndMsgVia)localObject2).a();
    ...
    a(paramQQAppInterface, paramMessageRecord, (FriendsManager)paramQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER));
  ...
  public static msg_svc.PbSendMsgReq a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, ArrayList<String> paramArrayList, ChatActivityFacade.HongbaoParams paramHongbaoParams)
  {
    boolean bool4 = true;
    Object localObject1;
    int i;
    ...
    for (;;)
    {
      ...
      a(paramHongbaoParams, (msg_svc.MultiMsgAssist)localObject1);
      ...
      paramHongbaoParams = new msg_svc.PbSendMsgReq();
      paramHongbaoParams.msg_body.set((MessageMicro)localObject2);
      paramHongbaoParams.msg_seq.set(k & 0xFFFF);
      paramHongbaoParams.msg_rand.set(j);
      paramHongbaoParams.msg_via.set(i);
      paramHongbaoParams.multi_msg_assist.set((MessageMicro)localObject1);
      if (paramArrayList != null) {
        paramHongbaoParams.sync_cookie.set(ByteStringMicro.copyFrom(paramArrayList));
      }
      paramArrayList = paramHongbaoParams;
      if (paramHongbaoParams == null) {
        break;
      }
      a(paramQQAppInterface, paramMessageRecord, paramHongbaoParams);
      return paramHongbaoParams;
  ...
  private static im_msg_body.GeneralFlags a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, msg_svc.PbSendMsgReq paramPbSendMsgReq)
  {
    ...
    boolean bool2 = a(false, localResvAttr, paramMessageRecord.getExtInfoFromExtStr(MessageConstants.jdField_c_of_type_JavaLangString));
    ...
    boolean bool4;
    int i;
    if (((paramMessageRecord instanceof MessageForFoldMsg)) && (PasswdRedBagManager.a(paramQQAppInterface)))
    {
      bool3 = PasswdRedBagManager.b(paramQQAppInterface);
      localObject = (PasswdRedBagManager)paramQQAppInterface.getManager(QQManagerFactory.PASSWD_RED_BAG_MANAGER);
      MessageForFoldMsg localMessageForFoldMsg = (MessageForFoldMsg)paramMessageRecord;
      if ((localMessageForFoldMsg.redBagId != null) && (PasswdRedBagManager.b(paramQQAppInterface))) {
        if ((bool3) && (!((PasswdRedBagManager)localObject).e))
        {
          bool1 = true;
    ...
    for (;;)
    {
      bool2 = g(paramMessageRecord, bool3, localResvAttr);
      bool1 = a(paramMessageRecord, bool4, localGeneralFlags);
      localObject = ((FriendsManager)paramQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER)).a(paramQQAppInterface.getCurrentUin());
      if (localObject != null)
      {
        localGeneralFlags.uint64_pendant_id.set(((ExtensionInfo)localObject).pendantId);
        bool1 = true;
        localResvAttr.uint32_mobile_custom_font.set(FontManager.a((ExtensionInfo)localObject));
      ...
      for (;;)
      {
        for (;;)
        {
          bool2 = d(paramMessageRecord, bool2, localResvAttr);
          ...
          try
          {
            ...
            bool2 = f(paramMessageRecord, a(paramQQAppInterface, paramMessageRecord, b(paramMessageRecord, c(paramMessageRecord, a(paramQQAppInterface, paramMessageRecord, paramPbSendMsgReq, bool2, localResvAttr), localResvAttr), localResvAttr), localResvAttr), localResvAttr);
            a(paramMessageRecord, localResvAttr);
            c(paramMessageRecord, localResvAttr);
            b(paramMessageRecord, localResvAttr);
            if (a(paramMessageRecord, e(paramMessageRecord, bool2, localResvAttr), localResvAttr))
            {
              bool1 = true;
  ...
  private static void a(ChatActivityFacade.HongbaoParams paramHongbaoParams, msg_svc.MultiMsgAssist paramMultiMsgAssist)
  {
    if (paramHongbaoParams != null)
    {
      if (QLog.isColorLevel()) {
      ...
      paramMultiMsgAssist.uint64_temp_id.set(paramHongbaoParams.jdField_a_of_type_Long);
      paramMultiMsgAssist.uint64_vedio_len.set(paramHongbaoParams.jdField_b_of_type_Long);
      paramMultiMsgAssist.uint32_has_readbag.set(paramHongbaoParams.jdField_a_of_type_Int);
      if (paramHongbaoParams.jdField_a_of_type_Int == 1)
      {
        if (paramHongbaoParams.jdField_a_of_type_ArrayOfByte != null) {
          paramMultiMsgAssist.bytes_redbag_id.set(ByteStringMicro.copyFrom(paramHongbaoParams.jdField_a_of_type_ArrayOfByte));
        }
        paramMultiMsgAssist.uint64_redbag_amount.set(paramHongbaoParams.c);
      }
      paramMultiMsgAssist.uint32_has_vedio.set(paramHongbaoParams.jdField_b_of_type_Int);
    }
  }
  
  private static void a(QQAppInterface paramQQAppInterface, FriendsManager paramFriendsManager, im_msg_body.PubGroup paramPubGroup)
  {
    for (;;)
    {
      try
      {
        String str = (String)NearbySPUtil.a(paramQQAppInterface.getCurrentAccountUin(), "self_nick", String.valueOf(""));
        int j = ((Integer)NearbySPUtil.a(paramQQAppInterface.getCurrentAccountUin(), "self_gender", Integer.valueOf(-1))).intValue();
        int i = ((Integer)NearbySPUtil.a(paramQQAppInterface.getCurrentAccountUin(), "self_age", Integer.valueOf(-1))).intValue();
        if ((i < 0) || (j < 0))
        {
  ...
  private static void a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, FriendsManager paramFriendsManager)
  {
    if (paramFriendsManager.a)
    {
      if (QLog.isColorLevel()) {
        QLog.d("KplMessage", 2, "get kpl global flag");
      }
      paramMessageRecord.saveExtInfoToExtStr("msg_ext_key", "Y");
      paramFriendsManager = paramMessageRecord.frienduin;
      int i = paramMessageRecord.istroop;
      long l = paramMessageRecord.uniseq;
      paramQQAppInterface.getMessageFacade().a(paramFriendsManager, i, l, "extStr", paramMessageRecord.extStr);
      paramQQAppInterface.getMessageFacade().a(paramFriendsManager, i, l, "extLong", Integer.valueOf(paramMessageRecord.extLong));
    }
  }
  ...
  protected static void a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, msg_svc.PbSendMsgReq paramPbSendMsgReq)
  {
    ...
    Object localObject = (SVIPHandler)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.SVIP_HANDLER);
    int j = ((SVIPHandler)localObject).d();
    paramQQAppInterface = (BubbleManager)paramQQAppInterface.getManager(QQManagerFactory.CHAT_BUBBLE_MANAGER);
    int k = ((SVIPHandler)localObject).b();
    boolean bool1;
    if (k > 0)
    {
    ...
    for (;;)
    {
      ...
      if ((paramPbSendMsgReq.msg_body.has()) && (((im_msg_body.MsgBody)paramPbSendMsgReq.msg_body.get()).rich_text.has()))
      {
        ...
        if ((paramQQAppInterface.elems != null) && (paramQQAppInterface.elems.has()))
        {
          ...
          if (!h(paramMessageRecord, false, (generalflags.ResvAttr)localObject)) {
            break label356;
          }
  ...
  private static void a(MessageRecord paramMessageRecord, msg_svc.PbSendMsgReq paramPbSendMsgReq, QQAppInterface paramQQAppInterface)
  {
    ...
    while (localIterator.hasNext()) {
      ((CreatePbSendReqFromMessageCallback)localIterator.next()).a(paramMessageRecord, paramPbSendMsgReq, paramQQAppInterface);
    }
  }
  ...
  {
    paramQQAppInterface = (RoutingType)paramQQAppInterface.getMessageFacade().a().a().a(Integer.valueOf(paramInt));
  ...
  {
    paramQQAppInterface = paramQQAppInterface.getMessageFacade().b(paramString1, paramInt);
    if (QLog.isColorLevel())
    {
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      paramQQAppInterface = paramQQAppInterface.getMessageFacade().b(paramMessageRecord.frienduin, paramMessageRecord.istroop);
      int j;
      int i;
      if (paramQQAppInterface == null)
      {
  ...
  {
    List localList = paramQQAppInterface.getMessageFacade().b(paramMessageRecord.frienduin, paramMessageRecord.istroop);
  ...
  private static boolean a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, boolean paramBoolean, long paramLong, StringBuilder paramStringBuilder, List<MessageRecord> paramList)
  {
    ...
    return paramQQAppInterface.getMsgCache().d(paramMessageRecord);
  }
  ...
  private static void b(MessageRecord paramMessageRecord, generalflags.ResvAttr paramResvAttr)
  {
    if ((paramMessageRecord instanceof MessageForPtt))
    {
      ...
      if (paramMessageRecord.waveformArray != null) {
        paramResvAttr.bytes_pb_ptt_waveform.set(ByteStringMicro.copyFrom(PttUtils.a(paramMessageRecord.waveformArray).toByteArray()));
      }
    }
  }
  ...
  private static boolean h(MessageRecord paramMessageRecord, boolean paramBoolean, generalflags.ResvAttr paramResvAttr)
  {
    boolean bool = paramBoolean;
    if ((paramMessageRecord instanceof MessageForShortVideo))
    {
