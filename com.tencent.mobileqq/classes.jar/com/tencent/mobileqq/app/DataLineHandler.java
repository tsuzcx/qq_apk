  ...
  implements LiteTransferListenerCallback, LiteTransferOperatorCallback
{
  ...
  private MessageObserver jdField_a_of_type_ComTencentMobileqqAppMessageObserver = new yzk(this);
  ...
  DataLineHandler(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new yyv(this);
    this.jdField_b_of_type_AndroidContentBroadcastReceiver = new yzd(this, paramQQAppInterface);
    this.jdField_a_of_type_ComTencentMobileqqMsfSdkHandlerINetInfoHandler = new yze(this);
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (int i = 2;; i = 36)
    {
      ...
      new Handler(Looper.getMainLooper()).post(new yzj(this, l, i));
      return;
    }
  }
    ...
    if (localObject == null)
    {
      ...
      if (localDataLineMsgRecord == null)
      {
        if (Thread.currentThread() != ((Looper)localObject).getThread()) {
          new Handler((Looper)localObject).post(new yza(this, paramLong, paramInt1, paramInt2));
        }
        return;
      }
      if (paramInt1 == 2) {
      ...
      if (Thread.currentThread() != ((Looper)localObject).getThread())
      {
        new Handler((Looper)localObject).post(new yzb(this, paramLong, paramInt1));
        return;
      }
  ...
  public void OnSessionNew(Session paramSession, NFCInfo paramNFCInfo, FTNInfo paramFTNInfo)
  {
    if (paramSession.bSend)
    {
      ...
      new Handler(localLooper).post(new yyx(this, paramSession, paramNFCInfo, paramFTNInfo));
    }
    for (;;)
    {
      a(paramSession);
  ...
  public void OnSessionProgress(long paramLong1, long paramLong2, long paramLong3)
  {
    ...
    if (localObject == null)
    {
      ...
      if (Thread.currentThread() != ((Looper)localObject).getThread())
      {
        new Handler((Looper)localObject).post(new yyz(this, paramLong1, paramLong2, paramLong3));
        return;
      }
  ...
  public void OnSessionStart(long paramLong)
  {
    ...
    if (localObject == null)
    {
      ...
      if (Thread.currentThread() != ((Looper)localObject).getThread())
      {
        new Handler((Looper)localObject).post(new yyy(this, paramLong));
        return;
      }
  ...
  public void OnSessionUpdate(int paramInt, long paramLong, String paramString)
  {
    ...
    if (Thread.currentThread() != localLooper.getThread())
    {
      new Handler(localLooper).post(new yzc(this, paramInt, paramLong, paramString));
      return;
    }
  ...
  {
    new Handler(Looper.getMainLooper()).post(new yzh(this, paramToServiceMsg, paramFromServiceMsg, paramInt));
  }
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (Thread.currentThread() != localLooper.getThread())
    {
      new Handler(localLooper).post(new yzg(this, paramToServiceMsg, paramFromServiceMsg, paramObject));
      return;
    }
  ...
  public void a(msg_comm.Msg paramMsg, C2CType0x211_SubC2CType0x9.MsgBody paramMsgBody)
  {
    ...
    if (Thread.currentThread() != localLooper.getThread())
    {
      new MqqHandler(localLooper).post(new yyw(this, this, paramMsg, paramMsgBody));
      return;
    }
  ...
  public void b(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_JavaUtilTimer.schedule(new yzf(this), 20000L);
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, int paramInt)
  {
    ...
    new Handler(Looper.getMainLooper()).post(new yzi(this, paramFromServiceMsg, paramInt, l));
  }
