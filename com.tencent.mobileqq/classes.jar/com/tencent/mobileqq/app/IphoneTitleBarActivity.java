  ...
  extends FragmentActivity
{
  ...
  protected View.OnClickListener onBackListeger = new zcp(this);
  @Deprecated
  ...
  {
    this.rightViewText = ((TextView)findViewById(2131363410));
  ...
  {
    return findViewById(2131363226);
  }
  ...
  public void init(Intent paramIntent)
  {
    ...
    {
      this.vg = ((ViewGroup)findViewById(2131363226));
      onCreateLeftView();
    }
    try
    {
  ...
  protected View onCreateLeftView()
  {
    ...
    this.mLeftBackText = ((TextView)findViewById(2131363971));
    this.mLeftBackIcon = ((ImageView)findViewById(2131363970));
  ...
  public void setContentView(int paramInt)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        this.titleRoot = ((RelativeLayout)((View)localObject1).findViewById(2131363995));
  ...
  public void setContentView(View paramView)
  {
    ...
    for (;;)
    {
      ...
      init(getIntent());
      return;
      this.titleRoot = ((RelativeLayout)LayoutInflater.from(this).inflate(2130968837, null).findViewById(2131363995));
      if (ImmersiveUtils.isSupporImmersive() == 1)
      {
        this.titleRoot.setFitsSystemWindows(true);
        this.titleRoot.setPadding(0, ImmersiveUtils.a(this), 0, 0);
  ...
  public void setContentViewNoTitle(int paramInt)
  {
    ...
    try
    {
      this.mTitleContainer = ((View)findViewById(2131364068).getParent());
      this.mTitleContainer.setVisibility(8);
      return;
    }
    catch (Throwable localThrowable) {}
  ...
  public void setLeftViewName(int paramInt)
  {
    if ((this.leftView != null) && ((this.leftView instanceof TextView)))
    {
      ...
      if (AppSetting.b)
      {
        ...
        str1 = str2;
        if (!str2.contains(getString(2131433681))) {
          str1 = getString(2131433681) + str2;
        }
  ...
  public void showContentViewTitle(boolean paramBoolean)
  {
    try
    {
      View localView = (View)findViewById(2131363226).getParent();
      if (paramBoolean) {}
      for (int i = 0;; i = 8)
      {
  ...
  public boolean startTitleProgress()
  {
    ...
    {
      localObject1 = (RelativeLayout)findViewById(2131363362);
    ...
    for (Object localObject2 = localObject1;; localObject2 = null)
    {
      if ((this.mUseOptimizMode) && (this.mLoadingParent != null))
      {
        ...
        if (this.mLoadingView == null)
        {
          ...
          this.mLoadingView.setId(2131365681);
      ...
      if (this.ad == null)
      {
        this.ad = getResources().getDrawable(2130838594);
