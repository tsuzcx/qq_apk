  ...
  extends FragmentActivity
{
  ...
  protected View.OnClickListener onBackListeger = new aoas(this);
  @Deprecated
  ...
  {
    this.rightViewText = ((TextView)findViewById(2131369073));
  ...
  {
    return findViewById(2131376731);
  }
  ...
  {
    ((FrameLayout)findViewById(16908290)).setForeground(getResources().getDrawable(2130850105));
    if (this.leftView == null)
    {
      this.vg = ((ViewGroup)findViewById(2131376731));
      onCreateLeftView();
    }
    try
    {
  ...
  protected View onCreateLeftView()
  {
    ...
    this.mLeftBackText = ((TextView)findViewById(2131379635));
    this.mLeftBackIcon = ((ImageView)findViewById(2131369452));
  ...
  public void setContentView(int paramInt)
  {
    ...
    do
    {
      ...
      Object localObject1 = ((LayoutInflater)localObject2).inflate(2131558978, null);
      try
      {
        localObject2 = ((LayoutInflater)localObject2).inflate(paramInt, (ViewGroup)localObject1, false);
        this.titleRoot = ((RelativeLayout)((View)localObject1).findViewById(2131379050));
        ...
        ((RelativeLayout.LayoutParams)localObject1).addRule(3, 2131376731);
  ...
  public void setContentView(View paramView)
  {
    ...
    for (;;)
    {
      ...
      init(getIntent());
      return;
      this.titleRoot = ((RelativeLayout)LayoutInflater.from(this).inflate(2131558978, null).findViewById(2131379050));
      if (ImmersiveUtils.isSupporImmersive() == 1)
      {
        this.titleRoot.setFitsSystemWindows(true);
        this.titleRoot.setPadding(0, ImmersiveUtils.getStatusBarHeight(this), 0, 0);
  ...
  {
    BounceScrollView localBounceScrollView = (BounceScrollView)View.inflate(this, 2131558746, null);
  ...
  public void setContentViewNoTitle(int paramInt)
  {
    ...
    try
    {
      this.mTitleContainer = ((View)findViewById(2131366714).getParent());
      this.mTitleContainer.setVisibility(8);
      return;
    }
    catch (Throwable localThrowable) {}
  ...
  public void setLeftViewName(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (AppSetting.c)
      {
        ...
        if (!((String)localObject1).contains(getString(2131690559))) {
          localObject2 = getString(2131690559) + (String)localObject1;
        }
      ...
      try
      {
        ...
        if (i >= 40300)
        {
          ...
          if (i <= 40313)
          {
            ...
            {
              paramIntent = (Intent)localObject;
              if (((String)localObject).contains(anzj.a(2131704731))) {
                paramIntent = getString(2131690559);
              }
            }
          }
        }
        ...
        for (;;)
        {
          ...
          paramIntent = (Intent)localObject;
          if (!((String)localObject).contains(getString(2131690559))) {
            paramIntent = getString(2131690559) + (String)localObject;
          }
  ...
  public void setRightButton(int paramInt, View.OnClickListener paramOnClickListener)
  {
    ...
    if (AppSetting.c) {
      this.rightViewText.setContentDescription(this.rightViewText.getText() + anzj.a(2131704732));
    }
  }
  ...
  public void showContentViewTitle(boolean paramBoolean)
  {
    try
    {
      View localView = (View)findViewById(2131376731).getParent();
      if (paramBoolean) {}
      for (int i = 0;; i = 8)
      {
  ...
  public boolean startTitleProgress()
  {
    ...
    {
      localObject1 = (RelativeLayout)findViewById(2131378993);
    ...
    for (Object localObject2 = localObject1;; localObject2 = null)
    {
      ...
      if (this.ad == null)
      {
        this.ad = getResources().getDrawable(2130839412);
