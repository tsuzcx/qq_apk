  ...
  extends CustomEmoRoamingBaseHandler<CustomEmotionData>
{
  ...
  private void a(int paramInt, List<FavEmotionOcr.OcrInfo> paramList, FavroamingDBManager paramFavroamingDBManager, List<CustomEmotionData> paramList1)
  {
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      while (j < paramList.size())
      {
        ...
        localObject = paramFavroamingDBManager.a(paramList1, str);
        int i = k;
        if (localObject != null)
        {
          i = m;
          ...
          if (m != 0)
          {
            paramFavroamingDBManager.b((CustomEmotionBase)localObject);
            i = 1;
          }
        }
        j += 1;
  ...
  public void a()
  {
    ...
    localPlatInfo.mqqver.set("8.5.5");
  ...
  public void a(CustomEmotionData paramCustomEmotionData, String paramString)
  {
    ...
    if ((this.a == null) || (this.a.getApp() == null))
    {
      ...
      notifyUI(3, false, this.a.getApplication().getString(2131692017));
      return;
    }
    if (!NetworkUtil.a())
    {
      notifyUI(3, false, this.a.getApp().getString(2131693806));
      return;
    }
    try
    {
      ...
      ((FavEmotionOcr.ReqBody)localObject1).string_version.set("8.5.5");
      ...
      try
      {
        ...
        if ((i != 0) && (paramObject.bytes_bodybuffer.has()) && (paramObject.bytes_bodybuffer.get() != null))
        {
          ...
          if (i < paramFromServiceMsg.size())
          {
            ...
            {
              paramObject = ((FavroamingDBManager)this.a.getManager(QQManagerFactory.FAVROAMING_DB_MANAGER)).a();
              if (paramObject != null)
              {
            ...
            {
              notifyUI(3, false, this.a.getApplication().getString(2131692023));
              if (QLog.isColorLevel()) {
      ...
      try
      {
        ...
        if (i != 0)
        {
          ...
          if (paramFromServiceMsg.list_ocr_info.has())
          {
            ...
            paramObject = (FavroamingDBManager)this.a.getManager(QQManagerFactory.FAVROAMING_DB_MANAGER);
  ...
  public void a(Object paramObject, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      ((FavroamingDBManager)this.a.getManager(QQManagerFactory.FAVROAMING_DB_MANAGER)).c(localArrayList);
      super.notifyUI(0, true, Boolean.valueOf(paramBoolean));
      EmoticonManager.d("0", 1);
      b(localArrayList);
      return;
      i += 1;
    }
  ...
  public void a(List<CustomEmotionData> paramList, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localReqBody.string_version.set("8.5.5");
  ...
  public void b(List<String> paramList)
  {
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      if (localArrayList.size() > 0) {
        ((VipComicMqqManager)this.a.getManager(QQManagerFactory.MQQ_COMIC_MANAGER)).a(localArrayList);
      }
    }
  }
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((paramObject == null) || (paramFromServiceMsg == null) || (!paramFromServiceMsg.isSuccess()))
    {
      ...
      if (i == 1)
      {
        paramToServiceMsg = (FavroamingManager)this.a.getManager(QQManagerFactory.FAV_ROAMING_MANAGER);
