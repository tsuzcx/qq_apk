  ...
  implements BusinessObserver
{
  ...
  public Activity a;
  private Handler jdField_a_of_type_AndroidOsHandler = new zjw(this, Looper.getMainLooper());
  ...
  private Handler jdField_b_of_type_AndroidOsHandler = new zjx(this, Looper.getMainLooper());
  ...
  public StartAppCheckHandler(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_JavaLangRunnable = new zjy(this);
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      ...
      this.jdField_a_of_type_Zjz.jdField_b_of_type_Long = Long.valueOf(l).longValue();
      if (((signature.SignatureResult)localObject2).u32_timeout.has()) {
        this.jdField_a_of_type_Zjz.jdField_a_of_type_Long = ((signature.SignatureResult)localObject2).u32_timeout.get();
      }
      if (((signature.SignatureResult)localObject2).u32_check_result.has()) {
        this.jdField_a_of_type_Zjz.jdField_a_of_type_Int = ((signature.SignatureResult)localObject2).u32_check_result.get();
      }
      if (((signature.SignatureResult)localObject2).str_title.has()) {
        this.jdField_a_of_type_Zjz.jdField_c_of_type_JavaLangString = ((signature.SignatureResult)localObject2).str_title.get();
      }
      if (((signature.SignatureResult)localObject2).str_content.has()) {
        this.jdField_a_of_type_Zjz.d = ((signature.SignatureResult)localObject2).str_content.get();
      }
      if (((signature.SignatureResult)localObject2).str_left_button.has()) {
        this.jdField_a_of_type_Zjz.e = ((signature.SignatureResult)localObject2).str_left_button.get();
      }
      if (((signature.SignatureResult)localObject2).str_right_button.has()) {
        this.jdField_a_of_type_Zjz.f = ((signature.SignatureResult)localObject2).str_right_button.get();
      }
      if (((signature.SignatureResult)localObject2).str_url.has()) {
        this.jdField_a_of_type_Zjz.g = ((signature.SignatureResult)localObject2).str_url.get();
      }
      this.jdField_a_of_type_Zjz.b();
      this.jdField_a_of_type_Zjz = null;
    ...
    for (;;)
    {
      ...
      {
        localObject1 = (zka)paramArrayOfByte.next();
      ...
      {
        localObject3 = (zka)((Iterator)localObject2).next();
        if (((zka)localObject3).jdField_a_of_type_JavaLangString.equals(paramArrayOfByte))
        {
      ...
      {
        localObject4 = (zka)((Iterator)localObject3).next();
        if (((zka)localObject4).jdField_a_of_type_JavaLangString.equals(paramArrayOfByte))
        {
  ...
  public void b(String paramString, Context paramContext, Intent paramIntent)
  {
    ...
    this.jdField_a_of_type_Zkb = new zkb(this, paramString);
    this.jdField_a_of_type_Zjz = new zjz(this, paramString);
    long l;
    if (Long.valueOf(System.currentTimeMillis()).longValue() < this.jdField_a_of_type_Zjz.jdField_b_of_type_Long + 86400000L)
    {
      PackageInfo localPackageInfo = a(this.jdField_b_of_type_ComTencentCommonAppAppInterface.getApplication(), this.jdField_a_of_type_Zkb.jdField_a_of_type_JavaLangString);
      if (localPackageInfo != null)
      {
        ...
        if ((this.jdField_a_of_type_Zjz.jdField_c_of_type_Long == l) && (this.jdField_a_of_type_Zjz.jdField_a_of_type_JavaLangString.equalsIgnoreCase(str)))
        {
          if (this.jdField_a_of_type_Zjz.jdField_a_of_type_Int != 2)
          {
            paramContext.startActivity(paramIntent);
            return;
          }
          ...
          paramContext.putString("dlg_title", this.jdField_a_of_type_Zjz.jdField_c_of_type_JavaLangString);
          paramContext.putString("dlg_content", this.jdField_a_of_type_Zjz.d);
          paramContext.putString("dlg_lbutton", this.jdField_a_of_type_Zjz.e);
          paramContext.putString("dlg_rbutton", this.jdField_a_of_type_Zjz.f);
          paramContext.putString("dlg_url", this.jdField_a_of_type_Zjz.g);
          ...
          try
          {
            ReportController.b(null, "P_CliOper", "Safe_StartAppCheck", this.jdField_b_of_type_ComTencentCommonAppAppInterface.getAccount(), "startAppByCheckValid", this.jdField_a_of_type_Zjz.jdField_b_of_type_JavaLangString, 0, 0, "", "", "", "");
            return;
          }
    ...
    for (;;)
    {
      try
      {
        this.jdField_a_of_type_Zkb.jdField_a_of_type_Long = Long.valueOf(this.jdField_b_of_type_ComTencentCommonAppAppInterface.getAccount()).longValue();
        this.jdField_a_of_type_Zkb.jdField_a_of_type_Int = 1;
        this.jdField_a_of_type_Zkb.jdField_a_of_type_JavaLangString = paramString;
        paramString = new zka(this, paramString, paramContext, paramIntent);
        ...
        if (this.jdField_a_of_type_Zjz.jdField_a_of_type_Long <= 0L) {
          break label581;
        }
        l = this.jdField_a_of_type_Zjz.jdField_a_of_type_Long;
