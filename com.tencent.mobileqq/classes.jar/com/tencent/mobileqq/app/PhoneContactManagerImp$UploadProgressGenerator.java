  ...
  implements Runnable
{
  ...
  private PhoneContactManagerImp$UploadProgressGenerator(PhoneContactManagerImp paramPhoneContactManagerImp) {}
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("PhoneContact.Manager", 2, "run progress, isCanceled = " + this.jdField_a_of_type_Boolean + ", bindState = " + this.this$0.jdField_a_of_type_Int);
    }
    Object localObject;
    if ((!this.jdField_a_of_type_Boolean) && ((this.this$0.jdField_a_of_type_Int == 8) || (this.this$0.jdField_a_of_type_Int == 4)) && (this.jdField_a_of_type_Int + 1 < this.c))
    {
      ...
      {
        PhoneContactManagerImp.a(this.this$0, 7);
 ...
 * Qualified Name:     com.tencent.mobileqq.app.PhoneContactManagerImp.UploadProgressGenerator
