  ...
  implements IFriendObserver
{
  ...
  static int[] NOTIFY_TYPES_1 = { 120, 122, 123, 124, 125, 126, 127, 128, 131 };
  static int[] NOTIFY_TYPES_2 = { 111, 121, 68, 116, 56, 96, 97, 98, 129, 130, 100 };
  static int[] NOTIFY_TYPES_3 = { 51, 61, 62, 52, 49, 73, 27, 65, 64 };
  static int[] NOTIFY_TYPES_4 = { 103, 104, 105, 106, 109, 110, 112, 113, 114 };
  static int[] NOTIFY_TYPES_5 = { 86, 92, 108, 107, 93, 95, 115, 117, 94, 101, 99 };
  static int[] NOTIFY_TYPES_6 = { 48, 76, 77, 74, 75, 78, 89, 79, 81, 82, 83, 84, 80, 90, 91, 85, 119 };
  static int[] NOTIFY_TYPES_7 = { 50, 58, 59, 60, 69, 70, 63, 66, 18, 19, 21, 22, 71, 72 };
  static int[] NOTIFY_TYPES_8 = { 12, 13, 14, 15, 28, 33, 35, 37, 102, 38, 41, 42, 43, 44, 47 };
  static int[] NOTIFY_TYPES_9 = { 1, 2, 46, 53, 3, 67, 7, 8, 9, 10, 11 };
  ...
  private void onUpdateBatch9(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    onUpdateAddFriend(paramBoolean, bool1, bool2, (String)localObject, paramObject);
  }
