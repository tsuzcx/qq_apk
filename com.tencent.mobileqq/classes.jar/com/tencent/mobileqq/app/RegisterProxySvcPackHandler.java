  ...
  extends BusinessHandler
{
  ...
  public void d(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getSharedPreferences("vip_message_roam_banner_file", 0).edit().putInt("message_roam_is_set_password" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), i).commit();
        return;
        if (paramLong != 2L) {
          i = -1;
        }
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
            ...
            if (paramFromServiceMsg.getServiceCmd().equals("RegPrxySvc.PushParam"))
            {
              if (paramObject != null)
              {
                ...
                if (paramObject.clientType == 9)
                {
                  ...
                  if (!((LoginDevicesManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.LOGIN_DEVICES_MANAGER)).a(localSvcRespParam)) {
                    break label535;
                  }
                }
                for (i = 1;; i = 0)
    ...
    for (;;)
    {
      try
      {
        ...
        if ((!paramToServiceMsg.uint64_uin.has()) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getLongAccountUin() != paramToServiceMsg.uint64_uin.get()) || (!paramToServiceMsg.msg_instances.has())) {
          break;
        }
      ...
      for (;;)
      {
        try
        {
          ...
          {
            bool = true;
            SettingCloneUtil.writeValue(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin(), null, "qqsetting_qrlogin_set_mute", bool);
            if (!QLog.isColorLevel()) {
              break;
            }
