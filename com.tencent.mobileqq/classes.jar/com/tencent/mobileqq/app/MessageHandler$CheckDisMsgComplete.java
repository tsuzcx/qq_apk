...
class MessageHandler$CheckDisMsgComplete
{
  private int jdField_a_of_type_Int;
  private StringBuilder jdField_a_of_type_JavaLangStringBuilder;
  private int b;
  
  public MessageHandler$CheckDisMsgComplete(MessageHandler paramMessageHandler, StringBuilder paramStringBuilder, int paramInt)
  {
  ...
  public CheckDisMsgComplete a()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      long l2 = this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.jdField_a_of_type_ComTencentMobileqqServiceMessageMessageCache.i(str);
      Object[] arrayOfObject = this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.jdField_a_of_type_ComTencentMobileqqServiceMessageMessageCache.a(str);
      if ((arrayOfObject != null) && (arrayOfObject.length > 0)) {}
      for (long l1 = ((Long)arrayOfObject[1]).longValue();; l1 = 0L)
      {
        if (((!this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().a(false)) && (!((Boolean)MessageHandler.b(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler).get(str)).booleanValue())) || (l2 >= l1)) {
          break label232;
        }
 ...
 * Qualified Name:     com.tencent.mobileqq.app.MessageHandler.CheckDisMsgComplete
