  ...
  implements Handler.Callback
{
  ...
  private void k(byte[] paramArrayOfByte)
  {
    ...
    if ((j == 1) && (i == 2))
    {
      new GroupVideoWrapper(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(new zil(this, paramArrayOfByte));
      return;
    }
    new QavWrapper((Context)localObject).a(new zim(this, paramArrayOfByte));
  }
  ...
  public void a(byte[] paramArrayOfByte, msg_comm.Msg paramMsg)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      jdField_a_of_type_JavaUtilArrayList.add(new zin(paramMsg, Long.valueOf(paramArrayOfByte).longValue(), l2));
  ...
  public void b(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    if (paramInt != 0)
    {
      if ((jdField_a_of_type_JavaUtilArrayList != null) && (!jdField_a_of_type_JavaUtilArrayList.isEmpty()))
      {
        ...
        {
          paramArrayOfByte = (zin)jdField_a_of_type_JavaUtilArrayList.get(paramInt);
    ...
    do
    {
      do
      {
        do
        {
          ...
          while (paramInt < jdField_a_of_type_JavaUtilArrayList.size())
          {
            localObject = (zin)jdField_a_of_type_JavaUtilArrayList.get(paramInt);
            if ((localObject != null) && (((zin)localObject).jdField_a_of_type_Long == l1) && (((zin)localObject).jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.compareAndSet(false, true))) {
              paramArrayOfByte.add(localObject);
            }
            paramInt += 1;
          }
          Collections.sort(paramArrayOfByte, new zio());
          paramInt = 0;
          while (paramInt < paramArrayOfByte.size() - 1)
          {
            if (QLog.isColorLevel()) {
              QLog.d("QQGAudioMsgHandler", 2, "onRecvMultiVideoC2SACK_0x31-retCode->list =" + ((zin)paramArrayOfByte.get(paramInt)).b);
            }
            localObject = (zin)paramArrayOfByte.get(paramInt);
            arrayOfByte1 = new byte[8];
            arrayOfByte2 = ((im_msg_body.MsgBody)((zin)localObject).jdField_a_of_type_MsfMsgcommMsg_comm$Msg.msg_body.get()).msg_content.get().toByteArray();
            System.arraycopy(arrayOfByte2, (arrayOfByte2[10] & 0xFF) + 19, arrayOfByte1, 0, 8);
            l2 = VideoPackageUtils.a(arrayOfByte1, 8);
            VideoMsgTools.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0, 6, true, Long.toString(l1), Long.toString(l2), false, null, false, new Object[] { ((zin)localObject).jdField_a_of_type_MsfMsgcommMsg_comm$Msg });
            paramInt += 1;
          }
        } while (paramArrayOfByte.size() <= 0);
        paramArrayOfByte = ((im_msg_body.MsgBody)((zin)paramArrayOfByte.get(paramArrayOfByte.size() - 1)).jdField_a_of_type_MsfMsgcommMsg_comm$Msg.msg_body.get()).msg_content.get().toByteArray();
      } while (this.jdField_a_of_type_ArrayOfByte == null);
    ...
    do
    {
      ...
      if (n > 0)
      {
        ...
        for (;;)
        {
          ...
          GVideoGrayConfig.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1), new zif(this, l1, i));
          j += 1;
        }
      }
  ...
  void f(byte[] paramArrayOfByte)
  {
    ...
    while ((j == 1) && (i == 2))
    {
      new GroupVideoWrapper(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(new zig(this));
      return;
      if ((j == 1) && (i == 10))
      {
        localObject = new byte[4];
    ...
    new QavWrapper(BaseApplication.getContext()).a(new zih(this));
  }
  ...
  void g(byte[] paramArrayOfByte)
  {
    ...
    GVideoGrayConfig.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l2), new zii(this, l2, j, l1));
  }
