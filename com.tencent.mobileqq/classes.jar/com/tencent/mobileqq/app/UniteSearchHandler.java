  ...
  extends BusinessHandler
{
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilHashMap != null)
    {
      ...
      {
        localObject1 = (UniteSearchHandler.RequestSearchWordCallback)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramToServiceMsg.extraData.getLong("time_stamp")));
    ...
    try
    {
      ...
      ((UniteSearchHandler.RequestSearchWordCallback)localObject1).a(paramToServiceMsg.msg_search_keywords.rcmds, paramToServiceMsg.msg_search_keywords.sessionid);
      return;
    }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    String str3 = DatalineMathUtil.a(DatalineMathUtil.a());
    ...
    paramQQAppInterface.sversion.set(a("8.5.5"));
  ...
  public void a(ByteStringMicro paramByteStringMicro, UniteSearchHandler.RequestSearchWordCallback paramRequestSearchWordCallback)
  {
    ...
    paramByteStringMicro = ReadInJoyOidbHelper.a("OidbSvc.0xd78_0", 3448, 0, paramRequestSearchWordCallback.toByteArray());
  ...
  public void a(String paramString1, String paramString2, int paramInt1, List<Long> paramList1, List<Long> paramList2, int paramInt2, byte[] paramArrayOfByte, double paramDouble1, double paramDouble2, boolean paramBoolean1, boolean paramBoolean2, int paramInt3, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt3 == 1)
      {
        ...
        i = 2;
        arrayOfString = SharedPreUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
  ...
  public void a(String paramString1, String paramString2, int paramInt1, List<Long> paramList1, List<Long> paramList2, byte[] paramArrayOfByte, int paramInt2, double paramDouble1, double paramDouble2, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      sendPbReq(paramList2);
      return;
      localIterator1 = FunctionModuleConfigManager.jdField_a_of_type_JavaUtilHashMap.values().iterator();
      paramInt1 = 2;
      i = paramInt1;
  ...
  public void a(byte[] paramArrayOfByte, TKDWupModule.HippyWupCallbackManager paramHippyWupCallbackManager, Integer paramInteger)
  {
    ...
    paramHippyWupCallbackManager.version.set(ByteStringMicro.copyFromUtf8("8.5.5"));
    ...
    for (;;)
    {
      try
      {
        ...
        if (localRspBody.error_msg.get() != null)
        {
          ...
          SharedPreUtils.a(this.appRuntime.getAccount(), i, localRspBody.expire_time.get());
