  ...
  extends CustomEmoRoamingBaseHandler<CameraEmotionData>
{
  ...
  protected CameraEmoRoamingHandler(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    CameraEmotionData localCameraEmotionData = (CameraEmotionData)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(j));
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i == 0)
        {
          ...
          ((CameraEmoRoamingManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.CAMERA_EMOTION_MANAGER)).a(localCameraEmotionData);
  ...
  private void a(List<CameraEmotionRoaming_sso.ImgInfo> paramList, List<CameraEmoRoamingHandler.CameraEmoImg> paramList1, List<String> paramList2)
  {
    ...
    String str3;
    String str5;
    CameraEmoRoamingHandler.CameraEmoImg localCameraEmoImg;
    while (localIterator.hasNext())
    {
      ...
      {
        localCameraEmoImg = new CameraEmoRoamingHandler.CameraEmoImg();
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    CameraEmotionData localCameraEmotionData = (CameraEmotionData)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(i));
    if ((paramObject == null) || (paramFromServiceMsg == null) || (!paramFromServiceMsg.isSuccess()))
    {
      paramObject = new StringBuilder().append("fail to  handlePrepareUploadInfo error code is ");
      if (paramFromServiceMsg == null) {}
  ...
  public void a()
  {
    ...
    String str = ((CameraEmoRoamingManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.CAMERA_EMOTION_MANAGER)).a();
    ...
    localReqBody.uint64_src_uin.set(Long.parseLong(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()));
    localReqBody.uint32_cmd_type.set(3);
    localReqBody.uint32_src_term.set(3);
    localReqBody.bytes_version.set(ByteStringMicro.copyFrom("8.5.5".getBytes()));
    localReqBody.get_list_req.set((MessageMicro)localObject);
    localObject = new ToServiceMsg("mobileqq.service", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "SelfGif.Op");
  ...
  public void a(CameraEmotionData paramCameraEmotionData, int paramInt1, int paramInt2, long paramLong)
  {
    ...
    ((CameraEmotionRoaming_sso.ReqBody)localObject2).uint64_src_uin.set(Long.parseLong(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()));
    ...
    ((CameraEmotionRoaming_sso.ReqBody)localObject2).bytes_version.set(ByteStringMicro.copyFrom("8.5.5".getBytes()));
    ((CameraEmotionRoaming_sso.ReqBody)localObject2).upLoad_req.set((MessageMicro)localObject1);
    localObject1 = new ToServiceMsg("mobileqq.service", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "SelfGif.Op");
  ...
  public void a(CameraEmotionData paramCameraEmotionData, boolean paramBoolean)
  {
    ...
    for (Object localObject1 = "";; localObject1 = paramCameraEmotionData.templateId)
    {
      ...
      ((CameraEmotionRoaming_sso.ReqBody)localObject1).uint64_src_uin.set(Long.parseLong(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()));
      ...
      ((CameraEmotionRoaming_sso.ReqBody)localObject1).bytes_version.set(ByteStringMicro.copyFrom("8.5.5".getBytes()));
      ((CameraEmotionRoaming_sso.ReqBody)localObject1).upLoad_state_req.set((MessageMicro)localObject2);
      localObject2 = new ToServiceMsg("mobileqq.service", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "SelfGif.Op");
  ...
  public void a(List<String> paramList, boolean paramBoolean)
  {
    ...
    paramList.uint64_src_uin.set(Long.parseLong(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()));
    paramList.uint32_cmd_type.set(4);
    paramList.uint32_src_term.set(3);
    paramList.bytes_version.set(ByteStringMicro.copyFrom("8.5.5".getBytes()));
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    case 3: 
      if ((paramObject == null) || (paramFromServiceMsg == null) || (!paramFromServiceMsg.isSuccess()))
      {
        ...
        for (paramToServiceMsg = "null";; paramToServiceMsg = Integer.valueOf(paramFromServiceMsg.getResultCode()))
        {
          ...
          EmoticonManager.e(String.valueOf(paramFromServiceMsg.getResultCode()), 2);
          return;
        }
        EmoticonManager.d("3002", 2);
        return;
      }
    ...
    if ((paramObject == null) || (paramFromServiceMsg == null) || (!paramFromServiceMsg.isSuccess()))
    {
      ...
      for (paramToServiceMsg = "null";; paramToServiceMsg = Integer.valueOf(paramFromServiceMsg.getResultCode()))
      {
        ...
        EmoticonManager.d(String.valueOf(paramFromServiceMsg.getResultCode()), 2);
        return;
      }
      EmoticonManager.d("3003", 2);
      return;
    }
