    ...
    for (;;)
    {
      try
      {
        ...
        if (k == 0)
        {
          ...
          ((DiscussionHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.DISCUSSION_HANDLER)).a(k);
      ...
      try
      {
        ...
        ((TroopCreateLogic)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.MGR_TROOP_CREATE)).a(paramFromServiceMsg, false, paramToServiceMsg);
        ReportController.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_create_new", "", "suc_create", "face_create", 0, 0, "" + paramFromServiceMsg, "" + m, "", "");
