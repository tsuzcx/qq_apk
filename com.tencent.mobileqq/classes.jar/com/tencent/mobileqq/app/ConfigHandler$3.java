...
public class ConfigHandler$3
  implements Runnable
{
  public ConfigHandler$3(alqf paramalqf, String paramString, akgu paramakgu, long paramLong) {}
  ...
  public void run()
  {
    ...
    if (i == 0) {
      bool = this.jdField_a_of_type_Akgu.a(this.jdField_a_of_type_Long, localFile.getAbsolutePath());
    }
