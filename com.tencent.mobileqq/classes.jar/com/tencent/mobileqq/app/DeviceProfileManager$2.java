  ...
  implements Runnable
{
  ...
  public void run()
  {
      ...
      do
      {
        do
        {
          try
          {
            ...
            localEditor2 = bdid.a(BaseApplicationImpl.getApplication(), "dpcConfig").edit();
            localSharedPreferences = bdid.a(BaseApplicationImpl.getApplication(), "dpcConfig_account");
          ...
          if (QLog.isColorLevel()) {
            QLog.d("DeviceProfileManager", 2, "onDPCResponse DPCXmlHandler.tempMap: key=" + (String)localObject9 + ", value=" + localalmo.toString() + ", isAccountName=" + bool1);
          }
    ...
    boolean bool3 = DeviceProfileManager.a((DeviceProfileManager.DPCConfigInfo)localObject9, localalmo.b.toString().trim());
    if (bool1) {
      ((HashMap)localObject7).put(???, localObject9);
    }
    for (;;)
    {
      localEditor1.putString((String)???, localalmo.b);
      label933:
      if (!QLog.isColorLevel()) {
        break label340;
      }
      ...
      synchronized (this.this$0)
      {
        ...
        j = aowf.a(BaseApplicationImpl.getApplication());
        if (i < j) {
