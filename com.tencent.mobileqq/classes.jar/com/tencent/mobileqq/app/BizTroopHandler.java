  ...
  extends BusinessHandler
{
  ...
  private int a(int paramInt)
  {
    ...
    tmp6_5[0] = 2131696123;
    int[] tmp11_6 = tmp6_5;
    tmp11_6[1] = 2131696119;
    int[] tmp16_11 = tmp11_6;
    tmp16_11[2] = 2131696115;
    int[] tmp21_16 = tmp16_11;
    tmp21_16[3] = 2131696118;
    int[] tmp26_21 = tmp21_16;
    tmp26_21[4] = 2131696122;
    int[] tmp31_26 = tmp26_21;
    tmp31_26[5] = 2131696120;
    int[] tmp36_31 = tmp31_26;
    tmp36_31[6] = 2131696125;
    int[] tmp42_36 = tmp36_31;
    tmp42_36[7] = 2131696117;
    int[] tmp48_42 = tmp42_36;
    tmp48_42[8] = 2131696124;
    int[] tmp54_48 = tmp48_42;
    tmp54_48[9] = 2131696116;
    int[] tmp60_54 = tmp54_48;
    tmp60_54[10] = 2131696121;
    tmp60_54;
  ...
  private void a(ToServiceMsg paramToServiceMsg, String paramString1, int paramInt, boolean paramBoolean, String paramString2, Object paramObject, oidb_sso.OIDBSSOPkg paramOIDBSSOPkg)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt == 1)
      {
        ...
        if (i == 1224)
        {
          SharedPreUtils.j(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramString1);
          paramToServiceMsg = (TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.TROOP_MANAGER);
  ...
  private void a(cmd0x874.RspBody paramRspBody)
  {
    ...
    localObject2 = (TroopInfoHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.TROOP_INFO_HANDLER);
    if (localObject2 != null) {
      ((TroopInfoHandler)localObject2).b(((TroopInfo)localObject1).troopuin);
    }
    localObject2 = (TroopCreateLogic)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.MGR_TROOP_CREATE);
    if (localObject2 != null) {
      ((TroopCreateLogic)localObject2).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((TroopInfo)localObject1).troopuin);
    }
    ...
    ((DiscussionManager)localObject1).jdField_a_of_type_JavaUtilMap.put(str, new String[] { paramRspBody, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() });
    ((DiscussionManager)localObject1).jdField_a_of_type_JavaUtilSet.add(paramRspBody);
    notifyUI(41, true, new Object[] { Integer.valueOf(2131696123), str, paramRspBody, Boolean.valueOf(true) });
  }
  ...
  private void k(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    paramToServiceMsg = (RecommendTroopManagerImp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.RECOMMEND_TROOP_MANAGER);
    if (paramFromServiceMsg.getResultCode() != 1000)
    {
    ...
    paramFromServiceMsg = paramFromServiceMsg.act_list.get();
    ...
    notifyUI(11, true, paramFromServiceMsg);
  ...
  private void m(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        paramToServiceMsg = TroopNotificationHelper.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, i, l1, l2, l3, paramFromServiceMsg, j, paramToServiceMsg);
      } while ((TextUtils.isEmpty(str)) || (paramToServiceMsg == null));
      short s = (short)paramToServiceMsg.length;
      if ("OidbSvc.0x852_35".equals(str))
      {
        TroopNotificationHelper.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, i, l1, l2, s, paramToServiceMsg, l3, paramFromServiceMsg, j);
        return;
      }
      if ("OidbSvc.0x852_48".equals(str))
      {
        TroopNotificationHelper.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, i, l1, l2, s, paramToServiceMsg, (short)k, bool);
        return;
      }
    } while (!"OidbSvc.0x8ca_2".equals(str));
    ((TroopHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.TROOP_HANDLER)).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "" + l1, paramToServiceMsg, i);
  }
  ...
  private void n(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    paramToServiceMsg = (byte[])paramObject;
    TroopNotificationHelper.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, i, l1, l2, l3, paramFromServiceMsg, j, paramToServiceMsg);
  }
  ...
  private void o(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        paramToServiceMsg = (byte[])paramObject;
        paramToServiceMsg = TroopNotificationHelper.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, l1, l2, paramToServiceMsg, j, i, bool);
      ...
      paramObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade();
      ArrayList localArrayList = new ArrayList();
      localArrayList.add(paramToServiceMsg);
      int i = (int)MessageCache.a();
      paramObject.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1), String.valueOf(l2), localArrayList, 34, i, 0, paramFromServiceMsg);
  ...
  private void p(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((paramToServiceMsg == null) || (paramFromServiceMsg == null))
    {
      notifyUI(28, false, localTroopCreateResult);
      return;
    }
    if (paramFromServiceMsg.getResultCode() != 1000)
    {
  ...
  {
    if ((paramToServiceMsg == null) || (paramFromServiceMsg == null)) {
      notifyUI(41, false, new Object[] { Integer.valueOf(2131696116) });
    }
  ...
  private void r(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      ...
      if (i == 2)
      {
        ((TroopGagMgr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.TROOP_GAG_MANAGER)).a(paramToServiceMsg, paramFromServiceMsg, paramObject);
        return;
      }
      if (i == 3)
      {
  ...
  private void t(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      if (i != 0)
      {
        ...
        if (i == 1328) {
          paramToServiceMsg[2] = HardCodeUtil.a(2131701232);
        }
  ...
  public void a(String paramString1, int paramInt, @Nullable String paramString2)
  {
    ...
    if (SharedPreUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).contains(str))
    {
  ...
  {
    paramString = new ToServiceMsg("mobileqq.service", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramString);
  ...
  public boolean a(String paramString, int paramInt)
  {
    ...
    if (i == 0)
    {
      QQToast.a(BaseApplication.getContext(), 2131696097, 0).b(BaseApplication.getContext().getResources().getDimensionPixelSize(2131299166));
      return false;
    }
  ...
  public void g(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    QLog.d("TroopFileHandler", 2, "handleGetFansTroopIdolInfoResp req == null");
    return;
    ...
    if (paramFromServiceMsg.name.has()) {
      paramObject.name = paramFromServiceMsg.name.get();
    }
    if (paramFromServiceMsg.alias.has()) {
      paramObject.avatar = paramFromServiceMsg.avatar.get();
    }
    if (localRspBody.rank.has()) {
      paramObject.rank = localRspBody.rank.get();
    }
    ((TroopInfoManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.TROOPINFO_MANAGER)).a(paramToServiceMsg, paramObject);
    notifyUI(47, true, new Object[] { paramToServiceMsg, paramObject.name, Long.valueOf(paramObject.rank) });
  }
