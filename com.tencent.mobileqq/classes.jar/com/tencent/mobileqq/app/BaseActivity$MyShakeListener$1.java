...
public class BaseActivity$MyShakeListener$1
  implements Runnable
{
  public BaseActivity$MyShakeListener$1(anqy paramanqy, BaseActivity paramBaseActivity) {}
  ...
  public void run()
  {
    ...
    if ((bool) && (SettingCloneUtil.readValue(this.a, null, this.a.getString(2131694747), "qqsetting_screenshot_key", false)) && (bhan.a(BaseApplicationImpl.sApplication)))
    {
