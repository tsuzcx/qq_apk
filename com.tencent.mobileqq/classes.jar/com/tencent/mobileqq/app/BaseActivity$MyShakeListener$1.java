...
public class BaseActivity$MyShakeListener$1
  implements Runnable
{
  public BaseActivity$MyShakeListener$1(amol paramamol, BaseActivity paramBaseActivity) {}
  ...
  public void run()
  {
    ...
    if ((bool) && (SettingCloneUtil.readValue(this.a, null, this.a.getString(2131694546), "qqsetting_screenshot_key", false)) && (bfrw.a(BaseApplicationImpl.sApplication)))
    {
