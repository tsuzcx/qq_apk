...
public class BaseActivity$MyShakeListener$1
  implements Runnable
{
  public BaseActivity$MyShakeListener$1(antv paramantv, BaseActivity paramBaseActivity) {}
  ...
  public void run()
  {
    ...
    if ((bool) && (SettingCloneUtil.readValue(this.a, null, this.a.getString(2131694432), "qqsetting_screenshot_key", false)) && (bhim.a(BaseApplicationImpl.sApplication)))
    {
    ...
    for (;;)
    {
      ...
      return;
      label299:
      if ((!bhvl.g) && (Build.VERSION.SDK_INT < 11)) {
        bhvi.a().a(this.a.getWindow());
      }
    }
  }
}
