...
public class BaseActivity$MyShakeListener$1
  implements Runnable
{
  public BaseActivity$MyShakeListener$1(ania paramania, BaseActivity paramBaseActivity) {}
  ...
  public void run()
  {
    ...
    if ((bool) && (SettingCloneUtil.readValue(this.a, null, this.a.getString(2131694390), "qqsetting_screenshot_key", false)) && (bgil.a(BaseApplicationImpl.sApplication)))
    {
