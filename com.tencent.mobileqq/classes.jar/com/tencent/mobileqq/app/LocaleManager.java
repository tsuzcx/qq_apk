...
public class LocaleManager
{
  ...
  private static final SparseArray<Locale> jdField_a_of_type_AndroidUtilSparseArray;
  ...
  {
    if (paramInt == 2052) {
      return HardCodeUtil.a(2131693613);
    }
    if (paramInt == 1033) {
      return HardCodeUtil.a(2131693612);
    }
    return "";
  }
  ...
  public static void a(Context paramContext)
  {
    ...
    {
      str = PropertiesUtils.a(paramContext, "key_local_cache", "0");
      ...
      str = PropertiesUtils.a(paramContext, "key_local_last", "0");
      if (!"0".equals(str)) {
        break label200;
      }
