...
{
  public static final Parcelable.Creator<UpdateFriendStatusItem> CREATOR = new akhn();
  public int a;
  public long a;
  public String a;
  private byte[] a;
  ...
  public long a()
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_ArrayOfByte.length == 4) {
        return ajml.a(this.jdField_a_of_type_ArrayOfByte);
      }
    } while (this.jdField_a_of_type_ArrayOfByte.length != 8);
    return ajml.a(Arrays.copyOfRange(this.jdField_a_of_type_ArrayOfByte, 0, 4));
  }
