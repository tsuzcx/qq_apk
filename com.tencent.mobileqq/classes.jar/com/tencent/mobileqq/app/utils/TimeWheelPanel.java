  ...
  implements anxd
{
  ...
  private void a()
  {
    if ((this.jdField_a_of_type_AndroidViewLayoutInflater == null) || (this.jdField_a_of_type_ComTencentMobileqqAppUtilsNumberWheelView == null) || (this.jdField_b_of_type_ComTencentMobileqqAppUtilsNumberWheelView == null) || (this.jdField_c_of_type_ComTencentMobileqqAppUtilsNumberWheelView == null))
    {
      ...
      this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131560974, this);
      this.jdField_a_of_type_ComTencentMobileqqAppUtilsNumberWheelView = ((NumberWheelView)findViewById(2131365329));
      this.jdField_b_of_type_ComTencentMobileqqAppUtilsNumberWheelView = ((NumberWheelView)findViewById(2131368214));
      this.jdField_c_of_type_ComTencentMobileqqAppUtilsNumberWheelView = ((NumberWheelView)findViewById(2131371289));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131365330));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131368215));
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131371290));
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131366100));
  ...
  public void a(NumberWheelView paramNumberWheelView, VerticalGallery paramVerticalGallery)
  {
    ...
    if (this.jdField_a_of_type_Anxm != null) {
      this.jdField_a_of_type_Anxm.a(paramNumberWheelView, paramVerticalGallery);
    }
  }
  ...
  public void setScrollerStateListener(anxm paramanxm)
  {
    this.jdField_a_of_type_Anxm = paramanxm;
  }
  ...
  {
    if (paramInt1 == 0) {
      findViewById(2131365325).setVisibility(paramInt2);
    }
    do
    {
      return;
      if (paramInt1 == 1)
      {
        findViewById(2131368210).setVisibility(paramInt2);
        return;
      }
      if (paramInt1 == 2)
      {
        findViewById(2131371286).setVisibility(paramInt2);
        return;
      }
    } while (paramInt1 != 3);
