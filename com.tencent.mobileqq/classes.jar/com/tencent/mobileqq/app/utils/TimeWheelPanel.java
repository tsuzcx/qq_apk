...
{
  public int a;
  private akid jdField_a_of_type_Akid;
  ...
  private void a()
  {
    if ((this.jdField_a_of_type_AndroidViewLayoutInflater == null) || (this.jdField_a_of_type_ComTencentMobileqqAppUtilsNumberWheelView == null) || (this.jdField_b_of_type_ComTencentMobileqqAppUtilsNumberWheelView == null) || (this.jdField_c_of_type_ComTencentMobileqqAppUtilsNumberWheelView == null))
    {
      ...
      this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131495091, this);
      this.jdField_a_of_type_ComTencentMobileqqAppUtilsNumberWheelView = ((NumberWheelView)findViewById(2131299366));
      this.jdField_b_of_type_ComTencentMobileqqAppUtilsNumberWheelView = ((NumberWheelView)findViewById(2131302042));
      this.jdField_c_of_type_ComTencentMobileqqAppUtilsNumberWheelView = ((NumberWheelView)findViewById(2131304681));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131299367));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131302043));
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131304682));
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131300097));
  ...
  public void a(NumberWheelView paramNumberWheelView, VerticalGallery paramVerticalGallery)
  {
    ...
    setValues(false);
    if (this.jdField_a_of_type_Akid != null) {
      this.jdField_a_of_type_Akid.a(paramNumberWheelView, paramVerticalGallery);
    }
  }
  ...
  public void setScrollerStateListener(akid paramakid)
  {
    this.jdField_a_of_type_Akid = paramakid;
  }
  ...
  {
    if (paramInt1 == 0) {
      findViewById(2131299362).setVisibility(paramInt2);
    }
    do
    {
      return;
      if (paramInt1 == 1)
      {
        findViewById(2131302038).setVisibility(paramInt2);
        return;
      }
      if (paramInt1 == 2)
      {
        findViewById(2131304678).setVisibility(paramInt2);
        return;
      }
    } while (paramInt1 != 3);
