  ...
  implements Manager
{
  ...
  {
    Object localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getQQHeadSetting(4, paramString, 0);
    int j;
    int i;
  ...
  public void a(ClassicHeadActivityManager.FriendHeadFlagItem paramFriendHeadFlagItem)
  {
    ...
    if ((a()) && (paramFriendHeadFlagItem != null))
    {
      ...
      localStringBuilder.append(" uin=").append(StringUtil.e(paramFriendHeadFlagItem.jdField_a_of_type_JavaLangString));
      localStringBuilder.append(" sysId=").append(paramFriendHeadFlagItem.jdField_b_of_type_Long);
      localStringBuilder.append(" headType=").append(paramFriendHeadFlagItem.c);
      localStringBuilder.append(" qq18Switch=").append(paramFriendHeadFlagItem.jdField_a_of_type_Long);
      ...
      localIQQAvatarHandlerService = (IQQAvatarHandlerService)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getRuntimeService(IQQAvatarHandlerService.class, "");
      ...
      localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getQQHeadSetting(1, paramFriendHeadFlagItem.jdField_a_of_type_JavaLangString, 0);
      if ((localObject == null) || (!((Boolean)((Pair)localObject).first).booleanValue())) {
        break label241;
      }
  ...
  public void a(String paramString)
  {
    if ((!TextUtils.isEmpty(paramString)) && (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap != null) && (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(paramString)))
    {
      ...
      if ((localHeadInfoItem != null) && (localHeadInfoItem.jdField_a_of_type_Boolean))
      {
        QLog.d("ClassicHeadActivityManager", 2, " QQ 18 handle handleGetHeadError uin=" + paramString + ",HeadID=" + localHeadInfoItem.jdField_a_of_type_Int + ",Type=" + localHeadInfoItem.b + ",IsRequest=" + localHeadInfoItem.jdField_a_of_type_Boolean);
        this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(paramString);
      }
    }
  }
  ...
  public void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    {
      localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getQQHeadSetting(4, paramString, 0);
      if ((localObject == null) || (((Pair)localObject).second == null)) {
        break label350;
      }
      localObject = (Setting)((Pair)localObject).second;
    ...
    for (;;)
    {
      ...
      do
      {
        do
        {
          ClassicHeadActivityManager.HeadInfoItem localHeadInfoItem;
          do
          {
            do
            {
            ...
            return;
            localHeadInfoItem = (ClassicHeadActivityManager.HeadInfoItem)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
          } while (localHeadInfoItem == null);
