  ...
  implements Manager
{
  ...
  public void a()
  {
    ...
    if (!TextUtils.isEmpty((CharSequence)localObject))
    {
      ...
      {
        this.jdField_a_of_type_Long = ArMapUtil.b(localObject[0]);
        this.jdField_b_of_type_Long = ArMapUtil.b(localObject[1]);
        if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if (paramLong3 == 1L)
      {
        ...
        if ((localObject != null) && (((Boolean)((Pair)localObject).first).booleanValue()))
        {
          ...
          localFriendListHandler.a(3, true, str);
        }
  ...
  public void a(ClassicHeadActivityManager.FriendHeadFlagItem paramFriendHeadFlagItem)
  {
    ...
    if ((a()) && (paramFriendHeadFlagItem != null))
    {
      ...
      localStringBuilder.append(" uin=").append(StringUtil.d(paramFriendHeadFlagItem.jdField_a_of_type_JavaLangString));
      ...
      localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(1, paramFriendHeadFlagItem.jdField_a_of_type_JavaLangString, 0);
      if ((localObject == null) || (!((Boolean)((Pair)localObject).first).booleanValue())) {
        break label221;
      }
      localFriendListHandler.c(paramFriendHeadFlagItem.jdField_a_of_type_JavaLangString);
      localFriendListHandler.a(3, true, paramFriendHeadFlagItem.jdField_a_of_type_JavaLangString);
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
