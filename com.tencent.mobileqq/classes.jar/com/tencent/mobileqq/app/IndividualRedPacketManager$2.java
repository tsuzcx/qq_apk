...
public class IndividualRedPacketManager$2
  implements Runnable
{
  public IndividualRedPacketManager$2(ajkz paramajkz) {}
  ...
  public void run()
  {
    ...
    try
    {
      ...
      localObject1 = str;
      arrayOfString[0] = ajkz.a(5);
      localObject1 = str;
      arrayOfString[1] = ajkz.a(6);
      localObject1 = str;
      arrayOfString[2] = ajkz.a(7);
      localObject1 = str;
      arrayOfString[3] = ajkz.a(8);
    }
    catch (Exception localException2)
    {
      for (;;)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.e(ajkz.b(), 2, "eliminateImageCache error: " + localException2.getMessage() + ", in step=" + (String)localObject1);
        }
        label425:
        try
        {
          ...
          awrn.a(BaseApplicationImpl.sApplication.getApplicationContext()).a(((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime()).getAccount(), "RedpacketClearCacheError", false, 1L, 0L, localHashMap, "", false);
          return;
        }
