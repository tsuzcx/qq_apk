...
public class IndividualRedPacketManager$2
  implements Runnable
{
  public IndividualRedPacketManager$2(ajzf paramajzf) {}
  ...
  public void run()
  {
    ...
    try
    {
      ...
      localObject1 = str;
      arrayOfString[0] = ajzf.a(5);
      localObject1 = str;
      arrayOfString[1] = ajzf.a(6);
      localObject1 = str;
      arrayOfString[2] = ajzf.a(7);
      localObject1 = str;
      arrayOfString[3] = ajzf.a(8);
    }
    catch (Exception localException2)
    {
      for (;;)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.e(ajzf.b(), 2, "eliminateImageCache error: " + localException2.getMessage() + ", in step=" + (String)localObject1);
        }
        label425:
        try
        {
          ...
          axrl.a(BaseApplicationImpl.sApplication.getApplicationContext()).a(((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime()).getAccount(), "RedpacketClearCacheError", false, 1L, 0L, localHashMap, "", false);
          return;
        }
