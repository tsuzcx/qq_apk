  ...
  extends BusinessHandler
{
  ...
  DownloadListener jdField_a_of_type_ComTencentMobileqqVipDownloadListener = new zih(this);
  ...
  {
    ThreadManager.getFileThreadHandler().post(new zif(this, paramInt, paramString));
  }
  ...
  {
    ThreadManager.getFileThreadHandler().post(new zig(this, paramInt, paramString));
  }
