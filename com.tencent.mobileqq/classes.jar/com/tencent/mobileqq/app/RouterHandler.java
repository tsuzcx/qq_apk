  ...
  implements LiteTransferListenerCallback, LiteTransferOperatorCallback
{
  ...
  private void a(String paramString)
  {
    ...
    do
    {
      ...
      paramString = (RecentUser)this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a().a().findRecentUserByUin(paramString, 6002);
  ...
  public void a(Session paramSession, NFCInfo paramNFCInfo, FTNInfo paramFTNInfo, boolean paramBoolean)
  {
    ...
    if (paramSession.msgHeader.uint64_src_uin == a())
    {
      ...
      localMessageForDeviceFile.msg = this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691133);
    }
    for (;;)
    {
