  ...
  implements LiteTransferListenerCallback, LiteTransferOperatorCallback
{
  ...
  {
    return ((xrh)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(51)).a();
  }
  
  private void a(int paramInt, FTNNotify paramFTNNotify, long paramLong)
  {
    paramFTNNotify = this.jdField_a_of_type_ComTencentLitetransfersdkProtocolHelper.MsgBodyFromFTNNotify(paramFTNNotify, paramLong, ajed.z, 1).toByteArray();
    ((xrh)this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a(51)).a(paramLong, paramInt, paramFTNNotify);
  }
  
  private void a(int paramInt, FileControl paramFileControl, long paramLong)
  {
    paramFileControl = this.jdField_a_of_type_ComTencentLitetransfersdkProtocolHelper.MsgBodyFromFileControl(paramFileControl, paramLong, ajed.z, 3).toByteArray();
    ((xrh)this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a(51)).a(paramLong, paramInt, paramFileControl);
  }
  ...
  private void a(int paramInt, MsgCSBody0x346 paramMsgCSBody0x346)
  {
    ...
    ((xrh)this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a(51)).a(paramMsgCSBody0x346.uMsgSubType, paramInt, localReqBody.toByteArray());
  }
  
  private void a(int paramInt, NFCNotify paramNFCNotify, long paramLong)
  {
    paramNFCNotify = this.jdField_a_of_type_ComTencentLitetransfersdkProtocolHelper.MsgBodyFromNFCNotify(paramNFCNotify, paramLong, ajed.z, 2).toByteArray();
    ((xrh)this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a(51)).a(paramLong, paramInt, paramNFCNotify);
  }
  ...
  {
    String str = akbm.a(String.valueOf(paramRouterMsgRecord.peerDin), 6002);
    boolean bool = false;
  ...
  private void a(String paramString)
  {
    ...
    {
      return;
      atmp localatmp = this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getEntityManagerFactory().createEntityManager();
  ...
  {
    return ((xrh)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(51)).a(paramInt1, paramInt2, paramArrayOfByte);
  }
  
  public static boolean a(long paramLong, int paramInt, byte[] paramArrayOfByte)
  {
    return ((xrh)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(51)).a(paramLong, paramInt, paramArrayOfByte);
  }
  ...
  private void c(RouterMsgRecord paramRouterMsgRecord)
  {
    ...
    akeu localakeu = this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a().a();
    localObject = localakeu.a((String)localObject, 6002);
  ...
  {
    es.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, paramReportItem, es.d);
  }
  ...
  public Session a(MessageForDeviceFile paramMessageForDeviceFile)
  {
    ...
    for (;;)
    {
      ...
      if ((QLog.isDevelopLevel()) && (paramMessageForDeviceFile.md5 != null)) {
        QLog.d("dataline.Router", 4, "getSessionFromMsgRecord, uSessionID[" + paramMessageForDeviceFile.uSessionID + "], strMR[" + bach.a(paramMessageForDeviceFile.md5) + "], filesize[" + paramMessageForDeviceFile.fileSize);
      }
  ...
  public QQMessageFacade.Message a(String paramString)
  {
    ...
    atmp localatmp = this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getEntityManagerFactory().createEntityManager();
    if (aken.a(localProxyManager, RouterMsgRecord.sBasicTableName + paramString)) {
      localProxyManager.a(localatmp);
    }
    paramString = localatmp.a(RouterMsgRecord.class, "select * from " + RouterMsgRecord.sBasicTableName + paramString + " order by msgid desc", null);
    localatmp.a();
    if (paramString == null) {
      return null;
    }
  ...
  {
    DeviceInfo localDeviceInfo = ((xrh)this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a(51)).a(paramLong);
    if (localDeviceInfo == null) {
      return BaseApplication.getContext().getString(2131625834);
    }
    return ydt.a(localDeviceInfo);
  }
  ...
  public void a(int paramInt1, Session paramSession, double paramDouble, int paramInt2)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        xrh localxrh = (xrh)this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a(51);
        if (paramSession.msgHeader.uint64_src_uin == localxrh.a())
        {
          ...
          ((RouterMsgRecord)localObject).time = awao.a();
  ...
  public void a(Session paramSession, NFCInfo paramNFCInfo, FTNInfo paramFTNInfo, boolean paramBoolean)
  {
    ...
    if (paramSession.msgHeader.uint64_src_uin == a())
    {
      ...
      localMessageForDeviceFile.srcFileName = apck.a(paramSession.strFilePathSrc);
      localMessageForDeviceFile.msgStatus = 3;
      localMessageForDeviceFile.nFileStatus = -1;
      localMessageForDeviceFile.time = awao.a();
      localMessageForDeviceFile.msg = this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131625716);
      if (!paramSession.bSend) {
        break label616;
      }
      i = 0;
      ...
      if (!xvq.d.equalsIgnoreCase(paramSession.actionInfo.strServiceName)) {
        break label622;
      }
      localMessageForDeviceFile.nFileMsgType = 2;
      localMessageForDeviceFile.msg = this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131625721);
    }
    for (;;)
    {
      ...
      ((xvq)this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a(49)).a().a(paramSession.uSessionID, localMessageForDeviceFile.frienduin, localMessageForDeviceFile.istroop, localMessageForDeviceFile.uniseq);
      ...
      break label151;
      label622:
      if (xvq.h.equalsIgnoreCase(paramSession.actionInfo.strServiceName))
      {
        localMessageForDeviceFile.nFileMsgType = 1;
        localMessageForDeviceFile.msg = this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131625716);
      }
      else if (xvq.b.equalsIgnoreCase(paramSession.actionInfo.strServiceName))
      {
        localMessageForDeviceFile.nFileMsgType = 1;
        localMessageForDeviceFile.msg = this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131625716);
      }
  ...
  public boolean a(List<MessageRecord> paramList)
  {
    ...
    for (;;)
    {
      ...
      ((xvq)this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a(49)).a().a(localMessageForDeviceFile.uSessionID, localMessageForDeviceFile.frienduin, localMessageForDeviceFile.istroop, localMessageForDeviceFile.uniseq);
