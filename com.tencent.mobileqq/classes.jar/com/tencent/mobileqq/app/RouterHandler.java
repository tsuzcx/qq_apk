  ...
  implements LiteTransferListenerCallback, LiteTransferOperatorCallback
{
  ...
  public RouterHandler(QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface.addAction("mqq.intent.action.EXIT_" + this.c.getApp().getPackageName());
    ...
    this.c.getApp().registerReceiver(this.jdField_a_of_type_ComTencentMobileqqAppRouterHandler$NotifyReceiver, paramQQAppInterface);
  }
  
  public static long a()
  {
    return ((SmartDeviceProxyMgr)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(51)).a();
  }
  
  private void a(int paramInt, FTNNotify paramFTNNotify, long paramLong)
  {
    paramFTNNotify = this.jdField_a_of_type_ComTencentLitetransfersdkProtocolHelper.MsgBodyFromFTNNotify(paramFTNNotify, paramLong, AppConstants.y, 1).toByteArray();
  ...
  {
    paramFileControl = this.jdField_a_of_type_ComTencentLitetransfersdkProtocolHelper.MsgBodyFromFileControl(paramFileControl, paramLong, AppConstants.y, 3).toByteArray();
  ...
  {
    paramNFCNotify = this.jdField_a_of_type_ComTencentLitetransfersdkProtocolHelper.MsgBodyFromNFCNotify(paramNFCNotify, paramLong, AppConstants.y, 2).toByteArray();
  ...
  private void a(long paramLong, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramArrayOfByte.msg_header.uint32_dst_app_id.set(AppSetting.jdField_a_of_type_Int);
  ...
  private void a(String paramString)
  {
    ...
    {
      return;
      EntityManager localEntityManager = this.c.getEntityManagerFactory().createEntityManager();
  ...
  private void a(SubMsgType0x7.MsgBody.MsgHeader paramMsgHeader, List paramList, boolean paramBoolean)
  {
    ...
    if (localArrayList.size() > 0) {
      new Handler(Looper.getMainLooper()).post(new zjd(this, paramMsgHeader, localArrayList, paramBoolean));
    }
  }
  
  public static boolean a(int paramInt1, int paramInt2, byte[] paramArrayOfByte)
  {
    return ((SmartDeviceProxyMgr)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(51)).a(paramInt1, paramInt2, paramArrayOfByte);
  }
  
  public static boolean a(long paramLong, int paramInt, byte[] paramArrayOfByte)
  {
    return ((SmartDeviceProxyMgr)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(51)).a(paramLong, paramInt, paramArrayOfByte);
  }
  ...
  private void b(SubMsgType0x7.MsgBody.MsgHeader paramMsgHeader, List paramList, boolean paramBoolean)
  {
    ...
    if (localArrayList.size() > 0) {
      new Handler(Looper.getMainLooper()).post(new zje(this, paramMsgHeader, localArrayList, paramBoolean));
    }
  }
  ...
  {
    if (paramInt2 == 5) {
      new Handler(Looper.getMainLooper()).post(new zjf(this, paramLong, paramMsgHeader));
    }
  }
  ...
  public void OnSessionComplete(long paramLong, int paramInt1, int paramInt2)
  {
    ...
    new Handler(Looper.getMainLooper()).post(new zjj(this, paramLong, paramInt1));
  }
  
  public void OnSessionNew(Session paramSession, NFCInfo paramNFCInfo, FTNInfo paramFTNInfo)
  {
    new Handler(Looper.getMainLooper()).post(new zjg(this, paramSession));
  }
  
  public void OnSessionProgress(long paramLong1, long paramLong2, long paramLong3)
  {
    new Handler(Looper.getMainLooper()).post(new zji(this, paramLong1, paramLong2, paramLong3));
  }
  
  public void OnSessionStart(long paramLong)
  {
    new Handler(Looper.getMainLooper()).post(new zjh(this, paramLong));
  }
  ...
  public String a(long paramLong)
  {
    ...
    if (localDeviceInfo == null) {
      return BaseApplication.getContext().getString(2131427694);
    }
  ...
  public void a()
  {
    if ((this.c != null) && (this.c.getApp() != null) && (this.jdField_a_of_type_ComTencentMobileqqAppRouterHandler$NotifyReceiver != null))
    {
      this.c.getApp().unregisterReceiver(this.jdField_a_of_type_ComTencentMobileqqAppRouterHandler$NotifyReceiver);
  ...
  public void a(Session paramSession, NFCInfo paramNFCInfo, FTNInfo paramFTNInfo, boolean paramBoolean)
  {
    ...
    if (paramSession.msgHeader.uint64_src_uin == a())
    {
      ...
      localMessageForDeviceFile.msg = this.c.getApp().getString(2131435555);
      if (!paramSession.bSend) {
        break label616;
      }
      i = 0;
      ...
      localMessageForDeviceFile.selfuin = this.c.getCurrentAccountUin();
      ...
      localMessageForDeviceFile.msg = this.c.getApp().getString(2131435550);
    }
    for (;;)
    {
      ...
      this.c.a().a(localMessageForDeviceFile, this.c.getCurrentAccountUin());
      return;
      l = paramSession.msgHeader.uint64_src_uin;
      break;
      label616:
  ...
  public void b(Session paramSession)
  {
    ...
    if ((paramSession.dwGroupID == 0) && (paramSession.bSend) && (paramSession.emFileType == 1) && (str != null) && (new File(str).exists())) {
      URLDrawable.getDrawable(AsyncImageView.a(str, this.jdField_a_of_type_Int, this.b, true), null, null, false).downloadImediatly();
    }
  }
