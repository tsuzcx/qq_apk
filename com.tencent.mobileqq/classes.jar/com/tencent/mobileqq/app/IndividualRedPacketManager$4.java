...
public class IndividualRedPacketManager$4
  implements Runnable
{
  public IndividualRedPacketManager$4(ajzf paramajzf, String paramString1, String paramString2, Bundle paramBundle, MessengerService paramMessengerService) {}
  ...
  public void run()
  {
    ...
    //   4: aconst_null
    //   5: astore 6
    //   7: getstatic 38	ajzf:l	I
    //   10: istore_1
    //   11: aload_0
    //   12: getfield 17	com/tencent/mobileqq/app/IndividualRedPacketManager$4:this$0	Lajzf;
    //   15: invokevirtual 41	ajzf:a	()Lbbpe;
    //   18: aload_0
    //   19: getfield 19	com/tencent/mobileqq/app/IndividualRedPacketManager$4:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   22: iconst_1
    //   23: invokevirtual 46	bbpe:a	(Ljava/lang/String;Z)Lbbpk;
    //   26: astore 4
    //   28: aload_0
    //   29: getfield 17	com/tencent/mobileqq/app/IndividualRedPacketManager$4:this$0	Lajzf;
    //   32: aload_0
    ...
    //   40: bipush 6
    //   42: invokevirtual 49	ajzf:a	(Ljava/lang/String;Ljava/lang/String;I)Ljava/lang/String;
    //   45: astore 5
    //   47: aload_0
    //   48: getfield 17	com/tencent/mobileqq/app/IndividualRedPacketManager$4:this$0	Lajzf;
    //   51: getfield 53	ajzf:c	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   54: invokevirtual 59	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   57: ifeq +288 -> 345
    //   60: invokestatic 62	ajzf:b	()Ljava/lang/String;
    //   63: iconst_2
    ...
    //   76: aload_0
    //   77: getfield 17	com/tencent/mobileqq/app/IndividualRedPacketManager$4:this$0	Lajzf;
    //   80: getfield 53	ajzf:c	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   134: iconst_2
    //   135: invokestatic 110	bbca:encodeToString	([BI)Ljava/lang/String;
    //   138: astore 4
    //   140: getstatic 113	ajzf:k	I
    //   143: istore_1
    ...
    //   217: ifeq +42 -> 259
    //   220: invokestatic 62	ajzf:b	()Ljava/lang/String;
    //   223: iconst_2
    ...
    //   261: ifnull +38 -> 299
    //   264: aload 6
    //   266: getfield 167	ajzh:jdField_a_of_type_AndroidGraphicsBitmap	Landroid/graphics/Bitmap;
    //   269: ifnull +30 -> 299
    //   272: aload 6
    //   274: getfield 170	ajzh:jdField_a_of_type_Boolean	Z
    //   277: ifne +22 -> 299
    //   280: aload_0
    //   281: getfield 17	com/tencent/mobileqq/app/IndividualRedPacketManager$4:this$0	Lajzf;
    //   284: aload 6
    //   286: getfield 167	ajzh:jdField_a_of_type_AndroidGraphicsBitmap	Landroid/graphics/Bitmap;
    //   289: ldc 85
    //   291: aload_0
    //   292: getfield 21	com/tencent/mobileqq/app/IndividualRedPacketManager$4:b	Ljava/lang/String;
    //   295: iconst_5
    //   296: invokevirtual 173	ajzf:a	(Landroid/graphics/Bitmap;Ljava/lang/String;Ljava/lang/String;I)V
    //   299: aload 6
    //   301: ifnull +43 -> 344
    //   304: aload 6
    //   306: getfield 167	ajzh:jdField_a_of_type_AndroidGraphicsBitmap	Landroid/graphics/Bitmap;
    //   309: ifnull +35 -> 344
    //   312: aload 5
    //   314: ifnull +30 -> 344
    //   317: aload 6
    //   319: getfield 175	ajzh:b	Z
    //   322: ifeq +307 -> 629
    //   325: aload_0
    //   326: getfield 17	com/tencent/mobileqq/app/IndividualRedPacketManager$4:this$0	Lajzf;
    //   329: aload 5
    //   331: aload_0
    ...
    //   339: bipush 12
    //   341: invokevirtual 173	ajzf:a	(Landroid/graphics/Bitmap;Ljava/lang/String;Ljava/lang/String;I)V
    //   344: return
    //   345: aload 5
    ...
    //   417: aload 4
    //   419: iconst_2
    //   420: invokestatic 110	bbca:encodeToString	([BI)Ljava/lang/String;
    //   423: astore 4
    //   425: getstatic 113	ajzf:k	I
    //   428: istore_2
    //   429: aload 5
    ...
    //   451: ifeq +33 -> 484
    //   454: invokestatic 62	ajzf:b	()Ljava/lang/String;
    //   457: iconst_2
    ...
    //   505: iconst_2
    //   506: aload 4
    //   508: getfield 210	bbpk:d	I
    //   511: aload 4
    //   513: getfield 212	bbpk:a	I
    //   516: invokestatic 215	ajzf:a	(Ljava/lang/String;Ljava/lang/String;III)Ljava/lang/String;
    //   519: invokespecial 186	java/io/File:<init>	(Ljava/lang/String;)V
    //   522: invokevirtual 218	java/io/File:exists	()Z
    //   525: ifeq +82 -> 607
    //   528: aload_0
    //   529: getfield 17	com/tencent/mobileqq/app/IndividualRedPacketManager$4:this$0	Lajzf;
    //   532: aload_0
    //   533: getfield 21	com/tencent/mobileqq/app/IndividualRedPacketManager$4:b	Ljava/lang/String;
    //   536: bipush 6
    //   538: invokevirtual 221	ajzf:a	(Ljava/lang/String;I)Lajzh;
    //   541: astore 5
    //   543: aload_0
    //   544: getfield 17	com/tencent/mobileqq/app/IndividualRedPacketManager$4:this$0	Lajzf;
    //   547: aload 5
    //   549: aload_0
    ...
    //   557: bipush 6
    //   559: invokestatic 224	ajzf:a	(Lajzf;Lajzh;Ljava/lang/String;Ljava/lang/String;I)Landroid/graphics/Bitmap;
    //   562: astore 4
    //   564: iload_3
    //   565: istore_2
    //   566: iload_2
    //   567: ifeq +21 -> 588
    //   570: aload_0
    //   571: getfield 17	com/tencent/mobileqq/app/IndividualRedPacketManager$4:this$0	Lajzf;
    //   574: invokevirtual 41	ajzf:a	()Lbbpe;
    //   577: ldc2_w 225
    //   580: aload_0
    //   581: getfield 19	com/tencent/mobileqq/app/IndividualRedPacketManager$4:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   584: aconst_null
    //   585: invokevirtual 229	bbpe:a	(JLjava/lang/String;Ljava/lang/String;)V
    //   588: aload 4
    //   590: astore 7
    //   592: ldc 85
    //   594: astore 4
    ...
    //   626: goto -60 -> 566
    //   629: aload_0
    //   630: getfield 17	com/tencent/mobileqq/app/IndividualRedPacketManager$4:this$0	Lajzf;
    //   633: aload 5
    //   635: aload_0
    ...
    //   643: bipush 6
    //   645: invokevirtual 173	ajzf:a	(Landroid/graphics/Bitmap;Ljava/lang/String;Ljava/lang/String;I)V
    //   648: return
    //   649: astore 5
    //   651: goto -203 -> 448
    //   654: astore 5
