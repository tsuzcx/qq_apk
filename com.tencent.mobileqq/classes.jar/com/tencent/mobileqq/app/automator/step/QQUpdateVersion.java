  ...
  extends AsyncStep
{
  ...
  private void b()
  {
    ...
    if (i < akpx.c.length)
    {
      ...
      localObject1 = ajsd.aj;
      if ((akpx.a(j) != 1001) && (akpx.a(j) != 10002)) {
        break label85;
      }
      localObject1 = ajsd.aj;
    }
    for (;;)
    {
      ...
      else
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if ((!((String)localObject1).equals(((MessageRecord)localObject3).senderuin)) && (akpx.d((MessageRecord)localObject3)))
          {
        ...
        for (;;)
        {
          ...
          if (localObject2 != null)
          {
            ...
            localObject3 = axas.a(localObject2.msgtype);
  ...
  private void c()
  {
    Object localObject = this.a.app.a().b(ajsd.ak, 1010);
    ...
    localObject = this.a.app.a().b(ajsd.ab, 1010);
    if (localObject != null)
    {
      localObject = ((List)localObject).iterator();
      while (((Iterator)localObject).hasNext())
    ...
    catch (Exception localException1)
    {
      try
      {
        do
        {
          ...
          {
            if (QLog.isColorLevel()) {
              QLog.d("QQUpdateVersion", 2, String.format("version update, old=%s, new=%s", new Object[] { str, "8.3.0" }));
            }
            ...
            localSharedPreferences.edit().putString("qq_update_version", "8.3.0").commit();
          }
          return 7;
