    ...
    try
    {
      ...
      try
      {
        ...
        if (i >= 10)
        {
          ...
          localSignatureKickData.str_right_button.set(localResources.getString(2131434625));
          localSignatureKickData.str_url.set("http://im.qq.com");
          localIntent.putExtra("data", localSignatureKickData.toByteArray());
          localIntent.putExtra("title", localResources.getString(2131433279));
          localIntent.putExtra("msg", localResources.getString(2131438817));
