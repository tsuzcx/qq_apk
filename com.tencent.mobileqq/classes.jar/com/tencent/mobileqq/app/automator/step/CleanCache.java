  ...
  extends AsyncStep
{
  ...
  static
  {
    jdField_a_of_type_ArrayOfJavaLangString = new String[] { ajsd.bk };
  }
  ...
  private void f()
  {
    ...
    aezl.d(true);
    Object localObject1 = ajsd.aW + "zhitu";
    localObject1 = new File(bbvj.a((String)localObject1 + "/" + "origin/"));
    int n;
    int k;
    int j;
    label153:
    ...
    if ((((File)localObject1).exists()) && (((File)localObject1).isDirectory()))
    {
      ...
      if (localObject1 != null)
      {
        ...
        if (n > 200)
        {
          Arrays.sort((Object[])localObject1, new aklp(this));
  ...
  private void g()
  {
    ...
    long l1 = System.currentTimeMillis();
    Object localObject1 = new File(awbf.a);
    int n;
    int k;
    if ((((File)localObject1).exists()) && (((File)localObject1).isDirectory()))
    {
      ...
      if (localObject1 != null)
      {
        ...
        if (n > 25)
        {
          Arrays.sort((Object[])localObject1, new aklq(this));
          int i1 = localObject1.length;
          k = 0;
          i = j;
          m = n;
  ...
  void c()
  {
    ...
    try
    {
      ...
      {
        localObject = ((File)localObject).listFiles(new akln(this));
        if ((localObject != null) && (localObject.length > 10))
        {
          Arrays.sort((Object[])localObject, new aklo(this));
  ...
  void e()
  {
    ...
    List localList = ((aukp)localObject2).a(Setting.class, new Setting().getTableName(), false, null, null, null, null, null, null);
    int i;
    if (localList != null) {
      i = localList.size();
    }
    ...
    for (;;)
    {
      ...
      catch (Exception localException2)
      {
        ...
        if ((localObject3 == null) || (i <= 0) || (!((aukp)localObject2).a())) {}
      }
    }
    for (;;)
    {
      try
      {
        ...
        if (((Iterator)localObject3).hasNext())
        {
          ...
          ((aukp)localObject2).b(localSetting2);
          continue;
        }
      ...
      for (k = localObject1.size();; k = 0)
      {
        ...
        axrn.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppAutomatorAutomator.mApp.getCurrentAccountUin(), "qq_head_setting", false, 0L, 0L, (HashMap)localObject2, "");
        label739:
        return;
      }
      label745:
