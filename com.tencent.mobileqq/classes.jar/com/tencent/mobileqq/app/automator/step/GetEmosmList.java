  ...
  extends AsyncStep
{
  public int a()
  {
    ...
    ((ansk)this.a.app.getManager(259)).a();
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      EmojiStickerManager.jdField_f_of_type_Boolean = bbdh.e();
      ...
      localObject2 = (askf)this.a.app.getManager(14);
      ...
      localObject3 = ((askf)localObject2).a();
    ...
    ((askf)localObject2).a((List)localObject3);
    label454:
    ...
    Object localObject3 = (ajvn)this.a.app.a(12);
    if (((Boolean)localObject2).booleanValue())
    {
      ((ajvn)localObject3).a(0, 0);
      if (!((Boolean)localObject1).booleanValue()) {
        break label708;
      }
      ((ajvn)localObject3).a(0, 0, 1, 0);
    }
    for (;;)
    {
      return 7;
      ((ajvn)localObject3).d(0);
      break;
      label708:
      ((ajvn)localObject3).d(1);
    }
  }
}
