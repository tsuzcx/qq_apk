  ...
  extends AsyncStep
{
  public int a()
  {
    ...
    } while (!localSharedPreferences.getBoolean("updateShortcutIcon8.2.8.4440", true));
    bbio.a(this.a.app, "sid");
    localSharedPreferences.edit().putBoolean("updateShortcutIcon8.2.8.4440", false).commit();
    return 7;
  }
}
