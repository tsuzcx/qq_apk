  ...
  extends AsyncStep
{
  protected int a()
  {
    ...
    } while (!localSharedPreferences.getBoolean("updateShortcutIcon7.6.0.3525", true));
    QQUtils.a(this.a.b, "sid");
    localSharedPreferences.edit().putBoolean("updateShortcutIcon7.6.0.3525", false).commit();
    return 7;
  }
}
