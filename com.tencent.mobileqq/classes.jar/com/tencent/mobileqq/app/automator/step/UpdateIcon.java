  ...
  extends AsyncStep
{
  public int a()
  {
    ...
    } while (!localSharedPreferences.getBoolean("updateShortcutIcon8.4.8.4810", true));
    bfyg.a(this.a.app, "sid");
    localSharedPreferences.edit().putBoolean("updateShortcutIcon8.4.8.4810", false).commit();
    return 7;
  }
}
