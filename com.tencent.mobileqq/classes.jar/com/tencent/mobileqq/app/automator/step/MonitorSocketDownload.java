  ...
  implements bdvw
{
  ...
  public void onResp(bdwt parambdwt)
  {
    ...
    //   46: ifeq +280 -> 326
    //   49: invokestatic 99	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   52: ifeq +32 -> 84
    //   55: ldc 101
    //   57: iconst_2
    ...
    //   70: aload 4
    //   72: invokevirtual 169	java/io/File:exists	()Z
    //   75: invokevirtual 172	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   78: invokevirtual 71	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   81: invokestatic 106	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   84: new 174	java/io/FileInputStream
    //   87: dup
    //   88: aload 4
    //   90: invokespecial 177	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   93: astore 4
    //   95: new 179	java/io/BufferedReader
    //   98: dup
    //   99: new 181	java/io/InputStreamReader
    //   102: dup
    //   103: aload 4
    //   105: invokespecial 184	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   108: invokespecial 187	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   111: astore_3
    //   112: aload_3
    //   113: invokevirtual 190	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   116: astore_1
    //   117: aload_1
    //   118: ifnull +92 -> 210
    //   121: invokestatic 99	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   124: ifeq +10 -> 134
    //   127: ldc 101
    //   129: iconst_2
    //   130: aload_1
    //   131: invokestatic 106	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   134: aload_1
    //   135: ldc 192
    //   137: invokevirtual 196	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   140: iconst_1
    //   141: aaload
    //   142: invokestatic 202	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   145: istore_2
    ...
    //   149: ldc 122
    //   151: iconst_0
    //   152: invokevirtual 126	com/tencent/common/app/BaseApplicationImpl:getSharedPreferences	(Ljava/lang/String;I)Landroid/content/SharedPreferences;
    //   155: ldc 128
    //   157: iconst_m1
    //   158: invokeinterface 134 3 0
    //   163: iload_2
    //   164: if_icmpne +70 -> 234
    //   167: invokestatic 99	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   170: ifeq +40 -> 210
    //   173: ldc 101
    //   175: iconst_2
    ...
    //   188: invokestatic 118	java/lang/System:currentTimeMillis	()J
    //   191: aload_0
    //   192: getfield 120	com/tencent/mobileqq/app/automator/step/MonitorSocketDownload:jdField_a_of_type_Long	J
    //   195: lsub
    //   196: invokevirtual 207	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   199: ldc 209
    ...
    //   207: invokestatic 106	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   210: aload_3
    //   211: ifnull +7 -> 218
    //   214: aload_3
    //   215: invokevirtual 212	java/io/BufferedReader:close	()V
    //   218: aload 4
    //   220: ifnull +8 -> 228
    //   223: aload 4
    //   225: invokevirtual 213	java/io/FileInputStream:close	()V
    //   228: return
    //   229: iconst_0
    //   230: istore_2
    //   231: goto -219 -> 12
    //   234: aload_0
    //   235: invokespecial 215	com/tencent/mobileqq/app/automator/step/MonitorSocketDownload:a	()V
    //   238: aload_0
    //   239: iload_2
    ...
    //   270: aload 4
    //   272: invokevirtual 111	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    ...
    //   282: ifnull +7 -> 289
    //   285: aload_3
    //   286: invokevirtual 212	java/io/BufferedReader:close	()V
    //   289: aload_1
    //   290: ifnull -62 -> 228
    //   293: aload_1
    //   294: invokevirtual 213	java/io/FileInputStream:close	()V
    //   297: return
    //   298: astore_1
    //   299: return
    //   300: astore_1
    ...
    //   307: ifnull +7 -> 314
    //   310: aload_3
    //   311: invokevirtual 212	java/io/BufferedReader:close	()V
    //   314: aload 4
    //   316: ifnull +8 -> 324
    //   319: aload 4
    //   321: invokevirtual 213	java/io/FileInputStream:close	()V
    //   324: aload_1
    //   325: athrow
    //   326: aload_3
    ...
    //   341: ldc 122
    //   343: iconst_0
    //   344: invokevirtual 126	com/tencent/common/app/BaseApplicationImpl:getSharedPreferences	(Ljava/lang/String;I)Landroid/content/SharedPreferences;
    //   347: invokeinterface 219 1 0
    //   352: ldc 128
    //   354: aload_0
    //   355: getfield 35	com/tencent/mobileqq/app/automator/step/MonitorSocketDownload:d	I
    //   358: invokeinterface 225 3 0
    //   363: invokeinterface 228 1 0
    //   368: pop
    //   369: invokestatic 99	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   372: ifeq -144 -> 228
    //   375: ldc 101
    //   377: iconst_2
    ...
    //   394: invokevirtual 139	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   397: invokevirtual 71	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   400: invokestatic 106	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   403: new 179	java/io/BufferedReader
    //   406: dup
    //   407: new 181	java/io/InputStreamReader
    //   410: dup
    //   411: new 174	java/io/FileInputStream
    //   414: dup
    //   415: aload 4
    //   417: invokespecial 177	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   420: invokespecial 184	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   423: invokespecial 187	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   426: astore_3
    //   427: aload_3
    //   428: invokevirtual 190	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   431: astore_1
    //   432: aload_1
    //   433: ifnull +57 -> 490
    //   436: ldc 101
    ...
    //   460: invokestatic 118	java/lang/System:currentTimeMillis	()J
    //   463: aload_0
    //   464: getfield 120	com/tencent/mobileqq/app/automator/step/MonitorSocketDownload:jdField_a_of_type_Long	J
    //   467: lsub
    //   468: invokevirtual 207	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   471: ldc 209
    ...
    //   479: invokestatic 106	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   482: aload_3
    //   483: invokevirtual 190	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   486: astore_1
    //   487: goto -55 -> 432
    //   490: aload_3
    //   491: invokevirtual 212	java/io/BufferedReader:close	()V
    //   494: return
    //   495: astore_1
    //   496: ldc 101
    //   498: iconst_1
    ...
    //   511: aload_1
    //   512: invokevirtual 111	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   515: invokevirtual 71	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   518: invokestatic 106	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   521: return
    //   522: ldc 101
    //   524: iconst_1
