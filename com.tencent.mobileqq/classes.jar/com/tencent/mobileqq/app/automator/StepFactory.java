...
public class StepFactory
{
  ...
  {
    if ("{85,{4,3,5,6},[11,12,14],17,20,21,59,60,22,44,45,[100,79,65,25,10,26,27,28,29,30,32,34,35,39,40,41,42,43,47,48,50,55,107,69,93,70,71,72,73,{91},53,54,61,104,63,77,81,67,80,74,36,37,38,87,88,78,82,84,98,86,102,103],57,95,105}".equals(paramLinearGroup.jdField_b_of_type_JavaLangString)) {
  ...
  public static AsyncStep a(Automator paramAutomator, String paramString)
  {
    ...
    for (;;)
    {
      ...
      paramString.jdField_b_of_type_JavaLangString = paramString.getClass().getSimpleName();
      return paramString;
      if (str.startsWith("["))
      {
    ...
    paramString.jdField_b_of_type_JavaLangString = str;
    return paramString;
  }
  ...
  public static boolean a(LinearGroup paramLinearGroup)
  {
    ...
    do
    {
      do
      {
        return true;
        return false;
        if (!"{[13,16],19,21,58,60,89,23,46,33,61,42,92,96,97,99}".equals(paramLinearGroup.jdField_b_of_type_JavaLangString)) {
          break;
        }
      } while (paramLinearGroup.d >= 1);
      return false;
    } while (("{15,18,21,58,60,24}".equals(paramLinearGroup.jdField_b_of_type_JavaLangString)) || (!"{[11,12,14],17,20,21,22}".equals(paramLinearGroup.jdField_b_of_type_JavaLangString)) || (paramLinearGroup.d >= 2));
    return false;
  }
  
  public static boolean b(LinearGroup paramLinearGroup)
  {
    return (!"{85,{4,3,5,6},[11,12,14],17,20,21,59,60,22,44,45,[100,79,65,25,10,26,27,28,29,30,32,34,35,39,40,41,42,43,47,48,50,55,107,69,93,70,71,72,73,{91},53,54,61,104,63,77,81,67,80,74,36,37,38,87,88,78,82,84,98,86,102,103],57,95,105}".equals(paramLinearGroup.jdField_b_of_type_JavaLangString)) || (paramLinearGroup.d > 5);
  }
  ...
  public static boolean c(LinearGroup paramLinearGroup)
  {
    ...
    do
    {
      do
      {
        ...
        } while (paramLinearGroup.d > 2);
        return false;
        if (!"{15,18,21,58,60,24}".equals(paramLinearGroup.jdField_b_of_type_JavaLangString)) {
          break;
        }
      } while (paramLinearGroup.d > 2);
      return false;
    } while ((!"{[11,12,14],17,20,21,22}".equals(paramLinearGroup.jdField_b_of_type_JavaLangString)) || (paramLinearGroup.d > 2));
    return false;
  }
}
