  ...
  implements Manager
{
  ...
  public static String a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
    default: 
      return BaseApplicationImpl.sApplication.getString(2131437282, new Object[] { Integer.valueOf(paramInt2), Integer.valueOf(paramInt3) });
    case 0: 
      return BaseApplicationImpl.sApplication.getString(2131437278);
    case 1: 
      return BaseApplicationImpl.sApplication.getString(2131437280);
    }
    return BaseApplicationImpl.sApplication.getString(2131437281);
  }
  ...
  public static String a(Context paramContext)
  {
    ...
    tmp6_5[0] = 2131437293;
    int[] tmp11_6 = tmp6_5;
    tmp11_6[1] = 2131437294;
    int[] tmp16_11 = tmp11_6;
    tmp16_11[2] = 2131437295;
    int[] tmp21_16 = tmp16_11;
    tmp21_16[3] = 2131437296;
    int[] tmp26_21 = tmp21_16;
    tmp26_21[4] = 2131437297;
    int[] tmp31_26 = tmp26_21;
    tmp31_26[5] = 2131437298;
    int[] tmp36_31 = tmp31_26;
    tmp36_31[6] = 2131437299;
    int[] tmp42_36 = tmp36_31;
    tmp42_36[7] = 2131437300;
    int[] tmp48_42 = tmp42_36;
    tmp48_42[8] = 2131437301;
    int[] tmp54_48 = tmp48_42;
    tmp54_48[9] = 2131437302;
    tmp54_48;
  ...
  public static String a(Context paramContext, SubMsgType0x76.MsgBody paramMsgBody)
  {
    ...
    if (TextUtils.isEmpty(str2))
    {
      ...
      str1 = String.format(paramContext.getString(2131437249), new Object[] { paramMsgBody.msg_geographic_notify.bytes_local_city.get().toStringUtf8() });
    }
    label63:
    do
    {
      ...
      if (paramMsgBody.uint32_msg_type.get() == 2) {
        return paramContext.getString(2131437250);
      }
      str1 = str2;
    } while (paramMsgBody.uint32_msg_type.get() != 3);
    return paramContext.getString(2131437251);
  }
  ...
  public void a(int paramInt)
  {
    ...
    for (;;)
    {
      if ((paramInt == 2) || (paramInt == 3))
      {
        ...
        ThreadManager.getSubThreadHandler().post(new zwa(this));
      }
      return;
      if (paramInt == 2) {
  ...
  public void a(int paramInt1, long[] paramArrayOfLong1, long[] paramArrayOfLong2, String paramString, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      ThreadManager.getSubThreadHandler().post(new zvz(this, paramInt1, paramArrayOfLong1, paramString, paramInt2, paramArrayOfLong2));
      return;
      label120:
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putBoolean(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131433604) + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramBoolean1).commit();
  }
  ...
  public boolean a(boolean paramBoolean)
  {
    ...
    return this.jdField_a_of_type_AndroidContentSharedPreferences.getBoolean(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131433604) + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), true);
  }
  ...
  public void b()
  {
    zvy localzvy = new zvy(this);
    if (Looper.myLooper() == Looper.getMainLooper())
    {
      ThreadManager.getSubThreadHandler().post(localzvy);
      return;
    }
    localzvy.run();
  }
