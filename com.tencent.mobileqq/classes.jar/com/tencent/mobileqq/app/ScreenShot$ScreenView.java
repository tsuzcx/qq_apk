  ...
  private void a(Canvas paramCanvas)
  {
    ...
    do
    {
      try
      {
        ...
        {
          Toast.makeText(this.jdField_a_of_type_ComTencentMobileqqAppScreenShot.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 2131718653, 1).show();
          return;
        }
      }
      ...
      if (this.jdField_a_of_type_AndroidGraphicsRect.isEmpty())
      {
        ...
        paramCanvas.drawText(this.jdField_a_of_type_ComTencentMobileqqAppScreenShot.jdField_a_of_type_AndroidContentContext.getString(2131719453), getWidth() / 2, m + 26.0F * f1, this.jdField_b_of_type_AndroidGraphicsPaint);
      }
