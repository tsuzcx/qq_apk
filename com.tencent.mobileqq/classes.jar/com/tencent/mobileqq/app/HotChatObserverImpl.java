  ...
  extends HotChatObserver
{
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i(this.a.b, 2, "TroopChatPie.onExitHotChat  troopUin=" + paramString1);
    }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(this.a.b, 2, "onGetUserCreateHotChatAnnounce  isSuccess= " + paramBoolean + ", result=" + paramInt + ", memo=" + paramString2 + ", troopOwner=" + paramLong);
    }
    long l2 = 100L;
    long l1 = l2;
    if (paramBoolean)
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(this.a.b, 2, "onGetHotChatAnnounce  isSuccess= " + paramBoolean + ", result=" + paramInt + ", memo=" + paramString2 + ", jumpurl=" + paramString3);
    }
    long l2 = 100L;
    long l1 = l2;
    if (paramBoolean)
 ...
 * Qualified Name:     com.tencent.mobileqq.app.HotChatObserverImpl
