...
public class UpgradeController$1
  implements Runnable
{
  public UpgradeController$1(akgo paramakgo, boolean paramBoolean) {}
  ...
  public void run()
  {
    ...
    do
    {
          ...
          do
          {
            do
            {
              do
              {
                ...
                {
                  return;
                  if (!akgo.a(this.this$0).jdField_a_of_type_ComTencentMobileqqAppNewUpgradeConfig.dialog.e.equals("1")) {
                    break;
                  }
                } while (!QLog.isColorLevel());
                QLog.d("UpgradeConfigManager", 2, "config do not allow to tip");
                return;
                if (awao.a() >= akgo.a(this.this$0).jdField_a_of_type_ComTencentMobileqqAppNewUpgradeConfig.dialog.b / 1000L) {
                  break;
                }
              } while (!QLog.isColorLevel());
              QLog.d("UpgradeConfigManager", 2, "want to tip but is not time to show");
              return;
              localObject = (QQAppInterface)akgo.a(this.this$0).getRuntime();
            } while (localObject == null);
            if ((this.this$0.a() != 4) || (!this.this$0.b())) {
              break;
            }
          } while ((akgo.a(this.this$0) == null) || (TextUtils.isEmpty(akgo.a(this.this$0).l)));
          akgo.a(this.this$0, true);
          localObject = new File(akgo.a(this.this$0).l);
      ...
      if (!ajgd.b((QQAppInterface)localObject))
      {
    ...
    } while ((akgo.a(this.this$0).jdField_a_of_type_ProtocolKQQConfigUpgradeInfo == null) || (akgo.a(this.this$0).jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.iUpgradeType != 1));
