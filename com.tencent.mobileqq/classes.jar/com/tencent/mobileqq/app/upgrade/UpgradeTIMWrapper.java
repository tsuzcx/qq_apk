...
{
  public static final Parcelable.Creator<UpgradeTIMWrapper> CREATOR = new amql();
  public int a;
  public String a;
  public String b;
  public String c;
  ...
  public static String a()
  {
    ...
    try
    {
      ...
      localObject1 = bdhb.a(new File((String)localObject1 + "upgrade_config_tim_info"));
  ...
  public static void a(String paramString)
  {
    ...
    {
      return;
      bdhb.a(new File(BaseApplicationImpl.getApplication().getFilesDir(), "upgrade_config_tim").getAbsolutePath(), "upgrade_config_tim_info", paramString);
  ...
  public static void b()
  {
    try
    {
      ...
      if (b())
      {
        ...
        bdhb.d(str + "upgrade_config_tim_info");
        if (QLog.isColorLevel()) {
  ...
  public static boolean b()
  {
    ...
    String str = new File(BaseApplicationImpl.getApplication().getFilesDir(), "upgrade_config_tim").getAbsolutePath();
    return bdhb.a(str + "upgrade_config_tim_info");
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.app.upgrade.UpgradeTIMWrapper
