...
{
  public static final Parcelable.Creator<UpgradeTIMWrapper> CREATOR = new akvh();
  public int a;
  public String a;
  public String b;
  public String c;
  ...
  public static String a()
  {
    ...
    try
    {
      ...
      localObject1 = bbdj.a(new File((String)localObject1 + "upgrade_config_tim_info"));
  ...
  public static void a(String paramString)
  {
    ...
    {
      return;
      bbdj.a(new File(BaseApplicationImpl.getApplication().getFilesDir(), "upgrade_config_tim").getAbsolutePath(), "upgrade_config_tim_info", paramString);
  ...
  public static void b()
  {
    try
    {
      ...
      if (b())
      {
        ...
        bbdj.d(str + "upgrade_config_tim_info");
        if (QLog.isColorLevel()) {
  ...
  public static boolean b()
  {
    ...
    String str = new File(BaseApplicationImpl.getApplication().getFilesDir(), "upgrade_config_tim").getAbsolutePath();
    return bbdj.a(str + "upgrade_config_tim_info");
  }
