  ...
  implements Manager
{
  ...
  FriendListObserver jdField_a_of_type_ComTencentMobileqqAppFriendListObserver = new zda(this);
  ...
  public MayknowRecommendManager(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_MqqOsMqqHandler.post(new zcy(this));
  ...
  private void e()
  {
    for (;;)
    {
      ...
      this.jdField_a_of_type_MqqOsMqqHandler.postDelayed(new zcz(this), 5000L);
    }
  }
  ...
  public void a(ArrayList paramArrayList, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      for (paramArrayList = "0X800778F";; paramArrayList = "0X8007792")
      {
        ...
        for (paramArrayList = "你有可能认识的人";; paramArrayList = String.format(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131435499), new Object[] { paramArrayList }))
        {
  ...
  public void b()
  {
    this.jdField_a_of_type_MqqOsMqqHandler.post(new zdb(this));
  }
