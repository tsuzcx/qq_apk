...
public class PublicAccountListActivity
  ...
  implements bcmq, ThreadExcutor.IThreadListener
{
  abtn jdField_a_of_type_Abtn = null;
  abtp jdField_a_of_type_Abtp;
  abtq jdField_a_of_type_Abtq = new abtq(this);
  private ajxl jdField_a_of_type_Ajxl = new abta(this);
  akdi jdField_a_of_type_Akdi;
  private akdo jdField_a_of_type_Akdo = new abtb(this);
  public Dialog a;
  public Drawable a;
  Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new absy(this);
  ...
  private atzl jdField_a_of_type_Atzl = new abtc(this);
  private bfpc jdField_a_of_type_Bfpc = new abtd(this);
  ...
  private Comparator<abtm> jdField_a_of_type_JavaUtilComparator = new abtf(this);
  List<abtm> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  public PublicAccountListActivity()
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new abte(this);
  }
  
  private abtm a(PublicAccountInfo paramPublicAccountInfo)
  {
    abtm localabtm = new abtm(paramPublicAccountInfo);
    localabtm.a(ChnToSpell.a(paramPublicAccountInfo.name, 2));
    localabtm.b(ChnToSpell.a(paramPublicAccountInfo.name, 1));
    return localabtm;
  }
  
  private boolean a(abtm paramabtm)
  {
    if ((paramabtm != null) && (paramabtm.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo == null)) {}
    return false;
  }
  ...
  private void d()
  {
    ...
    this.e = super.findViewById(2131364722);
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.setOnItemClickListener(this.jdField_a_of_type_Bfpc);
  }
  
  private void e()
  {
    this.jdField_a_of_type_AndroidWidgetTextView.setText(2131695523);
    this.jdField_b_of_type_AndroidWidgetTextView.setText(2131695532);
    ...
    if (AppSetting.d)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setContentDescription(this.jdField_b_of_type_AndroidWidgetTextView.getText() + ajyc.a(2131708764));
    }
  }
  ...
  private void f()
  {
    ...
    ((EditText)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131365764)).setOnTouchListener(new abtg(this));
    ...
    this.jdField_a_of_type_Abtn = new abtn(this);
    this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.setAdapter(this.jdField_a_of_type_Abtn);
  ...
  private void g()
  {
    ...
    this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)this.jdField_a_of_type_AndroidAppDialog.findViewById(2131375671));
    ...
    this.jdField_a_of_type_Abtp = new abtp(this, this.jdField_a_of_type_JavaUtilList);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Abtp);
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemClickListener(this.jdField_a_of_type_Bfpc);
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnTouchListener(new abtk(this, (InputMethodManager)localObject));
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidAppDialog.findViewById(2131375491);
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)this.jdField_a_of_type_AndroidAppDialog.findViewById(2131365764));
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new abtr(this));
    ...
    this.jdField_a_of_type_AndroidWidgetImageButton.setOnClickListener(new abtl(this));
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidAppDialog.findViewById(2131375187));
    this.jdField_b_of_type_AndroidWidgetRelativeLayout.setOnClickListener(new absz(this));
    this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidAppDialog.findViewById(2131367524);
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidAppDialog.findViewById(2131365043));
    ((Button)this.jdField_c_of_type_AndroidViewView.findViewById(2131375724)).setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
  }
  ...
  private void h()
  {
    if (this.g == null)
    {
      ViewStub localViewStub = (ViewStub)super.findViewById(2131365676);
      if (localViewStub == null) {
        return;
      }
      this.g = localViewStub.inflate();
      this.g.findViewById(2131375724).setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
    }
  ...
  private void j()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqRedtouchRedTouch != null)
    {
      ...
      BusinessInfoCheckUpdate.AppInfo localAppInfo = localavpq.a("101000.101001");
      if ((localAppInfo != null) && (localAppInfo.iNewFlag.get() == 1)) {
        noo.a(this.app, "P_CliOper", "Pb_account_lifeservice", "", "0X80060E2", "0X80060E2", 0, 0, "", "", "", "", false);
      }
  ...
  public void a()
  {
    ...
    localTranslateAnimation1.setAnimationListener(new abth(this, localTranslateAnimation1, localTranslateAnimation2, i));
    this.jdField_a_of_type_AndroidAppDialog.setOnDismissListener(new abti(this, i, localTranslateAnimation2, (InputMethodManager)localObject));
    this.jdField_a_of_type_AndroidWidgetEditText.setText("");
    this.jdField_a_of_type_AndroidWidgetEditText.setSelection(0);
    this.jdField_a_of_type_AndroidWidgetEditText.requestFocus();
    localObject = (Button)this.jdField_a_of_type_AndroidAppDialog.findViewById(2131363480);
    ((Button)localObject).setVisibility(0);
    ((Button)localObject).setOnClickListener(new abtj(this));
    this.jdField_a_of_type_JavaUtilList.clear();
    this.jdField_a_of_type_Abtp.notifyDataSetChanged();
  ...
  public void a(String paramString)
  {
    ...
    {
      return;
      i = this.jdField_a_of_type_Abtn.a(paramString);
    } while (i == -1);
  ...
  protected void b()
  {
    Object localObject = (ViewGroup)super.findViewById(2131375327);
    if (localObject != null) {
  ...
  public void b(String paramString)
  {
    ...
    {
      abtm localabtm = (abtm)localIterator.next();
      String str = localabtm.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.displayNumber;
      if ((str != null) && (str.equalsIgnoreCase(paramString)))
      {
        localArrayList4.add(localabtm);
      }
      else
      {
        str = localabtm.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.name.toLowerCase();
        if ((str.equals(paramString)) || (localabtm.b.equals(paramString)) || (localabtm.jdField_a_of_type_JavaLangString.equals(paramString))) {
          localArrayList1.add(localabtm);
        } else if ((str.indexOf(paramString) == 0) || (localabtm.b.indexOf(paramString) == 0) || (localabtm.jdField_a_of_type_JavaLangString.indexOf(paramString) == 0)) {
          localArrayList2.add(localabtm);
        } else if ((str.indexOf(paramString) > 0) || (localabtm.b.indexOf(paramString) > 0) || (localabtm.jdField_a_of_type_JavaLangString.indexOf(paramString) > 0)) {
          localArrayList3.add(localabtm);
        }
      }
    }
    Collections.sort(localArrayList4, this.jdField_a_of_type_Abtq);
    Collections.sort(localArrayList1, this.jdField_a_of_type_Abtq);
    Collections.sort(localArrayList2, this.jdField_a_of_type_Abtq);
    Collections.sort(localArrayList3, this.jdField_a_of_type_Abtq);
    ...
    {
      this.jdField_d_of_type_AndroidWidgetTextView.setText(getString(2131695541, new Object[] { paramString }));
  ...
  public void c()
  {
    ...
    ArrayList localArrayList = this.jdField_a_of_type_Akdi.b();
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_Akdi = ((akdi)this.app.getManager(56));
    super.setContentView(2131559435);
    this.jdField_a_of_type_AndroidViewLayoutInflater = super.getLayoutInflater();
    d();
    e();
    f();
    if (this.jdField_a_of_type_Akdi.jdField_a_of_type_Boolean) {
      c();
    }
    for (;;)
    {
      ...
      super.addObserver(this.jdField_a_of_type_Ajxl);
  ...
  public void doOnDestroy()
  {
    ...
    super.removeObserver(this.jdField_a_of_type_Ajxl);
    if (this.jdField_a_of_type_Abtn != null) {
      this.jdField_a_of_type_Abtn.c();
    }
    if (this.jdField_a_of_type_Abtp != null) {
      this.jdField_a_of_type_Abtp.c();
    }
    super.doOnDestroy();
  ...
  public void onWindowFocusChanged(boolean paramBoolean)
  {
    ...
    if (paramBoolean) {
      bbfc.a("pubAcc_follow_list_display", null, "");
    }
  }
