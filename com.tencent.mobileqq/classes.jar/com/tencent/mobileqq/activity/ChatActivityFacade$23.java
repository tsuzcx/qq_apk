  ...
  implements Runnable
{
  ...
  public void run()
  {
    try
    {
      ...
      AbsStructMsg localAbsStructMsg = awuw.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.msgData);
    ...
    MessageRecord localMessageRecord = awbi.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
