  ...
  implements View.OnClickListener
{
  ...
  private AccountObserver jdField_a_of_type_MqqObserverAccountObserver = new adpv(this);
  private MqqHandler jdField_a_of_type_MqqOsMqqHandler = new adps(this);
  public boolean a;
  ...
  private void c(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      super.setTitle(2131717514);
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
      return;
    }
    super.setTitle(2131717517);
  ...
  private void d()
  {
    bdcd.a(this, 0, null, super.getResources().getString(2131717478, new Object[] { "+" + this.jdField_b_of_type_JavaLangString + " " + this.jdField_a_of_type_JavaLangString }), super.getResources().getString(2131717442), super.getResources().getString(2131717460), null, new adpt(this), new adpu(this)).show();
  }
  ...
  public void a()
  {
    ...
    b();
    a(65);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131379096));
    Object localObject1 = (ImageView)super.findViewById(2131373469);
    ...
    for (;;)
    {
      try
      {
        int i = aekt.a(70.0F, super.getResources());
        int j = aekt.a(70.0F, super.getResources());
        URLDrawable.URLDrawableOptions localURLDrawableOptions = URLDrawable.URLDrawableOptions.obtain();
        localURLDrawableOptions.mRequestWidth = i;
        localURLDrawableOptions.mRequestHeight = j;
        localURLDrawableOptions.mLoadingDrawable = super.getResources().getDrawable(2130840084);
        localURLDrawableOptions.mFailedDrawable = super.getResources().getDrawable(2130840391);
        localObject2 = URLDrawable.getDrawable((String)localObject2, localURLDrawableOptions);
        ((URLDrawable)localObject2).setTag(bcuq.a(i, j));
        ((URLDrawable)localObject2).setDecodeHandler(bcuq.a);
        ((ImageView)localObject1).setImageDrawable((Drawable)localObject2);
        localObject1 = (TextView)super.findViewById(2131373514);
        localObject2 = super.getIntent().getStringExtra("key_register_binded_qq_nick");
        if (TextUtils.isEmpty((CharSequence)localObject2)) {
          break label264;
        }
        ((TextView)localObject1).setText((CharSequence)localObject2);
        ((TextView)super.findViewById(2131373515)).setText(this.f);
        ((Button)super.findViewById(2131363531)).setOnClickListener(this);
        ((Button)super.findViewById(2131363532)).setOnClickListener(this);
        c(false);
        return;
      }
      ...
      localException.setImageResource(2130840391);
      continue;
      label264:
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    azmj.a(this.app, "dc00898", "", "", "0X8007363", "0X8007363", 0, 0, "", "", "", "");
    if (!this.jdField_c_of_type_Boolean) {
      azmj.a(this.app, "dc00898", "", "", "0X8007363", "0X8007363", 1, 0, "", "", "", "");
    }
    if (!this.jdField_e_of_type_Boolean)
    {
      azmj.a(this.app, "dc00898", "", "", "0X8007363", "0X8007363", 2, 0, "", "", "", "");
      if (this.jdField_a_of_type_Int != 4) {
        break label448;
      }
      azmj.a(this.app, "new_reg_805", "already_reg", "page_exp", "", 1, "", "1", "", "", "", "", "", "", "");
    }
    for (;;)
    {
      return true;
      azmj.a(this.app, "dc00898", "", "", "0X8007363", "0X8007363", 3, 0, "", "", "", "");
      break;
      label448:
      if (this.jdField_a_of_type_Int == 5) {
        azmj.a(this.app, "new_reg_805", "already_reg", "page_exp", "", 1, "", "2", "", "", "", "", "", "", "");
      } else {
        azmj.a(this.app, "new_reg_805", "already_reg", "page_exp", "", 1, "", "3", "", "", "", "", "", "", "");
      }
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131363531: 
      ...
      azmj.a(this.app, "new_reg_805", "already_reg", "log_clk", "", 1, "");
      return;
    }
    if (getIntent().getBooleanExtra("key_register_from_fail_pay_lh", false)) {
      d(true);
    ...
    for (;;)
    {
      azmj.a(this.app, "new_reg_805", "already_reg", "con_clk", "", 1, "");
      return;
