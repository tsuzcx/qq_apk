  ...
  implements CompoundButton.OnCheckedChangeListener
{
  ...
  private final QQStoryObserver jdField_a_of_type_ComTencentBizQqstoryBaseQQStoryObserver = new riw(this);
  private CardObserver jdField_a_of_type_ComTencentMobileqqAppCardObserver = new riv(this);
  ...
  {
    this.jdField_a_of_type_AndroidOsHandler = new riu(this);
  }
  
  private void a()
  {
    this.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem = ((FormSwitchItem)super.findViewById(2131363321));
    this.jdField_c_of_type_AndroidViewView = super.findViewById(2131363314);
    this.jdField_d_of_type_AndroidViewView = super.findViewById(2131363315);
    if (!QQStoryManager.j())
    {
      this.jdField_d_of_type_AndroidViewView.setVisibility(8);
      ((FormSimpleItem)this.jdField_c_of_type_AndroidViewView).setBgType(0);
    }
    this.jdField_c_of_type_ComTencentMobileqqWidgetFormSwitchItem = ((FormSwitchItem)super.findViewById(2131363311));
    this.jdField_d_of_type_ComTencentMobileqqWidgetFormSwitchItem = ((FormSwitchItem)super.findViewById(2131363312));
    this.jdField_e_of_type_ComTencentMobileqqWidgetFormSwitchItem = ((FormSwitchItem)super.findViewById(2131363325));
    this.h = ((FormSwitchItem)super.findViewById(2131363326));
    this.i = ((FormSwitchItem)super.findViewById(2131363327));
    this.j = ((FormSwitchItem)super.findViewById(2131363328));
    this.jdField_f_of_type_ComTencentMobileqqWidgetFormSwitchItem = ((FormSwitchItem)super.findViewById(2131363313));
    this.g = ((FormSwitchItem)super.findViewById(2131363324));
    this.k = ((FormSwitchItem)super.findViewById(2131363330));
    this.l = ((FormSwitchItem)super.findViewById(2131363329));
    this.jdField_b_of_type_AndroidViewView = super.findViewById(2131363309);
    this.jdField_e_of_type_AndroidViewView = super.findViewById(2131363310);
    this.jdField_a_of_type_AndroidViewView = super.findViewById(2131363308);
    this.jdField_a_of_type_AndroidViewView.setVisibility(8);
    this.m = ((FormSwitchItem)super.findViewById(2131363316));
    this.n = ((FormSwitchItem)super.findViewById(2131363317));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131363318));
    this.o = ((FormSwitchItem)super.findViewById(2131363331));
    this.p = ((FormSwitchItem)super.findViewById(2131363334));
    this.r = ((FormSwitchItem)super.findViewById(2131363319));
    this.jdField_f_of_type_AndroidViewView = super.findViewById(2131363335);
    this.t = ((FormSwitchItem)super.findViewById(2131363332));
    Object localObject = this.app.getApp().getSharedPreferences("sticker_pref", 0);
    this.u = ((FormSwitchItem)super.findViewById(2131363336));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131363337));
    this.v = ((FormSwitchItem)super.findViewById(2131363340));
    this.jdField_f_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131363341));
    this.q = ((FormSwitchItem)findViewById(2131363338));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131363339));
    this.q.setVisibility(0);
    this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
    this.s = ((FormSwitchItem)findViewById(2131363342));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131363343));
    String str;
    label603:
    label619:
    label633:
    ...
    if (EmojiStickerManager.a())
    {
      ...
      this.t.setOnCheckedChangeListener(new ric(this, (SharedPreferences)localObject, str));
      ...
      this.jdField_b_of_type_ComTencentMobileqqWidgetFormSwitchItem = ((FormSwitchItem)findViewById(2131363322));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131363323));
      if (QFindBLEScanMgr.a()) {
        break label2166;
      }
      this.jdField_b_of_type_ComTencentMobileqqWidgetFormSwitchItem.setVisibility(8);
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
      bool1 = SettingCloneUtil.readValue(this, null, super.getString(2131433564), "qqsetting_screenshot_key", false);
      this.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem.setChecked(bool1);
      this.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem.setOnCheckedChangeListener(new riy(this));
      if (this.jdField_c_of_type_AndroidViewView != null) {
        this.jdField_c_of_type_AndroidViewView.setOnClickListener(new riz(this));
      }
      if (this.jdField_d_of_type_AndroidViewView != null) {
        this.jdField_d_of_type_AndroidViewView.setOnClickListener(new rja(this));
      }
      bool1 = SettingCloneUtil.readValue(this, null, getString(2131433555), "qqsetting_auto_receive_pic_key", true);
      this.jdField_c_of_type_ComTencentMobileqqWidgetFormSwitchItem.setChecked(bool1);
      this.jdField_c_of_type_ComTencentMobileqqWidgetFormSwitchItem.setOnCheckedChangeListener(new rjb(this));
      bool1 = SettingCloneUtil.readValue(this, null, getString(2131433555), "qqsetting_auto_receive_magic_face_key", true);
      this.jdField_d_of_type_ComTencentMobileqqWidgetFormSwitchItem.setChecked(bool1);
      this.jdField_d_of_type_ComTencentMobileqqWidgetFormSwitchItem.setOnCheckedChangeListener(new rjc(this));
      bool1 = SettingCloneUtil.readValue(this, null, getString(2131433609), "qqsetting_enter_sendmsg_key", false);
      this.jdField_e_of_type_ComTencentMobileqqWidgetFormSwitchItem.setChecked(bool1);
      this.jdField_e_of_type_ComTencentMobileqqWidgetFormSwitchItem.setOnCheckedChangeListener(new rjd(this));
      bool1 = SettingCloneUtil.readValue(this, null, null, "qqsetting_clear_memory_key", true);
      this.j.setChecked(bool1);
      this.j.setOnCheckedChangeListener(new rje(this));
      bool1 = ConfigHandler.a(this.app, false);
      this.jdField_f_of_type_ComTencentMobileqqWidgetFormSwitchItem.setChecked(bool1);
      this.jdField_f_of_type_ComTencentMobileqqWidgetFormSwitchItem.setOnCheckedChangeListener(new rid(this));
      bool1 = SettingCloneUtil.readValue(this, null, getString(2131436003), "qqsetting_notify_icon_key", false);
      this.g.setChecked(bool1);
      this.g.setOnCheckedChangeListener(new rie(this));
      b();
      this.k.setChecked(this.app.a().jdField_a_of_type_Boolean);
      this.k.setText(getText(2131434084));
      this.k.setContentDescription("在底部栏展示日迹功能");
      this.k.setOnCheckedChangeListener(new rif(this));
      this.k.setBackgroundResource(2130838619);
      ...
      if (localPstnManager.a() == 1)
      {
        ...
        localObject = this.app.getApplication().getResources().getString(2131438392);
        ...
        this.m.setOnCheckedChangeListener(new rig(this, localPstnManager));
        if (localPstnManager.d() == 1)
        {
          this.n.setVisibility(0);
          localObject = this.app.getApplication().getResources().getString(2131438395);
          ...
          this.n.setOnCheckedChangeListener(new rih(this, localPstnManager));
        }
      }
      ...
      if ((localObject != null) && (((FlashChatManager)localObject).c()))
      {
        ...
        this.p.setOnCheckedChangeListener(new rij(this));
      }
      bool1 = ReadInJoyHelper.f();
      if (!bool1) {
        break label2309;
      }
      this.jdField_b_of_type_AndroidWidgetTextView.setText(2131433537);
      label1431:
      this.q.setChecked(bool1);
      this.q.setOnCheckedChangeListener(new rik(this));
      this.jdField_a_of_type_AndroidViewView.setOnClickListener(new ril(this));
      this.jdField_b_of_type_AndroidViewView.setOnClickListener(new rim(this));
      this.jdField_e_of_type_AndroidViewView.setOnClickListener(new rio(this));
      if (SharedPreUtils.al(getApplication(), this.app.getCurrentAccountUin()) == 1)
      {
        this.r.setVisibility(0);
        findViewById(2131363320).setVisibility(0);
        ...
        ThreadManager.post(new rip(this), 5, null, true);
      ...
      if ((localObject != null) && (((ArrayList)localObject).size() > 0))
      {
        ...
        this.jdField_f_of_type_AndroidViewView.setOnClickListener(new riq(this, (ArrayList)localObject));
      }
      ...
      this.u.setOnCheckedChangeListener(new rir(this, (DoutuManager)localObject));
      label1704:
      ...
      this.v.setChecked(bool1);
      this.v.setOnCheckedChangeListener(new ris(this));
      label1785:
      ...
      this.s.setOnCheckedChangeListener(new rit(this, (NowEnterManager)localObject));
    }
    for (;;)
    {
      if (AppSetting.b)
      {
        ...
        this.jdField_d_of_type_ComTencentMobileqqWidgetFormSwitchItem.setContentDescription(getString(2131434043));
        this.r.setContentDescription(getString(2131434051));
        this.jdField_f_of_type_AndroidViewView.setContentDescription(getString(2131438800));
        this.q.setContentDescription(getString(2131439067));
        this.v.setContentDescription("智能匹配图片");
        this.s.setContentDescription(getString(2131439162));
      }
      return;
      this.t.setVisibility(8);
      super.findViewById(2131363333).setVisibility(8);
      break;
      label2083:
      ...
      for (bool1 = true;; bool1 = false)
      {
        ...
        this.jdField_b_of_type_ComTencentMobileqqWidgetFormSwitchItem.setOnCheckedChangeListener(new rin(this));
        break;
      }
      label2237:
      ...
      this.o.setOnCheckedChangeListener(new rii(this));
      break label1352;
      label2309:
      this.jdField_b_of_type_AndroidWidgetTextView.setText(2131433536);
      break label1431;
      label2322:
  ...
  private void a(boolean paramBoolean)
  {
    try
    {
      ...
      {
        QQToast.a(this, 2131438159, 100).a();
  ...
  private void b()
  {
    ...
    if ((((MsgTabStoryNodeConfigManager)localObject).b) && (((MsgTabStoryNodeConfigManager)localObject).c))
    {
      ...
      this.l.setOnCheckedChangeListener(new rix(this, (MsgTabStoryNodeConfigManager)localObject));
  ...
  public void onCheckedChanged(CompoundButton paramCompoundButton, boolean paramBoolean)
  {
    ...
    if (paramCompoundButton == this.r.a())
    {
      ...
      {
        QQToast.a(getApplicationContext(), 2131436049, 1).a();
        if (paramBoolean) {
          break label73;
        }
        bool1 = true;
  ...
  {
    return super.getString(2131433562);
  }
