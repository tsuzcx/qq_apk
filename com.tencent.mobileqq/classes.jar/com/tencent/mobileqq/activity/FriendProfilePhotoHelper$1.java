...
public class FriendProfilePhotoHelper$1
  implements Runnable
{
  public FriendProfilePhotoHelper$1(abgw paramabgw) {}
  
  public void run()
  {
    try
    {
      Object localObject1 = (ajxl)this.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
      Object localObject2 = ((ajxl)localObject1).b(this.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
