...
{
  amua jdField_a_of_type_Amua = new admt(this);
  ...
  private void a()
  {
    try
    {
      if ((this.jdField_a_of_type_Bhht == null) && (!isFinishing()))
      {
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    setTitle(amtj.a(2131704657));
    setRightButton(2131693307, this);
    setLeftViewName(2131690424);
    this.jdField_a_of_type_ComTencentMobileqqFreshnewsBlockableEditTextView = ((BlockableEditTextView)super.findViewById(2131362702));
    this.jdField_a_of_type_ComTencentMobileqqFreshnewsBlockableEditTextView.addTextChangedListener(new admu(this));
    this.jdField_b_of_type_ComTencentMobileqqFreshnewsBlockableEditTextView = ((BlockableEditTextView)super.findViewById(2131369998));
    this.jdField_b_of_type_ComTencentMobileqqFreshnewsBlockableEditTextView.addTextChangedListener(new admv(this));
    this.jdField_b_of_type_AndroidViewView = super.findViewById(2131380916);
    this.jdField_b_of_type_AndroidViewView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131369877));
    this.jdField_a_of_type_AndroidViewView = super.findViewById(2131370008);
  ...
  public void onClick(View paramView)
  {
    ...
    if (paramView == this.rightViewText)
    {
      if (!NetworkUtil.isNetSupport(this)) {
        QQToast.a(this, 0, 2131692035, 0).b(getTitleBarHeight());
      }
      for (;;)
      {
        ...
        {
          QQToast.a(this, 0, amtj.a(2131704662), 0).b(getTitleBarHeight());
        }
        else
        {
          ...
          QQToast.a(this, 0, amtj.a(2131704656), 0).b(getTitleBarHeight());
        }
      }
    ...
    for (;;)
    {
      ...
      {
        QQToast.a(this, 0, amtj.a(2131704664), 0).b(getTitleBarHeight());
        break;
      }
      amtp localamtp = (amtp)this.app.getBusinessHandler(35);
      ...
      bcef.b(this.app, "CliOper", "", "", "0X8005D54", "0X8005D54", 0, 0, "", "", "", "");
      if (localHotChatInfo.userCreate == 1) {}
      for (boolean bool = localamtp.a(localHotChatInfo.troopUin, (String)localObject2);; bool = localamtp.a(localHotChatInfo.uuid.getBytes(), (String)localObject2, (String)localObject1))
      {
        ...
        b();
        QQToast.a(this, 0, amtj.a(2131704660), 0).b(getTitleBarHeight());
        break;
      }
