  ...
  implements View.OnClickListener
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramInt > 0) {
      ...
      {
        paramView = ((LayoutInflater)this.a.getSystemService("layout_inflater")).inflate(2131560014, paramViewGroup, false);
        localObject1 = new TroopGagActivity.TroopGagMemberAdapter.ViewHolder(this, null);
        ((TroopGagActivity.TroopGagMemberAdapter.ViewHolder)localObject1).c = ((ImageView)paramView.findViewById(2131361796));
        ((TroopGagActivity.TroopGagMemberAdapter.ViewHolder)localObject1).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131372288));
        ((TroopGagActivity.TroopGagMemberAdapter.ViewHolder)localObject1).b = ((TextView)paramView.findViewById(2131367674));
        ((TroopGagActivity.TroopGagMemberAdapter.ViewHolder)localObject1).jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131378151));
        ...
        if ((!TroopGagActivity.a(this.a, this.a.app.getCurrentAccountUin())) && ((TroopGagActivity.b(this.a, ((TroopGagActivity.GagMemInfo)localObject2).jdField_a_of_type_JavaLangString)) || (TroopGagActivity.a(this.a, ((TroopGagActivity.GagMemInfo)localObject2).jdField_a_of_type_JavaLangString)))) {
  ...
  public void onClick(View paramView)
  {
    ...
    if (!(localObject instanceof TroopGagActivity.GagMemInfo)) {}
    for (;;)
    {
      EventCollector.getInstance().onViewClicked(paramView);
      return;
      localObject = (TroopGagActivity.GagMemInfo)localObject;
      String str = ((TroopGagActivity.GagMemInfo)localObject).jdField_a_of_type_JavaLangString;
      TroopGagMgr localTroopGagMgr = (TroopGagMgr)this.a.app.getManager(QQManagerFactory.TROOP_GAG_MANAGER);
