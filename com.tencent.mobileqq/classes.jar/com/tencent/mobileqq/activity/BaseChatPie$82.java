...
public class BaseChatPie$82
  implements Runnable
{
  BaseChatPie$82(BaseChatPie paramBaseChatPie, Activity paramActivity) {}
  
  public void run()
  {
    BaseChatPie.b(this.this$0, new View(this.a));
    BaseChatPie.b(this.this$0).setOnTouchListener(new aanj(this));
    ...
    localAnimationSet.setAnimationListener(new aank(this));
