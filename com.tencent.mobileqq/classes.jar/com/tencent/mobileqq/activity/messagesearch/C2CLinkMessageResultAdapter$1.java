...
public class C2CLinkMessageResultAdapter$1
  implements Runnable
{
  public C2CLinkMessageResultAdapter$1(aige paramaige, String paramString, int paramInt, long paramLong) {}
    ...
    for (;;)
    {
      synchronized (this.this$0.jdField_a_of_type_JavaLangObject)
      {
        if (this.this$0.jdField_a_of_type_JavaLangString.equals(this.jdField_a_of_type_JavaLangString))
        {
          ...
          localaige = this.this$0;
          if (((ArrayList)localObject2).size() < 20)
          {
            localaige.jdField_a_of_type_Boolean = bool;
