...
public class C2CMessageResultAdapter$1
  implements Runnable
{
  public C2CMessageResultAdapter$1(agdt paramagdt, String paramString, long paramLong, List paramList) {}
  ...
  public void run()
  {
    ...
    this.this$0.jdField_a_of_type_Bfnk.obtainMessage(6, localObject).sendToTarget();
  }
}
