...
public class C2CMessageResultAdapter$1
  implements Runnable
{
  public C2CMessageResultAdapter$1(ajgo paramajgo, String paramString, long paramLong, List paramList) {}
  ...
  public void run()
  {
    ...
    if ((localObject != null) && (((ChatHistorySearchData)localObject).mSearchData1 != null) && (!((ChatHistorySearchData)localObject).mSearchData1.isEmpty()))
    {
      ...
      while (i < ((ChatHistorySearchData)localObject).mSearchData1.size())
      {
        ...
        if (this.this$0.a(localMessageRecord)) {
          this.this$0.jdField_a_of_type_JavaUtilList.add(new ajhk(this.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord));
        }
        i += 1;
      }
    }
    ...
    this.this$0.jdField_a_of_type_Bjmp.obtainMessage(6, localObject).sendToTarget();
  }
}
