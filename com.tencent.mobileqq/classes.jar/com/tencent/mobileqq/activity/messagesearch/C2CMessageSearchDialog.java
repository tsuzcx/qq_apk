  ...
  extends BaseMessageSearchDialog
{
  ...
  private void g()
  {
    ((ImageButton)findViewById(2131368600)).setOnClickListener(new C2CMessageSearchDialog.2(this));
  ...
  protected void a()
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_b_of_type_Boolean) {
        a(3, this.jdField_a_of_type_AndroidContentContext.getString(2131718905));
      } else {
        a(0, null);
      }
    }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      {
        this.jdField_c_of_type_AndroidWidgetTextView.setText(HardCodeUtil.a(2131701362));
      ...
      if ((l == this.jdField_a_of_type_Long) && (this.jdField_a_of_type_JavaLangString.equals(localObject1)))
      {
        ...
        if ((this.jdField_a_of_type_Long == l) && (this.jdField_a_of_type_JavaLangString.equals(localObject1)))
        {
          ...
          if ((l == this.jdField_a_of_type_Long) && (this.jdField_a_of_type_JavaLangString.equals(localObject1)))
          {
            ...
            {
              this.jdField_c_of_type_AndroidWidgetTextView.setText(HardCodeUtil.a(2131701364));
              this.jdField_c_of_type_AndroidWidgetLinearLayout.findViewById(2131373546).setVisibility(8);
              this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(0);
              this.jdField_b_of_type_AndroidViewView.setVisibility(0);
            }
