...
public class MessageItem
{
  ...
  public static String a(CharSequence paramCharSequence)
  {
    ...
    if (i < paramCharSequence.length())
    {
      ...
      {
        j = i;
        if (paramCharSequence.charAt(i + 1) < EmotcationConstants.jdField_a_of_type_Int)
        {
      ...
      for (;;)
      {
        ...
        break;
        j = i;
        if (EmotcationConstants.jdField_a_of_type_AndroidUtilSparseIntArray.get(m, -1) >= 0) {
          if ((m > 65535) && (k >= i + 2))
          {
            paramCharSequence.replace(i, i + 2, "\001\001");
            j = i;
  ...
  public SpannableString a(String paramString)
  {
    ...
    if (i > 20)
    {
      ...
      {
        i = j;
        if (EmotcationConstants.jdField_a_of_type_AndroidUtilSparseIntArray.get(k, -1) >= 0)
        {
          i = j;
          if (k <= 65535) {}
        }
