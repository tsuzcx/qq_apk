...
class TroopAllMessageSearchDialog$1
  implements TextWatcher
{
  TroopAllMessageSearchDialog$1(TroopAllMessageSearchDialog paramTroopAllMessageSearchDialog) {}
  ...
  public void afterTextChanged(Editable paramEditable)
  {
    ...
    if (paramEditable.length() == 0)
    {
      ...
      this.a.jdField_a_of_type_ComTencentMobileqqActivityHistoryLinkSearchTroopAllMessageResultAdapter.a();
    ...
    if (!this.a.jdField_b_of_type_JavaLangString.equals(paramEditable))
    {
      ...
      ((TroopAllMessageSearchDialog)localObject).jdField_b_of_type_JavaLangString = paramEditable;
      ((TroopAllMessageSearchDialog)localObject).findViewById(2131368340).setVisibility(0);
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.messagesearch.TroopAllMessageSearchDialog.1
