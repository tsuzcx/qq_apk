...
public class BaseMessageSearchDialog$1
  implements Runnable
{
  public BaseMessageSearchDialog$1(aibn paramaibn, View paramView, Activity paramActivity) {}
  
  public void run()
  {
    int[] arrayOfInt = new int[2];
    this.jdField_a_of_type_AndroidViewView.getLocationOnScreen(arrayOfInt);
    int i = bngs.b(this.jdField_a_of_type_AndroidAppActivity);
    ...
    aekt.a(this.this$0.findViewById(2131365849));
  }
}
