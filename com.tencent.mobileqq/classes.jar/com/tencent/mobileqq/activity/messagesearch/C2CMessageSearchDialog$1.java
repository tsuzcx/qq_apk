  ...
  implements TextWatcher
{
  ...
  public void afterTextChanged(Editable paramEditable)
  {
    ...
    if (!this.a.jdField_b_of_type_JavaLangString.equals(paramEditable))
    {
      ...
      ((C2CMessageSearchDialog)localObject).jdField_b_of_type_JavaLangString = paramEditable;
      ((C2CMessageSearchDialog)localObject).findViewById(2131368340).setVisibility(0);
