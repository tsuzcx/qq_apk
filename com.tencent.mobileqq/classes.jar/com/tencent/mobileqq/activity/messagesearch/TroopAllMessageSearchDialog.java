  ...
  extends BaseMessageSearchDialog
{
  ...
  private View.OnClickListener F = new TroopAllMessageSearchDialog.4(this);
  boolean m = false;
  int n = 0;
  public TroopAllMessageResultAdapter o;
  View p;
  LinearLayout q;
  TextView r;
  LinearLayout s;
  ...
  private void g()
  {
    ...
    this.d.addTextChangedListener(new TroopAllMessageSearchDialog.1(this));
  ...
  private void i()
  {
    ((ImageButton)findViewById(2131435215)).setOnClickListener(new TroopAllMessageSearchDialog.2(this));
  ...
  private void j()
  {
    ...
    this.o = new TroopAllMessageResultAdapter(this.c, this.a, this.g, this.f);
    this.b.setAdapter(this.o);
    this.b.setOnScrollListener(new TroopAllMessageSearchDialog.5(this));
    this.b.setOnTouchListener(new TroopAllMessageSearchDialog.6(this));
    this.b.setOnItemClickListener(new TroopAllMessageSearchDialog.7(this));
    this.b.setOnItemLongClickListener(new TroopAllMessageSearchDialog.8(this));
  }
        ...
        for (;;)
        {
          ...
          if ((this.m) && (this.B == l) && (!TextUtils.isEmpty(paramMessage)) && (paramMessage.equals(this.z)))
          {
            if ((l == this.B) && (this.z.equals(paramMessage)))
            {
              ...
              {
                this.w.setText(HardCodeUtil.a(2131912460));
          ...
          else
          {
            ...
            else
            {
              ...
              {
                this.w.setText(HardCodeUtil.a(2131912458));
                this.v.findViewById(2131440727).setVisibility(8);
                this.v.setVisibility(0);
                this.u.setVisibility(0);
