  ...
  implements AdapterView.OnItemClickListener
{
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    if ((this.a.jdField_a_of_type_ComTencentMobileqqActivityHistoryLinkSearchLinkMessageResultAdapter.getCount() <= 0) || (paramInt <= 0)) {}
    do
    {
      return;
    ...
    try
    {
      paramAdapterView = GroupUtil.a(this.a.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.msgData);
