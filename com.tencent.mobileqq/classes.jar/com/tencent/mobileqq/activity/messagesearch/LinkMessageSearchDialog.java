  ...
  extends BaseMessageSearchDialog
{
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.setHint(this.jdField_a_of_type_AndroidContentContext.getString(2131690801));
  ...
  private void g()
  {
    ((ImageButton)findViewById(2131368340)).setOnClickListener(new LinkMessageSearchDialog.2(this));
        ...
        for (;;)
        {
          ...
          if ((this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Long == l) && (!TextUtils.isEmpty(paramMessage)) && (paramMessage.equals(this.jdField_a_of_type_JavaLangString)))
          {
            if ((l == this.jdField_a_of_type_Long) && (this.jdField_a_of_type_JavaLangString.equals(paramMessage)))
            {
              ...
              {
                this.jdField_c_of_type_AndroidWidgetTextView.setText(HardCodeUtil.a(2131706195));
          ...
          else
          {
            ...
            if ((!TextUtils.isEmpty(paramMessage)) && (this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Long == l) && (this.jdField_a_of_type_JavaLangString.equals(paramMessage)))
            {
              if ((l == this.jdField_a_of_type_Long) && (this.jdField_a_of_type_JavaLangString.equals(paramMessage)))
              {
                ...
                this.jdField_b_of_type_AndroidViewView.setVisibility(8);
                this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(8);
                this.jdField_a_of_type_ComTencentMobileqqActivityHistoryLinkSearchLinkMessageResultAdapter.a((List)localObject1, this.jdField_d_of_type_Boolean);
                this.jdField_a_of_type_ComTencentMobileqqActivityHistoryLinkSearchLinkMessageResultAdapter.notifyDataSetChanged();
                this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryLinkSearchLinkMessageResultAdapter);
                this.jdField_a_of_type_ComTencentWidgetXListView.setSelection(0);
                this.jdField_a_of_type_JavaUtilList.clear();
            ...
            else
            {
              ...
              {
                this.jdField_c_of_type_AndroidWidgetTextView.setText(HardCodeUtil.a(2131706194));
                this.jdField_c_of_type_AndroidWidgetLinearLayout.findViewById(2131373124).setVisibility(8);
                this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(0);
                this.jdField_b_of_type_AndroidViewView.setVisibility(0);
