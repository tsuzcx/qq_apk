    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.e("UserGuide", 2, "pkg build num is 3525, local build num is " + str);
        }
        if (!"3525".equals(str))
        {
          ...
          if (TextUtils.isEmpty(str))
          {
            ...
            paramSplashActivity.putString("qq_version", "3525");
            paramSplashActivity.commit();
          }
        }
        else
        {
          QLog.e("UserGuide", 1, "showUserGuide " + a + ", " + str + ", " + "3525");
          return false;
        }
      }
