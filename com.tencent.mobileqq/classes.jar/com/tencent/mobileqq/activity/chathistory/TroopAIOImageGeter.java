...
public class TroopAIOImageGeter
{
  ...
  aers jdField_a_of_type_Aers;
  aert jdField_a_of_type_Aert;
  ...
  private List<AIORichMediaData> a(QQAppInterface paramQQAppInterface, List<MessageRecord> paramList)
  {
    ...
    if (k < paramList.size())
    {
      ...
      for (;;)
      {
        k += 1;
        break;
        if ((!ajke.a((MessageRecord)localObject1)) && (!ajhz.a((MessageRecord)localObject1)) && (!adkt.a((MessageForPic)localObject1)))
        {
              ...
              if (localawwr != null)
              {
                ...
                for (;;)
                {
                  ...
                  if ((localStructMsgForImageShare.mMsgActionData != null) && (localStructMsgForImageShare.mMsgActionData.startsWith("ScreenShotShare")))
                  {
                    ...
                    ((AIOImageData)localObject2).a = localStructMsgForImageShare.getBytes();
                    if ((bado.b(((MessageRecord)localObject3).issend)) && (!TextUtils.isEmpty(((MessageForPic)localObject1).path)) && (new File(((MessageForPic)localObject1).path).exists())) {
    ...
    for (;;)
    {
      ...
      if ((localObject3 instanceof MessageForTroopFile))
      {
        ...
        for (j = 1;; j = 0)
        {
          ...
          localArrayList1.add(adwz.a((MessageForTroopFile)localObject1, paramQQAppInterface));
          localArrayList2.add(localObject1);
          break;
          i = 0;
          break label1076;
        ...
        label1127:
        if ((j == 0) || (!apdq.a(paramQQAppInterface))) {
          break;
        }
        localArrayList1.add(adwz.a((ChatMessage)localObject1, paramQQAppInterface));
        localArrayList2.add(localObject1);
        break;
      }
      if (!QLog.isColorLevel()) {
  ...
  public void a()
  {
    Object localObject = this.jdField_a_of_type_Aers;
    if (localObject != null) {
      ((aers)localObject).a(null, -1);
    }
    localObject = this.jdField_a_of_type_Aert;
    if (localObject != null) {
      ((aert)localObject).a(null, -1);
    }
  }
  
  public void a(int paramInt)
  {
    if ((this.jdField_a_of_type_Aers == null) && (this.jdField_a_of_type_Aert == null)) {
      a();
    }
    do
    {
      ...
      default: 
        return;
      case 0: 
        this.jdField_a_of_type_Befq.post(new TroopAIOImageGeter.IncreasinglyLoadMediaTask(this));
        return;
      }
    } while (this.jdField_a_of_type_Aers == null);
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Aers.a((AIORichMediaData[])???, -1);
      return;
      this.jdField_a_of_type_Befq.post(new TroopAIOImageGeter.IncreasinglyLoadMediaTask(this));
      return;
      if (this.jdField_a_of_type_Aert == null) {
        break;
      }
      if (this.jdField_a_of_type_JavaUtilList.size() > 0) {
        synchronized (this.jdField_a_of_type_JavaUtilList)
        {
          ...
          this.jdField_a_of_type_Aert.a(arrayOfAIORichMediaData, -1);
          return;
        }
      }
      this.jdField_a_of_type_Befq.post(new TroopAIOImageGeter.IncreasinglyLoadMediaTask(this));
  ...
  public void a(aers paramaers)
  {
    this.jdField_a_of_type_Aers = paramaers;
  }
