  ...
  implements View.OnClickListener
{
  ...
  public TroopLowCreditLevelNotifyActivity()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppTroopObserver = new tvx(this);
  }
  ...
  private String a(String paramString, long paramLong)
  {
    ...
    for (;;)
    {
      paramString = paramString.replace("$GCODE$", this.jdField_a_of_type_JavaLangString).replace("$CLIENTVER$", "android7.6.0").replace("$UIN$", str).replace("$LANG$", "zh_CN").replace("$GROUPAPPID$", Long.toString(paramLong)).replace("$ROLE$", (CharSequence)localObject).replace("$ENTERSOURCE$", "1");
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131363844));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131363667));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131364607));
    this.c = ((TextView)findViewById(2131375127));
    this.d = ((TextView)findViewById(2131375128));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131366320));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)findViewById(2131375129));
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
    setTitle(2131430661);
    this.c.setText(2131430662);
    this.d.setText(2131430663);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_b_of_type_JavaLangString);
    this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_JavaLangString);
    a(2131430664, 2131430670, this.jdField_a_of_type_ArrayOfBoolean[0], 0);
    a(2131430665, 2131430670, this.jdField_a_of_type_ArrayOfBoolean[1], 1);
    a(2131430666, 2131430669, this.jdField_a_of_type_ArrayOfBoolean[2], 2);
    a(2131430667, 2131430668, this.jdField_a_of_type_ArrayOfBoolean[3], 3);
  ...
  public void a()
  {
    ...
    for (;;)
    {
      ...
      if ((i == 0) && (j == 0))
      {
        localObject = DialogUtil.a(this.jdField_a_of_type_AndroidContentContext, 230).setTitle(getString(2131434764)).setMessage("错误，仅群主和管理员能访问");
        ((QQCustomDialog)localObject).setPositiveButton(2131430676, new tvw(this));
  ...
  {
    View localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130971623, null);
    TextView localTextView1 = (TextView)localView.findViewById(2131365299);
    TextView localTextView2 = (TextView)localView.findViewById(2131375126);
    TextView localTextView3 = (TextView)localView.findViewById(2131369133);
  ...
  protected void c()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.c(2131430678);
  ...
  protected void doOnActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    for (;;)
    {
      if (paramInt1 >= 0)
      {
        this.jdField_a_of_type_ArrayOfAndroidViewView[paramInt1].findViewById(2131369133).setVisibility(0);
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    super.setContentView(2130971624);
    e();
