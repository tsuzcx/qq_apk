  ...
  implements Runnable
{
  ...
  public void run()
  {
    try
    {
      ...
      i = banb.a((QQAppInterface)localObject1, str, 1, (StringBuilder)localObject2);
    ...
    catch (IllegalStateException localIllegalStateException)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          ajey.a((QQAppInterface)localObject1, "chat_history_confirm_del_msg");
        ...
        asfd.a().b(localException, (QQAppInterface)localObject1);
        continue;
        if (QLog.isColorLevel())
        {
