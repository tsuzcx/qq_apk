  ...
  extends VasWebviewJsPlugin
{
  ...
  private void a(String paramString, List paramList)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localJSONObject3.put("id", localycc.jdField_a_of_type_Int);
        localJSONObject3.put("soundName", localycc.jdField_a_of_type_JavaLangString);
        localJSONObject3.put("type", localycc.jdField_b_of_type_Int);
        localJSONObject3.put("soundVersion", localycc.jdField_b_of_type_JavaLangString);
        localJSONObject3.put("soundUrl", localycc.jdField_c_of_type_JavaLangString);
        localJSONObject3.put("whiteList", localycc.jdField_d_of_type_JavaLangString);
        localJSONObject3.put("isShow", localycc.jdField_c_of_type_Int);
        localJSONObject3.put("backgroundUrl", localycc.jdField_e_of_type_JavaLangString);
        localJSONObject3.put("access", localycc.f);
        localJSONObject3.put("useNum", localycc.jdField_d_of_type_Int);
        localJSONObject3.put("classify", localycc.jdField_e_of_type_Int);
        localJSONObject3.put("classifyName", localycc.g);
        localJSONObject3.put("limitFreeStart", localycc.h);
        localJSONObject3.put("limitFreeEnd", localycc.i);
        if ((localycc.jdField_c_of_type_JavaLangString != null) && (!TextUtils.isEmpty(localycc.jdField_c_of_type_JavaLangString)) && (f(localycc.jdField_c_of_type_JavaLangString)))
        {
          localJSONObject3.put("isDownload", true);
          localJSONObject2.put(String.valueOf(localycc.jdField_a_of_type_Int), localJSONObject3);
        }
        else
        {
  ...
  private boolean a(String paramString)
  {
    ...
    if (!this.jdField_a_of_type_ComTencentMobileqqActivitySpecialcareQvipSpecialSoundManager.a()) {
      this.jdField_a_of_type_ComTencentMobileqqActivitySpecialcareQvipSpecialSoundManager.a(new ydf(this, paramString));
    }
    for (;;)
    {
      return true;
  ...
  private boolean a(String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      ...
      return true;
      ydj localydj = new ydj(this);
      localydj.jdField_a_of_type_JavaLangString = paramString3;
      localydj.jdField_b_of_type_JavaLangString = paramString1;
      paramString3 = new ydh(this, localydj, paramString3);
      ThreadManager.post(localydj, 5, null, true);
  ...
  private void b(String paramString)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivitySpecialcareQvipSpecialSoundManager.a(new ydg(this, paramString));
  }
  ...
  private boolean b(String paramString1, String paramString2, String paramString3)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqUtilsMediaPlayerHelper.a(new ydi(this, paramString1, paramString2));
