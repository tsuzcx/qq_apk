...
public class QQSpecialFriendSettingActivity
  ...
  implements View.OnClickListener, CompoundButton.OnCheckedChangeListener, azwh
{
  private int jdField_a_of_type_Int;
  private ajjh jdField_a_of_type_Ajjh = new ahwh(this);
  private ajjj jdField_a_of_type_Ajjj;
  private ajqr jdField_a_of_type_Ajqr = new ahwi(this);
  ...
  {
    this.jdField_a_of_type_AndroidOsHandler = new ahwg(this);
  }
  
  private void a()
  {
    this.jdField_a_of_type_ComTencentMobileqqWidgetFormSimpleItem = ((FormSimpleItem)findViewById(2131305705));
    this.jdField_a_of_type_ComTencentMobileqqWidgetFormSimpleItem.setOnClickListener(this);
    this.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem = ((FormSwitchItem)findViewById(2131301194));
    this.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem.setVisibility(8);
    this.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem.setOnCheckedChangeListener(this);
    this.jdField_b_of_type_ComTencentMobileqqWidgetFormSwitchItem = ((FormSwitchItem)findViewById(2131301209));
    this.jdField_b_of_type_ComTencentMobileqqWidgetFormSwitchItem.setOnCheckedChangeListener(this);
    this.jdField_a_of_type_AndroidViewView = findViewById(2131308571);
    this.jdField_b_of_type_AndroidViewView = findViewById(2131298299);
    this.jdField_b_of_type_AndroidViewView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131300281));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131305159));
    if (this.jdField_a_of_type_Boolean)
    {
      setLeftViewName(2131624088);
      setRightButton(2131626982, new ahwd(this));
    ...
    for (;;)
    {
      if (AppSetting.c)
      {
        this.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem.setContentDescription(getString(2131633724));
        this.jdField_b_of_type_ComTencentMobileqqWidgetFormSwitchItem.setContentDescription(getString(2131633725));
      }
      return;
      setLeftViewName(2131628432);
    }
  }
  ...
  private void b()
  {
    ...
    Object localObject = this.jdField_a_of_type_Azwg.a(1, this.jdField_a_of_type_JavaLangString, 0);
    if (localObject == null)
    {
      if (!this.jdField_a_of_type_Azwg.a()) {
        this.jdField_a_of_type_Azwg.a(this.jdField_a_of_type_JavaLangString, 1, true);
      }
      this.jdField_a_of_type_AndroidWidgetImageView.setBackgroundDrawable((BitmapDrawable)bacm.a());
    }
    for (;;)
    {
      localObject = this.jdField_a_of_type_Ajjj.b(this.jdField_a_of_type_JavaLangString);
      if (localObject != null) {
        break;
      }
  ...
  {
    boolean bool2 = true;
    this.jdField_a_of_type_ComTencentMobileqqDataSpecialCareInfo = this.jdField_a_of_type_Ajjj.a(this.jdField_a_of_type_JavaLangString);
    if (QLog.isColorLevel()) {
  ...
  private void d()
  {
    ...
    startTitleProgress();
    this.jdField_a_of_type_ComTencentMobileqqActivitySpecialcareQvipSpecialSoundManager.a(new ahwf(this));
  }
  ...
  private void e()
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_Int = baho.a(BaseApplicationImpl.getContext(), "com.tencent.mobileqq_preferences").getInt("special_care_id_cache" + this.jdField_a_of_type_JavaLangString, 1);
      ...
      for (str1 = getString(2131629027);; str1 = str2)
      {
    ...
    if (ahwj.a(this.jdField_a_of_type_JavaLangString, this.app))
    {
      if (!this.jdField_a_of_type_ComTencentMobileqqActivitySpecialcareQvipSpecialSoundManager.a()) {
        d();
      }
      int i = ahwj.a(this.jdField_a_of_type_JavaLangString, this.app);
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetFormSimpleItem.setRightText(getString(2131629027));
  }
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    this.app.addObserver(this.jdField_a_of_type_Ajqr);
    b();
    awqx.b(null, "CliOper", "", "", "0X80050E5", "0X80050E5", 0, 0, "0", "", "", "");
    if (QLog.isColorLevel()) {
  ...
  public void doOnDestroy()
  {
    ...
    if (this.app != null)
    {
      this.app.removeObserver(this.jdField_a_of_type_Ajqr);
      this.app.removeObserver(this.jdField_a_of_type_Ajjh);
    }
    if (this.jdField_a_of_type_Boolean) {
      baho.a(BaseApplicationImpl.getContext(), "com.tencent.mobileqq_preferences").edit().remove("special_care_id_cache" + this.jdField_a_of_type_JavaLangString).commit();
    }
  }
  ...
  public void doOnResume()
  {
    ...
    if (this.c)
    {
      ...
      localIntent.putExtra("selfSet_leftViewText", getString(2131629851));
  ...
  public void onCheckedChanged(CompoundButton paramCompoundButton, boolean paramBoolean)
  {
    ...
    ((Message)localObject).arg2 = 2131626719;
  ...
  public void onClick(View paramView)
  {
    ...
    paramView.putExtra("url", bant.a("specialCareRingUrl") + "&suin=" + this.jdField_a_of_type_JavaLangString + "&uin=" + this.app.getCurrentAccountUin() + "&_bid=279&lazy=" + this.jdField_a_of_type_Boolean);
    ...
    if (badq.g(this))
    {
      ...
      paramView.obj = getString(2131633714);
      this.jdField_a_of_type_AndroidOsHandler.sendMessage(paramView);
    }
    for (;;)
    {
      awqx.b(null, "CliOper", "", "", "0X80050E6", "0X80050E6", 0, 0, "0", "", "", "");
      return;
