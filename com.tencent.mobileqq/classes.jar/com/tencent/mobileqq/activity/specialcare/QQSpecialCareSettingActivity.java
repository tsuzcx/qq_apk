...
public class QQSpecialCareSettingActivity
  ...
  implements alrp, View.OnClickListener, CompoundButton.OnCheckedChangeListener
{
  private int jdField_a_of_type_Int;
  private ajjh jdField_a_of_type_Ajjh = new ahwb(this);
  private ajjj jdField_a_of_type_Ajjj;
  private ajqr jdField_a_of_type_Ajqr = new ahwc(this);
  ...
  {
    this.jdField_a_of_type_AndroidOsHandler = new ahvz(this);
  }
  ...
  private void a()
  {
    ...
    {
      if (!this.jdField_a_of_type_Ajjj.e())
      {
  ...
  private void a(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      this.jdField_a_of_type_ComTencentMobileqqWidgetFormSimpleItem.setLeftText(getString(2131653837));
      return;
    }
    this.jdField_a_of_type_ComTencentMobileqqWidgetFormSimpleItem.setLeftText(getString(2131625751));
  }
  ...
  private void b()
  {
    ...
    Object localObject2 = baih.a(localSharedPreferences, str, null);
    ...
    if (((Set)localObject1).add(this.jdField_a_of_type_JavaLangString))
    {
      ...
      baih.a((SharedPreferences.Editor)localObject2, str, ((Set)localObject1).toArray());
  ...
  private void c()
  {
    ...
    startTitleProgress();
    this.jdField_a_of_type_ComTencentMobileqqActivitySpecialcareQvipSpecialSoundManager.a(new ahvy(this));
  }
  ...
  private void d()
  {
    ...
    if (ahwj.a(this.jdField_a_of_type_JavaLangString, this.app))
    {
      ...
      i = ahwj.a(this.jdField_a_of_type_JavaLangString, this.app);
      ...
      localObject = ((ajjj)this.app.getManager(51)).a(this.jdField_a_of_type_JavaLangString, false);
      if (localObject != null) {
        break label222;
      }
    ...
    {
      this.jdField_a_of_type_Alrm.a(this.jdField_a_of_type_ComTencentMobileqqWidgetFormSimpleItem, i, this.jdField_a_of_type_JavaLangString, 0);
      return;
      if (QLog.isColorLevel()) {
  ...
  {
    this.jdField_a_of_type_Alrm.a(this.jdField_a_of_type_ComTencentMobileqqWidgetFormSimpleItem, paramInt, this.jdField_a_of_type_JavaLangString, 0);
  }
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem = ((FormSwitchItem)findViewById(2131310590));
    this.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem.setOnCheckedChangeListener(this);
    this.jdField_a_of_type_AndroidViewView = findViewById(2131310591);
    this.jdField_b_of_type_ComTencentMobileqqWidgetFormSwitchItem = ((FormSwitchItem)findViewById(2131301194));
    this.jdField_b_of_type_ComTencentMobileqqWidgetFormSwitchItem.setOnCheckedChangeListener(this);
    this.c = ((FormSwitchItem)findViewById(2131301209));
    this.c.setOnCheckedChangeListener(this);
    this.jdField_b_of_type_AndroidViewView = findViewById(2131308571);
    ...
    for (paramBundle = "";; paramBundle = this.app.getCurrentAccountUin())
    {
      ...
      b();
      this.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem.setContentDescription(getString(2131651682));
  ...
  {
    super.doOnResume();
    this.jdField_a_of_type_Alrm.b(this.jdField_a_of_type_JavaLangString, 0);
    a();
  ...
  public void onCheckedChanged(CompoundButton paramCompoundButton, boolean paramBoolean)
  {
    ...
    if (paramCompoundButton == this.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem.a()) {
      if ((bbmy.a() == 0) && (paramBoolean))
      {
        paramCompoundButton = new akdz(this, this.app, this.jdField_a_of_type_JavaLangString);
        paramCompoundButton.setOnDismissListener(new ahwa(this, paramBoolean, paramCompoundButton));
  ...
  public void onClick(View paramView)
  {
    ...
    paramView.putExtra("url", bant.a("specialCareRingUrl").replace("[uid]", this.jdField_a_of_type_JavaLangString).replace("[lType]", "2"));
    startActivity(paramView);
    this.jdField_a_of_type_Boolean = false;
    awqx.b(null, "dc00898", "", "", "0X800A3C5", "0X800A3C5", 2, 0, "", "", "", "");
