  ...
  implements View.OnClickListener
{
  ...
  aniz jdField_a_of_type_Aniz = new aemc(this);
  ...
  private ViewGroup a(ViewGroup paramViewGroup, int paramInt, String paramString)
  {
    ...
    if (paramViewGroup != null)
    {
      ...
      if (paramInt > 0)
      {
        ...
        {
          localObject = (ViewGroup)this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561402, null);
          localView = ((ViewGroup)localObject).findViewById(2131368138);
          TextView localTextView = (TextView)((ViewGroup)localObject).findViewById(2131368563);
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_AndroidViewView = View.inflate(this, 2131561212, null);
    this.jdField_a_of_type_Boolean = false;
    Object localObject = (FrameLayout)findViewById(16908290);
    if (localObject != null) {
      ((FrameLayout)localObject).setBackgroundResource(2130845755);
    }
    this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368590));
    ...
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368585));
    ...
    this.jdField_a_of_type_ComTencentWidgetPullToZoomHeaderListView = ((PullToZoomHeaderListView)findViewById(2131364860));
    ...
    this.b.setText(getString(2131690563));
    this.b.setBackgroundResource(2130849136);
    this.b.setTextColor(getResources().getColor(2131166686));
    this.b.setOnClickListener(this);
    localObject = (LinearLayout)findViewById(2131363965);
    View localView = View.inflate(this, 2131561373, null);
    LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(-1, -2);
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)localView.findViewById(2131380031));
    ...
    this.jdField_a_of_type_ComTencentWidgetPullToZoomHeaderListView.setAdapter(new bkqn(this.jdField_a_of_type_AndroidViewView));
  }
  ...
  private void a(HorizontalScrollLayout paramHorizontalScrollLayout, KplCard paramKplCard)
  {
    ...
    for (;;)
    {
      ...
      break;
      label127:
      View localView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561386, null);
      ImageView localImageView = (ImageView)localView.findViewById(2131368164);
      ...
      try
      {
        ...
        ((URLDrawable)localObject4).setTag(bgey.b(m, m, (int)(16.0F * bgln.a())));
        ((URLDrawable)localObject4).setDecodeHandler(bgey.j);
        localImageView.setImageDrawable((Drawable)localObject4);
        ((TextView)localView.findViewById(2131378877)).setText((CharSequence)localObject1);
        ((TextView)localView.findViewById(2131365367)).setText((CharSequence)localObject3);
  ...
  private void c()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqDataKplCard = localanmw.a(this.jdField_a_of_type_ComTencentMobileqqDataKplRoleInfo$WZRYUIinfo.uin);
      if (bgnt.g(this)) {
        break label85;
      }
    ...
    for (;;)
    {
      ...
      return;
      label85:
      localanip.b(this.jdField_a_of_type_ComTencentMobileqqDataKplRoleInfo$WZRYUIinfo.uin);
    }
  }
  ...
  private void c(KplCard paramKplCard)
  {
    ...
    if (paramKplCard.gender == 0) {
      localObject1 = anni.a(2131704747);
    }
    for (;;)
    {
      a((ViewGroup)localObject2, 2130845765, (String)localObject1 + paramKplCard.gameLevel);
      a((ViewGroup)localObject2, 2130845313, paramKplCard.commonInfo);
      localObject1 = (ProfileCardFavorShowView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369496);
      ((ProfileCardFavorShowView)localObject1).setVisibility(0);
      ((ProfileCardFavorShowView)localObject1).setTitle(anni.a(2131704748));
      ((ProfileCardFavorShowView)localObject1).removeAllViews();
      localObject2 = new ProfileCardFavorItemView(this);
      ((ProfileCardFavorItemView)localObject2).setTitle(anni.a(2131704751));
      ...
      ((KPLScoreView)localObject3).setKplValue(paramKplCard.mvpLevel + anni.a(2131704753), paramKplCard.superLevel + anni.a(2131704752), paramKplCard.score + "%", paramKplCard.round + anni.a(2131704753));
      ((ProfileCardFavorItemView)localObject2).addView((View)localObject3);
      ((ProfileCardFavorItemView)localObject2).b.setImageDrawable(new ColorDrawable(getResources().getColor(2131167279)));
      ...
      localObject2 = new ProfileCardFavorItemView(this);
      ((ProfileCardFavorItemView)localObject2).setTitle(anni.a(2131704754));
      ((ProfileCardFavorItemView)localObject2).setArrowVisiale(false);
      localObject3 = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561413, null);
      HorizontalScrollLayout localHorizontalScrollLayout = (HorizontalScrollLayout)((View)localObject3).findViewById(2131376976);
      localHorizontalScrollLayout.setOnTouchListener(new aemb(this));
      a(localHorizontalScrollLayout, paramKplCard);
      ((ProfileCardFavorItemView)localObject2).addView((View)localObject3);
      ((ProfileCardFavorItemView)localObject2).b.setBackgroundDrawable(new ColorDrawable(getResources().getColor(2131167279)));
      ((ProfileCardFavorShowView)localObject1).addView((View)localObject2);
      return;
      if (paramKplCard.gender == 1) {
        localObject1 = anni.a(2131704749);
      }
    }
  }
  ...
  private void d()
  {
    ...
    do
    {
      QQToast.a(this, getResources().getString(2131693992), 0).b(getTitleBarHeight());
      do
      {
        return;
    ...
    } while (((anmw)this.app.getManager(51)).b(this.jdField_a_of_type_ComTencentMobileqqDataKplRoleInfo$WZRYUIinfo.uin));
    ...
    for (int j = 23;; j = this.jdField_a_of_type_ComTencentMobileqqDataKplRoleInfo$WZRYUIinfo.subSourceId)
    {
      ...
      bcst.b(this.app, "CliOper", "", "", "0X80085C5", "0X80085C5", 0, 0, String.valueOf(j), "", "", "");
      return;
  ...
  public void onClick(View paramView)
  {
    ...
    default: 
      ...
      {
        d();
        bcst.b(this.app, "dc00898", "", "", "0X8008436", "0X8008436", 0, 0, "", "", "", "");
      }
      break;
    }
    for (;;)
