...
public class ResizeLayout
  extends ScrollView
{
  private afby jdField_a_of_type_Afby;
  ...
  protected void onSizeChanged(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      for (this.jdField_a_of_type_Boolean = false; this.jdField_a_of_type_Afby != null; this.jdField_a_of_type_Boolean = true)
      {
  ...
  public void setOnResizeListener(afby paramafby)
  {
    this.jdField_a_of_type_Afby = paramafby;
  }
}
