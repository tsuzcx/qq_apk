  ...
  implements Runnable
{
  ...
  public void run()
  {
    Object localObject = this.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getSharedPreferences(aohq.a, 0);
    long l = ((SharedPreferences)localObject).getLong(aohq.d, 0L);
    if ((l == 0L) || (l > System.currentTimeMillis()) || (System.currentTimeMillis() - l > 14400000L)) {}
    for (int i = 1;; i = 0)
    {
      if (i != 0) {
        ((SharedPreferences)localObject).edit().putLong(aohq.d, System.currentTimeMillis()).commit();
      }
      if (i != 0)
      {
