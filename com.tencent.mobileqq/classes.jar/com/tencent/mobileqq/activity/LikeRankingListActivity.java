  ...
  implements Handler.Callback, View.OnClickListener, Animation.AnimationListener, FaceDecoder.DecodeTaskCompletionListener, AbsListView.OnScrollListener, AdapterView.OnItemClickListener
{
  ...
  CardObserver jdField_a_of_type_ComTencentMobileqqAppCardObserver = new swa(this);
  ...
  public void a(Card paramCard)
  {
    ...
    this.jdField_a_of_type_ComTencentUtilWeakReferenceHandler.post(new swe(this, paramCard));
    ...
    do
    {
      do
      {
        ...
        do
        {
          ...
          {
            this.jdField_a_of_type_ComTencentUtilWeakReferenceHandler.post(new swf(this, (Bitmap)localObject));
            return;
      ...
      this.jdField_a_of_type_ComTencentUtilWeakReferenceHandler.post(new swg(this));
      return;
    ...
    this.jdField_c_of_type_JavaLangString = paramCard;
    this.f = ((Integer)localObject).intValue();
    this.jdField_a_of_type_ComTencentUtilWeakReferenceHandler.post(new swh(this));
  }
  ...
  public void a(AdapterView paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    do
    {
      return;
      paramInt -= 1;
    } while ((this.jdField_a_of_type_Int != -1) && (paramInt == this.jdField_a_of_type_Swi.getCount() - 1));
    if (paramInt == -1)
    {
    ...
    {
      paramAdapterView = this.jdField_a_of_type_Swi.a(paramInt);
  ...
  public void a(String paramString)
  {
    ...
    this.g = 1;
    this.app.a(new swd(this, paramString));
  }
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_AndroidViewView = findViewById(2131370215);
    ...
    this.jdField_a_of_type_AndroidContentResColorStateList = paramBundle.getColorStateList(2131494019);
    this.jdField_b_of_type_AndroidContentResColorStateList = paramBundle.getColorStateList(2131494205);
    ...
    this.jdField_a_of_type_ComTencentWidgetPullToZoomListView = ((PullToZoomListView)findViewById(2131370214));
    ...
    this.jdField_b_of_type_AndroidViewView = LayoutInflater.from(this).inflate(2130970356, null);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131370216));
    this.jdField_a_of_type_ComTencentMobileqqWidgetCircleProgress = ((CircleProgress)this.jdField_b_of_type_AndroidViewView.findViewById(2131370217));
    this.jdField_a_of_type_ComTencentMobileqqWidgetCircleProgress.setStrokeWidth(2.0F);
    this.jdField_a_of_type_ComTencentMobileqqWidgetCircleProgress.setBgAndProgressColor(0, 2131492923, 100, 16763714);
    this.jdField_a_of_type_ComTencentMobileqqWidgetCircleProgress.setProgress(100.0F);
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this);
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131366351));
    ...
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131370220));
    this.jdField_c_of_type_AndroidViewView = this.jdField_b_of_type_AndroidViewView.findViewById(2131370218);
    this.jdField_d_of_type_AndroidViewView = this.jdField_b_of_type_AndroidViewView.findViewById(2131370219);
    ...
    this.jdField_a_of_type_Swi = new swi(this);
    this.jdField_a_of_type_ComTencentWidgetPullToZoomListView.setAdapter(this.jdField_a_of_type_Swi);
    ...
    this.jdField_e_of_type_AndroidViewView = findViewById(2131368764);
    ...
    if ((paramBundle != null) && (paramBundle.size() > 0))
    {
      ...
      this.jdField_a_of_type_Swi.a(paramBundle);
    }
    for (;;)
    {
      this.jdField_a_of_type_Swi.a = true;
      this.jdField_a_of_type_Swi.notifyDataSetChanged();
      ...
      ThreadManager.post(new swc(this), 5, null, false);
      return true;
      a(null);
    }
  }
