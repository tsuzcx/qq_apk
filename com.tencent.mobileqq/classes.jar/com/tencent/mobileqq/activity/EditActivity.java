  ...
  implements EmoticonCallback
{
  ...
  private TextWatcher jdField_a_of_type_AndroidTextTextWatcher = new sio(this);
  ...
  private void f()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new sik(this));
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetClearableEditText.setOnClickListener(new sil(this));
  }
  
  private void g()
  {
    this.jdField_a_of_type_Float = getResources().getDisplayMetrics().density;
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131364732));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131364733));
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqWidgetClearableEditText.setBackgroundResource(2130838619);
    ...
    {
      setRightHighlightButton(2131434517, new sim(this));
    ...
    for (;;)
    {
      ...
      new Handler().postDelayed(new sin(this), 500L);
      return;
  ...
  private void i()
  {
    if (this.jdField_a_of_type_AndroidAppDialog == null) {
      this.jdField_a_of_type_AndroidAppDialog = DialogUtil.a(this, "是否放弃对个人说明的修改？", 2131436276, 2131435737, new sip(this), new siq(this));
    }
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetClearableEditText = ((ClearableEditText)findViewById(2131364731));
  ...
  public void e()
  {
    ...
    if (!android.text.TextUtils.isEmpty(str))
    {
      ...
      catch (UnsupportedEncodingException localUnsupportedEncodingException)
      {
        for (;;)
        {
          ...
          continue;
          ColorStateList localColorStateList = getResources().getColorStateList(2131494262);
          continue;
          localObject1 = String.valueOf((this.jdField_c_of_type_Int - i) / 3);
          continue;
          if (i > this.jdField_c_of_type_Int) {
            localObject1 = getString(2131434767) + "！ " + i + "/" + this.jdField_c_of_type_Int;
          } else {
    ...
    for (int i = localObject1.length;; i = 0) {
      if (i > this.jdField_c_of_type_Int)
      {
        localObject2 = getResources().getColorStateList(2131494295);
