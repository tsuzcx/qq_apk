  ...
  implements IMediaPlayer.OnCompletionListener, IMediaPlayer.OnErrorListener, IMediaPlayer.OnInfoListener, IMediaPlayer.OnPreparedListener
{
  ...
  private static final String[] jdField_e_of_type_ArrayOfJavaLangString = { "Nexus 5" };
  ...
  private void e()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityRegisterGuideLoginGuideVideoHandler$GuideVideoCallBack != null) {
      this.jdField_a_of_type_ComTencentMobileqqActivityRegisterGuideLoginGuideVideoHandler$GuideVideoCallBack.b();
    }
  }
  ...
  public void a()
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("LoginActivity.GuideVideoHandler", 2, "not register BroadcastReceiver yet" + this.jdField_a_of_type_Boolean);
      }
      return;
    }
    try
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.e("LoginActivity.GuideVideoHandler", 2, "Can not register BroadcastReceiver exception:", localIllegalArgumentException);
      }
      return;
    }
    finally
  ...
  public void a(Context paramContext, MqqHandler paramMqqHandler, int paramInt)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("LoginActivity.GuideVideoHandler", 2, "getVideoFrame isRetrieve=" + this.jdField_e_of_type_Boolean);
      }
      return;
    }
    ...
    ThreadManager.postImmediately(new xsc(this, paramContext, paramInt, paramMqqHandler), null, false);
  }
  
  public void a(IMediaPlayer paramIMediaPlayer)
  {
    if (QLog.isColorLevel()) {
      QLog.d("LoginActivity.GuideVideoHandler", 2, "MediaPlayer onCompletion has been called.   at " + paramIMediaPlayer.b() + " mIsPause" + this.jdField_b_of_type_Boolean);
    }
    ...
    if ((a(jdField_c_of_type_ArrayOfJavaLangString)) && (!this.jdField_b_of_type_Boolean))
    {
  ...
  public boolean a(IMediaPlayer paramIMediaPlayer, int paramInt1, int paramInt2)
  {
    ...
    if (paramIMediaPlayer != null)
    {
      ...
      StatisticCollector.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getApplicationContext()).a(null, "newHandGuide_error", true, 0L, 0L, localHashMap, "", false);
    }
    return true;
  }
  ...
  public void a_(IMediaPlayer paramIMediaPlayer)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("LoginActivity.GuideVideoHandler", 2, "MediaPlayer onPrepared has been called. talkback=" + AppSetting.jdField_b_of_type_Boolean + " videoPrepareTime=" + (System.currentTimeMillis() - this.jdField_a_of_type_Long));
    }
  }
  ...
  public void c()
  {
    if (this.jdField_a_of_type_ComTencentBizQqstoryPlayvideoPlayerTextureVideoView != null)
    {
      ...
      if (this.jdField_a_of_type_ComTencentBizQqstoryPlayvideoPlayerTextureVideoView.isPlaying()) {
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("LoginActivity.GuideVideoHandler", 2, "play has been called. pause :" + this.jdField_b_of_type_Boolean + " isStartVideo:" + this.jdField_c_of_type_Boolean);
    }
    if (this.jdField_b_of_type_Boolean)
    {
      this.jdField_a_of_type_ComTencentBizQqstoryPlayvideoPlayerTextureVideoView.start();
    ...
    do
    {
      do
      {
        do
        {
          ...
          } while ((a(f)) && (!this.jdField_d_of_type_Boolean));
          this.jdField_a_of_type_MqqOsMqqHandler.sendEmptyMessage(103);
