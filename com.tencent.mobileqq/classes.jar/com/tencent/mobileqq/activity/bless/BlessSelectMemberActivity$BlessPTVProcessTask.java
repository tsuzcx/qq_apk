  ...
  extends AsyncTask<Void, Void, Integer>
{
  ...
  protected Integer a(Void... arg1)
  {
    ...
    if (((URLDrawable)localObject1).getStatus() == 1)
    {
      ...
      localShortVideoUploadInfo.e = true;
      ...
      ((BlessManager)((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getManager(QQManagerFactory.SEND_BLESS_CONFIG_MANAGER)).a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo);
