  ...
  extends MessageObserver
{
  ...
  public void onBlessDirtyTextCheck(boolean paramBoolean, int paramInt)
  {
    ...
    while ((i != 0) && (!BlessSelectMemberActivity.b()))
    {
      ...
      if (paramInt != 0) {
        if (paramInt == 1)
        {
          BlessSelectMemberActivity.a(this.a, 2131690735, true);
          i = 0;
        }
        else
        {
          if (paramInt == 8) {
            BlessSelectMemberActivity.a(this.a, 2131690759, true);
          }
          i = 0;
        }
      }
  ...
  public void onSendBlessMsgResp(boolean paramBoolean1, int paramInt, long paramLong, boolean paramBoolean2)
  {
    ...
    if (paramInt == 67L)
    {
      ...
      this.a.a(paramLong);
      this.a.e();
      BlessSelectMemberActivity.a(this.a, 2131690746, true);
      return;
    }
  ...
  public void onUpdateMsgContent(boolean paramBoolean, String paramString)
  {
    ...
    do
    {
      do
      {
        return;
        this.a.e();
        BlessSelectMemberActivity.a(this.a, 2131690745, false);
        return;
      } while (BlessSelectMemberActivity.c(this.a) != 2);
      if ((BlessSelectMemberActivity.a(this.a).a() == null) || (!paramBoolean))
      {
        this.a.e();
        BlessSelectMemberActivity.a(this.a, 2131690760, false);
        return;
      }
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.bless.BlessSelectMemberActivity.1
