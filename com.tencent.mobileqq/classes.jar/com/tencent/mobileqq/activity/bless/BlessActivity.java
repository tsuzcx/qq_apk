  ...
  implements View.OnClickListener
{
  ...
  private void a(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if (paramBoolean)
      {
        View localView = findViewById(2131363387);
        localView.setVisibility(0);
        localView.bringToFront();
        findViewById(2131363389).bringToFront();
        findViewById(2131363397).bringToFront();
      }
  ...
  private void b()
  {
    ...
    //   219: aload_0
    //   220: aload 6
    //   222: invokespecial 224	wjz:<init>	(Lcom/tencent/mobileqq/activity/bless/BlessActivity;Landroid/graphics/Bitmap;)V
    //   225: ldc2_w 225
    ...
    //   434: dup
    //   435: aload_0
    //   436: invokespecial 270	wkb:<init>	(Lcom/tencent/mobileqq/activity/bless/BlessActivity;)V
    //   439: ldc2_w 225
    ...
    //   493: dup
    //   494: aload_0
    //   495: invokespecial 273	wka:<init>	(Lcom/tencent/mobileqq/activity/bless/BlessActivity;)V
  ...
  private void c()
  {
    ...
    Object localObject1 = (RelativeLayout)findViewById(2131362845);
    if (this.jdField_a_of_type_ComTencentMobileqqWidgetQQVideoView == null) {
      this.jdField_a_of_type_ComTencentMobileqqWidgetQQVideoView = ((QQVideoView)findViewById(2131363388));
    }
    if (this.jdField_a_of_type_AndroidMediaAudioManager == null) {
    ...
    for (;;)
    {
      ...
      d();
      Object localObject2 = (RelativeLayout.LayoutParams)findViewById(2131363387).getLayoutParams();
      ((RelativeLayout.LayoutParams)localObject2).width = j;
      ((RelativeLayout.LayoutParams)localObject2).height = i;
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131363386));
      ...
      this.jdField_b_of_type_AndroidViewView.setOnClickListener(new wkc(this));
      if (this.jdField_a_of_type_AndroidMediaAudioManager != null) {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWidgetQQVideoView.setOnPreparedListener(new wkd(this));
      this.jdField_a_of_type_ComTencentMobileqqWidgetQQVideoView.setOnCompletionListener(new wkf(this));
      this.jdField_a_of_type_ComTencentMobileqqWidgetQQVideoView.setOnErrorListener(new wkg(this));
      return;
    }
  }
  ...
  private void d()
  {
    if (this.jdField_a_of_type_AndroidContentBroadcastReceiver == null) {
      this.jdField_a_of_type_AndroidContentBroadcastReceiver = new wjx(this);
    }
  ...
  public void a()
  {
    ...
    //   171: aload_0
    //   172: aload_1
    //   173: invokespecial 435	wjw:<init>	(Lcom/tencent/mobileqq/activity/bless/BlessActivity;Landroid/widget/RelativeLayout;)V
    ...
    //   209: dup
    //   210: aload_0
    //   211: invokespecial 453	wjy:<init>	(Lcom/tencent/mobileqq/activity/bless/BlessActivity;)V
    //   214: bipush 10
    //   216: aconst_null
    //   217: iconst_1
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    super.setContentView(2130968714);
