  ...
  implements View.OnClickListener
{
  ...
  private void a(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if (paramBoolean)
      {
        View localView = findViewById(2131304146);
        localView.setVisibility(0);
        localView.bringToFront();
        findViewById(2131302887).bringToFront();
        findViewById(2131311534).bringToFront();
      }
  ...
  private void b()
  {
    ...
    //   3: astore 6
    //   5: aload_0
    //   6: getfield 141	com/tencent/mobileqq/activity/bless/BlessActivity:jdField_a_of_type_Aeqd	Laeqd;
    //   9: invokevirtual 146	aeqd:f	()Ljava/lang/String;
    //   12: astore 9
    //   14: aload_0
    //   15: getfield 141	com/tencent/mobileqq/activity/bless/BlessActivity:jdField_a_of_type_Aeqd	Laeqd;
    //   18: invokevirtual 149	aeqd:g	()Ljava/lang/String;
    //   21: astore 8
    //   23: aload 8
    ...
    //   108: aload 8
    //   110: iconst_0
    //   111: invokestatic 179	bace:a	(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    //   158: invokestatic 202	bacm:a	(Ljava/io/InputStream;II)D
    //   161: d2i
    //   162: putfield 205	android/graphics/BitmapFactory$Options:inSampleSize	I
    //   165: aload_0
    //   166: getfield 141	com/tencent/mobileqq/activity/bless/BlessActivity:jdField_a_of_type_Aeqd	Laeqd;
    //   169: invokevirtual 209	aeqd:l	()I
    //   172: istore_2
    //   173: iload_2
    //   174: iconst_m1
    ...
    //   202: aload 6
    //   204: invokestatic 219	azvq:a	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   207: astore 6
    //   209: aload_0
    ...
    //   323: istore 4
    //   325: aload_0
    //   326: getfield 141	com/tencent/mobileqq/activity/bless/BlessActivity:jdField_a_of_type_Aeqd	Laeqd;
    //   329: invokevirtual 245	aeqd:m	()I
    //   332: istore_3
    //   333: aload_0
    ...
    //   377: aload 6
    //   379: invokestatic 219	azvq:a	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   382: astore 9
    //   384: aload_0
    ...
    //   493: dup
    //   494: aload_0
    //   495: invokespecial 273	aepu:<init>	(Lcom/tencent/mobileqq/activity/bless/BlessActivity;)V
    //   498: invokevirtual 276	com/tencent/mobileqq/activity/bless/BlessActivity$AnimationDrawable2:a	(Laepz;)V
    //   501: goto -74 -> 427
    //   504: astore 8
    //   506: aload 7
    //   508: astore 6
  ...
  private void c()
  {
    ...
    Object localObject1 = (RelativeLayout)findViewById(2131309736);
    if (this.jdField_a_of_type_ComTencentMobileqqWidgetQQVideoView == null) {
      this.jdField_a_of_type_ComTencentMobileqqWidgetQQVideoView = ((QQVideoView)findViewById(2131313302));
    }
    if (this.jdField_a_of_type_AndroidMediaAudioManager == null) {
    ...
    for (;;)
    {
      ...
      d();
      Object localObject2 = (RelativeLayout.LayoutParams)findViewById(2131304146).getLayoutParams();
      ((RelativeLayout.LayoutParams)localObject2).width = j;
      ((RelativeLayout.LayoutParams)localObject2).height = i;
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131313298));
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      try
      {
        localObject2 = new FileInputStream(this.jdField_c_of_type_JavaLangString);
        BitmapFactory.Options localOptions = new BitmapFactory.Options();
        localOptions.inSampleSize = ((int)bacm.a((InputStream)localObject2, j, i));
        localObject2 = azvq.a(this.jdField_c_of_type_JavaLangString, localOptions);
      ...
      this.jdField_b_of_type_AndroidViewView.setOnClickListener(new aepv(this));
      if (this.jdField_a_of_type_AndroidMediaAudioManager != null) {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWidgetQQVideoView.setOnPreparedListener(new aepw(this));
      this.jdField_a_of_type_ComTencentMobileqqWidgetQQVideoView.setOnCompletionListener(new aepx(this));
      this.jdField_a_of_type_ComTencentMobileqqWidgetQQVideoView.setOnErrorListener(new aepy(this));
      return;
    }
  }
  ...
  private void d()
  {
    if (this.jdField_a_of_type_AndroidContentBroadcastReceiver == null) {
      this.jdField_a_of_type_AndroidContentBroadcastReceiver = new aept(this);
    }
  ...
  public void a()
  {
    ...
    //   10: astore_1
    //   11: aload_0
    //   12: getfield 141	com/tencent/mobileqq/activity/bless/BlessActivity:jdField_a_of_type_Aeqd	Laeqd;
    //   15: invokevirtual 422	aeqd:a	()Ljava/lang/String;
    //   18: astore_3
    //   19: aload_3
    //   20: ifnull +125 -> 145
    ...
    //   58: invokestatic 202	bacm:a	(Ljava/io/InputStream;II)D
    //   61: d2i
    ...
    //   121: aload_3
    //   122: aload 4
    //   124: invokestatic 219	azvq:a	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   127: astore_3
    //   128: aload_3
    //   129: ifnull +8 -> 137
    //   132: aload_1
    ...
    //   171: aload_0
    //   172: aload_1
    //   173: invokespecial 435	aeps:<init>	(Lcom/tencent/mobileqq/activity/bless/BlessActivity;Landroid/widget/RelativeLayout;)V
    ...
    //   179: aload_0
    //   180: getfield 141	com/tencent/mobileqq/activity/bless/BlessActivity:jdField_a_of_type_Aeqd	Laeqd;
    //   183: invokevirtual 444	aeqd:a	()Ljava/lang/Boolean;
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    super.setContentView(2131493087);
    if (this.jdField_a_of_type_Aeqd.h())
    {
      this.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_Aeqd.c();
      this.jdField_c_of_type_JavaLangString = this.jdField_a_of_type_Aeqd.d();
    ...
    a();
    this.jdField_a_of_type_Aeqd.b(false);
