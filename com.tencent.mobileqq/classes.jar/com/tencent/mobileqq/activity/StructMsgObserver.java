  ...
  implements Observer
{
  public void update(Observable paramObservable, Object paramObject)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          ThreadManager.post(new tyj(this, paramObject, paramObservable.uinType, str1, str2), 5, null, false);
          return;
    ...
    ThreadManager.post(new tyk(this, paramObject, paramObservable.istroop, str2, str1), 5, null, false);
  }
}
