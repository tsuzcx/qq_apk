  ...
  extends IphoneTitleBarActivity
{
  public static void a(FragmentActivity paramFragmentActivity, Fragment paramFragment)
  {
    ...
    if (paramFragmentActivity.findFragmentById(2131367708) != null) {
      localFragmentTransaction.replace(2131367708, paramFragment);
    }
    while (VersionUtils.isHoneycomb())
    {
      localFragmentTransaction.commitAllowingStateLoss();
      return;
      localFragmentTransaction.add(2131367708, paramFragment);
    }
  ...
  {
    Fragment localFragment = getSupportFragmentManager().findFragmentById(2131367708);
