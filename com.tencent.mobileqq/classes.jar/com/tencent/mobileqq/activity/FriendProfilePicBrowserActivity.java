  ...
  implements DialogInterface.OnCancelListener, View.OnClickListener, PicBrowserImage.OnLoadListener
{
  ...
  private void h()
  {
    ...
    localQQCustomDialog.setMessage(getString(2131435951)).setCancelable(true);
    localQQCustomDialog.setNegativeButton(2131433029, new syl(this, localQQCustomDialog));
    localQQCustomDialog.setPositiveButton(2131433711, new sym(this, localQQCustomDialog));
    if (!isFinishing()) {
  ...
  public void c()
  {
    ...
    localActionSheet.a(new syk(this, localActionSheet));
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_ComTencentCommonGalleryactivityGalleryManager = new syn(this);
    super.doOnCreate(paramBundle);
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)findViewById(2131371197));
