...
final class TroopRequestActivity$24
  extends ProtoUtils.TroopProtocolObserver
{
  TroopRequestActivity$24(String paramString, Context paramContext, TroopNotificationUtils.TroopPrivilegeCallback paramTroopPrivilegeCallback, structmsg.StructMsg paramStructMsg) {}
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (paramBundle != null)
      {
        ...
        if (paramBundle.uint32_app_privilege_flag.has())
        {
          ...
          j = i;
          new Handler(this.jdField_a_of_type_AndroidContentContext.getMainLooper()).post(new TroopRequestActivity.24.1(this, k));
          label434:
          return;
        }
      }
    ...
    for (;;)
    {
      new Handler(this.jdField_a_of_type_AndroidContentContext.getMainLooper()).post(new TroopRequestActivity.24.2(this, i, paramInt, paramBundle));
      if (!QLog.isColorLevel()) {
        break label434;
      }
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.TroopRequestActivity.24
