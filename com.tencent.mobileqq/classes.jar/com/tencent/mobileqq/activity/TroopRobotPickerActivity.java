  ...
  extends BaseActivity
{
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqConditionsearchWidgetIphonePickerView = ((IphonePickerView)LayoutInflater.from(this).inflate(2130970373, null));
    this.jdField_a_of_type_ComTencentMobileqqConditionsearchWidgetIphonePickerView.a(new udr(this, this.jdField_a_of_type_ComTencentMobileqqActivityTroopRobotPickerActivity$RobotPickerData));
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_ComTencentWidgetActionSheet.setOnDismissListener(new udq(this, this.jdField_a_of_type_ComTencentMobileqqActivityTroopRobotPickerActivity$RobotPickerData));
      try
      {
        ...
        else
        {
          ...
          this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_ComTencentMobileqqConditionsearchWidgetIphonePickerView.findViewById(2131370271));
          ...
          for (localObject = this.jdField_a_of_type_ComTencentMobileqqActivityTroopRobotPickerActivity$RobotPickerData.mLocationCountry.name;; localObject = "中国")
          {
            ...
            this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new udn(this));
            if (!AppSetting.b) {
              break;
            }
      ...
      do
      {
        ...
        catch (Exception paramBundle)
        {
          ...
          for (;;)
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqAppConditionSearchManager.c(new udo(this));
