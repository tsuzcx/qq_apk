  ...
  extends BaseActivity
{
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqConditionsearchWidgetIphonePickerView = ((IphonePickerView)LayoutInflater.from(this).inflate(2131561215, null));
    this.jdField_a_of_type_ComTencentMobileqqConditionsearchWidgetIphonePickerView.a(new afok(this, this.jdField_a_of_type_ComTencentMobileqqActivityTroopRobotPickerActivity$RobotPickerData));
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Bkho.setOnDismissListener(new afoj(this, this.jdField_a_of_type_ComTencentMobileqqActivityTroopRobotPickerActivity$RobotPickerData));
      try
      {
        ...
        else
        {
          ...
          this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_ComTencentMobileqqConditionsearchWidgetIphonePickerView.findViewById(2131377132));
          ...
          for (localObject = this.jdField_a_of_type_ComTencentMobileqqActivityTroopRobotPickerActivity$RobotPickerData.mLocationCountry.name;; localObject = "中国")
          {
            ...
            this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new afog(this));
            if (!AppSetting.c) {
              break;
            }
            this.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(anni.a(2131714419) + (String)localObject + anni.a(2131714421));
            break;
          }
        }
      }
  ...
  private void a(String paramString)
  {
    ...
    {
      paramString = this.jdField_a_of_type_Anjh.a(paramString);
  ...
  public void doOnActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if ((paramInt2 == -1) && (paramInt1 == 111))
    {
      ...
      if ((!TextUtils.isEmpty(str)) && (!str.equals(this.jdField_a_of_type_ComTencentMobileqqActivityTroopRobotPickerActivity$RobotPickerData.mLocationCountyCode)))
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqActivityTroopRobotPickerActivity$RobotPickerData.mLocationCountry = this.jdField_a_of_type_Anjh.a(this.jdField_a_of_type_ComTencentMobileqqActivityTroopRobotPickerActivity$RobotPickerData.mLocationCountyCode);
        if (this.jdField_a_of_type_ComTencentMobileqqActivityTroopRobotPickerActivity$RobotPickerData.mLocationCountry != null)
        {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_AndroidWidgetTextView != null)
      {
        ...
        if (AppSetting.c) {
          this.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(anni.a(2131714429) + this.jdField_a_of_type_ComTencentMobileqqActivityTroopRobotPickerActivity$RobotPickerData.mLocationCountry.name + anni.a(2131714432));
        }
      }
    }
  }
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_AndroidAppProgressDialog.setMessage(anni.a(2131714426));
    ...
    catch (JSONException paramBundle)
    {
      do
      {
        ...
        try
        {
          ...
          {
            finish();
            QQToast.a(this, anni.a(2131714425), 1).a();
            return false;
          }
        }
        catch (Exception paramBundle)
        {
          ...
          for (;;)
          {
            ...
            this.jdField_a_of_type_Anjh.c(new afoh(this));
            this.jdField_a_of_type_Anjh.a(this.jdField_a_of_type_Anjh.a(), true);
            return false;
