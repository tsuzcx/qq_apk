  ...
  implements View.OnClickListener
{
  ...
  public void a()
  {
    if (this.jdField_a_of_type_ComTencentWidgetActionSheet == null)
    {
      ...
      this.jdField_a_of_type_ComTencentWidgetActionSheet.a(new tcx(this));
      this.jdField_a_of_type_ComTencentWidgetActionSheet.c(2131432998);
    }
  ...
  public boolean a()
  {
    ...
    catch (Exception localException)
    {
      ...
      ((TextView)findViewById(2131365467)).setText((CharSequence)localObject2);
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)findViewById(2131365469));
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
      localObject2 = (ImageView)findViewById(2131363456);
      ((ImageView)localObject2).setVisibility(0);
      if (AppSetting.b) {
        ((ImageView)localObject2).setContentDescription(getString(2131436837));
      }
      ((ImageView)localObject2).setBackgroundResource(2130839143);
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    {
      return true;
      super.setContentView(2130969171);
