  ...
  implements Runnable
{
  ...
  public void run()
  {
    List localList = this.this$0.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().b(this.this$0.jdField_b_of_type_JavaLangString, 1, this.this$0.jdField_b_of_type_Long, 20);
    if (localList != null) {
