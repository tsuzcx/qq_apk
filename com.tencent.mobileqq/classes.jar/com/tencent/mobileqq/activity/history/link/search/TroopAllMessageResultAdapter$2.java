...
public class TroopAllMessageResultAdapter$2
  implements Runnable
{
  public TroopAllMessageResultAdapter$2(ajwt paramajwt, String paramString, long paramLong, List paramList) {}
  
  public void run()
  {
    int j = 0;
    Object localObject = ajwt.d(this.this$0).getMessageFacade().queryAllHistroyByKey(ajwt.c(this.this$0), this.jdField_a_of_type_JavaLangString);
    int i;
    ...
    if ((localObject != null) && (((ChatHistorySearchData)localObject).mSearchData1 != null) && (!((ChatHistorySearchData)localObject).mSearchData1.isEmpty()))
    {
      ...
      while (i < ((ChatHistorySearchData)localObject).mSearchData1.size())
      {
        ...
        if (ajwt.a(this.this$0, localMessageRecord)) {
          this.this$0.jdField_a_of_type_JavaUtilList.add(new akcy(ajwt.e(this.this$0), localMessageRecord));
        }
        i += 1;
      }
    }
    ...
    {
      localObject = ajwt.f(this.this$0).getMessageFacade().queryMsgListByID(ajwt.d(this.this$0).curFriendUin, ajwt.e(this.this$0).curType, ((ChatHistorySearchData)localObject).mSearchData2);
      if ((localObject != null) && (((ChatHistorySearchData)localObject).mSearchData1 != null))
      {
        ...
        {
          localMessageRecord = (MessageRecord)((ChatHistorySearchData)localObject).mSearchData1.get(i);
          if (ajwt.b(this.this$0, localMessageRecord)) {
            this.this$0.jdField_a_of_type_JavaUtilList.add(new akcy(ajwt.g(this.this$0), localMessageRecord));
          }
          i += 1;
        }
      }
    ...
    ajwt.c(this.this$0).obtainMessage(6, localObject).sendToTarget();
  }
}
