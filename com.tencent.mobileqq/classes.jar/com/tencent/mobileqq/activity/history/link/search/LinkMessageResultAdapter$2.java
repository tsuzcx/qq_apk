...
public class LinkMessageResultAdapter$2
  implements Runnable
{
  public LinkMessageResultAdapter$2(agbo paramagbo, String paramString, long paramLong, List paramList) {}
  
  public void run()
  {
    int j = 0;
    Object localObject = this.this$0.a(agbo.c(this.this$0), this.jdField_a_of_type_JavaLangString);
    int i;
    ...
    if ((localObject != null) && (((ChatHistorySearchData)localObject).mSearchData1 != null) && (!((ChatHistorySearchData)localObject).mSearchData1.isEmpty()))
    {
      ...
      while (i < ((ChatHistorySearchData)localObject).mSearchData1.size())
      {
        ...
        if (agbo.a(this.this$0, localMessageRecord)) {
          this.this$0.jdField_a_of_type_JavaUtilList.add(new agep(agbo.b(this.this$0), localMessageRecord));
        }
        i += 1;
      }
    }
    ...
    {
      localObject = agbo.c(this.this$0).a().a(agbo.d(this.this$0).jdField_a_of_type_JavaLangString, agbo.e(this.this$0).jdField_a_of_type_Int, ((ChatHistorySearchData)localObject).mSearchData2);
      if ((localObject != null) && (((ChatHistorySearchData)localObject).mSearchData1 != null))
      {
        ...
        {
          localMessageRecord = (MessageRecord)((ChatHistorySearchData)localObject).mSearchData1.get(i);
          if (agbo.b(this.this$0, localMessageRecord)) {
            this.this$0.jdField_a_of_type_JavaUtilList.add(new agep(agbo.d(this.this$0), localMessageRecord));
          }
          i += 1;
        }
      }
    ...
    agbo.c(this.this$0).obtainMessage(6, localObject).sendToTarget();
  }
}
