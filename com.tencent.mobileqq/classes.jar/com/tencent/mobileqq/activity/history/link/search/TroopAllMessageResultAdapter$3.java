  ...
  implements Runnable
{
  ...
  {
    int j = 0;
    Object localObject = ajbe.h(this.this$0).getMessageFacade().queryAllHistroyByKey(ajbe.f(this.this$0), this.jdField_a_of_type_JavaLangString);
    int i;
    ...
    if ((localObject != null) && (((ChatHistorySearchData)localObject).mSearchData1 != null) && (!((ChatHistorySearchData)localObject).mSearchData1.isEmpty()))
    {
      ...
      while (i < ((ChatHistorySearchData)localObject).mSearchData1.size())
      {
        ...
        if (ajbe.c(this.this$0, localMessageRecord))
        {
          this.this$0.jdField_a_of_type_JavaUtilList.add(new ajhk(ajbe.i(this.this$0), localMessageRecord));
    ...
    {
      localObject = ajbe.j(this.this$0).getMessageFacade().queryMsgListByID(ajbe.g(this.this$0).curFriendUin, ajbe.h(this.this$0).curType, ((ChatHistorySearchData)localObject).mSearchData2);
      if ((localObject != null) && (((ChatHistorySearchData)localObject).mSearchData1 != null))
      {
        ...
        {
          localMessageRecord = (MessageRecord)((ChatHistorySearchData)localObject).mSearchData1.get(i);
          if (ajbe.d(this.this$0, localMessageRecord))
          {
            this.this$0.jdField_a_of_type_JavaUtilList.add(new ajhk(ajbe.k(this.this$0), localMessageRecord));
            this.this$0.jdField_a_of_type_JavaUtilSet.add(Long.valueOf(localMessageRecord.shmsgseq));
          }
          i += 1;
        }
    ...
    ajbe.d(this.this$0).obtainMessage(8, localObject).sendToTarget();
  }
}
