  ...
  implements View.OnClickListener
{
  ...
  public void doOnCreateView(LayoutInflater paramLayoutInflater, @Nullable ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    setTitle(getString(2131625168));
    this.jdField_a_of_type_ComTencentMobileqqWidgetFormSimpleItem = ((FormSimpleItem)this.mContentView.findViewById(2131298089));
    this.b = ((FormSimpleItem)this.mContentView.findViewById(2131297966));
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131298089: 
      ...
      do
      {
        ...
        bajr.a(localQQAppInterface, "chat_history", "ChatHistory", "Clk_RoamMsgSetting", 1, 0, new String[] { "0", "0", "msgHistory" });
      ...
      for (paramView = paramView + "&ADTAG=msgHistory";; paramView = paramView + "?ADTAG=msgHistory")
      {
        ...
        awqx.b(localQQAppInterface, "dc00898", "", "", "0X800A0AE", "0X800A0AE", 0, 0, "", "", "", "");
        return;
      }
      bbmy.a(BaseApplication.getContext(), 1, 2131652967, 1).a();
      return;
    }
    awqx.b(getActivity().app, "dc00898", "", "", "0X800A17C", "0X800A17C", 2, 0, "", "", "", "");
    ChatSettingActivity.a(getActivity().app, getActivity(), this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, new afls(this), 3);
  }
