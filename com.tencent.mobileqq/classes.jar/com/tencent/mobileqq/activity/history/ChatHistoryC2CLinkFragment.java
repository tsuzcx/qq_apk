...
public class ChatHistoryC2CLinkFragment
  ...
  implements Handler.Callback, View.OnClickListener, blih
{
  ...
  public akbo a;
  private akih jdField_a_of_type_Akih;
  public Context a;
  ...
  static
  {
    jdField_b_of_type_JavaLangString = bhoa.c.pattern() + "|" + bhoa.d.pattern();
  ...
  private void r()
  {
    ...
    this.jdField_b_of_type_AndroidViewView$OnClickListener = new akbu(this);
  }
  
  void a()
  {
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131377136));
  ...
  public void a(List<ChatMessage> paramList)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        this.jdField_a_of_type_Akbo.a(this.jdField_a_of_type_JavaUtilLinkedHashMap);
        auna.b(2131691331);
  ...
  void b(boolean paramBoolean)
  {
    ...
    if (paramBoolean) {
      bdll.b(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A0B1", "0X800A0B1", 4, 0, "", "", "", "");
    }
  }
  ...
  {
    super.e();
    if ((this.jdField_a_of_type_Akbo != null) && (this.jdField_a_of_type_Akbo.getCount() == 0)) {
      this.jdField_a_of_type_Akal.a(false);
    }
    bdll.b(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A0B0", "0X800A0B0", 5, 0, "", "", "", "");
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 1: 
      this.jdField_a_of_type_Akbo.a(this.jdField_a_of_type_JavaUtilLinkedHashMap);
      if (this.jdField_a_of_type_Akbo.getCount() == 0)
      {
  ...
  protected void m()
  {
    ...
    if ((localList != null) && (localList.size() > 0))
    {
      ...
      h();
      bdll.b(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A0B2", "0X800A0B2", 4, 0, "", "", "", "");
    }
  }
  ...
  protected void n()
  {
    ...
    if (a().size() > 0)
    {
      ...
      localblir.a(new akbv(this, localblir));
      localblir.show();
      return;
    }
    auna.c(2131690655);
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    r();
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramLayoutInflater.inflate(2131558880, paramViewGroup, false));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131366047));
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131378071));
    this.jdField_a_of_type_ComTencentWidgetXListView.setCacheColorHint(0);
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnScrollListener(this);
    this.jdField_b_of_type_AndroidViewView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131562950, null);
    this.jdField_b_of_type_AndroidViewView.setVisibility(0);
    this.jdField_a_of_type_ComTencentWidgetXListView.addFooterView(this.jdField_b_of_type_AndroidViewView);
    a();
    c(true);
    this.jdField_a_of_type_Akbo = new akbo(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_b_of_type_AndroidViewView$OnClickListener, this.jdField_a_of_type_AndroidViewView$OnClickListener, this, this.jdField_a_of_type_Akfq);
    this.jdField_a_of_type_Akbo.a(this.jdField_a_of_type_JavaUtilLinkedHashMap);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Akbo);
  ...
  void q()
  {
    ...
    this.jdField_a_of_type_Akih = new akih(getActivity(), this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
    this.jdField_a_of_type_Akih.a(this.jdField_a_of_type_JavaUtilArrayList);
    this.jdField_a_of_type_Akih.show();
    bdll.b(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A0B6", "0X800A0B6", 3, 0, "", "", "", "");
  }
}
