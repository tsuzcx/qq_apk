  ...
  implements View.OnClickListener
{
  ...
  {
    Object localObject = (TroopHandler)this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.b.getBusinessHandler(BusinessHandlerFactory.TROOP_HANDLER);
    String str;
    if (localObject != null)
    {
      ((TroopHandler)localObject).a(Long.parseLong(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_c_of_type_JavaLangString), this.jdField_a_of_type_JavaUtilList, this.jdField_a_of_type_AndroidWidgetCheckBox.isChecked(), this.jdField_a_of_type_Boolean);
