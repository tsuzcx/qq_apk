  ...
  implements Runnable
{
  ...
  public void run()
  {
    List localList = this.this$0.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().queryBeforeHistoryByShmsgseq(this.this$0.jdField_b_of_type_JavaLangString, 1, 9223372036854775807L, 20);
    if (localList != null) {
