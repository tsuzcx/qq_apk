...
public class ChatHistoryTroopMemberFragment
  ...
  implements Handler.Callback, bbjs, bbjt, behi
{
  ...
  public afoy a;
  public afph a;
  afpj jdField_a_of_type_Afpj = new afne(this);
  protected ajhf a;
  public ajhi a;
  public ajuc a;
  ...
  private boolean v;
  protected String w;
  private String x = ajjy.a(2131635848);
  ...
  public ChatHistoryTroopMemberFragment()
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new afnf(this);
    this.jdField_b_of_type_AndroidViewView$OnClickListener = new afnh(this);
    this.jdField_m_of_type_Int = 0;
    this.jdField_p_of_type_Boolean = true;
    this.jdField_a_of_type_Begw = new afnx(this);
    this.jdField_b_of_type_AndroidOsHandler = new afod(this);
    this.jdField_c_of_type_AndroidViewView$OnClickListener = new afoe(this);
    this.jdField_a_of_type_Double = 0.0D;
    this.jdField_n_of_type_Int = -1;
    this.jdField_u_of_type_JavaLangString = "";
    this.jdField_v_of_type_JavaLangString = "";
    this.jdField_d_of_type_AndroidViewView$OnClickListener = new afof(this);
    this.jdField_a_of_type_Ajhi = new afoj(this);
    this.jdField_a_of_type_Ajuc = new afok(this);
  }
  ...
  private void D()
  {
    if (this.jdField_a_of_type_Bemi == null)
    {
      ...
      this.jdField_a_of_type_Bemi = bemi.a(getActivity(), localArrayList, new afoi(this), null, vms.a(getActivity(), 135.0F), false);
      this.jdField_a_of_type_Bemi.setTouchInterceptor(new afop(this));
      c(this.jdField_m_of_type_Int);
    }
    this.jdField_a_of_type_Bemi.showAsDropDown(this.jdField_b_of_type_AndroidWidgetImageView, -(vms.a(getActivity(), 135.0F) - this.jdField_b_of_type_AndroidWidgetImageView.getWidth()), 0);
  }
  ...
  private void F()
  {
    ...
    this.jdField_g_of_type_AndroidViewView = getActivity().getLayoutInflater().inflate(2131496950, this.jdField_a_of_type_ComTencentWidgetPinnedDividerSwipListView, false);
    TextView localTextView = (TextView)this.jdField_g_of_type_AndroidViewView.findViewById(2131302441);
    ...
    {
      localObject = (afou)localIterator.next();
      if (((afou)localObject).jdField_b_of_type_Long == 0L) {
        ((afou)localObject).jdField_b_of_type_Long = ((afou)localObject).jdField_a_of_type_Long;
      }
      if (TextUtils.isEmpty(a(((afou)localObject).jdField_b_of_type_Long, localCalendar, this.jdField_d_of_type_JavaUtilArrayList, this.jdField_c_of_type_JavaUtilArrayList))) {
        break label362;
      }
      i1 += 1;
    }
    ...
    for (;;)
    {
      ...
      for (int i2 = 0;; i2 = 1)
      {
        this.jdField_g_of_type_AndroidViewView.setOnClickListener(new afns(this, i1, i2));
        G();
        this.jdField_a_of_type_ComTencentWidgetPinnedDividerSwipListView.addHeaderView(this.jdField_g_of_type_AndroidViewView);
        awqx.b(getActivity().app, "dc00899", "Grp_mber", "", "mber_list", "exp_inacmem", 0, 0, this.jdField_c_of_type_JavaLangString, "" + i2, "", "");
        return;
      }
    }
  }
  ...
  private void G()
  {
    ...
    {
      localObject = this.jdField_g_of_type_AndroidViewView.findViewById(2131309511);
  ...
  private void H()
  {
    ...
    this.jdField_d_of_type_AndroidAppDialog.setContentView(2131496769);
    ...
    if ((ImmersiveUtils.isSupporImmersive() == 1) && (Build.VERSION.SDK_INT < 24))
    {
      ...
      View localView = this.jdField_d_of_type_AndroidAppDialog.findViewById(2131309736);
      localView.setFitsSystemWindows(true);
      localView.setPadding(0, ImmersiveUtils.b(), 0, 0);
    }
    this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)this.jdField_d_of_type_AndroidAppDialog.findViewById(2131309910));
    ...
    this.jdField_a_of_type_Afoy = new afoy(this, this.jdField_b_of_type_JavaUtilList);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Afoy);
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnTouchListener(new afnt(this, (InputMethodManager)localObject));
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)this.jdField_d_of_type_AndroidAppDialog.findViewById(2131300167));
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new afpa(this));
    this.jdField_d_of_type_AndroidViewView = this.jdField_d_of_type_AndroidAppDialog.findViewById(2131309736);
    this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)this.jdField_d_of_type_AndroidAppDialog.findViewById(2131302060));
    this.jdField_c_of_type_AndroidViewView = this.jdField_d_of_type_AndroidAppDialog.findViewById(2131305203);
    this.jdField_c_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_d_of_type_AndroidAppDialog.findViewById(2131309439));
    this.jdField_a_of_type_AndroidWidgetImageButton.setOnClickListener(new afnu(this));
    this.jdField_c_of_type_AndroidWidgetRelativeLayout.setOnClickListener(new afnv(this));
  }
  
  private void I()
  {
    int i1 = this.jdField_a_of_type_Afow.jdField_b_of_type_JavaUtilList.size();
    if (i1 > 0)
    {
      String str = MessageFormat.format(ajjy.a(2131635823), new Object[] { Integer.valueOf(i1) });
      this.jdField_a_of_type_AndroidWidgetTextView.setEnabled(true);
      this.jdField_a_of_type_AndroidWidgetTextView.setText(str);
      this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new afnz(this));
      return;
    }
    this.jdField_a_of_type_AndroidWidgetTextView.setEnabled(false);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(ajjy.a(2131635835));
  }
  ...
  private void a(int paramInt1, int paramInt2, int paramInt3)
  {
    if ((this.jdField_d_of_type_Int == 20) || (this.jdField_d_of_type_Int == 21)) {
      this.jdField_e_of_type_AndroidWidgetTextView.setText(String.format(ajjy.a(2131635845), new Object[] { Integer.valueOf(paramInt3) }));
    }
    for (;;)
    {
      this.jdField_a_of_type_AndroidWidgetProgressBar.setProgress(paramInt3);
      return;
      this.jdField_e_of_type_AndroidWidgetTextView.setText(String.format(ajjy.a(2131635813), new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt2) }));
    }
  }
  ...
  private void a(Message paramMessage)
  {
    ...
    {
      this.jdField_a_of_type_Afow.jdField_a_of_type_JavaUtilLinkedHashMap = ((LinkedHashMap)paramMessage[0]);
      this.jdField_a_of_type_Afow.jdField_a_of_type_ArrayOfInt = ((int[])paramMessage[1]);
      this.jdField_a_of_type_Afow.jdField_a_of_type_ArrayOfJavaLangString = ((String[])paramMessage[2]);
      ...
      if (this.jdField_a_of_type_JavaUtilList.size() != 0)
      {
        ...
        this.jdField_a_of_type_Afow.notifyDataSetChanged();
    ...
    for (;;)
    {
      ...
      label302:
      this.jdField_a_of_type_Afow = new afow(this);
      this.jdField_a_of_type_ComTencentWidgetPinnedDividerSwipListView.setAdapter(this.jdField_a_of_type_Afow);
    }
  }
  ...
  private void a(List<Long> paramList)
  {
    ...
    for (;;)
    {
      ...
      localTextView.setOnClickListener(new afog(this, localDialog));
      ((TextView)localObject).setOnClickListener(new afoh(this, paramList, localCheckBox, bool, localDialog));
      localDialog.show();
      return;
      bool = false;
      break;
  ...
  private void a(List<TroopMemberInfo> paramList, int paramInt)
  {
    ...
    ajjj localajjj = (ajjj)this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
    azks localazks = (azks)this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getManager(203);
  ...
  private void a(boolean paramBoolean1, String paramString1, boolean paramBoolean2, int paramInt1, int paramInt2, String paramString2, String paramString3, boolean paramBoolean3)
  {
    ...
    if ((this.jdField_d_of_type_Int == 3) && (!this.jdField_d_of_type_Boolean) && (this.jdField_b_of_type_Int != 1))
    {
      ...
      if ((!this.jdField_d_of_type_Boolean) && (paramBoolean3) && (this.jdField_b_of_type_AndroidWidgetRelativeLayout != null))
      {
        ...
        if (i1 != 0)
        {
          ...
          ((ImageView)localObject3).setOnClickListener(new afol(this));
          ((TextView)localObject2).setTextSize(12.0F);
        }
        this.jdField_b_of_type_AndroidWidgetRelativeLayout.setOnClickListener(new afom(this, (String)localObject1));
    ...
    do
    {
      ...
      localObject2 = ajjy.a(2131635807);
      ...
      ((Button)localObject3).setOnClickListener(new afon(this));
      i1 = ((ajrm)this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a(13)).g();
    ...
    if ((paramBoolean2) && (paramInt1 > 0))
    {
      ...
      this.jdField_h_of_type_JavaLangString = (ajjy.a(2131635855) + paramInt1 + ajjy.a(2131635873));
    ...
    for (paramString2 = paramString1;; paramString2 = (String)localObject2 + "," + paramString1)
    {
      ...
      if (paramInt1 == 0)
      {
        this.jdField_h_of_type_JavaLangString = ajjy.a(2131635862);
        paramString1 = (String)localObject2 + ",剩余0次";
        ((TextView)localObject1).setText("剩余0次");
        break label615;
      }
      this.jdField_h_of_type_JavaLangString = "";
      paramString1 = (String)localObject2 + "," + ajjy.a(2131635853);
      ...
      if (!this.jdField_i_of_type_Boolean)
      {
        ...
        if (i1 != 3)
        {
          ...
          paramInt1 = (int)(ajjy.a(2131635880).length() * 12 * this.jdField_a_of_type_Float);
          new DisplayMetrics();
      ...
      if (paramString1.contains(ajjy.a(2131635863)))
      {
        paramInt1 = paramString1.indexOf(ajjy.a(2131635799));
        paramInt2 = ajjy.a(2131635877).length();
        paramString2.setSpan(new ForegroundColorSpan(-48606), paramInt1, paramInt2 + paramInt1, 33);
      }
  ...
  void B()
  {
    ...
    {
      ViewStub localViewStub = (ViewStub)a(2131312069);
      if (localViewStub != null) {
        ((LinearLayout)localViewStub.inflate().findViewById(2131312070)).setOnTouchListener(new afoo(this));
      }
    }
  }
  ...
  public void C()
  {
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_Afow.notifyDataSetChanged();
        if (this.jdField_a_of_type_Afoy == null) {
          continue;
        }
        try
        {
          this.jdField_a_of_type_Afoy.notifyDataSetChanged();
          return;
        }
  ...
  public afou a(DiscussionMemberInfo paramDiscussionMemberInfo, ajjj paramajjj)
  {
    afou localafou = new afou();
    localafou.jdField_a_of_type_JavaLangString = paramDiscussionMemberInfo.memberUin.trim();
    Friends localFriends = null;
    if (paramajjj != null) {
      localFriends = paramajjj.b(paramDiscussionMemberInfo.memberUin);
    }
    localafou.jdField_b_of_type_JavaLangString = paramDiscussionMemberInfo.getDiscussionMemberName();
    localafou.jdField_a_of_type_Short = 0;
    localafou.jdField_c_of_type_JavaLangString = ChnToSpell.a(localafou.jdField_b_of_type_JavaLangString, 2);
    localafou.a(ChnToSpell.a(localafou.jdField_b_of_type_JavaLangString, 1));
    if ((localFriends != null) && (localFriends.isFriend()) && (localFriends.remark != null) && (localFriends.remark.length() > 0))
    {
      localafou.e(localFriends.remark);
    ...
    for (;;)
    {
      ...
      {
        localafou.i(paramDiscussionMemberInfo.memberName);
        localafou.k(ChnToSpell.a(paramDiscussionMemberInfo.memberName, 1));
        localafou.j(ChnToSpell.a(paramDiscussionMemberInfo.memberName, 2));
      }
      if (this.jdField_a_of_type_Afph != null) {
        this.jdField_a_of_type_Afph.a(localafou);
      }
      return localafou;
      if ((paramDiscussionMemberInfo.inteRemark != null) && (paramDiscussionMemberInfo.inteRemark.length() > 0))
      {
        localafou.e(paramDiscussionMemberInfo.inteRemark);
        localafou.h(ChnToSpell.a(paramDiscussionMemberInfo.inteRemark, 1));
        localafou.f(ChnToSpell.a(paramDiscussionMemberInfo.inteRemark, 2));
      }
    }
  }
  
  public afou a(TroopMemberInfo paramTroopMemberInfo, ajjj paramajjj)
  {
    afou localafou = new afou();
    ...
    localafou.jdField_b_of_type_JavaLangString = babh.c(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_c_of_type_JavaLangString, localafou.jdField_a_of_type_JavaLangString, true);
    ...
    if ((localFriends != null) && (localFriends.isFriend()) && (localFriends.remark != null) && (localFriends.remark.length() > 0))
    {
      ...
      d1 = ((TroopManager)this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52)).a(this.jdField_c_of_type_JavaLangString, localafou.jdField_a_of_type_JavaLangString);
      ...
      localafou.jdField_t_of_type_JavaLangString = ((int)d1 + "km");
    }
    for (;;)
    {
      if ((paramTroopMemberInfo.mUniqueTitleExpire - NetConnInfoCenter.getServerTime() > 0L) || (paramTroopMemberInfo.mUniqueTitleExpire == -1))
      {
        localafou.jdField_u_of_type_JavaLangString = paramTroopMemberInfo.mUniqueTitle;
        localafou.jdField_b_of_type_Int = paramTroopMemberInfo.mUniqueTitleExpire;
      }
      if (this.jdField_a_of_type_Afph != null) {
        this.jdField_a_of_type_Afph.a(localafou);
      }
      localafou.jdField_e_of_type_Int = paramTroopMemberInfo.mVipType;
      localafou.jdField_f_of_type_Int = paramTroopMemberInfo.mVipLevel;
      ...
      {
        localafou.e(TroopInfo.QIDIAN_TROOP_MEMBER_DEF_NICK);
        localafou.h(ChnToSpell.a(TroopInfo.QIDIAN_TROOP_MEMBER_DEF_NICK, 1));
        localafou.f(ChnToSpell.a(TroopInfo.QIDIAN_TROOP_MEMBER_DEF_NICK, 2));
        break;
      }
      localafou.e(paramTroopMemberInfo.autoremark);
      localafou.h(paramTroopMemberInfo.pyAll_autoremark);
      localafou.f(paramTroopMemberInfo.pyFirst_autoremark);
      break;
      label660:
      localafou.jdField_t_of_type_JavaLangString = (this.jdField_a_of_type_JavaTextDecimalFormat.format(d1) + "km");
      continue;
      label695:
      localafou.jdField_t_of_type_JavaLangString = "";
    }
  }
  
  public afou a(String paramString)
  {
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          afou localafou = (afou)this.jdField_a_of_type_JavaUtilList.get(i1);
          if ((localafou != null) && (localafou.jdField_a_of_type_JavaLangString.equals(paramString)))
          {
            paramString = (afou)this.jdField_a_of_type_JavaUtilList.remove(i1);
            return paramString;
          }
        }
        else
  ...
  public afpb a(String paramString, boolean paramBoolean)
  {
    Object localObject1;
    int i2;
    int i1;
    ...
    for (;;)
    {
      ...
      if ((((View)localObject2).getTag() != null) && ((((View)localObject2).getTag() instanceof afpb)))
      {
        localObject2 = (afpb)((View)localObject2).getTag();
        if ((((afpb)localObject2).jdField_a_of_type_JavaLangString != null) && (((afpb)localObject2).jdField_a_of_type_JavaLangString.equals(paramString)))
        {
          if (QLog.isColorLevel()) {
  ...
  public List<afou> a(List<afou> paramList, String paramString1, String paramString2)
  {
    int i5 = 1;
    ...
    if (i6 > 0)
    {
      ...
      if (i1 < i6)
      {
        afou localafou = (afou)paramList.get(i1);
        if ((paramString1 != null) && (paramString1.equals(localafou.jdField_a_of_type_JavaLangString)))
        {
          paramList.remove(i1);
          paramList.add(0, localafou);
        }
      }
      else
      {
        ...
        paramString1 = (afou)paramList.get(i3);
    ...
    for (int i1 = i2 + 1;; i1 = i2)
    {
      ...
      if (i4 < i6)
      {
        paramString1 = (afou)paramList.get(i4);
      ...
      for (;;)
      {
        ...
        if (i2 < i6)
        {
          paramString1 = (afou)paramList.get(i2);
  ...
  protected void a()
  {
    Object localObject = (ViewGroup)a(2131309578);
    if (localObject != null) {
      IphoneTitleBarActivity.setLayerType((View)localObject);
    }
    localObject = a(2131311553);
    if (localObject != null) {
      IphoneTitleBarActivity.setLayerType((View)localObject);
    }
    localObject = (TextView)a(2131302804);
    if (localObject != null) {
      IphoneTitleBarActivity.setLayerType((View)localObject);
    }
  }
  ...
  void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    Object localObject1 = (ajjj)this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
    ...
    do
    {
      do
      {
        do
        {
          for (;;)
          {
            ...
            ThreadManager.post(new ChatHistoryTroopMemberFragment.2(this, paramIntent, (ajjj)localObject1, (TroopManager)localObject2), 8, null, true);
            return;
            if (paramIntent != null)
            {
      ...
      localObject1 = babh.a(getActivity().app, getActivity().getApplicationContext(), paramIntent);
      localObject2 = aciy.a(new Intent(getActivity(), SplashActivity.class), null);
    ...
    ThreadManager.post(new ChatHistoryTroopMemberFragment.3(this, (ajjj)localObject1), 8, null, true);
  }
  
  public void a(afou paramafou)
  {
    if ((paramafou != null) && (paramafou.jdField_c_of_type_Boolean))
    {
      this.jdField_a_of_type_Afow.jdField_a_of_type_JavaUtilList.clear();
      paramafou = new Intent();
      paramafou.putExtra("result", new JSONArray().toString());
      getActivity().setResult(-1, paramafou);
      awqx.b(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_work", "", "create", "Clk_none", 0, 0, this.jdField_c_of_type_JavaLangString, "", "", "");
      getActivity().finish();
    }
    label98:
    do
    {
      do
      {
        ...
        do
        {
          ...
          {
            return;
          } while ((paramafou == null) || (paramafou.jdField_a_of_type_JavaLangString == null));
          if (this.jdField_d_of_type_Int == 1)
          {
            if (this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin().equals(paramafou.jdField_a_of_type_JavaLangString))
            {
              localObject1 = new ProfileActivity.AllInOne(paramafou.jdField_a_of_type_JavaLangString, 0);
              ((ProfileActivity.AllInOne)localObject1).jdField_h_of_type_JavaLangString = babh.h(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, paramafou.jdField_a_of_type_JavaLangString);
            ...
            a(paramafou.jdField_a_of_type_JavaLangString, paramafou.jdField_b_of_type_JavaLangString);
            return;
          }
          if (this.jdField_d_of_type_Int == 2)
          {
            ...
            ((Intent)localObject1).putExtra("member_uin", paramafou.jdField_a_of_type_JavaLangString);
            localObject2 = new TroopMemberListActivity.TroopAdmin();
            ((TroopMemberListActivity.TroopAdmin)localObject2).jdField_a_of_type_JavaLangString = paramafou.jdField_a_of_type_JavaLangString;
            ((TroopMemberListActivity.TroopAdmin)localObject2).jdField_a_of_type_Short = paramafou.jdField_a_of_type_Short;
            ((TroopMemberListActivity.TroopAdmin)localObject2).jdField_b_of_type_JavaLangString = paramafou.jdField_b_of_type_JavaLangString;
          ...
          if ((this.jdField_d_of_type_Int == 3) || (this.jdField_d_of_type_Int == 11) || (this.jdField_d_of_type_Int == 16))
          {
            ...
            if (this.jdField_s_of_type_Boolean)
            {
              ((Intent)localObject1).putExtra("member_display_name", paramafou.jdField_b_of_type_JavaLangString);
          ...
          g(paramafou.jdField_a_of_type_JavaLangString);
        } while (this.jdField_d_of_type_Int != 22);
        azzx.a("Grp_idol", "mber_list", "clk", 0, 0, new String[] { this.jdField_c_of_type_JavaLangString });
        return;
        if (this.jdField_d_of_type_Int == 5)
        {
          int i1;
          if ((this.jdField_f_of_type_JavaLangString != null) && (this.jdField_f_of_type_JavaLangString.equals(paramafou.jdField_a_of_type_JavaLangString)))
          {
            i1 = 3;
            startActivityForResult(EditUniqueTitleActivity.a(getActivity(), 1, this.jdField_c_of_type_JavaLangString, paramafou.jdField_a_of_type_JavaLangString, i1, paramafou.jdField_u_of_type_JavaLangString), 2);
            this.w = paramafou.jdField_a_of_type_JavaLangString;
          ...
          for (paramafou = "1";; paramafou = "0")
          {
            awqx.b((QQAppInterface)localObject1, "P_CliOper", "Grp_manage", "", "mber_title", "Clk_person_list", 0, 0, (String)localObject2, String.valueOf(i1), paramafou, "");
            return;
            if ((this.jdField_g_of_type_JavaLangString != null) && (this.jdField_g_of_type_JavaLangString.contains(paramafou.jdField_a_of_type_JavaLangString)))
            {
              i1 = 2;
              break;
            }
        ...
        if ((this.jdField_d_of_type_Int == 12) || (this.jdField_d_of_type_Int == 20))
        {
          ...
          {
            this.jdField_a_of_type_Afow.jdField_a_of_type_JavaUtilList.clear();
            this.jdField_a_of_type_Afow.jdField_a_of_type_JavaUtilList.add(paramafou);
            paramafou = new Intent();
            localObject1 = new JSONArray();
            if (this.jdField_a_of_type_Afow.jdField_a_of_type_JavaUtilList != null)
            {
              localObject2 = this.jdField_a_of_type_Afow.jdField_a_of_type_JavaUtilList.iterator();
              for (;;)
              {
                if (((Iterator)localObject2).hasNext())
                {
                  afou localafou = (afou)((Iterator)localObject2).next();
                  JSONObject localJSONObject = new JSONObject();
                  try
                  {
                    localJSONObject.put("uin", localafou.jdField_a_of_type_JavaLangString);
                    localJSONObject.put("nick", localafou.jdField_b_of_type_JavaLangString);
            ...
            paramafou.putExtra("result", ((JSONArray)localObject1).toString());
            getActivity().setResult(-1, paramafou);
            getActivity().finish();
            return;
          }
          if (this.jdField_a_of_type_Afow.jdField_a_of_type_JavaUtilList.contains(paramafou)) {
            this.jdField_a_of_type_Afow.jdField_a_of_type_JavaUtilList.remove(paramafou);
          }
          for (;;)
          {
            this.jdField_a_of_type_Afow.notifyDataSetChanged();
            return;
            if (this.jdField_a_of_type_Afow.jdField_a_of_type_JavaUtilList.size() < this.jdField_f_of_type_Int)
            {
              this.jdField_a_of_type_Afow.jdField_a_of_type_JavaUtilList.add(paramafou);
            }
            ...
            {
              paramafou = getResources().getString(this.jdField_h_of_type_Int, new Object[] { Integer.valueOf(this.jdField_f_of_type_Int) });
              bbmy.a(getActivity(), paramafou, 0).a();
            }
          }
        }
        ...
        awqx.b(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800A596", "0X800A596", 1, 0, "", "", "", "");
      } while (this.jdField_d_of_type_Int != 19);
      paramafou = ((TroopManager)this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52)).b(this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      azzx.a("Grp_edu", "teachermsg", "showsomeone", 0, 0, new String[] { this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, azzx.a(paramafou) });
      return;
    ...
    ((Intent)localObject1).putExtra("filter_member_name", paramafou.jdField_g_of_type_JavaLangString);
    ((Intent)localObject1).putExtra("filter_uin", Long.valueOf(paramafou.jdField_a_of_type_JavaLangString));
  ...
  public void a(afpb paramafpb, afou paramafou, Bitmap paramBitmap, boolean paramBoolean1, boolean paramBoolean2)
  {
    String str;
    label76:
    Object localObject;
    ...
    if (paramBoolean1)
    {
      ...
      paramafpb.jdField_a_of_type_Boolean = paramBoolean1;
      paramafpb.jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setVisibility(0);
      paramafpb.jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
      paramafpb.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
      paramafpb.jdField_c_of_type_AndroidWidgetImageView.setImageBitmap(paramBitmap);
      if (this.jdField_m_of_type_Int != 1) {
        break label843;
      }
      if (paramafou.jdField_d_of_type_Boolean) {
        break label830;
      }
      paramafpb.jdField_c_of_type_AndroidWidgetImageView.setAlpha(165);
      if ((this.jdField_e_of_type_Boolean) || (a()) || (paramafou.jdField_d_of_type_Int == -100) || (paramafou.jdField_d_of_type_Int == 0)) {
        break label865;
      }
      paramafpb.j.setVisibility(8);
      paramafpb.j.setText("LV" + paramafou.jdField_d_of_type_Int);
      bajr.a(getActivity().app, getActivity(), getResources(), paramafpb, paramafou);
      if ((this.jdField_d_of_type_Int != 13) || (!paramBoolean1)) {
        break label877;
      }
      paramBitmap = paramafou.jdField_b_of_type_JavaLangString + "(" + paramafou.jdField_a_of_type_JavaLangString + ")";
      localObject = new SpannableString(paramBitmap);
      ((SpannableString)localObject).setSpan(new ForegroundColorSpan(-7829368), paramafou.jdField_b_of_type_JavaLangString.length(), paramBitmap.length(), 18);
      paramafpb.jdField_e_of_type_AndroidWidgetTextView.setText((CharSequence)localObject);
      label263:
      if ((paramBoolean2) && (paramafpb.k != null))
      {
        paramBitmap = ajjy.a(2131635801) + paramafou.jdField_j_of_type_JavaLangString;
        paramafpb.k.setText(paramBitmap);
      }
      paramafpb.jdField_a_of_type_JavaLangString = paramafou.jdField_a_of_type_JavaLangString;
      paramafpb.jdField_c_of_type_Int = 1;
      paramafpb.f.setText("");
      paramafpb.jdField_c_of_type_AndroidViewView.setTag(Boolean.valueOf(paramBoolean1));
      if (this.jdField_d_of_type_Int != 9) {
        break label962;
      }
      paramafpb.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
      paramafpb.g.setOnClickListener(this.jdField_d_of_type_AndroidViewView$OnClickListener);
      paramafpb.jdField_b_of_type_AndroidViewView.setOnClickListener(this.jdField_d_of_type_AndroidViewView$OnClickListener);
      paramafpb.jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setOnClickListener(this.jdField_c_of_type_AndroidViewView$OnClickListener);
      if ((!this.jdField_f_of_type_Boolean) && (!this.jdField_g_of_type_Boolean)) {
        break label977;
      }
      paramafpb.jdField_a_of_type_AndroidViewView.setOnClickListener(this.jdField_d_of_type_AndroidViewView$OnClickListener);
      paramafpb.jdField_a_of_type_AndroidViewView.setClickable(true);
      if (this.jdField_g_of_type_Boolean) {
        paramafpb.jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setOnClickListener(null);
      }
      label443:
      i2 = 0;
      ...
      paramafpb.jdField_e_of_type_AndroidWidgetTextView.setContentDescription(getString(2131626292) + paramafpb.jdField_e_of_type_AndroidWidgetTextView.getText().toString());
      paramafpb.jdField_c_of_type_AndroidViewView.setBackgroundResource(2130848381);
      if (this.jdField_d_of_type_Int != 13) {
        break label1024;
      }
      paramafpb.jdField_b_of_type_AndroidViewView.setVisibility(0);
      label532:
      if (!str.equals(paramafou.jdField_a_of_type_JavaLangString)) {
        break label1096;
      }
      paramafpb.jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.a(false);
    }
    int i1;
    for (;;)
    {
      paramafpb.jdField_b_of_type_AndroidViewView.setContentDescription(String.format(getString(2131626270), new Object[] { paramafpb.jdField_e_of_type_AndroidWidgetTextView.getText().toString() }));
      paramafpb.g.setContentDescription(getString(2131626269));
      i1 = i2;
      if (paramafpb.jdField_d_of_type_AndroidViewView != null)
      {
        paramBitmap = (azks)this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getManager(203);
        if ((paramBitmap == null) || (!paramBitmap.b(paramafou.jdField_a_of_type_JavaLangString))) {
          break label2269;
        }
        i2 = 1;
        label645:
        ...
        paramafpb.jdField_d_of_type_AndroidViewView.setVisibility(0);
      }
      label658:
      ...
      paramBitmap.append(paramafpb.jdField_e_of_type_AndroidWidgetTextView.getText().toString());
      if ((paramBoolean2) && (paramafpb.k != null)) {
        paramBitmap.append(paramafpb.k.getText());
      }
      if (paramafpb.jdField_c_of_type_AndroidWidgetTextView.getVisibility() == 0) {
        paramBitmap.append(paramafpb.jdField_c_of_type_AndroidWidgetTextView.getText().toString());
      }
      if (paramafpb.j.getVisibility() == 0) {
        paramBitmap.append(paramafpb.j.getText().toString());
      }
      if ((paramafpb.jdField_b_of_type_AndroidViewView.getVisibility() == 0) && (this.jdField_g_of_type_Boolean))
      {
        if (i1 == 0) {
          break label2287;
        }
        paramafou = "已选中";
        label803:
        paramBitmap.append(paramafou);
      }
      paramafpb.jdField_a_of_type_AndroidViewView.setContentDescription(paramBitmap.toString());
      return;
      str = this.jdField_u_of_type_JavaLangString;
      break;
      label830:
      paramafpb.jdField_c_of_type_AndroidWidgetImageView.setAlpha(255);
      break label76;
      label843:
      paramafpb.jdField_c_of_type_AndroidWidgetImageView.setAlpha(255);
      paramafpb.j.setVisibility(8);
      ...
      if (paramBoolean2)
      {
        paramBitmap = new axjq(paramafou.jdField_g_of_type_JavaLangString, 16).a();
        paramafpb.jdField_e_of_type_AndroidWidgetTextView.setText(paramBitmap);
        bami.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, paramafpb.jdField_e_of_type_AndroidWidgetTextView, paramBitmap);
        break label263;
      }
      paramBitmap = new axjq(paramafou.jdField_b_of_type_JavaLangString, 16).a();
      paramafpb.jdField_e_of_type_AndroidWidgetTextView.setText(paramBitmap);
      bami.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, paramafpb.jdField_e_of_type_AndroidWidgetTextView, paramBitmap);
      break label263;
      label962:
      paramafpb.jdField_c_of_type_AndroidWidgetTextView.setTag(Boolean.valueOf(paramBoolean1));
      break label362;
      label977:
      if (this.jdField_d_of_type_Int == 21)
      {
        paramafpb.jdField_a_of_type_AndroidViewView.setOnClickListener(null);
        paramafpb.jdField_a_of_type_AndroidViewView.setClickable(false);
        break label443;
      }
      paramafpb.jdField_a_of_type_AndroidViewView.setOnClickListener(null);
      paramafpb.jdField_a_of_type_AndroidViewView.setClickable(false);
      ...
      if ((this.jdField_f_of_type_JavaLangString != null) && (!paramafou.jdField_a_of_type_JavaLangString.equals(this.jdField_f_of_type_JavaLangString)))
      {
        paramafpb.jdField_b_of_type_AndroidViewView.setVisibility(0);
        break label532;
      }
      paramafpb.jdField_b_of_type_AndroidViewView.setVisibility(8);
      paramafpb.jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.b(false);
      break label532;
      label1096:
      paramafpb.jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.b(false);
    }
    label1107:
    paramafpb.jdField_c_of_type_AndroidWidgetTextView.setText("");
    label1129:
    boolean bool1;
    label1153:
    boolean bool2;
    ...
    boolean bool5;
    int i3;
    if (!TextUtils.isEmpty(paramafou.jdField_u_of_type_JavaLangString))
    {
      paramBoolean1 = true;
      if ((paramafou.jdField_a_of_type_JavaLangString == null) || (!paramafou.jdField_a_of_type_JavaLangString.equals(this.jdField_f_of_type_JavaLangString))) {
        break label1419;
      }
      bool1 = true;
      if ((this.jdField_g_of_type_JavaLangString == null) || (paramafou.jdField_a_of_type_JavaLangString == null) || (!this.jdField_g_of_type_JavaLangString.contains(paramafou.jdField_a_of_type_JavaLangString))) {
        break label1425;
      }
      bool2 = true;
      ...
      bool5 = this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin().equals(paramafou.jdField_a_of_type_JavaLangString);
      if (this.jdField_d_of_type_Int != 5) {
        break label1550;
      }
      paramafpb.h.setVisibility(0);
      paramafpb.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
      paramafpb.i.setVisibility(0);
      localObject = "";
      i3 = 0;
      if (!paramBoolean1) {
        break label1431;
      ...
      paramBitmap = paramafou.jdField_u_of_type_JavaLangString;
    }
    for (;;)
    {
      label1292:
      ...
      {
        paramafpb.h.setText(paramBitmap);
        ayqn.a(paramafpb.h, i1);
      }
      for (;;)
      {
        label1316:
      ...
      for (;;)
      {
        ...
        {
          paramafpb.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
          paramafpb.jdField_c_of_type_AndroidWidgetTextView.setText(paramBitmap);
          ayqn.a(paramafpb.jdField_c_of_type_AndroidWidgetTextView, i1);
          label1665:
          if (this.jdField_e_of_type_Boolean)
          {
            paramBitmap = ayqn.a().a(paramafou.jdField_a_of_type_Int, false, false, false);
            if ((paramBitmap == null) || (!azgh.a(paramafou.jdField_a_of_type_Int))) {
              break label1960;
            }
            if (TextUtils.isEmpty(paramBitmap.jdField_a_of_type_JavaLangString)) {
              break label1948;
            }
            paramafpb.jdField_d_of_type_AndroidWidgetTextView.setVisibility(0);
            paramafpb.jdField_d_of_type_AndroidWidgetTextView.setText(paramBitmap.jdField_a_of_type_JavaLangString);
            ayqn.a(paramafpb.jdField_d_of_type_AndroidWidgetTextView, paramBitmap.jdField_b_of_type_Int);
          }
        }
        for (;;)
        {
          ...
          if ((paramafou.jdField_a_of_type_JavaLangString == null) || (!paramafou.jdField_a_of_type_JavaLangString.equals(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))) {
            break label1972;
          }
          paramafpb.f.setText(getString(2131628854));
          break;
          localObject = ayqn.a().a(paramafou.jdField_a_of_type_Int, paramBoolean1, bool1, bool2);
          if (localObject != null)
          {
            paramBitmap = ((ayqo)localObject).jdField_a_of_type_JavaLangString;
            ...
            paramBitmap = (String)this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo.getTroopLevelMap().get(Integer.valueOf(paramafou.jdField_c_of_type_Int));
            i1 = i3;
            break label1614;
          }
          if (paramafou.jdField_a_of_type_Int != 315) {
            break label2294;
          }
          paramBitmap = (String)this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo.getTroopLevelMap().get(Integer.valueOf(paramafou.jdField_c_of_type_Int));
          ...
          break label1665;
          label1948:
          paramafpb.jdField_d_of_type_AndroidWidgetTextView.setVisibility(8);
          continue;
          label1960:
          paramafpb.jdField_d_of_type_AndroidWidgetTextView.setVisibility(8);
        }
        ...
        if (this.jdField_g_of_type_Boolean)
        {
          ...
          for (;;)
          {
            ...
            label2106:
            paramafpb.jdField_b_of_type_AndroidViewView.setVisibility(0);
            if ((paramafou.jdField_a_of_type_JavaLangString != null) && (this.jdField_a_of_type_Afow.jdField_b_of_type_JavaUtilList.contains(paramafou.jdField_a_of_type_JavaLangString)))
            {
              paramafpb.jdField_c_of_type_AndroidViewView.setBackgroundResource(2130840158);
              i1 = 1;
            }
            else
            {
              paramafpb.jdField_c_of_type_AndroidViewView.setBackgroundResource(2130840154);
              i1 = 0;
            }
          }
        }
        ...
        {
          paramafpb.jdField_b_of_type_AndroidViewView.setVisibility(0);
          if ((paramafou.jdField_a_of_type_JavaLangString != null) && (this.jdField_a_of_type_Afow.jdField_a_of_type_JavaUtilList.contains(paramafou)))
          {
            paramafpb.jdField_c_of_type_AndroidViewView.setBackgroundResource(2130840158);
            i1 = 1;
            break;
        ...
        break label645;
        label2275:
        paramafpb.jdField_d_of_type_AndroidViewView.setVisibility(8);
        break label658;
        label2287:
        paramafou = "未选中";
        break label803;
  ...
  public void a(String paramString)
  {
    ...
    {
      return;
      i1 = this.jdField_a_of_type_Afow.a(paramString);
    } while (i1 == -1);
  ...
  public void a(String paramString, int paramInt)
  {
    if ("$".equals(paramString)) {
      if ((this.jdField_d_of_type_Int == 11) && (paramInt == 1)) {
        awqx.b(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800621B", "0X800621B", 0, 0, "", "", "", "");
      }
    }
    while ((this.jdField_d_of_type_Int != 11) || (paramInt != 0)) {
      return;
    }
    awqx.b(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800621A", "0X800621A", 0, 0, "", "", "", "");
  }
  
  protected void a(String paramString1, String paramString2)
  {
    paramString2 = (ajjj)this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
  ...
  public void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    catch (Exception paramString1)
    {
      ...
      label179:
      awqx.b(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_mber", "", "mber_list", paramString1, 0, 0, this.jdField_c_of_type_JavaLangString, paramString2, paramString3, "");
    }
    awqx.b(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_pay", "", paramString2, paramString1, 0, 0, this.jdField_c_of_type_JavaLangString, paramString3, "", "");
    return;
  }
  ...
  public void a(String paramString, List<TroopMemberInfo> paramList)
  {
    ...
    //   94: invokevirtual 2004	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Latmq;
    //   97: invokevirtual 2010	atmq:createEntityManager	()Latmp;
    //   100: astore 8
    //   102: aload 8
    //   104: iconst_1
    //   105: ldc_w 980
    //   108: invokevirtual 2015	java/lang/Class:getSimpleName	()Ljava/lang/String;
    //   111: bipush 19
    ...
    //   536: pop
    //   537: aload_1
    //   538: invokeinterface 2066 1 0
    //   543: ifne -268 -> 275
    //   546: aload_1
    //   547: invokeinterface 2069 1 0
    //   552: aload 8
    //   554: invokevirtual 2070	atmp:a	()V
    ...
    //   594: lsub
    //   595: invokevirtual 2075	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    ...
    //   695: new 2079	com/tencent/mobileqq/activity/history/ChatHistoryTroopMemberFragment$36
    //   698: dup
    //   699: aload_0
    //   700: aload 8
    //   702: iload_3
    ...
    //   709: isub
    //   710: iload 4
    //   712: invokestatic 2085	java/lang/Math:min	(II)I
    //   715: invokespecial 2088	com/tencent/mobileqq/activity/history/ChatHistoryTroopMemberFragment$36:<init>	(Lcom/tencent/mobileqq/activity/history/ChatHistoryTroopMemberFragment;Ljava/util/List;II)V
    //   718: bipush 8
    //   720: aconst_null
    //   721: iconst_1
    ...
    //   808: aload_1
    //   809: invokevirtual 1991	java/lang/Exception:toString	()Ljava/lang/String;
    ...
    //   853: aload_1
    //   854: invokevirtual 2095	java/lang/OutOfMemoryError:toString	()Ljava/lang/String;
  ...
  {
    if ((paramArrayOfInt == null) || (paramArrayOfInt.length == 0) || (this.jdField_a_of_type_Afow == null)) {
      break label16;
    }
    label16:
    while (this.jdField_a_of_type_Afow.jdField_b_of_type_Int + this.jdField_a_of_type_Afow.jdField_c_of_type_Int > 16) {
      return;
    }
    int i3 = 1;
    int i1 = 0;
  ...
  protected Object[] a(String paramString)
  {
    ...
    try
    {
      ...
      try
      {
        ...
        localObject = (ajjj)this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
        this.jdField_c_of_type_JavaUtilList = ((ajhh)this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).a(paramString);
    ...
    for (;;)
    {
      ...
      localObject = this.jdField_a_of_type_Afow.a();
  ...
  public Object[] a(String paramString, List<String> paramList)
  {
    ...
    //   33: invokevirtual 2004	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Latmq;
    //   36: invokevirtual 2010	atmq:createEntityManager	()Latmp;
    //   39: astore 7
    //   41: aload_2
    ...
    //   88: aconst_null
    //   89: aconst_null
    //   90: invokevirtual 2154	atmp:a	(Ljava/lang/Class;ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    //   93: astore 8
    //   95: aload 8
    //   97: ifnull -49 -> 48
    //   100: aload 8
    ...
    //   124: aload 6
    //   126: invokevirtual 997	com/tencent/mobileqq/activity/history/ChatHistoryTroopMemberFragment:a	(Lcom/tencent/mobileqq/data/TroopMemberInfo;Lajjj;)Lafou;
    ...
    //   165: lload_3
    //   166: lsub
    //   167: invokevirtual 2075	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
  ...
  public void d(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          afou localafou = (afou)this.jdField_b_of_type_JavaUtilList.get(i1);
          if ((localafou != null) && (localafou.jdField_a_of_type_JavaLangString.equals(paramString))) {
  ...
  public void e(String paramString)
  {
    ...
    azks localazks = (azks)getActivity().app.getManager(203);
    int i1 = 0;
    for (;;)
    {
      afou localafou;
      try
      {
        ...
        localafou = (afou)this.jdField_a_of_type_JavaUtilList.get(i1);
        if ((this.jdField_v_of_type_Boolean) && (localazks.b(localafou.jdField_a_of_type_JavaLangString))) {
          break label1145;
        }
        localafou.jdField_e_of_type_JavaLangString = "";
        localafou.jdField_f_of_type_JavaLangString = "";
        if ((paramString.equals(localafou.m)) || (paramString.equals(localafou.jdField_o_of_type_JavaLangString)) || (paramString.equals(localafou.n)))
        {
          localafou.jdField_e_of_type_JavaLangString = localafou.m;
          localArrayList1.add(localafou);
          if (!QLog.isColorLevel()) {
            break label1145;
          }
          QLog.d("Q.history.BaseFragment", 2, "refreshSearchResultList:" + localafou.jdField_a_of_type_JavaLangString + "," + localafou.jdField_e_of_type_JavaLangString);
        }
      }
      finally {}
      if ((paramString.equals(localafou.jdField_j_of_type_JavaLangString)) || (paramString.equals(localafou.jdField_l_of_type_JavaLangString)) || (paramString.equals(localafou.jdField_k_of_type_JavaLangString)))
      {
        localafou.jdField_e_of_type_JavaLangString = localafou.jdField_j_of_type_JavaLangString;
        localArrayList1.add(localafou);
      }
      else if ((paramString.equals(localafou.jdField_g_of_type_JavaLangString)) || (paramString.equals(localafou.jdField_i_of_type_JavaLangString)) || (paramString.equals(localafou.jdField_h_of_type_JavaLangString)))
      {
        localafou.jdField_e_of_type_JavaLangString = localafou.jdField_g_of_type_JavaLangString;
        localArrayList1.add(localafou);
      }
      else if (paramString.equals(localafou.jdField_a_of_type_JavaLangString))
      {
        if (!this.jdField_h_of_type_Boolean)
        {
          localafou.jdField_e_of_type_JavaLangString = localafou.jdField_a_of_type_JavaLangString;
          localArrayList1.add(localafou);
        }
      }
      else if ((localafou.m.indexOf(paramString) == 0) || (localafou.jdField_o_of_type_JavaLangString.indexOf(paramString) == 0) || (localafou.n.indexOf(paramString) == 0))
      {
        localafou.jdField_e_of_type_JavaLangString = localafou.m;
        localafou.jdField_f_of_type_JavaLangString = localafou.n;
        localArrayList2.add(localafou);
      }
      else if ((localafou.jdField_j_of_type_JavaLangString.indexOf(paramString) == 0) || (localafou.jdField_l_of_type_JavaLangString.indexOf(paramString) == 0) || (localafou.jdField_k_of_type_JavaLangString.indexOf(paramString) == 0))
      {
        localafou.jdField_e_of_type_JavaLangString = localafou.jdField_j_of_type_JavaLangString;
        localafou.jdField_f_of_type_JavaLangString = localafou.jdField_k_of_type_JavaLangString;
        localArrayList2.add(localafou);
      }
      else if ((localafou.jdField_g_of_type_JavaLangString.indexOf(paramString) == 0) || (localafou.jdField_i_of_type_JavaLangString.indexOf(paramString) == 0) || (localafou.jdField_h_of_type_JavaLangString.indexOf(paramString) == 0))
      {
        localafou.jdField_e_of_type_JavaLangString = localafou.jdField_g_of_type_JavaLangString;
        localafou.jdField_f_of_type_JavaLangString = localafou.jdField_h_of_type_JavaLangString;
        localArrayList2.add(localafou);
      }
      else if (localafou.jdField_a_of_type_JavaLangString.indexOf(paramString) == 0)
      {
        if (!this.jdField_h_of_type_Boolean)
        {
          localafou.jdField_e_of_type_JavaLangString = localafou.jdField_a_of_type_JavaLangString;
          localafou.jdField_f_of_type_JavaLangString = localafou.jdField_a_of_type_JavaLangString;
          localArrayList2.add(localafou);
        }
      }
      else if ((localafou.m.indexOf(paramString) > 0) || (localafou.jdField_o_of_type_JavaLangString.indexOf(paramString) > 0) || (localafou.n.indexOf(paramString) > 0))
      ...
      else if ((localafou.jdField_a_of_type_JavaLangString.indexOf(paramString) > 0) && (!this.jdField_h_of_type_Boolean))
      {
        localafou.jdField_e_of_type_JavaLangString = localafou.jdField_a_of_type_JavaLangString;
        localArrayList3.add(localafou);
        continue;
        label967:
        Collections.sort(localArrayList2, new afoz(this));
    ...
    for (;;)
    {
      try
      {
        if (this.jdField_c_of_type_AndroidAppDialog == null)
        {
          ...
          this.jdField_c_of_type_AndroidAppDialog.setContentView(2131492892);
          Dialog localDialog = this.jdField_c_of_type_AndroidAppDialog;
          if (this.jdField_d_of_type_Int != 1)
          {
            localDialog.setCancelable(bool);
            ((TextView)this.jdField_c_of_type_AndroidAppDialog.findViewById(2131299579)).setText(getString(2131626268));
          }
        }
        else
        {
          this.jdField_c_of_type_AndroidAppDialog.show();
          this.jdField_a_of_type_Ajhf.b(Long.parseLong(this.jdField_b_of_type_JavaLangString), Long.valueOf(paramString).longValue());
          return;
        }
      }
      catch (Exception paramString)
  ...
  {
    if (((azks)this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getManager(203)).a(getActivity(), this.jdField_c_of_type_JavaLangString, Long.parseLong(paramString))) {
      return;
    }
    ...
    atxx.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, getActivity(), this.jdField_c_of_type_JavaLangString, paramString, 1, 1, localBundle);
    this.w = paramString;
  ...
  {
    paramLayoutInflater = paramLayoutInflater.inflate(2131496947, paramViewGroup, false);
  ...
  public void onDestroy()
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Afph != null)
      {
        this.jdField_a_of_type_Afph.c();
        this.jdField_a_of_type_Afph = null;
      }
      try
      {
        getActivity().removeObserver(this.jdField_a_of_type_Ajhi);
        getActivity().removeObserver(this.jdField_a_of_type_Ajuc);
        label58:
        if (this.jdField_a_of_type_Afoy != null) {
          this.jdField_a_of_type_Afoy.c();
        }
        super.g();
  ...
  public void onResume()
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Afph != null) {
        this.jdField_a_of_type_Afph.a();
      }
      awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A0B9", "0X800A0B9", 7, 0, "", "", "", "");
      return;
    }
    catch (Exception localException)
    {
  ...
  public void onViewCreated(View paramView, Bundle paramBundle)
  {
    ...
    this.jdField_h_of_type_Int = paramView.getInt("param_pick_max_num_exceeds_wording", 2131632104);
    ...
    if (this.jdField_d_of_type_Int == 17) {
      new awrb(getActivity().app).a("dc00899").b("Grp_online").c("mber_list").d("exp_onlineList").a(1).a(new String[] { this.jdField_c_of_type_JavaLangString }).a();
    }
    if (this.jdField_d_of_type_Int == 22) {
      azzx.a("Grp_idol", "mber_list", "exp", 0, 0, new String[] { this.jdField_c_of_type_JavaLangString });
    }
    ...
    try
    {
      ...
      if (this.jdField_m_of_type_Boolean) {
        getActivity().setTheme(2131689611);
      }
    ...
    catch (NumberFormatException paramBundle)
    {
      try
      {
        ...
        if ((this.jdField_m_of_type_Int == 1) || (this.jdField_m_of_type_Int == 8)) {
          ((ajtg)getActivity().app.a(20)).v(this.jdField_c_of_type_JavaLangString);
        }
        this.jdField_a_of_type_Ajhf = ((ajhf)getActivity().app.a(6));
        ...
        paramBundle = (ajhh)getActivity().app.getManager(53);
    ...
    if ((this.jdField_d_of_type_Int == 1) || (this.jdField_d_of_type_Int == 11) || (this.jdField_d_of_type_Int == 16))
    {
      getActivity().addObserver(this.jdField_a_of_type_Ajhi);
      ...
      if (this.jdField_d_of_type_Int == 0)
      {
        ...
        this.jdField_a_of_type_Afph = new afph(getActivity(), this.jdField_a_of_type_Afpj, getActivity().app, this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo, this.jdField_a_of_type_JavaUtilList);
        if (QLog.isColorLevel()) {
      ...
      awqx.b(getActivity().app, "CliOper", "", "", "0X8006214", "0X8006214", 0, 0, "", "", "", "");
      if (this.jdField_d_of_type_Int == 21) {
      ...
      paramView = getResources().getStringArray(2130903143);
      if (this.jdField_q_of_type_Boolean) {
        break label2096;
      }
      this.jdField_a_of_type_ArrayOfJavaLangString = paramView;
      paramView = getResources().getStringArray(2130903142);
      if (this.jdField_q_of_type_Boolean) {
        break label2167;
      }
    ...
    for (;;)
    {
      ...
      if (this.jdField_d_of_type_Int == 18) {
        awqx.b(getActivity().app, "dc00899", "Grp_chatRecord", "", "chatRecor_mber", "mber_exp", 0, 0, this.jdField_c_of_type_JavaLangString, "", "", "");
      }
      if (this.jdField_d_of_type_Int != 3) {
        break;
      }
      ((ajtg)getActivity().app.a(20)).q(this.jdField_c_of_type_JavaLangString);
      return;
      getActivity().app.addObserver(this.jdField_a_of_type_Ajuc, true);
      break label1109;
      label1774:
      bool = false;
      break label1434;
      ...
      this.jdField_a_of_type_ArrayOfJavaLangString[i1] = getResources().getString(2131654658);
      break label1532;
      label2167:
      ...
      this.jdField_b_of_type_ArrayOfJavaLangString[i1] = getResources().getString(2131654659);
      break label1555;
      paramView = "0";
      break label1618;
      paramView = "1";
  ...
  protected void p()
  {
    this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)a(2131312031));
    ...
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)a(2131302847));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)a(2131302796));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)a(2131298449));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)a(2131302804));
    if ((this.jdField_d_of_type_Int == 3) || (this.jdField_d_of_type_Int == 11))
    {
      this.jdField_d_of_type_AndroidWidgetTextView.setVisibility(8);
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)a(2131302806));
      this.jdField_d_of_type_AndroidWidgetTextView.setVisibility(0);
    }
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)a(2131302832));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)a(2131302816));
    this.jdField_a_of_type_ComTencentWidgetPinnedDividerSwipListView = ((PinnedDividerSwipListView)a(2131312027));
    this.jdField_a_of_type_ComTencentMobileqqWidgetIndexView = ((IndexView)a(2131302454));
    this.jdField_e_of_type_AndroidViewView = a(2131309309);
    this.jdField_e_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)a(2131303639));
    this.jdField_d_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)a(2131303816));
    ...
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)a(2131302817));
  ...
  protected void q()
  {
    ...
    for (;;)
    {
      ...
      {
        this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
        this.jdField_c_of_type_AndroidWidgetTextView.setText(ajjy.a(2131635832));
      }
      if (this.jdField_d_of_type_Int == 14) {
      ...
      if (this.jdField_d_of_type_Int == 2)
      {
        ...
        this.jdField_d_of_type_AndroidWidgetTextView.setOnClickListener(new afoq(this));
        break;
      }
      if (this.jdField_d_of_type_Int == 3)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130839704);
        this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
        this.jdField_d_of_type_AndroidWidgetTextView.setOnClickListener(new afor(this));
        break;
      }
      if (this.jdField_d_of_type_Int == 11)
      {
        ...
        this.jdField_d_of_type_AndroidWidgetTextView.setOnClickListener(new afos(this));
        break;
      }
      if (this.jdField_d_of_type_Int == 5)
      {
        ...
        if (this.jdField_i_of_type_JavaLangString == null) {
          this.jdField_i_of_type_JavaLangString = getString(2131625011);
        }
      ...
      if (this.jdField_d_of_type_Int == 19)
      {
        this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
        this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
        this.jdField_b_of_type_AndroidWidgetTextView.setText(ajjy.a(2131635846));
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setText(ajjy.a(2131635839));
      if ((this.jdField_k_of_type_JavaLangString != null) && (!TextUtils.isEmpty(this.jdField_k_of_type_JavaLangString))) {
        this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_k_of_type_JavaLangString);
      }
      if (this.jdField_i_of_type_JavaLangString == null) {
  ...
  protected void r()
  {
    ...
    {
      return;
      this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new afni(this));
      this.jdField_b_of_type_AndroidWidgetImageView.setOnClickListener(new afnj(this));
      if ((this.jdField_d_of_type_Int == 0) || (this.jdField_d_of_type_Int == 9) || (this.jdField_d_of_type_Int == 17) || (this.jdField_d_of_type_Int == 22)) {
        this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new afnk(this));
      }
      while ((this.jdField_h_of_type_Boolean) && (!this.jdField_d_of_type_Boolean) && ((this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo == null) || (!this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo.mMemberInvitingFlag) || (this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo.cGroupOption == 3)))
      {
        ...
        {
          this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new afnl(this));
        }
        else if (this.jdField_d_of_type_Int == 21)
        {
          this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new afnm(this));
        }
  ...
  protected void s()
  {
    View localView = getActivity().getLayoutInflater().inflate(2131496956, this.jdField_a_of_type_ComTencentWidgetPinnedDividerSwipListView, false);
    ...
    if (ThemeUtil.isDefaultTheme())
    {
      ...
      if ((i1 != 0) || (i2 != 0))
      {
        ...
        if (i1 != 0)
        {
          ...
          localImageView.setOnClickListener(new afnn(this));
          localTextView.setTextSize(12.0F);
        }
        this.jdField_b_of_type_AndroidWidgetRelativeLayout.setOnClickListener(new afno(this, (String)localObject));
        if (!this.jdField_s_of_type_Boolean)
        {
          this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
          this.jdField_b_of_type_AndroidWidgetRelativeLayout.setEnabled(false);
        }
        localObject = (ajtg)getActivity().app.a(20);
        if (badq.d(BaseApplication.getContext())) {
          break label879;
        }
        bbmy.a(getActivity(), 1, 2131628946, 0).b(getActivity().getTitleBarHeight());
      }
      if ((this.jdField_d_of_type_Int != 3) || (this.jdField_d_of_type_Boolean) || (this.jdField_b_of_type_Int == 1)) {
        break label984;
      }
      ...
      localView = getActivity().getLayoutInflater().inflate(2131496948, this.jdField_a_of_type_ComTencentWidgetPinnedDividerSwipListView, false);
      localView.setOnClickListener(new afnp(this));
    ...
    for (;;)
    {
      ...
      ((EditText)localObject).setOnTouchListener(new afnq(this));
      ...
      if ((this.jdField_a_of_type_Ajhf != null) && (this.jdField_d_of_type_Int == 11)) {
        this.jdField_a_of_type_Ajhf.b(getActivity().app.getCurrentAccountUin(), this.jdField_b_of_type_JavaLangString);
      }
      for (;;)
      {
        ...
        break;
        if (localObject != null) {
          ((ajtg)localObject).a(getActivity().app.getCurrentAccountUin(), this.jdField_c_of_type_JavaLangString);
        }
      }
      label984:
      i1 = 0;
  ...
  protected void t()
  {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_d_of_type_Int != 15) && (this.jdField_d_of_type_Int != 1) && (this.jdField_d_of_type_Int != 11) && (this.jdField_d_of_type_Int != 16))
      {
        ...
        localObject1 = null;
        if ((this.jdField_d_of_type_Int != 11) && (this.jdField_d_of_type_Int != 1) && (this.jdField_d_of_type_Int != 16) && (badq.g(getActivity())))
        {
          ...
          localObject2 = (ajtg)getActivity().app.a(20);
          if (localObject2 != null)
          {
            this.jdField_j_of_type_Boolean = true;
            this.jdField_a_of_type_Long = System.currentTimeMillis();
            ((ajtg)localObject2).a(true, this.jdField_c_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, true, d(), this.jdField_a_of_type_Long, 0);
            if (QLog.isColorLevel()) {
      ...
      try
      {
        ((ajtg)localObject2).a(Long.parseLong(this.jdField_c_of_type_JavaLangString), 0L, 1, 0, 0);
        if (this.jdField_d_of_type_Int == 3)
        {
          ...
          if (l2 > 60000L)
          {
            ...
            if (localObject2 != null)
            {
              ...
              ((ajtg)localObject2).j(this.jdField_c_of_type_JavaLangString);
              ((ajtg)localObject2).a(1, ajex.a(this.jdField_c_of_type_JavaLangString), 0L, 2, 0, 0, true);
              if (QLog.isColorLevel()) {
        ...
        ((azjq)getActivity().app.getManager(113)).a(this.jdField_c_of_type_JavaLangString, new afnw(this));
        return;
  ...
  public void u()
  {
    ...
    if (this.jdField_d_of_type_Int == 9)
    {
      ...
      if (!ajjy.a(2131635794).equals(arrayOfString[i2])) {
        break label191;
      }
    }
    label270:
    for (;;)
    {
      ...
      if (i2 == 2)
      {
        ...
        {
          this.jdField_a_of_type_Begr.c(arrayOfString[i2]);
          if (arrayOfString[i2].equals(ajjy.a(2131635879))) {
            awqx.b(getActivity().app, "dc00899", "Grp_mber", "", "mber_list", "exp_Add", 0, 0, this.jdField_c_of_type_JavaLangString, "", "", "");
          }
        }
      }
    }
  ...
  public void v()
  {
    if ((this.jdField_a_of_type_Afow != null) && (QLog.isColorLevel())) {
      QLog.d("Q.history.BaseFragment", 2, String.format("checkShowCharIndexView item: %s, other: %s, char: %s", new Object[] { Integer.valueOf(this.jdField_a_of_type_Afow.jdField_b_of_type_Int), Integer.valueOf(this.jdField_a_of_type_Afow.jdField_c_of_type_Int), Integer.valueOf(this.jdField_a_of_type_Afow.jdField_a_of_type_Int) }));
    }
    int i1 = this.jdField_a_of_type_ComTencentMobileqqWidgetIndexView.getVisibility();
    if (this.jdField_m_of_type_Int == 0) {
      if (this.jdField_d_of_type_Int == 11) {
        if ((this.jdField_a_of_type_Afow != null) && (this.jdField_a_of_type_Afow.jdField_b_of_type_Int > 6) && (this.jdField_a_of_type_Afow.jdField_a_of_type_Int > 1)) {
    ...
    for (;;)
    {
      ...
      if (this.jdField_d_of_type_Int == 0)
      {
        if ((this.jdField_a_of_type_Afow != null) && (this.jdField_a_of_type_Afow.jdField_b_of_type_Int + this.jdField_a_of_type_Afow.jdField_c_of_type_Int >= this.jdField_l_of_type_Int) && (this.jdField_a_of_type_Afow.jdField_a_of_type_Int > 1)) {
          this.jdField_a_of_type_ComTencentMobileqqWidgetIndexView.setVisibility(0);
        } else {
          this.jdField_a_of_type_ComTencentMobileqqWidgetIndexView.setVisibility(4);
        }
      }
      else if ((this.jdField_a_of_type_Afow != null) && (this.jdField_a_of_type_Afow.jdField_b_of_type_Int >= this.jdField_l_of_type_Int) && (this.jdField_a_of_type_Afow.jdField_a_of_type_Int > 1))
      {
        this.jdField_a_of_type_ComTencentMobileqqWidgetIndexView.setVisibility(0);
      }
      else
  ...
  public void w()
  {
    ...
    {
      localDialog.setCancelable(bool);
      ((TextView)this.jdField_c_of_type_AndroidAppDialog.findViewById(2131299579)).setText(getString(2131653452));
      return;
      label79:
      bool = false;
    }
  ...
  {
    if (this.jdField_d_of_type_Int == 11) {
      awqx.b(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006217", "0X8006217", 0, 0, "", "", "", "");
    }
    awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A0BF", "0X800A0BF", 7, 0, "", "", "", "");
    ...
    ((TranslateAnimation)localObject).setAnimationListener(new afoa(this, (TranslateAnimation)localObject, localTranslateAnimation, i1));
    this.jdField_d_of_type_AndroidAppDialog.setOnDismissListener(new afob(this));
    this.jdField_a_of_type_AndroidWidgetEditText.setText("");
    this.jdField_a_of_type_AndroidWidgetEditText.setSelection(0);
    this.jdField_a_of_type_AndroidWidgetEditText.requestFocus();
    localObject = (Button)this.jdField_d_of_type_AndroidAppDialog.findViewById(2131297934);
    ((Button)localObject).setVisibility(0);
    ((Button)localObject).setOnClickListener(new afoc(this));
    this.jdField_b_of_type_JavaUtilList.clear();
    this.jdField_a_of_type_Afoy.notifyDataSetChanged();
