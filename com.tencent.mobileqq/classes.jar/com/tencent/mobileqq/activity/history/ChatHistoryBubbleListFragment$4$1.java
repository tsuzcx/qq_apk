  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    ahvx localahvx = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryBubbleListFragment$4.this$0.jdField_a_of_type_Ahvx;
    ...
    if (this.jdField_a_of_type_JavaUtilList.size() < 20)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryBubbleListFragment$4.this$0.jdField_a_of_type_Ahvx.getCount() > 0)
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryBubbleListFragment$4.this$0.jdField_a_of_type_Long = ((MessageRecord)this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryBubbleListFragment$4.this$0.jdField_a_of_type_Ahvx.getItem(0)).shmsgseq;
        this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryBubbleListFragment$4.this$0.jdField_b_of_type_Long = ((MessageRecord)this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryBubbleListFragment$4.this$0.jdField_a_of_type_Ahvx.getItem(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryBubbleListFragment$4.this$0.jdField_a_of_type_Ahvx.getCount() - 1)).shmsgseq;
      }
    ...
    for (int k = m;; k = 0)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryBubbleListFragment$4.this$0.jdField_a_of_type_Ahvx.notifyDataSetChanged();
      if (j == 0) {
        break;
      }
