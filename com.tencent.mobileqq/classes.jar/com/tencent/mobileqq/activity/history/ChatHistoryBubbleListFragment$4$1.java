  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    aiqe localaiqe = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryBubbleListFragment$4.this$0.jdField_a_of_type_Aiqe;
    ...
    if (this.jdField_a_of_type_JavaUtilList.size() < 20)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryBubbleListFragment$4.this$0.jdField_a_of_type_Aiqe.getCount() > 0)
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryBubbleListFragment$4.this$0.jdField_a_of_type_Long = ((MessageRecord)this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryBubbleListFragment$4.this$0.jdField_a_of_type_Aiqe.getItem(0)).shmsgseq;
    ...
    for (int k = m;; k = 0)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryBubbleListFragment$4.this$0.jdField_a_of_type_Aiqe.notifyDataSetChanged();
      if (j == 0) {
        break;
      }
