...
public class ChatHistoryTroopMemberFragment$41$4
  implements Runnable
{
  public ChatHistoryTroopMemberFragment$41$4(ahyg paramahyg, List paramList) {}
  
  public void run()
  {
    Object localObject1 = (TroopManager)this.jdField_a_of_type_Ahyg.a.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52);
    ...
    do
    {
      ...
      localObject1 = this.jdField_a_of_type_Ahyg.a.jdField_b_of_type_AndroidOsHandler.obtainMessage();
      ((Message)localObject1).what = 11;
      ((Message)localObject1).obj = localTroopInfo;
      this.jdField_a_of_type_Ahyg.a.jdField_b_of_type_AndroidOsHandler.sendMessage((Message)localObject1);
