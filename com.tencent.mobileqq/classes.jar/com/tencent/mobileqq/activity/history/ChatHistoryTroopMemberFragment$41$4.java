...
public class ChatHistoryTroopMemberFragment$41$4
  implements Runnable
{
  public ChatHistoryTroopMemberFragment$41$4(afok paramafok, List paramList) {}
  
  public void run()
  {
    Object localObject1 = (TroopManager)this.jdField_a_of_type_Afok.a.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52);
    TroopInfo localTroopInfo = ((TroopManager)localObject1).b(this.jdField_a_of_type_Afok.a.c);
    ...
    do
    {
      ...
      {
        return;
      } while (baip.a(localTroopInfo.troopowneruin));
      ...
      localObject1 = this.jdField_a_of_type_Afok.a.jdField_b_of_type_AndroidOsHandler.obtainMessage();
      ((Message)localObject1).what = 11;
      ((Message)localObject1).obj = localTroopInfo;
      this.jdField_a_of_type_Afok.a.jdField_b_of_type_AndroidOsHandler.sendMessage((Message)localObject1);
