  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    for (;;)
    {
      try
      {
        SharedPreferences localSharedPreferences = this.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getSharedPreferences("vip_message_roam_banner_file", 0);
        if (1 != localSharedPreferences.getInt("setting_guide_tips_flag" + this.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), -1))
        {
          SharedPreferences.Editor localEditor = localSharedPreferences.edit();
          int j = localSharedPreferences.getInt("setting_guide_tips_show_time" + this.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 1);
