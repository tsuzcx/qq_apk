...
class ChatHistoryTroopMemberFragment$2
  implements Runnable
{
  ChatHistoryTroopMemberFragment$2(ChatHistoryTroopMemberFragment paramChatHistoryTroopMemberFragment, Intent paramIntent, ajxl paramajxl, TroopManager paramTroopManager) {}
    ...
    for (;;)
    {
      ...
      for (boolean bool1 = true;; bool1 = false) {
        for (;;)
        {
          ...
          if ((i != 0) && (this.this$0.jdField_a_of_type_Agau != null)) {
          ...
          Object localObject2 = bbdd.a().a(this.this$0.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, this.this$0.c, (String)???);
