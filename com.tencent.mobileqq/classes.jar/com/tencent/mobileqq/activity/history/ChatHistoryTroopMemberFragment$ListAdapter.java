  ...
  extends CharDividedFacePreloadBaseAdapter
{
  ...
  public ChatHistoryTroopMemberFragment$ListAdapter(ChatHistoryTroopMemberFragment paramChatHistoryTroopMemberFragment)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 1) || (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 11)) {
      paramChatHistoryTroopMemberFragment = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131691850);
    }
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 5) {
        paramChatHistoryTroopMemberFragment = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131696289);
      } else {
        paramChatHistoryTroopMemberFragment = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131720264);
      }
    }
  }
  ...
  public void a(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        ((TextView)paramView).setText(this.jdField_a_of_type_ArrayOfJavaLangString[paramInt] + this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131720762, new Object[] { Integer.valueOf(localList.size()) }));
        if (!this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_n_of_type_Boolean) {
          break label207;
        }
        paramView.setBackgroundResource(2130838979);
      }
      for (;;)
      {
        ...
        break;
        label207:
        paramView.setBackgroundResource(2130850505);
      }
    }
  }
  ...
  public Object[] a()
  {
    ...
    Object localObject6 = (TroopRobotManager)this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.TROOP_ROBOT_MANAGER);
    Object localObject9;
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int != 13) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int != 21))
      {
        ...
        if ((!localATroopMember.jdField_a_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())) && (localATroopMember.jdField_d_of_type_Long == 1L)) {
      ...
      if (((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.f != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.f.equals(localATroopMember.jdField_a_of_type_JavaLangString))) || ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_g_of_type_JavaLangString != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_g_of_type_JavaLangString.contains(localATroopMember.jdField_a_of_type_JavaLangString))) || ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.e) && ((localATroopMember.jdField_b_of_type_Int == 332) || (localATroopMember.jdField_b_of_type_Int == 333))))
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("zivonchen", 2, "constructHashStruct uin = " + localATroopMember.jdField_a_of_type_JavaLangString + ", name = " + localATroopMember.jdField_g_of_type_JavaLangString + ", level = " + localATroopMember.jdField_b_of_type_Int);
        }
      }
      else if ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 5) && (!TextUtils.isEmpty(localATroopMember.u)))
      {
        ((List)localObject7).add(localATroopMember);
      }
      else
      {
        ...
        for (;;)
        {
          ...
          ((List)localObject1.get(localObject4)).add(localATroopMember);
          break;
          localObject3 = localATroopMember.jdField_c_of_type_JavaLangString.substring(0, 1);
        }
      }
    }
    localObject6 = new ChatHistoryTroopMemberFragment.MyComparator(0, true);
    ...
    else
    {
      for (;;)
      {
        if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.h) {
          localObject1.remove(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131719482));
        }
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 21)
        {
          this.jdField_a_of_type_Int = 0;
          Collections.sort((List)localObject7, (Comparator)localObject6);
          ((LinkedHashMap)localObject4).put(HardCodeUtil.a(2131701666), this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_a_of_type_JavaUtilList);
          break label4323;
        }
        if ((((List)localObject9).size() > 0) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int != 12))
        {
          ...
          ((LinkedHashMap)localObject4).put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131719482), localObject9);
        }
        if ((localArrayList1.size() > 0) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int != 3))
        {
          ...
          ((LinkedHashMap)localObject4).put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131720239), localArrayList1);
        }
        if ((((List)localObject10).size() > 0) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int != 3))
        {
          ...
          ((LinkedHashMap)localObject4).put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131691384), localObject10);
        }
        if (((List)localObject7).size() > 0)
        {
          Collections.sort((List)localObject7, (Comparator)localObject6);
        ...
        for (localObject3 = ChatHistoryTroopMemberFragment.a(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment);; localObject3 = this.jdField_a_of_type_JavaLangString)
        {
          ...
          ((LinkedHashMap)localObject4).put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131720266), localObject8);
          break label4330;
          if (c1 > 'Z') {
            break;
          }
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_Int == 2)
        {
          ...
          while (((Iterator)localObject6).hasNext())
          {
            ...
            if (TextUtils.isEmpty(((ChatHistoryTroopMemberFragment.ATroopMember)localObject7).r)) {
              ((ChatHistoryTroopMemberFragment.ATroopMember)localObject7).r = a((String[])localObject4, ((ChatHistoryTroopMemberFragment.ATroopMember)localObject7).jdField_b_of_type_Long, (Calendar)localObject3);
            }
            if (localObject1.get(((ChatHistoryTroopMemberFragment.ATroopMember)localObject7).r) == null) {
              localObject1.put(((ChatHistoryTroopMemberFragment.ATroopMember)localObject7).r, new ArrayList());
            }
            ((List)localObject1.get(((ChatHistoryTroopMemberFragment.ATroopMember)localObject7).r)).add(localObject7);
          }
          ...
          if (i >= 0)
          {
            ...
            Collections.sort((List)localObject1.get(localObject4[i]), new ChatHistoryTroopMemberFragment.MyComparator(2, false));
        ...
        else if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_Int == 6)
        {
          ...
          {
            localObject6 = (ChatHistoryTroopMemberFragment.ATroopMember)((Iterator)localObject4).next();
            if (TextUtils.isEmpty(((ChatHistoryTroopMemberFragment.ATroopMember)localObject6).r))
            {
              if (((ChatHistoryTroopMemberFragment.ATroopMember)localObject6).jdField_b_of_type_Long == 0L) {
                ((ChatHistoryTroopMemberFragment.ATroopMember)localObject6).jdField_b_of_type_Long = ((ChatHistoryTroopMemberFragment.ATroopMember)localObject6).jdField_a_of_type_Long;
              }
              ((ChatHistoryTroopMemberFragment.ATroopMember)localObject6).r = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.a(((ChatHistoryTroopMemberFragment.ATroopMember)localObject6).jdField_b_of_type_Long, (Calendar)localObject3, ChatHistoryTroopMemberFragment.d(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment), ChatHistoryTroopMemberFragment.e(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment));
            }
            if (localObject2.get(((ChatHistoryTroopMemberFragment.ATroopMember)localObject6).r) == null) {
              localObject2.put(((ChatHistoryTroopMemberFragment.ATroopMember)localObject6).r, new ArrayList());
            }
            if (!TextUtils.isEmpty(((ChatHistoryTroopMemberFragment.ATroopMember)localObject6).r)) {
              ((List)localObject2.get(((ChatHistoryTroopMemberFragment.ATroopMember)localObject6).r)).add(localObject6);
            }
          }
          localObject3 = new LinkedHashMap();
          ...
          if (i >= 0)
          {
            ...
            Collections.sort((List)localObject2.get(ChatHistoryTroopMemberFragment.e(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment).get(i)), new ChatHistoryTroopMemberFragment.MyComparator(2, false));
        ...
        else
        {
          ...
          {
            localObject7 = (ChatHistoryTroopMemberFragment.ATroopMember)((Iterator)localObject6).next();
            if (TextUtils.isEmpty(((ChatHistoryTroopMemberFragment.ATroopMember)localObject7).q)) {
              ((ChatHistoryTroopMemberFragment.ATroopMember)localObject7).q = b((String[])localObject4, ((ChatHistoryTroopMemberFragment.ATroopMember)localObject7).jdField_a_of_type_Long, (Calendar)localObject3);
            }
            if (localObject2.get(((ChatHistoryTroopMemberFragment.ATroopMember)localObject7).q) == null) {
              localObject2.put(((ChatHistoryTroopMemberFragment.ATroopMember)localObject7).q, new ArrayList());
            }
            ((List)localObject2.get(((ChatHistoryTroopMemberFragment.ATroopMember)localObject7).q)).add(localObject7);
          }
          localObject3 = new LinkedHashMap();
          i = localObject4.length - 1;
          if (i >= 0)
          {
            ...
            Collections.sort((List)localObject2.get(localObject4[i]), new ChatHistoryTroopMemberFragment.MyComparator(3, false));
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_Int == 1)
      {
        ...
        {
          localObject10 = (ChatHistoryTroopMemberFragment.ATroopMember)((Iterator)localObject9).next();
          if (((TroopRobotManager)localObject6).b(((ChatHistoryTroopMemberFragment.ATroopMember)localObject10).jdField_a_of_type_JavaLangString))
          {
            if ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int != 5) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int != 2) && (!ChatHistoryTroopMemberFragment.f(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment))) {
              if ((this.jdField_c_of_type_JavaUtilList != null) && (this.jdField_c_of_type_JavaUtilList.contains(((ChatHistoryTroopMemberFragment.ATroopMember)localObject10).jdField_a_of_type_JavaLangString)))
              {
                ((List)localObject3).add(localObject10);
                ((ChatHistoryTroopMemberFragment.ATroopMember)localObject10).jdField_d_of_type_Boolean = true;
              }
              else
              {
                ((List)localObject8).add(localObject10);
                ((ChatHistoryTroopMemberFragment.ATroopMember)localObject10).jdField_d_of_type_Boolean = false;
              }
            }
          }
          else if ((this.jdField_c_of_type_JavaUtilList != null) && (this.jdField_c_of_type_JavaUtilList.contains(((ChatHistoryTroopMemberFragment.ATroopMember)localObject10).jdField_a_of_type_JavaLangString)))
          {
            ((ChatHistoryTroopMemberFragment.ATroopMember)localObject10).jdField_d_of_type_Boolean = true;
            if (((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.f != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.f.equals(((ChatHistoryTroopMemberFragment.ATroopMember)localObject10).jdField_a_of_type_JavaLangString))) || ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_g_of_type_JavaLangString != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_g_of_type_JavaLangString.contains(((ChatHistoryTroopMemberFragment.ATroopMember)localObject10).jdField_a_of_type_JavaLangString))) || ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.e) && ((((ChatHistoryTroopMemberFragment.ATroopMember)localObject10).jdField_b_of_type_Int == 332) || (((ChatHistoryTroopMemberFragment.ATroopMember)localObject10).jdField_b_of_type_Int == 333)))) {
        ...
        localObject2.clear();
        Collections.sort((List)localObject3, new ChatHistoryTroopMemberFragment.MyComparator(1, false));
        if (((List)localObject3).size() > 0) {
          localObject2.put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131720266), localObject3);
        }
        ...
        for (localObject3 = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131694641);; localObject3 = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131694640))
        {
          localObject2.put(localObject3, localObject4);
          Collections.sort((List)localObject7, new ChatHistoryTroopMemberFragment.MyComparator(1, false));
          if (((List)localObject7).size() > 0) {
            localObject2.put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131720262), localObject7);
          }
          Collections.sort((List)localObject8, new ChatHistoryTroopMemberFragment.MyComparator(1, false));
          if (((List)localObject8).size() <= 0) {
            break;
          }
          localObject2.put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131720261), localObject8);
          break;
        }
      }
      if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_Int == 7)
      {
        ...
        while (i < j)
        {
          localObject9 = (ChatHistoryTroopMemberFragment.ATroopMember)this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_a_of_type_JavaUtilList.get(i);
          ((ChatHistoryTroopMemberFragment.ATroopMember)localObject9).jdField_m_of_type_Int = 0;
          ((HashMap)localObject8).put(((ChatHistoryTroopMemberFragment.ATroopMember)localObject9).jdField_a_of_type_JavaLangString, localObject9);
          i += 1;
        }
        if (ChatHistoryTroopMemberFragment.a(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment) != null)
        {
          ...
          {
            localObject9 = (ChatHistoryTroopMemberFragment.ATroopMember)((HashMap)localObject8).remove(String.valueOf(ChatHistoryTroopMemberFragment.a(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment)[i]));
        ...
        if (ChatHistoryTroopMemberFragment.b(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment) != null)
        {
          ...
          {
            localObject9 = (ChatHistoryTroopMemberFragment.ATroopMember)((HashMap)localObject8).remove(String.valueOf(ChatHistoryTroopMemberFragment.b(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment)[i]));
            if (localObject9 == null) {
              break label4375;
            }
        ...
        if (ChatHistoryTroopMemberFragment.c(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment) != null)
        {
          ...
          {
            localObject9 = (ChatHistoryTroopMemberFragment.ATroopMember)((HashMap)localObject8).remove(String.valueOf(ChatHistoryTroopMemberFragment.c(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment)[i]));
            if (localObject9 == null) {
              break label4382;
            }
        ...
        Collections.sort((List)localObject3, new ChatHistoryTroopMemberFragment.MyComparator(2, true));
        if (!((List)localObject3).isEmpty()) {
          localObject2.put(HardCodeUtil.a(2131701679), localObject3);
        }
        if (!((List)localObject4).isEmpty()) {
          localObject2.put(HardCodeUtil.a(2131701739), localObject4);
        }
        if (!((List)localObject6).isEmpty()) {
          localObject2.put(HardCodeUtil.a(2131701705), localObject6);
        }
        Collections.sort((List)localObject7, new ChatHistoryTroopMemberFragment.MyComparator(2, true));
        if (((List)localObject7).isEmpty()) {
          break label4389;
        }
        localObject2.put(HardCodeUtil.a(2131701664), localObject7);
        break label4389;
      }
      if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_Int == 8)
      {
        ...
        {
          localObject8 = (ChatHistoryTroopMemberFragment.ATroopMember)((Iterator)localObject7).next();
          localObject9 = (oidb_0xa2a.UserInfo)((HashMap)localObject6).get(((ChatHistoryTroopMemberFragment.ATroopMember)localObject8).jdField_a_of_type_JavaLangString);
          if (localObject9 != null)
          {
            ((List)localObject3).add(localObject8);
            ((ChatHistoryTroopMemberFragment.ATroopMember)localObject8).n = ((oidb_0xa2a.UserInfo)localObject9).score.get();
          }
          else
          {
        ...
        if (((List)localObject3).size() > 0)
        {
          Collections.sort((List)localObject3, new ChatHistoryTroopMemberFragment.MyComparator(8, false));
          localObject2.put(HardCodeUtil.a(2131701701), localObject3);
        }
        if (((List)localObject4).size() <= 0) {
          break label4392;
        }
        Collections.sort((List)localObject4, new ChatHistoryTroopMemberFragment.MyComparator(8, false));
        localObject2.put(HardCodeUtil.a(2131701694), localObject4);
        break label4392;
      }
      if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_Int == 4)
      {
        ...
        localObject6 = HardCodeUtil.a(2131701670);
        localObject7 = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_a_of_type_JavaUtilList.iterator();
        while (((Iterator)localObject7).hasNext())
        {
          localObject8 = (ChatHistoryTroopMemberFragment.ATroopMember)((Iterator)localObject7).next();
          j = ((ChatHistoryTroopMemberFragment.ATroopMember)localObject8).jdField_b_of_type_Int;
          i = j;
          if (j >= 10000) {
            i = ((ChatHistoryTroopMemberFragment.ATroopMember)localObject8).jdField_b_of_type_Int - 10000;
          }
          if ((i >= 321) && (i <= 327))
          {
    ...
    for (;;)
    {
      if (i >= 0)
      {
        ...
        {
          Collections.sort((List)((LinkedHashMap)localObject3).get(localObject4[i]), new ChatHistoryTroopMemberFragment.MyComparator(0, false));
      ...
      else
      {
        if (((LinkedHashMap)localObject3).get(localObject6) != null)
        {
          Collections.sort((List)((LinkedHashMap)localObject3).get(localObject6), new ChatHistoryTroopMemberFragment.MyComparator(0, false));
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null) {
      if (i == 0)
      {
        ...
        paramView.jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setBackgroundResource(2130839537);
        ((View)localObject1).setTag(paramView);
        localObject2 = paramView;
        paramView = (View)localObject1;
        localObject1 = localObject2;
        label83:
        ((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).jdField_a_of_type_JavaLangString = "";
        if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int != 9) {
          break label307;
        }
        localObject2 = (ChatHistoryTroopMemberFragment.ATroopMember)this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_a_of_type_JavaUtilList.get(paramInt);
        ((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).g.setTag(((ChatHistoryTroopMemberFragment.ATroopMember)localObject2).jdField_a_of_type_JavaLangString);
        ((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).jdField_b_of_type_AndroidViewView.setTag(((ChatHistoryTroopMemberFragment.ATroopMember)localObject2).jdField_a_of_type_JavaLangString);
        ((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).jdField_a_of_type_AndroidViewView.setTag(((ChatHistoryTroopMemberFragment.ATroopMember)localObject2).jdField_a_of_type_JavaLangString);
        ...
        this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.a((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1, (ChatHistoryTroopMemberFragment.ATroopMember)localObject2, a(((ChatHistoryTroopMemberFragment.ATroopMember)localObject2).jdField_a_of_type_JavaLangString, 2), false, false);
        label195:
        if ((((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).jdField_e_of_type_AndroidViewView != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_a_of_type_ComTencentMobileqqWidgetIndexView != null))
        {
          ...
          ((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).jdField_e_of_type_AndroidViewView.setVisibility(0);
        }
      }
    }
    for (;;)
    {
      ...
      break;
      label282:
      paramView.jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setBackgroundResource(2130839534);
      break label67;
      ...
      {
        j = -(j + 1) - 1;
        localObject2 = (ChatHistoryTroopMemberFragment.ATroopMember)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[j])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[j] - 1);
        ((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).g.setTag(((ChatHistoryTroopMemberFragment.ATroopMember)localObject2).jdField_a_of_type_JavaLangString);
        ((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).jdField_b_of_type_AndroidViewView.setTag(((ChatHistoryTroopMemberFragment.ATroopMember)localObject2).jdField_a_of_type_JavaLangString);
        ((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).jdField_a_of_type_AndroidViewView.setTag(((ChatHistoryTroopMemberFragment.ATroopMember)localObject2).jdField_a_of_type_JavaLangString);
        ((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setTag(Integer.valueOf(paramInt));
        Object localObject3;
        if (((ChatHistoryTroopMemberFragment.ATroopMember)localObject2).jdField_c_of_type_Boolean)
        {
          localObject3 = new ColorNickText(((ChatHistoryTroopMemberFragment.ATroopMember)localObject2).jdField_b_of_type_JavaLangString, 16).a();
          ((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).jdField_e_of_type_AndroidWidgetTextView.setText((CharSequence)localObject3);
          ColorNickManager.a(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, ((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).jdField_e_of_type_AndroidWidgetTextView, (Spannable)localObject3);
          ((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).c.setImageResource(2130839708);
          ((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setOnClickListener(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.c);
        ...
        for (;;)
        {
          ...
          ((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).f.setVisibility(8);
          break;
          localObject3 = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment;
          Bitmap localBitmap = a(((ChatHistoryTroopMemberFragment.ATroopMember)localObject2).jdField_a_of_type_JavaLangString, 2);
          if (i == 1) {}
          for (;;)
          {
            ((ChatHistoryTroopMemberFragment)localObject3).a((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1, (ChatHistoryTroopMemberFragment.ATroopMember)localObject2, localBitmap, false, bool);
            break;
            bool = false;
          }
          label605:
        ...
        i = VipUtils.d(2);
        ((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).jdField_e_of_type_AndroidWidgetTextView.setMaxWidth(i);
        ChatHistoryTroopMemberFragment.a(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, ((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).jdField_e_of_type_AndroidWidgetTextView, ((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).d, ((ChatHistoryTroopMemberFragment.ATroopMember)localObject2).jdField_a_of_type_JavaLangString, i);
        break label195;
      }
      ((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.b(false);
      ((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setVisibility(8);
      ((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
      ((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      ((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setOnClickListener(null);
      ((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).g.setTag("");
      ((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).jdField_b_of_type_AndroidViewView.setTag("");
      ((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).jdField_a_of_type_AndroidViewView.setTag("");
      ((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setTag(Integer.valueOf(-1));
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 9) || (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 19))
      {
        ((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
        label826:
        if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 12)
        {
          ...
          {
            localObject2 = (ChatHistoryTroopMemberFragment.ATroopMember)((List)localObject2).get(i);
            if (!this.jdField_a_of_type_JavaUtilList.contains(localObject2)) {
              break label1081;
            }
            ((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      ...
      for (;;)
      {
        ((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setContentDescription("");
        break;
        ((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
        localObject2 = (List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[j]);
        if (localObject2 == null) {
          break label826;
        }
        if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131720266).equals(String.valueOf(this.jdField_a_of_type_ArrayOfJavaLangString[j])))
        {
          ((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).jdField_b_of_type_AndroidWidgetTextView.setText(String.valueOf(this.jdField_a_of_type_ArrayOfJavaLangString[j]));
          break label826;
        }
        ((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).jdField_b_of_type_AndroidWidgetTextView.setText(String.valueOf(this.jdField_a_of_type_ArrayOfJavaLangString[j]) + this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131720762, new Object[] { Integer.valueOf(((List)localObject2).size()) }));
        break label826;
        label1081:
        ((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      }
      label1094:
      ((ChatHistoryTroopMemberFragment.TmViewHolder)localObject1).jdField_e_of_type_AndroidViewView.setVisibility(8);
    }
  }
