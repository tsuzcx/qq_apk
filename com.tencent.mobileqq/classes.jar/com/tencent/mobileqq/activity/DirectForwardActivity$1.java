  ...
  implements Runnable
{
  ...
  public void run()
  {
    String str = ((axfb)this.this$0.app.a(122)).a(this.jdField_a_of_type_JavaLangString, this.b, this.c);
    if (TextUtils.isEmpty(str))
    {
      this.this$0.finish();
      return;
    }
    this.this$0.getIntent().putExtra("uinname", babh.a(this.this$0.app, str, this.jdField_a_of_type_Int));
