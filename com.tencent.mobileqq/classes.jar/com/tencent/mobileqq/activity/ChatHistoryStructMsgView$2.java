...
public class ChatHistoryStructMsgView$2
  implements Runnable
{
  public ChatHistoryStructMsgView$2(acjs paramacjs, boolean paramBoolean) {}
  ...
  public void run()
  {
    ...
    if (this.a)
    {
      ...
      if ((localObject1 != null) && (((List)localObject1).size() < acjs.a())) {
    ...
    for (;;)
    {
      ...
      if (abot.a(this.this$0.jdField_a_of_type_Int))
      {
        ...
        ((acjs)localObject1).jdField_b_of_type_Long -= 1L;
        localObject1 = this.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
        localObject2 = this.this$0.jdField_b_of_type_JavaLangString;
        i = this.this$0.jdField_a_of_type_Int;
