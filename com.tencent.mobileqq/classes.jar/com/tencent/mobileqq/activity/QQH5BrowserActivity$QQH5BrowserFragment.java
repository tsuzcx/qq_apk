  ...
  extends WebViewFragment
{
  private void a(Bundle paramBundle)
  {
    ...
    if ((this.mSwiftTitleUI.titleContainer.getLayoutParams() instanceof RelativeLayout.LayoutParams))
    {
      ...
      paramBundle.height = ((int)mum.a(BaseApplicationImpl.getApplication(), 60.0F));
      this.mSwiftTitleUI.titleContainer.setLayoutParams(paramBundle);
    }
    this.mSwiftTitleUI.titleContainer.setPadding(0, 0, 0, 0);
    int i = (int)mum.a(BaseApplicationImpl.getApplication(), 12.0F);
    paramBundle = new RelativeLayout.LayoutParams(-2, -2);
    paramBundle.width = ((int)mum.a(BaseApplicationImpl.getApplication(), 15.0F));
    paramBundle.height = ((int)mum.a(BaseApplicationImpl.getApplication(), 15.0F));
    this.mSwiftTitleUI.leftView.setLayoutParams(paramBundle);
    this.mSwiftTitleUI.leftView.setBackgroundResource(2130847713);
    ...
    paramBundle = super.getActivity().findViewById(2131376631);
    ...
    paramBundle.width = ((int)mum.a(BaseApplicationImpl.getApplication(), 22.0F));
    paramBundle.height = ((int)mum.a(BaseApplicationImpl.getApplication(), 15.0F));
    this.mSwiftTitleUI.rightViewImg.setLayoutParams(paramBundle);
    this.mSwiftTitleUI.rightViewImg.setImageResource(2130848345);
    ...
    paramBundle = super.getActivity().findViewById(2131376632);
