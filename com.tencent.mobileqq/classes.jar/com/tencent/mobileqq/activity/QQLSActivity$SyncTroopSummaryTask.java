  ...
  implements Runnable
{
  ...
  public QQLSActivity$SyncTroopSummaryTask(QQAppInterface paramQQAppInterface, bfob parambfob, String paramString1, String paramString2)
  {
  ...
  public void run()
  {
    ...
    if ((localQQAppInterface != null) && (this.jdField_a_of_type_Bfob != null) && (!QQLSActivity.a().contains(str)))
    {
      QQLSActivity.a().add(str);
      bbcz.h(localQQAppInterface, this.b, this.jdField_a_of_type_JavaLangString);
