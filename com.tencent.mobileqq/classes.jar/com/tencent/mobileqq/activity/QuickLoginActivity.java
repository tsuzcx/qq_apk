  ...
  extends BaseActivity
{
  ...
  SimpleAdapter c;
  private AccountObserver d = new QuickLoginActivity.2(this);
  
  private void a()
  {
    this.a = ((ListView)findViewById(2131442942));
  ...
  private void b()
  {
    ...
    this.c = new SimpleAdapter(this, localArrayList, 2131623995, new String[] { "text" }, new int[] { 2131436084 });
    this.a.setAdapter(this.c);
    this.a.setOnItemClickListener(new QuickLoginActivity.1(this));
  }
  ...
  private void c()
  {
    ...
    //   7: astore_1
    //   8: aload_1
    //   9: invokestatic 122	android/os/Environment:getExternalStorageDirectory	()Ljava/io/File;
    //   12: invokevirtual 127	java/io/File:getPath	()Ljava/lang/String;
    ...
    //   25: pop
    //   26: new 124	java/io/File
    //   29: dup
    //   30: aload_1
    //   31: invokevirtual 86	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   34: invokespecial 132	java/io/File:<init>	(Ljava/lang/String;)V
    //   37: astore_1
    //   38: aload_1
    //   39: invokevirtual 135	java/io/File:exists	()Z
    //   42: ifeq +171 -> 213
    //   45: new 137	java/io/BufferedReader
    //   48: dup
    //   49: new 139	java/io/InputStreamReader
    //   52: dup
    //   53: new 141	java/io/FileInputStream
    //   56: dup
    //   57: aload_1
    //   58: invokespecial 144	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   61: invokespecial 147	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   64: invokespecial 150	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   67: astore_2
    //   68: aload_2
    //   69: astore_1
    //   70: aload_2
    //   71: invokevirtual 153	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   74: astore_3
    //   75: aload_3
    //   76: ifnull +79 -> 155
    //   79: aload_2
    ...
    //   81: aload_3
    //   82: ldc 78
    //   84: invokevirtual 157	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   87: astore_3
    //   88: aload_2
    //   89: astore_1
    //   90: aload_3
    ...
    //   96: aload_2
    //   97: astore_1
    //   98: new 60	java/util/HashMap
    //   101: dup
    //   102: invokespecial 61	java/util/HashMap:<init>	()V
    //   105: astore 4
    //   107: aload_2
    //   108: astore_1
    //   109: aload 4
    ...
    //   114: iconst_0
    //   115: aaload
    //   116: invokevirtual 90	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   119: pop
    //   120: aload_2
    //   121: astore_1
    //   122: aload 4
    ...
    //   127: iconst_1
    //   128: aaload
    //   129: invokevirtual 90	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   132: pop
    //   133: aload_2
    //   134: astore_1
    //   135: aload_0
    //   136: getfield 40	com/tencent/mobileqq/activity/QuickLoginActivity:b	Ljava/util/ArrayList;
    //   139: aload 4
    ...
    //   146: astore_1
    //   147: aload_2
    //   148: invokevirtual 153	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   151: astore_3
    //   152: goto -77 -> 75
    //   155: aload_2
    //   156: invokevirtual 160	java/io/BufferedReader:close	()V
    //   159: return
    //   160: astore_3
    //   161: goto +12 -> 173
    //   164: astore_2
    ...
    //   174: astore_1
    //   175: aload_3
    //   176: invokevirtual 163	java/io/IOException:printStackTrace	()V
    //   179: aload_2
    //   180: ifnull +33 -> 213
    //   183: aload_2
    ...
    //   188: astore_1
    //   189: aload_1
    //   190: invokevirtual 163	java/io/IOException:printStackTrace	()V
    //   193: return
    //   194: astore_2
    //   195: aload_1
    //   196: ifnull +15 -> 211
    ...
    //   206: astore_1
    //   207: aload_1
    //   208: invokevirtual 163	java/io/IOException:printStackTrace	()V
    //   211: aload_2
    //   212: athrow
    //   213: return
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    super.setContentView(2131623994);
    a();
    return true;
  }
