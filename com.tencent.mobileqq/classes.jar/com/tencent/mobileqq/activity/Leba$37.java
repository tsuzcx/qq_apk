  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (this.jdField_a_of_type_Int > 0)
    {
      ...
      bkjh.a(Leba.d(this.this$0), 9, this.jdField_a_of_type_Int, 0);
      localObject = this.this$0.a();
      localTextView = Leba.c(this.this$0);
      if (Leba.a(this.this$0).b() == 1)
      {
        bool1 = true;
        bkjh.a((Context)localObject, localTextView, 9, bool1);
      }
    }
    for (;;)
    {
      try
      {
        if ((this.jdField_a_of_type_Boolean) && (this.b > 0))
        {
          if (Leba.e(this.this$0) != null)
          {
            ...
            bkjh.a(Leba.e(this.this$0), 8, this.jdField_a_of_type_Int, 0);
            localObject = this.this$0.a();
            ...
            bkjh.a((Context)localObject, localTextView, 8, bool1);
          }
        ...
        if ((this.jdField_a_of_type_Boolean) && (this.b == 0) && (this.jdField_a_of_type_Int == 0))
        {
          ...
          bkjh.a((Context)localObject, localTextView, 10, bool1);
          continue;
        }
        if (Leba.e(this.this$0) == null) {
          continue;
