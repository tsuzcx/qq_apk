  ...
  implements CompoundButton.OnCheckedChangeListener
{
  ...
  BizTroopObserver jdField_a_of_type_ComTencentMobileqqAppBizTroopObserver = new tuh(this);
  TroopObserver jdField_a_of_type_ComTencentMobileqqAppTroopObserver = new tuk(this);
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    paramBundle = ((LayoutInflater)getSystemService("layout_inflater")).inflate(2130969460, null);
    this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)paramBundle.findViewById(2131363710));
    ...
    localObject = View.inflate(this, 2130970624, null);
    ...
    ((TextView)localObject).setText(getResources().getString(2131429869));
    this.jdField_a_of_type_AndroidWidgetLinearLayout.addView((View)localObject);
    this.b = new LinearLayout(this);
    localObject = new AbsListView.LayoutParams(-1, -2);
    this.b.setLayoutParams((ViewGroup.LayoutParams)localObject);
    this.b.setOrientation(1);
    this.jdField_a_of_type_AndroidViewView = View.inflate(this, 2130970624, null);
    this.jdField_a_of_type_AndroidViewView.setVisibility(8);
    this.b.addView(this.jdField_a_of_type_AndroidViewView);
    localObject = View.inflate(this, 2130969447, null);
    this.jdField_a_of_type_ComTencentWidgetSwitch = ((Switch)((View)localObject).findViewById(2131366512));
    ...
    if ((localTroopGagInfo != null) && (localTroopGagInfo.a != 0L))
    {
      ...
      this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Tum);
      ...
      if (!NetworkUtil.d(BaseApplication.getContext())) {
        QQToast.a(this, 2131433196, 0).b(getTitleBarHeight());
      }
    ...
    {
      if (!bool) {
        ThreadManager.post(new tug(this, (TroopGagMgr)this.app.getManager(47)), 8, null, false);
      }
