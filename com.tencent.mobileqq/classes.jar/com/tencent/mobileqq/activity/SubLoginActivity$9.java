  ...
  extends SubAccountObserver
{
  ...
  public void onGetKeyBack(String paramString1, String paramString2, String paramString3)
  {
    ...
    else
    {
      ...
      this.a.e();
      this.a.b(this.a.getString(2131719626));
    ...
    for (;;)
    {
      ...
      if (!SubLoginActivity.a(this.a))
      {
        ...
        this.a.e();
        paramString1 = (SubAccountManager)this.a.app.getManager(QQManagerFactory.SUB_ACCOUNT_MANAGER);
      ...
      while (QLog.isColorLevel())
      {
        ...
        paramString1 = (SubAccountProtocManager)this.a.app.getManager(QQManagerFactory.MGR_SUB_ACNT);
        if (paramString1 != null) {
  ...
  public void onLoginFailed(String paramString1, String paramString2, String paramString3, Bundle paramBundle)
  {
    ...
    paramString3 = paramBundle.getString("error");
    if (QLog.isColorLevel()) {
      QLog.d("Q.subaccount.SubLoginActivity", 2, "onLoginFailed: subLogin ...onLoginTimeout  subuin =  uin .. .errorMsg = " + paramString3);
    }
    HashMap localHashMap = new HashMap();
    localHashMap.put("param_FailCode", "12002");
    localHashMap.put("fail_step", "loginFail");
    ...
    for (;;)
    {
      localHashMap.put("fail_location", paramString1);
      StatisticCollector.getInstance(BaseApplication.getContext()).collectPerformance(this.a.app.getCurrentAccountUin(), "actSBLogin", false, 0L, 0L, localHashMap, "");
      ...
      try
      {
        ...
        if (TextUtils.isEmpty(paramString3))
        {
          this.a.b(this.a.getString(2131694457));
          return;
      ...
      catch (Exception paramString1)
      {
        ...
        if (i == 40)
        {
          LoginFailedHelper.a(this.a, SubLoginActivity.a(this.a).getText().toString(), this.a.app);
          ReportController.a(this.a.app, "dc00898", "", "", "0X800B296", "0X800B296", 0, 0, "", "", paramString3, "");
          return;
        }
        if (i == 1)
        {
          SubLoginActivity.a(this.a).a(this.a.app, this.a, paramString2, 3, paramString3, new SubLoginActivity.9.3(this));
          return;
        }
        this.a.b(this.a.getResources().getString(2131718689), paramString3, null);
      }
    }
  }
