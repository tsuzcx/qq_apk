...
public class UpgradeDetailActivity
  ...
  implements amqh, Handler.Callback
{
  private long jdField_a_of_type_Long;
  private View jdField_a_of_type_AndroidViewView;
  public ProgressBar a;
  private atgt jdField_a_of_type_Atgt;
  bhsl jdField_a_of_type_Bhsl;
  ...
  private void a()
  {
    this.jdField_a_of_type_AndroidViewView = findViewById(2131378492);
    this.jdField_a_of_type_AndroidViewView.setVisibility(8);
    this.jdField_a_of_type_ComTencentSmttSdkWebView = ((ProtectedWebView)findViewById(2131378494));
    ...
    this.jdField_a_of_type_ComTencentSmttSdkWebView.setWebViewClient(new aekx(this, null));
    this.jdField_a_of_type_ComTencentSmttSdkWebView.setWebChromeClient(new aekw(this, null));
    this.jdField_a_of_type_Atgt = new atgt();
    this.jdField_a_of_type_Atgt.a(new UpgradeDetailActivity.JsCover(this), "qqupgrade");
    this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)findViewById(2131378495));
  }
      ...
      do
      {
        do
        {
          do
          {
            ...
            if (paramInt2 == 1)
            {
              azqs.b(null, "dc00898", "", "", "0X800AB96", "0X800AB96", 0, 0, "", "", "", "");
              return;
            }
            if (paramInt2 == 2)
            {
              azqs.b(null, "dc00898", "", "", "0X800AB97", "0X800AB97", 0, 0, "", "", "", "");
              return;
            }
          } while (paramInt2 != 3);
          azqs.b(null, "dc00898", "", "", "0X800AB98", "0X800AB98", 0, 0, "", "", "", "");
          return;
          if (paramInt2 == 1)
          {
            azqs.b(null, "dc00898", "", "", "0X800AB99", "0X800AB99", 0, 0, "", "", "", "");
            return;
          }
          if (paramInt2 == 2)
          {
            azqs.b(null, "dc00898", "", "", "0X800AB9A", "0X800AB9A", 0, 0, "", "", "", "");
            return;
          }
        } while (paramInt2 != 3);
        azqs.b(null, "dc00898", "", "", "0X800AB9B", "0X800AB9B", 0, 0, "", "", "", "");
        return;
        if (paramInt2 == 1)
        {
          azqs.b(null, "dc00898", "", "", "0X800AB9C", "0X800AB9C", 0, 0, "", "", "", "");
          return;
        }
        if (paramInt2 == 2)
        {
          azqs.b(null, "dc00898", "", "", "0X800AB9D", "0X800AB9D", 0, 0, "", "", "", "");
          return;
        }
      } while (paramInt2 != 3);
      azqs.b(null, "dc00898", "", "", "0X800AB9E", "0X800AB9E", 0, 0, "", "", "", "");
      return;
      if (paramInt2 == 1)
      {
        azqs.b(null, "dc00898", "", "", "0X800AB9F", "0X800AB9F", 0, 0, "", "", "", "");
        return;
      }
      if (paramInt2 == 2)
      {
        azqs.b(null, "dc00898", "", "", "0X800ABA0", "0X800ABA0", 0, 0, "", "", "", "");
        return;
      }
    } while (paramInt2 != 3);
    azqs.b(null, "dc00898", "", "", "0X800ABA1", "0X800ABA1", 0, 0, "", "", "", "");
  }
  ...
  private void b(boolean paramBoolean)
  {
    ...
    {
      if (paramBoolean) {
        this.jdField_a_of_type_Bhsl.obtainMessage(100, 0, 0).sendToTarget();
      }
      localObject = bdgm.a(this, 230);
      aekv localaekv = new aekv(this, i);
      str1 = "";
      switch (i)
      {
      }
      for (;;)
      {
        String str2 = getString(2131691718, new Object[] { str1 });
        str1 = getString(2131691716, new Object[] { str1 });
        ((bdjz)localObject).setMessage(str2);
        ((bdjz)localObject).setTitle(2131691720);
        ((bdjz)localObject).setNegativeButton(2131691715, localaekv);
        ((bdjz)localObject).setPositiveButton(str1, getResources().getColor(2131165332), localaekv);
        ((bdjz)localObject).show();
        a(i, 1);
        return;
        str1 = getString(2131691722);
        continue;
        str1 = getString(2131691721);
        continue;
        str1 = getString(2131691719);
        continue;
        str1 = getString(2131691717);
      }
    }
    amqe.a().b(false);
  }
  ...
  public void a(int paramInt, amqe paramamqe)
  {
    if (this.jdField_a_of_type_Boolean) {
      this.jdField_a_of_type_Bhsl.obtainMessage(100, paramInt, 0).sendToTarget();
    }
  }
  ...
  public void finish()
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      {
        this.jdField_a_of_type_Bhsl.removeMessages(100);
        this.jdField_a_of_type_Bhsl.removeMessages(101);
      }
      if (this.jdField_a_of_type_ComTencentSmttSdkWebView == null) {}
    }
    try
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    amqe.a().a(this);
    if (this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Amqj != null)
    {
      this.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Amqj.jdField_b_of_type_JavaLangString;
      this.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Amqj.jdField_a_of_type_JavaLangString;
      this.jdField_a_of_type_Long = this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Amqj.jdField_a_of_type_Long;
    }
    ...
    for (;;)
    {
      ...
      if (localIntent.getBooleanExtra("download_right_now", false)) {
        this.jdField_a_of_type_Bhsl.sendEmptyMessageAtTime(101, 1500L);
      }
      b(str1);
      a();
      if (paramBundle != null) {
