  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      str = TeamWorkUtils.b(str, "s_qq_myfile");
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityTeamWorkDocEditBrowserActivity$TeamWorkDocEditBrowserFragment$10.this$0.getActivity().overridePendingTransition(2130771990, 2130771991);
