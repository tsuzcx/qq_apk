  ...
  implements Runnable
{
  ...
  public void run()
  {
    Object localObject = (atxd)this.this$0.app.getManager(160);
    RedTouchItem localRedTouchItem = ((atxd)localObject).a(100601);
    if ((((atxd)localObject).a(localRedTouchItem, false)) && (localRedTouchItem.passThroughLevel > 0))
    {
