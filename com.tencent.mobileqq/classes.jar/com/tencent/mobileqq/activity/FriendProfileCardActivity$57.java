  ...
  implements Runnable
{
  ...
  public void run()
  {
    Object localObject = (atax)this.this$0.app.getManager(160);
    RedTouchItem localRedTouchItem = ((atax)localObject).a(100601);
    if ((((atax)localObject).a(localRedTouchItem, false)) && (localRedTouchItem.passThroughLevel > 0))
    {
