  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          localObject = bacm.a();
          localObject = azwp.a(this.this$0.app, 1, Long.toString(this.a), 3, (Drawable)localObject, (Drawable)localObject, 4);
          this.this$0.runOnUiThread(new ChatSettingForTroop.21.1(this, localImageView, (azwp)localObject));
          return;
        }
      }
