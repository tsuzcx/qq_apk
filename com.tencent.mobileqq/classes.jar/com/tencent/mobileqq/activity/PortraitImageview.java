  ...
  extends View
{
  ...
  private void a(Context paramContext)
  {
    ...
    this.jdField_c_of_type_JavaLangRunnable = new tdd(this);
    this.jdField_a_of_type_AndroidViewScaleGestureDetector = new ScaleGestureDetector(paramContext, new tdh(this));
    this.jdField_a_of_type_AndroidViewGestureDetector = new GestureDetector(paramContext, new tdg(this, null));
  ...
  public void a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    ...
    float f1 = a();
    post(new tdf(this, paramFloat4, System.currentTimeMillis(), f1, paramFloat1, paramFloat2, paramFloat3));
  }
  ...
  public void setImageBitmap(Bitmap paramBitmap)
  {
    ...
    if (getWidth() <= 0)
    {
      this.jdField_b_of_type_JavaLangRunnable = new tde(this, paramBitmap);
      return;
    }
    if (paramBitmap != null) {
