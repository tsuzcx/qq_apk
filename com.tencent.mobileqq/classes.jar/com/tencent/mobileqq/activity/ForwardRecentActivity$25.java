  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      this.a.jdField_a_of_type_ComTencentMobileqqForwardForwardBaseOption.a().putString("uin", "-1010");
      this.a.jdField_a_of_type_ComTencentMobileqqForwardForwardBaseOption.D();
      ReportController.b(this.a.app, "CliOper", "", "", "friendchoose", "0X800A2D7", ForwardRecentActivity.a(this.a), 0, "", "", "", ForwardRecentActivity.a(this.a));
      ...
      {
        ReportCenter.a().a(this.a.app.getAccount(), "", this.a.b, "1000", "33", "0", false, this.a.jdField_a_of_type_Boolean);
        if ((this.a.jdField_a_of_type_ComTencentMobileqqForwardForwardBaseOption instanceof ForwardSdkBaseOption))
        {
          localObject1 = (ForwardSdkBaseOption)this.a.jdField_a_of_type_ComTencentMobileqqForwardForwardBaseOption;
          localObject2 = new Bundle();
          ((Bundle)localObject2).putString("report_type", "102");
          ((Bundle)localObject2).putString("act_type", "81");
          ((Bundle)localObject2).putString("intext_1", "" + ReportDef.RepUtil.a(((ForwardSdkBaseOption)localObject1).e));
          ((Bundle)localObject2).putString("intext_2", "" + ReportDef.RepUtil.a(-1, AppConstants.QZONE_UIN));
          ((Bundle)localObject2).putString("intext_3", "0");
          ReportCenter.a().a((Bundle)localObject2, "", this.a.app.getCurrentAccountUin(), false, this.a.jdField_a_of_type_Boolean);
        }
      }
