  ...
  extends TroopBusinessObserver
{
  ...
  public void onOIDB0X89E_0_Ret(boolean paramBoolean, long paramLong, String paramString1, String paramString2, int paramInt, String paramString3)
  {
    ...
    if (paramBoolean)
    {
      ...
      paramString1.putExtra("fin_tip_msg", this.a.getString(2131720098));
    ...
    if ((paramInt == 1) || (paramInt == 2) || (paramInt == 6) || (paramInt == 8) || (paramInt == 9) || (paramInt == 10) || (paramInt == 11)) {
      paramString1 = this.a.getString(2131720084);
    }
    for (;;)
    {
      if (this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressNotifier == null) {
      ...
      {
        paramString1 = this.a.getString(2131720086);
      }
      else if ((paramInt == 5) || (paramInt == 17) || (paramInt == 18))
      {
        paramString1 = this.a.getString(2131720085);
      }
      else
      {
        if (paramInt == 12)
        {
          ...
          paramString1.setTitle(this.a.getString(2131696200));
          paramString1.setMessage(this.a.getString(2131696201));
          paramString1.setNegativeButton(this.a.getString(2131696145), new TroopTransferActivity.5.1(this, paramString1));
          paramString1.setPositiveButton(this.a.getString(2131719347), new TroopTransferActivity.5.2(this, paramString1));
          paramString1.show();
          return;
        }
        paramString1 = this.a.getString(2131720085);
