  ...
  implements Handler.Callback, HttpDownloadUtil.HttpDownloadListener
{
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileImageModel$ProfileImageInfo != null)
      {
        ...
        if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileImageModel$ProfileImageInfo.d)) {
          localObject1 = FaceDrawable.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1, this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileImageModel$ProfileImageInfo.d);
        }
      }
    }
    return localObject1;
  ...
  public void a(FriendProfileImageModel.ProfileImageInfo paramProfileImageInfo, boolean paramBoolean)
  {
    ...
    if ((paramBoolean) && (!this.jdField_a_of_type_Boolean) && ((paramProfileImageInfo.jdField_a_of_type_Int == 0) || (paramProfileImageInfo.jdField_a_of_type_Int == 3)))
    {
      ...
      ThreadManager.postImmediately(new sxd(this, paramProfileImageInfo), null, false);
    }
  ...
  public void a(BaseActivity paramBaseActivity, FriendProfileImageModel.ProfileImageInfo paramProfileImageInfo)
  {
    ...
    paramProfileImageInfo.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(false, this.jdField_b_of_type_JavaLangString, false);
    paramProfileImageInfo.c = ProfileCardUtil.a(this.jdField_b_of_type_JavaLangString);
  ...
  void a(String paramString)
  {
    ...
    ThreadManager.post(new sxf(this, paramString), 5, null, true);
  }
  ...
  public void a(String paramString1, byte paramByte, String paramString2)
  {
    ...
    ThreadManager.post(new sxg(this, paramString1, paramByte, paramString2), 5, null, true);
  }
