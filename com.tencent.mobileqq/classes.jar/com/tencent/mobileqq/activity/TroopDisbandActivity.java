  ...
  implements View.OnClickListener
{
  ...
  TroopObserver jdField_a_of_type_ComTencentMobileqqAppTroopObserver = new tuc(this);
  public TroopInfo a;
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131371404));
    this.jdField_a_of_type_AndroidViewView = findViewById(2131371401);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131371403));
    this.jdField_b_of_type_AndroidViewView = findViewById(2131371405);
    this.jdField_a_of_type_AndroidWidgetGridView = ((GridView)findViewById(2131371406));
    ...
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131371407));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)findViewById(2131371408));
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
    this.jdField_b_of_type_AndroidWidgetButton = ((Button)findViewById(2131371409));
  ...
  private void d()
  {
    ...
    localTextView1.setText(getString(2131434504, new Object[] { "解散", "解散" }));
    localTextView1.setGravity(3);
    localTextView2.setText(2131432999);
    localTextView3.setText(2131432998);
    localDialog.setCanceledOnTouchOutside(false);
    localTextView2.setOnClickListener(new tty(this, localDialog));
    localTextView3.setOnClickListener(new ttz(this, localDialog));
    try
    {
      localDialog.show();
      return;
  ...
  private void e()
  {
    String str1 = getString(2131434508);
    String str2 = getString(2131434503);
    QQCustomDialog localQQCustomDialog = DialogUtil.a(this, 230);
    localQQCustomDialog.setTitle(str1);
    localQQCustomDialog.setMessage(str2);
    localQQCustomDialog.setPositiveButton(getString(2131434505), new tua(this, localQQCustomDialog));
    localQQCustomDialog.setPositiveButtonContentDescription(getString(2131427392));
    localQQCustomDialog.setNegativeButton(getString(2131432998), new tub(this));
  ...
  public void a(TroopInfo paramTroopInfo, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo != null)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setText(String.format(getString(2131435198), new Object[] { Integer.valueOf(this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo.wMemberNum) }));
      if (this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo.wMemberNum <= 1)
      {
        this.jdField_c_of_type_AndroidWidgetTextView.setText(2131435193);
        this.jdField_a_of_type_AndroidWidgetTextView.setText(2131435196);
      ...
      for (;;)
      {
        ...
        this.jdField_c_of_type_AndroidWidgetTextView.setText(2131435194);
        this.jdField_a_of_type_AndroidWidgetTextView.setText(2131435195);
        if (!paramBoolean) {
          break;
        }
        ...
        ThreadManager.post(new ttx(this), 5, null, true);
        return;
    ...
    for (int i = 0;; i = 1)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressNotifier.a(0, 2131435199, 1000);
        ...
        this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressNotifier.a(2, 2131435200, 1500);
        continue;
        if (i != 0) {
          this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressNotifier.a(2, 2131434596, 1500);
        } else {
          this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressNotifier.a(2, 2131435192, 1500);
        }
      }
