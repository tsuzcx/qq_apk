  ...
  protected void onGetMutilTroopInfoResult(boolean paramBoolean, ArrayList<TroopInfo> paramArrayList)
  {
    if ((paramBoolean) && (paramArrayList != null))
    {
      ...
      while ((localTroopInfo == null) && (i < paramArrayList.size()))
      {
        ...
        if ((localTroopInfo != null) && (Utils.a(localTroopInfo.troopuin, this.a.jdField_a_of_type_JavaLangString)))
        {
          paramArrayList = this.a;
          paramArrayList.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo = localTroopInfo;
  ...
  protected void onGetTroopInfoResult(boolean paramBoolean, String paramString)
  {
    ...
    if ((paramBoolean) && (Utils.a(paramString, this.a.jdField_a_of_type_JavaLangString)))
    {
      ...
      if (paramString == null) {
        ...
        paramString = paramString.b(((TroopDisbandActivity)localObject).jdField_a_of_type_JavaLangString);
      }
      ((TroopDisbandActivity)localObject).jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo = paramString;
      paramString = this.a;
      paramString.a(paramString.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo, false);
    }
  }
  ...
  protected void onOIDB0X899_0_Ret(boolean paramBoolean, long paramLong1, int paramInt1, List<oidb_0x899.memberlist> paramList, long paramLong2, int paramInt2, String paramString)
  {
    ...
    else
    {
      if (paramBoolean)
      {
        ...
        while (paramInt2 < paramInt1)
        {
          ...
          if ((localObject != null) && (((oidb_0x899.memberlist)localObject).uint64_member_uin.has()))
          {
            ...
            if ((!this.a.jdField_a_of_type_JavaUtilArrayList.contains(paramString)) && (paramString != null) && (!"".equals(paramString.trim())) && (!Utils.a(this.a.d, paramString)))
            {
              int i;
              ...
              localObject = this.a.jdField_a_of_type_JavaUtilArrayList;
      ...
      if (this.a.jdField_a_of_type_JavaUtilArrayList.size() > 0)
      {
        ...
        {
          paramString = this.a;
          paramString.jdField_b_of_type_Long = paramLong2;
          paramList.a(paramLong1, paramString.jdField_b_of_type_Long, 4, 0, 0);
          if (QLog.isColorLevel()) {
        ...
        else
        {
          ...
          paramList.putExtra("leftViewText", this.a.getString(2131716747));
      ...
      else
      {
        if (paramBoolean)
        {
          ...
          {
            paramList = this.a;
            paramList.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressNotifier = new QQProgressNotifier(paramList);
          }
          this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressNotifier.b(2, 2131719825, 1500);
          return;
        }
        paramList = this.a;
        paramList.jdField_b_of_type_Int &= 0xFFFFFFFD;
        ...
        this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressNotifier.b(2, 2131719820, 1500);
      }
    }
  }
}
