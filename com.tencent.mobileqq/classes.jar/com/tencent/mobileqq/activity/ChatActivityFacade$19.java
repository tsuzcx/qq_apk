...
public final class ChatActivityFacade$19
  implements Runnable
{
  public ChatActivityFacade$19(Emoticon paramEmoticon, askd paramaskd, anvs paramanvs) {}
  ...
  public void run()
  {
    ...
    {
      localArrayList = (ArrayList)this.jdField_a_of_type_Askd.a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId, true);
      if ((localArrayList != null) && (localArrayList.size() > 0))
      {
        this.jdField_a_of_type_Anvs.a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId, localArrayList);
