  ...
  implements Observer
{
  ...
  private void c()
  {
    super.setContentView(2130970595);
    setContentBackgroundResource(2130838210);
    this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)findViewById(2131369887));
  ...
  protected View onCreateRightView()
  {
    ...
    this.rightViewText.setCompoundDrawablesWithIntrinsicBounds(2130846130, 0, 0, 0);
  ...
  public void update(Observable paramObservable, Object paramObject)
  {
    if ((paramObject != null) && ((paramObject instanceof MessageRecord)))
    {
      ...
      if ((this.jdField_a_of_type_JavaLangString.equals(paramObservable.frienduin)) && (paramObservable.istroop == 0))
      {
        ...
        runOnUiThread(new rrn(this));
      }
      if (!paramObservable.isSendFromLocal()) {
        runOnUiThread(new rro(this));
      }
    }
  }
}
