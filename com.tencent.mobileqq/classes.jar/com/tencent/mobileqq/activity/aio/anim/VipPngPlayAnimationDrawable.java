  ...
  implements Runnable
{
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_Agmf.cancel(false);
      this.jdField_a_of_type_Agmf = null;
    }
    this.jdField_a_of_type_Int = -1;
    this.jdField_a_of_type_Boolean = true;
    this.jdField_b_of_type_Int = -1;
  ...
  public void a(String[] paramArrayOfString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.jdField_d_of_type_Int = bhjx.a(localOptions.outWidth, 320, this.jdField_a_of_type_AndroidContentResResources.getDisplayMetrics().densityDpi);
        this.e = bhjx.a(localOptions.outHeight, 320, this.jdField_a_of_type_AndroidContentResResources.getDisplayMetrics().densityDpi);
  ...
  protected void b()
  {
    ...
    this.jdField_a_of_type_Agmf = new agmf(this, this.jdField_a_of_type_JavaLangObject);
    this.jdField_a_of_type_Agmf.execute(new Long[] { Long.valueOf(l1 + l2), Long.valueOf(this.jdField_b_of_type_Int), Long.valueOf(this.jdField_a_of_type_Int) });
  }
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_Int == 1) {}
      label100:
      while (((this.jdField_a_of_type_Int != 0) && (this.jdField_a_of_type_Int != 2)) || (this.jdField_a_of_type_Agme == null))
      {
        if (this.jdField_c_of_type_Boolean) {
      ...
      {
        this.jdField_a_of_type_Agme.a(paramCanvas, localRect1, localRect2, this.jdField_a_of_type_AndroidGraphicsPaint);
        break;
        a();
        break label100;
        label182:
  ...
  public void run()
  {
    ...
    } while ((this.jdField_a_of_type_Int == -1) || (this.jdField_a_of_type_AndroidGraphicsBitmap == null) || (this.jdField_a_of_type_Agme.jdField_a_of_type_AndroidGraphicsBitmap == this.jdField_a_of_type_AndroidGraphicsBitmap));
    this.jdField_a_of_type_Agme.a();
    this.jdField_a_of_type_Agme.a(this.jdField_a_of_type_AndroidGraphicsBitmap);
    this.jdField_a_of_type_AndroidGraphicsBitmap = null;
    super.invalidateSelf();
  }
