...
public class AioAnimationDetector
{
  ...
  public void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner, int paramInt1, int paramInt2)
  {
    ...
    BaseApplicationImpl.getContext().getResources().getDrawable(2130845799);
    if (paramInt1 == 3) {
      paramSessionInfo = BaseApplicationImpl.getContext().getResources().getDrawable(2130845799);
    }
    for (;;)
    {
      ...
      do
      {
        ...
        if (paramInt1 == 4)
        {
          paramSessionInfo = BaseApplicationImpl.getContext().getResources().getDrawable(2130845785);
          break;
        }
        if (paramInt1 == 1)
        {
          paramSessionInfo = BaseApplicationImpl.getContext().getResources().getDrawable(2130845802);
          break;
        }
        if (paramInt1 == 2)
        {
          paramSessionInfo = BaseApplicationImpl.getContext().getResources().getDrawable(2130845788);
          break;
        }
        if (paramInt1 == 5)
        {
          paramSessionInfo = BaseApplicationImpl.getContext().getResources().getDrawable(2130845801);
          break;
        }
        if (paramInt1 == HotReactiveHelper.jdField_a_of_type_Int)
        {
          paramSessionInfo = BaseApplicationImpl.getContext().getResources().getDrawable(2130845795);
          break;
        }
      } while (paramInt1 != HotReactiveHelper.jdField_b_of_type_Int);
      paramSessionInfo = BaseApplicationImpl.getContext().getResources().getDrawable(2130845797);
    }
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, ArrayList paramArrayList, boolean paramBoolean1, ChatMessage paramChatMessage, boolean paramBoolean2, AIOAnimationConatiner paramAIOAnimationConatiner, int paramInt)
  {
        ...
        if ((j == 0) && (m == 0))
        {
          ...
          if (localAioAnimationRule.jdField_a_of_type_Boolean)
          {
            ...
            while (i < j)
            {
              ...
              k = i * 800;
              this.jdField_a_of_type_AndroidOsHandler.postDelayed(new ukb(this, paramAIOAnimationConatiner, (Drawable)localObject, k, localAioAnimationRule), paramInt + k);
              i += 1;
            }
          }
          localObject = (AioAnimationRule.JumpImage)localAioAnimationRule.jdField_b_of_type_JavaUtilArrayList.get(0);
          localObject = AioAnimationRule.JumpImage.a(paramQQAppInterface.getApplication(), (AioAnimationRule.JumpImage)localObject);
          this.jdField_a_of_type_AndroidOsHandler.postDelayed(new ukc(this, paramAIOAnimationConatiner, (Drawable)localObject, localAioAnimationRule), paramInt);
        }
      }
      do
      {
        for (;;)
        {
          ...
          if (localAioAnimationRule.jdField_a_of_type_Boolean)
          {
            ...
            while (i < j)
            {
              ...
              localObject = AioAnimationRule.JumpImage.a(paramQQAppInterface.getApplication(), (AioAnimationRule.JumpImage)localObject);
              k = i * 800;
              this.jdField_a_of_type_AndroidOsHandler.postDelayed(new ukd(this, paramAIOAnimationConatiner, (Drawable)localObject, k, localAioAnimationRule), paramInt + k);
              i += 1;
            }
          }
          else
          {
            localObject = (AioAnimationRule.JumpImage)localAioAnimationRule.jdField_b_of_type_JavaUtilArrayList.get(0);
            localObject = AioAnimationRule.JumpImage.a(paramQQAppInterface.getApplication(), (AioAnimationRule.JumpImage)localObject);
            this.jdField_a_of_type_AndroidOsHandler.postDelayed(new uke(this, paramAIOAnimationConatiner, (Drawable)localObject, localAioAnimationRule), paramInt);
          }
        }
      } while (j >= m);
    } while (i < j);
    ...
    if (i == m)
    {
      ...
      if (paramBoolean2)
      {
        ...
        this.jdField_a_of_type_AndroidOsHandler.postDelayed(new ukf(this, paramAIOAnimationConatiner, i, paramChatMessage), paramInt + 0);
      }
      if (QLog.isColorLevel()) {
    ...
    for (int j = 1000;; j = 0)
    {
      if (localAioAnimationRule.jdField_a_of_type_Boolean)
      {
        ...
        while (k < n)
        {
          ...
          localObject = AioAnimationRule.JumpImage.a(paramQQAppInterface.getApplication(), (AioAnimationRule.JumpImage)localObject);
          int i1 = (k + i) * 800;
          this.jdField_a_of_type_AndroidOsHandler.postDelayed(new ukg(this, paramAIOAnimationConatiner, (Drawable)localObject, i1, localAioAnimationRule), paramInt + j + i1);
          k += 1;
        }
      }
      localObject = (AioAnimationRule.JumpImage)localAioAnimationRule.jdField_b_of_type_JavaUtilArrayList.get(0);
      localObject = AioAnimationRule.JumpImage.a(paramQQAppInterface.getApplication(), (AioAnimationRule.JumpImage)localObject);
      k = i * 800;
      this.jdField_a_of_type_AndroidOsHandler.postDelayed(new ukh(this, paramAIOAnimationConatiner, (Drawable)localObject, k, localAioAnimationRule), paramInt + j + k);
      i += 1;
      break label898;
      break label450;
      if (i > m)
      {
        ...
        if (paramBoolean2)
        {
          a(paramQQAppInterface, paramChatMessage, 1, 2, localAioAnimationRule);
          a(paramQQAppInterface, paramChatMessage, localAioAnimationRule);
          this.jdField_a_of_type_AndroidOsHandler.postDelayed(new uki(this, paramAIOAnimationConatiner, i, paramChatMessage), paramInt + 0);
        }
        if (QLog.isColorLevel()) {
          QLog.d("AioAnimationDetector", 2, "detect (M > Y) =======>  egg_jumper animation ,Y=" + m + ",crazyModeEnable=" + localAioAnimationRule.jdField_a_of_type_Boolean);
        }
      ...
      for (i = 1000;; i = 0)
      {
        if (localAioAnimationRule.jdField_a_of_type_Boolean)
        {
          ...
          while (j < k)
          {
            ...
            localObject = AioAnimationRule.JumpImage.a(paramQQAppInterface.getApplication(), (AioAnimationRule.JumpImage)localObject);
            m = j * 800;
            this.jdField_a_of_type_AndroidOsHandler.postDelayed(new ujy(this, paramAIOAnimationConatiner, (Drawable)localObject, m, localAioAnimationRule), paramInt + i + m);
            j += 1;
          }
          break label450;
        }
        localObject = (AioAnimationRule.JumpImage)localAioAnimationRule.jdField_b_of_type_JavaUtilArrayList.get(0);
        localObject = AioAnimationRule.JumpImage.a(paramQQAppInterface.getApplication(), (AioAnimationRule.JumpImage)localObject);
        this.jdField_a_of_type_AndroidOsHandler.postDelayed(new ujz(this, paramAIOAnimationConatiner, (Drawable)localObject, localAioAnimationRule), paramInt + i);
        break label450;
        if (QLog.isColorLevel()) {
        ...
        a(paramQQAppInterface, paramChatMessage, 1, 2, localAioAnimationRule);
        a(paramQQAppInterface, paramChatMessage, localAioAnimationRule);
        this.jdField_a_of_type_AndroidOsHandler.postDelayed(new uka(this, paramAIOAnimationConatiner, i, paramChatMessage), 0 + paramInt);
        break label450;
        break label74;
      }
    }
  ...
  public void a(QQAppInterface paramQQAppInterface, boolean paramBoolean1, boolean paramBoolean2, AIOAnimationConatiner paramAIOAnimationConatiner, int paramInt1, Drawable paramDrawable, int paramInt2)
  {
    ...
    {
      int j = i * 800;
      this.jdField_a_of_type_AndroidOsHandler.postDelayed(new ujx(this, paramAIOAnimationConatiner, paramDrawable, j), j + paramInt1);
      i += 1;
    }
  }
