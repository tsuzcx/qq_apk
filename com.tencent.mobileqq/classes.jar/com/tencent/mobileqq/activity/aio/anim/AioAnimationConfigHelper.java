...
public class AioAnimationConfigHelper
{
  ...
  {
    if ((paramInt < 0) || (ListUtils.a(paramArrayList))) {
      return null;
    }
  ...
  private ArrayList<AioAnimationRule> a(XmlPullParser paramXmlPullParser)
  {
    ...
    if (i != 1) {
      if (i == 2)
      {
        ...
        if (str1.equalsIgnoreCase("Item"))
        {
          ...
          ((AioAnimationRule)localObject1).jdField_b_of_type_Int = Integer.valueOf((String)localObject3).intValue();
        ...
        for (;;)
        {
          ...
          if (str1.equalsIgnoreCase("BusinessItem"))
          {
            ...
            ((AioAnimationRule)localObject1).jdField_a_of_type_Int = 1;
            localObject3 = localObject2;
          }
    ...
    for (;;)
    {
      ...
      localObject1 = new AioAnimationRule.JumpImage();
      if (str1 != null) {
        ((AioAnimationRule.JumpImage)localObject1).c = AioAnimationRule.JumpImage.a(str1);
      }
      ((AioAnimationRule.JumpImage)localObject1).jdField_a_of_type_JavaLangString = str2;
      if (localObject4 != null)
      {
            ...
            if (((String)localObject5).equalsIgnoreCase("JumpType"))
            {
              ...
              if (k == 3)
              {
                ...
                if (paramXmlPullParser.getName().equalsIgnoreCase("Item"))
                {
                  ...
                  {
                    ((AioAnimationRule)localObject5).jdField_a_of_type_JavaLangString = ((String)localObject3);
                    ((AioAnimationRule)localObject5).a(n);
                    ((AioAnimationRule)localObject5).jdField_b_of_type_JavaLangString = ((String)localObject4);
                    localObject1 = localObject4;
                    i = n;
                    localObject2 = localObject3;
                    m = j;
  ...
  private boolean a(String paramString)
  {
    ...
    //   165: aload_0
    //   166: aload_2
    //   167: invokespecial 329	com/tencent/mobileqq/activity/aio/anim/AioAnimationConfigHelper:a	(Lorg/xmlpull/v1/XmlPullParser;)Ljava/util/ArrayList;
    //   170: astore_2
    //   171: aload_1
    //   172: ifnull +7 -> 179
    //   175: aload_1
    ...
    //   183: aload_0
    //   184: aload_2
    //   185: putfield 333	com/tencent/mobileqq/activity/aio/anim/AioAnimationConfigHelper:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   188: aload_0
    //   189: getstatic 61	com/tencent/mobileqq/activity/aio/anim/AioAnimationConfigHelper:c	Ljava/lang/String;
    //   192: aload_0
    //   193: getfield 333	com/tencent/mobileqq/activity/aio/anim/AioAnimationConfigHelper:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   196: invokespecial 336	com/tencent/mobileqq/activity/aio/anim/AioAnimationConfigHelper:a	(Ljava/lang/String;Ljava/util/ArrayList;)Z
    //   199: pop
    //   200: iconst_1
    //   201: ireturn
    //   202: astore_2
    ...
    //   0	315	0	this	AioAnimationConfigHelper
  ...
  private boolean a(String paramString, ArrayList<AioAnimationRule> paramArrayList)
  {
    ...
    //   82: aconst_null
    //   83: invokestatic 348	com/tencent/mobileqq/utils/FileUtils:a	(Ljava/io/Closeable;)V
    //   86: iconst_0
    //   87: ireturn
    //   88: aload 6
    //   90: astore_3
    ...
    //   159: aload_3
    //   160: aload_2
    //   161: invokespecial 352	com/tencent/mobileqq/activity/aio/anim/AioAnimationConfigHelper:a	(Lorg/xmlpull/v1/XmlPullParser;Ljava/util/ArrayList;)V
    //   164: aload_1
    //   165: invokestatic 348	com/tencent/mobileqq/utils/FileUtils:a	(Ljava/io/Closeable;)V
    //   168: iconst_1
    //   169: ireturn
    //   170: astore_2
    //   171: aload 4
    ...
    //   194: aload_1
    //   195: invokestatic 348	com/tencent/mobileqq/utils/FileUtils:a	(Ljava/io/Closeable;)V
    //   198: iconst_0
    //   199: ireturn
    //   200: astore_2
    //   201: aload 5
    ...
    //   224: aload_1
    //   225: invokestatic 348	com/tencent/mobileqq/utils/FileUtils:a	(Ljava/io/Closeable;)V
    //   228: iconst_0
    //   229: ireturn
    //   230: astore_1
    //   231: aload_3
    //   232: invokestatic 348	com/tencent/mobileqq/utils/FileUtils:a	(Ljava/io/Closeable;)V
    //   235: aload_1
    //   236: athrow
    //   237: astore_2
    //   238: aload_1
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	253	0	this	AioAnimationConfigHelper
    //   0	253	1	paramString	String
    //   0	253	2	paramArrayList	ArrayList<AioAnimationRule>
  ...
  {
    if (FileUtils.b(jdField_b_of_type_JavaLangString))
    {
