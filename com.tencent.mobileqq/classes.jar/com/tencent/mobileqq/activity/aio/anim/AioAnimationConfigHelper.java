...
public class AioAnimationConfigHelper
{
  ...
  private ArrayList a(XmlPullParser paramXmlPullParser)
  {
    ...
    for (;;)
    {
      ...
      if (str1 != null) {
        ((AioAnimationRule.JumpImage)localObject2).jdField_b_of_type_Int = AioAnimationRule.JumpImage.a(str1);
      }
      ((AioAnimationRule.JumpImage)localObject2).jdField_a_of_type_JavaLangString = str2;
      if (localObject4 != null)
      {
      ...
      localObject4.jdField_a_of_type_ComTencentMobileqqActivityAioAnimAioAnimationRule$BussinessData.jdField_a_of_type_Int = Integer.parseInt((String)localObject2);
      ...
      localObject4.jdField_a_of_type_ComTencentMobileqqActivityAioAnimAioAnimationRule$BussinessData.c = Integer.parseInt(str1);
      localObject4.jdField_a_of_type_ComTencentMobileqqActivityAioAnimAioAnimationRule$BussinessData.e = Integer.parseInt(str3);
      localObject4.jdField_a_of_type_ComTencentMobileqqActivityAioAnimAioAnimationRule$BussinessData.d = Integer.parseInt(str2);
      localObject2 = localObject4;
      localObject3 = localObject1;
      break;
      localObject2 = localObject4;
  ...
  private boolean a(String paramString)
  {
    ...
    //   14: dup
    //   15: aload_1
    //   16: invokespecial 233	java/io/File:<init>	(Ljava/lang/String;)V
    //   19: astore_1
    //   20: aload 5
    //   22: astore_2
    //   23: aload_1
    //   24: invokevirtual 236	java/io/File:exists	()Z
    //   27: ifeq +13 -> 40
    //   30: aload 5
    //   32: astore_2
    //   33: aload_1
    //   34: invokevirtual 239	java/io/File:isFile	()Z
    //   37: ifne +57 -> 94
    //   40: aload 5
    //   42: astore_2
    //   43: invokestatic 199	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   46: ifeq +34 -> 80
    //   49: aload 5
    //   51: astore_2
    //   52: ldc 201
    //   54: iconst_2
    //   55: new 19	java/lang/StringBuilder
    //   58: dup
    //   59: invokespecial 22	java/lang/StringBuilder:<init>	()V
    //   62: ldc 241
    //   64: invokevirtual 43	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   67: aload_1
    //   68: invokevirtual 244	java/io/File:getAbsolutePath	()Ljava/lang/String;
    ...
    //   77: invokestatic 246	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   80: iconst_0
    //   81: ifeq +11 -> 92
    //   84: new 248	java/lang/NullPointerException
    //   87: dup
    //   88: invokespecial 249	java/lang/NullPointerException:<init>	()V
    //   91: athrow
    //   92: iconst_0
    //   93: ireturn
    //   94: aload 5
    //   96: astore_2
    //   97: invokestatic 199	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   100: ifeq +34 -> 134
    //   103: aload 5
    //   105: astore_2
    //   106: ldc 201
    //   108: iconst_2
    //   109: new 19	java/lang/StringBuilder
    //   112: dup
    //   113: invokespecial 22	java/lang/StringBuilder:<init>	()V
    //   116: ldc 251
    //   118: invokevirtual 43	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   121: aload_1
    //   122: invokevirtual 244	java/io/File:getAbsolutePath	()Ljava/lang/String;
    ...
    //   131: invokestatic 217	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   134: aload 5
    //   136: astore_2
    //   137: new 253	java/io/FileInputStream
    //   140: dup
    //   141: aload_1
    //   142: invokespecial 256	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   145: astore_1
    //   146: invokestatic 262	org/xmlpull/v1/XmlPullParserFactory:newInstance	()Lorg/xmlpull/v1/XmlPullParserFactory;
    //   149: invokevirtual 266	org/xmlpull/v1/XmlPullParserFactory:newPullParser	()Lorg/xmlpull/v1/XmlPullParser;
    //   152: astore_2
    //   153: aload_2
    //   154: aload_1
    //   155: ldc_w 268
    //   158: invokeinterface 272 3 0
    //   163: aload_0
    //   164: aload_2
    //   165: invokespecial 274	com/tencent/mobileqq/activity/aio/anim/AioAnimationConfigHelper:a	(Lorg/xmlpull/v1/XmlPullParser;)Ljava/util/ArrayList;
    //   168: astore_2
    //   169: aload_1
    //   170: ifnull +7 -> 177
    //   173: aload_1
    ...
    //   243: ldc_w 280
    //   246: aload_3
    //   247: invokestatic 283	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   250: aload_1
    //   251: ifnull -159 -> 92
    //   254: aload_1
    //   255: invokevirtual 277	java/io/FileInputStream:close	()V
    //   258: iconst_0
    //   259: ireturn
    //   260: astore_1
    //   261: iconst_0
    ...
    //   265: ifnull +7 -> 272
    //   268: aload_2
    //   269: invokevirtual 277	java/io/FileInputStream:close	()V
    //   272: aload_1
    //   273: athrow
    //   274: astore_1
    //   275: iconst_0
  ...
  private void b(Context paramContext)
  {
    ...
    paramContext = paramContext.getResources().getXml(2131165185);
