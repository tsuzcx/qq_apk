  ...
  extends View
{
  ...
  private void a()
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ((ObjectAnimator)localObject1).addListener(new uuf(this, bool2, localDrawItem2, bool1));
        ((ObjectAnimator)localObject1).setDuration(250L);
        m += 83;
      ...
      this.jdField_a_of_type_AndroidAnimationAnimatorSet.addListener(new uug(this));
