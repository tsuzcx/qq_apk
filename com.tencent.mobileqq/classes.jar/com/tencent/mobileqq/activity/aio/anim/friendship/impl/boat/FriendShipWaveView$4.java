  ...
  implements Action.OnActionEndListener
{
  ...
  public void a()
  {
    ...
    this.a.d.a(new Action[] { localObject });
    ...
    localObject = this.a;
    ((FriendShipWaveView)localObject).a(((FriendShipWaveView)localObject).e);
    ...
    localObject = this.a;
    ((FriendShipWaveView)localObject).a(((FriendShipWaveView)localObject).f);
    localObject = new ScaleAction(500, 0.0F, 1.0F);
    this.a.f.a(new Action[] { localObject });
    ...
    localObject = this.a;
    ((FriendShipWaveView)localObject).a(((FriendShipWaveView)localObject).g);
    localObject = new ScaleAction(500, 0.0F, 1.0F);
    this.a.g.a(new Action[] { localObject });
