  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      Object localObject = (acon)localIterator.next();
      long l2 = ((acon)localObject).a();
      if (l2 >= 0L)
      {
        if (l1 < 0L) {}
      ...
      if (QLog.isColorLevel()) {
        QLog.d("FloorJumperSet", 2, "removed businessId:" + ((acon)localObject).c);
      }
      if (((acon)localObject).c == 1)
      {
        ...
        } while (((acon)((Iterator)localObject).next()).c != 1);
      }
    }
    for (int i = 1;; i = 0)
    {
