  ...
  extends AIOAnimationConatiner.AIOAnimator
{
  ...
  private boolean a()
  {
    ...
    {
      localObject2 = (LottieAnimation.EggAnimInfo)this.jdField_a_of_type_JavaUtilQueue.peek();
      if (localObject2 != null)
      {
        localObject1 = ((LottieAnimation.EggAnimInfo)localObject2).jdField_a_of_type_JavaLangString;
        i = ((LottieAnimation.EggAnimInfo)localObject2).jdField_a_of_type_Int;
        label107:
        if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setImageAssetDelegate(new LottieAnimation.2(this, (String)localObject2));
        LottieComposition.Factory.fromInputStream(this.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.getContext(), localIOException2, new LottieAnimation.3(this, localIOException2));
        ...
        switch (this.jdField_a_of_type_ComTencentMobileqqActivityAioAnimLottieAnimationInfo.jdField_a_of_type_Int)
        {
        }
        for (;;)
        {
          ...
          str = this.jdField_a_of_type_ComTencentMobileqqActivityAioAnimLottieAnimationInfo.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo.troopuin;
          ...
          ReportController.b(null, "dc00898", "", this.jdField_a_of_type_ComTencentMobileqqActivityAioAnimLottieAnimationInfo.jdField_a_of_type_JavaLangString, "0X800AE17", "0X800AE17", i, 0, str, String.valueOf(l), "", "");
        }
        str = null;
      }
      String str = "";
  ...
  protected boolean a(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    Object localObject = (InputLinearLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131369142);
    if (localObject != null) {}
    for (paramInt4 = ((InputLinearLayout)localObject).getHeight();; paramInt4 = 0)
    {
      localObject = (PanelIconLinearLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131372729);
      if (localObject != null) {
  ...
  protected boolean a(Object... paramVarArgs)
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetLinearLayout == null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)View.inflate(this.jdField_a_of_type_AndroidWidgetRelativeLayout.getContext(), 2131558620, null));
      if (this.jdField_a_of_type_AndroidWidgetLinearLayout == null)
      {
        if (QLog.isColorLevel()) {
      ...
      this.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView = ((DiniFlyAnimationView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131362361));
      ...
      this.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.addAnimatorListener(new LottieAnimation.1(this));
