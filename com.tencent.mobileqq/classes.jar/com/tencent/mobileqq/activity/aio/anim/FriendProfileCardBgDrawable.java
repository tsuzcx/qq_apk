  ...
  implements Runnable
{
  ...
  public Handler a;
  private bgxu jdField_a_of_type_Bgxu;
  public Object a;
  public boolean a;
  ...
  public FriendProfileCardBgDrawable(Resources paramResources, bgxu parambgxu)
  {
    ...
    this.jdField_a_of_type_Bgxu = parambgxu;
    if (parambgxu != null)
    {
      if (parambgxu.jdField_a_of_type_ArrayOfJavaLangString != null) {
        this.jdField_d_of_type_Boolean = true;
      }
      a(parambgxu.jdField_a_of_type_ArrayOfJavaLangString, parambgxu.jdField_b_of_type_Int, parambgxu.jdField_a_of_type_JavaLangString);
    }
  }
  ...
  {
    if ((this.jdField_a_of_type_Bgxu != null) && (this.jdField_d_of_type_Boolean))
    {
      float f1 = this.jdField_e_of_type_Int / paramInt1;
      float f2 = this.f / paramInt2;
      int i = (int)(this.jdField_a_of_type_Bgxu.jdField_a_of_type_Float * paramInt3);
      paramInt1 = (int)(this.jdField_a_of_type_Bgxu.jdField_b_of_type_Float * paramInt4);
      paramInt2 = (int)(this.jdField_a_of_type_Bgxu.c * paramInt3);
      paramInt3 = (int)(this.jdField_a_of_type_Bgxu.d * paramInt4);
      paramInt4 = (int)(i / f1);
  ...
  private void d()
  {
    ...
    //   34: aload_0
    //   35: getfield 60	com/tencent/mobileqq/activity/aio/anim/FriendProfileCardBgDrawable:jdField_a_of_type_Bgxu	Lbgxu;
    //   38: getfield 71	bgxu:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   93: aload_0
    //   94: getfield 60	com/tencent/mobileqq/activity/aio/anim/FriendProfileCardBgDrawable:jdField_a_of_type_Bgxu	Lbgxu;
    //   97: getfield 71	bgxu:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   154: aload_0
    //   155: getfield 60	com/tencent/mobileqq/activity/aio/anim/FriendProfileCardBgDrawable:jdField_a_of_type_Bgxu	Lbgxu;
    //   158: getfield 71	bgxu:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   190: dup
    //   191: aload_0
    //   192: getfield 60	com/tencent/mobileqq/activity/aio/anim/FriendProfileCardBgDrawable:jdField_a_of_type_Bgxu	Lbgxu;
    //   195: getfield 71	bgxu:jdField_a_of_type_JavaLangString	Ljava/lang/String;
  ...
  public Bitmap a(Object paramObject, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Bgxu != null)
    {
      d();
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Agbu != null)
    {
      this.jdField_a_of_type_Agbu.cancel(false);
      this.jdField_a_of_type_Agbu = null;
    }
    if (this.jdField_c_of_type_AndroidGraphicsBitmap != null) {
      synchronized (this.jdField_a_of_type_ArrayOfByte)
      {
  ...
  protected void c()
  {
    ...
    this.jdField_a_of_type_Agbu = new agbu(this, this.jdField_a_of_type_JavaLangObject);
    this.jdField_a_of_type_Agbu.execute(new Long[] { Long.valueOf(l1 + l2), Long.valueOf(this.jdField_a_of_type_Int) });
  }
