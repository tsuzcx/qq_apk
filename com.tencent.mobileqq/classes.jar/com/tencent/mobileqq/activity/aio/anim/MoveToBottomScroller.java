  ...
  implements Runnable
{
  ...
  acyn jdField_a_of_type_Acyn;
  aczi jdField_a_of_type_Aczi;
  ...
  public MoveToBottomScroller(ListView paramListView, acyn paramacyn)
  {
    this.jdField_a_of_type_ComTencentWidgetListView = paramListView;
    this.jdField_a_of_type_Acyn = paramacyn;
  ...
  public void a()
  {
    ...
    for (;;)
    {
      ...
      while (QLog.isColorLevel())
      {
        ...
        int i2;
        if ((this.jdField_a_of_type_ComTencentWidgetListView.getFooterViewsCount() > 0) && (this.jdField_a_of_type_Acyn.jdField_a_of_type_Int >= 0)) {
          if (this.jdField_d_of_type_Int > 1)
          {
            i2 = this.jdField_d_of_type_Int - 1;
            label448:
            this.jdField_d_of_type_Int = i2;
            this.n = this.jdField_a_of_type_Acyn.jdField_a_of_type_Int;
            label464:
            i2 = this.n;
  ...
  public void a(aczi paramaczi)
  {
    this.jdField_a_of_type_Aczi = paramaczi;
  }
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Aczi != null) {
      this.jdField_a_of_type_Aczi.al_();
    }
    this.jdField_a_of_type_ComTencentWidgetListView.removeCallbacks(this);
  }
  ...
  public void run()
  {
    ...
    for (int i1 = 0;; i1 = i2)
    {
      ...
      for (;;)
      {
        ...
        break;
        i1 = (int)(bfmw.a(i3 / this.m) * this.n);
        break;
