...
class LottieAnimController$AlphaEvaluator
  implements TypeEvaluator
{
  public Object evaluate(float paramFloat, Object paramObject1, Object paramObject2)
  {
    if (QLog.isColorLevel())
    {
      ...
      QLog.d("LottieAnimController", 2, paramObject1.toString());
    }
    if (paramFloat >= 0.0F)
    {
      d = paramFloat;
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.aio.anim.friendship.impl.lottie.LottieAnimController.AlphaEvaluator
