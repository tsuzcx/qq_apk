  ...
  extends AIOAnimationConatiner.AIOAnimator
{
  ...
  {
    if ((paramArrayOfObject.length < 5) || (!(paramArrayOfObject[3] instanceof AioAnimationRule)) || (!(paramArrayOfObject[4] instanceof ChatMessage))) {}
    AioAnimationRule localAioAnimationRule;
    do
    {
      return;
      localAioAnimationRule = (AioAnimationRule)paramArrayOfObject[3];
    } while (!a(localAioAnimationRule.a));
    paramArrayOfObject = (ChatMessage)paramArrayOfObject[4];
    if (QLog.isColorLevel()) {
      QLog.d("FloorJumper", 2, "set jump url, url = " + localAioAnimationRule.a);
    }
  ...
  int a(int paramInt, BaseBubbleBuilder.ViewHolder paramViewHolder)
  {
    ...
    if (paramViewHolder.jdField_a_of_type_ComTencentMobileqqDataChatMessage.isSend())
    {
      ...
      m = paramViewHolder.jdField_a_of_type_AndroidViewView.getRight() - BaseChatItemLayout.j - BaseChatItemLayout.o;
      if (paramInt > k) {
        break label135;
      }
    ...
    do
    {
      ...
      m = paramViewHolder.jdField_a_of_type_AndroidViewView.getRight() - BaseChatItemLayout.k - BaseChatItemLayout.k;
      break;
      d1 = Math.random();
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      while ((this.jdField_a_of_type_ComTencentMobileqqActivityAioAnimAIOAnimationConatiner == null) || (this.jdField_a_of_type_AndroidViewView == null))
      {
        ...
        else
        {
          ...
          {
            k = localViewHolder.jdField_a_of_type_AndroidViewView.getTop();
            k = localViewHolder.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTop() + k + BaseChatItemLayout.h - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - (this.h + this.jdField_f_of_type_Int);
            if (k != 0)
            {
              this.h += k;
              this.j += k;
