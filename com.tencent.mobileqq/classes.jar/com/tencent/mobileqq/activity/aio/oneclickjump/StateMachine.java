...
public class StateMachine<E extends Enum>
{
  ...
  {
    paramE = (List)this.c.get(paramE.ordinal());
    return (paramE != null) && (paramE.contains(this.d));
  }
  ...
  public void a(E paramE, String paramString)
  {
    if (c(paramE))
    {
      ...
      QLog.d(paramE, 1, paramString.toString());
      return;
    }
    paramString = this.a;
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.aio.oneclickjump.StateMachine
