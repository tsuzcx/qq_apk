  ...
  extends RelativeLayout
{
  ...
  public AIOGalleryAdapter$GalleryImageStruct(AIOGalleryAdapter paramAIOGalleryAdapter, Context paramContext, int paramInt)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter$GalleryImageStruct$GalleryUrlImageView.setId(2131367910);
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setId(2131372237);
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130837943);
      localLayoutParams = new RelativeLayout.LayoutParams(-2, -2);
      localLayoutParams.addRule(13, -1);
      addView(this.jdField_a_of_type_AndroidWidgetImageView, localLayoutParams);
      this.jdField_a_of_type_AndroidWidgetTextView = new TextView(paramContext);
      this.jdField_a_of_type_AndroidWidgetTextView.setText(2131695498);
      this.jdField_a_of_type_AndroidWidgetTextView.setClickable(false);
      this.jdField_a_of_type_AndroidWidgetTextView.setTextSize(bcwh.b(paramAIOGalleryAdapter.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryActivity, 30.4F));
      ...
      paramContext.bottomMargin = bcwh.b(paramAIOGalleryAdapter.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryActivity, 40.0F);
  ...
  public agfq a()
  {
    return this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter$GalleryImageStruct$GalleryUrlImageView.jdField_a_of_type_Agfq;
  }
  ...
  public void a(int paramInt)
  {
    ...
    if (localObject != null) {
      localAIOShortVideoData = (AIOShortVideoData)((agfq)localObject).a;
    }
    int i;
    ...
    do
    {
      do
      {
        ...
        setImageDrawable(BaseApplicationImpl.getApplication().getResources().getDrawable(2130837967));
      ...
      return;
      setImageDrawable(baul.a);
      if (localAIOShortVideoData != null) {
        this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter.jdField_a_of_type_Agft.a(localAIOShortVideoData.jdField_f_of_type_Long, localAIOShortVideoData.jdField_f_of_type_Int, 1);
      }
    } while (!QLog.isColorLevel());
  ...
  public void a(String paramString)
  {
    if ((paramString != null) && (paramString.length() != 0) && (!paramString.equals("null")))
    {
      ...
      localTextView.setText(alpo.a(2131700428) + paramString);
      localTextView.setClickable(false);
      localTextView.setTextSize(1, 14.0F);
      localTextView.setTextColor(Color.parseColor("#777777"));
      localTextView.setVisibility(0);
      localTextView.setPadding(0, aekt.a(10.0F, this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryActivity.getResources()), aekt.a(10.0F, this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryActivity.getResources()), 0);
  ...
  public void setImageInfo(agfq paramagfq)
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter$GalleryImageStruct$GalleryUrlImageView.jdField_a_of_type_Agfq = paramagfq;
  }
