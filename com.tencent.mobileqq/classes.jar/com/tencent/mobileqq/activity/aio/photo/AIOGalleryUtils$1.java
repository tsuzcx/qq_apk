  ...
  extends AsyncTask<Void, Void, Integer>
{
  ...
  protected Integer a(Void... paramVarArgs)
  {
    ...
    for (paramVarArgs = SecUtil.getFileMd5(localFile.getAbsolutePath());; paramVarArgs = null)
    {
      ...
      for (String str1 = str1;; str1 = "")
      {
        ...
        try
        {
          FileUtils.a(localFile, new File(paramVarArgs));
  ...
  protected void a(Integer paramInteger)
  {
    ...
    {
      QQToast.a(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 2131694916, 0).b(this.jdField_a_of_type_Int);
      EmoticonManager.c("2004", 1);
    }
    while (paramInteger.intValue() != 2) {
      return;
    }
    QQToast.a(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 1, 2131689614, 0).b(this.jdField_a_of_type_Int);
