...
public class AIOGalleryScene$3
  implements Runnable
{
  public AIOGalleryScene$3(ahsd paramahsd) {}
  
  public void run()
  {
    Object localObject1;
    Object localObject2;
    if ((this.this$0.jdField_a_of_type_Ahtj.a() != null) && (this.this$0.jdField_a_of_type_Ahtj.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData != null))
    {
      localObject1 = this.this$0.jdField_a_of_type_Ahtj.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
      ...
      if ((this.this$0.jdField_a_of_type_Akhc != null) && (this.this$0.jdField_a_of_type_Akhc.c())) {}
    }
    else
    {
      return;
    ...
    label168:
    long l2;
    if (this.this$0.jdField_a_of_type_Ahtj.a().jdField_a_of_type_Ahuj.d)
    {
      l1 = this.this$0.jdField_a_of_type_Akhc.c();
      localObject1 = ShortVideoUtils.a(ahsd.a(this.this$0), l1 * 1024L);
      this.this$0.e.setText((String)localObject1 + "/s");
      if ((this.this$0.jdField_a_of_type_Akhc == null) || (this.this$0.jdField_a_of_type_Akhc.a == null) || (!this.this$0.jdField_a_of_type_Akhc.a.a)) {
        break label566;
      }
      l1 = this.this$0.jdField_a_of_type_Akhc.d();
    ...
    for (float f = (int)((float)l1 / (float)l2 * 10000.0F);; f = 10000.0F)
    {
      ...
      for (;;)
      {
        ...
        return;
        l1 = this.this$0.jdField_a_of_type_Akhc.a();
        int i = (int)(l1 / this.this$0.jdField_a_of_type_Akhc.b() * 10000.0D);
        ...
        {
          localObject2 = ahsd.a(this.this$0);
          if (localObject2 != null)
          {
            ...
            if ((localObject2 instanceof URLDrawable))
            {
              ...
              if (AIOFileVideoData.class.isInstance(localObject1))
              {
                ...
                l1 = this.this$0.jdField_a_of_type_Akhc.a();
                i = (int)(l1 / this.this$0.jdField_a_of_type_Akhc.b() * 10000.0D);
                this.this$0.c.setText(ShortVideoUtils.a(l1));
                this.this$0.jdField_b_of_type_AndroidWidgetSeekBar.setProgress(i);
              }
            }
