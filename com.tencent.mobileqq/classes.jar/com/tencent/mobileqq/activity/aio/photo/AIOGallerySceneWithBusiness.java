  ...
  extends AIOGalleryScene
{
  ...
  private void a(Context paramContext, String paramString)
  {
    try
    {
      ...
      for (;;)
      {
        ...
        this.e = ((TextView)this.jdField_a_of_type_AndroidAppProgressDialog.findViewById(2131363418));
      }
      return;
    }
  ...
  public void a(ViewGroup paramViewGroup)
  {
    ...
    this.jdField_b_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2130971744, null);
    ...
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_b_of_type_AndroidViewView.findViewById(2131375487));
    this.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
    this.jdField_b_of_type_AndroidWidgetButton = ((Button)this.jdField_b_of_type_AndroidViewView.findViewById(2131375488));
    this.jdField_b_of_type_AndroidWidgetButton.setVisibility(8);
    this.jdField_c_of_type_AndroidWidgetButton = ((Button)this.jdField_b_of_type_AndroidViewView.findViewById(2131375489));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131375485));
    this.jdField_a_of_type_JavaUtilSet = new HashSet();
    paramViewGroup = new vst(this);
      ...
      if ((localObject instanceof AIOShortVideoData))
      {
        ...
        if (localAIOShortVideoData.j == 2)
        {
          ...
          for (;;)
          {
            ...
            this.jdField_d_of_type_AndroidWidgetButton.setBackgroundResource(2130845630);
            ...
            this.jdField_d_of_type_AndroidWidgetButton.setOnClickListener(new vsu(this, localAIOShortVideoData));
            return true;
  ...
  boolean a(ActionSheet paramActionSheet, AIOImageData paramAIOImageData)
  {
    ...
    do
    {
      ...
      if (paramAIOImageData.c == 1)
      {
        ...
        paramActionSheet.b(2131435908);
        paramActionSheet.b(2131435909);
        return true;
      }
    } while (paramAIOImageData.c != 2);
    paramActionSheet.b(2131435891);
    paramActionSheet.b(2131435887);
    paramActionSheet.b(2131435910);
  ...
  boolean a(String paramString, AIOImageData paramAIOImageData, File paramFile)
  {
    ...
    {
      return false;
      if (!paramString.equals(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131435887))) {
        break;
      }
    ...
    label284:
    String str1;
    if (paramString.equals(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131435891))) {
      if (paramAIOImageData.c == 1)
      {
    ...
    for (;;)
    {
      ...
      if ((localObject[7].equals("scrawl_link")) && (localObject.length >= 9))
      {
        ...
        {
          return bool;
          if (paramString.equals(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131435908)))
          {
            if (paramAIOImageData.c != 1) {
              break;
            }
          ...
          if (paramString.equals(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131435909)))
          {
            if (paramAIOImageData.c != 1) {
              break;
            }
          ...
          if ((!paramString.equals(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131435910))) || (paramAIOImageData.c != 2)) {
            break;
          }
          paramString = (StructMsgForImageShare)StructMsgFactory.a((byte[])paramAIOImageData.a);
          b(paramString);
