...
class PhotoListPanel$SwipeUpAndDragListener$DragHandler
  extends PhotoListPanel.SwipeUpAndDragListener.GestureHandler
{
  ...
  public PhotoListPanel$SwipeUpAndDragListener$DragHandler(PhotoListPanel.SwipeUpAndDragListener paramSwipeUpAndDragListener, Context paramContext, ViewGroup paramViewGroup)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(HardCodeUtil.a(2131708112));
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130838326);
  ...
  AnimationSet a()
  {
    ...
    {
    default: 
      f1 = this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel$SwipeUpAndDragListener.a(this.jdField_b_of_type_Int, this.jdField_c_of_type_AndroidWidgetRelativeLayout.getWidth(), this.jdField_c_of_type_AndroidWidgetRelativeLayout.getHeight());
      Logger.a("PhotoListPanel", "createDragReleaseSendAnim", "d scale = " + f1);
      this.jdField_c_of_type_AndroidWidgetRelativeLayout.getLocationInWindow(this.jdField_a_of_type_ArrayOfInt);
      k = this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel$SwipeUpAndDragListener.jdField_a_of_type_ArrayOfInt[0] - (int)(65.0F * this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel$SwipeUpAndDragListener.e + 0.5F + this.jdField_c_of_type_AndroidWidgetRelativeLayout.getWidth() * f1 + 0.5F) - this.jdField_a_of_type_ArrayOfInt[0];
      m = this.jdField_a_of_type_AndroidViewViewGroup.getHeight() + this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel$SwipeUpAndDragListener.jdField_a_of_type_ArrayOfInt[1] - this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel$SwipeUpAndDragListener.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.getHeight() - (int)(13.0F * this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel$SwipeUpAndDragListener.e + 0.5F + this.jdField_c_of_type_AndroidWidgetRelativeLayout.getHeight() * f1 + 0.5F) - this.jdField_a_of_type_Int;
      ...
      {
        i = m - (int)(70.0F * this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel$SwipeUpAndDragListener.e + 0.5F);
        j = k;
      }
      break;
    }
    for (;;)
    {
      ...
      return localObject1;
      f1 = this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel$SwipeUpAndDragListener.a(this.jdField_b_of_type_Int, this.jdField_c_of_type_AndroidWidgetRelativeLayout.getHeight());
      break;
      i = m;
      j = k;
  ...
  boolean a(PhotoListPanel.PhotoPanelAdapter.RecyclerHolder paramRecyclerHolder, int paramInt)
  {
    ...
    paramInt = paramRecyclerHolder.itemView.getWidth() - (int)(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel$SwipeUpAndDragListener.e * 2.0F + 0.5F);
    int i = paramRecyclerHolder.itemView.getHeight() - (int)(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel$SwipeUpAndDragListener.e * 2.0F + 0.5F) * 2;
    ...
    if (PhotoListPanel.f() == 1)
    {
      float f2 = paramRecyclerHolder.itemView.getWidth() - this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel$SwipeUpAndDragListener.jdField_b_of_type_Float;
      float f1 = f2;
      if (this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel$SwipeUpAndDragListener.jdField_b_of_type_Float > paramRecyclerHolder.itemView.getWidth()) {
        f1 = f2 + paramRecyclerHolder.itemView.getWidth();
      }
      f2 = paramRecyclerHolder.itemView.getWidth() * 0.4F / 2.0F;
      paramRecyclerHolder = this.jdField_a_of_type_AndroidWidgetRelativeLayout$LayoutParams;
      paramRecyclerHolder.topMargin = ((int)(paramRecyclerHolder.topMargin - (f1 + f2)));
    }
    if (PhotoListPanel.f() == 1) {
      this.jdField_c_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130841667);
    }
  ...
  boolean b(MotionEvent paramMotionEvent)
  {
    ...
    this.jdField_c_of_type_AndroidWidgetRelativeLayout.startAnimation(paramMotionEvent);
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(4);
    int i = this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel$SwipeUpAndDragListener.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel$PhotoPanelAdapter.getItemViewType(this.jdField_b_of_type_Int);
    Object localObject2 = new ArrayList();
    ((ArrayList)localObject2).add(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel$SwipeUpAndDragListener.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel$PhotoPanelAdapter.a(this.jdField_b_of_type_Int).path);
    ...
    {
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel$SwipeUpAndDragListener.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel$SwipeUpAndDragCallBack;
      localObject2 = this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel$SwipeUpAndDragListener.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel$PhotoPanelAdapter.a(this.jdField_b_of_type_Int).path;
    ...
    for (;;)
    {
      paramMotionEvent.setAnimationListener(new PhotoListPanel.SwipeUpAndDragListener.DragHandler.2(this, f2));
      break;
      bool = false;
      break label507;
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel$SwipeUpAndDragListener.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo;
      if (QFileAssistantUtils.a(((SessionInfo)localObject1).jdField_a_of_type_JavaLangString))
      {
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel$SwipeUpAndDragListener.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerEngine().a(str, ((SessionInfo)localObject1).jdField_a_of_type_JavaLangString, ((SessionInfo)localObject1).jdField_a_of_type_JavaLangString, ((SessionInfo)localObject1).jdField_a_of_type_Int, true);
        }
      }
      else
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel$SwipeUpAndDragListener.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.a(this.jdField_b_of_type_Int, (ArrayList)localObject2, false, true, "0X8005E0D", "0", i + "", false);
      }
    }
  }
}
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.aio.photo.PhotoListPanel.SwipeUpAndDragListener.DragHandler
