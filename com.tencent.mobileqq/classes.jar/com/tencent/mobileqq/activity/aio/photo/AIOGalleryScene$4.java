...
public class AIOGalleryScene$4
  implements Runnable
{
  public AIOGalleryScene$4(agdi paramagdi, long paramLong, float paramFloat, String paramString) {}
  
  public void run()
  {
    Object localObject = this.this$0.jdField_a_of_type_Ages.a();
    if ((localObject == null) || (((agfq)localObject).a.f != this.jdField_a_of_type_Long)) {
      return;
    }
    if (AIOFileVideoData.class.isInstance(((agfq)localObject).a))
    {
      localObject = (AIOFileVideoData)((agfq)localObject).a;
