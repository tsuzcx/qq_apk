  ...
  implements AbstractImageListModel
{
    ...
    for (;;)
    {
      try
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          if (localAIORichMediaInfo.a.jdField_f_of_type_Long != paramLong) {
            continue;
          }
          if (localAIORichMediaInfo != null)
          {
            this.jdField_a_of_type_JavaUtilList.remove(localAIORichMediaInfo);
            this.jdField_b_of_type_JavaUtilList.remove(localAIORichMediaInfo);
  ...
  public void a(AIORichMediaInfo paramAIORichMediaInfo)
  {
    ...
    this.jdField_b_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaInfo.jdField_c_of_type_Boolean = true;
  ...
  public void a(boolean paramBoolean, List<AIORichMediaInfo> paramList)
  {
          ...
          if (k > 0)
          {
            ...
            for (;;)
            {
              if (j < this.jdField_d_of_type_Int - k)
              {
                ...
                j += 1;
                continue;
                this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichExpandInfo.a(this.jdField_d_of_type_JavaUtilList, this.jdField_d_of_type_Int);
                break;
              }
            }
          }
    ...
    ((AIORichExpandInfo)localObject).a(paramBoolean, this.jdField_d_of_type_Int, this.jdField_d_of_type_JavaUtilList);
  }
  ...
  public boolean a(AIORichMediaData[] paramArrayOfAIORichMediaData, int paramInt)
  {
    ...
    if (i < paramArrayOfAIORichMediaData.length)
    {
      ...
      for (;;)
      {
        ...
        {
          this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaInfo.jdField_c_of_type_Boolean = true;
