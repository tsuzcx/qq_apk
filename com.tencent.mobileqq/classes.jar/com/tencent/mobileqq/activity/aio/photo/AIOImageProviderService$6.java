  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      abao.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, this.jdField_a_of_type_JavaLangString, this.b, this.c, this.d);
      return;
    }
    abao.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.b, this.jdField_a_of_type_JavaLangString, this.c, abao.a(this.jdField_a_of_type_Int), this.c);
  }
}
