...
public class CustomizeStrategyFactory$ThemeAnimStrategy$1
  implements Runnable
{
  public CustomizeStrategyFactory$ThemeAnimStrategy$1(ackx paramackx, CustomizeStrategyFactory.RedPacketInfo paramRedPacketInfo) {}
  ...
  public void run()
  {
    ...
    if ((ackx.a(this.this$0) == null) || (TextUtils.isEmpty(this.a.templateId)))
    {
      CustomizeStrategyFactory.a().a(this.a);
      return;
    }
    String str = this.a.templateId + ".zip";
    ackx.a(this.this$0).a(str, "", new acky(this));
  }
}
