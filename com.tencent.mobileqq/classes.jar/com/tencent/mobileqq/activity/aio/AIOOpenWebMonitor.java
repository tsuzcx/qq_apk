...
public class AIOOpenWebMonitor
{
  ...
  private static ArrayMap<String, Long> jdField_a_of_type_AndroidSupportV4UtilArrayMap = null;
  private static String jdField_a_of_type_JavaLangString = "";
  private static HashMap<String, String> jdField_a_of_type_JavaUtilHashMap = null;
  ...
  public static void a(Intent paramIntent)
  {
    ...
    if ((jdField_a_of_type_JavaUtilHashMap == null) || (jdField_a_of_type_JavaUtilHashMap.size() > 25))
    {
      ...
      jdField_a_of_type_JavaUtilHashMap.put("network_type", HttpUtil.getNetWorkType() + "");
    ...
    for (;;)
    {
      ...
      break label249;
      label465:
      if ((SwiftBrowserStatistics.s) || (jdField_a_of_type_Int > 1)) {
        i = 2;
      } else {
        i = 3;
      }
      ...
      catch (Exception paramIntent)
      {
        for (;;)
        {
          ...
          if (l2 - l1 > 86400000L)
          {
            ...
            StatisticCollector.getInstance(BaseApplication.getContext()).collectPerformance(null, "AIOWebPreloadhit", false, 0L, 0L, localHashMap, "", false);
