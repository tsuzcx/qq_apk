  ...
  public void a(BaseRequest paramBaseRequest, boolean paramBoolean, long paramLong, String paramString, QQCircleCounter.GroupInfoRsp paramGroupInfoRsp)
  {
    if ((paramBoolean) && (paramLong == 0L))
    {
      if (paramGroupInfoRsp != null)
      {
        ...
        AIOTroopQcircleRedDotManager.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioAIOTroopQcircleRedDotManager, AIOTroopQcircleRedDotManager.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioAIOTroopQcircleRedDotManager).keySet());
        ...
        QZLog.d("AIOTroopQcircleRedDotManager", 2, "new greyTimeLimits from backend: " + AIOTroopQcircleRedDotManager.d(this.jdField_a_of_type_ComTencentMobileqqActivityAioAIOTroopQcircleRedDotManager));
      }
      return;
    }
    this.jdField_a_of_type_ComTencentMobileqqActivityAioAIOTroopQcircleRedDotManager.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreTroopChatPie, this.b);
