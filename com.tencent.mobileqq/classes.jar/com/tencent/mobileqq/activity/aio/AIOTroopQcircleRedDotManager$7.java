  ...
  implements VSDispatchObserver.onVSRspCallBack<QQCircleCounter.CountInfoRsp>
{
  ...
  public void a(BaseRequest paramBaseRequest, boolean paramBoolean, long paramLong, String paramString, QQCircleCounter.CountInfoRsp paramCountInfoRsp)
  {
    if ((paramBoolean) && (paramLong == 0L) && (paramCountInfoRsp != null))
    {
      ...
      {
        AIOTroopQcircleRedDotManager.a(this.e, Integer.valueOf(((FeedCloudCommon.Entry)paramCountInfoRsp.extInfo.mapInfo.get(0)).value.get()).intValue() * 1000);
        AIOTroopQcircleRedDotManager.b(this.e, Integer.valueOf(((FeedCloudCommon.Entry)paramCountInfoRsp.extInfo.mapInfo.get(1)).value.get()).intValue());
      }
      if (paramCountInfoRsp.rptRedPoint.size() == this.a.size())
      {
        int i = 0;
        while (i < paramCountInfoRsp.rptRedPoint.size())
        {
          ...
          this.a.put(str, new QcircleRedDotEntity(str, paramBoolean, paramLong, paramBaseRequest));
          i += 1;
        }
      }
      QZLog.d("AIOTroopQcircleRedDotManager", 2, "size of reddot rsp not equals to size of req");
      paramBaseRequest = this.c;
      if ((paramBaseRequest != null) && (paramBaseRequest.U != null)) {
      ...
      LocalMultiProcConfig.putLong("qcircle_troop_redpoint_pull_time_threshold", AIOTroopQcircleRedDotManager.c(this.e));
      LocalMultiProcConfig.putLong("qcircle_troop_redpoint_pull_amount_threshold", AIOTroopQcircleRedDotManager.d(this.e));
      paramBaseRequest = new StringBuilder();
      paramBaseRequest.append("new timeLimits from backend: ");
      paramBaseRequest.append(AIOTroopQcircleRedDotManager.c(this.e));
      QZLog.d("AIOTroopQcircleRedDotManager", 2, paramBaseRequest.toString());
      paramBaseRequest = new StringBuilder();
      paramBaseRequest.append("new amountLimits from backend: ");
      paramBaseRequest.append(AIOTroopQcircleRedDotManager.d(this.e));
      QZLog.d("AIOTroopQcircleRedDotManager", 2, paramBaseRequest.toString());
    }
  }
}
