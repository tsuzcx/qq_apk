...
public class AllInOneFactory
{
  ...
  public static AllInOne a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, String paramString)
  {
    if (paramMessageRecord.istroop == 1) {
      paramMessageRecord = new AllInOne(paramString, 20);
    } else if (paramMessageRecord.istroop == 3000) {
      paramMessageRecord = new AllInOne(paramString, 45);
    } else {
      paramMessageRecord = new AllInOne(paramString, 1);
    }
    paramMessageRecord.nickname = ContactUtils.c(paramQQAppInterface, paramString);
    return paramMessageRecord;
  }
  
  public static AllInOne a(QQAppInterface paramQQAppInterface, String paramString, SessionInfo paramSessionInfo, MessageRecord paramMessageRecord)
  {
