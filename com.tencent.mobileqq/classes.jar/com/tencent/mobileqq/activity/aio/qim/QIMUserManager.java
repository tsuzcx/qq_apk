...
public class QIMUserManager
{
  ...
  private static final String jdField_b_of_type_JavaLangString = AppConstants.cw + "icons/";
  private static final String jdField_c_of_type_JavaLangString = AppConstants.cw + "zip/";
  ...
  {
    ThreadManager.post(new vvh(paramLinearLayout, paramXEditTextEx, paramPanelIconLinearLayout, paramPatchedButton), 8, null, true);
  }
  
  public static void a(TextView paramTextView)
  {
    ThreadManager.post(new vvj(paramTextView), 8, null, true);
  }
  ...
  public static void a(SessionInfo paramSessionInfo, Context paramContext, TextView paramTextView1, TextView paramTextView2, TextView paramTextView3, ImageView paramImageView, TextView paramTextView4, LinearLayout paramLinearLayout, XEditTextEx paramXEditTextEx, PanelIconLinearLayout paramPanelIconLinearLayout, PatchedButton paramPatchedButton, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      catch (NullPointerException paramSessionInfo)
      {
        ...
        {
          if (QLog.isColorLevel()) {
            QLog.d("QIMUserManager", 2, paramSessionInfo.toString());
          }
        }
      }
      catch (EmptyStackException paramSessionInfo)
      {
        for (;;)
        {
          if (QLog.isColorLevel()) {
    ...
    if (paramQQAppInterface != null)
    {
      ...
      if ((!this.jdField_b_of_type_Boolean) || (!this.h.equals(str)))
      {
        ...
        if (paramQQAppInterface.contains(str + "_" + "qim_user_special_config_version"))
        {
          ...
          this.jdField_d_of_type_JavaLangString = paramQQAppInterface.getString(str + "_" + "qim_user_special_config_resources_url", "");
          this.f = paramQQAppInterface.getString(str + "_" + "qim_user_special_config_resources_md5", "");
          this.e = paramQQAppInterface.getString(str + "_" + "qim_user_special_config_qim_website", "");
          this.g = paramQQAppInterface.getString(str + "_" + "qim_user_special_config_online_wording", "好友在线");
          this.jdField_c_of_type_Boolean = paramQQAppInterface.getBoolean("qim_user_special_need_force_download", false);
        }
        this.h = str;
        this.jdField_b_of_type_Boolean = true;
        if (QLog.isColorLevel()) {
          QLog.d("QIMUserManager", 2, String.format("readAllConfigFromSp, first init,avatarSwitch %d, titleBarSwitch : %d, bubbleSwitch: %d, resourceUrl:%s ,md5:%s , onlineWording:%s, needForceDownload:%b, mQimWebsite:%s", new Object[] { Integer.valueOf(this.jdField_b_of_type_Int), Integer.valueOf(this.jdField_c_of_type_Int), Integer.valueOf(this.jdField_c_of_type_Int), this.jdField_d_of_type_JavaLangString, this.f, this.g, Boolean.valueOf(this.jdField_c_of_type_Boolean), this.e }));
        }
      }
    }
  }
  ...
  private boolean a(String paramString)
  {
    ...
    //   11: getstatic 48	com/tencent/mobileqq/activity/aio/qim/QIMUserManager:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   37: ireturn
    //   38: aload_2
    //   39: invokevirtual 382	java/io/File:getPath	()Ljava/lang/String;
    //   42: invokestatic 385	com/tencent/mobileqq/utils/FileUtils:b	(Ljava/lang/String;)Ljava/lang/String;
    //   45: astore_3
    //   46: aload_3
    ...
    //   53: aload_3
    //   54: aload_1
    //   55: invokevirtual 388	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   58: ifeq -22 -> 36
    //   61: getstatic 44	com/tencent/mobileqq/activity/aio/qim/QIMUserManager:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   64: invokestatic 137	com/tencent/mobileqq/utils/FileUtils:b	(Ljava/lang/String;)V
    //   67: aload_2
    //   68: getstatic 44	com/tencent/mobileqq/activity/aio/qim/QIMUserManager:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   71: invokestatic 393	com/tencent/biz/common/util/ZipUtils:a	(Ljava/io/File;Ljava/lang/String;)V
    //   74: iconst_1
    //   75: ireturn
    //   76: astore_1
    ...
    //   80: ifeq -44 -> 36
    //   83: aload_1
    //   84: invokevirtual 394	java/lang/UnsatisfiedLinkError:printStackTrace	()V
    //   87: iconst_0
    //   88: ireturn
    //   89: astore_1
    ...
    //   93: ifeq -57 -> 36
    //   96: aload_1
    //   97: invokevirtual 395	java/lang/Exception:printStackTrace	()V
    //   100: iconst_0
    //   101: ireturn
  ...
  public void a(int paramInt1, int paramInt2, String paramString1, String paramString2, String paramString3, String paramString4, boolean paramBoolean, int paramInt3)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("QIMUserManager", 2, String.format("setQimUserSpecial, first init,avatarSwitch %d, titleBarSwitch : %d, bubbleSwitch: %d, resourceUrl:%s ,md5:%s , onlineWording:%s, needForceDownload:%b, qimWebsite:%s", new Object[] { Integer.valueOf(this.jdField_b_of_type_Int), Integer.valueOf(this.jdField_c_of_type_Int), Integer.valueOf(this.jdField_c_of_type_Int), this.jdField_d_of_type_JavaLangString, this.f, this.g, Boolean.valueOf(this.jdField_c_of_type_Boolean), paramString2 }));
    }
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    if (paramBoolean)
    {
      ThreadManager.post(new vvf(this, paramString1, paramString2, paramQQAppInterface, paramBoolean), 8, null, true);
      return;
    }
    if (a(paramString2))
    {
    ...
    ThreadManager.post(new vvg(this, paramString1, paramString2, paramBoolean), 8, null, true);
  }
  
  public void a(ArrayList paramArrayList1, ArrayList paramArrayList2)
  {
    if ((paramArrayList1 != null) && (paramArrayList1.size() > 0) && (paramArrayList2 != null) && (paramArrayList2.size() > 0))
    {
      ArrayList localArrayList = new ArrayList();
      int i = 0;
      ...
      ThreadManager.postImmediately(new vvl(this, paramArrayList1, localArrayList), null, true);
    }
  }
