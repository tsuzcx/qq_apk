...
public class QIMUserManager
{
  ...
  private static final String jdField_b_of_type_JavaLangString = AppConstants.cv + "icons/";
  private static final String jdField_c_of_type_JavaLangString = AppConstants.cv + "zip/";
