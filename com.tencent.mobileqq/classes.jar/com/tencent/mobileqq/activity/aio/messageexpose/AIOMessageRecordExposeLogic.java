...
public class AIOMessageRecordExposeLogic
{
  private int a = -1;
  private int b = -1;
  private OnAIOMessageExposeListener[] c = { new ECommerceExposeBusiness(), new MessageFoldExposeBusiness(), new WriteTogetherMsgExposeBusi(), new OfficialAccountExposeBusiness(), new TroopGrayTipsMsgExpose(), new AnonymousExposeBusiness() };
