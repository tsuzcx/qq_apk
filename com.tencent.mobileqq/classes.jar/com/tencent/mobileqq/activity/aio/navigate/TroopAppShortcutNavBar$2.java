  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    int i = ((SharedPreferences)localObject).getInt(TroopAppShortcutNavBar.a(this.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), 0);
    ...
    ((SharedPreferences.Editor)localObject).putInt(TroopAppShortcutNavBar.a(this.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), i + 1).commit();
