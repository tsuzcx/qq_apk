...
public class TroopAppShortcutNavBar$2
  implements Runnable
{
  public TroopAppShortcutNavBar$2(aiad paramaiad) {}
  
  public void run()
  {
    Object localObject = PreferenceManager.getDefaultSharedPreferences(this.this$0.jdField_a_of_type_AndroidContentContext);
    int i = ((SharedPreferences)localObject).getInt(aiad.a(this.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), 0);
    ...
    ((SharedPreferences.Editor)localObject).putInt(aiad.a(this.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), i + 1).commit();
