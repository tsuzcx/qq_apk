...
public class TroopAppShortcutNavBar$2
  implements Runnable
{
  public TroopAppShortcutNavBar$2(ahpr paramahpr) {}
  
  public void run()
  {
    Object localObject = PreferenceManager.getDefaultSharedPreferences(this.this$0.jdField_a_of_type_AndroidContentContext);
    int i = ((SharedPreferences)localObject).getInt(ahpr.a(this.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), 0);
    ...
    ((SharedPreferences.Editor)localObject).putInt(ahpr.a(this.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), i + 1).commit();
