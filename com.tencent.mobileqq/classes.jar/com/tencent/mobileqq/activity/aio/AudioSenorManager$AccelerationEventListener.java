    ...
    for (;;)
    {
      ...
      if ((f4 >= AudioSenorManager.a(this.a)) || (f5 >= AudioSenorManager.a(this.a)) || (f6 >= AudioSenorManager.a(this.a)))
      {
        if ((!this.a.jdField_a_of_type_Boolean) && (QLog.isColorLevel())) {
          QLog.d("AudioPlayer_SenorManager", 2, "AccelerationListener$onSensorChanged moving | x=" + f1 + " | y = " + f2 + " | z = " + f3 + " | ax = " + f4 + " | ay = " + f5 + " | az = " + f6 + " | value=" + AudioSenorManager.a(this.a));
        }
      ...
      {
        if ((this.a.jdField_a_of_type_Boolean) && (QLog.isColorLevel())) {
          QLog.d("AudioPlayer_SenorManager", 2, "AccelerationListener$onSensorChanged stop moving | x=" + f1 + " | y = " + f2 + " | z = " + f3 + " | ax = " + f4 + " | ay = " + f5 + " | az = " + f6 + " | value=" + AudioSenorManager.a(this.a));
        }
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.aio.AudioSenorManager.AccelerationEventListener
