...
public class AudioBluetoothSCOHelper
{
  ...
  AudioBluetoothSCOHelper.AudioBluetoothSCOReceiver jdField_a_of_type_ComTencentMobileqqActivityAioAudioBluetoothSCOHelper$AudioBluetoothSCOReceiver;
  ...
  public void a()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioAudioBluetoothSCOHelper$AudioBluetoothSCOReceiver != null) {
    ...
    try
    {
      this.jdField_a_of_type_AndroidAppApplication.unregisterReceiver(this.jdField_a_of_type_ComTencentMobileqqActivityAioAudioBluetoothSCOHelper$AudioBluetoothSCOReceiver);
      label51:
      this.jdField_a_of_type_ComTencentMobileqqActivityAioAudioBluetoothSCOHelper$AudioBluetoothSCOReceiver = null;
      return;
    }
  ...
  public int b(String paramString, int paramInt)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityAioAudioBluetoothSCOHelper$AudioBluetoothSCOReceiver = paramString;
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.aio.AudioBluetoothSCOHelper
