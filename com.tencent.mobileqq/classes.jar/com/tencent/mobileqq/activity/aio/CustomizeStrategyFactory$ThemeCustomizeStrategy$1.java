...
public class CustomizeStrategyFactory$ThemeCustomizeStrategy$1
  implements Runnable
{
  public CustomizeStrategyFactory$ThemeCustomizeStrategy$1(afao paramafao, CustomizeStrategyFactory.RedPacketInfo paramRedPacketInfo) {}
  ...
  public void run()
  {
    try
    {
      ...
      if ((afao.a(this.this$0) == null) || (TextUtils.isEmpty(this.a.templateId)))
      {
        CustomizeStrategyFactory.a().a(this.a);
        return;
      }
      String str = this.a.templateId + ".png";
      afao.a(this.this$0).b(str, new afap(this));
      return;
    }
