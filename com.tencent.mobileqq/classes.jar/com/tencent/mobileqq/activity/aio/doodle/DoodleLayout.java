  ...
  implements ScribbleResMgr.ResCallback
{
  ...
  private void c()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioDoodleDoodleView == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityAioDoodleDoodleView.setBackgroundColor(getResources().getColor(2131492923));
      addView(this.jdField_a_of_type_ComTencentMobileqqActivityAioDoodleDoodleView);
      this.jdField_a_of_type_ComTencentMobileqqActivityAioDoodleDoodleView.a(new uod(this));
    }
    ...
    do
    {
      do
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqWidgetQQToast == null) {
          this.jdField_a_of_type_ComTencentMobileqqWidgetQQToast = QQToast.a(getContext(), getResources().getString(2131439054), 0);
        }
  ...
  protected Bitmap b()
  {
    ...
    {
      localBitmap1 = BitmapManager.a(BaseApplicationImpl.getContext().getResources(), 2130838597);
