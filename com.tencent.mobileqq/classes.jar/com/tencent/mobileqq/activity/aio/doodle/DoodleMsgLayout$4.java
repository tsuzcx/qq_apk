  ...
  implements Runnable
{
  ...
  public void run()
  {
    Drawable localDrawable1 = DoodleResHelper.a().a(1, DoodleMsgLayout.f(this.this$0), true);
    if (localDrawable1 != null) {
      ((URLDrawable)localDrawable1).setIndividualPause(true);
    }
    Drawable localDrawable2 = DoodleResHelper.a().a(2, DoodleMsgLayout.f(this.this$0), false);
