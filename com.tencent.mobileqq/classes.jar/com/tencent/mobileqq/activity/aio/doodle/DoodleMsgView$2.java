  ...
  extends TimerTask
{
  ...
  public void run()
  {
    try
    {
      acsg localacsg = DoodleMsgView.a(this.this$0);
      if (localacsg == null)
      {
      ...
      if (localacsg != null) {
        localacsg.a(DoodleMsgView.a(this.this$0), true);
      }
      if (DoodleMsgView.a(this.this$0) >= this.a)
      {
      ...
      if ((!DoodleMsgView.a(this.this$0)) && (localacsg != null)) {
        localacsg.a(this.a, true);
      }
      return;
    }
