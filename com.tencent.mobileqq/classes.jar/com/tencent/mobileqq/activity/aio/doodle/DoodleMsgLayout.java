...
public class DoodleMsgLayout
  ...
  implements addl, awhe, GifDrawable.OnGIFPlayOnceListener
{
  private int jdField_a_of_type_Int = 0;
  private addh jdField_a_of_type_Addh = new addh(this);
  ...
  private WeakReference<addg> jdField_a_of_type_JavaLangRefWeakReference;
  ...
  private void b(int paramInt)
  {
    if (paramInt > 0)
    {
      ...
      Drawable localDrawable = addx.a().a(1, paramInt, true);
      ...
      localDrawable = addx.a().a(2, paramInt, false);
      ...
      localDrawable = addx.a().a(2, paramInt, true);
  ...
  private void h()
  {
    ...
    this.jdField_a_of_type_ComTencentImageURLDrawableDownListener = new addf(this);
    Object localObject = getResources().getDisplayMetrics();
    int i = Math.min(((DisplayMetrics)localObject).widthPixels, ((DisplayMetrics)localObject).heightPixels);
    int k = getResources().getDimensionPixelSize(2131296302);
    int m = getResources().getDimensionPixelSize(2131296304);
    int n = getResources().getDimensionPixelSize(2131296303);
    int i1 = getResources().getDimensionPixelSize(2131296301);
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityAioDoodleDoodleMsgView == null)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqActivityAioDoodleDoodleMsgView.setBackgroundColor(getResources().getColor(2131167087));
  ...
  private void j()
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetImageView == null)
    {
      ...
      localLayoutParams = new RelativeLayout.LayoutParams(actn.a(19.0F, getResources()), actn.a(19.0F, getResources()));
      localLayoutParams.addRule(13);
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetImageView != null) {
      if (this.jdField_a_of_type_AndroidWidgetImageView.getDrawable() == null)
      {
        ...
        localObject = new bcnz((Bitmap)localObject, 0, false);
        ((bcnz)localObject).setBounds(new Rect(0, 0, actn.a(19.0F, getResources()), actn.a(19.0F, getResources())));
  ...
  public void a(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_JavaLangRefWeakReference != null) {
      localaddg = (addg)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    }
    if ((paramInt == -1) || (paramInt == 4) || (this.jdField_c_of_type_Int == 2))
    {
      c(0);
      this.jdField_c_of_type_Boolean = false;
      if ((paramInt != -1) && (localaddg != null)) {
        localaddg.a(this, 2);
      }
      return;
    }
  ...
  public void a(View paramView, int paramInt1, ScribbleResMgr.ResInfo paramResInfo, int paramInt2)
  {
    ...
    for (;;)
    {
      paramView = null;
      if (this.jdField_a_of_type_JavaLangRefWeakReference != null) {
        paramView = (addg)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      }
      if (paramView != null)
      {
  ...
  public boolean a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Addh.jdField_b_of_type_Boolean = false;
    ...
    {
      addx.a().b(1, this.jdField_b_of_type_Int, this, this);
      this.jdField_c_of_type_Int = 1;
    }
    ...
    if (this.jdField_a_of_type_Addh.jdField_a_of_type_Boolean)
    {
      if (QLog.isColorLevel()) {
        QLog.d("DoodleMsgLayout", 2, "pending data, return");
      }
      this.jdField_a_of_type_Addh.jdField_a_of_type_JavaLangString = paramString;
      this.jdField_a_of_type_Addh.jdField_a_of_type_Int = i;
      this.jdField_a_of_type_Addh.jdField_c_of_type_Boolean = paramBoolean;
      this.jdField_a_of_type_Addh.jdField_b_of_type_Boolean = true;
      c(0);
      if (this.jdField_a_of_type_ComTencentMobileqqActivityAioDoodleDoodleMsgView != null) {
  ...
  {
    this.jdField_a_of_type_Addh.jdField_a_of_type_Boolean = paramBoolean;
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioDoodleDoodleMsgView != null) {
      this.jdField_a_of_type_ComTencentMobileqqActivityAioDoodleDoodleMsgView.a(paramBoolean);
    }
    if (!paramBoolean)
    {
      if (this.jdField_a_of_type_Addh.jdField_b_of_type_Boolean)
      {
        if ((!a(this.jdField_a_of_type_Addh.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Addh.jdField_a_of_type_Int, this.jdField_a_of_type_Addh.jdField_c_of_type_Boolean)) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioDoodleDoodleMsgView != null)) {
    ...
    this.jdField_a_of_type_Addh.jdField_a_of_type_Int = this.jdField_b_of_type_Int;
    this.jdField_a_of_type_Addh.jdField_c_of_type_Boolean = this.jdField_a_of_type_Boolean;
    this.jdField_a_of_type_Addh.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
    this.jdField_a_of_type_Addh.jdField_b_of_type_Boolean = true;
  }
  ...
  public void setOperateListener(View.OnClickListener paramOnClickListener, View.OnTouchListener paramOnTouchListener, View.OnLongClickListener paramOnLongClickListener, addg paramaddg)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioDoodleDoodleMsgView != null)
    {
    ...
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramaddg);
  }
