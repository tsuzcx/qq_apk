  ...
  implements Runnable
{
  ...
  public LoadDataJob(String paramString, int paramInt1, int paramInt2, upo paramupo)
  {
    this.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramupo);
  ...
  private List a(String paramString)
  {
    ...
    //   448: aload_0
    //   449: aload 11
    //   451: invokespecial 237	upn:<init>	(Lcom/tencent/mobileqq/activity/aio/doodle/LoadDataJob;Ljava/util/List;)V
    //   454: invokespecial 240	upp:<init>	(Lcom/tencent/mobileqq/activity/aio/doodle/LoadDataJob;[BLupq;)V
    //   457: iconst_5
    //   458: aconst_null
    //   459: iconst_1
  ...
  public ups a(MyParcelable paramMyParcelable)
  {
  ...
  public void a(DoodleParam paramDoodleParam, String paramString)
  {
    ...
    //   139: aload_0
    //   140: aload_1
    //   141: invokevirtual 373	com/tencent/mobileqq/activity/aio/doodle/LoadDataJob:a	(Lcom/tencent/mobileqq/activity/aio/doodle/MyParcelable;)Lups;
    //   144: astore_1
    //   145: aload 8
    //   147: astore_3
    //   148: aload 5
    ...
    //   160: aload 5
    //   162: aload_1
    //   163: getfield 376	ups:jdField_a_of_type_Int	I
    ...
    //   187: aload 5
    //   189: aload_1
    //   190: getfield 386	ups:jdField_a_of_type_ArrayOfByte	[B
    //   193: iconst_0
    //   194: aload_1
    //   195: getfield 376	ups:jdField_a_of_type_Int	I
  ...
  public boolean a(List paramList, String paramString)
  {
    ...
    //   202: invokevirtual 373	com/tencent/mobileqq/activity/aio/doodle/LoadDataJob:a	(Lcom/tencent/mobileqq/activity/aio/doodle/MyParcelable;)Lups;
    //   205: astore 9
    //   207: aload 6
    //   209: astore 5
    //   211: aload 4
    ...
    //   219: aload 4
    //   221: aload 9
    //   223: getfield 376	ups:jdField_a_of_type_Int	I
    ...
    //   244: aload 4
    //   246: aload 9
    //   248: getfield 386	ups:jdField_a_of_type_ArrayOfByte	[B
    //   251: iconst_0
    //   252: aload 9
    //   254: getfield 376	ups:jdField_a_of_type_Int	I
  ...
  public void run()
  {
    ...
    for (upo localupo = (upo)this.jdField_a_of_type_JavaLangRefWeakReference.get();; localupo = null)
    {
      if (localupo == null) {
      ...
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_JavaLangString == null)
        {
          ...
          localupo.a(null, 4, null, null, null);
          return;
        }
        if (!localupo.a(this.jdField_a_of_type_JavaLangString))
        {
          if (QLog.isColorLevel()) {
          ...
          if (localupo.a(this.jdField_a_of_type_JavaLangString))
          {
            ...
            for (;;)
            {
              ...
              else
              {
                ...
                if (localObject2 == null)
                {
                  localupo.a(this.jdField_a_of_type_JavaLangString, 4, null, null, null);
                  return;
                ...
                if (l2 - l1 > 100L)
                {
                  ...
                  ThreadManager.post(new upm(this, (DoodleParam)localObject1, (List)localObject4), 5, null, false);
                }
              ...
              localupo.a(this.jdField_a_of_type_JavaLangString, 0, (DoodleParam)localObject2, (List)localObject3, (Map)localObject1);
              if (!QLog.isColorLevel()) {
                break;
              }
