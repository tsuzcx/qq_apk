  ...
  implements View.OnClickListener, View.OnLongClickListener, bepl
{
  ...
  private void c()
  {
    ...
    {
      this.jdField_a_of_type_Acse = new acse(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      this.jdField_a_of_type_ComTencentBizUiTouchWebView = this.jdField_a_of_type_Acse.a(this.jdField_a_of_type_AndroidWidgetFrameLayout);
      this.jdField_a_of_type_ComTencentBizUiTouchWebView.getSettings().setMediaPlaybackRequiresUserGesture(false);
      this.jdField_a_of_type_ComTencentBizUiTouchWebView.getPluginEngine().a(this.jdField_a_of_type_Acse);
  ...
  private void d()
  {
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      if (this.jdField_a_of_type_Acse != null) {
        this.jdField_a_of_type_Acse.a();
      }
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext, BaseChatPie paramBaseChatPie)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)findViewById(2131299045));
  }
  ...
  public void b()
  {
    ...
    if (this.jdField_c_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_Acse.a(str);
    }
  }
