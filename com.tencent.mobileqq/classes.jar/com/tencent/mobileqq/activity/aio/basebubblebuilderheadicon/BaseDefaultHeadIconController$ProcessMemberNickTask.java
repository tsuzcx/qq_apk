  ...
  implements Runnable
{
  ...
  {
    String str1 = null;
    if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null) || (this.jdField_a_of_type_AndroidContentContext == null) || (this.jdField_a_of_type_AndroidViewView == null) || (this.jdField_a_of_type_AndroidViewView$OnLongClickListener == null)) {}
    for (;;)
    {
      return;
      label55:
      ...
      try
      {
        ...
        ((Activity)this.jdField_a_of_type_AndroidContentContext).runOnUiThread(new BaseDefaultHeadIconController.ProcessMemberNickTask.1(this, (String)localObject));
        return;
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.aio.basebubblebuilderheadicon.BaseDefaultHeadIconController.ProcessMemberNickTask
