  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      IntimateInfoManager localIntimateInfoManager = (IntimateInfoManager)this.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.INTIMATE_INFO_MANAGER);
      IntimateInfo localIntimateInfo = localIntimateInfoManager.a(this.this$0.jdField_a_of_type_JavaLangString);
      ...
      localIntimateInfoManager.a(FriendIntimateRelationshipConfProcessor.a().Q, FriendIntimateRelationshipConfProcessor.a().R);
