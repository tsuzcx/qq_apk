  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (PressToSpeakPanel.a(this.this$0).l())
    {
      QQToast.a(BaseApplication.getContext(), HardCodeUtil.a(2131708393), 0).b(i);
      return;
    }
    if (PressToSpeakPanel.a(this.this$0).isVideoChatting())
    {
      QQToast.a(BaseApplication.getContext(), 2131695173, 0).b(i);
      return;
    }
    if (AudioHelper.b(1))
    {
    ...
    PressToSpeakPanel.a(this.this$0).j(0);
    PressToSpeakPanel.a(this.this$0).a(this.this$0, true, (RecordParams.RecorderParam)localObject);
    this.this$0.f();
