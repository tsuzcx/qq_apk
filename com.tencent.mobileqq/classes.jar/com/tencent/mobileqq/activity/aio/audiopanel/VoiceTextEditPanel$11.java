  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (bbkk.a(VoiceTextEditPanel.a(this.this$0)))
    {
      ...
      for (;;)
      {
        bcql.a(this.this$0.getContext(), ajya.a(2131716860), 0).b(this.this$0.getContext().getResources().getDimensionPixelSize(2131298865));
        return;
