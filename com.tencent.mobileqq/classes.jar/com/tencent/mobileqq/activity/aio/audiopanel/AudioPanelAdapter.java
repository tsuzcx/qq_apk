  ...
  extends PagerAdapter
{
  ...
  public Object instantiateItem(View paramView, int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.K) || (paramInt == 1))
    {
      ...
      localObject1 = (PressToSpeakPanel)LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()).inflate(2131560616, null);
      ...
      localObject2 = (ListenPanel)LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()).inflate(2131560613, null);
    ...
    do
    {
      do
      {
        ...
        localObject1 = (PressToChangeVoicePanel)LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()).inflate(2131560615, null);
      ...
      localObject1 = (RecordSoundPanel)LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()).inflate(2131560619, null);
