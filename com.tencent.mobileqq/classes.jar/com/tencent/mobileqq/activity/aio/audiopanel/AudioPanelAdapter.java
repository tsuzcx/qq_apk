  ...
  extends PagerAdapter
{
  ...
  public Object instantiateItem(View paramView, int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.G) || (paramInt == 1))
    {
      ...
      localObject1 = (PressToSpeakPanel)LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()).inflate(2130970199, null);
      ...
      localObject2 = (ListenPanel)LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()).inflate(2130970196, null);
    ...
    do
    {
      do
      {
        ...
        localObject1 = (PressToChangeVoicePanel)LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()).inflate(2130970198, null);
      ...
      localObject1 = (RecordSoundPanel)LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()).inflate(2130970202, null);
