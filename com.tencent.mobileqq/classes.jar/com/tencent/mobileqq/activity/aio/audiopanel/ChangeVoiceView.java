  ...
  extends RelativeLayout
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajya.a(2131701511);
  }
  ...
  {
    if (this.jdField_a_of_type_Bcab == null) {
      return;
    }
    ...
    if (paramInt == 2)
    {
      ...
      if (this.jdField_a_of_type_Bcab.jdField_b_of_type_Int != 1) {
        break label182;
      }
    ...
    for (;;)
    {
      ...
      if (paramInt == 1)
      {
        setContentDescription(getContext().getString(2131691120) + " " + this.jdField_a_of_type_Bcab.jdField_b_of_type_JavaLangString);
        break label28;
      }
      setContentDescription(this.jdField_a_of_type_Bcab.jdField_b_of_type_JavaLangString);
      break label28;
      label180:
      break;
      label182:
      ...
      if (paramInt == 1)
      {
        ...
        {
          this.jdField_b_of_type_AndroidWidgetTextView.setBackgroundResource(2130846880);
  ...
  public void a(bcab parambcab)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)super.findViewById(2131364040));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131364042));
      this.jdField_a_of_type_ComTencentMobileqqActivityAioAudiopanelCircleProgressView = ((CircleProgressView)super.findViewById(2131364041));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131364045));
      this.jdField_a_of_type_ComTencentMobileqqActivityAioAudiopanelVolumeIndicateSquareView = ((VolumeIndicateSquareView)super.findViewById(2131364046));
      if (parambcab != null) {
        break;
      }
    ...
    this.d = baxn.a(getContext(), 4.0F);
    this.jdField_a_of_type_Int = parambcab.jdField_a_of_type_Int;
    this.jdField_a_of_type_ComTencentMobileqqActivityAioAudiopanelCircleProgressView.setStrokeWidth(4);
    this.jdField_a_of_type_Bcab = parambcab;
    ...
    if (parambcab.jdField_a_of_type_Bcac.jdField_a_of_type_Int > 0)
    {
      this.jdField_c_of_type_AndroidWidgetImageView.setBackgroundResource(parambcab.jdField_a_of_type_Bcac.jdField_a_of_type_Int);
      if (parambcab.jdField_c_of_type_Int == 0) {
        break label805;
      }
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      if (parambcab.jdField_c_of_type_Int != 1) {
        break label792;
      }
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130846446);
      if (parambcab.d == 1) {
        break label857;
      }
      ...
      localObject1 = bcad.jdField_a_of_type_ArrayOfJavaLangString[0];
      if (TextUtils.isEmpty((CharSequence)localObject1)) {
        break label874;
      }
      localObject3 = new File(bcad.jdField_a_of_type_JavaLangString + ((String)localObject1).substring(((String)localObject1).lastIndexOf("/") + 1));
    ...
    for (;;)
    {
      ...
      label415:
      localObject3 = parambcab.jdField_a_of_type_JavaLangString;
      ...
      super.setContentDescription(parambcab.jdField_b_of_type_JavaLangString);
      if (parambcab.jdField_a_of_type_Int == this.jdField_b_of_type_Int) {}
      for (;;)
      {
        for (;;)
        {
          ...
          try
          {
            localObject1 = parambcab.jdField_a_of_type_Bcac.jdField_a_of_type_JavaLangString;
            if (!TextUtils.isEmpty((CharSequence)localObject1))
            {
              localURLDrawableOptions = URLDrawable.URLDrawableOptions.obtain();
              localURLDrawableOptions.mFailedDrawable = ((Resources)localObject3).getDrawable(2130846569);
              localURLDrawableOptions.mLoadingDrawable = ((Resources)localObject3).getDrawable(2130846569);
              File localFile = new File(bcad.jdField_a_of_type_JavaLangString + ((String)localObject1).substring(((String)localObject1).lastIndexOf("/") + 1));
            ...
            for (;;)
            {
              ...
              if (parambcab.jdField_b_of_type_Int != 1) {
                break label781;
              }
              ((Drawable)localObject1).setAlpha(127);
              parambcab.jdField_a_of_type_Bcac.jdField_a_of_type_AndroidGraphicsDrawableDrawable = ((Drawable)localObject1);
              ...
              continue;
              QLog.d("ChangeVoiceView", 2, "init drawable url = null, name=" + parambcab.jdField_a_of_type_JavaLangString + ",type=" + parambcab.jdField_a_of_type_Int);
              localObject1 = ((Resources)localObject3).getDrawable(2130846569);
            }
          }
          catch (Exception localException)
          {
            for (;;)
            {
              localObject2 = ((Resources)localObject3).getDrawable(2130846569);
              continue;
              label781:
        ...
        label792:
        this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130846445);
        break label295;
        label805:
        this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
        break label295;
        ...
        if (parambcab.d == 5)
        {
          localObject2 = bcad.jdField_a_of_type_ArrayOfJavaLangString[1];
          break label326;
        }
        localObject2 = bcad.jdField_a_of_type_ArrayOfJavaLangString[2];
        break label326;
        label845:
