  ...
  extends RelativeLayout
{
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioAudiopanelCircleProgressView != null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityAioAudiopanelCircleProgressView.setRingColor(-13056);
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    if (paramInt == 2)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setBackgroundResource(2130837965);
    ...
    for (;;)
    {
      ...
      if (paramInt == 1)
      {
        setContentDescription(getContext().getString(2131427458) + " " + this.jdField_a_of_type_ComTencentMobileqqVoicechangeVoiceChangeData.jdField_b_of_type_JavaLangString);
        break label28;
      }
      ...
      break;
      label182:
      this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(getContext().getResources().getColor(2131493213));
      continue;
      label204:
      if (paramInt == 1)
      {
        ...
        {
          this.jdField_b_of_type_AndroidWidgetTextView.setBackgroundResource(2130844338);
          this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(-16777216);
        }
        else
        {
          this.jdField_b_of_type_AndroidWidgetTextView.setBackgroundResource(2130837966);
  ...
  public void a(VoiceChangeData paramVoiceChangeData)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)super.findViewById(2131369379));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)super.findViewById(2131363679));
      this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)super.findViewById(2131369378));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131369384));
      this.jdField_a_of_type_ComTencentMobileqqActivityAioAudiopanelCircleProgressView = ((CircleProgressView)super.findViewById(2131369380));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131369382));
      this.jdField_a_of_type_ComTencentMobileqqActivityAioAudiopanelVolumeIndicateSquareView = ((VolumeIndicateSquareView)super.findViewById(2131369383));
      if (paramVoiceChangeData != null) {
        break;
      }
    ...
    if (paramVoiceChangeData.jdField_a_of_type_ComTencentMobileqqVoicechangeVoiceChangeData$IconData.jdField_a_of_type_Int > 0)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130844032);
      ...
      for (;;)
      {
        for (;;)
        {
          ...
          try
          {
            ...
            {
              localURLDrawableOptions = URLDrawable.URLDrawableOptions.obtain();
              localURLDrawableOptions.mFailedDrawable = ((Resources)localObject3).getDrawable(2130844112);
              localURLDrawableOptions.mLoadingDrawable = ((Resources)localObject3).getDrawable(2130844112);
            ...
            for (;;)
            {
              ...
              localObject1 = ((Resources)localObject3).getDrawable(2130844112);
            }
          }
          catch (Exception localException)
          {
            for (;;)
            {
              localObject2 = ((Resources)localObject3).getDrawable(2130844112);
              continue;
              label781:
        ...
        label792:
        this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130844031);
        break label295;
        label805:
        this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
        break label295;
