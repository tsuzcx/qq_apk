  ...
  extends RelativeLayout
{
  ...
  private acru jdField_a_of_type_Acru;
  ...
  private boolean a(float paramFloat)
  {
    ...
    return (this.jdField_e_of_type_Float > 2000.0F) || (paramFloat > awmc.a(150.0F)) || (!this.jdField_b_of_type_Boolean);
  }
  ...
  private void b()
  {
    ...
    {
      if (this.jdField_a_of_type_Acru != null) {
        this.jdField_a_of_type_Acru.i();
      }
  ...
  public void a(int paramInt)
  {
    ...
    int k = getHeight();
    if (this.jdField_a_of_type_Acru != null) {
      this.jdField_a_of_type_Acru.a(this.jdField_b_of_type_Int - i - paramInt, j - i, k);
    }
    if (!this.jdField_b_of_type_Boolean)
    {
      if (this.jdField_d_of_type_Boolean)
      {
        ...
        awqx.b(null, "dc00898", "", "", "0X800A8A0", "0X800A8A0", 3, 0, "", "", "", "");
        return;
      }
      awqx.b(null, "dc00898", "", "", "0X800A8A0", "0X800A8A0", 2, 0, "", "", "", "");
      return;
    }
    awqx.b(null, "dc00898", "", "", "0X800A8A0", "0X800A8A0", 1, 0, "", "", "", "");
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, View paramView)
  {
    ...
    localValueAnimator.addUpdateListener(new acro(this, paramInt4, paramInt3, paramView));
    localValueAnimator.start();
    localValueAnimator.addListener(new acrp(this, paramInt5));
  }
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Acru != null)
      {
        this.jdField_a_of_type_Acru.b(this.jdField_b_of_type_Int);
        continue;
        a(paramMotionEvent);
        a();
        b(paramMotionEvent);
        ...
        if (this.jdField_a_of_type_Acru != null)
        {
          ...
          else
          {
            ...
            this.jdField_a_of_type_Acru.a(i - j, this.jdField_c_of_type_Int);
          }
        }
      }
    }
  ...
  public void setListener(acru paramacru)
  {
    this.jdField_a_of_type_Acru = paramacru;
  }
