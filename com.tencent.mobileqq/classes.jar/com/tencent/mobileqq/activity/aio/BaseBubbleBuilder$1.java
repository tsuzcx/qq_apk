  ...
  implements IChatLayoutListener
{
  ...
  public void a(int paramInt, IChatLayoutListener.ChatLayoutListenerInfo paramChatLayoutListenerInfo)
  {
    ...
    {
      if (((paramChatLayoutListenerInfo instanceof BubbleBgHandler.BubbleBgHandlerListenerInfo)) && (((BubbleBgHandler.BubbleBgHandlerListenerInfo)paramChatLayoutListenerInfo).a != ChatLayoutBubbleBgExecutorImpl.b))
      {
      ...
      if (((paramChatLayoutListenerInfo instanceof BubbleBgHandler.BubbleBgHandlerListenerInfo)) && (!BubbleAnimation.a().a(paramChatLayoutListenerInfo)) && (((BubbleBgHandler.BubbleBgHandlerListenerInfo)paramChatLayoutListenerInfo).a == ChatLayoutBubbleBgExecutorImpl.a))
      {
      ...
      if (paramChatLayoutListenerInfo.jdField_a_of_type_ComTencentMobileqqActivityAioBaseBubbleBuilder$ViewHolder.jdField_a_of_type_AndroidViewView != null)
      {
        ...
        paramChatLayoutListenerInfo.jdField_a_of_type_ComTencentMobileqqActivityAioBaseBubbleBuilder$ViewHolder.jdField_a_of_type_AndroidViewView.setTag(2131364199, paramChatLayoutListenerInfo.jdField_a_of_type_ComTencentMobileqqActivityAioBaseBubbleBuilder$ViewHolder.jdField_a_of_type_ComTencentMobileqqBubbleBubbleInfo);
        paramChatLayoutListenerInfo.jdField_a_of_type_ComTencentMobileqqActivityAioBaseBubbleBuilder$ViewHolder.jdField_a_of_type_AndroidViewView.setTag(2131364681, paramChatLayoutListenerInfo.jdField_a_of_type_ComTencentMobileqqDataChatMessage);
        if (AioApolloHelper.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_AndroidContentContext, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo)) {
          AioApolloHelper.a(paramChatLayoutListenerInfo.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout, paramChatLayoutListenerInfo.jdField_a_of_type_ComTencentMobileqqActivityAioBaseBubbleBuilder$ViewHolder.jdField_a_of_type_AndroidViewView);
        }
      }
