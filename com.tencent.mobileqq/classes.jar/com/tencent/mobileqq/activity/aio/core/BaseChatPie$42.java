...
class BaseChatPie$42
  implements Runnable
{
  BaseChatPie$42(BaseChatPie paramBaseChatPie, QQMessageFacade.Message paramMessage, Intent paramIntent) {}
  ...
  public void run()
  {
    ...
    if ((!this.this$0.sessionInfo.curFriendUin.equals(this.val$message.frienduin)) && ((this.val$message.senderuin == null) || (!this.val$message.senderuin.equalsIgnoreCase(this.this$0.app.getCurrentAccountUin()))) && (!this.this$0.isOpenFromShare))
    {
      ...
      {
        BaseChatPie.access$1202(this.this$0, new View(this.this$0.mContext));
        BaseChatPie.access$1200(this.this$0).setId(2131371657);
        BaseChatPie.access$1200(this.this$0).setBackgroundColor(this.this$0.mContext.getResources().getColor(2131166462));
        localObject = new RelativeLayout.LayoutParams(-1, 1);
        this.this$0.mTipsContainer.addView(BaseChatPie.access$1200(this.this$0), (ViewGroup.LayoutParams)localObject);
        this.this$0.mMsgbox = new TextView(this.this$0.mContext);
        this.this$0.mMsgbox.setId(2131371654);
        this.this$0.mMsgbox.setSingleLine();
        this.this$0.mMsgbox.setBackgroundDrawable(this.this$0.mContext.getResources().getDrawable(2130839184));
        this.this$0.mMsgbox.setGravity(17);
        this.this$0.mMsgbox.setTextSize(2, 14.0F);
        this.this$0.mMsgbox.setBackgroundResource(2130839184);
        this.this$0.mMsgbox.setTextColor(this.this$0.mContext.getResources().getColorStateList(2131167102));
        ...
        localObject = new RelativeLayout.LayoutParams(-1, (int)this.this$0.mContext.getResources().getDimension(2131297077));
        ((RelativeLayout.LayoutParams)localObject).addRule(3, 2131371657);
      ...
      BaseChatPie.access$1200(this.this$0).setVisibility(0);
    }
    for (;;)
    {
      this.this$0.mMsgbox.setVisibility(0);
      ThreadManager.postImmediately(new BaseChatPie.42.1(this), null, true);
      ...
      bkyy.a(this.this$0.app).a(this.val$message, this.this$0.mMsgbox);
