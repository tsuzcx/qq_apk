...
class BaseChatPie$49
  implements Runnable
{
  BaseChatPie$49(BaseChatPie paramBaseChatPie, int paramInt) {}
  ...
  public void run()
  {
    ...
    while (((this.val$state != 2) && (this.val$state != 0)) || (this.this$0.mRecordToastDialog == null) || (!this.this$0.mRecordToastDialog.isShowing()) || (this.this$0.mRecordToastDialog.getWindow() == null))
    {
      ...
      this.this$0.mRecordToastDialog = new bhjt(this.this$0.mContext);
      this.this$0.mRecordToastDialog.a(this.this$0.mContext.getString(2131697963));
