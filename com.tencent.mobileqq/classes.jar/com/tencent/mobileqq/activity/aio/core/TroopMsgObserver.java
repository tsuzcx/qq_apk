  ...
  extends BaseTroopMsgObserver
{
  ...
  public void onGetSystemMsgFin(boolean paramBoolean1, boolean paramBoolean2, List<MessageRecord> paramList)
  {
    if (paramBoolean1)
    {
      ...
      List localList = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().b(AppConstants.TROOP_SYSTEM_MSG_UIN, 0);
    ...
    } while ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString == null) || (!this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString.equalsIgnoreCase("" + l)));
    this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreTroopChatPie.br();
  }
  ...
  public void onMessageRecordAdded(List<MessageRecord> paramList)
  {
    ...
    for (paramList = null;; paramList = (MessageRecord)paramList.get(0))
    {
      if ((paramList != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreTroopChatPie.jdField_a_of_type_ComTencentWidgetXPanelContainer.a() == 35)) {
        this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreTroopChatPie.c(true, true);
      }
      return;
    }
  }
  
  public void onUpdateMsgDelFriend(String paramString, int paramInt1, int paramInt2)
  {
    if ((paramString == null) || (!paramString.equals(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) || (paramInt1 != this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int)) {}
    while (paramInt1 != 1) {
      return;
    }
    switch (paramInt2)
    ...
    case 1: 
    case 2: 
      paramString = this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreTroopChatPie.b.obtainMessage(5, 1, 0, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131690066));
      this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreTroopChatPie.b.sendMessage(paramString);
    }
    for (;;)
    {
      this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreTroopChatPie.K();
      return;
      paramString = this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreTroopChatPie.b.obtainMessage(5, 1, 0, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131690060));
      this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreTroopChatPie.b.sendMessage(paramString);
    }
  }
  ...
  public void onUpdateSendMsgError(String paramString1, int paramInt1, int paramInt2, SendMessageHandler paramSendMessageHandler, long paramLong1, long paramLong2, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreTroopChatPie.g(196608);
      return;
      label160:
