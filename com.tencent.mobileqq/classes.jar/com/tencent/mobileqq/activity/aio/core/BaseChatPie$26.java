  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if ("tencent.av.v2q.StartVideoChat".equals(paramContext))
    {
      if (QLog.isColorLevel()) {
        QLog.d(this.a.b, 2, "receive action_recv_video_request");
      }
      this.a.i(2);
    }
    do
    {
      ...
      if ("android.intent.action.PHONE_STATE".equals(paramContext))
      {
        ...
        {
          if (QLog.isColorLevel()) {
            QLog.d(this.a.b, 2, "receive action_phone_state_changed|call_state_ringing");
          }
          this.a.i(2);
        }
        if (paramContext.getCallState() == 1)
        ...
        this.a.f(paramContext.getCallState());
        return;
      }
      if ((BaseChatPie.j() == 1) && ("vivo_smart_shot_enter".equals(paramContext)))
      {
        if (QLog.isColorLevel()) {
    ...
    for (int i = 1;; i = 0)
    {
      com.tencent.mobileqq.util.SystemDragUtils.a = i;
      return;
    }
  }
}
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.aio.core.BaseChatPie.26
