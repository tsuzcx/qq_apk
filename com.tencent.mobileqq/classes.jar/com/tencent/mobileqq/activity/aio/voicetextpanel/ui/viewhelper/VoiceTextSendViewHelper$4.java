...
public class VoiceTextSendViewHelper$4
  implements Runnable
{
  public VoiceTextSendViewHelper$4(ainw paramainw, int paramInt, View paramView) {}
  
  public void run()
  {
    Rect localRect = new Rect();
    ainw.a(this.this$0).getHitRect(localRect);
    ...
    this.jdField_a_of_type_AndroidViewView.setTouchDelegate(new TouchDelegate(localRect, ainw.a(this.this$0)));
  }
}
