  ...
  implements Runnable
{
  ...
  public void run()
  {
    ITroopRedDotHandler localITroopRedDotHandler = (ITroopRedDotHandler)this.this$0.d.getBusinessHandler(BusinessHandlerFactory.TROOP_RED_DOT_HANDLER);
    if (localITroopRedDotHandler != null)
    {
      ...
      localITroopRedDotHandler.a(this.this$0.ah.b, (List)localObject, true);
    }
  }
}
