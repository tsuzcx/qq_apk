  ...
  implements ArkDebugger.DebuggerCallback
{
  ...
  public void Accepted()
  {
    ...
    QLog.d(this.a.this$0.c, 1, "ArkDebugger Accepted");
  }
  ...
  public boolean ReadyToRun(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    QLog.d(this.a.this$0.c, 1, String.format("ArkDebugger ReadyToRun viewId: %s, metaData: %s, mode: %s", new Object[] { paramString1, paramString2, paramString3 }));
    return true;
  }
  ...
  public void ReceivedPackage(String paramString1, String paramString2)
  {
    ...
    QLog.d(this.a.this$0.c, 1, String.format("ArkDebugger ReceivedPackage appid: %s, appview: %s", new Object[] { paramString1, paramString2 }));
  }
  
  public void Stopped(int paramInt)
  {
    ArkDispatchTask.getInstance().postToMainThread(new ArkDebugChatPie.1.1.2(this, paramInt));
    QLog.d(this.a.this$0.c, 1, "ArkDebugger Stopped");
  }
}
