...
public class PublicAccountChatPie$52
  implements Runnable
{
  public PublicAccountChatPie$52(aegy paramaegy) {}
  
  public void run()
  {
    bcqv localbcqv = (bcqv)this.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(85);
    if (!this.this$0.ao) {
    ...
    {
      localObject = null;
      localbcqv.a(str1, str2, str3, str4, (String)localObject);
      this.this$0.a().runOnUiThread(new PublicAccountChatPie.52.1(this));
      localbcqv.a(this.this$0.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, this.this$0.j);
      return;
    }
  }
}
