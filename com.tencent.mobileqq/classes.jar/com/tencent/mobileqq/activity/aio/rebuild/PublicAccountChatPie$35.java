...
public class PublicAccountChatPie$35
  implements Runnable
{
  public PublicAccountChatPie$35(aidp paramaidp, String paramString, int paramInt, long paramLong1, long paramLong2) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      {
        bctj.a(BaseApplication.getContext()).a(this.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "show_msg_result", bool1, 0L, 0L, new HashMap(), "");
