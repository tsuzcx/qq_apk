  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    Object localObject2 = TransFileUtil.getTransferFilePath(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), null, 2, null);
    ...
    if (!FileUtils.copyFile(this.jdField_a_of_type_JavaLangString, str))
    {
    ...
    ((AudioPanelAioHelper)IMECommandListener.a(this.this$0).a(128)).b();
    long l = 0L;
    Object localObject3 = new File(str);
    if (((File)localObject3).exists()) {
      l = ((File)localObject3).length();
    }
    double d = ((IQQRecorderUtils)QRoute.api(IQQRecorderUtils.class)).getMillisecond(this.jdField_a_of_type_Int, 2, 2, l);
    if (QLog.isColorLevel())
    {
    ...
    ((IVoiceChangeManager)QRoute.api(IVoiceChangeManager.class)).requestToStart(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), (VoiceChangeBasicParams)localObject3, null, null, VoiceChangeModeParams.a(str));
    ((AudioPanelAioHelper)IMECommandListener.a(this.this$0).a(128)).a((String)localObject2, (int)d, (RecordParams.RecorderParam)localObject1, this.b);
