  ...
  implements Runnable
{
  ...
  public GetTextDraftJob(MqqHandler paramMqqHandler, SessionInfo paramSessionInfo, arig paramarig, QQAppInterface paramQQAppInterface, BaseChatPie paramBaseChatPie)
  {
  ...
  public void run()
  {
    ...
    localObject = this.jdField_a_of_type_Arig.b((QQAppInterface)localObject, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int);
