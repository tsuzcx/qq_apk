...
{
  boolean Z = false;
  aaud jdField_a_of_type_Aaud = null;
  agee jdField_a_of_type_Agee = new aiqr(this);
  public aius a;
  public aivd a;
  aivi jdField_a_of_type_Aivi;
  public aivk a;
  aiwl jdField_a_of_type_Aiwl;
  aiwm jdField_a_of_type_Aiwm;
  aiwp jdField_a_of_type_Aiwp;
  BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver;
  Handler jdField_a_of_type_AndroidOsHandler;
  public ScrollView a;
  Toast jdField_a_of_type_AndroidWidgetToast = null;
  anua jdField_a_of_type_Anua = new aiqb(this);
  private final anyu jdField_a_of_type_Anyu = new aips(this);
  protected aocj a;
  aogx jdField_a_of_type_Aogx = new aipu(this);
  aojs jdField_a_of_type_Aojs = new aipt(this);
  aoka jdField_a_of_type_Aoka = new aiqe(this);
  bebs jdField_a_of_type_Bebs = new aiqp(this);
  private bflz jdField_a_of_type_Bflz;
  protected bftx a;
  private bfyj jdField_a_of_type_Bfyj;
  bgrm jdField_a_of_type_Bgrm;
  protected bgyg a;
  protected bhaa a;
  public bhav a;
  protected bhbg a;
  ...
  private Observer jdField_a_of_type_JavaUtilObserver = new aiql(this);
  nln jdField_a_of_type_Nln;
  public nlo a;
  npk jdField_a_of_type_Npk;
  npn jdField_a_of_type_Npn = new aiqd(this);
  public boolean aa;
  boolean ab;
  public boolean ac;
  boolean ad = false;
  ...
  public TroopChatPie(QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, FragmentActivity paramFragmentActivity, Context paramContext)
  {
    ...
    this.jdField_b_of_type_AndroidOsHandler = new aipv(this, Looper.getMainLooper());
    this.jdField_a_of_type_Aocj = new aiqk(this);
  ...
  private void C(int paramInt)
  {
    ...
    case 6001: 
      do
      {
        ...
        {
          bdll.b(null, "dc00899", "Grp_flower", "", "aio_mall", "Clk_choosecancel", paramInt, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "", "", "");
          return;
        }
    ...
    while (!QLog.isColorLevel())
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          localObject1 = "0";
          bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_mber", "", "mber_list", "Clk_mberlist", 0, 0, localTroopInfo.troopuin, "2", (String)localObject1, "");
          return;
        }
  ...
  private boolean I()
  {
    ...
    localObject = (bgme[])((Editable)localObject).getSpans(0, localObject.toString().length(), bgme.class);
    int k = 0;
    for (;;)
    {
      bool1 = bool2;
      ...
      {
        if (localbgty.b(localObject[k].a())) {
          bool1 = true;
        }
      }
      else
  ...
  private void a(int paramInt, Intent paramIntent)
  {
    ...
    do
    {
        ...
        do
        {
          do
          {
            ...
            do
            {
              ...
              {
                return;
                localObject = agej.a(new Intent(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, SplashActivity.class), null);
                ((Intent)localObject).putExtras(new Bundle(paramIntent.getExtras()));
                this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.startActivity((Intent)localObject);
                return;
                h(paramIntent);
                return;
                bgth.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, paramIntent, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
                return;
                ar();
            ...
            return;
          } while (this.jdField_a_of_type_Aavw == null);
      ...
      ((antz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(22)).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, paramIntent, false);
  ...
  private void a(String paramString, boolean paramBoolean)
  {
    ...
    {
      return;
      bhbe localbhbe = (bhbe)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(234);
      String str = localbhbe.a(paramString);
      bool1 = ((awpf)a(33)).c();
      bool2 = ((agwp)a(43)).c();
      bool3 = ((aiwa)a(75)).d();
      if ((!this.U) && (!bool1) && (!bool2) && (!TextUtils.isEmpty(str)) && (!bool3))
      {
        if (this.t != 2)
        {
          z(2);
          if (paramBoolean)
          {
            if (localbhbe.a(paramString) != 3) {
              break label210;
            }
            bhju.a("Grp_idol", "Grp_AIO", "exp_renshu", 0, 0, new String[] { paramString });
          }
        }
        for (;;)
        {
          ...
          if (this.jdField_a_of_type_Bhav == null) {
            break label273;
          }
          this.jdField_a_of_type_Bhav.a(paramString);
          if (!this.jdField_a_of_type_Bhav.a()) {
            break;
          }
          this.jdField_a_of_type_Bhav.d();
          x(true);
          return;
          new bdlq(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_online").c("Grp_AIO").d("exp_onlineEntry").a(new String[] { a().jdField_a_of_type_JavaLangString }).a();
        }
        x(false);
        return;
        x(false);
    ...
    } while ((this.U) || (bool1) || (bool2) || (bool3));
    label273:
    c(false);
  ...
  {
    bgty localbgty = (bgty)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(203);
    localbgty.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_g_of_type_JavaLangString, "off");
    localbgty.a(null);
  }
  ...
  private void bI()
  {
    ((wte)wth.a(5)).c();
    ((wtt)wth.a(2)).d();
    ((zmu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(208)).a();
  }
  
  private void bJ()
  {
    bgre localbgre = (bgre)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(132);
    localbgre.e("");
    if (localbgre.b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) {
      localbgre.b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    }
  }
  ...
  private void bO()
  {
    if (this.jdField_a_of_type_Npk != null) {
      this.jdField_a_of_type_Npk.a();
    }
  }
  ...
  private void bP()
  {
    if (this.jdField_a_of_type_Bhav != null)
    {
      this.jdField_a_of_type_Bhav.a();
      this.jdField_a_of_type_Bhav = null;
    }
  }
  
  private void bQ()
  {
    ahvl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    if (this.jdField_a_of_type_Aaud != null)
    {
      this.jdField_a_of_type_Aaud.dismiss();
      this.jdField_a_of_type_Aaud = null;
    }
    if (this.jdField_a_of_type_Aavw != null) {
      this.jdField_a_of_type_Aavw = null;
    }
  }
  ...
  private void bS()
  {
    ...
    {
      this.jdField_a_of_type_Nlo.dismiss();
      this.jdField_a_of_type_Nlo = null;
    }
    nlj.a().b();
    if (this.U) {
      a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getColor(2131167048), true);
    }
  }
  ...
  private void bV()
  {
    if ((this.jdField_d_of_type_Bhpc != null) && (this.jdField_d_of_type_Bhpc.isShowing())) {
  ...
  private void bW()
  {
    ...
    for (;;)
    {
      aqzo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false);
      return;
      label33:
  ...
  private void bX()
  {
    ...
    for (;;)
    {
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_flower", "", "mber", "un", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, k + "", "", "");
      return;
      label96:
  ...
  private void bY()
  {
    ...
    {
      new bgds(this.jdField_a_of_type_AndroidContentContext, "3171", "libWXVoice.so", "WXVoice").a();
      if (this.jdField_a_of_type_AndroidContentBroadcastReceiver == null) {
        this.jdField_a_of_type_AndroidContentBroadcastReceiver = new aiqq(this);
      }
    }
    try
    {
      ...
      bghh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      return;
    }
    catch (Exception localException)
    {
  ...
  private void bZ()
  {
    if ((aqzo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) && (this.jdField_b_of_type_AndroidContentBroadcastReceiver == null)) {
      this.jdField_b_of_type_AndroidContentBroadcastReceiver = new aiqs(this);
    }
    try
    {
      IntentFilter localIntentFilter = new IntentFilter();
  ...
  private void cb()
  {
    ...
    bggn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqWidgetNavbarNavBarAIO, this.jdField_e_of_type_AndroidWidgetImageView, this.jdField_f_of_type_AndroidWidgetImageView, this.K);
  }
  
  private void cc()
  {
    this.jdField_a_of_type_Bflz = new aiqf(this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.registObserver(this.jdField_a_of_type_Bflz);
  }
  
  private void cd()
  {
    if (ThemeUtil.isDefaultOrDIYTheme(false)) {
      a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getDrawable(2130846177));
    }
    for (;;)
    {
      bdgb.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.mSystemBarComp, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getWindow());
      return;
      a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getColor(2131167048), true);
    }
  }
  ...
  private void ce()
  {
    ...
    bguq.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, localIntent.getExtras(), 1, 2000);
  }
  
  private void cf()
  {
    if ((this.jdField_a_of_type_Bhav != null) && (this.jdField_a_of_type_Bhav.a()))
    {
      if (this.jdField_a_of_type_Bhav.a() == 2)
      {
        c(false);
        z(0);
      }
  ...
  private void cg()
  {
    ...
    if (this.jdField_a_of_type_Aivi == null) {
      this.jdField_a_of_type_Aivi = new aivi(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    }
    this.jdField_a_of_type_Aivi.a(this.jdField_a_of_type_Aiwh);
  }
  ...
  private void ch()
  {
    ...
    ((aqyp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(269)).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    this.aq = true;
  }
  ...
  private void ck()
  {
    ...
    {
      if (!bool1) {
        if ((this.jdField_a_of_type_Aaud != null) && (this.jdField_a_of_type_Aaud.isShowing())) {
          bool1 = true;
        }
      }
      for (;;)
      {
        Object localObject = (bgot)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(223);
        if (localObject != null) {}
        for (boolean bool2 = ((bgot)localObject).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);; bool2 = false)
        {
          if ((localObject != null) && (bool2) && (bool1)) {
            ((bgot)localObject).b = false;
          }
          if ((!bool1) && (bool2))
          {
            bgot.jdField_a_of_type_Boolean = true;
            p(true);
          }
          localObject = awpf.a(this);
          if (localObject != null)
          {
            if (!bool1)
            {
  ...
  private void cl()
  {
    ...
    for (int k = 1; k != 0; k = 0)
    {
      ...
      this.jdField_a_of_type_Npk.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Npn, true);
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.d(".troop.notify_feeds.aio", 2, "onShow_troopType, reqNotifyItems");
    }
    bgql.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
  }
  ...
  private void h(Intent paramIntent)
  {
    ...
    paramIntent = null;
    if (!F()) {
      paramIntent = bhlg.e(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, str2);
    }
    ...
    this.jdField_a_of_type_Anra.jdField_a_of_type_ComTencentMobileqqDataApolloActionData.peerUin = str2;
    ...
    {
      VipUtils.a((AppInterface)localObject, "cmshow", "Apollo", "g_action_double_sent", str1, k, m, new String[] { str2, str3, paramIntent, this.jdField_a_of_type_Anra.jdField_a_of_type_ComTencentMobileqqDataApolloActionData.peerUin, String.valueOf(System.currentTimeMillis() / 1000L) });
      return;
      k = m;
  ...
  {
    if ((this.jdField_a_of_type_Aiwm != null) && (this.jdField_a_of_type_Aiwm.a()) && (axan.a().b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString))) {
  ...
  private void j(Intent paramIntent)
  {
    ...
    this.ad = ((aqyp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(269)).b(str, paramIntent);
  }
  ...
  void A(int paramInt)
  {
    ...
    for (;;)
    {
      if (localObject1 != null) {
        bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_AIO", "", "AIOshortcut", "Clk_shortcut", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, (String)localObject1, "", "");
      }
      return;
      localObject1 = "1";
      continue;
  ...
  public void B(int paramInt)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString) == 3)) {
      ((aoip)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramInt, 0);
    }
  }
  ...
  public void H()
  {
    ...
    bM();
    bT();
    ahvj.jdField_a_of_type_JavaUtilHashMap.clear();
    ahvj.jdField_a_of_type_AndroidSupportV4UtilLruCache.evictAll();
    aqzo.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false);
  ...
  boolean H()
  {
    ...
    boolean bool = bgts.c(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    if (QLog.isColorLevel()) {
  ...
  public void M()
  {
    ...
    if ((this.jdField_a_of_type_Aaud == null) || (!this.jdField_a_of_type_Aaud.isShowing()))
    {
      localObject = (bgot)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(223);
      if (localObject != null) {
        ((bgot)localObject).c();
      }
    }
    ...
    Object localObject = (bfui)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(231);
    ((bfui)localObject).jdField_a_of_type_Int = 0;
    ((bfui)localObject).b = 0;
    ((bfui)localObject).c = 0;
    ((bfui)localObject).d = 0;
    if (QLog.isColorLevel()) {
  ...
  public void N()
  {
    ...
    if (this.U)
    {
      ...
      nlj.a().a(this.jdField_a_of_type_Nln);
      a(-16777216, false);
    }
  }
  ...
  public void P()
  {
    ...
    this.jdField_a_of_type_Bftx.c();
    this.jdField_a_of_type_Bftx.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    aqzo.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, true);
  ...
  public void Q()
  {
    ...
    for (k = 1;; k = 0)
    {
      if ((k != 0) && (this.jdField_a_of_type_Bghm != null))
      {
        this.jdField_a_of_type_Bghm.b();
        this.jdField_a_of_type_Bghm = null;
      }
      if ((k != 0) && (this.jdField_a_of_type_Bfyj != null) && (this.jdField_a_of_type_Bfyj.a != null))
      {
        this.jdField_a_of_type_Bfyj.a.b();
        this.jdField_a_of_type_Bfyj.a = null;
      }
      if (this.jdField_a_of_type_Bgrm != null)
      {
        bgri.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Bgrm);
  ...
  public void R()
  {
    if (((this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity instanceof SplashActivity)) && (this.jdField_a_of_type_Bgzd != null)) {
  ...
  public aiwl a()
  {
    return this.jdField_a_of_type_Aiwl;
  }
  ...
  public View a(int paramInt)
  {
    if (paramInt == 35)
    {
      this.jdField_a_of_type_ComTencentMobileqqActivityAioConfessConfessPanel = ((ConfessPanel)View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131558592, null));
    ...
    for (Object localObject = this.jdField_a_of_type_ComTencentMobileqqActivityAioConfessConfessPanel;; localObject = super.a(paramInt))
    {
      if ((localObject instanceof PlusPanel)) {
        ((PlusPanel)localObject).setPagerChangedListener(new aiqm(this));
      }
      return localObject;
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Bftx == null) {
      this.jdField_a_of_type_Bftx = new bftx(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (RelativeLayout)this.jdField_c_of_type_AndroidViewViewGroup.findViewById(2131364389));
    }
    return this.jdField_a_of_type_Bftx;
  }
  ...
  public bhaa a()
  {
    if (this.jdField_a_of_type_Bhaa == null)
    {
      this.jdField_a_of_type_Bhaa = new bhaa();
      this.jdField_a_of_type_Bhaa.a(this);
    }
    return this.jdField_a_of_type_Bhaa;
  }
  
  public bhbg a()
  {
    if (this.jdField_a_of_type_Bhbg == null) {
      this.jdField_a_of_type_Bhbg = new bhbg(this.jdField_b_of_type_AndroidWidgetLinearLayout);
    }
  ...
  public EntryModel a()
  {
    return bguq.a(((TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52)).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString), this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
  }
  ...
  public List<ChatMessage> a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localList2 = aiwu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localList1, m, this.jdField_h_of_type_Long, this.jdField_g_of_type_Long, localObject3, paramBoolean);
        ...
        if (k < localList2.size())
        {
          ...
          if (aiwu.c((ChatMessage)localObject1)) {
            continue;
          }
        }
        if ((!aiwu.b((ChatMessage)localObject1)) || (localList2.size() >= 15)) {
          break label507;
        }
        aiwu.a("find first msg is fold msg,then get more msg ", new Object[0]);
        ...
        localObject1 = aiwu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (List)localObject1, m, this.jdField_h_of_type_Long, this.jdField_g_of_type_Long, localObject3, false);
      }
  ...
  {
    if (this.jdField_a_of_type_Nlo == null) {
      this.jdField_a_of_type_Nlo = new nlo(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity);
    }
    this.jdField_a_of_type_Nlo.a(paramInt, paramString);
    this.jdField_a_of_type_Nlo.show();
  ...
  {
    TroopManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, paramLong1, paramLong2, new aiqt(this, false));
  }
  ...
  public void a(long paramLong, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if (paramLong == 1L)
      {
        this.jdField_c_of_type_Bhpc = bhlq.a(this.jdField_a_of_type_AndroidContentContext, 230).setTitle(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131718699)).setMessage(2131696886);
        this.jdField_c_of_type_Bhpc.setPositiveButton(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131691082), new aipw(this));
        this.jdField_c_of_type_Bhpc.setNegativeButton(anzj.a(2131714056), new aipx(this));
        this.jdField_c_of_type_Bhpc.setPositiveButtonContentDescription(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131691082));
        this.jdField_c_of_type_Bhpc.setNegativeButtonContentDescription(anzj.a(2131714054));
        this.jdField_c_of_type_Bhpc.setCancelable(false);
        this.jdField_c_of_type_Bhpc.show();
        new bdlq(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_banned").c("Grp_AIO").d("exp_msgbox").a(new String[] { this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString }).a();
        return;
      }
      if ((paramLong == 2L) && (!paramBoolean))
      {
        this.jdField_c_of_type_Bhpc = bhlq.a(this.jdField_a_of_type_AndroidContentContext, 230).setTitle(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131718699)).setMessage(2131696885);
        this.jdField_c_of_type_Bhpc.setPositiveButton(2131696883, new aipy(this));
        this.jdField_c_of_type_Bhpc.setNegativeButton("", null);
        this.jdField_c_of_type_Bhpc.setCancelable(false);
        this.jdField_c_of_type_Bhpc.show();
        return;
      }
    } while ((paramLong != 2L) || (!paramBoolean));
    this.jdField_c_of_type_Bhpc = bhlq.a(this.jdField_a_of_type_AndroidContentContext, 230).setTitle(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131718699)).setMessage(2131696884);
    this.jdField_c_of_type_Bhpc.setNegativeButton(2131696883, new aipz(this));
    this.jdField_c_of_type_Bhpc.setPositiveButton(2131696882, new aiqa(this));
    this.jdField_c_of_type_Bhpc.setCancelable(false);
    this.jdField_c_of_type_Bhpc.show();
  }
  
  public void a(aiqv paramaiqv)
  {
    this.jdField_b_of_type_JavaUtilList.add(paramaiqv);
  }
  
  public void a(Intent paramIntent)
  {
    z(0);
    if ((this.U) && (!nlj.a().a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)))
    {
      w(false);
    ...
    {
      if ((this.U) && (nlj.a().a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString))) {
        this.jdField_f_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131689996) + nlj.a().a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString).jdField_a_of_type_JavaLangString);
      }
      super.a(paramIntent);
          ...
          try
          {
            ...
            for (;;)
            {
              if (k < ((JSONArray)localObject1).length())
              {
                ...
                String str3 = bhlg.e(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, (String)localObject3);
                localObject3 = bgme.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, (String)localObject3, str3, false, this.jdField_a_of_type_ComTencentWidgetXEditTextEx, true);
                ...
                w(true);
                this.jdField_d_of_type_AndroidViewViewGroup.setBackgroundResource(2130843607);
                this.jdField_a_of_type_ComTencentMobileqqWidgetNavbarNavBarAIO.setBackgroundResource(2130843613);
    ...
    for (;;)
    {
      ...
      {
        localObject2 = (agvx)a(27);
        if (localObject2 != null) {
          ((agvx)localObject2).a("0", str2, str1);
        }
      }
      if (paramIntent.getBooleanExtra("sendGift", false)) {
        a(true, TroopGiftPanel.jdField_f_of_type_Int);
      }
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1) && (TroopInfo.isQidianPrivateTroop(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) && (this.jdField_a_of_type_Agkt != null)) {
  ...
  {
    int k = paramIntent.getIntExtra(bhkc.jdField_h_of_type_JavaLangString, -1);
    if (((k == 2) || (k == 1)) && (b(true))) {
      return;
    }
  ...
  public void a(View paramView)
  {
    if (paramView.getId() == 2131378164)
    {
      ...
      {
        if (this.jdField_a_of_type_Bhav == null) {
          this.jdField_a_of_type_Bhav = new bhav(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidWidgetRelativeLayout, this.jdField_a_of_type_ComTencentMobileqqWidgetNavbarNavBarAIO, this.jdField_a_of_type_Bfpy);
        }
        this.jdField_a_of_type_Bhav.a(a().jdField_a_of_type_JavaLangString);
        if (!this.jdField_a_of_type_Bhav.b()) {}
      }
      do
      {
        do
        {
          ...
          cf();
        } while (this.jdField_a_of_type_Bhav.b == 2);
        new bdlq(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_online").c("Grp_AIO").d("clk_EntryClose").a(new String[] { a().jdField_a_of_type_JavaLangString }).a();
        return;
        this.jdField_a_of_type_Bhav.a(1);
        paramView = (aoip)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20);
        if (paramView != null) {
          paramView.u(a().jdField_a_of_type_JavaLangString);
        }
        v(true);
        if (this.jdField_a_of_type_Bhav.b == 2)
        {
          bhju.a("Grp_idol", "Grp_AIO", "clk_renshu", 0, 0, new String[] { a().jdField_a_of_type_JavaLangString });
          return;
        }
        new bdlq(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_online").c("Grp_AIO").d("clk_EntryOpen").a(new String[] { a().jdField_a_of_type_JavaLangString }).a();
        return;
        if (this.t == 3)
        {
          ((awpf)a(33)).b();
  ...
  public void a(bgsr parambgsr)
  {
    if (parambgsr.jdField_a_of_type_Boolean) {
      if ((1 != this.jdField_a_of_type_ComTencentWidgetXPanelContainer.a()) && (3 != this.jdField_a_of_type_ComTencentWidgetXPanelContainer.a()) && (8 != this.jdField_a_of_type_ComTencentWidgetXPanelContainer.a()) && ((this.jdField_f_of_type_Int != 1) || (this.m != 0)))
      {
        ...
        {
          QLog.d("troop_gag", 1, "fightgag.updateGagStatus_UI:" + parambgsr.b);
          this.jdField_h_of_type_AndroidWidgetTextView.setText(parambgsr.b);
        }
        if (QLog.isColorLevel()) {
          QLog.d("troop_gag", 2, "updateGagStatus_UI, sendEmptyMessageDelayed-TIMER_ID:" + parambgsr.jdField_a_of_type_Long + ", hasDestory=" + this.M);
        }
        if (!this.M)
        {
          this.jdField_b_of_type_AndroidOsHandler.removeMessages(1);
          this.jdField_b_of_type_AndroidOsHandler.sendEmptyMessageDelayed(1, parambgsr.jdField_a_of_type_Long * 1000L);
        }
  ...
  public void a(bgsr parambgsr, boolean paramBoolean)
  {
  ...
  public void a(Object paramObject)
  {
    ...
    case 5: 
      for (;;)
      {
        ...
        if (this.U)
        {
          bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_anon", "", "anon_aio", "Clk_face", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "", "", "");
          continue;
          if (this.U) {
            bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_anon", "", "anon_aio", "Clk_PTT", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "", "", "");
          }
          if (this.W)
          {
            new bdlq(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_robot").c("send_msg").d("voice_icon_clk").a(0).a(new String[] { this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_g_of_type_JavaLangString }).a();
            continue;
            if (this.U)
            {
    ...
    if (!F()) {
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_AIO", "", "AIOchat", "Clk_plusentry", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "", "", "");
    }
    if (this.jdField_a_of_type_Aavw == null) {
      this.jdField_a_of_type_Aavw = new aavw(this);
    }
    aavw localaavw = this.jdField_a_of_type_Aavw;
    int i1 = TroopGiftPanel.e;
    if (nlj.a().a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) {}
    for (int k = 4;; k = 1)
    {
      localaavw.a(i1, k);
      bflw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(bfmb.a(c()));
      break;
    }
  }
  ...
  public void a(String paramString, long paramLong, int paramInt1, int paramInt2, QQRecorder.RecorderParam paramRecorderParam, int paramInt3, boolean paramBoolean, int paramInt4)
  {
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      localObject = aean.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, -2, paramRecorderParam.c);
      if (localObject != null) {
        break label136;
      }
      return;
    ...
    if (!bhsr.a(paramRecorderParam.jdField_a_of_type_JavaLangString)) {
    ...
    bewa.a.put(paramString, Long.valueOf(l2));
    if (!bool1)
    {
    ...
    for (int k = 1;; k = 2)
    {
      bdll.b((QQAppInterface)localObject, "CliOper", "", "", "0X8005B57", "0X8005B57", k, 0, "", "", "", "8.4.5");
      D = true;
      k = b(paramInt1);
      localObject = new Bundle();
      ((Bundle)localObject).putInt("DiyTextId", paramRecorderParam.e);
      ArrayList localArrayList = new ArrayList();
      String str2 = bgme.a(this.jdField_a_of_type_ComTencentWidgetXEditTextEx.getEditableText(), localArrayList);
      bgty localbgty = (bgty)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(203);
      boolean bool3 = false;
      boolean bool2 = bool3;
      if (this.W)
      ...
      aean.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, m, str1, paramString, l1, false, paramInt2, paramRecorderParam.c, bool1, paramInt3, k, paramBoolean, paramRecorderParam.d, (Bundle)localObject, localArrayList, str2, bool2, paramInt4);
  ...
  {
    bgty localbgty = (bgty)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(203);
    if ((localbgty.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) && (localbgty.b(paramString1)))
    {
      if (I()) {
        return;
      }
      this.jdField_g_of_type_JavaLangString = paramString1;
      localbgty.e = paramString1;
  ...
  {
    bguq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, paramList);
    super.a(paramList, paramCharSequence, paramInt);
    if ((0xFFFF & paramInt) == 4)
    {
      ((bfpr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(225)).a(paramList);
      if (this.jdField_a_of_type_Bfpy != null) {
        this.jdField_a_of_type_Bfpy.a().f();
      }
    }
  }
  ...
  public void a(boolean paramBoolean, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject3 = agej.a(this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView, k);
        if (QLog.isColorLevel()) {
        ...
        localObject3 = (TextView)((View)localObject3).findViewById(2131367669);
      ...
      if ((this.jdField_a_of_type_Bfyj != null) && ((this.jdField_a_of_type_Bfyj.a instanceof bghh)))
      {
        localObject1 = (bghh)this.jdField_a_of_type_Bfyj.a;
      ...
      {
        ((bghh)localObject1).a(paramBoolean, null, this);
        cg();
        return;
      }
      label549:
  ...
  public boolean a(boolean paramBoolean)
  {
    ...
    bjpo.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getIntent(), true);
    return true;
  }
  ...
  public void ai()
  {
    ...
    if ((localTroopInfo != null) && (localTroopInfo.isTroopOwner(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())))
    {
      ...
      if (armu.c().mIsEnable)
      {
        ...
        ((aogu)localObject).a(Long.parseLong(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString));
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      {
        int k = localTroopManager.b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
        if ((k < 3) && (localTroopInfo.wMemberMax < 2000) && (localTroopInfo.wMemberNum >= 500))
        {
          if (this.jdField_a_of_type_Aiwp == null)
          {
            this.jdField_a_of_type_Aiwp = new aiwp(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.jdField_a_of_type_Aiwh);
            this.jdField_a_of_type_Aiwh.a(this.jdField_a_of_type_Aiwp);
          }
          this.jdField_a_of_type_Aiwp.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
          if (this.jdField_a_of_type_Aiwh.a(this.jdField_a_of_type_Aiwp, new Object[0]))
          {
            this.ak = true;
            localTroopManager.b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, k + 1);
            bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_up", "", "Grp_AIO", "exp", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "", "", "");
          }
        }
      }
      return;
  ...
  {
    super.al_();
    if ((this.jdField_a_of_type_Bfpy != null) && (!E())) {
      this.jdField_a_of_type_Bfpy.a().e();
    }
  }
  ...
  public void ap()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Aoka);
  ...
  public void aq()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.unRegistObserver(this.jdField_a_of_type_Bflz);
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a() != null) {
  ...
  public void as()
  {
    ...
    for (int k = 1;; k = 0)
    {
      ...
      bgty localbgty = (bgty)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(203);
      boolean bool2 = localbgty.a();
      Object localObject = localbgty.b;
      String str1 = localbgty.c;
      ArrayList localArrayList = new ArrayList();
      String str2 = bgme.a(this.jdField_a_of_type_ComTencentWidgetXEditTextEx.getEditableText(), localArrayList);
      k = 0;
      label259:
      ...
      if (k < localArrayList.size())
      {
        ...
        if (localbgty.a(localAtTroopMemberInfo.uin))
        {
          localObject = "" + localAtTroopMemberInfo.uin;
          str1 = bhlg.h(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, (String)localObject);
          if ((bool2) || (localbgty.a(str2, "" + localAtTroopMemberInfo.uin, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)))
          {
            bool1 = true;
            bool3 = localbgty.b(str2, "" + localAtTroopMemberInfo.uin, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
            bool2 = bool1;
          }
        }
      }
      for (boolean bool1 = bool3;; bool1 = false)
      {
        if ((bool2) && (!bool1))
        {
          ...
          a(localbgty.b, localbgty.c, true, 0);
        }
        for (;;)
        {
          this.Y = false;
          ...
          k += 1;
          break;
          ahvz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str2, localArrayList, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
          ...
          {
            y(false);
            localObject = (agwy)a(23);
            if (localObject != null) {
              ((agwy)localObject).a(false);
            }
          }
          this.X = false;
          localbgty.a();
  ...
  public aiwh b()
  {
    return this.jdField_a_of_type_Aiwh;
  }
  ...
  public boolean b(boolean paramBoolean)
  {
    ...
    if (this.af)
    {
      this.jdField_a_of_type_ComTencentWidgetXPanelContainer.a();
      if (paramBoolean) {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131696725, 0).b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getTitleBarHeight());
      }
      ak();
      bool = true;
    }
  ...
  public void bA()
  {
    ...
    localAlphaAnimation.setAnimationListener(new aiqh(this));
  ...
  public void bB()
  {
    ...
    localAlphaAnimation.setDuration(200L);
    localAlphaAnimation.setAnimationListener(new aiqi(this));
    this.q.startAnimation(localAlphaAnimation);
    this.p.startAnimation(localAlphaAnimation);
  }
  ...
  public void bC()
  {
    if ((this.jdField_c_of_type_Bjbs != null) && (this.jdField_c_of_type_Bjbs.isShowing()) && (!a().isFinishing())) {
  ...
  protected void bD()
  {
    Object localObject1 = (bgty)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(203);
    Object localObject2;
    String str1;
    int k;
    boolean bool;
    if (((bgty)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) {
      if (!this.Y)
      {
        localObject2 = (bgme[])this.jdField_a_of_type_ComTencentWidgetXEditTextEx.getEditableText().getSpans(0, this.jdField_a_of_type_ComTencentWidgetXEditTextEx.getEditableText().toString().length(), bgme.class);
        str1 = this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString;
        k = 0;
        if (k >= localObject2.length) {
          break label438;
        }
        if (!((bgty)localObject1).b(localObject2[k].a())) {
          break label247;
        }
        String str2 = localObject2[k].a();
        this.jdField_g_of_type_JavaLangString = str2;
        ((bgty)localObject1).e = str2;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (this.X == bool) {
          if (bool)
          {
            localObject1 = (agwy)a(23);
            if (localObject1 != null) {
              ((agwy)localObject1).b(this.jdField_a_of_type_ComTencentWidgetXEditTextEx.getLineCount());
            }
          }
        }
        label247:
          ...
          do
          {
            do
            {
              do
              {
                ...
                y(false);
                localObject2 = (agwy)a(23);
                if (localObject2 != null) {
                  ((agwy)localObject2).a(false);
                }
              } while (!((bgty)localObject1).a());
              ((bgty)localObject1).a();
              bgty.a("panel", "talk_out", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqTroopWidgetTroopAIORobotLayout.a(), "2", "");
              ((bgty)localObject1).b(Long.parseLong(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString), Long.parseLong(this.jdField_g_of_type_JavaLangString), "off", new aiqn(this));
              return;
            } while (this.W);
            this.jdField_a_of_type_ComTencentMobileqqTroopWidgetTroopAIORobotLayout.a(str1, this.jdField_g_of_type_JavaLangString, this.jdField_h_of_type_JavaLangString, this, new aiqo(this));
            return;
          } while (!this.W);
          y(false);
          localObject1 = (agwy)a(23);
  ...
  {
    if (this.jdField_d_of_type_AndroidWidgetTextView == null) {
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131365602));
    }
  ...
  public void bF()
  {
    ...
    Object localObject = (awpf)a(33);
    boolean bool1 = ((awpf)localObject).c();
    boolean bool2 = ((awpf)localObject).d();
    agwp localagwp = (agwp)a(43);
    boolean bool4 = localagwp.c();
    aiwa localaiwa = (aiwa)a(75);
    boolean bool3 = localaiwa.d();
    int k;
    if (bool1)
    {
      z(3);
      c(true);
      this.jdField_f_of_type_AndroidWidgetTextView.setText(((awpf)localObject).a(bool2));
      ...
      v(bool2);
      k = agej.a(8.0F, this.jdField_f_of_type_AndroidWidgetTextView.getResources());
      awow.a(this.jdField_b_of_type_AndroidViewViewGroup, 0, k, 0, 0, this.jdField_c_of_type_AndroidViewViewGroup.getRootView());
    }
    label172:
    while ((QLog.isColorLevel()) && (QLog.isColorLevel()))
    {
      ...
      if (bool4)
      {
        ...
        z(4);
        c(true);
        this.jdField_f_of_type_AndroidWidgetTextView.setText(localagwp.a());
        this.jdField_f_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getColor(2131166987));
        v(bool3);
        k = agej.a(8.0F, this.jdField_f_of_type_AndroidWidgetTextView.getResources());
        awow.a(this.jdField_b_of_type_AndroidViewViewGroup, 0, k, 0, 0, this.jdField_c_of_type_AndroidViewViewGroup.getRootView());
      ...
      else if (bool3)
      {
        ...
        c(true);
        bool4 = localaiwa.a();
        this.jdField_f_of_type_AndroidWidgetTextView.setText(localaiwa.a(bool4));
        this.jdField_f_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getColor(2131166987));
        v(bool4);
        k = agej.a(8.0F, this.jdField_f_of_type_AndroidWidgetTextView.getResources());
        awow.a(this.jdField_b_of_type_AndroidViewViewGroup, 0, k, 0, 0, this.jdField_c_of_type_AndroidViewViewGroup.getRootView());
      ...
      {
        localObject = ((bhbe)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(234)).a(a().jdField_a_of_type_JavaLangString);
        if (TextUtils.isEmpty((CharSequence)localObject)) {
          break label561;
        }
        z(2);
  ...
  public void beforeTextChanged(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    ((agsn)a(34)).a(paramCharSequence, paramInt1, paramInt2, paramInt3);
  }
  ...
  public void bp()
  {
    ...
    if (this.jdField_a_of_type_Bgrm == null)
    {
      aiqw localaiqw = new aiqw(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      this.jdField_a_of_type_Bgrm = new bgrm(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, localaiqw, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    }
    ...
    ((bgre)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(132)).e(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
  }
  ...
  public void bq()
  {
    ...
    bE();
    this.ag = true;
    if ((this.ac) && (this.jdField_a_of_type_Bfyj != null))
    {
      this.jdField_a_of_type_Bfyj.a(true);
      this.ac = false;
    }
    localObject = (bfui)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(231);
    if ((((bfui)localObject).jdField_a_of_type_Int != 0) && (!nlj.a().a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) && (!bdgb.b()))
    {
      ((bfui)localObject).a(new bfug(((bfui)localObject).e, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, ((bfui)localObject).b, ((bfui)localObject).c, ((bfui)localObject).d, ((bfui)localObject).jdField_a_of_type_Int));
      localObject = a();
      ((bftx)localObject).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      ((bftx)localObject).a();
    }
  }
  ...
  public void bv()
  {
    ...
    for (boolean bool2 = true;; bool2 = false)
    {
      ...
      if (localObject != null)
      {
        ...
        ((aoip)localObject).d(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, true);
      }
      a(l, bool3);
      return;
      bool1 = false;
      ...
      for (;;)
      {
        ...
        if ((localObject != null) && ((((TroopInfo)localObject).wMemberNum == 0) || (TextUtils.isEmpty(((TroopInfo)localObject).troopowneruin)))) {
          try
          {
            ...
            ((aoip)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a((ArrayList)localObject);
            if (QLog.isColorLevel())
            {
  ...
  public void bx()
  {
    ...
    try
    {
      localaoip.a(Long.parseLong(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString), 0L, 2, 0, 0);
      return;
    }
    catch (Exception localException)
    {
  ...
  void by()
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetTextView.getVisibility() == 0)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getColor(2131166984));
      agej.a(this.jdField_a_of_type_AndroidWidgetImageView, 2130850677);
      if ((this.jdField_f_of_type_AndroidWidgetTextView.getVisibility() == 0) && (this.jdField_f_of_type_AndroidWidgetTextView.getText() != null) && (this.jdField_f_of_type_AndroidWidgetTextView.getText().toString().startsWith(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131689996))))
      {
        this.jdField_f_of_type_AndroidWidgetTextView.setText("");
        this.jdField_f_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getColor(2131166987));
        c(false);
      }
      localObject = (bhbe)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(234);
      String str = ((bhbe)localObject).a(a().jdField_a_of_type_JavaLangString);
      if (TextUtils.isEmpty(str)) {
        break label613;
      }
      z(2);
      if (((bhbe)localObject).a(a().jdField_a_of_type_JavaLangString) != 3) {
        break label556;
      }
      bhju.a("Grp_idol", "Grp_AIO", "exp_renshu", 0, 0, new String[] { a().jdField_a_of_type_JavaLangString });
      label303:
      c(true);
      this.jdField_f_of_type_AndroidWidgetTextView.setText(str);
      this.jdField_f_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getColor(2131166987));
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentWidgetXEditTextEx != null)
      {
        this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setShadowLayer(1.0F, 0.0F, 1.0F, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getColor(2131165406));
        this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setHint("");
      }
      if (this.jdField_a_of_type_ComTencentMobileqqActivityAioPanelPanelIconLinearLayout != null) {
        agej.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioPanelPanelIconLinearLayout, 2130849892);
      }
      bz();
      ...
      this.jdField_c_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getColor(2131166984));
      break;
      label556:
      new bdlq(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_online").c("Grp_AIO").d("exp_onlineEntry").a(new String[] { a().jdField_a_of_type_JavaLangString }).a();
      break label303;
  ...
  public void e(Intent paramIntent)
  {
    ...
    if (this.U) {
      if (this.jdField_a_of_type_AndroidWidgetTextView.getVisibility() == 0)
      {
        ...
        this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(nlj.c);
      }
    }
    do
    {
  ...
  public void g(String paramString)
  {
    ...
    do
    {
      ...
      if (this.jdField_c_of_type_Bjbs == null) {
        this.jdField_c_of_type_Bjbs = new bjbs(a(), a().getTitleBarHeight());
      }
      this.jdField_c_of_type_Bjbs.a(paramString);
    } while ((a().isFinishing()) || (this.jdField_c_of_type_Bjbs.isShowing()));
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    while ((paramMessage.what == 60) && (this.U))
    {
      ...
      this.jdField_a_of_type_Aaud = new aaud(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.jdField_a_of_type_Bghm, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      ...
      this.jdField_a_of_type_Aaud.a(k, m - i1);
      this.jdField_a_of_type_Aaud.a(paramMessage.arg1);
      continue;
      if ((this.jdField_a_of_type_Bfpy != null) && (this.jdField_a_of_type_Bfpy.b()))
      {
        localObject = this.jdField_a_of_type_Bfpy.a();
        if (((bgia)localObject).a.get())
        {
          ((bgia)localObject).a.set(false);
          continue;
          if (bgya.a(this.jdField_j_of_type_AndroidWidgetImageView).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo))
          {
            k = 1;
  ...
  {
    super.i();
    this.jdField_a_of_type_Npk = new npk(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    if (this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getIntent().getBooleanExtra("PhotoConst.IS_JUMPTO_TROOP_ALBUM", false)) {
      aean.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getIntent());
    }
    this.Z = true;
    ...
    axan.a().b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject);
    if (this.jdField_a_of_type_Aged != null) {
    ...
    for (;;)
    {
      new bdlq(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_private").c("Grp_AIO").d("exp").a(new String[] { this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, String.valueOf(k) }).a();
      if (this.jdField_b_of_type_AndroidViewViewTreeObserver$OnGlobalLayoutListener == null)
      {
        this.jdField_b_of_type_AndroidViewViewTreeObserver$OnGlobalLayoutListener = new aiqu(this, null);
      ...
      this.am = false;
      ((agwy)a(23)).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      bG();
      return;
      label325:
  ...
  {
    super.j();
    if ((this.jdField_a_of_type_Bfpy.d()) && ((this.jdField_a_of_type_Bfpy.b() == 17) || (this.jdField_a_of_type_Bfpy.b() == 100) || (this.jdField_a_of_type_Bfpy.b() == 11))) {
      return;
    }
    this.jdField_a_of_type_Aiwm = new aiwm(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Aiwh, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_Bfpy, this.jdField_a_of_type_AndroidWidgetToast);
    this.jdField_a_of_type_Aiwh.a(this.jdField_a_of_type_Aiwm);
    ...
    this.jdField_a_of_type_Aiwl = new aiwl(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_Aiwh, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity);
    this.jdField_a_of_type_Aiwh.a(this.jdField_a_of_type_Aiwl);
    agtx localagtx = (agtx)a(71);
    if (localagtx != null) {
      localagtx.a(this.jdField_a_of_type_Aiwh);
    }
    ((aiwa)a(75)).a();
  }
  ...
  public void k(int paramInt)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqUtilsQQRecorder != null) && (!this.jdField_a_of_type_ComTencentMobileqqUtilsQQRecorder.b()) && (!this.jdField_a_of_type_MqqOsMqqHandler.hasMessages(16711686)))
    {
      ...
      bhkm.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getApplicationContext(), false);
      b(true);
    }
    label135:
  ...
  public void o(int paramInt)
  {
    ...
    try
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d(this.jdField_a_of_type_JavaLangString, 2, "avType : " + ((lnb)localObject1).jdField_a_of_type_Int);
        }
        if (((lnb)localObject1).jdField_a_of_type_Int != 2) {
          break label719;
        }
        if (((lnb)localObject1).jdField_a_of_type_Boolean)
        {
          bdll.b(null, "CliOper", "", "", "0X80066C2", "0X80066C2", 0, 0, "", "", "", "");
      ...
      else
      {
        ...
        this.jdField_a_of_type_AndroidWidgetScrollView = new aiqj(this, this.jdField_a_of_type_AndroidContentContext);
        ...
        ((RelativeLayout.LayoutParams)localObject1).topMargin = bhgr.a(this.jdField_a_of_type_AndroidContentContext, 50.0F);
        ...
        localObject1 = (bfui)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(231);
        this.jdField_a_of_type_Bftx = a();
        ((bfui)localObject1).jdField_a_of_type_Int = 0;
        ((bfui)localObject1).b = 0;
        ((bfui)localObject1).c = 0;
        ((bfui)localObject1).d = 0;
        if (!bdgb.b()) {
          ((bfui)localObject1).c(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
        }
        ...
        if (this.jdField_a_of_type_Bfyj == null) {
          this.jdField_a_of_type_Bfyj = ((bfyj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(289));
        }
        if (localObject1 != null)
        {
          this.jdField_a_of_type_Bfyj.a(((TroopInfo)localObject1).dwGroupClassExt, true, this, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
        ...
        bZ();
        bY();
        localObject1 = (arjm)aran.a().a(553);
        if ((localObject1 != null) && (!((arjm)localObject1).jdField_a_of_type_Boolean))
        {
          this.jdField_d_of_type_AndroidWidgetImageView.setVisibility(8);
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        if (QLog.isColorLevel())
        {
          ...
          continue;
          bdll.b(null, "CliOper", "", "", "0X80066BF", "0X80066BF", 0, 0, "", "", "", "");
          continue;
          label719:
          if (((lnb)localObject2).jdField_a_of_type_Int == 10)
          {
            if (((lnb)localObject2).jdField_a_of_type_Boolean) {
              bdll.b(null, "CliOper", "", "", "0X80066C1", "0X80066C1", 0, 0, "", "", "", "");
            }
            for (;;)
            {
              this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString).longValue(), 1);
              break;
              bdll.b(null, "CliOper", "", "", "0X80066BE", "0X80066BE", 0, 0, "", "", "", "");
            }
            this.s = (this.jdField_a_of_type_AndroidWidgetRelativeLayout.getHeight() - this.jdField_a_of_type_ComTencentMobileqqWidgetNavbarNavBarAIO.getHeight() - this.jdField_a_of_type_ComTencentMobileqqActivityAioInputLinearLayout.getHeight() - this.jdField_a_of_type_ComTencentMobileqqActivityAioPanelPanelIconLinearLayout.getHeight());
  ...
  {
    if (bhsi.m(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))
    {
      a(paramBoolean, TroopGiftPanel.jdField_f_of_type_Int);
      bhsi.k(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), false);
      return;
    }
  ...
  {
    if ((paramView.getId() == 2131367328) && (b(true))) {}
    for (;;)
    {
      ...
      {
        if ((this.jdField_a_of_type_Aiwm != null) && (this.jdField_a_of_type_Aiwm.a())) {
          this.jdField_a_of_type_Aiwh.a();
        }
      }
      else if (paramView.getId() == 2131371498) {
        cf();
      } else if ((paramView.getId() == 2131369056) && (this.jdField_j_of_type_AndroidWidgetImageView != null) && (this.jdField_j_of_type_AndroidWidgetImageView.getVisibility() == 0)) {
        bgya.a(this.jdField_j_of_type_AndroidWidgetImageView).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
      }
    }
  }
  ...
  public void onScrollStateChanged(AbsListView paramAbsListView, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Bfpy != null) {
      this.jdField_a_of_type_Bfpy.a().a(paramInt, 500L);
    }
    if (paramInt == 2) {
      cf();
    }
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      while (paramAbsListView.hasNext()) {
        ((aiqv)paramAbsListView.next()).a(this.al);
      }
    }
    if ((paramInt == 0) && (this.jdField_i_of_type_JavaLangString != null))
    {
      paramAbsListView = ((aoip)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a();
  ...
  public void onTextChanged(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    do
    {
      do
      {
        ...
        if ((paramInt3 != 1) || ((paramCharSequence.charAt(paramInt1) != '$') && (paramCharSequence.charAt(paramInt1) != 65509) && (paramCharSequence.charAt(paramInt1) != '¥') && (paramCharSequence.charAt(paramInt1) != 65284)) || (this.jdField_r_of_type_Boolean) || (((agvx)a(27)).jdField_a_of_type_Boolean)) {
          break;
        }
    ...
    for (;;)
    {
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_flower", "", "grp_aio", "sign", 0, 0, paramCharSequence.troopuin + "", paramInt1 + "", "", "");
      bgth.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, paramCharSequence.troopuin, "input", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      return;
    ...
    if ((!this.jdField_r_of_type_Boolean) && (!((agvx)a(27)).jdField_a_of_type_Boolean)) {
      ((agsn)a(34)).b(paramCharSequence, paramInt1, paramInt2, paramInt3);
    }
    bD();
  }
  ...
  {
    if ((this.jdField_a_of_type_Aavw != null) && (this.jdField_a_of_type_Aavw.a()))
    {
      this.jdField_a_of_type_Aavw.a();
      anfz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "troop_gift_panel", false);
    }
  ...
  public void update(Observable paramObservable, Object paramObject)
  {
    ...
    {
      return;
      if ((paramObject instanceof bgtn))
      {
        paramObservable = (bgtn)paramObject;
      ...
      for (;;)
      {
        ...
        return;
        if ((!((aoip)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a().b("highFreqInteract")) || (this.ab)) {
          break label197;
        }
        this.ab = true;
        if (this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopBatchAddFriendMgr$CheckHighFreqInteractionRunnable == null) {
        ...
        if ((paramObject instanceof bfpe)) {
          ...
          default: 
            break;
          case 123322: 
            if ((this.jdField_a_of_type_Bghm != null) && (this.jdField_a_of_type_Bghm.a())) {
              this.jdField_a_of_type_ComTencentMobileqqWidgetScrollerRunnable.a(1, this.jdField_a_of_type_Bghm.a() / 2);
            } else {
  ...
  public void v(boolean paramBoolean)
  {
    ...
    ((LinearLayout.LayoutParams)localObject).width = zps.a(this.jdField_a_of_type_AndroidContentContext, 15.0F);
    ((LinearLayout.LayoutParams)localObject).height = zps.a(this.jdField_a_of_type_AndroidContentContext, 15.0F);
    ...
    try
    {
      ...
      do
      {
        ...
        if (this.t == 2)
        {
          localObject = (AnimationDrawable)this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843846);
          ((AnimationDrawable)localObject).setOneShot(true);
          ((AnimationDrawable)localObject).setBounds(0, 0, zps.a(this.jdField_a_of_type_AndroidContentContext, 10.0F), zps.a(this.jdField_a_of_type_AndroidContentContext, 10.0F));
          this.jdField_h_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject);
        ...
        if (this.t == 3)
        {
          localObject = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843847);
          ((Drawable)localObject).setBounds(0, 0, zps.a(this.jdField_a_of_type_AndroidContentContext, 10.0F), zps.a(this.jdField_a_of_type_AndroidContentContext, 10.0F));
          this.jdField_h_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject);
          return;
        }
  ...
  public void w(boolean paramBoolean)
  {
    ...
    ((agwl)a(29)).c(paramBoolean);
    this.U = paramBoolean;
    nlj.a().a(paramBoolean, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    if ((paramBoolean) || (anfz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))) {
      anfz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "troop_anonyous", paramBoolean);
    }
    Object localObject;
    if (this.n == null)
    {
    ...
    if (this.q == null)
    {
      ...
      this.q.setBackgroundResource(2130843613);
    ...
    if (this.p == null)
    {
      ...
      this.p.setBackgroundResource(2130843613);
    ...
    if (this.jdField_a_of_type_Bghm != null) {
      this.jdField_a_of_type_Bghm.a(paramBoolean);
    }
    if (paramBoolean)
    {
      paramBoolean = ((awpf)a(33)).c();
      localObject = (agwp)a(43);
      boolean bool1 = ((agwp)localObject).c();
      boolean bool2 = ((aiwa)a(75)).d();
      ...
      if ((ImmersiveUtils.isSupporImmersive() != 0) && (ImmersiveUtils.c()))
      {
        ...
        this.jdField_e_of_type_AndroidWidgetTextView.setTextColor(nlj.c);
        this.jdField_d_of_type_AndroidWidgetTextView.setTextColor(nlj.c);
        if (this.jdField_a_of_type_AndroidWidgetTextView.getVisibility() != 0) {
          break label910;
        }
        this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130843633);
        ...
        this.jdField_f_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131689996) + nlj.a().a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString).jdField_a_of_type_JavaLangString);
        this.jdField_f_of_type_AndroidWidgetTextView.setTextColor(nlj.c);
        agej.a(this.jdField_a_of_type_AndroidWidgetImageView, null);
        c(true);
        PlusPanel localPlusPanel = (PlusPanel)this.jdField_a_of_type_Aiap.b(8);
        ...
        this.jdField_a_of_type_Nln = new aiqg(this);
        nlj.a().a(this.jdField_a_of_type_Nln);
        this.jdField_a_of_type_Aiwh.a();
        if (this.jdField_a_of_type_ComTencentWidgetXEditTextEx != null)
        {
          this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setHint(2131695398);
          this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setShadowLayer(0.0F, 0.0F, 0.0F, 0);
        }
        if (this.jdField_a_of_type_ComTencentMobileqqActivityAioPanelPanelIconLinearLayout != null)
        {
          agej.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioPanelPanelIconLinearLayout, 2130843613);
  ...
  public void x()
  {
    ...
    for (;;)
    {
      ...
      {
        bdll.b((QQAppInterface)localObject2, "P_CliOper", "Grp_set", "", "AIOchat", "Clk_dataEntry_new", 0, 0, str, (String)localObject1, "", "");
