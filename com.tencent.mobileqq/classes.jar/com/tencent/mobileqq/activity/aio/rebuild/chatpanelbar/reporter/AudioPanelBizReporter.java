  ...
  implements IPanelBizReporter
{
  ...
  {
    ((IRedTouchManager)paramIChatPanelBarData.e().getRuntimeService(IRedTouchManager.class, "")).onRedTouchItemClick("103100.103300");
    if ((paramView instanceof RedDotImageView)) {
      ((RedDotImageView)paramView).a(false);
    }
    ReportController.b(paramIChatPanelBarData.e(), "CliOper", "", "", "changevoice", "0X8006F48", 0, 0, "", "", "", "");
  }
