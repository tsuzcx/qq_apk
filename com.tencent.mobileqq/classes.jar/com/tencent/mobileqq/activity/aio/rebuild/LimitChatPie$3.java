...
class LimitChatPie$3
  extends MessageObserver
{
  LimitChatPie$3(LimitChatPie paramLimitChatPie) {}
  ...
  public void onMessageRecordAdded(List<MessageRecord> paramList)
  {
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      if ((!ExpandFriendChatUtil.a(paramList)) && (paramList.frienduin != null) && (paramList.frienduin.equals(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) && (!((FriendsManager)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER)).b(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)))
      {
  ...
  public void onSendResult(boolean paramBoolean, String paramString, long paramLong)
  {
    ...
    ((IceBreakingMng)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.ICE_BREAKING_MNG)).h(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.aio.rebuild.LimitChatPie.3
