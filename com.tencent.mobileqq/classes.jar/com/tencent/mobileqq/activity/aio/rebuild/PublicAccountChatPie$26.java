...
{
  PublicAccountChatPie$26(PublicAccountChatPie paramPublicAccountChatPie, String paramString) {}
  
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    if (QLog.isColorLevel()) {
      QLog.d(this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildPublicAccountChatPie.b, 2, "success:" + String.valueOf(paramBoolean));
    }
    if (!paramBoolean) {
