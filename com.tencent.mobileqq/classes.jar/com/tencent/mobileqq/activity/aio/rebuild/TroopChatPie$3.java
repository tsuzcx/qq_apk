...
public class TroopChatPie$3
  implements Runnable
{
  public TroopChatPie$3(aejb paramaejb) {}
  ...
  public void run()
  {
    ...
    if (localObject != null)
    {
      ...
      if (((Iterator)localObject).hasNext())
      {
        ...
        {
          ((azlf)this.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(81)).a(this.this$0.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, this.this$0.a(localTroopMemberInfo), NetConnInfoCenter.getServerTime(), localTroopMemberInfo.mUniqueTitleExpire, 0, 1);
          ...
          awqx.b(this.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_manage", "", "grp_aio", "exp_expire", 0, 0, this.this$0.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, "", "", "");
        }
      }
    }
    for (;;)
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.aio.rebuild.TroopChatPie.3
