  ...
  public void a(IChatPanelBarData paramIChatPanelBarData, View paramView)
  {
    if (paramIChatPanelBarData.b())
    {
      if (QLog.isDebugVersion())
      {
        ...
        paramView.append("[onClickReport] cmgame_aio, cmgame_aio_qun, click, ");
        paramView.append(paramIChatPanelBarData.a());
    ...
    if ((!paramIChatPanelBarData.a()) && (paramAIOPanelIconItem != null))
    {
      if (paramIChatPanelBarData.b())
      {
        if (QLog.isDebugVersion())
        {
          ...
          paramAIOPanelIconItem.append("[onExposureReport] cmgame_aio, cmgame_aio_qun, expo, ");
          paramAIOPanelIconItem.append(paramIChatPanelBarData.a());
