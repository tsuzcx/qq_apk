...
public class PublicAccountChatPie$57
  implements Runnable
{
  public PublicAccountChatPie$57(aido paramaido) {}
  
  public void run()
  {
    bjyi localbjyi = (bjyi)this.this$0.app.getBusinessHandler(BusinessHandlerFactory.QIDIAN_HANDLER);
    if (!this.this$0.w) {
    ...
    {
      localObject = null;
      localbjyi.a(str1, str2, str3, str4, (String)localObject);
      this.this$0.getActivity().runOnUiThread(new PublicAccountChatPie.57.1(this));
      localbjyi.a(this.this$0.sessionInfo.curFriendUin, this.this$0.e);
      return;
    }
  }
}
