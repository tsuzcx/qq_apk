  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("VipExtendIconExtender", 2, "vip_card_extension jumpUrl=" + str);
    }
    if (!StringUtil.a(str)) {
      VasWebviewUtil.openQQBrowserActivity(VipExtendIconExtender.a(this.a), str, 256L, null, false, -1);
    }
