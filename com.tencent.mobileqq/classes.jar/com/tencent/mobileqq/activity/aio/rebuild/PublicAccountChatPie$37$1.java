...
public class PublicAccountChatPie$37$1
  implements Runnable
{
  public PublicAccountChatPie$37$1(aien paramaien) {}
    ...
    try
    {
      ...
      while (localIterator1.hasNext())
      {
        ...
        while (localIterator2.hasNext())
        {
          ...
          if (localConfigInfo.title.get().equals(anni.a(2131707526))) {
      ...
      ((anlf)this.a.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(69)).a(localEqqDetail);
      this.a.a.jdField_a_of_type_Bjft.a(true);
      return;
    }
