...
public class HotChatPie$22
  implements Runnable
{
  public HotChatPie$22(aefe paramaefe, int paramInt1, int paramInt2) {}
  
  public void run()
  {
    int j = 1;
    if (!badq.g(this.this$0.jdField_a_of_type_AndroidContentContext)) {
      bbmy.a(this.this$0.jdField_a_of_type_AndroidContentContext, 1, this.this$0.jdField_a_of_type_AndroidContentContext.getString(2131628949), 0).a();
    }
    ...
    for (localObject1 = ((TicketManager)localObject1).getSkey((String)localObject2);; localObject1 = null)
    {
      ...
      if (this.b <= 0)
      {
        ...
        localObject3 = this.this$0.jdField_a_of_type_Aiaq;
        localObject4 = aefe.a(this.this$0);
      ...
      for (int i = j;; i = 2)
      {
        new bcen("https://buluo.qq.com/cgi-bin/bar/post/get_post_from_reliao", "GET", new aefu((Context)localObject1, (XListView)localObject2, (aiaq)localObject3, (PullRefreshHeader)localObject4, localTextView, i)).a(localBundle);
        return;
        i = this.b;
        break;
      }
