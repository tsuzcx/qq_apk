...
public class HotChatPie$22
  implements Runnable
{
  public HotChatPie$22(aeqd paramaeqd, int paramInt1, int paramInt2) {}
  
  public void run()
  {
    int j = 1;
    if (!bbev.g(this.this$0.jdField_a_of_type_AndroidContentContext)) {
      bcpw.a(this.this$0.jdField_a_of_type_AndroidContentContext, 1, this.this$0.jdField_a_of_type_AndroidContentContext.getString(2131694610), 0).a();
    }
    ...
    for (localObject1 = ((TicketManager)localObject1).getSkey((String)localObject2);; localObject1 = null)
    {
      ...
      if (this.b <= 0)
      {
        ...
        localObject3 = this.this$0.jdField_a_of_type_Ainj;
        localObject4 = aeqd.a(this.this$0);
      ...
      for (int i = j;; i = 2)
      {
        new bdio("https://buluo.qq.com/cgi-bin/bar/post/get_post_from_reliao", "GET", new aeqt((Context)localObject1, (XListView)localObject2, (ainj)localObject3, (PullRefreshHeader)localObject4, localTextView, i)).a(localBundle);
        return;
        i = this.b;
        break;
      }
