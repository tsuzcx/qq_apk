  ...
  implements Runnable
{
  ...
  {
    this.this$0.bx();
    Object localObject1 = ((bakk)this.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(48)).a(this.this$0.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, true);
    ...
    if (((i == 1) || (i == 4) || ((i == -1) && (((azqz)localObject2).c > 0))) && (((azqz)localObject2).jdField_a_of_type_Boolean) && (localObject1 != null) && (((TroopInfo)localObject1).wMemberNum < ((azqz)localObject2).b) && ((j == 4) || (j == 1))) {
      ((azqz)localObject2).b(this.this$0.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, Math.min(this.this$0.u, ((azqz)localObject2).jdField_a_of_type_Int));
    }
    localObject2 = TroopChatPie.h(this.this$0).obtainMessage(85);
    if (bapx.a(TroopChatPie.a(this.this$0)).a(this.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.this$0.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo)) {}
    for (i = 1;; i = 0)
    {
      ((Message)localObject2).arg1 = i;
      ((Message)localObject2).sendToTarget();
      if ((localObject1 != null) && (((TroopInfo)localObject1).isGameBind())) {
        bbbb.a("Grp_game", "Grp_AIO", "aio_exp", 0, 0, new String[] { this.this$0.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a });
      }
      return;
    }
  }
