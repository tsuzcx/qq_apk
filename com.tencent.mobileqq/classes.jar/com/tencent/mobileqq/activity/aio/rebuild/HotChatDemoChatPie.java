  ...
  extends HotChatPie
{
  ...
  private void b(Drawable paramDrawable)
  {
    ...
    do
    {
      do
      {
        ...
        paramDrawable.setText(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getText(2131438097));
        ...
        this.d.setBackgroundResource(2130842822);
  ...
  protected void X()
  {
    ...
    if (this.d == null)
    {
      ...
      ThreadManager.getFileThreadHandler().post(new vzt(this.h, this.jdField_a_of_type_MqqOsMqqHandler, this.m));
    }
  }
  ...
  protected void e(Intent paramIntent)
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(2131438095);
      this.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131438095));
