  ...
  extends BaseChatPie
{
  ...
  public MultiForwardChatPie(QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, FragmentActivity paramFragmentActivity, Context paramContext)
  {
    ...
    this.jdField_b_of_type_MqqOsMqqHandler = new vsk(this);
  }
  ...
  protected void G()
  {
    if (this.u)
    {
      this.jdField_b_of_type_ComTencentMobileqqBubbleChatXListView.postDelayed(new vsn(this), 600L);
      this.u = false;
    }
  ...
  protected boolean a(boolean paramBoolean)
  {
    ...
    Object localObject1 = (ViewGroup)this.jdField_c_of_type_AndroidViewViewGroup.findViewById(2131363473);
    ((ViewGroup)localObject1).removeView(this.jdField_c_of_type_AndroidViewViewGroup.findViewById(2131362822));
    ...
    this.g = this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131433632);
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131435258));
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131433681));
    b(false);
    this.jdField_e_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_c_of_type_AndroidViewViewGroup.findViewById(2131363006));
    this.jdField_f_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_c_of_type_AndroidViewViewGroup.findViewById(2131363009));
    this.jdField_n_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_c_of_type_AndroidViewViewGroup.findViewById(2131363010));
    this.j = ((TextView)this.jdField_c_of_type_AndroidViewViewGroup.findViewById(2131363011));
    this.jdField_b_of_type_ComTencentMobileqqBubbleChatXListView = ((ChatXListView)this.jdField_c_of_type_AndroidViewViewGroup.findViewById(2131363007));
    ...
    for (;;)
    {
      ...
      ThreadManager.post(new vsm(this), 8, null, true);
      ...
      localObject1 = this.jdField_a_of_type_AndroidContentContext.getResources().getColorStateList(2131494205);
      this.jdField_d_of_type_AndroidWidgetTextView.setTextColor((ColorStateList)localObject1);
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
      return true;
      MultiMsgManager.a().a(0);
    }
    this.jdField_a_of_type_ComTencentMobileqqWidgetNavbarNavBarAIO.setBackgroundResource(2130845744);
    ...
    for (;;)
    {
      localObject1 = this.jdField_a_of_type_AndroidContentContext.getResources().getColorStateList(2131494206);
      this.jdField_d_of_type_AndroidWidgetTextView.setTextColor((ColorStateList)localObject1);
  ...
  public void aX()
  {
    ...
    if ((localObject2 != null) && (((List)localObject2).size() > 0))
    {
      ...
      this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.runOnUiThread(new vso(this, (CharSequence)localObject1));
      return;
    }
    this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.runOnUiThread(new vsp(this));
  }
  ...
  public boolean x()
  {
    ...
    {
      this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getDrawable(2130838596);
