  ...
  extends FriendChatPie
{
  ...
  private CardObserver jdField_a_of_type_ComTencentMobileqqAppCardObserver = new vwo(this);
  public EnterpriseQQObserver a;
  FriendsManager jdField_a_of_type_ComTencentMobileqqAppFriendsManager;
  protected MessageObserver a;
  private PublicAccountObserver jdField_a_of_type_ComTencentMobileqqAppPublicAccountObserver = new vwv(this);
  private ShieldListObserver jdField_a_of_type_ComTencentMobileqqAppShieldListObserver = new vww(this);
  ...
  public BusinessCmrTmpChatPie(QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, FragmentActivity paramFragmentActivity, Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new vwe(this);
    this.jdField_b_of_type_JavaUtilList = null;
    this.jdField_a_of_type_ComTencentMobileqqAppMessageObserver = new vwy(this);
    this.jdField_a_of_type_ComTencentMobileqqAppEnterpriseQQObserver = new vwh(this);
    this.jdField_b_of_type_ComTencentMobileqqAppMessageObserver = new vwn(this);
    this.jdField_a_of_type_ComTencentQidianControllerQidianBusinessObserver = new vwp(this);
  }
  ...
  private void bj()
  {
    if (this.jdField_a_of_type_ComTencentQidianQidianManager.f(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString))
    {
      ...
      {
        this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setBackgroundResource(2130845717);
        l();
      }
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_ComTencentWidgetXEditTextEx != null)
      {
        this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setBackgroundResource(2130845855);
        if (CustomMenuBar.a()) {
  ...
  private void bk()
  {
    ...
    this.jdField_p_of_type_AndroidViewView = this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131363053);
    this.jdField_a_of_type_ComTencentBizUiCustomMenuBar = ((CustomMenuBar)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131363056));
    Object localObject = this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131363052);
    ((View)localObject).setOnClickListener(new vwz(this));
    this.jdField_a_of_type_ComTencentBizUiCustomMenuBar.setCoverView((View)localObject);
    this.jdField_a_of_type_ComTencentBizUiCustomMenuBar.setOnMenuItemClickListener(new vwf(this));
    this.jdField_a_of_type_ComTencentBizUiCustomMenuBar.setOnBackClickListner(new vwg(this));
    ...
    for (;;)
    {
      this.jdField_e_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.c.findViewById(2131363515));
      ...
      this.q = ((ImageView)this.jdField_e_of_type_AndroidWidgetLinearLayout.findViewById(2131365605));
      this.q.setOnClickListener(this);
      this.jdField_p_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_e_of_type_AndroidWidgetLinearLayout.findViewById(2131364100));
      this.jdField_p_of_type_AndroidWidgetImageView.setOnClickListener(this);
      if (!CustomMenuBar.a())
      {
        this.jdField_p_of_type_AndroidWidgetImageView.setImageResource(2130844609);
        this.q.setImageResource(2130837587);
      }
      if (this.jdField_a_of_type_ComTencentWidgetXEditTextEx != null)
      {
        this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setBackgroundResource(2130845855);
  ...
  private void bm()
  {
    ...
    String str = ((Resources)localObject2).getString(2131438755);
    localObject2 = ((Resources)localObject2).getString(2131438756);
  ...
  public void a(PublicAccountInfo paramPublicAccountInfo)
  {
    ...
    while (!QLog.isColorLevel())
    {
      ...
      paramPublicAccountInfo = DialogUtil.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 230, str1, str2, 2131428083, 2131428084, new vwi(this, paramPublicAccountInfo, localPublicAccountDataManager), new vwk(this, paramPublicAccountInfo, localPublicAccountDataManager));
  ...
  protected void aY()
  {
    ...
    if (this.jdField_d_of_type_AndroidWidgetLinearLayout == null)
    {
      ...
      this.jdField_o_of_type_AndroidViewView = this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getLayoutInflater().inflate(2130969522, null);
      this.jdField_o_of_type_AndroidViewView.setBackgroundDrawable(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getResources().getDrawable(2130837756));
      this.jdField_o_of_type_AndroidViewView.findViewById(2131366826).setVisibility(8);
      this.j = ((TextView)this.jdField_o_of_type_AndroidViewView.findViewById(2131364599));
      this.j.setTextColor(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getResources().getColorStateList(2131494266));
      ((ImageView)this.jdField_o_of_type_AndroidViewView.findViewById(2131364598)).setImageResource(2130839748);
      ...
      View localView = this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getLayoutInflater().inflate(2130969522, null);
      localView.setBackgroundDrawable(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getResources().getDrawable(2130837756));
      this.k = ((TextView)localView.findViewById(2131364599));
      this.k.setTextColor(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getResources().getColorStateList(2131494266));
      this.k.setText(this.jdField_a_of_type_AndroidContentContext.getString(2131436150));
      ((ImageView)localView.findViewById(2131364598)).setImageResource(2130839707);
    ...
    {
      this.j.setText(this.jdField_a_of_type_AndroidContentContext.getString(2131433419));
    ...
    for (;;)
    {
      if ((this.k != null) && (this.jdField_a_of_type_ComTencentQidianQidianManager.f(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString))) {
        this.k.setText(this.jdField_a_of_type_AndroidContentContext.getString(2131433417));
      }
      ...
      try
      {
        ...
        localObject1 = this.c.findViewById(2131363527);
        ...
        return;
        this.j.setText(this.jdField_a_of_type_AndroidContentContext.getString(2131436149));
  ...
  protected void aZ()
  {
    ...
    try
    {
      ...
      if (this.c != null)
      {
        View localView = this.c.findViewById(2131363527);
        if (localView != null)
        {
  ...
  protected void bb()
  {
    ...
    do
    {
      ...
      this.jdField_p_of_type_AndroidWidgetImageView.setImageResource(2130842234);
    ...
    if (this.jdField_e_of_type_Int == 2)
    {
      ...
      {
        if (CustomMenuBar.a()) {
          this.jdField_p_of_type_AndroidWidgetImageView.setImageResource(2130845751);
        }
        for (;;)
        {
          this.jdField_p_of_type_AndroidWidgetImageView.setContentDescription(this.jdField_a_of_type_AndroidContentContext.getString(2131433410));
          return;
          this.jdField_p_of_type_AndroidWidgetImageView.setImageResource(2130846046);
        }
      }
      if (CustomMenuBar.a()) {
        this.jdField_p_of_type_AndroidWidgetImageView.setImageResource(2130845750);
      }
      for (;;)
      {
        this.jdField_p_of_type_AndroidWidgetImageView.setContentDescription(this.jdField_a_of_type_AndroidContentContext.getString(2131433409));
        return;
        this.jdField_p_of_type_AndroidWidgetImageView.setImageResource(2130846047);
      }
    }
    this.jdField_p_of_type_AndroidWidgetImageView.setEnabled(true);
    if (this.jdField_a_of_type_ComTencentWidgetXPanelContainer.a() == 3)
  ...
  public void bd()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ((NewIntent)localObject).setObserver(new vwl(this));
        if (QLog.isColorLevel()) {
  ...
  public void bf()
  {
    ...
    SosoInterface.a(new vwm(this, 1, true, true, 0L, true, false, "BusinessCmrTmpChatPie"));
  }
  ...
  protected void c(int paramInt1, int paramInt2)
  {
    ...
    if (paramInt2 == 8) {
      if (this.q != null)
      {
        ...
        this.q.setImageResource(2130845794);
      }
    }
    label40:
    while (this.q == null)
    {
      return;
      this.q.setImageResource(2130845726);
      return;
    }
    if (CustomMenuBar.a())
    {
      this.q.setImageResource(2130845793);
      return;
    }
    this.q.setImageResource(2130845725);
  }
  ...
  public void onClick(View paramView)
  {
    ...
    if ((paramView.getId() == 2131364100) && (this.jdField_e_of_type_Int != 1))
    {
      if (this.jdField_a_of_type_ComTencentWidgetXPanelContainer.a() == 3)
      {
    ...
    else if (paramView.getId() == 2131365605)
    {
      ...
      if (this.q != null) {
        this.q.setContentDescription(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131437071));
      }
    ...
    for (;;)
    {
      ...
      if (this.q != null) {
        this.q.setContentDescription(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131437072));
      }
      k(0);
    }
  }
  ...
  public void p()
  {
    ...
    {
      this.jdField_d_of_type_AndroidWidgetImageView.setOnClickListener(new vwx(this));
  ...
  protected void u()
  {
    a(this.jdField_a_of_type_AndroidWidgetImageView, 2130845980, 2130845981);
  }
