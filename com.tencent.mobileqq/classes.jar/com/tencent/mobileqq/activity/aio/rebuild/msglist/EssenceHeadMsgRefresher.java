  ...
  implements IHeadMsgRefresher
{
  public void a(AIOContext paramAIOContext, int paramInt1, long paramLong1, int paramInt2, long paramLong2, int paramInt3, Runnable paramRunnable)
  {
    ...
    {
      QQToast.a(paramAIOContext.a, 2131720111, 0).b(paramAIOContext.a.getTitleBarHeight());
    ...
    {
      if (!NetworkUtil.g(paramAIOContext.a))
      {
        QQToast.a(paramAIOContext.a, 2131697207, 0).b(paramAIOContext.a.getTitleBarHeight());
        return;
      }
