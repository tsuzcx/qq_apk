...
class HotChatPie$21
  implements Runnable
{
  HotChatPie$21(HotChatPie paramHotChatPie, int paramInt1, int paramInt2) {}
  
  public void run()
  {
    int j = 1;
    if (!NetworkUtil.g(this.this$0.jdField_a_of_type_AndroidContentContext)) {
      QQToast.a(this.this$0.jdField_a_of_type_AndroidContentContext, 1, this.this$0.jdField_a_of_type_AndroidContentContext.getString(2131694460), 0).a();
    }
    ...
    for (localObject1 = ((TicketManager)localObject1).getSkey((String)localObject2);; localObject1 = null)
    {
      ...
      if (this.b <= 0)
      {
        ...
        localObject3 = this.this$0.jdField_a_of_type_ComTencentMobileqqAdapterHotChatPostListAdapter;
        localObject4 = HotChatPie.a(this.this$0);
