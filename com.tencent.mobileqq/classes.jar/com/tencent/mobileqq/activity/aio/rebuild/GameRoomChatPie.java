  ...
  implements GameRoomAVController.OnBindCallback
{
  ...
  boolean Y = false;
  boolean Z = true;
  BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new vrc(this);
  ...
  WerewolvesObserver jdField_a_of_type_ComTencentMobileqqWerewolvesWerewolvesObserver = new vqv(this);
  ...
  public GameRoomChatPie(QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, FragmentActivity paramFragmentActivity, Context paramContext)
  {
    ...
    this.jdField_b_of_type_AndroidViewView$OnClickListener = new vrf(this);
  }
  ...
  public void be()
  {
    ...
    ThreadManager.post(new vqs(this), 8, null, true);
  }
  
  public void bf()
  {
    ThreadManager.post(new vqt(this), 8, null, true);
  }
  ...
  public void bh()
  {
    ...
    localActionSheet.a(new vra(this, localActionSheet));
  ...
  public void bj()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWerewolvesWerewolvesHandler.a(localHotChatInfo, i, i1, new vrd(this));
  ...
  protected void d()
  {
    ...
    if ((localObject == null) || (((String)localObject).equals("1000")))
    {
      ...
      this.jdField_d_of_type_AndroidWidgetLinearLayout.setId(2131367774);
      ...
      if (i != 0)
      {
        ...
        this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setBackgroundResource(2130837619);
      }
      this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setVisibility(4);
      ...
      this.jdField_o_of_type_AndroidWidgetImageView.setImageResource(2130837642);
      ...
      label588:
      this.j.setBackgroundResource(2130845508);
      ...
      this.j.setOnTouchListener(new vqm(this));
      this.jdField_e_of_type_AndroidWidgetRelativeLayout = new RelativeLayout(this.jdField_a_of_type_AndroidContentContext);
      this.jdField_e_of_type_AndroidWidgetRelativeLayout.setOnTouchListener(new vqx(this));
      ...
      ((RelativeLayout.LayoutParams)localObject).addRule(12);
      this.k.setOnTouchListener(new vre(this));
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        break;
        label1039:
        this.j.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131494275));
        break label588;
        label1062:
        i += 1;
        break label976;
    ...
    for (;;)
    {
      ...
      if ((localHashMap1 != null) && (localHashMap2 != null))
      {
        ...
        if (this.jdField_a_of_type_ComTencentWidgetXPanelContainer.a() == 3)
        {
          ...
          label316:
          this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setBackgroundResource(2130838860);
          if (this.jdField_a_of_type_ComTencentMobileqqNearbyGameroomGameQuickWordsPanel != null) {
  ...
  public void e(String paramString)
  {
    ...
    localQQCustomDialog.setPositiveButton(2131432999, new vqw(this));
    localQQCustomDialog.setOnDismissListener(new vqy(this));
  ...
  protected void e(boolean paramBoolean)
  {
    ...
    if ((localWerewolvesPluginInterface.b()) && (!localWerewolvesPluginInterface.c()))
    {
      DialogUtil.a(this.jdField_a_of_type_AndroidContentContext, 230, null, "你的发言和分析对于队友非常重要，请不要轻易离开房间", "留在房间", "暂时离开", new vqo(this, paramBoolean), new vqp(this)).show();
      return;
    }
    DialogUtil.a(this.jdField_a_of_type_AndroidContentContext, 230, null, "你已经进入游戏，是否确定退出？", "否", "是", new vqq(this, paramBoolean, localWerewolvesPluginInterface), new vqr(this)).show();
  }
  ...
  protected boolean e()
  {
    ...
    if ((localWerewolvesPluginInterface.b()) && (!localWerewolvesPluginInterface.c()))
    {
      DialogUtil.a(this.jdField_a_of_type_AndroidContentContext, 230, null, "你的发言和分析对于队友非常重要，请不要轻易离开房间", "留在房间", "暂时离开", new vrh(this), new vri(this)).show();
      return true;
    }
    DialogUtil.a(this.jdField_a_of_type_AndroidContentContext, 230, null, "你已经进入游戏，是否确定退出？", "否", "是", new vrj(this, localWerewolvesPluginInterface), new vqn(this)).show();
    return true;
  }
  ...
  public void onNetMobile2None()
  {
    ...
    QQToast.a(this.jdField_a_of_type_AndroidContentContext, 1, 2131434826, 0).a();
  }
  ...
  public void s()
  {
    ...
    for (;;)
    {
      ...
      localActionSheet.a(new vqz(this, bool, localActionSheet));
      localActionSheet.show();
      return;
      bool = false;
      break;
  ...
  protected void z()
  {
    ...
    this.Y = false;
    if (this.W) {
      this.jdField_a_of_type_ComTencentMobileqqWerewolvesWerewolvesHandler.a(this.jdField_a_of_type_ComTencentMobileqqDataHotChatInfo, new vrg(this));
    }
    ...
    a(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131494247), true);
    try
    {
