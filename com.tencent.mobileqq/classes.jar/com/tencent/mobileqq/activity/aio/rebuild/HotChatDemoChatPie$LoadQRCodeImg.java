  ...
  implements Runnable
{
  ...
  private Bitmap a(String paramString, Resources paramResources)
  {
    ...
    //   29: getstatic 52	com/tencent/mobileqq/app/AppConstants:SDCARD_FILE_SAVE_PATH	Ljava/lang/String;
    //   32: invokevirtual 56	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   35: aload_1
    //   36: invokevirtual 62	java/lang/String:getBytes	()[B
    //   39: invokestatic 68	com/tencent/qphone/base/util/MD5:toMD5	([B)Ljava/lang/String;
    ...
    //   57: aload 8
    //   59: astore 5
    //   61: invokestatic 78	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   64: ifeq +40 -> 104
    //   67: aload 6
    //   69: astore_3
    //   70: aload 7
    ...
    //   84: dup
    //   85: invokespecial 47	java/lang/StringBuilder:<init>	()V
    //   88: ldc 82
    ...
    //   101: invokestatic 86	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   104: aload 6
    //   106: astore_3
    //   107: aload 7
    //   109: astore 4
    //   111: aload 8
    //   113: astore 5
    //   115: new 88	java/io/File
    //   118: dup
    //   119: aload 10
    //   121: invokespecial 91	java/io/File:<init>	(Ljava/lang/String;)V
    //   124: astore 9
    //   126: aload 6
    //   128: astore_3
    //   129: aload 7
    ...
    //   135: astore 5
    //   137: aload 9
    //   139: invokevirtual 94	java/io/File:exists	()Z
    //   142: ifne +80 -> 222
    //   145: aload 6
    //   147: astore_3
    //   148: aload 7
    ...
    //   162: iconst_0
    //   163: iconst_1
    //   164: invokestatic 99	com/tencent/mobileqq/troopshare/TroopShareUtility:a	(Ljava/lang/String;Landroid/content/res/Resources;IIZ)Landroid/graphics/Bitmap;
    //   167: astore_2
    //   168: aload_2
    //   169: astore_3
    //   170: aload_2
    ...
    //   176: aload_2
    //   177: aload 9
    //   179: invokestatic 104	com/tencent/mobileqq/utils/ImageUtil:a	(Landroid/graphics/Bitmap;Ljava/io/File;)Z
    //   182: pop
    //   183: aload_2
    //   184: astore_1
    //   185: aload_2
    ...
    //   191: astore 5
    //   193: aload_0
    //   194: getfield 35	com/tencent/mobileqq/activity/aio/rebuild/HotChatDemoChatPie$LoadQRCodeImg:b	I
    //   197: iconst_1
    ...
    //   214: invokestatic 107	com/tencent/mobileqq/utils/ImageUtil:a	(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    //   217: astore_1
    //   218: aload_0
    //   219: monitorexit
    //   220: aload_1
    ...
    //   231: astore 5
    //   233: aload 10
    //   235: invokestatic 113	android/graphics/BitmapFactory:decodeFile	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   238: astore_2
    //   239: aload_2
    //   240: astore_1
    //   241: aload_2
    ...
    //   247: astore 5
    //   249: aload_0
    //   250: getfield 35	com/tencent/mobileqq/activity/aio/rebuild/HotChatDemoChatPie$LoadQRCodeImg:b	I
    //   253: iconst_1
    ...
    //   270: invokestatic 107	com/tencent/mobileqq/utils/ImageUtil:a	(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    //   273: astore_1
    //   274: goto -56 -> 218
    //   277: astore_2
    //   278: aload_3
    //   279: astore_1
    //   280: invokestatic 78	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   283: ifeq -65 -> 218
    //   286: aload_2
    //   287: invokevirtual 116	java/lang/Exception:printStackTrace	()V
    //   290: aload_3
    //   291: astore_1
    //   292: goto -74 -> 218
    //   295: astore_1
    ...
    //   301: aload 4
    //   303: astore_1
    //   304: invokestatic 78	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   307: ifeq -89 -> 218
    //   310: aload_2
    //   311: invokevirtual 117	java/lang/Error:printStackTrace	()V
    //   314: aload 4
    //   316: astore_1
    //   317: goto -99 -> 218
    //   320: astore_1
