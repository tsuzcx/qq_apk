  ...
  extends BaseChatPie
{
  ...
  public DeviceMsgChatPie(QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, FragmentActivity paramFragmentActivity, Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new vpc(this);
  }
  ...
  private void m(Intent paramIntent)
  {
    ...
    do
    {
      ...
      paramIntent = DialogUtil.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 230, this.jdField_a_of_type_AndroidContentContext.getString(2131429763), this.jdField_a_of_type_AndroidContentContext.getString(2131429768), "不要", "要", new vpa(this, localArrayList, paramIntent), new vpb(this));
  ...
  protected void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    //   904: dup
    //   905: aload_0
    //   906: invokespecial 742	voy:<init>	(Lcom/tencent/mobileqq/activity/aio/rebuild/DeviceMsgChatPie;)V
    ...
    //   920: dup
    //   921: aload_0
    //   922: invokespecial 750	voz:<init>	(Lcom/tencent/mobileqq/activity/aio/rebuild/DeviceMsgChatPie;)V
  ...
  protected boolean a(boolean paramBoolean)
  {
    ...
    localObject1 = (ImageView)this.jdField_c_of_type_AndroidViewViewGroup.findViewById(2131363456);
    if (localObject1 != null) {
      ((ImageView)localObject1).setImageResource(2130838724);
    }
    for (localObject1 = (RelativeLayout)((ImageView)localObject1).getParent();; localObject1 = null)
    {
      Object localObject3 = (ImageView)this.jdField_c_of_type_AndroidViewViewGroup.findViewById(2131363979);
      if (localObject3 != null)
      {
        ((ImageView)localObject3).setVisibility(0);
        ((ImageView)localObject3).setImageResource(2130838723);
        ((ImageView)localObject3).setOnClickListener(new vox(this));
      }
      long l = Long.parseLong(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      ...
      for (int i = 1;; i = 0)
      {
        ...
        ((RelativeLayout.LayoutParams)localObject2).addRule(6, 2131363456);
        ((RelativeLayout.LayoutParams)localObject2).addRule(7, 2131363456);
        if (localObject1 != null)
        {
          ((RelativeLayout)localObject1).addView(this.jdField_n_of_type_AndroidWidgetImageView, (ViewGroup.LayoutParams)localObject2);
          this.jdField_n_of_type_AndroidWidgetImageView.setImageResource(2130845924);
        }
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if ((localProductInfo != null) && (bool1))
        {
          ...
          localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131437801);
          label380:
          if (!TextUtils.isEmpty((CharSequence)localObject1))
          {
            ...
            {
              localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131437827);
      ...
      for (;;)
      {
        ...
        break;
        label563:
        localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131437802);
        localObject1 = localObject2;
        if (localProductInfo.isSupportMainMsgType(1)) {
          localObject1 = (String)localObject2 + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131437795) + "、";
        }
        localObject2 = localObject1;
        if (localProductInfo.isSupportMainMsgType(2)) {
          localObject2 = (String)localObject1 + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131437796) + "、";
        }
        localObject1 = localObject2;
        if (localProductInfo.isSupportMainMsgType(8)) {
          localObject1 = (String)localObject2 + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131437799) + "、";
        }
        localObject2 = localObject1;
        if (localProductInfo.isSupportFuncMsgType(1)) {
          localObject2 = (String)localObject1 + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131437797) + "、";
        }
        localObject1 = localObject2;
        if (localProductInfo.isSupportFuncMsgType(2)) {
          localObject1 = (String)localObject2 + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131437798) + "、";
        }
        localObject2 = localObject1;
        if (((String)localObject1).endsWith("、")) {
          localObject2 = ((String)localObject1).substring(0, ((String)localObject1).length() - 1);
        }
        localObject1 = (String)localObject2 + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131437803);
        break label380;
        label905:
      ...
      if (localObject != null)
      {
        ...
        for (;;)
        {
          ...
          else if (((ProductInfo)localObject).isSupportMainMsgType(2))
          {
            if (((ProductInfo)localObject).isSupportFuncMsgType(3))
            {
              this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setHint(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131437039));
  ...
  public void ak()
  {
    ...
    if (this.jdField_a_of_type_ComTencentWidgetXEditTextEx.getText().length() > 0)
    {
      ...
      {
        ChatActivityUtils.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 2131433361, 1);
        return;
      }
    }
    for (;;)
  ...
  public void c(List paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if ((str != null) && (!"".equals(str)))
      {
        ...
        {
          localPicReq2.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoICompressionCallBack = new vpd(this);
  ...
  protected void o()
  {
    ...
    if ((this.jdField_n_of_type_Int == 1) || (this.jdField_n_of_type_Int == 3) || (this.jdField_n_of_type_Int == 9)) {
      if ((PanelIconLinearLayout)this.jdField_c_of_type_AndroidViewViewGroup.findViewById(2131363475) != null) {
        a(Integer.valueOf(4));
      }
    }
    label53:
  ...
  protected void u()
  {
    ...
    {
      a(this.jdField_a_of_type_AndroidWidgetImageView, 2130838724, 2130838724);
