...
public class PublicAccountChatPie$56
  implements Runnable
{
  public PublicAccountChatPie$56(aidp paramaidp) {}
  
  public void run()
  {
    bjhb localbjhb = (bjhb)this.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(85);
    if (!this.this$0.an) {
    ...
    {
      localObject = null;
      localbjhb.a(str1, str2, str3, str4, (String)localObject);
      this.this$0.a().runOnUiThread(new PublicAccountChatPie.56.1(this));
      localbjhb.a(this.this$0.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, this.this$0.j);
      return;
    }
  }
}
