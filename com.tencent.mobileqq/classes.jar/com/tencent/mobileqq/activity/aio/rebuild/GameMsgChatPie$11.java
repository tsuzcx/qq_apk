...
class GameMsgChatPie$11
  extends MessageObserver
{
  GameMsgChatPie$11(GameMsgChatPie paramGameMsgChatPie) {}
  ...
  protected void onUpdateSendMsgError(String paramString1, int paramInt1, int paramInt2, SendMessageHandler paramSendMessageHandler, long paramLong1, long paramLong2, String paramString2)
  {
    if (QLog.isColorLevel())
    {
      ...
      QLog.d("GameMsgChatPie", 2, paramString1.toString());
    }
    if (paramInt2 == 10012)
    {
    ...
    ThreadManager.getUIHandler().post(new GameMsgChatPie.11.1(this, paramString2));
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes4.jar
 * Qualified Name:     com.tencent.mobileqq.activity.aio.rebuild.GameMsgChatPie.11
