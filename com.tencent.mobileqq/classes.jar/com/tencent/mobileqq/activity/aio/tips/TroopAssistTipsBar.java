...
{
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new wag(this);
  public Toast a;
  ...
  private View.OnClickListener b = new wah(this);
  ...
  {
    paramVarArgs = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131436477);
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString) == 3) {
      paramVarArgs = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131436478);
    }
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    ...
    return;
    ThreadManager.post(new waf(this), 8, null, true);
  }
