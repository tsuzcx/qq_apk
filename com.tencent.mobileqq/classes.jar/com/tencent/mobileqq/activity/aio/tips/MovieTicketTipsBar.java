  ...
  implements TipsBarTask
{
  ...
  public View a(Object... paramVarArgs)
  {
    if (this.jdField_a_of_type_AndroidViewView == null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363104));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363102));
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130844211);
      this.jdField_a_of_type_AndroidViewView.setOnClickListener(new wik(this));
    }
