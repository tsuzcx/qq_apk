  ...
  implements View.OnClickListener, TipsBarTask
{
  ...
  public View a(Object... paramVarArgs)
  {
    ...
    {
      this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2131558657, null);
      paramVarArgs = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131370347);
      if (this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable != null)
      {
        paramVarArgs.setImageDrawable(this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable);
        paramVarArgs = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131370350);
        ...
        paramVarArgs.setContentDescription(this.jdField_a_of_type_JavaLangString + HardCodeUtil.a(2131706055));
        paramVarArgs.setOnClickListener(this);
        paramVarArgs = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131370349);
        if (AppSetting.d) {
          paramVarArgs.setContentDescription(HardCodeUtil.a(2131706054));
        }
        paramVarArgs.setOnClickListener(this);
      }
    }
      ...
      for (;;)
      {
        ...
        catch (Throwable localThrowable)
        {
          for (;;)
          {
            ...
            this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable = ((BitmapDrawable)this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130844957));
