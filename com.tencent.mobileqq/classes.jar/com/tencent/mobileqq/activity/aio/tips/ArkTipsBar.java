  ...
  implements TipsBarTask
{
  ...
  public View a(Object... paramVarArgs)
  {
    if (this.jdField_a_of_type_AndroidViewView == null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362947));
      this.jdField_a_of_type_AndroidViewView.setOnClickListener(new whu(this));
    }
  ...
  public void a(Drawable paramDrawable)
  {
    if (this.jdField_a_of_type_AndroidViewView != null)
    {
      ImageView localImageView = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362945);
