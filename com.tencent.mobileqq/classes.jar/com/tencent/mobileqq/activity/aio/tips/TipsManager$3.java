...
{
  TipsManager$3(TipsManager paramTipsManager) {}
  ...
  public void onAnimationEnd(Animation paramAnimation)
  {
    try
    {
      ...
      {
        paramAnimation = AnimationUtils.loadAnimation(BaseApplicationImpl.getContext(), 2130772277);
        paramAnimation.setInterpolator(new LinearInterpolator());
        this.a.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367257));
        this.a.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367258));
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.aio.tips.TipsManager.3
