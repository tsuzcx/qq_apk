  ...
  implements GrayTipsTask, TipsBarTask
{
  ...
  public QQOperateTips(QQAppInterface paramQQAppInterface, TipsManager paramTipsManager, Context paramContext, XPanelContainer paramXPanelContainer, List<QQOperationViopTipTask> paramList, SessionInfo paramSessionInfo, ChatAdapter1 paramChatAdapter1)
  {
  ...
  public View a(Object... paramVarArgs)
  {
    if ((paramVarArgs[0] instanceof QQOperationViopTipTask))
    {
      ...
      View localView = LayoutInflater.from((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).inflate(2131561082, null);
      TextView localTextView = (TextView)localView.findViewById(2131374585);
      Button localButton = (Button)localView.findViewById(2131374582);
  ...
  public void a(List<QQOperationViopTipTask> paramList)
  {
    ...
    for (;;)
    {
      ...
      if (paramList.hasNext())
      {
        ...
        localQQOperationViopTipTask = localQQOperateManager.a(i);
