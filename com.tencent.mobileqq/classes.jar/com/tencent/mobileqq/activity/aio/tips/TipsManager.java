  ...
  implements Handler.Callback, TipsConstants
{
  ...
  Animation.AnimationListener jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener = new wae(this);
  public Animation a;
  public ImageView a;
  ...
  public TipsManager(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, AIOTipsController paramAIOTipsController, XPanelContainer paramXPanelContainer, List paramList)
  {
    ...
    this.jdField_b_of_type_Int = DisplayUtil.a(BaseApplicationImpl.getContext(), 30.0F);
  ...
  {
    // Byte code:
    //   0: invokestatic 50	com/tencent/common/app/BaseApplicationImpl:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   3: ldc 85
    //   5: aconst_null
    //   6: invokestatic 91	android/view/View:inflate	(Landroid/content/Context;ILandroid/view/ViewGroup;)Landroid/view/View;
    //   9: checkcast 93	android/widget/RelativeLayout
    //   12: astore_1
    //   13: aload_0
    //   14: aload_1
    //   15: ldc 94
    //   17: invokevirtual 98	android/widget/RelativeLayout:findViewById	(I)Landroid/view/View;
    //   20: checkcast 100	com/tencent/image/URLImageView
    //   23: putfield 102	com/tencent/mobileqq/activity/aio/tips/TipsManager:jdField_a_of_type_ComTencentImageURLImageView	Lcom/tencent/image/URLImageView;
    //   26: aload_1
    //   27: astore_2
    //   28: new 104	java/io/File
    //   31: dup
    //   32: getstatic 110	com/tencent/biz/pubaccount/ecshopassit/EcShopAssistantManager:h	Ljava/lang/String;
    //   35: invokespecial 113	java/io/File:<init>	(Ljava/lang/String;)V
    //   38: invokevirtual 117	java/io/File:exists	()Z
    //   41: ifeq +62 -> 103
    ...
    //   52: iconst_2
    //   53: ldc 126
    //   55: invokestatic 130	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   58: new 132	java/net/URL
    //   61: dup
    //   62: new 134	java/lang/StringBuilder
    //   65: dup
    //   66: invokespecial 135	java/lang/StringBuilder:<init>	()V
    //   69: ldc 137
    //   71: invokevirtual 141	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   74: getstatic 110	com/tencent/biz/pubaccount/ecshopassit/EcShopAssistantManager:h	Ljava/lang/String;
    //   77: invokevirtual 141	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   80: invokevirtual 145	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   83: invokespecial 146	java/net/URL:<init>	(Ljava/lang/String;)V
    //   86: invokestatic 152	com/tencent/image/URLDrawable$URLDrawableOptions:obtain	()Lcom/tencent/image/URLDrawable$URLDrawableOptions;
    //   89: invokestatic 158	com/tencent/image/URLDrawable:getDrawable	(Ljava/net/URL;Lcom/tencent/image/URLDrawable$URLDrawableOptions;)Lcom/tencent/image/URLDrawable;
    //   92: astore_2
    //   93: aload_0
    //   94: getfield 102	com/tencent/mobileqq/activity/aio/tips/TipsManager:jdField_a_of_type_ComTencentImageURLImageView	Lcom/tencent/image/URLImageView;
    //   97: aload_2
    //   98: invokevirtual 162	com/tencent/image/URLImageView:setImageDrawable	(Landroid/graphics/drawable/Drawable;)V
    //   101: aload_1
    //   102: astore_2
    //   103: aload_2
    //   104: areturn
    ...
    //   107: astore_1
    //   108: aload_3
    //   109: invokevirtual 165	java/net/MalformedURLException:printStackTrace	()V
    //   112: aload_1
    //   113: astore_2
    //   114: invokestatic 122	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   117: ifeq -14 -> 103
    //   120: ldc 124
    //   122: iconst_2
    //   123: new 134	java/lang/StringBuilder
    //   126: dup
    //   127: invokespecial 135	java/lang/StringBuilder:<init>	()V
    //   130: ldc 167
    //   132: invokevirtual 141	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   135: aload_3
    //   136: invokevirtual 170	java/net/MalformedURLException:getMessage	()Ljava/lang/String;
    ...
    //   145: invokestatic 130	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   148: aload_1
    //   149: areturn
    //   150: astore_1
    //   151: aconst_null
  ...
  public void a()
  {
    ...
    wad localwad = new wad(this);
    this.jdField_a_of_type_MqqOsMqqHandler.post(localwad);
  }
  ...
  public void a(View.OnClickListener paramOnClickListener)
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout == null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setId(2131362325);
    }
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(paramOnClickListener);
    if (this.jdField_b_of_type_AndroidWidgetRelativeLayout == null) {
      this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_ComTencentWidgetXPanelContainer.findViewById(2131363474));
    }
  ...
  public boolean a(TipsBarTask paramTipsBarTask, Object... paramVarArgs)
  {
    ...
    while (!QLog.isColorLevel())
    {
      ...
      for (;;)
      {
        ...
        return true;
        paramVarArgs = new wac(this, paramTipsBarTask, paramVarArgs);
  ...
  public void c()
  {
    ...
    View localView2 = this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131368210);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        int k = BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131558448);
        if (i == -1) {
  ...
  public void d()
  {
    ...
    try
    {
      if ((this.jdField_b_of_type_AndroidWidgetRelativeLayout != null) && (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null) && (this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131362325) != null))
      {
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(null);
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.clearAnimation();
        this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131363211));
        this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131363212));
