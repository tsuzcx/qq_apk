  ...
  implements View.OnClickListener, TipsBarTask
{
  ...
  {
    paramVarArgs = LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2131560721, null);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramVarArgs.findViewById(2131379381));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramVarArgs.findViewById(2131368603));
    ArrayList localArrayList = new ArrayList();
    localArrayList.add((ImageView)paramVarArgs.findViewById(2131363197));
    localArrayList.add((ImageView)paramVarArgs.findViewById(2131363199));
    localArrayList.add((ImageView)paramVarArgs.findViewById(2131363201));
  ...
  protected void a(TroopManager paramTroopManager, TipsManager paramTipsManager, TroopMemberInfo paramTroopMemberInfo)
  {
    ...
    if (this.jdField_a_of_type_TencentImOidbCmd0xb36Oidb_cmd0xb36$ToastInfo.type.has())
    {
      ...
      paramTipsManager.mRequestWidth = DisplayUtil.b(this.jdField_a_of_type_AndroidAppActivity, 32.0F);
    ...
    while (paramTroopManager.hasNext())
    {
      ...
      if (paramTipsManager != null)
      {
        ...
        paramTroopManager = ImageUtil.c();
        paramTipsManager = FaceDrawable.getFaceDrawable(PlayModeUtils.a(), 1, String.valueOf(localList.get(i)), 3, paramTroopManager, paramTroopManager);
        if (paramTipsManager == null) {}
        for (;;)
        {
