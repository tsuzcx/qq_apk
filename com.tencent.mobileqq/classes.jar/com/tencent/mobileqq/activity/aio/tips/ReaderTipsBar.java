  ...
  implements TipsBarTask
{
  ...
  {
    paramVarArgs = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558692, null);
    paramVarArgs.setOnClickListener(new ReaderTipsBar.1(this));
    ((TextView)paramVarArgs.findViewById(2131362576)).setText(this.jdField_a_of_type_JavaLangString);
    return paramVarArgs;
  }
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    ...
    do
    {
      ...
      return;
      this.jdField_a_of_type_JavaLangString = String.format(HardCodeUtil.a(2131712677), new Object[] { str });
