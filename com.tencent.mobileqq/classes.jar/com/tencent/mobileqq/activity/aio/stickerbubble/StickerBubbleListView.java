  ...
  implements agsz, agtf
{
  ...
  {
    super(paramContext);
    this.jdField_a_of_type_Agte = new agte(this, this, afsw.b(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
    this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie = paramBaseChatPie;
  }
  
  private void a(float paramFloat1, float paramFloat2, agtd paramagtd)
  {
    int i = 0;
    for (;;)
    {
      if (i < getChildCount())
      {
        ...
        if ((localView instanceof StickerBubbleLinearLayout))
        {
          ...
          if (((localView instanceof LinearLayout)) && (((LinearLayout)localView).getChildAt(0) != null)) {
            paramagtd.a(((LinearLayout)localView).getChildAt(0));
          }
        }
      }
      return;
  ...
  public int a(float paramFloat1, float paramFloat2)
  {
    ...
    arrayOfInt[0] = -1;
    a(paramFloat1, paramFloat2, new agtb(this, arrayOfInt));
    return arrayOfInt[0];
  }
  ...
  {
    a(paramFloat1, paramFloat2, new agtc(this));
  }
  
  public void a(float paramFloat1, float paramFloat2, int paramInt1, int paramInt2)
  {
    Object localObject = agso.a(paramInt1);
    if (localObject == null) {}
    StickerBubbleAnimationView localStickerBubbleAnimationView;
    do
    {
      return;
      localObject = ((agsn)localObject).jdField_a_of_type_JavaLangString;
      localStickerBubbleAnimationView = agsw.a().a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.d, getContext());
    ...
    localStickerBubbleAnimationView.a(agsp.a(new Point((int)paramFloat1, (int)paramFloat2), (String)localObject, paramInt2));
  }
  
  public void a(int paramInt1, int paramInt2)
  {
    agsw.a().d(getContext()).a();
    agsn localagsn = agso.a(paramInt1);
    if (localagsn != null)
    {
      ...
      ThreadManager.post(new StickerBubbleListView.2(this, localagsn, paramInt2), 10, null, false);
      azmj.b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(), "dc00898", "", this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "0X8009222", "0X8009222", localagsn.jdField_a_of_type_Int, 0, Integer.toString(paramInt2), "", "", "");
    }
  }
  ...
  {
    boolean bool2 = this.jdField_a_of_type_Agte.a(paramMotionEvent);
    boolean bool1 = bool2;
    if (!bool2) {
