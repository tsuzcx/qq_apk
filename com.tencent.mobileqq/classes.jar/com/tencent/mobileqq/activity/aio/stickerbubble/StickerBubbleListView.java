  ...
  implements aevu, aewa
{
  ...
  {
    super(paramContext);
    this.jdField_a_of_type_Aevz = new aevz(this, this, adwj.b(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
    this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie = paramBaseChatPie;
  }
  
  private void a(float paramFloat1, float paramFloat2, aevy paramaevy)
  {
    int i = 0;
    for (;;)
    {
      if (i < getChildCount())
      {
        ...
        if ((localView instanceof StickerBubbleLinearLayout))
        {
          ...
          if (((localView instanceof LinearLayout)) && (((LinearLayout)localView).getChildAt(0) != null)) {
            paramaevy.a(((LinearLayout)localView).getChildAt(0));
          }
        }
      }
      return;
  ...
  public int a(float paramFloat1, float paramFloat2)
  {
    ...
    arrayOfInt[0] = -1;
    a(paramFloat1, paramFloat2, new aevw(this, arrayOfInt));
    return arrayOfInt[0];
  }
  ...
  {
    a(paramFloat1, paramFloat2, new aevx(this));
  }
  
  public void a(float paramFloat1, float paramFloat2, int paramInt1, int paramInt2)
  {
    Object localObject = aevj.a(paramInt1);
    if (localObject == null) {}
    StickerBubbleAnimationView localStickerBubbleAnimationView;
    do
    {
      return;
      localObject = ((aevi)localObject).jdField_a_of_type_JavaLangString;
      localStickerBubbleAnimationView = aevr.a().a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.d, getContext());
    ...
    localStickerBubbleAnimationView.a(aevk.a(new Point((int)paramFloat1, (int)paramFloat2), (String)localObject, paramInt2));
  }
  
  public void a(int paramInt1, int paramInt2)
  {
    aevr.a().d(getContext()).a();
    aevi localaevi = aevj.a(paramInt1);
    if (localaevi != null)
    {
  ...
  {
    boolean bool2 = this.jdField_a_of_type_Aevz.a(paramMotionEvent);
    boolean bool1 = bool2;
    if (!bool2) {
