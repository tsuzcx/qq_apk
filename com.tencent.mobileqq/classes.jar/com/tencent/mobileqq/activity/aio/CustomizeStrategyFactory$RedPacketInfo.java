  ...
  extends RedPacketInfoBase
{
  ...
  public boolean a()
  {
    ...
    if ((this.b) && (this.jdField_a_of_type_ArrayOfAndroidGraphicsDrawableDrawable != null) && (this.jdField_a_of_type_ArrayOfAndroidGraphicsDrawableDrawable.length > 0) && (this.jdField_a_of_type_Afad != null) && (this.jdField_a_of_type_Afad.b > 0))
    {
    ...
    for (Object localObject1 = Integer.valueOf(this.jdField_a_of_type_ArrayOfAndroidGraphicsDrawableDrawable.length);; localObject1 = null)
    {
      ...
      if (this.jdField_a_of_type_Afad != null) {
        localObject1 = Integer.valueOf(this.jdField_a_of_type_Afad.b);
      }
