  ...
  implements Handler.Callback
{
  ...
  private static AIOPreLoadEngine jdField_a_of_type_ComTencentMobileqqActivityAioAIOPreLoadEngine;
  ...
  static
  {
    ...
    jdField_a_of_type_ComTencentMobileqqActivityAioAIOPreLoadEngine = new AIOPreLoadEngine();
    a();
  }
  ...
  private void a(Activity paramActivity)
  {
    ...
    if ((paramActivity != null) && ((paramActivity instanceof SplashActivity)))
    {
      if ((jdField_a_of_type_Int == 1) || (ChatFragment.jdField_a_of_type_Boolean)) {
        if (QLog.isColorLevel()) {
          QLog.e("Q.aio.AIOPreLoadEngine", 2, "sPreloadedAIOType:" + jdField_a_of_type_Int + "|AIO_HAD_OPEN:" + ChatFragment.jdField_a_of_type_Boolean);
        }
      }
      do
      {
