...
public class IntimateContentItemMutualMarkView$1
  implements Runnable
{
  ...
  public void run()
  {
    ...
    Object localObject2 = bhdb.a((String)localObject3);
    Object localObject1;
    ...
    else
    {
      ...
      bhdb.a(str, (Bitmap)localObject2);
    }
