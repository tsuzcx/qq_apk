  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    localObject2 = BitmapFactory.decodeResource(localBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources(), 2130849208, (BitmapFactory.Options)localObject2);
    float f;
    int j;
    int k;
    if (localObject2 != null)
    {
      i = aekt.a(((Bitmap)localObject2).getHeight() / 2, localBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources());
      ...
      j = aekt.a(36.0F, localBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources());
