  ...
  implements Runnable
{
  ...
  public void run()
  {
    if (AIOTroopQcircleRedDotManager.a()) {
      AIOTroopQcircleRedDotManager.a().b(this.this$0.jdField_a_of_type_ComTencentMobileqqActivityAioCoreTroopChatPie.d(), this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreTroopChatPie, this.jdField_a_of_type_JavaUtilList);
    }
    if (AIOTroopQcircleRedDotManager.b()) {
      AIOTroopQcircleRedDotManager.a().b(this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreTroopChatPie, this.jdField_a_of_type_JavaUtilList);
    }
  }
}
