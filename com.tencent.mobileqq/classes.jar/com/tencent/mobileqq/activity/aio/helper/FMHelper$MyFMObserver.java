  ...
  extends FMObserver
{
  ...
  protected void a(ThumbnailInfo paramThumbnailInfo)
  {
    ...
    if ((paramThumbnailInfo.c instanceof FileManagerEntity))
    {
      ...
      if ((paramThumbnailInfo.d != null) && (paramThumbnailInfo.d.length() > 0))
      {
        ...
        FMHelper.b(this.a).getFileManagerDataCenter().c(localFileManagerEntity);
        FMHelper.a(this.a).bt();
        return;
      }
  ...
  protected void a(boolean paramBoolean, long paramLong1, long paramLong2, String paramString1, int paramInt1, int paramInt2, String paramString2)
  {
    ...
    paramString1 = FMHelper.b(this.a).getFileManagerDataCenter().a(paramLong2);
    if ((paramString1 != null) && (paramString1.nOpType == 6))
    {
      if (((IWeiyunResponseHandler)QRoute.api(IWeiyunResponseHandler.class)).endSave2Weiyun(paramInt2)) {
        if (paramBoolean)
        {
          ((IWeiyunSaveTipsHelper)QRoute.api(IWeiyunSaveTipsHelper.class)).showTopTips(FMHelper.b(this.a), FMHelper.a(this.a).aX(), AIOUtils.a(FMHelper.a(this.a).e));
        }
        else if (((IWeiyunResponseHandler)QRoute.api(IWeiyunResponseHandler.class)).needShowGrayTips())
        {
          ((IWeiyunResponseHandler)QRoute.api(IWeiyunResponseHandler.class)).showGrayTips(FMHelper.b(this.a));
        }
        else
        {
          if (!TextUtils.isEmpty(paramString2)) {
            QQToast.makeText(FMHelper.b(this.a).getApp(), paramString2, 1).show(AIOUtils.a(FMHelper.a(this.a).e));
          } else {
            QQToast.makeText(FMHelper.b(this.a).getApp(), 2131889760, 1).show(AIOUtils.a(FMHelper.a(this.a).e));
          }
          ((IOpenWeiyunVipHelper)QRoute.api(IOpenWeiyunVipHelper.class)).showWeiYunSpaceOrFlowLimitDialog(null, paramInt2);
        }
      }
    }
    else if ((!paramBoolean) && (paramString1 != null) && (!TextUtils.isEmpty(paramString1.peerUin)) && (paramString1.peerUin.equalsIgnoreCase(FMHelper.a(this.a).ah.b)))
    {
