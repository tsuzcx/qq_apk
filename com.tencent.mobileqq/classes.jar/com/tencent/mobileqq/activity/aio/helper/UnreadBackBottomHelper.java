  ...
  implements ILifeCycleHelper
{
  ...
  private boolean a(BaseChatPie paramBaseChatPie)
  {
    ...
    {
      boolean bool4 = Utils.b(localSessionInfo.jdField_a_of_type_JavaLangString);
      boolean bool5 = RobotUtils.b(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localSessionInfo.jdField_a_of_type_JavaLangString);
      bool2 = bool1;
      if (!bool4)
      {
        bool2 = bool1;
  ...
  private void c()
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie != null) && (this.jdField_a_of_type_AndroidWidgetTextView == null)) {
        this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.aa();
      }
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130838483);
      if (QLog.isColorLevel()) {
        QLog.d("UnreadBackBottomHelper", 2, "resume button to unread mode");
      }
      if (AppSetting.d) {
        this.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(HardCodeUtil.a(2131690042) + this.jdField_a_of_type_Int + HardCodeUtil.a(2131690043));
      }
    }
  }
  ...
  {
    if (!this.jdField_a_of_type_Boolean) {}
    while ((this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView == null) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView == null)) {
      return;
    }
      ...
      if (Math.abs(paramInt) >= 20) {
        ...
        else if ((this.jdField_a_of_type_AndroidWidgetTextView != null) && (this.jdField_a_of_type_Int == 0) && (!this.jdField_c_of_type_Boolean) && (!this.jdField_b_of_type_Boolean))
        {
          ...
          for (;;)
          {
            ...
            this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130838080);
            this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
            if (AppSetting.d) {
              this.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(HardCodeUtil.a(2131690042));
            }
            if (this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie == null) {
              break;
            }
  ...
  public void onClick(View paramView)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie != null)
    {
      paramView = this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo;
      if (paramView != null)
      {
