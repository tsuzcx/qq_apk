  ...
  implements ILifeCycleHelper
{
  ...
  public void onMoveToState(int paramInt)
  {
    ...
    if (l > 0L)
    {
      localChatMessage = ((ForwardMsgManager)this.a.a.getManager(QQManagerFactory.FORWARD_MSG_MANAGER)).a(l);
    ...
    try
    {
      ...
      if (l > 0L)
      {
        ...
        if ((localObject2 != null) && (!TextUtils.isEmpty(((TroopInfo)localObject2).getTroopDisplayName()))) {
