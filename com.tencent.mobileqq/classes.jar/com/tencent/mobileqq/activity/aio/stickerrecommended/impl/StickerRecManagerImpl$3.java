  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      Object localObject1 = (StickerRecommendEntity)StickerRecManagerImpl.access$000(this.this$0).find(StickerRecommendEntity.class, "usrMessage=? AND recommendType==1", new String[] { this.jdField_a_of_type_JavaLangString });
      Object localObject2;
      ...
      int i = StickerRecManagerImpl.access$100(this.this$0, this.jdField_a_of_type_Int);
      if ((localObject1 != null) && (System.currentTimeMillis() - ((StickerRecommendEntity)localObject1).cachedTime < 86400000L))
      {
        ...
        localObject2 = (StickerRecommendSortEntity)StickerRecManagerImpl.access$000(this.this$0).find(StickerRecommendSortEntity.class, "usrMessage=? AND recommendType==1", new String[] { this.jdField_a_of_type_JavaLangString });
        if (localObject2 != null) {
          ((StickerRecommendSortEntity)localObject2).convertToList();
        }
        StickerRecManagerImpl.access$200(this.this$0, (byte[])localObject1, this.jdField_a_of_type_JavaLangString, "cache", false, (StickerRecommendSortEntity)localObject2, 1, i);
        return;
      }
      ...
      StickerRecManagerImpl.access$000(this.this$0).delete(StickerRecommendSortEntity.class.getSimpleName(), "usrMessage=? AND recommendType=1", new String[] { this.jdField_a_of_type_JavaLangString });
      localObject1 = this.this$0;
      ((StickerRecManagerImpl)localObject1).sendScenesPullPicsRequest(StickerRecManagerImpl.access$300((StickerRecManagerImpl)localObject1).getCurrentUin(), 3, i, this.b, this.jdField_a_of_type_ComTencentMobileqqActivityAioStickerrecommendedScenesrecommendScenesRecommendItem);
    }
  }
}
