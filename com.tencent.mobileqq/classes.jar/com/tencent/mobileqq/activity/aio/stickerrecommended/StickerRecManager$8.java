...
public class StickerRecManager$8
  implements Runnable
{
  public StickerRecManager$8(aemi paramaemi, List paramList) {}
  ...
  public void run()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      StickerRecCacheEntity localStickerRecCacheEntity2 = (StickerRecCacheEntity)aemi.a(this.this$0).a(StickerRecCacheEntity.class, "md5=?", new String[] { localStickerRecCacheEntity1.md5 });
      if (localStickerRecCacheEntity2 != null)
      {
        ...
        aemi.a(this.this$0).a(localStickerRecCacheEntity2);
      }
      else
      {
        if (QLog.isColorLevel()) {
        ...
        aemi.a(this.this$0).b(localStickerRecCacheEntity1);
      }
    }
  }
}
