...
public class StickerRecManager$10
  implements Runnable
{
  public StickerRecManager$10(aijp paramaijp) {}
  
  public void run()
  {
    int i = 0;
    Object localObject = new File(aiji.a);
    long l1 = 0L;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        Iterator localIterator = aijp.a(this.this$0).query(StickerRecCacheEntity.class, StickerRecCacheEntity.class.getSimpleName(), false, "lastTime<?", (String[])localObject, "", "", "", "").iterator();
    ...
    return;
    aijp.a(this.this$0).delete(StickerRecCacheEntity.class.getSimpleName(), "lastTime<?", localException);
  }
}
