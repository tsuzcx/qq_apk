  ...
  extends BaseLocalStickerRecEmoticon
{
  ...
  public String a()
  {
    ...
    {
      bool = ((EmojiManager)((AppRuntime)localObject).getManager(QQManagerFactory.CHAT_EMOTION_MANAGER)).c(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon);
      if (!this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.isAPNG) {
        break label137;
      }
  ...
  {
    ((EmoticonManager)paramQQAppInterface.getManager(QQManagerFactory.EMOTICON_MANAGER)).a(this);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqDataEmoticon != null) && (this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.isNewSoundEmoticon())) {
      EmoticonManager.a(paramQQAppInterface, "0X800A932", paramSessionInfo.a, this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId);
    }
    ((EmoticonManager)paramQQAppInterface.getManager(QQManagerFactory.EMOTICON_MANAGER)).b(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon);
  }
