...
class StickerRecManager$9
  implements Runnable
{
  StickerRecManager$9(StickerRecManager paramStickerRecManager, List paramList) {}
  ...
  public void run()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      StickerRecCacheEntity localStickerRecCacheEntity2 = (StickerRecCacheEntity)StickerRecManager.a(this.this$0).find(StickerRecCacheEntity.class, "md5=?", new String[] { localStickerRecCacheEntity1.md5 });
      if (localStickerRecCacheEntity2 != null)
      {
        ...
        StickerRecManager.a(this.this$0).update(localStickerRecCacheEntity2);
      }
      else
      {
        if (QLog.isColorLevel()) {
        ...
        StickerRecManager.a(this.this$0).persistOrReplace(localStickerRecCacheEntity1);
      }
    }
  }
}
