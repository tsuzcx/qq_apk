...
public class StickerRecManager$9
  implements Runnable
{
  public StickerRecManager$9(ahns paramahns, List paramList) {}
  ...
  public void run()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      StickerRecCacheEntity localStickerRecCacheEntity2 = (StickerRecCacheEntity)ahns.a(this.this$0).find(StickerRecCacheEntity.class, "md5=?", new String[] { localStickerRecCacheEntity1.md5 });
      if (localStickerRecCacheEntity2 != null)
      {
        ...
        ahns.a(this.this$0).update(localStickerRecCacheEntity2);
      }
      else
      {
        if (QLog.isColorLevel()) {
        ...
        ahns.a(this.this$0).persistOrReplace(localStickerRecCacheEntity1);
      }
    }
  }
}
