  ...
  implements URLDrawable.URLDrawableListener
{
  ...
  {
    StickerDrawableDownloader.b(this.a).remove(paramURLDrawable);
  ...
  public void onLoadSuccessed(URLDrawable paramURLDrawable)
  {
    ...
    StickerDrawableDownloader.b(this.a).remove(paramURLDrawable);
    if (StickerDrawableDownloader.c(this.a) != null) {
      StickerDrawableDownloader.c(this.a).a(StickerDrawableDownloader.d(this.a));
    }
    if (QLog.isColorLevel()) {
