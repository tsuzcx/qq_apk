...
class QQWalletHbItemUtils$4
  implements View.OnClickListener
{
  QQWalletHbItemUtils$4(QQWalletHbItemUtils paramQQWalletHbItemUtils) {}
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if (this.a.jdField_a_of_type_ComTencentMobileqqActivityQwalletTroopUnAccalimedRedPacketList$HbItemClickListener != null) {
        this.a.jdField_a_of_type_ComTencentMobileqqActivityQwalletTroopUnAccalimedRedPacketList$HbItemClickListener.a(8);
      }
      ...
      if (QWalletRedPkgUtils.a(QQWalletHbItemUtils.jdField_a_of_type_Long, l))
      {
        ...
        {
          ((PasswdRedBagManager)localObject2).a(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, 8);
        ...
        else
        {
          if (this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1)
          {
            ...
            {
              ((PasswdRedBagManager)localObject2).b(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, 8);
              if (!QLog.isColorLevel()) {
                continue;
              }
          ...
          if ((localObject3 != null) && ((((PasswdRedBagInfo)localObject3).jdField_a_of_type_Boolean) || (((PasswdRedBagInfo)localObject3).b) || (((PasswdRedBagInfo)localObject3).c) || (((PasswdRedBagInfo)localObject3).jdField_a_of_type_Long < l)))
          {
            ...
            ((Bundle)localObject4).putString("feedsid", VoiceRedPacketHelper.a(localMessageForQQWalletMsg));
            ((PasswdRedBagManager)localObject2).a(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, (PasswdRedBagInfo)localObject3, l, 131072, (String)localObject1, localMessageForQQWalletMsg.mQQWalletRedPacketMsg.elem.skinId, localMessageForQQWalletMsg.fromHBList, (Bundle)localObject4);
            if (QLog.isColorLevel()) {
          ...
          else
          {
            ...
            PublicFragmentActivity.Launcher.a(paramView.getContext(), (Intent)localObject2, PublicTransFragmentActivity.class, RedPacketKSongFragment.class);
            if (QLog.isColorLevel()) {
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.aio.qwallet.QQWalletHbItemUtils.4
