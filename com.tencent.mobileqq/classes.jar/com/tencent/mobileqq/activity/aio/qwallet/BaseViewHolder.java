  ...
  implements IFBaseViewHolder
{
  ...
  protected int h;
  protected int i;
  protected int j = 2130847608;
  protected int k;
  
  public BaseViewHolder(QQAppInterface paramQQAppInterface, QWalletMsgHolder paramQWalletMsgHolder, QQWalletBaseMsgElem paramQQWalletBaseMsgElem, int paramInt, CustomizeStrategyFactory.OnCustomizeListener paramOnCustomizeListener)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqDataQQWalletBaseMsgElem = null;
  ...
  public void b()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        Object localObject1 = (RelativeLayout.LayoutParams)this.jdField_a_of_type_ComTencentMobileqqActivityAioQwalletQWalletMsgHolder.c.getLayoutParams();
        ...
        localObject2 = this.jdField_a_of_type_ComTencentMobileqqActivityAioQwalletQWalletMsgHolder.c.getChildAt(0);
        localObject1 = BaseApplicationImpl.getApplication().getApplicationContext().getResources().getDrawable(2130847598);
        long l2 = 0L;
        ...
        ((RoundImageView)localObject2).setImageDrawable(QWalletPicHelperImpl.getDrawableForAIO(this.jdField_a_of_type_ComTencentMobileqqActivityAioCustomizeStrategyFactory$RedPacketInfo.background, (Drawable)localObject1));
        l1 = l2;
        if (QQWalletMsgItemBuilder.a != null)
        {
          l1 = l2;
          if (!QQWalletMsgItemBuilder.a.isEmpty())
          {
            l1 = l2;
            if (QQWalletMsgItemBuilder.a.containsKey(Integer.valueOf(this.h))) {
              l1 = ((Long)QQWalletMsgItemBuilder.a.get(Integer.valueOf(this.h))).longValue();
            }
          }
        }
        ...
        ReportController.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "wrap.aio.show", 0, 0, "" + this.h, "", "", "");
        if (QQWalletMsgItemBuilder.a == null) {
          continue;
        }
        QQWalletMsgItemBuilder.a.put(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg, Long.valueOf(NetConnInfoCenter.getServerTimeMillis()));
        return;
      }
      ...
      if (QLog.isColorLevel())
      {
        ...
        if (Build.VERSION.SDK_INT >= 18) {
          ((RoundImageView)localObject2).setmRadius(UIUtils.a(this.jdField_a_of_type_AndroidContentContext, 4.0F), false);
        }
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioCustomizeStrategyFactory$RedPacketInfo != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioCustomizeStrategyFactory$RedPacketInfo.background != null))
        {
          localDrawable = QWalletPicHelperImpl.getDrawableForAIO(this.jdField_a_of_type_ComTencentMobileqqActivityAioCustomizeStrategyFactory$RedPacketInfo.background, localThrowable);
          if (Build.VERSION.SDK_INT < 16)
          {
            this.jdField_a_of_type_ComTencentMobileqqActivityAioQwalletQWalletMsgHolder.c.setBackgroundDrawable(localDrawable);
            if ((QQWalletMsgItemBuilder.a == null) || (QQWalletMsgItemBuilder.a.isEmpty()) || (!QQWalletMsgItemBuilder.a.containsKey(Integer.valueOf(this.h)))) {
              break label647;
            }
          }
        }
        for (l1 = ((Long)QQWalletMsgItemBuilder.a.get(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg)).longValue();; l1 = 0L)
        {
          if ((NetConnInfoCenter.getServerTimeMillis() - l1 <= 500L) || (this.h <= 0) || ((this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg.messageType != 2) && (this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg.messageType != 3))) {
            break label650;
          }
          ...
          QQWalletMsgItemBuilder.a.put(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg, Long.valueOf(NetConnInfoCenter.getServerTimeMillis()));
          return;
          this.jdField_a_of_type_ComTencentMobileqqActivityAioQwalletQWalletMsgHolder.c.setBackground(localDrawable);
          break;
          this.jdField_a_of_type_ComTencentMobileqqActivityAioQwalletQWalletMsgHolder.c.setBackgroundResource(2130847598);
          return;
        }
      }
    }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqActivityAioQwalletQWalletMsgHolder.jdField_b_of_type_AndroidWidgetTextView.setText(IFBaseViewHolder.jdField_a_of_type_JavaLangString);
          return false;
        }
  ...
  public void c()
  {
    ...
    while (this.jdField_a_of_type_ComTencentMobileqqActivityAioQwalletQWalletMsgHolder.f.getChildCount() == 0) {
      return;
    }
    this.jdField_a_of_type_ComTencentMobileqqActivityAioQwalletQWalletMsgHolder.f.removeAllViews();
  }
  ...
  public void f()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqDataQQWalletBaseMsgElem != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqDataQQWalletBaseMsgElem.title)))
    {
      ...
      int n = StringUtil.a(this.jdField_a_of_type_ComTencentMobileqqDataQQWalletBaseMsgElem.title);
      int m = 18;
      if (n <= 8)
      {
        n = this.f / 4;
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityAioQwalletQWalletMsgHolder.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqDataQQWalletBaseMsgElem.title);
      return;
    }
    this.jdField_a_of_type_ComTencentMobileqqActivityAioQwalletQWalletMsgHolder.jdField_a_of_type_AndroidWidgetTextView.setText("");
  }
