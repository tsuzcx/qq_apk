  ...
  implements URLDrawableDownListener
{
  ...
  private View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new uyv(this);
  private long jdField_c_of_type_Long;
  private View.OnClickListener jdField_c_of_type_AndroidViewView$OnClickListener = new uyx(this);
  public boolean c;
  ...
  public ApolloItemBuilder(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new uyw(this);
  }
  ...
  private AnimationDrawable a(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      ...
      localAnimationDrawable.addFrame(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130837998), 200);
      localAnimationDrawable.addFrame(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130837999), 100);
      localAnimationDrawable.addFrame(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130838000), 200);
      localAnimationDrawable.addFrame(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130837999), 100);
      localAnimationDrawable.addFrame(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130837998), 300);
      localAnimationDrawable.addFrame(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130838001), 100);
      localAnimationDrawable.addFrame(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130838002), 200);
      localAnimationDrawable.addFrame(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130838001), 140);
    ...
    localAnimationDrawable.addFrame(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130837982), 200);
    localAnimationDrawable.addFrame(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130837983), 100);
    localAnimationDrawable.addFrame(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130837984), 200);
    localAnimationDrawable.addFrame(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130837983), 100);
    localAnimationDrawable.addFrame(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130837982), 300);
    localAnimationDrawable.addFrame(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130837985), 100);
    localAnimationDrawable.addFrame(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130837986), 200);
    localAnimationDrawable.addFrame(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130837985), 140);
    localAnimationDrawable.selectDrawable(0);
    localAnimationDrawable.setOneShot(false);
    return localAnimationDrawable;
  }
      ...
      if ((paramMessageForApollo != null) && (this.jdField_d_of_type_Boolean))
      {
        ...
        else
        {
          ...
          if (paramHolder.d == null)
          {
            ...
            ((ImageView)localObject).setImageResource(2130844024);
        ...
        while (paramHolder.jdField_b_of_type_Int != paramHolder.jdField_c_of_type_Int - 1)
        {
          ...
          ThreadManager.post(new uyq(this, paramMessageForApollo, paramBaseChatItemLayout, paramHolder), 5, null, true);
          break label795;
        }
        if (this.f) {
          e();
  ...
  {
    ThreadManager.post(new uys(paramQQAppInterface, paramContext, paramApolloFavActionData, paramSessionInfo), 5, null, true);
  }
  ...
  private void a(MessageForApollo paramMessageForApollo)
  {
    ...
    {
      localApolloBaseInfo = localApolloManager.a(paramMessageForApollo.senderuin);
    ...
    else
    {
      ...
      {
        localApolloBaseInfo = localApolloManager.a(paramMessageForApollo.mApolloMessage.peer_uin + "");
        l1 = l2;
        if (localApolloBaseInfo != null) {
          l1 = localApolloBaseInfo.apolloUpdateTime;
        }
  ...
  {
    new Handler(Looper.getMainLooper()).post(new uyt(paramContext, paramInt, paramString));
  }
  ...
  private boolean a(MessageForApollo paramMessageForApollo)
  {
    ...
    do
    {
      ...
      paramMessageForApollo = ((ApolloManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(152)).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
  ...
  private AnimationDrawable b(boolean paramBoolean)
  {
    ...
    {
      localAnimationDrawable = new AnimationDrawable();
      localAnimationDrawable.addFrame(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130837992), 700);
      localAnimationDrawable.addFrame(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130837996), 200);
      localAnimationDrawable.addFrame(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130837993), 200);
    ...
    new AnimationDrawable();
    AnimationDrawable localAnimationDrawable = new AnimationDrawable();
    localAnimationDrawable.addFrame(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130837987), 700);
    localAnimationDrawable.addFrame(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130837991), 200);
    localAnimationDrawable.addFrame(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130837988), 200);
  ...
  private void b(ApolloItemBuilder.Holder paramHolder, boolean paramBoolean)
  {
    ...
    ((ImageView)localObject).setImageResource(2130838602);
  ...
  public View a(int paramInt1, int paramInt2, ChatMessage paramChatMessage, View paramView, ViewGroup paramViewGroup, OnLongClickAndTouchListener paramOnLongClickAndTouchListener)
  {
    ...
    paramOnLongClickAndTouchListener = paramChatMessage.getDrawable(2130838092);
  ...
  public void a(int paramInt, MessageForApollo paramMessageForApollo)
  {
    ...
    {
      a(this.jdField_a_of_type_AndroidContentContext.getString(2131438217), 1, this.jdField_a_of_type_AndroidContentContext);
      return;
    }
    ...
    for (localObject2 = "1";; localObject2 = "0")
    {
      ...
      paramMessageForApollo.c(2131438210);
  ...
  protected void a(View paramView)
  {
    ...
    if (paramView.jdField_a_of_type_ComTencentMobileqqDataChatMessage.isSend())
    {
      ...
      if (paramView.jdField_a_of_type_ComTencentMobileqqDataChatMessage.sendFailCode == ApolloConstant.jdField_a_of_type_Int)
      {
        ...
        localObject = ((ApolloManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(152)).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
        ...
        localActionSheet.a(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131438227));
        localActionSheet.a(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131438230), 1);
        paramView.f = 1;
      }
      for (;;)
      {
        ...
        localActionSheet.a(new uyu(this, paramView, localApolloActionData, localActionSheet));
        ...
        do
        {
          ...
          {
            localActionSheet.a(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131438232));
            localActionSheet.a(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131438235), 1);
            paramView.f = 2;
            break label241;
          }
          ...
          {
            localActionSheet.a(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131438237));
            localActionSheet.a(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131438238), 1);
            paramView.f = 3;
            break label241;
          }
          if (paramView.jdField_a_of_type_ComTencentMobileqqDataChatMessage.sendFailCode == ApolloConstant.jdField_c_of_type_Int)
          {
            localActionSheet.a(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131438239));
            paramView.f = 4;
            break label241;
          }
  ...
  protected void a(BaseBubbleBuilder.ViewHolder paramViewHolder, View paramView, ChatMessage paramChatMessage, BubbleInfo paramBubbleInfo)
  {
    ...
    {
      localHolder.jdField_a_of_type_AndroidWidgetTextView.setLinkTextColor(paramView.getResources().getColorStateList(2131494234));
      return;
  ...
  public void a(ApolloItemBuilder.Holder paramHolder, Resources paramResources, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localURLDrawableOptions.mFailedDrawable = paramResources.getDrawable(2130838093);
        localURLDrawableOptions.mLoadingDrawable = paramResources.getDrawable(2130838094);
        if (!paramBoolean) {
          break label204;
        }
  ...
  public QQCustomMenuItem[] a(View paramView)
  {
    ...
    if ((paramView instanceof MessageForApollo))
    {
      ...
      if ((this.jdField_d_of_type_Boolean) && (!ApolloGameUtil.a(localMessageForApollo.msgType))) {
        localQQCustomMenu.a(2131366774, this.jdField_a_of_type_AndroidContentContext.getString(2131438209), 2130838044);
      }
  ...
  public void e()
  {
    ...
    do
    {
      ...
      localObject3 = ((ApolloManager)localObject3).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
