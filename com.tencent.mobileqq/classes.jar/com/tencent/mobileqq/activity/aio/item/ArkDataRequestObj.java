  ...
  implements ark.RuntimeClassCallbackWrapper, vfl
{
  ...
  private boolean a(ark.VariantWrapper[] paramArrayOfVariantWrapper, ark.VariantWrapper paramVariantWrapper)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Var = new vkb(localQQAppInterface);
    } while (!this.jdField_a_of_type_Var.a(paramArrayOfVariantWrapper));
  ...
  private void b()
  {
    ...
    {
      this.jdField_a_of_type_Var.a(null);
      this.jdField_a_of_type_Var.a();
      this.jdField_a_of_type_Var = null;
    }
  }
  ...
  {
    if ((this.jdField_a_of_type_Var == null) || (paramArrayOfVariantWrapper == null) || (paramArrayOfVariantWrapper.length < 2)) {}
    do
    {
      paramVariantWrapper.SetBool(false);
      return true;
    ...
    for (;;)
    {
      this.jdField_a_of_type_Var.a(this);
      if (!this.jdField_a_of_type_Var.b(paramArrayOfVariantWrapper)) {
        break;
      }
      paramVariantWrapper.SetBool(true);
      return true;
  ...
  private boolean f(ark.VariantWrapper[] paramArrayOfVariantWrapper, ark.VariantWrapper paramVariantWrapper)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        this.jdField_a_of_type_Var.a(i);
        paramVariantWrapper.SetBool(true);
        return true;
  ...
  {
    boolean bool = false;
    if ((this.jdField_a_of_type_Var == null) || (paramArrayOfVariantWrapper == null) || (paramArrayOfVariantWrapper.length < 1))
    {
      paramVariantWrapper.SetBool(false);
      return true;
    }
    if (this.jdField_a_of_type_Var.a() == 0) {
      bool = true;
    }
        ...
        do
        {
          do
          {
            do
            {
              ...
              return true;
            } while (this.jdField_a_of_type_Var.a() != 0);
            str = this.jdField_a_of_type_Var.a();
          } while (str == null);
          paramArrayOfVariantWrapper = paramArrayOfVariantWrapper[1].GetString();
        } while (TextUtils.isEmpty(paramArrayOfVariantWrapper));
