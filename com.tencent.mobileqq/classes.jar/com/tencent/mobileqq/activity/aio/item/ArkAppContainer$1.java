  ...
  implements ark.ApplicationCallback
{
  ...
  public boolean CheckUrlLegalityCallback(ark.Application paramApplication, String paramString)
  {
    ...
    if (localArkAppUrlChecker != null)
    {
      ...
      boolean bool4 = ArkAppCenterUtil.a();
      if ((!bool3) || (bool4)) {
        break label294;
      }
      bool2 = true;
      ...
      QLog.e("ArkApp.ArkAppContainer", 1, new Object[] { "ArkSafe.UrlCheck.setDisable.EngineCallback , isValid set=true, appName=", paramApplication, ",appEnableCheck=", Boolean.valueOf(bool3), ", isPublicAccount=", Boolean.valueOf(bool4), ",url=", Util.b(paramString, new String[0]) });
      bool1 = true;
      i = 2;
      label213:
      ArkAppContainer.e();
    ...
    for (;;)
    {
      ArkSecurityReporter.a(paramApplication, paramString, j, i, ArkAppContainer.c);
      ArkAppDataReport.b(ArkAppContainer.a(), paramApplication, paramString, 1);
      QLog.e("ArkApp.ArkAppContainer", 1, new Object[] { "ArkSafe.EngineCallback appName=", paramApplication, ",url=", Util.b(paramString, new String[0]), ", isValid=", Boolean.valueOf(bool1) });
      return bool1;
      label288:
      bool1 = false;
      break;
