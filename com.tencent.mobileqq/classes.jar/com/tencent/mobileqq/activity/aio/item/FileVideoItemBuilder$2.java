...
public class FileVideoItemBuilder$2
  implements Runnable
{
  public FileVideoItemBuilder$2(adeq paramadeq, FileManagerEntity paramFileManagerEntity, String paramString) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      apdc.a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strLargeThumPath, localOptions);
