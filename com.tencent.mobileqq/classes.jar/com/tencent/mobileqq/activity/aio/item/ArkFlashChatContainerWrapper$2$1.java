  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    do
    {
      ...
      i = this.jdField_a_of_type_AndroidOsBundle.getInt("resourceId");
    } while ((i == -1) || (this.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkFlashChatContainerWrapper$2.a.c != i));
    if (QLog.isColorLevel()) {
