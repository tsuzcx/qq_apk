...
class StructingMsgItemBuilder$5
  implements Runnable
{
  StructingMsgItemBuilder$5(StructingMsgItemBuilder paramStructingMsgItemBuilder, adqx paramadqx) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      {
        awqx.b(this.this$0.a, "CliOper", "", "", "0X8004FF9", "0X8004FF9", 0, 0, "" + j, "" + i, "" + str1, str2);
        return;
        i = 2;
        break;
      }
