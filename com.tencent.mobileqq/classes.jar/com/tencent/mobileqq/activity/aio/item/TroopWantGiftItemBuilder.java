  ...
  extends BaseBubbleBuilder
{
  ...
  protected View a(ChatMessage paramChatMessage, BaseBubbleBuilder.ViewHolder paramViewHolder, View paramView, BaseChatItemLayout paramBaseChatItemLayout, OnLongClickAndTouchListener paramOnLongClickAndTouchListener)
  {
    ...
    if (paramView == null)
    {
      ...
      localTextView.setLinkTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColorStateList(2131494230));
      ...
      ((TextView)localObject1).setOnClickListener(new vpz(this, paramChatMessage, paramView));
      ...
      localTextView.setBackgroundResource(2130837950);
    ...
    for (;;)
    {
      ...
      ((View)localObject2).setOnTouchListener(new vqa(this, paramOnLongClickAndTouchListener));
      return localObject2;
