...
class ArkSSODataRequest$2
  implements Runnable
{
  ArkSSODataRequest$2(ArkSSODataRequest paramArkSSODataRequest, WeakReference paramWeakReference, int paramInt) {}
  ...
  public void run()
  {
    ...
    localArkSSODataRequest.a(this.jdField_a_of_type_Int, -1, null);
  }
}
