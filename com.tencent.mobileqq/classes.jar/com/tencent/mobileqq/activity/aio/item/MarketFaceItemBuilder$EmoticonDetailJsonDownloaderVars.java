  ...
  extends EmotionJsonDownloadListener
{
  ...
  public void onJsonComplete(EmoticonPackage paramEmoticonPackage, int paramInt, Bundle paramBundle)
  {
    ...
    if (paramInt == 0)
    {
      ...
      MarketFaceItemBuilder.a(this.a, this.b, this.d, paramEmoticonPackage, this.c, this.e, this.f);
      return;
    }
    MarketFaceItemBuilder.a(this.a + 1000, this.b, this.d, paramEmoticonPackage, this.c, this.e, this.f);
  }
}
