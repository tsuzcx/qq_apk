  ...
  implements BaseBubbleBuilder.TouchDelegate
{
  ...
  public LongMsgItemBuilder(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetAnimationTextView$OnDoubleClick = new vft(this);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new vfu(this);
  }
  ...
  protected View a(ChatMessage paramChatMessage, BaseBubbleBuilder.ViewHolder paramViewHolder, View paramView, BaseChatItemLayout paramBaseChatItemLayout, OnLongClickAndTouchListener paramOnLongClickAndTouchListener)
  {
    ...
    if (paramView == null) {
      if (i == 1)
      {
        ...
        paramView.setTextColor(((Context)localObject2).getResources().getColorStateList(2131494233));
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          if ((localHolder.jdField_a_of_type_AndroidWidgetTextView instanceof AnimationTextView))
          {
            ...
            ((AnimationTextView)localObject1).jdField_a_of_type_ComTencentMobileqqWidgetAnimationTextView$OnSingleClick = new vfq(this, paramChatMessage.isSend());
  ...
  public LinearLayout a(Context paramContext, LongMsgItemBuilder.Holder paramHolder)
  {
    ...
    paramHolder.b = ((TextView)((ViewGroup)localObject).findViewById(2131368539));
    paramHolder.c = ((TextView)((ViewGroup)localObject).findViewById(2131362759));
    paramHolder.jdField_a_of_type_ComEtrumpMixlayoutETTextView = ((ETTextView)((ViewGroup)localObject).findViewById(2131366640));
    localObject = new AnimationTextView(paramContext);
    ((AnimationTextView)localObject).setTextColor(paramContext.getResources().getColorStateList(2131494233));
    ...
    ((AnimationTextView)localObject).setId(2131363594);
    localLinearLayout.addView((View)localObject);
  ...
  protected void a(View paramView)
  {
    ...
    DialogUtil.a(this.jdField_a_of_type_AndroidContentContext, 230, str1, str2, new vfr(this, paramView), new vfs(this)).show();
  }
  ...
  public QQCustomMenuItem[] a(View paramView)
  {
    ...
    {
      localQQCustomMenu.a(2131375639, this.jdField_a_of_type_AndroidContentContext.getString(2131433731), 2130838310);
