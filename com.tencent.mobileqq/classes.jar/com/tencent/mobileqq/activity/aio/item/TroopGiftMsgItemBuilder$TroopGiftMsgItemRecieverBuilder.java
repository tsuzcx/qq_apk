  ...
  extends TroopGiftMsgItemBuilder
{
  ...
  {
    return LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130971616, paramBaseChatItemLayout, false);
  }
  
  protected BaseBubbleBuilder.ViewHolder a()
  {
    return new vhh(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  }
}
