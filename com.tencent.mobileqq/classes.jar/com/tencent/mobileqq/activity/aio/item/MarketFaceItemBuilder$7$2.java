  ...
  implements Runnable
{
  ...
  {
    Object localObject1;
    if ((this.jdField_a_of_type_ComTencentMobileqqDataEmoticon != null) && (this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.jobType == 2) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioItemMarketFaceItemBuilder$7.a.b != null) && ((this.jdField_a_of_type_ComTencentMobileqqActivityAioItemMarketFaceItemBuilder$7.a.b instanceof FragmentActivity)))
    {
      localObject1 = ((FragmentActivity)this.jdField_a_of_type_ComTencentMobileqqActivityAioItemMarketFaceItemBuilder$7.a.b).getChatFragment();
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqDataEmoticon != null) && (this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.jobType == 4) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioItemMarketFaceItemBuilder$7.a.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiManager.a()))
    {
    ...
    for (;;)
    {
      ...
      Object localObject2 = (EmoticonManager)this.jdField_a_of_type_ComTencentMobileqqActivityAioItemMarketFaceItemBuilder$7.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.EMOTICON_MANAGER);
