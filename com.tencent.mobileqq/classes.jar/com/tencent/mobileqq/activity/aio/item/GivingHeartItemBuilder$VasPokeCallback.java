  ...
  extends CallBacker
{
  ...
  public void callback(long paramLong, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2)
  {
    ...
    if (paramLong == 21L)
    {
      ...
      paramString2 = localInteger;
      paramString3 = str;
      if (!PokeItemHelper.c.contains(localInteger)) {
        break label337;
      }
      PokeItemHelper.c.remove(localInteger);
      paramString3 = str;
      paramString2 = localInteger;
      paramInt2 = 1;
    }
    for (;;)
    {
      ...
      label324:
      label330:
      for (paramString2 = HardCodeUtil.a(2131705300);; paramString2 = "")
      {
        ...
        paramString2 = localInteger;
        paramString3 = str;
        if (!PokeItemHelper.d.contains(localInteger)) {
          break label337;
        }
        PokeItemHelper.d.remove(localInteger);
        paramString3 = str;
        paramString2 = localInteger;
        paramInt2 = 1;
        break;
