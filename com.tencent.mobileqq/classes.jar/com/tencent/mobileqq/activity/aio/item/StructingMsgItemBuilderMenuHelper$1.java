  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    String str4 = this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.d;
    ...
    for (Object localObject7 = StructingMsgItemBuilderMenuHelper.a(this.this$0, localAbsShareMsg, null);; localObject7 = null)
    {
      if (localObject7 != null)
      {
        if (!(localObject7 instanceof AbsStructMsgItem)) {
          break label931;
        }
        localObject7 = (AbsStructMsgItem)localObject7;
        localObject1 = ((AbsStructMsgItem)localObject7).a;
        localObject6 = ((AbsStructMsgItem)localObject7).c;
        localObject1 = ((AbsStructMsgItem)localObject7).b;
        localObject2 = ((AbsStructMsgItem)localObject7).d;
        localObject3 = ((AbsStructMsgItem)localObject7).e;
        localObject4 = ((AbsStructMsgItem)localObject7).f;
        localObject5 = ((AbsStructMsgItem)localObject7).g;
        localObject9 = StructingMsgItemBuilderMenuHelper.a(this.this$0, (AbsStructMsgItem)localObject7, StructMsgItemTitle.class);
        localObject8 = StructingMsgItemBuilderMenuHelper.a(this.this$0, (AbsStructMsgItem)localObject7, StructMsgItemSummary.class);
        localObject7 = StructingMsgItemBuilderMenuHelper.a(this.this$0, (AbsStructMsgItem)localObject7, StructMsgItemCover.class);
      }
      for (;;)
      {
        ...
        if ((str3 == null) || ("".equals(str3)))
        {
          ...
          StructingMsgItemBuilderMenuHelper.a(this.this$0).a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, (String)localObject9, (String)localObject8, (String)localObject7, str4, (String)localObject1, (String)localObject10, (String)localObject6, (String)localObject2, (String)localObject3, (String)localObject4, (String)localObject5, l, str5);
          ReportController.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", "", "0X8005455", "0X8005455", 0, 0, str5, "" + l, "" + StructingMsgItemBuilder.c, "android");
          return;
          i = 0;
          ...
          if (!(localObject16 instanceof AbsStructMsgItem)) {
            break label853;
          }
          AbsStructMsgItem localAbsStructMsgItem = (AbsStructMsgItem)localObject16;
          localObject7 = localAbsStructMsgItem.a;
          localObject6 = StructingMsgItemBuilderMenuHelper.a(this.this$0, (String)localObject6, localAbsStructMsgItem.c);
          localObject16 = StructingMsgItemBuilderMenuHelper.a(this.this$0, (String)localObject1, localAbsStructMsgItem.b);
          localObject5 = StructingMsgItemBuilderMenuHelper.a(this.this$0, (String)localObject5, localAbsStructMsgItem.d);
          localObject4 = StructingMsgItemBuilderMenuHelper.a(this.this$0, (String)localObject4, localAbsStructMsgItem.e);
          localObject3 = StructingMsgItemBuilderMenuHelper.a(this.this$0, (String)localObject3, localAbsStructMsgItem.f);
          localObject2 = StructingMsgItemBuilderMenuHelper.a(this.this$0, (String)localObject2, localAbsStructMsgItem.g);
          String str1 = StructingMsgItemBuilderMenuHelper.a(this.this$0, localAbsStructMsgItem, StructMsgItemTitle.class);
          String str2 = StructingMsgItemBuilderMenuHelper.a(this.this$0, localAbsStructMsgItem, StructMsgItemSummary.class);
          localObject7 = StructingMsgItemBuilderMenuHelper.a(this.this$0, localAbsStructMsgItem, StructMsgItemCover.class);
          localObject1 = localObject7;
          if (localObject7 == null) {
            localObject1 = StructingMsgItemBuilderMenuHelper.a(this.this$0, localAbsStructMsgItem, StructMsgItemPAVideo.class);
          }
          localObject15 = localObject2;
          localObject14 = localObject3;
          localObject13 = localObject4;
          ...
          localObject7 = StructingMsgItemBuilderMenuHelper.a(this.this$0, localAbsStructMsgItem, StructMsgItemPAAudio.class);
          localObject8 = str2;
          localObject9 = str1;
