...
class TribeShortVideoItemBuilder$2
  implements Runnable
{
  TribeShortVideoItemBuilder$2(TribeShortVideoItemBuilder paramTribeShortVideoItemBuilder, String paramString, aecx paramaecx, long paramLong, MessageForTribeShortVideo paramMessageForTribeShortVideo) {}
  ...
  public void run()
  {
    ...
    this.this$0.a(this.jdField_a_of_type_Aecx, this.jdField_a_of_type_Long, this.this$0.c, this.this$0.d, this.jdField_a_of_type_ComTencentMobileqqDataMessageForTribeShortVideo.coverImgUrl, this.jdField_a_of_type_JavaLangString);
  }
}
