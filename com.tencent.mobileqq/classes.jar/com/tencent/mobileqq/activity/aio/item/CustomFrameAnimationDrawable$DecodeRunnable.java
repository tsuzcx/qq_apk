  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    for (Object localObject1 = bfuj.a(str);; localObject1 = null)
    {
      ...
      for (Bitmap localBitmap1 = (Bitmap)CustomFrameAnimationDrawable.a(this.this$0).remove(0);; localObject2 = null)
      {
        ...
        for (;;)
        {
          try
          {
            localBitmap1 = bfvo.a(this.jdField_a_of_type_AndroidContentResResources, this.b);
          ...
          {
            if (CustomFrameAnimationDrawable.a(this.this$0)) {
              bfuj.a(str, (Bitmap)localObject1);
            }
          ...
          if (this.jdField_a_of_type_JavaLangString != null) {
            try
            {
              Bitmap localBitmap2 = bfvo.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_AndroidGraphicsBitmapFactory$Options);
