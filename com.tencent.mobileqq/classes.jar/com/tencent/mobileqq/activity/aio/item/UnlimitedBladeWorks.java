  ...
  implements afkv
{
  ...
  private agbn jdField_a_of_type_Agbn;
  private agbp jdField_a_of_type_Agbp;
  private agbq jdField_a_of_type_Agbq;
  ...
  public UnlimitedBladeWorks(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    LayoutInflater.from(paramContext).inflate(2131562784, this, true);
  }
  ...
  private AnimationSet a(int paramInt)
  {
    ...
    while (i < j)
    {
      TranslateAnimation localTranslateAnimation = new TranslateAnimation(0.0F, aekt.a(new int[] { paramInt * 5, paramInt * -12, paramInt * 15, paramInt * -15, paramInt * 12, paramInt * -8, paramInt * 6, paramInt * 0 }[i], getResources()), 0.0F, aekt.a(new int[] { paramInt * 1, paramInt * -3, paramInt * 2, paramInt * -2, paramInt * 1, paramInt * -1, paramInt * 1, paramInt * 0 }[i], getResources()));
  ...
  private void e()
  {
    ...
    if ((this.jdField_a_of_type_MqqUtilWeakReference != null) && (this.jdField_a_of_type_MqqUtilWeakReference.get() != null))
    {
      ((FitSystemWindowsRelativeLayout)((ViewGroup)((Activity)this.jdField_a_of_type_MqqUtilWeakReference.get()).getWindow().getDecorView()).getChildAt(0).findViewById(2131362208)).a().a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForPoke, this.jdField_a_of_type_Boolean, this);
  ...
  public agbq a()
  {
    agbq localagbq = this.jdField_a_of_type_Agbq;
    this.jdField_a_of_type_ComTencentMobileqqActivityAioItemCustomFrameAnimationDrawable.f();
    localagbq.jdField_a_of_type_Int = this.jdField_a_of_type_ComTencentMobileqqActivityAioItemCustomFrameAnimationDrawable.a();
    if (this.jdField_a_of_type_AndroidAnimationValueAnimator.isRunning())
    {
      localagbq.jdField_a_of_type_Long = this.jdField_a_of_type_AndroidAnimationValueAnimator.getCurrentPlayTime();
    ...
    for (;;)
    {
      ...
      localagbq.jdField_b_of_type_Int = this.jdField_b_of_type_ComTencentMobileqqActivityAioItemCustomFrameAnimationDrawable.a();
      return localagbq;
      localagbq.jdField_a_of_type_Long = -1L;
    }
  }
  ...
  public CustomFrameAnimationDrawable a()
  {
    ...
    try
    {
      localObject = bdda.a(str + "01.png", (BitmapFactory.Options)localObject);
      localObject = new CustomFrameAnimationDrawable(getResources(), (Bitmap)localObject, afss.a().a());
  ...
  public void a()
  {
    this.jdField_a_of_type_Agbq.jdField_b_of_type_Boolean = true;
    this.jdField_a_of_type_Agbq.jdField_a_of_type_Boolean = false;
    d();
    if (this.jdField_a_of_type_Agbp != null) {
      this.jdField_a_of_type_Agbp.a();
    }
  }
  ...
  public void a(Context paramContext, boolean paramBoolean1, boolean paramBoolean2, float paramFloat)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131368414));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131363054));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131363349));
    ...
    try
    {
      this.jdField_a_of_type_AndroidGraphicsBitmap = bdda.a(PokeBigResHandler.d, localOptions);
      if (this.jdField_a_of_type_AndroidGraphicsBitmap != null) {
        this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = afsw.a(this.jdField_a_of_type_AndroidGraphicsBitmap);
      }
      ...
      this.jdField_a_of_type_Agbn = new agbn(this, null);
      this.jdField_a_of_type_ComTencentMobileqqActivityAioItemCustomFrameAnimationDrawable.a(new agbj(this));
  ...
  public void a(MessageForPoke paramMessageForPoke, float paramFloat)
  {
    ...
    this.jdField_a_of_type_Agbq = this.jdField_a_of_type_ComTencentMobileqqDataMessageForPoke.mUnlimitedState;
  ...
  public void a(MessageForPoke paramMessageForPoke, boolean paramBoolean, float paramFloat)
  {
    ...
    {
      ((FitSystemWindowsRelativeLayout)((ViewGroup)((Activity)this.jdField_a_of_type_MqqUtilWeakReference.get()).getWindow().getDecorView()).getChildAt(0).findViewById(2131362208)).a().a(paramMessageForPoke, this);
      return;
    }
    this.jdField_a_of_type_Agbq = paramMessageForPoke.mUnlimitedState;
    this.jdField_a_of_type_Agbq.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_Agbq.jdField_b_of_type_Boolean = false;
    if (QLog.isColorLevel()) {
      QLog.d("fangdazhao", 2, "[" + this.jdField_a_of_type_Agbq.jdField_a_of_type_Int + "," + this.jdField_a_of_type_Agbq.jdField_a_of_type_Long + "," + this.jdField_a_of_type_Agbq.jdField_b_of_type_Int + "]");
    }
    if (this.jdField_a_of_type_Agbq.jdField_a_of_type_Int < 23)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityAioItemCustomFrameAnimationDrawable.b(this.jdField_a_of_type_Agbq.jdField_a_of_type_Int);
      this.jdField_a_of_type_AndroidAnimationValueAnimator.cancel();
      this.jdField_b_of_type_AndroidWidgetImageView.setImageDrawable(null);
      this.jdField_a_of_type_ComTencentMobileqqActivityAioItemCustomFrameAnimationDrawable.a(new agbl(this));
      this.jdField_a_of_type_ComTencentMobileqqActivityAioItemCustomFrameAnimationDrawable.d();
      return;
    }
    if ((this.jdField_a_of_type_Agbq.jdField_a_of_type_Int >= 23) && (this.jdField_a_of_type_Agbq.jdField_a_of_type_Int < 29))
    {
      this.jdField_c_of_type_AndroidWidgetImageView.setImageDrawable(null);
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqActivityAioItemCustomFrameAnimationDrawable.b(this.jdField_a_of_type_Agbq.jdField_a_of_type_Int);
        if (this.jdField_a_of_type_Agbq.jdField_a_of_type_Long != -1L) {
          break label347;
        }
      ...
      for (;;)
      {
        ...
        label347:
        this.jdField_a_of_type_AndroidAnimationValueAnimator.start();
        this.jdField_a_of_type_AndroidAnimationValueAnimator.setCurrentPlayTime(this.jdField_a_of_type_Agbq.jdField_a_of_type_Long);
      }
    }
    ...
    if ((i <= 0) && (this.jdField_a_of_type_Agbq.jdField_b_of_type_Int >= 0) && (this.jdField_a_of_type_Agbq.jdField_b_of_type_Int < 9))
    {
      this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(0);
      ...
      this.jdField_b_of_type_ComTencentMobileqqActivityAioItemCustomFrameAnimationDrawable.a(new agbm(this));
      this.jdField_b_of_type_ComTencentMobileqqActivityAioItemCustomFrameAnimationDrawable.a(paramBoolean);
      this.jdField_b_of_type_ComTencentMobileqqActivityAioItemCustomFrameAnimationDrawable.b(this.jdField_a_of_type_Agbq.jdField_b_of_type_Int);
  ...
  public void b()
  {
    int i = azgq.jdField_a_of_type_Int;
    int j = azgq.a(142.0F);
    int k = (int)(azgq.jdField_a_of_type_Int - azgq.a(142.0F) * this.jdField_a_of_type_Float);
    float f = k * 1.0F / (i - j);
    ...
    this.jdField_a_of_type_AndroidAnimationValueAnimator = ValueAnimator.ofInt(new int[] { k, -azgq.a(80.0F) });
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new agbk(this));
    if (this.jdField_a_of_type_Agbn == null) {
      this.jdField_a_of_type_Agbn = new agbn(this, null);
    }
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(this.jdField_a_of_type_Agbn);
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Agbq.jdField_a_of_type_Int = 0;
    this.jdField_a_of_type_Agbq.jdField_b_of_type_Int = 0;
    this.jdField_a_of_type_Agbq.jdField_a_of_type_Long = 0L;
    this.jdField_a_of_type_Agbq.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_Agbq.jdField_b_of_type_Boolean = false;
    this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.jdField_a_of_type_ComTencentMobileqqActivityAioItemCustomFrameAnimationDrawable);
    this.jdField_b_of_type_AndroidWidgetImageView.setImageDrawable(null);
  ...
  public void setEndListener(agbp paramagbp)
  {
    this.jdField_a_of_type_Agbp = paramagbp;
  }
  ...
  public void setMirror(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      localLayoutParams.rightMargin = aekt.a(100.0F, getResources());
    ...
    for (;;)
    {
      ...
      localLayoutParams.leftMargin = aekt.a(100.0F, getResources());
      this.jdField_b_of_type_AndroidWidgetImageView.setLayoutParams(localLayoutParams);
    }
  }
  ...
  public void setParams(boolean paramBoolean)
  {
    ...
    if (paramBoolean == true)
    {
      ...
      localLayoutParams.addRule(9, -1);
      localLayoutParams.addRule(11, 0);
      localLayoutParams.height = ((int)(azgq.a(90.0F) * this.jdField_a_of_type_Float));
      localLayoutParams.width = ((int)(azgq.a(90.0F) * this.jdField_a_of_type_Float));
      this.jdField_a_of_type_AndroidWidgetImageView.setLayoutParams(localLayoutParams);
      localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_c_of_type_AndroidWidgetImageView.getLayoutParams();
      localLayoutParams.addRule(9, 0);
      localLayoutParams.addRule(11, -1);
      ...
      localLayoutParams.addRule(9, 0);
      localLayoutParams.addRule(11, -1);
      localLayoutParams.height = ((int)(azgq.a(34.0F) * this.jdField_a_of_type_Float));
      localLayoutParams.width = ((int)(azgq.a(48.0F) * this.jdField_a_of_type_Float));
      localLayoutParams.leftMargin = 0;
      localLayoutParams.rightMargin = aekt.a(100.0F, getResources());
      this.jdField_b_of_type_AndroidWidgetImageView.setLayoutParams(localLayoutParams);
    }
