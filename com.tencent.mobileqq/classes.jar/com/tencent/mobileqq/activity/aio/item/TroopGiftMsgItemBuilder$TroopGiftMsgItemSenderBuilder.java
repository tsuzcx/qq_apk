  ...
  extends TroopGiftMsgItemBuilder
{
  ...
  {
    return LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130971617, paramBaseChatItemLayout, false);
  }
  
  protected BaseBubbleBuilder.ViewHolder a()
  {
    return new vhi(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  }
}
