...
public class MarketFaceItemBuilder$6
  implements Runnable
{
  public MarketFaceItemBuilder$6(agif paramagif, String paramString, agis paramagis) {}
  ...
  public void run()
  {
    ...
    localIntent.putExtra("senderUin", this.jdField_a_of_type_Agis.jdField_a_of_type_ComTencentMobileqqDataChatMessage.senderuin);
    ...
    localIntent.putExtra("emoticon", this.jdField_a_of_type_Agis.jdField_a_of_type_ComTencentMobileqqEmoticonviewPicEmoticonInfo.emoticon);
    Object localObject = (avsq)this.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(14);
    EmoticonPackage localEmoticonPackage = ((avsq)localObject).a(this.jdField_a_of_type_Agis.jdField_a_of_type_ComTencentMobileqqEmoticonviewPicEmoticonInfo.emoticon.epId);
