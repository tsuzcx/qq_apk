  ...
  implements Runnable
{
  ...
  {
    this.jdField_a_of_type_Usn = null;
  ...
  public CustomFrameAnimationDrawable(Resources paramResources, Bitmap paramBitmap, MqqHandler paramMqqHandler, CustomFrameAnimationDrawable.FrameAnimationState paramFrameAnimationState, String paramString, boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_JavaLangString != null) && (this.jdField_a_of_type_Boolean)) {
      ThreadManager.postImmediately(new usm(this), null, true);
    }
  }
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivityAioItemCustomFrameAnimationDrawable$FrameAnimationState.jdField_a_of_type_JavaUtilArrayList.size() > 0)
        {
          ...
          if (paramInt >= 0)
          {
            ...
            if (paramInt < this.jdField_a_of_type_ComTencentMobileqqActivityAioItemCustomFrameAnimationDrawable$FrameAnimationState.jdField_a_of_type_JavaUtilArrayList.size()) {
              localObject1 = (uso)this.jdField_a_of_type_ComTencentMobileqqActivityAioItemCustomFrameAnimationDrawable$FrameAnimationState.jdField_a_of_type_JavaUtilArrayList.get(paramInt);
            }
          }
        }
      }
  ...
  {
    uso localuso = new uso();
    localuso.jdField_a_of_type_Int = paramInt1;
    localuso.jdField_b_of_type_Int = paramInt2;
    localuso.jdField_c_of_type_Int = paramInt3;
    localuso.jdField_a_of_type_JavaLangString = null;
    this.jdField_a_of_type_ComTencentMobileqqActivityAioItemCustomFrameAnimationDrawable$FrameAnimationState.jdField_a_of_type_JavaUtilArrayList.add(localuso);
  }
  ...
  public void a(int paramInt1, int paramInt2, String paramString)
  {
    ...
    localuso.jdField_a_of_type_Int = paramInt1;
    localuso.jdField_b_of_type_Int = paramInt2;
    localuso.jdField_a_of_type_JavaLangString = paramString;
    localuso.jdField_c_of_type_Int = 0;
    this.jdField_a_of_type_ComTencentMobileqqActivityAioItemCustomFrameAnimationDrawable$FrameAnimationState.jdField_a_of_type_JavaUtilArrayList.add(localuso);
  }
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_JavaUtilArrayList != null)
      {
        ...
        for (;;)
        {
          ...
          {
            localObject = (Bitmap)this.jdField_a_of_type_JavaUtilArrayList.get(((uso)this.jdField_a_of_type_ComTencentMobileqqActivityAioItemCustomFrameAnimationDrawable$FrameAnimationState.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_a_of_type_ComTencentMobileqqActivityAioItemCustomFrameAnimationDrawable$FrameAnimationState.jdField_a_of_type_JavaUtilArrayList.size() - 1)).jdField_a_of_type_Int);
          }
          else
          {
            localObject = (uso)this.jdField_a_of_type_ComTencentMobileqqActivityAioItemCustomFrameAnimationDrawable$FrameAnimationState.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_a_of_type_ComTencentMobileqqActivityAioItemCustomFrameAnimationDrawable$FrameAnimationState.jdField_a_of_type_Int);
            localObject = (Bitmap)this.jdField_a_of_type_JavaUtilArrayList.get(((uso)localObject).jdField_a_of_type_Int);
          }
        }
      }
    }
  ...
  public void run()
  {
    if ((this.jdField_a_of_type_JavaUtilArrayList == null) && (this.jdField_a_of_type_AndroidGraphicsBitmap != null))
    {
      ...
      if (i < this.jdField_a_of_type_ComTencentMobileqqActivityAioItemCustomFrameAnimationDrawable$FrameAnimationState.jdField_a_of_type_JavaUtilArrayList.size())
      {
        ...
        if (i < this.jdField_a_of_type_ComTencentMobileqqActivityAioItemCustomFrameAnimationDrawable$FrameAnimationState.jdField_a_of_type_JavaUtilArrayList.size())
        {
          ...
          {
            localObject1 = (uso)this.jdField_a_of_type_ComTencentMobileqqActivityAioItemCustomFrameAnimationDrawable$FrameAnimationState.jdField_a_of_type_JavaUtilArrayList.get(i);
            if (this.jdField_a_of_type_Usn == null)
            {
              this.jdField_a_of_type_Usn = new usn(this, i, ((uso)localObject1).jdField_a_of_type_JavaLangString, ((uso)localObject1).jdField_c_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqActivityAioItemCustomFrameAnimationDrawable$FrameAnimationState.jdField_b_of_type_JavaUtilArrayList);
              this.jdField_a_of_type_Usn.a(this.jdField_a_of_type_AndroidContentResResources);
              if (this.jdField_a_of_type_MqqOsMqqHandler != null) {
                this.jdField_a_of_type_MqqOsMqqHandler.post(this.jdField_a_of_type_Usn);
              }
              localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityAioItemCustomFrameAnimationDrawable$FrameAnimationState;
          ...
          localObject1 = (uso)this.jdField_a_of_type_ComTencentMobileqqActivityAioItemCustomFrameAnimationDrawable$FrameAnimationState.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_a_of_type_ComTencentMobileqqActivityAioItemCustomFrameAnimationDrawable$FrameAnimationState.jdField_a_of_type_Int);
          scheduleSelf(this, SystemClock.uptimeMillis() + ((uso)localObject1).jdField_b_of_type_Int);
          if ((this.jdField_a_of_type_JavaLangString != null) && (this.jdField_a_of_type_Boolean))
          {
            ...
            ((HapticManager)localObject2).a(i, ((uso)localObject1).jdField_b_of_type_Int * j);
          }
        }
      }
    }
    do
    {
      do
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivityAioItemCustomFrameAnimationDrawable$FrameAnimationState.jdField_a_of_type_Int < this.jdField_a_of_type_ComTencentMobileqqActivityAioItemCustomFrameAnimationDrawable$FrameAnimationState.jdField_a_of_type_JavaUtilArrayList.size())
        {
          ...
          scheduleSelf(this, ((uso)localObject1).jdField_b_of_type_Int + l);
          localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityAioItemCustomFrameAnimationDrawable$FrameAnimationState;
          ((CustomFrameAnimationDrawable.FrameAnimationState)localObject1).jdField_a_of_type_Int += 1;
          return;
        }
    ...
    Object localObject1 = (uso)this.jdField_a_of_type_ComTencentMobileqqActivityAioItemCustomFrameAnimationDrawable$FrameAnimationState.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_a_of_type_ComTencentMobileqqActivityAioItemCustomFrameAnimationDrawable$FrameAnimationState.jdField_a_of_type_Int);
