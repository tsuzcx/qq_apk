  ...
  extends BaseBubbleBuilder
{
  ...
  public VIPDonateMsgItemBuilder(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new vig(this);
  ...
  private RelativeLayout a(Context paramContext)
  {
    ...
    localQQWalletTransferBubbleView.setBackgroundResource(2130843928);
  ...
  protected View a(ChatMessage paramChatMessage, BaseBubbleBuilder.ViewHolder paramViewHolder, View paramView, BaseChatItemLayout paramBaseChatItemLayout, OnLongClickAndTouchListener paramOnLongClickAndTouchListener)
  {
    ...
    for (paramViewHolder = (MessageForVIPDonate)paramChatMessage;; paramViewHolder = null)
    {
      ...
      ((ImageView)paramView.a.findViewById(2131362209)).setImageResource(2130846241);
      ...
      {
        bool1 = true;
        localQQWalletTransferBubbleView.setBubbleBackground(2130843927, m, bool1);
      ...
      {
        paramBaseChatItemLayout.setBubbleBackground(2130843928, m, bool1);
