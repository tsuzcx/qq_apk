...
public class QQWalletMsgItemBuilder$1
  implements Runnable
{
  public QQWalletMsgItemBuilder$1(admw paramadmw, int paramInt) {}
  ...
  public void run()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d(admw.jdField_a_of_type_JavaLangString, 2, "preload qwallet process by qqWalletMsg isTroop=" + this.a);
    }
