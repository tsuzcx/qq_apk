...
public class TroopGiftMsgItemBuilder$4
  implements Runnable
{
  public TroopGiftMsgItemBuilder$4(ahmb paramahmb, String paramString1, BubbleImageView paramBubbleImageView, String paramString2, int paramInt) {}
  ...
  public void run()
  {
    ...
    ahmb.a(this.this$0, this.jdField_a_of_type_ComTencentMobileqqWidgetBubbleImageView, this.b, this.jdField_a_of_type_Int);
  }
}
