  ...
  extends BaseBubbleBuilder
{
  ...
  public TroopFeeMsgItemBuilder(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new vgi(this);
  ...
  {
    paramViewHolder = (vgj)paramViewHolder;
    ...
    if ((paramView != null) && ((paramView instanceof RelativeLayout)))
    {
      ...
      localImageView.setImageResource(2130843929);
    ...
    {
      localQQWalletTransferBubbleView.setBubbleBackground(2130843927, i1, bool);
  ...
  protected RelativeLayout a(Context paramContext)
  {
    ...
    ((RelativeLayout)localObject1).setBackgroundResource(2130843928);
