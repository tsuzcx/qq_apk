  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityAioItemQzoneFeedItemBuilder$Holder.d;
      if (!this.jdField_a_of_type_Boolean) {
        break label363;
      }
      i = 2130847887;
      ((ImageView)localObject1).setImageResource(i);
      long l = this.jdField_a_of_type_ComTencentMobileqqActivityAioItemQzoneFeedItemBuilder.a.getLongAccountUin();
      ...
      localObject2 = new QzoneCommonIntent(this.jdField_a_of_type_ComTencentMobileqqActivityAioItemQzoneFeedItemBuilder.a.getApplication(), QZoneCommonServlet.class);
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityAioItemQzoneFeedItemBuilder.a.startServlet((NewIntent)localObject2);
    ...
    for (Object localObject1 = "1";; localObject1 = "0")
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityAioItemQzoneFeedItemBuilder.a.getMessageFacade().a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQzoneFeed, this.jdField_a_of_type_ComTencentMobileqqDataMessageForQzoneFeed.selfuin);
