...
public class TextItemBuilder$7
  implements Runnable
{
  public TextItemBuilder$7(ahkf paramahkf, CharSequence paramCharSequence, long paramLong1, long paramLong2) {}
  ...
  public void run()
  {
    ...
    synchronized (ahkf.jdField_a_of_type_ComTencentUtilLRULinkedHashMap)
    {
      ahkf.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.put(Long.valueOf(this.b), localSpannableString);
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.aio.item.TextItemBuilder.7
