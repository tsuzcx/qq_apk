...
class QQStoryItemBuilder$10
  implements Runnable
{
  QQStoryItemBuilder$10(QQStoryItemBuilder paramQQStoryItemBuilder, admv paramadmv, long paramLong) {}
  ...
  public void run()
  {
    ...
    {
      return;
      localLong = (Long)this.jdField_a_of_type_Admv.jdField_a_of_type_ComTencentMobileqqActivityAioItemQQStoryItemBuilder$StoryChatVideoView.getTag();
