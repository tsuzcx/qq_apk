  ...
  implements Runnable
{
  ...
  ArrayList<agcm> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  private void d()
  {
    setOnTouchListener(new agcl(this));
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsBitmap = bfvo.a(((agcm)this.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_a_of_type_Int)).jdField_a_of_type_JavaLangString, null);
    jdField_a_of_type_Boolean = true;
  }
  
  public void a(String paramString, int paramInt)
  {
    agcm localagcm = new agcm(this);
    localagcm.jdField_a_of_type_JavaLangString = paramString;
    localagcm.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_JavaUtilArrayList.add(localagcm);
  }
  ...
  public void run()
  {
    ...
    if (i < 55)
    {
      ...
      agcm localagcm = (agcm)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      ...
      for (;;)
      {
        ...
        invalidate();
        this.jdField_a_of_type_AndroidOsHandler.postDelayed(this, localagcm.jdField_a_of_type_Int);
        return;
        label150:
        localBitmap.recycle();
      }
