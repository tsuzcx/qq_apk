  ...
  implements Runnable
{
  ...
  ArrayList<adht> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  private void d()
  {
    setOnTouchListener(new adhs(this));
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsBitmap = bacm.a(((adht)this.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_a_of_type_Int)).jdField_a_of_type_JavaLangString, null);
    jdField_a_of_type_Boolean = true;
  }
  
  public void a(String paramString, int paramInt)
  {
    adht localadht = new adht(this);
    localadht.jdField_a_of_type_JavaLangString = paramString;
    localadht.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_JavaUtilArrayList.add(localadht);
  }
  ...
  public void run()
  {
    ...
    if (i < 55)
    {
      ...
      adht localadht = (adht)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      ...
      for (;;)
      {
        ...
        invalidate();
        this.jdField_a_of_type_AndroidOsHandler.postDelayed(this, localadht.jdField_a_of_type_Int);
        return;
        label150:
        localBitmap.recycle();
      }
