  ...
  implements Runnable
{
  ...
  ArrayList<adsv> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  private void d()
  {
    setOnTouchListener(new adsu(this));
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsBitmap = bbdr.a(((adsv)this.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_a_of_type_Int)).jdField_a_of_type_JavaLangString, null);
    jdField_a_of_type_Boolean = true;
  }
  
  public void a(String paramString, int paramInt)
  {
    adsv localadsv = new adsv(this);
    localadsv.jdField_a_of_type_JavaLangString = paramString;
    localadsv.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_JavaUtilArrayList.add(localadsv);
  }
  ...
  public void run()
  {
    ...
    if (i < 55)
    {
      ...
      adsv localadsv = (adsv)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      ...
      for (;;)
      {
        ...
        invalidate();
        this.jdField_a_of_type_AndroidOsHandler.postDelayed(this, localadsv.jdField_a_of_type_Int);
        return;
        label150:
        localBitmap.recycle();
      }
