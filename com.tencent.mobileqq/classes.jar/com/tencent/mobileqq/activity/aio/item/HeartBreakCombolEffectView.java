  ...
  implements Runnable
{
  ...
  private void d()
  {
    setOnTouchListener(new adss(this));
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsBitmap = bbef.a(((adst)this.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_a_of_type_Int)).jdField_a_of_type_JavaLangString, null);
