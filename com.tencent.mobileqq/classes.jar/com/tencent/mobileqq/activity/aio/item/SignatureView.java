  ...
  extends View
{
  ...
  private void a()
  {
    ...
    this.jdField_b_of_type_JavaLangCharSequence = ajjy.a(2131648324);
    ...
    this.jdField_c_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130849096);
    this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130848734);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (this.jdField_e_of_type_Boolean)
        {
          ...
          m = paramCanvas.getSaveCount();
          paramCanvas.save();
          paramCanvas.translate(this.jdField_a_of_type_Baoj.jdField_a_of_type_Float * this.jdField_d_of_type_Int, this.k + this.jdField_a_of_type_Baoj.jdField_b_of_type_Float * (this.jdField_e_of_type_Int - this.k));
          n = (int)(this.jdField_a_of_type_Baoj.jdField_c_of_type_Float * this.jdField_d_of_type_Int + 0.5D);
          i1 = (int)(this.jdField_a_of_type_Baoj.jdField_d_of_type_Float * (this.jdField_e_of_type_Int - this.k) + 0.5D);
        ...
        {
          invalidate();
          if ((this.jdField_d_of_type_Boolean) && (this.jdField_a_of_type_Baoj != null))
          {
            m = paramCanvas.getSaveCount();
            paramCanvas.save();
            paramCanvas.translate(this.jdField_a_of_type_Baoj.jdField_a_of_type_Float * this.jdField_d_of_type_Int, this.k + this.jdField_a_of_type_Baoj.jdField_b_of_type_Float * (this.jdField_e_of_type_Int - this.k));
  ...
  public void setAnimation(int paramInt, String paramString, baoj parambaoj)
  {
    ...
    this.jdField_a_of_type_Baoj = parambaoj;
    ...
    ThreadManager.post(new SignatureView.1(this, paramInt, paramString, parambaoj), 5, null, true);
  }
}
