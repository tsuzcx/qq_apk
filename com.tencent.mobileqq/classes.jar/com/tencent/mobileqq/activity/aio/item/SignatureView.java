  ...
  extends View
{
  ...
  private void a()
  {
    ...
    this.jdField_c_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130845955);
    this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130845686);
  ...
  public void setAnimation(int paramInt, String paramString, SignatureTemplateInfo.DynamicItem paramDynamicItem)
  {
    ...
    ThreadManager.post(new vdo(this, paramInt, paramString, paramDynamicItem), 5, null, true);
  }
