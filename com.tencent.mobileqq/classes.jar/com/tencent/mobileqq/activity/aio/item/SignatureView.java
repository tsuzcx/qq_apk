  ...
  extends View
{
  ...
  private void a()
  {
    ...
    this.jdField_b_of_type_JavaLangCharSequence = ajyc.a(2131714112);
    ...
    this.jdField_c_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130849331);
    this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130848959);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (this.jdField_e_of_type_Boolean)
        {
          ...
          m = paramCanvas.getSaveCount();
          paramCanvas.save();
          paramCanvas.translate(this.jdField_a_of_type_Bbqf.jdField_a_of_type_Float * this.jdField_d_of_type_Int, this.k + this.jdField_a_of_type_Bbqf.jdField_b_of_type_Float * (this.jdField_e_of_type_Int - this.k));
          n = (int)(this.jdField_a_of_type_Bbqf.jdField_c_of_type_Float * this.jdField_d_of_type_Int + 0.5D);
          i1 = (int)(this.jdField_a_of_type_Bbqf.jdField_d_of_type_Float * (this.jdField_e_of_type_Int - this.k) + 0.5D);
        ...
        {
          invalidate();
          if ((this.jdField_d_of_type_Boolean) && (this.jdField_a_of_type_Bbqf != null))
          {
            m = paramCanvas.getSaveCount();
            paramCanvas.save();
            paramCanvas.translate(this.jdField_a_of_type_Bbqf.jdField_a_of_type_Float * this.jdField_d_of_type_Int, this.k + this.jdField_a_of_type_Bbqf.jdField_b_of_type_Float * (this.jdField_e_of_type_Int - this.k));
  ...
  public void setAnimation(int paramInt, String paramString, bbqf parambbqf)
  {
    if (QLog.isColorLevel()) {
    ...
    ThreadManager.post(new SignatureView.1(this, paramInt, paramString, parambbqf), 5, null, true);
  }
}
