...
class ShortVideoRealItemBuilder$12
  implements Runnable
{
  ShortVideoRealItemBuilder$12(ShortVideoRealItemBuilder paramShortVideoRealItemBuilder, boolean paramBoolean1, agok paramagok, MessageForShortVideo paramMessageForShortVideo, boolean paramBoolean2) {}
  
  public void run()
  {
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Agok != null) && (this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo.progressTask == null))
    {
