  ...
  extends AbstractChatItemBuilder
{
  ...
  public View a(MessageRecord paramMessageRecord, AbstractChatItemBuilder.ViewHolder paramViewHolder, View paramView, LinearLayout paramLinearLayout, OnLongClickAndTouchListener paramOnLongClickAndTouchListener)
  {
    ...
    try
    {
      ...
      if (paramView == null)
      {
        paramViewHolder = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558902, null);
        paramOnLongClickAndTouchListener.jdField_a_of_type_ComTencentMobileqqWidgetAnyScaleTypeImageView = ((AnyScaleTypeImageView)paramViewHolder.findViewById(2131364969));
        paramOnLongClickAndTouchListener.b = ((TextView)paramViewHolder.findViewById(2131364972));
        paramOnLongClickAndTouchListener.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)paramViewHolder.findViewById(2131364968));
        paramOnLongClickAndTouchListener.jdField_a_of_type_AndroidViewViewGroup.setOnClickListener(new ThumbItemBuilder.2(this, i));
      }
      str = ContactUtils.i(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord.frienduin);
      if (i != 0)
      {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          catch (Exception paramMessageRecord)
          {
            ...
            i = j;
            continue;
            paramOnLongClickAndTouchListener.b.setText(str + HardCodeUtil.a(2131714804) + this.jdField_a_of_type_AndroidContentContext.getString(2131691002, new Object[] { paramView }));
            return paramViewHolder;
          }
          if (2 != i) {
            break;
          }
          paramOnLongClickAndTouchListener.b.setText(str + HardCodeUtil.a(2131714803) + this.jdField_a_of_type_AndroidContentContext.getString(2131691002, new Object[] { paramView }));
          return paramViewHolder;
        ...
        paramOnLongClickAndTouchListener.jdField_a_of_type_ComTencentMobileqqWidgetAnyScaleTypeImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130847446));
    ...
    paramOnLongClickAndTouchListener.jdField_a_of_type_ComTencentMobileqqWidgetAnyScaleTypeImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130847446));
    paramOnLongClickAndTouchListener.b.setText(str + this.jdField_a_of_type_AndroidContentContext.getString(2131691002, new Object[] { this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131690793) }));
    return paramViewHolder;
  }
