  ...
  extends FlashChatObserver
{
  ...
  {
    ArkDispatchTask.getInstance().postDelayed(ArkFlashChatContainerWrapper.d(this.a).name, new ArkFlashChatContainerWrapper.2.1(this, paramBoolean, paramBundle), 1000L);
  }
}
