  ...
  implements Runnable
{
  ...
  public ScribbleItemBuilder$ProgressRunnable(MessageForScribble paramMessageForScribble, afvn paramafvn, Handler paramHandler, Context paramContext)
  {
    this.a = new WeakReference(paramMessageForScribble);
    this.b = new WeakReference(paramafvn);
  ...
  public void run()
  {
    ...
    {
      if (this.b != null) {}
      for (afvn localafvn = (afvn)this.b.get();; localafvn = null)
      {
        if (this.c != null) {}
        for (Handler localHandler = (Handler)this.c.get();; localHandler = null)
        {
          ...
          {
            if ((localMessageForScribble == null) || (localHandler == null) || (localafvn == null) || (localContext == null)) {}
            do
            {
              return;
              ScribbleItemBuilder.a(localMessageForScribble);
              ScribbleItemBuilder.a(localMessageForScribble, localafvn, localMessageForScribble.mUiProgress, false, localContext, localHandler);
            } while (!localafvn.a.isShown());
