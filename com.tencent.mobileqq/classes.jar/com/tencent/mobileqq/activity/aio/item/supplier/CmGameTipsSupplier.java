  ...
  extends ItemBuilderSupplier
{
  ...
  {
    return (ChatItemBuilder)((IApolloItemBuilderFactory)QRoute.api(IApolloItemBuilderFactory.class)).createChatItemBuilder(100, this.b, paramBaseAdapter, this.a, this.c, this.e);
  }
}
