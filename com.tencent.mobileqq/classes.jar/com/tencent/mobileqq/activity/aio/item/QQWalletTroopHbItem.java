  ...
  implements CustomizeStrategyFactory.OnCustomizeListener
{
  ...
  public FrameLayout a(LinearLayout paramLinearLayout)
  {
    ...
    Object localObject1 = paramLinearLayout.findViewById(2131375269);
    ...
    if (localObject1 == null)
    {
      ...
      View localView = paramLinearLayout.findViewById(2131375298);
    ...
    for (;;)
    {
      ...
      if ((localObject1 instanceof FrameLayout))
      {
        ...
        paramLinearLayout = paramLinearLayout.findViewById(2131375298);
  ...
  public void a(MessageForQQWalletMsg paramMessageForQQWalletMsg)
  {
    ...
    if ((paramMessageForQQWalletMsg instanceof SpecifyRedPkgViewHolder)) {
      ((SpecifyRedPkgViewHolder)paramMessageForQQWalletMsg).a(((IQQAvatarService)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getRuntimeService(IQQAvatarService.class, "")).getInstance(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
    }
    try
    {
  ...
  public boolean a(FrameLayout paramFrameLayout, RedPackGrapInfo paramRedPackGrapInfo, TroopUnAccalimedRedPacketList.HbItemClickListener paramHbItemClickListener)
  {
    ...
    paramFrameLayout = (RelativeLayout)paramFrameLayout.findViewById(2131375269);
    if (paramFrameLayout == null) {
      return false;
    }
    ...
    if (this.jdField_a_of_type_AndroidContentContext != null) {
      this.jdField_a_of_type_AndroidContentContext.getString(2131717133);
    }
    return this.jdField_a_of_type_ComTencentMobileqqActivityAioQwalletQQWalletHbItemUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie, paramFrameLayout, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_Int, paramRedPackGrapInfo.iSkinId, "");
  }
