...
public class TroopMemberListActivity
  ...
  implements bhey, bhez, AdapterView.OnItemClickListener
{
  ...
  public String u = "";
  protected String v;
  private String w = amtj.a(2131714572);
  ...
  public TroopMemberListActivity()
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new aeov(this);
    this.jdField_b_of_type_AndroidViewView$OnClickListener = new aeni(this);
    this.jdField_m_of_type_Int = 0;
    this.jdField_m_of_type_Boolean = true;
    this.jdField_a_of_type_Bjoe = new aeny(this);
    this.jdField_a_of_type_AndroidOsHandler = new aeof(this);
    this.jdField_c_of_type_AndroidViewView$OnClickListener = new aeog(this);
    this.jdField_a_of_type_Double = 0.0D;
    this.jdField_d_of_type_AndroidViewView$OnClickListener = new aeoh(this);
    this.jdField_a_of_type_Amrc = new aeok(this);
    this.jdField_a_of_type_Andd = new aeom(this);
  }
  ...
  private void a(int paramInt1, int paramInt2, int paramInt3)
  {
    if ((this.jdField_d_of_type_Int == 20) || (this.jdField_d_of_type_Int == 21)) {
      this.jdField_e_of_type_AndroidWidgetTextView.setText(String.format(amtj.a(2131714642), new Object[] { Integer.valueOf(paramInt3) }));
    }
    for (;;)
    {
      this.jdField_a_of_type_AndroidWidgetProgressBar.setProgress(paramInt3);
      return;
      this.jdField_e_of_type_AndroidWidgetTextView.setText(String.format(amtj.a(2131714578), new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt2) }));
    }
  }
  ...
  private void a(Message paramMessage)
  {
    ...
    {
      this.jdField_a_of_type_Aeoz.jdField_a_of_type_JavaUtilLinkedHashMap = ((LinkedHashMap)paramMessage[0]);
      this.jdField_a_of_type_Aeoz.jdField_a_of_type_ArrayOfInt = ((int[])paramMessage[1]);
      this.jdField_a_of_type_Aeoz.jdField_a_of_type_ArrayOfJavaLangString = ((String[])paramMessage[2]);
      ...
      if (this.jdField_a_of_type_JavaUtilList.size() != 0)
      {
        ...
        this.jdField_a_of_type_Aeoz.notifyDataSetChanged();
        this.jdField_a_of_type_Aeoz.a();
      }
    }
    for (;;)
    {
      ...
      label302:
      this.jdField_a_of_type_Aeoz = new aeoz(this);
      this.jdField_a_of_type_ComTencentWidgetPinnedDividerSwipListView.setAdapter(this.jdField_a_of_type_Aeoz);
    }
  }
  ...
  private void a(List<Long> paramList)
  {
    ...
    for (;;)
    {
      ...
      localTextView.setOnClickListener(new aeoi(this, localReportDialog));
      ((TextView)localObject).setOnClickListener(new aeoj(this, paramList, localCheckBox, bool, localReportDialog));
  ...
  private void a(boolean paramBoolean1, String paramString1, boolean paramBoolean2, int paramInt1, int paramInt2, String paramString2, String paramString3, boolean paramBoolean3)
  {
    ...
    if ((this.jdField_d_of_type_Int == 3) && (!this.jdField_a_of_type_Boolean) && (this.jdField_b_of_type_Int != 1))
    {
      ...
      if ((!this.jdField_a_of_type_Boolean) && (paramBoolean3) && (this.jdField_b_of_type_AndroidWidgetRelativeLayout != null))
      {
        ...
        if (i1 != 0)
        {
          ...
          ((ImageView)localObject3).setOnClickListener(new aeon(this));
          ((TextView)localObject2).setTextSize(12.0F);
        }
        this.jdField_b_of_type_AndroidWidgetRelativeLayout.setOnClickListener(new aeoo(this, (String)localObject1));
        if (!this.jdField_o_of_type_Boolean)
        {
    ...
    do
    {
      ...
      localObject2 = amtj.a(2131714591);
      ...
      ((Button)localObject3).setOnClickListener(new aeop(this));
      i1 = ((anaj)this.app.getBusinessHandler(13)).g();
    ...
    if ((paramBoolean2) && (paramInt1 > 0))
    {
      ...
      this.jdField_g_of_type_JavaLangString = (amtj.a(2131714595) + paramInt1 + amtj.a(2131714598));
    ...
    for (paramString2 = paramString1;; paramString2 = (String)localObject2 + "," + paramString1)
    {
      ...
      if (paramInt1 == 0)
      {
        this.jdField_g_of_type_JavaLangString = amtj.a(2131714657);
        paramString1 = (String)localObject2 + ",剩余0次";
        ((TextView)localObject1).setText("剩余0次");
        break label615;
      }
      this.jdField_g_of_type_JavaLangString = "";
      paramString1 = (String)localObject2 + "," + amtj.a(2131714656);
      ...
      if (!this.jdField_f_of_type_Boolean)
      {
        ...
        if (i1 != 3)
        {
          ...
          paramInt1 = (int)(amtj.a(2131714653).length() * 12 * this.jdField_a_of_type_Float);
          new DisplayMetrics();
      ...
      if (paramString1.contains(amtj.a(2131714663)))
      {
        paramInt1 = paramString1.indexOf(amtj.a(2131714664));
        paramInt2 = amtj.a(2131714581).length();
        paramString2.setSpan(new ForegroundColorSpan(-48606), paramInt1, paramInt2 + paramInt1, 33);
      }
  ...
  private void p()
  {
    if (this.jdField_a_of_type_Bjsv == null)
    {
      ...
      this.jdField_a_of_type_Bjsv = bjsv.a(this, localArrayList, new aeob(this), null, UIUtils.dip2px(this, 135.0F), false);
      this.jdField_a_of_type_Bjsv.setTouchInterceptor(new aeol(this));
      a(this.jdField_m_of_type_Int);
    }
    this.jdField_a_of_type_Bjsv.showAsDropDown(this.jdField_b_of_type_AndroidWidgetImageView, -(UIUtils.dip2px(this, 135.0F) - this.jdField_b_of_type_AndroidWidgetImageView.getWidth()), 0);
  }
  ...
  private void r()
  {
    ...
    this.jdField_e_of_type_AndroidViewView = getLayoutInflater().inflate(2131562923, this.jdField_a_of_type_ComTencentWidgetPinnedDividerSwipListView, false);
    TextView localTextView = (TextView)this.jdField_e_of_type_AndroidViewView.findViewById(2131368635);
    ...
    {
      localObject = (aeox)localIterator.next();
      if (((aeox)localObject).jdField_b_of_type_Long == 0L) {
        ((aeox)localObject).jdField_b_of_type_Long = ((aeox)localObject).jdField_a_of_type_Long;
      }
      if (TextUtils.isEmpty(a(((aeox)localObject).jdField_b_of_type_Long, localCalendar, this.jdField_d_of_type_JavaUtilArrayList, this.jdField_c_of_type_JavaUtilArrayList))) {
        break label353;
      }
      i1 += 1;
    }
    ...
    for (;;)
    {
      ...
      for (int i2 = 0;; i2 = 1)
      {
        this.jdField_e_of_type_AndroidViewView.setOnClickListener(new aent(this, i1, i2));
        s();
        this.jdField_a_of_type_ComTencentWidgetPinnedDividerSwipListView.addHeaderView(this.jdField_e_of_type_AndroidViewView);
        bcef.b(this.app, "dc00899", "Grp_mber", "", "mber_list", "exp_inacmem", 0, 0, this.jdField_b_of_type_JavaLangString, "" + i2, "", "");
        return;
      }
    }
  }
  ...
  private void s()
  {
    ...
    {
      localObject = this.jdField_e_of_type_AndroidViewView.findViewById(2131376421);
  ...
  private void t()
  {
    ...
    this.jdField_b_of_type_AndroidAppDialog.setContentView(2131562742);
    ...
    if ((ImmersiveUtils.isSupporImmersive() == 1) && (Build.VERSION.SDK_INT < 24))
    {
      ...
      View localView = this.jdField_b_of_type_AndroidAppDialog.findViewById(2131376679);
      localView.setFitsSystemWindows(true);
      localView.setPadding(0, ImmersiveUtils.b(), 0, 0);
    }
    this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)this.jdField_b_of_type_AndroidAppDialog.findViewById(2131376881));
    ...
    this.jdField_a_of_type_Aepb = new aepb(this, this.jdField_b_of_type_JavaUtilList);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Aepb);
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnTouchListener(new aenu(this, (InputMethodManager)localObject));
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)this.jdField_b_of_type_AndroidAppDialog.findViewById(2131366179));
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new aepd(this));
    this.jdField_c_of_type_AndroidViewView = this.jdField_b_of_type_AndroidAppDialog.findViewById(2131376679);
    this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)this.jdField_b_of_type_AndroidAppDialog.findViewById(2131368234));
    this.jdField_b_of_type_AndroidViewView = this.jdField_b_of_type_AndroidAppDialog.findViewById(2131371842);
    this.jdField_c_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_b_of_type_AndroidAppDialog.findViewById(2131376347));
    this.jdField_a_of_type_AndroidWidgetImageButton.setOnClickListener(new aenv(this));
    this.jdField_c_of_type_AndroidWidgetRelativeLayout.setOnClickListener(new aenw(this));
  }
  
  private void u()
  {
    int i1 = this.jdField_a_of_type_Aeoz.jdField_b_of_type_JavaUtilList.size();
    if (i1 > 0)
    {
      String str = MessageFormat.format(amtj.a(2131714644), new Object[] { Integer.valueOf(i1) });
      this.jdField_a_of_type_AndroidWidgetTextView.setEnabled(true);
      this.jdField_a_of_type_AndroidWidgetTextView.setText(str);
      this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new aeoa(this));
      return;
    }
    this.jdField_a_of_type_AndroidWidgetTextView.setEnabled(false);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(amtj.a(2131714670));
  }
  ...
  public aeox a(DiscussionMemberInfo paramDiscussionMemberInfo, amsw paramamsw)
  {
    aeox localaeox = new aeox();
    localaeox.jdField_a_of_type_JavaLangString = paramDiscussionMemberInfo.memberUin.trim();
    Friends localFriends = null;
    if (paramamsw != null) {
      localFriends = paramamsw.b(paramDiscussionMemberInfo.memberUin);
    }
    localaeox.jdField_b_of_type_JavaLangString = paramDiscussionMemberInfo.getDiscussionMemberName();
    localaeox.jdField_a_of_type_Short = 0;
    localaeox.jdField_c_of_type_JavaLangString = ChnToSpell.a(localaeox.jdField_b_of_type_JavaLangString, 2);
    localaeox.a(ChnToSpell.a(localaeox.jdField_b_of_type_JavaLangString, 1));
    if ((localFriends != null) && (localFriends.isFriend()) && (localFriends.remark != null) && (localFriends.remark.length() > 0))
    {
      localaeox.e(localFriends.remark);
      localaeox.h(ChnToSpell.a(localaeox.jdField_j_of_type_JavaLangString, 1));
      localaeox.f(ChnToSpell.a(localaeox.jdField_j_of_type_JavaLangString, 2));
    }
    for (;;)
    {
      if ((paramDiscussionMemberInfo.memberName != null) && (paramDiscussionMemberInfo.memberName.length() > 0))
      {
        localaeox.i(paramDiscussionMemberInfo.memberName);
        localaeox.k(ChnToSpell.a(paramDiscussionMemberInfo.memberName, 1));
        localaeox.j(ChnToSpell.a(paramDiscussionMemberInfo.memberName, 2));
      }
      if (this.jdField_a_of_type_Azwa != null) {
        this.jdField_a_of_type_Azwa.a(localaeox);
      }
      return localaeox;
      if ((paramDiscussionMemberInfo.inteRemark != null) && (paramDiscussionMemberInfo.inteRemark.length() > 0))
      {
        localaeox.e(paramDiscussionMemberInfo.inteRemark);
        localaeox.h(ChnToSpell.a(paramDiscussionMemberInfo.inteRemark, 1));
        localaeox.f(ChnToSpell.a(paramDiscussionMemberInfo.inteRemark, 2));
      }
    }
  }
  
  public aeox a(TroopMemberInfo paramTroopMemberInfo, amsw paramamsw)
  {
    aeox localaeox = new aeox();
    localaeox.jdField_a_of_type_JavaLangString = paramTroopMemberInfo.memberuin.trim();
    Friends localFriends = null;
    if (paramamsw != null) {
      localFriends = paramamsw.b(paramTroopMemberInfo.memberuin);
    }
    localaeox.jdField_b_of_type_JavaLangString = ContactUtils.getTroopMemberName(this.app, this.jdField_b_of_type_JavaLangString, localaeox.jdField_a_of_type_JavaLangString, true);
    localaeox.jdField_a_of_type_Short = paramTroopMemberInfo.faceid;
    localaeox.jdField_c_of_type_JavaLangString = ChnToSpell.a(localaeox.jdField_b_of_type_JavaLangString, 2);
    localaeox.a(ChnToSpell.a(localaeox.jdField_b_of_type_JavaLangString, 1));
    if ((paramTroopMemberInfo.friendnick != null) && (paramTroopMemberInfo.friendnick.length() > 0))
    {
      localaeox.b(paramTroopMemberInfo.friendnick);
      localaeox.d(paramTroopMemberInfo.pyAll_friendnick);
      localaeox.c(paramTroopMemberInfo.pyFirst_friendnick);
    }
    double d1;
    if ((localFriends != null) && (localFriends.isFriend()) && (localFriends.remark != null) && (localFriends.remark.length() > 0))
    {
      ...
      localaeox.h(ChnToSpell.a(localaeox.jdField_j_of_type_JavaLangString, 1));
      localaeox.f(ChnToSpell.a(localaeox.jdField_j_of_type_JavaLangString, 2));
      localaeox.g(localFriends.remark);
      if ((paramTroopMemberInfo.troopColorNick != null) && (paramTroopMemberInfo.troopColorNick.length() > 0))
      {
        localaeox.i(paramTroopMemberInfo.troopColorNick);
        localaeox.k(paramTroopMemberInfo.pyAll_troopnick);
        localaeox.j(paramTroopMemberInfo.pyFirst_troopnick);
      }
      localaeox.jdField_b_of_type_Long = paramTroopMemberInfo.last_active_time;
      localaeox.jdField_a_of_type_Long = paramTroopMemberInfo.join_time;
      localaeox.jdField_a_of_type_Int = paramTroopMemberInfo.level;
      localaeox.jdField_c_of_type_Int = paramTroopMemberInfo.realLevel;
      localaeox.jdField_d_of_type_Int = paramTroopMemberInfo.newRealLevel;
      localaeox.jdField_d_of_type_Long = paramTroopMemberInfo.credit_level;
      localaeox.jdField_a_of_type_Boolean = paramTroopMemberInfo.isTroopFollowed;
      localaeox.jdField_c_of_type_Long = paramTroopMemberInfo.active_point;
      localaeox.jdField_b_of_type_Boolean = paramTroopMemberInfo.mIsShielded;
      localaeox.jdField_e_of_type_Int = paramTroopMemberInfo.globalTroopLevel;
      d1 = ((TroopManager)this.app.getManager(52)).a(this.jdField_b_of_type_JavaLangString, localaeox.jdField_a_of_type_JavaLangString);
      ...
      localaeox.t = ((int)d1 + "km");
    }
    for (;;)
    {
      if ((paramTroopMemberInfo.mUniqueTitleExpire - NetConnInfoCenter.getServerTime() > 0L) || (paramTroopMemberInfo.mUniqueTitleExpire == -1))
      {
        localaeox.u = paramTroopMemberInfo.mUniqueTitle;
        localaeox.jdField_b_of_type_Int = paramTroopMemberInfo.mUniqueTitleExpire;
      }
      if (this.jdField_a_of_type_Azwa != null) {
        this.jdField_a_of_type_Azwa.a(localaeox);
      }
      localaeox.jdField_f_of_type_Int = paramTroopMemberInfo.mVipType;
      localaeox.jdField_g_of_type_Int = paramTroopMemberInfo.mVipLevel;
      localaeox.jdField_h_of_type_Int = paramTroopMemberInfo.mBigClubTemplateId;
      localaeox.jdField_i_of_type_Int = paramTroopMemberInfo.mBigClubVipType;
      localaeox.jdField_j_of_type_Int = paramTroopMemberInfo.mBigClubVipLevel;
      localaeox.jdField_k_of_type_Int = paramTroopMemberInfo.mBigClubTemplateId;
      localaeox.v = paramTroopMemberInfo.honorList;
      return localaeox;
      ...
      {
        localaeox.e(TroopInfo.QIDIAN_TROOP_MEMBER_DEF_NICK);
        localaeox.h(ChnToSpell.a(TroopInfo.QIDIAN_TROOP_MEMBER_DEF_NICK, 1));
        localaeox.f(ChnToSpell.a(TroopInfo.QIDIAN_TROOP_MEMBER_DEF_NICK, 2));
        break;
      }
      localaeox.e(paramTroopMemberInfo.autoremark);
      localaeox.h(paramTroopMemberInfo.pyAll_autoremark);
      localaeox.f(paramTroopMemberInfo.pyFirst_autoremark);
      break;
      label678:
      localaeox.t = (this.jdField_a_of_type_JavaTextDecimalFormat.format(d1) + "km");
      continue;
      label713:
      localaeox.t = "";
    }
  ...
  public aeox a(String paramString)
  {
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          aeox localaeox = (aeox)this.jdField_a_of_type_JavaUtilList.get(i1);
          if ((localaeox != null) && (localaeox.jdField_a_of_type_JavaLangString.equals(paramString)))
          {
            paramString = (aeox)this.jdField_a_of_type_JavaUtilList.remove(i1);
            return paramString;
          }
        }
        else
  ...
  public aepe a(String paramString, boolean paramBoolean)
  {
    Object localObject1;
    int i2;
    int i1;
    ...
    for (;;)
    {
      ...
      if ((((View)localObject2).getTag() != null) && ((((View)localObject2).getTag() instanceof aepe)))
      {
        localObject2 = (aepe)((View)localObject2).getTag();
        if ((((aepe)localObject2).jdField_a_of_type_JavaLangString != null) && (((aepe)localObject2).jdField_a_of_type_JavaLangString.equals(paramString)))
        {
          if (QLog.isColorLevel()) {
  ...
  public List<aeox> a(List<aeox> paramList, String paramString1, String paramString2)
  {
    int i5 = 1;
    ...
    if (i6 > 0)
    {
      ...
      if (i1 < i6)
      {
        aeox localaeox = (aeox)paramList.get(i1);
        if ((paramString1 != null) && (paramString1.equals(localaeox.jdField_a_of_type_JavaLangString)))
        {
          paramList.remove(i1);
          paramList.add(0, localaeox);
        }
      }
      else
      {
        ...
        paramString1 = (aeox)paramList.get(i3);
    ...
    for (int i1 = i2 + 1;; i1 = i2)
    {
      ...
      if (i4 < i6)
      {
        paramString1 = (aeox)paramList.get(i4);
      ...
      for (;;)
      {
        ...
        if (i2 < i6)
        {
          paramString1 = (aeox)paramList.get(i2);
  ...
  {
    int i1 = 3;
    if ((paramaeox != null) && (paramaeox.jdField_c_of_type_Boolean))
    {
      this.jdField_a_of_type_Aeoz.jdField_a_of_type_JavaUtilList.clear();
      paramaeox = new Intent();
      paramaeox.putExtra("result", new JSONArray().toString());
      setResult(-1, paramaeox);
      bcef.b(this.app, "P_CliOper", "Grp_work", "", "create", "Clk_none", 0, 0, this.jdField_b_of_type_JavaLangString, "", "", "");
      finish();
    }
    label94:
    label633:
    do
    {
      do
      {
        ...
        do
        {
          ...
          {
            return;
          } while ((paramaeox == null) || (paramaeox.jdField_a_of_type_JavaLangString == null));
          if (this.jdField_d_of_type_Int == 1)
          {
            if (this.app.getCurrentAccountUin().equals(paramaeox.jdField_a_of_type_JavaLangString))
            {
              localObject1 = new ProfileActivity.AllInOne(paramaeox.jdField_a_of_type_JavaLangString, 0);
              ((ProfileActivity.AllInOne)localObject1).jdField_h_of_type_JavaLangString = ContactUtils.getAccountNickName(this.app, paramaeox.jdField_a_of_type_JavaLangString);
            ...
            a(paramaeox.jdField_a_of_type_JavaLangString, paramaeox.jdField_b_of_type_JavaLangString);
            return;
          }
          if (this.jdField_d_of_type_Int == 2)
          {
            ...
            ((Intent)localObject1).putExtra("member_uin", paramaeox.jdField_a_of_type_JavaLangString);
            localObject2 = new TroopMemberListActivity.TroopAdmin();
            ((TroopMemberListActivity.TroopAdmin)localObject2).jdField_a_of_type_JavaLangString = paramaeox.jdField_a_of_type_JavaLangString;
            ((TroopMemberListActivity.TroopAdmin)localObject2).jdField_a_of_type_Short = paramaeox.jdField_a_of_type_Short;
            ((TroopMemberListActivity.TroopAdmin)localObject2).jdField_b_of_type_JavaLangString = paramaeox.jdField_b_of_type_JavaLangString;
          ...
          if ((this.jdField_d_of_type_Int == 3) || (this.jdField_d_of_type_Int == 11) || (this.jdField_d_of_type_Int == 16))
          {
            ...
            if (this.jdField_o_of_type_Boolean)
            {
              ((Intent)localObject1).putExtra("member_display_name", paramaeox.jdField_b_of_type_JavaLangString);
          ...
          e(paramaeox.jdField_a_of_type_JavaLangString);
        } while (this.jdField_d_of_type_Int != 22);
        bftc.a("Grp_idol", "mber_list", "clk", 0, 0, new String[] { this.jdField_b_of_type_JavaLangString });
        return;
        if (this.jdField_d_of_type_Int == 5)
        {
          if ((this.jdField_e_of_type_JavaLangString != null) && (this.jdField_e_of_type_JavaLangString.equals(paramaeox.jdField_a_of_type_JavaLangString)))
          {
            startActivityForResult(EditUniqueTitleActivity.a(this, 1, this.jdField_b_of_type_JavaLangString, paramaeox.jdField_a_of_type_JavaLangString, i1, paramaeox.u), 2);
            this.v = paramaeox.jdField_a_of_type_JavaLangString;
          ...
          for (paramaeox = "1";; paramaeox = "0")
          {
            bcef.b((QQAppInterface)localObject1, "P_CliOper", "Grp_manage", "", "mber_title", "Clk_person_list", 0, 0, (String)localObject2, String.valueOf(i1), paramaeox, "");
            return;
            if ((this.jdField_f_of_type_JavaLangString != null) && (this.jdField_f_of_type_JavaLangString.contains(paramaeox.jdField_a_of_type_JavaLangString)))
            {
              i1 = 2;
              break;
            }
        ...
        if (this.jdField_d_of_type_Int == 14)
        {
          localObject1 = getIntent();
          ((Intent)localObject1).putExtra("member_uin", paramaeox.jdField_a_of_type_JavaLangString);
          ((Intent)localObject1).putExtra("member_nickname", paramaeox.jdField_g_of_type_JavaLangString);
          ((Intent)localObject1).putExtra("member_display_name", paramaeox.jdField_b_of_type_JavaLangString);
          ((Intent)localObject1).putExtra("troop_uin", this.jdField_b_of_type_JavaLangString);
        ...
        if ((this.jdField_d_of_type_Int == 12) || (this.jdField_d_of_type_Int == 20))
        {
          ...
          {
            this.jdField_a_of_type_Aeoz.jdField_a_of_type_JavaUtilList.clear();
            this.jdField_a_of_type_Aeoz.jdField_a_of_type_JavaUtilList.add(paramaeox);
            paramaeox = new Intent();
            localObject1 = new JSONArray();
            if (this.jdField_a_of_type_Aeoz.jdField_a_of_type_JavaUtilList != null)
            {
              localObject2 = this.jdField_a_of_type_Aeoz.jdField_a_of_type_JavaUtilList.iterator();
              for (;;)
              {
                if (((Iterator)localObject2).hasNext())
                {
                  aeox localaeox = (aeox)((Iterator)localObject2).next();
                  JSONObject localJSONObject = new JSONObject();
                  try
                  {
                    localJSONObject.put("uin", localaeox.jdField_a_of_type_JavaLangString);
                    localJSONObject.put("nick", localaeox.jdField_b_of_type_JavaLangString);
            ...
            paramaeox.putExtra("result", ((JSONArray)localObject1).toString());
            setResult(-1, paramaeox);
            finish();
            return;
          }
          if (this.jdField_a_of_type_Aeoz.jdField_a_of_type_JavaUtilList.contains(paramaeox)) {
            this.jdField_a_of_type_Aeoz.jdField_a_of_type_JavaUtilList.remove(paramaeox);
          }
          for (;;)
          {
            this.jdField_a_of_type_Aeoz.notifyDataSetChanged();
            return;
            if (this.jdField_a_of_type_Aeoz.jdField_a_of_type_JavaUtilList.size() < this.jdField_f_of_type_Int)
            {
              this.jdField_a_of_type_Aeoz.jdField_a_of_type_JavaUtilList.add(paramaeox);
            }
      ...
      paramaeox = ((TroopManager)this.app.getManager(52)).b(this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, this.app.getCurrentAccountUin());
      bftc.a("Grp_edu", "teachermsg", "showsomeone", 0, 0, new String[] { this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, bftc.a(paramaeox) });
      return;
    ...
    ((Intent)localObject1).putExtra("filter_member_name", paramaeox.jdField_g_of_type_JavaLangString);
    ((Intent)localObject1).putExtra("filter_uin", Long.valueOf(paramaeox.jdField_a_of_type_JavaLangString));
  ...
  public void a(aepe paramaepe, aeox paramaeox, Bitmap paramBitmap, boolean paramBoolean1, boolean paramBoolean2)
  {
    String str;
    label84:
    Object localObject;
    ...
    {
      str = this.u;
      paramaepe.jdField_a_of_type_Boolean = paramBoolean1;
      paramaepe.jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setVisibility(0);
      paramaepe.jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
      paramaepe.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
      paramaepe.jdField_c_of_type_AndroidWidgetImageView.setImageBitmap(paramBitmap);
      if ((this.jdField_m_of_type_Int != 1) && (this.jdField_m_of_type_Int != 5)) {
        break label883;
      }
      if (paramaeox.jdField_d_of_type_Boolean) {
        break label870;
      }
      paramaepe.jdField_c_of_type_AndroidWidgetImageView.setAlpha(165);
      if ((this.jdField_b_of_type_Boolean) || (a()) || (paramaeox.jdField_e_of_type_Int == -100) || (paramaeox.jdField_e_of_type_Int == 0)) {
        break label905;
      }
      paramaepe.j.setVisibility(8);
      paramaepe.j.setText("LV" + paramaeox.jdField_e_of_type_Int);
      VipUtils.a(this.app, this, getResources(), paramaepe, paramaeox);
      if ((this.jdField_d_of_type_Int != 13) || (!paramBoolean1)) {
        break label917;
      }
      paramBitmap = paramaeox.jdField_b_of_type_JavaLangString + "(" + paramaeox.jdField_a_of_type_JavaLangString + ")";
      localObject = new SpannableString(paramBitmap);
      ((SpannableString)localObject).setSpan(new ForegroundColorSpan(-7829368), paramaeox.jdField_b_of_type_JavaLangString.length(), paramBitmap.length(), 18);
      paramaepe.jdField_e_of_type_AndroidWidgetTextView.setText((CharSequence)localObject);
      label265:
      if ((paramBoolean2) && (paramaepe.k != null))
      {
        paramBitmap = amtj.a(2131714564) + paramaeox.jdField_j_of_type_JavaLangString;
        paramaepe.k.setText(paramBitmap);
      }
      paramaepe.jdField_a_of_type_JavaLangString = paramaeox.jdField_a_of_type_JavaLangString;
      paramaepe.jdField_c_of_type_Int = 1;
      paramaepe.f.setText("");
      paramaepe.jdField_c_of_type_AndroidViewView.setTag(Boolean.valueOf(paramBoolean1));
      if (this.jdField_d_of_type_Int != 9) {
        break label1002;
      }
      paramaepe.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
      if (paramaepe.jdField_a_of_type_ComTencentMobileqqTroopTroopMemberLevelTroopMemberNewLevelView != null) {
        paramaepe.jdField_a_of_type_ComTencentMobileqqTroopTroopMemberLevelTroopMemberNewLevelView.setVisibility(8);
      }
      paramaepe.g.setOnClickListener(this.jdField_d_of_type_AndroidViewView$OnClickListener);
      paramaepe.jdField_b_of_type_AndroidViewView.setOnClickListener(this.jdField_d_of_type_AndroidViewView$OnClickListener);
      paramaepe.jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setOnClickListener(this.jdField_c_of_type_AndroidViewView$OnClickListener);
      if ((!this.jdField_c_of_type_Boolean) && (!this.jdField_d_of_type_Boolean)) {
        break label1017;
      }
      paramaepe.jdField_a_of_type_AndroidViewView.setOnClickListener(this.jdField_d_of_type_AndroidViewView$OnClickListener);
      paramaepe.jdField_a_of_type_AndroidViewView.setClickable(true);
      if (this.jdField_d_of_type_Boolean) {
        paramaepe.jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setOnClickListener(null);
      }
      label461:
      i5 = 0;
      ...
      paramaepe.jdField_e_of_type_AndroidWidgetTextView.setContentDescription(getString(2131691667) + paramaepe.jdField_e_of_type_AndroidWidgetTextView.getText().toString());
      paramaepe.jdField_c_of_type_AndroidViewView.setBackgroundResource(2130849590);
      if (this.jdField_d_of_type_Int != 13) {
        break label1064;
      }
      paramaepe.jdField_b_of_type_AndroidViewView.setVisibility(0);
      label550:
      if (!str.equals(paramaeox.jdField_a_of_type_JavaLangString)) {
        break label1136;
      }
      paramaepe.jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.a(false);
    }
    int i1;
    int i2;
    for (;;)
    {
      paramaepe.jdField_b_of_type_AndroidViewView.setContentDescription(String.format(getString(2131691652), new Object[] { paramaepe.jdField_e_of_type_AndroidWidgetTextView.getText().toString() }));
      paramaepe.g.setContentDescription(getString(2131691651));
      i1 = i5;
      if (paramaepe.jdField_d_of_type_AndroidViewView != null)
      {
        paramBitmap = (bfdm)this.app.getManager(203);
        if ((paramBitmap == null) || (!paramBitmap.b(paramaeox.jdField_a_of_type_JavaLangString))) {
          break label2999;
        }
        i2 = 1;
        label663:
        ...
        paramaepe.jdField_d_of_type_AndroidViewView.setVisibility(0);
      }
      label676:
      ...
      paramBitmap.append(paramaepe.jdField_e_of_type_AndroidWidgetTextView.getText().toString());
      if ((paramBoolean2) && (paramaepe.k != null)) {
        paramBitmap.append(paramaepe.k.getText());
      }
      if (paramaepe.jdField_c_of_type_AndroidWidgetTextView.getVisibility() == 0) {
        paramBitmap.append(paramaepe.jdField_c_of_type_AndroidWidgetTextView.getText().toString());
      }
      if (paramaepe.j.getVisibility() == 0) {
        paramBitmap.append(paramaepe.j.getText().toString());
      }
      if (paramaepe.jdField_a_of_type_ComTencentMobileqqTroopHonorWidgetTroopHonorView.getVisibility() == 0) {
        paramBitmap.append(paramaepe.jdField_a_of_type_ComTencentMobileqqTroopHonorWidgetTroopHonorView.a());
      }
      if ((paramaepe.jdField_b_of_type_AndroidViewView.getVisibility() == 0) && (this.jdField_d_of_type_Boolean))
      {
        if (i1 == 0) {
          break label3017;
        }
        paramaeox = "已选中";
        label843:
        paramBitmap.append(paramaeox);
      }
      paramaepe.jdField_a_of_type_AndroidViewView.setContentDescription(paramBitmap.toString());
      return;
      str = this.t;
      break;
      label870:
      paramaepe.jdField_c_of_type_AndroidWidgetImageView.setAlpha(255);
      break label84;
      label883:
      paramaepe.jdField_c_of_type_AndroidWidgetImageView.setAlpha(255);
      paramaepe.j.setVisibility(8);
      ...
      if (paramBoolean2)
      {
        paramBitmap = new bczs(paramaeox.jdField_g_of_type_JavaLangString, 16).a();
        paramaepe.jdField_e_of_type_AndroidWidgetTextView.setText(paramBitmap);
        bgdk.a(this.app, paramaepe.jdField_e_of_type_AndroidWidgetTextView, paramBitmap);
        break label265;
      }
      paramBitmap = new bczs(paramaeox.jdField_b_of_type_JavaLangString, 16).a();
      paramaepe.jdField_e_of_type_AndroidWidgetTextView.setText(paramBitmap);
      bgdk.a(this.app, paramaepe.jdField_e_of_type_AndroidWidgetTextView, paramBitmap);
      break label265;
      label1002:
      paramaepe.jdField_c_of_type_AndroidWidgetTextView.setTag(Boolean.valueOf(paramBoolean1));
      break label380;
      label1017:
      if (this.jdField_d_of_type_Int == 21)
      {
        paramaepe.jdField_a_of_type_AndroidViewView.setOnClickListener(null);
        paramaepe.jdField_a_of_type_AndroidViewView.setClickable(false);
        break label461;
      }
      paramaepe.jdField_a_of_type_AndroidViewView.setOnClickListener(null);
      paramaepe.jdField_a_of_type_AndroidViewView.setClickable(false);
      ...
      if ((this.jdField_e_of_type_JavaLangString != null) && (!paramaeox.jdField_a_of_type_JavaLangString.equals(this.jdField_e_of_type_JavaLangString)))
      {
        paramaepe.jdField_b_of_type_AndroidViewView.setVisibility(0);
        break label550;
      }
      paramaepe.jdField_b_of_type_AndroidViewView.setVisibility(8);
      paramaepe.jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.b(false);
      break label550;
      label1136:
      paramaepe.jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.b(false);
    }
    label1147:
    paramaepe.jdField_c_of_type_AndroidWidgetTextView.setText("");
    label1169:
    boolean bool1;
    label1193:
    boolean bool2;
    ...
    boolean bool4;
    boolean bool5;
    if (!TextUtils.isEmpty(paramaeox.u))
    {
      paramBoolean1 = true;
      if ((paramaeox.jdField_a_of_type_JavaLangString == null) || (!paramaeox.jdField_a_of_type_JavaLangString.equals(this.jdField_e_of_type_JavaLangString))) {
        break label1500;
      }
      bool1 = true;
      if ((this.jdField_f_of_type_JavaLangString == null) || (paramaeox.jdField_a_of_type_JavaLangString == null) || (!this.jdField_f_of_type_JavaLangString.contains(paramaeox.jdField_a_of_type_JavaLangString))) {
        break label1506;
      }
      bool2 = true;
      bool4 = this.app.getCurrentAccountUin().equals(this.jdField_e_of_type_JavaLangString);
      bool5 = this.app.getCurrentAccountUin().equals(paramaeox.jdField_a_of_type_JavaLangString);
      if (this.jdField_d_of_type_Int != 5) {
        break label1669;
      }
      paramaepe.h.setVisibility(0);
      paramaepe.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
      if (paramaepe.jdField_a_of_type_ComTencentMobileqqTroopTroopMemberLevelTroopMemberNewLevelView != null) {
        paramaepe.jdField_a_of_type_ComTencentMobileqqTroopTroopMemberLevelTroopMemberNewLevelView.setVisibility(8);
      }
      paramaepe.jdField_a_of_type_ComTencentMobileqqTroopHonorWidgetTroopHonorView.setVisibility(8);
      paramaepe.i.setVisibility(0);
      if (bewy.a(this.jdField_b_of_type_JavaLangString)) {
        break label1631;
      }
      localObject = "";
      i2 = 0;
    ...
    for (;;)
    {
      ...
      {
        paramaepe.h.setText(paramBitmap);
        beda.a(paramaepe.h, i1);
      }
      label1397:
      bedb localbedb;
      for (;;)
      {
        ...
        localbedb = beda.a().a(301, paramBoolean1, bool1, bool2);
        i1 = i2;
        paramBitmap = (Bitmap)localObject;
        if (localbedb == null) {
          break label1373;
        ...
        paramBitmap = localbedb.jdField_a_of_type_JavaLangString;
        break label1373;
        paramaepe.h.setVisibility(8);
        continue;
        label1631:
        paramBitmap = bewy.a(this.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo, paramaeox.jdField_a_of_type_JavaLangString, paramaeox.u);
        if ((paramBitmap != null) && (paramaepe.jdField_a_of_type_ComTencentMobileqqTroopTroopMemberLevelTroopMemberNewLevelView != null)) {
          paramaepe.jdField_a_of_type_ComTencentMobileqqTroopTroopMemberLevelTroopMemberNewLevelView.setTroopMemberNewLevel(paramBitmap);
        }
      }
      label1669:
      i1 = 0;
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          paramaepe.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
          paramaepe.jdField_c_of_type_AndroidWidgetTextView.setText((CharSequence)localObject);
          beda.a(paramaepe.jdField_c_of_type_AndroidWidgetTextView, i4);
          label1933:
          paramBitmap = (bepr)this.app.getManager(346);
          if (!paramBitmap.b(this.jdField_b_of_type_JavaLangString)) {
            break label2509;
          }
          paramBitmap = paramBitmap.a(paramaeox.v);
          if ((paramBitmap == null) || (paramBitmap.size() <= 0)) {
            break label2489;
          }
          paramaepe.jdField_a_of_type_ComTencentMobileqqTroopHonorWidgetTroopHonorView.setHonorList(paramBitmap, 2);
          paramaepe.jdField_a_of_type_ComTencentMobileqqTroopHonorWidgetTroopHonorView.setVisibility(0);
          label1997:
          if (this.jdField_b_of_type_Boolean)
          {
            ...
            if (paramaepe.jdField_b_of_type_ComTencentMobileqqTroopTroopMemberLevelTroopMemberNewLevelView != null) {
              paramaepe.jdField_b_of_type_ComTencentMobileqqTroopTroopMemberLevelTroopMemberNewLevelView.setVisibility(8);
            }
            paramBitmap = beda.a().a(paramaeox.jdField_a_of_type_Int, false, false, false);
            if ((paramBitmap == null) || (!beyy.a(paramaeox.jdField_a_of_type_Int))) {
              break label2541;
            }
            if ((TextUtils.isEmpty(paramBitmap.jdField_a_of_type_JavaLangString)) || (bbyp.b())) {
              break label2529;
            }
            paramaepe.jdField_d_of_type_AndroidWidgetTextView.setVisibility(0);
            paramaepe.jdField_d_of_type_AndroidWidgetTextView.setText(paramBitmap.jdField_a_of_type_JavaLangString);
            beda.a(paramaepe.jdField_d_of_type_AndroidWidgetTextView, paramBitmap.jdField_b_of_type_Int);
          }
        }
        for (;;)
        {
          ...
          if ((paramaeox.jdField_a_of_type_JavaLangString == null) || (!paramaeox.jdField_a_of_type_JavaLangString.equals(this.app.getCurrentAccountUin()))) {
            break label2702;
          }
          paramaepe.f.setText(getString(2131694024));
          break label1397;
          localbedb = beda.a().a(paramaeox.jdField_a_of_type_Int, paramBoolean1, bool1, bool2);
          if (localbedb != null)
          {
            localObject = localbedb.jdField_a_of_type_JavaLangString;
            i2 = localbedb.jdField_b_of_type_Int;
            if (localbedb.jdField_a_of_type_Int == 302) {
              localObject = paramaeox.u;
            }
            paramBitmap = (Bitmap)localObject;
            i1 = i2;
            if (this.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo == null) {
            ...
            paramBitmap = (String)this.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo.getTroopLevelMap().get(Integer.valueOf(paramaeox.jdField_c_of_type_Int));
            i1 = i2;
            break label1733;
          }
          if ((this.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo == null) || (paramaeox.jdField_a_of_type_Int != 315)) {
            break label3024;
          }
          paramBitmap = (String)this.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo.getTroopLevelMap().get(Integer.valueOf(paramaeox.jdField_c_of_type_Int));
          ...
          paramaepe.jdField_a_of_type_ComTencentMobileqqTroopTroopMemberLevelTroopMemberNewLevelView.setVisibility(8);
          i2 = paramaeox.jdField_d_of_type_Int;
          i1 = i2;
          if (i2 == 0) {
            i1 = bewy.b(paramaeox.jdField_c_of_type_Int);
          }
          paramBitmap = bewy.a(this.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo, paramaeox.jdField_a_of_type_JavaLangString, i1, paramaeox.jdField_a_of_type_Int, paramaeox.u);
          if (paramBitmap == null) {
            break;
          }
          paramaepe.jdField_a_of_type_ComTencentMobileqqTroopTroopMemberLevelTroopMemberNewLevelView.setTroopMemberNewLevel(paramBitmap);
          break label1933;
          label2489:
          paramaepe.jdField_a_of_type_ComTencentMobileqqTroopHonorWidgetTroopHonorView.setHonorList(null);
          paramaepe.jdField_a_of_type_ComTencentMobileqqTroopHonorWidgetTroopHonorView.setVisibility(8);
          break label1997;
          label2509:
          paramaepe.jdField_a_of_type_ComTencentMobileqqTroopHonorWidgetTroopHonorView.setHonorList(null);
          ...
          break label1997;
          label2529:
          paramaepe.jdField_d_of_type_AndroidWidgetTextView.setVisibility(8);
          continue;
          label2541:
          paramaepe.jdField_d_of_type_AndroidWidgetTextView.setVisibility(8);
          continue;
          ...
          if (paramaepe.jdField_b_of_type_ComTencentMobileqqTroopTroopMemberLevelTroopMemberNewLevelView != null)
          {
            ...
            if (bool1)
            {
              ...
              paramBitmap.jdField_a_of_type_ArrayOfInt = bewy.a(paramBitmap.jdField_a_of_type_Int);
              paramBitmap.jdField_a_of_type_JavaLangString = amtj.a(2131714747);
              paramaepe.jdField_b_of_type_ComTencentMobileqqTroopTroopMemberLevelTroopMemberNewLevelView.setTroopMemberNewLevel(paramBitmap);
            }
            else if (bool2)
            {
              paramBitmap = new bewz();
              ...
              paramBitmap.jdField_a_of_type_ArrayOfInt = bewy.a(paramBitmap.jdField_a_of_type_Int);
              paramBitmap.jdField_a_of_type_JavaLangString = amtj.a(2131714736);
              paramaepe.jdField_b_of_type_ComTencentMobileqqTroopTroopMemberLevelTroopMemberNewLevelView.setTroopMemberNewLevel(paramBitmap);
            }
          }
        }
        ...
        if (this.jdField_d_of_type_Boolean)
        {
          ...
          for (;;)
          {
            ...
            break label2810;
            paramaepe.jdField_b_of_type_AndroidViewView.setVisibility(0);
            if ((paramaeox.jdField_a_of_type_JavaLangString != null) && (this.jdField_a_of_type_Aeoz.jdField_b_of_type_JavaUtilList.contains(paramaeox.jdField_a_of_type_JavaLangString)))
            {
              paramaepe.jdField_c_of_type_AndroidViewView.setBackgroundResource(2130840530);
              i1 = 1;
            }
            else
            {
              paramaepe.jdField_c_of_type_AndroidViewView.setBackgroundResource(2130840526);
              i1 = 0;
            }
          }
        }
        ...
        {
          paramaepe.jdField_b_of_type_AndroidViewView.setVisibility(0);
          if ((paramaeox.jdField_a_of_type_JavaLangString != null) && (this.jdField_a_of_type_Aeoz.jdField_a_of_type_JavaUtilList.contains(paramaeox)))
          {
            paramaepe.jdField_c_of_type_AndroidViewView.setBackgroundResource(2130840530);
            i1 = 1;
            break;
        ...
        break label663;
        label3005:
        paramaepe.jdField_d_of_type_AndroidViewView.setVisibility(8);
        break label676;
        label3017:
        paramaeox = "未选中";
        break label843;
  ...
  public void a(String paramString)
  {
    ...
    {
      return;
      i1 = this.jdField_a_of_type_Aeoz.a(paramString);
    } while (i1 == -1);
  ...
  public void a(String paramString, int paramInt)
  {
    if ("$".equals(paramString)) {
      if ((this.jdField_d_of_type_Int == 11) && (paramInt == 1)) {
        bcef.b(this.app, "CliOper", "", "", "0X800621B", "0X800621B", 0, 0, "", "", "", "");
      }
    }
    while ((this.jdField_d_of_type_Int != 11) || (paramInt != 0)) {
      return;
    }
    bcef.b(this.app, "CliOper", "", "", "0X800621A", "0X800621A", 0, 0, "", "", "", "");
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    catch (Exception paramString1)
    {
      ...
      label179:
      bcef.b(this.app, "P_CliOper", "Grp_mber", "", "mber_list", paramString1, 0, 0, this.jdField_b_of_type_JavaLangString, paramString2, paramString3, "");
    }
    bcef.b(this.app, "P_CliOper", "Grp_pay", "", paramString2, paramString1, 0, 0, this.jdField_b_of_type_JavaLangString, paramString3, "", "");
    return;
  }
  ...
  public void a(String paramString, List<TroopMemberInfo> paramList)
  {
    ...
    //   59: aload_0
    //   60: invokestatic 966	java/lang/System:currentTimeMillis	()J
    ...
    //   94: invokevirtual 1964	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lcom/tencent/mobileqq/data/QQEntityManagerFactory;
    //   97: invokevirtual 1970	com/tencent/mobileqq/data/QQEntityManagerFactory:createEntityManager	()Lcom/tencent/mobileqq/persistence/EntityManager;
    //   100: astore 8
    //   102: aload 8
    //   104: iconst_1
    //   105: ldc_w 619
    //   108: invokevirtual 1975	java/lang/Class:getSimpleName	()Ljava/lang/String;
    //   111: bipush 20
    ...
    //   263: aconst_null
    //   264: aconst_null
    //   265: invokevirtual 2006	com/tencent/mobileqq/persistence/EntityManager:query	(ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   268: astore_1
    //   269: aload_1
    //   270: ifnull +302 -> 572
    //   273: aload_1
    //   274: invokeinterface 2011 1 0
    //   279: ifeq +287 -> 566
    //   282: new 619	com/tencent/mobileqq/data/troop/TroopMemberInfo
    //   285: dup
    //   286: invokespecial 2012	com/tencent/mobileqq/data/troop/TroopMemberInfo:<init>	()V
    //   289: astore 9
    //   291: aload 9
    //   293: aload_1
    //   294: iconst_0
    //   295: invokeinterface 2013 2 0
    //   300: putfield 622	com/tencent/mobileqq/data/troop/TroopMemberInfo:memberuin	Ljava/lang/String;
    //   303: aload 9
    //   305: aload_1
    //   306: iconst_1
    //   307: invokeinterface 2013 2 0
    //   312: invokestatic 2016	java/lang/Boolean:parseBoolean	(Ljava/lang/String;)Z
    //   315: putfield 1378	com/tencent/mobileqq/data/troop/TroopMemberInfo:mIsShielded	Z
    //   318: aload 9
    //   320: aload_1
    //   321: iconst_2
    //   322: invokeinterface 2013 2 0
    //   327: putfield 1405	com/tencent/mobileqq/data/troop/TroopMemberInfo:mUniqueTitle	Ljava/lang/String;
    //   330: aload 9
    //   332: aload_1
    //   333: iconst_3
    //   334: invokeinterface 2019 2 0
    //   339: putfield 1353	com/tencent/mobileqq/data/troop/TroopMemberInfo:level	I
    //   342: aload 9
    //   344: aload_1
    //   345: iconst_4
    //   346: invokeinterface 2023 2 0
    //   351: putfield 1374	com/tencent/mobileqq/data/troop/TroopMemberInfo:active_point	J
    //   354: aload 9
    //   356: aload_1
    //   357: iconst_5
    //   358: invokeinterface 2023 2 0
    //   363: putfield 1366	com/tencent/mobileqq/data/troop/TroopMemberInfo:credit_level	J
    //   366: aload 9
    //   368: aload_1
    //   369: bipush 6
    //   371: invokeinterface 2023 2 0
    //   376: putfield 1347	com/tencent/mobileqq/data/troop/TroopMemberInfo:last_active_time	J
    //   379: aload 9
    //   381: aload_1
    //   382: bipush 7
    //   384: invokeinterface 2023 2 0
    //   389: putfield 1350	com/tencent/mobileqq/data/troop/TroopMemberInfo:join_time	J
    //   392: aload 9
    //   394: aload_1
    //   395: bipush 8
    //   397: invokeinterface 2013 2 0
    //   402: putfield 2025	com/tencent/mobileqq/data/troop/TroopMemberInfo:troopnick	Ljava/lang/String;
    //   405: aload 9
    //   407: aload_1
    //   408: bipush 9
    //   410: invokeinterface 2013 2 0
    //   415: putfield 1341	com/tencent/mobileqq/data/troop/TroopMemberInfo:pyAll_troopnick	Ljava/lang/String;
    //   418: aload 9
    //   420: aload_1
    //   421: bipush 10
    //   423: invokeinterface 2013 2 0
    //   428: putfield 1344	com/tencent/mobileqq/data/troop/TroopMemberInfo:pyFirst_troopnick	Ljava/lang/String;
    //   431: aload 9
    //   433: aload_1
    //   434: bipush 11
    //   436: invokeinterface 2013 2 0
    //   441: putfield 1321	com/tencent/mobileqq/data/troop/TroopMemberInfo:friendnick	Ljava/lang/String;
    //   444: aload 9
    //   446: aload_1
    //   447: bipush 12
    //   449: invokeinterface 2013 2 0
    //   454: putfield 1326	com/tencent/mobileqq/data/troop/TroopMemberInfo:pyAll_friendnick	Ljava/lang/String;
    //   457: aload 9
    //   459: aload_1
    //   460: bipush 13
    //   462: invokeinterface 2013 2 0
    //   467: putfield 1331	com/tencent/mobileqq/data/troop/TroopMemberInfo:pyFirst_friendnick	Ljava/lang/String;
    //   470: aload 9
    //   472: aload_1
    //   473: bipush 14
    //   475: invokeinterface 2013 2 0
    //   480: putfield 1441	com/tencent/mobileqq/data/troop/TroopMemberInfo:autoremark	Ljava/lang/String;
    //   483: aload 9
    //   485: aload_1
    //   486: bipush 15
    //   488: invokeinterface 2013 2 0
    //   493: putfield 1447	com/tencent/mobileqq/data/troop/TroopMemberInfo:pyAll_autoremark	Ljava/lang/String;
    //   496: aload 9
    //   498: aload_1
    //   499: bipush 16
    //   501: invokeinterface 2013 2 0
    //   506: putfield 1450	com/tencent/mobileqq/data/troop/TroopMemberInfo:pyFirst_autoremark	Ljava/lang/String;
    //   509: aload 9
    //   511: aload_1
    //   512: bipush 17
    //   514: invokeinterface 2019 2 0
    //   519: putfield 1357	com/tencent/mobileqq/data/troop/TroopMemberInfo:realLevel	I
    //   522: aload 9
    //   524: aload_1
    //   525: bipush 18
    //   527: invokeinterface 2013 2 0
    //   532: putfield 1338	com/tencent/mobileqq/data/troop/TroopMemberInfo:troopColorNick	Ljava/lang/String;
    //   535: aload 9
    //   537: aload_1
    //   538: bipush 19
    //   540: invokeinterface 2019 2 0
    //   545: putfield 1362	com/tencent/mobileqq/data/troop/TroopMemberInfo:newRealLevel	I
    //   548: aload_2
    //   549: aload 9
    //   551: invokeinterface 647 2 0
    //   556: pop
    //   557: aload_1
    //   558: invokeinterface 2028 1 0
    //   563: ifne -281 -> 282
    //   566: aload_1
    //   567: invokeinterface 2031 1 0
    //   572: aload 8
    //   574: invokevirtual 2032	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   577: invokestatic 966	java/lang/System:currentTimeMillis	()J
    //   580: lstore 6
    //   582: aload_2
    //   583: astore 8
    ...
    //   614: lsub
    //   615: invokevirtual 2037	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    ...
    //   715: new 2041	com/tencent/mobileqq/activity/TroopMemberListActivity$35
    //   718: dup
    //   719: aload_0
    //   720: aload 8
    //   722: iload_3
    ...
    //   729: isub
    //   730: iload 4
    //   732: invokestatic 2047	java/lang/Math:min	(II)I
    //   735: invokespecial 2050	com/tencent/mobileqq/activity/TroopMemberListActivity$35:<init>	(Lcom/tencent/mobileqq/activity/TroopMemberListActivity;Ljava/util/List;II)V
    //   738: bipush 8
    //   740: aconst_null
    //   741: iconst_1
    //   742: invokestatic 975	com/tencent/mobileqq/app/ThreadManager:post	(Ljava/lang/Runnable;ILcom/tencent/mobileqq/app/ThreadExcutor$IThreadListener;Z)V
    //   745: iload_3
    ...
    //   828: aload_1
    //   829: invokevirtual 1951	java/lang/Exception:toString	()Ljava/lang/String;
    ...
    //   873: aload_1
    //   874: invokevirtual 2057	java/lang/OutOfMemoryError:toString	()Ljava/lang/String;
  ...
  {
    if ((paramArrayOfInt == null) || (paramArrayOfInt.length == 0) || (this.jdField_a_of_type_Aeoz == null)) {
      break label16;
    }
    label16:
    while (this.jdField_a_of_type_Aeoz.jdField_b_of_type_Int + this.jdField_a_of_type_Aeoz.jdField_c_of_type_Int > 16) {
      return;
    }
    int i3 = 1;
    int i1 = 0;
  ...
  protected Object[] a(String paramString)
  {
    ...
    try
    {
      ...
      try
      {
        ...
        this.jdField_c_of_type_JavaUtilList = ((amrb)this.app.getManager(53)).a(paramString);
    ...
    for (;;)
    {
      ...
      localObject = this.jdField_a_of_type_Aeoz.a();
  ...
  public Object[] a(String paramString, List<String> paramList)
  {
    ...
    //   0: aload_0
    //   1: monitorenter
    //   2: invokestatic 966	java/lang/System:currentTimeMillis	()J
    //   5: lstore_3
    ...
    //   24: checkcast 611	amsw
    //   27: astore 6
    //   29: aload_0
    //   30: getfield 603	com/tencent/mobileqq/activity/TroopMemberListActivity:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   33: invokevirtual 1964	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lcom/tencent/mobileqq/data/QQEntityManagerFactory;
    //   36: invokevirtual 1970	com/tencent/mobileqq/data/QQEntityManagerFactory:createEntityManager	()Lcom/tencent/mobileqq/persistence/EntityManager;
    //   39: astore 7
    //   41: aload_2
    //   42: invokeinterface 1009 1 0
    //   47: astore_2
    //   48: aload_2
    //   49: invokeinterface 1014 1 0
    //   54: ifeq +85 -> 139
    //   57: aload 7
    //   59: ldc_w 619
    //   62: iconst_0
    ...
    //   88: aconst_null
    //   89: aconst_null
    //   90: invokevirtual 2118	com/tencent/mobileqq/persistence/EntityManager:query	(Ljava/lang/Class;ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    //   93: astore 8
    //   95: aload 8
    //   97: ifnull -49 -> 48
    //   100: aload 8
    ...
    //   121: checkcast 619	com/tencent/mobileqq/data/troop/TroopMemberInfo
    //   124: aload 6
    //   126: invokevirtual 644	com/tencent/mobileqq/activity/TroopMemberListActivity:a	(Lcom/tencent/mobileqq/data/troop/TroopMemberInfo;Lamsw;)Laeox;
    ...
    //   162: invokestatic 966	java/lang/System:currentTimeMillis	()J
    //   165: lload_3
    //   166: lsub
    //   167: invokevirtual 2037	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
  ...
  protected void b()
  {
    this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131379247));
    ...
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131369061));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131364336));
    ...
    if ((this.jdField_d_of_type_Int == 3) || (this.jdField_d_of_type_Int == 11))
    {
      ...
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131369070));
    ...
    this.jdField_a_of_type_ComTencentWidgetPinnedDividerSwipListView = ((PinnedDividerSwipListView)findViewById(2131379241));
    this.jdField_a_of_type_ComTencentMobileqqWidgetIndexView = ((IndexView)findViewById(2131368648));
    this.jdField_d_of_type_AndroidViewView = findViewById(2131376213);
    this.jdField_e_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131370052));
    this.jdField_d_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131370275));
    ...
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131369083));
  ...
  public void b(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          aeox localaeox = (aeox)this.jdField_b_of_type_JavaUtilList.get(i1);
          if ((localaeox != null) && (localaeox.jdField_a_of_type_JavaLangString.equals(paramString))) {
  ...
  protected void c()
  {
    ...
    for (;;)
    {
      ...
      {
        this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
        this.jdField_c_of_type_AndroidWidgetTextView.setText(amtj.a(2131714582));
      }
      if (this.jdField_d_of_type_Int == 14) {
      ...
      if (this.jdField_d_of_type_Int == 2)
      {
        ...
        this.jdField_d_of_type_AndroidWidgetTextView.setOnClickListener(new aeor(this));
        break;
      }
      if (this.jdField_d_of_type_Int == 3)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130840329);
        this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
        this.jdField_d_of_type_AndroidWidgetTextView.setOnClickListener(new aeos(this));
        break;
      }
      if (this.jdField_d_of_type_Int == 11)
      {
        ...
        this.jdField_d_of_type_AndroidWidgetTextView.setOnClickListener(new aeot(this));
        break;
      }
      if (this.jdField_d_of_type_Int == 5)
      {
        ...
        if (this.jdField_h_of_type_JavaLangString == null) {
          this.jdField_h_of_type_JavaLangString = getString(2131690599);
        }
      ...
      if (this.jdField_d_of_type_Int == 19)
      {
        this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
        this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
        this.jdField_b_of_type_AndroidWidgetTextView.setText(amtj.a(2131714573));
        this.jdField_d_of_type_AndroidWidgetTextView.setOnClickListener(new aeou(this));
        break;
      }
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setText(amtj.a(2131714640));
      if ((this.jdField_j_of_type_JavaLangString != null) && (!TextUtils.isEmpty(this.jdField_j_of_type_JavaLangString))) {
        this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_j_of_type_JavaLangString);
      }
      if (this.jdField_h_of_type_JavaLangString == null) {
  ...
  public void c(String paramString)
  {
    ...
    if ((paramString == null) || (paramString.trim().length() == 0))
    {
      ...
      this.jdField_a_of_type_Aepb.notifyDataSetChanged();
      return;
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localaeox = (aeox)this.jdField_a_of_type_JavaUtilList.get(i1);
        if ((this.jdField_r_of_type_Boolean) && (localbfdm.b(localaeox.jdField_a_of_type_JavaLangString))) {
          break label1142;
        }
        localaeox.jdField_e_of_type_JavaLangString = "";
        localaeox.jdField_f_of_type_JavaLangString = "";
        if ((paramString.equals(localaeox.m)) || (paramString.equals(localaeox.jdField_o_of_type_JavaLangString)) || (paramString.equals(localaeox.jdField_n_of_type_JavaLangString)))
        {
          localaeox.jdField_e_of_type_JavaLangString = localaeox.m;
          localArrayList1.add(localaeox);
          if (!QLog.isColorLevel()) {
            break label1142;
          }
          QLog.d("TroopMemberListActivityget_troop_member", 2, "refreshSearchResultList:" + localaeox.jdField_a_of_type_JavaLangString + "," + localaeox.jdField_e_of_type_JavaLangString);
        }
      }
      finally {}
      if ((paramString.equals(localaeox.jdField_j_of_type_JavaLangString)) || (paramString.equals(localaeox.l)) || (paramString.equals(localaeox.jdField_k_of_type_JavaLangString)))
      {
        localaeox.jdField_e_of_type_JavaLangString = localaeox.jdField_j_of_type_JavaLangString;
        localArrayList1.add(localaeox);
      }
      else if ((paramString.equals(localaeox.jdField_g_of_type_JavaLangString)) || (paramString.equals(localaeox.jdField_i_of_type_JavaLangString)) || (paramString.equals(localaeox.jdField_h_of_type_JavaLangString)))
      {
        localaeox.jdField_e_of_type_JavaLangString = localaeox.jdField_g_of_type_JavaLangString;
        localArrayList1.add(localaeox);
      }
      else if (paramString.equals(localaeox.jdField_a_of_type_JavaLangString))
      {
        if (!this.jdField_e_of_type_Boolean)
        {
          localaeox.jdField_e_of_type_JavaLangString = localaeox.jdField_a_of_type_JavaLangString;
          localArrayList1.add(localaeox);
        }
      }
      else if ((localaeox.m.indexOf(paramString) == 0) || (localaeox.jdField_o_of_type_JavaLangString.indexOf(paramString) == 0) || (localaeox.jdField_n_of_type_JavaLangString.indexOf(paramString) == 0))
      {
        localaeox.jdField_e_of_type_JavaLangString = localaeox.m;
        localaeox.jdField_f_of_type_JavaLangString = localaeox.jdField_n_of_type_JavaLangString;
        localArrayList2.add(localaeox);
      }
      else if ((localaeox.jdField_j_of_type_JavaLangString.indexOf(paramString) == 0) || (localaeox.l.indexOf(paramString) == 0) || (localaeox.jdField_k_of_type_JavaLangString.indexOf(paramString) == 0))
      {
        localaeox.jdField_e_of_type_JavaLangString = localaeox.jdField_j_of_type_JavaLangString;
        localaeox.jdField_f_of_type_JavaLangString = localaeox.jdField_k_of_type_JavaLangString;
        localArrayList2.add(localaeox);
      }
      else if ((localaeox.jdField_g_of_type_JavaLangString.indexOf(paramString) == 0) || (localaeox.jdField_i_of_type_JavaLangString.indexOf(paramString) == 0) || (localaeox.jdField_h_of_type_JavaLangString.indexOf(paramString) == 0))
      {
        localaeox.jdField_e_of_type_JavaLangString = localaeox.jdField_g_of_type_JavaLangString;
        localaeox.jdField_f_of_type_JavaLangString = localaeox.jdField_h_of_type_JavaLangString;
        localArrayList2.add(localaeox);
      }
      else if (localaeox.jdField_a_of_type_JavaLangString.indexOf(paramString) == 0)
      {
        if (!this.jdField_e_of_type_Boolean)
        {
          localaeox.jdField_e_of_type_JavaLangString = localaeox.jdField_a_of_type_JavaLangString;
          localaeox.jdField_f_of_type_JavaLangString = localaeox.jdField_a_of_type_JavaLangString;
          localArrayList2.add(localaeox);
        }
      }
      else if ((localaeox.m.indexOf(paramString) > 0) || (localaeox.jdField_o_of_type_JavaLangString.indexOf(paramString) > 0) || (localaeox.jdField_n_of_type_JavaLangString.indexOf(paramString) > 0))
      ...
      else if ((localaeox.jdField_a_of_type_JavaLangString.indexOf(paramString) > 0) && (!this.jdField_e_of_type_Boolean))
      {
        localaeox.jdField_e_of_type_JavaLangString = localaeox.jdField_a_of_type_JavaLangString;
        localArrayList3.add(localaeox);
        continue;
        label964:
        Collections.sort(localArrayList2, new aepc(this));
  ...
  protected void d()
  {
    ...
    {
      return;
      this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new aenj(this));
      this.jdField_b_of_type_AndroidWidgetImageView.setOnClickListener(new aenk(this));
      if ((this.jdField_d_of_type_Int == 0) || (this.jdField_d_of_type_Int == 9) || (this.jdField_d_of_type_Int == 17) || (this.jdField_d_of_type_Int == 22)) {
        this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new aenl(this));
      }
      while ((this.jdField_e_of_type_Boolean) && (!this.jdField_a_of_type_Boolean) && ((this.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo == null) || (!this.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo.mMemberInvitingFlag) || (this.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo.cGroupOption == 3)))
      {
        ...
        {
          this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new aenm(this));
        }
        else if (this.jdField_d_of_type_Int == 21)
        {
          this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new aenn(this));
        }
      ...
      try
      {
        if (this.jdField_a_of_type_AndroidAppDialog == null)
        {
          ...
          if (this.jdField_d_of_type_Int != 1)
          {
            ...
            ((TextView)this.jdField_a_of_type_AndroidAppDialog.findViewById(2131365552)).setText(getString(2131691650));
          }
        }
        else
        {
          this.jdField_a_of_type_AndroidAppDialog.show();
          this.jdField_a_of_type_Amqx.b(Long.parseLong(this.jdField_a_of_type_JavaLangString), Long.valueOf(paramString).longValue());
          return;
        }
      }
      catch (Exception paramString)
  ...
  public void doOnActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
      ...
      do
      {
        do
        {
          for (;;)
          {
            ...
            ThreadManager.post(new TroopMemberListActivity.1(this, paramIntent, (amsw)localObject1, (TroopManager)localObject2), 8, null, true);
            return;
            if (paramIntent != null)
            {
    ...
    ThreadManager.post(new TroopMemberListActivity.2(this, (amsw)localObject1), 8, null, true);
  }
  
  public void doOnBackPressed()
  {
    if (this.jdField_d_of_type_Int == 11) {
      bcef.b(this.app, "CliOper", "", "", "0X8006215", "0X8006215", 0, 0, "2", "", "", "");
    }
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    this.jdField_h_of_type_Int = ((Bundle)localObject).getInt("param_pick_max_num_exceeds_wording", 2131697050);
    ...
    if (this.jdField_d_of_type_Int == 17) {
      new bcek(this.app).a("dc00899").b("Grp_online").c("mber_list").d("exp_onlineList").a(1).a(new String[] { this.jdField_b_of_type_JavaLangString }).a();
    }
    if (this.jdField_d_of_type_Int == 22) {
      bftc.a("Grp_idol", "mber_list", "exp", 0, 0, new String[] { this.jdField_b_of_type_JavaLangString });
    }
    ...
    catch (NumberFormatException localNumberFormatException)
    {
      try
      {
        ...
        if ((this.jdField_m_of_type_Int == 1) || (this.jdField_m_of_type_Int == 8)) {
          ((anca)this.app.getBusinessHandler(20)).v(this.jdField_b_of_type_JavaLangString);
        }
        if (this.jdField_m_of_type_Int == 5) {
          ((anca)this.app.getBusinessHandler(20)).w(this.jdField_b_of_type_JavaLangString);
        }
        ...
        if ((paramBundle != null) && (localObject != null)) {
          ...
          {
            this.jdField_a_of_type_ComTencentMobileqqDataDiscussionInfo = ((amrb)localObject).a(this.jdField_b_of_type_JavaLangString);
    ...
    if ((this.jdField_d_of_type_Int == 1) || (this.jdField_d_of_type_Int == 11) || (this.jdField_d_of_type_Int == 16))
    {
      ...
      if (this.jdField_d_of_type_Int == 0)
      {
        ...
        this.jdField_a_of_type_Azwa = new azwa(this);
        if (QLog.isColorLevel()) {
      ...
      bcef.b(this.app, "CliOper", "", "", "0X8006214", "0X8006214", 0, 0, "", "", "", "");
      if (this.jdField_d_of_type_Int == 21) {
    ...
    for (;;)
    {
      ...
      if (this.jdField_d_of_type_Int == 18) {
        bcef.b(this.app, "dc00899", "Grp_chatRecord", "", "chatRecor_mber", "mber_exp", 0, 0, this.jdField_b_of_type_JavaLangString, "", "", "");
      }
      if (this.jdField_d_of_type_Int == 3) {
        ((anca)this.app.getBusinessHandler(20)).q(this.jdField_b_of_type_JavaLangString);
      }
      return true;
      this.app.addObserver(this.jdField_a_of_type_Andd, true);
      break;
      label1735:
      bool = false;
      break label1420;
      ...
      this.jdField_a_of_type_ArrayOfJavaLangString[i3] = getResources().getString(2131719282);
      if (i1 != 0) {
        this.jdField_a_of_type_ArrayOfJavaLangString[(i3 + 1)] = getResources().getString(2131719281);
      }
      ...
      this.jdField_b_of_type_ArrayOfJavaLangString[i2] = getResources().getString(2131719283);
      if (i1 == 0) {
        break label1521;
      }
      this.jdField_b_of_type_ArrayOfJavaLangString[(i2 + 1)] = getResources().getString(2131719281);
      break label1521;
      paramBundle = "0";
      break label1587;
      paramBundle = "1";
  ...
  public void doOnDestroy()
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Azwa != null)
      {
        this.jdField_a_of_type_Azwa.c();
        this.jdField_a_of_type_Azwa = null;
      }
      try
      {
  ...
  protected void e()
  {
    View localView = getLayoutInflater().inflate(2131562929, this.jdField_a_of_type_ComTencentWidgetPinnedDividerSwipListView, false);
    ...
    if (ThemeUtil.isDefaultTheme())
    {
      ...
      if ((i1 != 0) || (i2 != 0))
      {
        ...
        if (i1 != 0)
        {
          ...
          localImageView.setOnClickListener(new aeno(this));
          localTextView.setTextSize(12.0F);
        }
        this.jdField_b_of_type_AndroidWidgetRelativeLayout.setOnClickListener(new aenp(this, (String)localObject));
        if (!this.jdField_o_of_type_Boolean)
        {
          this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
          this.jdField_b_of_type_AndroidWidgetRelativeLayout.setEnabled(false);
      ...
      localView = getLayoutInflater().inflate(2131562921, this.jdField_a_of_type_ComTencentWidgetPinnedDividerSwipListView, false);
      localView.setOnClickListener(new aenq(this));
    ...
    for (;;)
    {
      ...
      ((EditText)localObject).setOnTouchListener(new aenr(this));
      ...
      if ((this.jdField_a_of_type_Amqx != null) && (this.jdField_d_of_type_Int == 11)) {
        this.jdField_a_of_type_Amqx.b(this.app.getCurrentAccountUin(), this.jdField_a_of_type_JavaLangString);
      }
      for (;;)
      {
        ...
        break;
        if (localObject != null) {
          ((anca)localObject).a(this.app.getCurrentAccountUin(), this.jdField_b_of_type_JavaLangString);
        }
      }
      label954:
      i1 = 0;
  ...
  {
    if (((bfdm)this.app.getManager(203)).a(this, this.jdField_b_of_type_JavaLangString, Long.parseLong(paramString))) {
      return;
    }
    ...
    aynd.a(this.app, this, this.jdField_b_of_type_JavaLangString, paramString, 1, 1, localBundle);
    this.v = paramString;
  ...
  protected void f()
  {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_d_of_type_Int != 15) && (this.jdField_d_of_type_Int != 1) && (this.jdField_d_of_type_Int != 11) && (this.jdField_d_of_type_Int != 16))
      {
        ...
        if ((this.jdField_d_of_type_Int != 11) && (this.jdField_d_of_type_Int != 1) && (this.jdField_d_of_type_Int != 16) && (NetworkUtil.isNetworkAvailable(this)))
        {
          ...
          if (localObject2 != null)
          {
            ...
            ((anca)localObject2).a(true, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString, true, a(), this.jdField_a_of_type_Long, 0);
            if (QLog.isColorLevel()) {
      ...
      try
      {
        ((anca)localObject2).a(Long.parseLong(this.jdField_b_of_type_JavaLangString), 0L, 1, 0, 0);
        if (this.jdField_d_of_type_Int == 3)
        {
          ...
          if (l2 > 60000L)
          {
            ...
            if (localObject2 != null)
            {
              ...
              ((anca)localObject2).j(this.jdField_b_of_type_JavaLangString);
              ((anca)localObject2).a(1, amoo.a(this.jdField_b_of_type_JavaLangString), 0L, 2, 0, 0, true);
              if (QLog.isColorLevel()) {
        ...
        ((bfci)this.app.getManager(113)).a(this.jdField_b_of_type_JavaLangString, new aenx(this));
        return;
  ...
  public void g()
  {
    ...
    if (this.jdField_d_of_type_Int == 9)
    {
      ...
      if (!amtj.a(2131714608).equals(arrayOfString[i2])) {
        break label188;
      }
    }
    label267:
    for (;;)
    {
      ...
      if (i2 == 2)
      {
        ...
        {
          this.jdField_a_of_type_Bjnw.c(arrayOfString[i2]);
          if (arrayOfString[i2].equals(amtj.a(2131714568))) {
            bcef.b(this.app, "dc00899", "Grp_mber", "", "mber_list", "exp_Add", 0, 0, this.jdField_b_of_type_JavaLangString, "", "", "");
          }
        }
      }
    }
  ...
  public void h()
  {
    if ((this.jdField_a_of_type_Aeoz != null) && (QLog.isColorLevel())) {
      QLog.d("TroopMemberListActivityget_troop_member", 2, String.format("checkShowCharIndexView item: %s, other: %s, char: %s", new Object[] { Integer.valueOf(this.jdField_a_of_type_Aeoz.jdField_b_of_type_Int), Integer.valueOf(this.jdField_a_of_type_Aeoz.jdField_c_of_type_Int), Integer.valueOf(this.jdField_a_of_type_Aeoz.jdField_a_of_type_Int) }));
    }
    int i1 = this.jdField_a_of_type_ComTencentMobileqqWidgetIndexView.getVisibility();
    if (this.jdField_m_of_type_Int == 0) {
      if (this.jdField_d_of_type_Int == 11) {
        if ((this.jdField_a_of_type_Aeoz != null) && (this.jdField_a_of_type_Aeoz.jdField_b_of_type_Int > 6) && (this.jdField_a_of_type_Aeoz.jdField_a_of_type_Int > 1)) {
    ...
    for (;;)
    {
      ...
      if (this.jdField_d_of_type_Int == 0)
      {
        if ((this.jdField_a_of_type_Aeoz != null) && (this.jdField_a_of_type_Aeoz.jdField_b_of_type_Int + this.jdField_a_of_type_Aeoz.jdField_c_of_type_Int >= this.jdField_l_of_type_Int) && (this.jdField_a_of_type_Aeoz.jdField_a_of_type_Int > 1)) {
          this.jdField_a_of_type_ComTencentMobileqqWidgetIndexView.setVisibility(0);
        } else {
          this.jdField_a_of_type_ComTencentMobileqqWidgetIndexView.setVisibility(4);
        }
      }
      else if ((this.jdField_a_of_type_Aeoz != null) && (this.jdField_a_of_type_Aeoz.jdField_b_of_type_Int >= this.jdField_l_of_type_Int) && (this.jdField_a_of_type_Aeoz.jdField_a_of_type_Int > 1))
      {
        this.jdField_a_of_type_ComTencentMobileqqWidgetIndexView.setVisibility(0);
      }
      else
  ...
  public void i()
  {
    ...
    {
      localDialog.setCancelable(bool);
      ((TextView)this.jdField_a_of_type_AndroidAppDialog.findViewById(2131365552)).setText(getString(2131718142));
      return;
      label76:
      bool = false;
    }
  ...
  {
    if (this.jdField_d_of_type_Int == 11) {
      bcef.b(this.app, "CliOper", "", "", "0X8006217", "0X8006217", 0, 0, "", "", "", "");
    }
    ...
    ((TranslateAnimation)localObject).setAnimationListener(new aeoc(this, (TranslateAnimation)localObject, localTranslateAnimation, i1));
    this.jdField_b_of_type_AndroidAppDialog.setOnDismissListener(new aeod(this));
    this.jdField_a_of_type_AndroidWidgetEditText.setText("");
    this.jdField_a_of_type_AndroidWidgetEditText.setSelection(0);
    this.jdField_a_of_type_AndroidWidgetEditText.requestFocus();
    localObject = (Button)this.jdField_b_of_type_AndroidAppDialog.findViewById(2131363774);
    ((Button)localObject).setVisibility(0);
    ((Button)localObject).setOnClickListener(new aeoe(this));
    this.jdField_b_of_type_JavaUtilList.clear();
    this.jdField_a_of_type_Aepb.notifyDataSetChanged();
  ...
  void n()
  {
    ...
    {
      ViewStub localViewStub = (ViewStub)findViewById(2131379299);
      if (localViewStub != null) {
        ((LinearLayout)localViewStub.inflate().findViewById(2131379300)).setOnTouchListener(new aeoq(this));
      }
    }
  }
