...
class FriendProfileImageAvatar$5
  implements Runnable
{
  FriendProfileImageAvatar$5(FriendProfileImageAvatar paramFriendProfileImageAvatar, String paramString1, byte paramByte, String paramString2) {}
  
  public void run()
  {
    Object localObject2 = FaceUtil.c(String.valueOf(this.a));
    ...
    int j = 1;
    ((FriendProfileImageAvatar)localObject1).f = true;
    int i = this.b;
    if ((i & 0x20) != 0) {
      i = 0;
    } else if ((i & 0x10) != 0) {
    ...
    try
    {
      this.this$0.a = new URL((String)localObject1);
    }
    ...
    boolean bool1;
    if (HttpDownloadUtil.downloadData(this.this$0.l, new DownloadInfo(MsfSdkUtils.insertMtype("friendlist", (String)localObject1), (File)localObject3, 0), this.this$0) == 0) {
      bool1 = true;
    } else {
      bool1 = false;
    }
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.FriendProfileImageAvatar.5
