  ...
  extends RoamSettingObserver
{
  ...
  protected void a(boolean paramBoolean, String paramString, Map<String, Integer> paramMap)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      if (paramMap != null)
      {
        ...
        paramString = (ProxyManager)this.a.a.getManager(QQManagerFactory.PROXY_MANAGER);
        if (paramString == null) {
          paramString = null;
        } else {
        ...
        while (paramMap.hasNext())
        {
          ...
          try
          {
            RecentUser localRecentUser = paramString.b(str, 1);
            if (localRecentUser != null)
            {
              ...
              this.a.a().getMessageFacade().a(localRecentUser.uin, localRecentUser.getType());
            }
          }
  ...
  {
    Object localObject1 = (ProxyManager)this.a.a.getManager(QQManagerFactory.PROXY_MANAGER);
