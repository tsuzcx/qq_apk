  ...
  public static String a()
  {
    if (!jdField_a_of_type_Boolean)
    {
      ...
      if (localQQAppInterface != null) {
        d = ((QWalletConfigManager)localQQAppInterface.getManager(QQManagerFactory.QWALLET_CONFIG_MANAGER)).a("hb_exclusive", jdField_b_of_type_JavaLangString, new String[] { "aio_red", "prefix" });
      }
    }
    return d;
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.qwallet.redpacket.specify.SpecifyAnimInfo
