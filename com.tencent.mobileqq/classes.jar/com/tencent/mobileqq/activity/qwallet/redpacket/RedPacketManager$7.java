  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    //   54: ifeq +77 -> 131
    //   57: aload_1
    //   58: invokestatic 65	com/tencent/mobileqq/utils/FileUtils:readFile	(Ljava/lang/String;)[B
    //   61: astore_1
    //   62: aload_1
    //   63: ifnull +68 -> 131
    //   66: aload_1
    //   67: arraylength
    //   68: ifle +63 -> 131
    //   71: new 67	com/qq/taf/jce/JceInputStream
    //   74: dup
    //   75: aload_1
    //   76: invokespecial 70	com/qq/taf/jce/JceInputStream:<init>	([B)V
    //   79: astore_2
    //   80: aload_2
    //   81: ldc 72
    //   83: invokevirtual 76	com/qq/taf/jce/JceInputStream:setServerEncoding	(Ljava/lang/String;)I
    //   86: pop
    //   87: new 78	Wallet/GetGroupRedPackListRsp
    //   90: dup
    //   91: invokespecial 79	Wallet/GetGroupRedPackListRsp:<init>	()V
    //   94: astore_1
    //   95: aload_1
    //   96: aload_2
    //   97: invokevirtual 83	Wallet/GetGroupRedPackListRsp:readFrom	(Lcom/qq/taf/jce/JceInputStream;)V
    //   100: invokestatic 89	com/tencent/mobileqq/app/ThreadManager:getUIHandler	()Lmqq/os/MqqHandler;
    //   103: new 91	com/tencent/mobileqq/activity/qwallet/redpacket/RedPacketManager$7$1
    //   106: dup
    //   107: aload_0
    //   108: aload_1
    //   109: invokespecial 94	com/tencent/mobileqq/activity/qwallet/redpacket/RedPacketManager$7$1:<init>	(Lcom/tencent/mobileqq/activity/qwallet/redpacket/RedPacketManager$7;LWallet/GetGroupRedPackListRsp;)V
    //   112: invokevirtual 100	mqq/os/MqqHandler:post	(Ljava/lang/Runnable;)Z
    //   115: pop
    //   116: return
    //   117: astore_2
    //   118: aconst_null
    //   119: astore_1
    //   120: aload_2
    //   121: invokevirtual 103	java/lang/Throwable:printStackTrace	()V
    //   124: goto -24 -> 100
    //   127: astore_2
    //   128: goto -8 -> 120
    //   131: aconst_null
