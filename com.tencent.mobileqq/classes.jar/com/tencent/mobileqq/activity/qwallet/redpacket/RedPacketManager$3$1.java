...
public class RedPacketManager$3$1
  implements Runnable
{
  public RedPacketManager$3$1(agqq paramagqq, GetSkinListRsp paramGetSkinListRsp) {}
  ...
  public void run()
  {
    try
    {
      ...
      bace.a(localJceOutputStream.toByteArray(), BaseApplicationImpl.getApplication().getFilesDir() + "skins" + this.jdField_a_of_type_Agqq.a.getCurrentAccountUin());
      return;
    }
