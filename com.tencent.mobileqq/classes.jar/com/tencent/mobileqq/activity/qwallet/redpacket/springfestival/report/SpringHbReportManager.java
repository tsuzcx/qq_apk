...
import tencent.im.new_year_2020.newyear_report.NYCommonInfo;
import tencent.im.new_year_2020.newyear_report.NYReportItems;
import tencent.im.new_year_2020.newyear_report.NYReportReq;
import tencent.im.new_year_2020.newyear_report.SsoReq;
  ...
  implements Manager
{
  ...
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new agvp(this);
  ...
  private String a()
  {
    StringBuilder localStringBuilder = new StringBuilder(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getFilesDir().getPath());
    localStringBuilder.append("/QWallet/").append(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).append("/.config/");
  ...
  private LinkedList<SpringHbReportManager.ReportInfo> a()
  {
    ...
    //   4: aload_3
    //   5: astore_1
    //   6: getstatic 23	com/tencent/mobileqq/activity/qwallet/redpacket/springfestival/report/SpringHbReportManager:jdField_a_of_type_ArrayOfByte	[B
    //   9: astore 4
    //   11: aload_3
    //   12: astore_1
    //   13: aload 4
    //   15: monitorenter
    //   16: aload_0
    //   17: invokespecial 129	com/tencent/mobileqq/activity/qwallet/redpacket/springfestival/report/SpringHbReportManager:a	()Ljava/lang/String;
    //   20: invokestatic 137	agwj:a	(Ljava/lang/String;)Ljava/lang/Object;
    ...
    //   56: astore_2
    //   57: aload_2
    //   58: invokevirtual 140	java/lang/Throwable:printStackTrace	()V
    //   61: goto -31 -> 30
    //   64: astore_3
    //   65: goto -16 -> 49
  ...
  {
    NewIntent localNewIntent = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), agvr.class);
    localNewIntent.putExtra("cmd", paramString);
    paramString = new Unisso.UniSsoServerReq();
    paramString.reqdata.set(ByteStringMicro.copyFrom(paramArrayOfByte));
    localNewIntent.putExtra("data", bakc.a(paramString.toByteArray()));
    if (paramLong > 0L) {
  ...
  {
    return new agvq(this, paramLong);
  }
  ...
  private newyear_report.NYCommonInfo a()
  {
    ...
    if ((localObject != null) && (((SosoInterface.SosoLbsInfo)localObject).a != null))
    {
      ...
      localStringBuilder.append("&la=").append(((SosoInterface.SosoLbsInfo)localObject).a.a);
    }
    if (!TextUtils.isEmpty(str)) {
    ...
    localStringBuilder.append("&ver=").append(babp.e());
    localStringBuilder.append("&model=").append(babp.i());
    localStringBuilder.append("&qqver=").append(babp.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()));
  ...
  private void a()
  {
    try
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("springHb_report_SpringHbReportManager", 2, "[init] mBatchSize:" + this.jdField_a_of_type_Int + ",mLastReportTime:" + this.jdField_b_of_type_Long + ",mLastSaveFileTime:" + this.c + ",mReportItems:" + this.jdField_a_of_type_JavaUtilLinkedList);
      }
      return;
    }
  ...
  private void a(boolean paramBoolean)
  {
    if (!paramBoolean)
    {
      ...
      if (l <= 10000L)
      {
        l = 10000L - l;
        if (QLog.isColorLevel()) {
          QLog.d("springHb_report_SpringHbReportManager", 2, "[saveReportFile] no need to save, saveDelayTime=" + l);
        }
  ...
  private boolean a(SpringHbReportManager.ReportInfo paramReportInfo)
  {
    ...
    case 2: 
      do
      {
        ...
        paramReportInfo.isRealTime = false;
        return false;
      } while ((!TextUtils.equals(agvm.b, paramReportInfo.eventName)) && (!TextUtils.equals(agvm.a, paramReportInfo.eventName)) && (!TextUtils.equals(agvm.c, paramReportInfo.eventName)) && (!TextUtils.equals(agvm.e, paramReportInfo.eventName)) && (!TextUtils.equals(agvm.d, paramReportInfo.eventName)));
      return true;
    }
    return true;
  }
  ...
  private void b(SpringHbReportManager.ReportInfo paramReportInfo)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.i("springHb_report_SpringHbReportManager", 2, "[addToCache] merge succ:" + localReportInfo);
        }
        return;
      }
    }
  ...
  private void c()
  {
    ...
    for (;;)
    {
      ...
      {
        QLog.e("springHb_report_SpringHbReportManager", 1, localThrowable, new Object[0]);
        return;
      }
      long l2;
    ...
    if (QLog.isColorLevel()) {
      QLog.d("springHb_report_SpringHbReportManager", 2, "[doReportRequest] " + this.jdField_a_of_type_JavaUtilLinkedList + ",mToReqMap:" + this.jdField_a_of_type_JavaUtilHashMap + ",convertCost:" + (System.currentTimeMillis() - l1));
    }
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      localObject4 = a("NY2020Report.report", localSsoReq.toByteArray(), 30000L);
      ...
      if (QLog.isColorLevel()) {
        QLog.d("springHb_report_SpringHbReportManager", 2, "[doReportRequest],reqSeq:" + localObject3 + ",startTime:" + l1 + ",batchReqSize:" + ((LinkedList)localObject2).size());
      }
    }
    this.jdField_a_of_type_JavaUtilHashMap.clear();
  }
  ...
  private void d(int paramInt)
  {
    int j = a();
    if (QLog.isColorLevel()) {
      QLog.i("springHb_report_SpringHbReportManager", 2, "[tryReportNow] reportScene:" + paramInt + ",reportCount:" + j);
    }
    if (j <= 0) {
      return;
    }
    ...
    for (boolean bool2 = true;; bool2 = false)
    {
      ...
      if (((!bool2) && (!bool1) && (i == 0)) || (!badq.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()))) {
        break label333;
      }
      if (QLog.isColorLevel()) {
        QLog.d("springHb_report_SpringHbReportManager", 2, "[doReportRequest] tryReportInner,reportCount:" + j + ",mBatchSize:" + this.jdField_a_of_type_Int + ",isRealTime:" + bool2 + ",reportInterval:" + l1 + ",isTimeOk:" + bool1);
      }
      c();
      b();
    ...
    for (long l1 = 600000L;; l1 = 600000L - l1)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.i("springHb_report_SpringHbReportManager", 2, "[tryReportInner] schedule delayTime:" + l2);
      }
      ThreadManager.getSubThreadHandler().removeCallbacksAndMessages(this);
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.qwallet.redpacket.springfestival.report.SpringHbReportManager
