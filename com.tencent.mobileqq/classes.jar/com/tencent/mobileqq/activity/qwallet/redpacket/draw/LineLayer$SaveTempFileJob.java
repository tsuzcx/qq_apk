  ...
  implements Runnable
{
  ...
  private WeakReference<ahfa> jdField_a_of_type_JavaLangRefWeakReference;
  private int b = -1;
  
  public LineLayer$SaveTempFileJob(LineLayer paramLineLayer, int paramInt1, int paramInt2, Bitmap paramBitmap, ahfa paramahfa)
  {
    this.jdField_a_of_type_JavaLangString = (ajsd.cl + "temp" + File.separator);
    QLog.d("SaveTempFileJob", 2, "SaveTempFileJob begin:");
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramahfa);
    if (paramBitmap == null) {
      return;
    }
