  ...
  implements Runnable
{
  ...
  private WeakReference<ahfc> jdField_a_of_type_JavaLangRefWeakReference;
  private int b = -1;
  
  public LineLayer$SaveTempFileJob(LineLayer paramLineLayer, int paramInt1, int paramInt2, Bitmap paramBitmap, ahfc paramahfc)
  {
    this.jdField_a_of_type_JavaLangString = (ajsf.cl + "temp" + File.separator);
    QLog.d("SaveTempFileJob", 2, "SaveTempFileJob begin:");
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramahfc);
    if (paramBitmap == null) {
      return;
    }
