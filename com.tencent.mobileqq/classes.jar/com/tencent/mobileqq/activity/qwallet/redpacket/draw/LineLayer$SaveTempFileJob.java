  ...
  implements Runnable
{
  ...
  private WeakReference<agsn> jdField_a_of_type_JavaLangRefWeakReference;
  private int b = -1;
  
  public LineLayer$SaveTempFileJob(LineLayer paramLineLayer, int paramInt1, int paramInt2, Bitmap paramBitmap, agsn paramagsn)
  {
    this.jdField_a_of_type_JavaLangString = (ajed.cd + "temp" + File.separator);
    QLog.d("SaveTempFileJob", 2, "SaveTempFileJob begin:");
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramagsn);
    if (paramBitmap == null) {
      return;
    }
