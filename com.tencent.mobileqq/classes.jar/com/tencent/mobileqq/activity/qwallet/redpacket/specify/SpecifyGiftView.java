  ...
  extends RelativeLayout
{
  ...
  public SpecifyGiftView(Context paramContext, MessageForQQWalletMsg paramMessageForQQWalletMsg)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqSurfaceviewactionGlSpriteVideoView.setId(2131375362);
    ...
    paramContext.addRule(7, 2131375362);
    paramContext.addRule(6, 2131375362);
    ...
    paramMessageForQQWalletMsg.setImageResource(2130847544);
  ...
  private View a(MessageForQQWalletMsg paramMessageForQQWalletMsg, LinearLayout paramLinearLayout)
  {
    ...
    paramLinearLayout.setBackgroundResource(2130847722);
    ...
    localImageView.setBackgroundResource(2130847721);
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      ((ImageView)localObject2).setBackgroundResource(2130847721);
      ((ImageView)localObject2).setPadding(i, i, i, i);
    }
    paramLinearLayout = ContactUtils.c(localQQAppInterface, paramMessageForQQWalletMsg.senderuin, true);
    ...
    if (((Iterator)localObject2).hasNext())
    {
      ...
      str = ContactUtils.c(localQQAppInterface, l + "", true);
      if (i <= 0) {
        break label1166;
      }
    }
    ...
    for (localObject1 = paramLinearLayout + "、";; localObject1 = paramLinearLayout)
    {
      ...
      for (;;)
      {
        ...
        {
          localObject1 = paramLinearLayout;
          localObject2 = (String)localObject3 + HardCodeUtil.a(2131714190) + (String)localObject1;
          i = paramMessageForQQWalletMsg.mQQWalletRedPacketMsg.specifyUinList.size();
          paramLinearLayout = (LinearLayout)localObject2;
          if (i >= 2) {
            paramLinearLayout = (String)localObject2 + HardCodeUtil.a(2131714187) + i + HardCodeUtil.a(2131714188);
          }
          ...
          localTextView2.setText(HardCodeUtil.a(2131714189));
          ...
          localView.setBackgroundResource(2130847720);
  ...
  public void a(String paramString, FrameSprite.OnFrameEndListener paramOnFrameEndListener, View.OnClickListener paramOnClickListener)
  {
    if (this.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_ComTencentMobileqqSurfaceviewactionGlSpriteVideoView.a(paramString, paramOnFrameEndListener);
    ...
    for (;;)
    {
      ...
      return;
      if (paramOnFrameEndListener != null) {
