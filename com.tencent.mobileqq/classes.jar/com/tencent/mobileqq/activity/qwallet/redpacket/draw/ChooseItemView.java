  ...
  extends FrameLayout
{
  ...
  private View.OnClickListener c = new ahdr(this);
  ...
  public ChooseItemView(Context paramContext)
  {
    ...
    setOnClickListener(new ahdp(this));
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setOnTouchListener(new ahdq(this));
  }
  ...
  private TextView a(Context paramContext, String paramString)
  {
    ...
    if ((!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) && (this.jdField_a_of_type_JavaLangString.equals(paramString)))
    {
      ...
      localTextView.setBackgroundResource(2130846365);
    }
    for (;;)
    {
      localTextView.setTextSize(1, 13.0F);
      localTextView.setGravity(16);
      int i = bawz.a(paramContext, 13.0F);
      ...
      ahiy.a(localTextView, 0.6F);
      paramString = new LinearLayout.LayoutParams(-2, bawz.a(paramContext, 30.0F));
      paramString.leftMargin = bawz.a(paramContext, 12.0F);
      localTextView.setLayoutParams(paramString);
      localTextView.measure(0, 0);
      return localTextView;
      localTextView.setTextColor(-16578534);
      localTextView.setBackgroundResource(2130846364);
  ...
  private void b()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setPadding(bawz.a(getContext(), 8.0F), 0, this.jdField_a_of_type_AndroidWidgetLinearLayout.getPaddingRight(), bawz.a(getContext(), 10.0F));
    ...
    localObject2 = getContext().getResources().getDrawable(2130842844);
    ((Drawable)localObject2).setBounds(0, 0, ((Drawable)localObject2).getIntrinsicWidth(), ((Drawable)localObject2).getIntrinsicHeight());
    ((TextView)localObject1).setCompoundDrawables((Drawable)localObject2, null, null, null);
    ((TextView)localObject1).setCompoundDrawablePadding(bawz.a(getContext(), 7.0F));
    ((TextView)localObject1).setPadding(bawz.a(getContext(), 5.0F), 0, bawz.a(getContext(), 20.0F), bawz.a(getContext(), 10.0F));
    ((TextView)localObject1).setText(ajyc.a(2131701812));
    ...
    for (;;)
    {
      k = ((TextView)localObject1).getMeasuredWidth() + bawz.a(getContext(), 12.0F) + k;
      ...
      if ((i >= this.jdField_a_of_type_JavaUtilList.size()) || (((TextView)localObject1).getMeasuredWidth() + k + bawz.a(getContext(), 12.0F) * 2 > m))
      {
        j += 1;
  ...
  public void a(String paramString, View.OnClickListener paramOnClickListener1, View.OnClickListener paramOnClickListener2, ahdu paramahdu)
  {
    if (!TextUtils.isEmpty(paramString)) {
      try
      {
        ...
        this.jdField_a_of_type_AndroidViewView$OnClickListener = new ahdt(this, paramOnClickListener1);
      }
    ...
    this.jdField_a_of_type_Ahdu = paramahdu;
  }
  ...
  public void a(List<String> paramList, View.OnClickListener paramOnClickListener1, View.OnClickListener paramOnClickListener2, ahdu paramahdu)
  {
    if ((paramList != null) && (paramList.size() > 0)) {
      ...
      catch (Throwable paramList)
      {
        ...
        this.jdField_a_of_type_AndroidViewView$OnClickListener = new ahds(this, paramOnClickListener1);
        this.b = paramOnClickListener2;
        this.jdField_a_of_type_Ahdu = paramahdu;
      }
    }
  ...
  public void setVisibility(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Ahdu != null) {
      this.jdField_a_of_type_Ahdu.a(paramInt);
    }
  }
}
