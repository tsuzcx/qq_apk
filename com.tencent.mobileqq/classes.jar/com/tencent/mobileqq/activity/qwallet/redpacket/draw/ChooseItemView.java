  ...
  extends FrameLayout
{
  ...
  private View.OnClickListener c = new ahdp(this);
  ...
  public ChooseItemView(Context paramContext)
  {
    ...
    setOnClickListener(new ahdn(this));
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setOnTouchListener(new ahdo(this));
  }
  ...
  private TextView a(Context paramContext, String paramString)
  {
    ...
    if ((!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) && (this.jdField_a_of_type_JavaLangString.equals(paramString)))
    {
      ...
      localTextView.setBackgroundResource(2130846371);
    }
    for (;;)
    {
      localTextView.setTextSize(1, 13.0F);
      localTextView.setGravity(16);
      int i = baxn.a(paramContext, 13.0F);
      ...
      ahiw.a(localTextView, 0.6F);
      paramString = new LinearLayout.LayoutParams(-2, baxn.a(paramContext, 30.0F));
      paramString.leftMargin = baxn.a(paramContext, 12.0F);
      localTextView.setLayoutParams(paramString);
      localTextView.measure(0, 0);
      return localTextView;
      localTextView.setTextColor(-16578534);
      localTextView.setBackgroundResource(2130846370);
  ...
  private void b()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setPadding(baxn.a(getContext(), 8.0F), 0, this.jdField_a_of_type_AndroidWidgetLinearLayout.getPaddingRight(), baxn.a(getContext(), 10.0F));
    ...
    localObject2 = getContext().getResources().getDrawable(2130842845);
    ((Drawable)localObject2).setBounds(0, 0, ((Drawable)localObject2).getIntrinsicWidth(), ((Drawable)localObject2).getIntrinsicHeight());
    ((TextView)localObject1).setCompoundDrawables((Drawable)localObject2, null, null, null);
    ((TextView)localObject1).setCompoundDrawablePadding(baxn.a(getContext(), 7.0F));
    ((TextView)localObject1).setPadding(baxn.a(getContext(), 5.0F), 0, baxn.a(getContext(), 20.0F), baxn.a(getContext(), 10.0F));
    ((TextView)localObject1).setText(ajya.a(2131701823));
    ...
    for (;;)
    {
      k = ((TextView)localObject1).getMeasuredWidth() + baxn.a(getContext(), 12.0F) + k;
      ...
      if ((i >= this.jdField_a_of_type_JavaUtilList.size()) || (((TextView)localObject1).getMeasuredWidth() + k + baxn.a(getContext(), 12.0F) * 2 > m))
      {
        j += 1;
  ...
  public void a(String paramString, View.OnClickListener paramOnClickListener1, View.OnClickListener paramOnClickListener2, ahds paramahds)
  {
    if (!TextUtils.isEmpty(paramString)) {
      try
      {
        ...
        this.jdField_a_of_type_AndroidViewView$OnClickListener = new ahdr(this, paramOnClickListener1);
      }
    ...
    this.jdField_a_of_type_Ahds = paramahds;
  }
  ...
  public void a(List<String> paramList, View.OnClickListener paramOnClickListener1, View.OnClickListener paramOnClickListener2, ahds paramahds)
  {
    if ((paramList != null) && (paramList.size() > 0)) {
      ...
      catch (Throwable paramList)
      {
        ...
        this.jdField_a_of_type_AndroidViewView$OnClickListener = new ahdq(this, paramOnClickListener1);
        this.b = paramOnClickListener2;
        this.jdField_a_of_type_Ahds = paramahds;
      }
    }
  ...
  public void setVisibility(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Ahds != null) {
      this.jdField_a_of_type_Ahds.a(paramInt);
    }
  }
}
