  ...
  extends FrameLayout
{
  ...
  private View.OnClickListener c = new aixt(this);
  ...
  public ChooseItemView(Context paramContext)
  {
    ...
    setOnClickListener(new aixr(this));
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setOnTouchListener(new aixs(this));
  }
  ...
  private TextView a(Context paramContext, String paramString)
  {
    ...
    if ((!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) && (this.jdField_a_of_type_JavaLangString.equals(paramString)))
    {
      ...
      localTextView.setBackgroundResource(2130846752);
    }
    for (;;)
    {
      localTextView.setTextSize(1, 13.0F);
      localTextView.setGravity(16);
      int i = bcwh.a(paramContext, 13.0F);
      ...
      ajaf.a(localTextView, 0.6F);
      paramString = new LinearLayout.LayoutParams(-2, bcwh.a(paramContext, 30.0F));
      paramString.leftMargin = bcwh.a(paramContext, 12.0F);
      localTextView.setLayoutParams(paramString);
      localTextView.measure(0, 0);
      return localTextView;
      localTextView.setTextColor(-16578534);
      localTextView.setBackgroundResource(2130846751);
  ...
  private void b()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setPadding(bcwh.a(getContext(), 8.0F), 0, this.jdField_a_of_type_AndroidWidgetLinearLayout.getPaddingRight(), bcwh.a(getContext(), 10.0F));
    ...
    localObject2 = getContext().getResources().getDrawable(2130843029);
    ((Drawable)localObject2).setBounds(0, 0, ((Drawable)localObject2).getIntrinsicWidth(), ((Drawable)localObject2).getIntrinsicHeight());
    ((TextView)localObject1).setCompoundDrawables((Drawable)localObject2, null, null, null);
    ((TextView)localObject1).setCompoundDrawablePadding(bcwh.a(getContext(), 7.0F));
    ((TextView)localObject1).setPadding(bcwh.a(getContext(), 5.0F), 0, bcwh.a(getContext(), 20.0F), bcwh.a(getContext(), 10.0F));
    ((TextView)localObject1).setText(alpo.a(2131702195));
    ...
    for (;;)
    {
      k = ((TextView)localObject1).getMeasuredWidth() + bcwh.a(getContext(), 12.0F) + k;
      ...
      if ((i >= this.jdField_a_of_type_JavaUtilList.size()) || (((TextView)localObject1).getMeasuredWidth() + k + bcwh.a(getContext(), 12.0F) * 2 > m))
      {
        j += 1;
  ...
  public void a(String paramString, View.OnClickListener paramOnClickListener1, View.OnClickListener paramOnClickListener2, aixw paramaixw)
  {
    if (!TextUtils.isEmpty(paramString)) {
      try
      {
        ...
        this.jdField_a_of_type_AndroidViewView$OnClickListener = new aixv(this, paramOnClickListener1);
      }
    ...
    this.jdField_a_of_type_Aixw = paramaixw;
  }
  ...
  public void a(List<String> paramList, View.OnClickListener paramOnClickListener1, View.OnClickListener paramOnClickListener2, aixw paramaixw)
  {
    if ((paramList != null) && (paramList.size() > 0)) {
      ...
      catch (Throwable paramList)
      {
        ...
        this.jdField_a_of_type_AndroidViewView$OnClickListener = new aixu(this, paramOnClickListener1);
        this.b = paramOnClickListener2;
        this.jdField_a_of_type_Aixw = paramaixw;
      }
    }
  ...
  public void setVisibility(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Aixw != null) {
      this.jdField_a_of_type_Aixw.a(paramInt);
    }
  }
}
