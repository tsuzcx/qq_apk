  ...
  implements Serializable
{
    ...
    if ((localJSONArray != null) && (localJSONArray.length() > 0))
    {
      ...
      while (i < localJSONArray.length())
      {
        ...
        if (localJSONObject != null)
        {
          ...
          localTimeInfo.beginTime = agsy.a(localJSONObject.optString("start_time"));
          localTimeInfo.endTime = agsy.a(localJSONObject.optString("end_time"));
  ...
  private static SpringFestivalRedpacketConfBean.SpringFestivalHbEntryInfo.LoadingInfo a(JSONObject paramJSONObject)
  {
    ...
    paramJSONObject.beginTime = agsy.a(localJSONObject.optString("start_time"));
    paramJSONObject.endTime = agsy.a(localJSONObject.optString("end_time"));
    ...
    for (;;)
    {
      ...
      while (i < localJSONArray.length())
      {
        ...
        if (localJSONObject != null)
        {
          ...
          localActivityInfo.pendantEndTime = agsy.a(paramJSONObject);
