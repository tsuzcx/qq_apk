...
{
  private static volatile DrawClassifier jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketDrawDrawClassifier;
  private static boolean jdField_b_of_type_Boolean = false;
  public float a;
  private int jdField_a_of_type_Int = 5;
  private LiteClassifier jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketDrawLiteClassifier;
  ...
  {
    if (jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketDrawDrawClassifier == null) {}
    try
    {
      if (jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketDrawDrawClassifier == null) {
        jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketDrawDrawClassifier = new DrawClassifier();
      }
      return jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketDrawDrawClassifier;
    }
    finally {}
  }
  ...
  private void a(String paramString1, DrawClassifier.OnClassifierInitListener paramOnClassifierInitListener, String paramString2)
  {
    ...
    if ((IPreloadService)((QQAppInterface)localObject).getRuntimeService(IPreloadService.class, "") == null)
    {
      paramOnClassifierInitListener.a(false);
      return;
    }
  ...
  public String a()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketDrawLiteClassifier == null) {
      return null;
    }
    return this.jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketDrawLiteClassifier.a();
  }
  ...
  public void a()
  {
    ...
    //   23: aload_0
    //   24: getfield 24	com/tencent/mobileqq/activity/qwallet/redpacket/draw/DrawClassifier:jdField_a_of_type_Boolean	Z
    //   27: invokevirtual 217	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   30: invokevirtual 95	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   33: invokestatic 192	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   36: aload_0
    //   37: getfield 24	com/tencent/mobileqq/activity/qwallet/redpacket/draw/DrawClassifier:jdField_a_of_type_Boolean	Z
    //   40: istore_1
    //   41: iload_1
    //   42: ifne +6 -> 48
    //   45: aload_0
    ...
    //   48: aload_0
    //   49: iconst_0
    //   50: putfield 24	com/tencent/mobileqq/activity/qwallet/redpacket/draw/DrawClassifier:jdField_a_of_type_Boolean	Z
    //   53: aload_0
    //   54: getfield 49	com/tencent/mobileqq/activity/qwallet/redpacket/draw/DrawClassifier:jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketDrawLiteClassifier	Lcom/tencent/mobileqq/activity/qwallet/redpacket/draw/LiteClassifier;
    //   57: ifnull -12 -> 45
    //   60: aload_0
    //   61: getfield 49	com/tencent/mobileqq/activity/qwallet/redpacket/draw/DrawClassifier:jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketDrawLiteClassifier	Lcom/tencent/mobileqq/activity/qwallet/redpacket/draw/LiteClassifier;
    //   64: invokevirtual 219	com/tencent/mobileqq/activity/qwallet/redpacket/draw/LiteClassifier:a	()V
    //   67: goto -22 -> 45
    //   70: astore_2
    //   71: aload_0
    //   72: monitorexit
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.qwallet.redpacket.draw.DrawClassifier
