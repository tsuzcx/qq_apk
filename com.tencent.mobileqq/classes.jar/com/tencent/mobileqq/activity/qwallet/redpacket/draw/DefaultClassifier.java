  ...
  extends LiteClassifier
{
  ...
  {
    if ((paramDoodleItem == null) || (TextUtils.isEmpty(paramString))) {}
    do
    {
      do
      {
        ...
        localObject1 = a(paramDoodleItem);
      ...
      while ((paramInt < 20) && (paramInt < ((List)localObject1).size()))
      {
        ...
        ((StringBuilder)localObject2).append(localClassItem.jdField_a_of_type_JavaLangString + ":" + localClassItem.jdField_a_of_type_Float + "\n");
        paramInt += 1;
      }
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.qwallet.redpacket.draw.DefaultClassifier
