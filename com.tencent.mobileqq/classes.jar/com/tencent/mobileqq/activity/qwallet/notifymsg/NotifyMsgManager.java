...
{
  public static int a;
  public static NotifyMsgDBHelper a;
  public static Object a;
  public static ArrayList a;
  public static ArrayList b = new ArrayList();
  public static ArrayList c = new ArrayList(128);
  ...
  public static NotifyMsgDBHelper.NotifyMsgRecord a(NotifyMsgDBHelper.NotifyMsgRecord paramNotifyMsgRecord1, NotifyMsgDBHelper.NotifyMsgRecord paramNotifyMsgRecord2)
  {
  ...
  public static NotifyMsgDBHelper.NotifyMsgRecord a(ArrayList paramArrayList, int paramInt, String paramString)
  {
    Object localObject;
  ...
  protected static ArrayList a(ArrayList paramArrayList, int paramInt)
  {
    if (paramArrayList == null) {
      return null;
    }
  ...
  public static void a(NotifyMsgManager.WaitRecord paramWaitRecord)
  {
    if (QLog.isColorLevel()) {
  ...
  {
    ThreadManager.post(new xcc(paramBoolean, paramArrayList), 5, null, false);
  }
  ...
  public static void a(List paramList)
  {
    ...
    ThreadManager.post(new xca(localArrayList), 5, null, false);
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if ((bool) && (paramBoolean)) {
          ThreadManager.post(new xcb(paramMessageRecord), 5, null, false);
        }
        return bool;
      }
      ...
      if (paramInt == 2)
      {
        ...
        if ((localNotifyMsgRecord != null) && ((paramMessageRecord instanceof MessageForQQWalletMsg)))
        {
          ...
          if ((paramNotifyMsgRecord.mQQWalletRedPacketMsg != null) && (paramNotifyMsgRecord.mQQWalletRedPacketMsg.isOpened))
          {
            ...
            if (paramString != null) {
              paramString.a().a(paramNotifyMsgRecord.frienduin, paramNotifyMsgRecord.istroop, paramNotifyMsgRecord.uniseq, paramNotifyMsgRecord.msgData);
            }
          }
        }
      }
  ...
  protected static void b()
  {
    ...
    ThreadManager.post(new xbz(), 10, null, false);
  }
