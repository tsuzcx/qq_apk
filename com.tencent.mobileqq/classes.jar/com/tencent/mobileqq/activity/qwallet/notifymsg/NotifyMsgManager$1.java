...
final class NotifyMsgManager$1
  implements Runnable
{
  public void run()
  {
    ...
    do
    {
      ...
      if (NotifyMsgManager.jdField_a_of_type_ComTencentMobileqqActivityQwalletNotifymsgNotifyMsgDBHelper != null) {
        NotifyMsgManager.jdField_a_of_type_ComTencentMobileqqActivityQwalletNotifymsgNotifyMsgDBHelper.a(((QQAppInterface)???).getCurrentUin(), NotifyMsgManager.c);
      }
      ...
      l1 = QWalletSetting.a(((QQAppInterface)???).getCurrentUin(), "qwallet_last_clear_notify_time_", 0L);
    ...
    QWalletSetting.a(((QQAppInterface)???).getCurrentUin(), "qwallet_last_clear_notify_time_", l2);
  }
}
