  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      this.this$0.b.setText(amtj.a(2131712412));
    ...
    for (int i = 1;; i = 0)
    {
      bcef.b(localQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "162", "sound.grap.result", 0, i, this.this$0.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg.mQQWalletRedPacketMsg.elem.title.length() + "", this.this$0.getActivity().app.getCurrentAccountUin(), DeviceInfoUtil.getDeviceOSVersion() + "|" + DeviceInfoUtil.getModel(), "");
      ...
      return;
      this.this$0.b.setText(this.this$0.getResources().getString(2131694839));
      break label51;
    }
  }
}
