  ...
  implements VoiceRedPacketHelper.OnGetSkeyListener
{
  ...
  public void a(String paramString)
  {
    ...
    for (int i = 1;; i = 0)
    {
      QWalletCommonServlet.a(new VoiceRedPackMatchReq(l1, str1, str2, l2, paramString, l3, j, localGroupVoiceInfo, 0, localC2CVoiceInfo, "8.5.5", new VoiceMatchStatus(i, this.jdField_a_of_type_ComTencentMobileqqActivityQwalletVoiceVoiceRedPacketHelper.b, this.jdField_a_of_type_ComTencentMobileqqActivityQwalletVoiceVoiceRedPacketHelper.jdField_c_of_type_Int, VoiceRecognizer.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))), new VoiceRedPacketHelper.3.1(this, System.currentTimeMillis()));
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.qwallet.voice.VoiceRedPacketHelper.3
