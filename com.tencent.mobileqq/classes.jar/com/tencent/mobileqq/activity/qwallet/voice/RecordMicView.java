  ...
  extends View
{
  ...
  private akxk jdField_a_of_type_Akxk;
  ...
  private List<akxj> jdField_a_of_type_JavaUtilList = new ArrayList();
  public boolean a;
  ...
  public RecordMicView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    int i = bggq.a(getContext(), 120.0F);
    this.d = i;
    this.c = i;
    this.e = bggq.a(getContext(), 33.0F);
    ViewCompat.setImportantForAccessibility(this, 1);
    setContentDescription(anni.a(2131712053));
    setClickable(true);
  }
  ...
  {
    akxj localakxj = new akxj(bggq.a(getContext(), paramFloat1), bggq.a(getContext(), paramFloat2), paramFloat3, paramFloat4, paramFloat5, paramFloat6, paramFloat7, paramFloat8, paramInt1, paramInt2);
    this.jdField_a_of_type_JavaUtilList.add(localakxj);
  }
  ...
  private void d()
  {
    ...
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new akxi(this));
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    if (this.jdField_b_of_type_Int == 2)
    {
      ...
      {
        akxj localakxj = (akxj)((Iterator)localObject).next();
        paramCanvas.save();
        float f2 = localakxj.jdField_a_of_type_Float;
        f1 = localakxj.jdField_b_of_type_Float;
        f2 = (getWidth() - f2) / 2.0F;
        f1 = (getHeight() - f1) / 2.0F;
        i = (int)(255.0F * localakxj.c);
        ...
        paramCanvas.scale(localakxj.d, localakxj.e, getWidth() / 2, getHeight() / 2);
        paramCanvas.rotate(localakxj.jdField_a_of_type_Int, getWidth() / 2, getHeight() / 2);
      ...
      localObject = getResources().getDrawable(2130847318);
    ...
    this.jdField_b_of_type_Float = bggq.a(getContext(), 2.0F);
    paramCanvas.save();
    paramCanvas.translate((getWidth() - a()) / 2, (getHeight() - b()) / 2);
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      ...
      invalidate();
      b();
      if (this.jdField_a_of_type_Akxk != null) {
        this.jdField_a_of_type_Akxk.a();
      }
  ...
  public void setStatusListener(akxk paramakxk)
  {
    this.jdField_a_of_type_Akxk = paramakxk;
  }
}
