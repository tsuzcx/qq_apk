...
public class QWalletPushManager
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    for (int i = 5;; i = 1000)
    {
      ...
      localMqqHandler.postDelayed(new xgk(paramQQAppInterface), i);
      return;
    }
  }
  ...
  private static void b(QQAppInterface paramQQAppInterface, QWalletPushManager.PCPayData paramPCPayData)
  {
    ...
    if (QQUtils.a(paramQQAppInterface.getApp()))
    {
      ...
      String str2 = String.format(BaseApplication.getContext().getString(2131432248), new Object[] { Integer.valueOf(a()) });
    ...
    for (boolean bool2 = false;; bool2 = true)
    {
      ...
      return;
      str1 = BaseApplication.getContext().getString(2131432249);
      break;
      bool1 = true;
      break label327;
    }
    label495:
    AudioUtil.a(2131230759, false);
  }
  ...
  private static void c(QQAppInterface paramQQAppInterface, QWalletPushManager.PCPayData paramPCPayData)
  {
    ...
    {
      return;
      String str = String.format(BaseApplication.getContext().getString(2131432248), new Object[] { Integer.valueOf(a()) });
      ...
      if (TextUtils.isEmpty((CharSequence)localObject1)) {
        paramPCPayData = BaseApplication.getContext().getString(2131432249);
      }
      ...
      localObject1 = new Notification(2130839552, str, System.currentTimeMillis());
