  ...
  implements Manager
{
  public int a;
  public Context a;
  Handler jdField_a_of_type_AndroidOsHandler = new PasswdRedBagManager.1(this, Looper.getMainLooper());
  private PasswdRedBagDBManager jdField_a_of_type_ComTencentMobileqqActivityQwalletPasswdRedBagDBManager;
  private PasswdRedBagManager.RedPacketRefreshReceiver jdField_a_of_type_ComTencentMobileqqActivityQwalletPasswdRedBagManager$RedPacketRefreshReceiver;
  ...
  protected Object a;
  public String a;
  public HashMap<String, PasswdRedBagInfo> a;
  public List<PasswdRedBagUpdateInfo> a;
  public Map<Integer, List<Pair<String, String>>> a;
  public boolean a;
  private final Object b;
  public HashMap<String, List<String>> b;
  public List<PasswdRedBagUpdateInfo> b;
  public boolean b;
  ...
  public PasswdRedBagManager(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQWalletHandler = ((QWalletHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.QWALLET_HANDLER));
    ...
    try
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityQwalletPasswdRedBagManager$RedPacketRefreshReceiver = new PasswdRedBagManager.RedPacketRefreshReceiver(this, null);
      paramQQAppInterface.addAction("grap_idiom_hb_result_action");
      this.jdField_a_of_type_AndroidContentContext.registerReceiver(this.jdField_a_of_type_ComTencentMobileqqActivityQwalletPasswdRedBagManager$RedPacketRefreshReceiver, paramQQAppInterface);
      return;
    }
  ...
  private PasswdRedBagInfo a(SessionInfo paramSessionInfo, String paramString, Object[] paramArrayOfObject)
  {
    ...
    if (localObject3 != null) {
      for (;;)
      {
        try
        {
          ...
          localObject5 = (PasswdRedBagInfo)this.jdField_a_of_type_JavaUtilHashMap.get(localObject5);
        }
        finally {}
    ...
    for (;;)
    {
      ...
      if (k < m)
      {
        ...
        if (!StringUtil.a((String)localObject6))
        {
      ...
      else
      {
        ...
        if ((localObject3 != null) && (!((List)localObject3).isEmpty()))
        {
          ...
          while (paramString.hasNext())
          {
            ...
            {
              localObject4 = (PasswdRedBagInfo)this.jdField_a_of_type_JavaUtilHashMap.get(localObject4);
        ...
        {
          Collections.sort((List)localObject2, new PasswdRedBagManager.2(this));
          localObject2 = ((List)localObject2).iterator();
          paramString = null;
          while (((Iterator)localObject2).hasNext())
          {
            paramSessionInfo = (PasswdRedBagInfo)((Iterator)localObject2).next();
  ...
  private String a(PasswdRedBagInfo paramPasswdRedBagInfo)
  {
    if (paramPasswdRedBagInfo == null) {
      return "";
    }
    String str = "";
    if (StringUtil.a(paramPasswdRedBagInfo.e)) {
      str = paramPasswdRedBagInfo.d;
    }
  ...
  public static String a(String paramString)
  {
    ...
    if ((StringUtil.a(paramString)) || (!paramString.contains("_"))) {
      return "";
    }
  ...
  private void a(PasswdRedBagInfo paramPasswdRedBagInfo)
  {
    ...
    //   1: istore 4
    //   3: aload_1
    //   4: getfield 359	com/tencent/mobileqq/activity/qwallet/PasswdRedBagInfo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   7: astore 7
    //   9: aload_1
    //   10: getfield 371	com/tencent/mobileqq/activity/qwallet/PasswdRedBagInfo:d	Ljava/lang/String;
    //   13: astore 8
    //   15: aload_0
    //   16: getfield 140	com/tencent/mobileqq/activity/qwallet/PasswdRedBagManager:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   19: aload 7
    //   21: aload_1
    //   22: invokevirtual 387	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   25: pop
    //   26: aload_1
    //   27: getfield 342	com/tencent/mobileqq/activity/qwallet/PasswdRedBagInfo:jdField_a_of_type_Int	I
    //   30: ifne +161 -> 191
    //   33: aload_0
    //   34: getfield 129	com/tencent/mobileqq/activity/qwallet/PasswdRedBagManager:jdField_b_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   37: aload 8
    //   39: invokevirtual 227	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   42: checkcast 229	java/util/List
    //   45: astore 6
    //   47: aload 6
    //   49: ifnonnull +617 -> 666
    //   52: new 306	java/util/LinkedList
    //   55: dup
    //   56: invokespecial 307	java/util/LinkedList:<init>	()V
    //   59: astore 6
    //   61: aload_0
    //   62: getfield 129	com/tencent/mobileqq/activity/qwallet/PasswdRedBagManager:jdField_b_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   65: aload 8
    //   67: aload 6
    //   69: invokevirtual 387	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   72: pop
    //   73: aload_0
    //   74: getfield 48	com/tencent/mobileqq/activity/qwallet/PasswdRedBagManager:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   77: astore 8
    //   79: aload 8
    //   81: monitorenter
    //   82: aload 6
    ...
    //   102: aload 6
    //   104: iload_2
    //   105: invokeinterface 390 2 0
    //   110: checkcast 248	java/lang/String
    //   113: astore 9
    //   115: aload 9
    //   117: invokestatic 319	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   120: ifne +550 -> 670
    //   123: aload_0
    //   124: getfield 140	com/tencent/mobileqq/activity/qwallet/PasswdRedBagManager:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   127: aload 9
    //   129: invokevirtual 227	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   132: checkcast 263	com/tencent/mobileqq/activity/qwallet/PasswdRedBagInfo
    //   135: astore 9
    //   137: aload 9
    //   139: ifnull +531 -> 670
    //   142: aload 9
    //   144: getfield 350	com/tencent/mobileqq/activity/qwallet/PasswdRedBagInfo:jdField_a_of_type_Long	J
    //   147: aload_1
    //   148: getfield 350	com/tencent/mobileqq/activity/qwallet/PasswdRedBagInfo:jdField_a_of_type_Long	J
    //   151: lcmp
    //   152: ifge +518 -> 670
    //   155: iload_2
    //   156: istore_3
    ...
    //   159: iload_3
    //   160: aload 7
    //   162: invokeinterface 393 3 0
    //   167: aload 8
    //   169: monitorexit
    //   170: return
    //   171: astore_1
    //   172: invokestatic 396	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   175: ifeq -8 -> 167
    //   178: aload_1
    //   179: invokevirtual 399	java/lang/Throwable:printStackTrace	()V
    //   182: goto -15 -> 167
    //   185: astore_1
    //   186: aload 8
    //   188: monitorexit
    ...
    //   190: athrow
    //   191: aload_1
    //   192: getfield 342	com/tencent/mobileqq/activity/qwallet/PasswdRedBagInfo:jdField_a_of_type_Int	I
    //   195: iconst_4
    //   196: if_icmpne +473 -> 669
    //   199: aload_1
    //   200: invokevirtual 376	com/tencent/mobileqq/activity/qwallet/PasswdRedBagInfo:a	()I
    //   203: ifeq +19 -> 222
    //   206: aload_1
    //   207: invokevirtual 376	com/tencent/mobileqq/activity/qwallet/PasswdRedBagInfo:a	()I
    //   210: iconst_1
    //   211: if_icmpeq +11 -> 222
    //   214: aload_1
    //   215: invokevirtual 376	com/tencent/mobileqq/activity/qwallet/PasswdRedBagInfo:a	()I
    //   218: iconst_3
    //   219: if_icmpne +198 -> 417
    //   222: aload_1
    //   223: getfield 369	com/tencent/mobileqq/activity/qwallet/PasswdRedBagInfo:e	Ljava/lang/String;
    //   226: invokestatic 401	com/tencent/mobileqq/activity/qwallet/PasswdRedBagManager:a	(Ljava/lang/String;)Ljava/lang/String;
    //   229: ldc_w 403
    //   232: invokevirtual 374	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   235: astore 8
    //   237: aload 8
    //   239: arraylength
    //   240: istore 4
    ...
    //   254: astore 9
    //   256: aload_0
    //   257: getfield 131	com/tencent/mobileqq/activity/qwallet/PasswdRedBagManager:jdField_c_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   260: aload 9
    //   262: invokevirtual 227	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   265: checkcast 229	java/util/List
    //   268: astore 6
    //   270: aload 6
    //   272: ifnonnull +391 -> 663
    //   275: new 306	java/util/LinkedList
    //   278: dup
    //   279: invokespecial 307	java/util/LinkedList:<init>	()V
    //   282: astore 6
    //   284: aload_0
    //   285: getfield 131	com/tencent/mobileqq/activity/qwallet/PasswdRedBagManager:jdField_c_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   288: aload 9
    //   290: aload 6
    //   292: invokevirtual 387	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   295: pop
    //   296: aload_0
    //   297: getfield 48	com/tencent/mobileqq/activity/qwallet/PasswdRedBagManager:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   300: astore 9
    //   302: aload 9
    //   304: monitorenter
    //   305: aload 6
    ...
    //   322: aload 6
    //   324: iload_2
    //   325: invokeinterface 390 2 0
    //   330: checkcast 248	java/lang/String
    //   333: astore 10
    //   335: aload 10
    //   337: invokestatic 319	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   340: ifne +337 -> 677
    //   343: aload_0
    //   344: getfield 140	com/tencent/mobileqq/activity/qwallet/PasswdRedBagManager:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   347: aload 10
    //   349: invokevirtual 227	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   352: checkcast 263	com/tencent/mobileqq/activity/qwallet/PasswdRedBagInfo
    //   355: astore 10
    //   357: aload 10
    //   359: ifnull +318 -> 677
    //   362: aload 10
    //   364: getfield 350	com/tencent/mobileqq/activity/qwallet/PasswdRedBagInfo:jdField_a_of_type_Long	J
    //   367: aload_1
    //   368: getfield 350	com/tencent/mobileqq/activity/qwallet/PasswdRedBagInfo:jdField_a_of_type_Long	J
    //   371: lcmp
    //   372: ifge +305 -> 677
    //   375: aload 6
    //   377: iload_2
    //   378: aload 7
    //   380: invokeinterface 393 3 0
    //   385: aload 9
    //   387: monitorexit
    //   388: iload_3
    //   389: iconst_1
    ...
    //   392: goto -148 -> 244
    //   395: astore 6
    //   397: invokestatic 396	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   400: ifeq -15 -> 385
    //   403: aload 6
    //   405: invokevirtual 399	java/lang/Throwable:printStackTrace	()V
    //   408: goto -23 -> 385
    //   411: astore_1
    //   412: aload 9
    //   414: monitorexit
    ...
    //   416: athrow
    //   417: aload_1
    //   418: invokevirtual 376	com/tencent/mobileqq/activity/qwallet/PasswdRedBagInfo:a	()I
    //   421: iconst_2
    //   422: if_icmpne +247 -> 669
    //   425: aload_1
    //   426: invokevirtual 406	com/tencent/mobileqq/activity/qwallet/PasswdRedBagInfo:a	()Ljava/util/List;
    //   429: invokeinterface 237 1 0
    //   434: astore 8
    //   436: aload 8
    //   438: invokeinterface 242 1 0
    //   443: ifeq +226 -> 669
    //   446: aload 8
    //   448: invokeinterface 246 1 0
    //   453: checkcast 293	java/lang/Integer
    //   456: invokevirtual 409	java/lang/Integer:intValue	()I
    //   459: istore_2
    //   460: aload_0
    //   461: getfield 133	com/tencent/mobileqq/activity/qwallet/PasswdRedBagManager:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   464: iload_2
    //   465: invokestatic 297	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   468: invokeinterface 301 2 0
    //   473: checkcast 229	java/util/List
    //   476: astore 6
    //   478: aload 6
    //   480: ifnonnull +175 -> 655
    //   483: new 306	java/util/LinkedList
    //   486: dup
    //   487: invokespecial 307	java/util/LinkedList:<init>	()V
    //   490: astore 6
    //   492: aload_0
    //   493: getfield 133	com/tencent/mobileqq/activity/qwallet/PasswdRedBagManager:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   496: iload_2
    //   497: invokestatic 297	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   500: aload 6
    //   502: invokeinterface 410 3 0
    //   507: pop
    //   508: aload_0
    //   509: getfield 48	com/tencent/mobileqq/activity/qwallet/PasswdRedBagManager:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   512: astore 9
    //   514: aload 9
    //   516: monitorenter
    //   517: aload 6
    //   519: invokeinterface 304 1 0
    //   524: istore_3
    //   525: iconst_0
    //   526: istore_2
    //   527: iload_2
    ...
    //   532: aload 6
    //   534: iload_2
    //   535: invokeinterface 390 2 0
    //   540: checkcast 309	android/util/Pair
    //   543: getfield 325	android/util/Pair:first	Ljava/lang/Object;
    //   546: checkcast 248	java/lang/String
    //   549: astore 10
    //   551: aload 10
    //   553: invokestatic 319	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   556: ifne +71 -> 627
    //   559: aload_0
    //   560: getfield 140	com/tencent/mobileqq/activity/qwallet/PasswdRedBagManager:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   563: aload 10
    //   565: invokevirtual 227	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   568: checkcast 263	com/tencent/mobileqq/activity/qwallet/PasswdRedBagInfo
    //   571: astore 10
    //   573: aload 10
    //   575: ifnull +52 -> 627
    //   578: aload 10
    //   580: getfield 350	com/tencent/mobileqq/activity/qwallet/PasswdRedBagInfo:jdField_a_of_type_Long	J
    //   583: aload_1
    //   584: getfield 350	com/tencent/mobileqq/activity/qwallet/PasswdRedBagInfo:jdField_a_of_type_Long	J
    //   587: lcmp
    //   588: ifge +39 -> 627
    //   591: aload 6
    //   593: iload_2
    //   594: new 309	android/util/Pair
    //   597: dup
    //   598: aload 7
    //   600: aload_1
    //   601: getfield 369	com/tencent/mobileqq/activity/qwallet/PasswdRedBagInfo:e	Ljava/lang/String;
    //   604: invokestatic 401	com/tencent/mobileqq/activity/qwallet/PasswdRedBagManager:a	(Ljava/lang/String;)Ljava/lang/String;
    //   607: invokespecial 413	android/util/Pair:<init>	(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    //   631: goto -104 -> 527
    //   634: astore 6
    //   636: invokestatic 396	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   639: ifeq -24 -> 615
    //   642: aload 6
    //   644: invokevirtual 399	java/lang/Throwable:printStackTrace	()V
    //   647: goto -32 -> 615
    //   650: iconst_0
    //   651: istore_2
    //   652: goto -61 -> 591
    ...
    //   0	684	0	this	PasswdRedBagManager
    //   0	684	1	paramPasswdRedBagInfo	PasswdRedBagInfo
    //   92	589	2	k	int
    //   95	435	3	m	int
    //   1	247	4	n	int
    //   89	231	5	i1	int
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (!localPasswdRedBagManager.jdField_b_of_type_Boolean)
    {
      ...
      {
        localPasswdRedBagManager.jdField_c_of_type_Boolean = paramQQAppInterface.getBoolean(str + "_" + "redbag_fold_msg_switch", MessageForFoldMsgGrayTips.PASSWD_REDBAG_MSG_SWITCH_DEFAULT);
        ...
        localPasswdRedBagManager.jdField_d_of_type_Boolean = paramQQAppInterface.getBoolean(str + "_" + "redbag_fold_index_switch", MessageForFoldMsgGrayTips.PASSWD_REDBAG_MSG_SWITCH_INDEX);
        localPasswdRedBagManager.jdField_e_of_type_Boolean = paramQQAppInterface.getBoolean(str + "_" + "redbag_fold_index_with_redbagid", MessageForFoldMsgGrayTips.PASSWD_REDBAG_MSG_INDEX_WITH_ID);
      }
      if (QLog.isColorLevel()) {
        QLog.d("msgFold", 2, String.format("getFoldSwitch, first init, switch: %s, num: %d, indexSwitch: %s, indexWithId: %s ", new Object[] { Boolean.valueOf(localPasswdRedBagManager.jdField_c_of_type_Boolean), Integer.valueOf(localPasswdRedBagManager.jdField_a_of_type_Int), Boolean.valueOf(localPasswdRedBagManager.jdField_d_of_type_Boolean), Boolean.valueOf(localPasswdRedBagManager.jdField_e_of_type_Boolean) }));
      }
    }
    localPasswdRedBagManager.jdField_b_of_type_Boolean = true;
  }
    ...
    for (;;)
    {
      ...
      catch (Exception paramString)
      {
        ...
        if ((i5 == 0) || (i6 == 0) || (i3 == 0) || (i4 == 0))
        {
          ...
          paramString = (PasswdRedBagManager)paramQQAppInterface.getManager(QQManagerFactory.PASSWD_RED_BAG_MANAGER);
          ...
          SharedPreUtils.a(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), paramInt, bool1, k, bool2, bool3);
          return;
        }
        i3 = n;
        i4 = k;
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    return ((PasswdRedBagManager)paramQQAppInterface.getManager(QQManagerFactory.PASSWD_RED_BAG_MANAGER)).jdField_c_of_type_Boolean;
  }
  ...
  {
    boolean bool = true;
    if ((!StringUtil.a(paramString)) && (paramString.trim().length() > 1) && (paramString.trim().matches("[a-zA-Z]+"))) {}
    for (;;)
    {
      if (QLog.isColorLevel()) {
  ...
  private boolean a(String paramString1, String paramString2, PasswdRedBagInfo paramPasswdRedBagInfo)
  {
    if (TextUtils.isEmpty(paramString1)) {}
    String str;
    do
    ...
    } while ((TextUtils.isEmpty(paramString2)) || (!paramString2.contains(str)) || (!paramPasswdRedBagInfo.a(paramString1.length())));
    return true;
  }
  ...
  {
    a(paramQQAppInterface);
    return ((PasswdRedBagManager)paramQQAppInterface.getManager(QQManagerFactory.PASSWD_RED_BAG_MANAGER)).jdField_d_of_type_Boolean;
  }
  ...
  private boolean b(String paramString1, String paramString2, PasswdRedBagInfo paramPasswdRedBagInfo)
  {
    if (TextUtils.isEmpty(paramString1)) {}
    do
    {
      return false;
      paramString1 = paramString1.trim();
    } while ((TextUtils.isEmpty(paramString1)) || (paramString1.length() <= 1) || (!paramString1.contains(paramString2)) || (!paramPasswdRedBagInfo.a(paramString1.length())));
    return true;
  }
  ...
  public Bitmap a(String paramString, @DrawableRes int paramInt)
  {
    ...
    label145:
    for (Bitmap localBitmap1 = (Bitmap)GlobalImageCache.a.get(paramString);; localBitmap1 = null) {
        ...
        catch (Exception localException1)
        {
          for (;;)
          {
            try
            {
              ...
              if (GlobalImageCache.a != null) {
                GlobalImageCache.a.put(paramString, localObject2);
              }
              return localObject2;
            }
  ...
  public MessageRecord a(List<MessageRecord> paramList, MessageForFoldMsg paramMessageForFoldMsg, LinkedHashSet<String> arg3, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if ((QLog.isColorLevel()) && (StartupTrackerForAio.a()) && (paramList.size() > 0))
    {
      ...
      if (paramBoolean2)
      {
        localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageProxy(0).a().a(paramMessageForFoldMsg.frienduin, paramMessageForFoldMsg.istroop);
          ...
          synchronized (this.jdField_b_of_type_JavaLangObject)
          {
            ...
            if (paramBoolean2)
            {
              ...
              try
              {
                ...
                if ((!QLog.isColorLevel()) || (!StartupTrackerForAio.a()) || (paramList == null) || (paramList.size() <= 0)) {
                  break label1221;
                }
  ...
  public Boolean a(String paramString1, int paramInt, String paramString2, String paramString3)
  {
    ...
    Object localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().b(paramString1, paramInt);
    if (localObject == null) {
      return Boolean.valueOf(false);
    }
    List localList = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().a(paramString1, paramInt);
  ...
  public void a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      paramContext = (QWalletAIOLifeCycleHelper)paramContext.a(27);
    } while (paramContext == null);
  ...
  {
    a(paramSessionInfo, paramPasswdRedBagInfo, paramLong, 32, "", 0, paramInt, null);
  }
  
  public void a(SessionInfo paramSessionInfo, PasswdRedBagInfo paramPasswdRedBagInfo, long paramLong, int paramInt1, int paramInt2, Bundle paramBundle)
  {
    a(paramSessionInfo, paramPasswdRedBagInfo, paramLong, paramInt1, "", 0, paramInt2, paramBundle);
  }
  
  public void a(SessionInfo paramSessionInfo, PasswdRedBagInfo paramPasswdRedBagInfo, long paramLong, int paramInt, Bundle paramBundle)
  {
    a(paramSessionInfo, paramPasswdRedBagInfo, paramLong, 524288, "", 0, paramInt, paramBundle);
  }
  
  public void a(SessionInfo paramSessionInfo, PasswdRedBagInfo paramPasswdRedBagInfo, long paramLong, int paramInt1, String paramString, int paramInt2, int paramInt3, Bundle paramBundle)
  {
    ...
    do
    {
      return;
      d();
      str2 = (String)this.jdField_d_of_type_JavaUtilHashMap.get(a(paramSessionInfo.jdField_a_of_type_Int) + "_" + paramSessionInfo.jdField_a_of_type_JavaLangString + "_" + paramPasswdRedBagInfo.jdField_a_of_type_JavaLangString);
    ...
    for (String str1 = paramSessionInfo.jdField_a_of_type_JavaLangString;; str1 = this.jdField_a_of_type_JavaLangString)
    {
      ...
      paramSessionInfo = QWalletRedPkgUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramSessionInfo, k, (String)localObject, paramPasswdRedBagInfo, str2, str1, "appid#1344242394|bargainor_id#1000030201|channel#msg", "graphb", null, paramInt1, 0, paramString, paramInt2, paramInt3, paramBundle);
  ...
  public void a(SessionInfo paramSessionInfo, ArrayList<String> paramArrayList)
  {
    if ((paramArrayList != null) && (!paramArrayList.isEmpty())) {
      VoiceRedPacketHelper.a().a(new PasswdRedBagManager.4(this, paramArrayList, paramSessionInfo));
    }
  }
  
  public void a(PasswdRedBagInfo paramPasswdRedBagInfo, String paramString)
  {
    if (paramPasswdRedBagInfo != null) {}
    for (;;)
    {
  ...
  {
    String str = HardCodeUtil.a(2131707879);
    if (paramInt == 8) {
      str = "匿名不能抢K歌红包哦";
    }
    for (;;)
    {
      ((TroopTipsMsgMgr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.TROOP_TIPS_MSG_MANAGER)).a(paramString, str, NetConnInfoCenter.getServerTime(), 10000L, 0, 1);
      return;
      if (paramInt == 9) {
        str = HardCodeUtil.a(2131707882);
      } else if (paramInt == 10) {
        str = HardCodeUtil.a(2131707878);
      } else if (paramInt == 11) {
        str = HardCodeUtil.a(2131707885);
      }
    }
  }
  ...
  public void a(String paramString, SessionInfo paramSessionInfo, PasswdRedBagInfo paramPasswdRedBagInfo, long paramLong, int paramInt)
  {
    long l1 = QWalletSetting.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "idiom_match_in_phone", 0L);
    ...
    if (bool1) {
      VoiceRedPacketHelper.a().a(new PasswdRedBagManager.5(this, paramPasswdRedBagInfo, paramString, paramSessionInfo, paramLong, paramInt));
    }
  }
  ...
  {
    if ((StringUtil.a(paramString2)) || (StringUtil.a(paramString1)) || (StringUtil.a(paramString3))) {
      return;
    }
  ...
  public void a(String paramString1, String paramString2, String paramString3, int paramInt, String paramString4)
  {
    for (;;)
    {
      try
      {
        ...
        a(false);
        PasswdRedBagInfo localPasswdRedBagInfo = (PasswdRedBagInfo)this.jdField_a_of_type_JavaUtilHashMap.get(paramString1);
        if (QLog.isColorLevel()) {
          QLog.d("PasswdRedBagManager", 2, "setPasswdRedBagLastedWord|passwdRedBagInfo: " + localPasswdRedBagInfo);
        }
        if (localPasswdRedBagInfo != null) {
          if (TextUtils.isEmpty(paramString3))
          {
            if (localPasswdRedBagInfo.a() == 3) {
              a(paramString1);
            }
          }
          else {
            try
            {
              JSONObject localJSONObject = this.jdField_a_of_type_ComTencentMobileqqActivityQwalletPasswdRedBagDBManager.a(localPasswdRedBagInfo.f);
              if (localJSONObject != null)
              {
                int k = localJSONObject.optInt("key_extstr_idiomseq");
                if (QLog.isColorLevel()) {
                  QLog.d("PasswdRedBagManager", 2, "oldSeq: " + k + " newSeq: " + paramInt + " extObj: " + localJSONObject.toString() + " lastpassword: " + localPasswdRedBagInfo.e);
                }
                if (paramInt > k)
                {
                  localJSONObject.put("key_extstr_idiomseq", paramInt);
                  PasswdRedBagInfo.a(localJSONObject, paramString4);
                  localPasswdRedBagInfo.f = localJSONObject.toString();
                  paramString2 = paramString2.trim() + "_" + paramString3.trim();
                  if (QLog.isColorLevel()) {
                    QLog.d("PasswdRedBagManager", 2, "finalLastWord: " + paramString2);
                  }
                  paramString3 = a(localPasswdRedBagInfo.e);
                  localPasswdRedBagInfo.e = paramString2;
                  a(localPasswdRedBagInfo, paramString3);
  ...
  public void a(String paramString1, String paramString2, String paramString3, String paramString4, long paramLong, String paramString5, String paramString6, String paramString7, boolean paramBoolean1, boolean paramBoolean2, int paramInt, String paramString8, String paramString9)
  {
    ...
    {
      paramString2 = new PasswdRedBagInfo(paramString1, paramString2, paramString4, paramLong, new QQText(paramString3, 5, 16).toString(), paramBoolean1, paramBoolean2, false, paramInt, paramString8, paramString9);
      a(paramString2);
  ...
  {
    VoiceRedPacketHelper.a().a(new PasswdRedBagManager.6(this, paramInt2, paramInt1, paramBusinessObserver));
  }
  ...
  public boolean a(String paramString, PasswdRedBagInfo paramPasswdRedBagInfo)
  {
    if ((StringUtil.a(paramString)) || (paramPasswdRedBagInfo == null)) {}
    String str;
    do
    {
      do
      {
            ...
            for (;;)
            {
              ...
              if (paramString.trim().length() >= 4)
              {
                ...
                if ((paramString != null) && (paramString.length != 0))
                {
                  ...
                  while (k < m)
                  {
                    paramPasswdRedBagInfo = paramString[k];
                    if ((!StringUtil.a(str)) && (paramPasswdRedBagInfo.equals(str.trim()))) {
                      return true;
                    }
                    k += 1;
                  }
        ...
        } while ((StringUtil.a(paramString)) || (!paramString.equalsIgnoreCase(str)));
        return true;
        if (paramPasswdRedBagInfo.a() != 2) {
          break;
        }
      } while (!b(paramString, str, paramPasswdRedBagInfo));
      return true;
    } while ((paramPasswdRedBagInfo.a() != 3) || (!a(paramString, str, paramPasswdRedBagInfo)));
    return true;
  }
  ...
  public Object[] a(SessionInfo paramSessionInfo, String paramString, int paramInt)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.i("PasswdRedBagManager", 2, "----word hb----" + localPasswdRedBagInfo.jdField_a_of_type_JavaLangString);
    }
    if ((!StringUtil.a(paramString)) && (localPasswdRedBagInfo != null) && (!StringUtil.a(localPasswdRedBagInfo.d)) && (paramString.trim().equals(localPasswdRedBagInfo.d.trim())))
    {
      a(localPasswdRedBagInfo.jdField_a_of_type_JavaLangString, paramSessionInfo.jdField_a_of_type_JavaLangString, paramSessionInfo.jdField_a_of_type_Int);
    ...
    for (;;)
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.i("PasswdRedBagManager", 2, "----word chain hb----" + localPasswdRedBagInfo.jdField_a_of_type_JavaLangString);
        }
        if (a(paramString, localPasswdRedBagInfo)) {
          a(paramString.trim(), paramSessionInfo, localPasswdRedBagInfo, l, paramInt);
        }
      }
    }
  }
  ...
  public Object[] a(String paramString1, SessionInfo paramSessionInfo, String paramString2, int paramInt)
  {
    ...
    a(false);
    d();
    PasswdRedBagInfo localPasswdRedBagInfo = (PasswdRedBagInfo)this.jdField_a_of_type_JavaUtilHashMap.get(paramString2);
    if (localPasswdRedBagInfo == null)
    {
    ...
    while (4 != localPasswdRedBagInfo.jdField_a_of_type_Int) {
    ...
    {
      if ((localPasswdRedBagInfo.jdField_a_of_type_Int != 0) || (StringUtil.a(localPasswdRedBagInfo.d)) || (!paramString1.equals(localPasswdRedBagInfo.d))) {
        break label436;
      }
      a(localPasswdRedBagInfo.jdField_a_of_type_JavaLangString, paramSessionInfo.jdField_a_of_type_JavaLangString, paramSessionInfo.jdField_a_of_type_Int);
      a(paramSessionInfo, localPasswdRedBagInfo, l, paramInt);
    ...
    for (;;)
    {
      ...
      return arrayOfObject;
      label436:
      if ((4 != localPasswdRedBagInfo.jdField_a_of_type_Int) || (!a(paramString1, localPasswdRedBagInfo)) || (localPasswdRedBagInfo.jdField_b_of_type_Boolean) || (localPasswdRedBagInfo.a())) {
        break;
      }
      if (QLog.isColorLevel()) {
        QLog.i("PasswdRedBagManager", 2, "----成语接龙红包----" + localPasswdRedBagInfo.jdField_a_of_type_JavaLangString);
      }
      a(paramString1.trim(), paramSessionInfo, localPasswdRedBagInfo, l, paramInt);
    }
    if (QLog.isColorLevel()) {
  ...
  public void b()
  {
    ...
    do
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        localPasswdRedBagUpdateInfo.b = Long.parseLong((String)this.jdField_j_of_type_JavaUtilHashMap.get(localObject));
        int k = localList.indexOf(localPasswdRedBagUpdateInfo);
        if (k != -1)
        {
          localObject = (PasswdRedBagUpdateInfo)localList.get(k);
  ...
  {
    String str = HardCodeUtil.a(2131707883);
    if (paramInt == 8) {
      str = "禁言不能抢K歌红包哦";
    }
    for (;;)
    {
      ...
      return;
      if (paramInt == 9) {
        str = HardCodeUtil.a(2131707880);
      } else if (paramInt == 10) {
        str = HardCodeUtil.a(2131707881);
      } else if (paramInt == 11) {
        str = HardCodeUtil.a(2131707884);
      }
    }
  }
  ...
  public void d()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: invokevirtual 1279	com/tencent/mobileqq/activity/qwallet/PasswdRedBagManager:a	()Z
    //   6: ifeq +7 -> 13
    //   9: aload_0
    //   10: invokevirtual 1281	com/tencent/mobileqq/activity/qwallet/PasswdRedBagManager:e	()V
    //   13: aload_0
    //   14: getfield 157	com/tencent/mobileqq/activity/qwallet/PasswdRedBagManager:jdField_h_of_type_Boolean	Z
    //   17: ifeq +12 -> 29
    //   20: aload_0
    //   21: getfield 572	com/tencent/mobileqq/activity/qwallet/PasswdRedBagManager:jdField_i_of_type_Boolean	Z
    //   24: istore_1
    //   25: iload_1
    //   26: ifeq +6 -> 32
    //   29: aload_0
    ...
    //   32: aload_0
    //   33: iconst_1
    //   34: putfield 572	com/tencent/mobileqq/activity/qwallet/PasswdRedBagManager:jdField_i_of_type_Boolean	Z
    //   37: new 1402	com/tencent/mobileqq/activity/qwallet/PasswdRedBagManager$10
    //   40: dup
    //   41: aload_0
    //   42: invokespecial 1403	com/tencent/mobileqq/activity/qwallet/PasswdRedBagManager$10:<init>	(Lcom/tencent/mobileqq/activity/qwallet/PasswdRedBagManager;)V
    //   45: bipush 32
    //   47: aconst_null
    //   48: iconst_1
    //   49: invokestatic 1404	com/tencent/mobileqq/app/ThreadManager:excute	(Ljava/lang/Runnable;ILcom/tencent/mobileqq/app/ThreadExcutor$IThreadListener;Z)V
    //   52: goto -23 -> 29
    //   55: astore_2
    //   56: aload_0
    //   57: monitorexit
  ...
  public void onDestroy()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityQwalletPasswdRedBagManager$RedPacketRefreshReceiver != null) && (this.jdField_a_of_type_AndroidContentContext != null)) {
      this.jdField_a_of_type_AndroidContentContext.unregisterReceiver(this.jdField_a_of_type_ComTencentMobileqqActivityQwalletPasswdRedBagManager$RedPacketRefreshReceiver);
    }
  }
}
