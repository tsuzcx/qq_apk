...
public class GoldMsgAioState
{
  ...
  public static void b(BaseChatPie paramBaseChatPie)
  {
    for (;;)
    {
      try
      {
        ...
        {
          paramBaseChatPie.a(paramBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getDrawable(2130843377));
          ...
          paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqWidgetNavbarNavBarAIO.setBackgroundResource(2130845951);
          paramBaseChatPie.m.setVisibility(0);
          paramBaseChatPie.b.findViewById(2131363514).setVisibility(0);
          paramBaseChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx.setBackgroundResource(2130845717);
          paramBaseChatPie.jdField_d_of_type_AndroidWidgetTextView.setTextColor(paramBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getColor(2131494218));
          paramBaseChatPie.d().setTextColor(paramBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getColor(2131494218));
          paramBaseChatPie.c().setTextColor(paramBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getColor(2131494218));
          if (paramBaseChatPie.a().getVisibility() == 0)
          {
            paramBaseChatPie.a().setBackgroundResource(2130846346);
            paramBaseChatPie.a().setTextColor(paramBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getColor(2131494216));
            if (paramBaseChatPie.c().getVisibility() == 0) {
              paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqWidgetNavbarNavBarAIO.setRight2Icon(2130846348, 2130846349);
            }
            if (paramBaseChatPie.a().getVisibility() == 0)
            {
              paramBaseChatPie.a().setBackgroundResource(2130846351);
              if (paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int != 0) {
                break label456;
              }
              paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqWidgetNavbarNavBarAIO.setRight1Icon(2130845980);
            }
            paramBaseChatPie.b.setBackgroundResource(2130845716);
            ...
            if (paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioPanelPanelIconLinearLayout != null) {
              paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioPanelPanelIconLinearLayout.setBackgroundResource(2130845758);
            }
            Object localObject = paramBaseChatPie.c.findViewById(2131363523);
        ...
        {
          paramBaseChatPie.a(paramBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getColor(2131494260), true);
          continue;
        }
      ...
      paramBaseChatPie.b().setBackgroundResource(2130846347);
      paramBaseChatPie.b().setPadding(0, 0, 0, 0);
      paramBaseChatPie.b().setTextColor(paramBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getColor(2131494218));
      paramBaseChatPie.b().setBackgroundResource(2130837561);
      continue;
      label456:
      if ((paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1) || (paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 3000)) {
        paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqWidgetNavbarNavBarAIO.setRight1Icon(2130845974);
      }
    }
  }
  ...
  public void a(BaseChatPie paramBaseChatPie)
  {
    for (;;)
    {
      try
      {
        ...
        {
          this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(paramBaseChatPie.jdField_a_of_type_AndroidContentContext).inflate(2130971013, paramBaseChatPie.a(), false);
          ...
          this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131372519));
          this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131365559);
          this.jdField_a_of_type_AndroidViewView.findViewById(2131372518).setOnClickListener(paramBaseChatPie);
        }
        this.jdField_a_of_type_AndroidViewView.setVisibility(0);
        ((RelativeLayout.LayoutParams)localObject).addRule(2, 2131372517);
        if (ThemeUtil.isNowThemeIsDefault(null, false, null))
        {
          ...
          {
            paramBaseChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx.setBackgroundResource(2130844141);
          ...
          if (paramBaseChatPie.a().getVisibility() == 0)
          {
            paramBaseChatPie.a().setBackgroundResource(2130844163);
            paramBaseChatPie.a().setTextColor(-13421773);
            if (paramBaseChatPie.c().getVisibility() == 0) {
              paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqWidgetNavbarNavBarAIO.setRight2Icon(2130844182, 2130844182);
            }
            if (paramBaseChatPie.a().getVisibility() == 0)
            {
              ...
              paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqWidgetNavbarNavBarAIO.setRight1Icon(2130844188);
            }
            paramBaseChatPie.jdField_d_of_type_AndroidViewViewGroup.setBackgroundColor(-1298);
            if (paramBaseChatPie.b != null)
            {
              paramBaseChatPie.b.findViewById(2131363514).setVisibility(8);
              paramBaseChatPie.b.getBackground().setVisible(true, false);
              paramBaseChatPie.b.setBackgroundResource(2130844169);
            }
            if (paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioPanelPanelIconLinearLayout != null) {
            ...
            localObject = paramBaseChatPie.c.findViewById(2131363523);
            localLayoutParams = (RelativeLayout.LayoutParams)((View)localObject).getLayoutParams();
            localLayoutParams.addRule(2, 2131372517);
            ((View)localObject).setLayoutParams(localLayoutParams);
            localObject = paramBaseChatPie.a();
            localLayoutParams = (RelativeLayout.LayoutParams)((View)localObject).getLayoutParams();
            localLayoutParams.addRule(2, 2131372517);
      ...
      paramBaseChatPie.b().setBackgroundResource(2130844158);
      paramBaseChatPie.b().setTextColor(-13421773);
      paramBaseChatPie.b().setBackgroundResource(2130844171);
      continue;
      label608:
      if ((paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1) || (paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 3000)) {
        paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqWidgetNavbarNavBarAIO.setRight1Icon(2130844185);
      }
    }
  }
  ...
  public void a(BaseChatPie paramBaseChatPie, PlusPanel paramPlusPanel)
  {
    ...
    if (this.c == null)
    {
      this.c = a(2131432296, 2130842505, paramBaseChatPie.jdField_a_of_type_AndroidContentContext);
      if (this.c == null) {
        return;
      }
  ...
  public void a(BaseChatPie paramBaseChatPie, String paramString, int paramInt, RelativeLayout paramRelativeLayout)
  {
    ...
    {
      this.jdField_b_of_type_AndroidWidgetTextView = a(paramInt, 2130842506, paramBaseChatPie.jdField_a_of_type_AndroidContentContext);
      if (this.jdField_b_of_type_AndroidWidgetTextView == null) {
        return;
      }
      paramBaseChatPie = new RelativeLayout.LayoutParams(-2, -2);
      paramBaseChatPie.addRule(2, 2131372517);
    ...
    for (;;)
    {
      ...
      return;
      this.jdField_b_of_type_AndroidWidgetTextView.setText(2131432297);
    }
  }
    ...
    if (paramBoolean1)
    {
      ...
      if (!paramBoolean2)
      {
        ...
        if (i == 0)
        {
          ...
          a(paramBaseChatPie, String.format(paramBaseChatPie.jdField_a_of_type_AndroidContentContext.getResources().getString(2131432316), new Object[] { NumAnim.formatNumber(((GoldMsgChatHelper.GoldMsgChatState)localObject).jdField_a_of_type_Long / 100.0D, false) }), 2131432316, paramBaseChatPie.a());
        }
      }
      for (;;)
      {
        ...
        if (!paramBoolean2)
        {
          if (paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioPanelPanelIconLinearLayout != null)
          {
            ...
            if (paramBoolean1) {
              paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioPanelPanelIconLinearLayout.setSelected(8);
            }
          }
  ...
  public void c(BaseChatPie paramBaseChatPie)
  {
    ...
    for (;;)
    {
      ...
      paramBaseChatPie = localResources.getString(2131432345, new Object[] { str });
      continue;
      paramBaseChatPie = paramBaseChatPie.jdField_a_of_type_AndroidContentContext.getResources().getString(2131432346, new Object[] { str, String.valueOf(localGoldMsgChatState.c) });
    }
  }
  ...
  public void c(BaseChatPie paramBaseChatPie, boolean paramBoolean1, boolean paramBoolean2, String paramString)
  {
    ...
    paramBaseChatPie.a().postDelayed(new xjy(this, localGoldMsgEntryDialog, paramBaseChatPie, paramBoolean1, paramBoolean2, paramString), 500L);
  }
  ...
  public void d(BaseChatPie paramBaseChatPie)
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setMessage("好友设置仅接收不少于" + (String)localObject + "的句有料消息，开启后默认单条消息包含金额为" + (String)localObject + "。").setPositiveButton("我知道了", new xjz(this));
  ...
  public void e(BaseChatPie paramBaseChatPie)
  {
    ...
    case 0: 
      ...
      PriceSettingDialog.a(localContext, (Intent)localObject1, new xka(this, localSessionInfo, localQQAppInterface));
    ...
    String str1 = localResources.getString(2131432333);
    paramBaseChatPie = "0.03";
    String str2 = localResources.getString(2131432335);
    String str3 = localResources.getString(2131432334);
    ...
    localObject1 = DialogUtil.a(localContext, 2131432347, 2131432332, str1, paramBaseChatPie, str2, (TextWatcher)localObject1, str3, (String)localObject2, localResources.getString(2131432336), localTextWatcher, new xkb(this, localContext), new xkc(this, localContext, localSessionInfo, localQQAppInterface));
    paramBaseChatPie = new xkd(this, (QQCustomDialog)localObject1, localContext);
    localObject2 = (FormEditItem)((QQCustomDialog)localObject1).findViewById(2131364108);
    localObject1 = (FormEditItem)((QQCustomDialog)localObject1).findViewById(2131364110);
