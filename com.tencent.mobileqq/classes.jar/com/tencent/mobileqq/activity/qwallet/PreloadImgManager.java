...
public class PreloadImgManager
{
  ...
  private DownloadListener jdField_a_of_type_ComTencentMobileqqVipDownloadListener = new xfy(this);
  ...
  /* Error */
  private Bitmap a(android.content.Context paramContext, String paramString1, String paramString2)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 8
    ...
    //   228: astore 6
    //   230: aload_0
    //   231: getfield 34	com/tencent/mobileqq/activity/qwallet/PreloadImgManager:jdField_a_of_type_AndroidSupportV4UtilMQLruCache	Landroid/support/v4/util/MQLruCache;
    //   234: ifnull -206 -> 28
    //   237: aload_2
    //   238: astore 6
    //   240: aload_2
    //   241: ifnull -213 -> 28
    //   244: aload_0
    //   245: getfield 34	com/tencent/mobileqq/activity/qwallet/PreloadImgManager:jdField_a_of_type_AndroidSupportV4UtilMQLruCache	Landroid/support/v4/util/MQLruCache;
    //   248: aload_3
    //   249: aload_2
  ...
  private void a(AppInterface paramAppInterface, String paramString, List paramList)
  {
    ...
    Object localObject = new File(a(paramAppInterface), MD5.toMD5(paramString));
    if (((File)localObject).exists()) {
      paramAppInterface.getApplication();
    }
    for (paramAppInterface = a(MobileQQ.getContext(), ((File)localObject).getPath(), paramString);; paramAppInterface = null)
    {
      int i = 0;
      if (i < paramList.size())
      {
        localObject = (PreloadImgManager.OnSingleDownloadCallback)paramList.get(i);
        if (localObject == null) {}
        for (;;)
        {
          i += 1;
          ...
          if (paramAppInterface != null) {
            ((PreloadImgManager.OnSingleDownloadCallback)localObject).a(paramAppInterface);
          } else {
            ((PreloadImgManager.OnSingleDownloadCallback)localObject).a();
          }
        }
      }
  ...
  private void b(AppInterface paramAppInterface, String paramString, List paramList)
  {
    if ((paramList == null) || (paramList.isEmpty()))
    {
      if (QLog.isColorLevel()) {
    ...
    paramAppInterface = new File(a(paramAppInterface), MD5.toMD5(paramString));
    int i = 0;
    if (i < paramList.size())
    {
      ...
      for (;;)
      {
        ...
        if (paramAppInterface.exists()) {
          localOnSingleDownloadCallback.a(paramAppInterface.getAbsolutePath());
        } else {
  ...
  private String c(AppInterface paramAppInterface)
  {
  ...
  public Bitmap a(AppInterface paramAppInterface, String paramString)
  {
    ...
    for (paramString = (Bitmap)this.jdField_a_of_type_AndroidSupportV4UtilMQLruCache.get(str1);; paramString = null)
    {
      if (paramString == null)
      {
        ...
        File localFile2 = new File(b(paramAppInterface), str2);
        File localFile1 = localFile2;
        if (!localFile2.exists()) {
          localFile1 = new File(c(paramAppInterface), str2);
        }
  ...
  public String a(AppInterface paramAppInterface)
  {
    String str = b(paramAppInterface);
  ...
  public String a(AppInterface paramAppInterface, String paramString)
  {
    ...
    do
    {
      ...
      paramString = a(paramAppInterface) + File.separator + MD5.toMD5(str);
  ...
  public void a(AppInterface paramAppInterface, String paramString1, String paramString2, PreloadImgManager.OnSingleDownloadCallback paramOnSingleDownloadCallback)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqVipDownloaderInterface.a(paramString1, new xga(this, paramAppInterface), null);
  }
  ...
  public void b(AppInterface paramAppInterface, Set paramSet)
  {
    ...
    if ((paramSet != null) && (!paramSet.isEmpty()))
    {
      ...
      str2 = b(paramAppInterface);
      str3 = c(paramAppInterface);
    ...
    for (String str1 = str3;; str1 = str2)
    {
      ...
      ThreadManager.post(new xgb(this, paramSet, str2, str3, paramAppInterface, localArrayList, str1, localHashMap, localBundle), 8, new xgc(this, localArrayList, localHashMap, localBundle), true);
      return;
    }
  }
}
