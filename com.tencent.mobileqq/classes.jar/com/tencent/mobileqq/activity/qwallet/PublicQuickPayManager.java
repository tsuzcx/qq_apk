  ...
  implements Manager
{
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomSingleButtonDialog = DialogUtils.a(this.jdField_a_of_type_AndroidContentContext, HardCodeUtil.a(2131708803), "", HardCodeUtil.a(2131708804), new PublicQuickPayManager.2(this), null, null);
  ...
  public boolean a(String paramString, JSONObject paramJSONObject, PublicQuickPayManager.QQWalletPayCompletionImp paramQQWalletPayCompletionImp)
  {
    ...
    if (!((QWalletConfigManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.QWALLET_CONFIG_MANAGER)).a(paramString))
    {
      a();
    ...
    if ((!TextUtils.isEmpty(paramString)) && (!TextUtils.isEmpty((CharSequence)localObject)))
    {
      ...
      PayBridgeActivity.newPay(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, BaseActivity.sTopActivity, paramQQWalletPayCompletionImp, 9, localBundle);
      if (QLog.isColorLevel()) {
