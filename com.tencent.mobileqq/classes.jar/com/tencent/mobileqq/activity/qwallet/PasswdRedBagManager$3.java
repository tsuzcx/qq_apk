...
public class PasswdRedBagManager$3
  implements Runnable
{
  public PasswdRedBagManager$3(agjk paramagjk, SessionInfo paramSessionInfo) {}
  
  public void run()
  {
    ArrayList localArrayList = new ArrayList();
    Object localObject1 = agjk.a(this.this$0).a().b(this.a.jdField_a_of_type_JavaLangString, this.a.jdField_a_of_type_Int);
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if ((localObject2 instanceof MessageForQQWalletMsg))
        {
          ...
          if (((MessageForQQWalletMsg)localObject2).mQQWalletRedPacketMsg != null)
          {
            ...
            if ((localObject3 != null) && (((agjj)localObject3).jdField_a_of_type_Int == 4) && (!((agjj)localObject3).b)) {
