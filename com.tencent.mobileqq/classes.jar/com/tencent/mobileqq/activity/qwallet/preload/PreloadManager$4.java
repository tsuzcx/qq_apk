...
class PreloadManager$4
  extends TimerTask
{
  PreloadManager$4(PreloadManager paramPreloadManager, WeakReference paramWeakReference, List paramList, bbwt parambbwt) {}
  ...
  public void run()
  {
    ...
    if (PreloadManager.a(localPreloadManager)) {
      PreloadManager.a(localPreloadManager, this.jdField_a_of_type_JavaUtilList, this.jdField_a_of_type_Bbwt);
    }
  }
}
