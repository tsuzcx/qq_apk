  ...
  extends AbsDownloader
{
  public Object decodeFile(File paramFile, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    {
      if ((paramFile != null) && (paramFile.exists()) && (paramDownloadParams.useApngImage) && ("png".equals(FileUtils.b(paramFile.getPath()))))
      {
  ...
  public File downloadImage(java.io.OutputStream paramOutputStream, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    //   206: aconst_null
    //   207: areturn
    //   208: new 142	com/tencent/mobileqq/qwallet/preload/DownloadParam
    //   211: dup
    //   212: invokespecial 143	com/tencent/mobileqq/qwallet/preload/DownloadParam:<init>	()V
    //   215: astore_3
    //   216: aload_3
    //   217: aload_2
    //   218: putfield 145	com/tencent/mobileqq/qwallet/preload/DownloadParam:url	Ljava/lang/String;
    //   221: aload_3
    //   222: aload_1
    //   223: putfield 148	com/tencent/mobileqq/qwallet/preload/DownloadParam:md5	Ljava/lang/String;
    //   226: aload_3
    //   227: iconst_1
    //   228: putfield 151	com/tencent/mobileqq/qwallet/preload/DownloadParam:useQWalletConfig	Z
    ...
    //   239: astore_1
    //   240: invokestatic 161	com/tencent/mobileqq/qwallet/preload/PreloadStaticApi:a	()Lcom/tencent/mobileqq/qwallet/preload/IPreloadServiceAbs;
    //   243: aload_3
    //   244: new 163	com/tencent/mobileqq/activity/qwallet/preload/QWalletPicDownloader$1
    //   247: dup
    //   248: aload_0
    //   249: aload 5
    //   251: aload_1
    //   252: invokespecial 166	com/tencent/mobileqq/activity/qwallet/preload/QWalletPicDownloader$1:<init>	(Lcom/tencent/mobileqq/activity/qwallet/preload/QWalletPicDownloader;Ljava/io/File;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    //   255: invokeinterface 172 3 0
    //   260: aload_1
    //   261: invokevirtual 175	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   264: ifne -192 -> 72
    //   267: aload 5
    //   269: monitorenter
    //   270: aload_1
    //   271: invokevirtual 175	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   274: istore 4
    //   276: iload 4
    //   278: ifne +11 -> 289
    //   281: aload 5
    //   283: ldc2_w 176
    //   286: invokevirtual 183	java/lang/Object:wait	(J)V
    //   289: aload 5
    //   291: monitorexit
    //   292: goto -220 -> 72
    //   295: astore_1
    ...
    //   0	305	0	this	QWalletPicDownloader
    //   0	305	1	paramOutputStream	java.io.OutputStream
    //   0	305	2	paramDownloadParams	DownloadParams
    //   0	305	3	paramURLDrawableHandler	URLDrawableHandler
    //   274	3	4	bool	boolean
    //   24	273	5	localFile	File
    //   13	183	6	str	String
    // Exception table:
    //   from	to	target	type
    //   270	276	295	finally
    ...
    //   289	292	295	finally
    //   296	299	295	finally
    //   281	289	301	java/lang/InterruptedException
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes7.jar
 * Qualified Name:     com.tencent.mobileqq.activity.qwallet.preload.QWalletPicDownloader
