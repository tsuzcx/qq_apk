  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    Object localObject = (ajyg)this.this$0.a.getManager(245);
    if (localObject != null)
    {
      ((ajyg)localObject).c("preload", this.this$0);
      localObject = ((ajyg)localObject).a("preload");
      this.this$0.a((ajye)localObject);
    }
  }
}
