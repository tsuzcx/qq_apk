  ...
  extends QIPCModule
{
  ...
  private Map<Integer, IQWalletConfigService.ConfigUpdateListener> a;
  ...
  public static QWalletIPCModule a()
  {
    if (jdField_a_of_type_ComTencentMobileqqActivityQwalletPreloadQWalletIPCModule == null) {}
    try
    {
      if (jdField_a_of_type_ComTencentMobileqqActivityQwalletPreloadQWalletIPCModule == null) {
        jdField_a_of_type_ComTencentMobileqqActivityQwalletPreloadQWalletIPCModule = new QWalletIPCModule();
      }
      return jdField_a_of_type_ComTencentMobileqqActivityQwalletPreloadQWalletIPCModule;
    }
    finally {}
  }
  ...
  private EIPCResult a(QQAppInterface paramQQAppInterface, Bundle paramBundle, int paramInt)
  {
    ...
    case 9: 
      ...
      paramQQAppInterface = (ActivateFriendsManager)paramQQAppInterface.getManager(QQManagerFactory.MGR_ACTVATE_FRIENDS);
    ...
    case 11: 
      ...
      paramQQAppInterface = (IQQReminderAlarmService)paramQQAppInterface.getRuntimeService(IQQReminderAlarmService.class, "");
      if ((paramQQAppInterface != null) && (paramBundle != null)) {
        paramQQAppInterface.setAlarmTimer(paramBundle);
      }
      return null;
    case 12: 
      paramBundle = (AcsMsg)paramBundle.getSerializable("req_param");
      if (paramBundle != null)
      {
        ...
        paramQQAppInterface = (IQQReminderAlarmService)paramQQAppInterface.getRuntimeService(IQQReminderAlarmService.class, "");
        if (paramQQAppInterface != null) {
          paramQQAppInterface.cancelAlarmById(QQNotifyHelper.a(paramBundle).hashCode());
        }
      }
      return null;
    case 13: 
      ...
      if ((paramQQAppInterface != null) && (paramBundle != null))
      {
        paramQQAppInterface.getMessageFacade().b(AppConstants.ACTIVATE_FRIENDS_UIN, 9002, paramBundle.msg_id.hashCode());
        paramQQAppInterface.refreshAppBadge();
      }
      return null;
    case 0: 
      paramQQAppInterface = ContactUtils.c(paramQQAppInterface, paramBundle.getString("uin"), true);
      paramBundle = new Bundle();
    ...
    case 7: 
      ...
      EmojiGifHelper.getInstance().compositeAndTransToGifInner(paramQQAppInterface, new QWalletIPCModule.4(this, paramInt));
      return null;
    case 8: 
      ...
      return null;
    case 18: 
      paramInt = ComIPCUtils.a(paramBundle.getString("path"));
    ...
    case 6: 
      ...
      paramQQAppInterface = (QWalletRedManager)paramQQAppInterface.getManager(QQManagerFactory.QWALLET_RED_MANAGER);
      if (paramQQAppInterface != null) {
  ...
  private void a(Bundle paramBundle, QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (TextUtils.isEmpty(paramBundle)) {
        localObject1 = ContactUtils.c(paramQQAppInterface, str, true);
      }
      for (;;)
      {
  ...
  private void a(AppRuntime paramAppRuntime, Bundle paramBundle)
  {
    if ((paramAppRuntime != null) && (paramBundle != null))
    {
      ...
      if (paramBundle != null)
      {
        paramAppRuntime = (QWalletConfigManager)((QQAppInterface)paramAppRuntime).getManager(QQManagerFactory.QWALLET_CONFIG_MANAGER);
  ...
  private EIPCResult b(QQAppInterface paramQQAppInterface, Bundle paramBundle, int paramInt)
  {
    ...
    case 1: 
      ...
      ((IPreloadService)paramQQAppInterface.getRuntimeService(IPreloadService.class, "")).getResPath(paramBundle, new QWalletIPCModule.8(this, paramInt));
      return null;
    case 2: 
      ...
      {
        paramBundle = new QWalletIPCModule.7(this, (ResultReceiver)paramBundle.getParcelable("receiver"));
        ((IPreloadService)paramQQAppInterface.getRuntimeService(IPreloadService.class, "")).downloadUrls((List)localObject, paramBundle);
        return null;
      }
    case 4: 
      paramQQAppInterface = PreloadStaticApi.a((DownloadParam)paramBundle.getSerializable("download_params"));
      paramBundle = new Bundle();
    ...
    ((IPreloadService)paramQQAppInterface.getRuntimeService(IPreloadService.class, "")).getResPath(paramBundle, new QWalletIPCModule.9(this, paramInt));
    return null;
  }
  ...
  public EIPCResult a(Bundle paramBundle, int paramInt)
  {
    ...
    case 3: 
      for (;;)
      {
        ...
        localObject = new QWalletIPCModule.10(this, (Bundle)localObject, localResultReceiver);
        if (paramInt == 1) {
    ...
    if (paramBundle != null)
    {
      ...
      ((Bundle)localObject).putString("pop_ad_bg_jump_url", paramBundle.optString("bg_jump_url"));
    }
    return EIPCResult.createSuccessResult((Bundle)localObject);
  }
      ...
      for (;;)
      {
        ...
        else
        {
          if ("getVideoResPathByMID".equals(paramString))
          {
            ...
            paramString = ((IPreloadService)((AppRuntime)localObject).getRuntimeService(IPreloadService.class, "")).getVideoResPathByID(paramString);
            if (QLog.isColorLevel()) {
          ...
          if ("getResourceByResID".equals(paramString))
          {
            ...
            paramString = ((IPreloadService)((AppRuntime)localObject).getRuntimeService(IPreloadService.class, "")).getResourceByResID(paramString);
            if (QLog.isColorLevel()) {
          ...
          {
            paramString = paramBundle.getString("res_id");
            paramString = ((IPreloadService)((AppRuntime)localObject).getRuntimeService(IPreloadService.class, "")).getResInfoByResId(paramString);
            if (QLog.isColorLevel()) {
          ...
          else
          {
            if ("getConditionSearchManager".equals(paramString))
            {
              ...
              paramBundle = (ConditionSearchManager)((QQAppInterface)localObject).getManager(QQManagerFactory.CONDITION_SEARCH_MANAGER);
              ...
              if (paramInt != 0)
              {
                ...
                if (i == 0) {
                  paramBundle.c(new QWalletIPCModule.3(this, (Bundle)localObject, i, paramString, paramBundle));
                }
