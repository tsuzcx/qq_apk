...
public class QWalletIPCModule$2
  implements Runnable
{
  public QWalletIPCModule$2(akbx paramakbx, Bundle paramBundle, AppRuntime paramAppRuntime, String paramString) {}
  ...
  public void run()
  {
    ...
    akca localakca = new akca(this, (ResultReceiver)this.jdField_a_of_type_AndroidOsBundle.getParcelable("receiver"));
    ...
    if ("downloadModule".equals(this.jdField_a_of_type_JavaLangString)) {
      localPreloadManager.b(str2, str1, localakca);
    }
    while (!"downloadRes".equals(this.jdField_a_of_type_JavaLangString)) {
      return;
    }
    localPreloadManager.a(str2, str1, localakca);
  }
}
