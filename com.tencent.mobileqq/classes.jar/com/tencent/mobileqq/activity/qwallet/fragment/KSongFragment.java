  ...
  implements View.OnClickListener
{
  ...
  private agqj jdField_a_of_type_Agqj;
  ...
  private void c()
  {
    try
    {
      if (!baip.a(this.jdField_a_of_type_ComTencentMobileqqActivityQwalletFragmentKSongFragment$KsongBundleInfo.biz_params))
      {
  ...
  {
    b();
    this.jdField_a_of_type_Agqj = ((agqj)this.mQApp.getManager(273));
    this.jdField_a_of_type_Agqj.b("3001");
  }
  
  public void a(Bundle paramBundle)
  {
    super.a(paramBundle);
    bfok.a(paramBundle, this.jdField_a_of_type_ComTencentMobileqqActivityQwalletFragmentKSongFragment$KsongBundleInfo);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131298651));
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      try
      {
        this.jdField_a_of_type_Agqj.a("3001");
