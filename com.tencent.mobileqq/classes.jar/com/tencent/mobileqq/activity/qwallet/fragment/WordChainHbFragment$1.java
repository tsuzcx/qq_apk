  ...
  public void run()
  {
    if ((WordChainHbFragment.a(this.this$0) != null) && (WordChainHbFragment.a(this.this$0).size() > 0) && (WordChainHbFragment.a(this.this$0) != null))
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        localMarginLayoutParams.leftMargin = UIUtils.a(this.this$0.mActivity, 5.0F);
        localMarginLayoutParams.rightMargin = UIUtils.a(this.this$0.mActivity, 5.0F);
        localMarginLayoutParams.bottomMargin = UIUtils.a(this.this$0.mActivity, 10.0F);
        ...
        localTextView.setPadding(UIUtils.a(this.this$0.mActivity, 16.0F), UIUtils.a(this.this$0.mActivity, 5.0F), UIUtils.a(this.this$0.mActivity, 16.0F), UIUtils.a(this.this$0.mActivity, 5.0F));
        localTextView.setTextColor(Color.parseColor("#03081A"));
        localTextView.setTag(localWordChainTypeLabel);
        localTextView.setBackgroundDrawable(this.this$0.getResources().getDrawable(2130847658));
        localTextView.setOnClickListener(new WordChainHbFragment.1.1(this, localTextView, localWordChainTypeLabel));
      }
