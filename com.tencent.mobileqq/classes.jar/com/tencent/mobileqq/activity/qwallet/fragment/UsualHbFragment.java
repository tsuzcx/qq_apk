  ...
  implements View.OnClickListener
{
  ...
  private ahaq jdField_a_of_type_Ahaq;
  ...
  private void c()
  {
    ...
    int i = bgxb.a(this.jdField_a_of_type_AndroidWidgetEditText.getText().toString(), 1);
    String str = bgxb.a(String.valueOf(a()));
    if (TextUtils.isEmpty(str))
    {
      bcql.a(getActivity(), 2131693258, 0).a();
      return;
    }
    combineUploadData(this.jdField_a_of_type_Bgxj, b(), i, str, "hongbao.wrap.go");
    Object localObject2 = this.c.getText().toString();
    Object localObject1 = localObject2;
    if (TextUtils.isEmpty((CharSequence)localObject2))
    {
      if (TextUtils.isEmpty(this.c.getHint())) {
        localObject1 = getResources().getString(2131697098);
      }
    }
    else
    {
      ...
      if (!this.jdField_a_of_type_Ahaq.a()) {
        break label325;
      }
      ((Map)localObject2).put("skin_id", "" + ahan.c);
    }
    for (;;)
    {
      ...
      break;
      label325:
      ((Map)localObject2).put("skin_id", "" + this.jdField_a_of_type_Ahaq.a());
    }
  }
  
  protected float a()
  {
    float f2 = bgxb.a(this.b.getText().toString());
    float f1 = f2;
    if (bgxb.a(this.jdField_a_of_type_Bgxj.bus_type, 1) == 1) {
      f1 = f2 * bgxb.a(this.jdField_a_of_type_AndroidWidgetEditText.getText().toString(), 0);
    }
    return f1;
  }
  ...
  public void a()
  {
    ...
    label162:
    for (int i = this.bundle.getInt("skin_id", -1);; i = bgxb.a(localObject, -1))
    {
      QLog.i("UsualHbFragment", 2, "init data skin id: " + i);
      localObject = this.jdField_a_of_type_Ahaq;
      ...
      ((ahaq)localObject).a(localLinearLayout);
      ((ViewGroup)this.jdField_a_of_type_AndroidWidgetLinearLayout.getParent()).setVisibility(0);
      if (-1 != i) {
        this.jdField_a_of_type_Ahaq.a(i);
      }
      this.jdField_a_of_type_Ahaq.a(new ahaj(this));
      this.jdField_a_of_type_Ahaq.a(this.bundle);
      return;
    }
  }
  ...
  public void a(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_Ahaq = this.mActivity.a();
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363051));
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
    paramBundle = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378210);
    if (String.valueOf(2).equals(this.jdField_a_of_type_Bgxj.bus_type))
    {
      paramBundle.setText(2131697055);
      return;
    }
    paramBundle.setText(2131697056);
  }
  
  public int b()
  {
    if ((jdField_a_of_type_JavaUtilList.contains(Integer.valueOf(this.channel))) && (this.jdField_a_of_type_Ahaq.a() == -2)) {
      return 8;
    }
    return this.channel;
  }
  ...
  public void onClick(View paramView)
  {
    ...
    openUrl(ajzd.a(3, (QQAppInterface)this.mActivity.getAppRuntime()));
  }
  ...
  public void onDestroyView()
  {
    super.onDestroyView();
    if (jdField_a_of_type_JavaUtilList.contains(Integer.valueOf(this.channel))) {
      this.jdField_a_of_type_Ahaq.a(this.jdField_a_of_type_AndroidWidgetLinearLayout);
    }
  }
