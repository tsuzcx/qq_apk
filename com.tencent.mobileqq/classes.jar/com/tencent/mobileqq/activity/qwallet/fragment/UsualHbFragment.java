  ...
  implements View.OnClickListener
{
  ...
  private void c()
  {
    ...
    int i = bixy.a(this.jdField_a_of_type_AndroidWidgetEditText.getText().toString(), 1);
    String str = bixy.a(String.valueOf(a()));
    if (TextUtils.isEmpty(str))
    {
      QQToast.a(getActivity(), 2131693359, 0).a();
      return;
    }
    combineUploadData(this.jdField_a_of_type_Biyg, b(), i, str, "hongbao.wrap.go");
    Object localObject2 = this.c.getText().toString();
    Object localObject1 = localObject2;
    if (TextUtils.isEmpty((CharSequence)localObject2))
    {
      if (TextUtils.isEmpty(this.c.getHint())) {
        localObject1 = getResources().getString(2131697273);
      }
    }
    else
    {
      ...
      if (!this.jdField_a_of_type_Aius.a()) {
        break label325;
      }
      ((Map)localObject2).put("skin_id", "" + aiup.c);
    }
    for (;;)
    {
      ...
      break;
      label325:
      ((Map)localObject2).put("skin_id", "" + this.jdField_a_of_type_Aius.a());
    }
  }
  
  protected float a()
  {
    float f2 = bixy.a(this.b.getText().toString());
    float f1 = f2;
    if (bixy.a(this.jdField_a_of_type_Biyg.bus_type, 1) == 1) {
      f1 = f2 * bixy.a(this.jdField_a_of_type_AndroidWidgetEditText.getText().toString(), 0);
    }
    return f1;
  }
  ...
  public void a()
  {
    ...
    label162:
    for (int i = this.bundle.getInt("skin_id", -1);; i = bixy.a(localObject, -1))
    {
      QLog.i("UsualHbFragment", 2, "init data skin id: " + i);
      localObject = this.jdField_a_of_type_Aius;
      LinearLayout localLinearLayout = (LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131367433);
      this.jdField_a_of_type_AndroidWidgetLinearLayout = localLinearLayout;
      ((aius)localObject).a(localLinearLayout);
      ((ViewGroup)this.jdField_a_of_type_AndroidWidgetLinearLayout.getParent()).setVisibility(0);
      if (-1 != i) {
        this.jdField_a_of_type_Aius.a(i);
      }
      this.jdField_a_of_type_Aius.a(new aiug(this));
      this.jdField_a_of_type_Aius.a(this.bundle);
      return;
    }
  }
  ...
  public void a(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_Aius = this.mActivity.a();
    ...
    paramBundle = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378777);
    if (String.valueOf(2).equals(this.jdField_a_of_type_Biyg.bus_type))
    {
      paramBundle.setText(2131697230);
      return;
    }
    paramBundle.setText(2131697231);
  }
  
  public int b()
  {
    if ((jdField_a_of_type_JavaUtilList.contains(Integer.valueOf(this.channel))) && (this.jdField_a_of_type_Aius.a() == -2)) {
      return 8;
    }
    return this.channel;
  }
  ...
  public void onClick(View paramView)
  {
    ...
    openUrl(alqr.a(3, (QQAppInterface)this.mActivity.getAppRuntime()));
  }
  ...
  public void onDestroyView()
  {
    super.onDestroyView();
    if (jdField_a_of_type_JavaUtilList.contains(Integer.valueOf(this.channel))) {
      this.jdField_a_of_type_Aius.a(this.jdField_a_of_type_AndroidWidgetLinearLayout);
    }
  }
