...
public class ThemeHbFragment
  ...
  implements ajyo, View.OnClickListener, Animation.AnimationListener, RollNumberView.OnRollListener
{
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private ajue jdField_a_of_type_Ajue;
  private ajzn jdField_a_of_type_Ajzn = new ajzn(this);
    ...
    if (paramDouble >= 0.0D) {
      try
      {
        if ((64 == this.channel) && (!TextUtils.isEmpty(this.f)))
        {
          ...
          String str = bkvx.a(this.jdField_d_of_type_JavaLangString, this.f);
          this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_c_of_type_JavaLangString);
          this.jdField_a_of_type_AndroidWidgetButton.setText(String.format(getString(2131696237), new Object[] { this.f, str }));
  ...
  private void a(Bundle paramBundle)
  {
    ...
    try
    {
      ...
      {
        this.jdField_c_of_type_AndroidWidgetTextView.setText(String.format(getString(2131696236), new Object[] { this.jdField_a_of_type_JavaLangString }));
  ...
  private boolean a(String paramString)
  {
    ...
    int i = (int)this.mActivity.getResources().getDimension(2131298012);
    this.jdField_a_of_type_Ajue = new ajue(this.mActivity, this.jdField_a_of_type_AndroidWidgetLinearLayout, i, true, new ajzm(this));
    this.jdField_a_of_type_Ajue.a(paramString, true);
    return true;
  }
  
  private void b()
  {
    this.jdField_a_of_type_Ajzn.postDelayed(new ThemeHbFragment.1(this), 10L);
  }
  ...
  private void b(Bundle paramBundle)
  {
    ...
    paramBundle = bfqm.a().a(this.mActivity);
    if (paramBundle == null) {}
    for (;;)
    {
      try
      {
        ...
        this.mActivity.d(amtj.a(2131713950));
        this.mActivity.finish();
        return;
      }
    ...
    {
      localObject = ajux.a().a(this.mQApp, (String)localObject);
  ...
  private void d()
  {
    ...
    ImageView localImageView = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131364626);
    if (localImageView != null)
    {
      if (akgc.a(this.mActivity))
      {
        i = 8;
    ...
    {
      localImageView = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131364624);
      if (localImageView != null) {
        if (!akgc.a(this.mActivity)) {
          break label321;
        }
    ...
    for (int i = j;; i = 8)
    {
      localImageView.setVisibility(i);
      localImageView.setOnClickListener(this);
      this.jdField_a_of_type_ComTencentMobileqqActivityQwalletWidgetRollNumberView = ((RollNumberView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378567));
      ...
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131367893));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131367903));
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131377102));
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131378569));
      this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131362692));
      this.jdField_d_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131367905);
      this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131373726);
      this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131378568);
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131367882));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131367884));
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131367746));
      return;
      i = 0;
      break;
    }
  ...
  private void f()
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = ajux.a().a(this.mQApp, this.jdField_b_of_type_JavaLangString);
    if (QLog.isColorLevel()) {
    ...
    ajux.a().a(this.mQApp, this.jdField_b_of_type_JavaLangString, new ajzk(this));
  }
  ...
  private void g()
  {
    ...
    {
      return;
      str = ajux.a().a(this.mQApp, this.jdField_b_of_type_JavaLangString);
      if (QLog.isColorLevel()) {
    ...
    ajux.a().a(this.mQApp, this.jdField_b_of_type_JavaLangString, ".zip", new ajzl(this));
  }
    ...
    for (Object localObject1 = localObject2;; str = "theme.pack.go") {
      try
      {
        ...
        if (TextUtils.isEmpty((CharSequence)localObject1)) {
          localObject2 = getResources().getString(2131696287);
        }
        localObject1 = this.mActivity.a();
        ((Map)localObject1).put("total_num", this.jdField_a_of_type_JavaLangString);
        ((Map)localObject1).put("total_amount", bkvx.a(this.jdField_d_of_type_JavaLangString));
        ((Map)localObject1).put("wishing", localObject2);
        ((Map)localObject1).put("resource_type", this.jdField_a_of_type_Akdf.jdField_b_of_type_Int + "");
        ((Map)localObject1).put("channel", this.channel + "");
        ((Map)localObject1).put("type", this.jdField_a_of_type_Akdf.jdField_a_of_type_Int + "");
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        try
        {
          ...
          this.jdField_d_of_type_JavaLangString = bkvx.a(this.jdField_a_of_type_JavaLangString, (String)localObject);
          this.jdField_c_of_type_JavaLangString = this.jdField_c_of_type_OrgJsonJSONArray.optString(i, getString(2131695795));
          j = i;
          if (a(new BigDecimal((String)localObject).doubleValue()) == 0)
          {
            ...
            this.jdField_a_of_type_AndroidWidgetButton.setText(getString(2131696252) + " " + this.jdField_d_of_type_JavaLangString + amtj.a(2131713951));
            j = i;
          }
  ...
  public void a(int paramInt)
  {
    ...
    this.jdField_a_of_type_Akdf = ((RedPacketManager)RedPacketManager.getInstance()).getThemeRedPkgConfById(paramInt);
    if (this.jdField_a_of_type_Akdf == null) {
      this.mActivity.d(getString(2131696371));
    }
    int i;
    label266:
    label337:
    ...
    do
    {
      ...
      {
        return;
        this.jdField_c_of_type_OrgJsonJSONArray = this.jdField_a_of_type_Akdf.jdField_a_of_type_OrgJsonJSONArray;
        this.jdField_b_of_type_OrgJsonJSONArray = this.jdField_a_of_type_Akdf.jdField_b_of_type_OrgJsonJSONArray;
        this.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_Akdf.jdField_b_of_type_JavaLangString;
        if (this.jdField_a_of_type_Boolean)
        {
          this.jdField_c_of_type_OrgJsonJSONArray = this.jdField_a_of_type_Akdf.jdField_c_of_type_OrgJsonJSONArray;
          this.jdField_b_of_type_OrgJsonJSONArray = this.jdField_a_of_type_Akdf.jdField_d_of_type_OrgJsonJSONArray;
          this.jdField_a_of_type_OrgJsonJSONArray = this.jdField_a_of_type_Akdf.e;
        ...
        if (1 != this.jdField_a_of_type_Akdf.jdField_b_of_type_Int) {
          break;
        }
        g();
        if (!this.jdField_a_of_type_Boolean) {
      ...
      Object localObject = getString(2131695795);
      if (i > paramInt) {
        while (paramInt < i)
        {
  ...
  {
    if ((this.jdField_a_of_type_Int >= 0) && (this.jdField_a_of_type_Ajzn != null))
    {
      Message localMessage = this.jdField_a_of_type_Ajzn.obtainMessage();
      localMessage.what = 100;
      this.jdField_a_of_type_Ajzn.sendMessage(localMessage);
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    if (this.jdField_a_of_type_Ajue != null) {
      this.jdField_a_of_type_Ajue.a();
    }
    if (this.channel == 16384) {}
