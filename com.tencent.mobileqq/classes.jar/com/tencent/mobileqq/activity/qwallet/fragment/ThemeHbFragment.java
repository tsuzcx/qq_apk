...
public class ThemeHbFragment
  ...
  implements alaw, View.OnClickListener, Animation.AnimationListener, RollNumberView.OnRollListener
{
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private akwn jdField_a_of_type_Akwn;
  private albu jdField_a_of_type_Albu = new albu(this);
    ...
    if (paramDouble >= 0.0D) {
      try
      {
        if ((64 == this.channel) && (!TextUtils.isEmpty(this.f)))
        {
          ...
          String str = bmrq.a(this.jdField_d_of_type_JavaLangString, this.f);
          this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_c_of_type_JavaLangString);
          this.jdField_a_of_type_AndroidWidgetButton.setText(String.format(getString(2131696097), new Object[] { this.f, str }));
  ...
  private void a(Bundle paramBundle)
  {
    ...
    try
    {
      ...
      {
        this.jdField_c_of_type_AndroidWidgetTextView.setText(String.format(getString(2131696096), new Object[] { this.jdField_a_of_type_JavaLangString }));
  ...
  private boolean a(String paramString)
  {
    ...
    int i = (int)this.mActivity.getResources().getDimension(2131297957);
    this.jdField_a_of_type_Akwn = new akwn(this.mActivity, this.jdField_a_of_type_AndroidWidgetLinearLayout, i, true, new albt(this));
    this.jdField_a_of_type_Akwn.a(paramString, true);
    return true;
  }
  
  private void b()
  {
    this.jdField_a_of_type_Albu.postDelayed(new ThemeHbFragment.1(this), 10L);
  }
  ...
  private void b(Bundle paramBundle)
  {
    ...
    paramBundle = bhhc.a().a(this.mActivity);
    if (paramBundle == null) {}
    for (;;)
    {
      try
      {
        ...
        this.mActivity.d(anzj.a(2131713718));
        this.mActivity.finish();
        return;
      }
    ...
    {
      localObject = akxg.a().a(this.mQApp, (String)localObject);
  ...
  private void d()
  {
    ...
    ImageView localImageView = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131364595);
    if (localImageView != null)
    {
      if (alik.a(this.mActivity))
      {
        i = 8;
    ...
    {
      localImageView = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131364593);
      if (localImageView != null) {
        if (!alik.a(this.mActivity)) {
          break label321;
        }
    ...
    for (int i = j;; i = 8)
    {
      localImageView.setVisibility(i);
      localImageView.setOnClickListener(this);
      this.jdField_a_of_type_ComTencentMobileqqActivityQwalletWidgetRollNumberView = ((RollNumberView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378803));
      ...
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131367861));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131367871));
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131377339));
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131378805));
      this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131362687));
      this.jdField_d_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131367873);
      this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131373804);
      this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131378804);
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131367850));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131367852));
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131367714));
      return;
      i = 0;
      break;
    }
  ...
  private void f()
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = akxg.a().a(this.mQApp, this.jdField_b_of_type_JavaLangString);
    if (QLog.isColorLevel()) {
    ...
    akxg.a().a(this.mQApp, this.jdField_b_of_type_JavaLangString, new albr(this));
  }
  ...
  private void g()
  {
    ...
    {
      return;
      str = akxg.a().a(this.mQApp, this.jdField_b_of_type_JavaLangString);
      if (QLog.isColorLevel()) {
    ...
    akxg.a().a(this.mQApp, this.jdField_b_of_type_JavaLangString, ".zip", new albs(this));
  }
    ...
    for (Object localObject1 = localObject2;; str = "theme.pack.go") {
      try
      {
        ...
        if (TextUtils.isEmpty((CharSequence)localObject1)) {
          localObject2 = getResources().getString(2131696147);
        }
        localObject1 = this.mActivity.a();
        ((Map)localObject1).put("total_num", this.jdField_a_of_type_JavaLangString);
        ((Map)localObject1).put("total_amount", bmrq.a(this.jdField_d_of_type_JavaLangString));
        ((Map)localObject1).put("wishing", localObject2);
        ((Map)localObject1).put("resource_type", this.jdField_a_of_type_Alfm.jdField_b_of_type_Int + "");
        ((Map)localObject1).put("channel", this.channel + "");
        ((Map)localObject1).put("type", this.jdField_a_of_type_Alfm.jdField_a_of_type_Int + "");
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        try
        {
          ...
          this.jdField_d_of_type_JavaLangString = bmrq.a(this.jdField_a_of_type_JavaLangString, (String)localObject);
          this.jdField_c_of_type_JavaLangString = this.jdField_c_of_type_OrgJsonJSONArray.optString(i, getString(2131695655));
          j = i;
          if (a(new BigDecimal((String)localObject).doubleValue()) == 0)
          {
            ...
            this.jdField_a_of_type_AndroidWidgetButton.setText(getString(2131696112) + " " + this.jdField_d_of_type_JavaLangString + anzj.a(2131713719));
            j = i;
          }
  ...
  public void a(int paramInt)
  {
    ...
    this.jdField_a_of_type_Alfm = ((RedPacketManager)RedPacketManager.getInstance()).getThemeRedPkgConfById(paramInt);
    if (this.jdField_a_of_type_Alfm == null) {
      this.mActivity.d(getString(2131696231));
    }
    int i;
    label266:
    label337:
    ...
    do
    {
      ...
      {
        return;
        this.jdField_c_of_type_OrgJsonJSONArray = this.jdField_a_of_type_Alfm.jdField_a_of_type_OrgJsonJSONArray;
        this.jdField_b_of_type_OrgJsonJSONArray = this.jdField_a_of_type_Alfm.jdField_b_of_type_OrgJsonJSONArray;
        this.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_Alfm.jdField_b_of_type_JavaLangString;
        if (this.jdField_a_of_type_Boolean)
        {
          this.jdField_c_of_type_OrgJsonJSONArray = this.jdField_a_of_type_Alfm.jdField_c_of_type_OrgJsonJSONArray;
          this.jdField_b_of_type_OrgJsonJSONArray = this.jdField_a_of_type_Alfm.jdField_d_of_type_OrgJsonJSONArray;
          this.jdField_a_of_type_OrgJsonJSONArray = this.jdField_a_of_type_Alfm.e;
        ...
        if (1 != this.jdField_a_of_type_Alfm.jdField_b_of_type_Int) {
          break;
        }
        g();
        if (!this.jdField_a_of_type_Boolean) {
      ...
      Object localObject = getString(2131695655);
      if (i > paramInt) {
        while (paramInt < i)
        {
  ...
  {
    if ((this.jdField_a_of_type_Int >= 0) && (this.jdField_a_of_type_Albu != null))
    {
      Message localMessage = this.jdField_a_of_type_Albu.obtainMessage();
      localMessage.what = 100;
      this.jdField_a_of_type_Albu.sendMessage(localMessage);
    }
  }
