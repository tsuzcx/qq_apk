  ...
  implements View.OnClickListener
{
  ...
  public void init(QQAppInterface paramQQAppInterface, Context paramContext, BaseChatPie paramBaseChatPie)
  {
    ...
    this.mImgPanelBackGround = ((ImageView)findViewById(2131367990));
    this.mHbRecyclerView = ((RecyclerView)findViewById(2131367996));
    this.mHbRecyclerView.setHasFixedSize(true);
    this.layoutBottom = ((RelativeLayout)findViewById(2131364942));
    this.bottomTabLayout = ((LinearLayout)findViewById(2131367991));
    this.mImgActionFire = ((ImageView)findViewById(2131367993));
    this.layoutAction = ((RelativeLayout)findViewById(2131367992));
    this.layoutAction.setVisibility(8);
    this.mActionRedDot = ((ImageView)findViewById(2131367995));
    this.mActionRedDot.setVisibility(8);
    this.layoutAction.setOnClickListener(this);
    this.mActionTxtView = ((TextView)findViewById(2131367994));
