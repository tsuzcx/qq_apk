  ...
  implements View.OnClickListener
{
  ...
  public void init(QQAppInterface paramQQAppInterface, Context paramContext, BaseChatPie paramBaseChatPie)
  {
    ...
    this.mImgPanelBackGround = ((ImageView)findViewById(2131368006));
    this.mHbRecyclerView = ((RecyclerView)findViewById(2131368012));
    this.mHbRecyclerView.setHasFixedSize(true);
    this.layoutBottom = ((RelativeLayout)findViewById(2131364969));
    this.bottomTabLayout = ((LinearLayout)findViewById(2131368007));
    this.mImgActionFire = ((ImageView)findViewById(2131368009));
    this.layoutAction = ((RelativeLayout)findViewById(2131368008));
    this.layoutAction.setVisibility(8);
    this.mActionRedDot = ((ImageView)findViewById(2131368011));
    this.mActionRedDot.setVisibility(8);
    this.layoutAction.setOnClickListener(this);
    this.mActionTxtView = ((TextView)findViewById(2131368010));
