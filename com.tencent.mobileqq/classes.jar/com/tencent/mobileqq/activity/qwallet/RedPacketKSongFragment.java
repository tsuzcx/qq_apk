  ...
  implements aliw, aljj
{
  ...
  public aljb a;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new akyr(this);
  public MediaPlayer a;
  private Handler jdField_a_of_type_AndroidOsHandler;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new akyi(this);
  ...
  public KSongView a;
  public boolean a;
  private View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new akyl(this);
  public View b;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = anzj.a(2131712173);
    jdField_b_of_type_JavaLangString = anzj.a(2131712195);
    jdField_a_of_type_ArrayOfJavaLangString = new String[] { anzj.a(2131712190), anzj.a(2131712182), anzj.a(2131712200) };
  }
  ...
  private void c(String paramString)
  {
    ...
    if (localObject != null)
    {
      ...
      aljb.a(a(), this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg);
    ...
    {
      localakwu.a(localSessionInfo, localakwt, l, 131072, (String)localObject, this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg.mQQWalletRedPacketMsg.elem.skinId, this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg.fromHBList, localBundle);
      if (QLog.isColorLevel()) {
        QLog.d("PasswdRedBagManager", 2, "click open passwdredbag, isPasswdRedBagOpen=" + localakwt.jdField_a_of_type_Boolean + ",isPasswdRedBagFinish=" + localakwt.jdField_b_of_type_Boolean + ",isPasswdRedBagOverDue=" + localakwt.jdField_c_of_type_Boolean + "|scoreSwitch:" + i + "|scoreId" + paramString);
      }
      return;
      i = 1;
      break;
  ...
  private void q()
  {
    ...
    Object localObject = ((alao)getActivity().app.getManager(245)).a("redPackPanel", "", new String[] { "panelRedPkgList" });
    for (;;)
    {
      try
      {
      ...
      ((PreloadManager)getActivity().app.getManager(151)).c(this.jdField_c_of_type_JavaLangString, new akys(this));
      return;
      i += 1;
    }
  }
  ...
  public void a()
  {
    ...
    try
    {
      if (!this.jdField_b_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(getResources().getDrawable(2130847316));
      ...
      if (this.f) {
        if (this.jdField_c_of_type_Boolean)
        {
          ...
          this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(getResources().getDrawable(2130847314));
  ...
  {
    super.a(paramView);
    ((ViewStub)paramView.findViewById(2131378129)).inflate();
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131378922));
    this.jdField_a_of_type_ComTencentMobileqqActivityQwalletVoiceKSongMicView = ((KSongMicView)paramView.findViewById(2131376369));
    this.jdField_a_of_type_ComTencentMobileqqWidgetAnimationView = ((AnimationView)paramView.findViewById(2131369591));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370329));
    this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131370447);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131372758));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131372779));
    this.jdField_a_of_type_ComTencentMobileqqWidgetKsongKSongView = ((KSongView)paramView.findViewById(2131369593));
    this.jdField_a_of_type_ComTencentMobileqqWidgetKsongKSongProsBar = ((KSongProsBar)paramView.findViewById(2131369592));
    this.jdField_a_of_type_ComTencentMobileqqActivityQwalletVoiceKSongVolumeView = ((KSongVolumeView)paramView.findViewById(2131368628));
    this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131376600);
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131369590));
  ...
  public void a(String paramString, bjeu parambjeu, boolean paramBoolean)
  {
    if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      this.f = false;
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnPreparedListener(new akyo(this, paramBoolean));
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnCompletionListener(new akyp(this));
      this.jdField_a_of_type_ComTencentMobileqqWidgetKsongKSongView.setKListener(new akyq(this, parambjeu));
      return;
    }
  ...
  protected boolean a()
  {
    ...
    this.jdField_e_of_type_AndroidViewView.setBackgroundDrawable(getResources().getDrawable(2130847289));
    this.jdField_b_of_type_AndroidViewView.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
    this.jdField_b_of_type_AndroidViewView.setOnTouchListener(alil.a(0.7F));
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this.jdField_b_of_type_AndroidViewView$OnClickListener);
    Object localObject = bhlg.b(getActivity().app, this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg.senderuin, true);
    localObject = alil.a(getActivity(), (String)localObject, 135.0F, this.jdField_d_of_type_AndroidWidgetTextView.getPaint());
    ...
    bhga.b(this.jdField_a_of_type_ComTencentMobileqqWidgetKsongKSongView, false);
    p();
    this.jdField_a_of_type_ComTencentMobileqqActivityAioMediaPlayerManager = MediaPlayerManager.a(getActivity().app);
    bdll.b(getActivity().app, "P_CliOper", "Vip_pay_mywallet", "", "210", "ksong.sing.show", 0, 0, "", "", "", "");
    return true;
  }
  ...
  public void c()
  {
    a(this.jdField_a_of_type_Akyt.jdField_b_of_type_JavaLangString, new akym(this), false);
  }
  ...
  public void d()
  {
    bdll.b(getActivity().app, "P_CliOper", "Vip_pay_mywallet", "", "210", "ksong.sing.play", 0, 0, "", "", "", "");
    this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(getResources().getDrawable(2130847316));
    a(this.jdField_a_of_type_Akyt.jdField_a_of_type_JavaLangString, new akyn(this), true);
  }
  
  public void e()
  {
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(anzj.a(2131712205));
  ...
  public void f()
  {
    ...
    ((PreloadManager)getActivity().app.getManager(151)).c(this.jdField_d_of_type_JavaLangString, new akyj(this));
  }
  ...
  public void m()
  {
    ...
    {
      this.jdField_a_of_type_Aljb.b(this.jdField_a_of_type_Akyt.jdField_b_of_type_JavaLangString);
      this.jdField_a_of_type_Aljb.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg, "", false);
      this.jdField_d_of_type_Boolean = true;
    }
    bdll.b(getActivity().app, "P_CliOper", "Vip_pay_mywallet", "", "210", "ksong.sing.start", 0, 0, "", "", "", "");
  }
  ...
  {
    bdll.b(getActivity().app, "P_CliOper", "Vip_pay_mywallet", "", "210", "ksong.sing.close", 0, 0, "", "", "", "");
