...
import com.tencent.mobileqq.ark.API.ArkAppNotifyCenter.GdtNotify;
...
public class ArkPubicEventWrap$QWalletArkNotify
  extends ArkAppNotifyCenter.GdtNotify
  implements ArkAppNotifyCenter.INotifyReg
{
  public ArkPubicEventWrap$QWalletArkNotify(ArkPubicEventWrap paramArkPubicEventWrap) {}
  ...
  public boolean notify(String paramString1, String paramString2, String paramString3)
  {
    ...
    if ("ad_query_mute".equals(paramString2)) {
      ArkPubicEventWrap.a(this.a, paramString1);
    }
    do
    {
      do
      ...
      for (;;)
      {
        try
        {
          ...
          paramString2 = PackageUtil.a(BaseApplicationImpl.getContext(), paramString2);
    ...
    ArkPubicEventWrap.a(this.a);
    this.a.notifyObservers(new ArkPubicEventWrap.ArkEvent(this.a, paramString1, paramString2, paramString3));
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.qwallet.utils.ArkPubicEventWrap.QWalletArkNotify
