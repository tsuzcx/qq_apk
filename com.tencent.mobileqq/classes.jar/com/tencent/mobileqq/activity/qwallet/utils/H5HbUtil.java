...
public class H5HbUtil
{
  ...
  public static JSONObject a(AppInterface paramAppInterface, JSONObject paramJSONObject)
  {
    ...
    if ((!StringUtil.a(str1)) && (str1.equals(paramAppInterface.getCurrentAccountUin())) && (!StringUtil.a(str4)))
    {
      ...
      TenCookie localTenCookie = TenCookie.a();
      paramJSONObject = localTenCookie.b(str4);
      ...
      if (StringUtil.a(paramJSONObject))
      {
        ...
        paramAppInterface = localTenCookie.a(str1, str4, SharedPreferencesProxyManager.getInstance().getProxy("qb_tenpay_h5_common_hb_" + str1, 4));
      }
      if (QLog.isColorLevel()) {
  ...
  private static JSONObject a(JSONObject paramJSONObject)
  {
    ...
    if (paramJSONObject != null)
    {
      ...
      if (!StringUtil.a(str)) {
        localJSONObject.put("lucky_name", ComIPCUtils.a(str));
      }
  ...
  public static void a(AppInterface paramAppInterface, JSONObject paramJSONObject, String paramString, ResultReceiver paramResultReceiver)
  {
    ...
    if ((!TextUtils.isEmpty(str1)) && (str1.equals(paramAppInterface.getCurrentAccountUin())) && (!TextUtils.isEmpty((CharSequence)localObject)))
    {
      ...
      localObject = TenCookie.a().b((String)localObject);
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.qwallet.utils.H5HbUtil
