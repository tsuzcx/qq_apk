  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      localObject = (ahcy)((QQAppInterface)localObject).getManager(273);
      ahda localahda = ((ahcy)localObject).a("2001");
      if ((localahda.a) && (ahiy.a(localahda.b, this.jdField_a_of_type_Int)))
      {
        ((ahcy)localObject).b("2001");
