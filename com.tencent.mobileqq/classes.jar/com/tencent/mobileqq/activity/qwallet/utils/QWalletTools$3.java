  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      localObject = (agqj)((QQAppInterface)localObject).getManager(273);
      agql localagql = ((agqj)localObject).a("2001");
      if ((localagql.a) && (agwj.a(localagql.b, this.jdField_a_of_type_Int)))
      {
        ((agqj)localObject).b("2001");
