  ...
  implements Runnable
{
  public void run()
  {
    try
    {
      String str = "networkType=" + HttpUtil.getNetWorkType() + "&stackType=" + NetConnInfoCenter.getActiveNetIpFamily(true) + "&carrierType=" + DeviceInfoUtil.a(QWalletHelperImpl.getIMSI());
