...
public class FlymeOSStatusBarFontUtils
{
  ...
  private static boolean a(WindowManager.LayoutParams paramLayoutParams, java.lang.String paramString, boolean paramBoolean)
  {
    ...
    //   4: aload_1
    //   5: invokevirtual 151	java/lang/Class:getDeclaredField	(Ljava/lang/String;)Ljava/lang/reflect/Field;
    //   8: astore_1
    //   9: aload_1
    //   10: iconst_1
    //   11: invokevirtual 155	java/lang/reflect/Field:setAccessible	(Z)V
    //   14: aload_1
    //   15: aload_0
    //   16: invokevirtual 62	java/lang/reflect/Field:getInt	(Ljava/lang/Object;)I
    //   19: istore_3
    //   20: aload_0
    //   21: invokevirtual 148	java/lang/Object:getClass	()Ljava/lang/Class;
    //   24: ldc 157
    //   26: invokevirtual 151	java/lang/Class:getDeclaredField	(Ljava/lang/String;)Ljava/lang/reflect/Field;
    //   29: astore_1
    //   30: aload_1
    //   31: iconst_1
    //   32: invokevirtual 155	java/lang/reflect/Field:setAccessible	(Z)V
    //   35: aload_1
    //   36: aload_0
    //   37: invokevirtual 62	java/lang/reflect/Field:getInt	(Ljava/lang/Object;)I
    //   40: istore 4
    //   42: iload_2
    //   43: ifeq +22 -> 65
    //   46: iload_3
    ...
    //   58: aload_0
    //   59: iload_3
    //   60: invokevirtual 161	java/lang/reflect/Field:setInt	(Ljava/lang/Object;I)V
    //   63: iconst_1
    //   64: ireturn
    //   65: iload_3
    //   66: iconst_m1
    ...
    //   90: astore_0
    //   91: aload_0
    //   92: invokevirtual 162	java/lang/IllegalArgumentException:printStackTrace	()V
    //   95: goto -15 -> 80
    //   98: astore_0
    //   99: aload_0
    //   100: invokevirtual 163	java/lang/Throwable:printStackTrace	()V
    //   103: goto -23 -> 80
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.qwallet.utils.FlymeOSStatusBarFontUtils
