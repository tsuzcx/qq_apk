...
public class QWalletConfigManager
  implements IQWalletConfigService, Manager
{
  ...
  private void a(long paramLong, QWalletConfigManager.ConfigListener paramConfigListener, String paramString, Map<String, String> paramMap)
  {
    if (a())
    {
    ...
    {
      ReqWalletConfig localReqWalletConfig = ReqWalletConfig.createReq(paramLong, l2, l1, paramString, paramMap, "Android|" + DeviceInfoUtil.e() + "|" + DeviceInfoUtil.i(), DeviceInfoUtil.c(), NetworkUtil.a(BaseApplicationImpl.getContext()));
      if (QLog.isColorLevel()) {
        QLog.d("QWalletConfigManager", 2, "realGetConfig:" + paramLong + "|" + paramConfigListener + "|" + paramString + "|" + paramMap + "|" + localReqWalletConfig);
      }
      QWalletCommonServlet.a(localReqWalletConfig, new QWalletConfigManager.2(this, paramLong, paramConfigListener, new WeakReference(this)), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      return;
      l1 = 0L;
      break;
    }
  ...
  public static void a(String paramString, IQWalletConfigService.ConfigUpdateListener paramConfigUpdateListener)
  {
    ...
    {
      ((QWalletConfigManager)localAppRuntime.getManager(QQManagerFactory.QWALLET_CONFIG_MANAGER)).c(paramString, paramConfigUpdateListener);
      return;
    }
    ComIPCUtils.a(paramString, paramConfigUpdateListener);
  }
  ...
  public static void b(String paramString, IQWalletConfigService.ConfigUpdateListener paramConfigUpdateListener)
  {
    ...
    if ((localAppRuntime instanceof QQAppInterface))
    {
      ((QWalletConfigManager)localAppRuntime.getManager(QQManagerFactory.QWALLET_CONFIG_MANAGER)).d(paramString, paramConfigUpdateListener);
      return;
    }
    ComIPCUtils.b(paramString, paramConfigUpdateListener);
  }
  ...
  public IQWalletConfigApi.ConfigInfo a(String paramString)
  {
  ...
  public void a(Map<String, String> paramMap)
  {
    ...
    {
      return;
      String str1 = "Android|" + DeviceInfoUtil.e() + "|" + DeviceInfoUtil.i();
      String str2 = DeviceInfoUtil.c();
      int i = NetworkUtil.a(BaseApplicationImpl.getContext());
      paramMap = ReqWalletConfig.createReq(0L, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getLongAccountUin(), this.jdField_a_of_type_ComTencentMobileqqActivityQwalletConfigQWalletConfig.seriesNo, null, paramMap, str1, str2, i);
      QWalletCommonServlet.a(paramMap, 1, new QWalletConfigManager.3(this));
    } while (!QLog.isColorLevel());
  ...
  public void b(int paramInt)
  {
    ...
    try
    {
      String str = ((QWalletRedManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.QWALLET_RED_MANAGER)).a();
  ...
  public void c(String paramString, IQWalletConfigService.ConfigUpdateListener paramConfigUpdateListener)
  {
  ...
  public void d(String paramString, IQWalletConfigService.ConfigUpdateListener paramConfigUpdateListener)
  {
