  ...
  implements Serializable
{
  ...
  private transient Map<String, List<agmu>> jdField_a_of_type_JavaUtilMap;
  ...
  private void b(Map<String, String> paramMap, boolean paramBoolean, long paramLong)
  {
    ...
    if (paramMap != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        agmp.a(this.jdField_b_of_type_JavaLangString, (String)localEntry.getKey(), (String)localEntry.getValue());
      }
      if (!paramBoolean) {
        break label89;
      }
  ...
  public static QWalletConfig readConfig(QQAppInterface paramQQAppInterface)
  {
    ...
    //   29: monitorenter
    //   30: aload 4
    //   32: invokestatic 271	agwj:a	(Ljava/lang/String;)Ljava/lang/Object;
  ...
  public void addUpdateListener(String paramString, agmu paramagmu)
  {
    synchronized (this.jdField_a_of_type_ArrayOfByte)
    {
      if ((!TextUtils.isEmpty(paramString)) && (paramagmu != null))
      {
        ...
        if (!((List)localObject).contains(paramagmu)) {
          ((List)localObject).add(paramagmu);
        }
      }
      return;
    }
  ...
  public agmo getConfigInfo(String paramString)
  {
    agmo localagmo = new agmo();
    localagmo.jdField_a_of_type_JavaLangString = paramString;
    for (;;)
    {
      synchronized (this.jdField_b_of_type_ArrayOfByte)
      {
        localagmo.jdField_b_of_type_JavaLangString = getConfig(paramString);
        paramString = (Long)this.localVersions.get(paramString);
        if (paramString != null)
        {
          l = paramString.longValue();
          localagmo.jdField_a_of_type_Long = l;
          return localagmo;
        }
      }
      long l = 0L;
  ...
  public void handleRsp(RspWalletConfig paramRspWalletConfig, long paramLong, agmt paramagmt, agmq paramagmq)
  {
    ...
    for (;;)
    {
      ...
      for (i = 1;; i = 0)
      {
        ...
        this.commonMsg = paramRspWalletConfig.commonMsg;
        a(paramRspWalletConfig.mConfig, false, l);
        if ((paramagmq == null) || (i != 0) || (this.jdField_a_of_type_Int >= 100)) {
          break;
        }
        paramagmq.a();
  ...
  public void notifyListener(agmt paramagmt)
  {
    if (paramagmt != null) {}
    synchronized (this.jdField_b_of_type_ArrayOfByte)
    {
      HashMap localHashMap = new HashMap(this.configs);
      paramagmt.a(this.jdField_b_of_type_JavaLangString, localHashMap);
      return;
    }
  }
  ...
  public void notifyUpdateListeners(Map<String, String> paramMap, long paramLong)
  {
    synchronized (this.jdField_a_of_type_ArrayOfByte)
    {
      ...
      do
      {
        ...
        {
          agmu localagmu = (agmu)((Iterator)localObject2).next();
          try
          {
            localagmu.a(str, (String)localObject1, new agmo(str, (String)localObject1, paramLong));
          }
          catch (Throwable localThrowable) {}
        }
      } while (!QLog.isColorLevel());
  ...
  public void removeUpdateListener(String paramString, agmu paramagmu)
  {
    synchronized (this.jdField_a_of_type_ArrayOfByte)
    {
      if ((!TextUtils.isEmpty(paramString)) && (paramagmu != null))
