  ...
  implements abjv, View.OnClickListener
{
  ...
  private void initParams()
  {
    ...
    initThumb();
    agwj.a(this.reCaptureBtn, 0.3F);
    agwj.a(this.sendBtn, 0.3F);
    azve.a(this.reCaptureBtn, ajjy.a(2131638233));
    azve.a(this.sendBtn, ajjy.a(2131638236));
    this.reCaptureBtn.setOnClickListener(this);
    this.sendBtn.setOnClickListener(this);
    this.tips.setText(ajjy.a(2131638235));
    ...
    int i = azvv.a(getActivity(), 75.0F);
    int j = azvv.a(getActivity(), 75.0F);
    this.viewOpenAnim.setPivotX(i / 2);
    this.viewOpenAnim.setPivotY(j / 2 + azvv.a(getActivity(), 15.0F));
  ...
  private void initUI()
  {
    this.previewImg = ((ImageView)getActivity().findViewById(2131302380));
    this.reCaptureBtn = ((Button)getActivity().findViewById(2131298072));
    this.sendBtn = getActivity().findViewById(2131298032);
    this.viewOpenAnim = getActivity().findViewById(2131302371);
    this.tips = ((TextView)getActivity().findViewById(2131312678));
    this.numberProbar = ((NumberProgressBar)getActivity().findViewById(2131306256));
    this.imgLottie = ((ImageView)getActivity().findViewById(2131302366));
  }
  ...
  public static void start(Activity paramActivity, int paramInt1, int paramInt2, CameraCaptureView.VideoCaptureResult paramVideoCaptureResult, LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    abju.a(paramActivity, localIntent, PublicFragmentActivityForPeak.class, EmojiRedPackPreviewFragment.class, paramInt1);
  }
  ...
  public void onClick(View paramView)
  {
    ...
    getActivity().finish();
    awqx.b(null, "P_CliOper", "Vip_pay_mywallet", "", "211", "phiz.video.finish", 0, 0, "", "", "", "");
  }
  
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    return paramLayoutInflater.inflate(2131495995, paramViewGroup, false);
  }
