  ...
  implements Runnable
{
  ...
  public boolean convertVideoToGif(EmojiGifHelper.ConvertParam paramConvertParam, String paramString)
  {
    ...
    try
    {
      int i = GifProcessor.convertVideoToGifForLocal(paramConvertParam.inPath, paramConvertParam.videoWidth, paramConvertParam.videoHeight, paramConvertParam.videoDuration, paramString, 7, 30, 100);
