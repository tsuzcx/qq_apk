...
public class FaceDetector
{
  ...
  public List<QWalletFaceTracker.ExpressionInfo> parseExpressionConfigFromJson(Context paramContext, String paramString1, String paramString2)
  {
    try
    {
      paramContext = agwj.b(paramString1);
      ...
      catch (JSONException paramContext)
      {
        try
        {
          ...
          for (;;)
          {
            ...
            locallje = new lje();
            paramString1.expressionItem = locallje;
            ...
            locallje.expressionID = ((JSONObject)localObject).optString("expressionID");
            localJSONArray = ((JSONObject)localObject).optJSONArray("expressionFeat");
            if (localJSONArray == null) {
              break;
            }
            locallje.expressionFeat = new ArrayList();
            j = 0;
            while (j < localJSONArray.length() / 2)
            {
              locallje.expressionFeat.add(new PointF(localJSONArray.optInt(j * 2), localJSONArray.optInt(j * 2 + 1)));
              j += 1;
            }
          ...
          if ((localJSONArray != null) && (localJSONArray.length() == 3)) {
            locallje.expressionAngle = convertJsonAngle2NormalAngle(new float[] { (float)localJSONArray.optDouble(0), (float)localJSONArray.optDouble(1), (float)localJSONArray.optDouble(2) });
          }
          localJSONArray = ((JSONObject)localObject).optJSONArray("expressionWeight");
          if ((localJSONArray != null) && (localJSONArray.length() == 7))
          {
            locallje.expressionWeight = new double[7];
            j = 0;
          }
          while (j < 7)
          {
            locallje.expressionWeight[j] = localJSONArray.optDouble(j);
            j += 1;
            continue;
            locallje.expressionWeight = WEIGHT;
          }
          ...
          {
            locallje.a = new int[3];
            locallje.a[0] = ((JSONArray)localObject).optInt(0);
            locallje.a[1] = ((JSONArray)localObject).optInt(1);
            locallje.a[2] = ((JSONArray)localObject).optInt(2);
          }
