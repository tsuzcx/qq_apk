...
public class TroopUnAccalimedRedPacketList$HbListAdapter
  extends RecyclerView.Adapter<TroopUnAccalimedRedPacketList.HbListAdapter.HbItemViewHolder>
{
  ...
  public TroopUnAccalimedRedPacketList.HbListAdapter.HbItemViewHolder a(ViewGroup paramViewGroup, int paramInt)
  {
    return new TroopUnAccalimedRedPacketList.HbListAdapter.HbItemViewHolder(this, new TroopUnAccalimedRedPacketList.HbListItem(this.jdField_a_of_type_ComTencentMobileqqActivityQwalletTroopUnAccalimedRedPacketList, this.jdField_a_of_type_AndroidContentContext, new QQWalletTroopHbItem(TroopUnAccalimedRedPacketList.a(this.jdField_a_of_type_ComTencentMobileqqActivityQwalletTroopUnAccalimedRedPacketList), this.jdField_a_of_type_AndroidContentContext, TroopUnAccalimedRedPacketList.a(this.jdField_a_of_type_ComTencentMobileqqActivityQwalletTroopUnAccalimedRedPacketList), TroopUnAccalimedRedPacketList.a(this.jdField_a_of_type_ComTencentMobileqqActivityQwalletTroopUnAccalimedRedPacketList), TroopUnAccalimedRedPacketList.a(this.jdField_a_of_type_ComTencentMobileqqActivityQwalletTroopUnAccalimedRedPacketList))));
  }
  
  public void a(TroopUnAccalimedRedPacketList.HbListAdapter.HbItemViewHolder paramHbItemViewHolder, int paramInt)
  {
    ...
    for (;;)
    {
      EventCollector.getInstance().onRecyclerBindViewHolder(paramHbItemViewHolder, paramInt, getItemId(paramInt));
      return;
      TroopUnAccalimedRedPacketList.HbListItem localHbListItem = paramHbItemViewHolder.a;
