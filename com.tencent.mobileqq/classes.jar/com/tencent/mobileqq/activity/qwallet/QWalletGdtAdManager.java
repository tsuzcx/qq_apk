...
public class QWalletGdtAdManager
  implements Manager
{
  ...
  private GdtAdLoader.Listener jdField_a_of_type_ComTencentGdtadAditemGdtAdLoader$Listener;
  private GdtAppReceiver jdField_a_of_type_ComTencentGdtadAditemGdtAppReceiver;
  private boolean jdField_a_of_type_Boolean;
  
  public QWalletGdtAdManager(QQAppInterface paramQQAppInterface) {}
  ...
  private QWalletPubAdReport.TerminalInfor a(Context paramContext)
  {
    ...
    localTerminalInfor.qq_version.set("8.5.5");
    ...
    if (QWalletHelperImpl.isPhoneRooted()) {}
    for (int i = 1;; i = 0)
    {
      paramContext.set(i);
      try
      {
        ...
        {
          str = QQDeviceInfo.getMAC("5076bf");
          paramContext = str;
          if (TextUtils.isEmpty(str)) {
  ...
  private void a(Context paramContext, String paramString, int paramInt, GdtAdLoader.Listener paramListener)
  {
    GdtAdLoader.Session localSession = new GdtAdLoader.Session();
    localSession.jdField_a_of_type_TencentGdtQq_ad_get$QQAdGet = a(BaseApplicationImpl.getApplication().getRuntime().getLongAccountUin(), paramString, paramInt);
    new GdtAdLoader(localSession, new WeakReference(paramListener)).a(new WeakReference(paramContext));
    if (QLog.isColorLevel()) {
      QLog.i("QWalletGdtAdManager", 2, "doReqAds start");
    }
  }
  
  private void a(GdtAdLoader paramGdtAdLoader)
  {
    if (QLog.isColorLevel())
    {
    ...
    } while (paramGdtAdLoader.a().jdField_a_of_type_TencentGdtQq_ad_get$QQAdGetRsp.ret.get() == 0);
    QLog.i("QWalletGdtAdManager", 2, "reqAds onResponse ret fail,loader.getSession().response.ret.get " + paramGdtAdLoader.a().jdField_a_of_type_TencentGdtQq_ad_get$QQAdGetRsp.ret.get());
  }
  ...
  private void a(BaseActivity paramBaseActivity)
  {
    ...
    QwUtils.a(localQQAppInterface, "tenpay.com", new QWalletGdtAdManager.2(this, paramBaseActivity, localQQAppInterface, NetConnInfoCenter.getServerTimeMillis()));
  }
  ...
  public static void a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    ReportController.b(localQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", paramString1, 0, 0, paramString2, paramString3, paramString4, paramString5);
  }
  ...
  public static void a(im_msg_body.GeneralFlags paramGeneralFlags, MessageForStructing paramMessageForStructing)
  {
    ...
    Object localObject = StructMsgElementFactory.a(0);
    ((AbsStructMsgItem)localObject).a(new StructMsgItemHr());
    ((AbsStructMsgItem)localObject).a = paramMessageForStructing.structingMsg;
  ...
  {
    paramBaseChatPie = new QWalletGdtAdManager.1(this, NetConnInfoCenter.getServerTimeMillis(), paramBaseChatPie);
    this.jdField_a_of_type_ComTencentGdtadAditemGdtAdLoader$Listener = paramBaseChatPie;
  ...
  public void a(Context paramContext)
  {
    ...
    this.jdField_a_of_type_ComTencentGdtadAditemGdtAdLoader$Listener = null;
    paramContext = StructMsgItemLayout31.b.iterator();
  ...
  public void a(Context paramContext, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        QwUtils.a(localQQAppInterface, "tenpay.com", new QWalletGdtAdManager.3(this, paramInt, paramContext, localQQAppInterface, l));
        return;
      }
  ...
  public void a(BaseActivity paramBaseActivity, BaseChatPie paramBaseChatPie)
  {
    ...
    {
      localObject = (QWalletConfigManager)paramBaseActivity.app.getManager(QQManagerFactory.QWALLET_CONFIG_MANAGER);
      i1 = ((QWalletConfigManager)localObject).a("common", 1, new String[] { "pub_ad_control", "gdt_day_freq" });
      n = ((QWalletConfigManager)localObject).a("common", 4, new String[] { "pub_ad_control", "gdt_week_freq" });
    }
    int i2 = 0;
    int i5 = 0;
    int i4 = 0;
  ...
  public void a(List<ChatMessage> paramList)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("QWalletGdtAdManager", 2, "list,time:" + TimeFormatterUtils.b(localChatMessage.time * 1000L) + ",isShowQWalletPubAd:" + localChatMessage.isShowQWalletPubAd);
      }
      i -= 1;
      break label22;
      break;
  ...
  public boolean a()
  {
    ...
    if (((QWalletConfigManager)localQQAppInterface.getManager(QQManagerFactory.QWALLET_CONFIG_MANAGER)).a("common", 0, new String[] { "pub_ad_control", "gdt_switch" }) == 0) {}
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.qwallet.QWalletGdtAdManager
