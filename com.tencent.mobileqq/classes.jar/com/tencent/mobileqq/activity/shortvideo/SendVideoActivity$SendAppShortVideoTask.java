  ...
  extends AsyncTask<Void, Void, Integer>
{
  ...
  {
    DialogUtil.a(paramContext, 232, null, paramContext.getString(paramInt), new SendVideoActivity.SendAppShortVideoTask.1(paramContext), null).show();
  }
  ...
  protected int a()
  {
    ...
    //   3: istore_3
    //   4: aload_0
    //   5: getfield 53	com/tencent/mobileqq/activity/shortvideo/SendVideoActivity$SendAppShortVideoTask:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   8: iconst_1
    ...
    //   35: ldc 179
    //   37: invokestatic 185	com/tencent/mobileqq/shortvideo/ShortVideoUtils:getShortVideoThumbPicPath	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   40: astore 6
    //   42: new 106	java/lang/StringBuilder
    //   45: dup
    //   46: invokespecial 107	java/lang/StringBuilder:<init>	()V
    //   49: invokestatic 188	com/tencent/mobileqq/shortvideo/ShortVideoUtils:getShortVideoThumbPicDir	()Ljava/lang/String;
    ...
    //   63: invokestatic 195	com/tencent/mobileqq/utils/FileUtils:c	(Ljava/lang/String;)V
    //   66: new 197	java/io/File
    //   69: dup
    //   70: aload 6
    //   72: invokespecial 199	java/io/File:<init>	(Ljava/lang/String;)V
    //   75: astore 9
    //   77: new 197	java/io/File
    //   80: dup
    //   81: aload 9
    //   83: invokevirtual 202	java/io/File:getParent	()Ljava/lang/String;
    //   86: invokespecial 199	java/io/File:<init>	(Ljava/lang/String;)V
    //   89: astore 4
    //   91: aload 4
    //   93: invokevirtual 205	java/io/File:exists	()Z
    //   96: ifeq +11 -> 107
    //   99: aload 4
    //   101: invokevirtual 208	java/io/File:isDirectory	()Z
    //   104: ifne +9 -> 113
    //   107: aload 4
    //   109: invokevirtual 211	java/io/File:mkdirs	()Z
    //   112: pop
    //   113: aload 9
    //   115: invokevirtual 205	java/io/File:exists	()Z
    //   118: ifeq +11 -> 129
    //   121: aload 9
    //   123: invokevirtual 214	java/io/File:isFile	()Z
    //   126: ifne +9 -> 135
    //   129: aload 9
    //   131: invokevirtual 217	java/io/File:createNewFile	()Z
    //   134: pop
    //   135: new 219	java/io/BufferedOutputStream
    //   138: dup
    //   139: new 221	java/io/FileOutputStream
    //   142: dup
    //   143: aload 9
    //   145: invokespecial 224	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   148: invokespecial 227	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   151: astore 5
    //   153: aload 8
    //   155: ifnull +214 -> 369
    //   158: aload 5
    //   160: astore 4
    //   162: aload 8
    //   164: getstatic 233	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   167: bipush 80
    //   169: aload 5
    //   171: invokevirtual 239	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   174: pop
    //   175: aload 5
    //   177: astore 4
    //   179: aload 5
    //   181: invokevirtual 242	java/io/BufferedOutputStream:flush	()V
    //   184: iload_2
    //   185: istore_1
    //   186: aload 5
    //   188: ifnull +10 -> 198
    //   191: aload 5
    //   193: invokevirtual 245	java/io/BufferedOutputStream:close	()V
    //   196: iload_2
    //   197: istore_1
    //   198: aload 9
    //   200: invokevirtual 205	java/io/File:exists	()Z
    //   203: ifeq +782 -> 985
    //   206: new 247	java/io/FileInputStream
    //   209: dup
    //   210: aload 6
    //   212: invokespecial 248	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   215: astore 4
    //   217: aload 4
    //   219: aload 9
    //   221: invokevirtual 251	java/io/File:length	()J
    //   224: invokestatic 257	com/tencent/qphone/base/util/MD5:toMD5Byte	(Ljava/io/InputStream;J)[B
    //   227: invokestatic 263	com/qq/taf/jce/HexUtil:bytes2HexStr	([B)Ljava/lang/String;
    //   230: astore 5
    //   232: aload 4
    //   234: ifnull +8 -> 242
    //   237: aload 4
    //   239: invokevirtual 264	java/io/FileInputStream:close	()V
    //   242: aload 5
    //   244: invokestatic 270	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   247: ifeq +361 -> 608
    ...
    //   280: invokestatic 274	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   283: aload_0
    //   284: aload 5
    //   286: putfield 96	com/tencent/mobileqq/activity/shortvideo/SendVideoActivity$SendAppShortVideoTask:g	Ljava/lang/String;
    //   289: aload_0
    //   290: aload 6
    //   292: putfield 276	com/tencent/mobileqq/activity/shortvideo/SendVideoActivity$SendAppShortVideoTask:f	Ljava/lang/String;
    //   295: aload 8
    //   297: ifnull +21 -> 318
    //   300: aload_0
    //   301: aload 8
    //   303: invokevirtual 279	android/graphics/Bitmap:getWidth	()I
    //   306: putfield 281	com/tencent/mobileqq/activity/shortvideo/SendVideoActivity$SendAppShortVideoTask:jdField_b_of_type_Int	I
    //   309: aload_0
    //   310: aload 8
    //   312: invokevirtual 284	android/graphics/Bitmap:getHeight	()I
    //   315: putfield 286	com/tencent/mobileqq/activity/shortvideo/SendVideoActivity$SendAppShortVideoTask:jdField_c_of_type_Int	I
    //   318: new 247	java/io/FileInputStream
    //   321: dup
    //   322: aload_0
    //   323: getfield 53	com/tencent/mobileqq/activity/shortvideo/SendVideoActivity$SendAppShortVideoTask:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   326: invokespecial 248	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   329: astore 5
    //   331: aload_0
    //   332: aload 5
    //   334: new 197	java/io/File
    //   337: dup
    //   338: aload_0
    //   339: getfield 53	com/tencent/mobileqq/activity/shortvideo/SendVideoActivity$SendAppShortVideoTask:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   342: invokespecial 199	java/io/File:<init>	(Ljava/lang/String;)V
    //   345: invokevirtual 251	java/io/File:length	()J
    //   348: invokestatic 257	com/tencent/qphone/base/util/MD5:toMD5Byte	(Ljava/io/InputStream;J)[B
    //   351: invokestatic 263	com/qq/taf/jce/HexUtil:bytes2HexStr	([B)Ljava/lang/String;
    //   354: putfield 88	com/tencent/mobileqq/activity/shortvideo/SendVideoActivity$SendAppShortVideoTask:e	Ljava/lang/String;
    //   357: iload_1
    //   358: ireturn
    //   359: astore 4
    //   361: aload 4
    //   363: invokevirtual 289	java/io/IOException:printStackTrace	()V
    //   366: goto -231 -> 135
    //   369: iconst_2
    //   370: istore_2
    //   371: goto -187 -> 184
    ...
    //   420: aload 7
    //   422: invokevirtual 296	java/io/FileNotFoundException:getMessage	()Ljava/lang/String;
    ...
    //   431: invokestatic 274	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   434: aload 5
    //   436: ifnull +8 -> 444
    //   439: aload 5
    //   441: invokevirtual 245	java/io/BufferedOutputStream:close	()V
    //   444: iconst_2
    //   445: istore_1
    //   446: goto -248 -> 198
    //   449: astore 4
    ...
    //   502: aload 7
    //   504: invokevirtual 299	java/io/IOException:getMessage	()Ljava/lang/String;
    ...
    //   513: invokestatic 274	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   516: aload 5
    //   518: ifnull +8 -> 526
    //   521: aload 5
    //   523: invokevirtual 245	java/io/BufferedOutputStream:close	()V
    //   526: iconst_2
    //   527: istore_1
    //   528: goto -330 -> 198
    //   531: astore 4
    ...
    //   545: ifnull +8 -> 553
    //   548: aload 4
    //   550: invokevirtual 245	java/io/BufferedOutputStream:close	()V
    //   553: aload 5
    //   555: athrow
    //   556: astore 7
    ...
    //   591: aload 7
    //   593: invokevirtual 299	java/io/IOException:getMessage	()Ljava/lang/String;
    ...
    //   602: invokestatic 274	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   605: goto -363 -> 242
    //   608: aload 5
    //   610: ldc 179
    //   612: invokestatic 185	com/tencent/mobileqq/shortvideo/ShortVideoUtils:getShortVideoThumbPicPath	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   615: astore 7
    //   617: aload 6
    //   619: aload 7
    //   621: invokestatic 304	com/tencent/mobileqq/utils/FileUtils:c	(Ljava/lang/String;Ljava/lang/String;)Z
    //   624: ifeq +430 -> 1054
    //   627: aload 7
    //   629: astore 6
    //   631: goto -348 -> 283
    ...
    //   637: astore 4
    //   639: aload 5
    //   641: invokevirtual 305	java/io/FileNotFoundException:printStackTrace	()V
    //   644: aload 4
    //   646: ifnull +8 -> 654
    //   649: aload 4
    //   651: invokevirtual 264	java/io/FileInputStream:close	()V
    //   654: aconst_null
    ...
    //   690: invokestatic 274	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   693: iconst_2
    //   694: istore_1
    //   695: aconst_null
    //   696: astore 5
    ...
    //   736: aload 5
    //   738: invokevirtual 299	java/io/IOException:getMessage	()Ljava/lang/String;
    ...
    //   747: invokestatic 274	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   750: goto -96 -> 654
    //   753: aconst_null
    //   754: ldc 179
    //   756: invokestatic 185	com/tencent/mobileqq/shortvideo/ShortVideoUtils:getShortVideoThumbPicPath	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   759: astore 5
    //   761: aload 6
    //   763: astore 7
    //   765: aload 6
    //   767: aload 5
    //   769: invokestatic 304	com/tencent/mobileqq/utils/FileUtils:c	(Ljava/lang/String;Ljava/lang/String;)Z
    //   772: ifeq +7 -> 779
    //   775: aload 5
    //   777: astore 7
    //   779: iconst_2
    ...
    //   798: ifnull +8 -> 806
    //   801: aload 4
    //   803: invokevirtual 264	java/io/FileInputStream:close	()V
    //   806: aconst_null
    //   807: invokestatic 270	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   810: ifeq +90 -> 900
    ...
    //   842: invokestatic 274	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   845: aload 5
    //   847: athrow
    //   848: astore 4
    ...
    //   883: aload 4
    //   885: invokevirtual 299	java/io/IOException:getMessage	()Ljava/lang/String;
    ...
    //   894: invokestatic 274	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   897: goto -91 -> 806
    //   900: aload 6
    //   902: aconst_null
    //   903: ldc 179
    //   905: invokestatic 185	com/tencent/mobileqq/shortvideo/ShortVideoUtils:getShortVideoThumbPicPath	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   908: invokestatic 304	com/tencent/mobileqq/utils/FileUtils:c	(Ljava/lang/String;Ljava/lang/String;)Z
    //   911: ifeq -66 -> 845
    //   914: goto -69 -> 845
    //   917: astore 6
    //   919: iconst_5
    ...
    //   949: aload_0
    //   950: getfield 53	com/tencent/mobileqq/activity/shortvideo/SendVideoActivity$SendAppShortVideoTask:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   962: aload 6
    //   964: invokevirtual 296	java/io/FileNotFoundException:getMessage	()Ljava/lang/String;
    ...
    //   973: invokestatic 274	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   976: aload 4
    //   978: astore 5
    //   980: iload_2
    //   981: istore_1
    ...
    //   995: iconst_2
    //   996: ldc_w 311
    //   999: invokestatic 274	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   1002: iconst_2
    //   1003: ireturn
    //   1004: astore 4
    //   1006: iload_2
  ...
  protected void a(Integer paramInteger)
  {
    ...
    case 2: 
    case 6: 
      b((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), 2131719399);
      return;
    case 3: 
      b((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), 2131719394);
      return;
    case 4: 
      b((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), 2131719365);
      return;
    }
    b((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), 2131719391);
  }
