  ...
  implements View.OnClickListener, ImageViewVideoPlayer.IMPlayerEndListener
{
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    try
    {
      ...
      if (getIntent() == null)
      {
        Toast.makeText(getApplicationContext(), amtj.a(2131707526), 1).show();
        finish();
        return;
      }
    }
    catch (Exception paramBundle)
    {
      ...
      if (getIntent().getBooleanExtra("from_qzone_camera", false))
      {
        ...
        {
          Toast.makeText(getApplicationContext(), amtj.a(2131707525), 1).show();
        ...
        findViewById(2131376546).setVisibility(0);
        findViewById(2131363943).setOnClickListener(this);
        findViewById(2131363957).setOnClickListener(this);
      }
      FrameLayout.LayoutParams localLayoutParams;
      for (;;)
      {
        localObject1 = (FrameLayout)findViewById(2131380805);
        ...
        if ((i != 0) && (i != 1))
        {
          Toast.makeText(getApplicationContext(), amtj.a(2131707524), 1).show();
        ...
        {
          Toast.makeText(getApplicationContext(), amtj.a(2131707527), 1).show();
          QLog.e("PreviewVideoActivity", 4, "init error, mSourcePath=" + this.jdField_a_of_type_JavaLangString);
          finish();
          return;
        }
        findViewById(2131378367).setVisibility(0);
        findViewById(2131365035).setOnClickListener(this);
