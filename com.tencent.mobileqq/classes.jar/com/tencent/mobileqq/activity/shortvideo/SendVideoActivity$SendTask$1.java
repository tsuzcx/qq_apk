  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (this.this$0.jdField_a_of_type_AndroidContentIntent != null)
    {
      ...
      localObject1 = ayyu.a(this.this$0.jdField_a_of_type_AndroidContentIntent, (ayzo)localObject2);
      ((ayzo)localObject2).a((azae)localObject1);
      if (j != 9501) {
        break label214;
      }
      localObject2 = new zqf(this.this$0.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app);
      ((zqf)localObject2).a(((zqf)localObject2).a((azae)localObject1));
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
      ...
      return;
      label214:
      localObject2 = new ayye(this.this$0.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app);
      ...
      if (this.this$0.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app != null) {
        ((axso)this.this$0.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app.getManager(326)).a(((MessageRecord)localObject1).frienduin, ((MessageRecord)localObject1).uniseq);
      }
