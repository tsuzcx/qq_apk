  ...
  extends FrameLayout
{
  ...
  {
    if (this.jdField_a_of_type_Accl.a() == 0) {
      this.jdField_a_of_type_Accl.a(this.jdField_a_of_type_Accl.a(), this.jdField_a_of_type_Accl.b(), paramInt1, paramInt2);
    }
    for (;;)
    {
      scrollTo(this.jdField_a_of_type_Accl.a(), this.jdField_a_of_type_Accl.b());
      postInvalidate();
      return;
      this.jdField_a_of_type_Accl.a(this.jdField_a_of_type_Accl.a(), this.jdField_a_of_type_Accl.b(), paramInt1 - this.jdField_a_of_type_Accl.a(), paramInt2);
    }
  }
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      ...
      default: 
        return true;
      case 0: 
        if ((this.jdField_a_of_type_Accl != null) && (!this.jdField_a_of_type_Accl.a())) {
    ...
    if (getChildCount() > 0)
    {
      ...
      j = this.jdField_a_of_type_Accl.a(k);
      i = j;
      if (k > 0) {
        i = -j;
      }
      ...
      paramMotionEvent = this.jdField_a_of_type_Accl;
      if (k >= 0) {
        break label436;
      }
      bool = true;
      ...
      this.jdField_a_of_type_Accl.a(getScrollX(), getScrollY(), -i, 0, 0, this.jdField_a_of_type_Int - getWidth(), 0, 0);
      label401:
      postInvalidate();
    }
    for (;;)
    {
      ...
      break;
      label442:
      this.jdField_a_of_type_Accl.a(getScrollX(), getScrollY(), -i, 0, 0, this.jdField_a_of_type_Accl.a(), 0, 0);
      break label401;
      label473:
      i = getScrollX();
      ...
      this.jdField_a_of_type_Accl.a(i, getScrollY(), j - i, 0);
      postInvalidate();
    }
  }
