  ...
  extends CursorAdapter
{
  ...
  public void a(Cursor paramCursor, TextView paramTextView1, int paramInt1, String paramString1, String paramString2, String paramString3, int paramInt2, TextView paramTextView2, ChatHistory.Holder paramHolder, ImageView paramImageView1, CharSequence paramCharSequence, ChatThumbView paramChatThumbView, View paramView1, View paramView2, ImageView paramImageView2, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      if (-2008 == i)
      {
        paramTextView1.setText(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.getString(2131718938));
        return;
      }
      if (-1002 == i)
      {
      ...
      if (i == -2000)
      {
        if ((paramHolder.jdField_a_of_type_ComTencentMobileqqDataMessageRecord instanceof MessageForPic))
        {
          ...
          {
            paramTextView1.setVisibility(0);
            paramTextView1.setText(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.getString(2131691362));
            paramTextView1.setOnTouchListener(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.jdField_a_of_type_ComTencentMobileqqActivityChatHistory$HistoryItemOnlongClickListener);
            paramTextView1.setOnLongClickListener(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.jdField_a_of_type_ComTencentMobileqqActivityChatHistory$HistoryItemOnlongClickListener);
            return;
          }
  ...
  public void a(ImageView paramImageView, int paramInt, PicEmoticonInfo paramPicEmoticonInfo, MessageRecord paramMessageRecord)
  {
    if (paramPicEmoticonInfo == null) {
      paramImageView.setImageResource(2130838121);
    }
    do
    {
      for (;;)
    ...
    paramImageView.setOnClickListener(new ChatHistory.ChatHistoryAdapter.6(this, paramPicEmoticonInfo));
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.jdField_a_of_type_ComTencentMobileqqActivityChatHistory$PlayingPttHistoryInfo != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.jdField_a_of_type_ComTencentMobileqqActivityChatHistory$PlayingPttHistoryInfo.a(0, paramImageView.getTag())))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.jdField_a_of_type_ComTencentMobileqqActivityChatHistory$PlayingPttHistoryInfo.a((View)localObject, paramPicEmoticonInfo);
      if (localObject == null) {
        break label451;
      }
    }
    label451:
    for (paramPicEmoticonInfo = (ImageView)((View)localObject).findViewById(2131378152);; paramPicEmoticonInfo = null)
    {
      this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.a(paramPicEmoticonInfo);
      break;
      if (localObject != null) {}
      for (localObject = (ImageView)((View)localObject).findViewById(2131378152);; localObject = null)
      {
        ...
        if (paramInt == 3)
        {
          ...
          PngFrameManager localPngFrameManager = (PngFrameManager)this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.app.getManager(QQManagerFactory.PNG_FRAME_DRAWABLE_MANAGER);
          localHolder.jdField_a_of_type_Long = paramPicEmoticonInfo.emoticon.getId();
          ...
          localPngFrameManager.a((String)localObject, localHolder, paramPicEmoticonInfo.emoticon.getId(), false, false, null);
          break;
        }
        if (paramInt != 0) {
          break;
  ...
  protected void a(ImageView paramImageView1, MarkFaceMessage paramMarkFaceMessage, ImageView paramImageView2, MessageRecord paramMessageRecord)
  {
    ...
    ((EmoticonManager)this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.app.getManager(QQManagerFactory.EMOTICON_MANAGER)).a(paramMarkFaceMessage, new ChatHistory.ChatHistoryAdapter.8(this, paramImageView2, paramMarkFaceMessage, paramImageView1, paramMessageRecord));
  }
  ...
  public void a(MixedMsgLinearLayout paramMixedMsgLinearLayout, MessageForMixedMsg paramMessageForMixedMsg)
  {
    ...
    if (i < k)
    {
      ...
      if ((localObject2 instanceof MessageForText))
      {
        ...
        ((AnimationTextView)localObject3).setTextColor(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.getResources().getColor(2131167100));
      ...
      for (((LinearLayout.LayoutParams)localObject2).bottomMargin = BaseChatItemLayout.m;; ((LinearLayout.LayoutParams)localObject2).bottomMargin = 0)
      {
        ...
        if ((localObject2 instanceof MessageForPic))
        {
          ...
          ((ChatThumbView)localObject3).setMaxWidth(CommonImgThumbHelper.getImgThumbMaxPx(PicItemBuilder.a((MessageForPic)localObject2)));
          ((ChatThumbView)localObject3).setMaxHeight(CommonImgThumbHelper.getImgThumbMaxPx(PicItemBuilder.a((MessageForPic)localObject2)));
          ...
          ((ChatThumbView)localObject3).setTag(2131364648, localObject2);
  ...
  public void bindView(View paramView, Context paramContext, Cursor paramCursor)
  {
    ...
    for (;;)
    {
      ...
      localHolder.jdField_a_of_type_ComTencentMobileqqDataMessageRecord = ((MessageRecord)this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.a().cursor2Entity(MessageRecord.class, (String)localObject1, paramCursor));
      ...
      do
      {
        do
        {
          ...
          if (!this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.d) {
            this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.app.getMessageFacade().a(localHolder.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.frienduin, localHolder.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.istroop, localHolder.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
          }
          long l3 = paramCursor.getLong(0);
          localHolder.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.setId(l3);
          LinearLayout localLinearLayout = (LinearLayout)paramView.findViewById(2131370325);
          TextView localTextView3 = (TextView)paramView.findViewById(2131379967);
          localTextView1 = (TextView)paramView.findViewById(2131380156);
          TextView localTextView4 = (TextView)paramView.findViewById(2131380157);
          localPatchedTextView = (PatchedTextView)paramView.findViewById(2131380161);
          localImageView1 = (ImageView)paramView.findViewById(2131377416);
          MixedMsgLinearLayout localMixedMsgLinearLayout = (MixedMsgLinearLayout)paramView.findViewById(2131371791);
          TextView localTextView2 = (TextView)paramView.findViewById(2131380155);
          localLinearLayout.setVisibility(0);
          localPatchedTextView.setVisibility(0);
          localTextView2.setVisibility(8);
          ChatThumbView localChatThumbView = (ChatThumbView)paramView.findViewById(2131368877);
          localChatThumbView.jdField_a_of_type_Boolean = false;
          ImageView localImageView3 = (ImageView)paramView.findViewById(2131368881);
          Button localButton = (Button)paramView.findViewById(2131373606);
          ImageView localImageView2 = (ImageView)paramView.findViewById(2131378152);
          ...
          for (i = 1;; i = 0)
          {
            for (;;)
            {
              ...
              try
              {
                a(localChatThumbView, (MarkFaceMessage)MessagePkgUtils.a(paramView), localImageView2, localHolder.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
                return;
              }
              catch (Exception paramView)
              {
                paramView.printStackTrace();
                a(localChatThumbView, null, localImageView2, localHolder.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
                return;
              }
            ...
            {
              localTextView1.setText(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.getResources().getString(2131697219) + AnonymousChatHelper.a(localHolder.jdField_a_of_type_ComTencentMobileqqDataMessageRecord).b);
              localTextView3.setVisibility(8);
              break label697;
            }
            if (TroopBindPublicAccountMgr.a(localHolder.jdField_a_of_type_ComTencentMobileqqDataMessageRecord))
            {
              localTextView1.setText(((IPublicAccountConfigUtil)QRoute.api(IPublicAccountConfigUtil.class)).getSubscriptName(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.app, BaseApplicationImpl.getContext()));
              break label697;
            }
            ...
            localHolder.b = str2;
            ThreadManager.post(new ChatHistory.ChatHistoryAdapter.1(this, k, str2, localHolder, localTextView1), 8, null, true);
            break label697;
            localTextView1.setTextColor(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.getResources().getColor(2131167041));
            break label727;
          }
          if (m == -2058) {
            try
          ...
          if (m == -2039)
          {
            ...
            localPatchedTextView.setText(HardCodeUtil.a(2131701706));
            return;
          }
          if (m == -2010)
          {
          ...
          for (paramContext = "0";; paramContext = paramContext[1])
          {
            for (;;)
            {
              ...
              default: 
                return;
              case 0: 
                localPatchedTextView.setText(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.getString(2131692333));
                localPatchedTextView.setVisibility(0);
                localPatchedTextView.setOnTouchListener(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.jdField_a_of_type_ComTencentMobileqqActivityChatHistory$HistoryItemOnlongClickListener);
                localPatchedTextView.setOnLongClickListener(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.jdField_a_of_type_ComTencentMobileqqActivityChatHistory$HistoryItemOnlongClickListener);
                return;
                if ((m == -2011) || (m == -2051) || (m == -7002) || (m == -2054))
                {
                  ...
                  if ((localHolder.jdField_a_of_type_ComTencentMobileqqDataMessageRecord instanceof MessageForStructing))
                  {
                    ...
                    if (((paramContext.istroop == 1024) && (!QidianManager.b(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.app, paramContext.frienduin))) || (CrmUtils.b(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.app, paramContext.frienduin, paramContext.istroop)))
                    {
                      ...
                      paramView = String.format(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.app.getApp().getString(2131697678), new Object[] { HardCodeUtil.a(2131701660) });
                  ...
                  if (TroopBindPublicAccountMgr.a(localHolder.jdField_a_of_type_ComTencentMobileqqDataMessageRecord))
                  {
                    paramContext = String.format(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.app.getApp().getString(2131697678), new Object[] { ((IPublicAccountConfigUtil)QRoute.api(IPublicAccountConfigUtil.class)).getSubscriptName(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.app, BaseApplicationImpl.getContext()) });
                ...
                try
                {
                  paramContext = ((HiBoomMessage)MessagePkgUtils.a(paramContext)).text;
                  if (TextUtils.isEmpty(paramContext)) {
                    break label99;
                  }
                  localPatchedTextView.setText(paramContext);
            ...
            if ((m == -2000) || (m == -20000) || (m == -3004) || (m == -3005) || (m == -3000) || (m == -3001) || (m == -5015))
            {
              if ((localHolder.jdField_a_of_type_ComTencentMobileqqDataMessageRecord != null) && ((localHolder.jdField_a_of_type_ComTencentMobileqqDataMessageRecord instanceof MessageForPic)))
              {
                ...
                {
                  localPatchedTextView.setVisibility(0);
                  localPatchedTextView.setText(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.getString(2131691362));
                  localPatchedTextView.setOnTouchListener(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.jdField_a_of_type_ComTencentMobileqqActivityChatHistory$HistoryItemOnlongClickListener);
                  localPatchedTextView.setOnLongClickListener(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.jdField_a_of_type_ComTencentMobileqqActivityChatHistory$HistoryItemOnlongClickListener);
                  return;
                }
              ...
              QLog.d("history", 2, "not messageforpicuniseq:" + localHolder.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.uniseq + ",dbid:" + localHolder.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.getId() + "istroop:" + localHolder.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.istroop + ",msgtype:" + localHolder.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.msgtype);
              return;
            }
            if (m == -2002)
            {
              ...
              if (((MessageForPtt)localHolder.jdField_a_of_type_ComTencentMobileqqDataMessageRecord).voiceChangeFlag == 1)
              {
                ...
                localButton.setCompoundDrawables(null, null, null, null);
                localButton.setText("[" + this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.getString(2131695171) + "]");
                localButton.setOnClickListener(null);
              }
              if (this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.jdField_a_of_type_ComTencentMobileqqActivityChatHistory$PlayingPttHistoryInfo.a(0, localButton.getTag()))
              {
                ...
                localButton.setOnClickListener(new ChatHistory.ChatHistoryAdapter.2(this, j, paramCursor));
                return;
              }
              if (bool) {}
              for (paramView = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130850383);; paramView = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130850382))
              {
                ...
                localButton.setText("[" + this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.getString(2131695174) + "]");
                break;
              }
            }
            if (m == -1035)
            ...
            {
              localPatchedTextView.setVisibility(0);
              localPatchedTextView.setText(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.getString(2131694364));
              return;
            }
            if (m == -2017)
            {
            ...
            {
              localPatchedTextView.setVisibility(0);
              localPatchedTextView.setOnClickListener(new ChatHistory.ChatHistoryAdapter.3(this, str1));
              localPatchedTextView.setOnTouchListener(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.jdField_a_of_type_ComTencentMobileqqActivityChatHistory$HistoryItemOnlongClickListener);
              localPatchedTextView.setOnLongClickListener(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.jdField_a_of_type_ComTencentMobileqqActivityChatHistory$HistoryItemOnlongClickListener);
              if (MessageRecordInfo.a(k))
              {
                localPatchedTextView.setText(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.app.getApp().getString(2131719144, new Object[] { this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_d_of_type_JavaLangString }));
                return;
              }
              localPatchedTextView.setText(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.app.getApp().getString(2131719143));
              return;
            }
            if (m == -3008)
            {
              localPatchedTextView.setText(BaseApplicationImpl.getContext().getString(2131692374) + "\"" + (String)localObject2 + "\"");
              localPatchedTextView.setVisibility(0);
              localPatchedTextView.setOnTouchListener(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.jdField_a_of_type_ComTencentMobileqqActivityChatHistory$HistoryItemOnlongClickListener);
              localPatchedTextView.setOnLongClickListener(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.jdField_a_of_type_ComTencentMobileqqActivityChatHistory$HistoryItemOnlongClickListener);
              return;
            ...
            {
              localPatchedTextView.setVisibility(0);
              localPatchedTextView.setText(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.getString(2131719368));
              localPatchedTextView.setOnTouchListener(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.jdField_a_of_type_ComTencentMobileqqActivityChatHistory$HistoryItemOnlongClickListener);
              localPatchedTextView.setOnLongClickListener(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.jdField_a_of_type_ComTencentMobileqqActivityChatHistory$HistoryItemOnlongClickListener);
              return;
            }
            if (m == -5002)
            {
              if ((localHolder.jdField_a_of_type_ComTencentMobileqqDataMessageRecord != null) && ((localHolder.jdField_a_of_type_ComTencentMobileqqDataMessageRecord instanceof MessageForIncompatibleGrayTips)))
              {
                ...
                paramCursor = new ChatHistory.ChatHistoryAdapter.4(this, paramCursor, str1);
                paramContext.setSpan(new ForegroundColorSpan(2131167249), paramView.linkStart, paramView.linkEnd, 33);
              ...
              QLog.d("history", 2, "not MessageForIncompatibleGrayTipsuniseq:" + localHolder.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.uniseq + ",dbid:" + localHolder.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.getId() + "istroop:" + localHolder.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.istroop + ",msgtype:" + localHolder.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.msgtype);
              return;
            }
            if (m == -2025)
            {
            ...
            localPatchedTextView.setVisibility(0);
            localPatchedTextView.setText(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.getString(2131691363));
            localPatchedTextView.setOnTouchListener(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.jdField_a_of_type_ComTencentMobileqqActivityChatHistory$HistoryItemOnlongClickListener);
            localPatchedTextView.setOnLongClickListener(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.jdField_a_of_type_ComTencentMobileqqActivityChatHistory$HistoryItemOnlongClickListener);
            return;
          ...
          for (;;)
          {
            localButton.setOnClickListener(new ChatHistory.ChatHistoryAdapter.5(this, j, paramCursor));
            return;
            paramView = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130850382);
            paramView.setBounds(0, 0, paramView.getMinimumWidth(), paramView.getMinimumHeight());
            localButton.setCompoundDrawables(paramView, null, null, null);
            if (l1 <= 0L) {
              localButton.setText("[" + this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.getString(2131695174) + "]");
          ...
          localChatThumbView.setOnTouchListener(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.jdField_a_of_type_ComTencentMobileqqActivityChatHistory$HistoryItemOnlongClickListener);
          localChatThumbView.setOnLongClickListener(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.jdField_a_of_type_ComTencentMobileqqActivityChatHistory$HistoryItemOnlongClickListener);
          localChatThumbView.setImageResource(2130839221);
          return;
          i = paramCursor.getInt(paramCursor.getColumnIndex("msgtype"));
          localPatchedTextView.setVisibility(0);
          if (!MessageUtils.a(m))
      ...
      if (-2008 == i)
      {
        localPatchedTextView.setText(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.getString(2131718938));
        return;
      }
      if (-1002 == i)
      {
      ...
      localPatchedTextView.setText(new QQText((CharSequence)localObject2, 13, 32, localHolder.jdField_a_of_type_ComTencentMobileqqDataMessageRecord));
      return;
    }
  }
  ...
  {
    return this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131558961, paramViewGroup, false);
  }
}
