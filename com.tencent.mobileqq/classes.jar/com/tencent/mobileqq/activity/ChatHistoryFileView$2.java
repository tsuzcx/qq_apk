  ...
  implements Comparator<Object>
{
  ...
  public int compare(Object paramObject1, Object paramObject2)
  {
    ...
    else if ((paramObject1 instanceof TencentDocData))
    {
      if ((paramObject2 instanceof FileManagerEntity))
      {
        if (((TencentDocData)paramObject1).aioTime > ((FileManagerEntity)paramObject2).srvTime) {
          return -1;
        }
        return 1;
      }
      if ((paramObject2 instanceof TencentDocData))
      {
        if (((TencentDocData)paramObject1).aioTime > ((TencentDocData)paramObject2).aioTime) {
          return -1;
        }
        return 1;
      }
