  ...
  implements View.OnClickListener
{
  ...
  public long a;
  public Dialog a;
  BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new tuo(this);
  public Uri a;
  public Handler a;
  protected View a;
  protected Button a;
  protected LinearLayout a;
  BizTroopObserver jdField_a_of_type_ComTencentMobileqqAppBizTroopObserver = new tvb(this);
  public FriendListHandler a;
  FriendListObserver jdField_a_of_type_ComTencentMobileqqAppFriendListObserver = new tuy(this);
  public TroopHandler a;
  TroopObserver jdField_a_of_type_ComTencentMobileqqAppTroopObserver = new tvc(this);
  public TroopInfo a;
  ...
  public TroopInfoActivity()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new tux(this);
  }
  ...
  private void a(long paramLong1, int paramInt1, int paramInt2, long paramLong2, long paramLong3, String paramString)
  {
    ...
    localTextView1.setText(String.format(getString(2131435730), new Object[] { Integer.valueOf(this.jdField_d_of_type_Int) }));
    localTextView1.setGravity(3);
    localTextView2.setText(2131432999);
    localTextView3.setText(2131435727);
    localDialog.setCanceledOnTouchOutside(false);
    localTextView2.setOnClickListener(new tut(this, localDialog, paramLong1, paramInt2, paramLong2, paramLong3, paramString));
    localTextView3.setOnClickListener(new tuu(this, localDialog));
    try
    {
      localDialog.show();
      return;
  ...
  private void a(XListView paramXListView)
  {
    ...
    this.jdField_b_of_type_AndroidViewView = super.getLayoutInflater().inflate(2130969858, paramXListView, false);
    this.jdField_c_of_type_AndroidViewView = this.jdField_b_of_type_AndroidViewView.findViewById(2131367454);
    ((ImageButton)this.jdField_b_of_type_AndroidViewView.findViewById(2131362850)).setOnClickListener(new tvl(this, paramXListView));
  ...
  private void a(ArrayList paramArrayList)
  {
    ...
    this.jdField_a_of_type_JavaUtilObserver = new tvh(this);
    Object localObject2 = TroopUtils.a(this.app);
    if (localObject2 == null)
    {
      ((AccountManager)this.app.getManager(0)).updateSKey(new tvj(this, (TroopAvatarManger)localObject1, paramArrayList));
      return;
    }
  ...
  private void a(boolean paramBoolean, long paramLong1, String paramString, long paramLong2, long paramLong3)
  {
    ...
    if (!paramBoolean)
    {
      ...
      for (str = this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin;; str = "")
      {
        ...
        {
        default: 
          paramString = getString(2131435735);
          break;
        case 1281: 
          paramString = getString(2131430525);
          break;
        case 1282: 
          paramString = getString(2131430526);
          break;
        case 1283: 
          paramString = getString(2131430527);
          break;
        }
      }
    }
    ...
    for (String str = String.valueOf(this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.pa);; str = "")
    {
      ...
      QQToast.a(this, 2, getString(2131435734), 1).b(getTitleBarHeight());
      break;
      paramString = "";
      break label245;
    }
  ...
  private void q()
  {
    if ((this.jdField_e_of_type_Boolean) && (this.jdField_b_of_type_Int == 0))
    {
      ...
      ((QQCustomDialog)localObject).setMessage(getString(2131430539, new Object[] { l1 + "" }));
      ((QQCustomDialog)localObject).setNegativeButton(getString(2131430538), new tvt(this));
      ((QQCustomDialog)localObject).setPositiveButton(getString(2131435737), new tvu(this));
  ...
  private void u()
  {
    ...
    localActionSheet.a(new tuw(this, localActionSheet));
    localActionSheet.show();
  }
  
  private void v()
  {
    ThreadManager.post(new tvf(this), 5, null, true);
  }
  ...
  private void w()
  {
    ...
    ThreadManager.post(new tvg(this), 5, null, true);
  }
  ...
  private void x()
  {
    ...
    {
      localTextView = (TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131368262);
  ...
  {
    startTitleProgress();
    TroopInfoActivityHelper.a(this.app, Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin).longValue(), new tvm(this));
  }
  
  private void z()
  {
    TroopInfoActivityHelper.a(this.app, Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin).longValue(), new tvn(this));
  }
  
  protected String a()
  {
    if (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopName)) {
      return getString(2131430567);
    }
    if (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.mRichFingerMemo)) {
      return getString(2131430568);
    }
  ...
  public void a(int paramInt)
  {
    ...
    localQQCustomDialog.setPositiveButton(getString(2131435738), new tup(this, localQQCustomDialog));
    localQQCustomDialog.setPositiveButtonContentDescription(getString(2131435738));
    localQQCustomDialog.setNegativeButton(getString(2131435737), new DialogUtil.DialogOnClickAdapter());
    localQQCustomDialog.setNegativeButtonContentDescription(getString(2131435737));
  ...
  protected void a(int paramInt1, int paramInt2, View paramView, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      {
      default: 
        TextView localTextView2 = (TextView)paramView.findViewById(2131363360);
        localTextView1 = (TextView)paramView.findViewById(2131364095);
  ...
  public void a(int paramInt, String paramString, boolean paramBoolean)
  {
    ...
    for (View localView1 = this.jdField_a_of_type_ArrayOfAndroidViewView[paramInt];; localView1 = null)
    {
      ...
      if (localView1 != null)
      {
        localTextView = (TextView)localView1.findViewById(2131364095);
        localView2 = localView1.findViewById(2131363425);
        if (paramInt != 6) {
          break label205;
        }
        if (!TextUtils.isEmpty(paramString)) {
        ...
        if (!paramString.equals(getString(2131433068))) {
          break label194;
        }
  ...
  protected void b()
  {
    ...
    View localView = View.inflate(this, 2130970609, null);
    Object localObject1 = (ListView)localView.findViewById(2131371411);
    ...
    if (TextUtils.isEmpty((CharSequence)localObject2)) {
      localObject1 = getString(2131433662);
    }
    ...
    if (this.jdField_g_of_type_Boolean)
    {
      ...
      ((TextView)localObject1).setTextColor(getResources().getColor(2131494101));
    ...
    ((View)localObject1).findViewById(2131366440).setVisibility(8);
    localObject2 = (TextView)((View)localObject1).findViewById(2131366441);
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqTroopWidgetAvatarWallViewPager.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130838631);
      if ((localObject1 instanceof ViewGroup))
      {
        ((TextView)localObject2).setVisibility(8);
        this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)View.inflate(this, 2130969426, null));
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.dwGroupFlagExt & 0x800) != 0L)
    {
      localObject1 = View.inflate(this, 2130970612, null);
      this.jdField_a_of_type_ArrayOfAndroidViewView[7] = localObject1;
      this.jdField_a_of_type_AndroidWidgetLinearLayout.addView((View)localObject1);
      a(7, 0, (View)localObject1, getString(2131433489), this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopAuthenticateInfo, false);
    ...
    a(3, 1, (View)localObject1, getString(2131434470), this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopName, bool);
    localObject1 = View.inflate(this, 2130970612, null);
    this.jdField_a_of_type_ArrayOfAndroidViewView[5] = localObject1;
    this.jdField_a_of_type_AndroidWidgetLinearLayout.addView((View)localObject1);
    a(5, 2, (View)localObject1, getString(2131435536), this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopLocation, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.isOwnerOrAdim());
    k();
    localObject1 = View.inflate(this, 2130970612, null);
    this.jdField_a_of_type_ArrayOfAndroidViewView[4] = localObject1;
    this.jdField_a_of_type_AndroidWidgetLinearLayout.addView((View)localObject1);
    a(4, 2, (View)localObject1, getString(2131433642), this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopClass, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.isOwnerOrAdim());
    localObject1 = View.inflate(this, 2130970611, null);
    this.jdField_a_of_type_ArrayOfAndroidViewView[8] = localObject1;
    this.jdField_a_of_type_AndroidWidgetLinearLayout.addView((View)localObject1);
    a(8, 3, (View)localObject1, getString(2131433643), null, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.isOwnerOrAdim(), 1);
    ThreadManager.post(new tuz(this), 8, null, true);
    localObject1 = View.inflate(this, 2130970624, null);
    this.jdField_a_of_type_AndroidWidgetLinearLayout.addView((View)localObject1);
    localObject2 = View.inflate(this, 2130970617, null);
    ...
    if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.mRichFingerMemo))
    {
      ...
      a(6, 3, (View)localObject2, getString(2131433481), (String)localObject1, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.isOwnerOrAdim());
    ...
    for (;;)
    {
      ...
      this.leftView.setOnClickListener(new tvp(this));
      this.rightViewText.setOnClickListener(new tvq(this));
      if (QLog.isColorLevel()) {
        QLog.i("Q.troopinfo", 2, "initUI: time = " + (System.currentTimeMillis() - l));
      }
      return;
      localObject1 = getResources().getString(2131433068);
      break;
      label1312:
      b(11);
    }
  ...
  public void b(int paramInt)
  {
    ...
    case 10: 
      ...
      this.rightViewText.setText(2131435725);
      return;
    }
  ...
  protected void b(String paramString)
  {
    ...
    localQQProgressDialog.setOnDismissListener(new tuv(this));
  ...
  public void c()
  {
    if (((this.jdField_c_of_type_Long != 0L) || (this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.tribeId != 0L)) && (this.jdField_b_of_type_Int == 0))
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.modifyCount <= 0)
      {
        ...
        ((QQCustomDialog)localObject).setTitle(null);
        ((QQCustomDialog)localObject).setMessage(getString(2131430540));
        ((QQCustomDialog)localObject).setPositiveButton(getString(2131430538), new DialogUtil.DialogOnClickAdapter());
        ((QQCustomDialog)localObject).setPositiveButtonContentDescription(getString(2131430538));
        ((QQCustomDialog)localObject).show();
        return;
      }
      if (this.jdField_e_of_type_Boolean)
      {
        ...
        if (TextUtils.isEmpty((CharSequence)localObject))
        {
          localObject = DialogUtil.a(this, 230);
          ((QQCustomDialog)localObject).setTitle(null);
          ((QQCustomDialog)localObject).setMessage(getString(2131430541, new Object[] { String.valueOf(this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.modifyCount) }));
          ((QQCustomDialog)localObject).setPositiveButton(getString(2131430538), new tvr(this));
          ((QQCustomDialog)localObject).setNegativeButton(getString(2131435737), new tvs(this));
          ((QQCustomDialog)localObject).show();
          return;
        }
  ...
  public void f()
  {
    ...
    addObserver(this.jdField_a_of_type_ComTencentMobileqqAppBizTroopObserver);
    ThreadManager.post(new tuq(this), 5, null, true);
  }
  ...
  public void finish()
  {
    ...
    {
      TroopUtils.a(this.app, this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo, this, new tvv(this));
      return;
    }
    Intent localIntent;
    Bundle localBundle;
    if ((this.jdField_g_of_type_Boolean) && (!this.i))
    {
      ...
      localBundle.putString("leftViewText", getString(2131435333));
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopTypeExt == 2)
        {
          ...
          TroopInfoActivityHelper.a(this.app, l6, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopName, j, l4, l3, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.mPoiId, (String)localObject2, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.dwGroupClassExt, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopTags, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.mRichFingerMemo, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.tribeId, k, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.tribeName, new tur(this));
          return;
        }
      }
      ...
      catch (ArrayIndexOutOfBoundsException localArrayIndexOutOfBoundsException)
      {
        ...
        {
          TroopInfoActivityHelper.a(this.app, l6, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopName, j, l1, l2, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.mPoiId, (String)localObject1, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.dwGroupClassExt, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopTags, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.mRichFingerMemo, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.tribeId, k, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.tribeName, new tus(this));
          return;
        }
        if ((this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.dwGroupFlagExt & 0x800) != 0L)
        {
          ...
          ((QQCustomDialog)localObject1).setMessage(getString(2131435731, new Object[] { Integer.valueOf(this.jdField_d_of_type_Int) }));
          ((QQCustomDialog)localObject1).setPositiveButton(getString(2131430538), new DialogUtil.DialogOnClickAdapter());
          ((QQCustomDialog)localObject1).setPositiveButtonContentDescription(getString(2131430538));
  ...
  public void m()
  {
    ...
    {
      DialogUtil.a(this, 230, null, getString(2131430219), null, getString(2131430220), new DialogUtil.DialogOnClickAdapter(), null).show();
    ...
    case 11: 
      do
      {
        do
        {
          ...
          paramView.putExtra("title", getString(2131433481));
  ...
  public void p()
  {
    ...
    try
    {
      ...
      tvo localtvo = new tvo(this);
      localtvo.jdField_b_of_type_JavaLangRefWeakReference = new WeakReference(this.app);
      localtvo.jdField_b_of_type_Int = 2;
      ((NewIntent)localObject).setObserver(localtvo);
