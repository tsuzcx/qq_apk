  ...
  implements ActionSheet.OnButtonClickListener
{
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityUncommonlyUsedContactsActivity$ListItem.a instanceof Friends))
    {
      ...
      ((Intent)localObject).putExtra("uinname", ContactUtils.m(this.jdField_a_of_type_ComTencentMobileqqActivityUncommonlyUsedContactsActivity.app, paramView));
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityUncommonlyUsedContactsActivity$ListItem.a instanceof PhoneContact))
      {
        ...
        for (;;)
        {
          ...
          if ((this.jdField_a_of_type_ComTencentMobileqqActivityUncommonlyUsedContactsActivity$ListItem.a instanceof PhoneContact))
          {
            ((PhoneContactManagerImp)this.jdField_a_of_type_ComTencentMobileqqActivityUncommonlyUsedContactsActivity.app.getManager(QQManagerFactory.CONTACT_MANAGER)).a(((PhoneContact)this.jdField_a_of_type_ComTencentMobileqqActivityUncommonlyUsedContactsActivity$ListItem.a).mobileCode, false);
            continue;
            this.jdField_a_of_type_ComTencentMobileqqActivityUncommonlyUsedContactsActivity.a(2131694511, 0);
          }
        }
