...
public class StatisticConstants
{
  public static int a()
  {
    int j = 1;
    int i;
    if ((DeviceInfoUtil.e() >>> 20 < 600L) || (DeviceInfoUtil.b() == 1)) {
      i = 0;
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
        QLog.d("StatisticConstants", 2, "getDeviceType,DeviceInfoUtil.getSystemTotalMemory() =" + (DeviceInfoUtil.e() >>> 20) + ",DeviceInfoUtil.getCpuNumber() = " + DeviceInfoUtil.b() + ",phoneType = " + i);
      }
      return i;
      i = j;
      if (DeviceInfoUtil.e() >>> 20 >= 1536.0D)
      {
        i = j;
  ...
  public static void a(String paramString, int paramInt, QQAppInterface paramQQAppInterface)
  {
    ...
    //   5: aload_2
    //   6: bipush 105
    //   8: invokevirtual 420	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   11: checkcast 422	com/tencent/mobileqq/nearby/NearbyCardManager
    //   14: astore_2
    //   15: aload_2
    //   16: ifnull +962 -> 978
    //   19: aload_2
    //   20: invokevirtual 423	com/tencent/mobileqq/nearby/NearbyCardManager:a	()I
    //   23: istore 4
    //   25: aload_2
    //   26: invokevirtual 424	com/tencent/mobileqq/nearby/NearbyCardManager:b	()I
    //   29: istore_3
    //   30: new 426	android/graphics/BitmapFactory$Options
    //   33: dup
    //   34: invokespecial 427	android/graphics/BitmapFactory$Options:<init>	()V
    //   37: astore_2
    //   38: aload_2
    //   39: iconst_1
    //   40: putfield 431	android/graphics/BitmapFactory$Options:inJustDecodeBounds	Z
    //   43: aload_0
    //   44: aload_2
    //   45: invokestatic 436	com/tencent/mobileqq/utils/ImageUtil:a	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   48: pop
    //   49: aload_2
    //   50: getfield 440	android/graphics/BitmapFactory$Options:outWidth	I
    //   53: istore 7
    //   55: aload_2
    //   56: getfield 443	android/graphics/BitmapFactory$Options:outHeight	I
    //   59: istore 8
    //   61: iload 7
    //   63: i2l
    //   64: iload 8
    //   66: i2l
    //   67: invokestatic 448	com/tencent/mobileqq/richmedia/dc/PhotoUtils:a	(JJ)I
    //   70: istore 9
    //   72: iload_1
    //   73: istore 5
    //   75: iload_1
    ...
    //   100: aconst_null
    //   101: astore 17
    //   103: new 450	java/io/FileInputStream
    //   106: dup
    //   107: aload_0
    //   108: invokespecial 452	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   111: astore 16
    //   113: aload 16
    //   115: new 454	java/io/File
    //   118: dup
    //   119: aload_0
    //   120: invokespecial 455	java/io/File:<init>	(Ljava/lang/String;)V
    //   123: invokevirtual 458	java/io/File:length	()J
    //   126: invokestatic 464	com/tencent/qphone/base/util/MD5:toMD5Byte	(Ljava/io/InputStream;J)[B
    //   129: astore_2
    //   130: aload_2
    //   131: invokestatic 470	com/qq/taf/jce/HexUtil:bytes2HexStr	([B)Ljava/lang/String;
    //   134: astore_2
    //   135: aload_2
    //   136: astore 17
    //   138: aload 17
    ...
    //   143: ifnull +11 -> 154
    //   146: aload 16
    //   148: invokevirtual 473	java/io/FileInputStream:close	()V
    //   151: aload 17
    //   153: astore_2
    //   154: aload_0
    //   155: invokestatic 478	com/tencent/mobileqq/utils/FileUtils:a	(Ljava/lang/String;)Ljava/lang/String;
    //   158: astore 16
    //   160: aload 16
    //   162: invokevirtual 483	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   165: ldc_w 485
    //   168: invokevirtual 489	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   171: ifeq +759 -> 930
    //   174: iconst_0
    //   175: istore_1
    //   176: invokestatic 495	java/util/Calendar:getInstance	()Ljava/util/Calendar;
    //   179: bipush 11
    //   181: invokevirtual 499	java/util/Calendar:get	(I)I
    //   184: istore 10
    //   186: invokestatic 257	com/tencent/mobileqq/app/DeviceProfileManager:a	()Lcom/tencent/mobileqq/app/DeviceProfileManager;
    //   189: getstatic 263	com/tencent/mobileqq/app/DeviceProfileManager$AccountDpcManager$DpcAccountNames:picpredownload_whitelist	Lcom/tencent/mobileqq/app/DeviceProfileManager$AccountDpcManager$DpcAccountNames;
    //   192: invokevirtual 266	com/tencent/mobileqq/app/DeviceProfileManager$AccountDpcManager$DpcAccountNames:name	()Ljava/lang/String;
    //   195: invokevirtual 269	com/tencent/mobileqq/app/DeviceProfileManager:a	(Ljava/lang/String;)Z
    //   198: ifeq +737 -> 935
    //   201: sipush 1002
    //   204: istore 6
    //   206: invokestatic 148	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   209: ifeq +158 -> 367
    //   212: ldc 30
    //   214: iconst_4
    ...
    //   238: iload 5
    //   240: invokevirtual 47	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   243: ldc_w 505
    //   246: invokevirtual 39	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   249: iload 9
    //   251: invokevirtual 47	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   254: ldc_w 507
    //   257: invokevirtual 39	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   260: iload 4
    //   262: invokevirtual 47	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   265: ldc 185
    //   267: invokevirtual 39	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   270: iload_3
    //   271: invokevirtual 47	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   274: ldc_w 509
    //   277: invokevirtual 39	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   280: iload 10
    //   282: invokevirtual 47	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   285: ldc_w 511
    ...
    //   295: ldc_w 513
    //   298: invokevirtual 39	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   301: iload_1
    //   302: invokevirtual 47	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   305: ldc_w 515
    //   308: invokevirtual 39	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   311: aload 16
    ...
    //   322: aload_0
    //   323: invokestatic 520	com/tencent/qphone/base/util/MD5:toMD5	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   335: iload 7
    //   337: invokevirtual 47	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   340: ldc_w 524
    //   343: invokevirtual 39	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   346: iload 8
    //   348: invokevirtual 47	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   351: ldc 187
    //   353: invokevirtual 39	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   356: iload 6
    //   358: invokevirtual 47	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   361: invokevirtual 53	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   364: invokestatic 57	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   367: new 118	java/util/HashMap
    //   370: dup
    //   371: invokespecial 119	java/util/HashMap:<init>	()V
    //   374: astore_0
    //   375: aload_0
    //   376: ldc_w 526
    //   379: new 32	java/lang/StringBuilder
    //   382: dup
    //   383: invokespecial 33	java/lang/StringBuilder:<init>	()V
    //   386: iload 5
    //   388: invokevirtual 47	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   391: ldc 121
    //   393: invokevirtual 39	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   396: invokevirtual 53	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   399: invokevirtual 125	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   402: pop
    //   403: aload_0
    //   404: ldc_w 528
    //   407: new 32	java/lang/StringBuilder
    //   410: dup
    //   411: invokespecial 33	java/lang/StringBuilder:<init>	()V
    //   414: iload 9
    //   416: invokevirtual 47	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   419: ldc 121
    //   421: invokevirtual 39	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   424: invokevirtual 53	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   427: invokevirtual 125	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   430: pop
    //   431: aload_0
    //   432: ldc 243
    //   434: new 32	java/lang/StringBuilder
    //   437: dup
    //   438: invokespecial 33	java/lang/StringBuilder:<init>	()V
    //   441: iload 4
    //   443: invokevirtual 47	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   446: ldc 121
    //   448: invokevirtual 39	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   451: invokevirtual 53	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   454: invokevirtual 125	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   457: pop
    //   458: aload_0
    //   459: ldc 245
    //   461: new 32	java/lang/StringBuilder
    //   464: dup
    //   465: invokespecial 33	java/lang/StringBuilder:<init>	()V
    //   468: iload_3
    //   469: invokevirtual 47	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   472: ldc 121
    //   474: invokevirtual 39	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   477: invokevirtual 53	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   480: invokevirtual 125	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   483: pop
    //   484: aload_0
    //   485: ldc 247
    //   487: new 32	java/lang/StringBuilder
    //   490: dup
    //   491: invokespecial 33	java/lang/StringBuilder:<init>	()V
    //   494: iload 6
    //   496: invokevirtual 47	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   499: ldc 121
    //   501: invokevirtual 39	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   504: invokevirtual 53	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   507: invokevirtual 125	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   510: pop
    //   511: aload_0
    //   512: ldc_w 530
    //   515: aload_2
    //   516: invokevirtual 125	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   519: pop
    //   520: aload_0
    //   521: ldc_w 532
    //   524: new 32	java/lang/StringBuilder
    //   527: dup
    //   528: invokespecial 33	java/lang/StringBuilder:<init>	()V
    //   531: iload_1
    //   532: invokevirtual 47	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   535: ldc 121
    //   537: invokevirtual 39	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   540: invokevirtual 53	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   543: invokevirtual 125	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   546: pop
    //   547: aload_0
    //   548: ldc_w 534
    //   551: new 32	java/lang/StringBuilder
    //   554: dup
    //   555: invokespecial 33	java/lang/StringBuilder:<init>	()V
    //   558: iload 10
    //   560: invokevirtual 47	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   563: ldc 121
    //   565: invokevirtual 39	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   568: invokevirtual 53	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   571: invokevirtual 125	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   574: pop
    //   575: invokestatic 65	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   578: invokestatic 135	com/tencent/mobileqq/statistics/StatisticCollector:a	(Landroid/content/Context;)Lcom/tencent/mobileqq/statistics/StatisticCollector;
    //   581: aconst_null
    //   582: ldc_w 536
    //   585: iconst_0
    //   586: lconst_0
    ...
    //   589: ldc 121
    //   591: iconst_0
    //   592: invokevirtual 140	com/tencent/mobileqq/statistics/StatisticCollector:a	(Ljava/lang/String;Ljava/lang/String;ZJJLjava/util/HashMap;Ljava/lang/String;Z)V
    //   595: invokestatic 65	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   598: invokestatic 71	android/preference/PreferenceManager:getDefaultSharedPreferences	(Landroid/content/Context;)Landroid/content/SharedPreferences;
    //   601: astore_0
    //   602: aload_0
    //   603: ldc_w 538
    //   606: lconst_0
    //   607: invokeinterface 105 4 0
    //   612: lstore 11
    //   614: invokestatic 110	java/lang/System:currentTimeMillis	()J
    //   617: lstore 13
    //   619: aload_0
    //   620: ldc_w 540
    //   623: iconst_0
    //   624: invokeinterface 79 3 0
    //   629: iconst_1
    //   630: iadd
    //   631: istore_1
    //   632: lload 13
    ...
    //   640: lcmp
    //   641: ifle +302 -> 943
    //   644: new 118	java/util/HashMap
    //   647: dup
    //   648: invokespecial 119	java/util/HashMap:<init>	()V
    //   651: astore_2
    //   652: aload_2
    //   653: ldc 243
    //   655: new 32	java/lang/StringBuilder
    //   658: dup
    //   659: invokespecial 33	java/lang/StringBuilder:<init>	()V
    //   662: iload 4
    //   664: invokevirtual 47	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   667: ldc 121
    //   669: invokevirtual 39	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   672: invokevirtual 53	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   675: invokevirtual 125	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   678: pop
    //   679: aload_2
    //   680: ldc 245
    //   682: new 32	java/lang/StringBuilder
    //   685: dup
    //   686: invokespecial 33	java/lang/StringBuilder:<init>	()V
    //   689: iload_3
    //   690: invokevirtual 47	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   693: ldc 121
    //   695: invokevirtual 39	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   698: invokevirtual 53	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   701: invokevirtual 125	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   704: pop
    //   705: aload_2
    //   706: ldc 247
    //   708: new 32	java/lang/StringBuilder
    //   711: dup
    //   712: invokespecial 33	java/lang/StringBuilder:<init>	()V
    //   715: iload 6
    //   717: invokevirtual 47	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   720: ldc 121
    //   722: invokevirtual 39	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   725: invokevirtual 53	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   728: invokevirtual 125	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   731: pop
    //   732: aload_2
    //   733: ldc_w 542
    ...
    //   743: iload_1
    //   744: invokevirtual 47	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   747: ldc 121
    //   749: invokevirtual 39	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   752: invokevirtual 53	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   755: invokevirtual 125	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   758: pop
    //   759: invokestatic 65	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   762: invokestatic 135	com/tencent/mobileqq/statistics/StatisticCollector:a	(Landroid/content/Context;)Lcom/tencent/mobileqq/statistics/StatisticCollector;
    //   765: aconst_null
    //   766: ldc_w 544
    //   769: iconst_0
    //   770: lconst_0
    ...
    //   773: ldc 121
    //   775: iconst_0
    //   776: invokevirtual 140	com/tencent/mobileqq/statistics/StatisticCollector:a	(Ljava/lang/String;Ljava/lang/String;ZJJLjava/util/HashMap;Ljava/lang/String;Z)V
    //   779: aload_0
    //   780: invokeinterface 83 1 0
    //   785: ldc_w 538
    //   788: lload 13
    //   790: invokeinterface 144 4 0
    //   795: ldc_w 540
    //   798: iconst_0
    //   799: invokeinterface 89 3 0
    //   804: invokeinterface 92 1 0
    //   809: pop
    //   810: return
    //   811: astore_2
    //   812: new 454	java/io/File
    //   815: dup
    //   816: aload_0
    //   817: invokespecial 455	java/io/File:<init>	(Ljava/lang/String;)V
    //   820: astore_2
    //   821: aload_2
    //   822: invokevirtual 547	java/io/File:exists	()Z
    //   825: istore 15
    //   827: iload 15
    //   829: ifeq +144 -> 973
    //   832: aload_2
    //   833: invokestatic 552	com/tencent/qqprotect/singleupdate/MD5FileUtil:a	(Ljava/io/File;)Ljava/lang/String;
    //   836: astore_2
    //   837: aload_2
    //   838: ifnull +11 -> 849
    //   841: aload_2
    //   842: invokestatic 556	com/qq/taf/jce/HexUtil:hexStr2Bytes	(Ljava/lang/String;)[B
    //   845: astore_2
    //   846: goto -716 -> 130
    //   849: ldc 121
    //   851: astore_2
    ...
    //   861: astore_2
    //   862: aload_2
    //   863: invokevirtual 559	java/io/IOException:printStackTrace	()V
    //   866: aload 17
    //   868: astore_2
    //   869: goto -715 -> 154
    //   872: astore_2
    ...
    //   881: ifnull -727 -> 154
    //   884: aload 16
    //   886: invokevirtual 473	java/io/FileInputStream:close	()V
    //   889: aload 17
    //   891: astore_2
    //   892: goto -738 -> 154
    //   895: astore_2
    //   896: aload_2
    //   897: invokevirtual 559	java/io/IOException:printStackTrace	()V
    //   900: aload 17
    //   902: astore_2
    //   903: goto -749 -> 154
    //   906: astore_0
    ...
    //   912: ifnull +8 -> 920
    //   915: aload 16
    //   917: invokevirtual 473	java/io/FileInputStream:close	()V
    //   920: aload_0
    //   921: athrow
    //   922: astore_2
    //   923: aload_2
    //   924: invokevirtual 559	java/io/IOException:printStackTrace	()V
    //   927: goto -7 -> 920
    //   930: iconst_1
    //   931: istore_1
    //   932: goto -756 -> 176
    ...
    //   940: goto -734 -> 206
    //   943: aload_0
    //   944: invokeinterface 83 1 0
    //   949: ldc_w 540
    //   952: iload_1
    //   953: invokeinterface 89 3 0
    //   958: invokeinterface 92 1 0
    //   963: pop
    //   964: return
    //   965: astore_0
    //   966: goto -56 -> 910
  ...
  public static void a(boolean paramBoolean, long paramLong1, long paramLong2, long paramLong3)
  {
    ...
    StatisticCollector.a(BaseApplication.getContext()).a(null, "actVideoCompressTime", paramBoolean, 0L, 0L, localHashMap, "", false);
    if (QLog.isColorLevel()) {
