  ...
  extends Handler
{
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      return;
      localSendPhotoActivity.a(2131694889);
      return;
      ...
      Logger.a(SendPhotoActivity.jdField_a_of_type_JavaLangString, "CompressLog", "compress startTime = " + localSendPhotoActivity.b + "ns,finishTime = " + l1 + "ns,duration = " + l2 + "ms,count = " + i + ",isShowing = " + bool1);
      StatisticConstants.a(l2, i, bool1);
      Object localObject1 = localSendPhotoActivity.app;
      this.jdField_a_of_type_ComTencentMobileqqActivityPhotoSendPhotoActivity.a((QQAppInterface)localObject1, l1);
