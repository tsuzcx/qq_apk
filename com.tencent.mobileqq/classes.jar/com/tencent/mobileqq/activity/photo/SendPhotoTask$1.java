...
class SendPhotoTask$1
  implements Runnable
{
  SendPhotoTask$1(SendPhotoTask paramSendPhotoTask, abqn paramabqn, ayxx paramayxx, BaseActivity paramBaseActivity) {}
  
  public void run()
  {
    try
    {
      this.jdField_a_of_type_Abqn.a(Long.parseLong(this.jdField_a_of_type_Ayxx.a.c), "", "", "", 0, null);
      DeviceInfo localDeviceInfo = this.jdField_a_of_type_Abqn.a(Long.parseLong(this.jdField_a_of_type_Ayxx.a.c));
      Object localObject = new FileInfo(this.jdField_a_of_type_Ayxx.a.g);
