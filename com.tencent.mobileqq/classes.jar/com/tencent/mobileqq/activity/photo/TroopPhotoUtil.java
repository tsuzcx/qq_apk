...
public class TroopPhotoUtil
{
  ...
  public static int a(String paramString1, String paramString2)
  {
    ...
    //   6: iconst_0
    //   7: istore_2
    //   8: new 64	java/io/FileInputStream
    //   11: dup
    //   12: aload_0
    //   13: invokespecial 67	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   16: astore_0
    //   17: new 69	java/io/FileOutputStream
    //   20: dup
    //   21: aload_1
    //   22: invokespecial 70	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   25: astore 4
    //   27: sipush 8192
    //   30: newarray byte
    //   32: astore_1
    //   33: aload_0
    //   34: aload_1
    //   35: invokevirtual 76	java/io/InputStream:read	([B)I
    //   38: istore_3
    //   39: iload_3
    //   40: ifle +44 -> 84
    //   43: aload 4
    ...
    //   46: iconst_0
    //   47: iload_3
    //   48: invokevirtual 82	java/io/OutputStream:write	([BII)V
    //   51: goto -18 -> 33
    //   54: astore_1
    //   55: aload_0
    //   56: astore_1
    ...
    //   63: ifnull +7 -> 70
    //   66: aload_1
    //   67: invokevirtual 85	java/io/InputStream:close	()V
    //   70: iload_3
    //   71: istore_2
    //   72: aload_0
    //   73: ifnull +9 -> 82
    ...
    //   85: ifnull +7 -> 92
    //   88: aload_0
    //   89: invokevirtual 85	java/io/InputStream:close	()V
    //   92: aload 4
    //   94: ifnull -12 -> 82
    //   97: aload 4
    ...
    //   104: astore_0
    //   105: aload_0
    //   106: invokevirtual 89	java/io/IOException:printStackTrace	()V
    //   109: iconst_0
    //   110: ireturn
    //   111: astore_0
    //   112: aload_0
    ...
    //   119: astore_1
    //   120: aload_1
    //   121: invokevirtual 89	java/io/IOException:printStackTrace	()V
    //   124: goto -54 -> 70
    //   127: astore_0
    //   128: aload_0
    //   129: invokevirtual 89	java/io/IOException:printStackTrace	()V
    //   132: iconst_m1
    //   133: ireturn
    //   134: astore_1
    //   135: aconst_null
    ...
    //   142: ifnull +7 -> 149
    //   145: aload_0
    //   146: invokevirtual 85	java/io/InputStream:close	()V
    //   149: aload 4
    //   151: ifnull +8 -> 159
    //   154: aload 4
    //   156: invokevirtual 86	java/io/OutputStream:close	()V
    //   159: aload_1
    //   160: athrow
    //   161: astore_0
    //   162: aload_0
    //   163: invokevirtual 89	java/io/IOException:printStackTrace	()V
    //   166: goto -17 -> 149
    //   169: astore_0
    //   170: aload_0
  ...
  public static final Point a(Activity paramActivity, int paramInt)
  {
    ...
    for (int i = localDisplayMetrics.widthPixels;; i = localDisplayMetrics.heightPixels) {
      ...
      {
      default: 
        paramInt = i - AIOUtils.a(65.0F, paramActivity.getResources());
  ...
  {
    if (paramInt == 0) {
      return paramContext.getString(2131719066);
    }
    if (paramInt == 1) {
      return paramContext.getString(2131696071);
    }
    if (paramInt == 2) {
      return paramContext.getString(2131696070);
    }
    if (paramInt == 3) {
      return paramContext.getString(2131696072);
    }
    if (paramInt == 5) {
      return paramContext.getString(2131696069);
    }
    if (paramInt == 100) {
      return paramContext.getString(2131696053);
    }
    if (paramInt == 101) {
      return paramContext.getString(2131696054);
    }
    if (paramInt == 102) {
      return paramContext.getString(2131696051);
    }
    if (paramInt == 103) {
      return paramContext.getString(2131696055);
    }
    if (paramInt == 1793) {
      return paramContext.getString(2131693400);
    }
    return paramContext.getString(2131696068);
  }
  
  public static String a(List<AvatarInfo> paramList, TroopInfo paramTroopInfo)
  {
  ...
  public static void a(int paramInt, String paramString1, String paramString2)
  {
    ...
    URL localURL = a(localITroopAvatarUtilApi.getArtWork(localITroopAvatarUtilApi.getAvatarAddress(str, paramString2, 1)));
    if (localURL != null)
    {
    ...
    paramString2 = a(localITroopAvatarUtilApi.getThumbPhoto(localITroopAvatarUtilApi.getAvatarAddress(str, paramString2, 1)));
  ...
  public static final void a(Rect paramRect, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      if ((paramString.length == 4) && (PortalUtils.a(paramString[0])) && (PortalUtils.a(paramString[1])) && (PortalUtils.a(paramString[2])) && (PortalUtils.a(paramString[3])))
      {
  ...
  public static int b(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        int i = TroopUtils.a(paramString1);
        paramString1 = (String)localObject;
        if (i != 0) {
          paramString1 = ImageUtil.b((Bitmap)localObject, i);
        }
        if (paramString1 != null)
        {
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.photo.TroopPhotoUtil
