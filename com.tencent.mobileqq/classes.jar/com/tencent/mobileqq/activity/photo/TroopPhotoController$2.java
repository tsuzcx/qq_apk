...
public class TroopPhotoController$2
  implements Runnable
{
  public TroopPhotoController$2(akgq paramakgq, bfuo parambfuo, akeh paramakeh, int paramInt) {}
  
  public void run()
  {
    int i = this.jdField_a_of_type_Bfuo.c;
    this.jdField_a_of_type_Akeh.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Akeh.b = 1;
    this.jdField_a_of_type_Akeh.c = false;
    this.this$0.c(this.jdField_a_of_type_Akeh);
    i &= 0x7FFFFFFF;
    if ((i < 0) || (i > 1)) {
      this.this$0.a(this.jdField_a_of_type_Int, this.jdField_a_of_type_Akeh);
    }
    Iterator localIterator = this.this$0.a.iterator();
    while (localIterator.hasNext())
    {
      TroopClipPic localTroopClipPic = (TroopClipPic)localIterator.next();
      if (localTroopClipPic.ts == this.jdField_a_of_type_Akeh.jdField_a_of_type_Long) {
