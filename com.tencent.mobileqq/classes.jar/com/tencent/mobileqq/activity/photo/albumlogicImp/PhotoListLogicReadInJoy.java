...
public class PhotoListLogicReadInJoy
  extends PhotoListLogicDefault
{
  private boolean a;
  private boolean b;
  
  PhotoListLogicReadInJoy(NewPhotoListActivity paramNewPhotoListActivity)
  {
  ...
  public void a(LocalMediaInfo paramLocalMediaInfo, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.f)
    {
      ...
      PhotoUtils.sendPhoto(this.mActivity, localIntent, this.mPhotoCommonData.selectedPhotoList, 0, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.jdField_a_of_type_Boolean);
      return;
    }
    if (!this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.g)
    {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        AlbumUtil.a(localIntent, this.mPhotoCommonData.albumId, str, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.isRecodeLastAlbumPath);
  ...
  public void caseVideo(View paramView, int paramInt)
  {
    ...
    if (!this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.jdField_b_of_type_Boolean)
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        MediaScanner.getInstance(BaseApplicationImpl.getContext()).queryMediaInfoAsync(new PhotoListLogicReadInJoy.1(this, paramView, (ArrayList)localObject2), (LocalMediaInfo)localObject1);
        return;
      }
    ...
    if (!this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.isSingleMode)
    {
      ...
      ((Intent)localObject1).putExtra("PhotoConst.SHOW_MAGIC_USE_PASTER", this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.e);
      ((Intent)localObject1).putExtra("PasterConstants.paster_id", this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.jdField_a_of_type_JavaLangString);
      ((Intent)localObject1).putExtra("PasterConstants.paster_cate_id", this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.jdField_b_of_type_JavaLangString);
      ...
      ((Intent)localObject1).putExtra("PasterConstants.pasters_data", this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.jdField_b_of_type_JavaUtilHashMap);
  ...
  public void initData(Intent paramIntent)
  {
    ...
    ((PhotoOtherData)this.mOtherCommonData).a(this.jdField_b_of_type_Boolean, this.mPhotoCommonData);
    if (((PhotoOtherData)this.mOtherCommonData).a())
    {
  ...
  public void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    PhotoUtils.onSendResult(this.mActivity, paramInt1, paramInt2, paramIntent, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.h, this.mPhotoCommonData.myUin);
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.photo.albumlogicImp.PhotoListLogicReadInJoy
