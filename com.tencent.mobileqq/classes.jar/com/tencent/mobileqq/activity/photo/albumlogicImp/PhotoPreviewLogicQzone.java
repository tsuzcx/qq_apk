...
import com.tencent.mobileqq.activity.photo.album.PhotoPreviewLogicDefault.IslideShowActionListenerCallback;
...
public class PhotoPreviewLogicQzone
  extends PhotoPreviewLogicDefault
  implements PhotoPreviewLogicDefault.IslideShowActionListenerCallback
{
  ...
  protected PhotoPreviewLogicQzone(NewPhotoPreviewActivity paramNewPhotoPreviewActivity)
  {
  ...
  public void a_(SlideItemInfo paramSlideItemInfo)
  {
    ...
    if (i < this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoPreviewData.paths.size()) {
      if (!((String)this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoPreviewData.paths.get(i)).equals(paramSlideItemInfo.b)) {}
    }
    for (;;)
    {
      if ((i >= 0) && (i < this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoPreviewData.paths.size()) && (this.jdField_a_of_type_JavaUtilHashMap != null)) {
        this.jdField_a_of_type_JavaUtilHashMap.remove(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoPreviewData.paths.get(i));
      }
      return;
      i += 1;
      break;
  ...
  public void ak_()
  {
    ...
    if (i != -1)
    {
      String str = (String)this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoPreviewData.paths.get(i);
      if (this.c)
      {
  ...
  public void d()
  {
    ...
    if ((this.c) && (this.mPhotoCommonData.selectedPhotoList != null) && (this.mPhotoCommonData.selectedPhotoList.isEmpty()) && (((ArrayList)localObject1).size() == 1))
    {
      ...
      if ((((NewPhotoPreviewActivity)this.mActivity).getMediaType((String)localObject2) == 1) && (!AlbumUtil.a(this.mActivity, b(), (LocalMediaInfo)localObject3, this.e)))
      {
    ...
    {
      StatisticConstants.a(((ArrayList)localObject1).size(), this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoPreviewData.totalPicCount);
      StatisticConstants.a(((NewPhotoPreviewActivity)this.mActivity).getIntent(), ((ArrayList)localObject1).size(), this.mPhotoCommonData.currentQualityType);
    }
    Intent localIntent = ((NewPhotoPreviewActivity)this.mActivity).getIntent();
    if (localObject1 != null) {
      NewFlowCameraReporter.a((List)localObject1);
    }
    if ((this.c) || (((PhotoOtherData)this.mOtherCommonData).a()))
    {
  ...
  public void initData(Intent paramIntent)
  {
    ...
    ((PhotoOtherData)this.mOtherCommonData).a(this.b, this.mPhotoCommonData);
  ...
  public void onMagicStickClick(View paramView, int paramInt1, Bundle paramBundle, int paramInt2, Intent paramIntent)
  {
    ...
    label609:
    for (paramView = (LocalMediaInfo)this.mPhotoCommonData.selectedMediaInfoHashMap.get(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoPreviewData.a);; paramView = null)
    {
      if ((this.jdField_a_of_type_Boolean) && (AlbumUtil.getMediaType(paramView) == 1) && (this.c) && (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoPreviewData.c))
      {
        ...
        paramBundle.putExtra("file_send_path", this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoPreviewData.a);
      ...
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoPreviewData.c)
        {
          ...
          paramBundle.putStringArrayListExtra("PhotoConst.SELECTED_PATHS", this.mPhotoCommonData.selectedPhotoList);
          ...
          if (this.c) {
            paramView = QzoneEditPictureActivity.a(this.mActivity, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoPreviewData.a);
          } else {
            paramView = EditPicActivity.a(this.mActivity, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoPreviewData.a, true, true, true, true, true, 3, 99, 4, paramView);
          }
        }
        else
        {
  ...
  public void onSelectClick(View paramView)
  {
    ...
    if (i != -1) {}
    for (String str = (String)this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoPreviewData.paths.get(i);; str = "")
    {
      LocalMediaInfo localLocalMediaInfo = ((NewPhotoPreviewActivity)this.mActivity).getMediaInfo(str);
      if ((this.c) && (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoPreviewData.paths != null) && (((NewPhotoPreviewActivity)this.mActivity).getMediaType(str) == 1) && (!AlbumUtil.a(this.mActivity, b(), localLocalMediaInfo, ((PhotoOtherData)this.mOtherCommonData).a())))
      {
      ...
      str = (String)this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoPreviewData.paths.get(i);
      if ((!this.c) && (!((PhotoOtherData)this.mOtherCommonData).a())) {
        break;
      }
      if (this.mPhotoCommonData.selectedMediaInfoHashMap == null) {
  ...
  public void updateButton()
  {
    ...
    {
      localObject = ((NewPhotoPreviewActivity)this.mActivity).getString(2131699266);
      if (this.jdField_a_of_type_Int == 1) {
        localObject = ((NewPhotoPreviewActivity)this.mActivity).getString(2131694875);
      }
    ...
    for (;;)
    {
      ...
      else if (this.jdField_a_of_type_Boolean)
      {
        ...
        if ((this.c) && (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoPreviewData.paths != null)) {
      ...
      for (boolean bool1 = bool2;; bool1 = false)
      {
        ...
        c();
        return;
        localObject = ((NewPhotoPreviewActivity)this.mActivity).getString(2131694852);
        break;
        bool1 = false;
        break label132;
      }
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.photo.albumlogicImp.PhotoPreviewLogicQzone
