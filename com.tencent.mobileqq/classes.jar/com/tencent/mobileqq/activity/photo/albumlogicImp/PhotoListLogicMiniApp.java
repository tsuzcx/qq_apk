...
public class PhotoListLogicMiniApp
  extends PhotoListLogicDefault
{
  private int jdField_a_of_type_Int = 0;
  private boolean jdField_a_of_type_Boolean = false;
  
  PhotoListLogicMiniApp(NewPhotoListActivity paramNewPhotoListActivity)
  {
  ...
  {
    PhotoUtils.getTypeforReportSpcialDiscuss(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
    ...
    while (i1 < paramArrayList.size())
    {
      ...
      {
        m = ((PhotoOtherData)this.mOtherCommonData).a(this.mPhotoCommonData, (String)localObject);
  ...
  public void caseVideo(View paramView, int paramInt)
  {
    ...
    {
      paramView = DialogUtil.a(this.mActivity, "请选择不超过" + (float)this.mPhotoCommonData.videoSizeLimit / 1024.0F / 1024.0F / 1024.0F + "G的视频");
    ...
    {
      paramView = DialogUtil.a(this.mActivity, "请选择不超过" + this.mPhotoCommonData.videoDurationLimit / 60L / 1000L + "分钟的视频");
      paramView.setPositiveButton(2131694615, new DialogUtil.DialogOnClickAdapter());
      paramView.show();
      return;
    }
  ...
  public String getExceedMaxSelectNumStr(LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    if (this.mPhotoCommonData.showMediaType == 6) {
      return ((NewPhotoListActivity)this.mActivity).getResources().getString(2131694868, new Object[] { Integer.valueOf(i) });
    }
    if (this.mPhotoCommonData.showMediaType == 2) {
      return ((NewPhotoListActivity)this.mActivity).getResources().getString(2131694872, new Object[] { Integer.valueOf(i) });
    }
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.photo.albumlogicImp.PhotoListLogicMiniApp
