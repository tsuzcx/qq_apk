...
public class SDKAvatarSettingManager
{
  ...
  private void b(String paramString)
  {
    ...
    {
      i = ProfileCardUtil.b(this.jdField_a_of_type_AndroidAppActivity);
      localIntent = new Intent();
      localIntent.setFlags(603979776);
      localIntent.putExtra("Business_Origin", 100);
      localIntent.putExtra("FROM_WHERE", "FROM_SDK_AVATAR_SET_IMAGE");
      PhotoUtils.startPhotoEditForResult(localIntent, this.jdField_a_of_type_AndroidAppActivity, FriendProfileCardActivity.class.getName(), i, i, 1080, 1080, paramString, FaceUtil.a(), 1035);
  ...
  private void g()
  {
    String str = this.jdField_a_of_type_AndroidAppActivity.getString(2131719148) + this.jdField_b_of_type_JavaLangString;
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        try
        {
          Object localObject1 = DialogUtil.a(this.jdField_a_of_type_AndroidAppActivity, 230);
          ((QQCustomDialog)localObject1).setMessage(HardCodeUtil.a(2131713546));
          ((QQCustomDialog)localObject1).setNegativeButton(2131690800, new SDKAvatarSettingManager.1(this));
    ...
    DoraemonOpenAPI.a(this.jdField_a_of_type_AndroidAppActivity, 1, this.jdField_d_of_type_JavaLangString, (Bundle)localObject3).a("sdk_avatar_edit", null, new SDKAvatarSettingManager.2(this, str));
  }
  ...
  private void h()
  {
    ...
    if (localOpenID == null)
    {
      ...
      try
      {
        ...
        localQQAppInterface.getMsgHandler().a(l, this.e, Long.valueOf(this.jdField_d_of_type_JavaLangString).longValue(), new SDKAvatarSettingManager.3(this));
        return;
      }
  ...
  void a(String paramString)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setTitle(HardCodeUtil.a(2131713548));
    Object localObject = this.jdField_a_of_type_AndroidAppActivity.getString(2131719148);
    String str = this.jdField_a_of_type_AndroidAppActivity.getString(2131719149);
    if (paramString != null) {}
    for (paramString = (String)localObject + paramString;; paramString = (String)localObject)
    {
      localObject = new SDKAvatarSettingManager.6(this, (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime());
  ...
  protected void e()
  {
    ...
    this.jdField_b_of_type_ComTencentMobileqqUtilsQQCustomDialog = DialogUtil.a(this.jdField_a_of_type_AndroidAppActivity, 230);
    this.jdField_b_of_type_ComTencentMobileqqUtilsQQCustomDialog.setMessage(HardCodeUtil.a(2131713547));
    this.jdField_b_of_type_ComTencentMobileqqUtilsQQCustomDialog.setTitle(2131692187);
    SDKAvatarSettingManager.8 local8 = new SDKAvatarSettingManager.8(this);
    this.jdField_b_of_type_ComTencentMobileqqUtilsQQCustomDialog.setNegativeButton(2131690800, local8);
    this.jdField_b_of_type_ComTencentMobileqqUtilsQQCustomDialog.setPositiveButton(2131719158, local8);
    this.jdField_b_of_type_ComTencentMobileqqUtilsQQCustomDialog.show();
  }
