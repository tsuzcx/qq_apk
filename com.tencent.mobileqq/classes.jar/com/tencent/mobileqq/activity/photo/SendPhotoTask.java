  ...
  implements Runnable
{
  ...
  {
    return aunj.a(paramInt, paramIntent);
  }
  ...
  {
    return bgkh.a(paramCompressInfo.jdField_e_of_type_JavaLangString);
  }
  ...
  protected void a(aunt paramaunt, QQAppInterface paramQQAppInterface)
  {
    aunj.a(paramaunt, paramQQAppInterface);
  }
  
  protected void a(BaseActivity paramBaseActivity, aunt paramaunt)
  {
    boolean bool1 = false;
    int i = -1;
    ...
    {
      return;
      if ((paramaunt != null) && (paramaunt.jdField_a_of_type_Auob != null)) {
        break;
      }
    } while (!QLog.isColorLevel());
    QLog.d("SendPhotoTask", 2, "sendPhoto,sendReq is null,return!");
    return;
    a(paramBaseActivity.app, this.jdField_a_of_type_JavaLangString, paramaunt.jdField_a_of_type_Auob.jdField_g_of_type_JavaLangString);
    if (paramaunt.jdField_a_of_type_Auob.jdField_b_of_type_Int == 9501)
    {
      b(paramBaseActivity, paramaunt);
      return;
    }
    Object localObject;
    int j;
    if ((paramaunt.jdField_a_of_type_Auob.jdField_b_of_type_Int == 9500) && ((paramaunt.jdField_a_of_type_Int == 2) || (paramaunt.jdField_a_of_type_Int == 4)))
    {
      ...
      ((Intent)localObject).putExtra("uin", paramaunt.jdField_a_of_type_Auob.c);
      ((Intent)localObject).putExtra("key_confess_topicid", paramaunt.jdField_a_of_type_Auob.o);
      ArrayList localArrayList = new ArrayList();
      localArrayList.add(paramaunt.jdField_a_of_type_Auob.jdField_g_of_type_JavaLangString);
      ...
      j = ((Intent)localObject).getIntExtra(bbbi.h, -1);
      if ((j != 80) && (j != 82)) {
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramaunt.jdField_a_of_type_Auob == null) {
          break;
        }
        j = this.jdField_b_of_type_Int;
        if (paramaunt.jdField_a_of_type_Auob.h == 2) {
          bool1 = true;
        }
        agqf.a((String[])localObject, j, bool1, bool2, i, paramBaseActivity.app);
        return;
      }
      ...
      a(paramaunt, paramBaseActivity.app);
    }
  }
  ...
  protected void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    ((awan)paramQQAppInterface.getManager(326)).a(paramString1, paramString2);
  }
  ...
  {
    balh.a(((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).app, this.jdField_a_of_type_JavaLangString, ((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).app.c(), paramList, this.jdField_b_of_type_Long);
  }
  ...
  protected boolean a(aunt paramaunt, auob paramauob)
  {
    if (!paramaunt.a(paramauob))
    {
  ...
  protected boolean a(auob paramauob)
  {
    ...
    a(localCompressInfo);
    paramauob.jdField_g_of_type_JavaLangString = localCompressInfo.jdField_e_of_type_JavaLangString;
    if (QLog.isColorLevel()) {
      QLog.d("SendPhotoTask", 2, "sendPhotoTask,  compress finish, upInfo.localPath = " + paramauob.jdField_g_of_type_JavaLangString);
    }
    ...
    try
    {
      paramauob.jdField_a_of_type_JavaUtilArrayList = a(localCompressInfo);
      if ((paramauob.jdField_a_of_type_JavaUtilArrayList != null) && (QLog.isColorLevel())) {
        QLog.d("peak_pgjpeg", 2, "@SendPhotoActivity.sendPhotoTask:" + paramauob.jdField_a_of_type_JavaUtilArrayList.toString());
      }
      bben.a("peak_pgjpeg", "@PeakUtils.getSliceInfos(" + localCompressInfo.jdField_e_of_type_JavaLangString + ")");
      this.jdField_c_of_type_JavaUtilArrayList.add(localCompressInfo);
      if (localCompressInfo.jdField_e_of_type_Boolean)
      {
        paramauob.jdField_g_of_type_Int = 1;
        aune.a(paramauob, "fixProtocolType", "sendReq.upInfo.protocolType");
        return true;
      }
    }
    catch (OutOfMemoryError localOutOfMemoryError)
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.w("peak_pgjpeg", 2, "@OutOfMemoryError occurred in PeakUtils.getSliceInfos， " + localCompressInfo.jdField_e_of_type_JavaLangString + "'s size is " + bbdj.a(localCompressInfo.jdField_e_of_type_JavaLangString));
        }
      }
    }
    catch (ArrayIndexOutOfBoundsException localArrayIndexOutOfBoundsException)
    {
      ...
      paramauob.jdField_g_of_type_Int = paramauob.a();
    }
    return true;
  }
  ...
  protected boolean a(String paramString, int paramInt)
  {
    ...
    aunt localaunt = aunj.a(2, this.jdField_a_of_type_Int);
    localaunt.jdField_c_of_type_Int = this.jdField_a_of_type_AndroidContentIntent.getIntExtra("KEY_MSG_FORWARD_ID", -1);
    auob localauob = aunj.a(this.jdField_a_of_type_Int, this.jdField_a_of_type_AndroidContentIntent);
    if (!a(localaunt, localauob)) {}
    do
    {
      return false;
    ...
    for (;;)
    {
      a((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get(), localaunt);
      this.jdField_b_of_type_Long = localauob.jdField_a_of_type_Long;
      return true;
      localauob.jdField_g_of_type_JavaLangString = paramString;
    }
  }
  ...
  protected boolean a(String paramString, Parcelable paramParcelable)
  {
    ...
    paramString = aunj.a(2, 1045);
    paramParcelable = aunj.a(1045, this.jdField_a_of_type_AndroidContentIntent);
  ...
  {
    paramIntent = new aigy((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get(), paramIntent);
    paramIntent.a();
    paramIntent.a();
  }
  
  protected void b(BaseActivity paramBaseActivity, aunt paramaunt)
  {
    Object localObject = (yak)paramBaseActivity.app.a(51);
    if ((((yak)localObject).c(Long.parseLong(paramaunt.jdField_a_of_type_Auob.c))) && (((yak)localObject).a(Long.parseLong(paramaunt.jdField_a_of_type_Auob.c), 17))) {}
    for (boolean bool = true; !Boolean.valueOf(bool).booleanValue(); bool = false)
    {
      localObject = new ArrayList();
      ((ArrayList)localObject).add(paramaunt.jdField_a_of_type_Auob.jdField_g_of_type_JavaLangString);
      ((yeu)paramBaseActivity.app.a(49)).a().a(yeu.d, paramaunt.jdField_a_of_type_Auob.c, (List)localObject);
      return;
    }
    paramBaseActivity.runOnUiThread(new SendPhotoTask.1(this, (yak)localObject, paramaunt, paramBaseActivity));
  }
  
  protected boolean b(String paramString)
  {
    return bgkh.a(paramString);
  }
  ...
  public void run()
  {
    ...
    if (this.jdField_a_of_type_Long > 0L) {
      axrl.a(BaseApplication.getContext()).a(null, "actSendPhotoIdleCost", false, this.jdField_a_of_type_Long, 0L, null, "");
    }
    if (QLog.isColorLevel()) {
    ...
    if ((this.jdField_b_of_type_JavaUtilArrayList != null) && (!this.jdField_b_of_type_JavaUtilArrayList.isEmpty())) {
      bbjb.a(((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).app, this.jdField_b_of_type_JavaUtilArrayList, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_Int);
    }
    ...
    do
    {
      ...
      aune.b("PIC_TAG_COST", "launch req ", "time cost:" + (System.currentTimeMillis() - l));
