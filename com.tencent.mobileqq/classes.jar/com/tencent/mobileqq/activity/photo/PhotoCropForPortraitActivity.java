  ...
  extends PhotoCropActivity
{
  ...
  {
    boolean bool = true;
    Object localObject = (RelativeLayout)findViewById(2131297793);
    if (localObject == null) {
      return;
    }
    ViewGroup localViewGroup = (ViewGroup)LayoutInflater.from(this).inflate(2131493812, null);
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-2, -2);
    localLayoutParams.addRule(9);
    localLayoutParams.addRule(12);
    localLayoutParams.bottomMargin = aciy.a(20.0F, getResources());
    ((RelativeLayout)localObject).addView(localViewGroup, localLayoutParams);
    int i = baig.ad(this, getCurrentAccountUin());
    if (i == -1)
    {
      try
      {
    ...
    for (;;)
    {
      this.jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)findViewById(2131310963));
      if (i != 0) {}
      for (;;)
      {
        this.d = bool;
        this.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(this.d);
        localViewGroup.setOnClickListener(new agbb(this));
        return;
        this.i = 3;
        break;
        bool = false;
  ...
  void a(String paramString, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    localObject = ((ajjj)localObject).a(str);
    if ((localObject != null) && (((ExtensionInfo)localObject).isPendantValid()) && (this.e)) {
      this.jdField_a_of_type_AndroidOsHandler = new agba(this, (ExtensionInfo)localObject, str);
    }
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      {
        this.c = ((Button)super.findViewById(2131301288));
        this.c.setVisibility(0);
        this.c.setOnClickListener(new agaz(this));
      }
      return bool;
