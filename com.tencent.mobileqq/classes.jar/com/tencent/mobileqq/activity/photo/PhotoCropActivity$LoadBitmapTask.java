  ...
  extends AsyncTask<Void, Void, Bitmap>
{
  ...
  protected Bitmap a(Void... paramVarArgs)
  {
    try
    {
      ...
      for (paramVarArgs = Bitmap.Config.ARGB_8888;; paramVarArgs = Bitmap.Config.RGB_565)
      {
        ...
        localOptions.inSampleSize = TroopPhotoUtil.a(localOptions, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoCropActivity.g, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoCropActivity.g);
  ...
  protected void a(Bitmap paramBitmap)
  {
    ...
    if (this.jdField_a_of_type_Int == 1) {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoCropActivity, HardCodeUtil.a(2131708048), 0).a();
    }
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Int == 2) {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoCropActivity, HardCodeUtil.a(2131708049), 0).a();
      } else {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoCropActivity, HardCodeUtil.a(2131708047), 0).a();
      }
    }
  }
}
