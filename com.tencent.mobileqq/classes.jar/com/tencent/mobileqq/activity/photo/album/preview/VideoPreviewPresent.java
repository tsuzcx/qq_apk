  ...
  implements VideoPlayerCallback
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    paramView = ((LayoutInflater)((Context)localObject).getSystemService("layout_inflater")).inflate(2131561366, null);
    paramView.setTag(2131296400, Boolean.valueOf(true));
    paramView.setLayoutParams(new Gallery.LayoutParams(-1, -1));
    this.mCover = ((ImageView)paramView.findViewById(2131372848));
    this.mCenterPlayBtn = ((ImageView)paramView.findViewById(2131372847));
    this.mVideoLayout = ((FrameLayout)paramView.findViewById(2131372850));
