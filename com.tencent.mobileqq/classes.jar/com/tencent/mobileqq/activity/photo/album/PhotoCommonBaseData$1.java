...
class PhotoCommonBaseData$1
  implements ICursor.FilterListener
{
  PhotoCommonBaseData$1(PhotoCommonBaseData paramPhotoCommonBaseData) {}
  ...
  public boolean needMediaInfo(LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    if (this.this$0.filter != null)
    {
      ...
      else if ((paramLocalMediaInfo.mMediaType == 1) && (this.this$0.filter.videoMaxDuration > 0L) && (paramLocalMediaInfo.mDuration > this.this$0.filter.videoMaxDuration))
      {
        return false;
      }
    }
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.photo.album.PhotoCommonBaseData.1
