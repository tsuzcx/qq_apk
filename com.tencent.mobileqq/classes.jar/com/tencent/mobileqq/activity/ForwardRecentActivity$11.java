...
class ForwardRecentActivity$11
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    if (i == 2131432634)
    {
      ForwardRecentActivity.access$1200(this.a, 10);
      ReportController.b(this.a.app, "CliOper", "", "", "friendchoose", "0X8009D91", ForwardRecentActivity.access$1000(this.a), 0, "", "", "", "");
    }
    else if (i == 2131436211)
    {
      if (this.a.mOnlySingleSelection)
      {
        ...
        ForwardRecentActivity.access$1300(this.a);
        this.a.finish();
        ReportController.b(this.a.app, "CliOper", "", "", "friendchoose", "0X8009D8F", ForwardRecentActivity.access$1000(this.a), 0, "", "", "", "");
      ...
      else if (ForwardRecentActivity.access$400(this.a))
      {
        ...
        ReportController.b(this.a.app, "CliOper", "", "", "friendchoose", "0X8009D98", ForwardRecentActivity.access$1000(this.a), 0, "", "", "", ForwardRecentActivity.access$1500(this.a));
      }
      else
      {
        ForwardRecentActivity.access$1600(this.a);
        ReportController.b(this.a.app, "CliOper", "", "", "friendchoose", "0X8009D93", ForwardRecentActivity.access$1000(this.a), 0, "", "", "", ForwardRecentActivity.access$1500(this.a));
      }
    }
    else
    {
      if (i == 2131436182) {
        ...
        {
          ForwardRecentActivity.access$1700(this.a);
          ReportController.b(this.a.app, "CliOper", "", "", "friendchoose", "0X8009D94", ForwardRecentActivity.access$1000(this.a), 0, "", "", "", "");
        }
        else
        {
          if (this.a.mForwardOption != null)
      ...
      Object localObject2 = this.a.mForwardOption.al();
      ...
      ((Intent)localObject1).putExtras(this.a.mForwardOption.al());
      ...
      default: 
        break;
      case 2131433627: 
        ForwardRecentActivity.access$500(this.a, (Intent)localObject1);
        if (this.a.mOnlySingleSelection)
        {
          this.a.reportDataForBusiness("0X8007825");
          ((Intent)localObject1).setClass(this.a, TroopActivity.class);
          if (!this.a.mForwardOption.a(ForwardAbility.ForwardAbilityType.e))
          {
          ...
          else if (!this.a.mForwardOption.a(ForwardAbility.ForwardAbilityType.d))
          {
            ((Intent)localObject1).putExtra("onlyOneSegement", true);
        ...
        {
          ((Intent)localObject1).putParcelableArrayListExtra("selected_target_list", new ArrayList(ForwardRecentActivity.access$600(this.a).values()));
          ...
          ReportController.b(this.a.app, "CliOper", "", "", "friendchoose", "0X8009D96", ForwardRecentActivity.access$1000(this.a), 0, "", "", "", "");
        }
        break;
      case 2131433623: 
        localObject1 = new ForwardRecentActivity.11.1(this, (Intent)localObject1);
      ...
      case 2131433622: 
        ...
        if (this.a.mForwardOption.a(ForwardAbility.ForwardAbilityType.c)) {
          i = 1;
        }
        localObject1 = new Intent();
        ((Intent)localObject1).putExtra("param_type", 3000);
        ((Intent)localObject1).putExtra("param_subtype", 0);
        ((Intent)localObject1).putExtra("param_done_button_wording", this.a.getString(2131916211));
        ((Intent)localObject1).putExtra("param_done_button_highlight_wording", this.a.getString(2131916212));
        ...
        ReportController.b(this.a.app, "CliOper", "", "", "friendchoose", "0X8009D92", ForwardRecentActivity.access$1000(this.a), 0, "", "", "", "");
        break;
      case 2131433620: 
        ForwardRecentActivity.access$500(this.a, (Intent)localObject1);
        ((Intent)localObject1).putExtra("is_multi_selection", ForwardRecentActivity.access$400(this.a));
        ((Intent)localObject1).putParcelableArrayListExtra("selected_target_list", new ArrayList(ForwardRecentActivity.access$600(this.a).values()));
        ((Intent)localObject1).putExtra("only_single_selection", this.a.mOnlySingleSelection);
        QPublicFragmentActivity.startForResult(this.a.getActivity(), (Intent)localObject1, QQGuildForwardGuildListFragment.class, 20000);
        break;
      case 2131433619: 
        ...
        ReportController.b(this.a.app, "CliOper", "", "", "friendchoose", "0X8009D95", ForwardRecentActivity.access$1000(this.a), 0, "", "", "", "");
