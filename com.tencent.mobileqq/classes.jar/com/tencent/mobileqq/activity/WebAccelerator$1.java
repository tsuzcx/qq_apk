  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    Object localObject2 = acgk.a();
    int i;
    if (acgk.c(this.jdField_a_of_type_JavaLangString))
    {
      localObject1 = ((acgk)localObject2).a(this.jdField_a_of_type_JavaLangString);
    ...
    for (;;)
    {
      if ((!acgk.a(this.jdField_a_of_type_AndroidContentContext)) && (((acgk)localObject2).a((String)localObject1))) {
        this.jdField_a_of_type_AndroidContentIntent.putExtra("key_isReadModeEnabled", false);
      }
      for (int j = 1;; j = 0)
      {
        localObject1 = (Long)acgk.a((acgk)localObject2).remove(this.jdField_a_of_type_JavaLangString);
        if ((localObject1 != null) && (SystemClock.uptimeMillis() - ((Long)localObject1).longValue() < 180000L))
        {
          ((acgk)localObject2).a("bank_download_key");
          localObject1 = new HashMap();
          ((HashMap)localObject1).put("count", "1");
          awrn.a(BaseApplication.getContext()).a(null, "AIOWebPreDownloadHit", false, 0L, 0L, (HashMap)localObject1, "", false);
        }
        if ((j != 0) || (i != 0))
        {
          ((acgk)localObject2).a("bankSize");
          localObject1 = acgk.a().a();
        ...
        if (!acgk.b(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_AndroidContentIntent)) {
