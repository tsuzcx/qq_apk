  ...
  extends RecyclerView.Adapter<NewFriendEntryMultiHeadsAdapter.ViewHolder>
{
  ...
  {
    return new NewFriendEntryMultiHeadsAdapter.ViewHolder(this, LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()).inflate(2131559979, null));
  }
  ...
  public void a(NewFriendEntryMultiHeadsAdapter.ViewHolder paramViewHolder, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (!(localObject instanceof ContactMatchMessage)) {
        break;
      }
