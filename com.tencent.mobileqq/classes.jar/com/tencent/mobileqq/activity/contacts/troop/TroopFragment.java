  ...
  implements View.OnClickListener
{
  ...
  {
    this.jdField_a_of_type_Anif = new ajmi(this);
    this.jdField_a_of_type_Anhl = new ajmj(this);
  }
  ...
  public View a(LayoutInflater paramLayoutInflater, Bundle paramBundle)
  {
    ...
    if (this.jdField_a_of_type_ComTencentWidgetSwipPinnedHeaderExpandableListView == null)
    {
      ...
      this.jdField_a_of_type_ComTencentWidgetSwipPinnedHeaderExpandableListView.setId(2131373744);
    ...
    for (;;)
    {
      this.jdField_a_of_type_Bfyf = new bfyf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, null, "Grp_time", "Grp_contactlist", "visit_time");
      return this.jdField_a_of_type_ComTencentWidgetSwipPinnedHeaderExpandableListView;
  ...
  public void a(boolean paramBoolean)
  {
    ...
    new bcsy(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_listNew").c("Grp_contactlist").d("exp").a();
  }
  ...
  public void d()
  {
    if (this.b)
    {
      if (this.jdField_a_of_type_Ajmk == null) {
        this.jdField_a_of_type_Ajmk = new ajmk(this);
      }
      if (this.jdField_a_of_type_Ajmm == null) {
        this.jdField_a_of_type_Ajmm = new ajmm(this);
      }
      if (this.jdField_a_of_type_Ajml == null) {
        this.jdField_a_of_type_Ajml = new ajml(this);
      }
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Ajmk);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Ajmm);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Ajml);
  ...
  public void e()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Ajmk);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Ajmm);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Ajml);
