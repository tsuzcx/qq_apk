  ...
  extends View
{
  ...
  private ahve jdField_a_of_type_Ahve;
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Ahve != null) {
        this.jdField_a_of_type_Ahve.c(false);
      }
      invalidate();
      return true;
      if (k != i)
      {
        if ((this.jdField_a_of_type_ArrayOfJavaLangString != null) && (i >= 0) && (i < this.jdField_a_of_type_ArrayOfJavaLangString.length))
        {
          ...
          if (this.jdField_a_of_type_Ahve != null)
          {
            ...
            this.jdField_a_of_type_Ahve.a(this.jdField_a_of_type_ArrayOfJavaLangString[i], j, f1 - f2);
          }
        }
        invalidate();
      }
    ...
    if (this.jdField_a_of_type_Ahve != null) {
      this.jdField_a_of_type_Ahve.c(true);
    }
    invalidate();
    return true;
  }
  ...
  public void setOnIndexBarTouchListener(ahve paramahve)
  {
