  ...
  implements aiep, avsz
{
  ...
  {
    this.jdField_a_of_type_Aiqj = new aiqj(this, null);
    this.jdField_a_of_type_AndroidOsHandler = new bjng(Looper.getMainLooper(), null);
  ...
  public View a(LayoutInflater paramLayoutInflater, Bundle paramBundle)
  {
    ...
    {
      this.jdField_a_of_type_AndroidViewView = paramLayoutInflater.inflate(2131558966, null, false);
      this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)this.jdField_a_of_type_AndroidViewView.findViewById(2131372419));
      ...
      int i = getResources().getDimensionPixelSize(2131297468);
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Aiqi = new aiqi(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentWidgetXListView, 1, true, this);
      this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Aiqi);
    }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Aiqi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  }
  ...
  public void d()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (this.jdField_b_of_type_Boolean))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.registObserver(this.jdField_a_of_type_Aiqj);
  ...
  public void e()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.unRegistObserver(this.jdField_a_of_type_Aiqj);
    ...
    if (this.jdField_a_of_type_Aiqi != null)
    {
      this.jdField_a_of_type_Aiqi.a();
      this.jdField_a_of_type_Aiqi.c();
      this.jdField_a_of_type_Aiqi = null;
    }
  }
