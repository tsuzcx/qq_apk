  ...
  implements View.OnClickListener, View.OnLongClickListener, SwipPinnedHeaderExpandableListView.SwipListListener
{
  ...
  public ContactsDisAdapter(Context paramContext, QQAppInterface paramQQAppInterface, ExpandableListView paramExpandableListView)
  {
    ...
    this.jdField_a_of_type_ComTencentWidgetSwipTextViewMenuBuilder = new wrh(this, 1, 1, new int[] { paramContext.getResources().getDimensionPixelSize(2131558645) }, -1, new int[] { 2131370018, 2131370018 }, new int[] { 2131429837, 2131429838 }, new int[] { 2130838691, 2130838691 });
  ...
  private void a(BuddyListAdapter.GroupTag paramGroupTag, int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      return;
      str = this.jdField_a_of_type_AndroidContentContext.getString(2131435964);
      i = this.jdField_c_of_type_JavaUtilList.size();
      break;
      str = this.jdField_a_of_type_AndroidContentContext.getString(2131435965);
  ...
  private void g()
  {
    ...
    Object localObject3 = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131433320);
    ...
    Collections.sort(this.jdField_b_of_type_JavaUtilList, new wri(this, (HashMap)localObject1));
  ...
  public View getChildView(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      localObject = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130968945, null);
  ...
  public void onClick(View paramView)
  {
    ...
    {
      paramView = (BaseActivity)this.jdField_a_of_type_AndroidContentContext;
      QQToast.a(paramView, this.jdField_a_of_type_AndroidContentContext.getString(2131429836, new Object[] { String.valueOf(80) }), 0).b(paramView.getTitleBarHeight());
      return;
    }
    ...
    if ((paramView != null) && ((paramView instanceof BuddyListItem.ViewTag)))
    {
      ...
      if (localObject != null)
      {
        ...
        for (;;)
        {
          ...
          paramView.a(new wrj(this, bool, localDiscussionManager, (DiscussionInfo)localObject, paramView));
          try
          {
            paramView.show();
            label118:
