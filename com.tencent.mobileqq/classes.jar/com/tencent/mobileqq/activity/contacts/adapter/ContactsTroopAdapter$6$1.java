  ...
  public void run()
  {
    ...
    if (localObject1 != null)
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        {
          this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0.a((TroopInfo)localObject3, this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.jdField_a_of_type_Akeu);
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0.a((TroopInfo)localObject3, this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.jdField_a_of_type_Akeu);
      i = aida.a(this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.b(((TroopInfo)localObject3).troopuin));
      if (((TroopInfo)localObject3).isQidianPrivateTroop())
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0.g.add(new aidi(i, (atmo)localObject3));
      }
      else
      {
        if (((((TroopInfo)localObject3).dwAdditionalFlag & 1L) == 1L) || ((((TroopInfo)localObject3).troopowneruin != null) && (((TroopInfo)localObject3).troopowneruin.equals(localObject1)))) {
          this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0.c.add(new aidi(i, (atmo)localObject3));
        }
        for (;;)
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0.f.add(new aidi(i, (atmo)localObject3));
          break;
          if ((((TroopInfo)localObject3).dwCmdUinUinFlag & 1L) == 1L) {
            this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0.d.add(new aidi(i, (atmo)localObject3));
          } else {
            this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0.e.add(new aidi(i, (atmo)localObject3));
          }
        }
      }
    }
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      localObject3 = this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.jdField_a_of_type_Akeu.a(((DiscussionInfo)localObject2).uin, 3000);
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c().equals(((DiscussionInfo)localObject2).ownerUin)) {
        this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0.c.add(new aidi(1, (atmo)localObject2));
      }
      for (;;)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0.f.add(new aidi(1, (atmo)localObject2));
        break;
        this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0.e.add(new aidi(1, (atmo)localObject2));
      }
    }
    if (QLog.isColorLevel()) {
    ...
    afdq.b(this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0);
    if (afdq.a(this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0))
    {
      afdq.a(this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0, false);
      afdq.c(this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0);
    }
    for (;;)
    {
      if ((afdq.d(this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0) instanceof PinnedHeaderExpandableListView))
      {
        localObject1 = (PinnedHeaderExpandableListView)afdq.e(this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0);
      ...
      afdq.a(this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0).a(0);
    ...
    if (i < this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0.jdField_a_of_type_JavaUtilList.size())
    {
      ...
      afdq.b(this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0).a(i);
    }
    for (;;)
    {
      i += 1;
      ...
      break;
      label1586:
      afdq.c(this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0).b(i);
    }
  }
}
