  ...
  public void run()
  {
    ...
    if (localObject1 != null)
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        {
          this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0.a((TroopInfo)localObject3, this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.jdField_a_of_type_Amnz);
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0.a((TroopInfo)localObject3, this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.jdField_a_of_type_Amnz);
      i = aklr.a(this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.b(((TroopInfo)localObject3).troopuin));
      if (((TroopInfo)localObject3).isQidianPrivateTroop())
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0.g.add(new aklz(i, (awge)localObject3));
      }
      else
      {
        if (((((TroopInfo)localObject3).dwAdditionalFlag & 1L) == 1L) || ((((TroopInfo)localObject3).troopowneruin != null) && (((TroopInfo)localObject3).troopowneruin.equals(localObject1)))) {
          this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0.c.add(new aklz(i, (awge)localObject3));
        }
        for (;;)
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0.f.add(new aklz(i, (awge)localObject3));
          break;
          if ((((TroopInfo)localObject3).dwCmdUinUinFlag & 1L) == 1L) {
            this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0.d.add(new aklz(i, (awge)localObject3));
          } else {
            this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0.e.add(new aklz(i, (awge)localObject3));
          }
        }
      }
    }
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      localObject3 = this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.jdField_a_of_type_Amnz.a(((DiscussionInfo)localObject2).uin, 3000);
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c().equals(((DiscussionInfo)localObject2).ownerUin)) {
        this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0.c.add(new aklz(1, (awge)localObject2));
      }
      for (;;)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0.f.add(new aklz(1, (awge)localObject2));
        break;
        this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0.e.add(new aklz(1, (awge)localObject2));
      }
    }
    if (QLog.isColorLevel()) {
    ...
    ahrs.b(this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0);
    if (ahrs.a(this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0))
    {
      ahrs.a(this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0, false);
      ahrs.c(this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0);
    }
    for (;;)
    {
      if ((ahrs.d(this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0) instanceof PinnedHeaderExpandableListView))
      {
        localObject1 = (PinnedHeaderExpandableListView)ahrs.e(this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0);
      ...
      ahrs.a(this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0).a(0);
    ...
    if (i < this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0.jdField_a_of_type_JavaUtilList.size())
    {
      ...
      ahrs.b(this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0).a(i);
    }
    for (;;)
    {
      i += 1;
      ...
      break;
      label1586:
      ahrs.c(this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsTroopAdapter$6.this$0).b(i);
    }
  }
}
