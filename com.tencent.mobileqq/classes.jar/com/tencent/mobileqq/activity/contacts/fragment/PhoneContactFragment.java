  ...
  implements alti, aubn
{
  ...
  {
    this.jdField_a_of_type_Ahou = new ahou(this, null);
    this.jdField_a_of_type_AndroidOsHandler = new bhow(Looper.getMainLooper(), null);
  ...
  protected View a(LayoutInflater paramLayoutInflater, Bundle paramBundle)
  {
    ...
    {
      this.jdField_a_of_type_AndroidViewView = paramLayoutInflater.inflate(2131558892, null, false);
      this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)this.jdField_a_of_type_AndroidViewView.findViewById(2131371745));
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Ahnk = new ahnk(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentWidgetXListView, 1, true, this);
      this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Ahnk);
    }
  ...
  public void c()
  {
    ...
    while (this.jdField_a_of_type_Ahnk == null) {
      return;
    }
    this.jdField_a_of_type_Ahnk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  }
  ...
  protected void d()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (this.jdField_b_of_type_Boolean))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.registObserver(this.jdField_a_of_type_Ahou);
  ...
  protected void e()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.unRegistObserver(this.jdField_a_of_type_Ahou);
    ...
    if (this.jdField_a_of_type_Ahnk != null)
    {
      this.jdField_a_of_type_Ahnk.a();
      this.jdField_a_of_type_Ahnk.c();
      this.jdField_a_of_type_Ahnk = null;
    }
  }
