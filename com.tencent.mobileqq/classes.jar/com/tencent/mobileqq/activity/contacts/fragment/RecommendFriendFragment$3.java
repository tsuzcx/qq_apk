  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    label252:
    for (int i = (this.this$0.jdField_a_of_type_AndroidViewView.getMeasuredHeight() - Math.max(this.this$0.b - this.this$0.jdField_a_of_type_Int, 0) - this.this$0.c.getMeasuredHeight()) / 2;; i = actj.a(68.0F, this.this$0.getResources()))
    {
