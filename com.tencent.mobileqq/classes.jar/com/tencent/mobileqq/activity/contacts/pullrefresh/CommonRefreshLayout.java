  ...
  implements ajko
{
  ...
  ajkr jdField_a_of_type_Ajkr = new ajkp(this);
  private ajku jdField_a_of_type_Ajku;
  ...
  public CommonRefreshLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      else if (m == 1)
      {
        ...
        this.l = getResources().getDimensionPixelOffset(2131298748);
        return;
      }
      label362:
      paramInt += 1;
  ...
  {
    if ((ajks.a(this.k)) && (this.jdField_a_of_type_Ajkq != null) && (paramFloat > 0.0F))
    {
      a(3);
    ...
    {
      if ((ajks.h(this.k)) || (ajks.i(this.k)))
      {
        if (paramFloat >= 0.0F) {
          break label266;
        }
      ...
      if (((ajks.a(this.k)) || (ajks.h(this.k))) && (paramFloat > 0.0F) && (d()))
      {
      ...
      if (ajks.c(this.k))
      {
        if ((!ajks.d(this.k)) && (!ajks.e(this.k))) {
          break label282;
        }
    ...
    for (;;)
    {
      ...
      continue;
      label282:
      if ((paramFloat < 0.0F) && (this.jdField_a_of_type_Ajkq != null)) {
        a(2);
      }
    }
  }
  ...
  private void c(float paramFloat)
  {
    ...
    if (ajks.c(this.k))
    {
      ...
      this.jdField_a_of_type_Ajkr.a(m, false, false);
    }
    d(f1);
  }
  ...
  private void d(float paramFloat)
  {
    ...
    if ((ajks.c(this.k)) || (ajks.f(this.k))) {
      this.h = this.i;
    }
    g();
    requestLayout();
  ...
  private boolean d()
  {
    return (this.jdField_c_of_type_Boolean) && (!ajkx.a(this.jdField_a_of_type_AndroidViewView)) && (this.jdField_a_of_type_Boolean) && (this.jdField_b_of_type_Float > 0.0F);
  }
  ...
  private void i()
  {
    ...
    do
    {
      ...
      if ((ajks.j(this.k)) || (ajks.k(this.k)))
      {
        c();
        return;
      }
    } while ((!ajks.l(this.k)) && (!ajks.i(this.k)));
    d();
  }
  ...
  {
    if (ajks.d(this.k)) {
      this.jdField_a_of_type_Ajkr.a(this.i, false, true);
    }
    for (;;)
    {
      d(paramFloat);
      ...
      if (ajks.e(this.k)) {
        this.jdField_a_of_type_Ajkr.a(this.i, false, true);
      } else if (ajks.b(this.k)) {
        this.jdField_a_of_type_Ajkr.a(this.i, true, true);
      }
    }
  }
  ...
  protected void dispatchDraw(Canvas paramCanvas)
  {
    if (this.jdField_a_of_type_Ajkq != null) {
      this.jdField_a_of_type_Ajkq.onFlingScrollHeader(this.k, -this.i);
    }
  ...
  {
    if (this.jdField_a_of_type_Ajkq != null) {
      this.jdField_a_of_type_Ajkq.onTouchMoving(this, -this.i, paramMotionEvent);
    }
  ...
  protected void onFinishInflate()
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)findViewById(2131378119));
      this.jdField_a_of_type_AndroidViewView = findViewById(2131378120);
    } while ((this.jdField_a_of_type_AndroidViewView == null) || (this.jdField_a_of_type_AndroidViewViewGroup == null) || (!(this.jdField_a_of_type_AndroidViewViewGroup instanceof ajkw)));
  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (int m = this.jdField_a_of_type_ComTencentWidgetListView.getListViewScrollY();; m = 0)
    {
      ...
      for (;;)
      {
        ...
        if (((ajks.d(this.k)) || (ajks.e(this.k))) && (m == 0))
        {
          return true;
  ...
  public void setMiniAppScrollListener(ajkq paramajkq)
  {
    this.jdField_a_of_type_Ajkq = paramajkq;
  }
  
  public void setOnRefreshListener(ajku paramajku)
  {
    this.jdField_a_of_type_Ajku = paramajku;
  }
