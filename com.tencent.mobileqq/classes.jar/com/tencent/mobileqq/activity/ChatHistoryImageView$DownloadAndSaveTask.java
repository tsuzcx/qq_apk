  ...
  implements Runnable
{
  ...
  ArrayList<aeiy> jdField_a_of_type_JavaUtilArrayList;
  ...
  public ChatHistoryImageView$DownloadAndSaveTask(ArrayList<aeiy> paramArrayList, boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  public void a(boolean paramBoolean)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      if (!this.e)
      {
        ...
        this.this$0.jdField_a_of_type_Bfob.sendEmptyMessageDelayed(102, (this.jdField_a_of_type_JavaUtilArrayList.size() - this.jdField_a_of_type_Int) * 60000L);
        return;
      }
      this.this$0.jdField_a_of_type_Bfob.removeMessages(102);
    }
  }
  ...
  public void run()
  {
    ...
    //   16: getfield 86	com/tencent/mobileqq/activity/ChatHistoryImageView:jdField_a_of_type_Bfob	Lbfob;
    //   19: bipush 102
    //   21: aload_0
    ...
    //   29: ldc2_w 91
    //   32: lmul
    //   33: invokevirtual 98	bfob:sendEmptyMessageDelayed	(IJ)Z
    //   36: pop
    //   37: iconst_0
    //   38: istore_1
    //   39: iload_1
    ...
    //   61: getfield 86	com/tencent/mobileqq/activity/ChatHistoryImageView:jdField_a_of_type_Bfob	Lbfob;
    //   64: bipush 101
    //   66: invokevirtual 109	bfob:sendEmptyMessage	(I)Z
    //   69: pop
    //   70: return
    //   71: aload_0
    ...
    //   79: checkcast 115	aeiy
    //   82: astore 9
    //   84: ldc 117
    //   86: aload 9
    //   88: getfield 120	aeiy:jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData	Lcom/tencent/mobileqq/activity/aio/photo/AIORichMediaData;
    //   91: invokevirtual 126	java/lang/Class:isInstance	(Ljava/lang/Object;)Z
    //   94: ifeq +167 -> 261
    //   97: aload 9
    //   99: getfield 120	aeiy:jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData	Lcom/tencent/mobileqq/activity/aio/photo/AIORichMediaData;
    ...
    //   139: aload_0
    //   140: aload 9
    //   142: putfield 146	com/tencent/mobileqq/activity/ChatHistoryImageView$DownloadAndSaveTask:jdField_a_of_type_Aeiy	Laeiy;
    //   145: aload 9
    //   147: iconst_1
    //   148: putfield 147	aeiy:jdField_a_of_type_Boolean	Z
    //   151: aload_0
    ...
    //   172: aload_0
    //   173: getfield 146	com/tencent/mobileqq/activity/ChatHistoryImageView$DownloadAndSaveTask:jdField_a_of_type_Aeiy	Laeiy;
    //   176: astore 9
    //   178: aload 9
    //   180: monitorenter
    //   181: aload_0
    //   182: getfield 146	com/tencent/mobileqq/activity/ChatHistoryImageView$DownloadAndSaveTask:jdField_a_of_type_Aeiy	Laeiy;
    //   185: getfield 147	aeiy:jdField_a_of_type_Boolean	Z
    //   188: istore 6
    //   190: iload 6
    //   192: ifeq +10 -> 202
    //   195: aload_0
    //   196: getfield 146	com/tencent/mobileqq/activity/ChatHistoryImageView$DownloadAndSaveTask:jdField_a_of_type_Aeiy	Laeiy;
    ...
    //   275: getfield 86	com/tencent/mobileqq/activity/ChatHistoryImageView:jdField_a_of_type_Bfob	Lbfob;
    //   278: bipush 100
    //   280: invokevirtual 171	bfob:obtainMessage	(I)Landroid/os/Message;
    //   283: astore 9
    //   285: aload 9
    //   287: iconst_1
    ...
    //   316: getfield 86	com/tencent/mobileqq/activity/ChatHistoryImageView:jdField_a_of_type_Bfob	Lbfob;
    //   319: aload 9
    //   321: invokevirtual 183	bfob:sendMessage	(Landroid/os/Message;)Z
    //   324: pop
    //   325: iload_1
    //   326: iconst_1
    //   327: iadd
    ...
    //   344: getfield 86	com/tencent/mobileqq/activity/ChatHistoryImageView:jdField_a_of_type_Bfob	Lbfob;
    //   347: bipush 102
    //   349: invokevirtual 102	bfob:removeMessages	(I)V
    //   352: aload_0
    //   353: iconst_0
    ...
    //   368: getfield 86	com/tencent/mobileqq/activity/ChatHistoryImageView:jdField_a_of_type_Bfob	Lbfob;
    //   371: bipush 101
    //   373: invokevirtual 109	bfob:sendEmptyMessage	(I)Z
    //   376: pop
    //   377: return
    //   378: new 138	java/io/File
    //   381: dup
    //   382: getstatic 188	ajsd:bc	Ljava/lang/String;
    ...
    //   425: getfield 86	com/tencent/mobileqq/activity/ChatHistoryImageView:jdField_a_of_type_Bfob	Lbfob;
    //   428: bipush 100
    //   430: invokevirtual 171	bfob:obtainMessage	(I)Landroid/os/Message;
    //   433: astore 9
    //   435: aload 9
    //   437: iconst_2
    ...
    //   479: getfield 86	com/tencent/mobileqq/activity/ChatHistoryImageView:jdField_a_of_type_Bfob	Lbfob;
    //   482: aload 9
    //   484: invokevirtual 183	bfob:sendMessage	(Landroid/os/Message;)Z
    //   487: pop
    //   488: aload_0
    ...
    //   499: getfield 86	com/tencent/mobileqq/activity/ChatHistoryImageView:jdField_a_of_type_Bfob	Lbfob;
    //   502: bipush 101
    //   504: invokevirtual 109	bfob:sendEmptyMessage	(I)Z
    //   507: pop
    //   508: return
    //   509: aload 9
    //   511: iload_2
    ...
    //   537: checkcast 115	aeiy
    //   540: astore 9
    //   542: ldc 117
    //   544: aload 9
    //   546: getfield 120	aeiy:jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData	Lcom/tencent/mobileqq/activity/aio/photo/AIORichMediaData;
    //   549: invokevirtual 126	java/lang/Class:isInstance	(Ljava/lang/Object;)Z
    //   552: ifeq +65 -> 617
    //   555: aload 9
    //   557: getfield 120	aeiy:jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData	Lcom/tencent/mobileqq/activity/aio/photo/AIORichMediaData;
    ...
    //   617: ldc 200
    //   619: aload 9
    //   621: getfield 120	aeiy:jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData	Lcom/tencent/mobileqq/activity/aio/photo/AIORichMediaData;
    //   624: invokevirtual 126	java/lang/Class:isInstance	(Ljava/lang/Object;)Z
    //   627: ifeq +477 -> 1104
    //   630: aload 9
    //   632: getfield 120	aeiy:jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData	Lcom/tencent/mobileqq/activity/aio/photo/AIORichMediaData;
    ...
    //   763: ldc 222
    //   765: invokestatic 227	ajya:a	(I)Ljava/lang/String;
    //   768: invokestatic 231	aptx:a	(Ljava/lang/String;)V
    //   771: aload_0
    //   772: iconst_0
    ...
    //   780: getfield 86	com/tencent/mobileqq/activity/ChatHistoryImageView:jdField_a_of_type_Bfob	Lbfob;
    //   783: bipush 101
    //   785: invokevirtual 109	bfob:sendEmptyMessage	(I)Z
    //   788: pop
    //   789: return
    ...
    //   859: ldc_w 256
    //   862: invokestatic 227	ajya:a	(I)Ljava/lang/String;
    //   865: invokestatic 231	aptx:a	(Ljava/lang/String;)V
    //   868: aload_0
    //   869: iconst_0
    ...
    //   877: getfield 86	com/tencent/mobileqq/activity/ChatHistoryImageView:jdField_a_of_type_Bfob	Lbfob;
    //   880: bipush 101
    //   882: invokevirtual 109	bfob:sendEmptyMessage	(I)Z
    //   885: pop
    //   886: return
    //   887: iload_3
    //   888: istore 4
    ...
    //   934: invokestatic 269	bbef:a	(Landroid/content/Context;Ljava/lang/String;)V
    //   937: iload_1
    //   938: istore 5
    //   940: goto -336 -> 604
    //   943: iload_3
    ...
    //   982: getstatic 188	ajsd:bc	Ljava/lang/String;
    ...
    //   991: invokestatic 283	aptx:b	(Ljava/lang/String;)V
    //   994: aload_0
    //   995: iconst_0
    ...
    //   1003: getfield 86	com/tencent/mobileqq/activity/ChatHistoryImageView:jdField_a_of_type_Bfob	Lbfob;
    //   1006: bipush 101
    //   1008: invokevirtual 109	bfob:sendEmptyMessage	(I)Z
    //   1011: pop
    //   1012: return
    //   1013: iload_3
    //   1014: ifle +78 -> 1092
    ...
    //   1077: getstatic 188	ajsd:bc	Ljava/lang/String;
    ...
    //   1086: invokestatic 283	aptx:b	(Ljava/lang/String;)V
    //   1089: goto -95 -> 994
    //   1092: ldc_w 301
    //   1095: invokestatic 227	ajya:a	(I)Ljava/lang/String;
    //   1098: invokestatic 231	aptx:a	(Ljava/lang/String;)V
    //   1101: goto -107 -> 994
    //   1104: aconst_null
    //   1105: astore 9
    //   1107: goto -388 -> 719
