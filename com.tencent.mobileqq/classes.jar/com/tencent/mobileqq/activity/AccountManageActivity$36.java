  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    ((AccountManageActivity)localObject).c = bool;
    SettingCloneUtil.writeValue(((AccountManageActivity)localObject).getActivity(), this.jdField_a_of_type_ComTencentMobileqqActivityAccountManageActivity.app.getCurrentAccountUin(), this.jdField_a_of_type_ComTencentMobileqqActivityAccountManageActivity.getString(2131718135), "qqsetting_receivemsg_whenexit_key", bool);
    AccountDPCHelper.a(this.jdField_a_of_type_ComTencentMobileqqActivityAccountManageActivity.getActivity(), this.jdField_a_of_type_ComTencentMobileqqActivityAccountManageActivity.c);
    ...
    localObject = this.jdField_a_of_type_ComTencentMobileqqActivityAccountManageActivity.getActivity().getSharedPreferences("unreadcount", 4).edit();
