    ...
    for (;;)
    {
      try
      {
        if (QLog.isColorLevel()) {
          QLog.i("shua2021report_SpringHbReportManager", 2, "[report] " + this.a + ",over:" + SpringHbReportManager.a(this.this$0) + ",level:" + SpringHbReportManager.a(this.this$0) + ",levelTime:" + SpringHbReportManager.a(this.this$0));
        }
