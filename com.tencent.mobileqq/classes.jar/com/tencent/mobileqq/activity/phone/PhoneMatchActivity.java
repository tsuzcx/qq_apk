  ...
  implements View.OnClickListener
{
  ...
  ContactBindObserver jdField_a_of_type_ComTencentMobileqqPhonecontactContactBindObserver = new wsa(this);
  
  protected boolean doOnCreate(Bundle paramBundle)
  {
    super.doOnCreate(paramBundle);
    super.setContentViewB(2130969169);
    this.centerView.setText("通讯录");
    if (getIntent().getBooleanExtra("key_from_contact_first", false)) {
      ((TextView)super.findViewById(2131365462)).setText(2131436842);
    }
    this.jdField_a_of_type_Int = getIntent().getIntExtra("kSrouce", -1);
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)findViewById(2131365463));
