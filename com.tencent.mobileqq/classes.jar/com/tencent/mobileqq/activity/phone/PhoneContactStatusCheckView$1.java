  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    BitmapFactory.decodeResource(this.this$0.getResources(), 2130844116, localOptions);
    localOptions.inSampleSize = bacm.a(localOptions, ((Resources)localObject2).getDimensionPixelSize(2131165970), ((Resources)localObject2).getDimensionPixelSize(2131165968));
    localOptions.inJustDecodeBounds = false;
    Object localObject1 = null;
    try
    {
      localObject2 = BitmapFactory.decodeResource((Resources)localObject2, 2130844116, localOptions);
