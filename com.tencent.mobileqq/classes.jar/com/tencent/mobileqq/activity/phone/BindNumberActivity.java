  ...
  implements Handler.Callback, TextWatcher, View.OnClickListener, CompoundButton.OnCheckedChangeListener, OnSizeChangeListener
{
  ...
  private void a()
  {
    if (this.jdField_a_of_type_Boolean)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog == null) {
        this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = DialogUtil.a(this, 230, "更换手机号码", "QQ更换绑定新的手机号码前，需要将当前的绑定关系解除，请确定是否更换。", "确定", "取消", new wqd(this), new wqe(this));
      }
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    if ((this.jdField_b_of_type_Int == 10) || (this.jdField_b_of_type_Int == 11) || (this.jdField_b_of_type_Int == 15) || (this.jdField_b_of_type_Int == 17))
    {
      ...
      if ((Build.MANUFACTURER.equalsIgnoreCase("Letv")) && (Build.MODEL.equalsIgnoreCase("X900+")))
      {
        ...
        this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131365406));
        ...
        setRightButton(2131434737, this);
        label367:
        ...
        label498:
        this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131365408));
    ...
    for (;;)
    {
      this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)findViewById(2131365409));
      ...
      this.jdField_a_of_type_AndroidViewView = findViewById(2131365411);
      this.jdField_a_of_type_AndroidViewView.setOnClickListener(this);
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131365412));
      this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
      if (this.g) {
        ReportController.b(this.app, "CliOper", "", "", "0X8005D0D", "0X8005D0D", 0, 0, "", "", "", "");
      }
      return true;
      ((BounceScrollView)findViewById(2131363433)).setOnSizeChangeListener(this);
      break;
      ...
      if (this.jdField_c_of_type_Boolean)
      {
        setLeftButton(2131434920, null);
        break label367;
      }
      setLeftButton(2131433681, null);
      break label367;
      label958:
      if (getIntent().getBooleanExtra("k_is_block", false))
      {
        ...
        this.leftViewNotBack.setOnClickListener(new wqb(this));
        ...
        setRightButton(2131435627, this);
        break label391;
      }
      if (this.g)
      {
        this.jdField_c_of_type_AndroidWidgetTextView.setText(2131429501);
  ...
  protected void doOnResume()
  {
    super.doOnResume();
    if (TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {
      this.jdField_a_of_type_AndroidWidgetEditText.postDelayed(new wqc(this), 300L);
    }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 0: 
      this.jdField_b_of_type_ComTencentMobileqqPhonecontactContactBindObserver = new wqf(this);
    ...
    case 4: 
      do
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqPhonecontactContactBindObserver == null)
        {
          this.jdField_a_of_type_ComTencentMobileqqPhonecontactContactBindObserver = new wqg(this);
    ...
    ((BounceScrollView)findViewById(2131363433)).fullScroll(130);
    return true;
  }
