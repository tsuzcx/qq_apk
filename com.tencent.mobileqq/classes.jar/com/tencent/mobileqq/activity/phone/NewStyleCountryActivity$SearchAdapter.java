  ...
  extends BaseAdapter
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_ComTencentMobileqqActivityPhoneNewStyleCountryActivity;
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityPhoneNewStyleCountryActivity.a(localView, (PhoneCodeUtils.CountryCode)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt));
