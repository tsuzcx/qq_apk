  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (this.this$0.jdField_a_of_type_Azip == null)
    {
      this.this$0.jdField_a_of_type_Azip = new akiy(this);
      this.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.registObserver(this.this$0.jdField_a_of_type_Azip);
    }
