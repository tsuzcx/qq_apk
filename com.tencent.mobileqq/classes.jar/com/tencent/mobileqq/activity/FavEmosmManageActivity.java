  ...
  implements Handler.Callback, View.OnClickListener, AdapterView.OnItemClickListener
{
  ...
  BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new srm(this);
  public Handler a;
  ...
  FavEmoRoamingObserver jdField_a_of_type_ComTencentMobileqqAppFavEmoRoamingObserver = new srr(this);
  public FavroamingDBManager a;
  SyncListener jdField_a_of_type_ComTencentMobileqqEmosmFavroamingSyncListener = new srp(this);
  ...
  void a()
  {
    ...
    this.rightViewText.setText(2131438044);
    this.rightViewText.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)super.findViewById(2131364538));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)super.findViewById(2131364539));
    this.jdField_b_of_type_AndroidWidgetButton = ((Button)super.findViewById(2131364541));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131364540));
    this.jdField_a_of_type_ComTencentWidgetGridView = ((GridView)super.findViewById(2131364542));
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      this.rightViewText.setText(2131434953);
    ...
    this.jdField_c_of_type_AndroidWidgetButton = ((Button)findViewById(2131364537));
  ...
  void b()
  {
    ((FavroamingDBManager)this.app.getManager(148)).a(new sro(this));
  }
  ...
  public void c()
  {
    ((FavroamingDBManager)this.app.getManager(148)).a(new srq(this));
  }
    ...
    for (i = 0;; i = 1)
    {
      ...
      for (;;)
      {
        ...
        if (localObject3 != null)
        {
          ...
          i += 1;
          continue;
          ThreadManager.post(new srs(this, (List)localObject2), 5, null, true);
          ...
          if (i < this.jdField_a_of_type_JavaUtilArrayList.size())
          {
            ...
            ThreadManager.post(new srt(this, localObject2, (VipComicMqqManager)localObject1, i), 5, null, false);
            return;
          }
          localObject1 = this.app.getHandler(ChatActivity.class);
          if (localObject1 == null) {
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    super.setContentView(2130968968);
    super.setTitle(2131438048);
  ...
  void e()
  {
    ...
    for (;;)
    {
      localObject = String.format(getString(2131438046), new Object[] { Integer.valueOf(i) });
      this.jdField_a_of_type_AndroidWidgetTextView.setText((CharSequence)localObject);
      this.jdField_b_of_type_AndroidWidgetButton.setText(getString(2131438043));
      return;
      this.jdField_b_of_type_AndroidWidgetButton.setEnabled(false);
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131364541: 
      do
      {
        do
        {
          ...
          this.rightViewText.setText(2131438045);
          this.jdField_c_of_type_Int = 1;
          this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(false);
          this.jdField_a_of_type_ComTencentMobileqqActivityFavEmosmManageActivity$FavEmoAdapter.notifyDataSetChanged();
    ...
    VasH5PayUtil.a(this.app, this, "mvip.n.a.bqsc_edit", 3, "1450000516", "CJCLUBT", getString(2131436963), "");
  }
}
