  ...
  implements View.OnClickListener, View.OnTouchListener
{
  ...
  private aikx jdField_a_of_type_Aikx;
  private aiky jdField_a_of_type_Aiky = new abxc(this);
  ajtq jdField_a_of_type_Ajtq = new abwv(this);
  private ajuh jdField_a_of_type_Ajuh = new abwu(this);
  private ajxl jdField_a_of_type_Ajxl = new abww(this);
  private akab jdField_a_of_type_Akab = new abwy(this);
  private akfz jdField_a_of_type_Akfz = new abwz(this);
  private akjp jdField_a_of_type_Akjp = new abws(this);
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new abwi(this);
  Handler jdField_a_of_type_AndroidOsHandler = new abxb(this, Looper.getMainLooper());
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new abwn(this);
  protected View a;
  public ViewGroup a;
  ...
  private aqyd jdField_a_of_type_Aqyd = new aqyd("QQSetting_me", "com.tencent.mobileqq:tool");
  private atzl jdField_a_of_type_Atzl = new abwr(this);
  private awcb jdField_a_of_type_Awcb;
  private awcd jdField_a_of_type_Awcd;
  private awcg jdField_a_of_type_Awcg;
  private aweo jdField_a_of_type_Aweo;
  private ayma jdField_a_of_type_Ayma;
  aymd jdField_a_of_type_Aymd = new abwx(this);
  private bbrv jdField_a_of_type_Bbrv = new abxa(this);
  ...
  private ConcurrentHashMap<String, bfwg> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  public QQSettingMe(BaseActivity paramBaseActivity, QQAppInterface paramQQAppInterface, FrameHelperActivity paramFrameHelperActivity)
  {
    ...
    this.jdField_a_of_type_Xpa = new abxf(this);
    this.jdField_b_of_type_AndroidOsHandler = new abwj(this, Looper.getMainLooper());
    ...
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity).inflate(2131561082, null));
    ...
    if (AppSetting.jdField_d_of_type_Boolean) {
      this.jdField_a_of_type_AndroidViewView.setContentDescription(ajyc.a(2131710756));
    }
    ...
    this.jdField_a_of_type_ComTencentMobileqqAvatarDynamicavatarDynamicAvatarView = ((DynamicAvatarView)this.jdField_a_of_type_ComTencentMobileqqVasAvatarAvatarLayout.findViewById(2131363080));
    ...
    this.jdField_m_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131376225);
    ...
    if ((paramFrameHelperActivity == null) || (paramFrameHelperActivity.length() == 0))
    {
      ...
      this.jdField_c_of_type_Int = (axli.jdField_a_of_type_Int - axli.a(94.0F) - i1 - axli.a(45.0F));
      this.jdField_d_of_type_Int = (axli.jdField_a_of_type_Int - axli.a(94.0F) - i1 - axli.a(20.0F));
      ...
      this.jdField_a_of_type_ComTencentMobileqqWidgetQVipMedalView = ((QVipMedalView)this.jdField_a_of_type_AndroidViewView.findViewById(2131373142));
      this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131373047);
      this.jdField_d_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131373048);
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379265));
      this.jdField_a_of_type_ComTencentMobileqqWidgetAnimationTextView = ((AnimationTextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131373169));
      this.jdField_a_of_type_ComTencentMobileqqWidgetAnimationTextView.setText("");
      this.jdField_f_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131362994));
      this.jdField_b_of_type_AndroidWidgetFrameLayout = ((FrameLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131362992));
      this.jdField_e_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131373405));
      ...
      if (ImmersiveUtils.isSupporImmersive() == 0)
      {
        ...
        paramBaseActivity.topMargin = (axli.a(29.0F) - ImmersiveUtils.getStatusBarHeight(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getActivity().getApplicationContext()));
        if (QLog.isColorLevel()) {
      ...
      this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131370633));
      if (ImmersiveUtils.isSupporImmersive() == 0)
      {
        paramBaseActivity = (ViewGroup.MarginLayoutParams)this.jdField_a_of_type_AndroidWidgetLinearLayout.getLayoutParams();
        paramBaseActivity.topMargin = (axli.a(35.0F) - ImmersiveUtils.getStatusBarHeight(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getActivity().getApplicationContext()));
      ...
      this.jdField_a_of_type_ComTencentMobileqqRedtouchRedTouch = new RedTouch(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131376200)).a(53).a();
      this.jdField_e_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131376194);
      ...
      this.jdField_e_of_type_AndroidViewView.setOnTouchListener(muf.a);
      this.jdField_l_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131371992);
      this.jdField_a_of_type_ComTencentMobileqqWidgetFixedBounceScrollView = ((FixedBounceScrollView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131370133));
      ...
      tmp1387_1380[9] = 2131363823;
      FrameHelperActivity tmp1394_1387 = tmp1387_1380;
      tmp1394_1387[10] = 2131364861;
      FrameHelperActivity tmp1401_1394 = tmp1394_1387;
      tmp1401_1394[11] = 2131370609;
      tmp1401_1394;
      localObject1 = new int[12];
      Object tmp1417_1415 = localObject1;
      tmp1417_1415[0] = 2131699414;
      Object tmp1423_1417 = tmp1417_1415;
      tmp1423_1417[1] = 2131699428;
      Object tmp1429_1423 = tmp1423_1417;
      tmp1429_1423[2] = 2131699440;
      Object tmp1435_1429 = tmp1429_1423;
      tmp1435_1429[3] = 2131699413;
      Object tmp1441_1435 = tmp1435_1429;
      tmp1441_1435[4] = 2131699457;
      Object tmp1447_1441 = tmp1441_1435;
      tmp1447_1441[5] = 2131699391;
      Object tmp1453_1447 = tmp1447_1441;
      tmp1453_1447[6] = 2131699399;
      Object tmp1460_1453 = tmp1453_1447;
      tmp1460_1453[7] = 2131699435;
      Object tmp1467_1460 = tmp1460_1453;
      tmp1467_1460[8] = 2131699402;
      Object tmp1474_1467 = tmp1467_1460;
      tmp1474_1467[9] = 2131699382;
      Object tmp1481_1474 = tmp1474_1467;
      tmp1481_1474[10] = 2131699383;
      Object tmp1488_1481 = tmp1481_1474;
      tmp1488_1481[11] = 2131699412;
      tmp1488_1481;
    ...
    for (int i1 = this.jdField_a_of_type_AndroidViewViewGroup.getResources().getColor(2131166315);; i1 = this.jdField_a_of_type_AndroidViewViewGroup.getResources().getColor(2131166316))
    {
      ...
      int i3 = axli.a(2.0F);
      localObject2 = this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131370133);
      this.jdField_k_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqWidgetFixedBounceScrollView.findViewById(2131370134);
      int i2 = 0;
      while (i2 < 12)
      {
        ...
        if (paramFrameHelperActivity[i2] == 2131363823) {
          this.jdField_a_of_type_ArrayOfAndroidViewView[i2].setVisibility(8);
        }
        ...
        if (paramFrameHelperActivity[i2] == 2131370609)
        {
        ...
        ((ImageView)this.jdField_a_of_type_ArrayOfAndroidViewView[i2].findViewById(2131368345)).setImageResource(arrayOfInt[i2]);
        Object localObject3 = (TextView)this.jdField_a_of_type_ArrayOfAndroidViewView[i2].findViewById(2131368385);
        ((TextView)localObject3).setText(localObject1[i2]);
        if (!this.jdField_j_of_type_Boolean) {
          ((TextView)localObject3).setTextColor(i1);
        }
        if ((axmt.b()) && ("2920".equals(ThemeUtil.getCurrentThemeId()))) {
          ((TextView)localObject3).setTextColor(this.jdField_a_of_type_AndroidViewViewGroup.getResources().getColor(2131166314));
        }
        ...
        bawi.a(this.jdField_a_of_type_ArrayOfAndroidViewView[i2], paramBaseActivity.getString(localObject1[i2]), Button.class.getName());
    ...
    V();
    L();
    this.jdField_i_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131368544);
    ...
    if ((TextUtils.isEmpty(str)) || ("1000".equals(str)))
    {
      ...
      this.jdField_h_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131363354);
      this.jdField_g_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131375986);
      this.jdField_g_of_type_AndroidViewView.setOnClickListener(this);
      this.jdField_g_of_type_AndroidViewView.setOnTouchListener(this);
      bawi.a(this.jdField_g_of_type_AndroidViewView, ajyc.a(2131710750), Button.class.getName());
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131375988));
      this.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131373099));
      this.jdField_a_of_type_ComTencentMobileqqWidgetRedDotTextView = ((RedDotTextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131375987));
      ...
      bawi.a(this.jdField_f_of_type_AndroidViewView, ajyc.a(2131710733), Button.class.getName());
      ...
      this.n = this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131369456);
      this.jdField_h_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131378369));
      this.n.setOnClickListener(this);
      this.n.setOnTouchListener(this);
      this.jdField_c_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131379379));
      this.jdField_c_of_type_AndroidWidgetLinearLayout.setOnClickListener(this);
      this.jdField_c_of_type_AndroidWidgetLinearLayout.setOnTouchListener(this);
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131376957));
      this.jdField_j_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131376941);
      this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131376959));
      this.jdField_f_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131376958));
      this.jdField_g_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131379377));
      if (!axmt.b())
      {
    ...
    for (;;)
    {
      ...
      if (!this.jdField_j_of_type_Boolean)
      {
        ...
        this.jdField_d_of_type_AndroidWidgetImageView.setImageResource(2130845232);
        this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130845209);
  ...
  private void K()
  {
    ...
    this.jdField_k_of_type_AndroidViewView.getViewTreeObserver().addOnGlobalLayoutListener(new abwt(this));
  }
  ...
  private void M()
  {
    ...
    if (localView != null)
    {
      if (annq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, true))
      {
        String str = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getSharedPreferences("call_tim_config_pre" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), 0).getString("call_tim_config_title", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131699382));
        localView.setVisibility(0);
        ((TextView)localView.findViewById(2131368385)).setText(str);
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800887D", "0X800887D", 0, 0, "", "", "", "");
      }
    }
    else {
      return;
  ...
  private void P()
  {
    ...
    do
    {
      ...
      if ((localObject2 != null) && (((SparseArray)localObject2).size() > 0))
      {
        ...
        if (i1 < ((SparseArray)localObject2).size())
        {
          ...
          for (;;)
          {
            ...
            {
              localSonicPreloadData.url = bbpp.a("personalIndex");
              localArrayList1.add(localSonicPreloadData);
            }
          }
        }
      ...
      if ((localObject1 != null) && (((SparseArray)localObject1).size() > 0))
      {
        ...
        ((SonicPreloadData)localObject1).url = bbpp.a("personalIndex");
      ...
      if (((WebProcessManager)localObject1).a(localArrayList1)) {
        ((avpq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36)).b(String.valueOf("200010.200012"));
      }
  ...
  private void R()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqDataCard.allowPeopleSee) {
      if (this.jdField_a_of_type_ComTencentMobileqqDataCard.lLoginDays < 10000L) {
        str1 = String.format(ajyc.a(2131699418), new Object[] { Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqDataCard.lLoginDays) });
      }
    }
    for (String str2 = String.format(ajyc.a(2131699455), new Object[] { Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqDataCard.lLoginDays) });; str2 = ajyc.a(2131699419))
    {
      this.jdField_h_of_type_AndroidWidgetTextView.setText(str1);
      bawi.a(this.n, str2, Button.class.getName());
      return;
      str1 = "9999+";
      break;
      str1 = ajyc.a(2131699454);
    }
  }
  ...
  private void S()
  {
    ...
    this.jdField_a_of_type_Ayma.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity);
    ...
    {
      bawi.a(this.jdField_f_of_type_AndroidViewView, str, Button.class.getName());
      return;
    }
  }
  ...
  private void U()
  {
    ...
    Object localObject1 = ((atxb)localObject2).a(-4);
    if ((((atxb)localObject2).a((RedTouchItem)localObject1, true)) && (((RedTouchItem)localObject1).count > 0) && (this.jdField_a_of_type_TencentImOidbRedInfo$RedInfo != null))
    {
      ...
      if (this.jdField_a_of_type_TencentImOidbRedInfo$RedInfo.uint64_from_uin.has())
      {
        ...
        localTextView = (TextView)this.jdField_l_of_type_AndroidViewView.findViewById(2131370453);
      ...
      for (;;)
      {
        Object localObject3 = bbdr.a(true);
        localObject3 = baxt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1, l1 + "", 4, (Drawable)localObject3, (Drawable)localObject3);
        Drawable localDrawable = localImageView.getDrawable();
        if ((localDrawable != null) && (localDrawable != localObject3) && ((localDrawable instanceof baxt))) {
          ((baxt)localDrawable).a();
        }
        localImageView.setImageDrawable((Drawable)localObject3);
        localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getString(2131699401, new Object[] { Integer.valueOf(((RedTouchItem)localObject1).count) });
        ...
        ((View)localObject2).setOnTouchListener(new abwl(this, localImageView, localTextView, localView));
        ((View)localObject2).setOnClickListener(this);
        this.jdField_l_of_type_AndroidViewView.setVisibility(0);
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A97E", "0X800A97E", 0, 0, "0", "0", "", "");
        return;
        l1 = 0L;
        break;
        label385:
        ((View)localObject2).setBackgroundResource(2130845212);
      }
    }
  ...
  private void W()
  {
    ...
    {
      localObject = asaw.a(this.jdField_m_of_type_ComTencentPbGetbusiinfoBusinessInfoCheckUpdate$AppInfo);
      int i1 = asaw.a((String)localObject);
  ...
  private void X()
  {
    ...
    do
    {
      ...
      abwm localabwm = new abwm(this, localTextView);
      try
      {
        ...
        {
          localabwm.onLoadSuccessed((URLDrawable)localObject1);
          return;
        }
      }
      ...
      ((URLDrawable)localObject1).setURLDrawableListener(localabwm);
  ...
  private void Y()
  {
    try
    {
      a(10, this.jdField_l_of_type_ComTencentPbGetbusiinfoBusinessInfoCheckUpdate$AppInfo);
      return;
    }
    catch (Exception localException)
    {
  ...
  private void Z()
  {
    try
    {
      String str = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getSharedPreferences("vipTitleSpFile", 0).getString("vipTitleSpKey_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + "_" + ajzv.a(), "");
      if (QLog.isColorLevel()) {
  ...
  private void a(BusinessInfoCheckUpdate.AppInfo paramAppInfo)
  {
    if ((paramAppInfo != null) && (paramAppInfo.iNewFlag.get() != 0))
    {
      ...
      if (!this.jdField_a_of_type_JavaUtilHashSet.contains(Integer.valueOf(i1)))
      {
        ...
        ((avpq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36)).a(i1, 30);
      }
    }
  }
  ...
  {
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", paramString1, paramString1, 0, 0, paramString2, "", "", "");
  }
  ...
  private void ab()
  {
    Iterator localIterator = ajte.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext())
    {
      ajtf localajtf = (ajtf)localIterator.next();
      if ((localajtf instanceof ajzz)) {
        ((ajzz)localajtf).a();
      }
    }
  }
  ...
  private void ad()
  {
    Object localObject = (atxb)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(160);
    RedTouchItem localRedTouchItem1 = ((atxb)localObject).a(10015);
    RedTouchItem localRedTouchItem2 = ((atxb)localObject).a(10016);
    int i1;
    if ((atxi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) && ((((atxb)localObject).a(localRedTouchItem1, false)) || (((atxb)localObject).a(localRedTouchItem2, false))))
    {
      i1 = 1;
      if (i1 != 0)
      {
        i1 = ((atxb)localObject).a();
        localObject = null;
        switch (i1)
        {
        }
    ...
    {
      if (localObject != null) {
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", (String)localObject, (String)localObject, 0, 0, "", "", "", "");
      }
      return;
      i1 = 0;
      break;
  ...
  private void ae()
  {
    annq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  }
  ...
  private boolean b()
  {
    ...
    View localView = this.jdField_k_of_type_AndroidViewView.findViewById(2131364861);
    ...
    if (!((Rect)localObject2).contains((Rect)localObject1))
    {
      ...
      if (((ViewGroup)localObject1).getChildAt(i1).getId() != 2131370639) {
        break label264;
      }
    }
    for (;;)
  ...
  private boolean c()
  {
    atxb localatxb = (atxb)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(160);
    localatxb.a(100601, false);
    localatxb.a(10016, false);
    localatxb.a(10015, false);
    RedTouchItem localRedTouchItem = localatxb.a(-7);
    if (localatxb.a(localRedTouchItem, true)) {}
    try
    {
      ad();
  ...
  private void d(String paramString)
  {
    ...
    if (this.o == null)
    {
      ...
      ((TextView)localObject1).setBackgroundResource(2130843902);
  ...
  private boolean d()
  {
    bazo.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    Object localObject = (atxb)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(160);
    RedTouchItem localRedTouchItem = ((atxb)localObject).a(-4);
    if ((((atxb)localObject).a(localRedTouchItem, true)) && (localRedTouchItem.count > 0))
    {
      try
      {
        localObject = bbdj.a(atxa.a(-4));
  ...
  private void e(String paramString)
  {
    ...
    try
    {
      ...
      bool3 = bblf.a(this.jdField_a_of_type_ComTencentMobileqqDataCard.nameplateVipType);
      localObject = null;
      i1 = 0;
      if (!bool3) {
        break label1657;
      }
      localObject = bblf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqDataCard.uin, bblg.a(this.jdField_a_of_type_ComTencentMobileqqDataCard.nameplateVipType), bblf.b(this.jdField_a_of_type_ComTencentMobileqqDataCard.grayNameplateFlag));
      i1 = bblf.a(bblg.a(this.jdField_a_of_type_ComTencentMobileqqDataCard.nameplateVipType));
    }
    ...
    if (bool2)
    {
      ...
      paramString = bblf.a((i1 & 0xF) << 8 | i1 >> 8, i4, this.jdField_a_of_type_ComTencentMobileqqDataCard.lSuperVipTemplateId);
      i1 = 2130846153;
      i2 = 1;
      localObject = str;
    }
    for (;;)
    {
      ...
      if (!bool3)
      {
        ...
        if (i2 == 0)
        {
          ...
          str = bblf.a((i1 & 0xF) << 8 | i1 >> 8, i4, this.jdField_a_of_type_ComTencentMobileqqDataCard.lSuperVipTemplateId);
          i3 = 2130846154;
        }
      }
      label437:
      if ((str != null) && (i3 != 0))
      {
        ...
        this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(ajyc.a(2131716807));
        this.jdField_a_of_type_AndroidWidgetImageView.setFocusableInTouchMode(true);
        paramString = bblh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqDataCard.uin, "VIA_SETTINGME");
        paramString.a();
        this.jdField_a_of_type_AndroidWidgetImageView.setOnTouchListener(paramString);
        if (this.jdField_a_of_type_AndroidWidgetImageView.getVisibility() == 0)
        {
          i1 = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getBaseContext().getResources().getDimensionPixelSize(2131298249);
          this.jdField_c_of_type_Int = (axli.jdField_a_of_type_Int - axli.a(94.0F) - i1 - axli.a(45.0F) - axli.a(45.0F));
          this.jdField_a_of_type_AndroidWidgetTextView.setMaxWidth(this.jdField_c_of_type_Int);
        }
        if (bbrt.a().a(bool1, this.jdField_a_of_type_ComTencentMobileqqDataCard.namePlateOfKingLoginTime)) {
          localSpannableStringBuilder.append(bazw.a(this.jdField_a_of_type_ComTencentMobileqqWidgetAnimationTextView, localResources, this.jdField_a_of_type_ComTencentMobileqqDataCard.namePlateOfKingGameId, this.jdField_a_of_type_ComTencentMobileqqDataCard.namePlateOfKingDan, this.jdField_a_of_type_ComTencentMobileqqDataCard.namePlateOfKingDanDisplatSwitch));
        }
        i2 = 0;
        ...
        label738:
        i2 = this.jdField_a_of_type_ComTencentMobileqqDataMedalList.infoList.size() * vzo.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 21.0F) - vzo.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 6.0F);
        if (QLog.isColorLevel()) {
        ...
        if (!this.jdField_e_of_type_Boolean)
        {
          ...
          i1 = akjo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), false);
          axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "qvip", "0X800A126", 0, 0, String.valueOf(i1), "", "", "");
          i1 = i2;
        }
        label889:
        localSpannableStringBuilder.append(bazw.a(localResources, this.jdField_a_of_type_ComTencentMobileqqDataCard.mQQLevelType, this.jdField_a_of_type_ComTencentMobileqqDataCard.iQQLevel, a(i1)));
      ...
      for (;;)
      {
        ...
        if (bool1)
        {
          ...
          i1 = 1;
          label1147:
          paramString = bblf.a((i2 & 0xF) << 8 | i2 >> 8, i4, this.jdField_a_of_type_ComTencentMobileqqDataCard.lSuperVipTemplateId);
          if (i1 == 0) {
            break label1722;
          }
          i1 = 2130846154;
            ...
            if (i2 != 0)
            {
              ...
              if (i2 >> 8 == 3)
              {
                if ((i2 & 0xF) == 1)
                {
                  ...
                  paramString = bblf.a((i1 & 0xF) << 8 | i1 >> 8, this.jdField_a_of_type_ComTencentMobileqqDataCard.iBigClubVipLevel, this.jdField_a_of_type_ComTencentMobileqqDataCard.lBigClubTemplateId);
                  i1 = 2130846154;
                  break label1729;
                }
                i1 = VipUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, EVIPSPEC.E_SP_BIGCLUB);
  ...
  private boolean e()
  {
    ...
    long l1 = bbwv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "setting_me_last_request_success_time", 0L);
    int i1 = bbwv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "setting_me_vip_sync_freq", 0);
  ...
  private void f(String paramString)
  {
    ...
    BusinessInfoCheckUpdate.AppInfo localAppInfo = ((avpq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36)).a(String.valueOf(100400));
    Object localObject;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        i2 = bbev.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext());
        if (!TextUtils.isEmpty((CharSequence)localObject)) {
          break label499;
        }
        ...
        localObject = ((avpq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36)).a((String)localObject, localAppInfo);
        ...
        paramString = (avpq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36);
  ...
  private void i(String paramString)
  {
    ...
    if (!(localDate.getYear() + ":" + localDate.getMonth() + localDate.getDay()).equals(localSharedPreferences.getString("sign_in_report" + paramString, ""))) {
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", paramString, paramString, 0, 0, "", "", "", "");
    }
  }
  ...
  void A()
  {
    ...
    ImageView localImageView1 = (ImageView)this.jdField_e_of_type_AndroidViewView.findViewById(2131375233);
    TextView localTextView = (TextView)this.jdField_e_of_type_AndroidViewView.findViewById(2131375234);
    ...
    if (ThemeUtil.isNowThemeIsDefault(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, true, null))
    {
      ...
      localImageView1.setImageBitmap(this.jdField_a_of_type_Aweo.a(i1, 200));
    ...
    for (;;)
    {
      ...
      localImageView1.setImageResource(2130845217);
      localImageView1.setVisibility(8);
      break label377;
      label542:
  ...
  protected void C()
  {
    if (((ajtk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(2)).b())
    {
      E();
      this.jdField_b_of_type_Boolean = false;
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_duty", "", "locker", "exp", 0, 0, "", "", "", "");
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
  ...
  protected void D()
  {
    ...
    int i10 = axli.jdField_a_of_type_Int;
    int i11 = axli.a(65.0F);
    int i12 = axli.a(15.0F);
    ...
    try
    {
      ...
      localObject2 = localObject4;
      localObject1 = str;
      localObject4 = ajyc.a(2131710760);
      i1 = i5;
      i2 = i6;
      i4 = i7;
      i3 = i8;
    ...
    catch (JSONException localJSONException)
    {
      ...
      localObject3 = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getDrawable(2130845235);
      localObject5 = (URLImageView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131376199);
    ...
    for (;;)
    {
      ...
      localObject2 = (TextView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131376201);
      ...
      if (((this.jdField_a_of_type_ComTencentMobileqqDataCard != null) && ((bfmo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqDataCard)) || (!this.jdField_a_of_type_ComTencentMobileqqDataCard.isNoCover()))) || (!ThemeUtil.isNowThemeIsDefault(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, true, null)))
      {
        ...
        localObject1 = String.format(ajyc.a(2131710753), new Object[] { Integer.valueOf(i3) });
      }
      label1106:
      label1364:
      label1379:
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            try
            {
              if ((this.jdField_a_of_type_ComTencentMobileqqDataCard == null) || ((!bfmo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqDataCard)) && (this.jdField_a_of_type_ComTencentMobileqqDataCard.isNoCover()))) {
                continue;
              }
              localObject2 = BitmapFactory.decodeResource(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources(), 2130845235);
            }
            ...
            localObject2 = new BitmapDrawable(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources(), bfmm.a((Bitmap)localObject2));
            break;
            localObject2 = BitmapFactory.decodeResource(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources(), 2130845236);
          }
  ...
  protected void E()
  {
    ...
    this.jdField_b_of_type_AndroidWidgetLinearLayout.setVisibility(8);
    localObject3 = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getDrawable(2130845235);
    URLImageView localURLImageView = (URLImageView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131376199);
    ...
    for (;;)
    {
      ...
      localObject1 = (TextView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131376201);
      localObject3 = (TextView)this.jdField_b_of_type_AndroidWidgetLinearLayout.findViewById(2131368385);
      ((TextView)localObject1).setMaxWidth(axli.jdField_a_of_type_Int - this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getDimensionPixelSize(2131298249) - axli.a(65.0F) - (axli.a(15.0F) + this.jdField_e_of_type_AndroidWidgetImageView.getWidth()));
      if (((this.jdField_a_of_type_ComTencentMobileqqDataCard != null) && ((bfmo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqDataCard)) || (!this.jdField_a_of_type_ComTencentMobileqqDataCard.isNoCover()))) || (!ThemeUtil.isNowThemeIsDefault(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, true, null)))
      {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          try
          {
            ...
            localObject1 = BitmapFactory.decodeResource(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources(), 2130845235);
          }
          catch (OutOfMemoryError localOutOfMemoryError)
          {
            if (!QLog.isColorLevel()) {
          ...
          localObject1 = new BitmapDrawable(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources(), bfmm.a((Bitmap)localObject1));
          break;
          localObject1 = BitmapFactory.decodeResource(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources(), 2130845236);
        }
  ...
  public void H()
  {
    ...
    a(null);
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A42B", "0X800A42B", 0, 0, "", "", "", "");
    if ((this.jdField_a_of_type_ComTencentMobileqqDataCard != null) && (bbsu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqDataCard.mQQLevelType))) {
    ...
    {
      axqw.b(null, "dc00898", "", "", "qq_vip", "0X800A778", i1, 0, "", "", "", "");
      return;
    }
  }
  ...
  public int a()
  {
    if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size() > 0)
    {
      ...
      {
        Bitmap localBitmap = ((bfwg)localIterator.next()).a();
        if (localBitmap == null) {
          break label70;
        }
        i1 = bbbd.a(localBitmap) + i1;
      }
      label70:
      for (;;)
      {
  ...
  public bfwg a(String paramString)
  {
    ...
    return (bfwg)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
  }
  ...
  public void a()
  {
    ...
    v();
    axrg.a().a("QQSettingMe");
    if (!this.jdField_d_of_type_Boolean) {
      h();
    }
    this.jdField_k_of_type_AndroidViewView.setPadding(this.jdField_k_of_type_AndroidViewView.getPaddingLeft(), axli.a(14.0F), this.jdField_k_of_type_AndroidViewView.getPaddingRight(), this.jdField_k_of_type_AndroidViewView.getPaddingBottom());
    ...
    try
    {
      ...
      {
        aa();
        this.jdField_a_of_type_Aikx.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity);
      }
      for (;;)
      {
        i();
        ...
        if (localObject1 != null)
        {
          localObject2 = (ssw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(181);
          if ((localObject2 == null) || (!((ssw)localObject2).e())) {
            break;
          }
        ...
        V();
        K();
        if ((ImmersiveUtils.isSupporImmersive() != 0) && (ImmersiveUtils.c()) && (!ThemeUtil.isInNightMode(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app)) && (axmt.b())) {
          ImmersiveUtils.a(true, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getWindow());
        }
        localObject1 = new int[12];
        Object tmp429_427 = localObject1;
        tmp429_427[0] = 2131370646;
        Object tmp435_429 = tmp429_427;
        tmp435_429[1] = 2131370643;
        Object tmp441_435 = tmp435_429;
        tmp441_435[2] = 2131370635;
        Object tmp447_441 = tmp441_435;
        tmp447_441[3] = 2131370638;
        Object tmp453_447 = tmp447_441;
        tmp453_447[4] = 2131370642;
        Object tmp459_453 = tmp453_447;
        tmp459_453[5] = 2131370610;
        Object tmp465_459 = tmp459_453;
        tmp465_459[6] = 2131370639;
        Object tmp472_465 = tmp465_459;
        tmp472_465[7] = 2131370644;
        Object tmp479_472 = tmp472_465;
        tmp479_472[8] = 2131370645;
        Object tmp486_479 = tmp479_472;
        tmp486_479[9] = 2131363823;
        Object tmp493_486 = tmp486_479;
        tmp493_486[10] = 2131364861;
        Object tmp500_493 = tmp493_486;
        tmp500_493[11] = 2131370609;
        tmp500_493;
        i2 = akjo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), false);
        i1 = 0;
        for (;;)
        {
          if (i1 >= 12) {
          ...
          localObject2 = ((avpq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36)).a(String.valueOf(100400));
          int i3 = akjo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), RedTouch.a((BusinessInfoCheckUpdate.AppInfo)localObject2));
          axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A8C3", "0X800A8C3", i3, 0, String.valueOf(i3), "", "", "");
          i1 += 1;
        }
    ...
    catch (Throwable localThrowable)
    {
      for (;;)
      {
        ...
        if ((localThrowable[i1] == 2131370643) && (this.jdField_a_of_type_ArrayOfAndroidViewView[i1].getVisibility() == 0)) {
          axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A8C4", "0X800A8C4", i2, 0, String.valueOf(i2), "", "", "");
        } else if ((localThrowable[i1] == 2131364861) && (this.jdField_a_of_type_ArrayOfAndroidViewView[i1].getVisibility() == 0)) {
          axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A8C5", "0X800A8C5", i2, 0, String.valueOf(i2), "", "", "");
        }
      }
    }
  }
  ...
  {
    bcpw.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, paramInt, 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
  }
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (this.jdField_d_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
      f();
      this.jdField_a_of_type_Ayma.a(paramQQAppInterface);
      l();
      z();
      U();
      if (this.jdField_a_of_type_ComTencentMobileqqApolloSettingMeApolloViewController != null) {
  ...
  void a(RichStatus paramRichStatus)
  {
    ...
    if (ThemeUtil.isNowThemeIsDefault(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, true, null))
    {
      ...
      localImageView1.setImageBitmap(this.jdField_a_of_type_Aweo.a(paramRichStatus.actionId, 200));
      localImageView1.setVisibility(0);
    ...
    for (;;)
    {
      ...
      localImageView2.setVisibility(0);
      if (bbct.b()) {
        localTextView.setText(new ayki(paramRichStatus + " ", 1, 16));
      } else {
        localTextView.setText(new ayki(paramRichStatus, 1, 16));
      }
    }
  ...
  public void a(@Nullable Boolean paramBoolean)
  {
    ...
    {
      if ((axmt.b()) && (!ThemeUtil.isInNightMode(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app)) && (ImmersiveUtils.isSupporImmersive() != 0))
      {
        paramBoolean = ThemeUtil.getCurrentThemeId();
        if ((axmt.b(paramBoolean)) && (!ThemeUtil.isSimpleColrThemeStateBarUseWhite(paramBoolean)))
        {
    ...
    if (paramBoolean == null)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqDataCard != null) {
        if ((!bfmo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqDataCard)) && (this.jdField_a_of_type_ComTencentMobileqqDataCard.isNoCover())) {
          break label172;
        }
      }
    }
  ...
  public void a(String paramString, bfwg parambfwg)
  {
    ...
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString, parambfwg);
  }
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2, int paramInt)
  {
    ...
    //   23: iload_1
    //   24: invokevirtual 1119	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   27: ldc_w 2824
    //   30: invokevirtual 432	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   33: iload_2
    //   34: invokevirtual 1119	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   37: ldc_w 2826
    ...
    //   50: invokestatic 1123	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   53: aload_0
    ...
    //   57: invokevirtual 1242	com/tencent/mobileqq/app/QQAppInterface:getPreferences	()Landroid/content/SharedPreferences;
    //   60: astore 6
    //   62: aload_0
    ...
    //   105: aload 9
    //   107: ldc_w 646
    //   110: invokevirtual 732	android/content/res/Resources:getString	(I)Ljava/lang/String;
    //   113: astore 5
    //   115: invokestatic 909	ajzv:a	()Z
    //   118: ifeq +400 -> 518
    //   121: iload_1
    //   122: ifeq +238 -> 360
    //   125: invokestatic 1859	bbrt:a	()Lbbrt;
    //   128: getfield 2828	bbrt:d	Ljava/lang/String;
    //   131: invokestatic 674	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   134: ifne +209 -> 343
    //   137: invokestatic 1859	bbrt:a	()Lbbrt;
    //   140: getfield 2828	bbrt:d	Ljava/lang/String;
    //   143: astore 6
    //   145: aload 6
    //   147: astore 5
    //   149: aload 5
    ...
    //   165: iconst_0
    //   166: bipush 8
    //   168: invokevirtual 2122	java/lang/String:substring	(II)Ljava/lang/String;
    //   171: astore 6
    //   173: aload 7
    //   175: aload 6
    ...
    //   191: aload 8
    //   193: iload_3
    //   194: invokevirtual 711	android/widget/ImageView:setImageResource	(I)V
    //   197: aload 6
    //   199: invokestatic 674	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   202: ifne +107 -> 309
    //   205: aload_0
    ...
    //   212: ldc_w 1381
    //   215: iconst_0
    //   216: invokevirtual 1382	mqq/app/MobileQQ:getSharedPreferences	(Ljava/lang/String;I)Landroid/content/SharedPreferences;
    //   219: invokeinterface 2430 1 0
    ...
    //   253: invokestatic 1388	ajzv:a	()I
    ...
    //   262: aload 6
    //   264: invokeinterface 2437 3 0
    //   269: invokeinterface 2440 1 0
    //   274: pop
    ...
    //   331: aload 6
    //   333: ldc_w 734
    //   336: invokevirtual 739	java/lang/Class:getName	()Ljava/lang/String;
    //   339: invokestatic 744	bawi:a	(Landroid/view/View;Ljava/lang/CharSequence;Ljava/lang/String;)V
    //   342: return
    //   343: aload 9
    //   345: ldc_w 2832
    //   348: invokevirtual 732	android/content/res/Resources:getString	(I)Ljava/lang/String;
    //   351: astore 6
    //   353: aload 6
    //   355: astore 5
    //   357: goto -208 -> 149
    //   360: iload_2
    //   361: ifeq +47 -> 408
    //   364: invokestatic 1859	bbrt:a	()Lbbrt;
    //   367: getfield 2834	bbrt:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   370: invokestatic 674	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   373: ifne +18 -> 391
    //   376: invokestatic 1859	bbrt:a	()Lbbrt;
    //   379: getfield 2834	bbrt:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   382: astore 6
    //   384: aload 6
    //   386: astore 5
    //   388: goto -239 -> 149
    //   391: aload 9
    //   393: ldc_w 2835
    //   396: invokevirtual 732	android/content/res/Resources:getString	(I)Ljava/lang/String;
    //   399: astore 6
    //   401: aload 6
    //   403: astore 5
    //   405: goto -256 -> 149
    ...
    //   410: ldc_w 2837
    //   413: iconst_0
    //   414: invokeinterface 1248 3 0
    //   419: istore 4
    //   421: iload_3
    //   422: ifgt +8 -> 430
    //   425: iload 4
    //   427: ifle +47 -> 474
    //   430: invokestatic 1859	bbrt:a	()Lbbrt;
    //   433: getfield 2838	bbrt:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   436: invokestatic 674	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   439: ifne +18 -> 457
    //   442: invokestatic 1859	bbrt:a	()Lbbrt;
    //   445: getfield 2838	bbrt:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   448: astore 6
    //   450: aload 6
    //   452: astore 5
    //   454: goto -305 -> 149
    //   457: aload 9
    //   459: ldc_w 2839
    //   462: invokevirtual 732	android/content/res/Resources:getString	(I)Ljava/lang/String;
    //   465: astore 6
    //   467: aload 6
    //   469: astore 5
    //   471: goto -322 -> 149
    //   474: invokestatic 1859	bbrt:a	()Lbbrt;
    //   477: getfield 2840	bbrt:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   480: invokestatic 674	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   483: ifne +18 -> 501
    //   486: invokestatic 1859	bbrt:a	()Lbbrt;
    //   489: getfield 2840	bbrt:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   492: astore 6
    //   494: aload 6
    //   496: astore 5
    //   498: goto -349 -> 149
    //   501: aload 9
    //   503: ldc_w 646
    //   506: invokevirtual 732	android/content/res/Resources:getString	(I)Ljava/lang/String;
    //   509: astore 6
    //   511: aload 6
    //   513: astore 5
    //   515: goto -366 -> 149
    ...
    //   522: aload 9
    //   524: ldc_w 2832
    //   527: invokevirtual 732	android/content/res/Resources:getString	(I)Ljava/lang/String;
    //   530: astore 6
    //   532: goto -359 -> 173
    //   535: iload_2
    //   536: ifeq +16 -> 552
    //   539: aload 9
    //   541: ldc_w 2835
    //   544: invokevirtual 732	android/content/res/Resources:getString	(I)Ljava/lang/String;
    //   547: astore 6
    //   549: goto -376 -> 173
    //   552: aload 6
    //   554: ldc_w 2837
    //   557: iconst_0
    //   558: invokeinterface 1248 3 0
    //   563: istore 4
    //   565: iload_3
    //   566: ifgt +8 -> 574
    //   569: iload 4
    ...
    //   574: aload 9
    //   576: ldc_w 2839
    //   579: invokevirtual 732	android/content/res/Resources:getString	(I)Ljava/lang/String;
    //   582: astore 6
    //   584: goto -411 -> 173
    //   587: aload 9
    //   589: ldc_w 646
    //   592: invokevirtual 732	android/content/res/Resources:getString	(I)Ljava/lang/String;
    //   595: astore 6
    //   597: goto -424 -> 173
    //   600: astore 6
    //   602: ldc_w 274
    ...
    //   606: ldc_w 2842
    //   609: aload 6
    //   611: invokestatic 1371	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   614: aload 5
    //   616: astore 6
    //   618: goto -445 -> 173
    //   621: ldc_w 2843
    ...
    //   634: ldc_w 2845
    //   637: aload 5
    //   639: invokestatic 1371	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   642: goto -333 -> 309
    //   645: astore 6
    //   647: goto -45 -> 602
  ...
  {
    if (paramBoolean) {
      return new int[] { 2130845237, 2130845222, 2130845233, 2130845239, 2130845241, 2130845243, 2130845196, 2130845226, 2130845220, 2130845224, 2130845192, 2130845235 };
    }
    return new int[] { 2130845238, 2130845223, 2130845234, 2130845240, 2130845242, 2130845244, 2130845196, 2130845227, 2130845221, 2130845225, 2130845193, 2130845235 };
  }
  ...
  void b()
  {
    ...
    do
    {
      ...
      str = localSharedPreferences.getString("qqsettingme_f2f_guide_tip", ajyc.a(2131710749));
  ...
  protected void e()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Akjp);
      ...
      if (this.jdField_a_of_type_Aweo != null)
      {
        ...
        this.jdField_a_of_type_Aweo.b(this.jdField_a_of_type_Awcb);
      }
      if (this.jdField_a_of_type_Aikx != null)
      {
        this.jdField_a_of_type_Aikx.a(null);
        this.jdField_a_of_type_Aikx = null;
      }
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.unRegistObserver(this.jdField_a_of_type_Atzl);
    }
    VSNetworkHelper.a().a();
    if (this.jdField_a_of_type_Ayma != null) {
      this.jdField_a_of_type_Ayma.a(this.jdField_a_of_type_Aymd, false);
    }
    bbrt.a().b(this.jdField_a_of_type_Bbrv);
    xoz.a().b(this.jdField_a_of_type_Xpa);
  }
  ...
  protected void f()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Ajuh, false);
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Akjp, true);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Akfz, true);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Akab, true);
      if (this.jdField_a_of_type_ComTencentMobileqqApolloSettingMeApolloViewController != null) {
      ...
      this.jdField_a_of_type_Ayma.a(this.jdField_a_of_type_Aymd, true);
      this.jdField_a_of_type_Aikx = ((aikx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(114));
      if (this.jdField_a_of_type_Aikx != null) {
        this.jdField_a_of_type_Aikx.a(this.jdField_a_of_type_Aiky);
      }
      bbrt.a().a(this.jdField_a_of_type_Bbrv);
      xoz.a().a(this.jdField_a_of_type_Xpa);
    }
  }
  
  public void g()
  {
    SosoInterface.a(new abxe(this, 0, true, true, 60000L, true, false, "QQSettingRedesign"));
  }
  ...
  public void h()
  {
    ...
    this.jdField_a_of_type_Ayma = new ayma(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    f();
    l();
    z();
    x();
    ...
    try
    {
      ...
      if (TextUtils.isEmpty(bbrt.a().jdField_b_of_type_JavaLangString)) {
  ...
  protected void k()
  {
    try
    {
      ...
      ((avfa)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(104)).a(this.jdField_g_of_type_ComTencentPbGetbusiinfoBusinessInfoCheckUpdate$AppInfo);
      return;
    }
    catch (Exception localException)
    {
  ...
  protected void l()
  {
    ...
    if (TextUtils.isEmpty(str))
    {
      this.jdField_a_of_type_ComTencentMobileqqAvatarDynamicavatarDynamicAvatarView.setImageDrawable(bbdr.b());
  ...
  public void m()
  {
    ...
    if (axmt.b())
    {
      ...
      this.jdField_d_of_type_AndroidWidgetImageView.setImageResource(2130845228);
      ...
      {
        ((ImageView)this.jdField_a_of_type_ArrayOfAndroidViewView[i2].findViewById(2131368345)).setImageResource(localObject1[i2]);
        localObject2 = (TextView)this.jdField_a_of_type_ArrayOfAndroidViewView[i2].findViewById(2131368385);
        if (this.jdField_j_of_type_Boolean) {
          break label668;
        }
    ...
    {
      if ((axmt.b()) && ("2920".equals(ThemeUtil.getCurrentThemeId()))) {
        ((TextView)localObject2).setTextColor(this.jdField_a_of_type_AndroidViewViewGroup.getResources().getColor(2131166314));
      }
      i2 += 1;
      break label430;
      this.jdField_m_of_type_AndroidViewView.setVisibility(8);
    ...
    label689:
    ((alyz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(180)).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    ...
    ((akfi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(87)).notifyUI(4, true, null);
  }
  ...
  public void n()
  {
    ...
    int i1 = this.jdField_a_of_type_Ayma.a();
    String str;
    if (i1 == 1) {
      if (this.jdField_j_of_type_Boolean)
      {
        localObject1 = ((Resources)localObject2).getDrawable(2130845210);
        str = ((Resources)localObject2).getString(2131699420);
        localObject2 = localObject1;
        localObject1 = str;
      }
    }
    for (;;)
    {
      ...
      return;
      localObject1 = ((Resources)localObject2).getDrawable(2130845209);
      break;
      if (i1 == 2)
      {
        if (this.jdField_j_of_type_Boolean) {}
        for (localObject1 = ((Resources)localObject2).getDrawable(2130845210);; localObject1 = ((Resources)localObject2).getDrawable(2130845209))
        {
          str = ((Resources)localObject2).getString(2131699420);
          localObject2 = localObject1;
          localObject1 = str;
  ...
  {
    boolean bool2 = true;
    boolean bool1 = akva.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      case 2131362994: 
        if (FrameHelperActivity.b())
        {
          ...
          axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8009C4E", "0X8009C4E", 0, 0, "", "", "", "");
          return;
        }
        break;
      case 2131370609: 
      case 2131370633: 
        ...
        while (QLog.isColorLevel())
        {
          ...
          ((Intent)localObject1).putExtra("url", paramView);
          this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.startActivity((Intent)localObject1);
          axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_duty", "", "locker", "clk", 0, 0, "", "", "", "");
        }
      case 2131370833: 
      ...
      case 2131367408: 
        ...
        paramView.h = 8;
        ProfileActivity.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, paramView, 1009);
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004033", "0X8004033", 0, 0, "", "", "", "");
      ...
      case 2131373405: 
        ...
        paramView.putExtra("title", this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getString(2131717241));
        paramView.putExtra("nick", bbcl.h(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject1));
        ...
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X80055BB", "0X80055BB", 0, 0, "", "", "", "");
        return;
      case 2131370643: 
        l1 = System.currentTimeMillis();
        if (ProfileActivity.a(this.jdField_a_of_type_Long, l1))
        {
          ...
          if (QWalletHelper.isValidToLaunchQWallet(l1))
          {
            ...
            axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "My_wallet", "Clk_wallet", 0, 0, "", "", "", "");
            bazw.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
            ((avpq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36)).a(100007, 31);
            paramView = this.jdField_a_of_type_ArrayOfComTencentMobileqqRedtouchRedTouch[1];
            i1 = akjo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), paramView.a());
            axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A8BF", "0X800A8BF", i1, 0, String.valueOf(i1), "", "", "");
      ...
      case 2131370635: 
        ...
        {
          bgpf.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), null, -1, bool);
          bgpr.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1, 0);
          bgpv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
          DrawerFrame.jdField_a_of_type_Int = jdField_a_of_type_Int;
          ((avpq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36)).a(103000, 31);
          return;
        }
      case 2131370642: 
        paramView = (avpq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36);
        bool = false;
        localObject1 = new bgxs();
        ((bgxs)localObject1).a("443");
        ((bgxs)localObject1).b("3");
        ((bgxs)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getLongAccountUin());
        ...
        for (;;)
        {
          QZoneClickReport.startReportImediately(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), (bgxs)localObject1);
          ...
          try
          {
            ...
            localObject2 = bgyf.a();
            ((bgyf)localObject2).jdField_a_of_type_JavaLangString = String.valueOf(l1);
            localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentNickname();
            paramView = (View)localObject1;
            if (TextUtils.isEmpty((CharSequence)localObject1)) {
              paramView = bbcl.h(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
            }
            ((bgyf)localObject2).jdField_b_of_type_JavaLangString = paramView;
            bgxy.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, (bgyf)localObject2, Long.valueOf(l1), 0, bool, -1);
            paramView = new bgxs();
            ...
            axrl.a(BaseApplicationImpl.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "actQZSourceDataReport", true, 0L, 0L, paramView, null);
            axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "Setting_tab", "Clk_myalbum", 0, 0, "", "", "", "");
            DrawerFrame.jdField_a_of_type_Int = jdField_a_of_type_Int;
            return;
            ((bgxs)localObject1).c("2");
          }
      ...
      case 2131370610: 
        ...
        ((avpq)localObject1).a(100005, 31);
        if (((RedTouch)((ViewGroup)paramView).getChildAt(0)).a()) {}
        for (paramView = bhdv.b(((avpq)localObject1).a(String.valueOf(100005)));; paramView = bhdv.a("outside", "3"))
        {
          ...
          axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "Trends_tab", "Personality_setting", 0, 0, "", "", "", "");
          DrawerFrame.jdField_a_of_type_Int = jdField_a_of_type_Int;
          return;
        }
      case 2131375986: 
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.startActivity(paramView);
        if (akva.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {
          axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004DB0", "0X8004DB0", 0, 0, "", "", akva.a(), "");
        }
        if ((this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper != null) && (this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.a != null) && (this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.a.iUpgradeType > 0)) {
          ajuf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.a.iNewTimeStamp);
        }
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "Setting_tab", "Setting_tab", 0, 0, "", "", "", "");
        ((avpq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36)).a(100190, 31);
        DrawerFrame.jdField_a_of_type_Int = jdField_a_of_type_Int;
        return;
      case 2131370842: 
        if (!aylf.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, "", new abwk(this)))
        {
          S();
          return;
        }
      ...
      case 2131369456: 
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.startActivity(paramView);
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A9C3", "0X800A9C3", 0, 0, "", "", "", "");
        return;
      case 2131379379: 
        ...
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A42C", "0X800A42C", 0, 0, "", "", "", "");
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005BE4", "0X8005BE4", 0, 0, "", "", "", "");
        return;
      case 2131376194: 
        if ((this.jdField_a_of_type_Aweo != null) && (!this.jdField_a_of_type_Aweo.a()))
        {
          ((avpq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36)).a(100450, 31);
          if ((this.jdField_e_of_type_AndroidViewView != null) && (this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity != null))
          {
            paramView = (TextView)this.jdField_e_of_type_AndroidViewView.findViewById(2131375234);
        ...
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "signiture", "set_enter", 0, 0, "", "", "", "");
      ...
      case 2131370646: 
        ...
        if (ProfileActivity.a(this.jdField_a_of_type_Long, l1))
        {
          ...
          i1 = akjo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), ((RedTouch)localObject1).a());
          if (((RedTouch)localObject1).a()) {}
          for (paramView = bhdv.b(paramView.a(String.valueOf(100400)));; paramView = bhdv.a("outside", "1"))
          {
            axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A8BE", "0X800A8BE", i1, 0, String.valueOf(i1), "", "", "");
            f(paramView);
            axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004185", "0X8004185", 0, 0, "", "", "", "");
            if (jdField_a_of_type_Int <= 0) {
              break;
            }
            DrawerFrame.jdField_a_of_type_Int = 2;
      ...
      case 2131370638: 
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.startActivity(paramView);
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004251", "0X8004251", 0, 0, "", "", "", "");
        DrawerFrame.jdField_a_of_type_Int = jdField_a_of_type_Int;
        paramView = (avpq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36);
    ...
    Object localObject1 = "";
    BusinessInfoCheckUpdate.AppInfo localAppInfo = ((avpq)localObject2).a(String.valueOf(100500));
    paramView = (View)localObject1;
    if (localAppInfo != null)
    {
      ...
      {
        paramView = bhdv.a(localAppInfo);
        ((avpq)localObject2).a(100500, 31);
      }
    }
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.startActivity((Intent)localObject1);
    paramView = this.jdField_a_of_type_ArrayOfComTencentMobileqqRedtouchRedTouch[10];
    int i1 = akjo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), paramView.a());
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A8C0", "0X800A8C0", i1, 0, String.valueOf(i1), "", "", "");
    return;
    ...
    paramView = ayfv.b((String)localObject1, "s_qq_drawer");
    localObject1 = new Intent(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, QQBrowserActivity.class);
    ((Intent)localObject1).putExtra("url", paramView);
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.startActivity((Intent)localObject1);
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800887E", "0X800887E", 0, 0, "", "", "", "");
    return;
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.startActivity((Intent)localObject1);
    i1 = akjo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), false);
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "qvip", "0X800A127", 0, 0, String.valueOf(i1), "", "", "");
    return;
    bazo.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity);
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A97F", "0X800A97F", 0, 0, "0", "0", "", "");
    return;
    i1 = asaw.a(asaw.a(this.jdField_m_of_type_ComTencentPbGetbusiinfoBusinessInfoCheckUpdate$AppInfo));
    paramView = (avpq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36);
    ...
    for (;;)
    {
      ...
      asaw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 2066, "10", i1 + "");
      return;
      label3679:
      a("0x800AAFB", "2");
    }
  ...
  protected void s()
  {
    try
    {
      BusinessInfoCheckUpdate.AppInfo localAppInfo = ((avpq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36)).a(String.valueOf(1000017));
      if (!((amdk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(112)).a())
      {
  ...
  public void u()
  {
    ...
    //   5: invokevirtual 923	com/tencent/mobileqq/app/QQAppInterface:c	()Ljava/lang/String;
    //   8: putfield 3493	com/tencent/mobileqq/activity/QQSettingMe:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   11: aload_0
    //   12: aload_0
    //   13: getfield 3493	com/tencent/mobileqq/activity/QQSettingMe:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   16: invokestatic 3496	akjo:a	(Ljava/lang/String;)LMQQ/PayRuleCfg;
    //   19: putfield 1298	com/tencent/mobileqq/activity/QQSettingMe:jdField_a_of_type_MQQPayRuleCfg	LMQQ/PayRuleCfg;
    //   22: aload_0
    ...
    //   26: aload_0
    //   27: getfield 1298	com/tencent/mobileqq/activity/QQSettingMe:jdField_a_of_type_MQQPayRuleCfg	LMQQ/PayRuleCfg;
    //   30: aload_0
    //   31: getfield 2559	com/tencent/mobileqq/activity/QQSettingMe:jdField_f_of_type_Boolean	Z
    //   34: invokestatic 3499	akjo:a	(Lcom/tencent/mobileqq/app/QQAppInterface;LMQQ/PayRuleCfg;Z)Z
    //   37: istore_1
    //   38: aload_0
    //   39: getfield 1298	com/tencent/mobileqq/activity/QQSettingMe:jdField_a_of_type_MQQPayRuleCfg	LMQQ/PayRuleCfg;
    ...
    //   56: ifeq +345 -> 401
    //   59: aload_0
    //   60: getfield 2559	com/tencent/mobileqq/activity/QQSettingMe:jdField_f_of_type_Boolean	Z
    //   63: ifne +64 -> 127
    //   66: aload_0
    //   67: iconst_1
    //   68: putfield 2559	com/tencent/mobileqq/activity/QQSettingMe:jdField_f_of_type_Boolean	Z
    //   71: aconst_null
    //   72: ldc_w 1219
    //   75: ldc_w 443
    //   78: ldc_w 443
    ...
    //   84: ldc_w 3503
    //   87: aload_0
    //   88: getfield 1298	com/tencent/mobileqq/activity/QQSettingMe:jdField_a_of_type_MQQPayRuleCfg	LMQQ/PayRuleCfg;
    //   91: invokestatic 3506	akjo:a	(LMQQ/PayRuleCfg;)I
    //   94: iconst_1
    //   95: iconst_0
    //   96: ldc_w 1274
    //   99: aload_0
    //   100: getfield 1298	com/tencent/mobileqq/activity/QQSettingMe:jdField_a_of_type_MQQPayRuleCfg	LMQQ/PayRuleCfg;
    //   103: getfield 3509	MQQ/PayRuleCfg:advId	Ljava/lang/String;
    //   106: ldc_w 443
    //   109: ldc_w 443
    //   112: invokestatic 3512	axqw:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IIILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   115: bipush 101
    //   117: aload_0
    //   118: getfield 1298	com/tencent/mobileqq/activity/QQSettingMe:jdField_a_of_type_MQQPayRuleCfg	LMQQ/PayRuleCfg;
    //   121: getfield 3509	MQQ/PayRuleCfg:advId	Ljava/lang/String;
    //   124: invokestatic 3515	akjo:a	(ILjava/lang/String;)V
    //   127: aload_0
    //   128: invokespecial 3517	com/tencent/mobileqq/activity/QQSettingMe:X	()V
    ...
    //   154: aload_0
    //   155: getfield 971	com/tencent/mobileqq/activity/QQSettingMe:jdField_d_of_type_ComTencentPbGetbusiinfoBusinessInfoCheckUpdate$AppInfo	Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$AppInfo;
    //   158: invokestatic 3520	avpq:a	(Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$AppInfo;)Ljava/lang/String;
    ...
    //   170: new 1019	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$AppInfo
    //   173: dup
    //   174: invokespecial 1412	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$AppInfo:<init>	()V
    //   177: astore_2
    //   178: aload_2
    //   179: aload_0
    //   180: getfield 971	com/tencent/mobileqq/activity/QQSettingMe:jdField_d_of_type_ComTencentPbGetbusiinfoBusinessInfoCheckUpdate$AppInfo	Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$AppInfo;
    //   183: invokevirtual 1415	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$AppInfo:set	(Lcom/tencent/mobileqq/pb/MessageMicro;)V
    //   186: iload_1
    //   187: ifeq +54 -> 241
    //   190: aload_2
    //   191: invokestatic 3523	com/tencent/mobileqq/redtouch/RedTouchTextView:a	(Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$AppInfo;)Ljava/util/List;
    //   194: ifnull +47 -> 241
    //   197: new 91	java/util/ArrayList
    //   200: dup
    //   201: invokespecial 94	java/util/ArrayList:<init>	()V
    //   204: astore_3
    //   205: new 1449	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$RedTypeInfo
    //   208: dup
    //   209: invokespecial 1473	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$RedTypeInfo:<init>	()V
    //   212: astore 4
    //   214: aload 4
    //   216: getfield 1453	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$RedTypeInfo:red_type	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   219: iconst_0
    //   220: invokevirtual 1475	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   223: aload_3
    //   224: aload 4
    //   226: invokevirtual 991	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   229: pop
    //   230: aload_2
    //   231: getfield 1427	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$AppInfo:red_display_info	Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$RedDisplayInfo;
    //   234: getfield 1436	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$RedDisplayInfo:red_type_info	Lcom/tencent/mobileqq/pb/PBRepeatMessageField;
    //   237: aload_3
    //   238: invokevirtual 1472	com/tencent/mobileqq/pb/PBRepeatMessageField:set	(Ljava/util/List;)V
    //   241: aload_0
    //   242: iconst_0
    //   243: aload_2
    //   244: invokespecial 1293	com/tencent/mobileqq/activity/QQSettingMe:a	(ILcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$AppInfo;)V
    //   247: aload_0
    ...
    //   251: ifnull +61 -> 312
    //   254: aload_0
    //   255: getfield 971	com/tencent/mobileqq/activity/QQSettingMe:jdField_d_of_type_ComTencentPbGetbusiinfoBusinessInfoCheckUpdate$AppInfo	Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$AppInfo;
    //   258: ifnull +163 -> 421
    //   261: aload_0
    //   262: getfield 971	com/tencent/mobileqq/activity/QQSettingMe:jdField_d_of_type_ComTencentPbGetbusiinfoBusinessInfoCheckUpdate$AppInfo	Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$AppInfo;
    //   265: getfield 1419	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$AppInfo:iNewFlag	Lcom/tencent/mobileqq/pb/PBInt32Field;
    //   268: invokevirtual 1423	com/tencent/mobileqq/pb/PBInt32Field:get	()I
    //   271: iconst_1
    //   272: if_icmpeq +6 -> 278
    //   275: goto +146 -> 421
    //   278: ldc_w 274
    ...
    //   288: new 2067	android/content/Intent
    //   291: dup
    //   292: aload_0
    ...
    //   296: ldc_w 3527
    //   299: invokespecial 2072	android/content/Intent:<init>	(Landroid/content/Context;Ljava/lang/Class;)V
    //   302: astore_2
    //   303: aload_0
    ...
    //   307: aload_2
    //   308: invokevirtual 3531	com/tencent/mobileqq/app/BaseActivity:startService	(Landroid/content/Intent;)Landroid/content/ComponentName;
    //   311: pop
    //   312: return
    //   313: ldc_w 274
    //   316: iconst_1
    ...
    //   330: aload_0
    //   331: getfield 1298	com/tencent/mobileqq/activity/QQSettingMe:jdField_a_of_type_MQQPayRuleCfg	LMQQ/PayRuleCfg;
    //   334: getfield 1303	MQQ/PayRuleCfg:iconText	Ljava/lang/String;
    ...
    //   346: iload_1
    //   347: invokevirtual 1119	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   350: ldc_w 3537
    //   353: invokevirtual 432	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   356: aload_0
    //   357: getfield 1298	com/tencent/mobileqq/activity/QQSettingMe:jdField_a_of_type_MQQPayRuleCfg	LMQQ/PayRuleCfg;
    //   360: getfield 1306	MQQ/PayRuleCfg:iconUrl	Ljava/lang/String;
    ...
    //   372: aload_0
    //   373: getfield 2559	com/tencent/mobileqq/activity/QQSettingMe:jdField_f_of_type_Boolean	Z
    //   376: invokevirtual 1119	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    ...
    //   393: ldc_w 3541
    //   396: aload_2
    //   397: invokestatic 1371	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   400: return
    //   401: aload_0
    //   402: invokevirtual 3544	com/tencent/mobileqq/activity/QQSettingMe:w	()V
    //   405: goto -274 -> 131
    //   408: astore_2
    //   409: ldc_w 274
    //   412: iconst_2
    //   413: ldc_w 3546
    //   416: aload_2
    //   417: invokestatic 1371	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   420: return
    //   421: iload_1
    //   422: ifeq -110 -> 312
    //   425: goto -147 -> 278
  ...
  public void y()
  {
    ExtensionInfo localExtensionInfo = ((ajxn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), false);
    if (axmt.b())
    {
    ...
    for (;;)
    {
      ...
      if ((!this.jdField_i_of_type_Boolean) && (localExtensionInfo != null) && (localExtensionInfo.isPendantValid()))
      {
        ...
        if (bbby.a(localExtensionInfo.pendantId))
        {
          ...
          axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "AvatarPendant", "choutishow", 0, 0, "", "", "", "");
        }
      }
      for (int i1 = 1;; i1 = 0)
      {
  ...
  {
    this.jdField_a_of_type_Aweo = ((aweo)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(15));
    if ((this.jdField_a_of_type_Aweo == null) || (this.jdField_e_of_type_AndroidViewView == null)) {
      return;
    }
    if (this.jdField_a_of_type_Awcg == null)
    {
      this.jdField_a_of_type_Awcg = new abwo(this);
      this.jdField_a_of_type_Awcd = new abwp(this);
      this.jdField_a_of_type_Awcb = new abwq(this);
      this.jdField_a_of_type_Aweo.a(this.jdField_a_of_type_Awcg);
      this.jdField_a_of_type_Aweo.a(this.jdField_a_of_type_Awcd);
      this.jdField_a_of_type_Aweo.a(this.jdField_a_of_type_Awcb);
    }
    RichStatus localRichStatus = this.jdField_a_of_type_Aweo.a(false);
