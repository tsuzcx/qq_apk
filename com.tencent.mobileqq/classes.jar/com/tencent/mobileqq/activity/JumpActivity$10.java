...
class JumpActivity$10
  implements Runnable
{
  JumpActivity$10(JumpActivity paramJumpActivity, asmg paramasmg, Intent paramIntent, int paramInt) {}
  
  public void run()
  {
    if (!this.jdField_a_of_type_Asmg.a(this.jdField_a_of_type_AndroidContentIntent, this.jdField_a_of_type_AndroidContentIntent.getAction()))
    {
