...
class QQSettingMeWeatherListener
  implements WeatherManager.WeatherUpdaterListener
{
  private WeakReference<QQSettingMe> a;
  
  QQSettingMeWeatherListener(QQSettingMe paramQQSettingMe)
  {
  ...
  public void a(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    return;
    localQQSettingMe.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.requestPermissions(new QQSettingMeWeatherListener.1(this, localQQSettingMe), 1, new String[] { "android.permission.ACCESS_FINE_LOCATION" });
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.QQSettingMeWeatherListener
