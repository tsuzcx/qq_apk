  ...
  extends SubAccountObserver
{
  ...
  protected void onGetKeyBack(String paramString1, String paramString2, String paramString3)
  {
    ...
    {
      LoginInfoActivity.access$1700(this.b.c).post(new LoginInfoActivity.10.1.2(this));
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.d("LoginInfoActivity.AccDevSec", 2, "onGetKeyBack begin to kickOutDev");
    }
    if (EquipmentLockImpl.a().a(this.b.c.app, this.a.iAppId, (byte)1, HexUtil.hexStr2Bytes(paramString3), this.b.b))
    {
      LoginInfoActivity.access$2300(this.b.c, 1);
      return;
    }
    LoginInfoActivity.access$1700(this.b.c).post(new LoginInfoActivity.10.1.1(this));
  }
}
