  ...
  extends SwipeBackLayout
{
  ...
  public QQBrowserSwipeLayout(Context paramContext, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidViewGestureDetector = new GestureDetector(paramContext, new adyd(this, paramContext));
  }
  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        if ((this.jdField_b_of_type_Int < this.jdField_e_of_type_Int / 3) && ((this.jdField_a_of_type_Uht.a()) || (!a(paramMotionEvent))) && (this.jdField_e_of_type_Boolean)) {
