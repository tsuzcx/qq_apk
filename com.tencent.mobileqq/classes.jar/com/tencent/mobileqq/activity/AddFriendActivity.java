...
{
  private Handler jdField_a_of_type_AndroidOsHandler = new rmt(this);
  private InputMethodManager jdField_a_of_type_AndroidViewInputmethodInputMethodManager;
  private EditText jdField_a_of_type_AndroidWidgetEditText;
  private TextView jdField_a_of_type_AndroidWidgetTextView;
  ContactSearchFacade.ISearchListener jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactContactSearchFacade$ISearchListener = new rmp(this);
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqAppTroopObserver = new rmq(this);
  }
  ...
  private void c()
  {
    Button localButton = (Button)findViewById(2131362888);
    TextView localTextView = (TextView)findViewById(2131362886);
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)findViewById(2131362871));
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(this);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131362889));
    if (this.jdField_a_of_type_Boolean)
    {
      setTitle(2131434764);
      localTextView.setText(2131434766);
      this.jdField_a_of_type_AndroidWidgetEditText.setFilters(new InputFilter[] { new InputFilter.LengthFilter(25) });
      localTextView.setVisibility(8);
      findViewById(2131362887).setVisibility(8);
      Object localObject1 = findViewById(2131362884);
      ...
      localObject1 = findViewById(2131362885);
    ...
    for (;;)
    {
      ...
      return;
      setTitle(2131434763);
      this.jdField_a_of_type_AndroidWidgetEditText.setHint(2131434765);
      localTextView.setText(2131434765);
    }
  ...
  {
    runOnUiThread(new rmr(this, paramInt));
  }
  ...
  {
    runOnUiThread(new rms(this, paramString));
  }
