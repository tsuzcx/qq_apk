  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    do
    {
      ...
      {
        if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie$42.this$0.jdField_a_of_type_Aymw != null) {
          this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie$42.this$0.jdField_a_of_type_Aymw.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie$42.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.shmsgseq, false);
        }
      ...
      i = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie$42.this$0.jdField_a_of_type_Acka.a((ChatMessage)this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
    } while (i == -1);
