  ...
  extends QIPCModule
{
  ...
  private ConcurrentHashMap<Integer, ajjb> mBusinessInfoMap = new ConcurrentHashMap();
  ...
  public static void register(int paramInt, String paramString)
  {
    ...
    {
      ajjb localajjb = new ajjb();
      localajjb.a = paramInt;
      paramString.put(Integer.valueOf(paramInt), localajjb);
  ...
  public ajjb getBusinessInfo(int paramInt)
  {
    return (ajjb)this.mBusinessInfoMap.get(Integer.valueOf(paramInt));
  }
