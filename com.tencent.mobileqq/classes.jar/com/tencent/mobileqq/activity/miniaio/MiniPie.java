  ...
  implements Handler.Callback, TextWatcher, View.OnClickListener, IChatWindow, AbsListView.OnScrollButtomListener, AbsListView.OnScrollListener, OverScrollViewListener, Observer
{
  ...
  private void A()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130850243);
  ...
  private void B()
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130844959);
      localImageView = (ImageView)this.jdField_d_of_type_AndroidWidgetRelativeLayout.findViewById(2131369501);
      localImageView.setBackgroundResource(0);
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130850547));
      localImageView = (ImageView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131368865);
      Object localObject = localImageView.getLayoutParams();
      if ((localObject instanceof RelativeLayout.LayoutParams))
      {
        localObject = (RelativeLayout.LayoutParams)localObject;
        ((RelativeLayout.LayoutParams)localObject).width = AIOUtils.a(35.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
        ((RelativeLayout.LayoutParams)localObject).height = AIOUtils.a(35.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
        localImageView.setLayoutParams((ViewGroup.LayoutParams)localObject);
      }
      localImageView.setBackgroundResource(0);
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130851150));
      this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131167030));
    ...
    this.jdField_b_of_type_AndroidWidgetTextView.setAlpha(0.8F);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130844958);
    ImageView localImageView = (ImageView)this.jdField_d_of_type_AndroidWidgetRelativeLayout.findViewById(2131369501);
    localImageView.setBackgroundResource(0);
    if (SimpleUIUtil.a()) {
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130844893));
    }
    for (;;)
    {
      localImageView = (ImageView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131368865);
      localImageView.setBackgroundResource(0);
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130851151));
      return;
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130850548));
    }
  }
  ...
  private void F()
  {
    ...
    List localList1 = this.jdField_a_of_type_ComTencentMobileqqActivityMiniaioMiniChatAdapter.a();
    List localList2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().a(this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Int, -1L, true);
  ...
  private void a(int paramInt)
  {
    ...
    if (this.jdField_c_of_type_AndroidWidgetTextView == null)
    {
      ...
      ((TextView)localObject1).setId(2131371965);
      ((TextView)localObject1).setBackgroundResource(2130838483);
  ...
  public SpannableString a(boolean paramBoolean)
  {
    ...
    if (((HotChatManager)localQQAppInterface.getManager(QQManagerFactory.HOT_CHAT_MANAGER)).a(((SessionInfo)localObject).jdField_a_of_type_JavaLangString) != null)
    {
      bool1 = true;
      str1 = ContactUtils.a(localQQAppInterface, ((SessionInfo)localObject).jdField_a_of_type_Int, ((SessionInfo)localObject).jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqDataMessageForReplyText$SourceMsgInfo.mSourceMsgSenderUin + "");
    ...
    {
      localObject = AtTroopMemberSpan.a(localQQAppInterface, localContext, str2, str3, str1, bool1, localXEditTextEx, bool2, true);
    ...
    for (;;)
    {
      this.jdField_a_of_type_ComTencentWidgetXEditTextEx.getEditableText().insert(m, (CharSequence)localObject);
      return localObject;
  ...
  {
    if (paramView == null) {
      paramLayoutInflater = paramLayoutInflater.inflate(2131558941, paramViewGroup, false);
    }
    for (;;)
    {
      this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)paramLayoutInflater.findViewById(2131362327));
      this.jdField_c_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131364598));
  ...
  protected void a(int paramInt, long paramLong)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d(this.jdField_a_of_type_JavaLangString, 2, "refresh with refreshFlag: " + m + " scrollFlag: " + paramInt);
        }
  ...
  protected void a(Context paramContext)
  {
    ...
    {
      int m = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131299166);
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonMainPanel = ((EmoticonMainPanel)View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131559200, null));
      ...
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonMainPanel.init((QQAppInterface)localAppRuntime, 100003, this.jdField_a_of_type_AndroidContentContext, m, null, null, false);
      ...
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonMainPanel.setDispatchKeyEventListener(new MiniPie.8(this));
      return;
    }
  ...
  protected void a(List<ChatMessage> paramList1, List<ChatMessage> paramList2)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d(this.jdField_a_of_type_JavaLangString, 2, "listViewSrollPosition tempBindType " + m);
    }
    switch (m)
    {
    case 65536: 
    ...
    if (paramBoolean)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getOverScrollHeaderView() == null)
      {
        if (this.jdField_a_of_type_AndroidViewView == null) {
          this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559007, null);
        }
  ...
  public boolean a()
  {
    ...
    this.jdField_a_of_type_ComTencentImcoreMessageQQMessageFacade$RefreshMessageContext.a = new ChatContext(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    this.jdField_a_of_type_ComTencentImcoreMessageQQMessageFacade$RefreshMessageContext.jdField_h_of_type_Boolean = true;
    return true;
  }
  ...
  {
    int m = 0xFFFF & this.jdField_f_of_type_Int;
    MiniPieHelper localMiniPieHelper = (MiniPieHelper)a(1);
    if (QLog.isColorLevel()) {
      QLog.d(this.jdField_a_of_type_JavaLangString, 2, "listViewSrollPosition tempScrollType " + m);
    }
    switch (m)
    {
    case 5: 
    ...
    case 7: 
    default: 
      if (localMiniPieHelper != null) {
        this.jdField_g_of_type_Int = localMiniPieHelper.a(paramList1, paramList2, this.jdField_g_of_type_Int);
      }
      break;
    }
    for (;;)
    {
      ...
      if (m != 0)
      {
        this.jdField_f_of_type_Int = (m + this.jdField_f_of_type_Int);
      ...
      if (localMiniPieHelper != null)
      {
        ...
        if (localMiniPieHelper != null)
        {
          this.jdField_g_of_type_Int = localMiniPieHelper.a(this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView, this.jdField_g_of_type_Int, paramList1, paramList2);
          continue;
          if (localMiniPieHelper != null)
          {
            localMiniPieHelper.a(this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView, 0, paramList1, paramList2);
            m = paramList1.size();
            this.jdField_g_of_type_Int = (paramList2.size() + this.jdField_g_of_type_Int - m);
          }
        }
      }
    }
  ...
  protected void d()
  {
    ...
    {
      if (("1103".equals(ThemeUtil.curThemeId)) || ("2920".equals(ThemeUtil.curThemeId))) {
        this.jdField_a_of_type_AndroidViewViewGroup.setBackgroundResource(2130850444);
      }
    }
    else {
      return;
    }
    this.jdField_a_of_type_AndroidViewViewGroup.setBackgroundResource(2130850678);
  }
  ...
  protected void e()
  {
    this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView = ((ChatXListView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131370460));
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getHeaderViewsCount() == 0)
    {
      ...
      ((View)localObject).setId(2131362466);
  ...
  protected void g()
  {
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131377159));
    ...
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131369487));
    this.jdField_b_of_type_AndroidWidgetRelativeLayout.setOnClickListener(this);
    this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
    this.jdField_d_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131377177));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131379523));
    this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
    ImageView localImageView1 = (ImageView)this.jdField_d_of_type_AndroidWidgetRelativeLayout.findViewById(2131369501);
    localImageView1.setOnClickListener(this);
    if ((this.jdField_e_of_type_Boolean) && (!this.jdField_d_of_type_Boolean))
    {
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_d_of_type_AndroidWidgetRelativeLayout.findViewById(2131369496));
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_f_of_type_Int == 2) || (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_f_of_type_Int == 5))
    {
      ImageView localImageView2 = (ImageView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131368865);
      Object localObject = localImageView2.getLayoutParams();
      if ((localObject instanceof RelativeLayout.LayoutParams))
      {
        localObject = (RelativeLayout.LayoutParams)localObject;
        ((RelativeLayout.LayoutParams)localObject).width = AIOUtils.a(13.5F, this.jdField_a_of_type_AndroidContentContext.getResources());
        ((RelativeLayout.LayoutParams)localObject).height = AIOUtils.a(13.5F, this.jdField_a_of_type_AndroidContentContext.getResources());
        localImageView2.setLayoutParams((ViewGroup.LayoutParams)localObject);
      }
      localImageView2.setImageResource(2130850512);
      this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
      localImageView1.setImageResource(2130850673);
      if (Build.VERSION.SDK_INT >= 16) {
  ...
  protected void h()
  {
    this.jdField_b_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131369142));
    ...
    i();
    this.jdField_a_of_type_ComTencentWidgetXEditTextEx = ((XEditTextEx)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131369141));
    ...
    try
    {
      ...
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131367663));
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
      Object localObject = (PanelIconLinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131372729);
      ((PanelIconLinearLayout)localObject).setPanelIconListener(new MiniPie.1(this));
      if (this.jdField_d_of_type_Boolean)
      {
        ((PanelIconLinearLayout)localObject).setCustomHeight(AIOUtils.a(50.0F, ((PanelIconLinearLayout)localObject).getContext().getResources()));
        ...
        {
          localObject = this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131369150);
          if (localObject != null) {
            ((View)localObject).setBackgroundResource(2130850250);
          }
          this.jdField_b_of_type_AndroidViewViewGroup.setBackgroundResource(2130850250);
          this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setBackgroundResource(2130850251);
          this.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130838385);
          this.jdField_a_of_type_AndroidWidgetButton.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131167017));
        }
  ...
  public void k()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityMiniaioMiniChatProvider.a(6);
  ...
  public void m()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityMiniaioMiniChatProvider.a(10);
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_f_of_type_Int == 2) || (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_f_of_type_Int == 5))
      {
        ...
        Object localObject = AIOUtils.a(new Intent(paramView.getContext(), SplashActivity.class), new int[] { 0, 2 });
        ...
        if (this.jdField_i_of_type_Int == 0)
        {
          ...
          localImageButton.setImageResource(2130840283);
          this.jdField_a_of_type_ComTencentWidgetXPanelContainer.a();
          t();
        }
        else
        {
          ...
          localImageButton.setImageResource(2130840282);
          s();
          continue;
  ...
  {
    this.jdField_a_of_type_ComTencentWidgetXPanelContainer.a();
    this.jdField_a_of_type_ComTencentMobileqqActivityMiniaioMiniChatProvider.a(13);
  ...
  protected void v()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityMiniaioMiniChatAdapter != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityMiniaioMiniChatAdapter.getCount() > 0))
    {
  ...
  protected void w()
  {
    this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131362414));
    this.jdField_a_of_type_AndroidWidgetImageButton.setVisibility(0);
    this.jdField_a_of_type_AndroidWidgetImageButton.setOnClickListener(this);
    AIOUtils.a(this.jdField_a_of_type_AndroidWidgetImageButton, (int)(this.jdField_a_of_type_Float * 5.0F + 0.5F), (int)(this.jdField_a_of_type_Float * 5.0F + 0.5F), 0, 0);
    if (this.jdField_d_of_type_Boolean) {
