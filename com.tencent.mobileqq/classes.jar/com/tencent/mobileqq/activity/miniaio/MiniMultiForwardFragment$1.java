  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      ChatMessage localChatMessage = ((bakq)this.this$0.a.getManager(340)).a(MiniMultiForwardFragment.a(this.this$0));
    ...
    for (;;)
    {
      ...
      {
        localArrayList = MiniMultiForwardFragment.a(this.this$0, awwm.a().a);
      }
      else
      {
