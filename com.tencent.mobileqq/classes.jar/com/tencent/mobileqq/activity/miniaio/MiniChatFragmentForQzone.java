  ...
  extends MiniChatFragment
{
  protected void a()
  {
    ...
    Object localObject2 = (ArkAppMessage)apoe.a(2, (String)localObject4, localBundle, localObject1);
    if (localObject2 == null) {}
    for (;;)
    {
      localObject3 = bcwd.a(localBundle);
      ...
      for (localObject2 = ((QQAppInterface)localObject4).getCurrentAccountUin();; localObject2 = this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.b)
      {
        ...
        ((ArkAppMessage)localObject1).containStructMsg = bbzh.a((QQAppInterface)localObject4, str1, str2, (String)localObject2, i, j, (AbsStructMsg)localObject3);
        i = localBundle.getInt("KEY_MSG_FORWARD_ID");
        adrm.a((QQAppInterface)localObject4, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, (ArkAppMessage)localObject1, i);
        b();
        return;
        localObject1 = "";
        break;
  ...
  protected void b()
  {
    if (this.jdField_a_of_type_Akaj != null) {
      this.jdField_a_of_type_Akaj.a(131075, 0L);
    }
  }
