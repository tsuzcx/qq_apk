...
public class BaseChatpieHelper$IMECommandListener$1
  implements Runnable
{
  public BaseChatpieHelper$IMECommandListener$1(adzp paramadzp, QQAppInterface paramQQAppInterface, String paramString1, int paramInt, String paramString2, Context paramContext, View paramView) {}
  
  public void run()
  {
    long l = 0L;
    Object localObject1 = QQRecorder.a();
    Object localObject2 = berv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), null, 2, null);
    ...
    if (!bhmi.d(this.jdField_a_of_type_JavaLangString, str)) {
    ...
    do
    {
      ...
      localObject3 = new bilb((String)localObject2, this.jdField_a_of_type_Int, ((QQRecorder.RecorderParam)localObject1).b, ((QQRecorder.RecorderParam)localObject1).c, 0);
      bile.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), (bilb)localObject3, null, null, bilg.a(str));
      adzp.a(this.this$0).a((String)localObject2, (int)d, (QQRecorder.RecorderParam)localObject1, this.b);
