  ...
  extends FragmentActivity
{
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    if (aekt.a(this, this.app, true, getIntent())) {
      return false;
    }
  ...
  public void doOnNewIntent(Intent paramIntent)
  {
    ...
    if (aekt.a(this, this.app, false, getIntent())) {}
    for (;;)
    {
      return;
  ...
  public boolean showPreview()
  {
    ...
    try
    {
      this.jdField_a_of_type_AndroidViewView = ((View)findViewById(2131366414).getParent());
