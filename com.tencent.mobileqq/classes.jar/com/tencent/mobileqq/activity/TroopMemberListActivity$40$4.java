...
public class TroopMemberListActivity$40$4
  implements Runnable
{
  public TroopMemberListActivity$40$4(afvt paramafvt, List paramList) {}
  ...
  public void run()
  {
    ...
    do
    {
      ...
      localObject1 = this.jdField_a_of_type_Afvt.a.a.obtainMessage();
      ((Message)localObject1).what = 11;
      ((Message)localObject1).obj = localTroopInfo;
      this.jdField_a_of_type_Afvt.a.a.sendMessage((Message)localObject1);
