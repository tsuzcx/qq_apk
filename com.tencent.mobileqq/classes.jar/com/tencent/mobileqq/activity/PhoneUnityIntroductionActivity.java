  ...
  implements View.OnClickListener
{
  ...
  protected void doOnActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    paramIntent.putExtra("selfSet_leftViewText", getString(2131436810));
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    super.setContentView(2130970529);
    super.setTitle(getString(2131436856));
    ...
    if (this.a == 0)
    {
      ...
      default: 
        ...
        paramBundle = (TextView)super.findViewById(2131365432);
        if (this.a == 9)
        {
    ...
    for (;;)
    {
      paramBundle = (Button)super.findViewById(2131370970);
      if (paramBundle != null) {
      ...
      paramBundle = "设置";
      break label119;
      paramBundle.setText(2131436860);
      break label188;
  ...
  {
    if (paramView.getId() == 2131370970)
    {
      if (NetworkUtil.d(this)) {
        break label40;
      }
      if (!isFinishing()) {
        QQToast.a(this, 0, 2131434629, 0).b(super.getTitleBarHeight());
      }
    }
    label40:
    do
