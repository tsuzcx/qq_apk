  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    do
    {
      ...
      {
        localObject1 = ((aukp)localObject2).a(TroopMemberInfo.class, false, "troopuin=? ", new String[] { this.this$0.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin }, null, null, null, null);
        ((aukp)localObject2).a();
      }
