  ...
  extends BaseActivity
{
  ...
  FriendListObserver jdField_a_of_type_ComTencentMobileqqAppFriendListObserver = new tli(this);
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    this.c = ((TextView)findViewById(2131362846));
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(2131433946);
    setTitle(getString(2131433946));
    this.b = ((TextView)findViewById(2131363227));
    this.b.setVisibility(0);
    this.b.setText(2131433681);
    this.b.setOnClickListener(new tlj(this));
  ...
  protected void doOnDestroy()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAdapterRecommendFriendAdapter != null) {
      this.jdField_a_of_type_ComTencentMobileqqAdapterRecommendFriendAdapter.V_();
    }
  }
