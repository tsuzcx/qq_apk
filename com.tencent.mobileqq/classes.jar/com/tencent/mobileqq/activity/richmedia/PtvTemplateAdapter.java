  ...
  implements LbsFilterStatusManager.LbsUpdateFilter
{
  ...
  Handler jdField_a_of_type_AndroidOsHandler = new Handler(new PtvTemplateAdapter.1(this));
  AppInterface jdField_a_of_type_ComTencentCommonAppAppInterface;
  private PtvTemplateAdapter.IPtvTemplateItemCallback jdField_a_of_type_ComTencentMobileqqActivityRichmediaPtvTemplateAdapter$IPtvTemplateItemCallback = new PtvTemplateAdapter.2(this);
  ...
  private PtvTemplateManager.IPtvTemplateDownloadListener jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$IPtvTemplateDownloadListener = new PtvTemplateAdapter.3(this);
  public PtvTemplateManager.PtvTemplateInfo a;
  PtvTemplateManager jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager;
  HorizontalListView.OnScrollStateChangedListener jdField_a_of_type_ComTencentWidgetHorizontalListView$OnScrollStateChangedListener = new PtvTemplateAdapter.4(this);
  ...
  public PtvTemplateAdapter(AppInterface paramAppInterface, Context paramContext, ArrayList<PtvTemplateManager.PtvTemplateInfo> paramArrayList, int paramInt, HorizontalListView paramHorizontalListView, FSurfaceViewLayout paramFSurfaceViewLayout)
  {
  ...
  void a(PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ((PtvTemplateItemView)localObject).a(paramInt, (PtvTemplateManager.PtvTemplateInfo)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt), this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaPtvTemplateAdapter$IPtvTemplateItemCallback);
      break;
