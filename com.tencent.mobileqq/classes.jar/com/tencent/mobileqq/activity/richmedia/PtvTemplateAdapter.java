  ...
  implements LbsFilterStatusManager.LbsUpdateFilter
{
  ...
  private PtvTemplateAdapter.IPtvTemplateItemCallback jdField_a_of_type_ComTencentMobileqqActivityRichmediaPtvTemplateAdapter$IPtvTemplateItemCallback = new xpr(this);
  ...
  private PtvTemplateManager.IPtvTemplateDownloadListener jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$IPtvTemplateDownloadListener = new xps(this);
  public PtvTemplateManager.PtvTemplateInfo a;
  PtvTemplateManager jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager;
  HorizontalListView.OnScrollStateChangedListener jdField_a_of_type_ComTencentWidgetHorizontalListView$OnScrollStateChangedListener = new xpv(this);
  ...
  public PtvTemplateAdapter(AppInterface paramAppInterface, Context paramContext, ArrayList paramArrayList, int paramInt, HorizontalListView paramHorizontalListView, FSurfaceViewLayout paramFSurfaceViewLayout)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new Handler(new xpq(this));
