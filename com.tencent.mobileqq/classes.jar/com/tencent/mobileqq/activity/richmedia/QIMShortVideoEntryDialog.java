  ...
  implements View.OnClickListener
{
  ...
  public QIMShortVideoEntryDialog(@NonNull Context paramContext)
  {
    ...
    paramContext = getLayoutInflater().inflate(2130971527, null);
  ...
  public void a()
  {
    if (!StringUtil.a(this.jdField_a_of_type_JavaLangString))
    {
      ...
      CornerImageView localCornerImageView = (CornerImageView)findViewById(2131374905);
      float f = (int)getContext().getResources().getDimension(2131559446);
    ...
    if (!StringUtil.a(this.b)) {
      ((TextView)findViewById(2131374906)).setText(this.b);
    }
    int i;
    if (!StringUtil.a(this.c))
    {
      ((TextView)findViewById(2131374908)).setText(this.c);
      localObject = (RelativeLayout)findViewById(2131374907);
    ...
    Object localObject = (ImageView)findViewById(2131363954);
    if (localObject != null) {
