  ...
  implements Runnable
{
  ...
  private ahgr jdField_a_of_type_Ahgr;
  private String jdField_a_of_type_JavaLangString;
  private ver jdField_a_of_type_Ver;
  private long b;
  private long c;
  
  public EditLocalVideoMusicMixRunnable(long paramLong1, long paramLong2, long paramLong3, String paramString, ver paramver, ahgr paramahgr)
  {
    ...
    this.jdField_a_of_type_Ahgr = paramahgr;
  }
  ...
  {
    a();
    if (this.jdField_a_of_type_Ver.b == 0) {
      a(ahgm.a(this.jdField_a_of_type_JavaLangString));
    }
    ...
    do
    {
      do
      {
        ...
        localObject1 = ahgm.c(this.jdField_a_of_type_Ver.g);
        QZLog.d("EditLocalVideoMusicMixR", 2, "step 1, run() returned: " + (String)localObject1);
        localArrayList.add(localObject1);
      } while (a((String)localObject1));
      str = ahgm.b((String)localObject1);
      QZLog.d("EditLocalVideoMusicMixR", 2, "step 2, run() returned: " + str);
      localArrayList.add(str);
    } while (a(str));
    Object localObject1 = this.jdField_a_of_type_Ver;
    ((ver)localObject1).d -= 1000;
    if (this.jdField_a_of_type_Ver.d > 0) {}
    for (Object localObject2 = ahgm.a(this.jdField_a_of_type_Ver.d, this.jdField_a_of_type_Ver.e - this.jdField_a_of_type_Ver.d, str);; localObject2 = str)
    {
      ...
      if (this.b - this.jdField_a_of_type_Long > this.jdField_a_of_type_Ver.f) {
        localObject1 = ahgm.a((String)localObject2, (int)((this.b - this.jdField_a_of_type_Long) / this.jdField_a_of_type_Ver.f + 1L));
      }
      ...
      {
        str = ahgm.a(this.jdField_a_of_type_Long, str, this.jdField_a_of_type_Ver.f);
        localObject2 = ahgm.a(Arrays.asList(new String[] { str, localObject1 }));
        localArrayList.add(str);
      }
      ...
      localObject1 = ahgm.a(this.jdField_a_of_type_JavaLangString, (String)localObject2, this.c);
