...
class NewFlowCameraActivity$47
  implements Runnable
{
  NewFlowCameraActivity$47(NewFlowCameraActivity paramNewFlowCameraActivity, boolean paramBoolean, int paramInt) {}
  ...
  public void run()
  {
    if ((this.this$0.jdField_a_of_type_ComTencentMobileqqActivityRichmediaStateRMVideoStateMgr != null) && (this.this$0.jdField_a_of_type_ComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.b.get() != 4))
    {
      ...
      if ((NewFlowCameraActivity.b(this.this$0) != null) && ((this.this$0.jdField_a_of_type_ComTencentMobileqqActivityRichmediaViewFSurfaceViewLayout.a instanceof CameraFilterGLView)))
      {
        ...
        if ((NewFlowCameraActivity.e(this.this$0) != 0) || ((localCameraFilterGLView.a.c) && (FlowCameraConstant.jdField_a_of_type_Int != 2))) {
    ...
    do
    {
      ...
      {
        this.this$0.jdField_a_of_type_AndroidGraphicsDrawableDrawable = GestureRecognitionUtils.a(this.this$0, GestureFilterManager.sGestureType);
