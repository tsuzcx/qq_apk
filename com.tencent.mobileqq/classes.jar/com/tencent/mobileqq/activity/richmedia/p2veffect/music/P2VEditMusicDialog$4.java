  ...
  implements DataProvider.DataUpdateListener<AddressDataProvider.AddressInfo>
{
  ...
  {
    SLog.b(P2VEditMusicDialog.a(), "onAddressUpdate.");
    if ((paramBoolean) && (paramAddressInfo != null))
    {
      SLog.a(P2VEditMusicDialog.a(), "onAddressUpdate success, address=%s", paramAddressInfo);
      this.a.a.post(new P2VEditMusicDialog.4.1(this, paramAddressInfo));
      return;
    }
    SLog.e(P2VEditMusicDialog.a(), "onAddressUpdate failed.");
  }
}
