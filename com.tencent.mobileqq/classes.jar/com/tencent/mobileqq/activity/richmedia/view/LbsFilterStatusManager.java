  ...
  implements LBSDetetor.LBSTemplateListener
{
  ...
  private INetInfoHandler jdField_a_of_type_ComTencentMobileqqMsfSdkHandlerINetInfoHandler = new xuq(this);
  ...
  private LbsFilterStatusManager(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_AndroidUtilSparseArray.put(1, xus.a());
  ...
  private void a(String paramString)
  {
    ...
    {
      if ((xus)this.jdField_a_of_type_AndroidUtilSparseArray.get(i) != null)
      {
  ...
  {
    xus localxus = (xus)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt);
    if (localxus != null)
    {
      ...
      if (localxus.jdField_a_of_type_Int == 3) {
        break label99;
      }
      localxus.jdField_a_of_type_Boolean = paramBoolean;
      if (paramBoolean) {
        localxus.jdField_a_of_type_Int = 2;
      }
    }
    else
    {
    ...
    localxus.jdField_a_of_type_Int = 3;
    a(paramInt);
    return;
    label99:
    a("processLocationPermission", String.format("[Error]Status=%s", new Object[] { localxus.a() }), null);
    localxus.jdField_a_of_type_Boolean = paramBoolean;
    localxus.jdField_a_of_type_JavaUtilArrayList.clear();
    localxus.jdField_a_of_type_Xus.jdField_a_of_type_JavaUtilArrayList.clear();
    a(paramInt);
  }
  ...
  private void b(int paramInt, boolean paramBoolean, ArrayList paramArrayList)
  {
    ...
    if (localxus != null)
    {
      ...
      if (localxus.jdField_a_of_type_Int != 3)
      {
        if (paramBoolean)
        {
          localxus.jdField_a_of_type_JavaUtilArrayList.addAll(paramArrayList);
    ...
    a("processLocationForTemplate", String.format("[Error]templateIds= %s,Status=%s", new Object[] { paramArrayList.toString(), localxus.a() }), null);
  }
  
  private boolean b(int paramInt)
  {
    xus localxus = (xus)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt);
    if ((localxus.jdField_a_of_type_Boolean) && (localxus.a(this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.id))) {}
  ...
  private void d()
  {
    xus localxus = (xus)this.jdField_a_of_type_AndroidUtilSparseArray.get(this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.activityType);
    ...
    if ((localxus == null) || (!this.jdField_a_of_type_Boolean)) {}
    do
    {
      return;
      a("startLocationUsingActivity", String.format("mRequestStatus=%s", new Object[] { localxus.a() }), null);
    } while (localxus.jdField_a_of_type_Int != 3);
    a("startLocationUsingActivity", String.format("mRequestBeginTime=%s", new Object[] { "" + localxus.jdField_a_of_type_Long }), null);
    if (localxus.jdField_a_of_type_Long > 0L)
    {
      long l = System.currentTimeMillis() - localxus.jdField_a_of_type_Long;
    ...
    for (boolean bool = false;; bool = true)
    {
      ...
      localxus.c();
      localxus.b();
      localxus.jdField_a_of_type_Int = 1;
      localxus.jdField_a_of_type_Long = System.currentTimeMillis();
  ...
  public String a(String paramString, boolean[] paramArrayOfBoolean, boolean paramBoolean)
  {
    ...
    for (Object localObject = paramString.substring(i + 1);; localObject = null)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo != null) && (this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.name.equals(localObject)))
      {
        ...
        localObject = (xus)this.jdField_a_of_type_AndroidUtilSparseArray.get(i);
        if (localObject == null) {
          break;
        }
        if (this.jdField_a_of_type_Boolean)
        {
          a("getLbsParamsFileName", String.format("mRequestStatus=%s", new Object[] { "" + ((xus)localObject).jdField_a_of_type_Int }), null);
          a("getLbsParamsFileName", String.format("mHaveLocationPermission=%s", new Object[] { "" + ((xus)localObject).jdField_a_of_type_Boolean }), null);
          a("getLbsParamsFileName", String.format("mLocateInLbsRegion=%s", new Object[] { "" + ((xus)localObject).a(this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.id) }), null);
          if (((xus)localObject).jdField_a_of_type_Int == 3)
          {
            if (!((xus)localObject).jdField_a_of_type_Boolean) {}
            for (;;)
            {
              paramArrayOfBoolean[0] = j;
              if ((!((xus)localObject).jdField_a_of_type_Boolean) || (!((xus)localObject).a(this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.id))) {
                break;
              }
          ...
          a("getLbsParamsFileName", String.format("[cache]mRequestStatus=%s", new Object[] { "" + ((xus)localObject).jdField_a_of_type_Xus.jdField_a_of_type_Int }), null);
          a("getLbsParamsFileName", String.format("[cache]mHaveLocationPermission=%s", new Object[] { "" + ((xus)localObject).jdField_a_of_type_Xus.jdField_a_of_type_Boolean }), null);
          if ((((xus)localObject).jdField_a_of_type_Xus.jdField_a_of_type_Int == 3) && (((xus)localObject).jdField_a_of_type_Xus.jdField_a_of_type_Boolean))
          {
            a("getLbsParamsFileName", String.format("[cache]mLocateInLbsRegion=%s", new Object[] { "" + ((xus)localObject).jdField_a_of_type_Xus.a(this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.id) }), null);
            if (((xus)localObject).jdField_a_of_type_Xus.a(this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.id))
            {
              paramArrayOfBoolean = a(paramString, paramBoolean);
              if (paramArrayOfBoolean != null) {
                return paramArrayOfBoolean;
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.post(new xuo(this, paramInt, paramBoolean));
  }
  ...
  public void a(int paramInt, boolean paramBoolean, ArrayList paramArrayList)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.post(new xup(this, paramInt, paramBoolean, paramArrayList));
  }
