  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    int i = PtvFilterUtils.a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, 4, true, false, this.c, this.jdField_a_of_type_ComTencentMaxvideoCommonAVIOStruct, this.jdField_a_of_type_Bdei.jdField_a_of_type_Int, this.jdField_a_of_type_Boolean, this.d);
    ...
    {
      bdaq localbdaq = localSVHwEncoder.a();
      if (localbdaq == null) {
        break label235;
      }
      ...
      localbdaq.jdField_a_of_type_Long = this.jdField_a_of_type_ComTencentMaxvideoCommonAVIOStruct.vFrameTime;
      if (PtvFilterUtils.a(localbdaq.jdField_a_of_type_ArrayOfByte) == 0) {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Bdei.a();
      this.jdField_a_of_type_Bdbs.b();
      if ((!this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Bdeh.a()) && (this.jdField_a_of_type_Alup != null)) {}
      return;
      label235:
