...
public class GLVideoClipUtil
{
  ...
  public int a;
  private ajsm jdField_a_of_type_Ajsm = new ajsm(this, null);
  ...
  private void a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if ((paramBoolean) && ((bool1) || (bool2)) && (ajli.jdField_a_of_type_Int == 1)) {
    ...
    for (;;)
    {
      ...
      if ((bool1) && (ajli.jdField_a_of_type_Int == 2)) {
  ...
  private boolean a(int paramInt)
  {
    ...
    else
    {
      ...
      if (l1 != paramInt)
      {
        ajsm localajsm = this.jdField_a_of_type_Ajsm;
        localajsm.jdField_a_of_type_Int += 1;
        bool = true;
        if (this.jdField_a_of_type_Ajsm.jdField_a_of_type_Int >= 3) {
          throw new GLVideoClipUtil.GLClipOldLibException("checkDataLength: dataSize=" + l1 + " length=" + paramInt + "prev*preh=" + this.r + " * " + this.s);
        }
      }
      else
      {
        this.jdField_a_of_type_Ajsm.jdField_a_of_type_Int = 0;
      }
    }
    return bool;
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean)
  {
    ...
    if (localazda != null)
    {
      QLog.d("GLVideoClipUtil", 2, "allocateNativeBuffer[CameraControl-]: Width=" + localazda.jdField_a_of_type_Int + " Height=" + localazda.jdField_b_of_type_Int + " width1" + paramInt1 + " height1" + paramInt2);
      i4 = paramInt1;
      i3 = paramInt2;
      i2 = paramInt3;
      i1 = paramInt4;
      if (localazda.jdField_a_of_type_Int > 0)
      {
        ...
        i2 = paramInt3;
        i1 = paramInt4;
        if (localazda.jdField_b_of_type_Int > 0) {
          if (localazda.jdField_a_of_type_Int == paramInt1)
          {
            i4 = paramInt1;
            i3 = paramInt2;
            i2 = paramInt3;
            i1 = paramInt4;
            if (localazda.jdField_b_of_type_Int == paramInt2) {}
          }
          else
          {
            ...
            paramInt2 = localazda.jdField_b_of_type_Int;
    ...
    for (;;)
    {
      i4 = localazda.jdField_a_of_type_Int;
      i3 = localazda.jdField_b_of_type_Int;
      ...
      try
      {
        ...
        if (paramInt1 != 0)
        {
          ...
          label283:
          if (paramInt4 * 1.0F / paramInt3 > localazda.jdField_a_of_type_Int * 1.0F / localazda.jdField_b_of_type_Int)
          {
            paramInt1 = (int)(localazda.jdField_a_of_type_Int * paramInt3 * 1.0F / paramInt4);
            paramInt2 = paramInt1 - paramInt1 % 16;
            paramInt1 = localazda.jdField_a_of_type_Int;
            continue;
          }
          paramInt2 = localazda.jdField_b_of_type_Int;
          paramInt1 = (int)(localazda.jdField_b_of_type_Int * paramInt4 * 1.0F / paramInt3);
  ...
  public boolean a(boolean paramBoolean)
  {
    ...
    ajsi.a("glDrawFrame:err=" + i1 + " errname=" + ajsi.a(i1));
    return bool;
  }
