...
public class GLVideoClipUtil
{
  ...
  public int a;
  private aibc jdField_a_of_type_Aibc = new aibc(this, null);
  ...
  private void a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if ((paramBoolean) && ((bool1) || (bool2)) && (ahty.jdField_a_of_type_Int == 1)) {
    ...
    for (;;)
    {
      ...
      if ((bool1) && (ahty.jdField_a_of_type_Int == 2)) {
  ...
  private boolean a(int paramInt)
  {
    ...
    else
    {
      ...
      if (l1 != paramInt)
      {
        aibc localaibc = this.jdField_a_of_type_Aibc;
        localaibc.jdField_a_of_type_Int += 1;
        bool = true;
        if (this.jdField_a_of_type_Aibc.jdField_a_of_type_Int >= 3) {
          throw new GLVideoClipUtil.GLClipOldLibException("checkDataLength: dataSize=" + l1 + " length=" + paramInt + "prev*preh=" + this.r + " * " + this.s);
        }
      }
      else
      {
        this.jdField_a_of_type_Aibc.jdField_a_of_type_Int = 0;
      }
    }
    return bool;
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean)
  {
    ...
    if (localaxhu != null)
    {
      QLog.d("GLVideoClipUtil", 2, "allocateNativeBuffer[CameraControl-]: Width=" + localaxhu.jdField_a_of_type_Int + " Height=" + localaxhu.jdField_b_of_type_Int + " width1" + paramInt1 + " height1" + paramInt2);
      i4 = paramInt1;
      i3 = paramInt2;
      i2 = paramInt3;
      i1 = paramInt4;
      if (localaxhu.jdField_a_of_type_Int > 0)
      {
        ...
        i2 = paramInt3;
        i1 = paramInt4;
        if (localaxhu.jdField_b_of_type_Int > 0) {
          if (localaxhu.jdField_a_of_type_Int == paramInt1)
          {
            i4 = paramInt1;
            i3 = paramInt2;
            i2 = paramInt3;
            i1 = paramInt4;
            if (localaxhu.jdField_b_of_type_Int == paramInt2) {}
          }
          else
          {
            ...
            paramInt2 = localaxhu.jdField_b_of_type_Int;
    ...
    for (;;)
    {
      i4 = localaxhu.jdField_a_of_type_Int;
      i3 = localaxhu.jdField_b_of_type_Int;
      ...
      try
      {
        ...
        if (paramInt1 != 0)
        {
          ...
          label283:
          if (paramInt4 * 1.0F / paramInt3 > localaxhu.jdField_a_of_type_Int * 1.0F / localaxhu.jdField_b_of_type_Int)
          {
            paramInt1 = (int)(localaxhu.jdField_a_of_type_Int * paramInt3 * 1.0F / paramInt4);
            paramInt2 = paramInt1 - paramInt1 % 16;
            paramInt1 = localaxhu.jdField_a_of_type_Int;
            continue;
          }
          paramInt2 = localaxhu.jdField_b_of_type_Int;
          paramInt1 = (int)(localaxhu.jdField_b_of_type_Int * paramInt4 * 1.0F / paramInt3);
  ...
  public boolean a(boolean paramBoolean)
  {
    ...
    aiay.a("glDrawFrame:err=" + i1 + " errname=" + aiay.a(i1));
    return bool;
  }
