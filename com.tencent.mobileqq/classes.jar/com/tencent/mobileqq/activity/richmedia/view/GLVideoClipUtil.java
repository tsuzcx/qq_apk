...
public class GLVideoClipUtil
{
  ...
  private xun jdField_a_of_type_Xun = new xun(this, null);
  ...
  private boolean a(int paramInt)
  {
    ...
    else
    {
      ...
      if (l1 != paramInt)
      {
        xun localxun = this.jdField_a_of_type_Xun;
        localxun.jdField_a_of_type_Int += 1;
        bool = true;
        if (this.jdField_a_of_type_Xun.jdField_a_of_type_Int >= 3) {
          throw new GLVideoClipUtil.GLClipOldLibException("checkDataLength: dataSize=" + l1 + " length=" + paramInt + "prev*preh=" + this.r + " * " + this.s);
        }
      }
      else
      {
        this.jdField_a_of_type_Xun.jdField_a_of_type_Int = 0;
      }
    }
    return bool;
  }
