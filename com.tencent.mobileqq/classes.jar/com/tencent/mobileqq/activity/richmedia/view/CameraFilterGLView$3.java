...
class CameraFilterGLView$3
  implements Runnable
{
  CameraFilterGLView$3(CameraFilterGLView paramCameraFilterGLView, awmb paramawmb) {}
      ...
      for (;;)
      {
        try
        {
          ...
          if (CameraFilterGLView.c(this.this$0) % 180 == 0)
          {
            ...
            localObject = alrg.a(Bitmap.createBitmap(localBitmap, 0, 0, CameraFilterGLView.a(this.this$0), CameraFilterGLView.b(this.this$0), (Matrix)localObject, true));
            bool = bacm.a((Bitmap)localObject, localFile);
          }
        }
