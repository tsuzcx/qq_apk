  ...
  implements View.OnClickListener
{
  ...
  private QzEditPicPartManager jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager;
  ...
  public EditPicQzComment(@NonNull QzEditPicPartManager paramQzEditPicPartManager)
  {
    super(paramQzEditPicPartManager);
    this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager = paramQzEditPicPartManager;
  }
  ...
  private boolean a(String paramString)
  {
    try
    {
      ...
      this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_b_of_type_Int = paramString.jdField_a_of_type_Int;
      this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_c_of_type_Int = paramString.jdField_b_of_type_Int;
      this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_d_of_type_JavaLangString = paramString.jdField_a_of_type_JavaLangString;
      int i = this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_b_of_type_Int;
      if (i > 0) {
        return true;
      }
    }
  ...
  private void h()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaViewExtendEditText.setTextEffect(this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_e_of_type_JavaLangString);
    String str = FontInterface.a(this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_b_of_type_Int, null, null, null);
    if (TextUtils.isEmpty(str)) {
      this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_b_of_type_Int = -1;
    }
    for (;;)
    {
  ...
  public void a()
  {
    ...
    if (!this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_e_of_type_Boolean) {
      this.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
    }
    if ((this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_b_of_type_Boolean) || (this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_d_of_type_Boolean))
    {
      this.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
      this.jdField_a_of_type_AndroidWidgetCheckBox.setVisibility(0);
      this.jdField_a_of_type_AndroidWidgetCheckBox.setOnCheckedChangeListener(new xus(this));
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if (paramInt1 == 1)
    {
      ...
      if (paramIntent != null)
      {
        ...
        if (paramIntent.containsKey("permission_code")) {
          this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_a_of_type_Int = paramIntent.getInt("permission_code");
        }
        if (paramIntent.containsKey("uin_list"))
        {
          if (this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_a_of_type_JavaUtilArrayList == null) {
            this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
          }
          this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_a_of_type_JavaUtilArrayList.clear();
          localObject = paramIntent.getStringArrayList("uin_list");
          if (localObject != null) {
            this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_a_of_type_JavaUtilArrayList.addAll((Collection)localObject);
          }
        }
        if (a(this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_a_of_type_Int))
        {
          this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_b_of_type_JavaLangString = paramIntent.getString("key_setting_raw_json");
          this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_a_of_type_JavaLangString = paramIntent.getString("key_selected_tag");
        }
        e();
      }
    }
    do
    {
      ...
      if (this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_a_of_type_AndroidViewView != null) {
        this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_a_of_type_AndroidViewView.setVisibility(8);
      }
    ...
    if (localBundle.containsKey("contentIntentKey"))
    {
      ...
      this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_c_of_type_JavaLangString = paramIntent;
    }
    ...
    this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_b_of_type_Int = localBundle.getInt("extra_key_font_id", -1);
    this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_c_of_type_Int = localBundle.getInt("extra_key_font_format_type");
    this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_d_of_type_JavaLangString = localBundle.getString("extra_key_font_url");
    this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_d_of_type_Int = localBundle.getInt("extra_key_super_font_id", -1);
    this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_e_of_type_JavaLangString = localBundle.getString("extra_key_super_font_info");
    h();
  }
  ...
  public void a(int paramInt, Object paramObject)
  {
    ...
    case 7: 
      do
      {
        ...
        if (this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_c_of_type_Boolean) {}
  ...
  public void e()
  {
    this.jdField_a_of_type_JavaLangString = b(this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_a_of_type_Int);
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      if (i == 2131373558)
      {
        ...
        localBundle.putInt("permission_code", this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_a_of_type_Int);
        if ((this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_a_of_type_JavaUtilArrayList.size() > 0))
        {
          localBundle.putStringArrayList("uin_list", this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_a_of_type_JavaUtilArrayList);
          localObject1 = new ArrayList(this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_a_of_type_JavaUtilArrayList.size());
          localObject2 = this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_a_of_type_JavaUtilArrayList.iterator();
        ...
        if ((a(this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_a_of_type_Int)) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_b_of_type_JavaLangString))) {
          localBundle.putString("key_setting_raw_json", this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_b_of_type_JavaLangString);
        }
    ...
    if (this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_a_of_type_AndroidViewView != null) {
      this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_a_of_type_AndroidViewView.setVisibility(0);
    }
    Object localObject1 = (BaseActivity)this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoUi;
    Object localObject2 = this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_c_of_type_JavaLangString;
    if (this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_b_of_type_Boolean) {}
    for (int i = 0;; i = 1)
    {
      QZoneHelper.a((Activity)localObject1, paramView, 1009, "", (String)localObject2, "", "", 0, i, 1, 0, 0, 0, "", 10000, localBundle, this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_b_of_type_Boolean, this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_a_of_type_Boolean, this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_b_of_type_Int, this.jdField_a_of_type_ComTencentBizQqstoryQqonlyQzEditPicPartManager.jdField_d_of_type_Int, true);
      return;
    }
  }
}
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.richmedia.EditPicQzComment
