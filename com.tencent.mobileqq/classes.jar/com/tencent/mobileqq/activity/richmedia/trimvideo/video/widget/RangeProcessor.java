...
public class RangeProcessor
{
  ...
  public RangeProcessor(FrameParent paramFrameParent, float paramFloat1, float paramFloat2, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    this.d = paramInt3;
    paramFrameParent = a(((Context)localObject).getResources(), 2130845351, (int)this.jdField_a_of_type_Float, (int)this.jdField_b_of_type_Float);
    localObject = a(((Context)localObject).getResources(), 2130845353, (int)this.jdField_a_of_type_Float, (int)this.jdField_b_of_type_Float);
  ...
  public void a(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaTrimvideoVideoWidgetRangeProcessor$OnRangeChangeListener.a(this.e, this.f);
      return;
      label148:
      if (this.f - f1 < this.g)
      {
