  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        amao localamao;
        localObject2 = VideoFramesRetriever.a(this.this$0).getFrameAtTime((localamao.jdField_a_of_type_Int + localamao.b) / 2 * 1000L);
        if (localObject2 == null)
        {
          ...
          localamao = (amao)VideoFramesRetriever.a(this.this$0).take();
        ...
        if (((Bitmap)localObject2).getWidth() > ((Bitmap)localObject2).getHeight())
        {
          ...
          localObject2 = new amah();
          ((amah)localObject2).jdField_a_of_type_AndroidGraphicsBitmap = ((Bitmap)localObject1).copy(Bitmap.Config.RGB_565, true);
          ((amah)localObject2).jdField_a_of_type_Int = (localamao.jdField_a_of_type_Int / VideoFramesRetriever.b(this.this$0));
          ((Bitmap)localObject1).recycle();
          QLog.i("VideoFramesRetriever", 1, "end get frame bitmap, cost time=" + (System.currentTimeMillis() - l));
          VideoFramesRetriever.a(this.this$0).a((amah)localObject2);
          VideoFramesRetriever.a(this.this$0).remove(Integer.valueOf(localamao.jdField_a_of_type_Int));
          continue;
        }
        int i = 0;
      }
