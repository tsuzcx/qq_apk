  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ajrr localajrr;
        localObject2 = VideoFramesRetriever.a(this.this$0).getFrameAtTime((localajrr.jdField_a_of_type_Int + localajrr.b) / 2 * 1000L);
        if (localObject2 == null)
        {
          ...
          localajrr = (ajrr)VideoFramesRetriever.a(this.this$0).take();
        ...
        if (((Bitmap)localObject2).getWidth() > ((Bitmap)localObject2).getHeight())
        {
          ...
          localObject2 = new ajrk();
          ((ajrk)localObject2).jdField_a_of_type_AndroidGraphicsBitmap = ((Bitmap)localObject1).copy(Bitmap.Config.RGB_565, true);
          ((ajrk)localObject2).jdField_a_of_type_Int = (localajrr.jdField_a_of_type_Int / VideoFramesRetriever.b(this.this$0));
          ((Bitmap)localObject1).recycle();
          QLog.i("VideoFramesRetriever", 1, "end get frame bitmap, cost time=" + (System.currentTimeMillis() - l));
          VideoFramesRetriever.a(this.this$0).a((ajrk)localObject2);
          VideoFramesRetriever.a(this.this$0).remove(Integer.valueOf(localajrr.jdField_a_of_type_Int));
          continue;
        }
        int i = 0;
      }
