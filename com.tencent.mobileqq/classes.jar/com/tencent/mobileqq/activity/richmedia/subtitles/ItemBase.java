...
public abstract class ItemBase
{
  ...
  public ItemBase(long paramLong1, long paramLong2, boolean paramBoolean)
  {
  ...
  public static void a(RenderBuffer paramRenderBuffer, int paramInt, float paramFloat1, float paramFloat2, RectF paramRectF, float paramFloat3, float paramFloat4)
  {
    ...
    {
      return;
      j = paramRenderBuffer.b();
      k = paramRenderBuffer.c();
    } while ((k <= 0) || (j <= 0));
    b("onDrawFrame start");
    int i = a();
    float f2;
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.richmedia.subtitles.ItemBase
