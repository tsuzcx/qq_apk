...
public class BaseAnimDrawer
{
  ...
  private void f()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecRendererRenderBuffer != null) && (this.jdField_c_of_type_Boolean))
    {
  ...
  public boolean a(long paramLong)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecRendererRenderBuffer == null) {
      this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecRendererRenderBuffer = new RenderBuffer((int)this.jdField_c_of_type_Float, (int)this.jdField_d_of_type_Float, 33984);
    }
    paramLong = a(null, this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecRendererRenderBuffer, paramLong);
  ...
  public byte[] a()
  {
    try
    {
      ...
      Iterator localIterator = this.jdField_a_of_type_JavaUtilTreeMap.entrySet().iterator();
      while (localIterator.hasNext()) {
        ((ArrayList)localObject2).add(((Map.Entry)localIterator.next()).getValue());
      }
      localObject1.writeTypedList((List)localObject2);
    }
    finally {}
    localObject1.writeFloat(this.jdField_a_of_type_Float);
    localObject1.writeFloat(this.jdField_b_of_type_Float);
    localObject1.writeInt(this.jdField_a_of_type_Int);
    localObject1.writeString(this.jdField_a_of_type_JavaLangString);
    Object localObject2 = localObject1.marshall();
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.richmedia.subtitles.BaseAnimDrawer
