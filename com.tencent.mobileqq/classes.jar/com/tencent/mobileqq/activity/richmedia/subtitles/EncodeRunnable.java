  ...
  implements Runnable
{
  ...
  ahme jdField_a_of_type_Ahme = new ahme();
  private ahmo jdField_a_of_type_Ahmo;
  public final String a;
  private WeakReference<ahly> jdField_a_of_type_JavaLangRefWeakReference;
  ...
  public EncodeRunnable(ahly paramahly, int paramInt)
  {
    ...
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramahly);
    try
    {
      this.jdField_a_of_type_Ahmo = new ahmo(paramInt * 11 * 2);
      if (this.jdField_a_of_type_Ahmo == null) {
        return;
      }
    }
    catch (OutOfMemoryError paramahly)
    {
      for (;;)
      {
        QLog.e("EncodeRunnable", 2, "create DataPipe OOM!!");
        this.jdField_a_of_type_Ahmo = null;
      }
    }
    catch (Exception paramahly)
    {
      for (;;)
      {
        paramahly.printStackTrace();
        QLog.e("EncodeRunnable", 2, "DataPipe exception!!" + paramahly);
      }
      if (paramInt != 0)
      {
  ...
  private int a(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    try
    {
      if (this.jdField_a_of_type_Ahmo != null)
      {
        paramInt1 = this.jdField_a_of_type_Ahmo.b(paramArrayOfByte, paramInt1, paramInt2);
        return paramInt1;
      }
    }
  ...
  private void a(SilkCodecWrapper paramSilkCodecWrapper, ahme paramahme)
  {
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        i = 0;
        ahlt localahlt = new ahlt(this.g / 10 * 15);
        l2 = 0L;
        j = 0;
          ...
          if (!this.jdField_a_of_type_Boolean)
          {
            ...
            if (m >= 0)
            {
              ...
              if (m < 8820 - k)
              {
                ...
                i = m;
                continue;
                if (paramahme.a(arrayOfShort1, 0, 4410))
                {
                  ...
                  short[] arrayOfShort2 = localahlt.a();
                  localahlt.a();
                  if ((arrayOfShort2 == null) || (arrayOfShort2.length <= 0)) {
                    break label902;
                  }
                  j = localByteBuffer.position();
                  ahmw.a(arrayOfShort2, 0, arrayOfShort2.length);
                  ...
                  ahmw.a(this.g, arrayOfShort2, arrayOfShort2.length, localByteBuffer);
                  ...
                  ahmw.a(this.g, arrayOfShort1, 4410, localByteBuffer);
                ...
                localahlt.a(arrayOfShort1, 0, 4410);
                l1 = l2;
                break label916;
                j = k / 2;
                i = 0;
                ...
                if (j > 0)
                {
                  ahmw.a(arrayOfShort1, 0, j);
                  ahmw.a(this.g, arrayOfShort1, j, localByteBuffer);
                }
                if ((this.jdField_a_of_type_Long > 0L) && (this.d > 0)) {
        ...
        if (paramSilkCodecWrapper != null)
        {
          ...
          if (paramInt1 < paramSilkCodecWrapper.jdField_a_of_type_Int)
          {
            ...
            else
            {
              ...
              {
                paramArrayOfByte = (ahly)this.jdField_a_of_type_JavaLangRefWeakReference.get();
                if (paramArrayOfByte != null) {
  ...
  {
    this.jdField_a_of_type_Ahme.a(paramBoolean);
  }
  ...
  public void a(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    try
    {
      ...
      if (paramArrayOfByte != null)
      {
        if (this.jdField_a_of_type_Ahmo.b() >= paramInt2)
        {
          this.jdField_a_of_type_Ahmo.c(paramArrayOfByte, paramInt1, paramInt2);
          this.jdField_a_of_type_Ahmo.b();
          return;
        }
        if (QLog.isColorLevel()) {
  ...
  public void run()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 100	com/tencent/mobileqq/activity/richmedia/subtitles/EncodeRunnable:jdField_a_of_type_Ahmo	Lahmo;
    //   4: ifnonnull +23 -> 27
    ...
    //   64: aload_0
    //   65: getfield 61	com/tencent/mobileqq/activity/richmedia/subtitles/EncodeRunnable:jdField_a_of_type_Ahme	Lahme;
    //   68: aload_0
    //   69: getfield 54	com/tencent/mobileqq/activity/richmedia/subtitles/EncodeRunnable:g	I
    //   72: invokevirtual 354	ahme:a	(I)V
    //   75: bipush 237
    ...
    //   152: aload_1
    //   153: aload_0
    //   154: getfield 61	com/tencent/mobileqq/activity/richmedia/subtitles/EncodeRunnable:jdField_a_of_type_Ahme	Lahme;
    //   157: invokespecial 366	com/tencent/mobileqq/activity/richmedia/subtitles/EncodeRunnable:a	(Lcom/tencent/mobileqq/utils/SilkCodecWrapper;Lahme;)V
    //   160: goto -73 -> 87
    //   163: astore_1
    //   164: aload_1
