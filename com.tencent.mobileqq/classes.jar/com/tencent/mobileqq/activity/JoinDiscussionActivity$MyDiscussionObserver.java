  ...
  extends DiscussionObserver
{
      ...
      if (this.a.jdField_a_of_type_JavaUtilList != null)
      {
        ...
        if (((Iterator)localObject3).hasNext())
        {
          ...
          for (;;)
          {
            ...
            {
              localObject2 = ((FriendsManager)this.a.app.getManager(QQManagerFactory.FRIENDS_MANAGER)).b(((DiscussionMemberInfo)localObject1).memberUin);
  ...
  public void a(boolean paramBoolean, long paramLong, int paramInt)
  {
    ...
    {
      if (paramInt != 0) {
        QQToast.a(this.a, HardCodeUtil.a(2131705899), 0).b(this.a.getTitleBarHeight());
      }
