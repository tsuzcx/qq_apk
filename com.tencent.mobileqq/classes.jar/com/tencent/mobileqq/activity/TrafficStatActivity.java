  ...
  implements BusinessObserver
{
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_JavaUtilVector.add(Integer.valueOf(2131362766));
    this.jdField_a_of_type_JavaUtilVector.add(Integer.valueOf(2131362769));
    this.jdField_a_of_type_JavaUtilVector.add(Integer.valueOf(2131362772));
    this.jdField_a_of_type_JavaUtilVector.add(Integer.valueOf(2131362775));
    this.jdField_a_of_type_JavaUtilVector.add(Integer.valueOf(2131362778));
    this.jdField_a_of_type_JavaUtilVector.add(Integer.valueOf(2131362781));
    this.jdField_b_of_type_JavaUtilVector = new Vector();
    this.jdField_b_of_type_JavaUtilVector.add(Integer.valueOf(2131362767));
    this.jdField_b_of_type_JavaUtilVector.add(Integer.valueOf(2131362770));
    this.jdField_b_of_type_JavaUtilVector.add(Integer.valueOf(2131362773));
    this.jdField_b_of_type_JavaUtilVector.add(Integer.valueOf(2131362776));
    this.jdField_b_of_type_JavaUtilVector.add(Integer.valueOf(2131362779));
    this.jdField_b_of_type_JavaUtilVector.add(Integer.valueOf(2131362782));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131362783));
  }
  ...
  public void a(long[] paramArrayOfLong1, long[] paramArrayOfLong2)
  {
    ...
    {
      Toast.makeText(getApplicationContext(), getString(2131434443), 1).show();
      return;
    }
    long l1 = 0L;
    long l2 = 0L;
    ...
    paramArrayOfLong1 = (TextView)findViewById(2131362763);
    paramArrayOfLong2 = (TextView)findViewById(2131362764);
