...
class NotifyPushSettingActivity$24
  extends CardObserver
{
  NotifyPushSettingActivity$24(NotifyPushSettingActivity paramNotifyPushSettingActivity) {}
  ...
  protected void onSetHelloLiveMessageState(boolean paramBoolean1, boolean paramBoolean2, String paramString1, String paramString2)
  {
    ...
    {
      paramString1 = this.a;
      SettingCloneUtil.writeValue(paramString1, paramString1.a, null, "qqsetting_hello_live_message", paramBoolean2);
      paramString1 = new StringBuilder();
      paramString1.append("Set the hell live mesaage result ");
      paramString1.append(paramBoolean1);
      QLog.i("CardObserver_onSetHelloLiveMessage", 1, paramString1.toString());
      return;
    }
    Message localMessage = NotifyPushSettingActivity.a(this.a).obtainMessage();
    ...
    paramString2.append("Failed to HelloLiveMessage State ");
    paramString2.append(paramString1);
    QLog.i("SetHelloLiveMessage_Failure", 1, paramString2.toString());
  }
  ...
  protected void onSetNotDisturb(boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    if (!"not_disturb_from_notify_push_setting_activity".equals(paramString2))
    {
      if (QLog.isColorLevel())
      {
        ...
        QLog.d("IphoneTitleBarActivity", 4, paramString1.toString());
      }
      return;
    }
  ...
  protected void onSetPCActiveState(boolean paramBoolean1, boolean paramBoolean2, String paramString1, String paramString2)
  {
    ...
    {
      paramString1 = this.a;
      SettingCloneUtil.writeValue(paramString1, paramString1.a, null, "qqsetting_pcactive_key", paramBoolean2);
      paramString1 = new StringBuilder();
  ...
  protected void onSetShowPushNotice(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      localObject = this.a;
      SettingCloneUtil.writeValue((Context)localObject, ((NotifyPushSettingActivity)localObject).a, null, "qqsetting_show_push_message", paramBoolean2);
    ...
    QQToast.a(this.a.app.getApp(), 1, this.a.getString(2131718834), 0).b(5);
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.NotifyPushSettingActivity.24
