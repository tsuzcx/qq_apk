  ...
  public void a(List<LockPatternView.Cell> paramList)
  {
    ...
    do
    {
      ...
      if ((paramList != null) && (paramList.size() >= 3))
      {
        ...
        this.a.jdField_a_of_type_AndroidWidgetTextView.setText(2131692924);
      ...
      QQToast.a(this.a, 1, this.a.getString(2131692944), 0).b(this.a.getTitleBarHeight());
      ...
      QQToast.a(this.a, 2, this.a.getString(2131692926), 0).b(this.a.getTitleBarHeight());
    ...
    QQToast.a(this.a, 1, this.a.getString(2131692925), 0).b(this.a.getTitleBarHeight());
  }
