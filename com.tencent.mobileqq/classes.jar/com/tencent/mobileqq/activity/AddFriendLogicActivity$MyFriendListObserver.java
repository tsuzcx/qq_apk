...
class AddFriendLogicActivity$MyFriendListObserver
  extends FriendListObserver
{
  final WeakReference<AddFriendLogicActivity> jdField_a_of_type_MqqUtilWeakReference;
  
  AddFriendLogicActivity$MyFriendListObserver(AddFriendLogicActivity paramAddFriendLogicActivity1, AddFriendLogicActivity paramAddFriendLogicActivity2)
  {
  ...
  public void onQueryUinSafetyFlag(boolean paramBoolean, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.i("addFriendTag", 2, String.format("onQueryUinSafetyFlag [uin:%s, isSuc:%s, type:%s, serviceType:%s, status:%s]", new Object[] { Utils.a(String.valueOf(paramLong)), Boolean.valueOf(paramBoolean), Integer.valueOf(AddFriendLogicActivity.c(this.jdField_a_of_type_ComTencentMobileqqActivityAddFriendLogicActivity)), Integer.valueOf(paramInt1), Integer.valueOf(paramInt2) }));
      }
  ...
  public void onUpdateAddFriend(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, String paramString, Bundle paramBundle)
  {
    ...
    label70:
    for (int i = 2131719040;; i = 2131718552)
    {
  ...
  public void onUpdateAddFriendSetting(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (paramBoolean)
    {
      ...
      catch (Exception paramBundle)
      {
        ...
        {
        default: 
          AddFriendLogicActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityAddFriendLogicActivity, -1, HardCodeUtil.a(2131699933));
          QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityAddFriendLogicActivity.app.getApplication(), 2131718550, 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityAddFriendLogicActivity.getTitleBarHeight());
          this.jdField_a_of_type_ComTencentMobileqqActivityAddFriendLogicActivity.finish();
          return;
        }
      }
      this.jdField_a_of_type_ComTencentMobileqqActivityAddFriendLogicActivity.a(i, localBoolean.booleanValue(), localArrayList, AddFriendVerifyActivity.class, AddFriendLogicActivity.b(this.jdField_a_of_type_ComTencentMobileqqActivityAddFriendLogicActivity));
      return;
      AddFriendLogicActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityAddFriendLogicActivity, -1, this.jdField_a_of_type_ComTencentMobileqqActivityAddFriendLogicActivity.getString(2131718507));
      ...
      while ((this.jdField_a_of_type_ComTencentMobileqqActivityAddFriendLogicActivity.getIntent().getBooleanExtra("webim_qd_ext", false)) && (!TextUtils.isEmpty(paramBundle)))
      {
        ...
        if (AddFriendLogicActivity.c(this.jdField_a_of_type_ComTencentMobileqqActivityAddFriendLogicActivity) == 2) {
          ((PhoneContactManagerImp)this.jdField_a_of_type_ComTencentMobileqqActivityAddFriendLogicActivity.app.getManager(QQManagerFactory.CONTACT_MANAGER)).b();
        }
      }
      ...
      AddFriendLogicActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityAddFriendLogicActivity, -1, HardCodeUtil.a(2131699932));
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityAddFriendLogicActivity.app.getApplication(), HardCodeUtil.a(2131699929), 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityAddFriendLogicActivity.getTitleBarHeight());
      this.jdField_a_of_type_ComTencentMobileqqActivityAddFriendLogicActivity.setResult(-1);
      this.jdField_a_of_type_ComTencentMobileqqActivityAddFriendLogicActivity.finish();
      return;
    }
    AddFriendLogicActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityAddFriendLogicActivity, -1, HardCodeUtil.a(2131699936));
    QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityAddFriendLogicActivity.app.getApplication(), 2131718550, 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityAddFriendLogicActivity.getTitleBarHeight());
    this.jdField_a_of_type_ComTencentMobileqqActivityAddFriendLogicActivity.finish();
  }
}
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.AddFriendLogicActivity.MyFriendListObserver
