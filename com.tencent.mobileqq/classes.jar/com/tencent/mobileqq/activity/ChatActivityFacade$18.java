  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    String str = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131696078);
    ChatActivityFacade.b.setMainTitle(str);
    ChatActivityFacade.b.addButton(2131691558, 3);
    ChatActivityFacade.b.addCancelButton(2131690800);
