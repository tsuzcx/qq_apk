  ...
  implements View.OnClickListener
{
  ...
  public Button a;
  public TextView a;
  EmoticonObserver jdField_a_of_type_ComTencentMobileqqAppEmoticonObserver = new sqx(this);
  public DragSortAdapter a;
  DragSortListView.DropListener jdField_a_of_type_ComTencentMobileqqEmosmViewDragSortListView$DropListener = new sqz(this);
  DragSortListView.RemoveListener jdField_a_of_type_ComTencentMobileqqEmosmViewDragSortListView$RemoveListener = new sra(this);
  ...
  TabBarView.OnTabChangeListener jdField_a_of_type_ComTencentMobileqqWidgetTabBarView$OnTabChangeListener = new srb(this);
    ...
    for (;;)
    {
      if (i < this.jdField_a_of_type_ComTencentMobileqqEmosmViewDragSortAdapter.getCount())
      {
        ...
        if ((3 != localEmoticonPackage.jobType) && (1 != localEmoticonPackage.jobType) && (5 != localEmoticonPackage.jobType)) {
          ThreadManager.getFileThreadHandler().post(new src(this, str));
        }
  ...
  void c()
  {
    ...
    try
    {
      ...
      {
        this.leftView.setText(2131436274);
        return;
      }
      str = new JSONObject(str).optString("leftText", getString(2131436274));
  ...
  public void d()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqModelEmoticonManager.a(0, new srl(this));
  }
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    super.setContentView(2130968989);
    super.setContentBackgroundResource(2130838219);
    super.setTitle(2131436086);
    c();
    this.jdField_a_of_type_AndroidWidgetTextView = this.rightViewText;
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(2131436088);
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new srd(this));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)super.findViewById(2131364616));
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131364618));
    this.jdField_b_of_type_AndroidWidgetTextView.setOnClickListener(new sre(this));
    this.jdField_a_of_type_ComTencentMobileqqWidgetTabBarView = ((TabBarView)super.findViewById(2131364617));
    this.jdField_a_of_type_ComTencentMobileqqWidgetTabBarView.a(0, getString(2131436274));
    this.jdField_a_of_type_ComTencentMobileqqWidgetTabBarView.a(1, getString(2131436275));
    ...
    try
    {
      ...
      this.jdField_a_of_type_JavaLangRunnable = new srf(this);
      ...
      this.jdField_a_of_type_ComTencentMobileqqEmosmViewDragSortListView.setOnItemClickListener(new srg(this));
      this.jdField_a_of_type_Boolean = false;
      this.jdField_a_of_type_ComTencentMobileqqEmoticonEmoticonPackageChangedListener = new srh(this);
      EmojiListenerManager.a().a(this.jdField_a_of_type_ComTencentMobileqqEmoticonEmoticonPackageChangedListener);
      this.jdField_a_of_type_ComTencentMobileqqEmoticonEmoticonPackageDownloadListener = new sri(this);
  ...
  {
    if (this.c) {
      this.jdField_a_of_type_ComTencentMobileqqModelEmoticonManager.a(0, new sqy(this));
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      if (!NetworkUtil.d(this))
      {
        ...
        paramView.a(2130838723);
        paramView.d(1500);
        paramView.a("无网络连接，删除失败");
        paramView.b(0);
        return;
      }
      this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.a(getString(2131436110));
