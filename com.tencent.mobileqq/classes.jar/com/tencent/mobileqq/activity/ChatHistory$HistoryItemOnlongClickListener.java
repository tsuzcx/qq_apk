  ...
  implements View.OnClickListener, OnLongClickAndTouchListener, BubblePopupWindow.OnDismissListener
{
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    localQQCustomMenu.a(2131375633, this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.getString(2131433652), 2130838314);
    if (localQQCustomMenu.a() > 0)
    {
      ...
      this.jdField_a_of_type_ComTencentWidgetBubblePopupWindow = BubbleContextMenu.a(paramView, (int)this.jdField_a_of_type_AndroidGraphicsPointF.x, i - j, localQQCustomMenu, this);
