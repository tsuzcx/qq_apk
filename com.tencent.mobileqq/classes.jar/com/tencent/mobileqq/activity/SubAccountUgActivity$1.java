  ...
  extends SubAccountBindObserver
{
  ...
  public void a(boolean paramBoolean, SubAccountBackProtocData paramSubAccountBackProtocData)
  {
    ...
    paramSubAccountBackProtocData = (SubAccountControll)this.a.app.getManager(QQManagerFactory.SUB_ACCOUNT_CONTROLL);
  ...
  public void c(boolean paramBoolean, SubAccountBackProtocData paramSubAccountBackProtocData)
  {
    ...
    do
    {
      ...
      if (this.a.b)
      {
        ...
        {
          this.a.a();
          this.a.c(this.a.getString(2131719631));
          return;
        }
        this.a.b(this.a.getString(2131719630));
        return;
      }
    } while (!paramBoolean);
    paramSubAccountBackProtocData = (SubAccountControll)this.a.app.getManager(QQManagerFactory.SUB_ACCOUNT_CONTROLL);
    Pair localPair = paramSubAccountBackProtocData.a(this.a.jdField_a_of_type_JavaLangString, 1);
    paramSubAccountBackProtocData.a(this.a.app, this.a, localPair, new SubAccountUgActivity.1.1(this, paramSubAccountBackProtocData, localPair));
  }
}
