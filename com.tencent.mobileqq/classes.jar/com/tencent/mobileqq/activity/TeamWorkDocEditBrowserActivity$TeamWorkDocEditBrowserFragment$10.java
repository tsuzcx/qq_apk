...
class TeamWorkDocEditBrowserActivity$TeamWorkDocEditBrowserFragment$10
  implements Runnable
{
  TeamWorkDocEditBrowserActivity$TeamWorkDocEditBrowserFragment$10(TeamWorkDocEditBrowserActivity.TeamWorkDocEditBrowserFragment paramTeamWorkDocEditBrowserFragment) {}
  
  public void run()
  {
    String str = SharedPreUtils.p(this.this$0.getActivity());
