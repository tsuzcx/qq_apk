  ...
  extends RecentUserBaseData
{
  ...
  public void a(Context paramContext)
  {
    ...
    {
      this.jdField_d_of_type_JavaLangCharSequence = String.format(paramContext.getString(2131436667), new Object[] { Integer.valueOf(this.jdField_c_of_type_Int) });
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    if (TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {
      this.jdField_b_of_type_JavaLangString = paramContext.getString(2131435169);
    }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if ((TextUtils.isEmpty(localMsgSummary.b)) && (TextUtils.isEmpty(localMsgSummary.jdField_c_of_type_JavaLangCharSequence)))
        {
          ...
          localMsgSummary.b = paramContext.getString(2131435170);
        }
