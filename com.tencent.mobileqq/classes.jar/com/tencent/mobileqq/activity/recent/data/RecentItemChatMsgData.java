  ...
  extends RecentUserBaseData
{
  ...
  private void a(Context paramContext, QQMessageFacade.Message paramMessage, MessageForStructing paramMessageForStructing)
  {
    ...
    String str2 = paramContext.getString(2131698526);
  ...
  private void a(QQAppInterface paramQQAppInterface, Context paramContext, QQMessageFacade.Message paramMessage)
  {
    if (a(paramMessage))
    {
      ...
      if (!TextUtils.isEmpty(paramMessage))
      {
        ...
        this.mMsgExtroInfo = ajya.a(2131713173);
  ...
  private boolean a(ajxl paramajxl, String paramString)
  {
    if ((paramajxl == null) || (TextUtils.isEmpty(paramString))) {}
    boolean bool1;
    boolean bool2;
    do
    {
      ...
      {
        return false;
        paramajxl = paramajxl.b(paramString);
      } while ((paramajxl == null) || (!paramajxl.isFriend()));
      bool1 = paramajxl.isServiceEnabled(EVIPSPEC.E_SP_SUPERVIP);
      bool2 = paramajxl.isServiceEnabled(EVIPSPEC.E_SP_QQVIP);
    } while ((!bool1) && (!bool2));
    return true;
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    if ((localObject1 != null) && (localMessage != null))
    {
      ...
      this.mBubbleID = ((akfv)paramQQAppInterface.a(13)).a(localMessage);
      if (localMessage != null)
      {
        ...
        {
          this.mMsgExtroInfo = ((avew)localObject1).a();
    ...
    case 1008: 
      for (;;)
      {
        ...
        localObject2 = aylc.e(this.mLastMsg.toString());
        ...
        if (localMessage != null)
        {
          ...
          {
            paramContext = (Context)localObject2;
            if (asyp.a(paramQQAppInterface, localMessage)) {
              paramContext = asyp.a((String)localObject2);
            }
          }
        }
        ((StringBuilder)localObject3).append(paramContext).append(",").append(this.mShowTime);
        if ((this.mUser.getType() != 0) || (!((ajxl)localObject1).b(this.mUser.uin))) {
          break label3891;
        }
        paramQQAppInterface = asxd.a(paramQQAppInterface, this.mUser.uin, false, 5);
        ...
        for (;;)
        {
          ...
          paramContext = (asyd)paramQQAppInterface.next();
        ...
        if (localMessage != null)
        {
          ...
          if ((localMessage.msgtype == -4502) && (localMessage.frienduin.equals(ajsd.y))) {
          ...
          for (;;)
          {
            ...
            localObject1 = localObject2;
            break;
            localObject1 = ((yah)paramQQAppInterface.a(51)).a(Long.parseLong(localMessage.frienduin));
            if (localObject1 != null) {
              this.mTitleName = ymu.a((DeviceInfo)localObject1);
            }
          }
          localObject1 = localObject2;
          if (((MessageForDeviceFile)localObject3).msgStatus == 2)
          {
            ...
            if (localMessage.msgtype == -4501)
            {
              ...
              for (localMessage.nickName = paramQQAppInterface.getApp().getString(2131694516);; localMessage.nickName = bbcz.b(paramQQAppInterface, localMessage.senderuin, true))
              {
                bbfh.a(paramContext, paramQQAppInterface, localMessage, this.mUser.getType(), localMsgSummary, localMessage.nickName, true, false);
                localObject1 = localObject2;
                break;
            ...
            else if (localMessage.msgtype == -4503)
            {
              ...
              else
              {
                ...
                {
                  localObject1 = ((yer)paramQQAppInterface.a(49)).a();
                  if (localObject1 != null)
                  {
                    i = 1;
                    if (((ybp)localObject1).a(localMessage.uniseq)) {
                      break label1221;
                    }
                  }
                  for (int j = 1;; j = 0)
            ...
            else if (localMessage.msgtype == -4509)
            {
              ...
              else
              {
                ...
                {
                  localObject1 = ((yer)paramQQAppInterface.a(49)).a();
                  if (!aent.b((MessageRecord)localObject3)) {
                    if (localObject1 == null) {
                      break label1371;
                    }
                  }
                  for (i = 1;; i = 0)
                  {
                    if ((i & ((ybp)localObject1).a(localMessage.uniseq)) == 0) {
                      break label1376;
                    }
                    localMsgSummary.nState = 1;
                    localObject1 = localObject2;
            ...
            else
            {
              ...
              if (localMessage.msgtype == -4508)
              {
                ...
                bbfh.a(paramContext, paramQQAppInterface, localMessage, this.mUser.getType(), localMsgSummary, null, true, false);
                localObject1 = localObject2;
                continue;
    ...
    case 1006: 
      ...
      label1371:
      label1376:
      localObject3 = bbcz.e(paramQQAppInterface, this.mUser.uin);
      label896:
      label922:
      label1067:
      label1221:
    ...
    for (localObject1 = ((askn)localObject1).c(this.mUser.uin);; localObject1 = null)
    {
      if (localObject1 != null) {
      ...
      for (;;)
      {
        ...
        if (localObject3 != null) {
          this.mTitleName = bbcz.b(paramQQAppInterface, (String)localObject3, true);
        } else {
      ...
      localObject1 = localObject2;
      break;
      boolean bool1 = amgb.a(paramQQAppInterface).b(this.mUser.uin);
      if ((this.mUnreadNum > 0) && (bool1))
      {
        this.mMsgExtroInfo = paramContext.getString(2131717490);
        this.mExtraInfoColor = paramContext.getResources().getColor(2131166955);
      }
      if (0 == 0) {}
      for (localObject1 = (ajxl)paramQQAppInterface.getManager(51);; localObject1 = null)
      {
        if ((this.mUser.getType() == 0) && (((ajxl)localObject1).b(this.mUser.uin)))
        {
          if (aekp.a().a(paramQQAppInterface) != 1) {
            break label2738;
          }
          i = 1;
          label1899:
          ...
          if ((i != 0) && (aekp.a().a()))
          {
            localObject2 = ((ajxl)localObject1).e(this.mUser.uin);
        ...
        label1987:
        boolean bool2;
        if (a((ajxl)localObject1, this.mUser.uin))
        {
          this.mUnreadFlag = 4;
          if (FriendsStatusUtil.a(this.mUser.uin, paramQQAppInterface)) {
            this.mUnreadFlag = 3;
          }
          bool2 = adic.a(this.mUser.uin, this.mUser.getType(), paramQQAppInterface);
          if ((!bool2) || (aknj.a(paramQQAppInterface.c(), paramContext))) {
            break label2751;
          }
          this.mUnreadFlag = 0;
          label2047:
          ...
          localObject4 = paramContext.getString(2131697908);
        ...
        for (;;)
        {
          ...
          if ((localMessage != null) && (localMessage.msgtype == -1034))
          {
            ...
            {
              this.mMsgExtroInfo = ajya.a(2131713193);
              this.mExtraInfoColor = paramContext.getResources().getColor(2131166931);
              label2588:
          ...
          else
          {
            if ((localMessage != null) && (localMessage.msgtype == -2074))
            {
              ...
              this.mMsgExtroInfo = ajya.a(2131713169);
              this.mExtraInfoColor = paramContext.getResources().getColor(2131166928);
            }
            if (!ajsd.J.equals(this.mUser.uin)) {
              break label2867;
            }
            this.mTitleName = paramContext.getString(2131719984);
          }
          for (;;)
          {
            ...
            i = 0;
            break label2359;
            this.mMsgExtroInfo = ajya.a(2131713192);
            this.mExtraInfoColor = paramContext.getResources().getColor(2131166928);
            break label2588;
            label2867:
            if (ajsd.E.equals(this.mUser.uin))
            {
              this.mTitleName = paramContext.getString(2131720051);
            ...
            else if (this.mUser.getType() == 1000)
            {
              ...
              if (localObject2 != null)
              {
                ...
                this.mTitleName = bbcz.a(paramQQAppInterface, this.mUser.uin, (String)localObject2, this.mUser.troopUin, true, null);
              }
            }
            else if (this.mUser.getType() == 1004)
            {
              this.mTitleName = bbcz.c(paramQQAppInterface, this.mUser.troopUin, this.mUser.uin);
          ...
          if ((localMessage != null) && (localMessage.msgtype == -2025))
          {
            ...
            localObject3 = paramContext.getString(2131693288);
          ...
          for (;;)
          {
            ...
            if ((this.mUser.getType() == 1024) && (!bduf.b(paramQQAppInterface, this.mUser.uin))) {
              this.mAuthenIconId = naz.a(paramQQAppInterface, this.mUser.uin);
            }
            if (bbbr.b(this.mUser.uin)) {
              this.mAuthenIconId = 2130841310;
            }
            if ((this.mUser.getType() != 0) || (((ajxl)localObject1).a(this.mUser.uin) != 1)) {
              break label3919;
            }
          ...
          this.mTitleName = paramContext.getString(2131696772);
          localObject3 = "";
          localObject1 = null;
          if (localObject4 != null) {
            localObject1 = ((QQMessageFacade)localObject4).b(ajsd.D, 4000);
          }
          if ((localObject1 != null) && (((List)localObject1).size() > 0))
          {
            ...
            if (((MessageRecord)localObject1).msg != null) {
              if (((MessageRecord)localObject1).msgtype == -1033)
              {
                ...
                localObject1 = ajya.a(2131713175) + (String)localObject1;
              }
            }
          }
          for (;;)
          {
            ...
            if ((localMessage != null) && (localMessage.getMessageText() != null))
            {
              ...
              {
                if ((askn)paramQQAppInterface.getManager(11) != null) {}
                localObject1 = ajya.a(2131713178) + "";
                continue;
              }
              if (((MessageRecord)localObject1).msgtype == -1039)
              {
                localObject1 = (akfc)paramQQAppInterface.getManager(22);
                if (localObject1 == null) {
                  break label3912;
                }
                localObject1 = paramContext.getResources().getString(2131696774) + ((akfc)localObject1).a();
                continue;
              }
              if (((MessageRecord)localObject1).msgtype != -1040) {
                break label3905;
              }
              localObject4 = (akfc)paramQQAppInterface.getManager(22);
              localObject1 = localObject3;
              if (localObject4 != null) {
                localObject1 = ((akfc)localObject4).a();
              }
              continue;
            }
            this.mDisplayTime = 0L;
            localObject1 = localObject2;
            break;
            this.mTitleName = ajya.a(2131713195);
