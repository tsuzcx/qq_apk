...
public class RecentDataListManager
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = RecentDataListManager.class.getSimpleName();
  }
  ...
  public boolean a(BaseQQAppInterface paramBaseQQAppInterface, Context paramContext, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      if (localObject1 == null)
      {
        ...
        i = 0;
        j = 0;
        if ((i >= ((List)localObject1).size()) || (i >= IMCoreConstantsRoute.StartupDirectorConstants.a)) {
          break label319;
        }
        localRecentUser = (RecentUser)((List)localObject1).get(i);
      ...
      if (QLog.isColorLevel())
      {
        ...
        localObject1 = new StringBuilder().append("preloadRecentBaseData end: ").append(this.jdField_b_of_type_Boolean);
        if (paramBaseQQAppInterface == null) {
          break label613;
        }
      }
      label613:
      for (int i = paramBaseQQAppInterface.size();; i = 0)
      {
        QLog.d(paramContext, 2, i);
        paramBoolean1 = bool;
        if (k > 0) {
          paramBoolean1 = true;
        }
