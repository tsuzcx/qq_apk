  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    if (UpgradeController.a().b() == 4) {
      ReportController.b(InstallUpgradeBannerProcessor.f(this.a).getAppRuntime(), "CliOper", "", "", "0X8004DA4", "0X8004DA4", 0, 0, UpgradeConstants.b(), UpgradeController.l(), UpgradeController.k(), "0");
    } else {
      ReportController.b(InstallUpgradeBannerProcessor.g(this.a).getAppRuntime(), "CliOper", "", "", "0X8004DA3", "0X8004DA3", 0, 0, UpgradeConstants.b(), UpgradeController.l(), UpgradeController.k(), "0");
    }
