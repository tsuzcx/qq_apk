  ...
  extends RelativeLayout
{
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_AndroidViewAnimationAnimationSet.addAnimation((Animation)localObject);
    this.jdField_a_of_type_AndroidViewAnimationAnimationSet.setAnimationListener(new agxi(this));
    ...
    this.jdField_b_of_type_AndroidViewAnimationAnimationSet.addAnimation((Animation)localObject);
    this.jdField_b_of_type_AndroidViewAnimationAnimationSet.setAnimationListener(new agxj(this));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130839202);
    ...
    this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130839203);
