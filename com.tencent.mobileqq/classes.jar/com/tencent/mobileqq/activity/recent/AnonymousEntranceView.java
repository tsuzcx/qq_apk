  ...
  extends RelativeLayout
{
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_AndroidViewAnimationAnimationSet.addAnimation((Animation)localObject);
    this.jdField_a_of_type_AndroidViewAnimationAnimationSet.setAnimationListener(new xex(this));
    ...
    this.jdField_b_of_type_AndroidViewAnimationAnimationSet.addAnimation((Animation)localObject);
    this.jdField_b_of_type_AndroidViewAnimationAnimationSet.setAnimationListener(new xey(this));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130838670);
    ...
    this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130838671);
