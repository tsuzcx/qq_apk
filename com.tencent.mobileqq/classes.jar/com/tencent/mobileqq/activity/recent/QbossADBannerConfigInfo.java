...
import cooperation.vip.qqbanner.QbossADBannerCountDownInfo;
import cooperation.vip.qqbanner.QbossADBannerCountDownManager;
import cooperation.vip.qqbanner.QbossADBannerImmersionInfo;
import cooperation.vip.qqbanner.QbossADCountDownInmersionBannerManager;
import cooperation.vip.qqbanner.QbossADImmersionBannerManager;
...
public class QbossADBannerConfigInfo
{
  public int a;
  public tAdvDesc a;
  public SparseArray<QbossADBannerConfigInfo.ResourceInfo> a;
  ...
  public QbossADBannerConfigInfo(tAdvDesc paramtAdvDesc)
  {
  ...
  public QbossADBannerConfigInfo(TianShuAccess.AdItem paramAdItem)
  {
    this.jdField_a_of_type_Int = 0;
  ...
  public static QbossADBannerConfigInfo a(tAdvDesc paramtAdvDesc)
  {
    ...
    default: 
      return null;
    case 1012: 
      return new QbossADBannerConfigInfo(paramtAdvDesc);
    case 1108: 
      return new QbossADBannerCountDownInfo(paramtAdvDesc);
    case 1128: 
      return new QbossADBannerImmersionInfo(paramtAdvDesc);
    }
    return new QbossADBannerCountDownImmersionInfo(paramtAdvDesc);
  }
  
  public static QbossADBannerConfigInfo a(TianShuAccess.AdItem paramAdItem, String paramString)
  {
    if (paramAdItem == null) {
      return null;
    }
    if ("2".equals(paramString)) {
      return new QbossADBannerCountDownInfo(paramAdItem);
    }
    if ("1".equals(paramString)) {
      return new QbossADBannerImmersionInfo(paramAdItem);
    }
    return new QbossADBannerConfigInfo(paramAdItem);
  }
  
  public QbossADBannerManager a()
  {
    ...
    default: 
      return null;
    case 1012: 
      return new QbossADBannerManager();
    case 1108: 
      return new QbossADBannerCountDownManager();
    case 1128: 
      return new QbossADImmersionBannerManager();
    }
    return new QbossADCountDownInmersionBannerManager();
  }
  ...
  protected void a()
  {
    ...
    try
    {
      ...
      int i = ((JSONObject)localObject2).optInt("res_type");
      String str2 = ((JSONObject)localObject2).optString("res_url");
      String str3 = ((JSONObject)localObject2).optString("res_url_md5");
      int j = ((JSONObject)localObject2).optInt("jump_type");
      Object localObject1 = ((JSONObject)localObject2).optString("jump_url");
      int k = ((JSONObject)localObject2).optInt("WebViewPreloadFlag");
      localObject2 = ((JSONObject)localObject2).optString("thirdPartyReportURLForExposure");
      ...
      localObject1 = new QbossADBannerConfigInfo.ResourceInfo();
      ((QbossADBannerConfigInfo.ResourceInfo)localObject1).jdField_a_of_type_JavaLangString = str2;
      ((QbossADBannerConfigInfo.ResourceInfo)localObject1).jdField_b_of_type_JavaLangString = str3;
      ((QbossADBannerConfigInfo.ResourceInfo)localObject1).jdField_c_of_type_JavaLangString = QbossADBannerConfigManager.a().a(str2);
      this.jdField_d_of_type_JavaLangString = ((QbossADBannerConfigInfo.ResourceInfo)localObject1).jdField_c_of_type_JavaLangString;
  ...
  public void a(SharedPreferences paramSharedPreferences, String paramString)
  {
    ...
    try
    {
      ...
      paramSharedPreferences = new QbossADBannerConfigInfo.ResourceInfo();
  ...
  protected void b()
  {
    ...
    try
    {
      ...
      localObject1 = new QbossADBannerConfigInfo.ResourceInfo();
      ((QbossADBannerConfigInfo.ResourceInfo)localObject1).jdField_a_of_type_JavaLangString = ((String)localObject2);
      ((QbossADBannerConfigInfo.ResourceInfo)localObject1).jdField_b_of_type_JavaLangString = ((String)localObject3);
      ((QbossADBannerConfigInfo.ResourceInfo)localObject1).jdField_c_of_type_JavaLangString = QbossADBannerConfigManager.a().a((String)localObject2);
      this.jdField_d_of_type_JavaLangString = ((QbossADBannerConfigInfo.ResourceInfo)localObject1).jdField_c_of_type_JavaLangString;
      this.jdField_a_of_type_AndroidUtilSparseArray.put(1, localObject1);
      return;
    }
  ...
  public boolean b()
  {
    ...
    {
      QbossADBannerConfigInfo.ResourceInfo localResourceInfo = (QbossADBannerConfigInfo.ResourceInfo)this.jdField_a_of_type_AndroidUtilSparseArray.valueAt(i);
      if ((localResourceInfo == null) || (TextUtils.isEmpty(localResourceInfo.jdField_c_of_type_JavaLangString)) || (!localResourceInfo.a())) {
        return false;
      }
      i += 1;
    }
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.recent.QbossADBannerConfigInfo
