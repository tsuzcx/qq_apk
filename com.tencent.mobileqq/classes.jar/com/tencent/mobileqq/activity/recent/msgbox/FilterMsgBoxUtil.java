...
{
  public static int a(QQAppInterface paramQQAppInterface, Message paramMessage)
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      i = QCallFacade.a(paramQQAppInterface, localRecentUser.uin, localRecentUser.type, i, null).a() + i;
    }
    label63:
    for (;;)
    {
