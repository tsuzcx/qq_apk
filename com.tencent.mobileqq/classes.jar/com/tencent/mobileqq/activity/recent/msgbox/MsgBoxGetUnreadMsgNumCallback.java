  ...
  implements GetUnreadMsgNumCallback
{
  public int a(String paramString, StringBuilder paramStringBuilder)
  {
    ...
    int i = TempMsgBoxUtil.a(localQQAppInterface);
  ...
  public boolean a(ConversationInfo paramConversationInfo, boolean[] paramArrayOfBoolean)
  {
    ...
    localObject = (TempMsgBoxManager)((QQAppInterface)localObject).getManager(QQManagerFactory.TEMP_MSG_BOX);
    if ((((TempMsgBoxManager)localObject).a(paramConversationInfo.uin, paramConversationInfo.type)) || (((TempMsgBoxManager)localObject).b(paramConversationInfo.uin, paramConversationInfo.type)) || (paramConversationInfo.type == 10011) || (paramConversationInfo.type == 10012) || (TextUtils.equals(paramConversationInfo.uin, AppConstants.FILTER_MSG_UIN)) || (TextUtils.equals(paramConversationInfo.uin, AppConstants.TEMP_MSG_BOX_UIN)))
    {
