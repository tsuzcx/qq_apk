  ...
  implements ITempMsgBoxBusinessHandler
{
  ...
  {
    ((IGameMsgHelperApi)QRoute.api(IGameMsgHelperApi.class)).reportGameMsgExplosureInBox(paramAppInterface, paramInt, paramString);
  }
  ...
  {
    ((IGameMsgHelperApi)QRoute.api(IGameMsgHelperApi.class)).reportMsgBoxExposure(paramAppInterface, paramObject);
  }
