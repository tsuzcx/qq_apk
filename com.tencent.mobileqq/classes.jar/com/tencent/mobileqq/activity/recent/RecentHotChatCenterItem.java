  ...
  extends RecentUserBaseData
{
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    if (TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {
      this.jdField_b_of_type_JavaLangString = paramContext.getString(2131439088);
    }
  ...
  public void b(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    {
      this.jdField_d_of_type_JavaLangCharSequence = String.format(paramContext.getString(2131436668), new Object[] { Integer.valueOf(this.jdField_c_of_type_Int) });
      this.e = paramContext.getResources().getColor(2131494281);
      return;
    }
