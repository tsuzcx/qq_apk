  ...
  implements IRecentCheckFilterProcessor
{
  ...
  {
    return paramInt + ", ToFilterBox," + MsfSdkUtils.getShortUin(paramRecentUser.uin) + "," + paramRecentUser.getType() + ";";
  }
  
  public boolean a(BaseQQAppInterface paramBaseQQAppInterface, RecentUser paramRecentUser)
  {
    return ((TempMsgBoxManager)paramBaseQQAppInterface.getManager(QQManagerFactory.TEMP_MSG_BOX)).a(paramRecentUser.uin, paramRecentUser.getType());
  }
}
