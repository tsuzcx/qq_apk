...
class QQSettingSettingActivity$9
  implements Runnable
{
  QQSettingSettingActivity$9(QQSettingSettingActivity paramQQSettingSettingActivity) {}
  ...
  public void run()
  {
    ...
    if (new Date().getTime() - l1 <= l2 * 1000L)
    {
      ...
      this.this$0.runOnUiThread(new QQSettingSettingActivity.9.1(this, (String)localObject));
      return;
    }
    QQSettingSettingActivity.i(this.this$0);
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes6.jar
 * Qualified Name:     com.tencent.mobileqq.activity.QQSettingSettingActivity.9
