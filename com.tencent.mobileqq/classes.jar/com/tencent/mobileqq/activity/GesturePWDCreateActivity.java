  ...
  extends IphoneTitleBarActivity
{
  ...
  {
    setTitle(2131436058);
    setLeftButton(2131433029, new syo(this));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131364727));
    this.jdField_a_of_type_ComTencentMobileqqGesturelockLockPatternView = ((LockPatternView)findViewById(2131364729));
    ...
    this.jdField_a_of_type_ComTencentMobileqqGesturelockLockPatternView.setOnPatternListener(new syp(this));
    ...
    this.jdField_a_of_type_AndroidViewView = findViewById(2131364717);
    this.b = findViewById(2131364718);
    this.c = findViewById(2131364719);
    this.d = findViewById(2131364720);
    this.e = findViewById(2131364721);
    this.f = findViewById(2131364722);
    this.g = findViewById(2131364723);
    this.h = findViewById(2131364724);
    this.i = findViewById(2131364725);
  }
  ...
  private void d()
  {
    if ((this.jdField_a_of_type_ArrayOfInt != null) && (this.jdField_a_of_type_ArrayOfInt.length == 9))
    {
      ...
      this.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130842600);
      if (this.jdField_a_of_type_ArrayOfInt[1] != 1) {
        break label204;
      }
      this.b.setBackgroundResource(2130842600);
      label55:
      if (this.jdField_a_of_type_ArrayOfInt[2] != 1) {
        break label216;
      }
      this.c.setBackgroundResource(2130842600);
      label74:
      if (this.jdField_a_of_type_ArrayOfInt[3] != 1) {
        break label228;
      }
      this.d.setBackgroundResource(2130842600);
      label93:
      if (this.jdField_a_of_type_ArrayOfInt[4] != 1) {
        break label240;
      }
      this.e.setBackgroundResource(2130842600);
      label112:
      if (this.jdField_a_of_type_ArrayOfInt[5] != 1) {
        break label252;
      }
      this.f.setBackgroundResource(2130842600);
      label131:
      if (this.jdField_a_of_type_ArrayOfInt[6] != 1) {
        break label264;
      }
      this.g.setBackgroundResource(2130842600);
      label151:
      if (this.jdField_a_of_type_ArrayOfInt[7] != 1) {
        break label276;
      }
      this.h.setBackgroundResource(2130842600);
    }
    for (;;)
    {
      ...
      this.i.setBackgroundResource(2130842600);
      return;
      label192:
      this.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130842599);
      break;
      label204:
      this.b.setBackgroundResource(2130842599);
      break label55;
      label216:
      this.c.setBackgroundResource(2130842599);
      break label74;
      label228:
      this.d.setBackgroundResource(2130842599);
      break label93;
      label240:
      this.e.setBackgroundResource(2130842599);
      break label112;
      label252:
      this.f.setBackgroundResource(2130842599);
      break label131;
      label264:
      this.g.setBackgroundResource(2130842599);
      break label151;
      label276:
      this.h.setBackgroundResource(2130842599);
    }
    label288:
    this.i.setBackgroundResource(2130842599);
  }
