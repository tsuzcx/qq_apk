...
class ForwardRecentActivity$26
  implements View.OnClickListener
{
  ForwardRecentActivity$26(ForwardRecentActivity paramForwardRecentActivity) {}
  
  public void onClick(View paramView)
  {
    Object localObject1 = this.a.getIntent();
    Object localObject2 = ((Intent)localObject1).getStringExtra("key_forward_business_id");
    if (!this.a.mForwardOption.r())
    {
      ...
      else
      {
        ...
        if (this.a.isSdkShare)
        {
          ...
          if ((this.a.mForwardOption instanceof ForwardSdkBaseOption))
          {
            ...
            ((StringBuilder)localObject3).append(ReportDef.RepUtil.a(((ForwardSdkBaseOption)localObject2).ar));
      ...
      this.a.mForwardOption.al().putString("uin", "-1010");
      this.a.mForwardOption.ao();
      ReportController.b(this.a.app, "CliOper", "", "", "friendchoose", "0X800A2D7", ForwardRecentActivity.access$1000(this.a), 0, "", "", "", ForwardRecentActivity.access$1500(this.a));
      localObject1 = new Bundle();
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.ForwardRecentActivity.26
