  ...
  extends RecyclerView.ViewHolder
{
  ...
  {
    super(paramView);
    this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)paramView.findViewById(2131368865));
    this.b = ((URLImageView)paramView.findViewById(2131368880));
  ...
  private Drawable a()
  {
    ...
    localGradientDrawable.setCornerRadius(AIOUtils.a(5.0F, localResources));
    localGradientDrawable.setStroke(AIOUtils.a(1.5F, localResources), localResources.getColor(2131167141));
