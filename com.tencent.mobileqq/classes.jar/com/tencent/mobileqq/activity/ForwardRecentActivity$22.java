...
class ForwardRecentActivity$22
  implements ContactSearchResultPresenter.OnActionListener
{
  ForwardRecentActivity$22(ForwardRecentActivity paramForwardRecentActivity) {}
  ...
  public void onAction(View paramView)
  {
    ...
    int i = 1;
    if (bool) {}
    for (paramView = ((ContactSearchModelDiscussionMember)paramView).s();; paramView = ((ContactSearchModelDiscussion)paramView).c())
    {
      i = 3000;
      break label135;
    ...
    if ((i != -1) && (ForwardRecentActivity.access$900(this.a, new ResultRecord(str1, str2, i, paramView, "")))) {
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.ForwardRecentActivity.22
