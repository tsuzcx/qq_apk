  ...
  extends BroadcastReceiver
{
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if ((TextUtils.isEmpty(paramIntent.getPackage())) || (!paramIntent.getPackage().equals(this.this$0.app.getApp().getPackageName()))) {
    ...
    } while (((i != 0) && (j != 1)) || ((this.this$0.mEntrance != 11) && (this.this$0.mEntrance != 36)));
    if (QLog.isColorLevel()) {
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.selectmember.SelectMemberActivity.VideoMsgReceiver
