  ...
  implements View.OnClickListener, CompoundButton.OnCheckedChangeListener, IndexView.OnIndexChangedListener, PinnedDividerListView.OnLayoutListener
{
  ...
  private DiscussionMemberListInnerFrame.DiscussionMemberListAdapter jdField_a_of_type_ComTencentMobileqqActivitySelectmemberDiscussionMemberListInnerFrame$DiscussionMemberListAdapter;
  ...
  private void a(String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      return;
      label46:
      int j = this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberDiscussionMemberListInnerFrame$DiscussionMemberListAdapter.getCount();
      int i = 0;
      for (;;)
      {
        if (i >= j) {
        ...
        paramString = (DiscussionMemberInfo)this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberDiscussionMemberListInnerFrame$DiscussionMemberListAdapter.getItem(i);
  ...
  private void g()
  {
    ...
    LinearLayout localLinearLayout = (LinearLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131370665);
  ...
  private void h()
  {
    ...
    Object localObject = ((DiscussionManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.DISCUSSION_MANAGER)).a(this.b);
    if (localObject != null)
    {
  ...
  public void a(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppDiscussionManager = ((DiscussionManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.DISCUSSION_MANAGER));
    g();
    this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberDiscussionMemberListInnerFrame$DiscussionMemberListAdapter = new DiscussionMemberListInnerFrame.DiscussionMemberListAdapter(this);
    this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.setAdapter(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberDiscussionMemberListInnerFrame$DiscussionMemberListAdapter);
  }
  
  public void a(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if (((this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.getFirstVisiblePosition() > 0) || ((this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.getFirstVisiblePosition() == 0) && (this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.getChildCount() < this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberDiscussionMemberListInnerFrame$DiscussionMemberListAdapter.getCount() + this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.getHeaderViewsCount()))) && (!this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.e()))
    {
  ...
  public void a(String paramString)
  {
    ...
    {
      return;
      i = this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberDiscussionMemberListInnerFrame$DiscussionMemberListAdapter.a(paramString);
    } while (i == -1);
  ...
  public void b(Bundle paramBundle)
  {
    ...
    if (bool)
    {
      ...
      h();
      this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberDiscussionMemberListInnerFrame$DiscussionMemberListAdapter.a();
      this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.setSelection(0);
    ...
    for (;;)
    {
      ...
      break;
      label240:
      this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.a(true, HardCodeUtil.a(2131703396), this.c);
      break label137;
      label261:
      this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberDiscussionMemberListInnerFrame$DiscussionMemberListAdapter.notifyDataSetChanged();
    }
  }
  
  public void d()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberDiscussionMemberListInnerFrame$DiscussionMemberListAdapter != null) {
      this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberDiscussionMemberListInnerFrame$DiscussionMemberListAdapter.c();
    }
    super.d();
  }
  ...
  public void onCheckedChanged(CompoundButton paramCompoundButton, boolean paramBoolean)
  {
    if (2131364487 == paramCompoundButton.getId())
    {
      ...
      while (i < j)
      {
        DiscussionMemberInfo localDiscussionMemberInfo = (DiscussionMemberInfo)this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberDiscussionMemberListInnerFrame$DiscussionMemberListAdapter.getItem(i);
        if (localDiscussionMemberInfo != null)
        {
          ...
          localArrayList.add(SelectMemberActivity.a(localDiscussionMemberInfo.memberUin, ContactUtils.a(localDiscussionMemberInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), 2, this.b));
        }
        i += 1;
      }
  ...
  public void onClick(View paramView)
  {
    ...
    if (2131370665 != paramView.getId())
    {
      ...
      if ((localObject1 != null) && (((DiscussionMemberListInnerFrame.ViewHolder)localObject1).jdField_a_of_type_AndroidWidgetCheckBox != null) && (((DiscussionMemberListInnerFrame.ViewHolder)localObject1).b != null) && (((DiscussionMemberListInnerFrame.ViewHolder)localObject1).jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
      {
        bool = this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.a(((DiscussionMemberListInnerFrame.ViewHolder)localObject1).jdField_a_of_type_JavaLangString, ((DiscussionMemberListInnerFrame.ViewHolder)localObject1).b.getText().toString(), 2, this.b);
        ...
        if (AppSetting.d)
        {
          ...
          paramView.setContentDescription(((DiscussionMemberListInnerFrame.ViewHolder)localObject1).b.getText().toString() + HardCodeUtil.a(2131703369));
        }
      }
    }
    label155:
    ...
    do
    {
      for (;;)
      {
        ...
        return;
        paramView.setContentDescription(((DiscussionMemberListInnerFrame.ViewHolder)localObject1).b.getText().toString() + HardCodeUtil.a(2131703385));
        continue;
        if (((this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.jdField_d_of_type_Int != 32) && (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.jdField_d_of_type_Int != 43)) || (this.jdField_a_of_type_AndroidWidgetCheckBox.isChecked()) || (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.g >= this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberDiscussionMemberListInnerFrame$DiscussionMemberListAdapter.b())) {
          break;
        }
