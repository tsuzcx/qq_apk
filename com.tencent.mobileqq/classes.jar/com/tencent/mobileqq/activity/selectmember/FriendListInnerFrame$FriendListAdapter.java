  ...
  extends CharDividedFacePreloadBaseAdapter
{
  ...
  {
    int i = Arrays.binarySearch(this.jdField_a_of_type_ArrayOfInt, paramInt);
    FriendListInnerFrame.ViewHolder localViewHolder;
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberFriendListInnerFrame.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562998, paramViewGroup, false);
      localViewHolder = new FriendListInnerFrame.ViewHolder(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberFriendListInnerFrame, null);
    ...
    for (;;)
    {
      localViewHolder = (FriendListInnerFrame.ViewHolder)paramView.getTag();
      Object localObject;
      if (i < 0)
      {
        i = -(i + 1) - 1;
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberFriendListInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.b(((Friends)localObject).uin))
        {
          ...
          localViewHolder.c.setImageBitmap(a(((Friends)localObject).uin));
          localViewHolder.b.setText(((Friends)localObject).getFriendNick());
          localViewHolder.jdField_a_of_type_JavaLangString = ((Friends)localObject).uin;
          ...
          if ((AppSetting.d) && (localViewHolder.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
          {
            ...
            paramView.setContentDescription(((Friends)localObject).getFriendNick() + HardCodeUtil.a(2131704897));
          }
          label368:
      ...
      for (;;)
      {
        ...
        break label309;
        label416:
        paramView.setContentDescription(((Friends)localObject).getFriendNick() + HardCodeUtil.a(2131704900));
        break label368;
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.selectmember.FriendListInnerFrame.FriendListAdapter
