  ...
  extends CharDividedFacePreloadBaseAdapter
{
  ...
  public PhoneContactTabView$ContactsListAdapter(PhoneContactTabView paramPhoneContactTabView, Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, boolean paramBoolean)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    int i = Arrays.binarySearch(this.jdField_a_of_type_ArrayOfInt, paramInt);
    if (paramView == null) {
      paramView = SelectActivityViewHolder.a(paramViewGroup, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberPhoneContactTabView.jdField_a_of_type_AndroidViewLayoutInflater, 2131559036);
    }
    for (;;)
    {
      ...
      if (i < 0)
      {
        ...
        SelectActivityViewHolder.a(this, localSelectActivityViewHolder, (PhoneContact)localObject);
        localSelectActivityViewHolder.jdField_b_of_type_AndroidWidgetTextView.setText(((PhoneContact)localObject).name);
        localSelectActivityViewHolder.d.setText(((PhoneContact)localObject).mobileNo);
        localSelectActivityViewHolder.d.setVisibility(0);
        if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberPhoneContactTabView.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.b(localSelectActivityViewHolder.jdField_a_of_type_JavaLangString))
        {
          ...
          if ((AppSetting.d) && (localSelectActivityViewHolder.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
          {
            ...
            paramView.setContentDescription(((PhoneContact)localObject).name + HardCodeUtil.a(2131707978));
          }
          label226:
          localSelectActivityViewHolder.jdField_a_of_type_ComTencentMobileqqDataPhoneContact = ((PhoneContact)localObject);
          localSelectActivityViewHolder.jdField_b_of_type_AndroidViewView.setVisibility(8);
          localSelectActivityViewHolder.jdField_b_of_type_AndroidViewView.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
      ...
      for (;;)
      {
        ...
        break;
        label291:
        paramView.setContentDescription(((PhoneContact)localObject).name + HardCodeUtil.a(2131707976));
        break label226;
        ...
        localSelectActivityViewHolder.jdField_a_of_type_AndroidWidgetTextView.setText((CharSequence)localObject);
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.selectmember.PhoneContactTabView.ContactsListAdapter
