  ...
  public void a(boolean paramBoolean, Object paramObject)
  {
    ...
    while (j != this.a.jdField_a_of_type_Int)
    {
      ...
      if ((i == 2) || (i == 1))
      {
        ...
        ((Intent)localObject).putExtra("uinname", ContactUtils.h(this.a.app, this.a.app.getCurrentAccountUin()) + HardCodeUtil.a(2131702656));
      ...
      CreateFaceToFaceDiscussionActivity.a(this.a, 1, this.a.getString(2131692256));
      return;
    }
    CreateFaceToFaceDiscussionActivity.b(this.a, 1, this.a.getString(2131692256));
  }
  
  public void a(boolean paramBoolean, List<nearfield_discuss.UserProfile> paramList, int paramInt1, int paramInt2, nearfield_discuss.BusiRespHead paramBusiRespHead, int paramInt3, int paramInt4, long paramLong)
  {
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      default: 
        if (this.a.jdField_a_of_type_JavaUtilList == null)
        {
          ...
          if (this.a.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberCreateFaceToFaceDiscussionActivity$GridViewAdapter != null)
          {
            this.a.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberCreateFaceToFaceDiscussionActivity$GridViewAdapter.notifyDataSetChanged();
      ...
      for (;;)
      {
        ...
        return;
        CreateFaceToFaceDiscussionActivity.a(this.a).setText(this.a.getString(2131689650));
        CreateFaceToFaceDiscussionActivity.a(this.a).setContentDescription(this.a.getString(2131689650));
        this.a.jdField_a_of_type_AndroidWidgetTextView.setText(this.a.getString(2131718978));
        this.a.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(this.a.getString(2131718978));
        this.a.jdField_b_of_type_AndroidWidgetTextView.setText(this.a.getString(2131718979));
        this.a.jdField_b_of_type_AndroidWidgetTextView.setContentDescription(this.a.getString(2131718979));
        this.a.jdField_a_of_type_AndroidWidgetButton.setTextColor(this.a.getResources().getColor(2131167066));
        this.a.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130839424);
        this.a.jdField_a_of_type_AndroidWidgetButton.setText(HardCodeUtil.a(2131702655));
        this.a.jdField_a_of_type_AndroidWidgetButton.setContentDescription(HardCodeUtil.a(2131702655));
        this.a.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
        this.a.jdField_c_of_type_AndroidWidgetTextView.setText(this.a.getString(2131718982));
        break;
        this.a.jdField_b_of_type_Boolean = false;
        this.a.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
        this.a.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
        this.a.jdField_c_of_type_AndroidWidgetTextView.setText(this.a.getString(2131718984, new Object[] { localObject }));
        this.a.jdField_a_of_type_AndroidWidgetButton.setText(this.a.getString(2131718980));
        this.a.jdField_a_of_type_AndroidWidgetButton.setTextColor(-1);
        this.a.jdField_a_of_type_AndroidWidgetButton.setContentDescription(this.a.getString(2131718980));
        this.a.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130839424);
        break;
        this.a.jdField_b_of_type_Boolean = true;
        this.a.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
        this.a.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
        this.a.jdField_c_of_type_AndroidWidgetTextView.setText(this.a.getString(2131718983, new Object[] { localObject }));
        this.a.jdField_a_of_type_AndroidWidgetButton.setText(this.a.getString(2131718981));
        this.a.jdField_a_of_type_AndroidWidgetButton.setTextColor(-1);
        this.a.jdField_a_of_type_AndroidWidgetButton.setContentDescription(this.a.getString(2131718981));
        this.a.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130839424);
        break;
        ...
        if (!this.a.jdField_c_of_type_Boolean)
        {
          QQToast.a(this.a.jdField_a_of_type_AndroidContentContext, HardCodeUtil.a(2131702653), 1).a();
          if (this.a.jdField_a_of_type_AndroidOsHandler.hasMessages(1)) {
            this.a.jdField_a_of_type_AndroidOsHandler.removeMessages(1);
          }
          this.a.jdField_a_of_type_AndroidOsHandler.sendEmptyMessageDelayed(1, 600L);
