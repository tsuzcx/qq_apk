  ...
  implements View.OnClickListener, bcnf, bcot
{
  ...
  private aidf jdField_a_of_type_Aidf;
  private Handler jdField_a_of_type_AndroidOsHandler = new aide(this);
  ...
  private void g()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getLayoutInflater().inflate(2131562360, this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView, false));
  ...
  private void h()
  {
    ...
    if (localObject1 != null)
    {
      ...
      Object localObject2 = ((ajxl)localObject1).a(String.valueOf(this.b));
      Object localObject3;
      if (localObject2 != null)
      {
        ...
        {
          localObject3 = (auko)((Iterator)localObject2).next();
      ...
      {
        localObject2 = ((ajxl)localObject1).e();
        ...
        do
        {
          while (!((Iterator)localObject3).hasNext())
          {
            do
            {
              ...
              localObject3 = ((ajxl)localObject1).a(String.valueOf(((Groups)((Iterator)localObject2).next()).group_id));
    ...
    for (int i = 1;; i = 0)
    {
      if (i == 0)
      {
        ...
        ((Friends)localObject1).mCompareSpell = ChnToSpell.a(ajuh.a((Friends)localObject1), 1);
  ...
  public void a(String paramString)
  {
    ...
    {
      return;
      i = this.jdField_a_of_type_Aidf.a(paramString);
    } while (i == -1);
  ...
  public void b(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.a(true, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getString(2131719232), this.jdField_a_of_type_JavaLangString);
    if (this.b != this.jdField_a_of_type_Int)
    {
      h();
      this.jdField_a_of_type_Aidf.a();
      this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.setSelection(0);
      this.jdField_a_of_type_Int = this.b;
    }
    while (this.jdField_a_of_type_Aidf == null) {
      return;
    }
    this.jdField_a_of_type_Aidf.notifyDataSetChanged();
  }
  
  public void d()
  {
    if (this.jdField_a_of_type_Aidf != null) {
      this.jdField_a_of_type_Aidf.c();
    }
    super.d();
  }
  ...
  {
    aidg localaidg = (aidg)paramView.getTag();
    if ((localaidg != null) && (localaidg.jdField_a_of_type_AndroidWidgetCheckBox != null) && (localaidg.b != null) && (localaidg.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
    {
      boolean bool = this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.a(localaidg.jdField_a_of_type_JavaLangString, localaidg.b.getText().toString(), 0, "-1");
      localaidg.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(bool);
      if (AppSetting.d)
      {
        if (!localaidg.jdField_a_of_type_AndroidWidgetCheckBox.isChecked()) {
          break label127;
        }
        paramView.setContentDescription(localaidg.b.getText().toString() + ajya.a(2131704882));
      }
    }
    return;
    label127:
    paramView.setContentDescription(localaidg.b.getText().toString() + ajya.a(2131704885));
  }
}
