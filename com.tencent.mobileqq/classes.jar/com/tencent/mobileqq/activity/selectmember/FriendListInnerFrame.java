  ...
  implements View.OnClickListener, bemh, benv
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new ajuo(this);
  ...
  private void g()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getLayoutInflater().inflate(2131562564, this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView, false));
  ...
  private void h()
  {
    ...
    if (localObject1 != null)
    {
      ...
      Object localObject2 = ((aloz)localObject1).a(String.valueOf(this.b));
      Object localObject3;
      if (localObject2 != null)
      {
        ...
        {
          localObject3 = (awbv)((Iterator)localObject2).next();
      ...
      {
        localObject2 = ((aloz)localObject1).e();
        ...
        do
        {
          while (!((Iterator)localObject3).hasNext())
          {
            do
            {
              ...
              localObject3 = ((aloz)localObject1).a(String.valueOf(((Groups)((Iterator)localObject2).next()).group_id));
    ...
    for (int i = 1;; i = 0)
    {
      if (i == 0)
      {
        ...
        ((Friends)localObject1).mCompareSpell = ChnToSpell.a(allu.a((Friends)localObject1), 1);
  ...
  public void a(Bundle paramBundle)
  {
    ...
    g();
    this.jdField_a_of_type_Ajup = new ajup(this);
    this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.setAdapter(this.jdField_a_of_type_Ajup);
  }
  
  public void a(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if (((this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.getFirstVisiblePosition() > 0) || ((this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.getFirstVisiblePosition() == 0) && (this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.getChildCount() < this.jdField_a_of_type_Ajup.getCount() + this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.getHeaderViewsCount()))) && (!this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.e()))
    {
  ...
  public void a(String paramString)
  {
    ...
    {
      return;
      i = this.jdField_a_of_type_Ajup.a(paramString);
    } while (i == -1);
  ...
  public void b(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.a(true, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getString(2131719713), this.jdField_a_of_type_JavaLangString);
    if (this.b != this.jdField_a_of_type_Int)
    {
      h();
      this.jdField_a_of_type_Ajup.a();
      this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.setSelection(0);
      this.jdField_a_of_type_Int = this.b;
    }
    while (this.jdField_a_of_type_Ajup == null) {
      return;
    }
    this.jdField_a_of_type_Ajup.notifyDataSetChanged();
  }
  
  public void d()
  {
    if (this.jdField_a_of_type_Ajup != null) {
      this.jdField_a_of_type_Ajup.c();
    }
    super.d();
  }
  ...
  {
    ajuq localajuq = (ajuq)paramView.getTag();
    if ((localajuq != null) && (localajuq.jdField_a_of_type_AndroidWidgetCheckBox != null) && (localajuq.b != null) && (localajuq.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
    {
      boolean bool = this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.a(localajuq.jdField_a_of_type_JavaLangString, localajuq.b.getText().toString(), 0, "-1");
      localajuq.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(bool);
      if (AppSetting.c)
      {
        if (!localajuq.jdField_a_of_type_AndroidWidgetCheckBox.isChecked()) {
          break label127;
        }
        paramView.setContentDescription(localajuq.b.getText().toString() + alpo.a(2131705254));
      }
    }
    return;
    label127:
    paramView.setContentDescription(localajuq.b.getText().toString() + alpo.a(2131705257));
  }
}
