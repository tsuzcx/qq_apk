  ...
  extends CharDividedFacePreloadBaseAdapter
{
  ...
  public ContactsInnerFrame$ContactsListAdapter(ContactsInnerFrame paramContactsInnerFrame, Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, boolean paramBoolean)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    int i = Arrays.binarySearch(this.jdField_a_of_type_ArrayOfInt, paramInt);
    if (paramView == null) {
      paramView = SelectActivityViewHolder.a(paramViewGroup, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberContactsInnerFrame.jdField_a_of_type_AndroidViewLayoutInflater, 2131562998);
    }
    for (;;)
    {
      ...
      if (i < 0)
      {
        ...
        if (i - 1 < 0)
        {
          ...
          localSelectActivityViewHolder.d.setText(localPhoneContact2.mobileNo);
          label192:
          localSelectActivityViewHolder.b.setText(localPhoneContact2.name);
          if (!this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberContactsInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.b(localSelectActivityViewHolder.jdField_a_of_type_JavaLangString)) {
            break label415;
          }
          ...
          if ((AppSetting.d) && (localSelectActivityViewHolder.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
          {
            ...
            paramView.setContentDescription(localPhoneContact2.name + HardCodeUtil.a(2131702597));
          }
          label333:
      ...
      for (;;)
      {
        ...
        break label275;
        label439:
        paramView.setContentDescription(localPhoneContact2.name + HardCodeUtil.a(2131702568));
        break label333;
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.selectmember.ContactsInnerFrame.ContactsListAdapter
