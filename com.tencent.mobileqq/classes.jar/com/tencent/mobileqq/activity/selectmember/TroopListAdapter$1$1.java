...
public class TroopListAdapter$1$1
  implements Runnable
{
  public TroopListAdapter$1$1(ahtd paramahtd, QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, Bundle paramBundle, Handler paramHandler) {}
  ...
  public void run()
  {
    ...
    catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException)
    {
      ...
      {
        ahtc.a((QQAppInterface)ahtc.a(this.jdField_a_of_type_Ahtd.a).b.get(), ahtc.a(this.jdField_a_of_type_Ahtd.a), localArrayList);
        return;
      }
