  ...
  extends QQSettingMeBaseMenuProcessor
{
  ...
  public void a(View paramView)
  {
    ...
    {
      ((IMiniAppService)QRoute.api(IMiniAppService.class)).startMiniApp(this.d, paramView, 2066, null);
    }
    else
    {
    ...
    ReportController.b(this.c, "dc00898", "", "", "0X800BB68", "0X800BB68", 0, i, "", "", "", "");
    if (i != 0) {
  ...
  public void a(QQSettingMe paramQQSettingMe)
  {
    ...
    this.b.observe(this.e, new QQSettingMeDocumentProcessor.1(this, paramQQSettingMe));
  }
  
  public void a(BusinessInfoCheckUpdate.AppInfo paramAppInfo, boolean paramBoolean)
  {
    super.a(((IRedTouchManager)this.c.getRuntimeService(IRedTouchManager.class, "")).getAppInfo(1, String.valueOf(101700)), paramBoolean);
  }
  ...
  public void i()
  {
    ...
    localQQSettingMeDocumentBean.a = ((IDocDrawerConfig)QRoute.api(IDocDrawerConfig.class)).getIsShowInDrawer().booleanValue();
    localQQSettingMeDocumentBean.c = ((IDocDrawerConfig)QRoute.api(IDocDrawerConfig.class)).getAndroidDrawerText();
    localQQSettingMeDocumentBean.b = ((IDocDrawerConfig)QRoute.api(IDocDrawerConfig.class)).getAndroidDrawerIconURL();
