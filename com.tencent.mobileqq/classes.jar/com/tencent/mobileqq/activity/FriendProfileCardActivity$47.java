  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (localBitmap == null) {
      localObject = ((FriendProfileCardBgDrawable)this.this$0.jdField_a_of_type_AndroidGraphicsDrawableDrawable).b();
    }
    if ((localObject != null) && (!((Bitmap)localObject).isRecycled()))
    {
      ...
      bain.a((Bitmap)localObject, 2);
      if ((this.this$0.b != null) && (this.this$0.jdField_a_of_type_Atwx != null) && (this.this$0.jdField_a_of_type_Atwx.a != null))
      {
        localObject = this.this$0.b.obtainMessage(12, localObject);
        this.this$0.jdField_a_of_type_ComTencentMobileqqProfileProfileShoppingPhotoInfo = ProfileShoppingPhotoInfo.getPhotoInfo(this.this$0.app, this.this$0.jdField_a_of_type_Atwx.a.a);
