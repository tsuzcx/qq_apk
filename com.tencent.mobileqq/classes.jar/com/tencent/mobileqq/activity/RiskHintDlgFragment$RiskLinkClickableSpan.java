  ...
  extends ClickableSpan
{
  ...
  public RiskHintDlgFragment$RiskLinkClickableSpan(String paramString, QQCustomDialog paramQQCustomDialog, WeakReference<FragmentActivity> paramWeakReference)
  {
  ...
  public void onClick(View paramView)
  {
    ...
    ModifyPwdTopBarHelper.a().a(paramView.app.getCurrentAccountUin());
    if (this.jdField_a_of_type_JavaLangString.contains("1108149324")) {
      ReportController.b(paramView.app, "dc00898", "", "", "0X800B259", "0X800B259", 0, 0, "", "", "", "");
    }
