  ...
  implements Runnable
{
  public void run()
  {
    ...
    } while ((!bool1) || (TextUtils.isEmpty(str1)) || (RegisterVerifyCodeActivity.a(this.this$0, "8.3.5", (String)localObject) < 0));
    ...
    {
      advd localadvd = new advd(this, str1);
      int i = str1.indexOf(str2);
      ((SpannableString)localObject).setSpan(localadvd, i, str2.length() + i, 33);
    }
    ...
    {
      RegisterVerifyCodeActivity.a(this.this$0).setChecked(awia.a().a);
