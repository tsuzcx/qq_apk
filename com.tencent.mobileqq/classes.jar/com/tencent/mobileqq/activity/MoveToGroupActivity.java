...
{
  public byte a;
  private FriendListObserver jdField_a_of_type_ComTencentMobileqqAppFriendListObserver = new syv(this);
  private QQProgressDialog jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog;
  private XListView jdField_a_of_type_ComTencentWidgetXListView;
  private String jdField_a_of_type_JavaLangString;
  public List a;
  private syx jdField_a_of_type_Syx;
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    super.setContentView(2130969105);
    setTitle(getString(2131434524));
    paramBundle = (TextView)findViewById(2131363227);
    ...
    this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)findViewById(2131365151));
    this.jdField_a_of_type_Syx = new syx(this, null);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Syx);
    paramBundle.setOnClickListener(new syw(this));
    return true;
  }
  ...
  public void onClick(View paramView)
  {
    ...
    if (this.jdField_a_of_type_Syx != null) {
      this.jdField_a_of_type_Syx.notifyDataSetChanged();
    }
    if (getIntent().getBooleanExtra("PARAM_EXECUTE_IMMEDIATELY", true))
    {
      if ((this.jdField_a_of_type_Byte >= 0) && (this.jdField_a_of_type_Byte != this.b))
      {
        ...
        QQToast.a(this.app.getApp(), getString(2131434595), 1).b(getTitleBarHeight());
        finish();
        return;
      }
      if (this.jdField_a_of_type_Byte == this.b) {
        QQToast.a(this, getString(2131434499), 0).b(getTitleBarHeight());
      }
    }
    c();
  }
