  ...
  implements View.OnClickListener
{
  public int a;
  protected long a;
  ajen jdField_a_of_type_Ajen = new abpk(this);
  Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new abpi(this);
  View jdField_a_of_type_AndroidViewView;
  public ImageView a;
  public RelativeLayout a;
  TextView jdField_a_of_type_AndroidWidgetTextView;
  private babk jdField_a_of_type_Babk;
  baox jdField_a_of_type_Baox = new abpl(this);
  protected String a;
  protected byte[] a;
  protected int b;
  ...
  private void e()
  {
    ...
    if (QLog.isColorLevel())
    {
      localObject = new StringBuilder().append("initData type:").append(this.jdField_a_of_type_Int).append(" name:").append(this.jdField_a_of_type_JavaLangString).append(" url:").append(azzz.a(this.jdField_b_of_type_JavaLangString)).append(" cookie:");
      if (this.jdField_a_of_type_ArrayOfByte != null)
      {
        i = this.jdField_a_of_type_ArrayOfByte.length;
        QLog.d("Q.BabyQ", 2, i + " jump:" + azzz.a(this.jdField_c_of_type_JavaLangString) + " optWord:" + this.jdField_d_of_type_JavaLangString + " optUrl:" + azzz.a(this.e) + " toast:" + this.f + " picUrl:" + azzz.a(this.g) + " faceId:" + this.jdField_a_of_type_Long);
      }
    }
    else
    {
  ...
  void a()
  {
    ...
    for (;;)
    {
      ...
      while (i != 0)
      {
        finish();
        return;
        ((baot)this.app.a(71)).a(this.jdField_a_of_type_Long, -1, 1);
        awqx.b(this.app, "dc00898", "", "", "0X800723D", "0X800723D", 0, 0, "", "", "", "");
        continue;
        if (this.jdField_a_of_type_Int == 11)
        {
          b();
          ajei.a(this.app, this.jdField_b_of_type_Int, 2);
          i = 1;
        }
        else if ((this.jdField_a_of_type_Int == 12) || (this.jdField_a_of_type_Int == 13))
        {
          ((ajei)this.app.a(53)).b(this.jdField_a_of_type_ArrayOfByte);
          ajei.a(this.app, this.jdField_b_of_type_Int, 2);
        }
        else if (this.jdField_a_of_type_Int == 2)
        {
          d();
          awqx.b(this.app, "dc00898", "", "", "0X800724B", "0X800724B", 0, 0, "", "", "", "");
          i = 1;
        }
        else
        {
  ...
  public void b()
  {
    ...
    localIntent.putExtra("leftViewText", super.getString(2131624770));
  ...
  void d()
  {
    String str = "";
    if (balu.a != null) {
      str = balu.a.jdField_a_of_type_JavaLangString;
    }
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    super.setContentView(2131495459);
    e();
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)super.findViewById(2131309475));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)super.findViewById(2131309476));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)super.findViewById(2131311075));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)super.findViewById(2131309470));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131309472));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131309474));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)super.findViewById(2131298711));
    this.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)super.findViewById(2131309471));
    this.jdField_a_of_type_AndroidViewView = super.findViewById(2131308969);
    ...
    try
    {
      ...
      paramBundle.mRequestWidth = azvv.a(this, 75.0F);
      paramBundle.mRequestHeight = azvv.a(this, 65.0F);
      ...
      this.jdField_a_of_type_Babk = new babk(Looper.getMainLooper(), this.jdField_a_of_type_AndroidOsHandler$Callback);
      this.jdField_a_of_type_Babk.sendEmptyMessageDelayed(1, 200L);
      super.addObserver(this.jdField_a_of_type_Ajen);
      super.addObserver(this.jdField_a_of_type_Baox);
      if (this.jdField_a_of_type_Int == 2)
      {
        awqx.b(this.app, "dc00898", "", "", "0X800724A", "0X800724A", 0, 0, "", "", "", "");
        return true;
      }
    }
    catch (Exception paramBundle)
    {
      ...
      ajei.a(this.app, this.jdField_b_of_type_Int, 1);
    }
    return true;
  }
  ...
  {
    super.doOnDestroy();
    super.removeObserver(this.jdField_a_of_type_Ajen);
