  ...
  implements Handler.Callback
{
  ...
  private String a(int paramInt)
  {
    ...
    case 3: 
    default: 
      return HardCodeUtil.a(2131706040);
    case 0: 
      return HardCodeUtil.a(2131706042);
    case 1: 
      return HardCodeUtil.a(2131706044);
    case 2: 
      return HardCodeUtil.a(2131706043);
    }
    return HardCodeUtil.a(2131706045);
  }
  ...
  private boolean b()
  {
    ...
    for (;;)
    {
      ...
      return true;
      label287:
      this.c = LebaQZoneFacePlayHelper.FacePlayInfo.a(str, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      break;
      label302:
      ...
      this.jdField_b_of_type_ComTencentMobileqqActivityLebaQZoneFacePlayHelper$FacePlayInfo = LebaQZoneFacePlayHelper.FacePlayInfo.a(str, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      ...
      this.d = null;
      if (QLog.isColorLevel()) {
        QLog.i("UndealCount.Q.lebatab.lebaLebaQZoneFacePlayHelper", 2, "isPlayFinished play one" + this.jdField_b_of_type_ComTencentMobileqqActivityLebaQZoneFacePlayHelper$FacePlayInfo.jdField_a_of_type_JavaLangString);
      }
    }
    label553:
    return false;
  ...
  private void g()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityLebaQZoneFacePlayHelper$FacePlayInfo != null) && (!this.jdField_a_of_type_ComTencentMobileqqActivityLebaQZoneFacePlayHelper$FacePlayInfo.a()))
    {
    ...
    if ((this.jdField_b_of_type_ComTencentMobileqqActivityLebaQZoneFacePlayHelper$FacePlayInfo != null) && (!this.jdField_b_of_type_ComTencentMobileqqActivityLebaQZoneFacePlayHelper$FacePlayInfo.a()))
    {
    ...
    for (;;)
    {
      try
      {
        ...
        if ((this.jdField_a_of_type_JavaUtilArrayList.size() > 1) && (this.jdField_a_of_type_Int > 0))
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.i("UndealCount.Q.lebatab.lebaLebaQZoneFacePlayHelper", 2, "play two" + this.jdField_b_of_type_ComTencentMobileqqActivityLebaQZoneFacePlayHelper$FacePlayInfo.jdField_a_of_type_JavaLangString);
          }
      ...
      catch (Throwable localThrowable)
      {
        ...
        QZoneExceptionReport.doReport(localThrowable, HardCodeUtil.a(2131706041));
        return;
      }
      h();
      continue;
      ...
      if (!this.c.a())
      {
        ...
        continue;
        label541:
        if ((this.jdField_b_of_type_ComTencentMobileqqActivityLebaQZoneFacePlayHelper$FacePlayInfo == null) || ((!this.jdField_b_of_type_ComTencentMobileqqActivityLebaQZoneFacePlayHelper$FacePlayInfo.a()) && (!this.jdField_b_of_type_ComTencentMobileqqActivityLebaQZoneFacePlayHelper$FacePlayInfo.jdField_a_of_type_JavaLangString.equals(localThrowable))))
        {
          this.jdField_b_of_type_ComTencentMobileqqActivityLebaQZoneFacePlayHelper$FacePlayInfo = LebaQZoneFacePlayHelper.FacePlayInfo.a(localThrowable, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          continue;
          label587:
          this.jdField_b_of_type_ComTencentMobileqqActivityLebaQZoneFacePlayHelper$FacePlayInfo = a(localThrowable);
          if (this.jdField_b_of_type_ComTencentMobileqqActivityLebaQZoneFacePlayHelper$FacePlayInfo == null) {
            this.jdField_b_of_type_ComTencentMobileqqActivityLebaQZoneFacePlayHelper$FacePlayInfo = LebaQZoneFacePlayHelper.FacePlayInfo.a(localThrowable, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          }
          FaceDrawable localFaceDrawable = this.jdField_b_of_type_ComTencentMobileqqActivityLebaQZoneFacePlayHelper$FacePlayInfo.a();
          if (localFaceDrawable != null)
          {
            this.jdField_a_of_type_AndroidWidgetImageSwitcher.setImageDrawable(localFaceDrawable);
            if (QLog.isColorLevel()) {
              QLog.i("UndealCount.Q.lebatab.lebaLebaQZoneFacePlayHelper", 2, "play one" + this.jdField_b_of_type_ComTencentMobileqqActivityLebaQZoneFacePlayHelper$FacePlayInfo.jdField_a_of_type_JavaLangString);
            }
          }
        }
      }
  ...
  void a(boolean paramBoolean)
  {
    ...
    localAlphaAnimation1.setAnimationListener(new LebaQZoneFacePlayHelper.1(this, paramBoolean));
