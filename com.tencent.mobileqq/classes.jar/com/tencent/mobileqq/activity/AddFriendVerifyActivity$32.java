  ...
  implements DialogInterface.OnClickListener
{
  ...
  public void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    ...
    if (QLog.isColorLevel())
    {
      ...
      paramDialogInterface.append(String.format("&uin=%s", new Object[] { AddFriendVerifyActivity.a(this.a) }));
    ...
    localStringBuilder.append(String.format("&uin=%s", new Object[] { AddFriendVerifyActivity.a(this.a) }));
