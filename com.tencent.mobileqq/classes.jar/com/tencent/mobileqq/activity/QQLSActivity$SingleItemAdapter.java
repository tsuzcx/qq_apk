  ...
  extends XBaseAdapter
{
  ...
  private View b(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView != null)
    {
      ...
      if (!(paramViewGroup instanceof tgp)) {}
    }
    for (paramViewGroup = (tgp)paramViewGroup;; paramViewGroup = null)
    {
      if (paramViewGroup == null)
      {
        paramView = this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.getLayoutInflater().inflate(2130970372, null);
        paramViewGroup = new tgp();
        paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370299));
      ...
      for (;;)
      {
        Object localObject = (ImageView)paramView.findViewById(2131370302);
        if (localObject != null)
        {
  ...
  public View a(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if ((paramView == null) || (!(paramView.getTag() instanceof QQLSActivity.SinglePttHolder)))
    {
      ...
      paramView = this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.getLayoutInflater().inflate(2130970367, null);
    ...
    for (;;)
    {
      ...
      if ((localMessageRecord instanceof MessageForPtt))
      {
        ...
        ((TextView)paramView.findViewById(2131370297)).setText((CharSequence)localObject);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    do
    {
      ...
      if (paramView != null)
      {
        ...
        if ((paramView.getTag() instanceof tgo)) {}
      }
      else
      {
        paramViewGroup = this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.getLayoutInflater().inflate(2130970371, null);
        paramView = new tgo();
        localObject1 = (TextView)paramViewGroup.findViewById(2131370299);
        localObject2 = (ImageView)paramViewGroup.findViewById(2131370298);
    ...
    MessageRecord localMessageRecord = (MessageRecord)this.jdField_a_of_type_JavaUtilList.get(paramInt);
    Object localObject2 = (tgo)paramViewGroup.getTag();
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.jdField_a_of_type_JavaUtilArrayList.size() > 0) && (((String)localObject1).equals("")) && ((localMessageRecord.msgtype == -2016) || (localMessageRecord.msgtype == -2009) || (localMessageRecord.msgtype == -2026)))
      {
        ...
        ((tgo)localObject2).jdField_a_of_type_AndroidWidgetTextView.setTextColor(-570319);
        ((tgo)localObject2).jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
        label371:
        ((tgo)localObject2).jdField_a_of_type_AndroidWidgetTextView.setText(new QQText((CharSequence)localObject1, 5, 16, QQLSActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity).a()));
        ...
        if ((localMessageRecord.istroop == 1001) || (localMessageRecord.istroop == 1010) || (localMessageRecord.istroop == 10002))
        {
          if (localMessageRecord.msgtype == -2053)
          {
            ...
            paramView = this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.getString(2131437845) + (String)localObject1 + paramView.msg;
            continue;
          }
          ...
          {
            ((TextView)QQLSActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity).findViewById(2131370281)).setText(BaseApplicationImpl.getApplication().getString(2131437959));
            localObject1 = BaseApplicationImpl.getApplication().getString(2131437960);
            ((DragTextView)QQLSActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity).findViewById(2131370285)).setVisibility(8);
            ...
            ((TextView)QQLSActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity).findViewById(2131370281)).setText(localObject3[4]);
            paramView = localObject3[5];
            continue;
          }
          if (localMessageRecord.frienduin.equals(AppConstants.ac))
          {
            ((TextView)QQLSActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity).findViewById(2131370281)).setText(BaseApplicationImpl.getApplication().getString(2131437961));
            localObject1 = BaseApplicationImpl.getApplication().getString(2131437962);
            ((DragTextView)QQLSActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity).findViewById(2131370285)).setVisibility(8);
        ...
        {
          paramView = this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.getResources().getString(2131430270) + QQLSActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity).a().a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity, localMessageRecord, false);
          continue;
        }
      ...
      for (paramView = PublicAccountConfigUtil.a(QQLSActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity), BaseApplicationImpl.getContext()) + ":";; paramView = "")
      {
        ...
        paramView = QQLSActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity).a().a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity, localMessageRecord, false);
        break;
        ((tgo)localObject2).jdField_a_of_type_AndroidWidgetTextView.setTextColor(-4210755);
        ((tgo)localObject2).jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
        break label371;
      }
    }
  }
