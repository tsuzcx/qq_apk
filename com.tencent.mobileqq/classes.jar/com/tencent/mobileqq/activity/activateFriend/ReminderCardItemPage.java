  ...
  implements View.OnClickListener
{
  ...
  public void a()
  {
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131560608, this, false);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363924));
    this.f = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363925));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131363923));
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131363920));
    this.jdField_a_of_type_ComTencentMobileqqWidgetRoundImageView = ((RoundImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363921));
    this.jdField_a_of_type_ComTencentMobileqqWidgetRoundImageView.setmRadius(vzo.a(getContext(), 5.0F), true);
    this.g = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363926));
    this.h = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363919));
    this.i = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363917));
    this.i.setOnClickListener(this);
    this.jdField_b_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131363918));
    this.jdField_b_of_type_AndroidWidgetButton.setOnClickListener(this);
    this.j = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363922));
  ...
  public void a(AcsMsg paramAcsMsg)
  {
    for (;;)
    {
      try
      {
        ...
        this.f.setText(acrt.a(paramAcsMsg.notice_time * 1000L, "HH:mm"));
        ...
        if (TextUtils.isEmpty(paramAcsMsg.banner_url))
        {
          ...
          this.j.setText(acrt.a(paramAcsMsg.sub_time * 1000L, "yyyy.MM.dd") + ajyc.a(2131717573) + paramAcsMsg.busi_name + ajyc.a(2131717574));
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131363917: 
      if (this.jdField_a_of_type_WalletAcsMsg != null)
      {
        ...
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "QQnotice", "", "", "QQnotice.aio.detail.all", 0, 0, "", "", this.jdField_a_of_type_WalletAcsMsg.busi_id, this.jdField_a_of_type_WalletAcsMsg.msg_id);
      }
    ...
    if (this.jdField_a_of_type_WalletAcsMsg != null)
    {
      ...
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "QQnotice", "", "", "QQnotice.aio.detail.click", 0, 0, "", "", this.jdField_a_of_type_WalletAcsMsg.busi_id, this.jdField_a_of_type_WalletAcsMsg.msg_id);
    }
