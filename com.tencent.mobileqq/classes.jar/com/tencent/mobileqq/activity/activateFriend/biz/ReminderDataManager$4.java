...
public class ReminderDataManager$4
  implements Runnable
{
  public ReminderDataManager$4(aewd paramaewd, aewk paramaewk) {}
  
  public void run()
  {
    ArrayList localArrayList = new ArrayList();
    aewd.a(this.this$0);
    Object localObject = aewd.a(this.this$0, NetConnInfoCenter.getServerTimeMillis());
    if (localObject == null) {
      if (QLog.isColorLevel()) {
        QLog.d("ReminderDataManagerNew", 1, "async from db, msg list is null");
      }
    }
    while (!aewd.a(this.this$0).get())
    {
      ...
      for (;;)
      {
        if (((Iterator)localObject).hasNext())
        {
          ...
          aewd.a(this.this$0, localAcsMsg, 1);
          continue;
          if (QLog.isColorLevel()) {
