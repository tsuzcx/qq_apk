...
public class ActivateFriendView
  ...
  implements azwh
{
  private static final int jdField_a_of_type_Int = bajq.b(85.0F);
  private static Bitmap jdField_a_of_type_AndroidGraphicsBitmap;
  private static final int jdField_b_of_type_Int = bajq.b(70.0F);
  private static final int jdField_c_of_type_Int = bajq.b(70.0F);
  private static final int d = bajq.b(52.0F);
  private acgv jdField_a_of_type_Acgv;
  ajjh jdField_a_of_type_Ajjh = new acgy(this);
  public ajvm a;
  ajvp jdField_a_of_type_Ajvp = new acgz(this);
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new acgx(this);
  ...
  public void setData(QQAppInterface paramQQAppInterface, ArrayList<ActivateFriendItem> paramArrayList)
  {
    ...
    default: 
      ...
      if (!TextUtils.isEmpty(((ActivateFriendItem)this.jdField_a_of_type_JavaUtilArrayList.get(j)).nickName))
      {
        ...
        if (this.jdField_a_of_type_Boolean)
        {
          if ((!getResources().getString(2131624045).equals(((ActivateFriendItem)this.jdField_a_of_type_JavaUtilArrayList.get(j)).birthdayDesc)) && (!this.jdField_a_of_type_Ajvm.c(((ActivateFriendItem)this.jdField_a_of_type_JavaUtilArrayList.get(j)).uin, ((ActivateFriendItem)this.jdField_a_of_type_JavaUtilArrayList.get(j)).type))) {
            break label472;
          }
    ...
    for (;;)
    {
      ...
      break label289;
      label472:
      if ((this.jdField_a_of_type_Ajvm.a(((ActivateFriendItem)this.jdField_a_of_type_JavaUtilArrayList.get(j)).uin, ((ActivateFriendItem)this.jdField_a_of_type_JavaUtilArrayList.get(j)).type)) || (this.jdField_a_of_type_Ajvm.b(((ActivateFriendItem)this.jdField_a_of_type_JavaUtilArrayList.get(j)).uin, ((ActivateFriendItem)this.jdField_a_of_type_JavaUtilArrayList.get(j)).type)))
      {
        paramQQAppInterface.setChecked(false);
    ...
    if (this.jdField_a_of_type_Acgv != null) {
      this.jdField_a_of_type_Acgv.a(this.e);
    }
  }
