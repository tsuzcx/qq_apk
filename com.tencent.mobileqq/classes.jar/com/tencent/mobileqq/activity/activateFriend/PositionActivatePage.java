...
{
  private agbv jdField_a_of_type_Agbv = new agcf(this);
  ...
  {
    super(paramContext);
    this.jdField_b_of_type_AndroidViewView$OnClickListener = new agch(this);
    this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference((ActivateFriendActivity)paramContext);
    this.jdField_a_of_type_AndroidWidgetButton.setText(2131689524);
  ...
  public void a()
  {
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561022, this, false);
