  ...
  implements View.OnClickListener
{
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    abtq.a(paramContext, localIntent, PublicTransFragmentActivity.class, QQNotifySettingFragment.class);
  }
  
  public View a(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup)
  {
    return paramLayoutInflater.inflate(2131560605, paramViewGroup, false);
  }
  
  public void a()
  {
    bcql.a(getActivity(), ajya.a(2131710586), 0).a();
  }
  ...
  public void b(int paramInt, String paramString)
  {
    ...
    if (paramInt == 0)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetButton.setText(ajya.a(2131710582));
      this.c.setText(ajya.a(2131710588));
      this.d.setText(ajya.a(2131710584));
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131368586));
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(0);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368584));
    paramLayoutInflater = URLDrawable.URLDrawableOptions.obtain();
    paramLayoutInflater.mRequestHeight = vzl.a(getActivity(), 106.0F);
    paramLayoutInflater.mRequestWidth = vzl.a(getActivity(), 195.0F);
    ...
    this.d = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368585));
    this.c = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378081));
