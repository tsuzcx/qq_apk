    ...
    do
    {
      ...
      if (i < ActivateFriendView.a(this.a).size())
      {
        if (this.a.a.c(((ActivateFriendItem)ActivateFriendView.a(this.a).get(i)).uin, 2))
        {
          ...
          ((ActivateFriendViewItem)ActivateFriendView.b(this.a).get(i)).setBirthday(this.a.getResources().getString(2131689522));
        }
        for (;;)
        {
          i += 1;
          ...
          {
            ((ActivateFriendViewItem)ActivateFriendView.b(this.a).get(i)).setChecked(false);
            ((ActivateFriendViewItem)ActivateFriendView.b(this.a).get(i)).setBirthday(this.a.getResources().getString(2131689525));
          }
          else
          {
