  ...
  implements View.OnClickListener
{
  ...
  anam jdField_a_of_type_Anam = new aisz(this);
  private FragmentActivity jdField_a_of_type_AndroidSupportV4AppFragmentActivity;
  private ViewPager jdField_a_of_type_AndroidSupportV4ViewViewPager;
  private RecyclerView jdField_a_of_type_AndroidSupportV7WidgetRecyclerView;
  private SpannableString jdField_a_of_type_AndroidTextSpannableString;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new aita(this);
  ...
  private Map<String, aith> jdField_b_of_type_JavaUtilMap;
  ...
  private List<aith> jdField_d_of_type_JavaUtilList;
  ...
  private void a(List<EmoticonFromGroupEntity> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if (localEmoticonFromGroupEntity != null) {
        ...
        {
          MessageForPic localMessageForPic = this.jdField_a_of_type_Araq.a(localEmoticonFromGroupEntity);
          ...
          {
            this.jdField_a_of_type_Araq.b(localEmoticonFromGroupEntity);
            this.jdField_a_of_type_Araq.a(localEmoticonFromGroupEntity);
          }
        }
        else
        {
  ...
  private void b(List<EmoticonFromGroupEntity> paramList)
  {
    ...
    Object localObject2 = ((arba)localObject1).a();
    ...
    {
      EmoticonFromGroupEntity localEmoticonFromGroupEntity = (EmoticonFromGroupEntity)paramList.next();
      if (this.jdField_a_of_type_Araq.a((List)localObject1, localEmoticonFromGroupEntity.bigURL))
      {
  ...
  private void c()
  {
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.mContentView.findViewById(2131379986));
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView = ((RecyclerView)this.mContentView.findViewById(2131372636));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.mContentView.findViewById(2131363826));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.mContentView.findViewById(2131367741));
    this.jdField_b_of_type_AndroidWidgetButton = ((Button)this.mContentView.findViewById(2131363852));
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
    this.jdField_b_of_type_AndroidWidgetButton.setOnClickListener(this);
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.titleRoot.getContext()).inflate(2131561867, this.titleRoot, false);
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131365969);
    this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131365970);
    this.jdField_a_of_type_AndroidSupportV4ViewViewPager = ((ViewPager)this.jdField_a_of_type_AndroidViewView.findViewById(2131365971));
    this.jdField_d_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131363824);
    this.jdField_e_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131363825);
    this.jdField_c_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131363854));
    this.jdField_d_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131363853));
    ...
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.mContentView.findViewById(2131379977));
    ...
    this.jdField_f_of_type_AndroidViewView.setBackgroundColor(Color.parseColor(getString(2131165364)));
    try
    {
      this.jdField_g_of_type_AndroidViewView = LayoutInflater.from(this.titleRoot.getContext()).inflate(2131561862, this.titleRoot, false);
      this.h = this.jdField_g_of_type_AndroidViewView.findViewById(2131366688);
      this.h.setOnClickListener(this);
      this.jdField_a_of_type_AndroidWidgetListView = ((ListView)this.jdField_g_of_type_AndroidViewView.findViewById(2131370404));
      this.jdField_a_of_type_AndroidWidgetListView.setOnItemClickListener(new aitb(this));
      this.jdField_a_of_type_Aitf = new aitf(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity);
      this.jdField_a_of_type_AndroidWidgetListView.setAdapter(this.jdField_a_of_type_Aitf);
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_g_of_type_AndroidViewView.findViewById(2131379984));
      this.jdField_e_of_type_AndroidWidgetButton = ((Button)this.jdField_g_of_type_AndroidViewView.findViewById(2131363837));
      this.jdField_f_of_type_AndroidWidgetButton = ((Button)this.jdField_g_of_type_AndroidViewView.findViewById(2131363836));
      ...
      this.i = this.mContentView.findViewById(2131367742);
      ((URLImageView)this.i.findViewById(2131368542)).setImageDrawable(URLDrawable.getDrawable("https://imgcache.gtimg.cn/ACT/svip_act/act_img/public/201802/m1517913373_empty_img_1.png"));
      this.jdField_g_of_type_AndroidWidgetButton = new Button(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity);
      this.jdField_g_of_type_AndroidWidgetButton.setId(2131378037);
  ...
  private void c(List<EmoticonFromGroupEntity> paramList)
  {
    ...
    while ((getActivity() != null) && (k != 0))
    {
      ...
      String str = String.format(getString(2131692851), new Object[] { Integer.valueOf(k) });
      if (k < 3) {
        j = paramList.size();
      }
      k = 0;
      for (;;)
      {
        if (k < j)
        {
          URLDrawable localURLDrawable = (URLDrawable)this.jdField_a_of_type_Araq.a((EmoticonFromGroupEntity)paramList.get(k), 65537, ScreenUtil.dip2px(11.0F), null);
          int m = k + 1;
          k = m;
          if (localURLDrawable != null)
          {
            ...
            if (1 != localURLDrawable.getStatus())
            {
              ...
              localURLDrawable.setURLDrawableListener(new aite(this));
              k = m;
              continue;
              k = paramList.size();
              break;
      ...
      paramList = new aitk(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  ...
  private void d()
  {
    ...
    this.leftView.setText(2131692852);
    ...
    this.jdField_g_of_type_AndroidWidgetButton.setBackgroundResource(2130840291);
    ...
    this.jdField_b_of_type_AndroidViewAnimationTranslateAnimation.setAnimationListener(new aitc(this));
  ...
  private void e()
  {
    this.jdField_a_of_type_Aitl = new aitl(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this, this.jdField_a_of_type_Araq.a(), this.jdField_a_of_type_AndroidViewView, this.jdField_a_of_type_AndroidSupportV4ViewViewPager, this.jdField_b_of_type_AndroidWidgetButton);
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.setAdapter(this.jdField_a_of_type_Aitl);
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.setOnScrollListener(new aitd(this));
  }
  ...
  private void j()
  {
    ...
    for (;;)
    {
      localaith.jdField_a_of_type_JavaLangString = localEmoticonFromGroupEntity.troopUin;
      localaith.jdField_a_of_type_AndroidGraphicsBitmap = ((Bitmap)localObject2);
      localaith.jdField_a_of_type_Boolean = false;
      localaith.b = ((String)localObject1);
      localaith.jdField_a_of_type_Int = ((List)localEntry.getValue()).size();
      localCopyOnWriteArrayList.add(localaith);
      localConcurrentHashMap2.put(localaith.jdField_a_of_type_JavaLangString, localaith);
      break;
      if (3000 == localEmoticonFromGroupEntity.fromType)
      {
        ...
        this.jdField_a_of_type_Aitf.a(this.jdField_d_of_type_JavaUtilList);
        this.jdField_a_of_type_Aitf.notifyDataSetChanged();
        this.jdField_c_of_type_AndroidWidgetTextView.setText(amtj.a(2131703183) + this.jdField_b_of_type_JavaUtilList.size() + amtj.a(2131703195));
      }
      else
      {
        localObject1 = null;
  ...
  private void l()
  {
    ...
    while (localIterator.hasNext()) {
      ((aith)localIterator.next()).jdField_a_of_type_Boolean = false;
    }
  ...
  private void n()
  {
    this.jdField_g_of_type_AndroidWidgetButton.setBackgroundResource(2130840292);
  ...
  public void init(Bundle paramBundle)
  {
    ...
    super.setTitle(amtj.a(2131703184));
    ...
    for (;;)
    {
      this.jdField_a_of_type_Araq = ((bgga)paramBundle.getManager(235)).jdField_a_of_type_Araq;
      paramBundle = (arbb)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(103);
      if (paramBundle != null) {
        paramBundle.b();
      }
  ...
  {
    if ((this.jdField_a_of_type_Aitl != null) && (this.jdField_a_of_type_Aitl.jdField_a_of_type_Boolean))
    {
      ...
      this.jdField_a_of_type_Aitl.jdField_a_of_type_Boolean = false;
      this.jdField_a_of_type_Aitl.a(false);
      this.jdField_a_of_type_Aitl.notifyDataSetChanged();
      m();
      a(true);
      resetLeftButton();
      return true;
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      n();
      a(false);
      setLeftButton(amtj.a(2131703216), this.jdField_a_of_type_AndroidViewView$OnClickListener);
      this.leftViewNotBack.setTextColor(getResources().getColor(2131165351));
      this.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
      this.jdField_b_of_type_AndroidWidgetButton.setTextColor(Color.parseColor("#FFBFBFBF"));
      this.jdField_b_of_type_AndroidWidgetButton.setBackgroundDrawable(getResources().getDrawable(2130844307));
      this.jdField_b_of_type_AndroidWidgetButton.setEnabled(false);
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
      this.jdField_a_of_type_Aitl.a(true);
      this.jdField_a_of_type_Aitl.jdField_a_of_type_Boolean = true;
      this.jdField_a_of_type_Aitl.notifyDataSetChanged();
      ...
      this.jdField_a_of_type_Araq.d(new ArrayList(this.jdField_a_of_type_JavaUtilList));
      Object localObject1 = this.jdField_a_of_type_JavaUtilList.iterator();
      while (((Iterator)localObject1).hasNext()) {
        ((EmoticonFromGroupEntity)((Iterator)localObject1).next()).status = 0;
      }
      localObject1 = (arao)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(259);
      ((arao)localObject1).b -= this.jdField_a_of_type_JavaUtilList.size();
      this.jdField_a_of_type_JavaUtilList.clear();
      this.jdField_a_of_type_Aitl.notifyDataSetChanged();
      m();
      a(true);
      ...
      if (this.titleRoot == this.jdField_a_of_type_AndroidViewView.getParent())
      {
        ...
        if ((localObject1 != null) && (((EmoticonFromGroupEntity)localObject1).msg != null)) {
          agyh.b(new aham(agzl.a(((EmoticonFromGroupEntity)localObject1).msg)), this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 0);
        }
        for (;;)
        {
        ...
        localObject1 = ((ImgPreviewAdapter)this.jdField_a_of_type_AndroidSupportV4ViewViewPager.getAdapter()).a(this.jdField_a_of_type_AndroidSupportV4ViewViewPager.getCurrentItem());
        if (this.jdField_a_of_type_Araq.a((EmoticonFromGroupEntity)localObject1))
        {
          this.jdField_c_of_type_JavaUtilList.add(localObject1);
          this.jdField_d_of_type_AndroidWidgetButton.setText(amtj.a(2131703175));
          this.jdField_d_of_type_AndroidWidgetButton.setTextColor(Color.parseColor("#FFBBBBBB"));
          this.jdField_d_of_type_AndroidWidgetButton.setBackgroundDrawable(getResources().getDrawable(2130844307));
        ...
        else
        {
          ...
          while (((Iterator)localObject1).hasNext())
          {
            ...
            ((aith)this.jdField_b_of_type_JavaUtilMap.get(localObject2)).jdField_a_of_type_Boolean = true;
          }
          ...
          if (j == 0)
          {
            ...
            localObject2 = this.jdField_a_of_type_Araq.a((List)localObject1);
            if (localObject2 != null)
            {
              c((List)localObject1);
              this.jdField_a_of_type_Aitl.a((Map)localObject2, (List)localObject1);
            }
          }
          for (;;)
          {
  ...
  public void onDestroyView()
  {
    super.onDestroyView();
    this.jdField_a_of_type_JavaUtilList.clear();
    this.jdField_a_of_type_Araq.b(this.jdField_c_of_type_JavaUtilList);
    this.jdField_a_of_type_Araq.c(this.jdField_c_of_type_JavaUtilList);
  ...
  public void onResume()
  {
    ...
    if ((this.jdField_d_of_type_AndroidWidgetButton != null) && (this.jdField_a_of_type_AndroidSupportV4ViewViewPager != null))
    {
      ...
      if (localEmoticonFromGroupEntity != null)
      {
        ...
        this.jdField_d_of_type_AndroidWidgetButton.setText(amtj.a(2131703218));
        this.jdField_d_of_type_AndroidWidgetButton.setTextColor(Color.parseColor("#FFBBBBBB"));
        this.jdField_d_of_type_AndroidWidgetButton.setBackgroundDrawable(getResources().getDrawable(2130844307));
        this.jdField_d_of_type_AndroidWidgetButton.setEnabled(false);
      }
    ...
    return;
    label123:
    this.jdField_d_of_type_AndroidWidgetButton.setText(amtj.a(2131703179));
    this.jdField_d_of_type_AndroidWidgetButton.setTextColor(Color.parseColor("#FFFFFFFF"));
    this.jdField_d_of_type_AndroidWidgetButton.setBackgroundDrawable(getResources().getDrawable(2130844306));
