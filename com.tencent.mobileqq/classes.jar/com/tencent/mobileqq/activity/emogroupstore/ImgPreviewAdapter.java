  ...
  extends PagerAdapter
{
  ...
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new afuf(this);
  ...
  public Object instantiateItem(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    for (;;)
    {
      localURLImageView.setImageDrawable((URLDrawable)this.jdField_a_of_type_Ansm.a((EmoticonFromGroupEntity)this.jdField_a_of_type_JavaUtilList.get(paramInt), 1, -1, null));
      ...
      localURLImageView.setLayoutParams(new Gallery.LayoutParams(axlk.a(166.0F), axlk.a(166.0F)));
