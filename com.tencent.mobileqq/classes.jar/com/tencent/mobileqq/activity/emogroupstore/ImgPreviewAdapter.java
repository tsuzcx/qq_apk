  ...
  extends PagerAdapter
{
  ...
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new ahrx(this);
  ...
  public Object instantiateItem(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    for (;;)
    {
      localURLImageView.setImageDrawable((URLDrawable)this.jdField_a_of_type_Apju.a((EmoticonFromGroupEntity)this.jdField_a_of_type_JavaUtilList.get(paramInt), 1, -1, null));
      ...
      localURLImageView.setLayoutParams(new Gallery.LayoutParams(azgq.a(166.0F), azgq.a(166.0F)));
