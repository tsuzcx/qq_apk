  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (this.a == 1)
    {
      int j = -1;
      int i = j;
      if (SDKEmotionSettingManager.c(this.this$0) != null)
      {
        i = j;
        if (SDKEmotionSettingManager.c(this.this$0).size() > 0) {
          i = ((Integer)SDKEmotionSettingManager.c(this.this$0).get(0)).intValue();
        }
      }
