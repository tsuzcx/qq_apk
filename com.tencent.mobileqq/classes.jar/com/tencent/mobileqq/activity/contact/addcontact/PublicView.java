...
public class PublicView
  ...
  implements View.OnClickListener, bftk
{
  private long jdField_a_of_type_Long;
  private afft jdField_a_of_type_Afft;
  private affu jdField_a_of_type_Affu = new affu(this);
  private akdo jdField_a_of_type_Akdo = new affr(this);
  ...
  public PublicView(affk paramaffk)
  {
    super(paramaffk);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt1, String paramString1, String paramString2, int paramInt2, String paramString3, int paramInt3)
  {
    if (paramInt1 == 1)
    {
      ...
      sgj.a(paramString2, paramQQAppInterface, paramContext, paramString1, -7);
      return;
    }
    paramString1 = new Intent();
    paramString1.putExtra("uinname", paramString3);
    paramString1.putExtra("source", paramInt3);
    sgj.a(paramString1, paramQQAppInterface, paramContext, paramString2, paramInt2);
  }
  ...
  private void a(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      ...
      this.jdField_a_of_type_JavaUtilArrayList = ((akdi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(56)).c();
    }
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_Afft == null) {
        this.jdField_a_of_type_Afft = new afft(this, this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentWidgetXListView);
      }
      this.jdField_a_of_type_Afft.notifyDataSetChanged();
      return;
  ...
  private void e()
  {
    ...
    View localView = localLayoutInflater.inflate(2131560592, this.jdField_a_of_type_ComTencentWidgetXListView, false);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131362115));
    this.jdField_a_of_type_AndroidWidgetTextView.setPadding(getResources().getDimensionPixelSize(2131298014), 0, 0, 0);
    Drawable localDrawable = getResources().getDrawable(2130849226);
  ...
  private void j()
  {
    ...
    SosoInterface.a(new affq(this, 1, true, true, 0L, false, false, "PublicView"));
    this.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Affu.sendEmptyMessageDelayed(4, 3000L);
    if (QLog.isColorLevel()) {
  ...
  private void l()
  {
    if (Build.VERSION.SDK_INT >= 23)
    {
      if (this.jdField_a_of_type_AndroidAppActivity.checkSelfPermission("android.permission.ACCESS_FINE_LOCATION") != 0)
      {
        ...
        localAppActivity.requestPermissions(new affs(this, localAppActivity), 1, new String[] { "android.permission.ACCESS_FINE_LOCATION" });
        return;
      }
      j();
      return;
  ...
  protected void a()
  {
    ...
    a(2131560591);
    e();
    ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).addObserver(this.jdField_a_of_type_Akdo);
    a(true);
    l();
  }
  ...
  public boolean a(int paramInt, View paramView, ListView paramListView)
  {
    ...
    if (!a()) {
      this.jdField_a_of_type_Affu.sendEmptyMessageDelayed(2, 1000L);
    }
    return true;
  }
  ...
  protected void d()
  {
    ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).removeObserver(this.jdField_a_of_type_Akdo);
    if (this.jdField_a_of_type_Afft != null) {
      this.jdField_a_of_type_Afft.c();
    }
    super.d();
  }
  ...
  public void onClick(View paramView)
  {
    ...
    default: 
      return;
    case 2131362115: 
      this.jdField_a_of_type_Affk.a();
      awvy.a("add_page", "search", "active_frame", 3, 0, new String[] { "" });
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004BEC", "0X8004BEC", 3, 0, "", "", "", "");
      return;
    }
    paramView = (affv)paramView.getTag();
