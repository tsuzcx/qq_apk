  ...
  extends BaseAdapter
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      if (paramView == null)
      {
        paramView = this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a().getLayoutInflater().inflate(2131561023, paramViewGroup, false);
        ...
        localObject1 = new SearchBaseFragment.ItemViewHolder();
        ((SearchBaseFragment.ItemViewHolder)localObject1).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368314));
        ((SearchBaseFragment.ItemViewHolder)localObject1).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131372287));
        ((SearchBaseFragment.ItemViewHolder)localObject1).jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131380888));
        ((SearchBaseFragment.ItemViewHolder)localObject1).jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131365697));
        ((SearchBaseFragment.ItemViewHolder)localObject1).d = ((TextView)paramView.findViewById(2131370765));
        ((SearchBaseFragment.ItemViewHolder)localObject1).jdField_a_of_type_ComTencentPbAddcontactsAccountSearchPb$record = ((AccountSearchPb.record)getItem(paramInt));
        ((SearchBaseFragment.ItemViewHolder)localObject1).jdField_b_of_type_Int = ClassificationSearchFragment.a(this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment);
        paramView.setTag(2131371032, Integer.valueOf(paramInt));
        paramView.setTag(localObject1);
        localView = paramView;
        if ((((SearchBaseFragment.ItemViewHolder)localObject1).jdField_a_of_type_AndroidWidgetImageView instanceof ThemeImageView))
        {
          ((ThemeImageView)((SearchBaseFragment.ItemViewHolder)localObject1).jdField_a_of_type_AndroidWidgetImageView).setSupportMaskView(false);
          localView = paramView;
        }
      }
      ...
      if (AppSetting.d)
      {
        ...
        if (paramView == null)
        {
          localView = this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a().getLayoutInflater().inflate(2131561576, null);
          ...
          paramView.jdField_c_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131379371));
          paramView.d = ((TextView)localView.findViewById(2131363135));
          paramView.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131363872));
        ...
        paramView = (SearchBaseFragment.ArticleItemViewHolder)localView.getTag();
        ...
        int i = this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.getResources().getDimensionPixelSize(2131297524);
        ...
        try
        {
          ...
          if ((((AccountSearchPb.record)localObject1).brief.has()) && (!"".equals(((AccountSearchPb.record)localObject1).brief.get()))) {
            if (this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a(paramView.jdField_a_of_type_AndroidWidgetTextView, this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a()) > 1)
            {
              ...
              localView.setLayoutParams(new AbsListView.LayoutParams(new AbsListView.LayoutParams(-1, AIOUtils.a(110.0F, this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a().getResources()))));
              localObject2 = (ImageView)localView.findViewById(2131381805);
              ((ImageView)localObject2).setVisibility(4);
              ImageView localImageView = (ImageView)localView.findViewById(2131365419);
        ...
        catch (Exception localException)
        {
          for (;;)
          {
            ...
            localView.setLayoutParams(new AbsListView.LayoutParams(new AbsListView.LayoutParams(-1, AIOUtils.a(90.0F, this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a().getResources()))));
          }
        }
        localView = paramView;
        if (paramView == null)
        {
          localView = this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a().getLayoutInflater().inflate(2131559592, null);
          localView.setOnClickListener(this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment);
          paramView = new ClassificationSearchFragment.MoreViewHolder();
          localView.setTag(paramView);
        ...
        localObject1 = (ClassificationSearchFragment.MoreViewHolder)localView.getTag();
        if (this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.jdField_a_of_type_Int == 3)
        {
          if (!this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.jdField_a_of_type_Boolean)
          {
            ...
            ((ClassificationSearchFragment.MoreViewHolder)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
            ((ClassificationSearchFragment.MoreViewHolder)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(HardCodeUtil.a(2131701975));
            paramView = localView;
          }
          else
          {
            ...
            if (NetworkUtil.d(BaseApplicationImpl.getContext()))
            {
              ...
              ((ClassificationSearchFragment.MoreViewHolder)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
              ((ClassificationSearchFragment.MoreViewHolder)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(HardCodeUtil.a(2131701984));
        ...
        {
          ((ClassificationSearchFragment.MoreViewHolder)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
          ((ClassificationSearchFragment.MoreViewHolder)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(HardCodeUtil.a(2131701992));
          paramView = localView;
        }
        else
        {
          ...
          {
            ((ClassificationSearchFragment.MoreViewHolder)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
            ((ClassificationSearchFragment.MoreViewHolder)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(HardCodeUtil.a(2131701988));
            paramView = localView;
          }
        }
      }
