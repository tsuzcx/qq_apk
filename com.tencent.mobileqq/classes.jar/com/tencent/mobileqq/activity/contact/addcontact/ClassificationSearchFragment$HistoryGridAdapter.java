...
public class ClassificationSearchFragment$HistoryGridAdapter
  extends BaseAdapter
  implements PublicAccountSearchRecommendManager.GetRecommendListListener, DecodeTaskCompletionListener
{
  ...
  private ArrayList<PublicAccountSearchRecommendManager.PublicAccountSearchRecommendItem> jdField_a_of_type_JavaUtilArrayList;
  ...
  public ArrayList<PublicAccountSearchRecommendManager.PublicAccountSearchRecommendItem> a()
  {
  ...
  public void a(ArrayList<PublicAccountSearchRecommendManager.PublicAccountSearchRecommendItem> paramArrayList, String paramString, boolean paramBoolean)
  {
    ...
    if (ClassificationSearchFragment.a(this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment) != null)
    {
      if (getCount() == 0)
      {
        ((TextView)ClassificationSearchFragment.a(this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment).findViewById(2131377620)).setText(HardCodeUtil.a(2131701974));
    ...
    for (;;)
    {
      ...
      if (TextUtils.isEmpty(paramString)) {
        ((TextView)ClassificationSearchFragment.a(this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment).findViewById(2131377620)).setText(HardCodeUtil.a(2131701979));
      }
      for (;;)
      {
        ...
        break;
        ((TextView)ClassificationSearchFragment.a(this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment).findViewById(2131377620)).setText(paramString);
      }
      label271:
  ...
  {
    if (paramView == null) {
      paramView = LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.getActivity()).inflate(2131559750, null);
    }
    for (;;)
    {
      PublicAccountSearchRecommendManager.PublicAccountSearchRecommendItem localPublicAccountSearchRecommendItem = (PublicAccountSearchRecommendManager.PublicAccountSearchRecommendItem)getItem(paramInt);
      if (localPublicAccountSearchRecommendItem != null)
      {
        if (this.jdField_a_of_type_ComTencentMobileqqActivityRecentRecentFaceDecoder != null)
        {
          Drawable localDrawable = this.jdField_a_of_type_ComTencentMobileqqActivityRecentRecentFaceDecoder.a(1008, localPublicAccountSearchRecommendItem.jdField_a_of_type_JavaLangString);
          ((URLImageView)paramView.findViewById(2131368281)).setImageDrawable(localDrawable);
        }
        ((TextView)paramView.findViewById(2131372115)).setText(localPublicAccountSearchRecommendItem.b);
        paramView.findViewById(2131365255).setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
        paramView.findViewById(2131365255).setTag(localPublicAccountSearchRecommendItem);
        paramView.setTag(localPublicAccountSearchRecommendItem);
      }
  ...
  public void onDecodeTaskCompleted(int paramInt1, int paramInt2, String paramString, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      ...
      {
        GridView localGridView = (GridView)ClassificationSearchFragment.a(this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment).findViewById(2131377616);
        ...
        while (paramInt1 < paramInt2)
        {
          ...
          if (paramString.equals(((PublicAccountSearchRecommendManager.PublicAccountSearchRecommendItem)localView.getTag()).jdField_a_of_type_JavaLangString)) {
            ((URLImageView)localView.findViewById(2131368281)).setImageBitmap(paramBitmap);
          }
          paramInt1 += 1;
        }
      }
