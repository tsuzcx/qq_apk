  ...
  implements ViewFactory.GuideView.OnItemClickListener
{
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    ((SearchContactsFragment)localObject).a = true;
    ((SearchContactsFragment)localObject).b = paramInt;
    if (paramInt == 80000001) {
      SearchUtils.a("add_page", "search", "clk_search_grp", ((SearchContactsFragment)localObject).f + 1, 0, new String[] { "", "", paramString, "" });
    }
