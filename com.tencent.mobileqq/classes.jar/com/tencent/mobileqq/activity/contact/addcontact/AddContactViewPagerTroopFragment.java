  ...
  implements View.OnClickListener
{
  protected int a;
  public aesq a;
  aess jdField_a_of_type_Aess = new aetc(this);
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new aesz(this);
  ...
  public AddContactViewPagerTroopFragment()
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnTouchListener = new aesy(this);
  }
  ...
  private void c(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(2131624166);
    this.jdField_b_of_type_AndroidWidgetTextView.setText(2131641368);
    this.jdField_c_of_type_AndroidWidgetTextView.setText(2131624165);
    localObject = this.jdField_a_of_type_AndroidWidgetLinearLayout.getParent();
    if ((localObject != null) && ((localObject instanceof ViewGroup))) {
      ((ViewGroup)localObject).setBackgroundResource(2130839104);
    }
    if (paramBoolean)
    {
  ...
  public View a(LayoutInflater paramLayoutInflater, Bundle paramBundle)
  {
    ...
    {
      this.jdField_a_of_type_AndroidViewView = paramLayoutInflater.inflate(2131494084, null);
      this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131311525));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131302278));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131311409));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131311410));
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131311411));
      this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)this.jdField_a_of_type_AndroidViewView.findViewById(2131309225));
      this.jdField_a_of_type_ComTencentWidgetXListView.setId(2131296545);
    ...
    for (boolean bool = false;; bool = true)
    {
      ...
      {
        c(true);
        this.jdField_a_of_type_Aesq = new aesq(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentWidgetXListView, null, this.jdField_a_of_type_Int, this.jdField_b_of_type_JavaLangString);
        this.jdField_a_of_type_Aesq.jdField_a_of_type_Aess = this.jdField_a_of_type_Aess;
      }
      for (;;)
      {
        ...
        paramLayoutInflater = akfu.a("recommend_troop");
        if (QLog.isColorLevel()) {
        ...
        akfu.a(new aete(this, "recommend_troop"));
        break;
  ...
  public void a()
  {
    ...
    e();
    if (this.jdField_a_of_type_Aesq != null) {
      this.jdField_a_of_type_Aesq.e();
    }
  }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    if (!this.jdField_b_of_type_JavaLangString.equals(paramString1))
    {
      ...
      if ((this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Aesq != null)) {
        this.jdField_a_of_type_Aesq.a(paramString1);
      }
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        if (!this.jdField_a_of_type_AndroidWidgetTextView.getText().equals(getResources().getString(2131624166))) {
          break label158;
        }
      ...
      while ((this.jdField_b_of_type_Boolean) && (!this.jdField_c_of_type_Boolean))
      {
        ...
        this.jdField_a_of_type_Aesq.a(false);
        return;
        label158:
        awqx.b(null, "dc00899", "Grp_find_new", "", "grptab", "no_meet_exp", 0, 0, this.jdField_c_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString, "", "");
      }
    }
  }
