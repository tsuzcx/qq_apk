  ...
  implements AddContactFindTroopRTLW.onRefreshCallback
{
  ...
  public void a(boolean paramBoolean, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      ...
      this.a.jdField_a_of_type_AndroidWidgetTextView.setText(2131689660);
      this.a.jdField_b_of_type_AndroidWidgetTextView.setText(2131689664);
      this.a.c.setText(2131689661);
