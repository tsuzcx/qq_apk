  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    do
    {
      ...
      ConnectsExplorationFriendAdapter.a(this.jdField_a_of_type_ComTencentMobileqqActivityContactConnectionsConnectsExplorationFriendAdapter$7.this$0).setText(2131698974);
    ...
    QLog.d("ConnectsExplorationFriendAdapter", 2, "reloadRecommendData empty " + ConnectsExplorationFriendAdapter.a(this.jdField_a_of_type_ComTencentMobileqqActivityContactConnectionsConnectsExplorationFriendAdapter$7.this$0));
  }
}
