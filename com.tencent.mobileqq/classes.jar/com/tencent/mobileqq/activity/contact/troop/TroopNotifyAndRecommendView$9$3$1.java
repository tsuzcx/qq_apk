...
class TroopNotifyAndRecommendView$9$3$1
  implements Runnable
{
  TroopNotifyAndRecommendView$9$3$1(TroopNotifyAndRecommendView.9.3 param3, structmsg.StructMsg paramStructMsg, long paramLong) {}
  ...
  public void run()
  {
    if (this.jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg != null)
    {
      ...
      if (((i == 2) || (i == 3)) && (this.jdField_a_of_type_ComTencentMobileqqActivityContactTroopTroopNotifyAndRecommendView$9$3.b == 1))
      {
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.contact.troop.TroopNotifyAndRecommendView.9.3.1
