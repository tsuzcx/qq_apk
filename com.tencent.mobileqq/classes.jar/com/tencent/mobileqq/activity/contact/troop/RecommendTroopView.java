  ...
  implements View.OnClickListener, FaceDecoder.DecodeTaskCompletionListener, Observer
{
  ...
  public TextView a;
  TroopObserver jdField_a_of_type_ComTencentMobileqqAppTroopObserver = new wqc(this);
  ...
  {
    a(2130969713);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131367586));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131367589));
    this.jdField_a_of_type_ComTencentWidgetSwipListView = ((SwipListView)findViewById(2131367587));
    this.f = LayoutInflater.from(a()).inflate(2130969958, null);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.f.findViewById(2131368537));
    this.jdField_e_of_type_AndroidViewView = this.f.findViewById(2131368536);
    ...
    for (;;)
    {
      this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131367588));
      this.jdField_a_of_type_ComTencentWidgetSwipListView.setTranscriptMode(0);
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)findViewById(2131367591));
  ...
  public void j()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppSosoSosoInterface$OnLocationListener = new wqd(this, 3, true, false, 1800000L, false, false, "RecommendTroopView");
  ...
  protected void l()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactTroopBaseTroopView$ITroopContext.a(new wqf(this));
  }
  ...
  public void m()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqActivityContactTroopBaseTroopView$ITroopContext.a(new wqg(this, (List)localObject));
