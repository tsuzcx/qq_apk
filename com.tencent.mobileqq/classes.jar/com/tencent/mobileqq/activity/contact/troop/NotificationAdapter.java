  ...
  extends XBaseAdapter
{
  ...
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new NotificationAdapter.1(this);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      localViewHolder = new NotificationAdapter.ViewHolder();
      localViewHolder.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131374134));
      localViewHolder.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131374117));
      localViewHolder.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131374125));
      localViewHolder.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131374138));
      localViewHolder.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131374123));
      localViewHolder.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131374135));
      localViewHolder.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131374137));
      localViewHolder.d = ((TextView)paramView.findViewById(2131374124));
      localViewHolder.jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131374133));
      localViewHolder.jdField_a_of_type_ComTencentMobileqqWidgetShaderAnimLayout = ((ShaderAnimLayout)paramView.findViewById(2131379998));
      ((Button)paramView.findViewById(2131379997)).setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
      paramView.setTag(localViewHolder);
      localViewHolder.jdField_b_of_type_Int = paramInt;
      if (paramInt >= this.jdField_a_of_type_Int) {
        break label272;
      }
      NewFriendBaseBuilder.a(paramView, true);
      NewFriendBaseBuilder.a(localViewHolder.jdField_a_of_type_AndroidWidgetLinearLayout, true);
    }
    ...
    for (;;)
    {
      ...
      break;
      label272:
      NewFriendBaseBuilder.a(paramView, false);
      NewFriendBaseBuilder.a(localViewHolder.jdField_a_of_type_AndroidWidgetLinearLayout, false);
    }
    label289:
    localViewHolder.jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg = ((MessageForSystemMsg)localMessageRecord).getSystemMsg();
    localViewHolder.jdField_c_of_type_Long = localMessageRecord.uniseq;
    if (localMessageRecord != null) {}
    for (int i = ((MessageForSystemMsg)localMessageRecord).getSystemMsg().msg_type.get();; i = 2)
    {
      if (i == 2) {
        this.jdField_a_of_type_ComTencentMobileqqActivityContactNewfriendBaseSystemMsgInterface.a(localViewHolder, paramInt);
      }
      break;
      label354:
      break;
