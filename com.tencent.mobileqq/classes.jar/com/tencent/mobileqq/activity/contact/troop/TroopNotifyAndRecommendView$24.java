...
class TroopNotifyAndRecommendView$24
  implements View.OnClickListener
{
  TroopNotifyAndRecommendView$24(TroopNotifyAndRecommendView paramTroopNotifyAndRecommendView) {}
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if (TroopNotificationUtils.a(i) == 0)
      {
        ...
        TroopUtils.a(this.a.a(), (Bundle)localObject1, 2);
        if ((i == 2) || (i == 10) || (i == 12))
        {
          i = 1;
          label117:
      ...
      if ((((SuspiciousHolder)localObject2).jdField_a_of_type_Int != 2) || (!TroopInfo.isQidianPrivateTroop(((SuspiciousHolder)localObject2).jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.msg.uint32_group_flagext3.get())))
      {
        ...
        localObject1 = new ActivityURIRequest(this.a.jdField_a_of_type_AndroidContentContext, "/pubaccount/detail");
    ...
    default: 
      ...
      label370:
      if (((FriendsManager)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER)).b((String)localObject1)) {
    ...
    for (;;)
    {
      ...
      ReportController.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_contacts", "", "notice", "see_fromdata", 0, 0, ((SuspiciousHolder)localObject2).jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.msg.group_code.get() + "", "3", "", "");
      break;
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.contact.troop.TroopNotifyAndRecommendView.24
