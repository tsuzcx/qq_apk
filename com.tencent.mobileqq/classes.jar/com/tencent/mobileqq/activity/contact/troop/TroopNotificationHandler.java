...
{
  public TroopNotificationHandler(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      ...
      {
        return;
        localTroopNotificationManager = (TroopNotificationManager)this.appRuntime.getManager(QQManagerFactory.TROOP_NOTIFICATION_MANAGER);
    ...
    {
      paramFromServiceMsg = localTroopNotificationManager.a(paramToServiceMsg);
      if (paramFromServiceMsg != null) {
        localTroopNotificationManager.a(paramFromServiceMsg);
      }
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      ...
      paramFromServiceMsg = (TroopNotificationManager)this.appRuntime.getManager(QQManagerFactory.TROOP_NOTIFICATION_MANAGER);
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.contact.troop.TroopNotificationHandler
