...
public class DiscussionView
  ...
  implements amci, View.OnClickListener, bich, bkhe, bkmq
{
  private ajdj jdField_a_of_type_Ajdj = new ajdj(this, null);
  public amce a;
  ...
  {
    if ((a() == null) || (this.jdField_a_of_type_Amce == null)) {
      return;
    }
    if (paramInt == 0)
    {
    ...
    if ((paramInt < 0) || (paramInt >= this.jdField_a_of_type_Amce.getCount()))
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(4);
      return;
    }
    Object localObject = this.jdField_a_of_type_Amce.getItem(0);
    ...
    for (int i = ((Integer)localObject).intValue();; i = 0)
    {
      if (i == 0)
      {
        ...
        if (!(this.jdField_a_of_type_Amce.getItem(paramInt) instanceof Integer)) {
          break label214;
        }
        if (paramInt >= this.jdField_a_of_type_Amce.getCount()) {
          break;
        }
  ...
  private void k()
  {
    this.e = findViewById(2131365994);
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.e.findViewById(2131365150));
    this.e.setVisibility(8);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131379357));
    this.b = getResources().getDimensionPixelSize(2131299045);
    this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView = ((SlideDetectListView)findViewById(2131370333));
    ...
    View localView = localLayoutInflater.inflate(2131562820, this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView, false);
    localView.findViewById(2131363719).setVisibility(8);
    EditText localEditText = (EditText)localView.findViewById(2131366102);
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView.setContentBackground(2130838758);
  ...
  private void l()
  {
    ...
    a(localIntent, 1300);
    bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "Contacts_tab", "Contacts_tab_creat_discuss", 0, 0, "", "", "", "");
  }
  ...
  {
    DiscussionInfo localDiscussionInfo = this.jdField_a_of_type_Amce.a(paramInt);
    ...
    do
    {
      ...
      {
        return;
        paramView = (ShaderAnimLayout)paramView.findViewById(2131365549);
      } while (paramView == null);
      localButton = (Button)paramView.findViewById(2131365548);
    ...
    for (paramInt = 2131695491;; paramInt = 2131695487)
    {
  ...
  {
    if (this.jdField_a_of_type_Amce.a(paramInt) == null) {}
    do
    {
      do
      {
        return;
        paramSlideDetectListView = (ShaderAnimLayout)paramView.findViewById(2131365549);
      } while (paramSlideDetectListView == null);
      paramSlideDetectListView.e();
      paramSlideDetectListView = (Button)paramSlideDetectListView.findViewById(2131365548);
    } while (paramSlideDetectListView == null);
  ...
  protected boolean b()
  {
    ...
    {
      this.c = true;
      ((anks)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6)).f(Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).longValue());
      return true;
    }
    return false;
  }
  ...
  public void d()
  {
    ...
    {
      this.jdField_a_of_type_Amce.b = true;
  ...
  public void e()
  {
    super.e();
    if (this.jdField_a_of_type_Amce != null) {
      this.jdField_a_of_type_Amce.b = false;
    }
  }
  ...
  protected void j()
  {
    this.jdField_a_of_type_Amce = new amce(a(), this, this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false);
    this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView.setAdapter(this.jdField_a_of_type_Amce);
    a(this.jdField_a_of_type_Ajdj);
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      return;
      h();
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006665", "0X8006665", 0, 0, "", "", "", "");
      continue;
      l();
    }
  }
