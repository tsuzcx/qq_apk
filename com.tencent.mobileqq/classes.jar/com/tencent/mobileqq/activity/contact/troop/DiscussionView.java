...
public class DiscussionView
  ...
  implements amgw, View.OnClickListener, bldp, SlideDetectListView.OnSlideListener, AbsListView.OnScrollListener
{
  private ajec jdField_a_of_type_Ajec = new ajec(this, null);
  public amgs a;
  ...
  {
    if ((a() == null) || (this.jdField_a_of_type_Amgs == null)) {
      return;
    }
    if (paramInt == 0)
    {
    ...
    if ((paramInt < 0) || (paramInt >= this.jdField_a_of_type_Amgs.getCount()))
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(4);
      return;
    }
    Object localObject = this.jdField_a_of_type_Amgs.getItem(0);
    ...
    for (int i = ((Integer)localObject).intValue();; i = 0)
    {
      if (i == 0)
      {
        ...
        if (!(this.jdField_a_of_type_Amgs.getItem(paramInt) instanceof Integer)) {
          break label214;
        }
        if (paramInt >= this.jdField_a_of_type_Amgs.getCount()) {
          break;
        }
  ...
  private void k()
  {
    this.e = findViewById(2131366171);
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.e.findViewById(2131365310));
    this.e.setVisibility(8);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131379609));
    this.b = getResources().getDimensionPixelSize(2131299129);
    this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView = ((SlideDetectListView)findViewById(2131370585));
    ...
    View localView = localLayoutInflater.inflate(2131562804, this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView, false);
    localView.findViewById(2131363845).setVisibility(8);
    EditText localEditText = (EditText)localView.findViewById(2131366280);
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView.setContentBackground(2130838911);
  ...
  private void l()
  {
    ...
    a(localIntent, 1300);
    bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "Contacts_tab", "Contacts_tab_creat_discuss", 0, 0, "", "", "", "");
  }
  ...
  protected boolean b()
  {
    ...
    {
      this.c = true;
      ((antl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.DISCUSSION_HANDLER)).f(Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).longValue());
      return true;
    }
    return false;
  }
  ...
  public void d()
  {
    if (this.jdField_a_of_type_Amgs != null)
    {
      this.jdField_a_of_type_Amgs.b = true;
      this.jdField_a_of_type_Amgs.notifyDataSetChanged();
    }
  }
  ...
  public void e()
  {
    super.e();
    if (this.jdField_a_of_type_Amgs != null) {
      this.jdField_a_of_type_Amgs.b = false;
    }
  }
  ...
  {
    super.g();
    b(this.jdField_a_of_type_Ajec);
    if (this.jdField_a_of_type_Amgs != null) {
      this.jdField_a_of_type_Amgs.a();
    }
  }
  ...
  protected void j()
  {
    this.jdField_a_of_type_Amgs = new amgs(a(), this, this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false);
    this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView.setAdapter(this.jdField_a_of_type_Amgs);
    a(this.jdField_a_of_type_Ajec);
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      return;
      h();
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006665", "0X8006665", 0, 0, "", "", "", "");
      continue;
      l();
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Amgs.a(paramInt) == null) {}
    do
    {
      do
      {
        return;
        paramSlideDetectListView = (ShaderAnimLayout)paramView.findViewById(2131365717);
      } while (paramSlideDetectListView == null);
      paramSlideDetectListView.hide();
      paramSlideDetectListView = (Button)paramSlideDetectListView.findViewById(2131365716);
    } while (paramSlideDetectListView == null);
  ...
  {
    DiscussionInfo localDiscussionInfo = this.jdField_a_of_type_Amgs.a(paramInt);
    ...
    do
    {
      ...
      {
        return;
        paramView = (ShaderAnimLayout)paramView.findViewById(2131365717);
      } while (paramView == null);
      localButton = (Button)paramView.findViewById(2131365716);
    ...
    for (paramInt = 2131695925;; paramInt = 2131695921)
    {
