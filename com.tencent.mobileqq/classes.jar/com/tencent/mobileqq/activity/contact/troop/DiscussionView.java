...
public class DiscussionView
  ...
  implements amoc, View.OnClickListener, bjdf, blih, blnt
{
  private ajos jdField_a_of_type_Ajos = new ajos(this, null);
  public amny a;
  ...
  {
    if ((a() == null) || (this.jdField_a_of_type_Amny == null)) {
      return;
    }
    if (paramInt == 0)
    {
    ...
    if ((paramInt < 0) || (paramInt >= this.jdField_a_of_type_Amny.getCount()))
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(4);
      return;
    }
    Object localObject = this.jdField_a_of_type_Amny.getItem(0);
    ...
    for (int i = ((Integer)localObject).intValue();; i = 0)
    {
      if (i == 0)
      {
        ...
        if (!(this.jdField_a_of_type_Amny.getItem(paramInt) instanceof Integer)) {
          break label214;
        }
        if (paramInt >= this.jdField_a_of_type_Amny.getCount()) {
          break;
        }
  ...
  private void k()
  {
    this.e = findViewById(2131366040);
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.e.findViewById(2131365194));
    this.e.setVisibility(8);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131379524));
    this.b = getResources().getDimensionPixelSize(2131299058);
    this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView = ((SlideDetectListView)findViewById(2131370434));
    ...
    View localView = localLayoutInflater.inflate(2131562854, this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView, false);
    localView.findViewById(2131363745).setVisibility(8);
    EditText localEditText = (EditText)localView.findViewById(2131366151);
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView.setContentBackground(2130838778);
  ...
  private void l()
  {
    ...
    a(localIntent, 1300);
    bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "Contacts_tab", "Contacts_tab_creat_discuss", 0, 0, "", "", "", "");
  }
  ...
  {
    DiscussionInfo localDiscussionInfo = this.jdField_a_of_type_Amny.a(paramInt);
    ...
    do
    {
      ...
      {
        return;
        paramView = (ShaderAnimLayout)paramView.findViewById(2131365591);
      } while (paramView == null);
      localButton = (Button)paramView.findViewById(2131365590);
    ...
    for (paramInt = 2131695534;; paramInt = 2131695530)
    {
  ...
  {
    if (this.jdField_a_of_type_Amny.a(paramInt) == null) {}
    do
    {
      do
      {
        return;
        paramSlideDetectListView = (ShaderAnimLayout)paramView.findViewById(2131365591);
      } while (paramSlideDetectListView == null);
      paramSlideDetectListView.e();
      paramSlideDetectListView = (Button)paramSlideDetectListView.findViewById(2131365590);
    } while (paramSlideDetectListView == null);
  ...
  protected boolean b()
  {
    ...
    {
      this.c = true;
      ((anwo)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6)).f(Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).longValue());
      return true;
    }
    return false;
  }
  ...
  public void d()
  {
    if (this.jdField_a_of_type_Amny != null)
    {
      this.jdField_a_of_type_Amny.b = true;
  ...
  public void e()
  {
    super.e();
    if (this.jdField_a_of_type_Amny != null) {
      this.jdField_a_of_type_Amny.b = false;
    }
  }
  ...
  protected void j()
  {
    this.jdField_a_of_type_Amny = new amny(a(), this, this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false);
    this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView.setAdapter(this.jdField_a_of_type_Amny);
    a(this.jdField_a_of_type_Ajos);
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      return;
      h();
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006665", "0X8006665", 0, 0, "", "", "", "");
      continue;
      l();
    }
  }
