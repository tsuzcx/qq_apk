...
public class TroopNotificationUtils
{
  ...
  {
    int i = 0 + GroupSystemMsgController.a().a(paramQQAppInterface) + RecommendTroopManagerImp.b(paramQQAppInterface);
  ...
  public static Drawable a(FaceDecoder paramFaceDecoder, String paramString, int paramInt)
  {
    ...
    label68:
    for (localBitmap1 = ImageUtil.f();; localBitmap1 = ImageUtil.a()) {
