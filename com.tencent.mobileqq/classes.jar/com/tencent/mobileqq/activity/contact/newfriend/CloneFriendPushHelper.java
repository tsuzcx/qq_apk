...
public class CloneFriendPushHelper
{
  ...
  private static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3)
  {
    ...
    localMessageForText.msg = String.format(HardCodeUtil.a(2131702007), new Object[] { paramString1, paramString3, paramString2 });
  ...
  private static void b(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt)
  {
    ...
    Object localObject1 = HardCodeUtil.a(2131702010);
    String str1 = String.format("%s(%s)", new Object[] { paramString2, paramString1 });
    Object localObject2 = HardCodeUtil.a(2131702008);
    if (paramInt == 1) {}
    for (paramString2 = HardCodeUtil.a(2131702002);; paramString2 = HardCodeUtil.a(2131702005))
    {
      ...
      paramString2 = HardCodeUtil.a(2131702006);
      paramString4 = HardCodeUtil.a(2131702003);
      localObject2 = new UniteGrayTipParam(paramString3, paramString3, (String)localObject1 + str1 + str2 + str3 + "的好友列表中。\n不想和他们是好友关系，可选择" + paramString2 + "。\n不想再被其他好友克隆，可选择" + paramString4 + "。", 0, -5040, 2686977, MessageCache.a());
      ...
      ((UniteGrayTipParam)localObject2).a(paramInt, str1.length() + paramInt, localBundle);
      ...
      paramString3.putString("key_a_action_DATA", String.format(HardCodeUtil.a(2131702009), new Object[] { str1, str3 }));
      paramInt = paramInt + str3.length() + "的好友列表中。\n不想和他们是好友关系，可选择".length();
      ((UniteGrayTipParam)localObject2).a(paramInt, paramString2.length() + paramInt, paramString3);
      ...
      ((UniteGrayTipParam)localObject2).a(paramInt, paramString4.length() + paramInt, paramString1);
  ...
  {
    MessageForUniteGrayTip localMessageForUniteGrayTip = new MessageForUniteGrayTip();
    localMessageForUniteGrayTip.initGrayTipMsg(paramQQAppInterface, new UniteGrayTipParam(paramString, paramString, HardCodeUtil.a(2131702004), 0, -5020, 2686977, MessageCache.a()));
    UniteGrayTipUtil.a(paramQQAppInterface, localMessageForUniteGrayTip);
  }
}
