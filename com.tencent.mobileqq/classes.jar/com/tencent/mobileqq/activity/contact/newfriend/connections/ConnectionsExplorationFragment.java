...
{
  altm jdField_a_of_type_Altm = new ahnp(this);
  ...
  private ArrayList<ahnq> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  private int a(int paramInt)
  {
    ...
    {
      ahnq localahnq = (ahnq)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt);
      if (localahnq != null) {
        return localahnq.a;
      }
    }
  ...
  private void a(View paramView)
  {
    ...
    LinearLayout localLinearLayout = (LinearLayout)paramView.findViewById(2131376034);
    ...
    this.b = ((TextView)paramView.findViewById(2131368624));
    this.b.setVisibility(0);
    this.b.setText("");
    this.b.setOnClickListener(new ahno(this));
    this.jdField_a_of_type_Alwd = ((alwd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131369751));
    this.c = ((TextView)paramView.findViewById(2131365744));
    this.jdField_a_of_type_ComTencentMobileqqActivityContactNewfriendConnectionsConnectionsExplorationViewPager = ((ConnectionsExplorationViewPager)paramView.findViewById(2131364703));
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactNewfriendConnectionsThemeTabLayout = ((ThemeTabLayout)paramView.findViewById(2131377381));
    a(true, false);
    a(true);
  ...
  public void a(sko paramsko)
  {
    ...
    for (;;)
    {
      ...
      return;
      azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "frd_recom", "frd_tab_clk", a(paramsko.a()), 0, "0", "4", "", "");
    }
  }
  ...
  {
    paramLayoutInflater = paramLayoutInflater.inflate(2131561113, paramViewGroup, false);
