  ...
  extends MessageObserver
{
  ...
  public void onSendSystemMsgActionError(String paramString)
  {
    ...
    {
      paramString = SystemMsgListView.a(this.a).getResources().getString(2131719697);
    ...
    for (;;)
    {
      ...
      if (!paramBoolean)
      {
        ...
        for (;;)
        {
          ...
          return;
          paramString3 = SystemMsgListView.a(this.a).getResources().getString(2131719023);
        }
      }
      paramString1 = SystemMsgListView.a(this.a).getResources().getString(2131692699);
      ...
      try
      {
        this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().a(AppConstants.FRIEND_SYSTEM_MSG_UIN, 0, l2, localStructMsg.toByteArray());
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.contact.newfriend.SystemMsgListView.MessageObserverForSystemMsgListView
