    ...
    for (;;)
    {
        ...
        if (!TextUtils.isEmpty(paramStructMsg.msg.msg_qna.get()))
        {
          ...
          if (bool)
          {
            ...
            if (!TextUtils.isEmpty(str)) {
              paramStructMsg = paramContext.getString(2131693430) + paramContext.getString(2131693429) + str;
            }
          }
        }
      }
      for (;;)
      {
        ...
        if (bool)
        {
          paramStructMsg = str;
          if (!TextUtils.isEmpty(str)) {
            paramStructMsg = paramContext.getString(2131693428) + paramContext.getString(2131693429) + str;
          }
        }
      }
    }
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.contact.newfriend.msg.FriendSystemMessage
