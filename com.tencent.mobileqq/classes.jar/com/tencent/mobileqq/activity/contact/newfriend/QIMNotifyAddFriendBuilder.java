  ...
  implements View.OnClickListener
{
  ...
  public View a(int paramInt, View paramView)
  {
    ...
    if ((paramView == null) || (!(paramView.getTag() instanceof QIMNotifyAddFriendBuilder.QIMNotifyAddFriendHolder)))
    {
      ...
      paramView = a(this.jdField_a_of_type_AndroidContentContext, 2130970650, localQIMNotifyAddFriendHolder);
      localQIMNotifyAddFriendHolder.jdField_f_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131366543));
      localQIMNotifyAddFriendHolder.h = ((TextView)paramView.findViewById(2131362899));
      localQIMNotifyAddFriendHolder.i = ((TextView)paramView.findViewById(2131369991));
      localQIMNotifyAddFriendHolder.l = ((TextView)paramView.findViewById(2131371530));
      localQIMNotifyAddFriendHolder.j = ((TextView)paramView.findViewById(2131369993));
      localQIMNotifyAddFriendHolder.k = ((TextView)paramView.findViewById(2131368975));
      localQIMNotifyAddFriendHolder.a = ((Button)paramView.findViewById(2131368974));
      ...
      localQIMNotifyAddFriendHolder.jdField_f_of_type_AndroidViewView.setBackgroundResource(2130838591);
      ...
      localQIMNotifyAddFriendHolder.jdField_f_of_type_AndroidViewView.setBackgroundResource(2130838595);
      paramInt = 0;
      switch (localQIMNotifyAddFriend.gender)
      {
      default: 
        i = 0;
        localQIMNotifyAddFriendHolder.l.setBackgroundResource(2130843152);
    ...
    for (;;)
    {
      ...
      localQIMNotifyAddFriendHolder.a.setBackgroundResource(2130838515);
      ...
      j = 1;
      k = 2130843149;
      localQIMNotifyAddFriendHolder.l.setBackgroundResource(2130843150);
      i = k;
      paramInt = j;
      if (!AppSetting.b) {
        break label300;
  ...
  protected void a()
  {
    ...
    ThreadManager.postImmediately(new wpf(this), null, true);
  }
