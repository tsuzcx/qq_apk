  ...
  implements View.OnClickListener
{
  ...
  public View a(int paramInt, View paramView)
  {
    ...
    if ((paramView == null) || (!(paramView.getTag() instanceof PhoneContactAddBuilder.PhoneContactAddHolder)))
    {
      ...
      paramView = a(this.jdField_a_of_type_AndroidContentContext, 2130970650, localPhoneContactAddHolder);
      localPhoneContactAddHolder.jdField_f_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131366543));
      localPhoneContactAddHolder.h = ((TextView)paramView.findViewById(2131362899));
      localPhoneContactAddHolder.i = ((TextView)paramView.findViewById(2131369991));
      localPhoneContactAddHolder.l = ((TextView)paramView.findViewById(2131371530));
      localPhoneContactAddHolder.j = ((TextView)paramView.findViewById(2131369993));
      localPhoneContactAddHolder.k = ((TextView)paramView.findViewById(2131368975));
      localPhoneContactAddHolder.a = ((Button)paramView.findViewById(2131368974));
      ...
      localPhoneContactAddHolder.jdField_f_of_type_AndroidViewView.setBackgroundResource(2130838591);
    ...
    for (;;)
    {
      ...
      localPhoneContactAddHolder.k.setText(this.jdField_a_of_type_AndroidContentContext.getString(2131433062));
  ...
  protected void a()
  {
    ThreadManager.postImmediately(new wpb(this), null, true);
  }
