  ...
  implements View.OnClickListener
{
  ...
  public View a(int paramInt, View paramView)
  {
    ...
    if ((paramView == null) || (!(paramView.getTag() instanceof PhoneContactAddBuilder.PhoneContactAddHolder)))
    {
      ...
      paramView = a(this.jdField_a_of_type_AndroidContentContext, 2130970637, localPhoneContactAddHolder);
      localPhoneContactAddHolder.jdField_f_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131366545));
      localPhoneContactAddHolder.h = ((TextView)paramView.findViewById(2131362894));
      localPhoneContactAddHolder.i = ((TextView)paramView.findViewById(2131369982));
      localPhoneContactAddHolder.l = ((TextView)paramView.findViewById(2131371532));
      localPhoneContactAddHolder.j = ((TextView)paramView.findViewById(2131369984));
      localPhoneContactAddHolder.k = ((TextView)paramView.findViewById(2131368974));
      localPhoneContactAddHolder.a = ((Button)paramView.findViewById(2131368973));
      ...
      localPhoneContactAddHolder.jdField_f_of_type_AndroidViewView.setBackgroundResource(2130838585);
    ...
    for (;;)
    {
      ...
      localPhoneContactAddHolder.k.setText(this.jdField_a_of_type_AndroidContentContext.getString(2131433048));
  ...
  protected void a()
  {
    ThreadManager.postImmediately(new wjr(this), null, true);
  }
