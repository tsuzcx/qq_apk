  ...
  implements View.OnClickListener
{
  ...
  public View a(int paramInt, View paramView)
  {
    ...
    if ((paramView == null) || (!(paramView.getTag() instanceof NewFriendMoreInfoBuilder.NewFriendMoreInfoHolder)))
    {
      ...
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131561413, null);
      localNewFriendMoreInfoHolder.a = ((TextView)paramView.findViewById(2131371867));
      if (ThemeUtil.isDefaultTheme())
      {
        paramView.setBackgroundResource(2130839590);
        paramView.setTag(localNewFriendMoreInfoHolder);
      }
    }
    for (;;)
    {
      NewFriendMoreInfo localNewFriendMoreInfo = ((NewFriendMoreInfoMessage)this.jdField_a_of_type_ComTencentMobileqqActivityContactNewfriendMsgNewFriendMessage).a;
  ...
  public void onClick(View paramView)
  {
    ...
    if ((localObject != null) && ((localObject instanceof NewFriendMoreInfoBuilder.NewFriendMoreInfoHolder))) {
      switch (((NewFriendMoreInfoMessage)this.jdField_a_of_type_ComTencentMobileqqActivityContactNewfriendMsgNewFriendMessage).a.type)
      {
      }
    }
    for (;;)
    {
      ...
      return;
      int i = this.jdField_a_of_type_ComTencentMobileqqActivityContactNewfriendSystemMsgListAdapter.a();
      ...
      ((NewFriendManager)localObject).f();
    }
  }
}
