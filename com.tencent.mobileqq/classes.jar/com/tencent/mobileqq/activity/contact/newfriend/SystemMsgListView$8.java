...
class SystemMsgListView$8
  implements AbsListView.OnScrollListener
{
  SystemMsgListView$8(SystemMsgListView paramSystemMsgListView) {}
  ...
  public void onScrollStateChanged(AbsListView paramAbsListView, int paramInt)
  {
    ...
    for (paramInt = i;; paramInt = paramAbsListView.getTop())
    {
      ...
      {
        paramAbsListView = new ListviewScrollStatus(j, k, paramInt);
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.contact.newfriend.SystemMsgListView.8
