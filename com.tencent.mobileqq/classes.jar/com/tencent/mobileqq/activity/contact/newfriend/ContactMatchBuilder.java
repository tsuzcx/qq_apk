  ...
  implements View.OnClickListener
{
  ...
  public View a(int paramInt, View paramView)
  {
    ...
    if ((paramView == null) || (!(paramView.getTag() instanceof ContactMatchBuilder.ContactMatchHolder)))
    {
      ...
      paramView = a(this.jdField_a_of_type_AndroidContentContext, 2130970650, localContactMatchHolder);
      localContactMatchHolder.jdField_f_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131366543));
      localContactMatchHolder.h = ((TextView)paramView.findViewById(2131362899));
      localContactMatchHolder.i = ((TextView)paramView.findViewById(2131369991));
      localContactMatchHolder.l = ((TextView)paramView.findViewById(2131371530));
      localContactMatchHolder.j = ((TextView)paramView.findViewById(2131369993));
      localContactMatchHolder.k = ((TextView)paramView.findViewById(2131368975));
      localContactMatchHolder.a = ((Button)paramView.findViewById(2131368974));
      ...
      localContactMatchHolder.jdField_f_of_type_AndroidViewView.setBackgroundResource(2130838595);
      ...
      {
      default: 
        localContactMatchHolder.l.setBackgroundResource(2130843152);
        i = 0;
        paramInt = 0;
      }
    }
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          break;
          label573:
          localContactMatchHolder.jdField_f_of_type_AndroidViewView.setBackgroundResource(2130838591);
          break label196;
          label586:
          ...
          break label310;
          paramInt = 2130843149;
          localContactMatchHolder.l.setBackgroundResource(2130843150);
          i = paramInt;
          if (!AppSetting.b) {
            break label826;
          }
          ...
          ColorStateList localColorStateList = this.jdField_a_of_type_AndroidContentContext.getResources().getColorStateList(2131494244);
          if (localColorStateList != null) {
            localContactMatchHolder.a.setTextColor(localColorStateList);
          }
          localContactMatchHolder.a.setBackgroundResource(2130838526);
  ...
  protected void a()
  {
    ThreadManager.getSubThreadHandler().post(new wov(this));
