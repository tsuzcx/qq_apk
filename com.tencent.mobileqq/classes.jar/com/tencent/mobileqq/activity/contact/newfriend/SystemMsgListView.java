  ...
  implements PhoneContactManager.IPhoneContactListener, Observer
{
  ...
  DiscussionObserver jdField_a_of_type_ComTencentMobileqqAppDiscussionObserver = new wpl(this);
  FriendListObserver jdField_a_of_type_ComTencentMobileqqAppFriendListObserver = new wpk(this);
  MessageObserver jdField_a_of_type_ComTencentMobileqqAppMessageObserver = new wpm(this);
  private NewFriendManager jdField_a_of_type_ComTencentMobileqqAppNewFriendManager;
  QQCustomDialog jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog;
  private QQProgressDialog jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog;
  private AbsListView.OnScrollListener jdField_a_of_type_ComTencentWidgetAbsListView$OnScrollListener = new wpn(this);
  ...
  {
    super(paramContext);
    this.jdField_a_of_type_AndroidOsHandler = new wph(this);
  ...
  private void e(int paramInt)
  {
    ...
    if ((localObject1 instanceof NewFriendMoreInfoBuilder))
    {
      ...
      if (((NewFriendMoreInfo)localObject1).type == 1000) {
        localObject1 = getResources().getString(2131433339);
      }
    }
    for (;;)
    {
      ...
      {
        localObject1 = getResources().getString(2131433342);
        continue;
  ...
  {
    super.d(2130970652);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131371532));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131371533));
    this.jdField_a_of_type_ComTencentWidgetSwipListView = ((SwipListView)findViewById(2131369973));
    this.jdField_a_of_type_AndroidViewView = findViewById(2131370869);
  ...
  protected void c()
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      wpi localwpi = new wpi(this);
      this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setNegativeButton("暂不", localwpi);
      this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setPositiveButton("绑定", localwpi);
  ...
  public void h()
  {
    ...
    if ((i == 1) || (i == 5))
    {
      ...
      if (i <= 3)
      {
        ...
        this.jdField_a_of_type_ComTencentWidgetSwipListView.setOverscrollHeader(getResources().getDrawable(2130845951));
  ...
  void j()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.a(this.jdField_a_of_type_AndroidContentContext.getString(2131434469));
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.runOnUiThread(new wpj(this));
  }
}
