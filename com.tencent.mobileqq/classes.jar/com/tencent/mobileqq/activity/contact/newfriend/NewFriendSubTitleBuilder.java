  ...
  extends NewFriendBaseBuilder
{
  ...
  public View a(int paramInt, View paramView)
  {
    ...
    if ((paramView == null) || (!(paramView.getTag() instanceof NewFriendSubTitleBuilder.NewFriendSubTitleHolder)))
    {
      ...
      localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130970459, null);
      paramView.a = ((TextView)localView.findViewById(2131363360));
