...
public class NewFriendVerificationManager
  implements Manager
{
  public static int a;
  private CardObserver jdField_a_of_type_ComTencentMobileqqAppCardObserver = new NewFriendVerificationManager.1(this);
  private FriendListObserver jdField_a_of_type_ComTencentMobileqqAppFriendListObserver = new NewFriendVerificationManager.2(this);
  ...
  public NewFriendVerificationManager(QQAppInterface paramQQAppInterface)
  {
  ...
  public static NewFriendVerificationManager a(QQAppInterface paramQQAppInterface)
  {
    return (NewFriendVerificationManager)paramQQAppInterface.getManager(QQManagerFactory.NEW_FRIEND_VERIFICATION_MANAGER);
  }
  ...
  public NewFriendVerificationHandler a()
  {
    return (NewFriendVerificationHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.NEW_FRIEND_VERIFICATION_HANDLER);
  }
  ...
  public void a()
  {
    ...
    if (jdField_a_of_type_Int > 0) {
      ReportController.b(null, "dc00898", "", "", "0X800A3A3", "0X800A3A3", 0, jdField_a_of_type_Int, 0, "", "", "", "");
    }
    jdField_a_of_type_Int = 0;
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.activity.contact.addfriendverifi.NewFriendVerificationManager
