  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    for (;;)
    {
        ...
        if (paramInt == 1)
        {
          if (((QQProtectRisks.QQProtectRisksResponse)localObject).str_no_risk_text.has())
          {
            ...
            if (!TextUtils.isEmpty(paramArrayOfByte)) {
              LoginInfoActivity.access$3702(this.a, paramArrayOfByte);
            }
          }
          if (((QQProtectRisks.QQProtectRisksResponse)localObject).str_risk_tip_text.has())
          {
            ...
            if (!TextUtils.isEmpty(paramArrayOfByte)) {
              LoginInfoActivity.access$3802(this.a, paramArrayOfByte + "　");
            }
          }
          if ((((QQProtectRisks.QQProtectRisksResponse)localObject).risk_info_list.has()) && (!((QQProtectRisks.QQProtectRisksResponse)localObject).risk_info_list.isEmpty()))
          {
            ...
            if (paramInt < ((QQProtectRisks.QQProtectRisksResponse)localObject).risk_info_list.size())
            {
              ...
              if (!LoginInfoActivity.access$3500(this.a)) {
                LoginInfoActivity.access$3900(this.a).add(paramBundle);
              }
      ...
      catch (InvalidProtocolBufferMicroException paramArrayOfByte)
      {
        ...
        paramInt = 0;
        if ((LoginInfoActivity.access$3900(this.a) != null) && (!LoginInfoActivity.access$3900(this.a).isEmpty()))
        {
          if (TextUtils.isEmpty(LoginInfoActivity.access$3800(this.a)))
          {
            paramArrayOfByte = ((RiskInfoItem)LoginInfoActivity.access$3900(this.a).get(0)).jdField_a_of_type_JavaLangString;
            i = LoginInfoActivity.access$3900(this.a).size();
            paramBundle = this.a.getString(2131717065);
            LoginInfoActivity.access$3802(this.a, String.format(paramBundle, new Object[] { paramArrayOfByte, Integer.valueOf(i) }));
          }
          paramArrayOfByte = LoginInfoActivity.access$3800(this.a);
          bool = false;
          if (paramInt == 0) {
            paramArrayOfByte = this.a.getString(2131717067);
          }
          LoginInfoActivity.access$4202(this.a, bool);
          paramBundle = LoginInfoActivity.access$1700(this.a).obtainMessage(20170211);
          ...
          LoginInfoActivity.access$1700(this.a).sendMessageDelayed(paramBundle, 2000L);
          return;
          if (((QQProtectRisks.QQProtectRisksResponse)localObject).uint32_qpim_switches.has())
          {
            ...
            LoginInfoActivity.access$4000(this.a, paramInt);
          }
          long l = 3600L;
          paramArrayOfByte = "";
          ...
          if (TextUtils.isEmpty(paramArrayOfByte))
          {
            ...
            if (((QQProtectRisks.QQProtectRisksResponse)localObject).risk_info_list.has())
            {
              ...
              if (!((QQProtectRisks.QQProtectRisksResponse)localObject).risk_info_list.isEmpty()) {
                paramBundle = this.a.getString(2131699114);
              }
            }
          }
          LoginInfoActivity.access$4100(this.a, l, paramBundle);
          paramInt = i;
          continue;
        }
      }
      catch (Throwable paramArrayOfByte)
      {
        ...
        paramInt = i;
        continue;
        if (TextUtils.isEmpty(LoginInfoActivity.access$3700(this.a))) {
          LoginInfoActivity.access$3702(this.a, this.a.getString(2131717068));
        }
        paramArrayOfByte = LoginInfoActivity.access$3700(this.a);
        boolean bool = true;
        continue;
      }
      label906:
