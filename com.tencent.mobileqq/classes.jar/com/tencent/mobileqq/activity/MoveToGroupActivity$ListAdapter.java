  ...
  extends BaseAdapter
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.a.getLayoutInflater().inflate(2131559594, null);
      int i = (byte)((Groups)MoveToGroupActivity.a(this.a).get(paramInt)).group_id;
      localObject = (ImageView)localView.findViewById(2131364734);
    ...
    for (;;)
    {
      localObject = (TextView)localView.findViewById(2131368125);
