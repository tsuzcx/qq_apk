  ...
  extends ChatMessage
{
  ...
  protected void doParse()
  {
    ...
    //   3: aconst_null
    //   4: astore_1
    //   5: new 122	java/io/ObjectInputStream
    //   8: dup
    //   9: new 124	java/io/ByteArrayInputStream
    //   12: dup
    //   13: aload_0
    //   14: getfield 128	com/tencent/mobileqq/data/MessageForTroopReward:msgData	[B
    //   17: invokespecial 131	java/io/ByteArrayInputStream:<init>	([B)V
    //   20: invokespecial 134	java/io/ObjectInputStream:<init>	(Ljava/io/InputStream;)V
    //   23: astore_2
    //   24: aload_0
    //   25: aload_2
    //   26: invokespecial 136	com/tencent/mobileqq/data/MessageForTroopReward:readExternal	(Ljava/io/ObjectInput;)V
    //   29: aload_0
    //   30: aload_0
    //   31: invokevirtual 139	com/tencent/mobileqq/data/MessageForTroopReward:getSummaryMsg	()Ljava/lang/String;
    //   34: putfield 142	com/tencent/mobileqq/data/MessageForTroopReward:msg	Ljava/lang/String;
    //   37: aload_2
    //   38: invokevirtual 145	java/io/ObjectInputStream:close	()V
    //   41: return
    //   42: astore_1
    //   43: goto +55 -> 98
    //   46: astore_1
    ...
    //   64: aload_2
    //   65: astore_1
    //   66: invokestatic 151	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   69: ifeq +14 -> 83
    //   72: aload_2
    //   73: astore_1
    //   74: ldc 153
    ...
    //   77: ldc 155
    //   79: aload_3
    //   80: invokestatic 159	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   83: aload_2
    //   84: ifnull +13 -> 97
    //   87: aload_2
    //   88: invokevirtual 145	java/io/ObjectInputStream:close	()V
    //   91: return
    //   92: astore_1
    //   93: aload_1
    //   94: invokevirtual 162	java/lang/Exception:printStackTrace	()V
    //   97: return
    //   98: aload_2
    //   99: ifnull +15 -> 114
    //   102: aload_2
    //   103: invokevirtual 145	java/io/ObjectInputStream:close	()V
    //   106: goto +8 -> 114
    //   109: astore_2
    //   110: aload_2
    ...
    //   0	116	0	this	MessageForTroopReward
  ...
  public void prewrite()
  {
    ...
    //   43: aload_2
    //   44: invokevirtual 196	java/io/ObjectOutputStream:close	()V
    //   47: goto +19 -> 66
    //   50: astore_1
    //   51: invokestatic 151	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   54: ifeq +12 -> 66
    //   57: ldc 202
    //   59: iconst_2
    //   60: ldc 204
    //   62: aload_1
    //   63: invokestatic 159	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   66: aload 4
    //   68: invokevirtual 205	java/io/ByteArrayOutputStream:close	()V
    //   71: return
    //   72: astore_1
    //   73: invokestatic 151	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   76: ifeq +88 -> 164
    //   79: ldc 202
    //   81: iconst_2
    //   82: ldc 204
    //   84: aload_1
    //   85: invokestatic 159	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   88: return
    //   89: astore_3
    //   90: goto +12 -> 102
    //   93: astore_1
    ...
    //   102: aload_2
    //   103: astore_1
    //   104: invokestatic 151	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   107: ifeq +14 -> 121
    //   110: aload_2
    //   111: astore_1
    //   112: ldc 202
    ...
    //   115: ldc 204
    //   117: aload_3
    //   118: invokestatic 159	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   121: aload_2
    //   122: ifnull +26 -> 148
    //   125: aload_2
    //   126: invokevirtual 196	java/io/ObjectOutputStream:close	()V
    //   129: goto +19 -> 148
    //   132: astore_1
    //   133: invokestatic 151	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   136: ifeq +12 -> 148
    //   139: ldc 202
    //   141: iconst_2
    //   142: ldc 204
    //   144: aload_1
    //   145: invokestatic 159	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   148: aload 4
    //   150: invokevirtual 205	java/io/ByteArrayOutputStream:close	()V
    //   153: return
    //   154: astore_1
    ...
    //   171: ifnull +26 -> 197
    //   174: aload_2
    //   175: invokevirtual 196	java/io/ObjectOutputStream:close	()V
    //   178: goto +19 -> 197
    //   181: astore_2
    //   182: invokestatic 151	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   185: ifeq +12 -> 197
    //   188: ldc 202
    //   190: iconst_2
    //   191: ldc 204
    //   193: aload_2
    //   194: invokestatic 159	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   197: aload 4
    //   199: invokevirtual 205	java/io/ByteArrayOutputStream:close	()V
    //   202: goto +19 -> 221
    //   205: astore_2
    //   206: invokestatic 151	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   209: ifeq +12 -> 221
    //   212: ldc 202
    //   214: iconst_2
    //   215: ldc 204
    //   217: aload_2
    //   218: invokestatic 159	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   221: goto +5 -> 226
    //   224: aload_1
    //   225: athrow
    //   226: goto -2 -> 224
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	229	0	this	MessageForTroopReward
