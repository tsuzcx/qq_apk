  ...
  extends Entity
{
  ...
  public CardProfile clone()
  {
    ...
    if (this.lTime > 0) {
      localCardProfile.strTime = bfzl.a(this.lTime * 1000L, true, "yyyy-MM-dd");
    }
  ...
  public void readFrom(UserProfile paramUserProfile)
  {
    ...
    if (this.lTime > 0) {
      this.strTime = bfzl.a(this.lTime * 1000L, true, "yyyy-MM-dd");
    }
  ...
  public void updateTime(long paramLong)
  {
    ...
    this.strTime = bfzl.a(1000L * paramLong, true, "yyyy-MM-dd");
  }
}
