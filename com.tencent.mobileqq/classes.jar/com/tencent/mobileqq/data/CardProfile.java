  ...
  extends atmo
{
  ...
  public CardProfile clone()
  {
    ...
    if (this.lTime > 0) {
      localCardProfile.strTime = baiu.a(this.lTime * 1000L, true, "yyyy-MM-dd");
    }
  ...
  public void readFrom(UserProfile paramUserProfile)
  {
    ...
    if (this.lTime > 0) {
      this.strTime = baiu.a(this.lTime * 1000L, true, "yyyy-MM-dd");
    }
  ...
  public void updateTime(long paramLong)
  {
    ...
    this.strTime = baiu.a(1000L * paramLong, true, "yyyy-MM-dd");
  }
}
