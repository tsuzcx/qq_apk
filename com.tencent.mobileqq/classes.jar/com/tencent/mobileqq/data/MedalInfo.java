  ...
  extends atmo
{
  ...
  public boolean isNewer(MedalInfo paramMedalInfo)
  {
    ...
    long l1 = l2;
    if (azzz.b(l2, this.lObtainTimeLevel2) < 0) {
      l1 = this.lObtainTimeLevel2;
    }
    l2 = l1;
    if (azzz.b(l1, this.lObtainTimeLevel3) < 0) {
      l2 = this.lObtainTimeLevel3;
    }
    long l3 = paramMedalInfo.lObtainTimeLevel1;
    l1 = l3;
    if (azzz.b(l3, paramMedalInfo.lObtainTimeLevel2) < 0) {
      l1 = paramMedalInfo.lObtainTimeLevel2;
    }
    l3 = l1;
    if (azzz.b(l1, paramMedalInfo.lObtainTimeLevel3) < 0) {
