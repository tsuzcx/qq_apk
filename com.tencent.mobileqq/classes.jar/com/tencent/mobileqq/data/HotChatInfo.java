  ...
  implements Serializable, Cloneable
{
  ...
  public static HotChatInfo createHotChat(JSONObject paramJSONObject)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (QLog.isDevelopLevel()) {
        auwz.a("PttShow", "createHotChat_JSONObject", new Object[] { localHotChatInfo });
      }
  ...
  public static HotChatInfo createHotChat(Common.WifiPOIInfo paramWifiPOIInfo, boolean paramBoolean, int paramInt)
  {
    ...
    localHotChatInfo.troopUin = String.valueOf(bdeu.a(paramWifiPOIInfo.uint32_group_code.get()));
    localHotChatInfo.troopCode = String.valueOf(bdeu.a(paramWifiPOIInfo.uint32_group_uin.get()));
    ...
    for (paramBoolean = true;; paramBoolean = false)
    {
      ...
      if (QLog.isDevelopLevel()) {
        auwz.a("PttShow", "createHotChat_WifiPOIInfo", new Object[] { localHotChatInfo });
      }
      return localHotChatInfo;
      paramBoolean = false;
      break;
  ...
  public static RecentUser createRecentUser(HotChatInfo paramHotChatInfo, boolean paramBoolean)
  {
    ...
    for (localRecentUser.uin = alof.X;; localRecentUser.uin = paramHotChatInfo.troopUin)
    {
  ...
  public static Common.WifiPOIInfo createWifiPOIInfo(HotChatInfo paramHotChatInfo)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localWifiPOIInfo.uint32_group_code.set(bdeu.a(Long.parseLong(paramHotChatInfo.troopUin)));
        localWifiPOIInfo.uint32_group_uin.set(bdeu.a(Long.parseLong(paramHotChatInfo.troopCode)));
        ...
        localWifiPOIInfo.uint64_owner_uin.set(aloz.a(paramHotChatInfo.ownerUin));
      ...
      catch (Exception localException)
      {
        ...
        auwz.a("PttShow", "createWifiPOIInfo", new Object[] { localException.toString() });
        continue;
      }
      if (QLog.isDevelopLevel()) {
        auwz.a("PttShow", "createWifiPOIInfo", new Object[] { paramHotChatInfo });
      }
  ...
  {
    if (QLog.isColorLevel()) {
      auwz.a("Q.hotchat", new Object[] { "onExit", Integer.valueOf(paramInt) });
    }
    this.state = paramInt;
  ...
  public void updateHotChatInfo(HotChatInfo paramHotChatInfo)
  {
    ...
    auwz.a("PttShow", new Object[] { "updateHotChatInfo", paramHotChatInfo });
  }
}
