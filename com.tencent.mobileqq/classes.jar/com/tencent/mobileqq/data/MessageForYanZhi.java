  ...
  extends ChatMessage
{
  ...
  {
    // Byte code:
    //   0: new 70	java/io/ObjectInputStream
    //   3: dup
    //   4: new 72	java/io/ByteArrayInputStream
    //   7: dup
    //   8: aload_0
    //   9: getfield 76	com/tencent/mobileqq/data/MessageForYanZhi:msgData	[B
    //   12: invokespecial 79	java/io/ByteArrayInputStream:<init>	([B)V
    //   15: invokespecial 82	java/io/ObjectInputStream:<init>	(Ljava/io/InputStream;)V
    //   18: astore_2
    //   19: aload_2
    //   20: astore_1
    //   21: aload_0
    //   22: aload_2
    //   23: invokespecial 84	com/tencent/mobileqq/data/MessageForYanZhi:readExternal	(Ljava/io/ObjectInput;)V
    //   26: aload_2
    //   27: ifnull +7 -> 34
    //   30: aload_2
    //   31: invokevirtual 87	java/io/ObjectInputStream:close	()V
    //   34: return
    //   35: astore_1
    //   36: aload_1
    //   37: invokevirtual 90	java/lang/Exception:printStackTrace	()V
    //   40: return
    //   41: astore_3
    //   42: aconst_null
    //   43: astore_2
    //   44: aload_2
    //   45: astore_1
    //   46: invokestatic 96	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   49: ifeq +14 -> 63
    //   52: aload_2
    //   53: astore_1
    //   54: ldc 8
    ...
    //   57: ldc 98
    //   59: aload_3
    //   60: invokestatic 102	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   63: aload_2
    //   64: ifnull -30 -> 34
    //   67: aload_2
    //   68: invokevirtual 87	java/io/ObjectInputStream:close	()V
    //   71: return
    //   72: astore_1
    //   73: aload_1
    ...
    //   82: ifnull +7 -> 89
    //   85: aload_1
    //   86: invokevirtual 87	java/io/ObjectInputStream:close	()V
    //   89: aload_2
    //   90: athrow
    //   91: astore_1
    //   92: aload_1
  ...
  public void prewrite()
  {
    ...
    //   44: ifnull +7 -> 51
    //   47: aload_2
    //   48: invokevirtual 121	java/io/ObjectOutputStream:close	()V
    //   51: aload 4
    //   53: invokevirtual 126	java/io/ByteArrayOutputStream:close	()V
    //   56: return
    //   57: astore_1
    ...
    //   67: ldc 128
    //   69: aload_1
    //   70: invokestatic 102	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   73: goto -22 -> 51
    //   76: astore_1
    ...
    //   86: ldc 128
    //   88: aload_1
    //   89: invokestatic 102	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   92: return
    //   93: astore_3
    //   94: aconst_null
    //   95: astore_2
    //   96: aload_2
    //   97: astore_1
    //   98: invokestatic 96	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   101: ifeq +14 -> 115
    //   104: aload_2
    //   105: astore_1
    //   106: ldc 8
    ...
    //   109: ldc 128
    //   111: aload_3
    //   112: invokestatic 102	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   115: aload_2
    //   116: ifnull +7 -> 123
    //   119: aload_2
    //   120: invokevirtual 121	java/io/ObjectOutputStream:close	()V
    //   123: aload 4
    //   125: invokevirtual 126	java/io/ByteArrayOutputStream:close	()V
    //   128: return
    //   129: astore_1
    //   130: invokestatic 96	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   133: ifeq -77 -> 56
    //   136: ldc 8
    //   138: iconst_2
    //   139: ldc 128
    //   141: aload_1
    //   142: invokestatic 102	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   145: return
    //   146: astore_1
    //   147: invokestatic 96	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   150: ifeq -27 -> 123
    //   153: ldc 8
    //   155: iconst_2
    //   156: ldc 128
    //   158: aload_1
    //   159: invokestatic 102	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   162: goto -39 -> 123
    //   165: astore_2
    //   166: aconst_null
    //   167: astore_1
    ...
    //   169: ifnull +7 -> 176
    //   172: aload_1
    //   173: invokevirtual 121	java/io/ObjectOutputStream:close	()V
    //   176: aload 4
    //   178: invokevirtual 126	java/io/ByteArrayOutputStream:close	()V
    //   181: aload_2
    //   182: athrow
    //   183: astore_1
    //   184: invokestatic 96	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   187: ifeq -11 -> 176
    //   190: ldc 8
    //   192: iconst_2
    //   193: ldc 128
    //   195: aload_1
    //   196: invokestatic 102	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   199: goto -23 -> 176
    //   202: astore_1
    //   203: invokestatic 96	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   206: ifeq -25 -> 181
    //   209: ldc 8
    //   211: iconst_2
    //   212: ldc 128
    //   214: aload_1
    //   215: invokestatic 102	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   218: goto -37 -> 181
    //   221: astore_2
    //   222: goto -54 -> 168
    //   225: astore_3
