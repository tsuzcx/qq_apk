  ...
  extends ClickableSpan
{
  ...
  public void a(String paramString)
  {
    ...
    if (localQQAppInterface != null)
    {
      ...
      if (((String)localObject).contains("sign=xxx"))
      {
        ...
        paramString = ((String)localObject).replace("sign=xxx", "sign=" + Utils.a(localQQAppInterface.getMsgCache().m(this.jdField_a_of_type_ComTencentMobileqqDataMessageForNearbyMarketGrayTips.frienduin)));
      }
    ...
    for (;;)
    {
      ...
      {
        paramString = ((String)localObject).replace("sign=xxx", "sign=" + Utils.a(localQQAppInterface.getMsgCache().p(this.jdField_a_of_type_ComTencentMobileqqDataMessageForNearbyMarketGrayTips.frienduin)));
        break;
      }
      paramString = (String)localObject;
      ...
      paramString = ((String)localObject).replace("sign=xxx", "sign=" + Utils.a(localQQAppInterface.getMsgCache().j(this.jdField_a_of_type_ComTencentMobileqqDataMessageForNearbyMarketGrayTips.frienduin)));
      break;
      label472:
      localObject = paramString;
      if (1010 == this.jdField_a_of_type_ComTencentMobileqqDataMessageForNearbyMarketGrayTips.istroop) {
  ...
  public void c(String paramString)
  {
    ...
    return;
    ((NearbyRelevantHandler)localQQAppInterface.getBusinessHandler(BusinessHandlerFactory.NEARBY_RELEVANT_HANDLER)).a("tag_nearby_chat", paramString, null);
