  ...
  extends MessageForStructing
{
  ...
  public void doParse()
  {
    ...
    {
      localObject1 = (bdnu)((List)localObject1).get(0);
      if ((localObject1 instanceof bdqn))
      {
        Object localObject2 = (bdqn)localObject1;
        localObject1 = ((bdqn)localObject2).a;
        try
        {
          if (QLog.isColorLevel()) {
            QLog.d("MessageForTroopSign", 2, "doParse, mCommonData=" + ((bdqn)localObject2).i);
          }
          if (!TextUtils.isEmpty(((bdqn)localObject2).i))
          {
            localObject2 = new JSONObject(((bdqn)localObject2).i);
        ...
        catch (Exception localException)
        {
          for (;;)
          {
            ...
            if (QLog.isColorLevel())
            {
              ...
              {
                if ((localException instanceof bdsv)) {
                  this.msgContent = ((bdsv)localException).b();
                }
              }
        ...
        for (;;)
        {
          ...
          if ((localObject2 instanceof bdpx)) {
            this.msgCoverUrl = ((bdpx)localObject2).ac;
          }
        }
      }
    }
  ...
  public String getSummaryMsg()
  {
    if (TextUtils.isEmpty(this.msgBrief)) {
      this.msgBrief = anvx.a(2131706075);
    }
