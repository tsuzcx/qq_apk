  ...
  implements Comparable<DateEventMsg>
{
  ...
  public static DateEventMsg convertFrom(appoint_define.DateEvent paramDateEvent)
  {
    ...
    {
      localDateEventMsg.user_info = aqui.a((appoint_define.StrangerInfo)paramDateEvent.msg_user_info.get());
      label96:
    ...
    if (paramDateEvent.msg_comment.has()) {
      localDateEventMsg.date_comment = aque.a((appoint_define.DateComment)paramDateEvent.msg_comment.get());
    }
    for (;;)
    {
      aquj.a("DateEventMsg.convertFrom", new Object[] { localDateEventMsg.date_comment });
      break;
      aquj.b("DateEventMsg.convertFrom", new Object[] { "msg_comment no value" });
    }
    ...
    for (;;)
    {
      aquj.a("DateEventMsg.convertFrom", new Object[] { paramDateEvent.str_event_tips.get(), localDateEventMsg.str_event_tips });
      break;
      localDateEventMsg.str_event_tips = amtj.a(2131701917);
      continue;
      localDateEventMsg.str_event_tips = amtj.a(2131701918);
      continue;
      localDateEventMsg.str_event_tips = amtj.a(2131701919);
    }
  }
  ...
  public void init()
  {
    ...
    do
    {
      ...
      try
      {
        ...
        for (this.user_info = null; (this.msg_date_info == null) || (this.msg_date_info.length == 0); this.user_info = aqui.a(new JSONObject(this.msg_user_info)))
        {
          this.date_info = null;
      ...
      catch (Exception localException2)
      {
        ...
        this.date_comment = aque.a(new JSONObject(this.msg_content));
        aquj.a("DateEventMsg.init", new Object[] { Integer.valueOf(this.type), this.date_comment, this.msg_content });
        return;
      }
  ...
  {
    Object localObject = aqui.a(this.user_info);
    if (localObject == null)
    {
      localObject = "";
      ...
      localObject = aque.a(this.date_comment);
      if (localObject != null) {
        break label91;
      }
      localObject = "";
