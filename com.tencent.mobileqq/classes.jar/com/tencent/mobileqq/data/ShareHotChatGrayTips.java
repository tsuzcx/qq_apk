  ...
  extends ChatMessage
{
  ...
  public static final String SHARE_GRAY_TIP_CONTENT = anvx.a(2131713396);
  ...
  public SpannableString getHighlightMsgText(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    for (int i = this.mMsgContent.indexOf(this.mMsgContentHighlight);; i = -1)
    {
      ...
      if ((i >= 0) && (j > i)) {
        localSpannableString.setSpan(new arvk(paramQQAppInterface, paramContext, this, this.mHotnamecode), i, j, 33);
      }
