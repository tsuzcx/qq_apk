  ...
  extends ChatMessage
{
  ...
  public static final String SHARE_GRAY_TIP_CONTENT = amtj.a(2131713049);
  ...
  public SpannableString getHighlightMsgText(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    for (int i = this.mMsgContent.indexOf(this.mMsgContentHighlight);; i = -1)
    {
      ...
      if ((i >= 0) && (j > i)) {
        localSpannableString.setSpan(new aqry(paramQQAppInterface, paramContext, this, this.mHotnamecode), i, j, 33);
      }
