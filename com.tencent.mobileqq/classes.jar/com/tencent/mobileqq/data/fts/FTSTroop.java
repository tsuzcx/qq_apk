  ...
  extends FTSEntity
{
  ...
  {
    return String.format("FTSTroop type=%d, troopuin|memberuin=%s, troopnick|size=%s, nick|size=%s", new Object[] { Integer.valueOf(this.mType), this.mExt1 + "zzz" + this.mExt6, bbbr.a(this.mExt4), bbbr.a(this.mExt2) });
  }
  ...
  public void doSerialize()
  {
    ...
    for (;;)
    {
      ...
      break label38;
      label130:
      this.mExt3 = bbmo.a(this.mExt2);
      this.mSegmentCount += bbmo.a(this.mExt3);
      break label67;
      label160:
      this.mExt5 = bbmo.a(this.mExt4);
      this.mSegmentCount += bbmo.a(this.mExt5);
    }
  }
