  ...
  implements acxl
{
  ...
  public void doParse()
  {
    ...
    //   889: invokestatic 428	bbbg:a	(Ljava/lang/String;)LActionMsg/MsgBody;
    ...
    //   1144: invokestatic 467	bbbd:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   1205: invokestatic 467	bbbd:a	(Ljava/lang/String;)Ljava/lang/String;
  ...
  public im_msg_body.RichText getRichText()
  {
    ...
    try
    {
      this.md5 = bfjx.a(new File(getLocalFilePath()));
      serial();
      if ((this.istroop == 1) || (this.istroop == 3000))
      {
        ...
        localPtt.bytes_file_md5.set(ByteStringMicro.copyFrom(bbdm.a(this.md5)));
        ...
        if (this.urlAtServer != null)
        {
          ...
          Object localObject1 = ayrd.a(this);
          ...
          {
            localResvAttr.bytes_pb_ptt_waveform.set(ByteStringMicro.copyFrom(bbfm.a(this.waveformArray).toByteArray()));
  ...
  public String getSummaryMsg()
  {
    ...
    return ajyc.a(2131706602);
  }
  
  public boolean hasSttTxt()
  {
    return (!bbjw.a(this.sttText)) && (!BaseApplicationImpl.sApplication.getResources().getString(2131719804).equals(this.sttText)) && (this.sttAbility != 3);
  }
  ...
  public void serial()
  {
    ...
    for (;;)
    {
      ...
      if (this.urlAtServer != null)
      {
        ...
        ((RichMsg.PttRec)localObject2).voiceLength.set(bbbd.a(this.voiceLength));
