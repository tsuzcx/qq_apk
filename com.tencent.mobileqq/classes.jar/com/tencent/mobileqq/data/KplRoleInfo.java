  ...
  extends atmo
{
  ...
  {
    boolean bool;
    if (aeiv.a(paramBaseChatPie.jdField_a_of_type_AndroidContentContext, paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, false, false) != null) {
      bool = true;
    }
    for (;;)
    {
      ...
      if (paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1022)
      {
        ...
        ajjj localajjj = (ajjj)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
        if ((localList != null) && (localList.size() > 0) && (!localajjj.b(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) && (!TextUtils.isEmpty(((ChatMessage)localList.get(localList.size() - 1)).getExtInfoFromExtStr("msg_ext_key"))))
        {
          bool = true;
          continue;
        }
  ...
  {
    boolean bool;
    if (aeiv.a(paramContext, paramInt, false, false) != null) {
      bool = true;
    }
    for (;;)
    {
