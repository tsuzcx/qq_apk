  ...
  implements anie
{
  ...
  protected void doParse()
  {
      ...
      for (;;)
      {
        if (((Iterator)localObject5).hasNext())
        {
          ...
          for (;;)
          {
            ...
            m = k;
            bool3 = bool1;
            bool2 = bcwm.a().a((String)localObject1);
            if (bool2) {
              break label983;
            }
            bool1 = true;
          ...
          try
          {
            this.mSourceMsgInfo = ((MessageForReplyText.SourceMsgInfo)akwb.a(HexUtil.hexStr2Bytes(str)));
            k = n;
            bool1 = bool2;
          }
    ...
    for (;;)
    {
      ...
      this.sb = new ayki(this.msg, 13, ChatTextSizeSettingActivity.a(), this.istroop);
      if (m != 0) {
        this.sb2 = new ayki(localStringBuilder2.toString(), 13, ChatTextSizeSettingActivity.a(), this.istroop);
      }
      return;
      label983:
      label986:
  ...
  public MessageRecord rebuildLongMsg(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (this.msgtype == -1036)
      {
        ...
        for (;;)
        {
            ...
            while (((Iterator)localObject8).hasNext())
            {
              ...
              else if ((localObject9 instanceof MessageForPic))
              {
                if (!((List)localObject6).isEmpty())
                {
                  ...
                  localObject10 = (MessageForText)axaq.a(-1000);
          ...
          else if ((localObject8 instanceof MessageForPic))
          {
            if (!((List)localObject6).isEmpty())
            {
              ...
              localObject9 = (MessageForText)axaq.a(-1000);
        ...
        ??? = (MessageForMixedMsg)axaq.a(-1035);
