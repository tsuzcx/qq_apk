  ...
  extends ChatMessage
{
  ...
  {
    Object localObject = afuo.a(paramMessageRecord);
    if ((localObject == null) || (((PAMessage)localObject).items == null) || (((PAMessage)localObject).items.size() == 0))
    {
      ...
      return paramQQAppInterface.getApp().getString(2131694485);
    }
    ...
    if (paramBoolean) {}
    for (paramMessageRecord = String.format(paramQQAppInterface.getApp().getString(2131697424), new Object[] { usu.a(paramQQAppInterface, BaseApplicationImpl.getContext()) });; paramMessageRecord = "")
    {
  ...
  protected void doParse()
  {
    try
    {
      this.mPAMessage = usd.a(this.msgData);
  ...
  public void prewrite()
  {
    ...
    try
    {
      this.msgData = usd.a(this.mPAMessage);
      return;
    }
    catch (Exception localException)
    {
