  ...
  extends auko
{
  ...
  public String toString()
  {
    ...
    localStringBuilder.append("subuin:").append(this.subuin).append(",subname:").append(this.subname).append(",trunk:").append(this.trunkuin).append(",isbind:").append(this.isbind).append(",unreadMsgNum:").append(this.unreadMsgNum).append(",unreadSenderNum:").append(this.unreadSenderNum).append(",unNotificationSender:").append(this.unNotifySender).append(",lasttime:").append(this.lasttime).append(",serverErrorType:").append(this.serverErrorType).append(",serverErrorMsg:").append(this.serverErrorMsg).append(",lastCleanQZoneMessageTime:").append(this.lastCleanQZoneMessageTime);
