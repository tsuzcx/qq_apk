  ...
  extends ChatMessage
{
  ...
  private String parseLine(JSONObject paramJSONObject)
  {
    ...
    default: 
      return "";
    case 20002: 
      return line(2131695077, paramJSONObject.optString("key_profile_nickname", ""));
    case 20031: 
      i = paramJSONObject.optInt("key_profile_birthday", 0);
      return line(2131695019, String.format(Locale.getDefault(), "%d-%d-%d", new Object[] { Integer.valueOf((0xFFFF0000 & i) >>> 16), Integer.valueOf((0xFF00 & i) >>> 8), Integer.valueOf(i & 0xFF) }));
    case 27264: 
      return line(2131695021, paramJSONObject.optString("key_profile_education", ""));
    case 20032: 
      return line(2131695073, paramJSONObject.optString("key_profile_location_desc", ""));
    case 24002: 
      return line(2131695067, paramJSONObject.optString("key_profile_location_desc", ""));
    case 24008: 
      return line(2131695030, paramJSONObject.optString("key_profile_company", ""));
    case 27037: 
      ...
      for (paramJSONObject = str;; paramJSONObject = NearbyProfileUtil.e[i]) {
        return line(2131695124, paramJSONObject);
      }
    case 20011: 
      label267:
      return line(2131695060, paramJSONObject.optString("key_profile_email", ""));
    }
    return line(2131695091, paramJSONObject.optString("key_profile_introduction", ""));
  }
