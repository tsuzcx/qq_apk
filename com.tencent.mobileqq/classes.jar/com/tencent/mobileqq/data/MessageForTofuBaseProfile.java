  ...
  extends ChatMessage
{
  ...
  private String parseLine(JSONObject paramJSONObject)
  {
    ...
    default: 
      return "";
    case 20002: 
      return line(2131694481, paramJSONObject.optString("key_profile_nickname", ""));
    case 20031: 
      i = paramJSONObject.optInt("key_profile_birthday", 0);
      return line(2131694424, String.format(Locale.getDefault(), "%d-%d-%d", new Object[] { Integer.valueOf((0xFFFF0000 & i) >>> 16), Integer.valueOf((0xFF00 & i) >>> 8), Integer.valueOf(i & 0xFF) }));
    case 27264: 
      return line(2131694426, paramJSONObject.optString("key_profile_education", ""));
    case 20032: 
      return line(2131694477, paramJSONObject.optString("key_profile_location_desc", ""));
    case 24002: 
      return line(2131694471, paramJSONObject.optString("key_profile_location_desc", ""));
    case 24008: 
      return line(2131694435, paramJSONObject.optString("key_profile_company", ""));
    case 27037: 
      i = paramJSONObject.optInt("key_profile_occupation", -1);
      String str = "";
      paramJSONObject = str;
      if (i < bght.e.length - 1) {
        if (i > 0) {
          break label267;
        }
      }
      for (paramJSONObject = str;; paramJSONObject = bght.e[i]) {
        return line(2131694525, paramJSONObject);
      }
    case 20011: 
      label267:
      return line(2131694465, paramJSONObject.optString("key_profile_email", ""));
    }
    return line(2131694495, paramJSONObject.optString("key_profile_introduction", ""));
  }
