  ...
  extends ChatMessage
{
  ...
  public long nAppearTime = bbko.a();
  ...
  protected void doParse()
  {
    try
    {
      MessageForDeviceSingleStruct.SingleStructMsgSerial localSingleStructMsgSerial = (MessageForDeviceSingleStruct.SingleStructMsgSerial)anwz.a(this.msgData);
  ...
  public boolean parseFromJson(String paramString)
  {
    ...
    //   24: ldc 164
    //   26: ldc 165
    //   28: invokestatic 170	amtj:a	(I)Ljava/lang/String;
  ...
  public void serial()
  {
    ...
    try
    {
      this.msgData = anwz.a(localSingleStructMsgSerial);
      return;
    }
    catch (Exception localException)
    {
