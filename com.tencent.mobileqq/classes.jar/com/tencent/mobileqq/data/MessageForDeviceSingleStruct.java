  ...
  extends ChatMessage
{
  ...
  public long nAppearTime = bcrg.a();
  ...
  protected void doParse()
  {
    try
    {
      MessageForDeviceSingleStruct.SingleStructMsgSerial localSingleStructMsgSerial = (MessageForDeviceSingleStruct.SingleStructMsgSerial)apab.a(this.msgData);
  ...
  public boolean parseFromJson(String paramString)
  {
    ...
    //   24: ldc 164
    //   26: ldc 165
    //   28: invokestatic 170	anvx:a	(I)Ljava/lang/String;
  ...
  public void serial()
  {
    ...
    try
    {
      this.msgData = apab.a(localSingleStructMsgSerial);
      return;
    }
    catch (Exception localException)
    {
