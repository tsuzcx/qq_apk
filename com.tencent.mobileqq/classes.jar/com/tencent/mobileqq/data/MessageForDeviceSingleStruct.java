  ...
  extends ChatMessage
{
  ...
  public long nAppearTime = ayvc.a();
  ...
  protected void doParse()
  {
    try
    {
      MessageForDeviceSingleStruct.SingleStructMsgSerial localSingleStructMsgSerial = (MessageForDeviceSingleStruct.SingleStructMsgSerial)ammq.a(this.msgData);
  ...
  public boolean parseFromJson(String paramString)
  {
    ...
    //   24: ldc 164
    //   26: ldc 165
    //   28: invokestatic 170	alpo:a	(I)Ljava/lang/String;
  ...
  public void serial()
  {
    ...
    try
    {
      this.msgData = ammq.a(localSingleStructMsgSerial);
      return;
    }
    catch (Exception localException)
    {
