  ...
  extends ChatMessage
{
  ...
  public long nAppearTime = awzy.a();
  ...
  protected void doParse()
  {
    try
    {
      MessageForDeviceSingleStruct.SingleStructMsgSerial localSingleStructMsgSerial = (MessageForDeviceSingleStruct.SingleStructMsgSerial)akwa.a(this.msgData);
  ...
  public boolean parseFromJson(String paramString)
  {
    ...
    //   24: ldc 164
    //   26: ldc 165
    //   28: invokestatic 170	ajya:a	(I)Ljava/lang/String;
  ...
  public void serial()
  {
    ...
    try
    {
      this.msgData = akwa.a(localSingleStructMsgSerial);
      return;
    }
    catch (Exception localException)
    {
