  ...
  extends ChatMessage
{
  ...
  protected void doParse()
  {
    try
    {
      MessageForDeviceSingleStruct.SingleStructMsgSerial localSingleStructMsgSerial = (MessageForDeviceSingleStruct.SingleStructMsgSerial)apdm.a(this.msgData);
  ...
  public boolean parseFromJson(String paramString)
  {
    ...
    //   24: ldc 164
    //   26: ldc 165
    //   28: invokestatic 170	anzj:a	(I)Ljava/lang/String;
  ...
  public void serial()
  {
    ...
    try
    {
      this.msgData = apdm.a(localSingleStructMsgSerial);
      return;
    }
    catch (Exception localException)
    {
