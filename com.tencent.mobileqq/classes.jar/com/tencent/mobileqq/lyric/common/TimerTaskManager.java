...
{
  private Map<String, atsa> jdField_a_of_type_JavaUtilMap = new HashMap();
  ...
  private void a()
  {
    if (this.jdField_a_of_type_JavaUtilConcurrentScheduledThreadPoolExecutor == null) {
      this.jdField_a_of_type_JavaUtilConcurrentScheduledThreadPoolExecutor = new atrz(this, 1);
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    //   38: pop
    //   39: aload_3
    //   40: invokestatic 55	atsa:a	(Latsa;)Ljava/util/concurrent/ScheduledFuture;
    //   43: ifnull +14 -> 57
    //   46: aload_3
    //   47: invokestatic 55	atsa:a	(Latsa;)Ljava/util/concurrent/ScheduledFuture;
    //   50: iconst_1
    ...
    //   61: aload_3
    //   62: invokestatic 64	atsa:a	(Latsa;)Ljava/lang/Runnable;
    ...
    //   115: pop
    //   116: aload_3
    //   117: invokestatic 98	atsa:a	(Latsa;)Lcom/tencent/mobileqq/lyric/common/TimerTaskManager$TimerTaskRunnable;
    //   120: iconst_0
    ...
    //   125: aload_3
    //   126: aconst_null
    //   127: invokestatic 106	atsa:a	(Latsa;Lcom/tencent/mobileqq/lyric/common/TimerTaskManager$TimerTaskRunnable;)Lcom/tencent/mobileqq/lyric/common/TimerTaskManager$TimerTaskRunnable;
    //   130: pop
    //   131: aload_0
  ...
  public void a(String paramString, long paramLong1, long paramLong2, TimerTaskManager.TimerTaskRunnable paramTimerTaskRunnable)
  {
    try
    {
      ...
      if (paramString == null) {
        throw new IllegalArgumentException(alpo.a(2131715358));
      }
    }
    finally {}
    if ((paramLong1 < 0L) || (paramLong2 <= 0L)) {
      throw new IllegalArgumentException(alpo.a(2131715356));
    }
    if (paramTimerTaskRunnable == null) {
      throw new IllegalArgumentException(alpo.a(2131715357));
    }
    a();
    ...
    paramTimerTaskRunnable = atsa.a(paramTimerTaskRunnable);
    atsa.a(paramTimerTaskRunnable, paramLong2);
    atsa.a(paramTimerTaskRunnable, paramString);
    atsa.a(paramTimerTaskRunnable, this.jdField_a_of_type_JavaUtilConcurrentScheduledThreadPoolExecutor.scheduleWithFixedDelay(atsa.a(paramTimerTaskRunnable), paramLong1, paramLong2, TimeUnit.MILLISECONDS));
