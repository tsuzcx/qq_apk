...
{
  private Map<String, arew> jdField_a_of_type_JavaUtilMap = new HashMap();
  ...
  private void a()
  {
    if (this.jdField_a_of_type_JavaUtilConcurrentScheduledThreadPoolExecutor == null) {
      this.jdField_a_of_type_JavaUtilConcurrentScheduledThreadPoolExecutor = new arev(this, 1);
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    //   38: pop
    //   39: aload_3
    //   40: invokestatic 55	arew:a	(Larew;)Ljava/util/concurrent/ScheduledFuture;
    //   43: ifnull +14 -> 57
    //   46: aload_3
    //   47: invokestatic 55	arew:a	(Larew;)Ljava/util/concurrent/ScheduledFuture;
    //   50: iconst_1
    ...
    //   61: aload_3
    //   62: invokestatic 64	arew:a	(Larew;)Ljava/lang/Runnable;
    ...
    //   115: pop
    //   116: aload_3
    //   117: invokestatic 98	arew:a	(Larew;)Lcom/tencent/mobileqq/lyric/common/TimerTaskManager$TimerTaskRunnable;
    //   120: iconst_0
    ...
    //   125: aload_3
    //   126: aconst_null
    //   127: invokestatic 106	arew:a	(Larew;Lcom/tencent/mobileqq/lyric/common/TimerTaskManager$TimerTaskRunnable;)Lcom/tencent/mobileqq/lyric/common/TimerTaskManager$TimerTaskRunnable;
    //   130: pop
    //   131: aload_0
  ...
  public void a(String paramString, long paramLong1, long paramLong2, TimerTaskManager.TimerTaskRunnable paramTimerTaskRunnable)
  {
    try
    {
      ...
      if (paramString == null) {
        throw new IllegalArgumentException(ajjy.a(2131649186));
      }
    }
    finally {}
    if ((paramLong1 < 0L) || (paramLong2 <= 0L)) {
      throw new IllegalArgumentException(ajjy.a(2131649184));
    }
    if (paramTimerTaskRunnable == null) {
      throw new IllegalArgumentException(ajjy.a(2131649185));
    }
    a();
    ...
    paramTimerTaskRunnable = arew.a(paramTimerTaskRunnable);
    arew.a(paramTimerTaskRunnable, paramLong2);
    arew.a(paramTimerTaskRunnable, paramString);
    arew.a(paramTimerTaskRunnable, this.jdField_a_of_type_JavaUtilConcurrentScheduledThreadPoolExecutor.scheduleWithFixedDelay(arew.a(paramTimerTaskRunnable), paramLong1, paramLong2, TimeUnit.MILLISECONDS));
