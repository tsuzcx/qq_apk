  ...
  extends View
{
  ...
  public LyricViewInternal(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new aelm(this, Looper.getMainLooper());
    ...
    for (this.m = paramAttributeSet.getDefaultDisplay().getWidth();; this.m = ((Point)localObject).x)
    {
      ...
      this.jdField_a_of_type_JavaLangString = paramContext.getString(2131438329);
      this.jdField_b_of_type_JavaLangString = paramContext.getString(2131438330);
  ...
  public void a(Lyric paramLyric1, Lyric paramLyric2)
  {
    for (;;)
    {
      try
  ...
  public void setSegment(int paramInt1, int paramInt2)
  {
    ...
    this.n = paramInt1;
    this.o = paramInt2;
    this.p = this.jdField_a_of_type_ComTencentMobileqqLyricDataLyric.b(paramInt1);
    this.q = this.jdField_a_of_type_ComTencentMobileqqLyricDataLyric.c(paramInt2);
