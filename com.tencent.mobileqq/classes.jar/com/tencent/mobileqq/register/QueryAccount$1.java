...
public class QueryAccount$1
  implements Runnable
{
  public QueryAccount$1(avpy paramavpy, String paramString) {}
  ...
  public void run()
  {
    ...
    ((Intent)localObject2).putExtra("selfSet_leftViewText", ajya.a(2131711232));
    ...
    axqy.b(this.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800665B", "0X800665B", 0, 0, "", "", "", "");
  }
}
