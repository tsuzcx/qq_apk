...
public class ReplyMsgSender
{
  ...
  public void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, Intent paramIntent)
  {
    ...
    {
      return;
      localChatMessage = ((ForwardMsgManager)paramQQAppInterface.getManager(QQManagerFactory.FORWARD_MSG_MANAGER)).a(l);
  ...
  public void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, String paramString1, ArrayList<AtTroopMemberInfo> paramArrayList1, ChatActivityFacade.SendMsgParams paramSendMsgParams, MessageRecord paramMessageRecord, String paramString2, ArrayList<AtTroopMemberInfo> paramArrayList2)
  {
    ...
    int j = 2;
    int i = j;
    if (paramSendMsgParams.a != null)
    {
      i = j;
      if (!TextUtils.isEmpty(paramSendMsgParams.a.mSourceMsgTroopName)) {
        i = 0;
      }
    }
