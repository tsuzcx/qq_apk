  ...
  extends MessageMicro<RootSearcherRequest>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 48, 58 }, new String[] { "ver", "business", "start_index", "page_size", "busi_mask", "req_ctrl_type", "plugin_state" }, new Object[] { localInteger, localInteger, localInteger, Integer.valueOf(3), Long.valueOf(-1L), localInteger, null }, RootSearcherRequest.class);
  }
}
