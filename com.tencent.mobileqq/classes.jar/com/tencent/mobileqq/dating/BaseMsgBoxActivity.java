...
public class BaseMsgBoxActivity
  ...
  implements ahab, ahdb, amwd, Handler.Callback, begh, benm, Observer
{
  public int a;
  public long a;
  public ahai a;
  ajjh jdField_a_of_type_Ajjh = new amvp(this);
  private Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new amvr(this);
  public View a;
  public ViewStub a;
  ...
  public void a(View paramView, RecentBaseData paramRecentBaseData, String paramString, boolean paramBoolean)
  {
    ...
    if (akbm.c(paramView))
    {
      ...
      {
        awqx.b(this.app, "dc00899", "grp_lbs", "", "c2c_tmp", "clk_say_hi", 0, 0, "", "", paramView, "");
        return;
      }
    }
    paramString = (ajjj)this.app.getManager(51);
    if (paramString != null) {}
    for (paramBoolean = paramString.b(paramView);; paramBoolean = false)
    {
      ...
      if (paramBoolean)
      {
        ...
        paramString = babh.q(this.app, paramRecentBaseData.a());
        paramView = paramString;
        if (TextUtils.isEmpty(paramString)) {
          paramView = babh.b(this.app, paramRecentBaseData.a(), false);
        }
        ...
        if (paramString.commonId > 0) {
          awqx.b(this.app, "CliOper", "", "", "0X8005DEF", "0X8005DEF", paramString.commonId, 0, "", "", "", "");
        }
      ...
      {
        awqx.b(paramString, "dc00899", "grp_lbs", "", "c2c_tmp", "clk_aio", 0, 0, paramRecentBaseData, "1", paramView, "");
        return;
      ...
      for (paramRecentBaseData = "0";; paramRecentBaseData = "1")
      {
        awqx.b(paramString, "dc00899", "grp_lbs", "", "c2c_tmp", "clk_aio", 0, 0, paramRecentBaseData, "0", paramView, "");
        return;
      }
    }
  }
  ...
  public void a(RecentBaseData paramRecentBaseData, String paramString)
  {
    if (paramRecentBaseData != null)
    {
      ...
      if (i > 0)
      {
        if (!akbm.c(paramRecentBaseData.a())) {
          break label175;
        }
    ...
    for (;;)
    {
      if ((ajed.aj.equals(paramRecentBaseData.a())) || (ajed.ai.equals(paramRecentBaseData.a())))
      {
        awqx.b(this.app, "CliOper", "", "", "0X8005297", "0X8005297", 0, 0, "", "", "", "");
        awqx.b(this.app, "dc00899", "grp_lbs", "", "msg_box", "drag_msg", 0, 0, "", "", "", "");
      }
      return;
      label175:
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    {
      this.jdField_a_of_type_JavaLangString = ajed.H;
      this.jdField_a_of_type_Int = 1001;
    }
    this.jdField_a_of_type_AndroidViewViewStub = ((ViewStub)findViewById(2131307355));
    this.jdField_a_of_type_AndroidViewViewStub.setVisibility(0);
    this.jdField_a_of_type_ComTencentMobileqqFpsreportFPSSwipListView = ((FPSSwipListView)findViewById(2131299357));
    this.jdField_b_of_type_AndroidViewView = findViewById(2131299358);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131299359));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131299360));
    this.jdField_c_of_type_AndroidViewView = findViewById(2131300072);
    this.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragFrameLayout = DragFrameLayout.a(this);
    this.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragFrameLayout.a(this, false);
    this.jdField_a_of_type_AndroidViewView = getLayoutInflater().inflate(2131493262, null);
    ...
    if (akbm.c(this.jdField_a_of_type_JavaLangString))
    {
      this.jdField_a_of_type_Ahai = new ahai(this, this.app, this.jdField_a_of_type_ComTencentMobileqqFpsreportFPSSwipListView, this, 7);
      ...
      this.jdField_b_of_type_MqqOsMqqHandler = new babk(getMainLooper(), this.jdField_a_of_type_AndroidOsHandler$Callback);
      ...
      if (this.jdField_d_of_type_Boolean)
      {
        ...
        if ((this.jdField_a_of_type_JavaUtilArrayList.size() > 0) && (this.jdField_b_of_type_Int >= 0) && (this.jdField_b_of_type_Int < this.jdField_a_of_type_JavaUtilArrayList.size()))
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqWidgetTabBarView.setOnTabChangeListener(new amvq(this));
          findViewById(2131310986).setVisibility(0);
    ...
    for (;;)
    {
      ...
      return true;
      this.jdField_a_of_type_Ahai = new ahai(this, this.app, this.jdField_a_of_type_ComTencentMobileqqFpsreportFPSSwipListView, this, 6);
      break;
      label722:
  ...
  public void doOnPause()
  {
    ...
    if ((this.app != null) && (this.jdField_a_of_type_Ahai != null) && ((ajed.aa.equals(this.jdField_a_of_type_JavaLangString)) || (ajed.H.equals(this.jdField_a_of_type_JavaLangString))))
    {
  ...
  public void update(Observable paramObservable, Object paramObject)
  {
    ...
    boolean bool;
    if (((akbm.a(paramObservable.istroop) == 1010) && (this.jdField_a_of_type_Int == 1010)) || ((akbm.a(paramObservable.istroop) == 1001) && (this.jdField_a_of_type_Int == 1001))) {
      bool = true;
    }
    for (;;)
    {
