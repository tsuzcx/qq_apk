  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    try
    {
      ...
      if (i == 0)
      {
        ...
        if ((arrayOfClickableSpan[0] instanceof aper)) {
          ((aper)arrayOfClickableSpan[0]).a(true);
        } else {
    ...
    if ((i == 1) || (i == 3))
    {
      ...
      {
        if ((arrayOfClickableSpan[0] instanceof aper)) {
          ((aper)arrayOfClickableSpan[0]).a(false);
        }
        for (;;)
        {
        ...
        if ((this.jdField_a_of_type_AndroidTextStyleClickableSpan != null) && ((this.jdField_a_of_type_AndroidTextStyleClickableSpan instanceof aper)))
        {
          ((aper)this.jdField_a_of_type_AndroidTextStyleClickableSpan).a(false);
          this.jdField_a_of_type_AndroidTextStyleClickableSpan = null;
        }
        for (;;)
        {
