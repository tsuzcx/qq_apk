  ...
  implements Handler.Callback
{
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqAppFriendListObserver = new abqv(this);
  ...
  public String a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaUtilSet)
      {
        ...
        ThreadManager.post(new abqu(this, paramString, paramInt, paramBoolean, str2), 8, null, false);
        return str1;
      }
    }
  }
