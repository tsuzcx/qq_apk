  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      if ((!this.a.a()) && (this.a.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragFrameLayout.a() == -1) && (paramMessage.obj != null))
      {
        ...
        NearbySPUtil.a(this.a.app.getCurrentAccountUin(), "nearby_msg_tab_last_num", Integer.valueOf(j));
        Object localObject;
    ...
    } while ((this.a.jdField_a_of_type_ComTencentMobileqqTianshuUiRedTouch == null) || (!this.a.e));
    label298:
    NearbyActivity.a(this.a.jdField_a_of_type_ComTencentMobileqqTianshuUiRedTouch, this.a.jdField_c_of_type_Int);
    label403:
    label418:
    return false;
  }
