  ...
  extends BaseMsgBoxActivity
{
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyRelevantObserver = new abqs(this);
  }
  ...
  protected List a(List paramList)
  {
    ...
    if (!localArrayList2.isEmpty()) {
      ThreadManager.getFileThreadHandler().post(new abqt(this, localArrayList2));
    }
    if (QLog.isDevelopLevel())
    {
      l2 = System.currentTimeMillis();
