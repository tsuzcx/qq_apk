...
public class BaseMsgBoxActivity$1$2
  implements Runnable
{
  public BaseMsgBoxActivity$1$2(arxn paramarxn, boolean paramBoolean, String paramString1, String paramString2) {}
  
  public void run()
  {
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Arxn.a.jdField_a_of_type_Algc != null) && (this.jdField_a_of_type_Arxn.a.jdField_a_of_type_JavaUtilList != null))
    {
      Iterator localIterator = this.jdField_a_of_type_Arxn.a.jdField_a_of_type_JavaUtilList.iterator();
