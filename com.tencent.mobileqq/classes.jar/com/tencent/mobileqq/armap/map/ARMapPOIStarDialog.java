  ...
  extends Dialog
{
  ...
  private ArMapObserver jdField_a_of_type_ComTencentMobileqqArmapArMapObserver = new aazw(this);
  public SanHuaView a;
  public String a;
  public boolean a;
  ...
  public ARMapPOIStarDialog(Context paramContext, long paramLong1, long paramLong2, String paramString1, int paramInt, String paramString2, String paramString3, ArMapInterface paramArMapInterface)
  {
    ...
    b();
    this.jdField_a_of_type_AndroidWidgetProgressBar.postDelayed(new abaa(this), 1500L);
    ThreadManager.postImmediately(new abab(this, paramArMapInterface, paramLong1, paramLong2), null, false);
  }
  ...
  private void a(ItemInfo paramItemInfo, int paramInt)
  {
    ...
    if ((paramInt != -1) && (paramItemInfo.e > 0))
    {
      ...
      if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
        ThreadManager.getUIHandler().postDelayed(new abai(this), 500L);
      }
      for (;;)
      {
        if (((ARMapActivity)this.jdField_a_of_type_AndroidContentContext).a != null) {
          ((ARMapActivity)this.jdField_a_of_type_AndroidContentContext).a.queueEvent(new abaj(this, paramItemInfo));
        }
        ...
        this.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130842219);
    ...
    QQToast.a(this.jdField_a_of_type_AndroidContentContext, 2131437295, 1).b(this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131558448));
    this.jdField_b_of_type_Boolean = false;
    this.jdField_b_of_type_AndroidWidgetProgressBar.setVisibility(8);
    this.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130842219);
    this.jdField_a_of_type_AndroidWidgetButton.setClickable(true);
  ...
  private void a(String paramString, long paramLong)
  {
    ...
    this.jdField_c_of_type_AndroidWidgetTextView.setOnClickListener(new aazz(this, paramLong));
    this.jdField_a_of_type_AndroidWidgetTextView.setText("你已领取" + paramString);
  }
  
  private void b()
  {
    this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)findViewById(2131369633));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131361926));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131369637));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131369640));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)findViewById(2131369613));
    this.jdField_b_of_type_AndroidWidgetButton = ((Button)findViewById(2131363954));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131369635));
    this.jdField_c_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131369632));
    this.jdField_d_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131369634));
    this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)findViewById(2131363544));
    this.jdField_b_of_type_AndroidWidgetProgressBar = ((ProgressBar)findViewById(2131369639));
    this.jdField_b_of_type_AndroidWidgetButton.setOnClickListener(new abac(this));
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131363805));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131369636));
  ...
  public void a()
  {
    ...
    localAnimationSet.setAnimationListener(new abad(this));
  ...
  public void a(POIInfo paramPOIInfo, List paramList, int paramInt)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new abaf(this, paramPOIInfo, paramInt));
    } while (paramInt == -1);
    if (paramInt == 0) {
    ...
    for (;;)
    {
      this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentContext.getString(2131438751, new Object[] { this.jdField_c_of_type_JavaLangString }));
      return;
      if (paramInt == 1)
      {
        paramList = "2";
      ...
      break;
      label451:
      localObject = new abae(this, paramPOIInfo);
