  ...
  implements Handler.Callback
{
  ...
  private void a(View paramView1, View paramView2, View paramView3)
  {
    ...
    if (this.jdField_a_of_type_ComNineoldandroidsAnimationValueAnimator == null)
    {
      ...
      this.jdField_a_of_type_ComNineoldandroidsAnimationValueAnimator.addUpdateListener(new ConversationPullDownActiveBase.4(this, paramView2, paramView1, paramView3));
      this.jdField_a_of_type_ComNineoldandroidsAnimationAnimator$AnimatorListener = new ConversationPullDownActiveBase.5(this, paramView3);
    }
  ...
  public void k()
  {
    ...
    localAlphaAnimation.setAnimationListener(new ConversationPullDownActiveBase.1(this));
    int i = (int)this.jdField_a_of_type_AndroidViewViewGroup.getResources().getDimension(2131298294);
    ...
    localTranslateAnimation.setAnimationListener(new ConversationPullDownActiveBase.2(this));
    localAnimationSet.addAnimation(localTranslateAnimation);
    localAnimationSet.addAnimation(localAlphaAnimation);
    localAlphaAnimation = new AlphaAnimation(1.0F, 0.0F);
    localAlphaAnimation.setDuration(500L);
    localAlphaAnimation.setStartOffset(1000L);
    localAlphaAnimation.setAnimationListener(new ConversationPullDownActiveBase.3(this));
    localAnimationSet.addAnimation(localAlphaAnimation);
