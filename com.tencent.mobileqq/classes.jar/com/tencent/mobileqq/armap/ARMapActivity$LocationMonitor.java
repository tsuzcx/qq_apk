        ...
        if ((paramSosoLbsInfo != null) && (paramSosoLbsInfo.a != null) && (paramSosoLbsInfo.a.m != null))
        {
          if (paramSosoLbsInfo.a.m.equals("cell"))
          {
            ...
            if (this.jdField_a_of_type_Int > j)
            {
              ...
              this.jdField_a_of_type_ComTencentMobileqqArmapARMapActivity.runOnUiThread(new abiu(this));
            }
            this.b = 0;
            return;
          }
          if (paramSosoLbsInfo.a.m.equals("gps"))
          {
            if (paramSosoLbsInfo.a.b > 4.17D)
            {
              this.b += 1;
              if (this.b > i) {
                this.jdField_a_of_type_ComTencentMobileqqArmapARMapActivity.runOnUiThread(new abiv(this));
              }
            }
            for (;;)
            {
