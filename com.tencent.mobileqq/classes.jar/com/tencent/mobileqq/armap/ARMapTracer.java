  ...
  implements ARGLSurfaceView.TraceCallback
{
  ...
  public static int a()
  {
    ...
    {
      f1 = (float)bdcb.d() / 1.073742E+009F;
      i = bdcb.b();
      f2 = (float)bdcb.b() / 1000000.0F;
  ...
  public void trace(long paramLong)
  {
    ...
    do
    {
      ...
      arrayOfInt1[i] += 1;
    } while ((this.f < 30) || (this.jdField_a_of_type_Annr == null));
    ...
    for (;;)
    {
      if ((i != this.c) && (this.d > 2) && (this.jdField_a_of_type_Annr.a(i)))
      {
        this.c = i;
