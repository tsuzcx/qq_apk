...
public class OrientationCalculator
{
  ...
  private ArrayList jdField_a_of_type_JavaUtilArrayList = new ArrayList(793);
  ...
  public void a(Matrix4 paramMatrix4, int paramInt, float[] paramArrayOfFloat)
  {
    ...
    float f6 = Util.a(this.d, this.f);
    float f7 = Util.a(this.d, this.e);
    float f4 = Util.a(this.c, this.f);
    float f2 = Util.a(this.c, this.d);
    float f1 = Util.a(this.f, this.d);
    float f3 = Util.a(f1, Util.a(f4, f2, f1)) * 57.29578F - 90.0F;
    f1 = f3;
    if (f6 > f7) {
      f1 = -f3;
    }
    ...
    for (f3 = 0.0F;; f3 = f1)
    {
      ...
      for (;;)
      {
        ...
        if (paramInt % 72 == 0)
        {
          ...
          f2 = Util.a(this.d, (Vector3)this.jdField_a_of_type_JavaUtilArrayList.get(m));
        ...
        for (;;)
        {
          ...
          {
            f4 = n % 72;
            f5 = Util.a((Vector3)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt), paramMatrix4);
            double d1 = f4 * 5.0F;
            double d2 = 5.0F;
            double d3 = Math.cos(Util.b(f2, Util.a(f1, f2, f5)));
            f1 = Util.a(d1 + d2 * (f1 * d3 / f5) - 180.0D);
            f2 = f1;
            if (Float.isNaN(f1)) {
              f2 = 0.0F;
            }
