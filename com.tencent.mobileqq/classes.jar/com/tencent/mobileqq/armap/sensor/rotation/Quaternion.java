  ...
  implements Serializable
{
  ...
  public Quaternion setFromAxes(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, float paramFloat5, float paramFloat6, float paramFloat7, float paramFloat8, float paramFloat9)
  {
    ...
    if (f >= 0.0F)
    {
      ...
      d1 = 0.5D * d2;
      d2 = 0.5D / d2;
      d4 = (paramFloat8 - paramFloat6) * d2;
      d3 = (paramFloat3 - paramFloat7) * d2;
      d2 *= (paramFloat4 - paramFloat2);
    }
    for (;;)
    {
      return set((float)d4, (float)d3, (float)d2, (float)d1);
      if ((paramFloat1 > paramFloat5) && (paramFloat1 > paramFloat9))
      {
        d1 = Math.sqrt(1.0D + paramFloat1 - paramFloat5 - paramFloat9);
        d4 = d1 * 0.5D;
        d1 = 0.5D / d1;
        d3 = (paramFloat4 + paramFloat2) * d1;
      ...
      else if (paramFloat5 > paramFloat9)
      {
        ...
        d3 = d1 * 0.5D;
        d1 = 0.5D / d1;
        d4 = (paramFloat4 + paramFloat2) * d1;
        d2 = (paramFloat8 + paramFloat6) * d1;
        d1 *= (paramFloat3 - paramFloat7);
      }
      else
      {
        d1 = Math.sqrt(1.0D + paramFloat9 - paramFloat1 - paramFloat5);
        d2 = 0.5D * d1;
        d1 = 0.5D / d1;
        d4 = (paramFloat3 + paramFloat7) * d1;
  ...
  public Quaternion setFromAxis(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    ...
    float f = anto.a(paramFloat4 / 2.0F);
    return set(paramFloat1 * f, paramFloat2 * f, f * paramFloat3, anto.b(paramFloat4 / 2.0F)).nor();
  }
