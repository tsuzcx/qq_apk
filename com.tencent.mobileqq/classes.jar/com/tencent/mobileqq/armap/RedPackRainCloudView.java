  ...
  extends RelativeLayout
{
  ...
  private void a(long paramLong)
  {
    ...
    ((ValueAnimator)localObject).addUpdateListener(new abkb(this));
  ...
  private void c()
  {
    LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130970244, this);
    this.jdField_a_of_type_ComTencentMobileqqArmapSdCardImageAnimView = ((SdCardImageAnimView)findViewById(2131369745));
    this.jdField_a_of_type_AndroidViewView = findViewById(2131369744);
    this.jdField_a_of_type_ComTencentMobileqqArmapWealthgodARMapFlakeView = ((ARMapFlakeView)findViewById(2131369743));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131369746));
  ...
  public void a(String paramString, long paramLong)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqArmapSdCardImageAnimView.setImageResource(2130842331);
