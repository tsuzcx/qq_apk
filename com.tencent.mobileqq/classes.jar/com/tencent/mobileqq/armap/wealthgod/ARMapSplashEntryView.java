  ...
  extends FrameLayout
{
  ...
  public ARMapSplashEntryView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    LayoutInflater.from(paramContext).inflate(2130970219, this, true);
    a();
  }
  
  private void a()
  {
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131369691));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131369692));
    this.c = ((ImageView)findViewById(2131369693));
    this.d = ((ImageView)findViewById(2131369694));
  ...
  private void d()
  {
    if (this.jdField_a_of_type_AndroidAnimationValueAnimator == null)
    {
      ...
      this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new abbp(this));
      this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new abbq(this));
    }
  ...
  private void e()
  {
    if (this.jdField_b_of_type_AndroidAnimationValueAnimator == null)
    {
      ...
      this.jdField_b_of_type_AndroidAnimationValueAnimator.addUpdateListener(new abbr(this));
      this.jdField_b_of_type_AndroidAnimationValueAnimator.addListener(new abbs(this));
    }
