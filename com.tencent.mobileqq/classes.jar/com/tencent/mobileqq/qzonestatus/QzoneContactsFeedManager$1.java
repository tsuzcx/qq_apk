  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    Object localObject = QzoneContactsFeedManager.b(this.this$0);
    long l2 = ((SharedPreferences)localObject).getLong("last_click_time", 0L);
    long l1 = System.currentTimeMillis();
    l2 = l1 - l2;
    if (l2 < QzoneContactsFeedManager.h()) {
      return;
    }
    long l3 = this.this$0.c();
    if ((l3 > 0L) && (l2 < QzoneContactsFeedManager.i()))
    {
      QzoneContactsFeedManager localQzoneContactsFeedManager = this.this$0;
      localQzoneContactsFeedManager.a(l3, localQzoneContactsFeedManager.d());
    }
    else
    {
      this.this$0.b();
