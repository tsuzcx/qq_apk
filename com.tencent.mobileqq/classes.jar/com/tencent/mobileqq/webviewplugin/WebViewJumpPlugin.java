  ...
  extends WebViewPlugin
{
  ...
  private void c(String paramString)
  {
    ...
    for (;;)
    {
      ...
      for (int i = 1; i != 0; i = 0)
      {
        new Handler().postDelayed(new akzk(this), 2000L);
        return;
      }
    }
  }
      ...
      } else if (paramLong == 8589934601L)
      {
        if ((!TextUtils.isEmpty(paramString)) && ((paramString.contains("chatplay/hall")) || (paramString.contains("avwithstranger/avchathall")) || (paramString.contains("chatplay/avchathall"))) && (paramString.endsWith("#child")))
        {
          if ((paramString.contains("adtag=client.tab")) && (this.mRuntime != null) && (this.mRuntime.a() != null))
          {
            ...
            ((IphoneTitleBarActivity)this.mRuntime.a()).setLeftViewName(2131433312);
          }
          while ((this.mRuntime != null) && (this.mRuntime.a() != null) && (this.mRuntime.a().canGoBack()))
          {
            ...
            if ((this.mRuntime.a() instanceof SwiftWebViewFragmentSupporter))
            {
              ...
              if ((paramString != null) && (paramString.a.a != null)) {
                paramString.a.a.setText(2131433312);
              }
            }
          }
        }
        ...
        if ((this.mRuntime.a() instanceof IphoneTitleBarActivity))
        {
          ((IphoneTitleBarActivity)this.mRuntime.a()).setLeftViewName(2131433712);
        }
        else if ((this.mRuntime.a() instanceof SwiftWebViewFragmentSupporter))
        {
          paramString = this.mRuntime.a();
          if ((paramString != null) && (paramString.a.a != null)) {
            paramString.a.a.setText(2131433712);
          }
        }
      }
    }
  ...
  protected boolean handleSchemaRequest(String paramString1, String paramString2)
  {
    ...
    //   688: dup
    //   689: aload_0
    //   690: invokespecial 390	akzh:<init>	(Lcom/tencent/mobileqq/webviewplugin/WebViewJumpPlugin;)V
    //   693: ldc2_w 118
    ...
    //   805: dup
    //   806: aload_0
    //   807: invokespecial 403	akzi:<init>	(Lcom/tencent/mobileqq/webviewplugin/WebViewJumpPlugin;)V
    //   810: ldc2_w 118
    ...
    //   1624: dup
    //   1625: aload_0
    //   1626: invokespecial 534	akzj:<init>	(Lcom/tencent/mobileqq/webviewplugin/WebViewJumpPlugin;)V
    //   1629: ldc2_w 118
