  ...
  implements Serializable
{
  ...
  public void parseConfig4Dialog(String paramString)
  {
    ...
    for (;;)
    {
      ...
      jdField_a_of_type_ComTencentMobileqqUpgradeNewUpgradeConfig.dialog.jdField_a_of_type_Long = ayma.a(localXmlPullParser.nextText());
      continue;
      label212:
      if (paramString.equalsIgnoreCase("showTime")) {
        jdField_a_of_type_ComTencentMobileqqUpgradeNewUpgradeConfig.dialog.jdField_b_of_type_Long = ayma.a(localXmlPullParser.nextText());
