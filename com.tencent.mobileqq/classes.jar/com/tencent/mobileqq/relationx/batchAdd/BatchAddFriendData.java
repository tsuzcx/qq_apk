...
public class BatchAddFriendData
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString, List<cmd0x777.AddFrdInfo> paramList)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (k > 0)
        {
          QQToast.a(BaseApplication.getContext(), 0, HardCodeUtil.a(2131701142), 0).a();
        ...
        for (;;)
        {
          ...
          QQToast.a(BaseApplication.getContext(), 0, HardCodeUtil.a(2131701145), 0).a();
          break label353;
          label465:
          break;
          label467:
        ...
        for (;;)
        {
          paramList = DialogUtil.a(paramActivity, String.format(Locale.getDefault(), HardCodeUtil.a(2131701149), new Object[] { paramList }), 0, 0, null, null);
          paramList.setPositiveButton(2131694615, new BatchAddFriendData.2());
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3)
  {
    ...
    Object localObject1 = paramQQAppInterface.getMessageFacade().a(paramString1, 1);
    long l1;
    label109:
    long l2;
    int j;
    ...
    if ((localObject1 != null) && (!((List)localObject1).isEmpty()))
    {
      ...
      i = 1;
      localObject1 = String.format(Locale.getDefault(), HardCodeUtil.a(2131701143), new Object[] { paramString3, Integer.valueOf(paramInt2) });
      if (paramInt2 != 1) {
        break label746;
      }
      paramString3 = String.format(Locale.getDefault(), HardCodeUtil.a(2131701146), new Object[] { paramString3 });
      paramInt2 = 1;
    }
    for (;;)
    {
      ...
      if (paramInt1 == 0)
      {
        paramString3 = paramString3 + HardCodeUtil.a(2131701150);
        localObject1 = HardCodeUtil.a(2131701147);
        ...
        label349:
        ((UniteGrayTipParam)localObject1).d = paramString3;
      ...
      for (localObject1 = "0";; localObject1 = "1")
      {
        ...
        break label109;
        label619:
        paramString3 = String.format(Locale.getDefault(), HardCodeUtil.a(2131701148), new Object[] { Integer.valueOf(paramInt2) });
        i = j;
        ...
        paramString3 = String.format(Locale.getDefault(), HardCodeUtil.a(2131701144), new Object[] { paramString2 });
        paramInt2 = 0;
        break label188;
        paramString3 = paramString3 + HardCodeUtil.a(2131701141);
        break label218;
        paramString3 = "";
        break label349;
      }
  ...
  private void b(FriendListHandler paramFriendListHandler)
  {
    ...
    for (boolean bool2 = true;; bool2 = bool1)
    {
      ...
      paramFriendListHandler.notifyUI(111, bool1, new Object[] { this.jdField_a_of_type_JavaLangString, localArrayList });
      if (!QLog.isDevelopLevel()) {
        break;
      }
  ...
  public void a(FriendListHandler paramFriendListHandler)
  {
    ...
    for (;;)
    {
      ...
      Object localObject = (FriendsManager)paramFriendListHandler.app.getManager(QQManagerFactory.FRIENDS_MANAGER);
