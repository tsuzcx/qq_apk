  ...
  implements Runnable
{
  ...
  public void run()
  {
    String str1 = bgqt.a(false, this.jdField_a_of_type_Int);
    ...
    {
      bdla.b((QQAppInterface)localObject2, "dc00899", "Grp_addFrd", "", "Grp_AIO", str1, 0, 0, str2, (String)localObject1, "", "");
      return;
    }
    label110:
    bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_addFrd", "", "Grp_AIO", str1, 0, 0, this.jdField_a_of_type_JavaLangString, "0", Integer.toString(((TroopInfo)localObject1).wMemberNum), "");
  }
}
