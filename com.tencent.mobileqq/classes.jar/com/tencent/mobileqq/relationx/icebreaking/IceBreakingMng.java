  ...
  implements Handler.Callback, CfgProcess.OnGetConfigListener, Manager
{
  ...
  public int a;
  FriendListObserver jdField_a_of_type_ComTencentMobileqqAppFriendListObserver = new IceBreakingMng.1(this);
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private TroopBusinessObserver jdField_a_of_type_ComTencentMobileqqAppTroopBusinessObserver = new IceBreakingMng.4(this);
  private TroopObserver jdField_a_of_type_ComTencentMobileqqTroopApiObserverTroopObserver = new IceBreakingMng.3(this);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = HardCodeUtil.a(2131705716);
  }
  ...
  private Object[] a(boolean paramBoolean, String paramString)
  {
    ...
    if (!paramBoolean) {
      localObject2 = SharedPreUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin(), "breaking_ice_config");
    }
    bool6 = bool7;
    i1 = i2;
    n = i3;
  ...
  private void g()
  {
    ...
    Object localObject1 = FileUtils.a(String.format("%s_%s", new Object[] { "break_ice_map", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }));
    ??? = FileUtils.a(String.format("%s_%s", new Object[] { "entered_c2c", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }));
    ??? = FileUtils.a(String.format("%s_%s", new Object[] { "entered_troop", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }));
    ??? = FileUtils.a(String.format("%s_%s", new Object[] { "entered_match_chat", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }));
    ??? = FileUtils.a(String.format("%s_%s", new Object[] { "entered_qcircle_chat", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }));
  ...
  private void h()
  {
    ...
    FileUtils.a(String.format("%s_%s", new Object[] { "break_ice_map", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }), localConcurrentHashMap);
  }
    ...
    if (localTroopInfo.wMemberNum < this.jdField_b_of_type_Int)
    {
      ...
      if ((localObject2 == null) || (((List)localObject2).size() <= 1))
      {
        ...
        for (i = 0;; i = ((List)localObject2).size())
        {
          ...
          ((TroopMemberInfoHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.TROOP_MEMBER_INFO_HANDLER)).a(paramString);
          return;
        }
      }
      ...
      if (((Iterator)localObject2).hasNext())
      {
        ...
        if ((TextUtils.isEmpty(str2)) || (str2.equals(str1)) || (((FriendsManager)localObject1).b(str2))) {
          break label321;
        }
        i += 1;
      }
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2)
  {
    ...
    try
    {
      ...
      localReqBody.str_client_ver.set("8.5.5");
      ...
      for (;;)
      {
        ...
        paramString2 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), StickerRecServlet.class);
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if ((localObject != null) && (((Friends)localObject).isFriend()))
      {
        ...
        {
          localObject = (OnIceBreakChangeListener)this.jdField_a_of_type_JavaLangRefWeakReference.get();
          if (localObject != null) {
  ...
  public void b()
  {
    ...
    FileUtils.a(String.format("%s_%s", new Object[] { "entered_c2c", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }), localHashSet);
  }
  
  public void b(OnIceBreakChangeListener paramOnIceBreakChangeListener)
  {
    if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() == paramOnIceBreakChangeListener)) {
  ...
  public void c()
  {
    ...
    FileUtils.a(String.format("%s_%s", new Object[] { "entered_troop", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }), localHashSet);
  }
  ...
  public void d()
  {
    ...
    FileUtils.a(String.format("%s_%s", new Object[] { "entered_match_chat", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }), localHashSet);
  }
  ...
  public void e()
  {
    ...
    FileUtils.a(String.format("%s_%s", new Object[] { "entered_qcircle_chat", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }), localHashSet);
  }
  ...
  public boolean e(String paramString)
  {
    ...
    if (localObject != null)
    {
      if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
      {
        OnIceBreakChangeListener localOnIceBreakChangeListener = (OnIceBreakChangeListener)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        if (localOnIceBreakChangeListener != null) {
          localOnIceBreakChangeListener.b(paramString, false);
        }
      }
      if (this.jdField_a_of_type_ComTencentUtilMqqWeakReferenceHandler.hasMessages(1)) {
        this.jdField_a_of_type_ComTencentUtilMqqWeakReferenceHandler.removeMessages(1);
  ...
  public void f(String paramString)
  {
    ...
    if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
    {
      OnIceBreakChangeListener localOnIceBreakChangeListener = (OnIceBreakChangeListener)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localOnIceBreakChangeListener != null) {
        localOnIceBreakChangeListener.a(paramString, true);
      }
    }
  }
  ...
  public void g(String paramString)
  {
    ...
    if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
    {
      OnIceBreakChangeListener localOnIceBreakChangeListener = (OnIceBreakChangeListener)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localOnIceBreakChangeListener != null) {
        localOnIceBreakChangeListener.b(paramString, true);
      }
    }
  }
  ...
  public void j(String paramString)
  {
    ...
    OnIceBreakChangeListener localOnIceBreakChangeListener;
    do
    {
      do
      {
        ...
        {
          return;
          if (((ExtendFriendManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.EXTEND_FRIEND_MANAGER)).e()) {
            break;
          }
      ...
      localOnIceBreakChangeListener = (OnIceBreakChangeListener)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (localOnIceBreakChangeListener == null);
    localOnIceBreakChangeListener.a(paramString, false);
  }
  ...
  {
    if (!StickerRecManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b()) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      if ((localTroopMemberInfo == null) || (localTroopMemberInfo.last_active_time == localTroopMemberInfo.join_time))
      {
        ...
        this.jdField_d_of_type_JavaLangString = paramString;
        ((TroopMemberInfoHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.TROOP_MEMBER_INFO_HANDLER)).a(Long.valueOf(paramString).longValue(), Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).longValue(), true);
        return;
      }
