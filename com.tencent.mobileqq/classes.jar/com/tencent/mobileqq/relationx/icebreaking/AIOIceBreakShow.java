...
public class AIOIceBreakShow
  implements Handler.Callback, bbcb
{
  private static int jdField_a_of_type_Int;
  private agkt jdField_a_of_type_Agkt;
  private Animator.AnimatorListener jdField_a_of_type_AndroidAnimationAnimator$AnimatorListener = new bbby(this);
  private ValueAnimator.AnimatorUpdateListener jdField_a_of_type_AndroidAnimationValueAnimator$AnimatorUpdateListener = new bbbx(this);
  private ValueAnimator jdField_a_of_type_AndroidAnimationValueAnimator;
  private Context jdField_a_of_type_AndroidContentContext;
  private LinearLayout jdField_a_of_type_AndroidWidgetLinearLayout;
  private bbcd jdField_a_of_type_Bbcd;
  ...
  private blha jdField_b_of_type_Blha;
  ...
  public AIOIceBreakShow(BaseChatPie paramBaseChatPie, Context paramContext, String paramString)
  {
    ...
    this.jdField_a_of_type_Bbcd = ((bbcd)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(285));
    this.jdField_a_of_type_Blha = new blha(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a().getLooper(), this);
    this.jdField_b_of_type_Blha = new blha(ThreadManager.getSubThreadLooper(), this);
    jdField_a_of_type_Int = agej.a(150.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.jdField_a_of_type_Agkt = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Agkt;
  }
  
  private void a(int paramInt, String paramString)
  {
    this.jdField_b_of_type_Blha.removeCallbacksAndMessages(null);
    this.jdField_b_of_type_Blha.postDelayed(new AIOIceBreakShow.RemoveRunnable(this, paramInt, paramString), this.jdField_a_of_type_Bbcd.jdField_a_of_type_Int * 1000L);
  }
  ...
  private boolean a()
  {
    ...
    for (Object localObject = (ViewGroup)localObject;; localObject = null) {
      return ((ViewGroup)localObject).getId() == 2131362425;
    }
  }
  ...
  private void b(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetLinearLayout == null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetLinearLayout.setTag(2131362372, Integer.valueOf(this.c));
    ...
    anfz.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "ice_break", true);
    Object localObject = (agwg)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(52);
    if (localObject != null) {
      ((agwg)localObject).a(true);
    }
    c();
    ...
    if (paramBoolean)
    {
      ...
      this.jdField_a_of_type_Agkt.a(3, 0);
      this.jdField_a_of_type_Agkt.a(0, false, "icebreak_showFooter", 0);
      ...
      if (QLog.isColorLevel()) {
        QLog.d("AIOIceBreakShow", 2, "real show duration = " + this.jdField_a_of_type_Bbcd.jdField_a_of_type_Int);
      }
    ...
    for (;;)
    {
      bdll.b((QQAppInterface)localObject, "dc00898", "", "", "0X8009B95", "0X8009B95", i, 0, "", "", "", "");
      return;
      this.jdField_a_of_type_Agkt.a(3, jdField_a_of_type_Int);
      this.jdField_a_of_type_Agkt.a(jdField_a_of_type_Int, false, "icebreak_showFooter", 0);
      break;
      label628:
      i = 2;
    }
  ...
  private void c()
  {
    ...
    if (localObject1 != null)
    {
      ...
      if (((View)localObject1).getId() == 2131362425) {
        i = ((Rect)localObject2).top;
      }
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a().findViewById(2131368726);
      localObject2 = new Rect();
      ((View)localObject1).getGlobalVisibleRect((Rect)localObject2);
    ...
    for (;;)
    {
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Agkt;
      if (this.jdField_a_of_type_AndroidWidgetLinearLayout.getParent() != null)
      {
        if (!(a() ^ i))
        {
      ...
      if (i != 0)
      {
        ((agkt)localObject1).a(this.jdField_a_of_type_AndroidWidgetLinearLayout, (FrameLayout.LayoutParams)localObject2);
        this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.f(196608);
        if (!QLog.isColorLevel()) {
          break;
        }
      ...
      ((FrameLayout)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a().findViewById(2131372948)).addView(this.jdField_a_of_type_AndroidWidgetLinearLayout, (ViewGroup.LayoutParams)localObject2);
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  private void d()
  {
    ...
    do
    {
      ...
      anfz.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "ice_break", false);
      localagwg = (agwg)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(52);
    } while (localagwg == null);
    localagwg.a(false);
  }
  ...
  {
    if (bbcg.d(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int))
    {
      if (QLog.isColorLevel()) {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aimd)) {
        ((aimd)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).bp();
      }
      ThreadManager.getSubThreadHandler().post(new AIOIceBreakShow.4(this));
    }
    while (!bbcg.e(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int)) {
      return;
    }
    if (QLog.isColorLevel()) {
  ...
  {
    int i = this.jdField_a_of_type_Bbcd.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int);
    if (QLog.isColorLevel()) {
    ...
    if (i != -1)
    {
      ...
      paramList = this.jdField_a_of_type_Blha.obtainMessage(0, 1, 0);
      this.jdField_a_of_type_Blha.sendMessage(paramList);
      return;
    }
    this.c = i;
    this.jdField_a_of_type_JavaUtilList = paramList;
    this.jdField_a_of_type_Blha.sendEmptyMessage(2);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_Boolean ^ paramBoolean))
    {
      ...
      if ((this.jdField_b_of_type_Int == 0) && (!this.jdField_b_of_type_Boolean))
      {
        ...
        localMessage = this.jdField_a_of_type_Blha.obtainMessage(1, 0, 0);
    ...
    this.jdField_a_of_type_Blha.removeMessages(0);
    this.jdField_a_of_type_Blha.removeMessages(1);
    Message localMessage = this.jdField_a_of_type_Blha.obtainMessage(0, 0, 0);
    this.jdField_a_of_type_Blha.sendMessage(localMessage);
  }
