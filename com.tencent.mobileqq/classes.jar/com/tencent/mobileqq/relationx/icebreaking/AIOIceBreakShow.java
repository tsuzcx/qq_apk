...
public class AIOIceBreakShow
  implements Handler.Callback, baji
{
  private static int jdField_a_of_type_Int;
  private agaz jdField_a_of_type_Agaz;
  private Animator.AnimatorListener jdField_a_of_type_AndroidAnimationAnimator$AnimatorListener = new bajf(this);
  private ValueAnimator.AnimatorUpdateListener jdField_a_of_type_AndroidAnimationValueAnimator$AnimatorUpdateListener = new baje(this);
  ...
  private bkfv jdField_b_of_type_Bkfv;
  ...
  public AIOIceBreakShow(BaseChatPie paramBaseChatPie, Context paramContext, String paramString)
  {
    ...
    this.jdField_a_of_type_Bajk = ((bajk)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(285));
    this.jdField_a_of_type_Bkfv = new bkfv(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a().getLooper(), this);
    this.jdField_b_of_type_Bkfv = new bkfv(ThreadManager.getSubThreadLooper(), this);
    jdField_a_of_type_Int = afur.a(150.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.jdField_a_of_type_Agaz = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Agaz;
  }
  
  private void a(int paramInt, String paramString)
  {
    this.jdField_b_of_type_Bkfv.removeCallbacksAndMessages(null);
    this.jdField_b_of_type_Bkfv.postDelayed(new AIOIceBreakShow.RemoveRunnable(this, paramInt, paramString), this.jdField_a_of_type_Bajk.jdField_a_of_type_Int * 1000L);
  }
  ...
  private boolean a()
  {
    ...
    for (Object localObject = (ViewGroup)localObject;; localObject = null) {
      return ((ViewGroup)localObject).getId() == 2131362410;
    }
  }
  ...
  private void b(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetLinearLayout == null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetLinearLayout.setTag(2131362357, Integer.valueOf(this.c));
    ...
    amuf.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "ice_break", true);
    c();
    ...
    if (paramBoolean)
    {
      ...
      this.jdField_a_of_type_Agaz.a(3, 0);
      this.jdField_a_of_type_Agaz.a(0, false, "icebreak_showFooter", 0);
      ...
      if (QLog.isColorLevel()) {
        QLog.d("AIOIceBreakShow", 2, "real show duration = " + this.jdField_a_of_type_Bajk.jdField_a_of_type_Int);
      }
    ...
    for (;;)
    {
      bcst.b((QQAppInterface)localObject, "dc00898", "", "", "0X8009B95", "0X8009B95", i, 0, "", "", "", "");
      return;
      this.jdField_a_of_type_Agaz.a(3, jdField_a_of_type_Int);
      this.jdField_a_of_type_Agaz.a(jdField_a_of_type_Int, false, "icebreak_showFooter", 0);
      break;
      label606:
      i = 2;
    }
  ...
  private void c()
  {
    ...
    if (localObject1 != null)
    {
      ...
      if (((View)localObject1).getId() == 2131362410) {
        i = ((Rect)localObject2).top;
      }
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a().findViewById(2131368652);
      localObject2 = new Rect();
      ((View)localObject1).getGlobalVisibleRect((Rect)localObject2);
    ...
    for (;;)
    {
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Agaz;
      if (this.jdField_a_of_type_AndroidWidgetLinearLayout.getParent() != null)
      {
        if (!(a() ^ i))
        {
      ...
      if (i != 0)
      {
        ((agaz)localObject1).a(this.jdField_a_of_type_AndroidWidgetLinearLayout, (FrameLayout.LayoutParams)localObject2);
      ...
      ((FrameLayout)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a().findViewById(2131372835)).addView(this.jdField_a_of_type_AndroidWidgetLinearLayout, (ViewGroup.LayoutParams)localObject2);
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  private void d()
  {
    ...
    amuf.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "ice_break", false);
  }
  ...
  {
    if (bajn.d(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int))
    {
      if (QLog.isColorLevel()) {
        QLog.i("IceBreak.IceBreakingUtil", 2, "onImageClick remove matchChat Ice show");
      }
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aicl)) {
        ((aicl)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).bp();
      }
      ThreadManager.getSubThreadHandler().post(new AIOIceBreakShow.4(this));
    }
    while (!bajn.e(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int)) {
      return;
    }
    if (QLog.isColorLevel()) {
  ...
  {
    int i = this.jdField_a_of_type_Bajk.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int);
    if (QLog.isColorLevel()) {
    ...
    if (i != -1)
    {
      ...
      paramList = this.jdField_a_of_type_Bkfv.obtainMessage(0, 1, 0);
      this.jdField_a_of_type_Bkfv.sendMessage(paramList);
      return;
    }
    this.c = i;
    this.jdField_a_of_type_JavaUtilList = paramList;
    this.jdField_a_of_type_Bkfv.sendEmptyMessage(2);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_Boolean ^ paramBoolean))
    {
      ...
      if ((this.jdField_b_of_type_Int == 0) && (!this.jdField_b_of_type_Boolean))
      {
        ...
        localMessage = this.jdField_a_of_type_Bkfv.obtainMessage(1, 0, 0);
    ...
    this.jdField_a_of_type_Bkfv.removeMessages(0);
    this.jdField_a_of_type_Bkfv.removeMessages(1);
    Message localMessage = this.jdField_a_of_type_Bkfv.obtainMessage(0, 0, 0);
    this.jdField_a_of_type_Bkfv.sendMessage(localMessage);
  }
