  ...
  extends MessageMicro<RspPreDownloadRecmd>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 32, 40, 48, 58 }, new String[] { "err_info", "start_time", "end_time", "interval", "daily_num", "quota_num", "download_url" }, new Object[] { null, localInteger, localInteger, localInteger, localInteger, localInteger, "" }, RspPreDownloadRecmd.class);
  }
}
