...
@QAPI(process={"all"})
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/mobileqq/ecshop/report/api/IEcshopReportApi;", "Lcom/tencent/mobileqq/qroute/QRouteApi;", "doArrivalArkReport", "", "record", "Lcom/tencent/mobileqq/data/MessageRecord;", "doArrivalReport", "app", "Lcom/tencent/common/app/business/BaseQQAppInterface;", "doClickReport", "index", "", "isReportForClick", "", "reportForClick", "", "report", "opName", "reportEcshopTo644", "opType", "d2", "d1", "reportEcshopToBeacon", "reportSetTopOrCancleSetTop", "uinType", "uin", "isSetTop", "qqshop-feature-api_release"}, k=1, mv={1, 1, 16})
