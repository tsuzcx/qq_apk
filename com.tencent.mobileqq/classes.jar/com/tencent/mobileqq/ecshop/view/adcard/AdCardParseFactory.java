...
{
  private static final AdCardBaseProcessor jdField_a_of_type_ComTencentMobileqqEcshopViewAdcardAdCardBaseProcessor = new AdCardBaseProcessor();
  public static final AdCardParseFactory a;
  private static final Map<Integer, AdCardBaseProcessor> jdField_a_of_type_JavaUtilMap;
  
  static
  {
    AdCardParseFactory localAdCardParseFactory = new AdCardParseFactory();
    jdField_a_of_type_ComTencentMobileqqEcshopViewAdcardAdCardParseFactory = localAdCardParseFactory;
    jdField_a_of_type_JavaUtilMap = (Map)new AdCardParseFactory.processorMap.1(localAdCardParseFactory);
  }
  
  public int a(@Nullable qq_ad_get.QQAdGetRsp.AdInfo paramAdInfo, @NotNull MessageRecord paramMessageRecord)
  {
  ...
  @NotNull
  public final AdCardBaseProcessor a(@Nullable qq_ad_get.QQAdGetRsp.AdInfo paramAdInfo, @NotNull MessageRecord paramMessageRecord)
  {
    Intrinsics.checkParameterIsNotNull(paramMessageRecord, "messageRecord");
    paramAdInfo = (AdCardBaseProcessor)jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(a(paramAdInfo, paramMessageRecord)));
    if (paramAdInfo != null) {
      return paramAdInfo;
    }
    return jdField_a_of_type_ComTencentMobileqqEcshopViewAdcardAdCardBaseProcessor;
  }
  ...
  public final AdCardModel a(@Nullable qq_ad_get.QQAdGetRsp.AdInfo paramAdInfo, @NotNull MessageRecord paramMessageRecord)
  {
    ...
    AdCardBaseProcessor localAdCardBaseProcessor = a(paramAdInfo, paramMessageRecord);
    ...
    localAdCardModel.g(localAdCardBaseProcessor.a(paramMessageRecord));
    localAdCardModel.c(localAdCardBaseProcessor.a());
    localAdCardModel.b(jdField_a_of_type_ComTencentMobileqqEcshopViewAdcardAdCardParseFactory.a(paramMessageRecord));
