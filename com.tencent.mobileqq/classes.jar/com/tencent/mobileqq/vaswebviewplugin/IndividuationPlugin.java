  ...
  extends VasWebviewJsPlugin
{
  ...
  protected void getFontType(JSONObject paramJSONObject, String paramString)
  {
    ...
    super.sendRemoteReq(anqu.a("isSupportFont", paramString, this.mOnRemoteResp.key, paramJSONObject), false, true);
  }
  ...
  protected void onResponse(Bundle paramBundle)
  {
    ...
    if ("openProfileCard".equals(str2))
    {
      ...
      paramBundle.putExtra("url", bbqd.a(this.mActivity, "card", "inside.myIndividuationWeb"));
    ...
    if ("openFontSetting".equals(str2))
    {
      if (((Bundle)localObject).getBoolean("feature"))
      {
        ...
        paramBundle.putExtra("startOpenPageTime", System.currentTimeMillis());
        VasWebviewUtil.openQQBrowserWithoutAD(this.mActivity, bbqd.a(this.mActivity, "font", ""), 4096L, paramBundle, false, -1);
        return;
      }
    ...
    for (int i = 1;; i = -40) {
      try
      {
        ...
        if ("600".equals(localObject))
        {
          ...
          aymk.a(null, "theme_detail", "205", 150, 1, i, ThemeUtil.getUserCurrentThemeId(this.mRuntime.a()), ThemeUtil.getUserCurrentThemeVersion(this.mRuntime.a()), "2", "");
          if (!BaseApplicationImpl.IS_SUPPORT_THEME)
          {
            Toast.makeText(this.mActivity.getApplicationContext(), this.mActivity.getString(2131720233), 0).show();
            return;
          }
          if (!bbbr.a())
          {
            Toast.makeText(this.mActivity.getApplicationContext(), this.mActivity.getString(2131719055), 0).show();
            return;
          }
        }
      }
      catch (Exception paramJSONObject)
      {
        ...
        if (QLog.isColorLevel())
        {
          ...
          VasWebviewUtil.openQQBrowserWithoutAD(this.mActivity, bbqd.a(this.mActivity, "theme", "mvip.gongneng.android.theme.index_dynamic_tab"), 32L, paramJSONObject, true, 0);
          return;
          if ("500".equals(localObject))
          {
            ...
            paramJSONObject.putExtra("url", bbqd.a(this.mActivity, "background", ""));
            paramJSONObject.putExtra("startOpenPageTime", System.currentTimeMillis());
            paramJSONObject.putExtra("vasUsePreWebview", true);
            VasWebviewUtil.openQQBrowserWithoutAD(this.mRuntime.a(), bbqd.a(this.mRuntime.a(), "background", ""), 33554432L, paramJSONObject, true, 1);
            axqy.b(null, "CliOper", "", "", "0X8004E0D", "0X8004E0D", 0, 0, "", "", "", "");
            return;
          }
          if ("200".equals(localObject))
          {
            paramJSONObject = new Intent(this.mActivity, QQBrowserActivity.class);
            paramJSONObject.putExtra("updateFlag", false);
            VasWebviewUtil.openQQBrowserWithoutAD(this.mActivity, bbqd.a(this.mActivity, "bubble", "mvip.gongneng.android.bubble.index_dynamic_tab"), 64L, paramJSONObject, false, -1);
            return;
          }
          if ("100".equals(localObject))
          {
            paramJSONObject = new Bundle();
            super.sendRemoteReq(anqu.a("openEmojiMall", paramString, this.mOnRemoteResp.key, paramJSONObject), true, true);
            return;
          }
          if ("101".equals(localObject))
          {
            ...
            super.sendRemoteReq(anqu.a("openEmojiDetail", paramString, this.mOnRemoteResp.key, (Bundle)localObject), true, true);
            return;
          }
          if ("400".equals(localObject))
          {
            ...
            paramJSONObject.putExtra("hide_left_button", false);
            paramJSONObject.putExtra("show_right_close_button", false);
            paramJSONObject.putExtra("url", bbqd.a(this.mActivity, "pendant", ""));
            ...
            axqy.b(null, "CliOper", "", "", "PendantMarket", "WebEntrance", 0, 0, "", "", "", "");
            return;
          }
          if ("300".equals(localObject))
          {
            paramJSONObject = new Bundle();
            sendRemoteReq(anqu.a("openFontSetting", paramString, this.mOnRemoteResp.key, paramJSONObject), true, true);
            return;
          }
          if ("700".equals(localObject))
          {
            paramJSONObject = new Bundle();
            super.sendRemoteReq(anqu.a("openProfileCard", paramString, this.mOnRemoteResp.key, paramJSONObject), true, true);
            return;
          }
          if ("800".equals(localObject))
          {
            ...
            paramJSONObject.putExtra("show_right_close_button", false);
            paramJSONObject.putExtra("startOpenPageTime", System.currentTimeMillis());
            VasWebviewUtil.openQQBrowserWithoutAD(this.mActivity, bbqd.a(this.mActivity, "suit", "mvip.gongneng.android.gxsuit"), 262144L, paramJSONObject, false, -1);
            return;
          }
          if ("900".equals(localObject))
          {
            ...
            paramJSONObject.putExtra("show_right_close_button", false);
            paramJSONObject.putExtra("startOpenPageTime", System.currentTimeMillis());
            VasWebviewUtil.openQQBrowserWithoutAD(this.mActivity, bbqd.a(this.mActivity, "ring", "mvip.gongneng.anroid.individuation.web"), 4194304L, paramJSONObject, false, -1);
            return;
          }
          if ("0".equals(localObject))
          {
            paramString = new Intent(this.mActivity, QQBrowserActivity.class);
            paramJSONObject = URLDecoder.decode(paramJSONObject.getString("detailId"), "UTF-8").replace("{uin}", this.mBrowserApp.getCurrentAccountUin()).replace("{client}", "androidQQ").replace("{version}", "8.3.0.4480").replace("{platformId}", "2").replace("{device}", Build.DEVICE).replace("{system}", Build.VERSION.RELEASE).replace("{systemInt}", Integer.toString(Build.VERSION.SDK_INT)).replace("{adtag}", "mvip.gongneng.anroid.individuation.web").replace("{updateFlag}", "false").replace("{density}", ThemeUtil.getThemeDensity(this.mBrowserApp.getApplication().getApplicationContext()));
      ...
      try
      {
        ...
        if (i == 2)
        {
          ...
          if (paramJSONObject != null)
          {
            ...
            paramJSONObject.setText(2131695243);
