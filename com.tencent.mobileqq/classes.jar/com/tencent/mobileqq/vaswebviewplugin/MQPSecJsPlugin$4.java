  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if ((localWebUiBaseInterface != null) && ((localWebUiBaseInterface instanceof WebUiUtils.WebTitleBarInterface))) {
      QQToast.a(this.this$0.activity, this.this$0.activity.getString(2131692257), 0).b(((WebUiUtils.WebTitleBarInterface)localWebUiBaseInterface).getTitleBarHeight());
    }
  }
}
