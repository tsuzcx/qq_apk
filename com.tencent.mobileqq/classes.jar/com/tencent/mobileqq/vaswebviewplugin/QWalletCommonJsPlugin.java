  ...
  extends VasWebviewJsPlugin
{
  ...
  private void chooseQQFriendsForTransfer(String paramString)
  {
    ...
    if ((localObject1 != null) && (!TextUtils.isEmpty(paramString))) {
      try
      {
        ...
        paramString = ((JSONObject)localObject2).optString("title", HardCodeUtil.a(2131711377));
        boolean bool2 = true;
  ...
  private JSONObject getAllContact()
  {
    ...
    //   31: dup
    //   32: invokespecial 347	org/json/JSONObject:<init>	()V
    //   35: astore 9
    //   37: new 349	org/json/JSONArray
    //   40: dup
    //   41: invokespecial 350	org/json/JSONArray:<init>	()V
    //   44: astore 10
    //   46: getstatic 356	android/provider/ContactsContract$Contacts:CONTENT_URI	Landroid/net/Uri;
    //   49: astore 4
    //   51: aload_0
    //   52: getfield 206	com/tencent/mobileqq/vaswebviewplugin/QWalletCommonJsPlugin:mContext	Landroid/content/Context;
    //   55: invokevirtual 362	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   58: aload 4
    //   60: aconst_null
    //   61: aconst_null
    //   62: aconst_null
    //   63: aconst_null
    //   64: invokevirtual 368	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   67: astore 5
    //   69: aload 7
    //   71: astore 4
    //   73: aload 5
    ...
    //   109: aload 5
    //   111: ldc_w 376
    //   114: invokeinterface 380 2 0
    //   119: invokeinterface 383 2 0
    //   124: astore_3
    //   125: aload 4
    //   127: astore_1
    //   128: aload 4
    ...
    //   150: aload_0
    //   151: aload_3
    //   152: invokevirtual 386	com/tencent/mobileqq/vaswebviewplugin/QWalletCommonJsPlugin:trimPhoneName	(Ljava/lang/String;)Ljava/lang/String;
    //   155: astore 6
    //   157: aload 4
    //   159: astore_3
    //   160: aload 4
    ...
    //   220: invokevirtual 362	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   223: astore 7
    //   225: aload 4
    //   227: astore_1
    //   228: aload 4
    //   230: astore_2
    //   231: getstatic 397	android/provider/ContactsContract$CommonDataKinds$Phone:CONTENT_URI	Landroid/net/Uri;
    //   234: astore 8
    //   236: aload 4
    //   238: astore_1
    //   239: aload 4
    //   241: astore_2
    //   242: new 399	java/lang/StringBuilder
    //   245: dup
    //   246: invokespecial 400	java/lang/StringBuilder:<init>	()V
    //   249: astore 11
    //   251: aload 4
    //   253: astore_1
    //   254: aload 4
    ...
    //   257: aload 11
    //   259: ldc_w 402
    //   262: invokevirtual 406	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   265: pop
    //   266: aload 4
    //   268: astore_1
    //   269: aload 4
    ...
    //   272: aload 11
    //   274: aload_3
    //   275: invokevirtual 406	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   278: pop
    //   279: aload 4
    //   281: astore_1
    //   282: aload 4
    ...
    //   289: aconst_null
    //   290: aload 11
    //   292: invokevirtual 410	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   295: aconst_null
    //   296: aconst_null
    //   297: invokevirtual 368	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   300: astore 4
    //   302: aload 4
    //   304: ifnull +154 -> 458
    //   307: aload 4
    ...
    //   331: aload 4
    //   333: ldc_w 412
    //   336: invokeinterface 380 2 0
    //   341: invokeinterface 383 2 0
    //   346: astore_3
    //   347: aload 4
    //   349: astore_1
    //   350: aload 4
    ...
    //   369: aload_0
    //   370: aload_3
    //   371: invokevirtual 415	com/tencent/mobileqq/vaswebviewplugin/QWalletCommonJsPlugin:trimPhoneNumPre	(Ljava/lang/String;)Ljava/lang/String;
    //   374: astore_3
    //   375: aload 4
    //   377: astore_1
    //   378: aload 4
    ...
    //   384: dup
    //   385: invokespecial 347	org/json/JSONObject:<init>	()V
    //   388: astore 7
    //   390: aload 4
    //   392: astore_1
    //   393: aload 4
    ...
    //   398: ldc_w 417
    //   401: aload 6
    //   403: invokevirtual 421	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   406: pop
    //   407: aload 4
    //   409: astore_1
    //   410: aload 4
    ...
    //   415: ldc_w 423
    //   418: aload_3
    //   419: invokevirtual 421	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   422: pop
    //   423: aload 4
    //   425: astore_1
    //   426: aload 4
    ...
    //   429: aload 10
    //   431: aload 7
    //   433: invokevirtual 426	org/json/JSONArray:put	(Ljava/lang/Object;)Lorg/json/JSONArray;
    //   436: pop
    //   437: aload 4
    //   439: ifnull +19 -> 458
    //   442: aload 4
    ...
    //   521: ldc_w 434
    //   524: aload 10
    //   526: invokevirtual 421	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   529: pop
    //   530: aload 4
    //   532: astore_1
    //   533: aload 4
    ...
    //   538: ldc_w 436
    //   541: iconst_0
    //   542: invokevirtual 439	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   545: pop
    //   546: aload 5
    //   548: ifnull +18 -> 566
    //   551: aload 5
    //   553: invokeinterface 432 1 0
    //   558: goto +8 -> 566
    //   561: astore_1
    //   562: aload_1
    //   563: invokevirtual 440	java/lang/Exception:printStackTrace	()V
    //   566: aload 4
    //   568: ifnull +91 -> 659
    //   571: aload 4
    //   573: invokeinterface 432 1 0
    //   578: aload 9
    //   580: areturn
    //   581: astore_2
    //   582: aconst_null
    ...
    //   589: astore_1
    //   590: aload_3
    //   591: invokevirtual 440	java/lang/Exception:printStackTrace	()V
    //   594: aload 9
    //   596: ldc_w 434
    //   599: aload 10
    //   601: invokevirtual 421	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   604: pop
    //   605: aload 9
    //   607: ldc_w 436
    //   610: iconst_m1
    //   611: invokevirtual 439	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   614: pop
    //   615: goto +8 -> 623
    //   618: astore_3
    //   619: aload_3
    //   620: invokevirtual 335	org/json/JSONException:printStackTrace	()V
    //   623: aload_2
    //   624: ifnull +17 -> 641
    //   627: aload_2
    //   628: invokeinterface 432 1 0
    //   633: goto +8 -> 641
    //   636: astore_2
    //   637: aload_2
    //   638: invokevirtual 440	java/lang/Exception:printStackTrace	()V
    //   641: aload_1
    //   642: ifnull +17 -> 659
    //   645: aload_1
    //   646: invokeinterface 432 1 0
    //   651: aload 9
    //   653: areturn
    //   654: astore_1
    //   655: aload_1
    //   656: invokevirtual 440	java/lang/Exception:printStackTrace	()V
    //   659: aload 9
    //   661: areturn
    //   662: astore 4
    //   664: aload_2
    ...
    //   670: ifnull +17 -> 687
    //   673: aload_3
    //   674: invokeinterface 432 1 0
    //   679: goto +8 -> 687
    //   682: astore_3
    //   683: aload_3
    //   684: invokevirtual 440	java/lang/Exception:printStackTrace	()V
    //   687: aload_1
    //   688: ifnull +17 -> 705
    //   691: aload_1
    //   692: invokeinterface 432 1 0
    //   697: goto +8 -> 705
    //   700: astore_1
    //   701: aload_1
    //   702: invokevirtual 440	java/lang/Exception:printStackTrace	()V
    //   705: goto +5 -> 710
    //   708: aload_2
    //   709: athrow
    //   710: goto -2 -> 708
  ...
  private void getAppAuthCode(String paramString)
  {
    ...
    try
    {
      ...
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        localStringBuilder.append(this.mRuntime.a().getFilesDir());
  ...
  private JSONObject getSelectContact(String paramString)
  {
    ...
    //   3: dup
    //   4: invokespecial 347	org/json/JSONObject:<init>	()V
    //   7: astore 9
    //   9: aconst_null
    //   10: astore 4
    //   12: aconst_null
    ...
    //   14: aconst_null
    //   15: astore 6
    //   17: getstatic 356	android/provider/ContactsContract$Contacts:CONTENT_URI	Landroid/net/Uri;
    //   20: astore_2
    //   21: aload_0
    //   22: getfield 206	com/tencent/mobileqq/vaswebviewplugin/QWalletCommonJsPlugin:mContext	Landroid/content/Context;
    //   25: invokevirtual 362	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   28: aload_2
    //   29: aconst_null
    //   30: ldc_w 572
    //   33: iconst_1
    //   34: anewarray 340	java/lang/String
    //   37: dup
    //   38: iconst_0
    //   39: aload_1
    //   40: aastore
    //   41: aconst_null
    //   42: invokevirtual 368	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   45: astore_2
    //   46: aload_2
    //   47: invokeinterface 374 1 0
    //   52: ifeq +436 -> 488
    //   55: aload_0
    //   56: aload_2
    //   57: aload_2
    //   58: ldc_w 376
    //   61: invokeinterface 380 2 0
    //   66: invokeinterface 383 2 0
    //   71: invokevirtual 386	com/tencent/mobileqq/vaswebviewplugin/QWalletCommonJsPlugin:trimPhoneName	(Ljava/lang/String;)Ljava/lang/String;
    //   74: astore 8
    //   76: aload_2
    //   77: aload_2
    //   78: ldc_w 388
    //   81: invokeinterface 380 2 0
    //   86: invokeinterface 392 2 0
    //   91: ifle +388 -> 479
    //   94: aload_0
    //   95: getfield 206	com/tencent/mobileqq/vaswebviewplugin/QWalletCommonJsPlugin:mContext	Landroid/content/Context;
    //   98: invokevirtual 362	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   101: astore 4
    //   103: getstatic 397	android/provider/ContactsContract$CommonDataKinds$Phone:CONTENT_URI	Landroid/net/Uri;
    //   106: astore 5
    //   108: new 399	java/lang/StringBuilder
    //   111: dup
    //   112: invokespecial 400	java/lang/StringBuilder:<init>	()V
    //   115: astore 7
    //   117: aload 7
    //   119: ldc_w 402
    //   122: invokevirtual 406	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   125: pop
    //   126: aload 7
    //   128: aload_1
    //   129: invokevirtual 406	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   132: pop
    //   133: aload 4
    //   135: aload 5
    //   137: aconst_null
    //   138: aload 7
    //   140: invokevirtual 410	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   143: aconst_null
    //   144: aconst_null
    //   145: invokevirtual 368	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   148: astore 4
    //   150: aload 8
    //   152: astore 7
    //   154: aload 4
    ...
    //   184: aload 4
    //   186: ldc_w 412
    //   189: invokeinterface 380 2 0
    //   194: invokeinterface 383 2 0
    //   199: invokevirtual 415	com/tencent/mobileqq/vaswebviewplugin/QWalletCommonJsPlugin:trimPhoneNumPre	(Ljava/lang/String;)Ljava/lang/String;
    //   202: astore 6
    //   204: aload 8
    //   206: astore 7
    //   208: aload 4
    ...
    //   247: ldc_w 436
    //   250: iconst_0
    //   251: invokevirtual 439	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   254: pop
    //   255: aload_1
    //   256: astore_3
    //   257: aload_1
    ...
    //   262: ldc_w 417
    //   265: aload 7
    //   267: invokevirtual 421	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   270: pop
    //   271: aload_1
    //   272: astore_3
    //   273: aload_1
    ...
    //   278: ldc_w 423
    //   281: aload 6
    //   283: invokevirtual 421	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   286: pop
    //   287: aload_2
    //   288: ifnull +17 -> 305
    //   291: aload_2
    //   292: invokeinterface 432 1 0
    //   297: goto +8 -> 305
    //   300: astore_2
    //   301: aload_2
    //   302: invokevirtual 440	java/lang/Exception:printStackTrace	()V
    //   305: aload_1
    //   306: ifnull +125 -> 431
    //   309: aload_1
    //   310: invokeinterface 432 1 0
    //   315: aload 9
    //   317: areturn
    //   318: astore_1
    //   319: goto +122 -> 441
    ...
    //   350: astore_2
    //   351: aload_3
    //   352: invokevirtual 440	java/lang/Exception:printStackTrace	()V
    //   355: aload 9
    //   357: ldc_w 436
    //   360: iconst_m1
    //   361: invokevirtual 439	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   364: pop
    //   365: aload 9
    //   367: ldc_w 417
    //   370: ldc 31
    //   372: invokevirtual 421	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   375: pop
    //   376: aload 9
    //   378: ldc_w 423
    //   381: ldc 31
    //   383: invokevirtual 421	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   386: pop
    //   387: goto +8 -> 395
    //   390: astore_3
    //   391: aload_3
    //   392: invokevirtual 335	org/json/JSONException:printStackTrace	()V
    //   395: aload_2
    //   396: ifnull +17 -> 413
    //   399: aload_2
    //   400: invokeinterface 432 1 0
    //   405: goto +8 -> 413
    //   408: astore_2
    //   409: aload_2
    //   410: invokevirtual 440	java/lang/Exception:printStackTrace	()V
    //   413: aload_1
    //   414: ifnull +17 -> 431
    //   417: aload_1
    //   418: invokeinterface 432 1 0
    //   423: aload 9
    //   425: areturn
    //   426: astore_1
    //   427: aload_1
    //   428: invokevirtual 440	java/lang/Exception:printStackTrace	()V
    //   431: aload 9
    //   433: areturn
    //   434: astore 4
    //   436: aload_1
    ...
    //   442: ifnull +17 -> 459
    //   445: aload_2
    //   446: invokeinterface 432 1 0
    //   451: goto +8 -> 459
    //   454: astore_2
    //   455: aload_2
    //   456: invokevirtual 440	java/lang/Exception:printStackTrace	()V
    //   459: aload_3
    //   460: ifnull +17 -> 477
    //   463: aload_3
    //   464: invokeinterface 432 1 0
    //   469: goto +8 -> 477
    //   472: astore_2
    //   473: aload_2
    //   474: invokevirtual 440	java/lang/Exception:printStackTrace	()V
    //   477: aload_1
    //   478: athrow
    //   479: aconst_null
    //   480: astore_1
