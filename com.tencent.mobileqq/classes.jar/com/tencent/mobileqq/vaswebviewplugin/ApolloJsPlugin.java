  ...
  implements aivc
{
  ...
  private static final int DEFAULT_HEIGHT = (int)(bbdh.l() * 0.4D / bbdh.a());
  private static final int DEFAULT_WIDTH = (int)((float)(bbdh.k() >> 1) / bbdh.a());
  ...
  public ApolloJsPlugin(String paramString)
  {
    ...
    if (ajkc.a())
    {
      ...
      this.mInterceptor = ajka.a(true, paramString);
      if (QLog.isColorLevel()) {
  ...
  boolean checkSdcard(Context paramContext)
  {
    ...
    {
      bcql.a(paramContext, ajya.a(2131700431), 0).a();
      return false;
    }
    return true;
  }
  
  public ajka getIntercepter()
  {
    ...
    try
    {
      ...
      do
      {
        for (;;)
        {
          ...
          {
            callbackError(paramString2, ajya.a(2131700438));
            return true;
          }
          if ("startRecord".equals(paramString3))
          {
            ...
            else
            {
              ...
              super.sendRemoteReq(anqu.a("ipc_apollo_start_record_msg", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
            }
          }
          else if ("stopRecord".equals(paramString3))
          {
            super.sendRemoteReq(anqu.a("ipc_apollo_stop_record_msg", paramString2, this.mOnRemoteResp.key, null), false, true);
          }
          else if ("startUploadRecord".equals(paramString3))
          {
            super.sendRemoteReq(anqu.a("ipc_apollo_upload_record_msg", paramString2, this.mOnRemoteResp.key, null), false, true);
          }
          else if ("startPlayLastRecord".equals(paramString3))
          {
            ...
            super.sendRemoteReq(anqu.a("ipc_apollo_play_last_record_msg", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
          }
          else if ("stopPlayLastRecord".equals(paramString3))
          {
            super.sendRemoteReq(anqu.a("ipc_apollo_stop_last_record_msg", paramString2, this.mOnRemoteResp.key, null), false, true);
          }
          else if ("getPlaymateMsgList".equals(paramString3))
          {
            ...
            if (paramJsBridgeListener != null)
            {
              ...
              super.sendRemoteReq(anqu.a("ipc_apollo_get_playmate_msg", paramString2, this.mOnRemoteResp.key, this.mReqBundle), true, true);
            }
            else
            {
          ...
          else if ("openCmGameAio".equals(paramString3))
          {
            ...
            if (!TextUtils.isEmpty(paramJsBridgeListener))
            {
              ...
              super.sendRemoteReq(anqu.a("ipc_apollo_open_cmgame_aio", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
          ...
          {
            paramJsBridgeListener = new File(ajms.jdField_a_of_type_JavaLangString + "/webview/");
            if (paramJsBridgeListener.exists())
            {
              ...
              if ((paramJsBridgeListener != null) && (paramJsBridgeListener.length > 0))
              {
                ...
                if (i < j)
                {
                  ...
                  bbdx.a(paramString1.getAbsolutePath());
                  if (!QLog.isColorLevel()) {
                    break label10047;
                  }
          ...
          else
          {
            ...
            if ("startApolloGame".equals(paramString3))
            {
              ...
              {
                callbackError(paramString2, ajya.a(2131700420));
                return true;
              }
              ...
              if ((paramVarArgs != null) && (!paramVarArgs.isFinishing()))
              {
                if (bool2)
                {
                  ...
                  paramJsBridgeListener = actj.a(new Intent(paramVarArgs, SplashActivity.class), new int[] { 2 });
                ...
                else
                {
                  ...
                  if (!TextUtils.isEmpty(paramString3))
                  {
                    ...
                    if (!TextUtils.isEmpty(paramJsBridgeListener))
                    {
                      ...
                      paramString1.disableMinGame = true;
                      aizr.a((String)localObject2);
                    }
                  }
                  this.mReqBundle.clear();
                  this.mReqBundle.putSerializable("StartCheckParam", paramString1);
                  super.sendRemoteReq(anqu.a("ipc_apollo_start_apollo_game", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
                }
              }
              else {
                callbackError(paramString2, ajya.a(2131700414));
              }
            }
            else
            {
              if ("checkGameStatus".equals(paramString3))
              {
                ...
                if (bbdx.c() < 52428800.0F)
                {
                  callbackError(paramString2, ajya.a(2131700419));
                  return true;
                }
                i = ((JSONObject)localObject1).optInt("gameId");
                this.mReqBundle.clear();
                this.mReqBundle.putInt("gameId", i);
                paramJsBridgeListener = anqu.a("IPC_APOLLO_DOWNLOAD_GAME", paramString2, this.mOnRemoteResp.key, this.mReqBundle);
              ...
              {
                i = ((JSONObject)localObject1).optInt("gameId");
                paramJsBridgeListener = new ajrd();
                paramJsBridgeListener.jdField_a_of_type_Int = i;
                ajnc.a(paramJsBridgeListener, this.mRuntime.a(), 2);
                return true;
              }
              if ("dispatchGameEvent".equals(paramString3))
              {
                paramJsBridgeListener = ajac.a();
                if (paramJsBridgeListener != null) {
              ...
              else if ("setBackViewVisibility".equals(paramString3))
              {
                ...
                if ((paramVarArgs instanceof ajin))
                {
                  ((ajin)paramVarArgs).c(i);
                  callbackOk(paramString2);
                }
                else
                {
              ...
              else if ("openApolloShareFloatView".equals(paramString3))
              {
                ...
                else if ((paramVarArgs instanceof ajin))
                {
                  ((ajin)paramVarArgs).a(paramVarArgs, paramString1, paramString3);
                  callbackOk(paramString2);
                }
                else
                {
              ...
              else if ("openDiyActionFloatView".equals(paramString3))
              {
                ...
                if ((paramVarArgs instanceof ajin)) {
                  ((ajin)paramVarArgs).a(paramJsBridgeListener);
                } else {
                  callbackError(paramString2, ajya.a(2131700448));
                }
              }
              else if ("sayHi".equals(paramString3))
              {
                if ((paramVarArgs instanceof ajin))
                {
                  paramJsBridgeListener = ((ajin)paramVarArgs).a();
              ...
              else if ("setCapsuleOpened".equals(paramString3))
              {
                ...
                else
                {
                  ...
                  super.sendRemoteReq(anqu.a("ipc_apollo_setcapsule", paramString2, this.mOnRemoteResp.key, this.mReqBundle), true, true);
                }
              }
              else if ("openBox".equals(paramString3))
              {
                ...
                if ((paramVarArgs instanceof ajin))
                {
                  paramJsBridgeListener = ((ajin)paramVarArgs).a(paramJsBridgeListener);
                  super.callJs(paramString2 + "&&" + paramString2 + "(" + paramJsBridgeListener + ");");
                }
                else
                {
                  callbackError(paramString2, ajya.a(2131700454));
                }
              }
              ...
              else if ("initApolloView".equals(paramString3))
              {
                ...
                {
                  this.mApolloViewContoller = new ajig((RelativeLayout)this.mRuntime.a().getParent(), null);
                ...
                if (!bool2)
                {
                  ...
                  super.sendRemoteReq(anqu.a("ipc_apollo_check_avatar_res", paramString2, this.mOnRemoteResp.key, this.mReqBundle), true, true);
              ...
              else if ("initAvatar".equals(paramString3))
              {
                ...
                if (!ajin.class.isInstance(paramVarArgs))
                {
                  if (QLog.isColorLevel()) {
                ...
                if ((paramVarArgs instanceof ajin))
                {
                  paramVarArgs = (ajin)paramVarArgs;
                  if (i != 0)
                  {
                    if (QLog.isColorLevel()) {
                ...
                for (;;)
                {
                  ...
                  super.sendRemoteReq(anqu.a("ipc_apollo_update_avatar_info", paramString2, this.mOnRemoteResp.key, this.mReqBundle), true, true);
                  break;
                  ...
                  callbackError(paramString2, ajya.a(2131700437));
                }
              }
                ...
                if ((paramJsBridgeListener != null) && (paramJsBridgeListener.length() > 0))
                {
                  ...
                  if ((TextUtils.isEmpty(paramString3.apolloId)) || (TextUtils.isEmpty(paramString3.uin)))
                  {
                    ...
                    if (j != 0)
                    {
                      ...
                      callbackError(paramString2, ajya.a(2131700440));
                    }
                  }
                  else
                  {
                  ...
                  {
                    paramJsBridgeListener = ((ajin)paramVarArgs).a(paramString1);
                    super.callJs(paramString2 + "&&" + paramString2 + "(" + paramJsBridgeListener + ");");
                  }
                  else if (this.mApolloViewContoller != null)
                  {
                  ...
                  else
                  {
                    ...
                    callbackError(paramString2, ajya.a(2131700452));
                  }
                }
                else
                {
                  QLog.e("ApolloJsPlugin", 1, "addAvatar, param list null");
                  callbackError(paramString2, ajya.a(2131700460));
                }
              }
              else if ("destroyAvatar".equals(paramString3))
              {
                ...
                if ((paramJsBridgeListener == null) || (paramJsBridgeListener.length() == 0))
                {
                  callbackError(paramString2, ajya.a(2131700449));
                }
                else
                {
                  ...
                  if ((paramVarArgs instanceof ajin))
                  {
                    ((ajin)paramVarArgs).a(paramString1);
                    callbackOk(paramString2);
                  }
                  else if (this.mApolloViewContoller != null)
                  {
                  ...
                  else
                  {
                    ...
                    callbackError(paramString2, ajya.a(2131700444));
                  }
                }
              }
              else if ("getRoleId".equals(paramString3))
              {
                if (!this.mDataInited)
                {
                  ...
                  super.sendRemoteReq(anqu.a("ipc_apollo_get_apollo_data", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
                  return true;
                }
              ...
              else if ("getLocalInfo".equals(paramString3))
              {
                ...
                {
                  callbackError(paramString2, ajya.a(2131700430));
                  if (QLog.isColorLevel()) {
              ...
              else if ("preview".equals(paramString3))
              {
                ...
                if ((paramVarArgs instanceof ajin))
                {
                  ...
                  if ((paramJsBridgeListener != null) && (paramJsBridgeListener.length() > 0))
                  {
                    ...
                    else
                    {
                      ...
                      super.sendRemoteReq(anqu.a("ipc_apollo_preview", paramString2, this.mOnRemoteResp.key, this.mReqBundle), true, true);
                    }
                  }
                  else
                  {
                ...
                {
                  callbackError(paramString2, ajya.a(2131700445));
                }
              }
              else if (("previewOnFrame".equals(paramString3)) || ("previewAction".equals(paramString3)))
              {
                ...
                super.sendRemoteReq(anqu.a("ipc_apollo_preview_action", paramString2, this.mOnRemoteResp.key, this.mReqBundle), true, true);
              }
              else if ("setup".equals(paramString3))
              {
                ...
                if ((paramVarArgs instanceof ajin))
                {
                  ...
                  ((ajin)paramVarArgs).a(this.mRoleId, this.mDressIds);
                  callbackOk(paramString2);
                  this.mReqBundle.clear();
                  ...
                  super.sendRemoteReq(anqu.a("ipc_apollo_setup", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
                }
                else
                {
                  callbackError(paramString2, ajya.a(2131700426));
                }
              }
              else if ("changeRole".equals(paramString3))
              {
                ...
                if ((j > 0) && (paramJsBridgeListener != null) && (paramJsBridgeListener.length() > 0))
                {
                  ...
                  this.mReqBundle.putString("apollo_userData", paramJsBridgeListener);
                  super.sendRemoteReq(anqu.a("ipc_apollo_changerole", paramString2, this.mOnRemoteResp.key, this.mReqBundle), true, true);
                }
                else
                {
                  callbackError(paramString2, ajya.a(2131700433));
                }
              }
              else if ("closeWebview".equals(paramString3))
              {
                super.sendRemoteReq(anqu.a("ipc_kandian_hb_close_guid", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
                paramVarArgs.finish();
                if (!(paramVarArgs instanceof ajin)) {
              ...
              {
                this.mReqBundle.clear();
                super.sendRemoteReq(anqu.a("ipc_apollo_get_openapollo_friends", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
              }
              ...
              {
                this.mReqBundle.clear();
                super.sendRemoteReq(anqu.a("ipc_apollo_refresh_action", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
                if (QLog.isColorLevel()) {
              ...
              {
                this.mReqBundle.clear();
                super.sendRemoteReq(anqu.a("ipc_apollo_getfav_action", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
                if (QLog.isColorLevel()) {
              ...
              else if ("addCustomAction".equals(paramString3))
              {
                ...
                super.sendRemoteReq(anqu.a("ipc_apollo_add_fav_action", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
                if (QLog.isColorLevel()) {
              ...
              else if ("delLocalFavAction".equals(paramString3))
              {
                ...
                super.sendRemoteReq(anqu.a("ipc_apollo_del_fav_list", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
                if (QLog.isColorLevel()) {
              ...
              else if ("writeLocalData".equals(paramString3))
              {
                ...
                super.sendRemoteReq(anqu.a("ipc_apollo_write_local", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
                if (QLog.isColorLevel()) {
              ...
              else if ("redbagCallback".equals(paramString3))
              {
                ...
                if (i == 1)
                {
                  ...
                  super.sendRemoteReq(anqu.a("ipc_kandian_hb_lottery", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
                }
              }
              else if ("removeBubble".equals(paramString3))
              {
                ...
                super.sendRemoteReq(anqu.a("ipc_apollo_clear_bubble", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
              }
              else if ("downloadImageOnFrame".equals(paramString3))
              {
                ...
                this.mReqBundle.clear();
                this.mReqBundle.putInt("apollo_previewAction", i);
                super.sendRemoteReq(anqu.a("ipc_apollo_downloadImageOnFrame", paramString2, this.mOnRemoteResp.key, this.mReqBundle), true, true);
              }
              else if ("addGame".equals(paramString3))
              {
                this.mReqBundle.clear();
                this.mReqBundle.putString("gameListJson", ((JSONObject)localObject1).toString());
                super.sendRemoteReq(anqu.a("ipc_apollo_add_game", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
              }
              else if ("delGame".equals(paramString3))
              {
                this.mReqBundle.clear();
                this.mReqBundle.putString("gameListJson", ((JSONObject)localObject1).toString());
                super.sendRemoteReq(anqu.a("ipc_apollo_del_game", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
              }
              else if ("updateGameList".equals(paramString3))
              {
                ...
                this.mReqBundle.clear();
                this.mReqBundle.putString("gameListJson", ((JSONObject)localObject1).toString());
                super.sendRemoteReq(anqu.a("ipc_apollo_update_game_list", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
              }
              else if ("isCmFaceAdded".equals(paramString3))
              {
                ...
                if ((paramJsBridgeListener != null) && (paramJsBridgeListener.length() > 0))
                {
                  ...
                  super.sendRemoteReq(anqu.a("ipc_apollo_is_cm_face_added", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
                }
                else
                {
                  paramJsBridgeListener = new JSONObject();
                  paramJsBridgeListener.put("result", 1);
                  paramJsBridgeListener.put("msg", ajya.a(2131700422));
                  super.callJs(paramString2 + "&&" + paramString2 + "(" + paramJsBridgeListener.toString() + ");");
                }
              }
              else if ("addCmFace".equals(paramString3))
              {
                ...
                {
                  this.mReqBundle.putString("faceIdList", paramJsBridgeListener.toString());
                  super.sendRemoteReq(anqu.a("ipc_apollo_add_cm_face", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
                }
                else
                {
                  paramJsBridgeListener = new JSONObject();
                  paramJsBridgeListener.put("result", 1);
                  paramJsBridgeListener.put("msg", ajya.a(2131700439));
                  super.callJs(paramString2 + "&&" + paramString2 + "(" + paramJsBridgeListener.toString() + ");");
                }
              }
              ...
              else if ("setLeftViewIcon".equals(paramString3))
              {
                ...
                if (!TextUtils.isEmpty(paramString1))
                {
                  paramJsBridgeListener = (bcfx)access$101(this, 2);
                  if ((paramJsBridgeListener != null) && (paramJsBridgeListener.a != null) && (paramJsBridgeListener.a.a != null))
                  {
                    ...
                    paramString3.mLoadingDrawable = paramVarArgs.getResources().getDrawable(2130849547);
              ...
              {
                airx.a(((JSONObject)localObject1).optInt("gameId"), ((JSONObject)localObject1).optString("extraInfo"), this.mRuntime.a());
              }
              ...
              else if ("openCmGameMatch".equals(paramString3))
              {
                ...
                super.sendRemoteReq(anqu.a("ipc_open_cm_game_match_page", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
              }
              else if ("isTcpConnected".equals(paramString3))
              {
                this.mReqBundle.clear();
                super.sendRemoteReq(anqu.a("ipc_cm_game_conn_connected", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
              }
              else if ("checkCmGameWebView".equals(paramString3))
              {
                if ((paramVarArgs instanceof QQBrowserActivity))
                {
                  ...
                  if ((!(paramJsBridgeListener instanceof CmGameFragment)) && (!TextUtils.isEmpty(paramString1)))
                  {
                    ...
                    callbackOk(paramString2);
                    paramVarArgs.finish();
                    ajac.a(paramVarArgs, paramString1);
                  }
                  else
                  {
              ...
              else if ("sendGameAppArkMessage".equals(paramString3))
              {
                ...
                if ((!TextUtils.isEmpty(paramJsBridgeListener)) && (paramString1 != null))
                {
                  ...
                  super.sendRemoteReq(anqu.a("ipc_open_cm_game_send_game_app_ark_msg", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
                }
                else
                {
              ...
              else
              {
                ...
                if ((!TextUtils.isEmpty(paramVarArgs)) && (!TextUtils.isEmpty(paramJsBridgeListener)) && (!TextUtils.isEmpty(paramString1)) && (!TextUtils.isEmpty(paramString3)))
                {
                  ...
                  super.sendRemoteReq(anqu.a("ipc_save_game_to_plus", paramString2, this.mOnRemoteResp.key, this.mReqBundle), false, true);
                }
                else
                {
                  callbackError(paramString2, "param error");
  ...
  protected void onResponse(Bundle paramBundle)
  {
    ...
    if ((paramBundle != null) && (paramBundle.getInt("respkey", 0) == this.mOnRemoteResp.key))
    {
      ...
      if ((localObject3 != null) && (localObject2 != null))
      {
        ...
        callbackError(str, ajya.a(2131700418));
      }
    }
    return;
    label101:
    ...
    do
    {
        ...
        do
        {
          for (;;)
          {
            ...
            catch (Throwable paramBundle)
            {
              ...
              callbackError(str, ajya.a(2131700423));
              return;
            }
            callbackError(str, i + "");
            return;
            ...
            if ("ipc_apollo_preview".equals(localObject3))
            {
              ...
              {
                callbackError(str, ajya.a(2131700424));
                return;
              }
              if (this.mApolloViewContoller != null)
              {
              ...
              else if ((localObject1 instanceof ajin))
              {
                paramBundle = ((ajin)localObject1).a(paramBundle);
                super.callJs(str + "&&" + str + "(" + paramBundle + ");");
                if (QLog.isColorLevel()) {
                  QLog.e("ApolloJsPlugin", 2, "callbackId->" + str + " callbackOk" + paramBundle);
                }
              ...
              {
                callbackError(str, ajya.a(2131700435));
              }
            }
            else
            {
              ...
              if (("ipc_apollo_preview_action".equals(localObject3)) || ("ipc_apollo_preview_audio_action".equals(localObject3)))
              {
                ...
                localObject2 = new ajik();
                ((ajik)localObject2).jdField_a_of_type_Int = i5;
                ((ajik)localObject2).jdField_b_of_type_Int = i;
                ((ajik)localObject2).jdField_c_of_type_Int = m;
                ((ajik)localObject2).jdField_d_of_type_Int = n;
                ((ajik)localObject2).e = i1;
                ((ajik)localObject2).f = j;
                ((ajik)localObject2).g = k;
                ((ajik)localObject2).h = i2;
                ((ajik)localObject2).i = i9;
                ((ajik)localObject2).j = i3;
                ((ajik)localObject2).k = i4;
                ((ajik)localObject2).jdField_a_of_type_JavaLangString = ((String)localObject6);
                ((ajik)localObject2).l = i6;
                ((ajik)localObject2).m = i7;
                ((ajik)localObject2).jdField_a_of_type_Float = f1;
                ((ajik)localObject2).jdField_b_of_type_Float = f2;
                ((ajik)localObject2).jdField_a_of_type_Boolean = bool1;
                ((ajik)localObject2).jdField_c_of_type_JavaLangString = paramBundle;
                ((ajik)localObject2).jdField_d_of_type_JavaLangString = ((String)localObject4);
                ((ajik)localObject2).jdField_b_of_type_JavaLangString = ((String)localObject7);
                ((ajik)localObject2).jdField_b_of_type_Boolean = bool2;
                if ((i8 == 0) && (i > 0))
                {
                  if ("ipc_apollo_preview_audio_action".equals(localObject3))
                  {
                    paramBundle = ajig.a("ApolloViewController is null or Activity not instanceof IApolloActivityJsCallBack");
                    if (this.mApolloViewContoller != null)
                    {
                      paramBundle = this.mApolloViewContoller.a((ajik)localObject2);
                      super.callJs(str + "&&" + str + "(" + paramBundle + ");");
                    }
                    while (QLog.isColorLevel())
                    {
                      ...
                      return;
                      if ((localObject1 instanceof ajin))
                      {
                        paramBundle = ((ajin)localObject1).a((ajik)localObject2);
                        super.callJs(str + "&&" + str + "(" + paramBundle + ");");
                      }
                    }
                  }
                  ...
                  {
                    localObject3 = new File(ajhu.b(i7));
                    if ((i7 > 0) && (!((File)localObject3).exists()))
                    {
                      ...
                      super.sendRemoteReq(anqu.a("ipc_apollo_preview_audio_action", str, this.mOnRemoteResp.key, this.mReqBundle), true, true);
                      return;
                    }
                    paramBundle = ajig.a("ApolloViewController is null or Activity not instanceof IApolloActivityJsCallBack");
                    if ((localObject1 instanceof ajin))
                    ...
                    while (QLog.isColorLevel())
                    {
                      ...
                      {
                        callbackError(str, ajya.a(2131700453));
                      }
                    }
                  }
                }
                else {
                  callbackError(str, ajya.a(2131700450) + (String)localObject3);
                }
              }
              else if ("ipc_apollo_check_avatar_res".equals(localObject3))
              {
                ...
                if (i == 0)
                {
                  ...
                  {
                    callbackError(str, ajya.a(2131700429));
                    return;
                  }
                    ...
                    if (this.mValidAvatarIdList.contains(((ApolloWebAvatarParam)localObject2).apolloId))
                    {
                      ...
                      for (;;)
                      {
                        ...
                        if (j == 0)
                        {
                          ...
                          paramBundle = ((ajin)localObject1).a(this.mApolloStatus, (ApolloWebAvatarParam)localObject2);
                        }
                      }
                    }
                  ...
                  if (paramBundle != null)
                  {
                    ajhu.a(paramBundle, ((ApolloWebAvatarParam)localObject2).uin, new ApolloJsPlugin.4(this, (ApolloWebAvatarParam)localObject2, (Activity)localObject1, j, str), ((ApolloWebAvatarParam)localObject2).roleId, ((ApolloWebAvatarParam)localObject2).dressIds, -1, -1, false);
                    return;
                  }
                    ...
                    while (((Iterator)localObject4).hasNext())
                    {
                      ...
                      if (((ApolloWebAvatarParam)localObject5).isResExist)
                      {
                        ...
                        if (this.mValidAvatarIdList.contains(((ApolloWebAvatarParam)localObject5).apolloId))
                        {
                          ...
                          ((ajin)localObject1).a((ArrayList)localObject6);
                        }
                        for (;;)
                        {
                      ...
                      if (paramBundle != null)
                      {
                        ajhu.a(paramBundle, ((ApolloWebAvatarParam)localObject5).uin, new ApolloJsPlugin.5(this, (ApolloWebAvatarParam)localObject5, (Activity)localObject1, (AtomicInteger)localObject2, (ArrayList)localObject3, str), ((ApolloWebAvatarParam)localObject5).roleId, ((ApolloWebAvatarParam)localObject5).dressIds, -1, -1, false);
                      }
                      else
                      {
                ...
                {
                  if (j != 2) {
                    bcql.a((Context)localObject1, ajya.a(2131700417), 1).a();
                  }
                  callbackError(str, ajya.a(2131700427));
                  if (QLog.isColorLevel()) {
              ...
              else
              {
                if ("ipc_apollo_changerole".equals(localObject3))
                {
                  ...
                  callbackError(str, ajya.a(2131700413));
                  return;
                }
                if ("ipc_apollo_get_apollo_data".equals(localObject3))
                {
                  ...
                  for (;;)
                  {
                    if (3 == i)
                    {
                      if ((this.mDressIds == null) || (this.mDressIds.length <= 0))
                      {
                        callbackError(str, ajya.a(2131700455));
                        if (!QLog.isColorLevel()) {
                          break;
                        }
                        QLog.d("ApolloJsPlugin", 2, "dressIds.array->默认角色或获取本人信息失败");
                  ...
                  if (2 == i)
                  {
                    if (this.mRoleId <= 0)
                    {
                      callbackError(str, ajya.a(2131700434));
                      return;
                    }
                    paramBundle = new JSONObject();
                    paramBundle.put("result", 0);
                ...
                else
                {
                  ...
                  while (QLog.isColorLevel())
                  {
                    ...
                    return;
                    if (i == 1) {
                      callbackError(str, ajya.a(2131700432));
                    } else if (i == 2) {
                      callbackError(str, ajya.a(2131700441));
                    } else {
                      callbackError(str, ajya.a(2131700428));
                    }
                  }
                }
              }
      ...
      } while (!(localObject1 instanceof ajin));
      ((ajin)localObject1).b(str);
      return;
    ...
    if ("ipc_apollo_start_apollo_game".equals(localObject3))
    {
      ...
      callbackError(str, ajya.a(2131700446));
      return;
    }
    if ("ipc_apollo_choose_friend_play_game".equals(localObject3))
    {
      ...
      {
        this.gameDialog = bbdj.a((Context)localObject1, 0, "", ajya.a(2131700416), 2131690596, 2131694794, new ApolloJsPlugin.6(this, i, j, (Activity)localObject1), new ApolloJsPlugin.7(this));
      ...
      paramBundle = new ajrd();
      paramBundle.jdField_a_of_type_Int = i;
      ajnc.a(paramBundle, this.mRuntime.a(), 2);
      return;
    }
    if ("IPC_APOLLO_DOWNLOAD_GAME".equals(localObject3))
    {
      ...
      if (paramBundle == null)
      {
        callbackError(str, ajya.a(2131700457));
        return;
      }
      localObject2 = ajac.a();
