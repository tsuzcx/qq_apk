  ...
  implements akwk, bccc
{
    ...
    if (("EquipLockManager".equalsIgnoreCase(paramString2)) || ("SetPwdJsInterface".equalsIgnoreCase(paramString2)) || ("CAPTCHA".equalsIgnoreCase(paramString2)))
    {
      ...
      if ("openDevLock".equals(paramString3))
      {
        ...
        try
        {
          ...
          localJSONObject.put("image_res_id", 2130844268);
  ...
  {
    paramString1 = bbbr.c(paramString1, paramString2);
  ...
  void onBindedToClient()
  {
    ...
    do
    {
      ...
      if ((0x8000 & l) != 0L)
      {
        ...
        sendRemoteReq(anqu.a("getA2", "", this.mOnRemoteResp.key, localBundle), true, false);
        hideProgressDialog();
        return;
      }
    } while ((0x200000 & l) == 0L);
    sendRemoteReq(anqu.a("puzzle_verify_code_clearProgressDialog", "", this.mOnRemoteResp.key, new Bundle()), true, false);
  }
  ...
  public void onLoadIsSetPsw(String paramString)
  {
    ...
    if ((paramString != null) && (paramString.equals("1"))) {
      sendRemoteReq(anqu.a("setHasSetPwd", "", this.mOnRemoteResp.key, new Bundle()), true, false);
    }
  }
  ...
  public void onResponse(Bundle paramBundle)
  {
    ...
    do
    {
      do
      {
        ...
        return;
        localObject2 = nau.b((String)localObject1);
      ...
      if (((String)localObject1).equalsIgnoreCase("openDevLock"))
      {
        ...
        try
        {
          ...
          ((JSONObject)localObject2).put("sigDA2", bbea.a((byte[])localObject1));
          if (QLog.isColorLevel()) {
  ...
  public void onVerifyCAPTCHA(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          bool1 = true;
          String str = paramString.getString("ticket");
          paramString = null;
          if (this.activity == null) {
            break label255;
          }
          ...
          boolean bool3 = ((Intent)localObject).getBooleanExtra("is_register_uin", false);
          bool2 = bool3;
          if (bool3)
          {
            i = ((Intent)localObject).getIntExtra("register_uin_msg", 0);
            paramString = ((Intent)localObject).getStringExtra("register_uin_class");
            bool2 = bool3;
          }
          localObject = new Bundle();
          ((Bundle)localObject).putInt("seq", this.mSeq);
          ((Bundle)localObject).putBoolean("result", bool1);
          ((Bundle)localObject).putString("ticket", str);
          ((Bundle)localObject).putBoolean("is_register_uin", bool2);
          if (bool2)
          {
            ((Bundle)localObject).putInt("register_uin_msg", i);
            ((Bundle)localObject).putString("register_uin_class", paramString);
          }
          sendRemoteReq(anqu.a("puzzle_verify_code_setTicket", "", this.mOnRemoteResp.key, (Bundle)localObject), true, false);
          if (this.activity != null) {
            this.activity.finish();
          }
          return;
  ...
  public void onWebViewCreated(CustomWebView paramCustomWebView)
  {
    ...
    while ((l & 0x200000) == 0L) {
      try
      {
        this.smsContent = new akwm(null);
        this.smsContent.a(this.activity, this);
        paramCustomWebView = (TextView)this.activity.findViewById(2131368429);
  ...
  public void openDevLock(boolean paramBoolean, String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      ...
      sendRemoteReq(anqu.a("openDevLock", paramString3, this.mOnRemoteResp.key, localBundle), true, false);
      return;
  ...
  public void openEquipmentLock(String paramString1, String paramString2, String paramString3)
  {
    ...
    sendRemoteReq(anqu.a("openEquipmentLock", "", this.mOnRemoteResp.key, paramString3), true, false);
  }
  ...
  {
    sendRemoteReq(anqu.a("queryDevLockStatus", "", this.mOnRemoteResp.key, null), true, false);
  }
