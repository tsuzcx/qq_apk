  ...
  extends VasWebviewJsPlugin
{
  ...
  protected boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    if (QLog.isColorLevel())
    {
      ...
      QLog.d("Plugin Preloader", 2, paramJsBridgeListener.toString());
    }
    if (("ppreloader".equals(paramString2)) && (paramString1 != null))
    {
  ...
  protected void onResponse(Bundle paramBundle)
  {
    ...
    if (paramBundle.getInt("respkey", 0) == this.mOnRemoteResp.key)
    {
      ...
      if ("ipc_preload_plugin_process".equals(localObject))
      {
        int i = paramBundle.getInt("code", -1);
        localObject = paramBundle.getString("message");
