      ...
      try
      {
        ...
        if (i != -1)
        {
          ...
          if (("qqpublic.qpic.cn".equalsIgnoreCase(paramString)) && (!TextUtils.isEmpty((CharSequence)localObject)) && (((String)localObject).startsWith("/qq_public")))
          {
            ...
            if (QLog.isColorLevel()) {
              QLog.i("PublicAccountWebReport", 2, "urlStr: " + str3 + ",errorcode:" + m + ",netType:" + n + ",DNSCost" + i + ",connectCost:" + j + ",receiveCost:" + k + ",website_address:" + (String)localObject + ",AppSetting.subVersion:" + "7.6.0,3,3525");
            }
          }
          if (!str2.equalsIgnoreCase(str1)) {
            break;
    ...
    for (paramMap = (Integer)paramMap;; paramMap = Integer.valueOf(0))
    {
      ...
      if (paramLong == 8589934594L)
      {
        ...
        for (;;)
        {
          ...
          ReportController.a(null, "P_CliOper", "vasweb", "", "load", "finish", 0, 1, "errocode:" + this.errorMap.get(paramString), paramMap, Util.b(paramString, new String[0]), "7.6.0--android--" + Build.VERSION.SDK_INT);
        ...
        {
          ReportController.a(null, "P_CliOper", "vasweb", "", "load", "finish", 0, 0, "" + paramLong, paramMap, Util.b(paramString, new String[0]), "7.6.0--android--" + Build.VERSION.SDK_INT);
          break;
          if (QLog.isColorLevel()) {
