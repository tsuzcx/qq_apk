    ...
    for (;;)
    {
      ...
      try
      {
        ...
        else if ("setFunCallMedia".equals(paramString3))
        {
          ...
          localBundle.putInt("ringId", j);
          localBundle.putInt("feeType", k);
          sendRemoteReq(anqu.a("funcall_set", str, this.mOnRemoteResp.key, localBundle), false, false);
        }
      }
      catch (JSONException paramJsBridgeListener)
      {
        ...
        if ("downloadFunCallMedia".equals(paramString3))
        {
          ...
          paramString3 = bbzh.a(null, i, bbzh.a(), paramJsBridgeListener);
          ...
          if (TextUtils.isEmpty(paramString3))
          {
            ...
            ((JSONObject)localObject1).put("code", bbzh.a);
            ((JSONObject)localObject1).put("errorMessage", "no mediaUrl , fcPath=null");
            callJs(str, new String[] { ((JSONObject)localObject1).toString() });
            return true;
          }
          paramJsBridgeListener = bbzh.a(null, i, 9, paramString2);
          ...
          if (!bbbr.a())
          {
            ...
            ((JSONObject)localObject1).put("code", bbzh.c);
          ...
          if (l < 1048576)
          {
            ...
            ((JSONObject)localObject1).put("code", bbzh.b);
            ((JSONObject)localObject1).put("errorMessage", "SDCard is full");
            callJs(str, new String[] { ((JSONObject)localObject1).toString() });
            return true;
          }
          sendRemoteReq(anqu.a("funcall_download", str, this.mOnRemoteResp.key, localBundle), false, false);
      ...
      if ("queryDownloadInfo".equals(paramString3))
      {
        ...
        {
          localObject3 = bbzh.a(null, i, bbzh.a(), paramJsBridgeListener);
        ...
        {
          paramJsBridgeListener = bbpb.a(j, 3);
      ...
      if ("delFunCallGroup".equals(paramString3))
      {
        ...
        sendRemoteReq(anqu.a("funcall_delete", str, this.mOnRemoteResp.key, localBundle), false, false);
      }
      else
      {
