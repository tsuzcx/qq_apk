    ...
    for (;;)
    {
      ...
      synchronized (this.this$0.mJDUpdateConfig)
      {
        ...
        if (!bool) {
          try
          {
            Object localObject1 = new File(this.this$0.mRuntime.a().getApplicationContext().getFilesDir(), ClubContentJsonTask.c.a);
      ...
      catch (Exception localException3)
      {
        try
        {
          ((StringBuilder)localObject2).append("jd").append("|").append(URLEncoder.encode(this.val$url, "UTF-8")).append("|").append(???).append("|").append("android").append("|").append("8.5.5").append("|").append("|").append("|").append("|").append("|").append("|").append("|");
        ...
        catch (Exception localException3)
        {
          try
          {
            for (;;)
            {
              ...
              ((StringBuilder)localObject2).append("jiankang").append("|").append((String)localObject5).append("|").append(???).append("|").append("android").append("|").append("8.5.5").append("|").append("|").append("|").append("|").append("|").append("|").append("|");
              DcReportUtil.a(null, "dc00454", ((StringBuilder)localObject2).toString(), false);
              return;
