  ...
  extends VasWebviewJsPlugin
{
  ...
  public static FilenameFilter mHiBoomFontFilter = new ChatFontJsPlugin.5();
  ...
  void diyPreview(String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3, int paramInt3)
  {
    ...
    ETEngine.getInstance().native_diyFontDeleteNativeConfig(localETFont.mDiyHandle);
  }
  ...
  void getFontPreview(String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3, int paramInt3, String paramString4)
  {
    ...
    //   183: iload_2
    //   184: iload_3
    //   185: invokestatic 140	com/etrump/mixlayout/FontManager:a	(II)Z
    //   188: ifne +44 -> 232
    ...
    //   265: iload_2
    //   266: iload_3
    //   267: invokestatic 159	com/etrump/mixlayout/FontManager:a	(II)Ljava/lang/String;
    //   270: iload_2
    //   271: iconst_0
    ...
    //   281: iload_2
    //   282: iload_3
    //   283: invokestatic 159	com/etrump/mixlayout/FontManager:a	(II)Ljava/lang/String;
    //   286: iload 9
    //   288: i2f
    ...
    //   513: iconst_2
    //   514: invokestatic 437	com/tencent/mobileqq/utils/Base64Util:encodeToString	([BI)Ljava/lang/String;
    //   517: astore 4
    ...
    //   655: aload 7
    //   657: getfield 456	com/etrump/mixlayout/ETFont:mDiyHandle	J
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      paramJsBridgeListener.put("message", HardCodeUtil.a(2131701659));
            ...
            if ("showBlackMsgBox".equals(paramString3))
            {
              ...
              try
              {
                ...
                if ((paramString3 != null) && ((paramString3 instanceof WebUiUtils.WebTitleBarInterface))) {
                  QQToast.a(this.mRuntime.a(), paramString2, 0).b(((WebUiUtils.WebTitleBarInterface)paramString3).getTitleBarHeight());
                }
              }
  ...
  {
    int j = -1;
    int k = VasSoUtils.a(VasSoUtils.a(), "libvipfont8417.so");
    if (QLog.isColorLevel()) {
  ...
  public void isUseFont(String paramString)
  {
    ...
    for (bool1 = true;; bool1 = false)
    {
      ...
      QQCustomDialog localQQCustomDialog = DialogUtil.a(this.mRuntime.a(), 230).setTitle(this.mRuntime.a().getString(2131719906)).setMessage(this.mRuntime.a().getString(2131694963)).setPositiveButton(this.mRuntime.a().getString(2131694964), new ChatFontJsPlugin.3(this, localJSONObject, paramString)).setNegativeButton(this.mRuntime.a().getString(2131694961), new ChatFontJsPlugin.2(this, localJSONObject, paramString));
