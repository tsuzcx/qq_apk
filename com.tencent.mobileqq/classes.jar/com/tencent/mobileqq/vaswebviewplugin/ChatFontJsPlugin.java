  ...
  extends VasWebviewJsPlugin
{
  ...
  public static FilenameFilter mHiBoomFontFilter = new bbup();
  ...
  private void checkDiyFontText(int paramInt1, int paramInt2, String paramString1, String paramString2)
  {
    ...
    ETFont localETFont = new ETFont(paramInt1, ho.a(paramInt1, paramInt2), 16.0F);
  ...
  private void getDiyFontInfo(int paramInt1, int paramInt2, String paramString)
  {
    ...
    for (;;)
    {
      ...
      Object localObject1 = new ETFont(paramInt1, ho.a(paramInt1, paramInt2), 16.0F);
  ...
  {
    Object localObject = new File(aqwz.b);
  ...
  private void setFontSwitch(JSONObject paramJSONObject, String paramString)
  {
    ...
    try
    {
      ...
      super.sendRemoteReq(anqp.a("setFontSwtich", paramString, this.mOnRemoteResp.key, this.mReqBundle), false, true);
      return;
    }
  ...
  void diyPreview(String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3, int paramInt3)
  {
    ...
    if (!ETEngine.getInstance().native_isFontLoaded(paramInt1)) {
      ETEngine.getInstance().native_loadFont(ho.a(paramInt1, paramInt2), paramInt1, false);
    }
    ETFont localETFont = new ETFont(paramInt1, ho.a(paramInt1, paramInt2), paramInt3 * 2);
    if (!ETEngine.getInstance().native_diyFontIsDIYFont(localETFont))
    {
      if (QLog.isColorLevel()) {
        QLog.d("ChatFontJsPlugin", 2, "checkDiyFontText fail font is not diy font id = " + paramInt1);
    ...
    try
    {
      ...
      paramString2 = bbca.encodeToString(paramString2.toByteArray(), 2);
  ...
  void getFontPreview(String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3, int paramInt3, String paramString4)
  {
    ...
    //   183: iload_2
    //   184: iload_3
    //   185: invokestatic 140	ho:a	(II)Z
    //   188: ifne +44 -> 232
    ...
    //   265: iload_2
    //   266: iload_3
    //   267: invokestatic 159	ho:a	(II)Ljava/lang/String;
    //   270: iload_2
    //   271: iconst_0
    ...
    //   281: iload_2
    //   282: iload_3
    //   283: invokestatic 159	ho:a	(II)Ljava/lang/String;
    //   286: iload 9
    //   288: i2f
    ...
    //   513: iconst_2
    //   514: invokestatic 437	bbca:encodeToString	([BI)Ljava/lang/String;
    //   517: astore 4
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      paramJsBridgeListener.put("message", ajyc.a(2131701575));
      ...
      for (;;)
      {
        ...
        super.sendRemoteReq(anqp.a(paramJsBridgeListener, paramString1, this.mOnRemoteResp.key, this.mReqBundle), false, true);
        return true;
          ...
          else
          {
            if ("showBlackMsgBox".equals(paramString3))
            {
              ...
              try
              {
                ...
                if ((paramString3 != null) && ((paramString3 instanceof bchu))) {
                  bcpw.a(this.mRuntime.a(), paramString2, 0).b(((bchu)paramString3).b());
                }
              }
      ...
      if ("fontBubblePaySuccess".equals(paramString3))
      {
        ...
        super.sendRemoteReq(anqp.a("fontBubblePaySuccess", paramString1, this.mOnRemoteResp.key, this.mReqBundle), false, true);
        return true;
      }
      if (QLog.isColorLevel()) {
  ...
  {
    int j = -1;
    int k = bbkv.a(bbkv.a(), "libvipfont808.so");
    if (QLog.isColorLevel()) {
  ...
  public void isUseFont(String paramString)
  {
    ...
    for (bool1 = true;; bool1 = false)
    {
      ...
      bbgg localbbgg = bbcv.a(this.mRuntime.a(), 230).setTitle(this.mRuntime.a().getString(2131720266)).setMessage(this.mRuntime.a().getString(2131695247)).setPositiveButton(this.mRuntime.a().getString(2131695248), new ChatFontJsPlugin.3(this, localJSONObject, paramString)).setNegativeButton(this.mRuntime.a().getString(2131695243), new ChatFontJsPlugin.2(this, localJSONObject, paramString));
      localbbgg.show();
      localbbgg.setOnCancelListener(new ChatFontJsPlugin.4(this, localJSONObject, paramString));
      return;
    }
    try
    {
  ...
  public void queryLocal(JSONObject paramJSONObject, String paramString)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        paramJSONObject = new File(ho.a);
        localObject = new JSONArray();
        searchFontInDir(paramJSONObject, (JSONArray)localObject);
        searchFontInDir(new File(ho.b), (JSONArray)localObject);
  ...
  public void setSize(JSONObject paramJSONObject, String paramString)
  {
    ...
    try
    {
      ...
      axqw.a(null, "CliOper", "", "", "Font_Mall", "change_" + paramJSONObject, 0, 0, "", "", "", "");
      int i;
  ...
  void startDownloadFont(int paramInt1, int paramInt2, String paramString, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        super.sendRemoteReq(anqp.a("font_startDownLoad", paramString, this.mOnRemoteResp.key, this.mReqBundle), false, true);
        return;
        if (aqwz.a(paramInt1)) {
          localJSONObject = new JSONObject();
        }
        try
        {
          ...
          return;
          this.mReqBundle.putInt("id", paramInt1);
          super.sendRemoteReq(anqp.a("ipc_download_hiboom", paramString, this.mOnRemoteResp.key, this.mReqBundle), false, true);
          return;
        }
  ...
  void tryInitHYEngine(String paramString)
  {
    ...
    for (;;)
    {
      ...
      return;
      super.sendRemoteReq(anqp.a("ipc_font_download_hy_so", paramString, this.mOnRemoteResp.key, this.mReqBundle), false, true);
      return;
      ETEngine.isSOLoaded.set(true);
      try
      {
