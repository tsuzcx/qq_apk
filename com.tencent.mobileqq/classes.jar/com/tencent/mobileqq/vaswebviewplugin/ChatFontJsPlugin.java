  ...
  extends VasWebviewJsPlugin
{
  ...
  public static FilenameFilter mHiBoomFontFilter = new bgna();
  ...
  private void checkDiyFontText(int paramInt1, int paramInt2, String paramString1, String paramString2)
  {
    ...
    ETFont localETFont = new ETFont(paramInt1, gb.a(paramInt1, paramInt2), 16.0F);
  ...
  private void getDiyFontInfo(int paramInt1, int paramInt2, String paramString)
  {
    ...
    for (;;)
    {
      ...
      Object localObject1 = new ETFont(paramInt1, gb.a(paramInt1, paramInt2), 16.0F);
  ...
  {
    Object localObject = new File(auef.b);
  ...
  private void setFontSwitch(JSONObject paramJSONObject, String paramString)
  {
    ...
    try
    {
      ...
      super.sendRemoteReq(aqyt.a("setFontSwtich", paramString, this.mOnRemoteResp.key, this.mReqBundle), false, true);
      return;
    }
  ...
  void diyPreview(String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3, int paramInt3)
  {
    ...
    if (!ETEngine.getInstance().native_isFontLoaded(paramInt1)) {
      ETEngine.getInstance().native_loadFont(gb.a(paramInt1, paramInt2), paramInt1, false);
    }
    ETFont localETFont = new ETFont(paramInt1, gb.a(paramInt1, paramInt2), paramInt3 * 2);
    if (!ETEngine.getInstance().native_diyFontIsDIYFont(localETFont))
    {
      if (QLog.isColorLevel()) {
        QLog.d("ChatFontJsPlugin", 2, "checkDiyFontText fail font is not diy font id = " + paramInt1);
    ...
    try
    {
      ...
      paramString2 = bfuc.encodeToString(paramString2.toByteArray(), 2);
  ...
  void getFontPreview(String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3, int paramInt3, String paramString4)
  {
    ...
    //   183: iload_2
    //   184: iload_3
    //   185: invokestatic 140	gb:a	(II)Z
    //   188: ifne +44 -> 232
    ...
    //   265: iload_2
    //   266: iload_3
    //   267: invokestatic 159	gb:a	(II)Ljava/lang/String;
    //   270: iload_2
    //   271: iconst_0
    ...
    //   281: iload_2
    //   282: iload_3
    //   283: invokestatic 159	gb:a	(II)Ljava/lang/String;
    //   286: iload 9
    //   288: i2f
    ...
    //   513: iconst_2
    //   514: invokestatic 437	bfuc:encodeToString	([BI)Ljava/lang/String;
    //   517: astore 4
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      paramJsBridgeListener.put("message", amtj.a(2131700733));
      ...
      for (;;)
      {
        ...
        super.sendRemoteReq(aqyt.a(paramJsBridgeListener, paramString1, this.mOnRemoteResp.key, this.mReqBundle), false, true);
        return true;
          ...
          else
          {
            if ("showBlackMsgBox".equals(paramString3))
            {
              ...
              try
              {
                ...
                if ((paramString3 != null) && ((paramString3 instanceof bgzt))) {
                  QQToast.a(this.mRuntime.a(), paramString2, 0).b(((bgzt)paramString3).getTitleBarHeight());
                }
              }
      ...
      if ("fontBubblePaySuccess".equals(paramString3))
      {
        ...
        super.sendRemoteReq(aqyt.a("fontBubblePaySuccess", paramString1, this.mOnRemoteResp.key, this.mReqBundle), false, true);
        return true;
      }
      if (QLog.isColorLevel()) {
  ...
  {
    int j = -1;
    int k = bgae.a(bgae.a(), "libvipfont808.so");
    if (QLog.isColorLevel()) {
  ...
  public void isUseFont(String paramString)
  {
    ...
    for (bool1 = true;; bool1 = false)
    {
      ...
      QQCustomDialog localQQCustomDialog = bfur.a(this.mRuntime.a(), 230).setTitle(this.mRuntime.a().getString(2131718952)).setMessage(this.mRuntime.a().getString(2131694524)).setPositiveButton(this.mRuntime.a().getString(2131694525), new ChatFontJsPlugin.3(this, localJSONObject, paramString)).setNegativeButton(this.mRuntime.a().getString(2131694522), new ChatFontJsPlugin.2(this, localJSONObject, paramString));
  ...
  public void queryLocal(JSONObject paramJSONObject, String paramString)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        paramJSONObject = new File(gb.a);
        localObject = new JSONArray();
        searchFontInDir(paramJSONObject, (JSONArray)localObject);
        searchFontInDir(new File(gb.b), (JSONArray)localObject);
  ...
  public void setSize(JSONObject paramJSONObject, String paramString)
  {
    ...
    try
    {
      ...
      bcef.a(null, "CliOper", "", "", "Font_Mall", "change_" + paramJSONObject, 0, 0, "", "", "", "");
      int i;
  ...
  void startDownloadFont(int paramInt1, int paramInt2, String paramString, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        super.sendRemoteReq(aqyt.a("font_startDownLoad", paramString, this.mOnRemoteResp.key, this.mReqBundle), false, true);
        return;
        if (auef.a(paramInt1)) {
          localJSONObject = new JSONObject();
        }
        try
        {
          ...
          return;
          this.mReqBundle.putInt("id", paramInt1);
          super.sendRemoteReq(aqyt.a("ipc_download_hiboom", paramString, this.mOnRemoteResp.key, this.mReqBundle), false, true);
          return;
        }
  ...
  void tryInitHYEngine(String paramString)
  {
    ...
    for (;;)
    {
      ...
      return;
      super.sendRemoteReq(aqyt.a("ipc_font_download_hy_so", paramString, this.mOnRemoteResp.key, this.mReqBundle), false, true);
      return;
      ETEngine.isSOLoaded.set(true);
      try
      {
