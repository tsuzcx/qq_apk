  ...
  extends VasWebviewJsPlugin
{
  ...
  private aejx mReminderDataManager;
  ...
  private void deleteNotify(JSONObject paramJSONObject)
  {
    ...
    if ((bdje.a(str)) || (bdje.a(str)))
    {
      handJsError("4", "params error");
      return;
    }
    aejw.a(str, new QWalletMixJsPlugin.1(this, new Handler(Looper.getMainLooper()), paramJSONObject, str));
  }
  ...
  private void notifydelMsgUI(String paramString1, String paramString2)
  {
    ...
    paramString1 = apic.a("ipc_cmd_is_qq_notify_all_notify", this.mCallback, this.mOnRemoteResp.key, localBundle);
  ...
  public void onCreate()
  {
    ...
    if (this.mRuntime != null)
    {
      ...
      if (localActivity != null)
      {
        ...
        this.mReminderDataManager = new aejx(this.app);
        aejw.a(this.app);
