...
public class MusicPlayerActivity$1$1$1
  implements Runnable
{
  public MusicPlayerActivity$1$1$1(awyz paramawyz, int paramInt) {}
  
  public void run()
  {
    Object localObject = awys.a(this.jdField_a_of_type_Awyz.jdField_a_of_type_Awzh.c);
    if (localObject != null)
    {
      ...
      if (i * j > 8000)
      {
        ...
        localObject = Message.obtain(MusicPlayerActivity.a(this.jdField_a_of_type_Awyz.jdField_a_of_type_Awyy.a), 55);
