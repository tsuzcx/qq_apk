...
public class BitmapAlgorithms
{
  ...
  public static Bitmap b(Bitmap paramBitmap, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    //   14: areturn
    //   15: aload_0
    //   16: invokevirtual 23	android/graphics/Bitmap:getWidth	()I
    //   19: istore 5
    //   21: aload_0
    //   22: invokevirtual 27	android/graphics/Bitmap:getHeight	()I
    //   25: istore 6
    //   27: iload 5
    //   29: iload 6
    //   31: imul
    ...
    //   45: iload 5
    //   47: iload 6
    //   49: getstatic 61	android/graphics/Bitmap$Config:ARGB_8888	Landroid/graphics/Bitmap$Config;
    //   52: invokestatic 64	android/graphics/Bitmap:createBitmap	(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    //   55: astore 7
    //   57: aload_0
    //   58: aload 11
    //   60: iconst_0
    ...
    //   65: iload 5
    //   67: iload 6
    //   69: invokevirtual 68	android/graphics/Bitmap:getPixels	([IIIIIII)V
    //   72: iconst_0
    //   73: istore 4
    //   75: iload 4
    //   77: iload_1
    ...
    //   89: iload_2
    //   90: i2f
    //   91: invokestatic 70	com/tencent/mobileqq/musicgene/BitmapAlgorithms:b	([I[IIIF)V
    //   94: aload 12
    //   96: aload 11
    //   98: iload 6
    //   100: iload 5
    //   102: iload_3
    //   103: i2f
    //   104: invokestatic 70	com/tencent/mobileqq/musicgene/BitmapAlgorithms:b	([I[IIIF)V
    //   107: iload 4
    //   109: iconst_1
    //   110: iadd
    //   111: istore 4
    ...
    //   124: iload_2
    //   125: i2f
    //   126: invokestatic 72	com/tencent/mobileqq/musicgene/BitmapAlgorithms:a	([I[IIIF)V
    //   129: aload 12
    //   131: aload 11
    //   133: iload 6
    //   135: iload 5
    //   137: iload_3
    //   138: i2f
    //   139: invokestatic 72	com/tencent/mobileqq/musicgene/BitmapAlgorithms:a	([I[IIIF)V
    //   142: aload 7
    //   144: aload 11
    //   146: iconst_0
    //   147: iload 5
    ...
    //   151: iload 5
    //   153: iload 6
    //   155: invokevirtual 75	android/graphics/Bitmap:setPixels	([IIIIIII)V
    //   158: aload 7
    //   160: areturn
    //   161: astore_0
    //   162: aload 8
    ...
    //   168: iconst_1
    //   169: aload_0
    //   170: invokevirtual 44	java/lang/Exception:toString	()Ljava/lang/String;
    //   173: invokestatic 50	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   176: aload 7
    //   178: areturn
    //   179: astore_0
    //   180: aload 9
    ...
    //   186: iconst_1
    //   187: aload_0
    //   188: invokevirtual 76	java/lang/OutOfMemoryError:toString	()Ljava/lang/String;
    //   191: invokestatic 50	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   194: aload 7
    //   196: areturn
    //   197: astore_0
    //   198: aload 10
    ...
    //   204: iconst_1
    //   205: aload_0
    //   206: invokevirtual 77	java/lang/Error:toString	()Ljava/lang/String;
    //   209: invokestatic 50	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   212: aload 7
    //   214: areturn
    //   215: astore_0
    //   216: goto -14 -> 202
