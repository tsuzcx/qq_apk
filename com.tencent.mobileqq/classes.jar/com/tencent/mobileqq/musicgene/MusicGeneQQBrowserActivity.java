  ...
  extends QQBrowserActivity
{
  ...
  {
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new adxb(this);
  ...
  {
    paramString6 = new AbsShareMsg.Builder(StructMsgForAudioShare.class).b(2).a("最近在听 的分享").a();
