  ...
  extends MessageMicro<PAInfoElem>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 48, 58 }, new String[] { "puin", "account_type", "index", "uin_seq", "time", "unread_num", "pa_msg_id" }, new Object[] { localLong, localInteger, localInteger, localLong, localLong, localInteger, "" }, PAInfoElem.class);
  }
}
