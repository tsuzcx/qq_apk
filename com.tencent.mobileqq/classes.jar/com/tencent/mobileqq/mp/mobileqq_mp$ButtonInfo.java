  ...
  extends MessageMicro<ButtonInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 34, 40, 48, 58, 64, 74, 80, 88, 98, 106, 112, 122, 130, 138 }, new String[] { "id", "name", "key", "url", "auth_type", "type", "sub_button", "event_id", "event_param", "is_need_lbs", "item_id", "actionInfo", "media_id", "is_new_menu", "logo_url", "bg_colors", "texture_url" }, new Object[] { localInteger1, "", "", "", localInteger1, localInteger2, null, localInteger2, null, localBoolean, localInteger1, null, "", localBoolean, "", "", "" }, ButtonInfo.class);
  }
}
