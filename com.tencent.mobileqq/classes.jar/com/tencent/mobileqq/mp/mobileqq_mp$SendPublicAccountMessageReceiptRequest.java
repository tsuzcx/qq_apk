  ...
  extends MessageMicro<SendPublicAccountMessageReceiptRequest>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 48 }, new String[] { "uint64_unique_id", "uint32_op", "pcuin", "cuin", "receipt_type", "unique_ids" }, new Object[] { localLong, localLong, localLong, localLong, Integer.valueOf(0), localLong }, SendPublicAccountMessageReceiptRequest.class);
  }
}
