  ...
  extends MessageMicro<GetEqqDetailInfoRequest>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "eqq_id", "seqno", "leqq_id", "version" }, new Object[] { localInteger, localInteger, Long.valueOf(0L), localInteger }, GetEqqDetailInfoRequest.class);
  }
}
