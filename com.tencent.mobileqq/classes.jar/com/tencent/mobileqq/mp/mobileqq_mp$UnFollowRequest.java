  ...
  extends MessageMicro<UnFollowRequest>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "uin", "account_type", "luin" }, new Object[] { localInteger, localInteger, Long.valueOf(0L) }, UnFollowRequest.class);
  }
}
