  ...
  extends MessageMicro<AccountDetailDynamicListRequest>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 32 }, new String[] { "versionInfo", "puin", "last_msg_id", "msg_cnt" }, new Object[] { "", localLong, localLong, Integer.valueOf(0) }, AccountDetailDynamicListRequest.class);
  }
}
