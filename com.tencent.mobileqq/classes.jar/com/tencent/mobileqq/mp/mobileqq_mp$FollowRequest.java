  ...
  extends MessageMicro<FollowRequest>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 40 }, new String[] { "uin", "ext", "account_type", "luin", "type" }, new Object[] { localInteger, "", localInteger, Long.valueOf(0L), localInteger }, FollowRequest.class);
  }
}
