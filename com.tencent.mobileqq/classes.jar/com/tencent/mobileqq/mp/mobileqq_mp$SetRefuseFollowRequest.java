  ...
  extends MessageMicro<SetRefuseFollowRequest>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "luin", "account_type", "refuse_forever", "refuse_period" }, new Object[] { Long.valueOf(0L), localInteger, Boolean.valueOf(false), localInteger }, SetRefuseFollowRequest.class);
  }
}
