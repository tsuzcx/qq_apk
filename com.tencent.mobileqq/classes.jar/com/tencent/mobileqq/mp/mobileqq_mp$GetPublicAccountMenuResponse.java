  ...
  extends MessageMicro<GetPublicAccountMenuResponse>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 34, 40, 48, 56, 64 }, new String[] { "ret_info", "seqno", "uin", "button_info", "update_type", "luin", "update_internal", "menu_type" }, new Object[] { null, localInteger, localInteger, null, localInteger, Long.valueOf(0L), localInteger, localInteger }, GetPublicAccountMenuResponse.class);
  }
}
