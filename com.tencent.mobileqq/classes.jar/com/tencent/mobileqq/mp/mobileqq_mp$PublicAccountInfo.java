  ...
  extends MessageMicro<PublicAccountInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 34, 40, 48, 56, 64, 72, 80, 88, 96, 106, 114, 120 }, new String[] { "uin", "name", "display_number", "summary", "is_recv_msg", "is_recv_push", "certified_grade", "is_sync_lbs", "group_id", "show_flag", "account_flag", "luin", "config_group_info", "config_group_info_new", "account_flag2" }, new Object[] { localInteger, "", "", "", localBoolean, localBoolean, localInteger, localBoolean, localInteger, localInteger, localInteger, Long.valueOf(0L), null, null, Long.valueOf(0L) }, PublicAccountInfo.class);
  }
}
