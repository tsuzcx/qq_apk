  ...
  extends MessageMicro<GetUserFollowListRequest>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 48, 56 }, new String[] { "follow_seqno", "public_account_seqno", "begin", "limit", "is_increment", "group_info_seqno", "version" }, new Object[] { localInteger, localInteger, localInteger, localInteger, Boolean.valueOf(false), localInteger, localInteger }, GetUserFollowListRequest.class);
  }
}
