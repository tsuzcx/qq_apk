  ...
  extends MessageMicro<GetPublicInfoRequest>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "seqno", "uin", "luin", "version" }, new Object[] { localInteger, localInteger, Long.valueOf(0L), localInteger }, GetPublicInfoRequest.class);
  }
}
