  ...
  implements ARResourceManagerTools.ARResourceCallback
{
  ...
  public void a()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqArArengineARMarkerResourceManager$ARMarkerResourceCallback != null) {
      this.jdField_a_of_type_ComTencentMobileqqArArengineARMarkerResourceManager$ARMarkerResourceCallback.d();
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (int i = 0;; i = 1)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqArArengineARMarkerResourceManager.e();
      if (paramBoolean)
      {
