...
public class ARLocalMarkerRecog
{
  ...
  private ArrayList<amyg> jdField_b_of_type_JavaUtilArrayList;
  ...
  public void a()
  {
    ...
    for (long l1 = 0L;; l1 = this.jdField_d_of_type_Long / this.q)
    {
      ...
      amzf.a().a(this.l, this.m, this.n, this.o, this.k, this.jdField_a_of_type_JavaLangString);
      this.q = 0;
      this.p = 0;
  ...
  public boolean a(int paramInt1, int paramInt2, ArConfigInfo paramArConfigInfo, ArrayList<ArCloudConfigInfo> paramArrayList, amyf paramamyf)
  {
    boolean bool1 = false;
    ...
    try
    {
      ...
      if (!ARShell.loadNativeLibrary())
      {
        ...
        amzf.a().e(System.currentTimeMillis() - l2, false);
      }
      for (;;)
      {
        this.jdField_a_of_type_Boolean = bool1;
        QLog.i("AREngine_ARLocalMarkerRecog", 1, "init end. mIsInited = " + this.jdField_a_of_type_Boolean);
        amzf.a().d(System.currentTimeMillis() - l1, this.jdField_a_of_type_Boolean);
        return this.jdField_a_of_type_Boolean;
        amzf.a().e(System.currentTimeMillis() - l2, true);
        boolean bool2 = c();
        if (!bool2) {
          d();
        }
  ...
  public boolean a(String paramString1, String paramString2, ArCloudConfigInfo paramArCloudConfigInfo)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          if (((amyg)this.jdField_b_of_type_JavaUtilArrayList.get(i1)).jdField_a_of_type_JavaLangString.equals(paramString1))
          {
            ((amyg)this.jdField_b_of_type_JavaUtilArrayList.get(i1)).jdField_b_of_type_JavaLangString = paramString2;
            ((amyg)this.jdField_b_of_type_JavaUtilArrayList.get(i1)).jdField_a_of_type_ComTencentMobileqqArAidlArCloudConfigInfo = paramArCloudConfigInfo;
            return true;
          }
        }
        else
        {
          amyg localamyg = new amyg(null);
          localamyg.jdField_a_of_type_JavaLangString = paramString1;
          localamyg.jdField_b_of_type_JavaLangString = paramString2;
          localamyg.jdField_a_of_type_ComTencentMobileqqArAidlArCloudConfigInfo = paramArCloudConfigInfo;
          localamyg.jdField_a_of_type_Boolean = false;
          localamyg.jdField_b_of_type_Boolean = false;
          this.jdField_b_of_type_JavaUtilArrayList.add(localamyg);
  ...
  boolean c()
  {
    ...
    int i4 = i1;
    int i5 = i2;
    if (!anbo.jdField_a_of_type_Boolean)
    {
      i4 = i1;
      i5 = i2;
