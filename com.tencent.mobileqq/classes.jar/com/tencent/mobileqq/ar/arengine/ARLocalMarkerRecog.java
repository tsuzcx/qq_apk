...
public class ARLocalMarkerRecog
{
  ...
  private aaoe jdField_a_of_type_Aaoe;
  ...
  private boolean d()
  {
    ...
    //   1: istore_1
    //   2: aload_0
    //   3: getfield 91	com/tencent/mobileqq/ar/arengine/ARLocalMarkerRecog:jdField_e_of_type_Boolean	Z
    //   6: istore_3
    //   7: iload_3
    //   8: ifeq +49 -> 57
    //   11: iload_1
    ...
    //   18: if_icmpge +39 -> 57
    //   21: ldc2_w 198
    //   24: invokestatic 205	java/lang/Thread:sleep	(J)V
    //   27: iload_2
    //   28: istore_1
    ...
    //   37: iconst_2
    //   38: ldc 210
    //   40: invokestatic 212	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   43: iload_2
    //   44: istore_1
    //   45: goto -43 -> 2
    //   48: astore 4
    //   50: aload 4
    //   52: invokevirtual 215	java/lang/Exception:printStackTrace	()V
    //   55: iconst_1
    //   56: ireturn
    //   57: aload_0
    //   58: getfield 55	com/tencent/mobileqq/ar/arengine/ARLocalMarkerRecog:jdField_d_of_type_JavaLangObject	Ljava/lang/Object;
    //   61: astore 4
    //   63: aload 4
    //   65: monitorenter
    //   66: ldc 101
    //   68: iconst_1
    //   69: ldc 217
    //   71: invokestatic 121	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   74: invokestatic 220	com/youtu/arsdk/ARShell:nativeStop	()Z
    //   77: pop
    //   78: ldc 101
    //   80: iconst_1
    //   81: ldc 222
    //   83: invokestatic 121	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   86: ldc 101
    //   88: iconst_1
    //   89: ldc 224
    //   91: invokestatic 121	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   94: invokestatic 227	com/youtu/arsdk/ARShell:nativeDestroy	()Z
    //   97: pop
    //   98: ldc 101
    //   100: iconst_1
    //   101: ldc 229
    //   103: invokestatic 121	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   106: aload 4
    //   108: monitorexit
    //   109: iconst_1
    //   110: ireturn
  ...
  public void a(long paramLong, byte[] paramArrayOfByte)
  {
    ...
    while (this.jdField_a_of_type_Aaoe == null) {
      return;
    }
    this.jdField_a_of_type_Aaoe.a(paramLong, paramArrayOfByte);
  }
  ...
  public boolean a()
  {
    ...
    this.g = 2;
    if (this.jdField_a_of_type_Aaoe == null) {
      this.jdField_a_of_type_Aaoe = new aaoe(this);
    }
    this.n = 0;
  ...
  public boolean a(int paramInt1, int paramInt2, ArConfigInfo paramArConfigInfo, ArrayList paramArrayList, ARLocalMarkerRecog.ARLocalMarkerRecogCallback paramARLocalMarkerRecogCallback)
  {
    boolean bool1 = false;
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        ARReport.a().d(System.currentTimeMillis() - l1, this.jdField_a_of_type_Boolean);
  ...
  public boolean a(String paramString1, String paramString2, ArCloudConfigInfo paramArCloudConfigInfo)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          if (((aaod)this.jdField_b_of_type_JavaUtilArrayList.get(i1)).jdField_a_of_type_JavaLangString.equals(paramString1))
          {
            ((aaod)this.jdField_b_of_type_JavaUtilArrayList.get(i1)).jdField_b_of_type_JavaLangString = paramString2;
            ((aaod)this.jdField_b_of_type_JavaUtilArrayList.get(i1)).jdField_a_of_type_ComTencentMobileqqArAidlArCloudConfigInfo = paramArCloudConfigInfo;
            return true;
          }
        }
        else
        {
          aaod localaaod = new aaod(null);
          localaaod.jdField_a_of_type_JavaLangString = paramString1;
          localaaod.jdField_b_of_type_JavaLangString = paramString2;
          localaaod.jdField_a_of_type_ComTencentMobileqqArAidlArCloudConfigInfo = paramArCloudConfigInfo;
          localaaod.jdField_a_of_type_Boolean = false;
          localaaod.jdField_b_of_type_Boolean = false;
          this.jdField_b_of_type_JavaUtilArrayList.add(localaaod);
  ...
  boolean c()
  {
    ...
    int i4 = i1;
    int i5 = i2;
    if (!AREngine.jdField_a_of_type_Boolean)
    {
      i4 = i1;
      i5 = i2;
  ...
  public void d()
  {
    ...
    if (this.jdField_a_of_type_Aaoe != null)
    {
      this.jdField_a_of_type_Aaoe.a();
      this.jdField_a_of_type_Aaoe = null;
    }
    this.jdField_a_of_type_ComTencentMobileqqArFramePerformanceMonitor = null;
    a();
    this.jdField_b_of_type_Boolean = false;
