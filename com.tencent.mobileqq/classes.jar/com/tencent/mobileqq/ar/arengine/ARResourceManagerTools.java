...
public class ARResourceManagerTools
{
  ...
  public void a(ArrayList paramArrayList, ARResourceManagerTools.ARResourceCallback paramARResourceCallback)
  {
    ...
    if (i < paramArrayList.size())
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqArArengineARResourceDownload.a((ARResourceDownload.DownloadInfo)paramArrayList.get(i), new aaph(this, paramARResourceCallback, paramArrayList, (ArrayList)localObject));
    }
    for (;;)
    {
      i += 1;
      ...
      if (((ARResourceDownload.DownloadInfo)paramArrayList.get(i)).jdField_a_of_type_Int == 4)
      {
        ...
        HtmlOffline.a(((ARResourceDownload.DownloadInfo)paramArrayList.get(i)).jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentCommonAppAppInterface, new aapi(this, paramARResourceCallback, (ArrayList)localObject, localDownloadInfo), true, 0, true);
      }
    }
  }
