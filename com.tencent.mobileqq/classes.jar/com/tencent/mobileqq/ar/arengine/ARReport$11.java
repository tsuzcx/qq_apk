...
public class ARReport$11
  implements Runnable
{
  public ARReport$11(apcf paramapcf, long paramLong, boolean paramBoolean) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      bctj.a(BaseApplication.getContext()).a("", "ARLocalMarkerRecoglSo", true, 0L, 0L, localHashMap, "");
      return;
