...
public class ARReport$10
  implements Runnable
{
  public ARReport$10(appv paramappv, long paramLong, boolean paramBoolean) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      bdmc.a(BaseApplication.getContext()).a("", "ARLocalMarkerRecoglinit", true, 0L, 0L, localHashMap, "");
      return;
