...
public class ARCloudPretreatmentManager$1
  implements Runnable
{
  public ARCloudPretreatmentManager$1(amww paramamww, FaceStatus[] paramArrayOfFaceStatus, FaceCluster paramFaceCluster, byte[] paramArrayOfByte, int paramInt1, int paramInt2) {}
  ...
  public void run()
  {
    ...
    amxq.a().e = l1;
    amxq.a().jdField_a_of_type_Int = i;
    if (QLog.isColorLevel()) {
