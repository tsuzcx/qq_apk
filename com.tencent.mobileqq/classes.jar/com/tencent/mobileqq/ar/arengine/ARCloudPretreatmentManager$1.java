...
public class ARCloudPretreatmentManager$1
  implements Runnable
{
  public ARCloudPretreatmentManager$1(apnm paramapnm, FaceStatus[] paramArrayOfFaceStatus, FaceCluster paramFaceCluster, byte[] paramArrayOfByte, int paramInt1, int paramInt2) {}
  ...
  public void run()
  {
    ...
    apog.a().e = l1;
    apog.a().jdField_a_of_type_Int = i;
    if (QLog.isColorLevel()) {
