...
public class ARCloudPretreatmentManager$1
  implements Runnable
{
  public ARCloudPretreatmentManager$1(aogz paramaogz, FaceStatus[] paramArrayOfFaceStatus, FaceCluster paramFaceCluster, byte[] paramArrayOfByte, int paramInt1, int paramInt2) {}
  ...
  public void run()
  {
    ...
    aoht.a().e = l1;
    aoht.a().jdField_a_of_type_Int = i;
    if (QLog.isColorLevel()) {
