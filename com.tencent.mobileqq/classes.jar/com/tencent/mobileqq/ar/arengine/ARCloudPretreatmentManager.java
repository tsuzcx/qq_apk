...
public class ARCloudPretreatmentManager
{
  ...
  public void a(byte[] paramArrayOfByte, int paramInt1, int paramInt2, ARRecognition paramARRecognition, ARCloudPretreatmentManager.ARCloudPretreatmentCallback paramARCloudPretreatmentCallback)
  {
    ...
    if (ARLocalFaceRecog.a != null)
    {
      ...
      paramArrayOfByte = Message.obtain(ARLocalFaceRecog.a, new aame(this, paramARRecognition, localFaceCluster, paramArrayOfByte, paramInt1, paramInt2));
  ...
  public void a(byte[] paramArrayOfByte, ArrayList paramArrayList, ARCloudPretreatmentManager.ARCloudPretreatmentCallback paramARCloudPretreatmentCallback, int paramInt1, int paramInt2, int paramInt3)
  {
