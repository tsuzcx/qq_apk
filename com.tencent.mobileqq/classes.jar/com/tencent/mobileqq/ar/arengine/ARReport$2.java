...
public class ARReport$2
  implements Runnable
{
  public ARReport$2(appv paramappv, String paramString, long paramLong1, long paramLong2, int paramInt1, long paramLong3, long paramLong4, int paramInt2, long paramLong5, int paramInt3, long paramLong6, long paramLong7, int paramInt4) {}
  ...
  public void run()
  {
    ...
    if (appv.a(this.this$0, this.jdField_d_of_type_Long)) {
    ...
    localHashMap.put("cloud_download_net_type", String.valueOf(bhnv.a(BaseApplication.getContext())));
    ...
    bdmc.a(BaseApplication.getContext()).a("", "AndroidactARCloudDownLoad", true, 0L, 0L, localHashMap, "", true);
  }
}
