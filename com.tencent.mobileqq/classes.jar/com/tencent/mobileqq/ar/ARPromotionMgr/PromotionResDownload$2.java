  ...
  implements ResDownloadManager.IResDownloadListener
{
  ...
  public void a(String paramString1, String paramString2, int paramInt)
  {
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      if ((QLog.isDevelopLevel()) && ((bool2) || (bool1))) {
        QLog.w(this.jdField_a_of_type_ComTencentMobileqqArARPromotionMgrPromotionResDownload.jdField_a_of_type_JavaLangString, 1, "onDownloadUpdate, md5[" + paramString2 + "], activityid[" + this.jdField_a_of_type_JavaLangString + "], index[" + this.jdField_b_of_type_Int + "], curPercent[" + paramInt + "], lastPercent[" + this.jdField_a_of_type_Int + "], needNotify[" + bool1 + "], needNotify2[" + bool2 + "]");
      }
      if (bool1) {
  ...
  public void a(String paramString1, String paramString2, int paramInt, String paramString3, Object paramObject)
  {
    ...
    if ((paramObject instanceof PromotionConfigInfo.ZipItem))
    {
      ...
      QLog.w(this.jdField_a_of_type_ComTencentMobileqqArARPromotionMgrPromotionResDownload.jdField_a_of_type_JavaLangString, 1, "onDownloadFinish, md5[" + paramString2 + "], errCode[" + paramInt + "], check[" + bool + "], path[" + paramString3 + "], id[" + paramString1.e + "], request[" + paramString1.jdField_a_of_type_Long + "], Begin[" + paramString1.jdField_b_of_type_Long + "], End[" + paramString1.c + "], 调度耗时[" + (paramString1.jdField_b_of_type_Long - paramString1.jdField_a_of_type_Long) + "], 下载耗时[" + (paramString1.c - paramString1.jdField_b_of_type_Long) + "], fromPreCover[" + paramString1.d + "], seq[" + this.jdField_a_of_type_Long + "], Uin[" + paramObject + "], zipItem[" + paramString1 + "]");
  ...
  {
    super.finalize();
    QLog.w(this.jdField_a_of_type_ComTencentMobileqqArARPromotionMgrPromotionResDownload.jdField_a_of_type_JavaLangString, 1, "ZipItem.finalize, activityid[" + this.jdField_a_of_type_JavaLangString + "], index[" + this.jdField_b_of_type_Int + "], seq[" + this.jdField_a_of_type_Long + "]");
  }
}
