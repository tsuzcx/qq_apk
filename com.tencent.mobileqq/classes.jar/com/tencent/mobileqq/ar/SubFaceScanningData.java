...
public class SubFaceScanningData
  extends ScanningData
{
  ...
  public SubFaceScanningData(Context paramContext)
  {
    super(paramContext);
    l();
    a();
  ...
  private void l()
  {
    ...
    this.i = (ViewUtils.a(1.5F) * this.jdField_c_of_type_Float);
  ...
  public void b()
  {
    ...
    {
      this.i = ViewUtils.a(5.0F);
      return;
    }
    this.i = ViewUtils.a(1.5F);
  }
  ...
  public void g()
  {
    ...
    {
      this.jdField_g_of_type_AndroidAnimationObjectAnimator = ObjectAnimator.ofFloat(this, "fCPositionY", new float[] { -ViewUtils.a(25.0F), 0.0F });
 ...
 * Qualified Name:     com.tencent.mobileqq.ar.SubFaceScanningData
