...
public abstract class ObjectBaseData
{
  ...
  public ObjectBaseData(Context paramContext)
  {
    ...
    this.jdField_f_of_type_JavaLangString = amtj.a(2131706797);
  ...
  private void a()
  {
    ...
    this.jdField_b_of_type_AndroidGraphicsPaint.setStrokeWidth(aoec.jdField_b_of_type_Int);
  ...
  public void b()
  {
    this.jdField_f_of_type_Float = aoec.I;
    this.jdField_i_of_type_Float = aoec.jdField_h_of_type_Int;
    this.jdField_n_of_type_Float = aoec.jdField_i_of_type_Int;
    this.B = aoec.L;
    this.E = aoec.jdField_c_of_type_Int;
    this.L = aoec.G;
    this.O = aoec.H;
    this.P = aoec.jdField_b_of_type_Int;
    this.X = aoec.G;
    this.Y = aoec.jdField_c_of_type_Int;
    this.ag = aoec.G;
    this.ai = aoec.jdField_u_of_type_Int;
    this.am = aoec.jdField_q_of_type_Int;
    this.an = aoec.jdField_b_of_type_Int;
    this.ay = aoec.jdField_c_of_type_Int;
    this.aB = aoec.jdField_k_of_type_Int;
    this.aH = aoec.x;
    this.aD = aoec.C;
    this.aE = aoec.jdField_u_of_type_Int;
    this.aL = aoec.x;
    this.aM = aoec.x;
    this.aN = aoec.jdField_p_of_type_Int;
    this.aP = aoec.jdField_r_of_type_Int;
    this.aQ = aoec.jdField_r_of_type_Int;
    this.aR = aoec.jdField_j_of_type_Int;
    this.aH = aoec.jdField_r_of_type_Int;
    this.aS = aoec.jdField_k_of_type_Int;
    this.aT = aoec.jdField_m_of_type_Int;
    this.aU = 0.0F;
    this.aX = aoec.jdField_m_of_type_Int;
    this.aY = aoec.jdField_b_of_type_Int;
    this.bb = aoec.jdField_a_of_type_Int;
    this.bd = aoec.A;
    this.be = aoec.jdField_o_of_type_Int;
    this.bf = aoec.jdField_f_of_type_Int;
    this.bh = aoec.jdField_d_of_type_Int;
    this.bI = aoec.F;
    this.bJ = aoec.jdField_e_of_type_Int;
    this.bK = aoec.jdField_h_of_type_Int;
    this.bM = aoec.y;
    this.bN = aoec.jdField_c_of_type_Int;
    this.bQ = aoec.jdField_v_of_type_Int;
    this.bR = aoec.D;
  }
  ...
  public void v()
  {
    ...
    this.bn = aoec.jdField_i_of_type_Int;
    this.bo = aoec.jdField_s_of_type_Int;
    this.bw = aoec.z;
    this.bp = aoec.jdField_s_of_type_Int;
    this.bq = aoec.jdField_s_of_type_Int;
    this.br = aoec.jdField_g_of_type_Int;
    this.bs = aoec.jdField_g_of_type_Int;
    this.bx = aoec.jdField_s_of_type_Int;
    this.bt = aoec.jdField_j_of_type_Int;
    this.bu = aoec.jdField_p_of_type_Int;
    this.bv = aoec.jdField_s_of_type_Int;
    this.by = aoec.jdField_s_of_type_Int;
    this.bz = aoec.jdField_r_of_type_Int;
    this.bA = aoec.jdField_p_of_type_Int;
    this.bB = aoec.jdField_n_of_type_Int;
    this.jdField_r_of_type_Int = Color.argb(255, 119, 119, 119);
    this.bC = aoec.jdField_h_of_type_Int;
    this.bD = aoec.jdField_r_of_type_Int;
    this.bE = aoec.jdField_e_of_type_Int;
    this.jdField_s_of_type_Int = Color.argb(76, 0, 104, 144);
    this.bF = aoec.jdField_l_of_type_Int;
    this.bG = aoec.jdField_i_of_type_Int;
    this.bH = 0.0F;
    this.bI = aoec.F;
    this.bJ = aoec.jdField_e_of_type_Int;
    this.t = -1;
    ...
    this.bQ = aoec.jdField_v_of_type_Int;
    this.bR = aoec.D;
    this.w = aoec.jdField_k_of_type_Int;
    this.aV = 0.0F;
    this.aW = 0.0F;
    this.bc = 0.0F;
    this.bi = 0.0F;
