...
public abstract class ObjectBaseData
{
  ...
  public ObjectBaseData(Context paramContext)
  {
    ...
    this.jdField_f_of_type_JavaLangString = alpo.a(2131708071);
  ...
  private void a()
  {
    ...
    this.jdField_b_of_type_AndroidGraphicsPaint.setStrokeWidth(amtt.jdField_b_of_type_Int);
  ...
  public void b()
  {
    this.jdField_f_of_type_Float = amtt.I;
    this.jdField_i_of_type_Float = amtt.jdField_h_of_type_Int;
    this.jdField_n_of_type_Float = amtt.jdField_i_of_type_Int;
    this.B = amtt.L;
    this.E = amtt.jdField_c_of_type_Int;
    this.L = amtt.G;
    this.O = amtt.H;
    this.P = amtt.jdField_b_of_type_Int;
    this.X = amtt.G;
    this.Y = amtt.jdField_c_of_type_Int;
    this.ag = amtt.G;
    this.ai = amtt.jdField_u_of_type_Int;
    this.am = amtt.jdField_q_of_type_Int;
    this.an = amtt.jdField_b_of_type_Int;
    this.ay = amtt.jdField_c_of_type_Int;
    this.aB = amtt.jdField_k_of_type_Int;
    this.aH = amtt.x;
    this.aD = amtt.C;
    this.aE = amtt.jdField_u_of_type_Int;
    this.aL = amtt.x;
    this.aM = amtt.x;
    this.aN = amtt.jdField_p_of_type_Int;
    this.aP = amtt.jdField_r_of_type_Int;
    this.aQ = amtt.jdField_r_of_type_Int;
    this.aR = amtt.jdField_j_of_type_Int;
    this.aH = amtt.jdField_r_of_type_Int;
    this.aS = amtt.jdField_k_of_type_Int;
    this.aT = amtt.jdField_m_of_type_Int;
    this.aU = 0.0F;
    this.aX = amtt.jdField_m_of_type_Int;
    this.aY = amtt.jdField_b_of_type_Int;
    this.bb = amtt.jdField_a_of_type_Int;
    this.bd = amtt.A;
    this.be = amtt.jdField_o_of_type_Int;
    this.bf = amtt.jdField_f_of_type_Int;
    this.bh = amtt.jdField_d_of_type_Int;
    this.bI = amtt.F;
    this.bJ = amtt.jdField_e_of_type_Int;
    this.bK = amtt.jdField_h_of_type_Int;
    this.bM = amtt.y;
    this.bN = amtt.jdField_c_of_type_Int;
    this.bQ = amtt.jdField_v_of_type_Int;
    this.bR = amtt.D;
  }
  ...
  public void v()
  {
    ...
    this.bn = amtt.jdField_i_of_type_Int;
    this.bo = amtt.jdField_s_of_type_Int;
    this.bw = amtt.z;
    this.bp = amtt.jdField_s_of_type_Int;
    this.bq = amtt.jdField_s_of_type_Int;
    this.br = amtt.jdField_g_of_type_Int;
    this.bs = amtt.jdField_g_of_type_Int;
    this.bx = amtt.jdField_s_of_type_Int;
    this.bt = amtt.jdField_j_of_type_Int;
    this.bu = amtt.jdField_p_of_type_Int;
    this.bv = amtt.jdField_s_of_type_Int;
    this.by = amtt.jdField_s_of_type_Int;
    this.bz = amtt.jdField_r_of_type_Int;
    this.bA = amtt.jdField_p_of_type_Int;
    this.bB = amtt.jdField_n_of_type_Int;
    this.jdField_r_of_type_Int = Color.argb(255, 119, 119, 119);
    this.bC = amtt.jdField_h_of_type_Int;
    this.bD = amtt.jdField_r_of_type_Int;
    this.bE = amtt.jdField_e_of_type_Int;
    this.jdField_s_of_type_Int = Color.argb(76, 0, 104, 144);
    this.bF = amtt.jdField_l_of_type_Int;
    this.bG = amtt.jdField_i_of_type_Int;
    this.bH = 0.0F;
    this.bI = amtt.F;
    this.bJ = amtt.jdField_e_of_type_Int;
    this.t = -1;
    ...
    this.bQ = amtt.jdField_v_of_type_Int;
    this.bR = amtt.D;
    this.w = amtt.jdField_k_of_type_Int;
    this.aV = 0.0F;
    this.aW = 0.0F;
    this.bc = 0.0F;
    this.bi = 0.0F;
