...
public abstract class ObjectBaseData
{
  ...
  public ObjectBaseData(Context paramContext)
  {
    ...
    this.jdField_f_of_type_JavaLangString = anzj.a(2131706567);
  ...
  private void a()
  {
    ...
    this.jdField_b_of_type_AndroidGraphicsPaint.setStrokeWidth(apkp.jdField_b_of_type_Int);
  ...
  public void b()
  {
    this.jdField_f_of_type_Float = apkp.I;
    this.jdField_i_of_type_Float = apkp.jdField_h_of_type_Int;
    this.jdField_n_of_type_Float = apkp.jdField_i_of_type_Int;
    this.B = apkp.L;
    this.E = apkp.jdField_c_of_type_Int;
    this.L = apkp.G;
    this.O = apkp.H;
    this.P = apkp.jdField_b_of_type_Int;
    this.X = apkp.G;
    this.Y = apkp.jdField_c_of_type_Int;
    this.ag = apkp.G;
    this.ai = apkp.jdField_u_of_type_Int;
    this.am = apkp.jdField_q_of_type_Int;
    this.an = apkp.jdField_b_of_type_Int;
    this.ay = apkp.jdField_c_of_type_Int;
    this.aB = apkp.jdField_k_of_type_Int;
    this.aH = apkp.x;
    this.aD = apkp.C;
    this.aE = apkp.jdField_u_of_type_Int;
    this.aL = apkp.x;
    this.aM = apkp.x;
    this.aN = apkp.jdField_p_of_type_Int;
    this.aP = apkp.jdField_r_of_type_Int;
    this.aQ = apkp.jdField_r_of_type_Int;
    this.aR = apkp.jdField_j_of_type_Int;
    this.aH = apkp.jdField_r_of_type_Int;
    this.aS = apkp.jdField_k_of_type_Int;
    this.aT = apkp.jdField_m_of_type_Int;
    this.aU = 0.0F;
    this.aX = apkp.jdField_m_of_type_Int;
    this.aY = apkp.jdField_b_of_type_Int;
    this.bb = apkp.jdField_a_of_type_Int;
    this.bd = apkp.A;
    this.be = apkp.jdField_o_of_type_Int;
    this.bf = apkp.jdField_f_of_type_Int;
    this.bh = apkp.jdField_d_of_type_Int;
    this.bI = apkp.F;
    this.bJ = apkp.jdField_e_of_type_Int;
    this.bK = apkp.jdField_h_of_type_Int;
    this.bM = apkp.y;
    this.bN = apkp.jdField_c_of_type_Int;
    this.bQ = apkp.jdField_v_of_type_Int;
    this.bR = apkp.D;
  }
  ...
  public void v()
  {
    ...
    this.bn = apkp.jdField_i_of_type_Int;
    this.bo = apkp.jdField_s_of_type_Int;
    this.bw = apkp.z;
    this.bp = apkp.jdField_s_of_type_Int;
    this.bq = apkp.jdField_s_of_type_Int;
    this.br = apkp.jdField_g_of_type_Int;
    this.bs = apkp.jdField_g_of_type_Int;
    this.bx = apkp.jdField_s_of_type_Int;
    this.bt = apkp.jdField_j_of_type_Int;
    this.bu = apkp.jdField_p_of_type_Int;
    this.bv = apkp.jdField_s_of_type_Int;
    this.by = apkp.jdField_s_of_type_Int;
    this.bz = apkp.jdField_r_of_type_Int;
    this.bA = apkp.jdField_p_of_type_Int;
    this.bB = apkp.jdField_n_of_type_Int;
    this.jdField_r_of_type_Int = Color.argb(255, 119, 119, 119);
    this.bC = apkp.jdField_h_of_type_Int;
    this.bD = apkp.jdField_r_of_type_Int;
    this.bE = apkp.jdField_e_of_type_Int;
    this.jdField_s_of_type_Int = Color.argb(76, 0, 104, 144);
    this.bF = apkp.jdField_l_of_type_Int;
    this.bG = apkp.jdField_i_of_type_Int;
    this.bH = 0.0F;
    this.bI = apkp.F;
    this.bJ = apkp.jdField_e_of_type_Int;
    this.t = -1;
    ...
    this.bQ = apkp.jdField_v_of_type_Int;
    this.bR = apkp.D;
    this.w = apkp.jdField_k_of_type_Int;
    this.aV = 0.0F;
    this.aW = 0.0F;
    this.bc = 0.0F;
    this.bi = 0.0F;
