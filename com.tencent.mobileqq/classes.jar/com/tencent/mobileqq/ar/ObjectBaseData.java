...
public abstract class ObjectBaseData
{
  ...
  public ObjectBaseData(Context paramContext)
  {
    ...
    this.jdField_f_of_type_JavaLangString = ajya.a(2131707699);
  ...
  private void a()
  {
    ...
    this.jdField_b_of_type_AndroidGraphicsPaint.setStrokeWidth(aldd.jdField_b_of_type_Int);
  ...
  public void b()
  {
    this.jdField_f_of_type_Float = aldd.I;
    this.jdField_i_of_type_Float = aldd.jdField_h_of_type_Int;
    this.jdField_n_of_type_Float = aldd.jdField_i_of_type_Int;
    this.B = aldd.L;
    this.E = aldd.jdField_c_of_type_Int;
    this.L = aldd.G;
    this.O = aldd.H;
    this.P = aldd.jdField_b_of_type_Int;
    this.X = aldd.G;
    this.Y = aldd.jdField_c_of_type_Int;
    this.ag = aldd.G;
    this.ai = aldd.jdField_u_of_type_Int;
    this.am = aldd.jdField_q_of_type_Int;
    this.an = aldd.jdField_b_of_type_Int;
    this.ay = aldd.jdField_c_of_type_Int;
    this.aB = aldd.jdField_k_of_type_Int;
    this.aH = aldd.x;
    this.aD = aldd.C;
    this.aE = aldd.jdField_u_of_type_Int;
    this.aL = aldd.x;
    this.aM = aldd.x;
    this.aN = aldd.jdField_p_of_type_Int;
    this.aP = aldd.jdField_r_of_type_Int;
    this.aQ = aldd.jdField_r_of_type_Int;
    this.aR = aldd.jdField_j_of_type_Int;
    this.aH = aldd.jdField_r_of_type_Int;
    this.aS = aldd.jdField_k_of_type_Int;
    this.aT = aldd.jdField_m_of_type_Int;
    this.aU = 0.0F;
    this.aX = aldd.jdField_m_of_type_Int;
    this.aY = aldd.jdField_b_of_type_Int;
    this.bb = aldd.jdField_a_of_type_Int;
    this.bd = aldd.A;
    this.be = aldd.jdField_o_of_type_Int;
    this.bf = aldd.jdField_f_of_type_Int;
    this.bh = aldd.jdField_d_of_type_Int;
    this.bI = aldd.F;
    this.bJ = aldd.jdField_e_of_type_Int;
    this.bK = aldd.jdField_h_of_type_Int;
    this.bM = aldd.y;
    this.bN = aldd.jdField_c_of_type_Int;
    this.bQ = aldd.jdField_v_of_type_Int;
    this.bR = aldd.D;
  }
  ...
  public void v()
  {
    ...
    this.bn = aldd.jdField_i_of_type_Int;
    this.bo = aldd.jdField_s_of_type_Int;
    this.bw = aldd.z;
    this.bp = aldd.jdField_s_of_type_Int;
    this.bq = aldd.jdField_s_of_type_Int;
    this.br = aldd.jdField_g_of_type_Int;
    this.bs = aldd.jdField_g_of_type_Int;
    this.bx = aldd.jdField_s_of_type_Int;
    this.bt = aldd.jdField_j_of_type_Int;
    this.bu = aldd.jdField_p_of_type_Int;
    this.bv = aldd.jdField_s_of_type_Int;
    this.by = aldd.jdField_s_of_type_Int;
    this.bz = aldd.jdField_r_of_type_Int;
    this.bA = aldd.jdField_p_of_type_Int;
    this.bB = aldd.jdField_n_of_type_Int;
    this.jdField_r_of_type_Int = Color.argb(255, 119, 119, 119);
    this.bC = aldd.jdField_h_of_type_Int;
    this.bD = aldd.jdField_r_of_type_Int;
    this.bE = aldd.jdField_e_of_type_Int;
    this.jdField_s_of_type_Int = Color.argb(76, 0, 104, 144);
    this.bF = aldd.jdField_l_of_type_Int;
    this.bG = aldd.jdField_i_of_type_Int;
    this.bH = 0.0F;
    this.bI = aldd.F;
    this.bJ = aldd.jdField_e_of_type_Int;
    this.t = -1;
    ...
    this.bQ = aldd.jdField_v_of_type_Int;
    this.bR = aldd.D;
    this.w = aldd.jdField_k_of_type_Int;
    this.aV = 0.0F;
    this.aW = 0.0F;
    this.bc = 0.0F;
    this.bi = 0.0F;
