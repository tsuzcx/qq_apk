...
public abstract class ObjectBaseData
{
  ...
  public ObjectBaseData(Context paramContext)
  {
    ...
    this.jdField_f_of_type_JavaLangString = ajjy.a(2131641903);
  ...
  private void a()
  {
    ...
    this.jdField_b_of_type_AndroidGraphicsPaint.setStrokeWidth(akos.jdField_b_of_type_Int);
  ...
  public void b()
  {
    this.jdField_f_of_type_Float = akos.I;
    this.jdField_i_of_type_Float = akos.jdField_h_of_type_Int;
    this.jdField_n_of_type_Float = akos.jdField_i_of_type_Int;
    this.B = akos.L;
    this.E = akos.jdField_c_of_type_Int;
    this.L = akos.G;
    this.O = akos.H;
    this.P = akos.jdField_b_of_type_Int;
    this.X = akos.G;
    this.Y = akos.jdField_c_of_type_Int;
    this.ag = akos.G;
    this.ai = akos.jdField_u_of_type_Int;
    this.am = akos.jdField_q_of_type_Int;
    this.an = akos.jdField_b_of_type_Int;
    this.ay = akos.jdField_c_of_type_Int;
    this.aB = akos.jdField_k_of_type_Int;
    this.aH = akos.x;
    this.aD = akos.C;
    this.aE = akos.jdField_u_of_type_Int;
    this.aL = akos.x;
    this.aM = akos.x;
    this.aN = akos.jdField_p_of_type_Int;
    this.aP = akos.jdField_r_of_type_Int;
    this.aQ = akos.jdField_r_of_type_Int;
    this.aR = akos.jdField_j_of_type_Int;
    this.aH = akos.jdField_r_of_type_Int;
    this.aS = akos.jdField_k_of_type_Int;
    this.aT = akos.jdField_m_of_type_Int;
    this.aU = 0.0F;
    this.aX = akos.jdField_m_of_type_Int;
    this.aY = akos.jdField_b_of_type_Int;
    this.bb = akos.jdField_a_of_type_Int;
    this.bd = akos.A;
    this.be = akos.jdField_o_of_type_Int;
    this.bf = akos.jdField_f_of_type_Int;
    this.bh = akos.jdField_d_of_type_Int;
    this.bI = akos.F;
    this.bJ = akos.jdField_e_of_type_Int;
    this.bK = akos.jdField_h_of_type_Int;
    this.bM = akos.y;
    this.bN = akos.jdField_c_of_type_Int;
    this.bQ = akos.jdField_v_of_type_Int;
    this.bR = akos.D;
  }
  ...
  public void v()
  {
    ...
    this.bn = akos.jdField_i_of_type_Int;
    this.bo = akos.jdField_s_of_type_Int;
    this.bw = akos.z;
    this.bp = akos.jdField_s_of_type_Int;
    this.bq = akos.jdField_s_of_type_Int;
    this.br = akos.jdField_g_of_type_Int;
    this.bs = akos.jdField_g_of_type_Int;
    this.bx = akos.jdField_s_of_type_Int;
    this.bt = akos.jdField_j_of_type_Int;
    this.bu = akos.jdField_p_of_type_Int;
    this.bv = akos.jdField_s_of_type_Int;
    this.by = akos.jdField_s_of_type_Int;
    this.bz = akos.jdField_r_of_type_Int;
    this.bA = akos.jdField_p_of_type_Int;
    this.bB = akos.jdField_n_of_type_Int;
    this.jdField_r_of_type_Int = Color.argb(255, 119, 119, 119);
    this.bC = akos.jdField_h_of_type_Int;
    this.bD = akos.jdField_r_of_type_Int;
    this.bE = akos.jdField_e_of_type_Int;
    this.jdField_s_of_type_Int = Color.argb(76, 0, 104, 144);
    this.bF = akos.jdField_l_of_type_Int;
    this.bG = akos.jdField_i_of_type_Int;
    this.bH = 0.0F;
    this.bI = akos.F;
    this.bJ = akos.jdField_e_of_type_Int;
    this.t = -1;
    ...
    this.bQ = akos.jdField_v_of_type_Int;
    this.bR = akos.D;
    this.w = akos.jdField_k_of_type_Int;
    this.aV = 0.0F;
    this.aW = 0.0F;
    this.bc = 0.0F;
    this.bi = 0.0F;
