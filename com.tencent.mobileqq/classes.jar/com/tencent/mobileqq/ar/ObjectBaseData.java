...
public abstract class ObjectBaseData
{
  ...
  public ObjectBaseData(Context paramContext)
  {
    ...
    this.jdField_f_of_type_JavaLangString = ajyc.a(2131707688);
  ...
  private void a()
  {
    ...
    this.jdField_b_of_type_AndroidGraphicsPaint.setStrokeWidth(alde.jdField_b_of_type_Int);
  ...
  public void b()
  {
    this.jdField_f_of_type_Float = alde.I;
    this.jdField_i_of_type_Float = alde.jdField_h_of_type_Int;
    this.jdField_n_of_type_Float = alde.jdField_i_of_type_Int;
    this.B = alde.L;
    this.E = alde.jdField_c_of_type_Int;
    this.L = alde.G;
    this.O = alde.H;
    this.P = alde.jdField_b_of_type_Int;
    this.X = alde.G;
    this.Y = alde.jdField_c_of_type_Int;
    this.ag = alde.G;
    this.ai = alde.jdField_u_of_type_Int;
    this.am = alde.jdField_q_of_type_Int;
    this.an = alde.jdField_b_of_type_Int;
    this.ay = alde.jdField_c_of_type_Int;
    this.aB = alde.jdField_k_of_type_Int;
    this.aH = alde.x;
    this.aD = alde.C;
    this.aE = alde.jdField_u_of_type_Int;
    this.aL = alde.x;
    this.aM = alde.x;
    this.aN = alde.jdField_p_of_type_Int;
    this.aP = alde.jdField_r_of_type_Int;
    this.aQ = alde.jdField_r_of_type_Int;
    this.aR = alde.jdField_j_of_type_Int;
    this.aH = alde.jdField_r_of_type_Int;
    this.aS = alde.jdField_k_of_type_Int;
    this.aT = alde.jdField_m_of_type_Int;
    this.aU = 0.0F;
    this.aX = alde.jdField_m_of_type_Int;
    this.aY = alde.jdField_b_of_type_Int;
    this.bb = alde.jdField_a_of_type_Int;
    this.bd = alde.A;
    this.be = alde.jdField_o_of_type_Int;
    this.bf = alde.jdField_f_of_type_Int;
    this.bh = alde.jdField_d_of_type_Int;
    this.bI = alde.F;
    this.bJ = alde.jdField_e_of_type_Int;
    this.bK = alde.jdField_h_of_type_Int;
    this.bM = alde.y;
    this.bN = alde.jdField_c_of_type_Int;
    this.bQ = alde.jdField_v_of_type_Int;
    this.bR = alde.D;
  }
  ...
  public void v()
  {
    ...
    this.bn = alde.jdField_i_of_type_Int;
    this.bo = alde.jdField_s_of_type_Int;
    this.bw = alde.z;
    this.bp = alde.jdField_s_of_type_Int;
    this.bq = alde.jdField_s_of_type_Int;
    this.br = alde.jdField_g_of_type_Int;
    this.bs = alde.jdField_g_of_type_Int;
    this.bx = alde.jdField_s_of_type_Int;
    this.bt = alde.jdField_j_of_type_Int;
    this.bu = alde.jdField_p_of_type_Int;
    this.bv = alde.jdField_s_of_type_Int;
    this.by = alde.jdField_s_of_type_Int;
    this.bz = alde.jdField_r_of_type_Int;
    this.bA = alde.jdField_p_of_type_Int;
    this.bB = alde.jdField_n_of_type_Int;
    this.jdField_r_of_type_Int = Color.argb(255, 119, 119, 119);
    this.bC = alde.jdField_h_of_type_Int;
    this.bD = alde.jdField_r_of_type_Int;
    this.bE = alde.jdField_e_of_type_Int;
    this.jdField_s_of_type_Int = Color.argb(76, 0, 104, 144);
    this.bF = alde.jdField_l_of_type_Int;
    this.bG = alde.jdField_i_of_type_Int;
    this.bH = 0.0F;
    this.bI = alde.F;
    this.bJ = alde.jdField_e_of_type_Int;
    this.t = -1;
    ...
    this.bQ = alde.jdField_v_of_type_Int;
    this.bR = alde.D;
    this.w = alde.jdField_k_of_type_Int;
    this.aV = 0.0F;
    this.aW = 0.0F;
    this.bc = 0.0F;
    this.bi = 0.0F;
