...
public abstract class ObjectBaseData
{
  ...
  public ObjectBaseData(Context paramContext)
  {
    ...
    this.jdField_f_of_type_JavaLangString = anni.a(2131706460);
  ...
  private void a()
  {
    ...
    this.jdField_b_of_type_AndroidGraphicsPaint.setStrokeWidth(aowz.jdField_b_of_type_Int);
  ...
  public void b()
  {
    this.jdField_f_of_type_Float = aowz.I;
    this.jdField_i_of_type_Float = aowz.jdField_h_of_type_Int;
    this.jdField_n_of_type_Float = aowz.jdField_i_of_type_Int;
    this.B = aowz.L;
    this.E = aowz.jdField_c_of_type_Int;
    this.L = aowz.G;
    this.O = aowz.H;
    this.P = aowz.jdField_b_of_type_Int;
    this.X = aowz.G;
    this.Y = aowz.jdField_c_of_type_Int;
    this.ag = aowz.G;
    this.ai = aowz.jdField_u_of_type_Int;
    this.am = aowz.jdField_q_of_type_Int;
    this.an = aowz.jdField_b_of_type_Int;
    this.ay = aowz.jdField_c_of_type_Int;
    this.aB = aowz.jdField_k_of_type_Int;
    this.aH = aowz.x;
    this.aD = aowz.C;
    this.aE = aowz.jdField_u_of_type_Int;
    this.aL = aowz.x;
    this.aM = aowz.x;
    this.aN = aowz.jdField_p_of_type_Int;
    this.aP = aowz.jdField_r_of_type_Int;
    this.aQ = aowz.jdField_r_of_type_Int;
    this.aR = aowz.jdField_j_of_type_Int;
    this.aH = aowz.jdField_r_of_type_Int;
    this.aS = aowz.jdField_k_of_type_Int;
    this.aT = aowz.jdField_m_of_type_Int;
    this.aU = 0.0F;
    this.aX = aowz.jdField_m_of_type_Int;
    this.aY = aowz.jdField_b_of_type_Int;
    this.bb = aowz.jdField_a_of_type_Int;
    this.bd = aowz.A;
    this.be = aowz.jdField_o_of_type_Int;
    this.bf = aowz.jdField_f_of_type_Int;
    this.bh = aowz.jdField_d_of_type_Int;
    this.bI = aowz.F;
    this.bJ = aowz.jdField_e_of_type_Int;
    this.bK = aowz.jdField_h_of_type_Int;
    this.bM = aowz.y;
    this.bN = aowz.jdField_c_of_type_Int;
    this.bQ = aowz.jdField_v_of_type_Int;
    this.bR = aowz.D;
  }
  ...
  public void v()
  {
    ...
    this.bn = aowz.jdField_i_of_type_Int;
    this.bo = aowz.jdField_s_of_type_Int;
    this.bw = aowz.z;
    this.bp = aowz.jdField_s_of_type_Int;
    this.bq = aowz.jdField_s_of_type_Int;
    this.br = aowz.jdField_g_of_type_Int;
    this.bs = aowz.jdField_g_of_type_Int;
    this.bx = aowz.jdField_s_of_type_Int;
    this.bt = aowz.jdField_j_of_type_Int;
    this.bu = aowz.jdField_p_of_type_Int;
    this.bv = aowz.jdField_s_of_type_Int;
    this.by = aowz.jdField_s_of_type_Int;
    this.bz = aowz.jdField_r_of_type_Int;
    this.bA = aowz.jdField_p_of_type_Int;
    this.bB = aowz.jdField_n_of_type_Int;
    this.jdField_r_of_type_Int = Color.argb(255, 119, 119, 119);
    this.bC = aowz.jdField_h_of_type_Int;
    this.bD = aowz.jdField_r_of_type_Int;
    this.bE = aowz.jdField_e_of_type_Int;
    this.jdField_s_of_type_Int = Color.argb(76, 0, 104, 144);
    this.bF = aowz.jdField_l_of_type_Int;
    this.bG = aowz.jdField_i_of_type_Int;
    this.bH = 0.0F;
    this.bI = aowz.F;
    this.bJ = aowz.jdField_e_of_type_Int;
    this.t = -1;
    ...
    this.bQ = aowz.jdField_v_of_type_Int;
    this.bR = aowz.D;
    this.w = aowz.jdField_k_of_type_Int;
    this.aV = 0.0F;
    this.aW = 0.0F;
    this.bc = 0.0F;
    this.bi = 0.0F;
