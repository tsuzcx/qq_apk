...
public abstract class ObjectBaseData
{
  ...
  public ObjectBaseData(Context paramContext)
  {
    ...
    this.jdField_f_of_type_JavaLangString = anvx.a(2131707143);
  ...
  private void a()
  {
    ...
    this.jdField_b_of_type_AndroidGraphicsPaint.setStrokeWidth(aphe.jdField_b_of_type_Int);
  ...
  public void b()
  {
    this.jdField_f_of_type_Float = aphe.I;
    this.jdField_i_of_type_Float = aphe.jdField_h_of_type_Int;
    this.jdField_n_of_type_Float = aphe.jdField_i_of_type_Int;
    this.B = aphe.L;
    this.E = aphe.jdField_c_of_type_Int;
    this.L = aphe.G;
    this.O = aphe.H;
    this.P = aphe.jdField_b_of_type_Int;
    this.X = aphe.G;
    this.Y = aphe.jdField_c_of_type_Int;
    this.ag = aphe.G;
    this.ai = aphe.jdField_u_of_type_Int;
    this.am = aphe.jdField_q_of_type_Int;
    this.an = aphe.jdField_b_of_type_Int;
    this.ay = aphe.jdField_c_of_type_Int;
    this.aB = aphe.jdField_k_of_type_Int;
    this.aH = aphe.x;
    this.aD = aphe.C;
    this.aE = aphe.jdField_u_of_type_Int;
    this.aL = aphe.x;
    this.aM = aphe.x;
    this.aN = aphe.jdField_p_of_type_Int;
    this.aP = aphe.jdField_r_of_type_Int;
    this.aQ = aphe.jdField_r_of_type_Int;
    this.aR = aphe.jdField_j_of_type_Int;
    this.aH = aphe.jdField_r_of_type_Int;
    this.aS = aphe.jdField_k_of_type_Int;
    this.aT = aphe.jdField_m_of_type_Int;
    this.aU = 0.0F;
    this.aX = aphe.jdField_m_of_type_Int;
    this.aY = aphe.jdField_b_of_type_Int;
    this.bb = aphe.jdField_a_of_type_Int;
    this.bd = aphe.A;
    this.be = aphe.jdField_o_of_type_Int;
    this.bf = aphe.jdField_f_of_type_Int;
    this.bh = aphe.jdField_d_of_type_Int;
    this.bI = aphe.F;
    this.bJ = aphe.jdField_e_of_type_Int;
    this.bK = aphe.jdField_h_of_type_Int;
    this.bM = aphe.y;
    this.bN = aphe.jdField_c_of_type_Int;
    this.bQ = aphe.jdField_v_of_type_Int;
    this.bR = aphe.D;
  }
  ...
  public void v()
  {
    ...
    this.bn = aphe.jdField_i_of_type_Int;
    this.bo = aphe.jdField_s_of_type_Int;
    this.bw = aphe.z;
    this.bp = aphe.jdField_s_of_type_Int;
    this.bq = aphe.jdField_s_of_type_Int;
    this.br = aphe.jdField_g_of_type_Int;
    this.bs = aphe.jdField_g_of_type_Int;
    this.bx = aphe.jdField_s_of_type_Int;
    this.bt = aphe.jdField_j_of_type_Int;
    this.bu = aphe.jdField_p_of_type_Int;
    this.bv = aphe.jdField_s_of_type_Int;
    this.by = aphe.jdField_s_of_type_Int;
    this.bz = aphe.jdField_r_of_type_Int;
    this.bA = aphe.jdField_p_of_type_Int;
    this.bB = aphe.jdField_n_of_type_Int;
    this.jdField_r_of_type_Int = Color.argb(255, 119, 119, 119);
    this.bC = aphe.jdField_h_of_type_Int;
    this.bD = aphe.jdField_r_of_type_Int;
    this.bE = aphe.jdField_e_of_type_Int;
    this.jdField_s_of_type_Int = Color.argb(76, 0, 104, 144);
    this.bF = aphe.jdField_l_of_type_Int;
    this.bG = aphe.jdField_i_of_type_Int;
    this.bH = 0.0F;
    this.bI = aphe.F;
    this.bJ = aphe.jdField_e_of_type_Int;
    this.t = -1;
    ...
    this.bQ = aphe.jdField_v_of_type_Int;
    this.bR = aphe.D;
    this.w = aphe.jdField_k_of_type_Int;
    this.aV = 0.0F;
    this.aW = 0.0F;
    this.bc = 0.0F;
    this.bi = 0.0F;
