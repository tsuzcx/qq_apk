  ...
  implements Handler.Callback, Manager
{
  ...
  public ArResourceManager(AppInterface paramAppInterface)
  {
    ...
    ThreadManager.post(new zyc(this), 8, null, true);
  ...
  public ArDownloadInfo a(String paramString)
  {
    ...
    //   1: monitorenter
    //   2: aload_1
    //   3: invokestatic 164	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   6: istore_2
    //   7: iload_2
    //   8: ifeq +9 -> 17
    //   11: aconst_null
    ...
    //   16: areturn
    //   17: aload_0
    //   18: getfield 101	com/tencent/mobileqq/ar/ArResourceManager:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   21: ldc 166
    //   23: aload_1
    //   24: invokevirtual 171	com/tencent/mobileqq/persistence/EntityManager:a	(Ljava/lang/Class;Ljava/lang/String;)Lcom/tencent/mobileqq/persistence/Entity;
    //   27: checkcast 166	com/tencent/mobileqq/ar/model/ArDownloadInfo
    //   30: astore_3
    //   31: aload_3
    //   32: astore_1
    //   33: invokestatic 136	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   36: ifeq -23 -> 13
    //   39: ldc 138
    //   41: iconst_2
    //   42: new 41	java/lang/StringBuilder
    //   45: dup
    //   46: invokespecial 42	java/lang/StringBuilder:<init>	()V
    //   49: ldc 173
    //   51: invokevirtual 48	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   54: aload_3
    //   55: invokevirtual 176	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   58: invokevirtual 55	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   61: invokestatic 144	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   64: aload_3
    //   65: astore_1
    //   66: goto -53 -> 13
    //   69: astore_1
  ...
  public void a(ArConfigInfo paramArConfigInfo)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        Object localObject3;
        if ((((ArCloudConfigInfo)localObject2).jdField_a_of_type_Int == 1) && (((ArCloudConfigInfo)localObject2).jdField_a_of_type_ComTencentMobileqqArModelArAwardInfo != null))
        {
          if (!TextUtils.isEmpty(((ArCloudConfigInfo)localObject2).jdField_a_of_type_ComTencentMobileqqArModelArAwardInfo.b))
          {
            i = ((ArCloudConfigInfo)localObject2).jdField_a_of_type_ComTencentMobileqqArModelArAwardInfo.b.lastIndexOf("/");
            localObject3 = ((ArCloudConfigInfo)localObject2).jdField_a_of_type_ComTencentMobileqqArModelArAwardInfo.b.substring(i + 1);
            ((ArCloudConfigInfo)localObject2).jdField_a_of_type_ComTencentMobileqqArModelArAwardInfo.e = (this.jdField_a_of_type_JavaLangString + "ar_marker_award/" + ((ArCloudConfigInfo)localObject2).jdField_a_of_type_Int + File.separator + MD5.toMD5(((ArCloudConfigInfo)localObject2).jdField_a_of_type_ComTencentMobileqqArModelArAwardInfo.b) + "_" + (String)localObject3);
          }
          if (!TextUtils.isEmpty(((ArCloudConfigInfo)localObject2).jdField_a_of_type_ComTencentMobileqqArModelArAwardInfo.jdField_a_of_type_JavaLangString))
          {
            i = ((ArCloudConfigInfo)localObject2).jdField_a_of_type_ComTencentMobileqqArModelArAwardInfo.jdField_a_of_type_JavaLangString.lastIndexOf("/");
            localObject3 = ((ArCloudConfigInfo)localObject2).jdField_a_of_type_ComTencentMobileqqArModelArAwardInfo.jdField_a_of_type_JavaLangString.substring(i + 1);
            ((ArCloudConfigInfo)localObject2).jdField_a_of_type_ComTencentMobileqqArModelArAwardInfo.f = (this.jdField_a_of_type_JavaLangString + "ar_marker_award/" + ((ArCloudConfigInfo)localObject2).jdField_a_of_type_Int + File.separator + MD5.toMD5(((ArCloudConfigInfo)localObject2).jdField_a_of_type_ComTencentMobileqqArModelArAwardInfo.jdField_a_of_type_JavaLangString) + "_" + (String)localObject3);
          }
        }
  ...
  public void a(ArDownloadInfo paramArDownloadInfo)
  {
    ...
    //   8: return
    //   9: aload_0
    //   10: getfield 101	com/tencent/mobileqq/ar/ArResourceManager:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   13: invokevirtual 420	com/tencent/mobileqq/persistence/EntityManager:a	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   16: astore_2
    //   17: aload_2
    //   18: invokevirtual 423	com/tencent/mobileqq/persistence/EntityTransaction:a	()V
    //   21: aload_0
    //   22: getfield 101	com/tencent/mobileqq/ar/ArResourceManager:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   25: aload_1
    //   26: invokevirtual 426	com/tencent/mobileqq/persistence/EntityManager:b	(Lcom/tencent/mobileqq/persistence/Entity;)V
    //   29: aload_2
    //   30: invokevirtual 428	com/tencent/mobileqq/persistence/EntityTransaction:c	()V
    //   33: aload_2
    //   34: invokevirtual 429	com/tencent/mobileqq/persistence/EntityTransaction:b	()V
    //   37: goto -31 -> 6
    //   40: astore_1
    //   41: aload_0
    //   42: monitorexit
    ...
    //   44: athrow
    //   45: astore_1
    //   46: invokestatic 136	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   49: ifeq +7 -> 56
    //   52: aload_1
    //   53: invokevirtual 432	java/lang/Exception:printStackTrace	()V
    //   56: aload_2
    //   57: invokevirtual 429	com/tencent/mobileqq/persistence/EntityTransaction:b	()V
    //   60: goto -54 -> 6
    //   63: astore_1
    //   64: aload_2
    //   65: invokevirtual 429	com/tencent/mobileqq/persistence/EntityTransaction:b	()V
    //   68: aload_1
    //   69: athrow
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  public boolean a()
  {
    ...
    for (int i = 3; i == 1; i = this.jdField_a_of_type_ComTencentMobileqqArArDownloadDPC.jdField_a_of_type_Int) {
      return true;
    }
  ...
  public boolean a(ArConfigInfo paramArConfigInfo)
  {
    ...
    //   31: invokestatic 144	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   34: aload_1
    //   35: aload_0
    //   36: getfield 33	com/tencent/mobileqq/ar/ArResourceManager:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    //   39: invokevirtual 181	com/tencent/common/app/AppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   42: invokestatic 498	com/tencent/mobileqq/ar/aidl/ArConfigInfo:saveArConfigToFile	(Lcom/tencent/mobileqq/ar/aidl/ArConfigInfo;Ljava/lang/String;)Z
    //   45: ifeq +14 -> 59
    //   48: aload_0
    //   49: aload_1
    //   50: putfield 130	com/tencent/mobileqq/ar/ArResourceManager:jdField_a_of_type_ComTencentMobileqqArAidlArConfigInfo	Lcom/tencent/mobileqq/ar/aidl/ArConfigInfo;
    //   53: iconst_1
    //   54: istore_2
    //   55: aload_0
    //   56: monitorexit
  ...
  public boolean a(String paramString)
  {
    ...
    do
    {
      ...
      {
        return bool1;
        i = this.jdField_a_of_type_ComTencentMobileqqArArDownloadDPC.b;
        break;
        j = this.jdField_a_of_type_ComTencentMobileqqArArDownloadDPC.c;
        break label55;
      }
  ...
  public void b(ArConfigInfo paramArConfigInfo, boolean paramBoolean1, boolean paramBoolean2)
  {
    for (;;)
    {
      try
      {
        ...
        if (!NetworkUtil.d(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp()))
        {
          if (!QLog.isColorLevel()) {
            continue;
          }
      ...
      else if (!a())
      {
        ...
        label218:
        ThreadManager.post(new zyd(this, paramArConfigInfo, paramBoolean1, paramBoolean2), 5, null, true);
      }
    }
  }
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqArArDownloadDPC == null) {}
    for (int i = 1; i == 1; i = this.jdField_a_of_type_ComTencentMobileqqArArDownloadDPC.e) {
      return true;
    }
    return false;
  }
  ...
  public int c()
  {
    ...
    if (localArEffectConfig != null) {
      i = localArEffectConfig.jdField_a_of_type_Int;
    }
    if (QLog.isColorLevel()) {
  ...
  public void c()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqArArDownloadDPC.jdField_a_of_type_Int = Integer.valueOf(localObject[4]).intValue();
      this.jdField_a_of_type_ComTencentMobileqqArArDownloadDPC.b = Integer.valueOf(localObject[5]).intValue();
      this.jdField_a_of_type_ComTencentMobileqqArArDownloadDPC.c = Integer.valueOf(localObject[6]).intValue();
      this.jdField_a_of_type_ComTencentMobileqqArArDownloadDPC.jdField_d_of_type_Int = Integer.valueOf(localObject[7]).intValue();
      this.jdField_a_of_type_ComTencentMobileqqArArDownloadDPC.e = Integer.valueOf(localObject[8]).intValue();
      i = 0;
    }
    catch (Exception localException)
    {
    ...
    if (i != 0)
    {
      this.jdField_a_of_type_ComTencentMobileqqArArDownloadDPC.jdField_a_of_type_Int = 3;
      this.jdField_a_of_type_ComTencentMobileqqArArDownloadDPC.b = 3;
      this.jdField_a_of_type_ComTencentMobileqqArArDownloadDPC.c = 1000;
      this.jdField_a_of_type_ComTencentMobileqqArArDownloadDPC.jdField_d_of_type_Int = 1;
      this.jdField_a_of_type_ComTencentMobileqqArArDownloadDPC.e = 1;
    }
  ...
  public int d()
  {
    ...
    return this.jdField_a_of_type_ComTencentMobileqqArArDownloadDPC.jdField_a_of_type_Int;
  }
    ...
    for (;;)
    {
      try
      {
        if (i < this.jdField_a_of_type_JavaUtilVector.size())
        {
          ...
          {
            ((IArConfigListener)((WeakReference)localObject1).get()).b();
          }
        }
        else
        {
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    {
      ArConfigUtils.b(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), bool1, i);
      ...
      for (bool1 = true;; bool1 = false)
      {
        ...
        for (paramMessage = "1";; paramMessage = "0")
        {
          ...
          StatisticCollector.a(BaseApplicationImpl.getContext()).a(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), "olympic_ar_native_so_report", bool1, 0L, 0L, (HashMap)localObject, null);
        ...
        for (;;)
        {
          try
          {
            ...
            if (FileUtils.a(((ArCloudConfigInfo)localObject).jdField_a_of_type_ComTencentMobileqqArModelArFeatureInfo.c)) {
              break label432;
            }
            bool1 = false;
            ArConfigUtils.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), bool1, bool2);
          ...
          {
            bool1 = FileUtils.a(((ArCloudConfigInfo)localObject).jdField_a_of_type_ComTencentMobileqqArModelArModelResource.f);
            if (!bool1)
            {
              bool1 = true;
              bool2 = false;
