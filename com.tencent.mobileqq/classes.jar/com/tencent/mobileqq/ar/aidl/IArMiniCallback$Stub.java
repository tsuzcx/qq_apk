...
public abstract class IArMiniCallback$Stub
  extends Binder
  implements IArMiniCallback
{
  public IArMiniCallback$Stub()
  {
    attachInterface(this, "com.tencent.mobileqq.ar.aidl.IArMiniCallback");
  }
  
  public static IArMiniCallback a(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("com.tencent.mobileqq.ar.aidl.IArMiniCallback");
    if ((localIInterface != null) && ((localIInterface instanceof IArMiniCallback))) {
      return (IArMiniCallback)localIInterface;
    }
    return new IArMiniCallback.Stub.Proxy(paramIBinder);
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.ar.aidl.IArMiniCallback.Stub
