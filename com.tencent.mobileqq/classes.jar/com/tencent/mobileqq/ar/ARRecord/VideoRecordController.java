  ...
  implements Handler.Callback, ARVideoRecordDataSource, VideoEncoder.VideoEncoderCallback
{
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_b_of_type_Int == -1) {
      this.jdField_b_of_type_Int = 2130838761;
    }
    try
    {
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          paramInt1 = 1024000;
          this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecEncoderEncodeConfig = new EncodeConfig(str, 540, paramInt2 * 16, paramInt1, 1, false, 0);
    ...
    do
    {
      do
      {
        do
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqArARRecordVideoRecordController$RecordListener.h();
          return true;
        } while ((this.jdField_a_of_type_ComTencentMobileqqArARRecordVideoRecordController$RecordListener == null) || (this.jdField_b_of_type_Boolean));
