...
public class ARVideoRecordViewProxy$6
  implements Runnable
{
  public ARVideoRecordViewProxy$6(apdp paramapdp, int paramInt) {}
  
  public void run()
  {
    if (this.a == 0)
    {
      apdp.a(this.this$0).setShowState(2);
      apdp.a(this.this$0);
      apdp.a(this.this$0, 0);
    ...
    do
    {
      ...
      apdp.a(this.this$0).setShowState(3);
      apdp.a(this.this$0).setVisibility(0);
      apdp.b(this.this$0).setVisibility(0);
      apdp.a(this.this$0, 1);
