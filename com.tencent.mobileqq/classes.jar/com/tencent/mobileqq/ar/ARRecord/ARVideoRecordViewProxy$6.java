...
public class ARVideoRecordViewProxy$6
  implements Runnable
{
  public ARVideoRecordViewProxy$6(amqf paramamqf, int paramInt) {}
  
  public void run()
  {
    if (this.a == 0)
    {
      amqf.a(this.this$0).setShowState(2);
      amqf.a(this.this$0);
      amqf.a(this.this$0, 0);
    ...
    do
    {
      ...
      amqf.a(this.this$0).setShowState(3);
      amqf.a(this.this$0).setVisibility(0);
      amqf.b(this.this$0).setVisibility(0);
      amqf.a(this.this$0, 1);
