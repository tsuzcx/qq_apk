...
public class OnlineVideoARRenderable$4
  implements Runnable
{
  public OnlineVideoARRenderable$4(albd paramalbd, TVK_IMediaPlayer paramTVK_IMediaPlayer) {}
  ...
  public void run()
  {
    for (;;)
    {
      try
      {
        ...
        localTVK_PlayerVideoInfo.setConfigMap("filesize", String.valueOf(albd.a(this.this$0)));
        localTVK_PlayerVideoInfo.setPlayMode("cache_extend_video");
        localTVK_PlayerVideoInfo.setVid(bdhv.d(albd.a(this.this$0)));
        localObject = new HashMap();
        ((Map)localObject).put("shouq_bus_type", "shouq_ar_online_video");
        localTVK_PlayerVideoInfo.setReportInfoMap((Map)localObject);
        albd.a(this.this$0).openMediaPlayerByUrl(BaseApplicationImpl.getContext(), albd.a(this.this$0), 0L, 0L, localTVK_UserInfo, localTVK_PlayerVideoInfo);
        albd.e(this.this$0);
        return;
      }
