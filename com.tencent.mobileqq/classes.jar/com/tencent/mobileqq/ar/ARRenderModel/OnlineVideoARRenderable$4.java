...
public class OnlineVideoARRenderable$4
  implements Runnable
{
  public OnlineVideoARRenderable$4(akmr paramakmr, TVK_IMediaPlayer paramTVK_IMediaPlayer) {}
  ...
  public void run()
  {
    for (;;)
    {
      try
      {
        ...
        localTVK_PlayerVideoInfo.setConfigMap("filesize", String.valueOf(akmr.a(this.this$0)));
        localTVK_PlayerVideoInfo.setPlayMode("cache_extend_video");
        localTVK_PlayerVideoInfo.setVid(bcdu.d(akmr.a(this.this$0)));
        localObject = new HashMap();
        ((Map)localObject).put("shouq_bus_type", "shouq_ar_online_video");
        localTVK_PlayerVideoInfo.setReportInfoMap((Map)localObject);
        akmr.a(this.this$0).openMediaPlayerByUrl(BaseApplicationImpl.getContext(), akmr.a(this.this$0), 0L, 0L, localTVK_UserInfo, localTVK_PlayerVideoInfo);
        akmr.e(this.this$0);
        return;
      }
