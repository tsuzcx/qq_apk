  ...
  implements Runnable
{
  public void run()
  {
    alav.a(this.this$0).native_onTouchEnd(this.jdField_a_of_type_Int, this.jdField_a_of_type_Float, this.b, 1, this.jdField_a_of_type_Long, alav.a(this.this$0).mCurrentActiveId);
