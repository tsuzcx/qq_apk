  ...
  implements Runnable
{
  public void run()
  {
    alaw.a(this.this$0).native_onTouchBegin(this.jdField_a_of_type_Int, this.jdField_a_of_type_Float, this.b, 0, this.jdField_a_of_type_Long, alaw.a(this.this$0).mCurrentActiveId);
