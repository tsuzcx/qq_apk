...
public class ARRenerArumentManager
{
  ...
  public ARRenerArumentManager.DrawFrameParements a(int paramInt1, int paramInt2)
  {
    ...
    if ((this.jdField_h_of_type_Boolean) && (((paramInt2 == 0) && (!this.jdField_c_of_type_Boolean)) || (paramInt2 == 2) || ((paramInt2 == 1) && (!this.jdField_d_of_type_Boolean))))
    {
      ...
      arrayOfFloat2 = new float[jdField_a_of_type_Int];
      arrayOfFloat3 = new float[jdField_a_of_type_Int];
      localObject = new float[jdField_a_of_type_Int];
      System.arraycopy(this.o, 0, arrayOfFloat1, 0, 2);
      System.arraycopy(this.p, 0, arrayOfFloat2, 0, jdField_a_of_type_Int);
      System.arraycopy(this.q, 0, arrayOfFloat3, 0, jdField_a_of_type_Int);
      System.arraycopy(this.r, 0, localObject, 0, jdField_a_of_type_Int);
      localDrawFrameParements = new ARRenerArumentManager.DrawFrameParements();
      localDrawFrameParements.a("TARGET_SIZE", arrayOfFloat1);
      localDrawFrameParements.a("CAMERA_MATRIX", localObject);
      localDrawFrameParements.a("CAMERA_POSITION", arrayOfFloat2);
      localDrawFrameParements.a("POSE", arrayOfFloat3);
    ...
    Object localObject = new float[jdField_a_of_type_Int];
    if (paramInt1 == 0) {
      if (a(this.jdField_i_of_type_ArrayOfFloat))
      {
        ...
        System.arraycopy(this.w, 0, arrayOfFloat3, 0, jdField_a_of_type_Int);
        System.arraycopy(this.w, 0, localObject, 0, jdField_a_of_type_Int);
      }
    }
    for (;;)
    {
      ...
      System.arraycopy(arrayOfFloat3, 0, this.q, 0, jdField_a_of_type_Int);
      System.arraycopy(localObject, 0, this.r, 0, jdField_a_of_type_Int);
      ...
      if (paramInt2 == 0)
      {
        ...
        System.arraycopy(this.jdField_b_of_type_ArrayOfFloat, 0, arrayOfFloat3, 0, jdField_a_of_type_Int);
        System.arraycopy(this.jdField_b_of_type_ArrayOfFloat, 0, localObject, 0, jdField_a_of_type_Int);
        System.arraycopy(localObject, 0, this.j, 0, jdField_a_of_type_Int);
      }
      else if (paramInt2 == 1)
      {
        ...
        System.arraycopy(this.jdField_d_of_type_ArrayOfFloat, 0, localObject, 0, jdField_a_of_type_Int);
        System.arraycopy(localObject, 0, this.j, 0, jdField_a_of_type_Int);
      }
      else if (paramInt2 == 2)
      {
        ...
        if ((paramInt1 == 2) || (paramInt1 == 3) || (paramInt1 == 4))
        {
          if (paramInt2 == 0)
          {
            ...
            System.arraycopy(this.jdField_h_of_type_ArrayOfFloat, 0, arrayOfFloat2, 0, jdField_a_of_type_Int);
            this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.lock();
            System.arraycopy(this.jdField_i_of_type_ArrayOfFloat, 0, arrayOfFloat3, 0, jdField_a_of_type_Int);
            this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.unlock();
            if (this.jdField_c_of_type_Int == 1) {}
            for (;;)
            {
              System.arraycopy(arrayOfFloat3, 0, localObject, 0, jdField_a_of_type_Int);
              System.arraycopy(localObject, 0, this.j, 0, jdField_a_of_type_Int);
              break;
              Matrix.translateM(arrayOfFloat3, 0, arrayOfFloat1[0] / 2.0F, arrayOfFloat1[1] / 2.0F, 0.0F);
            }
          }
          if (paramInt2 == 1)
          {
            ...
            System.arraycopy(this.jdField_i_of_type_ArrayOfFloat, 0, arrayOfFloat3, 0, jdField_a_of_type_Int);
            Matrix.translateM(arrayOfFloat3, 0, arrayOfFloat1[0] / 2.0F, arrayOfFloat1[1] / 2.0F, 0.0F);
            Matrix.multiplyMM((float[])localObject, 0, this.u, 0, arrayOfFloat3, 0);
            this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.lock();
            Matrix.multiplyMM((float[])localObject, 0, this.t, 0, (float[])localObject, 0);
            this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.unlock();
            Matrix.multiplyMM((float[])localObject, 0, this.v, 0, (float[])localObject, 0);
            System.arraycopy(localObject, 0, this.j, 0, jdField_a_of_type_Int);
          }
          else if (paramInt2 == 2)
          {
  ...
  public void a(int paramInt1, int paramInt2, ArCloudConfigInfo.ARVideoLayout paramARVideoLayout)
  {
    ...
    if (paramInt2 == 0) {
      ...
      {
        this.k[0] = ARRenderManagerImpl.jdField_a_of_type_Int;
        this.k[1] = ARRenderManagerImpl.jdField_b_of_type_Int;
        paramARVideoLayout = new float[jdField_a_of_type_Int];
        Matrix.setIdentityM(paramARVideoLayout, 0);
        Matrix.perspectiveM(paramARVideoLayout, 0, 45.0F, 1.0F * ARRenderManagerImpl.jdField_b_of_type_Int / ARRenderManagerImpl.jdField_a_of_type_Int, 100.0F, 8000.0F);
        ...
        f1 = 1.25F;
        if (this.k[0] <= ARRenderManagerImpl.jdField_a_of_type_Int) {
          break label665;
        }
        f2 = this.k[0];
        if (this.k[0] == 0.0F) {
        ...
        f3 = this.k[1] / this.k[0] / (1.0F * ARRenderManagerImpl.jdField_b_of_type_Int / ARRenderManagerImpl.jdField_a_of_type_Int);
        label233:
        if ((f3 <= 1.0F) || (this.k[1] <= ARRenderManagerImpl.jdField_b_of_type_Int)) {
          break label680;
        }
        f1 *= f3;
      }
    ...
    for (;;)
    {
      ...
      f1 = 1.0F;
      break label173;
      f2 = ARRenderManagerImpl.jdField_a_of_type_Int;
      break label195;
      f3 = 1.0F;
      break label233;
    }
