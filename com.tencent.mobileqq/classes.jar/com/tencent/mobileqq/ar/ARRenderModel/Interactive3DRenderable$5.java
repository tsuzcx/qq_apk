  ...
  implements Runnable
{
  public void run()
  {
    aour.a(this.this$0).native_onTouchMove(this.jdField_a_of_type_ArrayOfInt, this.jdField_a_of_type_ArrayOfFloat, this.b, this.jdField_a_of_type_Long, aour.a(this.this$0).mCurrentActiveId);
