  ...
  implements Runnable
{
  public void run()
  {
    amrl.a(this.this$0).native_onTouchEnd(this.jdField_a_of_type_Int, this.jdField_a_of_type_Float, this.b, 6, this.jdField_a_of_type_Long, amrl.a(this.this$0).mCurrentActiveId);
