  ...
  implements Runnable
{
  public void run()
  {
    amwa.a(this.this$0).native_onTouchCancel(this.jdField_a_of_type_ArrayOfInt, this.jdField_a_of_type_ArrayOfFloat, this.b, this.jdField_a_of_type_Long, amwa.a(this.this$0).mCurrentActiveId);
