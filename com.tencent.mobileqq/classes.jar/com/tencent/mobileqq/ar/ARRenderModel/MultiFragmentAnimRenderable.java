  ...
  implements Handler.Callback, ARBaseRender, ARRenderMangerInnerCallback
{
  ...
  private ARRenderResourceInfo a(ArVideoResourceInfo paramArVideoResourceInfo)
  {
    ...
    {
      ThreadManager.getUIHandler().post(new zwt(this));
    ...
    return AREngine.a(localArCloudConfigInfo, true, this.jdField_a_of_type_ComTencentMobileqqArARRenderModelMultiFragmentAnimARResourceInfo.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqArARRenderModelMultiFragmentAnimARResourceInfo.jdField_c_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqArARRenderModelMultiFragmentAnimARResourceInfo.jdField_a_of_type_Float, this.jdField_a_of_type_ComTencentMobileqqArARRenderModelMultiFragmentAnimARResourceInfo.b, this.jdField_a_of_type_ComTencentMobileqqArARRenderModelMultiFragmentAnimARResourceInfo.jdField_c_of_type_Float);
  }
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqArARRenderModelARRenderMangerInnerCallback.a(new zwu(this, localARBaseRender));
  }
  ...
  public int a()
  {
    ...
    {
      if ((!this.jdField_a_of_type_ComTencentMobileqqArARRenderModelARBaseRender.b()) && (this.jdField_b_of_type_ComTencentMobileqqArARRenderModelARBaseRender != null)) {
        return this.jdField_b_of_type_ComTencentMobileqqArARRenderModelARBaseRender.a();
      }
      return this.jdField_a_of_type_ComTencentMobileqqArARRenderModelARBaseRender.a();
    }
    return 5;
  }
    ...
    do
    {
      do
      {
        do
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqArARRenderModelARRenderMangerInnerCallback.a(paramInt1, paramInt2);
          return;
        ...
        this.jdField_a_of_type_ComTencentMobileqqArARRenderModelARRenderMangerInnerCallback.a(paramInt1, 0);
        return;
  ...
  public void a(ARRenerArumentManager.DrawFrameParements paramDrawFrameParements)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqArARRenderModelARBaseRender != null)
    {
      if ((!this.jdField_a_of_type_ComTencentMobileqqArARRenderModelARBaseRender.b()) && (this.jdField_b_of_type_ComTencentMobileqqArARRenderModelARBaseRender != null) && (this.jdField_a_of_type_ComTencentMobileqqArARRenderModelARRenerArumentManager$DrawFrameParements != null))
      {
    ...
    if (this.jdField_b_of_type_ComTencentMobileqqArARRenderModelARBaseRender != null) {
      this.jdField_a_of_type_ComTencentMobileqqArARRenderModelARRenderMangerInnerCallback.a(new zwv(this));
    }
  ...
  public int b()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqArARRenderModelARBaseRender != null)
    {
      if ((this.jdField_b_of_type_ComTencentMobileqqArARRenderModelARBaseRender != null) && (!this.jdField_a_of_type_ComTencentMobileqqArARRenderModelARBaseRender.b())) {
  ...
  public void d()
  {
    ...
    if (this.jdField_b_of_type_ComTencentMobileqqArARRenderModelARBaseRender != null)
    {
      this.jdField_b_of_type_ComTencentMobileqqArARRenderModelARBaseRender.d();
  ...
  public void f()
  {
    this.jdField_a_of_type_ComTencentMobileqqArARRenderModelARRenderMangerInnerCallback.f();
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqArARRenderModelARRenderMangerInnerCallback != null) {
        this.jdField_a_of_type_ComTencentMobileqqArARRenderModelARRenderMangerInnerCallback.a(new zww(this));
      }
    }
  }
}
