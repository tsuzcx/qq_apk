  ...
  implements Runnable
{
  public void run()
  {
    aobu.a(this.this$0).native_onTouchBegin(this.jdField_a_of_type_Int, this.jdField_a_of_type_Float, this.b, 5, this.jdField_a_of_type_Long, aobu.a(this.this$0).mCurrentActiveId);
