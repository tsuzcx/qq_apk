  ...
  implements Runnable
{
  public void run()
  {
    aour.a(this.this$0).native_onTouchBegin(this.jdField_a_of_type_Int, this.jdField_a_of_type_Float, this.b, 5, this.jdField_a_of_type_Long, aour.a(this.this$0).mCurrentActiveId);
