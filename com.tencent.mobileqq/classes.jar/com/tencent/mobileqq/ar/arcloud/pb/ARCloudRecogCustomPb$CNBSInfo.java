  ...
  extends MessageMicro<CNBSInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 48, 808, 816 }, new String[] { "uint32_game_id", "uint32_confirmed", "uint32_confirm_time", "uint32_be_killed", "uint32_killed_time", "uint32_key_time", "uint32_sum_num", "uint32_dead_num" }, new Object[] { localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger }, CNBSInfo.class);
  }
}
