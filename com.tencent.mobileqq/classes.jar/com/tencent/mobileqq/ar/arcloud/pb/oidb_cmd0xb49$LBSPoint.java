  ...
  extends MessageMicro<LBSPoint>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34, 40 }, new String[] { "int32_lat", "int32_lon", "str_name", "str_addr", "uint32_dist" }, new Object[] { localInteger, localInteger, "", "", Integer.valueOf(0) }, LBSPoint.class);
  }
}
