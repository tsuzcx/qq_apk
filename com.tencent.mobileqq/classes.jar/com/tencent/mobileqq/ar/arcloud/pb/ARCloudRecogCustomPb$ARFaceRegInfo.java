  ...
  extends MessageMicro<ARFaceRegInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34, 42 }, new String[] { "uint32_img_cnt", "uin32_timeout_ms", "person_id", "person_name", "group_ids" }, new Object[] { localInteger, localInteger, "", "", "" }, ARFaceRegInfo.class);
  }
}
