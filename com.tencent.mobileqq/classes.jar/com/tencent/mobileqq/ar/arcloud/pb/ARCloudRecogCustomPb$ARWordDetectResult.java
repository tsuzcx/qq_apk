  ...
  extends MessageMicro<ARWordDetectResult>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 34, 42, 48, 61, 66 }, new String[] { "errorcode", "errormsg", "ar_word_detect_errorcode", "ar_word_detect_errormsg", "session_id", "word_type", "confidence", "ocr_class" }, new Object[] { localInteger, "", localInteger, "", "", localInteger, Float.valueOf(0.0F), null }, ARWordDetectResult.class);
  }
}
