  ...
  extends MessageMicro<DetectFaceRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 24, 32, 42, 48, 58 }, new String[] { "session_id", "image_height", "image_width", "face", "errorcode", "errormsg" }, new Object[] { "", localInteger, localInteger, null, localInteger, "" }, DetectFaceRsp.class);
  }
}
