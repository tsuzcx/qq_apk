  ...
  extends MessageMicro<ImageARSearchRes>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 34, 40, 48, 56, 66 }, new String[] { "errorcode", "errormsg", "session_id", "tags", "time_ms", "score", "kpt_num", "coordinate" }, new Object[] { localInteger, "", "", null, localInteger, localInteger, localInteger, null }, ImageARSearchRes.class);
  }
}
