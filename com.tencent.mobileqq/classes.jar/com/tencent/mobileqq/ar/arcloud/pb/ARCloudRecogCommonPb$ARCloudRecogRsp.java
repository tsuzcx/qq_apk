...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 34, 42, 50, 58, 64, 74, 82, 90, 98, 106, 114, 130 }, new String[] { "str_session_id", "uin64_req_recog_type", "uin32_business_type", "msg_ar_marker_recog_result", "msg_ar_object_classify_result", "msg_face_recog_result", "msg_face_reg_result", "uint64_uin", "msg_ocr_result", "msg_game_result", "msg_word_detect_result", "msg_img_retrieval_result", "msg_face_detect_result", "msg_search_question_result", "msg_scene_classify_result" }, new Object[] { "", Long.valueOf(0L), Integer.valueOf(0), null, null, null, null, Long.valueOf(0L), null, null, null, null, null, null, null }, ARCloudRecogRsp.class);
