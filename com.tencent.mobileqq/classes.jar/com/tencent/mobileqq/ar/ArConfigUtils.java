...
public class ArConfigUtils
{
  ...
  public static void a(String paramString1, String paramString2)
  {
    ...
    //   33: new 160	com/tencent/commonsdk/zip/QZipFile
    //   36: dup
    //   37: aload_0
    //   38: invokespecial 163	com/tencent/commonsdk/zip/QZipFile:<init>	(Ljava/lang/String;)V
    //   41: astore 4
    //   43: aload 4
    //   45: invokevirtual 167	com/tencent/commonsdk/zip/QZipFile:entries	()Ljava/util/Enumeration;
    //   48: astore 7
    //   50: sipush 8192
    //   53: newarray byte
    //   55: astore 6
    ...
    //   77: astore 5
    //   79: aload 5
    //   81: invokevirtual 181	java/util/zip/ZipEntry:getName	()Ljava/lang/String;
    //   84: astore_0
    //   85: aload_0
    //   86: ifnull +410 -> 496
    //   89: aload_0
    //   90: ldc 183
    //   92: invokevirtual 188	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   95: ifeq +6 -> 101
    //   98: goto -41 -> 57
    ...
    //   115: invokevirtual 104	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   118: aload_0
    ...
    //   125: astore_0
    //   126: aload 5
    //   128: invokevirtual 191	java/util/zip/ZipEntry:isDirectory	()Z
    //   131: ifeq +27 -> 158
    //   134: new 122	java/io/File
    //   137: dup
    //   138: aload_0
    //   139: invokespecial 192	java/io/File:<init>	(Ljava/lang/String;)V
    //   142: astore_0
    //   143: aload_0
    //   144: invokevirtual 195	java/io/File:exists	()Z
    //   147: ifne +352 -> 499
    //   150: aload_0
    //   151: invokevirtual 198	java/io/File:mkdir	()Z
    //   154: pop
    //   155: goto +344 -> 499
    //   158: aload_0
    //   159: getstatic 128	java/io/File:separator	Ljava/lang/String;
    //   162: invokevirtual 202	java/lang/String:lastIndexOf	(Ljava/lang/String;)I
    //   165: istore_2
    //   166: aload_0
    //   167: iconst_0
    //   168: iload_2
    //   169: invokevirtual 206	java/lang/String:substring	(II)Ljava/lang/String;
    //   172: astore 8
    //   174: aload_0
    //   175: iload_2
    //   176: iconst_1
    //   177: iadd
    //   178: invokevirtual 209	java/lang/String:substring	(I)Ljava/lang/String;
    //   181: ldc 211
    //   183: invokevirtual 215	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   186: ifeq +6 -> 192
    //   189: goto -132 -> 57
    //   192: new 122	java/io/File
    //   195: dup
    //   196: aload 8
    //   198: invokespecial 192	java/io/File:<init>	(Ljava/lang/String;)V
    //   201: astore 8
    //   203: aload 8
    //   205: invokevirtual 195	java/io/File:exists	()Z
    //   208: ifne +9 -> 217
    //   211: aload 8
    //   213: invokevirtual 198	java/io/File:mkdir	()Z
    //   216: pop
    //   217: new 122	java/io/File
    //   220: dup
    ...
    //   237: invokevirtual 110	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   240: invokespecial 192	java/io/File:<init>	(Ljava/lang/String;)V
    //   243: astore 8
    //   245: new 122	java/io/File
    //   248: dup
    //   249: aload_0
    //   250: invokespecial 192	java/io/File:<init>	(Ljava/lang/String;)V
    //   253: astore 9
    //   255: aload 8
    //   257: invokevirtual 195	java/io/File:exists	()Z
    //   260: ifeq +9 -> 269
    //   263: aload 8
    //   265: invokevirtual 220	java/io/File:delete	()Z
    //   268: pop
    //   269: new 222	java/io/FileOutputStream
    //   272: dup
    //   273: aload 8
    //   275: invokespecial 225	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   278: astore_0
    //   279: aload 4
    //   281: aload 5
    //   283: invokevirtual 229	com/tencent/commonsdk/zip/QZipFile:getInputStream	(Ljava/util/zip/ZipEntry;)Ljava/io/InputStream;
    //   286: astore 5
    //   288: aload 5
    //   290: aload 6
    //   292: iconst_0
    //   293: aload 6
    //   295: arraylength
    //   296: invokevirtual 235	java/io/InputStream:read	([BII)I
    //   299: istore_2
    //   300: iload_2
    //   301: iconst_m1
    ...
    //   308: iconst_0
    //   309: iload_2
    //   310: invokevirtual 239	java/io/FileOutputStream:write	([BII)V
    //   313: goto -25 -> 288
    //   316: astore 6
    //   318: aload 5
    //   320: astore_1
    ...
    //   327: ifnull +7 -> 334
    //   330: aload_3
    //   331: invokevirtual 242	java/io/FileOutputStream:close	()V
    //   334: aload_1
    //   335: ifnull +7 -> 342
    //   338: aload_1
    //   339: invokevirtual 243	java/io/InputStream:close	()V
    //   342: aload 4
    //   344: ifnull +8 -> 352
    //   347: aload 4
    //   349: invokevirtual 244	com/tencent/commonsdk/zip/QZipFile:close	()V
    //   352: aload_0
    //   353: athrow
    //   354: aload_0
    //   355: invokevirtual 247	java/io/FileOutputStream:flush	()V
    //   358: aload_0
    //   359: invokevirtual 242	java/io/FileOutputStream:close	()V
    //   362: aload 5
    //   364: invokevirtual 243	java/io/InputStream:close	()V
    //   367: aload 8
    //   369: aload 9
    //   371: invokestatic 251	com/tencent/mobileqq/utils/FileUtils:b	(Ljava/io/File;Ljava/io/File;)Z
    //   374: ifne +125 -> 499
    //   377: aload 8
    //   379: aload 9
    //   381: invokestatic 253	com/tencent/mobileqq/utils/FileUtils:a	(Ljava/io/File;Ljava/io/File;)Z
    //   384: pop
    //   385: goto +114 -> 499
    //   388: astore_0
    //   389: aconst_null
    ...
    //   420: ifnull +8 -> 428
    //   423: aload 4
    //   425: invokevirtual 244	com/tencent/commonsdk/zip/QZipFile:close	()V
    //   428: return
    //   429: astore_0
    //   430: aload_0
