...
public class NeonControl$1
  implements Runnable
{
  public NeonControl$1(amtr paramamtr, SharedPreferences paramSharedPreferences, boolean paramBoolean) {}
  ...
  public void run()
  {
    ...
    for (int k = 1;; k = 0)
    {
      ...
      for (;;)
      {
        synchronized (this.this$0.a)
        {
          amtr localamtr = this.this$0;
          if ((bool3) && (bool2))
          {
            amtr.a(localamtr, bool1);
            return;
          }
        }
        bool1 = false;
