  ...
  implements OnCompositionLoadedListener
{
  ...
  public void onCompositionLoaded(@Nullable LottieComposition paramLottieComposition)
  {
    ...
    if (paramLottieComposition != null)
    {
      ...
      QRScanEntryView.f(this.a).setCompoundDrawablesWithIntrinsicBounds(null, (Drawable)localObject, null, null);
    }
    else
    {
      QLog.e("AREngine_QRScanEntryView", 1, "loadFlashLightSVGDrawable fail, use static resource.");
      QRScanEntryView.f(this.a).setCompoundDrawablesWithIntrinsicBounds(0, 2130846300, 0, 0);
      l = 0L;
    }
    paramLottieComposition = ObjectAnimator.ofFloat(QRScanEntryView.f(this.a), "alpha", new float[] { 1.0F, 0.0F, 1.0F });
    ...
    QRScanEntryView.a(paramLottieComposition, QRScanEntryView.f(paramLottieComposition), true, false);
    paramLottieComposition = this.a;
    QRScanEntryView.a(paramLottieComposition, QRScanEntryView.g(paramLottieComposition), false, true);
  }
}
