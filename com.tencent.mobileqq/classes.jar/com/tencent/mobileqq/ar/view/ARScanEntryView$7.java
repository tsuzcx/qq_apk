...
class ARScanEntryView$7
  implements Runnable
{
  ARScanEntryView$7(ARScanEntryView paramARScanEntryView, long paramLong, apsh paramapsh) {}
  ...
  public void run()
  {
    ...
    {
      i = 1;
      if (!this.jdField_a_of_type_Apsh.a(2)) {
        l1 = 0L | 0x2;
      }
      l2 = l1;
      if (!this.jdField_a_of_type_Apsh.a(8)) {
        l2 = l1 | 0x8;
      }
      if ((this.jdField_a_of_type_Apsh.a(4)) || (i == 0)) {
        break label294;
      }
      l2 |= 0x4;
    }
    for (;;)
    {
      this.jdField_a_of_type_Apsh.a(l2, ARScanEntryView.a(this.this$0), ARScanEntryView.a(this.this$0));
      boolean bool = this.jdField_a_of_type_Apsh.c();
      if ((this.jdField_a_of_type_Apsh.a(4)) || (i == 0)) {
