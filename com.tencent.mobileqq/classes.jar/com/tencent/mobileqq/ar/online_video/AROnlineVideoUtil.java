  ...
  public static void a(Context paramContext, QQAppInterface paramQQAppInterface)
  {
        ...
        do
        {
          do
          {
            do
            {
              ...
              paramQQAppInterface = (ArResourceManager)paramQQAppInterface.getManager(167);
            } while (paramQQAppInterface == null);
    ...
    for (;;)
    {
      ...
      if (!bool)
      {
        ...
        localTVK_PlayerVideoInfo.setVid(MD5Utils.d((String)localObject2));
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        for (;;)
        {
          ...
          localTVK_PlayerVideoInfo.setConfigMap("cache_duration", "60");
          localTVK_PlayerVideoInfo.setConfigMap("cache_servers_type", "20161009");
          localTVK_PlayerVideoInfo.setVid(MD5Utils.d(paramArVideoResourceInfo));
