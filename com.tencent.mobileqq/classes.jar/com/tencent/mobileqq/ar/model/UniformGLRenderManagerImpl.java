  ...
  implements ARRenderMangerInnerCallback, UniformGLRenderManager
{
  ...
  {
    QLog.i("AREngine_UniformGLRenderManagerImpl", 1, "startModelRender. resourceInfo.key = " + paramARRenderResourceInfo.jdField_a_of_type_JavaLangString + ", resourceInfo.arType = " + paramARRenderResourceInfo.jdField_a_of_type_Int + ", resourceInfo.trackMode = " + paramARRenderResourceInfo.jdField_b_of_type_Int);
    if (!this.e)
    {
    ...
    if (localARBaseRender2 == null)
    {
      ...
      QLog.d("AREngine_UniformGLRenderManagerImpl", 1, "crate new render here 1" + localARBaseRender1);
      this.jdField_a_of_type_JavaUtilMap.put(paramARRenderResourceInfo.jdField_a_of_type_JavaLangString, localARBaseRender1);
      QLog.d("AREngine_UniformGLRenderManagerImpl", 1, "crate new render here " + localARBaseRender1);
    }
    ...
    this.jdField_a_of_type_AndroidOpenglGLSurfaceView.queueEvent(new UniformGLRenderManagerImpl.2(this, localARBaseRender1, paramARRenderResourceInfo));
    return true;
  }
  ...
  public void b()
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext()) {
        ((ARBaseRender)localIterator.next()).f();
      }
  ...
  public void onSurfaceChanged(GL10 paramGL10, int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqArViewGLRenderStatusCallBack != null) {
      this.jdField_a_of_type_ComTencentMobileqqArViewGLRenderStatusCallBack.a(paramGL10, paramInt1, paramInt2);
    }
  ...
  public void onSurfaceCreated(GL10 paramGL10, EGLConfig paramEGLConfig)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqArViewGLRenderStatusCallBack != null) {
      this.jdField_a_of_type_ComTencentMobileqqArViewGLRenderStatusCallBack.a(paramGL10);
    }
