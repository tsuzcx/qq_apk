...
public class QQARSession$16
  implements Runnable
{
  public QQARSession$16(akwn paramakwn, boolean paramBoolean, ArCloudConfigInfo paramArCloudConfigInfo) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        try
        {
          awqx.b(null, "CliOper", "", "", "0X80081DE", "0X80081DE", 0, 0, this.jdField_a_of_type_ComTencentMobileqqArAidlArCloudConfigInfo.b + "", "2", "", "");
          akwn.a(this.this$0).a(2L, new akmy(this.jdField_a_of_type_ComTencentMobileqqArAidlArCloudConfigInfo));
        ...
        catch (Exception localException)
        {
          ...
          if (this.jdField_a_of_type_ComTencentMobileqqArAidlArCloudConfigInfo.f())
          {
            ...
            akwn.a(this.this$0, 2L, this.jdField_a_of_type_ComTencentMobileqqArAidlArCloudConfigInfo, -1, 0.0F, 0.0F, 0.0F);
            return;
          }
