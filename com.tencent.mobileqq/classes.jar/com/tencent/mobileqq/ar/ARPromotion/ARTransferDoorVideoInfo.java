...
public class ARTransferDoorVideoInfo
{
  ...
  public static ARTransferDoorVideoInfo a(String paramString)
  {
    ...
    //   103: aload_2
    //   104: invokestatic 100	com/tencent/mobileqq/ar/ARPromotion/ARTransferDoorVideoInfo:b	(Ljava/lang/String;)Lcom/tencent/mobileqq/ar/ARPromotion/ARTransferDoorVideoInfo;
    //   107: astore_2
    //   108: aload_0
    //   109: ifnull +7 -> 116
    //   112: aload_0
  ...
  public static ARTransferDoorVideoInfo b(String paramString)
  {
    try
    {
      ...
      ARTransferDoorVideoInfo localARTransferDoorVideoInfo = new ARTransferDoorVideoInfo();
      JSONArray localJSONArray = ((JSONObject)localObject).getJSONArray("360senceinfo");
      paramString = localARTransferDoorVideoInfo;
      if (((JSONObject)localObject).has("360senceinfo"))
      {
        ...
        if (j > 0)
        {
          ...
          for (;;)
          {
            ...
            localObject = new ARTransferDoorVideoInfo.PlayGuideShowInfo();
            if (paramString.has("text")) {
              ((ARTransferDoorVideoInfo.PlayGuideShowInfo)localObject).jdField_a_of_type_JavaLangString = paramString.optString("text");
            }
            if (paramString.has("starttime")) {
              ((ARTransferDoorVideoInfo.PlayGuideShowInfo)localObject).jdField_a_of_type_Long = paramString.optLong("starttime");
            }
            if (paramString.has("endtime")) {
              ((ARTransferDoorVideoInfo.PlayGuideShowInfo)localObject).b = paramString.optLong("endtime");
            }
            localARTransferDoorVideoInfo.a.add(localObject);
            if (QLog.isColorLevel()) {
              QLog.d("ARTransferDoorVideoInfo", 2, "ARTransferDoorVideoInfo parseJson index: " + i + "," + ((ARTransferDoorVideoInfo.PlayGuideShowInfo)localObject).toString());
            }
            i += 1;
          }
        }
