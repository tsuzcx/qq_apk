  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if ((this.jdField_a_of_type_Int > 0) && (this.jdField_a_of_type_Int < 180000))
    {
      ...
      aljv.a(localHashMap);
      localaxrl.a("", "report_tag_scan_avg_qr", true, 0L, 0L, localHashMap, "");
    }
    if ((this.d > 0) && (this.e > 0) && (this.e < 180000))
    {
      ...
      localHashMap.put("report_key_scan_suc", String.valueOf(this.c));
      aljv.a(localHashMap);
      localaxrl.a("", "report_tag_scan_avg_minidecode", true, 0L, 0L, localHashMap, "");
    }
    if ((this.f > 0) && (this.g > 0) && (this.g < 180000))
    {
      ...
      localHashMap.put("report_key_scan_suc", String.valueOf(this.c));
      aljv.a(localHashMap);
      localaxrl.a("", "report_tag_scan_avg_minidetect", true, 0L, 0L, localHashMap, "");
    }
