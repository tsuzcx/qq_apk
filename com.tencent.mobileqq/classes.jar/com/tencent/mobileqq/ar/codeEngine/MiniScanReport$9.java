  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    localHashMap.put("report_key_detect_init_process", String.valueOf(asjn.b()));
    alju.a(localHashMap);
    axrn.a(BaseApplication.getContext()).a("", "report_tag_detect_first_cost", true, 0L, 0L, localHashMap, "");
