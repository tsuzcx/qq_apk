  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    localHashMap.put("report_key_detect_init_process", String.valueOf(auew.b()));
    anet.a(localHashMap);
    azri.a(BaseApplication.getContext()).a("", "report_tag_detect_first_cost", true, 0L, 0L, localHashMap, "");
