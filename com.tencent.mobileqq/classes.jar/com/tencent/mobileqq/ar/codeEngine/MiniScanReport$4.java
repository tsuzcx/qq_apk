  ...
  implements Runnable
{
  ...
  public void run()
  {
    long l1 = alju.a("report_tag_detect_support_easy", 0L);
    ...
    if (l2 - l1 > 86400000L)
    {
      ...
      alju.a(localHashMap);
      axrn.a(BaseApplication.getContext()).a("", "report_tag_detect_support_easy", true, 0L, 0L, localHashMap, "");
      ...
      alju.a("report_tag_detect_support_easy", l2);
    }
  }
}
