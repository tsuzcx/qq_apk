  ...
  implements Runnable
{
  ...
  public void run()
  {
    long l1 = anet.a("report_tag_detect_support_easy", 0L);
    ...
    if (l2 - l1 > 86400000L)
    {
      ...
      anet.a(localHashMap);
      azri.a(BaseApplication.getContext()).a("", "report_tag_detect_support_easy", true, 0L, 0L, localHashMap, "");
      ...
      anet.a("report_tag_detect_support_easy", l2);
    }
  }
}
