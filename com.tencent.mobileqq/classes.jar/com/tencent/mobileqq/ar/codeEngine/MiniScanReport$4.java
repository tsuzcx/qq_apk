  ...
  implements Runnable
{
  ...
  public void run()
  {
    long l1 = aljv.a("report_tag_detect_support_easy", 0L);
    ...
    if (l2 - l1 > 86400000L)
    {
      ...
      aljv.a(localHashMap);
      axrl.a(BaseApplication.getContext()).a("", "report_tag_detect_support_easy", true, 0L, 0L, localHashMap, "");
      ...
      aljv.a("report_tag_detect_support_easy", l2);
    }
  }
}
