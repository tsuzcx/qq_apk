...
public class ARDeviceController$1
  implements Runnable
{
  public ARDeviceController$1(amnr paramamnr, int paramInt, boolean paramBoolean) {}
  
  public void run()
  {
    Object localObject = new HashMap();
    ((HashMap)localObject).put("param_FailCode", String.valueOf(this.jdField_a_of_type_Int));
    azmz.a(BaseApplication.getContext()).a(null, "AREnable", this.jdField_a_of_type_Boolean, 0L, 0L, (HashMap)localObject, null);
    ...
    bdiv.a((SharedPreferences.Editor)localObject);
  }
}
