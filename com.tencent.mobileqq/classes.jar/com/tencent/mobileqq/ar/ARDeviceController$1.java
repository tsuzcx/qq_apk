...
public class ARDeviceController$1
  implements Runnable
{
  public ARDeviceController$1(akiq paramakiq, int paramInt, boolean paramBoolean) {}
  
  public void run()
  {
    Object localObject = new HashMap();
    ((HashMap)localObject).put("param_FailCode", String.valueOf(this.jdField_a_of_type_Int));
    awrn.a(BaseApplication.getContext()).a(null, "AREnable", this.jdField_a_of_type_Boolean, 0L, 0L, (HashMap)localObject, null);
    ...
    baig.a((SharedPreferences.Editor)localObject);
  }
}
