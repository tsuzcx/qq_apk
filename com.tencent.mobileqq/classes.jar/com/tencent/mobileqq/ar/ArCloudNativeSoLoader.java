...
public class ArCloudNativeSoLoader
{
  ...
  public static int a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localObject1 = a(FileUtils.b((File)localObject2));
        ...
        str = PortalUtils.a((String)localObject1);
  ...
  {
    return new File(ArNativeSoLoaderBase.a("arcloud", "v8.4.1.1", ArNativeSoLoaderBase.b("arcloud", "v8.4.1.1", "arcloud")) + File.separator + a() + ".so").exists();
  }
  ...
  public static boolean a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        String str = ArNativeSoLoaderBase.a("arcloud", "v8.4.1.1", ArNativeSoLoaderBase.b("arcloud", "v8.4.1.1", "arcloud")) + File.separator + paramString + ".so";
