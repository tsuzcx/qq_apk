...
public abstract class ScanningData
{
  ...
  public ScanningData(Context paramContext)
  {
    ...
    this.jdField_e_of_type_JavaLangString = anzj.a(2131712395);
  ...
  private void a()
  {
    ...
    this.jdField_b_of_type_AndroidGraphicsPaint.setStrokeWidth(apla.jdField_b_of_type_Int);
  ...
  public void A()
  {
    ...
    {
      this.jdField_a_of_type_AndroidAnimationObjectAnimator = ObjectAnimator.ofFloat(this, "bCWidth", new float[] { bhtq.a(5.0F) * this.jdField_c_of_type_Float, apla.jdField_c_of_type_Int * this.jdField_c_of_type_Float });
  ...
  public void C()
  {
    ...
    {
      this.jdField_n_of_type_AndroidAnimationObjectAnimator = ObjectAnimator.ofFloat(this, "bCWidth", new float[] { apla.jdField_c_of_type_Int * this.jdField_c_of_type_Float, apla.jdField_h_of_type_Int * this.jdField_c_of_type_Float });
  ...
  public void b()
  {
    this.jdField_f_of_type_Float = apla.I;
    this.jdField_i_of_type_Float = apla.jdField_h_of_type_Int;
    this.jdField_n_of_type_Float = apla.jdField_i_of_type_Int;
    this.jdField_B_of_type_Float = apla.L;
    this.jdField_E_of_type_Float = apla.jdField_c_of_type_Int;
    this.L = apla.G;
    this.O = apla.H;
    this.P = apla.jdField_b_of_type_Int;
    this.X = apla.G;
    this.Y = apla.jdField_c_of_type_Int;
    this.ag = apla.G;
    this.ai = apla.jdField_u_of_type_Int;
    this.am = apla.jdField_q_of_type_Int;
    this.an = apla.jdField_b_of_type_Int;
    this.ay = apla.jdField_c_of_type_Int;
    this.aB = apla.jdField_k_of_type_Int;
    this.aH = apla.x;
    this.aD = apla.C;
    this.aE = apla.jdField_u_of_type_Int;
    this.aL = apla.x;
    this.aM = apla.x;
    this.aN = apla.jdField_p_of_type_Int;
    this.aP = apla.jdField_r_of_type_Int;
    this.aQ = apla.jdField_r_of_type_Int;
    this.aR = apla.jdField_j_of_type_Int;
    this.aH = apla.jdField_r_of_type_Int;
    this.aS = apla.jdField_k_of_type_Int;
    this.aT = apla.jdField_m_of_type_Int;
    this.aU = 0.0F;
    this.aX = apla.jdField_m_of_type_Int;
    this.aY = apla.jdField_b_of_type_Int;
    this.bb = apla.jdField_a_of_type_Int;
    this.bd = apla.A;
    this.be = apla.jdField_o_of_type_Int;
    this.bf = apla.f;
    this.bh = apla.jdField_d_of_type_Int;
    this.bI = apla.F;
    this.bK = apla.jdField_e_of_type_Int;
    this.bL = apla.jdField_h_of_type_Int;
    this.bP = apla.y;
    this.bS = apla.jdField_c_of_type_Int;
    this.bV = apla.jdField_v_of_type_Int;
    this.bW = apla.D;
  }
  ...
  public void x()
  {
    ...
    this.bn = apla.jdField_i_of_type_Int;
    this.bo = apla.jdField_s_of_type_Int;
    this.bw = apla.z;
    this.bp = apla.jdField_s_of_type_Int;
    this.bq = apla.jdField_s_of_type_Int;
    this.br = apla.jdField_g_of_type_Int;
    this.bs = apla.jdField_g_of_type_Int;
    this.bx = apla.jdField_s_of_type_Int;
    this.bt = apla.jdField_j_of_type_Int;
    this.bu = apla.jdField_p_of_type_Int;
    this.bv = apla.jdField_s_of_type_Int;
    this.by = apla.jdField_s_of_type_Int;
    this.bz = apla.jdField_r_of_type_Int;
    this.bA = apla.jdField_p_of_type_Int;
    this.bB = apla.jdField_n_of_type_Int;
    this.jdField_s_of_type_Int = Color.argb(255, 119, 119, 119);
    this.bC = apla.jdField_h_of_type_Int;
    this.bD = apla.jdField_r_of_type_Int;
    this.bE = apla.jdField_e_of_type_Int;
    this.jdField_t_of_type_Int = Color.argb(76, 0, 104, 144);
    this.bF = apla.jdField_l_of_type_Int;
    this.bG = apla.jdField_i_of_type_Int;
    this.bH = 0.0F;
    this.bI = apla.F;
    this.bK = apla.jdField_e_of_type_Int;
    ...
    this.bV = apla.jdField_v_of_type_Int;
    this.bW = apla.D;
    this.jdField_w_of_type_Float = apla.jdField_k_of_type_Int;
    this.aV = 0.0F;
    this.aW = 0.0F;
    this.bc = 0.0F;
    this.bi = 0.0F;
