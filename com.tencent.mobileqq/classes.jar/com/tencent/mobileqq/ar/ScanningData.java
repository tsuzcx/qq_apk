...
public abstract class ScanningData
{
  ...
  public ScanningData(Context paramContext)
  {
    ...
    this.jdField_e_of_type_JavaLangString = ajjy.a(2131647725);
  ...
  private void a()
  {
    ...
    this.jdField_b_of_type_AndroidGraphicsPaint.setStrokeWidth(akpd.jdField_b_of_type_Int);
  ...
  public void A()
  {
    ...
    {
      this.jdField_a_of_type_AndroidAnimationObjectAnimator = ObjectAnimator.ofFloat(this, "bCWidth", new float[] { bajq.a(5.0F) * this.jdField_c_of_type_Float, akpd.jdField_c_of_type_Int * this.jdField_c_of_type_Float });
  ...
  public void C()
  {
    ...
    {
      this.jdField_n_of_type_AndroidAnimationObjectAnimator = ObjectAnimator.ofFloat(this, "bCWidth", new float[] { akpd.jdField_c_of_type_Int * this.jdField_c_of_type_Float, akpd.jdField_h_of_type_Int * this.jdField_c_of_type_Float });
  ...
  public void b()
  {
    this.jdField_f_of_type_Float = akpd.I;
    this.jdField_i_of_type_Float = akpd.jdField_h_of_type_Int;
    this.jdField_n_of_type_Float = akpd.jdField_i_of_type_Int;
    this.jdField_B_of_type_Float = akpd.L;
    this.jdField_E_of_type_Float = akpd.jdField_c_of_type_Int;
    this.L = akpd.G;
    this.O = akpd.H;
    this.P = akpd.jdField_b_of_type_Int;
    this.X = akpd.G;
    this.Y = akpd.jdField_c_of_type_Int;
    this.ag = akpd.G;
    this.ai = akpd.jdField_u_of_type_Int;
    this.am = akpd.jdField_q_of_type_Int;
    this.an = akpd.jdField_b_of_type_Int;
    this.ay = akpd.jdField_c_of_type_Int;
    this.aB = akpd.jdField_k_of_type_Int;
    this.aH = akpd.x;
    this.aD = akpd.C;
    this.aE = akpd.jdField_u_of_type_Int;
    this.aL = akpd.x;
    this.aM = akpd.x;
    this.aN = akpd.jdField_p_of_type_Int;
    this.aP = akpd.jdField_r_of_type_Int;
    this.aQ = akpd.jdField_r_of_type_Int;
    this.aR = akpd.jdField_j_of_type_Int;
    this.aH = akpd.jdField_r_of_type_Int;
    this.aS = akpd.jdField_k_of_type_Int;
    this.aT = akpd.jdField_m_of_type_Int;
    this.aU = 0.0F;
    this.aX = akpd.jdField_m_of_type_Int;
    this.aY = akpd.jdField_b_of_type_Int;
    this.bb = akpd.jdField_a_of_type_Int;
    this.bd = akpd.A;
    this.be = akpd.jdField_o_of_type_Int;
    this.bf = akpd.f;
    this.bh = akpd.jdField_d_of_type_Int;
    this.bI = akpd.F;
    this.bK = akpd.jdField_e_of_type_Int;
    this.bL = akpd.jdField_h_of_type_Int;
    this.bP = akpd.y;
    this.bS = akpd.jdField_c_of_type_Int;
    this.bV = akpd.jdField_v_of_type_Int;
    this.bW = akpd.D;
  }
  ...
  public void x()
  {
    ...
    this.bn = akpd.jdField_i_of_type_Int;
    this.bo = akpd.jdField_s_of_type_Int;
    this.bw = akpd.z;
    this.bp = akpd.jdField_s_of_type_Int;
    this.bq = akpd.jdField_s_of_type_Int;
    this.br = akpd.jdField_g_of_type_Int;
    this.bs = akpd.jdField_g_of_type_Int;
    this.bx = akpd.jdField_s_of_type_Int;
    this.bt = akpd.jdField_j_of_type_Int;
    this.bu = akpd.jdField_p_of_type_Int;
    this.bv = akpd.jdField_s_of_type_Int;
    this.by = akpd.jdField_s_of_type_Int;
    this.bz = akpd.jdField_r_of_type_Int;
    this.bA = akpd.jdField_p_of_type_Int;
    this.bB = akpd.jdField_n_of_type_Int;
    this.jdField_s_of_type_Int = Color.argb(255, 119, 119, 119);
    this.bC = akpd.jdField_h_of_type_Int;
    this.bD = akpd.jdField_r_of_type_Int;
    this.bE = akpd.jdField_e_of_type_Int;
    this.jdField_t_of_type_Int = Color.argb(76, 0, 104, 144);
    this.bF = akpd.jdField_l_of_type_Int;
    this.bG = akpd.jdField_i_of_type_Int;
    this.bH = 0.0F;
    this.bI = akpd.F;
    this.bK = akpd.jdField_e_of_type_Int;
    ...
    this.bV = akpd.jdField_v_of_type_Int;
    this.bW = akpd.D;
    this.jdField_w_of_type_Float = akpd.jdField_k_of_type_Int;
    this.aV = 0.0F;
    this.aW = 0.0F;
    this.bc = 0.0F;
    this.bi = 0.0F;
