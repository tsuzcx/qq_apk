...
public abstract class ScanningData
{
  ...
  public ScanningData(Context paramContext)
  {
    ...
    this.jdField_e_of_type_JavaLangString = ajyc.a(2131713512);
  ...
  private void a()
  {
    ...
    this.jdField_b_of_type_AndroidGraphicsPaint.setStrokeWidth(aldp.jdField_b_of_type_Int);
  ...
  public void A()
  {
    ...
    {
      this.jdField_a_of_type_AndroidAnimationObjectAnimator = ObjectAnimator.ofFloat(this, "bCWidth", new float[] { bbkx.a(5.0F) * this.jdField_c_of_type_Float, aldp.jdField_c_of_type_Int * this.jdField_c_of_type_Float });
  ...
  public void C()
  {
    ...
    {
      this.jdField_n_of_type_AndroidAnimationObjectAnimator = ObjectAnimator.ofFloat(this, "bCWidth", new float[] { aldp.jdField_c_of_type_Int * this.jdField_c_of_type_Float, aldp.jdField_h_of_type_Int * this.jdField_c_of_type_Float });
  ...
  public void b()
  {
    this.jdField_f_of_type_Float = aldp.I;
    this.jdField_i_of_type_Float = aldp.jdField_h_of_type_Int;
    this.jdField_n_of_type_Float = aldp.jdField_i_of_type_Int;
    this.jdField_B_of_type_Float = aldp.L;
    this.jdField_E_of_type_Float = aldp.jdField_c_of_type_Int;
    this.L = aldp.G;
    this.O = aldp.H;
    this.P = aldp.jdField_b_of_type_Int;
    this.X = aldp.G;
    this.Y = aldp.jdField_c_of_type_Int;
    this.ag = aldp.G;
    this.ai = aldp.jdField_u_of_type_Int;
    this.am = aldp.jdField_q_of_type_Int;
    this.an = aldp.jdField_b_of_type_Int;
    this.ay = aldp.jdField_c_of_type_Int;
    this.aB = aldp.jdField_k_of_type_Int;
    this.aH = aldp.x;
    this.aD = aldp.C;
    this.aE = aldp.jdField_u_of_type_Int;
    this.aL = aldp.x;
    this.aM = aldp.x;
    this.aN = aldp.jdField_p_of_type_Int;
    this.aP = aldp.jdField_r_of_type_Int;
    this.aQ = aldp.jdField_r_of_type_Int;
    this.aR = aldp.jdField_j_of_type_Int;
    this.aH = aldp.jdField_r_of_type_Int;
    this.aS = aldp.jdField_k_of_type_Int;
    this.aT = aldp.jdField_m_of_type_Int;
    this.aU = 0.0F;
    this.aX = aldp.jdField_m_of_type_Int;
    this.aY = aldp.jdField_b_of_type_Int;
    this.bb = aldp.jdField_a_of_type_Int;
    this.bd = aldp.A;
    this.be = aldp.jdField_o_of_type_Int;
    this.bf = aldp.f;
    this.bh = aldp.jdField_d_of_type_Int;
    this.bI = aldp.F;
    this.bK = aldp.jdField_e_of_type_Int;
    this.bL = aldp.jdField_h_of_type_Int;
    this.bP = aldp.y;
    this.bS = aldp.jdField_c_of_type_Int;
    this.bV = aldp.jdField_v_of_type_Int;
    this.bW = aldp.D;
  }
  ...
  public void x()
  {
    ...
    this.bn = aldp.jdField_i_of_type_Int;
    this.bo = aldp.jdField_s_of_type_Int;
    this.bw = aldp.z;
    this.bp = aldp.jdField_s_of_type_Int;
    this.bq = aldp.jdField_s_of_type_Int;
    this.br = aldp.jdField_g_of_type_Int;
    this.bs = aldp.jdField_g_of_type_Int;
    this.bx = aldp.jdField_s_of_type_Int;
    this.bt = aldp.jdField_j_of_type_Int;
    this.bu = aldp.jdField_p_of_type_Int;
    this.bv = aldp.jdField_s_of_type_Int;
    this.by = aldp.jdField_s_of_type_Int;
    this.bz = aldp.jdField_r_of_type_Int;
    this.bA = aldp.jdField_p_of_type_Int;
    this.bB = aldp.jdField_n_of_type_Int;
    this.jdField_s_of_type_Int = Color.argb(255, 119, 119, 119);
    this.bC = aldp.jdField_h_of_type_Int;
    this.bD = aldp.jdField_r_of_type_Int;
    this.bE = aldp.jdField_e_of_type_Int;
    this.jdField_t_of_type_Int = Color.argb(76, 0, 104, 144);
    this.bF = aldp.jdField_l_of_type_Int;
    this.bG = aldp.jdField_i_of_type_Int;
    this.bH = 0.0F;
    this.bI = aldp.F;
    this.bK = aldp.jdField_e_of_type_Int;
    ...
    this.bV = aldp.jdField_v_of_type_Int;
    this.bW = aldp.D;
    this.jdField_w_of_type_Float = aldp.jdField_k_of_type_Int;
    this.aV = 0.0F;
    this.aW = 0.0F;
    this.bc = 0.0F;
    this.bi = 0.0F;
