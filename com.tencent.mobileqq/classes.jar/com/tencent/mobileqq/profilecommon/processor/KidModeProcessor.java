  ...
  extends AbsProfileCommonProcessor
{
  ...
  public void onProcessProfileModifyPush(int paramInt, ByteStringMicro paramByteStringMicro)
  {
    ...
    TempGetProfileDetailProcessor localTempGetProfileDetailProcessor;
    do
    {
      do
      {
      ...
      localTempGetProfileDetailProcessor = (TempGetProfileDetailProcessor)ProfileServiceUtils.getBusinessProcessor(this.appRuntime, TempGetProfileDetailProcessor.class);
    } while (localTempGetProfileDetailProcessor == null);
