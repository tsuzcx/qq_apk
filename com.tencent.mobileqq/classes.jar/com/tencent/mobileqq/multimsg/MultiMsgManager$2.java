...
public class MultiMsgManager$2
  implements Runnable
{
  public MultiMsgManager$2(arxu paramarxu, ArrayList paramArrayList, int paramInt1, HashMap paramHashMap, MessageRecord paramMessageRecord, QQAppInterface paramQQAppInterface, String paramString, int paramInt2, Bundle paramBundle) {}
  
  public void run()
  {
    ArrayList localArrayList1 = new ArrayList(this.jdField_a_of_type_JavaUtilArrayList);
    arxu.a(System.currentTimeMillis());
    Object localObject2;
    ...
    {
      localObject2 = ((akbp)localObject1).a((MessageRecord)localObject2, localArrayList1, null, true, bool);
      if (this.jdField_a_of_type_Int == 5) {
        aupz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
    ...
    for (;;)
    {
      if (localIterator.hasNext())
      {
        ...
        {
          localObject6 = atpl.a(7, (MessageForPic)localObject4, j, (String)localObject3, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount());
          if (localObject6 != null)
          {
            if (this.jdField_a_of_type_Int == 5)
            {
              ...
              label448:
              ((atpp)localObject6).jdField_a_of_type_Int = i;
              localObject4 = ((atpp)localObject6).jdField_a_of_type_Atqd;
              if (i != 2) {
                break label515;
              }
            }
            ...
            for (i = 1;; i = 0)
            {
              for (;;)
              {
                ...
                try
                {
                  i = Integer.valueOf(aupw.b((MessageRecord)localObject4)).intValue();
                }
        ...
        {
          localObject5 = atpl.a(7, (MessageForMixedMsg)localNumberFormatException, j, (String)localObject3, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount());
        ...
        else if (((MessageRecord)localObject5).msgtype == -1036)
        {
          ...
          while (((Iterator)localObject5).hasNext())
          {
            ...
            {
              localObject6 = atpl.a(7, (MessageForMixedMsg)localObject6, j, (String)localObject3, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount());
              if (localObject6 != null) {
        ...
        else if ((localObject5 instanceof MessageForStructing))
        {
          ...
          if ((localObject5 != null) && ((localObject5 instanceof StructMsgForImageShare)))
          {
            ...
            if (localObject6 != null)
            {
              if (((awwr)localObject6).jdField_a_of_type_ComTencentMobileqqDataMessageForPic == null)
              {
                if (((awwr)localObject6).jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForImageShare == null) {
                  ((awwr)localObject6).jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForImageShare = ((StructMsgForImageShare)localObject5);
                }
                ((awwr)localObject6).jdField_a_of_type_ComTencentMobileqqDataMessageForPic = ((awwr)localObject6).a();
              }
              localObject5 = atpl.a(7, ((awwr)localObject6).jdField_a_of_type_ComTencentMobileqqDataMessageForPic, this.b, (String)localObject3, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount());
              if (localObject5 != null) {
    ...
    for (;;)
    {
      localObject5 = aweg.a(5, localObject5, (awey)localObject1);
      if (localObject5 != null) {
      ...
      for (i = ((ChatMessage)localObject3).istroop;; i = 0)
      {
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004660", "0X8004660", 0, 0, i + "", j + "", "" + localArrayList1.size(), "" + localArrayList2.size());
            if ((localArrayList2.size() == 0) && (localArrayList3.size() == 0) && (localArrayList4.size() == 0) && (localArrayList5.size() == 0))
            {
              ...
              arxu.a(this.this$0, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString, this.b, this.jdField_a_of_type_JavaUtilHashMap, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord, null, (ArrayList)localObject2, true, this.jdField_a_of_type_Int);
              return;
              if (i == 3000)
              {
                i = 2;
            ...
            if (localArrayList2.size() > 0)
            {
              ...
              arxu.a(this.this$0, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.uniseq, 1);
            }
            for (;;)
            {
              arxu.a(this.this$0, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString, this.b, this.jdField_a_of_type_JavaUtilHashMap, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord, (ArrayList)localObject2, localArrayList2, this.jdField_a_of_type_Int);
              if (localArrayList3.size() > 0)
              {
                if (QLog.isColorLevel()) {
                  QLog.d("MultiMsg_TAG", 2, "[requestSendMultiMsg]Upload videos, count is [" + localArrayList3.size() + "], goto requestUploadVideos");
                }
                arxu.a(this.this$0, 2);
                arxu.a(this.this$0, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString, this.b, this.jdField_a_of_type_JavaUtilHashMap, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord, (ArrayList)localObject2, localArrayList3, (awey)localObject1, this.jdField_a_of_type_Int);
              }
              if (localArrayList4.size() > 0)
              {
                ...
                arxu.a(this.this$0, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString, this.b, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord, (ArrayList)localObject2, this.jdField_a_of_type_Int, this.jdField_a_of_type_AndroidOsBundle);
              }
