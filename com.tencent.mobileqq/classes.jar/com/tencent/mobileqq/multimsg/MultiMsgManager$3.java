  ...
  private boolean a(MessageForPic paramMessageForPic, PicResult paramPicResult)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Int != 5)
      {
        ...
        paramMessageForPic.md5 = FileUtils.c(MultiMsgManager.jdField_a_of_type_JavaLangString);
      }
      ...
      for (;;)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.e("MultiMsg_TAG", 2, "WTF, picResult.mExtraObj is " + paramPicResult.jdField_a_of_type_JavaLangObject.getClass().getSimpleName());
        }
        label612:
        i = 0;
        break label285;
              ...
              if ((localObject2 != null) && ((localObject2 instanceof StructMsgForImageShare)))
              {
                ...
                if ((localObject3 != null) && (((StructMsgItemImage)localObject3).a != null))
                {
                  ...
                  for (;;)
                  {
                    i += 1;
                    break;
                    ((StructMsgItemImage)localObject3).ad = localMessageForPic.uuid;
                    ((StructMsgItemImage)localObject3).ae = localMessageForPic.md5;
                    ((StructMsgItemImage)localObject3).ac = localMessageForPic.path;
