...
public class MultiMsgManager$5
  implements Runnable
{
  public MultiMsgManager$5(awwm paramawwm, QQAppInterface paramQQAppInterface, String paramString, int paramInt, long paramLong, boolean paramBoolean) {}
  ...
  public void run()
  {
    ...
    {
      localObject = awwm.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Long);
      if (localObject != null)
      {
        j = ((List)localObject).size();
        k = awwm.a().a((Collection)localObject);
    ...
    for (int i = 0;; i = 1)
    {
      ...
      bctj.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "multiMsgSend", this.jdField_a_of_type_Boolean, 30000L, 0L, (HashMap)localObject, "");
      return;
    }
  }
}
