...
public class ImaxAdUtil
{
  ...
  {
    return (paramInt == 10005) && ((paramRecentBaseData instanceof RecentItemImaxADData)) && (!TextUtils.isEmpty(((RecentItemImaxADData)paramRecentBaseData).g));
  }
  ...
  public static byte[] a(byte[] paramArrayOfByte)
  {
    ...
    //   14: iconst_1
    //   15: ldc 115
    //   17: invokestatic 121	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   20: aload 6
    //   22: astore_2
    //   23: aload_2
    //   24: areturn
    //   25: new 123	java/io/ByteArrayOutputStream
    //   28: dup
    //   29: invokespecial 124	java/io/ByteArrayOutputStream:<init>	()V
    //   32: astore_1
    //   33: new 126	java/io/ByteArrayInputStream
    //   36: dup
    //   37: aload_0
    //   38: iconst_0
    //   39: aload_0
    //   40: arraylength
    //   41: invokespecial 129	java/io/ByteArrayInputStream:<init>	([BII)V
    //   44: astore 5
    //   46: aload 5
    //   48: astore_3
    //   49: aload_1
    //   50: astore_2
    //   51: new 131	java/util/zip/GZIPInputStream
    //   54: dup
    //   55: aload 5
    //   57: aload_0
    //   58: arraylength
    //   59: invokespecial 134	java/util/zip/GZIPInputStream:<init>	(Ljava/io/InputStream;I)V
    //   62: astore 4
    //   64: aload 5
    //   66: astore_3
    //   67: aload_1
    ...
    //   84: aload 4
    //   86: aload_0
    //   87: invokevirtual 138	java/util/zip/GZIPInputStream:read	([B)I
    //   90: invokevirtual 141	java/io/ByteArrayOutputStream:write	([BII)V
    //   93: aload 5
    //   95: astore_3
    //   96: aload_1
    //   97: astore_2
    //   98: aload 4
    //   100: invokevirtual 144	java/util/zip/GZIPInputStream:close	()V
    //   103: aload 5
    //   105: astore_3
    //   106: aload_1
    //   107: astore_2
    //   108: aload_1
    //   109: invokevirtual 148	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   112: astore_0
    //   113: aload 5
    //   115: ifnull +8 -> 123
    //   118: aload 5
    //   120: invokevirtual 149	java/io/ByteArrayInputStream:close	()V
    //   123: aload_0
    //   124: astore_2
    //   125: aload_1
    //   126: ifnull -103 -> 23
    //   129: aload_1
    //   130: invokevirtual 150	java/io/ByteArrayOutputStream:close	()V
    //   133: aload_0
    //   134: areturn
    //   135: astore_1
    //   136: ldc 113
    ...
    //   139: ldc 152
    //   141: aload_1
    //   142: invokestatic 155	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   145: aload_0
    //   146: areturn
    //   147: astore 4
    //   149: aconst_null
    ...
    //   168: ifnull +7 -> 175
    //   171: aload_0
    //   172: invokevirtual 149	java/io/ByteArrayInputStream:close	()V
    //   175: aload 6
    //   177: astore_2
    //   178: aload_1
    //   179: ifnull -156 -> 23
    //   182: aload_1
    //   183: invokevirtual 150	java/io/ByteArrayOutputStream:close	()V
    //   186: aconst_null
    //   187: areturn
    //   188: astore_0
    //   189: ldc 113
    ...
    //   192: ldc 152
    //   194: aload_0
    //   195: invokestatic 155	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   198: aconst_null
    //   199: areturn
    //   200: astore_0
    //   201: aconst_null
    ...
    //   206: ifnull +7 -> 213
    //   209: aload_3
    //   210: invokevirtual 149	java/io/ByteArrayInputStream:close	()V
    //   213: aload_1
    //   214: ifnull +7 -> 221
    //   217: aload_1
    //   218: invokevirtual 150	java/io/ByteArrayOutputStream:close	()V
    //   221: aload_0
    //   222: athrow
    //   223: astore_1
    //   224: ldc 113
    ...
    //   227: ldc 152
    //   229: aload_1
    //   230: invokestatic 155	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   233: goto -12 -> 221
    //   236: astore_0
    //   237: aconst_null
    //   238: astore_3
