...
public class ImaxAdRecentUserManager$2
  implements Runnable
{
  public ImaxAdRecentUserManager$2(aqiy paramaqiy, QQAppInterface paramQQAppInterface, String paramString, int paramInt, mxu parammxu) {}
  ...
  public void run()
  {
    ...
    if (localMessage != null)
    {
      ...
      if (this.jdField_a_of_type_Mxu.a != null)
      {
        ...
        if (this.jdField_a_of_type_Mxu.a.l == 2) {
          aqiw.a().b(this.jdField_a_of_type_Mxu);
        }
      }
    }
  }
