  ...
  extends MessageMicro<STServiceMonitItem>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 32, 40 }, new String[] { "cmd", "url", "errcode", "cost", "src" }, new Object[] { "", "", localInteger, localInteger, localInteger }, STServiceMonitItem.class);
  }
}
