  ...
  extends ReadInJoySearchTipsContainer
{
  ...
  private void a(String paramString1, int paramInt1, int paramInt2, int paramInt3, String paramString2)
  {
    ...
    if (paramInt1 == 0)
    {
      ...
      localButton.setPadding(bbll.a(12.0F), bbll.a(3.0F), bbll.a(12.0F), bbll.a(4.0F));
  ...
  {
    int i6 = (int)bbdv.a(getContext(), 12.0F);
    int i1 = (int)bbdv.a(getContext(), 10.0F);
    int i7 = (int)bbdv.a(getContext(), 10.0F);
    int i8 = (int)bbdv.a(getContext(), 10.0F);
    int m = (int)bbdv.a(getContext(), 15.0F);
    int i9 = (int)bbdv.a(getContext(), 15.0F);
  ...
  public void a(List<awmm> paramList, int paramInt1, int paramInt2, int paramInt3)
  {
    removeAllViews();
    paramList = paramList.iterator();
    while (paramList.hasNext()) {
      a(((awmm)paramList.next()).b, paramInt1, paramInt2, paramInt3, null);
    }
  }
  
  public void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    int i2 = (int)bbdv.a(getContext(), 12.0F);
    int k = (int)bbdv.a(getContext(), 10.0F);
    int i3 = (int)bbdv.a(getContext(), 10.0F);
    paramInt4 = (int)bbdv.a(getContext(), 15.0F);
    int i4 = (int)bbdv.a(getContext(), 15.0F);
