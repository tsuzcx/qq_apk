  ...
  extends ReadInJoySearchTipsContainer
{
  ...
  private void a(String paramString1, int paramInt1, int paramInt2, int paramInt3, String paramString2)
  {
    ...
    if (paramInt1 == 0)
    {
      ...
      localButton.setPadding(bgtn.a(12.0F), bgtn.a(3.0F), bgtn.a(12.0F), bgtn.a(4.0F));
  ...
  {
    int i6 = (int)bgme.a(getContext(), 12.0F);
    int i1 = (int)bgme.a(getContext(), 10.0F);
    int i7 = (int)bgme.a(getContext(), 10.0F);
    int i8 = (int)bgme.a(getContext(), 10.0F);
    int m = (int)bgme.a(getContext(), 15.0F);
    int i9 = (int)bgme.a(getContext(), 15.0F);
  ...
  public void a(List<bblc> paramList, int paramInt1, int paramInt2, int paramInt3)
  {
    removeAllViews();
    paramList = paramList.iterator();
    while (paramList.hasNext()) {
      a(((bblc)paramList.next()).b, paramInt1, paramInt2, paramInt3, null);
    }
  }
  
  public void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    int i2 = (int)bgme.a(getContext(), 12.0F);
    int k = (int)bgme.a(getContext(), 10.0F);
    int i3 = (int)bgme.a(getContext(), 10.0F);
    paramInt4 = (int)bgme.a(getContext(), 15.0F);
    int i4 = (int)bgme.a(getContext(), 15.0F);
