  ...
  extends SearchResultGroupMessageView
{
  ...
  {
    this.b = LayoutInflater.from(paramViewGroup.getContext()).inflate(2131562964, paramViewGroup, false);
    this.c = ((TextView)this.b.findViewById(2131371850));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.b.findViewById(2131370553));
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.jdField_a_of_type_AndroidViewView = this.b.findViewById(2131371870);
