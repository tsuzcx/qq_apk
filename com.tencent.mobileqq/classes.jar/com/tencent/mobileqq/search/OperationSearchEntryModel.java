  ...
  extends BaseSearchEntryModel
{
  ...
  public View a(Context paramContext, QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    for (paramViewGroup = ((BaseActivity)paramContext).getAppRuntime();; paramViewGroup = null)
    {
      ...
      this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(paramContext).inflate(2130971732, null);
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131361926));
      this.b = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131375462));
      this.c = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131375463));
      this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131375461));
      if (ThemeUtil.isInNightMode(BaseApplicationImpl.getApplication().getRuntime()))
      {
        this.jdField_a_of_type_AndroidViewView.findViewById(2131363985).setBackgroundColor(Color.parseColor("#040E1C"));
  ...
  public void a()
  {
    ThreadManager.post(new ahvu(this, new OperationSearchEntryDataModel(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 2, this.jdField_a_of_type_Int)), 5, null, true);
  }
  ...
  public void b(SearchEntryDataModel paramSearchEntryDataModel)
  {
    ...
    for (;;)
    {
      if (!TextUtils.isEmpty(paramSearchEntryDataModel.e)) {
        this.jdField_a_of_type_AndroidViewView.setOnClickListener(new ahvt(this, paramSearchEntryDataModel));
      }
