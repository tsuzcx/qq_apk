  ...
  public void handleTabSearchError(String paramString1, boolean paramBoolean, String paramString2, int paramInt, String paramString3, long[] paramArrayOfLong)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.a.jdField_b_of_type_AndroidWidgetTextView.setText(HardCodeUtil.a(2131699856));
            ...
            if ((paramList == null) || (paramList.isEmpty()))
            {
              ...
              if ((!bool1) && (paramString3.jdField_d_of_type_Boolean)) {
                if (this.a.jdField_a_of_type_ComTencentMobileqqActivityContactRecommendtroopRecommendTroopListWrapper == null)
                {
                  ...
                  paramArrayOfByte.setText(HardCodeUtil.a(2131699860));
                  ...
                  paramArrayOfByte.setText(HardCodeUtil.a(2131699858));
                  paramArrayOfByte.setBackgroundResource(2130838980);
                  paramString2.addHeaderView(paramArrayOfByte);
            ...
            for (;;)
            {
              for (;;)
              {
                ...
                try
                {
                  ...
                  this.a.jdField_b_of_type_AndroidWidgetTextView.setText(HardCodeUtil.a(2131699851));
                  if (bool1)
                  {
                    this.a.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
                    this.a.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new ActiveEntitySearchFragment.2.1(this, paramString2));
