  ...
  implements AbsListView.OnScrollListener
{
  ...
  protected String a()
  {
    if (jdField_b_of_type_Int == 12) {
      return ((IPublicAccountConfigUtil)QRoute.api(IPublicAccountConfigUtil.class)).getSubscriptName(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, BaseApplicationImpl.getContext());
    }
    return HardCodeUtil.a(2131708775);
  }
  ...
  public void a(List paramList, int paramInt)
  {
    ...
    this.jdField_c_of_type_JavaUtilList.add(0, new GroupSearchModeTitle(HardCodeUtil.a(2131708725), "", ""));
    label197:
    this.jdField_a_of_type_ArrayOfByte = null;
  ...
  protected void e(List paramList)
  {
    ...
    Object localObject1 = ((PublicAccountDataManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.PUBLICACCOUNTDATA_MANAGER)).a();
    ...
    for (;;)
    {
      paramList = (UniteSearchHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.UNITE_SEARCH_HANDLER);
  ...
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqSearchAdapterBaseMvpAdapter == null) || (this.jdField_a_of_type_ComTencentMobileqqSearchAdapterBaseMvpAdapter.getCount() == 0) || (this.jdField_a_of_type_Int == 0)) {}
    while ((paramInt3 - paramInt1 - paramInt2 >= 10) || (this.jdField_a_of_type_Boolean) || (this.g)) {
      return;
    }
    e(this.jdField_c_of_type_JavaUtilList);
  }
