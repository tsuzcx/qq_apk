...
public class ActiveEntitySearchFragment
  extends Fragment
  implements View.OnClickListener, avit, begh
{
  ...
  public ActiveEntitySearchFragment()
  {
    ...
    this.jdField_a_of_type_Ajup = new avkr(this);
    this.jdField_a_of_type_Ajus = new avkv(this);
  }
  ...
  protected avkq a()
  {
    return new avkq(this.jdField_a_of_type_ComTencentWidgetXListView, this.jdField_a_of_type_Azwg, this, 0);
  }
  
  public List<Long> a()
  {
    List localList = new PublicAccountSearchEngine(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_d_of_type_Int).a(new avvn(this.jdField_b_of_type_JavaLangString));
    ...
    for (;;)
    {
      ...
      {
        avpr localavpr = (avpr)localList.get(i);
        int j = 0;
  ...
  protected void a(String paramString, List<Long> paramList, byte[] paramArrayOfByte, double paramDouble1, double paramDouble2, Bundle paramBundle)
  {
    ...
    {
      this.jdField_a_of_type_Ajuq.a(paramString, this.jdField_d_of_type_JavaLangString, 20, avjb.a(this.jdField_a_of_type_ArrayOfLong), paramList, paramArrayOfByte, this.jdField_c_of_type_Int, paramDouble1, paramDouble2, paramBundle);
      return;
    }
    if (this.jdField_a_of_type_Ajuo != null)
    {
      this.jdField_a_of_type_Ajuo.a(paramString, this.jdField_d_of_type_JavaLangString, 20, avjb.a(this.jdField_a_of_type_ArrayOfLong), paramList, paramArrayOfByte, this.jdField_c_of_type_Int, paramDouble1, paramDouble2, paramBundle);
      return;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_ArrayOfByte != null) {
          avwf.a("all_result", "load_tab", new String[] { paramString, avwf.a(this.jdField_b_of_type_JavaUtilList), "", avwf.a("UnifySearch.Unite", this.jdField_a_of_type_ArrayOfLong) });
        }
        if ((getActivity() instanceof avip))
        {
          d1 = ((avip)getActivity()).a();
  ...
  public void c()
  {
    if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_Avkq != null))
    {
      this.jdField_a_of_type_JavaUtilList.clear();
      this.jdField_b_of_type_JavaUtilList.clear();
      a(false);
      this.jdField_a_of_type_Avkq.a(this.jdField_a_of_type_JavaUtilList);
    }
    if (this.jdField_c_of_type_Boolean)
    {
  ...
  {
    paramView = paramView.getTag(2131302015);
    if ((paramView instanceof DynamicTabSearch.SubHotWord))
    {
      ...
      if ((localObject instanceof ActiveEntitySearchActivity))
      {
        ...
        avwf.a("sub_result", "clk_relate", new String[] { this.jdField_b_of_type_JavaLangString, paramView.search_word.get().toStringUtf8(), "", "" });
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    label169:
    label179:
    for (this.jdField_a_of_type_ArrayOfLong = ajuq.c;; this.jdField_a_of_type_ArrayOfLong = ajuo.c)
    {
  ...
  public View onCreateView(android.view.LayoutInflater paramLayoutInflater, android.view.ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    //   307: ldc_w 582
    //   310: invokestatic 587	ajjy:a	(I)Ljava/lang/String;
    ...
    //   381: dup
    //   382: aload_0
    //   383: invokespecial 618	avkz:<init>	(Lcom/tencent/mobileqq/search/fragment/ActiveEntitySearchFragment;)V
    ...
    //   429: ldc_w 626
    //   432: invokestatic 587	ajjy:a	(I)Ljava/lang/String;
    ...
    //   485: aload_0
    //   486: aload_0
    //   487: invokevirtual 628	com/tencent/mobileqq/search/fragment/ActiveEntitySearchFragment:a	()Lavkq;
    //   490: putfield 407	com/tencent/mobileqq/search/fragment/ActiveEntitySearchFragment:jdField_a_of_type_Avkq	Lavkq;
    //   493: aload_0
    //   494: getfield 407	com/tencent/mobileqq/search/fragment/ActiveEntitySearchFragment:jdField_a_of_type_Avkq	Lavkq;
    //   497: iconst_0
    //   498: invokevirtual 629	avkq:a	(Z)V
    //   501: aload_0
    ...
    //   510: aload_0
    //   511: getfield 407	com/tencent/mobileqq/search/fragment/ActiveEntitySearchFragment:jdField_a_of_type_Avkq	Lavkq;
    //   514: iconst_1
    //   515: invokevirtual 629	avkq:a	(Z)V
    //   518: aload_0
    ...
    //   531: aload_0
    //   532: getfield 407	com/tencent/mobileqq/search/fragment/ActiveEntitySearchFragment:jdField_a_of_type_Avkq	Lavkq;
    ...
    //   821: aload_0
    //   822: invokevirtual 644	com/tencent/widget/XListView:setOnScrollListener	(Lbegh;)V
    //   825: aload_0
    //   826: monitorexit
    //   827: aload_3
    //   828: areturn
    ...
    //   900: goto -493 -> 407
    //   903: aload_0
    //   904: getfield 407	com/tencent/mobileqq/search/fragment/ActiveEntitySearchFragment:jdField_a_of_type_Avkq	Lavkq;
    //   907: aload_0
    ...
    //   911: invokevirtual 415	avkq:a	(Ljava/util/List;)V
    //   914: aload_0
    ...
    //   978: ldc_w 653
    //   981: invokestatic 587	ajjy:a	(I)Ljava/lang/String;
  ...
  {
    super.onResume();
    this.jdField_a_of_type_Avkq.notifyDataSetChanged();
  }
  
  public void onScroll(AbsListView paramAbsListView, int paramInt1, int paramInt2, int paramInt3)
  {
    if ((this.jdField_a_of_type_Avkq == null) || (this.jdField_a_of_type_Avkq.getCount() == 0) || (this.jdField_e_of_type_Int == 0)) {}
  ...
  public void onScrollStateChanged(AbsListView paramAbsListView, int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_Avkq == null) || (this.jdField_a_of_type_Avkq.getCount() == 0)) {}
    while ((this.jdField_a_of_type_Avkq == null) || (this.jdField_a_of_type_Avkq.getCount() == 0) || (this.jdField_e_of_type_Int == 0) || (this.jdField_e_of_type_Int == 0) || (!this.jdField_c_of_type_Boolean) || (this.jdField_e_of_type_Boolean) || (this.jdField_d_of_type_Boolean) || (a() >= 20)) {
      return;
    }
    b(this.jdField_b_of_type_JavaLangString);
  }
  ...
  public void onViewCreated(View paramView, Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnTouchListener(new avla(this));
  }
}
