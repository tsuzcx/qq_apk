  ...
  extends BaseAdapter
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    default: 
      ...
      paramView.setBackgroundResource(2130842520);
      localObject1 = paramView;
      paramView = (AssociateSearchWordsFragment.ViewHolder)((View)localObject1).getTag();
      switch (getItemViewType(paramInt))
      {
      default: 
        label200:
        if (bool1) {
          ((View)localObject1).setBackgroundResource(2130839529);
        }
        break;
      }
      break;
    ...
    for (;;)
    {
      ((View)localObject1).setTag(2131381652, Integer.valueOf(paramInt));
      ((View)localObject1).setTag(2131381651, localAssociateItem);
      ...
      for (;;)
      {
        ...
        paramView = new TextView((Context)localObject2);
        paramView.setTextColor(((Context)localObject2).getResources().getColor(2131167113));
        paramView.setTextSize(1, 15.0F);
        paramView.setGravity(16);
        paramView.setIncludeFontPadding(false);
        paramView.setHeight(((Context)localObject2).getResources().getDimensionPixelSize(2131298553));
        ...
        paramView.setTextColor(((Context)localObject2).getResources().getColor(2131167033));
        label479:
        Object localObject5;
        if (getItemViewType(paramInt) == 5)
        {
          ...
          localObject5 = ((Context)localObject2).getResources().getDrawable(2130850764);
          ((Drawable)localObject5).setColorFilter(BaseApplicationImpl.sApplication.getResources().getColor(2131166953), PorterDuff.Mode.SRC_ATOP);
          ...
          ((ImageView)localObject5).setImageResource(2130850771);
          ((ImageView)localObject5).setColorFilter(BaseApplicationImpl.sApplication.getResources().getColor(2131166953));
          label685:
          ...
          if ((!bool1) && (!bool2))
          {
            ...
            ((TextView)localObject4).setBackgroundColor(((Context)localObject2).getResources().getColor(2131166965));
        ...
        for (;;)
        {
          ...
          break label479;
          label855:
          paramView.setCompoundDrawablesWithIntrinsicBounds(((Context)localObject2).getResources().getDrawable(2130850764), null, null, null);
          break label598;
          label875:
          ((ImageView)localObject5).setImageResource(2130850771);
          break label685;
          label886:
          paramView.setCompoundDrawablesWithIntrinsicBounds(((Context)localObject2).getResources().getDrawable(2130850763), null, null, null);
      ...
      for (;;)
      {
        ...
        if (bool1) {
          paramView.c.setBackgroundColor(((Context)localObject2).getResources().getColor(2131166966));
        } else {
          paramView.c.setBackgroundColor(((Context)localObject2).getResources().getColor(2131166965));
        }
      }
      if (this.jdField_a_of_type_ComTencentMobileqqSearchFragmentAssociateSearchWordsFragment.b)
      {
        ...
        {
          localObject2 = SearchUtils.a(paramView.a, 2.147484E+009F, 1, localAssociateItem.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqSearchFragmentAssociateSearchWordsFragment.jdField_a_of_type_JavaLangString, false, false, true);
      ...
      if (TextUtils.isEmpty(localAssociateItem.jdField_a_of_type_JavaLangString))
      {
        ...
        ((LinearLayout.LayoutParams)paramView.b.getLayoutParams()).setMargins(0, DisplayUtil.a((Context)localObject2, 16.0F), 0, DisplayUtil.a((Context)localObject2, 16.0F));
        break label200;
      }
      ...
      paramView.c.setBackgroundColor(((Context)localObject2).getResources().getColor(2131166965));
      break label200;
      ((View)localObject1).setBackgroundResource(2130839528);
    }
  }
