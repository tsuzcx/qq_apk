  ...
  extends Fragment
{
  ...
  ReadInJoySearchTipsContainer.OnTipClickListener jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoySearchTipsContainer$OnTipClickListener = new ahya(this);
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqAppUniteSearchObserver = new ahxz(this);
  }
  ...
  private void a()
  {
    ...
    try
    {
      ...
      if ((jdField_a_of_type_Int == -1) || (l2 - l1 > jdField_a_of_type_Int * 1000))
      {
        ...
        ThreadManager.post(new ahxx(this, bool), 5, null, true);
        return;
      }
    }
  ...
  private void a(List paramList)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqSearchViewHotWordForSubTipsContainer.a(paramList, 2130839181, getResources().getColor(2131492954), getResources().getColor(2131492953));
      return;
    }
    this.jdField_a_of_type_ComTencentMobileqqSearchViewHotWordForSubTipsContainer.a(paramList, 2130839178, getResources().getColor(2131492971), getResources().getColor(2131492952));
  }
        ...
        while (paramList.hasNext())
        {
          ...
          if ((localObject2 != null) && (Arrays.equals((long[])localObject2, this.jdField_a_of_type_ArrayOfLong)))
          {
            ...
            if ((localObject1 != null) && (((List)localObject1).size() > 0))
            {
              this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
              if (this.jdField_a_of_type_Boolean) {
                this.jdField_a_of_type_ComTencentMobileqqSearchViewHotWordForSubTipsContainer.a((List)localObject1, 2130839181, getResources().getColor(2131492954), getResources().getColor(2131492953));
              } else {
                this.jdField_a_of_type_ComTencentMobileqqSearchViewHotWordForSubTipsContainer.a((List)localObject1, 2130839178, getResources().getColor(2131492971), getResources().getColor(2131492952));
              }
            }
          }
        }
  ...
  {
    this.jdField_a_of_type_AndroidViewView = paramLayoutInflater.inflate(2130970699, null);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131371635));
    this.jdField_a_of_type_ComTencentMobileqqSearchViewHotWordForSubTipsContainer = ((HotWordForSubTipsContainer)this.jdField_a_of_type_AndroidViewView.findViewById(2131362733));
