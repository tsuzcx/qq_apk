  ...
  implements Handler.Callback
{
  ...
  private AdapterView.OnItemClickListener jdField_a_of_type_ComTencentWidgetAdapterView$OnItemClickListener = new ahvo(this);
  public XListView a;
  public List a;
  protected boolean a;
  public int b;
  ...
  private void e()
  {
    ThreadManager.postImmediately(new ahvn(this), null, true);
  }
  ...
  public XListView a(Context paramContext, QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130971728, null));
    ...
    paramContext = (LinearLayout)LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130971549, null);
    this.b = ((TextView)paramContext.findViewById(2131375063));
    this.c = ((TextView)paramContext.findViewById(2131375064));
    this.d = ((TextView)paramContext.findViewById(2131375065));
    ...
    {
      this.jdField_a_of_type_ComTencentWidgetXListView.setBackgroundResource(2130838586);
    ...
    for (;;)
    {
      this.jdField_a_of_type_ComTencentMobileqqAdapterContactsSearchResultAdapter = new ContactsSearchResultAdapter(paramQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentWidgetXListView, null, new ahvj(this), new ahvk(this), false);
      this.jdField_a_of_type_ComTencentWidgetXListView.setOnTouchListener(new ahvm(this));
      ...
      this.jdField_a_of_type_ComTencentWidgetXListView.setBackgroundResource(2130838585);
    }
  }
