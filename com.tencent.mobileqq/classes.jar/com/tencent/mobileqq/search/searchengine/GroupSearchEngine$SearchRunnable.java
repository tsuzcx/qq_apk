  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      Object localObject3 = (GroupSearchEngine.SearchEngineEntity)GroupSearchEngine.a(this.this$0).get(k);
      ...
      if (localObject1 != null)
      {
        ...
        if (!((List)localObject1).isEmpty())
        {
          ...
          if (!(((GroupSearchEngine.SearchEngineEntity)localObject3).a instanceof NetSearchEngine))
          {
            SearchStatisticsConstants.a(((GroupSearchEngine.SearchEngineEntity)localObject3).c);
            j = i;
          }
        }
      }
      if (((((GroupSearchEngine.SearchEngineEntity)localObject3).a instanceof ContactSearchEngine)) && (((ContactSearchEngine)((GroupSearchEngine.SearchEngineEntity)GroupSearchEngine.a(this.this$0).get(k)).a).a() != 64))
      {
        if (this.jdField_a_of_type_Boolean) {
          return;
        }
        ...
        if ((localObject3 != null) && (!((List)localObject3).isEmpty()))
        {
          ...
          localObject3 = new GroupSearchModelLocalContact(null, GroupSearchEngine.a(this.this$0), GroupSearchEngine.a(this.this$0));
    ...
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      if (bool)
      {
        ...
        GroupSearchEngine.a(this.this$0, new GroupSearchEngine.TroopMemberSearchRunnable(this.jdField_a_of_type_ComTencentMobileqqSearchSearchengineSearchRequest, (ArrayList)((ArrayList)localArrayList1).clone(), this.jdField_a_of_type_ComTencentMobileqqSearchSearchengineISearchListener, GroupSearchEngine.a(this.this$0), (CountDownLatch)localObject2, this.this$0));
