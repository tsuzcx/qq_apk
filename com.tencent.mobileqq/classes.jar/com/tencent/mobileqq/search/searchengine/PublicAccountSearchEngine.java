...
{
  private static final Comparator jdField_a_of_type_JavaUtilComparator = new ahil();
  private static final Comparator b = new ahim();
  ...
  public List a(SearchRequest paramSearchRequest)
  {
    ...
    if (i < j)
    {
      ...
      for (;;)
      {
        i += 1;
        break;
        Object localObject4 = (QidianManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(164);
        if ((localObject4 == null) || (!((QidianManager)localObject4).f(((PublicAccountInfo)localObject3).getUin())))
        {
          ...
          if ((this.jdField_a_of_type_Int != 12) || (PublicAccountUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((PublicAccountInfo)localObject3).getUin())))
          {
            ...
            if ((localObject3 != null) && (((PublicAccountInfo)localObject3).displayNumber != null) && (((PublicAccountInfo)localObject3).displayNumber.equalsIgnoreCase(((PublicAccountSearchResultModel)localObject4).b()))) {
  ...
  {
    ThreadManager.postImmediately(new ahik(this, paramSearchRequest, paramISearchListener), null, true);
