  ...
  public List<IContactSearchModel> a(SearchRequest paramSearchRequest)
  {
    ...
    while (((Iterator)localObject4).hasNext())
    {
      ...
      while (((Iterator)localObject5).hasNext())
      {
        ...
        if (!((Map)localObject2).containsKey(((IContactSearchModel)localObject6).b()))
        {
          ((Map)localObject2).put(((IContactSearchModel)localObject6).b(), Integer.valueOf(i));
          ((Map)localObject1).put(Integer.valueOf(i), ((IContactSearchModel)localObject6).b());
          i += 1;
        }
      }
    }
    ...
    while (j < ((List)localObject3).size())
    {
      ...
      {
        localObject5 = (Integer)((Map)localObject2).get(((IContactSearchModel)((List)((List)localObject3).get(j)).get(k)).b());
    ...
    while (i >= 0)
    {
      if (localObject2[i] != -1)
      {
        ...
        while (((Iterator)localObject6).hasNext())
        {
          ...
          if ((localObject5 != null) && (((String)localObject5).equals(localIContactSearchModel.b()))) {
