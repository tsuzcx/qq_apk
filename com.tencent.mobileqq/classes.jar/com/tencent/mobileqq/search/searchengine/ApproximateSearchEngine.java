  ...
  implements ISearchEngine<IContactSearchModel>
{
  ...
  public ApproximateSearchEngine(QQAppInterface paramQQAppInterface, int paramInt1, int paramInt2, String paramString, Set<String> paramSet)
  {
  ...
  public ApproximateSearchEngine(QQAppInterface paramQQAppInterface, int paramInt1, int paramInt2, Set<String> paramSet)
  {
    ...
    for (;;)
    {
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          if ((!paramString.contains(localSearchResultCache.jdField_a_of_type_JavaLangString)) || (localSearchResultCache.jdField_a_of_type_JavaLangString.length() <= i)) {
            break label238;
          }
          i = localSearchResultCache.jdField_a_of_type_JavaLangString.length();
          localObject1 = localSearchResultCache;
          break label241;
        }
  ...
  private List<IContactSearchModel> b(SearchRequest paramSearchRequest)
  {
    ...
    do
    {
      ...
      ??? = new ArrayList();
      bool = a(localArrayList, (List)???, localCancelFlag, paramSearchRequest);
  ...
  protected List<IContactSearchModel> a(int paramInt)
  {
        ...
        if (localObject1 != null)
        {
          ...
          while (localIterator1.hasNext())
          {
            ...
            if (localObject1 != null)
            {
              ...
              for (localObject1 = BaseApplicationImpl.sApplication.getResources().getString(2131720362);; localObject1 = localGroups.group_name)
              {
    ...
    if ((paramInt & 0x100) != 0)
    {
      ...
      localObject3 = (PhoneContactManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.CONTACT_MANAGER);
  ...
  public void a()
  {
    ...
    //   0: aload_0
    //   1: aload_0
    //   2: getfield 52	com/tencent/mobileqq/search/searchengine/ApproximateSearchEngine:jdField_a_of_type_Int	I
    //   5: invokevirtual 415	com/tencent/mobileqq/search/searchengine/ApproximateSearchEngine:a	(I)Ljava/util/List;
    //   8: astore_1
    //   9: aload_0
    //   10: monitorenter
    //   11: aload_1
    ...
    //   21: ifle +26 -> 47
    //   24: aload_0
    //   25: getfield 50	com/tencent/mobileqq/search/searchengine/ApproximateSearchEngine:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   28: invokeinterface 418 1 0
    //   33: aload_0
    //   34: getfield 50	com/tencent/mobileqq/search/searchengine/ApproximateSearchEngine:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   37: aload_1
    ...
    //   46: return
    //   47: aload_0
    //   48: getfield 50	com/tencent/mobileqq/search/searchengine/ApproximateSearchEngine:jdField_a_of_type_JavaUtilList	Ljava/util/List;
