...
{
  private Comparator<IContactSearchModel> a = new PhoneContactBinedSearchEngine.1(this);
  
  public PhoneContactBinedSearchEngine(QQAppInterface paramQQAppInterface, int paramInt1, int paramInt2, String paramString, Set<String> paramSet)
  {
