  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    View localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559925, null, false);
    ImageView localImageView1 = (ImageView)localView.findViewById(2131363419);
    ImageView localImageView2 = (ImageView)localView.findViewById(2131363046);
    ImageView localImageView3 = (ImageView)localView.findViewById(2131363033);
    TextView localTextView1 = (TextView)localView.findViewById(2131364357);
    TextView localTextView2 = (TextView)localView.findViewById(2131365655);
    if (ThemeUtil.isNowThemeIsNight(BaseApplicationImpl.getApplication().getRuntime(), false, null))
    {
      localImageView1.setBackgroundColor(Color.parseColor("#0b1d35"));
      localImageView2.setImageResource(2130842515);
      localImageView3.setImageResource(2130842515);
      localTextView1.setBackgroundResource(2130846338);
    }
    for (;;)
    {
      ...
      return;
      localImageView1.setImageResource(2130839407);
      localImageView2.setImageResource(2130842516);
      localImageView3.setImageResource(2130842516);
      localTextView1.setBackgroundResource(2130842506);
    }
  }
}
