...
public class MostUsedCache
{
  ...
  public static ArrayList<MostUsedCache.MostUsedSearchItemModel> a(ArrayList<MostUsedCache.MostUsedSearchItemModel> paramArrayList)
  {
    ...
    while (paramArrayList.hasNext())
    {
      ...
      if (((HashMap)localObject).containsKey(Integer.valueOf(i)))
      {
        ...
        if (localHashMap.containsKey(localMostUsedSearchItemModel.jdField_a_of_type_ComTencentMobileqqSearchMostusedMostUsedSearchItem.identify)) {
          QLog.d("MostUsedCahce", 2, "more high level exsit " + localMostUsedSearchItemModel.jdField_a_of_type_ComTencentMobileqqSearchMostusedMostUsedSearchItem.identify);
        } else {
          localHashMap.put(localMostUsedSearchItemModel.jdField_a_of_type_ComTencentMobileqqSearchMostusedMostUsedSearchItem.identify, localMostUsedSearchItemModel);
        }
      }
      else
      {
      ...
      while (paramArrayList.hasNext())
      {
        ...
        if ((localObject != null) && (((HashMap)localObject).values() != null) && (((HashMap)localObject).values().size() > 0))
        {
          ...
          while (((Iterator)localObject).hasNext()) {
            localArrayList.add((MostUsedCache.MostUsedSearchItemModel)((Iterator)localObject).next());
          }
        }
      }
    }
      ...
      try
      {
        ...
        if (k != 0)
        {
          ...
          if (j < localMostUsedSearch.items.size())
          {
            ...
            {
              MostUsedCache.MostUsedSearchItemModel localMostUsedSearchItemModel = new MostUsedCache.MostUsedSearchItemModel(this);
              localMostUsedSearchItemModel.jdField_a_of_type_Boolean = false;
              localMostUsedSearchItemModel.jdField_a_of_type_ComTencentMobileqqSearchMostusedMostUsedSearchItem = new MostUsedSearchItem(localMostUsedSearchItem);
              localMostUsedSearchItemModel.jdField_a_of_type_Int = k;
              paramQQAppInterface.add(localMostUsedSearchItemModel);
            }
            else
            {
  ...
  public void a()
  {
    ...
    //   55: astore_1
    //   56: aload_0
    //   57: getfield 44	com/tencent/mobileqq/search/mostused/MostUsedCache:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
