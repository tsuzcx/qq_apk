  ...
  implements IPresenter
{
  ...
  public void a(IModel paramIModel, ISearchResultGroupView paramISearchResultGroupView)
  {
    ...
    if (localLinearLayout != null)
    {
      ...
      if ((localList != null) && (!localList.isEmpty()))
      {
        ...
        if (i < j)
        {
          ...
          {
            localView1 = LayoutInflater.from(paramISearchResultGroupView.a().getContext()).inflate(2130971566, null);
            paramIModel = new FTSMessageSearchResultView(localView1);
            localView2 = localView1.findViewById(2131365690);
          ...
          for (;;)
          {
            ...
            i += 1;
            break;
            localView1 = LayoutInflater.from(paramISearchResultGroupView.a().getContext()).inflate(2130971565, null);
    ...
    if ((paramIModel == null) || (paramIModel.isEmpty()))
    {
      ...
      if (bool) {
        localSearchResultGroupMessageView.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130838586);
      }
      for (;;)
      {
        ...
        localSearchResultGroupMessageView.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130843297);
        localSearchResultGroupMessageView.jdField_a_of_type_AndroidViewView.setOnClickListener(new ahzb(this, localISearchResultGroupModel));
        return;
        localSearchResultGroupMessageView.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130838585);
      }
    }
