  ...
  implements IPresenter
{
  ...
  public void a(IModel paramIModel, ISearchResultGroupView paramISearchResultGroupView)
  {
    ...
    if (localLinearLayout != null)
    {
      ...
      if ((localList != null) && (!localList.isEmpty()))
      {
        ...
        if (i < j)
        {
          ...
          {
            localView1 = LayoutInflater.from(paramISearchResultGroupView.a().getContext()).inflate(2130971492, null);
            paramIModel = new FTSMessageSearchResultView(localView1);
            localView2 = localView1.findViewById(2131365658);
            ...
            localView1.setBackgroundColor(localResources.getColor(2131492947));
            localView2.setBackgroundResource(2130838576);
          }
          for (;;)
          {
            ...
            i += 1;
            break;
            localView1 = LayoutInflater.from(paramISearchResultGroupView.a().getContext()).inflate(2130971491, null);
            paramIModel = new SearchResultView(localView1);
            break label143;
            label347:
            localView1.setBackgroundColor(localResources.getColor(2131492968));
            localView2.setBackgroundResource(2130838575);
          }
        }
      }
    }
    ...
    if ((paramIModel == null) || (paramIModel.isEmpty()))
    {
      ...
      if (bool) {
        localSearchResultGroupMessageView.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130838576);
      }
      for (;;)
      {
        ...
        localSearchResultGroupMessageView.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130843165);
        localSearchResultGroupMessageView.jdField_a_of_type_AndroidViewView.setOnClickListener(new ahgi(this, localISearchResultGroupModel));
        return;
        localSearchResultGroupMessageView.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130838575);
      }
    }
