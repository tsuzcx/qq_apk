    ...
    if (localLinearLayout != null)
    {
      ...
      if (localList != null)
      {
        ...
        if (i < j)
        {
          ...
          View localView1 = LayoutInflater.from(paramISearchResultGroupView.a().getContext()).inflate(2130971487, null);
          View localView2 = localView1.findViewById(2131365658);
