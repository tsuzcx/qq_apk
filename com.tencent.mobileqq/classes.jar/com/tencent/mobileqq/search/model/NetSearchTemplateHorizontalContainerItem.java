  ...
  extends NetSearchTemplateBaseItem
{
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        paramString = new NetSearchTemplateHorizontalOneItem(this.g, this.jdField_a_of_type_Long, this.jdField_b_of_type_JavaUtilList, this.c, localJSONObject, j, (DynamicSearch.ResultItem)a(), i + 1);
        continue;
        QLog.e(jdField_a_of_type_JavaLangString, 2, "parseLayoutExtensions, e = " + paramString);
      }
      else if ((a() instanceof UnifySearchCommon.ResultItem))
      {
        paramString = new NetSearchTemplateHorizontalOneItem(this.g, this.jdField_a_of_type_Long, this.jdField_b_of_type_JavaUtilList, this.c, localJSONObject, j, (UnifySearchCommon.ResultItem)a(), i + 1);
        continue;
