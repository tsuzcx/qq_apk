  ...
  extends ISearchResultPositionModel
{
  ...
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqAppFmsFullMessageSearchResult$SearchResultItem.user.type == 3000) && (!TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString))) {
