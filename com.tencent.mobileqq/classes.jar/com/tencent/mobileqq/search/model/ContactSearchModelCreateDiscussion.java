  ...
  extends IContactSearchModel
{
  ...
  public ContactSearchModelCreateDiscussion(QQAppInterface paramQQAppInterface, int paramInt, String paramString, List<IContactSearchModel> paramList)
  {
  ...
  public void a(View paramView)
  {
    ...
    if (j < this.jdField_a_of_type_JavaUtilList.size())
    {
      ...
      str1 = ((IContactSearchModel)localObject).b();
    ...
    for (;;)
    {
      ...
      else if ((localObject instanceof ContactSearchModelFriend))
      {
        ...
        i = 0;
        continue;
        localIntent.putExtra("param_done_button_wording", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131718993));
        localIntent.putExtra("param_done_button_highlight_wording", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131718994));
        localIntent.putExtra("param_title", HardCodeUtil.a(2131702576));
