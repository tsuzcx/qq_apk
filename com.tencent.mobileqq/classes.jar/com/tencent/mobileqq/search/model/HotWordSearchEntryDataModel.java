  ...
  extends avpu
{
  ...
  public HotWordSearchEntryDataModel(QQAppInterface paramQQAppInterface, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Avoi = new avoi(this);
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_Avoi.b = ((DynamicDiscovery.TitleHeaderItem)localObject).icon_url.get().toStringUtf8();
        this.jdField_a_of_type_Avoi.jdField_a_of_type_JavaLangString = ((DynamicDiscovery.TitleHeaderItem)localObject).title.get().toStringUtf8();
        this.jdField_a_of_type_Avoi.c = ((DynamicDiscovery.TitleHeaderItem)localObject).morn_text.get().toStringUtf8();
        this.jdField_a_of_type_Avoi.d = ((DynamicDiscovery.TitleHeaderItem)localObject).morn_url.get().toStringUtf8();
        this.jdField_a_of_type_Avoi.jdField_a_of_type_Int = ((DynamicDiscovery.TitleHeaderItem)localObject).header_type.get();
        if (((DynamicDiscovery.TitleHeaderItem)localObject).qq_index_jump_url.has()) {
          this.jdField_a_of_type_Avoi.e = ((DynamicDiscovery.TitleHeaderItem)localObject).qq_index_jump_url.get().toStringUtf8();
        }
    ...
    try
    {
      ...
      this.jdField_a_of_type_Avoi.b = ((UnifySearchDiscovery.TitleHeaderItem)localObject).icon_url.get().toStringUtf8();
      this.jdField_a_of_type_Avoi.jdField_a_of_type_JavaLangString = ((UnifySearchDiscovery.TitleHeaderItem)localObject).title.get().toStringUtf8();
      this.jdField_a_of_type_Avoi.c = ((UnifySearchDiscovery.TitleHeaderItem)localObject).morn_text.get().toStringUtf8();
      this.jdField_a_of_type_Avoi.d = ((UnifySearchDiscovery.TitleHeaderItem)localObject).morn_url.get().toStringUtf8();
      this.jdField_a_of_type_Avoi.jdField_a_of_type_Int = ((UnifySearchDiscovery.TitleHeaderItem)localObject).header_type.get();
      if (((UnifySearchDiscovery.TitleHeaderItem)localObject).qq_index_jump_url.has()) {
        this.jdField_a_of_type_Avoi.e = ((UnifySearchDiscovery.TitleHeaderItem)localObject).qq_index_jump_url.get().toStringUtf8();
      }
      this.jdField_a_of_type_JavaUtilList.clear();
      if (!a(this.b, true))
      {
