  ...
  extends ContactSearchModelGlobalTroop
{
  ...
  public ContactSearchModelNewTroop(QQAppInterface paramQQAppInterface, int paramInt, String paramString, List<ContactSearchModelGlobalTroop.TroopSearchMemberInfo> paramList)
  {
  ...
  protected void a()
  {
    ...
    if (SearchUtils.a(this.jdField_b_of_type_Int))
    {
      ...
      {
        this.jdField_c_of_type_JavaLangCharSequence = (this.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo.wMemberNum + HardCodeUtil.a(2131702592));
        return;
      }
    }
    this.jdField_a_of_type_JavaLangCharSequence = HardCodeUtil.a(2131702601);
