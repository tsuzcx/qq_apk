  ...
  extends IContactSearchModel
{
  ...
  private long a(List paramList)
  {
    ...
    while (i < paramList.size())
    {
      ...
      {
        localObject = ((ahys)((List)paramList.get(i)).get(j)).jdField_a_of_type_ComTencentMobileqqSearchModelContactSearchModelGlobalTroop$TroopSearchMemberInfo;
        ...
        l2 = l1;
        if (((ahys)((List)paramList.get(i)).get(j)).jdField_a_of_type_Long > l1) {
          l2 = ((ahys)((List)paramList.get(i)).get(j)).jdField_a_of_type_Long;
        }
        j += 1;
        l1 = l2;
      }
    ...
    for (;;)
    {
      ...
      long l3 = ((ahys)((List)paramList.get(i)).get(arrayOfInt[i])).jdField_a_of_type_Long;
      l2 = l1;
      if (l3 > l1) {
        l2 = l3;
      }
      this.jdField_a_of_type_JavaUtilSet.add(((ahys)((List)paramList.get(i)).get(arrayOfInt[i])).jdField_a_of_type_ComTencentMobileqqSearchModelContactSearchModelGlobalTroop$TroopSearchMemberInfo);
      this.jdField_b_of_type_JavaUtilList.add(((ahys)((List)paramList.get(i)).get(arrayOfInt[i])).jdField_a_of_type_JavaLangString);
      i += 1;
      l1 = l2;
    }
  }
  ...
  static boolean a(int paramInt, List paramList, long[] paramArrayOfLong, Map paramMap1, int[] paramArrayOfInt, Map paramMap2, boolean[] paramArrayOfBoolean, Set paramSet, Map paramMap3)
  {
    ...
    {
      ContactSearchModelGlobalTroop.TroopSearchMemberInfo localTroopSearchMemberInfo = ((ahys)((List)paramList.get(paramInt)).get(i)).jdField_a_of_type_ComTencentMobileqqSearchModelContactSearchModelGlobalTroop$TroopSearchMemberInfo;
      if (paramSet.contains(localTroopSearchMemberInfo)) {}
      for (;;)
      {
        i += 1;
        break;
        long l = paramArrayOfLong[paramInt] + ((Long)paramMap1.get(localTroopSearchMemberInfo)).longValue() - ((ahys)((List)paramList.get(paramInt)).get(i)).jdField_a_of_type_Long;
        if (l == 0L)
        {
      ...
      while (i < paramString.length)
      {
        ...
        while (j < this.jdField_a_of_type_JavaUtilList.size())
        {
          ...
          if (l != -9223372036854775808L)
          {
            ...
            ((ahys)localObject).jdField_a_of_type_Long = l;
            ((ahys)localObject).jdField_a_of_type_JavaLangString = ((String)arrayOfObject[1]);
            ((ahys)localObject).jdField_a_of_type_ComTencentMobileqqSearchModelContactSearchModelGlobalTroop$TroopSearchMemberInfo = ((ContactSearchModelGlobalTroop.TroopSearchMemberInfo)this.jdField_a_of_type_JavaUtilList.get(j));
