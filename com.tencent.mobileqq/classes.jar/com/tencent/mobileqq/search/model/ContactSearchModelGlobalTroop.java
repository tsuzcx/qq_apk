  ...
  extends IContactSearchModel
{
  ...
  public ContactSearchModelGlobalTroop(QQAppInterface paramQQAppInterface, int paramInt, String paramString, List<ContactSearchModelGlobalTroop.TroopSearchMemberInfo> paramList)
  {
    ...
    if (paramQQAppInterface.getProxyManager().a().a(paramString))
    {
  ...
  private long a(List<List<ContactSearchModelGlobalTroop.TroopMemberMatchInfo>> paramList)
  {
    ...
    while (i < paramList.size())
    {
      ...
      {
        localObject = ((ContactSearchModelGlobalTroop.TroopMemberMatchInfo)((List)paramList.get(i)).get(j)).jdField_a_of_type_ComTencentMobileqqSearchModelContactSearchModelGlobalTroop$TroopSearchMemberInfo;
    ...
    for (;;)
    {
      ...
      long l3 = ((ContactSearchModelGlobalTroop.TroopMemberMatchInfo)((List)paramList.get(i)).get(arrayOfInt[i])).jdField_a_of_type_Long;
      l2 = l1;
      if (l3 > l1) {
        l2 = l3;
      }
      this.jdField_a_of_type_JavaUtilSet.add(((ContactSearchModelGlobalTroop.TroopMemberMatchInfo)((List)paramList.get(i)).get(arrayOfInt[i])).jdField_a_of_type_ComTencentMobileqqSearchModelContactSearchModelGlobalTroop$TroopSearchMemberInfo);
  ...
  static boolean a(int paramInt, List<List<ContactSearchModelGlobalTroop.TroopMemberMatchInfo>> paramList, long[] paramArrayOfLong, Map<ContactSearchModelGlobalTroop.TroopSearchMemberInfo, Long> paramMap1, int[] paramArrayOfInt, Map<ContactSearchModelGlobalTroop.TroopSearchMemberInfo, Integer> paramMap, boolean[] paramArrayOfBoolean, Set<ContactSearchModelGlobalTroop.TroopSearchMemberInfo> paramSet, Map<ContactSearchModelGlobalTroop.TroopSearchMemberInfo, Long> paramMap2)
  {
    ...
    {
      ContactSearchModelGlobalTroop.TroopSearchMemberInfo localTroopSearchMemberInfo = ((ContactSearchModelGlobalTroop.TroopMemberMatchInfo)((List)paramList.get(paramInt)).get(i)).jdField_a_of_type_ComTencentMobileqqSearchModelContactSearchModelGlobalTroop$TroopSearchMemberInfo;
      ...
      while (i < paramString.length)
      {
        ...
        while (j < this.jdField_a_of_type_JavaUtilList.size())
        {
          ...
          if (l != -9223372036854775808L)
          {
            ...
            ((ContactSearchModelGlobalTroop.TroopMemberMatchInfo)localObject).jdField_a_of_type_Long = l;
            ((ContactSearchModelGlobalTroop.TroopMemberMatchInfo)localObject).jdField_a_of_type_JavaLangString = ((String)arrayOfObject[1]);
            ((ContactSearchModelGlobalTroop.TroopMemberMatchInfo)localObject).jdField_a_of_type_ComTencentMobileqqSearchModelContactSearchModelGlobalTroop$TroopSearchMemberInfo = ((ContactSearchModelGlobalTroop.TroopSearchMemberInfo)this.jdField_a_of_type_JavaUtilList.get(j));
  ...
  public String c()
  {
    return ContactUtils.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString, true);
  }
