  ...
  extends SearchEntryDataModel
{
  ...
  private void c()
  {
    ...
    for (;;)
    {
      i += 1;
      break;
      if (((BusinessSearchEntryDataModel.SearchEntry)localObject3).jdField_c_of_type_Int != 4) {
        if (((BusinessSearchEntryDataModel.SearchEntry)localObject3).jdField_c_of_type_Int == 3)
        {
          ...
          ((BusinessSearchEntryDataModel.SearchEntry)localObject4).jdField_a_of_type_JavaLangString = HardCodeUtil.a(2131701330);
          ...
          if (SearchConfigUtils.b("emoji"))
          {
            ...
            ((BusinessSearchEntryDataModel.SearchEntry)localObject5).jdField_a_of_type_JavaLangString = HardCodeUtil.a(2131701343);
          ...
          else
          {
            ...
            ((BusinessSearchEntryDataModel.SearchEntry)localObject2).jdField_a_of_type_JavaLangString = HardCodeUtil.a(2131701344);
            ...
            if (TextUtils.isEmpty((CharSequence)localObject2)) {
              localObject1 = HardCodeUtil.a(2131718906);
            }
          ...
          for (;;)
          {
            ...
            ((BusinessSearchEntryDataModel.SearchEntry)localObject1).jdField_a_of_type_JavaLangString = HardCodeUtil.a(2131701324);
            ...
            break label342;
            label697:
            if ((localObject1 != null) && (!StudyModeManager.a()))
            {
