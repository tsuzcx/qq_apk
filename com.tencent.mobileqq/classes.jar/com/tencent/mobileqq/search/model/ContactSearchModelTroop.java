  ...
  extends IContactSearchModel
{
  ...
  public ContactSearchModelTroop(QQAppInterface paramQQAppInterface, int paramInt, TroopInfo paramTroopInfo, long paramLong)
  {
    ...
    if (paramQQAppInterface.getProxyManager().a().a(paramTroopInfo.troopuin)) {
      this.jdField_b_of_type_Long = IContactSearchable.C;
    }
    while ((this.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo.troopmask != 2) || (!TroopAssistantManager.a().a(paramTroopInfo.troopuin))) {
      return;
    }
    this.jdField_b_of_type_Long = IContactSearchable.C;
  }
  ...
  private void a()
  {
    ...
    {
      this.jdField_b_of_type_JavaLangString = String.valueOf(this.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo.wMemberNumClient + HardCodeUtil.a(2131702565));
      return;
    }
  ...
  public void a(View paramView)
  {
    ...
    {
      RecentUtil.a = true;
      RecentUtil.a(paramView.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo.troopuin, 1, this.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo.getTroopDisplayName(), false);
      ...
      SearchUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, a().toString(), this.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo.troopuin, this.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo.troopcode, 1);
      SearchUtils.a(this.c, 30, paramView, false);
      SearchUtils.a(this, paramView);
      if (((a() instanceof String)) && (!this.jdField_b_of_type_Boolean)) {
        SearchUtils.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.c, this.i, (String)a(), e());
      }
    ...
    for (;;)
    {
      new ReportTask(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_listNew").c("search_result").d("clk_grp").a(new String[] { this.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo.troopuin }).a();
      return;
      label253:
  ...
  public CharSequence c()
  {
    ...
    return HardCodeUtil.a(2131702607);
  }
  ...
  public CharSequence f()
  {
    ...
    localSpannableStringBuilder.append(HardCodeUtil.a(2131702586));
    if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo.troopRemark)) {
