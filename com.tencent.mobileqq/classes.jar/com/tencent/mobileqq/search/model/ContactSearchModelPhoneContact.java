  ...
  extends IContactSearchModel
{
  ...
  public void a(View paramView)
  {
    ...
    int i;
    Object localObject1;
    if ((paramView.getId() == 2131368974) && (this.jdField_b_of_type_Int == 17))
    {
      int j;
  ...
  public CharSequence d()
  {
    if ((this.jdField_b_of_type_Int == 17) && (this.jdField_a_of_type_ComTencentMobileqqDataPhoneContact.samFriend > 0)) {
      return String.format(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getResources().getString(2131433325), new Object[] { Integer.valueOf(this.jdField_a_of_type_ComTencentMobileqqDataPhoneContact.samFriend) });
    }
    return null;
  }
