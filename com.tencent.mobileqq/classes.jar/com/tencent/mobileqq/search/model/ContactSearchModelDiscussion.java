  ...
  extends IContactSearchModel
{
  ...
  public ContactSearchModelDiscussion(QQAppInterface paramQQAppInterface, int paramInt1, DiscussionInfo paramDiscussionInfo, List<DiscussionMemberInfo> paramList, int paramInt2)
  {
  ...
  private long a(List<List<ContactSearchModelDiscussion.DiscussionMemberMatchInfo>> paramList)
  {
    ...
    while (i < paramList.size())
    {
      ...
      {
        localObject = ((ContactSearchModelDiscussion.DiscussionMemberMatchInfo)((List)paramList.get(i)).get(j)).jdField_a_of_type_ComTencentMobileqqDataDiscussionMemberInfo;
    ...
    for (;;)
    {
      ...
      long l3 = ((ContactSearchModelDiscussion.DiscussionMemberMatchInfo)((List)paramList.get(i)).get(arrayOfInt[i])).jdField_a_of_type_Long;
      l2 = l1;
      if (l3 > l1) {
        l2 = l3;
      }
  ...
  private void a()
  {
    ...
    if ((SearchUtils.a(this.jdField_b_of_type_Int)) || (this.jdField_b_of_type_Int == 5))
    {
      ...
      this.jdField_c_of_type_JavaLangCharSequence = (i + HardCodeUtil.a(2131702559));
      return;
    }
    this.jdField_a_of_type_JavaLangCharSequence = HardCodeUtil.a(2131702617);
  ...
  private Object[] a(DiscussionMemberInfo paramDiscussionMemberInfo, String paramString)
  {
    ...
    for (;;)
    {
      ...
      Friends localFriends = this.jdField_a_of_type_ComTencentMobileqqAppFriendsManager.b(paramDiscussionMemberInfo.memberUin);
        ...
        if (j < this.jdField_a_of_type_JavaUtilList.size())
        {
          ...
          for (;;)
          {
            ...
            if (l != -9223372036854775808L)
            {
              ...
              localDiscussionMemberMatchInfo.jdField_a_of_type_Long = l;
