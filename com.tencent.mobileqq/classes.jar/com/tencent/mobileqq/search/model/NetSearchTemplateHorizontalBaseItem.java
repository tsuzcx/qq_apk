  ...
  implements View.OnClickListener
{
  ...
  public void a(View paramView)
  {
    ...
    try
    {
      ...
      UniteSearchReportController.a(null, new ReportModelDC02528().module("all_result").action("clk_item").obj1(this.jdField_a_of_type_Long + "").obj2(this.j).ver1(this.g).ver2(UniteSearchReportController.a(this.c)).ver7(localJSONObject.toString()).session_id(paramView.getCurrentAccountUin() + SearchUtil.jdField_a_of_type_Long));
      return;
    }
