  ...
  extends NetSearchTemplateBaseItem
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = NetSearchTemplateQAItem.class.getSimpleName();
  }
    ...
    try
    {
      ...
      if (paramString != null)
      {
        ...
        while (i < paramString.length())
        {
          ...
          localObject1 = new AnswerItem((String)localObject1, str1, str2, str3, n, localArrayList);
 ...
 * Qualified Name:     com.tencent.mobileqq.search.model.NetSearchTemplateQAItem
