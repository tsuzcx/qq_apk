  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      int k = SearchUtils.h(this.b.m, (String)localObject);
      localHashMap.put("troopMask", String.valueOf(SearchUtils.h(this.b.m, (String)localObject)));
      localObject = SearchUtils.g(this.b.m, (String)localObject);
      i = j;
      if (localObject != null) {
