...
public class SearchConfigManager
{
  ...
  public static ArrayList<awvu> troopMemberUpdateConfigs;
  ...
  private static ArrayList<awvu> a(String paramString)
  {
    int i = 0;
        ...
        if (arrayOfString != null)
        {
          ...
          if (arrayOfString.length > 0)
          {
            ...
            for (;;)
            {
              ...
              {
                awvu localawvu = new awvu();
                localawvu.a = Integer.valueOf(localObject1[0]).intValue();
                localawvu.b = Integer.valueOf(localObject1[1]).intValue();
                localawvu.c = (Integer.valueOf(localObject1[2]).intValue() * 24);
                localawvu.d = (Integer.valueOf(localObject1[3]).intValue() * 24);
                localArrayList.add(localawvu);
              }
              i += 1;
            }
            Object localObject2;
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    //   754: invokestatic 538	ampm:a	()Lampm;
    //   757: sipush 414
    //   760: invokevirtual 541	ampm:a	(I)Ljava/lang/Object;
    //   763: checkcast 543	amsn
    //   766: astore_0
    //   767: aload_0
    //   768: ifnull -648 -> 120
    //   771: aload_0
    //   772: invokevirtual 545	amsn:a	()Z
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    //   189: iload_3
    //   190: invokestatic 601	auok:a	(I)V
    //   193: aload_1
