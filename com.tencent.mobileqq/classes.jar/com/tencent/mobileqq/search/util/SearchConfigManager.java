...
public class SearchConfigManager
{
  ...
  public static ArrayList<ayvi> troopMemberUpdateConfigs;
  ...
  private static ArrayList<ayvi> a(String paramString)
  {
    int i = 0;
        ...
        if (arrayOfString != null)
        {
          ...
          if (arrayOfString.length > 0)
          {
            ...
            for (;;)
            {
              ...
              {
                ayvi localayvi = new ayvi();
                localayvi.a = Integer.valueOf(localObject1[0]).intValue();
                localayvi.b = Integer.valueOf(localObject1[1]).intValue();
                localayvi.c = (Integer.valueOf(localObject1[2]).intValue() * 24);
                localayvi.d = (Integer.valueOf(localObject1[3]).intValue() * 24);
                localArrayList.add(localayvi);
              }
              i += 1;
            }
            Object localObject2;
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    //   754: invokestatic 538	aoks:a	()Laoks;
    //   757: sipush 414
    //   760: invokevirtual 541	aoks:a	(I)Ljava/lang/Object;
    //   763: checkcast 543	aonv
    //   766: astore_0
    //   767: aload_0
    //   768: ifnull -648 -> 120
    //   771: aload_0
    //   772: invokevirtual 545	aonv:a	()Z
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    //   189: iload_3
    //   190: invokestatic 601	awkd:a	(I)V
    //   193: aload_1
