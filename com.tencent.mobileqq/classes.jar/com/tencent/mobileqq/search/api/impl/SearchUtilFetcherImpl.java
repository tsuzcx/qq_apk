  ...
  implements ISearchUtilFetcher
{
  public Drawable getFaceBitmap(IFaceDecoder paramIFaceDecoder, String paramString, int paramInt)
  {
    ...
    if (paramInt == 102) {
      return BaseApplicationImpl.sApplication.getResources().getDrawable(2130844282);
    }
    if (paramInt == 106) {
      return BaseApplicationImpl.sApplication.getResources().getDrawable(2130847270);
    }
    if (paramInt == 105)
    {
    ...
    if (String.valueOf(9999L).equals(paramString)) {
      return BaseApplicationImpl.sApplication.getResources().getDrawable(2130840421);
    }
    if (String.valueOf(9994L).equals(paramString)) {
      return BaseApplicationImpl.sApplication.getResources().getDrawable(2130840429);
    }
    if (String.valueOf(9992L).equals(paramString)) {
      return BaseApplicationImpl.sApplication.getResources().getDrawable(2130840427);
    }
    ...
    if (String.valueOf(9980L).equals(paramString)) {
      return BaseApplicationImpl.sApplication.getResources().getDrawable(2130840428);
    }
    if (String.valueOf(9973L).equals(paramString)) {
      return BaseApplicationImpl.sApplication.getResources().getDrawable(2130844725);
    }
    if (paramInt == 9889987) {
      return BaseApplicationImpl.sApplication.getResources().getDrawable(2130842637);
    }
    if (paramInt == 108)
    {
    ...
    else
    {
      if (String.valueOf(AppConstants.RECOMMEND_CONTACT_UIN).equals(paramString)) {
        return BaseApplicationImpl.sApplication.getResources().getDrawable(2130840417);
      }
      if (paramInt == 110)
      {
  ...
  {
    return SearchUtils.a(paramString1, paramString2, 6);
  }
  ...
  public void report(Context paramContext, String paramString1, String paramString2)
  {
    if ((paramContext instanceof SearchInfoInterface))
    {
      ...
      report(paramString1, paramString2, new String[] { str, localStringBuilder.toString(), "", SearchUtils.a("dynamic_tab_search.1", paramContext.a()) });
      return;
    }
  ...
  public void reportJumpToAIOorProfile(String paramString, int paramInt, View paramView, boolean paramBoolean)
  {
    ...
    if (isUniteSearchActivity(paramView.getContext()))
    {
      ...
      if (UniteSearchActivity.jdField_b_of_type_Boolean)
      {
        if (UniteSearchActivity.e == -1)
        {
          paramString = new StringBuilder();
          paramString.append("");
          paramString.append(UniteSearchActivity.jdField_b_of_type_Int);
          ReportController.b(null, "CliOper", "", "", "0X8007E2E", "0X8007E2E", 2, 0, "", paramString.toString(), UniteSearchActivity.a, "");
          return;
        }
        paramString = new StringBuilder();
        paramString.append("");
        paramString.append(UniteSearchActivity.jdField_b_of_type_Int);
        ReportController.b(null, "CliOper", "", "", "0X8007E2E", "0X8007E2E", 1, 0, "", paramString.toString(), UniteSearchActivity.a, "");
      }
    }
    else
    {
