  ...
  implements ISearchReportFetcher
{
  public String getReportType(ISearchResultModel paramISearchResultModel)
  {
    if ((!(paramISearchResultModel instanceof ContactSearchModelDiscussion)) && (!(paramISearchResultModel instanceof ContactSearchModelCreateDiscussion)) && (!(paramISearchResultModel instanceof ContactSearchModelDiscussionMember)))
    {
      if ((!(paramISearchResultModel instanceof ContactSearchModelGlobalTroop)) && (!(paramISearchResultModel instanceof ContactSearchModelGlobalTroopMember)) && (!(paramISearchResultModel instanceof ContactSearchModelTroop)) && (!(paramISearchResultModel instanceof ContactSearchModelTroopMember)) && (!(paramISearchResultModel instanceof ContactSearchModelNewTroop)) && (!(paramISearchResultModel instanceof ContactSearchModelNewTroopMember))) {
        return HardCodeUtil.a(2131705783);
      }
      return HardCodeUtil.a(2131705782);
    }
    return HardCodeUtil.a(2131705781);
  }
  ...
  {
    if (SearchUtils.a(paramInt))
    {
      Object localObject1 = (Integer)paramView.getTag(2131380885);
      Integer localInteger = (Integer)paramView.getTag(2131380883);
      Object localObject2;
      ...
      {
        Object localObject3 = (SearchUtils.ObjectItemInfo)SearchUtils.b.get(this);
        ...
        try
        {
          ...
          localJSONObject.put("obj_lct", ((SearchUtils.ObjectItemInfo)localObject3).jdField_a_of_type_Int);
        ...
        localStringBuilder1.append(((SearchUtils.ObjectItemInfo)localObject3).jdField_a_of_type_Long);
        localStringBuilder1.append("");
        paramString2 = paramString2.obj1(localStringBuilder1.toString()).obj2(((SearchUtils.ObjectItemInfo)localObject3).b).ver1(((SearchUtils.ObjectItemInfo)localObject3).jdField_a_of_type_JavaLangString).ver2(UniteSearchReportController.a(paramInt)).ver7(localJSONObject.toString());
  ...
  {
    UniteSearchReportController.a(null, 0, paramInt2, "0X8009D4B", 0, 0, null, null);
  }
  ...
  public void onReportRuntimeDC02528(AppInterface paramAppInterface, long paramLong, String paramString1, String paramString2, JSONObject paramJSONObject)
  {
    ...
    paramString1 = localReportModelDC02528.obj1(localStringBuilder.toString()).obj2(paramString1).ver1(paramString2).ver2(UniteSearchReportController.a(UniteSearchActivity.d)).ver7(paramJSONObject.toString());
    paramString2 = new StringBuilder();
    paramString2.append(paramAppInterface.getCurrentAccountUin());
    paramString2.append(SearchUtils.d);
