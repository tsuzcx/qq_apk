...
public class UnifiedDebugManager
{
  ...
  public static void a(Application paramApplication)
  {
    ...
    localEditor.commit();
    a(paramApplication);
    ThreadManager.getFileThreadHandler().postDelayed(new ajkc(paramApplication), 2000L);
  ...
  public UnifiedDebugManager.TerminalInfo a(Context paramContext)
  {
    ...
    localTerminalInfo.c = "7.6.0.3525";
    ...
    localTerminalInfo.jdField_b_of_type_Long = DeviceInfoUtil.e();
  ...
  {
    // Byte code:
    //   0: invokestatic 392	java/util/Calendar:getInstance	()Ljava/util/Calendar;
    //   3: astore 18
    //   5: aload 18
    //   7: lload_1
    //   8: invokevirtual 396	java/util/Calendar:setTimeInMillis	(J)V
    //   11: invokestatic 392	java/util/Calendar:getInstance	()Ljava/util/Calendar;
    //   14: astore 19
    //   16: aload 19
    //   18: lload_3
    //   19: invokevirtual 396	java/util/Calendar:setTimeInMillis	(J)V
    //   22: invokestatic 401	java/lang/System:currentTimeMillis	()J
    //   25: lstore 16
    //   27: lload_3
    //   28: lload 16
    //   30: lcmp
    ...
    //   34: aload 19
    //   36: lload 16
    //   38: invokevirtual 396	java/util/Calendar:setTimeInMillis	(J)V
    //   41: aload 18
    //   43: iconst_1
    //   44: invokevirtual 403	java/util/Calendar:get	(I)I
    //   47: istore 7
    //   49: aload 18
    //   51: iconst_2
    //   52: invokevirtual 403	java/util/Calendar:get	(I)I
    //   55: istore 8
    //   57: aload 18
    //   59: iconst_5
    //   60: invokevirtual 403	java/util/Calendar:get	(I)I
    //   63: istore 9
    //   65: aload 18
    //   67: bipush 10
    //   69: invokevirtual 403	java/util/Calendar:get	(I)I
    //   72: istore 10
    //   74: aload 19
    //   76: iconst_1
    //   77: invokevirtual 403	java/util/Calendar:get	(I)I
    //   80: istore 11
    //   82: aload 19
    //   84: iconst_2
    //   85: invokevirtual 403	java/util/Calendar:get	(I)I
    //   88: istore 12
    //   90: aload 19
    //   92: iconst_5
    //   93: invokevirtual 403	java/util/Calendar:get	(I)I
    //   96: istore 13
    //   98: aload 19
    //   100: bipush 10
    //   102: invokevirtual 403	java/util/Calendar:get	(I)I
    //   105: istore 14
    //   107: new 405	java/util/HashSet
    //   110: dup
    //   111: invokespecial 406	java/util/HashSet:<init>	()V
    //   114: astore 20
    //   116: iconst_0
    //   117: istore 6
    //   119: invokestatic 410	com/tencent/qphone/base/util/QLog:getLogFileFormatter	()Ljava/text/SimpleDateFormat;
    //   122: lload_1
    //   123: invokestatic 416	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   126: invokevirtual 422	java/text/SimpleDateFormat:format	(Ljava/lang/Object;)Ljava/lang/String;
    //   129: astore 18
    //   131: aload 20
    //   133: aload 18
    //   135: invokevirtual 426	java/util/HashSet:add	(Ljava/lang/Object;)Z
    //   138: pop
    //   139: iload 6
    //   141: istore 5
    //   143: iload 6
    ...
    //   172: lcmp
    //   173: ifle -54 -> 119
    //   176: new 433	java/util/ArrayList
    //   179: dup
    //   180: invokespecial 434	java/util/ArrayList:<init>	()V
    //   183: astore 22
    //   185: new 436	java/io/File
    //   188: dup
    //   189: invokestatic 439	com/tencent/qphone/base/util/QLog:getLogPath	()Ljava/lang/String;
    //   192: invokespecial 440	java/io/File:<init>	(Ljava/lang/String;)V
    //   195: astore 21
    //   197: aload 21
    //   199: invokevirtual 443	java/io/File:exists	()Z
    //   202: ifeq +183 -> 385
    //   205: aload 21
    //   207: invokevirtual 447	java/io/File:listFiles	()[Ljava/io/File;
    //   210: astore 23
    //   212: aload 23
    //   214: ifnull +177 -> 391
    //   217: aload 23
    ...
    //   237: astore 24
    //   239: aload 24
    //   241: invokevirtual 450	java/io/File:getName	()Ljava/lang/String;
    //   244: astore 19
    //   246: aload 19
    //   248: ldc_w 452
    //   251: invokevirtual 270	java/lang/String:endsWith	(Ljava/lang/String;)Z
    //   254: ifeq +12 -> 266
    //   257: iload 6
    //   259: iconst_1
    //   260: iadd
    ...
    //   266: aload 19
    //   268: ldc_w 454
    //   271: invokevirtual 270	java/lang/String:endsWith	(Ljava/lang/String;)Z
    //   274: ifeq +78 -> 352
    //   277: aload 19
    //   279: iconst_0
    //   280: aload 19
    //   282: invokevirtual 429	java/lang/String:length	()I
    //   285: iconst_4
    //   286: isub
    //   287: invokevirtual 458	java/lang/String:substring	(II)Ljava/lang/String;
    //   290: astore 18
    //   292: aload 18
    //   294: getstatic 461	com/tencent/qphone/base/util/QLog:packageName	Ljava/lang/String;
    //   297: invokevirtual 261	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   300: ifeq -43 -> 257
    //   303: aload 18
    //   305: aload 18
    //   307: invokevirtual 429	java/lang/String:length	()I
    //   310: iload 5
    //   312: isub
    //   313: invokevirtual 464	java/lang/String:substring	(I)Ljava/lang/String;
    //   316: astore 18
    //   318: aload 18
    //   320: invokestatic 469	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   323: ifne -66 -> 257
    //   326: aload 20
    //   328: aload 18
    //   330: invokevirtual 471	java/util/HashSet:contains	(Ljava/lang/Object;)Z
    //   333: ifeq -76 -> 257
    //   336: aload 22
    //   338: aload 24
    //   340: invokevirtual 474	java/io/File:getPath	()Ljava/lang/String;
    //   343: invokeinterface 475 2 0
    //   348: pop
    //   349: goto -92 -> 257
    //   352: aload 19
    //   354: astore 18
    //   356: aload 19
    //   358: ldc_w 477
    //   361: invokevirtual 270	java/lang/String:endsWith	(Ljava/lang/String;)Z
    //   364: ifeq -72 -> 292
    //   367: aload 19
    //   369: iconst_0
    //   370: aload 19
    //   372: invokevirtual 429	java/lang/String:length	()I
    //   375: iconst_5
    //   376: isub
    //   377: invokevirtual 458	java/lang/String:substring	(II)Ljava/lang/String;
    //   380: astore 18
    //   382: goto -90 -> 292
    //   385: aload 21
    //   387: invokevirtual 480	java/io/File:mkdirs	()Z
    //   390: pop
    //   391: aconst_null
    //   392: astore 18
    //   394: aload 21
    //   396: invokevirtual 443	java/io/File:exists	()Z
    //   399: ifeq +145 -> 544
    //   402: new 436	java/io/File
    //   405: dup
    //   406: aload 21
    //   408: ldc_w 482
    //   411: invokespecial 485	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   414: astore 18
    //   416: new 487	java/io/BufferedWriter
    //   419: dup
    //   420: new 489	java/io/OutputStreamWriter
    //   423: dup
    //   424: new 491	java/io/FileOutputStream
    //   427: dup
    //   428: aload 18
    //   430: invokespecial 494	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   433: invokespecial 497	java/io/OutputStreamWriter:<init>	(Ljava/io/OutputStream;)V
    //   436: invokespecial 500	java/io/BufferedWriter:<init>	(Ljava/io/Writer;)V
    //   439: astore 20
    //   441: aload 20
    //   443: astore 19
    //   445: aload 21
    //   447: invokevirtual 447	java/io/File:listFiles	()[Ljava/io/File;
    //   450: astore 21
    //   452: aload 21
    //   454: ifnull +71 -> 525
    //   457: aload 20
    ...
    //   485: astore 19
    //   487: aload 20
    //   489: new 146	java/lang/StringBuilder
    //   492: dup
    //   493: invokespecial 147	java/lang/StringBuilder:<init>	()V
    //   496: aload 23
    //   498: invokevirtual 450	java/io/File:getName	()Ljava/lang/String;
    //   501: invokevirtual 153	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   504: ldc_w 502
    //   507: invokevirtual 153	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   510: invokevirtual 162	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   513: invokevirtual 505	java/io/BufferedWriter:write	(Ljava/lang/String;)V
    //   516: iload 5
    //   518: iconst_1
    //   519: iadd
    //   520: istore 5
    ...
    //   527: astore 19
    //   529: aload 20
    //   531: invokevirtual 508	java/io/BufferedWriter:flush	()V
    //   534: aload 20
    //   536: ifnull +8 -> 544
    //   539: aload 20
    //   541: invokevirtual 511	java/io/BufferedWriter:close	()V
    //   544: aload 18
    //   546: ifnull +16 -> 562
    //   549: aload 22
    //   551: aload 18
    //   553: invokevirtual 474	java/io/File:getPath	()Ljava/lang/String;
    //   556: invokeinterface 475 2 0
    //   561: pop
    //   562: new 436	java/io/File
    //   565: dup
    //   566: ldc_w 513
    //   569: invokespecial 440	java/io/File:<init>	(Ljava/lang/String;)V
    //   572: astore 18
    //   574: aload 18
    //   576: invokevirtual 443	java/io/File:exists	()Z
    //   579: ifeq +16 -> 595
    //   582: aload 22
    //   584: aload 18
    //   586: invokevirtual 474	java/io/File:getPath	()Ljava/lang/String;
    //   589: invokeinterface 475 2 0
    //   594: pop
    //   595: new 146	java/lang/StringBuilder
    //   598: dup
    //   599: invokespecial 147	java/lang/StringBuilder:<init>	()V
    //   602: invokestatic 439	com/tencent/qphone/base/util/QLog:getLogPath	()Ljava/lang/String;
    //   605: invokevirtual 153	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   608: iload 7
    //   610: invokevirtual 170	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   613: ldc_w 515
    //   616: invokevirtual 153	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   619: iload 8
    //   621: iconst_1
    //   622: iadd
    //   623: invokevirtual 170	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   626: ldc_w 515
    //   629: invokevirtual 153	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   632: iload 9
    //   634: invokevirtual 170	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   637: ldc_w 515
    //   640: invokevirtual 153	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   643: iload 10
    //   645: invokevirtual 170	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   648: ldc_w 517
    //   651: invokevirtual 153	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   654: iload 11
    //   656: invokevirtual 170	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   659: ldc_w 515
    //   662: invokevirtual 153	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   665: iload 12
    //   667: iconst_1
    //   668: iadd
    //   669: invokevirtual 170	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   672: ldc_w 515
    //   675: invokevirtual 153	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   678: iload 13
    //   680: invokevirtual 170	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   683: ldc_w 515
    //   686: invokevirtual 153	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   689: iload 14
    //   691: invokevirtual 170	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   694: ldc_w 452
    //   697: invokevirtual 153	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   700: invokevirtual 162	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   703: astore 18
    //   705: aload 22
    //   707: aload 18
    //   709: invokestatic 522	com/tencent/mobileqq/unifiedebug/UnifiedFileUtil:a	(Ljava/util/List;Ljava/lang/String;)V
    //   712: aload 18
    //   714: areturn
    //   715: astore 19
    //   717: ldc 138
    ...
    //   720: ldc_w 524
    //   723: aload 19
    //   725: invokestatic 527	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   728: goto -184 -> 544
    //   731: astore 21
    //   733: aconst_null
    //   734: astore 20
    ...
    //   743: ldc_w 529
    //   746: aload 21
    //   748: invokestatic 527	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   751: aload 20
    //   753: ifnull +8 -> 761
    //   756: aload 20
    //   758: invokevirtual 511	java/io/BufferedWriter:close	()V
    //   761: goto -217 -> 544
    //   764: astore 19
    //   766: ldc 138
    //   768: iconst_1
    //   769: ldc_w 524
    //   772: aload 19
    //   774: invokestatic 527	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   777: goto -233 -> 544
    //   780: astore 18
    //   782: aconst_null
    //   783: astore 19
    ...
    //   787: ifnull +8 -> 795
    //   790: aload 19
    //   792: invokevirtual 511	java/io/BufferedWriter:close	()V
    //   795: aload 18
    //   797: athrow
    //   798: astore 19
    //   800: ldc 138
    ...
    //   803: ldc_w 524
    //   806: aload 19
    //   808: invokestatic 527	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   811: goto -16 -> 795
    //   814: astore 18
    //   816: goto -31 -> 785
    //   819: astore 21
    ...
    //   0	824	0	this	UnifiedDebugManager
  ...
  public String a(Context paramContext, String paramString)
  {
    ...
    {
      paramString = paramContext.list(new ajjz(this, paramString));
      ...
      finally
      {
        try
        {
          ...
          try
          {
            ...
            UnifiedFileUtil.a(localArrayList);
            return paramContext;
          }
  ...
  public String a(Context paramContext, List paramList)
  {
    ...
    if ((((File)localObject1).exists()) && (((File)localObject1).isDirectory()))
    {
      ...
      while (paramList.hasNext())
      {
        localObject2 = ((File)localObject1).list(new ajjx(this, c((String)paramList.next()).substring(0, 16)));
  ...
  {
    // Byte code:
    //   0: new 695	android/os/Bundle
    //   3: dup
    //   4: invokespecial 696	android/os/Bundle:<init>	()V
    //   7: astore 12
    //   9: aload 12
    //   11: ldc_w 698
    //   14: ldc_w 381
    //   17: invokestatic 702	com/tencent/mobileqq/webview/swift/utils/SwiftWebViewUtils:b	(Ljava/lang/String;)Ljava/lang/String;
    //   20: invokevirtual 705	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   23: invokestatic 710	com/tencent/smtt/sdk/CookieManager:getInstance	()Lcom/tencent/smtt/sdk/CookieManager;
    //   26: astore_1
    //   27: aload_1
    //   28: iconst_1
    //   29: invokevirtual 714	com/tencent/smtt/sdk/CookieManager:setAcceptCookie	(Z)V
    //   32: aload_1
    //   33: aload 4
    //   35: invokevirtual 717	com/tencent/smtt/sdk/CookieManager:getCookie	(Ljava/lang/String;)Ljava/lang/String;
    //   38: astore_1
    //   39: aload_1
    //   40: ifnull +69 -> 109
    //   43: aload 12
    //   45: ldc_w 719
    //   48: aload_1
    //   49: invokevirtual 705	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   52: invokestatic 136	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   55: ifeq +54 -> 109
    //   58: ldc 138
    //   60: iconst_2
    //   61: new 146	java/lang/StringBuilder
    //   64: dup
    //   65: invokespecial 147	java/lang/StringBuilder:<init>	()V
    //   68: ldc_w 721
    //   71: invokevirtual 153	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   74: aload_1
    //   75: iconst_0
    //   76: anewarray 257	java/lang/String
    //   79: invokestatic 726	com/tencent/biz/common/util/Util:c	(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    //   91: aload 4
    //   93: iconst_0
    //   94: anewarray 257	java/lang/String
    //   97: invokestatic 730	com/tencent/biz/common/util/Util:b	(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    //   106: invokestatic 144	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   109: new 146	java/lang/StringBuilder
    //   112: dup
    //   113: invokespecial 147	java/lang/StringBuilder:<init>	()V
    //   116: invokestatic 735	android/os/Environment:getExternalStorageDirectory	()Ljava/io/File;
    //   119: invokevirtual 738	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   122: ldc_w 740
    ...
    //   131: astore 9
    //   133: new 436	java/io/File
    //   136: dup
    //   137: aload 9
    //   139: invokespecial 440	java/io/File:<init>	(Ljava/lang/String;)V
    //   142: astore_1
    //   143: aload_1
    //   144: invokevirtual 443	java/io/File:exists	()Z
    //   147: ifne +8 -> 155
    //   150: aload_1
    //   151: invokevirtual 480	java/io/File:mkdirs	()Z
    //   154: pop
    //   155: lload_2
    //   156: invokestatic 743	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   159: astore 10
    //   161: new 146	java/lang/StringBuilder
    //   164: dup
    //   165: invokespecial 147	java/lang/StringBuilder:<init>	()V
    //   168: aload 9
    //   170: invokevirtual 153	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   173: ldc_w 592
    ...
    //   190: invokevirtual 162	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   193: astore 11
    //   195: new 436	java/io/File
    //   198: dup
    //   199: aload 11
    //   201: invokespecial 440	java/io/File:<init>	(Ljava/lang/String;)V
    //   204: astore 6
    //   206: aconst_null
    //   207: astore_1
    //   208: aconst_null
    ...
    //   211: aconst_null
    //   212: astore 7
    //   214: new 491	java/io/FileOutputStream
    //   217: dup
    //   218: aload 6
    //   220: invokespecial 494	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   223: astore 6
    //   225: new 558	java/net/URL
    //   228: dup
    //   229: aload 4
    //   231: invokespecial 559	java/net/URL:<init>	(Ljava/lang/String;)V
    //   234: invokevirtual 749	java/net/URL:openConnection	()Ljava/net/URLConnection;
    //   237: checkcast 751	java/net/HttpURLConnection
    //   240: astore_1
    //   241: aload_1
    //   242: ldc_w 753
    //   245: invokevirtual 756	java/net/HttpURLConnection:setRequestMethod	(Ljava/lang/String;)V
    //   248: aload_1
    //   249: sipush 6000
    //   252: invokevirtual 760	java/net/HttpURLConnection:setConnectTimeout	(I)V
    //   255: aload_1
    //   256: sipush 6000
    //   259: invokevirtual 763	java/net/HttpURLConnection:setReadTimeout	(I)V
    //   262: aload 12
    //   264: invokevirtual 767	android/os/Bundle:keySet	()Ljava/util/Set;
    //   267: invokeinterface 770 1 0
    //   272: astore 4
    //   274: aload 4
    //   276: invokeinterface 243 1 0
    //   281: ifeq +110 -> 391
    //   284: aload 4
    //   286: invokeinterface 247 1 0
    //   291: checkcast 257	java/lang/String
    //   294: astore 7
    //   296: aload 12
    //   298: aload 7
    //   300: invokevirtual 772	android/os/Bundle:get	(Ljava/lang/String;)Ljava/lang/Object;
    //   303: astore 8
    //   305: aload 8
    //   307: instanceof 257
    //   310: ifeq -36 -> 274
    ...
    //   321: invokevirtual 775	java/net/HttpURLConnection:setRequestProperty	(Ljava/lang/String;Ljava/lang/String;)V
    //   324: goto -50 -> 274
    //   327: astore 7
    //   329: aload 6
    //   331: astore 4
    ...
    //   350: ldc_w 777
    //   353: aload 6
    //   355: invokestatic 527	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   358: aload 6
    //   360: athrow
    //   361: astore 7
    //   363: aload_1
    ...
    //   371: ifnull +8 -> 379
    //   374: aload 6
    //   376: invokevirtual 780	java/io/OutputStream:close	()V
    //   379: aload 4
    //   381: ifnull +8 -> 389
    //   384: aload 4
    //   386: invokevirtual 783	java/net/HttpURLConnection:disconnect	()V
    //   389: aload_1
    //   390: athrow
    //   391: aload_1
    //   392: invokevirtual 786	java/net/HttpURLConnection:connect	()V
    //   395: sipush 200
    //   398: aload_1
    //   399: invokevirtual 789	java/net/HttpURLConnection:getResponseCode	()I
    //   402: if_icmpne +56 -> 458
    //   405: sipush 1024
    //   408: newarray byte
    //   410: astore 4
    //   412: new 791	java/io/BufferedInputStream
    //   415: dup
    //   416: aload_1
    //   417: invokevirtual 795	java/net/HttpURLConnection:getInputStream	()Ljava/io/InputStream;
    //   420: invokespecial 798	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   423: astore 7
    //   425: aload 7
    //   427: aload 4
    //   429: invokevirtual 804	java/io/InputStream:read	([B)I
    //   432: istore 5
    //   434: iconst_m1
    //   435: iload 5
    ...
    //   444: iconst_0
    //   445: iload 5
    //   447: invokevirtual 807	java/io/OutputStream:write	([BII)V
    //   450: goto -25 -> 425
    //   453: aload 6
    //   455: invokevirtual 808	java/io/OutputStream:flush	()V
    //   458: aload 6
    //   460: ifnull +8 -> 468
    //   463: aload 6
    //   465: invokevirtual 780	java/io/OutputStream:close	()V
    //   468: aload_1
    //   469: ifnull +7 -> 476
    //   472: aload_1
    //   473: invokevirtual 783	java/net/HttpURLConnection:disconnect	()V
    //   476: new 433	java/util/ArrayList
    //   479: dup
    //   480: invokespecial 434	java/util/ArrayList:<init>	()V
    //   483: astore_1
    //   484: aload_1
    //   485: aload 11
    //   487: invokeinterface 475 2 0
    //   492: pop
    //   493: new 146	java/lang/StringBuilder
    //   496: dup
    //   497: invokespecial 147	java/lang/StringBuilder:<init>	()V
    //   500: aload 9
    //   502: invokevirtual 153	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   505: ldc_w 592
    //   508: invokevirtual 153	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   511: aload 10
    //   513: invokevirtual 153	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   516: ldc_w 452
    //   519: invokevirtual 153	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   522: invokevirtual 162	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   525: astore 4
    //   527: aload_1
    //   528: aload 4
    //   530: invokestatic 522	com/tencent/mobileqq/unifiedebug/UnifiedFileUtil:a	(Ljava/util/List;Ljava/lang/String;)V
    //   533: aload 4
    //   535: areturn
    //   536: astore 4
    //   538: ldc 138
    ...
    //   541: ldc_w 777
    //   544: aload 4
    //   546: invokestatic 527	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   549: goto -81 -> 468
    //   552: astore 6
    //   554: ldc 138
    //   556: iconst_1
    //   557: ldc_w 777
    //   560: aload 6
    //   562: invokestatic 527	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   565: goto -186 -> 379
    //   568: astore_1
    //   569: aconst_null
    //   570: astore 6
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	623	0	this	UnifiedDebugManager
  ...
  public void a(Context paramContext, String paramString1, int paramInt, long paramLong1, long paramLong2, String paramString2)
  {
    synchronized (this.jdField_a_of_type_JavaUtilQueue)
    {
      ...
      {
        this.jdField_a_of_type_JavaUtilQueue.offer(new ajkd(this, paramString1, paramInt, paramLong1, paramLong2, paramString2));
        return;
      }
  ...
  public void a(Context paramContext, List paramList)
  {
    ...
    for (;;)
    {
      ...
      localObject1 = paramContext.listFiles(new ajjy(this, c((String)paramList.next()).substring(0, 16)));
  ...
  public boolean a(Context paramContext, long paramLong)
  {
    synchronized (this.jdField_a_of_type_JavaUtilQueue)
    {
      ajkd localajkd = (ajkd)this.jdField_a_of_type_JavaUtilQueue.poll();
      if ((localajkd != null) && (localajkd.jdField_b_of_type_Long == paramLong))
      {
        localajkd = (ajkd)this.jdField_a_of_type_JavaUtilQueue.peek();
        if (localajkd != null)
        {
          b(paramContext, localajkd.jdField_a_of_type_JavaLangString, localajkd.jdField_a_of_type_Int, localajkd.jdField_a_of_type_Long, localajkd.jdField_b_of_type_Long, localajkd.jdField_b_of_type_JavaLangString);
          if (QLog.isColorLevel()) {
            QLog.d("UnifiedDebugManager", 2, "finish once webview debug, start new debug(dequeue one cmd): seq=" + localajkd.jdField_b_of_type_Long);
          }
        }
        while (!QLog.isColorLevel()) {
          return true;
  ...
  public void b(Context paramContext, String paramString1, int paramInt, long paramLong1, long paramLong2, String paramString2)
  {
    ...
    localIntent.putExtra("callback", this.jdField_a_of_type_AndroidOsResultReceiver);
    paramContext.startActivity(localIntent);
    this.jdField_a_of_type_AndroidOsHandler.postDelayed(new ajkb(this, paramLong2, paramContext, paramString1, paramInt, paramLong1, paramString2), 120000L + paramLong1);
  }
  ...
  public void b(Context paramContext, String paramString, List paramList)
  {
    ...
    if ((paramContext.exists()) && (paramContext.isDirectory()))
    {
      paramString = paramContext.list(new ajka(this, paramString));
      if ((paramString != null) && (paramString.length > 0))
      {
        int j = paramString.length;
        int i = 0;
