...
public class UnifiedDebugManager
{
  ...
  public UnifiedDebugManager.TerminalInfo a(Context paramContext)
  {
    ...
    localTerminalInfo.c = "8.5.5.5105";
  ...
  public String a(long paramLong1, long paramLong2)
  {
    ...
    //   172: lcmp
    //   173: ifle -54 -> 119
    //   176: new 436	java/util/ArrayList
    //   179: dup
    //   180: invokespecial 437	java/util/ArrayList:<init>	()V
    //   183: astore 22
    //   185: new 439	java/io/File
    //   188: dup
    //   189: invokestatic 442	com/tencent/qphone/base/util/QLog:getLogPath	()Ljava/lang/String;
    //   192: invokespecial 443	java/io/File:<init>	(Ljava/lang/String;)V
    //   195: astore 21
    //   197: aload 21
    //   199: invokevirtual 446	java/io/File:exists	()Z
    //   202: ifeq +183 -> 385
    //   205: aload 21
    //   207: invokevirtual 450	java/io/File:listFiles	()[Ljava/io/File;
    //   210: astore 23
    //   212: aload 23
    //   214: ifnull +177 -> 391
    //   217: aload 23
    ...
    //   237: astore 24
    //   239: aload 24
    //   241: invokevirtual 453	java/io/File:getName	()Ljava/lang/String;
    //   244: astore 19
    //   246: aload 19
    //   248: ldc_w 455
    ...
    //   279: iconst_0
    //   280: aload 19
    //   282: invokevirtual 432	java/lang/String:length	()I
    //   285: iconst_4
    //   286: isub
    //   287: invokevirtual 461	java/lang/String:substring	(II)Ljava/lang/String;
    //   290: astore 18
    //   292: aload 18
    //   294: ldc_w 257
    ...
    //   303: aload 18
    //   305: aload 18
    //   307: invokevirtual 432	java/lang/String:length	()I
    //   310: iload 5
    //   312: isub
    ...
    //   369: iconst_0
    //   370: aload 19
    //   372: invokevirtual 432	java/lang/String:length	()I
    //   375: iconst_5
    //   376: isub
    //   377: invokevirtual 461	java/lang/String:substring	(II)Ljava/lang/String;
    //   380: astore 18
    //   382: goto -90 -> 292
    //   385: aload 21
    ...
    //   392: astore 18
    //   394: aload 21
    //   396: invokevirtual 446	java/io/File:exists	()Z
    //   399: ifeq +145 -> 544
    //   402: new 439	java/io/File
    //   405: dup
    //   406: aload 21
    //   408: ldc_w 482
    ...
    //   443: astore 19
    //   445: aload 21
    //   447: invokevirtual 450	java/io/File:listFiles	()[Ljava/io/File;
    //   450: astore 21
    //   452: aload 21
    //   454: ifnull +71 -> 525
    //   457: aload 20
    ...
    //   496: aload 23
    //   498: invokevirtual 453	java/io/File:getName	()Ljava/lang/String;
    ...
    //   561: pop
    //   562: new 439	java/io/File
    //   565: dup
    //   566: ldc_w 513
    //   569: invokespecial 443	java/io/File:<init>	(Ljava/lang/String;)V
    //   572: astore 18
    //   574: aload 18
    //   576: invokevirtual 446	java/io/File:exists	()Z
    //   579: ifeq +16 -> 595
    //   582: aload 22
    //   584: aload 18
    ...
    //   602: invokestatic 442	com/tencent/qphone/base/util/QLog:getLogPath	()Ljava/lang/String;
  ...
  public String a(Context paramContext, String paramString)
  {
    ...
    {
      paramString = paramContext.list(new UnifiedDebugManager.3(this, paramString));
  ...
  public String a(QQAppInterface paramQQAppInterface, long paramLong, String paramString)
  {
    ...
    //   11: ldc_w 700
    //   14: ldc_w 384
    //   17: invokestatic 704	com/tencent/mobileqq/webview/swift/utils/SwiftWebViewUtils:b	(Ljava/lang/String;)Ljava/lang/String;
    //   20: invokevirtual 707	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   23: invokestatic 712	com/tencent/smtt/sdk/CookieManager:getInstance	()Lcom/tencent/smtt/sdk/CookieManager;
    //   26: astore_1
    //   27: aload_1
    //   28: iconst_1
    //   29: invokevirtual 716	com/tencent/smtt/sdk/CookieManager:setAcceptCookie	(Z)V
    //   32: aload_1
    //   33: aload 4
    //   35: invokevirtual 719	com/tencent/smtt/sdk/CookieManager:getCookie	(Ljava/lang/String;)Ljava/lang/String;
    //   38: astore_1
    //   39: aload_1
    //   40: ifnull +69 -> 109
    //   43: aload 12
    //   45: ldc_w 721
    //   48: aload_1
    //   49: invokevirtual 707	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   79: invokestatic 728	com/tencent/biz/common/util/Util:c	(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    //   97: invokestatic 732	com/tencent/biz/common/util/Util:b	(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    //   116: invokestatic 737	android/os/Environment:getExternalStorageDirectory	()Ljava/io/File;
    //   119: invokevirtual 740	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   122: ldc_w 742
    ...
    //   131: astore 9
    //   133: new 439	java/io/File
    //   136: dup
    //   137: aload 9
    //   139: invokespecial 443	java/io/File:<init>	(Ljava/lang/String;)V
    //   142: astore_1
    //   143: aload_1
    //   144: invokevirtual 446	java/io/File:exists	()Z
    //   147: ifne +8 -> 155
    //   150: aload_1
    //   151: invokevirtual 480	java/io/File:mkdirs	()Z
    //   154: pop
    //   155: lload_2
    //   156: invokestatic 745	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   159: astore 10
    ...
    //   193: astore 11
    //   195: new 439	java/io/File
    //   198: dup
    //   199: aload 11
    //   201: invokespecial 443	java/io/File:<init>	(Ljava/lang/String;)V
    //   204: astore 6
    //   206: aconst_null
    //   207: astore_1
    //   208: aconst_null
    ...
    //   234: invokevirtual 751	java/net/URL:openConnection	()Ljava/net/URLConnection;
    //   237: checkcast 753	java/net/HttpURLConnection
    //   240: astore_1
    //   241: aload_1
    //   242: ldc_w 755
    //   245: invokevirtual 758	java/net/HttpURLConnection:setRequestMethod	(Ljava/lang/String;)V
    //   248: aload_1
    //   249: sipush 6000
    //   252: invokevirtual 762	java/net/HttpURLConnection:setConnectTimeout	(I)V
    //   255: aload_1
    //   256: sipush 6000
    //   259: invokevirtual 765	java/net/HttpURLConnection:setReadTimeout	(I)V
    //   262: aload 12
    //   264: invokevirtual 769	android/os/Bundle:keySet	()Ljava/util/Set;
    //   267: invokeinterface 772 1 0
    //   272: astore 4
    //   274: aload 4
    ...
    //   296: aload 12
    //   298: aload 7
    //   300: invokevirtual 774	android/os/Bundle:get	(Ljava/lang/String;)Ljava/lang/Object;
    //   303: astore 8
    //   305: aload 8
    //   307: instanceof 259
    //   310: ifeq -36 -> 274
    ...
    //   321: invokevirtual 777	java/net/HttpURLConnection:setRequestProperty	(Ljava/lang/String;Ljava/lang/String;)V
    //   324: goto -50 -> 274
    //   327: astore 7
    //   329: aload 6
    //   331: astore 4
    ...
    //   371: ifnull +8 -> 379
    //   374: aload 6
    //   376: invokevirtual 782	java/io/OutputStream:close	()V
    //   379: aload 4
    //   381: ifnull +8 -> 389
    //   384: aload 4
    //   386: invokevirtual 785	java/net/HttpURLConnection:disconnect	()V
    //   389: aload_1
    //   390: athrow
    //   391: aload_1
    //   392: invokevirtual 788	java/net/HttpURLConnection:connect	()V
    //   395: sipush 200
    //   398: aload_1
    //   399: invokevirtual 791	java/net/HttpURLConnection:getResponseCode	()I
    //   402: if_icmpne +56 -> 458
    //   405: sipush 1024
    //   408: newarray byte
    //   410: astore 4
    //   412: new 793	java/io/BufferedInputStream
    //   415: dup
    //   416: aload_1
    //   417: invokevirtual 797	java/net/HttpURLConnection:getInputStream	()Ljava/io/InputStream;
    //   420: invokespecial 800	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   423: astore 7
    //   425: aload 7
    //   427: aload 4
    //   429: invokevirtual 806	java/io/InputStream:read	([B)I
    //   432: istore 5
    //   434: iconst_m1
    //   435: iload 5
    ...
    //   444: iconst_0
    //   445: iload 5
    //   447: invokevirtual 809	java/io/OutputStream:write	([BII)V
    //   450: goto -25 -> 425
    //   453: aload 6
    //   455: invokevirtual 810	java/io/OutputStream:flush	()V
    //   458: aload 6
    //   460: ifnull +8 -> 468
    //   463: aload 6
    //   465: invokevirtual 782	java/io/OutputStream:close	()V
    //   468: aload_1
    //   469: ifnull +7 -> 476
    //   472: aload_1
    //   473: invokevirtual 785	java/net/HttpURLConnection:disconnect	()V
    //   476: new 436	java/util/ArrayList
    //   479: dup
    //   480: invokespecial 437	java/util/ArrayList:<init>	()V
    //   483: astore_1
    //   484: aload_1
    //   485: aload 11
    ...
    synchronized (this.jdField_a_of_type_JavaUtilQueue)
    {
      ...
      if ((localCommand != null) && (localCommand.jdField_b_of_type_Long == paramLong))
      {
        ...
        if (localCommand != null)
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.d("UnifiedDebugManager", 2, "finish once webview debug, start new debug(dequeue one cmd): seq=" + localCommand.jdField_b_of_type_Long);
          }
        }
        while (!QLog.isColorLevel()) {
          return true;
