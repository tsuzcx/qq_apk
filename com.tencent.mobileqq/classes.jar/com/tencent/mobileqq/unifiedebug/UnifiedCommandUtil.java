...
public class UnifiedCommandUtil
{
  ...
  public static UnifiedCommandUtil.ExecResult a(String[] paramArrayOfString)
  {
    ...
    //   18: aload 16
    //   20: iconst_0
    //   21: putfield 26	com/tencent/mobileqq/unifiedebug/UnifiedCommandUtil$ExecResult:jdField_a_of_type_Boolean	Z
    //   24: aload 16
    //   26: areturn
    ...
    //   320: aload 16
    //   322: iload_3
    //   323: putfield 26	com/tencent/mobileqq/unifiedebug/UnifiedCommandUtil$ExecResult:jdField_a_of_type_Boolean	Z
    //   326: aload 16
    //   328: aload 17
    //   330: putfield 130	com/tencent/mobileqq/unifiedebug/UnifiedCommandUtil$ExecResult:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   333: aload_0
    //   334: ifnull +12 -> 346
    //   337: aload 16
    //   339: aload_0
    //   340: invokevirtual 50	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   343: putfield 133	com/tencent/mobileqq/unifiedebug/UnifiedCommandUtil$ExecResult:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   346: aload 16
    //   348: areturn
    //   349: aload 8
    //   351: astore 11
    ...
    //   407: astore 9
    //   409: aload 4
    //   411: invokevirtual 139	java/lang/Process:waitFor	()I
    //   414: istore_1
    //   415: aload 8
    //   417: astore 11
    //   419: aload 15
    ...
    //   459: dup
    //   460: new 141	java/io/InputStreamReader
    //   463: dup
    //   464: aload 4
    //   466: invokevirtual 145	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    //   469: invokespecial 148	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   472: invokespecial 151	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   475: astore_0
    //   476: new 105	java/io/BufferedReader
    //   479: dup
    //   480: new 141	java/io/InputStreamReader
    //   483: dup
    //   484: aload 4
    //   486: invokevirtual 154	java/lang/Process:getErrorStream	()Ljava/io/InputStream;
    //   489: invokespecial 148	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   492: invokespecial 151	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   495: astore 9
    //   497: aload_0
    //   498: invokevirtual 157	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   501: astore 6
    //   503: aload 6
    //   505: ifnull +48 -> 553
    //   508: aload 17
    //   510: aload 6
    //   512: invokeinterface 163 2 0
    //   517: pop
    ...
    //   550: goto -53 -> 497
    //   553: aload 9
    //   555: invokevirtual 157	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   558: astore 6
    //   560: aload 6
    //   562: ifnull +99 -> 661
    //   565: aload 5
    ...
    //   602: astore 9
    //   604: aload_0
    //   605: invokevirtual 166	java/lang/Exception:printStackTrace	()V
    //   608: aload 8
    //   610: ifnull +8 -> 618
    //   613: aload 8
    ...
    //   7	340	16	localExecResult	UnifiedCommandUtil.ExecResult
