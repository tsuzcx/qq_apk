...
import com.tencent.mobileqq.colornote.ColorNoteConfBean;
...
public class ColorNoteProxy
  extends BaseProxy
{
  public static int a;
  private static final Object jdField_a_of_type_JavaLangObject = new Object();
  private EntityManager jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager;
  ArrayList<ColorNoteProxy.IColorNoteListener> jdField_a_of_type_JavaUtilArrayList;
  private Comparator<ColorNote> jdField_a_of_type_JavaUtilComparator = new ColorNoteProxy.1(this);
  ...
  public ColorNoteProxy(QQAppInterface paramQQAppInterface, BaseProxyManager paramBaseProxyManager)
  {
  ...
  private void a(int paramInt, ColorNote paramColorNote)
  {
    ...
    if (i < j)
    {
      ...
      ((ColorNoteProxy.IColorNoteListener)localArrayList.get(i)).a(paramColorNote);
    }
    for (;;)
    {
      i += 1;
      ...
      label62:
      if (paramInt == 2) {
        ((ColorNoteProxy.IColorNoteListener)localArrayList.get(i)).b(paramColorNote);
      }
    }
  }
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        if (ColorNoteUtils.c(localColorNote))
        {
          ...
          a(((QQAppInterface)this.app).getCurrentUin(), localColorNote.getUniKey(), "mExtLong", Long.valueOf(localColorNote.mExtLong));
        }
      }
    }
  }
  ...
  public void a(ColorNoteProxy.IColorNoteListener paramIColorNoteListener)
  {
    if (this.jdField_a_of_type_JavaUtilArrayList == null) {
      this.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
    }
    if (!this.jdField_a_of_type_JavaUtilArrayList.contains(paramIColorNoteListener)) {
      this.jdField_a_of_type_JavaUtilArrayList.add(paramIColorNoteListener);
    }
  }
  ...
  {
    boolean bool = false;
    if ((!a(paramColorNote)) && (ColorNoteSmallScreenUtil.a())) {
    ...
    QLog.e("ColorNoteProxy", 2, "addColorNote error! isAfterSyncMsg = " + ColorNoteSmallScreenUtil.a());
    return false;
  }
  ...
  public void b(ColorNoteProxy.IColorNoteListener paramIColorNoteListener)
  {
    if (this.jdField_a_of_type_JavaUtilArrayList != null) {
      this.jdField_a_of_type_JavaUtilArrayList.remove(paramIColorNoteListener);
    }
  }
  ...
  public void init()
  {
    ...
    if ((localObject != null) && (!((List)localObject).isEmpty()))
    {
      ...
      ColorNoteSmallScreenUtil.a(((QQAppInterface)this.app).getApp(), false, false);
    }
    localObject = ColorNoteConfigProcessor.a();
    if ((localObject != null) && (((ColorNoteConfBean)localObject).a() != -1))
    {
      jdField_a_of_type_Int = ((ColorNoteConfBean)localObject).a();
      if (QLog.isColorLevel()) {
        QLog.e("ColorNoteConfigProcessor", 2, "init MAX_COUNT " + jdField_a_of_type_Int);
      }
    }
    ColorNoteSmallScreenUtil.a(BaseApplicationImpl.getContext(), 3, true);
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes8.jar
 * Qualified Name:     com.tencent.mobileqq.colornote.data.ColorNoteProxy
