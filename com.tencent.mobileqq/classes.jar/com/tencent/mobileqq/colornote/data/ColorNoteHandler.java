  ...
  extends BusinessHandler
{
  ...
  private short jdField_a_of_type_Short = -23193;
  
  public ColorNoteHandler(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (paramBoolean = true;; paramBoolean = false)
    {
      ...
      try
      {
        ...
        ((ByteBuffer)localObject2).putInt(Utils.a(l)).put((byte)0).putShort((short)1).putShort(this.jdField_a_of_type_Short).putShort((short)2).putShort(s);
