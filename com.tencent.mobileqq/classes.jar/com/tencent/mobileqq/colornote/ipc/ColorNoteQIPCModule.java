...
public class ColorNoteQIPCModule
{
  private static ColorNoteQIPCModule jdField_a_of_type_ComTencentMobileqqColornoteIpcColorNoteQIPCModule;
  private static final byte[] jdField_a_of_type_ArrayOfByte = new byte[0];
  private static final byte[] jdField_b_of_type_ArrayOfByte = new byte[0];
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new ColorNoteQIPCModule.1(this);
  private Point jdField_a_of_type_AndroidGraphicsPoint = new Point();
  private Set<String> jdField_a_of_type_JavaUtilSet = new HashSet();
  private WeakReference<ColorNoteCurd.OnColorNoteCurdListener> jdField_a_of_type_MqqUtilWeakReference;
  private boolean jdField_a_of_type_Boolean = true;
  private WeakReference<IServiceSyncListener> jdField_b_of_type_MqqUtilWeakReference;
  private boolean jdField_b_of_type_Boolean = true;
  
  public static ColorNoteQIPCModule a()
  {
    if (jdField_a_of_type_ComTencentMobileqqColornoteIpcColorNoteQIPCModule == null) {}
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      if (jdField_a_of_type_ComTencentMobileqqColornoteIpcColorNoteQIPCModule == null)
      {
        jdField_a_of_type_ComTencentMobileqqColornoteIpcColorNoteQIPCModule = new ColorNoteQIPCModule();
        if (QLog.isColorLevel()) {
          QLog.d("ColorNoteQIPCModule", 2, "create ColorNoteQIPCModule");
        }
      }
      return jdField_a_of_type_ComTencentMobileqqColornoteIpcColorNoteQIPCModule;
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("ColorNoteQIPCModule", 2, "[updateColorNoteSet] " + ColorNoteUtils.a());
    }
    if (paramInt2 == 2) {
      return;
    }
  ...
  {
    ColorNoteRecentView.a(paramBoolean);
  }
  
  public void a(ColorNoteCurd.OnColorNoteCurdListener paramOnColorNoteCurdListener)
  {
    this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(paramOnColorNoteCurdListener);
  }
  
  public void a(IServiceSyncListener paramIServiceSyncListener)
  {
    this.jdField_b_of_type_MqqUtilWeakReference = new WeakReference(paramIServiceSyncListener);
  }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ColorNoteQIPCModule", 2, "[setSyncState] " + ColorNoteUtils.a());
    }
  }
  ...
  public void c(boolean paramBoolean)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ColorNoteQIPCModule", 2, "[setCanAddColorNote] " + ColorNoteUtils.a());
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("ColorNoteQIPCModule", 2, "[getCanAddColorNote] " + ColorNoteUtils.a());
    }
 ...
 * Qualified Name:     com.tencent.mobileqq.colornote.ipc.ColorNoteQIPCModule
