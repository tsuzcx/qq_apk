...
{
  private static ColorNoteIPCServer jdField_a_of_type_ComTencentMobileqqColornoteColorNoteIPCServer;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver;
  private ColorNoteHelper jdField_a_of_type_ComTencentMobileqqColornoteColorNoteHelper;
  ...
  private ColorNoteIPCServer()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqColornoteColorNoteHelper = new ColorNoteHelper(localQQAppInterface, localQQAppInterface.getProxyManager().a());
  ...
  {
    if (jdField_a_of_type_ComTencentMobileqqColornoteColorNoteIPCServer == null) {}
    try
    {
      if (jdField_a_of_type_ComTencentMobileqqColornoteColorNoteIPCServer == null) {
        jdField_a_of_type_ComTencentMobileqqColornoteColorNoteIPCServer = new ColorNoteIPCServer();
      }
      return jdField_a_of_type_ComTencentMobileqqColornoteColorNoteIPCServer;
    }
    finally {}
  }
  ...
  {
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new ColorNoteIPCServer.1(this);
  ...
  private void c()
  {
    ...
    {
      ColorNoteProxy localColorNoteProxy = localQQAppInterface.getProxyManager().a();
      this.jdField_a_of_type_ComTencentMobileqqColornoteColorNoteHelper.a(localQQAppInterface);
      this.jdField_a_of_type_ComTencentMobileqqColornoteColorNoteHelper.a(localColorNoteProxy);
    }
  }
  
  private void d()
  {
    this.jdField_a_of_type_ComTencentMobileqqColornoteColorNoteHelper.a(null);
    this.jdField_a_of_type_ComTencentMobileqqColornoteColorNoteHelper.a(null);
  }
  ...
  EIPCResult c(Bundle paramBundle)
  {
    ...
    boolean bool = this.jdField_a_of_type_ComTencentMobileqqColornoteColorNoteHelper.b(str, i);
    paramBundle = new Bundle();
  ...
  {
    boolean bool = this.jdField_a_of_type_ComTencentMobileqqColornoteColorNoteHelper.c();
    paramBundle = new Bundle();
  ...
  EIPCResult e(Bundle paramBundle)
  {
    ...
    return EIPCResult.createResult(0, this.jdField_a_of_type_ComTencentMobileqqColornoteColorNoteHelper.a(str, bool));
  }
  ...
  EIPCResult f(Bundle paramBundle)
  {
    ...
    boolean bool = this.jdField_a_of_type_ComTencentMobileqqColornoteColorNoteHelper.b(str1, str2, str3, i);
    paramBundle = new Bundle();
  ...
  EIPCResult g(Bundle paramBundle)
  {
    ...
    boolean bool = this.jdField_a_of_type_ComTencentMobileqqColornoteColorNoteHelper.c(paramBundle);
    paramBundle = new Bundle();
  ...
  {
    boolean bool = ColorNoteHistoryManager.a(paramBundle.getInt("color_note_service_type"));
    paramBundle = new Bundle();
