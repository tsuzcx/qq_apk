    ...
    for (;;)
    {
      ...
      if (QLog.isDevelopLevel())
      {
        ...
        if ((paramContext != null) && (paramContext.size() != 0))
        {
          ...
          if (ColorNoteUtils.a(paramContext)) {
            ColorNoteSmallScreenService.a(this.a).a();
          }
          if (QLog.isColorLevel())
          {
            ColorNoteUtils.a("ColorNoteSmallScreenService", "[onReceive->FromType_UpdateData]\n[visibleColorNotes]: " + this.a.jdField_a_of_type_Int + "\n" + ColorNoteUtils.b(paramContext));
            break label728;
            paramContext = this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProxyManager().a().a();
            if ((!ColorNoteRecentView.a()) && (((paramContext.size() == 1) && (ColorNoteUtils.b((ColorNote)paramContext.get(0)))) || (paramContext.size() == 0)))
            {
              this.a.f();
              break label728;
              ...
              ColorNoteUtils.a("ColorNoteSmallScreenService", "[onReceive->FromType_CustomNightMode]\n[setCustomNightMode]: " + bool);
              break label728;
              label549:
