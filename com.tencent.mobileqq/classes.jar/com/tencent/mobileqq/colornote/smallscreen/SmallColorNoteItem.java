  ...
  extends LinearLayout
{
  ...
  private void a(boolean paramBoolean)
  {
    ...
    for (this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(getContext()).inflate(2131558808, null);; this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(getContext()).inflate(2131558807, null))
    {
      ...
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localView.findViewById(2131364722));
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    paramInt1 = (int)(baxn.a(getContext(), 6.0F) * f);
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWidgetRoundImageView.setmRadius((int)(baxn.a(getContext(), 3.0F) * f), false);
      localObject = (RelativeLayout.LayoutParams)this.jdField_a_of_type_ComTencentMobileqqWidgetRoundImageView.getLayoutParams();
      ((RelativeLayout.LayoutParams)localObject).height = ((int)(baxn.a(getContext(), 20.0F) * f));
      ((RelativeLayout.LayoutParams)localObject).width = ((int)(baxn.a(getContext(), 20.0F) * f));
      ...
      paramInt1 = Math.max(baxn.a(getContext(), 2.0F), (int)(baxn.a(getContext(), 4.0F) * f));
      if (!this.jdField_a_of_type_Boolean) {
        break label297;
      }
      paramInt2 = 0;
