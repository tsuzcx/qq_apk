  ...
  extends BroadcastReceiver
{
  ...
  private final aobf jdField_a_of_type_Aobf;
  
  public SkinnableServiceProcesser(Service paramService, aobf paramaobf)
  {
    this.jdField_a_of_type_AndroidAppService = paramService;
    this.jdField_a_of_type_Aobf = paramaobf;
    try
    {
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if (this.jdField_a_of_type_Aobf != null) {
      this.jdField_a_of_type_Aobf.e();
    }
