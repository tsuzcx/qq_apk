  ...
  implements Runnable
{
  ...
  public void run()
  {
    try
    {
      ...
      ColorNoteSmallScreenRelativeLayout.a(this.this$0, LottieComposition.Factory.fromInputStream(this.jdField_a_of_type_AndroidContentContext, localInputStream, new aquq(this)));
      return;
    }
