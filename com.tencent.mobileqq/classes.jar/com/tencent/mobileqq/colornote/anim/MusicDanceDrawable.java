  ...
  implements aqcn, Runnable
{
  ...
  {
    this.jdField_a_of_type_JavaUtilList.add(new aqcq(this, paramInt1, paramInt2, paramInt3, paramInt4, null));
  }
  ...
  public void a(Context paramContext, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    this.b = paramInt2;
    this.c = afur.a(2.0F, paramContext.getResources());
    if (this.c < 0) {}
  ...
  public void draw(@NonNull Canvas paramCanvas)
  {
    ...
    {
      aqcq localaqcq = (aqcq)this.jdField_a_of_type_JavaUtilList.get(i);
      paramCanvas.drawRect(this.jdField_a_of_type_Int, this.b - aqcq.a(localaqcq), this.jdField_a_of_type_Int + aqcq.b(localaqcq), this.b, this.jdField_a_of_type_AndroidGraphicsPaint);
      this.jdField_a_of_type_Int += aqcq.b(localaqcq) + this.c;
      i += 1;
    }
  }
  ...
  public void run()
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      while (i < this.jdField_a_of_type_JavaUtilList.size())
      {
        ...
        aqcq localaqcq = (aqcq)this.jdField_a_of_type_JavaUtilList.get(i);
        localaqcq.a((int)(d1 * aqcq.c(localaqcq)));
        i += 1;
      }
