...
public class FightMsgReporter
{
  ...
  public static void a()
  {
    ...
    if (jdField_c_of_type_Boolean) {
      QLog.d("FightMsgReporter", 1, "report.value:" + String.format("%b_%d_%d_%d_%d_%d_%d_%d_%d_%d", new Object[] { Boolean.valueOf(jdField_b_of_type_Boolean), Integer.valueOf(jdField_b_of_type_Int), Integer.valueOf(jdField_a_of_type_Int), Integer.valueOf(e), Integer.valueOf(d), Integer.valueOf(h), Integer.valueOf(g), Integer.valueOf(k), Integer.valueOf(j), Long.valueOf(jdField_a_of_type_Long) }));
    }
    ...
    ReportController.a(null, "dc00898", "", "", "0X800A95A", "0X800A95B", 0, h, "" + k, "", "", "");
    ReportController.a(null, "dc00898", "", "", "0X800A95A", "0X800A95B", 0, g, "" + j, "", "", "");
  ...
  public static void b()
  {
    ...
    do
    {
      ...
      BaseApplication localBaseApplication = BaseApplicationImpl.getContext();
      String str = BaseApplicationImpl.getApplication().getRuntime().getAccount();
      SharedPreUtils.a(localBaseApplication, "f_msg_report_preference", str, false, "key_msg_funnel_report_new_friend", Integer.valueOf(jdField_b_of_type_Int));
      SharedPreUtils.a(localBaseApplication, "f_msg_report_preference", str, false, "key_msg_funnel_report_new_troop", Integer.valueOf(jdField_a_of_type_Int));
      SharedPreUtils.a(localBaseApplication, "f_msg_report_preference", str, false, "key_msg_funnel_report_new_other", Integer.valueOf(jdField_c_of_type_Int));
      SharedPreUtils.a(localBaseApplication, "f_msg_report_preference", str, false, "key_msg_funnel_report_new_friend_aio", Integer.valueOf(e));
      SharedPreUtils.a(localBaseApplication, "f_msg_report_preference", str, false, "key_msg_funnel_report_new_troop_aio", Integer.valueOf(d));
      SharedPreUtils.a(localBaseApplication, "f_msg_report_preference", str, false, "key_msg_funnel_report_new_other_aio", Integer.valueOf(f));
      SharedPreUtils.a(localBaseApplication, "f_msg_report_preference", str, false, "key_msg_funnel_report_readed_friend", Integer.valueOf(h));
      SharedPreUtils.a(localBaseApplication, "f_msg_report_preference", str, false, "key_msg_funnel_report_readed_troop", Integer.valueOf(g));
      SharedPreUtils.a(localBaseApplication, "f_msg_report_preference", str, false, "key_msg_funnel_report_readed_other", Integer.valueOf(i));
      SharedPreUtils.a(localBaseApplication, "f_msg_report_preference", str, false, "key_msg_funnel_report_readed_friend_aio", Integer.valueOf(k));
      SharedPreUtils.a(localBaseApplication, "f_msg_report_preference", str, false, "key_msg_funnel_report_readed_troop_aio", Integer.valueOf(j));
      SharedPreUtils.a(localBaseApplication, "f_msg_report_preference", str, false, "key_msg_funnel_report_readed_other_aio", Integer.valueOf(l));
      SharedPreUtils.a(localBaseApplication, "f_msg_report_preference", str, false, "key_msg_report_time", Long.valueOf(jdField_a_of_type_Long));
    } while (!jdField_c_of_type_Boolean);
    QLog.d("FightMsgReporter", 1, "saveToSp.value:" + String.format("%b_%d_%d_%d_%d_%d_%d_%d_%d_%d", new Object[] { Boolean.valueOf(jdField_b_of_type_Boolean), Integer.valueOf(jdField_b_of_type_Int), Integer.valueOf(jdField_a_of_type_Int), Integer.valueOf(e), Integer.valueOf(d), Integer.valueOf(h), Integer.valueOf(g), Integer.valueOf(k), Integer.valueOf(j), Long.valueOf(jdField_a_of_type_Long) }));
  }
  ...
  private static void c()
  {
    ...
    if (jdField_c_of_type_Boolean) {
      QLog.d("FightMsgReporter", 1, "init.value:" + String.format("%b_%d_%d_%d_%d_%d_%d_%d_%d_%d", new Object[] { Boolean.valueOf(jdField_b_of_type_Boolean), Integer.valueOf(jdField_b_of_type_Int), Integer.valueOf(jdField_a_of_type_Int), Integer.valueOf(e), Integer.valueOf(d), Integer.valueOf(h), Integer.valueOf(g), Integer.valueOf(k), Integer.valueOf(j), Long.valueOf(jdField_a_of_type_Long) }));
    }
