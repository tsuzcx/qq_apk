  ...
  implements HookMethodCallback
{
  ...
  public BatteryStatsImpl$GPS(BatteryStatsImpl paramBatteryStatsImpl, String paramString)
  {
  ...
  public void a(String paramString, Object[] paramArrayOfObject)
  {
    ...
    {
      return;
      str3 = BatteryStatsImpl.a().toString();
      if (QLog.isColorLevel()) {
        BatteryStatsImpl.a(this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryBatteryStatsImpl, "onGPSScan: " + str3);
      }
    ...
    if ("requestLocationUpdates".equals(paramString)) {
      if (paramArrayOfObject.length == 5) {
        if ((paramArrayOfObject[2] instanceof Criteria))
        {
          ...
          BatteryIPCModule.a().a(paramString);
        }
      }
    }
    for (;;)
    {
      paramString = this.jdField_a_of_type_ComTencentMobileqqStatisticsBatteryHighFrequencyDetector.a(str3);
      if ((paramString != null) && (paramString.size() > 0))
      {
        BatteryStatsImpl.a(this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryBatteryStatsImpl, 6, 0, 0, "GPS request update is too frequently(" + this.jdField_a_of_type_Int + " in " + this.jdField_a_of_type_Long / 60L / 1000L + " seconds", HighFrequencyDetector.a(paramString));
        this.jdField_a_of_type_ComTencentMobileqqStatisticsBatteryHighFrequencyDetector.a();
      }
      paramString = this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryHighFrequencyDetector.a(str3);
      if ((paramString == null) || (paramString.size() <= 0)) {
        break;
      }
      BatteryStatsImpl.a(this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryBatteryStatsImpl, 6, 0, 0, "Wifi scan is too frequently(" + this.jdField_b_of_type_Int + " in " + this.jdField_b_of_type_Long / 60L / 1000L + " seconds", HighFrequencyDetector.a(paramString));
      ...
      {
        BatteryStatsImpl.a(this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryBatteryStatsImpl, new String[] { str4, "0", "|", "1", "|", "{", paramArrayOfObject[0].toString(), "#", paramArrayOfObject[1].toString(), "#", paramArrayOfObject[2].toString(), "}", "|", str3 });
        break label321;
      }
      BatteryStatsImpl.a(this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryBatteryStatsImpl, new String[] { str4, "0", "|", "-1", "|", "{}", "|", str3 });
      break label321;
      ...
      if ((paramArrayOfObject[0] instanceof String))
      {
        BatteryStatsImpl.a(this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryBatteryStatsImpl, new String[] { str4, "0", "|", "3", "|", "{", paramArrayOfObject[0].toString(), "#", paramArrayOfObject[1].toString(), "#", paramArrayOfObject[2].toString(), "}", "|", str3 });
        break label321;
      }
      BatteryStatsImpl.a(this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryBatteryStatsImpl, new String[] { str4, "0", "|", "-1", "|", "{}", "|", str3 });
      break label321;
      ...
      {
        if ((paramArrayOfObject[0] instanceof String)) {
          BatteryStatsImpl.a(this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryBatteryStatsImpl, new String[] { str4, "1", "|", "0", "|", "{", paramArrayOfObject[0].toString(), "}", "|", str3 });
        }
        for (;;)
        {
          paramString = new Bundle();
          ...
          if ((paramArrayOfObject[0] instanceof Criteria)) {
            BatteryStatsImpl.a(this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryBatteryStatsImpl, new String[] { str4, "1", "|", "1", "|", "{", "[", this.jdField_a_of_type_AndroidLocationLocationManager.getBestProvider((Criteria)paramArrayOfObject[0], true), ",", String.valueOf(((Criteria)paramArrayOfObject[0]).getAccuracy()), ",", String.valueOf(((Criteria)paramArrayOfObject[0]).getPowerRequirement()), "]", "}", "|", str3 });
          } else {
            BatteryStatsImpl.a(this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryBatteryStatsImpl, new String[] { str4, "1", "|", "-1", "|", "{}", "|", str3 });
          }
        }
        label1437:
        a(paramString);
      ...
      {
        label1465:
        BatteryStatsImpl localBatteryStatsImpl;
        String str5;
        String str6;
        String str1;
        ...
        {
          paramString = "none";
          localBatteryStatsImpl = this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryBatteryStatsImpl;
        ...
        {
          BatteryStatsImpl.a(localBatteryStatsImpl, new String[] { str4, "2", "|", "0", "|", "{", str5, "#", str6, "#", paramString, "#", str1, "#", str2, "#", paramArrayOfObject[5].toString(), "}", "|", str3 });
          ...
          BatteryIPCModule.a().a(paramArrayOfObject);
          break;
  ...
  {
    super.e();
    if ((this.jdField_a_of_type_Boolean) && (BatteryStatsImpl.a())) {}
    label518:
    for (;;)
    {
      String str;
      ...
      synchronized (this.jdField_a_of_type_JavaUtilMap)
      {
        ...
        BatteryStatsImpl.b(this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryBatteryStatsImpl, new String[] { "fg30SdkCount", "|", String.valueOf(i) });
        if (BatteryStatsImpl.b(this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryBatteryStatsImpl)) {
          BatteryStatsImpl.b(this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryBatteryStatsImpl, new String[] { "fg30SysCount", "|", String.valueOf(j) });
        }
        ...
        if (localIterator1.hasNext())
        {
          ...
          BatteryStatsImpl.b(this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryBatteryStatsImpl, new String[] { "fg30SdkDetail", "|", str, "|", ((StringBuilder)localObject3).toString() });
        }
      }
      ...
      while (localIterator2.hasNext())
      {
        ...
        BatteryStatsImpl.b(this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryBatteryStatsImpl, new String[] { "fg30SysDetail", "|", str, "|", ((StringBuilder)localObject2).toString() });
      }
  ...
  public void f()
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaUtilMap)
      {
        ...
        BatteryStatsImpl.b(this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryBatteryStatsImpl, new String[] { "bg5SdkCount", "|", String.valueOf(i) });
        if (BatteryStatsImpl.b(this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryBatteryStatsImpl)) {
          BatteryStatsImpl.b(this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryBatteryStatsImpl, new String[] { "bg5SysCount", "|", String.valueOf(j) });
        }
        ...
        if (localIterator1.hasNext())
        {
          ...
          BatteryStatsImpl.b(this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryBatteryStatsImpl, new String[] { "bg5SdkDetail", "|", str, "|", ((StringBuilder)localObject3).toString() });
        }
      }
      ...
      while (localIterator2.hasNext())
      {
        ...
        BatteryStatsImpl.b(this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryBatteryStatsImpl, new String[] { "bg5SysDetail", "|", str, "|", ((StringBuilder)localObject2).toString() });
      }
      this.jdField_c_of_type_JavaUtilMap.clear();
      this.jdField_d_of_type_JavaUtilMap.clear();
      return;
 ...
 * Qualified Name:     com.tencent.mobileqq.statistics.battery.BatteryStatsImpl.GPS
