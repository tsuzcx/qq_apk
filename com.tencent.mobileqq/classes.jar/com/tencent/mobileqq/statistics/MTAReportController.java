...
{
  private static volatile MTAReportController jdField_a_of_type_ComTencentMobileqqStatisticsMTAReportController;
  ...
  private MTAReportController(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext.getApplicationContext();
    this.jdField_a_of_type_Boolean = LightDpcConfig.a(this.jdField_a_of_type_AndroidContentContext, true);
  }
  
  public static MTAReportController a(Context paramContext)
  {
    if (jdField_a_of_type_ComTencentMobileqqStatisticsMTAReportController == null) {}
    try
    {
      if (jdField_a_of_type_ComTencentMobileqqStatisticsMTAReportController == null) {
        jdField_a_of_type_ComTencentMobileqqStatisticsMTAReportController = new MTAReportController(paramContext);
      }
      return jdField_a_of_type_ComTencentMobileqqStatisticsMTAReportController;
    }
    finally {}
  }
  ...
  private void b(boolean paramBoolean)
  {
    ...
    for (Object localObject = (QQAppInterface)localObject;; localObject = null)
    {
      ...
      ReportController.b((QQAppInterface)localObject, "dc00898", "", "", "0X80075F3", "0X80075F3", 0, 0, new SimpleDateFormat("yyyyMMdd", Locale.US).format(localDate), "", "", "");
      MTAReportManager.setMTAReporter(jdField_a_of_type_ComTencentMobileqqStatisticsMTAReportController);
 ...
 * Qualified Name:     com.tencent.mobileqq.statistics.MTAReportController
