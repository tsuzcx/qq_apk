  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    //   13: invokestatic 68	com/tencent/mobileqq/statistics/UnifiedMonitor:a	(Lcom/tencent/mobileqq/statistics/UnifiedMonitor;)[Lbdlz;
    //   16: aload_0
    //   17: getfield 63	com/tencent/mobileqq/statistics/UnifiedMonitor$StackGetterJob:jdField_a_of_type_Int	I
    //   20: aaload
    //   21: getfield 162	bdlz:g	I
    //   24: aload_0
    ...
    //   28: invokestatic 68	com/tencent/mobileqq/statistics/UnifiedMonitor:a	(Lcom/tencent/mobileqq/statistics/UnifiedMonitor;)[Lbdlz;
    //   31: aload_0
    //   32: getfield 63	com/tencent/mobileqq/statistics/UnifiedMonitor$StackGetterJob:jdField_a_of_type_Int	I
    //   35: aaload
    //   36: getfield 163	bdlz:jdField_b_of_type_Int	I
    //   39: if_icmplt +15 -> 54
    //   42: aload_0
    ...
    //   58: invokestatic 68	com/tencent/mobileqq/statistics/UnifiedMonitor:a	(Lcom/tencent/mobileqq/statistics/UnifiedMonitor;)[Lbdlz;
    //   61: aload_0
    //   62: getfield 63	com/tencent/mobileqq/statistics/UnifiedMonitor$StackGetterJob:jdField_a_of_type_Int	I
    //   65: aaload
    //   66: getfield 169	bdlz:jdField_b_of_type_Long	J
    //   69: lconst_0
    //   70: lcmp
    //   71: ifne +19 -> 90
    //   74: aload_0
    ...
    //   94: invokestatic 68	com/tencent/mobileqq/statistics/UnifiedMonitor:a	(Lcom/tencent/mobileqq/statistics/UnifiedMonitor;)[Lbdlz;
    //   97: aload_0
    //   98: getfield 63	com/tencent/mobileqq/statistics/UnifiedMonitor$StackGetterJob:jdField_a_of_type_Int	I
    //   101: aaload
    //   102: getfield 169	bdlz:jdField_b_of_type_Long	J
    //   105: lstore_1
    //   106: lload_1
    //   107: lconst_0
    //   108: lcmp
    ...
    //   135: invokestatic 68	com/tencent/mobileqq/statistics/UnifiedMonitor:a	(Lcom/tencent/mobileqq/statistics/UnifiedMonitor;)[Lbdlz;
    //   138: aload_0
    //   139: getfield 63	com/tencent/mobileqq/statistics/UnifiedMonitor$StackGetterJob:jdField_a_of_type_Int	I
    //   142: aaload
    //   143: getfield 169	bdlz:jdField_b_of_type_Long	J
    //   146: lsub
    //   147: aload_0
    ...
    //   151: invokestatic 68	com/tencent/mobileqq/statistics/UnifiedMonitor:a	(Lcom/tencent/mobileqq/statistics/UnifiedMonitor;)[Lbdlz;
    //   154: aload_0
    //   155: getfield 63	com/tencent/mobileqq/statistics/UnifiedMonitor$StackGetterJob:jdField_a_of_type_Int	I
    //   158: aaload
    //   159: getfield 71	bdlz:jdField_a_of_type_Int	I
    //   162: i2l
    //   163: lsub
    //   164: lstore_3
    //   165: lload_3
    ...
    //   185: invokestatic 68	com/tencent/mobileqq/statistics/UnifiedMonitor:a	(Lcom/tencent/mobileqq/statistics/UnifiedMonitor;)[Lbdlz;
    //   188: aload_0
    //   189: getfield 63	com/tencent/mobileqq/statistics/UnifiedMonitor$StackGetterJob:jdField_a_of_type_Int	I
    //   192: aaload
    //   193: getfield 169	bdlz:jdField_b_of_type_Long	J
    //   196: lcmp
    //   197: ifne -188 -> 9
    //   200: aload_0
    ...
    //   204: invokestatic 68	com/tencent/mobileqq/statistics/UnifiedMonitor:a	(Lcom/tencent/mobileqq/statistics/UnifiedMonitor;)[Lbdlz;
    //   207: aload_0
    ...
    //   224: putfield 188	bdlz:jdField_b_of_type_Boolean	Z
    //   227: aload_0
    ...
    //   278: invokestatic 68	com/tencent/mobileqq/statistics/UnifiedMonitor:a	(Lcom/tencent/mobileqq/statistics/UnifiedMonitor;)[Lbdlz;
    //   281: aload_0
    //   282: getfield 63	com/tencent/mobileqq/statistics/UnifiedMonitor$StackGetterJob:jdField_a_of_type_Int	I
    //   285: aaload
    //   286: getfield 169	bdlz:jdField_b_of_type_Long	J
    //   289: lcmp
    //   290: ifne +80 -> 370
    //   293: aload_0
    //   294: iconst_1
    ...
    //   312: invokestatic 68	com/tencent/mobileqq/statistics/UnifiedMonitor:a	(Lcom/tencent/mobileqq/statistics/UnifiedMonitor;)[Lbdlz;
    //   315: aload_0
    //   316: getfield 63	com/tencent/mobileqq/statistics/UnifiedMonitor$StackGetterJob:jdField_a_of_type_Int	I
    //   319: aaload
    //   320: aload 6
    //   322: putfield 197	bdlz:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   325: aload_0
    ...
    //   375: invokestatic 68	com/tencent/mobileqq/statistics/UnifiedMonitor:a	(Lcom/tencent/mobileqq/statistics/UnifiedMonitor;)[Lbdlz;
    //   378: aload_0
    //   379: getfield 63	com/tencent/mobileqq/statistics/UnifiedMonitor$StackGetterJob:jdField_a_of_type_Int	I
    //   382: aaload
    //   383: getfield 169	bdlz:jdField_b_of_type_Long	J
    //   386: lcmp
    //   387: ifne -378 -> 9
    //   390: aload_0
    ...
    //   394: invokestatic 68	com/tencent/mobileqq/statistics/UnifiedMonitor:a	(Lcom/tencent/mobileqq/statistics/UnifiedMonitor;)[Lbdlz;
    //   397: aload_0
    //   398: getfield 63	com/tencent/mobileqq/statistics/UnifiedMonitor$StackGetterJob:jdField_a_of_type_Int	I
    //   401: aaload
    //   402: lconst_0
    //   403: putfield 169	bdlz:jdField_b_of_type_Long	J
    //   406: goto -397 -> 9
    //   409: aload_0
    ...
    //   413: invokestatic 68	com/tencent/mobileqq/statistics/UnifiedMonitor:a	(Lcom/tencent/mobileqq/statistics/UnifiedMonitor;)[Lbdlz;
    //   416: aload_0
    //   417: getfield 63	com/tencent/mobileqq/statistics/UnifiedMonitor$StackGetterJob:jdField_a_of_type_Int	I
    //   420: aaload
    //   421: getfield 188	bdlz:jdField_b_of_type_Boolean	Z
    //   424: ifeq -54 -> 370
    //   427: aload 5
    //   429: aload_0
    ...
    //   447: invokestatic 68	com/tencent/mobileqq/statistics/UnifiedMonitor:a	(Lcom/tencent/mobileqq/statistics/UnifiedMonitor;)[Lbdlz;
    //   450: aload_0
    //   451: getfield 63	com/tencent/mobileqq/statistics/UnifiedMonitor$StackGetterJob:jdField_a_of_type_Int	I
    //   454: aaload
    //   455: getfield 169	bdlz:jdField_b_of_type_Long	J
    //   458: lcmp
    //   459: ifne -89 -> 370
    //   462: aload_0
    ...
    //   466: invokestatic 68	com/tencent/mobileqq/statistics/UnifiedMonitor:a	(Lcom/tencent/mobileqq/statistics/UnifiedMonitor;)[Lbdlz;
    //   469: aload_0
    //   470: getfield 63	com/tencent/mobileqq/statistics/UnifiedMonitor$StackGetterJob:jdField_a_of_type_Int	I
    //   473: aaload
    //   474: getfield 223	bdlz:jdField_d_of_type_Boolean	Z
    //   477: ifeq +57 -> 534
    //   480: ldc 148
    //   482: iconst_1
    ...
    //   538: invokestatic 68	com/tencent/mobileqq/statistics/UnifiedMonitor:a	(Lcom/tencent/mobileqq/statistics/UnifiedMonitor;)[Lbdlz;
    //   541: aload_0
    ...
    //   551: putfield 197	bdlz:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   554: goto -184 -> 370
    //   557: astore 6
    //   559: goto -550 -> 9
    //   562: astore 6
