      ...
      for (;;)
      {
        try
        {
          ...
          if (i != 0)
          {
            ...
            azri.a(BaseApplicationImpl.getContext()).a(this.a, "wtloginCost", true, 0L, 0L, (HashMap)localObject2, "");
            if (QLog.isColorLevel()) {
        ...
        for (;;)
        {
          try
          {
            ...
            if (i != 0)
            {
              ...
              azri.a(BaseApplicationImpl.getContext()).a(this.a, "wtloginCostTrace", true, 0L, 0L, localHashMap, "");
              if (QLog.isColorLevel()) {
