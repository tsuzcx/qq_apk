  ...
  extends AIOAnimationConatiner.AIOAnimator
{
  ...
  public static long a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
    ...
    BubbleConfig localBubbleConfig1 = localBubbleManager.a((int)paramMessageRecord.vipBubbleID, false);
    if (a(localBubbleConfig1)) {
      return -1L;
    }
    long l1 = -1L;
    long l2 = -1L;
      ...
      if (paramAIOAnimationConatiner.a() != null)
      {
        ...
        if (paramAIOAnimationConatiner.a().getAdapter() != null)
        {
          ...
          if (j >= k)
          {
            ...
            paramQQAppInterface = AIOUtils.a(AIOUtils.a(paramAIOAnimationConatiner.a(), j));
    ...
    for (;;)
    {
      ...
      if (paramQQAppInterface != null)
      {
        ...
        if (paramQQAppInterface.jdField_a_of_type_ComTencentMobileqqBubbleBubbleInfo != null)
        {
          ...
          BubbleConfig localBubbleConfig2 = localBubbleManager.a((int)((ChatMessage)localObject).vipBubbleID, false);
          if (a((ChatMessage)localObject, localBubbleConfig2)) {
            continue;
          }
          boolean bool = a(paramSessionInfo, localBubbleConfig1, localBubbleConfig2);
          l3 = l1;
          l4 = l2;
  ...
  private static boolean a(SessionInfo paramSessionInfo, BubbleConfig paramBubbleConfig1, BubbleConfig paramBubbleConfig2)
  {
    boolean bool2 = false;
    boolean bool1;
    if (paramSessionInfo.jdField_a_of_type_Int == 0) {
    ...
    do
    {
      do
      {
        return bool1;
        bool1 = bool2;
      } while (paramBubbleConfig1.f == -1);
      bool1 = bool2;
    } while (paramBubbleConfig2.f == -1);
    return a(paramBubbleConfig1, paramBubbleConfig2, false);
  }
  ...
  private static boolean a(BubbleConfig paramBubbleConfig)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.i("BubbleInterActiveAnim", 2, "bubble config mInterActivePackageID: " + paramBubbleConfig.f + ", bubble mInterActiveType: " + paramBubbleConfig.g);
    }
    return false;
  }
  ...
  private static boolean a(BubbleConfig paramBubbleConfig1, BubbleConfig paramBubbleConfig2, boolean paramBoolean)
  {
    if (paramBubbleConfig1.g == 3) {
      if ((paramBubbleConfig2.g != 2) || (paramBubbleConfig2.f == paramBubbleConfig1.f)) {}
    }
    do
    {
      do
      ...
      } while ((paramBubbleConfig1.g != 2) || ((paramBubbleConfig2.g != 2) && (paramBubbleConfig2.g != 3)));
  ...
  private static boolean a(ChatMessage paramChatMessage, BubbleConfig paramBubbleConfig)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.i("BubbleInterActiveAnim", 2, "record seq: " + paramChatMessage.uniseq + ", other bubble config mInterActivePackageID: " + paramBubbleConfig.f + ", other bubble config mInterActiveType: " + paramBubbleConfig.g);
    }
    return false;
  }
  ...
  public ObjectAnimator a(BubbleInterActiveAnim.AnimHolder paramAnimHolder)
  {
    ...
    for (;;)
    {
      localObjectAnimator.addListener(new BubbleInterActiveAnim.5(this, (ObjectAnimator)localObject1, paramAnimHolder));
  ...
  public Rect a(BaseBubbleBuilder.ViewHolder paramViewHolder, long paramLong, ListView paramListView)
  {
    ...
    for (;;)
    {
      if ((paramViewHolder == null) || ((paramViewHolder instanceof BaseChatItemLayout)))
      {
        ...
        paramViewHolder.right = (paramListView.getRight() - paramListView.getLeft() + j - BaseChatItemLayout.j);
        paramViewHolder.top = (BaseChatItemLayout.h + i);
        paramViewHolder.bottom = (paramListView.getBottom() - paramListView.getTop() + i - BaseChatItemLayout.i);
  ...
  public ObjectAnimator b(BubbleInterActiveAnim.AnimHolder paramAnimHolder)
  {
    ...
    ((ObjectAnimator)localObject1).addListener(new BubbleInterActiveAnim.6(this, paramAnimHolder, (ObjectAnimator)localObject2));
    return localObject1;
  }
  ...
  public ObjectAnimator c(BubbleInterActiveAnim.AnimHolder paramAnimHolder)
  {
    ...
    localObjectAnimator.setRepeatCount(localInterActiveAnimConf.jdField_a_of_type_Int - 1);
    localObjectAnimator.addListener(new BubbleInterActiveAnim.7(this, paramAnimHolder));
    return localObjectAnimator;
  }
    ...
    do
    {
      do
      {
        ...
        if ((f < this.jdField_a_of_type_ComTencentMobileqqActivityAioAnimAIOAnimationConatiner.getTop()) || (f > this.jdField_a_of_type_ComTencentMobileqqActivityAioAnimAIOAnimationConatiner.getBottom() + this.jdField_d_of_type_Int))
        {
          ...
          this.jdField_a_of_type_AndroidOsHandler.post(new BubbleInterActiveAnim.8(this, paramAnimFrameData));
          return;
        }
      ...
      {
        localObject = new AnimatorPathDrawable(paramAnimFrameData.jdField_a_of_type_AndroidGraphicsBitmap);
        ((AnimatorPathDrawable)localObject).jdField_a_of_type_Boolean = paramAnimFrameData.jdField_a_of_type_JavaLangBoolean.booleanValue();
  ...
  public void setPathLocation(BubbleInterActiveAnim.AnimFrameData paramAnimFrameData)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidOsHandler.post(new BubbleInterActiveAnim.9(this, paramAnimFrameData));
      return;
      label459:
