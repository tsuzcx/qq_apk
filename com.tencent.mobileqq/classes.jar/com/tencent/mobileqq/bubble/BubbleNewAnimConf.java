  ...
  public void a(int paramInt, String paramString, JSONObject paramJSONObject)
  {
    ...
    do
    {
      ...
      if (paramJSONObject.has("rect"))
      {
        ...
        this.jdField_a_of_type_AndroidGraphicsRect.left = AIOUtils.a(localJSONArray.getInt(0) / 2, paramString.getResources());
        this.jdField_a_of_type_AndroidGraphicsRect.top = AIOUtils.a(localJSONArray.getInt(1) / 2, paramString.getResources());
        this.jdField_a_of_type_AndroidGraphicsRect.right = AIOUtils.a(localJSONArray.getInt(2) / 2, paramString.getResources());
        this.jdField_a_of_type_AndroidGraphicsRect.bottom = AIOUtils.a(localJSONArray.getInt(3) / 2, paramString.getResources());
      }
    ...
    this.jdField_b_of_type_AndroidGraphicsRect.left = AIOUtils.a(paramJSONObject.getInt(0) / 2, paramString.getResources());
    this.jdField_b_of_type_AndroidGraphicsRect.top = AIOUtils.a(paramJSONObject.getInt(1) / 2, paramString.getResources());
    this.jdField_b_of_type_AndroidGraphicsRect.right = AIOUtils.a(paramJSONObject.getInt(2) / 2, paramString.getResources());
    this.jdField_b_of_type_AndroidGraphicsRect.bottom = AIOUtils.a(paramJSONObject.getInt(3) / 2, paramString.getResources());
  }
}
