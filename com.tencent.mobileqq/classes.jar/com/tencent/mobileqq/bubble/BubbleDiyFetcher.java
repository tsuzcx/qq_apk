...
public class BubbleDiyFetcher
{
  ...
  private BubbleDiyFetcher()
  {
    ...
    this.jdField_a_of_type_JavaLangRunnable = new abdv(this);
  }
  ...
  public Bitmap a(VipBubbleDrawable paramVipBubbleDrawable, DiyBubbleConfig.DiyBubblePasterConfig paramDiyBubblePasterConfig)
  {
    ...
    paramDiyBubblePasterConfig = (Bitmap)BaseApplicationImpl.sImageCache.get(paramVipBubbleDrawable);
  ...
  public void a()
  {
    ...
    if (localHashSet.size() > 0)
    {
      ...
      this.jdField_a_of_type_AndroidOsHandler.post(new abdx(this, localHashSet));
    }
  }
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    if (!jdField_a_of_type_Boolean)
    {
      ...
      ThreadManager.post(new abdw(this, paramQQAppInterface), 5, null, false);
    }
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString, BusinessObserver paramBusinessObserver)
  {
    ...
    ((BubbleDiyHandler)paramQQAppInterface.a(70)).a((List)localObject, paramBusinessObserver);
  }
  ...
  public Bitmap b(VipBubbleDrawable paramVipBubbleDrawable, DiyBubbleConfig.DiyBubblePasterConfig paramDiyBubblePasterConfig)
  {
    ...
    if (this.jdField_b_of_type_JavaUtilMap.containsKey(paramVipBubbleDrawable.jdField_a_of_type_JavaLangString))
    {
      ...
      localObject = (Bitmap)BaseApplicationImpl.sImageCache.get(paramDiyBubblePasterConfig);
      if (localObject != null)
      {
  ...
  public void b()
  {
    ...
    for (;;)
    {
      ...
      if ((localObject2 != null) && (localObject2.length > 0))
      {
        ...
        localVasQuickUpdateManager.a(2L, localObject2[0], (String[])localObject2, "0");
      }
      label222:
      do
      {
  ...
  public void b(QQAppInterface paramQQAppInterface)
  {
    ...
    ThreadManager.post(new abdy(this, paramQQAppInterface), 5, null, false);
  }
  ...
  public void c(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      while (i < j)
      {
        BubbleDiyEntity localBubbleDiyEntity = (BubbleDiyEntity)((EntityManager)localObject2).a(BubbleDiyEntity.class, (String)((ArrayList)localObject1).get(i));
  ...
  {
    Object localObject1 = (BubbleManager)BaseApplicationImpl.getApplication().getRuntime().getManager(43);
  ...
  {
    File localFile = ((BubbleManager)BaseApplicationImpl.getApplication().getRuntime().getManager(43)).b();
