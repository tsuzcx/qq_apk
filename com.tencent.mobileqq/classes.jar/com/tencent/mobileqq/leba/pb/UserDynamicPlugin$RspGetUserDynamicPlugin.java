  ...
  extends MessageMicro<RspGetUserDynamicPlugin>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "plugin_id", "last_time", "ret", "plugin_type" }, new Object[] { localInteger, localInteger, localInteger, localInteger }, RspGetUserDynamicPlugin.class);
  }
}
