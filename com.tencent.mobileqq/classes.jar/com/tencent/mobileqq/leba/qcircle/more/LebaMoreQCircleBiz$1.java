...
class LebaMoreQCircleBiz$1
  implements VSDispatchObserver.onVSRspCallBack<QQCircleSwitch.SetMultiCircleSwitchRsp>
{
  LebaMoreQCircleBiz$1(LebaMoreQCircleBiz paramLebaMoreQCircleBiz, boolean paramBoolean, String paramString) {}
  ...
  public void a(BaseRequest paramBaseRequest, boolean paramBoolean, long paramLong, String paramString, QQCircleSwitch.SetMultiCircleSwitchRsp paramSetMultiCircleSwitchRsp)
  {
    if ((paramBoolean) && (paramLong == 0L))
    {
      ...
      QLog.i("LebaMoreQCircleBiz", 1, paramBaseRequest.toString());
      if (!this.a)
      {
 ...
 * Qualified Name:     com.tencent.mobileqq.leba.qcircle.more.LebaMoreQCircleBiz.1
