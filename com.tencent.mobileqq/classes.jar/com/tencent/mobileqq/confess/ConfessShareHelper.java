...
public class ConfessShareHelper
{
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        catch (OutOfMemoryError paramString1)
        {
          ...
          paramAppInterface = paramContext.getResources().getDrawable(2130842394);
  ...
  public static void a(AppInterface paramAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3, String paramString1, String paramString2, String paramString3, JSONArray paramJSONArray, NonMainAppHeadLoader paramNonMainAppHeadLoader, int paramInt4, int paramInt5, int paramInt6, int paramInt7, String paramString4, Canvas paramCanvas, Paint paramPaint)
  {
    ...
    for (;;)
    {
      ...
      for (paramAppInterface = new BitmapDrawable(paramAppInterface);; paramAppInterface = paramContext.getResources().getDrawable(2130842387))
      {
  ...
  public static boolean a(Context paramContext, Canvas paramCanvas, int paramInt1, int paramInt2, float paramFloat)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (localBgElement.jdField_a_of_type_Int == 2130842395) {
          break label317;
        }
  ...
  public static ConfessShareHelper.BgElement[] a(int paramInt1, int paramInt2)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        return new ConfessShareHelper.BgElement[] { new ConfessShareHelper.BgElement(2130842377, 60, 60, true, 0.75F), new ConfessShareHelper.BgElement(2130842382, 458, 84, true, 0.75F), new ConfessShareHelper.BgElement(2130842383, 142, 250, true, 0.75F), new ConfessShareHelper.BgElement(2130842377, 368, 188, true, 0.75F), new ConfessShareHelper.BgElement(2130842375, 168, 120, true, 0.75F), new ConfessShareHelper.BgElement(2130842392, 120, 40, true, 0.75F), new ConfessShareHelper.BgElement(2130842393, 120, 110, true, 0.75F), new ConfessShareHelper.BgElement(2130842390, 30, 150, true, 0.75F), new ConfessShareHelper.BgElement(2130842390, 180, 200, true, 0.75F), new ConfessShareHelper.BgElement(2130842392, 420, 160, true, 0.75F), new ConfessShareHelper.BgElement(2130842393, 495, 150, true, 0.75F), new ConfessShareHelper.BgElement(2130842389, 257, 82, false, 1.0F) };
        return new ConfessShareHelper.BgElement[] { new ConfessShareHelper.BgElement(2130842384, 60, 88, true, 0.75F), new ConfessShareHelper.BgElement(2130842376, 226, 56, true, 0.75F), new ConfessShareHelper.BgElement(2130842383, 480, 140, true, 0.75F), new ConfessShareHelper.BgElement(2130842381, 330, 198, true, 0.75F), new ConfessShareHelper.BgElement(2130842382, 168, 244, true, 0.75F), new ConfessShareHelper.BgElement(2130842392, 300, 50, true, 0.75F), new ConfessShareHelper.BgElement(2130842393, 460, 50, true, 0.75F), new ConfessShareHelper.BgElement(2130842390, 60, 230, true, 0.75F), new ConfessShareHelper.BgElement(2130842392, 120, 120, true, 0.75F), new ConfessShareHelper.BgElement(2130842392, 440, 270, true, 0.75F), new ConfessShareHelper.BgElement(2130842389, 257, 82, false, 1.0F) };
        return new ConfessShareHelper.BgElement[] { new ConfessShareHelper.BgElement(2130842377, 174, 58, true, 0.75F), new ConfessShareHelper.BgElement(2130842379, 70, 146, true, 0.75F), new ConfessShareHelper.BgElement(2130842381, 390, 106, true, 0.75F), new ConfessShareHelper.BgElement(2130842376, 206, 240, true, 0.75F), new ConfessShareHelper.BgElement(2130842378, 470, 225, true, 0.75F), new ConfessShareHelper.BgElement(2130842393, 120, 88, true, 0.75F), new ConfessShareHelper.BgElement(2130842393, 480, 70, true, 0.75F), new ConfessShareHelper.BgElement(2130842390, 110, 230, true, 0.75F), new ConfessShareHelper.BgElement(2130842392, 340, 210, true, 0.75F), new ConfessShareHelper.BgElement(2130842389, 257, 82, false, 1.0F) };
        return new ConfessShareHelper.BgElement[] { new ConfessShareHelper.BgElement(2130842383, 138, 88, true, 0.75F), new ConfessShareHelper.BgElement(2130842377, 68, 232, true, 0.75F), new ConfessShareHelper.BgElement(2130842381, 298, 206, true, 0.75F), new ConfessShareHelper.BgElement(2130842384, 480, 140, true, 0.75F), new ConfessShareHelper.BgElement(2130842396, 382, 140, true, 0.75F), new ConfessShareHelper.BgElement(2130842392, 60, 90, true, 0.75F), new ConfessShareHelper.BgElement(2130842390, 182, 64, true, 0.75F), new ConfessShareHelper.BgElement(2130842390, 440, 210, true, 0.75F), new ConfessShareHelper.BgElement(2130842392, 440, 30, true, 0.75F), new ConfessShareHelper.BgElement(2130842392, 190, 200, true, 0.75F), new ConfessShareHelper.BgElement(2130842389, 257, 82, false, 1.0F) };
        if (paramInt1 != 1) {
          break;
        }
        switch (paramInt2)
      ...
      return new ConfessShareHelper.BgElement[] { new ConfessShareHelper.BgElement(2130842378, 110, 230, true, 1.0F), new ConfessShareHelper.BgElement(2130842381, 656, 170, true, 1.0F), new ConfessShareHelper.BgElement(2130842376, 516, 350, true, 1.0F), new ConfessShareHelper.BgElement(2130842377, 84, 550, true, 1.0F), new ConfessShareHelper.BgElement(2130842382, 656, 586, true, 1.0F), new ConfessShareHelper.BgElement(2130842377, 526, 735, true, 1.0F), new ConfessShareHelper.BgElement(2130842383, 198, 830, true, 1.0F), new ConfessShareHelper.BgElement(2130842379, 70, 1016, true, 1.0F), new ConfessShareHelper.BgElement(2130842381, 397, 952, true, 1.0F), new ConfessShareHelper.BgElement(2130842384, 670, 880, true, 1.0F), new ConfessShareHelper.BgElement(2130842376, 220, 1257, true, 1.0F), new ConfessShareHelper.BgElement(2130842380, 606, 1220, true, 1.0F), new ConfessShareHelper.BgElement(2130842396, 452, 475, true, 1.0F), new ConfessShareHelper.BgElement(2130842375, 240, 645, true, 1.0F), new ConfessShareHelper.BgElement(2130842390, 160, 300, true, 1.0F), new ConfessShareHelper.BgElement(2130842393, 660, 330, true, 1.0F), new ConfessShareHelper.BgElement(2130842391, 620, 450, true, 1.0F), new ConfessShareHelper.BgElement(2130842392, 175, 500, true, 1.0F), new ConfessShareHelper.BgElement(2130842392, 460, 570, true, 1.0F), new ConfessShareHelper.BgElement(2130842393, 180, 630, true, 1.0F), new ConfessShareHelper.BgElement(2130842390, 40, 690, true, 1.0F), new ConfessShareHelper.BgElement(2130842390, 260, 750, true, 1.0F), new ConfessShareHelper.BgElement(2130842393, 710, 600, true, 1.0F), new ConfessShareHelper.BgElement(2130842392, 600, 710, true, 1.0F), new ConfessShareHelper.BgElement(2130842392, 140, 970, true, 1.0F), new ConfessShareHelper.BgElement(2130842390, 85, 1200, true, 1.0F), new ConfessShareHelper.BgElement(2130842390, 600, 1050, true, 1.0F), new ConfessShareHelper.BgElement(2130842393, 420, 1100, true, 1.0F), new ConfessShareHelper.BgElement(2130842392, 540, 1250, true, 1.0F), new ConfessShareHelper.BgElement(2130842395, 375, 134, false, 1.0F) };
      return new ConfessShareHelper.BgElement[] { new ConfessShareHelper.BgElement(2130842381, 110, 368, true, 1.0F), new ConfessShareHelper.BgElement(2130842382, 570, 256, true, 1.0F), new ConfessShareHelper.BgElement(2130842377, 655, 475, true, 1.0F), new ConfessShareHelper.BgElement(2130842384, 75, 740, true, 1.0F), new ConfessShareHelper.BgElement(2130842376, 320, 686, true, 1.0F), new ConfessShareHelper.BgElement(2130842383, 670, 832, true, 1.0F), new ConfessShareHelper.BgElement(2130842381, 505, 955, true, 1.0F), new ConfessShareHelper.BgElement(2130842382, 260, 1020, true, 1.0F), new ConfessShareHelper.BgElement(2130842380, 75, 1216, true, 1.0F), new ConfessShareHelper.BgElement(2130842376, 565, 1235, true, 1.0F), new ConfessShareHelper.BgElement(2130842396, 430, 355, true, 1.0F), new ConfessShareHelper.BgElement(2130842375, 110, 174, true, 1.0F), new ConfessShareHelper.BgElement(2130842390, 140, 250, true, 1.0F), new ConfessShareHelper.BgElement(2130842393, 640, 195, true, 1.0F), new ConfessShareHelper.BgElement(2130842390, 170, 450, true, 1.0F), new ConfessShareHelper.BgElement(2130842392, 490, 1220, true, 1.0F), new ConfessShareHelper.BgElement(2130842391, 350, 520, true, 1.0F), new ConfessShareHelper.BgElement(2130842391, 630, 410, true, 1.0F), new ConfessShareHelper.BgElement(2130842393, 60, 500, true, 1.0F), new ConfessShareHelper.BgElement(2130842393, 680, 655, true, 1.0F), new ConfessShareHelper.BgElement(2130842393, 310, 1110, true, 1.0F), new ConfessShareHelper.BgElement(2130842392, 470, 660, true, 1.0F), new ConfessShareHelper.BgElement(2130842392, 190, 780, true, 1.0F), new ConfessShareHelper.BgElement(2130842392, 680, 1060, true, 1.0F), new ConfessShareHelper.BgElement(2130842390, 180, 1230, true, 1.0F), new ConfessShareHelper.BgElement(2130842395, 375, 134, false, 1.0F) };
      return new ConfessShareHelper.BgElement[] { new ConfessShareHelper.BgElement(2130842377, 110, 220, true, 1.0F), new ConfessShareHelper.BgElement(2130842383, 654, 240, true, 1.0F), new ConfessShareHelper.BgElement(2130842381, 562, 482, true, 1.0F), new ConfessShareHelper.BgElement(2130842379, 95, 537, true, 1.0F), new ConfessShareHelper.BgElement(2130842376, 295, 672, true, 1.0F), new ConfessShareHelper.BgElement(2130842378, 683, 660, true, 1.0F), new ConfessShareHelper.BgElement(2130842380, 60, 850, true, 1.0F), new ConfessShareHelper.BgElement(2130842382, 442, 872, true, 1.0F), new ConfessShareHelper.BgElement(2130842376, 114, 1046, true, 1.0F), new ConfessShareHelper.BgElement(2130842377, 680, 950, true, 1.0F), new ConfessShareHelper.BgElement(2130842382, 230, 1197, true, 1.0F), new ConfessShareHelper.BgElement(2130842384, 480, 1260, true, 1.0F), new ConfessShareHelper.BgElement(2130842396, 670, 1200, true, 1.0F), new ConfessShareHelper.BgElement(2130842390, 140, 630, true, 1.0F), new ConfessShareHelper.BgElement(2130842390, 500, 960, true, 1.0F), new ConfessShareHelper.BgElement(2130842390, 330, 1050, true, 1.0F), new ConfessShareHelper.BgElement(2130842390, 50, 1150, true, 1.0F), new ConfessShareHelper.BgElement(2130842391, 290, 430, true, 1.0F), new ConfessShareHelper.BgElement(2130842391, 330, 760, true, 1.0F), new ConfessShareHelper.BgElement(2130842392, 60, 310, true, 1.0F), new ConfessShareHelper.BgElement(2130842392, 480, 580, true, 1.0F), new ConfessShareHelper.BgElement(2130842392, 220, 820, true, 1.0F), new ConfessShareHelper.BgElement(2130842393, 600, 150, true, 1.0F), new ConfessShareHelper.BgElement(2130842393, 700, 410, true, 1.0F), new ConfessShareHelper.BgElement(2130842393, 25, 900, true, 1.0F), new ConfessShareHelper.BgElement(2130842393, 150, 430, true, 1.0F), new ConfessShareHelper.BgElement(2130842395, 375, 134, false, 1.0F) };
      return new ConfessShareHelper.BgElement[] { new ConfessShareHelper.BgElement(2130842377, 104, 278, true, 1.0F), new ConfessShareHelper.BgElement(2130842380, 588, 200, true, 1.0F), new ConfessShareHelper.BgElement(2130842376, 690, 390, true, 1.0F), new ConfessShareHelper.BgElement(2130842379, 420, 534, true, 1.0F), new ConfessShareHelper.BgElement(2130842378, 92, 592, true, 1.0F), new ConfessShareHelper.BgElement(2130842382, 660, 624, true, 1.0F), new ConfessShareHelper.BgElement(2130842377, 475, 735, true, 1.0F), new ConfessShareHelper.BgElement(2130842383, 192, 818, true, 1.0F), new ConfessShareHelper.BgElement(2130842384, 696, 880, true, 1.0F), new ConfessShareHelper.BgElement(2130842381, 430, 990, true, 1.0F), new ConfessShareHelper.BgElement(2130842376, 64, 1034, true, 1.0F), new ConfessShareHelper.BgElement(2130842376, 272, 1250, true, 1.0F), new ConfessShareHelper.BgElement(2130842380, 584, 1205, true, 1.0F), new ConfessShareHelper.BgElement(2130842375, 254, 638, true, 1.0F), new ConfessShareHelper.BgElement(2130842390, 200, 320, true, 1.0F), new ConfessShareHelper.BgElement(2130842390, 260, 780, true, 1.0F), new ConfessShareHelper.BgElement(2130842390, 620, 1000, true, 1.0F), new ConfessShareHelper.BgElement(2130842390, 150, 1250, true, 1.0F), new ConfessShareHelper.BgElement(2130842391, 70, 420, true, 1.0F), new ConfessShareHelper.BgElement(2130842391, 460, 590, true, 1.0F), new ConfessShareHelper.BgElement(2130842391, 630, 450, true, 1.0F), new ConfessShareHelper.BgElement(2130842392, 70, 800, true, 1.0F), new ConfessShareHelper.BgElement(2130842392, 280, 980, true, 1.0F), new ConfessShareHelper.BgElement(2130842392, 610, 720, true, 1.0F), new ConfessShareHelper.BgElement(2130842392, 480, 1220, true, 1.0F), new ConfessShareHelper.BgElement(2130842393, 170, 590, true, 1.0F), new ConfessShareHelper.BgElement(2130842393, 330, 1160, true, 1.0F), new ConfessShareHelper.BgElement(2130842393, 700, 680, true, 1.0F), new ConfessShareHelper.BgElement(2130842393, 660, 290, true, 1.0F), new ConfessShareHelper.BgElement(2130842395, 375, 134, false, 1.0F) };
    } while (paramInt1 != 2);
    return new ConfessShareHelper.BgElement[] { new ConfessShareHelper.BgElement(2130842378, 110, 310, true, 1.0F), new ConfessShareHelper.BgElement(2130842381, 650, 216, true, 1.0F), new ConfessShareHelper.BgElement(2130842376, 516, 350, true, 1.0F), new ConfessShareHelper.BgElement(2130842378, 92, 592, true, 1.0F), new ConfessShareHelper.BgElement(2130842382, 656, 586, true, 1.0F), new ConfessShareHelper.BgElement(2130842377, 470, 716, true, 1.0F), new ConfessShareHelper.BgElement(2130842383, 198, 830, true, 1.0F), new ConfessShareHelper.BgElement(2130842384, 670, 980, true, 1.0F), new ConfessShareHelper.BgElement(2130842381, 397, 1060, true, 1.0F), new ConfessShareHelper.BgElement(2130842379, 70, 1016, true, 1.0F), new ConfessShareHelper.BgElement(2130842390, 200, 320, true, 1.0F), new ConfessShareHelper.BgElement(2130842375, 240, 438, true, 1.0F), new ConfessShareHelper.BgElement(2130842396, 452, 475, true, 0.75F), new ConfessShareHelper.BgElement(2130842390, 200, 600, true, 1.0F), new ConfessShareHelper.BgElement(2130842390, 1000, 620, true, 1.0F), new ConfessShareHelper.BgElement(2130842391, 70, 420, true, 1.0F) };
  }
