...
public class ConfessShareHelper
{
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        catch (OutOfMemoryError paramString1)
        {
          ...
          paramAppInterface = paramContext.getResources().getDrawable(2130842347);
  ...
  public static void a(AppInterface paramAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3, String paramString1, String paramString2, String paramString3, JSONArray paramJSONArray, NonMainAppHeadLoader paramNonMainAppHeadLoader, int paramInt4, int paramInt5, int paramInt6, int paramInt7, String paramString4, Canvas paramCanvas, Paint paramPaint)
  {
    ...
    for (;;)
    {
      ...
      for (paramAppInterface = new BitmapDrawable(paramAppInterface);; paramAppInterface = paramContext.getResources().getDrawable(2130842340))
      {
  ...
  public static boolean a(Context paramContext, Canvas paramCanvas, int paramInt1, int paramInt2, float paramFloat)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (localBgElement.jdField_a_of_type_Int == 2130842348) {
          break label317;
        }
  ...
  public static ConfessShareHelper.BgElement[] a(int paramInt1, int paramInt2)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        return new ConfessShareHelper.BgElement[] { new ConfessShareHelper.BgElement(2130842330, 60, 60, true, 0.75F), new ConfessShareHelper.BgElement(2130842335, 458, 84, true, 0.75F), new ConfessShareHelper.BgElement(2130842336, 142, 250, true, 0.75F), new ConfessShareHelper.BgElement(2130842330, 368, 188, true, 0.75F), new ConfessShareHelper.BgElement(2130842328, 168, 120, true, 0.75F), new ConfessShareHelper.BgElement(2130842345, 120, 40, true, 0.75F), new ConfessShareHelper.BgElement(2130842346, 120, 110, true, 0.75F), new ConfessShareHelper.BgElement(2130842343, 30, 150, true, 0.75F), new ConfessShareHelper.BgElement(2130842343, 180, 200, true, 0.75F), new ConfessShareHelper.BgElement(2130842345, 420, 160, true, 0.75F), new ConfessShareHelper.BgElement(2130842346, 495, 150, true, 0.75F), new ConfessShareHelper.BgElement(2130842342, 257, 82, false, 1.0F) };
        return new ConfessShareHelper.BgElement[] { new ConfessShareHelper.BgElement(2130842337, 60, 88, true, 0.75F), new ConfessShareHelper.BgElement(2130842329, 226, 56, true, 0.75F), new ConfessShareHelper.BgElement(2130842336, 480, 140, true, 0.75F), new ConfessShareHelper.BgElement(2130842334, 330, 198, true, 0.75F), new ConfessShareHelper.BgElement(2130842335, 168, 244, true, 0.75F), new ConfessShareHelper.BgElement(2130842345, 300, 50, true, 0.75F), new ConfessShareHelper.BgElement(2130842346, 460, 50, true, 0.75F), new ConfessShareHelper.BgElement(2130842343, 60, 230, true, 0.75F), new ConfessShareHelper.BgElement(2130842345, 120, 120, true, 0.75F), new ConfessShareHelper.BgElement(2130842345, 440, 270, true, 0.75F), new ConfessShareHelper.BgElement(2130842342, 257, 82, false, 1.0F) };
        return new ConfessShareHelper.BgElement[] { new ConfessShareHelper.BgElement(2130842330, 174, 58, true, 0.75F), new ConfessShareHelper.BgElement(2130842332, 70, 146, true, 0.75F), new ConfessShareHelper.BgElement(2130842334, 390, 106, true, 0.75F), new ConfessShareHelper.BgElement(2130842329, 206, 240, true, 0.75F), new ConfessShareHelper.BgElement(2130842331, 470, 225, true, 0.75F), new ConfessShareHelper.BgElement(2130842346, 120, 88, true, 0.75F), new ConfessShareHelper.BgElement(2130842346, 480, 70, true, 0.75F), new ConfessShareHelper.BgElement(2130842343, 110, 230, true, 0.75F), new ConfessShareHelper.BgElement(2130842345, 340, 210, true, 0.75F), new ConfessShareHelper.BgElement(2130842342, 257, 82, false, 1.0F) };
        return new ConfessShareHelper.BgElement[] { new ConfessShareHelper.BgElement(2130842336, 138, 88, true, 0.75F), new ConfessShareHelper.BgElement(2130842330, 68, 232, true, 0.75F), new ConfessShareHelper.BgElement(2130842334, 298, 206, true, 0.75F), new ConfessShareHelper.BgElement(2130842337, 480, 140, true, 0.75F), new ConfessShareHelper.BgElement(2130842349, 382, 140, true, 0.75F), new ConfessShareHelper.BgElement(2130842345, 60, 90, true, 0.75F), new ConfessShareHelper.BgElement(2130842343, 182, 64, true, 0.75F), new ConfessShareHelper.BgElement(2130842343, 440, 210, true, 0.75F), new ConfessShareHelper.BgElement(2130842345, 440, 30, true, 0.75F), new ConfessShareHelper.BgElement(2130842345, 190, 200, true, 0.75F), new ConfessShareHelper.BgElement(2130842342, 257, 82, false, 1.0F) };
        if (paramInt1 != 1) {
          break;
        }
        switch (paramInt2)
      ...
      return new ConfessShareHelper.BgElement[] { new ConfessShareHelper.BgElement(2130842331, 110, 230, true, 1.0F), new ConfessShareHelper.BgElement(2130842334, 656, 170, true, 1.0F), new ConfessShareHelper.BgElement(2130842329, 516, 350, true, 1.0F), new ConfessShareHelper.BgElement(2130842330, 84, 550, true, 1.0F), new ConfessShareHelper.BgElement(2130842335, 656, 586, true, 1.0F), new ConfessShareHelper.BgElement(2130842330, 526, 735, true, 1.0F), new ConfessShareHelper.BgElement(2130842336, 198, 830, true, 1.0F), new ConfessShareHelper.BgElement(2130842332, 70, 1016, true, 1.0F), new ConfessShareHelper.BgElement(2130842334, 397, 952, true, 1.0F), new ConfessShareHelper.BgElement(2130842337, 670, 880, true, 1.0F), new ConfessShareHelper.BgElement(2130842329, 220, 1257, true, 1.0F), new ConfessShareHelper.BgElement(2130842333, 606, 1220, true, 1.0F), new ConfessShareHelper.BgElement(2130842349, 452, 475, true, 1.0F), new ConfessShareHelper.BgElement(2130842328, 240, 645, true, 1.0F), new ConfessShareHelper.BgElement(2130842343, 160, 300, true, 1.0F), new ConfessShareHelper.BgElement(2130842346, 660, 330, true, 1.0F), new ConfessShareHelper.BgElement(2130842344, 620, 450, true, 1.0F), new ConfessShareHelper.BgElement(2130842345, 175, 500, true, 1.0F), new ConfessShareHelper.BgElement(2130842345, 460, 570, true, 1.0F), new ConfessShareHelper.BgElement(2130842346, 180, 630, true, 1.0F), new ConfessShareHelper.BgElement(2130842343, 40, 690, true, 1.0F), new ConfessShareHelper.BgElement(2130842343, 260, 750, true, 1.0F), new ConfessShareHelper.BgElement(2130842346, 710, 600, true, 1.0F), new ConfessShareHelper.BgElement(2130842345, 600, 710, true, 1.0F), new ConfessShareHelper.BgElement(2130842345, 140, 970, true, 1.0F), new ConfessShareHelper.BgElement(2130842343, 85, 1200, true, 1.0F), new ConfessShareHelper.BgElement(2130842343, 600, 1050, true, 1.0F), new ConfessShareHelper.BgElement(2130842346, 420, 1100, true, 1.0F), new ConfessShareHelper.BgElement(2130842345, 540, 1250, true, 1.0F), new ConfessShareHelper.BgElement(2130842348, 375, 134, false, 1.0F) };
      return new ConfessShareHelper.BgElement[] { new ConfessShareHelper.BgElement(2130842334, 110, 368, true, 1.0F), new ConfessShareHelper.BgElement(2130842335, 570, 256, true, 1.0F), new ConfessShareHelper.BgElement(2130842330, 655, 475, true, 1.0F), new ConfessShareHelper.BgElement(2130842337, 75, 740, true, 1.0F), new ConfessShareHelper.BgElement(2130842329, 320, 686, true, 1.0F), new ConfessShareHelper.BgElement(2130842336, 670, 832, true, 1.0F), new ConfessShareHelper.BgElement(2130842334, 505, 955, true, 1.0F), new ConfessShareHelper.BgElement(2130842335, 260, 1020, true, 1.0F), new ConfessShareHelper.BgElement(2130842333, 75, 1216, true, 1.0F), new ConfessShareHelper.BgElement(2130842329, 565, 1235, true, 1.0F), new ConfessShareHelper.BgElement(2130842349, 430, 355, true, 1.0F), new ConfessShareHelper.BgElement(2130842328, 110, 174, true, 1.0F), new ConfessShareHelper.BgElement(2130842343, 140, 250, true, 1.0F), new ConfessShareHelper.BgElement(2130842346, 640, 195, true, 1.0F), new ConfessShareHelper.BgElement(2130842343, 170, 450, true, 1.0F), new ConfessShareHelper.BgElement(2130842345, 490, 1220, true, 1.0F), new ConfessShareHelper.BgElement(2130842344, 350, 520, true, 1.0F), new ConfessShareHelper.BgElement(2130842344, 630, 410, true, 1.0F), new ConfessShareHelper.BgElement(2130842346, 60, 500, true, 1.0F), new ConfessShareHelper.BgElement(2130842346, 680, 655, true, 1.0F), new ConfessShareHelper.BgElement(2130842346, 310, 1110, true, 1.0F), new ConfessShareHelper.BgElement(2130842345, 470, 660, true, 1.0F), new ConfessShareHelper.BgElement(2130842345, 190, 780, true, 1.0F), new ConfessShareHelper.BgElement(2130842345, 680, 1060, true, 1.0F), new ConfessShareHelper.BgElement(2130842343, 180, 1230, true, 1.0F), new ConfessShareHelper.BgElement(2130842348, 375, 134, false, 1.0F) };
      return new ConfessShareHelper.BgElement[] { new ConfessShareHelper.BgElement(2130842330, 110, 220, true, 1.0F), new ConfessShareHelper.BgElement(2130842336, 654, 240, true, 1.0F), new ConfessShareHelper.BgElement(2130842334, 562, 482, true, 1.0F), new ConfessShareHelper.BgElement(2130842332, 95, 537, true, 1.0F), new ConfessShareHelper.BgElement(2130842329, 295, 672, true, 1.0F), new ConfessShareHelper.BgElement(2130842331, 683, 660, true, 1.0F), new ConfessShareHelper.BgElement(2130842333, 60, 850, true, 1.0F), new ConfessShareHelper.BgElement(2130842335, 442, 872, true, 1.0F), new ConfessShareHelper.BgElement(2130842329, 114, 1046, true, 1.0F), new ConfessShareHelper.BgElement(2130842330, 680, 950, true, 1.0F), new ConfessShareHelper.BgElement(2130842335, 230, 1197, true, 1.0F), new ConfessShareHelper.BgElement(2130842337, 480, 1260, true, 1.0F), new ConfessShareHelper.BgElement(2130842349, 670, 1200, true, 1.0F), new ConfessShareHelper.BgElement(2130842343, 140, 630, true, 1.0F), new ConfessShareHelper.BgElement(2130842343, 500, 960, true, 1.0F), new ConfessShareHelper.BgElement(2130842343, 330, 1050, true, 1.0F), new ConfessShareHelper.BgElement(2130842343, 50, 1150, true, 1.0F), new ConfessShareHelper.BgElement(2130842344, 290, 430, true, 1.0F), new ConfessShareHelper.BgElement(2130842344, 330, 760, true, 1.0F), new ConfessShareHelper.BgElement(2130842345, 60, 310, true, 1.0F), new ConfessShareHelper.BgElement(2130842345, 480, 580, true, 1.0F), new ConfessShareHelper.BgElement(2130842345, 220, 820, true, 1.0F), new ConfessShareHelper.BgElement(2130842346, 600, 150, true, 1.0F), new ConfessShareHelper.BgElement(2130842346, 700, 410, true, 1.0F), new ConfessShareHelper.BgElement(2130842346, 25, 900, true, 1.0F), new ConfessShareHelper.BgElement(2130842346, 150, 430, true, 1.0F), new ConfessShareHelper.BgElement(2130842348, 375, 134, false, 1.0F) };
      return new ConfessShareHelper.BgElement[] { new ConfessShareHelper.BgElement(2130842330, 104, 278, true, 1.0F), new ConfessShareHelper.BgElement(2130842333, 588, 200, true, 1.0F), new ConfessShareHelper.BgElement(2130842329, 690, 390, true, 1.0F), new ConfessShareHelper.BgElement(2130842332, 420, 534, true, 1.0F), new ConfessShareHelper.BgElement(2130842331, 92, 592, true, 1.0F), new ConfessShareHelper.BgElement(2130842335, 660, 624, true, 1.0F), new ConfessShareHelper.BgElement(2130842330, 475, 735, true, 1.0F), new ConfessShareHelper.BgElement(2130842336, 192, 818, true, 1.0F), new ConfessShareHelper.BgElement(2130842337, 696, 880, true, 1.0F), new ConfessShareHelper.BgElement(2130842334, 430, 990, true, 1.0F), new ConfessShareHelper.BgElement(2130842329, 64, 1034, true, 1.0F), new ConfessShareHelper.BgElement(2130842329, 272, 1250, true, 1.0F), new ConfessShareHelper.BgElement(2130842333, 584, 1205, true, 1.0F), new ConfessShareHelper.BgElement(2130842328, 254, 638, true, 1.0F), new ConfessShareHelper.BgElement(2130842343, 200, 320, true, 1.0F), new ConfessShareHelper.BgElement(2130842343, 260, 780, true, 1.0F), new ConfessShareHelper.BgElement(2130842343, 620, 1000, true, 1.0F), new ConfessShareHelper.BgElement(2130842343, 150, 1250, true, 1.0F), new ConfessShareHelper.BgElement(2130842344, 70, 420, true, 1.0F), new ConfessShareHelper.BgElement(2130842344, 460, 590, true, 1.0F), new ConfessShareHelper.BgElement(2130842344, 630, 450, true, 1.0F), new ConfessShareHelper.BgElement(2130842345, 70, 800, true, 1.0F), new ConfessShareHelper.BgElement(2130842345, 280, 980, true, 1.0F), new ConfessShareHelper.BgElement(2130842345, 610, 720, true, 1.0F), new ConfessShareHelper.BgElement(2130842345, 480, 1220, true, 1.0F), new ConfessShareHelper.BgElement(2130842346, 170, 590, true, 1.0F), new ConfessShareHelper.BgElement(2130842346, 330, 1160, true, 1.0F), new ConfessShareHelper.BgElement(2130842346, 700, 680, true, 1.0F), new ConfessShareHelper.BgElement(2130842346, 660, 290, true, 1.0F), new ConfessShareHelper.BgElement(2130842348, 375, 134, false, 1.0F) };
    } while (paramInt1 != 2);
    return new ConfessShareHelper.BgElement[] { new ConfessShareHelper.BgElement(2130842331, 110, 310, true, 1.0F), new ConfessShareHelper.BgElement(2130842334, 650, 216, true, 1.0F), new ConfessShareHelper.BgElement(2130842329, 516, 350, true, 1.0F), new ConfessShareHelper.BgElement(2130842331, 92, 592, true, 1.0F), new ConfessShareHelper.BgElement(2130842335, 656, 586, true, 1.0F), new ConfessShareHelper.BgElement(2130842330, 470, 716, true, 1.0F), new ConfessShareHelper.BgElement(2130842336, 198, 830, true, 1.0F), new ConfessShareHelper.BgElement(2130842337, 670, 980, true, 1.0F), new ConfessShareHelper.BgElement(2130842334, 397, 1060, true, 1.0F), new ConfessShareHelper.BgElement(2130842332, 70, 1016, true, 1.0F), new ConfessShareHelper.BgElement(2130842343, 200, 320, true, 1.0F), new ConfessShareHelper.BgElement(2130842328, 240, 438, true, 1.0F), new ConfessShareHelper.BgElement(2130842349, 452, 475, true, 0.75F), new ConfessShareHelper.BgElement(2130842343, 200, 600, true, 1.0F), new ConfessShareHelper.BgElement(2130842343, 1000, 620, true, 1.0F), new ConfessShareHelper.BgElement(2130842344, 70, 420, true, 1.0F) };
  }
