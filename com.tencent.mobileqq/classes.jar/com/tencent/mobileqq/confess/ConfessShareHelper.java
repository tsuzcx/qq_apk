...
public class ConfessShareHelper
{
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        catch (OutOfMemoryError paramString1)
        {
          ...
          localPaint.setColor(-1);
          a(paramAppInterface, paramContext, paramInt1, paramInt2, paramInt3, paramString1, paramString2, paramString3, paramJSONArray, paramINonMainProcAvatarLoader, i, j, k, m, str, localCanvas, localPaint);
          ...
          paramAppInterface = paramContext.getResources().getDrawable(2130845124);
          paramAppInterface.setBounds(i / 2 - 45, j - 102 - 42, i / 2 + 45, j - 102);
          paramAppInterface.draw(localCanvas);
          paramAppInterface = HardCodeUtil.a(2131702472);
  ...
  public static final String a(AppInterface paramAppInterface)
  {
    ...
    //   17: getstatic 254	mqq/app/Constants$PropertiesKey:nickName	Lmqq/app/Constants$PropertiesKey;
    //   20: invokevirtual 255	mqq/app/Constants$PropertiesKey:toString	()Ljava/lang/String;
    ...
    //   34: invokevirtual 260	mqq/app/MobileQQ:getProperty	(Ljava/lang/String;)Ljava/lang/String;
    //   37: astore_0
    //   38: aload_0
    //   39: invokestatic 230	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   42: ifeq +324 -> 366
    //   45: invokestatic 266	com/tencent/common/app/BaseApplicationImpl:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   48: invokevirtual 272	com/tencent/qphone/base/util/BaseApplication:getContentResolver	()Landroid/content/ContentResolver;
    //   51: astore_1
    //   52: aload_1
    ...
    //   74: invokestatic 280	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   77: aconst_null
    //   78: ldc_w 282
    //   81: iconst_1
    ...
    //   89: aastore
    //   90: aconst_null
    //   91: invokevirtual 288	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   94: astore_2
    //   95: aload_0
    //   96: astore 4
    //   98: aload_2
    ...
    //   119: aload_2
    //   120: ldc_w 295
    //   123: invokeinterface 299 2 0
    //   128: invokeinterface 302 2 0
    //   133: astore 4
    //   135: aload_0
    //   136: astore_1
    //   137: aload_0
    //   138: astore_3
    //   139: aload 4
    //   141: invokestatic 230	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   144: ifne +24 -> 168
    //   147: aload_0
    //   148: astore_3
    ...
    //   152: dup
    //   153: aload 4
    //   155: invokevirtual 306	java/lang/String:getBytes	()[B
    //   158: ldc_w 308
    //   161: invokespecial 311	java/lang/String:<init>	([BLjava/lang/String;)V
    //   164: invokestatic 316	com/tencent/mobileqq/utils/SecurityUtile:decode	(Ljava/lang/String;)Ljava/lang/String;
    //   167: astore_1
    //   168: aload_1
    //   169: astore 4
    //   171: aload_1
    ...
    //   214: ifnull +12 -> 226
    //   217: aload_2
    //   218: invokeinterface 321 1 0
    //   223: aload 4
    //   225: astore_0
    //   226: aload_0
    //   227: astore_1
    //   228: aload_0
    //   229: invokestatic 230	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   232: ifeq +6 -> 238
    //   235: aload 5
    //   237: astore_1
    ...
    //   267: invokestatic 326	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   270: aload_1
    //   271: areturn
    //   272: astore_2
    //   273: aconst_null
    ...
    //   301: aload_3
    //   302: invokestatic 332	com/tencent/qphone/base/util/QLog:getStackTraceString	(Ljava/lang/Throwable;)Ljava/lang/String;
    ...
    //   311: invokestatic 326	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   314: aload_2
    //   315: astore_0
    //   316: aload_1
    //   317: ifnull -91 -> 226
    //   320: aload_1
    //   321: invokeinterface 321 1 0
    //   326: aload_2
    //   327: astore_0
    //   328: goto -102 -> 226
    //   331: astore_0
  ...
  public static String a(String paramString, AppInterface paramAppInterface)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        paramAppInterface = HttpUtil.uploadImageWithHttps(NetworkUtil.a("https://cgi.connect.qq.com/qqconnectopen/upload_share_image", 1007), "cgi.connect.qq.com", str1, str2, null, localHashMap, (Map)localObject1, false);
  ...
  public static void a(AppInterface paramAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3, String paramString1, String paramString2, String paramString3, JSONArray paramJSONArray, INonMainProcAvatarLoader paramINonMainProcAvatarLoader, int paramInt4, int paramInt5, int paramInt6, int paramInt7, String paramString4, Canvas paramCanvas, Paint paramPaint)
  {
    ...
    paramString3 = new TagUtils.TagArrangementEngine();
    ...
    for (;;)
    {
      ...
      if (paramJSONArray.hasNext())
      {
        ...
        if (((Iterator)localObject2).hasNext())
        {
          ...
          paramString3.left = (((TagUtils.Tag.Child)localObject3).jdField_a_of_type_AndroidGraphicsRect.left + paramString2.left + 1);
          paramString3.top = (((TagUtils.Tag.Child)localObject3).jdField_a_of_type_AndroidGraphicsRect.top + paramString2.top + 1);
      ...
      for (paramAppInterface = new BitmapDrawable(paramAppInterface);; paramAppInterface = paramContext.getResources().getDrawable(2130845117))
      {
        ...
        paramContext = a(paramString4, 8.0F) + HardCodeUtil.a(2131702473);
  ...
  public static boolean a(Context paramContext, Canvas paramCanvas, int paramInt1, int paramInt2, float paramFloat)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (localBgElement.jdField_a_of_type_Int == 2130845126) {
          break label316;
        }
        if (localBgElement.jdField_a_of_type_Int != 2130845119) {
          break label309;
        }
      }
  ...
  public static ConfessShareHelper.BgElement[] a(int paramInt1, int paramInt2)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        return new ConfessShareHelper.BgElement[] { new ConfessShareHelper.BgElement(2130845091, 60, 60, true, 0.75F), new ConfessShareHelper.BgElement(2130845096, 458, 84, true, 0.75F), new ConfessShareHelper.BgElement(2130845097, 142, 250, true, 0.75F), new ConfessShareHelper.BgElement(2130845091, 368, 188, true, 0.75F), new ConfessShareHelper.BgElement(2130845089, 168, 120, true, 0.75F), new ConfessShareHelper.BgElement(2130845122, 120, 40, true, 0.75F), new ConfessShareHelper.BgElement(2130845123, 120, 110, true, 0.75F), new ConfessShareHelper.BgElement(2130845120, 30, 150, true, 0.75F), new ConfessShareHelper.BgElement(2130845120, 180, 200, true, 0.75F), new ConfessShareHelper.BgElement(2130845122, 420, 160, true, 0.75F), new ConfessShareHelper.BgElement(2130845123, 495, 150, true, 0.75F), new ConfessShareHelper.BgElement(2130845119, 257, 82, false, 1.0F) };
        return new ConfessShareHelper.BgElement[] { new ConfessShareHelper.BgElement(2130845098, 60, 88, true, 0.75F), new ConfessShareHelper.BgElement(2130845090, 226, 56, true, 0.75F), new ConfessShareHelper.BgElement(2130845097, 480, 140, true, 0.75F), new ConfessShareHelper.BgElement(2130845095, 330, 198, true, 0.75F), new ConfessShareHelper.BgElement(2130845096, 168, 244, true, 0.75F), new ConfessShareHelper.BgElement(2130845122, 300, 50, true, 0.75F), new ConfessShareHelper.BgElement(2130845123, 460, 50, true, 0.75F), new ConfessShareHelper.BgElement(2130845120, 60, 230, true, 0.75F), new ConfessShareHelper.BgElement(2130845122, 120, 120, true, 0.75F), new ConfessShareHelper.BgElement(2130845122, 440, 270, true, 0.75F), new ConfessShareHelper.BgElement(2130845119, 257, 82, false, 1.0F) };
        return new ConfessShareHelper.BgElement[] { new ConfessShareHelper.BgElement(2130845091, 174, 58, true, 0.75F), new ConfessShareHelper.BgElement(2130845093, 70, 146, true, 0.75F), new ConfessShareHelper.BgElement(2130845095, 390, 106, true, 0.75F), new ConfessShareHelper.BgElement(2130845090, 206, 240, true, 0.75F), new ConfessShareHelper.BgElement(2130845092, 470, 225, true, 0.75F), new ConfessShareHelper.BgElement(2130845123, 120, 88, true, 0.75F), new ConfessShareHelper.BgElement(2130845123, 480, 70, true, 0.75F), new ConfessShareHelper.BgElement(2130845120, 110, 230, true, 0.75F), new ConfessShareHelper.BgElement(2130845122, 340, 210, true, 0.75F), new ConfessShareHelper.BgElement(2130845119, 257, 82, false, 1.0F) };
        return new ConfessShareHelper.BgElement[] { new ConfessShareHelper.BgElement(2130845097, 138, 88, true, 0.75F), new ConfessShareHelper.BgElement(2130845091, 68, 232, true, 0.75F), new ConfessShareHelper.BgElement(2130845095, 298, 206, true, 0.75F), new ConfessShareHelper.BgElement(2130845098, 480, 140, true, 0.75F), new ConfessShareHelper.BgElement(2130845127, 382, 140, true, 0.75F), new ConfessShareHelper.BgElement(2130845122, 60, 90, true, 0.75F), new ConfessShareHelper.BgElement(2130845120, 182, 64, true, 0.75F), new ConfessShareHelper.BgElement(2130845120, 440, 210, true, 0.75F), new ConfessShareHelper.BgElement(2130845122, 440, 30, true, 0.75F), new ConfessShareHelper.BgElement(2130845122, 190, 200, true, 0.75F), new ConfessShareHelper.BgElement(2130845119, 257, 82, false, 1.0F) };
        if (paramInt1 != 1) {
          break;
        }
        switch (paramInt2)
      ...
      return new ConfessShareHelper.BgElement[] { new ConfessShareHelper.BgElement(2130845092, 110, 230, true, 1.0F), new ConfessShareHelper.BgElement(2130845095, 656, 170, true, 1.0F), new ConfessShareHelper.BgElement(2130845090, 516, 350, true, 1.0F), new ConfessShareHelper.BgElement(2130845091, 84, 550, true, 1.0F), new ConfessShareHelper.BgElement(2130845096, 656, 586, true, 1.0F), new ConfessShareHelper.BgElement(2130845091, 526, 735, true, 1.0F), new ConfessShareHelper.BgElement(2130845097, 198, 830, true, 1.0F), new ConfessShareHelper.BgElement(2130845093, 70, 1016, true, 1.0F), new ConfessShareHelper.BgElement(2130845095, 397, 952, true, 1.0F), new ConfessShareHelper.BgElement(2130845098, 670, 880, true, 1.0F), new ConfessShareHelper.BgElement(2130845090, 220, 1257, true, 1.0F), new ConfessShareHelper.BgElement(2130845094, 606, 1220, true, 1.0F), new ConfessShareHelper.BgElement(2130845127, 452, 475, true, 1.0F), new ConfessShareHelper.BgElement(2130845089, 240, 645, true, 1.0F), new ConfessShareHelper.BgElement(2130845120, 160, 300, true, 1.0F), new ConfessShareHelper.BgElement(2130845123, 660, 330, true, 1.0F), new ConfessShareHelper.BgElement(2130845121, 620, 450, true, 1.0F), new ConfessShareHelper.BgElement(2130845122, 175, 500, true, 1.0F), new ConfessShareHelper.BgElement(2130845122, 460, 570, true, 1.0F), new ConfessShareHelper.BgElement(2130845123, 180, 630, true, 1.0F), new ConfessShareHelper.BgElement(2130845120, 40, 690, true, 1.0F), new ConfessShareHelper.BgElement(2130845120, 260, 750, true, 1.0F), new ConfessShareHelper.BgElement(2130845123, 710, 600, true, 1.0F), new ConfessShareHelper.BgElement(2130845122, 600, 710, true, 1.0F), new ConfessShareHelper.BgElement(2130845122, 140, 970, true, 1.0F), new ConfessShareHelper.BgElement(2130845120, 85, 1200, true, 1.0F), new ConfessShareHelper.BgElement(2130845120, 600, 1050, true, 1.0F), new ConfessShareHelper.BgElement(2130845123, 420, 1100, true, 1.0F), new ConfessShareHelper.BgElement(2130845122, 540, 1250, true, 1.0F), new ConfessShareHelper.BgElement(2130845126, 375, 134, false, 1.0F) };
      return new ConfessShareHelper.BgElement[] { new ConfessShareHelper.BgElement(2130845095, 110, 368, true, 1.0F), new ConfessShareHelper.BgElement(2130845096, 570, 256, true, 1.0F), new ConfessShareHelper.BgElement(2130845091, 655, 475, true, 1.0F), new ConfessShareHelper.BgElement(2130845098, 75, 740, true, 1.0F), new ConfessShareHelper.BgElement(2130845090, 320, 686, true, 1.0F), new ConfessShareHelper.BgElement(2130845097, 670, 832, true, 1.0F), new ConfessShareHelper.BgElement(2130845095, 505, 955, true, 1.0F), new ConfessShareHelper.BgElement(2130845096, 260, 1020, true, 1.0F), new ConfessShareHelper.BgElement(2130845094, 75, 1216, true, 1.0F), new ConfessShareHelper.BgElement(2130845090, 565, 1235, true, 1.0F), new ConfessShareHelper.BgElement(2130845127, 430, 355, true, 1.0F), new ConfessShareHelper.BgElement(2130845089, 110, 174, true, 1.0F), new ConfessShareHelper.BgElement(2130845120, 140, 250, true, 1.0F), new ConfessShareHelper.BgElement(2130845123, 640, 195, true, 1.0F), new ConfessShareHelper.BgElement(2130845120, 170, 450, true, 1.0F), new ConfessShareHelper.BgElement(2130845122, 490, 1220, true, 1.0F), new ConfessShareHelper.BgElement(2130845121, 350, 520, true, 1.0F), new ConfessShareHelper.BgElement(2130845121, 630, 410, true, 1.0F), new ConfessShareHelper.BgElement(2130845123, 60, 500, true, 1.0F), new ConfessShareHelper.BgElement(2130845123, 680, 655, true, 1.0F), new ConfessShareHelper.BgElement(2130845123, 310, 1110, true, 1.0F), new ConfessShareHelper.BgElement(2130845122, 470, 660, true, 1.0F), new ConfessShareHelper.BgElement(2130845122, 190, 780, true, 1.0F), new ConfessShareHelper.BgElement(2130845122, 680, 1060, true, 1.0F), new ConfessShareHelper.BgElement(2130845120, 180, 1230, true, 1.0F), new ConfessShareHelper.BgElement(2130845126, 375, 134, false, 1.0F) };
      return new ConfessShareHelper.BgElement[] { new ConfessShareHelper.BgElement(2130845091, 110, 220, true, 1.0F), new ConfessShareHelper.BgElement(2130845097, 654, 240, true, 1.0F), new ConfessShareHelper.BgElement(2130845095, 562, 482, true, 1.0F), new ConfessShareHelper.BgElement(2130845093, 95, 537, true, 1.0F), new ConfessShareHelper.BgElement(2130845090, 295, 672, true, 1.0F), new ConfessShareHelper.BgElement(2130845092, 683, 660, true, 1.0F), new ConfessShareHelper.BgElement(2130845094, 60, 850, true, 1.0F), new ConfessShareHelper.BgElement(2130845096, 442, 872, true, 1.0F), new ConfessShareHelper.BgElement(2130845090, 114, 1046, true, 1.0F), new ConfessShareHelper.BgElement(2130845091, 680, 950, true, 1.0F), new ConfessShareHelper.BgElement(2130845096, 230, 1197, true, 1.0F), new ConfessShareHelper.BgElement(2130845098, 480, 1260, true, 1.0F), new ConfessShareHelper.BgElement(2130845127, 670, 1200, true, 1.0F), new ConfessShareHelper.BgElement(2130845120, 140, 630, true, 1.0F), new ConfessShareHelper.BgElement(2130845120, 500, 960, true, 1.0F), new ConfessShareHelper.BgElement(2130845120, 330, 1050, true, 1.0F), new ConfessShareHelper.BgElement(2130845120, 50, 1150, true, 1.0F), new ConfessShareHelper.BgElement(2130845121, 290, 430, true, 1.0F), new ConfessShareHelper.BgElement(2130845121, 330, 760, true, 1.0F), new ConfessShareHelper.BgElement(2130845122, 60, 310, true, 1.0F), new ConfessShareHelper.BgElement(2130845122, 480, 580, true, 1.0F), new ConfessShareHelper.BgElement(2130845122, 220, 820, true, 1.0F), new ConfessShareHelper.BgElement(2130845123, 600, 150, true, 1.0F), new ConfessShareHelper.BgElement(2130845123, 700, 410, true, 1.0F), new ConfessShareHelper.BgElement(2130845123, 25, 900, true, 1.0F), new ConfessShareHelper.BgElement(2130845123, 150, 430, true, 1.0F), new ConfessShareHelper.BgElement(2130845126, 375, 134, false, 1.0F) };
      return new ConfessShareHelper.BgElement[] { new ConfessShareHelper.BgElement(2130845091, 104, 278, true, 1.0F), new ConfessShareHelper.BgElement(2130845094, 588, 200, true, 1.0F), new ConfessShareHelper.BgElement(2130845090, 690, 390, true, 1.0F), new ConfessShareHelper.BgElement(2130845093, 420, 534, true, 1.0F), new ConfessShareHelper.BgElement(2130845092, 92, 592, true, 1.0F), new ConfessShareHelper.BgElement(2130845096, 660, 624, true, 1.0F), new ConfessShareHelper.BgElement(2130845091, 475, 735, true, 1.0F), new ConfessShareHelper.BgElement(2130845097, 192, 818, true, 1.0F), new ConfessShareHelper.BgElement(2130845098, 696, 880, true, 1.0F), new ConfessShareHelper.BgElement(2130845095, 430, 990, true, 1.0F), new ConfessShareHelper.BgElement(2130845090, 64, 1034, true, 1.0F), new ConfessShareHelper.BgElement(2130845090, 272, 1250, true, 1.0F), new ConfessShareHelper.BgElement(2130845094, 584, 1205, true, 1.0F), new ConfessShareHelper.BgElement(2130845089, 254, 638, true, 1.0F), new ConfessShareHelper.BgElement(2130845120, 200, 320, true, 1.0F), new ConfessShareHelper.BgElement(2130845120, 260, 780, true, 1.0F), new ConfessShareHelper.BgElement(2130845120, 620, 1000, true, 1.0F), new ConfessShareHelper.BgElement(2130845120, 150, 1250, true, 1.0F), new ConfessShareHelper.BgElement(2130845121, 70, 420, true, 1.0F), new ConfessShareHelper.BgElement(2130845121, 460, 590, true, 1.0F), new ConfessShareHelper.BgElement(2130845121, 630, 450, true, 1.0F), new ConfessShareHelper.BgElement(2130845122, 70, 800, true, 1.0F), new ConfessShareHelper.BgElement(2130845122, 280, 980, true, 1.0F), new ConfessShareHelper.BgElement(2130845122, 610, 720, true, 1.0F), new ConfessShareHelper.BgElement(2130845122, 480, 1220, true, 1.0F), new ConfessShareHelper.BgElement(2130845123, 170, 590, true, 1.0F), new ConfessShareHelper.BgElement(2130845123, 330, 1160, true, 1.0F), new ConfessShareHelper.BgElement(2130845123, 700, 680, true, 1.0F), new ConfessShareHelper.BgElement(2130845123, 660, 290, true, 1.0F), new ConfessShareHelper.BgElement(2130845126, 375, 134, false, 1.0F) };
    } while (paramInt1 != 2);
    return new ConfessShareHelper.BgElement[] { new ConfessShareHelper.BgElement(2130845092, 110, 310, true, 1.0F), new ConfessShareHelper.BgElement(2130845095, 650, 216, true, 1.0F), new ConfessShareHelper.BgElement(2130845090, 516, 350, true, 1.0F), new ConfessShareHelper.BgElement(2130845092, 92, 592, true, 1.0F), new ConfessShareHelper.BgElement(2130845096, 656, 586, true, 1.0F), new ConfessShareHelper.BgElement(2130845091, 470, 716, true, 1.0F), new ConfessShareHelper.BgElement(2130845097, 198, 830, true, 1.0F), new ConfessShareHelper.BgElement(2130845098, 670, 980, true, 1.0F), new ConfessShareHelper.BgElement(2130845095, 397, 1060, true, 1.0F), new ConfessShareHelper.BgElement(2130845093, 70, 1016, true, 1.0F), new ConfessShareHelper.BgElement(2130845120, 200, 320, true, 1.0F), new ConfessShareHelper.BgElement(2130845089, 240, 438, true, 1.0F), new ConfessShareHelper.BgElement(2130845127, 452, 475, true, 0.75F), new ConfessShareHelper.BgElement(2130845120, 200, 600, true, 1.0F), new ConfessShareHelper.BgElement(2130845120, 1000, 620, true, 1.0F), new ConfessShareHelper.BgElement(2130845121, 70, 420, true, 1.0F) };
  }
