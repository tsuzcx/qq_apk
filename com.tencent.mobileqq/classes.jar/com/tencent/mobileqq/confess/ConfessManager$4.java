  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if ((localGroupChatExtra == null) || (this.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)) {}
    do
    {
      return;
      if (TextUtils.isEmpty(localGroupChatExtra.c)) {
        localGroupChatExtra.c = ContactUtils.g(this.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqConfessConfessManager$GroupChatExtra.d);
      }
    ...
    } while (localGroupChatExtra.jdField_e_of_type_Int != 1);
    long l2 = MessageCache.a();
    List localList = this.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().a(this.jdField_a_of_type_JavaLangString, 1);
    long l1;
