  ...
  extends View
{
  ...
  amnz[] jdField_a_of_type_ArrayOfAmnz = null;
  int b = 0;
  private int c;
  ...
  private void a()
  {
    ...
    if (this.c == 2)
    {
      this.jdField_a_of_type_ArrayOfAmnz = amny.a(this.c, this.b);
      ...
      {
        localObject1 = this.jdField_a_of_type_ArrayOfAmnz;
    ...
    {
      localObject1 = amny.a[0];
      if ((this.b < 0) || (this.b >= amny.a.length)) {
        break label309;
      }
      localObject1 = amny.a[this.b];
      this.jdField_a_of_type_ArrayOfAmnz = amny.a(0, this.b);
    }
    try
    {
      for (;;)
      {
        ...
        return;
        label309:
        this.jdField_a_of_type_ArrayOfAmnz = amny.a(0, 0);
      }
    }
  ...
  public void onDraw(Canvas paramCanvas)
  {
    ...
    try
    {
      ...
      if ((this.jdField_a_of_type_ArrayOfAmnz != null) && (this.jdField_a_of_type_ArrayOfAmnz.length > 0))
      {
        localObject1 = this.jdField_a_of_type_ArrayOfAmnz;
        int m = localObject1.length;
        i = 0;
        if (i < m)
        {
          ...
          for (;;)
          {
            try
            {
              ...
              if (localObject2.jdField_a_of_type_Int == 2130844179) {
                break;
              }
