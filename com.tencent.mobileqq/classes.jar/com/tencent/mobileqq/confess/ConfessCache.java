...
public class ConfessCache
{
  ...
  Pair jdField_a_of_type_ComTencentUtilPair = new Pair("", Boolean.valueOf(false));
  ...
  {
    Object localObject1 = ConfessMsgUtil.a(???, paramInt1, paramInt2);
  ...
  {
    String str = ConfessMsgUtil.a(???, paramInt, paramConfessInfo.topicId);
    synchronized (jdField_a_of_type_JavaLangObject)
    {
