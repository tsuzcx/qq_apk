...
public class ConfessConfig
{
  ...
  public ConfessConfig(String paramString)
  {
    ...
    paramString = SharedPreUtils.a(this.jdField_i_of_type_JavaLangString, "confess_config_sp");
    ...
    a(paramString.getString("confess_config", ""), true);
  }
  ...
  public String a()
  {
    ...
    if ((!TextUtils.isEmpty(this.jdField_j_of_type_JavaLangString)) && (Math.abs(l - this.jdField_d_of_type_Long) < (this.jdField_a_of_type_Float * 60000.0F))) {
    ...
    for (;;)
    {
      ...
      {
        this.jdField_j_of_type_JavaLangString = this.jdField_b_of_type_JavaLangString;
      }
      else if ((this.jdField_c_of_type_Int > 0) && (this.jdField_c_of_type_Int > this.jdField_b_of_type_Int))
      {
        ...
        this.jdField_j_of_type_JavaLangString = this.jdField_b_of_type_JavaLangString.replace("N", localNumberFormat.format(m % (n - i1 + 1) + i2));
      }
      else
      {
        this.jdField_j_of_type_JavaLangString = "";
  ...
  public void a()
  {
    SharedPreferences localSharedPreferences = SharedPreUtils.a(this.jdField_i_of_type_JavaLangString, "confess_config_sp");
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    if (TextUtils.isEmpty(paramString))
    {
      ...
      if (TextUtils.isEmpty(this.jdField_g_of_type_JavaLangString)) {
        this.jdField_g_of_type_JavaLangString = "https://ti.qq.com/honest-say/setting.html?_wv=9191&_wwv=4&_qStyle=1&adtag=message_box";
      }
      if (TextUtils.isEmpty(this.jdField_h_of_type_JavaLangString)) {
        this.jdField_h_of_type_JavaLangString = "题库更新啦！快来抢先体验吧！";
      }
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (((JSONObject)localObject).has("frdRecMsgSwitch")) {
            this.k = ((JSONObject)localObject).getInt("frdRecMsgSwitch");
          }
          ...
          if (((JSONObject)localObject).has("settingUrl")) {
            this.jdField_g_of_type_JavaLangString = ((JSONObject)localObject).getString("settingUrl");
          }
          ...
          if (((JSONObject)localObject).has("redPointText")) {
            this.jdField_h_of_type_JavaLangString = ((JSONObject)localObject).getString("redPointText");
          }
  ...
  public void b()
  {
    ...
    this.jdField_j_of_type_Int = 0;
    SharedPreUtils.a(this.jdField_i_of_type_JavaLangString, "confess_config_sp").edit().putLong("lLastVanishTime", this.jdField_b_of_type_Long).putInt("nContinuousVanishCount", this.jdField_j_of_type_Int);
  }
