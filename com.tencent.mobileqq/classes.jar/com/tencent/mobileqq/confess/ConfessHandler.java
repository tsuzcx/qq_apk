  ...
  extends BusinessHandler
{
      ...
      try
      {
        ...
        if (n == 0)
        {
          ...
          if (localRspBody.uint32_result.has())
          {
            ...
            ConfessMsgUtil.a(this.a, str, ConfessConfig.e, k, m, paramToServiceMsg);
            label169:
          ...
          while (QLog.isColorLevel())
          {
            ...
            break label141;
            label280:
            ConfessMsgUtil.a(this.a, str, k, m, paramToServiceMsg);
            break label169;
            label297:
  ...
  private void b(QQAppInterface paramQQAppInterface, ConfessConfig paramConfessConfig)
  {
    ...
    for (;;)
    {
      ...
      if (localRecentUser2.lastmsgtime < l1)
      {
        localRecentUser2.lastmsgtime = l1;
        i = 1;
        localRecentUser1 = localRecentUser2;
      }
    }
  ...
  public void a(FrdConfessInfo paramFrdConfessInfo)
  {
    ...
    if (this.a.getProxyManager().a().b(AppConstants.CONFESS_UIN, 1032) != null)
    {
  ...
  public void b(FrdConfessInfo paramFrdConfessInfo)
  {
    ...
    {
      localRecentUserProxy = this.a.getProxyManager().a();
      localRecentUser2 = localRecentUserProxy.b(AppConstants.CONFESS_UIN, 1032);
      i = 0;
      if (localRecentUser2 != null) {
        break label127;
      }
      localRecentUser1 = new RecentUser();
      localRecentUser1.uin = AppConstants.CONFESS_UIN;
