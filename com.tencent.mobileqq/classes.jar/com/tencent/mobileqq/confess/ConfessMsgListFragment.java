  ...
  implements View.OnClickListener
{
  ...
  aqyu jdField_a_of_type_Aqyu = new aqys(this);
  View b;
  public ImageView b;
  View c;
  ...
  public static void a(Context paramContext, int paramInt)
  {
    ...
    localIntent.putExtra("uin", antf.aM);
  ...
  private void d()
  {
    ...
    boolean bool2 = aqyl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "redpoint_box_show");
    boolean bool1;
    label40:
    Object localObject1;
    label60:
    ...
    Object localObject3;
    Object localObject2;
    if (this.jdField_b_of_type_AndroidViewView.findViewById(2131376428).getVisibility() == 0)
    {
      bool1 = true;
      if (bool2 != bool1)
      {
        localObject1 = this.jdField_b_of_type_AndroidViewView.findViewById(2131376428);
        if (!bool2) {
          break label223;
        }
      ...
      localObject3 = ((aqyl)localObject1).i;
      str = ((aqyl)localObject1).a();
      localObject2 = ((aqyl)localObject1).r;
    }
    for (;;)
    {
      localObject1 = localObject3;
      if (TextUtils.isEmpty((CharSequence)localObject3)) {
        localObject1 = aqyl.jdField_a_of_type_JavaLangString;
      }
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          localObject3 = (TextView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131365046);
          TextView localTextView = (TextView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131365388);
          if (bool2) {}
          for (;;)
          {
            ...
            break label60;
            label229:
            localObject1 = this.jdField_a_of_type_Aqyp.b();
            break label76;
  ...
  public void a(View paramView, RecentBaseData paramRecentBaseData, String paramString, boolean paramBoolean)
  {
    ...
    if ((paramRecentBaseData instanceof RecentItemConfessMsg))
    {
      ...
      aqyt.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, paramView.getRecentUserUin(), paramView.mType, paramView.mConfessInfo.topicId, paramView.mTitleName, paramString);
      if (paramView.mType != 1033) {
        break label234;
      }
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8008F4D", "0X8008F4D", 2, 0, "", "", "", "");
    }
    label234:
    while ((paramView.mType != 1032) || (!TextUtils.equals(paramView.mUin, antf.aN))) {
      for (;;)
      {
        aqyt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (RecentItemConfessMsg)paramRecentBaseData, false);
        return;
        bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8008F4E", "0X8008F4E", 2, 0, "", "", "", "");
      }
    }
    label273:
    if (this.jdField_a_of_type_Aqyp == null)
    ...
    for (paramView = "https://ti.qq.com/honest-say/friends-received.html?_bid=3104&_wv=9191&_qStyle=1&adtag=message_box";; paramView = paramView.m)
    {
      ...
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8008F4F", "0X8008F4F", 2, 0, "", "", "", "");
      break;
      paramView = this.jdField_a_of_type_Aqyp.b();
      break label305;
    }
  }
  ...
  public void a(RecentBaseData paramRecentBaseData, String paramString)
  {
    ...
    if ((paramRecentBaseData instanceof RecentItemConfessMsg)) {
      aqyt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (RecentItemConfessMsg)paramRecentBaseData, true);
    }
    b();
  }
  ...
  {
    int k = 0;
    Object localObject1 = this.jdField_a_of_type_Aqyp.a();
    int i;
    Object localObject2;
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      if (j >= 0)
      {
        ...
        for (;;)
        {
          ...
          {
            if ((localObject1 == null) || (((aqzb)localObject1).jdField_a_of_type_Long <= ((MessageRecord)localObject2).time)) {
              break label593;
            }
            i = j;
          }
    ...
    for (int j = i;; j = 0)
    {
      ...
      {
        i = 0;
        if ((localObject1 != null) && (((aqzb)localObject1).a()) && (paramList != null))
        {
          localObject2 = new MessageRecord();
          ((MessageRecord)localObject2).istroop = 1032;
          ((MessageRecord)localObject2).frienduin = antf.aN;
          ((MessageRecord)localObject2).time = ((aqzb)localObject1).jdField_a_of_type_Long;
          ((MessageRecord)localObject2).senderuin = ((aqzb)localObject1).jdField_a_of_type_JavaLangString;
          ((MessageRecord)localObject2).msg = ((aqzb)localObject1).c;
          ((MessageRecord)localObject2).msg2 = ((aqzb)localObject1).b;
          ((MessageRecord)localObject2).longMsgCount = ((aqzb)localObject1).jdField_a_of_type_Int;
        ...
        localObject2 = (RecentUser)((apaw)localObject1).findRecentUser(antf.aM, 1032);
        bool = aqyl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "redpoint_box_show");
        l1 = aqyl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "redpoint_box_show");
        long l2 = aqyl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "redpoint_clear_time");
        long l3 = bcrg.a();
      ...
      for (;;)
      {
        ...
        if ((j == 0) && (localObject2 == null))
        {
          ...
          ((RecentUser)localObject2).uin = antf.aM;
        ...
        if (j != 0)
        {
          ...
          if (localObject2 == null)
          {
            ...
            paramList.uin = antf.aM;
            paramList.setType(1032);
            paramList.lastmsgtime = l1;
            ((apaw)localObject1).saveRecentUser(paramList);
            i = 1;
          }
        }
      }
  ...
  public void doOnCreateView(LayoutInflater paramLayoutInflater, @Nullable ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    setTitle(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131697920));
    paramViewGroup = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources();
    this.jdField_a_of_type_Aqyp = ((aqyp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(269));
    paramBundle = this.jdField_a_of_type_Aqyp.b();
    if ((paramBundle != null) && (paramBundle.g == 1))
    {
      Drawable localDrawable1 = getResources().getDrawable(2130850416);
      Drawable localDrawable2 = getResources().getDrawable(2130845010);
      if ((this.jdField_b_of_type_AndroidWidgetImageView != null) && (this.jdField_a_of_type_AndroidWidgetImageView != null))
      {
        ...
        this.jdField_b_of_type_AndroidWidgetImageView.setContentDescription(getString(2131697918));
        this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(getString(2131693471));
      }
      if ((paramBundle == null) || ((paramBundle != null) && (paramBundle.h >= 1)) || (aqyl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "redpoint_box_show")))
      {
        this.jdField_b_of_type_AndroidViewView = paramLayoutInflater.inflate(2131561129, this.jdField_a_of_type_AndroidWidgetLinearLayout, false);
        if ((LinearLayout.LayoutParams)this.jdField_b_of_type_AndroidViewView.getLayoutParams() != null) {
          break label396;
        }
        paramBundle = new LinearLayout.LayoutParams(-1, paramViewGroup.getDimensionPixelSize(2131298072));
        paramBundle.topMargin = paramViewGroup.getDimensionPixelSize(2131298073);
        paramBundle.bottomMargin = paramViewGroup.getDimensionPixelOffset(2131298073);
        this.jdField_a_of_type_AndroidWidgetLinearLayout.addView(this.jdField_b_of_type_AndroidViewView, paramBundle);
        label289:
        this.jdField_b_of_type_AndroidViewView.setOnClickListener(this);
        d();
        this.jdField_c_of_type_AndroidViewView = paramLayoutInflater.inflate(2131561136, this.jdField_a_of_type_AndroidWidgetLinearLayout, false);
        if ((LinearLayout.LayoutParams)this.jdField_c_of_type_AndroidViewView.getLayoutParams() != null) {
          break label410;
        }
        paramLayoutInflater = new LinearLayout.LayoutParams(-1, paramViewGroup.getDimensionPixelSize(2131298074));
        this.jdField_a_of_type_AndroidWidgetLinearLayout.addView(this.jdField_c_of_type_AndroidViewView, paramLayoutInflater);
      }
    }
    for (;;)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Aqyu, true);
  ...
  public void onClick(View paramView)
  {
    ...
    if (paramView == this.jdField_b_of_type_AndroidViewView) {
      if (this.jdField_a_of_type_Aqyp == null)
      {
        ...
        localObject2 = this.jdField_b_of_type_AndroidViewView.findViewById(2131376428);
        if (((View)localObject2).getVisibility() != 8) {
          ((View)localObject2).setVisibility(8);
        }
        aqyt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false);
        bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8008F4B", "0X8008F4B", 2, 0, "", "", "", "");
        if (QLog.isDevelopLevel()) {
    ...
    do
    {
      ...
      localObject1 = this.jdField_a_of_type_Aqyp.b();
      break;
      localObject1 = ((aqyl)localObject1).k;
      break label25;
      if (paramView == this.rightViewText)
      {
        ...
        for (localObject1 = "https://ti.qq.com/honest-say/setting.html?_wv=9191&_wwv=4&_qStyle=1&adtag=message_box";; localObject1 = ((aqyl)localObject1).p)
        {
          if (!TextUtils.isEmpty((CharSequence)localObject1))
          {
            localObject2 = new Intent(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, QQBrowserActivity.class);
          ...
          bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80091A1", "0X80091A1", 0, 0, "", "", "", "");
          if (!QLog.isDevelopLevel()) {
            break;
          }
          QLog.i("ConfessMsgListFragment", 4, String.format(Locale.getDefault(), "click entry url: %s", new Object[] { localObject1 }));
      ...
      if (paramView == this.jdField_b_of_type_AndroidWidgetImageView)
      {
        ...
        for (localObject1 = "https://ti.qq.com/honest-say/rank.html?_wv=9191&_wwv=4&_qStyle=1";; localObject1 = ((aqyl)localObject1).q)
        {
          if (!TextUtils.isEmpty((CharSequence)localObject1))
          {
            localObject2 = new Intent(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, QQBrowserActivity.class);
          ...
          bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800948C", "0X800948C", 0, 0, "", "", "", "");
          if (!QLog.isDevelopLevel()) {
            break;
          }
          QLog.i("ConfessMsgListFragment", 4, String.format(Locale.getDefault(), "click entry url: %s", new Object[] { localObject1 }));
    ...
    label526:
    for (Object localObject1 = "https://ti.qq.com/honest-say/setting.html?_wv=9191&_wwv=4&_qStyle=1&adtag=message_box";; localObject1 = ((aqyl)localObject1).p)
    {
      if (!TextUtils.isEmpty((CharSequence)localObject1))
      {
        localObject2 = new Intent(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, QQBrowserActivity.class);
  ...
  public View onCreateRightView()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.titleRoot.findViewById(2131369056));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.titleRoot.findViewById(2131369057));
