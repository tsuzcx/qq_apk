  ...
  implements View.OnClickListener
{
  ...
  aqjr jdField_a_of_type_Aqjr = new aqjp(this);
  View b;
  public ImageView b;
  View c;
  ...
  public static void a(Context paramContext, int paramInt)
  {
    ...
    localIntent.putExtra("uin", anhk.aM);
  ...
  private void d()
  {
    ...
    boolean bool2 = aqji.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "redpoint_box_show");
    boolean bool1;
    label40:
    Object localObject1;
    label60:
    ...
    Object localObject3;
    Object localObject2;
    if (this.jdField_b_of_type_AndroidViewView.findViewById(2131376296).getVisibility() == 0)
    {
      bool1 = true;
      if (bool2 != bool1)
      {
        localObject1 = this.jdField_b_of_type_AndroidViewView.findViewById(2131376296);
        if (!bool2) {
          break label223;
        }
        ((View)localObject1).setVisibility(i);
      }
      if (this.jdField_a_of_type_Aqjm != null) {
        break label229;
      }
      localObject1 = null;
      ...
      localObject3 = ((aqji)localObject1).i;
      str = ((aqji)localObject1).a();
      localObject2 = ((aqji)localObject1).r;
    }
    for (;;)
    {
      localObject1 = localObject3;
      if (TextUtils.isEmpty((CharSequence)localObject3)) {
        localObject1 = aqji.jdField_a_of_type_JavaLangString;
      }
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          localObject3 = (TextView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131364999);
          TextView localTextView = (TextView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131365344);
          if (bool2) {}
          for (;;)
          {
            ...
            break label60;
            label229:
            localObject1 = this.jdField_a_of_type_Aqjm.b();
            break label76;
  ...
  public void a(View paramView, RecentBaseData paramRecentBaseData, String paramString, boolean paramBoolean)
  {
    ...
    if ((paramRecentBaseData instanceof RecentItemConfessMsg))
    {
      ...
      aqjq.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, paramView.getRecentUserUin(), paramView.mType, paramView.mConfessInfo.topicId, paramView.mTitleName, paramString);
      if (paramView.mType != 1033) {
        break label234;
      }
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8008F4D", "0X8008F4D", 2, 0, "", "", "", "");
    }
    label234:
    while ((paramView.mType != 1032) || (!TextUtils.equals(paramView.mUin, anhk.aN))) {
      for (;;)
      {
        aqjq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (RecentItemConfessMsg)paramRecentBaseData, false);
        return;
        bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8008F4E", "0X8008F4E", 2, 0, "", "", "", "");
      }
    }
    label273:
    if (this.jdField_a_of_type_Aqjm == null)
    ...
    for (paramView = "https://ti.qq.com/honest-say/friends-received.html?_bid=3104&_wv=9191&_qStyle=1&adtag=message_box";; paramView = paramView.m)
    {
      ...
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8008F4F", "0X8008F4F", 2, 0, "", "", "", "");
      break;
      paramView = this.jdField_a_of_type_Aqjm.b();
      break label305;
    }
  }
  ...
  public void a(RecentBaseData paramRecentBaseData, String paramString)
  {
    ...
    if ((paramRecentBaseData instanceof RecentItemConfessMsg)) {
      aqjq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (RecentItemConfessMsg)paramRecentBaseData, true);
    }
    b();
  }
  ...
  {
    int k = 0;
    Object localObject1 = this.jdField_a_of_type_Aqjm.a();
    int i;
    Object localObject2;
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      if (j >= 0)
      {
        ...
        for (;;)
        {
          ...
          {
            if ((localObject1 == null) || (((aqjy)localObject1).jdField_a_of_type_Long <= ((MessageRecord)localObject2).time)) {
              break label593;
            }
            i = j;
          }
    ...
    for (int j = i;; j = 0)
    {
      ...
      {
        i = 0;
        if ((localObject1 != null) && (((aqjy)localObject1).a()) && (paramList != null))
        {
          localObject2 = new MessageRecord();
          ((MessageRecord)localObject2).istroop = 1032;
          ((MessageRecord)localObject2).frienduin = anhk.aN;
          ((MessageRecord)localObject2).time = ((aqjy)localObject1).jdField_a_of_type_Long;
          ((MessageRecord)localObject2).senderuin = ((aqjy)localObject1).jdField_a_of_type_JavaLangString;
          ((MessageRecord)localObject2).msg = ((aqjy)localObject1).c;
          ((MessageRecord)localObject2).msg2 = ((aqjy)localObject1).b;
          ((MessageRecord)localObject2).longMsgCount = ((aqjy)localObject1).jdField_a_of_type_Int;
        ...
        localObject2 = (RecentUser)((aong)localObject1).findRecentUser(anhk.aM, 1032);
        bool = aqji.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "redpoint_box_show");
        l1 = aqji.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "redpoint_box_show");
        long l2 = aqji.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "redpoint_clear_time");
        long l3 = bbyp.a();
      ...
      for (;;)
      {
        ...
        if ((j == 0) && (localObject2 == null))
        {
          ...
          ((RecentUser)localObject2).uin = anhk.aM;
        ...
        if (j != 0)
        {
          ...
          if (localObject2 == null)
          {
            ...
            paramList.uin = anhk.aM;
            paramList.setType(1032);
            paramList.lastmsgtime = l1;
            ((aong)localObject1).saveRecentUser(paramList);
            i = 1;
          }
        }
      }
  ...
  public void doOnCreateView(LayoutInflater paramLayoutInflater, @Nullable ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    setTitle(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131697836));
    paramViewGroup = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources();
    this.jdField_a_of_type_Aqjm = ((aqjm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(269));
    paramBundle = this.jdField_a_of_type_Aqjm.b();
    if ((paramBundle != null) && (paramBundle.g == 1))
    {
      Drawable localDrawable1 = getResources().getDrawable(2130850404);
      Drawable localDrawable2 = getResources().getDrawable(2130844995);
      if ((this.jdField_b_of_type_AndroidWidgetImageView != null) && (this.jdField_a_of_type_AndroidWidgetImageView != null))
      {
        ...
        this.jdField_b_of_type_AndroidWidgetImageView.setContentDescription(getString(2131697834));
        this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(getString(2131693459));
      }
      if ((paramBundle == null) || ((paramBundle != null) && (paramBundle.h >= 1)) || (aqji.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "redpoint_box_show")))
      {
        this.jdField_b_of_type_AndroidViewView = paramLayoutInflater.inflate(2131561093, this.jdField_a_of_type_AndroidWidgetLinearLayout, false);
        if ((LinearLayout.LayoutParams)this.jdField_b_of_type_AndroidViewView.getLayoutParams() != null) {
          break label396;
        }
        paramBundle = new LinearLayout.LayoutParams(-1, paramViewGroup.getDimensionPixelSize(2131298060));
        paramBundle.topMargin = paramViewGroup.getDimensionPixelSize(2131298061);
        paramBundle.bottomMargin = paramViewGroup.getDimensionPixelOffset(2131298061);
        this.jdField_a_of_type_AndroidWidgetLinearLayout.addView(this.jdField_b_of_type_AndroidViewView, paramBundle);
        label289:
        this.jdField_b_of_type_AndroidViewView.setOnClickListener(this);
        d();
        this.jdField_c_of_type_AndroidViewView = paramLayoutInflater.inflate(2131561100, this.jdField_a_of_type_AndroidWidgetLinearLayout, false);
        if ((LinearLayout.LayoutParams)this.jdField_c_of_type_AndroidViewView.getLayoutParams() != null) {
          break label410;
        }
        paramLayoutInflater = new LinearLayout.LayoutParams(-1, paramViewGroup.getDimensionPixelSize(2131298062));
        this.jdField_a_of_type_AndroidWidgetLinearLayout.addView(this.jdField_c_of_type_AndroidViewView, paramLayoutInflater);
      }
    }
    for (;;)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Aqjr, true);
  ...
  public void onClick(View paramView)
  {
    ...
    if (paramView == this.jdField_b_of_type_AndroidViewView) {
      if (this.jdField_a_of_type_Aqjm == null)
      {
        ...
        localObject2 = this.jdField_b_of_type_AndroidViewView.findViewById(2131376296);
        if (((View)localObject2).getVisibility() != 8) {
          ((View)localObject2).setVisibility(8);
        }
        aqjq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false);
        bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8008F4B", "0X8008F4B", 2, 0, "", "", "", "");
        if (QLog.isDevelopLevel()) {
    ...
    do
    {
      ...
      localObject1 = this.jdField_a_of_type_Aqjm.b();
      break;
      localObject1 = ((aqji)localObject1).k;
      break label25;
      if (paramView == this.rightViewText)
      {
        ...
        for (localObject1 = "https://ti.qq.com/honest-say/setting.html?_wv=9191&_wwv=4&_qStyle=1&adtag=message_box";; localObject1 = ((aqji)localObject1).p)
        {
          if (!TextUtils.isEmpty((CharSequence)localObject1))
          {
            localObject2 = new Intent(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, QQBrowserActivity.class);
          ...
          bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80091A1", "0X80091A1", 0, 0, "", "", "", "");
          if (!QLog.isDevelopLevel()) {
            break;
          }
          QLog.i("ConfessMsgListFragment", 4, String.format(Locale.getDefault(), "click entry url: %s", new Object[] { localObject1 }));
      ...
      if (paramView == this.jdField_b_of_type_AndroidWidgetImageView)
      {
        ...
        for (localObject1 = "https://ti.qq.com/honest-say/rank.html?_wv=9191&_wwv=4&_qStyle=1";; localObject1 = ((aqji)localObject1).q)
        {
          if (!TextUtils.isEmpty((CharSequence)localObject1))
          {
            localObject2 = new Intent(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, QQBrowserActivity.class);
          ...
          bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800948C", "0X800948C", 0, 0, "", "", "", "");
          if (!QLog.isDevelopLevel()) {
            break;
          }
          QLog.i("ConfessMsgListFragment", 4, String.format(Locale.getDefault(), "click entry url: %s", new Object[] { localObject1 }));
    ...
    label526:
    for (Object localObject1 = "https://ti.qq.com/honest-say/setting.html?_wv=9191&_wwv=4&_qStyle=1&adtag=message_box";; localObject1 = ((aqji)localObject1).p)
    {
      if (!TextUtils.isEmpty((CharSequence)localObject1))
      {
        localObject2 = new Intent(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, QQBrowserActivity.class);
  ...
  public View onCreateRightView()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.titleRoot.findViewById(2131368961));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.titleRoot.findViewById(2131368962));
