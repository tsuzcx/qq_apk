...
public final class StudyModeSwitchDialog$manager$2
  extends Lambda
  implements Function0<azwl>
{
  public StudyModeSwitchDialog$manager$2(azwy paramazwy)
  {
    super(0);
  }
  
  @NotNull
  public final azwl invoke()
  {
    Manager localManager = azwy.a(this.this$0).app.getManager(361);
    if (localManager == null) {
      throw new TypeCastException("null cannot be cast to non-null type com.tencent.mobileqq.studymode.ModeSwitchManager");
    }
    return (azwl)localManager;
  }
}
