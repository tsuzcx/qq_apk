  ...
  implements TextWatcher, View.OnClickListener, View.OnFocusChangeListener, View.OnTouchListener, AdapterView.OnItemClickListener, EmoticonCallback, HotPicPageView.OnHotPicItemClickListener, HttpWebCgiAsyncTask.Callback, InputMethodLinearLayout.onSizeChangeListenner
{
  ...
  static
  {
    jdField_a_of_type_AndroidTextEditable$Factory = new aiyn();
  }
  ...
  public AbsPublishActivity()
  {
    ...
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new aiys(this);
    this.jdField_a_of_type_AndroidOsHandler = new aiyt(this);
  ...
  protected void a()
  {
    ...
    {
      this.leftViewNotBack.setContentDescription(getString(2131430338));
      this.rightViewText.setContentDescription(getString(2131430339));
    }
    this.jdField_a_of_type_ComTencentMobileqqWidgetInputMethodLinearLayout = ((InputMethodLinearLayout)findViewById(2131365641));
    this.jdField_a_of_type_ComTencentWidgetScrollView = ((ScrollView)findViewById(2131363712));
    ...
    this.jdField_a_of_type_AndroidViewView = findViewById(2131368615);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131368616));
    this.jdField_a_of_type_AndroidWidgetTextView.setMaxWidth(((DisplayMetrics)localObject).widthPixels / 2);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131368618));
    this.jdField_b_of_type_AndroidWidgetTextView.setMaxWidth(((DisplayMetrics)localObject).widthPixels / 2);
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131368619));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131368617));
    this.jdField_a_of_type_AndroidWidgetListView = ((ListView)findViewById(2131366618));
    this.jdField_a_of_type_ComTencentMobileqqTribeViewTEditText = ((TEditText)findViewById(2131366614));
    this.jdField_b_of_type_ComTencentMobileqqTribeViewTEditText = ((TEditText)findViewById(2131366616));
    this.jdField_b_of_type_AndroidWidgetEditText = ((EditText)findViewById(2131366615));
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)findViewById(2131366613));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131366617));
    this.jdField_b_of_type_AndroidViewView = findViewById(2131366620);
    this.jdField_a_of_type_ComTencentMobileqqTroopActivityExtendGridView = ((ExtendGridView)findViewById(2131366621));
    this.jdField_b_of_type_AndroidWidgetFrameLayout = ((FrameLayout)findViewById(2131366612));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131366633));
    this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131366635));
    this.jdField_a_of_type_ComTencentMobileqqTroopWidgetPublishItemContainer = ((PublishItemContainer)findViewById(2131366619));
    this.jdField_c_of_type_AndroidViewView = findViewById(2131366622);
    this.jdField_a_of_type_ComTencentMobileqqTroopWidgetPublishItemBar = ((PublishItemBar)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131366637));
    ...
    for (;;)
    {
      ...
      this.jdField_b_of_type_ComTencentMobileqqTribeViewTEditText.setFilters(new InputFilter[] { new aiyz(this) });
      ...
      a(this, this);
      localObject = getResources().getDrawable(2130841237);
      ...
      {
        localObject = getResources().getDrawable(2130841242);
  ...
  public void a(int paramInt)
  {
    ...
    case 0: 
      ...
      for (;;)
      {
        ...
        e();
        return;
        paramInt = paramInt + i1 + localResources.getDrawable(2130840580).getIntrinsicHeight();
      }
    case 1: 
  ...
  protected void a(int paramInt, String... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      return;
      paramVarArgs = getString(2131430360);
      paramInt = i1;
      break label41;
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqAppSosoSosoInterface$OnLocationListener = new aiyo(this, 0, true, true, this.jdField_n_of_type_Int, false, false, "AbsPublish", paramBaseActivity, paramCallback);
  ...
  public void a(BaseActivity paramBaseActivity, String paramString)
  {
    ...
    paramString.a(2131436176, 1);
    paramString.a(2131436178, 1);
    paramString.c(2131433029);
    paramString.a(new aiyy(this, paramBaseActivity, paramString));
    paramString.show();
  ...
  public boolean a(int paramInt)
  {
    ...
    if ((this.jdField_k_of_type_Int & paramInt) == paramInt)
    {
      ...
      while (localObject != null)
      {
        ...
        return true;
        localObject = getString(2131430495, new Object[] { this.jdField_n_of_type_JavaLangString });
        continue;
        localObject = getString(2131430494, new Object[] { this.jdField_n_of_type_JavaLangString });
      }
    }
    return false;
  }
  ...
  protected boolean a(int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (((paramInt & 0x1) == 1) && (this.jdField_a_of_type_JavaUtilArrayList.size() == 0)) {
        str = getString(2131430498, new Object[] { getString(2131430483) });
      }
      while (str != null)
      {
        ...
        if (((paramInt & 0x2) == 2) && (this.jdField_a_of_type_ComTencentMobileqqTroopDataAudioInfo == null)) {
          str = getString(2131430498, new Object[] { getString(2131430481) });
        } else if ((paramInt & 0x4) == 4) {
          str = getString(2131430498, new Object[] { getString(2131430482) });
        } else if ((paramInt & 0x8) == 8) {
          str = getString(2131430498, new Object[] { getString(2131430484) });
        }
      }
    }
  }
  ...
  protected void b(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      this.jdField_a_of_type_AndroidWidgetImageButton.setImageResource(2130841238);
      this.jdField_a_of_type_AndroidWidgetImageButton.setContentDescription(getString(2131430344));
    }
  }
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.t = getString(2131430329, new Object[] { Integer.valueOf(this.jdField_f_of_type_Int) });
  ...
  public void e()
  {
    ...
    ((Animation)localObject).setAnimationListener(new aiym(this, localAnimation));
    localAnimation.setAnimationListener(new aiyp(this));
  ...
  public void g()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqTroopWidgetTribeHotPicPanel = ((TribeHotPicPanel)LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity).inflate(2130971673, null));
  ...
  protected void j()
  {
    ...
    if ((this.jdField_i_of_type_Int & 0x1) == 1)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqTribeViewTEditText.setFilters(new InputFilter[] { new InputFilter.LengthFilter(this.jdField_b_of_type_Int), new aiza(this) });
  ...
  public void onClick(View paramView)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewSystemEmoticonPanel.setVisibility(8);
      this.jdField_a_of_type_AndroidOsHandler.postDelayed(new aiyq(this), 200L);
      return;
    }
    label384:
    InputMethodUtil.b(this.jdField_b_of_type_ComTencentMobileqqTribeViewTEditText);
    this.jdField_a_of_type_AndroidOsHandler.postDelayed(new aiyr(this), 200L);
  }
    ...
    if (paramView == this.jdField_b_of_type_ComTencentMobileqqTribeViewTEditText) {
      if (paramBoolean)
      {
        ...
        if (!this.jdField_b_of_type_Boolean) {
          this.jdField_a_of_type_AndroidOsHandler.postDelayed(new aiyw(this), 200L);
        }
      }
    }
