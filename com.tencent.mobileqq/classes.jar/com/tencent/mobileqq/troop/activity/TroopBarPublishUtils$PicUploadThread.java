  ...
  public void run()
  {
    ...
    for (;;)
    {
      if (localIterator.hasNext())
      {
        ...
        if ((!aupa.a(str3)) && (TroopBarPublishUtils.a()) && (TroopBarPublishUtils.jdField_a_of_type_Boolean)) {}
        for (i = 1;; i = 0)
        {
          localObject1 = (TroopBarPublishActivity.Pic_list)bajf.a.get(str3);
        ...
        else
        {
          ...
          if (localObject2 != null)
          {
            ...
            vxv.a((Bitmap)localObject2, Bitmap.CompressFormat.PNG, 100, (String)localObject1);
          }
        }
      }
    }
    ...
    for (;;)
    {
      ...
      localObject2 = bajf.a(this.jdField_a_of_type_JavaLangString, localBaseActivity, (String)localObject1, str1, str2, (Map)localObject2);
      if (i != 0) {
