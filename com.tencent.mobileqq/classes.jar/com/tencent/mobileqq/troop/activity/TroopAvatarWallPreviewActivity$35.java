...
class TroopAvatarWallPreviewActivity$35
  extends PersonalityLabelObserver
{
  TroopAvatarWallPreviewActivity$35(TroopAvatarWallPreviewActivity paramTroopAvatarWallPreviewActivity) {}
  ...
  public void onDelPersonalityLabelPhoto(boolean paramBoolean, String paramString, long paramLong1, long paramLong2)
  {
    ...
    {
      if (TroopAvatarWallPreviewActivity.access$500(this.a) == null) {
        return;
      }
      if ((this.a.mIndex >= 0) && (this.a.mIndex <= this.a.mAdapter.getCount() - 1) && (this.a.mPhotoIds != null))
      {
        ...
        long l1 = TroopAvatarWallPreviewActivity.access$500(this.a).getLong("label_id", 0L);
        ...
        if (l1 == paramLong1)
        {
          ...
          TroopAvatarWallPreviewActivity.access$2300(this.a);
          localObject = this.a;
          int i;
          if (paramBoolean)
          {
          ...
          TroopAvatarWallPreviewActivity.access$2400((TroopAvatarWallPreviewActivity)localObject, paramString.getString(i));
          if (paramBoolean)
          {
 ...
 * Qualified Name:     com.tencent.mobileqq.troop.activity.TroopAvatarWallPreviewActivity.35
