...
class TroopAvatarWallPreviewActivity$16
  implements Runnable
{
  TroopAvatarWallPreviewActivity$16(TroopAvatarWallPreviewActivity paramTroopAvatarWallPreviewActivity, URLDrawable paramURLDrawable, ActionSheet paramActionSheet) {}
    ...
    try
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject2))
      {
        ...
        if ((localObject1 != null) && (((ScannerResult)localObject1).h()))
        {
          ...
          this.this$0.runOnUiThread(new TroopAvatarWallPreviewActivity.16.1(this));
        }
      }
