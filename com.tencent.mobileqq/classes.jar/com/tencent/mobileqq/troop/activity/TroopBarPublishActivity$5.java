...
class TroopBarPublishActivity$5
  implements BusinessObserver
{
  TroopBarPublishActivity$5(TroopBarPublishActivity paramTroopBarPublishActivity) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (paramBoolean)
    {
      ...
      paramBundle = "0";
      TroopBarUtils.a("pub_page", "fail", paramBundle, "4", TroopBarPublishActivity.b(this.a), "");
    ...
    {
      ReportController.b(null, "P_CliOper", "Grp_tribe", "", "pub_page", "suc", paramInt, 0, paramBundle, this.a.jdField_b_of_type_JavaLangString, localStringBuffer.toString(), "");
      this.a.e = true;
      ...
      for (;;)
      {
        ...
        if ((this.a.jdField_a_of_type_ComTencentMobileqqTribeViewTribeTitlePrefixPanelView$TitlePrefixItem != null) && (!TroopBarPublishActivity.a(this.a).equals("###...^_^###"))) {
          ReportController.b(null, "dc00899", "Grp_tribe", "", "pub_page", "sus_prefixpub", 0, 0, this.a.q, "", "", "");
        }
 ...
 * Qualified Name:     com.tencent.mobileqq.troop.activity.TroopBarPublishActivity.5
