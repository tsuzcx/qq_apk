  ...
  implements View.OnClickListener
{
  ...
  {
    this.jdField_a_of_type_AndroidOsHandler = new bevh(this);
  }
  ...
  {
    this.jdField_a_of_type_AndroidViewView = paramLayoutInflater.inflate(2131559958, null);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = getActivity().app;
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131376947));
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131363050));
    a(getResources(), this.jdField_a_of_type_AndroidWidgetRelativeLayout);
    this.jdField_a_of_type_ComTencentMobileqqActivityAioAudiopanelCommonRecordSoundPanel = ((CommonRecordSoundPanel)paramLayoutInflater.inflate(2131559902, null));
    ...
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131379325);
    this.jdField_b_of_type_AndroidViewView.setOnClickListener(this);
    paramLayoutInflater = AnimationUtils.loadAnimation(getActivity(), 2130771979);
    paramLayoutInflater.setAnimationListener(new bevg(this));
