  ...
  extends IphoneTitleBarActivity
{
  ...
  public TroopAdminList()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppFriendListObserver = new aigu(this);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new aiha(this);
  }
  
  protected void a()
  {
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    ThreadManager.post(new aigv(this), 8, null, true);
  }
  ...
  protected void b()
  {
    View localView = View.inflate(this, 2130969835, null);
  ...
  public void c()
  {
    ...
    {
      ThreadManager.post(new aigx(this), 8, null, true);
      return;
    }
