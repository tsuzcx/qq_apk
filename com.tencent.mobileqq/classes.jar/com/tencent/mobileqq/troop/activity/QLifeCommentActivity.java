  ...
  extends TroopBarPublishActivity
{
  ...
  private void a(double paramDouble1, double paramDouble2)
  {
    ...
    new bcgp("http://s.p.qq.com/cgi-bin/coupon_q/shop/shop_list.fcg?cid=" + this.v + "&maplat=" + paramDouble1 + "&maplng=" + paramDouble2 + "&coordinate=1", "", this, 1002, null).a(localHashMap);
  }
  ...
  protected void a()
  {
    ...
    this.jdField_e_of_type_AndroidViewView = ((ViewStub)findViewById(2131379943)).inflate();
    this.d = ((TextView)findViewById(2131379003));
    this.jdField_e_of_type_AndroidViewView.setOnClickListener(this);
    this.jdField_f_of_type_AndroidViewView = findViewById(2131369241);
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131379004));
    this.jdField_f_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131379003));
    if (TextUtils.isEmpty(this.A)) {
      this.jdField_f_of_type_AndroidWidgetTextView.setHint(2131696657);
    }
    for (;;)
    {
      ...
      if ((!TextUtils.isEmpty(this.v)) && (this.jdField_g_of_type_Boolean)) {
        SosoInterface.a(new bbcd(this, 0, true, true, 0L, false, false, "QLifeCommentActivity"));
      }
      return;
    ...
    do
    {
      ...
      case 1001: 
        ...
        if (paramInt == 0)
        {
          ...
          finish();
          QQToast.a(this, 2, 2131696727, 1).b(getTitleBarHeight());
          azmj.b(null, "P_CliOper", "Pb_account_lifeservice", "", "qlife_comment", "success", 0, 0, paramJSONObject.optString("comment_id"), this.w, this.jdField_a_of_type_JavaUtilArrayList.size() + "", this.z);
        }
        for (;;)
        {
          this.o = false;
          ...
          if (TextUtils.isEmpty(paramBundle)) {
            paramJSONObject = getString(2131696745, new Object[] { Integer.valueOf(paramInt) });
          }
          ...
          azmj.b(null, "P_CliOper", "Pb_account_lifeservice", "", "qlife_comment", "fail", 0, 0, "", this.w, this.jdField_a_of_type_JavaUtilArrayList.size() + "", this.z);
        }
      }
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    azmj.b(null, "P_CliOper", "Pb_account_lifeservice", "", "qlife_comment", "write", 0, 0, "", "", "", this.z);
    azmj.b(null, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "qlife.activity.show", 0, 0, "", "", "", "");
    return true;
  }
  ...
  public void l()
  {
    ...
    try
    {
      ...
      do
      {
        ...
        if (TextUtils.isEmpty(this.u))
        {
          if (TextUtils.isEmpty(this.B)) {
            QQToast.a(this, 2131696658, 1).b(getTitleBarHeight());
          }
          for (;;)
          {
            o();
        ...
        localObject1 = bcht.a(this.jdField_b_of_type_ComTencentMobileqqTribeViewTEditText);
        ...
        {
          QQToast.a(this, getString(2131696712, new Object[] { Integer.valueOf(this.jdField_f_of_type_Int) }), 0).b(getTitleBarHeight());
          return;
        }
      ...
      while (i < this.jdField_a_of_type_JavaUtilArrayList.size())
      {
        ...
        if ((TroopBarPublishActivity.Pic_list)bcht.a.get(localObject2) == null)
        {
      ...
      if (!this.jdField_a_of_type_JavaUtilArrayList.isEmpty())
      {
        ...
        while (i < localArrayList.size())
        {
          ...
          localObject3 = (TroopBarPublishActivity.Pic_list)bcht.a.get(localObject3);
      ...
      ((Bundle)localObject2).putString("version", "8.3.3");
      ...
      new bcgp("http://s.p.qq.com/cgi-bin/coupon_q/social/comment.fcg?", "", this, 1001, null).a((HashMap)localObject1);
      return;
    }
  ...
  public boolean onBackEvent()
  {
    ...
    {
      a(this);
      azmj.b(null, "P_CliOper", "Pb_account_lifeservice", "", "qlife_comment", "cancel", 0, 0, "", "", "", this.z);
      return true;
    }
    Object localObject = getString(2131720796);
    String str = getString(2131696656);
    localObject = bdcd.a(this, 230).setTitle((String)localObject).setMessage(str);
    ((bdfq)localObject).setPositiveButton(getString(2131721490), new bbce(this, (bdfq)localObject));
    ((bdfq)localObject).setNegativeButton(getString(2131694804), new bbcf(this, (bdfq)localObject));
    ((bdfq)localObject).setPositiveButtonContentDescription(getString(2131721490));
    ((bdfq)localObject).setNegativeButtonContentDescription(getString(2131721490));
