  ...
  extends TroopBarPublishActivity
{
  ...
  private void a(double paramDouble1, double paramDouble2)
  {
    ...
    new baid("http://s.p.qq.com/cgi-bin/coupon_q/shop/shop_list.fcg?cid=" + this.v + "&maplat=" + paramDouble1 + "&maplng=" + paramDouble2 + "&coordinate=1", "", this, 1002, null).a(localHashMap);
  }
  ...
  protected void a()
  {
    ...
    this.jdField_e_of_type_AndroidViewView = ((ViewStub)findViewById(2131379242)).inflate();
    this.d = ((TextView)findViewById(2131378395));
    this.jdField_e_of_type_AndroidViewView.setOnClickListener(this);
    this.jdField_f_of_type_AndroidViewView = findViewById(2131369011);
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131378396));
    this.jdField_f_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131378395));
    if (TextUtils.isEmpty(this.A)) {
      this.jdField_f_of_type_AndroidWidgetTextView.setHint(2131696482);
    }
    for (;;)
    {
      ...
      if ((!TextUtils.isEmpty(this.v)) && (this.jdField_g_of_type_Boolean)) {
        SosoInterface.a(new azee(this, 0, true, true, 0L, false, false, "QLifeCommentActivity"));
      }
      return;
    ...
    do
    {
      ...
      case 1001: 
        ...
        if (paramInt == 0)
        {
          ...
          finish();
          bcql.a(this, 2, 2131696552, 1).b(getTitleBarHeight());
          axqy.b(null, "P_CliOper", "Pb_account_lifeservice", "", "qlife_comment", "success", 0, 0, paramJSONObject.optString("comment_id"), this.w, this.jdField_a_of_type_JavaUtilArrayList.size() + "", this.z);
        }
        for (;;)
        {
          this.o = false;
          ...
          if (TextUtils.isEmpty(paramBundle)) {
            paramJSONObject = getString(2131696570, new Object[] { Integer.valueOf(paramInt) });
          }
          bcql.a(this, 1, paramJSONObject, 0).b(getTitleBarHeight());
          c(false);
          ...
          axqy.b(null, "P_CliOper", "Pb_account_lifeservice", "", "qlife_comment", "fail", 0, 0, "", this.w, this.jdField_a_of_type_JavaUtilArrayList.size() + "", this.z);
        }
      }
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    axqy.b(null, "P_CliOper", "Pb_account_lifeservice", "", "qlife_comment", "write", 0, 0, "", "", "", this.z);
    axqy.b(null, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "qlife.activity.show", 0, 0, "", "", "", "");
    return true;
  }
  ...
  public void l()
  {
    ...
    try
    {
      ...
      do
      {
        ...
        if (TextUtils.isEmpty(this.u))
        {
          if (TextUtils.isEmpty(this.B)) {
            bcql.a(this, 2131696483, 1).b(getTitleBarHeight());
          }
          for (;;)
          {
            o();
            return;
            bcql.a(this, this.B, 1).b(getTitleBarHeight());
          }
        }
        localObject1 = bajf.a(this.jdField_b_of_type_ComTencentMobileqqTribeViewTEditText);
        ...
        {
          bcql.a(this, getString(2131696537, new Object[] { Integer.valueOf(this.jdField_f_of_type_Int) }), 0).b(getTitleBarHeight());
          return;
        }
      ...
      while (i < this.jdField_a_of_type_JavaUtilArrayList.size())
      {
        ...
        if ((TroopBarPublishActivity.Pic_list)bajf.a.get(localObject2) == null)
        {
      ...
      if (!this.jdField_a_of_type_JavaUtilArrayList.isEmpty())
      {
        ...
        while (i < localArrayList.size())
        {
          ...
          localObject3 = (TroopBarPublishActivity.Pic_list)bajf.a.get(localObject3);
      ...
      ((Bundle)localObject2).putString("version", "8.3.0");
      ...
      new baid("http://s.p.qq.com/cgi-bin/coupon_q/social/comment.fcg?", "", this, 1001, null).a((HashMap)localObject1);
      return;
    }
  ...
  public boolean onBackEvent()
  {
    ...
    {
      a(this);
      axqy.b(null, "P_CliOper", "Pb_account_lifeservice", "", "qlife_comment", "cancel", 0, 0, "", "", "", this.z);
      return true;
    }
    Object localObject = getString(2131720260);
    String str = getString(2131696481);
    localObject = bbdj.a(this, 230).setTitle((String)localObject).setMessage(str);
    ((bbgu)localObject).setPositiveButton(getString(2131720929), new azef(this, (bbgu)localObject));
    ((bbgu)localObject).setNegativeButton(getString(2131694648), new azeg(this, (bbgu)localObject));
    ((bbgu)localObject).setPositiveButtonContentDescription(getString(2131720929));
    ((bbgu)localObject).setNegativeButtonContentDescription(getString(2131720929));
