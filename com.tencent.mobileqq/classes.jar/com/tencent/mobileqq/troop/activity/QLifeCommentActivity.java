  ...
  extends TroopBarPublishActivity
{
  ...
  private void a(double paramDouble1, double paramDouble2)
  {
    ...
    new bahp("http://s.p.qq.com/cgi-bin/coupon_q/shop/shop_list.fcg?cid=" + this.v + "&maplat=" + paramDouble1 + "&maplng=" + paramDouble2 + "&coordinate=1", "", this, 1002, null).a(localHashMap);
  }
  ...
  protected void a()
  {
    ...
    this.jdField_e_of_type_AndroidViewView = ((ViewStub)findViewById(2131379237)).inflate();
    this.d = ((TextView)findViewById(2131378390));
    this.jdField_e_of_type_AndroidViewView.setOnClickListener(this);
    this.jdField_f_of_type_AndroidViewView = findViewById(2131369011);
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131378391));
    this.jdField_f_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131378390));
    if (TextUtils.isEmpty(this.A)) {
      this.jdField_f_of_type_AndroidWidgetTextView.setHint(2131696481);
    }
    for (;;)
    {
    ...
    do
    {
      ...
      case 1001: 
        ...
        if (paramInt == 0)
        {
          ...
          finish();
          bcpw.a(this, 2, 2131696551, 1).b(getTitleBarHeight());
          axqw.b(null, "P_CliOper", "Pb_account_lifeservice", "", "qlife_comment", "success", 0, 0, paramJSONObject.optString("comment_id"), this.w, this.jdField_a_of_type_JavaUtilArrayList.size() + "", this.z);
        }
        for (;;)
        {
          this.o = false;
          ...
          if (TextUtils.isEmpty(paramBundle)) {
            paramJSONObject = getString(2131696569, new Object[] { Integer.valueOf(paramInt) });
          }
          bcpw.a(this, 1, paramJSONObject, 0).b(getTitleBarHeight());
          c(false);
          ...
          axqw.b(null, "P_CliOper", "Pb_account_lifeservice", "", "qlife_comment", "fail", 0, 0, "", this.w, this.jdField_a_of_type_JavaUtilArrayList.size() + "", this.z);
        }
      }
  ...
  public void l()
  {
    ...
    try
    {
      ...
      do
      {
        ...
        if (TextUtils.isEmpty(this.u))
        {
          if (TextUtils.isEmpty(this.B)) {
            bcpw.a(this, 2131696482, 1).b(getTitleBarHeight());
          }
          for (;;)
          {
            o();
            return;
            bcpw.a(this, this.B, 1).b(getTitleBarHeight());
          }
        }
        localObject1 = bair.a(this.jdField_b_of_type_ComTencentMobileqqTribeViewTEditText);
        ...
        {
          bcpw.a(this, getString(2131696536, new Object[] { Integer.valueOf(this.jdField_f_of_type_Int) }), 0).b(getTitleBarHeight());
          return;
        }
      ...
      while (i < this.jdField_a_of_type_JavaUtilArrayList.size())
      {
        ...
        if ((TroopBarPublishActivity.Pic_list)bair.a.get(localObject2) == null)
        {
      ...
      if (!this.jdField_a_of_type_JavaUtilArrayList.isEmpty())
      {
        ...
        while (i < localArrayList.size())
        {
          ...
          localObject3 = (TroopBarPublishActivity.Pic_list)bair.a.get(localObject3);
      ...
      ((Bundle)localObject2).putString("version", "8.2.8");
      ...
      new bahp("http://s.p.qq.com/cgi-bin/coupon_q/social/comment.fcg?", "", this, 1001, null).a((HashMap)localObject1);
      return;
    }
  ...
  public boolean onBackEvent()
  {
    ...
    Object localObject = getString(2131720249);
    String str = getString(2131696480);
    localObject = bbcv.a(this, 230).setTitle((String)localObject).setMessage(str);
    ((bbgg)localObject).setPositiveButton(getString(2131720918), new azed(this, (bbgg)localObject));
    ((bbgg)localObject).setNegativeButton(getString(2131694647), new azee(this, (bbgg)localObject));
    ((bbgg)localObject).setPositiveButtonContentDescription(getString(2131720918));
    ((bbgg)localObject).setNegativeButtonContentDescription(getString(2131720918));
