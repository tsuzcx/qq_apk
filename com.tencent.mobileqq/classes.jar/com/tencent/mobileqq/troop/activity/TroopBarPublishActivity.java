  ...
  implements TextWatcher
{
  ...
  public String J = "    ";
  protected String K;
  Animation.AnimationListener jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener = new aygf(this);
  public axzw a;
  public ayab a;
  ...
  private Handler jdField_b_of_type_AndroidOsHandler = new ayfr(this);
  ...
  private List<aycg> jdField_b_of_type_JavaUtilList;
  ...
  public TroopBarPublishActivity()
  {
    ...
    this.jdField_c_of_type_AndroidOsHandler = new aygc(this);
  }
  ...
  {
    awje.jdField_r_of_type_Int = 2000000;
    String str1 = paramString + ".doodle.mp4";
    String str2 = paramString + ".tmp.mp4";
    Object localObject = new bjgu(awje.jdField_r_of_type_Int, this.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry);
    ((bjgu)localObject).b(2);
    int i = new bjgs().a(paramString, str1, (bjgu)localObject, this.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry);
    if (i != 0)
    {
      if (i == -1) {
        vlm.c(paramString, str1);
      }
    }
    else
    {
      if (QLog.isColorLevel()) {
        QLog.i("tribe_publish_TroopBarPublishActivity", 1, "onCompositeFinish step 1 timeCost:" + (SystemClock.uptimeMillis() - paramLong) + "ms bitrate:" + awje.jdField_r_of_type_Int);
      }
      paramString = new MediaMetadataRetriever();
      paramString.setDataSource(str1);
      localObject = paramString.getFrameAtTime();
      this.jdField_a_of_type_Ayab.jdField_b_of_type_Int = ((Bitmap)localObject).getWidth();
      this.jdField_a_of_type_Ayab.c = ((Bitmap)localObject).getHeight();
      paramString.release();
    ...
    if (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.backgroundMusicPath))
    {
      ...
      {
        if (this.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoRangeEnd == 0) {}
        for (i = vol.a(str1, paramString, str2, 0);; i = vol.a(str1, paramString, str2, 0, this.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoRangeStart, this.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoRangeEnd))
        {
          vlm.f(str1);
          if ((i != 0) && (i != -8)) {
            break;
    ...
    new sjj().a(this.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry, str1, str2, true, new ayfw(this, str1, paramLong, str2));
  }
  ...
  private void v()
  {
    ...
    label169:
    for (int i = 2130841977;; i = 2130841978)
    {
      ...
      if (!TextUtils.isEmpty(this.G)) {
        ((SpannableString)localObject).setSpan(new vrc(this, i), 0, 1, 33);
      }
  ...
  private void w()
  {
    ...
    this.jdField_b_of_type_ComTencentMobileqqTribeViewTEditText.addTextChangedListener(new aygk(this));
    this.jdField_b_of_type_ComTencentMobileqqTribeViewTEditText.setOnSelectionChangedListener(new ayfs(this));
    if (this.jdField_u_of_type_Int == 700) {
      this.G = "";
    }
    d(false);
    if ((this.jdField_t_of_type_Boolean) && (!TextUtils.isEmpty(this.G)) && (!baig.b(this, this.app.getCurrentAccountUin(), "tribe_video_post_has_show_tips", false))) {
  ...
  private void x()
  {
    ...
    awqx.b(null, "dc00899", "Grp_tribe", "", "pub_page", "exp_prefix", 0, 0, this.jdField_q_of_type_JavaLangString, "", "", "");
    this.jdField_a_of_type_Aycg = ((aycg)this.jdField_b_of_type_JavaUtilList.get(0));
    this.jdField_a_of_type_Aycb = new aycb(this, this.jdField_a_of_type_AndroidWidgetListView);
    this.jdField_a_of_type_Aycb.a(new aygl(this, null));
    this.jdField_a_of_type_Axzw = new axzw(this.jdField_a_of_type_AndroidWidgetListView, this.jdField_a_of_type_Aycb, this.jdField_b_of_type_JavaUtilList);
    this.jdField_a_of_type_AndroidWidgetEditText.setEnabled(false);
    if (!TextUtils.isEmpty(this.jdField_a_of_type_Aycg.jdField_b_of_type_JavaLangString)) {
      this.jdField_a_of_type_ComTencentMobileqqTribeViewTEditText.setMovementMethod(LinkMovementMethod.getInstance());
    }
    this.jdField_a_of_type_ComTencentMobileqqTribeViewTEditText.addTextChangedListener(new ayft(this));
    this.jdField_a_of_type_ComTencentMobileqqTribeViewTEditText.setOnSelectionChangedListener(new ayfu(this));
    e(false);
  ...
  private void y()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqTribeViewTEditText == null) || (this.jdField_a_of_type_AndroidWidgetEditText == null) || (this.jdField_a_of_type_Aycg == null)) {
      return;
    }
    if (this.jdField_a_of_type_Aycg != null) {}
    for (int i = this.jdField_a_of_type_Aycg.jdField_b_of_type_JavaLangString.length() + this.jdField_a_of_type_Aycg.jdField_c_of_type_JavaLangString.length() + this.jdField_a_of_type_Aycg.jdField_a_of_type_JavaLangString.length();; i = 0)
    {
      int k = this.jdField_a_of_type_ComTencentMobileqqTribeViewTEditText.getText().length();
      SpannableString localSpannableString;
      if ((this.jdField_a_of_type_Aycg == null) || (TextUtils.isEmpty(this.jdField_a_of_type_Aycg.jdField_b_of_type_JavaLangString)))
      {
        j = 0;
        if (k > j) {
          break label330;
        ...
        if ((this.jdField_b_of_type_JavaUtilList != null) && (this.jdField_b_of_type_JavaUtilList.size() > 1)) {
          if ((this.jdField_a_of_type_Axzw == null) || (!this.jdField_a_of_type_Axzw.b())) {
            break label323;
          }
        }
      }
      label282:
      label323:
      for (int j = 2130841975;; j = 2130841976)
      {
        if ((this.jdField_a_of_type_Aycg != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_Aycg.jdField_b_of_type_JavaLangString))) {
          localSpannableString.setSpan(new vrc(this, j), i + 1, i + 2, 33);
        }
  ...
  {
    super.a();
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131306846));
    this.jdField_o_of_type_Boolean = b();
    if (this.jdField_b_of_type_AndroidWidgetTextView != null) {
      this.jdField_b_of_type_AndroidWidgetTextView.setTag(2131306988, this.jdField_b_of_type_AndroidWidgetTextView);
    }
    r();
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarMyBar != null)
    {
      ...
      if ((!"barindex".equals(this.jdField_a_of_type_JavaLangString)) && (this.jdField_d_of_type_Int == 1))
      {
        ...
        azho.b(this, (Bundle)localObject, "https://buluo.qq.com/cgi-bin/bar/bar_publish_info", 8, null, this);
      }
      ...
      this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131307043));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131307042));
      this.g = ((TextView)findViewById(2131307041));
      a(getIntent());
      if (this.jdField_a_of_type_Ayab != null)
      {
        b(getIntent());
      ...
      localObject = "0";
      label420:
      awqx.b(null, "P_CliOper", "Grp_tribe", "", "pub_page", "exp", i, 0, (String)localObject, this.jdField_b_of_type_JavaLangString, localStringBuffer.toString(), "");
      if (this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarMyBar != null) {
        break label538;
      }
    }
    ...
    {
      azho.a("pub_page", "choose_place", (String)localObject, "0", "", "");
      return;
      this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
      break;
      label491:
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if ((paramInt1 >= 0) && (paramInt1 < this.jdField_a_of_type_JavaUtilArrayList.size()))
    {
      if (this.jdField_a_of_type_JavaUtilArrayList.size() == 1)
      {
        ...
        localObject = this.jdField_a_of_type_Ayfp;
        if (this.jdField_a_of_type_JavaUtilArrayList.size() < paramInt2) {
          bool = true;
        }
        ((ayfp)localObject).a(bool, true);
        this.jdField_a_of_type_Ayfp.a(this.jdField_a_of_type_JavaUtilArrayList);
      }
    }
    else {
      if (this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarMyBar != null) {
    ...
    for (Object localObject = "0";; localObject = this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarMyBar.jdField_c_of_type_JavaLangString)
    {
      azho.a("pub_page", "del_photo", (String)localObject, "", "", "");
      return;
  ...
  protected void a(Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        Bitmap localBitmap = bacm.a(this.jdField_t_of_type_JavaLangString, null);
        int i = localBitmap.getWidth();
        int j = localBitmap.getHeight();
        localLayoutParams = (LinearLayout.LayoutParams)this.jdField_b_of_type_AndroidWidgetRelativeLayout.getLayoutParams();
        if (i > j)
        {
          localLayoutParams.width = azvv.a(this, 216.0F);
          localLayoutParams.height = azvv.a(this, 130.0F);
          ...
          this.jdField_b_of_type_AndroidWidgetImageView.setOnClickListener(new aygb(this));
          this.jdField_a_of_type_Ayab = new ayab();
          this.jdField_a_of_type_Ayab.jdField_e_of_type_JavaLangString = str2;
          this.jdField_a_of_type_Ayab.a(paramIntent.getIntExtra("captureMode", 0));
          a(str1, this.I);
          return;
        }
      }
      ...
      localLayoutParams.width = azvv.a(this, 130.0F);
      localLayoutParams.height = azvv.a(this, 216.0F);
    }
  }
  
  public void a(View paramView, int paramInt, long paramLong)
  {
    if (this.jdField_a_of_type_Ayfp.a(paramInt))
    {
    ...
    paramView.putExtra("back_btn_text", this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131631798));
    ...
    {
      awqx.b(null, "P_CliOper", "Grp_tribe", "", "pub_page", "choose_photo", paramInt, 0, paramView, "", "", "");
      return;
      paramInt = 1;
      break;
    }
  ...
  void a(JSONObject paramJSONObject)
  {
    ...
    //   202: invokestatic 1117	axzw:a	(Lorg/json/JSONArray;)Ljava/util/List;
  ...
  public void a(JSONObject paramJSONObject, int paramInt, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.jdField_m_of_type_JavaLangString = paramBundle.optString("forbiddenMsg", getString(2131631797));
      }
  ...
  public void afterTextChanged(Editable paramEditable)
  {
    ...
    String str = azho.a(this.jdField_b_of_type_ComTencentMobileqqTribeViewTEditText);
    int j;
    if (str == null)
    {
      i = 0;
      ...
      {
        bbmy.a(this, this.jdField_s_of_type_JavaLangString, 0).b(getTitleBarHeight());
  ...
  public void b(String paramString, boolean paramBoolean)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      localObject = new ayby();
      ((ayby)localObject).jdField_a_of_type_JavaLangString = paramString;
      if (this.jdField_a_of_type_ComTencentMobileqqTribeVideouploadTribeVideoUploadTask == null)
      {
        this.jdField_a_of_type_ComTencentMobileqqTribeVideouploadTribeVideoUploadTask = new TribeVideoUploadTask(this, this.jdField_c_of_type_AndroidOsHandler, (ayby)localObject);
  ...
  protected void b(JSONObject paramJSONObject)
  {
    ...
    baiz.a(this.app, "share_ask", paramJSONObject.optString("bid"));
    ...
    this.jdField_c_of_type_JavaLangString = getString(2131630843, new Object[] { Integer.valueOf(this.jdField_a_of_type_Int), Integer.valueOf(this.jdField_b_of_type_Int) });
    this.jdField_e_of_type_Int = 10;
    this.f = 700;
    this.jdField_j_of_type_JavaLangString = getString(2131630827, new Object[] { Integer.valueOf(this.jdField_e_of_type_Int), Integer.valueOf(this.f) });
    this.jdField_i_of_type_Int |= 0x1;
  }
  ...
  public void d(int paramInt)
  {
    ...
    label174:
    Object localObject1 = new TranslateAnimation(0.0F, 0.0F, 0.0F, -this.jdField_a_of_type_Ayfp.a());
  ...
  public void d(boolean paramBoolean)
  {
    ...
    if (this.jdField_t_of_type_Int == -1)
    {
      ...
      if (!TextUtils.isEmpty(this.G)) {
        ((SpannableString)localObject1).setSpan(new vrc(this, j), 0, 1, 33);
      }
      ((SpannableString)localObject1).setSpan(new aygi(this, i), 0, this.G.length(), 33);
  ...
  public void doOnActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    do
    {
      ...
      case 1002: 
        ...
        {
          azho.a("pub_page", "choose_place", paramIntent, "2", "", "");
          return;
      ...
      case 1004: 
        ...
        while ((this.jdField_b_of_type_AndroidWidgetTextView != null) && (this.jdField_a_of_type_AndroidWidgetLinearLayout != null))
        {
          ...
          paramInt2 = azvv.a(this, 20.0F);
          int i = azvv.a(this, 10.0F);
          int j = azvv.a(this, 6.0F);
          paramInt1 = 0;
          for (;;)
          {
            for (;;)
            {
              ...
              ((TextView)localObject2).setBackgroundResource(2130842893);
              ...
              ((TextView)localObject2).setTag(2131306988, localObject1);
        ...
        while (this.jdField_a_of_type_Ayab == null)
        {
  ...
  public void e(boolean paramBoolean)
  {
    ...
    localObject1 = new SpannableStringBuilder(this.jdField_a_of_type_Aycg.jdField_a_of_type_JavaLangString).append(this.jdField_a_of_type_Aycg.jdField_b_of_type_JavaLangString).append(this.jdField_a_of_type_Aycg.jdField_c_of_type_JavaLangString);
    if (!TextUtils.isEmpty(this.jdField_a_of_type_Aycg.jdField_b_of_type_JavaLangString)) {
      ((SpannableStringBuilder)localObject1).append(this.J);
    }
    ((SpannableStringBuilder)localObject1).append(localObject2);
    localObject1 = new SpannableString((CharSequence)localObject1);
    int i = this.jdField_a_of_type_Aycg.jdField_a_of_type_JavaLangString.length();
    int j = this.jdField_a_of_type_Aycg.jdField_b_of_type_JavaLangString.length();
    j = this.jdField_a_of_type_Aycg.jdField_c_of_type_JavaLangString.length() + (i + j);
    ...
    label418:
    for (i = 2130841975;; i = 2130841976)
    {
      if (!TextUtils.isEmpty(this.jdField_a_of_type_Aycg.jdField_b_of_type_JavaLangString)) {
        ((SpannableString)localObject1).setSpan(new vrc(this, i), j + 1, j + 2, 33);
      }
      ((SpannableString)localObject1).setSpan(new aygj(this), 0, j + this.J.length() - 1, 33);
  ...
  public void finish()
  {
    ...
    if ((!this.jdField_e_of_type_Boolean) && (this.jdField_d_of_type_Boolean) && (this.jdField_a_of_type_OrgJsonJSONObject != null)) {
      baiz.a(this, this.jdField_a_of_type_OrgJsonJSONObject.optLong("share_app_id"));
    }
    String str1;
  ...
  public void l()
  {
    ...
    try
    {
      ...
      if (!c())
      {
        ...
        {
          i = 1;
          awqx.b(null, "dc00899", "Grp_tribe", "", "post", "Clk_post ", i, 0, b(), "", "", "");
        }
      }
      else
      {
        ...
        if (!this.g.getText().toString().equals(ajjy.a(2131649456))) {
          break label115;
        }
        t();
      }
      ...
      do
      {
        ...
        {
          bbmy.a(this, 2131630834, 1).b(getTitleBarHeight());
          if (this.jdField_b_of_type_AndroidWidgetTextView != null)
          {
            this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(Color.parseColor("#FF725A"));
            localObject1 = getResources().getDrawable(2130842896);
          ...
          {
            azho.a("pub_page", "fail", (String)localObject1, "8", b(), "");
            return;
          }
        }
        if (this.jdField_h_of_type_Boolean)
        {
          localObject1 = azho.a(this.jdField_a_of_type_ComTencentMobileqqTribeViewTEditText);
          if (TextUtils.isEmpty((CharSequence)localObject1)) {
            break label2031;
          }
          ...
          if (this.jdField_a_of_type_Aycg != null)
          {
            i = k;
            localObject1 = localObject2;
            if (k > this.J.length() + this.jdField_a_of_type_Aycg.jdField_c_of_type_JavaLangString.length() + this.jdField_a_of_type_Aycg.jdField_b_of_type_JavaLangString.length() + this.jdField_a_of_type_Aycg.jdField_a_of_type_JavaLangString.length())
            {
              i = k - this.J.length();
              localObject1 = localObject2;
            }
          ...
          {
            bbmy.a(this, getString(2131630840, new Object[] { Integer.valueOf(this.jdField_a_of_type_Int) }), 0).b(getTitleBarHeight());
            if (this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarMyBar == null) {}
            for (localObject1 = "0";; localObject1 = this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarMyBar.jdField_c_of_type_JavaLangString)
            {
              azho.a("pub_page", "fail", (String)localObject1, "0", b(), "");
              return;
            }
          }
          if (i > this.jdField_b_of_type_Int)
          {
            bbmy.a(this, getString(2131630841, new Object[] { Integer.valueOf(this.jdField_b_of_type_Int) }), 0).b(getTitleBarHeight());
            if (this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarMyBar == null) {}
            for (localObject1 = "0";; localObject1 = this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarMyBar.jdField_c_of_type_JavaLangString)
            {
              azho.a("pub_page", "fail", (String)localObject1, "1", b(), "");
              return;
            }
          }
        }
        else
        {
          ...
          {
            bbmy.a(this, 2131630825, 0).b(getTitleBarHeight());
            if (this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarMyBar == null) {}
            for (localObject1 = "0";; localObject1 = this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarMyBar.jdField_c_of_type_JavaLangString)
            {
              azho.a("pub_page", "fail", (String)localObject1, "35", b(), "");
              return;
            }
          }
          localObject1 = null;
        }
        localObject3 = azho.a(this.jdField_b_of_type_ComTencentMobileqqTribeViewTEditText);
        ...
        if ((!this.jdField_k_of_type_Boolean) || (this.jdField_a_of_type_JavaUtilArrayList.isEmpty()))
        {
          if (i < this.jdField_e_of_type_Int)
          {
            ...
            for (localObject1 = "0";; localObject1 = this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarMyBar.jdField_c_of_type_JavaLangString)
            {
              azho.a("pub_page", "fail", (String)localObject1, "2", b(), "");
              return;
            }
          }
          if (i > this.f)
          {
            bbmy.a(this, getString(2131630824, new Object[] { Integer.valueOf(this.f) }), 0).b(getTitleBarHeight());
            if (this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarMyBar == null) {}
            for (localObject1 = "0";; localObject1 = this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarMyBar.jdField_c_of_type_JavaLangString)
            {
              azho.a("pub_page", "fail", (String)localObject1, "4", b(), "");
              return;
            }
          }
        }
      ...
      {
        bbmy.a(this, 2131630836, 0).b(getTitleBarHeight());
        if (this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarMyBar == null) {}
        for (localObject1 = "0";; localObject1 = this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarMyBar.jdField_c_of_type_JavaLangString)
        {
          azho.a("pub_page", "fail", (String)localObject1, "9", b(), "");
          return;
        }
      }
      if (!mpl.a(this))
      {
        ...
        for (localObject1 = "0";; localObject1 = this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarMyBar.jdField_c_of_type_JavaLangString)
        {
          azho.a("pub_page", "fail", (String)localObject1, "7", b(), "");
          return;
        }
      }
      ...
      {
        p();
        azhe.a("pub_page_new", "auto_choose_tribe", 0, 0, new String[] { "" });
        return;
      }
      if (this.jdField_s_of_type_Boolean)
      {
        bbmy.a(this, ajjy.a(2131649451), 0).a();
        return;
      }
      c(true);
      this.rightViewText.setEnabled(false);
      ...
      while (i < this.jdField_a_of_type_JavaUtilArrayList.size())
      {
        ...
        if ((TroopBarPublishActivity.Pic_list)azho.a.get(localObject3) == null)
        {
          a(1, this.jdField_a_of_type_AndroidOsHandler);
          if (this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarMyBar == null) {}
          for (localObject1 = "0";; localObject1 = this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarMyBar.jdField_c_of_type_JavaLangString)
          {
            azho.a("pub_page", "fail", (String)localObject1, "10", b(), "");
            return;
          }
        }
        i += 1;
      }
      if ((this.jdField_a_of_type_Ayab != null) && (TextUtils.isEmpty(this.jdField_a_of_type_Ayab.d)))
      {
        a(this.jdField_t_of_type_JavaLangString, false);
        return;
      }
      if ((!TextUtils.isEmpty(this.H)) && (this.jdField_a_of_type_Ayab != null) && (TextUtils.isEmpty(this.jdField_a_of_type_Ayab.jdField_a_of_type_JavaLangString)))
      {
        b(this.H, false);
        return;
      }
      Object localObject3 = TroopBarPublishUtils.a((String)localObject2, this.jdField_a_of_type_JavaUtilArrayList, this.jdField_a_of_type_ComTencentMobileqqTroopDataAudioInfo, this.jdField_a_of_type_Ayab);
      ...
      for (;;)
      {
        try
        {
          ...
          if (this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarMyBar == null)
          {
            ...
            if (this.jdField_a_of_type_Aycg != null)
            {
              if (a(this.jdField_a_of_type_Aycg, this.J) == null) {
                break label2036;
              }
              localObject1 = this.jdField_a_of_type_Aycg.jdField_a_of_type_JavaLangString + this.jdField_a_of_type_Aycg.jdField_b_of_type_JavaLangString + this.jdField_a_of_type_Aycg.jdField_c_of_type_JavaLangString + a(this.jdField_a_of_type_Aycg, this.J);
            }
            ...
            ((JSONObject)localObject2).put("version", "8.2.6.4370");
            if ((this.jdField_b_of_type_AndroidWidgetTextView == null) || (this.jdField_b_of_type_AndroidWidgetTextView.getVisibility() != 0)) {
              break label2049;
            }
            i = j;
      ...
      for (i = 0;; i = this.jdField_t_of_type_Int)
      {
        ...
        localNewIntent.setObserver(new aygg(this));
  ...
  protected void o()
  {
    ...
    {
      azho.a("pub_page", "choose_tribe", str1, str2, "", "");
      return;
  ...
  public boolean onBackEvent()
  {
    if (this.jdField_a_of_type_Ayab != null)
    {
      babr.a(this, 230, ajjy.a(2131649446), ajjy.a(2131649459), ajjy.a(2131649442), ajjy.a(2131649430), new aygd(this), new ayge(this)).show();
      return true;
    }
  ...
  {
    if (paramView.getTag(2131306988) != null)
    {
      p();
      return;
    }
    ...
    {
      awqx.b(null, "P_CliOper", "Grp_tribe", "", "pub_page", "Clk_place", i, 0, paramView, str, "", "");
      return;
      i = 1;
      break;
  ...
  public void t()
  {
    babr.a(this, 230, null, ajjy.a(2131649443), ajjy.a(2131649438), ajjy.a(2131649427), new ayfz(this), new ayga(this)).show();
  }
  ...
  public void u()
  {
    ...
    for (int i = 1;; i = 2)
    {
      if (localTribeVideoPublishParams.combo0Info != null) {
        awqx.b(this.app, "dc00899", "Grp_tribe", "", "video_shoot", "pub_packages", i, 0, localTribeVideoPublishParams.combo0Info.id, localTribeVideoPublishParams.combo0Info.type, "", "");
      }
      if ((localTribeVideoPublishParams.changeFace != null) && (!TextUtils.isEmpty(localTribeVideoPublishParams.changeFace.id))) {
        awqx.b(this.app, "dc00899", "Grp_tribe", "", "video_shoot", "pub_changeface", i, 0, localTribeVideoPublishParams.changeFace.id, localTribeVideoPublishParams.changeFace.type, "", "");
      }
      if (localTribeVideoPublishParams.filter != null) {
        awqx.b(this.app, "dc00899", "Grp_tribe", "", "video_shoot", "pub_filter", i, 0, localTribeVideoPublishParams.filter.id, localTribeVideoPublishParams.filter.typeId, "", "");
      }
      if (localTribeVideoPublishParams.beauty > 0) {
        awqx.b(this.app, "dc00899", "Grp_tribe", "", "video_shoot", "pub_beauty", i, 0, "" + localTribeVideoPublishParams.beauty, "", "", "");
      }
      if (localTribeVideoPublishParams.hasGraffiti) {
        awqx.b(this.app, "dc00899", "Grp_tribe", "", "video_edit", "pub_graffiti", i, 0, "", "", "", "");
      }
      if (localTribeVideoPublishParams.hasText) {
        awqx.b(this.app, "dc00899", "Grp_tribe", "", "video_edit", "pub_text", i, 0, "", "", "", "");
      }
      if (localTribeVideoPublishParams.hasFace) {
        awqx.b(this.app, "dc00899", "Grp_tribe", "", "video_edit", "pub_face", i, 0, "", "", "", "");
      }
      if (localTribeVideoPublishParams.music == null) {
        break;
      }
      awqx.b(this.app, "dc00899", "Grp_tribe", "", "video_edit", "pub_music", i, 0, localTribeVideoPublishParams.music.name, localTribeVideoPublishParams.music.type, "", "");
      return;
    }
    if (localTribeVideoPublishParams.isSoundOn)
    {
      awqx.b(this.app, "dc00899", "Grp_tribe", "", "video_edit", "sound_on", i, 0, "", "", "", "");
      return;
    }
    awqx.b(this.app, "dc00899", "Grp_tribe", "", "video_edit", "sound_off", i, 0, "", "", "", "");
  }
}
