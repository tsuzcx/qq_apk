  ...
  implements View.OnClickListener, HttpWebCgiAsyncTask.Callback, AdapterView.OnItemClickListener
{
  ...
  public TroopBarPublishLocationSelectActivity()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new ajdn(this);
  }
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_ComTencentWidgetXListView.setOverscrollHeader(getResources().getDrawable(2130838596));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOverScrollHeader(this.jdField_a_of_type_ComTencentMobileqqWidgetPullRefreshHeader);
    this.jdField_a_of_type_ComTencentWidgetXListView.setOverScrollListener(new ajdk(this));
  }
    ...
    for (;;)
    {
      ...
      else
      {
        if (this.jdField_a_of_type_JavaUtilArrayList.size() > 1)
        {
          ...
          QQToast.a(this, 1, getString(2131430312, new Object[] { Integer.valueOf(paramInt) }), 0).b(getTitleBarHeight());
          return;
        }
        paramBundle = null;
        continue;
        label274:
        QQToast.a(this, 1, getString(2131430312, new Object[] { Integer.valueOf(paramJSONObject.optInt("errno", -1)) }), 0).b(getTitleBarHeight());
        return;
  ...
  {
    TextView localTextView = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363969);
    if (paramBoolean)
    {
  ...
  protected void b()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppSosoSosoInterface$OnLocationListener = new ajdo(this, 0, true, true, 0L, false, false, "QLifeCommentActivity");
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_ComTencentWidgetXListView.setDivider(getResources().getDrawable(2130839289));
    ...
    setTitle(2131430337);
    this.rightViewImg.setImageResource(2130840571);
    ...
    for (;;)
    {
      this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this).inflate(2130969237, null);
      a();
      paramBundle = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363318);
      TextView localTextView1 = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363969);
      TextView localTextView2 = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363970);
      ProgressBar localProgressBar = (ProgressBar)this.jdField_a_of_type_AndroidViewView.findViewById(2131363054);
      ...
      this.jdField_a_of_type_ComTencentWidgetXListView.setOnScrollListener(new ajdj(this));
