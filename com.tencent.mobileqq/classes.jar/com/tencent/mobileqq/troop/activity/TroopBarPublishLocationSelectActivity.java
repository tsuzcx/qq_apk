...
public class TroopBarPublishLocationSelectActivity
  ...
  implements View.OnClickListener, bfpo, bkij
{
  public long a;
  ...
  public TroopBarPublishLocationSelectActivity()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarPOI = new TroopBarPOI("-1", "", anni.a(2131713901), 0, "", 0, "");
    this.jdField_a_of_type_AndroidOsHandler = new bekh(this);
  }
  
  public static final void a(BaseActivity paramBaseActivity, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean, bfpo parambfpo)
  {
    ...
    bfqu.a(paramBaseActivity, localBundle1, "https://buluo.qq.com/cgi-bin/bar/user/poilist", 3, localBundle2, parambfpo);
  }
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_ComTencentWidgetXListView.setOverScrollListener(new bekg(this));
  }
  ...
  protected void a(int paramInt)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqWidgetPullRefreshHeader != null)
    {
      ...
      if (localajhj != null)
      {
        localajhj.jdField_a_of_type_Boolean = false;
    ...
    for (;;)
    {
      ...
      else
      {
        if (this.jdField_a_of_type_JavaUtilArrayList.size() > 1)
        {
          ...
          this.b = paramBundle;
          this.jdField_a_of_type_Bekj.notifyDataSetChanged();
          return;
          label212:
          if (paramJSONObject.optInt("isend", -1) == 1) {
            break;
          ...
          QQToast.a(this, 1, getString(2131695572, new Object[] { Integer.valueOf(paramInt) }), 0).b(getTitleBarHeight());
          return;
        }
        paramBundle = null;
        continue;
        label274:
        QQToast.a(this, 1, getString(2131695572, new Object[] { Integer.valueOf(paramJSONObject.optInt("errno", -1)) }), 0).b(getTitleBarHeight());
        return;
  ...
  {
    TextView localTextView = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131376312);
    if (paramBoolean)
    {
  ...
  protected void b()
  {
    this.jdField_a_of_type_Aopa = new beki(this, 0, true, true, 0L, false, false, "QLifeCommentActivity");
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_ComTencentWidgetXListView.setDivider(getResources().getDrawable(2130840479));
    ...
    setTitle(2131695531);
    this.rightViewImg.setImageResource(2130842465);
    ...
    for (;;)
    {
      this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this).inflate(2131559646, null);
      a();
      paramBundle = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131376310);
      TextView localTextView1 = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131376312);
      TextView localTextView2 = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131376318);
      ProgressBar localProgressBar = (ProgressBar)this.jdField_a_of_type_AndroidViewView.findViewById(2131376313);
      ...
      this.jdField_a_of_type_ComTencentWidgetXListView.setOnScrollListener(new bekf(this));
      this.jdField_a_of_type_Bekj = new bekj(this, this, this.jdField_a_of_type_Boolean);
      this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Bekj);
