...
class TroopBarReplyActivity$10
  extends Handler
{
  TroopBarReplyActivity$10(TroopBarReplyActivity paramTroopBarReplyActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
        ...
        do
        {
          do
          {
            ...
            case 1001: 
              ...
              QQToast.a(this.a, 2131696251, 1).b(this.a.getTitleBarHeight());
            }
    ...
    {
      this.a.requestPermissions(new TroopBarReplyActivity.10.1(this), 1, new String[] { "android.permission.RECORD_AUDIO" });
      return;
    }
 ...
 * Qualified Name:     com.tencent.mobileqq.troop.activity.TroopBarReplyActivity.10
