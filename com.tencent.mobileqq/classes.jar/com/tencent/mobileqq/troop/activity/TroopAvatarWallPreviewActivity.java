  ...
  extends BaseActivity
{
  ...
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new aiie(this);
  ...
  protected boolean[] a;
  public int b;
  private View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new aiit(this);
  public View b;
  ...
  public TroopAvatarWallPreviewActivity()
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new aiif(this);
    this.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelPersonalityLabelObserver = new aiio(this);
  }
  ...
  private void a(int paramInt, Bundle paramBundle)
  {
    ...
    DialogUtil.a(this, 230).setTitle(getString(2131439056)).setPositiveButton(getString(2131432999), new aiin(this, paramBundle, paramInt)).setNegativeButton(getString(2131432998), new aiim(this)).show();
  }
  ...
  private void a(boolean paramBoolean)
  {
    if (this.jdField_b_of_type_AndroidViewView != null)
    {
      if (paramBoolean)
      {
        ...
        this.jdField_b_of_type_AndroidViewAnimationTranslateAnimation.setAnimationListener(new aiip(this));
      }
    }
    else {
      return;
    ...
    this.jdField_a_of_type_AndroidViewAnimationTranslateAnimation.setAnimationListener(new aiir(this));
  }
  ...
  private boolean a()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetImageAnimationView.setAnimationListener(new aiia(this));
    this.jdField_a_of_type_ComTencentMobileqqWidgetImageAnimationView.a();
    this.jdField_a_of_type_AndroidWidgetFrameLayout.postDelayed(new aiib(this), this.jdField_a_of_type_Long);
  ...
  {
    new aihx(this, paramURLDrawable, paramString).execute(new Void[0]);
  }
  ...
  private void c()
  {
    ...
    {
      ((ImageView)this.jdField_c_of_type_AndroidViewView).setImageResource(2130844859);
    ...
    ((ImageView)this.jdField_c_of_type_AndroidViewView).setImageResource(2130844860);
  ...
  private void d(int paramInt)
  {
    ...
    for (paramInt = 2130844865;; paramInt = 2130844868)
    {
    ...
    if ((this.jdField_e_of_type_JavaUtilArrayList != null) && (paramInt < this.jdField_e_of_type_JavaUtilArrayList.size()) && (!TextUtils.isEmpty((CharSequence)this.jdField_e_of_type_JavaUtilArrayList.get(paramInt))) && (AbsDownloader.a((String)this.jdField_e_of_type_JavaUtilArrayList.get(paramInt)) == null))
    {
      ...
      for (;;)
      {
        try
        {
          ...
          this.jdField_d_of_type_AndroidWidgetTextView.setText(String.format(Locale.CHINA, getResources().getString(2131436095), new Object[] { FileUtil.a(l1) }));
        ...
        continue;
        label173:
        this.jdField_d_of_type_AndroidWidgetTextView.setText(2131436094);
      }
    }
  ...
  private void f()
  {
    ...
    {
      this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130844865);
    ...
    for (int i1 = 1;; i1 = 0)
    {
      ...
      return;
      this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130844868);
      break;
    }
  }
  ...
  private void g()
  {
    ...
    if (this.jdField_e_of_type_Boolean)
    {
      ...
      if (!getIntent().getBooleanExtra("from_photo_wall", false)) {
        ThreadManager.executeOnFileThread(new aiiv(this, (URLDrawable)localObject, localActionSheet));
      }
    }
    if ((this.jdField_a_of_type_Boolean) && (a(this.jdField_a_of_type_Int))) {
      localActionSheet.a(2131435868, 1);
    }
    if (this.jdField_d_of_type_Boolean)
    {
      localActionSheet.a(2131430225, 5);
      localActionSheet.a(2131435868, 3);
    }
    localActionSheet.c(2131432998);
    localActionSheet.a(new aiix(this, localActionSheet, (URLDrawable)localObject));
    try
    {
  ...
  public void a(URLDrawable paramURLDrawable)
  {
    ...
    for (;;)
    {
      ...
      DialogUtil.a(this, 230).setTitle(getString(2131434569)).setMessage(getString(2131434571)).setPositiveButton(getString(2131434570), new aihw(this, paramURLDrawable, str)).setNegativeButton(getString(2131432995), new aiiy(this)).show();
    }
  }
  ...
  public void a(URLDrawable paramURLDrawable, String paramString)
  {
    ...
    new aiiu(this, paramURLDrawable, paramString).execute(new Void[0]);
  }
  ...
  public void b()
  {
    ...
    localAnimationSet.setAnimationListener(new aiic(this));
    if (this.jdField_a_of_type_JavaLangRunnable == null) {
      this.jdField_a_of_type_JavaLangRunnable = new aiid(this);
    }
  ...
  public void b(int paramInt)
  {
    ...
    DialogUtil.a(this, 230).setTitle(getString(2131437151)).setPositiveButton(getString(2131432999), new aihz(this, paramInt)).setNegativeButton(getString(2131432998), new aihy(this)).show();
    a("0X8006A83", "");
  }
  ...
  protected boolean doOnCreate(Bundle arg1)
  {
    ...
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131364777));
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetImageAnimationView = ((ImageAnimationView)findViewById(2131364775));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131364776));
    this.jdField_c_of_type_AndroidViewView = findViewById(2131364781);
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131364778));
    this.jdField_d_of_type_AndroidWidgetTextView.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131364779));
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setVisibility(0);
    ...
    if (this.jdField_d_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130837592);
      ...
      localObject2 = ((ViewStub)findViewById(2131364780)).inflate();
      this.jdField_b_of_type_AndroidViewView = ((View)localObject2).findViewById(2131364634);
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)((View)localObject2).findViewById(2131364635));
      this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)((View)localObject2).findViewById(2131364636));
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)((View)localObject2).findViewById(2131364637));
      this.jdField_b_of_type_AndroidViewView.setBackgroundResource(2130846316);
    ...
    for (;;)
    {
      ...
      if (this.j)
      {
        ...
        {
          this.jdField_d_of_type_AndroidViewView = ((ViewStub)findViewById(2131364782)).inflate();
          this.jdField_d_of_type_AndroidViewView.setVisibility(0);
          if ((this.jdField_d_of_type_AndroidViewView != null) && ((this.jdField_d_of_type_AndroidViewView instanceof LinearLayout)))
          {
            localObject4 = (TextView)this.jdField_d_of_type_AndroidViewView.findViewById(2131363360);
            if (!TextUtils.isEmpty((CharSequence)localObject3)) {
              ((TextView)localObject4).setText((CharSequence)localObject3);
            }
            localObject3 = (Button)this.jdField_d_of_type_AndroidViewView.findViewById(2131364802);
            ...
            ((Button)localObject3).setOnClickListener(new aihv(this, (String)localObject2, localArticleInfo));
          }
        }
      }
      ThreadManager.post(new aiih(this, ???), 8, null, true);
      if (b())
      {
        this.jdField_a_of_type_Aiiz = new aiiz(this, new Handler());
        this.jdField_a_of_type_Aiiz.a();
