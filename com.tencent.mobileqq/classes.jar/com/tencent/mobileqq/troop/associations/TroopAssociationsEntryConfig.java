...
public class TroopAssociationsEntryConfig
{
  ...
  public static TroopAssociationsEntryConfig a(QConfItem[] paramArrayOfQConfItem)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.i("TroopAssociationsEntryConfig", 2, "config:" + localTroopAssociationsEntryConfig.toString());
    }
 ...
 * Qualified Name:     com.tencent.mobileqq.troop.associations.TroopAssociationsEntryConfig
