...
public class TroopFileThumbnailMgr$2
  implements Runnable
{
  public TroopFileThumbnailMgr$2(bbsw parambbsw, TroopFileTransferManager.Item paramItem, long paramLong, int paramInt) {}
  ...
  public void run()
  {
    ...
    if (arof.b(str)) {
      bbsw.a(this.this$0).a(this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, this.jdField_a_of_type_Int, str);
    }
    ...
    bbsw.a(this.this$0).a(this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, this.jdField_a_of_type_Int, null);
  }
}
