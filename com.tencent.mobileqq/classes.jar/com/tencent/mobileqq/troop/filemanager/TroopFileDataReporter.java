...
public class TroopFileDataReporter
{
  ...
  public static void a(long paramLong, TroopFileTransferManager.Item paramItem, TroopFileDataReporter.ReportTransferItem paramReportTransferItem)
  {
    ...
    localHashMap.put("param_check_time", String.valueOf(paramReportTransferItem.g));
    ...
    for (paramLong = 0L;; paramLong = l - paramLong)
    {
      ...
      TroopFileTransferUtil.Log.c("TroopFileDataReporter", TroopFileTransferUtil.Log.jdField_a_of_type_Int, "reportUploadSucInfo. reportType:actGroupFileUp params:" + localHashMap.toString());
      StatisticCollector.a(BaseApplication.getContext()).a((String)localObject, "actGroupFileUp", true, l, 1, localHashMap, "");
      return;
    }
  }
  ...
  public static void a(long paramLong, TroopFileTransferManager.Item paramItem, String paramString, TroopFileDataReporter.ReportTransferItem paramReportTransferItem)
  {
    ...
    for (paramLong = 0L;; paramLong = l - paramLong)
    {
      ...
      TroopFileTransferUtil.Log.c("TroopFileDataReporter", TroopFileTransferUtil.Log.jdField_a_of_type_Int, "reportUploadFailInfo. reportType:" + paramString + " params:" + localHashMap.toString());
      StatisticCollector.a(BaseApplication.getContext()).a((String)localObject, paramString, false, l, 1, localHashMap, "");
      return;
    }
  }
  
  public static void b(long paramLong, TroopFileTransferManager.Item paramItem, TroopFileDataReporter.ReportTransferItem paramReportTransferItem)
  {
    if ((paramItem == null) || (paramReportTransferItem == null)) {}
    do
    {
    ...
    localHashMap.put("param_uuid", paramItem.FilePath);
    localHashMap.put("param_store_type", String.valueOf(paramItem.BusId));
    localHashMap.put("param_life_left_second", String.valueOf(paramReportTransferItem.h));
    localHashMap.put("param_result", String.valueOf(0));
    localHashMap.put("param_sub_reason", String.valueOf(0));
    localHashMap.put("param_http_status_code", String.valueOf(paramReportTransferItem.jdField_e_of_type_Int));
    localHashMap.put("param_err_msg", "");
    ...
    for (paramLong = 0L;; paramLong = l - paramLong)
    {
      ...
      TroopFileTransferUtil.Log.c("TroopFileDataReporter", TroopFileTransferUtil.Log.jdField_a_of_type_Int, "reportDownloadSucInfo. reportType:actGroupFileDown params:" + localHashMap.toString());
      StatisticCollector.a(BaseApplication.getContext()).a((String)localObject, "actGroupFileDown", true, l, 1, localHashMap, "");
      return;
    }
  }
  ...
  public static void b(long paramLong, TroopFileTransferManager.Item paramItem, String paramString, TroopFileDataReporter.ReportTransferItem paramReportTransferItem)
  {
    ...
    for (paramLong = 0L;; paramLong = l - paramLong)
    {
      ...
      TroopFileTransferUtil.Log.c("TroopFileDataReporter", TroopFileTransferUtil.Log.jdField_a_of_type_Int, "reportDownloadFailInfo. reportType:" + paramString + " params:" + localHashMap.toString());
      StatisticCollector.a(BaseApplication.getContext()).a((String)localObject, paramString, false, l, 1, localHashMap, "");
      return;
    }
  }
