...
{
  private static volatile TroopFileSearchManager c;
  protected List<IContactSearchable> a = null;
  ...
  public static final int a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8)
  {
    ...
    paramString6 = b(paramString6);
    paramString7 = b(paramString7);
    paramString8 = b(paramString8);
    if (b(paramString2).contains(paramString1)) {
      return 7;
    }
    ...
    if (paramList != null)
    {
      ...
      for (;;)
      {
        ...
        if ((localObject instanceof ContactSearchableFriend))
        {
          ...
          try
          {
            if ((((ContactSearchableFriend)localObject).e() != 0) && (((ContactSearchableFriend)localObject).e() != 3)) {
              localArrayList1.add(Long.valueOf(Long.parseLong(((ContactSearchableFriend)localObject).j())));
            }
          }
  ...
  public final ContactSearchableFriend a(String paramString)
  {
    ...
    while (i < j)
    {
      localObject = (IContactSearchable)this.a.get(i);
      if (((localObject instanceof ContactSearchableFriend)) && (paramString.equals(((IContactSearchable)localObject).j()))) {
  ...
  public List<IContactSearchable> a(Context paramContext, QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    localArrayList2.add(localExecutorService.submit(new TroopFileSearchManager.CallableForSearchData(this, paramContext, paramQQAppInterface, IContactSearchable.I, paramInt)));
    paramInt = 0;
    try
    {
  ...
  public List<IContactSearchable> a(Context paramContext, QQAppInterface paramQQAppInterface, long paramLong, boolean paramBoolean)
  {
    ...
    if (localFriendsManager != null)
    {
      ...
      if (localObject1 != null)
      {
        ...
        while (localIterator1.hasNext())
        {
          ...
          Object localObject2 = localFriendsManager.t(String.valueOf(((Groups)localObject1).group_id));
          if (localObject2 != null)
          {
            ...
            while (localIterator2.hasNext())
            {
              ...
              if (localFriends.gathtertype == 1) {
                localObject2 = paramContext.getResources().getString(2131917726);
              } else {
    ...
    if (paramBoolean)
    {
      ...
      localArrayList.add(new ContactSearchableFriend(paramContext, paramQQAppInterface, (Friends)localObject1, paramContext.getResources().getString(2131917726), 0L, paramLong));
    }
  ...
  public List<TroopFileSearchableFriend> a(Context paramContext, QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    if (localFriendsManager != null)
    {
      Object localObject1 = localFriendsManager.h();
      if (localObject1 != null)
      {
        localObject1 = ((List)localObject1).iterator();
        while (((Iterator)localObject1).hasNext())
        {
          Object localObject2 = localFriendsManager.t(String.valueOf(((Groups)((Iterator)localObject1).next()).group_id));
          if (localObject2 != null)
          {
