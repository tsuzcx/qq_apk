  ...
  extends TroopFileReqResendFileObserver
{
  ...
  public void a(boolean paramBoolean, int paramInt, oidb_0x6d6.ResendRspBody paramResendRspBody, Bundle paramBundle)
  {
    ...
    if ((paramResendRspBody == null) || (!paramBoolean))
    {
      ...
      paramResendRspBody = new TroopFileError.SimpleErrorInfo(this.a.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FileName, this.a.e, 3, 207);
      ...
      this.a.a(true, TroopTechReportUtils.TroopFileReportResultCode.b, TroopTechReportUtils.TroopFileReportResultCode.A, paramResendRspBody);
      return;
    }
    ...
    if (i < 0)
    {
      ...
      for (;;)
      {
        ...
        TroopFileDataCenter.b(this.a.e, this.a.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, paramInt);
 ...
 * Qualified Name:     com.tencent.mobileqq.troop.filemanager.upload.TroopFileUploadWorker.2
