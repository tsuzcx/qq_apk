...
public class TroopMemberLevelMapConfig
{
  ...
  public static TroopMemberLevelMapConfig a(String paramString)
  {
      ...
      if (paramString != null)
      {
        ...
        if (paramString.length() > 0)
        {
          ...
          for (;;)
          {
            ...
            localObject3 = str1;
            localObject1 = str2;
            localObject4 = new TroopMemberLevelMapItem(((JSONObject)localObject2).getInt("begin"), ((JSONObject)localObject2).getInt("end"), ((JSONObject)localObject2).getInt("rankid"), ((JSONObject)localObject2).getString("rankname"));
            localObject3 = str1;
            localObject1 = str2;
      ...
      if (paramString != null)
      {
        ...
        if (paramString.length() > 0)
        {
          ...
          for (;;)
          {
            ...
            localObject3 = str1;
            localObject1 = str2;
            localObject4 = new TroopMemberLevelColorItem(((JSONObject)localObject2).getInt("titleId"), ((JSONObject)localObject2).getString("start"), ((JSONObject)localObject2).getString("end"));
            localObject3 = str1;
            localObject1 = str2;
    ...
    localObject1 = new TroopMemberLevelMapConfig();
    ((TroopMemberLevelMapConfig)localObject1).jdField_a_of_type_JavaUtilHashMap = localHashMap1;
    ((TroopMemberLevelMapConfig)localObject1).jdField_b_of_type_JavaUtilHashMap = localHashMap2;
    ((TroopMemberLevelMapConfig)localObject1).jdField_a_of_type_JavaUtilList = localArrayList;
    ((TroopMemberLevelMapConfig)localObject1).jdField_a_of_type_JavaUtilTreeMap = localTreeMap;
    ((TroopMemberLevelMapConfig)localObject1).jdField_a_of_type_JavaLangString = ((String)localObject3);
    ((TroopMemberLevelMapConfig)localObject1).jdField_b_of_type_JavaLangString = ((String)localObject2);
    ((TroopMemberLevelMapConfig)localObject1).c = paramString;
    if (QLog.isColorLevel()) {
  ...
  public int a(int paramInt)
  {
    ...
    do
    {
      ...
      localObject = (TroopMemberLevelMapItem)this.jdField_a_of_type_JavaUtilHashMap.get(localObject);
    } while ((((TroopMemberLevelMapItem)localObject).jdField_a_of_type_Int > paramInt) || (paramInt > ((TroopMemberLevelMapItem)localObject).b));
    for (paramInt = ((TroopMemberLevelMapItem)localObject).c;; paramInt = 0) {
      return paramInt;
    }
  }
  ...
  public String a(int paramInt)
  {
    ...
    } while ((localObject2 == null) || (((TroopMemberLevelMapItem)localObject2).jdField_a_of_type_Int > paramInt) || (((TroopMemberLevelMapItem)localObject2).b < paramInt));
    for (localObject1 = ((TroopMemberLevelMapItem)localObject2).jdField_a_of_type_JavaLangString;; localObject1 = "")
    {
      if (QLog.isColorLevel()) {
 ...
 * Qualified Name:     com.tencent.mobileqq.troop.troopMemberLevel.TroopMemberLevelMapConfig
