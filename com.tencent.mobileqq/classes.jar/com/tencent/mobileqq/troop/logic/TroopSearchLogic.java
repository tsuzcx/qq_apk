...
public class TroopSearchLogic
{
  ...
  public void a(ArrayList<ResultRecord> paramArrayList, baef parambaef)
  {
    ThreadManager.postImmediately(new TroopSearchLogic.TroopSearchTask(this, parambaef, paramArrayList), null, false);
  }
}
