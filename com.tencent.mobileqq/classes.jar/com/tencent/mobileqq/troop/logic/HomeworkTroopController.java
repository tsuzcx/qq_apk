...
public class HomeworkTroopController
{
  ...
  public HomeworkTroopController(QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity, SessionInfo paramSessionInfo, ImageView paramImageView, RelativeLayout paramRelativeLayout, PanelIconLinearLayout paramPanelIconLinearLayout)
  {
    ...
    paramQQAppInterface.addRule(7, 2131364026);
    paramQQAppInterface.addRule(6, 2131364026);
  ...
  {
    ThreadManager.getUIHandler().postDelayed(new ajtl(this, paramInt), paramLong);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new ajtk(this));
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130841389);
