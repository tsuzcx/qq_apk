  ...
  implements Manager
{
  ...
  private List<oidb_0xdc9.HonorList> b;
  private AppRuntime c;
  private TroopHonorConfig d;
  ...
  public TroopHonorManager(AppRuntime paramAppRuntime)
  {
    ...
    this.e = paramAppRuntime.getEntityManagerFactory().createEntityManager();
    this.d = new TroopHonorConfig();
    ThreadManager.getSubThreadHandler().post(new TroopHonorManager.1(this));
  }
  
  private byte a()
  {
    return (byte)this.c.getApp().getSharedPreferences(this.c.getCurrentAccountUin(), 0).getInt("honor_rich_self", 0);
  }
  
  private void a(boolean paramBoolean, String paramString1, int paramInt, String paramString2)
  {
    byte b1 = a();
    TroopInfo localTroopInfo = ((ITroopInfoService)this.c.getRuntimeService(ITroopInfoService.class, "")).getTroopInfo(paramString1);
    if (localTroopInfo != null)
    {
      ...
      localTroopInfo.myHonorRichFlag = b1;
      a(localTroopInfo);
      if (QLog.isColorLevel()) {
        QLog.d("TroopHonor.manager", 2, String.format("updateHostHonorList| update notUpdateHonors:%s, troopUin: %s, troopHonorGrayFlag: %s,honor_rich: %s", new Object[] { Boolean.valueOf(paramBoolean), paramString1, Integer.valueOf(paramInt), Byte.valueOf(b1) }));
      }
    }
  }
  ...
  {
    byte b1 = a();
    ITroopMemberInfoService localITroopMemberInfoService = (ITroopMemberInfoService)this.c.getRuntimeService(ITroopMemberInfoService.class, "");
    ...
    if (localTroopMemberInfo2 == null)
    {
      ...
      if (!TextUtils.isEmpty(paramString3))
      {
        ...
        localTroopMemberInfo1.memberuin = this.c.getCurrentAccountUin();
    ...
    if (localTroopMemberInfo1 != null)
    {
      ...
      localTroopMemberInfo1.mHonorRichFlag = b1;
      ...
      if (QLog.isColorLevel()) {
        QLog.d("TroopHonor.manager", 2, String.format("updateHostHonorList| update host memberInfo, troopUin: %s, honorList: %s, result: %s ,honor_rich: %s", new Object[] { paramString2, paramList, Boolean.valueOf(paramBoolean), Byte.valueOf(b1) }));
      }
    }
  }
  ...
  public List<TroopHonor> a(String paramString, Byte paramByte)
  {
    ...
    if ((paramString != null) && (paramString.size() > 0))
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        {
          paramString = this.d.a(paramString.intValue());
        }
        else
        {
          int i = TroopHonorUtils.a(paramString.intValue(), paramByte.byteValue());
          if (i == 1) {
            paramString = this.d.a(paramString.intValue(), i);
          } else {
            paramString = this.d.a(paramString.intValue());
          }
        }
  ...
  public List<TroopHonor> a(String paramString1, String paramString2)
  {
    ...
    TroopMemberInfo localTroopMemberInfo = ((ITroopMemberInfoService)this.c.getRuntimeService(ITroopMemberInfoService.class, "")).getTroopMember(paramString1, paramString2);
  ...
  {
    ((ITroopMemberInfoService)this.c.getRuntimeService(ITroopMemberInfoService.class, "")).getTroopMemberInfo(paramString1, paramString2, new TroopHonorManager.2(this, paramString1, paramString2, paramIGetTroopHonorListCallback));
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3, byte paramByte, long paramLong)
  {
    if (!TextUtils.isEmpty(paramString1))
    {
      ...
      ITroopMemberInfoService localITroopMemberInfoService = (ITroopMemberInfoService)this.c.getRuntimeService(ITroopMemberInfoService.class, "");
      Object localObject2 = (ITroopInfoService)this.c.getRuntimeService(ITroopInfoService.class, "");
      if (this.c.getCurrentAccountUin().equals(paramString2))
      {
  ...
  {
    ITroopInfoService localITroopInfoService = (ITroopInfoService)this.c.getRuntimeService(ITroopInfoService.class, "");
      ...
      try
      {
        ...
        if ((paramArrayOfByte != null) && (paramArrayOfByte.size() > 0))
        {
          ...
          if (((Iterator)localObject).hasNext())
          {
            ...
            if ((!TextUtils.isEmpty(str)) && (str.equals(this.c.getCurrentAccountUin()))) {
              ((ITroopListHandler)((AppInterface)MobileQQ.sMobileQQ.waitAppRuntime(null)).getBusinessHandler(a)).a(TroopObserver.TYPE_NOTIFY_UPDATE_RECENT_LIST, true, new Object[] { paramString, str });
            }
            if (!QLog.isColorLevel()) {
              continue;
            }
  ...
  {
    this.c.getApplication().getSharedPreferences(this.c.getCurrentAccountUin(), 0).edit().putInt("honor_rich_self", paramShort).apply();
  }
  ...
  public boolean a(String paramString)
  {
    ...
    boolean bool = true;
    int i;
    if ((localObject != null) && (((TroopHonorConfig)localObject).a)) {
      i = 1;
    } else {
      i = 0;
    }
    localObject = (ITroopInfoService)this.c.getRuntimeService(ITroopInfoService.class, "");
    if (i == 0)
    {
  ...
  {
    TroopHonorConfig localTroopHonorConfig = this.d;
    boolean bool1;
    if ((localTroopHonorConfig != null) && (localTroopHonorConfig.a)) {
      bool1 = true;
    } else {
      bool1 = false;
    }
    paramString = ((ITroopInfoService)this.c.getRuntimeService(ITroopInfoService.class, "")).getTroopInfo(paramString);
    boolean bool2;
    ...
    paramString = ((IProfileDataService)this.c.getRuntimeService(IProfileDataService.class, "all")).getProfileCard(this.c.getCurrentUin(), true);
    boolean bool5;
    if (paramString != null) {
  ...
  public List<TroopHonor> c(String paramString)
  {
