...
public class TroopAioKeywordTipManager$1
  implements Runnable
{
  public TroopAioKeywordTipManager$1(bdzb parambdzb, List paramList) {}
  ...
  public void run()
  {
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      bdzb.a(this.this$0, (MessageRecord)localObject2);
    }
    localObject1 = null;
    ...
    if (((Iterator)localObject2).hasNext())
    {
      ...
      localObject3 = bdzb.a(this.this$0, (MessageRecord)localObject3);
    ...
    for (;;)
    {
      ...
      if ((localObject1 != null) && (((List)localObject1).size() > 0)) {
        bdzb.a(this.this$0, (List)localObject1);
      }
      return;
      break label97;
    }
