...
public class TroopFeedsDataManager$2
  implements Runnable
{
  public TroopFeedsDataManager$2(ayok paramayok, List paramList, int paramInt) {}
  ...
  public void run()
  {
    ...
    new azgk("http://web.qun.qq.com/cgi-bin/notice/get_data_new", "GET", this.this$0.jdField_a_of_type_Azgl, this.jdField_a_of_type_Int, null, true).execute(new HashMap[] { localObject1 });
