  ...
  extends MsgProxy
{
  ...
  public MessageRecord a(String paramString, int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    if (localMessageRecord == null)
    {
      ...
      if (((QQAppInterface)this.app).getMsgCache().a != null)
      {
        localList.clear();
        ...
        if (!paramList.isEmpty())
        {
          ...
          if (paramString != null)
          {
            ...
            if (QLog.isColorLevel())
            {
              ...
              paramMessageRecord.append("getSendingTroopMsgItem: find msg =");
  ...
  public List<MessageRecord> a(String paramString, int paramInt1, long paramLong1, int paramInt2, long paramLong2, int paramInt3, int[] paramArrayOfInt)
  {
    ...
    paramString = MessageDBUtils.a(MessageRecord.getOldTableName(paramString, paramInt1), MessageRecord.getTableName(paramString, paramInt1), paramLong1, paramInt2, paramLong2, paramArrayOfInt, paramInt3, b());
    if (paramString == null) {
  ...
  protected void a(String paramString, int paramInt, MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if ((a().a().containsKey(localObject2)) && (paramBoolean))
        {
          localObject2 = (List)a().a().get(localObject2);
          if (localObject2 == null)
          {
          ...
          else
          {
            ...
            if (((List)localObject2).size() > 200)
            {
              ...
              if (paramMessageRecord.istroop == 1) {
                ...
                {
                  localObject1 = localObject2;
                  if (!this.jdField_a_of_type_ComTencentMobileqqAppTroopManager.f(paramString))
                  {
  ...
  public void c()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 274	com/tencent/mobileqq/troop/data/TroopAndDiscMsgProxy:proxyManager	Lcom/tencent/mobileqq/app/proxy/BaseProxyManager;
    //   4: invokevirtual 550	com/tencent/mobileqq/app/proxy/BaseProxyManager:transSaveToDatabase	()V
    //   7: aload_0
    //   8: getfield 274	com/tencent/mobileqq/troop/data/TroopAndDiscMsgProxy:proxyManager	Lcom/tencent/mobileqq/app/proxy/BaseProxyManager;
    //   11: invokevirtual 706	com/tencent/mobileqq/app/proxy/BaseProxyManager:clearMsgQueue	()V
    //   14: aload_0
    //   15: invokevirtual 277	com/tencent/mobileqq/troop/data/TroopAndDiscMsgProxy:a	()Lcom/tencent/mobileqq/persistence/EntityManager;
    //   18: invokevirtual 710	com/tencent/mobileqq/persistence/EntityManager:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   21: astore 6
    //   23: aload_0
    //   24: invokevirtual 712	com/tencent/mobileqq/troop/data/TroopAndDiscMsgProxy:a	()Lcom/tencent/mobileqq/app/SQLiteDatabase;
    //   27: astore 7
    //   29: aload 7
    //   31: invokevirtual 718	com/tencent/mobileqq/app/SQLiteDatabase:getAllTableNameFromCache	()[Ljava/lang/String;
    //   34: astore 8
    //   36: aload 8
    //   38: ifnonnull +4 -> 42
    //   41: return
    //   42: aload_0
    //   43: getfield 188	com/tencent/mobileqq/troop/data/TroopAndDiscMsgProxy:app	Lmqq/app/AppRuntime;
    //   46: getstatic 721	com/tencent/mobileqq/app/QQManagerFactory:SLOW_TABLE_MANAGER	I
    //   49: invokevirtual 639	mqq/app/AppRuntime:getManager	(I)Lmqq/manager/Manager;
    //   52: checkcast 723	com/tencent/mobileqq/persistence/qslowtable/QSlowTableManager
    //   55: astore 9
    //   57: iconst_0
    //   58: istore_1
    //   59: iload_1
    ...
    //   72: aload 10
    //   74: ldc_w 725
    //   77: invokevirtual 728	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   80: ifne +23 -> 103
    //   83: aload 10
    //   85: ldc_w 730
    //   88: invokevirtual 728	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   91: ifeq +6 -> 97
    //   94: goto +9 -> 103
    //   97: aconst_null
    //   98: astore 5
    ...
    //   146: aload 5
    //   148: ldc_w 736
    //   151: invokevirtual 60	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   154: pop
    //   155: aload 5
    ...
    //   162: aload 5
    //   164: ifnull +295 -> 459
    //   167: invokestatic 49	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   170: ifeq +41 -> 211
    //   173: new 51	java/lang/StringBuilder
    //   176: dup
    //   177: invokespecial 54	java/lang/StringBuilder:<init>	()V
    //   180: astore 11
    //   182: aload 11
    //   184: ldc_w 738
    ...
    //   213: aload 5
    //   215: aconst_null
    //   216: invokevirtual 743	com/tencent/mobileqq/app/SQLiteDatabase:rawQuery	(Ljava/lang/String;[Ljava/lang/String;)Landroid/database/Cursor;
    //   219: astore 5
    //   221: aload 5
    //   223: ifnull +113 -> 336
    //   226: aload 5
    ...
    //   233: ifle +103 -> 336
    //   236: aload 5
    //   238: invokeinterface 746 1 0
    //   243: pop
    //   244: aload 5
    //   246: aload 5
    //   248: ldc_w 748
    //   251: invokeinterface 751 2 0
    //   256: invokeinterface 755 2 0
    //   261: lstore_3
    //   262: aload 5
    //   264: aload 5
    //   266: ldc_w 756
    //   269: invokeinterface 751 2 0
    //   274: invokeinterface 461 2 0
    //   279: astore 11
    //   281: aload 5
    //   283: aload 5
    //   285: ldc_w 757
    //   288: invokeinterface 751 2 0
    //   293: invokeinterface 761 2 0
    //   298: istore_2
    //   299: aload_0
    //   300: getfield 188	com/tencent/mobileqq/troop/data/TroopAndDiscMsgProxy:app	Lmqq/app/AppRuntime;
    //   303: checkcast 397	com/tencent/mobileqq/app/QQAppInterface
    //   306: invokevirtual 401	com/tencent/mobileqq/app/QQAppInterface:getMsgCache	()Lcom/tencent/mobileqq/service/message/MessageCache;
    //   309: aload 11
    //   311: iload_2
    //   312: lload_3
    //   313: invokevirtual 763	com/tencent/mobileqq/service/message/MessageCache:a	(Ljava/lang/String;IJ)V
    //   316: goto +20 -> 336
    //   319: astore 6
    //   321: aload 5
    //   323: ifnull +10 -> 333
    ...
    //   338: ifnull +10 -> 348
    //   341: aload 5
    //   343: invokeinterface 318 1 0
    //   348: aload 6
    //   350: ifnull +8 -> 358
    //   353: aload 6
    //   355: invokevirtual 768	com/tencent/mobileqq/persistence/EntityTransaction:begin	()V
    //   358: aload 7
    //   360: aload 10
    //   362: aconst_null
    //   363: aconst_null
    //   364: invokevirtual 772	com/tencent/mobileqq/app/SQLiteDatabase:delete	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    //   367: pop
    //   368: aload 6
    //   370: ifnull +8 -> 378
    //   373: aload 6
    //   375: invokevirtual 775	com/tencent/mobileqq/persistence/EntityTransaction:commit	()V
    //   378: aload 6
    //   380: ifnull +48 -> 428
    //   383: aload 6
    //   385: invokevirtual 778	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   388: goto +40 -> 428
    //   391: astore 5
    //   393: goto +53 -> 446
    //   396: astore 5
    //   398: aload 5
    //   400: invokevirtual 781	java/lang/Exception:printStackTrace	()V
    //   403: invokestatic 49	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   406: ifeq +14 -> 420
    //   409: ldc 69
    //   411: iconst_2
    //   412: ldc_w 783
    //   415: aload 5
    //   417: invokestatic 225	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   420: aload 6
    //   422: ifnull +6 -> 428
    //   425: goto -42 -> 383
    //   428: aload 9
    ...
    //   437: aconst_null
    //   438: aconst_null
    //   439: invokevirtual 785	com/tencent/mobileqq/persistence/qslowtable/QSlowTableManager:a	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    //   442: pop
    //   443: goto +16 -> 459
    //   446: aload 6
    //   448: ifnull +8 -> 456
    //   451: aload 6
    //   453: invokevirtual 778	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   456: aload 5
    //   458: athrow
    //   459: iload_1
    //   460: iconst_1
