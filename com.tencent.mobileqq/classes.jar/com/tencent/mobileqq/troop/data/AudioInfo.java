  ...
  implements Serializable, Cloneable
{
  ...
  public View getView(Context paramContext, View.OnClickListener paramOnClickListener)
  {
    ...
    View localView = LayoutInflater.from(paramContext).inflate(2130969472, null);
    RelativeLayout localRelativeLayout = (RelativeLayout)localView.findViewById(2131366607);
    ...
    for (localLayoutParams.width = ((int)DisplayUtils.a(paramContext, i));; localLayoutParams.width = ((int)DisplayUtils.a(paramContext, this.mMaxLayoutLength)))
    {
      ...
      localView.findViewById(2131366610).setOnClickListener(paramOnClickListener);
      this.mAudioIcon = ((ImageView)localView.findViewById(2131366608));
      this.mAudioIcon.setOnClickListener(paramOnClickListener);
      paramContext = (TextView)localView.findViewById(2131366609);
