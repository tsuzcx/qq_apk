  ...
  extends TroopAioAgent
{
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if (localObject != null)
      {
        ...
        if (localObject != null)
        {
          ...
          localLayoutParams.addRule(3, 2131362425);
        }
      }
    }
    for (;;)
    {
      ...
      break;
      label101:
      int i = TroopAioMsgNavigateBar.a(this.jdField_a_of_type_AndroidWidgetRelativeLayout, new int[] { 2131363527, 2131362153, 2131362130 });
      if (i > 0) {
  ...
  protected void c()
  {
    ...
    this.jdField_a_of_type_AndroidViewGestureDetector = new GestureDetector(this.jdField_a_of_type_AndroidContentContext, new ajig(this));
  }
