  ...
  implements View.OnClickListener
{
  ...
  public TroopEntranceBar()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppFriendListObserver = new aipt(this);
  }
  ...
  public void a(long paramLong, int paramInt)
  {
    ...
    ProtoUtils.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new aipr(this, paramLong), localReqBody.toByteArray(), "OidbSvc.0x487_0", 1159, paramInt);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext, Observer paramObserver, SessionInfo paramSessionInfo, RelativeLayout paramRelativeLayout, ChatAdapter1 paramChatAdapter1, ChatXListView paramChatXListView)
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null) {
      this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131363490);
    }
    ...
    this.d = paramContext.getResources().getColor(2131493581);
    this.e = paramContext.getResources().getColor(2131493582);
  ...
  public void b()
  {
    ...
    if (this.jdField_c_of_type_AndroidViewView == null) {
      this.jdField_c_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130969837, null);
    }
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout.indexOfChild(this.jdField_c_of_type_AndroidViewView) == -1)
    {
      ...
      ((RelativeLayout.LayoutParams)localObject).addRule(3, 2131363490);
    ...
    if (ThemeUtil.isInNightMode(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {
      this.jdField_b_of_type_AndroidViewView.setBackgroundResource(2130846144);
    }
    for (;;)
    {
      this.jdField_c_of_type_AndroidGraphicsDrawableDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841237);
      this.jdField_b_of_type_AndroidViewView.setOnClickListener(this);
      this.jdField_a_of_type_Boolean = true;
      c();
      this.jdField_c_of_type_AndroidViewView.setVisibility(8);
      ThreadManager.post(new aipp(this), 8, null, true);
      return;
      this.jdField_b_of_type_AndroidViewView.setBackgroundResource(2130846145);
    }
  }
  ...
  public void c()
  {
    ...
    ImageView localImageView = (ImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131368211);
    ...
    Drawable localDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841238);
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(2131430754);
  }
  ...
  {
    ThreadManager.post(new aipq(this), 8, null, true);
  }
}
