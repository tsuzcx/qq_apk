  ...
  implements View.OnClickListener
{
  ...
  private void a(MessageRecord paramMessageRecord, TroopAioKeywordTipInfo paramTroopAioKeywordTipInfo)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipBar$ViewHolder == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipBar$ViewHolder.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560719, null));
      ...
      this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipBar$ViewHolder.jdField_a_of_type_ComTencentWidgetURLThemeImageView = ((URLThemeImageView)this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipBar$ViewHolder.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131379816));
      this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipBar$ViewHolder.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipBar$ViewHolder.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131379819));
      this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipBar$ViewHolder.b = ((TextView)this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipBar$ViewHolder.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131379818));
      this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipBar$ViewHolder.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipBar$ViewHolder.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131379815));
      this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipBar$ViewHolder.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130851170);
    }
    this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipBar$ViewHolder.jdField_a_of_type_AndroidViewViewGroup.setBackgroundResource(2130844110);
    for (;;)
    {
      try
      {
  ...
  {
    if ((!this.jdField_a_of_type_Boolean) || (this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipBar$ViewHolder == null) || (!this.jdField_b_of_type_Boolean) || (this.jdField_a_of_type_AndroidWidgetRelativeLayout.indexOfChild(this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipBar$ViewHolder.jdField_a_of_type_AndroidViewViewGroup) < 0)) {}
    ...
    } while (this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipBar$ViewHolder.jdField_a_of_type_AndroidViewViewGroup.getAnimation() != null);
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipBar$ViewHolder != null) {
      return this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipBar$ViewHolder.jdField_a_of_type_AndroidViewViewGroup;
    }
    return null;
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = ((String)localObject1).replace("$TEXT$", Base64Util.encodeToString(((MessageForText)this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord).sb.toString().getBytes(), 0));
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.isSend())
      {
        ...
        ((ReportTask)localObject2).d((String)localObject1).a(new String[] { this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.frienduin, String.valueOf(this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipInfo.ruleId), this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.getExtInfoFromExtStr("key_aio_keyword") }).a();
        b(true);
        break;
        ...
        localObject1 = ((String)localObject1).replace("$TEXT$", Base64Util.encodeToString(((AbsShareMsg)((MessageForStructing)localObject2).structingMsg).mContentTitle.getBytes(), 0));
        continue;
