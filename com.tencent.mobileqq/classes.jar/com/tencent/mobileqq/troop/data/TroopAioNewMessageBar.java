  ...
  implements Animation.AnimationListener
{
  ...
  public static int j;
  protected static final int m = (int)BaseApplicationImpl.getApplication().getResources().getDimension(2131558420);
  protected float a;
  protected Handler a;
  ...
  public TroopAioNewMessageBar()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new aiow(this);
  }
  ...
  private void a(TextView paramTextView, int paramInt)
  {
    ...
    if (paramInt == e)
    {
      paramTextView.setText(2131430170);
      paramTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130840390, 0);
