  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 24, 34, 40, 160018, 160072, 160248, 322176, 322504, 322512, 324328, 324336, 332856, 332872, 332880, 332888, 332904, 332912, 332944, 332952, 332976, 332984, 336600, 337024, 337376, 338312, 338584, 338664, 338720, 338848, 338888, 338936, 339016 }, new String[] { "rpt_uint64_uins", "uint32_max_package_size", "rpt_bytes_openid", "uint32_appid", "str_nick", "uint32_gender", "uint32_birthday", "uint32_profile_company_visible", "uint32_profile_interest_switch", "uint32_profile_music_switch", "uint32_ueflag", "uint32_parent_allow_flag", "uint32_profile_birthday_visible", "uint32_profile_constellation_visible", "uint32_profile_age_visible", "uint32_profile_sex_visible", "uint32_profile_hometown_visible", "uint32_profile_location_visible", "uint32_profile_profession_visible", "uint32_profile_college_visible", "uint32_profile_email_visible", "uint32_profile_personal_note_visible", "uint32_req_medalwall_flag", "uint32_profile_personality_label_switch", "uint32_extend_friend_card_shown", "uint32_profile_present_switch", "uint32_profile_miniapp_switch", "user_login_guard_face", "uint32_profile_musicbox_switch", "uint32_profile_sticky_note_switch", "uint32_profile_qqcircle_switch", "uint32_flag_profile_life_achievement_switch", "uint32_flag_profile_weishi_switch" }, new Object[] { Long.valueOf(0L), Integer.valueOf(0), localByteStringMicro, Integer.valueOf(0), "", Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0) }, ReqBody.class);
  }
}
