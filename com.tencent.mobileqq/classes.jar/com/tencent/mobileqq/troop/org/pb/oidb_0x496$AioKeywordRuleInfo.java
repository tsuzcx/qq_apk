  ...
  extends MessageMicro<AioKeywordRuleInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 48 }, new String[] { "rule_id", "start_time", "end_time", "postion_flag", "match_group_class", "version" }, new Object[] { localInteger, localInteger, localInteger, localInteger, localInteger, localInteger }, AioKeywordRuleInfo.class);
  }
}
