...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 34, 42, 48 }, new String[] { "uint32_display_flag", "str_hori_bar_content", "str_change_mibao_url", "str_tips_header", "str_tips_content", "uint32_next_access_time" }, new Object[] { Integer.valueOf(0), "", "", "", "", Integer.valueOf(0) }, RspBody.class);
