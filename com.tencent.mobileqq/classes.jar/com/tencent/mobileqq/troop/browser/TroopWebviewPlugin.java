  ...
  implements TroopMemberApiClient.Callback
{
  ...
  private void g(String paramString)
  {
    ...
    ((QQProgressDialog)localObject).setOnDismissListener(new ajfv(this));
  ...
  private void h(String paramString)
  {
    ...
    {
      QQToast.a((Context)localObject, 2131433227, 0).b(((BaseActivity)localObject).getTitleBarHeight());
      return;
    }
    g(((BaseActivity)localObject).getString(2131435565));
  ...
  private void j(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localIntent.putExtra("param_title", this.mRuntime.a().getString(2131433685));
        localIntent.putExtra("param_done_button_wording", this.mRuntime.a().getString(2131433030));
        localIntent.putExtra("param_done_button_highlight_wording", this.mRuntime.a().getString(2131435062));
        localIntent.putExtra("param_only_friends", true);
      ...
      catch (JSONException localJSONException1)
      {
        try
        {
          ...
          if (!TextUtils.isEmpty(paramString))
          {
            ...
            paramString.putString("troop_info_title", localActivity.getString(2131429858));
  ...
  private void m(String paramString)
  {
    ...
    g(((Activity)localObject).getString(2131435572));
    localObject = new Intent((Context)localObject, TroopCreateLogicActivity.class);
  ...
  public void b()
  {
    ...
    localActionSheet.a(2131435570);
    localActionSheet.a(2131435571, 3);
    localActionSheet.c(2131433029);
    localActionSheet.setOnDismissListener(new ajfw(this));
    localActionSheet.a(new ajfx(this));
  ...
  public void b(String paramString)
  {
    ...
    if (!NetworkUtil.d(localBaseActivity)) {
      QQToast.a(localBaseActivity, 2131433227, 0).b(localBaseActivity.getTitleBarHeight());
    }
  ...
  protected boolean handleJsRequest(com.tencent.mobileqq.webview.swift.JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    //   1124: aload_0
    //   1125: aload_3
    //   1126: invokespecial 744	ajft:<init>	(Lcom/tencent/mobileqq/troop/browser/TroopWebviewPlugin;Ljava/lang/String;)V
    ...
    //   1493: aload_0
    //   1494: aload_1
    //   1495: invokespecial 801	ajfu:<init>	(Lcom/tencent/mobileqq/troop/browser/TroopWebviewPlugin;Ljava/lang/String;)V
    //   1498: ldc2_w 802
  ...
  public void onActivityResult(Intent paramIntent, byte paramByte, int paramInt)
  {
    ...
    {
      if (bool) {
        QQToast.a((Context)localObject2, 2131435575, 0).b(((BaseActivity)localObject2).getTitleBarHeight());
      }
      for (;;)
      {
        ...
        return;
        QQToast.a((Context)localObject2, 2131435573, 0).b(((BaseActivity)localObject2).getTitleBarHeight());
      }
    }
    if (paramByte == 1002) {
      paramIntent = ((BaseActivity)localObject2).getString(2131435577);
    }
    for (;;)
    {
      ...
      return;
      if (bool) {
        paramIntent = ((BaseActivity)localObject2).getString(2131435576);
      } else {
        paramIntent = ((BaseActivity)localObject2).getString(2131435574);
      }
    }
  }
