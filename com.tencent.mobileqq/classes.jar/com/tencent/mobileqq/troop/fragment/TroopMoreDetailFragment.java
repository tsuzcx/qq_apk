  ...
  implements akgw, View.OnClickListener, aobv
{
  ...
  anxg jdField_a_of_type_Anxg = new beym(this);
  protected aobu a;
  ...
  private String a(long paramLong)
  {
    ...
    if (paramLong > 0L)
    {
      ...
      localObject = getResources().getString(2131695429) + ((SimpleDateFormat)localObject).format(Long.valueOf(1000L * paramLong));
    }
    return localObject;
  }
  ...
  private void a()
  {
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)a(2131367826));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)a(2131379323));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)a(2131379369));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)a(2131379195));
    this.c = ((TextView)a(2131379283));
    this.jdField_a_of_type_ComTencentMobileqqTroopWidgetExpandableTextView = ((ExpandableTextView)a(2131379256));
    this.jdField_a_of_type_ComTencentMobileqqTroopWidgetTroopMoreDetailView = ((TroopMoreDetailView)a(2131379321));
    this.d = ((TextView)a(2131379366));
    this.e = ((TextView)a(2131379331));
  }
  
  private void a(boolean paramBoolean)
  {
    Object localObject1 = aqxg.c();
    ...
    {
      paramBoolean = anxa.c(this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.groupFreezeReason);
      int i;
      if (this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.bOwner)
      {
        ...
        if (paramBoolean)
        {
          ...
          String str3 = anni.a(2131714334);
          beyn localbeyn = new beyn(this, paramBoolean);
          if (!paramBoolean) {
            break label167;
          }
          ...
          i = 1;
          label120:
          VipUtils.a((Context)localObject2, str1, str2, str3, localbeyn, (String)localObject1, i, paramBoolean);
        }
      }
      for (;;)
      {
    ...
    if (!paramBoolean)
    {
      localObject2 = abga.a(this.jdField_a_of_type_AndroidWidgetImageView);
      if (localObject2 != null) {
        ((Bundle)localObject1).putParcelable("KEY_THUMBNAL_BOUND", (Parcelable)localObject2);
      }
    }
    a((Bundle)localObject1);
    bcst.b(a(), "P_CliOper", "Grp_set", "", "Grp_Admin_data", "nonmber_Clk_head", 0, 0, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, "", "", "");
    ...
    {
      bgjt.a("Grp_set_new", "grpData_admin", "clk_head", 0, 0, new String[] { localObject2, localObject1 });
      return;
    }
  }
  ...
  private void b()
  {
    ...
    azml.a(this.jdField_a_of_type_AndroidWidgetTextView, anni.a(2131714342));
    this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_JavaLangString);
    azml.a(this.jdField_b_of_type_AndroidWidgetTextView, anni.a(2131714343));
    ...
    this.jdField_a_of_type_ComTencentMobileqqTroopWidgetExpandableTextView.setText(new bdnt(str1, 11, 15));
    this.jdField_a_of_type_ComTencentMobileqqTroopWidgetExpandableTextView.a().setEditableFactory(bdod.a);
    ...
    this.jdField_a_of_type_ComTencentMobileqqTroopWidgetExpandableTextView.setOnExpandStateChangeListener(new beyl(this));
    int i;
    if ((this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.dwGroupFlagExt & 0x800) != 0L) {
      if ((this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.dwAuthGroupType == 2L) || (this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.dwAuthGroupType == 1L))
      {
        ...
        str1 = String.format(getResources().getString(2131693046), new Object[] { Integer.valueOf(i) });
        this.c.setText(str1);
    ...
    for (;;)
    {
      ...
      for (i = 1;; i = 0)
      {
        ...
        this.e.setText(getResources().getString(2131693047));
        this.e.setContentDescription(getResources().getString(2131693047));
        break;
        ...
        {
          this.d.setText(getString(2131695579));
          break label474;
        }
  ...
  private void c()
  {
    ...
    ((anwd)localObject).a(1, anie.a(this.jdField_a_of_type_JavaLangString), 0L, 2, 6, 0, false);
  }
  ...
  public void doOnCreateView(LayoutInflater paramLayoutInflater, @Nullable ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    paramLayoutInflater.addObserver(this.jdField_a_of_type_Anxg);
    a();
    b();
    c();
  }
  ...
  public void init(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_Aobu = new aobu(paramBundle, paramBundle.getAppInterface());
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      bcst.b((QQAppInterface)localObject2, "dc00899", "Grp_set_new", "", "grpData_admin", "clk_image", 0, 0, str, "0", (String)localObject1, "");
      break;
      ...
      {
        this.jdField_a_of_type_Akgq = new akgn(getActivity(), getActivity(), (QQAppInterface)localObject2, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin);
  ...
  public void onDestroyView()
  {
    ...
    localFragmentActivity.removeObserver(this.jdField_a_of_type_Anxg);
    if (this.jdField_a_of_type_Aobu != null) {
  ...
  public void onNewIntent(Intent paramIntent)
  {
    ...
    if ((!TextUtils.isEmpty(str)) && (this.jdField_a_of_type_Akgq != null))
    {
      if (QLog.isColorLevel()) {
