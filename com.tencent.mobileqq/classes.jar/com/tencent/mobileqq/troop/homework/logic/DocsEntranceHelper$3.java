...
public class DocsEntranceHelper$3
  implements Runnable
{
  public DocsEntranceHelper$3(bgbn parambgbn, boolean paramBoolean, int paramInt) {}
  
  public void run()
  {
    Object localObject = PreferenceManager.getDefaultSharedPreferences(this.this$0.a.getActivity());
    int i = ((SharedPreferences)localObject).getInt(bgbn.a(this.this$0), 0);
    if (QLog.isColorLevel()) {
      QLog.d("DocsEntranceHelper", 2, String.format("onShow guide count: %s", new Object[] { Integer.valueOf(i) }));
    }
    localObject = ((SharedPreferences)localObject).edit();
    if (this.jdField_a_of_type_Boolean) {
      ((SharedPreferences.Editor)localObject).putInt(bgbn.a(this.this$0), i + this.jdField_a_of_type_Int).commit();
    }
    for (;;)
    {
      ((SharedPreferences.Editor)localObject).apply();
      return;
      ((SharedPreferences.Editor)localObject).putInt(bgbn.a(this.this$0), this.jdField_a_of_type_Int).commit();
    }
  }
}
