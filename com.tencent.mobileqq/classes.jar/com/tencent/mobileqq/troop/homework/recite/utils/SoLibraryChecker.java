...
public class SoLibraryChecker
{
  ...
  private void a(JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      SoLibraryChecker.3 local3 = new SoLibraryChecker.3(this, str, bool2, bool1);
      if (!TextUtils.isEmpty(str)) {
        ThreadManager.post(new SoLibraryChecker.4(this, paramJSONObject, str, local3), 8, null, false);
      }
      return;
      if ((i == 3) || (i == 2))
      {
  ...
  private void c()
  {
    ...
    long l = System.currentTimeMillis();
    if ((!HtmlOffline.a(BaseApplicationImpl.getContext(), str, new SoLibraryChecker.2(this, l))) && (QLog.isColorLevel())) {
