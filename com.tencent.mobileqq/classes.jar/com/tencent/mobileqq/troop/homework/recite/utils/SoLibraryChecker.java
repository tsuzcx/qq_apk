...
public class SoLibraryChecker
{
  ...
  private void a(JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      ajro localajro = new ajro(this, str, bool2, bool1);
      if (!TextUtils.isEmpty(str)) {
        ThreadManager.post(new ajrp(this, paramJSONObject, str, localajro), 8, null, false);
      }
      return;
      if ((i == 3) || (i == 2))
      {
  ...
  private void b()
  {
    ...
    HtmlOffline.a(this.jdField_a_of_type_JavaLangString, localQQAppInterface, new ajrm(this), false);
  }
  ...
  private void c()
  {
    ...
    long l = System.currentTimeMillis();
    if ((!HtmlOffline.a(BaseApplicationImpl.getContext(), str, new ajrn(this, l))) && (QLog.isColorLevel())) {
