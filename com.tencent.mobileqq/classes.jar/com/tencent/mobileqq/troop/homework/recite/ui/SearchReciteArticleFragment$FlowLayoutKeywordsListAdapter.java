  ...
  extends BaseAdapter
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      paramView = LayoutInflater.from(paramViewGroup.getContext()).inflate(2130969911, null, false);
      paramViewGroup = new aivp(this, null);
    ...
    for (;;)
    {
      ...
      return paramView;
      paramViewGroup = (aivp)paramView.getTag();
    }
  }
}
