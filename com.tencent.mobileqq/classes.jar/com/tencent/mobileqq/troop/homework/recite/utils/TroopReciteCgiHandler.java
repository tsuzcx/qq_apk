...
public class TroopReciteCgiHandler
{
  public HttpWebCgiAsyncTask2 a(QQAppInterface paramQQAppInterface, HttpWebCgiAsyncTask.Callback paramCallback, String paramString, int paramInt)
  {
    ...
    for (localObject = ((TicketManager)localObject).getSkey(str);; localObject = null)
    {
      ...
      paramQQAppInterface = new HttpWebCgiAsyncTask2("https://qun.qq.com/cgi-bin/qun/web/kewen/get_search_keywords", "POST", paramCallback, paramInt, localBundle);
  ...
  public HttpWebCgiAsyncTask2 a(QQAppInterface paramQQAppInterface, HttpWebCgiAsyncTask.Callback paramCallback, String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    for (localObject = ((TicketManager)localObject).getSkey(str);; localObject = null)
    {
      ...
      localHashMap.put("BUNDLE", localBundle);
      localHashMap.put("CONTEXT", paramQQAppInterface.getApp().getApplicationContext());
      paramQQAppInterface = new HttpWebCgiAsyncTask2("https://qun.qq.com/cgi-bin/qun/web/kewen/search", "POST", paramCallback, paramInt3, localBundle);
      paramQQAppInterface.a(localHashMap);
      return paramQQAppInterface;
    }
  }
  
  public HttpWebCgiAsyncTask2 a(QQAppInterface paramQQAppInterface, HttpWebCgiAsyncTask.Callback paramCallback, String paramString, List<Integer> paramList, int paramInt)
  {
    Object localObject = (TicketManager)paramQQAppInterface.getManager(2);
    String str = paramQQAppInterface.getCurrentAccountUin();
    if (localObject != null) {}
    for (localObject = ((TicketManager)localObject).getSkey(str);; localObject = null)
    {
      ...
      localHashMap.put("BUNDLE", localBundle);
      localHashMap.put("CONTEXT", paramQQAppInterface.getApp().getApplicationContext());
      paramQQAppInterface = new HttpWebCgiAsyncTask2("https://qun.qq.com/cgi-bin/qun/web/kewen/get_kewen_info", "POST", paramCallback, paramInt, localBundle);
      paramQQAppInterface.a(localHashMap);
      return paramQQAppInterface;
    }
  }
