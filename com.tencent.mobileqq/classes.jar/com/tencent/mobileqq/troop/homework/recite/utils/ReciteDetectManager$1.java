...
class ReciteDetectManager$1
  extends Handler
{
  ReciteDetectManager$1(ReciteDetectManager paramReciteDetectManager, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  {
    if (this.a.jdField_a_of_type_ComTencentMobileqqTroopHomeworkReciteUtilsReciteDetectManager$ReciteDetectListener == null) {}
    ...
    do
    {
      ...
      case 0: 
        ...
        this.a.jdField_a_of_type_ComTencentMobileqqTroopHomeworkReciteUtilsReciteDetectManager$ReciteDetectListener.a(localWordInfo);
    ...
    for (i = 0; i != 0; i = 1)
    {
      ...
      i += 1;
      break label148;
      this.a.jdField_a_of_type_ComTencentMobileqqTroopHomeworkReciteUtilsReciteDetectManager$ReciteDetectListener.g();
      return;
      this.a.jdField_a_of_type_ComTencentMobileqqTroopHomeworkReciteUtilsReciteDetectManager$ReciteDetectListener.a(this.a.jdField_a_of_type_Int, this.a.b, this.a.c);
 ...
 * Qualified Name:     com.tencent.mobileqq.troop.homework.recite.utils.ReciteDetectManager.1
