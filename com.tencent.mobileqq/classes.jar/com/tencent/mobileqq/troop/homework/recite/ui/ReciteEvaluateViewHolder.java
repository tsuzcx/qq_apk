...
public class ReciteEvaluateViewHolder
{
  ...
  public ReciteEvaluateViewHolder(Context paramContext, ViewGroup paramViewGroup)
  {
    ...
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(paramContext).inflate(2131560794, paramViewGroup, false);
    e();
  ...
  private void a(String paramString)
  {
    ...
    paramString.setDownloadListener(new ReciteEvaluateViewHolder.3(this));
  ...
  private void e()
  {
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131381110);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131380267));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369644));
    this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131381098);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131380710));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131380337));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131380564));
    this.jdField_d_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131381099);
    this.e = this.jdField_a_of_type_AndroidViewView.findViewById(2131381101);
    this.f = this.jdField_a_of_type_AndroidViewView.findViewById(2131381112);
    this.g = this.jdField_a_of_type_AndroidViewView.findViewById(2131377203);
    this.jdField_a_of_type_ComTencentMobileqqSurfaceviewactionGlSpriteVideoView = ((SpriteVideoView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378753));
  }
  ...
  public void a(boolean paramBoolean, String paramString, int paramInt1, long paramLong, int paramInt2, int paramInt3)
  {
    ...
    int j = 2130844040;
    int i = paramString.getColor(2131165357);
    paramInt1 -= 1;
    int k;
    ...
    default: 
      ...
      if (this.jdField_a_of_type_AndroidWidgetImageView.getMeasuredHeight() > 0)
      {
        ...
        this.jdField_b_of_type_AndroidWidgetTextView.setText(a(HardCodeUtil.a(2131713181), paramString.toString(), paramInt1));
        this.jdField_c_of_type_AndroidWidgetTextView.setTextColor(i);
        this.jdField_c_of_type_AndroidWidgetTextView.setText(a(HardCodeUtil.a(2131713179), String.valueOf(paramInt2), paramInt1));
        this.jdField_d_of_type_AndroidWidgetTextView.setTextColor(i);
        this.jdField_d_of_type_AndroidWidgetTextView.setText(a(HardCodeUtil.a(2131713180), String.valueOf(paramInt3), paramInt1));
        if (this.g.getMeasuredHeight() != 0) {
          break label440;
        }
        this.g.getViewTreeObserver().addOnGlobalLayoutListener(new ReciteEvaluateViewHolder.2(this, paramBoolean));
      }
      break;
    }
    for (;;)
    {
      ...
      break;
      paramInt1 = paramString.getColor(2131167374);
      m = 2130844021;
      j = 2130844039;
      i = paramInt1;
      break;
      ...
      i = paramInt1;
      break;
      this.jdField_a_of_type_AndroidWidgetImageView.getViewTreeObserver().addOnGlobalLayoutListener(new ReciteEvaluateViewHolder.1(this, str2));
      break label168;
      label440:
  ...
  public void c()
  {
    ...
    if ((localObject1 instanceof QQAppInterface)) {
      VideoAnimationUtils.a((QQAppInterface)localObject1, "qb_troop_hw_recite_result.mp4", "https://pub.idqqimg.com/pc/misc/files/20180312/59583551a1c748dfaae1e64f6e04ca20.mp4");
    }
