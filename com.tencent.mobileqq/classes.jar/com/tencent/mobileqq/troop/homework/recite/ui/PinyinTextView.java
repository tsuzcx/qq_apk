  ...
  extends TextView
{
  ...
  bgbt jdField_a_of_type_Bgbt = new bgbt(this);
  ...
  private final String jdField_b_of_type_JavaLangString = anzj.a(2131707057);
  ...
  public PinyinTextView(ReciteDisplayView paramReciteDisplayView, Context paramContext, int paramInt)
  {
    ...
    this.i = bhmg.a(getContext(), 10.0F);
    if (a()) {
      this.j = bhmg.a(getContext(), 18.6F);
    }
    for (this.k = bhmg.a(getContext(), 18.0F);; this.k = bhmg.a(getContext(), 12.0F))
    {
      this.g = this.k;
      a();
      return;
      this.j = bhmg.a(getContext(), 0.5F);
    }
  }
  ...
  float a(int paramInt)
  {
    ...
    f1 = f2 + this.j;
    if (f1 < this.h) {
      return bhmg.a(getContext(), f1 / 2.0F) + (this.jdField_a_of_type_Float + this.j);
    }
    return bhmg.a(getContext(), f1 / 2.0F);
  }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_AndroidTextTextPaint.setTextSize(bhmg.a(getContext(), this.jdField_c_of_type_Int));
    this.jdField_b_of_type_AndroidTextTextPaint.setStrokeWidth(f1);
    this.jdField_b_of_type_AndroidTextTextPaint.setTextSize(bhmg.a(getContext(), this.jdField_c_of_type_Int) / 2.0F);
  ...
  public void a(int paramInt, bgbt parambgbt)
  {
    boolean bool3 = false;
    if ((this.jdField_e_of_type_Int == 1) && (paramInt == 0)) {
      parambgbt.jdField_a_of_type_Float += 2.0F * (this.jdField_a_of_type_Float + this.j);
    }
    ...
    float f1 = parambgbt.jdField_a_of_type_Float;
    ...
    if (localWordInfo1 == null)
    {
      ...
      if (f1 + (f2 + f3) - this.j <= parambgbt.jdField_a_of_type_Int - this.l) {
        break label321;
      }
    ...
    for (;;)
    {
      if ((f2 - this.j > parambgbt.jdField_a_of_type_Int - this.l) || (bool2) || (bool3) || (bool1))
      {
        f2 = this.l;
        if (!a()) {
          break label302;
      ...
      {
        parambgbt.jdField_a_of_type_Float = (f1 + f2);
        parambgbt.jdField_b_of_type_Float = (parambgbt.jdField_b_of_type_Float + this.k + this.jdField_a_of_type_Float + this.jdField_c_of_type_Float + this.i);
        return;
  ...
  public void b(int paramInt, bgbt parambgbt)
  {
    WordInfo localWordInfo2 = (WordInfo)this.jdField_a_of_type_JavaUtilList.get(paramInt);
    WordInfo localWordInfo1 = null;
    paramInt += 1;
    ...
    parambgbt.jdField_a_of_type_Float = (parambgbt.jdField_a_of_type_Float + a(localWordInfo2.text) + this.j);
    if (((localWordInfo2.text.equalsIgnoreCase("…")) || (localWordInfo2.text.equalsIgnoreCase("─")) || (localWordInfo2.text.equalsIgnoreCase("-"))) && (localWordInfo1 != null) && (localWordInfo1.text.equalsIgnoreCase(localWordInfo2.text))) {
      parambgbt.jdField_a_of_type_Float = (parambgbt.jdField_a_of_type_Float - this.j - a(localWordInfo2.text) + this.jdField_b_of_type_Float);
    }
  }
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    {
      bgbt.a(this.jdField_a_of_type_Bgbt);
      this.jdField_a_of_type_Bgbt.jdField_b_of_type_Float = (this.jdField_a_of_type_Float + this.k + this.jdField_c_of_type_Float + this.i);
      this.jdField_a_of_type_Bgbt.jdField_a_of_type_Int = getWidth();
      Object localObject = this.jdField_a_of_type_Bgbt;
      float f2 = this.l;
      if (a()) {
        f1 = 0.0F * this.jdField_a_of_type_Float;
      }
      ((bgbt)localObject).jdField_a_of_type_Float = (f1 + f2);
      int m = 0;
      while (m < this.jdField_a_of_type_JavaUtilList.size())
      {
        ...
        a(m, this.jdField_a_of_type_Bgbt);
        if (!TextUtils.isEmpty(((WordInfo)localObject).text))
        {
          if ((((WordInfo)localObject).isNormalWord()) && (a()))
          {
            ...
            f1 = this.jdField_a_of_type_Bgbt.jdField_a_of_type_Float;
            f2 = (this.jdField_a_of_type_Float - f2) / 2.0F;
            paramCanvas.drawText(((WordInfo)localObject).pinyin2Display.substring(0, ((WordInfo)localObject).pinyin2Display.length()), f2 + f1, this.jdField_a_of_type_Bgbt.jdField_b_of_type_Float - this.jdField_a_of_type_Float - this.i, this.jdField_b_of_type_AndroidTextTextPaint);
          }
          paramCanvas.drawText(((WordInfo)localObject).text, this.jdField_a_of_type_Bgbt.jdField_a_of_type_Float, this.jdField_a_of_type_Bgbt.jdField_b_of_type_Float, this.jdField_a_of_type_AndroidTextTextPaint);
          b(m, this.jdField_a_of_type_Bgbt);
          WordInfo localWordInfo = this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkReciteUiReciteDisplayView.a();
          f1 = getTop() + this.jdField_a_of_type_Bgbt.jdField_b_of_type_Float + this.jdField_c_of_type_Float + this.i + this.jdField_a_of_type_Float;
      ...
      for (;;)
      {
        ...
        else if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.size() != 0))
        {
          ...
          if (!a())
          {
            this.l = a(m);
            bgbt.a(this.jdField_a_of_type_Bgbt);
            this.jdField_a_of_type_Bgbt.jdField_a_of_type_Int = m;
            this.jdField_a_of_type_Bgbt.jdField_b_of_type_Float = (this.jdField_a_of_type_Float + this.k + this.jdField_c_of_type_Float + this.i);
            localObject = this.jdField_a_of_type_Bgbt;
            f2 = this.l;
            if (!a()) {
              break label385;
            }
          ...
          for (float f1 = this.jdField_a_of_type_Float * 0.0F;; f1 = 0.0F)
          {
            ...
            {
              a(paramInt1, this.jdField_a_of_type_Bgbt);
              b(paramInt1, this.jdField_a_of_type_Bgbt);
              paramInt1 += 1;
            }
            f1 = paramInt1;
          ...
          f1 = this.jdField_a_of_type_Bgbt.jdField_b_of_type_Float;
