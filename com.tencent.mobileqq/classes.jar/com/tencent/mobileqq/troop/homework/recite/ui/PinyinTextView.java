  ...
  extends TextView
{
  ...
  ayxn jdField_a_of_type_Ayxn = new ayxn(this);
  ...
  private final String jdField_b_of_type_JavaLangString = ajjy.a(2131642392);
  ...
  public PinyinTextView(ReciteDisplayView paramReciteDisplayView, Context paramContext, int paramInt)
  {
    ...
    this.i = bacc.a(getContext(), 10.0F);
    if (a()) {
      this.j = bacc.a(getContext(), 18.6F);
    }
    for (this.k = bacc.a(getContext(), 18.0F);; this.k = bacc.a(getContext(), 12.0F))
    {
      this.g = this.k;
      a();
      return;
      this.j = bacc.a(getContext(), 0.5F);
    }
  }
  ...
  float a(int paramInt)
  {
    ...
    f1 = f2 + this.j;
    if (f1 < this.h) {
      return bacc.a(getContext(), f1 / 2.0F) + (this.jdField_a_of_type_Float + this.j);
    }
    return bacc.a(getContext(), f1 / 2.0F);
  }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_AndroidTextTextPaint.setTextSize(bacc.a(getContext(), this.jdField_c_of_type_Int));
    this.jdField_b_of_type_AndroidTextTextPaint.setStrokeWidth(f1);
    this.jdField_b_of_type_AndroidTextTextPaint.setTextSize(bacc.a(getContext(), this.jdField_c_of_type_Int) / 2.0F);
  ...
  public void a(int paramInt, ayxn paramayxn)
  {
    boolean bool3 = false;
    if ((this.jdField_e_of_type_Int == 1) && (paramInt == 0)) {
      paramayxn.jdField_a_of_type_Float += 2.0F * (this.jdField_a_of_type_Float + this.j);
    }
    ...
    float f1 = paramayxn.jdField_a_of_type_Float;
    ...
    if (localWordInfo1 == null)
    {
      ...
      if (f1 + (f2 + f3) - this.j <= paramayxn.jdField_a_of_type_Int - this.l) {
        break label321;
      }
    ...
    for (;;)
    {
      if ((f2 - this.j > paramayxn.jdField_a_of_type_Int - this.l) || (bool2) || (bool3) || (bool1))
      {
        f2 = this.l;
        if (!a()) {
          break label302;
      ...
      {
        paramayxn.jdField_a_of_type_Float = (f1 + f2);
        paramayxn.jdField_b_of_type_Float = (paramayxn.jdField_b_of_type_Float + this.k + this.jdField_a_of_type_Float + this.jdField_c_of_type_Float + this.i);
        return;
  ...
  public void b(int paramInt, ayxn paramayxn)
  {
    WordInfo localWordInfo2 = (WordInfo)this.jdField_a_of_type_JavaUtilList.get(paramInt);
    WordInfo localWordInfo1 = null;
    paramInt += 1;
    ...
    paramayxn.jdField_a_of_type_Float = (paramayxn.jdField_a_of_type_Float + a(localWordInfo2.text) + this.j);
    if (((localWordInfo2.text.equalsIgnoreCase("…")) || (localWordInfo2.text.equalsIgnoreCase("─")) || (localWordInfo2.text.equalsIgnoreCase("-"))) && (localWordInfo1 != null) && (localWordInfo1.text.equalsIgnoreCase(localWordInfo2.text))) {
      paramayxn.jdField_a_of_type_Float = (paramayxn.jdField_a_of_type_Float - this.j - a(localWordInfo2.text) + this.jdField_b_of_type_Float);
    }
  }
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    {
      ayxn.a(this.jdField_a_of_type_Ayxn);
      this.jdField_a_of_type_Ayxn.jdField_b_of_type_Float = (this.jdField_a_of_type_Float + this.k + this.jdField_c_of_type_Float + this.i);
      this.jdField_a_of_type_Ayxn.jdField_a_of_type_Int = getWidth();
      Object localObject = this.jdField_a_of_type_Ayxn;
      float f2 = this.l;
      if (a()) {
        f1 = 0.0F * this.jdField_a_of_type_Float;
      }
      ((ayxn)localObject).jdField_a_of_type_Float = (f1 + f2);
      int m = 0;
      while (m < this.jdField_a_of_type_JavaUtilList.size())
      {
        ...
        a(m, this.jdField_a_of_type_Ayxn);
        if (!TextUtils.isEmpty(((WordInfo)localObject).text))
        {
          if ((((WordInfo)localObject).isNormalWord()) && (a()))
          {
            ...
            f1 = this.jdField_a_of_type_Ayxn.jdField_a_of_type_Float;
            f2 = (this.jdField_a_of_type_Float - f2) / 2.0F;
            paramCanvas.drawText(((WordInfo)localObject).pinyin2Display.substring(0, ((WordInfo)localObject).pinyin2Display.length()), f2 + f1, this.jdField_a_of_type_Ayxn.jdField_b_of_type_Float - this.jdField_a_of_type_Float - this.i, this.jdField_b_of_type_AndroidTextTextPaint);
          }
          paramCanvas.drawText(((WordInfo)localObject).text, this.jdField_a_of_type_Ayxn.jdField_a_of_type_Float, this.jdField_a_of_type_Ayxn.jdField_b_of_type_Float, this.jdField_a_of_type_AndroidTextTextPaint);
          b(m, this.jdField_a_of_type_Ayxn);
          WordInfo localWordInfo = this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkReciteUiReciteDisplayView.a();
          f1 = getTop() + this.jdField_a_of_type_Ayxn.jdField_b_of_type_Float + this.jdField_c_of_type_Float + this.i + this.jdField_a_of_type_Float;
      ...
      for (;;)
      {
        ...
        else if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.size() != 0))
        {
          ...
          if (!a())
          {
            this.l = a(m);
            ayxn.a(this.jdField_a_of_type_Ayxn);
            this.jdField_a_of_type_Ayxn.jdField_a_of_type_Int = m;
            this.jdField_a_of_type_Ayxn.jdField_b_of_type_Float = (this.jdField_a_of_type_Float + this.k + this.jdField_c_of_type_Float + this.i);
          ...
          for (float f1 = this.jdField_a_of_type_Float * 0.0F;; f1 = 0.0F)
          {
            ...
            {
              a(paramInt1, this.jdField_a_of_type_Ayxn);
              b(paramInt1, this.jdField_a_of_type_Ayxn);
              paramInt1 += 1;
            }
            f1 = paramInt1;
          ...
          f1 = this.jdField_a_of_type_Ayxn.jdField_b_of_type_Float;
