...
import com.tencent.mobileqq.troop.homework.recite.ui.ReciteDisplayView.MyArticleAdapter;
...
public class ReplayLyricManager
{
  private static final String a;
  protected int a;
  protected long a;
  protected ReciteDisplayView.MyArticleAdapter a;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ReplayLyricManager.class.getSimpleName();
  }
  
  public ReplayLyricManager(List<ParagraphInfo> paramList, ReciteDisplayView.MyArticleAdapter paramMyArticleAdapter, String paramString)
  {
    this.jdField_a_of_type_OrgJsonJSONArray = null;
    this.jdField_a_of_type_OrgJsonJSONObject = null;
    this.jdField_a_of_type_Int = 0;
    this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkReciteUiReciteDisplayView$MyArticleAdapter = paramMyArticleAdapter;
        ...
        try
        {
          ...
          if ((k >= 0) && (k < ((List)localObject).size()))
          {
            ...
            if (this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkReciteUiReciteDisplayView$MyArticleAdapter != null) {
              this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkReciteUiReciteDisplayView$MyArticleAdapter.a((WordInfo)localObject);
            }
          }
 ...
 * Qualified Name:     com.tencent.mobileqq.troop.homework.recite.utils.ReplayLyricManager
