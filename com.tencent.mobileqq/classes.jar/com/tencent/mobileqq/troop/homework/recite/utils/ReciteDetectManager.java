...
public class ReciteDetectManager
{
  ...
  protected ReciteDetectManager.ReciteDetectListener a;
  ...
  public ReciteDetectManager(ArticleInfo paramArticleInfo, ReciteDetectManager.ReciteDetectListener paramReciteDetectListener, QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new ReciteDetectManager.1(this, Looper.getMainLooper());
  ...
  protected void a(int paramInt)
  {
    ...
    {
      TroopReportor.a((QQAppInterface)localObject3, str1, "Grp_recite", "Norecognize_Recite_Again_Clk", 0, 0, new String[] { str2, "", localObject2, "" });
      break;
      if (paramInt >= this.jdField_a_of_type_ComTencentMobileqqAppTroopManager.a.jdField_b_of_type_Int) {
        break;
      }
  ...
  protected WordInfo b()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 69	com/tencent/mobileqq/troop/homework/recite/utils/ReciteDetectManager:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   6: invokevirtual 336	java/util/ArrayList:isEmpty	()Z
    //   9: ifne +19 -> 28
    //   12: aload_0
    //   13: getfield 69	com/tencent/mobileqq/troop/homework/recite/utils/ReciteDetectManager:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   16: iconst_0
    //   17: invokevirtual 351	java/util/ArrayList:remove	(I)Ljava/lang/Object;
    //   20: checkcast 187	com/tencent/mobileqq/troop/homework/recite/data/WordInfo
    //   23: astore_1
    //   24: aload_0
    //   25: monitorexit
    //   26: aload_1
