  ...
  extends BaseAdapter
{
  ...
  public ReciteDisplayView$MyArticleAdapter(ReciteDisplayView paramReciteDisplayView, Context paramContext, List<ParagraphInfo> paramList, int paramInt1, int paramInt2)
  {
  ...
  {
    ReciteDisplayView.Holder localHolder;
    if (paramView == null)
    {
      localHolder = new ReciteDisplayView.Holder();
      localHolder.a = new PinyinTextView(this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkReciteUiReciteDisplayView, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Int);
      paramView = localHolder.a;
      paramView.setTag(localHolder);
    }
    for (;;)
    {
      localHolder = (ReciteDisplayView.Holder)paramView.getTag();
      ParagraphInfo localParagraphInfo = (ParagraphInfo)this.jdField_a_of_type_JavaUtilList.get(paramInt);
      if (this.e == d) {
        if (paramInt == getCount() - 1) {
          localHolder.a.setWordInfos(localParagraphInfo, this.g, true);
        }
      }
      for (;;)
      {
        ...
        return paramView;
        localHolder.a.setWordInfos(localParagraphInfo, this.g, false);
        continue;
        localHolder.a.setWordInfos(localParagraphInfo, this.g, false);
      }
    }
