...
public class BeginnerGuideDownloadManager
{
  ...
  private boolean b(Handler paramHandler, int paramInt, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      ((ArrayList)localObject).addAll(ZipUtils.getEntriesNames(localFile2));
      ...
      ZipUtils.unZipFile2(localFile2.getAbsolutePath(), localFile1.getAbsolutePath());
  ...
  public boolean a(Handler paramHandler, int paramInt, boolean paramBoolean)
  {
    ...
    localHttpNetReq.mCallback = new BeginnerGuideDownloadManager.DownloadListener(this, paramHandler, paramInt, paramBoolean);
