  ...
  extends PagerAdapter
{
  ...
  {
    View localView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131494780, paramViewGroup, false);
    ayvr localayvr = new ayvr(this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkArithmeticUiHomeworkGuideFragment);
    localayvr.a(paramInt, localView);
    localView.setTag(localayvr);
    this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkArithmeticUiHomeworkGuideFragment.jdField_a_of_type_JavaUtilList.add(localayvr);
