  ...
  extends IphoneTitleBarFragment
{
  ...
  public void doOnCreateView(LayoutInflater paramLayoutInflater, @Nullable ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_AndroidSupportV4ViewViewPager = ((ViewPager)this.mContentView.findViewById(2131313343));
    this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkArithmeticUiDotStyleNavBar = ((DotStyleNavBar)this.mContentView.findViewById(2131299754));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.mContentView.findViewById(2131298001));
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new ayvq(this));
