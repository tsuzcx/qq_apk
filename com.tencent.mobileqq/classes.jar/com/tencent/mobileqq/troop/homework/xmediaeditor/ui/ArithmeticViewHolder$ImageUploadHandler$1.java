...
class ArithmeticViewHolder$ImageUploadHandler$1
  implements Runnable
{
  ArithmeticViewHolder$ImageUploadHandler$1(ArithmeticViewHolder.ImageUploadHandler paramImageUploadHandler, ArithmeticInfo.ArithmeticImageInfo paramArithmeticImageInfo) {}
  
  public void run()
  {
    ArithmeticViewHolder.a(this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkXmediaeditorUiArithmeticViewHolder$ImageUploadHandler.a).a();
    ArithmeticViewHolder.ArithmeticImageView localArithmeticImageView = (ArithmeticViewHolder.ArithmeticImageView)ArithmeticViewHolder.a(this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkXmediaeditorUiArithmeticViewHolder$ImageUploadHandler.a).get(this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkXmediaeditorModelArithmeticInfo$ArithmeticImageInfo);
