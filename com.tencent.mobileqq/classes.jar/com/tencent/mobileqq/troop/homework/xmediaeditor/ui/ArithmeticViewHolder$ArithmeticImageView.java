  ...
  implements View.OnClickListener, URLDrawable.URLDrawableListener
{
  ...
  private void c()
  {
    inflate(getContext(), 2130970603, this);
    this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeDiscoverRoundCornerImageView = ((RoundCornerImageView)findViewById(2131363610));
    this.b = ((ImageView)findViewById(2131371390));
    this.jdField_a_of_type_ComTencentMobileqqWidgetMessageProgressView = ((MessageProgressView)findViewById(2131366639));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131371391));
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetMessageProgressView.setAnimRunnableListener(new aiwi(this));
    b();
  }
  ...
  public void a()
  {
    ...
    do
    {
      ...
      localUploadFileTask.a(new aiwk(this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkXmediaeditorUiArithmeticViewHolder, this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkXmediaeditorModelArithmeticInfo$ArithmeticImageInfo));
      ThreadManager.post(new aiwj(this, localUploadFileTask), 8, null, true);
