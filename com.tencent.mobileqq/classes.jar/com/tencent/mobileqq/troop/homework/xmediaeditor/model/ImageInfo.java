  ...
  extends UploadEditItemInfo
{
  ...
  {
    File localFile = new File(TroopHWJsPlugin.jdField_a_of_type_JavaLangString);
    if (!localFile.exists())
    {
      localFile.mkdirs();
  ...
  public Stream a(XMediaEditor paramXMediaEditor)
  {
    this.g = 1;
    Object localObject2 = Stream.of(this).map(new ThreadOffFunction(2));
