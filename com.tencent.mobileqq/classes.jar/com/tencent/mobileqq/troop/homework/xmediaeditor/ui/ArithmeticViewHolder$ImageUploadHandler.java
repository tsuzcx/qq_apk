...
class ArithmeticViewHolder$ImageUploadHandler
  implements TroopHomeworkHelper.UploadCallback
{
  ...
  public ArithmeticViewHolder$ImageUploadHandler(ArithmeticViewHolder paramArithmeticViewHolder, ArithmeticInfo.ArithmeticImageInfo paramArithmeticImageInfo)
  {
  ...
  {
    ThreadManager.getUIHandler().post(new ArithmeticViewHolder.ImageUploadHandler.1(this, paramArithmeticImageInfo));
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.troop.homework.xmediaeditor.ui.ArithmeticViewHolder.ImageUploadHandler
