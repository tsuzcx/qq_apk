  ...
  implements ViewPager.OnPageChangeListener
{
  ...
  public ComplexGuidViewPager(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    LayoutInflater.from(getContext()).inflate(2131561579, this, true);
    this.jdField_a_of_type_ComTencentBizTroopgiftRadioButtonIndicator = ((RadioButtonIndicator)findViewById(2131375923));
    this.jdField_a_of_type_ComTencentBizTroopgiftRadioButtonIndicator.setOrientation(0);
    this.jdField_a_of_type_ComTencentBizTroopgiftRadioButtonIndicator.setButtonResourceId(2130846184);
    this.jdField_a_of_type_AndroidWidgetHorizontalScrollView = ((HorizontalScrollView)findViewById(2131376979));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131363924));
    this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkEntryUiViewGuideViewPager = ((GuideViewPager)findViewById(2131367734));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131376984));
    this.jdField_a_of_type_Int = getResources().getDisplayMetrics().widthPixels;
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new bfbo(this));
  }
  ...
  public void setOnActionBtnClickListener(bfbp parambfbp)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkEntryUiViewGuideViewPager.setOnActionBtnClickListener(parambfbp);
  }
}
