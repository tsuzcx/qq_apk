  ...
  extends Handler
{
    ...
    do
    {
      do
      {
        ...
        if (paramSubmitHomeWorkFragment.jdField_a_of_type_JavaUtilLinkedList.isEmpty())
        {
          ...
          paramSubmitHomeWorkFragment.jdField_b_of_type_ComTencentMobileqqTroopHomeworkXmediaeditorXMediaEditor.setHint(paramSubmitHomeWorkFragment.getActivity().getString(2131697484));
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    if (i < 1000)
    {
      QQToast.a(localSubmitHomeWorkFragment.getActivity(), HardCodeUtil.a(2131714510), 0).a();
    ...
    if (!NetworkUtil.d(localSubmitHomeWorkFragment.getActivity()))
    {
      ...
      QQToast.a(localSubmitHomeWorkFragment.getActivity(), 2131697207, 0).a();
      localSubmitHomeWorkFragment.jdField_a_of_type_Boolean = false;
      localSubmitHomeWorkFragment.j();
      return;
    }
