  ...
  extends TroopObserver
{
  ...
  {
    if ((paramString1.equals(Long.toString(this.a.longValue()))) && (paramString2.equals("SUBCMD_GET_INVITE_NO_AUTH_LIMIT_NUM")))
    {
      if ((paramBoolean) && (paramGroupInfo != null) && (paramGroupInfo.uint64_invite_no_auth_num_limit.has()))
      {
        ...
        this.b.notifyUI(TroopManagerBizObserver.TYPE_GET_INVITE_NO_AUTH_LIMIT_NUM, true, new Object[] { this.a, Long.valueOf(l) });
      }
      TroopManagerBizHandler.h(this.b).removeObserver(this);
    }
  }
}
