  ...
  extends TroopModifyObserver
{
  ...
  {
    if ((paramLong == this.jdField_a_of_type_Long) && (paramString1.equals("SUBCMD_MODIFY_TROOP_NICK_RULE")))
    {
      this.jdField_a_of_type_ComTencentMobileqqTroopTroopmanagerApiImplTroopManagerBizHandler.notifyUI(TroopManagerBizObserver.TYPE_NOTIFY_MODIFY_TROOP_NICK_RULE, paramBoolean, new Object[] { Long.valueOf(paramLong), Integer.valueOf(paramInt), paramString2 });
      TroopManagerBizHandler.e(this.jdField_a_of_type_ComTencentMobileqqTroopTroopmanagerApiImplTroopManagerBizHandler).removeObserver(this);
    }
  }
}
