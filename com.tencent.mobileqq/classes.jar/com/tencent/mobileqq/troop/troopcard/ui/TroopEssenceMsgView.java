  ...
  implements View.OnClickListener
{
  ...
  private int a(TroopCardEssenceMsg paramTroopCardEssenceMsg)
  {
    ...
    while (paramTroopCardEssenceMsg.hasNext())
    {
      ...
      if ((j >= 1) && (j <= 5))
      {
        if ((j == 4) && (QQFileManagerUtil.k(((TroopCardEssenceMsg.EssenceMsgContent)localObject).fileName) != 0) && (QQFileManagerUtil.k(((TroopCardEssenceMsg.EssenceMsgContent)localObject).fileName) != 2)) {
          j = 1048576;
        } else {
          j = 1 << (j - 1) * 4;
        }
  ...
  private void a(int paramInt, List<TroopCardEssenceMsg> paramList)
  {
    ...
    if (this.a == null)
    {
      this.a = View.inflate(getContext(), 2131627920, null);
      this.a.setBackgroundResource(2130839629);
      this.a.setOnClickListener(this);
      this.a.setTag(paramList.get(0));
      ((TextView)this.a.findViewById(2131447463)).setText(getContext().getString(2131917456));
      addView(this.a);
    }
    ((TextView)this.a.findViewById(2131435692)).setText(getContext().getString(2131917455).replace("$COUNT$", String.valueOf(paramInt)));
  }
          ...
          if (i != 1048576)
          {
            if ((i != 16) && (i != 17))
            {
              if (i != 256)
              {
                ...
                setTextAndPictureMsgView(paramTroopCardEssenceMsg);
                return;
              }
              setOnlyPictureMsgView(paramTroopCardEssenceMsg);
            }
          }
          else {
            setFileMsgViewForNotVideoOrPicture(paramTroopCardEssenceMsg);
          }
        }
        else {
          setShareMsgView(paramTroopCardEssenceMsg);
        }
      }
      else
      {
        if (paramBoolean)
        {
          setFileMsgViewForMember(paramTroopCardEssenceMsg);
          return;
        }
        setFileMsgViewForNotMember(paramTroopCardEssenceMsg);
        return;
      }
    }
    setOnlyTextView(paramTroopCardEssenceMsg);
  }
  
  private void a(String paramString1, String paramString2)
  {
    View localView = View.inflate(getContext(), 2131629561, null);
    if (!TextUtils.isEmpty(paramString1))
    {
      ...
      if (paramString1 != null) {
        ((URLImageView)localView.findViewById(2131431346)).setImageDrawable(paramString1);
      }
    }
    if (!TextUtils.isEmpty(paramString2)) {
      ((TextView)localView.findViewById(2131431365)).setText(paramString2);
    }
    ...
    this.b.addView(localView, paramString1);
  }
  ...
  private void a(List<TroopCardEssenceMsg> paramList, boolean paramBoolean)
  {
    ...
    this.b.setOnClickListener(new TroopEssenceMsgView.1(this, paramBoolean));
  }
  ...
  private void setFileMsgViewForMember(TroopCardEssenceMsg paramTroopCardEssenceMsg)
  {
    ...
    if ((!TextUtils.isEmpty(paramTroopCardEssenceMsg)) && (((TroopCardEssenceMsg.EssenceMsgContent)localObject1).msgType == 4))
    {
      ...
      if (localObject3 != null)
      {
        ...
        paramTroopCardEssenceMsg.setBackgroundResource(2130839629);
        ...
        if (QQFileManagerUtil.k(((TroopCardEssenceMsg.EssenceMsgContent)localObject1).fileName) == 2)
        {
          localObject1 = new ImageView(getContext());
          ((ImageView)localObject1).setImageResource(2130840122);
        ...
        this.b.addView(paramTroopCardEssenceMsg, -2, Utils.a(124.0F, getResources()));
      }
    }
  }
  
  private void setFileMsgViewForNotMember(TroopCardEssenceMsg paramTroopCardEssenceMsg)
  {
  ...
  private void setFileMsgViewForNotVideoOrPicture(TroopCardEssenceMsg paramTroopCardEssenceMsg)
  {
  ...
  private void setOnlyPictureMsgView(TroopCardEssenceMsg paramTroopCardEssenceMsg)
  {
    Object localObject1 = (TroopCardEssenceMsg.EssenceMsgContent)paramTroopCardEssenceMsg.msgContent.get(0);
    if (localObject1 != null) {
    ...
    if ((!TextUtils.isEmpty(paramTroopCardEssenceMsg)) && (((TroopCardEssenceMsg.EssenceMsgContent)localObject1).msgType == 3))
    {
      ...
      if (localObject2 != null)
      {
        ...
        paramTroopCardEssenceMsg.addView((View)localObject1, (ViewGroup.LayoutParams)localObject2);
        this.b.addView(paramTroopCardEssenceMsg, -1, Utils.a(124.0F, getResources()));
      }
    }
  }
  
  private void setOnlyTextView(TroopCardEssenceMsg paramTroopCardEssenceMsg)
  {
    ...
    {
      localObject2 = View.inflate(getContext(), 2131629562, null);
      ((View)localObject2).setBackgroundResource(2130839629);
      localObject3 = (TextView)((View)localObject2).findViewById(2131431322);
      LinearLayout localLinearLayout = (LinearLayout)((View)localObject2).findViewById(2131431458);
      Button localButton = (Button)localLinearLayout.findViewById(2131438855);
      ...
      this.b.addView((View)localObject2, -1, -2);
    }
  }
  
  private void setShareMsgView(TroopCardEssenceMsg paramTroopCardEssenceMsg)
  {
    paramTroopCardEssenceMsg = (TroopCardEssenceMsg.EssenceMsgContent)paramTroopCardEssenceMsg.msgContent.get(0);
  ...
  private void setTextAndPictureMsgView(TroopCardEssenceMsg paramTroopCardEssenceMsg)
  {
    ...
    localObject2 = View.inflate(getContext(), 2131629560, null);
    ((View)localObject2).setBackgroundResource(2130839629);
    localObject3 = new QQText((CharSequence)localObject3, 3);
    int i;
    if (((QQText)localObject3).length() > 0)
    {
      localObject4 = (TextView)((View)localObject2).findViewById(2131431365);
    ...
    if (!TextUtils.isEmpty((CharSequence)localObject1))
    {
      ...
      localObject3 = (URLImageView)((View)localObject2).findViewById(2131431346);
    ...
    if (j != 0)
    {
      RelativeLayout localRelativeLayout = (RelativeLayout)((View)localObject2).findViewById(2131431458);
      localObject3 = (Button)localRelativeLayout.findViewById(2131438855);
      ...
      if (ThemeUtil.isNowThemeIsNight(MobileQQ.sMobileQQ.waitAppRuntime(null), false, null))
      {
        ...
        localRelativeLayout.setBackgroundResource(2130853327);
      }
      this.b.addView((View)localObject2, -1, Utils.a(108.0F, getResources()));
  ...
  public void onClick(View paramView)
  {
    ...
    if ((localObject instanceof TroopCardEssenceMsg)) {
      if (paramView.getId() == 2131438855) {
        b(((TroopCardEssenceMsg.EssenceMsgContent)((TroopCardEssenceMsg)localObject).msgContent.get(0)).jumpUrlForMore);
      } else {
        b(((TroopCardEssenceMsg)localObject).jumpUrl);
      }
    }
 ...
 * Qualified Name:     com.tencent.mobileqq.troop.troopcard.ui.TroopEssenceMsgView
