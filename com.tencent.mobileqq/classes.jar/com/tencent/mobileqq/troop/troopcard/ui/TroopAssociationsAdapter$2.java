  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    ((ITroopCardApi)QRoute.api(ITroopCardApi.class)).openTroopInfoFromTroopAssociation(TroopAssociationsAdapter.a(this.a), localObject);
    if (localObject == null) {
      localObject = "";
    } else {
 ...
 * Qualified Name:     com.tencent.mobileqq.troop.troopcard.ui.TroopAssociationsAdapter.2
