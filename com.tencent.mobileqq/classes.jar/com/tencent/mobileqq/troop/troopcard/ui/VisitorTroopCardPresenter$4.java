  ...
  implements TroopPhotoController.OnGotoBigPicListener
{
  ...
  public void b(Bundle paramBundle)
  {
    if ((VisitorTroopCardPresenter.c(this.a) != null) && (VisitorTroopCardPresenter.d(this.a) != null))
    {
      ...
      localBundle.putString("troop_uin", VisitorTroopCardPresenter.d(this.a).troopUin);
      localBundle.putLong("troop_flag_ext", VisitorTroopCardPresenter.d(this.a).dwGroupFlagExt);
      localBundle.putBoolean("isUseClassAvatar", VisitorTroopCardPresenter.d(this.a).isUseClassAvatar);
      boolean bool2 = localBundle.getBoolean("IS_EDIT");
      boolean bool1 = localBundle.getBoolean("IS_COVER") ^ true;
      if (bool1) {
        paramBundle = VisitorTroopCardPresenter.h(this.a);
      } else {
        paramBundle = VisitorTroopCardPresenter.i(this.a);
      }
 ...
 * Qualified Name:     com.tencent.mobileqq.troop.troopcard.ui.VisitorTroopCardPresenter.4
