  ...
  implements BusinessObserver
{
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (TroopMoreDetailView.a((TroopMoreDetailView)localObject1) == null) {
      return;
    }
    if (!paramBoolean) {
      return;
    ...
    try
    {
      ...
      {
        View localView = localObject1.a[5];
        StringBuffer localStringBuffer = new StringBuffer(((TroopMoreDetailView)localObject1).getResources().getString(2131719962));
        if (localView == null) {
          return;
        }
        ...
        if (localObject1.a[4] != null) {
          localObject1.a[4].setBackgroundResource(2130839440);
        }
        localStringBuffer.append(",本群共");
        localStringBuffer.append(i);
        localStringBuffer.append("人");
        paramBundle = localView.findViewById(2131379286);
        ...
        while (paramInt < ((List)localObject2).size())
        {
          ...
          if (paramInt != 0)
          {
            if (paramInt != 1)
            {
              if (paramInt != 2)
              {
                ...
                paramBundle = localView.findViewById(2131379289);
                localObject1 = CylinderProgressView.a(CylinderProgressView.a(localObject3[0]));
                break label613;
              }
              paramBundle = localView.findViewById(2131379288);
              localObject1 = CylinderProgressView.b();
              break label613;
            }
            paramBundle = localView.findViewById(2131379287);
            localObject1 = CylinderProgressView.a(localObject3[0].contains(localContext.getString(2131693879)));
            break label613;
          }
          paramBundle = localView.findViewById(2131379286);
          localObject1 = CylinderProgressView.a();
          int j = ((troop_member_distribute.OStatisticInfo)localObject4).uint32_count.get() * 100 / i;
          localObject4 = (TextView)paramBundle.findViewById(2131379805);
          ((TextView)localObject4).setTextColor(localObject1[0]);
          ((TextView)localObject4).setTypeface(localTypeface);
          CylinderProgressView localCylinderProgressView = (CylinderProgressView)paramBundle.findViewById(2131376844);
          ...
          ((TextView)paramBundle.findViewById(2131378784)).setText(localObject3[0]);
          ((TextView)paramBundle.findViewById(2131372043)).setText(localObject3[1]);
          localObject3 = (TextView)paramBundle.findViewById(2131379804);
 ...
 * Qualified Name:     com.tencent.mobileqq.troop.troopcard.TroopMoreDetailView.GetTroopMemberDistributeObserver
