  ...
  extends LinearLayout
{
  ...
  private RecyclerView.OnScrollListener jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$OnScrollListener = new bamx(this);
  private RecyclerView jdField_a_of_type_AndroidSupportV7WidgetRecyclerView;
  private RelativeLayout jdField_a_of_type_AndroidWidgetRelativeLayout;
  private TextView jdField_a_of_type_AndroidWidgetTextView;
  private bamy jdField_a_of_type_Bamy;
  private baxk jdField_a_of_type_Baxk;
  private baxl jdField_a_of_type_Baxl = new bamw(this);
  ...
  private void a(Context paramContext)
  {
    ...
    setBackgroundResource(2130849312);
    paramContext = paramContext.inflate(2131561151, null);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramContext.findViewById(2131369091));
    this.b = ((TextView)paramContext.findViewById(2131375247));
    ...
    paramContext.setText(getResources().getString(2131694650));
    paramContext.setTextSize(2, 14.0F);
    paramContext.setTextColor(getResources().getColor(2131166928));
    paramContext.setContentDescription(getResources().getString(2131694650));
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130849312);
    ...
    this.jdField_a_of_type_Bamy = new bamy(this, this.jdField_a_of_type_AndroidContentContext);
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.setAdapter(this.jdField_a_of_type_Bamy);
  ...
  public void setAddList(ArrayList<balv> paramArrayList, int paramInt, String paramString)
  {
    if (this.b != null) {
    ...
    for (int i = paramArrayList.size();; i = 0)
    {
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_Bamy.a(paramArrayList);
