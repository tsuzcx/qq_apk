  ...
  implements URLDrawableDownListener, DynamicAvatarDownloadManager.IDynamicAvatarDownloadCallback
{
  ...
  public MediaPreviewAdapter(Context paramContext, Gallery paramGallery)
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = paramContext.getResources().getDrawable(2130838183);
    this.jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
    paramContext = (DynamicAvatarManager)((AppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(QQManagerFactory.DYNAMIC_AVATAR_MANAGER);
      ...
      if ((localMediaPreviewInfo != null) && (paramString.equals(localMediaPreviewInfo.b)) && ((localObject instanceof MediaPreviewAdapter.ViewHolder)))
      {
        ...
        if (paramBoolean1)
        {
          ...
          if (DynamicAvatarDownloadManager.b(localMediaPreviewInfo.b))
          {
            ...
            ((MediaPreviewAdapter.ViewHolder)localObject).jdField_a_of_type_ComTencentImageURLImageView.post(new MediaPreviewAdapter.3(this, (MediaPreviewAdapter.ViewHolder)localObject, i, localFile, localMediaPreviewInfo));
            paramBoolean2 = true;
          }
        }
        if (!paramBoolean2)
        {
          ...
          ((MediaPreviewAdapter.ViewHolder)localObject).jdField_a_of_type_ComTencentImageURLImageView.post(new MediaPreviewAdapter.4(this, (MediaPreviewAdapter.ViewHolder)localObject));
        }
      }
      return;
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131559453, null);
      ...
      paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131378417));
