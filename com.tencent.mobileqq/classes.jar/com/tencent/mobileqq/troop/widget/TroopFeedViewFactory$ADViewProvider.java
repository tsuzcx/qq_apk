  ...
  extends TroopFeedViewFactory.ViewProvider
{
  ...
  protected View a(View paramView, TroopFeedItem paramTroopFeedItem, int paramInt, boolean paramBoolean)
  {
    ...
    if (paramView == null) {
      paramTroopFeedItem = LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqTroopWidgetTroopFeedViewFactory.jdField_a_of_type_AndroidContentContext).inflate(2131560723, null);
    }
    Object localObject = (TroopFeedViewFactory.ADViewProvider.ViewHolder)paramTroopFeedItem.getTag();
    paramView = (View)localObject;
    if (localObject == null)
    {
      paramView = new TroopFeedViewFactory.ADViewProvider.ViewHolder(this);
      paramView.a = ((URLImageView)paramTroopFeedItem.findViewById(2131362101));
