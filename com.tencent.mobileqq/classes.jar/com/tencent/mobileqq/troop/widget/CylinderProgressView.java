  ...
  extends View
{
  ...
  public CylinderProgressView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    paramContext = paramContext.obtainStyledAttributes(paramAttributeSet, R.styleable.CylinderProgressView);
    this.g = paramContext.getColor(3, 0);
    this.jdField_a_of_type_Int = paramContext.getColor(3, 0);
    this.jdField_b_of_type_Int = paramContext.getColor(2, -16776961);
    this.jdField_c_of_type_Int = paramContext.getColor(0, Color.parseColor("#F5F6FA"));
  ...
  public static int[] a(boolean paramBoolean)
  {
    ...
    label40:
    for (String str = "#4D4D94FF";; str = "#4DFF5CBE")
    {
  ...
  public void onDraw(Canvas paramCanvas)
  {
    ...
    if (this.f == 0) {
      try
      {
        ...
        paramCanvas.drawRoundRect(this.jdField_a_of_type_AndroidGraphicsRectF, m, m, this.jdField_a_of_type_AndroidGraphicsPaint);
        ...
        paramCanvas.drawRoundRect(this.jdField_b_of_type_AndroidGraphicsRectF, m, m, this.jdField_a_of_type_AndroidGraphicsPaint);
        f1 = this.j / this.jdField_a_of_type_Float;
        f2 = (this.d - this.g) * f1;
        this.jdField_c_of_type_AndroidGraphicsRectF.set(this.g, this.g, f2, this.e - this.g);
        if (f1 != 0.0F)
        {
          this.jdField_a_of_type_AndroidGraphicsShader = new LinearGradient(this.g, this.g, f2, this.e - this.g, this.i, this.h, Shader.TileMode.CLAMP);
          this.jdField_a_of_type_AndroidGraphicsPaint.setShader(this.jdField_a_of_type_AndroidGraphicsShader);
        }
        paramCanvas.drawRoundRect(this.jdField_c_of_type_AndroidGraphicsRectF, m, m, this.jdField_a_of_type_AndroidGraphicsPaint);
    ...
    try
    {
      ...
      paramCanvas.drawRoundRect(this.jdField_b_of_type_AndroidGraphicsRectF, m, m, this.jdField_a_of_type_AndroidGraphicsPaint);
      f1 = this.j / this.jdField_a_of_type_Float;
      f2 = this.e - this.g - (this.e - this.g * 2) * f1;
      this.jdField_c_of_type_AndroidGraphicsRectF.set(this.g, f2, this.d - this.g, this.e - this.g);
      if (f1 != 0.0F)
      {
        this.jdField_a_of_type_AndroidGraphicsShader = new LinearGradient(this.g, f2, this.d - this.g, this.e - this.g, this.i, this.h, Shader.TileMode.CLAMP);
        this.jdField_a_of_type_AndroidGraphicsPaint.setShader(this.jdField_a_of_type_AndroidGraphicsShader);
      }
      paramCanvas.drawRoundRect(this.jdField_c_of_type_AndroidGraphicsRectF, m, m, this.jdField_a_of_type_AndroidGraphicsPaint);
      this.jdField_a_of_type_AndroidGraphicsPaint.setShader(null);
 ...
 * Qualified Name:     com.tencent.mobileqq.troop.widget.CylinderProgressView
