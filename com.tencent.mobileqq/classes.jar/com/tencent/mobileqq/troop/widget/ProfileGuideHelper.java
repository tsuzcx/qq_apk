...
public class ProfileGuideHelper
{
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    this.jdField_a_of_type_AndroidAppDialog = new Dialog(this.jdField_a_of_type_AndroidAppActivity, 2131624574);
    ...
    RelativeLayout localRelativeLayout2 = (RelativeLayout)LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2130971646, null);
    ...
    ((Button)localRelativeLayout2.findViewById(2131375187)).setOnClickListener(new ajep(this));
