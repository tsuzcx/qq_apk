...
public class ProfileGuideHelper
{
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    RelativeLayout localRelativeLayout2 = (RelativeLayout)LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2130971723, null);
    ...
    ((Button)localRelativeLayout2.findViewById(2131375434)).setOnClickListener(new akag(this));
