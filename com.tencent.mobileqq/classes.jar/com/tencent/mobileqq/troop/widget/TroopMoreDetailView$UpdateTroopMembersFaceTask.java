  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    ((LinearLayout)((View)localObject3).findViewById(2131366529)).setVisibility(0);
    Object localObject2 = (TextView)((View)localObject3).findViewById(2131371122);
    ((TextView)localObject2).setText(HardCodeUtil.a(2131715527) + k + HardCodeUtil.a(2131715520));
    Object localObject3 = (TextView)((View)localObject3).findViewById(2131371127);
    ...
    for (;;)
    {
      ...
      if (j < i - 1)
      {
        ...
        if (AppSetting.d)
        {
          ((ImageView)localObject1).setContentDescription(HardCodeUtil.a(2131715517) + (j + 1));
