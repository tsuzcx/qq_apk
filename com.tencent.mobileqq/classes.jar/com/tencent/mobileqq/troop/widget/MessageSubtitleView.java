  ...
  extends RelativeLayout
{
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        ((Animator)localObject).addListener(new bgvz(this, bool, paramInt2));
  ...
  public void a()
  {
    if ((!this.jdField_a_of_type_JavaUtilQueue.isEmpty()) && (this.jdField_a_of_type_JavaUtilArrayList.size() <= 3))
    {
      ...
      localTextView.setShadowLayer(3.0F, 3.0F, 3.0F, 2131165539);
      ...
      localObject = new RelativeLayout.LayoutParams(((Context)localObject).getResources().getDimensionPixelSize(2131298932), ((Context)localObject).getResources().getDimensionPixelSize(2131298930));
  ...
  void a(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Int = paramContext.getResources().getDimensionPixelSize(2131298930);
  }
