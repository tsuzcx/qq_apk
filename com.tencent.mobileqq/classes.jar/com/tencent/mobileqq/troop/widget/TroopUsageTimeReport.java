  ...
  extends BroadcastReceiver
{
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      {
        bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_AIO", "", "time", "aio_time", 0, i, 0, localSessionInfo.jdField_a_of_type_JavaLangString, "", "", "");
  ...
  public void b()
  {
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      if (localSessionInfo != null)
      {
        bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_AIO", "", "time", "grp_time", 0, i, 0, localSessionInfo.jdField_a_of_type_JavaLangString, "", "", "");
        if (QLog.isColorLevel()) {
