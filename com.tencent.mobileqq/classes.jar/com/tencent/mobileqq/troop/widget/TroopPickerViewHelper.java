...
public class TroopPickerViewHelper
{
  ...
  private akbw jdField_a_of_type_Akbw;
  ...
  public void a(Activity paramActivity, TroopPickerViewHelper.OnConfirmListener paramOnConfirmListener)
  {
    ...
    {
      View localView = paramActivity.getLayoutInflater().inflate(2130969947, null);
      ...
      this.jdField_a_of_type_ComTencentMobileqqTroopWidgetWheelPickerLayout = ((WheelPickerLayout)localView.findViewById(2131368514));
      ...
      localViewStyle.b = 23;
      localViewStyle.c = paramActivity.getColor(2131494282);
      localViewStyle.d = 17;
      localViewStyle.e = 23;
      localViewStyle.f = paramActivity.getColor(2131494220);
      this.jdField_a_of_type_Akbw = new akbw(this, this.jdField_a_of_type_ComTencentMobileqqTroopWidgetWheelPickerLayout);
      this.jdField_a_of_type_ComTencentMobileqqTroopWidgetWheelPickerLayout.a(this.jdField_a_of_type_Akbw, localViewStyle);
      this.jdField_a_of_type_ComTencentMobileqqTroopWidgetWheelPickerLayout.setPickListener(new akbu(this));
      paramActivity = localView.findViewById(2131364308);
      if (paramActivity != null) {
        paramActivity.setOnClickListener(new akbv(this, paramOnConfirmListener));
      }
    }
    if (!this.jdField_a_of_type_ComTencentWidgetActionSheet.isShowing())
    {
      paramActivity = this.jdField_a_of_type_Akbw.a(this.jdField_a_of_type_Long);
      int i = 0;
      ...
      this.jdField_a_of_type_JavaUtilCalendar = this.jdField_a_of_type_Akbw.a(paramActivity);
    }
    try
    {
