  ...
  implements BusinessObserver
{
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      localStringBuffer = new StringBuffer(((TroopMoreDetailView)localObject1).getResources().getString(2131720229));
    } while ((localView == null) || (((List)localObject2).size() < 4));
    localView.setVisibility(0);
    if (localObject1.a[4] != null) {
      localObject1.a[4].setBackgroundResource(2130839582);
    }
    localStringBuffer.append(",本群共").append(i).append("人");
    paramBundle = localView.findViewById(2131379957);
    ...
    for (;;)
    {
      ...
      localObject4 = (TextView)paramBundle.findViewById(2131380506);
      ((TextView)localObject4).setTextColor(localObject1[0]);
      ((TextView)localObject4).setTypeface(localTypeface);
      CylinderProgressView localCylinderProgressView = (CylinderProgressView)paramBundle.findViewById(2131377394);
      ...
      ((TextView)paramBundle.findViewById(2131379432)).setText(localObject3[0]);
      ((TextView)paramBundle.findViewById(2131372460)).setText(localObject3[1]);
      localObject3 = (TextView)paramBundle.findViewById(2131380505);
      ...
      continue;
      paramBundle = localView.findViewById(2131379958);
      localObject1 = CylinderProgressView.a(localObject3[0].contains(localContext.getString(2131693923)));
      continue;
      paramBundle = localView.findViewById(2131379959);
      localObject1 = CylinderProgressView.b();
      continue;
      paramBundle = localView.findViewById(2131379960);
 ...
 * Qualified Name:     com.tencent.mobileqq.troop.widget.TroopMoreDetailView.GetTroopMemberDistributeObserver
