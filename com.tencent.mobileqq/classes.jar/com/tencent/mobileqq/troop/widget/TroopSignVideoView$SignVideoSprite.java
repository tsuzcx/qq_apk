...
class TroopSignVideoView$SignVideoSprite
  extends VideoSprite
{
  private int ap = GLES20.glGetUniformLocation(this.X, "v_isShowCover");
  ...
  {
    if (TroopSignVideoView.b(this.this$0) == 0) {
      TroopSignVideoView.a(this.this$0, paramInt2);
    }
    super.a(paramInt1, TroopSignVideoView.b(this.this$0));
  }
  ...
  {
    super.v();
    this.ap = GLES20.glGetUniformLocation(this.X, "v_isShowCover");
  }
}
