  ...
  extends View
{
  ...
  void a()
  {
    ...
    this.jdField_c_of_type_AndroidAnimationValueAnimator.addUpdateListener(new bcmz(this));
    ...
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new bcna(this));
    ...
    this.jdField_b_of_type_AndroidAnimationValueAnimator.addUpdateListener(new bcnb(this));
