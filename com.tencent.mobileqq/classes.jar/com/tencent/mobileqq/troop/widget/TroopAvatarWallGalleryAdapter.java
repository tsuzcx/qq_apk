  ...
  extends BaseAdapter
{
  ...
  public void a(int paramInt, TroopAvatarWallGalleryAdapter.ViewHolder paramViewHolder)
  {
    ...
    localURLImageView.setURLDrawableDownListener(new akar(this, localImageProgressCircle, localURLImageView));
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = LayoutInflater.from(paramViewGroup.getContext()).inflate(2130971689, null);
