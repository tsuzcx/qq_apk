  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    bfkb localbfkb = bfkc.a(localActivity).a(localActivity, (String)localObject1);
    ...
    for (;;)
    {
      ...
      if (localbfkb != null)
      {
        localObject1 = localObject2;
        i = j;
        if (!TextUtils.isEmpty(localbfkb.a))
        {
          localObject1 = localObject2;
          i = j;
          if (!amtj.a(2131714677).equals(localbfkb.a))
          {
            localObject1 = localbfkb.a;
            i = 1;
          }
        }
      }
