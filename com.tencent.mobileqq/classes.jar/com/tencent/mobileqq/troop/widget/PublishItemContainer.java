  ...
  implements View.OnClickListener, VoicePlayer.VoicePlayerListener
{
  ...
  public PublishItemContainer(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(getContext()).inflate(2130969472, null);
  ...
  {
    Object localObject = paramView.findViewById(2131366643);
    URLImageView localURLImageView = (URLImageView)paramView.findViewById(2131366641);
    localURLImageView.setImageResource(2130845019);
  ...
  protected void a(View paramView, String paramString)
  {
    ...
    {
      localView = paramView.findViewById(2131366643);
      localURLImageView = (URLImageView)paramView.findViewById(2131366641);
      localURLImageView.setAdjustViewBounds(false);
  ...
  public boolean a(String paramString)
  {
    ...
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (!TextUtils.isEmpty(paramString)))
    {
      ...
      View localView = LayoutInflater.from(getContext()).inflate(2130969472, null);
      this.jdField_a_of_type_AndroidWidgetLinearLayout.addView(localView);
      ...
      setVisibility(0);
      postDelayed(new akah(this), 200L);
      return true;
    }
    return false;
  }
    ...
    if (paramArrayList != null)
    {
      ...
      for (;;)
      {
        ...
        if (j < k)
        {
          ...
          while (i < k - j)
          {
            localObject = paramArrayList.inflate(2130969472, null);
      ...
      if (this.jdField_a_of_type_JavaUtilArrayList.size() > 0)
      {
        this.g = 1;
        setVisibility(0);
        postDelayed(new akai(this), 200L);
      }
      return true;
    }
    this.jdField_a_of_type_AndroidWidgetLinearLayout.removeAllViews();
  ...
  public void b()
  {
    ...
    do
    {
      ...
      localAudioInfo.mAudioIcon.setImageResource(2130845845);
    ...
    Object localObject = (AnimationDrawable)BaseApplicationImpl.getApplication().getResources().getDrawable(2131034275);
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      if (paramView.getTag() != null)
      {
        ...
        paramView.putExtra("back_btn_text", this.jdField_a_of_type_AndroidAppActivity.getString(2131430499));
  ...
  public void setItemEnable(boolean paramBoolean)
  {
    ...
    if (this.g == 2)
    {
      ...
      View localView1 = localView2.findViewById(2131366630);
      localView2 = localView2.findViewById(2131366632);
