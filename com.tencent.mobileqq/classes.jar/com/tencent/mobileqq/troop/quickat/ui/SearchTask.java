...
public class SearchTask
{
  ...
  private Object[] a(String paramString, TroopInfo paramTroopInfo)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((localATroopMember.jdField_a_of_type_Boolean) || ((!TextUtils.isEmpty(paramString)) && (AtUtil.a(localATroopMember.jdField_a_of_type_JavaLangString, paramTroopInfo)))) {
          break label664;
        }
        if ((TextUtils.isEmpty(paramString)) || (!AtUtil.b(localATroopMember.jdField_a_of_type_JavaLangString, paramTroopInfo))) {
          break label228;
        }
      }
      finally {}
  ...
  public SearchTask.SearchResult a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean1, SessionInfo paramSessionInfo, boolean paramBoolean2)
  {
    ...
    for (this.jdField_b_of_type_JavaUtilList = QuickAtListHelper.a(paramQQAppInterface, this.jdField_a_of_type_JavaUtilList, paramBoolean1);; this.jdField_b_of_type_JavaUtilList = new ArrayList(QuickAtListHelper.a(paramString, QuickAtListHelper.a(paramQQAppInterface, this.jdField_a_of_type_JavaUtilList, paramBoolean1), paramQQAppInterface, paramSessionInfo))) {
