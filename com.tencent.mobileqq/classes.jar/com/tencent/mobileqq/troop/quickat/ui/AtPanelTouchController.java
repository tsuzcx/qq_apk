  ...
  extends LinearLayout
{
  ...
  public float a(float paramFloat)
  {
    ...
    {
      i = aciy.a(f, getContext().getResources());
  ...
  public void computeScroll()
  {
    ...
    do
    {
      ...
      this.e = false;
    } while (this.jdField_a_of_type_Azdh == null);
    this.jdField_a_of_type_Azdh.a(this.jdField_a_of_type_Int);
  }
  ...
  public boolean dispatchTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_Azdh != null)
        {
          paramMotionEvent = this.jdField_a_of_type_Azdh;
          if (getScrollY() > 0) {
            bool = true;
          }
  ...
  public void setAtPanelTouchListener(azdh paramazdh)
  {
