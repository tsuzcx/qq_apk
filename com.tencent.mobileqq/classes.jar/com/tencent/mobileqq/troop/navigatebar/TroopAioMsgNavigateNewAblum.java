  ...
  extends BaseAioMsgNavigateBarDelegate
{
  ...
  public BaseAioMsgNavigateBarDelegate.Entity a(int paramInt1, List<Long> paramList, long paramLong1, Object paramObject, long paramLong2, long paramLong3, int paramInt2)
  {
    ...
    if ((paramList != null) && (a(paramList, paramLong2, paramLong3))) {
      return new BaseAioMsgNavigateBarDelegate.Entity(true, this.e.getString(2131895390), AioAgent.Message.a(paramInt1, paramLong1, paramInt2), paramList.senderuin);
    }
    return null;
  }
  ...
  {
    ReportController.b(this.d, "dc00899", "Grp_AIO", "", "notice_center_new", "exp_album", 0, 0, this.f.b, "", "", "");
  }
  
  public void b(int paramInt, Object paramObject, String paramString)
  {
    ReportController.b(this.d, "dc00899", "Grp_AIO", "", "notice_center_new", "clk_album", 0, 0, this.f.b, "", "", "");
  }
}
