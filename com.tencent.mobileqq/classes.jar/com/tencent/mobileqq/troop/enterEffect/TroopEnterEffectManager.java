  ...
  implements Manager
{
  ...
  protected TroopEnterEffectConfig a;
  protected HashMap<String, TroopEnterEffectManager.EntranceStatus> a;
  protected ConcurrentHashMap<String, List<TroopEnterEffectController.TroopEnterEffectData>> a;
  ...
  protected void a()
  {
    ...
    ((VipInfoHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.VIPINFO_HANDLER)).a(str, (String)localObject);
  }
  ...
  public void a(long paramLong, int paramInt1, String paramString, int paramInt2, int paramInt3)
  {
    this.jdField_a_of_type_Int = 8;
    this.jdField_b_of_type_Int = paramInt2;
    this.jdField_c_of_type_Int = paramInt3;
    this.e = paramInt1;
    if ((this.jdField_a_of_type_ComTencentMobileqqTroopEnterEffectTroopEnterEffectConfig != null) && (this.jdField_a_of_type_ComTencentMobileqqTroopEnterEffectTroopEnterEffectConfig.jdField_a_of_type_ComTencentMobileqqTroopEnterEffectTroopEnterEffectConfig$EffectInfo != null) && (this.jdField_a_of_type_ComTencentMobileqqTroopEnterEffectTroopEnterEffectConfig.jdField_a_of_type_ComTencentMobileqqTroopEnterEffectTroopEnterEffectConfig$EffectInfo.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap != null))
    {
      if ((TroopEnterEffectConfig.EffectInfoData)this.jdField_a_of_type_ComTencentMobileqqTroopEnterEffectTroopEnterEffectConfig.jdField_a_of_type_ComTencentMobileqqTroopEnterEffectTroopEnterEffectConfig$EffectInfo.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramLong)) != null) {
        break label120;
      }
      this.jdField_a_of_type_ComTencentMobileqqTroopEnterEffectTroopEnterEffectConfig.jdField_a_of_type_ComTencentMobileqqTroopEnterEffectTroopEnterEffectConfig$EffectInfo.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(String.valueOf(paramLong), new TroopEnterEffectConfig.EffectInfoData(paramLong, paramInt1, paramString));
    }
    for (;;)
    {
      a(this.jdField_a_of_type_ComTencentMobileqqTroopEnterEffectTroopEnterEffectConfig.jdField_a_of_type_ComTencentMobileqqTroopEnterEffectTroopEnterEffectConfig$EffectInfo.a());
      return;
      label120:
      Iterator localIterator = this.jdField_a_of_type_ComTencentMobileqqTroopEnterEffectTroopEnterEffectConfig.jdField_a_of_type_ComTencentMobileqqTroopEnterEffectTroopEnterEffectConfig$EffectInfo.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.entrySet().iterator();
      while (localIterator.hasNext())
      {
        TroopEnterEffectConfig.EffectInfoData localEffectInfoData = (TroopEnterEffectConfig.EffectInfoData)((Map.Entry)localIterator.next()).getValue();
  ...
  public void a(boolean paramBoolean)
  {
    ...
    localObject = VasUpdateUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1000L, "groupeffect_config.json", (String)localObject, paramBoolean, null);
    if (localObject != null)
    {
  ...
  public void c(String paramString)
  {
    ...
    do
    {
      ...
      if (l + this.jdField_a_of_type_Long < System.currentTimeMillis())
      {
        ...
        ((IApolloExtensionHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.APOLLO_EXTENSION_HANDLER)).a(8192L, l);
