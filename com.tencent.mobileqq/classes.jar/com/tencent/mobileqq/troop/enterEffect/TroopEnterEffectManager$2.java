...
public class TroopEnterEffectManager$2
  implements Runnable
{
  public TroopEnterEffectManager$2(bedt parambedt, group_effect_commu.TGetMyEffectRsp0x2 paramTGetMyEffectRsp0x2) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      try
      {
        localFileOutputStream = BaseApplication.getContext().openFileOutput("troop_enter_effect_config_" + this.this$0.a.getCurrentAccountUin(), 0);
