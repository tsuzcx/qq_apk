  ...
  extends TroopBusinessObserver
{
  ...
  public void onBulkSendMessage(boolean paramBoolean, homework.RspSend1V1Msg paramRspSend1V1Msg, homework.ReqSend1V1Msg paramReqSend1V1Msg)
  {
    ...
    if (paramRspSend1V1Msg == null)
    {
      QQToast.a((Context)localObject, 1, HardCodeUtil.a(2131701308), 1).a();
      return;
    }
    ...
    QQToast.a((Context)localObject, 2, HardCodeUtil.a(2131701304), 1).a();
    ((FragmentActivity)localObject).finish();
    ((FragmentActivity)localObject).overridePendingTransition(0, 2130772003);
