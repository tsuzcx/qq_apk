...
public class HWTroopUtils
{
  ...
  public static final void a(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    ...
    localIntent.putExtra("url", String.format("http://admin.qun.qq.com/mcreatev3/joingroup.html?_bid=206&_wv=2098179&groupCode=%1$s&source=%2$s&uin=%3$s", new Object[] { paramString2, paramString3, paramString1 }));
    paramContext.startActivity(localIntent);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, TroopTipsEntity paramTroopTipsEntity)
  {
    ...
    if (!MessageHandlerUtils.a(paramQQAppInterface, localMessageForGrayTips, false))
    {
      ...
      if (!((TroopBindPublicAccountMgr)paramQQAppInterface.getManager(131)).a(paramTroopTipsEntity.troopUin))
      {
        MessageInfo localMessageInfo = new MessageInfo();
        Object localObject1 = new MessageInfo();
        ((MessageInfo)localObject1).o.a(localMessageForGrayTips.shmsgseq, localMessageForGrayTips.uniseq);
  ...
  {
    b(paramQQAppInterface, paramString, 0);
    String str = String.valueOf(1104445552);
    ((TroopHandler)paramQQAppInterface.a(20)).a(61, true, new Object[] { paramString, str, Boolean.valueOf(false) });
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    String str = ((Resources)localObject).getString(2131430701);
    localObject = ((Resources)localObject).getString(2131430702);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, HWTroopUtils.OnHomeworkTroopIdentityCheckListener paramOnHomeworkTroopIdentityCheckListener, boolean paramBoolean)
  {
    ...
    ((TroopManager)paramQQAppInterface.getManager(51)).a(paramString1, paramString2, new aizk(paramString1, paramString2, paramBoolean, paramQQAppInterface, paramOnHomeworkTroopIdentityCheckListener));
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    ThreadManager.post(new aizm(paramQQAppInterface, paramString), 8, null, true);
  }
  ...
  private static void b(HWTroopUtils.OnHomeworkTroopIdentityCheckListener paramOnHomeworkTroopIdentityCheckListener, int paramInt)
  {
    ...
    ThreadManager.getUIHandler().post(new aizl(paramOnHomeworkTroopIdentityCheckListener, paramInt));
  }
