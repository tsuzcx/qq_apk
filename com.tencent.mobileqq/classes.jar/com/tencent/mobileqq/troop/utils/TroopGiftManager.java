  ...
  implements Manager
{
    ...
    for (;;)
    {
      try
      {
        ...
        default: 
          ...
          localReqBody.bytes_version.set(ByteStringMicro.copyFrom("V 7.6.8.3615".getBytes()), true);
          ...
          ProtoUtils.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new ajxf(this, paramTroopGiftCallback), localReqBody.toByteArray(), paramString1 + "_" + paramInt2, paramInt1, paramInt2, paramString2, paramLong);
          return;
          if (paramInt2 != 11) {
            continue;
          }
  ...
  private void a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, int paramInt4, oidb_0x6c3.GetStockReq paramGetStockReq, oidb_0x6c3.GetExtraDataReq paramGetExtraDataReq, long paramLong, TroopGiftCallback paramTroopGiftCallback)
  {
    ...
    for (paramString2 = paramString2.getSkey(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin());; paramString2 = "")
    {
      ...
      ProtoUtils.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new ajxg(this, paramTroopGiftCallback), localReqBody.toByteArray(), paramString1 + "_" + paramInt4, paramInt1, paramInt4, paramString2, paramLong);
      return;
    }
  }
    ...
    for (;;)
    {
      try
      {
        ...
        default: 
          ...
          ProtoUtils.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new ajxi(this, paramTroopGiftCallback, paramString1, paramString2), localReqBody.toByteArray(), "OidbSvc.0x6c2_" + paramInt3, 1730, paramInt3, (Bundle)localObject, paramLong);
          return;
        }
      }
  ...
  private void a(String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, TroopGiftCallback paramTroopGiftCallback)
  {
    ...
    try
    {
      ...
      localClientInfo.bytes_version.set(ByteStringMicro.copyFrom("V 7.6.8.3615".getBytes()), true);
      ...
      ProtoUtils.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new ajxj(this, paramTroopGiftCallback), paramString1.toByteArray(), "OidbSvc.0x962_" + paramInt3, 2402, 1, paramString2, 500L);
      return;
    }
  ...
  private void b(String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3, long paramLong, TroopGiftCallback paramTroopGiftCallback)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramInt2 = 1;
        ProtoUtils.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new ajxh(this, paramTroopGiftCallback, paramString2, paramString3), localReqBody.toByteArray(), paramString1 + "_" + paramInt2, paramInt1, paramInt2, (Bundle)localObject, paramLong);
        return;
      }
      catch (NumberFormatException paramString1) {}
      if (!QLog.isColorLevel()) {
  ...
  public void a(int paramInt, TroopGiftCallback paramTroopGiftCallback)
  {
    ...
    ProtoUtils.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, new ajxk(this, paramTroopGiftCallback), localReqBody.toByteArray(), "OidbSvc.0x9e9_0", 2537, 0);
  }
  ...
  public void a(String paramString, TroopGiftCallback paramTroopGiftCallback)
  {
    try
    {
      ...
      ProtoUtils.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, new ajxl(this, paramTroopGiftCallback), paramString.toByteArray(), "OidbSvc.0xa48_1", 2632, 1, new Bundle(), 6000L);
      return;
    }
