  ...
  implements Manager
{
    ...
    for (;;)
    {
      try
      {
        ...
        default: 
          ...
          ProtoUtils.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new TroopGiftManager.1(this, paramTroopGiftCallback), localReqBody.toByteArray(), paramString1 + "_" + paramInt2, paramInt1, paramInt2, paramString2, paramLong);
          return;
          if (paramInt2 != 11) {
            continue;
          }
  ...
  private void a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, int paramInt4, oidb_0x6c3.GetStockReq paramGetStockReq, oidb_0x6c3.GetExtraDataReq paramGetExtraDataReq, long paramLong, TroopGiftCallback paramTroopGiftCallback)
  {
    ...
    for (paramGetStockReq = paramGetStockReq.getSkey(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin());; paramGetStockReq = "")
    {
      ...
      ProtoUtils.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new TroopGiftManager.3(this, paramTroopGiftCallback), localReqBody.toByteArray(), paramString1 + "_" + paramInt4, paramInt1, paramInt4, paramGetStockReq, paramLong);
      return;
    }
  }
    ...
    for (;;)
    {
      try
      {
        ...
        default: 
          ...
          ProtoUtils.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new TroopGiftManager.5(this, paramTroopGiftCallback, paramString1, paramString2), localReqBody.toByteArray(), "OidbSvc.0x6c2_" + paramInt3, 1730, paramInt3, (Bundle)localObject, paramLong);
          return;
        }
      }
  ...
  private void a(String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, TroopGiftCallback paramTroopGiftCallback)
  {
    ...
    try
    {
      ...
      ProtoUtils.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new TroopGiftManager.6(this, paramTroopGiftCallback), paramString1.toByteArray(), "OidbSvc.0x962_" + paramInt3, 2402, 1, paramString2, 500L);
      return;
    }
  ...
  private void b(String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3, long paramLong, TroopGiftCallback paramTroopGiftCallback)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramInt2 = 1;
        ProtoUtils.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new TroopGiftManager.4(this, paramTroopGiftCallback, paramString2, paramString3), localReqBody.toByteArray(), paramString1 + "_" + paramInt2, paramInt1, paramInt2, (Bundle)localObject, paramLong);
        return;
      }
      catch (NumberFormatException paramString1) {}
      if (!QLog.isColorLevel()) {
  ...
  public void a(TroopGiftAioItemData paramTroopGiftAioItemData, int paramInt, String paramString, long paramLong, TroopGiftCallback paramTroopGiftCallback)
  {
    ...
    do
    {
      ...
      localReqBody.product_id.set(paramTroopGiftAioItemData.jdField_a_of_type_Int, true);
      localReqBody.amount.set(paramTroopGiftAioItemData.f, true);
      ...
      try
      {
        ...
        ProtoUtils.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new TroopGiftManager.7(this, paramTroopGiftCallback, paramTroopGiftAioItemData), localReqBody.toByteArray(), "OidbSvc.0xdad_" + paramInt, 3501, paramInt, paramString, 0L);
        return;
      }
