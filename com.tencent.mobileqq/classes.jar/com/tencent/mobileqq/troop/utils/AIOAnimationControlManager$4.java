  ...
  extends DownloadListener
{
  ...
  {
    Object localObject2 = new AIOAnimationControlManager.DownloadGftData();
    ...
    ((AIOAnimationControlManager.DownloadGftData)localObject2).jdField_a_of_type_Boolean = true;
    ((AIOAnimationControlManager.DownloadGftData)localObject2).jdField_a_of_type_JavaLangString = str1;
    AIOAnimationControlManager.DownloadGiftResStateObservable.a().setChanged();
    AIOAnimationControlManager.DownloadGiftResStateObservable.a().notifyObservers(localObject2);
    ...
    if (paramDownloadTask.a == 0)
    {
      ...
      try
      {
        localObject2 = paramDownloadTask.getAbsolutePath().replace(".zip", "_tmp");
        FileUtils.a(paramDownloadTask.getAbsolutePath(), (String)localObject2, false);
        TroopGiftUtil.a(paramDownloadTask, (String)localObject2);
        ...
        if (((this.a.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie != null) || (this.a.jdField_a_of_type_AndroidAppActivity != null)) && (!AIOAnimationControlManager.jdField_a_of_type_JavaLangString.equals(this.a.b))) {}
        return;
      }
    ...
    for (;;)
    {
      if ((!(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie instanceof NearbyChatPie)) && (!(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie instanceof HotChatPie))) {
        break label446;
      }
    ...
    for (int j = 2;; j = 1)
    {
      ReportController.b(null, "P_CliOper", "Grp_flower", "", "grp_aio", "anime_fail", j, 0, str2, localObject1 + "", paramDownloadTask, i + "");
      break;
      paramDownloadTask = "1";
      break label459;
    }
