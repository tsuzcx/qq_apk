...
public class TroopLinkManager
{
  ...
  private TroopLinkManager()
  {
    ...
    ThreadManager.post(new ajxm(this, BaseApplicationImpl.getApplication().getFilesDir().getAbsolutePath() + File.separator + "troop_link_config.json"), 5, null, false);
  }
  ...
  public boolean a(String paramString)
  {
    ...
    ThreadManager.post(new ajxn(this, (String)???, paramString), 5, null, false);
    return true;
  }
}
