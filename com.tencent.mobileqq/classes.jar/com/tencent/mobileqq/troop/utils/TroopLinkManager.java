...
public class TroopLinkManager
{
  ...
  public static String a(String paramString1, String paramString2, long paramLong1, long paramLong2)
  {
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)))
    {
      QLog.d("TroopManage", 1, "getSmartManagerUrl, url: " + paramString1 + ", troopUin: " + paramString2 + ", robotUin: " + paramLong1 + ", id: " + paramLong2);
  ...
  {
    paramString = TroopLinkManager.LinkParams.a().a(paramString);
  ...
  {
    paramString1 = TroopLinkManager.LinkParams.a().b(paramString2).a(paramString1);
  ...
  {
    paramString3 = TroopLinkManager.LinkParams.a().a(paramString1).b(paramString2).e(paramString3).d("3").c("aio");
  ...
  {
    Object localObject = TroopLinkManager.LinkParams.a().a(paramString);
    if (paramBoolean) {}
    for (paramString = "1";; paramString = "0")
    {
      paramString = ((TroopLinkManager.LinkParams)localObject).f(paramString);
  ...
  public String b(String paramString, TroopLinkManager.LinkParams paramLinkParams)
  {
    ...
    if (!TextUtils.isEmpty(str))
    {
      ...
      if (paramLinkParams != null) {
        paramString = a(str, paramLinkParams);
      }
    }
    return paramString;
  }
