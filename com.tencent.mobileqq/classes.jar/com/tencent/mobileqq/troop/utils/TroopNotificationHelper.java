...
public class TroopNotificationHelper
{
  ...
  private static HashMap<String, TroopNotificationFlagMsg> d;
  ...
  public static TroopNotificationCache a(TroopNotificationHelper.FeedItem paramFeedItem, String paramString, int paramInt1, int paramInt2, long paramLong)
  {
    if (paramFeedItem != null)
    {
      if (paramFeedItem.jdField_a_of_type_Int == 1)
      {
        ...
        localTroopNotificationCache.needConfirm = paramFeedItem.jdField_a_of_type_Boolean;
  ...
  public static TroopNotificationFlagMsg a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (paramString == null)
    {
      ...
      localObject = (TroopNotificationFlagMsg)jdField_d_of_type_JavaUtilHashMap.get(paramString);
      if (localObject == null) {
        break label141;
      }
      ...
      if (QLog.isColorLevel())
      {
        paramString = new StringBuilder().append("HasUnReadRepeatTroopNotification. found in mTroopNotificationRepeatAIOFlag. type = ").append(((TroopNotificationFlagMsg)localObject).jdField_a_of_type_Int).append(", feedsId = ");
    ...
    do
    {
      do
      {
        ...
        paramString = (TroopNotificationFlagMsg)jdField_d_of_type_JavaUtilHashMap.get(paramString);
      ...
      return null;
      paramString = new TroopNotificationFlagMsg(((TroopInfo)localObject).feeds_id, ((TroopInfo)localObject).troopRepeatType);
      paramQQAppInterface = paramString;
    } while (!QLog.isColorLevel());
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((i == 5) || (i == 19))
        {
          ...
          paramBoolean = bool1;
          ((TroopNotificationHelper.FeedItem)localObject5).jdField_a_of_type_Boolean = paramBoolean;
          break label896;
        }
        if (i == 22)
        {
          ...
          if (localGroupFeedsMessage.opt_uint32_ctl_flag.has())
          {
            ...
            ((TroopNotificationHelper.FeedItem)localObject3).jdField_a_of_type_Boolean = paramBoolean;
            break;
          }
        }
        return null;
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt1, long paramLong1, long paramLong2, long paramLong3, String paramString, int paramInt2, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      if (localObject != null)
      {
        ...
        localQQMessageFacade.a().a(paramQQAppInterface, String.valueOf(paramLong1), String.valueOf(paramLong2), localArrayList, 23, paramInt1, ((TroopNotificationHelper.FeedItem)localObject).jdField_e_of_type_Int, ((TroopNotificationHelper.FeedItem)localObject).jdField_b_of_type_JavaLangString);
      }
    }
    catch (Exception paramQQAppInterface)
    {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    if ((jdField_a_of_type_JavaUtilHashMap != null) && (jdField_a_of_type_JavaUtilHashMap.containsKey(paramString)))
    {
      ...
      ((TroopHandler)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.TROOP_HANDLER)).a(paramQQAppInterface, paramString, arrayOfByte, paramInt);
      return;
    }
    try
    {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        do
        {
          do
          {
            ...
            if (bool2)
            {
              ...
              if ((paramList != null) && (paramList.h() < 5) && (paramList.d().equals(paramString1)))
              {
                if (QLog.isColorLevel()) {
        ...
        if (paramInt2 == 1)
        {
          ...
          paramQQAppInterface = BaseApplication.getContext().getString(2131719914);
          label469:
          ((TroopNotificationMsg)localObject1).jdField_a_of_type_JavaLangString = paramQQAppInterface;
        }
        for (;;)
        {
          ((TroopNotificationMsg)paramString1.msg).jdField_c_of_type_Int = paramInt2;
          paramString1.lastmsgtime = paramInt1;
          paramString2.a().b(paramString1);
          paramList.sendEmptyMessage(1009);
          return;
          if ((!(paramString1.msg instanceof TroopNotificationMsg)) || (((TroopNotificationMsg)paramString1.msg).jdField_c_of_type_Int != 1)) {
            break;
          }
          return;
          i = 11;
          break label429;
          paramQQAppInterface = BaseApplication.getContext().getString(2131719913);
          break label469;
  ...
  public static void a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    QLog.d("TroopNotificationHelper", 2, TroopNotificationHelper.class.getSimpleName() + "-->clearTroopNotification. troop = " + paramString);
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    } while (((paramString2.msg instanceof TroopNotificationMsg)) && (((TroopNotificationMsg)paramString2.msg).jdField_c_of_type_Int == 1));
    if (QLog.isColorLevel()) {
    ...
    ((TroopNotificationMsg)localObject).jdField_c_of_type_Int = 0;
