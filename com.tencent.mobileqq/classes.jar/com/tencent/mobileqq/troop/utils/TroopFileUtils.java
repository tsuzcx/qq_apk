...
public class TroopFileUtils
{
  ...
  public static long a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, long paramLong1, String paramString3, int paramInt1, String paramString4, long paramLong2, int paramInt2, int paramInt3, int paramInt4, long paramLong3, int paramInt5)
  {
    ...
    paramString1 = paramQQAppInterface.getMessageFacade().a(localMessageRecord.senderuin, 1);
    ...
    for (localMessageRecord.shmsgseq = ((ChatMessage)paramString1.get(paramString1.size() - 1)).shmsgseq;; localMessageRecord.shmsgseq = Math.abs(new Random().nextInt()))
    {
      ...
      if (localMessageRecord.isSend()) {
        ((SVIPHandler)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.SVIP_HANDLER)).a(localMessageRecord);
      }
      paramString1.serial();
  ...
  public static boolean a(String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    //   4: iload_2
    //   5: iload_3
    //   6: invokestatic 957	com/tencent/mobileqq/troop/utils/TroopFileUtils:a	(Ljava/lang/String;II)Landroid/graphics/Bitmap;
    //   9: astore 6
    //   11: aload 6
    //   13: ifnonnull +10 -> 23
    //   16: iload 5
    ...
    //   165: ldc_w 997
    //   168: iconst_2
    //   169: new 228	java/lang/StringBuilder
    //   172: dup
    ...
    //   212: ldc_w 997
    //   215: iconst_2
    //   216: new 228	java/lang/StringBuilder
    //   219: dup
    ...
    //   272: ldc_w 997
    //   275: iconst_2
    //   276: new 228	java/lang/StringBuilder
    //   279: dup
    ...
    //   311: ldc_w 997
    //   314: iconst_2
    //   315: new 228	java/lang/StringBuilder
    //   318: dup
    ...
    //   369: ldc_w 997
    //   372: iconst_2
    //   373: new 228	java/lang/StringBuilder
    //   376: dup
    ...
    //   410: ldc_w 997
    //   413: iconst_2
    //   414: new 228	java/lang/StringBuilder
    //   417: dup
