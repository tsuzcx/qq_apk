  ...
  implements Manager
{
  ...
  public void a(String paramString, List<ChatMessage> arg2)
  {
    ...
    for (;;)
    {
      ...
      if (i < 0)
      {
        localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().b(paramString, 1, l);
  ...
  public boolean a(String paramString)
  {
    ...
    //   1: monitorenter
    //   2: aload_1
    //   3: invokestatic 300	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   6: ifne +63 -> 69
    //   9: aload_1
    //   10: aload_0
    //   11: getfield 33	com/tencent/mobileqq/troop/utils/TroopBindPublicAccountMgr:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   14: invokevirtual 305	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   17: ifeq +52 -> 69
    //   20: iconst_1
    //   21: istore_2
