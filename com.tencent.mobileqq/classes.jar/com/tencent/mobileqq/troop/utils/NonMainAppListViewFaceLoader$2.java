...
class NonMainAppListViewFaceLoader$2
  extends Handler
{
  public void handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        else if ((localObject2 instanceof VideoItemHolder))
        {
          localObject2 = (VideoItemHolder)localObject2;
          if ((((VideoItemHolder)localObject2).a != null) && (((VideoItemHolder)localObject2).a.a != null) && ((((VideoItemHolder)localObject2).a.a.jdField_a_of_type_Int == 1) || (((VideoItemHolder)localObject2).a.a.jdField_a_of_type_Int == 6)) && (!TextUtils.isEmpty(((VideoItemHolder)localObject2).a.a.j)) && (((VideoItemHolder)localObject2).a.a.j.equals(localObject1))) {
            ((VideoItemHolder)localObject2).b.setImageBitmap(paramMessage);
          }
        }
      }
 ...
 * Qualified Name:     com.tencent.mobileqq.troop.utils.NonMainAppListViewFaceLoader.2
