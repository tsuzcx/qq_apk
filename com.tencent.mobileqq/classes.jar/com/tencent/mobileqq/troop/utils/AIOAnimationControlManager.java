  ...
  implements Manager
{
  ...
  FrameSprite.OnFrameEndListener jdField_a_of_type_ComTencentMobileqqSurfaceviewactionGlFrameSprite$OnFrameEndListener = new ajuh(this);
  public AIOAnimationControlManager.OnAnimationPlayEndListener a;
  TroopGiftAnimationController.OnCleanAnimationListener jdField_a_of_type_ComTencentMobileqqTroopgiftTroopGiftAnimationController$OnCleanAnimationListener = new ajug(this);
  ...
  DownloadListener jdField_a_of_type_ComTencentMobileqqVipDownloadListener = new ajum(this);
  public Comparator a;
  public HashMap a;
  public String b;
  public HashMap b;
  ...
  public AIOAnimationControlManager(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_JavaUtilComparator = new ajul(this);
  ...
  private void a(AppInterface paramAppInterface)
  {
    ...
    ThreadManager.post(new ajue(this), 8, null, true);
  }
  ...
  private void i()
  {
    Object localObject = new File(AppConstants.cd);
  ...
  public void a(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      do
      {
        do
        {
          do
          {
            do
            {
              ...
              {
                this.jdField_a_of_type_AndroidOsHandler.postDelayed(new ajuo(this, paramBoolean), 500L);
                return;
            ...
            ((TroopGiftManager)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(112)).a(((MessageForDeliverGiftTips)localObject5).frienduin, ((MessageForDeliverGiftTips)localObject5).interactId, ((MessageForDeliverGiftTips)localObject5).giftId, new ajup(this, (MessageForDeliverGiftTips)localObject5, (List)localObject3, paramBoolean, (List)localObject4, (String)localObject6));
            return;
          ...
          {
            localObject3 = ((TroopGiftManager)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(112)).a((String)localObject1, ((MessageForDeliverGiftTips)localObject5).bagId, new ajus(this, (MessageForDeliverGiftTips)localObject5, (String)localObject1, paramBoolean));
          ...
          for (;;)
          {
            ...
            this.jdField_a_of_type_AndroidOsHandler.postDelayed(new ajuv(this, paramBoolean), 500L);
            return;
        ...
        this.jdField_a_of_type_ComTencentMobileqqTroopgiftTroopInteractGiftAnimationController.a((MessageForDeliverGiftTips)localObject5, (String)localObject6, false, new ajuw(this, paramBoolean));
        return;
        if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null)
        {
          localObject3 = "0";
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqTrooppiceffectsTroopPicEffectsController.a(((MessageForTroopEffectPic)localObject5).effectId, (Bitmap)localObject1, ((TroopChatPie)localObject3).o, new ajuf(this, paramBoolean));
        ((List)localObject4).remove(localObject5);
        return;
        i = 90;
        continue;
  ...
  public boolean a(MessageForDeliverGiftTips paramMessageForDeliverGiftTips, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      ((TroopGiftManager)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(112)).a(paramMessageForDeliverGiftTips.frienduin, paramMessageForDeliverGiftTips.interactId, paramMessageForDeliverGiftTips.giftId, new ajuj(this, paramMessageForDeliverGiftTips, paramBoolean));
    }
  }
