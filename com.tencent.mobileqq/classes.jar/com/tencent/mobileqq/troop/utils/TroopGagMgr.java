  ...
  implements Manager
{
  ...
  TroopObserver jdField_a_of_type_ComTencentMobileqqAppTroopObserver = new ajbn(this);
  ...
  public TroopGagMgr.SelfGagInfo a(String paramString, boolean paramBoolean)
  {
    ...
    if ((((TroopInfo)localObject).dwGagTimeStamp != 0L) && (!bool))
    {
      ...
      return new TroopGagMgr.SelfGagInfo(this, paramString, true, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext().getString(2131430242), 60L);
    }
    if ((((TroopInfo)localObject).dwGagTimeStamp_me != 0L) && (l < ((TroopInfo)localObject).dwGagTimeStamp_me + 3L))
    {
      ...
      String str = localContext.getString(2131430243);
  ...
  {
    return String.format(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext().getString(2131430244), new Object[] { b(paramContext, paramLong) });
  }
  ...
  public String a(Context paramContext, long paramLong1, long paramLong2)
  {
    ...
    paramContext = ((Context)localObject).getString(2131430245);
    String str = ((Context)localObject).getString(2131430246);
    localObject = ((Context)localObject).getString(2131430247);
    if (paramLong1 < 60L) {
  ...
  public void a(int paramInt1, long paramLong1, long paramLong2, long paramLong3, String paramString, int paramInt2)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramLong3 == 0L)
        {
          paramString = ((Context)localObject2).getResources().getString(2131430451);
      ...
      paramString = ((Context)localObject2).getResources().getString(2131430452);
      continue;
      label244:
      if (paramLong3 == 0L) {
        paramString = ((Context)localObject2).getResources().getString(2131430450, new Object[] { paramString });
      } else {
        paramString = ((Context)localObject2).getResources().getString(2131430449, new Object[] { paramString, c((Context)localObject2, paramLong3) });
      }
    }
  }
  ...
  public void a(String paramString1, String paramString2, long paramLong1, long paramLong2, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (!paramBoolean1)
    {
      localObject1 = ((Context)localObject3).getString(2131430259);
      if ((paramBoolean2) && (bool))
      {
        str = (String)localObject1 + ((Context)localObject3).getString(2131430257);
        if (!paramBoolean1) {
          break label419;
        }
        if (paramLong2 == 0L) {
        ...
        localObject1 = ((Context)localObject3).getString(2131430264);
    ...
    for (int i = 1;; i = 0)
    {
      ...
      for (;;)
      {
        ...
        return;
        str = (String)localObject1 + ((Context)localObject3).getString(2131430258);
        break;
        if ((paramBoolean2) && (bool))
        {
          str = ((Context)localObject3).getString(2131430263);
          break;
        }
        str = ((Context)localObject3).getString(2131430262);
        break;
        localObject1 = ((Context)localObject3).getString(2131430265);
        break label126;
        if (paramLong2 != 0L) {}
        for (i = 2131430260;; i = 2131430261)
        {
  ...
  public void b(String paramString, boolean paramBoolean)
  {
    ...
    {
      new Handler(Looper.getMainLooper()).post(new ajbm(this, paramBoolean, localContext, paramString, i));
      return;
    }
    if (paramBoolean)
    {
    ...
    QQToast.a(localContext, 2130838748, paramString, 0).b(i);
  }
  ...
  public final boolean b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (int i = 2131430254;; i = 2131430250)
    {
      a(i, true);
      return true;
    }
  ...
  public String c(Context paramContext, long paramLong)
  {
    ...
    String str1 = paramContext.getString(2131430245);
    String str2 = paramContext.getString(2131430246);
    Object localObject = paramContext.getString(2131430247);
    if (paramLong < 60L) {
      paramContext = 1 + str1;
    }
    long l2;
