...
{
  TroopGagMgr$3(TroopGagMgr paramTroopGagMgr) {}
    ...
    if (((paramInt1 == 6) || (paramInt1 == 3)) && (paramBoolean))
    {
      ...
      while (paramList.hasNext())
      {
        ...
        if ((paramString != null) && (paramString.uint64_member_uin.has()) && (paramString.uint32_shutup_timestap.has()))
        {
          ...
          ((TroopManager)this.a.a.getManager(QQManagerFactory.TROOP_MANAGER)).c(paramLong1 + "", l + "", paramLong2);
        }
      }
    }
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.troop.utils.TroopGagMgr.3
