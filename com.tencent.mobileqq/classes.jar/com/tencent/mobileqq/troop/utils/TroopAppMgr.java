  ...
  implements Manager
{
  ...
  ThreadLocal<SimpleDateFormat> jdField_a_of_type_JavaLangThreadLocal = new TroopAppMgr.1(this);
  protected Map<String, JSONObject> a;
  protected boolean a;
  protected final int b;
  protected SparseArray<TroopAIOAppInfoListItem> b;
  String b;
  protected String c;
  ...
  public TroopAppMgr(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppTroopHandler = ((TroopHandler)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.TROOP_HANDLER));
    a();
    paramQQAppInterface = new int[2];
    QQAppInterface tmp105_104 = paramQQAppInterface;
    tmp105_104[0] = 0;
    QQAppInterface tmp109_105 = tmp105_104;
    tmp109_105[1] = 32;
    tmp109_105;
    ...
    while (i < j)
    {
      ...
      localTroopAIOAppInfoListItem.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences().getString("appinfo_date_" + k, "");
      localTroopAIOAppInfoListItem.jdField_b_of_type_Int = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences().getInt("KEY_APP_LIST_TIME_STAMP_" + k, 0);
      this.jdField_b_of_type_AndroidUtilSparseArray.put(k, localTroopAIOAppInfoListItem);
      i += 1;
    }
    f();
    d();
    ...
    this.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences().getString("appinfo_all_app_string", HardCodeUtil.a(2131715046));
  }
  ...
  private void f()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      if (((ListIterator)localObject1).hasNext())
      {
        ...
        TroopAIOAppInfoListItem localTroopAIOAppInfoListItem = (TroopAIOAppInfoListItem)this.jdField_b_of_type_AndroidUtilSparseArray.get(((TroopAIOAppInfo)localObject3).groupType);
  ...
  {
    TroopAIOAppInfoListItem localTroopAIOAppInfoListItem = (TroopAIOAppInfoListItem)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt);
    ...
    return localTroopAIOAppInfoListItem.jdField_b_of_type_Int;
  }
  
  public TroopAIOAppInfo a(int paramInt1, int paramInt2)
  {
    Object localObject1 = (TroopAIOAppInfoListItem)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt2, null);
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        localObject1 = (TroopAIOAppInfo)((TroopAIOAppInfoListItem)localObject1).jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt1));
        if (localObject1 != null)
        {
  ...
  public List<TroopAIOAppInfo> a(boolean paramBoolean, int paramInt)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      Object localObject2 = (TroopAIOAppInfoListItem)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt);
      AssertUtils.a(localObject2);
      localObject2 = ((TroopAIOAppInfoListItem)localObject2).a().iterator();
  ...
  public void a(int paramInt)
  {
    ...
    TroopAIOAppInfoListItem localTroopAIOAppInfoListItem = (TroopAIOAppInfoListItem)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt, null);
    if (localTroopAIOAppInfoListItem != null) {}
    for (boolean bool = true;; bool = false)
    {
      AssertUtils.a(bool);
      if (localTroopAIOAppInfoListItem != null) {
        localTroopAIOAppInfoListItem.jdField_a_of_type_JavaLangString = ((String)localObject);
      }
  ...
  {
    TroopAIOAppInfoListItem localTroopAIOAppInfoListItem = (TroopAIOAppInfoListItem)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt2);
    boolean bool;
    if (localTroopAIOAppInfoListItem != null)
    {
      bool = true;
  ...
  public void a(ArrayList<Integer> paramArrayList)
  {
    ...
    TroopAIOAppInfoListItem localTroopAIOAppInfoListItem = (TroopAIOAppInfoListItem)this.jdField_b_of_type_AndroidUtilSparseArray.get(0, null);
    if (localTroopAIOAppInfoListItem != null) {}
    for (boolean bool = true;; bool = false)
    {
      AssertUtils.a(bool);
      ...
      } while (localTroopAIOAppInfoListItem.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(localInteger));
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramBoolean) {
          localTroopAIOAppInfoListItem.jdField_a_of_type_Int |= 0x2;
        } else {
  ...
  public boolean a(int paramInt)
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 44	com/tencent/mobileqq/troop/utils/TroopAppMgr:jdField_b_of_type_AndroidUtilSparseArray	Landroid/util/SparseArray;
    //   8: iload_1
    //   9: aconst_null
    //   10: invokevirtual 294	android/util/SparseArray:get	(ILjava/lang/Object;)Ljava/lang/Object;
    //   13: checkcast 79	com/tencent/mobileqq/troop/utils/TroopAIOAppInfoListItem
    //   16: astore 4
    //   18: aload 4
    //   20: ifnull +20 -> 40
    //   23: iconst_1
    //   24: istore_2
    //   25: iload_2
    //   26: invokestatic 290	com/tencent/biz/qqstory/utils/AssertUtils:a	(Z)V
    //   29: aload 4
    //   31: ifnonnull +14 -> 45
    //   34: iload_3
    //   35: istore_2
    ...
    //   42: goto -17 -> 25
    //   45: aload 4
    //   47: getfield 489	com/tencent/mobileqq/troop/utils/TroopAIOAppInfoListItem:jdField_a_of_type_Int	I
    //   50: istore_1
    //   51: iload_1
    //   52: iconst_1
    //   53: iand
    ...
    //   16	30	4	localTroopAIOAppInfoListItem	TroopAIOAppInfoListItem
  ...
  public boolean a(TroopAIOAppInfo paramTroopAIOAppInfo)
  {
    ...
    Object localObject = (TroopAIOAppInfoListItem)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramTroopAIOAppInfo.groupType);
    boolean bool1;
    if (localObject != null)
    {
      bool1 = true;
  ...
  public boolean a(List<Integer> paramList, int paramInt)
  {
    ...
    {
      AssertUtils.a(bool1);
      if ((localTroopAIOAppInfoListItem != null) && (paramList != null)) {
        break label59;
      }
      return false;
      bool1 = false;
    ...
    for (;;)
    {
      try
      {
        bool2 = localTroopAIOAppInfoListItem.a(paramList);
        bool1 = bool2;
        if (bool2)
        {
          bool1 = bool2;
        ...
        if (bool1)
        {
          ...
          b(localTroopAIOAppInfoListItem.a(), paramInt);
        }
        return bool1;
      }
      finally {}
  ...
  public void b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        {
          int k = arrayOfInt[i];
          Object localObject3 = (TroopAIOAppInfoListItem)this.jdField_b_of_type_AndroidUtilSparseArray.get(k);
          AssertUtils.a(localObject3);
          localObject3 = (TroopAIOAppInfo)((TroopAIOAppInfoListItem)localObject3).jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt));
          if (localObject3 != null)
          {
  ...
  public void b(int paramInt1, int paramInt2)
  {
    ...
    localTroopAIOAppInfoListItem.jdField_b_of_type_Int = paramInt1;
  ...
  {
    int i = paramTroopAIOAppInfo.appid;
    TroopAIOAppInfoListItem localTroopAIOAppInfoListItem = (TroopAIOAppInfoListItem)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramTroopAIOAppInfo.groupType);
    if (localTroopAIOAppInfoListItem != null) {}
    for (boolean bool = true;; bool = false)
    {
      AssertUtils.a(bool);
  ...
  public void c()
  {
    ...
    try
    {
      ...
      ProtoUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new TroopAppMgr.6(this), localReqBody.toByteArray(), "OidbSvc.0xa1e", 2590, 0);
      return;
    }
    finally {}
  }
  ...
  public void onDestroy()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      while (i < j)
      {
        int k = arrayOfInt[i];
        a(false, k);
        TroopAIOAppInfoListItem localTroopAIOAppInfoListItem = (TroopAIOAppInfoListItem)this.jdField_b_of_type_AndroidUtilSparseArray.get(k);
        AssertUtils.a(localTroopAIOAppInfoListItem);
        localTroopAIOAppInfoListItem.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.clear();
        localTroopAIOAppInfoListItem.a();
        localTroopAIOAppInfoListItem.jdField_b_of_type_Int = 0;
        i += 1;
      }
      return;
    }
