  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      return;
      if ((paramView == LeftAppShortcutBarPanel.a(this.a)) && (LeftAppShortcutBarPanel.a(this.a).a != null) && (LeftAppShortcutBarPanel.a(this.a) != null))
      {
        Object localObject = new int[2];
        paramView.getLocationOnScreen((int[])localObject);
        ImageView localImageView = (ImageView)paramView.findViewById(2131378047);
        if (LeftAppShortcutBarPanel.a(this.a) != null)
        {
          if (!LeftAppShortcutBarPanel.a(this.a).a())
          {
            if (LeftAppShortcutBarPanel.a(this.a).a() > 5) {}
            for (int i = ViewUtils.a(247.0F);; i = ViewUtils.a(LeftAppShortcutBarPanel.a(this.a).a() * 40 + 7))
            {
              LeftAppShortcutBarPanel.a(this.a).b(paramView, paramView.getWidth(), 0, localObject[0] - ViewUtils.a(175.0F) / 2, localObject[1] - i);
              localImageView.setImageResource(2130846529);
