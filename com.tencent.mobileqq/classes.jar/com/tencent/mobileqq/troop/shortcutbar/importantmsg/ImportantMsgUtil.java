...
public class ImportantMsgUtil
{
  ...
  {
    String str2 = BaseApplicationImpl.getContext().getResources().getString(2131720164);
    String str1 = str2;
  ...
  {
    String str = BaseApplicationImpl.getContext().getResources().getString(2131720163);
    if (paramBoolean) {
      str = BaseApplicationImpl.getContext().getResources().getString(2131720165);
    }
    for (;;)
    {
      Object localObject;
  ...
  public static ArrayList<ShortcutBarInfo> a(ArrayList<ImportantMsgItem.MsgInfo> paramArrayList)
  {
    ...
    while (paramArrayList.hasNext())
    {
      ...
      ImportantMsgInfo localImportantMsgInfo = a(localMsgInfo);
      if (localImportantMsgInfo != null) {
        localArrayList.add(localImportantMsgInfo);
      } else if (QLog.isColorLevel()) {
        QLog.i("ImportantMsgUtil", 2, "convToImportantMsgInfo error: " + localMsgInfo.toString());
      }
    }
    return localArrayList;
  }
  ...
  {
    String str = BaseApplicationImpl.getContext().getResources().getString(2131720162);
    if ((paramMessageRecord instanceof MessageForArkApp))
    {
      paramMessageRecord = ((MessageForArkApp)paramMessageRecord).ark_app_message;
      if (paramMessageRecord == null) {}
  ...
  {
    String str = BaseApplicationImpl.getContext().getResources().getString(2131720167);
    if ((paramMessageRecord instanceof MessageForArkApp))
    {
      paramMessageRecord = ((MessageForArkApp)paramMessageRecord).ark_app_message;
      if (paramMessageRecord != null) {
  ...
  {
    String str = BaseApplicationImpl.getContext().getResources().getString(2131720166);
    if ((paramMessageRecord instanceof MessageForArkApp))
    {
      paramMessageRecord = ((MessageForArkApp)paramMessageRecord).ark_app_message;
