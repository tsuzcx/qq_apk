  ...
  implements HttpWebCgiAsyncTask.Callback
{
  ...
  public void a(JSONObject paramJSONObject, int paramInt, Bundle paramBundle)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        if (paramJSONObject != null)
        {
          ...
          return;
          if ((VisitorTroopCardPresenter.a(this.a) != null) && (paramJSONObject != null)) {
            try
            {
              ...
              if (paramJSONObject != null)
              {
                ...
                if (paramJSONObject != null)
                {
                  ...
                  if (VisitorTroopCardPresenter.a(this.a) != null) {
                    VisitorTroopCardPresenter.a(this.a).a(true);
                  }
            ...
            {
              VisitorTroopCardPresenter.a(this.a).c(VisitorTroopCardPresenter.a(this.a).getString(2131720176));
            }
          }
        }
      }
    ...
    return;
    label921:
    paramJSONObject = VisitorTroopCardPresenter.a(this.a).getString(2131720176);
    switch (paramInt)
    {
    }
    for (;;)
    {
      VisitorTroopCardPresenter.a(this.a).c(paramJSONObject);
      break label820;
      paramJSONObject = VisitorTroopCardPresenter.a(this.a).getString(2131720171);
      continue;
      paramJSONObject = VisitorTroopCardPresenter.a(this.a).getString(2131720177);
      continue;
      label1008:
      paramInt += 1;
      break;
