  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    if (paramView != null)
    {
      if (TroopNotificationFragment.u(this.a.n) != null) {
        TroopNotificationFragment.u(this.a.n).a();
      }
        ...
        if (((localObject1 instanceof Integer)) && ((localObject2 instanceof Integer)))
        {
          ...
          if ((localObject1 instanceof MessageRecord))
          {
            ...
            if (localObject2 != null)
            {
              ...
              this.a.n.w.sendEmptyMessage(1017);
              TroopNotifyHelper.a((structmsg.StructMsg)localObject2, (AppInterface)TroopNotificationFragment.f(this.a.n), true);
            }
          }
        }
 ...
 * Qualified Name:     com.tencent.mobileqq.troop.troopnotification.ui.TroopNotificationFragment.24.1
