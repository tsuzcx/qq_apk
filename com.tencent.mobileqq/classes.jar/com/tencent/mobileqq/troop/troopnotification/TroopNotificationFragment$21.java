  ...
  implements TroopNotificationUtils.TroopPrivilegeCallback
{
  ...
  public void a(String paramString, structmsg.StructMsg paramStructMsg, int paramInt)
  {
    ...
    if (i != 0)
    {
      ...
      TroopNotificationUtils.a(this.a.a, paramString, "");
      TroopNotificationUtils.a((AppInterface)TroopNotificationFragment.a(this.a));
      if ((TroopNotificationFragment.a(this.a) != null) && (TroopNotificationFragment.a(this.a).isShowing())) {
    ...
    if (paramStructMsg != null)
    {
      ...
      {
        ReportController.b(TroopNotificationFragment.a(this.a), "P_CliOper", "Grp_contacts", "", "notice", "agree_invite", 0, 0, paramString, "", "0", "0");
 ...
 * Qualified Name:     com.tencent.mobileqq.troop.troopnotification.TroopNotificationFragment.21
