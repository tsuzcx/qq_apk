  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    if ((paramView.getTag() instanceof SuspiciousHolder))
    {
      ...
      {
        Object localObject3 = ((SuspiciousHolder)localObject2).jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg;
        int j = ((SuspiciousHolder)localObject2).jdField_a_of_type_Int;
        ...
        if (k == 0)
        {
          ...
          if (localObject1 != null) {
            ((ITroopUtilApi)localObject1).openTroopInfoActivity(TroopNotificationFragment.a(this.a), String.valueOf(((SuspiciousHolder)localObject2).jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.msg.group_code.get()));
          }
          if ((j == 2) || (j == 10) || (j == 12)) {
            i = 1;
          }
          localObject3 = TroopNotificationFragment.a(this.a);
          localObject1 = new StringBuilder();
          ((StringBuilder)localObject1).append(((SuspiciousHolder)localObject2).jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.msg.group_code.get());
        ...
        else if ((((SuspiciousHolder)localObject2).jdField_a_of_type_Int != 2) || (!TroopInfo.isQidianPrivateTroop(((SuspiciousHolder)localObject2).jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.msg.uint32_group_flagext3.get())))
        {
          Object localObject4;
          if (((SuspiciousHolder)localObject2).jdField_a_of_type_Int == 82)
          {
            ...
            ((StringBuilder)localObject4).append(((SuspiciousHolder)localObject2).jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.req_uin.get());
          ...
          else
          {
            ...
            if ((!bool2) || (i != 2))
            {
              localObject4 = (ITroopSysMsgDependApiService)TroopNotificationFragment.a(this.a).getRuntimeService(ITroopSysMsgDependApiService.class, "");
              if (localObject4 != null)
              {
                ...
                localObject1 = TroopNotificationFragment.a(this.a);
                localObject3 = new StringBuilder();
                ((StringBuilder)localObject3).append(((SuspiciousHolder)localObject2).jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.msg.group_code.get());
 ...
 * Qualified Name:     com.tencent.mobileqq.troop.troopnotification.TroopNotificationFragment.27
