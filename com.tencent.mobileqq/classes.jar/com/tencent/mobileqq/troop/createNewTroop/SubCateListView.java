...
public class SubCateListView
{
  ...
  private void a(View paramView, int paramInt1, int paramInt2, Interpolator paramInterpolator, boolean paramBoolean)
  {
    ...
    localValueAnimator.addUpdateListener(new ajgy(this, paramView));
    localValueAnimator.addListener(new ajgz(this, paramBoolean, paramView, paramInt2));
  ...
  private void a(CateListAdapter.SingleItemViewHolder paramSingleItemViewHolder, boolean paramBoolean)
  {
    ...
    for (ValueAnimator localValueAnimator = ValueAnimator.ofInt(new int[] { 0, 100 });; localValueAnimator = ValueAnimator.ofInt(new int[] { 100, 0 }))
    {
      ...
      localValueAnimator.addUpdateListener(new ajha(this, paramSingleItemViewHolder));
      localValueAnimator.start();
      return;
    }
  }
  ...
  private void b()
  {
    ...
    GridView localGridView = (GridView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368350);
    ...
    this.b = this.jdField_a_of_type_AndroidViewView.findViewById(2131368349);
  }
