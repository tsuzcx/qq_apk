...
import com.tencent.mobileqq.activity.selectmember.SelectMemberBuddyListAdapter.SelectBuddyChildTag;
...
public class RelationFriendsTroopViewHelper
{
  ...
  RelationFriendsSearchHelper jdField_a_of_type_ComTencentMobileqqTroopCreateNewTroopRelationFriendsSearchHelper;
  private RelationFriendsTroopViewHelper.CallBack jdField_a_of_type_ComTencentMobileqqTroopCreateNewTroopRelationFriendsTroopViewHelper$CallBack;
  ...
  public RelationFriendsTroopViewHelper(QQAppInterface paramQQAppInterface, PinnedFooterExpandableListView paramPinnedFooterExpandableListView, RelationFriendsTroopViewHelper.CallBack paramCallBack)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_ComTencentWidgetPinnedFooterExpandableListView = paramPinnedFooterExpandableListView;
    this.jdField_a_of_type_ComTencentMobileqqTroopCreateNewTroopRelationFriendsTroopViewHelper$CallBack = paramCallBack;
    this.jdField_a_of_type_ComTencentMobileqqTroopCreateNewTroopRelationFriendsSearchHelper = new RelationFriendsSearchHelper(paramQQAppInterface);
  }
  ...
  private void e()
  {
    ...
    {
      ArrayList localArrayList1 = this.jdField_a_of_type_ComTencentMobileqqTroopCreateNewTroopRelationFriendsTroopViewHelper$CallBack.a();
      if (localArrayList1 != null)
      {
        ...
        localTroopCreateLogic.a(localArrayList2, new RelationFriendsTroopViewHelper.4(this));
      }
    }
  }
  ...
  public View a(int paramInt1, int paramInt2, View paramView, ViewGroup paramViewGroup, Context paramContext, View.OnClickListener paramOnClickListener, RelationTroopEntity paramRelationTroopEntity)
  {
    if (paramView == null)
    {
      paramView = LayoutInflater.from(paramContext).inflate(2131560566, paramViewGroup, false);
      paramViewGroup = new ContactListAdapter.SelectBuddyChildTag();
      paramViewGroup.c = ((ImageView)paramView.findViewById(2131368603));
    ...
    for (paramInt1 = 4;; paramInt1 = 113)
    {
      ...
      paramContext = paramRelationTroopEntity.troopInfo.getTroopDisplayName();
  ...
  public void a()
  {
    ReportController.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_create", "", "grptab", "friendlist_exp", a(), 0, "", "", "", "");
  }
  ...
  public void a(ArrayList<Groups> paramArrayList, SparseArray<ArrayList<Entity>> paramSparseArray)
  {
    ...
    if (!this.b.isEmpty())
    {
      ...
      ((Groups)localObject2).group_name = HardCodeUtil.a(2131718520);
    ...
    if (!this.jdField_a_of_type_JavaUtilArrayList.isEmpty())
    {
      ...
      ((Groups)localObject1).group_name = HardCodeUtil.a(2131718519);
  ...
  public void b()
  {
    ReportController.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_create", "", "grptab", "friendlist_clk", a(), 0, "", "", "", "");
  }
  
  public void c()
  {
    ReportController.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_create", "", "grptab", "grplist_exp", a(), 0, "", "", "", "");
  }
  
  public void d()
  {
    ReportController.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_create", "", "grptab", "grplist_clk", a(), 0, "", "", "", "");
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes10.jar
 * Qualified Name:     com.tencent.mobileqq.troop.createNewTroop.RelationFriendsTroopViewHelper
