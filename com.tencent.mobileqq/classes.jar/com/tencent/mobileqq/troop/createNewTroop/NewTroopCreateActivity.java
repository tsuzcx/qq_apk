  ...
  implements bbom
{
  ...
  {
    this.jdField_a_of_type_AndroidAnimationValueAnimator$AnimatorUpdateListener = new aykp(this);
    this.jdField_a_of_type_AndroidAnimationAnimatorListenerAdapter = new aykq(this);
  }
  ...
  private void f()
  {
    ...
    awqx.b(this.app, "dc00899", "grp_create", "", "grp_create_bytype", "exp_grptype", 0, 0, "", "", "", "");
  }
  ...
  protected void a()
  {
    ...
    if (this.jdField_a_of_type_JavaLangString == null) {
      this.jdField_a_of_type_JavaLangString = getString(2131625700);
    }
  ...
  protected void b()
  {
    super.setContentView(2131493774);
    View localView = findViewById(2131309736);
    ...
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131302806));
    this.d = ((TextView)findViewById(2131302832));
    this.jdField_a_of_type_ComTencentMobileqqWidgetTabBarView2 = ((TabBarView2)findViewById(2131312086));
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)findViewById(2131312087));
    this.jdField_a_of_type_ComTencentMobileqqWidgetTabBarView2.a(0, getString(2131654645));
    this.jdField_a_of_type_ComTencentMobileqqWidgetTabBarView2.a(0).setContentDescription(getString(2131654645));
    this.jdField_a_of_type_ComTencentMobileqqWidgetTabBarView2.a(1, getString(2131654646));
    this.jdField_a_of_type_ComTencentMobileqqWidgetTabBarView2.a(1).setContentDescription(getString(2131654646));
  ...
  protected void c()
  {
    ...
    this.jdField_b_of_type_AndroidWidgetTextView.setText(2131653378);
    ...
    if (AppSetting.c)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setContentDescription(getString(2131653378));
    }
    this.jdField_b_of_type_AndroidWidgetTextView.setOnClickListener(new ayko(this));
  }
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    this.jdField_c_of_type_Int = vms.a(this, 40.0F);
    a();
    b();
    c();
    d();
