  ...
  extends BaseAdapter
{
  ...
  public static final String b = HardCodeUtil.a(2131701539);
  protected Context a;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = HardCodeUtil.a(2131701538);
  }
  
  public CateListAdapter(NewTroopCateView paramNewTroopCateView, QQAppInterface paramQQAppInterface)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131560745, null);
