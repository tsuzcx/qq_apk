...
public class CateListAdapter$SingleItemViewHolder
{
  ...
  View.OnTouchListener jdField_a_of_type_AndroidViewView$OnTouchListener = new ajfy(this);
  ...
  public CateListAdapter$SingleItemViewHolder(View paramView, int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368337));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131368339));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131368341));
    this.c = paramView.findViewById(2131368340);
    this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131368338);
  }
