...
public class CateListAdapter$SingleItemViewHolder
{
  ...
  View.OnTouchListener jdField_a_of_type_AndroidViewView$OnTouchListener = new CateListAdapter.SingleItemViewHolder.1(this);
  ...
  public CateListAdapter$SingleItemViewHolder(View paramView, int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131380842));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131380839));
    this.c = paramView.findViewById(2131380841);
    this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131380843);
  }
