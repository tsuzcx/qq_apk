  ...
  implements View.OnClickListener
{
  ...
  TroopCreateLogic jdField_a_of_type_ComTencentMobileqqTroopDataTroopCreateLogic = (TroopCreateLogic)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.MGR_TROOP_CREATE);
  ...
  public void onClick(View paramView)
  {
    ...
    {
      NewTroopSearchResultDialog.ViewHolder localViewHolder = (NewTroopSearchResultDialog.ViewHolder)paramView.getTag();
      this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopCreateLogic.a(localViewHolder.a);
    ...
    for (;;)
    {
      ...
      else if (2131364824 == paramView.getId())
      {
        this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopCreateLogic.a();
        dismiss();
      }
  ...
  public void show()
  {
    LinearLayout localLinearLayout = (LinearLayout)LayoutInflater.from(getContext()).inflate(2131560749, null);
    ...
    this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)localLinearLayout.findViewById(2131377642));
    localObject = (TroopCreateLogic)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.MGR_TROOP_CREATE);
    ...
    localObject = new NewTroopSearchResultDialog.ListAdapter(this, ((TroopCreateLogic)localObject).a);
    ...
    this.jdField_a_of_type_AndroidViewView = localLinearLayout.findViewById(2131365458);
    this.jdField_a_of_type_AndroidViewView.setOnClickListener(this);
    int i = this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopCreateLogic.a.size();
    localObject = String.format(HardCodeUtil.a(2131707551), new Object[] { Integer.valueOf(i) });
    ((TextView)localLinearLayout.findViewById(2131377024)).setText((CharSequence)localObject);
    ...
    String str = String.format(HardCodeUtil.a(2131707557), new Object[] { Integer.valueOf(this.jdField_a_of_type_Int) });
    ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131377730)).setText(str);
    ((SingleLineTextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379988)).setText(((TroopCreateLogic.TroopCreateInfo)localObject).c);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localLinearLayout.findViewById(2131364824));
