...
public class RelationFriendsTroopViewHelper$3
  implements Runnable
{
  public RelationFriendsTroopViewHelper$3(bdxn parambdxn, String paramString) {}
  
  public void run()
  {
    ArrayList localArrayList1 = this.this$0.jdField_a_of_type_Bdxj.a(this.a);
    ...
    do
    {
      ...
      localArrayList3.addAll(bdxn.a(this.this$0).b());
      i = 0;
      j = 0;
