  ...
  implements TroopCreateLogicActivity.OnGetBitmapCallback
{
  ...
  public void a(Bitmap paramBitmap)
  {
    ...
    ((IWXShareHelper)QRoute.api(IWXShareHelper.class)).shareTroopToWXFriendCircle(this.jdField_a_of_type_ComTencentMobileqqTroopTroopcreateUiTroopCreateLogicActivity.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString, paramBitmap, this.b, this.c);
  }
}
