  ...
  public Bitmap run(DownloadParams paramDownloadParams, Bitmap paramBitmap)
  {
    ...
    if ((paramDownloadParams instanceof int[]))
    {
      ...
      if (paramDownloadParams.length == 2) {
        return BaseImageUtil.c(paramBitmap, 20.0F, paramDownloadParams[0], paramDownloadParams[1]);
      }
    }
 ...
 * Qualified Name:     com.tencent.mobileqq.qqlive.prepare.GameListAdapter.2
