...
class AudienceListImpl$1
  extends BaseSsoCallback
{
  AudienceListImpl$1(AudienceListImpl paramAudienceListImpl, AudienceListCallback paramAudienceListCallback) {}
  ...
  public void onProxyRequestSuccess(int paramInt, QQLiveRspData paramQQLiveRspData)
  {
    try
    {
      ...
      if ((paramQQLiveRspData.a != null) && (paramQQLiveRspData.a.b != null))
      {
        ...
        if (localLiveAudienceListData.list.size() == 0) {
          localLiveAudienceListData.isEnd = true;
        }
 ...
 * Qualified Name:     com.tencent.mobileqq.qqlive.api.impl.room.AudienceListImpl.1
