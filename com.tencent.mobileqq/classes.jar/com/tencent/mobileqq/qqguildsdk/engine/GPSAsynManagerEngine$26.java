...
class GPSAsynManagerEngine$26
  implements IGetChannelCategoryWithListCallback
{
  GPSAsynManagerEngine$26(GPSAsynManagerEngine paramGPSAsynManagerEngine, String paramString, IGetChannelCategoryCallback paramIGetChannelCategoryCallback) {}
  ...
  {
    if (paramInt == 0) {
      this.c.d().b(this.a, paramCategoryChannelSortInfo, paramList);
    }
 ...
 * Qualified Name:     com.tencent.mobileqq.qqguildsdk.engine.GPSAsynManagerEngine.26
