...
class GPSAsynManagerEngine$38
  implements IFetchAppChnnPreInfoListCallback
{
  GPSAsynManagerEngine$38(GPSAsynManagerEngine paramGPSAsynManagerEngine, List paramList1, List paramList2, String paramString) {}
  ...
  public void a(int paramInt, String paramString, List<AppChnnPreInfo> paramList, List<String> paramList1, List<String> paramList2, List<String> paramList3)
  {
    ...
    GProLog.b("【gpro_sdk】", false, "sdk callback", "tryRrefreshAllAppChnnPreInfo", (String)localObject, paramInt, paramString, localStringBuilder.toString());
    if (paramInt == 0)
    {
 ...
 * Qualified Name:     com.tencent.mobileqq.qqguildsdk.engine.GPSAsynManagerEngine.38
