...
class GPSAsynManagerEngine$29
  implements IGetChannelCategoryWithListCallback
{
  GPSAsynManagerEngine$29(GPSAsynManagerEngine paramGPSAsynManagerEngine, String paramString, IGetChannelCategoryCallback paramIGetChannelCategoryCallback) {}
  ...
  {
    if (paramInt == 0) {
      this.c.d().e(this.a, paramCategoryChannelSortInfo, paramList);
    }
 ...
 * Qualified Name:     com.tencent.mobileqq.qqguildsdk.engine.GPSAsynManagerEngine.29
