...
class GPSAsynManagerEngine$30
  implements IGetChannelCategoryWithListCallback
{
  GPSAsynManagerEngine$30(GPSAsynManagerEngine paramGPSAsynManagerEngine, String paramString, IGetChannelCategoryCallback paramIGetChannelCategoryCallback) {}
  ...
  {
    if (paramInt == 0) {
      this.c.d().f(this.a, paramCategoryChannelSortInfo, paramList);
    }
 ...
 * Qualified Name:     com.tencent.mobileqq.qqguildsdk.engine.GPSAsynManagerEngine.30
