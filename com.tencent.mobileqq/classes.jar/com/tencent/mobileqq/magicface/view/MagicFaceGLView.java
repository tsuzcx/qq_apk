...
{
  private arhq jdField_a_of_type_Arhq;
  ...
  public MagicFaceGLView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    setRenderer(this.jdField_a_of_type_Arhq);
    setRenderMode(0);
    if (QLog.isColorLevel()) {
  ...
  {
    if (this.jdField_a_of_type_Arhq == null) {
      return;
    }
    this.jdField_a_of_type_Arhq.a(paramArrayOfByte1, paramArrayOfByte2, paramInt1, paramInt2, getWidth(), getHeight(), paramFloat, this.b);
    requestRender();
  }
