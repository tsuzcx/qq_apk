  ...
  implements View.OnClickListener
{
  ...
  public void a(Emoticon paramEmoticon, int paramInt1, String paramString, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqMagicfaceServiceMagicfaceActionManager.a(new adrg(this, paramInt1, (TextView)localObject1));
      this.jdField_a_of_type_ComTencentMobileqqMagicfaceServiceMagicfaceActionManager.a(new adrk(this, l, paramInt1));
      ...
      this.jdField_a_of_type_AndroidOsHandler.post(new adrf(this));
      this.jdField_b_of_type_ComTencentMobileqqMagicfaceViewMagicfaceContainerView.setVisibility(8);
      ((View)this.jdField_b_of_type_ComTencentMobileqqMagicfaceViewIMagicFaceView).setVisibility(8);
    ...
    this.jdField_a_of_type_AndroidOsHandler.postDelayed(new adrn(this), 200L);
    ((IMagicFaceView)localObject2).setSurfaceCreatelistener(new adro(this, paramEmoticon, paramInt1, paramString, paramInt2));
  }
  ...
  public void a(Emoticon paramEmoticon, MagicfaceViewController.OnMagicPlayEnd paramOnMagicPlayEnd)
  {
    ...
    if (this.jdField_a_of_type_JavaLangRunnable == null) {
      this.jdField_a_of_type_JavaLangRunnable = new adrd(this);
    }
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqMagicfaceViewMagicfaceContainerView == null)
    {
      ...
      {
        localView = View.inflate(BaseApplicationImpl.getContext(), 2130970912, null);
        this.jdField_a_of_type_ComTencentMobileqqMagicfaceViewIMagicFaceView = ((IMagicFaceView)localView.findViewById(2131372185));
        this.jdField_a_of_type_ComTencentMobileqqMagicfaceViewMagicfaceContainerView = ((MagicfaceContainerView)localView.findViewById(2131372184));
        this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131372186));
        this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131372187));
        this.jdField_b_of_type_AndroidWidgetButton = ((Button)localView.findViewById(2131372191));
        this.jdField_a_of_type_AndroidWidgetButton = ((Button)localView.findViewById(2131372188));
        this.jdField_d_of_type_AndroidWidgetButton = ((Button)localView.findViewById(2131372190));
        this.e = ((Button)localView.findViewById(2131372189));
    ...
    for (View localView = View.inflate(BaseApplicationImpl.getContext(), 2130970911, null);; localView = View.inflate(BaseApplicationImpl.getContext(), 2130970913, null))
    {
      ...
      this.jdField_b_of_type_ComTencentMobileqqMagicfaceViewIMagicFaceView = ((IMagicFaceView)localView.findViewById(2131366101));
      this.jdField_b_of_type_ComTencentMobileqqMagicfaceViewMagicfaceContainerView = ((MagicfaceContainerView)localView.findViewById(2131366100));
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131372195));
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131372183));
      this.jdField_c_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131366102));
      this.f = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131372193));
      ...
      return;
      localView = View.inflate(BaseApplicationImpl.getContext(), 2130970914, null);
      break;
    }
  }
  ...
  public void c()
  {
    ...
    {
      this.e.setBackgroundResource(2130843878);
      return;
    }
    this.e.setBackgroundResource(2130843877);
  }
  ...
  public void d()
  {
    ...
    {
      this.f.setBackgroundResource(2130843854);
      return;
    }
    this.f.setBackgroundResource(2130843875);
  }
  
  public void e()
  {
    this.jdField_a_of_type_AndroidOsHandler.post(new adrc(this));
  }
  ...
  public void g()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqMagicfaceServiceMagicfaceActionManager.a())
    {
      ...
      ((MagicfaceActionManager)localObject).a(new adre(this, (MagicfaceActionManager)localObject));
    }
    for (;;)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqMagicfaceViewMagicfaceViewController$OnMagicPlayEnd != null)
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131372191: 
      ...
      this.jdField_a_of_type_AndroidOsHandler.postDelayed(new adrb(this), 300L);
      return;
    case 2131372190: 
      f();
      return;
