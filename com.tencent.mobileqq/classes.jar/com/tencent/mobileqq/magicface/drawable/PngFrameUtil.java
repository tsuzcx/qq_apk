...
public class PngFrameUtil
{
      ...
      try
      {
        ...
        if (paramString1.has("process_frame"))
        {
          ...
          if ((localObject != null) && (((JSONArray)localObject).length() > 0))
          {
            ...
            {
              localPngPlayParam.jdField_a_of_type_ArrayOfJavaLangString[i] = (EmoticonUtils.z.replace("[epId]", paramString2) + ((JSONArray)localObject).getString(i));
              i += 1;
            }
          }
        }
        ...
        for (;;)
        {
          ...
          localPngPlayParam.jdField_b_of_type_ArrayOfJavaLangString[i] = (EmoticonUtils.z.replace("[epId]", paramString2) + ((JSONArray)localObject).getString(i));
          i += 1;
        }
  ...
  private String a(String paramString)
  {
    ...
    localStringBuffer.append(EmoticonUtils.z.replace("[epId]", paramString));
