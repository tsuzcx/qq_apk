  ...
  implements Manager
{
  ...
  private Map<String, TroopDetailOnlineData> a;
  ...
  public List<TroopOnlineMemberItem> a(String paramString)
  {
    paramString = (TroopDetailOnlineData)this.jdField_a_of_type_JavaUtilMap.get(paramString);
    if (paramString == null) {
      return null;
  ...
  public void a(String paramString1, List<TroopOnlineMemberItem> paramList, int paramInt1, String paramString2, int paramInt2)
  {
    int i = paramInt1;
    if (paramInt1 <= 0) {
      i = 10;
