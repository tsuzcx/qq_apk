...
public class CameraRoamingStrategy$3
  implements Runnable
{
  public CameraRoamingStrategy$3(anqk paramanqk, List paramList) {}
  ...
  public void run()
  {
    ...
    if (i < this.a.size())
    {
      ...
      if (!TextUtils.isEmpty(localCameraEmotionData.resid))
      {
        ...
        axqy.b(this.this$0.a, "dc00898", "", "", "0X800A372", "0X800A372", 0, 0, "", "", localCameraEmotionData.resid, "");
      }
      for (;;)
      {
        i += 1;
    ...
    ((anrx)this.this$0.a.getManager(334)).c();
    ((ajtf)this.this$0.a.a(160)).a(3, true, 0);
  }
}
