...
public class MultiEmotionSaveManager$1
  implements Runnable
{
  public MultiEmotionSaveManager$1(aseb paramaseb, File paramFile1, File paramFile2, String paramString, asdk paramasdk) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        bheg.a(BaseApplicationImpl.getContext(), this.jdField_a_of_type_JavaIoFile.getAbsolutePath());
        i = 1;
        if (i == 0) {
          continue;
        }
      ...
      catch (Exception localException)
      {
        ...
        this.jdField_a_of_type_Asdk.b = 10005;
        this.jdField_a_of_type_Asdk.c = axje.a(this.jdField_a_of_type_Asdk.b);
        continue;
        j = 2;
        continue;
        int i = -1;
      ...
      localObject = this.jdField_a_of_type_Asdk;
      if (i == 0) {
        continue;
      }
      i = k;
      ((asdk)localObject).a = i;
      localObject = aseb.a(this.this$0).obtainMessage(j);
      ((Message)localObject).obj = this.jdField_a_of_type_Asdk;
      aseb.a(this.this$0).sendMessage((Message)localObject);
      return;
      ...
      this.jdField_a_of_type_Asdk.b = 10004;
      this.jdField_a_of_type_Asdk.c = axje.a(this.jdField_a_of_type_Asdk.b);
      i = 0;
    }
  }
