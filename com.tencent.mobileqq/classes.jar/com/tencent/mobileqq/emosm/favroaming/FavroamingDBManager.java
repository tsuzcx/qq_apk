  ...
  extends CustomEmotionRoamingDBManagerBase<CustomEmotionData>
{
        ...
        for (;;)
        {
          ...
          if (paramList2 != null)
          {
            ...
            if ((TextUtils.isEmpty(localCustomEmotionData2.url)) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null))
            {
              ...
              localCustomEmotionData2.url = FavEmoConstant.a(str, paramString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
            }
  ...
  public CustomEmotionData a(List<CustomEmotionData> paramList, String paramString)
  {
    ...
    {
      paramString = new StringBuilder().append("fav custom data customDataList is empty. dataList: ");
      if (paramList == null) {}
      for (bool = true;; bool = false)
      {
        QLog.e("FavroamingDBManager", 1, bool);
        return null;
      }
    }
    ...
    if (i < j)
    {
      ...
      {
        localObject1 = new StringBuilder().append("fav custom data emotionData: ");
        if (localCustomEmotionData == null) {}
        for (bool = true;; bool = false)
        {
          QLog.d("FavroamingDBManager", 1, bool);
          if (localCustomEmotionData != null) {
            QLog.d("FavroamingDBManager", 1, "fav custom data emotionData type: " + localCustomEmotionData.RomaingType);
          }
          i += 1;
          break;
        }
    ...
    for (;;)
    {
      ...
      {
        localObject1 = new StringBuilder().append("md5 id is empty. md5:");
      ...
      for (localObject1 = localCustomEmotionData.md5;; localObject1 = HexUtil.bytes2HexStr(MD5.getFileMd5(localCustomEmotionData.emoPath)))
      {
  ...
  public CustomEmotionRoamingManagerBase<CustomEmotionData> a()
  {
    return (FavroamingManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.FAV_ROAMING_MANAGER);
  }
  
  public EmoticonInfo a(CustomEmotionData paramCustomEmotionData)
  {
    if (paramCustomEmotionData.isMarkFace)
    {
      ...
      ((PicEmoticonInfo)localObject1).emoticon = ((EmoticonManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.EMOTICON_MANAGER)).a(str, (String)localObject2);
      ((PicEmoticonInfo)localObject1).src_type = 2;
    ...
    Object localObject1 = ((VipComicMqqManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.MQQ_COMIC_MANAGER)).a();
    Object localObject2 = new FavoriteEmoticonInfo();
    ((FavoriteEmoticonInfo)localObject2).type = 4;
    ((FavoriteEmoticonInfo)localObject2).path = a(paramCustomEmotionData);
    ((FavoriteEmoticonInfo)localObject2).src_type = 2;
    ...
    if (localObject1 != null) {
      ((FavoriteEmoticonInfo)localObject2).actionData = VipComicMqqManager.a((Map)localObject1, paramCustomEmotionData.md5);
    }
  ...
  public String a(CustomEmotionData paramCustomEmotionData)
  {
    ...
    do
    {
      ...
      localObject1 = AppConstants.SDCARD_IMG_FAVORITE;
      localObject2 = (VipComicMqqManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.MQQ_COMIC_MANAGER);
      if ((localObject2 != null) && (((VipComicMqqManager)localObject2).a(paramCustomEmotionData)))
      {
        ...
        if (!TextUtils.isEmpty(paramCustomEmotionData.resid)) {
          return (String)localObject1 + DiySecureFileHelper.a(paramCustomEmotionData.resid);
        }
  ...
  public List<CustomEmotionData> a(List<String> paramList1, List<String> paramList2, String paramString, List<Integer> paramList)
  {
    ...
    for (;;)
    {
      ...
      paramString = (FavEmoRoamingHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.FAVEMO_ROAMING_HANDLER);
      if (paramList2.size() > 0) {
        paramString.a(paramList2, 2);
      }
      int j = a(paramList1, paramList2);
      QLog.d("FavroamingDBManager", 1, "updateFavEmotionsInLocalEx final cache size: " + paramList2.size() + ",delete size:" + i + ",upload size:" + j);
      return paramList1;
      i = 0;
    }
  }
  
  protected void a(CustomEmotionData paramCustomEmotionData, int paramInt)
  {
    super.b(paramCustomEmotionData, paramInt);
  }
  ...
  public boolean a(CustomEmotionData paramCustomEmotionData, int paramInt)
  {
    ...
    for (Object localObject = "isUpdate";; localObject = "overflow_downloaded")
    {
      ...
      localObject = (FavroamingManager)a();
      if (localObject != null) {
        ((FavroamingManager)localObject).d(paramCustomEmotionData);
      }
      return true;
    }
  }
  ...
  public List<EmoticonInfo> b()
  {
    ...
    for (;;)
    {
      ...
      {
        localObject1 = (FavoriteEmoticonInfo)localObject2;
        if ((TextUtils.isEmpty(((FavoriteEmoticonInfo)localObject1).path)) && (TextUtils.isEmpty(((FavoriteEmoticonInfo)localObject1).url))) {
          QLog.e("FavroamingDBManager", 1, "path and url is null! " + ((FavoriteEmoticonInfo)localObject1).toString());
        } else {
  ...
  {
    Map localMap = ((VipComicMqqManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.MQQ_COMIC_MANAGER)).a();
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i >= 0)
        {
          ...
          else if (localCustomEmotionData.isMarkFace)
          {
            ...
            ((PicEmoticonInfo)localObject).isAPNG = localCustomEmotionData.isAPNG;
            ((PicEmoticonInfo)localObject).emoticon = ((EmoticonManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.EMOTICON_MANAGER)).a(str2, str1);
            ((PicEmoticonInfo)localObject).src_type = 2;
      ...
      ((FavoriteEmoticonInfo)localObject).type = 4;
      ((FavoriteEmoticonInfo)localObject).path = a(localCustomEmotionData);
      ((FavoriteEmoticonInfo)localObject).src_type = 2;
      ((FavoriteEmoticonInfo)localObject).eId = localCustomEmotionData.eId;
      ((FavoriteEmoticonInfo)localObject).url = localCustomEmotionData.url;
      ((FavoriteEmoticonInfo)localObject).actionData = VipComicMqqManager.a(localOutOfMemoryError, localCustomEmotionData.md5);
      ((FavoriteEmoticonInfo)localObject).roamingType = localCustomEmotionData.RomaingType;
      ((FavoriteEmoticonInfo)localObject).emoId = localCustomEmotionData.emoId;
      ((FavoriteEmoticonInfo)localObject).resID = localCustomEmotionData.resid;
      if ((TextUtils.isEmpty(((FavoriteEmoticonInfo)localObject).path)) && (TextUtils.isEmpty(((FavoriteEmoticonInfo)localObject).url))) {
  ...
  public List<CustomEmotionData> d()
  {
    ...
    //   3: iconst_0
    //   4: istore 6
    //   6: new 271	java/util/ArrayList
    //   9: dup
    //   10: invokespecial 272	java/util/ArrayList:<init>	()V
    //   13: astore 8
    //   15: aload_0
    //   16: getfield 64	com/tencent/mobileqq/emosm/favroaming/FavroamingDBManager:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   19: ifnonnull +10 -> 29
    //   22: aload 8
    //   24: astore 9
    //   26: aload 9
    //   28: areturn
    //   29: aload_0
    //   30: getfield 64	com/tencent/mobileqq/emosm/favroaming/FavroamingDBManager:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   33: invokevirtual 561	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lcom/tencent/mobileqq/persistence/QQEntityManagerFactoryProxy;
    //   36: invokevirtual 567	com/tencent/mobileqq/persistence/QQEntityManagerFactoryProxy:createEntityManager	()Lcom/tencent/mobileqq/persistence/EntityManager;
    //   39: astore 11
    //   41: aload 11
    //   43: ifnull +379 -> 422
    //   46: aload 11
    //   48: aload_0
    //   49: invokevirtual 569	com/tencent/mobileqq/emosm/favroaming/FavroamingDBManager:a	()Ljava/lang/Class;
    //   52: iconst_0
    //   53: aconst_null
    //   54: aconst_null
    //   55: aconst_null
    ...
    //   57: aconst_null
    //   58: aconst_null
    //   59: invokevirtual 575	com/tencent/mobileqq/persistence/EntityManager:query	(Ljava/lang/Class;ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    //   62: astore 9
    //   64: ldc_w 577
    //   67: aload_0
    //   68: getfield 64	com/tencent/mobileqq/emosm/favroaming/FavroamingDBManager:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   71: invokevirtual 580	com/tencent/mobileqq/app/QQAppInterface:getCurrentUin	()Ljava/lang/String;
    //   74: invokestatic 583	com/tencent/mobileqq/app/utils/DiySecureFileHelper:a	(Ljava/lang/String;Ljava/lang/String;)I
    //   77: iconst_1
    //   78: if_icmpge +335 -> 413
    //   81: aload 11
    //   83: invokevirtual 587	com/tencent/mobileqq/persistence/EntityManager:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   86: astore 10
    //   88: aload 9
    ...
    //   144: getstatic 410	com/tencent/mobileqq/app/AppConstants:SDCARD_IMG_FAVORITE	Ljava/lang/String;
    ...
    //   181: getstatic 410	com/tencent/mobileqq/app/AppConstants:SDCARD_IMG_FAVORITE	Ljava/lang/String;
    ...
    //   192: invokestatic 417	com/tencent/mobileqq/app/utils/DiySecureFileHelper:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   213: istore 4
    //   215: aload 10
    //   217: invokevirtual 592	com/tencent/mobileqq/persistence/EntityTransaction:begin	()V
    //   220: iconst_1
    //   221: istore_3
    //   222: iload_3
    //   223: istore_2
    ...
    //   227: aload 11
    //   229: aload 8
    //   231: invokevirtual 596	com/tencent/mobileqq/persistence/EntityManager:update	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   234: pop
    //   235: iload_3
    //   236: istore_1
    //   237: iload 5
    ...
    //   274: getstatic 410	com/tencent/mobileqq/app/AppConstants:SDCARD_IMG_FAVORITE	Ljava/lang/String;
    ...
    //   297: invokevirtual 601	java/lang/String:matches	(Ljava/lang/String;)Z
    //   300: ifeq +399 -> 699
    //   303: iload_1
    //   304: istore_2
    //   305: iload_1
    ...
    //   327: aload 12
    //   329: aload 12
    //   331: invokestatic 417	com/tencent/mobileqq/app/utils/DiySecureFileHelper:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   349: istore 4
    //   351: aload 10
    //   353: invokevirtual 592	com/tencent/mobileqq/persistence/EntityTransaction:begin	()V
    //   356: iconst_1
    //   357: istore_3
    //   358: iload_3
    //   359: istore_2
    ...
    //   363: aload 11
    //   365: aload 8
    //   367: invokevirtual 596	com/tencent/mobileqq/persistence/EntityManager:update	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   370: pop
    //   371: iload_3
    //   372: istore_1
    //   373: goto -136 -> 237
    ...
    //   383: istore 4
    //   385: aload 10
    //   387: invokevirtual 604	com/tencent/mobileqq/persistence/EntityTransaction:commit	()V
    //   390: iload_1
    //   391: ifeq +8 -> 399
    //   394: aload 10
    //   396: invokevirtual 607	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   399: ldc_w 577
    //   402: aload_0
    //   403: getfield 64	com/tencent/mobileqq/emosm/favroaming/FavroamingDBManager:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   406: invokevirtual 580	com/tencent/mobileqq/app/QQAppInterface:getCurrentUin	()Ljava/lang/String;
    //   409: iconst_1
    //   410: invokestatic 610	com/tencent/mobileqq/app/utils/DiySecureFileHelper:a	(Ljava/lang/String;Ljava/lang/String;I)V
    //   413: aload 11
    //   415: invokevirtual 613	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   418: aload 9
    //   420: astore 8
    //   422: iload 7
    //   424: istore_2
    ...
    //   440: ifle +169 -> 609
    //   443: new 271	java/util/ArrayList
    //   446: dup
    //   447: invokespecial 272	java/util/ArrayList:<init>	()V
    //   450: astore 9
    //   452: aload 8
    ...
    //   519: aload 11
    //   521: iconst_1
    //   522: invokevirtual 544	com/tencent/mobileqq/emosm/favroaming/FavroamingDBManager:a	(Lcom/tencent/mobileqq/data/CustomEmotionData;I)V
    //   525: goto -61 -> 464
    //   528: astore 8
    //   530: iconst_0
    //   531: istore 4
    ...
    //   535: istore_2
    //   536: aload 8
    //   538: invokevirtual 616	java/lang/Exception:printStackTrace	()V
    //   541: iload 4
    //   543: ifeq -144 -> 399
    //   546: aload 10
    //   548: invokevirtual 607	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   551: goto -152 -> 399
    //   554: astore 8
    //   556: iconst_0
    //   557: istore_2
    ...
    //   559: ifeq +8 -> 567
    //   562: aload 10
    //   564: invokevirtual 607	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   567: aload 8
    //   569: athrow
    //   570: aload 11
    ...
    //   590: aload 9
    //   592: aload 11
    //   594: invokeinterface 254 2 0
    //   599: pop
    //   600: aload_0
    //   601: invokevirtual 618	com/tencent/mobileqq/emosm/favroaming/FavroamingDBManager:b	()V
    //   604: iconst_1
    //   605: istore_1
    //   606: goto -88 -> 518
    //   609: aload_0
    //   610: invokevirtual 620	com/tencent/mobileqq/emosm/favroaming/FavroamingDBManager:a	()V
    //   613: iload_2
    //   614: ifeq +10 -> 624
    //   617: aload_0
    //   618: aload 8
    //   620: iconst_2
    //   621: invokevirtual 476	com/tencent/mobileqq/emosm/favroaming/FavroamingDBManager:a	(Ljava/util/List;I)V
    //   624: aload 8
    //   626: ifnonnull +67 -> 693
    //   629: new 271	java/util/ArrayList
    //   632: dup
    //   633: invokespecial 272	java/util/ArrayList:<init>	()V
    //   636: astore 8
    //   638: aload 8
    //   640: astore 9
    ...
    //   671: invokevirtual 263	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    ...
    //   0	707	0	this	FavroamingDBManager
    //   94	512	1	i	int
    //   109	505	2	j	int
    //   205	167	3	k	int
    //   111	431	4	m	int
