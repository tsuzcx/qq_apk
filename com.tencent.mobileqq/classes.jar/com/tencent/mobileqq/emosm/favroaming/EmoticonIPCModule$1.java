...
public class EmoticonIPCModule$1
  implements Runnable
{
  public EmoticonIPCModule$1(anso paramanso, Bundle paramBundle, String paramString, ansh paramansh, int paramInt) {}
  ...
  public void run()
  {
    ...
    if ("action_group_emo_big_pic_add_fav".equals(this.jdField_a_of_type_JavaLangString)) {
      if (!this.jdField_a_of_type_Ansh.b((String)localObject))
      {
    ...
    this.jdField_a_of_type_Ansh.a((String)localObject);
  }
}
