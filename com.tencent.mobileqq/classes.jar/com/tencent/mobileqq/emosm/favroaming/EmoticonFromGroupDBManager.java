  ...
  implements Manager
{
  ...
  private Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new EmoticonFromGroupDBManager.1(this);
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  EntityManager jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager;
  List<URLDrawable> jdField_a_of_type_JavaUtilList = new ArrayList(20);
  ...
  public List<EmoticonFromGroupEntity> a()
  {
    ...
    return this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager.query(EmoticonFromGroupEntity.class);
  }
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    if ((paramMessageRecord instanceof MessageForPic)) {
      d(((VasExtensionManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.VAS_EXTENSION_MANAGER)).a.a(paramMessageRecord));
    }
    for (;;)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("StressTesting.Emoticon.EmoticonFromGroup", 2, "EmoticonFromGroup deal with per msg time = [" + (Calendar.getInstance().getTimeInMillis() - l) + "]");
      }
      return;
      if ((paramMessageRecord instanceof MessageForMixedMsg))
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if ((localObject instanceof MessageForPic))
          {
            ...
            d(((VasExtensionManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.VAS_EXTENSION_MANAGER)).a.a((MessageRecord)localObject));
          }
        }
      }
    }
    ...
    do
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((localObject instanceof MessageForPic))
        {
          localObject = (MessageForPic)localObject;
          MessageForMixedMsg.copyBaseInfoFromMixedToPic((MessageForPic)localObject, paramMessageRecord);
          localObject = ((VasExtensionManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.VAS_EXTENSION_MANAGER)).a.a((MessageRecord)localObject);
