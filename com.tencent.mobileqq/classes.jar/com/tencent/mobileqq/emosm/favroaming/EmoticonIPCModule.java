  ...
  extends QIPCModule
{
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    ThreadManager.post(new EmoticonIPCModule.1(this, paramBundle, paramString, ((VasExtensionManager)((QQAppInterface)localAppRuntime).getManager(QQManagerFactory.VAS_EXTENSION_MANAGER)).a, paramInt), 5, null, true);
    return null;
  }
}
