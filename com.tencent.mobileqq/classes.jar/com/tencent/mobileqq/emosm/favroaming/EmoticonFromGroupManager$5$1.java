...
{
  EmoticonFromGroupManager$5$1(EmoticonFromGroupManager.5 param5, URLDrawable paramURLDrawable, CustomEmotionData paramCustomEmotionData, FavroamingManager paramFavroamingManager, FavroamingDBManager paramFavroamingDBManager) {}
  
  public void onLoadCanceled(URLDrawable paramURLDrawable)
  {
    EmoticonFromGroupManager.a(this.jdField_a_of_type_ComTencentMobileqqEmosmFavroamingEmoticonFromGroupManager$5.this$0).a.remove(this.jdField_a_of_type_ComTencentImageURLDrawable);
  }
  ...
  public void onLoadSuccessed(URLDrawable paramURLDrawable)
  {
    ...
    do
    {
      ...
      {
        return;
        str = EmoticonFromGroupManager.a(this.jdField_a_of_type_ComTencentMobileqqEmosmFavroamingEmoticonFromGroupManager$5.this$0, paramURLDrawable);
      } while ("".equals(str));
    ...
    try
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqEmosmFavroamingFavroamingManager.d(this.jdField_a_of_type_ComTencentMobileqqDataCustomEmotionData);
