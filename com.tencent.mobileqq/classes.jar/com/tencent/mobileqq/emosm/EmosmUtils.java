...
public class EmosmUtils
{
  ...
  public static String a(Context paramContext, Message paramMessage)
  {
    ...
    return paramContext.getString(2131692001);
  }
  ...
  public static boolean a(Context paramContext)
  {
    ...
    if (!bool) {
      QQToast.a(BaseApplicationImpl.getContext(), 2131692257, 0).a();
    }
    return bool;
  }
  ...
  public static byte[] a(String paramString)
  {
    ...
    //   11: ifeq +63 -> 74
    //   14: new 321	java/io/FileInputStream
    //   17: dup
    //   18: new 150	java/io/File
    //   21: dup
    //   22: aload_0
    //   23: invokespecial 155	java/io/File:<init>	(Ljava/lang/String;)V
    //   26: invokespecial 324	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   29: astore_1
    //   30: aload_1
    //   31: astore_0
    //   32: aload_1
    //   33: invokevirtual 327	java/io/FileInputStream:available	()I
    //   36: newarray byte
    //   38: astore_2
    //   39: aload_1
    //   40: astore_0
    //   41: aload_1
    //   42: aload_2
    //   43: invokevirtual 331	java/io/FileInputStream:read	([B)I
    //   46: pop
    //   47: aload_1
    //   48: ifnull +7 -> 55
    //   51: aload_1
    //   52: invokevirtual 334	java/io/FileInputStream:close	()V
    //   55: aload_2
    //   56: areturn
    //   57: astore_2
    //   58: aconst_null
    ...
    //   61: astore_0
    //   62: aload_2
    //   63: invokevirtual 335	java/io/FileNotFoundException:printStackTrace	()V
    //   66: aload_1
    //   67: ifnull +7 -> 74
    //   70: aload_1
    //   71: invokevirtual 334	java/io/FileInputStream:close	()V
    //   74: aconst_null
    //   75: areturn
    //   76: astore_2
    //   77: aconst_null
    ...
    //   80: astore_0
    //   81: aload_2
    //   82: invokevirtual 336	java/io/IOException:printStackTrace	()V
    //   85: aload_1
    //   86: ifnull -12 -> 74
    //   89: aload_1
    //   90: invokevirtual 334	java/io/FileInputStream:close	()V
    //   93: goto -19 -> 74
    //   96: astore_0
    //   97: goto -23 -> 74
    //   100: astore_1
    ...
    //   104: ifnull +7 -> 111
    //   107: aload_0
    //   108: invokevirtual 334	java/io/FileInputStream:close	()V
    //   111: aload_1
    //   112: athrow
    //   113: astore_0
    //   114: aload_2
  ...
  public static boolean b(String paramString)
  {
    ...
    //   2: iconst_0
    //   3: istore_3
    //   4: new 391	com/tencent/mobileqq/emosm/EmosmRandomAccessFile
    //   7: dup
    //   8: aload_0
    //   9: ldc_w 393
    //   12: invokespecial 396	com/tencent/mobileqq/emosm/EmosmRandomAccessFile:<init>	(Ljava/lang/String;Ljava/lang/String;)V
    //   15: astore 4
    //   17: aload 4
    //   19: astore_0
    //   20: bipush 10
    ...
    //   29: aload 4
    //   31: aload 5
    //   33: invokevirtual 397	com/tencent/mobileqq/emosm/EmosmRandomAccessFile:read	([B)I
    //   36: pop
    //   37: iload_3
    //   38: istore_2
    //   39: aload 5
    ...
    //   78: ifnull +10 -> 88
    //   81: aload 4
    //   83: invokevirtual 398	com/tencent/mobileqq/emosm/EmosmRandomAccessFile:close	()V
    //   86: iload_2
    //   87: istore_3
    //   88: iload_3
    //   89: ireturn
    //   90: astore_0
    //   91: aload_0
    //   92: invokevirtual 336	java/io/IOException:printStackTrace	()V
    //   95: iload_2
    //   96: istore_3
    //   97: invokestatic 85	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   100: ifeq -12 -> 88
    //   103: ldc_w 400
    //   106: iconst_2
    //   107: ldc_w 402
    //   110: aload_0
    //   111: invokestatic 406	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   114: iload_2
    //   115: ireturn
    //   116: astore 5
    //   118: aconst_null
    ...
    //   123: astore_0
    //   124: aload 5
    //   126: invokevirtual 336	java/io/IOException:printStackTrace	()V
    //   129: aload 4
    //   131: astore_0
    //   132: invokestatic 85	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   135: ifeq +18 -> 153
    //   138: aload 4
    //   140: astore_0
    //   141: ldc_w 400
    ...
    //   145: ldc_w 408
    //   148: aload 5
    //   150: invokestatic 406	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   153: iload_2
    //   154: istore_3
    //   155: aload 4
    //   157: ifnull -69 -> 88
    //   160: aload 4
    //   162: invokevirtual 398	com/tencent/mobileqq/emosm/EmosmRandomAccessFile:close	()V
    //   165: iconst_0
    //   166: ireturn
    //   167: astore_0
    //   168: aload_0
    //   169: invokevirtual 336	java/io/IOException:printStackTrace	()V
    //   172: iload_2
    //   173: istore_3
    //   174: invokestatic 85	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   177: ifeq -89 -> 88
    //   180: ldc_w 400
    //   183: iconst_2
    //   184: ldc_w 402
    //   187: aload_0
    //   188: invokestatic 406	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   191: iconst_0
    //   192: ireturn
    //   193: astore 4
    //   195: aconst_null
    ...
    //   198: ifnull +7 -> 205
    //   201: aload_0
    //   202: invokevirtual 398	com/tencent/mobileqq/emosm/EmosmRandomAccessFile:close	()V
    //   205: aload 4
    //   207: athrow
    //   208: astore_0
    //   209: aload_0
    //   210: invokevirtual 336	java/io/IOException:printStackTrace	()V
    //   213: invokestatic 85	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   216: ifeq -11 -> 205
    //   219: ldc_w 400
    //   222: iconst_2
    //   223: ldc_w 402
    //   226: aload_0
    //   227: invokestatic 406	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   230: goto -25 -> 205
    //   233: astore 4
    //   235: goto -38 -> 197
    //   238: astore 5
    ...
    //   15	146	4	localEmosmRandomAccessFile	EmosmRandomAccessFile
