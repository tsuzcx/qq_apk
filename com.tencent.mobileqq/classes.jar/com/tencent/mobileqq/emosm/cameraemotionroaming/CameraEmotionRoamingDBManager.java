...
import com.tencent.mobileqq.app.CameraEmoRoamingHandler.CameraEmoImg;
...
public class CameraEmotionRoamingDBManager
  extends CustomEmotionRoamingDBManagerBase<CameraEmotionData>
{
  private boolean a;
  private boolean b;
  
  public CameraEmotionRoamingDBManager(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
  }
  
  private CameraEmotionData a(CameraEmoRoamingHandler.CameraEmoImg paramCameraEmoImg, int paramInt)
  {
    if ((paramCameraEmoImg == null) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)) {
      return null;
    }
    ...
    for (localCameraEmotionData.md5 = CameraEmoConstant.a(paramCameraEmoImg.a);; localCameraEmotionData.md5 = paramCameraEmoImg.d)
    {
  ...
  private void a(List<CameraEmoRoamingHandler.CameraEmoImg> paramList1, List<CameraEmoRoamingHandler.CameraEmoImg> paramList2)
  {
    int k = 0;
    if (paramList2.size() < paramList1.size())
    {
      ...
      while (paramList2.hasNext()) {
        paramList1.remove((CameraEmoRoamingHandler.CameraEmoImg)paramList2.next());
      }
    }
    for (boolean bool = true;; bool = false)
    {
      if (bool)
      {
        ...
        {
          Object localObject = (CameraEmoRoamingHandler.CameraEmoImg)localIterator.next();
          i = j + 1;
          localObject = a((CameraEmoRoamingHandler.CameraEmoImg)localObject, i);
          j = i;
          if (localObject != null)
          {
  ...
  public String a(CameraEmotionData paramCameraEmotionData)
  {
    ...
    return CameraEmoConstant.a(str1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin());
  }
  ...
  public void a(CameraEmotionData paramCameraEmotionData, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      paramCameraEmotionData = StickerRecManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  ...
  public void a(List<CameraEmotionData> paramList, int paramInt)
  {
    super.a(paramList, paramInt);
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
      StickerRecManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).g();
    }
  }
  
  public void a(List<CameraEmoRoamingHandler.CameraEmoImg> paramList, List<String> paramList1, List<String> paramList2)
  {
    boolean bool2 = false;
    boolean bool1 = false;
 ...
 * Qualified Name:     com.tencent.mobileqq.emosm.cameraemotionroaming.CameraEmotionRoamingDBManager
