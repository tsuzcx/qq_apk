...
public class FavRoamingStrategy$4
  implements Runnable
{
  public FavRoamingStrategy$4(aqzl paramaqzl, Object paramObject, arce paramarce, int paramInt) {}
      ...
      while (((Iterator)localObject3).hasNext())
      {
        ...
        if (localCustomEmotionData != null) {
          ...
          else if ((this.jdField_a_of_type_JavaLangObject instanceof FavoriteEmoticonInfo))
          {
            ...
            for (localObject1 = AppConstants.SDCARD_IMG_FAVORITE + amsz.a(((FavoriteEmoticonInfo)this.jdField_a_of_type_JavaLangObject).path);; localObject1 = ((FavoriteEmoticonInfo)this.jdField_a_of_type_JavaLangObject).path)
            {
    ...
    if (((List)localObject2).size() > 0)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        if (!TextUtils.isEmpty(((CustomEmotionData)localObject3).resid))
        {
          ...
          aqzl.a(this.this$0).add(((CustomEmotionData)localObject3).resid);
      ...
      if (((List)localObject1).size() > 0) {
        this.jdField_a_of_type_Arce.a((List)localObject1);
      }
    }
    for (;;)
    {
      if (aqzl.a(this.this$0) != null) {
        aqzl.a(this.this$0).obtainMessage(207, Integer.valueOf(this.jdField_a_of_type_Int)).sendToTarget();
      }
      return;
