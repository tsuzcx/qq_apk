  ...
  implements Handler.Callback, View.OnClickListener, IEmosmView, AdapterView.OnItemClickListener, GestureSelectGridView.OnSelectListener
{
  ...
  public FavEmosmViewPage(QQAppInterface paramQQAppInterface, IphoneTitleBarActivity paramIphoneTitleBarActivity)
  {
    ...
    this.jdField_e_of_type_Int = AIOUtils.a(88.0F, paramIphoneTitleBarActivity.getResources());
  }
  ...
  private void a(View paramView, int paramInt)
  {
    ...
    AIOEmotionFragment.a(this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity, (EmoticonInfo)getItem(paramInt), AnimationUtils.a(paramView.jdField_a_of_type_ComTencentImageURLImageView));
  }
  ...
  private void a(FavEmosmViewPage.Holder paramHolder)
  {
    ...
    Animatable localAnimatable = (Animatable)BaseApplication.getContext().getResources().getDrawable(2130839545);
  ...
  private void c(int paramInt)
  {
    if (this.jdField_f_of_type_Int == 0) {
      this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity.setTitle(this.jdField_a_of_type_ComTencentMobileqqEmosmBaseEmosmStrategy.a());
    }
    while (this.jdField_f_of_type_Int != 1) {
      return;
    }
    String str = String.format(this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity.getString(2131691984), new Object[] { Integer.valueOf(paramInt) });
  ...
  private void d(int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_JavaUtilList != null) && (localObject1 != null))
    {
      ...
      FavroamingManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(Integer.valueOf(((EmoticonInfo)localObject1).emoId));
    }
  }
  ...
  private void d(FavEmosmViewPage.Holder paramHolder)
  {
    ...
    {
      return;
      localObject = paramHolder.jdField_a_of_type_ComTencentImageURLImageView.getTag(2131381651);
    } while (!(localObject instanceof ICustomEmotionInfo));
  ...
  private void i()
  {
    if (this.jdField_f_of_type_Int == 1)
    {
      ...
      if ((!this.jdField_a_of_type_ComTencentMobileqqEmosmBaseEmosmStrategy.b()) && (!VipUtils.b((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()))) {
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
      }
      this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
      this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
      this.jdField_f_of_type_AndroidWidgetTextView.setText(2131691985);
      this.jdField_f_of_type_AndroidWidgetTextView.setContentDescription(this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity.getString(2131691986));
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqEmosmFavEmosmViewPage$IEmosmViewPagerListener != null) {
        this.jdField_a_of_type_ComTencentMobileqqEmosmFavEmosmViewPage$IEmosmViewPagerListener.b(false);
      }
      ReportController.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "ep_mall", "0X80057D5", 0, 0, "", "", "", "");
    }
    while (this.jdField_f_of_type_Int != 0)
    {
    ...
    this.jdField_f_of_type_AndroidWidgetTextView.setContentDescription(this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity.getString(2131691967));
    if ((this.jdField_a_of_type_ComTencentMobileqqEmosmBaseEmosmStrategy.b()) || (VipUtils.b((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()))) {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqEmosmFavEmosmViewPage$IEmosmViewPagerListener != null) {
      this.jdField_a_of_type_ComTencentMobileqqEmosmFavEmosmViewPage$IEmosmViewPagerListener.b(true);
    }
    ReportController.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800B8BB", "0X800B8BB", 0, 0, "", "", "", "");
    ReportController.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "ep_mall", "0X80057D3", 0, 0, "", "", "", "");
  }
  ...
  private void j()
  {
    ...
    for (;;)
    {
      if (i == 0)
      {
        this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity.requestPermissions(new FavEmosmViewPage.1(this), 1, new String[] { "android.permission.WRITE_EXTERNAL_STORAGE" });
        return;
        i = 0;
      }
      else
  ...
  private void k()
  {
    ...
    {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity, 2131694510, 1).b(this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity.getResources().getDimensionPixelSize(2131299166));
      return;
    }
    ...
    ReportController.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800B8BE", "0X800B8BE", localArrayList.size(), 0, "", "", "", "");
    ...
    for (;;)
    {
      n();
      return;
      EmotionBatchForwardOption.a(this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity, localArrayList);
    }
  }
  ...
  private void l()
  {
    ...
    if (this.jdField_b_of_type_JavaUtilList != null)
    {
      ...
      localObject1 = ((FavroamingDBManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.FAVROAMING_DB_MANAGER)).a();
    ...
    return;
    label328:
    Object localObject4 = (FavEmoRoamingHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.FAVEMO_ROAMING_HANDLER);
    ...
    for (;;)
    {
      ...
      if (j > 0)
      {
        ...
        while (i >= 0)
        {
          ...
          ((FavroamingDBManager)localObject2).a((CustomEmotionBase)localObject1);
          ...
          ((FavroamingDBManager)localObject2).c((CustomEmotionBase)localObject1);
          i -= 1;
        }
        ((FavroamingDBManager)localObject2).a();
      }
      i = localArrayList3.size() + localArrayList2.size();
      ReportController.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800B8BC", "0X800B8BC", i, 0, String.valueOf(i), "", "", "");
      return;
    }
  }
  ...
  private void m()
  {
    Object localObject = (ActionSheet)ActionSheetHelper.a(this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity, null);
    ((ActionSheet)localObject).setMainTitle(2131691969);
    ((ActionSheet)localObject).addButton(this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity.getString(2131692345), 3);
    ...
    ReportController.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800B8BF", "0X800B8BF", i, 0, "", "", "", "");
  }
  ...
  private void p()
  {
    ...
    for (;;)
    {
      if (i == 0)
      {
        this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity.requestPermissions(new FavEmosmViewPage.5(this), 3, new String[] { "android.permission.READ_EXTERNAL_STORAGE", "android.permission.WRITE_EXTERNAL_STORAGE" });
        return;
        i = 0;
      }
      else
      {
        o();
        ReportController.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800A6D6", "0X800A6D6", 0, 0, "", "", "", "");
        return;
        i = 1;
      }
    }
  ...
  private void q()
  {
    if (this.jdField_c_of_type_Boolean)
    {
      ...
      ((FavEmoRoamingHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.FAVEMO_ROAMING_HANDLER)).notifyUI(2, true, null);
    }
  }
  ...
  public void a(BaseEmosmStrategy paramBaseEmosmStrategy)
  {
    ...
    int j = AIOUtils.a(0.0F, localResources);
    int k = AIOUtils.a(4.0F, localResources);
    int m = AIOUtils.a(4.0F, localResources);
    this.jdField_a_of_type_Int = ((i - j * 2 - k * 3) / 4);
    this.jdField_b_of_type_Int = this.jdField_a_of_type_Int;
    this.jdField_f_of_type_AndroidWidgetTextView = this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity.rightViewText;
    this.jdField_e_of_type_AndroidWidgetTextView = this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity.leftView;
    this.jdField_e_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_f_of_type_AndroidWidgetTextView.setVisibility(0);
    this.jdField_f_of_type_AndroidWidgetTextView.setText(2131691985);
    this.jdField_f_of_type_AndroidWidgetTextView.setContentDescription(this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity.getString(2131691986));
    this.jdField_f_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity.findViewById(2131366229));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity.findViewById(2131366231));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity.findViewById(2131366230));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity.findViewById(2131366241));
    this.jdField_b_of_type_AndroidWidgetTextView.setContentDescription(this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity.getString(2131691974));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity.findViewById(2131366232));
    this.jdField_d_of_type_AndroidWidgetTextView.setContentDescription(this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity.getString(2131691988));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity.findViewById(2131371899));
    this.jdField_a_of_type_ComTencentWidgetGestureSelectGridView = ((GestureSelectGridView)this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity.findViewById(2131366239));
    this.jdField_a_of_type_ComTencentWidgetGestureSelectGridView.setSelectMode(false);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity.findViewById(2131366240));
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity.findViewById(2131366177));
    ...
    if ((paramBaseEmosmStrategy.a(this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity)) && (paramBaseEmosmStrategy.jdField_a_of_type_Boolean))
    {
      this.jdField_f_of_type_AndroidWidgetTextView.setText(2131690946);
      if (this.jdField_e_of_type_AndroidWidgetTextView != null) {
        this.jdField_e_of_type_AndroidWidgetTextView.setVisibility(8);
      }
      this.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
    }
    this.jdField_b_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity.findViewById(2131363993));
    this.jdField_b_of_type_AndroidWidgetButton.setOnClickListener(this);
    if ((paramBaseEmosmStrategy.b()) || (VipUtils.b((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()))) {
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
    }
  }
  ...
  public void a(List<EmoticonInfo> paramList)
  {
    ...
    FavroamingManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).h();
    if (this.jdField_f_of_type_Int == 0) {
  ...
  void c()
  {
    ...
    ReportController.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800B8BD", "0X800B8BD", localArrayList.size(), 0, "", "", "", "");
    if (localArrayList.isEmpty())
    {
      FMToastUtil.c(2131692499);
      return;
    }
    localObject = new FileSaveDialog(this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity);
  ...
  void d()
  {
    ...
    for (;;)
    {
      ...
      {
        c(i);
        this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity.getString(2131691968));
        return;
        this.jdField_a_of_type_AndroidWidgetTextView.setEnabled(false);
  ...
  void f()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqEmosmBaseEmosmStrategy != null) {
      this.jdField_a_of_type_ComTencentMobileqqEmosmBaseEmosmStrategy.h();
    }
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      localHolder.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localView.findViewById(2131366236));
      localHolder.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131366238));
      localHolder.jdField_a_of_type_AndroidViewView = localView.findViewById(2131366233);
      localHolder.jdField_b_of_type_AndroidViewView = localView.findViewById(2131366234);
      localHolder.c = localView.findViewById(2131366235);
      localHolder.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131366237));
      localView.setTag(localHolder);
      localEmoticonInfo = (EmoticonInfo)this.jdField_b_of_type_JavaUtilList.get(paramInt);
      if (localEmoticonInfo != localHolder.jdField_a_of_type_ComTencentImageURLImageView.getTag(2131381651))
      {
        if (localEmoticonInfo.operateType != 1) {
          break label524;
        }
        localHolder.jdField_a_of_type_ComTencentImageURLImageView.setImageResource(2130839776);
        if (AppSetting.jdField_d_of_type_Boolean) {
          localHolder.jdField_a_of_type_ComTencentImageURLImageView.setContentDescription(this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity.getString(2131691965));
        }
        label216:
        localHolder.jdField_a_of_type_ComTencentImageURLImageView.setTag(2131381651, localEmoticonInfo);
      }
      if ((localEmoticonInfo instanceof ICustomEmotionInfo))
      {
        ...
        localHolder.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130845988);
        label290:
        if (this.jdField_f_of_type_Int != 1) {
          break label582;
        }
        ...
        if (localEmoticonInfo.operateType != 1)
        {
          paramView = this.jdField_a_of_type_ComTencentMobileqqEmosmBaseEmosmStrategy.a(localEmoticonInfo);
          if ((!AppSetting.jdField_d_of_type_Boolean) || (TextUtils.isEmpty(paramView)) || (localHolder.jdField_a_of_type_AndroidWidgetImageView.getVisibility() != 0)) {
            break label648;
          }
          if (localICustomEmotionInfo.isChecked()) {
            break label595;
          ...
          paramView = paramView + "," + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131720361);
        }
      }
    }
    label648:
    for (;;)
    {
      ...
      break;
      label524:
      localHolder.jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable(localEmoticonInfo.getZoomDrawable(this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity.getApplicationContext(), this.jdField_a_of_type_Float, this.jdField_e_of_type_Int, this.jdField_e_of_type_Int));
      break label216;
      label559:
      localHolder.jdField_a_of_type_AndroidViewView.setVisibility(0);
      localHolder.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130845991);
      break label290;
      label582:
      localHolder.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      break label307;
      label595:
      if ((AppSetting.jdField_d_of_type_Boolean) && (!TextUtils.isEmpty(paramView))) {
        paramView = paramView + "," + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131690930);
      }
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (int i = 1;; i = 2)
    {
      EmoAddedAuthCallback.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity, i);
      return false;
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      return;
      ReportController.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800B8BA", "0X800B8BA", 0, 0, "", "", "", "");
      ...
      {
        ReportController.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005C7A", "0X8005C7A", 0, 0, "", "", "", "");
        this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity.finish();
      }
      else
      {
        ...
        if (this.jdField_b_of_type_JavaUtilList != null)
        {
          ...
          notifyDataSetChanged();
          d();
          ReportController.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "ep_mall", "0X80057D6", 0, 0, "", "", "", "");
          continue;
          m();
          continue;
          VasH5PayUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity, "mvip.n.a.bqsc_edit", 3, "1450000516", "CJCLUBT", this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity.getString(2131719674), "");
          j();
          continue;
          k();
          continue;
          l();
          d();
          QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity.getApplicationContext(), this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity.getString(2131691973), 0).a();
        }
      }
    }
  }
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    AIOEmotionFragment.a(this.jdField_a_of_type_ComTencentMobileqqAppIphoneTitleBarActivity, (EmoticonInfo)getItem(paramInt), AnimationUtils.a(paramAdapterView.jdField_a_of_type_ComTencentImageURLImageView));
    return;
    paramAdapterView = getItem(paramInt);
