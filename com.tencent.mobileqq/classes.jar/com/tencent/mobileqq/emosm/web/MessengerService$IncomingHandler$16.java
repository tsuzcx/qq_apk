...
{
  public MessengerService$IncomingHandler$16(anuq paramanuq, Bundle paramBundle, QQAppInterface paramQQAppInterface, MessengerService paramMessengerService) {}
  ...
  public void onDone(List<CustomEmotionData> paramList1, List<CustomEmotionData> paramList2)
  {
    ...
    if (paramList2 != null) {
      for (;;)
      {
        ...
        paramList2 = (answ)this.val$qqApp.getManager(149);
