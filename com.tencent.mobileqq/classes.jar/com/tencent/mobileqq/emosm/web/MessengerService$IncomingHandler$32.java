...
public class MessengerService$IncomingHandler$32
  implements Runnable
{
  public MessengerService$IncomingHandler$32(aned paramaned, JSONArray paramJSONArray, QQAppInterface paramQQAppInterface, Bundle paramBundle, MessengerService paramMessengerService) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          localJSONObject2.put("text", ajjy.a(2131640890));
          localJSONObject2.put("timestamp", localMessageRecord.time);
          continue;
        }
        if (TextUtils.isEmpty(localMessageRecord.msg)) {
      ...
      localJSONObject2.put("text", new axkd(localMessageRecord.msg, 3).a());
      localJSONObject2.put("timestamp", localMessageRecord.time);
      continue;
      label406:
      localJSONObject2.put("text", ajjy.a(2131640894));
      localJSONObject2.put("timestamp", localMessageRecord.time);
      continue;
      label435:
