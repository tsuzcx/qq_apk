...
public class MessengerService$IncomingHandler$28
  implements Runnable
{
  public MessengerService$IncomingHandler$28(anul paramanul, QQAppInterface paramQQAppInterface, String paramString, Bundle paramBundle, MessengerService paramMessengerService) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject3 = ((ajmw)localObject2).a(l);
      ...
      {
        ((ajmw)localObject2).f(localArrayList);
