...
public class MessengerService$IncomingHandler$28
  implements Runnable
{
  public MessengerService$IncomingHandler$28(aned paramaned, QQAppInterface paramQQAppInterface, String paramString, Bundle paramBundle, MessengerService paramMessengerService) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject3 = ((aiyu)localObject2).a(l);
      ...
      {
        ((aiyu)localObject2).f(localArrayList);
