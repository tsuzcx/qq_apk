...
public class WebIPCOperator
{
  ...
  private EmojiIPCAlarmer.TimeoutObserver jdField_a_of_type_ComTencentMobileqqEmosmWebEmojiIPCAlarmer$TimeoutObserver = new abvp(this);
  ...
  public abvr a(int paramInt)
  {
    synchronized (this.jdField_a_of_type_JavaUtilVector)
    {
      ...
      while (localIterator.hasNext())
      {
        abvr localabvr = (abvr)localIterator.next();
        if (localabvr.jdField_a_of_type_Int == paramInt)
        {
          if (QLog.isColorLevel()) {
            QLog.i("Q.emoji.web.EmoWebIPCOperator", 2, "remove req queue seq:" + paramInt);
          }
          this.jdField_a_of_type_ComTencentMobileqqEmosmWebEmojiIPCAlarmer.a(localabvr.jdField_a_of_type_JavaLangRunnable);
          this.jdField_a_of_type_JavaUtilVector.remove(localabvr);
          if (QLog.isColorLevel()) {
  ...
  public abvr a(Bundle paramBundle)
  {
    synchronized (this.jdField_a_of_type_JavaUtilVector)
    {
      int i = this.jdField_a_of_type_Int;
      this.jdField_a_of_type_Int = (i + 1);
      paramBundle = new abvr(i, paramBundle);
      e();
      if (QLog.isColorLevel()) {
  ...
  public void a(Bundle paramBundle)
  {
    ...
    do
    {
      ...
      } while ((localObject == null) || ((this.jdField_a_of_type_ComTencentMobileqqEmosmClient != null) && (this.jdField_a_of_type_ComTencentMobileqqEmosmClient.onReqToServer(((abvr)localObject).jdField_a_of_type_AndroidOsBundle))));
