  ...
  implements DataReportInterface
{
  ...
  private int a(LoginInfo paramLoginInfo)
  {
    ...
    switch (CustomDataReportService.7.a[paramLoginInfo.loginType.ordinal()])
    {
    default: 
      return -1;
    case 1: 
  ...
  {
    new Thread(new CustomDataReportService.6(this, paramContext)).start();
  }
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_ComTencentFalcoBaseLibapiDatareportDataReportInterface$DataReportAdapter.getLog().i("DataReportService", "onCreate end qImei=" + str, new Object[0]);
    this.jdField_a_of_type_ComTencentFalcoBaseLibapiDatareportDataReportInterface$DataReportAdapter.onGetBeaconImei(str);
  }
  
  Map<String, String> a(Map<String, String> paramMap)
  {
    if (paramMap != null)
    {
    ...
    for (;;)
    {
      paramMap.put("sdk_version", "1.0");
      paramMap.put("platform", "Android");
      return paramMap;
      label476:
      if ((!this.jdField_a_of_type_ComTencentFalcoBaseLibapiDatareportDataReportInterface$DataReportAdapter.getAppInfo().isLiteSdk()) && (this.jdField_a_of_type_ComTencentFalcoBaseLibapiDatareportDataReportInterface$DataReportAdapter.isRoomAccessorNull()))
      {
  ...
  void a()
  {
    if ((this.jdField_a_of_type_ComTencentFalcoBaseLibapiDatareportDataReportInterface$DataReportAdapter.getHostProxy().getReportInterface() != null) && (this.jdField_a_of_type_ComTencentFalcoBaseLibapiDatareportDataReportInterface$DataReportAdapter.getHostProxy().getReportInterface().isBeaconRealTimeDebug())) {}
    for (boolean bool = true;; bool = false)
    {
      UserAction.setLogAble(bool, false);
      return;
    }
  }
  ...
  public void a(String paramString, Map<String, String> paramMap, boolean paramBoolean)
  {
    ...
    if (paramString.equals("startLive"))
    {
      ...
      this.jdField_a_of_type_ComTencentFalcoBaseLibapiDatareportDataReportInterface$DataReportAdapter.getLog().i("DataReportService", "reportAnchorQualityEvent start act_type =" + paramString, new Object[0]);
    }
    for (;;)
    {
      paramString = a(paramMap);
      b.submit(new CustomDataReportService.3(this, str, paramString, paramBoolean));
      return;
      long l = System.currentTimeMillis() - this.jdField_a_of_type_Long;
      paramMap.put("timelong", String.valueOf(l));
      this.jdField_a_of_type_ComTencentFalcoBaseLibapiDatareportDataReportInterface$DataReportAdapter.getLog().i("DataReportService", "reportAnchorQualityEvent act_type =" + paramString + ";time = " + l, new Object[0]);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_ComTencentFalcoBaseLibapiDatareportDataReportInterface$DataReportAdapter.isUserHostBeacon())
    {
      b();
      return;
    }
  ...
  {
    paramMap = a(paramMap);
    jdField_a_of_type_JavaUtilConcurrentExecutorService.submit(new CustomDataReportService.1(this, paramMap, paramString, paramBoolean1, paramLong1, paramLong2, paramBoolean2, paramBoolean3));
  }
