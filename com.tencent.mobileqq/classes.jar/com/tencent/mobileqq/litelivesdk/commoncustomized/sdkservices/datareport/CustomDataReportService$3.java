...
class CustomDataReportService$3
  implements Runnable
{
  CustomDataReportService$3(CustomDataReportService paramCustomDataReportService, String paramString, Map paramMap, boolean paramBoolean) {}
  ...
  public void run()
  {
    ...
    if (this.this$0.a.isUserHostBeacon())
    {
      if (BuildConfig.jdField_a_of_type_Boolean) {
        Log.d("DataReportService", "anchor quality report--eventName=" + this.jdField_a_of_type_JavaLangString + ";params=" + CustomDataReportService.a(this.jdField_a_of_type_JavaUtilMap));
      }
 ...
 * Qualified Name:     com.tencent.mobileqq.litelivesdk.commoncustomized.sdkservices.datareport.CustomDataReportService.3
