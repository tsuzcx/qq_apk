...
public class HeaderParser
{
  ...
  void a(String paramString)
  {
    ...
    this.b = Changeset.a(paramString.substring(this.jdField_a_of_type_Int, this.jdField_a_of_type_Int + j));
    ...
    int k = Changeset.a(paramString.substring(this.jdField_a_of_type_Int, this.jdField_a_of_type_Int + j));
    this.jdField_a_of_type_Int = (j + this.jdField_a_of_type_Int);
    this.c = (i * k + this.b);
  }
}
