...
{
  static LogcatHookThread.WriteHandler jdField_a_of_type_ComTencentMobileqqLogcathookLogcatHookThread$WriteHandler;
  private static BufferedWriter jdField_a_of_type_JavaIoBufferedWriter = null;
  ...
  {
    if (jdField_a_of_type_ComTencentMobileqqLogcathookLogcatHookThread$WriteHandler == null)
    {
      ...
      paramString1.start();
      jdField_a_of_type_ComTencentMobileqqLogcathookLogcatHookThread$WriteHandler = new LogcatHookThread.WriteHandler(paramString1.getLooper());
      jdField_a_of_type_ComTencentMobileqqLogcathookLogcatHookThread$WriteHandler.sendEmptyMessageDelayed(1, paramLong);
      if (BaseApplicationImpl.sProcessId == 1) {
        jdField_a_of_type_ComTencentMobileqqLogcathookLogcatHookThread$WriteHandler.sendEmptyMessageDelayed(2, paramLong);
      }
    }
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.logcathook.LogcatHookThread
