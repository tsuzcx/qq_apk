  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    if (!TextUtils.isEmpty(GamePubNav.a(this.a))) {
      GamePubAccountHelper.b(GamePubAccountHelper.a()).h("770").e("1").f("160").d("77002").c("208127").a(4, "20").i(GamePubNav.c(this.a)).b(GamePubNav.b(this.a)).a(2, GamePubNav.a(this.a)).a();
    }
    this.a.a(false);
