  ...
  implements Runnable
{
  ...
  public void run()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqQqgamepubViewGameSessionView == null) {
      return;
    }
    ...
    this.jdField_a_of_type_ComTencentMobileqqQqgamepubViewGameSessionView.getLocationInWindow((int[])localObject1);
    localObject1[0] += this.jdField_a_of_type_ComTencentMobileqqQqgamepubViewGameSessionView.getWidth() / 2;
    localObject1[1] += this.jdField_a_of_type_ComTencentMobileqqQqgamepubViewGameSessionView.getHeight() / 2;
    ...
    int i = this.jdField_a_of_type_ComTencentMobileqqQqgamepubViewGameSessionView.getLeft();
    int j = this.jdField_a_of_type_ComTencentMobileqqQqgamepubViewGameSessionView.getTop();
    ...
    QQGameUIHelper.a(this.jdField_a_of_type_ComTencentMobileqqQqgamepubViewGameSessionView, false);
    this.jdField_a_of_type_ComTencentMobileqqQqgamepubViewGameSessionView.startAnimation(localAnimationSet);
  }
}
