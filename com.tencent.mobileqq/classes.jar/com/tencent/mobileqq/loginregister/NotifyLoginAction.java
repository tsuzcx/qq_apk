  ...
  extends BaseLoginAction
{
  ...
  public static int a(byte[] paramArrayOfByte)
  {
    ...
    QLog.d("NotifyLoginAction", 1, "getTipsScenesId scene_id=" + localRspBody.msg_rsp_tips_info.uint32_scene_id.get());
  ...
  public void a(QBaseActivity paramQBaseActivity, AppRuntime paramAppRuntime, LoginErrorInfo paramLoginErrorInfo)
  {
    ...
    {
      Intent localIntent = new Intent(paramQBaseActivity, NotificationActivity.class);
      ...
      for (;;)
      {
        ...
        return;
        localIntent.putExtra("msg", paramLoginErrorInfo.jdField_b_of_type_JavaLangString + " " + paramLoginErrorInfo.c);
      }
    }
    if (paramLoginErrorInfo.jdField_a_of_type_Int == 2008)
    {
      DialogUtil.a(paramQBaseActivity, 230, HardCodeUtil.a(2131706375), HardCodeUtil.a(2131706371), "OK", null, new NotifyLoginAction.1(this), null).show();
      QQToast.a(paramQBaseActivity, 2131693035, 0).a();
      return;
    }
    DialogUtil.a(paramQBaseActivity, 230, HardCodeUtil.a(2131706365), paramLoginErrorInfo.jdField_b_of_type_JavaLangString, new NotifyLoginAction.2(this), null).show();
  }
}
