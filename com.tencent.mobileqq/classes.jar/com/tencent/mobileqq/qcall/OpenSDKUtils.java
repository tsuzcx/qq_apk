...
public class OpenSDKUtils
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, int paramInt1, PstnSessionInfo paramPstnSessionInfo, int paramInt2)
  {
    ...
    default: 
      arrayOfInt[0] = 1;
      localActionSheet.b(2131438062);
    }
    for (;;)
    {
      localActionSheet.c(2131433029);
      localActionSheet.a(new agyk());
      localActionSheet.a(new agyl(localActionSheet, arrayOfInt, paramInt1, paramQQAppInterface, paramContext, paramPstnSessionInfo, paramInt2, paramString));
      localActionSheet.show();
      return;
      localActionSheet.a(paramContext.getResources().getString(2131438363), paramContext.getResources().getDrawable(2130840374), 0);
      continue;
      localActionSheet.a(paramContext.getResources().getString(2131438363), paramContext.getResources().getDrawable(2130840373), 0);
      continue;
      localActionSheet.a(paramContext.getResources().getString(2131438363), paramContext.getResources().getDrawable(2130840372), 0);
      localActionSheet.b(2131438062);
    }
  }
