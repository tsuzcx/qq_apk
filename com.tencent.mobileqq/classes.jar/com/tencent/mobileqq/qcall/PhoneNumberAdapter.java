  ...
  extends BaseAdapter
{
  ...
  {
    paramViewGroup = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131561138, null);
    PhoneNumberAdapter.Holder localHolder = new PhoneNumberAdapter.Holder(null);
    localHolder.a = ((TextView)paramViewGroup.findViewById(2131374659));
    localHolder.b = ((TextView)paramViewGroup.findViewById(2131374658));
