  ...
  implements View.OnClickListener
{
  ...
  private DiscussionObserver jdField_a_of_type_ComTencentMobileqqAppDiscussionObserver = new agzf(this);
  private FriendListHandler jdField_a_of_type_ComTencentMobileqqAppFriendListHandler;
  private FriendListObserver jdField_a_of_type_ComTencentMobileqqAppFriendListObserver = new agyq(this);
  ...
  private LightalkShieldObserver jdField_a_of_type_ComTencentMobileqqQcallLightalkShieldObserver = new agzg(this);
  ...
  VipFunCallObserver jdField_a_of_type_ComTencentMobileqqVipavVipFunCallObserver = new agyu(this);
  private QQToastNotifier jdField_a_of_type_ComTencentMobileqqWidgetQQToastNotifier;
  private XListView jdField_a_of_type_ComTencentWidgetXListView;
  Runnable jdField_a_of_type_JavaLangRunnable = new agzi(this);
  ...
  private void c()
  {
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)LayoutInflater.from(this).inflate(2130970279, null));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131363068));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131362759));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131363208));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131369895));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131369896));
    this.jdField_c_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131369897));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131369898));
    this.jdField_f_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131369899));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131369907));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131369893));
    this.jdField_c_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131369901));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)findViewById(2131369890));
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
    this.jdField_d_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131369909));
    this.jdField_d_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131369903));
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131369906);
    int j = getResources().getColor(2131494156);
    this.jdField_a_of_type_AndroidViewView.setBackgroundColor(j);
    Object localObject1 = this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131369900);
    ...
    Object localObject3 = (TextView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131363481);
    Object localObject2 = (ImageView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131365691);
    switch (this.jdField_a_of_type_Int)
    {
    default: 
      ...
      localObject1 = (TextView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131369908);
      ((TextView)localObject1).setContentDescription(getString(2131436977));
      ((TextView)localObject1).setOnClickListener(this);
      ThreadManager.post(new agzj(this), 8, null, true);
      ...
      this.jdField_d_of_type_AndroidWidgetTextView.setOnClickListener(this);
      this.jdField_d_of_type_AndroidWidgetTextView.setOnTouchListener(new agzl(this));
      if (this.jdField_e_of_type_Int != -1)
      {
        ...
        if (this.jdField_a_of_type_Int == 26)
        {
          ...
          {
            this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131369904).setVisibility(0);
            localObject2 = (NoScrollListView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131369905);
            ...
            ((NoScrollListView)localObject2).setOnItemClickListener(new agzm(this));
          }
          return;
        }
      }
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        findViewById(2131369889).setVisibility(8);
      ...
      findViewById(2131369889).setVisibility(0);
      ...
      {
        ((ImageView)localObject2).setVisibility(8);
        this.jdField_d_of_type_AndroidWidgetTextView.setText(2131436570);
        ((View)localObject1).setVisibility(8);
        this.jdField_c_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
        findViewById(2131369889).setVisibility(8);
        break;
    ...
    do
    {
      ...
      do
      {
        ...
        if ((this.jdField_c_of_type_Int == 2) || (this.jdField_c_of_type_Int == 3) || (this.jdField_a_of_type_Int == 25))
        {
          ...
          this.jdField_b_of_type_AndroidWidgetImageView.setBackgroundResource(2130842470);
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqDataFriends.getNetWorkType() == 2) || (this.jdField_a_of_type_ComTencentMobileqqDataFriends.getNetWorkType() == 3) || (this.jdField_a_of_type_ComTencentMobileqqDataFriends.getNetWorkType() == 4) || (this.jdField_a_of_type_ComTencentMobileqqDataFriends.getNetWorkType() == 1) || (this.jdField_a_of_type_ComTencentMobileqqDataFriends.netTypeIconId == 7) || (this.jdField_a_of_type_ComTencentMobileqqDataFriends.netTypeIconId == 8))
      {
        ...
        {
          this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
          this.jdField_d_of_type_AndroidWidgetTextView.setText(2131436979);
          this.jdField_d_of_type_AndroidWidgetTextView.setContentDescription(getString(2131436979));
          return;
        }
        if (this.jdField_a_of_type_ComTencentMobileqqDataFriends.getNetWorkType() == 3)
        {
          this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
          this.jdField_d_of_type_AndroidWidgetTextView.setText(2131436980);
          this.jdField_d_of_type_AndroidWidgetTextView.setContentDescription(getString(2131436980));
          return;
        }
        if (this.jdField_a_of_type_ComTencentMobileqqDataFriends.getNetWorkType() == 4)
        {
          this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
          this.jdField_d_of_type_AndroidWidgetTextView.setText(2131436981);
          this.jdField_d_of_type_AndroidWidgetTextView.setContentDescription(getString(2131436981));
          return;
        }
        if (this.jdField_a_of_type_ComTencentMobileqqDataFriends.netTypeIconId == 7)
        {
          this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
          this.jdField_d_of_type_AndroidWidgetTextView.setText(getString(2131436983));
          this.jdField_d_of_type_AndroidWidgetTextView.setContentDescription(getString(2131436983));
          return;
        }
        if (this.jdField_a_of_type_ComTencentMobileqqDataFriends.netTypeIconId == 8)
        {
          this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
          this.jdField_d_of_type_AndroidWidgetTextView.setText(getString(2131436984));
          this.jdField_d_of_type_AndroidWidgetTextView.setContentDescription(getString(2131436984));
          return;
        }
        if (this.jdField_a_of_type_ComTencentMobileqqDataFriends.netTypeIconId == 9)
        {
          this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
          this.jdField_d_of_type_AndroidWidgetTextView.setText(getString(2131436985));
          this.jdField_d_of_type_AndroidWidgetTextView.setContentDescription(getString(2131436985));
          return;
        }
        this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
        this.jdField_b_of_type_AndroidWidgetImageView.setBackgroundResource(2130842457);
        this.jdField_d_of_type_AndroidWidgetTextView.setText(2131436982);
        this.jdField_d_of_type_AndroidWidgetTextView.setContentDescription(getString(2131436982));
        return;
      }
      this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
      return;
  ...
  private void g()
  {
    ...
    {
      this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)LayoutInflater.from(this).inflate(2130970278, null));
      this.jdField_b_of_type_AndroidWidgetLinearLayout.setContentDescription(getString(2131429233));
      this.jdField_b_of_type_AndroidWidgetLinearLayout.setOnClickListener(this);
    }
    LinearLayout localLinearLayout1 = (LinearLayout)findViewById(2131369887);
    Button localButton1 = (Button)localLinearLayout1.findViewById(2131365278);
    localLinearLayout1.setOnClickListener(this);
    localButton1.setTag(Integer.valueOf(2131369887));
    localButton1.setOnClickListener(this);
    LinearLayout localLinearLayout2 = (LinearLayout)findViewById(2131369886);
    Button localButton2 = (Button)localLinearLayout2.findViewById(2131365278);
    localLinearLayout2.setOnClickListener(this);
    localButton2.setTag(Integer.valueOf(2131369886));
    localButton2.setOnClickListener(this);
    LinearLayout localLinearLayout3 = (LinearLayout)findViewById(2131369885);
    Button localButton3 = (Button)localLinearLayout3.findViewById(2131365278);
    localLinearLayout3.setOnClickListener(this);
    localButton3.setTag(Integer.valueOf(2131369885));
    localButton3.setOnClickListener(this);
    localButton1.setText(2131433661);
    if (this.jdField_a_of_type_Int == 3000)
    {
      localButton1.setContentDescription("发消息");
      localButton3.setText(2131435814);
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Int == 1008)
      {
        ...
        localButton3.setContentDescription(getString(2131436996));
        this.jdField_c_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
        return;
      }
      if ((this.jdField_c_of_type_Int == 2) || (this.jdField_c_of_type_Int == 3) || (this.jdField_a_of_type_Int == 25))
      {
        localLinearLayout2.setVisibility(8);
        localLinearLayout1.setVisibility(8);
        localButton3.setText(2131435813);
        localButton3.setContentDescription(getString(2131436996));
        return;
      }
      localButton1.setContentDescription("发消息");
      ...
      if (!CrmUtils.a(this.app, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int))
      {
        ...
        localButton2.setText(2131436994);
    ...
    localLinearLayout2.setVisibility(8);
    localButton3.setContentDescription(getString(2131436995));
  }
  
  private void h()
  {
    this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)findViewById(2131369888));
    ...
    this.jdField_a_of_type_Agzo = new agzo(this);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Agzo);
  }
  ...
  public void a(Context paramContext, String paramString)
  {
    ...
    for (;;)
    {
      ...
      localActionSheet.a(new agzn(this));
      localActionSheet.a(new agyt(this, paramContext, paramString, localActionSheet));
  ...
  public void a(boolean paramBoolean)
  {
    ...
    try
    {
      ...
      if (j == 0)
      {
        localObject1 = getResources().getString(2131436216);
        localObject2 = localObject1;
        if (TextUtils.isEmpty((CharSequence)localObject1)) {
          localObject2 = getResources().getString(2131436216);
        }
    ...
    for (;;)
    {
      ...
      case 2131363493: 
        ...
        for (;;)
        {
          ...
          k = 2131435313;
          paramView.b(k);
          paramView.b(2131435132);
          paramView.c(2131433029);
          paramView.a(new agyw(this));
          if (QLog.isColorLevel()) {
          ...
          paramView.a(new agyx(this, bool2, bool3, bool5, j, paramView));
          paramView.show();
          return;
      ...
      case 2131369896: 
        for (bool3 = ((FriendsManager)localObject).d(this.jdField_a_of_type_JavaLangString);; bool3 = false)
        {
          ...
          if ((localObject != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)))
          {
            ...
            for (;;)
            {
              this.jdField_a_of_type_Agzo.a.clear();
              this.jdField_a_of_type_Agzo.notifyDataSetChanged();
              return;
            ...
            if (this.jdField_a_of_type_Int == 3000)
            {
              if (this.jdField_b_of_type_ComTencentMobileqqQcallPstnManager.a() == 1)
              {
                ...
                if (this.jdField_a_of_type_ComTencentMobileqqQcallPstnCardInfo.pstn_multi_call_time > 0)
                {
                  ...
                  paramView.a(getResources().getString(2131438363), getResources().getDrawable(2130840374), 0);
                  ReportController.b(this.app, "CliOper", "", "", "0X80063FE", "0X80063FE", 1, 0, "", "", "", "");
                }
                for (;;)
                {
                  paramView.c(2131433029);
                  paramView.a(new agzb(this));
                  paramView.a(new agzc(this, paramView));
                  paramView.show();
                  return;
                  if ((this.jdField_b_of_type_ComTencentMobileqqQcallPstnManager.c() == 1) && (this.jdField_a_of_type_ComTencentMobileqqQcallPstnCardInfo.pstn_multi_try_status == 0))
                  {
                    ...
                    paramView.a(getResources().getString(2131438363), getResources().getDrawable(2130840373), 0);
                    ReportController.b(this.app, "CliOper", "", "", "0X80063FE", "0X80063FE", 3, 0, "", "", "", "");
                  }
                  else
                  {
                    this.jdField_f_of_type_Int = 5;
                    paramView.a(getResources().getString(2131438363), getResources().getDrawable(2130840372), 0);
            ...
            {
              paramView.c(2131433029);
              paramView.a(new agzd(this));
              paramView.a(new agze(this, paramView));
              paramView.show();
              return;
              j = 0;
              break;
  ...
  protected void onDestroy()
  {
    ...
    {
      this.jdField_a_of_type_Agzo.a = null;
      this.jdField_a_of_type_Agzo = null;
    }
