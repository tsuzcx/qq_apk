  ...
  implements Manager
{
  ...
  private void a()
  {
    ...
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_multi_no_try_chance_tips", localResources.getString(2131438388));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_multi_has_try_chance_tips", localResources.getString(2131438389));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_tried_c2c_recharge_title", localResources.getString(2131438390));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_tried_c2c_recharge_content", localResources.getString(2131438391));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_tried_c2c_recharge_confirm_text", localResources.getString(2131438392));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_tried_multi_recharge_title", localResources.getString(2131438393));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_tried_multi_recharge_content", localResources.getString(2131438394));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_tried_multi_recharge_confirm_text", localResources.getString(2131438395));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_untried_c2c_recharge_title", localResources.getString(2131438396));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_untried_c2c_recharge_content", localResources.getString(2131438397));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_untried_c2c_recharge_confirm_text", localResources.getString(2131438398));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_untried_multi_recharge_title", localResources.getString(2131438399));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_untried_multi_recharge_content", localResources.getString(2131438400));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_untried_multi_recharge_confirm_text", localResources.getString(2131438401));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_c2c_try_over_recharge_title", localResources.getString(2131438402));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_c2c_try_over_recharge_content", localResources.getString(2131438403));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_c2c_try_over_recharge_confirm_text", localResources.getString(2131438404));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_multi_try_over_recharge_title", localResources.getString(2131438405));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_multi_try_over_recharge_content", localResources.getString(2131438406));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_multi_try_over_recharge_confirm_text", localResources.getString(2131438407));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("pstn_c2c_trans_wording", localResources.getString(2131438408));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("pstn_c2c_trans_check_wording", localResources.getString(2131438409));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("pstn_c2c_trans_setting_wording", localResources.getString(2131438410));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("pstn_multi_trans_wording", localResources.getString(2131438411));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("pstn_multi_trans_check_wording", localResources.getString(2131438412));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("pstn_multi_trans_setting_wording", localResources.getString(2131438413));
  }
