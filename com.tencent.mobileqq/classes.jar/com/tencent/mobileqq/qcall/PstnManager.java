  ...
  implements Manager
{
  ...
  private void a()
  {
    ...
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_multi_no_try_chance_tips", localResources.getString(2131438408));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_multi_has_try_chance_tips", localResources.getString(2131438409));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_tried_c2c_recharge_title", localResources.getString(2131438410));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_tried_c2c_recharge_content", localResources.getString(2131438411));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_tried_c2c_recharge_confirm_text", localResources.getString(2131438412));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_tried_multi_recharge_title", localResources.getString(2131438413));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_tried_multi_recharge_content", localResources.getString(2131438414));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_tried_multi_recharge_confirm_text", localResources.getString(2131438415));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_untried_c2c_recharge_title", localResources.getString(2131438416));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_untried_c2c_recharge_content", localResources.getString(2131438417));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_untried_c2c_recharge_confirm_text", localResources.getString(2131438418));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_untried_multi_recharge_title", localResources.getString(2131438419));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_untried_multi_recharge_content", localResources.getString(2131438420));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_untried_multi_recharge_confirm_text", localResources.getString(2131438421));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_c2c_try_over_recharge_title", localResources.getString(2131438422));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_c2c_try_over_recharge_content", localResources.getString(2131438423));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_c2c_try_over_recharge_confirm_text", localResources.getString(2131438424));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_multi_try_over_recharge_title", localResources.getString(2131438425));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_multi_try_over_recharge_content", localResources.getString(2131438426));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("key_pstn_multi_try_over_recharge_confirm_text", localResources.getString(2131438427));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("pstn_c2c_trans_wording", localResources.getString(2131438428));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("pstn_c2c_trans_check_wording", localResources.getString(2131438429));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("pstn_c2c_trans_setting_wording", localResources.getString(2131438430));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("pstn_multi_trans_wording", localResources.getString(2131438431));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("pstn_multi_trans_check_wording", localResources.getString(2131438432));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put("pstn_multi_trans_setting_wording", localResources.getString(2131438433));
  }
