  ...
  public void b(QCallRecord paramQCallRecord)
  {
    ...
    for (;;)
    {
      synchronized (a(paramQCallRecord.friendUin, paramQCallRecord.uinType))
      {
        ...
        {
          localObject1 = (QCallRecord)localIterator.next();
          ...
          localObject1 = new StringBuilder().append("updateRecord ThreadName:").append(Thread.currentThread().getName()).append(" updateRecord records size:");
          if (localList != null)
          {
            i = localList.size();
            QLog.d("QCallProxy", 2, i);
