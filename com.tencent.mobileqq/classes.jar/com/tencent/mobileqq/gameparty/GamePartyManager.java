  ...
  implements ArkAppCenterCheckEvent.Callback, Manager
{
  ...
  public GamePartyManager(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new adeo(this, Looper.getMainLooper());
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        a("http://openmobile.qq.com/gameteam/get_team_context?uin=" + paramQQAppInterface.getCurrentAccountUin(), new adep(this));
    ...
    do
    {
      ...
      while (paramGameTeam_TurnOverMessage.hasNext())
      {
        ...
        if ((((SubMsgType0xaa.InviteSource)localObject).type.has()) && (((SubMsgType0xaa.InviteSource)localObject).src.has()))
        {
          ...
          {
            localObject = new GamePartyManager.Session(this, b(m), (String)localObject);
    ...
    for (;;)
    {
      ...
      while (paramGameTeam_TurnOverMessage.hasNext())
      {
        ...
        if ((((SubMsgType0xaa.InviteSource)localObject).type.has()) && (((SubMsgType0xaa.InviteSource)localObject).src.has()))
        {
          ...
          {
            localObject = new GamePartyManager.Session(this, b(i), (String)localObject);
            this.jdField_a_of_type_JavaUtilVector.add(localObject);
          }
        }
      }
  ...
  private void b(SubMsgType0xaa.GameTeam_TurnOverMessage paramGameTeam_TurnOverMessage)
  {
    ...
    if (bool)
    {
      paramGameTeam_TurnOverMessage = localQQAppInterface.getApp().getString(2131438416);
      switch (j)
      {
      case 5: 
      default: 
        return;
      case 1: 
        localObject1 = localQQAppInterface.getApp().getString(2131438412);
      }
    }
    for (;;)
    {
      String str3 = localQQAppInterface.getApp().getString(2131438417);
      ...
      str1 = String.format("http://openmobile.qq.com/TeamGame/index.html?_wv=1031&uin=%s&team_id=%s&srcSessionType=%d&srcSessionUin=%s", new Object[] { localQQAppInterface.getAccount(), str2, Integer.valueOf(i), localObject2 });
      ...
      case 3000: 
        ...
        break;
        localObject1 = localQQAppInterface.getApp().getString(2131438413);
        continue;
        localObject1 = localQQAppInterface.getApp().getString(2131438414);
        continue;
        localObject1 = localQQAppInterface.getApp().getString(2131438415);
      }
    }
  }
  ...
  {
    ThreadManager.post(new ades(this, paramString, paramAsyncRequestCallback), 5, null, false);
  }
  ...
  protected void a(SubMsgType0xaa.GameTeam_StartGameMessage paramGameTeam_StartGameMessage, boolean paramBoolean)
  {
    ...
    for (l1 -= l2;; l1 = l2 - l1)
    {
      ...
      a("http://openmobile.qq.com/gameteam/get_team_info?uin=" + localQQAppInterface.getCurrentAccountUin() + "&team_list=" + (String)localObject, new adeq(this, l1, paramGameTeam_StartGameMessage, l2, paramBoolean));
      return;
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  protected void a(SubMsgType0xaa.GameTeam_UpdateTeamMessage paramGameTeam_UpdateTeamMessage)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ArkAppCenter.a().post(new ader(this, (String)localObject));
