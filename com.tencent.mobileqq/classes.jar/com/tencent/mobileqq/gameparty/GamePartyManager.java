  ...
  implements ArkAppCenterCheckEvent.Callback, Manager
{
  ...
  public GamePartyManager(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        a("https://openmobile.qq.com/gameteam/get_team_context?uin=" + paramQQAppInterface.getCurrentAccountUin(), new GamePartyManager.2(this));
  ...
  private void b(SubMsgType0xaa.GameTeam_TurnOverMessage paramGameTeam_TurnOverMessage)
  {
    ...
    if (bool)
    {
      paramGameTeam_TurnOverMessage = localQQAppInterface.getApp().getString(2131692848);
      switch (j)
      {
      case 5: 
      default: 
        return;
      case 1: 
        localObject1 = localQQAppInterface.getApp().getString(2131692861);
      }
    }
    for (;;)
    {
      String str3 = localQQAppInterface.getApp().getString(2131692863);
      ...
      case 3000: 
        ...
        break;
        localObject1 = localQQAppInterface.getApp().getString(2131692864);
        continue;
        localObject1 = localQQAppInterface.getApp().getString(2131692854);
        continue;
        localObject1 = localQQAppInterface.getApp().getString(2131692862);
      }
    }
  }
  ...
  protected void a(SubMsgType0xaa.GameTeam_StartGameMessage paramGameTeam_StartGameMessage, boolean paramBoolean)
  {
    ...
    for (l1 -= l2;; l1 = l2 - l1)
    {
      ...
      a("https://openmobile.qq.com/gameteam/get_team_info?uin=" + localQQAppInterface.getCurrentAccountUin() + "&team_list=" + (String)localObject, new GamePartyManager.3(this, l1, paramGameTeam_StartGameMessage, l2, paramBoolean));
      return;
      if (!QLog.isColorLevel()) {
        break;
      }
