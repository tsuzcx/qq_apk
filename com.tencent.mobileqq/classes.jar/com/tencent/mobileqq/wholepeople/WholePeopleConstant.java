...
public class WholePeopleConstant
{
  ...
  {
    int i = 1;
    if (!WholePeopleLebaEntryChecker.a(paramQQAppInterface)) {
  ...
  public static EIPCResult a(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    ((LocalRedTouchManager)paramString.getManager(159)).a(10014);
    paramBundle.code = 0;
    return paramBundle;
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, RedTouch paramRedTouch)
  {
    ...
    if (paramQQAppInterface != null)
    {
      ...
      paramQQAppInterface = ((LocalRedTouchManager)localObject1).a(10013);
      localObject2 = ((LocalRedTouchManager)localObject1).a(10014);
  ...
  public static EIPCResult b(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    paramString = (LocalRedTouchManager)paramString.getManager(159);
