...
public class OlympicUtil
{
  ...
  public static Bitmap a(String paramString)
  {
    ...
    paramString = (Bitmap)GlobalImageCache.a.get(localObject);
    if (QLog.isColorLevel())
    {
  ...
  public static Pair<Integer, Bitmap> a(String paramString1, String paramString2, OlympicDPC paramOlympicDPC, int paramInt)
  {
    localObject1 = null;
    k = 0;
    ...
    for (;;)
    {
      ...
      paramInt = 1;
      if ((paramOlympicDPC == null) && (j == 0) && (i == 0)) {}
      try
      {
  ...
  {
    AppIntefaceReportWrap.a(paramAppInterface, "CliOper", "", paramString2, paramString1, paramString1, 0, 0, "" + paramInt, "", "", "");
  }
