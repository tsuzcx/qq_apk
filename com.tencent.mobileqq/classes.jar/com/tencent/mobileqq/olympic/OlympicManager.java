  ...
  implements SoundPool.OnLoadCompleteListener, Handler.Callback, Manager, BusinessObserver
{
  ...
  private static Comparator<ShuayishuaConfig> jdField_a_of_type_JavaUtilComparator = new atgw();
  ...
  public atgv a;
  private atgz jdField_a_of_type_Atgz = new atgy(this);
  private atha jdField_a_of_type_Atha;
  private athc jdField_a_of_type_Athc = new atgx(this);
  ...
  public OlympicManager(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Atha = new atha(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    this.jdField_a_of_type_Atmp = paramQQAppInterface.getEntityManagerFactory().createEntityManager();
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Atgz);
    this.jdField_a_of_type_Atha.a(this.jdField_a_of_type_Athc);
  ...
  protected static OlyimpicConfig a(String paramString, int paramInt, ArrayList<Integer> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      {
        ((ShuayishuaConfig)localObject2).realBegin = atiu.a(((XmlPullParser)localObject1).nextText());
      }
      else if (str.equalsIgnoreCase("End"))
      {
        ((ShuayishuaConfig)localObject2).realEnd = atiu.a(((XmlPullParser)localObject1).nextText());
      }
    ...
    for (int i = paramArrayList.size();; i = 0)
    {
      ...
      if ((i != 0) && (k > 0))
      {
        ...
        if (((ShuayishuaConfig)localObject1).type == 2)
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.i("OlympicManager", 2, "parseConfig last.realBegin=" + ((ShuayishuaConfig)localObject1).realBegin + "(" + atiu.a(((ShuayishuaConfig)localObject1).realBegin) + "),countHitConfig =" + 0 + ",diff = " + paramInt);
          }
      ...
      for (;;)
      {
        if (j < k)
        {
          ...
          if (((ShuayishuaConfig)localObject2).type == 2)
          {
            ...
            if (QLog.isColorLevel()) {
              QLog.i("OlympicManager", 2, "parseConfig cur.realBegin=" + ((ShuayishuaConfig)localObject2).realBegin + "(" + atiu.a(((ShuayishuaConfig)localObject2).realBegin) + "),countHitConfig =" + paramInt + ",diff = " + m);
            }
  ...
  private void a(long paramLong)
  {
    ...
    atgv localatgv = this.jdField_a_of_type_Atgv;
    if (localatgv == null) {
      return;
    }
    long l = paramLong;
    ...
    {
      QLog.d("OlympicManager", 2, (String)localObject + ",currentTime = " + l + "(" + atiu.a(l) + "),closeEntrance = " + bool2 + ",mHasChechBreathOnRecovery = " + this.jdField_d_of_type_Boolean + ",olympicSettingFlag = " + bool3 + ",mTorchbearerFlag = " + this.jdField_a_of_type_Int);
      if (this.jdField_a_of_type_ComTencentMobileqqOlympicOlympicActConfig != null) {}
      localatgv.a();
      return;
  ...
  {
    atiu.b("OlympicManager", new Object[] { "tryDownloadActResource ，forceDownload = " + paramBoolean });
    ...
    boolean bool;
    if (this.jdField_a_of_type_Atgt == null)
    {
      localObject1 = "dpc is null";
      QLog.i("OlympicManager", 1, "tryDownloadActResource dpc =" + (String)localObject1);
      if ((this.jdField_a_of_type_Atgt != null) && (!this.jdField_a_of_type_Atgt.jdField_a_of_type_Boolean)) {
        break label222;
      }
      bool = true;
      label105:
    ...
    label222:
    label228:
    for (int i = 0;; i = this.jdField_a_of_type_Atgt.jdField_a_of_type_Int)
    {
      ((HashMap)localObject1).put("dpc", String.valueOf(i));
      awrn.a(BaseApplicationImpl.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "olympic_down_dpc", bool, 0L, 0L, (HashMap)localObject1, "", false);
      if (paramBoolean) {
        break label262;
      }
      if (d()) {
      ...
      atiu.b("OlympicManager", new Object[] { "tryDownloadActResource, can't auto pre download, return" });
      return;
      if (this.jdField_a_of_type_Atgt.jdField_a_of_type_JavaLangString == null)
      {
        localObject1 = "dpc.string is null";
        break;
      }
      localObject1 = this.jdField_a_of_type_Atgt.jdField_a_of_type_JavaLangString;
      break;
      bool = false;
      break label105;
    }
    ...
    if (!c())
    {
      atiu.b("OlympicManager", new Object[] { "tryDownloadActResource, isNetworkCanPredown is false, return" });
      return;
    }
    label262:
    long l = NetConnInfoCenter.getServerTimeMillis();
    Object localObject1 = paramOlympicActConfig.getConfigString("HomePage", "End");
    if ((TextUtils.isEmpty((CharSequence)localObject1)) || (atiu.a((String)localObject1) < l))
    {
      atiu.b("OlympicManager", new Object[] { "tryDownloadActResource, time expired!" });
      return;
    }
    ...
    {
      atiu.b("OlympicManager", new Object[] { "tryDownloadActResource, cityPic & starPic, isSelfTorchbearer() && mTorchbearerInfo != null" });
      localObject1 = localObject2;
      if (this.jdField_a_of_type_ComTencentMobileqqOlympicTorchInfo.city_list.size() > 0)
      {
        ...
        {
          this.jdField_a_of_type_Atha.a(((TorchInfo.CityInfo)localObject3).city_pic_url, ((TorchInfo.CityInfo)localObject3).city_pic_md5, new String[] { "ActConfig", "CityImage", ((TorchInfo.CityInfo)localObject3).city_id + "_" + ((TorchInfo.CityInfo)localObject3).city_pic_id }, false, 2, true);
          localArrayList1.add(((TorchInfo.CityInfo)localObject3).city_pic_md5);
          this.jdField_a_of_type_Atha.a(((TorchInfo.CityInfo)localObject3).cons_pic_url, ((TorchInfo.CityInfo)localObject3).cons_pic_md5, new String[] { "ActConfig", "StarImage", ((TorchInfo.CityInfo)localObject3).city_id + "_" + ((TorchInfo.CityInfo)localObject3).city_pic_id }, false, 2, true);
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqOlympicTorchInfo.city_list.size() > 1)
      {
        ...
        if (localObject3 != null)
        {
          this.jdField_a_of_type_Atha.a(((TorchInfo.CityInfo)localObject3).city_pic_url, ((TorchInfo.CityInfo)localObject3).city_pic_md5, new String[] { "ActConfig", "City2Image", ((TorchInfo.CityInfo)localObject3).city_id + "_" + ((TorchInfo.CityInfo)localObject3).city_pic_id }, false, 2, true);
          localArrayList1.add(((TorchInfo.CityInfo)localObject3).city_pic_md5);
          this.jdField_a_of_type_Atha.a(((TorchInfo.CityInfo)localObject3).cons_pic_url, ((TorchInfo.CityInfo)localObject3).cons_pic_md5, new String[] { "ActConfig", "Star2Image", ((TorchInfo.CityInfo)localObject3).city_id + "_" + ((TorchInfo.CityInfo)localObject3).city_pic_id }, false, 2, true);
          localArrayList1.add(((TorchInfo.CityInfo)localObject3).cons_pic_md5);
          localObject2 = localObject1;
        }
      }
    ...
    do
    {
      ...
      paramBoolean = true;
      atiu.b("OlympicManager", new Object[] { "tryDownloadActResource, homePageBg==null?", Boolean.valueOf(paramBoolean) });
      if (localObject1 == null) {
        break label1943;
      }
      this.jdField_a_of_type_Atha.a(((OlympicActConfig.HomePageBg)localObject1).url, ((OlympicActConfig.HomePageBg)localObject1).md5, new String[] { "ActConfig", "homePageBg", "01" }, false, 2, true);
      ...
      paramBoolean = true;
      atiu.b("OlympicManager", new Object[] { "tryDownloadActResource, homePageBg2==null?", Boolean.valueOf(paramBoolean) });
      if (localObject1 != null)
      {
        this.jdField_a_of_type_Atha.a(((OlympicActConfig.HomePageBg)localObject1).url, ((OlympicActConfig.HomePageBg)localObject1).md5, new String[] { "ActConfig", "homePageBg", "02" }, false, 2, true);
        localArrayList1.add(((OlympicActConfig.HomePageBg)localObject1).md5);
      }
      localObject1 = "";
      atiu.b("OlympicManager", new Object[] { "tryDownloadActResource, actConfig.mTorchImageMap.size() = ", Integer.valueOf(paramOlympicActConfig.getTorchImageMap().size()) });
      ...
      while (((Iterator)localObject4).hasNext())
      {
        ...
        this.jdField_a_of_type_Atha.a(localTorchImage.url, localTorchImage.md5, new String[] { "ActConfig", "TorchImage", str }, false, 2, true);
      ...
      atiu.b("OlympicManager", new Object[] { "tryDownloadActResource, actConfig.getChosenCityImageList.size() = ", Integer.valueOf(paramOlympicActConfig.getChosenCityImageList().size()) });
    ...
    {
      this.jdField_a_of_type_Atha.a(((OlympicActConfig.CityImage)localObject2).url, ((OlympicActConfig.CityImage)localObject2).md5, new String[] { "ActConfig", "CityImage", ((OlympicActConfig.CityImage)localObject2).companyId + "_" + ((OlympicActConfig.CityImage)localObject2).picId }, false, 2, true);
      localArrayList1.add(((OlympicActConfig.CityImage)localObject2).md5);
      this.jdField_a_of_type_Atha.a(((OlympicActConfig.CityImage)localObject2).starUrl, ((OlympicActConfig.CityImage)localObject2).starMd5, new String[] { "ActConfig", "StarImage", ((OlympicActConfig.CityImage)localObject2).companyId + "_" + ((OlympicActConfig.CityImage)localObject2).picId }, false, 2, true);
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_Atha.a((String)localObject4, str, new String[] { "ActConfig", "TorchAnim" }, false, 2, true);
        ...
        this.jdField_a_of_type_Atha.a((String)localObject4, str, new String[] { "ActConfig", "MsgTabBG" }, false, 2, true);
        ...
        this.jdField_a_of_type_Atha.a((String)localObject4, str, new String[] { "ActConfig", "TorchImageNoBg" }, false, 2, true);
        localArrayList1.add(str);
        label1700:
        ...
        this.jdField_a_of_type_Atha.a((String)localObject4, paramOlympicActConfig, null, false, 2, true);
        localArrayList1.add(paramOlympicActConfig);
      }
      for (;;)
      {
        if (atiu.a(BaseApplicationImpl.getContext(), "olympic_predown_act")) {
        ...
        return;
        atiu.b("OlympicManager", new Object[] { "tryDownloadActResource, TorchAnim,  torchAnimUrl or torchAnimMd5 is empty" });
        break label1538;
        label1892:
        atiu.b("OlympicManager", new Object[] { "tryDownloadActResource, MsgTabBG,  msgTabImgUrl or msgTabImgMD5 is empty" });
        break label1619;
        label1910:
        QLog.i("OlympicManager", 1, "tryDownloadActResource, TorchImageNoBg,  torchImageNoBgUrl or torchImageNoBgMD5 is empty");
        break label1700;
        label1922:
        atiu.b("OlympicManager", new Object[] { "tryDownloadActResource, takeAwardImg,  takeAwardImgUrl or takeAwardImgUrl is empty" });
      }
      label1940:
      break label1184;
      label1943:
    ...
    do
    {
      ...
      for (;;)
      {
        try
        {
          ...
          {
            bool1 = atha.a((String)paramList1.next()) & bool1;
            if (!bool1) {
              bool2 = bool1;
            }
          }
          else
          {
            ...
            awrn.a(BaseApplicationImpl.getContext()).a("", paramString, true, 0L, 0L, paramList2, "", false);
            atiu.a(BaseApplicationImpl.getContext(), paramString);
            return;
          }
        }
  ...
  private void b(long paramLong)
  {
    ...
    while (QLog.isColorLevel())
    {
      ...
      for (;;)
      {
        if (j < ((ArrayList)localObject2).size())
        {
          ...
          ((StringBuilder)localObject1).append(localShuayishuaConfig.realBegin + "(" + atiu.a(localShuayishuaConfig.realBegin) + ")").append("-").append(localShuayishuaConfig.uiEnd + "(" + atiu.a(localShuayishuaConfig.uiEnd) + ")").append(";");
          j += 1;
          continue;
          i = -k - 1;
          break;
    ...
    if ((i > 0) && (i <= ((ArrayList)localObject2).size()))
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("OlympicManager", 2, "handleCheckTime ,cConfig.uiEnd = " + ((ShuayishuaConfig)localObject1).uiEnd + "(" + atiu.a(((ShuayishuaConfig)localObject1).uiEnd) + "),current = " + paramLong + "(" + atiu.a(paramLong) + ")");
        }
        localObject1 = null;
      }
    }
  ...
  private void b(OlyimpicConfig paramOlyimpicConfig)
  {
    ...
    do
    {
      ...
      if (!d())
      {
        atiu.b("OlympicManager", new Object[] { "tryDownload, can't auto pre download, return" });
        return;
      }
      if (!c())
      {
        atiu.b("OlympicManager", new Object[] { "tryDownload, isNetworkCanPredown is false, return" });
        return;
      }
      long l = NetConnInfoCenter.getServerTimeMillis();
      ...
      while (paramOlyimpicConfig.hasNext())
      {
        ...
        if ((localShuayishuaConfig.uiEnd > l) || (localShuayishuaConfig.realEnd > l))
        {
          ...
          {
            this.jdField_a_of_type_Atha.a(localShuayishuaConfig.LUIconImg, localShuayishuaConfig.LUIconImgMd5, new String[] { "shuayishua", String.valueOf(localShuayishuaConfig.id) }, false, 1, true);
          ...
          {
            this.jdField_a_of_type_Atha.a(localShuayishuaConfig.torchLogoImg, localShuayishuaConfig.torchLogoImgMd5, new String[] { "shuayishua", String.valueOf(localShuayishuaConfig.id) }, false, 1, true);
          ...
          {
            this.jdField_a_of_type_Atha.a(localShuayishuaConfig.torchAnimUrl, localShuayishuaConfig.torchAnimMd5, new String[] { "shuayishua_anim", String.valueOf(localShuayishuaConfig.id) }, false, 1, true);
            localArrayList2.add(localShuayishuaConfig.torchAnimMd5);
          }
        }
      }
    } while (!atiu.a(BaseApplicationImpl.getContext(), "olympic_predown_shua"));
  ...
  public OlympicPredownInfo a(String paramString)
  {
    ...
    try
    {
      atiu.b("OlympicManager", new Object[] { "getEntity, url=", str });
      ...
      for (;;)
      {
        ...
        try
        {
          paramString = this.jdField_a_of_type_Atmp.a(OlympicPredownInfo.class, false, "url = ?", new String[] { paramString }, null, null, null, null);
  ...
  public TorchInfo a(torch_transfer.TorchbearerInfo paramTorchbearerInfo)
  {
    ...
    for (;;)
    {
      ...
      for (int i = 1;; i = 0)
      {
        ...
        {
          atiu.b("OlympicManager", new Object[] { paramTorchbearerInfo });
  ...
  public void a(OlympicPredownInfo paramOlympicPredownInfo)
  {
    ...
    //   24: aload_2
    //   25: aastore
    //   26: invokestatic 595	atiu:b	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   29: aload_1
    //   30: ifnonnull +11 -> 41
    //   33: aload_0
    //   34: monitorexit
    ...
    //   38: goto -28 -> 10
    //   41: aload_0
    //   42: getfield 185	com/tencent/mobileqq/olympic/OlympicManager:jdField_a_of_type_Atmp	Latmp;
    //   45: invokevirtual 1256	atmp:a	()Latmr;
    //   48: astore_2
    //   49: aload_2
    //   50: invokevirtual 1259	atmr:a	()V
    //   53: aload_0
    //   54: getfield 185	com/tencent/mobileqq/olympic/OlympicManager:jdField_a_of_type_Atmp	Latmp;
    //   57: aload_1
    //   58: invokevirtual 1262	atmp:b	(Latmo;)V
    //   61: aload_2
    //   62: invokevirtual 1264	atmr:c	()V
    //   65: aload_2
    //   66: invokevirtual 1266	atmr:b	()V
    //   69: goto -36 -> 33
    //   72: astore_1
    //   73: aload_0
    //   74: monitorexit
    ...
    //   88: aload_2
    //   89: invokevirtual 1266	atmr:b	()V
    //   92: goto -59 -> 33
    //   95: astore_1
    //   96: aload_2
    //   97: invokevirtual 1266	atmr:b	()V
    //   100: aload_1
    //   101: athrow
    // Local variable table:
    //   start	length	slot	name	signature
    ...
    for (;;)
    {
      ...
      finally
      {
        try
        {
          ...
          bace.a(new File(BaseApplicationImpl.sApplication.getFilesDir(), "olympic_shuayishua_config_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).getAbsolutePath(), localByteArrayOutputStream.toByteArray(), false);
        }
  ...
  {
    atiu.b("OlympicManager", new Object[] { "onGetActConfig" });
    if (paramOlympicActConfig == null)
    {
      atiu.b("OlympicManager", new Object[] { "onGetActConfig, config is null!" });
      return;
    }
  ...
  public void a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        atiu.b("OlympicManager", new Object[] { "updateEntity, url=", localObject1, ", dailyInc=", Integer.valueOf(paramInt) });
        boolean bool = TextUtils.isEmpty(paramString);
        if (bool)
        {
          return;
      ...
      if (((OlympicPredownInfo)localObject1).dailyStartTime >= 86400000L)
      {
        ...
        label170:
        paramString = this.jdField_a_of_type_Atmp.a();
      }
      try
      {
        paramString.a();
        this.jdField_a_of_type_Atmp.a((atmo)localObject1);
        paramString.c();
        paramString.b();
        continue;
        ((OlympicPredownInfo)localObject1).dailyRetryCount += paramInt;
  ...
  public void b(TorchInfo paramTorchInfo)
  {
    if (paramTorchInfo != null)
    {
      ...
      Object localObject;
      if ((atiu.a(paramTorchInfo.torch_pic_url) == null) && (jdField_a_of_type_Boolean))
      {
        localObject = atha.a() + paramTorchInfo.torch_pic_md5;
        if (jdField_a_of_type_Boolean)
        {
          localObject = atiu.a(paramTorchInfo.torch_pic_url, (String)localObject, this.jdField_a_of_type_Atgt, 0);
      ...
      if ((paramTorchInfo.city_list != null) && (paramTorchInfo.city_list.size() > 0))
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          if (paramTorchInfo.city_id == l) {
            if ((atiu.a(paramTorchInfo.city_pic_url) == null) && (jdField_a_of_type_Boolean))
            {
              localObject = atha.a() + paramTorchInfo.city_pic_md5;
              if (jdField_a_of_type_Boolean)
              {
                paramTorchInfo = atiu.a(paramTorchInfo.city_pic_url, (String)localObject, this.jdField_a_of_type_Atgt, 2);
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_ArrayOfByte)
      {
        if (this.jdField_a_of_type_ComTencentMobileqqOlympicOlympicActConfig != null)
        {
          ...
          atiu.b("OlympicManager", new Object[] { "saveActConfigToLocal, result=", Boolean.valueOf(bool) });
          return bool;
        }
      }
      boolean bool = false;
  ...
  public boolean b(String paramString)
  {
    ...
    do
    {
      ...
      {
        return bool1;
        i = this.jdField_a_of_type_Atgt.jdField_b_of_type_Int;
        break;
        j = this.jdField_a_of_type_Atgt.jdField_c_of_type_Int;
        break label55;
      }
      bool1 = bool2;
  ...
  public void c()
  {
    ...
    //   37: ldc_w 1421
    //   40: aastore
    //   41: invokestatic 595	atiu:b	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   44: aload_0
    ...
    //   127: aastore
    //   128: invokestatic 595	atiu:b	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   131: aload_0
    ...
    //   171: aastore
    //   172: invokestatic 595	atiu:b	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   175: goto -112 -> 63
    //   178: astore_1
    //   179: aload_2
    //   180: monitorexit
  ...
  {
    boolean bool = false;
    atiu.b("OlympicManager", new Object[] { "isNetworkCanPredown" });
    if (this.jdField_a_of_type_Atgt == null) {}
    for (int i = 0; i == 1; i = this.jdField_a_of_type_Atgt.jdField_a_of_type_Int) {
      return true;
    }
    int j = badq.a(BaseApplicationImpl.getContext());
    atiu.b("OlympicManager", new Object[] { "isNetworkCanPredown, type=", Integer.valueOf(j) });
    if (i == 0) {
      if ((j != 1) && (j != 4)) {}
    }
  ...
  protected void d()
  {
    ...
    if (this.jdField_a_of_type_Atgt == null)
    {
      ...
      i = (int)(babp.d() / 1024L / 1024L);
      j = bajq.a();
      str = DeviceProfileManager.a().a(DeviceProfileManager.DpcNames.olympic_act_config.name());
      this.jdField_a_of_type_Atgt.jdField_a_of_type_JavaLangString = str;
    }
    try
    {
      if (str.length() > 0)
      {
        ...
        if (arrayOfString.length >= 9)
        {
          ...
          for (this.jdField_a_of_type_Atgt.jdField_b_of_type_Boolean = true;; this.jdField_a_of_type_Atgt.jdField_b_of_type_Boolean = true)
          {
            if (Integer.valueOf(arrayOfString[3]).intValue() == 1) {
              this.jdField_a_of_type_Atgt.jdField_d_of_type_Boolean = true;
            }
            this.jdField_a_of_type_Atgt.jdField_a_of_type_Int = Integer.valueOf(arrayOfString[4]).intValue();
            this.jdField_a_of_type_Atgt.jdField_b_of_type_Int = Integer.valueOf(arrayOfString[5]).intValue();
            this.jdField_a_of_type_Atgt.jdField_c_of_type_Int = Integer.valueOf(arrayOfString[6]).intValue();
            this.jdField_a_of_type_Atgt.jdField_d_of_type_Int = Integer.valueOf(arrayOfString[7]).intValue();
            this.jdField_a_of_type_Atgt.jdField_e_of_type_Int = Integer.valueOf(arrayOfString[8]).intValue();
            bool1 = false;
            this.jdField_a_of_type_Atgt.jdField_a_of_type_Boolean = bool1;
            if (bool1)
            {
              if (i > 512) {
                break label487;
              }
              this.jdField_a_of_type_Atgt.jdField_b_of_type_Boolean = true;
              this.jdField_a_of_type_Atgt.jdField_d_of_type_Boolean = false;
              this.jdField_a_of_type_Atgt.jdField_a_of_type_Int = 0;
              this.jdField_a_of_type_Atgt.jdField_b_of_type_Int = 3;
              this.jdField_a_of_type_Atgt.jdField_c_of_type_Int = 1000;
              this.jdField_a_of_type_Atgt.jdField_d_of_type_Int = 1;
              this.jdField_a_of_type_Atgt.jdField_e_of_type_Int = 1;
            }
            if (this.jdField_a_of_type_Atgt.jdField_d_of_type_Int != 1) {
              break label523;
            }
            atiu.a(bool2);
            if (QLog.isColorLevel()) {
              QLog.d("OlympicManager", 2, "loadDPCConfig|featureValue:" + str + ",systemTotalMem:" + i + ",screenWidth:" + j + ",isUseDefault:" + bool1 + ",dpc:" + this.jdField_a_of_type_Atgt.toString());
            }
            return;
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        {
          this.jdField_a_of_type_Atgt.jdField_c_of_type_Boolean = true;
          continue;
          label487:
          if (j <= 480)
          {
  ...
  public boolean d()
  {
    atiu.b("OlympicManager", new Object[] { "isNetworkCanPredown" });
    if (this.jdField_a_of_type_Atgt == null) {}
    for (int i = 1; i == 1; i = this.jdField_a_of_type_Atgt.jdField_e_of_type_Int) {
      return true;
    }
    return false;
  }
  ...
  public void e()
  {
    atiu.b("OlympicManager", new Object[] { "clearActConfig" });
    synchronized (this.jdField_a_of_type_ArrayOfByte)
    {
  ...
  public void g()
  {
    if (atiu.a(BaseApplicationImpl.getContext(), "olympic_config_act"))
    {
      if (QLog.isColorLevel()) {
      ...
      awrn.a(BaseApplicationImpl.getContext()).a("", "olympic_config_act", false, 0L, 0L, localHashMap, "", false);
    }
    for (;;)
    {
      atiu.a(BaseApplicationImpl.getContext(), "olympic_config_act");
      return;
      label106:
      awrn.a(BaseApplicationImpl.getContext()).a("", "olympic_config_act", true, 0L, 0L, null, "", false);
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      if (paramMessage.obj == null)
      {
        ...
        if ((this.jdField_a_of_type_Int != 1) && (this.jdField_a_of_type_Atgv != null)) {
          this.jdField_a_of_type_Atgv.a();
        }
      ...
      {
        this.jdField_a_of_type_Atgv.a(this.jdField_a_of_type_ComTencentMobileqqOlympicTorchInfo);
        continue;
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqOlympicOlyimpicConfig != null)
        {
          ...
          for (boolean bool = true;; bool = false)
          {
            ...
            this.jdField_a_of_type_Atgv.a(true, bool, i);
            break;
          }
          ...
          if (this.jdField_a_of_type_Atgv != null) {
            this.jdField_a_of_type_Atgv.a(false, false, -1);
          }
        }
      }
    }
  ...
  public void onDestroy()
  {
    ...
    this.jdField_b_of_type_AndroidOsHandler.removeMessages(8);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Atgz);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.unRegistObserver(this);
    this.jdField_a_of_type_Atha.b(this.jdField_a_of_type_Athc);
