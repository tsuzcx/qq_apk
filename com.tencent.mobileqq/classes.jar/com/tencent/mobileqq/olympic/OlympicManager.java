  ...
  implements SoundPool.OnLoadCompleteListener, Handler.Callback, Manager, BusinessObserver
{
  ...
  private static Comparator<ShuayishuaConfig> jdField_a_of_type_JavaUtilComparator = new auev();
  ...
  public aueu a;
  private auey jdField_a_of_type_Auey = new auex(this);
  private auez jdField_a_of_type_Auez;
  private aufb jdField_a_of_type_Aufb = new auew(this);
  ...
  public OlympicManager(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Auez = new auez(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    this.jdField_a_of_type_Aukn = paramQQAppInterface.getEntityManagerFactory().createEntityManager();
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Auey);
    this.jdField_a_of_type_Auez.a(this.jdField_a_of_type_Aufb);
  ...
  protected static OlyimpicConfig a(String paramString, int paramInt, ArrayList<Integer> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      {
        ((ShuayishuaConfig)localObject2).realBegin = augt.a(((XmlPullParser)localObject1).nextText());
      }
      else if (str.equalsIgnoreCase("End"))
      {
        ((ShuayishuaConfig)localObject2).realEnd = augt.a(((XmlPullParser)localObject1).nextText());
      }
    ...
    for (int i = paramArrayList.size();; i = 0)
    {
      ...
      if ((i != 0) && (k > 0))
      {
        ...
        if (((ShuayishuaConfig)localObject1).type == 2)
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.i("OlympicManager", 2, "parseConfig last.realBegin=" + ((ShuayishuaConfig)localObject1).realBegin + "(" + augt.a(((ShuayishuaConfig)localObject1).realBegin) + "),countHitConfig =" + 0 + ",diff = " + paramInt);
          }
      ...
      for (;;)
      {
        if (j < k)
        {
          ...
          if (((ShuayishuaConfig)localObject2).type == 2)
          {
            ...
            if (QLog.isColorLevel()) {
              QLog.i("OlympicManager", 2, "parseConfig cur.realBegin=" + ((ShuayishuaConfig)localObject2).realBegin + "(" + augt.a(((ShuayishuaConfig)localObject2).realBegin) + "),countHitConfig =" + paramInt + ",diff = " + m);
            }
  ...
  private void a(long paramLong)
  {
    ...
    aueu localaueu = this.jdField_a_of_type_Aueu;
    if (localaueu == null) {
      return;
    }
    long l = paramLong;
    ...
    {
      QLog.d("OlympicManager", 2, (String)localObject + ",currentTime = " + l + "(" + augt.a(l) + "),closeEntrance = " + bool2 + ",mHasChechBreathOnRecovery = " + this.jdField_d_of_type_Boolean + ",olympicSettingFlag = " + bool3 + ",mTorchbearerFlag = " + this.jdField_a_of_type_Int);
      if (this.jdField_a_of_type_ComTencentMobileqqOlympicOlympicActConfig != null) {}
      localaueu.a();
      return;
  ...
  {
    augt.b("OlympicManager", new Object[] { "tryDownloadActResource ，forceDownload = " + paramBoolean });
    ...
    if (this.jdField_a_of_type_Aues == null)
    {
      ...
      if ((this.jdField_a_of_type_Aues != null) && (!this.jdField_a_of_type_Aues.jdField_a_of_type_Boolean)) {
        break label222;
      }
      bool = true;
      label105:
    ...
    label222:
    label228:
    for (int i = 0;; i = this.jdField_a_of_type_Aues.jdField_a_of_type_Int)
    {
      ((HashMap)localObject1).put("dpc", String.valueOf(i));
      axrl.a(BaseApplicationImpl.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "olympic_down_dpc", bool, 0L, 0L, (HashMap)localObject1, "", false);
      if (paramBoolean) {
        break label262;
      }
      if (d()) {
      ...
      augt.b("OlympicManager", new Object[] { "tryDownloadActResource, can't auto pre download, return" });
      return;
      if (this.jdField_a_of_type_Aues.jdField_a_of_type_JavaLangString == null)
      {
        localObject1 = "dpc.string is null";
        break;
      }
      localObject1 = this.jdField_a_of_type_Aues.jdField_a_of_type_JavaLangString;
      break;
      bool = false;
      break label105;
    }
    ...
    if (!c())
    {
      augt.b("OlympicManager", new Object[] { "tryDownloadActResource, isNetworkCanPredown is false, return" });
      return;
    }
    label262:
    long l = NetConnInfoCenter.getServerTimeMillis();
    Object localObject1 = paramOlympicActConfig.getConfigString("HomePage", "End");
    if ((TextUtils.isEmpty((CharSequence)localObject1)) || (augt.a((String)localObject1) < l))
    {
      augt.b("OlympicManager", new Object[] { "tryDownloadActResource, time expired!" });
      return;
    }
    ...
    {
      augt.b("OlympicManager", new Object[] { "tryDownloadActResource, cityPic & starPic, isSelfTorchbearer() && mTorchbearerInfo != null" });
      localObject1 = localObject2;
      if (this.jdField_a_of_type_ComTencentMobileqqOlympicTorchInfo.city_list.size() > 0)
      {
        ...
        {
          this.jdField_a_of_type_Auez.a(((TorchInfo.CityInfo)localObject3).city_pic_url, ((TorchInfo.CityInfo)localObject3).city_pic_md5, new String[] { "ActConfig", "CityImage", ((TorchInfo.CityInfo)localObject3).city_id + "_" + ((TorchInfo.CityInfo)localObject3).city_pic_id }, false, 2, true);
          localArrayList1.add(((TorchInfo.CityInfo)localObject3).city_pic_md5);
          this.jdField_a_of_type_Auez.a(((TorchInfo.CityInfo)localObject3).cons_pic_url, ((TorchInfo.CityInfo)localObject3).cons_pic_md5, new String[] { "ActConfig", "StarImage", ((TorchInfo.CityInfo)localObject3).city_id + "_" + ((TorchInfo.CityInfo)localObject3).city_pic_id }, false, 2, true);
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqOlympicTorchInfo.city_list.size() > 1)
      {
        ...
        if (localObject3 != null)
        {
          this.jdField_a_of_type_Auez.a(((TorchInfo.CityInfo)localObject3).city_pic_url, ((TorchInfo.CityInfo)localObject3).city_pic_md5, new String[] { "ActConfig", "City2Image", ((TorchInfo.CityInfo)localObject3).city_id + "_" + ((TorchInfo.CityInfo)localObject3).city_pic_id }, false, 2, true);
          localArrayList1.add(((TorchInfo.CityInfo)localObject3).city_pic_md5);
          this.jdField_a_of_type_Auez.a(((TorchInfo.CityInfo)localObject3).cons_pic_url, ((TorchInfo.CityInfo)localObject3).cons_pic_md5, new String[] { "ActConfig", "Star2Image", ((TorchInfo.CityInfo)localObject3).city_id + "_" + ((TorchInfo.CityInfo)localObject3).city_pic_id }, false, 2, true);
          localArrayList1.add(((TorchInfo.CityInfo)localObject3).cons_pic_md5);
          localObject2 = localObject1;
        }
      }
    ...
    do
    {
      ...
      paramBoolean = true;
      augt.b("OlympicManager", new Object[] { "tryDownloadActResource, homePageBg==null?", Boolean.valueOf(paramBoolean) });
      if (localObject1 == null) {
        break label1943;
      }
      this.jdField_a_of_type_Auez.a(((OlympicActConfig.HomePageBg)localObject1).url, ((OlympicActConfig.HomePageBg)localObject1).md5, new String[] { "ActConfig", "homePageBg", "01" }, false, 2, true);
      ...
      paramBoolean = true;
      augt.b("OlympicManager", new Object[] { "tryDownloadActResource, homePageBg2==null?", Boolean.valueOf(paramBoolean) });
      if (localObject1 != null)
      {
        this.jdField_a_of_type_Auez.a(((OlympicActConfig.HomePageBg)localObject1).url, ((OlympicActConfig.HomePageBg)localObject1).md5, new String[] { "ActConfig", "homePageBg", "02" }, false, 2, true);
        localArrayList1.add(((OlympicActConfig.HomePageBg)localObject1).md5);
      }
      localObject1 = "";
      augt.b("OlympicManager", new Object[] { "tryDownloadActResource, actConfig.mTorchImageMap.size() = ", Integer.valueOf(paramOlympicActConfig.getTorchImageMap().size()) });
      ...
      while (((Iterator)localObject4).hasNext())
      {
        ...
        this.jdField_a_of_type_Auez.a(localTorchImage.url, localTorchImage.md5, new String[] { "ActConfig", "TorchImage", str }, false, 2, true);
      ...
      augt.b("OlympicManager", new Object[] { "tryDownloadActResource, actConfig.getChosenCityImageList.size() = ", Integer.valueOf(paramOlympicActConfig.getChosenCityImageList().size()) });
    ...
    {
      this.jdField_a_of_type_Auez.a(((OlympicActConfig.CityImage)localObject2).url, ((OlympicActConfig.CityImage)localObject2).md5, new String[] { "ActConfig", "CityImage", ((OlympicActConfig.CityImage)localObject2).companyId + "_" + ((OlympicActConfig.CityImage)localObject2).picId }, false, 2, true);
      localArrayList1.add(((OlympicActConfig.CityImage)localObject2).md5);
      this.jdField_a_of_type_Auez.a(((OlympicActConfig.CityImage)localObject2).starUrl, ((OlympicActConfig.CityImage)localObject2).starMd5, new String[] { "ActConfig", "StarImage", ((OlympicActConfig.CityImage)localObject2).companyId + "_" + ((OlympicActConfig.CityImage)localObject2).picId }, false, 2, true);
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_Auez.a((String)localObject4, str, new String[] { "ActConfig", "TorchAnim" }, false, 2, true);
        ...
        this.jdField_a_of_type_Auez.a((String)localObject4, str, new String[] { "ActConfig", "MsgTabBG" }, false, 2, true);
        ...
        this.jdField_a_of_type_Auez.a((String)localObject4, str, new String[] { "ActConfig", "TorchImageNoBg" }, false, 2, true);
        localArrayList1.add(str);
        label1700:
        ...
        this.jdField_a_of_type_Auez.a((String)localObject4, paramOlympicActConfig, null, false, 2, true);
        localArrayList1.add(paramOlympicActConfig);
      }
      for (;;)
      {
        if (augt.a(BaseApplicationImpl.getContext(), "olympic_predown_act")) {
        ...
        return;
        augt.b("OlympicManager", new Object[] { "tryDownloadActResource, TorchAnim,  torchAnimUrl or torchAnimMd5 is empty" });
        break label1538;
        label1892:
        augt.b("OlympicManager", new Object[] { "tryDownloadActResource, MsgTabBG,  msgTabImgUrl or msgTabImgMD5 is empty" });
        break label1619;
        label1910:
        QLog.i("OlympicManager", 1, "tryDownloadActResource, TorchImageNoBg,  torchImageNoBgUrl or torchImageNoBgMD5 is empty");
        break label1700;
        label1922:
        augt.b("OlympicManager", new Object[] { "tryDownloadActResource, takeAwardImg,  takeAwardImgUrl or takeAwardImgUrl is empty" });
      }
      label1940:
      break label1184;
      label1943:
    ...
    do
    {
      ...
      for (;;)
      {
        try
        {
          ...
          {
            bool1 = auez.a((String)paramList1.next()) & bool1;
            if (!bool1) {
              bool2 = bool1;
            }
          }
          else
          {
            ...
            axrl.a(BaseApplicationImpl.getContext()).a("", paramString, true, 0L, 0L, paramList2, "", false);
            augt.a(BaseApplicationImpl.getContext(), paramString);
            return;
          }
        }
  ...
  private void b(long paramLong)
  {
    ...
    while (QLog.isColorLevel())
    {
      ...
      for (;;)
      {
        if (j < ((ArrayList)localObject2).size())
        {
          ...
          ((StringBuilder)localObject1).append(localShuayishuaConfig.realBegin + "(" + augt.a(localShuayishuaConfig.realBegin) + ")").append("-").append(localShuayishuaConfig.uiEnd + "(" + augt.a(localShuayishuaConfig.uiEnd) + ")").append(";");
          j += 1;
          continue;
          i = -k - 1;
          break;
    ...
    if ((i > 0) && (i <= ((ArrayList)localObject2).size()))
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("OlympicManager", 2, "handleCheckTime ,cConfig.uiEnd = " + ((ShuayishuaConfig)localObject1).uiEnd + "(" + augt.a(((ShuayishuaConfig)localObject1).uiEnd) + "),current = " + paramLong + "(" + augt.a(paramLong) + ")");
        }
        localObject1 = null;
      }
    }
  ...
  private void b(OlyimpicConfig paramOlyimpicConfig)
  {
    ...
    do
    {
      ...
      if (!d())
      {
        augt.b("OlympicManager", new Object[] { "tryDownload, can't auto pre download, return" });
        return;
      }
      if (!c())
      {
        augt.b("OlympicManager", new Object[] { "tryDownload, isNetworkCanPredown is false, return" });
        return;
      }
      long l = NetConnInfoCenter.getServerTimeMillis();
      ...
      while (paramOlyimpicConfig.hasNext())
      {
        ...
        if ((localShuayishuaConfig.uiEnd > l) || (localShuayishuaConfig.realEnd > l))
        {
          ...
          {
            this.jdField_a_of_type_Auez.a(localShuayishuaConfig.LUIconImg, localShuayishuaConfig.LUIconImgMd5, new String[] { "shuayishua", String.valueOf(localShuayishuaConfig.id) }, false, 1, true);
          ...
          {
            this.jdField_a_of_type_Auez.a(localShuayishuaConfig.torchLogoImg, localShuayishuaConfig.torchLogoImgMd5, new String[] { "shuayishua", String.valueOf(localShuayishuaConfig.id) }, false, 1, true);
          ...
          {
            this.jdField_a_of_type_Auez.a(localShuayishuaConfig.torchAnimUrl, localShuayishuaConfig.torchAnimMd5, new String[] { "shuayishua_anim", String.valueOf(localShuayishuaConfig.id) }, false, 1, true);
            localArrayList2.add(localShuayishuaConfig.torchAnimMd5);
          }
        }
      }
    } while (!augt.a(BaseApplicationImpl.getContext(), "olympic_predown_shua"));
  ...
  public OlympicPredownInfo a(String paramString)
  {
    ...
    try
    {
      augt.b("OlympicManager", new Object[] { "getEntity, url=", str });
      ...
      for (;;)
      {
        ...
        try
        {
          paramString = this.jdField_a_of_type_Aukn.a(OlympicPredownInfo.class, false, "url = ?", new String[] { paramString }, null, null, null, null);
  ...
  protected OlyimpicConfig a()
  {
    ...
    //   39: astore_1
    //   40: aload_1
    //   41: invokevirtual 1151	java/io/File:exists	()Z
    //   44: ifeq +351 -> 395
    //   47: new 1153	java/io/FileInputStream
    //   50: dup
    //   51: aload_1
    //   52: invokespecial 1156	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   55: astore_2
    //   56: new 1158	java/io/ObjectInputStream
    //   59: dup
    //   60: new 1160	java/io/BufferedInputStream
    //   63: dup
    //   64: aload_2
    //   65: invokespecial 1163	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   68: invokespecial 1164	java/io/ObjectInputStream:<init>	(Ljava/io/InputStream;)V
    //   71: astore_1
    //   72: aload_2
    //   73: astore 4
    //   75: aload_1
    ...
    //   87: ifnull +7 -> 94
    //   90: aload_1
    //   91: invokevirtual 1170	java/io/ObjectInputStream:close	()V
    //   94: aload 5
    //   96: astore_1
    //   97: aload_2
    //   98: ifnull +10 -> 108
    ...
    //   245: ifnull +7 -> 252
    //   248: aload_1
    //   249: invokevirtual 1170	java/io/ObjectInputStream:close	()V
    //   252: aload_2
    //   253: ifnull +142 -> 395
    //   256: aload_2
    //   257: invokevirtual 1171	java/io/FileInputStream:close	()V
    //   260: aconst_null
    //   261: astore_1
    //   262: goto -154 -> 108
    //   265: astore_1
    ...
    //   313: ifnull +7 -> 320
    //   316: aload_3
    //   317: invokevirtual 1170	java/io/ObjectInputStream:close	()V
    //   320: aload_2
    //   321: ifnull +7 -> 328
    //   324: aload_2
    //   325: invokevirtual 1171	java/io/FileInputStream:close	()V
    //   328: aload_1
    //   329: athrow
    //   330: astore_3
  ...
  public TorchInfo a()
  {
    ...
    //   4: astore 5
    //   6: aload_0
    //   7: getfield 82	com/tencent/mobileqq/olympic/OlympicManager:jdField_c_of_type_ArrayOfByte	[B
    //   10: astore 7
    //   12: aload 7
    //   14: monitorenter
    //   15: new 1132	java/io/File
    //   18: dup
    ...
    //   54: astore_2
    //   55: aload_2
    //   56: invokevirtual 1151	java/io/File:exists	()Z
    //   59: istore_1
    //   60: iload_1
    //   61: ifeq +381 -> 442
    //   64: new 1153	java/io/FileInputStream
    //   67: dup
    //   68: aload_2
    //   69: invokespecial 1156	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   72: astore_3
    //   73: new 1158	java/io/ObjectInputStream
    //   76: dup
    //   77: new 1160	java/io/BufferedInputStream
    //   80: dup
    //   81: aload_3
    //   82: invokespecial 1163	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   85: invokespecial 1164	java/io/ObjectInputStream:<init>	(Ljava/io/InputStream;)V
    //   88: astore_2
    //   89: aload_2
    ...
    //   112: ifnull +7 -> 119
    //   115: aload_2
    //   116: invokevirtual 1170	java/io/ObjectInputStream:close	()V
    //   119: aload 4
    //   121: astore_2
    //   122: aload_3
    //   123: ifnull +10 -> 133
    //   126: aload_3
    //   127: invokevirtual 1171	java/io/FileInputStream:close	()V
    //   130: aload 4
    //   132: astore_2
    //   133: aload 7
    //   135: monitorexit
    ...
    //   255: ifnull +8 -> 263
    //   258: aload 4
    //   260: invokevirtual 1170	java/io/ObjectInputStream:close	()V
    //   263: aload_3
    //   264: ifnull +175 -> 439
    //   267: aload_3
    ...
    //   321: ifnull +8 -> 329
    //   324: aload 4
    //   326: invokevirtual 1170	java/io/ObjectInputStream:close	()V
    //   329: aload_3
    //   330: ifnull +7 -> 337
    //   333: aload_3
    //   334: invokevirtual 1171	java/io/FileInputStream:close	()V
    //   337: aload_2
    //   338: athrow
    //   339: astore 4
  ...
  public TorchInfo a(torch_transfer.TorchbearerInfo paramTorchbearerInfo)
  {
    ...
    for (;;)
    {
      ...
      for (int i = 1;; i = 0)
      {
        ...
        {
          augt.b("OlympicManager", new Object[] { paramTorchbearerInfo });
  ...
  public void a(OlympicPredownInfo paramOlympicPredownInfo)
  {
    ...
    //   24: aload_2
    //   25: aastore
    //   26: invokestatic 595	augt:b	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   29: aload_1
    //   30: ifnonnull +11 -> 41
    //   33: aload_0
    //   34: monitorexit
    ...
    //   38: goto -28 -> 10
    //   41: aload_0
    //   42: getfield 185	com/tencent/mobileqq/olympic/OlympicManager:jdField_a_of_type_Aukn	Laukn;
    //   45: invokevirtual 1256	aukn:a	()Laukp;
    //   48: astore_2
    //   49: aload_2
    //   50: invokevirtual 1259	aukp:a	()V
    //   53: aload_0
    //   54: getfield 185	com/tencent/mobileqq/olympic/OlympicManager:jdField_a_of_type_Aukn	Laukn;
    //   57: aload_1
    //   58: invokevirtual 1262	aukn:b	(Laukm;)V
    //   61: aload_2
    //   62: invokevirtual 1264	aukp:c	()V
    //   65: aload_2
    //   66: invokevirtual 1266	aukp:b	()V
    //   69: goto -36 -> 33
    //   72: astore_1
    //   73: aload_0
    //   74: monitorexit
    ...
    //   88: aload_2
    //   89: invokevirtual 1266	aukp:b	()V
    //   92: goto -59 -> 33
    //   95: astore_1
    //   96: aload_2
    //   97: invokevirtual 1266	aukp:b	()V
    //   100: aload_1
    //   101: athrow
    // Local variable table:
    //   start	length	slot	name	signature
    ...
    for (;;)
    {
      ...
      finally
      {
        try
        {
          ...
          bbdj.a(new File(BaseApplicationImpl.sApplication.getFilesDir(), "olympic_shuayishua_config_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).getAbsolutePath(), localByteArrayOutputStream.toByteArray(), false);
        }
  ...
  {
    augt.b("OlympicManager", new Object[] { "onGetActConfig" });
    if (paramOlympicActConfig == null)
    {
      augt.b("OlympicManager", new Object[] { "onGetActConfig, config is null!" });
      return;
    }
  ...
  public void a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        augt.b("OlympicManager", new Object[] { "updateEntity, url=", localObject1, ", dailyInc=", Integer.valueOf(paramInt) });
        boolean bool = TextUtils.isEmpty(paramString);
        if (bool)
        {
          return;
      ...
      if (((OlympicPredownInfo)localObject1).dailyStartTime >= 86400000L)
      {
        ...
        label170:
        paramString = this.jdField_a_of_type_Aukn.a();
      }
      try
      {
        paramString.a();
        this.jdField_a_of_type_Aukn.a((aukm)localObject1);
        paramString.c();
        paramString.b();
        continue;
        ((OlympicPredownInfo)localObject1).dailyRetryCount += paramInt;
  ...
  public void b(TorchInfo paramTorchInfo)
  {
    if (paramTorchInfo != null)
    {
      ...
      Object localObject;
      if ((augt.a(paramTorchInfo.torch_pic_url) == null) && (jdField_a_of_type_Boolean))
      {
        localObject = auez.a() + paramTorchInfo.torch_pic_md5;
        if (jdField_a_of_type_Boolean)
        {
          localObject = augt.a(paramTorchInfo.torch_pic_url, (String)localObject, this.jdField_a_of_type_Aues, 0);
      ...
      if ((paramTorchInfo.city_list != null) && (paramTorchInfo.city_list.size() > 0))
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          if (paramTorchInfo.city_id == l) {
            if ((augt.a(paramTorchInfo.city_pic_url) == null) && (jdField_a_of_type_Boolean))
            {
              localObject = auez.a() + paramTorchInfo.city_pic_md5;
              if (jdField_a_of_type_Boolean)
              {
                paramTorchInfo = augt.a(paramTorchInfo.city_pic_url, (String)localObject, this.jdField_a_of_type_Aues, 2);
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_ArrayOfByte)
      {
        if (this.jdField_a_of_type_ComTencentMobileqqOlympicOlympicActConfig != null)
        {
          ...
          augt.b("OlympicManager", new Object[] { "saveActConfigToLocal, result=", Boolean.valueOf(bool) });
          return bool;
        }
      }
      boolean bool = false;
  ...
  public boolean b(String paramString)
  {
    ...
    do
    {
      ...
      {
        return bool1;
        i = this.jdField_a_of_type_Aues.jdField_b_of_type_Int;
        break;
        j = this.jdField_a_of_type_Aues.jdField_c_of_type_Int;
        break label55;
      }
      bool1 = bool2;
  ...
  public void c()
  {
    ...
    //   37: ldc_w 1421
    //   40: aastore
    //   41: invokestatic 595	augt:b	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   44: aload_0
    ...
    //   127: aastore
    //   128: invokestatic 595	augt:b	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   131: aload_0
    ...
    //   171: aastore
    //   172: invokestatic 595	augt:b	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   175: goto -112 -> 63
    //   178: astore_1
    //   179: aload_2
    //   180: monitorexit
  ...
  {
    boolean bool = false;
    augt.b("OlympicManager", new Object[] { "isNetworkCanPredown" });
    if (this.jdField_a_of_type_Aues == null) {}
    for (int i = 0; i == 1; i = this.jdField_a_of_type_Aues.jdField_a_of_type_Int) {
      return true;
    }
    int j = bbev.a(BaseApplicationImpl.getContext());
    augt.b("OlympicManager", new Object[] { "isNetworkCanPredown, type=", Integer.valueOf(j) });
    if (i == 0) {
      if ((j != 1) && (j != 4)) {}
    }
      ...
      if (str.length() > 0)
      {
        ...
        if (arrayOfString.length >= 9)
        {
          ...
          for (this.jdField_a_of_type_Aues.jdField_b_of_type_Boolean = true;; this.jdField_a_of_type_Aues.jdField_b_of_type_Boolean = true)
          {
            ...
            augt.a(bool2);
            if (QLog.isColorLevel()) {
              QLog.d("OlympicManager", 2, "loadDPCConfig|featureValue:" + str + ",systemTotalMem:" + i + ",screenWidth:" + j + ",isUseDefault:" + bool1 + ",dpc:" + this.jdField_a_of_type_Aues.toString());
            }
            return;
  ...
  public boolean d()
  {
    augt.b("OlympicManager", new Object[] { "isNetworkCanPredown" });
    if (this.jdField_a_of_type_Aues == null) {}
    for (int i = 1; i == 1; i = this.jdField_a_of_type_Aues.jdField_e_of_type_Int) {
      return true;
    }
    return false;
  }
  ...
  public void e()
  {
    augt.b("OlympicManager", new Object[] { "clearActConfig" });
    synchronized (this.jdField_a_of_type_ArrayOfByte)
    {
  ...
  public void g()
  {
    if (augt.a(BaseApplicationImpl.getContext(), "olympic_config_act"))
    {
      if (QLog.isColorLevel()) {
      ...
      axrl.a(BaseApplicationImpl.getContext()).a("", "olympic_config_act", false, 0L, 0L, localHashMap, "", false);
    }
    for (;;)
    {
      augt.a(BaseApplicationImpl.getContext(), "olympic_config_act");
      return;
      label106:
      axrl.a(BaseApplicationImpl.getContext()).a("", "olympic_config_act", true, 0L, 0L, null, "", false);
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      if (paramMessage.obj == null)
      {
        ...
        if ((this.jdField_a_of_type_Int != 1) && (this.jdField_a_of_type_Aueu != null)) {
          this.jdField_a_of_type_Aueu.a();
        }
      ...
      {
        this.jdField_a_of_type_Aueu.a(this.jdField_a_of_type_ComTencentMobileqqOlympicTorchInfo);
        continue;
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqOlympicOlyimpicConfig != null)
        {
          ...
          for (boolean bool = true;; bool = false)
          {
            ...
            this.jdField_a_of_type_Aueu.a(true, bool, i);
            break;
          }
          ...
          if (this.jdField_a_of_type_Aueu != null) {
            this.jdField_a_of_type_Aueu.a(false, false, -1);
          }
        }
      }
    }
  ...
  public void onDestroy()
  {
    ...
    this.jdField_b_of_type_AndroidOsHandler.removeMessages(8);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Auey);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.unRegistObserver(this);
    this.jdField_a_of_type_Auez.b(this.jdField_a_of_type_Aufb);
