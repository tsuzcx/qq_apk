  ...
  extends ResultReceiver
{
  ...
  {
    azet.b("ScannerResultReceiver", new Object[] { "setActivity activity:", paramScanBaseActivity, this });
  ...
  {
    azet.b("ScannerResultReceiver", new Object[] { "mResultReceiver.onReceiveResult, resultCode=", Integer.valueOf(paramInt), this });
    if (paramInt == 0)
    {
