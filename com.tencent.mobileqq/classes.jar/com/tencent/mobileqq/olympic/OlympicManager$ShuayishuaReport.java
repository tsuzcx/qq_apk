  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      j = (int)l;
      OlympicManager.a(this.jdField_a_of_type_ComTencentMobileqqOlympicOlympicManager).postDelayed(new afqy(this, k, localArrayList1, localArrayList2, localArrayList3, localArrayList4), j);
      break;
    }
  }
}
