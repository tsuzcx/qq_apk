  ...
  extends AbsBaseWebViewActivity
{
  ...
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new athz(this);
  ...
  private void h()
  {
    ...
    i();
    k();
    this.jdField_a_of_type_Befq.sendEmptyMessageDelayed(0, 5000L);
  }
    ...
    do
    {
      ...
      try
      {
        if (this.jdField_a_of_type_Bbms == null)
        {
          ...
          this.jdField_a_of_type_Bbms.a(ajjy.a(2131642050));
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_Befq = new befq(this.jdField_a_of_type_AndroidOsHandler$Callback);
