...
{
  agit jdField_a_of_type_Agit = null;
  ...
  {
    this.jdField_a_of_type_Agit = new agit(this, null);
    AppNetConnInfo.registerConnectionChangeReceiver(getApplication(), this.jdField_a_of_type_Agit);
