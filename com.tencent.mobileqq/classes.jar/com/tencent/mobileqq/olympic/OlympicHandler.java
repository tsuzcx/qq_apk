  ...
  extends BusinessHandler
{
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ((OlympicManager)this.appRuntime.getManager(QQManagerFactory.OLYMPIC_MANAGER)).a(paramToServiceMsg);
        if (QLog.isColorLevel()) {
  ...
  public void a(torch_transfer.TorchbearerInfo paramTorchbearerInfo)
  {
    ...
    OlympicManager localOlympicManager = (OlympicManager)this.appRuntime.getManager(QQManagerFactory.OLYMPIC_MANAGER);
