  ...
  implements Serializable
{
  ...
  private void a(AppRuntime paramAppRuntime)
  {
    ...
    //   10: ldc 67
    //   12: aastore
    //   13: invokestatic 73	axsb:b	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   16: aload_1
    ...
    //   189: aastore
    //   190: invokestatic 73	axsb:b	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   193: goto -101 -> 92
    //   196: astore_1
    //   197: aload_0
    //   198: monitorexit
  ...
  public static boolean deleteFile(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    for (;;)
    {
      try
      {
        axsb.b("OlympicActConfig", new Object[] { "deleteFile()" });
        if (paramQQAppInterface == null)
        {
          axsb.b("OlympicActConfig", new Object[] { "deleteFile(), app is null" });
          return bool;
        }
        paramQQAppInterface = paramContext.getFileStreamPath("olympic_act_cfg_" + paramQQAppInterface.getCurrentAccountUin());
        if (!paramQQAppInterface.exists()) {
          axsb.b("OlympicActConfig", new Object[] { "deleteFile, config file not exist" });
        } else {
  ...
  public static OlympicActConfig parse(AppRuntime paramAppRuntime, String paramString)
  {
    ...
    {
      axsb.b("OlympicActConfig", new Object[] { "parse(), xmlContent is empty" });
      return null;
    }
    ...
    localObject1 = "";
    localObject4 = null;
    axsb.b("OlympicActConfig", new Object[] { "parse(), start parse" });
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        axsb.b("OlympicActConfig", new Object[] { "startTag=", str, ", depth=", Integer.valueOf(localXmlPullParser.getDepth()) });
        ...
        else
        {
          ...
          else if ("TorchImage".equalsIgnoreCase(paramString))
          {
            ...
            else if ("FileUrl".equalsIgnoreCase(str))
            {
              ...
              {
                axsb.b("OlympicActConfig", new Object[] { "TorchImage, FileUrl 错误的tag顺序!" });
                localObject5 = localObject3;
                localObject3 = localObject2;
                localObject2 = localObject1;
                localObject1 = localObject5;
            ...
            else
            {
              ...
              {
                axsb.b("OlympicActConfig", new Object[] { "TorchImage, FileMd5 错误的tag顺序!" });
                localObject5 = localObject3;
                localObject3 = localObject2;
                localObject2 = localObject1;
                localObject1 = localObject5;
          ...
          else if (("CityImage".equalsIgnoreCase(paramString)) || ("City2Image".equalsIgnoreCase(paramString)))
          {
            ...
            else if ("PicId".equalsIgnoreCase(str))
            {
              ...
              {
                axsb.b("OlympicActConfig", new Object[] { "CityImage, PicId 错误的tag顺序!" });
                localObject5 = localObject3;
                localObject3 = localObject2;
                localObject2 = localObject1;
                localObject1 = localObject5;
            ...
            else if ("FileUrl".equalsIgnoreCase(str))
            {
              ...
              {
                axsb.b("OlympicActConfig", new Object[] { "CityImage, FileUrl 错误的tag顺序!" });
                localObject5 = localObject3;
                localObject3 = localObject2;
                localObject2 = localObject1;
                localObject1 = localObject5;
            ...
            else if ("FileMd5".equalsIgnoreCase(str))
            {
              ...
              {
                axsb.b("OlympicActConfig", new Object[] { "CityImage, FileMd5 错误的tag顺序!" });
                localObject5 = localObject3;
                localObject3 = localObject2;
                localObject2 = localObject1;
                localObject1 = localObject5;
            ...
            else if ("StarFileUrl".equalsIgnoreCase(str))
            {
              ...
              {
                axsb.b("OlympicActConfig", new Object[] { "CityImage, StarFileUrl 错误的tag顺序!" });
                localObject5 = localObject3;
                localObject3 = localObject2;
                localObject2 = localObject1;
                localObject1 = localObject5;
            ...
            else
            {
              ...
              axsb.b("OlympicActConfig", new Object[] { "CityImage, StarFileMd5 错误的tag顺序!" });
              localObject5 = localObject3;
              localObject3 = localObject2;
              localObject2 = localObject1;
              localObject1 = localObject5;
          ...
          else if ("HomePageBG".equalsIgnoreCase(paramString))
          {
            ...
            else if ("Url".equalsIgnoreCase(str))
            {
              ...
              {
                axsb.b("OlympicActConfig", new Object[] { "HomePageBG, Url 错误的tag顺序!" });
                localObject5 = localObject3;
                localObject3 = localObject2;
                localObject2 = localObject1;
                localObject1 = localObject5;
            ...
            else
            {
              ...
              {
                axsb.b("OlympicActConfig", new Object[] { "HomePageBG, Md5 错误的tag顺序!" });
                localObject5 = localObject3;
                localObject3 = localObject2;
                localObject2 = localObject1;
                localObject1 = localObject5;
          ...
          else if ("BusiBanner".equalsIgnoreCase(paramString))
          {
            if ("BannerId".equalsIgnoreCase(str))
            {
              ...
              localObject5 = null;
              axsb.b("OlympicActConfig", new Object[] { "BannerId is empty" });
              localObject4 = localObject3;
              localObject3 = localObject2;
              localObject2 = localObject1;
              localObject1 = localObject4;
            ...
            else if ("Text".equalsIgnoreCase(str))
            {
              if (localObject4 != null)
              {
                ...
                localObject5 = null;
                axsb.b("OlympicActConfig", new Object[] { "Text is empty" });
                localObject4 = localObject3;
                localObject3 = localObject2;
                localObject2 = localObject1;
                localObject1 = localObject4;
              ...
              {
                axsb.b("OlympicActConfig", new Object[] { "BusiBanner, Text 错误的tag顺序!" });
                localObject5 = localObject3;
                localObject3 = localObject2;
                localObject2 = localObject1;
                localObject1 = localObject5;
            ...
            else if ("RemindText".equalsIgnoreCase(str))
            {
              if (localObject4 != null)
              {
                ...
                localObject5 = null;
                axsb.b("OlympicActConfig", new Object[] { "RemindText is empty" });
                localObject4 = localObject3;
                localObject3 = localObject2;
                localObject2 = localObject1;
                localObject1 = localObject4;
              ...
              {
                axsb.b("OlympicActConfig", new Object[] { "BusiBanner, RemindText 错误的tag顺序!" });
                localObject5 = localObject3;
                localObject3 = localObject2;
                localObject2 = localObject1;
                localObject1 = localObject5;
            ...
            else if ("ImgUrl".equalsIgnoreCase(str))
            {
              if (localObject4 != null)
              {
                ...
                localObject5 = null;
                axsb.b("OlympicActConfig", new Object[] { "ImgUrl is empty" });
                localObject4 = localObject3;
                localObject3 = localObject2;
                localObject2 = localObject1;
                localObject1 = localObject4;
              ...
              {
                axsb.b("OlympicActConfig", new Object[] { "BusiBanner, ImgUrl 错误的tag顺序!" });
                localObject5 = localObject3;
                localObject3 = localObject2;
                localObject2 = localObject1;
                localObject1 = localObject5;
            ...
            else if ("ImgMd5".equalsIgnoreCase(str))
            {
              if (localObject4 != null)
              {
                ...
                localObject5 = null;
                axsb.b("OlympicActConfig", new Object[] { "ImgMd5 is empty" });
                localObject4 = localObject3;
                localObject3 = localObject2;
                localObject2 = localObject1;
                localObject1 = localObject4;
              ...
              {
                axsb.b("OlympicActConfig", new Object[] { "BusiBanner, ImgMd5 错误的tag顺序!" });
                localObject5 = localObject3;
                localObject3 = localObject2;
                localObject2 = localObject1;
                localObject1 = localObject5;
            ...
            else
            {
              ...
              if (localObject4 != null)
              {
                ...
                localObject4 = null;
                axsb.b("OlympicActConfig", new Object[] { "BusiBannerJump is empty" });
                if (localObject4 == null) {
                  continue;
                }
              ...
              axsb.b("OlympicActConfig", new Object[] { "BusiBanner, BusiBannerJump 错误的tag顺序!" });
              localObject5 = localObject3;
              localObject3 = localObject2;
              localObject2 = localObject1;
              localObject1 = localObject5;
    ...
    for (;;)
    {
      ...
      {
        axsb.b("OlympicActConfig", new Object[] { "parse(), end parse" });
  ...
  public static OlympicActConfig readFromFile(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    //   15: ldc_w 440
    //   18: aastore
    //   19: invokestatic 73	axsb:b	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   22: aload_0
    //   23: ifnonnull +25 -> 48
    //   26: ldc 16
    //   28: iconst_1
    ...
    //   34: ldc_w 442
    //   37: aastore
    //   38: invokestatic 73	axsb:b	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   41: aload_2
    //   42: astore_0
    //   43: ldc 2
    //   45: monitorexit
    ...
    //   90: ldc_w 444
    //   93: aastore
    //   94: invokestatic 73	axsb:b	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   97: aload_2
    //   98: astore_0
    //   99: goto -56 -> 43
    //   102: astore_0
  ...
  public static int tryParseInt(String paramString)
  {
    ...
    {
      axsb.b("OlympicActConfig", new Object[] { "tryParseInt, exception, str=", paramString });
    }
    return -1;
  }
  ...
  public boolean save2File(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    //   16: ldc_w 502
    //   19: aastore
    //   20: invokestatic 73	axsb:b	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   23: aload_1
    //   24: ifnonnull +25 -> 49
    //   27: ldc 16
    //   29: iconst_1
    ...
    //   35: ldc_w 504
    //   38: aastore
    //   39: invokestatic 73	axsb:b	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   42: iload 4
    //   44: istore_3
    //   45: aload_0
    //   46: monitorexit
