  ...
  implements TogetherParser
{
  ...
  public void a(QQAppInterface paramQQAppInterface, SingTogetherSession paramSingTogetherSession, int paramInt, long paramLong1, String paramString, long paramLong2, long paramLong3, TroopTips0x857.SingChangePushInfo paramSingChangePushInfo)
  {
    ...
    Object localObject = (SingTogetherSession)localTogetherControlManager.a(paramSingTogetherSession.jdField_e_of_type_Int, paramSingTogetherSession.jdField_f_of_type_Int, paramSingTogetherSession.jdField_e_of_type_JavaLangString);
    if (localObject != null)
    {
    ...
    for (;;)
    {
      if (paramInt == 1)
      {
        TogetherUtils.a(paramQQAppInterface, paramSingTogetherSession.jdField_e_of_type_JavaLangString, true, paramSingTogetherSession.jdField_f_of_type_Int, 16777216);
        label164:
        if (paramSingTogetherSession.jdField_f_of_type_Int != 2) {
          break label307;
        }
        localObject = ((FriendsManager)paramQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER)).b(paramSingTogetherSession.jdField_e_of_type_JavaLangString);
      ...
      while (TextUtils.isEmpty(paramSingTogetherSession.jdField_e_of_type_JavaLangString))
      {
        ...
        if (paramInt == 2)
        {
          ...
          TogetherUtils.a(paramQQAppInterface, paramSingTogetherSession.jdField_e_of_type_JavaLangString, false, paramSingTogetherSession.jdField_f_of_type_Int, 16777216);
          break label164;
        }
      ...
      localObject = localTogetherControlManager.a(4, paramSingTogetherSession.jdField_f_of_type_Int, paramSingTogetherSession.jdField_e_of_type_JavaLangString, 1003);
      ((TogetherControlManager.CacheHolder)localObject).jdField_a_of_type_AndroidOsBundle.putInt("action_type", paramInt);
      ((TogetherControlManager.CacheHolder)localObject).jdField_a_of_type_AndroidOsBundle.putString("tips", paramString);
      ((TogetherControlManager.CacheHolder)localObject).jdField_a_of_type_AndroidOsBundle.putLong("seq", paramLong2);
      ((TogetherControlManager.CacheHolder)localObject).jdField_a_of_type_AndroidOsBundle.putLong("msgSeq", paramLong3);
      ((TogetherControlManager.CacheHolder)localObject).jdField_a_of_type_JavaLangObject = paramSingChangePushInfo;
      ...
      localTogetherControlManager.a(4, paramSingTogetherSession.jdField_f_of_type_Int, paramSingTogetherSession.jdField_e_of_type_JavaLangString, 1003);
      return;
      label454:
      paramSingTogetherSession = (SingTogetherSession)localObject;
    }
  ...
  public void a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, long paramLong1, long paramLong2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      label584:
      l4 = ((TogetherControlManager)paramQQAppInterface.getManager(QQManagerFactory.TOGETHER_CONTROLLER_MANAGER)).a(4, 2, l2);
      if (l3 < l4)
      {
        if (QLog.isColorLevel()) {
          QLog.d("SingTogetherParser", 2, "handleSingTogetherGroupPush, skip pushinfo, old seq=" + l4);
  ...
  public void a(ToServiceMsg paramToServiceMsg, aio_media.RspLatestPlayingState paramRspLatestPlayingState)
  {
    ...
    label131:
    boolean bool2 = false;
    Object localObject3 = (TogetherControlManager)this.a.getManager(QQManagerFactory.TOGETHER_CONTROLLER_MANAGER);
    paramToServiceMsg = (SingTogetherSession)((TogetherControlManager)localObject3).a(4, j, (String)localObject2);
    Object localObject1 = paramToServiceMsg;
    if (paramToServiceMsg == null)
    {
      localObject1 = (SingTogetherSession)TogetherUtils.a(4, j, (String)localObject2);
      ((TogetherControlManager)localObject3).a(4, j, (String)localObject2, (TogetherSession)localObject1);
    }
    boolean bool1;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localObject2 != null)
        {
          ...
          if (!TextUtils.isEmpty(((SingTogetherSession)localObject1).jdField_f_of_type_JavaLangString))
          {
            ...
            ContactUtils.p(this.a, ((SingTogetherSession)localObject1).jdField_f_of_type_JavaLangString);
            bool2 = bool1;
            paramRspLatestPlayingState = paramToServiceMsg;
          }
          label815:
      ...
      for (paramToServiceMsg = ((aio_media.ResultInfo)localObject2).bytes_errmsg.get().toStringUtf8();; paramToServiceMsg = "")
      {
        ...
        ContactUtils.g(this.a, ((SingTogetherSession)localObject1).jdField_e_of_type_JavaLangString, ((SingTogetherSession)localObject1).jdField_f_of_type_JavaLangString);
        paramRspLatestPlayingState = paramToServiceMsg;
        bool2 = bool1;
        break label815;
        break label958;
