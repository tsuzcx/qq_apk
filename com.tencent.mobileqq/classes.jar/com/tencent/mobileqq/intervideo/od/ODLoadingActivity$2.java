  ...
  implements Runnable
{
  ...
  public void run()
  {
    try
    {
      ((aqkc)this.jdField_a_of_type_JavaUtilConcurrentFuture.get(6L, TimeUnit.SECONDS)).enter(this.this$0, this.jdField_a_of_type_Long, this.jdField_a_of_type_AndroidOsBundle, new aqpo(this));
      return;
    }
