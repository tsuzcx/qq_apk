...
public final class GroupVideoManager$7
  implements Runnable
{
  public GroupVideoManager$7(String paramString, avtb paramavtb) {}
  ...
  public void run()
  {
    try
    {
      ...
      for (List localList = new UpgradeablePluginManager(avub.a(BaseApplicationImpl.getContext()), "huiyin2", avte.a()).getCachedLatestPlugin(this.jdField_a_of_type_JavaLangString);; localList = avsv.a().getCachedLatestPlugin(this.jdField_a_of_type_JavaLangString))
      {
