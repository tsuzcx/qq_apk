  ...
  implements aqvd
{
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqIntervideoAudioroomColornoteOnColorNoteAnimFinish != null) {
      this.jdField_a_of_type_ComTencentMobileqqIntervideoAudioroomColornoteOnColorNoteAnimFinish.onColorNoteAnimFinish();
    }
  }
}
