  ...
  implements PluginManagerUpdater
{
  ...
  private CdnPmUpdater.PmUpdaterListener jdField_a_of_type_ComTencentMobileqqIntervideoCdnPmUpdater$PmUpdaterListener;
  ...
  public CdnPmUpdater(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_JavaLangString = ("https://dlied5sdk.myapp.com/now/pluginmanager/" + "" + this.e + "/ShadowPluginManager_nowPlugin_" + paramContext);
    }
    for (;;)
    {
    ...
    {
      this.jdField_a_of_type_JavaLangString = ("https://dlied5sdk.myapp.com/huayang/Android/ShadowPluginManager1_1_" + paramString1 + paramContext);
      break;
    }
  }
  ...
  private boolean a()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        throw new Error(this.jdField_a_of_type_JavaLangString + HardCodeUtil.a(2131701542));
      }
      finally
      {
        localObject1 = null;
      ...
      try
      {
        if (((HttpURLConnection)localObject1).getResponseCode() != 200) {
          throw new Error(HardCodeUtil.a(2131701544) + 200 + HardCodeUtil.a(2131701545) + ((HttpURLConnection)localObject1).getResponseCode());
        }
  ...
  public File a()
  {
    ...
    localNowDownloadManager.a(this.jdField_a_of_type_JavaLangString, new CdnPmUpdater.2(this, localFile, arrayOfException, l, localCountDownLatch));
    localNowDownloadManager.b(NowDownloadTaskInfo.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaIoFile.getAbsolutePath()));
  ...
  public void a(CdnPmUpdater.PmUpdaterListener paramPmUpdaterListener)
  {
    this.jdField_a_of_type_ComTencentMobileqqIntervideoCdnPmUpdater$PmUpdaterListener = paramPmUpdaterListener;
  }
