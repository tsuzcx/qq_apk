...
public class LoginKeyHelper
{
  ...
  private void a(String paramString, boolean paramBoolean, int paramInt)
  {
    ...
    {
      LoginKeyHelper.GetLoginKeyListener localGetLoginKeyListener = (LoginKeyHelper.GetLoginKeyListener)localIterator.next();
      if (localGetLoginKeyListener != null) {
        localGetLoginKeyListener.a(paramString, paramBoolean, paramInt);
      }
    }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqIntervideoLoginKeyHelper$AccountInfo.a = null;
  }
  ...
  public void a(AppInterface paramAppInterface, String paramString1, Context paramContext, String paramString2, LoginKeyHelper.GetLoginKeyListener paramGetLoginKeyListener)
  {
    ...
    aebr localaebr = new aebr(this, paramGetLoginKeyListener, paramString1);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramContext.setObserver(localaebr);
      ...
      catch (Exception paramString2)
      {
        for (;;)
        {
          paramGetLoginKeyListener.a(paramString1, false, -10001);
        }
      }
    }
  }
  
  public boolean a(String paramString1, String paramString2, String paramString3, String paramString4, LoginKeyHelper.GetLoginKeyListener paramGetLoginKeyListener, boolean paramBoolean, String paramString5)
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_OicqWlogin_sdkRequestWtloginHelper.SetListener(new aebq(this, paramString2));
      this.jdField_a_of_type_JavaUtilList.add(paramGetLoginKeyListener);
      ...
      {
        paramString5 = HexUtil.a(paramString5);
      }
    }
  }
