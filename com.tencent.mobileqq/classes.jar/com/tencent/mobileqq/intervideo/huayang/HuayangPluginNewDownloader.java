...
{
  private static HashMap<String, HuayangPluginNewDownloader> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private final Context jdField_a_of_type_AndroidContentContext;
  private Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new HuayangPluginNewDownloader.1(this);
  ...
  private HuayangPluginNewDownloader.HuayangPluginLoadStatusListener jdField_a_of_type_ComTencentMobileqqIntervideoHuayangHuayangPluginNewDownloader$HuayangPluginLoadStatusListener;
  ...
  private HuayangPluginNewDownloader(Context paramContext, File paramFile, String paramString)
  {
    ...
    this.jdField_a_of_type_Boolean = IVPluginLoader.a();
  ...
  private InstalledPlugin a(ProgressFuture<InstalledPlugin> paramProgressFuture)
  {
    ...
    if ((!this.jdField_b_of_type_Boolean) && (Monitor.jdField_a_of_type_Boolean))
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (str.equals("SOURCE_CGI"))
        {
          ...
          Monitor.a("2653754");
          localObject1 = localObject2;
          a("HuayangPluginNewDownloader", HardCodeUtil.a(2131705659) + localTargetDownloadInfo.url);
          localObject1 = localObject2;
      ...
      catch (VersionCheckException localVersionCheckException)
      {
        ...
        try
        {
          ...
          a("updatePlugin", j, m, "", "");
          localObject3 = localInstalledPlugin;
          a("HuayangPluginNewDownloader", HardCodeUtil.a(2131705673) + m);
          localObject3 = localInstalledPlugin;
          if (!str.equals("SOURCE_CGI")) {
            continue;
          }
  ...
  private void a(InstalledPlugin paramInstalledPlugin)
  {
    ...
    try
    {
      ...
      a("HuayangPluginNewDownloader", HardCodeUtil.a(2131705655));
      str1 = str2;
      if (!this.jdField_b_of_type_Boolean)
      {
  ...
  {
    Object localObject = new StringBuilder().append(HardCodeUtil.a(2131705661));
    boolean bool;
    if (paramInstalledPlugin == null)
    {
      bool = true;
  ...
  private void b(InstalledPlugin paramInstalledPlugin)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqIntervideoHuayangHuayangPluginNewDownloader$HuayangPluginLoadStatusListener != null) {
      this.jdField_a_of_type_ComTencentMobileqqIntervideoHuayangHuayangPluginNewDownloader$HuayangPluginLoadStatusListener.a(10, new Object[0]);
    }
    ...
    a("HuayangPluginNewDownloader", HardCodeUtil.a(2131705675));
  }
  
  private void b(InstalledPlugin paramInstalledPlugin, boolean paramBoolean)
  {
    a("HuayangPluginNewDownloader", HardCodeUtil.a(2131705663) + paramInstalledPlugin);
  ...
  private void c()
  {
    ...
    if ((localObject1 != null) && (((List)localObject1).size() > 0))
    {
      ...
      {
        a("HuayangPluginNewDownloader", HardCodeUtil.a(2131705670) + (String)localObject3 + " mPluginVersion:" + this.e);
    ...
    for (;;)
    {
      try
      {
        ...
        if ((!"huiyin".equals(this.d)) || (NetworkUtil.a(this.jdField_a_of_type_AndroidContentContext)) || (!bool)) {
          break label559;
        }
        return;
      }
    ...
    if (!this.jdField_b_of_type_Boolean) {
      if (localException1 == null)
      {
        ...
        a("HuayangPluginNewDownloader", HardCodeUtil.a(2131705669));
  ...
  public void a(HuayangPluginNewDownloader.HuayangPluginLoadStatusListener paramHuayangPluginLoadStatusListener)
  {
    this.jdField_a_of_type_ComTencentMobileqqIntervideoHuayangHuayangPluginNewDownloader$HuayangPluginLoadStatusListener = paramHuayangPluginLoadStatusListener;
  }
