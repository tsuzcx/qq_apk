...
public class NowEntry
{
  ...
  private DynamicNowManager.OnOpenCloseRoomCallback jdField_a_of_type_ComTencentMobileqqIntervideoNowDynamicDynamicNowManager$OnOpenCloseRoomCallback;
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqIntervideoNowDynamicDynamicNowManager$OnOpenCloseRoomCallback = paramOnOpenCloseRoomCallback;
    ...
    if ((l - this.jdField_a_of_type_Long < 1000L) && (!NowProxyParamParser.f(paramBundle).equals("1")))
    {
      ...
      QQToast.a(BaseApplicationImpl.getContext(), HardCodeUtil.a(2131707644), 0).a();
      return;
    }
    this.jdField_a_of_type_Long = l;
    QLog.i("DynamicNow | NowEntry", 1, "开始进入now结合版,time = " + System.currentTimeMillis() + " mqqScheme = " + paramOnOpenCloseRoomCallback);
