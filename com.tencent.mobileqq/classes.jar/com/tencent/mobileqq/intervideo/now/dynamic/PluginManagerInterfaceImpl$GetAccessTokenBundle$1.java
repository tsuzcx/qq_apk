...
{
  PluginManagerInterfaceImpl$GetAccessTokenBundle$1(PluginManagerInterfaceImpl.GetAccessTokenBundle paramGetAccessTokenBundle, LoginKeyHelper paramLoginKeyHelper, Bundle[] paramArrayOfBundle, CountDownLatch paramCountDownLatch) {}
  ...
  public void onGetKeyComplete(String paramString, boolean paramBoolean, int paramInt)
  {
    if (paramBoolean)
    {
      ...
      paramString.putString("authid", this.jdField_a_of_type_ComTencentMobileqqIntervideoLoginKeyHelper.a().b);
      paramString.putString("authKey", this.jdField_a_of_type_ComTencentMobileqqIntervideoLoginKeyHelper.a().jdField_a_of_type_JavaLangString);
      paramString.putLong("accountUpdateTime", this.jdField_a_of_type_ComTencentMobileqqIntervideoLoginKeyHelper.a().jdField_a_of_type_Long);
      paramString.putString("payToken", this.jdField_a_of_type_ComTencentMobileqqIntervideoLoginKeyHelper.a().c);
