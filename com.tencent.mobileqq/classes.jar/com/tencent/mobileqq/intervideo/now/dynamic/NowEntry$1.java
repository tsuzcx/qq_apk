  ...
  implements URLDrawable.URLDrawableListener
{
  ...
  public void onLoadCanceled(URLDrawable paramURLDrawable)
  {
    ...
    if (!this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())
    {
      ...
      NowEntry.a(this.jdField_a_of_type_ComTencentMobileqqIntervideoNowDynamicNowEntry, this.jdField_a_of_type_AndroidOsBundle);
    }
  }
  ...
  public void onLoadFialed(URLDrawable paramURLDrawable, Throwable paramThrowable)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqIntervideoNowDynamicNowEntry.a.b("download_cover").c("1").d(paramThrowable.getMessage()).i(String.valueOf(l1 - l2)).b();
    if (!this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())
    {
      this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(true);
      NowEntry.a(this.jdField_a_of_type_ComTencentMobileqqIntervideoNowDynamicNowEntry, this.jdField_a_of_type_AndroidOsBundle);
