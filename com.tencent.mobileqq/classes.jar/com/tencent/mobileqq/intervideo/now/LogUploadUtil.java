...
public class LogUploadUtil
{
  ...
  static void a(String paramString1, String paramString2)
  {
    ...
    //   10: ifnonnull +4 -> 14
    //   13: return
    //   14: new 44	java/io/File
    //   17: dup
    //   18: aload_0
    //   19: invokespecial 66	java/io/File:<init>	(Ljava/lang/String;)V
    //   22: astore 5
    //   24: new 44	java/io/File
    //   27: dup
    //   28: aload_1
    //   29: invokespecial 66	java/io/File:<init>	(Ljava/lang/String;)V
    //   32: astore_1
    //   33: aload 5
    //   35: invokevirtual 69	java/io/File:exists	()Z
    //   38: ifne +33 -> 71
    //   41: new 71	java/io/FileNotFoundException
    //   44: dup
    ...
    //   56: ldc 72
    //   58: invokestatic 77	com/tencent/mobileqq/app/HardCodeUtil:a	(I)Ljava/lang/String;
    ...
    //   67: invokespecial 78	java/io/FileNotFoundException:<init>	(Ljava/lang/String;)V
    //   70: athrow
    //   71: new 80	java/io/FileOutputStream
    //   74: dup
    //   75: aload_1
    //   76: invokespecial 83	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   79: astore_2
    //   80: new 85	java/util/zip/ZipOutputStream
    //   83: dup
    //   84: new 87	java/util/zip/CheckedOutputStream
    //   87: dup
    //   88: aload_2
    //   89: new 89	java/util/zip/CRC32
    //   92: dup
    //   93: invokespecial 90	java/util/zip/CRC32:<init>	()V
    //   96: invokespecial 93	java/util/zip/CheckedOutputStream:<init>	(Ljava/io/OutputStream;Ljava/util/zip/Checksum;)V
    //   99: invokespecial 96	java/util/zip/ZipOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   102: astore_1
    //   103: aload 5
    //   105: aload_1
    //   106: ldc 98
    //   108: invokestatic 100	com/tencent/mobileqq/intervideo/now/LogUploadUtil:a	(Ljava/io/File;Ljava/util/zip/ZipOutputStream;Ljava/lang/String;)V
    //   111: aload_1
    //   112: ifnull +59 -> 171
    //   115: aload_1
    //   116: invokevirtual 103	java/util/zip/ZipOutputStream:close	()V
    //   119: aload 4
    //   121: astore_0
    //   122: aload_0
    //   123: ifnull -110 -> 13
    //   126: aload_0
    //   127: invokevirtual 104	java/io/FileOutputStream:close	()V
    //   130: return
    //   131: astore_0
    //   132: aconst_null
    //   133: astore_1
    ...
    //   137: ifnull +29 -> 166
    //   140: aload_1
    //   141: invokevirtual 103	java/util/zip/ZipOutputStream:close	()V
    //   144: aload_3
    //   145: astore_1
    //   146: aload_1
    //   147: ifnull +7 -> 154
    //   150: aload_1
    //   151: invokevirtual 104	java/io/FileOutputStream:close	()V
    //   154: aload_0
    //   155: athrow
    //   156: astore_0
    //   157: aconst_null
