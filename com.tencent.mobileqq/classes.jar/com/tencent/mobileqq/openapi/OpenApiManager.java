...
public class OpenApiManager
{
  ...
  private ajmm mMsgObserver = new atlo(this);
  private final Queue<atma> mPayMsgRspQueue = new LinkedList();
  private View mPttHolderView;
  private aclm mPttTransferCallback;
  private ConcurrentHashMap<Long, String> mSendingMsgMap = new ConcurrentHashMap();
  private ConcurrentHashMap<String, atls> mThirdAppMap = new ConcurrentHashMap();
  ...
  private void checkDownloadPtt(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    if ((paramMessageRecord != null) && ((paramMessageRecord instanceof MessageForPtt)))
    {
      ...
      i = adlr.a(paramQQAppInterface, localMessageForPtt);
      if (i != -1) {
        break label46;
      }
      aael.a(paramQQAppInterface, paramMessageRecord.frienduin, localMessageForPtt, true, 3, 0, true);
    }
    label46:
    while ((!paramBoolean) || ((i != 2005) && (i != 2004))) {
      return;
    }
    aael.a(paramQQAppInterface, paramMessageRecord.frienduin, localMessageForPtt, true, 2, 0, false);
  }
  ...
  private boolean checkNeedPayAuth(atma paramatma)
  {
    if ((paramatma == null) || (paramatma.jdField_a_of_type_Int != 3)) {}
    for (;;)
    {
      return false;
      try
      {
        int i = new JSONObject(paramatma.jdField_a_of_type_JavaLangString).optInt("retcode");
        if (i != 10001) {
          continue;
        }
        try
        {
          paramatma = this.mLoginSucApp;
          Object localObject = new JSONObject();
          ((JSONObject)localObject).put("userId", paramatma.getCurrentAccountUin());
          ...
          localObject = new Intent(paramatma.getApplication(), PayBridgeActivity.class);
          ((Intent)localObject).putExtras(localBundle);
          ((Intent)localObject).addFlags(268435456);
          ((Intent)localObject).putExtra("pay_requestcode", 5);
          paramatma.getApplication().startActivity((Intent)localObject);
          return true;
        }
        catch (Exception paramatma)
        {
          for (;;)
          {
            if (QLog.isDevelopLevel()) {
              paramatma.printStackTrace();
            }
          }
        }
        return false;
      }
      catch (JSONException paramatma) {}
    }
  }
  ...
  private atlx copyMsgFromMessageRecord(MessageRecord paramMessageRecord, String paramString, int paramInt)
  {
    return null;
  }
  ...
  private void resetFilters()
  {
    ...
    {
      atls localatls = (atls)localIterator.next();
      j |= localatls.a();
      i = localatls.b() | i;
    }
  ...
  private void setupPttTransferCallback()
  {
    ...
    this.mPttTransferCallback = new atlp(this);
    aclk.a(this.mLoginSucApp).a(this.mPttHolderView, this.mPttTransferCallback);
  }
  ...
  public Pair<Integer, Integer> decodePtt(String paramString1, String paramString2, String paramString3, int paramInt, String paramString4, String paramString5, String paramString6)
  {
    ...
    //   63: areturn
    //   64: aload 15
    //   66: getfield 348	atls:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   69: aload_2
    ...
    //   93: aload 15
    //   95: sipush 256
    //   98: invokevirtual 357	atls:a	(I)Z
    //   101: ifne +20 -> 121
    ...
    //   121: aload 15
    //   123: aload_3
    //   124: invokevirtual 360	atls:b	(Ljava/lang/String;)Ljava/lang/String;
    //   127: astore_1
    //   128: aload 15
    //   130: aload 5
    //   132: invokevirtual 360	atls:b	(Ljava/lang/String;)Ljava/lang/String;
    //   135: astore_2
    //   136: lconst_0
    //   137: lstore 13
    //   139: aload_2
    ...
    //   217: aload 6
    //   219: getstatic 382	ajed:aT	Ljava/lang/String;
    //   222: invokevirtual 386	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   225: ifne +31 -> 256
    //   228: aload 7
    //   230: getstatic 382	ajed:aT	Ljava/lang/String;
    ...
    //   255: areturn
    //   256: aload 6
    //   258: invokestatic 390	bace:a	(Ljava/lang/String;)Z
    //   261: ifne +20 -> 281
    ...
    //   304: astore_1
    //   305: aload_1
    //   306: invokestatic 398	bahn:a	(Ljava/io/InputStream;)B
    //   309: istore 8
    //   311: iload 8
    //   313: ifge +57 -> 370
    ...
    //   369: areturn
    //   370: aload 7
    //   372: invokestatic 407	bace:a	(Ljava/lang/String;)Ljava/io/File;
    //   375: pop
    ...
    //   385: astore_3
    //   386: iload 8
    //   388: invokestatic 413	bahn:a	(B)I
    //   391: istore 4
    //   393: iload 4
    //   395: invokestatic 416	bahn:a	(I)I
    //   398: istore 9
    //   400: iload 9
    //   402: newarray byte
    //   404: astore 6
    ...
    //   493: areturn
    //   494: aload 5
    //   496: invokestatic 437	bahn:a	([B)I
    //   499: istore 10
    //   501: iload 10
    //   503: ifgt +55 -> 558
  ...
  public Pair<Integer, Integer> downloadMedia(String paramString1, String paramString2, String paramString3, int paramInt, String paramString4)
  {
    ...
    paramString1 = (atls)this.mThirdAppMap.get(paramString1);
    ...
    try
    {
      ...
      if (paramInt == 1)
      {
        paramString1 = ((ajjj)localQQAppInterface.getManager(51)).e(paramString2);
    ...
    {
      paramString1 = localQQAppInterface.a().b(paramString2, atmb.c(paramInt), l);
      ...
      return new Pair(Integer.valueOf(0), Integer.valueOf(atmb.a(localQQAppInterface, (MessageForPtt)paramString1)));
    }
    return new Pair(Integer.valueOf(-5), Integer.valueOf(0));
  }
  
  public atma[] exchangeUins(String paramString1, String paramString2, long paramLong1, long paramLong2, String[] paramArrayOfString)
  {
    paramString2 = new atma[1];
    paramString2[0] = new atma(0, null);
    paramString1 = atlq.a(BaseApplicationImpl.sApplication, paramString1);
    ...
    paramString1 = new atls(paramString1);
    if (!paramString1.a(4))
    {
      paramString2[0].jdField_b_of_type_Int = -4;
      return paramString2;
    }
    paramString2 = new atma[paramArrayOfString.length];
    int i = 0;
    for (;;)
    {
      if (i < paramArrayOfString.length)
      {
        paramString2[i] = new atma(0, null);
        try
        {
  ...
  public atma getAvatarPath(String paramString1, String paramString2, String paramString3, int paramInt)
  {
    QQAppInterface localQQAppInterface = this.mLoginSucApp;
    if (localQQAppInterface == null) {
      return new atma(-1, null);
    }
    paramString1 = (atls)this.mThirdAppMap.get(paramString1);
    if (paramString1 == null) {
      return new atma(-2, null);
    }
    if (!paramString1.jdField_b_of_type_JavaLangString.equals(paramString2)) {
      return new atma(-7, null);
    }
    if (!paramString1.a(4)) {
      return new atma(-4, null);
    }
    paramString1 = paramString1.b(paramString3);
    if (TextUtils.isEmpty(paramString1)) {
      return new atma(-6, null);
    }
    int i = 1;
    if (paramInt == 2) {
      i = 101;
    ...
    for (;;)
    {
      return new atma(0, localQQAppInterface.a(i, paramString1, 0));
      if (paramInt == 4) {
        i = 4;
      }
    }
  ...
  public int getLastMessages(List<atlx> paramList, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2)
  {
    QQAppInterface localQQAppInterface = this.mLoginSucApp;
    if (localQQAppInterface == null) {
      return -1;
    ...
    atls localatls = (atls)this.mThirdAppMap.get(paramString1);
    if (localatls == null) {
      return -2;
    }
    if (!localatls.jdField_b_of_type_JavaLangString.equals(paramString2)) {
      return -7;
    }
    paramString1 = localatls.b(paramString3);
    if (TextUtils.isEmpty(paramString1)) {
      return -6;
    }
    if (!localatls.a(2)) {
    ...
    List localList = localQQAppInterface.a().a(paramString1, atmb.c(paramInt1), paramInt2);
    akbm.a(paramString1, atmb.c(paramInt1), localList, localQQAppInterface);
    paramInt2 = 0;
    if (paramInt2 < localList.size())
    {
      ...
      int i = atmb.a(localMessageRecord.msgtype);
      String str2 = localatls.a(String.valueOf(localMessageRecord.uniseq));
      paramString1 = null;
      paramString2 = null;
      int j = 1007;
      if ((i == 1) && (localatls.a(paramInt1, 1)))
      {
        paramString1 = new axkd(localMessageRecord.msg, 3).a();
        label269:
        if (paramInt1 != 1) {
          break label545;
        }
      ...
      label545:
      for (String str1 = "";; str1 = localatls.a(localMessageRecord.senderuin))
      {
        paramList.add(new atlx(paramString3, paramInt1, str1, i, str2, localMessageRecord.time, localMessageRecord.isSend(), paramString1, paramString2, j));
        break;
        if ((i == 2) && ((localMessageRecord instanceof MessageForPtt)) && (localatls.a(paramInt1, 2)))
        {
          ...
          j = atmb.a(localQQAppInterface, (MessageForPtt)localMessageRecord);
          break label269;
        }
        if ((i == 4) && (localatls.a(paramInt1, 4)))
        {
          paramString1 = new axkd(localMessageRecord.msg, 3).a();
          break label269;
        }
        if ((i == 8) && (localatls.a(paramInt1, 8)))
        {
          paramString1 = atlx.jdField_b_of_type_JavaLangString;
          break label269;
        }
        if ((i == 16) && (localatls.a(paramInt1, 16)))
        {
          paramString1 = atlx.c;
          break label269;
        }
        if ((i == 32) && (localatls.a(paramInt1, 32)))
        {
          paramString1 = atlx.d;
          break label269;
        }
        if ((i == 64) && (localatls.a(paramInt1, 64)))
        {
          paramString1 = atlx.e;
          break label269;
        }
        if (!localatls.a(paramInt1, 1073741824)) {
          break;
        }
        i = 1073741824;
        paramString1 = atlx.f;
  ...
  public atma getNickName(String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    if (!atlw.a(paramInt)) {
      return new atma(-5, null);
    }
    paramString1 = paramString1.b(paramString3);
    if (TextUtils.isEmpty(paramString1)) {
      return new atma(-6, null);
    }
    paramInt = atmb.c(paramInt);
    return new atma(0, babh.a(this.mLoginSucApp, paramString1, paramInt));
  }
  
  public List<atma> handlePayMsgReq(String paramString1, String paramString2, String paramString3, int paramInt, String paramString4)
  {
    QQAppInterface localQQAppInterface = this.mLoginSucApp;
    if (localQQAppInterface == null) {
      return handlePayMsgRsp(new atma(paramInt, -1, paramString4));
    }
    if ((TextUtils.isEmpty(paramString3)) || (TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2))) {
      return handlePayMsgRsp(new atma(paramInt, -6, paramString4));
    }
    paramString1 = atlq.a(BaseApplicationImpl.sApplication, paramString1);
    if (paramString1 == null) {
      return handlePayMsgRsp(new atma(paramInt, -8, paramString4));
    }
    if (!paramString1.jdField_b_of_type_JavaLangString.equals(paramString2)) {
      return handlePayMsgRsp(new atma(paramInt, -7, paramString4));
    }
    if (!atlq.a(BaseApplicationImpl.sApplication, paramString2, paramString1.c)) {
      return handlePayMsgRsp(new atma(paramInt, -7, paramString4));
    }
  ...
  public List<atma> handlePayMsgRsp(atma paramatma)
  {
  ...
  public void onFileTransStatusChanged(axqf paramaxqf, int paramInt1, int paramInt2)
  {
    if (paramaxqf.jdField_b_of_type_Int != 2) {}
    label641:
    label647:
    for (;;)
    {
      ...
      if ((paramInt1 != 2002) && (paramInt1 != 1002) && (paramInt1 != 2001) && (this.mThirdAppMap.size() != 0) && (isSDKEnable()))
      {
        Object localObject1;
        Object localObject2;
        if ((this.mSendingMsgMap.contains(Long.valueOf(paramaxqf.jdField_b_of_type_Long))) && ((paramInt1 == 1004) || (paramInt1 == 1005) || (paramInt1 == 1003)))
        {
          localObject1 = (String)this.mSendingMsgMap.remove(Long.valueOf(paramaxqf.jdField_b_of_type_Long));
          localObject1 = (atls)this.mThirdAppMap.get(localObject1);
          if (QLog.isColorLevel()) {
            QLog.d("OpenApi.Manager", 2, "onPttStateChange, thirdApp = " + localObject1 + ", status = " + paramInt1);
          }
          if (localObject1 != null)
          {
            localObject2 = new Intent("com.tencent.mobileqq.openapi.ACTION_MSG_SENDED." + ((atls)localObject1).jdField_b_of_type_JavaLangString);
            ((Intent)localObject2).putExtra("msgid", ((atls)localObject1).a(String.valueOf(paramaxqf.jdField_b_of_type_Long)));
            if (paramInt1 != 1003) {
              break label595;
            }
            paramInt2 = 0;
            ...
            BaseApplicationImpl.sApplication.sendBroadcast((Intent)localObject2, ((atls)localObject1).c);
          }
        }
        int i;
        if (paramaxqf.h == 0)
        ...
        for (;;)
        {
          ...
          String str = paramaxqf.q;
          localObject1 = this.mLoginSucApp;
          if (paramaxqf.jdField_a_of_type_Int == 0) {}
          for (boolean bool = true;; bool = false)
          {
            paramInt1 = atmb.a((QQAppInterface)localObject1, paramInt1, bool);
            if (QLog.isColorLevel()) {
            ...
            while (localIterator.hasNext())
            {
              ...
              if ((paramInt1 == 1003) && (this.mLoginSucApp != null))
              {
                ...
                if (localObject2 != null)
                {
                  localObject2 = ((QQMessageFacade)localObject2).b(str, paramInt2, paramaxqf.jdField_b_of_type_Long);
                  if (localObject2 != null) {
              ...
              if (localatls.b(i, 2))
              {
                ((Intent)localObject1).putExtra("msgid", localatls.a(String.valueOf(paramaxqf.jdField_b_of_type_Long)));
                ((Intent)localObject1).setAction("com.tencent.mobileqq.openapi.ACTION_MSG_STATUS_UPDATE." + localatls.jdField_b_of_type_JavaLangString);
                BaseApplicationImpl.sApplication.sendBroadcast((Intent)localObject1, localatls.c);
                localObject2 = localObject1;
              }
            }
            break;
    ...
    for (;;)
    {
      ...
      if ((paramInt == 0) || (paramInt == 3000) || (paramInt == 1))
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          localObject1 = localObject2;
          if (localatls.c(paramInt))
          {
            ((Intent)localObject2).putExtra("uin", localatls.a(paramString));
            ((Intent)localObject2).setAction("com.tencent.mobileqq.openapi.ACTION_MSG_READED." + localatls.jdField_b_of_type_JavaLangString);
            BaseApplicationImpl.sApplication.sendBroadcast((Intent)localObject2, localatls.c);
            localObject1 = localObject2;
          }
        }
      }
  ...
  public final void onPayMsgRsp(atma paramatma)
  {
    if (checkNeedPayAuth(paramatma)) {}
    for (;;)
    {
      return;
      synchronized (this.mPayMsgRspQueue)
      {
        ...
        {
          this.mPayMsgRspQueue.add(paramatma);
          if ((this.mLoginSucApp == null) || (!isSDKEnable())) {
            break;
          }
          paramatma = new Intent();
          paramatma.setAction("com.tencent.mobileqq.openapi.ACTION_PAYMSG_RCV." + this.mLastGetPayCodePkgName);
          BaseApplicationImpl.sApplication.sendBroadcast(paramatma, this.mLastGetPayCodePermission);
          return;
        }
  ...
  public void onReceiveNewMsg(QQMessageFacade.Message paramMessage)
  {
    ...
    do
    {
      ...
      k = atmb.a(paramMessage.msgtype);
      m = atmb.b(paramMessage.istroop);
    ...
    if (QLog.isColorLevel()) {
      QLog.d("OpenApi.Manager", 2, "new msg, uin = " + baip.e(str1));
    }
    Object localObject1 = null;
    Iterator localIterator = this.mThirdAppMap.values().iterator();
    label188:
    ...
    if (localIterator.hasNext())
    {
      ...
      boolean bool = localatls.b(m, k);
      if ((!bool) && (!localatls.b(m))) {
        break label415;
      }
      if (!bool) {
        break label410;
      ...
      ((Intent)localObject2).putExtra("uin", localatls.a(str1));
      ((Intent)localObject2).putExtra("senderUin", localatls.a(str2));
      ((Intent)localObject2).setAction("com.tencent.mobileqq.openapi.ACTION_NEW_MSG." + localatls.jdField_b_of_type_JavaLangString);
      BaseApplicationImpl.sApplication.sendBroadcast((Intent)localObject2, localatls.c);
  ...
  public int openAIO(String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    if (paramInt == 1)
    {
      paramString2 = ((ajjj)localQQAppInterface.getManager(51)).e(paramString1);
      if ((paramString2 == null) || (!paramString2.isFriend())) {
        return -11;
      }
      paramString3 = aciy.a(new Intent(BaseApplicationImpl.sApplication, SplashActivity.class), new int[] { 2 });
      ...
      paramString3.putExtra("uinname", babh.a(paramString2));
      if ((mqb.a(paramString2.cSpecialFlag)) || (bcpn.b(paramString2.cSpecialFlag)))
      {
  ...
  public atlz registerThirdApp(String paramString1, String paramString2, long paramLong, int paramInt1, int paramInt2, String paramString3)
  {
    QQAppInterface localQQAppInterface = this.mLoginSucApp;
    if (localQQAppInterface == null) {
      return new atlz(-1, 0L, null);
    }
    Object localObject = (atls)this.mThirdAppMap.get(paramString1);
    if (localObject == null)
    {
      localObject = atlq.a(BaseApplicationImpl.sApplication, paramString1);
      if (localObject == null) {
        return new atlz(-8, 0L, null);
      }
      if (!((atlr)localObject).jdField_b_of_type_JavaLangString.equals(paramString2)) {
        return new atlz(-7, 0L, null);
      }
      if (!atlq.a(BaseApplicationImpl.sApplication, paramString2, ((atlr)localObject).c)) {
        return new atlz(-7, 0L, null);
      }
      if ((((atlr)localObject).jdField_b_of_type_Boolean) && (paramLong != ((atlr)localObject).d)) {
        return new atlz(-18, ((atlr)localObject).d, null);
      }
      if ((!((atlr)localObject).jdField_b_of_type_Boolean) && (paramLong != ((atlr)localObject).jdField_b_of_type_Long)) {
        return new atlz(-18, ((atlr)localObject).jdField_b_of_type_Long, null);
      }
      if (((atlr)localObject).jdField_b_of_type_Boolean) {
        atlq.a(BaseApplicationImpl.sApplication, (atlr)localObject);
      }
      paramString2 = new atls((atlr)localObject);
    ...
    while (paramLong != paramString3.a)
    {
      ...
      resetFilters();
      return new atlz(-18, paramString3.a, null);
      paramString3 = (String)localObject;
      if (!((atls)localObject).jdField_b_of_type_JavaLangString.equals(paramString2)) {
        return new atlz(-7, 0L, null);
      }
    }
    paramString3.a(paramInt1, paramInt2);
    resetFilters();
    return new atlz(0, 0L, paramString3.a(localQQAppInterface.getCurrentAccountUin()));
  }
  
  public atma sendMessage(String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, String paramString4, String paramString5)
  {
    QQAppInterface localQQAppInterface = this.mLoginSucApp;
    if (localQQAppInterface == null) {
      return new atma(-1, null);
    ...
    paramString3 = localatls.b(paramString3);
    ...
    if (paramInt1 == 1)
    {
      paramString2 = ((ajjj)localQQAppInterface.getManager(51)).e(paramString3);
      if ((paramString2 == null) || (!paramString2.isFriend())) {
        return new atma(-11, null);
      }
      ...
      paramString2.d = babh.m(localQQAppInterface, paramString3);
      if (paramInt2 == 1)
      {
        if (TextUtils.isEmpty(paramString4)) {
          return new atma(-6, null);
        }
        paramString2 = aael.a(localQQAppInterface, localQQAppInterface.getApp(), paramString2, paramString4, null, new aaes());
        if ((paramString2 == null) || (paramString2.length == 0)) {
          return new atma(-9, null);
        }
      ...
      for (;;)
      {
        ...
        return new atma(0, localatls.a(String.valueOf(l1)));
        if (paramInt2 == 2)
        {
          ...
          if (!baeh.a(paramString5, atlv.a)) {
            return new atma(-13, null);
          }
          paramString3 = MessageForPtt.getLocalFilePath(2, axoy.a(localQQAppInterface.getCurrentAccountUin(), null, 2, null));
          bace.d(paramString5, paramString3);
          paramString4 = aael.a(localQQAppInterface, paramString3, paramString2, -3, 0);
          ...
          aael.a(localQQAppInterface, paramString2.jdField_a_of_type_Int, paramString2.jdField_a_of_type_JavaLangString, paramString3, l1, true, (int)(1000L * l2), 0, true, 0, 0, true, paramString4.vipSubBubbleId, paramString5);
        }
      }
    }
    return new atma(-5, null);
  ...
  public int setMessageReaded(String paramString1, String paramString2, String paramString3, int paramInt, String paramString4)
  {
    ...
    paramString1 = localatls.b(paramString3);
    paramString2 = localatls.b(paramString4);
    long l2 = 0L;
    try
    {
  ...
  public int unregisterThirdApp(String paramString1, String paramString2)
  {
    ...
    atls localatls = (atls)this.mThirdAppMap.get(paramString1);
    if ((localatls != null) && (!localatls.jdField_b_of_type_JavaLangString.equals(paramString2))) {
      return -7;
    }
    this.mThirdAppMap.remove(paramString1);
    return 0;
