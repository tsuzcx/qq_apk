  ...
  extends ContentProvider
{
  ...
  {
    MatrixCursor localMatrixCursor = new MatrixCursor(atlu.a);
  ...
  public Cursor query(Uri paramUri, String[] paramArrayOfString1, String paramString1, String[] paramArrayOfString2, String paramString2)
  {
    ...
    case 1: 
      ...
      if (QLog.isColorLevel())
      {
        ...
        paramString1.append("query face, uin = ").append(baip.e(paramArrayOfString1));
      ...
      paramArrayOfString1 = new MatrixCursor(atlu.c);
    ...
    if (QLog.isColorLevel())
    {
      ...
      paramString1.append("query msg, uin = ").append(baip.e(paramArrayOfString1));
      paramString1.append(", type = ").append(i);
    ...
    paramArrayOfString1 = new MatrixCursor(atlu.b);
    paramUri = paramUri.iterator();
    while (paramUri.hasNext()) {
      paramArrayOfString1.addRow(((atlx)paramUri.next()).a());
    }
    return paramArrayOfString1;
    paramArrayOfString1 = paramUri.getQueryParameter("uin");
    try
    ...
    {
      paramString1 = new StringBuilder(150);
      paramString1.append("query nick, uin = ").append(baip.e(paramArrayOfString1));
      paramString1.append(", type = ").append(i);
      paramString1.append(", rs = ").append(paramUri.b);
      QLog.d("OpenApi.Provider", 2, paramString1.toString());
    }
    ...
    paramArrayOfString1 = new MatrixCursor(atlu.d);
    paramArrayOfString1.addRow(new Object[] { paramUri.jdField_a_of_type_JavaLangString });
    return paramArrayOfString1;
    i = 0;
    int j = 0;
    ...
    for (;;)
    {
      ...
      paramArrayOfString1 = new MatrixCursor(atlu.e);
      ...
      return paramArrayOfString1;
      paramUri = new atlz(paramString1.unregisterThirdApp(paramString2, str1), 0L, null);
    }
    paramArrayOfString1 = paramUri.getQueryParameter("uin");
    try
    {
    ...
    paramArrayOfString1 = new MatrixCursor(atlu.f);
    paramArrayOfString1.addRow(new Object[] { paramUri.jdField_a_of_type_JavaLangString });
    return paramArrayOfString1;
    paramArrayOfString1 = paramUri.getQueryParameter("uin");
    ...
    if (QLog.isColorLevel())
    {
      ...
      paramUri.append("set readed, uin = ").append(baip.e(paramArrayOfString1));
    ...
    paramUri = new MatrixCursor(atlu.a);
    ...
    try
    {
      ...
      paramUri = new MatrixCursor(atlu.h);
    ...
    catch (Exception paramArrayOfString2)
    {
      ...
      paramArrayOfString1 = new MatrixCursor(atlu.i);
    ...
    catch (Exception paramUri)
    {
      ...
      paramArrayOfString1 = new MatrixCursor(atlu.j);
    ...
    catch (Exception paramUri)
    {
      ...
      paramArrayOfString1 = new MatrixCursor(atlu.k);
    ...
    {
      paramArrayOfString1 = new MatrixCursor(atlu.l);
      paramUri = paramUri.iterator();
      for (;;)
      {
        if (paramUri.hasNext())
        {
          paramString1 = (atma)paramUri.next();
