  ...
  extends ContentProvider
{
  ...
  {
    MatrixCursor localMatrixCursor = new MatrixCursor(awbb.a);
  ...
  public Cursor query(Uri paramUri, String[] paramArrayOfString1, String paramString1, String[] paramArrayOfString2, String paramString2)
  {
    ...
    case 1: 
      ...
      if (QLog.isColorLevel())
      {
        ...
        paramString1.append("query face, uin = ").append(bdje.e(paramArrayOfString1));
      ...
      paramArrayOfString1 = new MatrixCursor(awbb.c);
    ...
    if (QLog.isColorLevel())
    {
      ...
      paramString1.append("query msg, uin = ").append(bdje.e(paramArrayOfString1));
      paramString1.append(", type = ").append(i);
    ...
    paramArrayOfString1 = new MatrixCursor(awbb.b);
    paramUri = paramUri.iterator();
    while (paramUri.hasNext()) {
      paramArrayOfString1.addRow(((awbe)paramUri.next()).a());
    }
    return paramArrayOfString1;
    paramArrayOfString1 = paramUri.getQueryParameter("uin");
    try
    ...
    {
      paramString1 = new StringBuilder(150);
      paramString1.append("query nick, uin = ").append(bdje.e(paramArrayOfString1));
      paramString1.append(", type = ").append(i);
      paramString1.append(", rs = ").append(paramUri.b);
      QLog.d("OpenApi.Provider", 2, paramString1.toString());
    }
    ...
    paramArrayOfString1 = new MatrixCursor(awbb.d);
    paramArrayOfString1.addRow(new Object[] { paramUri.jdField_a_of_type_JavaLangString });
    return paramArrayOfString1;
    i = 0;
    int j = 0;
    ...
    for (;;)
    {
      ...
      paramArrayOfString1 = new MatrixCursor(awbb.e);
      ...
      return paramArrayOfString1;
      paramUri = new awbg(paramString1.unregisterThirdApp(paramString2, str1), 0L, null);
    }
    paramArrayOfString1 = paramUri.getQueryParameter("uin");
    try
    {
    ...
    paramArrayOfString1 = new MatrixCursor(awbb.f);
    paramArrayOfString1.addRow(new Object[] { paramUri.jdField_a_of_type_JavaLangString });
    return paramArrayOfString1;
    paramArrayOfString1 = paramUri.getQueryParameter("uin");
    ...
    if (QLog.isColorLevel())
    {
      ...
      paramUri.append("set readed, uin = ").append(bdje.e(paramArrayOfString1));
    ...
    paramUri = new MatrixCursor(awbb.a);
    ...
    try
    {
      ...
      paramUri = new MatrixCursor(awbb.h);
    ...
    catch (Exception paramArrayOfString2)
    {
      ...
      paramArrayOfString1 = new MatrixCursor(awbb.i);
    ...
    catch (Exception paramUri)
    {
      ...
      paramArrayOfString1 = new MatrixCursor(awbb.j);
    ...
    catch (Exception paramUri)
    {
      ...
      paramArrayOfString1 = new MatrixCursor(awbb.k);
    ...
    {
      paramArrayOfString1 = new MatrixCursor(awbb.l);
      paramUri = paramUri.iterator();
      for (;;)
      {
        if (paramUri.hasNext())
        {
          paramString1 = (awbh)paramUri.next();
