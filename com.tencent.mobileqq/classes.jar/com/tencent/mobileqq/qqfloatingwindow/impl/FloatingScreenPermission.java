...
public class FloatingScreenPermission
{
  ...
  public static boolean checkOpForVivo(Context paramContext)
  {
    ...
    //   57: aconst_null
    //   58: aconst_null
    //   59: invokevirtual 165	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   62: astore 5
    //   64: aload 5
    //   66: ifnull +97 -> 163
    //   69: aload 5
    ...
    //   165: astore 4
    //   167: aload_0
    //   168: invokestatic 191	com/tencent/mobileqq/qqfloatingwindow/impl/FloatingScreenPermission:checkOpForCommon	(Landroid/content/Context;)Z
    //   171: istore_2
    //   172: aload 5
    //   174: astore 4
    //   176: ldc 11
    ...
    //   229: astore 4
    //   231: aload_0
    //   232: invokestatic 191	com/tencent/mobileqq/qqfloatingwindow/impl/FloatingScreenPermission:checkOpForCommon	(Landroid/content/Context;)Z
    //   235: istore_2
    //   236: iload_2
    //   237: istore_3
    //   238: aload 5
  ...
  public static void enterPermissionRequestDialog(Context paramContext)
  {
    ...
    DialogUtil.a(paramContext, 230, paramContext.getString(2131699663), paramContext.getString(2131699661), paramContext.getString(2131699660), paramContext.getString(2131699662), new FloatingScreenPermission.1(paramContext), null).show();
  }
  ...
  public static void enterPermissionRequestDialogCustom(Context paramContext, int paramInt1, int paramInt2)
  {
    ...
    FloatingScreenReporter.b();
    DialogUtil.a(paramContext, 230, paramContext.getString(paramInt1), paramContext.getString(paramInt2), paramContext.getString(2131699660), paramContext.getString(2131699662), new FloatingScreenPermission.2(paramContext), null).show();
  }
  ...
  private static boolean handleVivoPermissionDialog(Context paramContext)
  {
    if (canUseCheckOpForVivo())
    {
      DialogUtil.a(paramContext, 230, paramContext.getString(2131699663), paramContext.getString(2131699672), paramContext.getString(2131699660), paramContext.getString(2131694699), new FloatingScreenPermission.3(paramContext), null).show();
      return true;
    }
    return false;
  }
