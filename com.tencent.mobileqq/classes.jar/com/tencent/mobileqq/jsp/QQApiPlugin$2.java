...
public class QQApiPlugin$2
  implements Runnable
{
  public QQApiPlugin$2(awhh paramawhh, String paramString1, Activity paramActivity, String paramString2, String paramString3, String paramString4, ApplicationInfo paramApplicationInfo) {}
  ...
  public void run()
  {
    ...
    if (bilw.a(this.jdField_a_of_type_AndroidAppActivity))
    {
      bilw.a(2).a(this.this$0.a(), this.b, this.c, this.d, "text", BitmapFactory.decodeFile(str));
      QLog.d("QQApi", 1, "shareMsgToSina use weibo sdk!");
    }
    for (;;)
    {
