  ...
  extends WebViewPlugin
{
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if (this.jdField_a_of_type_Auwm == null) {
      this.jdField_a_of_type_Auwm = new auwm(this, this.mRuntime.a(), (BaseActivity)this.mRuntime.a());
    }
    if ("startRecord".equals(paramString3)) {
      try
      {
        ...
        this.jdField_a_of_type_Auwm.a(i, j);
        return true;
      }
    ...
    {
      this.jdField_a_of_type_Auwm.b(0);
      return true;
    }
    if ("play".equals(paramString3)) {
      try
      {
        ...
        this.jdField_a_of_type_Auwm.b(paramJsBridgeListener);
        return true;
      }
      catch (JSONException paramJsBridgeListener)
      {
    ...
    if ("pause".equals(paramString3)) {
      try
      {
        ...
        this.jdField_a_of_type_Auwm.d(paramJsBridgeListener);
        return true;
      }
      catch (JSONException paramJsBridgeListener)
      {
    ...
    if ("stop".equals(paramString3)) {
      ...
      {
        paramJsBridgeListener = new JSONObject(paramVarArgs[0]).optString("recordID", "");
        this.jdField_a_of_type_Auwm.c(paramJsBridgeListener);
        return true;
      }
      catch (JSONException paramJsBridgeListener)
      {
    ...
    if ("upload".equals(paramString3)) {
      try
      {
        ...
        this.jdField_a_of_type_Auwm.a(paramJsBridgeListener, paramString1, paramString2);
        return true;
      }
      catch (JSONException paramJsBridgeListener)
      {
