...
{
  private atfv jdField_a_of_type_Atfv;
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if (this.jdField_a_of_type_Atfv == null) {
      this.jdField_a_of_type_Atfv = new atfv(this, this.mRuntime.a(), (BaseActivity)this.mRuntime.a());
    }
    if ("startRecord".equals(paramString3)) {
      try
      {
        ...
        this.jdField_a_of_type_Atfv.a(i, j);
        return true;
      }
    ...
    {
      this.jdField_a_of_type_Atfv.b(0);
      return true;
    }
    if ("play".equals(paramString3)) {
      try
      {
        ...
        this.jdField_a_of_type_Atfv.b(paramJsBridgeListener);
        return true;
      }
      catch (JSONException paramJsBridgeListener)
      {
    ...
    if ("pause".equals(paramString3)) {
      try
      {
        ...
        this.jdField_a_of_type_Atfv.d(paramJsBridgeListener);
        return true;
      }
      catch (JSONException paramJsBridgeListener)
      {
    ...
    if ("stop".equals(paramString3)) {
      ...
      {
        paramJsBridgeListener = new JSONObject(paramVarArgs[0]).optString("recordID", "");
        this.jdField_a_of_type_Atfv.c(paramJsBridgeListener);
        return true;
      }
      catch (JSONException paramJsBridgeListener)
      {
    ...
    if ("upload".equals(paramString3)) {
      try
      {
        ...
        this.jdField_a_of_type_Atfv.a(paramJsBridgeListener, paramString1, paramString2);
        return true;
      }
      catch (JSONException paramJsBridgeListener)
      {
