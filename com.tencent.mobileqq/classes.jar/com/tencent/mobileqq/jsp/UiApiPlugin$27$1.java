  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      bdla.b(null, "P_CliOper", "BizTechReport", "", "web", "jsapi_addShortcut_result", 0, 1, 0, "", "", "", "");
    }
    for (int i = 2131697583;; i = 2131697582)
    {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqJspUiApiPlugin$27.a, i, 0).b(this.jdField_a_of_type_ComTencentMobileqqJspUiApiPlugin$27.a.getResources().getDimensionPixelSize(2131299080));
      bdla.b(null, "P_CliOper", "BizTechReport", "", "web", "jsapi_addShortcut_dialog_click", 0, 1, 0, "", "", "", "");
      ...
      bdla.b(null, "P_CliOper", "BizTechReport", "", "web", "jsapi_addShortcut_result", 0, 1, -1, "", "", "", "");
    }
  }
}
