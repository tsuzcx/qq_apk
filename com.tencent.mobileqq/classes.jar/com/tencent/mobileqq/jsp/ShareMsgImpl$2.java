...
public class ShareMsgImpl$2
  implements Runnable
{
  public ShareMsgImpl$2(auun paramauun, String paramString1, Activity paramActivity, String paramString2, String paramString3, String paramString4, ApplicationInfo paramApplicationInfo) {}
  ...
  public void run()
  {
    ...
    if (bgsf.a(this.jdField_a_of_type_AndroidAppActivity))
    {
      bgsf.a(2).a((Activity)this.this$0.a, this.b, this.c, this.d, "text", BitmapFactory.decodeFile(str));
