  ...
  implements Manager
{
  ...
  DownloadListener jdField_a_of_type_ComTencentMobileqqVipDownloadListener = new VipFunCallManager.5(this, "param_WIFIColorRingDownloadFlow", "param_XGColorRingDownloadFlow");
  ...
  public VipFunCallManager(QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface = new File(AVPathUtil.g());
    ...
    for (;;)
    {
      try
      {
        ...
        FileUtils.a(AVPathUtil.g(), new StringBuffer("config.json"), localInputStream);
      }
  ...
  public static VipFullScreenVideoView a(Activity paramActivity, RelativeLayout paramRelativeLayout, boolean paramBoolean)
  {
    ...
    {
      return null;
      localView = LayoutInflater.from(BaseApplicationImpl.getApplication()).inflate(2131563210, null);
    ...
    return (VipFullScreenVideoView)localView.findViewById(2131381245);
  }
  ...
  public static String a(AppRuntime paramAppRuntime, int paramInt1, int paramInt2, String paramString)
  {
    ...
    paramString = AVPathUtil.g() + paramInt1 + File.separator;
  ...
  public static void a(AppRuntime paramAppRuntime, int paramInt, Bundle paramBundle, VipFunCallAndRing.TSourceInfo paramTSourceInfo, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        break;
        localObject1 = new File(AVPathUtil.g() + paramInt + File.separator);
  ...
  public static void a(AppRuntime paramAppRuntime, String paramString1, int paramInt1, String paramString2, int paramInt2)
  {
    ...
    ((DownloaderFactory)paramAppRuntime.getManager(QQManagerFactory.DOWNLOADER_FACTORY)).a(1).a(paramString1, null, paramString2);
  }
  
  public static boolean a()
  {
    return new File(VipFunCallConstants.jdField_a_of_type_JavaLangString).exists();
  }
  ...
  public static boolean a(Context paramContext, VideoView paramVideoView, String paramString, int paramInt1, VipFunCallMediaListener paramVipFunCallMediaListener, int paramInt2, boolean paramBoolean)
  {
    ...
    if ((paramContext.exists()) && (!paramVideoView.isPlaying()))
    {
      ...
      if (paramInt1 == 6)
      {
        paramVideoView.setOnTouchListener(new VipFunCallManager.1());
        paramVideoView.setVideoPath(paramContext.getAbsolutePath());
        paramVideoView.requestFocus();
        paramVideoView.setVisibility(0);
        paramVideoView.setOnPreparedListener(new VipFunCallManager.2(paramVipFunCallMediaListener));
        paramVideoView.setOnCompletionListener(new VipFunCallManager.3(paramVideoView));
        paramVideoView.setOnErrorListener(new VipFunCallManager.4(paramInt2, paramVipFunCallMediaListener, paramVideoView, paramBoolean));
        return true;
      }
      if (paramInt1 == 7)
      {
  ...
  public void a(int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3)
  {
    ...
    for (int i = 0;; i = paramInt2)
    {
      ...
      {
        ((DownloadTask)localObject).l = paramBoolean;
        if (7 != paramInt2) {
  ...
  public boolean a(int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3, IPCDownloadListener paramIPCDownloadListener)
  {
    ...
    if (paramInt2 != 0)
    {
      ColorRingManager localColorRingManager = (ColorRingManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.COLOR_RING_MANAGER);
