  ...
  extends BusinessHandler
{
  ...
  public void a(int paramInt, Object paramObject)
  {
    ...
    localTSsoReq.str_qq_ver.set("7.6.8");
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (((VipFunCallAndRing.TSsoReq)localObject2).i32_cmd.has())
        {
          ...
          QLog.e("VipSetFunCallHandler", 1, "onReceive~ isSuccess=false ,data=" + PkgTools.a((byte[])paramObject) + ", funcType=" + j);
          ReportCenter.a().a("FunCallSvr.call", 100, paramFromServiceMsg.getBusinessFailCode(), this.b.getCurrentAccountUin(), 1000277, "趣味来电设置失败", true);
    ...
    if (QLog.isColorLevel())
    {
      ...
      for (;;)
      {
        ...
        paramToServiceMsg = VipFunCallManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1, null);
        ...
        else
        {
          ...
          {
            paramFromServiceMsg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0, this.b.getAccount(), ((VipFunCallAndRing.TUserInfo)localObject2).i32_common_id.get(), ((VipFunCallAndRing.TUserInfo)localObject2).i32_ring_id.get(), null, l);
            localObject3 = (VipFunCallAndRing.TSourceInfo)((VipFunCallAndRing.TUserInfo)localObject2).st_src_info.get();
            VipFunCallManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((VipFunCallAndRing.TUserInfo)localObject2).i32_common_id.get(), null, (VipFunCallAndRing.TSourceInfo)localObject3, true);
