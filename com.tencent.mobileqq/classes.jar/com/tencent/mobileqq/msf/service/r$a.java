...
class r$a
{
  ...
  public r$a(long[] paramArrayOfLong1, long[] paramArrayOfLong2)
  {
  ...
  public boolean a(long paramLong)
  {
    if (this.a != null)
    {
      ...
      {
        j = -j - 1;
        QLog.d("GuardManager", 2, paramLong + " is the " + j + "th of " + Arrays.toString(this.a) + ", range reaches [" + (paramLong - r.b()) + ", " + (r.b() + paramLong) + "]");
        if ((j <= 0) || (paramLong - this.a[(j - 1)] > r.b())) {
          break label197;
        }
        i = j - 1;
      }
      while (i >= 0)
      {
        ...
        QLog.d("GuardManager", 2, "order: " + j + ", limit: " + r.c() + ", in " + Arrays.toString(this.b));
        if (j < r.c()) {
          return true;
        }
      }
 ...
 * Qualified Name:     com.tencent.mobileqq.msf.service.r.a
