...
class u$a
{
  ...
  public u$a(long[] paramArrayOfLong1, long[] paramArrayOfLong2)
  {
  ...
  public boolean a(long paramLong)
  {
    if (this.a != null)
    {
      ...
      {
        j = -j - 1;
        QLog.d("GuardManager", 2, paramLong + " is the " + j + "th of " + Arrays.toString(this.a) + ", range reaches [" + (paramLong - u.b()) + ", " + (u.b() + paramLong) + "]");
        if ((j <= 0) || (paramLong - this.a[(j - 1)] > u.b())) {
          break label197;
        }
        i = j - 1;
      }
      while (i >= 0)
      {
        ...
        QLog.d("GuardManager", 2, "order: " + j + ", limit: " + u.c() + ", in " + Arrays.toString(this.b));
        if (j < u.c()) {
          return true;
        }
      }
 ...
 * Qualified Name:     com.tencent.mobileqq.msf.service.u.a
