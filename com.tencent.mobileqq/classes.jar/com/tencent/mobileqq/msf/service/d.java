  ...
  public static void a(String paramString1, String paramString2, IMsfServiceCallbacker paramIMsfServiceCallbacker, int paramInt)
  {
    ...
    try
    {
      ...
      catch (UnsatisfiedLinkError paramString2)
      {
        for (;;)
        {
          QLog.d("MSF.S.AppProcessManager", 1, "onRegisterApp UnsatisfiedLinkError", paramString2);
          if (new Random().nextInt(100) < 1) {
            CrashReport.handleCatchException(Thread.currentThread(), paramString2, "NativeConfigStoreCatchedException", null);
          }
        }
      }
      if (QLog.isColorLevel()) {
