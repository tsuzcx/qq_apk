  ...
  implements Runnable
{
  ...
  public aa$b(aa paramaa, ToServiceMsg paramToServiceMsg)
  {
  ...
  public void run()
  {
    ...
    Object localObject = (ToServiceMsg)aa.f.get(Integer.valueOf(this.b.getAppSeq()));
    if ((localObject != null) && (((ToServiceMsg)localObject).getAttribute("appTimeoutReq", Integer.valueOf(-1)) == this.b.getAttribute("appTimeoutReq", Integer.valueOf(-2))) && ((ToServiceMsg)aa.f.remove(Integer.valueOf(this.b.getAppSeq())) != null))
    {
 ...
 * Qualified Name:     com.tencent.mobileqq.msf.sdk.aa.b
