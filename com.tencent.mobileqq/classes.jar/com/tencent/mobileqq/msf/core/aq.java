  ...
  extends k.a
{
  ...
  private aq.f B = null;
  public aq.e i = new aq.e(this);
  public aq.a j = new aq.a(this);
  public aq.a k = new aq.a(this);
  public aq.a l = new aq.a(this);
  public aq.a m = new aq.a(this);
  private final Handler q = x.b();
  ...
  private void k()
  {
    ...
    {
      if ((this.w == null) || (this.w.get() == null)) {
        this.w = new WeakReference(new aq.h(this, null));
      }
      if (this.w.get() != null)
      {
        l();
        ((aq.h)this.w.get()).d = false;
  ...
  private void m()
  {
    ...
    {
      if ((this.x == null) || (this.x.get() == null)) {
        this.x = new WeakReference(new aq.g(this, null));
      }
      if (((aq.g)this.x.get()).a.compareAndSet(false, true))
      {
        n();
        ((aq.g)this.x.get()).b = false;
  ...
  private void n()
  {
    ...
    do
    {
      ...
      ((aq.g)this.x.get()).b = true;
      ((aq.g)this.x.get()).a.set(false);
    } while (!QLog.isColorLevel());
  ...
  private void o()
  {
    ...
    {
      if ((this.u == null) || (this.u.get() == null)) {
        this.u = new WeakReference(new aq.c(this));
      }
      if (((aq.c)this.u.get()).a.compareAndSet(false, true))
      {
  ...
  public void a(int paramInt, long paramLong, com.tencent.mobileqq.msf.core.net.x paramx)
  {
  ...
  public void a(ToServiceMsg paramToServiceMsg)
  {
    ...
    {
      if ((this.v == null) || (this.v.get() == null)) {
        this.v = new WeakReference(new aq.b(this));
      }
      Object localObject = (aq.b)this.v.get();
      aq.e locale = this.i;
      long l1 = paramToServiceMsg.getRequestSsoSeq();
      locale.f = l1;
      ((aq.b)localObject).b = l1;
      paramToServiceMsg = (aq.b)this.v.get();
      localObject = this.i;
      l1 = System.currentTimeMillis();
      ((aq.e)localObject).g = l1;
      ...
      if ((this.r) && (paramToServiceMsg != null) && (paramFromServiceMsg != null) && (paramFromServiceMsg.isSuccess()))
      {
        ...
        if (localObject != null)
        {
          ...
          if (l1 > 0L)
          {
            ...
            long l3 = this.k.a;
            ((aq.a)localObject).b = (l1 / (this.k.a + 1) + l2 * l3);
            localObject = this.k;
            ((aq.a)localObject).a += 1;
          }
        }
      }
