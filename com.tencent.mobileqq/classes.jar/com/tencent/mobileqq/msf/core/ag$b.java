  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    synchronized (ag.a(this.a))
    {
      ...
      if (this.a.L >= l)
      {
        ag.b(this.a).postDelayed(this.a.i, this.a.m);
        if ((!ag.c(this.a)) && (this.a.h.size() - this.a.k > 0))
        {
          ag.b(this.a).postDelayed(this.a.i, this.a.m);
          ag.a(this.a, true);
        }
      ...
      try
      {
        ...
        ag localag = this.a;
        localag.l -= ((ToServiceMsg)???).getWupBuffer().length;
        ag.a(this.a, (ToServiceMsg)this.a.h.poll());
        return;
      }
      catch (Exception localException)
      {
        for (;;)
        {
          synchronized (ag.a(this.a))
          {
            if ((this.a.l >= this.a.k) && (!ag.c(this.a)))
            {
              ag.a(this.a, true);
              ag.b(this.a).post(this.a.i);
              if (i1 > 0)
              {
                ...
                localObject6 = ag.b(((ByteArrayOutputStream)localObject6).toByteArray());
              ...
              ag.a(this.a, localToServiceMsg1);
              continue;
              ...
              continue;
              ??? = this.a;
              ((ag)???).l -= localToServiceMsg2.getWupBuffer().length;
              if (n == 0)
              {
                ...
                {
                  localBusiBuffItem.BusiBuffLen.set(ag.b(localToServiceMsg2.getWupBuffer()).length);
                  if (localToServiceMsg2.getWupBuffer().length < 4) {
                    continue;
                  }
                  ...
                  localToServiceMsg2.getAttributes().put("__extraTimeoutSeq", Integer.valueOf(ag.q().incrementAndGet()));
              ...
              else
              {
                ...
                ??? = this.a;
                i = ((ag)???).l;
                ((ag)???).l = (localToServiceMsg2.getWupBuffer().length + i);
                i1 = k;
                continue;
              }
            ...
            if ((!ag.c(this.a)) && (this.a.h.size() >= this.a.j))
            {
              ag.a(this.a, true);
              ag.b(this.a).post(this.a.i);
            }
          }
          if ((!ag.c(this.a)) && (!this.a.h.isEmpty()))
          {
            ag.b(this.a).postDelayed(this.a.i, this.a.m);
            ag.a(this.a, true);
          }
    ...
    label348:
    ??? = new ToServiceMsg("MSF SSOPackageMerge", ag.d(this.a), "SSO.LoginMerge");
 ...
 * Qualified Name:     com.tencent.mobileqq.msf.core.ag.b
