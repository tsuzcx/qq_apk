  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    try
    {
      Object localObject4;
      int i;
      if (MsfCore.sCore.sender.d.size() >= ap.g().e)
      {
        this.b.clear();
      ...
      for (;;)
      {
        ...
        if (((Iterator)localObject4).hasNext())
        {
          ...
          if ((l <= 0L) || (System.currentTimeMillis() - l <= ap.g().g)) {
            break label736;
          }
          if (this.b.size() < 10)
          {
        ...
        if ((i >= ap.g().e) && (ap.g().f >= 0))
        {
          ...
          if (QLog.isColorLevel())
          {
            ...
            this.c.append("wakenet ssoCheck current:" + Integer.toHexString(ap.a(this.e)) + " sendQueue:" + MsfCore.sCore.sender.d.size() + " detectQueue:" + MsfCore.sCore.sender.f.size() + " waitQueue:" + MsfCore.sCore.sender.g.size() + " delayWaitQueue:" + MsfCore.sCore.sender.h.size() + " bnbc: \n");
    ...
    {
      if ((ap.e(this.e) != null) && (ap.e(this.e).get() != null)) {
        ap.d(this.e).postDelayed((Runnable)ap.e(this.e).get(), ap.g().g);
      }
      this.b.clear();
    }
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.msf.core.ap.h
