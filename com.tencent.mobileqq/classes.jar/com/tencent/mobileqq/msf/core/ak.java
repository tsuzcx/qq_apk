...
public class ak
{
  ...
  private static Handler h = new al(u.a().getLooper());
  ...
  private static void a(ak.a parama, boolean paramBoolean, long paramLong)
  {
  ...
  private static void a(ak.a parama, boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  public static void a(a parama)
  {
    ...
    for (;;)
    {
      ...
      locala = (ak.a)((Map.Entry)localIterator.next()).getValue();
    ...
    if ((d != null) && (d.size() > 0))
    {
      ...
      {
        locala = (ak.a)localIterator.next();
  ...
  public static void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramToServiceMsg = (ak.a)c.remove(str + paramToServiceMsg + l);
      ...
      continue;
      label370:
      paramToServiceMsg = (ak.a)c.get(str + paramToServiceMsg + l);
  ...
  private static void c()
  {
    ...
    if ((c != null) && (c.size() > 0))
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        ak.a locala = (ak.a)((Map.Entry)localObject).getValue();
    ...
    if ((d != null) && (d.size() > 0))
    {
      ...
      while (localIterator.hasNext())
      {
        localObject = (ak.a)localIterator.next();
        if (l - ((ak.a)localObject).c >= 3600000L)
        {
          if (QLog.isColorLevel()) {
            QLog.d("WeakNetworkStat", 2, "clean, clean QuickSendedMsg by interval check.");
          }
          a((ak.a)localObject, true, true);
