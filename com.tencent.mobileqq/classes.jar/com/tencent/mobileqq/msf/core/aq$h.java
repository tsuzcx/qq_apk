  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    try
    {
      Object localObject4;
      int i;
      if (MsfCore.sCore.sender.d.size() >= aq.g().e)
      {
        this.b.clear();
      ...
      for (;;)
      {
        ...
        if (((Iterator)localObject4).hasNext())
        {
          ...
          if ((l <= 0L) || (System.currentTimeMillis() - l <= aq.g().g)) {
            break label736;
          }
          if (this.b.size() < 10)
          {
        ...
        if ((i >= aq.g().e) && (aq.g().f >= 0))
        {
          ...
          if (QLog.isColorLevel())
          {
            ...
            this.c.append("wakenet ssoCheck current:" + Integer.toHexString(aq.a(this.e)) + " sendQueue:" + MsfCore.sCore.sender.d.size() + " detectQueue:" + MsfCore.sCore.sender.f.size() + " waitQueue:" + MsfCore.sCore.sender.g.size() + " delayWaitQueue:" + MsfCore.sCore.sender.h.size() + " bnbc: \n");
    ...
    {
      if ((aq.e(this.e) != null) && (aq.e(this.e).get() != null)) {
        aq.d(this.e).postDelayed((Runnable)aq.e(this.e).get(), aq.g().g);
      }
      this.b.clear();
    }
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.msf.core.aq.h
