...
public class an
{
  ...
  private static Handler h = new ao(x.a().getLooper());
  ...
  private static void a(an.a parama, boolean paramBoolean, long paramLong)
  {
  ...
  private static void a(an.a parama, boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  public static void a(a parama)
  {
    ...
    for (;;)
    {
      ...
      locala = (an.a)((Map.Entry)localIterator.next()).getValue();
  ...
  public static void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramToServiceMsg = (an.a)c.remove(str + paramToServiceMsg + l);
      ...
      continue;
      label370:
      paramToServiceMsg = (an.a)c.get(str + paramToServiceMsg + l);
  ...
  private static void c()
  {
    ...
    if ((c != null) && (c.size() > 0))
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        an.a locala = (an.a)((Map.Entry)localObject).getValue();
    ...
    if ((d != null) && (d.size() > 0))
    {
      ...
      while (localIterator.hasNext())
      {
        localObject = (an.a)localIterator.next();
        if (l - ((an.a)localObject).c >= 3600000L)
        {
          if (QLog.isColorLevel()) {
            QLog.d("WeakNetworkStat", 2, "clean, clean QuickSendedMsg by interval check.");
          }
          a((an.a)localObject, true, true);
