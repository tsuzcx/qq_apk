...
public class j
{
  ...
  public void a(long paramLong1, int paramInt, long paramLong2)
  {
    if (NetConnInfoCenter.isWifiOrMobileConn())
    {
      ...
      a("dim_Msf_TokenExpired", false, paramLong1, paramLong2, localHashMap, false, false);
    }
  }
  ...
  public void a(WifiInfo paramWifiInfo)
  {
    if ((paramWifiInfo.getBSSID() == null) || (paramWifiInfo.getIpAddress() == 0) || (paramWifiInfo.getSupplicantState() != SupplicantState.COMPLETED))
    {
      ...
      a("dim_Msf_WifiNoConnection", false, 0L, 0L, paramWifiInfo, true, false);
    }
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    try
    {
      ...
      a("msf_core_DeadObjectException", true, 0L, 0L, localHashMap, false, false);
      return;
    }
  ...
  public void a(String arg1, String paramString2, boolean paramBoolean1, long paramLong1, long paramLong2, Map paramMap, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4)
  {
    ...
    try
    {
      ...
      paramMap.put("param_SsoServerIp", ad.E);
      paramMap.put("param_GatewayrIp", ad.q());
  ...
  public void a(String paramString, boolean paramBoolean, long paramLong1, int paramInt, long paramLong2)
  {
    if (NetConnInfoCenter.isWifiOrMobileConn())
    {
      ...
      localHashMap.put("param_FailCode", String.valueOf(paramInt));
      a("dim_Msf_UserGrayfail", paramBoolean, paramLong1, paramLong2, localHashMap, false, false);
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    a("Msf_LoginRespTimeout", false, 0L, 0L, localHashMap, false, false);
  }
  ...
  public void a(boolean paramBoolean, long paramLong1, int paramInt, long paramLong2)
  {
    if (NetConnInfoCenter.isWifiOrMobileConn())
    {
      ...
      if (r())
      {
        a("dim_Msf_BG_PushQueryResult", paramBoolean, paramLong1, paramLong2, localHashMap, false, false);
        return;
      }
      a("dim_Msf_PushQueryResult", paramBoolean, paramLong1, paramLong2, localHashMap, false, false);
    }
  }
  ...
  public void a(boolean paramBoolean1, long paramLong1, int paramInt, long paramLong2, String paramString1, String paramString2, boolean paramBoolean2, long paramLong3)
  {
    ...
    localHashMap.put("param_NowLocalIp", ad.F);
    localHashMap.put("param_Reason", String.valueOf(paramBoolean2));
    localHashMap.put("param_sendTime", String.valueOf(paramLong3));
    a("Msf_CommonLogin", paramBoolean1, paramLong1, paramLong2, localHashMap, false, false);
  }
  ...
  public void a(boolean paramBoolean1, long paramLong1, int paramInt, long paramLong2, boolean paramBoolean2, String paramString)
  {
    if (NetConnInfoCenter.isWifiOrMobileConn())
    {
      ...
      if (!paramBoolean2)
      {
        ...
        if (r())
        {
          a("dim_Msf_BG_RigisterPushResult", paramBoolean1, paramLong1, paramLong2, localHashMap, false, false);
          return;
        }
        a("dim_Msf_RigisterPushResult", paramBoolean1, paramLong1, paramLong2, localHashMap, false, false);
        return;
      }
      localHashMap.put("param_FailCode", String.valueOf(paramInt + 3200));
      if (r())
      {
        a("dim_Msf_BG_UnRigisterPushResult", paramBoolean1, paramLong1, paramLong2, localHashMap, false, false);
        return;
      }
      a("dim_Msf_UnRigisterPushResult", paramBoolean1, paramLong1, paramLong2, localHashMap, false, false);
    }
  }
  ...
  public void a(boolean paramBoolean1, long paramLong1, long paramLong2, long paramLong3, long paramLong4, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    a("dim_msf_deviceidle_status", true, paramLong1, 0L, localHashMap, false, false);
  }
  ...
  public void a(boolean paramBoolean, long paramLong1, d paramd, com.tencent.qphone.base.a parama, int paramInt, long paramLong2, long paramLong3, long paramLong4, String paramString1, String paramString2)
  {
    ...
    if (r())
    {
      a("dim_Msf_BG_ConnClose", paramBoolean, paramLong1, 0, localHashMap, false, false);
      return;
    }
    a("dim_Msf_ConnClose", paramBoolean, paramLong1, 0, localHashMap, false, false);
  }
  ...
  public void a(boolean paramBoolean, String paramString1, long paramLong1, int paramInt, long paramLong2, String paramString2, String paramString3)
  {
    if (NetConnInfoCenter.isWifiOrMobileConn())
    {
      ...
      a("dim_Msf_RenewToken_3", paramBoolean, paramLong1, paramLong2, localHashMap, false, false);
    }
  }
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, long paramLong, ArrayList paramArrayList)
  {
    ...
    int i2 = 0;
    label119:
    localHashMap.put("param_GatewayIp", ad.q());
    ...
    if (paramBoolean1)
    {
      if (paramBoolean2)
      {
        a("dim_Msf_MutilConnDefaultElapsedTime", paramBoolean3, paramLong, 0, localHashMap, true, false);
        return;
      }
      a("dim_Msf_MutilConnElapsedTime", paramBoolean3, paramLong, 0, localHashMap, false, false);
      return;
    }
    if (paramBoolean2)
    {
      if (r())
      {
        a("dim_Msf_BG_ConnDefaultElapsedTime", paramBoolean3, paramLong, 0, localHashMap, false, false);
        return;
      }
      a("dim_Msf_ConnDefaultElapsedTime", paramBoolean3, paramLong, 0, localHashMap, false, false);
      return;
    }
    if (r())
    {
      if (i1 != 0)
      {
        a("dim_Msf_BG_ConnFailByUnreachable", paramBoolean3, paramLong, 0, localHashMap, false, false);
        return;
      }
      if (i2 != 0)
      {
        a("dim_Msf_BG_ConnFailByPermission", paramBoolean3, paramLong, 0, localHashMap, false, false);
        return;
      }
      a("dim_Msf_BG_ConnElapsedTime", paramBoolean3, paramLong, 0, localHashMap, false, false);
      return;
    }
    if (i1 != 0)
    {
      a("dim_Msf_ConnFailByUnreachable", paramBoolean3, paramLong, 0, localHashMap, false, false);
      return;
    }
    if (i2 != 0)
    {
      a("dim_Msf_ConnFailByPermission", paramBoolean3, paramLong, 0, localHashMap, false, false);
      return;
    }
    a("dim_Msf_ConnElapsedTime", paramBoolean3, paramLong, 0, localHashMap, false, false);
  }
  ...
  public void b(boolean paramBoolean, long paramLong, String paramString)
  {
    ...
    if (MsfService.getCore().getStatReporter() != null) {
      MsfService.getCore().getStatReporter().a(str, paramBoolean, paramLong, 0L, localHashMap, false, false);
    }
  }
  ...
  public void h()
  {
    a("dim_Msf_AUTOBOTTING", true, 0L, 0L, new HashMap(), false, false);
  }
