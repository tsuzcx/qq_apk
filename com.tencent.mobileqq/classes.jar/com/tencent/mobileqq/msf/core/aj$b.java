  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    synchronized (aj.a(this.a))
    {
      ...
      if (this.a.L >= l)
      {
        aj.b(this.a).postDelayed(this.a.i, this.a.m);
        if ((!aj.c(this.a)) && (this.a.h.size() - this.a.k > 0))
        {
          aj.b(this.a).postDelayed(this.a.i, this.a.m);
          aj.a(this.a, true);
        }
      ...
      try
      {
        ...
        aj localaj = this.a;
        localaj.l -= ((ToServiceMsg)???).getWupBuffer().length;
        aj.a(this.a, (ToServiceMsg)this.a.h.poll());
        return;
      }
      catch (Exception localException)
      {
        for (;;)
        {
          synchronized (aj.a(this.a))
          {
            if ((this.a.l >= this.a.k) && (!aj.c(this.a)))
            {
              aj.a(this.a, true);
              aj.b(this.a).post(this.a.i);
              if (i1 > 0)
              {
                ...
                localObject6 = aj.b(((ByteArrayOutputStream)localObject6).toByteArray());
              ...
              aj.a(this.a, localToServiceMsg1);
              continue;
              ...
              continue;
              ??? = this.a;
              ((aj)???).l -= localToServiceMsg2.getWupBuffer().length;
              if (n == 0)
              {
                ...
                {
                  localBusiBuffItem.BusiBuffLen.set(aj.b(localToServiceMsg2.getWupBuffer()).length);
                  if (localToServiceMsg2.getWupBuffer().length < 4) {
                    continue;
                  }
              ...
              else
              {
                ...
                ??? = this.a;
                i = ((aj)???).l;
                ((aj)???).l = (localToServiceMsg2.getWupBuffer().length + i);
                i1 = k;
                continue;
              }
            ...
            if ((!aj.c(this.a)) && (this.a.h.size() >= this.a.j))
            {
              aj.a(this.a, true);
              aj.b(this.a).post(this.a.i);
            }
          }
          if ((!aj.c(this.a)) && (!this.a.h.isEmpty()))
          {
            aj.b(this.a).postDelayed(this.a.i, this.a.m);
            aj.a(this.a, true);
          }
    ...
    label348:
    ??? = new ToServiceMsg("MSF SSOPackageMerge", aj.d(this.a), "SSO.LoginMerge");
 ...
 * Qualified Name:     com.tencent.mobileqq.msf.core.aj.b
