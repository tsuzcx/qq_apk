...
public class m
{
  ...
  public static void a(FromServiceMsg paramFromServiceMsg)
  {
    ...
    try
    {
      ...
      if (b.a == 1)
      {
        new Thread(new g(b, c, g.a.a, h, i)).start();
        return;
      }
      if (b.a == 2)
      {
        new Thread(new g(b, c, g.a.b, h, i)).start();
        return;
      }
    }
    ...
    if (b.a == 3)
    {
      new Thread(new g(b, c, g.a.c, h, i)).start();
      return;
    }
    if (b.a == 5)
    {
      new Thread(new g(b, c, g.a.e, h, i)).start();
      return;
    }
    if (b.a == 6)
    {
      new Thread(new g(b, c, g.a.d, h, i)).start();
      return;
    }
    a();
    return;
    ...
    if ((b.m & 0xFF) == 1L)
    {
      ...
      if (j < 2)
      {
        if (b.a == 1)
        {
          new Thread(new g(b, c, g.a.a, 2, j)).start();
          break label1712;
        }
        if (b.a == 2)
        {
          new Thread(new g(b, c, g.a.b, 2, j)).start();
          break label1712;
        }
        if (b.a == 3)
        {
          new Thread(new g(b, c, g.a.c, 2, j)).start();
          break label1712;
        }
        a();
      }
    ...
    else
    {
      ...
      if ((!NetConnInfoCenter.isWifiConn()) || (NetConnInfoCenter.getWifiStrength() < 10))
      {
        ...
        if (b.a == 1)
        {
          new Thread(new c(b, c, c.a.a, h, i)).start();
          return;
        }
        if (b.a == 2)
        {
          new Thread(new c(b, c, c.a.b, h, i)).start();
          return;
        }
        if (b.a == 3)
        {
          new Thread(new c(b, c, c.a.c, h, i)).start();
          return;
        }
        if (b.a == 5)
        {
          new Thread(new c(b, c, c.a.e, h, i)).start();
          return;
        }
        if (b.a == 6)
        {
          new Thread(new c(b, c, c.a.d, h, i)).start();
          return;
        }
        a();
        return;
    ...
    for (;;)
    {
      ...
      if (j < 2)
      {
        if (b.a == 1)
        {
          new Thread(new c(b, c, c.a.a, 2, j)).start();
          break label1724;
        }
        if (b.a == 2)
        {
          new Thread(new c(b, c, c.a.b, 2, j)).start();
          break label1724;
        }
        if (b.a == 3)
        {
          new Thread(new c(b, c, c.a.c, 2, j)).start();
          break label1724;
        }
        a();
        return;
 ...
 * Qualified Name:     com.tencent.mobileqq.msf.core.net.c.m
