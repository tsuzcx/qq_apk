...
public class ao
{
  ...
  private static Handler h = new ap(x.a().getLooper());
  ...
  private static void a(ao.a parama, boolean paramBoolean, long paramLong)
  {
  ...
  private static void a(ao.a parama, boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  public static void a(a parama)
  {
    ...
    for (;;)
    {
      ...
      locala = (ao.a)((Map.Entry)localIterator.next()).getValue();
    ...
    if ((d != null) && (d.size() > 0))
    {
      ...
      {
        locala = (ao.a)localIterator.next();
  ...
  public static void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramToServiceMsg = (ao.a)c.remove(str + paramToServiceMsg + l);
      ...
      continue;
      label370:
      paramToServiceMsg = (ao.a)c.get(str + paramToServiceMsg + l);
  ...
  private static void c()
  {
    ...
    if ((c != null) && (c.size() > 0))
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        ao.a locala = (ao.a)((Map.Entry)localObject).getValue();
    ...
    if ((d != null) && (d.size() > 0))
    {
      ...
      while (localIterator.hasNext())
      {
        localObject = (ao.a)localIterator.next();
        if (l - ((ao.a)localObject).c >= 3600000L)
        {
          if (QLog.isColorLevel()) {
            QLog.d("WeakNetworkStat", 2, "clean, clean QuickSendedMsg by interval check.");
          }
          a((ao.a)localObject, true, true);
