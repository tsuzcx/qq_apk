    ...
    for (;;)
    {
      if (bool)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("WeaknetNew", 2, "weaknet quickSendCheck reason=" + Integer.toHexString(am.a(this.c)) + " ssoSeq=" + i + " timeout=" + bool);
        }
      }
      if ((this.c.a(32)) || (MsfCore.sCore.quicksender.a().size() <= 0) || (am.c(this.c) == null) || (am.c(this.c).get() == null)) {
        break;
      }
      am.d(this.c).postDelayed((Runnable)am.c(this.c).get(), am.g().i);
      return;
      break label89;
      i = 0;
      continue;
 ...
 * Qualified Name:     com.tencent.mobileqq.msf.core.am.g
