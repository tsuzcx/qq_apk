  ...
  extends k.a
{
  ...
  private am.f B = null;
  public am.e i = new am.e(this);
  public am.a j = new am.a(this);
  public am.a k = new am.a(this);
  public am.a l = new am.a(this);
  public am.a m = new am.a(this);
  ...
  private void k()
  {
    ...
    {
      if ((this.w == null) || (this.w.get() == null)) {
        this.w = new WeakReference(new am.h(this, null));
      }
      if (this.w.get() != null)
      {
        l();
        ((am.h)this.w.get()).d = false;
  ...
  private void m()
  {
    ...
    {
      if ((this.x == null) || (this.x.get() == null)) {
        this.x = new WeakReference(new am.g(this, null));
      }
      if (((am.g)this.x.get()).a.compareAndSet(false, true))
      {
        n();
        ((am.g)this.x.get()).b = false;
  ...
  private void n()
  {
    ...
    do
    {
      ...
      ((am.g)this.x.get()).b = true;
      ((am.g)this.x.get()).a.set(false);
    } while (!QLog.isColorLevel());
  ...
  private void o()
  {
    ...
    {
      if ((this.u == null) || (this.u.get() == null)) {
        this.u = new WeakReference(new am.c(this));
      }
      if (((am.c)this.u.get()).a.compareAndSet(false, true))
      {
  ...
  public void a(ToServiceMsg paramToServiceMsg)
  {
    ...
    {
      if ((this.v == null) || (this.v.get() == null)) {
        this.v = new WeakReference(new am.b(this));
      }
      Object localObject = (am.b)this.v.get();
      am.e locale = this.i;
      long l1 = paramToServiceMsg.getRequestSsoSeq();
      locale.f = l1;
      ((am.b)localObject).b = l1;
      paramToServiceMsg = (am.b)this.v.get();
      localObject = this.i;
      l1 = System.currentTimeMillis();
      ((am.e)localObject).g = l1;
      ...
      if ((this.r) && (paramToServiceMsg != null) && (paramFromServiceMsg != null) && (paramFromServiceMsg.isSuccess()))
      {
        ...
        if (localObject != null)
        {
          ...
          if (l1 > 0L)
          {
            ...
            long l3 = this.k.a;
            ((am.a)localObject).b = (l1 / (this.k.a + 1) + l2 * l3);
            localObject = this.k;
            ((am.a)localObject).a += 1;
          }
        }
      }
