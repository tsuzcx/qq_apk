  ...
  extends k.a
{
  ...
  private ap.f B = null;
  public ap.e i = new ap.e(this);
  public ap.a j = new ap.a(this);
  public ap.a k = new ap.a(this);
  public ap.a l = new ap.a(this);
  public ap.a m = new ap.a(this);
  ...
  private void k()
  {
    ...
    {
      if ((this.w == null) || (this.w.get() == null)) {
        this.w = new WeakReference(new ap.h(this, null));
      }
      if (this.w.get() != null)
      {
        l();
        ((ap.h)this.w.get()).d = false;
  ...
  private void m()
  {
    ...
    {
      if ((this.x == null) || (this.x.get() == null)) {
        this.x = new WeakReference(new ap.g(this, null));
      }
      if (((ap.g)this.x.get()).a.compareAndSet(false, true))
      {
        n();
        ((ap.g)this.x.get()).b = false;
  ...
  private void n()
  {
    ...
    do
    {
      ...
      ((ap.g)this.x.get()).b = true;
      ((ap.g)this.x.get()).a.set(false);
    } while (!QLog.isColorLevel());
  ...
  private void o()
  {
    ...
    {
      if ((this.u == null) || (this.u.get() == null)) {
        this.u = new WeakReference(new ap.c(this));
      }
      if (((ap.c)this.u.get()).a.compareAndSet(false, true))
      {
  ...
  public void a(ToServiceMsg paramToServiceMsg)
  {
    ...
    {
      if ((this.v == null) || (this.v.get() == null)) {
        this.v = new WeakReference(new ap.b(this));
      }
      Object localObject = (ap.b)this.v.get();
      ap.e locale = this.i;
      long l1 = paramToServiceMsg.getRequestSsoSeq();
      locale.f = l1;
      ((ap.b)localObject).b = l1;
      paramToServiceMsg = (ap.b)this.v.get();
      localObject = this.i;
      l1 = System.currentTimeMillis();
      ((ap.e)localObject).g = l1;
      ...
      if ((this.r) && (paramToServiceMsg != null) && (paramFromServiceMsg != null) && (paramFromServiceMsg.isSuccess()))
      {
        ...
        if (localObject != null)
        {
          ...
          if (l1 > 0L)
          {
            ...
            long l3 = this.k.a;
            ((ap.a)localObject).b = (l1 / (this.k.a + 1) + l2 * l3);
            localObject = this.k;
            ((ap.a)localObject).a += 1;
          }
        }
      }
