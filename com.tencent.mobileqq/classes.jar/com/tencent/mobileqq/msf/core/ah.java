...
public class ah
{
  ...
  public ah(MsfCore paramMsfCore)
  {
    this.s = paramMsfCore;
  }
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    do
    {
      ...
      {
        this.s.pushManager.s().a(paramToServiceMsg, paramFromServiceMsg);
        return;
      }
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        try
        {
          ...
          try
          {
            ...
            ak.a(paramToServiceMsg, paramFromServiceMsg, false);
          ...
          if (paramFromServiceMsg.getServiceCmd().startsWith("SharpSvr."))
          {
            ...
            if ((ag.J > 0L) && (l1 - ag.J > 0L) && (l1 - ag.J <= 30000L)) {
              paramFromServiceMsg.addAttribute("__timestamp_msf2net_boot_sharp_c2s", Long.valueOf(ag.J));
            }
          }
          else
          {
      ...
      label1003:
      if (((!ag.s) || (!com.tencent.mobileqq.msf.core.net.a.f.a())) || ((paramFromServiceMsg.getServiceCmd().startsWith("wtlogin.")) && (i1 != 0)))
      {
        if (paramToServiceMsg != null)
        {
          com.tencent.mobileqq.msf.core.auth.n.a(paramToServiceMsg, paramFromServiceMsg);
      ...
      else
      {
        ...
        {
          com.tencent.mobileqq.msf.core.net.c.m.d = this.s;
          com.tencent.mobileqq.msf.core.net.c.m.a(paramFromServiceMsg);
        ...
        {
          y.a().a(paramToServiceMsg, paramFromServiceMsg);
          return;
        ...
        switch (aj.a[paramToServiceMsg.getMsfCommand().ordinal()])
        {
        default: 
        ...
        case 3: 
          ...
          return;
        case 4: 
          this.s.pushManager.c(paramToServiceMsg, paramFromServiceMsg);
          return;
        case 5: 
