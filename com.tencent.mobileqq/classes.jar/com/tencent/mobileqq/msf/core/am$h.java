  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    try
    {
      Object localObject4;
      int i;
      if (MsfCore.sCore.sender.d.size() >= am.g().e)
      {
        this.b.clear();
      ...
      for (;;)
      {
        ...
        if (((Iterator)localObject4).hasNext())
        {
          ...
          if ((l <= 0L) || (System.currentTimeMillis() - l <= am.g().g)) {
            break label736;
          }
          if (this.b.size() < 10)
          {
        ...
        if ((i >= am.g().e) && (am.g().f >= 0))
        {
          ...
          if (QLog.isColorLevel())
          {
            ...
            this.c.append("wakenet ssoCheck current:" + Integer.toHexString(am.a(this.e)) + " sendQueue:" + MsfCore.sCore.sender.d.size() + " detectQueue:" + MsfCore.sCore.sender.f.size() + " waitQueue:" + MsfCore.sCore.sender.g.size() + " delayWaitQueue:" + MsfCore.sCore.sender.h.size() + " bnbc: \n");
    ...
    {
      if ((am.e(this.e) != null) && (am.e(this.e).get() != null)) {
        am.d(this.e).postDelayed((Runnable)am.e(this.e).get(), am.g().g);
      }
      this.b.clear();
    }
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.msf.core.am.h
