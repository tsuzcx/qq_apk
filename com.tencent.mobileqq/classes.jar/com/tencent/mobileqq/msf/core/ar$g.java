    ...
    for (;;)
    {
      if (bool)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("WeaknetNew", 2, "weaknet quickSendCheck reason=" + Integer.toHexString(ar.a(this.c)) + " ssoSeq=" + i + " timeout=" + bool);
        }
      }
      if ((this.c.a(32)) || (MsfCore.sCore.quicksender.a().size() <= 0) || (ar.c(this.c) == null) || (ar.c(this.c).get() == null)) {
        break;
      }
      ar.d(this.c).postDelayed((Runnable)ar.c(this.c).get(), ar.g().i);
      return;
      break label89;
      i = 0;
      continue;
 ...
 * Qualified Name:     com.tencent.mobileqq.msf.core.ar.g
