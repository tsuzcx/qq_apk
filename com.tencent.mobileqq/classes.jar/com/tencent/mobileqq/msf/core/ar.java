  ...
  extends k.a
{
  ...
  private ar.f B = null;
  public ar.e i = new ar.e(this);
  public ar.a j = new ar.a(this);
  public ar.a k = new ar.a(this);
  public ar.a l = new ar.a(this);
  public ar.a m = new ar.a(this);
  ...
  private void k()
  {
    ...
    {
      if ((this.w == null) || (this.w.get() == null)) {
        this.w = new WeakReference(new ar.h(this, null));
      }
      if (this.w.get() != null)
      {
        l();
        ((ar.h)this.w.get()).d = false;
  ...
  private void m()
  {
    ...
    {
      if ((this.x == null) || (this.x.get() == null)) {
        this.x = new WeakReference(new ar.g(this, null));
      }
      if (((ar.g)this.x.get()).a.compareAndSet(false, true))
      {
        n();
        ((ar.g)this.x.get()).b = false;
  ...
  private void n()
  {
    ...
    do
    {
      ...
      ((ar.g)this.x.get()).b = true;
      ((ar.g)this.x.get()).a.set(false);
    } while (!QLog.isColorLevel());
  ...
  private void o()
  {
    ...
    {
      if ((this.u == null) || (this.u.get() == null)) {
        this.u = new WeakReference(new ar.c(this));
      }
      if (((ar.c)this.u.get()).a.compareAndSet(false, true))
      {
  ...
  public void a(ToServiceMsg paramToServiceMsg)
  {
    ...
    {
      if ((this.v == null) || (this.v.get() == null)) {
        this.v = new WeakReference(new ar.b(this));
      }
      Object localObject = (ar.b)this.v.get();
      ar.e locale = this.i;
      long l1 = paramToServiceMsg.getRequestSsoSeq();
      locale.f = l1;
      ((ar.b)localObject).b = l1;
      paramToServiceMsg = (ar.b)this.v.get();
      localObject = this.i;
      l1 = System.currentTimeMillis();
      ((ar.e)localObject).g = l1;
      ...
      if ((this.r) && (paramToServiceMsg != null) && (paramFromServiceMsg != null) && (paramFromServiceMsg.isSuccess()))
      {
        ...
        if (localObject != null)
        {
          ...
          if (l1 > 0L)
          {
            ...
            long l3 = this.k.a;
            ((ar.a)localObject).b = (l1 / (this.k.a + 1) + l2 * l3);
            localObject = this.k;
            ((ar.a)localObject).a += 1;
          }
        }
      }
