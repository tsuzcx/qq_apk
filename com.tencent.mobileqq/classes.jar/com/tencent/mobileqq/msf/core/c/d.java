  ...
  extends BroadcastReceiver
{
  ...
  public static com.tencent.qphone.base.util.QLog.LogFile a(long paramLong1, long paramLong2)
  {
    ...
    //   192: aload 7
    //   194: astore 6
    //   196: new 200	com/tencent/qphone/base/util/QLog$LogFile
    //   199: dup
    //   200: aload 8
    //   202: ldc 202
    //   204: invokespecial 205	com/tencent/qphone/base/util/QLog$LogFile:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   207: astore 8
    //   209: aload 7
    //   211: astore 6
    ...
    //   395: getstatic 71	com/tencent/mobileqq/msf/core/c/d:g	Ljava/text/SimpleDateFormat;
    //   398: aload 7
    //   400: bipush 7
  ...
  private PrintWriter a(Calendar paramCalendar)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ((PrintWriter)localObject2).print("de12fadd|");
  ...
  private void a(HashMap paramHashMap1, HashMap paramHashMap2)
  {
    ...
    try
    {
      ...
      for (int i1 = 0; ((Iterator)localObject1).hasNext(); i1 = (int)(((b)paramHashMap1.get(localObject2)).f + l2))
      {
        ...
        y.execSQL("insert into dataflow(processName, uin, ip, refer, port, flag, buffersize, networktype, mType, curtime, status) values(?,?,?,?,?,?,?,?,?,?,?)", new Object[] { localb.a, this.i.sender.l(), localb.b, localb.c, Integer.valueOf(localb.d), Integer.valueOf(localb.e), Long.valueOf(localb.f), Integer.valueOf(localb.g), localb.h, Long.valueOf(l1), Byte.valueOf(localb.i) });
        l2 = i1;
      }
  ...
  public HashMap a(long paramLong, boolean paramBoolean)
  {
    ...
    //   93: ladd
    //   94: lstore 8
    //   96: getstatic 140	com/tencent/mobileqq/msf/core/c/d:y	Landroid/database/sqlite/SQLiteDatabase;
    //   99: ifnonnull +12 -> 111
    //   102: invokestatic 145	com/tencent/mobileqq/msf/core/c/c:a	()Lcom/tencent/mobileqq/msf/core/c/c;
    //   105: invokevirtual 149	com/tencent/mobileqq/msf/core/c/c:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   108: putstatic 140	com/tencent/mobileqq/msf/core/c/d:y	Landroid/database/sqlite/SQLiteDatabase;
    ...
    //   129: iload_3
    //   130: ifeq +101 -> 231
    //   133: getstatic 140	com/tencent/mobileqq/msf/core/c/d:y	Landroid/database/sqlite/SQLiteDatabase;
    //   136: ldc 28
    //   138: bipush 6
    ...
    //   229: aconst_null
    //   230: areturn
    //   231: getstatic 140	com/tencent/mobileqq/msf/core/c/d:y	Landroid/database/sqlite/SQLiteDatabase;
    //   234: ldc 28
    //   236: bipush 6
  ...
  public HashMap b(long paramLong, boolean paramBoolean)
  {
    ...
    //   111: iload_3
    //   112: ifeq +117 -> 229
    //   115: getstatic 140	com/tencent/mobileqq/msf/core/c/d:y	Landroid/database/sqlite/SQLiteDatabase;
    //   118: ldc 28
    //   120: bipush 10
    ...
    //   227: aconst_null
    //   228: areturn
    //   229: getstatic 140	com/tencent/mobileqq/msf/core/c/d:y	Landroid/database/sqlite/SQLiteDatabase;
    //   232: ldc 28
    //   234: bipush 10
