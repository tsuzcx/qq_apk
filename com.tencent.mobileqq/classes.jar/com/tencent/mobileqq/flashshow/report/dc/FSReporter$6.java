  ...
  implements Runnable
{
  public void run()
  {
    FSReporter.g(this.this$0).add(this.a);
    ...
    if (((IAppSettingApi)QRoute.api(IAppSettingApi.class)).isDebugVersion())
    {
      ...
      QLog.d("FSReporter_DoQuality", 2, localStringBuilder.toString());
    }
  }
}
 ...
 * Qualified Name:     com.tencent.mobileqq.flashshow.report.dc.FSReporter.6
