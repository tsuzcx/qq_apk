...
public class FSPublishTitleBarView
  extends SwiftIphoneTitleBarUI
{
  public FSPublishTitleBarView(SwiftBrowserUIStyleHandler paramSwiftBrowserUIStyleHandler)
  {
  ...
  public void c()
  {
    try
    {
      if (this.a.i != null)
      {
        ...
        if (!this.b.v)
        {
          this.o.setBackgroundColor(localResources.getColor(2131167446));
          if ((this.a.r != null) && (this.a.r.getWebTitleBarInterface().l() != null))
          {
            a(this.a.i, localResources.getColor(2131167446));
            this.a.r.getWebTitleBarInterface().l().setBackgroundColor(localResources.getColor(2131167446));
          }
        }
        if ((this.b.R instanceof FSWebViewTitleStyle))
        {
          ...
          {
            this.j.setImageDrawable(localResources.getDrawable(2130846092));
        ...
        ImmersiveUtils.setStatusTextColor(true, this.a.i.getWindow());
        this.e.setTextColor(localResources.getColor(2131167464));
        b(true);
 ...
 * Qualified Name:     com.tencent.mobileqq.flashshow.api.hybird.FSPublishTitleBarView
