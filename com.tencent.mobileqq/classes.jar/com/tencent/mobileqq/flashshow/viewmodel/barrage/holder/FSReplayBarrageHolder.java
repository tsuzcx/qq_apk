...
public class FSReplayBarrageHolder
  extends FSBaseBarrageHolder
{
  private FSGradientTextView b;
  
  public FSReplayBarrageHolder(Context paramContext)
  {
    super(paramContext, 2131624792);
  }
  ...
  public void a(View paramView)
  {
    ...
    this.b = ((FSGradientTextView)paramView.findViewById(2131433335));
  }
  ...
  public void a(BarrageHolderParam paramBarrageHolderParam)
  {
    if (paramBarrageHolderParam == null)
    {
      QLog.d("FSReplayBarrageHolder", 1, "[onBindView] comment should not be null.");
      return;
    }
 ...
 * Qualified Name:     com.tencent.mobileqq.flashshow.viewmodel.barrage.holder.FSReplayBarrageHolder
