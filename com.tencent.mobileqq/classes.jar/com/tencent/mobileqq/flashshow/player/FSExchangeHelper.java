...
import com.tencent.mobileqq.flashshow.request.FSUrlAdapterRequest;
...
public class FSExchangeHelper
{
  ...
  public static FeedCloudMeta.StVideoUrl a(List<FeedCloudMeta.StVideoUrl> paramList)
  {
    ...
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        {
          QLog.i("FSBaseVideoView_FSVideoUrlExchangeHelper", 1, String.format("getTargetLevelTypeUrl urls size:%d, targetLevelType:%d", new Object[] { Integer.valueOf(paramList.size()), Integer.valueOf(i) }));
          return localStVideoUrl;
        }
      }
    }
    QLog.i("FSBaseVideoView_FSVideoUrlExchangeHelper", 1, "getTargetLevelTypeUrl urls size 0");
    return null;
  }
  ...
  public void a(int paramInt, FeedCloudMeta.StVideo paramStVideo, FSExchangeHelper.VideoUrlAdapterCallBack paramVideoUrlAdapterCallBack)
  {
    if (paramStVideo != null)
    {
      ...
      if (!a(paramStVideo))
      {
        QLog.i("FSBaseVideoView_FSVideoUrlExchangeHelper", 1, String.format("exchangeVideoUrl: valid callBack fileId:%s ,videoExchange url:%s", new Object[] { paramStVideo.fileId.get(), paramStVideo.playUrl.get() }));
      ...
      {
        QLog.i("FSBaseVideoView_FSVideoUrlExchangeHelper", 1, String.format("exchangeVideoUrl: success hit Video Cache fileId:%s ,videoExchange url %s:", new Object[] { ((FeedCloudMeta.StVideo)localObject).fileId.get(), ((FeedCloudMeta.StVideo)localObject).playUrl.get() }));
  ...
  public boolean a(FeedCloudMeta.StVideo paramStVideo)
  {
    ...
    try
    {
      ...
      if (paramStVideo.getQueryParameter("dis_t") != null)
      {
        ...
        QLog.d("FSBaseVideoView_FSVideoUrlExchangeHelper", 2, String.format("intervalTime:%d, disTime: %d, valid time:%d", new Object[] { Long.valueOf(l1), Long.valueOf(l2), Long.valueOf(21600000L) }));
        l2 = this.c;
        if (l1 > 21600000L - l2) {
          return true;
        }
 ...
 * Qualified Name:     com.tencent.mobileqq.flashshow.player.FSExchangeHelper
