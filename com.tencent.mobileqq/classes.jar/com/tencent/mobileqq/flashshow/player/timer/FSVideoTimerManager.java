...
public class FSVideoTimerManager
{
  ...
  private final HandlerThread c = new HandlerThread("FSVideoTimerManager");
  ...
  private void c(IFSVideoTimerListener paramIFSVideoTimerListener)
  {
    ...
    QLog.i("FSVideoTimerManager", 4, paramIFSVideoTimerListener.toString());
    if (this.d.size() == 1) {
      b();
    }
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.flashshow.player.timer.FSVideoTimerManager
