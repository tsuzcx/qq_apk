  ...
  public void a(BaseRequest paramBaseRequest, boolean paramBoolean, long paramLong, String paramString, QQCircleVideourlexchange.StGetVideoAdaptRsp paramStGetVideoAdaptRsp)
  {
    if ((paramBoolean) && (paramLong == 0L) && (paramStGetVideoAdaptRsp.videos.size() > 0))
    {
      ...
      if (paramBaseRequest.playUrl.get().trim().length() > 0)
      {
        ...
        QLog.i("FSBaseVideoView_FSVideoUrlExchangeHelper", 1, String.format("exchangeVideoUrl: success fileId:%s ,videoExchange url %s:", new Object[] { paramBaseRequest.fileId.get(), paramBaseRequest.playUrl.get() }));
        return;
      }
      this.b.a(paramLong, paramString);
      QLog.e("FSBaseVideoView_FSVideoUrlExchangeHelper", 1, String.format("exchangeVideoUrl: failed fileId:%s ,final url:%s, retCode:%d, errMsg:%s", new Object[] { this.a.fileId.get(), this.a.playUrl.get(), Long.valueOf(paramLong), paramString }));
      return;
    }
    this.b.a(paramLong, paramString);
    QLog.e("FSBaseVideoView_FSVideoUrlExchangeHelper", 1, String.format("exchangeVideoUrl: failed fileId:%s ,final url:%s, retCode:%d, errMsg:%s", new Object[] { this.a.fileId.get(), this.a.playUrl.get(), Long.valueOf(paramLong), paramString }));
 ...
 * Qualified Name:     com.tencent.mobileqq.flashshow.player.FSExchangeHelper.1
