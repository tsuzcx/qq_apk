...
public class FSVideoUtils
{
  ...
  public static SuperPlayerVideoInfo a(String paramString1, String paramString2)
  {
    ...
    if (!StringUtil.isEmpty(paramString2))
    {
      ...
      QLog.i("FSVideoUtils", 1, String.format("createSuperVideoInfo fileId:%s, url:%s", new Object[] { paramString1, paramString2 }));
  ...
  public static String a(FeedCloudMeta.StVideo paramStVideo)
  {
    ...
    {
      QLog.i("FSVideoUtils", 1, "stop selectUrlByDownloadSpeed because of hit cache");
      return paramStVideo.playUrl.get();
    }
    long l = FSBaseFragment.a.getCurrentPrediction();
    QLog.i("FSVideoUtils", 1, String.format("selectUrlByDownloadSpeed start, predictDownloadSpeed:%d", new Object[] { Long.valueOf(l) }));
    if (l < 500L)
    {
      FeedCloudMeta.StVideoUrl localStVideoUrl = FSExchangeHelper.a(paramStVideo.vecVideoUrl.get());
      if ((localStVideoUrl != null) && (!StringUtil.isEmpty(localStVideoUrl.playUrl.get())))
      {
        ...
        QLog.i("FSVideoUtils", 1, paramStVideo.toString());
        return localStVideoUrl.playUrl.get();
      }
      QLog.i("FSVideoUtils", 1, "selectUrlByDownloadSpeed target url is null or empty");
    }
    QLog.i("FSVideoUtils", 1, "selectUrlByDownloadSpeed use original video url");
    return paramStVideo.playUrl.get();
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.flashshow.player.FSVideoUtils
