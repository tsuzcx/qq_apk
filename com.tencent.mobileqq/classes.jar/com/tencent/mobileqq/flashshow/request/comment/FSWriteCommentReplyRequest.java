...
public class FSWriteCommentReplyRequest
  extends FSBaseRequest
{
  ...
  public FSWriteCommentReplyRequest(FeedCloudMeta.StFeed paramStFeed, FeedCloudMeta.StComment paramStComment, FeedCloudMeta.StReply paramStReply, int paramInt, boolean paramBoolean)
  {
    if (paramStFeed == null)
    {
  ...
  {
    return "QflashSvr.trpc.qflash.commwriter.ComWriter.DoReply";
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.flashshow.request.comment.FSWriteCommentReplyRequest
