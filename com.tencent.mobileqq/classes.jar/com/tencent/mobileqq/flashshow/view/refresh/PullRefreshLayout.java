...
{
  private View a;
  private PullRefreshLayout.OnRefreshListener b;
  ...
  private void a(float paramFloat1, float paramFloat2, Animator.AnimatorListener paramAnimatorListener)
  {
    ...
    this.z.addUpdateListener(new PullRefreshLayout.3(this, arrayOfView));
    this.z.start();
  }
  ...
  private void a(MotionEvent paramMotionEvent)
  {
    ...
    if (k())
    {
      ...
      if (f1 >= f2)
      {
        b(f1, f2, new PullRefreshLayout.1(this));
        return;
      }
      b(f1, 0.0F, null);
      return;
    ...
    if (l())
    {
      ...
      if (f2 >= f3)
      {
        a(f1, -f3, new PullRefreshLayout.2(this));
        return;
      }
      a(f1, 0.0F, null);
    }
  ...
  private void b(float paramFloat1, float paramFloat2, Animator.AnimatorListener paramAnimatorListener)
  {
    ...
    this.y.addUpdateListener(new PullRefreshLayout.4(this, arrayOfView));
    this.y.start();
  }
  ...
  private void i()
  {
    ...
    {
      if (this.w == null) {
        this.w = new DefaultHeaderView(getContext());
      }
  ...
  private void j()
  {
    ...
    {
      this.q = 1;
      IRefreshView localIRefreshView = this.k;
      if (localIRefreshView != null) {
        localIRefreshView.a(this);
      }
    }
  }
  ...
  private void m()
  {
    if (this.h != 2)
    {
      ...
      if (localObject != null) {
        ((IRefreshView)localObject).b(this);
      }
      localObject = this.b;
      if (localObject != null) {
        ((PullRefreshLayout.OnRefreshListener)localObject).a(this);
      }
    }
  }
  ...
  private void n()
  {
    if (this.q != 2)
    {
      ...
      IRefreshView localIRefreshView = this.k;
      if (localIRefreshView != null) {
        localIRefreshView.b(this);
      }
      if (this.b != null)
      {
        localIRefreshView = this.k;
        if ((localIRefreshView != null) && (localIRefreshView.getRefreshView() != null) && (this.k.getRefreshView().getVisibility() != 8)) {
          this.b.b(this);
        }
      }
    }
  ...
  public void a(long paramLong)
  {
    if (this.h != 2)
    {
      ...
      postDelayed(new PullRefreshLayout.5(this), paramLong);
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if ((this.a != null) && (this.q == 2))
    {
      IRefreshView localIRefreshView = this.k;
      if (localIRefreshView != null) {
        localIRefreshView.a(this, paramBoolean);
      }
      FSThreadUtils.a(new PullRefreshLayout.6(this), 200L);
    }
  }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    {
      IRefreshView localIRefreshView = this.d;
      if (localIRefreshView != null) {
        localIRefreshView.a(this, true);
      }
      FSThreadUtils.a(new PullRefreshLayout.7(this), 200L);
    }
  }
  ...
  {
    IRefreshView localIRefreshView = this.k;
    if ((localIRefreshView != null) && (localIRefreshView.getRefreshView() != null)) {
  ...
  {
    IRefreshView localIRefreshView = this.k;
    if ((localIRefreshView != null) && (localIRefreshView.getRefreshView() != null) && (a())) {
  ...
  public void setFooterView(IRefreshView paramIRefreshView)
  {
    setFooterView(paramIRefreshView, 2, null);
  }
  
  public void setFooterView(IRefreshView paramIRefreshView, int paramInt)
  {
    setFooterView(paramIRefreshView, paramInt, null);
  }
  
  public void setFooterView(IRefreshView paramIRefreshView, int paramInt, FrameLayout.LayoutParams paramLayoutParams)
  {
    if (paramIRefreshView != null)
    {
      if (paramIRefreshView.getRefreshView() == null) {
        return;
      }
      this.l = paramInt;
      this.k = paramIRefreshView;
      this.n = paramIRefreshView.getStartRefreshDistance();
      this.j.removeAllViews();
      if (paramLayoutParams != null)
      {
        this.j.addView(paramIRefreshView.getRefreshView(), paramLayoutParams);
        return;
      }
      this.j.addView(paramIRefreshView.getRefreshView());
    }
  }
  ...
  public void setHeaderView(IRefreshView paramIRefreshView)
  {
    setHeaderView(paramIRefreshView, 2, null);
  }
  
  public void setHeaderView(IRefreshView paramIRefreshView, int paramInt)
  {
    setHeaderView(paramIRefreshView, paramInt, null);
  }
  
  public void setHeaderView(IRefreshView paramIRefreshView, int paramInt, FrameLayout.LayoutParams paramLayoutParams)
  {
    if (paramIRefreshView != null)
    {
      if (paramIRefreshView.getRefreshView() == null) {
      ...
      this.d = paramIRefreshView;
      this.e = paramInt;
      this.g = paramIRefreshView.getStartRefreshDistance();
      this.c.removeAllViews();
      if (paramLayoutParams != null)
      {
        this.c.addView(paramIRefreshView.getRefreshView(), paramLayoutParams);
        return;
      }
      this.c.addView(paramIRefreshView.getRefreshView());
    }
  }
  ...
  public void setOnRefreshListener(PullRefreshLayout.OnRefreshListener paramOnRefreshListener)
  {
 ...
 * Qualified Name:     com.tencent.mobileqq.flashshow.view.refresh.PullRefreshLayout
