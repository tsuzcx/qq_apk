  ...
  implements IRefreshView
{
  ...
  private float k;
  private float l;
  private String m = FSHardCodeUtil.a(2131889531);
  private String n = FSHardCodeUtil.a(2131889535);
  private String o = FSHardCodeUtil.a(2131889529);
  private String p = FSHardCodeUtil.a(2131889528);
  private String q = FSHardCodeUtil.a(2131889530);
  ...
  public DefaultFooterView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.x.setStrokeWidth(ViewUtils.dip2px(1.5F));
    this.x.setStrokeCap(Paint.Cap.ROUND);
    this.x.setColor(-12303292);
    this.i = new Paint(1);
    this.i.setTextSize(ViewUtils.dip2px(16.0F));
    this.i.setColor(-12303292);
    this.i.setTextAlign(Paint.Align.CENTER);
    this.j = this.i.getFontMetrics();
    this.c = ViewUtils.dip2px(30.0F);
    this.d = this.c;
    this.z = ViewUtils.dip2px(50.0F);
  ...
  private void a(Canvas paramCanvas, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, int paramInt, float paramFloat5)
  {
    ...
    double d2 = paramInt;
    Double.isNaN(d2);
    double d3 = (d1 + d2) * 3.141592653589793D / 180.0D;
    Double.isNaN(d2);
    double d5 = (d1 - d2) * 3.141592653589793D / 180.0D;
    d1 = paramFloat5;
    d2 = Math.cos(d3);
    Double.isNaN(d1);
    d2 *= d1;
    ...
    Double.isNaN(d6);
    paramFloat5 = (float)(d6 - d2);
    d6 = paramFloat2;
    Double.isNaN(d6);
    localPath.moveTo(paramFloat5, (float)(d6 - d3));
    localPath.moveTo(paramFloat1, paramFloat2);
    localPath.lineTo(paramFloat3, paramFloat4);
    d6 = paramFloat3;
    Double.isNaN(d6);
    paramFloat1 = (float)(d2 + d6);
    d2 = paramFloat4;
    Double.isNaN(d2);
    localPath.moveTo(paramFloat1, (float)(d3 + d2));
    localPath.lineTo(paramFloat3, paramFloat4);
    Double.isNaN(d6);
    paramFloat1 = (float)(d6 + d4 * d1);
    Double.isNaN(d2);
    localPath.lineTo(paramFloat1, (float)(d2 + d1 * d5));
  ...
  private void c(Canvas paramCanvas)
  {
    ...
    a(paramCanvas, this.e + this.c / 2, this.b.bottom - ViewUtils.dip2px(4.0F), this.e + this.c / 2, this.f + ViewUtils.dip2px(4.0F), 40, 30.0F);
    if (this.v)
    {
      if (this.t)
      {
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    this.y = ((i3 / 2 + this.c + ViewUtils.dip2px(20.0F)) * 2);
    ...
    this.e = ((getMeasuredWidth() - i3) / 2 - this.c - ViewUtils.dip2px(20.0F));
    paramInt1 = this.e;
    float f1 = paramInt1;
    paramInt2 = this.f;
 ...
 * Qualified Name:     com.tencent.mobileqq.flashshow.view.refresh.DefaultFooterView
