...
public class DefaultHeaderView
  extends View
  implements IRefreshView
{
  ...
  private float k;
  private float l;
  private String m = FSHardCodeUtil.a(2131889536);
  ...
  private int u;
  private int v;
  private String w = FSHardCodeUtil.a(2131889536);
  private String x = FSHardCodeUtil.a(2131889534);
  private String y = FSHardCodeUtil.a(2131889533);
  private String z = FSHardCodeUtil.a(2131889532);
  
  public DefaultHeaderView(Context paramContext)
  {
    this(paramContext, null);
  }
  
  public DefaultHeaderView(Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
    this.s.setStyle(Paint.Style.STROKE);
    this.s.setStrokeWidth(ViewUtils.dip2px(1.5F));
    ...
    this.t = new Path();
    this.b = ViewUtils.dip2px(28.0F);
    this.c = this.b;
    this.u = ViewUtils.dip2px(170.0F);
    this.v = ViewUtils.dip2px(50.0F);
  ...
  private void c(Canvas paramCanvas)
  {
    ...
    a(paramCanvas, this.e + this.b / 2, this.f + ViewUtils.dip2px(4.0F), this.e + this.b / 2, this.f + this.c - ViewUtils.dip2px(4.0F), 40, 30.0F);
    if (this.q)
    {
      if (this.o)
      {
  ...
  private void d(Canvas paramCanvas)
  {
    ...
    paramCanvas.save();
    this.t.reset();
    this.t.moveTo(this.a.centerX() - this.b / 2 + ViewUtils.dip2px(4.0F), this.a.centerY());
    this.t.lineTo(this.a.centerX() - ViewUtils.dip2px(2.0F), this.a.centerY() + this.b / 2 - ViewUtils.dip2px(8.0F));
    this.t.lineTo(this.a.centerX() + this.b / 2 - ViewUtils.dip2px(6.0F), this.a.centerY() - ViewUtils.dip2px(6.0F));
    paramCanvas.drawPath(this.t, this.s);
    paramCanvas.restore();
  }
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    this.e = ViewUtils.dip2px(20.0F);
    paramInt1 = this.e;
    float f1 = paramInt1;
    paramInt2 = this.f;
    this.a = new RectF(f1, paramInt2, paramInt1 + this.b, paramInt2 + this.c);
    this.k = ((getMeasuredWidth() - ViewUtils.dip2px(50.0F)) / 2 + ViewUtils.dip2px(50.0F));
    f1 = this.j.bottom;
    float f2 = this.j.top;
 ...
 * Qualified Name:     com.tencent.mobileqq.flashshow.view.refresh.DefaultHeaderView
