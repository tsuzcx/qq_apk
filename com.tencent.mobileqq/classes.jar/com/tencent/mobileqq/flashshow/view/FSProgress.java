  ...
  extends ImageView
{
  ...
  public FSProgress(Context paramContext)
  {
    super(paramContext);
    a();
  }
  
  public FSProgress(Context paramContext, AttributeSet paramAttributeSet)
  {
  ...
  private void a()
  {
    ...
    this.c = getResources().getColor(2131166080);
    this.f = getResources().getColor(2131166077);
    this.e = 51;
    this.g = 255;
    this.d = getResources().getColor(2131166078);
    this.j = new Paint();
 ...
 * Qualified Name:     com.tencent.mobileqq.flashshow.view.FSProgress
