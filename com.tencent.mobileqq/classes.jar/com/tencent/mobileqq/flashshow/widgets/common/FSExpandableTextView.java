...
public class FSExpandableTextView
  extends LinearLayout
{
  ...
  int k = 0;
  boolean l = false;
  FSExpandableTextView.OnExpandStateChangeListener m;
  
  public FSExpandableTextView(Context paramContext)
  {
    this(paramContext, null);
  }
  
  public FSExpandableTextView(Context paramContext, AttributeSet paramAttributeSet)
  {
    this(paramContext, paramAttributeSet, 0);
  }
  
  public FSExpandableTextView(Context paramContext, @Nullable AttributeSet paramAttributeSet, int paramInt)
  {
  ...
  protected void onFinishInflate()
  {
    ...
    this.a = ((FSAsyncTextView)getChildAt(0));
    this.b = ((TextView)getChildAt(1));
    this.b.setText(this.f);
    this.b.setOnClickListener(new FSExpandableTextView.1(this));
  }
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    if ((getVisibility() != 8) && (this.g))
    {
      ...
      FSAsyncTextView localFSAsyncTextView = this.a;
      this.h = a(localFSAsyncTextView, localFSAsyncTextView.getLineCount());
      if (this.i) {
      ...
      if (this.i)
      {
        this.a.post(new FSExpandableTextView.2(this));
        return;
      }
      this.a.post(new FSExpandableTextView.3(this));
      return;
    }
    super.onMeasure(paramInt1, paramInt2);
  }
  ...
  public void setListener(FSExpandableTextView.OnExpandStateChangeListener paramOnExpandStateChangeListener)
  {
 ...
 * Qualified Name:     com.tencent.mobileqq.flashshow.widgets.common.FSExpandableTextView
