...
public class FSDoubleClickLayout
  extends FrameLayout
{
  private boolean a = true;
  private int b = QCircleConstants.c;
  private int c;
  private int d;
  private int e;
  private FSDoubleClickLayout.OnTapClickListener f;
  private FSDoubleClickLayout.OnDoubleClickListener g;
  private FSDoubleClickLayout.OnLongClickListener h;
  ...
  private Runnable r = new FSDoubleClickLayout.1(this);
  private Runnable s = new FSDoubleClickLayout.2(this);
  
  public FSDoubleClickLayout(@NonNull Context paramContext)
  {
    super(paramContext);
    b();
  }
  
  public FSDoubleClickLayout(@NonNull Context paramContext, @NonNull AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
    b();
  }
  
  public FSDoubleClickLayout(@NonNull Context paramContext, @NonNull AttributeSet paramAttributeSet, int paramInt)
  {
  ...
  private boolean a(MotionEvent paramMotionEvent1, MotionEvent paramMotionEvent2, MotionEvent paramMotionEvent3)
  {
    ...
    if (paramMotionEvent1 != null)
    {
      ...
      if (paramMotionEvent3.getEventTime() - paramMotionEvent2.getEventTime() > this.b) {
        return false;
      }
  ...
  private void c()
  {
    if (b(this.m, this.n))
    {
      a(this.m);
      b(this.n);
      FSDoubleClickLayout.OnTapClickListener localOnTapClickListener = this.f;
      if (localOnTapClickListener != null) {
        localOnTapClickListener.a(this.m);
      }
      QLog.d("FSDoubleClickLayout", 1, "singleTap success");
      return;
    }
    QLog.d("FSDoubleClickLayout", 1, "singleTap error");
  }
  ...
  private void d()
  {
    if (this.q != null)
    {
      ...
      if (localMotionEvent != null)
      {
        ...
        QLog.d("FSDoubleClickLayout", 4, "move success");
        return;
      }
    }
    QLog.d("FSDoubleClickLayout", 4, "move error");
  }
  ...
  public boolean dispatchTouchEvent(MotionEvent paramMotionEvent)
  {
    if (!this.a)
    {
      QLog.d("FSDoubleClickLayout", 4, "not intercept");
    ...
    QLog.d("FSDoubleClickLayout", 4, ((StringBuilder)localObject).toString());
  ...
  public void setOnDoubleClickListener(FSDoubleClickLayout.OnDoubleClickListener paramOnDoubleClickListener)
  {
    this.g = paramOnDoubleClickListener;
  }
  
  public void setOnLongClickListener(FSDoubleClickLayout.OnLongClickListener paramOnLongClickListener)
  {
    this.h = paramOnLongClickListener;
  }
  
  public void setOnTapClickListener(FSDoubleClickLayout.OnTapClickListener paramOnTapClickListener)
  {
 ...
 * Qualified Name:     com.tencent.mobileqq.flashshow.widgets.FSDoubleClickLayout
