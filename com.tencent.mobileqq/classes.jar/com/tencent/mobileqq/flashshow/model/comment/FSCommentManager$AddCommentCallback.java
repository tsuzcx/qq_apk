...
class FSCommentManager$AddCommentCallback
  implements VSDispatchObserver.onVSRspCallBack<FeedCloudWrite.StDoCommentRsp>
{
  ...
  private final FSAddFeedCommentBean b;
  
  public FSCommentManager$AddCommentCallback(FSCommentManager paramFSCommentManager, FSAddFeedCommentBean paramFSAddFeedCommentBean)
  {
    this.a = new WeakReference(paramFSCommentManager);
    this.b = paramFSAddFeedCommentBean;
  }
  ...
  public void a(BaseRequest paramBaseRequest, boolean paramBoolean, long paramLong, String paramString, FeedCloudWrite.StDoCommentRsp paramStDoCommentRsp)
  {
    ...
    QLog.d("FSC-AddCommentCallback", 1, new Object[] { str2, " | retCode: ", Long.valueOf(paramLong), " | errMsg: ", paramString, " | trace id: ", localObject, " | cmd name: ", paramBaseRequest });
 ...
 * Qualified Name:     com.tencent.mobileqq.flashshow.model.comment.FSCommentManager.AddCommentCallback
