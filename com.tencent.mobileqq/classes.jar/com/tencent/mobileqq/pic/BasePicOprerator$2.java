...
public class BasePicOprerator$2
  implements Runnable
{
  public BasePicOprerator$2(ayco paramayco, aydn paramaydn, ayds paramayds) {}
  
  public void run()
  {
    ayde.a(this.this$0.b, this.this$0.jdField_a_of_type_JavaLangString, "doFastForward", "start");
    if (this.this$0.jdField_a_of_type_ComTencentMobileqqDataMessageRecord == null)
    {
      this.jdField_a_of_type_Aydn.a("doFastForward", "rec==null");
      this.this$0.a(4, this.jdField_a_of_type_Aydn.jdField_a_of_type_Aydp);
      return;
    }
    Object localObject1 = (MessageForPic)this.this$0.jdField_a_of_type_ComTencentMobileqqDataMessageRecord;
    ((MessageForPic)localObject1).path = this.jdField_a_of_type_Aydn.jdField_a_of_type_Ayeb.jdField_g_of_type_JavaLangString;
    ayco.a(this.this$0, this.jdField_a_of_type_Ayds, ((MessageForPic)localObject1).uniseq);
    ...
    else
    {
      ...
      ((TransferRequest)localObject1).mBusiType = this.jdField_a_of_type_Aydn.jdField_a_of_type_Ayeb.a;
      ((TransferRequest)localObject1).mLocalPath = this.jdField_a_of_type_Aydn.jdField_a_of_type_Ayeb.jdField_g_of_type_JavaLangString;
      localObject2 = new TransferRequest.PicUpExtraInfo();
      if (this.jdField_a_of_type_Aydn.jdField_a_of_type_Ayeb.l != 1) {
        break label462;
      }
    }
    label462:
    for (boolean bool = true;; bool = false)
    {
      ...
      if ((this.jdField_a_of_type_Aydn.jdField_a_of_type_Ayeb.f != null) && (this.jdField_a_of_type_Aydn.jdField_a_of_type_Ayeb.j != 0) && (this.jdField_a_of_type_Aydn.jdField_a_of_type_Ayeb.k != 0) && (this.jdField_a_of_type_Aydn.jdField_a_of_type_Ayeb.c != 0L)) {
        break label467;
      }
      this.jdField_a_of_type_Aydn.a("doFastForward", "upInfo uncomplete!");
      this.this$0.a(4, this.jdField_a_of_type_Aydn.jdField_a_of_type_Aydp);
      return;
    ...
    label467:
    ((TransferRequest)localObject1).mMd5 = this.jdField_a_of_type_Aydn.jdField_a_of_type_Ayeb.f;
    ayde.a(this.this$0.b, this.this$0.jdField_a_of_type_JavaLangString, "doFastForward", " Get width/height/filesize from UploadInfo");
    ((TransferRequest)localObject1).mFastForwardWidth = this.jdField_a_of_type_Aydn.jdField_a_of_type_Ayeb.j;
    ((TransferRequest)localObject1).mFastForwardHeight = this.jdField_a_of_type_Aydn.jdField_a_of_type_Ayeb.k;
    ((TransferRequest)localObject1).mFastForwardFileSize = this.jdField_a_of_type_Aydn.jdField_a_of_type_Ayeb.c;
    ...
    this.this$0.a(this.this$0.jdField_a_of_type_ComTencentMobileqqDataMessageRecord, this.jdField_a_of_type_Aydn.jdField_a_of_type_Ayeb.jdField_g_of_type_Long);
    ayde.a(this.this$0.b, this.this$0.jdField_a_of_type_JavaLangString, "doFastForward", "end, req.mFastForwardWidth = " + ((TransferRequest)localObject1).mFastForwardWidth + ",req.mFastForwardHeight = " + ((TransferRequest)localObject1).mFastForwardHeight);
  }
}
