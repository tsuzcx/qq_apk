  ...
  implements DeviceProfileManager.DPCObserver
{
  ...
  private void a(int paramInt, long paramLong1, long paramLong2, boolean paramBoolean)
  {
    if (paramInt == 1)
    {
      ...
      for (paramLong1 = 0L;; paramLong1 = this.B)
      {
        ...
        paramLong2 = this.A;
        paramLong1 = this.B;
        PicPreDownloadUtils.a("4gFlowPre", this.A, false);
        PicPreDownloadUtils.a("4gFlowWaste", this.B, paramBoolean);
        if (QLog.isColorLevel()) {
    ...
    for (paramLong1 = 0L;; paramLong1 = this.D)
    {
      ...
      paramLong2 = this.C;
      paramLong1 = this.D;
      PicPreDownloadUtils.a("xgFlowPre", this.C, false);
      PicPreDownloadUtils.a("xgFlowWaste", this.D, paramBoolean);
      break;
      paramLong1 = this.C;
      break label270;
      paramLong1 = this.C;
  ...
  private void a(MessageForPic paramMessageForPic, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    {
      this.L += 1L;
      PicPreDownloadUtils.a("wifiHitCount", this.L, true);
      if (QLog.isColorLevel()) {
        Logger.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payHit", "networkType:" + paramInt1 + ",wifiHitCount:" + this.L + ",uniseq:" + paramMessageForPic.uniseq);
      }
    }
    do
    {
      ...
      this.H += 1L;
      this.F -= paramLong;
      PicPreDownloadUtils.a("accFlowWasteTotal", this.F, false);
      PicPreDownloadUtils.a("xgHitCount", this.H, true);
    } while (!QLog.isColorLevel());
    Logger.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payHit", "networkType:" + paramInt1 + ",xgHitCount:" + this.H + ",uniseq:" + paramMessageForPic.uniseq);
    Logger.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payHit", "accFlowPreTotal:" + this.E + ",accFlowWasteTotal:" + this.F);
  }
  ...
  private void b(MessageForPic paramMessageForPic, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    {
      this.M += 1L;
      PicPreDownloadUtils.a("wifiMissCount", this.M, true);
      Logger.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payMiss", "networkType:" + paramInt1 + ",wifiMissCount:" + this.M + ",uniseq:" + paramMessageForPic.uniseq);
    }
    label164:
    do
    {
      ...
      this.I += 1L;
      PicPreDownloadUtils.a("xgMissCount", this.I, true);
    } while (!QLog.isColorLevel());
    Logger.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payMiss", "networkType:" + paramInt1 + ", xgMissCount:" + this.I + ", uniseq:" + paramMessageForPic.uniseq);
  }
  ...
  private void c(MessageForPic paramMessageForPic, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 == 0) {
      if (QLog.isColorLevel()) {
        Logger.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payLeftRight", "networkType:" + paramInt1 + ",wifiHitCount:" + this.L + ",uniseq:" + paramMessageForPic.uniseq);
      }
    }
    do
    {
    ...
    Logger.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payLeftRight", "networkType:" + paramInt1 + ",xgHitCount:" + this.H + ",uniseq:" + paramMessageForPic.uniseq);
  }
  ...
  private void d(MessageForPic paramMessageForPic, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 == 0) {
      if (QLog.isColorLevel()) {
        Logger.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payNotSupport", "networkType:" + paramInt1 + ",wifiHitCount:" + this.L + ",uniseq:" + paramMessageForPic.uniseq);
      }
    }
    do
    {
    ...
    Logger.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payNotSupport", "networkType:" + paramInt1 + ",xgHitCount:" + this.H + ", uniseq:" + paramMessageForPic.uniseq);
  }
  
  private void e()
  {
    this.A = PicPreDownloadUtils.a("4gFlowPre", this.s);
    this.B = PicPreDownloadUtils.a("4gFlowWaste", 0L);
    this.C = PicPreDownloadUtils.a("xgFlowPre", this.y);
    this.D = PicPreDownloadUtils.a("xgFlowWaste", 0L);
    this.L = PicPreDownloadUtils.a("wifiHitCount", this.L);
    this.M = PicPreDownloadUtils.a("wifiMissCount", this.M);
    this.N = PicPreDownloadUtils.a("wifiManulClickCount", this.N);
    this.K = PicPreDownloadUtils.a("wifiPreDownCout", this.K);
    this.H = PicPreDownloadUtils.a("xgHitCount", this.H);
    this.I = PicPreDownloadUtils.a("xgMissCount", this.I);
    this.J = PicPreDownloadUtils.a("xgManulClickCount", this.J);
    this.G = PicPreDownloadUtils.a("xgPreDownCount", this.G);
    this.E = PicPreDownloadUtils.a("accFlowPreTotal", this.E);
    this.F = PicPreDownloadUtils.a("accFlowWasteTotal", this.F);
    this.O = PicPreDownloadUtils.a("requestListOverLimitCount", this.O);
    if (QLog.isColorLevel()) {
  ...
  private void f()
  {
    ...
    else
    {
      ...
      this.u = PicPreDownloadUtils.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "AMaxPDFlow3G", 614400L);
      this.v = PicPreDownloadUtils.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "AMaxWFlow3G", 716800L);
      this.w = 0L;
      this.x = 0L;
      this.o = this.u;
      this.q = 0L;
  ...
  public HashMap a()
  {
    ...
    long l1 = PicPreDownloadUtils.a("4gFlowPre", this.A);
    long l2 = PicPreDownloadUtils.a("4gFlowWaste", this.B);
    long l3 = PicPreDownloadUtils.a("xgFlowPre", this.C);
    long l4 = PicPreDownloadUtils.a("xgFlowWaste", this.D);
    long l5 = PicPreDownloadUtils.a("accFlowPreTotal", this.E);
    long l6 = PicPreDownloadUtils.a("xgPreDownCount", this.G);
    long l7 = PicPreDownloadUtils.a("xgHitCount", this.H);
    long l8 = PicPreDownloadUtils.a("xgMissCount", this.I);
    long l9 = PicPreDownloadUtils.a("wifiPreDownCout", this.K);
    long l10 = PicPreDownloadUtils.a("wifiHitCount", this.L);
    long l11 = PicPreDownloadUtils.a("wifiMissCount", this.M);
    long l12 = PicPreDownloadUtils.a("xgManulClickCount", this.J);
    long l13 = PicPreDownloadUtils.a("wifiManulClickCount", this.N);
    long l14 = PicPreDownloadUtils.a("requestListOverLimitCount", this.O);
    if (QLog.isColorLevel()) {
  ...
  public void a(long paramLong, int paramInt)
  {
    ...
    {
      this.K += 1L;
      PicPreDownloadUtils.a("wifiPreDownCout", this.K, true);
    }
    do
    {
      return;
      ...
      this.F += paramLong;
      this.G += 1L;
      PicPreDownloadUtils.a("accFlowPreTotal", this.E, false);
      PicPreDownloadUtils.a("accFlowWasteTotal", this.F, false);
      PicPreDownloadUtils.a("xgPreDownCount", this.G, true);
    } while (!QLog.isColorLevel());
    Logger.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "calcFlowConsume", "networkType:" + paramInt + ",wifiPreDownCout:" + this.K + ",xgPreDownCout:" + this.G);
    Logger.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "calcFlowConsume", "accFlowPreTotal:" + this.E + ",accFlowWasteTotal:" + this.F);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqPicPicStatisticsManager = ((PicStatisticsManager)this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getManager(72));
    this.jdField_a_of_type_ComTencentMobileqqAppAsyncdbCacheTroopStatisticsCache = ((TroopStatisticsCache)this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a().a(3));
    f();
    c();
    e();
  ...
  public void a(MessageForPic paramMessageForPic, long paramLong)
  {
    ...
    do
    {
      ...
      this.F -= paramLong;
      PicPreDownloadUtils.a("accFlowPreTotal", this.E, false);
      PicPreDownloadUtils.a("accFlowWasteTotal", this.F, true);
    } while (!QLog.isColorLevel());
    Logger.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "fixPicSizeAfter", "accFlowPreTotal:" + this.E + ",accFlowWasteTotal:" + this.F);
  }
  ...
  {
    if (PicPreDownloadUtils.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageForPic.istroop, paramMessageForPic.frienduin) != 0) {}
    label349:
    for (;;)
    {
      return true;
  ...
  {
    int i1 = 0;
    this.i = PicPreDownloadUtils.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "PicDPy471", 1374942199L);
    this.j = PicPreDownloadUtils.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "AFBFlowHit3G", 150L);
    this.k = PicPreDownloadUtils.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "AFBFlowMiss3G", 40960L);
    this.l = this.k;
    this.m = PicPreDownloadUtils.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "APicAvgSize", 71680L);
    this.n = PicPreDownloadUtils.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "APicMaxSize", 204800L);
    this.jdField_a_of_type_Boolean = PicPreDownloadUtils.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, false);
    this.jdField_a_of_type_ArrayOfLong = PicPreDownloadUtils.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface);
    this.T = PicPreDownloadUtils.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "APicMaxSize", 921600L);
    int i2;
    if (QLog.isColorLevel())
    {
  ...
  public void d()
  {
    ...
    this.J = 0L;
    this.G = 0L;
    PicPreDownloadUtils.a("requestListOverLimitCount", this.O, false);
    PicPreDownloadUtils.a("wifiHitCount", this.L, false);
    PicPreDownloadUtils.a("wifiMissCount", this.M, false);
    PicPreDownloadUtils.a("wifiManulClickCount", this.N, false);
    PicPreDownloadUtils.a("wifiPreDownCout", this.K, false);
    PicPreDownloadUtils.a("4gFlowWaste", this.B, false);
    PicPreDownloadUtils.a("xgFlowWaste", this.D, false);
    PicPreDownloadUtils.a("xgHitCount", this.H, false);
    PicPreDownloadUtils.a("xgMissCount", this.I, false);
    PicPreDownloadUtils.a("xgManulClickCount", this.J, false);
    PicPreDownloadUtils.a("xgPreDownCount", this.G, true);
  }
}
