  ...
  extends BaseStrategy
{
  ...
  private void a(int paramInt, long paramLong1, long paramLong2, boolean paramBoolean)
  {
    if (paramInt == 1)
    {
      ...
      for (paramLong1 = 0L;; paramLong1 = this.A)
      {
        ...
        paramLong2 = this.z;
        paramLong1 = this.A;
        PicPreDownloadUtils.a("4gFlowPre", this.z, false);
    ...
    for (paramLong1 = 0L;; paramLong1 = this.C)
    {
      ...
      paramLong2 = this.B;
      paramLong1 = this.C;
      PicPreDownloadUtils.a("xgFlowPre", this.B, false);
  ...
  private void a(MessageForPic paramMessageForPic, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 == 0)
    {
      ...
      if (QLog.isColorLevel()) {
        Logger.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payHit", "networkType:" + paramInt1 + ",wifiHitCount:" + this.K + ",uniseq:" + paramMessageForPic.uniseq);
      }
    }
    do
    {
    ...
    Logger.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payHit", "networkType:" + paramInt1 + ",xgHitCount:" + this.G + ",uniseq:" + paramMessageForPic.uniseq);
    Logger.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payHit", "accFlowPreTotal:" + this.D + ",accFlowWasteTotal:" + this.E);
  }
  ...
  private void b(MessageForPic paramMessageForPic, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 == 0)
    {
      ...
      Logger.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payMiss", "networkType:" + paramInt1 + ",wifiMissCount:" + this.L + ",uniseq:" + paramMessageForPic.uniseq);
    }
    label164:
    do
    {
    ...
    Logger.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payMiss", "networkType:" + paramInt1 + ", xgMissCount:" + this.H + ", uniseq:" + paramMessageForPic.uniseq);
  }
  ...
  private void c(MessageForPic paramMessageForPic, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 == 0) {
      if (QLog.isColorLevel()) {
        Logger.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payLeftRight", "networkType:" + paramInt1 + ",wifiHitCount:" + this.K + ",uniseq:" + paramMessageForPic.uniseq);
      }
    }
    do
    {
    ...
    Logger.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payLeftRight", "networkType:" + paramInt1 + ",xgHitCount:" + this.G + ",uniseq:" + paramMessageForPic.uniseq);
  }
  ...
  private void d(MessageForPic paramMessageForPic, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 == 0) {
      if (QLog.isColorLevel()) {
        Logger.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payNotSupport", "networkType:" + paramInt1 + ",wifiHitCount:" + this.K + ",uniseq:" + paramMessageForPic.uniseq);
      }
    }
    do
    {
    ...
    Logger.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payNotSupport", "networkType:" + paramInt1 + ",xgHitCount:" + this.G + ", uniseq:" + paramMessageForPic.uniseq);
  }
  ...
  private void h()
  {
    ...
    else
    {
      ...
      this.t = PicPreDownloadUtils.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "AMaxPDFlow3G", 614400L);
      this.u = PicPreDownloadUtils.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "AMaxWFlow3G", 716800L);
      this.v = 0L;
      this.w = 0L;
      this.n = this.t;
      this.p = 0L;
  ...
  public int a(long paramLong, int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3)
  {
    ...
    if (GIFPreDownloadLimit.a(null, paramBoolean, paramInt3))
    {
      if (this.jdField_a_of_type_ComTencentMobileqqPicGIFPreDownloadLimit == null) {
        f();
      }
      if (paramInt2 == 0) {}
      for (paramBoolean = true; this.jdField_a_of_type_ComTencentMobileqqPicGIFPreDownloadLimit.a(paramBoolean, paramLong); paramBoolean = false) {
        return -11;
      }
      return 2;
    }
    ...
    {
      if (QLog.isColorLevel()) {
        Logger.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "isOverLimit", "result:" + paramInt3 + ",FlowWaste +picSize=" + (l2 + l3) + ",FlowWasteLimit：" + paramLong + ",FlowPre:" + l1 + ",picSize:" + l3 + ",FlowWaste:" + l2 + ",uinType:" + paramInt1 + ",networkType:" + paramInt2 + ",isDynamic:" + paramBoolean);
      }
      paramInt1 = paramInt3;
      break;
      paramLong = this.u;
  ...
  public HashMap<String, String> a()
  {
    ...
    long l1 = PicPreDownloadUtils.a("4gFlowPre", this.z);
    long l2 = PicPreDownloadUtils.a("4gFlowWaste", this.A);
    long l3 = PicPreDownloadUtils.a("xgFlowPre", this.B);
    long l4 = PicPreDownloadUtils.a("xgFlowWaste", this.C);
  ...
  public void a(long paramLong, int paramInt)
  {
    ...
    Logger.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "calcFlowConsume", "networkType:" + paramInt + ",wifiPreDownCount:" + this.J + ",xgPreDownCount:" + this.F);
    Logger.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "calcFlowConsume", "accFlowPreTotal:" + this.D + ",accFlowWasteTotal:" + this.E);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqPicPicStatisticsManager = ((PicStatisticsManager)this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.PICTURE_STATISTICS_MANAGER));
    this.jdField_a_of_type_ComTencentMobileqqAppAsyncdbCacheTroopStatisticsCache = ((TroopStatisticsCache)this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getCacheManager().getCache(3));
    f();
    h();
    g();
    ...
    if (l1 - PicPreDownloadUtils.a("lastDayTime", 0L) > 86400000L)
    {
      ...
      PicReporter.a(str, a());
      e();
      ((PicStatisticsManager)paramQQAppInterface.getManager(QQManagerFactory.PICTURE_STATISTICS_MANAGER)).a();
    }
    if (QLog.isColorLevel()) {
  ...
  public void a(MessageForPic paramMessageForPic, long paramLong)
  {
    ...
    Logger.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "fixPicSizeAfter", "accFlowPreTotal:" + this.D + ",accFlowWasteTotal:" + this.E);
  }
  ...
  public boolean[] a(int paramInt1, int paramInt2)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        Logger.a("PIC_TAG_PRELOAD", "isPreDownload", "netWorkType:" + paramInt2 + ",uinType:" + paramInt1 + ",preDownThumb:" + bool1 + ",preDownBig:" + bool2 + ",xGPreDownPolicy:" + this.h);
      }
  ...
  public void b(MessageForPic paramMessageForPic, long paramLong)
  {
    ...
    do
    {
      ...
      {
        return;
      } while ((paramMessageForPic.isSendFromLocal()) || (paramMessageForPic.subVersion < 5) || (GIFPreDownloadLimit.a(paramMessageForPic)));
  ...
  public void b(String paramString)
  {
    ...
    do
    {
      ...
      {
        return;
      } while (this.jdField_a_of_type_ComTencentMobileqqAppAsyncdbCacheTroopStatisticsCache == null);
      if (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) {
        break;
      }
    } while (!QLog.isColorLevel());
