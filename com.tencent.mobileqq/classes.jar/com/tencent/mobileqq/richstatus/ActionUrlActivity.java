  ...
  extends IphoneTitleBarActivity
{
  ...
  private void b()
  {
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131375472));
    ...
    this.jdField_a_of_type_ComTencentWidgetProtectedWebView.setWebViewClient(new ahty(this, null));
    this.jdField_a_of_type_ComTencentWidgetProtectedWebView.setWebChromeClient(new ahtx(this, null));
    ...
    this.jdField_a_of_type_AndroidViewView = ((LinearLayout)findViewById(2131375473));
    this.jdField_a_of_type_AndroidViewView.setVisibility(0);
    this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)findViewById(2131375474));
    this.jdField_a_of_type_JavaLangString = this.leftView.getText().toString();
    this.b = findViewById(2131365602);
  ...
  public void a()
  {
    ...
    {
      this.leftView.setText(2131435567);
      return;
    }
