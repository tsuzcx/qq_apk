  ...
  extends IphoneTitleBarActivity
{
  ...
  private void b()
  {
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131312897));
    ...
    this.jdField_a_of_type_ComTencentWidgetProtectedWebView.setWebViewClient(new avby(this, null));
    this.jdField_a_of_type_ComTencentWidgetProtectedWebView.setWebChromeClient(new avbx(this, null));
    ...
    this.jdField_a_of_type_Aqrc.a(this.jdField_a_of_type_ComTencentMobileqqRichstatusStatusJsHandler, "statusJsHandler");
    this.jdField_a_of_type_AndroidViewView = ((LinearLayout)findViewById(2131312894));
    this.jdField_a_of_type_AndroidViewView.setVisibility(0);
    this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)findViewById(2131312895));
    this.jdField_a_of_type_JavaLangString = this.leftView.getText().toString();
    this.b = findViewById(2131304131);
  ...
  public void a()
  {
    ...
    {
      this.leftView.setText(2131654691);
      return;
    }
