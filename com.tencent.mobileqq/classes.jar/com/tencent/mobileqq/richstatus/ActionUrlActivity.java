  ...
  extends IphoneTitleBarActivity
{
  ...
  private void b()
  {
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131378722));
    ...
    this.jdField_a_of_type_ComTencentWidgetProtectedWebView.setWebViewClient(new awbr(this, null));
    this.jdField_a_of_type_ComTencentWidgetProtectedWebView.setWebChromeClient(new awbq(this, null));
    ...
    this.jdField_a_of_type_Arlu.a(this.jdField_a_of_type_ComTencentMobileqqRichstatusStatusJsHandler, "statusJsHandler");
    this.jdField_a_of_type_AndroidViewView = ((LinearLayout)findViewById(2131378718));
    this.jdField_a_of_type_AndroidViewView.setVisibility(0);
    this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)findViewById(2131378719));
    this.jdField_a_of_type_JavaLangString = this.leftView.getText().toString();
    this.b = findViewById(2131369804);
  ...
  public void a()
  {
    ...
    {
      this.leftView.setText(2131720589);
      return;
    }
