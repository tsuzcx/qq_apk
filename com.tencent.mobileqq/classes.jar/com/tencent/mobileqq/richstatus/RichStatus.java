  ...
  implements Serializable, Cloneable
{
  ...
  public HashMap<Integer, avcq> sigZanInfo;
  public int signType;
  public long time;
    ...
    for (;;)
    {
      if (localByteBuffer.hasRemaining())
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("Q.richstatus.status", 2, bach.a(paramArrayOfByte));
        }
      }
      for (;;)
      {
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          else
          {
            ...
            if (QLog.isColorLevel())
            {
              QLog.d("Q.richstatus.status", 2, bach.a(paramArrayOfByte) + ",sign feeds id=" + localRichStatus.feedsId);
              continue;
  ...
  public CharSequence getLocSS(Resources paramResources, float paramFloat, CharSequence paramCharSequence)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localObject2 = BitmapFactory.decodeResource(paramResources, 2130848306);
        if (localObject2 == null) {
          continue;
        }
        int i = (int)(0.9F * paramFloat + 0.5F);
        int j = ((Bitmap)localObject2).getWidth() * i / ((Bitmap)localObject2).getHeight();
        paramResources = new bboi(paramResources, (Bitmap)localObject2, false, true);
        paramResources.setBounds(0, 0, j, i);
        paramResources = new bbkk(paramResources, 0).a(-0.1F);
        if (paramCharSequence == null) {}
  ...
  public void sortTopicPos()
  {
    if ((this.topicsPos != null) && (this.topicsPos.size() > 1)) {
      Collections.sort(this.topicsPos, new avcp(this));
    }
  }
  ...
  public CharSequence toSpannableStringWithTopic(String paramString, int paramInt1, int paramInt2, avga paramavga)
  {
    String str1 = paramString;
    if (paramString == null) {
      str1 = "";
    ...
    for (int i = m + 1;; i = m)
    {
      ...
      if (shouldShowAtHead())
      {
        ...
        if (j < this.topics.size())
        {
          ...
          for (;;)
          {
            ...
            localavfy = new avfy(paramavga, avgf.a(-11692801, -2142399233), new Pair(((Pair)this.topics.get(j)).first, str2));
            paramString.append(str2);
            paramString.setSpan(localavfy, k, str2.length() + k, 33);
          }
        }
      }
      int j = 0;
      ...
      for (;;)
      {
        ...
        localavfy = new avfy(paramavga, avgf.a(-11692801, -2142399233), new Pair(((Pair)this.topicsPos.get(j)).first, str2));
        paramString.insert(k, str2);
        paramString.setSpan(localavfy, k, str2.length() + k, 33);
      }
    }
  ...
  @NotNull
  public CharSequence toSpannableStringWithoutAction(avga paramavga)
  {
    int k = 0;
    ...
    if (shouldShowAtHead())
    {
      ...
      if (i < this.topics.size())
      {
        ...
        for (;;)
        {
          ...
          localavfy = new avfy(paramavga, avgf.a(-11692801, -2142399233), new Pair(((Pair)this.topics.get(i)).first, str));
          localSpannableStringBuilder.append(str);
          localSpannableStringBuilder.setSpan(localavfy, j, str.length() + j, 33);
        }
      }
    }
    int i = 0;
    ...
    for (;;)
    {
      ...
      localavfy = new avfy(paramavga, avgf.a(-11692801, -2142399233), new Pair(((Pair)this.topicsPos.get(i)).first, str));
