  ...
  extends QIPCModule
{
  ...
  private EIPCResult b(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    for (paramString = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();; paramString = null)
    {
      ...
      LocalRedTouchManager localLocalRedTouchManager = (LocalRedTouchManager)paramString.getManager(QQManagerFactory.LOCAL_REDTOUCH_MANAGER);
      ...
      for (;;)
      {
        ...
        localLocalRedTouchManager.a(103421, true, l1, true, true);
      }
    }
  }
