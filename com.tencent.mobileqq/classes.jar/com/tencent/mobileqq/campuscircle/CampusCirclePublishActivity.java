  ...
  implements Handler.Callback, TextWatcher, View.OnClickListener, AdapterView.OnItemClickListener, CompoundButton.OnCheckedChangeListener, EmoticonCallback, ActionSheet.OnButtonClickListener, ScrollView.OnScrollStateChangedListener, XPanelContainer.PanelCallback
{
  ...
  abit jdField_a_of_type_Abit;
  private Animator.AnimatorListener jdField_a_of_type_AndroidAnimationAnimator$AnimatorListener = new abil(this);
  private ValueAnimator.AnimatorUpdateListener jdField_a_of_type_AndroidAnimationValueAnimator$AnimatorUpdateListener = new abim(this);
  ValueAnimator jdField_a_of_type_AndroidAnimationValueAnimator;
  DialogInterface.OnCancelListener jdField_a_of_type_AndroidContentDialogInterface$OnCancelListener = new abiq(this);
  public ViewGroup a;
  ...
  CampusCircleObserver jdField_a_of_type_ComTencentMobileqqCampuscircleCampusCircleObserver = new abir(this);
  ...
  private void a(int paramInt)
  {
    ...
    if (paramInt == 0)
    {
      this.jdField_a_of_type_AndroidWidgetImageButton.setImageResource(2130842304);
      ...
      this.jdField_a_of_type_AndroidWidgetImageButton.setContentDescription(getString(2131433379));
    }
    while (paramInt != 1) {
      return;
    }
    this.jdField_a_of_type_AndroidWidgetImageButton.setImageResource(2130842305);
    ...
    this.jdField_a_of_type_AndroidWidgetImageButton.setContentDescription(getString(2131433378));
  }
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    case 0: 
      for (;;)
      {
        ...
        int i = 0;
        while (i < this.jdField_a_of_type_Abit.a())
        {
          localObject = (String)this.jdField_a_of_type_Abit.getItem(i);
    ...
    if (this.jdField_a_of_type_Abit.a() < 9) {}
    for (;;)
    {
      try
      {
  ...
  public View a(int paramInt)
  {
    ...
    if (paramInt == 3)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqEmoticonviewSystemAndEmojiEmoticonPanel == null)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqEmoticonviewSystemAndEmojiEmoticonPanel.setBackgroundColor(getResources().getColor(2131493378));
      }
  ...
  void a()
  {
    ...
    ThreadManager.post(new abin(this), 5, null, true);
  }
  ...
  void a(CampusTopic paramCampusTopic)
  {
    ...
    this.jdField_e_of_type_Int = localResources.getDimensionPixelSize(2131559410);
    this.f = (this.jdField_e_of_type_Int * 2 + 1);
    this.jdField_a_of_type_ComTencentWidgetXPanelContainer = ((XPanelContainer)findViewById(2131364050));
    this.jdField_a_of_type_ComTencentWidgetScrollView = ((ScrollView)findViewById(2131363746));
    this.jdField_a_of_type_ComTencentWidgetPrefixXEditText = ((PrefixXEditText)findViewById(2131368265));
    this.jdField_a_of_type_ComTencentWidgetDynamicGridView = ((DynamicGridView)findViewById(2131368763));
    this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)findViewById(2131364051));
    this.jdField_b_of_type_AndroidWidgetImageButton = ((ImageButton)findViewById(2131369842));
    this.jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)findViewById(2131369843));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131369844));
    this.jdField_a_of_type_ComTencentWidgetHorizontalListView = ((HorizontalListView)findViewById(2131369836));
    this.jdField_c_of_type_AndroidViewViewGroup = ((ViewGroup)findViewById(2131369837));
    this.jdField_b_of_type_AndroidViewViewGroup = ((ViewGroup)findViewById(2131369833));
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)findViewById(2131369832));
    this.jdField_d_of_type_AndroidViewViewGroup = ((ViewGroup)findViewById(2131369841));
    this.jdField_c_of_type_AndroidViewViewGroup.findViewById(2131366621).setOnClickListener(this);
    ((TextView)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131369834)).setOnClickListener(this);
    h();
    int i = localResources.getColor(2131493379);
    getTitleBarView().setBackgroundDrawable(localResources.getDrawable(2130842313));
    ...
    for (;;)
    {
      ...
      this.leftViewNotBack.setTextColor(localResources.getColorStateList(2131494120));
      setRightButton(2131438278, this);
      this.rightViewText.setBackgroundDrawable(null);
      this.rightViewText.setTextSize(1, 17.0F);
      this.rightViewText.setTextColor(localResources.getColorStateList(2131494120));
      ...
      this.jdField_a_of_type_ComTencentWidgetPrefixXEditText.setOnTouchListener(new abik(this));
      ...
      i = localResources.getDimensionPixelSize(2131559403);
      j = localResources.getDimensionPixelSize(2131559402);
      ...
      this.jdField_a_of_type_Abit = new abit(this, this, 3, m);
      ...
      this.jdField_a_of_type_ComTencentWidgetDynamicGridView.setAdapter(this.jdField_a_of_type_Abit);
      this.jdField_a_of_type_ComTencentWidgetDynamicGridView.setOnDragListener(this.jdField_a_of_type_Abit);
      this.jdField_a_of_type_ComTencentWidgetDynamicGridView.setOnDropListener(this.jdField_a_of_type_Abit);
      this.jdField_a_of_type_ComTencentWidgetDynamicGridView.setOnItemClickListener(this.jdField_a_of_type_Abit);
      this.jdField_a_of_type_ComTencentWidgetDynamicGridView.setOnItemLongClickListener(this.jdField_a_of_type_Abit);
      this.jdField_a_of_type_Abit.a();
  ...
  {
    ThreadManager.post(new abis(this, paramString), 5, null, false);
  }
  ...
  public boolean a()
  {
    ...
    while (this.jdField_a_of_type_Abit.a() > 0) {
      return false;
    }
    return true;
  }
  ...
  public void d()
  {
    ...
    for (;;)
    {
      ...
      if (a()) {
        ...
        DialogUtil.a(this, getString(2131438908), 2131432998, 2131437709, new abio(this), new abip(this)).show();
      }
    }
  }
  ...
  protected void doOnActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      return;
      if ((!android.text.TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) && (this.jdField_a_of_type_Abit.a() < 9))
      {
  ...
  protected void doOnNewIntent(Intent paramIntent)
  {
    ...
    do
    {
      ...
      if ((!android.text.TextUtils.isEmpty(paramIntent)) && (this.jdField_a_of_type_Abit.a() < 9))
      {
        this.jdField_b_of_type_Boolean = true;
  ...
  public void e()
  {
    ...
    for (int j = 0;; j = this.jdField_a_of_type_ComTencentMobileqqCampuscircleCampusTopic.id)
    {
      ...
      while (i < this.jdField_a_of_type_Abit.a())
      {
        localObject2 = (String)this.jdField_a_of_type_Abit.getItem(i);
  ...
  protected void f()
  {
    if (QavCameraUsage.b(BaseApplicationImpl.getContext())) {
      a(true, 1, getString(2131434776), 0);
    }
    for (;;)
    {
      return;
      if (!Utils.a())
      {
        a(true, 1, getString(2131434753), 0);
        return;
      }
  ...
  protected void h()
  {
    TextView localTextView = (TextView)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131369834);
    if (this.jdField_a_of_type_ComTencentMobileqqCampuscircleCampusCircleHandler.a().jdField_c_of_type_Int == 1)
    {
      localTextView.setText(String.format(Locale.getDefault(), "%s(必选)", new Object[] { getString(2131438924) }));
      return;
    }
    localTextView.setText(2131438924);
  }
      ...
      do
      {
        do
        {
          do
          {
            ...
            } while ((!(paramMessage.obj instanceof String)) || (this.jdField_a_of_type_Abit.a() >= 9));
            this.jdField_a_of_type_Abit.a(this.jdField_a_of_type_Abit.a(), paramMessage.obj);
            this.jdField_a_of_type_Abit.a();
            return true;
          } while (!(paramMessage.obj instanceof ArrayList));
          paramMessage = (ArrayList)paramMessage.obj;
          this.jdField_a_of_type_Abit.d();
          int i = 0;
          while ((i < paramMessage.size()) && (this.jdField_a_of_type_Abit.a() < 9))
          {
            localObject = (String)paramMessage.get(i);
            if (!android.text.TextUtils.isEmpty((CharSequence)localObject)) {
              this.jdField_a_of_type_Abit.a(this.jdField_a_of_type_Abit.a(), localObject);
            }
            i += 1;
          }
          this.jdField_a_of_type_Abit.a();
        ...
        while (paramMessage.hasNext())
        {
          ...
          this.jdField_a_of_type_Abit.d(localObject);
        }
        this.jdField_a_of_type_Abit.a();
        return true;
  ...
  public void onCheckedChanged(CompoundButton paramCompoundButton, boolean paramBoolean)
  {
    ...
    label43:
    for (paramCompoundButton = paramCompoundButton.getColorStateList(2131493372);; paramCompoundButton = paramCompoundButton.getColorStateList(2131493370))
    {
  ...
  public void onClick(View paramView)
  {
    ...
    } while (paramView.getId() != 2131369834);
    g();
  }
