  ...
  extends DefaultFileModel
{
  ...
  private MessageObserver jdField_a_of_type_ComTencentMobileqqAppMessageObserver = new adlq(this);
  ...
  private void d(int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityMPFileFailedView.a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerIFileBrowser.a(), new adln(this), paramInt, this.jdField_b_of_type_Int);
  ...
  public IDownloadController a()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerControllerIDownloadController == null) {
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerControllerIDownloadController = new adlr(this);
    }
  ...
  public void a(byte[] paramArrayOfByte, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomSingleButtonDialog = new QQCustomSingleButtonDialog(this.jdField_a_of_type_AndroidAppActivity, 2131624516);
        this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomSingleButtonDialog.setContentView(2130968857);
        ...
        this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomSingleButtonDialog.a(2131427501, new adlp(this));
  ...
  protected void b()
  {
    ...
    {
      this.jdField_a_of_type_AndroidContentBroadcastReceiver = new adll(this);
    ...
    this.jdField_a_of_type_ComTencentMobileqqMsfSdkHandlerINetEventHandler = new adlm(this);
  ...
  protected void l()
  {
    ...
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityMPFileVerifyPwdView.a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerIFileBrowser.a(), new adlo(this));
