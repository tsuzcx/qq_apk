  ...
  extends DefaultFileModel
{
  ...
  {
    this.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new acty(this, paramTroopFileStatusInfo));
  }
  ...
  public IDownloadController a()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerControllerIDownloadController == null) {
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerControllerIDownloadController = new actx(this);
    }
  ...
  public IUploadController a()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerControllerIUploadController == null) {
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerControllerIUploadController = new actw(this);
    }
  ...
  public ArrayList a()
  {
    ...
    if ((i == 5) || (i == 4))
    {
      ...
      localArrayList.add(HorizontalListViewAdapter.a(2130841562, "存到微云", FileOperaterUtils.d(this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerIFileBrowser, localFileManagerEntity)));
      localArrayList.add(HorizontalListViewAdapter.a(2130841558, "发给好友", FileOperaterUtils.c(this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerIFileBrowser, localFileManagerEntity)));
      ...
      if (FileManagerUtil.c(localFileManagerEntity)) {
        localArrayList.add(HorizontalListViewAdapter.a(2130841536, "收藏", FileOperaterUtils.b(this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerIFileBrowser, localFileManagerEntity)));
      }
  ...
  public void a(FileBrowserModelBase.OnPreviewVideoOnlineListener paramOnPreviewVideoOnlineListener)
  {
    if (this.jdField_a_of_type_ComTencentBizTroopFileTroopFileProtocol$ReqDownloadFileObserver == null) {
      this.jdField_a_of_type_ComTencentBizTroopFileTroopFileProtocol$ReqDownloadFileObserver = new acub(this, paramOnPreviewVideoOnlineListener);
    }
    ThreadManager.post(new actr(this, this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerIFileViewerAdapter.a(), paramOnPreviewVideoOnlineListener), 8, null, true);
  }
  ...
  public boolean a(FileBrowserModelBase.OnPreviewVideoOnlineListener paramOnPreviewVideoOnlineListener)
  {
    ...
    TroopFileVideoOnlinePlayManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localFileManagerEntity.TroopUin, new actz(this, paramOnPreviewVideoOnlineListener, localTroopInfo, localTroopManager));
    return true;
  }
  ...
  protected void b()
  {
    ...
    do
    {
      ...
      {
        return;
        this.jdField_a_of_type_ComTencentMobileqqAppBizTroopObserver = new actv(this);
  ...
  public void f()
  {
    TroopFileProtocol.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerIFileViewerAdapter.a().TroopUin, this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerIFileViewerAdapter.a().strTroopFilePath, this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerIFileViewerAdapter.a().busId, new actp(this));
    TroopFileProtocol.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerIFileViewerAdapter.a().TroopUin, this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerIFileViewerAdapter.a().busId, this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerIFileViewerAdapter.a().strTroopFilePath, new actt(this));
  }
