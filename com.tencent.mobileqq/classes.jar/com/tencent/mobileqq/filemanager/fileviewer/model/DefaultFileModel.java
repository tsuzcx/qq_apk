  ...
  extends FileBrowserModelBase
{
  ...
  private void l()
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityFilePreviewActivity$ControlerCallback == null) {
        this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityFilePreviewActivity$ControlerCallback = new acsv(this);
      }
  ...
  public IThumbController a()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerControllerIThumbController == null) {
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerControllerIThumbController = new acsy(this);
    }
  ...
  public ArrayList a()
  {
    ...
    if ((localObject3 != null) && (!TextUtils.isEmpty(((FileManagerEntity)localObject3).WeiYunFileId)) && (!TextUtils.isEmpty(((FileManagerEntity)localObject3).WeiYunDirKey)))
    {
      ...
      if (i == 0)
      {
        ...
        localArrayList.add(HorizontalListViewAdapter.a(2130841562, "存到微云", FileOperaterUtils.a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerIFileBrowser, str)));
      }
      if (!bool) {
        break label483;
      }
    ...
    for (;;)
    {
      try
      {
        ...
        localObject3 = HorizontalListViewAdapter.a(2130841558, "发给好友", FileOperaterUtils.a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerIFileBrowser, (FileManagerEntity)localObject1, this.jdField_a_of_type_AndroidAppActivity));
        ...
        if (FileManagerUtil.c((FileManagerEntity)localObject1)) {
          localArrayList.add(HorizontalListViewAdapter.a(2130841536, "收藏", FileOperaterUtils.b(this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerIFileBrowser, (FileManagerEntity)localObject1)));
        }
        if ((bool) && (((DataLineHandler)((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime()).a(8)).a.a(a()))) {
          localArrayList.add(HorizontalListViewAdapter.a(2130841560, "打印", FileOperaterUtils.b(this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerIFileBrowser, b())));
        }
        if (bool) {
          localArrayList.add(HorizontalListViewAdapter.a(2130841559, "用其他应用打开", FileOperaterUtils.a(this.jdField_a_of_type_AndroidAppActivity, str)));
        }
        ...
        localArrayList.add(HorizontalListViewAdapter.a(2130841562, "存到微云", FileOperaterUtils.a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerIFileBrowser, (FileManagerEntity)localObject3)));
      }
      ...
      label483:
      HorizontalListViewAdapter.MenuData localMenuData = HorizontalListViewAdapter.a(2130841558, "发给好友", FileOperaterUtils.a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerIFileBrowser, (FileManagerEntity)localObject3, this.jdField_a_of_type_AndroidAppActivity));
  ...
  public void a(FileBrowserModelBase.OnVideoDataEventListener paramOnVideoDataEventListener)
  {
    ...
    FileVideoManager.a(c()).a(localFileManagerEntity, new actb(this, paramOnVideoDataEventListener));
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3, int paramInt, String paramString4, String paramString5, FileManagerEntity paramFileManagerEntity, TroopFileProtocol.OnGetZipFileList paramOnGetZipFileList)
  {
    ...
    {
      paramString1 = new HttpWebCgiAsyncTask2(str, "GET", new acsx(this, new ArrayList(), paramString4, paramFileManagerEntity, bool, paramString5, paramString1, paramString2, paramString3, paramInt, paramOnGetZipFileList), 1000, null);
  ...
  public ArrayList b()
  {
    ...
    for (;;)
    {
      if (bool)
      {
        localArrayList.add(HorizontalListViewAdapter.a(0, "保存到手机", new acsz(this)));
        localArrayList.add(HorizontalListViewAdapter.a(0, "用其他应用打开", new acta(this)));
      }
      return localArrayList;
  ...
  public void f()
  {
    ...
    for (;;)
    {
      ...
      QQToast.a(this.jdField_a_of_type_AndroidAppActivity, 1, this.jdField_a_of_type_AndroidAppActivity.getString(2131432992), 1).b(j());
      return;
