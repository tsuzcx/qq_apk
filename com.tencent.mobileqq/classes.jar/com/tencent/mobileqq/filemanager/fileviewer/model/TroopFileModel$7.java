...
public class TroopFileModel$7
  implements Runnable
{
  public TroopFileModel$7(argq paramargq, bbpe parambbpe) {}
  ...
  public void run()
  {
    ...
    Object localObject1 = this.this$0.jdField_a_of_type_Ardq.a();
    ...
    if (this.this$0.jdField_a_of_type_Arge != null) {
      this.this$0.jdField_a_of_type_Arge.a(this.a.e, this.a.jdField_c_of_type_JavaLangString);
    }
    switch (this.a.b)
    {
    }
    for (;;)
    {
      argq.a(this.this$0, this.a.b);
      return;
      if ((this.this$0.jdField_a_of_type_Argf != null) && (argq.a(this.this$0) != 8)) {
        this.this$0.jdField_a_of_type_Argf.d();
      }
      if (this.this$0.jdField_a_of_type_Argf != null)
      {
        this.this$0.jdField_a_of_type_Argf.a((float)this.a.d * 1.0F / ((float)this.a.jdField_c_of_type_Long * 1.0F));
        continue;
        if (this.this$0.jdField_a_of_type_Argf != null)
        {
          this.this$0.jdField_a_of_type_Argf.e();
          continue;
          ...
          FileManagerEntity localFileManagerEntity = arni.a(this.a);
          ...
          if ((this.this$0.b == 3) && (this.this$0.e() == 2))
          {
            ...
            if (this.this$0.jdField_a_of_type_Ardn != null)
            {
          ...
          {
            if (this.this$0.jdField_a_of_type_Argf != null) {
              this.this$0.jdField_a_of_type_Argf.f();
            }
          }
