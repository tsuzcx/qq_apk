...
public class TroopFileModel$7
  implements Runnable
{
  public TroopFileModel$7(aovz paramaovz, ayqd paramayqd) {}
  ...
  public void run()
  {
    ...
    Object localObject1 = this.this$0.jdField_a_of_type_Aotf.a();
    ...
    if (this.this$0.jdField_a_of_type_Aovn != null) {
      this.this$0.jdField_a_of_type_Aovn.a(this.a.e, this.a.jdField_c_of_type_JavaLangString);
    }
    switch (this.a.b)
    {
    }
    for (;;)
    {
      aovz.a(this.this$0, this.a.b);
      return;
      if ((this.this$0.jdField_a_of_type_Aovo != null) && (aovz.a(this.this$0) != 8)) {
        this.this$0.jdField_a_of_type_Aovo.d();
      }
      if (this.this$0.jdField_a_of_type_Aovo != null)
      {
        this.this$0.jdField_a_of_type_Aovo.a((float)this.a.d * 1.0F / ((float)this.a.jdField_c_of_type_Long * 1.0F));
        continue;
        if (this.this$0.jdField_a_of_type_Aovo != null)
        {
          this.this$0.jdField_a_of_type_Aovo.e();
          continue;
          ...
          FileManagerEntity localFileManagerEntity = apck.a(this.a);
          ...
          if ((this.this$0.b == 3) && (this.this$0.e() == 2))
          {
            ...
            if (this.this$0.jdField_a_of_type_Aotc != null)
            {
          ...
          {
            if (this.this$0.jdField_a_of_type_Aovo != null) {
              this.this$0.jdField_a_of_type_Aovo.f();
            }
          }
