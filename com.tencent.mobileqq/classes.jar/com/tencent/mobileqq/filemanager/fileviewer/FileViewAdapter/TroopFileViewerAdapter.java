  ...
  extends EntityFileViewerAdapter
{
  ...
  public TroopFileViewerAdapter(QQAppInterface paramQQAppInterface, FileManagerEntity paramFileManagerEntity)
  {
    ...
    if ((paramFileManagerEntity.isZipInnerFile) && (FileManagerUtil.a(paramQQAppInterface, this, true))) {
    ...
    {
      boolean bool2 = FileManagerUtil.a(this);
      if (c() == 3) {
  ...
  public String i()
  {
    ...
    if (104 == super.a().busId)
    {
      ...
      {
        str1 = str2 + BaseApplicationImpl.getContext().getString(2131692414);
