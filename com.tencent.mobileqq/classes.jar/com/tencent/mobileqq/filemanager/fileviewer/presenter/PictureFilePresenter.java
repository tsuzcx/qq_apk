  ...
  implements FileBrowserModelBase.OnThumbEventListener, FileBrowserModelBase.OnTransEventListener
{
  ...
  private String b()
  {
    ...
    String str = localImageFileInfo.a();
    if (TextUtils.isEmpty(str)) {
      return localImageFileInfo.b();
    }
    return str;
  }
  ...
  private void b()
  {
    ...
    int i;
    switch (this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerModelFileBrowserModelBase.l())
    {
    case 5: 
    case 6: 
    case 10: 
  ...
  public void a()
  {
    ...
    if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.get(this.jdField_a_of_type_Int) != null) && (this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerModelFileBrowserModelBase.e()))
    {
