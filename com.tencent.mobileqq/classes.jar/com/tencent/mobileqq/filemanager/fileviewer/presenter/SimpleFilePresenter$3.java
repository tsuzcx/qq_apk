...
public class SimpleFilePresenter$3
  implements Runnable
{
  public SimpleFilePresenter$3(asvn paramasvn) {}
  
  public void run()
  {
    String str = this.this$0.jdField_a_of_type_Asst.i();
    if ((TextUtils.isEmpty(str)) || (asvn.a(this.this$0)))
    {
    ...
    asvn.a(this.this$0).postDelayed(asvn.a(this.this$0), 1000L);
  }
}
