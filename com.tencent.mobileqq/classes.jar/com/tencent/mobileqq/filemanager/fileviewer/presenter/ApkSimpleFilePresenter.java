  ...
  implements FileBrowserModelBase.OnMMApkSafeCheckListener
{
  ...
  public void a()
  {
    ...
    String str = BaseApplicationImpl.getContext().getString(2131692757);
  ...
  public void a(int paramInt, String paramString1, String paramString2, Bundle paramBundle)
  {
    ...
    {
      paramBundle = BaseApplicationImpl.getContext().getString(2131692757);
  ...
  protected void h()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerModelFileBrowserModelBase.i() == 2) {
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerViewerSimpleFileViewer.a(HardCodeUtil.a(2131700372), new ApkSimpleFilePresenter.2(this));
    }
  }
}
