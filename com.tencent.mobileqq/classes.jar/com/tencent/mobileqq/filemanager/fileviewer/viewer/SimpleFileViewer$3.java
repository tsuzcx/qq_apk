  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if ((SimpleFileViewer.a(this.this$0) != null) && (SimpleFileViewer.b(this.this$0) != null) && ((BaseApplicationImpl.sApplication.getRuntime() instanceof QQAppInterface)))
    {
      ...
      if (localObject != null)
      {
        ...
        SimpleFileViewer.a(localSimpleFileViewer, ((LayoutInflater)localObject).inflate(2131560826, SimpleFileViewer.a(localSimpleFileViewer), false));
        ...
        ((ITencentDocConvertABTestUtil)QRoute.api(ITencentDocConvertABTestUtil.class)).configureABTest(localQQAppInterface, this.this$0.a, SimpleFileViewer.a(this.this$0), this.a, new SimpleFileViewer.3.1(this, localQQAppInterface));
      }
    }
  }
}
