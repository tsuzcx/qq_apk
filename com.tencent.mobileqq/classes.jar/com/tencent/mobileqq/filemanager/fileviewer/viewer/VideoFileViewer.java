  ...
  extends FileBrowserViewBase
{
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)BaseApplicationImpl.getContext().getSystemService("layout_inflater")).inflate(2130970036, this.jdField_a_of_type_AndroidViewViewGroup, false);
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368797));
      this.d = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368799));
      this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131368803));
      this.jdField_c_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131368806));
      this.f = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368808));
      this.f.setText("恢复发送");
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368807));
      this.jdField_c_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
      this.jdField_a_of_type_AndroidWidgetSeekBar = ((SeekBar)this.jdField_a_of_type_AndroidViewView.findViewById(2131368798));
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131366850));
      this.g = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368804));
      this.e = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368805));
      this.b = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131368778));
      if (ImmersiveUtils.isSupporImmersive() == 1) {
        ((RelativeLayout.LayoutParams)((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131363730)).getLayoutParams()).setMargins(0, ImmersiveUtils.a(this.jdField_a_of_type_AndroidAppActivity), 0, 0);
      }
    }
  }
  ...
  public void a(long paramLong, View.OnClickListener paramOnClickListener)
  {
    if (this.jdField_c_of_type_AndroidViewView == null)
    {
      ...
      this.jdField_c_of_type_AndroidViewView.setId(2131374739);
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    localTextView.setCompoundDrawablesWithIntrinsicBounds(0, 2130841603, 0, 0);
    ...
    if (FileUtil.b(paramString1))
    {
      ...
      paramString2.setOnClickListener(new acwb(this, paramString1));
    ...
    this.jdField_a_of_type_AndroidViewView.setOnClickListener(new acwc(this));
  }
  ...
  public void a(List paramList)
  {
    ...
    this.jdField_a_of_type_ComTencentWidgetActionSheet.a(new acwd(this, paramList));
  }
  ...
  public void d()
  {
    if (Build.VERSION.SDK_INT >= 11)
    {
      ...
      this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new acwe(this));
    }
  }
  ...
  public void d(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      this.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130842911);
      this.jdField_a_of_type_AndroidWidgetButton.setContentDescription(this.jdField_a_of_type_AndroidAppActivity.getString(2131437380));
      return;
    }
    this.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130842909);
    this.jdField_a_of_type_AndroidWidgetButton.setContentDescription(this.jdField_a_of_type_AndroidAppActivity.getString(2131437379));
  }
  ...
  public void g(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new acwa(this));
  }
}
