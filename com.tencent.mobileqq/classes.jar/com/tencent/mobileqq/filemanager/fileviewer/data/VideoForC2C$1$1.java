...
import com.tencent.mobileqq.filemanager.util.FileManagerUtil.CheckResult;
...
class VideoForC2C$1$1
  implements FileManagerUtil.CheckResult
{
  ...
  public void a(boolean paramBoolean)
  {
    ...
    while ((this.jdField_a_of_type_JavaLangString == null) || (this.jdField_a_of_type_JavaLangString.length() == 0))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerDataVideoForC2C$1.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreFileVideoDownloadManager$FileVideoManagerCallback.a((int)l, BaseApplication.getContext().getResources().getString(2131691044));
      return;
      if ((this.jdField_a_of_type_Long == -25081L) || (this.jdField_a_of_type_Long == -6101L) || (this.jdField_a_of_type_Long == -7003L))
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerDataVideoForC2C$1.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreFileVideoDownloadManager$FileVideoManagerCallback.a((int)this.jdField_a_of_type_Long, BaseApplication.getContext().getResources().getString(2131692793));
        return;
      }
      if (!this.jdField_a_of_type_Boolean)
      {
        this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerDataVideoForC2C$1.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreFileVideoDownloadManager$FileVideoManagerCallback.a((int)9045L, BaseApplication.getContext().getResources().getString(2131691044));
        return;
      }
    }
    ...
    localObject1 = VideoForC2C.a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerDataVideoForC2C$1.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerDataVideoForC2C, (String)localObject2, this.jdField_a_of_type_Short, (List)localObject1, this.jdField_b_of_type_Boolean);
