  ...
  implements BaseVideoBiz
{
  ...
  private String a(String paramString, int paramInt, List<String> paramList, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if ((paramBoolean) && (paramList != null) && (paramList.size() > 0))
      {
        ...
        paramString = FileIPv6StrateyController.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1, paramList);
  ...
  public String b()
  {
    return FMSettings.a().c() + MD5.a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.Uuid);
  }
