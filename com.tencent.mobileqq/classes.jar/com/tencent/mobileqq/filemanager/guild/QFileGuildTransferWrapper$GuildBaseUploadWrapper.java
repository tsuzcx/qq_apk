...
abstract class QFileGuildTransferWrapper$GuildBaseUploadWrapper
  implements IUFTUploadCallback
{
  boolean a = true;
  final QQAppInterface b;
  IUFTTransferKey c;
  final QFileGuildTransferWrapper.ITransferWrapperCallback d;
  
  public QFileGuildTransferWrapper$GuildBaseUploadWrapper(QQAppInterface paramQQAppInterface, QFileGuildTransferWrapper.ITransferWrapperCallback paramITransferWrapperCallback)
  {
  ...
  protected UFTTransferConfig a()
  {
    ...
    Object localObject = (IQFileConfigManager)this.b.getRuntimeService(IQFileConfigManager.class, "");
    localUFTTransferConfig.a().c(true);
    localUFTTransferConfig.a().d(FileIPv6StrateyController.b().isConfigEnableIPV6(this.b, 1));
  ...
  boolean a(int paramInt)
  {
    ...
    if (this.c != null)
    {
      ...
      ((IUFTTransferService)this.b.getRuntimeService(IUFTTransferService.class, "")).stop(this.c, localBundle);
    }
    return this.a;
  }
}
 ...
 * Qualified Name:     com.tencent.mobileqq.filemanager.guild.QFileGuildTransferWrapper.GuildBaseUploadWrapper
