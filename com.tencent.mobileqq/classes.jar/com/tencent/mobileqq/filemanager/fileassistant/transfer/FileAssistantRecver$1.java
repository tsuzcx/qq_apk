  ...
  extends FMObserver
{
  ...
  public void a(boolean paramBoolean, long paramLong1, long paramLong2, String paramString1, int paramInt1, int paramInt2, String paramString2)
  {
    ...
    {
      QLog.w("FileAssistantRecver<FileAssistant>.NFRV", 1, "offline failed errCode :" + paramInt2);
    ...
    QLog.i("FileAssistantRecver<FileAssistant>.NFRV", 1, "onFileTransferEnd :" + paramLong2);
  }
}
