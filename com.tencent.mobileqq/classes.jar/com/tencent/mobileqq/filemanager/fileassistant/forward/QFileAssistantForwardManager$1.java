  ...
  implements Runnable
{
  ...
  public void run()
  {
    if (NetworkUtil.getSystemNetwork(BaseApplication.getContext()) != 0) {
      QQToast.makeText(QFileAssistantForwardManager.a(this.this$0).getApp(), 2, this.a, 0).show(BaseApplication.getContext().getResources().getDimensionPixelSize(2131299920));
    }
  }
}
