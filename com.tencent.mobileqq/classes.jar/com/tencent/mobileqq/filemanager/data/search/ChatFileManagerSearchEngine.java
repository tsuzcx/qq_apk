  ...
  implements avuz<aoof>
{
  ...
  public List<aoof> a(avvn paramavvn)
  {
    ...
    if (this.b == 1)
    {
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(paramavvn.jdField_a_of_type_JavaLangString);
      localObject2 = ((Map)localObject1).keySet().iterator();
      while (((Iterator)localObject2).hasNext())
      {
        localObject3 = (String)((Iterator)localObject2).next();
        localaoof = new aoof();
        localaoof.jdField_a_of_type_JavaUtilList.addAll((Collection)((Map)localObject1).get(localObject3));
        localaoof.jdField_a_of_type_JavaLangString = paramavvn.jdField_a_of_type_JavaLangString;
        localaoof.jdField_a_of_type_Int = this.jdField_a_of_type_Int;
        if (this.jdField_a_of_type_AndroidOsBundle != null) {
          localaoof.b = this.jdField_a_of_type_AndroidOsBundle.getString("qfile_search_param_uin", "");
        }
        localArrayList1.add(localaoof);
      }
    }
        ...
        if ((i != -1) && (!TextUtils.isEmpty((CharSequence)localObject2)))
        {
          ...
          for (localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b((List)localObject1, (String)localObject2); localObject1 != null; localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(a(i), (String)localObject2))
          {
            ...
            while (((Iterator)localObject1).hasNext())
            {
              ...
              localaoof.jdField_a_of_type_JavaUtilList.addAll(localArrayList2);
              localaoof.jdField_a_of_type_JavaLangString = paramavvn.jdField_a_of_type_JavaLangString;
              localaoof.jdField_a_of_type_Int = this.jdField_a_of_type_Int;
              localaoof.b = ((String)localObject2);
              localArrayList1.add(localaoof);
            }
          }
        }
    ...
    else if ((this.b == 3) && (this.jdField_a_of_type_AndroidOsBundle != null))
    {
      ...
      {
        localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(paramavvn.jdField_a_of_type_JavaLangString, (String)localObject1, false).iterator();
        while (((Iterator)localObject2).hasNext())
        {
          ...
          localaoof.jdField_a_of_type_JavaLangString = paramavvn.jdField_a_of_type_JavaLangString;
          localaoof.jdField_a_of_type_Int = this.jdField_a_of_type_Int;
          localaoof.b = ((String)localObject1);
          localArrayList1.add(localaoof);
        }
      }
    }
  ...
  public void a(avvn paramavvn, avva<aoof> paramavva)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataSearchChatFileManagerSearchEngine$SearchRunnable.jdField_a_of_type_Avvn = paramavvn;
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataSearchChatFileManagerSearchEngine$SearchRunnable.jdField_a_of_type_Avva = paramavva;
  ...
  public void b()
  {
    synchronized (this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataSearchChatFileManagerSearchEngine$SearchRunnable)
    {
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataSearchChatFileManagerSearchEngine$SearchRunnable.jdField_a_of_type_Avvn = null;
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataSearchChatFileManagerSearchEngine$SearchRunnable.jdField_a_of_type_Avva = null;
      ThreadManager.removeJobFromThreadPool(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataSearchChatFileManagerSearchEngine$SearchRunnable, 64);
      return;
    }
  }
