  ...
  extends FileSelectorSearchResultModel
{
  ...
  protected void b(View paramView)
  {
    ...
    {
      TeamWorkUtils.a(localFileManagerEntity.Uuid, paramView, this.jdField_a_of_type_Int, localFileManagerEntity, paramView.app);
      return;
    }
    CommonFileBrowserParams localCommonFileBrowserParams = new CommonFileBrowserParams(paramView.app, paramView, localFileManagerEntity, 10001);
    ...
    paramView = new FileBrowserCreator(paramView, localCommonFileBrowserParams);
    paramView.a(7);
    if (this.jdField_a_of_type_Int != 0) {
      paramView.a(this.jdField_a_of_type_Int);
    }
    paramView.a(HardCodeUtil.a(2131704533));
    paramView.a();
  }
  ...
  public boolean b()
  {
    ...
    if (localFileManagerEntity != null) {
      return FMDataCache.a(localFileManagerEntity);
    }
    return false;
  }
  ...
  public String c()
  {
    ...
    {
      if (localFileManagerEntity.nFileType == 13) {
        localObject1 = TeamWorkUtils.f(localFileManagerEntity.Uuid);
      }
      return localObject1;
      if (i == 5) {
  ...
  protected void c(View paramView)
  {
    ...
    for (;;)
    {
      if ((localFileManagerEntity.cloudType == 3) && (!FileUtil.b(localFileManagerEntity.getFilePath())))
      {
        FMToastUtil.a(FileManagerUtil.d(localFileManagerEntity.fileName) + HardCodeUtil.a(2131709588));
        FMDataCache.b(localFileManagerEntity);
      }
      return;
  ...
  public CharSequence d()
  {
    ...
    if (j > 1)
    {
      ...
      ((SpannableStringBuilder)localObject1).append("\"").append(HardCodeUtil.a(2131692401));
    ...
    if (str.indexOf(HardCodeUtil.a(2131692392)) == 0) {
      localSpannableStringBuilder.append(HardCodeUtil.a(2131692392) + " ");
    }
    for (;;)
    {
      localObject1 = str;
      ...
      try
      {
        ...
        return this.jdField_b_of_type_JavaLangCharSequence;
        if (str.indexOf(HardCodeUtil.a(2131692396)) == 0)
        {
          localSpannableStringBuilder.append(HardCodeUtil.a(2131692396) + " ");
        }
        else if (str.indexOf(HardCodeUtil.a(2131692393)) == 0)
        {
          localSpannableStringBuilder.append(HardCodeUtil.a(2131692393) + " ");
          i = 4;
        }
        else if (str.indexOf(HardCodeUtil.a(2131692397)) == 0)
        {
          localSpannableStringBuilder.append(HardCodeUtil.a(2131692397) + " ");
          i = 4;
        }
        else if (str.indexOf(HardCodeUtil.a(2131692391)) == 0)
        {
          localSpannableStringBuilder.append(HardCodeUtil.a(2131692391) + " ");
          i = 2;
        }
        else if (str.indexOf(HardCodeUtil.a(2131692395)) == 0)
        {
          localSpannableStringBuilder.append(HardCodeUtil.a(2131692395) + "  ");
          i = 2;
        }
        else if (str.indexOf(HardCodeUtil.a(2131692394)) == 0)
        {
          localSpannableStringBuilder.append(HardCodeUtil.a(2131692394));
          i = 2;
        }
      }
