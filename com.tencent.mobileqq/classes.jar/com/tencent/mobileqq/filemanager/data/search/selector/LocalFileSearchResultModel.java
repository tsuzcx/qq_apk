  ...
  extends FileSelectorSearchResultModel
{
  ...
  protected void b(View paramView)
  {
    ...
    paramView = new FileBrowserCreator(paramView, new CommonFileBrowserParams(paramView.app, paramView, (FileManagerEntity)localObject, 10000));
    paramView.a(8);
    paramView.a();
  }
  ...
  public boolean b()
  {
    ...
    if (localFileInfo != null) {
      return FMDataCache.a(localFileInfo);
    }
    return false;
  }
  ...
  protected void c(View paramView)
  {
    ...
    for (;;)
    {
      if (!FileUtil.b(paramView.c()))
      {
        FMToastUtil.a(FileManagerUtil.d(paramView.d()) + HardCodeUtil.a(2131709598));
        FMDataCache.b(paramView);
      }
      return;
  ...
  public CharSequence d()
  {
    ...
    if (i > 1)
    {
      localSpannableStringBuilder = new SpannableStringBuilder(i + HardCodeUtil.a(2131704537) + "\"");
      ...
      localSpannableStringBuilder.append("\"").append(HardCodeUtil.a(2131692401));
      this.b = localSpannableStringBuilder;
      return this.b;
    }
    SpannableStringBuilder localSpannableStringBuilder = new SpannableStringBuilder();
    localSpannableStringBuilder.append(SearchUtils.a(a((FileInfo)this.jdField_a_of_type_JavaUtilList.get(0)), this.jdField_a_of_type_JavaLangString));
    if (this.b == null) {
      this.b = localSpannableStringBuilder;
    }
    return this.b;
