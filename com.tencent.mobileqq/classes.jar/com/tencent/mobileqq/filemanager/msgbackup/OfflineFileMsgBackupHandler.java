...
{
  public OfflineFileMsgBackupHandler(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    String str2 = FMSettings.a().d();
    String str1 = QFileUtils.a(paramInt, com.tencent.securitysdk.utils.MD5.a(paramString1));
    paramString1 = str1;
    if (!FileUtil.b(str2 + str1))
    {
      paramString1 = str1;
      if (!TextUtils.isEmpty(paramString2)) {
        paramString1 = QFileUtils.a(paramInt, com.tencent.securitysdk.utils.MD5.a(paramString2));
      }
    }
    return paramString1;
  }
  ...
  private boolean a(MessageRecord paramMessageRecord, List<MsgBackupResEntity> paramList)
  {
    ...
    Object localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerProxy().e((String)localObject1);
    if (localObject2 == null) {}
    for (localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerProxy().a((String)localObject1);; localObject1 = localObject2)
    {
          ...
          for (;;)
          {
            ...
            if ((a((MsgBackupResEntity)localObject2)) && (b(paramMessageRecord, (MsgBackupResEntity)localObject2)))
            {
              ...
              if (!TextUtils.isEmpty(str))
              {
                ...
                {
                  if (FileUtils.b(((FileManagerEntity)localObject1).strLargeThumPath)) {
                    continue;
                  }
                  localObject2 = a((FileManagerEntity)localObject1, 7, str);
                  if ((FileUtils.b(((FileManagerEntity)localObject1).strLargeThumPath)) || (!FileUtils.b((String)localObject2))) {
                    continue;
                  }
                  ...
                  continue;
                  if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().a(paramMessageRecord.frienduin, paramMessageRecord.istroop, paramMessageRecord.shmsgseq, paramMessageRecord.msgtype) != null) {
                    break;
                  }
                ...
                if ((((MsgBackupResEntity)localObject2).msgSubType == 11) && (!FileUtils.b(((FileManagerEntity)localObject1).getFilePath())))
                {
  ...
  private void c(MessageRecord paramMessageRecord, List<MsgBackupResEntity> paramList)
  {
    ...
    if (paramMessageRecord.isMultiMsg)
    {
      ...
      localFileManagerEntity = FileManagerUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)paramMessageRecord);
    }
    for (;;)
    {
      label139:
              ...
              if ((a((MsgBackupResEntity)localObject)) && (b(paramMessageRecord, (MsgBackupResEntity)localObject)))
              {
                ...
                if (!TextUtils.isEmpty(str)) {
                  if (((MsgBackupResEntity)localObject).msgSubType == 12)
                  {
                    ...
                    localFileManagerEntity.peerNick = FileManagerUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localFileManagerEntity.peerUin, null, localFileManagerEntity.peerType);
  ...
  protected String a(MessageRecord paramMessageRecord, int paramInt)
  {
    ...
    try
    {
      ...
      FileManagerEntity localFileManagerEntity = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerDataCenter().a(paramMessageRecord.uniseq, paramMessageRecord.frienduin, paramMessageRecord.istroop);
      if (localFileManagerEntity == null)
      {
      ...
      for (paramInt = i;; paramInt = 0)
      {
        ...
        QLog.i("OfflineFileMsgBackupHandler<QFile>", 1, "buildResourceInfo: can not handle peerType[" + localFileManagerEntity.peerType + "] msgInfo[" + QFileUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord) + "]");
        break;
      }
      return "{}";
    }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (paramMsgBackupResEntity.msgSubType == 11)
        {
          ...
          str2 = (String)localHashMap.get("bytes_file_uuid");
          str2 = com.tencent.qphone.base.util.MD5.toMD5(str1 + str2);
          if (QLog.isDebugVersion()) {
  ...
  public void a(MessageRecord paramMessageRecord, List<MsgBackupResEntity> paramList)
  {
    ...
    for (Object localObject1 = FileManagerUtil.a((ChatMessage)paramMessageRecord);; localObject1 = paramMessageRecord)
    {
      Object localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerDataCenter().a(((MessageRecord)localObject1).uniseq, ((MessageRecord)localObject1).frienduin, ((MessageRecord)localObject1).istroop);
      if (localObject2 == null) {
        QLog.i("OfflineFileMsgBackupHandler<QFile>", 1, "handleExport: get offline file entity null. " + QFileUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageRecord)localObject1, false));
      }
      for (;;)
      {
        return;
        int i = FileManagerUtil.a(((FileManagerEntity)localObject2).fileName);
        if ((i == 0) || (i == 2))
        {
  ...
  public boolean a(MessageRecord paramMessageRecord, MsgBackupResEntity paramMsgBackupResEntity)
  {
    ...
    do
    {
      ...
      paramMessageRecord = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerProxy().a(paramMessageRecord);
      if (paramMessageRecord == null) {
        return true;
      }
      if (paramMsgBackupResEntity.msgSubType == 12)
      {
        bool1 = FileUtils.b(paramMessageRecord.strLargeThumPath);
    ...
    boolean bool2 = FileUtils.b(paramMessageRecord.getFilePath());
  ...
  public void b(MessageRecord paramMessageRecord, List<MsgBackupResEntity> paramList)
  {
    if (QLog.isDebugVersion())
    {
      QLog.i("<QFile_Backup>", 1, "Import: type[offline]" + QFileUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord));
      if (paramList != null)
      {
