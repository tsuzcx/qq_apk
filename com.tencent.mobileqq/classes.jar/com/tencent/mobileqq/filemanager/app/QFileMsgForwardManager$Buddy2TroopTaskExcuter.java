  ...
  extends QFileMsgForwardManager.TaskExcuter
{
  ...
  void a(String paramString, int paramInt, QFileMsgForwardManager.OnUploadCallback paramOnUploadCallback)
  {
    ...
    {
      QFileMsgForwardManager.a(this.i).getFileManagerEngine().b().a(paramString, paramInt, this.b, this.c, this.a, this.g, 102, new QFileMsgForwardManager.Buddy2TroopTaskExcuter.1(this, paramString, paramOnUploadCallback));
      return;
    }
    if (QLog.isColorLevel())
    {
