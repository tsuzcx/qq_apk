  ...
  implements FileForwardManager.ForwarResult
{
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      if (QLog.isColorLevel()) {
        QLog.e("FileMultiMsgManager<FileAssistant>", 1, this.jdField_a_of_type_ComTencentMobileqqFilemanagerAppQFileMsgForwardManager$Buddy2DiscTaskExcuter.jdField_a_of_type_JavaLangString + " Buddy2DiscTaskExcuter faild:" + paramInt);
      }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    localBundle.putString("_m_ForwardSize", this.jdField_a_of_type_ComTencentMobileqqFilemanagerAppQFileMsgForwardManager$Buddy2DiscTaskExcuter.jdField_a_of_type_Long + "");
    ...
    if (QLog.isColorLevel()) {
      QLog.e("FileMultiMsgManager<FileAssistant>", 1, this.jdField_a_of_type_ComTencentMobileqqFilemanagerAppQFileMsgForwardManager$Buddy2DiscTaskExcuter.jdField_a_of_type_JavaLangString + " Buddy2DiscTaskExcuter success");
    }
