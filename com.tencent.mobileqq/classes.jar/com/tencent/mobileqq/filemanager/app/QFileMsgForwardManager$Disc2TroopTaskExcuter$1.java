  ...
  implements FileForwardManager.ForwarResult
{
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      if (QLog.isColorLevel()) {
        QLog.e("FileMultiMsgManager<FileAssistant>", 1, this.jdField_a_of_type_ComTencentMobileqqFilemanagerAppQFileMsgForwardManager$Disc2TroopTaskExcuter.jdField_a_of_type_JavaLangString + " Disc2TroopTaskExcuter send faild:" + paramInt);
      }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    paramString2.putString("_m_ForwardSize", this.jdField_a_of_type_ComTencentMobileqqFilemanagerAppQFileMsgForwardManager$Disc2TroopTaskExcuter.jdField_a_of_type_Long + "");
    ...
    label248:
    for (int j = 0;; j = Integer.parseInt(this.jdField_a_of_type_ComTencentMobileqqFilemanagerAppQFileMsgForwardManager$Disc2TroopTaskExcuter.f))
    {
      if (QLog.isColorLevel()) {
        QLog.e("FileMultiMsgManager<FileAssistant>", 1, this.jdField_a_of_type_ComTencentMobileqqFilemanagerAppQFileMsgForwardManager$Disc2TroopTaskExcuter.jdField_a_of_type_JavaLangString + " Disc2TroopTaskExcuter send success send feeds");
      }
