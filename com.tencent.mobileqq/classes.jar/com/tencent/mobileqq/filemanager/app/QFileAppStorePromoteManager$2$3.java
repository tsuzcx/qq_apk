  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    atiw localatiw = (atiw)atip.a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerAppQFileAppStorePromoteManager$2.this$0).remove(Integer.valueOf(this.jdField_a_of_type_Int));
