...
class QFileMsgForwardManager$Disc2TroopTaskExcuter
  extends QFileMsgForwardManager.TaskExcuter
{
  ...
  QFileMsgForwardManager$Disc2TroopTaskExcuter(QFileMsgForwardManager paramQFileMsgForwardManager, MessageRecord paramMessageRecord)
  {
  ...
  void a(String paramString, int paramInt, QFileMsgForwardManager.OnUploadCallback paramOnUploadCallback)
  {
    if ("1".equals(this.h))
    {
      if (QLog.isColorLevel())
      {
        ...
        paramString.append("start Disc2TroopTaskExcuter:");
    ...
    {
      QFileMsgForwardManager.a(this.i).getFileManagerEngine().b().a(paramString, paramInt, this.d, 102, this.b, this.a, this.g, this.c, new QFileMsgForwardManager.Disc2TroopTaskExcuter.1(this, paramString, paramOnUploadCallback));
      return;
    }
    if (QLog.isColorLevel())
    {
      paramString = new StringBuilder();
      paramString.append(this.a);
      paramString.append(" Disc2TroopTaskExcuter send faild uuid is null");
 ...
 * Qualified Name:     com.tencent.mobileqq.filemanager.app.QFileMsgForwardManager.Disc2TroopTaskExcuter
