  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    for (QFileMsgForwardManager.QFileUploadRequest localQFileUploadRequest = (QFileMsgForwardManager.QFileUploadRequest)QFileMsgForwardManager.a(this.this$0).remove(this.a);; localQFileUploadRequest = null)
    {
      ...
      Iterator localIterator = localQFileUploadRequest.jdField_a_of_type_JavaUtilHashMap.keySet().iterator();
