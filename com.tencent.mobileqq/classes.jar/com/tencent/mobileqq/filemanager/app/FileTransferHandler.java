...
public class FileTransferHandler
{
  ...
  private FileTransferHandler.OlFileInfo a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      localOlFileInfo.jdField_a_of_type_JavaLangString = new String(arrayOfByte, "UTF-16LE");
      if (i >= j + 4)
      {
        ...
        localOlFileInfo.jdField_a_of_type_Long = ((PkgTools.getLongData(paramArrayOfByte, j) << 32) + l);
  ...
  private FileManagerEntity a(hummer_resv_21.ResvAttr paramResvAttr)
  {
    ...
    if (localFileAssitInfo.uint64_session_id.has())
    {
      ...
      if (paramResvAttr != null)
      {
        ...
        {
          l1 = l2;
          if (QFileAssistantUtils.a(paramResvAttr.device_type.get()) == 2) {
            l1 = l2 | 0x0;
          }
        }
      }
      localFileManagerEntity.nSessionId = l1;
      paramResvAttr = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerDataCenter().a(l1);
      if (paramResvAttr != null) {
        localStringBuilder.append("setWlan Sessionid:" + paramResvAttr.nSessionId);
      }
    }
    for (;;)
    {
      ...
      {
        paramResvAttr.dlGroupId = localFileAssitInfo.uint32_group_id.get();
        localStringBuilder.append(" groupId:" + paramResvAttr.dlGroupId);
      }
      if (localFileAssitInfo.uint32_group_count.has())
      {
        paramResvAttr.dlGroupCount = localFileAssitInfo.uint32_group_count.get();
        localStringBuilder.append(" groupCount:" + paramResvAttr.dlGroupCount);
      }
      if (localFileAssitInfo.uint32_group_idx.has())
      {
        paramResvAttr.dlGourpIndex = localFileAssitInfo.uint32_group_idx.get();
        localStringBuilder.append(" groupIndex:" + paramResvAttr.dlGourpIndex);
      }
  ...
  private List<String> a(FileTransferHandler.FileUploadInfo paramFileUploadInfo, List<String> paramList, cmd0x346.ApplyUploadRspV2 paramApplyUploadRspV2)
  {
  ...
  private List<String> a(FileTransferHandler.FileUploadInfo paramFileUploadInfo, List<String> paramList, cmd0x346.ApplyUploadRspV3 paramApplyUploadRspV3)
  {
  ...
  private List<String> a(FileTransferHandler.FileUploadInfo paramFileUploadInfo, List<String> paramList, cmd0x346.RspBody paramRspBody)
  {
  ...
  private void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, String paramString1, String paramString2, long paramLong1, short paramShort, boolean paramBoolean1, boolean paramBoolean2, int paramInt1, String paramString3, String paramString4, String paramString5, long paramLong2, int paramInt2, long paramLong3, long paramLong4, String paramString6, TempSessionInfo paramTempSessionInfo, int paramInt3, hummer_resv_21.ResvAttr paramResvAttr, byte[] paramArrayOfByte, String paramString7)
  {
    ...
    FileManagerEntity localFileManagerEntity = a(paramResvAttr);
    if (localFileManagerEntity == null) {
      localFileManagerEntity = a(paramMessageHandler, paramString1, paramString2, paramLong1, paramShort, paramBoolean1, paramBoolean2, paramInt1, paramString3, paramString4, paramString5, paramLong2, paramInt2, paramLong3, paramLong4);
    }
    for (;;)
    {
      if (localFileManagerEntity == null) {
      ...
      for (;;)
      {
        ...
        localFileManagerEntity.nFileType = FileManagerUtil.a(paramString5);
        a(paramString1, paramMessageHandler, paramString3, paramTempSessionInfo, paramArrayOfByte, paramString7, localFileManagerEntity);
        if ((paramResvAttr != null) && (paramResvAttr.file_image_info != null) && (paramResvAttr.file_image_info.has()))
        {
          ...
          localFileManagerEntity.imgWidth = paramString4.uint32_file_width.get();
          localFileManagerEntity.imgHeight = paramString4.uint32_file_height.get();
        }
        if ((paramResvAttr != null) && (paramResvAttr.file_apk_info != null) && (paramResvAttr.file_apk_info.has())) {
          a((hummer_resv_21.FileApkInfo)paramResvAttr.file_apk_info.get(), localFileManagerEntity);
        }
        ...
        if (TextUtils.isEmpty(localFileManagerEntity.Uuid))
        {
          ...
          FileManagerUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localFileManagerEntity.nSessionId, "actFileDownDetail", 0L, "", localFileManagerEntity.selfUin, localFileManagerEntity.Uuid, localFileManagerEntity.strFileMd5, 9081L, paramString4, 0L, 0L, paramLong2, "", "", 0, "uuid null", null);
        }
        ...
        FileManagerUtil.a(localFileManagerEntity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, null);
        if (QLog.isDevelopLevel()) {
          QLog.w("FileTransferHandler<FileAssistant>", 2, "offline file come:fileName[" + paramString5 + "],uuid[" + paramString3 + "] insert To AIO");
        }
        if (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerDataCenter().b(localFileManagerEntity.nSessionId))
        {
          QLog.i("FileTransferHandler<FileAssistant>", 1, "MsgRecord is not exsited, addAIOMsg uniseq:" + localFileManagerEntity.uniseq);
          this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerDataCenter().b(localFileManagerEntity.nSessionId);
          localFileManagerEntity.uniseq = a(paramList, paramString1, paramMessageHandler, paramString5, paramLong2, paramBoolean1, i, str, paramShort, paramShort, paramString3, paramInt1, localFileManagerEntity.uniseq, paramLong4, paramLong3, paramLong1, -2005, paramInt3, paramResvAttr);
          this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerDataCenter().c(localFileManagerEntity);
        }
        if ((QFileAssistantUtils.a(localFileManagerEntity.peerUin)) && (localFileManagerEntity.status != 16) && (QFileAssistantUtils.a(paramMessageHandler)) && (QFileAssistantUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localFileManagerEntity.fileSize))) {
        ...
        return;
        paramMessageHandler = a(paramString2, paramTempSessionInfo);
        break;
        label1417:
        i = 0;
        continue;
  ...
  private void a(List<MessageRecord> paramList, String paramString1, boolean paramBoolean1, boolean paramBoolean2, long paramLong1, int paramInt1, hummer_resv_21.ResvAttr paramResvAttr, long paramLong2, long paramLong3, short paramShort, String paramString2, int paramInt2, long paramLong4, String paramString3, String paramString4)
  {
    ...
    a(paramList, paramString1, paramString3, paramString2, paramLong4, paramBoolean1, 0, paramString4, paramShort, paramShort, "", paramInt2, l, paramLong2, paramLong1, paramLong3, -3008, paramInt1, paramResvAttr);
  }
  ...
  private void a(boolean paramBoolean, FileManagerEntity paramFileManagerEntity, String paramString1, int paramInt, String paramString2, long paramLong)
  {
    if (paramBoolean)
    {
      ...
      default: 
        if (QLog.isDevelopLevel()) {
          throw new NullPointerException(HardCodeUtil.a(2131704597));
        }
        break;
      case 21: 
    ...
    do
    {
      ...
      do
      {
        ...
        } while (!(paramFileManagerEntity.mContext instanceof IForwardCallBack));
      ...
      throw new NullPointerException(HardCodeUtil.a(2131704598));
  ...
  private boolean a(long paramLong, boolean paramBoolean, List<MessageRecord> paramList, int paramInt, msg_comm.Msg paramMsg, msg_comm.MsgHead paramMsgHead)
  {
    ...
    if (((!MessageUtils.c(i)) || (!paramMsgHead.c2c_cmd.has()) || (j != 169)) && ((i != 529) || (j != 4))) {
      return false;
    }
  ...
  private boolean a(ProtoReqManagerImpl.ProtoResp paramProtoResp, FileTransferHandler.FileUploadInfo paramFileUploadInfo)
  {
    if (a(paramProtoResp))
    {
  ...
  private boolean a(String paramString1, String paramString2, long paramLong1, long paramLong2, long paramLong3, List<MessageRecord> paramList, String paramString3)
  {
    if (paramLong1 != 0L)
    {
      ...
      if (localObject != null)
      {
        ...
        {
          paramString1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().b(String.valueOf(paramString1), ((FileManagerEntity)localObject).peerType, ((FileManagerEntity)localObject).uniseq);
      ...
      do
      {
        do
        {
          do
          {
            ...
            paramString2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().b(paramString1, localFileManagerEntity.peerType, localFileManagerEntity.uniseq);
    ...
    for (;;)
    {
      ...
      catch (UnsupportedEncodingException localUnsupportedEncodingException1)
      {
        ...
        if (paramGroupFile.equals(String.valueOf(paramLong3)))
        {
          ...
          localFileManagerEntity.peerNick = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131692589);
          localFileManagerEntity.bSend = true;
          localFileManagerEntity.isReaded = true;
          localFileManagerEntity.bOnceSuccess = true;
        }
  ...
  private void h(ProtoReqManagerImpl.ProtoReq paramProtoReq, ProtoReqManagerImpl.ProtoResp paramProtoResp)
  {
    ...
    for (;;)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        localOfflineFileInfo.jdField_c_of_type_Long = (MessageCache.a() * 1000L + localFileInfo.uint32_life_time.get() * 1000L);
  ...
  private void j(ProtoReqManagerImpl.ProtoReq paramProtoReq, ProtoReqManagerImpl.ProtoResp paramProtoResp)
  {
    ...
    for (boolean bool5 = true;; bool5 = false)
    {
      for (;;)
      {
        localObject = (FileTransferHandler.PreviewBusiData)paramProtoReq.busiData;
        if (!a(bool2, bool3, bool4, bool5, ((FileTransferHandler.PreviewBusiData)localObject).b())) {
          break label303;
        }
        ((FileTransferHandler.PreviewBusiData)localObject).a();
        a(paramProtoReq.ssoCmd, paramProtoReq.reqBody, (FileTransferHandler.PreviewBusiData)localObject);
        return;
      ...
      break;
      localList = a(localFileUploadInfo, null, (cmd0x346.RspBody)localObject);
      bool1 = true;
      break;
      bool2 = false;
      break label55;
    ...
    a(((FileTransferHandler.PreviewBusiData)localObject).a(), 5004, bool2, new Object[] { localFileUploadInfo, paramProtoReq, localList });
  }
  ...
  private void k(ProtoReqManagerImpl.ProtoReq paramProtoReq, ProtoReqManagerImpl.ProtoResp paramProtoResp)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        ((StatictisInfo)localObject).jdField_b_of_type_Int = localFileUploadInfo.jdField_a_of_type_Int;
        ((StatictisInfo)localObject).jdField_c_of_type_Int = paramProtoResp.freeRunnalbleIndex;
        if (QLog.isColorLevel()) {
        ...
        a(((FileTransferHandler.PreviewBusiData)paramProtoReq.busiData).a(), 5005, bool, new Object[] { localFileUploadInfo, localObject });
        return;
        if (paramProtoResp.resp.getResultCode() != 1000)
        {
  ...
  private void n(ProtoReqManagerImpl.ProtoReq paramProtoReq, ProtoReqManagerImpl.ProtoResp paramProtoResp)
  {
    ...
    case 9: 
    default: 
      QLog.e("FileTransferHandler<FileAssistant>", 1, "handleDiscGetFileInfo: subcmd[" + localPreviewBusiData.a() + "] is not implemented");
    case 4: 
    case 5: 
      return;
    case 1: 
  ...
  private void o(ProtoReqManagerImpl.ProtoReq paramProtoReq, ProtoReqManagerImpl.ProtoResp paramProtoResp)
  {
    ...
    for (paramProtoResp = "";; paramProtoResp = "")
    {
      ...
      bool = false;
      l = ((FileTransferHandler.PreviewBusiData)paramProtoReq.busiData).a();
  ...
  private void r(ProtoReqManagerImpl.ProtoReq paramProtoReq, ProtoReqManagerImpl.ProtoResp paramProtoResp)
  {
    ...
    Object localObject2;
    int i;
    FileTransferHandler.PreviewBusiData localPreviewBusiData;
    long l2;
    label135:
    boolean bool;
    label151:
    ...
    if (a(paramProtoResp.resp.getResultCode()))
    {
      ...
      l1 = -100001L;
      if (l1 != 0L) {}
      localPreviewBusiData = (FileTransferHandler.PreviewBusiData)paramProtoReq.busiData;
      if (l1 != -100001L) {
        break label669;
      }
      l2 = 9043L;
    ...
    label753:
    label759:
    for (paramProtoReq = (ProtoReqManagerImpl.ProtoReq)localObject1;; paramProtoReq = "")
    {
      for (;;)
      {
        ...
        a(localPreviewBusiData.a(), 5013, bool, new Object[] { Long.valueOf(l2), str3, str4, localObject2, Integer.valueOf(i), localObject1, str2, Integer.valueOf(paramProtoResp.resp.getAppSeq()), Long.valueOf(localPreviewBusiData.a()), localBundle });
        return;
        if (paramProtoResp.resp.getResultCode() != 1000)
        {
      ...
      break;
      localObject3 = new FileTransferHandler.DiscDownloadInfo(this, l1, "", 80, "", "", "", "", (short)0, "", localBundle, (cmd0x345.RspBody.SubCmd0x3RspBody)((cmd0x345.RspBody)localObject2).msg_subcmd_0x3_rsp_body.get()).a();
      l1 = ((FileTransferHandler.DiscDownloadInfo)localObject3).a();
      localObject2 = ((FileTransferHandler.DiscDownloadInfo)localObject3).a();
      i = ((FileTransferHandler.DiscDownloadInfo)localObject3).a();
      String str1 = ((FileTransferHandler.DiscDownloadInfo)localObject3).b();
      str2 = ((FileTransferHandler.DiscDownloadInfo)localObject3).c();
      str3 = ((FileTransferHandler.DiscDownloadInfo)localObject3).d();
      str4 = ((FileTransferHandler.DiscDownloadInfo)localObject3).e();
      s = ((FileTransferHandler.DiscDownloadInfo)localObject3).a();
      localObject3 = ((FileTransferHandler.DiscDownloadInfo)localObject3).f();
      break;
      if (l1 == -100003L)
      {
        l2 = 9045L;
  ...
  private void s(ProtoReqManagerImpl.ProtoReq paramProtoReq, ProtoReqManagerImpl.ProtoResp paramProtoResp)
  {
    ...
    for (;;)
    {
      ...
      {
        bool = false;
        localObject5 = (FileTransferHandler.PreviewBusiData)paramProtoReq.busiData;
        if (l == -100001L)
        {
          l = 9043L;
          label129:
          ...
          a(((FileTransferHandler.PreviewBusiData)localObject5).a(), 5015, bool, new Object[] { Long.valueOf(l), localObject1, paramProtoResp, localObject2, localObject3, Integer.valueOf(i), str1, str2, paramProtoReq });
          return;
          if (paramProtoResp.resp.getResultCode() != 1000)
          {
                    ...
                    for (str3 = ((cmd0x345.RspBody.SubCmd0x1RspBody)localObject4).str_https_domain.get();; str3 = null)
                    {
                      ...
                      for (s = (short)((cmd0x345.RspBody.SubCmd0x1RspBody)localObject4).uint32_https_port.get();; s = 0)
                      {
                        ...
                        for (localObject4 = ((cmd0x345.RspBody.SubCmd0x1RspBody)localObject4).str_dns.get();; localObject4 = "")
                        {
                          ...
                          for (int j = 1;; j = 0)
                          {
                            int k = ((FileTransferHandler.PreviewBusiData)localObject5).b();
                            if ((j == 0) || (k >= 3)) {
                              break;
                            }
                            ((FileTransferHandler.PreviewBusiData)localObject5).a();
                            a(paramProtoReq.ssoCmd, paramProtoReq.reqBody, (FileTransferHandler.PreviewBusiData)localObject5);
                            return;
                          }
                          break label129;
                          break label106;
  ...
  private void u(ProtoReqManagerImpl.ProtoReq paramProtoReq, ProtoReqManagerImpl.ProtoResp paramProtoResp)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        a(((FileTransferHandler.PreviewBusiData)paramProtoReq.busiData).a(), 5020, bool, new Object[] { localFileUploadInfo, localObject, null });
        return;
        if (paramProtoResp.resp.getResultCode() != 1000)
        {
          localFileUploadInfo.jdField_a_of_type_Int = -100002;
      ...
      for (;;)
      {
        ...
        if (localApplyUploadHitRspV2.str_upload_https_domain.has()) {
          localFileUploadInfo.jdField_c_of_type_JavaLangString = localApplyUploadHitRspV2.str_upload_https_domain.get();
        }
        if (localApplyUploadHitRspV2.uint32_upload_https_port.has()) {
          localFileUploadInfo.jdField_b_of_type_Short = ((short)localApplyUploadHitRspV2.uint32_upload_https_port.get());
        }
        if (localApplyUploadHitRspV2.str_upload_dns.has()) {
          localFileUploadInfo.jdField_d_of_type_JavaLangString = localApplyUploadHitRspV2.str_upload_dns.get();
        }
        bool = true;
        break;
  ...
  public long a(List<MessageRecord> paramList, String paramString1, String paramString2, String paramString3, long paramLong1, boolean paramBoolean, int paramInt1, String paramString4, long paramLong2, long paramLong3, String paramString5, int paramInt2, long paramLong4, long paramLong5, long paramLong6, long paramLong7, int paramInt3, int paramInt4, hummer_resv_21.ResvAttr paramResvAttr)
  {
    ...
    for (;;)
    {
      if (paramInt3 == -3008)
      {
        ...
        ((SVIPHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.SVIP_HANDLER)).a(paramString5);
      }
      for (;;)
      {
        paramString5.vipBubbleDiyTextId = paramInt4;
        if ((paramResvAttr != null) && (paramResvAttr.file_image_info.has()))
        {
          paramString3 = (hummer_resv_21.FileImgInfo)paramResvAttr.file_image_info.get();
          paramString5.saveExtInfoToExtStr("file_pic_width", String.valueOf(paramString3.uint32_file_width.get()));
          paramString5.saveExtInfoToExtStr("file_pic_heigth", String.valueOf(paramString3.uint32_file_height.get()));
          QLog.i("FileTransferHandler<FileAssistant>", 1, "Insert ThumbSize toMsg height[" + paramString3.uint32_file_width.get() + "], width[" + paramString3.uint32_file_height.get() + "]");
        }
        if (paramInt3 == -2005) {
        ...
        paramString5.createMessageUniseq();
        break;
        ...
        if (paramLong6 != -1L) {
          ...
          paramString5.vipBubbleID = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().a(paramString1);
        }
      }
    }
  }
  ...
  public void a(int paramInt1, int paramInt2, FileTransferObserver paramFileTransferObserver)
  {
    a(paramInt1, paramInt2, paramFileTransferObserver, 0);
  }
  ...
  public void a(long paramLong, byte[] paramArrayOfByte, String paramString)
  {
    ...
    int i;
    switch (localFileManagerEntity.nFileType)
    {
    case 1: 
    default: 
      i = 0;
    ...
    for (;;)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("FileTransferHandler<FileAssistant>", 2, "send0x211C2CDatalineMsg DataLineMsgRecord:" + localFileManagerEntity.nSessionId);
      }
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          {
            return;
            str2 = FileManagerUtil.a(paramNotOnlineFile.bytes_file_name.get().toStringUtf8());
            ...
            str3 = FileHttpUtils.a(paramNotOnlineFile.bytes_file_md5.get().toByteArray());
            ...
            if (paramNotOnlineFile.bytes_file_uuid.has())
            {
              ...
              if (QLog.isColorLevel()) {
                QLog.d("FileTransferHandler<FileAssistant>", 2, "offline file come, msgTime[" + l2 + "] msgSeq[" + s + "] msgUid[" + l1 + "]  fileName[" + str2 + "] uuid[" + str4 + "] fileType[" + i + "] subCmd[" + j + "] strMd5[" + str3 + "]");
              }
            }
            if (i == 1)
            {
              a(paramList, paramString, paramBoolean1, paramBoolean2, paramLong, paramInt, paramResvAttr, l1, l2, s, str2, i, l4, String.valueOf(l3), str1);
              return;
            }
            if (paramNotOnlineFile.bytes_file_uuid.has()) {
              break;
      ...
      if ((paramResvAttr != null) && (paramResvAttr.file_apk_info.has())) {
        hummer_resv_21.FileApkInfo localFileApkInfo = (hummer_resv_21.FileApkInfo)paramResvAttr.file_apk_info.get();
      }
      a(paramMessageHandler, paramList, paramString, String.valueOf(l3), l2, s, paramBoolean1, paramBoolean2, i, str4, str1, str2, l4, j, paramLong, l1, str3, localTempSessionInfo, paramInt, paramResvAttr, paramNotOnlineFile.bytes_pb_reserve.get().toByteArray(), paramNotOnlineFile.bytes_note.get().toStringUtf8());
      if ((paramList.size() > 0) && (QFileAssistantUtils.a(l3 + "")) && (paramResvAttr != null) && (paramResvAttr.device_type.has()))
      {
        paramInt = paramResvAttr.device_type.get();
        paramMessageHandler = paramList.iterator();
        while (paramMessageHandler.hasNext())
        {
          paramString = (MessageRecord)paramMessageHandler.next();
          if (TextUtils.isEmpty(paramString.getExtInfoFromExtStr("dataline_msg_device_type"))) {
            QFileAssistantUtils.a(paramString, paramInt);
          }
        }
      }
    } while (((localTempSessionInfo == null) || (localTempSessionInfo.jdField_a_of_type_Int != 1024)) && (!BmqqSegmentUtil.a(BaseApplicationImpl.getContext(), String.valueOf(l3))));
  ...
  public void a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    cmd0x346.ReqBody localReqBody = new cmd0x346.ReqBody();
    localReqBody.msg_apply_forward_file_req.set(localApplyForwardFileReq);
    localReqBody.uint32_cmd.set(700);
    Object localObject = localReqBody.uint32_seq;
    int i = jdField_a_of_type_Int;
    jdField_a_of_type_Int = i + 1;
    ((PBUInt32Field)localObject).set(i);
    ...
    {
      paramFileManagerEntity = new FileTransferHandler.PreviewBusiData(this, false, paramFileManagerEntity.nSessionId);
      a("OfflineFilleHandleSvr.pb_ftn_CMD_REQ_APPLY_FORWARD_FILE-700", localReqBody.toByteArray(), paramFileManagerEntity, 30000, 3, 1);
      return;
  ...
  public void a(ProtoReqManagerImpl.ProtoReq paramProtoReq, ProtoReqManagerImpl.ProtoResp paramProtoResp)
  {
    ...
    for (int j = 1;; j = 0)
    {
      for (;;)
      {
        Object localObject1 = (FileTransferHandler.PreviewBusiData)paramProtoReq.busiData;
        int k = ((FileTransferHandler.PreviewBusiData)localObject1).b();
        if (((j == 0) && (i == 0)) || (k >= 3)) {
          break label432;
        }
        ((FileTransferHandler.PreviewBusiData)localObject1).a();
        a(paramProtoReq.ssoCmd, paramProtoReq.reqBody, (FileTransferHandler.PreviewBusiData)localObject1);
        return;
        if (paramProtoResp.resp.getResultCode() != 1000)
        {
      ...
      for (;;)
      {
        DownloadRespInfo.a(localDownloadRespInfo, (cmd0x346.ApplyDownloadRsp)((cmd0x346.RspBody)localObject2).msg_apply_download_rsp.get(), bool1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount());
    ...
    if (QLog.isColorLevel())
    {
      localObject2 = new StringBuilder().append("handleDownloadResp: return ").append(bool2).append(", retCode=").append(l).append(", retMsg=").append(localDownloadRespInfo.jdField_a_of_type_JavaLangString).append(", key=");
      if (localDownloadRespInfo.jdField_a_of_type_ComTencentMobileqqPbByteStringMicro == null) {
        break label857;
      }
    }
    label857:
    for (paramProtoReq = localDownloadRespInfo.jdField_a_of_type_ComTencentMobileqqPbByteStringMicro.toStringUtf8();; paramProtoReq = "")
    {
      QLog.d("FileTransferHandler<FileAssistant>", 2, paramProtoReq + ", strIP=" + localDownloadRespInfo.jdField_b_of_type_JavaLangString + ", port=" + localDownloadRespInfo.jdField_a_of_type_Short + ", strUrl=" + localDownloadRespInfo.jdField_c_of_type_JavaLangString + ", strHttpsDomain=" + localDownloadRespInfo.h + ", httpsPort=" + localDownloadRespInfo.jdField_b_of_type_Short);
      paramProtoReq = new Bundle();
      ...
      a(localInvalidProtocolBufferMicroException.a(), 5006, bool2, new Object[] { Long.valueOf(l), localDownloadRespInfo.jdField_a_of_type_JavaLangString, localDownloadRespInfo.jdField_d_of_type_JavaLangString, localDownloadRespInfo.jdField_a_of_type_ComTencentMobileqqPbByteStringMicro, Boolean.valueOf(bool1), localDownloadRespInfo.jdField_b_of_type_JavaLangString, Short.valueOf(localDownloadRespInfo.jdField_a_of_type_Short), localDownloadRespInfo.jdField_c_of_type_JavaLangString, localDownloadRespInfo.jdField_a_of_type_JavaUtilList, Integer.valueOf(paramProtoResp.resp.getAppSeq()), localDownloadRespInfo.jdField_e_of_type_JavaLangString, localDownloadRespInfo.jdField_f_of_type_JavaLangString, localDownloadRespInfo.g, Long.valueOf(localInvalidProtocolBufferMicroException.a()), paramProtoReq });
      return;
    }
  }
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, long paramLong)
  {
    ...
    for (;;)
    {
      if ((bool) && (paramLong > 0L))
      {
        ...
        if (localObject != null)
        {
          l2 = FileManagerUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((FileManagerEntity)localObject).fileName);
  ...
  public void a(String paramString1, String paramString2, String paramString3, long paramLong, String paramString4, String paramString5, FileTransferObserver paramFileTransferObserver)
  {
    ...
    paramString2 = new FileTransferHandler.PreviewBusiData(this, false, 0L, paramFileTransferObserver, 1);
  ...
  public void a(SubMsgType0x4.WlanRecvNotify paramWlanRecvNotify)
  {
    ...
    long l1 = paramWlanRecvNotify.uint64_session_id.get();
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerDataCenter().b(l1))
    {
      QLog.i("FileTransferHandler<FileAssistant>", 1, l1 + " is exsited, igone!");
      return;
    }
    ...
    int m = QFileAssistantUtils.a(i);
    int n = QFileAssistantUtils.a(j);
    int i1 = QFileAssistantUtils.a(k);
    if (m == 2) {
      l1 |= 0x0;
    }
    for (;;)
    {
      ...
      String str = paramWlanRecvNotify.str_file_name.get();
      long l2 = paramWlanRecvNotify.uint64_file_size.get();
      ...
      {
        bool = true;
        QLog.i("FileTransferHandler<FileAssistant>.NFRV", 1, "sendType:" + i + ",recvType:" + j + ",currentType:" + k + ",parentSendType:" + m + ",parentCurrentType:" + i1);
        if ((i1 != m) && (i1 != n)) {
          break label441;
        }
        localFileManagerEntity.status = 16;
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerDataCenter().a(localFileManagerEntity);
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerDataCenter().a(paramWlanRecvNotify, str, bool, i, localFileManagerEntity);
  ...
  public boolean a(String paramString, FileManagerEntity paramFileManagerEntity, FileTransferObserver paramFileTransferObserver)
  {
    ...
    label500:
    for (localObject1 = (hummer_resv_21.ResvAttr)localMsgBody.resv_attr.get();; localObject1 = new hummer_resv_21.ResvAttr())
    {
  ...
  public void b(int paramInt1, int paramInt2, FileTransferObserver paramFileTransferObserver)
  {
    b(paramInt1, paramInt2, paramFileTransferObserver, 0);
  }
  ...
  protected void b(ProtoReqManagerImpl.ProtoReq paramProtoReq, ProtoReqManagerImpl.ProtoResp paramProtoResp)
  {
    ...
    for (;;)
    {
      ...
      a(((FileTransferHandler.PreviewBusiData)paramProtoReq.busiData).a(), 5007, bool, new Object[] { localFileUploadInfo, localObject });
      return;
      if (paramProtoResp.resp.getResultCode() != 1000)
      {
        localFileUploadInfo.jdField_a_of_type_Int = -100002;
  ...
  {
    long l1 = paramFromServiceMsg.getResultCode();
    boolean bool;
    if ((l1 == 1002L) || (l1 == 1013L))
    {
      QLog.i("FileTransferHandler<FileAssistant>", 1, "handleWlanNotify: resp is timeout[" + paramFromServiceMsg + "]");
      l1 = -100001L;
      bool = true;
    }
    for (;;)
    {
      ...
      for (int i = 1;; i = 0)
      {
        ...
        l1 = -100002L;
        QLog.i("FileTransferHandler<FileAssistant>", 1, "handleWlanNotify: resp is failed[" + paramFromServiceMsg + "]");
        bool = false;
        break;
      }
      label171:
      long l2 = paramFromServiceMsg.extraData.getLong("ServerReplyCode", 0L);
      if ((l2 != 0L) && (l2 != 241L))
      {
        bool = false;
        l1 = l2;
      ...
      for (;;)
      {
        QLog.i("FileTransferHandler<FileAssistant>", 1, "handleWlanNotify bSuccess: " + bool + ", serverCode : " + l1);
        return;
      }
      label249:
      bool = true;
  ...
  protected void c(ProtoReqManagerImpl.ProtoReq paramProtoReq, ProtoReqManagerImpl.ProtoResp paramProtoResp)
  {
    ...
    for (paramProtoResp = ((cmd0x346.ApplyDownloadAbsRsp)localObject3).str_ret_msg.get();; paramProtoResp = null)
    {
      if ((i == 0) && (!((cmd0x346.ApplyDownloadAbsRsp)localObject3).msg_download_info.has()))
      {
        ...
        paramProtoResp = (ProtoReqManagerImpl.ProtoResp)localObject8;
        break;
      }
  ...
  protected void d(ProtoReqManagerImpl.ProtoReq paramProtoReq, ProtoReqManagerImpl.ProtoResp paramProtoResp)
  {
    ...
    for (;;)
    {
      ...
      l3 = ((FileTransferHandler.PreviewBusiData)paramProtoReq.busiData).a();
      if (bool1)
      {
      ...
      try
      {
        ((IForwardCallBack)paramProtoReq.mContext).a(bool1, paramProtoReq.strTroopFileUuid, paramProtoReq.nSessionId, i, paramProtoResp, String.valueOf(paramProtoReq.peerUin), (String)localObject2);
        return;
      }
      ...
      for (paramProtoResp = ((cmd0x346.ApplyCopyToRsp)localObject1).str_ret_msg.get();; paramProtoResp = null)
      {
        ...
        for (localObject1 = ((cmd0x346.ApplyCopyToRsp)localObject1).str_file_key.get();; localObject1 = null)
        {
          ...
          if ((QFileAssistantUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) && (QFileAssistantUtils.a(paramProtoReq.peerUin)))
          {
            ...
            QLog.i("FileTransferHandler<FileAssistant>", 1, "notify to old device[" + bool + "]:" + paramProtoReq.nSessionId);
            return;
          }
          if ((i == -6101) || (i == -7003))
          {
  ...
  public void f(ProtoReqManagerImpl.ProtoReq paramProtoReq, ProtoReqManagerImpl.ProtoResp paramProtoResp)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        a(((FileTransferHandler.PreviewBusiData)paramProtoReq.busiData).a(), 5004, bool, new Object[] { localFileUploadInfo, localObject, localList });
        return;
        if (paramProtoResp.resp.getResultCode() != 1000)
        {
          localFileUploadInfo.jdField_a_of_type_Int = -100002;
      ...
      if (localRspBody.uint32_flag_use_media_platform.has()) {
        ...
        {
          bool = true;
          localFileUploadInfo.jdField_b_of_type_Boolean = bool;
          QLog.i("FileTransferHandler<FileAssistant>", 1, "handleUploadResponseV3: bUseMediaPlatform " + localFileUploadInfo.jdField_b_of_type_Boolean);
        }
      }
      for (;;)
      {
        label536:
        localList = a(localFileUploadInfo, null, (cmd0x346.ApplyUploadRspV3)localRspBody.msg_apply_upload_rsp_v3.get());
        if (localFileUploadInfo.jdField_a_of_type_Int != 0) {
          break label625;
        }
        bool = true;
