  ...
  implements ProtoReqManagerImpl.IProtoRespBack
{
  ...
  public ProtocolManager(QQAppInterface paramQQAppInterface)
  {
  ...
  private void b(ProtoReqManagerImpl.ProtoReq paramProtoReq, ProtoReqManagerImpl.ProtoResp paramProtoResp)
  {
    ...
    for (;;)
    {
      ...
      ((ProtocolFileCallback.OnForwardOfflineResult)((ProtocolManager.CustomData)paramProtoReq.busiData).a()).a(bool, i, paramProtoResp, (String)localObject, null, 0L, 0L);
      return;
      if (paramProtoResp.resp.getResultCode() != 1000)
      {
        i = -100002;
  ...
  private void c(ProtoReqManagerImpl.ProtoReq paramProtoReq, ProtoReqManagerImpl.ProtoResp paramProtoResp)
  {
    ...
    {
      ((ProtocolFileCallback.OnForwardOfflineResult)((ProtocolManager.CustomData)paramProtoReq.busiData).a()).a(bool, i, (String)localObject1, paramProtoResp, null, 0L, 0L);
      return;
      if (paramProtoResp.resp.getResultCode() == 1000) {
        break;
      }
  ...
  public void a(String paramString1, int paramInt1, String paramString2, int paramInt2, ProtocolManager.FileInfo paramFileInfo, int paramInt3, int paramInt4, ProtocolFileCallback.OnForwardOfflineResult paramOnForwardOfflineResult)
  {
    ...
    localSubCmd0x6ReqBody.uint64_file_size.set(paramFileInfo.jdField_a_of_type_Long);
    localSubCmd0x6ReqBody.bytes_uuid.set(ByteStringMicro.copyFrom(paramFileInfo.b.getBytes()));
    if (!TextUtils.isEmpty(paramFileInfo.c)) {
      localSubCmd0x6ReqBody.bytes_file_md5.set(ByteStringMicro.copyFrom(paramFileInfo.c.getBytes()));
    }
    ...
    localSubCmd0x6ReqBody.str_file_name.set(paramFileInfo.jdField_a_of_type_JavaLangString);
    localSubCmd0x6ReqBody.str_src_file_path.set(paramFileInfo.b);
    ...
    if ((paramInt1 != 1) && (paramInt1 != 0))
    {
      ...
      paramString1 = FileManagerUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1, paramInt1);
    ...
    paramString2 = new ProtocolManager.CustomData(this, paramOnForwardOfflineResult);
    paramString2.a(7);
  ...
  public void a(String paramString1, int paramInt1, String paramString2, String paramString3, int paramInt2, int paramInt3, ProtocolFileCallback.OnForwardOfflineResult paramOnForwardOfflineResult)
  {
    ...
    if (paramInt1 != 0)
    {
      ...
      byte[] arrayOfByte = FileManagerUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1, paramInt1);
      if (arrayOfByte != null) {
    ...
    if ((((IQFileConfigManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getRuntimeService(IQFileConfigManager.class, "")).isMediaPlatformEnabled()) || (QFileAssistantUtils.a(paramString1)))
    {
    ...
    for (;;)
    {
      paramString1 = new ProtocolManager.CustomData(this, paramOnForwardOfflineResult);
  ...
  public void a(String paramString1, String paramString2, ProtocolManager.FileInfo paramFileInfo, int paramInt1, int paramInt2, int paramInt3, ProtocolFileCallback.OnForwardOfflineResult paramOnForwardOfflineResult)
  {
    ...
    localApplyCopyToReq.uint64_file_size.set(paramFileInfo.jdField_a_of_type_Long);
    localApplyCopyToReq.str_file_name.set(paramFileInfo.jdField_a_of_type_JavaLangString);
  ...
  public void a(String paramString1, String paramString2, ProtocolManager.FileInfo paramFileInfo, ProtocolFileCallback.OnForwardOfflineResult paramOnForwardOfflineResult)
  {
    ...
    localSubCmd0x5ReqBody.bytes_src_file_path.set(ByteStringMicro.copyFrom(paramFileInfo.b.getBytes()));
    localSubCmd0x5ReqBody.uint32_dst_uin.set(Integer.parseInt(paramString1));
    localSubCmd0x5ReqBody.uint64_file_size.set(paramFileInfo.jdField_a_of_type_Long);
    localSubCmd0x5ReqBody.uint32_from_uin.set(Integer.parseInt(paramString2));
    localSubCmd0x5ReqBody.str_file_name.set(paramFileInfo.jdField_a_of_type_JavaLangString);
    if ((paramFileInfo.c != null) && (paramFileInfo.c.length() > 0)) {
      localSubCmd0x5ReqBody.bytes_md5.set(ByteStringMicro.copyFrom(paramFileInfo.c.getBytes()));
    }
    paramString1 = new cmd0x345.ReqBody();
  ...
  public void a(String paramString1, String paramString2, String paramString3, long paramLong, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, int paramInt1, int paramInt2, ProtocolFileCallback.OnSendLocalFileToBuddy paramOnSendLocalFileToBuddy)
  {
    ...
    paramString1 = new ProtocolManager.CustomData(this, paramOnSendLocalFileToBuddy);
  ...
  public void a(String paramString, byte[] paramArrayOfByte, int paramInt1, int paramInt2, ProtocolFileCallback.SetSendBuddyFileSuccessResult paramSetSendBuddyFileSuccessResult)
  {
    ...
    if (paramSetSendBuddyFileSuccessResult != null) {
      paramString = new ProtocolManager.CustomData(this, paramSetSendBuddyFileSuccessResult);
    }
    ...
    for (;;)
    {
      ...
      else if ("GTalkFileAppSvr.CMD_DISCUSS_FILE".equals(paramProtoReq.ssoCmd))
      {
        ...
        if (i == 6) {
          ...
          QLog.w("ProtocolManager", 1, "unspourt:" + localCustomData.a());
        }
      }
