  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (this.a.a.nFileType == 0)
    {
      ...
      localStringBuilder.append(this.a.a.nSessionId);
      ...
      this.a.this$0.a.getFileManagerEngine().d(this.a.a, 7);
      return;
    }
    if (this.a.a.nFileType == 2)
    {
      localStringBuilder = new StringBuilder();
      localStringBuilder.append("Id[");
      localStringBuilder.append(this.a.a.nSessionId);
      ...
      QLog.i("FileTransferHandler<FileAssistant>", 1, localStringBuilder.toString());
      this.a.this$0.a.getFileManagerEngine().b(this.a.a);
    }
  }
}
