...
public class FileTransferObserver
{
  void a(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    default: 
      ...
      return;
    case 5004: 
      a(paramBoolean, (FileTransferHandler.FileUploadInfo)localObject[0], (StatictisInfo)localObject[1], (List)localObject[2]);
      return;
    case 5005: 
      a(paramBoolean, (FileTransferHandler.FileUploadInfo)localObject[0], (StatictisInfo)localObject[1]);
      return;
    case 5006: 
      ...
      return;
    case 5007: 
      b(paramBoolean, (FileTransferHandler.FileUploadInfo)localObject[0], (StatictisInfo)localObject[1]);
      return;
    case 5013: 
    ...
    case 5016: 
      ...
      return;
    case 5020: 
      b(paramBoolean, (FileTransferHandler.FileUploadInfo)localObject[0], (StatictisInfo)localObject[1], (List)localObject[2]);
      return;
    case 5022: 
  ...
  protected void a(boolean paramBoolean, FileTransferHandler.FileUploadInfo paramFileUploadInfo, StatictisInfo paramStatictisInfo) {}
  
  protected void a(boolean paramBoolean, FileTransferHandler.FileUploadInfo paramFileUploadInfo, StatictisInfo paramStatictisInfo, List<String> paramList) {}
  ...
  protected void b(boolean paramBoolean, FileTransferHandler.FileUploadInfo paramFileUploadInfo, StatictisInfo paramStatictisInfo) {}
  
  protected void b(boolean paramBoolean, FileTransferHandler.FileUploadInfo paramFileUploadInfo, StatictisInfo paramStatictisInfo, List<String> paramList) {}
