...
public class FileTransferHandler$3
  implements Runnable
{
  public FileTransferHandler$3(aofe paramaofe, String paramString, int paramInt, short paramShort, long paramLong1, long paramLong2) {}
  ...
  public void run()
  {
    ...
    if (localFileManagerEntity != null)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("FileTransferHandler<FileAssistant>", 2, "online change to offline, update offline msg seq , uid and msgTime" + apck.a(localFileManagerEntity));
      }
    }
  }
}
