...
public class FileTransferHandler$7
  implements Runnable
{
  public FileTransferHandler$7(aowc paramaowc, FileManagerEntity paramFileManagerEntity, hummer_resv_21.FileImgInfo paramFileImgInfo, SubMsgType0x4.MsgBody paramMsgBody, aowi paramaowi, Handler paramHandler, String paramString) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      localFMTransC2CMsgInfo.fileTransferObserver = this.jdField_a_of_type_Aowi;
      ...
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strQRUrl = apug.e(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity);
