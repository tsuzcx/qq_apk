...
public class FileTransferHandler$7
  implements Runnable
{
  public FileTransferHandler$7(aszj paramaszj, FileManagerEntity paramFileManagerEntity, hummer_resv_21.FileImgInfo paramFileImgInfo, SubMsgType0x4.MsgBody paramMsgBody, aszq paramaszq, Handler paramHandler, String paramString) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      localFMTransC2CMsgInfo.fileTransferObserver = this.jdField_a_of_type_Aszq;
      ...
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strQRUrl = atvo.e(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity);
