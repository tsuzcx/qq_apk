...
public class FileTransferHandler$7
  implements Runnable
{
  public FileTransferHandler$7(atrd paramatrd, FileManagerEntity paramFileManagerEntity, hummer_resv_21.FileImgInfo paramFileImgInfo, SubMsgType0x4.MsgBody paramMsgBody, atrl paramatrl, Handler paramHandler, String paramString) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      localFMTransC2CMsgInfo.fileTransferObserver = this.jdField_a_of_type_Atrl;
      ...
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strQRUrl = aunj.e(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity);
