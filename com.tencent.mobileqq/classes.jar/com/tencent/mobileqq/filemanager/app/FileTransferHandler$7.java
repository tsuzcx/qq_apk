...
public class FileTransferHandler$7
  implements Runnable
{
  public FileTransferHandler$7(atht paramatht, FileManagerEntity paramFileManagerEntity, hummer_resv_21.FileImgInfo paramFileImgInfo, SubMsgType0x4.MsgBody paramMsgBody, atib paramatib, Handler paramHandler, String paramString) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      localFMTransC2CMsgInfo.fileTransferObserver = this.jdField_a_of_type_Atib;
      ...
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strQRUrl = auea.e(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity);
