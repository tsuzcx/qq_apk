...
public class FileTransferHandler$7
  implements Runnable
{
  public FileTransferHandler$7(aovy paramaovy, FileManagerEntity paramFileManagerEntity, hummer_resv_21.FileImgInfo paramFileImgInfo, SubMsgType0x4.MsgBody paramMsgBody, aowe paramaowe, Handler paramHandler, String paramString) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      localFMTransC2CMsgInfo.fileTransferObserver = this.jdField_a_of_type_Aowe;
      ...
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strQRUrl = apue.e(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity);
