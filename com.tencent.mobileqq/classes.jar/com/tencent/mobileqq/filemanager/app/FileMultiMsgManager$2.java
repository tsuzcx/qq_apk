...
public class FileMultiMsgManager$2
  implements Runnable
{
  public FileMultiMsgManager$2(aoea paramaoea, long paramLong) {}
  
  public void run()
  {
    if (aoea.a(this.this$0).containsKey(Long.valueOf(this.a))) {}
    for (aoew localaoew = (aoew)aoea.a(this.this$0).remove(Long.valueOf(this.a));; localaoew = null)
    {
      if ((localaoew != null) && (localaoew.jdField_a_of_type_Arxn != null))
      {
        ArrayList localArrayList = new ArrayList();
        Iterator localIterator = localaoew.jdField_a_of_type_JavaUtilHashMap.keySet().iterator();
        if (localIterator.hasNext())
        {
          Object localObject = (String)localIterator.next();
          localObject = (ArrayList)localaoew.jdField_a_of_type_JavaUtilHashMap.get(localObject);
          int i = 0;
          label112:
          ...
          if (i < ((ArrayList)localObject).size())
          {
            ...
            if (apck.a(localMessageRecord))
            {
              ...
              localMessageRecord = aoea.a(this.this$0).a().a().a(localMessageRecord, str, true);
        ...
        aoea.a(this.this$0).a().a().a(localArrayList, null);
        if (localaoew.d.size() > 0)
        {
          if (QLog.isColorLevel()) {
            QLog.i("FileMultiMsgManager<FileAssistant>", 1, "removeMultiRequest : remove upload request uinseq = [" + this.a + "] resultCode[1]");
          }
          localaoew.jdField_a_of_type_Arxn.a(1, 2, localaoew.jdField_a_of_type_Arya);
        }
      }
      else
      {
      ...
      localaoew.jdField_a_of_type_Arxn.a(0, 2, localaoew.jdField_a_of_type_Arya);
      return;
    }
  }
}
