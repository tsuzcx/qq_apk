  ...
  extends IphoneTitleBarActivity
{
  ...
  {
    super.setContentViewNoTitle(2130970043);
    ((RelativeLayout)findViewById(2131368826)).addView(((LayoutInflater)getSystemService("layout_inflater")).inflate(paramInt, null));
    init(getIntent());
  }
}
