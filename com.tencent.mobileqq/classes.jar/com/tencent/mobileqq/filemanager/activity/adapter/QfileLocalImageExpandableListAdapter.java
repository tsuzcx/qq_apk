  ...
  extends QfileBaseExpandableListAdapter
{
  ...
  private View a(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    acxi localacxi = (acxi)paramView.getTag();
    int i = 0;
    for (;;)
    {
      View localView;
      if (i < 4)
      {
        localView = b(paramInt1, paramInt2 * 4 + i, paramBoolean, localacxi.a[i], paramViewGroup);
        if (localView != null) {}
      }
      else
      {
  ...
  private LinearLayout a(ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup.setTag(new acxi(null));
  ...
  private View b(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (Object localObject = (FileInfo)paramViewGroup;; localObject = null)
    {
      ...
      try
      {
        paramViewGroup = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130970034, null);
        ...
        try
        {
          ...
          paramView = paramViewGroup;
          localImageHolder.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131368809));
          paramView = paramViewGroup;
          localImageHolder.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131368808));
          paramView = paramViewGroup;
          ...
          paramView = paramViewGroup;
          localImageHolder.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setDefaultImage(2130844568);
          paramView = paramViewGroup;
