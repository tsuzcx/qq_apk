  ...
  extends FMObserver
{
  ...
  protected void a(int paramInt, long paramLong, String paramString)
  {
    ...
    ((IOpenWeiyunVipHelper)QRoute.api(IOpenWeiyunVipHelper.class)).showWeiYunSpaceOrFlowLimitDialog(this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity, paramInt);
  }
  ...
  protected void a(ThumbnailInfo paramThumbnailInfo)
  {
    ...
    if ((paramThumbnailInfo.a instanceof FileManagerEntity))
    {
      ...
      if ((paramThumbnailInfo.b != null) && (paramThumbnailInfo.b.length() > 0))
      {
        ...
        ((IQQFileDataCenter)QfileBaseRecentFileTabView.p(this.a).getRuntimeService(IQQFileDataCenter.class, "")).updateFileEntity(localFileManagerEntity);
        this.a.i();
      }
    }
  }
  ...
  protected void a(Integer paramInteger, long paramLong, String paramString)
  {
    ...
    ((IOpenWeiyunVipHelper)QRoute.api(IOpenWeiyunVipHelper.class)).showWeiYunSpaceOrFlowLimitDialog(this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity, paramInteger.intValue());
  }
  ...
  {
    Object localObject = ((IQQFileDataCenter)QfileBaseRecentFileTabView.q(this.a).getRuntimeService(IQQFileDataCenter.class)).queryFileEntity(paramLong1, paramString1, paramInt1, paramLong2);
    if (localObject == null)
    {
      paramString2 = QfileBaseRecentFileTabView.jdField_a_of_type_JavaLangString;
    ...
    if (!paramBoolean)
    {
      ...
      ((IOpenWeiyunVipHelper)QRoute.api(IOpenWeiyunVipHelper.class)).showWeiYunSpaceOrFlowLimitDialog(this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity, paramInt2);
    }
    else
    {
      paramInt1 = ((FileManagerEntity)localObject).nOpType;
      if ((paramInt1 == 4) || (paramInt1 == 20) || (paramInt1 == 6)) {
        QQFileManagerUtil.a(paramLong2);
      }
    }
    if ((this.a.b == null) || (this.a.b.trim().length() == 0) || (((FileManagerEntity)localObject).getCloudType() != 2)) {
      this.a.b((FileManagerEntity)localObject);
    }
    ((IQQFileDataCenter)QfileBaseRecentFileTabView.r(this.a).getRuntimeService(IQQFileDataCenter.class, "")).updateFileEntity((FileManagerEntity)localObject);
  }
  ...
  {
    Object localObject = ((IQQFileDataCenter)QfileBaseRecentFileTabView.s(this.a).getRuntimeService(IQQFileDataCenter.class)).queryFileEntity(paramLong1, paramString, paramInt, paramLong2);
    if (localObject == null)
    {
    ...
    this.a.b((FileManagerEntity)localObject);
    ((IQQFileDataCenter)QfileBaseRecentFileTabView.t(this.a).getRuntimeService(IQQFileDataCenter.class, "")).updateFileEntity((FileManagerEntity)localObject);
