  ...
  implements View.OnClickListener
{
  ...
  public LocalFileBrowserActivity()
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new acdl(this);
    this.jdField_a_of_type_AndroidViewView$OnLongClickListener = new acdp(this);
    this.jdField_b_of_type_AndroidViewView$OnClickListener = new acds(this);
    this.jdField_a_of_type_ComTencentWidgetAdapterView$OnItemClickListener = new acdh(this);
  }
  ...
  private void a(String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidOsAsyncTask = new acdi(this, paramBoolean).execute(new String[] { paramString });
      return;
  ...
  private void b(int paramInt)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView.setSelected(true);
    this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView.post(new acdj(this, paramInt));
  }
  ...
  private void n()
  {
    this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView = ((SlideDetectListView)findViewById(2131368729));
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetNoFileRelativeLayout = ((NoFileRelativeLayout)findViewById(2131368730));
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetNoFileRelativeLayout.setText(2131435612);
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView.setOnSlideListener(new acdk(this));
  }
  ...
  private void q()
  {
    ...
    if (this.c != null) {
      this.c.setOnClickListener(new acdt(this));
    }
    this.c = this.leftView;
  }
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    p();
    q();
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131368728));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131368727));
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView.setOnItemClickListener(this.jdField_a_of_type_ComTencentWidgetAdapterView$OnItemClickListener);
    this.jdField_a_of_type_ComTencentMobileqqWidgetSlideDetectListView.setOnScrollToTopListener(new acdg(this));
    a(this.f, true);
    if (this.jdField_e_of_type_Int == 6) {
  ...
  public void l()
  {
    ...
    localActionSheet.a(new acdm(this, localActionSheet));
    localActionSheet.setOnDismissListener(new acdn(this));
    localActionSheet.setOnCancelListener(new acdo(this));
