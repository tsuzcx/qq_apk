...
public class FilePreviewActivity$16$1
  implements Runnable
{
  public FilePreviewActivity$16$1(athq paramathq, int paramInt1, int paramInt2) {}
  
  public void run()
  {
    if (!this.jdField_a_of_type_Athq.a.a()) {
      return;
    }
    String str = String.valueOf(this.jdField_a_of_type_Int) + "/" + String.valueOf(this.b);
    this.jdField_a_of_type_Athq.a.a.setText(str);
  }
}
