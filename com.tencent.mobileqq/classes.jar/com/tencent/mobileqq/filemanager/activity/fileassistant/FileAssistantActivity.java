...
public class FileAssistantActivity
  ...
  implements bctk
{
  amxq jdField_a_of_type_Amxq;
  public Handler a;
  ViewStub jdField_a_of_type_AndroidViewViewStub = null;
  private atzn jdField_a_of_type_Atzn = new aosb(this);
  public bfut a;
  private bidt jdField_a_of_type_Bidt;
  ...
  private int[] jdField_a_of_type_ArrayOfInt = { 2131692651, 2131698390, 2131720875, 2131720195 };
  private ViewStub jdField_b_of_type_AndroidViewViewStub;
  TextView jdField_b_of_type_AndroidWidgetTextView;
  private aoun jdField_b_of_type_Aoun = new aorz(this);
  ...
  private int[] jdField_b_of_type_ArrayOfInt = { 2130843487, 2130843488, 2130843493, 2130843534 };
  ...
  TextView e;
  TextView f;
  private String g = ajya.a(2131704493);
  ...
  public FileAssistantActivity()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new aosa(this, Looper.getMainLooper());
  }
  ...
  private void B()
  {
    ...
    {
      localavps = (avps)this.app.getManager(36);
      if (localavps != null) {
        break label25;
      }
    }
    ...
    {
      return;
      this.jdField_b_of_type_ComTencentPbGetbusiinfoBusinessInfoCheckUpdate$AppInfo = localavps.a(1, "100160.100163");
    ...
    localavps.b(this.jdField_b_of_type_ComTencentPbGetbusiinfoBusinessInfoCheckUpdate$AppInfo, null);
  }
  ...
  private void C()
  {
    ...
    {
      return;
      this.jdField_c_of_type_ComTencentPbGetbusiinfoBusinessInfoCheckUpdate$AppInfo = localavps.a(1, "100160.100162");
    ...
    localavps.b(this.jdField_c_of_type_ComTencentPbGetbusiinfoBusinessInfoCheckUpdate$AppInfo, null);
  }
  ...
  private void D()
  {
    ...
    {
      return;
      this.jdField_a_of_type_ComTencentPbGetbusiinfoBusinessInfoCheckUpdate$AppInfo = localavps.a(1, "100160.100164");
    ...
    localavps.b(this.jdField_a_of_type_ComTencentPbGetbusiinfoBusinessInfoCheckUpdate$AppInfo, null);
  }
  ...
  private void a(BusinessInfoCheckUpdate.AppInfo paramAppInfo, String paramString)
  {
    ...
    {
      localavps.b(paramString);
      return;
    }
    localavps.a(paramAppInfo, null);
  }
  ...
  private void n()
  {
    ...
    axqy.b(this.app, "dc00898", "", "", "0X800906F", "0X800906F", 0, 0, "", "", "", "");
  }
  
  private void o()
  {
    anco localanco = ancp.a();
    if (localanco != null)
    {
      this.e.setText(localanco.jdField_a_of_type_JavaLangString);
      this.d.setText(localanco.b);
      this.g = localanco.c;
    }
  }
  ...
  private void p()
  {
    if ((this.jdField_a_of_type_Amxq == null) || (!this.jdField_a_of_type_Amxq.a()))
    {
      QLog.i("FileAssistantActivity", 1, "FileAssistantTips is switch off");
      return;
    }
    if (TextUtils.isEmpty(this.jdField_a_of_type_Amxq.a()))
    {
      QLog.i("FileAssistantActivity", 1, "FileAssistantTips not ready, textContent is null");
      return;
    }
    this.jdField_b_of_type_AndroidViewViewStub = ((ViewStub)findViewById(2131365821));
    this.jdField_b_of_type_AndroidViewViewStub.inflate();
    TextView localTextView1 = (TextView)findViewById(2131378381);
    TextView localTextView2 = (TextView)findViewById(2131378382);
    ImageView localImageView = (ImageView)findViewById(2131368714);
    localTextView1.setText(this.jdField_a_of_type_Amxq.a());
    localTextView2.setText(this.jdField_a_of_type_Amxq.b());
    localTextView2.setOnClickListener(this);
    localImageView.setOnClickListener(this);
    this.jdField_a_of_type_Amxq.a();
  }
  ...
  private void r()
  {
    ...
    while (i < this.jdField_a_of_type_ArrayOfInt.length)
    {
      ...
      localbfuw.jdField_a_of_type_JavaLangString = getString(this.jdField_a_of_type_ArrayOfInt[i]);
      localbfuw.c = localbfuw.jdField_a_of_type_JavaLangString;
      if (i == 3)
      {
        anco localanco = ancp.a();
        if ((localanco != null) && (!TextUtils.isEmpty(localanco.d)))
        {
          localbfuw.jdField_a_of_type_JavaLangString = localanco.d;
          localbfuw.c = localanco.d;
        }
      }
      localbfuw.b = this.jdField_b_of_type_ArrayOfInt[i];
      localArrayList.add(localbfuw);
      i += 1;
    }
    this.jdField_a_of_type_Bfut = bfut.a(this, localArrayList, new aorw(this), null, actj.a(210.0F, getResources()));
    this.jdField_a_of_type_Bfut.setTouchInterceptor(new aorx(this));
  }
  ...
  private void t()
  {
    ...
    try
    {
      ...
      localIntent.putExtra("custom_title", getString(2131692425));
  ...
  private void x()
  {
    this.jdField_a_of_type_Bidt = new bidt();
    PluginCommunicationHandler.getInstance().register(this.jdField_a_of_type_Bidt);
    bidp.a(this.app.getApplication());
  }
  ...
  public void a(View paramView, int paramInt)
  {
    if (paramInt == 5)
    {
      ...
      int i = this.jdField_a_of_type_Bfut.getWidth();
      int m = getResources().getDimensionPixelSize(2131298615);
      this.jdField_a_of_type_Bfut.showAsDropDown(this.jdField_a_of_type_ComTencentMobileqqWidgetNavbarNavBarCommon, paramInt - i - m, 0);
      axqy.b(this.app, "dc00898", "", "", "0X800A15E", "0X800A15E", 0, 0, "", "", "", "");
    }
    do
    {
      return;
      if (paramInt == 4)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqWidgetNavbarNavBarCommon.setTitle(getString(2131692492));
        return;
      }
    } while (paramInt != 1);
    finish();
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    findViewById(2131376875).setOnClickListener(this);
    this.jdField_a_of_type_ComTencentMobileqqWidgetNavbarNavBarCommon = ((NavBarCommon)findViewById(2131375329));
    this.jdField_a_of_type_ComTencentMobileqqWidgetNavbarNavBarCommon.setTitle(getString(2131692492));
    if (Build.VERSION.SDK_INT >= 21) {}
    int[] arrayOfInt;
    for (paramBundle = getDrawable(2130843436);; paramBundle = getResources().getDrawable(2130843436))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWidgetNavbarNavBarCommon.setRightImageDesc(ajya.a(2131704495));
      ...
      o();
      m();
      this.app.a().addObserver(this.jdField_b_of_type_Aoun);
      x();
      A();
      this.app.registObserver(this.jdField_a_of_type_Atzn);
      if (bbkb.aR(this, this.app.getCurrentAccountUin()) == 1)
      {
      ...
      paramBundle = new apuf();
      paramBundle.b = "file_asst_in";
      paramBundle.jdField_a_of_type_Int = 11;
      apue.a(this.app.getCurrentAccountUin(), paramBundle);
      if (apug.a(this, getString(2131692428))) {
        break label547;
      }
    ...
    paramBundle[(paramBundle.length - 1)] = 2131692470;
    ...
    arrayOfInt[(arrayOfInt.length - 1)] = 2130843489;
  ...
  public void doOnDestroy()
  {
    ...
    if (this.jdField_b_of_type_Aoun != null) {
      this.app.a().deleteObserver(this.jdField_b_of_type_Aoun);
    }
  ...
  public void doOnPause()
  {
    super.doOnPause();
    this.l = true;
    this.jdField_a_of_type_Bidt.a(null);
  }
    ...
    do
    {
      do
      {
        ...
        if (i == 2131368349)
        {
          ...
          {
            CheckPermission.requestSDCardPermission(this, new aory(this));
            return;
          }
          t();
          return;
        ...
        if (i == 2131368357)
        {
          ...
          bgph.a(this, paramView, "com.qqdataline.mpfile.LiteMpFileMainActivity");
          if (this.j)
          {
            apue.a("0X8005539");
            return;
        ...
        if (i == 2131368399)
        {
          i = bbkb.aR(this, this.app.getCurrentAccountUin());
          if (i == 1)
          {
            paramView = bbkb.t(this, this.app.getCurrentAccountUin());
            i = bbkb.aS(this, this.app.getCurrentAccountUin());
        ...
        this.jdField_a_of_type_Amxq.c();
        paramView = (aoww)this.app.getManager(317);
