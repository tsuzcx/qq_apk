...
class LocalFileBrowserActivity$11
  extends AsyncTask<String, String, List<FileInfo>>
{
  LocalFileBrowserActivity$11(LocalFileBrowserActivity paramLocalFileBrowserActivity, boolean paramBoolean) {}
  ...
  protected List<FileInfo> a(String... paramVarArgs)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityLocalFileBrowserActivity.l)
    {
      ...
      localObject = FileUtil.a(new File(((File)localObject).getAbsolutePath() + "/QQ/").getAbsolutePath(), false, 0);
      if (localObject != null) {
    ...
    if (localObject != null)
    {
      ...
      for (int i = 0; i < paramVarArgs.size(); i = j + 1)
      {
        ...
        if (!localFileInfo.c()) {
          ...
          {
            j = i;
            if (OpenFileUtil.a(localFileInfo.d().toLowerCase(), (String[])localObject)) {}
          }
          else
          {
 ...
 * Qualified Name:     com.tencent.mobileqq.filemanager.activity.LocalFileBrowserActivity.11
