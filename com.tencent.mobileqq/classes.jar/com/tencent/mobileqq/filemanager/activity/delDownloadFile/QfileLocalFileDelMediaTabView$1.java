  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    TreeMap localTreeMap = new TreeMap(new atbs(this));
    Iterator localIterator = QfileLocalFileDelMediaTabView.a(this.this$0).iterator();
    while (localIterator.hasNext())
    {
      augj localaugj = (augj)localIterator.next();
      QfileLocalFileDelMediaTabView.a(this.this$0, localaugj.a(), localaugj, this.this$0.jdField_b_of_type_JavaUtilList, 2, localTreeMap, 1000, null);
    }
