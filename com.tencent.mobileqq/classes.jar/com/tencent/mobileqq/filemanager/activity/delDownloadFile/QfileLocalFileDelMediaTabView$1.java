  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    TreeMap localTreeMap = new TreeMap(new QfileLocalFileDelMediaTabView.1.1(this));
    ...
    while (localIterator.hasNext())
    {
      ...
      QfileLocalFileDelMediaTabView.a(this.this$0, localScanParams.a(), localScanParams, this.this$0.jdField_b_of_type_JavaUtilList, 2, localTreeMap, 1000, null);
    }
