  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    TreeMap localTreeMap = new TreeMap(new arxn(this));
    Iterator localIterator = QfileLocalFileDelPicTabView.a(this.this$0).iterator();
    while (localIterator.hasNext())
    {
      atcc localatcc = (atcc)localIterator.next();
      QfileLocalFileDelPicTabView.a(this.this$0, localatcc.a(), localatcc, this.this$0.jdField_b_of_type_JavaUtilList, 0, localTreeMap, 1000, null);
    }
