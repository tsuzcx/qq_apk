...
public class DiscFileOperator$2
  implements Runnable
{
  public DiscFileOperator$2(apgq paramapgq) {}
  
  public void run()
  {
    if (QLog.isColorLevel()) {
      QLog.i("DiscFileOperator<FileAssistant>", 1, "run sendFile:" + awzy.a());
    }
    if (!bbfj.d(BaseApplication.getContext()))
    {
      ...
      this.this$0.jdField_a_of_type_Apgu.a = 9004L;
      this.this$0.jdField_a_of_type_Apgu.jdField_c_of_type_JavaLangString = "NoNetWork";
      this.this$0.jdField_a_of_type_Apgu.b();
    ...
    do
    {
      ...
      {
        str1 = apgt.a(apug.d(this.this$0.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.getFilePath()));
      ...
      {
        str2 = apgt.a(apug.a(this.this$0.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.getFilePath()));
      ...
      this.this$0.jdField_a_of_type_Apgu.e = str1;
      this.this$0.jdField_a_of_type_Apgu.f = str2;
      this.this$0.jdField_a_of_type_Apgu.jdField_c_of_type_Long = System.currentTimeMillis();
