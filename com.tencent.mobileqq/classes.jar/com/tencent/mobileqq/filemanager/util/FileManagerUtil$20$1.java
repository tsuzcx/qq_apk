  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    } while (!auea.a((FileManagerEntity)localObject, this.this$0.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity));
    for (;;)
    {
      if (localObject == null)
      {
        ...
        if (this.this$0.jdField_a_of_type_Auek != null) {
          this.this$0.jdField_a_of_type_Auek.a(false);
        }
        return;
      }
      auel.a().execute(new FileManagerUtil.20.1.1(this, (FileManagerEntity)localObject));
      return;
      label359:
      localObject = null;
    }
