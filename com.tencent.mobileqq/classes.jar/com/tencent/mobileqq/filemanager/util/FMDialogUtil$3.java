  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    do
    {
      ...
      {
        bhdj.a(this.jdField_a_of_type_AndroidContentContext, 230, this.jdField_a_of_type_JavaLangString, (String)this.jdField_a_of_type_JavaLangCharSequence, 2131692203, 2131692207, this.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener, this.b).show();
        return;
      }
    } while (!(this.jdField_a_of_type_JavaLangCharSequence instanceof SpannableString));
    bhdj.a(this.jdField_a_of_type_AndroidContentContext, 230, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaLangCharSequence, 2131692203, 2131692207, this.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener, this.b).show();
  }
}
