...
final class FileManagerUtil$17
  implements Runnable
{
  FileManagerUtil$17(String paramString1, QQAppInterface paramQQAppInterface, int paramInt, String paramString2) {}
  ...
  public void run()
  {
    ...
    if (i >= 4)
    {
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerDataCenter().a(this.jdField_a_of_type_JavaLangString, this.b, this.jdField_a_of_type_Int, -3013, (Map)localObject2, BaseApplicationImpl.getContext().getString(2131692598), -1L, -1L, -1L);
