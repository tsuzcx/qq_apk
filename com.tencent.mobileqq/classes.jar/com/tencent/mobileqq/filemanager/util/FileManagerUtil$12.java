...
public final class FileManagerUtil$12
  implements Runnable
{
  public FileManagerUtil$12(String paramString, int paramInt1, boolean paramBoolean, apur paramapur, int paramInt2, int paramInt3) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        label138:
        throw localBitmap2;
        if ((!this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Apur != null))
        {
          this.jdField_a_of_type_Apur.a(localBitmap2);
          return;
        }
        float f;
        label193:
        ...
        for (;;)
        {
          try
          {
            localBitmap3 = apue.a(localMatrix, localBitmap2, this.b, this.c);
            if (this.jdField_a_of_type_Apur == null) {
              break;
            }
            this.jdField_a_of_type_Apur.a(localBitmap3);
            return;
          }
