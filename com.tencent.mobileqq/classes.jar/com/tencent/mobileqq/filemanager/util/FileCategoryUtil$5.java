...
public final class FileCategoryUtil$5
  implements Runnable
{
  public FileCategoryUtil$5(String paramString, aszp paramaszp) {}
  ...
  public void run()
  {
    ...
    if (localPackageInfo != null)
    {
      ...
      this.jdField_a_of_type_Aszp.a((String)localObject, localPackageInfo.applicationInfo.packageName);
      return;
    }
    this.jdField_a_of_type_Aszp.a(aszt.a(this.jdField_a_of_type_JavaLangString), aszt.a(this.jdField_a_of_type_JavaLangString));
  }
}
