...
public final class FileCategoryUtil$7
  implements Runnable
{
  public FileCategoryUtil$7(String paramString, apcg paramapcg) {}
  ...
  public void run()
  {
    ...
    {
      this.jdField_a_of_type_Apcg.b(localPackageInfo.applicationInfo.packageName);
      ...
      this.jdField_a_of_type_Apcg.a((String)localObject);
      return;
    }
    this.jdField_a_of_type_Apcg.b(apck.a(this.jdField_a_of_type_JavaLangString));
    this.jdField_a_of_type_Apcg.a(apck.a(this.jdField_a_of_type_JavaLangString));
  }
}
