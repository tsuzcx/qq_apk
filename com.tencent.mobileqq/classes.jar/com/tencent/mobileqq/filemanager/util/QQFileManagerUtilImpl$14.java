  ...
  implements IForwardCallBack
{
  ...
  {
    return QQFileManagerUtilImpl.a(paramString1, paramInt1, paramString2, paramInt2, paramString3, paramString4, paramString5, paramLong1, paramInt3, this.jdField_a_of_type_ComTencentCommonAppBusinessBaseQQAppInterface, this.jdField_a_of_type_Int);
  }
  ...
  public void a(boolean paramBoolean, long paramLong, int paramInt, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    if (paramInt != 0)
    {
      if (TextUtils.isEmpty(paramString1)) {
        FMToastUtil.c(BaseApplication.getContext().getString(2131692559));
      } else {
        FMToastUtil.c(paramString1);
      }
      paramBoolean = false;
    }
    QQFileManagerUtilImpl.a(paramBoolean, paramLong, paramInt, paramString4, this.jdField_a_of_type_ComTencentCommonAppBusinessBaseQQAppInterface);
  }
