...
public class DocCooperationBanner$2
  implements Runnable
{
  public DocCooperationBanner$2(apfe paramapfe, TeamWorkFileImportInfo paramTeamWorkFileImportInfo, String paramString1, boolean paramBoolean, String paramString2) {}
  ...
  public void run()
  {
    ...
    for (int i = 2;; i = 1)
    {
      localObject = axfb.a(str2, str3, i, (String)localObject, str1, this.b);
      if (localObject != null) {
