  ...
  extends WebView
{
  ...
  /* Error */
  public boolean a(WebView paramWebView, java.lang.String paramString, apfg paramapfg)
  {
    // Byte code:
    //   0: aload_2
    //   1: ifnonnull +5 -> 6
    ...
    //   130: astore 6
    //   132: aload_2
    //   133: invokestatic 188	apck:a	(Ljava/lang/String;)Ljava/util/LinkedHashMap;
    //   136: astore_1
    //   137: aload_1
    //   138: astore 6
    //   140: aload_3
  ...
  public boolean dispatchTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        this.jdField_a_of_type_Apfh.c();
        break;
        this.jdField_a_of_type_Apfh.f();
      } while (getScrollY() >= 1.0F);
      this.jdField_a_of_type_Apfh.a(false);
      this.jdField_a_of_type_Apfh.c();
      return super.dispatchTouchEvent(paramMotionEvent);
      this.jdField_a_of_type_Apfh.d();
    }
  }
  ...
  protected void onScrollChanged(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    do
    {
      ...
      if ((f < paramInt3 * 2) && (!apck.a())) {
        this.jdField_a_of_type_Apfh.g();
      }
      if (f < 2.5D) {
        this.jdField_a_of_type_Apfh.b();
      }
  ...
  public void setOnCustomScroolChangeListener(apfh paramapfh)
  {
