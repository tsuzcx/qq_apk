  ...
  extends LinearLayout
{
  ...
  private HeaderScrollHelper jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetHeaderScrollHelper;
  private HeaderScrollView.OnScrollListener jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetHeaderScrollView$OnScrollListener;
  public boolean a;
  ...
  public HeaderScrollView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetHeaderScrollHelper = new HeaderScrollHelper();
    ...
    if (this.jdField_a_of_type_AndroidWidgetScroller.computeScrollOffset())
    {
      ...
      if (this.j == 1)
      {
        if (a())
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetHeaderScrollHelper.a(a(m, n), m, n);
      ...
      {
        if ((this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetHeaderScrollHelper.a()) || (this.jdField_c_of_type_Boolean))
        {
          n = this.k;
  ...
  public boolean dispatchTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    if (n != 0)
    {
      ...
      if (n != 1)
      {
        ...
        else if (!this.jdField_b_of_type_Boolean)
        {
          ...
          bool = a();
          if ((this.jdField_a_of_type_Boolean) && (((this.jdField_d_of_type_Float > 0.0F) && (!bool)) || (this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetHeaderScrollHelper.a()) || (this.jdField_c_of_type_Boolean)))
          {
            if (!this.jdField_d_of_type_Boolean)
            {
              this.jdField_d_of_type_Boolean = true;
              this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetHeaderScrollHelper.a(false);
            }
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetHeaderScrollHelper.a(true);
  ...
  public void scrollTo(int paramInt1, int paramInt2)
  {
    ...
    this.i = paramInt2;
    HeaderScrollView.OnScrollListener localOnScrollListener = this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetHeaderScrollView$OnScrollListener;
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetHeaderScrollHelper.a(paramScrollableContainer);
  }
  
  public void setOnScrollListener(HeaderScrollView.OnScrollListener paramOnScrollListener)
  {
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetHeaderScrollView$OnScrollListener = paramOnScrollListener;
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.filemanager.widget.HeaderScrollView
