  ...
  extends FilePreViewControllerBase
{
  ...
  private FavoritesRemoteCommand.IRemoteCommandHandler jdField_a_of_type_CooperationQqfavIpcFavoritesRemoteCommand$IRemoteCommandHandler = new acox(this);
  ...
  public QfavFilePreviewController(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.postDelayed(new acoz(this), 300000L);
  }
  ...
  public boolean a()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.postDelayed(new acpa(this), 2000L);
    return true;
  }
