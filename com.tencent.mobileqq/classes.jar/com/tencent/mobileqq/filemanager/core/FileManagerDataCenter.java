...
public class FileManagerDataCenter
{
  ...
  {
    ThreadManager.executeOnSubThread(new adde(this, paramBundle));
  }
  ...
  public void d()
  {
    ThreadManager.executeOnSubThread(new addc(this));
  }
  ...
  public void e()
  {
    ThreadManager.executeOnSubThread(new addf(this));
  }
