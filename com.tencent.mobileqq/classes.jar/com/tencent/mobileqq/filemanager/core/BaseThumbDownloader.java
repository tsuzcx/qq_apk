  ...
  implements ThumbHttpDownloader.WhatHappen
{
  ...
  public final void a(long paramLong, boolean paramBoolean, String paramString1, int paramInt, String paramString2, String paramString3, String paramString4)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a(paramLong, paramBoolean, paramString1, paramInt, paramString2, paramString3, paramString4);
  }
  ...
  protected void a(BaseThumbDownloader.Session paramSession, String paramString)
  {
    ...
    for (int i = 1;; i = 0)
    {
      if ((i == 0) && (!FMConfig.a()) && (FileManagerUtil.a()))
      {
