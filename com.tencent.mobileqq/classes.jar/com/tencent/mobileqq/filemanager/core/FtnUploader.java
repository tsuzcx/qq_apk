  ...
  implements IHttpUploader, IHttpCommunicatorListener
{
  ...
  private FtnUploader(QQAppInterface paramQQAppInterface, long paramLong1, int paramInt1, int paramInt2, String paramString1, String paramString2, long paramLong2, boolean paramBoolean, String paramString3)
  {
  ...
  public static FtnUploader a(QQAppInterface paramQQAppInterface, long paramLong1, int paramInt1, int paramInt2, String paramString1, String paramString2, long paramLong2, boolean paramBoolean, String paramString3)
  {
    ...
    return new FtnUploader(paramQQAppInterface, paramLong1, paramInt1, paramInt2, paramString1, paramString2, paramLong2, paramBoolean, paramString3);
  }
  ...
  {
    return (HttpCommunicator)((IHttpEngineService)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getRuntimeService(IHttpEngineService.class, "all")).getCommunicator();
  }
  ...
  public boolean a(String paramString, long paramLong, byte[] paramArrayOfByte)
  {
    ...
    if ((this.jdField_b_of_type_Boolean) && (paramArrayOfByte.startsWith("https")))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqUtilsHttputilsHttpMsg.mIsHostIP = HttpUrlProcessor.a(paramString);
      this.jdField_a_of_type_ComTencentMobileqqUtilsHttputilsHttpMsg.mReqHost = this.jdField_a_of_type_JavaLangString;
    }
    this.jdField_a_of_type_ComTencentMobileqqUtilsHttputilsHttpMsg.timeoutParam = FileManagerUtil.a();
