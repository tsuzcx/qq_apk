  ...
  implements HttpThumbDownloader.ThumbEventCallback
{
  ...
  public void a(String paramString1, boolean paramBoolean, int paramInt, String paramString2, long paramLong)
  {
    ...
    ThumbDownloadManager.a(this.a).getFileManagerNotifyCenter().a(paramBoolean, 60, new Object[] { Long.valueOf(paramLong), Integer.valueOf(paramInt), paramString2, paramString1 });
