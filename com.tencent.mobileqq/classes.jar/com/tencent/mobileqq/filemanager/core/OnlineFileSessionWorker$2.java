...
public class OnlineFileSessionWorker$2
  extends TimerTask
{
  public OnlineFileSessionWorker$2(aokk paramaokk) {}
  
  public void run()
  {
    QLog.e("OnlineFileSessionWorker<FileAssistant>", 1, "OLfilesession[" + this.this$0.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId + "] state:" + aokk.a(this.this$0).a() + " WaitAskUpProgressResultTimer time out!!!!!!!");
