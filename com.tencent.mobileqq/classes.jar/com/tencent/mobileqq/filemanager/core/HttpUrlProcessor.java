...
public class HttpUrlProcessor
{
  ...
  public String a()
  {
    ...
    label287:
    label295:
    for (str1 = "http://" + this.jdField_a_of_type_MqqManagerProxyIpManager$ProxyIp.ip + ":" + this.jdField_a_of_type_MqqManagerProxyIpManager$ProxyIp.port + this.jdField_a_of_type_JavaLangString + "&bHost=" + str2 + "&bPort=" + str1;; str1 = "http://" + str1 + this.jdField_a_of_type_JavaLangString)
    {
      str2 = str1;
      if (!QLog.isDevelopLevel()) {
        break;
