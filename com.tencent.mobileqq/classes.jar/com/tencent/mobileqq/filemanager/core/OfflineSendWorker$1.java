...
public class OfflineSendWorker$1
  implements Runnable
{
  public OfflineSendWorker$1(apax paramapax) {}
  ...
  public void run()
  {
    ...
    if (!bbfj.d(BaseApplicationImpl.getContext()))
    {
      ...
      apax.a(this.this$0, 0L, 9004, "NoNetWork");
      apax.b(this.this$0, 0L, 9004, "NoNetWork");
      return;
    }
    ...
    localapuf.b = "send_file_number";
    apue.a(this.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), localapuf);
    this.this$0.m();
