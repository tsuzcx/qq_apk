...
public class OfflineSendWorker$1
  implements Runnable
{
  public OfflineSendWorker$1(aqtv paramaqtv) {}
  ...
  public void run()
  {
    ...
    if (!bdee.d(BaseApplicationImpl.getContext()))
    {
      ...
      aqtv.a(this.this$0, 0L, 9004, "NoNetWork");
      aqtv.b(this.this$0, 0L, 9004, "NoNetWork");
      return;
    }
    ...
    localarnh.b = "send_file_number";
    arng.a(this.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), localarnh);
    this.this$0.m();
