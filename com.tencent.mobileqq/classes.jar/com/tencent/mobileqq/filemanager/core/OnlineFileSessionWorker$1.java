...
public class OnlineFileSessionWorker$1
  extends TimerTask
{
  public OnlineFileSessionWorker$1(atfe paramatfe) {}
  
  public void run()
  {
    QLog.e("OnlineFileSessionWorker<FileAssistant>", 1, "OLfilesession[" + this.this$0.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId + "] state:" + atfe.a(this.this$0).a() + " WaitSenderReplayOnRecvTimer time out!!!!!!!");
