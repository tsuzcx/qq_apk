...
public class OnlineFileSessionWorker$1
  extends TimerTask
{
  public OnlineFileSessionWorker$1(atwy paramatwy) {}
  
  public void run()
  {
    QLog.e("OnlineFileSessionWorker<FileAssistant>", 1, "OLfilesession[" + this.this$0.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId + "] state:" + atwy.a(this.this$0).a() + " WaitSenderReplayOnRecvTimer time out!!!!!!!");
