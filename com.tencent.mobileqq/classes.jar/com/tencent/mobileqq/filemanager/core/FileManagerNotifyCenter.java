  ...
  extends Observable
{
  ...
  {
    this.jdField_a_of_type_MqqOsMqqHandler = new addg(this, Looper.getMainLooper());
  ...
  public void a(FileManagerEntity paramFileManagerEntity, int paramInt, String paramString)
  {
    ...
    ThreadManager.executeOnSubThread(new addh(this, paramFileManagerEntity, paramInt));
  }
