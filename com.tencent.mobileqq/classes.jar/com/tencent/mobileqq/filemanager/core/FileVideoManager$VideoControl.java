...
public class FileVideoManager$VideoControl
{
  ...
  private FileTransferObserver jdField_a_of_type_ComTencentMobileqqFilemanagerAppFileTransferObserver = new acml(this);
  ...
  private void b(FileManagerEntity paramFileManagerEntity, FileVideoManager.FileVideoManagerCallback paramFileVideoManagerCallback)
  {
    ...
    if (!TextUtils.isEmpty(paramFileManagerEntity.Uuid)) {
      ((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime()).a().a(paramFileManagerEntity.Uuid, paramFileManagerEntity.bSend, new acmj(this, paramFileManagerEntity, paramFileVideoManagerCallback));
    }
  }
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IDownloadMgr.setCallBackListener(20160714, new acmh(this, localQQAppInterface));
  ...
  private void c(FileManagerEntity paramFileManagerEntity, FileVideoManager.FileVideoManagerCallback paramFileVideoManagerCallback)
  {
    ...
    QQAppInterface localQQAppInterface = (QQAppInterface)BaseApplicationImpl.sApplication.getRuntime();
    localQQAppInterface.a().a(paramFileManagerEntity.nSessionId, paramFileManagerEntity.fileName, Long.parseLong(paramFileManagerEntity.peerUin), paramFileManagerEntity.Uuid, new acmk(this, paramFileManagerEntity, localQQAppInterface, paramFileVideoManagerCallback));
  }
  ...
  private void d()
  {
    ...
    if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
    {
      ...
      if (localObject != null) {
        ((FileVideoManager.FileVideoManagerCallback)localObject).ad_();
      }
    }
    Object localObject = Looper.getMainLooper();
    if (((Looper)localObject).getThread() != Thread.currentThread())
    {
      new Handler((Looper)localObject).post(new acmm(this, localQQAppInterface));
      return;
    }
  ...
  public TVK_IMediaPlayer a(Context paramContext, View paramView, FileVideoManager.FileVideoManagerCallback paramFileVideoManagerCallback)
  {
    if (this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer == null)
    {
      ...
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnErrorListener(new acmf(this));
    }
  ...
  public void a()
  {
    ...
    {
      new Handler(localLooper).post(new acmr(this));
      return;
    }
    f();
  }
  ...
  public void a(FileManagerEntity paramFileManagerEntity, FileVideoManager.FileVideoManagerCallback paramFileVideoManagerCallback)
  {
    ...
    new Handler(Looper.getMainLooper()).post(new acmo(this, paramFileManagerEntity, paramFileVideoManagerCallback));
  }
  ...
  public void a(FileManagerEntity paramFileManagerEntity, boolean paramBoolean)
  {
    ...
    if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))
    {
      ...
      a(paramFileManagerEntity, new acmn(this, paramFileManagerEntity, paramBoolean));
      return;
    }
    c();
    int i;
  ...
  public void b()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.stop();
      localQQCustomDialog = DialogUtil.a(BaseActivity.sTopActivity, 230, "", "当前网络不稳定，无法播放及下载视频，请稍后重试。", null, "我知道了", new acmg(this), null);
