...
class DiscVideoThumbDownloader$1
  extends FMObserver
{
  ...
  protected void c(boolean paramBoolean, int paramInt1, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt2, String paramString6, long paramLong, Bundle paramBundle)
  {
    ...
    paramString1.append("] OnGetDiscVideoThumbInfo, bSuccess[");
    ...
    QLog.i("DiscVideoThumbDownloader<FileAssistant>", 1, paramString1.toString());
    ...
    if (localVideoSession == null)
    {
      ...
      paramString1.append("[downloadThumb]  ID[");
      paramString1.append(paramLong);
      paramString1.append("] OnGetDiscVideoThumbInfo no this session");
      QLog.e("DiscVideoThumbDownloader<FileAssistant>", 2, paramString1.toString());
    ...
    if ((paramString1 != null) && (paramString1.length() >= 0))
    {
      if ((paramString3 == null) || (paramString3.length() < 0))
      {
        ...
        QLog.w("DiscVideoThumbDownloader<FileAssistant>", 2, paramString4.toString());
      }
      paramString4 = new StringBuilder();
