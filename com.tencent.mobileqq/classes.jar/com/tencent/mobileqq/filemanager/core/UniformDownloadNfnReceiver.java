  ...
  extends BroadcastReceiver
{
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if (str1 != null)
    {
      ...
      apdc.a().c(paramIntent, paramContext);
    }
    label90:
    label100:
    do
    {
      ...
      if (str1.equals("com.tencent.mobileqq.UniformDownloadNfn.DO_DOWNLOAD"))
      {
        if (paramContext != null)
        {
          ...
          apdc.a().d(paramIntent, paramContext);
          return;
        }
      ...
      if (str1.equals("com.tencent.mobileqq.UniformDownloadNfn.TRY_DOWNLOAD"))
      {
        if (paramContext != null)
        {
          ...
          apdc.a().e(paramIntent, paramContext);
          return;
        }
