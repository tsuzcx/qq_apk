  ...
  implements Runnable
{
  ...
  {
    TextView localTextView = ExpandPluginLoadingFragment.h(this.this$0);
    if (localTextView != null) {
      localTextView.setVisibility(0);
    }
    localTextView = ExpandPluginLoadingFragment.h(this.this$0);
    if (localTextView != null)
    {
      ...
      localObject = ((BaseApplication)localObject).getResources().getString(2131896844);
