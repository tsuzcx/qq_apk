  ...
  extends QRouteApi
{
  ...
  public abstract void getExtendFriendSwitch(@Nullable BaseQQAppInterface paramBaseQQAppInterface, @Nullable Long paramLong, @Nullable IExpandCmdCallback paramIExpandCmdCallback);
  
  public abstract boolean getExtendFriendUserSwitch(@Nullable BaseQQAppInterface paramBaseQQAppInterface);
  
  @NotNull
  public abstract String getExtendFriendUserSwitchText();
  ...
  public abstract void handlePreLoadDataForAvatarProfileCard(@Nullable BaseQQAppInterface paramBaseQQAppInterface, @Nullable String paramString, @NotNull Object paramObject);
  ...
  public abstract void preLoadDataForAvatarProfileCard(@Nullable BaseQQAppInterface paramBaseQQAppInterface, @Nullable Long paramLong, @Nullable BusinessObserver paramBusinessObserver);
  
  public abstract void requestAddMatchedRelation(@Nullable BaseQQAppInterface paramBaseQQAppInterface, @Nullable String paramString1, @Nullable String paramString2, int paramInt);
  ...
  public abstract void saveTempC2cSignature(@NotNull AppRuntime paramAppRuntime, @NotNull String paramString, @NotNull byte[] paramArrayOfByte);
  
  public abstract void setExtendFriendSwitch(@Nullable BaseQQAppInterface paramBaseQQAppInterface, boolean paramBoolean, @Nullable IExpandCmdCallback paramIExpandCmdCallback);
  
  public abstract void setExtendFriendUserSwitch(@Nullable BaseQQAppInterface paramBaseQQAppInterface, boolean paramBoolean, @NotNull String paramString, long paramLong);
  ...
  public abstract void startExtendFriendCardOnClickAvatar(@Nullable Context paramContext, @Nullable String paramString, int paramInt);
}
