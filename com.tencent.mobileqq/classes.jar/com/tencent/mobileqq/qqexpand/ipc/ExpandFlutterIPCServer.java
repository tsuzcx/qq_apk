...
public class ExpandFlutterIPCServer
  extends QIPCModule
{
  private static volatile ExpandFlutterIPCServer jdField_a_of_type_ComTencentMobileqqQqexpandIpcExpandFlutterIPCServer;
  final IpcDispatchCenter jdField_a_of_type_ComTencentMobileqqQqexpandIpcIpcDispatchCenter = new IpcDispatchCenter(this, new ExpandFlutterIPCServer.2(this));
  private final ExpandObserver jdField_a_of_type_ComTencentMobileqqQqexpandNetworkExpandObserver = new ExpandFlutterIPCServer.1(this);
  ...
  private ExpandFlutterIPCServer()
  {
    ...
    if ((localAppRuntime instanceof QQAppInterface)) {
      ((QQAppInterface)localAppRuntime).addObserver(this.jdField_a_of_type_ComTencentMobileqqQqexpandNetworkExpandObserver);
    }
  }
  
  private Bundle a()
  {
    String str = ((ExpandManager)a().getManager(QQManagerFactory.EXTEND_FRIEND_MANAGER)).c();
  ...
  {
    Object localObject2 = ((FriendsManager)ExpandManager.a().getManager(QQManagerFactory.FRIENDS_MANAGER)).b(ExpandManager.a().getCurrentAccountUin());
    ...
    IExpandHandler localIExpandHandler = (IExpandHandler)ExpandManager.a().getBusinessHandler(BusinessHandlerFactory.EXTEND_FRIEND_HANDLER);
    if (localIExpandHandler != null) {
      ((Bundle)localObject2).putInt("seqNum", localIExpandHandler.a(ExpandManager.a().getCurrentAccountUin(), false));
    }
  ...
  private Bundle a(Bundle paramBundle)
  {
    ...
    ((ExpandManager)BaseApplicationImpl.getApplication().getRuntime().getManager(QQManagerFactory.EXTEND_FRIEND_MANAGER)).a().a(paramBundle);
    return localBundle;
  }
  ...
  private Bundle a(Bundle paramBundle, int paramInt)
  {
    ...
    localExpandManager.a().a(str, i, new ExpandFlutterIPCServer.5(this, paramInt));
    return null;
  }
  
  public static ExpandFlutterIPCServer a()
  {
    if (jdField_a_of_type_ComTencentMobileqqQqexpandIpcExpandFlutterIPCServer == null) {
      try
      {
        if (jdField_a_of_type_ComTencentMobileqqQqexpandIpcExpandFlutterIPCServer == null) {
          jdField_a_of_type_ComTencentMobileqqQqexpandIpcExpandFlutterIPCServer = new ExpandFlutterIPCServer();
        }
      }
      finally {}
    }
    return jdField_a_of_type_ComTencentMobileqqQqexpandIpcExpandFlutterIPCServer;
  }
  ...
  {
    if (((ExpandManager)a().getManager(QQManagerFactory.EXTEND_FRIEND_MANAGER)).g()) {
  ...
  private void a()
  {
    this.jdField_a_of_type_ComTencentMobileqqQqexpandIpcIpcDispatchCenter.a("METHOD_GET_FLUTTER_RESOURCE_PATH", new ExpandFlutterIPCServer.7(this));
    this.jdField_a_of_type_ComTencentMobileqqQqexpandIpcIpcDispatchCenter.a("METHOD_GET_EXPAND_CONFIG", new ExpandFlutterIPCServer.8(this));
    this.jdField_a_of_type_ComTencentMobileqqQqexpandIpcIpcDispatchCenter.a("METHOD_CHAT_GET_CONVERSATION_LIST", new ExpandFlutterIPCServer.9(this));
    this.jdField_a_of_type_ComTencentMobileqqQqexpandIpcIpcDispatchCenter.a("METHOD_CHAT_REMOVE_CONVERSATION", new ExpandFlutterIPCServer.10(this));
    this.jdField_a_of_type_ComTencentMobileqqQqexpandIpcIpcDispatchCenter.a("METHOD_REFRESH_EXTEND_FRIEND_INFO", new ExpandFlutterIPCServer.11(this));
    this.jdField_a_of_type_ComTencentMobileqqQqexpandIpcIpcDispatchCenter.a("METHOD_GET_BIRTH_DATE", new ExpandFlutterIPCServer.12(this));
    this.jdField_a_of_type_ComTencentMobileqqQqexpandIpcIpcDispatchCenter.a("METHOD_SET_BIRTH_DATE", new ExpandFlutterIPCServer.13(this));
    this.jdField_a_of_type_ComTencentMobileqqQqexpandIpcIpcDispatchCenter.a("METHOD_SET_BIRTH_DIALOG_FLAG", new ExpandFlutterIPCServer.14(this));
    this.jdField_a_of_type_ComTencentMobileqqQqexpandIpcIpcDispatchCenter.a("METHOD_GET_BIRTH_DIALOG_FLAG", new ExpandFlutterIPCServer.15(this));
    this.jdField_a_of_type_ComTencentMobileqqQqexpandIpcIpcDispatchCenter.a("METHOD_GET_SYS_EMOJI_FILE_PATH", new ExpandFlutterIPCServer.16(this));
    this.jdField_a_of_type_ComTencentMobileqqQqexpandIpcIpcDispatchCenter.a("METHOD_GET_EXPAND_FRIEND_BANNER_CONFIG_LIST", new ExpandFlutterIPCServer.17(this));
    this.jdField_a_of_type_ComTencentMobileqqQqexpandIpcIpcDispatchCenter.a("METHOD_GET_SECURITY_INFO", new ExpandFlutterIPCServer.18(this));
    this.jdField_a_of_type_ComTencentMobileqqQqexpandIpcIpcDispatchCenter.a("METHOD_GET_ABTEST_INFO", new ExpandFlutterIPCServer.19(this));
    this.jdField_a_of_type_ComTencentMobileqqQqexpandIpcIpcDispatchCenter.a("METHOD_SET_QUIET_MODE", new ExpandFlutterIPCServer.20(this));
    this.jdField_a_of_type_ComTencentMobileqqQqexpandIpcIpcDispatchCenter.a("METHOD_GET_QUIET_MODE", new ExpandFlutterIPCServer.21(this));
    this.jdField_a_of_type_ComTencentMobileqqQqexpandIpcIpcDispatchCenter.a("METHOD_CLEAR_ALL_MSGS", new ExpandFlutterIPCServer.22(this));
    this.jdField_a_of_type_ComTencentMobileqqQqexpandIpcIpcDispatchCenter.a("getNetworkStatus", new ExpandFlutterIPCServer.23(this));
  }
  ...
  private void b()
  {
    if ((BaseApplication.getContext() != null) && (BaseApplication.getContext().getContentResolver() != null))
    {
      ...
      MobileQQ.sMobileQQ.registerReceiver(new ExpandFlutterIPCServer.24(this), localIntentFilter);
    }
  }
  ...
  {
    Bundle localBundle = new Bundle();
    localBundle.putLong("birthdate", ((FriendsManager)ExpandManager.a().getManager(QQManagerFactory.FRIENDS_MANAGER)).b(ExpandManager.a().getCurrentAccountUin()).lBirthday);
    return localBundle;
  }
  ...
  private Bundle c(Bundle paramBundle, int paramInt)
  {
    ...
    if ((localObject instanceof QQAppInterface))
    {
      ...
      ((QQAppInterface)localObject).addObserver(new ExpandFlutterIPCServer.25(this, (QQAppInterface)localObject, paramInt));
      ((ExpandHandlerImpl)((QQAppInterface)localObject).getBusinessHandler(BusinessHandlerFactory.EXTEND_FRIEND_HANDLER)).a(((QQAppInterface)localObject).getCurrentUin(), bool);
    }
    return null;
  }
  ...
  private Bundle g()
  {
    ...
    if ((!TextUtils.isEmpty((CharSequence)localObject)) && (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))) {
      this.jdField_a_of_type_JavaLangString = ExpandSharePreUtils.b((String)localObject);
    }
    localObject = new Bundle();
    ((Bundle)localObject).putString("data", this.jdField_a_of_type_JavaLangString);
    return localObject;
  }
  
  private Bundle h()
  {
    ThreadManagerV2.excute(new ExpandFlutterIPCServer.26(this), 80, null, true);
    Bundle localBundle = new Bundle();
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    try
    {
      paramString = this.jdField_a_of_type_ComTencentMobileqqQqexpandIpcIpcDispatchCenter.a(paramString, paramBundle, paramInt);
      return paramString;
    }
