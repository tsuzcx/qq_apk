  ...
  implements MethodChannel.MethodCallHandler
{
  ...
  static
  {
    jdField_a_of_type_ComTencentMobileqqQqexpandFlutterChannelRedpointExpandRedPointApiChannel$MethodCallHandler$Companion = new ExpandRedPointApiChannel.MethodCallHandler.Companion(null);
  }
  
  public ExpandRedPointApiChannel$MethodCallHandler(@NotNull ExpandRedPointApi paramExpandRedPointApi)
  {
    this.jdField_a_of_type_ComTencentMobileqqQqexpandFlutterChannelRedpointExpandRedPointApi = paramExpandRedPointApi;
  }
  ...
  public void onMethodCall(@NotNull MethodCall paramMethodCall, @NotNull MethodChannel.Result paramResult)
  {
    ...
    jdField_a_of_type_ComTencentMobileqqQqexpandFlutterChannelRedpointExpandRedPointApiChannel$MethodCallHandler$Companion.a(this.jdField_a_of_type_ComTencentMobileqqQqexpandFlutterChannelRedpointExpandRedPointApi, paramMethodCall, (IExpandChannelCallback)new ExpandRedPointApiChannel.MethodCallHandler.onMethodCall.1(paramResult));
  }
}
