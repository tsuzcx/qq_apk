  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    int j;
    int i;
    if (ExpandVoiceView.a(this.this$0) == 0)
    {
    ...
    {
      localObject = ExpandLimitChatResourceUtil.a("expand_voice_animation2.json");
      j = ViewUtils.a(16.0F);
      i = ViewUtils.a(17.0F);
    }
    try
    {
      ...
      LottieComposition.Factory.fromInputStream(this.this$0.getContext(), (InputStream)localObject, new ExpandVoiceView.1.1(this, j, i));
      return;
    }
