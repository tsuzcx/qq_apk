  ...
  extends URLImageView
{
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    this.j.set(getPaddingLeft(), getPaddingTop(), getPaddingLeft() + (m - n - i1), getPaddingTop() + (i2 - i3 - i4));
  ...
  public void setCorner(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if ((paramInt1 >= 0) && (paramInt2 >= 0) && (paramInt3 >= 0) && (paramInt4 >= 0))
    {
      ...
      arrayOfFloat[6] = f1;
      arrayOfFloat[7] = f1;
      this.l = ((paramInt1 + paramInt2 + paramInt3 + paramInt4) / 4);
      return;
    }
 ...
 * Qualified Name:     com.tencent.mobileqq.qqexpand.widget.RoundCornerImageView
