...
public class BaseListenTogetherPanel$9
  implements Runnable
{
  public BaseListenTogetherPanel$9(aqyg paramaqyg) {}
  
  public void run()
  {
    try
    {
      View localView = ((LayoutInflater)this.this$0.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getSystemService("layout_inflater")).inflate(2131495048, this.this$0.jdField_a_of_type_AndroidViewViewGroup, false);
      ...
      localView.setOnClickListener(new aqym(this));
      if (this.this$0.jdField_a_of_type_AndroidViewViewGroup != null) {}
      for (int i = this.this$0.jdField_a_of_type_AndroidViewViewGroup.getWidth();; i = bajq.a())
      {
 ...
 * Qualified Name:     com.tencent.mobileqq.listentogether.ui.BaseListenTogetherPanel.9
