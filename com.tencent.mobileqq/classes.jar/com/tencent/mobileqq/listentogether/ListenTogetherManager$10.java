...
{
  ListenTogetherManager$10(ListenTogetherManager paramListenTogetherManager, WeakReference paramWeakReference, int paramInt, String paramString) {}
  
  public void a()
  {
    BaseActivity localBaseActivity = (BaseActivity)this.jdField_a_of_type_MqqUtilWeakReference.get();
    if ((ListenTogetherManager.a(this.jdField_a_of_type_ComTencentMobileqqListentogetherListenTogetherManager)) || (localBaseActivity == null) || (localBaseActivity.isFinishing())) {
      return;
    }
