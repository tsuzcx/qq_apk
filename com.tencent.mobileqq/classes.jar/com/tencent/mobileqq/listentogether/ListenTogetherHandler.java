  ...
  extends BusinessHandler
{
    ...
    if (paramTypeMusic != null)
    {
      ...
      if (localList != null)
      {
        ...
        if (localList.size() > 0)
        {
          ...
          if (paramLong2 > 0L) {
            paramTypeMusic.h = (l + paramLong2);
          } else {
            paramTypeMusic.h = l;
          }
          StringBuilder localStringBuilder = new StringBuilder();
          localStringBuilder.append("handler seek: ");
          localStringBuilder.append(paramTypeMusic.h);
          localStringBuilder.append(" currentTime: ");
          localStringBuilder.append(System.currentTimeMillis());
          QLog.i("ListenTogether.Seek", 1, localStringBuilder.toString());
          paramTypeMusic.i = SystemClock.elapsedRealtime();
          paramTypeMusic.j = SystemClock.elapsedRealtime();
          paramTypeMusic = localList;
          if (QLog.isColorLevel())
          {
  ...
  private void a(int paramInt1, String paramString, int paramInt2, int paramInt3)
  {
    try
    {
      ...
      ToServiceMsg localToServiceMsg = new ToServiceMsg("mobileqq.service", this.b.getCurrentAccountUin(), "QQAIOMediaSvc.media_operation");
    ...
    catch (NumberFormatException localNumberFormatException)
    {
      ...
      if (paramInt2 == 1)
      {
        localListenTogetherManager = this.a;
  ...
  private void b(int paramInt1, String paramString, int paramInt2, int paramInt3)
  {
    try
    {
      ...
      ToServiceMsg localToServiceMsg = new ToServiceMsg("mobileqq.service", this.b.getCurrentAccountUin(), "QQAIOMediaSvc.room_operation");
      localToServiceMsg.extraData.putInt("KEY_SESSION_TYPE", paramInt1);
      localToServiceMsg.extraData.putString("KEY_SESSION_UIN", paramString);
      localToServiceMsg.extraData.putInt("KEY_OPERATOR", paramInt2);
    ...
    catch (NumberFormatException localNumberFormatException)
    {
      ...
      ListenTogetherManager localListenTogetherManager = this.a;
      if (localListenTogetherManager != null) {
        if (paramInt2 == 1) {
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((paramToServiceMsg != null) && (paramFromServiceMsg != null) && (paramObject != null))
    {
      ...
      if ((!paramFromServiceMsg.isSuccess()) || (!localListenTogetherSession.g())) {}
    }
    for (;;)
    {
      try
      {
        ...
        if (k == 0)
        {
          try
          {
            ...
            localListenTogetherSession.p = paramToServiceMsg.enum_aio_state.get();
            paramFromServiceMsg = (aio_media.TypeMusic)paramToServiceMsg.msg_music.get();
            try
            {
              localListenTogetherSession.a = a(paramFromServiceMsg, l2, l1);
              localListenTogetherSession.h = ((aio_media.TypeMusic)paramToServiceMsg.msg_music.get()).bool_allow_member_start.get();
              localListenTogetherSession.i = ((aio_media.TypeMusic)paramToServiceMsg.msg_music.get()).bool_allow_member_add.get();
              localListenTogetherSession.j = ((aio_media.TypeMusic)paramToServiceMsg.msg_music.get()).enum_play_mode.get();
              localListenTogetherSession.t = l2;
              localListenTogetherSession.r = String.valueOf(paramToServiceMsg.uint64_create_uin.get());
              if (!TextUtils.isEmpty(localListenTogetherSession.r)) {
                localListenTogetherSession.s = ListenTogetherUtils.a(this.b, str1, i, localListenTogetherSession.r);
              }
              localListenTogetherSession.q = paramToServiceMsg.enum_user_state.get();
              localListenTogetherSession.f = paramToServiceMsg.msg_personal_setting.uint32_theme_id.get();
              if (i == 1)
              {
              ...
              localListenTogetherSession.c = localListenTogetherSession.a(i, k);
              localListenTogetherSession.d = paramToServiceMsg.enum_joined_aio_type.get();
              localListenTogetherSession.e = String.valueOf(paramToServiceMsg.uint64_joined_id.get());
              localListenTogetherSession.g = paramToServiceMsg.bool_joined_is_creater.get();
              localListenTogetherSession.x = paramToServiceMsg.uint64_aio_identification.get();
              bool = true;
            }
            catch (Exception paramToServiceMsg) {}
            bool = true;
          ...
          try
          {
            ...
            if (paramObject != null)
            {
              ...
              if (paramObject.hasNext())
              {
                ...
                ((MusicInfo)localObject1).a = paramToServiceMsg;
  ...
  private void f(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((paramToServiceMsg != null) && (paramFromServiceMsg != null) && (paramObject != null))
    {
      ...
      if ((paramFromServiceMsg.isSuccess()) && (((ListenTogetherSession)localObject).g()))
      {
        try
        {
    ...
    for (boolean bool = false;; bool = true)
    {
      ...
      if (paramToServiceMsg != null) {
        if (j == 1) {
          ...
          this.a.a(bool, (ListenTogetherSession)localObject, j, true);
        }
      }
      if (QLog.isColorLevel()) {
      ...
      if (this.a != null)
      {
        ...
        if ((j == 2) || (j == 3)) {
          this.a.a(false, paramToServiceMsg, j, true);
        }
      }
      return;
      label447:
  ...
  private void i(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    ListenTogetherManager.a(this.b).a(bool2, k, (String)localObject, paramToServiceMsg, m, str2);
  }
  ...
  private void j(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    // Byte code:
    //   0: aload_1
    //   1: getfield 249	com/tencent/qphone/base/remote/ToServiceMsg:extraData	Landroid/os/Bundle;
    //   4: astore 11
    //   6: iconst_m1
    //   7: istore 4
    //   9: aload 11
    //   11: ldc_w 650
    //   14: iconst_m1
    //   15: invokevirtual 653	android/os/Bundle:getInt	(Ljava/lang/String;I)I
    //   18: iconst_1
    //   19: if_icmpeq +4 -> 23
    //   22: return
    //   23: aload_1
    //   24: getfield 249	com/tencent/qphone/base/remote/ToServiceMsg:extraData	Landroid/os/Bundle;
    //   27: ldc 251
    //   29: iconst_m1
    //   30: invokevirtual 653	android/os/Bundle:getInt	(Ljava/lang/String;I)I
    //   33: istore 8
    //   35: aload_1
    //   36: getfield 249	com/tencent/qphone/base/remote/ToServiceMsg:extraData	Landroid/os/Bundle;
    //   39: astore 12
    //   41: ldc_w 334
    //   44: astore 11
    //   46: aload 12
    //   48: ldc_w 259
    //   51: ldc_w 334
    //   54: invokevirtual 656	android/os/Bundle:getString	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   57: astore 12
    //   59: aload_1
    //   60: getfield 249	com/tencent/qphone/base/remote/ToServiceMsg:extraData	Landroid/os/Bundle;
    //   63: ldc_w 682
    //   66: lconst_0
    //   67: invokevirtual 686	android/os/Bundle:getLong	(Ljava/lang/String;J)J
    //   70: lstore 9
    //   72: aload_2
    //   73: invokevirtual 349	com/tencent/qphone/base/remote/FromServiceMsg:isSuccess	()Z
    //   76: ifeq +124 -> 200
    //   79: new 688	com/tencent/trpcprotocol/qqAioMedia/heartbeat/heartbeat/CmdAIOMediaHeartbeatRsp
    //   82: dup
    //   83: invokespecial 689	com/tencent/trpcprotocol/qqAioMedia/heartbeat/heartbeat/CmdAIOMediaHeartbeatRsp:<init>	()V
    //   86: astore_1
    //   87: aload_1
    //   88: aload_3
    //   89: checkcast 357	[B
    //   92: checkcast 357	[B
    //   95: invokevirtual 690	com/tencent/trpcprotocol/qqAioMedia/heartbeat/heartbeat/CmdAIOMediaHeartbeatRsp:mergeFrom	([B)Lcom/tencent/mobileqq/pb/MessageMicro;
    //   98: pop
    //   99: aload_1
    //   100: getfield 691	com/tencent/trpcprotocol/qqAioMedia/heartbeat/heartbeat/CmdAIOMediaHeartbeatRsp:msg_result	Ltencent/aio/media/aio_media$ResultInfo;
    //   103: invokevirtual 370	tencent/aio/media/aio_media$ResultInfo:get	()Lcom/tencent/mobileqq/pb/MessageMicro;
    //   106: checkcast 367	tencent/aio/media/aio_media$ResultInfo
    //   109: astore_2
    //   110: aload_1
    //   111: getfield 694	com/tencent/trpcprotocol/qqAioMedia/heartbeat/heartbeat/CmdAIOMediaHeartbeatRsp:interval	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   114: invokevirtual 377	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   117: istore 7
    //   119: iload 4
    //   121: istore 5
    //   123: aload_2
    //   124: ifnull +15 -> 139
    //   127: aload_2
    //   128: getfield 374	tencent/aio/media/aio_media$ResultInfo:uint32_result	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   131: invokevirtual 377	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   134: istore 5
    //   136: goto +3 -> 139
    //   139: iload 5
    //   141: istore 4
    ...
    //   156: istore 4
    //   158: aload_2
    //   159: getfield 506	tencent/aio/media/aio_media$ResultInfo:bytes_errmsg	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   162: invokevirtual 511	com/tencent/mobileqq/pb/PBBytesField:get	()Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   165: invokevirtual 516	com/tencent/mobileqq/pb/ByteStringMicro:toStringUtf8	()Ljava/lang/String;
    //   168: astore_1
    //   169: iload 5
    //   171: istore 4
    //   173: iload 7
    ...
    //   187: ldc_w 696
    //   190: aload_1
    //   191: invokestatic 289	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   194: aload 11
    //   196: astore_1
    //   197: goto +9 -> 206
    //   200: iconst_0
    ...
    //   203: aload 11
    //   205: astore_1
    //   206: invokestatic 56	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   209: ifeq +39 -> 248
    //   212: ldc 58
    //   214: iconst_2
    //   215: ldc_w 698
    //   218: iconst_3
    //   219: anewarray 62	java/lang/Object
    //   222: dup
    //   223: iconst_0
    //   224: iload 6
    //   226: invokestatic 73	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   229: aastore
    //   230: dup
    //   231: iconst_1
    //   232: iload 4
    //   234: invokestatic 73	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   237: aastore
    //   238: dup
    //   239: iconst_2
    //   240: aload_1
    //   241: aastore
    //   242: invokestatic 79	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   245: invokestatic 180	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   248: iload 4
    //   250: ifne +44 -> 294
    //   253: aload_0
    //   254: bipush 24
    //   256: iconst_1
    //   257: iconst_4
    //   258: anewarray 62	java/lang/Object
    //   261: dup
    //   262: iconst_0
    //   263: iload 8
    //   265: invokestatic 73	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   268: aastore
    //   269: dup
    //   270: iconst_1
    //   271: aload 12
    ...
    //   275: iconst_2
    //   276: lload 9
    //   278: invokestatic 68	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   281: aastore
    //   282: dup
    //   283: iconst_3
    //   284: iload 6
    //   286: invokestatic 73	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   289: aastore
    //   290: invokevirtual 633	com/tencent/mobileqq/listentogether/ListenTogetherHandler:notifyUI	(IZLjava/lang/Object;)V
    //   293: return
    //   294: aload_0
    //   295: bipush 24
    //   297: iconst_0
    ...
    //   303: iconst_0
    //   304: iload 8
    //   306: invokestatic 73	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   309: aastore
    //   310: dup
    //   311: iconst_1
    //   312: aload 12
    ...
    //   316: iconst_2
    //   317: lload 9
    //   319: invokestatic 68	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   322: aastore
    //   323: dup
    //   324: iconst_3
    //   325: iload 4
    //   327: invokestatic 73	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   330: aastore
    //   331: dup
    //   332: iconst_4
    //   333: aload_1
    //   334: aastore
    //   335: invokevirtual 633	com/tencent/mobileqq/listentogether/ListenTogetherHandler:notifyUI	(IZLjava/lang/Object;)V
    //   338: return
    //   339: astore_1
    //   340: iload 7
    //   342: istore 6
  ...
  {
    ((TogetherOperationHandler)this.b.getBusinessHandler(BusinessHandlerFactory.TOGETHER_OPERATOR_HANDLER)).a(1, paramInt1, paramString1, paramString2, paramInt2);
  }
  ...
  public void a(int paramInt, String paramString1, String paramString2, String paramString3, String paramString4, List<String> paramList)
  {
    try
    {
      ...
      paramString2 = new ToServiceMsg("mobileqq.service", this.b.getCurrentAccountUin(), "QQAIOMediaSvc.report_download_fail");
    ...
    if ((paramList != null) && (paramList.size() != 0))
    {
      ...
      try
      {
        ...
        while (paramList.hasNext())
        {
          ...
          localSongExtendedReqParam.str_song_id.set(localMusicExtendedReqParam.a);
          localSongExtendedReqParam.bool_need_lyric.set(localMusicExtendedReqParam.c);
          localSongExtendedReqParam.bool_need_url.set(localMusicExtendedReqParam.b);
          localArrayList2.add(localSongExtendedReqParam);
          localArrayList1.add(localMusicExtendedReqParam.a);
        }
        localReqSongExtendedInfo.rpt_msg_song_list.set(localArrayList2);
        paramList = new ToServiceMsg("mobileqq.service", this.b.getCurrentAccountUin(), "QQAIOMediaSvc.get_song_extended_info");
    ...
    try
    {
      if (paramFromServiceMsg.isSuccess())
      {
        ...
        if (i == 0)
        {
          ...
          if (!TextUtils.isEmpty(QQMusicPlayService.e())) {
            paramToServiceMsg = QQMusicPlayService.e();
          }
          paramObject.put("current_song_id", paramToServiceMsg);
          this.a.a(true, paramObject);
          return;
        }
        if (QLog.isColorLevel())
        {
  ...
  public void a(String paramString)
  {
    ...
    try
    {
      ...
      ToServiceMsg localToServiceMsg = new ToServiceMsg("mobileqq.service", this.b.getCurrentAccountUin(), "QQAIOMediaSvc.get_play_show_info");
      localToServiceMsg.extraData.putString("KEY_SESSION_UIN", paramString);
  ...
  public void a(JSONObject paramJSONObject)
  {
    try
    {
      ...
      localObject2 = new ToServiceMsg("mobileqq.service", this.b.getCurrentAccountUin(), "QQAIOMediaSvc.share_trans_check");
  ...
  public void b(JSONObject paramJSONObject)
  {
    try
    {
      ...
      localObject1 = new ToServiceMsg("mobileqq.service", this.b.getCurrentAccountUin(), "QQAIOMediaSvc.share_trans");
  ...
  public long e(int paramInt, String paramString)
  {
    return ((TogetherOperationHandler)this.b.getBusinessHandler(BusinessHandlerFactory.TOGETHER_OPERATOR_HANDLER)).a(1, paramInt, paramString);
  }
