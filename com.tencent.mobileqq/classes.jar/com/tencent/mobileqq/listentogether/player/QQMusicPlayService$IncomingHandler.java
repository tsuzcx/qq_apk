  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            do
            {
              do
              {
                    ...
                    do
                    {
                      do
                      {
                        do
                        {
                          do
                          {
                            do
                            {
                              QQMusicPlayService.ReleaseObject localReleaseObject;
                              do
                              {
                                return;
                                try
                                ...
                                localReleaseObject = (QQMusicPlayService.ReleaseObject)paramMessage.obj;
                              } while (localReleaseObject == null);
                              ...
                              for (paramMessage = "null";; paramMessage = QQMusicPlayService.b().a())
                              {
                                ...
                                if (localReleaseObject.a != null)
                                {
                                  localReleaseObject.a.release();
                                  if (QQMusicPlayService.a() == localReleaseObject.a) {
                      ...
                      if ((paramMessage.equals(QQMusicPlayService.b())) && ((QQMusicPlayService.e() == 2) || (QQMusicPlayService.e() == 1)))
                      {
                        ...
                        for (i = -1;; i = Math.abs(m - paramMessage.a()))
                        {
                          ...
                          QQMusicPlayReport.a(i, NetworkUtil.b((Context)localObject));
                          return;
                        }
                      }
                ...
                } while ((QQMusicPlayService.e() != 2) && ((QQMusicPlayService.e() != 1) || (QQMusicPlayService.a() == null)));
          ...
          } while (!NetworkUtil.g(((QQMusicPlayService)localObject).getApplicationContext()));
          if (QLog.isColorLevel()) {
    ...
    for (float f = 0.0F;; f = 1.0F)
    {
      ...
      for (bool1 = true;; bool1 = false)
      {
        ...
        QQMusicPlayService.a((QQMusicPlayService)localObject, QQMusicPlayService.b(), QQMusicPlayService.b(), QQMusicPlayService.g());
        return;
