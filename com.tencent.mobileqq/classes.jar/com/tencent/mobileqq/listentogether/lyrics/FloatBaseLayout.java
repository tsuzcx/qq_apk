  ...
  extends FrameLayout
{
  ...
  {
    this.e = aepi.a(3.0F, getResources());
  ...
  public void b()
  {
    this.jdField_a_of_type_Atnt = null;
  }
  ...
  public boolean dispatchTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    case 2: 
      for (;;)
      {
        ...
        if ((this.jdField_a_of_type_Atnt != null) && (this.jdField_b_of_type_Boolean)) {
          this.jdField_a_of_type_Atnt.a((int)(f1 - this.jdField_a_of_type_Float), (int)(f2 - this.jdField_b_of_type_Float));
        }
  ...
  public void setFloatLayoutCallback(atnt paramatnt)
  {
    this.jdField_a_of_type_Atnt = paramatnt;
  }
}
