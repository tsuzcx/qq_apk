  ...
  implements FloatLayoutCallback, ILyricView.LyricState, SkinDrawable.IVasSkinChangeCallback
{
  ...
  public LyricsController(QQAppInterface paramQQAppInterface)
  {
    ...
    int j = AIOUtils.a(12.0F, paramQQAppInterface.getResources());
    this.jdField_d_of_type_Int = j;
    this.jdField_b_of_type_Int = j;
    j = AIOUtils.a(12.0F, paramQQAppInterface.getResources());
    this.jdField_e_of_type_Int = j;
    this.jdField_c_of_type_Int = j;
    this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_a_of_type_Int = -1000;
    this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_b_of_type_Int = -1000;
    f();
  ...
  private boolean a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    ILyricView localILyricView;
    do
    {
      return false;
      localILyricView = a();
    } while ((localILyricView == null) || (!paramString1.equals(localILyricView.a())) || (localILyricView.a() == 2));
  ...
  private void b(String paramString, int paramInt)
  {
    ...
    if (paramInt == 2)
    {
      ...
      QLog.i("LyricsController", 1, "updateLyricPosition() seek to playPosition:" + 0 + " isPlaying:" + bool);
      localILyricView.a(0);
      return;
    }
    if (3 == paramInt)
  ...
  private boolean b(int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_b_of_type_Boolean = this.jdField_a_of_type_JavaUtilSet.contains(paramInt + "_" + paramString);
        if (this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.b(paramInt, paramString))
        {
          ...
          {
            this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_c_of_type_Boolean = bool1;
            this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_d_of_type_Boolean = true;
          }
          ...
          if (this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_b_of_type_Int == -1000) {
            this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_b_of_type_Int = (this.jdField_g_of_type_Int - this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.e() / 2 - AIOUtils.a(110.0F, BaseApplicationImpl.getContext().getResources()));
          }
          this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_e_of_type_Boolean = true;
          if (QLog.isColorLevel()) {
            QLog.d("LyricsController", 2, "showLyricsInner mFloatParams: " + this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams);
          }
          ...
          this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams), this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.b(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams));
          this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams), this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.b(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams));
          boolean bool3 = this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams);
          bool1 = this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams);
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_a_of_type_Boolean) {}
    for (this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_a_of_type_Int = (this.jdField_d_of_type_Int + this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.d() / 2);; this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_a_of_type_Int = (this.jdField_f_of_type_Int - this.jdField_b_of_type_Int - this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.d() / 2))
    {
      if (this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_b_of_type_Int == -1000) {
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_b_of_type_Int = (AIOUtils.a(70.0F, BaseApplicationImpl.getContext().getResources()) + this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.e() / 2);
      }
  ...
  private void c(String paramString, int paramInt)
  {
    ILyricView localILyricView = a();
    if (localILyricView == null) {}
    while (!Utils.a(localILyricView.a(), paramString)) {
      return;
    }
  ...
  private void q()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_h_of_type_Boolean = false;
    boolean bool1;
    if (this.jdField_b_of_type_Boolean) {
      if ((this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_f_of_type_Boolean) && (!this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_g_of_type_Boolean))
      {
        ...
        k = this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_b_of_type_Int;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_a_of_type_Boolean = bool1;
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_a_of_type_Int = j;
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_b_of_type_Int = k;
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams);
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams);
        if ((this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_f_of_type_Boolean) && (!this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_g_of_type_Boolean)) {
          i();
        ...
        break label251;
        label473:
        if (this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_d_of_type_Boolean)
        {
          if (bool1) {}
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("LyricsController", 2, "onPositionChangeEnd mFloatParams:" + this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams + " mScreenWidth:" + this.jdField_f_of_type_Int + " mScreenHeight:" + this.jdField_g_of_type_Int);
    }
    q();
    r();
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    {
      j = this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_a_of_type_Int;
      m = this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_b_of_type_Int;
      k = j - paramInt1;
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_e_of_type_Boolean = false;
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_a_of_type_Int = paramInt1;
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_b_of_type_Int = paramInt2;
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams), this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.b(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams));
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams), this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.b(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams));
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams);
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams);
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("LyricsController", 2, "onExitAIO, type:" + paramInt + " uin:" + paramString + ", isForeground: " + this.jdField_a_of_type_Boolean + " mFloatParams:" + this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams);
    }
    int k;
    int m;
    int j;
    if (this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.b(paramInt, paramString))
    {
      ...
      if (!this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_c_of_type_Boolean)
      {
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_c_of_type_Boolean = true;
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_d_of_type_Boolean = true;
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_h_of_type_Boolean = false;
    ...
    for (paramInt = -this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.d();; paramInt = this.jdField_f_of_type_Int)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.b();
      this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_h_of_type_Boolean = true;
      this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_h_of_type_Int = k;
      this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.i = m;
      this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_a_of_type_AndroidGraphicsPaint$Align = Paint.Align.CENTER;
      ThreadManager.getUIHandlerV2().removeCallbacks(this.jdField_b_of_type_JavaLangRunnable);
      paramInt = 300;
      if (paramBoolean) {
        paramInt = 500;
  ...
  public void b()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.a()) && (BaseActivity.sTopActivity != null))
    {
      ...
      if (bool) {
        ((ActionSheet)localObject).addButton(2131693718);
      }
      ((ActionSheet)localObject).addButton(2131693693);
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("LyricsController", 2, "hideLyrics,  type:" + paramInt + " uin:" + paramString + " mFloatParams:" + this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams);
    }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("LyricsController", 2, "onEnterAIO, type:" + paramInt + " uin:" + paramString + " mFloatParams:" + this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams + " mIsForeground:" + this.jdField_a_of_type_Boolean);
    }
    ...
    for (boolean bool = false;; bool = true)
    {
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_c_of_type_Boolean = bool;
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("LyricsController", 2, "onDestroyAIO, type:" + paramInt + " uin:" + paramString + ", isForeground: " + this.jdField_a_of_type_Boolean + " mFloatParams:" + this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams);
    }
  ...
  public void g()
  {
    ...
    if (!bool)
    {
      ...
      if (!this.jdField_d_of_type_Boolean)
      {
        ...
        PublicFragmentActivity.Launcher.a(BaseApplicationImpl.getContext(), localIntent, PublicTransFragmentActivity.class, ListenTogetherOverlayFragment.class);
  ...
  public void h()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_g_of_type_Boolean = false;
    q();
    int j = this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_e_of_type_Int;
    String str3 = this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_b_of_type_JavaLangString;
    b(j, str3, true);
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ((ListenTogetherHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.LISTEN_TOGETHER_HANDLER)).notifyUI(14, true, new Object[] { Integer.valueOf(j), str3 });
      ...
      ReportController.b(null, "dc00899", "c2c_AIO", "", "music_tab", "clk_close", 0, 0, str3, "", "", "");
    }
    label156:
    ...
    for (;;)
    {
      ReportController.b(null, "dc00899", "Grp_AIO", "", "music_tab", "clk_close", 0, 0, str3, "", str1, "");
      return;
      label250:
      str1 = str2;
  ...
  protected void j()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_a_of_type_Int = ((SharedPreferences)localObject2).getInt("listen_together_float_loc_icon_cx", this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_a_of_type_Int);
    this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_b_of_type_Int = ((SharedPreferences)localObject2).getInt("listen_together_float_loc_icon_cy", this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_b_of_type_Int);
    this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_a_of_type_Boolean = ((SharedPreferences)localObject2).getBoolean("listen_together_float_align_right", this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatParams.jdField_a_of_type_Boolean);
