  ...
  implements Manager
{
  ...
  Map<String, bats> jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  boolean jdField_a_of_type_Boolean;
  Map<String, baos> b;
  
  static
  {
    jdField_b_of_type_JavaLangString = ajed.cb + "ChatBgJson.txt";
    jdField_a_of_type_Int = 1;
    jdField_a_of_type_AndroidOsHandler = new arnx(BaseApplication.getContext().getMainLooper());
  }
  ...
  private Vector<Integer> a(Context paramContext, SessionInfo paramSessionInfo, String paramString)
  {
    ...
    Object localObject = new arnu(this, paramContext);
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ThreadManager.executeOnFileThread(new ChatBackgroundManager.BgColorExtractJob(this, paramString, paramContext, bool1, (arnw)localObject));
      return null;
      paramSessionInfo = bacm.c(paramSessionInfo.a.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
      bool2 = true;
      paramContext = paramSessionInfo;
      bool1 = bool2;
      if (QLog.isDevelopLevel())
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, awrn paramawrn)
  {
    ...
    try
    {
      paramawrn.b(paramQQAppInterface, paramString, localHashMap);
      return;
    }
  ...
  {
    bapf.a(BaseApplicationImpl.getApplication().getRuntime(), "individual_v2_background_play_fail", "0", paramString, Build.MODEL, Build.VERSION.RELEASE, Long.toString(babp.d()), 0.0F, 0.0F);
    bape.a("individual_v2_background_play_fail", Build.MODEL + " " + Build.VERSION.RELEASE + " " + Long.toString(babp.d()));
  }
  ...
  private void a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject = new ThemeDIYData(2130846371, "theme_bg_message_path", 2131100852, "theme_bg_message_path_png", 50, 1);
        ...
        new ThemeDiyStyleLogic.DarkBrightnessTask(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString2, paramString1.path, (ThemeDIYData)localObject, null, new arnv(this)).execute(new Object[0]);
      }
      return;
  ...
  {
    paramContext = ackc.a(paramContext, paramString1, paramString2);
  ...
  public Bundle a(String paramString)
  {
    ...
    paramString = (baos)this.jdField_b_of_type_JavaUtilMap.get(paramString);
    if (paramString != null)
    {
  ...
  public String a(String paramString)
  {
    try
    {
      Object localObject = bace.a(new File(jdField_b_of_type_JavaLangString));
  ...
  {
    SharedPreferences localSharedPreferences = ackc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), paramString1, 4);
    if (TextUtils.isEmpty(paramString2))
    {
      paramString1 = localSharedPreferences.getString("chat_uniform_bg", null);
  ...
  {
    Object localObject = ackc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 4);
    HashMap localHashMap = new HashMap();
  ...
  {
    int j = 0;
    Object localObject = baph.a(paramBitmap);
    if ((localObject != null) && (!((List)localObject).isEmpty()))
    {
      paramBitmap = ((List)localObject).iterator();
      for (int i = 0; paramBitmap.hasNext(); i = ((bapi)paramBitmap.next()).jdField_a_of_type_Int + i) {}
      paramBitmap = new Vector();
      float f = ((bapi)((List)localObject).get(0)).a();
      ...
      do
      {
        ...
        bapi localbapi = (bapi)((Iterator)localObject).next();
        if (localbapi.a() / f <= 0.2F) {
          break;
        }
        paramBitmap.add(Integer.valueOf(localbapi.a()));
        k = j + localbapi.jdField_a_of_type_Int;
        j = k;
  ...
  public void a(int paramInt1, int paramInt2, String paramString1, String paramString2, int paramInt3)
  {
    ...
    {
      ackc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), paramString1, ackc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), paramString1), paramInt2, paramInt3);
      return;
    }
    if (("100".equals(String.valueOf(paramInt1))) || ("0".equals(String.valueOf(paramInt1))))
    {
      ackc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), paramString1, "null", paramInt2, paramInt3);
      return;
    }
    ...
    {
      ackc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), paramString1, str, paramInt2, paramInt3);
      return;
    }
    localChatBackgroundInfo.id = String.valueOf(paramInt1);
    a(paramString2 + "_" + paramInt1, new arnt(this, paramString1, paramInt2, paramInt3));
  ...
  void a(int paramInt, String paramString, long paramLong)
  {
    ...
    int i = badq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext());
    awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "chatbackground", "BjIDXiazai", 0, paramInt, "0", "0", i + "", String.valueOf(paramLong));
  }
  ...
  public void a(long paramLong, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, VasQuickUpdateManager paramVasQuickUpdateManager)
  {
    ...
    paramString1 = (baos)this.jdField_b_of_type_JavaUtilMap.get(paramString2);
    if (paramString1 == null)
    {
      paramString1 = new baos();
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if ((!this.jdField_a_of_type_JavaUtilMap.isEmpty()) && (paramString1.jdField_a_of_type_AndroidOsBundle != null) && (paramString1.jdField_a_of_type_AndroidOsBundle.containsKey("callbackId")))
        {
          ...
          paramString3 = (bats)this.jdField_a_of_type_JavaUtilMap.remove(paramString3);
        ...
        {
          label421:
          bace.a(localFile.getAbsolutePath(), paramVasQuickUpdateManager, false);
  ...
  public void a(Intent paramIntent)
  {
    ...
    if (paramIntent != null)
    {
      ...
      if (i != 999) {
        awqx.b(null, "CliOper", "", "", "background", "bkground_replace", i, 0, "0", "0", "", "");
      }
    }
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString, int paramInt)
  {
    ...
    paramString = (baos)this.jdField_b_of_type_JavaUtilMap.get(str);
    paramQQAppInterface = paramString;
    if (paramString == null)
    {
      paramQQAppInterface = new baos();
  ...
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null) || ((paramString == null) && (!bato.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext()))) || (paramChatBackgroundInfo == null)) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          this.jdField_a_of_type_Boolean = bavz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), "ChatBackgroundManager", false);
  ...
  public void a(String paramString, bats parambats)
  {
    this.jdField_a_of_type_JavaUtilMap.put(paramString, parambats);
  }
  
  public void a(String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ackc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext(), paramString1, paramString2, paramString3, paramInt);
    awqx.b(null, "CliOper", "", "", "chatbackground", "BjIDShezhi", 0, 0, "0", "0", "", d(paramString3));
  }
  ...
  {
    SharedPreferences localSharedPreferences = ackc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 4);
    HashMap localHashMap = new HashMap();
