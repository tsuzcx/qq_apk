  ...
  implements Manager
{
  ...
  static
  {
    ...
    jdField_a_of_type_JavaLangString = HardCodeUtil.a(2131702272);
    jdField_b_of_type_JavaLangString = HardCodeUtil.a(2131702271);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageForMarketFace paramMessageForMarketFace)
  {
    ...
    {
      i = ((CommercialDrainageManager)paramQQAppInterface.getManager(QQManagerFactory.COMMERCIAL_DRAINAGE_MANAGER)).a(paramMessageForMarketFace.time, String.valueOf(localMarkFaceMessage.dwTabID), localMarkFaceMessage.copywritingContent, localMarkFaceMessage.copywritingType);
      if (i != 0) {
        break label70;
      }
  ...
  public int a(long paramLong, String paramString1, String paramString2, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        localObject = VasUpdateUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "vip_personal_card.json", false, null);
        if (localObject == null) {
          continue;
        }
