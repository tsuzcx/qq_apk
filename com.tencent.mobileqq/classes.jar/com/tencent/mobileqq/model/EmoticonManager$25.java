...
public class EmoticonManager$25
  implements Runnable
{
  public EmoticonManager$25(arnz paramarnz, EmosmPb.SubCmd0x5RspBQRecommend paramSubCmd0x5RspBQRecommend, int paramInt) {}
  ...
  public void run()
  {
    ...
    if (i > 0) {
      arnz.jdField_a_of_type_Int = i;
    }
    if (QLog.isColorLevel()) {
      QLog.d("EmoticonManager", 2, "saveAndUpdateRecommendEmosInfo maxexposenum = " + arnz.jdField_a_of_type_Int);
    }
