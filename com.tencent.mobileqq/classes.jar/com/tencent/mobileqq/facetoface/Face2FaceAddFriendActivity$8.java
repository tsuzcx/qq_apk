  ...
  extends MessageObserver
{
  ...
  public void onGetSystemMsgFin(boolean paramBoolean1, boolean paramBoolean2, List<MessageRecord> paramList)
  {
    ...
    for (;;)
    {
      ...
      {
        new ArrayList();
        localObject = this.a.app.getMessageFacade().b(AppConstants.FRIEND_SYSTEM_MSG_UIN, 0);
        if (QLog.isColorLevel()) {
      ...
      if (localException.structMsg.msg_type.get() == 1)
      {
        ...
        else
        {
          ...
          for (boolean bool = true;; bool = false)
          {
            ...
            String str1 = this.a.getResources().getString(2131719695);
  ...
  public void onSendSystemMsgActionError(String paramString)
  {
    ...
    try
    {
      ...
      if (localObject != null)
      {
        ...
        localObject = this.a.getResources().getString(2131692213);
