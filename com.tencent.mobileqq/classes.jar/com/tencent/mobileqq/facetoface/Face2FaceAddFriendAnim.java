...
public class Face2FaceAddFriendAnim
{
  ...
  List<Integer> jdField_f_of_type_JavaUtilList = Arrays.asList(new Integer[] { Integer.valueOf(2131367469), Integer.valueOf(2131367471), Integer.valueOf(2131367472), Integer.valueOf(2131367473), Integer.valueOf(2131367474), Integer.valueOf(2131367475), Integer.valueOf(2131367476), Integer.valueOf(2131367477), Integer.valueOf(2131367478), Integer.valueOf(2131367470) });
  int g;
  int h = 0;
  int i = 0;
  int j = 0;
  ...
  public void a(QQAppInterface paramQQAppInterface, View paramView, int paramInt, String paramString)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131365165));
    if ((paramInt == 1) && (!TextUtils.isEmpty(paramString)))
    {
      ((ImageView)paramView.findViewById(2131365166)).setVisibility(4);
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130840237);
      paramQQAppInterface = paramQQAppInterface.getTroopFaceBitmap(paramString, (byte)3, false, false);
      if (paramQQAppInterface != null) {
        break label476;
      }
      paramQQAppInterface = ImageUtil.a();
    }
    label476:
    for (;;)
    {
      paramString = (ImageView)paramView.findViewById(2131379873);
  ...
  public void a(Face2FaceUserData paramFace2FaceUserData, boolean paramBoolean1, int paramInt, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (;;)
    {
      ...
      default: 
        ...
        ((TranslateAnimation)localObject2).setAnimationListener(new Face2FaceAddFriendAnim.1(this, paramFace2FaceUserData, m, d1, bool, paramBoolean3, paramFace2FaceUserData, paramBoolean1, paramBoolean2, (Face2FaceFriendBubbleView)localObject1, paramInt));
