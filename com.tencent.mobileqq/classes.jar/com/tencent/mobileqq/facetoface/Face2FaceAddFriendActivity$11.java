  ...
  extends NearFieldTroopObserver
{
  ...
  public void a(nearfield_group.BusiRespHead paramBusiRespHead, String paramString)
  {
    ...
    for (paramBusiRespHead = paramBusiRespHead.e + "_" + ((Face2FaceGroupProfile)paramBusiRespHead).jdField_b_of_type_JavaLangString;; paramBusiRespHead = paramString)
    {
      ...
      break;
      ReportController.b(null, "P_CliOper", "Grp_set", "", "Radar_grp_guest", "suc_join", 0, 0, paramString, "8.5.5", "", this.a.app.getCurrentAccountUin());
  ...
  public void a(nearfield_group.BusiRespHead paramBusiRespHead, List<Face2FaceGroupProfile> paramList)
  {
    ...
    if (paramList == null)
    {
      ...
      if (this.a.jdField_b_of_type_Int == 1) {
        DialogUtil.a(this.a, 230, this.a.getString(2131719900), HardCodeUtil.a(2131704317), 2131690800, 2131692161, new Face2FaceAddFriendActivity.11.1(this), null).show();
      }
    }
    label179:
    label185:
    ...
    label421:
    DialogUtil.a(this.a, 230, this.a.getString(2131719900), HardCodeUtil.a(2131704310), 2131690800, 2131692161, new Face2FaceAddFriendActivity.11.2(this), null).show();
  }
}
