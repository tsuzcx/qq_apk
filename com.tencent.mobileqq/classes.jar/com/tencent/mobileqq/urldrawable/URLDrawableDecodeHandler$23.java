...
final class URLDrawableDecodeHandler$23
  implements DownloadParams.DecodeHandler
{
  public Bitmap run(DownloadParams paramDownloadParams, Bitmap paramBitmap)
  {
    try
    {
      ...
      {
        QLog.d(URLDrawableDecodeHandler.a(), 2, String.format("ALIGN_TOP_DECODER srcHeight = %s, srcWidth = %s, reqWidth = %s, reqHeight = %s, scale = %s", new Object[] { Integer.valueOf(i), Integer.valueOf(j), Integer.valueOf(k), Integer.valueOf(m), Float.valueOf(f) }));
        break;
      }
 ...
 * Qualified Name:     com.tencent.mobileqq.urldrawable.URLDrawableDecodeHandler.23
