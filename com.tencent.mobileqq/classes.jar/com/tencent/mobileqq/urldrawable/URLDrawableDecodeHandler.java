...
{
  public static final DownloadParams.DecodeHandler A = new URLDrawableDecodeHandler.24();
  public static final DownloadParams.DecodeHandler a;
  private static String a;
  public static final DownloadParams.DecodeHandler b;
  public static final DownloadParams.DecodeHandler c;
  public static final DownloadParams.DecodeHandler d;
  public static final DownloadParams.DecodeHandler e;
  public static final DownloadParams.DecodeHandler f;
  public static final DownloadParams.DecodeHandler g;
  public static final DownloadParams.DecodeHandler h;
  public static final DownloadParams.DecodeHandler i;
  public static final DownloadParams.DecodeHandler j;
  public static final DownloadParams.DecodeHandler k;
  public static final DownloadParams.DecodeHandler l;
  public static final DownloadParams.DecodeHandler m;
  public static final DownloadParams.DecodeHandler n;
  public static final DownloadParams.DecodeHandler o;
  public static final DownloadParams.DecodeHandler p;
  public static final DownloadParams.DecodeHandler q;
  public static final DownloadParams.DecodeHandler r;
  public static final DownloadParams.DecodeHandler s;
  public static final DownloadParams.DecodeHandler t;
  public static final DownloadParams.DecodeHandler u;
  public static final DownloadParams.DecodeHandler v;
  public static final DownloadParams.DecodeHandler w;
  public static final DownloadParams.DecodeHandler x;
  public static final DownloadParams.DecodeHandler y;
  public static final DownloadParams.DecodeHandler z;
  ...
  static
  {
    ...
    b = new URLDrawableDecodeHandler.2();
    c = new URLDrawableDecodeHandler.3();
    d = new URLDrawableDecodeHandler.4();
    e = new URLDrawableDecodeHandler.5();
    f = new URLDrawableDecodeHandler.6();
    g = new URLDrawableDecodeHandler.7();
    h = new URLDrawableDecodeHandler.8();
    i = new URLDrawableDecodeHandler.9();
    j = new URLDrawableDecodeHandler.10();
    k = new URLDrawableDecodeHandler.11();
    l = new URLDrawableDecodeHandler.12();
    m = new URLDrawableDecodeHandler.13();
    n = new URLDrawableDecodeHandler.14();
    o = new URLDrawableDecodeHandler.15();
    p = new URLDrawableDecodeHandler.16();
    q = new URLDrawableDecodeHandler.17();
    r = new URLDrawableDecodeHandler.18();
    s = new URLDrawableDecodeHandler.19();
    t = new URLDrawableDecodeHandler.FastBlurDecoder(10);
    u = new URLDrawableDecodeHandler.FastBlurDecoder(20);
    v = new URLDrawableDecodeHandler.20();
    w = new URLDrawableDecodeHandler.21();
    x = new URLDrawableDecodeHandler.ReadInJoyVideoFeedsFastBlurDecoder();
    y = new URLDrawableDecodeHandler.22();
    z = new URLDrawableDecodeHandler.23();
  }
