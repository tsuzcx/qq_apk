  ...
  implements IWebViewBuilder
{
  ...
  private void j()
  {
    ...
    View localView = LayoutInflater.from(this.jdField_f_of_type_AndroidContentContext).inflate(2130971752, null);
    this.jdField_h_of_type_AndroidAppActivity.setContentView(localView);
    this.jdField_a_of_type_AndroidViewView = localView.findViewById(2131375513);
    ...
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131366356));
    this.jdField_b_of_type_AndroidWidgetFrameLayout = ((FrameLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131373102));
    ...
    this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)this.jdField_a_of_type_AndroidViewView.findViewById(2131363054));
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131375514);
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131364143));
    if ((this.d != null) && (!this.d.getBooleanExtra("webview_hide_progress", false)))
    {
      this.jdField_a_of_type_ComTencentMobileqqWidgetWebViewProgressBar = ((WebViewProgressBar)this.jdField_a_of_type_AndroidViewView.findViewById(2131366768));
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_ComTencentBizUiTouchWebView.setId(2131362578);
  ...
  public void a(Bundle paramBundle)
  {
    ...
    if ((this.e) && (ImmersiveUtils.isSupporImmersive() == 1))
    {
      ...
      int i = this.jdField_h_of_type_AndroidAppActivity.getResources().getColor(2131494260);
  ...
  public void b(boolean paramBoolean, WebViewBaseBuilder.ImmersiveParam paramImmersiveParam)
  {
    ...
    paramImmersiveParam.jdField_b_of_type_AndroidViewView.setBackgroundResource(2130845951);
  ...
  public void f()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setBackgroundResource(2130845951);
    if (this.d != null)
    {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWebviewUiWebViewTitlerBar.a(new akuc(this));
  }
