  ...
  extends RadioGroup
{
  ...
  RadioButton a(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_AndroidViewLayoutInflater != null) {
      localObject = (RadioButton)this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131497020, this, false);
    }
    for (;;)
    {
  ...
  public void setButtonNum(int paramInt1, int paramInt2)
  {
    ...
    {
      localObject = new LinearLayout.LayoutParams(-2, azvv.a(super.getContext(), 30.0F));
      ...
      super.addView((View)localObject, new LinearLayout.LayoutParams(-2, azvv.a(super.getContext(), 30.0F)));
    }
    for (;;)
    {
      paramInt2 += 1;
  ...
  public void setLeftAndRightPaddingByDp(int paramInt)
  {
    ...
    while (i < super.getChildCount())
    {
      super.getChildAt(i).setPadding(azvv.a(super.getContext(), paramInt), super.getPaddingTop(), azvv.a(super.getContext(), paramInt), super.getPaddingBottom());
      i += 1;
    }
  }
