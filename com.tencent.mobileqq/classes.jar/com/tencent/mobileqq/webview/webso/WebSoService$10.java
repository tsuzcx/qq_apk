...
final class WebSoService$10
  implements Runnable
{
  WebSoService$10(bbdn parambbdn, Uri paramUri, String paramString1, String paramString2, WebSoService.WebSoState paramWebSoState) {}
  ...
  public void run()
  {
    ...
    if (this.jdField_a_of_type_Bbdn != null)
    {
      localObject1 = localObject2;
      if (this.jdField_a_of_type_Bbdn.d != null)
      {
        bbee.a(this.jdField_a_of_type_Bbdn.d.getBytes(), bbee.b(this.jdField_a_of_type_AndroidNetUri));
        localObject1 = bbdp.a(this.jdField_a_of_type_Bbdn.d);
      }
    }
    if ((!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) && (this.jdField_a_of_type_AndroidNetUri != null))
    {
      ...
      String str2 = bbee.a(this.jdField_a_of_type_AndroidNetUri);
