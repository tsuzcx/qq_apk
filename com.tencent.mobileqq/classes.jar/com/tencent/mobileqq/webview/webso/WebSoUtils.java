...
public class WebSoUtils
{
  ...
  public static String a()
  {
    ...
    for (;;)
    {
      ...
      ((StringBuilder)localObject).append(" ").append("QQ/").append("7.6.0").append(".").append("3525").append(str).append(" Pixel/").append(BaseApplicationImpl.getContext().getResources().getDisplayMetrics().widthPixels);
