  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      bbee.a(this.jdField_a_of_type_JavaLangString.getBytes(), bbee.b(this.jdField_a_of_type_AndroidNetUri));
      str1 = bbdp.a(this.jdField_a_of_type_JavaLangString);
    }
    ...
    if ((!TextUtils.isEmpty(this.b)) && (this.jdField_a_of_type_AndroidNetUri != null))
    {
      ...
      String str3 = bbee.a(this.jdField_a_of_type_AndroidNetUri);
