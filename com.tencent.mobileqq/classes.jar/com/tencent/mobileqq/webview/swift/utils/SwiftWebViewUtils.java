...
public class SwiftWebViewUtils
{
  ...
  public static Bundle a(WebViewFragment paramWebViewFragment, Intent paramIntent)
  {
    ...
    if (localObject != null)
    {
      ...
      if (Build.VERSION.SDK_INT >= 19) {
        ...
        {
          paramWebViewFragment.a.evaluateJavascript("document.querySelector(\"meta[itemprop='name']\").getAttribute('content')", new akcq(paramWebViewFragment));
          paramIntent = null;
        }
      }
    }
  ...
  public static String a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    {
      return paramString1 + " QQ/" + "7.6.0" + "." + "3525" + str1 + str2 + " Pixel/" + i;
    ...
    if ((!TextUtils.isEmpty(paramString)) && (paramString.equalsIgnoreCase(paramJSONObject.optString("business", ""))))
    {
      ...
      if (bool2)
      {
        ...
        if (paramJSONObject.has("minVersion"))
        {
          ...
          {
            bool1 = bool2;
            if (!IndividuationUrlHelper.a(paramString, "7.6.0.3525")) {
              bool1 = false;
            }
          }
        }
      ...
      if (bool1)
      {
        ...
        if (paramJSONObject.has("maxVersion"))
        {
          ...
          {
            bool2 = bool1;
            if (!IndividuationUrlHelper.a("7.6.0.3525", paramString)) {
              bool2 = false;
            }
          }
        }
