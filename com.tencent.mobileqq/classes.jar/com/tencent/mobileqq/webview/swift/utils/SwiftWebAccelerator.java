...
public class SwiftWebAccelerator
{
  ...
  public int a;
  final SwiftBrowserStateMachineScheduler jdField_a_of_type_ComTencentMobileqqWebviewSwiftSchedulerSwiftBrowserStateMachineScheduler = new SwiftBrowserStateMachineScheduler(new akci(this));
  public boolean a;
  public int b = 0;
  ...
  public static void b()
  {
    ...
    if (WebViewPluginEngine.a == null) {
      ThreadManager.postImmediately(new akcp(l), null, false);
    }
  }
  ...
  public int a(Bundle paramBundle)
  {
    ...
    for (boolean bool = BaseApplicationImpl.sApplication.getSharedPreferences("sp_x5_config_" + (String)localObject, 4).getBoolean("key_x5_init_sub_thread", true);; bool = true)
    {
      ...
      if (bool)
      {
        ThreadManager.postImmediately(new akck(this, l, paramBundle), null, false);
        return -1;
      }
  ...
  public void a(Bundle paramBundle)
  {
    ...
    new Handler(Looper.getMainLooper()).post(new akcj(this, paramBundle));
  }
  ...
  public void b(Bundle paramBundle)
  {
    ...
    ThreadManager.postImmediately(new akcm(this, System.currentTimeMillis(), paramBundle), null, false);
  }
  ...
  public int c(Bundle paramBundle)
  {
    ...
    if ((!TextUtils.isEmpty(paramBundle)) && ((paramBundle.startsWith("http:")) || (paramBundle.startsWith("https:"))))
    {
      ...
      new Handler(Looper.getMainLooper()).postDelayed(new akcl(this, localSwiftReuseTouchWebView), 300L);
    }
  ...
  public void c(Bundle paramBundle)
  {
    ...
    ThreadManager.postImmediately(new akco(this, System.currentTimeMillis()), null, false);
  }
