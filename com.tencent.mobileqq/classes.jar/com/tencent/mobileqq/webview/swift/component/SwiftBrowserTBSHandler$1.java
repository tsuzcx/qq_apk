...
public class SwiftBrowserTBSHandler$1
  implements Runnable
{
  public SwiftBrowserTBSHandler$1(bihz parambihz, int paramInt) {}
  ...
  public void run()
  {
    ...
    StringBuilder localStringBuilder = new StringBuilder().append(anvx.a(2131714077));
    if (this.a == 0) {}
