...
public class SwiftBrowserShareMenuHandler
  ...
  implements DialogInterface.OnDismissListener, ShareActionSheet.OnItemClickListener, RangeButtonView.OnChangeListener
{
  ...
  {
    if (paramInt == 1) {
      return this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131719817, new Object[] { this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131691371) });
    }
    if (paramInt == 3) {
      return this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131719817, new Object[] { this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131719318) });
    }
    if (paramInt == 10) {
      return this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131719817, new Object[] { this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131719314) });
    }
    if (paramInt == 12) {
      return this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131719817, new Object[] { this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131696398) });
    }
    return this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131719817, new Object[] { this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131720375) });
  }
  ...
  {
    DialogUtil.a(this.jdField_a_of_type_AndroidAppActivity, a(paramInt), 2131691888, 2131720671, new SwiftBrowserShareMenuHandler.4(this, paramInt, paramString), new SwiftBrowserShareMenuHandler.5(this, paramInt, paramString)).show();
  }
  ...
  private void b(String paramString)
  {
    ...
    if ((this.i) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentBizWebviewpluginShare.p))) {
  ...
  private void c(String paramString)
  {
    ...
    for (;;)
    {
      ...
      ((IPublicAccountReportUtils)QRoute.api(IPublicAccountReportUtils.class)).publicAccountReportClickEvent(null, "", "0X800787A", "0X800787A", 0, 0, (String)localObject, str, "", "");
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    ...
    do
    {
      do
      {
        ...
        if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFontSizePanel != null) {
          this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFontSizePanel.a();
        }
        if (this.jdField_a_of_type_ComTencentBizTroopTroopMemberApiClient != null)
        {
          this.jdField_a_of_type_ComTencentBizTroopTroopMemberApiClient.a(this.jdField_c_of_type_Int);
    ...
    } while ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFontSizePanel == null) || (!this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFontSizePanel.a()));
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFontSizePanel.b();
    d();
  }
  ...
  public void a(int paramInt, String paramString, Bundle paramBundle)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null)
    {
      localObject2 = this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getRedirect302Url();
    ...
    for (localObject1 = ((WebView)localObject3).getOriginalUrl();; localObject1 = null)
    {
      ...
      for (;;)
      {
        ...
        catch (Exception localException)
        {
          ...
          b(paramString);
          continue;
          VasWatchWord.a.a(this.jdField_a_of_type_AndroidAppActivity, paramString);
          n = paramInt;
          continue;
          if (paramInt != 11) {
            continue;
          ...
          try
          {
            ...
            if (n != 0)
            {
              ...
              paramString = ((IPublicAccountDetailActivity)QRoute.api(IPublicAccountDetailActivity.class)).getArticleId(str3);
              ((IPublicAccountReportUtils)QRoute.api(IPublicAccountReportUtils.class)).publicAccountReportClickEventForMigrate(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005B07", "0X8005B07", 1008, 0, str4, str2, str3, paramString, false);
              n = paramInt;
            }
          }
          ...
          if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserShareMenuHandler$ShareToFriendCallback == null) {
            continue;
          }
          this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserShareMenuHandler$ShareToFriendCallback.a(paramString);
          n = paramInt;
          continue;
          boolean bool2 = false;
          if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) {
          ...
          String str1 = this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserComponentsProvider$SwiftBrowserComponentContext.a().getUrl();
          ...
          QLog.d("SwiftBrowserShareMenuHandler", 2, new Object[] { "ShareArkFromH5 mShare.isShareArk=", Boolean.valueOf(this.jdField_a_of_type_ComTencentBizWebviewpluginShare.g), ",\n shareUrl=", Util.b(paramString, new String[0]) });
          if ((paramInt != 72) || (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentBizWebviewpluginShare.r))) {
            continue;
          }
          this.jdField_a_of_type_ComTencentBizWebviewpluginShare.a(n, str8, str7);
          ...
          paramBundle = (SwiftBrowserStatistics)this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserComponentsProvider$SwiftBrowserComponentContext.a().a(-2);
          bool1 = bool2;
          if (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getWebView().getUrl())) {
            continue;
          }
          bool1 = bool2;
          if (paramBundle == null) {
          ...
          str1 = this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getWebView().getUrl();
          bool1 = bool2;
          if (TextUtils.isEmpty(paramBundle.jdField_d_of_type_JavaLangString)) {
            continue;
          }
          if (paramBundle.jdField_d_of_type_JavaLangString.equals(str1)) {
            continue;
          }
          bool1 = bool2;
          if (!paramBundle.jdField_d_of_type_JavaLangString.equals(paramString)) {
            continue;
          }
          bool1 = true;
          continue;
          ...
          paramBundle.putString("to_uin_name", this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131698224));
          a(72, paramString, paramBundle);
          continue;
          if (paramInt != 4) {
            continue;
          }
          BrowserDialogViewModel.a(this.jdField_a_of_type_AndroidAppActivity, paramString, str6);
          n = paramInt;
          continue;
          if (paramInt != 5) {
            continue;
          ...
          paramString = ((IPublicAccountDetailActivity)QRoute.api(IPublicAccountDetailActivity.class)).getArticleId(str3);
          ((IPublicAccountReportUtils)QRoute.api(IPublicAccountReportUtils.class)).publicAccountReportClickEventForMigrate(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005B07", "0X8005B07", 1005, 0, str4, str2, str3, paramString, false);
          n = paramInt;
          continue;
          ...
          ((IPublicAccountUtil)QRoute.api(IPublicAccountUtil.class)).reportPAShareItemEvent(1002, (String)localObject1, this.jdField_f_of_type_Int);
          ...
          if (!this.jdField_a_of_type_ComTencentBizWebviewpluginShare.a(paramString)) {
            continue;
          }
          ...
          paramString = ((IPublicAccountDetailActivity)QRoute.api(IPublicAccountDetailActivity.class)).getArticleId(str3);
          ((IPublicAccountReportUtils)QRoute.api(IPublicAccountReportUtils.class)).publicAccountReportClickEventForMigrate(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005B07", "0X8005B07", 1007, 0, str4, str2, str3, paramString, false);
          n = paramInt;
          continue;
          if (paramInt != 129) {
            continue;
          }
          QfavHelper.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mApp.getCurrentAccountUin(), this.jdField_c_of_type_Long, this.jdField_d_of_type_Long);
          n = paramInt;
          continue;
          ...
          ((IPublicAccountUtil)QRoute.api(IPublicAccountUtil.class)).reportPAShareItemEvent(1003, (String)localObject1, this.jdField_f_of_type_Int);
          ...
          n = paramInt;
          continue;
          ((IPublicAccountUtil)QRoute.api(IPublicAccountUtil.class)).reportPAShareItemEvent(1004, (String)localObject1, this.jdField_f_of_type_Int);
          continue;
          ...
          return;
          a().a(i2, new SwiftBrowserShareMenuHandler.2(this));
          ReportController.b(null, "P_CliOper", "Grp_open", "", "third_app", "add_menu", 0, 1, 0, "" + i1, "" + i2, "", "");
          n = paramInt;
          continue;
          if (paramInt != 16) {
            continue;
          ...
          ReportController.b(null, "P_CliOper", "Grp_open", "", "third_app", "detail_menu", 0, 1, 0, "" + i1, "" + i2, "", "");
          n = paramInt;
          continue;
          if (paramInt != 17) {
            continue;
          ...
          paramBundle.putExtra("hide_more_button", true);
          this.jdField_a_of_type_AndroidAppActivity.startActivity(paramBundle);
          ReportController.b(null, "P_CliOper", "Grp_open", "", "third_app", "share_menu", 0, 1, 0, "" + i1, "" + i2, "", "");
          n = paramInt;
          continue;
          if (paramInt != 18) {
            continue;
          ...
          ReportController.b(null, "P_CliOper", "Grp_open", "", "third_app", "refresh_menu", 0, 1, 0, "" + i1, "" + i2, "", "");
          n = paramInt;
          continue;
          ...
          this.jdField_a_of_type_ComTencentBizWebviewpluginShare.a(paramString, n, false);
          n = paramInt;
          continue;
          n = 7;
          continue;
          this.jdField_a_of_type_ComTencentBizWebviewpluginShare.a(paramString, n, true);
          n = paramInt;
          continue;
          if (paramInt != 21) {
            continue;
          ...
          paramString = (IPublicAccountJavascriptInterface.ActionItem)((Iterator)localObject1).next();
          ...
          if (!((IPublicAccountProxy)QRoute.api(IPublicAccountProxy.class)).isPublicAccountBrowser(this.jdField_a_of_type_AndroidAppActivity)) {
            continue;
          }
          n = 0;
          TeamWorkConvertUtils.a(1, n);
          paramBundle = a();
          paramString = paramBundle;
          if (paramBundle != null) {
            continue;
          ...
          n = 1;
          continue;
          paramBundle = this.jdField_a_of_type_ComTencentBizWebviewpluginShare.b();
          continue;
          if (paramInt != 70) {
            continue;
          }
          paramString = ((QQBrowserActivity)this.jdField_a_of_type_AndroidAppActivity).getColorNoteController();
          n = paramInt;
          if (paramString == null) {
            continue;
          }
  ...
  public void a(Share paramShare, long paramLong, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    Object localObject1 = this.jdField_f_of_type_JavaLangString;
    if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) {
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getRedirect302Url();
    }
    for (;;)
    {
      for (;;)
      {
        ((IPublicAccountUtil)QRoute.api(IPublicAccountUtil.class)).reportPAShareButtonEvent((String)localObject1);
        ...
        {
          if (((SwiftBrowserStatistics)localObject1).m)
          {
            paramShare = "<font color='#777777'>应用由 </font><font color='#00a5e0'>" + this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.troopAppCompanyName + "</font><font color='#777777'> 提供</font>";
            this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder.setActionSheetTitle(Html.fromHtml(paramShare));
            ReportController.b(null, "P_CliOper", "Grp_open", "", "third_app", "exp_menu", 0, 1, 0, "" + this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.troopId, "" + this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.appId, "", "");
          }
        }
        else
        {
        ...
        try
        {
          ...
          Object localObject2 = paramShare;
          if (paramShare == null) {
            localObject2 = "";
          }
          ((IPublicAccountReportUtils)QRoute.api(IPublicAccountReportUtils.class)).publicAccountReportClickEventForMigrate(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005F78", "0X8005F78", 0, 0, this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.publicUin, (String)localObject1, this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.msgid, (String)localObject2, false);
          if (this.jdField_f_of_type_Boolean)
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder.setActionSheetTitle(BaseApplicationImpl.getApplication().getString(2131719275));
            break label308;
            label589:
            n = 8;
            break label348;
  ...
  public void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      ((IPublicAccountUtil)QRoute.api(IPublicAccountUtil.class)).reportPAShareItemEvent(1001, paramString3, this.jdField_f_of_type_Int);
      if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentBizWebviewpluginShare.p)) {
  ...
  public List<ShareActionSheetBuilder.ActionSheetItem>[] a()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (localObject1 != null) && (((SwiftBrowserStatistics)localObject1).m))
    {
    ...
    for (localObject1 = BaseApplicationImpl.getApplication().getRuntime();; localObject1 = null)
    {
      ...
      if ((localObject1 != null) && (!TextUtils.isEmpty(((AppRuntime)localObject1).getAccount())) && (this.h) && (!localIPublicAccountH5AbilityPlugin.contains(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:share:diandian")) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentBizWebviewpluginShare.p))) {
      ...
      {
        n = 1;
        if (((n != 0) || (this.g)) && (!localIPublicAccountH5AbilityPlugin.contains(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:share:sinaWeibo"))) {
        ...
        if ((!localIPublicAccountH5AbilityPlugin.contains(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:copyWatchWord")) && ((this.jdField_a_of_type_Long & 0x2) == 0L) && (QVipWatchWordProcessor.a(a())) && (a().contains("?")))
        {
          n = VasWatchWord.a.a(a()).intValue();
          if (n != -1)
          {
            ReportController.b(null, "dc00898", "", "", "qq_vip", "0X800AF77", n, 0, "", "", "", "");
        ...
        if (this.k)
        {
          ...
          if ((localObject3 != null) && (((ColorNoteController)localObject3).a()) && (((ColorNoteController)localObject3).e()) && (!ColorNoteUtils.c((String)localObject2)))
          {
            boolean bool = ((ColorNoteController)localObject3).c();
  ...
  public void b(int paramInt)
  {
    ...
    } while (this.jdField_a_of_type_ComTencentBizWebviewpluginShare == null);
    this.jdField_a_of_type_ComTencentBizWebviewpluginShare.a(paramInt, n);
  }
  ...
  public void d()
  {
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFontSizePanel = new FontSizePanel.Builder(this.jdField_a_of_type_AndroidAppActivity.getLayoutInflater()).a(this).a(this.jdField_b_of_type_Int).a().a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserComponentsProvider$SwiftBrowserComponentContext.a());
  }
