...
public class SwiftBrowserStatistics$2
  implements Runnable
{
  public SwiftBrowserStatistics$2(bbca parambbca, AppRuntime paramAppRuntime) {}
  
  public void run()
  {
    if (!awqr.a)
    {
      boolean bool = bahj.a(BaseApplicationImpl.getApplication());
