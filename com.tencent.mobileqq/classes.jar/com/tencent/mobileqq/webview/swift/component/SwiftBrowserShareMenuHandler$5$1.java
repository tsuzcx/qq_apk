...
public class SwiftBrowserShareMenuHandler$5$1
  implements Runnable
{
  public SwiftBrowserShareMenuHandler$5$1(bhpy parambhpy) {}
  
  public void run()
  {
    int i = this.a.a.jdField_a_of_type_Abcr.a().a;
    String str1 = this.a.a.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mApp.getCurrentAccountUin();
    String str2 = this.a.a.jdField_a_of_type_Abcr.a().i;
    String str3 = this.a.a.jdField_a_of_type_Abcr.a().h;
    if (this.a.a.jdField_a_of_type_Abcr.a().b == 3) {}
    for (boolean bool = true;; bool = false)
    {
      bool = bdiq.a(str1, str2, str3, bool, false, 2, null, null, null);
