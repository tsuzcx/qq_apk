...
public class SwiftBrowserShareMenuHandler$5$1
  implements Runnable
{
  public SwiftBrowserShareMenuHandler$5$1(beel parambeel) {}
  
  public void run()
  {
    int i = this.a.a.jdField_a_of_type_Zbj.a().a;
    String str1 = this.a.a.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.a.getCurrentAccountUin();
    String str2 = this.a.a.jdField_a_of_type_Zbj.a().i;
    String str3 = this.a.a.jdField_a_of_type_Zbj.a().h;
    if (this.a.a.jdField_a_of_type_Zbj.a().b == 3) {}
    for (boolean bool = true;; bool = false)
    {
      bool = badd.a(str1, str2, str3, bool, false, 2, null, null, null);
