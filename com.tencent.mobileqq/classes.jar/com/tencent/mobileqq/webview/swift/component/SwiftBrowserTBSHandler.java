  ...
  implements Handler.Callback
{
  ...
  public static void a(WebView paramWebView, String paramString1, String paramString2)
  {
    ...
    {
      ThreadManager.getUIHandler().post(new akxv(paramString2, paramString1, paramWebView, i, j, (String)localObject));
      return;
    }
  }
  ...
  private void c()
  {
    if (SwiftWebViewUtils.a())
    {
      ...
      if ((!TextUtils.isEmpty(str)) && (SwiftWebViewUtils.a(str)) && (!str.contains("asyncMode=3")) && (!str.contains("sonic=1"))) {
        ThreadManager.post(new akyd(this, str), 5, null, true);
      }
    }
  }
  ...
  public Object a(String paramString, Bundle paramBundle)
  {
    ...
    ThreadManager.post(new akxx(this, paramBundle, str), 8, null, true);
    return paramBundle;
          ...
          if ((!TextUtils.isEmpty(paramString)) && (paramString.startsWith("http")))
          {
            ...
            if (!TextUtils.isEmpty(str))
            {
              ...
              if (!this.jdField_a_of_type_JavaUtilHashSet.contains(str))
              {
                ...
                ThreadManager.getUIHandler().postDelayed(new akxy(this, paramString), 5000L);
              }
            }
          }
        }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramBoolean)
        {
          paramString = BaseApplicationImpl.getApplication().getResources().getString(2131435492);
      ...
      paramString = BaseApplicationImpl.getApplication().getResources().getString(2131435488);
    }
    this.jdField_a_of_type_JavaLangBoolean = Boolean.valueOf(false);
    this.jdField_a_of_type_JavaLangString = paramString;
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.isFinishing())
    {
      ...
      ThreadManager.post(new akxz(this), 8, null, true);
      paramString = new akya(this);
      localObject = new akyb(this);
    ...
    label335:
    for (paramString = BaseApplicationImpl.getApplication().getResources().getString(2131435492);; paramString = BaseApplicationImpl.getApplication().getResources().getString(2131435488))
    {
      QQToast.a(BaseApplicationImpl.getApplication(), 2, paramString, 0).b(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.b());
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserUIStyleHandler.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
      return;
    ...
    if (paramBoolean)
    {
      Drawable localDrawable = BaseApplicationImpl.getApplication().getResources().getDrawable(2130841694);
      this.jdField_a_of_type_AndroidAppDialog = DialogUtil.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity, localDrawable, BaseApplicationImpl.getApplication().getResources().getString(2131435493), " ", BaseApplicationImpl.getApplication().getResources().getString(2131433713), BaseApplicationImpl.getApplication().getResources().getString(2131435485), paramString, (View.OnClickListener)localObject);
    ...
    for (paramString = paramString.getString("icon_url", null);; paramString = null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserUIStyleHandler.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
      return;
      this.jdField_a_of_type_AndroidAppDialog = DialogUtil.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity, BaseApplicationImpl.getApplication().getResources().getString(2131435487), 2131433713, 2131435485, paramString, (View.OnClickListener)localObject);
      this.jdField_a_of_type_AndroidAppDialog.show();
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserUIStyleHandler.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
      return;
    }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserUIStyleHandler.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
        return true;
        ThreadManager.post(new akxw(this), 8, null, true);
        return true;
      ...
      Object localObject1 = (ImageView)this.jdField_a_of_type_AndroidAppDialog.findViewById(2131364119);
      ((ImageView)localObject1).setImageDrawable(null);
      ((ImageView)localObject1).setImageDrawable(paramMessage);
      return true;
      paramMessage = (String)paramMessage.obj;
    } while ((this.jdField_a_of_type_AndroidAppDialog == null) || (!this.jdField_a_of_type_AndroidAppDialog.isShowing()) || (paramMessage == null));
    ((TextView)this.jdField_a_of_type_AndroidAppDialog.findViewById(2131364122)).setText(paramMessage);
    return true;
  }
}
