  ...
  implements Handler.Callback
{
  ...
  WebViewFragment jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment;
      ...
      if (paramString.isHierarchical())
      {
        ...
        if ((!TextUtils.isEmpty(paramString)) && (AuthorizeConfig.a().j(paramString)))
        {
          ...
          if (!paramString.contains("cmshow")) {
            i = m - (int)UITools.a(BaseApplicationImpl.getApplication(), 54.0F);
          }
        }
      }
    }
  ...
  private String a()
  {
    Object localObject;
    int i;
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.tabBarConfigData != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.tabBarConfigData.size() > 1))
    {
      if (this.jdField_a_of_type_JavaUtilMap == null)
      {
        localObject = (QQComicRedTouchManager)((AppInterface)MobileQQ.sMobileQQ.waitAppRuntime(null).getAppRuntime("modular_web")).getManager(QQManagerFactory.COMIC_RED_TOUCH_MANAGER);
    ...
    for (;;)
    {
      if ((i != 0) && (this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.tabBarConfigData.size() > 4) && (this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.currentTabIndex == 0))
      {
        localObject = (WebViewTabBarData)this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.tabBarConfigData.get(4);
        if (localObject != null)
        {
      ...
      {
        i = this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.currentTabIndex + 1;
        if (i < this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.tabBarConfigData.size()) {}
        while (i > 0)
        {
          localObject = (WebViewTabBarData)this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.tabBarConfigData.get(i);
          if (localObject != null)
          {
            return ((WebViewTabBarData)localObject).url;
            i = -1;
  ...
  public Object a(String paramString, Bundle paramBundle)
  {
    ...
    if (paramString != null)
    {
      ...
      localBundle.putString(DownloadConstants.b, paramBundle);
      localBundle.putString(DownloadConstants.j, paramString);
      localBundle.putInt(DownloadConstants.k, 2);
      localBundle.putString(DownloadConstants.l, str);
      localBundle.putBoolean(DownloadConstants.r, false);
      localBundle.putBoolean(DownloadConstants.x, false);
      localBundle.putString(DownloadConstants.m, "_" + paramBundle);
      DownloadApi.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity, localBundle, "biz_src_yyb", null, 0);
      return paramBundle;
    }
    ...
    if ("installDownloadTask".equals(paramString))
    {
      ...
      paramBundle.putBoolean(DownloadConstants.r, false);
      paramBundle.putBoolean(DownloadConstants.x, false);
      DownloadApi.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity, paramBundle, "biz_src_yyb", null, 0);
      return Boolean.valueOf(true);
    }
    if ("notifyQBiconShine".equals(paramString))
    {
      ...
      if (paramString != null)
      {
        paramString.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserUIStyleHandler$SwiftBrowserUIStyle.z = true;
    ...
    for (;;)
    {
      if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.browserApp != null) && (i != 0)) {
        if ("CN".equals(Locale.getDefault().getCountry())) {
          if (TbsDownloader.needDownload(BaseApplication.getContext(), false, false, new SwiftBrowserTBSHandler.TbsDownloadCallback(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment)))
          {
            if (QLog.isColorLevel()) {
      ...
      {
        if (((localObject1 == null) || (!((SwiftBrowserStatistics)localObject1).i)) && (!QLog.isColorLevel())) {
          break label451;
        }
        ...
        {
          if ((localObject1 == null) || (!((SwiftBrowserStatistics)localObject1).i)) {
            break;
          }
      ...
      for (;;)
      {
        ...
        catch (Throwable paramBundle)
        {
          try
          {
            ...
            QLog.d("SwiftBrowserTBSHandler", 1, "handle stgw time, requestTime: " + localObject4 + "s, responseTime: " + (String)localObject3 + "s, url: " + Util.b(localObject5, new String[0]));
            return;
          }
          catch (Throwable paramBundle)
          {
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
      ThreadManager.post(new SwiftBrowserTBSHandler.5(this), 8, null, true);
      paramString = new SwiftBrowserTBSHandler.6(this);
      localObject = new SwiftBrowserTBSHandler.7(this);
    ...
    for (paramString = BaseApplicationImpl.getApplication().getResources().getString(2131689480);; paramString = BaseApplicationImpl.getApplication().getResources().getString(2131689485))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
      return;
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
      break;
    }
    label351:
    if (paramBoolean)
    {
      Drawable localDrawable = BaseApplicationImpl.getApplication().getResources().getDrawable(2130844528);
    ...
    {
      localObject = new SwiftBrowserTBSHandler.8(this);
      if (paramString != null)
      {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
      return;
      this.jdField_a_of_type_AndroidAppDialog = DialogUtil.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity, BaseApplicationImpl.getApplication().getResources().getString(2131689484), 2131690779, 2131689478, paramString, (View.OnClickListener)localObject);
      this.jdField_a_of_type_AndroidAppDialog.show();
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
      return;
    }
  ...
  public void b()
  {
    ...
    for (this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity = ((QQBrowserActivity)localActivity);; this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity = null)
    {
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      Object localObject1 = (ImageView)this.jdField_a_of_type_AndroidAppDialog.findViewById(2131380911);
      ((ImageView)localObject1).setImageDrawable(null);
      ((ImageView)localObject1).setImageDrawable(paramMessage);
      return true;
      paramMessage = (String)paramMessage.obj;
    } while ((this.jdField_a_of_type_AndroidAppDialog == null) || (!this.jdField_a_of_type_AndroidAppDialog.isShowing()) || (paramMessage == null));
    ((TextView)this.jdField_a_of_type_AndroidAppDialog.findViewById(2131380913)).setText(paramMessage);
    return true;
  }
}
