...
public class SwiftBrowserLongClickHandler$7
  implements Runnable
{
  public SwiftBrowserLongClickHandler$7(bbbd parambbbd, String paramString, IX5WebViewExtension paramIX5WebViewExtension) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      try
      {
        localObject2 = bace.a(this.jdField_a_of_type_JavaLangString);
