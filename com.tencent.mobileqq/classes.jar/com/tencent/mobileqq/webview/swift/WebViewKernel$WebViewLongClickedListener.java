  ...
  implements View.OnLongClickListener
{
  ...
  {
    if (!WebViewKernel.d(this.a).b("web_view_long_click", true))
    {
    ...
    if (!WebViewKernel.d(this.a).b("image_long_click", false))
    {
      if (QLog.isDevelopLevel()) {
    ...
    SwiftBrowserComponentsProvider.SwiftBrowserComponent localSwiftBrowserComponent = (SwiftBrowserComponentsProvider.SwiftBrowserComponent)WebViewKernel.b(this.a).getComponentProvider().a(8);
