...
public class WebViewWrapper$WebViewClientImpl$2
  implements Runnable
{
  public WebViewWrapper$WebViewClientImpl$2(bcdz parambcdz, WebViewPluginEngine paramWebViewPluginEngine, String paramString) {}
  ...
  public void run()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("WebLog_WebViewWrapper", 2, new Object[] { "post intercept:", Boolean.valueOf(bool), " ", bcgq.a(this.jdField_a_of_type_JavaLangString) });
    }
  }
}
