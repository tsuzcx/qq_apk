...
public class WebViewWrapper$WebViewClientImpl$2
  implements Runnable
{
  public WebViewWrapper$WebViewClientImpl$2(bipi parambipi, WebViewPluginEngine paramWebViewPluginEngine, String paramString) {}
  ...
  public void run()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("WebLog_WebViewWrapper", 2, new Object[] { "post intercept:", Boolean.valueOf(bool), " ", birz.a(this.jdField_a_of_type_JavaLangString) });
    }
  }
}
