...
public class WebStateReporter
{
  ...
  public void a(AppInterface paramAppInterface, String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        ThreadManager.post(new akcv(this, paramString, l, paramInt), 5, null, false);
        return;
      }
    }
  }
  ...
  public void b(Context paramContext, long paramLong, String paramString, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      default: 
        String str1 = "Unknown";
        ThreadManager.post(new akcu(this, paramBoolean, paramString, paramContext, paramLong, str1), 5, null, false);
        return;
      }
    }
