...
final class ProfileCardUtil$5
  implements Runnable
{
  ProfileCardUtil$5(QQAppInterface paramQQAppInterface) {}
          ...
          try
          {
            ...
            if (bool)
            {
              ...
              if ((localObject != null) && (localObject.length > 0) && (i < localObject.length))
              {
                ...
                if ((str2.startsWith("qvip_profile_template.json")) && (!str2.endsWith("8.5.5")))
                {
                  FileUtils.e(str2);
                  if (QLog.isColorLevel()) {
 ...
 * Qualified Name:     com.tencent.mobileqq.util.ProfileCardUtil.5
