...
final class PackageInstallMonitorKt$checkAppInstalled$result$1
  extends Lambda
  implements Function2<Context, String, String>
{
  public static final 1 INSTANCE = new 1();
  
  PackageInstallMonitorKt$checkAppInstalled$result$1()
  {
    super(2);
  }
  ...
  public final String invoke(@NotNull Context paramContext, @Nullable String paramString)
  {
    ...
    return PackageUtil.b(paramContext, paramString);
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes12.jar
 * Qualified Name:     com.tencent.mobileqq.util.privacy.PackageInstallMonitorKt.checkAppInstalled.result.1
