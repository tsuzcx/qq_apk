...
class HbThemeConfigManager$1
  implements Runnable
{
  HbThemeConfigManager$1(HbThemeConfigManager paramHbThemeConfigManager, Context paramContext, JSONObject paramJSONObject, QQAppInterface paramQQAppInterface) {}
  
  public void run()
  {
    Object localObject = this.jdField_a_of_type_AndroidContentContext.getSharedPreferences("qb_tenpay_share_face", 0).edit();
    ((SharedPreferences.Editor)localObject).putString("hb_face", HbThemeConfigManager.a(this.this$0, this.jdField_a_of_type_OrgJsonJSONObject).toString());
    ((SharedPreferences.Editor)localObject).commit();
    localObject = HbThemeConfigManager.a(this.this$0).optString("hb_face_imgurl");
