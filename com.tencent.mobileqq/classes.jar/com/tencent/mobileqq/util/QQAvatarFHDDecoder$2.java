  ...
  implements Runnable
{
  public void run()
  {
    if (bbah.a(this.this$0)) {
      return;
    }
    Setting localSetting = bbah.a(this.this$0).c(this.jdField_a_of_type_JavaLangString);
    ...
    {
      bbah.a(this.this$0).c(this.jdField_a_of_type_JavaLangString);
      return;
    }
