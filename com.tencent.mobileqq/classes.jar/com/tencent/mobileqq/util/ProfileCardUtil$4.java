    ...
    if (this.a != null)
    {
      ...
      if ((!TextUtils.equals(str2, str1)) && (!TextUtils.isEmpty((CharSequence)localObject)))
      {
        ...
        for (;;)
        {
          try
          {
            str2 = azyk.b(this.a.getApplication());
            File localFile = new File(str2 + ".tmp");
            batm localbatm = new batm((String)localObject, localFile);
            localbatm.f = "profileCardDownload";
            localbatm.e = "VIP_profilecard";
            localbatm.a = 1;
            int j = bato.a(localbatm, this.a);
            if (j != 0) {
              break label595;
            }
            if (QLog.isColorLevel()) {
            ...
            if (bool)
            {
              ...
              if ((localObject != null) && (localObject.length > 0) && (i < localObject.length))
              {
                ...
                if ((str2.startsWith("qvip_profile_template.json")) && (!str2.endsWith("8.2.6")))
                {
                  bace.d(str2);
                  if (QLog.isColorLevel()) {
