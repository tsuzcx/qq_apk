  ...
  extends Drawable
{
  ...
  protected void onBoundsChange(Rect paramRect)
  {
    ...
    {
      this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = new BitmapDrawable(BaseApplicationImpl.getApplication().getResources(), SkinUtils.a(this.jdField_a_of_type_AndroidGraphicsDrawableDrawable));
