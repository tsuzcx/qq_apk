...
public class FPSCalculator
{
  ...
  private Runnable jdField_a_of_type_JavaLangRunnable = new ajlf(this);
  private Vector jdField_a_of_type_JavaUtilVector = new Vector();
  private boolean jdField_a_of_type_Boolean;
  private Runnable b = new ajlg(this);
  ...
  private void a()
  {
    ...
    if (Build.VERSION.SDK_INT > 16)
    {
      if (this.jdField_a_of_type_AndroidViewChoreographer$FrameCallback == null) {
        this.jdField_a_of_type_AndroidViewChoreographer$FrameCallback = new ajle(this);
      }
