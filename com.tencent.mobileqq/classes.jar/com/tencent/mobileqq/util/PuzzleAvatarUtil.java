...
public class PuzzleAvatarUtil
{
  ...
  public static Bitmap a(int paramInt, Bitmap.Config paramConfig, Bitmap[] paramArrayOfBitmap)
  {
    ...
    Object localObject = new PuzzleAvatarUtil.PuzzleParams[j];
    i = 0;
    while (i < j)
    {
      localObject[i] = new PuzzleAvatarUtil.PuzzleParams(null);
      i += 1;
    }
  ...
  public static Bitmap a(int paramInt, Bitmap[] paramArrayOfBitmap)
  {
    ...
    int i;
    PuzzleAvatarUtil.PuzzleParams[] arrayOfPuzzleParams;
    Paint localPaint;
    RectF localRectF;
    Rect localRect;
    Canvas localCanvas;
    ...
    do
    {
      ...
      do
      {
        ...
        arrayOfPuzzleParams = new PuzzleAvatarUtil.PuzzleParams[i];
        j = 0;
        while (j < i)
        {
          arrayOfPuzzleParams[j] = new PuzzleAvatarUtil.PuzzleParams(null);
          j += 1;
        }
        ...
        arrayOfPuzzleParams[0].c = (paramInt / 2 - 1);
        arrayOfPuzzleParams[0].d = paramInt;
        arrayOfPuzzleParams[0].e = 1;
        arrayOfPuzzleParams[1].a = (paramInt / 2 + 1);
        arrayOfPuzzleParams[1].b = 0;
        arrayOfPuzzleParams[1].c = paramInt;
        arrayOfPuzzleParams[1].d = paramInt;
        arrayOfPuzzleParams[1].e = 1;
        paramInt = 0;
    ...
    if (arrayOfPuzzleParams[paramInt].e == 1) {
      localRect.set(j / 4, 0, j / 4 * 3, k);
    }
    for (;;)
    {
      localRectF.set(arrayOfPuzzleParams[paramInt].a, arrayOfPuzzleParams[paramInt].b, arrayOfPuzzleParams[paramInt].c, arrayOfPuzzleParams[paramInt].d);
      ...
      if (i == 3)
      {
        ...
        arrayOfPuzzleParams[1].b = 0;
        arrayOfPuzzleParams[1].c = paramInt;
        arrayOfPuzzleParams[1].d = (paramInt / 2 - 1);
        arrayOfPuzzleParams[1].e = 2;
        arrayOfPuzzleParams[2].a = (paramInt / 2 + 1);
        arrayOfPuzzleParams[2].b = (paramInt / 2 + 1);
        arrayOfPuzzleParams[2].c = paramInt;
        arrayOfPuzzleParams[2].d = paramInt;
        arrayOfPuzzleParams[2].e = 2;
        break;
      }
      if (i < 4) {
        break;
      ...
      arrayOfPuzzleParams[0].b = 0;
      arrayOfPuzzleParams[0].c = (paramInt / 2 - 1);
      arrayOfPuzzleParams[0].d = (paramInt / 2 - 1);
      arrayOfPuzzleParams[0].e = 2;
      arrayOfPuzzleParams[1].a = (paramInt / 2 + 1);
      arrayOfPuzzleParams[1].b = 0;
      arrayOfPuzzleParams[1].c = paramInt;
      arrayOfPuzzleParams[1].d = (paramInt / 2 - 1);
      ...
      arrayOfPuzzleParams[3].b = (paramInt / 2 + 1);
      arrayOfPuzzleParams[3].c = (paramInt / 2 - 1);
      arrayOfPuzzleParams[3].d = paramInt;
      arrayOfPuzzleParams[3].e = 2;
      break;
