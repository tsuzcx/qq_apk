...
public class TroopInteractGiftAnimationController
{
  ...
  public void a()
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.runOnUiThread(new akdz(this));
  ...
  public void a(TroopChatPie paramTroopChatPie)
  {
    ...
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie.c.findViewById(2131363511));
  }
  ...
  public void a(MessageForDeliverGiftTips paramMessageForDeliverGiftTips, long paramLong)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.postDelayed(new akdx(this, paramMessageForDeliverGiftTips), l);
  }
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie != null) {
      ((TroopGiftManager)this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(112)).a(paramString1, paramString2, paramInt1, paramInt2, new akdw(this, paramInt2, paramString2, paramMessageForDeliverGiftTips, paramBoolean));
    }
  ...
  public void a(MessageForDeliverGiftTips paramMessageForDeliverGiftTips, String paramString, boolean paramBoolean, FrameSprite.OnFrameEndListener paramOnFrameEndListener)
  {
    ...
    ThreadManager.post(new akdi(this, paramString, paramMessageForDeliverGiftTips, paramBoolean, paramOnFrameEndListener, (TroopGiftManager)this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(112)), 8, null, true);
  }
