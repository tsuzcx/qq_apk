  ...
  extends View
{
  ...
  {
    int m = paramContext.getResources().getColor(2131167156);
    int k = paramContext.getResources().getDimensionPixelOffset(2131299144);
    int j = k;
    int i = m;
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new bepq(this));
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new bepr(this));
  }
  ...
  private void d()
  {
    ...
    this.jdField_b_of_type_AndroidAnimationValueAnimator.addUpdateListener(new beps(this));
    this.jdField_b_of_type_AndroidAnimationValueAnimator.addListener(new bept(this));
  }
  ...
  private void e()
  {
    ...
    this.jdField_c_of_type_AndroidAnimationValueAnimator.addUpdateListener(new bepu(this));
    this.jdField_c_of_type_AndroidAnimationValueAnimator.addListener(new bepv(this));
  }
  ...
  private void f()
  {
    ...
    this.jdField_d_of_type_AndroidAnimationValueAnimator.setDuration(500L);
    this.jdField_d_of_type_AndroidAnimationValueAnimator.addUpdateListener(new bepw(this));
    this.jdField_d_of_type_AndroidAnimationValueAnimator.addListener(new bepx(this));
  }
  ...
  public void setOnAnimationStateListener(bepy parambepy)
  {
 ...
 * Qualified Name:     com.tencent.mobileqq.together.writetogether.view.SavingAnimView
