...
public class WriteTogetherEditorView
  extends EditText
  implements View.OnClickListener, View.OnFocusChangeListener, bepp
{
  ...
  private List<beog> jdField_a_of_type_JavaUtilList;
      ...
      if (i < localClipData.getItemCount())
      {
        if ((paramBoolean) && (Build.VERSION.SDK_INT > 15))
        {
          ...
          if (localObject1 != null)
          {
            ...
            localObject1 = bemv.a((CharSequence)localObject1);
  ...
  private void a(Canvas paramCanvas, Point paramPoint, float paramFloat, String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidTextTextPaint.setColor(getResources().getColor(2131167302));
    paramInt = getResources().getDimensionPixelSize(2131299136);
    paramString = a(paramString, paramBoolean, this.jdField_a_of_type_AndroidTextTextPaint, paramInt);
    float f3 = getResources().getDimensionPixelSize(2131299120);
    ...
    int i2 = (int)f1;
    int i3 = getResources().getDimensionPixelSize(2131299135);
    int i;
    RectF localRectF;
    float f2;
    if (paramBoolean)
    ...
    {
      f3 = getResources().getDimensionPixelSize(2131299137);
  ...
  private void a(Canvas paramCanvas, List<beog> paramList)
  {
    Iterator localIterator = paramList.iterator();
    while (localIterator.hasNext())
    {
      beog localbeog = (beog)localIterator.next();
      if ((localbeog != null) && (localbeog.jdField_c_of_type_Int >= 0))
      {
        Point localPoint = a(localbeog.jdField_c_of_type_Int);
        if (localPoint != null)
        {
          if (a(localbeog.jdField_c_of_type_Int) == 0) {
            localPoint.y = this.jdField_c_of_type_Int;
          }
          paramList = (Float)this.jdField_a_of_type_JavaUtilMap.get(localbeog.jdField_a_of_type_JavaLangString);
          if ((paramList != null) && (paramList.floatValue() < 0.5F)) {
            a(paramCanvas, localPoint, this.jdField_a_of_type_Float, localbeog.jdField_b_of_type_Int);
          }
          if (localbeog.jdField_a_of_type_Boolean)
          {
            String str = localbeog.jdField_b_of_type_JavaLangString;
            paramList = str;
            if (str == null) {
              paramList = "";
            }
            a(paramCanvas, localPoint, this.jdField_a_of_type_Float, paramList, localbeog.jdField_b_of_type_Int, localbeog.jdField_b_of_type_Boolean);
          }
        }
      }
    }
  ...
  private void f()
  {
    ...
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new beql(this));
  ...
  private void h()
  {
    beqm localbeqm = new beqm(this);
    setCustomSelectionActionModeCallback(localbeqm);
    if (Build.VERSION.SDK_INT >= 23) {
      setCustomInsertionActionModeCallback(localbeqm);
    }
  }
  ...
  public void a(beoc parambeoc)
  {
    addTextChangedListener(parambeoc);
  }
  ...
  public void b()
  {
    this.jdField_a_of_type_Float = getResources().getDimensionPixelSize(2131299134);
    this.jdField_b_of_type_Float = getResources().getDimensionPixelSize(2131299138);
    this.jdField_c_of_type_Float = getLineHeight();
    this.jdField_d_of_type_Float = getResources().getDimensionPixelSize(2131299120);
    this.jdField_c_of_type_Int = getResources().getDimensionPixelSize(2131299126);
    super.setOnClickListener(this);
  }
  
  public void b(beoc parambeoc)
  {
    removeTextChangedListener(parambeoc);
  }
  ...
  public void onClick(View paramView)
  {
    ...
    if (this.jdField_a_of_type_Beqn != null)
    {
      this.jdField_a_of_type_Beqn.d();
      setCursorVisible(true);
    }
  ...
  {
    return new beqo(this, super.onCreateInputConnection(paramEditorInfo), false);
  }
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    if (this.jdField_a_of_type_Beng != null)
    {
      this.jdField_a_of_type_JavaUtilList = this.jdField_a_of_type_Beng.a();
  ...
  protected void onSelectionChanged(int paramInt1, int paramInt2)
  {
    ...
    } while (this.jdField_a_of_type_Beng == null);
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      this.jdField_a_of_type_Beng.a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, paramInt1, paramInt2, bool1);
  ...
  public boolean onTextContextMenuItem(int paramInt)
  {
    ...
    default: 
      i = 0;
      if (i != 0) {
        bdll.b(null, "dc00898", "", "", "0X800AF34", "0X800AF34", i, 0, "", "", "", "");
      }
      i = a().length();
      if (isFocused())
      {
  ...
  public void setClient(beng parambeng)
  {
  ...
  public void setOnEditorClickEventListener(beqn parambeqn)
  {
 ...
 * Qualified Name:     com.tencent.mobileqq.together.writetogether.view.WriteTogetherEditorView
