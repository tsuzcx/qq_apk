...
public class HeadsPanelAnimationView
{
  ...
  public HeadsPanelAnimationView()
  {
    ...
    this.jdField_a_of_type_Int = AIOUtils.a(4.0F, ((Context)localObject).getResources());
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate((Context)localObject, 2131561671, null));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131368282));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131368283));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131368284));
    int i = 0;
  ...
  void b()
  {
    ...
    int i = AIOUtils.a(1.0F, ((Context)localObject2).getResources());
    this.d.setPadding(i, i, i, i);
    this.d.setBackgroundResource(2130845264);
    ...
    ((RelativeLayout.LayoutParams)localObject2).addRule(7, 2131368282);
    ((RelativeLayout.LayoutParams)localObject2).addRule(6, 2131368282);
  ...
  void e()
  {
    int j = this.jdField_a_of_type_AndroidWidgetImageView.getWidth() - AIOUtils.a(5.0F, BaseApplicationImpl.getContext().getResources());
    ...
    localObject2 = new HeadsPanelAnimationView.2(this, localAnimatorSet);
