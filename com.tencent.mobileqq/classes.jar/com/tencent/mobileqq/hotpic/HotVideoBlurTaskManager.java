...
public class HotVideoBlurTaskManager
{
  ...
  public static HotVideoBlurTaskManager a(Context paramContext)
  {
    ...
    //   2: monitorenter
    //   3: iconst_0
    //   4: invokestatic 39	com/tencent/mobileqq/hotpic/HotVideoBlurTaskManager:a	(Z)V
    //   7: aload_0
    //   8: ifnonnull +10 -> 18
    //   11: aconst_null
    //   12: astore_0
    ...
    //   21: dup
    //   22: aload_0
    //   23: invokespecial 41	com/tencent/mobileqq/hotpic/HotVideoBlurTaskManager:<init>	(Landroid/content/Context;)V
    //   26: astore_1
    //   27: aload_1
    //   28: astore_0
    //   29: getstatic 23	com/tencent/mobileqq/hotpic/HotVideoBlurTaskManager:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   32: invokevirtual 45	java/util/ArrayList:size	()I
    //   35: iconst_3
    //   36: if_icmpge -23 -> 13
    //   39: getstatic 23	com/tencent/mobileqq/hotpic/HotVideoBlurTaskManager:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   42: new 47	java/lang/ref/WeakReference
    //   45: dup
    //   46: aload_1
    //   47: invokespecial 50	java/lang/ref/WeakReference:<init>	(Ljava/lang/Object;)V
    //   50: invokevirtual 54	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   53: pop
    //   54: aload_1
    //   55: astore_0
    //   56: goto -43 -> 13
  ...
  public static void b(HotVideoBlurTaskManager paramHotVideoBlurTaskManager)
  {
    ...
    //   13: monitorexit
    //   14: return
    //   15: getstatic 23	com/tencent/mobileqq/hotpic/HotVideoBlurTaskManager:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   18: invokevirtual 59	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   21: astore_1
    //   22: aload_1
    ...
    //   42: ifnull -20 -> 22
    //   45: aload_2
    //   46: invokevirtual 72	java/lang/ref/WeakReference:get	()Ljava/lang/Object;
    ...
    //   57: aload_0
    //   58: aload_3
    //   59: invokevirtual 75	java/lang/Object:equals	(Ljava/lang/Object;)Z
    //   62: ifeq -40 -> 22
    //   65: getstatic 23	com/tencent/mobileqq/hotpic/HotVideoBlurTaskManager:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   68: aload_2
