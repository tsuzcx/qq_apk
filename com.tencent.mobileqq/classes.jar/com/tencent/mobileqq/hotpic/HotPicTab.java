  ...
  extends HorizontalListView
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new avcj(this);
  avck jdField_a_of_type_Avck;
  ...
  static
  {
    ...
    h = localResources.getColor(2131166994);
    i = localResources.getColor(2131166986);
  }
  ...
  {
    if (this.jdField_a_of_type_Avck != null)
    {
      Object localObject = this.jdField_a_of_type_Avck.a;
  ...
  public void a(List<HotPicTagInfo> paramList, int paramInt)
  {
    ...
    for (int j = 2131165359;; j = 2131167294)
    {
    ...
    this.jdField_a_of_type_Avck = new avck(this, paramList, this.jdField_a_of_type_JavaUtilArrayList, bool1);
    this.jdField_a_of_type_Int = paramInt;
    setAdapter(this.jdField_a_of_type_Avck);
  }
  ...
  public void dispatchDraw(Canvas paramCanvas)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Float > 0.0F)
      {
        ...
        {
          localObject = ((avcm)localView.getTag()).a;
      ...
      for (;;)
      {
        ...
        localObject = (avcm)localView.getTag();
        k = (int)(localView.getLeft() + ((avcm)localObject).a.getLeft() - jdField_b_of_type_Float * 5.0F);
        j = localView.getLeft();
        j = (int)(((avcm)localObject).a.getRight() + j + jdField_b_of_type_Float * 5.0F);
        break;
        n = 0;
        break label121;
      }
