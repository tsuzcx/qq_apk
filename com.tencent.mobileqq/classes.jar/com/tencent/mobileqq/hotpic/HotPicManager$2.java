...
public class HotPicManager$2
  implements Runnable
{
  public HotPicManager$2(avtm paramavtm, int paramInt1, int paramInt2) {}
  ...
  public void run()
  {
    ...
    case 10001: 
      ...
      for (i = 10003;; i = 10002)
      {
        ((avtm)localObject).a(0, 15, j, k, true, i);
    ...
    case 10002: 
      localArrayList = (ArrayList)avtm.a(this.this$0).get(this.b);
      localObject = localArrayList;
      if (localArrayList == null)
      {
        localObject = new ArrayList();
        avtm.a(this.this$0).put(this.b, localObject);
      }
      i = ((ArrayList)localObject).size();
      this.this$0.a(i, 16 + i - 1, this.this$0.b(), this.b, false, this.a);
      return;
    }
    ArrayList localArrayList = (ArrayList)avtm.a(this.this$0).get(this.b);
