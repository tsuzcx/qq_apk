  ...
  implements Handler.Callback
{
  ...
  {
    QQToast.a(paramContext, 0, HardCodeUtil.a(2131704698), 2000).a();
    int j;
    if (this.b != null)
    {
  ...
  private void a(BaseChatPie paramBaseChatPie)
  {
    ...
    do
    {
      ...
      localSendMsgParams.i = paramBaseChatPie.E;
      paramBaseChatPie.E = false;
      this.jdField_a_of_type_ArrayOfLong = ChatActivityFacade.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramBaseChatPie.a(), paramBaseChatPie.a(), str, new ArrayList(), localSendMsgParams);
    ...
    for (int i = this.b.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble.fontId;; i = this.b.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble.bubbleId)
    {
      VasWebviewUtil.reportCommercialDrainage(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin(), "aio_iconA", "Send", "", 1, 0, 0, "", Integer.toString(i), FontBubblePanelView.a(j), "0", "", "", "", 0, 0, 0, 0);
      this.b = null;
      return;
    }
  }
  ...
  private void a(BaseChatPie paramBaseChatPie, long paramLong, int paramInt)
  {
    ...
    if (TextUtils.isEmpty((CharSequence)localObject2)) {
      localObject1 = HardCodeUtil.a(2131704699);
    }
    ...
    DialogUtil.a(paramBaseChatPie.a(), 230, (String)localObject1, (CharSequence)localObject2, HardCodeUtil.a(2131704700), (String)localObject3, new FontBubbleManager.3(this, paramBaseChatPie, str), new FontBubbleManager.4(this)).show();
  }
  ...
  public void a(long paramLong)
  {
    ...
    for (;;)
    {
      if (i < j)
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqHiboomSetFontBubble != null) {
          this.jdField_a_of_type_ComTencentMobileqqHiboomSetFontBubble.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        }
      }
      return;
      label59:
  ...
  public void a(BaseChatPie paramBaseChatPie, Bundle paramBundle)
  {
    ...
    if (this.b != null)
    {
      ...
      VasWebviewUtil.reportCommercialDrainage(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin(), "aio_iconA", "OpenSvip", "", 1, 0, 0, "", "", FontBubblePanelView.a(i));
  ...
  public void a(BaseChatPie paramBaseChatPie, boolean paramBoolean, SetFontBubbleRsp paramSetFontBubbleRsp, int paramInt)
  {
    if ((paramBoolean) && (paramSetFontBubbleRsp.stRet != null) && (paramSetFontBubbleRsp.stRet.ret == 0))
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqHiboomSetFontBubble != null) && (this.jdField_a_of_type_ComTencentMobileqqHiboomSetFontBubble.jdField_a_of_type_Int == paramInt))
      {
        if ((paramSetFontBubbleRsp.stFontRsp.authRet != 0) || (paramSetFontBubbleRsp.stBubbleRsp.authRet != 0)) {
          QLog.e("FontBubbleManager", 1, "onSetFontBubble failed," + " fontAuth:" + paramSetFontBubbleRsp.stFontRsp.authRet + " bubbleAuth:" + paramSetFontBubbleRsp.stBubbleRsp.authRet + this.jdField_a_of_type_ComTencentMobileqqHiboomSetFontBubble.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble);
        }
        for (;;)
        {
          this.jdField_a_of_type_ComTencentMobileqqHiboomSetFontBubble = null;
          return;
          if (QLog.isColorLevel()) {
            QLog.d("FontBubbleManager", 2, "onSetFontBubble mRestore success: " + this.jdField_a_of_type_ComTencentMobileqqHiboomSetFontBubble.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble);
          }
        }
      }
    ...
    StringBuilder localStringBuilder = AIOUtils.a().append("onSetFontBubble failed,");
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqHiboomSetFontBubble != null) && (this.jdField_a_of_type_ComTencentMobileqqHiboomSetFontBubble.jdField_a_of_type_Int == paramInt)) {
      QLog.e("FontBubbleManager", 1, "restore failed: " + this.jdField_a_of_type_ComTencentMobileqqHiboomSetFontBubble.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble);
    }
    a(paramBaseChatPie.a());
  }
