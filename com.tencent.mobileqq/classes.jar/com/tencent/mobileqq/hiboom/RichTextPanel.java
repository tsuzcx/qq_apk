...
public class RichTextPanel
  ...
  implements ahqz, ViewPager.OnPageChangeListener, View.OnClickListener, arsg, asoe
{
  private int jdField_a_of_type_Int = -1;
  private PagerAdapter jdField_a_of_type_AndroidSupportV4ViewPagerAdapter = new asoo(this);
  ...
  private void c(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_AndroidWidgetButton.setBackgroundDrawable(getResources().getDrawable(2130838270));
        this.jdField_a_of_type_AndroidWidgetButton.setTextColor(getResources().getColor(2131167057));
      }
  ...
  private void d()
  {
    ...
    do
    {
      ...
      Object localObject2 = arsh.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        if (i == 1)
        {
          if (((FlashChatManager)localObject1).a().size() > 0)
          {
            ...
            localArrayList2.add(Integer.valueOf(2131375720));
          }
        }
        else if (i == 2)
        {
          if (asnx.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a())
          {
            this.jdField_c_of_type_JavaUtilArrayList.add(this.jdField_a_of_type_JavaUtilArrayList.get(i));
            this.jdField_b_of_type_JavaUtilArrayList.add(Integer.valueOf(2));
            localArrayList1.add(((RichTextPanelView)this.jdField_a_of_type_JavaUtilArrayList.get(i)).a());
            localArrayList2.add(Integer.valueOf(2131375723));
          }
        }
        else if ((i == 0) && (agwq.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a()).c()))
        {
          this.jdField_c_of_type_JavaUtilArrayList.add(this.jdField_a_of_type_JavaUtilArrayList.get(i));
          this.jdField_b_of_type_JavaUtilArrayList.add(Integer.valueOf(0));
          localArrayList1.add(((RichTextPanelView)this.jdField_a_of_type_JavaUtilArrayList.get(i)).a());
          localArrayList2.add(Integer.valueOf(2131375727));
        }
        else if ((i == 3) || (i == 4))
        {
          this.jdField_c_of_type_JavaUtilArrayList.add(this.jdField_a_of_type_JavaUtilArrayList.get(i));
      ...
      i = arsh.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_b_of_type_JavaUtilArrayList);
  ...
  public int a(int paramInt, boolean paramBoolean)
  {
    ...
    if ((paramInt >= 0) && (paramInt < this.jdField_c_of_type_JavaUtilArrayList.size()))
    {
      ...
      if (localRichTextPanelView != null)
      {
        ...
        if (!TextUtils.isEmpty(str)) {
          azmj.b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", str, str, 0, 0, "", "", "", "");
        }
      }
    ...
    for (;;)
    {
      ...
      if ((this.jdField_b_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_Int >= 0) && (this.jdField_a_of_type_Int < this.jdField_b_of_type_JavaUtilArrayList.size()))
      {
        ...
        bdiv.aa(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramInt);
      }
      return 0;
      label511:
  ...
  public void a(BaseChatPie paramBaseChatPie)
  {
    ...
    Drawable localDrawable = getResources().getDrawable(2130849607);
    ...
    {
      setBackgroundDrawable((Drawable)localObject);
      this.jdField_d_of_type_Int = aekt.a(250.0F, getResources());
      ...
      ((RelativeLayout)localObject).setId(2131375726);
      RelativeLayout.LayoutParams localLayoutParams1 = new RelativeLayout.LayoutParams(-1, bcwh.a(getContext(), 40.0F));
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator.setId(2131375725);
      c(true);
      this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator.setOnTabListener(this);
      RelativeLayout.LayoutParams localLayoutParams2 = new RelativeLayout.LayoutParams(-1, bcwh.a(getContext(), 40.0F));
      localLayoutParams2.addRule(0, 2131376331);
      ...
      this.jdField_a_of_type_AndroidWidgetButton.setId(2131376331);
      this.jdField_a_of_type_AndroidWidgetButton.setBackgroundDrawable(getResources().getDrawable(2130838270));
      this.jdField_a_of_type_AndroidWidgetButton.setText(getResources().getString(2131721498));
      this.jdField_a_of_type_AndroidWidgetButton.setTextColor(getResources().getColor(2131167057));
      this.jdField_a_of_type_AndroidWidgetButton.setContentDescription(getResources().getString(2131721498));
      this.jdField_a_of_type_AndroidWidgetButton.setTextSize(2, 14.0F);
      this.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
      localLayoutParams2 = new RelativeLayout.LayoutParams(bcwh.a(getContext(), 60.0F), bcwh.a(getContext(), 40.0F));
      ...
      this.jdField_a_of_type_ComTencentMobileqqWidgetQQViewPager.setId(2131375724);
      ...
      ((RelativeLayout.LayoutParams)localObject).addRule(2, 2131375726);
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setId(2131366681);
      ...
      this.jdField_a_of_type_JavaUtilArrayList.add(new FontBubblePanelView(getContext(), paramBaseChatPie, new asno()));
      this.jdField_a_of_type_JavaUtilArrayList.add(new FontBubblePanelView(getContext(), paramBaseChatPie, new asnc()));
      return;
  ...
  public void b(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ((bdpx)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(71)).f(asnx.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx.getText().toString()));
      asnx.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(this);
      str = null;
  ...
  public void onClick(View paramView)
  {
    ...
    {
      return;
      paramView = bdox.a(getContext(), "font", "mvip.gexinghua.mobile.font.client_tab_store") + "&haibao=1";
      if (QLog.isColorLevel()) {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      return;
      paramView = agwq.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
