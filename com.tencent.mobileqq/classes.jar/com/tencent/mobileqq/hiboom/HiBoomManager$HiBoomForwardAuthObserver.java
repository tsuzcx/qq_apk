  ...
  extends SVIPObserver
{
  ...
  public HiBoomManager$HiBoomForwardAuthObserver(Context paramContext)
  {
  ...
  public void onAuthHiBoom(boolean paramBoolean, Object paramObject)
  {
    ...
    Object localObject = HiBoomManager.a(localContext);
    ...
    if ((paramBoolean) && ((paramObject instanceof Object[])))
    {
      ...
      if (arrayOfObject.length >= 5)
      {
        ...
        for (paramObject = (String)arrayOfObject[3];; paramObject = null)
        {
          ...
          HiBoomManager.a(localContext, (byte[])localObject, j);
          HiBoomManager.b.set(false);
          return;
          i = -1;
          break;
          localObject = null;
    ...
    {
    default: 
      QQToast.a(localContext, 1, HardCodeUtil.a(2131705497), 0).a();
      HiBoomManager.b.set(false);
      return;
    case 1: 
      label234:
      ...
      ((Bundle)localObject).putInt("key_hiboom_type", HiBoomManager.a(j));
      paramObject = new Intent();
      paramObject.putExtras((Bundle)localObject);
      ForwardBaseOption.a((Activity)localContext, paramObject, 21);
      return;
    }
    if ((localContext instanceof FragmentActivity))
    {
      ...
      if ((((FragmentActivity)localObject).getChatFragment() != null) && (((FragmentActivity)localObject).getChatFragment().a() != null))
      {
        ...
        ((HiBoomManager)((BaseChatPie)localObject).jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.HIBOOM_MANAGER)).a((BaseChatPie)localObject, paramObject, j, HiBoomManager.a(j));
        ((BaseChatPie)localObject).ax();
  ...
  public void onSetHiBoom(boolean paramBoolean, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (paramBoolean)
      {
        ...
        if (localObject.length >= 5)
        {
          ...
          for (localObject = (String)localObject[4];; localObject = null)
          {
            ...
            HiBoomManager.a(localContext, paramObject, j);
            HiBoomManager.b.set(false);
            return;
            i = -1;
            break label102;
          ...
          if (paramBoolean)
          {
            if ((localContext instanceof FragmentActivity))
            {
              ...
              if ((paramObject.getChatFragment() != null) && (paramObject.getChatFragment().a() != null))
              {
                ...
                ((HiBoomManager)paramObject.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.HIBOOM_MANAGER)).a(paramObject, (String)localObject, j, HiBoomManager.a(j));
                paramObject.ax();
          ...
          ((SVIPHandler)((QQAppInterface)paramObject).getBusinessHandler(BusinessHandlerFactory.SVIP_HANDLER)).b();
          return;
        }
        paramBoolean = false;
      }
      while (paramBoolean)
      {
        QQToast.a(localContext, 1, HardCodeUtil.a(2131705494), 0).a();
        HiBoomManager.b.set(false);
        return;
