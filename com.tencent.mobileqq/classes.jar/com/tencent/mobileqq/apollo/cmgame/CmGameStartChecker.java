...
public class CmGameStartChecker
  implements akzl, BusinessObserver
{
  private volatile int jdField_a_of_type_Int;
  public long a;
  private akzc jdField_a_of_type_Akzc;
  ...
  private WeakReference<aksk> jdField_a_of_type_JavaLangRefWeakReference;
  public long b;
  ...
  private void a(long paramLong)
  {
    ...
    {
      aksk localaksk = (aksk)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localaksk != null)
      {
        ...
        localaksk.onGameCheckFinish(paramLong, this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam, null);
      }
    }
  }
  ...
  private void b(long paramLong)
  {
    if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
    {
      ...
      if (localaksk != null)
      {
        ...
        localaksk.onGameFailed(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam, paramLong);
      }
    }
  }
  ...
  private void d()
  {
    ...
    if (akwd.b(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam))
    {
      b();
      return;
    }
  ...
  {
    if ((this.jdField_b_of_type_JavaLangRefWeakReference.get() == null) || ((!bdin.d(((AppInterface)this.jdField_b_of_type_JavaLangRefWeakReference.get()).getApp())) && (!akwd.b(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam))))
    {
  ...
  public void a(int paramInt1, int paramInt2, String paramString)
  {
    ...
    do
    {
      ...
      paramString = (aksk)this.jdField_a_of_type_JavaLangRefWeakReference.get();
  ...
  public void a(aksj paramaksj, long paramLong)
  {
    ...
    do
    {
      ...
      localaksk = (aksk)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (localaksk == null);
    ...
    localaksk.onDownloadConfirm(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam, paramaksj, paramLong);
  }
  ...
  protected void a(Bundle paramBundle)
  {
    ...
    try
    {
      ...
      localObject1 = (aksk)this.jdField_a_of_type_JavaLangRefWeakReference.get();
          ...
          if (((STCheckGame.STCheckGameRsp)localObject3).commFlagBits.has())
          {
            ...
            if (((STCheckGame.STCheckGameRsp)localObject3).ssoCmdRule.has())
            {
              ...
              if (localObject1 != null)
              {
                ...
                ((aksk)localObject1).onSsoCmdRuleRsp(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam, (String)localObject2);
              }
            }
            for (;;)
            {
              ...
              if (((STCheckGame.STCheckGameRsp)localObject3).gameConfInfo.has())
              {
                ...
                if (localObject1 != null)
                {
                  ...
                  ((aksk)localObject1).onGetGameData(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam);
                }
              }
            ...
            aknx.b = str4;
            aknx.jdField_c_of_type_JavaLangString = str5;
            ...
            if (bool1) {
              akwd.a(ApolloUtil.a(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId));
            }
    ...
    for (Object localObject2 = "1";; localObject2 = "0")
    {
      ...
      azri.a(((AppInterface)localObject3).getApp()).a(((AppInterface)localObject3).getCurrentAccountUin(), "cmgame_checkgame_update", true, 0L, 0L, (HashMap)localObject4, "", false);
      ...
      if (localObject1 != null) {
        ((aksk)localObject1).onGameCheckFinish(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.retCode, this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam, null);
      }
      if (aljn.a(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.isWhiteUsr, this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId))
      {
        localObject1 = new akzf();
        ((akzf)localObject1).jdField_a_of_type_JavaLangString = String.valueOf(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
        ((akzf)localObject1).jdField_a_of_type_Long = l2;
        ((akzf)localObject1).jdField_b_of_type_Long = l1;
        ((akzf)localObject1).jdField_a_of_type_ArrayOfByte = paramBundle;
        ((akzf)localObject1).jdField_b_of_type_Boolean = bool2;
        ((akzf)localObject1).jdField_a_of_type_Boolean = bool1;
        ((akzf)localObject1).jdField_c_of_type_JavaLangString = str3;
        ((akzf)localObject1).jdField_e_of_type_JavaLangString = str1;
        ((akzf)localObject1).jdField_d_of_type_JavaLangString = str2;
        ((akzf)localObject1).jdField_b_of_type_Int = this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId;
        ((akzf)localObject1).jdField_a_of_type_Int = i1;
        ((akzf)localObject1).jdField_c_of_type_Int = this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.enter;
        ((akzf)localObject1).f = this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.from;
        ((akzf)localObject1).jdField_d_of_type_Int = 0;
        ((akzf)localObject1).jdField_c_of_type_Long = System.currentTimeMillis();
        ((akzf)localObject1).jdField_e_of_type_Int = this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.delayMs;
        this.jdField_a_of_type_Akzc = new akzc((akzf)localObject1, this);
        bool3 = this.jdField_a_of_type_Akzc.a();
        akwd.a(new Object[] { "[checkRes], serverVersion:" + i1 + ", isPatch:" + bool2, ", isUpdate:" + bool1, ",delay:", Integer.valueOf(((akzf)localObject1).jdField_e_of_type_Int) });
  ...
  public void a(CmGameStartChecker.StartCheckParam paramStartCheckParam, aksk paramaksk)
  {
    if ((paramStartCheckParam == null) || (paramaksk == null)) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramaksk);
  ...
  public void c()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.retCode == aliu.jdField_a_of_type_Long)
    {
      if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
      {
        localObject = (aksk)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        if (localObject != null)
        {
          ...
          ((aksk)localObject).onGameLifeTipShow(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam);
        }
      }
  ...
  public void c(int paramInt, String paramString)
  {
    ...
    akwd.a(new Object[] { "[downloadRes], failed ret:", Integer.valueOf(paramInt), ", packName:", paramString });
    b(-12L);
  }
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    //   100: invokestatic 827	akyf:a	(Z)Ljava/lang/String;
    //   103: aload 14
    ...
    //   438: lstore 12
    //   440: aconst_null
    //   441: invokestatic 869	bfbh:a	(Landroid/content/Context;)I
    //   444: istore 6
    ...
    //   503: invokestatic 630	azri:a	(Landroid/content/Context;)Lazri;
    //   506: astore 14
    //   508: aload 15
    ...
    //   536: ldc 117
    //   538: iconst_0
    //   539: invokevirtual 638	azri:a	(Ljava/lang/String;Ljava/lang/String;ZJJLjava/util/HashMap;Ljava/lang/String;Z)V
    //   542: lload 10
    //   544: lconst_0
    //   545: lcmp
    //   546: ifne +667 -> 1213
    ...
    //   723: aastore
    //   724: invokestatic 720	akwd:a	([Ljava/lang/Object;)V
    //   727: return
    //   728: iload 7
    //   730: istore_1
    //   731: iload 8
    ...
    //   869: lstore 12
    //   871: aconst_null
    //   872: invokestatic 869	bfbh:a	(Landroid/content/Context;)I
    //   875: istore 6
    ...
    //   934: invokestatic 630	azri:a	(Landroid/content/Context;)Lazri;
    //   937: astore 14
    //   939: aload 15
    ...
    //   967: ldc 117
    //   969: iconst_0
    //   970: invokevirtual 638	azri:a	(Ljava/lang/String;Ljava/lang/String;ZJJLjava/util/HashMap;Ljava/lang/String;Z)V
    //   973: lload 10
    //   975: lconst_0
    //   976: lcmp
    //   977: ifne +261 -> 1238
    ...
    //   1154: aastore
    //   1155: invokestatic 720	akwd:a	([Ljava/lang/Object;)V
    //   1158: return
    //   1159: iload 7
    //   1161: istore_1
    //   1162: iload 8
    ...
    //   1308: lstore 12
    //   1310: aconst_null
    //   1311: invokestatic 869	bfbh:a	(Landroid/content/Context;)I
    //   1314: istore 6
    ...
    //   1377: invokestatic 630	azri:a	(Landroid/content/Context;)Lazri;
    //   1380: astore 15
    //   1382: aload 16
    ...
    //   1411: ldc 117
    //   1413: iconst_0
    //   1414: invokevirtual 638	azri:a	(Ljava/lang/String;Ljava/lang/String;ZJJLjava/util/HashMap;Ljava/lang/String;Z)V
    //   1417: lload 10
    //   1419: lconst_0
    //   1420: lcmp
    //   1421: ifne +196 -> 1617
    ...
    //   1598: aastore
    //   1599: invokestatic 720	akwd:a	([Ljava/lang/Object;)V
    //   1602: aload_3
    //   1603: athrow
    //   1604: iload 4
    //   1606: i2l
