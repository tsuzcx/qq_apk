  ...
  public void run()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          localObject1 = akyf.a(CmGameStartChecker.a(this.this$0).isWhiteUsr);
      ...
      for (;;)
      {
        ...
        try
        {
          bool = new File(aliu.s + CmGameStartChecker.a(this.this$0).gameId + ".zip").exists();
          if (bool) {
            continue;
          }
          i = j;
      ...
      j = akwd.b(CmGameStartChecker.a(this.this$0).gameId);
      localJSONObject.put("pkgMode", j);
      localJSONObject.put("pModel", bdgk.i());
      localUniSsoServerReq.reqdata.set(localJSONObject.toString());
      localObject2 = new NewIntent(localAppInterface.getApp(), aksh.class);
      ...
      akwd.a(new Object[] { "[checkGame], checkGameWay:", Integer.valueOf(this.a), ", localVersion:", Integer.valueOf(i), ", rscType:", Integer.valueOf(j) });
