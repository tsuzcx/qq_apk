  ...
  public void run()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          localObject1 = andd.a(CmGameStartChecker.a(this.this$0).isWhiteUsr);
      ...
      for (;;)
      {
        ...
        try
        {
          bool = new File(annv.s + CmGameStartChecker.a(this.this$0).gameId + ".zip").exists();
          if (bool) {
            continue;
          }
          i = j;
      ...
      j = anbd.b(CmGameStartChecker.a(this.this$0).gameId);
      localJSONObject.put("pkgMode", j);
      localJSONObject.put("pModel", bhlo.i());
      localUniSsoServerReq.reqdata.set(localJSONObject.toString());
      localObject2 = new NewIntent(localAppInterface.getApp(), amxh.class);
      ...
      anbd.a(new Object[] { "[checkGame], checkGameWay:", Integer.valueOf(this.a), ", localVersion:", Integer.valueOf(i), ", rscType:", Integer.valueOf(j) });
