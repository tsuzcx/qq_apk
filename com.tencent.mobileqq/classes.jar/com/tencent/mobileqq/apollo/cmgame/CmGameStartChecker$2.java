  ...
  public void run()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          localObject1 = alxx.a(CmGameStartChecker.a(this.this$0).isWhiteUsr);
      ...
      for (;;)
      {
        ...
        try
        {
          bool = new File(amip.s + CmGameStartChecker.a(this.this$0).gameId + ".zip").exists();
          if (bool) {
            continue;
          }
          i = j;
      ...
      j = alvx.b(CmGameStartChecker.a(this.this$0).gameId);
      ...
      localObject2 = new NewIntent(localAppInterface.getApp(), alsb.class);
      ...
      alvx.a(new Object[] { "[checkGame], checkGameWay:", Integer.valueOf(this.a), ", localVersion:", Integer.valueOf(i), ", rscType:", Integer.valueOf(j) });
