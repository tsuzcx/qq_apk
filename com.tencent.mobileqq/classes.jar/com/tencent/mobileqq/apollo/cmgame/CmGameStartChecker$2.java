  ...
  public void run()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          localObject1 = amyn.a(CmGameStartChecker.a(this.this$0).isWhiteUsr);
      ...
      for (;;)
      {
        ...
        try
        {
          bool = new File("/sdcard/Android/data/com.tencent.mobileqq/Tencent/MobileQQ/.apollo/game/" + CmGameStartChecker.a(this.this$0).gameId + ".zip").exists();
          if (bool) {
            continue;
          }
          i = j;
      ...
      j = amwn.b(CmGameStartChecker.a(this.this$0).gameId);
      localJSONObject.put("pkgMode", j);
      localJSONObject.put("pModel", DeviceInfoUtil.getModel());
      localUniSsoServerReq.reqdata.set(localJSONObject.toString());
      localObject2 = new NewIntent(localAppInterface.getApp(), amrc.class);
      ...
      amwn.a(new Object[] { "[checkGame], checkGameWay:", Integer.valueOf(this.a), ", localVersion:", Integer.valueOf(i), ", rscType:", Integer.valueOf(j) });
