...
public class ChatPieApolloViewController$2
  implements Runnable
{
  public ChatPieApolloViewController$2(aklj paramaklj, BaseChatPie paramBaseChatPie) {}
  ...
  public void run()
  {
    ...
    if (this.this$0.jdField_a_of_type_ComTencentMobileqqApolloApolloRender == null)
    {
      ...
      this.this$0.jdField_a_of_type_ComTencentMobileqqApolloApolloRender = new ApolloRender(f, this.a.jdField_a_of_type_Aljb, 0);
      this.this$0.jdField_a_of_type_ComTencentMobileqqApolloApolloRender.setUseGlobalTimer(true);
    }
    alfz.b(this.this$0.jdField_a_of_type_Alga);
    if (!ApolloEngine.a())
    {
      alfz.a(this.this$0.jdField_a_of_type_Alga);
