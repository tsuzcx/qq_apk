  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    boolean bool2 = ApolloPanel.c(this.this$0);
    QLog.d("[cmshow]ApolloPanel", 1, new Object[] { "updateView, show=", Boolean.valueOf(bool1), ", has3dQualification=", Boolean.valueOf(bool2) });
    if ((bool1) && (bool2))
    {
      ApolloPanel.d(this.this$0).setVisibility(0);
      ApolloPanel.e(this.this$0).setVisibility(0);
    }
    else
    {
    ...
    if (ApolloPanel.d(this.this$0).getVisibility() == 0) {
      ApolloPanel.d(this.this$0).setOnClickListener(this.this$0);
    }
  }
}
