  ...
  implements Handler.Callback, IProfileCmShowComponentDelegate
{
  ...
  private static final String TAG = "[cmshow]ProfileCmShowComponentDelegateImpl";
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("[cmshow]ProfileCmShowComponentDelegateImpl", 0, "handleMessage MSG_REFRESH_APOLLO");
    }
  ...
  public void onCreate(Activity paramActivity, View paramView, Bundle paramBundle, ProfileCardInfo paramProfileCardInfo, IProfileConfig paramIProfileConfig)
  {
    ...
    {
      QLog.e("[cmshow]ProfileCmShowComponentDelegateImpl", 1, "[OnCreate] friendProfileCardActivityObj is not instance of QBaseActivity");
      return;
    }
  ...
  public void onDestroy()
  {
    ...
    if (localObject != null) {
      ((FriendCardApolloViewController)localObject).e();
    }
  }
  ...
  public void onPause()
  {
    ...
    if (localFriendCardApolloViewController != null) {
      localFriendCardApolloViewController.c();
    }
  }
  ...
  public void onResume()
  {
    FriendCardApolloViewController localFriendCardApolloViewController = this.mApolloViewController;
    if (localFriendCardApolloViewController != null) {
      localFriendCardApolloViewController.b();
    }
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.apollo.profilecard.api.impl.ProfileCmShowComponentDelegateImpl
