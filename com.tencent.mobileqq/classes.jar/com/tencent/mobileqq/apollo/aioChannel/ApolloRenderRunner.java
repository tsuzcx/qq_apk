...
public class ApolloRenderRunner
{
  ...
  public void a(IApolloCmdChannel paramIApolloCmdChannel, long paramLong, int paramInt, String paramString1, String paramString2)
  {
    for (;;)
    {
      ArrayList localArrayList;
      ...
      try
      {
        ...
        if (paramIApolloCmdChannel == null) {
          return;
        }
      ...
      else
      {
        ...
        {
          localIRenderRunner.runRenderTask(new ApolloRenderRunner.1(this, localIRenderRunner, paramLong, paramIApolloCmdChannel, paramInt, paramString1, paramString2));
          if (QLog.isColorLevel()) {
