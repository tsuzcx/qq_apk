...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/mobileqq/apollo/player/action/MODE;", "", "(Ljava/lang/String;I)V", "ACTION_MODE_RECORD_APNG", "ACTION_MODE_RECORD_GIF", "ACTION_MODE_FRAME", "cmshow_api_release"}, k=1, mv={1, 1, 16})
public enum MODE
{
  static
  {
 ...
 * Qualified Name:     com.tencent.mobileqq.apollo.player.action.MODE
