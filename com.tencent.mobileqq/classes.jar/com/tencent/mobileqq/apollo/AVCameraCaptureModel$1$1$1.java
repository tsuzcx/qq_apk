...
{
  public AVCameraCaptureModel$1$1$1(airo paramairo, ApolloSurfaceView paramApolloSurfaceView, AVVideoCtrl.VideoFrame paramVideoFrame) {}
  ...
  public void run()
  {
    String str = ajac.a().getCurrentAccountUin();
    ajct localajct = ajac.a(airm.a(this.jdField_a_of_type_Airo.a.a));
    if (localajct == null) {}
    while (TextUtils.isEmpty(localajct.b(str))) {
      return;
    }
