  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    anpx.b("preLoadEngine");
    anpx.a("sava_ApolloRender_preLoadTask");
    ...
    anpx.a("sava_ApolloRender_preLoadDirector");
    synchronized (ApolloRender.access$200(this.this$0))
    {
      if (!ApolloRender.access$300(this.this$0).b()) {
        ApolloRender.access$300(this.this$0).a(0L, 0, 0, ApolloRender.access$400(this.this$0), 1, amsx.a());
      }
      anpx.b("sava_ApolloRender_preLoadDirector");
    }
    for (;;)
    {
      synchronized (ApolloRender.access$500(this.this$0))
      {
        ...
        anpx.a("sava_ApolloRender_preLoadDirector_" + localIApolloRunnableTask.a());
        ...
        if (localIApolloRunnableTask.a() == 4) {
          synchronized (ApolloRender.access$200(this.this$0))
          {
            ...
            anpx.b("sava_ApolloRender_preLoadDirector_" + localIApolloRunnableTask.a());
          }
        }
      }
      ApolloRender.access$300(this.this$0).a(localObject3.a());
      localObject3.run();
      anpx.b("sava_ApolloRender_preLoadDirector_" + localObject3.a());
      continue;
      label535:
      if ((!ApolloRender.access$000(this.this$0)) && (!ApolloRender.access$600(this.this$0)) && (ApolloRender.access$700(this.this$0).isEmpty())) {
    ...
    anpx.b("sava_ApolloRender_preLoadTask");
  }
}
