  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    amkr.b("preLoadEngine");
    amkr.a("sava_ApolloRender_preLoadTask");
    ...
    amkr.a("sava_ApolloRender_preLoadDirector");
    synchronized (ApolloRender.access$200(this.this$0))
    {
      if (!ApolloRender.access$300(this.this$0).b()) {
        ApolloRender.access$300(this.this$0).a(0L, 0, 0, ApolloRender.access$400(this.this$0), 1, alnr.a());
      }
      amkr.b("sava_ApolloRender_preLoadDirector");
    }
    for (;;)
    {
      synchronized (ApolloRender.access$500(this.this$0))
      {
        ...
        amkr.a("sava_ApolloRender_preLoadDirector_" + localIApolloRunnableTask.a());
        ...
        if (localIApolloRunnableTask.a() == 4) {
          synchronized (ApolloRender.access$200(this.this$0))
          {
            ...
            amkr.b("sava_ApolloRender_preLoadDirector_" + localIApolloRunnableTask.a());
          }
        }
      }
      ApolloRender.access$300(this.this$0).a(localObject3.a());
      localObject3.run();
      amkr.b("sava_ApolloRender_preLoadDirector_" + localObject3.a());
      continue;
      label535:
      if ((!ApolloRender.access$000(this.this$0)) && (!ApolloRender.access$600(this.this$0)) && (ApolloRender.access$700(this.this$0).isEmpty())) {
    ...
    amkr.b("sava_ApolloRender_preLoadTask");
  }
}
