  ...
  implements IApolloResDownloader.OnAudioDownloadListener
{
  ...
  public void a(boolean paramBoolean, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      ...
      localBundle.putBoolean("apollo_is_super_yellow", QZoneVipInfoManager.getInstance().isSuperYellow());
 ...
 * Qualified Name:     com.tencent.mobileqq.apollo.handler.CmShowModule.6
