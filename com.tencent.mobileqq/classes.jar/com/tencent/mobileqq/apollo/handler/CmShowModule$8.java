  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      localObject = ((IApolloDaoManagerService)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getRuntimeService(IApolloDaoManagerService.class, "all")).getFavPackageActionList();
 ...
 * Qualified Name:     com.tencent.mobileqq.apollo.handler.CmShowModule.8
