...
public class CmGameDebugManager
{
  ...
  private WeakReference<CmGameDebugManager.OnLogViewRefresh> jdField_a_of_type_JavaLangRefWeakReference;
  private BlockingQueue<CmGameLogData> jdField_a_of_type_JavaUtilConcurrentBlockingQueue = new ArrayBlockingQueue(100);
  private boolean jdField_a_of_type_Boolean = false;
  private BlockingQueue<CmGameLogData> b;
  private BlockingQueue<CmGameLogData> c;
  ...
  private void a(CmGameLogData paramCmGameLogData)
  {
    if (paramCmGameLogData == null) {
      return;
    }
    switch (paramCmGameLogData.a)
    {
    }
    for (;;)
    {
      this.jdField_a_of_type_JavaUtilConcurrentBlockingQueue.offer(paramCmGameLogData);
      ...
      ThreadManager.getUIHandler().post(new CmGameDebugManager.1(this, paramCmGameLogData));
      return;
      this.jdField_c_of_type_JavaUtilConcurrentBlockingQueue.offer(paramCmGameLogData);
      if (this.jdField_c_of_type_JavaUtilConcurrentBlockingQueue.size() == 50)
      {
        ...
        continue;
        this.jdField_b_of_type_JavaUtilConcurrentBlockingQueue.offer(paramCmGameLogData);
  ...
  private List<CmGameLogData> b(int paramInt)
  {
    Object localObject = Arrays.asList(this.jdField_a_of_type_JavaUtilConcurrentBlockingQueue.toArray(new CmGameLogData[0]));
    if (paramInt == 0) {
      return localObject;
    }
    ...
    {
      CmGameLogData localCmGameLogData = (CmGameLogData)((Iterator)localObject).next();
      if (localCmGameLogData.a == paramInt) {
        localArrayList.add(localCmGameLogData);
      }
    }
    return localArrayList;
  }
  
  public List<CmGameLogData> a(int paramInt)
  {
    ArrayList localArrayList = new ArrayList();
    switch (paramInt)
    {
    default: 
      return localArrayList;
    case 0: 
      return Arrays.asList(this.jdField_a_of_type_JavaUtilConcurrentBlockingQueue.toArray(new CmGameLogData[0]));
    case 1: 
      return b(1);
    case 2: 
      return b(2);
    case 3: 
      return Arrays.asList(this.jdField_b_of_type_JavaUtilConcurrentBlockingQueue.toArray(new CmGameLogData[0]));
    }
    return Arrays.asList(this.jdField_c_of_type_JavaUtilConcurrentBlockingQueue.toArray(new CmGameLogData[0]));
  }
  ...
  public void a(CmGameDebugManager.OnLogViewRefresh paramOnLogViewRefresh)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramOnLogViewRefresh);
  }
  ...
  public void a(String paramString, int paramInt, Object... paramVarArgs)
  {
    ...
    a(new CmGameLogData(localStringBuilder.toString(), paramInt));
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.apollo.debug.CmGameDebugManager
