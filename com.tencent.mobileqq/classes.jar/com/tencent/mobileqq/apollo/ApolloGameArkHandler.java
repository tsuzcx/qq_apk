...
public class ApolloGameArkHandler
{
  ...
  public MessageForArkApp a(MessageForApollo paramMessageForApollo, MessageForArkApp paramMessageForArkApp)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localArkAppMessage.appDesc = HardCodeUtil.a(2131700431);
        ...
        else
        {
          ...
          localObject1 = ((ApolloManagerServiceImpl)paramMessageForArkApp.getRuntimeService(IApolloManagerService.class, "all")).getGameTempMsgHandler();
      ...
      paramMessageForArkApp.put("nickname", ((CmGameTempSessionHandler)localObject1).a.get(paramMessageForApollo.senderuin));
      paramMessageForArkApp.put("avatarUrl", ((CmGameTempSessionHandler)localObject1).b.get(paramMessageForApollo.senderuin));
    ...
    for (paramMessageForArkApp = paramMessageForApollo.frienduin;; paramMessageForArkApp = paramMessageForApollo.selfuin)
    {
      ...
      localJSONObject3.put("nickname", ((CmGameTempSessionHandler)localObject1).a.get(paramMessageForArkApp));
      localJSONObject3.put("avatarUrl", ((CmGameTempSessionHandler)localObject1).b.get(paramMessageForArkApp));
    ...
    for (;;)
    {
      ...
      if ((paramMessageForApollo != null) && (paramMessageForApollo.length() > 0))
      {
        ...
        continue;
        localObject2 = ((IApolloDaoManagerService)paramMessageForArkApp.getRuntimeService(IApolloDaoManagerService.class, "all")).findGameById(paramMessageForApollo.gameId);
        paramMessageForArkApp = HardCodeUtil.a(2131700432);
  ...
  public String a(String paramString)
  {
    ...
    //   0: aload_0
    //   1: monitorenter
    //   2: getstatic 19	com/tencent/mobileqq/apollo/ApolloGameArkHandler:jdField_a_of_type_ComTencentUtilLRULinkedHashMap	Lcom/tencent/util/LRULinkedHashMap;
    //   5: ifnull +12 -> 17
    //   8: aload_1
    ...
    //   21: aload_3
    //   22: areturn
    //   23: getstatic 19	com/tencent/mobileqq/apollo/ApolloGameArkHandler:jdField_a_of_type_ComTencentUtilLRULinkedHashMap	Lcom/tencent/util/LRULinkedHashMap;
    //   26: aload_1
    //   27: invokevirtual 432	com/tencent/util/LRULinkedHashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    //   46: aload_0
    //   47: aload_1
    //   48: invokespecial 434	com/tencent/mobileqq/apollo/ApolloGameArkHandler:a	(Ljava/lang/String;)V
    //   51: aconst_null
    //   52: astore_3
    //   53: goto -34 -> 19
    //   56: astore_1
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    //   25: monitorexit
    //   26: return
    //   27: getstatic 19	com/tencent/mobileqq/apollo/ApolloGameArkHandler:jdField_a_of_type_ComTencentUtilLRULinkedHashMap	Lcom/tencent/util/LRULinkedHashMap;
    //   30: aload_1
    //   31: aload_2
    //   32: invokevirtual 463	com/tencent/util/LRULinkedHashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   35: pop
    //   36: goto -12 -> 24
    //   39: astore_1
    //   40: aload_0
