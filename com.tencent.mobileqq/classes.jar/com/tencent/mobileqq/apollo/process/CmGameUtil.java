...
import com.tencent.mobileqq.apollo.process.data.CmGameManager.GameRunningTask;
...
public class CmGameUtil
{
  ...
  public static IApolloCmdChannel a()
  {
  ...
  public static CmGameDebugManager a()
  {
    CmGameManager localCmGameManager = a();
    if (localCmGameManager != null) {
      return localCmGameManager.a();
  ...
  public static void a(Activity paramActivity, Conversation paramConversation)
  {
    ...
    {
      return;
      localApolloManagerServiceImpl = (ApolloManagerServiceImpl)paramConversation.a.getRuntimeService(IApolloManagerService.class, "all");
      if (a(null)) {
        localApolloManagerServiceImpl.setNeedShowWorldCup(true);
      }
    } while ((localApolloManagerServiceImpl == null) || (!localApolloManagerServiceImpl.mNeedShowPlusGuide) || (paramActivity == null) || (!(paramActivity instanceof SplashActivity)) || (paramActivity.isFinishing()) || (!((SplashActivity)paramActivity).isResume()) || (paramConversation == null));
    if (FrameHelperActivity.b())
    {
      FrameHelperActivity.c(true);
      FrameHelperActivity.w();
    }
    a(paramConversation.b, localApolloManagerServiceImpl.getPlusTipsStr());
    localApolloManagerServiceImpl.mNeedShowPlusGuide = false;
  ...
  public static void a(View paramView, String paramString)
  {
    ...
    try
    {
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        localTextView.setBackgroundResource(2130838716);
        localTextView.setPadding((int)(DeviceInfoUtil.jdField_a_of_type_Float * 7.0F), (int)(DeviceInfoUtil.jdField_a_of_type_Float * 7.0F), (int)(DeviceInfoUtil.jdField_a_of_type_Float * 7.0F), 0);
        ...
        int i = (int)((float)DeviceInfoUtil.k() - DeviceInfoUtil.jdField_a_of_type_Float * 7.0F - localTextView.getMeasuredWidth());
        int j = (int)(localRect.bottom - 6.0F * DeviceInfoUtil.jdField_a_of_type_Float);
  ...
  public static void a(AppInterface paramAppInterface, int paramInt1, int paramInt2, int paramInt3, long paramLong, JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      ((JSONObject)localObject).put("sqVersion", "8.5.5.5105");
      ...
      paramJSONObject.setObserver(new CmGameUtil.3());
  ...
  public static void a(CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    {
      localList = localCmGameManager.a();
      if ((paramStartCheckParam.mStartType == 2) || (paramStartCheckParam.mStartType == 1) || (paramStartCheckParam.mStartType == 3))
      {
        ...
        if (localList != null)
        {
          ...
          if (i < localList.size())
          {
            localObject3 = (CmGameManager.GameRunningTask)localList.get(i);
            if ((localObject3 == null) || (((CmGameManager.GameRunningTask)localObject3).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam == null)) {
              break label713;
            }
            localObject1 = localCmGameManager.a(((CmGameManager.GameRunningTask)localObject3).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
            if (localObject1 == null) {
              break label713;
            }
            localObject4 = ((CmGameLauncher)localObject1).a();
            if ((((CmGameLauncher)localObject1).a() != paramStartCheckParam.gameId) || ((paramStartCheckParam.roomId != 0L) && (paramStartCheckParam.roomId != ((ApolloGameMsgInfo)localObject4).roomId))) {
              break label713;
            }
            if (((CmGameLauncher)localObject1).a() == null) {
              break label1490;
            }
          }
        }
    ...
    label849:
    label1490:
    for (localObject1 = ((CmGameLauncher)localObject1).a().getClass();; localObject1 = null)
    {
      QLog.i("cmgame_process.CmGameUtil", 1, " launchGame found old task.mStartCheckParam:" + ((CmGameManager.GameRunningTask)localObject3).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam);
      if (localObject1 == null)
      {
        if ((localList != null) && (localList.size() >= CmGameManager.jdField_a_of_type_ArrayOfJavaLangClass.length))
        {
          localObject2 = (CmGameManager.GameRunningTask)localList.get(0);
          if ((localObject2 != null) && (((CmGameManager.GameRunningTask)localObject2).jdField_a_of_type_JavaLangRefWeakReference != null))
          {
            localObject3 = (Activity)((CmGameManager.GameRunningTask)localObject2).jdField_a_of_type_JavaLangRefWeakReference.get();
            if (localObject3 != null)
            {
              ((Activity)localObject3).finish();
              if (((CmGameManager.GameRunningTask)localObject2).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null)
              {
                CmGameToolCmdChannel.a("cs.close_room.local", "{}", false, null, ((CmGameManager.GameRunningTask)localObject2).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                QLog.i("cmgame_process.CmGameUtil", 1, " launchGame close old  task.mStartCheckParam.gameId:" + ((CmGameManager.GameRunningTask)localObject2).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
              }
            }
          }
          localCmGameManager.jdField_a_of_type_JavaUtilList.remove(0);
        }
        localObject2 = new HashMap();
        i = 0;
        for (;;)
        {
          if (i < localCmGameManager.jdField_a_of_type_JavaUtilList.size())
          {
            localObject3 = (CmGameManager.GameRunningTask)localCmGameManager.jdField_a_of_type_JavaUtilList.get(i);
            if ((localObject3 != null) && (((CmGameManager.GameRunningTask)localObject3).jdField_a_of_type_JavaLangString != null)) {
              ((HashMap)localObject2).put(((CmGameManager.GameRunningTask)localObject3).jdField_a_of_type_JavaLangString, ((CmGameManager.GameRunningTask)localObject3).jdField_a_of_type_JavaLangString);
            }
            i += 1;
            continue;
            i += 1;
        ...
        i = 0;
        if (i >= CmGameManager.jdField_a_of_type_ArrayOfJavaLangClass.length) {
          break label1483;
        }
        if (TextUtils.isEmpty((String)((HashMap)localObject2).get(CmGameManager.jdField_a_of_type_ArrayOfJavaLangClass[i].getSimpleName())))
        {
          localObject2 = CmGameManager.jdField_a_of_type_ArrayOfJavaLangClass[i];
      ...
      for (;;)
      {
        ...
        {
          localObject1 = CmGameManager.jdField_a_of_type_ArrayOfJavaLangClass[0];
          QLog.e("cmgame_process.CmGameUtil", 1, "can not find activityClass, use first class");
        }
        localObject2 = new CmGameManager.GameRunningTask();
        ((CmGameManager.GameRunningTask)localObject2).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam = paramStartCheckParam;
        ((CmGameManager.GameRunningTask)localObject2).jdField_a_of_type_JavaLangString = ((Class)localObject1).getSimpleName();
        localCmGameManager.jdField_a_of_type_JavaUtilList.add(localObject2);
        for (;;)
        {
          if (QLog.isColorLevel())
          {
            localObject2 = localCmGameManager.jdField_a_of_type_JavaUtilList.iterator();
            for (;;)
            {
              if (((Iterator)localObject2).hasNext())
              {
                localObject3 = (CmGameManager.GameRunningTask)((Iterator)localObject2).next();
                QLog.d("cmgame_process.CmGameUtil", 2, "launchGame task:" + ((CmGameManager.GameRunningTask)localObject3).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                continue;
                i += 1;
                break;
                ...
                {
                  CmGameManager.GameRunningTask localGameRunningTask = (CmGameManager.GameRunningTask)localList.get(i);
                  boolean bool2 = false;
                  localObject3 = localObject1;
                  if (localGameRunningTask != null)
                  {
                    localObject3 = localObject1;
                    if (localGameRunningTask.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null)
                    {
                      localObject3 = localCmGameManager.a(localGameRunningTask.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                      boolean bool1 = bool2;
                      localObject2 = localObject1;
                      if (localObject3 != null)
                      {
                        ApolloGameMsgInfo localApolloGameMsgInfo = ((CmGameLauncher)localObject3).a();
                        bool1 = bool2;
                        localObject2 = localObject1;
                        if (((CmGameLauncher)localObject3).a() == paramStartCheckParam.gameId) {
                          if (paramStartCheckParam.roomId != 0L)
                          {
                            bool1 = bool2;
                            localObject2 = localObject1;
                            if (paramStartCheckParam.roomId != localApolloGameMsgInfo.roomId) {}
                          }
                          else
                          {
                            bool2 = true;
                            bool1 = bool2;
                            localObject2 = localObject1;
                            if (((CmGameLauncher)localObject3).a() != null)
                            {
                              localObject2 = ((CmGameLauncher)localObject3).a().getClass();
                              bool1 = bool2;
                            }
                          }
                        }
                      ...
                      if (!bool1)
                      {
                        if (localGameRunningTask.jdField_a_of_type_JavaLangRefWeakReference != null)
                        {
                          localObject1 = (Activity)localGameRunningTask.jdField_a_of_type_JavaLangRefWeakReference.get();
                          if (localObject1 != null)
                          {
                            ((Activity)localObject1).finish();
                            if (localGameRunningTask.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null) {
                              CmGameToolCmdChannel.a("cs.close_room.local", "{}", false, null, localGameRunningTask.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                            }
                            QLog.i("cmgame_process.CmGameUtil", 1, " launchGame close old  task.mStartCheckParam.gameId:" + localGameRunningTask.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                          }
                        }
                        ((List)localObject4).add(localGameRunningTask);
                        localObject3 = localObject2;
                      }
                    }
                  }
        ...
        for (;;)
        {
          ...
          localObject2 = CmGameManager.jdField_a_of_type_ArrayOfJavaLangClass[0];
          break;
  ...
  {
    CmGameDebugManager localCmGameDebugManager = a();
    if (localCmGameDebugManager != null) {
      localCmGameDebugManager.a("cmg_launch", 4, paramVarArgs);
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    ApolloGameData localApolloGameData = ((ApolloDaoManagerServiceImpl)localObject).findGameById(paramStartCheckParam.gameId);
    ...
    if (localApolloManagerServiceImpl != null)
    {
      ...
      if ((localApolloGameData != null) && ((((ApolloDaoManagerServiceImpl)localObject).isInUserGameList(paramStartCheckParam.gameId)) || (paramStartCheckParam.isRequestConf))) {
        break label251;
      }
    }
    label251:
    for (boolean bool = true;; bool = false)
    {
      ...
      paramStartCheckParam.version = localApolloManagerServiceImpl.getApolloGameLocalVersion(paramStartCheckParam.gameId);
      localObject = paramQQAppInterface.getCurrentAccountUin();
      paramStartCheckParam.isWhiteUsr = localApolloManagerServiceImpl.isApolloGameWhiteUser((String)localObject);
      paramStartCheckParam.apolloStatus = localApolloManagerServiceImpl.getApolloStatus((String)localObject);
      paramStartCheckParam.pushItem = localApolloManagerServiceImpl.getCmGamePushManager().a();
      paramStartCheckParam.mGameType = ApolloGameUtil.a(paramStartCheckParam.gameId);
      paramStartCheckParam.isGameRscExist = ApolloUtilImpl.isGameRscExist(paramStartCheckParam.gameId);
      ...
      paramStartCheckParam.gender = ((NearbyCardManager)paramQQAppInterface.getManager(QQManagerFactory.NEARBY_CARD_MANAGER)).b();
      paramStartCheckParam.isEnableMSAA = c(paramStartCheckParam.gameId);
      paramStartCheckParam.mIsTransGame = ApolloConfigUtils.c.contains(Integer.valueOf(paramStartCheckParam.gameId));
      return true;
    }
  }
  ...
  public static boolean a(String paramString1, String paramString2)
  {
    ...
    do
    {
      try
      {
        ...
        QLog.e("cmgame_process.CmGameUtil", 1, "md5 not match!");
        paramString1.delete();
      }
      catch (Exception paramString2)
      {
        QLog.e("cmgame_process.CmGameUtil", 1, "[patchGameRes] Exception:", paramString2);
      ...
      return false;
      QLog.i("cmgame_process.CmGameUtil", 1, "patch files succeed.");
      if (((File)localObject2).exists()) {
        ((File)localObject2).delete();
      }
      if (((File)localObject1).exists()) {
      ...
      return true;
      QLog.e("cmgame_process.CmGameUtil", 1, "patch game res error.");
      if (paramString1.exists()) {
        paramString1.delete();
      }
      if (((File)localObject2).exists()) {
  ...
  public static int b()
  {
    ...
    if ((localObject != null) && (((ApolloManagerServiceImpl)localObject).isPlusWhiteList())) {
      return 1;
    }
    return 0;
  }
  ...
  public static int b(int paramInt)
  {
    try
    {
      ...
      localObject = new JSONObject(FileUtils.b((File)localObject)).optJSONArray("subpackages");
      if (localObject != null)
      {
  ...
  public static String b(CmGameInitParams paramCmGameInitParams)
  {
    ...
    for (;;)
    {
      try
      {
        localJSONObject1 = ApolloGameBasicEventUtil.a(0, ApolloResDownloaderImpl.DEFAULT_DRESSIDS_ROLE0);
        ...
        if (("1".equals(paramCmGameInitParams.mGameName)) || ("2".equals(paramCmGameInitParams.mGameName)))
        {
          ...
          localJSONObject1.put("QQVer", "8.5.5.5105");
  ...
  public static void b()
  {
    ...
    do
    {
      do
      {
        ...
        {
          localObject = (ApolloManagerServiceImpl)((AppInterface)localObject).getRuntimeService(IApolloManagerService.class, "all");
          if ((localObject != null) && (((ApolloManagerServiceImpl)localObject).isGameAudioManagerCreated())) {
            ((ApolloManagerServiceImpl)localObject).getCmGameAudioManager().a();
          }
        }
        catch (Throwable localThrowable)
        {
          ...
          {
            int i;
            QLog.e("cmgame_process.CmGameUtil", 2, "[onGameCrashed] forceStopAudio error!", localThrowable);
          }
        }
        i = a();
      } while (-1 == i);
      localObject = CmGameServerQIPCModule.a().a(i);
    } while (localObject == null);
    ((CmGameLifeCycle)localObject).c();
  }
  ...
  public static void b(int paramInt)
  {
    try
    {
      ...
      ((ApolloExtensionHandlerImpl)a().getBusinessHandler(BusinessHandlerFactory.APOLLO_EXTENSION_HANDLER)).a("apollo_router_game.game_extend_linkcmd_set_plus_flag", localJSONObject.toString(), -1L, 0);
      return;
    }
    catch (Exception localException) {}
  }
  ...
  public static int c()
  {
    ...
    localObject = (ApolloManagerServiceImpl)((AppInterface)localObject).getRuntimeService(IApolloManagerService.class, "all");
    if ((localObject != null) && (((ApolloManagerServiceImpl)localObject).mIsPlayedGame)) {
      return 1;
    }
    return 0;
  }
  ...
  public static boolean c(int paramInt)
  {
    ...
    try
    {
      ...
      int i = new JSONObject(FileUtils.b((File)localObject)).optInt("enableMSAA");
  ...
  public static int e()
  {
    ...
    if (d < 0L) {
      d = Math.ceil(DeviceInfoUtil.a() / 1073741824.0D);
    }
    if (QLog.isColorLevel()) {
