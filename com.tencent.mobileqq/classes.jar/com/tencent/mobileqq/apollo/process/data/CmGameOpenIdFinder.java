...
public class CmGameOpenIdFinder
{
    ...
    for (;;)
    {
      ...
      try
      {
        if (CmGameUtil.a() != null)
        {
          ...
          {
            str = localCmGameOpenIdFinder.c(str);
  ...
  public static void a(long paramLong, int paramInt, String paramString)
  {
    ...
    try
    {
      ...
      localObject = localCmGameOpenIdFinder.c(paramString);
  ...
  public void a(int paramInt1, ArrayList paramArrayList1, ArrayList paramArrayList2, int paramInt2, long paramLong, boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramArrayList1)
      {
        ...
        QLog.w("cmgame_process.CmGameOpenIdFinder", 1, "[getOpenIdOrUinInfo], errInfo->" + paramArrayList1.getMessage());
      }
    }
    label217:
    return;
    localJSONObject.put("openIdList", paramArrayList2);
    for (;;)
    {
      ...
      if (1 == paramInt1)
      {
        ...
        while (paramArrayList2.hasNext()) {
          paramArrayList1.put((Long)paramArrayList2.next());
        }
        localJSONObject.put("uinList", paramArrayList1);
      }
    }
  }
  
  public void a(int paramInt1, ArrayList paramArrayList1, ArrayList paramArrayList2, int paramInt2, long paramLong, boolean paramBoolean, String paramString1, String paramString2, CmGameOpenIdFinder.OpenIdListener paramOpenIdListener)
  {
    a(paramInt1, paramArrayList1, paramArrayList2, paramInt2, paramLong, paramBoolean, paramString1, paramString2);
  ...
  public void a(ArrayList paramArrayList1, ArrayList paramArrayList2, int paramInt, long paramLong)
  {
    if (QLog.isColorLevel()) {
      QLog.d("cmgame_process.CmGameOpenIdFinder", 2, new Object[] { "[onIdentifierResp], tinyids=" + paramArrayList1.toString() + ",identifiers:", paramArrayList2.toString() });
    }
    if ((paramArrayList1 == null) || (paramArrayList2 == null) || (paramArrayList1.size() <= 0) || (paramArrayList2.size() <= 0) || (this.b == null)) {
      return;
    }
    ...
    for (;;)
    {
      ...
      {
        this.b.put(paramArrayList1.get(i), paramArrayList2.get(i));
        try
        {
          JSONObject localJSONObject2 = new JSONObject();
          localJSONObject2.put("identifier", paramArrayList2.get(i));
    ...
    try
    {
      ...
      label252:
      CmGameUtil.a().callbackFromRequest(paramLong, 0, "cs.audioRoom_update_userinfo.local", localJSONObject1.toString());
      return;
    }
    catch (Exception paramArrayList1)
    {
            ...
            if (((JSONArray)localObject1).length() > 0)
            {
              ...
              if (i < ((JSONArray)localObject1).length())
              {
                ...
                for (;;)
                {
                  ...
                  localObject2 = (CmGameOpenIdFinder.OpenIdListener)((WeakReference)localObject2).get();
                  if (localObject2 == null) {
                    break label741;
                  }
                  ((CmGameOpenIdFinder.OpenIdListener)localObject2).a(0, "", (String)localObject1);
              ...
              if (paramString.has("lState"))
              {
                ...
                if (((JSONArray)localObject3).length() > 0) {
                  CmGameUtil.a().callbackFromRequest(l, 0, "cs.audioRoom_update_userinfo.local", ((JSONObject)localObject2).toString());
                }
 ...
 * Qualified Name:     com.tencent.mobileqq.apollo.process.data.CmGameOpenIdFinder
