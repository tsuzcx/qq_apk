...
import com.tencent.mobileqq.apollo.ApolloRenderDriver.GameStatListener;
...
public class CmGameLauncher
  implements Handler.Callback, View.OnKeyListener, ApolloRenderDriver.GameStatListener, OnApolloViewListener
{
  public int a;
  public long a;
  ...
  private ApolloGameMsgInfo jdField_a_of_type_ComTencentMobileqqApolloApiModelApolloGameMsgInfo;
  private IApolloSoLoader.OnCmSoLoadCompleteCallback jdField_a_of_type_ComTencentMobileqqApolloApiResIApolloSoLoader$OnCmSoLoadCompleteCallback = new CmGameLauncher.5(this);
  ...
  private CmGameBannerAds jdField_a_of_type_ComTencentMobileqqApolloProcessAdsCmGameBannerAds;
  private ICmGameAudioPlayer jdField_a_of_type_ComTencentMobileqqApolloProcessAudioICmGameAudioPlayer;
  private CmGameAvHandler jdField_a_of_type_ComTencentMobileqqApolloProcessChanelCmGameAvHandler;
  private CmGameNativeMethodHandler jdField_a_of_type_ComTencentMobileqqApolloProcessChanelCmGameNativeMethodHandler;
  ...
  private CmGameSubRscHandler jdField_a_of_type_ComTencentMobileqqApolloProcessDownloadCmGameSubRscHandler;
  private NativeUIManager jdField_a_of_type_ComTencentMobileqqApolloProcessUiNativeUIManager;
  ...
  private ICmGameAudioPlayer jdField_b_of_type_ComTencentMobileqqApolloProcessAudioICmGameAudioPlayer;
  ...
  public CmGameLauncher(int paramInt)
  {
    ...
    DeviceInfoUtil.a();
    ApolloUtilImpl.getCmdChannel().makesureHasInitObj();
    ...
    this.jdField_a_of_type_ComTencentMobileqqApolloProcessDownloadCmGameSubRscHandler = new CmGameSubRscHandler(paramInt);
    this.jdField_a_of_type_ComTencentMobileqqApolloProcessAdsCmGameBannerAds = new CmGameBannerAds(paramInt);
  }
  ...
  private void c(CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameLauncher$RedPacketInfo.jdField_c_of_type_Int = this.jdField_e_of_type_Int;
  ...
  private void n()
  {
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      CmGameUtil.a(new Object[] { "[startGameEngine], game is not ready, so status:", Boolean.valueOf(this.k) });
    }
    for (;;)
    {
      return;
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null)
      {
        ...
        if (localObject1 != null) {
          ((IApolloCmdChannel)localObject1).callbackFromRequest(this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView.getLuaState(), 0, "sc.init_global_var.local", CmGameUtil.b(this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameInitParams));
        }
      ...
      {
        if (b()) {
          CmGameUtil.a().callbackFromRequest(this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView.getLuaState(), 0, "cs.xy_life_cycle_event_activity.local", "{}");
        }
        for (;;)
        {
          o();
          ...
          CmGameUtil.a(new Object[] { "[startGameEngine] cost:", Long.valueOf(l) });
          if (l <= 0L) {
            break;
          }
          ...
          StatisticCollector.getInstance(((AppInterface)localObject2).getApp()).collectPerformance(((AppInterface)localObject2).getCurrentAccountUin(), "cmgame_open_to_start_engine", true, l, 0L, (HashMap)localObject1, "", false);
          return;
          label527:
          localObject1 = String.valueOf(ApolloGameTool.a(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.extendJson));
          break label251;
          CmGameUtil.a().callbackFromRequest(a(), 0, "cs.xy_life_cycle_event_activity.local", "{}");
        }
      }
  ...
  public DoraemonAPIManager a(long paramLong, Activity paramActivity)
  {
    ...
    DoraemonOpenAPI.a();
    this.jdField_a_of_type_ComTencentMobileqqDoraemonDoraemonAPIManager = DoraemonOpenAPI.a(paramActivity, 5, String.valueOf(paramLong));
  ...
  {
    return this.jdField_a_of_type_ComTencentMobileqqApolloApiModelApolloGameMsgInfo;
  }
  ...
  {
    return this.jdField_a_of_type_ComTencentMobileqqApolloProcessAdsCmGameBannerAds;
  }
  
  public ICmGameAudioPlayer a()
  {
    return this.jdField_a_of_type_ComTencentMobileqqApolloProcessAudioICmGameAudioPlayer;
  }
  ...
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameScreenRotate == null) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameInitParams != null)) {
  ...
  {
    return this.jdField_a_of_type_ComTencentMobileqqApolloProcessDownloadCmGameSubRscHandler;
  }
  
  public NativeUIManager a()
  {
    return this.jdField_a_of_type_ComTencentMobileqqApolloProcessUiNativeUIManager;
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, String paramString)
  {
    for (;;)
    {
      try
      {
        ...
        if ((localObject != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null))
        {
          if (paramInt1 == -1)
          {
            ((IApolloCmdChannel)localObject).callbackFromRequest(this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView.getLuaState(), -1, "sc.share_game_to_friend_result.local", "{}");
            return;
          }
          CmGameShareDataHandler.GameShareResult localGameShareResult = new CmGameShareDataHandler.GameShareResult();
          localGameShareResult.jdField_e_of_type_Int = paramInt1;
          localGameShareResult.jdField_a_of_type_Long = System.currentTimeMillis();
          localGameShareResult.jdField_a_of_type_Int = this.jdField_e_of_type_Int;
          localGameShareResult.d = paramInt2;
          localGameShareResult.jdField_c_of_type_Int = paramInt3;
          localGameShareResult.jdField_a_of_type_JavaLangString = paramString;
          localGameShareResult.jdField_b_of_type_Int = this.jdField_b_of_type_Int;
          if (QLog.isColorLevel()) {
            QLog.d("cmgame_process.CmGameLauncher", 2, new Object[] { "[notifyEngineSharedResult],gameShareResult:", localGameShareResult });
          }
          ...
          if (!CmGameShareDataHandler.a().a(localGameShareResult)) {
            break label428;
          }
          paramInt3 = 0;
          ...
          ((IApolloCmdChannel)localObject).callbackFromRequest(this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView.getLuaState(), 0, "sc.share_game_to_friend_result.local", localJSONObject.toString());
          CmGameShareDataHandler.a().a(localGameShareResult);
        }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localApolloFloatActivity.mWebViewInstance != null)
        {
          paramString = new JSONObject(paramString);
          paramString = "window.mqq && mqq.execEventCallback && mqq.execEventCallback(" + Util.a("apolloGameWebMessage") + "," + String.valueOf(paramString) + "," + String.valueOf("") + ");";
          localApolloFloatActivity.mWebViewInstance.callJs(paramString);
          return;
        }
      }
      catch (Throwable paramString)
  ...
  public void a(int paramInt, String paramString1, String paramString2)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqApolloGameIApolloGameInterface != null) {
      this.jdField_a_of_type_ComTencentMobileqqApolloGameIApolloGameInterface.a(paramInt, paramString1, paramString2);
    }
  }
  ...
  public void a(Activity paramActivity)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqApolloProcessDownloadCmGameSubRscHandler != null) {
      this.jdField_a_of_type_ComTencentMobileqqApolloProcessDownloadCmGameSubRscHandler.a(paramActivity);
    }
    this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameCommonShare = new CmGameCommonShare(a(), CmGameUtil.a());
    this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameCommonShare.a(null, this.jdField_e_of_type_Int);
  }
  ...
  public void a(Activity paramActivity, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        a(paramActivity);
        a(paramActivity);
        this.jdField_a_of_type_ComTencentMobileqqApolloUtilsApolloGameRscVerify = new ApolloGameRscVerify(this.jdField_e_of_type_Int);
        if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null) {
          break label543;
        }
        if (this.jdField_a_of_type_JavaLangRefWeakReference != null) {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqApolloProcessUiNativeUIManager == null) {
        this.jdField_a_of_type_ComTencentMobileqqApolloProcessUiNativeUIManager = new NativeUIManager((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), this.jdField_e_of_type_Int);
      }
    ...
    {
      QLog.e("cmgame_process.CmGameLauncher", 1, localThrowable, new Object[0]);
      bool2 = CmGameUtil.a(this.jdField_e_of_type_Int);
      if (!bool2) {}
    }
    label543:
    label736:
      ...
      for (;;)
      {
        try
        {
          if ((paramActivity instanceof ApolloGameActivity))
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqApolloProcessChanelCmGameSubProcessHandler = new CmGameSubProcessHandler(this.jdField_e_of_type_Int, paramActivity);
            this.jdField_a_of_type_ComTencentMobileqqApolloProcessChanelCmGameAvHandler = new CmGameAvHandler(this.jdField_e_of_type_Int);
            this.jdField_a_of_type_ComTencentMobileqqApolloProcessChanelCmGameNativeMethodHandler = new CmGameNativeMethodHandler(this);
            paramActivity = CmGameUtil.a();
            if (paramActivity != null)
            {
              paramActivity.addRenderRunner(this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView);
              if (this.jdField_a_of_type_ComTencentMobileqqApolloProcessChanelCmGameSubProcessHandler != null) {
                paramActivity.removeCmdHandler(this.jdField_a_of_type_ComTencentMobileqqApolloProcessChanelCmGameSubProcessHandler);
              }
              if (this.jdField_a_of_type_ComTencentMobileqqApolloProcessChanelCmGameAvHandler != null) {
                paramActivity.removeCmdHandler(this.jdField_a_of_type_ComTencentMobileqqApolloProcessChanelCmGameAvHandler);
              }
              paramActivity.addCmdHandler(this.jdField_a_of_type_ComTencentMobileqqApolloProcessChanelCmGameSubProcessHandler);
              paramActivity.addCmdHandler(this.jdField_a_of_type_ComTencentMobileqqApolloProcessChanelCmGameAvHandler);
              paramActivity.addCmdHandler(this.jdField_a_of_type_ComTencentMobileqqApolloProcessChanelCmGameNativeMethodHandler);
            }
  ...
  public void a(Bitmap paramBitmap)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameCommonShare != null) {
      this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameCommonShare.a(paramBitmap, this.jdField_e_of_type_Int);
    }
    if (QLog.isColorLevel()) {
  ...
  public void a(Bundle paramBundle)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        b(paramBundle);
        CmGameUtil.a(new Object[] { "[checkFinish], loading from main process and tool process is on, before cost:", Long.valueOf(l1) });
  ...
  public void a(IApolloGameInterface paramIApolloGameInterface)
  {
    ...
    if (localIApolloCmdChannel != null) {
      localIApolloCmdChannel.addRenderRunner(paramIApolloGameInterface);
    }
  }
  
  public void a(CmGameADInfo paramCmGameADInfo)
  {
    if (paramCmGameADInfo == null) {}
    CmGameVideoViewController localCmGameVideoViewController;
    do
    {
      return;
      localCmGameVideoViewController = a();
    } while (localCmGameVideoViewController == null);
    localCmGameVideoViewController.a(paramCmGameADInfo);
  }
  ...
  public void a(String paramString)
  {
    ...
    localCmGameVideoViewController.a(paramString);
  }
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqApolloProcessAudioICmGameAudioPlayer == null)
    {
      if (paramInt != 0) {
        break label52;
      }
      this.jdField_a_of_type_ComTencentMobileqqApolloProcessAudioICmGameAudioPlayer = new ApolloGameMusicPlayer(CmGameUtil.a(), this.jdField_e_of_type_Int);
    }
    for (;;)
    {
      if (this.jdField_b_of_type_ComTencentMobileqqApolloProcessAudioICmGameAudioPlayer == null) {
        this.jdField_b_of_type_ComTencentMobileqqApolloProcessAudioICmGameAudioPlayer = new CmAudioManager(this.jdField_a_of_type_ComTencentMobileqqApolloProcessChanelCmGameNativeMethodHandler);
      }
      return;
      label52:
      if (1 == paramInt) {
        this.jdField_a_of_type_ComTencentMobileqqApolloProcessAudioICmGameAudioPlayer = new CmGameSoudPoolPlayer(this.jdField_e_of_type_Int);
      }
    }
  }
  ...
  public void b(Activity paramActivity, CmGameInitParams paramCmGameInitParams)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameCommonShare = new CmGameCommonShare(a(), CmGameUtil.a());
    this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameCommonShare.a(null, this.jdField_e_of_type_Int);
    paramCmGameInitParams = CmGameUtil.a();
    if (paramCmGameInitParams != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqApolloProcessChanelCmGameSubProcessHandler = new CmGameSubProcessHandler(this.jdField_e_of_type_Int, paramActivity);
      if (this.jdField_a_of_type_ComTencentMobileqqApolloProcessChanelCmGameAvHandler != null) {
        paramCmGameInitParams.removeCmdHandler(this.jdField_a_of_type_ComTencentMobileqqApolloProcessChanelCmGameAvHandler);
      }
      paramCmGameInitParams.addCmdHandler(this.jdField_a_of_type_ComTencentMobileqqApolloProcessChanelCmGameSubProcessHandler);
      this.jdField_a_of_type_ComTencentMobileqqApolloProcessChanelCmGameAvHandler = new CmGameAvHandler(this.jdField_e_of_type_Int);
      paramCmGameInitParams.addCmdHandler(this.jdField_a_of_type_ComTencentMobileqqApolloProcessChanelCmGameAvHandler);
    }
    int m;
    label150:
    String str;
    ...
    for (;;)
    {
      ...
      break label150;
      label228:
      str = String.valueOf(ApolloGameTool.a(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.extendJson));
      break label162;
  ...
  public void b(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      if ((localObject != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.mGameType != 1)) {
        ((IApolloCmdChannel)localObject).callbackFromRequest(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId, 0, "sc.game_shell_share.local", "{}");
      }
      if ((localObject != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null)) {
        ((IApolloCmdChannel)localObject).callbackFromRequest(this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView.getLuaState(), 0, "sc.game_shell_share.local", "{}");
      }
      this.jdField_a_of_type_ComTencentUtilWeakReferenceHandler.removeMessages(203);
      localObject = this.jdField_a_of_type_ComTencentUtilWeakReferenceHandler.obtainMessage(203);
  ...
  public void c()
  {
    CmGameVideoViewController localCmGameVideoViewController = a();
    if (localCmGameVideoViewController != null) {
      localCmGameVideoViewController.b(false);
    }
  }
  ...
  public void c(String paramString)
  {
    ...
    if (localIApolloCmdChannel != null)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null)
      {
        localIApolloCmdChannel.callbackFromRequest(this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView.getRuntimeState(), 0, "sc.web_callback_game.local", paramString);
        return;
      }
  ...
  public void d()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null) && (localIApolloCmdChannel != null))
    {
      if (this.jdField_a_of_type_ComTencentMobileqqApolloProcessAudioICmGameAudioPlayer != null) {
        this.jdField_a_of_type_ComTencentMobileqqApolloProcessAudioICmGameAudioPlayer.b();
      }
      if (this.jdField_b_of_type_ComTencentMobileqqApolloProcessAudioICmGameAudioPlayer != null) {
        this.jdField_b_of_type_ComTencentMobileqqApolloProcessAudioICmGameAudioPlayer.b();
      }
      if (localIApolloCmdChannel != null)
      {
        localIApolloCmdChannel.callbackFromRequest(this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView.getLuaState(), 0, "sc.game_maximize.local", "{}");
        localIApolloCmdChannel.callbackFromRequest(this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView.getLuaState(), 0, "sc.game_enter_foreground.local", "{}");
      }
    }
  }
  ...
  {
    IApolloCmdChannel localIApolloCmdChannel = CmGameUtil.a();
    if ((localIApolloCmdChannel != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null)) {
      localIApolloCmdChannel.callbackFromRequest(this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView.getLuaState(), paramInt, "sc.send_b2c_redpacket_result.local", "{}");
    }
  }
  ...
  {
    this.jdField_a_of_type_ComTencentUtilWeakReferenceHandler.removeMessages(203);
    if (((!this.jdField_b_of_type_Boolean) || ((!TextUtils.isEmpty(paramString)) && (paramString.contains("inner")))) && (this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameCommonShare != null))
    {
      boolean bool = this.jdField_e_of_type_Boolean;
      this.jdField_a_of_type_ComTencentUtilWeakReferenceHandler.post(new CmGameLauncher.9(this, paramString, bool));
    }
  ...
  public void e()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqApolloProcessAudioICmGameAudioPlayer != null) {
      this.jdField_a_of_type_ComTencentMobileqqApolloProcessAudioICmGameAudioPlayer.a();
    }
    if (this.jdField_b_of_type_ComTencentMobileqqApolloProcessAudioICmGameAudioPlayer != null) {
      this.jdField_b_of_type_ComTencentMobileqqApolloProcessAudioICmGameAudioPlayer.a();
    }
    IApolloCmdChannel localIApolloCmdChannel = CmGameUtil.a();
    if ((localIApolloCmdChannel != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null)) {
      localIApolloCmdChannel.callbackFromRequest(this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView.getLuaState(), 0, "sc.game_enter_background.local", "{}");
    }
  }
  ...
  {
    IApolloCmdChannel localIApolloCmdChannel = CmGameUtil.a();
    if ((localIApolloCmdChannel != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.mGameType != 1)) {}
    try
    {
      JSONObject localJSONObject = new JSONObject();
      localJSONObject.put("shareType", paramInt);
      localIApolloCmdChannel.callbackFromRequest(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId, 0, "sc.game_shell_share.local", localJSONObject.toString());
      return;
    }
    catch (Throwable localThrowable)
    {
  ...
  public void f()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqApolloProcessAudioICmGameAudioPlayer != null) {
      this.jdField_a_of_type_ComTencentMobileqqApolloProcessAudioICmGameAudioPlayer.c();
    }
    if (this.jdField_b_of_type_ComTencentMobileqqApolloProcessAudioICmGameAudioPlayer != null) {
      this.jdField_b_of_type_ComTencentMobileqqApolloProcessAudioICmGameAudioPlayer.c();
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqApolloProcessUiNativeUIManager != null) {
          this.jdField_a_of_type_ComTencentMobileqqApolloProcessUiNativeUIManager.a();
        }
        if (this.jdField_a_of_type_ComTencentMobileqqApolloProcessAdsCmGameBannerAds != null) {
          this.jdField_a_of_type_ComTencentMobileqqApolloProcessAdsCmGameBannerAds.a();
        }
        if (QLog.isColorLevel()) {
  ...
  public void g()
  {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        {
          if (this.jdField_a_of_type_ComTencentMobileqqApolloGameIApolloGameInterface != null) {
            localIApolloCmdChannel.removeRenderRunner(this.jdField_a_of_type_ComTencentMobileqqApolloGameIApolloGameInterface);
          }
          if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null) {
            localIApolloCmdChannel.removeRenderRunner(this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView);
          }
          if (this.jdField_a_of_type_ComTencentMobileqqApolloProcessChanelCmGameSubProcessHandler != null) {
            localIApolloCmdChannel.removeCmdHandler(this.jdField_a_of_type_ComTencentMobileqqApolloProcessChanelCmGameSubProcessHandler);
          }
          if (this.jdField_a_of_type_ComTencentMobileqqApolloProcessChanelCmGameAvHandler != null) {
            localIApolloCmdChannel.removeCmdHandler(this.jdField_a_of_type_ComTencentMobileqqApolloProcessChanelCmGameAvHandler);
          }
          if (this.jdField_a_of_type_ComTencentMobileqqApolloProcessChanelCmGameNativeMethodHandler != null) {
            localIApolloCmdChannel.removeCmdHandler(this.jdField_a_of_type_ComTencentMobileqqApolloProcessChanelCmGameNativeMethodHandler);
          }
        }
        if (this.jdField_a_of_type_ComTencentMobileqqApolloProcessChanelCmGameAvHandler != null) {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqApolloProcessChanelCmGameNativeMethodHandler != null) {
          this.jdField_a_of_type_ComTencentMobileqqApolloProcessChanelCmGameNativeMethodHandler.a();
        }
        return;
        label234:
  ...
  public void h()
  {
    ...
    if (localIApolloCmdChannel != null)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null)
      {
        localIApolloCmdChannel.callbackFromRequest(this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView.getLuaState(), 0, "sc.game_minimize.local", "{}");
        localIApolloCmdChannel.callbackFromRequest(this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView.getLuaState(), 0, "sc.game_shell_pack_up.local", "{}");
      }
    }
    CmGameToolCmdChannel.a("cs.make_room_min.local", "{}", false, null, this.jdField_e_of_type_Int);
    if ((CmGameUtil.a() != null) && (this.jdField_a_of_type_JavaLangRefWeakReference != null)) {
      CmGameUtil.a(this.jdField_e_of_type_Int, (Context)this.jdField_a_of_type_JavaLangRefWeakReference.get());
    }
    if (QLog.isColorLevel()) {
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    {
      if ((this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameCommonShare == null) || (!this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameCommonShare.a(this.jdField_e_of_type_Int))) {
        break label271;
      }
      this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameCommonShare.a((String)paramMessage.obj, this.jdField_e_of_type_Int, this.jdField_e_of_type_Boolean);
    ...
    for (;;)
    {
      ...
      return false;
      label271:
      ApolloGameBasicEventUtil.a(this.jdField_e_of_type_Int, (String)paramMessage.obj, a());
    }
  }
  ...
  public void i()
  {
    IApolloCmdChannel localIApolloCmdChannel = CmGameUtil.a();
    if ((localIApolloCmdChannel != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null)) {
      localIApolloCmdChannel.callbackFromRequest(this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView.getLuaState(), 0, "sc.game_shell_close.local", "{}");
    }
    CmGameToolCmdChannel.a("cs.close_room.local", "{}", false, null, this.jdField_e_of_type_Int);
  }
  ...
  public void j()
  {
    ...
    QIPCClientHelper.getInstance().callServer("cm_game_module", "action_query_check_game_data", localBundle, new CmGameLauncher.10(this));
  }
  ...
  public void onSurfaceReady(int paramInt1, int paramInt2)
  {
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameNetInfoHandler = new CmGameNetInfoHandler(this.jdField_e_of_type_Int);
