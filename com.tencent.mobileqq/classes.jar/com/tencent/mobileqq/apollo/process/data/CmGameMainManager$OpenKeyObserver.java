  ...
  extends WtloginObserver
{
  ...
  CmGameMainManager$OpenKeyObserver(CmGameMainManager paramCmGameMainManager)
  {
  ...
  public void onGetOpenKeyWithoutPasswd(String paramString, long paramLong1, long paramLong2, int paramInt1, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, int paramInt2, ErrMsg paramErrMsg)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramArrayOfByte1 = ((ApolloDaoManagerServiceImpl)paramArrayOfByte1.getRuntimeService(IApolloDaoManagerService.class, "all")).findGameById(this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameMainManager.a.gameId);
        if (paramArrayOfByte1 != null)
        {
 ...
 * Qualified Name:     com.tencent.mobileqq.apollo.process.data.CmGameMainManager.OpenKeyObserver
