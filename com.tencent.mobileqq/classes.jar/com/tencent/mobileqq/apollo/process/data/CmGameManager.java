...
import com.tencent.mobileqq.apollo.api.res.impl.ApolloImageDownloaderImpl;
  ...
  implements Manager
{
  ...
  private CmGameDebugManager jdField_a_of_type_ComTencentMobileqqApolloDebugCmGameDebugManager;
  ...
  private void c()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        if (localSharedPreferences.contains("exit_game_guide_today_" + ApolloUtilImpl.getTodayKey())) {
          this.jdField_a_of_type_Boolean = false;
        }
      }
  ...
  private void d()
  {
    ...
    String str1 = "exit_game_guide_today_" + ApolloUtilImpl.getTodayKey();
  ...
  public IApolloCmdChannel a()
  {
    return ApolloUtilImpl.getCmdChannel();
  }
  
  /* Error */
  public CmGameDebugManager a()
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 57	com/tencent/mobileqq/apollo/process/data/CmGameManager:c	Z
    //   6: istore_1
    //   7: iload_1
    //   8: ifne +9 -> 17
    //   11: aconst_null
    ...
    //   16: areturn
    //   17: aload_0
    //   18: getfield 372	com/tencent/mobileqq/apollo/process/data/CmGameManager:jdField_a_of_type_ComTencentMobileqqApolloDebugCmGameDebugManager	Lcom/tencent/mobileqq/apollo/debug/CmGameDebugManager;
    //   21: ifnonnull +29 -> 50
    //   24: aload_0
    //   25: new 374	com/tencent/mobileqq/apollo/debug/CmGameDebugManager
    //   28: dup
    //   29: invokespecial 375	com/tencent/mobileqq/apollo/debug/CmGameDebugManager:<init>	()V
    //   32: putfield 372	com/tencent/mobileqq/apollo/process/data/CmGameManager:jdField_a_of_type_ComTencentMobileqqApolloDebugCmGameDebugManager	Lcom/tencent/mobileqq/apollo/debug/CmGameDebugManager;
    //   35: invokestatic 225	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   38: ifeq +12 -> 50
    //   41: ldc 73
    //   43: iconst_2
    //   44: ldc_w 377
    //   47: invokestatic 379	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   50: aload_0
    //   51: getfield 372	com/tencent/mobileqq/apollo/process/data/CmGameManager:jdField_a_of_type_ComTencentMobileqqApolloDebugCmGameDebugManager	Lcom/tencent/mobileqq/apollo/debug/CmGameDebugManager;
    //   54: astore_2
    //   55: goto -42 -> 13
    //   58: astore_2
    //   59: aload_0
    ...
    //   0	63	0	this	CmGameManager
    //   6	2	1	bool	boolean
    //   12	43	2	localCmGameDebugManager	CmGameDebugManager
  ...
  public CmGameLauncher a()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((localCmGameLauncher != null) && (!CmGameUtil.a(localCmGameLauncher.a())) && (!CmGameUtil.b(localCmGameLauncher.a()))) {
  ...
  public CmGameLauncher a(long paramLong)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 46	com/tencent/mobileqq/apollo/process/data/CmGameManager:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   6: invokevirtual 381	java/util/concurrent/CopyOnWriteArrayList:iterator	()Ljava/util/Iterator;
    //   9: astore 6
    //   11: aload 6
    //   13: invokeinterface 280 1 0
    //   18: ifeq +49 -> 67
    //   21: aload 6
    //   23: invokeinterface 284 1 0
    //   28: checkcast 383	com/tencent/mobileqq/apollo/process/data/CmGameLauncher
    //   31: astore 5
    //   33: aload 5
    //   35: ifnull -24 -> 11
    //   38: aload 5
    //   40: invokevirtual 418	com/tencent/mobileqq/apollo/process/data/CmGameLauncher:a	()Lcom/tencent/mobileqq/apollo/ApolloSurfaceView;
    //   43: astore 7
    //   45: aload 7
    //   47: ifnull -36 -> 11
    //   50: aload 7
    //   52: invokevirtual 424	com/tencent/mobileqq/apollo/ApolloSurfaceView:getLuaState	()J
    //   55: lstore_3
    //   56: lload_3
    //   57: lload_1
    //   58: lcmp
  ...
  public List<CmGameManager.GameRunningTask> a()
  {
    ...
    Collections.sort(localArrayList, new CmGameManager.1(this));
  ...
  public void a()
  {
    ...
    while (localIterator.hasNext())
    {
      CmGameManager.GameRunningTask localGameRunningTask = (CmGameManager.GameRunningTask)localIterator.next();
      if (localGameRunningTask != null) {
        if (localGameRunningTask.jdField_a_of_type_JavaLangRefWeakReference == null)
        {
          localArrayList.add(localGameRunningTask);
          QLog.e("cmgame_process.CmGameManager", 1, "checkValidGameTask remove invalid 1 gameTask:" + localGameRunningTask.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam);
        }
        else
        {
          if (localGameRunningTask.jdField_a_of_type_JavaLangRefWeakReference.get() == null) {
            localArrayList.add(localGameRunningTask);
          }
          QLog.e("cmgame_process.CmGameManager", 1, "checkValidGameTask remove invalid 2 gameTask:" + localGameRunningTask.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam);
        }
      }
    }
  ...
  public void a(Activity paramActivity, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    for (;;)
    {
      return;
      Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
      CmGameManager.GameRunningTask localGameRunningTask;
      while (localIterator.hasNext())
      {
        localGameRunningTask = (CmGameManager.GameRunningTask)localIterator.next();
        if ((localGameRunningTask != null) && (localGameRunningTask.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId == paramStartCheckParam.gameId))
        {
          localGameRunningTask.jdField_a_of_type_Int = 1;
          localGameRunningTask.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
          QLog.d("cmgame_process.CmGameManager", 1, "onGameActivityCreate foundTask" + localGameRunningTask);
        }
      }
      for (;;)
      {
        ...
        localGameRunningTask = new CmGameManager.GameRunningTask();
        localGameRunningTask.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam = paramStartCheckParam;
        localGameRunningTask.jdField_a_of_type_JavaLangString = paramActivity.getClass().getSimpleName();
        localGameRunningTask.jdField_a_of_type_Int = 1;
        localGameRunningTask.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
        this.jdField_a_of_type_JavaUtilList.add(localGameRunningTask);
        return;
        localGameRunningTask = null;
      }
    }
  }
  ...
  public CmGameLauncher b(int paramInt1, int paramInt2)
  {
    ...
    //   36: iload_1
    //   37: aload_3
    //   38: invokevirtual 385	com/tencent/mobileqq/apollo/process/data/CmGameLauncher:a	()I
    //   41: if_icmpne -30 -> 11
    //   44: iload_2
    //   45: aload_3
    //   46: getfield 401	com/tencent/mobileqq/apollo/process/data/CmGameLauncher:d	I
    //   49: if_icmpne -38 -> 11
    //   52: aload_0
    //   53: getfield 46	com/tencent/mobileqq/apollo/process/data/CmGameManager:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   56: aload_3
    //   57: invokevirtual 519	java/util/concurrent/CopyOnWriteArrayList:remove	(Ljava/lang/Object;)Z
    //   60: ifeq -49 -> 11
    //   63: ldc 73
    //   65: iconst_1
    //   66: new 157	java/lang/StringBuilder
    //   69: dup
    //   70: invokespecial 158	java/lang/StringBuilder:<init>	()V
    //   73: ldc_w 521
    //   76: invokevirtual 162	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   79: iload_1
    //   80: invokevirtual 409	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   83: ldc_w 411
    //   86: invokevirtual 162	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   89: aload_0
    //   90: getfield 46	com/tencent/mobileqq/apollo/process/data/CmGameManager:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   93: invokevirtual 414	java/util/concurrent/CopyOnWriteArrayList:size	()I
    //   96: invokevirtual 409	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   99: invokevirtual 169	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   102: invokestatic 81	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   105: aload_0
    //   106: monitorexit
    //   107: aload_3
    //   108: areturn
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	119	0	this	CmGameManager
    //   0	119	1	paramInt1	int
    //   0	119	2	paramInt2	int
    //   31	80	3	localCmGameLauncher	CmGameLauncher
  ...
  public void b(Activity paramActivity, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((localGameRunningTask != null) && (localGameRunningTask.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId == paramStartCheckParam.gameId))
        {
          localGameRunningTask.jdField_a_of_type_Int = 2;
          localGameRunningTask.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
          localGameRunningTask.jdField_a_of_type_Long = System.currentTimeMillis();
          QLog.d("cmgame_process.CmGameManager", 1, "onGameActivityResume foundTask" + localGameRunningTask);
        }
      }
      for (paramActivity = localGameRunningTask; (paramActivity == null) && (paramStartCheckParam != null); paramActivity = null)
      {
  ...
  public void c(Activity paramActivity, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    if ((paramStartCheckParam != null) && (paramActivity != null))
    {
      ...
      while (localIterator.hasNext())
      {
        paramActivity = (CmGameManager.GameRunningTask)localIterator.next();
  ...
  public void onDestroy()
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqApolloDebugCmGameDebugManager != null) {
        this.jdField_a_of_type_ComTencentMobileqqApolloDebugCmGameDebugManager.a();
      }
      this.c = false;
      return;
    }
