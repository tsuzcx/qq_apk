...
public class CmGameLauncher$RedPacketInfo
{
  ...
  public String a()
  {
    ...
    if (!TextUtils.isEmpty(this.jdField_c_of_type_JavaLangString)) {
      try
      {
        String str = this.jdField_c_of_type_JavaLangString + "?amount=" + this.jdField_d_of_type_JavaLangString + "&state=" + this.f + "&goalScore=" + this.jdField_a_of_type_Int + "&curScore=" + this.jdField_d_of_type_Int + "&nickName=" + this.e + "&uin=" + this.h;
  ...
  public String toString()
  {
    ...
    localStringBuffer.append(", ownerUin='").append(this.h).append('\'');
 ...
 * Qualified Name:     com.tencent.mobileqq.apollo.process.data.CmGameLauncher.RedPacketInfo
