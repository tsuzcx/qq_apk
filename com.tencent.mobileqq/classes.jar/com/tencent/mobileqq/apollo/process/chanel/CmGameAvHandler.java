  ...
  implements IRequestHandler
{
  ...
  private AVVideoCtrl.EnableCameraCompleteCallback jdField_a_of_type_ComTencentTMGSdkAVVideoCtrl$EnableCameraCompleteCallback = new CmGameAvHandler.16(this);
  public AVCameraCaptureModel a;
  AVEngineEventHandler jdField_a_of_type_ComTencentQqavopensdkAVEngineEventHandler = new CmGameAvHandler.15(this);
  ...
  private void a(String[] paramArrayOfString, String paramString)
  {
    ...
    paramArrayOfString = new CmGameAvHandler.18(this);
    if (QLog.isColorLevel())
    {
      i = j;
      while (i < localArrayList1.size())
  ...
  private void b(boolean paramBoolean)
  {
    ...
    this.f = paramBoolean;
    if ((CmGameUtil.b(this.jdField_a_of_type_Long) != null) && (CmGameUtil.b(this.jdField_a_of_type_Long).a != null))
    {
      AppActivity localAppActivity = (AppActivity)CmGameUtil.b(this.jdField_a_of_type_Long).a.get();
      localAppActivity.requestPermissions(new CmGameAvHandler.17(this, localAppActivity), 1, new String[] { "android.permission.CAMERA" });
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      label130:
      label140:
      AVManager.a(BaseApplicationImpl.getContext()).a().getRoom().cancelAllView(new CmGameAvHandler.19(this));
    }
  }
