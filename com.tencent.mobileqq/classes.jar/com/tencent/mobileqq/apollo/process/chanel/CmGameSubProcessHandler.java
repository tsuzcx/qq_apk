...
import com.tencent.mobileqq.apollo.api.impl.ApolloCmdChannelImpl.openApiHeadCallback;
import com.tencent.mobileqq.apollo.api.impl.ApolloCmdChannelImpl.openApiNickCallback;
  ...
  implements IRequestHandler
{
  ...
  private void a(long paramLong, int paramInt, CmGameLauncher.RedPacketInfo paramRedPacketInfo)
  {
    ...
    {
      localIApolloCmdChannel.callbackFromRequest(paramLong, paramInt, "cs.get_redPacket_result.local", paramRedPacketInfo.a());
  ...
  private void a(long paramLong, String paramString, DoraemonAPIManager paramDoraemonAPIManager)
  {
    ...
    paramDoraemonAPIManager.a(str, null, new CmGameSubProcessHandler.3(this, paramString, paramLong));
  }
  ...
  private void a(String paramString, long paramLong, int paramInt)
  {
    try
    {
      ...
      IApolloCmdChannel localIApolloCmdChannel = CmGameUtil.a();
      if (localIApolloCmdChannel != null) {
        localIApolloCmdChannel.callbackFromRequest(paramLong, paramInt, paramString, localJSONObject.toString());
      }
      return;
    }
  ...
  private void e(long paramLong, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        CmGameUtil.a(CmGameUtil.a(), i, j, this.jdField_d_of_type_Int, k, paramString);
        i = 0;
      }
      catch (Exception paramString)
      {
  ...
  private void i(long paramLong, String paramString)
  {
    ...
    do
    {
      ...
      {
        return;
        localCmGameInitParams = ((CmGameLauncher)localObject).a();
    ...
    if (localCmGameInitParams.accessTokenRet != 1)
    {
      ...
      ((DoraemonAPIManager)localObject).a("login", null, new CmGameSubProcessHandler.2(this, paramString, paramLong, (DoraemonAPIManager)localObject, localCmGameInitParams));
      return;
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localCmGameLauncher != null)
        {
          ...
          ApolloGameMsgInfo localApolloGameMsgInfo2 = localCmGameLauncher.a();
          ApolloGameMsgInfo localApolloGameMsgInfo1;
          if ((localApolloGameMsgInfo2 != null) && (localApolloGameMsgInfo2.roomId != 0L))
          {
            localApolloGameMsgInfo1 = localApolloGameMsgInfo2;
            if (localApolloGameMsgInfo2.gameId != 0) {}
          }
          else
          {
            localApolloGameMsgInfo1 = this.jdField_a_of_type_ComTencentMobileqqApolloUtilsApolloGameInvitation.a(paramString);
          }
          if (localApolloGameMsgInfo1 != null)
          {
            this.jdField_a_of_type_ComTencentMobileqqApolloUtilsApolloGameInvitation.a(localApolloGameMsgInfo1);
    ...
    for (;;)
    {
      ...
      if (((CmGameLauncher.RedPacketInfo)localObject).jdField_b_of_type_Int == 0)
      {
        if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
          QWalletTools.a(CmGameUtil.a(), ((CmGameLauncher.RedPacketInfo)localObject).g + "", this.jdField_d_of_type_Int + "", i + "", new CmGameSubProcessHandler.4(this, null, paramLong));
        }
  ...
  private void j(String paramString)
  {
    ...
    try
    {
      localCmGameLauncher = CmGameUtil.a(this.jdField_d_of_type_Int);
      if (localCmGameLauncher == null) {
        return;
      }
      localApolloGameMsgInfo = localCmGameLauncher.a();
      paramString = new JSONObject(paramString);
    ...
    localApolloGameMsgInfo.gameExtendJson = paramString.optString("extendInfo");
    paramString = localCmGameLauncher.a();
    if (paramString != null)
    {
      paramString.mRoomId = l;
      localApolloGameMsgInfo.gameName = paramString.mChineseName;
      localApolloGameMsgInfo.actionId = paramString.mActionId;
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramString != null)
        {
          ...
          {
            QWalletTools.a(CmGameUtil.a(), paramString.g + "", this.jdField_d_of_type_Int + "", i + "", new CmGameSubProcessHandler.5(this, null, paramLong));
  ...
  private void l(long paramLong, String paramString)
  {
    ...
    if (paramString != null)
    {
      ...
      if (localObject != null)
      {
        ...
        paramString.a("login", null, new CmGameSubProcessHandler.11(this, (CmGameInitParams)localObject, paramLong));
      }
    }
    try
    {
  ...
  private void m(long paramLong, String paramString)
  {
    ...
    {
      CmGameUtil.a().callbackFromRequest(paramLong, 6, "cs.xy_device_vibrate.local", "{}");
      QLog.e("cmgame_process.CmGameSubProcessHandler", 1, paramString, new Object[0]);
    }
  }
  ...
  private void n(long paramLong, String paramString)
  {
    ...
    {
      CmGameUtil.a().callbackFromRequest(paramLong, 4, "cs.xy_device_gyro_sensor_start.local", "{}");
      QLog.e("cmgame_process.CmGameSubProcessHandler", 1, paramString, new Object[0]);
    }
  }
  ...
  public HandleResult a(long paramLong, String paramString1, String paramString2)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return null;
        } while ((localCmGameLauncher == null) || (localCmGameLauncher.a() == null));
      ...
      {
        ApolloGameBasicEventUtil.a(this.jdField_d_of_type_Int, paramString2, a());
        return null;
      }
  ...
  {
    paramString = CmGameADInfo.a(paramString);
    CmGameLauncher localCmGameLauncher = CmGameUtil.a(this.jdField_d_of_type_Int);
    if ((paramString == null) || (localCmGameLauncher == null))
    {
  ...
  public void a(long paramLong, String paramString, ApolloCmdChannelImpl.openApiHeadCallback paramopenApiHeadCallback)
  {
    if ((this.jdField_b_of_type_JavaUtilHashMap != null) && (this.jdField_b_of_type_JavaUtilHashMap.containsKey(paramString))) {
      paramopenApiHeadCallback.a((Bitmap)this.jdField_b_of_type_JavaUtilHashMap.get(paramString), 200);
    }
    for (;;)
    {
      return;
      ...
      {
        ThreadManagerV2.excute(new CmGameSubProcessHandler.10(this, ((CmGameUserInfo)this.jdField_a_of_type_JavaUtilHashMap.get(paramString)).jdField_a_of_type_JavaLangString, paramopenApiHeadCallback, paramString), 128, null, true);
        return;
      }
      paramopenApiHeadCallback = CmGameUtil.a();
      if (paramopenApiHeadCallback != null)
      {
        ...
        Object localObject2 = ((CmGameLauncher)localObject1).a();
        try
        {
          ...
          paramopenApiHeadCallback.a("ltgame_native_api.batch_get_user_info", ((JSONObject)localObject1).toString(), paramLong, jdField_a_of_type_Int);
          if (QLog.isColorLevel())
          {
  ...
  public void a(long paramLong, String paramString, ApolloCmdChannelImpl.openApiNickCallback paramopenApiNickCallback)
  {
    if ((this.jdField_a_of_type_JavaUtilHashMap != null) && (this.jdField_a_of_type_JavaUtilHashMap.containsKey(paramString))) {
      paramopenApiNickCallback.a(((CmGameUserInfo)this.jdField_a_of_type_JavaUtilHashMap.get(paramString)).jdField_b_of_type_JavaLangString);
    }
    for (;;)
    {
      return;
      paramopenApiNickCallback = CmGameUtil.a();
      if (paramopenApiNickCallback != null)
      {
        Object localObject1 = CmGameUtil.a(this.jdField_d_of_type_Int);
        if (localObject1 == null)
        {
        ...
        try
        {
          ...
          ((JSONArray)localObject2).put(paramString);
          ((JSONObject)localObject1).put("uidList", localObject2);
          paramopenApiNickCallback.a("ltgame_native_api.batch_get_user_info", ((JSONObject)localObject1).toString(), paramLong, jdField_b_of_type_Int);
          if (QLog.isColorLevel())
          {
  ...
  public void a(CmGameUserInfo paramCmGameUserInfo)
  {
    if (this.jdField_a_of_type_JavaUtilHashMap != null) {
      this.jdField_a_of_type_JavaUtilHashMap.put(paramCmGameUserInfo.c, paramCmGameUserInfo);
    }
  }
    ...
    for (;;)
    {
      ...
      catch (Throwable paramString)
      {
        try
        {
          ...
          ((IApolloCmdChannel)localObject).callbackFromRequest(paramLong, 0, "cs.fetch_cloud_signature.local", paramString);
          return;
        }
        catch (Throwable paramString)
        {
  ...
  public void b()
  {
    ...
    localCmGameLauncher.c();
  }
  
  public void b(long paramLong, String paramString)
  {
    int i = this.e;
    if (ApolloGameBasicEventUtil.a(a(), paramString, this.jdField_d_of_type_Int, i)) {}
    try
    {
      ...
      if (localIApolloCmdChannel != null)
      {
        localIApolloCmdChannel.callbackFromRequest(paramLong, 0, "cs.openWebViewWithoutUrl.local", paramString.toString());
        this.e += 1;
      }
      return;
    }
  ...
  public void c(long paramLong, String paramString)
  {
    ...
    {
      localObject1 = CmGameUtil.a(this.jdField_d_of_type_Int);
      if (localObject1 == null) {
        QLog.w("cmgame_process.CmGameSubProcessHandler", 1, "[getUserInfo], launcher is null, mGameId:" + this.jdField_d_of_type_Int);
      }
    }
    ...
    Object localObject1 = ((CmGameLauncher)localObject1).a();
    for (;;)
    {
      try
      {
        ...
        else
        {
          ...
          localCmGameSSoHandler.a("ltgame_native_api.batch_get_user_info", ((JSONObject)localObject2).toString(), paramLong, c, false, null);
          return;
        }
      }
      catch (Exception paramString)
