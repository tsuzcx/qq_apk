...
class GeneralEventHandler$1
  implements Runnable
{
  GeneralEventHandler$1(GeneralEventHandler paramGeneralEventHandler, String paramString) {}
  ...
  public void run()
  {
    try
    {
      ...
      CmGameSessionUtil.a((QQAppInterface)GeneralEventHandler.a(this.this$0).get(), str1, str2, i);
      return;
    }
