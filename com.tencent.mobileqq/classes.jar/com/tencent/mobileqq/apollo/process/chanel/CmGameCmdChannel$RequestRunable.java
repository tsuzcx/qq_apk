  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    synchronized (localCmGameCmdChannel.a)
    {
      ...
      {
        aije localaije = ((aioo)localIterator.next()).a(this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
        if (localaije != null)
        {
          ...
          if (localaije.b) {
            localCmGameCmdChannel.a(0, this.jdField_a_of_type_JavaLangString, localaije.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int);
          }
        }
      }
    }
