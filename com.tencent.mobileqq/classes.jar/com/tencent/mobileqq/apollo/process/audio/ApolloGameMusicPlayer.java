  ...
  implements ICmGameAudioPlayer
{
  ...
  private AudioManager.OnAudioFocusChangeListener jdField_a_of_type_AndroidMediaAudioManager$OnAudioFocusChangeListener = new ApolloGameMusicPlayer.2(this);
  ...
  public int a(IRenderRunner paramIRenderRunner, int paramInt1, int paramInt2, String paramString, long paramLong, int paramInt3, float paramFloat)
  {
    ...
    if ((this.b > 0) && ((this.jdField_a_of_type_Int == 0) || (localObject1 == null) || (!CmGameUtil.d()) || (paramIRenderRunner == null)))
    {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      for (localObject1 = null;; localObject1 = null)
      {
        ...
        if (paramString != null)
        {
          ...
          if (localObject1 != null) {
            ((IApolloCmdChannel)localObject1).playMusicInner(paramIRenderRunner, paramString.hashCode(), paramLong);
          }
          ...
          try
          {
            ...
            synchronized (this.jdField_a_of_type_JavaLangObject)
            {
              ...
              if (paramInt2 == 2147483647)
              {
                ...
                if (paramInt2 != 2147483647)
                {
                  paramString.setOnCompletionListener(new ApolloGameMusicPlayer.1(this, paramInt2, paramIRenderRunner, paramLong));
                  if (QLog.isColorLevel()) {
 ...
 * Qualified Name:     com.tencent.mobileqq.apollo.process.audio.ApolloGameMusicPlayer
