...
public class CmGameBannerAds
{
  ...
  private void a(long paramLong, int paramInt1, int paramInt2, int paramInt3)
  {
    try
    {
      ...
      CmGameUtil.a().callbackFromRequest(paramLong, paramInt2, "sc.game_ad_banner_load.local", localJSONObject.toString());
      return;
    }
 ...
 * Qualified Name:     com.tencent.mobileqq.apollo.process.ads.CmGameBannerAds
