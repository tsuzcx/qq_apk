  ...
  implements TipsBarTask
{
  ...
  public CmGameTipsBar(Context paramContext, View.OnClickListener paramOnClickListener)
  {
    ...
    paramContext = new RelativeLayout.LayoutParams(-1, AIOUtils.a(44.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()));
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(HardCodeUtil.a(2131702180));
    this.jdField_a_of_type_AndroidWidgetTextView.setCompoundDrawablePadding(AIOUtils.a(8.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()));
    paramOnClickListener = a(2130838637);
    ...
    paramContext = new RelativeLayout.LayoutParams(-2, AIOUtils.a(44.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()));
    paramContext.addRule(15);
    paramContext.leftMargin = AIOUtils.a(12.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
    ...
    localLayoutParams.rightMargin = AIOUtils.a(12.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
    paramContext = new StateListDrawable();
    Drawable localDrawable1 = a(2130838737);
    Drawable localDrawable2 = a(2130838738);
    ...
    localObject = new RelativeLayout.LayoutParams(-1, AIOUtils.a(44.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()));
    ...
    this.jdField_b_of_type_AndroidWidgetTextView.setText(HardCodeUtil.a(2131702181));
    this.jdField_b_of_type_AndroidWidgetTextView.setCompoundDrawablePadding(AIOUtils.a(8.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()));
    this.jdField_b_of_type_AndroidWidgetTextView.setCompoundDrawables(paramOnClickListener, null, null, null);
    paramOnClickListener = new RelativeLayout.LayoutParams(-2, AIOUtils.a(44.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()));
    paramOnClickListener.addRule(15);
    paramOnClickListener.leftMargin = AIOUtils.a(12.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
    ...
    ((RelativeLayout.LayoutParams)localObject).rightMargin = AIOUtils.a(12.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
