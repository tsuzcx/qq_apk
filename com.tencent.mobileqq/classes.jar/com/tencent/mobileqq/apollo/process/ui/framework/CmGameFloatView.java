  ...
  implements View.OnClickListener
{
  ...
  private bkzq jdField_a_of_type_Bkzq = new anai(this);
  ...
  {
    RelativeLayout localRelativeLayout = (RelativeLayout)LayoutInflater.from(paramContext).inflate(2131558939, null);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localRelativeLayout.findViewById(2131363954));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)localRelativeLayout.findViewById(2131363866));
    this.jdField_a_of_type_ComTencentMobileqqApolloViewFrameGifView = ((FrameGifView)localRelativeLayout.findViewById(2131364008));
    this.jdField_a_of_type_ComTencentMobileqqApolloViewFrameGifView.setPlayLoop(true);
    this.jdField_a_of_type_AndroidViewView = localRelativeLayout.findViewById(2131370135);
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)localRelativeLayout.findViewById(2131371564));
    this.jdField_a_of_type_ComTencentMobileqqApolloViewFrameGifView.setVisibility(8);
    this.jdField_a_of_type_AndroidViewView.setVisibility(8);
    this.jdField_a_of_type_AndroidWidgetImageView.setBackgroundResource(2130838571);
    if (c()) {
    ...
    localRelativeLayout = (RelativeLayout)((Activity)this.jdField_a_of_type_MqqUtilWeakReference.get()).findViewById(2131376956);
  ...
  public void a(boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    if ((paramBoolean) && (!TextUtils.isEmpty(paramString1)))
    {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setBackgroundResource(2130838570);
      if (!TextUtils.isEmpty(paramString2))
      {
        this.jdField_a_of_type_ComTencentMobileqqApolloViewFrameGifView.setGifData(100, null, paramString2, annt.a(paramString2), true);
    ...
    for (paramString1 = String.valueOf(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);; paramString1 = "")
    {
      ...
      {
        return;
        this.jdField_a_of_type_ComTencentMobileqqApolloViewFrameGifView.setImageResource(2130838572);
        break;
        this.jdField_a_of_type_ComTencentMobileqqApolloViewFrameGifView.setImageResource(2130838572);
        break;
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        case 2131363954: 
          if (this.jdField_a_of_type_Amyo != null)
          {
            if (!this.jdField_a_of_type_Amyo.c()) {
              break label185;
            }
    ...
    if (this.jdField_a_of_type_Bkzi == null) {
      if (a())
      {
        this.jdField_a_of_type_Bkzi = ((bkzi)bkzz.a(this.jdField_a_of_type_Amyo.a(), null));
        if (QLog.isColorLevel()) {
        ...
        localObject1 = anvx.a(2131701567);
        ...
        this.jdField_a_of_type_Bkzi.a((String)localObject1, 2130850427, 0);
        label343:
    ...
    for (int i = 1;; i = 0)
    {
      ...
      if (!this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.disableMinGame)
      {
        ...
        if ((j == 0) || (j == 1) || (j == 7))
        {
          this.jdField_a_of_type_Bkzi.a(2131690090, 0);
          label490:
      ...
      else
      {
        ...
        if (this.jdField_b_of_type_Boolean)
        {
          ...
          if (this.jdField_d_of_type_Boolean)
          {
            ...
            if (!this.jdField_a_of_type_Boolean)
            {
              ...
              this.jdField_a_of_type_Bkzi.c(anvx.a(2131701572));
        ...
        this.jdField_a_of_type_Bkzi.a(anvx.a(2131701569) + this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.game.name, 0);
        label690:
        localObject1 = this.jdField_a_of_type_AndroidUtilSparseIntArray;
        j = i + 1;
      ...
      do
      {
        do
        {
          ...
          break;
          this.jdField_a_of_type_Bkzi = ((bkzi)bkzz.b(this.jdField_a_of_type_Amyo.a(), null));
          break label234;
          this.jdField_a_of_type_Bkzi.a(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.pushItem.content, 0);
          break label343;
          i = 0;
          break label403;
          this.jdField_a_of_type_Bkzi.a(2131690091, 0);
          break label490;
          this.jdField_a_of_type_Bkzi.c(anvx.a(2131701571));
          break label550;
          this.jdField_a_of_type_Bkzi.a(2131690092, 0);
          break label690;
          bool = ((SharedPreferences)localObject1).getBoolean("game_debug_tool_switch", true);
          localObject1 = this.jdField_a_of_type_Bkzi;
          if (bool) {}
          for (i = 2131690088;; i = 2131690089)
          {
            ((bkzi)localObject1).a(i, 0);
            this.e = j;
      ...
      for (i = 2131690088;; i = 2131690089)
      {
        ((bkzi)localObject1).a(j, ((Resources)localObject2).getString(i));
        break;
      }
      ...
      if (!b())
      {
        ...
        {
          this.jdField_a_of_type_Bkys.sendEmptyMessageDelayed(102, 1000L);
          break label112;
        }
        this.jdField_a_of_type_Bkys.sendEmptyMessageDelayed(102, 5000L);
        QLog.i("cmframe_CmGameFloatView", 1, "comm flag bit0 is 1.");
        break label112;
      }
      this.jdField_a_of_type_Bkys.sendEmptyMessage(111);
      break label112;
      if (this.jdField_a_of_type_Boolean)
      {
        if (!amwn.e())
