  ...
  implements View.OnClickListener
{
  ...
  private void e()
  {
    ...
    if ((this.jdField_a_of_type_AndroidViewView != null) && ((this.jdField_a_of_type_AndroidViewView instanceof Button))) {
      this.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130842106);
    }
  }
  ...
  public void a(View paramView, View.OnClickListener paramOnClickListener)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.viewMode > 0) {
      if (localDisplayMetrics.heightPixels > localDisplayMetrics.widthPixels)
      {
        ...
        paramView.getViewTreeObserver().addOnGlobalLayoutListener(new ajeb(this, paramView, localDisplayMetrics));
      }
    }
    for (;;)
    {
      paramView = new ajec(this, localDisplayMetrics);
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        {
          ajac.a(ajac.a(), aiye.a(0, 0, 3, 901003004, this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId, this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.src));
          return;
        ...
        if (paramView == this.f)
        {
          ...
          {
            bcql.a(getContext(), 0, ajya.a(2131711911), 0).a();
            return;
          }
          if ((this.jdField_a_of_type_Ajcf != null) && (this.jdField_a_of_type_Ajcf.c()))
          {
            QLog.e("cmframe_QzoneGameFloatView", 1, "onClick mGameLauncher.isDisableMoreMenu():true");
            return;
          }
          if ((this.jdField_a_of_type_Ajcf != null) && (this.jdField_a_of_type_Ajcf.a()) && (this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null)) {
            try
            {
              ...
              this.jdField_a_of_type_Ajcf.b(paramView.toString());
              if (this.jdField_a_of_type_Aiym != null) {
              ...
              ajac.a(ajac.a(), aiye.a(0, 0, 3, 901003002, this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId, this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.src));
              return;
            }
        ...
        else
        {
          ...
          if ((this.jdField_a_of_type_Ajcf != null) && (this.jdField_a_of_type_Ajcf.a()))
          {
            ...
            if (this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null) {
              ajac.a(ajac.a(), aiye.a(0, 0, 3, 901003003, this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId, this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.src));
            }
          }
