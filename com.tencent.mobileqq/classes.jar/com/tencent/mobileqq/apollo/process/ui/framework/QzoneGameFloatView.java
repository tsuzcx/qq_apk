  ...
  implements View.OnClickListener
{
  ...
  public QzoneGameFloatView(Context paramContext, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    for (int j = 2131560085;; j = 2131560086)
    {
  ...
  private void e()
  {
    ...
    {
      ((TextView)this.f).setCompoundDrawablesWithIntrinsicBounds(0, 2130842823, 0, 0);
      ((TextView)this.f).setTextColor(getResources().getColor(2131167230));
    }
    if ((this.g != null) && ((this.g instanceof TextView)))
    {
      ((TextView)this.g).setCompoundDrawablesWithIntrinsicBounds(0, 2130842820, 0, 0);
      ((TextView)this.g).setTextColor(getResources().getColor(2131167230));
    }
    if ((this.e != null) && ((this.e instanceof TextView)))
    {
      ((TextView)this.e).setCompoundDrawablesWithIntrinsicBounds(0, 2130842814, 0, 0);
      ((TextView)this.e).setTextColor(getResources().getColor(2131167230));
    }
    if ((this.d != null) && ((this.d instanceof TextView)))
    {
      ((TextView)this.d).setCompoundDrawablesWithIntrinsicBounds(0, 2130842811, 0, 0);
      ((TextView)this.d).setTextColor(getResources().getColor(2131167230));
    }
    if ((this.jdField_a_of_type_AndroidViewView != null) && ((this.jdField_a_of_type_AndroidViewView instanceof Button))) {
      this.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130842816);
    }
  }
  ...
  public void a(View paramView, View.OnClickListener paramOnClickListener)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.viewMode > 0) {
      if (localDisplayMetrics.heightPixels > localDisplayMetrics.widthPixels)
      {
        ...
        this.jdField_c_of_type_AndroidViewView = paramView.findViewById(2131379381);
        ...
        paramView.getViewTreeObserver().addOnGlobalLayoutListener(new QzoneGameFloatView.2(this, paramView, localDisplayMetrics));
      }
    }
    for (;;)
    {
      paramView = new QzoneGameFloatView.3(this, localDisplayMetrics);
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        CmGameUtil.a(CmGameUtil.a(), ApolloGameTool.a(0, 0, 3, 901003004, this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId, this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.src));
        break;
      ...
      if (paramView == this.f)
      {
        if ((this.jdField_b_of_type_Boolean) && (!this.jdField_c_of_type_Boolean)) {
          QQToast.a(getContext(), 0, HardCodeUtil.a(2131711877), 0).a();
        } else if ((this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameLauncher != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameLauncher.c())) {
          QLog.e("cmframe_QzoneGameFloatView", 1, "onClick mGameLauncher.isDisableMoreMenu():true");
        } else if ((this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameLauncher != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameLauncher.a()) && (this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null)) {
          try
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameLauncher.b(localJSONObject.toString());
            if (this.jdField_a_of_type_ComTencentMobileqqApolloGameOnGameMenuListener != null) {
              this.jdField_a_of_type_ComTencentMobileqqApolloGameOnGameMenuListener.b();
            }
            if (this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam == null) {
              continue;
            }
            CmGameUtil.a(CmGameUtil.a(), ApolloGameTool.a(0, 0, 3, 901003002, this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId, this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.src));
          }
      ...
      {
        if ((this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameLauncher != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameLauncher.c()))
        {
          QLog.e("cmframe_QzoneGameFloatView", 1, "onClick mGameLauncher.isDisableMoreMenu():true");
        }
        else
        {
          if ((this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameLauncher != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameLauncher.a()))
          {
            ...
            if (this.jdField_a_of_type_ComTencentMobileqqApolloGameOnGameMenuListener != null) {
              this.jdField_a_of_type_ComTencentMobileqqApolloGameOnGameMenuListener.c();
            }
            if (this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null) {
              CmGameUtil.a(CmGameUtil.a(), ApolloGameTool.a(0, 0, 3, 901003003, this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId, this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.src));
            }
          }
          for (;;)
          {
