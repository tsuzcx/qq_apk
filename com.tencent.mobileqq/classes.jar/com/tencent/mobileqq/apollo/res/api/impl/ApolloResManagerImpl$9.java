...
class ApolloResManagerImpl$9
  implements Runnable
{
  ApolloResManagerImpl$9(ApolloResManagerImpl paramApolloResManagerImpl, boolean paramBoolean, int paramInt) {}
  
  public void run()
  {
    Object localObject1 = ApolloResManagerImpl.access$200(this.this$0);
    ...
    if (this.jdField_a_of_type_Boolean) {
      ...
      localObject1 = ((ApolloDaoManagerServiceImpl)localObject1).getNeedDownloadAction(this.jdField_a_of_type_Int);
    }
    if (localObject1 != null)
    {
      ...
      for (int i = 0; i < ((List)localObject1).size(); i = j)
      {
        ...
        {
          ApolloResManagerImpl localApolloResManagerImpl = this.this$0;
          StringBuilder localStringBuilder = new StringBuilder();
          localStringBuilder.append(this.jdField_a_of_type_Int);
          localStringBuilder.append("apollo_key");
          localStringBuilder.append(i);
          localApolloResManagerImpl.downloadResAndPanel((List)localObject2, localStringBuilder.toString());
 ...
 * Qualified Name:     com.tencent.mobileqq.apollo.res.api.impl.ApolloResManagerImpl.9
