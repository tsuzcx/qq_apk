...
class ApolloPanel$10
  implements Runnable
{
  ApolloPanel$10(ApolloPanel paramApolloPanel, List paramList) {}
  
  public void run()
  {
    if ((this.this$0.jdField_a_of_type_Anpo != null) && (this.this$0.jdField_a_of_type_AndroidWidgetLinearLayout != null) && (this.this$0.jdField_a_of_type_ComTencentWidgetHorizontalListView != null))
    {
      this.this$0.jdField_a_of_type_Anpo.a(this.a);
    ...
    for (;;)
    {
      ...
      this.this$0.jdField_a_of_type_Anpo.notifyDataSetChanged();
