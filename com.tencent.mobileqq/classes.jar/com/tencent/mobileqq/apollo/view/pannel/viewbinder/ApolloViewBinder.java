...
public class ApolloViewBinder
{
  ...
  {
    return this.jdField_a_of_type_ComTencentMobileqqApolloViewPannelApolloPanelListAdapter;
  }
  ...
  protected void c(View paramView)
  {
      ...
      do
      {
        do
        {
          ...
          if (this.jdField_a_of_type_ComTencentMobileqqApolloViewPannelApolloPanelListAdapter == null) {
            this.jdField_a_of_type_ComTencentMobileqqApolloViewPannelApolloPanelListAdapter = new ApolloPanelListAdapter(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext);
          }
          if (this.jdField_a_of_type_ComTencentWidgetAbsListView$OnScrollListener == null) {
            this.jdField_a_of_type_ComTencentWidgetAbsListView$OnScrollListener = new ApolloViewBinder.1(this);
          }
          this.jdField_a_of_type_ComTencentMobileqqApolloViewPannelApolloPanelListAdapter.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
          this.jdField_a_of_type_ComTencentMobileqqApolloViewPannelApolloPanelListAdapter.a(this.c);
          this.jdField_a_of_type_ComTencentMobileqqApolloViewPannelApolloPanelListAdapter.b(this.f);
          this.jdField_a_of_type_ComTencentMobileqqApolloViewPannelApolloPanelListAdapter.c(this.e);
          this.jdField_a_of_type_ComTencentMobileqqApolloViewPannelApolloPanelListAdapter.a(this.jdField_a_of_type_JavaUtilList);
        ...
        paramView.setAdapter(this.jdField_a_of_type_ComTencentMobileqqApolloViewPannelApolloPanelListAdapter);
      } while (this.e == -1);
      int j = this.e / this.f;
      i = j;
      if (this.e % this.f != 0) {
    ...
    } while (i >= this.jdField_a_of_type_ComTencentMobileqqApolloViewPannelApolloPanelListAdapter.getCount());
 ...
 * Qualified Name:     com.tencent.mobileqq.apollo.view.pannel.viewbinder.ApolloViewBinder
