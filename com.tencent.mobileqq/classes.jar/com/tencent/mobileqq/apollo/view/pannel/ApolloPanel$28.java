      ...
      for (;;)
      {
        try
        {
          ...
          if (localJSONObject != null)
          {
            ...
            if (localJSONObject != null)
            {
              amme localamme = (amme)this.this$0.a.app.getManager(QQManagerFactory.APOLLO_MANAGER);
              ApolloPanel.a(this.this$0, localamme.a(this.jdField_a_of_type_JavaLangString, (String)localObject, localJSONObject, bool2, 6));
