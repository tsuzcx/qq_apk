  ...
  extends LinearLayout
{
  ...
  public ApolloLinearLayout(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqVasVasExtensionObserver = new yuq(this);
  }
    ...
    while (i < paramInt2)
    {
      ...
      if (i == 0) {
        if (XPanelContainer.d > 0)
        {
          ...
          ((ApolloLinearLayout.ViewHolder)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localView.findViewById(2131363225));
          ((ApolloLinearLayout.ViewHolder)localObject1).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131363214));
          ((ApolloLinearLayout.ViewHolder)localObject1).jdField_c_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131363216));
          ((ApolloLinearLayout.ViewHolder)localObject1).e = ((ImageView)localView.findViewById(2131363213));
          ((ApolloLinearLayout.ViewHolder)localObject1).jdField_c_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localView.findViewById(2131363215));
          ...
          ((ApolloLinearLayout.ViewHolder)localObject1).jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131363223));
          ((ApolloLinearLayout.ViewHolder)localObject1).jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localView.findViewById(2131363217));
          ...
          ((ApolloLinearLayout.ViewHolder)localObject1).jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localView.findViewById(2131363219));
          ...
          ((ApolloLinearLayout.ViewHolder)localObject1).jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131363221));
      ...
      for (float f1 = 16.0F;; f1 = 10.0F)
      {
        ...
        ((ApolloLinearLayout.ViewHolder)localObject1).jdField_b_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131363220));
        ((ApolloLinearLayout.ViewHolder)localObject1).jdField_c_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131363224));
        ((ApolloLinearLayout.ViewHolder)localObject1).d = ((ImageView)localView.findViewById(2131363218));
            ...
            for (;;)
            {
              ...
              if ((((ApolloLinearLayout.ViewHolder)localObject).jdField_a_of_type_ComTencentMobileqqApolloViewApolloInfo != null) && (((ApolloLinearLayout.ViewHolder)localObject).jdField_a_of_type_ComTencentMobileqqApolloViewApolloInfo.jdField_a_of_type_ComTencentMobileqqDataApolloActionData != null) && (((ApolloLinearLayout.ViewHolder)localObject).jdField_a_of_type_ComTencentMobileqqApolloViewApolloInfo.jdField_a_of_type_ComTencentMobileqqDataApolloActionData.status != 0))
              {
                ...
                for (;;)
                {
                  ...
                  ImageView localImageView = (ImageView)paramView.findViewById(2131363170);
  ...
  public void a(ApolloActionData paramApolloActionData)
  {
    ...
    ThreadManager.post(new yup(this, paramApolloActionData), 5, null, false);
  }
  ...
  public boolean a(ApolloActionData paramApolloActionData)
  {
    ...
    if (((ApolloManager)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c()))
    {
      if (((ApolloManager)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c()) < paramApolloActionData.vipLevel)
      {
        ...
        localObject3 = super.getResources().getString(2131438196);
        localObject1 = super.getResources().getString(2131438190);
        localObject2 = super.getResources().getString(2131436118);
    ...
    else
    {
      ...
      {
        localObject4 = super.getResources().getString(2131438189);
        str2 = super.getResources().getString(2131438190);
        localObject5 = super.getResources().getString(2131438192);
      ...
      for (localObject3 = localObject4;; localObject3 = localObject4)
      {
        ...
        return false;
        localObject1 = super.getResources().getString(2131438195);
        localObject4 = super.getResources().getString(2131438190);
        str2 = super.getResources().getString(2131438192);
    ...
    do
    {
      do
      {
        do
        {
          ...
          {
            return true;
            if ((!this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Yur != null)) {
              super.removeCallbacks(this.jdField_a_of_type_Yur);
            }
          ...
          if (this.jdField_a_of_type_Yur == null) {
            this.jdField_a_of_type_Yur = new yur(this);
          }
          this.jdField_a_of_type_Yur.a();
          super.postDelayed(this.jdField_a_of_type_Yur, ViewConfiguration.getLongPressTimeout());
        ...
        paramMotionEvent.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130838113);
