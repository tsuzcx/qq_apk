  ...
  implements Handler.Callback
{
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        if ((!this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_ArrayOfJavaLangString != null) && (this.jdField_a_of_type_ArrayOfJavaLangString.length > 0))
        {
          ...
          new zgu(this, 0).execute(new Integer[] { Integer.valueOf(this.jdField_c_of_type_Int) });
        }
      }
      return;
    }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if ((this.jdField_c_of_type_Boolean) && (this.jdField_a_of_type_ArrayOfJavaLangString != null) && (this.jdField_c_of_type_Int >= this.jdField_a_of_type_ArrayOfJavaLangString.length)) {
      this.jdField_c_of_type_Int = 0;
    }
    if ((this.jdField_a_of_type_ArrayOfJavaLangString != null) && (this.jdField_a_of_type_ArrayOfJavaLangString.length > this.jdField_c_of_type_Int)) {
      new zgu(this, this.jdField_c_of_type_Int).execute(new Integer[] { Integer.valueOf(this.jdField_c_of_type_Int) });
    }
    for (;;)
    {
