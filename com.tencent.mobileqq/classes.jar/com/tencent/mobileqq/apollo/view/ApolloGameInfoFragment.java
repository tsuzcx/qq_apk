  ...
  implements FaceDecoder.DecodeTaskCompletionListener
{
  ...
  {
    paramView = (RelativeLayout)paramView.findViewById(2131363995);
    if (ImmersiveUtils.isSupporImmersive() == 1)
    {
      paramView.setFitsSystemWindows(true);
      paramView.setPadding(0, ImmersiveUtils.a(paramLayoutInflater.getContext()), 0, 0);
    }
    paramLayoutInflater = (NavBarCommon)paramView.findViewById(2131363226);
    ((TextView)paramLayoutInflater.findViewById(2131363227)).setText("返回");
    paramLayoutInflater.setOnItemSelectListener(new yug(this));
    ...
    paramLayoutInflater.setBackgroundResource(2130838555);
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.addView((View)localObject1, (ViewGroup.LayoutParams)localObject2);
    localObject2 = new yuh(this, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, "游戏开发者");
    ...
    ((yuh)localObject2).setId(this.e);
    ((yuh)localObject2).b("玩一玩");
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.addView((View)localObject2, (ViewGroup.LayoutParams)localObject3);
    this.jdField_a_of_type_Yuh = new yuh(this, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, "相关公众号");
    localObject3 = new RelativeLayout.LayoutParams(-1, -2);
    ((RelativeLayout.LayoutParams)localObject3).addRule(3, this.e);
    this.jdField_a_of_type_Yuh.setId(this.f);
    ((RelativeLayout.LayoutParams)localObject3).topMargin = -1;
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.addView(this.jdField_a_of_type_Yuh, (ViewGroup.LayoutParams)localObject3);
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqDataApolloGameData != null) {
      try
      {
        ...
        paramView.mLoadingDrawable = ((Resources)localObject3).getDrawable(2130838065);
        paramView.mFailedDrawable = ((Resources)localObject3).getDrawable(2130838065);
        ...
        ((yuh)localObject2).b(this.jdField_a_of_type_ComTencentMobileqqDataApolloGameData.developerName);
        ...
        {
          this.jdField_a_of_type_Yuh.setVisibility(8);
          return;
        }
      }
      catch (Exception paramView)
      {
        for (;;)
        {
          paramLayoutInflater.setImageResource(2130838065);
          QLog.e("apollo_cmGame_ApolloGameInfoFragment", 1, paramView, new Object[0]);
        }
        this.jdField_a_of_type_Yuh.a(paramView, this.jdField_a_of_type_ComTencentMobileqqDataApolloGameData.officialAccountUin);
        return;
      }
    }
  ...
  {
    if ((!TextUtils.isEmpty(paramString)) && (!"0".equals(paramString)) && (paramString.equals(this.jdField_a_of_type_ComTencentMobileqqDataApolloGameData.officialAccountUin)) && (paramBitmap != null) && (this.jdField_a_of_type_Yuh != null)) {
      this.jdField_a_of_type_Yuh.a(paramBitmap, this.jdField_a_of_type_ComTencentMobileqqDataApolloGameData.officialAccountUin);
    }
  }
