...
public class ChatApolloViewListener$1
  implements Runnable
{
  public ChatApolloViewListener$1(aljb paramaljb) {}
  ...
  public void run()
  {
    ...
    if ((localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (localBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo != null)) {
      ((akwq)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(249)).a(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, localBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int);
    }
    algf.b("TraceReport_initApolloSurfaceView_PreLoadJS");
  }
}
