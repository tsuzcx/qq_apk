...
public class EglHelper
{
  ...
  public static void a(String paramString, int paramInt)
  {
    ...
    throw new EglHelper.EGLException(paramString);
  }
  ...
  private void d()
  {
    if ((this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLSurface != null) && (this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLSurface != EGL10.EGL_NO_SURFACE))
    {
      ...
      if (localGLRenderView != null) {
        localGLRenderView.getEGLWindowSurfaceFactory().a(this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGL10, this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLDisplay, this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLSurface);
      }
  ...
  GL a()
  {
    ...
    label116:
    for (localObject = new LogWriter();; localObject = null)
    {
  ...
  public void a()
  {
    ...
    for (this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLContext = null;; this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLContext = ((GLRenderView)localObject).getEGLContextFactory().a(this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGL10, this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLDisplay, this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLConfig))
    {
  ...
  public boolean a()
  {
    ...
    GLRenderView localGLRenderView = (GLRenderView)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if (localGLRenderView != null) {}
    for (this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLSurface = localGLRenderView.getEGLWindowSurfaceFactory().a(this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGL10, this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLDisplay, this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLConfig, localGLRenderView.getNativeWindow()); (this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLSurface == null) || (this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLSurface == EGL10.EGL_NO_SURFACE); this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLSurface = null)
    {
      int i = this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGL10.eglGetError();
      Log.e("EglHelper", "createWindowSurface returned error:" + a(i));
      return false;
    }
  ...
  public void c()
  {
    if (this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLContext != null)
    {
      GLRenderView localGLRenderView = (GLRenderView)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localGLRenderView != null) {
        localGLRenderView.getEGLContextFactory().a(this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGL10, this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLDisplay, this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLContext);
      }
      this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLContext = null;
    }
    if (this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLDisplay != null)
