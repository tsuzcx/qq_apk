      ...
      for (;;)
      {
        ...
        if (n < this.jdField_a_of_type_Int)
        {
          ...
          if (i1 < this.jdField_a_of_type_JavaUtilList.size())
          {
            ...
            localViewHolder.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130838138);
            ...
            if (!TextUtils.isEmpty(localViewHolder.jdField_a_of_type_ComTencentMobileqqApolloViewApolloInfo.b)) {
              if (XPanelContainer.d == 0)
              {
                ...
                ((ImageView)localObject2).postDelayed(new ywe(this, (ImageView)localObject2, localRelativeLayout, (RelativeLayout)localObject1, localViewHolder), 200L);
                this.f = -1;
                label980:
