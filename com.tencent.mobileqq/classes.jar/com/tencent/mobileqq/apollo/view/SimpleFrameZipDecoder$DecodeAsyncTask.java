  ...
  extends AsyncTask<Integer, Void, Bitmap>
{
  ...
  protected Bitmap a(Integer... paramVarArgs)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 22	com/tencent/mobileqq/apollo/view/SimpleFrameZipDecoder$DecodeAsyncTask:a	Ljava/lang/ref/WeakReference;
    //   4: invokevirtual 34	java/lang/ref/WeakReference:get	()Ljava/lang/Object;
    //   7: checkcast 36	com/tencent/mobileqq/apollo/view/SimpleFrameZipDecoder
    //   10: astore_2
    //   11: aconst_null
    //   12: astore 4
    //   14: aconst_null
    ...
    //   38: arraylength
    //   39: ifle +302 -> 341
    //   42: invokestatic 42	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   45: ifeq +36 -> 81
    ...
    //   65: iconst_0
    //   66: aaload
    //   67: invokevirtual 54	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   70: pop
    //   71: ldc 56
    //   73: iconst_2
    //   74: aload_3
    //   75: invokevirtual 60	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   78: invokestatic 64	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    ...
    //   89: aload_3
    //   90: aload_2
    //   91: getfield 68	com/tencent/mobileqq/apollo/view/SimpleFrameZipDecoder:f	Ljava/lang/String;
    ...
    //   100: iconst_0
    //   101: aaload
    //   102: invokevirtual 54	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   105: pop
    //   106: new 70	java/io/BufferedInputStream
    //   109: dup
    //   110: new 72	java/io/FileInputStream
    //   113: dup
    //   114: aload_3
    //   115: invokevirtual 60	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   118: invokespecial 75	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   121: invokespecial 78	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   124: astore_2
    //   125: aload_2
    //   126: astore_1
    //   127: aload_2
    //   128: invokestatic 84	android/graphics/BitmapFactory:decodeStream	(Ljava/io/InputStream;)Landroid/graphics/Bitmap;
    //   131: astore 4
    //   133: aload 4
    //   135: astore_3
    //   136: aload_2
    //   137: ifnull +204 -> 341
    //   140: aload_2
    //   141: invokevirtual 87	java/io/BufferedInputStream:close	()V
    //   144: aload 4
    //   146: areturn
    //   147: astore_2
    ...
    //   163: aload_1
    //   164: aload_2
    //   165: invokevirtual 92	java/lang/Throwable:getMessage	()Ljava/lang/String;
    ...
    //   179: invokestatic 95	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   182: aload 4
    //   184: areturn
    //   185: astore_3
    //   186: goto +17 -> 203
    ...
    //   207: iconst_1
    //   208: aload_3
    //   209: invokevirtual 92	java/lang/Throwable:getMessage	()Ljava/lang/String;
    //   212: invokestatic 95	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   215: aload 6
    //   217: astore_3
    //   218: aload_2
    //   219: ifnull +122 -> 341
    //   222: aload_2
    //   223: invokevirtual 87	java/io/BufferedInputStream:close	()V
    //   226: aconst_null
    //   227: areturn
    //   228: astore_2
    //   229: new 44	java/lang/StringBuilder
    //   232: dup
    //   233: invokespecial 45	java/lang/StringBuilder:<init>	()V
    //   236: astore_1
    //   237: aload 5
    //   239: astore 4
    //   241: goto -85 -> 156
    ...
    //   251: iconst_1
    //   252: aload_3
    //   253: invokevirtual 96	java/lang/OutOfMemoryError:getMessage	()Ljava/lang/String;
    //   256: invokestatic 95	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   259: aload 6
    //   261: astore_3
    //   262: aload_2
    //   263: ifnull +78 -> 341
    //   266: aload_2
    //   267: invokevirtual 87	java/io/BufferedInputStream:close	()V
    //   270: aconst_null
    //   271: areturn
    //   272: astore_2
    ...
    //   294: ifnull +45 -> 339
    //   297: aload_2
    //   298: invokevirtual 87	java/io/BufferedInputStream:close	()V
    //   301: goto +38 -> 339
    //   304: astore_2
    //   305: new 44	java/lang/StringBuilder
    //   308: dup
    //   309: invokespecial 45	java/lang/StringBuilder:<init>	()V
    //   312: astore_3
    //   313: aload_3
    //   314: ldc 89
    ...
    //   320: aload_3
    //   321: aload_2
    //   322: invokevirtual 92	java/lang/Throwable:getMessage	()Ljava/lang/String;
    ...
    //   336: invokestatic 95	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   339: aload_1
    //   340: athrow
    //   341: aload_3
    //   342: areturn
  ...
  protected void a(Bitmap paramBitmap)
  {
    ...
    SimpleFrameZipDecoder localSimpleFrameZipDecoder = (SimpleFrameZipDecoder)this.a.get();
    if ((localSimpleFrameZipDecoder != null) && (paramBitmap != null) && (!paramBitmap.isRecycled())) {
      localSimpleFrameZipDecoder.a(paramBitmap, this.b);
    }
  }
}
