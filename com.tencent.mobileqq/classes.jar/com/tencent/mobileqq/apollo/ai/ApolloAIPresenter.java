  ...
  implements IApolloAIListener, QQRecorder.OnQQRecorderListener
{
  ...
  private TransProcessorHandler jdField_a_of_type_ComTencentMobileqqTransfileTransProcessorHandler = new ylh(this, ThreadManager.getSubThreadLooper());
  private QQRecorder jdField_a_of_type_ComTencentMobileqqUtilsQQRecorder;
  VasExtensionObserver jdField_a_of_type_ComTencentMobileqqVasVasExtensionObserver = new ylg(this);
