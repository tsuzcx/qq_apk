  ...
  implements Handler.Callback
{
  ...
  public ApolloRecorderView(Context paramContext, ApolloRecorderView.OnRecordViewTouchListener paramOnRecordViewTouchListener)
  {
    ...
    setState(0);
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = super.getResources().getDrawable(2130838012);
  ...
  public void setState(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      super.setImageDrawable(null);
      continue;
      Drawable localDrawable = super.getResources().getDrawable(2130837973);
