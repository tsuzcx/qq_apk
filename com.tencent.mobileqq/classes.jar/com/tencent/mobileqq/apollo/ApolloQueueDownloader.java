...
public class ApolloQueueDownloader
  implements INetInfoHandler, DownloaderInterface
{
  ...
  public ApolloQueueDownloader(AppRuntime paramAppRuntime, DownloaderFactory.DownloadConfig paramDownloadConfig)
  {
    ...
    try
    {
      if (!this.jdField_a_of_type_JavaUtilLinkedList.isEmpty())
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          {
            if (QLog.isColorLevel()) {
              QLog.d("ApolloQueue_Downloader", 2, "getTask | " + paramString + " task find =" + localDownloadTask);
            }
            return localDownloadTask;
          }
        }
  ...
  void a()
  {
    for (;;)
    {
      try
      {
        synchronized (this.jdField_a_of_type_JavaUtilLinkedList)
        {
          ...
          if ((!localDownloadTask2.a()) && (l > localDownloadTask2.c + localDownloadTask2.d))
          {
            ...
            QLog.d("ApolloQueue_Downloader", 2, "remove task[" + localDownloadTask2.jdField_a_of_type_JavaLangString + "], isCancal=" + localDownloadTask2.b() + ", timeOut=" + bool);
          }
        }
        bool = false;
      }
      ...
      for (;;)
      {
        ...
        return;
        label288:
        ThreadManager.postDownLoadTask(new ApolloQueueDownloader.1(this, localDownloadTask1), 2, null, false);
  ...
  public void a(DownloadTask paramDownloadTask)
  {
    ...
    try
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("ApolloQueue_Downloader", 2, "removeTask | task=" + paramDownloadTask);
        }
        paramDownloadTask.j();
      ...
      synchronized (this.jdField_a_of_type_JavaUtilLinkedList)
      {
        ...
        if (paramBundle == null)
        {
          ...
          if (paramDownloadTask.b)
          {
            ...
            ??? = null;
            if (QLog.isColorLevel()) {
              QLog.d("ApolloQueue_Downloader", 2, new Object[] { "startDownload | task=" + paramDownloadTask.jdField_a_of_type_JavaLangString, ", url:", ??? });
            }
            a();
            return;
          }
 ...
 * Qualified Name:     com.tencent.mobileqq.apollo.ApolloQueueDownloader
