...
{
  SpriteAioScript$1(SpriteAioScript paramSpriteAioScript, String paramString, IApolloRenderView paramIApolloRenderView, int paramInt, boolean paramBoolean) {}
  ...
  public void run()
  {
    ...
    if ((this.jdField_a_of_type_JavaLangString.startsWith("initDrawerInfoSprite")) || (this.jdField_a_of_type_JavaLangString.startsWith("initSprite"))) {
      TraceReportUtil.a(this.this$0.a.d(), 350, 0, new Object[] { "enter exeInitSprite" });
    }
