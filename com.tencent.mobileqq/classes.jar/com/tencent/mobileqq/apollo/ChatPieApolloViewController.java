...
import com.tencent.mobileqq.activity.aio.helper.ShortcutBarAIOHelper.OnVisibilityChangedListener;
...
public class ChatPieApolloViewController
  implements ShortcutBarAIOHelper.OnVisibilityChangedListener
{
  private static boolean jdField_c_of_type_Boolean = true;
  private int jdField_a_of_type_Int;
  ApolloRender jdField_a_of_type_ComTencentMobileqqApolloApolloRender;
  private ApolloSurfaceView jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView;
  public ApolloTextureView a;
  IApolloSoLoader.OnCmSoLoadCompleteCallback jdField_a_of_type_ComTencentMobileqqApolloApiResIApolloSoLoader$OnCmSoLoadCompleteCallback = new ChatPieApolloViewController.1(this);
  ...
  private void d()
  {
    ...
    {
      String str = ApolloClientUtil.a(new File(ApolloConstant.I + "cm3d.js"));
      if (!TextUtils.isEmpty(str)) {
        localApolloRender.queueRenderTask(new ChatPieApolloViewController.3(this, localApolloRender, str));
      }
      if (!TextUtils.isEmpty(ApolloManagerServiceImpl.sBasicScript)) {
  ...
  private void g(BaseChatPie paramBaseChatPie)
  {
    ...
    ThreadManager.getFileThreadHandler().post(new ChatPieApolloViewController.8(this, paramBaseChatPie, str, localApolloManagerServiceImpl, localQQAppInterface));
  }
  ...
  public void a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (j != 0) {}
      for (paramInt = 2131377560;; paramInt = 2131369142)
      {
        b(paramInt);
        d(i);
        return;
  ...
  public void a(int paramInt, BaseChatPie paramBaseChatPie)
  {
    int i;
    int j;
    if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null)
    ...
    do
    {
      for (;;)
      {
        if (this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView != null)
        {
          ...
          if (((i <= 0) || (i - j >= paramInt)) && (!paramBaseChatPie.y())) {
            break;
          }
          QLog.i("sava_ChatPieApolloViewController", 1, "checkApolloViewLayout invisible apolloBottom:" + i + ",apolloTop:" + j + ",titleHeight:" + paramInt);
  ...
  public void a(BaseChatPie paramBaseChatPie)
  {
    ...
    label179:
    if (!((IApolloManagerService)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getRuntimeService(IApolloManagerService.class, "all")).isApolloFuncOpen(BaseApplicationImpl.getContext()))
    {
      QLog.d("sava_ChatPieApolloViewController", 1, "Not in white list.");
      return;
    }
    SelfGagInfo localSelfGagInfo = ((TroopGagMgr)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.TROOP_GAG_MANAGER)).a(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, true);
    if ((localSelfGagInfo != null) && (localSelfGagInfo.jdField_a_of_type_Boolean))
    {
  ...
  public boolean a(BaseChatPie paramBaseChatPie)
  {
    ...
    Object localObject = (SpriteScriptManagerImpl)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getRuntimeService(ISpriteScriptManager.class, "all");
    ((SpriteScriptManagerImpl)localObject).setPie(paramBaseChatPie);
    boolean bool = ((SpriteScriptManagerImpl)localObject).getSpriteContext().d();
    if ((!((IApolloManagerService)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getRuntimeService(IApolloManagerService.class, "all")).isApolloFuncOpen(BaseApplicationImpl.getContext())) && (!bool))
    {
      if (QLog.isColorLevel()) {
    ...
    localObject = ((SpriteScriptManagerImpl)localObject).getUIHandler();
    if (localObject != null) {
      ((ISpriteUIHandler)localObject).a(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView, paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioChatAdapter1);
    }
    if ((((IApolloActionHelper)QRoute.api(IApolloActionHelper.class)).getApolloFuncSwitch(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) != 1) && (!bool))
    {
      if (QLog.isColorLevel()) {
  ...
  public void b(BaseChatPie paramBaseChatPie)
  {
    ...
    do
    {
      ...
      TraceReportUtil.a(j, 10, 106, new Object[] { "aio is finished" });
    ...
    if (paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      ((IApolloPushManager)localObject1).setActionPushListener(new ChatPieApolloViewController.5(this, paramBaseChatPie, (IApolloPushManager)localObject1));
    }
    if ((this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null) || (this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView != null))
    {
    ...
    ApolloManagerServiceImpl localApolloManagerServiceImpl = (ApolloManagerServiceImpl)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getRuntimeService(IApolloManagerService.class, "all");
    boolean bool1;
    if ((Build.VERSION.SDK_INT >= 26) || (localApolloManagerServiceImpl.isUseTextureViewConfig()))
    {
      bool1 = true;
      label171:
      if (QLog.isColorLevel()) {
      ...
      label228:
      TraceReportUtil.a(j, 10, 0, new Object[] { "cmshow switch done" });
      TraceReportUtil.a(j, 100);
      TraceReportUtil.a(j, 101);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.init(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqApolloViewChatApolloViewListener, 0, this.jdField_a_of_type_ComTencentMobileqqApolloApolloRender);
        this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.setDispatchEvent2Native(true);
        this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.setDumplicateCreateRenderThread(localApolloManagerServiceImpl.isDisableCreateRenderThread());
        this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.getRender().setUseGlobalTimer(true);
        if (paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
          ((SpriteScriptManagerImpl)localObject1).setRenderView(this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView);
        }
        this.jdField_a_of_type_ComTencentMobileqqApolloApolloRender = null;
        if (ApolloConfigUtils.jdField_b_of_type_Boolean) {
          break label876;
        }
        bool2 = true;
        ...
        CmShowStatUtil.a("preLoadEngine");
        ...
        ThreadManager.postImmediately(new ChatPieApolloViewController.6(this, j, paramBaseChatPie, (SpriteScriptManagerImpl)localObject1), null, false);
        ...
        localObject2 = (ShortcutBarAIOHelper)paramBaseChatPie.a(52);
        if (localObject2 != null) {
          ((ShortcutBarAIOHelper)localObject2).a(this);
        }
        if ((localObject2 == null) || (!((ShortcutBarAIOHelper)localObject2).b())) {
          break label918;
        }
        ...
        ((RelativeLayout.LayoutParams)localObject1).addRule(6, 2131370460);
        if (i == 0) {
          break label957;
        }
        ((RelativeLayout.LayoutParams)localObject1).addRule(2, 2131377560);
        ...
        localObject2 = new RelativeLayout.LayoutParams(-1, (int)((float)DeviceInfoUtil.j() * 0.171F));
        if (i == 0) {
          break label968;
        }
        ((RelativeLayout.LayoutParams)localObject2).addRule(2, 2131377560);
        ...
        if ((paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null) || (localApolloManagerServiceImpl == null)) {
          break;
        }
        localApolloManagerServiceImpl.doAfterOpenAIO(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramBaseChatPie.jdField_a_of_type_AndroidContentContext);
        return;
      }
      ...
      this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView.init(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqApolloViewChatApolloViewListener, 0, this.jdField_a_of_type_ComTencentMobileqqApolloApolloRender);
      if (paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
        ((SpriteScriptManagerImpl)localObject1).setRenderView(this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView);
      }
      ...
      continue;
      label882:
      ThreadManager.excute(new ChatPieApolloViewController.7(this, paramBaseChatPie, (SpriteScriptManagerImpl)localObject1), 16, null, false);
      continue;
      label903:
      ...
      continue;
      label923:
      this.jdField_c_of_type_Int = AIOUtils.a(5.0F, paramBaseChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx.getResources());
      if (i == 0)
      {
  ...
  public void c(BaseChatPie paramBaseChatPie)
  {
    ...
    if (paramBaseChatPie == null) {}
    while ((!((ApolloManagerServiceImpl)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getRuntimeService(IApolloManagerService.class, "all")).isApolloBackgroundActionSwitchOpen()) || (this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView != null)) {
      return;
    }
    ...
    Object localObject1 = (ShortcutBarAIOHelper)paramBaseChatPie.a(52);
    int i;
    if ((localObject1 != null) && (((ShortcutBarAIOHelper)localObject1).b()))
    {
      i = 1;
      if (paramBaseChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx != null)
      {
      ...
      localLayoutParams.addRule(2, 2131377560);
    }
    for (;;)
    {
      ...
      localObject1 = new ApolloBackgroundViewListener(paramBaseChatPie);
      this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.init((OnApolloViewListener)localObject1);
      if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getRender() != null) {
        this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getRender().setRenderCallback((IRenderCallback)localObject1);
      }
      Object localObject2 = (SpriteScriptManagerImpl)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getRuntimeService(ISpriteScriptManager.class, "all");
      ((SpriteScriptManagerImpl)localObject2).setBackgroundManager(this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView);
      localObject2 = ((SpriteScriptManagerImpl)localObject2).getSpriteBackgroundManager();
      if (localObject2 != null) {
        ((ApolloBackgroundViewListener)localObject1).a((IRenderCallback)localObject2);
      }
  ...
  public void d(BaseChatPie paramBaseChatPie)
  {
    ...
    ((ApolloManagerServiceImpl)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getRuntimeService(IApolloManagerService.class, "all")).setApolloGameChatPie(new WeakReference(paramBaseChatPie));
    if (a()) {
  ...
  public void f(BaseChatPie paramBaseChatPie)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ((SpriteScriptManagerImpl)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getRuntimeService(ISpriteScriptManager.class, "all")).onDestroy();
        if (a()) {
          break label273;
        }
      ...
      localObject = (ApolloGameManager)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.APOLLO_GAME_MANAGER);
      if (localObject != null) {
      ...
      paramBaseChatPie = (ShortcutBarAIOHelper)paramBaseChatPie.a(52);
