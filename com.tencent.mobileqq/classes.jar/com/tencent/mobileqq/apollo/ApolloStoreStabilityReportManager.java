...
{
  private static ApolloStoreStabilityReportManager jdField_a_of_type_ComTencentMobileqqApolloApolloStoreStabilityReportManager = null;
  ...
  public static ApolloStoreStabilityReportManager a()
  {
    try
    {
      if (jdField_a_of_type_ComTencentMobileqqApolloApolloStoreStabilityReportManager == null) {
        jdField_a_of_type_ComTencentMobileqqApolloApolloStoreStabilityReportManager = new ApolloStoreStabilityReportManager();
      }
      ApolloStoreStabilityReportManager localApolloStoreStabilityReportManager = jdField_a_of_type_ComTencentMobileqqApolloApolloStoreStabilityReportManager;
    ...
    for (int i = 1;; i = 0)
    {
      ...
      for (;;)
      {
        ...
        if (i != 0)
        {
          ...
          TraceReportUtil.a(40, 1, j, new Object[] { paramString });
  ...
  public boolean b(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      localHashSet = ApolloConfigDataReport.b();
      if (localHashSet != null)
      {
 ...
 * Qualified Name:     com.tencent.mobileqq.apollo.ApolloStoreStabilityReportManager
