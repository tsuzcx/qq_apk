  ...
  implements Handler.Callback, IRenderCommInterface, ISetActionInterface
{
  ...
  ITriggerRenderCallback jdField_a_of_type_ComTencentMobileqqApolloITriggerRenderCallback;
  WeakReferenceHandler jdField_a_of_type_ComTencentUtilWeakReferenceHandler;
  private WeakReference<ApolloRenderDriver.GameStatListener> jdField_a_of_type_JavaLangRefWeakReference;
  ...
  public int a(int paramInt1, String paramString, int paramInt2, float paramFloat1, float paramFloat2, float paramFloat3)
  {
    ...
    paramString = ApolloActionHelperImpl.getRoleLuaString(str, paramInt2, paramFloat1, paramFloat2, paramFloat3);
    if (TextUtils.isEmpty(paramString)) {
      return 1;
    }
  ...
  public int a(int paramInt1, String paramString1, int paramInt2, int paramInt3, String paramString2, String paramString3)
  {
    ...
    paramString1 = ApolloActionHelperImpl.getActionLuaString(str, paramInt2, paramInt3, paramString2, paramString3);
  ...
  public int a(int paramInt, String paramString, int[] paramArrayOfInt, OnDressDoneListener paramOnDressDoneListener)
  {
    ...
    do
    {
      ...
      paramString = ApolloActionHelperImpl.getDressLuaString(str, paramArrayOfInt);
  ...
  public void a(int paramInt, String paramString1, String paramString2)
  {
    ...
    a(new ApolloRenderDriver.RenderThreadRunnable(this, ApolloActionHelperImpl.getRemoveBubbleLuaString(str, paramString2), this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock, this.jdField_a_of_type_ComTencentMobileqqApolloApolloEngine));
  }
  ...
  public void a(ApolloRenderDriver.GameStatListener paramGameStatListener)
  {
    if (paramGameStatListener == null) {
      return;
    }
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramGameStatListener);
  }
  
  public void a(IApolloRunnableTask paramIApolloRunnableTask)
  {
    if ((paramIApolloRunnableTask == null) || (this.jdField_a_of_type_ComTencentMobileqqApolloITriggerRenderCallback == null)) {}
    do
    {
      return;
      if ((this.jdField_a_of_type_ComTencentMobileqqApolloITriggerRenderCallback instanceof ApolloSurfaceView))
      {
        ((ApolloSurfaceView)this.jdField_a_of_type_ComTencentMobileqqApolloITriggerRenderCallback).runRenderTask(paramIApolloRunnableTask);
        return;
      }
    } while (!(this.jdField_a_of_type_ComTencentMobileqqApolloITriggerRenderCallback instanceof ApolloTextureView));
    ((ApolloTextureView)this.jdField_a_of_type_ComTencentMobileqqApolloITriggerRenderCallback).queueEvent(paramIApolloRunnableTask);
  }
  ...
  public int b(int paramInt1, String paramString1, int paramInt2, int paramInt3, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      ...
      if ((1 == paramInt1) && (localObject1 != null))
      {
        ...
        {
          paramString2 = HardCodeUtil.a(2131700595);
          if ((localObject2 != null) && (((ApolloManagerServiceImpl)localObject2).getAVIPStatus(paramString3))) {
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          if (TextUtils.isEmpty(paramString1)) {
            paramString3 = ApolloUtilImpl.getApolloId(paramInt2);
          }
          paramString1 = ApolloActionHelperImpl.getBubbleLuaString(paramString3, paramInt1, paramInt3, paramString2);
          if (TextUtils.isEmpty(paramString1))
          {
            if (QLog.isColorLevel()) {
              QLog.d("ApolloRenderDriver", 2, "errInfo->luaParam is NULL.");
  ...
  public void c(String paramString)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      a(new ApolloRenderDriver.10(this, paramString));
    }
  }
