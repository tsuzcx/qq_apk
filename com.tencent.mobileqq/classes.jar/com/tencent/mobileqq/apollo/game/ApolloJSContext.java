...
public class ApolloJSContext
{
  ...
  public void a()
  {
    ...
    IApolloGameInterface localIApolloGameInterface = this.jdField_a_of_type_ComTencentMobileqqApolloGameIApolloGameInterface;
    if ((localIApolloGameInterface != null) && ((localIApolloGameInterface instanceof ApolloGameInterfaceProxy))) {
      ((ApolloGameInterfaceProxy)localIApolloGameInterface).a();
    }
  ...
  public void a(int paramInt, String paramString1, String paramString2)
  {
    if (ApolloGameTool.a(this.jdField_a_of_type_JavaLangString))
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        localStringBuilder.append("[notifyJSEVent] ");
        localStringBuilder.append(paramString1);
        localStringBuilder.append(" ");
        localStringBuilder.append(paramString2);
        QLog.d("[cmshow]ApolloJSContext", 1, localStringBuilder.toString());
      }
      a(String.format("if(window.__dispatchEvent){window.__dispatchEvent(%s,'%s','%s')}", new Object[] { Integer.valueOf(paramInt), paramString1, paramString2 }), new ApolloJSContext.3(this));
      return;
    }
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append("[notifyJSEVent] game not running ");
    localStringBuilder.append(paramString1);
    localStringBuilder.append(" ");
    localStringBuilder.append(paramString2);
    QLog.e("[cmshow]ApolloJSContext", 1, localStringBuilder.toString());
  }
  
  public void a(CustomWebView paramCustomWebView)
  {
    if ((paramCustomWebView != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloGameIApolloGameInterface != null))
    {
      if (QLog.isColorLevel()) {
        QLog.d("[cmshow]ApolloJSContext", 2, "register success");
      }
      this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView = paramCustomWebView;
      if (Build.VERSION.SDK_INT > 17)
      {
        paramCustomWebView.addJavascriptInterface(this.jdField_a_of_type_ComTencentMobileqqApolloGameIApolloGameInterface, "__browserMsg");
        return;
      }
    ...
    QLog.e("[cmshow]ApolloJSContext", 1, "[registeJSContext] failed");
  }
  ...
  public void a(String paramString1, String paramString2)
  {
    IApolloGameInterface localIApolloGameInterface = this.jdField_a_of_type_ComTencentMobileqqApolloGameIApolloGameInterface;
    if ((localIApolloGameInterface != null) && ((localIApolloGameInterface instanceof ApolloGameInterfaceProxy))) {
      ((ApolloGameInterfaceProxy)localIApolloGameInterface).send(paramString2, paramString1);
    }
  }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    QLog.e("[cmshow]ApolloJSContext", 1, "[onLoadFinish] interface null ");
  }
}
