...
public class CmGameBannerAds
{
  private int a;
  
  public CmGameBannerAds(int paramInt)
  {
    this.a = paramInt;
  }
  ...
  private void a(long paramLong, int paramInt1, int paramInt2, int paramInt3)
  {
    try
    {
      ...
      ApolloCmdChannel.getInstance().callbackFromRequest(paramLong, paramInt2, "sc.game_ad_banner_load.local", localJSONObject.toString());
      return;
    }
 ...
 * Qualified Name:     com.tencent.mobileqq.apollo.game.process.ads.CmGameBannerAds
