  ...
  extends ApolloFragment
{
  ...
  View.OnLayoutChangeListener jdField_a_of_type_AndroidViewView$OnLayoutChangeListener = new ailt(this);
  public Runnable a;
  ...
  public boolean a()
  {
    ...
    if (!bool)
    {
      this.jdField_a_of_type_Bbcj.jdField_a_of_type_Bbcm.jdField_a_of_type_Boolean = true;
      this.jdField_a_of_type_Bbcj.b = false;
      this.jdField_a_of_type_Bbcj.jdField_a_of_type_Boolean = false;
    }
    if (!g()) {
  ...
  public void b(Bundle paramBundle)
  {
    ...
    if (paramBundle != null)
    {
      ...
      String str2 = b();
      aing.a(new Object[] { "[launchWebGame], success load url:", str1 });
