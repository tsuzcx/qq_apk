  ...
  implements Handler.Callback, Observer
{
  ...
  public void doOnActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if ((paramIntent != null) && (paramInt1 == 14002) && (paramInt2 == -1))
    {
      ...
      bbjx.a(this.app, str, i, localAbsStructMsg, null);
      VipUtils.a(this.app, "cmshow", "Apollo", "share_url_succeed", ApolloUtil.b(i), 0, new String[] { Integer.toString(j) });
    }
    if ((paramInt2 == -1) && (paramIntent != null) && ((paramInt1 == 14006) || (paramInt1 == 14005)) && (this.jdField_a_of_type_Ajcf != null) && (this.jdField_a_of_type_Ajcf.a() != null)) {
      this.jdField_a_of_type_Ajcf.a().runRenderTask(new ApolloWebGameActivity.3(this, paramInt1, paramInt2, paramIntent));
    }
  ...
  public void doOnConfigurationChanged(Configuration paramConfiguration)
  {
    ...
    if (paramConfiguration != null)
    {
      ...
      if ((this.jdField_a_of_type_Long != l) && (this.jdField_a_of_type_Long != this.b))
      {
        ...
        this.jdField_a_of_type_Bfob.sendEmptyMessageDelayed(18, 500L);
      }
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    paramBundle = new RelativeLayout.LayoutParams(actj.a(25.0F, super.getResources()), actj.a(25.0F, super.getResources()));
    ...
    this.jdField_a_of_type_Ajcf = ajac.a(paramBundle.gameId, this.jdField_a_of_type_Int);
    if (this.jdField_a_of_type_Ajcf != null) {
      this.jdField_a_of_type_Ajcf.a(paramBundle);
    }
    paramBundle = ajac.a();
    this.jdField_a_of_type_Aiyj = new aiyj(this, paramBundle);
    this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker = new CmGameStartChecker(paramBundle);
    this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker.a(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam, this.jdField_a_of_type_Aiyj);
    ajac.a(1, this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId, this.jdField_a_of_type_Int);
  ...
  public void doOnDestroy()
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Ajcf != null)
      {
        ...
        ajac.b(this.jdField_a_of_type_Ajcf.a(), this.jdField_a_of_type_Int);
      }
      if (this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null) {
        ajac.a(5, this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId, this.jdField_a_of_type_Int);
      }
  ...
  public void doOnPause()
  {
    super.doOnPause();
    if (this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null) {
      ajac.a(3, this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId, this.jdField_a_of_type_Int);
    }
    if (this.jdField_a_of_type_Ajcf != null) {
  ...
  public void doOnResume()
  {
    super.doOnResume();
    if (this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null) {
      ajac.a(2, this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId, this.jdField_a_of_type_Int);
    }
    if (this.jdField_a_of_type_Ajcf != null) {
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 17: 
      ...
      if (TextUtils.isEmpty((CharSequence)localObject)) {
        paramMessage = ajya.a(2131700594);
      }
      a(paramMessage);
      return false;
    case 15: 
    ...
    case 16: 
      ...
      {
        paramMessage = new aiyh(this);
        localObject = new aiyi(this);
      }
      try
      {
        this.jdField_a_of_type_Bbgu = bbdj.a(this, 0, ajya.a(2131700591), ajya.a(2131700592), ajya.a(2131700593), ajya.a(2131700589), paramMessage, (DialogInterface.OnClickListener)localObject);
        if (this.jdField_a_of_type_Bbgu != null)
        {
      ...
      catch (Throwable paramMessage)
      {
        ...
        paramMessage.putExtra("url", ajms.Y);
