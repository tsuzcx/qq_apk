...
public class ApolloQueueDownloader$1
  implements Runnable
{
  public ApolloQueueDownloader$1(akkh paramakkh, bdvv parambdvv) {}
  ...
  public void run()
  {
    ...
    if ((this.a.c) && (bdvx.a(this.a.jdField_a_of_type_JavaLangString)))
    {
    ...
    int i = bdvx.a(this.a, localAppRuntime);
    if (QLog.isColorLevel()) {
  ...
  public String toString()
  {
    try
    {
      ...
      if ((this.a.jdField_a_of_type_JavaUtilList == null) || (this.a.jdField_a_of_type_JavaUtilList.size() == 0))
      {
        ...
        if (akkh.a(this.this$0) != null) {
          break label105;
        }
      }
      label105:
      for (int i = 0;; i = akkh.a(this.this$0).size())
      {
