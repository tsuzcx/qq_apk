...
public class ApolloQueueDownloader$1
  implements Runnable
{
  public ApolloQueueDownloader$1(aige paramaige, batm parambatm) {}
  ...
  public void run()
  {
    ...
    if ((this.a.c) && (bato.a(this.a.jdField_a_of_type_JavaLangString)))
    {
    ...
    int i = bato.a(this.a, localAppRuntime);
    if (QLog.isColorLevel()) {
  ...
  public String toString()
  {
    try
    {
      ...
      if ((this.a.jdField_a_of_type_JavaUtilList == null) || (this.a.jdField_a_of_type_JavaUtilList.size() == 0))
      {
        ...
        if (aige.a(this.this$0) != null) {
          break label105;
        }
      }
      label105:
      for (int i = 0;; i = aige.a(this.this$0).size())
      {
