  ...
  public void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    do
    {
      do
      {
        ...
        {
          ThreadManager.getSubThreadHandler().postDelayed(new yru(this, paramQQAppInterface, (ApolloActionPush)localObject1), 500L);
          return;
        }
      ...
      if (i >= 0)
      {
        ...
        if ((localApolloGameData == null) || (!ApolloConfigUtils.a("7.6.0", localApolloGameData.minVer, localApolloGameData.maxVer))) {
          break label262;
        }
      }
      do
      {
        do
        {
          ...
          } while ((localObject1 != null) && (ApolloConfigUtils.a("7.6.0", ((ApolloGameData)localObject1).minVer, ((ApolloGameData)localObject1).maxVer)));
    ...
    for (paramSessionInfo = (SessionInfo)localObject1;; paramSessionInfo = null)
    {
      ...
      ThreadManager.post(new yrv(this, localMessageRecord), 5, null, false);
      return;
      bool1 = false;
      break;
    }
