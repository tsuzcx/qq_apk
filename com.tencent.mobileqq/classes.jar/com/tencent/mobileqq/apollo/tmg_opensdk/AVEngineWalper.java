...
{
  static AVEngineWalper jdField_a_of_type_ComTencentMobileqqApolloTmg_opensdkAVEngineWalper = null;
  int jdField_a_of_type_Int = 0;
  Context jdField_a_of_type_AndroidContentContext;
  private AVCallback jdField_a_of_type_ComTencentTMGSdkAVCallback = new AVEngineWalper.6(this);
  private AVManager.RoomInfoListener jdField_a_of_type_ComTencentMobileqqApolloTmg_opensdkAVManager$RoomInfoListener = new AVEngineWalper.7(this);
  ...
  private void d()
  {
    TMG_Downloader.a().a(this.jdField_a_of_type_ComTencentMobileqqApolloTmg_opensdkTMG_DownloadInfo, new AVEngineWalper.1(this));
  }
  ...
  {
    AVManager.a(this.jdField_a_of_type_AndroidContentContext).a(paramString, paramBoolean1, paramBoolean2, this.jdField_a_of_type_Int, new AVEngineWalper.2(this));
  }
  
  public void a(boolean paramBoolean)
  {
    AVManager.a(this.jdField_a_of_type_AndroidContentContext).a(paramBoolean, new AVEngineWalper.4(this));
  }
  ...
  {
    SSOTunnelEvent.a().a(Integer.valueOf(this.jdField_a_of_type_JavaLangString).intValue(), new AVEngineWalper.3(this, paramString, paramBoolean1, paramBoolean2));
  }
  
  public void b(boolean paramBoolean)
  {
    AVManager.a(this.jdField_a_of_type_AndroidContentContext).a(paramBoolean, new AVEngineWalper.5(this));
  }
