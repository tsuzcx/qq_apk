...
public class TMG_Downloader
{
  ...
  zcg jdField_a_of_type_Zcg = new zcg();
  ...
  boolean a(TMG_DownloadInfo paramTMG_DownloadInfo)
  {
    ...
    return this.jdField_a_of_type_Zcg.a(paramTMG_DownloadInfo, this.jdField_a_of_type_ComTencentMobileqqApolloTmg_opensdkTMG_Downloader$TMG_Downloader_DownloadEvent);
  }
