...
public class TMG_Downloader
{
  ...
  TMG_Downloader.DownloadContrl jdField_a_of_type_ComTencentMobileqqApolloTmg_opensdkTMG_Downloader$DownloadContrl = new TMG_Downloader.DownloadContrl();
  ...
  boolean a(TMG_DownloadInfo paramTMG_DownloadInfo)
  {
    ...
    return this.jdField_a_of_type_ComTencentMobileqqApolloTmg_opensdkTMG_Downloader$DownloadContrl.a(paramTMG_DownloadInfo, this.jdField_a_of_type_ComTencentMobileqqApolloTmg_opensdkTMG_Downloader$TMG_Downloader_DownloadEvent);
  }
