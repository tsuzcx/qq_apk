...
public class BarrageSurfaceView
  extends SurfaceView
  implements aiwc, Handler.Callback, SurfaceHolder.Callback
{
  private int jdField_a_of_type_Int;
  private aivx jdField_a_of_type_Aivx;
  private aivy<Canvas> jdField_a_of_type_Aivy;
  ...
  public void a(List<aiwb> paramList, boolean paramBoolean)
  {
    ...
    Message localMessage = this.jdField_a_of_type_Bfob.obtainMessage(13);
  ...
  public void a(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Bfob.obtainMessage(15).sendToTarget();
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          {
            return false;
          } while (this.jdField_a_of_type_Aivy == null);
          localObject = (List)paramMessage.obj;
          if (paramMessage.arg1 > 0) {
            this.jdField_a_of_type_Aivy.a(false);
          }
          if ((localObject != null) && (!((List)localObject).isEmpty()))
          {
            paramMessage = ((List)localObject).iterator();
            while (paramMessage.hasNext()) {
              ((aiwb)paramMessage.next()).a();
            }
          }
          this.jdField_a_of_type_Aivy.a((List)localObject);
          b();
          return false;
        } while (this.jdField_a_of_type_Aivy == null);
        paramMessage = (aiwb)paramMessage.obj;
        this.jdField_a_of_type_Aivy.a(paramMessage);
        b();
        return false;
      } while (this.jdField_a_of_type_Aivy == null);
      this.jdField_a_of_type_Aivy.a(false);
    ...
    for (;;)
    {
      try
      {
        ...
        paramMessage = localCanvas;
        localObject = localCanvas;
        bool2 = this.jdField_a_of_type_Aivy.a(localCanvas, 1.0F);
        bool1 = bool2;
        paramMessage = localCanvas;
        localObject = localCanvas;
        localCanvas.restore();
      ...
      try
      {
        ...
        bool3 = bool2;
        if ((bool3) && (this.jdField_a_of_type_Bfob != null)) {
          this.jdField_a_of_type_Bfob.sendEmptyMessageDelayed(16, 20L);
        }
        if (QLog.isColorLevel()) {
  ...
  public void surfaceCreated(SurfaceHolder paramSurfaceHolder)
  {
    ...
    if (this.jdField_a_of_type_Aivy == null) {
      this.jdField_a_of_type_Aivy = new aiwd();
    }
    ...
    this.jdField_a_of_type_Bfob = new bfob(this.jdField_a_of_type_AndroidOsHandlerThread.getLooper(), this);
  }
