...
public abstract class AbsBarrageCache
{
  ...
  public Bitmap a(Barrage paramBarrage)
  {
    ...
    //   7: ifnull +17 -> 24
    //   10: aload_1
    //   11: getfield 96	com/tencent/mobileqq/apollo/barrage/Barrage:e	I
    //   14: ifeq +10 -> 24
    //   17: aload_1
    //   18: getfield 99	com/tencent/mobileqq/apollo/barrage/Barrage:f	I
    //   21: ifne +7 -> 28
    //   24: aconst_null
    //   25: astore_3
    //   26: aload_3
    ...
    //   28: aload_0
    //   29: aload_1
    //   30: invokevirtual 101	com/tencent/mobileqq/apollo/barrage/AbsBarrageCache:b	(Lcom/tencent/mobileqq/apollo/barrage/Barrage;)Landroid/graphics/Bitmap;
    //   33: astore_2
    //   34: aload_2
    //   35: ifnull +48 -> 83
    //   38: aload_2
    ...
    //   68: aload_1
    //   69: getfield 126	com/tencent/mobileqq/apollo/barrage/Barrage:jdField_a_of_type_JavaLangCharSequence	Ljava/lang/CharSequence;
    ...
    //   104: aload_1
    //   105: getfield 126	com/tencent/mobileqq/apollo/barrage/Barrage:jdField_a_of_type_JavaLangCharSequence	Ljava/lang/CharSequence;
    ...
    //   124: astore 6
    //   126: aload_1
    //   127: getfield 96	com/tencent/mobileqq/apollo/barrage/Barrage:e	I
    //   130: aload_1
    //   131: getfield 99	com/tencent/mobileqq/apollo/barrage/Barrage:f	I
    ...
    //   149: astore_2
    //   150: aload_1
    //   151: getfield 159	com/tencent/mobileqq/apollo/barrage/Barrage:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   154: invokestatic 165	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   157: ifne +119 -> 276
    //   160: aload_0
    //   161: getfield 34	com/tencent/mobileqq/apollo/barrage/AbsBarrageCache:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   164: aload_1
    //   165: getfield 159	com/tencent/mobileqq/apollo/barrage/Barrage:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   202: dup
    //   203: aload_1
    //   204: getfield 159	com/tencent/mobileqq/apollo/barrage/Barrage:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   219: dup
    //   220: aload_1
    //   221: getfield 159	com/tencent/mobileqq/apollo/barrage/Barrage:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   245: astore_2
    //   246: aload_0
    //   247: getfield 34	com/tencent/mobileqq/apollo/barrage/AbsBarrageCache:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   250: aload_1
    //   251: getfield 159	com/tencent/mobileqq/apollo/barrage/Barrage:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   280: aload_0
    //   281: getfield 34	com/tencent/mobileqq/apollo/barrage/AbsBarrageCache:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   284: ldc 201
    ...
    //   327: astore 4
    //   329: aload_0
    //   330: getfield 34	com/tencent/mobileqq/apollo/barrage/AbsBarrageCache:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   333: ldc 201
    ...
    //   382: iconst_0
    //   383: aload_1
    //   384: getfield 96	com/tencent/mobileqq/apollo/barrage/Barrage:e	I
    //   387: aload_1
    //   388: getfield 99	com/tencent/mobileqq/apollo/barrage/Barrage:f	I
    ...
    //   399: astore_2
    //   400: aload_1
    //   401: getfield 239	com/tencent/mobileqq/apollo/barrage/Barrage:jdField_a_of_type_AndroidTextStaticLayout	Landroid/text/StaticLayout;
    //   404: ifnull +27 -> 431
    //   407: aload 6
    //   409: aload_1
    //   410: getfield 241	com/tencent/mobileqq/apollo/barrage/Barrage:jdField_g_of_type_Int	I
    //   413: i2f
    //   414: aload_1
    //   415: getfield 88	com/tencent/mobileqq/apollo/barrage/Barrage:h	I
    //   418: i2f
    //   419: invokevirtual 245	android/graphics/Canvas:translate	(FF)V
    //   422: aload_1
    //   423: getfield 239	com/tencent/mobileqq/apollo/barrage/Barrage:jdField_a_of_type_AndroidTextStaticLayout	Landroid/text/StaticLayout;
    //   426: aload 6
    //   428: invokevirtual 250	android/text/StaticLayout:draw	(Landroid/graphics/Canvas;)V
    //   431: aload_0
    //   432: aload_1
    //   433: aload_2
    //   434: invokevirtual 253	com/tencent/mobileqq/apollo/barrage/AbsBarrageCache:a	(Lcom/tencent/mobileqq/apollo/barrage/Barrage;Landroid/graphics/Bitmap;)V
    //   437: aload_2
    //   438: areturn
    //   439: aload 6
    //   441: aload 4
    ...
    //   467: iconst_0
    //   468: aload_1
    //   469: getfield 96	com/tencent/mobileqq/apollo/barrage/Barrage:e	I
    //   472: aload_1
    //   473: getfield 99	com/tencent/mobileqq/apollo/barrage/Barrage:f	I
    ...
    //   0	555	0	this	AbsBarrageCache
    //   0	555	1	paramBarrage	Barrage
