  ...
  extends IApolloRunnableTask
{
  ...
  public void run()
  {
    ...
    String[] arrayOfString = ajki.a(ApolloUtil.f(1), this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, this.jdField_a_of_type_ArrayOfJavaLangString[0], this.jdField_a_of_type_ArrayOfJavaLangString[1]);
    ...
    if (this.jdField_b_of_type_ArrayOfJavaLangString != null)
    {
      ...
      if (this.jdField_b_of_type_ArrayOfJavaLangString.length == 2) {
        localObject1 = ajki.a(ApolloUtil.f(2), this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, this.jdField_b_of_type_ArrayOfJavaLangString[0], this.jdField_b_of_type_ArrayOfJavaLangString[1]);
      }
    }
      ...
      do
      {
        try
        {
          while (i < arrayOfString.length)
          {
            ...
            if ((!this.this$0.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) && (this.this$0.jdField_a_of_type_Aivb != null)) {
              this.this$0.jdField_a_of_type_Aivb.onRender();
            }
            return;
          }
        }
