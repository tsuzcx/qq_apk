...
public class CmShowViewListener$1
  implements Runnable
{
  public CmShowViewListener$1(ajgq paramajgq, int paramInt1, int paramInt2) {}
  
  public void run()
  {
    if (ajgq.a(this.this$0).get() != null) {
      ((ajgb)ajgq.a(this.this$0).get()).a(ajgq.a(this.this$0));
    }
    QLog.d("CmShow_ApolloDrawerInfoViewListener", 1, new Object[] { "onSurfaceReady w:", Integer.valueOf(this.a), " h:", Integer.valueOf(this.b) });
    if (ajgq.a(this.this$0) != null) {
      ajgq.a(this.this$0).a(this.a, this.b);
    }
  }
}
