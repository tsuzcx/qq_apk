  ...
  implements Runnable
{
  ...
  public void run()
  {
    Object localObject1 = this.this$0.mMemeAction.a(null, null);
    boolean bool;
    ...
    {
      if (this.this$0.mMemeAction.i() == MODE.ACTION_MODE_RECORD_GIF)
      {
        ...
        ((IApolloAvatarFileManager)QRoute.api(IApolloAvatarFileManager.class)).putAction2GifFilePath(ApolloBrickPlayerImpl.access$500(this.this$0), this.this$0.mMemeAction.c().j, (String)localObject2);
      }
      else
      {
    ...
    MemeHelper.a.a(null, this.this$0.mMemeAction, ApolloBrickPlayerImpl.access$1000(this.this$0));
    if (ApolloBrickPlayerImpl.access$1200().containsKey(localObject1))
    {
      localObject2 = ApolloBrickPlayerImpl.access$1000(this.this$0);
      ThreadManager.getSubThreadHandler().post(new ApolloBrickPlayerImpl.1.2(this, (String)localObject1, (ApolloBrickPlayerImpl.CustomMemePlayerListener)localObject2));
    }
 ...
 * Qualified Name:     com.tencent.mobileqq.apollo.meme.api.impl.ApolloBrickPlayerImpl.1
