...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"com/tencent/mobileqq/apollo/meme/manager/MemeBornPlayer$BornActionContext$dressChangeListener$2$1", "Lcom/tencent/mobileqq/apollo/handler/ApolloExtensionObserver;", "onApolloDressChange", "", "result", "", "data", "", "cmshow_impl_release"}, k=1, mv={1, 1, 16})
public final class MemeBornPlayer$BornActionContext$dressChangeListener$2$1
  extends ApolloExtensionObserver
{
  protected void a(boolean paramBoolean, @Nullable Object paramObject)
  {
    ...
    QLog.w("[cmshow][MemePlayer]MemeBornPlayer", 1, ((StringBuilder)localObject1).toString());
    if (paramBoolean) {
      if (paramObject == null) {
        return;
      }
    ...
    try
    {
      ...
      paramObject = this.a.this$0.l().getSpriteCreator().b(0);
      if (paramObject != null)
      {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          {
            Object localObject2 = MemeHelper.a.a();
            ...
            if (((IApolloManagerService)((QQAppInterface)localObject2).getRuntimeService(IApolloManagerService.class, "all")).getCmShowStatus(str) == 1)
            {
              ...
              QLog.w("[cmshow][MemePlayer]MemeBornPlayer", 1, ((StringBuilder)localObject2).toString());
 ...
 * Qualified Name:     com.tencent.mobileqq.apollo.meme.manager.MemeBornPlayer.BornActionContext.dressChangeListener.2.1
