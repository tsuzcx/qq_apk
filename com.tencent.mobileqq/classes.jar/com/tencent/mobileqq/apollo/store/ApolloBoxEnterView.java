  ...
  implements Handler.Callback, BusinessObserver
{
  ...
  Runnable jdField_a_of_type_JavaLangRunnable = new ypj(this);
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    this.b = paramString1;
    ThreadManager.executeOnSubThread(new ypi(this, paramString1, paramString2));
  }
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      if (paramBoolean)
      {
        ThreadManager.executeOnSubThread(new ypk(this, paramBundle));
        return;
      }
    } while (!QLog.isColorLevel());
