  ...
  implements Runnable
{
  ...
  public void run()
  {
    try
    {
      ...
      localaifg = (aifg)localQQAppInterface.getManager(153);
      localObject2 = localaifg.a(str + "", true);
    ...
    localaifg.a((ApolloPandora)localObject1);
    ...
    if (QLog.isColorLevel())
    {
      QLog.d("ApolloBoxEnterView", 2, "handleQueryPandora canSteal: " + ((ApolloPandora)localObject1).canSteal + ", hadStolen: " + ((ApolloPandora)localObject1).hadStolen + ",boxType:" + ((ApolloPandora)localObject1).boxType + ", checkPoint: " + baiu.a(localQQAppInterface.getApp(), ((ApolloPandora)localObject1).checkPoint * 1000L));
      return;
    }
  }
}
