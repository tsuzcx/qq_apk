  ...
  implements DialogInterface.OnDismissListener, Handler.Callback, View.OnClickListener, AdapterView.OnItemClickListener, IRenderCallback, OnApolloViewListener, ActionSheet.OnButtonClickListener
{
  ...
  public void a(int paramInt1, int paramInt2, AppInterface paramAppInterface, int paramInt3, int[] paramArrayOfInt, float paramFloat)
  {
    ...
    if (!this.jdField_b_of_type_Boolean)
    {
      ...
      this.jdField_d_of_type_AndroidWidgetImageView.setBackgroundResource(2130838017);
      ...
      paramAppInterface.setBackgroundResource(2130838028);
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setBackgroundResource(2130838146);
      ...
      this.jdField_b_of_type_AndroidWidgetImageView.setBackgroundResource(2130838147);
      ...
      this.jdField_c_of_type_AndroidWidgetImageView.setBackgroundResource(2130838148);
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      if (Build.VERSION.SDK_INT >= 14) {
        ThreadManager.executeOnSubThread(new yqk(this, a(), this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getWidth(), this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getHeight(), 15, l));
      }
  ...
  public void onItemClick(AdapterView paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    if (paramLong == 1L)
    {
      if (Build.VERSION.SDK_INT >= 14)
      {
        ...
        ThreadManager.executeOnSubThread(new yqk(this, a(), this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getWidth(), this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getHeight(), 16, l));
      }
    ...
    {
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.invalidate();
      ThreadManager.executeOnSubThread(new yqk(this, a(), this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getWidth(), this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getHeight(), 17, l));
    }
