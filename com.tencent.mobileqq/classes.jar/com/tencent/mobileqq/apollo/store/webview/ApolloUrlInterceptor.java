  ...
  implements Handler.Callback, BridgeStream.IBridgeStreamCallback
{
  ...
  private volatile yrm jdField_a_of_type_Yrm;
  ...
  private void b(boolean paramBoolean)
  {
    ...
    if (3 != i)
    {
      ...
      if ((this.jdField_a_of_type_Yrm != null) && (!paramBoolean))
      {
        this.jdField_a_of_type_Yrm.a();
        this.jdField_a_of_type_Yrm = null;
      }
  ...
  private void c()
  {
    ThreadManager.postImmediately(new yrj(this), null, true);
  }
  ...
  {
    long l1 = System.currentTimeMillis();
    this.jdField_a_of_type_Yrm = new yrm(this.jdField_e_of_type_JavaLangString, false);
    long l2 = System.currentTimeMillis();
    int j = this.jdField_a_of_type_Yrm.a();
    int i = j;
    Map localMap;
    Object localObject;
    if (j == 0)
    {
      ...
      i = this.jdField_a_of_type_Yrm.b();
      if (QLog.isColorLevel()) {
      ...
      l2 = System.currentTimeMillis();
      localMap = this.jdField_a_of_type_Yrm.a();
      if (QLog.isColorLevel()) {
  ...
  {
    int i = 2;
    Object localObject1 = this.jdField_a_of_type_Yrm.a(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean, null);
    ...
    this.jdField_a_of_type_JavaIoInputStream = new BridgeStream(this, ((yro)localObject1).jdField_a_of_type_JavaIoByteArrayOutputStream, ((yro)localObject1).jdField_a_of_type_JavaIoBufferedInputStream);
    if (((yro)localObject1).jdField_a_of_type_Boolean) {}
    for (;;)
    {
      try
      {
        localObject1 = ((yro)localObject1).jdField_a_of_type_JavaIoByteArrayOutputStream.toString("UTF-8");
      }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ThreadManager.postImmediately(new yrk(this), null, true);
      return;
    }
    if (QLog.isColorLevel()) {
  ...
  public void a(boolean paramBoolean, ByteArrayOutputStream paramByteArrayOutputStream)
  {
    ...
    {
      ThreadManager.getSubThreadHandler().postDelayed(new yrl(this, paramByteArrayOutputStream), 3000L);
      return;
    }
