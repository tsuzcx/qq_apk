...
public class ApolloUrlInterceptor$3
  implements Runnable
{
  public ApolloUrlInterceptor$3(anlc paramanlc, ByteArrayOutputStream paramByteArrayOutputStream) {}
  ...
  public void run()
  {
    ...
    try
    {
      ...
      if (!TextUtils.isEmpty(str))
      {
        ...
        anle.a().b(anlc.a(this.this$0), str);
        anlc.a(this.this$0, true);
        if (QLog.isColorLevel()) {
      ...
      anlc.a(this.this$0).set(false);
      if ((anlc.b(this.this$0)) && (QLog.isColorLevel())) {
