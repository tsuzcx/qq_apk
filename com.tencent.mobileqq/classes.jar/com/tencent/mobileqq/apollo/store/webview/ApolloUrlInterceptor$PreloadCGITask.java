  ...
  private void c()
  {
    ...
    if (j == 0)
    {
      if (QLog.isColorLevel()) {
        QLog.d("Apollo_client_PreloadCGITask", 2, "task(" + this.jdField_a_of_type_ComTencentMobileqqApolloStoreWebviewApolloSSOConfig$CGIConfig.jdField_a_of_type_JavaLangString + ") connection connect cost = " + (System.currentTimeMillis() - l2) + " ms.");
      }
      l2 = System.currentTimeMillis();
      i = this.jdField_a_of_type_ComTencentMobileqqApolloStoreWebviewApolloUrlConnection.b();
      if (QLog.isColorLevel()) {
        QLog.d("Apollo_client_PreloadCGITask", 2, "task(" + this.jdField_a_of_type_ComTencentMobileqqApolloStoreWebviewApolloSSOConfig$CGIConfig.jdField_a_of_type_JavaLangString + ") connection response cost = " + (System.currentTimeMillis() - l2) + " ms.");
      }
      l2 = System.currentTimeMillis();
      localObject2 = this.jdField_a_of_type_ComTencentMobileqqApolloStoreWebviewApolloUrlConnection.a();
      if (QLog.isColorLevel()) {
        QLog.d("Apollo_client_PreloadCGITask", 2, "task(" + this.jdField_a_of_type_ComTencentMobileqqApolloStoreWebviewApolloSSOConfig$CGIConfig.jdField_a_of_type_JavaLangString + ") connection get header fields cost = " + (System.currentTimeMillis() - l2) + " ms.");
      }
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("Apollo_client_PreloadCGITask", 2, "task(" + this.jdField_a_of_type_ComTencentMobileqqApolloStoreWebviewApolloSSOConfig$CGIConfig.jdField_a_of_type_JavaLangString + ") mHeaderMap:" + this.jdField_a_of_type_JavaUtilHashMap);
        }
        if (QLog.isColorLevel()) {
          QLog.d("Apollo_client_PreloadCGITask", 4, "task(" + this.jdField_a_of_type_ComTencentMobileqqApolloStoreWebviewApolloSSOConfig$CGIConfig.jdField_a_of_type_JavaLangString + ") handleFlow_Connection: respCode = " + i + ", cost " + (System.currentTimeMillis() - l1) + " ms.");
        }
        if (ApolloUrlInterceptor.c(this.jdField_a_of_type_ComTencentMobileqqApolloStoreWebviewApolloUrlInterceptor))
        {
          if (QLog.isColorLevel()) {
            QLog.d("Apollo_client_PreloadCGITask", 6, "task(" + this.jdField_a_of_type_ComTencentMobileqqApolloStoreWebviewApolloSSOConfig$CGIConfig.jdField_a_of_type_JavaLangString + ") handleFlow_Connection: destroy before server response.");
          }
          if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreWebviewApolloUrlConnection != null)
          {
        ...
        if (200 != i)
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.d("Apollo_client_PreloadCGITask", 4, "task(" + this.jdField_a_of_type_ComTencentMobileqqApolloStoreWebviewApolloSSOConfig$CGIConfig.jdField_a_of_type_JavaLangString + ") handleFlow_Connection: response code not 200, response code = " + i);
          }
          this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(2);
          synchronized (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger)
          {
        ...
        {
          if (QLog.isColorLevel()) {
            QLog.d("Apollo_client_PreloadCGITask", 2, "task(" + this.jdField_a_of_type_ComTencentMobileqqApolloStoreWebviewApolloSSOConfig$CGIConfig.jdField_a_of_type_JavaLangString + ") handleFlow_FirstLoad error:responseDataTuple is null!");
          }
          this.jdField_a_of_type_ComTencentMobileqqApolloStoreWebviewBridgeStream = null;
          this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(2);
          synchronized (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger)
        ...
        synchronized (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger)
        {
          ...
          QLog.d("Apollo_client_PreloadCGITask", 2, "task(" + this.jdField_a_of_type_ComTencentMobileqqApolloStoreWebviewApolloSSOConfig$CGIConfig.jdField_a_of_type_JavaLangString + ") mCostTime:" + this.jdField_a_of_type_Long);
          return;
        }
      }
      label1083:
