  ...
  implements Runnable
{
  ...
  public void run()
  {
    azmj.b(null, "P_CliOper", "WebStatusReport", "", "", this.jdField_a_of_type_JavaLangString, 0, 1, this.this$0.jdField_a_of_type_Int, this.this$0.jdField_a_of_type_JavaLangString, Build.VERSION.RELEASE, String.valueOf(this.this$0.f - this.this$0.g), String.valueOf(System.currentTimeMillis() - this.this$0.g));
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      if ((((Map.Entry)localObject2).getValue() instanceof String))
      {
        ...
        if (!((String)((Map.Entry)localObject2).getKey()).equalsIgnoreCase(String.valueOf(this.this$0.jdField_a_of_type_Long)))
        {
          ...
          azmj.b(null, "P_CliOper", "WebStatusReport", "", "hard code unknown", this.jdField_a_of_type_JavaLangString, 0, 1, 100, (String)localObject2, Build.VERSION.RELEASE, "100", "200");
        }
      }
    }
