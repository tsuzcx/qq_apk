  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    } while ((localApolloImageShareLayout == null) || (ApolloImageShareLayout.a(localApolloImageShareLayout) == null) || (localApolloImageShareLayout.jdField_a_of_type_Blhq == null));
    for (;;)
    {
      try
      {
        ...
        localObject1 = nnw.a((Bitmap)localObject3);
        localObject3 = localApolloImageShareLayout.jdField_a_of_type_Blhq.obtainMessage(this.jdField_a_of_type_Int);
