  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    } while ((localApolloImageShareLayout == null) || (ApolloImageShareLayout.a(localApolloImageShareLayout) == null) || (localApolloImageShareLayout.jdField_a_of_type_Bjng == null));
    for (;;)
    {
      try
      {
        ...
        localObject1 = npg.a((Bitmap)localObject3);
        localObject3 = localApolloImageShareLayout.jdField_a_of_type_Bjng.obtainMessage(this.jdField_a_of_type_Int);
