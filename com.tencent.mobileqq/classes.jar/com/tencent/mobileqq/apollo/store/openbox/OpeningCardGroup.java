  ...
  implements Handler.Callback
{
  ...
  public OpeningCardGroup(Context paramContext, ajiy paramajiy)
  {
    super(paramContext);
    this.jdField_a_of_type_Ajiy = paramajiy;
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    this.jdField_a_of_type_Bfob.sendEmptyMessageDelayed(15, 400L);
  }
  
  public void a(int paramInt1, int paramInt2, ajiq paramajiq)
  {
    if ((paramajiq == null) || (paramajiq.b == null)) {
      return;
    }
    int j = Math.min(super.getChildCount(), paramajiq.b.size());
    int i = 0;
    while (i < j)
    {
      View localView = super.getChildAt(i);
      ...
      if ((localView instanceof ApolloCardLayout)) {
        ((ApolloCardLayout)localView).a(1, (ajir)paramajiq.b.get(i), paramInt1, paramInt2);
      }
      i += 1;
    }
  ...
  public void a(List<ajir> paramList, List<ApolloCardLayout> paramList1, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (j == 1)
    {
      ...
      paramList1.a(2, (ajir)paramList.get(0), paramInt4, i);
    ...
    if (j == 2)
    {
      ...
      localApolloCardLayout.a(2, (ajir)paramList.get(0), paramInt4, i);
      ...
      paramList1.a(2, (ajir)paramList.get(1), paramInt4, i);
      paramList = new FrameLayout.LayoutParams(paramInt4, i);
    ...
    if (j == 3)
    {
      ...
      i = (int)(i * 0.38F);
      localApolloCardLayout = (ApolloCardLayout)paramList1.get(0);
      localApolloCardLayout.a(3, (ajir)paramList.get(0), paramInt4, i);
      localLayoutParams = new FrameLayout.LayoutParams(paramInt4, i);
      ...
      localApolloCardLayout.a(3, (ajir)paramList.get(1), paramInt4, i);
      localLayoutParams = new FrameLayout.LayoutParams(paramInt4, i);
      ...
      paramList1.a(3, (ajir)paramList.get(2), paramInt4, i);
      paramList = new FrameLayout.LayoutParams(paramInt4, i);
    ...
    localApolloCardLayout.a(4, (ajir)paramList.get(0), paramInt4, i);
    ...
    super.addView(localApolloCardLayout, localLayoutParams);
    localApolloCardLayout = (ApolloCardLayout)paramList1.get(1);
    localApolloCardLayout.a(4, (ajir)paramList.get(1), paramInt4, i);
    localLayoutParams = new FrameLayout.LayoutParams(paramInt4, i);
    ...
    localApolloCardLayout.a(4, (ajir)paramList.get(2), paramInt4, i);
    localLayoutParams = new FrameLayout.LayoutParams(paramInt4, i);
    ...
    paramList1.a(4, (ajir)paramList.get(3), paramInt4, i);
    paramList = new FrameLayout.LayoutParams(paramInt4, i);
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      this.jdField_a_of_type_Ajiy = null;
      this.jdField_a_of_type_Ajja = null;
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    } while (this.jdField_a_of_type_Ajiy == null);
    this.jdField_a_of_type_Ajiy.a(10, 0, 0);
    return false;
