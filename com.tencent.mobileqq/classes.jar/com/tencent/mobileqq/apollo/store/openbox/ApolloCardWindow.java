...
public class ApolloCardWindow
  ...
  implements aiux, aiuy, aiva, Handler.Callback, View.OnClickListener
{
  static float jdField_a_of_type_Float;
  private static final String jdField_a_of_type_JavaLangString = ajjy.a(2131634518);
  public static Map<String, Drawable> a;
  private static boolean jdField_a_of_type_Boolean;
  static float jdField_b_of_type_Float;
  private static final String jdField_b_of_type_JavaLangString = ajjy.a(2131634507);
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private aiuq jdField_a_of_type_Aiuq;
  private aiuv jdField_a_of_type_Aiuv;
  private aiuw jdField_a_of_type_Aiuw;
  ...
  batl jdField_a_of_type_Batl = new aiuu(this);
  ...
  public ApolloCardWindow(Context paramContext)
  {
    ...
    d();
    this.jdField_a_of_type_Batr = new bato(BaseApplicationImpl.getApplication().getRuntime()).a(3);
    ThreadManager.post(this.jdField_a_of_type_JavaLangRunnable, 10, null, true);
  }
  
  public static void a()
  {
    jdField_a_of_type_Float = ajia.a() / 16.0F;
    if (jdField_a_of_type_Float == 0.0F) {
      jdField_a_of_type_Float = 1.0F;
    }
    jdField_b_of_type_Float = babp.a() / jdField_a_of_type_Float;
    if (jdField_b_of_type_Float == 0.0F) {
      jdField_b_of_type_Float = babp.a();
    }
  }
  ...
  public static void b()
  {
    ...
    do
    {
      ...
      while (m <= 9)
      {
        ...
        if (!new File(aiys.k + "boxcard/" + str).exists()) {
          aitu.a(str, null, aitu.a(str)).startDownload();
        }
        m += 1;
      }
      if (!new File(aiys.k + "boxcard/" + "apollo_card_gold_add.png").exists()) {
        aitu.a("apollo_card_gold_add.png", null, aitu.a("apollo_card_gold_add.png")).startDownload();
      }
      m = n;
      if (!new File(aiys.k + "boxcard/" + "apollo_card_gold_icon.png").exists())
      {
        aitu.a("apollo_card_gold_icon.png", null, aitu.a("apollo_card_gold_icon.png")).startDownload();
        m = n;
      }
      while (m <= 9)
      {
      ...
      if (!new File(aiys.k + "boxcard/" + "apollo_card_crystal_add.png").exists()) {
        aitu.a("apollo_card_crystal_add.png", null, aitu.a("apollo_card_crystal_add.png")).startDownload();
      }
    } while (new File(aiys.k + "boxcard/" + "apollo_card_crystal_image.png").exists());
    aitu.a("apollo_card_crystal_image.png", null, aitu.a("apollo_card_crystal_image.png")).startDownload();
  }
  ...
  private void d()
  {
    ...
    this.jdField_a_of_type_Aiuw = new aiuw(this);
    this.jdField_a_of_type_Befq = new befq(Looper.getMainLooper(), this);
    a();
    int n = (int)babp.i();
    int m = (int)babp.j() - ImmersiveUtils.getStatusBarHeight(this.jdField_a_of_type_AndroidContentContext);
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(2131625271);
    ...
    this.jdField_g_of_type_AndroidWidgetTextView.setText(ajjy.a(2131634517));
    localObject3 = new RelativeLayout.LayoutParams(-2, -2);
    ...
    URLDrawable localURLDrawable = aitu.a("apollo_error.png", null, aitu.a("apollo_error.png"));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130839115);
    ...
    this.jdField_d_of_type_AndroidWidgetImageView.setBackgroundResource(2130838271);
    ...
    this.jdField_e_of_type_AndroidWidgetImageView.setBackgroundResource(2130838270);
  ...
  private void e()
  {
    if ((this.jdField_a_of_type_Aiuq == null) || (this.jdField_a_of_type_Aiuq.jdField_b_of_type_JavaUtilList == null) || (this.jdField_a_of_type_Aiuq.jdField_b_of_type_JavaUtilList.isEmpty())) {
      return;
    }
    Object localObject1;
    if (TextUtils.isEmpty(this.jdField_a_of_type_Aiuq.jdField_c_of_type_JavaLangString))
    {
      localObject1 = "";
      label50:
      if ((TextUtils.isEmpty(this.jdField_d_of_type_JavaLangString)) || (!this.jdField_d_of_type_JavaLangString.equals(this.jdField_a_of_type_Aiuq.jdField_b_of_type_JavaLangString))) {
        break label1753;
      }
      localObject1 = ajjy.a(2131634514);
    }
    label300:
    label455:
    label587:
    ...
    for (;;)
    {
      ...
      label376:
      int m;
      if (this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.size() == 3)
      {
        ...
        localObject2 = (aius)this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.get(2);
        if (localObject2 != null)
        {
          if (!TextUtils.isEmpty(((aius)localObject2).jdField_a_of_type_JavaLangString))
          {
            localObject3 = aitu.a(Utils.Crc64String(((aius)localObject2).jdField_a_of_type_JavaLangString), null, ((aius)localObject2).jdField_a_of_type_JavaLangString);
            this.jdField_h_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject3);
          }
          if (((aius)localObject2).jdField_a_of_type_Int == 7) {
            this.jdField_i_of_type_AndroidWidgetTextView.setTextColor(-31676);
          }
        }
        else
        {
          localObject2 = (aius)this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.get(1);
          if (localObject2 != null)
          {
            if (!TextUtils.isEmpty(((aius)localObject2).jdField_a_of_type_JavaLangString))
            {
          ...
          localObject2 = (aius)this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.get(0);
          if (localObject2 != null)
          {
            if (!TextUtils.isEmpty(((aius)localObject2).jdField_a_of_type_JavaLangString))
            {
          ...
          if (this.jdField_a_of_type_Aiuq.jdField_a_of_type_Int != -1) {
            super.setBackgroundColor(this.jdField_a_of_type_Aiuq.jdField_a_of_type_Int);
          }
          this.jdField_a_of_type_ComTencentMobileqqApolloStoreOpenboxOpeningCardGroup.removeAllViews();
          if ((this.jdField_a_of_type_Aiuq.jdField_b_of_type_Long == 0L) && (this.jdField_a_of_type_Aiuq.jdField_a_of_type_Long != -501031L) && (this.jdField_a_of_type_Aiuq.jdField_a_of_type_Long != -501027L)) {
            break label1243;
          }
          this.jdField_a_of_type_ComTencentMobileqqApolloStoreOpenboxOpeningCardGroup.setVisibility(0);
          m = 0;
          if (m >= this.jdField_a_of_type_Aiuq.jdField_b_of_type_JavaUtilList.size()) {
            break label1020;
          }
      ...
      for (;;)
      {
        ...
        m += 1;
        break label455;
        localObject1 = this.jdField_a_of_type_Aiuq.jdField_c_of_type_JavaLangString;
        break label50;
        this.jdField_i_of_type_AndroidWidgetTextView.setTextColor(-16777216);
        break label224;
        this.jdField_h_of_type_AndroidWidgetTextView.setTextColor(-16777216);
        ...
        this.jdField_c_of_type_AndroidWidgetTextView.setTextColor(-16777216);
        break label376;
        if (this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.size() == 2)
        {
        ...
        if (this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.size() != 1) {
          break label376;
        }
        this.jdField_h_of_type_AndroidWidgetImageView.setVisibility(8);
        this.jdField_i_of_type_AndroidWidgetTextView.setVisibility(8);
        ...
        break label376;
        label1020:
        this.jdField_a_of_type_ComTencentMobileqqApolloStoreOpenboxOpeningCardGroup.a(this.jdField_c_of_type_Int, this.jdField_f_of_type_Int, this.jdField_a_of_type_Aiuq);
        ...
        if (this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.size() > 0) {
          this.jdField_c_of_type_AndroidWidgetTextView.setText(aiuq.c(((aius)this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.get(0)).jdField_b_of_type_Int));
        }
        if (this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.size() > 1) {
          this.jdField_h_of_type_AndroidWidgetTextView.setText(aiuq.b(((aius)this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.get(1)).jdField_b_of_type_Int));
        }
        if (this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.size() > 2) {
          this.jdField_i_of_type_AndroidWidgetTextView.setText(aiuq.a(((aius)this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.get(2)).jdField_b_of_type_Int));
        }
        if ((this.jdField_a_of_type_Aiuq.jdField_b_of_type_Long != -501027L) && (this.jdField_a_of_type_Long != -501027L)) {
          break;
        }
        ...
        this.jdField_e_of_type_AndroidWidgetTextView.setText(ajjy.a(2131634511) + (String)localObject1 + ajjy.a(2131634512));
        this.jdField_e_of_type_AndroidWidgetTextView.setVisibility(0);
        this.jdField_a_of_type_ComTencentMobileqqApolloStoreOpenboxApolloOpenBoxView.setVisibility(0);
        if (this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.size() > 0) {
          this.jdField_c_of_type_AndroidWidgetTextView.setText(aiuq.c(((aius)this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.get(0)).jdField_b_of_type_Int - ((aius)this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.get(0)).jdField_c_of_type_Int));
        }
        if (this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.size() > 1) {
          this.jdField_h_of_type_AndroidWidgetTextView.setText(aiuq.b(((aius)this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.get(1)).jdField_b_of_type_Int - ((aius)this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.get(1)).jdField_c_of_type_Int));
        }
        if (this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.size() > 2) {
          this.jdField_i_of_type_AndroidWidgetTextView.setText(aiuq.a(((aius)this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.get(2)).jdField_b_of_type_Int - ((aius)this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.get(2)).jdField_c_of_type_Int));
        }
        if ((this.jdField_a_of_type_Aiuq.jdField_b_of_type_Long == -501027L) || (this.jdField_a_of_type_Long == -501027L)) {
          this.jdField_g_of_type_AndroidWidgetTextView.setVisibility(0);
        }
        ...
        for (;;)
        {
          ...
          localObject1 = (aiur)this.jdField_a_of_type_Aiuq.jdField_b_of_type_JavaUtilList.get(m);
          if ((localObject1 != null) && (((aiur)localObject1).jdField_a_of_type_Short == 15)) {
            bajr.a(null, "cmshow", "Apollo", "0X80065C002", this.jdField_a_of_type_Int, 0, new String[0]);
          }
          m += 1;
          break;
          this.jdField_a_of_type_ComTencentMobileqqApolloStoreOpenboxOpeningCardGroup.a(this.jdField_a_of_type_Aiuq.jdField_b_of_type_JavaUtilList, (List)localObject3, this.j, this.k - this.jdField_h_of_type_Int, super.getWidth(), super.getHeight());
          this.jdField_a_of_type_Befq.sendEmptyMessageDelayed(256, 600);
  ...
  void a(int paramInt)
  {
    ...
    aivb localaivb = new aivb(0, 0, 0, -ApolloUtil.a(144.0F, jdField_b_of_type_Float), -(ApolloUtil.a(195.0F, jdField_b_of_type_Float) - paramInt), -ApolloUtil.a(164.0F, jdField_b_of_type_Float));
    localaivb.setDuration(500L);
    localaivb.setStartOffset(250L);
    localaivb.setInterpolator(new AccelerateDecelerateInterpolator());
    ...
    this.jdField_a_of_type_AndroidViewAnimationAnimationSet.addAnimation(localaivb);
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
        } while (this.jdField_a_of_type_Aiuq == null);
        if (4 != paramInt1) {
          break;
        }
      ...
      } while ((this.jdField_a_of_type_Aiuq.jdField_b_of_type_Long != -501027L) && (this.jdField_a_of_type_Long != -501027L));
      this.jdField_g_of_type_AndroidWidgetTextView.setVisibility(0);
      return;
    } while (10 != paramInt1);
  ...
  public void a(View paramView, String paramString1, String paramString2, AppInterface paramAppInterface, aiuv paramaiuv)
  {
    if ((paramView == null) || (paramAppInterface == null) || (paramString1 == null)) {
      return;
    }
    this.jdField_a_of_type_Aiuv = paramaiuv;
    ...
    {
      this.jdField_a_of_type_Befq.sendEmptyMessage(258);
      this.jdField_a_of_type_Befq.removeMessages(264);
      this.jdField_a_of_type_Befq.sendEmptyMessageDelayed(264, 1000L);
    }
    for (;;)
    {
      ...
      return;
      this.jdField_a_of_type_Befq.removeMessages(264);
      this.jdField_a_of_type_Befq.sendEmptyMessage(264);
      this.jdField_a_of_type_Befq.sendEmptyMessageDelayed(258, 500L);
    }
  }
  ...
  void a(TextView paramTextView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    localValueAnimator.addUpdateListener(new aiut(this, paramTextView));
  ...
  void a(File paramFile, String paramString)
  {
    ...
    batm localbatm = new batm(paramString, paramFile);
    localbatm.p = true;
    localbatm.j = false;
    localbatm.n = true;
    localbatm.s = false;
    localbatm.q = true;
    localbatm.r = true;
    localbatm.jdField_b_of_type_Boolean = true;
    localbatm.jdField_f_of_type_JavaLangString = "apollo_res";
    Bundle localBundle = new Bundle();
    localBundle.putString("path", paramFile.getPath());
    localBundle.putString("url", paramString);
    this.jdField_a_of_type_Batr.a(localbatm, this.jdField_a_of_type_Batl, null);
  }
  ...
  public void a(String paramString1, boolean paramBoolean, long paramLong, Object paramObject, String paramString2)
  {
    ...
    do
    {
      ...
      paramString1 = this.jdField_a_of_type_Befq.obtainMessage(257);
      ...
      if ("apollo_interact.thank_zan".equals(paramString1))
      {
        ...
        {
          this.jdField_b_of_type_Boolean = false;
          this.jdField_a_of_type_Befq.obtainMessage(261).sendToTarget();
          return;
        }
        this.jdField_a_of_type_Befq.obtainMessage(262).sendToTarget();
        return;
      }
    } while (!"apollo_interact.take_chips".equals(paramString1));
    this.jdField_a_of_type_Befq.removeMessages(258);
    if ((paramObject instanceof aiuq)) {
      this.jdField_a_of_type_Aiuq = ((aiuq)paramObject);
    }
    this.jdField_a_of_type_Long = paramLong;
    if ((this.jdField_a_of_type_Aiuq != null) && ((this.jdField_a_of_type_Long == -501030L) || (this.jdField_a_of_type_Aiuq.jdField_b_of_type_Long == -501030L)))
    {
      if (this.jdField_a_of_type_Aiuq.jdField_b_of_type_JavaUtilList == null) {
        this.jdField_a_of_type_Aiuq.jdField_b_of_type_JavaUtilList = new ArrayList();
      }
      paramString1 = new aiur();
      paramString1.jdField_g_of_type_Int = 1;
      this.jdField_a_of_type_Aiuq.jdField_b_of_type_JavaUtilList.add(0, paramString1);
    }
    if (paramBoolean)
    {
      ...
      {
        this.jdField_a_of_type_Befq.obtainMessage(260).sendToTarget();
        return;
      }
      if (this.jdField_a_of_type_Long == -501028L)
      {
        this.jdField_e_of_type_JavaLangString = jdField_b_of_type_JavaLangString;
        this.jdField_a_of_type_Befq.obtainMessage(259).sendToTarget();
        return;
      }
      this.jdField_e_of_type_JavaLangString = jdField_a_of_type_JavaLangString;
      this.jdField_a_of_type_Befq.obtainMessage(259).sendToTarget();
  ...
  {
    if ((!paramBoolean) && (this.jdField_a_of_type_Aiuv != null)) {
      this.jdField_a_of_type_Aiuv.a(this.jdField_c_of_type_JavaLangString);
    }
  ...
  void c()
  {
    ...
    File localFile1;
    File localFile2;
    if ((this.jdField_a_of_type_Aiuq != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloStoreOpenboxApolloOpenBoxView != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_Aiuq.jdField_e_of_type_JavaLangString)) && (!TextUtils.isEmpty(this.jdField_a_of_type_Aiuq.jdField_d_of_type_JavaLangString)))
    {
      localObject1 = bcdu.d(this.jdField_a_of_type_Aiuq.jdField_d_of_type_JavaLangString);
      localObject3 = bcdu.d(this.jdField_a_of_type_Aiuq.jdField_e_of_type_JavaLangString);
      localFile1 = new File(aiys.k + (String)localObject1 + ".cache");
      localFile2 = new File(aiys.k + (String)localObject3 + ".cache");
    ...
    synchronized (jdField_a_of_type_JavaUtilMap)
    {
      ...
      for (localObject1 = (Drawable)jdField_a_of_type_JavaUtilMap.get(localObject1); jdField_a_of_type_JavaUtilMap.containsKey(localObject3); localObject1 = null)
      {
        ...
        if (!localFile1.exists()) {
          a(localFile1, this.jdField_a_of_type_Aiuq.jdField_d_of_type_JavaLangString);
        }
        if (!localFile2.exists()) {
          a(localFile2, this.jdField_a_of_type_Aiuq.jdField_e_of_type_JavaLangString);
        }
        return;
      }
      localObject3 = null;
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          if (this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.size() > 0)
          {
            paramMessage = (aius)this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.get(0);
            if ((paramMessage != null) && (paramMessage.jdField_c_of_type_Int > 0))
            {
              ...
              ((URLDrawable.URLDrawableOptions)localObject).mLoadingDrawable = super.getResources().getDrawable(2130838266);
              localObject = aitu.a("apollo_card_first_image.png", (URLDrawable.URLDrawableOptions)localObject, paramMessage.jdField_a_of_type_JavaLangString);
              ...
              a(0);
              this.jdField_c_of_type_AndroidWidgetTextView.setText(aiuq.c(paramMessage.jdField_b_of_type_Int - paramMessage.jdField_c_of_type_Int));
              ...
              if (this.jdField_c_of_type_AndroidWidgetImageView == null)
              {
                ...
                this.jdField_c_of_type_AndroidWidgetImageView.setId(2131299867);
              ...
              this.jdField_a_of_type_Befq.sendEmptyMessageDelayed(266, 650L);
            }
          }
        } while (!QLog.isColorLevel());
        QLog.d("ApolloCardWindow", 2, "MSG_CODE_ADD_CARD:");
        return false;
        this.jdField_a_of_type_Aiuw.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_c_of_type_JavaLangString, this.jdField_f_of_type_JavaLangString, (AppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get());
        return false;
      } while (this.jdField_a_of_type_Aiuq == null);
      return false;
      ...
      this.jdField_e_of_type_AndroidWidgetTextView.setVisibility(8);
      return false;
      if (this.jdField_a_of_type_Aiuq != null)
      {
        if (Build.VERSION.SDK_INT >= 11)
        {
          paramMessage = this.jdField_d_of_type_AndroidWidgetImageView;
          if (!this.jdField_a_of_type_Aiuq.jdField_a_of_type_Boolean) {
            break label686;
          }
          f1 = 1.0F;
      ...
      for (m = -1;; m = -2130706433)
      {
        ...
        bbmy.a(this.jdField_a_of_type_AndroidContentContext, ajjy.a(2131634513), 0).a();
        return false;
        f1 = 0.5F;
        break label629;
      }
    ...
    label686:
    label693:
    bbmy.a(this.jdField_a_of_type_AndroidContentContext, ajjy.a(2131634508), 0).a();
    return false;
    super.setVisibility(0);
    c();
    if (this.jdField_a_of_type_Aiuq == null)
    ...
    if ((!TextUtils.isEmpty(this.jdField_d_of_type_JavaLangString)) && (this.jdField_d_of_type_JavaLangString.equals(this.jdField_c_of_type_JavaLangString)))
    {
      ...
      label890:
      if ((this.jdField_a_of_type_Aiuq.jdField_b_of_type_Long == 0L) && (this.jdField_a_of_type_Aiuq.jdField_a_of_type_Long != -501031L)) {
        break label1168;
      }
      if (this.jdField_a_of_type_Aiuq.jdField_b_of_type_Int <= 0) {
        break label1138;
      }
      if ((TextUtils.isEmpty(this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaLangString)) || (!this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaLangString.equals(this.jdField_a_of_type_Aiuq.jdField_b_of_type_JavaLangString))) {
        break label1130;
      }
    ...
    for (;;)
    {
      bajr.a(null, "cmshow", "Apollo", "openfloatagain", this.jdField_a_of_type_Int, 0, new String[] { String.valueOf(this.jdField_b_of_type_Int) });
      label996:
      e();
      return false;
      if (this.jdField_a_of_type_Aiuq.jdField_b_of_type_Int > 0)
      ...
      continue;
      label1138:
      if (this.jdField_a_of_type_Aiuq.jdField_b_of_type_Long == -501030L) {
    ...
    if (this.jdField_a_of_type_Aiuq.jdField_b_of_type_Int > 0) {
      ...
      {
        this.jdField_b_of_type_Int = 1;
        paramMessage = (aius)this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(3));
        if ((paramMessage != null) && (paramMessage.jdField_c_of_type_Int > 0)) {
          bajr.a(null, "cmshow", "Apollo", "0X80065C2", this.jdField_a_of_type_Int, 0, new String[] { "", String.valueOf(paramMessage.jdField_c_of_type_Int), "" });
        }
        paramMessage = (aius)this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(7));
        if ((paramMessage != null) && (paramMessage.jdField_c_of_type_Int > 0)) {
          bajr.a(null, "cmshow", "Apollo", "0X80065C04", this.jdField_a_of_type_Int, 0, new String[] { "", String.valueOf(paramMessage.jdField_c_of_type_Int), "" });
        }
        paramMessage = (aius)this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(15));
        if ((paramMessage != null) && (paramMessage.jdField_c_of_type_Int > 0)) {
          bajr.a(null, "cmshow", "Apollo", "0X80065C06", this.jdField_a_of_type_Int, 0, new String[] { "", String.valueOf(paramMessage.jdField_c_of_type_Int), "" });
        }
      }
    }
    for (int m = 0;; m = 1)
    {
      bajr.a(null, "cmshow", "Apollo", "0X80065C1", this.jdField_a_of_type_Int, 0, new String[] { String.valueOf(m), String.valueOf(this.jdField_a_of_type_Aiuq.jdField_b_of_type_Int) });
      break label996;
      this.jdField_b_of_type_Int = 2;
      if ((this.jdField_a_of_type_Aiuq.jdField_c_of_type_JavaUtilList != null) && (!this.jdField_a_of_type_Aiuq.jdField_c_of_type_JavaUtilList.isEmpty()))
      {
        paramMessage = this.jdField_a_of_type_Aiuq.jdField_c_of_type_JavaUtilList.iterator();
        for (;;)
        {
          if (paramMessage.hasNext())
          {
            localObject = (aiur)paramMessage.next();
            aius localaius = (aius)this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(3));
            if ((localaius != null) && (localaius.jdField_c_of_type_Int > 0)) {
              bajr.a(null, "cmshow", "Apollo", "0X80065C3", this.jdField_a_of_type_Int, 0, new String[] { String.valueOf(((aiur)localObject).jdField_a_of_type_Int), String.valueOf(0), String.valueOf(((aiur)localObject).jdField_a_of_type_Short) });
            }
            localObject = (aius)this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(7));
            if ((localObject != null) && (((aius)localObject).jdField_c_of_type_Int > 0)) {
              bajr.a(null, "cmshow", "Apollo", "0X80065C3", this.jdField_a_of_type_Int, 0, new String[] { "0", String.valueOf(0), "4" });
            }
            localObject = (aius)this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(15));
            if ((localObject != null) && (((aius)localObject).jdField_c_of_type_Int > 0))
            {
              bajr.a(null, "cmshow", "Apollo", "0X80065C3", this.jdField_a_of_type_Int, 0, new String[] { "0", String.valueOf(0), "5" });
              continue;
              if (this.jdField_a_of_type_Aiuq.jdField_a_of_type_Long == -501030L)
              {
                this.jdField_b_of_type_Int = 3;
                bajr.a(null, "cmshow", "Apollo", "0X80065C4", this.jdField_a_of_type_Int, 0, new String[] { "0", "0", "1" });
                break label996;
              }
              this.jdField_b_of_type_Int = 4;
              bajr.a(null, "cmshow", "Apollo", "0X80065C5", this.jdField_a_of_type_Int, 0, new String[0]);
              break label996;
              ...
              paramMessage.mLoadingDrawable = bacm.b();
              ...
              return false;
              if ((this.jdField_a_of_type_Aiuq == null) || (this.jdField_a_of_type_Aiuq.jdField_b_of_type_JavaUtilList == null)) {
                break;
              }
              ...
              if (this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.size() > 0)
              {
                ...
                {
                  this.jdField_a_of_type_Befq.sendEmptyMessageDelayed(255, 500L);
                  n = 650;
                  m = 650;
                }
              }
              for (;;)
              {
                ...
                if (this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.size() > 1)
                {
                  paramMessage = (aius)this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.get(1);
                  i1 = m;
                  if (paramMessage != null)
                  {
                    i1 = m;
                    if (paramMessage.jdField_a_of_type_Boolean)
                    {
                      ...
                      {
                        this.jdField_a_of_type_Befq.sendEmptyMessageDelayed(265, n + 500);
                        i1 = m + 150 + 500;
                      }
                    }
                  }
                ...
                paramMessage = (aius)this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.get(2);
                if ((paramMessage == null) || (!paramMessage.jdField_a_of_type_Boolean) || (paramMessage.jdField_c_of_type_Int <= 0)) {
                  break;
                }
                this.jdField_a_of_type_Befq.sendEmptyMessageDelayed(268, i1 + 500);
                return false;
                if (this.jdField_a_of_type_Aiuq == null) {
                  break;
                }
                if (this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.size() > 1)
                {
                  ...
                  if ((paramMessage != null) && (paramMessage.jdField_c_of_type_Int > 0))
                  {
                    this.jdField_f_of_type_AndroidWidgetTextView.setText("+" + paramMessage.jdField_c_of_type_Int);
                    localObject = URLDrawable.URLDrawableOptions.obtain();
                    ((URLDrawable.URLDrawableOptions)localObject).mLoadingDrawable = super.getResources().getDrawable(2130838267);
                    localObject = aitu.a("apollo_card_first_image.png", (URLDrawable.URLDrawableOptions)localObject, paramMessage.jdField_a_of_type_JavaLangString);
                    m = ApolloUtil.a(25.0F / jdField_a_of_type_Float, jdField_b_of_type_Float);
                    ...
                    this.jdField_h_of_type_AndroidWidgetTextView.setText(aiuq.b(paramMessage.jdField_b_of_type_Int - paramMessage.jdField_c_of_type_Int));
                    ...
                    if (this.jdField_g_of_type_AndroidWidgetImageView == null)
                    {
                      ...
                      this.jdField_g_of_type_AndroidWidgetImageView.setId(2131307784);
                    ...
                    this.jdField_a_of_type_Befq.sendEmptyMessageDelayed(267, 650L);
                  }
                }
                if (!QLog.isColorLevel()) {
                  break;
                ...
                if (this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.size() > 2)
                {
                  ...
                  {
                    this.jdField_f_of_type_AndroidWidgetTextView.setText("+" + paramMessage.jdField_c_of_type_Int);
                    localObject = aitu.a("apollo_card_props_image.png", null, paramMessage.jdField_a_of_type_JavaLangString);
                    m = ApolloUtil.a(25.0F / jdField_a_of_type_Float, jdField_b_of_type_Float);
                    ((URLDrawable)localObject).setBounds(0, 0, m, m);
                    this.jdField_f_of_type_AndroidWidgetTextView.setCompoundDrawables((Drawable)localObject, null, null, null);
                    ...
                    this.jdField_i_of_type_AndroidWidgetTextView.setText(aiuq.a(paramMessage.jdField_b_of_type_Int - paramMessage.jdField_c_of_type_Int));
                    ...
                    if (this.jdField_i_of_type_AndroidWidgetImageView == null)
                    {
                      ...
                      this.jdField_i_of_type_AndroidWidgetImageView.setId(2131307784);
                    ...
                    this.jdField_a_of_type_Befq.sendEmptyMessageDelayed(269, 650L);
                  }
                }
                ...
                this.jdField_c_of_type_AndroidWidgetImageView.setImageResource(2130838269);
                return false;
                if (this.jdField_g_of_type_AndroidWidgetImageView == null) {
                  break;
                }
                this.jdField_g_of_type_AndroidWidgetImageView.setImageResource(2130838269);
                return false;
                if (this.jdField_i_of_type_AndroidWidgetImageView == null) {
                  break;
                }
                this.jdField_i_of_type_AndroidWidgetImageView.setImageResource(2130838269);
                return false;
                m = 0;
                n = 0;
              }
  ...
  public void onClick(View paramView)
  {
    ...
    {
      bajr.a(null, "cmshow", "Apollo", "0X80065C8", this.jdField_a_of_type_Int, 0, new String[0]);
      a(false);
    }
    label642:
    do
    {
      do
      {
        ...
        do
        {
          ...
          do
          {
            ...
            } while ((!this.jdField_c_of_type_Boolean) || (this.jdField_a_of_type_Aiuq == null));
            localObject2 = new Intent(this.jdField_a_of_type_AndroidContentContext, QQBrowserActivity.class);
            localObject1 = aiys.aa + "&adtag=floatlayer";
            paramView = (View)localObject1;
            if (this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.size() > 0)
            {
              aius localaius = (aius)this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.get(0);
              paramView = (View)localObject1;
              if (!TextUtils.isEmpty(localaius.jdField_b_of_type_JavaLangString)) {
                paramView = localaius.jdField_b_of_type_JavaLangString;
              }
            }
            ...
            bajr.a(null, "cmshow", "Apollo", "0X80065C01", this.jdField_a_of_type_Int, 0, new String[0]);
            a(false);
            return;
          ...
          localObject1 = aiys.Z + "&adtag=floatlayer";
          paramView = (View)localObject1;
          if (this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.size() > 1)
          {
            localObject2 = (aius)this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.get(1);
            paramView = (View)localObject1;
            if (!TextUtils.isEmpty(((aius)localObject2).jdField_b_of_type_JavaLangString)) {
              paramView = ((aius)localObject2).jdField_b_of_type_JavaLangString;
            }
          }
          ...
          bajr.a(null, "cmshow", "Apollo", "0X80065C03", this.jdField_a_of_type_Int, 0, new String[0]);
          a(false);
          return;
        ...
        if (this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.size() > 2)
        {
          paramView = (aius)this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.get(2);
          if (!TextUtils.isEmpty(paramView.jdField_b_of_type_JavaLangString))
          {
            ...
            bajr.a(null, "cmshow", "Apollo", "0X80065C001", this.jdField_a_of_type_Int, 0, new String[0]);
          }
        }
        a(false);
        return;
      ...
      } while ((this.jdField_a_of_type_Aiuq == null) || (!this.jdField_c_of_type_Boolean));
      if ((this.jdField_a_of_type_Aiuq.jdField_a_of_type_Boolean) && (!this.jdField_b_of_type_Boolean)) {
        if (badq.g(this.jdField_a_of_type_AndroidContentContext))
        {
          ...
          this.jdField_a_of_type_Aiuw.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Aiuq.jdField_c_of_type_Long, (AppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), this.jdField_f_of_type_JavaLangString, this.jdField_c_of_type_JavaLangString);
          f();
        }
      }
      for (int m = 1;; m = 2)
      {
        if ((this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.size() > 2) && (((aius)this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.get(2)).jdField_c_of_type_Int > 0)) {
          bajr.a(null, "cmshow", "Apollo", "sendflower", m, 0, new String[] { "3" });
        }
        if ((this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.size() > 1) && (((aius)this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.get(1)).jdField_c_of_type_Int > 0)) {
          bajr.a(null, "cmshow", "Apollo", "sendflower", m, 0, new String[] { "2" });
        }
        if ((this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.size() <= 0) || (((aius)this.jdField_a_of_type_Aiuq.jdField_a_of_type_JavaUtilList.get(0)).jdField_c_of_type_Int <= 0)) {
          break;
        }
        bajr.a(null, "cmshow", "Apollo", "sendflower", m, 0, new String[] { "1" });
        return;
        bbmy.a(this.jdField_a_of_type_AndroidContentContext, ajjy.a(2131634516), 0).a();
        break label642;
        bbmy.a(this.jdField_a_of_type_AndroidContentContext, ajjy.a(2131634506), 0).a();
      }
    } while ((this != paramView) || (!this.jdField_c_of_type_Boolean) || (this.jdField_e_of_type_Boolean));
    bajr.a(null, "cmshow", "Apollo", "clickblackfloat", this.jdField_a_of_type_Int, 0, new String[0]);
    a(false);
  }
