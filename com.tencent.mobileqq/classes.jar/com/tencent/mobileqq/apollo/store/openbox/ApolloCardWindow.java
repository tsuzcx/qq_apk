  ...
  implements Handler.Callback, View.OnClickListener, BoxCardHandler.onBoxCardHandlerListener, IApolloOpenBoxListener, MultilScreenlLayout.OnClickScrollLayoutListener
{
  ...
  private static final String jdField_a_of_type_JavaLangString = HardCodeUtil.a(2131700394);
  static Map<String, Drawable> jdField_a_of_type_JavaUtilMap = new HashMap();
  private static boolean jdField_a_of_type_Boolean;
  static float jdField_b_of_type_Float;
  private static final String jdField_b_of_type_JavaLangString = HardCodeUtil.a(2131700383);
  ...
  private RoundRectLinearLayout jdField_b_of_type_ComTencentMobileqqApolloApiStoreOpenboxRoundRectLinearLayout;
    ...
    do
    {
      ...
      while (m <= 9)
      {
        ...
        if (!new File("/sdcard/Android/data/com.tencent.mobileqq/Tencent/MobileQQ/.apollo/image_cache/boxcard/" + str).exists()) {
          ((IApolloUtil)QRoute.api(IApolloUtil.class)).getDrawable(str, null, ((IApolloUtil)QRoute.api(IApolloUtil.class)).getApolloImageUrl(str)).startDownload();
        }
        m += 1;
      }
  ...
  private void d()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(2131690946);
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
    super.addView(this.jdField_a_of_type_AndroidWidgetTextView, (ViewGroup.LayoutParams)localObject3);
    this.jdField_b_of_type_ComTencentMobileqqApolloApiStoreOpenboxRoundRectLinearLayout = new RoundRectLinearLayout(this.jdField_a_of_type_AndroidContentContext);
    this.jdField_b_of_type_ComTencentMobileqqApolloApiStoreOpenboxRoundRectLinearLayout.setOrientation(0);
    this.jdField_b_of_type_ComTencentMobileqqApolloApiStoreOpenboxRoundRectLinearLayout.setGravity(17);
    this.jdField_b_of_type_ComTencentMobileqqApolloApiStoreOpenboxRoundRectLinearLayout.setClickable(true);
    this.jdField_b_of_type_ComTencentMobileqqApolloApiStoreOpenboxRoundRectLinearLayout.setRoundRect(ApolloUtilImpl.dp2px(15.0F, jdField_b_of_type_Float), -1, true);
    localObject3 = new RelativeLayout.LayoutParams(-2, ApolloUtilImpl.dp2px(30.0F, jdField_b_of_type_Float));
    ((RelativeLayout.LayoutParams)localObject3).topMargin = ((int)(m * 0.018F));
    ((RelativeLayout.LayoutParams)localObject3).addRule(10);
    ((RelativeLayout.LayoutParams)localObject3).addRule(9);
    this.jdField_b_of_type_ComTencentMobileqqApolloApiStoreOpenboxRoundRectLinearLayout.setPadding(0, 0, ApolloUtilImpl.dp2px(12.0F, jdField_b_of_type_Float), 0);
    super.addView(this.jdField_b_of_type_ComTencentMobileqqApolloApiStoreOpenboxRoundRectLinearLayout, (ViewGroup.LayoutParams)localObject3);
    this.jdField_b_of_type_AndroidWidgetImageView = new ImageView(this.jdField_a_of_type_AndroidContentContext);
    localObject3 = new LinearLayout.LayoutParams(ApolloUtilImpl.dp2px(15.0F, jdField_b_of_type_Float), ApolloUtilImpl.dp2px(17.0F, jdField_b_of_type_Float));
    ((LinearLayout.LayoutParams)localObject3).leftMargin = ApolloUtilImpl.dp2px(12.0F, jdField_b_of_type_Float);
    this.jdField_b_of_type_ComTencentMobileqqApolloApiStoreOpenboxRoundRectLinearLayout.addView(this.jdField_b_of_type_AndroidWidgetImageView, (ViewGroup.LayoutParams)localObject3);
    ...
    ((LinearLayout.LayoutParams)localObject3).leftMargin = ApolloUtilImpl.dp2px(3.0F, jdField_b_of_type_Float);
    this.jdField_b_of_type_ComTencentMobileqqApolloApiStoreOpenboxRoundRectLinearLayout.addView(this.jdField_c_of_type_AndroidWidgetTextView, (ViewGroup.LayoutParams)localObject3);
    ...
    localObject3 = new LinearLayout.LayoutParams(ApolloUtilImpl.dp2px(15.0F, jdField_b_of_type_Float), ApolloUtilImpl.dp2px(17.0F, jdField_b_of_type_Float));
    ((LinearLayout.LayoutParams)localObject3).leftMargin = ApolloUtilImpl.dp2px(15.0F, jdField_b_of_type_Float);
    this.jdField_b_of_type_ComTencentMobileqqApolloApiStoreOpenboxRoundRectLinearLayout.addView(this.jdField_f_of_type_AndroidWidgetImageView, (ViewGroup.LayoutParams)localObject3);
    ...
    localObject3 = new LinearLayout.LayoutParams(-2, -2);
    ((LinearLayout.LayoutParams)localObject3).leftMargin = ApolloUtilImpl.dp2px(3.0F, jdField_b_of_type_Float);
    this.jdField_b_of_type_ComTencentMobileqqApolloApiStoreOpenboxRoundRectLinearLayout.addView(this.jdField_h_of_type_AndroidWidgetTextView, (ViewGroup.LayoutParams)localObject3);
    ...
    localObject3 = new LinearLayout.LayoutParams(ApolloUtilImpl.dp2px(15.0F, jdField_b_of_type_Float), ApolloUtilImpl.dp2px(17.0F, jdField_b_of_type_Float));
    ((LinearLayout.LayoutParams)localObject3).leftMargin = ApolloUtilImpl.dp2px(15.0F, jdField_b_of_type_Float);
    this.jdField_b_of_type_ComTencentMobileqqApolloApiStoreOpenboxRoundRectLinearLayout.addView(this.jdField_h_of_type_AndroidWidgetImageView, (ViewGroup.LayoutParams)localObject3);
    ...
    localObject3 = new LinearLayout.LayoutParams(-2, -2);
    ((LinearLayout.LayoutParams)localObject3).leftMargin = ApolloUtilImpl.dp2px(3.0F, jdField_b_of_type_Float);
    this.jdField_b_of_type_ComTencentMobileqqApolloApiStoreOpenboxRoundRectLinearLayout.addView(this.jdField_i_of_type_AndroidWidgetTextView, (ViewGroup.LayoutParams)localObject3);
    ...
    this.jdField_g_of_type_AndroidWidgetTextView.setText(HardCodeUtil.a(2131700393));
    localObject3 = new RelativeLayout.LayoutParams(-2, -2);
    ...
    ((LinearLayout.LayoutParams)localObject3).bottomMargin = ApolloUtilImpl.dp2px(25.0F, jdField_b_of_type_Float);
    ...
    localObject3 = new LinearLayout.LayoutParams(-1, ApolloUtilImpl.dp2px(250.0F, jdField_b_of_type_Float) * 3 / 4);
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130839547);
    ...
    this.jdField_a_of_type_ComTencentMobileqqApolloApiStoreOpenboxRoundRectLinearLayout = new RoundRectLinearLayout(this.jdField_a_of_type_AndroidContentContext);
    this.jdField_a_of_type_ComTencentMobileqqApolloApiStoreOpenboxRoundRectLinearLayout.setGravity(17);
    this.jdField_a_of_type_ComTencentMobileqqApolloApiStoreOpenboxRoundRectLinearLayout.setRoundRect((int)(n * 0.008F), -7707920, false);
    this.jdField_d_of_type_AndroidWidgetImageView = new ImageView(this.jdField_a_of_type_AndroidContentContext);
    this.jdField_d_of_type_AndroidWidgetImageView.setBackgroundResource(2130838578);
    localObject2 = new LinearLayout.LayoutParams(-2, -2);
    this.jdField_a_of_type_ComTencentMobileqqApolloApiStoreOpenboxRoundRectLinearLayout.addView(this.jdField_d_of_type_AndroidWidgetImageView, (ViewGroup.LayoutParams)localObject2);
    ...
    this.jdField_a_of_type_ComTencentMobileqqApolloApiStoreOpenboxRoundRectLinearLayout.addView(this.jdField_d_of_type_AndroidWidgetTextView, (ViewGroup.LayoutParams)localObject2);
    this.jdField_a_of_type_ComTencentMobileqqApolloApiStoreOpenboxRoundRectLinearLayout.setOnClickListener(this);
    localObject2 = new LinearLayout.LayoutParams(0, -1);
    ((LinearLayout.LayoutParams)localObject2).weight = 1.0F;
    this.jdField_a_of_type_AndroidWidgetLinearLayout.addView(this.jdField_a_of_type_ComTencentMobileqqApolloApiStoreOpenboxRoundRectLinearLayout, (ViewGroup.LayoutParams)localObject2);
    ...
    this.jdField_e_of_type_AndroidWidgetImageView.setBackgroundResource(2130838577);
  ...
  private void e()
  {
    ...
    if (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqApolloStoreOpenboxApolloBoxData.jdField_c_of_type_JavaLangString))
    {
      localObject1 = "";
      label50:
      if ((TextUtils.isEmpty(this.jdField_d_of_type_JavaLangString)) || (!this.jdField_d_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqApolloStoreOpenboxApolloBoxData.jdField_b_of_type_JavaLangString))) {
        break label1813;
      }
      localObject1 = HardCodeUtil.a(2131700390);
    }
    label897:
    label1803:
    label1808:
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreOpenboxApolloBoxData.jdField_a_of_type_JavaUtilList.size() == 3)
      {
        ...
        if (localObject2 != null)
        {
          ...
          {
            localObject3 = ((IApolloUtil)QRoute.api(IApolloUtil.class)).getDrawable(Utils.Crc64String(((ApolloBoxData.BoxCardListSummary)localObject2).jdField_a_of_type_JavaLangString), null, ((ApolloBoxData.BoxCardListSummary)localObject2).jdField_a_of_type_JavaLangString);
      ...
      for (;;)
      {
        ...
        this.jdField_b_of_type_ComTencentMobileqqApolloApiStoreOpenboxRoundRectLinearLayout.setVisibility(0);
        ...
        this.jdField_e_of_type_AndroidWidgetTextView.setText(HardCodeUtil.a(2131700387) + (String)localObject1 + HardCodeUtil.a(2131700388));
  ...
  void a(int paramInt)
  {
    ...
    QuadBezierAnimation localQuadBezierAnimation = new QuadBezierAnimation(0, 0, 0, -ApolloUtilImpl.dp2px(144.0F, jdField_b_of_type_Float), -(ApolloUtilImpl.dp2px(195.0F, jdField_b_of_type_Float) - paramInt), -ApolloUtilImpl.dp2px(164.0F, jdField_b_of_type_Float));
  ...
  public void a(View paramView, String paramString1, String paramString2, AppInterface paramAppInterface, ApolloCardWindow.OnCloseCardWindowListener paramOnCloseCardWindowListener)
  {
    ...
    this.jdField_b_of_type_ComTencentMobileqqApolloApiStoreOpenboxRoundRectLinearLayout.setVisibility(8);
  ...
  public void a(boolean paramBoolean)
  {
    if ((!paramBoolean) && (this.jdField_a_of_type_ComTencentMobileqqApolloStoreOpenboxApolloCardWindow$OnCloseCardWindowListener != null)) {
      this.jdField_a_of_type_ComTencentMobileqqApolloStoreOpenboxApolloCardWindow$OnCloseCardWindowListener.a(this.jdField_c_of_type_JavaLangString);
    }
  ...
  void c()
  {
    ...
    File localFile1;
    File localFile2;
    if ((this.jdField_a_of_type_ComTencentMobileqqApolloStoreOpenboxApolloBoxData != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloStoreOpenboxApolloOpenBoxView != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqApolloStoreOpenboxApolloBoxData.jdField_e_of_type_JavaLangString)) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqApolloStoreOpenboxApolloBoxData.jdField_d_of_type_JavaLangString)))
    {
      ...
      localObject3 = MD5Utils.toMD5(this.jdField_a_of_type_ComTencentMobileqqApolloStoreOpenboxApolloBoxData.jdField_e_of_type_JavaLangString);
    ...
    synchronized (jdField_a_of_type_JavaUtilMap)
    {
      ...
      for (localObject1 = (Drawable)jdField_a_of_type_JavaUtilMap.get(localObject1); jdField_a_of_type_JavaUtilMap.containsKey(localObject3); localObject1 = null)
      {
        ...
        if (!localFile2.exists()) {
          a(localFile2, this.jdField_a_of_type_ComTencentMobileqqApolloStoreOpenboxApolloBoxData.jdField_e_of_type_JavaLangString);
        }
        return;
      }
      localObject3 = null;
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
        ...
        do
        {
          ...
          if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreOpenboxApolloBoxData.jdField_a_of_type_JavaUtilList.size() > 0)
          {
            ...
            if ((paramMessage != null) && (paramMessage.jdField_c_of_type_Int > 0))
            {
              ...
              ((URLDrawable.URLDrawableOptions)localObject).mLoadingDrawable = super.getResources().getDrawable(2130838573);
              localObject = ((IApolloUtil)QRoute.api(IApolloUtil.class)).getDrawable("apollo_card_first_image.png", (URLDrawable.URLDrawableOptions)localObject, paramMessage.jdField_a_of_type_JavaLangString);
              m = ApolloUtilImpl.dp2px(25.0F / jdField_a_of_type_Float, jdField_b_of_type_Float);
              ...
              if (this.jdField_c_of_type_AndroidWidgetImageView == null)
              {
                ...
                this.jdField_c_of_type_AndroidWidgetImageView.setId(2131366105);
                this.jdField_c_of_type_AndroidWidgetImageView.setScaleType(ImageView.ScaleType.CENTER_CROP);
                paramMessage = new RelativeLayout.LayoutParams(ApolloUtilImpl.dp2px(15.0F, jdField_b_of_type_Float), ApolloUtilImpl.dp2px(15.0F, jdField_b_of_type_Float));
                paramMessage.leftMargin = ApolloUtilImpl.dp2px(12.0F, jdField_b_of_type_Float);
                paramMessage.topMargin = (((RelativeLayout.LayoutParams)this.jdField_b_of_type_ComTencentMobileqqApolloApiStoreOpenboxRoundRectLinearLayout.getLayoutParams()).topMargin + ApolloUtilImpl.dp2px(7.5F, jdField_b_of_type_Float));
      ...
      for (m = -1;; m = -2130706433)
      {
        ...
        QQToast.a(this.jdField_a_of_type_AndroidContentContext, HardCodeUtil.a(2131700389), 0).a();
        return false;
        f1 = 0.5F;
        break label639;
      }
    ...
    label696:
    label703:
    QQToast.a(this.jdField_a_of_type_AndroidContentContext, HardCodeUtil.a(2131700384), 0).a();
    return false;
    super.setVisibility(0);
    c();
    if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreOpenboxApolloBoxData == null)
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqApolloApiStoreOpenboxRoundRectLinearLayout.setVisibility(8);
      this.jdField_b_of_type_AndroidWidgetLinearLayout.setVisibility(8);
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreOpenboxApolloBoxData.jdField_b_of_type_Int > 0)
      {
        this.jdField_a_of_type_ComTencentMobileqqApolloApiStoreOpenboxRoundRectLinearLayout.setVisibility(0);
        if (Build.VERSION.SDK_INT >= 11)
        {
          paramMessage = this.jdField_d_of_type_AndroidWidgetImageView;
          if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreOpenboxApolloBoxData.jdField_a_of_type_Boolean)
        ...
        for (;;)
        {
          if (paramMessage.hasNext())
          {
            ...
            if ((localObject != null) && (((ApolloBoxData.BoxCardListSummary)localObject).jdField_c_of_type_Int > 0))
            {
              ...
              paramMessage.mLoadingDrawable = ImageUtil.c();
              paramMessage.mFailedDrawable = paramMessage.mLoadingDrawable;
              localObject = new ApolloDrawableExtraInfo();
              ((ApolloDrawableExtraInfo)localObject).mDrawableType = ApolloConstant.jdField_h_of_type_Int;
              ...
              for (;;)
              {
                ...
                if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreOpenboxApolloBoxData.jdField_a_of_type_JavaUtilList.size() > 1)
                {
                  ...
                  if ((paramMessage != null) && (paramMessage.jdField_c_of_type_Int > 0))
                  {
                    this.jdField_f_of_type_AndroidWidgetTextView.setText("+" + paramMessage.jdField_c_of_type_Int);
                    localObject = URLDrawable.URLDrawableOptions.obtain();
                    ((URLDrawable.URLDrawableOptions)localObject).mLoadingDrawable = super.getResources().getDrawable(2130838574);
                    localObject = ((IApolloUtil)QRoute.api(IApolloUtil.class)).getDrawable("apollo_card_first_image.png", (URLDrawable.URLDrawableOptions)localObject, paramMessage.jdField_a_of_type_JavaLangString);
                    m = ApolloUtilImpl.dp2px(25.0F / jdField_a_of_type_Float, jdField_b_of_type_Float);
                    ...
                    if (this.jdField_g_of_type_AndroidWidgetImageView == null)
                    {
                      ...
                      this.jdField_g_of_type_AndroidWidgetImageView.setId(2131375248);
                      this.jdField_g_of_type_AndroidWidgetImageView.setScaleType(ImageView.ScaleType.CENTER_CROP);
                      paramMessage = new RelativeLayout.LayoutParams(ApolloUtilImpl.dp2px(15.0F, jdField_b_of_type_Float), ApolloUtilImpl.dp2px(15.0F, jdField_b_of_type_Float));
                      paramMessage.leftMargin = (ApolloUtilImpl.dp2px(47.0F, jdField_b_of_type_Float) + this.jdField_c_of_type_AndroidWidgetTextView.getWidth());
                      paramMessage.topMargin = (((RelativeLayout.LayoutParams)this.jdField_b_of_type_ComTencentMobileqqApolloApiStoreOpenboxRoundRectLinearLayout.getLayoutParams()).topMargin + ApolloUtilImpl.dp2px(7.5F, jdField_b_of_type_Float));
                ...
                if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreOpenboxApolloBoxData.jdField_a_of_type_JavaUtilList.size() > 2)
                {
                  ...
                  {
                    this.jdField_f_of_type_AndroidWidgetTextView.setText("+" + paramMessage.jdField_c_of_type_Int);
                    localObject = ((IApolloUtil)QRoute.api(IApolloUtil.class)).getDrawable("apollo_card_props_image.png", null, paramMessage.jdField_a_of_type_JavaLangString);
                    m = ApolloUtilImpl.dp2px(25.0F / jdField_a_of_type_Float, jdField_b_of_type_Float);
                    ((URLDrawable)localObject).setBounds(0, 0, m, m);
                    this.jdField_f_of_type_AndroidWidgetTextView.setCompoundDrawables((Drawable)localObject, null, null, null);
                    ...
                    if (this.jdField_i_of_type_AndroidWidgetImageView == null)
                    {
                      ...
                      this.jdField_i_of_type_AndroidWidgetImageView.setId(2131375248);
                      this.jdField_i_of_type_AndroidWidgetImageView.setScaleType(ImageView.ScaleType.CENTER_CROP);
                      paramMessage = new RelativeLayout.LayoutParams(ApolloUtilImpl.dp2px(15.0F, jdField_b_of_type_Float), ApolloUtilImpl.dp2px(15.0F, jdField_b_of_type_Float));
                      paramMessage.leftMargin = (ApolloUtilImpl.dp2px(82.0F, jdField_b_of_type_Float) + this.jdField_c_of_type_AndroidWidgetTextView.getWidth() + this.jdField_h_of_type_AndroidWidgetTextView.getWidth());
                      paramMessage.topMargin = (((RelativeLayout.LayoutParams)this.jdField_b_of_type_ComTencentMobileqqApolloApiStoreOpenboxRoundRectLinearLayout.getLayoutParams()).topMargin + ApolloUtilImpl.dp2px(7.5F, jdField_b_of_type_Float));
                ...
                this.jdField_c_of_type_AndroidWidgetImageView.setImageResource(2130838576);
                return false;
                if (this.jdField_g_of_type_AndroidWidgetImageView == null) {
                  break;
                }
                this.jdField_g_of_type_AndroidWidgetImageView.setImageResource(2130838576);
                return false;
                if (this.jdField_i_of_type_AndroidWidgetImageView == null) {
                  break;
                }
                this.jdField_i_of_type_AndroidWidgetImageView.setImageResource(2130838576);
                return false;
                m = 0;
                n = 0;
              }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      {
        if ((this.jdField_c_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqApolloStoreOpenboxApolloBoxData != null))
        {
          localObject3 = new Intent(this.jdField_a_of_type_AndroidContentContext, QQBrowserActivity.class);
          localObject2 = ApolloConstant.n + "&adtag=floatlayer";
          ...
          if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreOpenboxApolloBoxData.jdField_a_of_type_JavaUtilList.size() > 0)
          {
            ...
            if (!TextUtils.isEmpty(localBoxCardListSummary.jdField_b_of_type_JavaLangString)) {
              localObject1 = localBoxCardListSummary.jdField_b_of_type_JavaLangString;
            }
          }
      ...
      else if ((paramView == this.jdField_f_of_type_AndroidWidgetImageView) || (paramView == this.jdField_h_of_type_AndroidWidgetTextView))
      {
        if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreOpenboxApolloBoxData != null)
        {
          localObject2 = ApolloConstant.m + "&adtag=floatlayer";
          localObject1 = localObject2;
          if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreOpenboxApolloBoxData.jdField_a_of_type_JavaUtilList.size() > 1)
          {
            localObject3 = (ApolloBoxData.BoxCardListSummary)this.jdField_a_of_type_ComTencentMobileqqApolloStoreOpenboxApolloBoxData.jdField_a_of_type_JavaUtilList.get(1);
            localObject1 = localObject2;
            if (!TextUtils.isEmpty(((ApolloBoxData.BoxCardListSummary)localObject3).jdField_b_of_type_JavaLangString)) {
              localObject1 = ((ApolloBoxData.BoxCardListSummary)localObject3).jdField_b_of_type_JavaLangString;
            }
          }
      ...
      else if ((paramView == this.jdField_h_of_type_AndroidWidgetImageView) || (paramView == this.jdField_i_of_type_AndroidWidgetTextView))
      {
        if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreOpenboxApolloBoxData != null)
        {
          if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreOpenboxApolloBoxData.jdField_a_of_type_JavaUtilList.size() > 2)
          {
            ...
            if (!TextUtils.isEmpty(((ApolloBoxData.BoxCardListSummary)localObject1).jdField_b_of_type_JavaLangString))
            {
              localObject2 = new Intent(this.jdField_a_of_type_AndroidContentContext, QQBrowserActivity.class);
              ((Intent)localObject2).putExtra("big_brother_source_key", "biz_src_zf_lmx");
              VasWebviewUtil.openQQBrowserActivity(this.jdField_a_of_type_AndroidContentContext, ((ApolloBoxData.BoxCardListSummary)localObject1).jdField_b_of_type_JavaLangString, -1L, (Intent)localObject2, false, -1);
      ...
      else if (paramView == this.jdField_a_of_type_ComTencentMobileqqApolloApiStoreOpenboxRoundRectLinearLayout)
      {
        if ((this.jdField_a_of_type_ComTencentMobileqqApolloStoreOpenboxApolloBoxData != null) && (this.jdField_c_of_type_Boolean))
        {
          ...
          for (int m = 1;; m = 2)
          {
            ...
            break;
            QQToast.a(this.jdField_a_of_type_AndroidContentContext, HardCodeUtil.a(2131700392), 0).a();
            break label667;
            QQToast.a(this.jdField_a_of_type_AndroidContentContext, HardCodeUtil.a(2131700382), 0).a();
          }
        }
      }
