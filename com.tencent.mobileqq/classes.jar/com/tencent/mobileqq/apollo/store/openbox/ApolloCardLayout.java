  ...
  extends RelativeLayout
{
  ...
  public void a(int paramInt1, ApolloBoxData.ApolloBoxDataItem paramApolloBoxDataItem, int paramInt2, int paramInt3)
  {
    ...
    if (this.jdField_d_of_type_AndroidWidgetTextView == null)
    {
      ...
      paramApolloBoxDataItem.addRule(3, 2131362444);
    ...
    if (this.jdField_c_of_type_Int == 1)
    {
      ...
      if (this.jdField_a_of_type_AndroidWidgetTextView == null)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetTextView.setId(2131362444);
      ...
      paramApolloBoxDataItem = getContext().getResources().getDrawable(2130838024);
    ...
    for (;;)
    {
      ...
      if (this.jdField_c_of_type_Int == 1)
      {
        ...
        this.jdField_d_of_type_ComTencentImageURLImageView.setBackgroundResource(2130838047);
