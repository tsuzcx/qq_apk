  ...
  implements Handler.Callback, OnApolloViewListener, IApolloActivityJsCallBack, IApolloViewControllerCallBack, ApolloCardWindow.OnCloseCardWindowListener
{
  ...
  private void e()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog == null) {
      this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = DialogUtil.a(this, 230, "温馨提示", "使用特定角色就能体验厘米秀AI功能，快去商城换角色", "取消", "去商城", new zap(this), new zaq(this));
    }
  ...
  public void a(RelativeLayout paramRelativeLayout)
  {
    ...
    for (;;)
    {
      ...
      ThreadManager.postImmediately(new zao(this), null, true);
    }
  }
  ...
  public String b(String paramString)
  {
    ...
    ThreadManager.executeOnSubThread(new zas(this, localApolloTextureView.getBitmap(), l, paramString));
    return "";
  }
        ...
        if (paramInt2 == 2)
        {
          ...
          if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloViewController != null)
          {
            ...
            if (localObject1 != null) {
              ((ApolloTextureView)localObject1).queueEvent(new zar(this, paramInt1, paramInt2, paramIntent));
            }
          }
        }
      }
  ...
  public boolean showPreview()
  {
    ...
    if (this.mSystemBarComp != null)
    {
      ...
      int m = super.getResources().getColor(2131494260);
