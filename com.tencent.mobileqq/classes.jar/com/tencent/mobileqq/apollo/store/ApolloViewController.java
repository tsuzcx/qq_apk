  ...
  implements MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener, Handler.Callback, View.OnClickListener, TouchWebView.OnScrollChangedListener, OnApolloViewListener
{
  ...
  public ApolloViewController(RelativeLayout paramRelativeLayout, IApolloViewControllerCallBack paramIApolloViewControllerCallBack)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqApolloIRenderCallback = new ApolloViewController.1(this);
    ...
    paramIApolloViewControllerCallBack.setImageResource(2130839545);
    ...
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setBackgroundResource(2130838731);
  ...
  private String b(int paramInt, boolean paramBoolean, ApolloWebAvatarParam paramApolloWebAvatarParam)
  {
    ...
    {
      QQToast.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), HardCodeUtil.a(2131700654), 0).a();
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaUtilHashMap)
      {
        ...
        if ((paramApolloWebAvatarParam.tapRectWidth > 0) && (paramApolloWebAvatarParam.tapRectHeight > 0))
        {
          ...
          ((RelativeLayout.LayoutParams)???).width = ApolloUtilImpl.dp2px(81.0F * this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.rate / 0.289F, this.jdField_d_of_type_Float);
          ((RelativeLayout.LayoutParams)???).height = ApolloUtilImpl.dp2px(58.0F * this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.rate / 0.289F, this.jdField_d_of_type_Float);
  ...
  private void e()
  {
      ...
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null) {
          if (this.jdField_i_of_type_Int == 0) {
            try
            {
              String str = ApolloUtilImpl.getAudioPathForAction(this.jdField_c_of_type_Int);
              if (FileUtils.a(str))
              {
    ...
    for (int m = 1;; m = 0)
    {
      ...
      if ((!ApolloResDownloaderImpl.hasSound(this.jdField_c_of_type_Int)) || (m != 0) || (k != 0) || (n == 0)) {
        break;
      }
      try
      {
        QQAudioUtils.a(BaseApplicationImpl.getContext(), true);
        this.jdField_a_of_type_AndroidMediaMediaPlayer.reset();
        this.jdField_a_of_type_AndroidMediaMediaPlayer.setDataSource("/sdcard/Android/data/com.tencent.mobileqq/Tencent/MobileQQ/.apollo/action/" + this.jdField_c_of_type_Int + "/" + "music.amr");
  ...
  public String a()
  {
    ...
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null))
    {
      ...
      String[] arrayOfString = ApolloActionHelperImpl.getActionRscPath(10, -1, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId, true);
    ...
    return a(HardCodeUtil.a(2131700642));
  }
  ...
  public String a(int paramInt, boolean paramBoolean, ApolloWebAvatarParam paramApolloWebAvatarParam)
  {
    ...
    if (!ApolloActionHelperImpl.isRscValid(paramApolloWebAvatarParam.uin, paramApolloWebAvatarParam.roleId, paramApolloWebAvatarParam.dressIds, null))
    {
      QQToast.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), HardCodeUtil.a(2131700641), 0).a();
      return a("dresses is not download!");
    }
  ...
  public String a(ApolloViewController.PlayActionData paramPlayActionData)
  {
    if (this.j)
    {
      ...
      return a(HardCodeUtil.a(2131700647));
    }
    ...
    for (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloViewController$PlayActionData = paramPlayActionData; (paramPlayActionData.jdField_c_of_type_Int == 1) && (!TextUtils.isEmpty(paramPlayActionData.jdField_b_of_type_JavaLangString)) && (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null) && (!paramPlayActionData.jdField_b_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId)); this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloViewController$PlayActionData = null) {
      return a(HardCodeUtil.a(2131700652));
    }
    ...
    if (!this.jdField_a_of_type_JavaUtilHashMap.containsKey(paramPlayActionData.jdField_b_of_type_JavaLangString)) {
      return a(HardCodeUtil.a(2131700650));
    }
    ...
    if (localObject1 == null) {
      return a(HardCodeUtil.a(2131700636));
    }
    int m = 0;
    int k = m;
    if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null)
    ...
    {
      QQToast.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), HardCodeUtil.a(2131700637), 0).a();
      return a(HardCodeUtil.a(2131700648));
    }
    if (!ApolloUtilImpl.isActionResDone(paramPlayActionData.jdField_b_of_type_Int, paramPlayActionData.jdField_c_of_type_Int))
    {
      if (k != 0) {
        QQToast.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), HardCodeUtil.a(2131700655), 0).a();
      }
      return a(HardCodeUtil.a(2131700638));
    }
    ...
    {
      if (k != 0) {
        QQToast.a(BaseApplicationImpl.getContext(), HardCodeUtil.a(2131700653), 0).a();
      }
      return a(HardCodeUtil.a(2131700643));
    }
    if (k != 0) {
      f();
    }
    ...
    if (paramPlayActionData.l == 0)
    {
      ...
      if (this.jdField_a_of_type_Int != paramPlayActionData.jdField_c_of_type_Int)
      {
        ...
        if (ApolloUtilImpl.checkRoleRes(this.jdField_f_of_type_Int))
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getRenderImpl().a(2, null, ((IApolloResDownloader)QRoute.api(IApolloResDownloader.class)).readRoleDefaultDressIds(this.jdField_f_of_type_Int), null);
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqApolloBarrageBarrageView != null)
      {
        ...
        n = (int)((float)DeviceInfoUtil.j() * ((ApolloWebAvatarParam)localObject1).rate * 1.14F);
    ...
    {
      a(false);
      return b(HardCodeUtil.a(2131700651));
      bool = false;
      break;
      label1152:
      bool = false;
    ...
    label1529:
    if ((this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null) && (!paramPlayActionData.jdField_b_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId))) {
      return a(HardCodeUtil.a(2131700660));
    }
    a();
    if ((!this.jdField_c_of_type_Boolean) || (this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView == null))
    {
      ...
      this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.init(new ApolloViewController.4(this, (DisplayMetrics)localObject1, paramPlayActionData));
      if (this.jdField_b_of_type_ComTencentMobileqqApolloIRenderCallback == null) {
        this.jdField_b_of_type_ComTencentMobileqqApolloIRenderCallback = new ApolloViewController.OtherSurfaceViewRenderCallBack(this);
      }
      ...
      localObject1 = HardCodeUtil.a(2131700656);
      label1811:
    ...
    for (;;)
    {
      ...
      if (TextUtils.isEmpty(this.jdField_c_of_type_JavaLangString)) {
        this.jdField_c_of_type_AndroidWidgetTextView.setText(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext().getResources().getString(2131690125));
      }
      this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
  ...
  public String a(ArrayList<ApolloWebAvatarParam> paramArrayList)
  {
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      {
        QQToast.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), HardCodeUtil.a(2131700639), 0).a();
        return a("dresses is not download!");
      }
    }
  ...
  public String a(int[] paramArrayOfInt)
  {
    if (this.j)
    {
      ...
      return a(HardCodeUtil.a(2131700649));
    }
    if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam == null) {
      return a(HardCodeUtil.a(2131700640));
    }
    if (!ApolloActionHelperImpl.isRscValid(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.uin, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId, paramArrayOfInt, null))
    {
      QQToast.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), HardCodeUtil.a(2131700657), 0).a();
      return a(HardCodeUtil.a(2131700646));
    }
    ...
    f();
    return b(HardCodeUtil.a(2131700645));
  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout == null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundColor(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext().getResources().getColor(2131166942));
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(4);
      Object localObject1 = new RelativeLayout.LayoutParams(-2, (int)((float)DeviceInfoUtil.j() * 0.6F));
      ((RelativeLayout.LayoutParams)localObject1).addRule(13, -1);
      ((RelativeLayout.LayoutParams)localObject1).leftMargin = ApolloUtilImpl.dp2px(25.0F, this.jdField_d_of_type_Float);
      ((RelativeLayout.LayoutParams)localObject1).rightMargin = ApolloUtilImpl.dp2px(25.0F, this.jdField_d_of_type_Float);
      Object localObject2 = LayoutInflater.from(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext()).inflate(2131558731, null);
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)((View)localObject2).findViewById(2131364286));
      this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)((View)localObject2).findViewById(2131362859));
      this.jdField_a_of_type_AndroidWidgetLinearLayout.setOnClickListener(this);
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)((View)localObject2).findViewById(2131362780));
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)((View)localObject2).findViewById(2131362779));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)((View)localObject2).findViewById(2131362777));
      ...
      ((ImageView)localObject1).setId(2131362810);
      ...
      ((ImageView)localObject1).setBackgroundResource(2130838570);
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null)
      {
        if ("mall".equals(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.tab)) {
          ...
          {
            this.jdField_a_of_type_JavaLangString = HardCodeUtil.a(2131700659);
            if (this.jdField_h_of_type_Int == 1) {
              this.jdField_a_of_type_JavaLangString = ApolloResDownloaderImpl.readRoleBubbleTips(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId);
            }
        ...
        for (;;)
        {
          ...
          {
            this.jdField_a_of_type_JavaLangString = HardCodeUtil.a(2131700644);
            break;
          }
  ...
  public boolean handleMessage(Message arg1)
  {
    ...
    case 27: 
      do
      {
        do
        {
          ...
          ??? = ApolloActionHelperImpl.getActionRscPath(4, -1, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId, true);
        ...
        if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView != null) && (this.jdField_a_of_type_Int != 0))
        {
          ...
          if ((this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId)))
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getRenderImpl().a(1, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId, ApolloResDownloaderImpl.DEFAULT_DRESSIDS_ROLE0, null);
          }
        }
        for (;;)
        {
              ...
              for (;;)
              {
                synchronized (this.jdField_a_of_type_JavaUtilHashMap)
                {
                  for (;;)
                  {
                    ...
                    ???.a(1, localApolloWebAvatarParam.apolloId, localApolloWebAvatarParam.roleId, ApolloUtilImpl.getSurfaceScale(localApolloWebAvatarParam.rate), localApolloWebAvatarParam.x, this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getHeight() / this.jdField_d_of_type_Float - localApolloWebAvatarParam.y);
                    if (localApolloWebAvatarParam.roleId == 0)
                    {
                      ???.a(1, localApolloWebAvatarParam.apolloId, ApolloResDownloaderImpl.DEFAULT_DRESSIDS_ROLE0, null);
                      synchronized (this.jdField_a_of_type_JavaUtilHashMap)
                      {
            ...
            if (this.jdField_a_of_type_JavaUtilHashMap.containsKey(???))
            {
              ...
              if (localApolloWebAvatarParam != null)
              {
                ...
                if (??? != null)
                {
                  ...
                  ((ApolloRenderInterfaceImpl)???).a(1, localApolloWebAvatarParam.apolloId, localApolloWebAvatarParam.roleId, ApolloUtilImpl.getSurfaceScale(localApolloWebAvatarParam.rate), localApolloWebAvatarParam.x, this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getHeight() / this.jdField_d_of_type_Float - localApolloWebAvatarParam.y);
                  if (localApolloWebAvatarParam.roleId != 0) {
                    break label2011;
                  }
                  ((ApolloRenderInterfaceImpl)???).a(1, localApolloWebAvatarParam.apolloId, ApolloResDownloaderImpl.DEFAULT_DRESSIDS_ROLE0, null);
                }
              }
            }
    ...
    case 19: 
      ...
      {
        f2 = 77.0F;
        f4 = (float)(Math.max(DeviceInfoUtil.h(), DeviceInfoUtil.g()) / 7L) / 368.0F;
        ??? = ???.obj;
    ...
    {
      float f1;
      if ((m == 1) && (ApolloUtilImpl.checkRoleRes(this.jdField_f_of_type_Int)))
      {
        ...
        this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.getRenderImpl().a(2, null, ((IApolloResDownloader)QRoute.api(IApolloResDownloader.class)).readRoleDefaultDressIds(this.jdField_f_of_type_Int), null);
        ??? = ApolloActionHelperImpl.getActionRscPath(13, n, this.jdField_f_of_type_Int, false);
        if (k != 0)
        {
      ...
      for (;;)
      {
        ...
        ??? = ApolloActionHelperImpl.getActionRscPath(13, n, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId, true);
          ...
          if (!TextUtils.isEmpty(this.jdField_d_of_type_JavaLangString))
          {
            if (this.jdField_g_of_type_Int == 1)
            {
              ...
              if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != ???)
              {
                ...
                ???.addRule(12, -1);
                ???.leftMargin = ApolloUtilImpl.dp2px(25.0F, this.jdField_d_of_type_Float);
                ???.rightMargin = ApolloUtilImpl.dp2px(25.0F, this.jdField_d_of_type_Float);
