...
public class ApolloVoiceDIYHelper
{
  ...
  private void b(double paramDouble)
  {
    ...
    String[] arrayOfString2 = ApolloActionHelper.a(1, this.jdField_a_of_type_Int, this.b, true);
    String[] arrayOfString1 = null;
    if (this.c == 1) {
      arrayOfString1 = ApolloActionHelper.a(1, this.jdField_a_of_type_Int, this.b, false);
    }
  ...
  public void a(double paramDouble)
  {
    ...
    for (;;)
    {
      ...
      return;
      localApolloTextureView.queueEvent(new yra(this, localApolloTextureView, paramDouble - this.jdField_a_of_type_Double));
    }
  }
