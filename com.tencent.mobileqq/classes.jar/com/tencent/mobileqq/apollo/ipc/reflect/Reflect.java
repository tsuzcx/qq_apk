...
public class Reflect
{
  ...
  private Method a(String paramString, Class<?>[] paramArrayOfClass)
  {
    ...
    do
    {
      ...
      {
        Log.e("Reflect", "error, ", localNoSuchMethodException1);
  ...
  public Reflect a(String paramString, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      try
      {
        Reflect localReflect = a(a(paramString, arrayOfClass), this.jdField_a_of_type_JavaLangObject, paramVarArgs);
        return localReflect;
      }
      ...
      try
      {
        paramString = a((Method)a(b(paramString, arrayOfClass)), this.jdField_a_of_type_JavaLangObject, paramVarArgs);
        return paramString;
      }
  ...
  public boolean equals(Object paramObject)
  {
    if ((paramObject instanceof Reflect)) {
      return this.jdField_a_of_type_JavaLangObject.equals(((Reflect)paramObject).a());
    }
    return false;
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.apollo.ipc.reflect.Reflect
