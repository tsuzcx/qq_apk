  ...
  public void run()
  {
    ...
    do
    {
      do
      {
        ...
        localObject2 = ((aisi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(249)).a();
        if (localObject2 != null) {
          ((aisa)localObject2).a(this.jdField_a_of_type_ComTencentMobileqqDataChatMessage, i);
        }
