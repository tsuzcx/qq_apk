  ...
  implements DialogInterface.OnDismissListener, Handler.Callback, AdapterView.OnItemClickListener, ActionSheet.OnButtonClickListener
{
  ...
  private int a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.f = (HardCodeUtil.a(2131700433) + this.jdField_a_of_type_JavaLangString);
  ...
  private void b()
  {
    ...
    for (localObject = (Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get();; localObject = null)
    {
      ...
      for (AppInterface localAppInterface = (AppInterface)this.jdField_b_of_type_JavaLangRefWeakReference.get();; localAppInterface = null)
      {
        ...
        label172:
        for (int i = -1;; i = ((IApolloUtil)QRoute.api(IApolloUtil.class)).getReportSessiontype(((BaseChatPie)localObject).a.jdField_a_of_type_Int))
        {
  ...
  private void c()
  {
    Object localObject1 = new AbsShareMsg.Builder(StructMsgForGeneralShare.class).c(96).a(this.f).e(this.c).a(HardCodeUtil.a(2131700461), null).b("web", "https://cmshow.qq.com/apollo/html/intro.html?_wv=1027&_bid=2326", "https://cmshow.qq.com/apollo/html/intro.html?_wv=1027&_bid=2326", "https://cmshow.qq.com/apollo/html/intro.html?_wv=1027&_bid=2326", "https://cmshow.qq.com/apollo/html/intro.html?_wv=1027&_bid=2326").a();
  ...
  public void a(String paramString)
  {
    ...
    for (paramString = (Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get();; paramString = null)
    {
      ...
      paramString = a();
      if (paramString == null) {}
      for (i = -1;; i = ((IApolloUtil)QRoute.api(IApolloUtil.class)).getReportSessiontype(paramString.a.jdField_a_of_type_Int))
      {
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    for (Activity localActivity = (Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get();; localActivity = null)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentWidgetActionSheet == null) && (localActivity != null))
      {
        ...
        this.jdField_a_of_type_ComTencentWidgetActionSheet = ActionSheetAdapter.a(localActivity, localActionSheetAdapter, new ApolloGameShare.1(this, paramString), this, this, false);
      }
      if ((this.jdField_a_of_type_ComTencentWidgetActionSheet == null) || (this.jdField_a_of_type_ComTencentWidgetActionSheet.isShowing())) {
        break;
      }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localBundle.putString("summary", HardCodeUtil.a(2131700418));
      ...
      {
        ApolloUtilImpl.forwardImage_Common(paramMessage, (String)localObject, null, 1);
        return false;
      }
      break;
      label335:
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      for (int j = -1;; j = ((IApolloUtil)QRoute.api(IApolloUtil.class)).getReportSessiontype(localBaseChatPie.a.jdField_a_of_type_Int))
      {
