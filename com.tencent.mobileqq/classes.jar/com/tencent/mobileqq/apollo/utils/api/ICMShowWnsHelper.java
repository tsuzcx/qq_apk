...
@QAPI(process={"all"})
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/mobileqq/apollo/utils/api/ICMShowWnsHelper;", "Lcom/tencent/mobileqq/qroute/QRouteApi;", "enableCmshowAvatar", "", "getCmshowAvatar3DSwitch", "getCmshowAvatarTitle", "", "getCmshowMemeCacheKey", "", "isCmShowMemeEnabledForIceBreak", "isCmShowMemeTabInFaceEnabled", "runOnCrossEngineForMemePlayer", "cmshow_api_release"}, k=1, mv={1, 1, 16})
  ...
  extends QRouteApi
{
  ...
  public abstract boolean isCmShowMemeEnabledForIceBreak();
