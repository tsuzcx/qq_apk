...
final class ApolloGameUtil$13
  implements Runnable
{
  ApolloGameUtil$13(int paramInt, String paramString, anll paramanll) {}
  ...
  public void run()
  {
    ...
    try
    {
      Object localObject2 = amwn.a(this.jdField_a_of_type_Int);
      if (localObject2 == null) {
        return;
      }
      Object localObject3 = ((amyo)localObject2).a();
      if ((localObject3 != null) && (((CmGameStartChecker.StartCheckParam)localObject3).game != null))
      {
        ...
        localObject1 = null;
        Activity localActivity = ((amyo)localObject2).a();
        ...
        ApolloGameUtil.a(localActivity, this.jdField_a_of_type_Int, localIntent, (String)localObject3, (Bitmap)localObject1, this.jdField_a_of_type_Anll);
        return;
      }
    }
