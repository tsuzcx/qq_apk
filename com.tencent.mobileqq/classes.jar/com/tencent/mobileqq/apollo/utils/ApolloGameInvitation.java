  ...
  implements DialogInterface.OnDismissListener, AdapterView.OnItemClickListener, ActionSheet.OnButtonClickListener
{
  ...
  private WeakReference<ActionSheet> c = null;
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqApolloApiModelApolloGameMsgInfo != null)
    {
      CmGameLauncher localCmGameLauncher = CmGameUtil.a(this.jdField_a_of_type_ComTencentMobileqqApolloApiModelApolloGameMsgInfo.gameId);
  ...
  public ApolloGameMsgInfo a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localObject != null)
        {
          ...
          if (localObject != null)
          {
            localApolloGameMsgInfo.gameName = ((CmGameInitParams)localObject).mChineseName;
            localApolloGameMsgInfo.actionId = ((CmGameInitParams)localObject).mActionId;
          }
        }
        if (0L == l) {
        ...
        localApolloGameMsgInfo.gameId = i;
        ...
        paramString = localApolloGameMsgInfo;
  ...
  public void a(ApolloGameMsgInfo paramApolloGameMsgInfo)
  {
    this.jdField_a_of_type_ComTencentMobileqqApolloApiModelApolloGameMsgInfo = paramApolloGameMsgInfo;
  }
  ...
  public void b()
  {
    ...
    ApolloGameBasicEventUtil.a(this.jdField_a_of_type_ComTencentMobileqqApolloApiModelApolloGameMsgInfo, localActivity, 1);
  }
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      for (int i = 1;; i = 0)
      {
        if ((this.jdField_b_of_type_JavaLangRefWeakReference == null) || (this.jdField_a_of_type_ComTencentMobileqqApolloApiModelApolloGameMsgInfo == null) || ((AppInterface)this.jdField_b_of_type_JavaLangRefWeakReference.get() == null)) {
          break label165;
        }
        VipUtils.a(null, "cmshow", "Apollo", "invite_chose", i, 0, new String[] { Integer.toString(this.jdField_a_of_type_ComTencentMobileqqApolloApiModelApolloGameMsgInfo.gameId) });
        break;
        if (paramLong == 0L)
        {
          if (QLog.isColorLevel()) {
