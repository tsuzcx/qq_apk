  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if ((this.a != null) && (this.a.get() != null) && (this.b != null) && (this.b.get() != null))
    {
      ...
      if ((localQQAppInterface != null) && (localStartCheckParam != null) && (aing.a(localQQAppInterface, localStartCheckParam))) {}
    }
    else
    {
      return;
    ...
    boolean bool2 = aing.a(localQQAppInterface.getApp());
    boolean bool1;
    label114:
    Object localObject2;
    ...
    for (Object localObject1 = "1";; localObject1 = "0")
    {
      ...
      awrn.a(localQQAppInterface.getApp()).a(localQQAppInterface.getCurrentAccountUin(), "cmgame_data_req_conf", true, 0L, 0L, (HashMap)localObject2, "", false);
      if (!bool1) {
        break label371;
      }
      if (!badq.d(localQQAppInterface.getApp())) {
        break label358;
      }
      localObject1 = (baot)localQQAppInterface.a(71);
      ...
      ((baot)localObject1).a(localArrayList, (Bundle)localObject2);
    ...
    label358:
    ApolloGameUtil.a(ajjy.a(2131634586), 1, BaseApplicationImpl.getContext());
    return;
    label371:
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (bool2)
        {
          ...
          awrn.a(localQQAppInterface.getApp()).a(localQQAppInterface.getCurrentAccountUin(), "cmgame_ipc_start", true, 0L, 0L, (HashMap)localObject2, "", false);
          return;
          l1 = 0L;
          continue;
          localStartCheckParam.mLoadingOnMainProcess = true;
          aing.b(localStartCheckParam);
        }
      }
