...
public class ApolloGameInvitation$1
  implements Runnable
{
  public ApolloGameInvitation$1(ajnj paramajnj) {}
  
  public void run()
  {
    Object localObject1 = new StringBuilder();
    ((StringBuilder)localObject1).append(ajms.s).append(ajnj.a(this.this$0).jdField_a_of_type_Int).append("/inviteIcon.png");
    try
    {
      if (new File(((StringBuilder)localObject1).toString()).exists()) {
        ...
        localObject1 = baxi.b(BaseApplicationImpl.getApplication().getResources(), 2130838438);
      }
    }
    ...
    {
      Bitmap localBitmap = baui.a(localThrowable);
      ajnj.a(this.this$0, String.valueOf(System.currentTimeMillis()));
      String str1 = ajya.a(2131700374) + ajnj.a(this.this$0).b;
      Object localObject2 = new JSONObject();
      try
      {
        ((JSONObject)localObject2).put("gameId", ajnj.a(this.this$0).jdField_a_of_type_Int);
        ((JSONObject)localObject2).put("roomId", ajnj.a(this.this$0).jdField_a_of_type_Long);
        ((JSONObject)localObject2).put("gameMode", ajnj.a(this.this$0).jdField_c_of_type_Int);
        ((JSONObject)localObject2).put("extendInfo", ajnj.a(this.this$0).jdField_c_of_type_JavaLangString);
        ...
        WXShareHelper.a().a(new ajnk(this));
        WXShareHelper.a().a(ajnj.a(this.this$0), str1, localBitmap, ajnj.b(this.this$0), localStringBuilder.toString(), 1);
        return;
      }
