  ...
  implements Manager
{
  ...
  {
    this.jdField_a_of_type_JavaUtilList = ApolloDaoManagerServiceImpl.getRencentData(paramQQAppInterface, "recent_c2c");
    this.b = ApolloDaoManagerServiceImpl.getRencentData(paramQQAppInterface, "recent_troop");
