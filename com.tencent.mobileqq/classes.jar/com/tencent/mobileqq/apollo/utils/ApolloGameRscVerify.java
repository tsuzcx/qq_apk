...
public class ApolloGameRscVerify
{
  ...
  private ApolloGameRscVerify.OnVerifyResultCallback jdField_a_of_type_ComTencentMobileqqApolloUtilsApolloGameRscVerify$OnVerifyResultCallback;
  ...
  private void a(String paramString, int paramInt)
  {
    ...
    do
    {
      return;
      this.d = paramInt;
      if (this.jdField_a_of_type_ComTencentMobileqqApolloUtilsApolloGameRscVerify$OnVerifyResultCallback != null) {
        this.jdField_a_of_type_ComTencentMobileqqApolloUtilsApolloGameRscVerify$OnVerifyResultCallback.a(paramInt);
      }
  ...
  public static boolean a(boolean paramBoolean, int paramInt)
  {
    ...
    try
    {
      if (CmGameDebugManager.a(paramInt))
      {
    ...
    for (;;)
    {
      try
      {
        if (!a(this.jdField_b_of_type_Int, this.c))
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqApolloUtilsApolloGameRscVerify$OnVerifyResultCallback.a(0);
          return false;
        }
      ...
      if (((this.c == 0) || (this.c == 1)) && (!new RSAVerify(c() + "/checkList.sig", localThrowable.getAbsolutePath()).a(0)))
      {
        a("checkList.sig", 3);
        return false;
      }
      this.jdField_a_of_type_OrgJsonJSONObject = new JSONObject(FileUtils.b(localThrowable));
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqApolloUtilsApolloGameRscVerify$OnVerifyResultCallback = paramOnVerifyResultCallback;
  }
  ...
  public boolean a(String paramString1, String paramString2)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 35	com/tencent/mobileqq/apollo/utils/ApolloGameRscVerify:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   4: invokevirtual 361	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   7: ifeq +41 -> 48
    //   10: aload_0
    //   11: getfield 28	com/tencent/mobileqq/apollo/utils/ApolloGameRscVerify:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   14: ifnull +34 -> 48
    //   17: aload_2
    //   18: invokestatic 356	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   21: ifne +27 -> 48
    //   24: aload_1
    //   25: invokestatic 356	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   28: ifne +20 -> 48
    //   31: aload_0
    //   32: getfield 37	com/tencent/mobileqq/apollo/utils/ApolloGameRscVerify:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   35: ifnull +13 -> 48
    //   38: aload_0
    //   39: getfield 37	com/tencent/mobileqq/apollo/utils/ApolloGameRscVerify:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   42: invokevirtual 361	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   45: ifeq +5 -> 50
    //   48: iconst_0
    //   49: ireturn
    //   50: invokestatic 318	java/lang/System:currentTimeMillis	()J
    //   53: pop2
    //   54: aconst_null
    //   55: astore 4
    //   57: aconst_null
    //   58: astore 5
    //   60: new 249	java/io/File
    //   63: dup
    //   64: aload_1
    //   65: invokespecial 362	java/io/File:<init>	(Ljava/lang/String;)V
    //   68: astore 7
    //   70: aload 4
    //   72: astore_3
    //   73: aload 7
    //   75: invokevirtual 259	java/io/File:exists	()Z
    //   78: ifne +37 -> 115
    //   81: aload 4
    //   83: astore_3
    //   84: aload_0
    //   85: aload_2
    //   86: iconst_1
    //   87: invokespecial 265	com/tencent/mobileqq/apollo/utils/ApolloGameRscVerify:a	(Ljava/lang/String;I)V
    //   90: iconst_0
    //   91: ifeq -43 -> 48
    //   94: new 364	java/lang/NullPointerException
    //   97: dup
    //   98: invokespecial 365	java/lang/NullPointerException:<init>	()V
    //   101: athrow
    //   102: astore_1
    //   103: ldc 68
    //   105: iconst_1
    //   106: ldc_w 367
    //   109: aload_1
    //   110: invokestatic 270	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   113: iconst_0
    //   114: ireturn
    //   115: aload 4
    //   117: astore_3
    //   118: aload_0
    //   119: getfield 28	com/tencent/mobileqq/apollo/utils/ApolloGameRscVerify:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   122: aload_2
    //   123: invokevirtual 350	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   126: astore 6
    //   128: aload 4
    //   130: astore_3
    //   131: new 369	java/io/FileInputStream
    //   134: dup
    //   135: aload_1
    //   136: invokespecial 370	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   139: astore 4
    //   141: aload 4
    //   143: aload 7
    //   145: invokevirtual 372	java/io/File:length	()J
    //   148: invokestatic 378	com/tencent/qphone/base/util/MD5:toMD5Byte	(Ljava/io/InputStream;J)[B
    //   151: invokestatic 384	com/qq/taf/jce/HexUtil:bytes2HexStr	([B)Ljava/lang/String;
    //   154: astore_3
    //   155: aload_3
    //   156: invokestatic 356	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   159: ifne +57 -> 216
    //   162: aload 6
    //   164: invokestatic 356	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   167: ifne +49 -> 216
    //   170: aload_3
    //   171: invokevirtual 387	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   174: aload 6
    //   176: invokevirtual 387	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   179: invokevirtual 391	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   182: ifne +34 -> 216
    //   185: aload_0
    //   186: aload_2
    //   187: iconst_4
    //   188: invokespecial 265	com/tencent/mobileqq/apollo/utils/ApolloGameRscVerify:a	(Ljava/lang/String;I)V
    //   191: aload 4
    //   193: ifnull -145 -> 48
    //   196: aload 4
    //   198: invokevirtual 394	java/io/FileInputStream:close	()V
    //   201: iconst_0
    //   202: ireturn
    //   203: astore_1
    //   204: ldc 68
    ...
    //   218: ifnull +8 -> 226
    //   221: aload 4
    //   223: invokevirtual 394	java/io/FileInputStream:close	()V
    //   226: iconst_1
    //   227: ireturn
    //   228: astore_1
    //   229: ldc 68
    ...
    //   232: ldc_w 367
    //   235: aload_1
    //   236: invokestatic 270	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   239: goto -13 -> 226
    //   242: astore_3
    //   243: aload 5
    //   245: astore 4
    ...
    //   290: aload_2
    //   291: aastore
    //   292: invokestatic 403	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   295: aload 4
    //   297: ifnull -71 -> 226
    //   300: aload 4
    //   302: invokevirtual 394	java/io/FileInputStream:close	()V
    //   305: goto -79 -> 226
    //   308: astore_1
    //   309: ldc 68
    //   311: iconst_1
    //   312: ldc_w 367
    //   315: aload_1
    //   316: invokestatic 270	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   319: goto -93 -> 226
    //   322: astore_1
    //   323: aload_3
    //   324: ifnull +7 -> 331
    //   327: aload_3
    //   328: invokevirtual 394	java/io/FileInputStream:close	()V
    //   331: aload_1
    //   332: athrow
    //   333: astore_2
    //   334: ldc 68
    ...
    //   337: ldc_w 367
    //   340: aload_2
    //   341: invokestatic 270	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   344: goto -13 -> 331
    //   347: astore_1
    //   348: aload 4
    //   350: astore_3
    ...
    //   0	359	0	this	ApolloGameRscVerify
