  ...
  extends AbsDownloader
{
  ...
  public ApolloDownloader(BaseApplicationImpl paramBaseApplicationImpl)
  {
  ...
  public File a(OutputStream paramOutputStream, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    for (;;)
    {
      ...
      for (paramURLDrawableHandler = (AppInterface)this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl.getAppRuntime(str);; paramURLDrawableHandler = null)
      {
        ...
        break label150;
        label234:
        paramOutputStream = (ApolloManager)paramOutputStream.getManager(152);
        if (paramOutputStream != null)
        {
          if (j == 0)
          {
 ...
 * Qualified Name:     com.tencent.mobileqq.apollo.utils.ApolloDownloader
