...
public class ApolloDrawerStrategy
{
  public int a;
  ...
  public ApolloDrawerStrategy(QQAppInterface paramQQAppInterface)
  {
    ...
    if (i >= j)
    {
      ...
      QLog.i("[cmshow]ApolloDrawerStrategy", 1, paramQQAppInterface.toString());
    }
  }
  ...
  protected int a(SpriteDrawerInfoManager paramSpriteDrawerInfoManager, int paramInt1, int paramInt2, AppInterface paramAppInterface, Context paramContext)
  {
    if (QLog.isColorLevel()) {
      QLog.d("[cmshow]ApolloDrawerStrategy", 2, new Object[] { "draw execAction default say hi, model:", Integer.valueOf(paramInt1) });
    }
    if (paramInt1 == 3) {
      paramInt1 = 14;
    } else {
  ...
  public int a(SpriteDrawerInfoManager paramSpriteDrawerInfoManager, int paramInt, AppInterface paramAppInterface, Context paramContext)
  {
    ...
    if (paramAppInterface.contains("actid"))
    {
      ...
      QLog.d("[cmshow]ApolloDrawerStrategy", 1, paramAppInterface.toString());
      SpriteUtil.a(paramSpriteDrawerInfoManager, 12, paramContext);
      return 0;
    }
    SpriteUtil.a(paramSpriteDrawerInfoManager, 5, paramContext);
    if (QLog.isColorLevel()) {
      QLog.d("[cmshow]ApolloDrawerStrategy", 2, "draw execAction random say hi");
    }
    return 0;
  }
  ...
  public boolean a(AppInterface paramAppInterface)
  {
    if ((paramAppInterface != null) && ((paramAppInterface instanceof QQAppInterface)))
    {
      ...
      if ((bool) && (QLog.isColorLevel())) {
        QLog.d("[cmshow]ApolloDrawerStrategy", 2, "isShowDrawerAction current is 3D User");
      }
      return bool ^ true;
    }
    return false;
 ...
 * Qualified Name:     com.tencent.mobileqq.apollo.drawer.ApolloDrawerStrategy
