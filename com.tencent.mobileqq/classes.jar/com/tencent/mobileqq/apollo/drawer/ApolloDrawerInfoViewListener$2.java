  ...
  public void run()
  {
    try
    {
      if ((this.a) && (this.b != null))
      {
        ...
        Object localObject2 = (ArrayList)this.b;
        if (localObject2 != null)
        {
          ...
          Object localObject3 = ((SpriteDrawerInfoManager)localObject1).e();
          SpriteContext localSpriteContext = ((SpriteDrawerInfoManager)localObject1).f();
          if (localObject3 != null)
          {
            ...
            while (localIterator.hasNext())
            {
              ...
              if (str.equals(localSpriteContext.g())) {
            ...
            ThreadManager.getSubThreadHandler().postDelayed(new ApolloDrawerInfoViewListener.2.2(this, (ApolloManagerServiceImpl)localObject1), CmShowWnsUtils.z());
            return;
          }
        }
      }
 ...
 * Qualified Name:     com.tencent.mobileqq.apollo.drawer.ApolloDrawerInfoViewListener.2
