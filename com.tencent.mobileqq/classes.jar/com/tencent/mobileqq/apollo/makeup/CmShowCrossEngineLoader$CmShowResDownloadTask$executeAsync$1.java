...
final class CmShowCrossEngineLoader$CmShowResDownloadTask$executeAsync$1
  implements IApolloResManager.ApolloUserDressInfoListener
{
  CmShowCrossEngineLoader$CmShowResDownloadTask$executeAsync$1(CmShowCrossEngineLoader.CmShowResDownloadTask paramCmShowResDownloadTask) {}
  
  public final void a(ApolloDressInfo paramApolloDressInfo, String paramString, int paramInt)
  {
    if (paramApolloDressInfo == null)
    {
      paramApolloDressInfo = CmShowCrossEngineLoader.a.a();
    ...
    QLog.i(CmShowCrossEngineLoader.a.a(), 1, "[CrossEngine][CmShowResDownloadTask] success");
    this.a.e();
  }
}
