...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"com/tencent/mobileqq/apollo/makeup/CmShowCrossEngineLoader$CmShowResDownloadTask$executeAsync$1", "Lcom/tencent/mobileqq/cmshow/engine/resource/IApolloResManager$ApolloUserDressInfoListener;", "onGetApolloUserDressInfo", "", "apolloDressInfo", "Lcom/tencent/mobileqq/apollo/model/ApolloDressInfo;", "errMsg", "", "errCode", "", "cmshow_impl_release"}, k=1, mv={1, 1, 16})
public final class CmShowCrossEngineLoader$CmShowResDownloadTask$executeAsync$1
  implements IApolloResManager.ApolloUserDressInfoListener
{
  public void a(@Nullable ApolloDressInfo paramApolloDressInfo, @Nullable String paramString, int paramInt)
  {
    ...
    {
      paramApolloDressInfo = CmShowCrossEngineLoader.h.a();
      StringBuilder localStringBuilder = new StringBuilder();
      localStringBuilder.append("[CrossEngine] getApolloUserRes return null ");
    ...
    QLog.i(CmShowCrossEngineLoader.h.a(), 1, "[CrossEngine][CmShowResDownloadTask] success");
    this.a.j();
  }
}
 ...
 * Qualified Name:     com.tencent.mobileqq.apollo.makeup.CmShowCrossEngineLoader.CmShowResDownloadTask.executeAsync.1
