...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"<anonymous>", "", "result", "", "onResult"}, k=3, mv={1, 1, 16})
final class CmShowCrossEngineLoader$InitCEEngineTask$executeAsync$1$1
  implements CrossEngineResManager.LoadListener
{
  CmShowCrossEngineLoader$InitCEEngineTask$executeAsync$1$1(CmShowCrossEngineLoader.InitCEEngineTask.executeAsync.1 param1) {}
