  ...
  extends AsyncTask
{
  ...
  public CmShowCrossEngineLoader$CmShowResDownloadTask(@NotNull Context paramContext, @NotNull String paramString)
  {
    super(paramContext);
    this.g = paramString;
  }
  ...
  public void a()
  {
    ((ICMResManager)ApolloIPCModule.a.a(ICMResManager.class)).a(this.g, 1, (IApolloResManager.ApolloUserDressInfoListener)new CmShowCrossEngineLoader.CmShowResDownloadTask.executeAsync.1(this));
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.apollo.makeup.CmShowCrossEngineLoader.CmShowResDownloadTask
