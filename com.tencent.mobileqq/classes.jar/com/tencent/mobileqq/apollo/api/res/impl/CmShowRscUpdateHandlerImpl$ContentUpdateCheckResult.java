...
public class CmShowRscUpdateHandlerImpl$ContentUpdateCheckResult
{
  ...
  {
    if (100 == paramInt) {
      return new File("/sdcard/Android/data/com.tencent.mobileqq/Tencent/MobileQQ/.apollo/rsc_jsonConfig/" + paramInt + "_" + paramLong + "_" + paramString1 + File.separator + paramString2).exists();
    }
    return false;
  }
  ...
  public String b()
  {
    if (100 == this.jdField_a_of_type_Int) {
      return "/sdcard/Android/data/com.tencent.mobileqq/Tencent/MobileQQ/.apollo/rsc_jsonConfig/" + a() + File.separator;
    }
    return "";
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.apollo.api.res.impl.CmShowRscUpdateHandlerImpl.ContentUpdateCheckResult
