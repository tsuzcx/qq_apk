...
public class CmShowRscCacheManagerImpl$IdolRscItem
{
  ...
  public boolean b()
  {
    if ((ApolloUtilImpl.isFileExistAndLenNot0(b())) && (this.jdField_a_of_type_Int == 8)) {
      return ApolloUtilImpl.isFileExistAndLenNot0("/sdcard/Android/data/com.tencent.mobileqq/Tencent/MobileQQ/.apollo/room/" + this.jdField_b_of_type_Int + File.separator + "room.bin");
    }
    return false;
  }
    ...
    for (;;)
    {
      ...
      if (((File)localObject2).exists())
      {
        ...
        if (((File)localObject3).exists())
        {
          try
          {
            localObject3 = FileUtils.b((File)localObject3);
            return localObject3;
          }
        ...
        else
        {
          ...
          if (((File)localObject4).exists()) {
            try
            {
              localObject4 = FileUtils.b((File)localObject4);
              return localObject4;
            }
 ...
 * Qualified Name:     com.tencent.mobileqq.apollo.api.res.impl.CmShowRscCacheManagerImpl.IdolRscItem
