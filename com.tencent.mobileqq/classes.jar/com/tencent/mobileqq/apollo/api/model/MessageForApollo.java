  ...
  extends ChatMessage
{
  ...
  public void doParse()
  {
    try
    {
      ...
      this.msg = ((IApolloUtil)QRoute.api(IApolloUtil.class)).getApolloDescMsg(this);
    ...
    catch (Throwable localThrowable)
    {
      if (this.mApolloMessage == null)
      {
        ...
        this.mApolloMessage.name = ApolloUtilImpl.getFakeMsgText();
  ...
  {
    return (CmShowWnsUtils.b()) && ((this.msgType == 10) || (this.msgType == 11));
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.apollo.api.model.MessageForApollo
