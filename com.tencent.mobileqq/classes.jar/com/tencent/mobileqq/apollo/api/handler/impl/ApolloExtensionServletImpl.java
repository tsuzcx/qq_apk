...
public class ApolloExtensionServletImpl
  extends MSFServlet
  implements IApolloExtensionServlet
{
  public Class getImplClass()
  {
    return ApolloExtensionServletImpl.class;
  }
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ApolloExtensionHandlerImpl localApolloExtensionHandlerImpl = (ApolloExtensionHandlerImpl)((QQAppInterface)super.getAppRuntime()).getBusinessHandler(BusinessHandlerFactory.APOLLO_EXTENSION_HANDLER);
      if (localApolloExtensionHandlerImpl != null) {
        localApolloExtensionHandlerImpl.a(paramIntent, paramFromServiceMsg, arrayOfByte);
      }
      if (QLog.isColorLevel()) {
 ...
 * Qualified Name:     com.tencent.mobileqq.apollo.api.handler.impl.ApolloExtensionServletImpl
