...
import com.tencent.mobileqq.apollo.handler.ApolloGetAvatarDataVasHandler;
...
import com.tencent.mobileqq.apollo.lightGame.CmGameConnManager.GameConnInfo;
...
import com.tencent.mobileqq.apollo.request.ApolloRequestReceiveManager;
import com.tencent.mobileqq.apollo.request.ApolloRequestReceiveManager.ReceiveMethodHolder;
...
public class ApolloExtensionHandlerImpl
  ...
  implements IApolloExtensionHandler
{
  ...
  private PraiseManager.OnPraiseSetCallback jdField_a_of_type_ComTencentMobileqqProfileLikePraiseManager$OnPraiseSetCallback;
  private HashMap<String, BusinessObserver> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private List<ApolloExtensionHandlerImpl.OnQueryBaseInfoListener> jdField_a_of_type_JavaUtilList = new ArrayList();
  private Vector<Long> jdField_a_of_type_JavaUtilVector = new Vector();
  public int b;
  
  static
  {
    jdField_a_of_type_JavaLangString = ApolloExtensionHandlerImpl.class.getName();
    jdField_b_of_type_JavaLangString = "ApolloExtensionHandlerImpl";
    jdField_c_of_type_JavaLangString = "Addon.Set";
    d = "IndividPub.ExpTips";
    jdField_a_of_type_JavaUtilMap = new HashMap();
    jdField_b_of_type_Long = 0L;
    jdField_a_of_type_JavaUtilMap.put("qqvalue.GetQQValue", new QqValueGetValueHandler());
    jdField_a_of_type_JavaUtilMap.put("apollo_router_light.cmshow_game_linkcmd_open_game_box", new ApolloGetBattleGameListVasHandler());
    jdField_a_of_type_JavaUtilMap.put("OidbSvc.0x5eb_99", new GetStrangerVasInfoHandler());
    jdField_a_of_type_JavaUtilMap.put("apollo_router_light.apollo_emotionsvr_linkcmd_emotionused", new ApolloGetActionUsedListVasHandler());
    jdField_a_of_type_JavaUtilMap.put("apollo_router_light.apollo_imglogic_linkcmd_get_avatars", new ApolloGetAvatarDataVasHandler());
    jdField_c_of_type_Long = 0L;
  }
  
  public ApolloExtensionHandlerImpl(QQAppInterface paramQQAppInterface)
  {
  ...
  private void A(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        QLog.e(jdField_b_of_type_JavaLangString, 1, "handlePokeAuthResp failed " + paramIntent);
      }
      catch (Exception paramIntent)
      {
        localBundle.putInt("result", -254);
        localBundle.putString("msg", HardCodeUtil.a(2131715870));
        if (!QLog.isColorLevel()) {
          continue;
        }
        QLog.e(jdField_b_of_type_JavaLangString, 2, "handlePokeAuthResp failed ", paramIntent);
        continue;
      }
      notifyUI(23, false, localBundle);
      return;
      localBundle.putInt("result", -255);
      localBundle.putString("msg", HardCodeUtil.a(2131715871));
      if (QLog.isColorLevel()) {
        QLog.e(jdField_b_of_type_JavaLangString, 2, "handlePokeAuthResp fail ret: " + paramFromServiceMsg.getResultCode());
      }
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(jdField_b_of_type_JavaLangString, 2, "[handleGameOnlineCountRsp]");
    }
    if ((paramArrayOfByte == null) || (!paramFromServiceMsg.isSuccess()))
    {
      QLog.e(jdField_b_of_type_JavaLangString, 1, "[handleGameOnlineCountRsp] data null or rsp failed");
    ...
    try
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d(jdField_b_of_type_JavaLangString, 2, new Object[] { "[handleGameOnlineCountRsp] ret=", Long.valueOf(paramFromServiceMsg.ret.get()) });
      }
      if (paramFromServiceMsg.ret.get() == 0L)
      {
        paramFromServiceMsg = paramFromServiceMsg.rspdata.get();
        if (QLog.isColorLevel()) {
          QLog.d(jdField_b_of_type_JavaLangString, 2, new Object[] { "[handleGameOnlineCountRsp] respData=", paramFromServiceMsg });
        }
    ...
    {
      QLog.e(jdField_b_of_type_JavaLangString, 1, "[handleGameOnlineCountRsp] exception=", paramIntent);
      return;
    }
    notifyUI(25, false, null);
  }
  ...
  private void C(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          ...
          paramIntent = (TroopEnterEffectManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.TROOP_ENTER_EFFECT_MANAGER);
          if (l == 8192L)
          {
    ...
    if (paramFromServiceMsg != null)
    {
      ...
      SharedPreUtils.f(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), System.currentTimeMillis());
  ...
  private void D(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    if ((paramIntent != null) && (paramArrayOfByte != null) && (paramFromServiceMsg != null) && (paramFromServiceMsg.isSuccess()))
    {
      try
      {
        ...
        paramIntent.mergeFrom(paramArrayOfByte);
        if (QLog.isColorLevel()) {
          QLog.d(jdField_b_of_type_JavaLangString, 2, new Object[] { "[handleApolloGameLoginReq] ret=", Long.valueOf(paramIntent.ret.get()) });
        }
        if (paramIntent.ret.get() == 0L)
        {
          if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
          {
            ((ApolloGameManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.APOLLO_GAME_MANAGER)).a(paramIntent.ret.get(), paramIntent.pbRsqData.get().toByteArray());
            return;
          }
          QLog.e(jdField_b_of_type_JavaLangString, 1, "[handleApolloGameLoginReq] app is null");
          return;
        }
      }
      catch (Exception paramIntent)
      {
        QLog.e(jdField_b_of_type_JavaLangString, 1, "[handleApolloGameLoginReq] exception=", paramIntent);
        return;
      }
      QLog.e(jdField_b_of_type_JavaLangString, 1, new Object[] { "[handleApolloGameLoginReq] failed ret:", Long.valueOf(paramIntent.ret.get()) });
      return;
    }
    QLog.e(jdField_b_of_type_JavaLangString, 1, "[handleApolloGameLoginReq] failed");
  }
  ...
  private void E(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    if ((paramIntent != null) && (paramArrayOfByte != null) && (paramFromServiceMsg != null) && (paramFromServiceMsg.isSuccess()))
    {
      try
      {
        ...
        paramFromServiceMsg.mergeFrom(paramArrayOfByte);
        if (QLog.isColorLevel()) {
          QLog.d(jdField_b_of_type_JavaLangString, 2, new Object[] { "[handleGameConfigListReq] ret=", Long.valueOf(paramFromServiceMsg.ret.get()) });
        }
        if (paramFromServiceMsg.ret.get() == 0L)
        {
          if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
          {
            ((ApolloGameManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.APOLLO_GAME_MANAGER)).a(paramFromServiceMsg.ret.get(), paramFromServiceMsg.pbRsqData.get().toByteArray(), paramIntent.getBundleExtra("extras"));
            return;
          }
          QLog.e(jdField_b_of_type_JavaLangString, 1, "[handleGameConfigListReq] app is null");
          return;
        }
      }
      catch (Exception paramIntent)
      {
        QLog.e(jdField_b_of_type_JavaLangString, 1, "[handleGameConfigListReq] exception=", paramIntent);
        return;
      }
      QLog.e(jdField_b_of_type_JavaLangString, 1, new Object[] { "[handleGameConfigListReq] failed ret:", Long.valueOf(paramFromServiceMsg.ret.get()) });
      return;
    }
    QLog.e(jdField_b_of_type_JavaLangString, 1, "[handleGameConfigListReq] failed");
  }
  
  private void F(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    if (QLog.isColorLevel()) {
      QLog.d(jdField_b_of_type_JavaLangString, 2, "[handleApolloGameDevList]");
    }
    if ((paramIntent != null) && (paramArrayOfByte != null) && (paramFromServiceMsg != null) && (paramFromServiceMsg.isSuccess())) {}
    for (;;)
    {
      ...
      try
      {
        ...
        paramIntent.mergeFrom(paramArrayOfByte);
        if (QLog.isColorLevel()) {
          QLog.d(jdField_b_of_type_JavaLangString, 2, new Object[] { "[handleApolloGameDevList] ret=", Long.valueOf(paramIntent.ret.get()) });
        }
        if (paramIntent.ret.get() == 0L)
        {
          paramIntent = paramIntent.rspdata.get();
          if (QLog.isColorLevel()) {
            QLog.d(jdField_b_of_type_JavaLangString, 2, new Object[] { "[handleApolloGameDevList] respData=", paramIntent });
          }
          if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (!TextUtils.isEmpty(paramIntent)))
          {
            ...
            break label310;
            if (QLog.isColorLevel()) {
              QLog.d(jdField_b_of_type_JavaLangString, 2, new Object[] { "[handleApolloGameDevList] innerUin:", Integer.valueOf(i), ",gameIdList:", paramArrayOfByte });
            }
            paramFromServiceMsg.edit().putString(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + "_" + "cmgame_sp_dev_game_list", paramIntent).commit();
          }
        }
        return;
      }
      ...
      {
        QLog.e(jdField_b_of_type_JavaLangString, 1, "[handleApolloGameDevList] exception=", paramIntent);
        return;
      }
      label310:
      if (i == 1) {
  ...
  private void G(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramIntent.ret.get() == 0L)
        {
          ...
          if (paramFromServiceMsg.getResultCode() == 1002)
          {
            ...
            if (QLog.isColorLevel()) {
              QLog.d(jdField_b_of_type_JavaLangString, 2, "costTime:" + l + " isTimeOut:" + bool2 + " legalSuccess:" + bool1);
            }
            ((HiBoomManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.HIBOOM_MANAGER)).b(bool1);
          }
        }
        else
        {
      ...
      {
        QLog.e(jdField_b_of_type_JavaLangString, 2, "diy handler onRecive fail err:" + paramIntent.getMessage());
        return;
      }
    }
  }
  ...
  {
    QLog.d(jdField_b_of_type_JavaLangString, 1, "handleCmGameConnInfoRsp, code=" + paramFromServiceMsg.getResultCode());
    ...
    for (;;)
    {
      try
      {
        ...
        paramIntent.mergeFrom(paramArrayOfByte);
        long l = paramIntent.ret.get();
        QLog.e(jdField_b_of_type_JavaLangString, 2, new Object[] { "[handleCmGameConnInfoRsp] unissoRet=", Long.valueOf(l) });
        if (l != 0L) {
          break label230;
        }
        ...
        paramIntent = new CmGameConnManager.GameConnInfo(paramFromServiceMsg.ip_list.get(), i, paramFromServiceMsg.aes_key.get(), paramFromServiceMsg.distribute_ts.get(), paramFromServiceMsg.sign.get());
      }
      catch (Exception paramIntent)
      {
        QLog.e(jdField_b_of_type_JavaLangString, 2, "[handleCmGameConnInfoRsp] failed ", paramIntent);
        paramIntent = localObject;
        continue;
        paramFromServiceMsg.b();
        return;
      }
      paramFromServiceMsg = ((IApolloManagerService)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getRuntimeService(IApolloManagerService.class, "all")).getCmGameConnManager();
      if (paramIntent != null)
      {
  ...
  private void I(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    if ((paramIntent != null) && (paramArrayOfByte != null) && (paramFromServiceMsg != null) && (paramFromServiceMsg.isSuccess())) {
      try
      {
        ...
        paramIntent.mergeFrom(paramArrayOfByte);
        if (QLog.isColorLevel()) {
          QLog.d(jdField_b_of_type_JavaLangString + "_apollo_store_stability_", 2, new Object[] { "[handleReportApolloStoreStabilityResp] ret=", Long.valueOf(paramIntent.ret.get()) });
        }
        if (paramIntent.ret.get() != 0L) {
          QLog.e(jdField_b_of_type_JavaLangString + "_apollo_store_stability_", 1, new Object[] { "[handleReportApolloStoreStabilityResp] failed ret:", Long.valueOf(paramIntent.ret.get()) });
        }
        return;
      }
      catch (Exception paramIntent)
      {
        QLog.e(jdField_b_of_type_JavaLangString + "_apollo_store_stability_", 1, "[handleReportApolloStoreStabilityResp] exception=", paramIntent);
        return;
      }
    }
    QLog.e(jdField_b_of_type_JavaLangString + "_apollo_store_stability_", 1, "[handleReportApolloStoreStabilityResp] failed");
  }
  ...
  private void J(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      paramIntent.mergeFrom(paramArrayOfByte);
      if (QLog.isColorLevel()) {
        QLog.d(jdField_b_of_type_JavaLangString, 2, new Object[] { "[handleGetArkAds] ret=", Long.valueOf(paramIntent.ret.get()) });
      }
      if (paramIntent.ret.get() == 0L)
      {
        ...
        if (paramIntent != null)
        {
          ...
          {
            paramIntent = (GameCenterManagerImp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.GAMECENTER_MANAGER);
    ...
    {
      QLog.e(jdField_b_of_type_JavaLangString, 1, "[handleGetArkAds] err:" + paramIntent.getMessage());
    }
  }
  ...
  private void K(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      paramIntent.mergeFrom(paramArrayOfByte);
      if (QLog.isColorLevel()) {
        QLog.d(jdField_b_of_type_JavaLangString, 2, new Object[] { "[handleReportPadFaceShown] ret=", Long.valueOf(paramIntent.ret.get()) });
      }
      if (paramIntent.ret.get() == 0L)
      {
        paramIntent = new JSONObject(paramIntent.rspdata.get());
        if (paramIntent != null)
        {
          ...
          if (paramIntent != null)
          {
            ...
            if (i != 0) {
              QLog.e(jdField_b_of_type_JavaLangString, 1, "[handleReportPadFaceShown] ret:" + i);
            }
          }
        }
      }
    ...
    {
      QLog.e(jdField_b_of_type_JavaLangString, 1, "[handleReportPadFaceShown] err:" + paramIntent.getMessage());
    }
  }
  
  private void a(FromServiceMsg paramFromServiceMsg, BusinessObserver paramBusinessObserver, Object paramObject)
  {
    ThreadManager.getSubThreadHandler().post(new ApolloExtensionHandlerImpl.UpdateRunnable(paramBusinessObserver, paramFromServiceMsg.isSuccess(), paramObject));
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(jdField_b_of_type_JavaLangString, 2, "handleGetUserApolloDress rootData: " + paramJSONObject);
    }
    ...
    if (localJSONArray != null)
    {
      ...
      if (i < localJSONArray.length())
      {
        ...
        ApolloBaseInfo localApolloBaseInfo = localIApolloManagerService.getApolloBaseInfo(l1 + "");
        ...
        label338:
        for (localObject2 = "";; localObject2 = ((ApolloDress)localObject2).encode())
        {
          if ((!TextUtils.isEmpty((CharSequence)localObject2)) && (!TextUtils.equals((CharSequence)localObject1, (CharSequence)localObject2)))
          {
            ...
            if (QLog.isColorLevel()) {
              QLog.d(jdField_b_of_type_JavaLangString, 2, "save history uin:" + l1 + ", dress: " + (String)localObject1 + ", new dres: " + (String)localObject2);
            }
          }
    ...
    if (localObject1 != null)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d(jdField_b_of_type_JavaLangString, 2, "handleGetUserApolloDress MSAA_level deviceJson : " + localObject1);
      }
    }
    ...
    if (localObject1 != null)
    {
      ...
      if (i < ((JSONArray)localObject1).length())
      {
        ...
        paramJSONObject = localIApolloManagerService.getApolloBaseInfo(l1 + "");
      }
    }
    label752:
    for (int j = 1;; j = 0)
    {
      paramJSONObject.setApolloDress3D(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (JSONObject)localObject2);
      if (j != 0) {
        localArrayList.add(paramJSONObject);
      }
      paramJSONObject = paramJSONObject.getApolloDress3D();
      if ((paramJSONObject != null) && (!TextUtils.isEmpty(paramJSONObject.faceData))) {
        ((IApolloResDownloader)QRoute.api(IApolloResDownloader.class)).checkDownloadFaceData(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramJSONObject.faceData, null);
      }
      i += 1;
      break;
      if (localArrayList.size() > 0)
      {
        ...
        ((IApolloManagerService)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getRuntimeService(IApolloManagerService.class, "all")).updateUserDress(localArrayList);
      }
      for (;;)
      {
        return;
  ...
  private void a(JSONObject paramJSONObject, IApolloManagerService paramIApolloManagerService, ApolloBaseInfo paramApolloBaseInfo, boolean paramBoolean)
  {
    int i;
    if (paramJSONObject.has("CurrencyInfo"))
    {
      i = paramJSONObject.getJSONObject("CurrencyInfo").optInt("balance");
      ApolloPanelManager localApolloPanelManager = paramIApolloManagerService.getApolloPanelManager();
      if (localApolloPanelManager != null)
      {
        localApolloPanelManager.jdField_a_of_type_Int = i;
        if (localApolloPanelManager.jdField_a_of_type_Boolean) {
          localApolloPanelManager.c();
        }
      }
      if (QLog.isColorLevel()) {
        QLog.d(jdField_b_of_type_JavaLangString, 2, new Object[] { "balance:", Integer.valueOf(i) });
      }
    }
    ...
    if (paramJSONObject.has("gameCoinInfo"))
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d(jdField_b_of_type_JavaLangString, 2, new Object[] { "[handleGetUserApolloInfo] game coin count=", Integer.valueOf(i) });
      }
      ApolloGameUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, i);
    }
    if (paramBoolean) {
      paramIApolloManagerService.saveOrUpdateApolloBaseInfo(paramApolloBaseInfo);
    }
  }
  
  private void a(JSONObject paramJSONObject, IApolloDaoManagerService paramIApolloDaoManagerService, EntityManager paramEntityManager)
  {
      ...
      while (i < k)
      {
        ...
        if (localJSONObject1 != null)
        {
          ...
          if (localJSONArray != null)
          {
            ...
            paramIApolloDaoManagerService.updateGameScore(paramEntityManager, localArrayList);
          }
        }
        i += 1;
      }
  ...
  private void a(JSONObject paramJSONObject, JSONArray paramJSONArray, IApolloDaoManagerService paramIApolloDaoManagerService, EntityManager paramEntityManager)
  {
    if ((paramJSONArray != null) && (paramJSONArray.length() > 0))
    {
      ArrayList localArrayList = new ArrayList();
      ...
      while (i < j)
      {
        ...
        if (localObject != null)
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.i(jdField_b_of_type_JavaLangString, 2, "updateRankInfo handleGameRank data " + localApolloGameRankData1);
          }
          localObject = paramIApolloDaoManagerService.getRankData(2147483647);
          if ((localObject != null) && (((List)localObject).size() > 0))
          {
            ...
            while (((Iterator)localObject).hasNext())
            {
              ...
              if ((localApolloGameRankData2 != null) && (localApolloGameRankData2.mFriendUin.equals(localApolloGameRankData1.mFriendUin)) && (localApolloGameRankData2.mRank == 2) && (localApolloGameRankData1.mRank == 1)) {
                VipUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "cmshow", "Apollo", "beyond_notice_disappear", 3, 0, new String[] { String.valueOf(localApolloGameRankData2.mGameId) });
              }
            }
          }
        }
      ...
      paramIApolloDaoManagerService.updateGameRank(paramEntityManager, localArrayList);
    }
  }
  ...
  private void a(Long[] paramArrayOfLong, String paramString)
  {
    try
    {
      ...
      paramString = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), ApolloExtensionServletImpl.class);
    ...
    catch (Exception paramString)
    {
      ...
      QLog.e(jdField_b_of_type_JavaLangString, 2, paramString.getMessage());
    }
  }
  ...
  private boolean a(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    {
      QLog.e(jdField_b_of_type_JavaLangString, 1, "response is error", paramIntent);
    }
    return false;
  }
  ...
  {
    paramString = ApolloRequestReceiveManager.INSTANCE.getRequestReceive(paramString);
    if (paramString != null)
    {
      ApolloRequestReceiveParams localApolloRequestReceiveParams = new ApolloRequestReceiveParams();
      localApolloRequestReceiveParams.jdField_a_of_type_AndroidContentIntent = paramIntent;
      localApolloRequestReceiveParams.jdField_a_of_type_ComTencentQphoneBaseRemoteFromServiceMsg = paramFromServiceMsg;
      localApolloRequestReceiveParams.jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
      localApolloRequestReceiveParams.jdField_a_of_type_ComTencentMobileqqApolloApiHandlerImplApolloExtensionHandlerImpl = this;
      localApolloRequestReceiveParams.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
      paramString.a(localApolloRequestReceiveParams);
      return true;
    }
    return false;
  }
  
  private boolean a(IApolloManagerService paramIApolloManagerService1, HashMap<Integer, Bundle> paramHashMap, JSONArray paramJSONArray, IApolloManagerService paramIApolloManagerService2, IApolloDaoManagerService paramIApolloDaoManagerService)
  {
    boolean bool1 = false;
    boolean bool2 = false;
    ...
    paramIApolloManagerService2 = paramIApolloDaoManagerService.getNotFeeTypeActionList(1);
    paramJSONArray = paramIApolloDaoManagerService.getHideActionList();
    int i;
    if (paramIApolloManagerService2 != null)
    {
      j = 0;
      i = 0;
      while (j < paramIApolloManagerService2.size())
      {
        ApolloActionData localApolloActionData = (ApolloActionData)paramIApolloManagerService2.get(j);
        if (paramHashMap.containsKey(Integer.valueOf(localApolloActionData.actionId)))
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.d(jdField_b_of_type_JavaLangString, 2, "handleGetUserApolloInfo update actlist id: " + localApolloActionData.actionId);
          }
          i = 1;
        }
        j += 1;
      }
      if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (paramIApolloDaoManagerService != null) && (i != 0)) {
        paramIApolloDaoManagerService.bulkSaveOrUpdateApolloActionData(paramIApolloManagerService2);
      }
    }
    for (int j = i;; j = 0)
    {
      if (paramJSONArray != null)
      {
        ...
        {
          paramIApolloManagerService2 = (ApolloActionData)paramJSONArray.get(k);
          if (paramHashMap.containsKey(Integer.valueOf(paramIApolloManagerService2.actionId)))
          {
            paramIApolloManagerService2.isShow = 1;
            if (QLog.isColorLevel()) {
              QLog.d(jdField_b_of_type_JavaLangString, 2, new Object[] { "[handleGetUserApolloInfo] set user action ", Integer.valueOf(paramIApolloManagerService2.actionId), " visible" });
            }
            i = 1;
          }
          k += 1;
      ...
      for (int k = i;; k = 0)
      {
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            ...
            if (paramIApolloDaoManagerService.findActionById(((Integer)paramHashMap.next()).intValue()) == null) {
              paramIApolloManagerService1.checkActionJsonInterval();
            }
          }
  ...
  private boolean a(String paramString, WebSSOAgent.UniSsoServerRsp paramUniSsoServerRsp, int paramInt)
  {
    ...
    boolean bool2;
    int i;
    if ((paramUniSsoServerRsp != null) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null))
    {
      if (QLog.isColorLevel()) {
        QLog.d(jdField_b_of_type_JavaLangString, 2, "handleGetUserApolloInfo apollo data: " + paramUniSsoServerRsp.toString());
      }
      ...
      {
        paramString = localIApolloManagerService.getApolloBaseInfo(paramString);
        bool2 = false;
        bool1 = bool2;
    ...
    for (boolean bool1 = true;; bool1 = bool2)
    {
      if (paramUniSsoServerRsp.has("actlist"))
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d(jdField_b_of_type_JavaLangString, 2, new Object[] { "[handleGetUserApolloInfo] user action list=", localObject1 });
        }
        ...
        if (localHashMap.size() > 0)
        {
          ...
          if (localObject1 != null) {
            ((IApolloManagerService)localObject1).setUserActionId(localHashMap);
          }
          ...
          a(localIApolloManagerService, localHashMap, localJSONArray, (IApolloManagerService)localObject1, (IApolloDaoManagerService)localObject2);
        }
      ...
      for (bool2 = a(paramUniSsoServerRsp);; bool2 = false)
      {
        if (bool2)
        {
          QLog.d(jdField_b_of_type_JavaLangString, 1, "[handleGetUserApolloInfo] send NOTIFY_TYPE_REFRESH_ACTION");
          notifyUI(9, true, null);
        }
        a(paramUniSsoServerRsp, localIApolloManagerService, paramString, bool1);
        return false;
        notifyUI(9, false, null);
        break;
      }
  ...
  private boolean a(JSONArray paramJSONArray, boolean paramBoolean, int paramInt, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      if (i < j)
      {
        ...
        if (paramLong != l)
        {
          QLog.i(jdField_b_of_type_JavaLangString, 1, "handleApolloStandAction version update res.");
          bool = true;
        }
      }
      return bool;
  ...
  {
    QLog.d(jdField_b_of_type_JavaLangString, 1, "[handleGetUserApolloInfo] rsp for recommend action");
    ArrayList localArrayList = new ArrayList();
    ...
    if (paramJSONObject.has("hotAct"))
    {
      ...
      QLog.d(jdField_b_of_type_JavaLangString, 1, new Object[] { "[handleGetUserApolloInfo] hotAct=", localObject2 });
    ...
    if (paramJSONObject.has("ascendAct"))
    {
      ...
      QLog.d(jdField_b_of_type_JavaLangString, 1, new Object[] { "[handleGetUserApolloInfo] ascendAct=", paramJSONObject });
    ...
    for (int j = 1;; j = 0)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
      {
        paramJSONObject = (IApolloDaoManagerService)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getRuntimeService(IApolloDaoManagerService.class, "all");
        if (paramJSONObject != null)
        {
          localObject1 = paramJSONObject.getRecommendList();
          QLog.d(jdField_b_of_type_JavaLangString, 1, new Object[] { "[handleGetUserApolloInfo] recommendActionList=", localArrayList, ", local=", localObject1 });
      ...
      for (;;)
      {
        if (i != 0)
        {
          QLog.d(jdField_b_of_type_JavaLangString, 1, new Object[] { "[handleGetUserApolloInfo] update recommendActionList=", localArrayList });
          paramJSONObject.removeAllRecommendActionList();
          paramJSONObject.saveRecommendActionList(localArrayList);
          return true;
          i = 0;
          for (;;)
          {
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(jdField_b_of_type_JavaLangString, 2, "handleExpireInfoResponse");
    }
    long l2;
    try
    {
      if (!paramFromServiceMsg.isSuccess())
      {
        QLog.e(jdField_b_of_type_JavaLangString, 1, "handleExpireInfoResponse, isSuccess false, error code=" + paramFromServiceMsg.getResultCode());
        return;
      }
      ...
      if (l1 != 0L) {
        QLog.e(jdField_b_of_type_JavaLangString, 1, "handleExpireInfoResponse, ret=" + l1 + ", error msg=" + paramFromServiceMsg.errmsg.get());
      }
      l2 = paramIntent.getIntExtra("from", 1);
      if (QLog.isColorLevel()) {
        QLog.d(jdField_b_of_type_JavaLangString, 2, "handleExpireInfoResponse, from=" + l2);
      }
      if (l2 == 1L)
      {
        if (l1 != 0L) {
        ...
        if (QLog.isColorLevel()) {
          QLog.d(jdField_b_of_type_JavaLangString, 2, "handleExpireInfoResponse, from aio, expireFlag=" + i + ", expireTipContent=" + paramIntent + ", clickText=" + paramFromServiceMsg + ", action=" + j + ", url=" + paramObject);
        }
        if (i == 0) {
          return;
        }
    ...
    {
      QLog.e(jdField_b_of_type_JavaLangString, 1, "handleExpireInfoResponse exception", paramIntent);
      return;
    }
    if ((l2 != 2L) && (l2 == 3L)) {}
  }
  ...
  private void w(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    if ((paramArrayOfByte == null) || (!paramFromServiceMsg.isSuccess()))
    {
      QLog.e(jdField_b_of_type_JavaLangString, 1, "[handleExploreInfo] cmd: " + str + "data null or rsp failed");
    ...
    do
    {
      ...
      while (!paramFromServiceMsg.hasNext())
      {
        for (;;)
        {
          try
          {
            ...
            paramArrayOfByte = new StringBuilder().append("[handleExploreInfo] cmd: ").append(str).append(", retCode: ").append(l).append(", errMsg: ");
          ...
          {
            QLog.e(jdField_b_of_type_JavaLangString, 1, "[handleExploreInfo] cmd: " + str + ", exceptonMsg: " + paramIntent.getMessage());
            notifyUI(28, false, null);
            return;
          }
          paramIntent = "unknown";
      ...
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getSharedPreferences("apollo_sp" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin(), 0);
      if (j != 1) {
        break;
      }
      paramIntent = "next_req_st_drawer";
      this.jdField_a_of_type_Int = k;
      ((SharedPreferences)localObject1).edit().putInt(paramIntent, k).commit();
      paramIntent = paramArrayOfByte.msg_info.get().iterator();
    } while (!paramIntent.hasNext());
    Object localObject2 = (STExploreInfo.STMsgInfo)paramIntent.next();
    long l = ((STExploreInfo.STMsgInfo)localObject2).seq.get();
    paramFromServiceMsg = ((STExploreInfo.STMsgInfo)localObject2).wording.get().toStringUtf8();
    paramArrayOfByte = ((STExploreInfo.STMsgInfo)localObject2).jump_url.get().toStringUtf8();
    int m = ((STExploreInfo.STMsgInfo)localObject2).is_red.get();
    Object localObject1 = ((STExploreInfo.STMsgInfo)localObject2).icon_url.get().toStringUtf8();
    int n = ((STExploreInfo.STMsgInfo)localObject2).action_id.get();
    int i1 = ((STExploreInfo.STMsgInfo)localObject2).bubble_id.get();
    paramIntent = ((STExploreInfo.STMsgInfo)localObject2).scheme.get();
    int i2 = ((IApolloManagerService)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getRuntimeService(IApolloManagerService.class, "all")).getCmShowStatus(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin());
    if (2 == i2)
    {
      paramIntent = "3d_" + paramIntent;
      label570:
      if (!((STExploreInfo.STMsgInfo)localObject2).msg_id.has()) {
        break label832;
      }
    }
    label832:
    for (int i = ((STExploreInfo.STMsgInfo)localObject2).msg_id.get();; i = 0)
    {
      localObject2 = new JSONObject();
      ((JSONObject)localObject2).put("entry_id", j);
      ((JSONObject)localObject2).put("seq", l);
      ((JSONObject)localObject2).put("wording", paramFromServiceMsg);
      ((JSONObject)localObject2).put("jump_url", paramArrayOfByte);
      ((JSONObject)localObject2).put("is_red", m);
      ((JSONObject)localObject2).put("icon_url", localObject1);
      ((JSONObject)localObject2).put("action_id", n);
      ((JSONObject)localObject2).put("bubble_id", i1);
      ((JSONObject)localObject2).put("scheme", paramIntent);
      ((JSONObject)localObject2).put("next_st", k);
      ((JSONObject)localObject2).put("show_sum", 1);
      ((JSONObject)localObject2).put("msg_id", i);
      ((JSONObject)localObject2).put("cmshow_module", i2);
      QLog.d(jdField_b_of_type_JavaLangString, 1, "[handleExploreInfo] reqCmd: " + str + ", id:" + j + ",info:" + ((JSONObject)localObject2).toString());
      notifyUI(28, true, ((JSONObject)localObject2).toString());
      return;
  ...
  {
    int j = 0;
    QLog.d(jdField_b_of_type_JavaLangString, 1, "; isSuccess: " + paramFromServiceMsg.isSuccess() + ", ret: " + paramFromServiceMsg.getResultCode());
    if ((paramArrayOfByte != null) && (paramFromServiceMsg.isSuccess())) {}
    for (;;)
    {
      try
      {
        ...
        paramFromServiceMsg.mergeFrom(paramArrayOfByte);
        if (QLog.isColorLevel()) {
          QLog.d(jdField_b_of_type_JavaLangString, 2, "handleGetUserApolloDress ret: " + paramFromServiceMsg.ret.get());
        }
      ...
      {
        long l;
        QLog.e(jdField_b_of_type_JavaLangString, 1, "", paramFromServiceMsg);
        continue;
      }
      ...
      if (QLog.isColorLevel())
      {
        ...
        if (i < k)
        {
          ...
          QLog.e(jdField_b_of_type_JavaLangString, 2, "handleGetUserApolloDress no dress info uin:" + l);
        ...
        {
          continue;
          QLog.e(jdField_b_of_type_JavaLangString, 1, "handleGetUserApolloDress request failed " + paramFromServiceMsg.ret.get());
          paramFromServiceMsg = (Long[])paramIntent.getExtras().get("uinArr");
          if (paramFromServiceMsg != null)
          {
            k = paramFromServiceMsg.length;
            ...
            {
              continue;
              QLog.e(jdField_b_of_type_JavaLangString, 1, "handleGetUserApolloDress fail ret: " + paramFromServiceMsg.getResultCode());
              paramFromServiceMsg = (Long[])paramIntent.getExtras().get("uinArr");
              if (paramFromServiceMsg != null)
              {
                k = paramFromServiceMsg.length;
    ...
    if (QLog.isColorLevel()) {
      QLog.i(jdField_b_of_type_JavaLangString, 2, "handleGetUserApolloDress done  mSendingQueue size: " + this.jdField_a_of_type_JavaUtilVector.size());
    }
  }
  
  private void y(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    Object localObject1 = jdField_b_of_type_JavaLangString;
    ...
    for (int i = paramArrayOfByte.length;; i = -1)
    {
      ...
      if ((paramArrayOfByte != null) && (paramFromServiceMsg.isSuccess())) {
        try
        {
          ...
          if ((paramFromServiceMsg.uint32_result.has()) && (paramFromServiceMsg.uint32_result.get() == 0))
          {
            ...
            if (i < paramIntent.rpt_msg_uin_data.size())
            {
              ...
              ApolloBaseInfo localApolloBaseInfo = ((IApolloManagerService)localObject1).getApolloBaseInfo(str);
              ...
              QLog.d(jdField_b_of_type_JavaLangString, 1, new Object[] { "handleGetApolloBaseInfo uin: ", localApolloBaseInfo.uin, ",apollo vipFlag: ", Integer.valueOf(localApolloBaseInfo.apolloVipFlag), ", apollo status: ", Integer.valueOf(localApolloBaseInfo.apolloStatus), ", apollo level: ", Integer.valueOf(localApolloBaseInfo.apolloVipLevel), ", svr TS: ", Long.valueOf(localApolloBaseInfo.apolloServerTS), ", cmshow3dFlag=", Integer.valueOf(localApolloBaseInfo.cmshow3dFlag) });
        ...
        {
          QLog.e(jdField_b_of_type_JavaLangString, 1, "", paramIntent);
        }
      }
      do
      {
        ((IApolloManagerService)localObject1).bulkSaveOrUpdateApolloBaseInfos(paramArrayOfByte);
      ...
      if (i < j)
      {
        ...
        localObject1 = ((IApolloManagerService)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getRuntimeService(IApolloManagerService.class, "all")).getApolloBaseInfo(paramArrayOfByte);
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(jdField_b_of_type_JavaLangString, 2, "[handleSetUserFlagResponse]");
    }
    HashMap localHashMap = new HashMap();
    int i;
    if (paramIntent != null)
    {
      ...
      if (paramIntent != null)
      {
        ...
        {
          QLog.e(jdField_b_of_type_JavaLangString, 1, "[handleSetUserFlagResponse] get request data exception=", paramIntent);
        }
      }
    }
    QLog.d(jdField_b_of_type_JavaLangString, 2, new Object[] { "[handleSetUserFlagResponse] flagSettingMap=", localHashMap });
    label201:
    if ((paramArrayOfByte != null) && (paramFromServiceMsg.isSuccess())) {}
    for (;;)
    {
      ...
      try
      {
        ...
        l = paramIntent.ret.get();
        if (QLog.isColorLevel()) {
          QLog.d(jdField_b_of_type_JavaLangString, 2, new Object[] { "[handleSetUserFlagResponse] ret=", Long.valueOf(l) });
        }
        if ((l != 0L) || (!localHashMap.containsKey(Integer.valueOf(16)))) {
          break label535;
        }
        i = ((Integer)localHashMap.get(Integer.valueOf(16))).intValue();
        paramIntent = (IApolloManagerService)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getRuntimeService(IApolloManagerService.class, "all");
        paramFromServiceMsg = paramIntent.getApolloBaseInfo(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
        if ((paramFromServiceMsg == null) || ((paramFromServiceMsg.apolloAISwitch & 0x10) == i << 4)) {
          break label535;
        }
        if (QLog.isColorLevel()) {
          QLog.d(jdField_b_of_type_JavaLangString, 2, new Object[] { "[handleSetUserFlagResponse] before update, apolloAISwitch=", Integer.toBinaryString(paramFromServiceMsg.apolloAISwitch) });
        }
        paramFromServiceMsg.apolloAISwitch = (paramFromServiceMsg.apolloAISwitch & 0xFFFFFFEF | paramFromServiceMsg.apolloAISwitch ^ 0x10);
        paramIntent.saveOrUpdateApolloBaseInfo(paramFromServiceMsg);
        if (!QLog.isColorLevel()) {
          break label535;
        }
        QLog.d(jdField_b_of_type_JavaLangString, 2, new Object[] { "[handleSetUserFlagResponse] after update, apolloAISwitch=", Integer.toBinaryString(paramFromServiceMsg.apolloAISwitch) });
      }
      catch (Exception paramIntent)
      {
        if (!QLog.isColorLevel()) {
        ...
        QLog.e(jdField_b_of_type_JavaLangString, 2, "[handleSetUserFlagResponse] exception=", paramIntent);
      ...
      continue;
      if (QLog.isColorLevel()) {
        QLog.e(jdField_b_of_type_JavaLangString, 2, new Object[] { "[handleSetUserFlagResponse] failed, result code=", Integer.valueOf(paramFromServiceMsg.getResultCode()) });
      }
  ...
  public JSONObject a(String paramString, List<ApolloGameScoreData> paramList)
  {
    ...
    {
      QLog.e(jdField_b_of_type_JavaLangString, 1, "[getScoreParam]", paramString);
      return null;
    }
  ...
  public void a()
  {
    try
    {
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)
      {
        QLog.e(jdField_b_of_type_JavaLangString, 1, "[getUsedAppList]");
        return;
      }
      Object localObject = new WebSSOAgent.UniSsoServerReqComm();
      ((WebSSOAgent.UniSsoServerReqComm)localObject).platform.set(109L);
      ...
      localUniSsoServerReq.reqdata.set(((JSONObject)localObject).toString());
      if (QLog.isColorLevel()) {
        QLog.d(jdField_b_of_type_JavaLangString, 2, "[getUsedAppList] " + ((JSONObject)localObject).toString());
      }
      localObject = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), ApolloExtensionServletImpl.class);
    ...
    {
      QLog.e(jdField_b_of_type_JavaLangString, 1, "[getUsedAppList] exception=", localException);
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(jdField_b_of_type_JavaLangString, 2, "requestExpireInfo, from=" + paramInt);
    }
    ...
    ((IndividPub.Platform_Comm_Req)localObject).mqqver.set("8.5.5.5105");
    ...
    localObject = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), ApolloExtensionServletImpl.class);
    ((NewIntent)localObject).putExtra("cmd", d);
  ...
  {
    QLog.d(jdField_b_of_type_JavaLangString, 1, "getPadFaceAd");
    try
    {
      Object localObject = new WebSSOAgent.UniSsoServerReqComm();
      ((WebSSOAgent.UniSsoServerReqComm)localObject).platform.set(109L);
      ...
      JSONObject localJSONObject2 = new JSONObject();
      localJSONObject2.put("uin", Long.parseLong(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()));
    ...
    {
      QLog.e(jdField_b_of_type_JavaLangString, 1, "[getPadFaceAd] exception=", localException);
    }
  }
  ...
  public void a(int paramInt1, int paramInt2, String paramString)
  {
    ...
    try
    {
      i = NetworkUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext());
    }
    catch (Exception paramString)
    {
      for (;;)
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(jdField_b_of_type_JavaLangString, 2, "requestPraiseAuth, praiseId=" + paramInt);
    }
    ...
    localTPraiseSsoReq.str_qq_ver.set("8.5.5.5105");
  ...
  public void a(int paramInt1, String paramString1, int paramInt2, String paramString2, int paramInt3)
  {
    ...
    {
      while (!QLog.isColorLevel()) {}
      QLog.e(jdField_b_of_type_JavaLangString, 2, "handlePokeAuth failed ", paramString1);
    }
  }
  
  public void a(int paramInt, String paramString, ApolloRequestCallbackManager.ApolloRspCallback paramApolloRspCallback)
  {
    ...
    for (;;)
    {
      ...
      QLog.e(jdField_b_of_type_JavaLangString, 2, "changeApolloStatus failed ", paramString);
      return;
      label224:
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(jdField_b_of_type_JavaLangString, 2, "[reportGamePubAccountMsgList] status:" + paramInt + ",msg:" + paramString1 + ",url:" + paramString2);
    }
    Object localObject = new WebSSOAgent.UniSsoServerReqComm();
    ((WebSSOAgent.UniSsoServerReqComm)localObject).platform.set(109L);
    ((WebSSOAgent.UniSsoServerReqComm)localObject).osver.set(Build.VERSION.RELEASE);
    ...
    for (paramString1 = Long.valueOf(0L);; paramString1 = Long.valueOf(Long.parseLong(paramString1)))
    {
      ...
      paramString1 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), ApolloExtensionServletImpl.class);
  ...
  public void a(int paramInt1, String paramString1, String paramString2, int paramInt2, float paramFloat, int paramInt3, String paramString3)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.e(jdField_b_of_type_JavaLangString, 2, "checkActionAuth failed id: " + paramInt1, paramString1);
      }
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(jdField_b_of_type_JavaLangString, 2, new Object[] { "[getGameOnlineUserCount] gameId=", Integer.valueOf(paramInt1), ", from=", paramString1 });
    }
    try
    {
      Object localObject = new WebSSOAgent.UniSsoServerReqComm();
    ...
    {
      QLog.e(jdField_b_of_type_JavaLangString, 1, "[getGameOnlineUserCount] exception=", paramString1);
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(jdField_b_of_type_JavaLangString, 2, "[reportGamePubAccountMsgList] status:" + paramInt + " size:" + paramList.size());
    }
    Object localObject = new WebSSOAgent.UniSsoServerReqComm();
    ((WebSSOAgent.UniSsoServerReqComm)localObject).platform.set(109L);
    ((WebSSOAgent.UniSsoServerReqComm)localObject).osver.set(Build.VERSION.RELEASE);
    ...
    for (;;)
    {
      ...
      break;
      localUniSsoServerReq.pbReqData.set(ByteStringMicro.copyFrom(((MonitReport.MonitReportReq)localObject).toByteArray()));
      paramList = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), ApolloExtensionServletImpl.class);
  ...
  {
    NewIntent localNewIntent = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), ApolloExtensionServletImpl.class);
    localNewIntent.putExtra("cmd", jdField_c_of_type_JavaLangString);
    ...
    localSetAddonReq.str_qq_version.set("8.5.5");
    if (paramInt2 != -1) {
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    localReqBody.u64_uin.set(Long.parseLong(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()));
    localReqBody.i32_implat.set(109);
    localReqBody.str_version.set(DeviceInfoUtil.c());
    Object localObject;
    if (paramLong1 == 8192L)
    {
      if (QLog.isColorLevel()) {
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(jdField_b_of_type_JavaLangString, 2, "handlePraiseAuthResponse");
    }
    for (;;)
    {
      int i;
      try
      {
        if (!paramFromServiceMsg.isSuccess())
        {
          QLog.e(jdField_b_of_type_JavaLangString, 1, "handlePraiseAuthResponse, isSuccess false, error code=" + paramFromServiceMsg.getResultCode());
          return;
        }
      ...
      {
        QLog.e(jdField_b_of_type_JavaLangString, 1, "handlePraiseAuthResponse exception", paramIntent);
        return;
      }
      QLog.e(jdField_b_of_type_JavaLangString, 1, "handlePraiseAuthResponse, ret=" + i);
    }
  }
  ...
  public void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    do
    {
      ...
      IVasExtensionHandler localIVasExtensionHandler = (IVasExtensionHandler)jdField_a_of_type_JavaUtilMap.get(str);
      if (localIVasExtensionHandler != null)
      {
        localIVasExtensionHandler.a(this, paramIntent, paramFromServiceMsg, paramArrayOfByte);
        return;
      }
    } while (!QLog.isColorLevel());
    QLog.e(jdField_b_of_type_JavaLangString, 2, "unknow cmd :" + str);
  }
  ...
  public void a(Intent paramIntent, byte[] paramArrayOfByte)
  {
    ...
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      for (;;)
      {
        QLog.e(jdField_b_of_type_JavaLangString, 1, "handlePendantAuthRsp rsp.mergeFrom e=" + paramArrayOfByte);
      ...
      try
      {
        ...
        if (bool)
        {
          ...
          if (((String)localObject1).equals("")) {
            paramIntent = HardCodeUtil.a(2131715868);
          }
          ...
          paramIntent = (Intent)localObject1;
          if (((String)localObject1).equals("")) {
            paramIntent = HardCodeUtil.a(2131715869);
          }
          ...
          paramIntent = (Intent)localObject1;
          if (((String)localObject1).equals("")) {
            paramIntent = HardCodeUtil.a(2131715867);
          }
      ...
      catch (InvalidProtocolBufferMicroException paramIntent)
      {
        ...
        {
          label377:
          QLog.e(jdField_b_of_type_JavaLangString, 1, "handlePendantAuthRsp tipsInfo.mergeFrom e=" + paramIntent);
        }
  ...
  {
    QLog.d(jdField_b_of_type_JavaLangString, 1, "reportGameCenterChannel");
    try
    {
      Object localObject = new WebSSOAgent.UniSsoServerReqComm();
      ((WebSSOAgent.UniSsoServerReqComm)localObject).platform.set(109L);
      ...
      localUniSsoServerReq.reqdata.set(((JSONObject)localObject).toString());
      paramReportChannlInfo = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), ApolloExtensionServletImpl.class);
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.startServlet(paramReportChannlInfo);
      return;
    }
  ...
  public void a(ApolloExtensionHandlerImpl.OnQueryBaseInfoListener paramOnQueryBaseInfoListener)
  {
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(jdField_b_of_type_JavaLangString, 2, "[buyActionByGold]");
    }
    try
    {
      Object localObject = new WebSSOAgent.UniSsoServerReqComm();
    ...
    {
      QLog.e(jdField_b_of_type_JavaLangString, 1, "[handleBuyActionByGold] exception=", paramString);
    }
  }
  
  public void a(String paramString, int paramInt, ApolloRequestCallbackManager.ApolloRspCallback paramApolloRspCallback)
  {
    try
    {
      Object localObject = new WebSSOAgent.UniSsoServerReqComm();
  ...
  public void a(String paramString1, int paramInt, String paramString2)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d(jdField_b_of_type_JavaLangString, 2, "");
    }
    for (;;)
    {
      try
      {
        ...
        localUniSsoServerReq.reqdata.set(localJSONObject.toString());
        paramString2 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), ApolloExtensionServletImpl.class);
      ...
      QLog.e(jdField_b_of_type_JavaLangString, 2, "getUserApolloInfo failed ", paramString1);
      return;
      label336:
  ...
  void a(String paramString, Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      {
        QLog.e(jdField_b_of_type_JavaLangString, 1, "handleRoomSSOInfoCallback error:", paramString);
        return;
      }
      if ("apollo_game_av.get_av_ctrl_param".equals(paramString))
      {
  ...
  public void a(String paramString, ApolloBaseInfo paramApolloBaseInfo)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      ...
      {
        ApolloExtensionHandlerImpl.OnQueryBaseInfoListener localOnQueryBaseInfoListener = (ApolloExtensionHandlerImpl.OnQueryBaseInfoListener)localIterator.next();
  ...
  public void a(String paramString, MessageMicro paramMessageMicro, Class paramClass, BusinessObserver paramBusinessObserver)
  {
    ...
    NewIntent localNewIntent = new NewIntent(localQQAppInterface.getApp(), ApolloExtensionServletImpl.class);
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      QLog.e(jdField_b_of_type_JavaLangString, 2, "changeApolloStatus failed ", paramString1);
      return;
      label203:
      paramString2 = "android." + paramString2;
    }
  ...
  {
    QLog.d(jdField_b_of_type_JavaLangString, 1, "[reportGameAchievement]");
    try
    {
      Object localObject = new WebSSOAgent.UniSsoServerReqComm();
      ((WebSSOAgent.UniSsoServerReqComm)localObject).platform.set(109L);
      ...
      localJSONObject2.put("skey", ((TicketManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(2)).getSkey(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()));
      localJSONObject1.put("req", localJSONObject2);
    ...
    {
      QLog.e(jdField_b_of_type_JavaLangString, 1, "[reportGameAchievement] exception=", paramString1);
    }
  }
  ...
  public void a(String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    try
    {
      ...
      {
        QLog.e(jdField_b_of_type_JavaLangString + "_apollo_store_stability_", 1, "reportApolloStoreStabilityData. cmd == null || url == null");
        return;
      }
      ...
      localObject2 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), ApolloExtensionServletImpl.class);
      ...
      if (QLog.isColorLevel())
      {
        ...
        QLog.d(jdField_b_of_type_JavaLangString + "_apollo_store_stability_", 2, ((StringBuilder)localObject1).toString());
        return;
      }
    }
    catch (Exception paramString1)
    {
      QLog.e(jdField_b_of_type_JavaLangString + "_apollo_store_stability_", 1, "reportApolloStoreStabilityData failed ", paramString1);
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(jdField_b_of_type_JavaLangString, 2, "[doCMGameReq], cmd:" + paramString1 + ",reqData:" + paramString2 + ",luaR:" + paramLong + ", app: " + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    }
    try
    {
      Object localObject = new WebSSOAgent.UniSsoServerReqComm();
      ...
      {
        localObject = ApolloUtilImpl.convertJson2JavaObj(paramString2).toByteArray();
        byte[] arrayOfByte = paramString2.getBytes();
        if ((localObject != null) && (localObject.length > 0))
        {
          if (QLog.isColorLevel()) {
            QLog.d(jdField_b_of_type_JavaLangString, 2, "set pb data, orgByte:" + arrayOfByte.length + ",pbByte:" + localObject.length);
          }
    ...
    {
      QLog.e(jdField_b_of_type_JavaLangString, 1, "doCMGameReq failed ", paramString1);
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(jdField_b_of_type_JavaLangString, 2, "[getGameStatusReq], cmd:" + paramString1 + ",reqData:" + paramString2 + ",extraInfo:" + paramString3);
    }
    try
    {
    ...
    {
      while (!QLog.isColorLevel()) {}
      QLog.e(jdField_b_of_type_JavaLangString, 2, "getGameStatusReq failed ", paramString1);
    }
  }
  
  public void a(String paramString, ArrayList<ColorClearableEditText.Paragraph> paramArrayList, int paramInt)
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("ColorNick", 2, "modifyTroopMemberCardInfoWithColorNick type = " + localParagraph.c + " text = " + localParagraph.jdField_a_of_type_JavaLangString);
        }
        localArrayList2.add(localRichCardNameElem);
        break;
        localRichCardNameElem.bytes_text.set(ByteStringMicro.copyFrom(localParagraph.jdField_a_of_type_JavaLangString.getBytes()));
        localStringBuilder.append(localParagraph.jdField_a_of_type_JavaLangString);
        continue;
        paramArrayList = localParagraph.jdField_a_of_type_JavaLangString;
    ...
    paramArrayList = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), ApolloExtensionServletImpl.class);
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i(jdField_b_of_type_JavaLangString, 2, "getApolloStandAction.");
    }
    if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null) || (TextUtils.isEmpty(paramString1)) || (paramList1 == null)) {
      QLog.e(jdField_b_of_type_JavaLangString, 1, "[requestGameRank] uin is empty");
    }
    do
    {
      return;
      try
      {
        ...
        localUniSsoServerReq.reqdata.set(((JSONObject)localObject).toString());
        if (QLog.isColorLevel()) {
          QLog.i(jdField_b_of_type_JavaLangString, 2, "requestGameRank request:" + localObject);
        }
        paramString1 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), ApolloExtensionServletImpl.class);
        paramString1.putExtra("cmd", "apollo_router_game.game_relation_linkcmd_get_rank_chg");
        paramString1.putExtra("data", localUniSsoServerReq.toByteArray());
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.startServlet(paramString1);
        VipUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "cmshow", "Apollo", "get_rank_compare", 1, 0, new String[0]);
        return;
      }
      catch (Exception paramString1) {}
    } while (!QLog.isColorLevel());
    QLog.e(jdField_b_of_type_JavaLangString, 2, "getApolloStandAction failed ", paramString1);
  }
  ...
  public void a(ArrayList<Long> paramArrayList, String paramString)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d(jdField_b_of_type_JavaLangString, 2, "getGetUserApolloDress uinList size: " + ((ArrayList)localObject).size() + ", queue size: " + this.jdField_a_of_type_JavaUtilVector.size() + ",from: " + paramString);
    }
    int i = 0;
    label132:
  ...
  public void a(List<Integer> paramList, Bundle paramBundle)
  {
    for (;;)
    {
      try
      {
        if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null) || (paramList == null) || (paramList.size() == 0))
        {
          QLog.e(jdField_b_of_type_JavaLangString, 1, "[getGameConfigListReq] app is null");
          return;
        }
        Object localObject = new WebSSOAgent.UniSsoServerReqComm();
        ((WebSSOAgent.UniSsoServerReqComm)localObject).platform.set(109L);
        ...
        if (bool)
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.d(jdField_b_of_type_JavaLangString, 1, new Object[] { "getGameConfigListReq isGameWhiteUser:", Boolean.valueOf(bool) });
          }
          localObject = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), ApolloExtensionServletImpl.class);
      ...
      {
        QLog.e(jdField_b_of_type_JavaLangString, 1, "[getGameConfigListReq] exception=", paramList);
        return;
      }
  ...
  public void a(long... paramVarArgs)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        localUniSsoServerReq.reqdata.set(((JSONObject)localObject).toString());
        paramVarArgs = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), ApolloExtensionServletImpl.class);
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.startServlet(paramVarArgs);
        return;
      }
      catch (Exception paramVarArgs) {}
    } while (!QLog.isColorLevel());
    QLog.e(jdField_b_of_type_JavaLangString, 2, "getApolloStandAction failed ", paramVarArgs);
  }
  ...
  public boolean a(String paramString1, String paramString2)
  {
    try
    {
      ...
      localSCUpdateReq.comm.qver.set(ByteStringMicro.copyFrom("8.5.5.5105".getBytes()));
      localSCUpdateReq.comm.osrelease.set(ByteStringMicro.copyFrom(String.valueOf(Build.VERSION.SDK_INT).getBytes()));
      localSCUpdateReq.comm.network.set(NetworkUtil.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication()));
      ...
      for (;;)
      {
        if (!"SyncVCRReq".equals(paramString1)) {
          break label503;
        }
    ...
    catch (Throwable paramString1)
    {
      if (QLog.isColorLevel())
      {
        ...
        while (i < paramString1.length)
        {
          QLog.e(jdField_b_of_type_JavaLangString, 2, paramString1[i].toString());
          i += 1;
        }
        ...
        for (;;)
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.startServlet(paramString1);
          return true;
          if ("GetUrlReq".equals(paramString1))
          {
  ...
  {
    QLog.d(jdField_b_of_type_JavaLangString, 1, "reportPadFaceShown");
    try
    {
      Object localObject = new WebSSOAgent.UniSsoServerReqComm();
      ((WebSSOAgent.UniSsoServerReqComm)localObject).platform.set(109L);
    ...
    {
      QLog.e(jdField_b_of_type_JavaLangString, 1, "[reportPadFaceShown] exception=", localException);
    }
  }
  ...
  public void b(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    if ((paramArrayOfByte != null) && (paramFromServiceMsg != null) && (paramFromServiceMsg.isSuccess())) {
      try
      {
        ...
        paramFromServiceMsg.mergeFrom(paramArrayOfByte);
        if (QLog.isColorLevel()) {
          QLog.d(jdField_b_of_type_JavaLangString, 2, new Object[] { "[handleGamePubAccountFeeds] ret=", paramFromServiceMsg.ret.get() + ",data:" + paramFromServiceMsg.rspdata.get() });
        }
        if (paramFromServiceMsg.ret.get() == 0L)
        {
          paramFromServiceMsg = new JSONObject(paramFromServiceMsg.rspdata.get());
      ...
      {
        notifyUI(29, false, arrayOfObject);
        QLog.e(jdField_b_of_type_JavaLangString, 1, "[handleGamePubAccountFeeds] err:" + paramIntent.getMessage());
        return;
      }
    }
    notifyUI(29, false, arrayOfObject);
  ...
  public void b(ApolloExtensionHandlerImpl.OnQueryBaseInfoListener paramOnQueryBaseInfoListener)
  {
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
  ...
  public void b(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        QLog.d(jdField_b_of_type_JavaLangString, 2, "getUserSignStr uin: " + paramString1);
        return;
      }
      catch (Exception paramString1) {}
      if (!QLog.isColorLevel()) {
      ...
      QLog.e(jdField_b_of_type_JavaLangString, 2, "getUserSignStr failed ", paramString1);
      return;
      label250:
      paramString2 = "android." + paramString2;
    }
  ...
  public void c()
  {
    for (;;)
    {
      try
      {
        if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)
        {
          QLog.e(jdField_b_of_type_JavaLangString, 1, "[getApolloLoginData] app is null");
          return;
        }
        Object localObject = new WebSSOAgent.UniSsoServerReqComm();
        ((WebSSOAgent.UniSsoServerReqComm)localObject).platform.set(109L);
        ...
        long l = ApolloGameUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        ...
        if (bool)
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.d(jdField_b_of_type_JavaLangString, 1, new Object[] { "getApolloGameLoginReq isGameWhiteUser:", Boolean.valueOf(bool), " ts:", Long.valueOf(l) });
          }
          NewIntent localNewIntent = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), ApolloExtensionServletImpl.class);
      ...
      {
        QLog.e(jdField_b_of_type_JavaLangString, 1, "[getApolloGameLoginReq] exception=", localException);
        return;
      }
  ...
  public void c(int paramInt)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)
    {
      QLog.e(jdField_b_of_type_JavaLangString, 1, "[getExploreInfo] app is null");
      return;
    }
    if (((IApolloManagerService)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getRuntimeService(IApolloManagerService.class, "all")).getCmShowStatus(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin()) != 2) {}
    String str2;
    for (String str1 = "apollo_interact.get_msg";; str2 = "cmshowar_message_plat.get_msg")
    {
      long l = NetConnInfoCenter.getServerTime();
      if (paramInt == 1)
      {
        if (this.jdField_a_of_type_Int == 0) {
          this.jdField_a_of_type_Int = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getSharedPreferences("apollo_sp" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin(), 0).getInt("next_req_st_drawer", (int)l);
        }
        if (QLog.isColorLevel()) {
          QLog.d(jdField_b_of_type_JavaLangString, 2, "[getExploreInfo] exploreDrawerSt:" + this.jdField_a_of_type_Int + ",currentTime:" + l + "|" + paramInt);
        }
      ...
      do
      {
        try
        {
          QLog.i(jdField_b_of_type_JavaLangString, 1, "[getExploreInfo] cmd: " + str1);
          Object localObject = new WebSSOAgent.UniSsoServerReqComm();
          ((WebSSOAgent.UniSsoServerReqComm)localObject).platform.set(109L);
          ((WebSSOAgent.UniSsoServerReqComm)localObject).osver.set(Build.VERSION.RELEASE);
          ((WebSSOAgent.UniSsoServerReqComm)localObject).mqqver.set("8.5.5");
          ...
          localObject = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), ApolloExtensionServletImpl.class);
          ((NewIntent)localObject).putExtra("cmd", str1);
          ((NewIntent)localObject).putExtra("data", localUniSsoServerReq.toByteArray());
          this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.startServlet((NewIntent)localObject);
          return;
        }
        ...
        {
          QLog.e(jdField_b_of_type_JavaLangString, 1, new Object[] { "[getExploreInfo] exception: ", localException.getMessage() });
          return;
        }
        if (this.jdField_b_of_type_Int == 0) {
          this.jdField_b_of_type_Int = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getSharedPreferences("apollo_sp" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin(), 0).getInt("next_req_st_drawer_friend_card", (int)l);
        }
        if (QLog.isColorLevel()) {
          QLog.d(jdField_b_of_type_JavaLangString, 2, "[getExploreInfo] exploreFriendCardSt:" + this.jdField_b_of_type_Int + ",currentTime:" + l + "|" + paramInt);
        }
  ...
  public void c(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramIntent.mergeFrom(paramArrayOfByte);
        if (QLog.isColorLevel()) {
          QLog.d(jdField_b_of_type_JavaLangString, 2, new Object[] { "[handleGetGameFriend] ret=", paramIntent.ret.get() + ",data:" + paramIntent.rspdata.get() });
        }
        if (paramIntent.ret.get() == 0L)
        {
          paramIntent = new JSONObject(paramIntent.rspdata.get());
      ...
      {
        notifyUI(31, false, null);
        QLog.e(jdField_b_of_type_JavaLangString, 1, "[handleGetGameFriend] err:" + paramIntent.getMessage());
        return;
      }
      notifyUI(31, false, null);
      return;
  ...
  public void d()
  {
    try
    {
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)
      {
        QLog.e(jdField_b_of_type_JavaLangString, 1, "[getApolloGameDevList] app is null");
        return;
      }
      Object localObject = new WebSSOAgent.UniSsoServerReqComm();
      ((WebSSOAgent.UniSsoServerReqComm)localObject).platform.set(109L);
      ...
      localUniSsoServerReq.reqdata.set(((JSONObject)localObject).toString());
      if (QLog.isColorLevel()) {
        QLog.d(jdField_b_of_type_JavaLangString, 2, "[getApolloGameDevList] " + ((JSONObject)localObject).toString());
      }
      localObject = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), ApolloExtensionServletImpl.class);
    ...
    {
      QLog.e(jdField_b_of_type_JavaLangString, 1, "[getApolloGameDevList] exception=", localException);
    }
  }
    ...
    while (!QLog.isColorLevel()) {
      try
      {
        ...
        if ((QLog.isColorLevel()) && (paramIntent.rspdata.has())) {
          QLog.d(jdField_b_of_type_JavaLangString, 2, "handleGetUserApolloInfo ret: " + paramIntent.ret.get() + ", msg: " + paramIntent.rspdata.get() + ", touin:" + str + ", mask: " + i);
        }
      ...
      {
        while (!QLog.isColorLevel()) {}
        QLog.e(jdField_b_of_type_JavaLangString, 2, "handleGetUserApolloInfo failed", paramIntent);
        return;
      }
    }
    QLog.e(jdField_b_of_type_JavaLangString, 2, "handleGetUserApolloInfo fail ret: " + paramFromServiceMsg.getResultCode());
  }
  ...
  public void d(String paramString)
  {
    ...
    {
    default: 
      QLog.e(jdField_b_of_type_JavaLangString, 1, "showIfHadSpecialCareTip have error type " + i);
      return;
    case 1: 
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131693091);
    }
    for (;;)
    {
      paramString = new UniteGrayTipParam(paramString, paramString, (String)localObject1, 0, -5020, 2097156, MessageCache.a());
      localObject2 = new Bundle();
      String str = HardCodeUtil.a(2131715872);
      if (!TextUtils.isEmpty(str))
      {
        ...
        VasWebviewUtil.reportCommercialDrainage(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "Care", "CareTipShow", "", 1, 0, 0, null, Integer.toString(i), null);
      }
      ...
      return;
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131693094);
      continue;
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131693093);
      continue;
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131693090);
      continue;
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131693092);
      continue;
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131693089);
    }
  }
  ...
  public void e()
  {
    try
    {
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)
      {
        QLog.e(jdField_b_of_type_JavaLangString, 1, "[requestApolloWhiteList] app is null");
        return;
      }
      Object localObject = new WebSSOAgent.UniSsoServerReqComm();
      ((WebSSOAgent.UniSsoServerReqComm)localObject).platform.set(109L);
      ...
      localUniSsoServerReq.reqdata.set(((JSONObject)localObject).toString());
      if (QLog.isColorLevel()) {
        QLog.d(jdField_b_of_type_JavaLangString, 2, "[requestApolloWhiteList] " + ((JSONObject)localObject).toString());
      }
      localObject = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), ApolloExtensionServletImpl.class);
    ...
    {
      QLog.e(jdField_b_of_type_JavaLangString, 1, "[requestApolloWhiteList] exception=", localException);
    }
  }
  ...
  public void e(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    if ((paramArrayOfByte != null) && (paramFromServiceMsg.isSuccess())) {
      try
      {
        ...
        if ((QLog.isColorLevel()) && (paramFromServiceMsg.rspdata.has())) {
          QLog.d(jdField_b_of_type_JavaLangString, 2, "handleCheckActionAuth ret: " + paramFromServiceMsg.ret.get() + ", msg: " + paramFromServiceMsg.rspdata.get());
        }
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.e(jdField_b_of_type_JavaLangString, 2, "handleChangeApolloStatus failed ", paramFromServiceMsg);
        }
    ...
    notifyUI(5, false, paramIntent);
    if (QLog.isColorLevel()) {
      QLog.e(jdField_b_of_type_JavaLangString, 2, "handleChangeApolloStatus fail ret: " + paramFromServiceMsg.getResultCode());
    }
  }
  ...
  public void e(String paramString)
  {
    ...
    {
    default: 
      QLog.e(jdField_b_of_type_JavaLangString, 1, "showIfHadNewBoatTips have error type " + i);
      return;
    }
    if (TextUtils.isEmpty(str1))
    {
      QLog.e(jdField_b_of_type_JavaLangString, 1, "showIfHadNewBoatTips grayStr null ");
      return;
    }
    ...
    for (Object localObject1 = str1.replace("gray_small_ship", " ");; localObject1 = str1)
    {
      ...
      for (;;)
      {
        ...
        if (!TextUtils.isEmpty(str1))
        {
          str1 = MutualMarkConfigHelper.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 12L, 1L);
          str2 = MutualMarkConfigHelper.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 12L, 2L);
  ...
  public void f()
  {
    QLog.d(jdField_b_of_type_JavaLangString, 1, "getCmGameConnInfo");
    try
    {
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)
      {
        QLog.e(jdField_b_of_type_JavaLangString, 1, "[getCmGameConnInfo] app null");
        return;
      }
      Object localObject = new WebSSOAgent.UniSsoServerReqComm();
      ((WebSSOAgent.UniSsoServerReqComm)localObject).platform.set(109L);
      ...
      localAddrDistribueReq.net_type.set(CmGameUtil.d());
      WebSSOAgent.UniSsoServerReq localUniSsoServerReq = new WebSSOAgent.UniSsoServerReq();
      localUniSsoServerReq.comm.set((MessageMicro)localObject);
    ...
    {
      QLog.e(jdField_b_of_type_JavaLangString, 1, "[getCmGameConnInfo] exception=", localException);
    }
  }
  ...
  public void f(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    if ((paramArrayOfByte != null) && (paramFromServiceMsg.isSuccess())) {
      try
      {
        ...
        paramIntent.mergeFrom(paramArrayOfByte);
        if (QLog.isColorLevel()) {
          QLog.d(jdField_b_of_type_JavaLangString, 2, "handleSetZanCount ret: " + paramIntent.ret.get());
        }
        if (0L == paramIntent.ret.get())
        {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.e(jdField_b_of_type_JavaLangString, 2, "handleChangeApolloStatus failed ", paramIntent);
        }
  ...
  public void f(String paramString)
  {
    ...
    if (paramString == null)
    {
      ...
      if (QLog.isColorLevel())
      {
        QLog.d(jdField_b_of_type_JavaLangString, 2, "content == null");
        localObject = paramString;
      }
    }
    ...
    localFilter_Req_Comm.mqqver.set("8.5.5");
  ...
  public void g(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    if ((paramArrayOfByte != null) && (paramFromServiceMsg.isSuccess()))
    {
      ...
      try
      {
        paramIntent.mergeFrom(paramArrayOfByte);
        if (QLog.isColorLevel()) {
          QLog.d(jdField_b_of_type_JavaLangString, 2, "handleQuickUpdate ret: " + paramIntent.ret.get());
        }
        l = 0L;
      ...
      {
        long l;
        QLog.e(jdField_b_of_type_JavaLangString, 1, "handleQuickUpdate error: ", paramFromServiceMsg);
        ...
        if (paramIntent.cmd.get() == 1)
        {
          ...
          return;
          QLog.e(jdField_b_of_type_JavaLangString, 1, "handleQuickUpdate result = " + paramIntent.ret.get() + "msg = " + paramIntent.msg.get());
          paramFromServiceMsg = new VasQuickUpdateManager.QuickUpdateRsp();
    ...
    if ((paramArrayOfByte != null) && (paramFromServiceMsg.isSuccess())) {
      try
      {
        ...
        if (0L == paramIntent.ret.get())
        {
          ...
          paramArrayOfByte = (IApolloManagerService)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getRuntimeService(IApolloManagerService.class, "all");
          if (paramArrayOfByte != null)
          {
            ApolloBaseInfo localApolloBaseInfo = paramArrayOfByte.getApolloBaseInfo(paramFromServiceMsg);
            if (localApolloBaseInfo != null)
            {
              ...
              paramArrayOfByte.saveOrUpdateApolloBaseInfo(localApolloBaseInfo);
            }
          }
          if (!QLog.isColorLevel()) {
            return;
          }
          QLog.d(jdField_b_of_type_JavaLangString, 2, "handleGetSignStr uin: " + paramFromServiceMsg + ", sign: " + paramIntent);
          return;
        }
        if (!QLog.isColorLevel()) {
          return;
        }
        QLog.d(jdField_b_of_type_JavaLangString, 2, "handleGetSignStr err  ret: " + paramIntent.ret.get());
        return;
      }
      catch (Exception paramIntent)
      {
        QLog.e(jdField_b_of_type_JavaLangString, 1, "handleGetSignStr error", paramIntent);
        return;
      }
    } else if (QLog.isColorLevel()) {
      QLog.e(jdField_b_of_type_JavaLangString, 2, "handleGetSignStr fail ret: " + paramFromServiceMsg.getResultCode());
    }
  }
  ...
  public void k(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    do
    {
      return;
      int j = 0;
      paramIntent = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getHandler(LebaQzoneAndPluginPart.class);
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(jdField_b_of_type_JavaLangString, 2, "[handleGameStatusResp],data:" + paramArrayOfByte);
    }
    ...
    try
    {
      if (paramFromServiceMsg.isSuccess())
      {
        ...
        ((ApolloGameManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.APOLLO_GAME_MANAGER)).a((int)paramFromServiceMsg.ret.get(), paramArrayOfByte.rpt_msg_list.get(), paramIntent);
        return;
      }
      QLog.e(jdField_b_of_type_JavaLangString, 1, "handleGameStatusResp resp data is err.");
      return;
    }
    catch (Exception paramIntent)
    {
      if (QLog.isColorLevel()) {
        QLog.d(jdField_b_of_type_JavaLangString, 2, "errInfo->" + paramIntent.getMessage());
      }
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(jdField_b_of_type_JavaLangString, 2, "[handleCMGameResp],data:" + paramArrayOfByte);
    }
    if ((paramArrayOfByte != null) && (paramFromServiceMsg != null)) {}
    try
    {
      if (paramFromServiceMsg.isSuccess())
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d(jdField_b_of_type_JavaLangString, 2, "[handleGetRedDotInfo] " + paramIntent);
        }
      }
      return;
    }
    ...
    {
      QLog.e(jdField_b_of_type_JavaLangString, 1, "[handleGetRedDotInfo] ");
    }
  }
  ...
  public void n(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    if ((paramArrayOfByte != null) && (paramFromServiceMsg != null)) {
      for (;;)
      {
        ...
        try
        {
          ...
          localObject = (ApolloGameManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.APOLLO_GAME_MANAGER);
          if (("apollo_aio_game.add_games_to_user_gamepanel".equals(paramArrayOfByte)) || ("apollo_aio_game.del_games_from_user_gamepanel".equals(paramArrayOfByte)))
          {
            ...
            QLog.d(jdField_b_of_type_JavaLangString, 2, "ret:" + localUniSsoServerRsp.ret.get() + ",data:" + paramFromServiceMsg + ",cmd:" + paramArrayOfByte);
            return;
          }
          if (i != 4) {
            break label310;
          }
          ApolloUtilImpl.getCmdChannel().callbackFromRequest(l, (int)localUniSsoServerRsp.ret.get(), paramArrayOfByte, paramFromServiceMsg);
          continue;
          QLog.d(jdField_b_of_type_JavaLangString, 2, "errInfo->" + paramIntent.getMessage());
        }
        catch (Exception paramIntent)
        ...
        {
          localObject = ((IApolloManagerService)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getRuntimeService(IApolloManagerService.class, "all")).getApolloPanelManager();
          if (localObject != null) {
    ...
    if (QLog.isColorLevel()) {
      QLog.d(jdField_b_of_type_JavaLangString, 2, "resp data is err.");
    }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(jdField_b_of_type_JavaLangString, 2, "[handleApolloGameKey],data:" + paramArrayOfByte);
    }
    try
    {
      Object localObject;
      ...
      if ((paramArrayOfByte != null) && (paramFromServiceMsg != null) && (paramFromServiceMsg.isSuccess()))
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d(jdField_b_of_type_JavaLangString, 2, "ret:" + paramFromServiceMsg.ret.get());
        }
      }
      else
      {
  ...
  void p(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    if ((paramArrayOfByte == null) || (!paramFromServiceMsg.isSuccess()) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)) {
      return;
    }
    for (;;)
    {
      ...
      try
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.i(jdField_b_of_type_JavaLangString, 2, "handleApolloStandAction response:" + paramArrayOfByte);
        }
        paramIntent = ((IApolloManagerService)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getRuntimeService(IApolloManagerService.class, "all")).getStandUpSp();
        ...
        if (!ApolloUtilImpl.isActionResDone(k, 0))
        {
          ...
          QLog.i(jdField_b_of_type_JavaLangString, 2, "handleApolloStandAction download res first time.");
          break label796;
        }
        if (bool)
        {
          ...
          String str = ApolloUtilImpl.getApolloResPath((ApolloActionData)localObject4, 5);
          localObject4 = ApolloUtilImpl.getApolloResPath((ApolloActionData)localObject4, 4);
          ...
          ((IApolloResDownloader)QRoute.api(IApolloResDownloader.class)).downLoadSpecialAction(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject4, str);
        }
      ...
      QLog.e(jdField_b_of_type_JavaLangString, 2, "handleApolloStandAction ", paramIntent);
      return;
      label567:
      localArrayList1.add(((JSONArray)localObject2).getJSONObject(j));
      localJSONArray.put(((JSONArray)localObject2).getJSONObject(j));
      ...
      label598:
      if (QLog.isColorLevel()) {
        QLog.d(jdField_b_of_type_JavaLangString, 2, new Object[] { "uin:", localObject1, ",sort result:" + localArrayList1 });
      }
      ...
      Object localObject1 = localIApolloManagerService.getApolloBaseInfo((String)localObject1);
      if (localObject1 != null)
      {
        ...
        localIApolloManagerService.bulkSaveOrUpdateApolloBaseInfos(localArrayList2);
        return;
        label796:
        bool = true;
        continue;
  ...
  public void q(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramIntent.mergeFrom(paramArrayOfByte);
        if (QLog.isColorLevel()) {
          QLog.i(jdField_b_of_type_JavaLangString, 2, "updateRankInfo handleGameRank response code:" + paramIntent.ret.get());
        }
        if ((paramIntent.ret.get() == 0L) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null))
        {
          paramIntent = paramIntent.rspdata.get();
          if (QLog.isColorLevel()) {
            QLog.i(jdField_b_of_type_JavaLangString, 2, " updateRankInfo handleGameRank response:" + paramIntent);
          }
          paramIntent = new JSONObject(paramIntent).optJSONObject("data");
          ...
          paramArrayOfByte = (IApolloDaoManagerService)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getRuntimeService(IApolloDaoManagerService.class, "all");
      ...
      {
        QLog.e(jdField_b_of_type_JavaLangString, 1, "[handleGameRank]", paramIntent);
        return;
      }
    }
    QLog.e(jdField_b_of_type_JavaLangString, 1, "[handleGameRank] context is null");
  }
  ...
  public void r(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramIntent.mergeFrom(paramArrayOfByte);
        if ((QLog.isColorLevel()) && (paramIntent.rspdata.has())) {
          QLog.d(jdField_b_of_type_JavaLangString, 2, new Object[] { "handleBuyActionByGold ret: ", Long.valueOf(paramIntent.ret.get()), ", msg: ", paramIntent.rspdata.get() });
        }
        if (paramIntent.ret.get() != 0L) {
          break label406;
        }
        paramIntent = new JSONObject(paramIntent.rspdata.get()).getJSONObject("data");
        if ((paramIntent == null) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)) {
          break label406;
        }
        int k = paramIntent.optInt("isSuccBuy");
        int m = paramIntent.optInt("balance");
        paramIntent = ((IApolloManagerService)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getRuntimeService(IApolloManagerService.class, "all")).getApolloPanelManager();
        if (paramIntent != null) {
        ...
        paramIntent = (IApolloDaoManagerService)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getRuntimeService(IApolloDaoManagerService.class, "all");
        ...
        paramIntent.insertObtainedActionData(paramFromServiceMsg);
        paramIntent = new Bundle();
        ...
        paramIntent.put("tips", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131690117));
        paramFromServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getHandler(ChatActivity.class);
        if (paramFromServiceMsg == null) {
          break label412;
        }
      ...
      {
        QLog.e(jdField_b_of_type_JavaLangString, 1, "handleBuyActionByGold failed", paramIntent);
        return;
      }
      if (i == 0) {
        ApolloItemBuilder.a(HardCodeUtil.a(2131715873), 1, BaseApplicationImpl.getContext());
      }
      return;
      label406:
      i = 0;
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(jdField_b_of_type_JavaLangString, 2, "[handleSaveGameListResult]");
    }
    if ((paramArrayOfByte == null) || (!paramFromServiceMsg.isSuccess()))
    {
      QLog.e(jdField_b_of_type_JavaLangString, 1, "[handleSaveGameListResult] data null or rsp failed");
      notifyUI(25, false, null);
    }
    for (;;)
    {
      ...
      try
      {
        ...
        paramIntent.mergeFrom(paramArrayOfByte);
        if (QLog.isColorLevel()) {
          QLog.d(jdField_b_of_type_JavaLangString, 2, new Object[] { "[handleSaveGameListResult] ret=", Long.valueOf(paramIntent.ret.get()) });
        }
        if (paramIntent.ret.get() == 0L)
        {
          paramIntent = paramIntent.rspdata.get();
          if (QLog.isColorLevel()) {
            QLog.d(jdField_b_of_type_JavaLangString, 2, new Object[] { "[handleSaveGameListResult] respData=", paramIntent });
          }
          paramIntent = new JSONObject(paramIntent).optJSONObject("data");
          if (paramIntent == null) {
            continue;
          ...
          QLog.e(jdField_b_of_type_JavaLangString, 1, "[handleSaveGameListResult] last timeStamp : " + l);
        }
      }
      catch (Exception paramIntent)
      {
    ...
    QLog.e(jdField_b_of_type_JavaLangString, 1, "[handleSaveGameListResult] ret : " + paramIntent.ret.get());
  }
  
  public void t(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    if (QLog.isColorLevel()) {
      QLog.d(jdField_b_of_type_JavaLangString, 2, "[handlePlusUsedAppListRsp]");
    }
    if ((paramIntent != null) && (paramArrayOfByte != null) && (paramFromServiceMsg != null) && (paramFromServiceMsg.isSuccess())) {}
    try
    {
      ...
      paramIntent.mergeFrom(paramArrayOfByte);
      if (QLog.isColorLevel()) {
        QLog.d(jdField_b_of_type_JavaLangString, 2, new Object[] { "[handlePlusUsedAppListRsp] ret=", Long.valueOf(paramIntent.ret.get()) });
      }
      if (paramIntent.ret.get() == 0L)
      {
        paramIntent = paramIntent.rspdata.get();
        if (QLog.isColorLevel()) {
          QLog.d(jdField_b_of_type_JavaLangString, 2, new Object[] { "[handlePlusUsedAppListRsp] respData=", paramIntent });
        }
        if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
        {
          paramFromServiceMsg = (UsedAppListManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.USED_APP_LIST_MANAGER);
          if (paramFromServiceMsg != null) {
    ...
    {
      QLog.e(jdField_b_of_type_JavaLangString, 1, "[handlePlusUsedAppListRsp] exception=", paramIntent);
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(jdField_b_of_type_JavaLangString, 2, "[handleApolloLoginReq]");
    }
    if ((paramIntent != null) && (paramArrayOfByte != null) && (paramFromServiceMsg != null) && (paramFromServiceMsg.isSuccess())) {}
    try
    {
      ...
      paramIntent.mergeFrom(paramArrayOfByte);
      if (QLog.isColorLevel()) {
        QLog.d(jdField_b_of_type_JavaLangString, 2, new Object[] { "[handleApolloWhiteList] ret=", Long.valueOf(paramIntent.ret.get()) });
      }
      if (paramIntent.ret.get() == 0L)
      {
        paramIntent = paramIntent.rspdata.get();
        ...
        if (paramFromServiceMsg != null)
        {
          ...
          if (i >= 0)
          {
            ...
            if (j >= 0) {
              ThreadManagerV2.executeOnSubThread(new ApolloExtensionHandlerImpl.1(this, paramIntent.substring(i + 8, j), paramFromServiceMsg.optJSONArray("val_list")));
            }
          }
        }
      }
    ...
    {
      QLog.e(jdField_b_of_type_JavaLangString, 1, paramIntent, new Object[] { " handle err" });
    }
  }
  ...
  public void v(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      paramIntent.mergeFrom(paramArrayOfByte);
      if (QLog.isColorLevel()) {
        QLog.d(jdField_b_of_type_JavaLangString, 2, new Object[] { "[handleKapuReportDownload] ret=", Long.valueOf(paramIntent.ret.get()) });
      }
      return;
    }
    catch (Exception paramIntent)
    {
      QLog.e(jdField_b_of_type_JavaLangString, 1, "[handleKapuReportDownload] err:" + paramIntent.getMessage());
    }
  }
}
 ...
 * Qualified Name:     com.tencent.mobileqq.apollo.api.handler.impl.ApolloExtensionHandlerImpl
