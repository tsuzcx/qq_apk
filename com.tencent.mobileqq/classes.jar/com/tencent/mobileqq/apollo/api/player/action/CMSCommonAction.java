  ...
  extends CMSAction
{
  ...
  public CMSCommonAction(int paramInt1, int paramInt2, @NotNull String paramString1, @Nullable String paramString2, @Nullable String paramString3, boolean paramBoolean, int paramInt3, int paramInt4)
  {
  ...
  {
    return "CMSCommonAction(actionId=" + this.jdField_a_of_type_Int + ", actionType=" + this.jdField_b_of_type_Int + ", senderUin='" + this.jdField_c_of_type_JavaLangString + "', " + "receiverUin=" + this.jdField_d_of_type_JavaLangString + ", extendJson=" + this.e + ", needRecord=" + a() + ", " + "priority=" + b() + ", playAmountTimes=" + c() + ", id='" + a() + "', name='" + b() + "')";
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes7.jar
 * Qualified Name:     com.tencent.mobileqq.apollo.api.player.action.CMSCommonAction
