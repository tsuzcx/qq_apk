...
public class App3DConfig
{
  ...
  private static void a()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      QLog.d("App3DConfig", 1, new Object[] { "App3DConfig init, sShow=", Boolean.valueOf(jdField_a_of_type_Boolean) });
      return;
    }
  }
  
  public static void a(Map<String, String> paramMap, int paramInt, String paramString)
  {
    SharedPreferences localSharedPreferences = BaseApplicationImpl.getApplication().getSharedPreferences("apollo_app3d_config", 0);
    try
    {
      ...
      if (Integer.parseInt((String)paramMap.get("show")) == 1)
      {
        ...
        if ((TextUtils.isEmpty(jdField_a_of_type_JavaLangString)) || (TextUtils.isEmpty(jdField_b_of_type_JavaLangString)) || (TextUtils.isEmpty(c)) || (TextUtils.isEmpty(g)))
        {
          ...
          QLog.w("App3DConfig", 1, "App3DConfig parse invalid param");
        }
      ...
      for (paramInt = 1;; paramInt = 0)
      {
        ...
        QLog.d("App3DConfig", 1, new Object[] { "App3DConfig parse, sShow=", Boolean.valueOf(jdField_a_of_type_Boolean) });
        return;
        bool = false;
        break;
      }
    ...
    {
      QLog.e("App3DConfig", 1, "App3DConfig parse error:", paramMap);
    }
  }
}
 ...
 * Qualified Name:     com.tencent.mobileqq.apollo.api.impl.model.App3DConfig
