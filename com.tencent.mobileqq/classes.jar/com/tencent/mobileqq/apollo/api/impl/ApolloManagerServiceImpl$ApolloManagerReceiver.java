  ...
  extends BroadcastReceiver
{
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    do
    {
      ...
      paramIntent = ApolloManagerServiceImpl.access$300(this.a);
    } while (paramIntent == null);
    ((ApolloExtensionHandlerImpl)paramIntent.getBusinessHandler(BusinessHandlerFactory.APOLLO_EXTENSION_HANDLER)).a(null, paramContext, -1003, 0);
  }
}
