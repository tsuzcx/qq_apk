  ...
  implements Runnable
{
  ...
  WeakReference<ApolloItemBuilder.Holder> jdField_a_of_type_JavaLangRefWeakReference;
  ...
  public void run()
  {
    ...
    if (this.jdField_a_of_type_Int == 0) {
      if ((!(localHolder.c.getContext() instanceof MultiForwardActivity)) && (!this.jdField_a_of_type_Boolean) && (!localApolloItemBuilder.a.n))
      {
 ...
 * Qualified Name:     com.tencent.mobileqq.apollo.api.aio.item.impl.ApolloItemBuilder.PlusOneManagerTask
