...
public class CmGameSocketConnection
{
  ...
  private CmGameSocketConnection.ConnectionHandler jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection$ConnectionHandler;
  ...
  private boolean c()
  {
    ...
    for (;;)
    {
      ...
      catch (Throwable localThrowable)
      {
        for (;;)
        {
          bool1 = NetworkUtil.e(BaseApplicationImpl.getApplication().getApplicationContext());
  ...
  private boolean d()
  {
    ...
    //   8: invokevirtual 92	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   11: ifne +14 -> 25
    //   14: ldc 70
    //   16: iconst_1
    //   17: ldc_w 298
    //   20: invokestatic 77	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   23: iconst_0
    //   24: ireturn
    //   25: iload_2
    //   26: istore_1
    //   27: aload_0
    //   28: getfield 45	com/tencent/mobileqq/apollo/lightGame/CmGameSocketConnection:jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue	Ljava/util/concurrent/ConcurrentLinkedQueue;
    //   31: invokevirtual 63	java/util/concurrent/ConcurrentLinkedQueue:isEmpty	()Z
    //   34: ifne +111 -> 145
    //   37: iload_2
    //   38: istore_1
    //   39: aload_0
    //   40: getfield 45	com/tencent/mobileqq/apollo/lightGame/CmGameSocketConnection:jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue	Ljava/util/concurrent/ConcurrentLinkedQueue;
    //   43: invokevirtual 302	java/util/concurrent/ConcurrentLinkedQueue:poll	()Ljava/lang/Object;
    //   46: checkcast 304	[B
    //   49: astore 4
    //   51: aload 4
    //   53: ifnull +92 -> 145
    ...
    //   84: aload 4
    //   86: invokevirtual 310	java/io/OutputStream:write	([B)V
    //   89: iload_3
    //   90: istore_2
    //   91: aload_0
    ...
    //   95: invokevirtual 313	java/io/OutputStream:flush	()V
    //   98: aload 5
    //   100: monitorexit
    //   101: iconst_1
    //   102: istore_1
    ...
    //   122: ldc_w 315
    //   125: aload 4
    //   127: invokestatic 318	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   130: aload_0
    //   131: iconst_1
    //   132: invokevirtual 320	com/tencent/mobileqq/apollo/lightGame/CmGameSocketConnection:a	(Z)V
    //   135: goto -32 -> 103
    //   138: astore 4
    //   140: iconst_1
    //   141: istore_1
  ...
  private boolean e()
  {
    ...
    //   2: iconst_1
    //   3: ldc_w 324
    //   6: invokestatic 77	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   9: aload_0
    ...
    //   13: invokevirtual 92	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   16: ifne +14 -> 30
    //   19: ldc 70
    //   21: iconst_1
    //   22: ldc_w 326
    //   25: invokestatic 77	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   28: iconst_0
    //   29: ireturn
    //   30: aload_0
    //   31: getfield 55	com/tencent/mobileqq/apollo/lightGame/CmGameSocketConnection:jdField_a_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    //   34: ifnull +84 -> 118
    //   37: aload_0
    //   38: getfield 55	com/tencent/mobileqq/apollo/lightGame/CmGameSocketConnection:jdField_a_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    //   41: invokevirtual 330	java/lang/ref/WeakReference:get	()Ljava/lang/Object;
    //   44: checkcast 332	com/tencent/mobileqq/apollo/lightGame/CmGameSocketConnection$CmGameSocketConnectionListener
    //   47: astore_2
    //   48: aload_2
    //   49: ifnull +69 -> 118
    //   52: aload_2
    //   53: invokeinterface 335 1 0
    //   58: astore_3
    //   59: aload_3
    //   60: ifnull +58 -> 118
    //   63: aload_0
    ...
    //   81: aload_3
    //   82: invokevirtual 310	java/io/OutputStream:write	([B)V
    //   85: aload_0
    ...
    //   89: invokevirtual 313	java/io/OutputStream:flush	()V
    //   92: aload_2
    //   93: monitorexit
    //   94: goto +24 -> 118
    //   97: astore_3
    ...
    //   106: ldc_w 337
    //   109: aload_2
    //   110: invokestatic 318	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   113: iconst_0
    //   114: istore_1
    //   115: goto +5 -> 120
    //   118: iconst_1
  ...
  private void f()
  {
    ...
    try
    {
      if (this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection$ConnectionHandler != null) {
        this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection$ConnectionHandler.removeCallbacksAndMessages(null);
      }
  ...
  public void a()
  {
    ...
    //   4: iconst_1
    //   5: ldc_w 364
    //   8: invokestatic 77	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   11: aload_0
    ...
    //   15: invokevirtual 92	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   18: ifeq +15 -> 33
    //   21: ldc 70
    //   23: iconst_1
    //   24: ldc_w 366
    //   27: invokestatic 345	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   30: aload_0
    //   31: monitorexit
    //   32: return
    //   33: aload_0
    //   34: getfield 368	com/tencent/mobileqq/apollo/lightGame/CmGameSocketConnection:jdField_a_of_type_AndroidOsHandlerThread	Landroid/os/HandlerThread;
    //   37: ifnonnull +21 -> 58
    //   40: aload_0
    //   41: ldc_w 370
    //   44: iconst_0
    ...
    //   48: putfield 368	com/tencent/mobileqq/apollo/lightGame/CmGameSocketConnection:jdField_a_of_type_AndroidOsHandlerThread	Landroid/os/HandlerThread;
    //   51: aload_0
    ...
    //   58: aload_0
    //   59: getfield 347	com/tencent/mobileqq/apollo/lightGame/CmGameSocketConnection:jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection$ConnectionHandler	Lcom/tencent/mobileqq/apollo/lightGame/CmGameSocketConnection$ConnectionHandler;
    //   62: ifnonnull +22 -> 84
    //   65: aload_0
    //   66: new 349	com/tencent/mobileqq/apollo/lightGame/CmGameSocketConnection$ConnectionHandler
    //   69: dup
    //   70: aload_0
    ...
    //   77: aload_0
    //   78: invokespecial 373	com/tencent/mobileqq/apollo/lightGame/CmGameSocketConnection$ConnectionHandler:<init>	(Landroid/os/Looper;Lcom/tencent/mobileqq/apollo/lightGame/CmGameSocketConnection;)V
    //   81: putfield 347	com/tencent/mobileqq/apollo/lightGame/CmGameSocketConnection:jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection$ConnectionHandler	Lcom/tencent/mobileqq/apollo/lightGame/CmGameSocketConnection$ConnectionHandler;
    //   84: aload_0
    //   85: getfield 347	com/tencent/mobileqq/apollo/lightGame/CmGameSocketConnection:jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection$ConnectionHandler	Lcom/tencent/mobileqq/apollo/lightGame/CmGameSocketConnection$ConnectionHandler;
    //   88: iconst_1
    //   89: invokevirtual 377	com/tencent/mobileqq/apollo/lightGame/CmGameSocketConnection$ConnectionHandler:sendEmptyMessage	(I)Z
    //   92: pop
    //   93: goto -63 -> 30
    //   96: astore_1
    //   97: aload_0
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection$ConnectionHandler.removeMessages(2);
    this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection$ConnectionHandler.sendEmptyMessage(2);
  }
  ...
  public void c()
  {
    ...
    if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
    {
      CmGameSocketConnection.CmGameSocketConnectionListener localCmGameSocketConnectionListener = (CmGameSocketConnection.CmGameSocketConnectionListener)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localCmGameSocketConnectionListener != null) {
        localCmGameSocketConnectionListener.c();
      }
    }
  }
  ...
  public void d()
  {
    ...
    if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
    {
      CmGameSocketConnection.CmGameSocketConnectionListener localCmGameSocketConnectionListener = (CmGameSocketConnection.CmGameSocketConnectionListener)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localCmGameSocketConnectionListener != null) {
        localCmGameSocketConnectionListener.d();
      }
    }
  }
