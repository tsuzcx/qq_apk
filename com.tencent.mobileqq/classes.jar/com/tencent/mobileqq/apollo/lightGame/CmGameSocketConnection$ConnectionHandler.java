    ...
    for (CmGameSocketConnection localCmGameSocketConnection = (CmGameSocketConnection)this.a.get();; localCmGameSocketConnection = null)
    {
      ...
      do
      {
        ...
        if (bool)
        {
          ...
          for (l = ApolloConfigUtils.a;; l = 120000L)
          {
      ...
      super.removeMessages(2);
      if (ApolloConfigUtils.a > 0L) {}
      for (long l = ApolloConfigUtils.a;; l = 120000L)
      {
        super.sendEmptyMessageDelayed(2, l);
 ...
 * Qualified Name:     com.tencent.mobileqq.apollo.lightGame.CmGameSocketConnection.ConnectionHandler
