  ...
  implements Handler.Callback, CmGameSocketConnection.CmGameSocketConnectionListener, INetInfoHandler
{
  ...
  private CmGameConnManager.GameConnInfo jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameConnManager$GameConnInfo;
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameConnManager$GameConnInfo == null)
    {
    ...
    ((CmGameMsgTunnel.TunnelMsgStream)localObject).mqqver.set("8.5.5");
    ...
    ((CmGameMsgTunnel.TunnelMsgStream)localObject).distribute_ts.set(this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameConnManager$GameConnInfo.jdField_a_of_type_Long);
    ...
    ((CmGameMsgTunnel.TunnelMsgStream)localObject).sign.set(this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameConnManager$GameConnInfo.b);
    ...
    try
    {
      paramString = CmGameUtil.a(paramString, this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameConnManager$GameConnInfo.jdField_a_of_type_JavaLangString);
  ...
  {
    ((ApolloManagerServiceImpl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getRuntimeService(IApolloManagerService.class, "all")).getGameTempMsgHandler().a(paramTunnelMsgStream);
  }
  ...
  private boolean b()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameConnManager$GameConnInfo.jdField_a_of_type_JavaUtilList == null) || (this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameConnManager$GameConnInfo.jdField_a_of_type_JavaUtilList.size() == 0))
    {
      QLog.e("CmGameConnManager", 1, "[createConnection] no connection host");
      return false;
    }
    CmGameSocketConnection.ConnectionParam localConnectionParam = new CmGameSocketConnection.ConnectionParam();
    localConnectionParam.jdField_a_of_type_JavaUtilList = this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameConnManager$GameConnInfo.jdField_a_of_type_JavaUtilList;
    localConnectionParam.jdField_a_of_type_Int = this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameConnManager$GameConnInfo.jdField_a_of_type_Int;
    localConnectionParam.b = 10000;
    localConnectionParam.c = 3000;
    if (this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection == null) {
      this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection = new CmGameSocketConnection(localConnectionParam);
    }
    for (;;)
    {
      ...
      return true;
      this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection.a(localConnectionParam);
    }
  }
  ...
  private void f()
  {
    for (;;)
    {
      try
      {
        ...
        this.b = true;
        if (!NetworkUtil.e(BaseApplicationImpl.getApplication().getApplicationContext()))
        {
        ...
        {
          ((ApolloExtensionHandlerImpl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.APOLLO_EXTENSION_HANDLER)).f();
        }
      }
      finally {}
    }
  ...
  public void a(CmGameConnManager.GameConnInfo paramGameConnInfo)
  {
    ...
    for (;;)
    {
      return;
      if (this.jdField_a_of_type_Boolean) {
        this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameConnManager$GameConnInfo = paramGameConnInfo;
      }
  ...
  public void a(MsfSocketInputBuffer paramMsfSocketInputBuffer)
  {
    ...
    try
    {
      paramMsfSocketInputBuffer = CmGameUtil.b((byte[])localObject, this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameConnManager$GameConnInfo.jdField_a_of_type_JavaLangString);
  ...
  {
    boolean bool = NetworkUtil.e(BaseApplicationImpl.getApplication().getApplicationContext());
  ...
  public void b()
  {
    QLog.d("CmGameConnManager", 1, new Object[] { "[onGetConnInfoFailed] mShouldKeepConnect=", Boolean.valueOf(this.jdField_a_of_type_Boolean), ", mConnInfo=", this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameConnManager$GameConnInfo });
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameConnManager$GameConnInfo != null)) {}
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 5: 
      ...
      if ((paramMessage.obj != null) && (((Boolean)paramMessage.obj).booleanValue()))
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameConnManager$GameConnInfo = null;
      }
      i();
      return false;
    case 7: 
 ...
 * Qualified Name:     com.tencent.mobileqq.apollo.lightGame.CmGameConnManager
