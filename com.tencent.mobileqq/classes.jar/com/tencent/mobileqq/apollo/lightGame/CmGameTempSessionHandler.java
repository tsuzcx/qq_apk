...
{
  private static SparseArray<QuickInputTipsBar.TipsDataItem> b;
  private SparseArray<Long> jdField_a_of_type_AndroidUtilSparseArray;
  public QQLruCache<String, String> a;
  private CmGameTempSessionHandler.MyComparator jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameTempSessionHandler$MyComparator;
  private CmGameTempSessionHandler.TopGameInfo jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameTempSessionHandler$TopGameInfo;
  ...
  public static QuickInputTipsBar.TipsDataItem a(int paramInt)
  {
    return (QuickInputTipsBar.TipsDataItem)jdField_b_of_type_AndroidUtilSparseArray.get(paramInt);
  }
    ...
    for (;;)
    {
      ...
      if (paramBoolean)
      {
        ...
        try
        {
          ...
          if ("apollo_router_game.apl_audio_linkcmd_query_status".equals(localObject1))
          {
            if (l1 == 0L)
            {
              ...
              localObject1 = (CmGameTempSessionHandler.ICmGameMsgUIHandler)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(paramInt);
              ...
              paramBoolean = false;
              ((CmGameTempSessionHandler.ICmGameMsgUIHandler)localObject1).a(str, paramBoolean);
              break label2977;
            }
            i = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size();
            paramInt = 0;
        ...
        if ("ltgame_gamepanel.query_top_gamelist".equals(localObject1))
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameTempSessionHandler$TopGameInfo = new CmGameTempSessionHandler.TopGameInfo(this);
          this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameTempSessionHandler$TopGameInfo.jdField_a_of_type_JavaLangString = str;
          ...
          this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameTempSessionHandler$TopGameInfo.jdField_b_of_type_JavaLangString = ((JSONObject)localObject2).optString("description", HardCodeUtil.a(2131702174));
          if ((localJSONArray != null) && (localJSONArray.length() > 0))
          {
            localApolloDaoManagerServiceImpl = (ApolloDaoManagerServiceImpl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getRuntimeService(IApolloDaoManagerService.class, "all");
            ...
            if (paramInt < j)
            {
              ...
              this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameTempSessionHandler$TopGameInfo.jdField_a_of_type_JavaUtilList.add(Integer.valueOf(k));
              this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameTempSessionHandler$TopGameInfo.c.add(localObject1);
              if (localJSONObject.optInt("isGameApp") != 1) {
                break label3038;
              }
              i = 1;
              label1085:
              localObject2 = localApolloDaoManagerServiceImpl.findGameById(k);
              ...
              if (localObject1 != null)
              {
                this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameTempSessionHandler$TopGameInfo.jdField_b_of_type_JavaUtilList.add(localObject1);
                break label3031;
              }
            ...
            if (((List)localObject3).size() > 0) {
              ((ApolloDaoManagerServiceImpl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getRuntimeService(IApolloDaoManagerService.class, "all")).updateGameInfoList((List)localObject3);
            }
            if (localArrayList.size() > 0)
            {
              localObject1 = (ApolloExtensionHandlerImpl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.APOLLO_EXTENSION_HANDLER);
              localObject2 = new Bundle();
              ((Bundle)localObject2).putInt("key_get_game_detail_from", 1);
              ((Bundle)localObject2).putString("key_get_game_detail_friuin", str);
              ((ApolloExtensionHandlerImpl)localObject1).a(localArrayList, paramBundle);
              return;
            }
            i = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size();
            paramInt = 0;
            ...
            paramBundle.a(str, this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameTempSessionHandler$TopGameInfo);
            break label3044;
          }
        ...
        if ("ltgame_gamepanel.query_self_gamelist".equals(localObject1))
        {
          ...
          if ((localJSONArray != null) && (localJSONArray.length() > 0))
          {
            ...
            if (paramInt < j)
            {
              ...
              i = 1;
              label1597:
              localObject1 = localApolloDaoManagerServiceImpl.findGameById(k);
            ...
            if (localArrayList.size() > 0) {
              ((ApolloDaoManagerServiceImpl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getRuntimeService(IApolloDaoManagerService.class, "all")).updateGameInfoList(localArrayList);
            }
            if (((ArrayList)localObject3).size() > 0)
            {
              paramBundle = (ApolloExtensionHandlerImpl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.APOLLO_EXTENSION_HANDLER);
            ...
            Collections.sort((List)localObject2, this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameTempSessionHandler$MyComparator);
            i = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size();
            paramInt = 0;
            if (paramInt >= i) {
              break label3069;
        ...
        if ("ltgame_playmate.get_playmate_info".equals(localObject1))
        {
          ...
          if (!android.text.TextUtils.isEmpty(paramBundle))
          {
            ...
            paramBundle = new CmGameChatPie.UserInfo();
            ...
            ((CmGameTempSessionHandler.ICmGameMsgUIHandler)localObject1).a(str, paramBundle);
            break label3071;
          }
        ...
        if ("ltgame_msg_auth.get_sign".equals(localObject1))
        {
          ...
          if (l1 == -10002L)
          {
            ...
            ApolloItemBuilder.a(HardCodeUtil.a(2131702173), 1, BaseApplicationImpl.getContext());
            return;
          }
          if (l1 == -10000L)
          {
          ...
          if (l1 == -10001L)
          {
            ...
            ApolloItemBuilder.a(HardCodeUtil.a(2131702179), 1, BaseApplicationImpl.getContext());
            return;
          }
          if (!QLog.isColorLevel()) {
            continue;
          }
          ApolloItemBuilder.a(HardCodeUtil.a(2131702175) + l1, 1, BaseApplicationImpl.getContext());
          return;
        }
        long l2;
        if ("ltgame_usermatch.create_roomid".equals(localObject1))
        {
          ...
          l2 = ApolloUtilImpl.getJsonLongValue((String)localObject1, "roomId");
          k = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size();
          paramInt = 0;
          label2501:
          if (paramInt >= k) {
  ...
  private void a(long paramLong)
  {
    ...
    while (i < j)
    {
      CmGameTempSessionHandler.ICmGameMsgUIHandler localICmGameMsgUIHandler = (CmGameTempSessionHandler.ICmGameMsgUIHandler)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i);
      if (localICmGameMsgUIHandler != null) {
        localICmGameMsgUIHandler.d(String.valueOf(paramLong));
      }
      i += 1;
    }
  }
  ...
  private void a(String paramString, int paramInt1, long paramLong, int paramInt2)
  {
    ...
    {
      return;
      List localList = CmGameSessionUtil.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, paramInt2, paramInt1, paramLong);
      ...
      while (paramInt1 < i)
      {
        CmGameTempSessionHandler.ICmGameMsgUIHandler localICmGameMsgUIHandler = (CmGameTempSessionHandler.ICmGameMsgUIHandler)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(paramInt1);
        if (localICmGameMsgUIHandler != null) {
          localICmGameMsgUIHandler.a(paramString, paramInt2, localList);
        }
        paramInt1 += 1;
      }
    }
  ...
  private void a(String paramString1, String paramString2, boolean paramBoolean, String paramString3)
  {
    ...
    localIntent.putExtra("leftViewText", HardCodeUtil.a(2131702176));
    ...
    if (paramString3 == null)
    {
      ...
      if (SplashActivity.sWeakInstance != null) {
        paramString2 = (Context)SplashActivity.sWeakInstance.get();
      }
    }
  ...
  public static void a(JSONArray paramJSONArray)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        i = AIOUtils.a(7.0F, BaseApplicationImpl.getContext().getResources());
        if (DeviceInfoUtil.a() > 2.0F) {
          break label201;
        }
        i = AIOUtils.a(9.0F, BaseApplicationImpl.getContext().getResources());
      }
      catch (Exception paramJSONArray)
      {
        ...
        int i;
        JSONObject localJSONObject;
        QuickInputTipsBar.TipsDataItem localTipsDataItem;
      ...
      if (j < k)
      {
        ...
        if (localJSONObject != null)
        {
          ...
          localTipsDataItem.jdField_a_of_type_JavaLangCharSequence = localJSONObject.optString("tips");
          localTipsDataItem.jdField_a_of_type_Int = localJSONObject.optInt("id");
          localTipsDataItem.jdField_b_of_type_Int = localJSONObject.optInt("tipsType");
          if (!android.text.TextUtils.isEmpty(localTipsDataItem.jdField_a_of_type_JavaLangCharSequence))
          {
            if (localTipsDataItem.jdField_b_of_type_Int == 1) {
              localTipsDataItem.jdField_a_of_type_JavaLangCharSequence = new QQText(com.tencent.mobileqq.text.TextUtils.getSysEmotcationString(localJSONObject.optInt("tips")), 3, i);
            }
            jdField_b_of_type_AndroidUtilSparseArray.put(localTipsDataItem.jdField_a_of_type_Int, localTipsDataItem);
          }
        }
        j += 1;
      }
  ...
  private void b(long paramLong)
  {
    ...
    while (i < j)
    {
      CmGameTempSessionHandler.ICmGameMsgUIHandler localICmGameMsgUIHandler = (CmGameTempSessionHandler.ICmGameMsgUIHandler)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i);
      if (localICmGameMsgUIHandler != null) {
        localICmGameMsgUIHandler.e(String.valueOf(paramLong));
      }
      i += 1;
    }
  }
  ...
  private void b(boolean paramBoolean, String paramString, int paramInt, long paramLong)
  {
    ...
    while (i < j)
    {
      CmGameTempSessionHandler.ICmGameMsgUIHandler localICmGameMsgUIHandler = (CmGameTempSessionHandler.ICmGameMsgUIHandler)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i);
      if (localICmGameMsgUIHandler != null) {
        localICmGameMsgUIHandler.b(paramBoolean, paramString, paramInt, paramLong);
      }
      i += 1;
    }
  }
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameTempSessionHandler$MyComparator = new CmGameTempSessionHandler.MyComparator(this.jdField_a_of_type_AndroidUtilSparseArray);
  }
  ...
  private void c(String paramString, int paramInt, long paramLong)
  {
    ...
    while (i < j)
    {
      CmGameTempSessionHandler.ICmGameMsgUIHandler localICmGameMsgUIHandler = (CmGameTempSessionHandler.ICmGameMsgUIHandler)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i);
      if (localICmGameMsgUIHandler != null) {
        localICmGameMsgUIHandler.a(paramString, paramInt, paramLong);
      }
      i += 1;
    }
  }
  ...
  private void c(String paramString1, String paramString2)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        {
          paramString1 = CmGameSessionUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1, 1036);
          if ((paramString1 == null) || (paramString1.isEmpty()))
          {
            QLog.e("CmGameTemp_CmGameTempSessionHandler", 2, "onQueryTempGameStatusRsp msgList == null || msgList.isEmpty()");
            return;
          }
          ApolloGameArkHandler localApolloGameArkHandler = ((ApolloGameManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.APOLLO_GAME_MANAGER)).a();
          int i = 0;
          if (i < paramString2.length())
          {
            ...
            if (localObject2 != null)
            {
              ...
              if ((k >= 4) && (l > 0L) && (j > 0))
              {
                MessageForApollo localMessageForApollo = CmGameSessionUtil.a(paramString1, j, l);
                if (localMessageForApollo != null)
                {
                  ...
                  if (j < ((JSONArray)localObject2).length())
                  {
                    ...
                    localMessageForApollo.winnerList.add(Long.valueOf(ApolloUtilImpl.parseToLong((String)localObject1)));
                    j += 1;
                    continue;
                  }
                  ApolloGameUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForApollo);
                  localApolloGameArkHandler.a(localMessageForApollo);
                }
              }
            }
            i += 1;
  ...
  private void i(String paramString)
  {
    ...
    try
    {
      ...
      localObject2 = CmGameSessionUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, 1036);
    ...
    if ((j >= 4) && (l > 0L) && (i > 0))
    {
      localObject2 = CmGameSessionUtil.a((List)localObject2, i, l);
      if (localObject2 != null)
      {
    ...
    for (;;)
    {
      if (i < ((JSONArray)localObject1).length())
      {
        ...
        ((MessageForApollo)localObject2).winnerList.add(Long.valueOf(ApolloUtilImpl.parseToLong(paramString)));
        i += 1;
      }
      else
      {
        ...
        do
        {
          ...
          ((ApolloGameManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.APOLLO_GAME_MANAGER)).a().a((MessageForApollo)localObject2);
          return;
  ...
  public void a()
  {
    this.jdField_a_of_type_ComTencentUtilWeakReferenceHandler.removeMessages(255);
  ...
  public void a(int paramInt1, int paramInt2)
  {
    try
    {
      ...
      localObject = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), CmGameServlet.class);
  ...
  public void a(int paramInt1, String paramString1, int paramInt2, String paramString2, int paramInt3)
  {
    ...
    try
    {
      ...
      localUniSsoServerReq.reqdata.set(((JSONObject)localObject).toString());
      paramString1 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), CmGameServlet.class);
  ...
  public void a(CmGameTempSessionHandler.ICmGameMsgUIHandler paramICmGameMsgUIHandler)
  {
    ...
    QLog.i("CmGameTemp_CmGameTempSessionHandler", 1, "addMsgUIHandler size:" + this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size() + " cmGameMsgUIHandler:" + paramICmGameMsgUIHandler);
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ("close_aio".equals(str))
        {
          ...
          paramTunnelMsgStream = (CmGameTempSessionHandler.ICmGameMsgUIHandler)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i);
          if (paramTunnelMsgStream == null) {
            break label741;
          }
        ...
        if ("mphone_status".equals(str))
        {
          ...
          paramTunnelMsgStream = (CmGameTempSessionHandler.ICmGameMsgUIHandler)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(j);
          if (paramTunnelMsgStream == null) {
            break label748;
          }
      ...
      else
      {
        ...
        {
          CmGameSessionUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1), l3, j);
          return;
        }
      ...
      for (int i = 1;; i = 0)
      {
        ...
        RobotDataUtil.a(String.valueOf(l1));
        return;
        if ("robot_send_arkmsg".equals(str))
        {
          ...
          l1 = ApolloUtilImpl.parseToLong(paramTunnelMsgStream.optString("roomId"));
          l2 = paramTunnelMsgStream.optLong("rbUin");
          paramTunnelMsgStream = paramTunnelMsgStream.optString("rbOpenId");
          CmGameSessionUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l2), paramTunnelMsgStream, l1, i);
          return;
        }
  ...
  public void a(String paramString)
  {
    try
    {
      ...
      localObject2 = CmGameSessionUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, 1036, 1);
      if ((localObject2 == null) || (((List)localObject2).isEmpty()))
      {
        if (!QLog.isColorLevel()) {
          return;
    ...
    Object localObject1 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), CmGameServlet.class);
  ...
  public void a(List<ApolloGameData> paramList, Bundle paramBundle)
  {
    ...
    if (i == 1)
    {
      this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameTempSessionHandler$TopGameInfo.jdField_b_of_type_JavaUtilList.clear();
      k = this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameTempSessionHandler$TopGameInfo.jdField_b_of_type_JavaUtilList.size();
      i = 0;
      while (i < k)
      {
        int m = ((Integer)this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameTempSessionHandler$TopGameInfo.jdField_a_of_type_JavaUtilList.get(i)).intValue();
        paramBundle = ((ApolloDaoManagerServiceImpl)localObject).findGameById(m);
        if (paramBundle != null)
        {
          this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameTempSessionHandler$TopGameInfo.jdField_b_of_type_JavaUtilList.add(paramBundle);
          i += 1;
        }
        else
        {
    ...
    for (;;)
    {
      ...
      while (i < k)
      {
        paramBundle = (CmGameTempSessionHandler.ICmGameMsgUIHandler)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i);
        if (paramBundle != null) {
          paramBundle.a(paramList, this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameTempSessionHandler$TopGameInfo);
        }
        i += 1;
      }
      continue;
      if (i == 2)
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          ApolloGameData localApolloGameData = ((ApolloDaoManagerServiceImpl)localObject).findGameById(i);
        ...
        Collections.sort(paramBundle, this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameTempSessionHandler$MyComparator);
        j = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size();
        i = 0;
        while (i < j)
        {
          localObject = (CmGameTempSessionHandler.ICmGameMsgUIHandler)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(0);
          if (localObject != null) {
            ((CmGameTempSessionHandler.ICmGameMsgUIHandler)localObject).a(paramList, paramBundle);
          }
          i += 1;
        }
      }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        while (i < k)
        {
          CmGameTempSessionHandler.ICmGameMsgUIHandler localICmGameMsgUIHandler = (CmGameTempSessionHandler.ICmGameMsgUIHandler)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i);
          if (localICmGameMsgUIHandler != null) {
            localICmGameMsgUIHandler.a(paramBoolean, paramString1, j, l, paramString2);
          }
          i += 1;
        }
        return;
  ...
  {
    this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.remove(paramICmGameMsgUIHandler);
    QLog.i("CmGameTemp_CmGameTempSessionHandler", 1, "removeMsgUIHandler size:" + this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size() + " cmGameMsgUIHandler:" + paramICmGameMsgUIHandler);
  }
      ...
      try
      {
        if ((BaseActivity.sTopActivity instanceof FragmentActivity))
        {
          ...
          if (localObject1 != null)
          {
            ...
            if ((localObject1 instanceof CmGameChatPie))
            {
              localObject1 = (CmGameChatPie)localObject1;
              ...
              if ((localObject1 == null) || (!((CmGameChatPie)localObject1).E()))
              {
                a(str, (String)localObject2, true, paramString);
                return;
              }
              CmGameChatPie.O = true;
              ((CmGameChatPie)localObject1).a(j, i, paramString);
              return;
            }
          }
        }
 ...
 * Qualified Name:     com.tencent.mobileqq.apollo.lightGame.CmGameTempSessionHandler
