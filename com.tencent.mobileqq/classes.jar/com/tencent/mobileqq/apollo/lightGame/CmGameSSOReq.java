...
public class CmGameSSOReq
{
  public static void a(AppInterface paramAppInterface, int paramInt, String paramString, CmGameSSOReq.ICmGameSSOReqListener paramICmGameSSOReqListener)
  {
    ...
    try
    {
      ...
      paramString = new NewIntent(BaseApplicationImpl.getContext(), CmGameServlet.class);
      ...
      paramString.setObserver(paramICmGameSSOReqListener);
 ...
 * Qualified Name:     com.tencent.mobileqq.apollo.lightGame.CmGameSSOReq
