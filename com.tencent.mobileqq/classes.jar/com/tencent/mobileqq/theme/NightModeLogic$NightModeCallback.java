  ...
  public final void c(Bundle paramBundle)
  {
    ...
    for (;;)
    {
      if (QLog.isColorLevel()) {
        QLog.i("ThemeSwitchManager", 2, "NightModeCallback start_status: " + paramBundle.getInt("start_status", -1));
      }
      b(paramBundle);
      return;
      if (i == 1)
      ...
      else if (i == 3)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.i("ThemeSwitchManager", 2, "NightModeCallback transferedSize: " + l1 + ",filesize=" + l2 + ",percent=" + i);
        }
