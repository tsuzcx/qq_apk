  ...
  extends RelativeLayout
{
  ...
  public void init(ThemeDIYData paramThemeDIYData, int paramInt1, int paramInt2, int paramInt3, ThemeBackground paramThemeBackground)
  {
    ...
    this.mRLayout = ((RelativeLayout)super.findViewById(2131375064));
    ...
    this.pich = paramInt3;
    this.picw = paramInt2;
    this.mUserBgView = super.findViewById(2131375065);
    this.mMaskColor = super.findViewById(2131375066);
    ...
    for (;;)
    {
      this.mShotView = super.findViewById(2131375067);
      return;
  ...
  {
    Object localObject = this.mRLayout.findViewById(2131365666);
    if (localObject != null)
    {
    ...
    while ((localObject == null) || (((ProgressBar)localObject).getParent() == null) || (((this.bgResData == null) || (this.bgResData.state >= 2)) && ((this.shotResData == null) || (this.shotResData.state >= 2))))
    {
      ...
      ((ProgressBar)localObject).setId(2131365666);
      ((ProgressBar)localObject).setIndeterminateDrawable(super.getResources().getDrawable(2130838592));
