...
public class DIYThemeUtils
{
  ...
  public static android.graphics.drawable.Drawable getDIYDrawable(android.content.Context paramContext, ResData paramResData, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    ...
    //   330: aload 7
    //   332: aload_0
    //   333: invokestatic 179	becs:a	(Landroid/content/Context;)Z
  ...
  public static ResData getResData(AppRuntime paramAppRuntime, ResSuitData paramResSuitData, int paramInt, String paramString)
  {
    ...
    case 115: 
      ...
      return localResData;
    case 116: 
      localResData.path = (ajed.cb + "deal/" + paramResSuitData.id);
      return localResData;
    case 110: 
      localResData.path = ChatBackgroundManager.a(true, paramResSuitData.id);
      return localResData;
    case 117: 
      localResData.path = (ajed.ca + localResData.id + "/" + localResData.url.hashCode());
      return localResData;
    case 120: 
    case 121: 
      ...
      {
        paramAppRuntime = "0";
        paramAppRuntime = new StringBuilder().append(ThemeDiyStyleLogic.getDataDIYDir()).append(akhi.a(paramAppRuntime)).append("/");
        if (120 != paramInt) {
          break label350;
        }
      }
