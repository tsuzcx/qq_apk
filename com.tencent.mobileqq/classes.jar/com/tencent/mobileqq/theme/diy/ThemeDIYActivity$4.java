  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    try
    {
      bool = bavz.a(this.this$0.app.getApplication(), "ThemeDIYActivity", false);
      l = azzz.b();
    ...
    if (j < this.this$0.showData.length)
    {
      ...
      if (k < localJSONArray2.length())
      {
        ...
        if ((!banq.a(localJSONObject1.optString("minVersion"), "8.2.6")) || (banq.a(localJSONObject1.optString("maxVersion"), "8.2.6")))
        {
          localObject3 = localObject2;
          m = i;
          if (!QLog.isColorLevel()) {
          ...
          QLog.d("ThemeDIYActivity", 2, "loadResJson style subVersion: 8.2.6, minVersion:" + localJSONObject1.optString("minVersion") + ", maxVersion:" + localJSONObject1.optString("maxVersion") + ", id:" + str2 + ", timeStamp:" + l);
          localObject3 = localObject2;
          m = i;
          break label1639;
        }
