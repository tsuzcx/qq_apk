  ...
  public void run()
  {
    ...
    if (j < this.this$0.showData.length)
    {
      ...
      if (k < localJSONArray2.length())
      {
        ...
        if ((!IndividuationConfigInfo.a(localJSONObject1.optString("minVersion"), "7.6.8")) || (IndividuationConfigInfo.a(localJSONObject1.optString("maxVersion"), "7.6.8")))
        {
          localObject3 = localObject2;
          m = i;
          if (!QLog.isColorLevel()) {
          ...
          QLog.d("ThemeDIYActivity", 2, "loadResJson style subVersion: 7.6.8, minVersion:" + localJSONObject1.optString("minVersion") + ", maxVersion:" + localJSONObject1.optString("maxVersion") + ", id:" + str2 + ", timeStamp:" + l);
          localObject3 = localObject2;
          m = i;
          break label1639;
        }
