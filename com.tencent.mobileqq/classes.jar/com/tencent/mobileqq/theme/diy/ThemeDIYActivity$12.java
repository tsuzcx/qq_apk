  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      if ((((ItemView)localObject1).resSuitData instanceof ResSuitData.BgSuit))
      {
        ...
        for (;;)
        {
          bcst.b(this.this$0.app, "CliOper", "", this.this$0.app.getCurrentAccountUin(), "theme_mall", (String)localObject1, 0, 0, String.valueOf(this.this$0.mCurrentPageIndex), localBgSuit.id, "" + localBgSuit.from, "");
          break;
      ...
      if ((((ItemView)localObject1).resSuitData instanceof ResSuitData.StyleSuit))
      {
        ...
        for (this.this$0.mStyleSetStatus = 2;; this.this$0.mStyleSetStatus = 0)
        {
          ...
          bcst.b(this.this$0.app, "CliOper", "", this.this$0.app.getCurrentAccountUin(), "theme_mall", "diy_style", 0, 0, String.valueOf(this.this$0.mCurrentPageIndex), ((ResSuitData.StyleSuit)localObject1).id, "", "");
