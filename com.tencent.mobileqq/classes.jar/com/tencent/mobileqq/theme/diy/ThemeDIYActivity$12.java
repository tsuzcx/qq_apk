  ...
  implements AdapterView.OnItemClickListener
{
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    if ((paramAdapterView.resSuitData instanceof ResSuitData.BgSuit))
    {
      ...
      for (;;)
      {
        azqs.b(this.this$0.app, "CliOper", "", this.this$0.app.getCurrentAccountUin(), "theme_mall", paramAdapterView, 0, 0, String.valueOf(this.this$0.mCurrentPageIndex), paramView.id, "" + paramView.from, "");
        return;
    ...
    if ((paramAdapterView.resSuitData instanceof ResSuitData.StyleSuit))
    {
      ...
      for (this.this$0.mStyleSetStatus = 2;; this.this$0.mStyleSetStatus = 0)
      {
        ...
        azqs.b(this.this$0.app, "CliOper", "", this.this$0.app.getCurrentAccountUin(), "theme_mall", "diy_style", 0, 0, String.valueOf(this.this$0.mCurrentPageIndex), paramAdapterView.id, "", "");
