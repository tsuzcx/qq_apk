  ...
  extends Handler
{
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case 19: 
      ...
      Object localObject = this.this$0.mContext.getResources().getDrawable(2130846370);
      try
      {
        ...
        localURLDrawableOptions.mUseSharpPImage = becs.a(BaseApplicationImpl.getApplication());
    ...
    for (;;)
    {
      ...
      bbmy.a(this.this$0.mContext, 2131654319, 3000).b(this.this$0.mContext.getResources().getDimensionPixelSize(2131167766));
      return;
      ...
      bbmy.a(this.this$0.mContext, paramMessage.obj.toString(), 3600).b(this.this$0.mContext.getResources().getDimensionPixelSize(2131167766));
      return;
      if (paramMessage.obj == null) {
        break;
      }
