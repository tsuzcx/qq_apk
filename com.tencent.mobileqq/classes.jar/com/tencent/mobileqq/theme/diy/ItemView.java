  ...
  extends RelativeLayout
{
  ...
  public void init(ResSuitData paramResSuitData1, ResSuitData paramResSuitData2, ResSuitData paramResSuitData3, boolean paramBoolean)
  {
    ...
    {
      this.mThumImg = ((ImageView)super.findViewById(2131378583));
      this.mUsedTv = ((TextView)super.findViewById(2131380251));
      this.mUsedTv.setVisibility(8);
      this.mNameTv = ((TextView)super.findViewById(2131371628));
      this.bgView = super.findViewById(2131380249);
      this.mFlagFeetype = ((ImageView)super.findViewById(2131366808));
    }
    ...
    if (!paramBoolean)
    {
      ...
      ((ResData)localObject1).resID = 2130845999;
      i = super.getResources().getColor(2131166590);
    }
    for (;;)
    {
      ...
      if (i == 0)
      {
        ...
        this.mFlagFeetype.setImageResource(2130846977);
        label281:
      ...
      for (;;)
      {
        ...
        if ("100".equals(paramResSuitData1.id))
        {
          ...
          for (i = paramResSuitData1.resID;; i = 2130845999)
          {
        ...
        if ("999".equals(paramResSuitData1.id)) {
          ((ResData)localObject1).resID = 2130845954;
        }
        ...
        {
          this.mFlagFeetype.setImageResource(2130846978);
          break label281;
        }
