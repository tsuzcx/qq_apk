  ...
  extends RelativeLayout
{
  ...
  public void init(ResSuitData paramResSuitData1, ResSuitData paramResSuitData2, ResSuitData paramResSuitData3, boolean paramBoolean)
  {
    ...
    {
      this.mThumImg = ((ImageView)super.findViewById(2131378877));
      this.mUsedTv = ((TextView)super.findViewById(2131380586));
      this.mUsedTv.setVisibility(8);
      this.mNameTv = ((TextView)super.findViewById(2131371816));
      this.bgView = super.findViewById(2131380584);
      this.mFlagFeetype = ((ImageView)super.findViewById(2131366926));
    }
    ...
    if (!paramBoolean)
    {
      ...
      ((ResData)localObject1).resID = 2130846087;
      i = super.getResources().getColor(2131166604);
    }
    for (;;)
    {
      ...
      if (i == 0)
      {
        ...
        this.mFlagFeetype.setImageResource(2130847074);
        label281:
      ...
      for (;;)
      {
        ...
        if ("100".equals(paramResSuitData1.id))
        {
          ...
          for (i = paramResSuitData1.resID;; i = 2130846087)
          {
        ...
        if ("999".equals(paramResSuitData1.id)) {
          ((ResData)localObject1).resID = 2130846042;
        }
        ...
        {
          this.mFlagFeetype.setImageResource(2130847075);
          break label281;
        }
