...
class ThemeDIYActivity$14
  extends Handler
{
  ThemeDIYActivity$14(ThemeDIYActivity paramThemeDIYActivity, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case 19: 
      ...
      Object localObject = this.this$0.mContext.getResources().getDrawable(2130844107);
      try
      {
        ...
        localURLDrawableOptions.mUseSharpPImage = QQSharpPUtil.a(BaseApplicationImpl.getApplication());
        ...
        if (((URLDrawable)localObject).getStatus() != 1)
        {
          ...
          ((URLDrawable)localObject).addHeader("my_uin", this.this$0.app.c());
    ...
    for (;;)
    {
      ...
      QQToast.a(this.this$0.mContext, 2131434103, 3000).b(this.this$0.mContext.getResources().getDimensionPixelSize(2131558448));
      return;
      ...
      QQToast.a(this.this$0.mContext, paramMessage.obj.toString(), 3600).b(this.this$0.mContext.getResources().getDimensionPixelSize(2131558448));
      return;
      if (paramMessage.obj == null) {
        break;
      }
