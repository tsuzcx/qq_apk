  ...
  implements Manager
{
  ...
  Handler jdField_a_of_type_AndroidOsHandler = new ThemeSwitchManager.2(this, Looper.getMainLooper());
  ...
  {
    boolean bool3 = false;
    String str = ((IDPCApi)QRoute.api(IDPCApi.class)).getFeatureValue(DPCNames.theme_profile.name(), "1|1|1");
