  ...
  implements Manager
{
  ...
  ThemeDownloader.ThemeDownloadListener jdField_a_of_type_ComTencentMobileqqThemeThemeDownloader$ThemeDownloadListener = new aiad(this);
  ...
  ThemeDiyStyleLogic.StyleCallBack jdField_b_of_type_ComTencentMobileqqThemeDiyThemeDiyStyleLogic$StyleCallBack = new aiaa(this);
  public String b;
  ...
  public ThemeSwitchManager(AppRuntime paramAppRuntime)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new aiac(this, Looper.getMainLooper());
    this.jdField_a_of_type_JavaLangObject = new Object();
    this.jdField_a_of_type_ComTencentMobileqqThemeThemeDownloader$ThemeUnzipListener = new aiae(this);
      ...
      else
      {
        ...
        for (;;)
        {
          ...
          if (bool4)
          {
            ...
            {
              ThreadManager.getUIHandler().post(new aiaf(this, localMobileQQ, paramString1));
              if (bool3) {
            ...
            if ((bool3) || (!bool2))
            {
              if ((paramBundle != null) && (!paramBundle.getBoolean("server_after_download", false)))
              {
                ...
                if ((i == 1) || (i == 4) || (bool1))
                {
                  ...
                  ThreadManager.post(new aiag(this, paramBundle), 8, null, true);
                }
                for (i = 0;; i = 1)
                {
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_AndroidGraphicsBitmap != null) {
      if ((!this.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) && (this.jdField_a_of_type_AndroidWidgetImageView != null))
      {
        ...
        this.jdField_a_of_type_AndroidViewView.postDelayed(new aiab(this), 601L);
      }
    }
    for (;;)
    {
