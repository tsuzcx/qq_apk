...
public class SdCardUtil
{
  ...
  public static ArrayList a()
  {
    ...
    //   8: aconst_null
    //   9: astore_0
    //   10: invokestatic 83	com/tencent/mobileqq/utils/SdCardUtil:b	()Z
    //   13: ifeq +20 -> 33
    //   16: invokestatic 86	android/os/Environment:getExternalStorageDirectory	()Ljava/io/File;
    //   19: invokevirtual 89	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   22: astore_1
    //   23: aload_1
    //   24: ifnull +9 -> 33
    //   27: aload_3
    //   28: aload_1
    //   29: invokevirtual 93	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   32: pop
    //   33: new 95	java/io/BufferedReader
    //   36: dup
    //   37: new 97	java/io/FileReader
    //   40: dup
    //   41: ldc 99
    //   43: invokespecial 100	java/io/FileReader:<init>	(Ljava/lang/String;)V
    //   46: invokespecial 103	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   49: astore_1
    //   50: aload_1
    ...
    //   59: aload_0
    //   60: ldc 108
    //   62: invokevirtual 112	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   65: ifne +30 -> 95
    //   68: aload_0
    //   69: ldc 114
    //   71: invokevirtual 112	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   74: ifne +21 -> 95
    //   77: aload_0
    //   78: ldc 116
    //   80: invokevirtual 112	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   83: ifne +12 -> 95
    //   86: aload_0
    //   87: ldc 118
    //   89: invokevirtual 112	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   92: ifeq -42 -> 50
    //   95: aload_0
    //   96: ldc 120
    //   98: invokevirtual 124	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   101: astore_2
    //   102: aload_2
    //   103: iconst_1
    //   104: aaload
    //   105: invokestatic 86	android/os/Environment:getExternalStorageDirectory	()Ljava/io/File;
    //   108: invokevirtual 39	java/io/File:getPath	()Ljava/lang/String;
    //   111: invokevirtual 127	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   114: ifeq +43 -> 157
    //   117: aload_3
    //   118: aload_2
    //   119: iconst_1
    //   120: aaload
    //   121: invokestatic 130	com/tencent/mobileqq/utils/SdCardUtil:a	(Ljava/util/ArrayList;Ljava/lang/String;)Z
    //   124: ifne -74 -> 50
    //   127: aload_3
    //   128: aload_2
    //   129: iconst_1
    //   130: aaload
    //   131: invokevirtual 93	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   134: pop
    //   135: goto -85 -> 50
    //   138: astore_2
    //   139: aload_1
    ...
    //   142: astore_1
    //   143: aload_1
    //   144: invokevirtual 131	java/lang/Exception:printStackTrace	()V
    //   147: aload_0
    //   148: ifnull +7 -> 155
    //   151: aload_0
    ...
    //   157: aload_0
    //   158: ldc 136
    //   160: invokevirtual 112	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   163: ifeq -113 -> 50
    //   166: aload_0
    //   167: ldc 138
    //   169: invokevirtual 112	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   172: ifne -122 -> 50
    //   175: aload_0
    //   176: ldc 140
    //   178: invokevirtual 112	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   181: ifne -131 -> 50
    //   184: aload_0
    //   185: ldc 142
    //   187: invokevirtual 112	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   190: ifne -140 -> 50
    //   193: aload_0
    //   194: ldc 144
    //   196: invokevirtual 112	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   199: ifne -149 -> 50
    //   202: aload_0
    //   203: ldc 146
    //   205: invokevirtual 112	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   208: ifne -158 -> 50
    //   211: aload_3
    //   212: aload_2
    //   213: iconst_1
    //   214: aaload
    //   215: invokestatic 130	com/tencent/mobileqq/utils/SdCardUtil:a	(Ljava/util/ArrayList;Ljava/lang/String;)Z
    //   218: ifne -168 -> 50
    //   221: aload_3
    //   222: aload_2
    //   223: iconst_1
    //   224: aaload
    //   225: invokevirtual 93	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   228: pop
    //   229: goto -179 -> 50
    //   232: astore_0
    //   233: aload_1
    ...
    //   242: athrow
    //   243: aload_3
    //   244: invokestatic 149	com/tencent/mobileqq/utils/SdCardUtil:a	(Ljava/util/ArrayList;)V
    //   247: aload_1
    //   248: ifnull -93 -> 155
    //   251: aload_1
    ...
    //   257: astore_0
    //   258: aload_0
    //   259: invokevirtual 150	java/io/IOException:printStackTrace	()V
    //   262: aload_3
    //   263: areturn
    //   264: astore_0
    //   265: aload_0
    //   266: invokevirtual 150	java/io/IOException:printStackTrace	()V
    //   269: aload_3
    //   270: areturn
    //   271: astore_1
    //   272: aload_1
    //   273: invokevirtual 150	java/io/IOException:printStackTrace	()V
    //   276: goto -35 -> 241
    //   279: astore_0
    //   280: aconst_null
    //   281: astore_1
  ...
  static boolean a(ArrayList paramArrayList, String paramString)
  {
    boolean bool2 = false;
