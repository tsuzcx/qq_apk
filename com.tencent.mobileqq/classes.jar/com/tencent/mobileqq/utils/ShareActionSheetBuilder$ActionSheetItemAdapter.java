  ...
  extends BaseAdapter
{
  ...
  private aknq jdField_a_of_type_Aknq;
  private Resources jdField_a_of_type_AndroidContentResResources;
  private LayoutInflater jdField_a_of_type_AndroidViewLayoutInflater;
  private List jdField_a_of_type_JavaUtilList;
  
  public ShareActionSheetBuilder$ActionSheetItemAdapter(Context paramContext, List paramList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (this.jdField_a_of_type_Aknq == null) {
      this.jdField_a_of_type_Aknq = new aknq(paramViewGroup.getContext());
    }
    if (paramView == null)
    {
    ...
    paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.setText(ShareActionSheetBuilder.a(paramViewGroup.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.jdField_a_of_type_JavaLangString, 6));
    paramInt = -8947849;
    ...
    if (paramViewGroup.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.jdField_b_of_type_Boolean)
    {
      ...
      localObject = this.jdField_a_of_type_Aknq.a((Drawable)localObject, paramInt, i);
      if (!paramViewGroup.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.jdField_b_of_type_Boolean) {
        break label421;
      }
      Drawable localDrawable = aknq.a(this.jdField_a_of_type_Aknq, (Drawable)localObject);
      localObject = this.jdField_a_of_type_Aknq.a((Drawable)localObject, localDrawable);
    ...
    for (;;)
    {
      ...
      break label294;
      label421:
      localObject = aknq.b(this.jdField_a_of_type_Aknq, (Drawable)localObject);
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject);
    }
    label444:
