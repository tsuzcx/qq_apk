  ...
  implements View.OnClickListener
{
  ...
  public QQCustomMenuLayout(Context paramContext)
  {
    ...
    this.jdField_c_of_type_AndroidWidgetImageView.setBackgroundResource(2130838296);
    ...
    this.jdField_d_of_type_AndroidWidgetImageView.setBackgroundResource(2130838296);
    if (!AppSetting.jdField_b_of_type_Boolean) {
    ...
    this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130838315);
