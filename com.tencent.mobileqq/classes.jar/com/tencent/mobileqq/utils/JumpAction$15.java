...
public class JumpAction$15
  implements Runnable
{
  public JumpAction$15(bbeg parambbeg, String paramString) {}
  
  public void run()
  {
    String str = bbdx.a(this.this$0.jdField_a_of_type_AndroidContentContext, this.a, "opensdk_tmp");
    try
    {
      str = new String(bbco.encode(str.getBytes("UTF-8"), 0));
