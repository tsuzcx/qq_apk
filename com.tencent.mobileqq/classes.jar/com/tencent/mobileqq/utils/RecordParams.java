...
public abstract class RecordParams
{
  ...
  public static int a(String paramString)
  {
    ...
    //   12: aconst_null
    //   13: astore 7
    //   15: new 45	java/io/FileInputStream
    //   18: dup
    //   19: aload_0
    //   20: invokespecial 48	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   23: astore_0
    //   24: new 50	java/io/DataInputStream
    //   27: dup
    //   28: aload_0
    //   29: invokespecial 53	java/io/DataInputStream:<init>	(Ljava/io/InputStream;)V
    //   32: astore 4
    //   34: iload_3
    //   35: istore_2
    //   36: bipush 10
    ...
    //   44: aload 4
    //   46: aload 8
    //   48: invokevirtual 57	java/io/DataInputStream:read	([B)I
    //   51: aload 8
    //   53: arraylength
    ...
    //   58: istore_2
    //   59: aload 8
    //   61: invokestatic 60	com/tencent/mobileqq/qqaudio/QQAudioUtils:a	([B)Z
    //   64: ifeq +5 -> 69
    //   67: iconst_1
    //   68: istore_1
    //   69: iload_1
    //   70: istore_2
    //   71: aload 4
    //   73: invokevirtual 63	java/io/DataInputStream:close	()V
    //   76: iload_1
    //   77: istore_2
    //   78: aload_0
    //   79: invokevirtual 64	java/io/FileInputStream:close	()V
    //   82: aconst_null
    //   83: astore_0
    //   84: aload 7
    //   86: astore 4
    ...
    //   89: ifnull +7 -> 96
    //   92: aload_0
    //   93: invokevirtual 64	java/io/FileInputStream:close	()V
    //   96: iload_1
    //   97: istore_2
    //   98: aload 4
    //   100: ifnull +10 -> 110
    //   103: aload 4
    //   105: invokevirtual 63	java/io/DataInputStream:close	()V
    //   108: iload_1
    //   109: istore_2
    //   110: iload_2
    //   111: ireturn
    ...
    //   117: istore_1
    //   118: aload 4
    //   120: invokevirtual 67	java/lang/Exception:printStackTrace	()V
    //   123: aload_0
    //   124: ifnull +7 -> 131
    //   127: aload_0
    //   128: invokevirtual 64	java/io/FileInputStream:close	()V
    //   131: iload_1
    //   132: istore_2
    //   133: aload 5
    //   135: ifnull -25 -> 110
    //   138: aload 5
    //   140: invokevirtual 63	java/io/DataInputStream:close	()V
    //   143: iload_1
    //   144: ireturn
    //   145: astore_0
    //   146: iload_1
    ...
    //   157: ifnull +7 -> 164
    //   160: aload_0
    //   161: invokevirtual 64	java/io/FileInputStream:close	()V
    //   164: aload 5
    //   166: ifnull +8 -> 174
    //   169: aload 5
    //   171: invokevirtual 63	java/io/DataInputStream:close	()V
    //   174: aload 4
    //   176: athrow
    //   177: astore_0
    //   178: goto -4 -> 174
  ...
  public static RecordParams.RecorderParam a(AppRuntime paramAppRuntime, boolean paramBoolean)
  {
    ...
    if (paramBoolean) {}
    for (paramAppRuntime = jdField_b_of_type_ComTencentMobileqqUtilsRecordParams$RecorderParam;; paramAppRuntime = jdField_a_of_type_ComTencentMobileqqUtilsRecordParams$RecorderParam) {
  ...
  {
    paramAppRuntime = BaseApplication.getContext().getSharedPreferences("RecordParams_" + paramAppRuntime.getCurrentAccountUin(), 0).getString("SilkCfg", null);
    if (QLog.isColorLevel()) {
      QLog.d("RecordParams", 2, "getSavedSilkCfg: " + paramAppRuntime);
    }
  ...
  {
    BaseApplication.getContext().getSharedPreferences("RecordParams_" + paramAppRuntime.getCurrentAccountUin(), 0).edit().putString("SilkCfg", paramString).commit();
    if (QLog.isColorLevel()) {
  ...
  public static void a(AppRuntime paramAppRuntime, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("RecordParams", 2, "init from sp:" + paramAppRuntime);
        }
        if (paramAppRuntime != null)
        {
          i = paramAppRuntime.length();
          if (i != 0) {
            continue;
          }
        }
      ...
      QLog.d("RecordParams", 2, "init params: " + jdField_a_of_type_ComTencentMobileqqUtilsRecordParams$RecorderParam.c + "-" + jdField_a_of_type_ComTencentMobileqqUtilsRecordParams$RecorderParam.jdField_a_of_type_Int + "-" + jdField_a_of_type_ComTencentMobileqqUtilsRecordParams$RecorderParam.jdField_b_of_type_Int);
      QLog.d("RecordParams", 2, "init changer params: " + jdField_b_of_type_ComTencentMobileqqUtilsRecordParams$RecorderParam.c + "-" + jdField_b_of_type_ComTencentMobileqqUtilsRecordParams$RecorderParam.jdField_a_of_type_Int + "-" + jdField_b_of_type_ComTencentMobileqqUtilsRecordParams$RecorderParam.jdField_b_of_type_Int);
      return;
      paramAppRuntime = paramAppRuntime.split("\\|");
      if ((paramAppRuntime != null) && (paramAppRuntime.length >= 3))
      {
        i = Integer.valueOf(paramAppRuntime[0]).intValue();
        j = Integer.valueOf(paramAppRuntime[1]).intValue();
        k = Integer.valueOf(paramAppRuntime[2]).intValue();
