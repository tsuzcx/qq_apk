...
public abstract class RecordParams
{
  ...
  static
  {
    ...
    jdField_a_of_type_ComTencentMobileqqUtilsQQRecorder$RecorderParam = new QQRecorder.RecorderParam(jdField_a_of_type_Int, 8000, 0);
  ...
  public static int a(String paramString)
  {
    ...
    //   18: dup
    //   19: aload_0
    //   20: invokespecial 64	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   23: astore_0
    //   24: new 66	java/io/DataInputStream
    //   27: dup
    //   28: aload_0
    //   29: invokespecial 69	java/io/DataInputStream:<init>	(Ljava/io/InputStream;)V
    //   32: astore 4
    //   34: iload_3
    //   35: istore_2
    //   36: bipush 10
    ...
    //   44: aload 4
    //   46: aload 8
    //   48: invokevirtual 72	java/io/DataInputStream:read	([B)I
    //   51: aload 8
    //   53: arraylength
    ...
    //   58: istore_2
    //   59: aload 8
    //   61: invokestatic 45	com/tencent/mobileqq/utils/RecordParams:a	([B)Z
    //   64: ifeq +5 -> 69
    //   67: iconst_1
    //   68: istore_1
    //   69: iload_1
    //   70: istore_2
    //   71: aload 4
    //   73: invokevirtual 75	java/io/DataInputStream:close	()V
    //   76: iload_1
    //   77: istore_2
    //   78: aload_0
    //   79: invokevirtual 76	java/io/FileInputStream:close	()V
    //   82: aconst_null
    //   83: astore_0
    //   84: aload 7
    //   86: astore 4
    ...
    //   89: ifnull +7 -> 96
    //   92: aload_0
    //   93: invokevirtual 76	java/io/FileInputStream:close	()V
    //   96: iload_1
    //   97: istore_2
    //   98: aload 4
    //   100: ifnull +10 -> 110
    //   103: aload 4
    //   105: invokevirtual 75	java/io/DataInputStream:close	()V
    //   108: iload_1
    //   109: istore_2
    //   110: iload_2
    //   111: ireturn
    ...
    //   117: istore_1
    //   118: aload 4
    //   120: invokevirtual 79	java/lang/Exception:printStackTrace	()V
    //   123: aload_0
    //   124: ifnull +7 -> 131
    //   127: aload_0
    ...
    //   135: ifnull -25 -> 110
    //   138: aload 5
    //   140: invokevirtual 75	java/io/DataInputStream:close	()V
    //   143: iload_1
    //   144: ireturn
    //   145: astore_0
    //   146: iload_1
    ...
    //   157: ifnull +7 -> 164
    //   160: aload_0
    //   161: invokevirtual 76	java/io/FileInputStream:close	()V
    //   164: aload 5
    //   166: ifnull +8 -> 174
    //   169: aload 5
    //   171: invokevirtual 75	java/io/DataInputStream:close	()V
    //   174: aload 4
    //   176: athrow
    //   177: astore_0
    //   178: goto -4 -> 174
  ...
  public static boolean a(byte[] paramArrayOfByte)
  {
    ...
    {
      return bool;
      str = PkgTools.b(paramArrayOfByte, 1, 9);
      if (QLog.isColorLevel()) {
