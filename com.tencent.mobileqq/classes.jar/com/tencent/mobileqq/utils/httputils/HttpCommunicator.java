  ...
  implements SSCMTimer.SSCMTimerObserver
{
  ...
  private akon[] jdField_a_of_type_ArrayOfAkon;
  ...
  private void a(HttpURLConnection paramHttpURLConnection, HttpMsg paramHttpMsg)
  {
    ...
    if ((paramHttpMsg.j) && ((paramHttpURLConnection instanceof HttpsURLConnection)))
    {
      ...
      localakol = new akol(this, str, paramHttpMsg);
      if (paramHttpMsg.k)
      {
        paramHttpURLConnection.setRequestProperty("host", str);
        paramHttpURLConnection.setSSLSocketFactory(new SniSSLSocketFactory(str, localakol));
        paramHttpURLConnection.setHostnameVerifier(localakol);
      }
    }
    else
    {
  ...
  public void a()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      this.jdField_a_of_type_ArrayOfAkon = new akon[4];
      while (i < 4)
      {
        HandlerThread localHandlerThread = ThreadManager.newFreeHandlerThread("httpcommunicator_norm_" + i, 5);
        localHandlerThread.start();
        this.jdField_a_of_type_ArrayOfAkon[i] = new akon(this, localHandlerThread.getLooper());
        this.jdField_a_of_type_ArrayOfAkon[i].jdField_a_of_type_Int = i;
        i += 1;
      }
      i = NetworkCenter.a().a();
      if ((i == 2) || (i == 3))
  ...
  public void a(akon paramakon)
  {
    ...
    do
    {
      ...
      {
        return;
      } while (paramakon == null);
      paramakon.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(true);
      i = paramakon.jdField_a_of_type_Int;
      if ((i >= 0) && (i < 4))
      {
        ??? = new HandlerThread("httpcommunicator_norm_new_" + i, 5);
        ((HandlerThread)???).start();
        akon localakon = new akon(this, ((HandlerThread)???).getLooper());
        localakon.jdField_a_of_type_Int = i;
        synchronized (this.jdField_a_of_type_JavaLangObject)
        {
          this.jdField_a_of_type_ArrayOfAkon[i] = localakon;
          if (paramakon.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) {
            this.e -= 1;
          }
  ...
  void a(akon paramakon, HttpMsg paramHttpMsg)
  {
    ...
    if ((paramakon != null) && (paramakon.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())) {
  ...
  public void a(HttpMsg paramHttpMsg, akon paramakon)
  {
    int i = 0;
    if ((paramHttpMsg != null) && (paramakon != null)) {
      try
      {
  ...
  /* Error */
  public void a(HttpMsg paramHttpMsg, akon paramakon, boolean paramBoolean)
  {
    // Byte code:
    //   0: aload_1
    ...
    //   71: aload_2
    //   72: aload_1
    //   73: invokevirtual 670	com/tencent/mobileqq/utils/httputils/HttpCommunicator:a	(Lakon;Lcom/tencent/mobileqq/utils/httputils/HttpMsg;)V
    //   76: aload_0
    //   77: aload_1
    ...
    //   135: aload_1
    //   136: aload_2
    //   137: invokespecial 687	akok:<init>	(Lcom/tencent/mobileqq/utils/httputils/HttpCommunicator;Lcom/tencent/mobileqq/utils/httputils/HttpMsg;Lakon;)V
    //   140: astore 26
    //   142: aload_0
    ...
    //   210: aload_2
    //   211: aload_1
    //   212: invokevirtual 670	com/tencent/mobileqq/utils/httputils/HttpCommunicator:a	(Lakon;Lcom/tencent/mobileqq/utils/httputils/HttpMsg;)V
    //   215: aload 25
    //   217: aload 32
    //   219: iload 5
    //   221: sipush 10240
    ...
    //   253: ifnull +13 -> 266
    //   256: aload_2
    //   257: getfield 610	akon:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   312: aload_2
    //   313: aload_1
    //   314: invokevirtual 670	com/tencent/mobileqq/utils/httputils/HttpCommunicator:a	(Lakon;Lcom/tencent/mobileqq/utils/httputils/HttpMsg;)V
    //   317: aload 24
    ...
    //   334: ifnull +231 -> 565
    //   337: aload_2
    //   338: getfield 610	akon:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   396: ifnull +13 -> 409
    //   399: aload_2
    //   400: getfield 610	akon:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   835: ifnull +13 -> 848
    //   838: aload_2
    //   839: getfield 610	akon:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   1151: ifnull +13 -> 1164
    //   1154: aload_2
    //   1155: getfield 610	akon:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   1654: ifnull +13 -> 1667
    //   1657: aload_2
    //   1658: getfield 610	akon:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   1871: ifnull +13 -> 1884
    //   1874: aload_2
    //   1875: getfield 610	akon:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   1996: ifnull +13 -> 2009
    //   1999: aload_2
    //   2000: getfield 610	akon:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   2311: aload_2
    //   2312: iconst_1
    //   2313: invokevirtual 872	com/tencent/mobileqq/utils/httputils/HttpCommunicator:a	(Lcom/tencent/mobileqq/utils/httputils/HttpMsg;Lakon;Z)V
    //   2316: iload 5
    //   2318: sipush 200
    ...
    //   2361: ifnull +13 -> 2374
    //   2364: aload_2
    //   2365: getfield 610	akon:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   2994: aload_2
    //   2995: aload_1
    //   2996: invokevirtual 670	com/tencent/mobileqq/utils/httputils/HttpCommunicator:a	(Lakon;Lcom/tencent/mobileqq/utils/httputils/HttpMsg;)V
    //   2999: lload 13
    //   3001: iload 7
    //   3003: i2l
    //   3004: ladd
    ...
    //   3524: ifnull +13 -> 3537
    //   3527: aload_2
    //   3528: getfield 610	akon:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   3957: aload_2
    //   3958: iconst_0
    //   3959: invokevirtual 872	com/tencent/mobileqq/utils/httputils/HttpCommunicator:a	(Lcom/tencent/mobileqq/utils/httputils/HttpMsg;Lakon;Z)V
    ...
    //   4053: ifnull +13 -> 4066
    //   4056: aload_2
    //   4057: getfield 610	akon:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   289	5018	15	l3	long
    //   2945	959	17	l4	long
    //   2953	1816	19	l5	long
    //   34	4999	21	bool1	boolean
    ...
    //   5171	73	30	localObject38	Object
  ...
  public void a(String paramString)
  {
    ...
    if (this.e < this.jdField_d_of_type_Int)
    {
      ...
      if (paramString != null)
      {
        arrayOfakon = this.jdField_a_of_type_ArrayOfAkon;
        j = arrayOfakon.length;
      }
    }
    for (;;)
    {
      ...
      if (i < j)
      {
        localakon = arrayOfakon[i];
        localHttpMsg = localakon.jdField_a_of_type_ComTencentMobileqqUtilsHttputilsHttpMsg;
        if (localakon.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) {
          break label268;
        }
        this.jdField_a_of_type_ComTencentMobileqqUtilsHttputilsHttpCommunicator$PriorityQueue.a(paramString);
        paramString.b();
        localakon.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(true);
        localakon.jdField_a_of_type_ComTencentMobileqqUtilsHttputilsHttpMsg = paramString;
        localakon.a(paramString);
        this.e += 1;
      ...
      for (;;)
      {
        return;
        label268:
        if ((!this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) || (!localakon.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) || (localHttpMsg == null) || (localHttpMsg.b() <= paramString.b())) {
          break;
        }
        localakon.a();
      }
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_MqqOsMqqHandler.post(new akom(this));
  }
  ...
  public void c()
  {
    ...
    akon[] arrayOfakon = this.jdField_a_of_type_ArrayOfAkon;
    int j = arrayOfakon.length;
    while (i < j)
    {
      arrayOfakon[i].sendEmptyMessage(1);
      i += 1;
    }
    this.jdField_a_of_type_ArrayOfAkon = null;
    this.e = 0;
