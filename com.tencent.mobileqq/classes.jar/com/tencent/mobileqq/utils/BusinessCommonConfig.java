  ...
  implements Manager
{
  ...
  public static boolean isResReady(String paramString1, SharedPreferences paramSharedPreferences, String paramString2, String paramString3, String paramString4)
  {
    ...
    for (;;)
    {
      ...
      if (!FileUtils.fileExists(paramString4))
      {
        ...
        if (AudioHelper.f())
        {
          paramSharedPreferences = anvx.a(2131700771) + paramString4 + "]";
          bool1 = bool2;
        }
      }
      else
  ...
  public static void onDownloadRequest(QQAppInterface paramQQAppInterface, Intent paramIntent)
  {
    ...
    default: 
      return;
    case 2: 
      apcx.a(paramQQAppInterface).a(paramQQAppInterface, str);
      return;
    case 1: 
      bczy.a();
      return;
  ...
  public <T extends ConfigInfo> Boolean decodeConfig(QQAppInterface paramQQAppInterface, int paramInt, Intent paramIntent, ConfigurationService.Config paramConfig)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          AudioHelper.c(anvx.a(2131700757) + paramInt);
      ...
      if (AudioHelper.e())
      {
        ...
        throw new IllegalArgumentException(anvx.a(2131700759));
        ...
        if (i < paramInt)
        {
          ...
          if (paramIntent != null)
          {
            ...
            if (localObject1 != null)
            {
              ...
              {
                localObject5 = ayym.a(((ByteStringMicro)localObject1).toByteArray());
              ...
              for (;;)
              {
                ...
                catch (UnsupportedEncodingException paramIntent)
                {
                  ...
                  try
                  {
                    AudioHelper.c(str + anvx.a(2131700748));
                  ...
                  localObject1 = anvx.a(2131700742) + paramIntent.getMessage();
                  paramIntent = null;
                  continue;
                }
                ...
                {
                  paramIntent.printStackTrace();
                  localObject1 = anvx.a(2131700745) + paramIntent.getMessage();
                  System.gc();
                  try
                  {
                    paramIntent = new String((byte[])localObject5, "UTF-8");
                  ...
                  {
                    paramIntent = null;
                    localObject2 = anvx.a(2131700740) + localThrowable1.getMessage();
                  }
                  continue;
                }
                ...
                localObject2 = anvx.a(2131700764);
                paramIntent = null;
                continue;
                paramIntent = ((ByteStringMicro)localObject2).toStringUtf8();
                localObject2 = anvx.a(2131700760);
              }
  ...
  public <T extends ConfigInfo> Boolean decodeConfig(QQAppInterface paramQQAppInterface, int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (localConfigHandler == null)
        {
          AudioHelper.c(anvx.a(2131700741) + paramInt);
          return Boolean.valueOf(false);
        }
  ...
  {
    this.mBroadcastReceiver = new bhcx(this, paramQQAppInterface);
