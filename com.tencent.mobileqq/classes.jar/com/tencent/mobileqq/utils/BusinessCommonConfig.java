  ...
  implements Manager
{
  ...
  public static boolean isResReady(String paramString1, SharedPreferences paramSharedPreferences, String paramString2, String paramString3, String paramString4)
  {
    ...
    for (;;)
    {
      ...
      return bool1;
      if (!bbdx.a(paramString4))
      {
        paramSharedPreferences = localObject;
        bool1 = bool2;
        if (AudioHelper.e())
        {
          paramSharedPreferences = ajya.a(2131701273) + paramString4 + "]";
          bool1 = bool2;
        }
      }
      else
  ...
  public static void onDownloadRequest(QQAppInterface paramQQAppInterface, Intent paramIntent)
  {
    ...
    default: 
      return;
    case 2: 
      akyx.a(paramQQAppInterface).a(paramQQAppInterface, str);
      return;
    case 1: 
      axgr.a();
      return;
  ...
  public <T extends ConfigInfo> Boolean decodeConfig(QQAppInterface paramQQAppInterface, int paramInt, Intent paramIntent, ConfigurationService.Config paramConfig)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          AudioHelper.c(ajya.a(2131701259) + paramInt);
      ...
      if (AudioHelper.d())
      {
        ...
        throw new IllegalArgumentException(ajya.a(2131701261));
        ...
        if (i < paramInt)
        {
          ...
          if (paramIntent != null)
          {
            ...
            if (localObject1 != null)
            {
              ...
              {
                localObject5 = augv.a(((ByteStringMicro)localObject1).toByteArray());
              ...
              for (;;)
              {
                ...
                catch (UnsupportedEncodingException paramIntent)
                {
                  ...
                  try
                  {
                    AudioHelper.c(str + ajya.a(2131701250));
                  ...
                  localObject1 = ajya.a(2131701244) + paramIntent.getMessage();
                  paramIntent = null;
                  continue;
                }
                ...
                {
                  paramIntent.printStackTrace();
                  localObject1 = ajya.a(2131701247) + paramIntent.getMessage();
                  System.gc();
                  try
                  {
                    paramIntent = new String((byte[])localObject5, "UTF-8");
                  ...
                  {
                    paramIntent = null;
                    localObject2 = ajya.a(2131701242) + localThrowable1.getMessage();
                  }
                  continue;
                }
                ...
                localObject2 = ajya.a(2131701266);
                paramIntent = null;
                continue;
                paramIntent = ((ByteStringMicro)localObject2).toStringUtf8();
                localObject2 = ajya.a(2131701262);
              }
  ...
  public <T extends ConfigInfo> Boolean decodeConfig(QQAppInterface paramQQAppInterface, int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (localConfigHandler == null)
        {
          AudioHelper.c(ajya.a(2131701243) + paramInt);
          return Boolean.valueOf(false);
        }
  ...
  {
    this.mBroadcastReceiver = new bbcs(this, paramQQAppInterface);
