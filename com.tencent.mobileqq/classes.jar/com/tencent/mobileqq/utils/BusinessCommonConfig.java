  ...
  implements Manager
{
  ...
  public static boolean isResReady(String paramString1, SharedPreferences paramSharedPreferences, String paramString2, String paramString3, String paramString4)
  {
    ...
    for (;;)
    {
      ...
      return bool1;
      if (!bbdj.a(paramString4))
      {
        paramSharedPreferences = localObject;
        bool1 = bool2;
        if (AudioHelper.e())
        {
          paramSharedPreferences = ajyc.a(2131701262) + paramString4 + "]";
          bool1 = bool2;
        }
      }
      else
  ...
  public static void onDownloadRequest(QQAppInterface paramQQAppInterface, Intent paramIntent)
  {
    ...
    default: 
      return;
    case 2: 
      akyy.a(paramQQAppInterface).a(paramQQAppInterface, str);
      return;
    case 1: 
      axgp.a();
      return;
  ...
  public <T extends ConfigInfo> Boolean decodeConfig(QQAppInterface paramQQAppInterface, int paramInt, Intent paramIntent, ConfigurationService.Config paramConfig)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          AudioHelper.c(ajyc.a(2131701248) + paramInt);
      ...
      if (AudioHelper.d())
      {
        ...
        throw new IllegalArgumentException(ajyc.a(2131701250));
        ...
        if (i < paramInt)
        {
          ...
          if (paramIntent != null)
          {
            ...
            if (localObject1 != null)
            {
              ...
              {
                localObject5 = augt.a(((ByteStringMicro)localObject1).toByteArray());
              ...
              for (;;)
              {
                ...
                catch (UnsupportedEncodingException paramIntent)
                {
                  ...
                  try
                  {
                    AudioHelper.c(str + ajyc.a(2131701239));
                  ...
                  localObject1 = ajyc.a(2131701233) + paramIntent.getMessage();
                  paramIntent = null;
                  continue;
                }
                ...
                {
                  paramIntent.printStackTrace();
                  localObject1 = ajyc.a(2131701236) + paramIntent.getMessage();
                  System.gc();
                  try
                  {
                    paramIntent = new String((byte[])localObject5, "UTF-8");
                  ...
                  {
                    paramIntent = null;
                    localObject2 = ajyc.a(2131701231) + localThrowable1.getMessage();
                  }
                  continue;
                }
                ...
                localObject2 = ajyc.a(2131701255);
                paramIntent = null;
                continue;
                paramIntent = ((ByteStringMicro)localObject2).toStringUtf8();
                localObject2 = ajyc.a(2131701251);
              }
  ...
  public <T extends ConfigInfo> Boolean decodeConfig(QQAppInterface paramQQAppInterface, int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (localConfigHandler == null)
        {
          AudioHelper.c(ajyc.a(2131701232) + paramInt);
          return Boolean.valueOf(false);
        }
  ...
  {
    this.mBroadcastReceiver = new bbce(this, paramQQAppInterface);
