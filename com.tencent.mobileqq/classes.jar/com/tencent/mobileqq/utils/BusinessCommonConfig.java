  ...
  implements Manager
{
  ...
  public static boolean isResReady(String paramString1, SharedPreferences paramSharedPreferences, String paramString2, String paramString3, String paramString4)
  {
    ...
    for (;;)
    {
      ...
      return bool1;
      if (!bgmg.a(paramString4))
      {
        paramSharedPreferences = localObject;
        bool1 = bool2;
        if (AudioHelper.f())
        {
          paramSharedPreferences = anni.a(2131700078) + paramString4 + "]";
          bool1 = bool2;
        }
      }
      else
  ...
  public static void onDownloadRequest(QQAppInterface paramQQAppInterface, Intent paramIntent)
  {
    ...
    default: 
      return;
    case 2: 
      aost.a(paramQQAppInterface).a(paramQQAppInterface, str);
      return;
    case 1: 
      bchg.a();
      return;
  ...
  public <T extends ConfigInfo> Boolean decodeConfig(QQAppInterface paramQQAppInterface, int paramInt, Intent paramIntent, ConfigurationService.Config paramConfig)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          AudioHelper.c(anni.a(2131700064) + paramInt);
      ...
      if (AudioHelper.e())
      {
        ...
        throw new IllegalArgumentException(anni.a(2131700066));
        ...
        if (i < paramInt)
        {
          ...
          if (paramIntent != null)
          {
            ...
            if (localObject1 != null)
            {
              ...
              {
                localObject5 = ayma.a(((ByteStringMicro)localObject1).toByteArray());
              ...
              for (;;)
              {
                ...
                catch (UnsupportedEncodingException paramIntent)
                {
                  ...
                  try
                  {
                    AudioHelper.c(str + anni.a(2131700055));
                  ...
                  localObject1 = anni.a(2131700049) + paramIntent.getMessage();
                  paramIntent = null;
                  continue;
                }
                ...
                {
                  paramIntent.printStackTrace();
                  localObject1 = anni.a(2131700052) + paramIntent.getMessage();
                  System.gc();
                  try
                  {
                    paramIntent = new String((byte[])localObject5, "UTF-8");
                  ...
                  {
                    paramIntent = null;
                    localObject2 = anni.a(2131700047) + localThrowable1.getMessage();
                  }
                  continue;
                }
                ...
                localObject2 = anni.a(2131700071);
                paramIntent = null;
                continue;
                paramIntent = ((ByteStringMicro)localObject2).toStringUtf8();
                localObject2 = anni.a(2131700067);
              }
  ...
  public <T extends ConfigInfo> Boolean decodeConfig(QQAppInterface paramQQAppInterface, int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (localConfigHandler == null)
        {
          AudioHelper.c(anni.a(2131700048) + paramInt);
          return Boolean.valueOf(false);
        }
  ...
  {
    this.mBroadcastReceiver = new bgky(this, paramQQAppInterface);
