  ...
  implements Manager
{
  ...
  public static boolean isResReady(String paramString1, SharedPreferences paramSharedPreferences, String paramString2, String paramString3, String paramString4)
  {
    ...
    for (;;)
    {
      ...
      return bool1;
      if (!bace.a(paramString4))
      {
        paramSharedPreferences = localObject;
        bool1 = bool2;
        if (AudioHelper.e())
        {
          paramSharedPreferences = ajjy.a(2131635478) + paramString4 + "]";
          bool1 = bool2;
        }
      }
      else
  ...
  public static void onDownloadRequest(QQAppInterface paramQQAppInterface, Intent paramIntent)
  {
    ...
    default: 
      return;
    case 2: 
      akkm.a(paramQQAppInterface).a(paramQQAppInterface, str);
      return;
    case 1: 
      awhj.a();
      return;
  ...
  public <T extends ConfigInfo> Boolean decodeConfig(QQAppInterface paramQQAppInterface, int paramInt, Intent paramIntent, ConfigurationService.Config paramConfig)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          AudioHelper.c(ajjy.a(2131635464) + paramInt);
      ...
      if (AudioHelper.d())
      {
        ...
        throw new IllegalArgumentException(ajjy.a(2131635466));
        ...
        if (i < paramInt)
        {
          ...
          if (paramIntent != null)
          {
            ...
            if (localObject1 != null)
            {
              ...
              {
                localObject5 = atiu.a(((ByteStringMicro)localObject1).toByteArray());
              ...
              for (;;)
              {
                ...
                catch (UnsupportedEncodingException paramIntent)
                {
                  ...
                  try
                  {
                    AudioHelper.c(str + ajjy.a(2131635455));
                  ...
                  localObject1 = ajjy.a(2131635449) + paramIntent.getMessage();
                  paramIntent = null;
                  continue;
                }
                ...
                {
                  paramIntent.printStackTrace();
                  localObject1 = ajjy.a(2131635452) + paramIntent.getMessage();
                  System.gc();
                  try
                  {
                    paramIntent = new String((byte[])localObject5, "UTF-8");
                  ...
                  {
                    paramIntent = null;
                    localObject2 = ajjy.a(2131635447) + localThrowable1.getMessage();
                  }
                  continue;
                }
                ...
                localObject2 = ajjy.a(2131635471);
                paramIntent = null;
                continue;
                paramIntent = ((ByteStringMicro)localObject2).toStringUtf8();
                localObject2 = ajjy.a(2131635467);
              }
  ...
  public <T extends ConfigInfo> Boolean decodeConfig(QQAppInterface paramQQAppInterface, int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (localConfigHandler == null)
        {
          AudioHelper.c(ajjy.a(2131635448) + paramInt);
          return Boolean.valueOf(false);
        }
  ...
  {
    this.mBroadcastReceiver = new baba(this, paramQQAppInterface);
