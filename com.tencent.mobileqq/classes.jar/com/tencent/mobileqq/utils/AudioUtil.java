...
public class AudioUtil
{
    ...
    for (;;)
    {
      ...
      if (paramInt1 != AppSetting.e)
      {
        ...
        if (jdField_a_of_type_AndroidMediaMediaPlayer != null)
        {
          ...
          jdField_a_of_type_AndroidMediaMediaPlayer.setOnCompletionListener(new akbq(paramOnCompletionListener, paramHandler));
      ...
      continue;
      label154:
      paramHandler.post(new akbs(paramOnCompletionListener));
    }
  }
  ...
  public static void a(int paramInt, boolean paramBoolean)
  {
    for (;;)
    {
      ...
      jdField_a_of_type_AndroidMediaMediaPlayer.setOnCompletionListener(new akbo());
      jdField_a_of_type_AndroidMediaMediaPlayer.start();
  ...
  public static void a(Uri paramUri, int paramInt, MediaPlayer.OnCompletionListener paramOnCompletionListener)
  {
    ...
    //   263: dup
    //   264: aload_2
    //   265: invokespecial 279	akbu:<init>	(Landroid/media/MediaPlayer$OnCompletionListener;)V
    ...
    //   356: ifnull +7 -> 363
    //   359: aload_2
    //   360: invokevirtual 276	java/io/FileInputStream:close	()V
    //   363: aload_0
    //   364: athrow
    //   365: astore_2
    //   366: aload_2
    //   367: invokevirtual 243	java/io/IOException:printStackTrace	()V
    //   370: goto -7 -> 363
    //   373: astore 4
    //   375: aload_0
    //   376: astore_2
  ...
  public static void a(Uri paramUri, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    //   126: new 287	akbt
    //   129: dup
    //   130: invokespecial 288	akbt:<init>	()V
  ...
  public static void a(java.lang.String paramString, boolean paramBoolean)
  {
    ...
    //   143: new 295	akbn
    //   146: dup
    //   147: invokespecial 296	akbn:<init>	()V
  ...
  public static void b(int paramInt, boolean paramBoolean)
  {
    for (;;)
    {
      ...
      jdField_a_of_type_AndroidMediaMediaPlayer.setOnCompletionListener(new akbp());
      jdField_a_of_type_AndroidMediaMediaPlayer.start();
      jdField_a_of_type_AndroidMediaMediaPlayer.setLooping(paramBoolean);
    }
  }
