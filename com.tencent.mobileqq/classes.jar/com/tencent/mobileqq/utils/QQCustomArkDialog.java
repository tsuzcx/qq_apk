  ...
  extends QQCustomDialogWtihEmoticonInput
{
  ...
  private ArkAppContainer a(QQCustomArkDialog.AppInfo paramAppInfo, Bundle paramBundle)
  {
    ...
    if (ArkFullScreenAppActivity.a(paramBundle))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppContainer.setFixSize(this.jdField_e_of_type_Int, this.jdField_f_of_type_Int);
    }
    for (;;)
    {
  ...
  public static String a(Bundle paramBundle, String paramString)
  {
    ...
    try
    {
      ...
      {
        str1 = str3;
        if (str3.contains(HardCodeUtil.a(2131710167))) {
          str1 = str3.replace(HardCodeUtil.a(2131710171), "");
        }
      }
    ...
    for (;;)
    {
      ...
      FileUtils.d(str6, paramString + File.separator + str1);
  ...
  public void a()
  {
    ((LinearLayout)findViewById(2131369153)).setVisibility(8);
  }
  ...
  public void a(Context paramContext, Bundle paramBundle)
  {
    try
    {
      ...
      Object localObject1 = localView.findViewById(2131363025);
      ...
      if (this.bodyLayout != null)
      {
        ...
        ((RelativeLayout.LayoutParams)localObject1).topMargin = ((int)paramContext.getResources().getDimension(2131296922));
        ((RelativeLayout.LayoutParams)localObject1).leftMargin = ((int)paramContext.getResources().getDimension(2131296893));
        ((RelativeLayout.LayoutParams)localObject1).rightMargin = ((int)paramContext.getResources().getDimension(2131296894));
        ((RelativeLayout.LayoutParams)localObject1).bottomMargin = ((int)paramContext.getResources().getDimension(2131296918));
      }
      if (!bool1)
      {
        ...
        i = paramContext.getResources().getDimensionPixelSize(2131296917);
  ...
  public void a(String paramString)
  {
    ...
    ((TextView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131380828)).setText(paramString);
  }
