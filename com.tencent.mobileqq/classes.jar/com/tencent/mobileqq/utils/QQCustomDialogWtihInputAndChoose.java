  ...
  implements View.OnClickListener
{
  ...
  public QQCustomDialogWtihInputAndChoose(Context paramContext, int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new ajqt(this);
  ...
  public void a(int paramInt)
  {
    if (this.jdField_a_of_type_AndroidWidgetEditText != null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new ajqu(this, paramInt));
    }
  }
  ...
  void a(Context paramContext)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityQwalletWidgetMyLinearLayout.findViewById(2131364064).setOnClickListener(this);
    this.jdField_a_of_type_ComTencentMobileqqActivityQwalletWidgetMyLinearLayout.setDispatchKeyEventListener(new ajqv(this));
  }
  ...
  public void a(ArrayList paramArrayList)
  {
    ...
    LinearLayout localLinearLayout = (LinearLayout)this.jdField_a_of_type_ComTencentMobileqqActivityQwalletWidgetMyLinearLayout.findViewById(2131364065);
    ...
    while (i < paramArrayList.size())
    {
      ...
      ((TextView)localView.findViewById(2131364066)).setText((CharSequence)paramArrayList.get(i));
  ...
  public void onClick(View paramView)
  {
    if (paramView.getId() == 2131364063)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqActivityQwalletWidgetMyLinearLayout != null)
      {
        ...
        {
          a();
          this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130844000);
          this.jdField_a_of_type_AndroidWidgetImageView.setTag(Integer.valueOf(2130844000));
          this.jdField_a_of_type_AndroidOsHandler.postDelayed(new ajqw(this), 200L);
        }
      }
      else {
        return;
      ...
      if ((paramView != null) && ((paramView instanceof Integer)) && (((Integer)paramView).intValue() == 2130844422))
      {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130844422);
      this.jdField_a_of_type_AndroidWidgetImageView.setTag(Integer.valueOf(2130844422));
      this.jdField_a_of_type_AndroidOsHandler.postDelayed(new ajqx(this), 200L);
      return;
    }
    if (paramView.getId() == 2131364064)
    {
      a();
      return;
    }
  ...
  public void setContentView(int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131364008));
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)findViewById(2131363479));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131364063));
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this);
    findViewById(2131364049).setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetEditText.setSingleLine(this.jdField_a_of_type_Boolean);
    this.jdField_a_of_type_AndroidWidgetEditText.setOnTouchListener(new ajqs(this));
  ...
  {
    TextView localTextView = (TextView)findViewById(2131364062);
  ...
  public QQCustomDialog setNegativeButton(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.lBtn.setOnClickListener(new ajqz(this, paramOnClickListener));
    setSeperatorState();
    return this;
  }
  ...
  public QQCustomDialog setPositiveButton(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.rBtn.setOnClickListener(new ajra(this, paramOnClickListener));
    setSeperatorState();
    return this;
  }
