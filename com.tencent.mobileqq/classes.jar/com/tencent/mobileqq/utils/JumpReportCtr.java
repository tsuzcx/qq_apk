...
public class JumpReportCtr
{
  ...
  JumpAction jdField_a_of_type_ComTencentMobileqqUtilsJumpAction = null;
  ...
  public void a(Intent paramIntent)
  {
    ...
    return;
    String str;
    if (this.jdField_a_of_type_ComTencentMobileqqUtilsJumpAction != null)
    {
      str = this.jdField_a_of_type_ComTencentMobileqqUtilsJumpAction.jdField_b_of_type_JavaLangString;
      paramIntent = this.jdField_a_of_type_ComTencentMobileqqUtilsJumpAction.jdField_c_of_type_JavaLangString;
    }
    for (;;)
    {
  ...
  public void a(QQAppInterface paramQQAppInterface, Activity paramActivity, Intent paramIntent)
  {
    ...
    if (this.jdField_c_of_type_Boolean)
    {
      if ((this.d.equals("android.intent.action.SEND")) || (this.d.equals("android.intent.action.SEND_MULTIPLE")))
      {
    ...
    label340:
    for (paramQQAppInterface = this.g;; paramQQAppInterface = this.d + "/shareContext:" + this.jdField_a_of_type_JavaLangString)
    {
      paramActivity.reportSchemaInfo(paramIntent, paramQQAppInterface);
      return;
      label242:
      ...
      if (!(paramQQAppInterface instanceof ArrayList)) {
        break;
      }
      this.jdField_a_of_type_JavaLangString = "MULTIPLE_SHARE";
      break;
      if ((TextUtils.isEmpty(this.g)) || (paramQQAppInterface == null)) {
        break;
      }
      this.jdField_a_of_type_ComTencentMobileqqUtilsJumpAction = JumpParser.a(paramQQAppInterface, paramActivity, this.g);
      break;
    }
  }
