  ...
  implements AppConstants
{
  public static MessageRecord a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, AbsStructMsg paramAbsStructMsg)
  {
    ...
    try
    {
      ...
      paramString = MessageRecordFactory.c(paramQQAppInterface, str, paramString, str, paramInt, i, paramAbsStructMsg);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt, AbsStructMsg paramAbsStructMsg, BusinessObserver paramBusinessObserver, String paramString2, String paramString3)
  {
    ...
    paramAbsStructMsg = MessageRecordFactory.c(paramQQAppInterface, (String)localObject, paramString1, paramBusinessObserver, paramInt, l, paramAbsStructMsg);
    paramBusinessObserver = TeamWorkConstants.j;
  ...
  public static Intent b(Context paramContext, int paramInt1, int paramInt2, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, String paramString9, String paramString10, String paramString11, String paramString12, String paramString13, String paramString14, String paramString15, String paramString16, String paramString17, String paramString18, Intent paramIntent, int paramInt3, String paramString19, long paramLong)
  {
    ...
    if (bool)
    {
      ...
      {
        paramIntent.putExtra("strurt_msgid", ((SwiftBrowserShareMenuHandler)paramString2.getComponentProvider().a(4)).o);
    ...
    if (paramString1 != null)
    {
      ...
      if (((1001 == paramInt1) || (38 == paramInt1)) && (bool))
      {
        ...
        if (paramContext != null)
        {
          ...
          paramIntent.putExtra("strurt_msgid", paramString1.o);
          paramIntent.putExtra("struct_uin", paramString1.n);
          paramIntent.putExtra("struct_url", paramContext.getUrl());
          paramIntent.putExtra("from_web", true);
          if ((paramString1.p != null) && (!"".equals(paramString1.p))) {
            paramIntent.putExtra("source_puin", paramString1.p);
          }
        }
      }
      return paramIntent;
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt, AbsStructMsg paramAbsStructMsg, BusinessObserver paramBusinessObserver)
  {
    ...
    case 1005: 
      ...
      if (paramAbsStructMsg.mMsgServiceID == 1)
      {
        ...
        MobileQQService.seq = i + 1;
        paramString1 = MessageRecordFactory.c(paramQQAppInterface, paramString2, paramString1, paramString2, paramInt, i, paramAbsStructMsg);
    ...
    case 1006: 
      ...
      for (;;)
      {
        ...
        if (paramAbsStructMsg.mMsgServiceID == 118)
        {
          ...
          paramString2 = MessageRecordFactory.b(paramQQAppInterface, paramBusinessObserver, paramString1, paramString2, paramInt, l, paramAbsStructMsg);
        }
        else
        {
          if (TextUtils.isEmpty(paramString2)) {
          ...
          paramString2 = MessageRecordFactory.c(paramQQAppInterface, paramBusinessObserver, paramString1, paramString2, paramInt, l, paramAbsStructMsg);
        }
      }
      if (paramAbsStructMsg.mMsgServiceID == 41)
      {
      ...
      if (paramAbsStructMsg.mMsgServiceID == 100)
      {
        ...
        paramString1 = MessageRecordFactory.c(paramQQAppInterface, paramBusinessObserver, paramString1, paramBusinessObserver, paramInt, l, paramAbsStructMsg);
