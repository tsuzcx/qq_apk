  ...
  implements AppConstants
{
    ...
    if (paramString1 != null)
    {
      ...
      do
      {
        do
        {
          ...
          {
            return localIntent;
          } while (((1001 != paramInt1) && (38 != paramInt1)) || (!(paramContext instanceof SwiftWebViewFragmentSupporter)));
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt, AbsStructMsg paramAbsStructMsg, BusinessObserver paramBusinessObserver, String paramString2, String paramString3)
  {
    ...
    {
      paramAbsStructMsg = MessageRecordFactory.a(paramQQAppInterface, str, paramString1, paramBusinessObserver, paramInt, l, paramAbsStructMsg);
      QLog.i(TeamWorkConstants.i, 1, "sendDocsStructingMsg. disUin = " + paramString1 + ", disUinType = " + paramInt + ", seq = " + l + ", shmsgseq = " + paramAbsStructMsg.shmsgseq + ", time = " + paramAbsStructMsg.time);
      paramQQAppInterface.getMessageFacade().a(paramAbsStructMsg, null);
      if ((paramInt != 0) && (paramInt != 1)) {
        break;
      }
      TeamWorkUtils.a(paramQQAppInterface, paramString1, paramInt, paramAbsStructMsg.shmsgseq, paramAbsStructMsg.time + 1L, paramString2, paramString3);
      return;
    }
  }
