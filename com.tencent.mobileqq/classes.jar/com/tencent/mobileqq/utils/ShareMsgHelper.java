  ...
  implements AppConstants
{
  ...
  {
    ThreadManager.post(new aknr(paramQQAppInterface, paramString, paramInt, paramAbsStructMsg, paramBusinessObserver), 8, null, false);
  }
  ...
  {
    ThreadManager.getSubThreadHandler().post(new akns(paramQQAppInterface, paramString1, paramString2, paramInt, paramAbsStructMsg, paramBusinessObserver));
  }
    ...
    do
    {
      do
      {
        ...
        if (paramAbsStructMsg.mMsgServiceID == 100)
        {
          ...
          paramQQAppInterface.a().a(paramString1, new aknt());
          return;
        }
