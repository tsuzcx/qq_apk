...
public class JumpAction$16
  implements Runnable
{
  public JumpAction$16(bddb parambddb, String paramString, long paramLong, HashMap paramHashMap) {}
  
  public void run()
  {
    String str1 = bdcs.a(this.this$0.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangString, "opensdk_tmp");
    if (!TextUtils.isEmpty(str1)) {}
    try
    {
      String str2 = new String(bdbi.encode(str1.getBytes("UTF-8"), 0));
      this.this$0.jdField_a_of_type_JavaUtilHashMap.put("file_data", str2);
      long l = System.currentTimeMillis() - this.jdField_a_of_type_Long;
      arzy.a("KEY_STAGE_1_SAVE_IMAGE", l, this.jdField_a_of_type_JavaUtilHashMap, true);
