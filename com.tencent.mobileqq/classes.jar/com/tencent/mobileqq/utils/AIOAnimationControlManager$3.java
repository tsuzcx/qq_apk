  ...
  implements Comparator<AIOAnimationControlManager.IAnimationMessage>
{
  ...
  public int a(AIOAnimationControlManager.IAnimationMessage paramIAnimationMessage1, AIOAnimationControlManager.IAnimationMessage paramIAnimationMessage2)
  {
    ...
    for (;;)
    {
      ...
      if ((paramIAnimationMessage1.receiverUin == this.a.p.getLongAccountUin()) && (paramIAnimationMessage2.receiverUin == this.a.p.getLongAccountUin()))
      {
        l1 = paramIAnimationMessage1.time;
        l2 = paramIAnimationMessage2.time;
      }
      ...
      {
        if (paramIAnimationMessage1.receiverUin == this.a.p.getLongAccountUin()) {
          return -1;
        }
        if (paramIAnimationMessage2.receiverUin == this.a.p.getLongAccountUin()) {
          return 1;
        }
        l1 = paramIAnimationMessage1.time;
        l2 = paramIAnimationMessage2.time;
 ...
 * Qualified Name:     com.tencent.mobileqq.utils.AIOAnimationControlManager.3
