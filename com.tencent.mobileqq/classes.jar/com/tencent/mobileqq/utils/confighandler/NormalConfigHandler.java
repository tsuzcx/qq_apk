  ...
  extends ConfigHandler<T>
{
  ...
  private SharedPreferences getSP()
  {
    ...
    return bhuj.a(this.TAG, this.mUin, this.mSPName);
  }
  ...
  public T getConfig()
  {
    if ((this.mConfig == null) && (AudioHelper.e()))
    {
      ...
      throw new IllegalArgumentException(anzj.a(2131706472));
    }
    return this.mConfig;
  }
  ...
  public ReadConfigTask<T> syncGetConfigInfo(AppInterface paramAppInterface, NormalConfigHandler.GetConfigListen<T> paramGetConfigListen)
  {
    ...
    if (((ReadConfigTask)localObject1).isNeedRunTask())
    {
      ...
      bhss.requestSyncTask(null, (ArrayList)localObject2, new bhug(this, paramGetConfigListen, paramAppInterface));
      return localObject1;
    }
