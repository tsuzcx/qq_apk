  ...
  extends ConfigHandler<T>
{
  ...
  private SharedPreferences getSP()
  {
    ...
    return bdky.a(this.TAG, this.mUin, this.mSPName);
  }
  ...
  public T getConfig()
  {
    if ((this.mConfig == null) && (AudioHelper.d()))
    {
      ...
      throw new IllegalArgumentException(alpo.a(2131707976));
    }
    return this.mConfig;
  }
  ...
  public ReadConfigTask<T> syncGetConfigInfo(AppInterface paramAppInterface, NormalConfigHandler.GetConfigListen<T> paramGetConfigListen)
  {
    ...
    if (((ReadConfigTask)localObject1).isNeedRunTask())
    {
      ...
      bdjf.requestSyncTask(null, (ArrayList)localObject2, new bdkv(this, paramGetConfigListen, paramAppInterface));
      return localObject1;
    }
