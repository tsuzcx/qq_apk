...
public class AntiFraudConfigFileUtil
{
  ...
  private void b(String paramString)
  {
    ...
    //   52: astore 8
    //   54: aload_0
    //   55: getfield 15	com/tencent/mobileqq/utils/AntiFraudConfigFileUtil:jdField_a_of_type_AndroidOsBundle	Landroid/os/Bundle;
    //   58: aload 6
    ...
    //   181: ifne +303 -> 484
    //   184: new 19	android/os/Bundle
    //   187: dup
    //   188: invokespecial 20	android/os/Bundle:<init>	()V
    //   191: astore 7
    //   193: aload 5
    //   195: astore_1
    //   196: aload 5
    ...
    //   217: aload_0
    //   218: iload_3
    //   219: putfield 17	com/tencent/mobileqq/utils/AntiFraudConfigFileUtil:jdField_a_of_type_Int	I
    //   222: aload 8
    //   224: ldc 239
    ...
    //   265: astore 5
    //   267: new 19	android/os/Bundle
    //   270: dup
    //   271: invokespecial 20	android/os/Bundle:<init>	()V
    //   274: astore 8
    //   276: aload 9
    //   278: ldc 241
    ...
    //   311: astore 11
    //   313: new 19	android/os/Bundle
    //   316: dup
    //   317: invokespecial 20	android/os/Bundle:<init>	()V
    //   320: astore 12
    //   322: aload_0
    //   323: aload 12
    //   325: aload 5
    ...
    //   387: astore 9
    //   389: new 19	android/os/Bundle
    //   392: dup
    //   393: invokespecial 20	android/os/Bundle:<init>	()V
    //   396: astore 10
    //   398: aload_0
    //   399: aload 10
    //   401: aload 5
    ...
    //   430: goto -196 -> 234
    //   433: aload_0
    //   434: getfield 15	com/tencent/mobileqq/utils/AntiFraudConfigFileUtil:jdField_a_of_type_AndroidOsBundle	Landroid/os/Bundle;
    //   437: aload 6
    //   439: aload 7
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3)
  {
    ...
    //   10: aload_1
    //   11: aload_0
    //   12: getfield 29	com/tencent/mobileqq/utils/AntiFraudConfigFileUtil:jdField_a_of_type_ComTencentMobileqqAppSecSvcObserver	Lcom/tencent/mobileqq/app/SecSvcObserver;
    ...
    //   67: iflt -42 -> 25
    //   70: aload_1
    //   71: getstatic 340	com/tencent/mobileqq/app/BusinessHandlerFactory:SEC_SVC_HANDLER	Ljava/lang/String;
    //   74: invokevirtual 344	com/tencent/mobileqq/app/QQAppInterface:getBusinessHandler	(Ljava/lang/String;)Lcom/tencent/mobileqq/app/BusinessHandler;
    //   77: checkcast 346	com/tencent/mobileqq/app/SecSvcHandler
    //   80: aload_2
    //   81: invokevirtual 347	com/tencent/mobileqq/app/SecSvcHandler:a	(Ljava/lang/String;)V
    //   84: return
    //   85: aload_2
    //   86: ldc_w 312
    ...
    //   95: aload_0
    //   96: aload_2
    //   97: invokevirtual 354	com/tencent/mobileqq/utils/AntiFraudConfigFileUtil:b	(Ljava/lang/String;)Ljava/lang/String;
    //   100: astore 12
    //   102: aload_0
    //   103: ldc_w 312
    //   106: invokevirtual 173	com/tencent/mobileqq/utils/AntiFraudConfigFileUtil:a	(Ljava/lang/String;)Ljava/lang/String;
    //   109: astore 15
    //   111: aload 12
    //   113: invokestatic 79	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   116: istore 10
    //   118: aload_0
    //   119: getfield 17	com/tencent/mobileqq/utils/AntiFraudConfigFileUtil:jdField_a_of_type_Int	I
    //   122: iconst_m1
    ...
    //   135: aload_0
    //   136: aload 15
    //   138: invokevirtual 356	com/tencent/mobileqq/utils/AntiFraudConfigFileUtil:a	(Ljava/lang/String;)I
    //   141: putfield 17	com/tencent/mobileqq/utils/AntiFraudConfigFileUtil:jdField_a_of_type_Int	I
    //   144: aload_0
    //   145: getfield 17	com/tencent/mobileqq/utils/AntiFraudConfigFileUtil:jdField_a_of_type_Int	I
    //   148: iconst_2
    //   149: if_icmpge +6 -> 155
    //   152: iconst_1
    //   153: istore 10
    ...
    //   166: invokevirtual 360	com/tencent/qphone/base/util/BaseApplication:getAssets	()Landroid/content/res/AssetManager;
    //   169: ldc_w 362
    //   172: invokevirtual 368	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   175: astore_1
    //   176: new 370	java/io/FileOutputStream
    //   179: dup
    //   180: aload 15
    //   182: invokespecial 371	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   185: astore 11
    //   187: sipush 4096
    //   190: newarray byte
    //   192: astore_2
    ...
    //   234: ifnull +7 -> 241
    //   237: aload_2
    //   238: invokevirtual 386	java/io/InputStream:close	()V
    //   241: aload_1
    //   242: ifnull +7 -> 249
    //   245: aload_1
    //   246: invokevirtual 387	java/io/OutputStream:close	()V
    //   249: aload 12
    //   251: astore_1
    //   252: aload 15
    //   254: invokestatic 390	com/tencent/mobileqq/filemanager/util/FileUtil:a	(Ljava/lang/String;)Z
    //   257: ifeq +27 -> 284
    //   260: aload 15
    //   262: invokestatic 395	com/tencent/mobileqq/utils/SecUtil:getFileMd5	(Ljava/lang/String;)Ljava/lang/String;
    //   265: astore_1
    //   266: aload_0
    //   267: ldc_w 312
    //   270: aload_1
    //   271: invokevirtual 397	com/tencent/mobileqq/utils/AntiFraudConfigFileUtil:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   274: aload_0
    //   275: aload_0
    //   276: aload 15
    //   278: invokevirtual 356	com/tencent/mobileqq/utils/AntiFraudConfigFileUtil:a	(Ljava/lang/String;)I
    //   281: putfield 17	com/tencent/mobileqq/utils/AntiFraudConfigFileUtil:jdField_a_of_type_Int	I
    //   284: aload_1
    //   285: aload 4
    ...
    //   304: aload 4
    //   306: aload_3
    //   307: invokevirtual 400	com/tencent/mobileqq/utils/AntiFraudConfigFileUtil:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   310: return
    //   311: aload_1
    //   312: ifnull +7 -> 319
    //   315: aload_1
    //   316: invokevirtual 386	java/io/InputStream:close	()V
    //   319: aload 11
    //   321: ifnull -72 -> 249
    //   324: aload 11
    //   326: invokevirtual 387	java/io/OutputStream:close	()V
    //   329: goto -80 -> 249
    //   332: astore_1
    //   333: aload_1
    //   334: invokevirtual 401	java/io/IOException:printStackTrace	()V
    //   337: goto -88 -> 249
    //   340: astore_1
    //   341: aload_1
    //   342: invokevirtual 401	java/io/IOException:printStackTrace	()V
    //   345: goto -96 -> 249
    //   348: astore_2
    //   349: aconst_null
    //   350: astore_1
    ...
    //   355: ifnull +7 -> 362
    //   358: aload_1
    //   359: invokevirtual 386	java/io/InputStream:close	()V
    //   362: aload_3
    //   363: ifnull +7 -> 370
    //   366: aload_3
    //   367: invokevirtual 387	java/io/OutputStream:close	()V
    //   370: aload_2
    //   371: athrow
    //   372: astore_1
    //   373: aload_1
    //   374: invokevirtual 401	java/io/IOException:printStackTrace	()V
    //   377: goto -7 -> 370
    //   380: astore_2
    //   381: aload 13
    //   383: astore_3
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	431	0	this	AntiFraudConfigFileUtil
