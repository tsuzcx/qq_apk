  ...
  public static String a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, int paramInt, String paramString2)
  {
    ...
    do
    {
      ...
      if (AppConstants.F.equals(paramString1)) {
        return paramContext.getString(2131434926);
      }
      if (AppConstants.H.equals(paramString1)) {
        return paramContext.getString(2131434924);
      }
      if (AppConstants.D.equals(paramString1)) {
        return paramContext.getString(2131434965);
      }
      if (paramInt != 1000) {
        break;
      }
  ...
  public static ArrayList a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (j >= 3)
    {
      ...
      if (j >= 3)
      {
        ...
        ((SpannableStringBuilder)localObject2).setSpan(new ForegroundColorSpan(BaseApplicationImpl.sApplication.getResources().getColor(2131494298)), 0, paramString.length(), 17);
          ...
          if (localArrayList.size() < i)
          {
            ...
            for (paramString = "null";; paramString = paramString.a())
            {
              ...
              if (((String)localObject1).toLowerCase().startsWith(paramString.toLowerCase()))
              {
                ...
                ((SpannableStringBuilder)localObject3).setSpan(new ForegroundColorSpan(BaseApplicationImpl.sApplication.getResources().getColor(2131494298)), 1, paramString.length() + 1, 17);
              ...
              if (localObject3[0] == 0)
              {
                i = localObject3[1];
                localObject2 = new SpannableStringBuilder((CharSequence)localObject2);
                ((SpannableStringBuilder)localObject2).setSpan(new ForegroundColorSpan(BaseApplicationImpl.sApplication.getResources().getColor(2131494298)), 0, i, 17);
                localArrayList.add(new SQLiteFTSUtils.MsgSearchContactInfo((String)localObject1, 0, new Pair(localObject2, null)));
                i = m + 1;
                break label193;
              }
