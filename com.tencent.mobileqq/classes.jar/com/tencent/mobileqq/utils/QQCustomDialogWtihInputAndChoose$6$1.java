  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (k - n > 0)
    {
      ...
      {
        localObject1 = (LinearLayout)this.a.this$0.jdField_a_of_type_ComTencentMobileqqActivityQwalletWidgetMyLinearLayout.findViewById(2131303599);
        if ((localObject1 != null) && (((LinearLayout)localObject1).getChildCount() > 0))
        {
          localObject1 = ((LinearLayout)localObject1).getChildAt(0);
          localObject2 = (TextView)((View)localObject1).findViewById(2131303598);
          if (((TextView)localObject2).getText() != null) {
            this.a.this$0.a(((TextView)localObject2).getText().toString());
          }
          localObject1 = ((View)localObject1).findViewById(2131303597);
