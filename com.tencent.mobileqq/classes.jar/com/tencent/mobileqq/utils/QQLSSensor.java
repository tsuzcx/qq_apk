...
public class QQLSSensor
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new ajri(this, Looper.getMainLooper());
  ...
  {
    this.jdField_a_of_type_AndroidHardwareSensorEventListener = new ajrh(this);
