...
public class QQRecorder
{
  ...
  public void a()
  {
    if ((this.jdField_a_of_type_Akne != null) && (this.jdField_a_of_type_Akne.a())) {}
    synchronized (this.jdField_a_of_type_Akne)
    {
      this.jdField_a_of_type_Akne.jdField_b_of_type_Boolean = false;
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("ChatActivity", 2, "thread is:" + this.jdField_a_of_type_Akne + ",time is:" + System.currentTimeMillis());
    }
    if (this.jdField_a_of_type_AndroidMediaAudioManager != null) {}
    try
    {
    ...
    catch (Exception localException)
    {
      ...
      synchronized (this.jdField_a_of_type_Akne)
      {
        this.jdField_a_of_type_Akne.jdField_b_of_type_Boolean = true;
        this.jdField_a_of_type_Akne.jdField_a_of_type_JavaLangString = paramString;
        try
        {
          notifyAll();
          return;
    ...
    if ((this.jdField_a_of_type_Akne == null) || (!this.jdField_a_of_type_Akne.a()))
    {
      ...
      this.jdField_a_of_type_Akne = new akne(this);
      this.jdField_a_of_type_Akne.jdField_a_of_type_JavaLangString = paramString;
  ...
  public boolean a()
  {
    return (this.jdField_a_of_type_Akne != null) && (this.jdField_a_of_type_Akne.jdField_a_of_type_Boolean);
  }
  ...
  public boolean c()
  {
    ...
    {
      boolean bool = this.jdField_a_of_type_Akne.jdField_a_of_type_Boolean;
      this.jdField_a_of_type_Akne.jdField_a_of_type_Boolean = false;
      return bool;
    }
    return false;
  }
