...
public class QuicResProcess
{
  ...
  public static int a(ShortVideoResourceManager.SVConfigItem paramSVConfigItem)
  {
    ...
    VideoEnvironment.LogDownLoad("QuicDownProcess", localStringBuilder.toString(), null);
    return i;
  }
      ...
      if (i >= paramSVConfigItem.versionCode)
      {
        try
        {
          if (a.tryLock(3000L, TimeUnit.MILLISECONDS))
          {
            ...
            VideoEnvironment.LogDownLoad("QuicDownProcess", paramAppInterface.toString(), null);
            if (bool2)
            {
              i = 1;
            }
        ...
        catch (Exception paramAppInterface)
        {
          ...
          VideoEnvironment.LogDownLoad("QuicDownProcess", ((StringBuilder)localObject).toString(), paramAppInterface);
          i = 4;
        }
      }
      else
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    VideoEnvironment.LogDownLoad("QuicDownProcess", paramQQAppInterface.toString(), null);
    return i >= 3;
  }
