  ...
  extends ShareActionSheetBuilder
{
  ...
  protected View a()
  {
    View localView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131563016, null);
    this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$AdViewManager.a((RelativeLayout)localView.findViewById(2131362237));
    ...
    for (int j = 0;; j = 1)
    {
      ...
      for (int k = 0;; k = 1)
      {
        ...
        ((TextPaint)localObject3).setTextSize(this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131299096));
        ...
        int m = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelOffset(2131296815);
        int i;
        if (j != 0)
        {
          this.jdField_a_of_type_AndroidWidgetGridView = ((GridView)localView.findViewById(2131368059));
        ...
        for (;;)
        {
          ...
          if (k != 0)
          {
            this.jdField_b_of_type_AndroidWidgetGridView = ((GridView)localView.findViewById(2131368060));
            if (Build.VERSION.SDK_INT >= 9) {
          ...
          for (;;)
          {
            ...
            localObject1 = (TextView)localView.findViewById(2131361970);
            ...
            for (;;)
            {
              ...
              localObject1 = (RelativeLayout)localView.findViewById(2131377964);
              ...
              for (;;)
              {
                localObject1 = (ImageView)localView.findViewById(2131377963);
