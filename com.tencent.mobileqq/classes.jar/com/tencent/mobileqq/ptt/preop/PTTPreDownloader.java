  ...
  implements Handler.Callback, Manager
{
  ...
  private final PTTPreDownloader.CacheInfo jdField_a_of_type_ComTencentMobileqqPttPreopPTTPreDownloader$CacheInfo = new PTTPreDownloader.CacheInfo();
  ...
  private final PTTPreDownloader.CacheInfo jdField_b_of_type_ComTencentMobileqqPttPreopPTTPreDownloader$CacheInfo = new PTTPreDownloader.CacheInfo();
  private boolean jdField_b_of_type_Boolean;
  private final PTTPreDownloader.CacheInfo c = new PTTPreDownloader.CacheInfo();
  ...
  public PTTPreDownloader(QQAppInterface paramQQAppInterface)
  {
    ...
    a(new PTTPreDownloadStrategy(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentUtilWeakReferenceHandler));
  }
  ...
  public static int a(QQAppInterface paramQQAppInterface, MessageForPtt paramMessageForPtt)
  {
    ...
    {
      return 2005;
      if ((paramMessageForPtt.url.startsWith(AppConstants.SDCARD_ROOT)) && (FileUtils.a(paramMessageForPtt.getLocalFilePath()))) {
        return 2003;
      }
  ...
  private PTTPreDownloader.CacheInfo a(MessageForPtt paramMessageForPtt)
  {
    PTTPreDownloader.CacheInfo localCacheInfo = null;
    if (paramMessageForPtt.istroop == 0) {
      localCacheInfo = this.jdField_a_of_type_ComTencentMobileqqPttPreopPTTPreDownloader$CacheInfo;
    }
    do
    {
      return localCacheInfo;
      if (paramMessageForPtt.istroop == 1) {
        return this.jdField_b_of_type_ComTencentMobileqqPttPreopPTTPreDownloader$CacheInfo;
      }
  ...
  {
    return (PTTPreDownloader)paramQQAppInterface.getManager(QQManagerFactory.PTT_PRE_DOWNLOAD_MANAGER);
  }
  
  private void a(PTTPreDownloader.CacheInfo paramCacheInfo)
  {
    if (QLog.isColorLevel()) {
      QLog.d("PTTPreDownloader", 2, "cancelCache");
    }
    int i = 0;
    if (i < paramCacheInfo.jdField_a_of_type_JavaUtilArrayList.size())
    {
      ...
      for (long l = localMessageForPtt.extFlag;; l = (0x3 ^ 0xFFFFFFFF) & localMessageForPtt.extFlag)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().a(localMessageForPtt.frienduin, localMessageForPtt.istroop, localMessageForPtt.uniseq, localMessageForPtt.msgData);
        i += 1;
        break;
      }
    }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    {
      a(this.jdField_a_of_type_ComTencentMobileqqPttPreopPTTPreDownloader$CacheInfo);
      a(this.jdField_b_of_type_ComTencentMobileqqPttPreopPTTPreDownloader$CacheInfo);
      a(this.c);
    }
  }
  ...
  private boolean a(PTTPreDownloader.CacheInfo paramCacheInfo)
  {
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      {
        MessageForPtt localMessageForPtt = (MessageForPtt)paramCacheInfo.jdField_a_of_type_JavaUtilArrayList.get(0);
  ...
  private boolean d(MessageForPtt paramMessageForPtt)
  {
    ...
    int i;
    PTTPreDownloader.CacheInfo localCacheInfo;
    label299:
    label364:
    do
    {
      for (;;)
      {
        ...
        if (!((HotChatManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.HOT_CHAT_MANAGER)).b(paramMessageForPtt.frienduin))
        {
          ...
          if ((i == 0) || (i == -1))
          {
            localCacheInfo = a(paramMessageForPtt);
            if (localCacheInfo != null)
            {
              ...
              long l;
              if ((localCacheInfo.jdField_a_of_type_Int < 3) && (this.jdField_a_of_type_ComTencentMobileqqPttPreopPTTPreDownloader$IPreDownloadStrategy.a(paramMessageForPtt))) {
              ...
              for (;;)
              {
                ...
                break;
                localCacheInfo.jdField_a_of_type_Int += 1;
                continue;
                i = localCacheInfo.jdField_a_of_type_JavaUtilArrayList.size();
                localCacheInfo.getClass();
                if (i + 1 < 99) {
                  localCacheInfo.jdField_a_of_type_JavaUtilArrayList.add(paramMessageForPtt);
                }
              }
            }
          }
  ...
  private boolean g(MessageForPtt paramMessageForPtt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        bool1 = ((ITransFileController)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getRuntimeService(ITransFileController.class)).transferAsync(localTransferRequest);
        if (QLog.isDevelopLevel()) {
