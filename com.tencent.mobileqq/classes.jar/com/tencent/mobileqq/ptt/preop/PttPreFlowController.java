...
public class PttPreFlowController
{
  ...
  private void b()
  {
    ...
    localStringBuilder.append(this.f.getCurrentUin());
    localObject = ((BaseApplication)localObject).getSharedPreferences(localStringBuilder.toString(), 0);
    this.a[0] = ((SharedPreferences)localObject).getInt("avaliableflowxg", this.b[0]);
    this.a[1] = ((SharedPreferences)localObject).getInt("avaliableflowifi", this.b[1]);
    this.c = ((SharedPreferences)localObject).getLong("lastdaymillion", 0L);
  ...
  public void a()
  {
    ...
    localStringBuilder.append("PttPreSendSp_");
    localStringBuilder.append(this.f.getCurrentUin());
    localBaseApplication.getSharedPreferences(localStringBuilder.toString(), 0).edit().putInt("avaliableflowxg", this.a[0]).putInt("avaliableflowifi", this.a[1]).commit();
  }
