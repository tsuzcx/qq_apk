...
public class ReportUtil
{
  ...
  public static boolean a(AppInterface paramAppInterface, int paramInt)
  {
    ...
    int i = b(paramAppInterface, paramInt);
  ...
  /* Error */
  private static int b(AppInterface paramAppInterface, int paramInt)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 53	com/tencent/common/app/AppInterface:getApp	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   4: invokevirtual 59	com/tencent/qphone/base/util/BaseApplication:getContentResolver	()Landroid/content/ContentResolver;
    //   7: astore 6
    //   9: aconst_null
    //   10: astore 5
    //   12: aconst_null
    ...
    //   18: aload 5
    //   20: astore_0
    //   21: getstatic 65	android/provider/ContactsContract$RawContacts:CONTENT_URI	Landroid/net/Uri;
    //   24: astore 7
    //   26: iconst_0
    //   27: istore_2
    //   28: aload 4
    ...
    //   33: astore_0
    //   34: iload_1
    //   35: invokestatic 69	java/lang/Integer:toString	(I)Ljava/lang/String;
    //   38: astore 8
    //   40: aload 4
    //   42: astore_3
    //   43: aload 5
    ...
    //   59: ldc 75
    //   61: iconst_1
    //   62: anewarray 71	java/lang/String
    //   65: dup
    //   66: iconst_0
    //   67: aload 8
    //   69: aastore
    //   70: aconst_null
    //   71: invokevirtual 81	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   74: astore 4
    //   76: iload_2
    //   77: istore_1
    //   78: aload 4
    ...
    //   123: aload_0
    //   124: astore_3
    //   125: invokestatic 94	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   128: ifeq +15 -> 143
    //   131: aload_0
    //   132: astore_3
    //   133: ldc 29
    ...
    //   136: ldc 96
    //   138: aload 4
    //   140: invokestatic 99	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   143: iload_1
    //   144: istore_2
    //   145: aload_0
    //   146: ifnull +6 -> 152
