...
{
  public ContactBindHandler(AppInterface paramAppInterface)
  {
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("IMCore.PhoneContact.ContactBindHandler", 2, String.format("handleShowBindPhonePage reqOpCode=%s result=%s", new Object[] { Integer.valueOf(i), Integer.valueOf(j) }));
    }
    if (j == 0)
    {
      long l = 0L;
      ...
      if (localRspBody.enum_op_code.has()) {
        i = localRspBody.enum_op_code.get();
      } else {
        i = 0;
      }
      if (localRspBody.uint32_rsp_of_popup_flag.has()) {
        j = localRspBody.uint32_rsp_of_popup_flag.get();
      } else {
        j = 0;
      }
      if (QLog.isColorLevel()) {
        QLog.d("IMCore.PhoneContact.ContactBindHandler", 2, String.format("handleShowBindPhonePage resUin=%s resOpCode=%s resFlag=%s", new Object[] { Long.valueOf(l), Integer.valueOf(i), Integer.valueOf(j) }));
      }
      if (i == 2)
      {
        if (j == 1)
  ...
  {
    paramToServiceMsg = new RecommendedListResp();
    try
    {
      ...
      if (i == 0)
      {
        ...
        if ((paramFromServiceMsg != null) && (!paramFromServiceMsg.isEmpty()))
        {
          ...
          while (paramFromServiceMsg.hasNext())
          {
            ...
            localObject = new PhoneInfo();
            ((PhoneInfo)localObject).a = paramObject.str_phone.get();
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("IMCore.PhoneContact.ContactBindHandler", 2, String.format("getRecommendedList uin=%s startIndex=%s num=%s", new Object[] { Long.valueOf(paramLong), Integer.valueOf(paramInt1), Integer.valueOf(paramInt2) }));
    }
    try
    {
    ...
    {
      QLog.e("IMCore.PhoneContact.ContactBindHandler", 1, "getRecommendedList fail.", localThrowable);
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("IMCore.PhoneContact.ContactBindHandler", 2, String.format("queryShowBindPhonePage uin=%s", new Object[] { paramString }));
    }
    try
    {
    ...
    {
      QLog.e("IMCore.PhoneContact.ContactBindHandler", 1, "queryShowBindPhonePage fail.", paramString);
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("IMCore.PhoneContact.ContactBindHandler", 2, String.format("reportCommonGuideWebOpen uin=%s type=%s", new Object[] { paramString, Integer.valueOf(paramInt) }));
    }
    try
    {
      oidb_0xbe8.ReqBody localReqBody = new oidb_0xbe8.ReqBody();
    ...
    {
      QLog.e("IMCore.PhoneContact.ContactBindHandler", 1, "reportCommonGuideShowState fail.", paramString);
    }
  }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    int i = 2;
    if (bool) {
      QLog.d("IMCore.PhoneContact.ContactBindHandler", 2, String.format("setShowBindPhonePageResult uin=%s success=%s", new Object[] { paramString, Boolean.valueOf(paramBoolean) }));
    }
    try
    {
      oidb_0xbe8.ReqBody localReqBody = new oidb_0xbe8.ReqBody();
    ...
    {
      QLog.e("IMCore.PhoneContact.ContactBindHandler", 1, "setShowBindPhonePageResult fail.", paramString);
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("IMCore.PhoneContact.ContactBindHandler", 2, String.format("reportContactsGuidePopWindowState uin=%s", new Object[] { paramString }));
    }
    try
    {
      oidb_0xbe8.ReqBody localReqBody = new oidb_0xbe8.ReqBody();
