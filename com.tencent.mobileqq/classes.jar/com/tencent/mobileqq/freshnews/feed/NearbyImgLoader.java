...
public class NearbyImgLoader
{
  ...
  public static int b;
  public static int c;
  bauz jdField_a_of_type_Bauz = new bauz();
  ArrayList<asib> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  public List<URL> a;
  ...
  static
  {
    ...
    b = (i - aepi.a(2.0F, localBaseApplication.getResources())) / 2;
