...
public class NearbyImgLoader
{
  ...
  public static int b;
  public static int c;
  aysr jdField_a_of_type_Aysr = new aysr();
  ArrayList<aqkb> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  public List<URL> a;
  ...
  static
  {
    ...
    b = (i - actn.a(2.0F, localBaseApplication.getResources())) / 2;
