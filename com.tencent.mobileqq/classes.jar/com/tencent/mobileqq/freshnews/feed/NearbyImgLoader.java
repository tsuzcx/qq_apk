...
public class NearbyImgLoader
{
  ...
  public static int b;
  public static int c;
  bdwn jdField_a_of_type_Bdwn = new bdwn();
  ArrayList<auoq> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  public List<URL> a;
  ...
  static
  {
    ...
    b = (i - afur.a(2.0F, localBaseApplication.getResources())) / 2;
