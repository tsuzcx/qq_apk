  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    //   42: dup
    //   43: aload_0
    //   44: invokespecial 60	avgr:<init>	(Lcom/tencent/mobileqq/freshnews/feed/NearbyImgLoader$RequestLoadedImgTask;)V
    //   47: astore_2
    //   48: aload_0
    ...
    //   52: getfield 63	com/tencent/mobileqq/freshnews/feed/NearbyImgLoader:jdField_a_of_type_Bevg	Lbevg;
    //   55: aload_1
    //   56: aload_2
    //   57: invokevirtual 69	bevg:loadImageFile	(Lcom/tencent/image/DownloadParams;Lcom/tencent/image/URLDrawableHandler;)Ljava/io/File;
    //   60: astore 4
    //   62: aconst_null
    //   63: astore_2
    //   64: aload_2
    ...
    //   129: aload_1
    //   130: invokestatic 111	bhmq:a	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   133: pop
    //   134: aload_1
    //   135: getfield 114	android/graphics/BitmapFactory$Options:outWidth	I
    //   138: i2l
    //   139: invokestatic 120	bhlo:i	()J
    //   142: lcmp
    //   143: ifle +17 -> 160
    //   146: aload_1
    //   147: invokestatic 120	bhlo:i	()J
    //   150: aload_1
    ...
    //   170: aload_1
    //   171: invokestatic 111	bhmq:a	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   174: astore_1
    //   175: aload_0
