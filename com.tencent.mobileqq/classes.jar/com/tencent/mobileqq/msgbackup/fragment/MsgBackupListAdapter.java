  ...
  implements DecodeTaskCompletionListener
{
  ...
  public MsgBackupListAdapter(Context paramContext, QQAppInterface paramQQAppInterface, RecyclerView paramRecyclerView)
  {
  ...
  private void a(MsgBackupListAdapter.BackupAndMigrateItemHolder paramBackupAndMigrateItemHolder, int paramInt, Drawable paramDrawable)
  {
    ...
    if ((localRecentBaseData instanceof MsgBackupMsgUserData))
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityRecentRecentFaceDecoder != null) {
        paramDrawable = this.jdField_a_of_type_ComTencentMobileqqActivityRecentRecentFaceDecoder.a(localRecentBaseData);
      }
      if (!a(localRecentBaseData)) {
        break label233;
      }
      localQQAppInterface = ((BaseActivity)this.jdField_a_of_type_AndroidContentContext).app;
      int j = ((Integer)RecentFaceDecoder.a(localQQAppInterface, localRecentBaseData.getRecentUserType(), localRecentBaseData.getRecentUserUin()).first).intValue();
      int i = j;
      if (j == 103) {
        i = 1;
      }
      RecentDynamicAvatarView localRecentDynamicAvatarView = paramBackupAndMigrateItemHolder.jdField_a_of_type_ComTencentWidgetRecentDynamicAvatarView;
    ...
    for (;;)
    {
      paramBackupAndMigrateItemHolder.jdField_a_of_type_ComTencentWidgetRecentDynamicAvatarView.setImageDrawable(paramDrawable);
  ...
  private void b(MsgBackupListAdapter.BackupAndMigrateItemHolder paramBackupAndMigrateItemHolder, int paramInt, Drawable paramDrawable)
  {
    ...
    } while ((paramBackupAndMigrateItemHolder == null) || (localRecentBaseData == null));
    Drawable localDrawable = paramDrawable;
    if (paramDrawable == null)
    {
      int i = localRecentBaseData.getRecentUserType();
      localDrawable = this.jdField_a_of_type_ComTencentMobileqqActivityRecentRecentFaceDecoder.a(i, localRecentBaseData.getRecentUserUin());
    }
  ...
  {
    return new MsgBackupListAdapter.BackupAndMigrateItemHolder(this, this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562913, paramViewGroup, false), this.jdField_a_of_type_ComTencentMobileqqMsgbackupFragmentMsgBackupListAdapter$OnItemCheckedChangeListener);
  }
  ...
  public void onDecodeTaskCompleted(int paramInt1, int paramInt2, String arg3, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      if (paramInt1 < paramInt2)
      {
        ...
        j = ((Integer)RecentFaceDecoder.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, j, ((RecentBaseData)localObject).getRecentUserUin()).first).intValue();
        if (j == -2147483648) {
          break label438;
        }
