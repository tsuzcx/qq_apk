...
public class MsgBackupTransportProcessor$4
  implements Runnable
{
  public MsgBackupTransportProcessor$4(asnz paramasnz, String paramString) {}
  ...
  public void run()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("MsgBackup_MsgBackupTransportProcessor", 2, "after start called with ret = " + i + ", ipv4 = " + asoi.a(this.this$0.jdField_a_of_type_ComTencentMobileqqMsgbackupTransportMsgBackupEndPoint.ipv4) + ", udpport = " + this.this$0.jdField_a_of_type_ComTencentMobileqqMsgbackupTransportMsgBackupEndPoint.port + ", tcpport = " + this.this$0.b.port);
    }
    askv.a().a();
  }
}
