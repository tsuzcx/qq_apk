  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    ((MsgBackupTransportProcessor)localObject).jdField_a_of_type_Long = ((MsgBackupTransportProcessor)localObject).jdField_a_of_type_ComTencentMobileqqMsgbackupTransportMsgBackupJniProxy.createSession(2, Long.parseLong(this.jdField_a_of_type_JavaLangString), i, this.this$0.jdField_a_of_type_ComTencentMobileqqMsgbackupTransportMsgBackupNotifier);
    if (this.this$0.a())
    {
    ...
    MsgBackupAuthProcessor.a().a(this.jdField_a_of_type_Boolean);
  }
}
