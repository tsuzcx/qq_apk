...
public class MsgBackupTransportProcessor$3
  implements Runnable
{
  public MsgBackupTransportProcessor$3(arrt paramarrt, String paramString) {}
  ...
  public void run()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("MsgBackup_MsgBackupTransportProcessor", 2, "after start called with ret = " + i + ", ipv4 = " + arsc.a(this.this$0.c.ipv4) + ", udpport = " + this.this$0.c.port + ", tcpport = " + this.this$0.d.port);
    }
    arop.a().a();
  }
}
