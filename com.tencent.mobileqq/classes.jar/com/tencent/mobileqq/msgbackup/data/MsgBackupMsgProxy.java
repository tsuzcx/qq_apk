  ...
  extends BaseProxy
{
  ...
  private static long a(@NonNull QQAppInterface paramQQAppInterface, msg_comm.Msg paramMsg, msg_comm.MsgHead paramMsgHead, long paramLong1, long paramLong2, int paramInt, MessageInfo paramMessageInfo, long paramLong3, MessageHandler paramMessageHandler, ArrayList<MessageRecord> paramArrayList)
  {
    ...
    {
      paramLong2 = a(paramQQAppInterface.getLongAccountUin(), paramLong1, paramLong2);
    ...
    do
    {
      ...
      paramLong1 = paramLong3;
    } while (!paramMsgHead.discuss_info.has());
  ...
  public static MessageRecord a(@NonNull QQAppInterface paramQQAppInterface, @NonNull byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        long l1 = ((msg_comm.MsgHead)localObject2).from_uin.get();
        l2 = ((msg_comm.MsgHead)localObject2).to_uin.get();
        l3 = ((msg_comm.MsgHead)localObject2).msg_seq.get();
        long l4 = ((msg_comm.MsgHead)localObject2).msg_time.get();
        long l5 = ((msg_comm.MsgHead)localObject2).msg_uid.get();
        ...
        long l6 = MessageProtoCodec.a(localMessageHandler, (msg_comm.Msg)localObject1, String.valueOf(l2), String.valueOf(l1));
        paramArrayOfByte = new ArrayList();
        long l7 = a(paramQQAppInterface, (msg_comm.Msg)localObject1, (msg_comm.MsgHead)localObject2, l1, l2, i1, localMessageInfo, 0L, localMessageHandler, paramArrayOfByte);
        int m = 0;
        int i2 = MessageProtoCodec.a((msg_comm.Msg)localObject1);
        if (((msg_comm.Msg)localObject1).content_head.has())
        {
          ...
          if (((Iterator)localObject1).hasNext())
          {
            ...
            ((MessageRecord)localObject2).msgUid = l5;
            ((MessageRecord)localObject2).selfuin = paramQQAppInterface.getCurrentAccountUin();
            ((MessageRecord)localObject2).senderuin = String.valueOf(l1);
            ((MessageRecord)localObject2).frienduin = String.valueOf(l7);
            ((MessageRecord)localObject2).vipBubbleDiyTextId = i2;
            ((MessageRecord)localObject2).vipBubbleID = SVIPHandler.a((int)l6, i2);
            ...
            if (l1 != paramQQAppInterface.getLongAccountUin()) {
              break label647;
            }
            n = 2;
            label413:
            ...
            ((MessageRecord)localObject2).msgBackupMsgRandom = MessageUtils.b(l5);
            m += 1;
            continue;
            label503:
            ...
            ((MessageRecord)localObject2).shmsgseq = l3;
            continue;
            if (!AppConstants.DATALINE_PC_UIN.equals(Long.valueOf(l2))) {}
          }
        }
      }
      ...
      do
      {
        ...
        for (;;)
        {
          ...
          break;
          if (AppConstants.DATALINE_IPAD_UIN.equals(Long.valueOf(l2))) {
            ((MessageRecord)localObject2).istroop = 6003;
          } else {
            ((MessageRecord)localObject2).istroop = 0;
          }
        }
        MessageHandlerUtils.a(paramArrayOfByte);
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          {
            localObject2 = MessageProtoCodec.a((MessageForStructing)paramMessageRecord);
          ...
          else if ((paramMessageRecord.msgtype == -2059) && (!TextUtils.isEmpty(paramMessageRecord.msg)))
          {
            ...
            ((im_msg_body.Elem)localObject2).text.set(localText);
  ...
  public static byte[] a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    catch (Throwable paramQQAppInterface)
    {
      for (;;)
      {
        ...
        CaughtExceptionReport.a(paramQQAppInterface, "MsgBackup_msgproxy,mr = " + paramMessageRecord.getClass().getSimpleName());
        paramQQAppInterface = null;
      }
  ...
  public MessageRecord a(@NonNull MsgBackupMsgEntity paramMsgBackupMsgEntity)
  {
    ...
    if (paramMsgBackupMsgEntity.extensionData != null) {
      localMessageRecord = a((QQAppInterface)this.app, paramMsgBackupMsgEntity.extensionData);
    }
  ...
  public MsgBackupMsgEntity a(@NonNull MessageRecord paramMessageRecord)
  {
    ...
    catch (Throwable localThrowable)
    {
      ...
      {
        QLog.e("MsgBackup_msgproxy", 1, "transToBackupEntity,getMsgBody error mr = " + paramMessageRecord.getClass().getSimpleName());
        CaughtExceptionReport.a(localThrowable, "MsgBackup_msgproxy,mr = " + paramMessageRecord.getClass().getSimpleName());
        localObject2 = null;
      }
      localMsg.msg_head.set(localMsgHead);
