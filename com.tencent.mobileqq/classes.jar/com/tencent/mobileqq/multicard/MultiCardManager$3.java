...
public class MultiCardManager$3
  implements Runnable
{
  public MultiCardManager$3(arwc paramarwc, long paramLong, arwf paramarwf) {}
  
  public void run()
  {
    ArrayList localArrayList = arwc.a(this.this$0, this.jdField_a_of_type_Long);
    if (localArrayList != null) {}
    for (;;)
    {
      synchronized (arwc.a(this.this$0))
      {
        arwc.a(this.this$0).put(Long.valueOf(this.jdField_a_of_type_Long), (ArrayList)localArrayList.clone());
