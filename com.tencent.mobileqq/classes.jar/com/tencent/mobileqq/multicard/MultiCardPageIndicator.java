  ...
  implements DecodeTaskCompletionListener, PageIndicator
{
  ...
  private void a(View paramView, boolean paramBoolean)
  {
    ...
    for (paramView = (MultiCardPageIndicator.MultiAIOHolder)paramView;; paramView = null)
    {
      if (paramView != null)
      {
  ...
  private void a(MultiCardPageIndicator.MultiAIOHolder paramMultiAIOHolder, CardIndicator paramCardIndicator, Drawable paramDrawable)
  {
    ...
    if (paramDrawable == null)
    {
      ...
      paramDrawable = a(paramCardIndicator.a());
    }
    for (;;)
    {
      ...
      b(paramMultiAIOHolder, paramCardIndicator, localDrawable);
      return;
    }
  }
  ...
  private void b(MultiCardPageIndicator.MultiAIOHolder paramMultiAIOHolder, CardIndicator paramCardIndicator, Drawable paramDrawable)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.i("TabPageIndicator", 2, "bindview user:" + paramCardIndicator.a());
      }
      int n = ((Integer)RecentFaceDecoder.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramCardIndicator.a(), paramCardIndicator.a()).first).intValue();
      int m = n;
      if (n == 103) {
        m = 1;
      }
      ThemeRecentDynamicAvatarView localThemeRecentDynamicAvatarView = paramMultiAIOHolder.jdField_a_of_type_ComTencentWidgetThemeRecentDynamicAvatarView;
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.mAutomator.a() == 1)
      {
        bool = true;
        label162:
        localThemeRecentDynamicAvatarView.setFaceDrawable(localQQAppInterface, paramDrawable, m, paramCardIndicator, 100, false, bool, 0);
      }
    }
    for (;;)
    {
  ...
  private void e(int paramInt)
  {
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      ...
      while (m < n)
      {
        TabPageIndicator.OnPageChangeListener localOnPageChangeListener = (TabPageIndicator.OnPageChangeListener)this.jdField_a_of_type_JavaUtilList.get(m);
  ...
  public View a(int paramInt)
  {
    ...
    CardIndicator localCardIndicator = this.jdField_a_of_type_ComTencentMobileqqMulticardMultiCardContext.a(paramInt);
    MultiCardPageIndicator.MultiAIOHolder localMultiAIOHolder = new MultiCardPageIndicator.MultiAIOHolder();
    View localView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131558661, null);
    localMultiAIOHolder.jdField_a_of_type_ComTencentWidgetThemeRecentDynamicAvatarView = ((ThemeRecentDynamicAvatarView)localView.findViewById(2131378843));
    ...
    Drawable localDrawable2 = a(localCardIndicator.a());
    Drawable localDrawable1 = localDrawable2;
    if (localDrawable2 == null) {
      localDrawable1 = ImageUtil.c();
    }
    b(localMultiAIOHolder, localCardIndicator, localDrawable1);
  ...
  public void b(int paramInt)
  {
    ...
    } while (!(localObject instanceof MultiCardPageIndicator.MultiAIOHolder));
  ...
  public void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      break;
      label137:
      this.g = AIOUtils.a(56.0F, getResources());
    }
  }
