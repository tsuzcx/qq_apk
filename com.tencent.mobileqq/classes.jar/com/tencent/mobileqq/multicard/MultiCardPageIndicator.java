  ...
  implements arut, azwh
{
  ...
  private List<aruz> jdField_a_of_type_JavaUtilList;
  private boolean jdField_a_of_type_Boolean;
  private int[] jdField_a_of_type_ArrayOfInt = new int[2];
  private int jdField_b_of_type_Int;
  private long jdField_b_of_type_Long;
  private final View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new arwj(this);
  ...
  private Drawable a(String paramString)
  {
    ...
    {
      this.jdField_a_of_type_Azwg = new azwg(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  ...
  private void a(Context paramContext, int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidViewGestureDetector = new GestureDetector(getContext(), new arwk(this), new Handler(Looper.getMainLooper()));
    addView(this.jdField_a_of_type_ComTencentMobileqqMultiaioWidgetIcsLinearLayout, new ViewGroup.LayoutParams(-2, -1));
    g();
    this.jdField_a_of_type_Arur.a(new arwl(this));
    h();
  }
  ...
  private void a(arwm paramarwm, arvf paramarvf, Drawable paramDrawable)
  {
    if ((paramarwm == null) || (paramarvf == null)) {
      return;
    }
    if (paramDrawable == null)
    {
      paramarvf.a();
      paramDrawable = a(paramarvf.a());
    }
    for (;;)
    {
      ...
      b(paramarwm, paramarvf, localDrawable);
      return;
    }
  }
  
  private void b(arwm paramarwm, arvf paramarvf, Drawable paramDrawable)
  {
    if ((paramarwm == null) || (paramarvf == null))
    {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.i("TabPageIndicator", 2, "bindview user:" + paramarvf.a());
      }
      int n = ((Integer)ahbe.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramarvf.a(), paramarvf.a()).first).intValue();
      int m = n;
      if (n == 103) {
        m = 1;
      }
      ThemeRecentDynamicAvatarView localThemeRecentDynamicAvatarView = paramarwm.jdField_a_of_type_ComTencentWidgetThemeRecentDynamicAvatarView;
      QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
      paramarvf = paramarvf.a();
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a.a() == 1)
      {
        bool = true;
        label162:
        localThemeRecentDynamicAvatarView.setFaceDrawable(localQQAppInterface, paramDrawable, m, paramarvf, 100, false, bool, 0);
      }
    }
    for (;;)
    {
      paramarwm.jdField_a_of_type_AndroidWidgetImageView.setVisibility(4);
      paramarwm.jdField_a_of_type_JavaLangString = String.valueOf(0);
      paramarwm.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setVisibility(4);
      if ((!"1103".equals(ThemeUtil.curThemeId)) && (!"2920".equals(ThemeUtil.curThemeId))) {
        break;
      }
      paramarwm.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130837928);
      return;
      bool = false;
      break label162;
      paramarwm.jdField_a_of_type_ComTencentWidgetThemeRecentDynamicAvatarView.setImageDrawable(paramDrawable);
    }
  }
  ...
  private void e(int paramInt)
  {
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      ...
      while (m < n)
      {
        aruz localaruz = (aruz)this.jdField_a_of_type_JavaUtilList.get(m);
        if (localaruz != null) {
  ...
  public View a(int paramInt)
  {
    ...
    arvf localarvf = this.jdField_a_of_type_Arvk.a(paramInt);
    arwm localarwm = new arwm();
    View localView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131493010, null);
    localarwm.jdField_a_of_type_ComTencentWidgetThemeRecentDynamicAvatarView = ((ThemeRecentDynamicAvatarView)localView.findViewById(2131310999));
    localarwm.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView = ((DragTextView)localView.findViewById(2131312777));
    localarwm.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131297252));
    localarwm.jdField_a_of_type_Int = paramInt;
    localView.setTag(localarwm);
    StringBuilder localStringBuilder = new StringBuilder();
    Drawable localDrawable2 = a(localarvf.a());
    Drawable localDrawable1 = localDrawable2;
    if (localDrawable2 == null) {
      localDrawable1 = bacm.b();
    }
    b(localarwm, localarvf, localDrawable1);
    localStringBuilder.append(localarvf.b());
  ...
  public void a(aruz paramaruz)
  {
    ...
    this.jdField_a_of_type_JavaUtilList.add(paramaruz);
  }
  ...
  public void b(int paramInt)
  {
    ...
    } while (!(localObject instanceof arwm));
    localObject = (arwm)localObject;
    switch (paramInt)
    {
    }
  }
  ...
  public void e()
  {
    ...
    this.jdField_b_of_type_Int = this.jdField_a_of_type_Arvk.a();
    int m = 0;
  ...
  public void onDecodeTaskCompleted(int paramInt1, int paramInt2, String arg3, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      ...
      {
        paramBitmap = this.jdField_a_of_type_Arvk.a(paramInt1);
        if (paramBitmap == null)
        {
          break label429;
        ...
        if (!(localObject1 instanceof arwm)) {
          break label429;
        }
        localObject1 = (arwm)localObject1;
        int m = paramBitmap.a();
        ...
        a((arwm)localObject1, paramBitmap, new BitmapDrawable(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources(), (Bitmap)localObject2));
        bool = true;
        break label429;
      }
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (paramInt1 < paramInt2)
    {
      ...
      {
        localObject = ((View)localObject).getTag();
        if ((localObject instanceof arwm))
        {
          localObject = (arwm)localObject;
          ((arwm)localObject).jdField_a_of_type_ComTencentWidgetThemeRecentDynamicAvatarView.setScaleX(f1);
          ((arwm)localObject).jdField_a_of_type_ComTencentWidgetThemeRecentDynamicAvatarView.setScaleY(f1);
        }
        paramInt1 += 1;
        break;
      }
  ...
  public void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      break;
      label137:
      this.g = aciy.a(56.0F, getResources());
    }
  }
  ...
  public void setMultiCardContext(arvk paramarvk)
  {
