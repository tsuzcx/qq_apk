  ...
  implements Manager
{
  ...
  private IntimateInfoManager jdField_a_of_type_ComTencentMobileqqFriendsIntimateIntimateInfoManager;
  private MultiCardManager.GroupCardIntimateInfoObserver jdField_a_of_type_ComTencentMobileqqMulticardMultiCardManager$GroupCardIntimateInfoObserver;
  private MultiCardManager.MyFriendObserver jdField_a_of_type_ComTencentMobileqqMulticardMultiCardManager$MyFriendObserver;
  private MultiCardManager.MyTroopBusinessObserver jdField_a_of_type_ComTencentMobileqqMulticardMultiCardManager$MyTroopBusinessObserver;
  private HashMap<Long, WeakReference<MultiCardManager.GetGroupRecommendUinListsListener>> jdField_a_of_type_JavaUtilHashMap = new HashMap(5);
  private boolean jdField_a_of_type_Boolean = true;
  private HashMap<Long, WeakReference<MultiCardManager.GetGroupIntimateInfoListListener>> b = new HashMap(20);
  private HashMap<Long, Boolean> c = new HashMap(200);
  private HashMap<Long, WeakReference<MultiCardManager.GetGroupMemberNickListener>> d = new HashMap(5);
  ...
  public void a(long paramLong)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqMulticardMultiCardManager$GroupCardIntimateInfoObserver == null) {
      this.jdField_a_of_type_ComTencentMobileqqMulticardMultiCardManager$GroupCardIntimateInfoObserver = new MultiCardManager.GroupCardIntimateInfoObserver(this, null);
    }
    if (this.jdField_a_of_type_ComTencentMobileqqMulticardMultiCardManager$MyFriendObserver == null) {
      this.jdField_a_of_type_ComTencentMobileqqMulticardMultiCardManager$MyFriendObserver = new MultiCardManager.MyFriendObserver(this, null);
    }
    if (this.jdField_a_of_type_ComTencentMobileqqMulticardMultiCardManager$MyTroopBusinessObserver == null) {
      this.jdField_a_of_type_ComTencentMobileqqMulticardMultiCardManager$MyTroopBusinessObserver = new MultiCardManager.MyTroopBusinessObserver(this, null);
    }
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_ComTencentMobileqqMulticardMultiCardManager$GroupCardIntimateInfoObserver);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_ComTencentMobileqqMulticardMultiCardManager$MyFriendObserver);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_ComTencentMobileqqMulticardMultiCardManager$MyTroopBusinessObserver);
  }
