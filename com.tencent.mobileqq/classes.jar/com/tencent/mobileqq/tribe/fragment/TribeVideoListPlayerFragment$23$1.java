...
public class TribeVideoListPlayerFragment$23$1
  implements Runnable
{
  public TribeVideoListPlayerFragment$23$1(bbdi parambbdi) {}
  
  public void run()
  {
    if (((TribeVideoListPlayerFragment.a(this.a.a) != null) && (TribeVideoListPlayerFragment.a(this.a.a).isVisible())) || (this.a.a.e))
    {
      if ((((View)this.a.a.jdField_a_of_type_ComTencentQqliveMediaplayerViewIVideoViewBase).getTag() instanceof bbdq))
      {
        this.a.a.a(((bbdq)((View)this.a.a.jdField_a_of_type_ComTencentQqliveMediaplayerViewIVideoViewBase).getTag()).a, this.a.a.jdField_a_of_type_Long, this.a.a.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.getCurrentPostion(), true);
