...
public class TribeVideoListPlayerFragment$12$1
  implements Runnable
{
  public TribeVideoListPlayerFragment$12$1(azan paramazan) {}
  ...
  public void run()
  {
    for (;;)
    {
      try
      {
        HttpResponse localHttpResponse = nam.a(BaseApplicationImpl.getContext(), this.a.jdField_a_of_type_Azby.h, null, "GET", null, null);
      ...
      try
      {
        axqw.b(null, "dc00899", "Grp_tribe", "", "video_player", "ad_dislike_suc", this.a.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment.e, 0, "" + this.a.jdField_a_of_type_Azby.a.report_info.trace_info.aid.get(), "" + (this.a.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment.jdField_a_of_type_JavaUtilArrayList.indexOf(this.a.jdField_a_of_type_Azby) + 1), "", "");
        return;
      }
