...
public class TribeVideoListPlayerFragment$12$1
  implements Runnable
{
  public TribeVideoListPlayerFragment$12$1(beso parambeso) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      return;
      this.a.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment.b(this.a.jdField_a_of_type_Betg);
    }
  }
}
