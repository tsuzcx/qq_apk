...
public class TribeVideoListPlayerFragment$11$1
  implements Runnable
{
  public TribeVideoListPlayerFragment$11$1(bedx parambedx) {}
  
  public void run()
  {
    try
    {
      HttpResponse localHttpResponse = nlw.a(BaseApplicationImpl.getContext(), this.a.jdField_a_of_type_Befg.h, null, "GET", null, null);
      if ((localHttpResponse != null) && (localHttpResponse.getStatusLine().getStatusCode() == 200))
      {
        ...
        TribeVideoListPlayerFragment.a(this.a.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment, this.a.jdField_a_of_type_Befg, "ad_dislike_suc", "negative ad report error: e= ");
      }
      return;
    }
