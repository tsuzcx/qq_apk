...
public class TribeVideoListPlayerFragment$13$1
  implements Runnable
{
  public TribeVideoListPlayerFragment$13$1(ayag paramayag) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      return;
      this.a.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment.b(this.a.jdField_a_of_type_Ayaz);
    }
  }
}
