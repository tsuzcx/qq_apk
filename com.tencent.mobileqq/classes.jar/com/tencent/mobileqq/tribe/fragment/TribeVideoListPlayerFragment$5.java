...
class TribeVideoListPlayerFragment$5
  implements SSOLoadBusinessObserver.SSOLoadListener
{
  TribeVideoListPlayerFragment$5(TribeVideoListPlayerFragment paramTribeVideoListPlayerFragment) {}
  ...
  public void a(Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i < paramBundle.length())
        {
          ...
          if (localJSONObject2 != null)
          {
            ...
            if (m - 1 > 0)
            {
              ...
              {
                localObject = new TribeVideoADItem(localJSONObject2);
        ...
        {
          if (j != 0) {
            this.a.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment$VideoListAdapter.notifyDataSetChanged();
          }
          return;
        }
      }
