  ...
  extends PublicBaseFragment
{
  ...
  {
    paramView = paramView.findViewById(2131379376);
  ...
  {
    paramView = (RelativeLayout)paramView.findViewById(2131381009);
    ...
    localVideoPlayParam.mSceneName = bapv.a(111);
    this.a = ((BaseVideoView)bapu.b(paramView.getContext(), 0L, localVideoPlayParam, null));
  ...
  {
    ((ImageButton)paramView.findViewById(2131377026)).setOnClickListener(new bets(this, paramString));
  }
  ...
  {
    paramLayoutInflater = paramLayoutInflater.inflate(2131562961, paramViewGroup, false);
    ...
    paramLayoutInflater.setOnTouchListener(new betr(this));
