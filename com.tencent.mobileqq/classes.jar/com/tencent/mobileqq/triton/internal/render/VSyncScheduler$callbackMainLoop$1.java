  ...
  implements Runnable
{
  ...
  public final void run()
  {
    ...
    for (long l1 = 0L;; l1 = l2 - VSyncScheduler.access$getLastFrameTimeNanos$p(this.this$0))
    {
      ...
      VSyncScheduler.access$setTotalDrawTimeNanos$p(localVSyncScheduler, l1 + VSyncScheduler.access$getTotalDrawTimeNanos$p(localVSyncScheduler));
