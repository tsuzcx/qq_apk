...
public class TouchEventManager
{
  ...
  private float d;
  private TTEngine e;
  private Queue<TouchEventManager.a> f = new LinkedList();
  private TouchEventManager.a g;
  ...
  private void b(MotionEvent paramMotionEvent)
  {
    ...
    //   3: ifnull +12 -> 15
    //   6: aload_0
    //   7: getfield 59	com/tencent/mobileqq/triton/touch/TouchEventManager:g	Lcom/tencent/mobileqq/triton/touch/TouchEventManager$a;
    //   10: astore_3
    //   11: aload_3
    //   12: ifnonnull +6 -> 18
    //   15: aload_0
    ...
    //   17: return
    //   18: aload_1
    //   19: invokevirtual 65	android/view/MotionEvent:getActionIndex	()I
    //   22: istore_2
    //   23: aload_1
    //   24: iload_2
    //   25: invokevirtual 69	android/view/MotionEvent:getX	(I)F
    //   28: aload_3
    ...
    //   60: aload_1
    //   61: iload_2
    //   62: invokevirtual 69	android/view/MotionEvent:getX	(I)F
    ...
    //   84: aload_0
    //   85: getfield 40	com/tencent/mobileqq/triton/touch/TouchEventManager:f	Ljava/util/Queue;
    //   88: aload_3
    //   89: invokeinterface 101 2 0
    //   94: pop
    //   95: aload_0
    //   96: getfield 40	com/tencent/mobileqq/triton/touch/TouchEventManager:f	Ljava/util/Queue;
    //   99: invokeinterface 104 1 0
    //   104: bipush 10
    //   106: if_icmple -91 -> 15
    //   109: aload_0
    //   110: getfield 40	com/tencent/mobileqq/triton/touch/TouchEventManager:f	Ljava/util/Queue;
    ...
    //   22	49	2	i	int
    //   10	79	3	locala	TouchEventManager.a
    // Exception table:
    //   from	to	target	type
    //   6	11	122	finally
    //   18	119	122	finally
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      a(m);
      if (m == 0) {
        this.g = new TouchEventManager.a(paramMotionEvent.getX(k), paramMotionEvent.getY(k));
      }
    }
  }
  ...
  public String b()
  {
    try
    {
      ...
      {
        TouchEventManager.a locala = (TouchEventManager.a)localIterator.next();
        if (i == 0) {
