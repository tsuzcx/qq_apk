  ...
  implements IGameLauncher
{
  ...
  private void launchMainScript(MiniGameInfo paramMiniGameInfo)
  {
    if (paramMiniGameInfo == null) {
      return;
    }
    TTLog.i("GameLauncher", "launch game [" + paramMiniGameInfo.gameId + "] mainContext");
    String str = this.mTritonEngine.getQQEnv().getMiniGamePath(paramMiniGameInfo) + File.separator + "game.js";
    ...
    this.mTritonEngine.loadScriptPathWithCodeCache(1, localFile.getAbsolutePath(), getGameDebugPath(str), localFile.getAbsolutePath() + ".cc");
  }
  ...
  private void launchOpenDataScript(MiniGameInfo paramMiniGameInfo)
  {
    ...
    for (;;)
    {
      ...
      localObject = new File(this.mTritonEngine.getQQEnv().getMiniGamePath(paramMiniGameInfo) + File.separator + (String)localObject + File.separator + "index.js");
      paramMiniGameInfo = new File(this.mTritonEngine.getQQEnv().getMiniGamePath(paramMiniGameInfo) + File.separator + "subContext.js");
  ...
  public String getGameDebugPath(String paramString)
  {
    ...
    if (localObject == null) {}
    for (localObject = null;; localObject = this.mTritonEngine.getQQEnv().getMiniGamePath((MiniGameInfo)localObject))
    {
