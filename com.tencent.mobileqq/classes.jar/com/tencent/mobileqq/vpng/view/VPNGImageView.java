...
public class VPNGImageView
  extends FrameLayout
  implements TextureView.SurfaceTextureListener, baxd
{
  ...
  public void onSetRenderer(baxe parambaxe)
  {
    this.mVPNGRenderer = parambaxe;
  ...
  public void onSurfaceTextureAvailable(SurfaceTexture paramSurfaceTexture, int paramInt1, int paramInt2)
  {
    if (this.mVPNGRenderer == null)
    {
      this.mVPNGRenderer = baxg.a().a(this, this.mWidth, this.mHeight);
      if (this.mVPNGRenderer != null)
      {
  ...
  public void setImage(String paramString, BitmapFactory.Options paramOptions)
  {
    ...
    if ((!new File(str).exists()) && (baxh.a(paramString, str))) {
      setVideo(str, true);
    }
