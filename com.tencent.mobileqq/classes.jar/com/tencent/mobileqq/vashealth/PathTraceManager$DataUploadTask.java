  ...
  implements Runnable
{
  ...
  private void a(boolean paramBoolean, int paramInt)
  {
    if (this.this$0.jdField_a_of_type_ComTencentMobileqqAppBrowserAppInterface != null)
    {
      ...
      awrn.a(this.this$0.jdField_a_of_type_ComTencentMobileqqAppBrowserAppInterface.getApp()).a(str, "QQSportUpload", paramBoolean, System.currentTimeMillis(), 0L, localHashMap, "", false);
    }
  }
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        localObject2 = new NewIntent(BaseApplicationImpl.sApplication.getApplicationContext(), aquf.class);
        ...
        ((NewIntent)localObject2).setObserver(new basb(this, localJSONObject, localList, localThrowable, localSharedPreferences, localOrbitReq));
