  ...
  extends TimerTask
{
  ...
  public void run()
  {
    ...
    {
      qcn.a(localTextView, ((TVK_IMediaPlayer)this.this$0.d.get(this.jdField_a_of_type_JavaLangString)).getDuration() - ((TVK_IMediaPlayer)this.this$0.d.get(this.jdField_a_of_type_JavaLangString)).getCurrentPostion());
      qcn.a(this.jdField_a_of_type_AndroidWidgetTextView, ((TVK_IMediaPlayer)this.this$0.d.get(this.jdField_a_of_type_JavaLangString)).getCurrentPostion());
      qcn.a(this.b, ((TVK_IMediaPlayer)this.this$0.d.get(this.jdField_a_of_type_JavaLangString)).getDuration());
