  ...
  extends AsyncStep
{
  public int a()
  {
    ...
    Object localObject = (odh)this.a.app.a(139);
    ((odh)localObject).a = true;
    ((odh)localObject).b = System.currentTimeMillis();
    ((odh)localObject).a(null, null, false, null, 1);
    ...
    {
      localObject = new NewIntent((Context)localObject, bhfy.class);
    ...
    bhfq.b = bool;
    localObject = (bhft)this.a.app.getManager(260);
    if (bhfq.a(1)) {
      ((bhft)localObject).a("login");
    }
    ((bhft)localObject).a();
    return 7;
  }
