  ...
  extends BroadcastReceiver
{
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if (i == 1) {
      PathTraceService.a(this.a).setTextViewText(2131372115, anvx.a(2131707361));
    }
    PathTraceService.a(this.a).setChronometer(2131372116, SystemClock.elapsedRealtime() - l * 1000L, null, false);
    paramContext = new DecimalFormat("######0.00");
    PathTraceService.a(this.a).setTextViewText(2131372114, paramContext.format(d / 1000.0D) + "km");
    try
    {
