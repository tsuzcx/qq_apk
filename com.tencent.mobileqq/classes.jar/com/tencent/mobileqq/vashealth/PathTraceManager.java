  ...
  implements Manager
{
  ...
  public Handler a;
  private biga jdField_a_of_type_Biga;
  bihw jdField_a_of_type_Bihw;
  bihz jdField_a_of_type_Bihz;
  ...
  public PathTraceManager(BrowserAppInterface paramBrowserAppInterface)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new bify(this, Looper.getMainLooper());
    ...
    this.jdField_a_of_type_ComTencentMobileqqPluginsdkPluginInterfaceHelper$OnPluginInterfaceLoadedListener = new bifu(this);
    ...
    this.jdField_a_of_type_AndroidHardwareSensorEventListener = new bifv(this);
  ...
  private JSONObject a(TracePointsData paramTracePointsData)
  {
    ...
    try
    {
      ...
      {
        paramTracePointsData = (bifo)this.jdField_a_of_type_JavaLangRefWeakReference.get();
  ...
  public static void a(ArrayList<Uri> paramArrayList)
  {
    ...
    //   236: dup
    //   237: aload_0
    //   238: invokespecial 325	bifx:<init>	(Ljava/util/ArrayList;)V
  ...
  private void b(List<TracePointsData> paramList)
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
      {
        paramList = (bifo)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        if (paramList != null) {
  ...
  public TracePathData a(long paramLong)
  {
    ...
    localObject = this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager.rawQuery(TracePathData.class, (String)localObject, null);
    if (localObject != null) {
  ...
  public List<TracePointsData> a(long paramLong)
  {
    ...
    localObject = this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager.rawQuery(TracePointsData.class, (String)localObject, null);
  ...
  public JSONObject a()
  {
    JSONObject localJSONObject1 = new JSONObject();
    JSONArray localJSONArray = new JSONArray();
    Object localObject = this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager.query(TracePathData.class);
    try
    {
  ...
  {
    if (this.jdField_a_of_type_Biga == null) {
      this.jdField_a_of_type_Biga = new biga(this, this.jdField_a_of_type_ComTencentMobileqqAppBrowserAppInterface);
    }
    this.jdField_c_of_type_Int = paramInt;
    SosoInterface.a(this.jdField_a_of_type_Biga);
    ...
    {
      localObject = (bifo)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if ((localObject != null) && (((bifo)localObject).mRuntime != null)) {
        if (((bifo)localObject).mRuntime.a() == null) {
          break label149;
        }
      }
    }
    label149:
    for (Object localObject = ((bifo)localObject).mRuntime.a().mUrl;; localObject = null)
    {
  ...
  public void a(bifo parambifo)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambifo);
  }
    ...
    if (this.jdField_c_of_type_Int == 1)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
          {
            localObject2 = (bifo)this.jdField_a_of_type_JavaLangRefWeakReference.get();
            if (localObject2 != null)
            {
              ((bifo)localObject2).dispatchJsEvent("PathTraceEnd", paramTracePointsData, new JSONObject());
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        return;
        localObject = new bihu("https://imgcache.qq.com/ac/vasapp/webviewlib/2513/run_sd/audio715.zip", (File)localObject);
        ((bihu)localObject).r = false;
        ((bihu)localObject).q = true;
        if (this.jdField_a_of_type_Bihw == null)
        {
          this.jdField_a_of_type_Bihw = ((bihw)this.jdField_a_of_type_ComTencentMobileqqAppBrowserAppInterface.getManager(47));
      ...
      return;
      this.jdField_a_of_type_Bihz.a((bihu)localObject, new bifw(this, str, paramString), null);
      return;
      localObject = null;
    }
  }
  ...
  public void a(List<Entity> paramList)
  {
    ...
    //   32: checkcast 1077	com/tencent/mobileqq/persistence/Entity
    //   35: invokevirtual 1080	com/tencent/mobileqq/vashealth/PathTraceManager:a	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   38: pop
    //   39: return
    //   40: aload_0
    ...
    //   44: invokevirtual 1084	com/tencent/mobileqq/persistence/EntityManager:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   47: astore_2
    //   48: aload_2
    //   49: invokevirtual 1089	com/tencent/mobileqq/persistence/EntityTransaction:begin	()V
    //   52: aload_1
    ...
    //   75: checkcast 1077	com/tencent/mobileqq/persistence/Entity
    //   78: invokevirtual 1080	com/tencent/mobileqq/vashealth/PathTraceManager:a	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   81: pop
    //   82: goto -23 -> 59
    //   85: astore_1
    ...
    //   108: aload_1
    //   109: invokevirtual 1094	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   121: aload_2
    //   122: invokevirtual 1096	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   125: return
    //   126: aload_2
    //   127: invokevirtual 1098	com/tencent/mobileqq/persistence/EntityTransaction:commit	()V
    //   130: aload_2
    //   131: invokevirtual 1096	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   134: return
    //   135: astore_1
    //   136: aload_2
    //   137: invokevirtual 1096	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   140: aload_1
    //   141: athrow
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  public boolean a(long paramLong)
  {
    ...
    if (this.jdField_a_of_type_JavaLangRefWeakReference != null) {}
    Object localObject;
    for (bifo localbifo = (bifo)this.jdField_a_of_type_JavaLangRefWeakReference.get();; localObject = null)
    {
      if ((this.jdField_a_of_type_ComTencentMobileqqVashealthTracePathData.totalTime < 60L) || (this.jdField_a_of_type_ComTencentMobileqqVashealthTracePathData.distance < 100.0D))
      {
        try
        {
          ...
          if (localbifo != null) {
            localbifo.dispatchJsEvent("PathTraceEnd", localJSONObject, new JSONObject());
          }
  ...
  public boolean a(Long paramLong)
  {
    ...
    bool = this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager.execSQL(paramLong);
    try
    {
      ...
      for (;;)
      {
        paramLong = null;
        if (this.jdField_a_of_type_JavaLangRefWeakReference != null) {
          paramLong = (bifo)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        }
        if (paramLong == null) {
          break;
        }
  ...
  {
    TracePathData localTracePathData = null;
    List localList = this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager.rawQuery(TracePathData.class, "SELECT * FROM TracePathData WHERE isStop <> 1 order by startTime desc limit 1 ", null);
    if (localList != null) {
  ...
  public void b(int paramInt)
  {
    if (this.jdField_a_of_type_Biga != null)
    {
      SosoInterface.b(this.jdField_a_of_type_Biga);
      this.jdField_c_of_type_Int = paramInt;
  ...
  public void b(ArrayList<String> paramArrayList)
  {
    ...
    if (!this.jdField_d_of_type_Boolean)
    {
      ...
      {
        if (!auog.a(this.jdField_a_of_type_JavaLangString + (String)paramArrayList.get(m) + ".mp3"))
        {
      ...
      {
        if (paramArrayList.size() == 1) {
          bhkm.a(Uri.fromFile(new File(this.jdField_a_of_type_JavaLangString + (String)paramArrayList.get(0) + ".mp3")), false, true);
        }
      }
      else {
        return;
