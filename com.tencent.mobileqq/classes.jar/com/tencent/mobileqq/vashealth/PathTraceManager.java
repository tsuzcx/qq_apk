  ...
  implements Manager
{
  ...
  public PathTraceManager(BrowserAppInterface paramBrowserAppInterface)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new basa(this, Looper.getMainLooper());
    this.jdField_a_of_type_ComTencentMobileqqAppBrowserAppInterface = paramBrowserAppInterface;
    this.jdField_a_of_type_Atmp = this.jdField_a_of_type_ComTencentMobileqqAppBrowserAppInterface.getEntityManagerFactory().createEntityManager();
    this.jdField_c_of_type_Int = -1;
    this.jdField_a_of_type_ComTencentMobileqqPluginsdkPluginInterfaceHelper$OnPluginInterfaceLoadedListener = new barw(this);
    ...
    this.jdField_a_of_type_AndroidHardwareSensorEventListener = new barx(this);
  ...
  private JSONObject a(TracePointsData paramTracePointsData)
  {
    ...
    try
    {
      ...
      {
        paramTracePointsData = (barq)this.jdField_a_of_type_JavaLangRefWeakReference.get();
  ...
  public static void a(ArrayList<Uri> paramArrayList)
  {
    ...
    //   236: dup
    //   237: aload_0
    //   238: invokespecial 325	barz:<init>	(Ljava/util/ArrayList;)V
  ...
  private void b(List<TracePointsData> paramList)
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
      {
        paramList = (barq)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        if (paramList != null) {
  ...
  public TracePathData a(long paramLong)
  {
    ...
    localObject = this.jdField_a_of_type_Atmp.a(TracePathData.class, (String)localObject, null);
    if (localObject != null) {
  ...
  public List<TracePointsData> a(long paramLong)
  {
    ...
    localObject = this.jdField_a_of_type_Atmp.a(TracePointsData.class, (String)localObject, null);
  ...
  public JSONObject a()
  {
    JSONObject localJSONObject1 = new JSONObject();
    JSONArray localJSONArray = new JSONArray();
    Object localObject = this.jdField_a_of_type_Atmp.a(TracePathData.class);
    try
    {
  ...
  {
    if (this.jdField_a_of_type_Basc == null) {
      this.jdField_a_of_type_Basc = new basc(this, this.jdField_a_of_type_ComTencentMobileqqAppBrowserAppInterface);
    }
    this.jdField_c_of_type_Int = paramInt;
    SosoInterface.a(this.jdField_a_of_type_Basc);
    ...
    {
      localObject = (barq)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if ((localObject != null) && (((barq)localObject).mRuntime != null)) {
        if (((barq)localObject).mRuntime.a() == null) {
          break label149;
        }
      }
    }
    label149:
    for (Object localObject = ((barq)localObject).mRuntime.a().h;; localObject = null)
    {
  ...
  public void a(barq parambarq)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambarq);
  }
    ...
    if (this.jdField_c_of_type_Int == 1)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
          {
            localObject2 = (barq)this.jdField_a_of_type_JavaLangRefWeakReference.get();
            if (localObject2 != null)
            {
              ((barq)localObject2).dispatchJsEvent("PathTraceEnd", paramTracePointsData, new JSONObject());
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        return;
        localObject = new batm("http://imgcache.qq.com/ac/vasapp/webviewlib/2513/run_sd/audio715.zip", (File)localObject);
        ((batm)localObject).r = false;
        ((batm)localObject).q = true;
        if (this.jdField_a_of_type_Bato == null)
        {
          this.jdField_a_of_type_Bato = ((bato)this.jdField_a_of_type_ComTencentMobileqqAppBrowserAppInterface.getManager(47));
      ...
      return;
      this.jdField_a_of_type_Batr.a((batm)localObject, new bary(this, str, paramString), null);
      return;
      localObject = null;
    }
  }
  ...
  /* Error */
  public void a(List<atmo> paramList)
  {
    // Byte code:
    //   0: aload_1
    //   1: ifnull +12 -> 13
    ...
    //   32: checkcast 1074	atmo
    //   35: invokevirtual 1077	com/tencent/mobileqq/vashealth/PathTraceManager:a	(Latmo;)Z
    //   38: pop
    //   39: return
    //   40: aload_0
    //   41: getfield 103	com/tencent/mobileqq/vashealth/PathTraceManager:jdField_a_of_type_Atmp	Latmp;
    //   44: invokevirtual 1080	atmp:a	()Latmr;
    //   47: astore_2
    //   48: aload_2
    //   49: invokevirtual 1084	atmr:a	()V
    //   52: aload_1
    ...
    //   75: checkcast 1074	atmo
    //   78: invokevirtual 1077	com/tencent/mobileqq/vashealth/PathTraceManager:a	(Latmo;)Z
    //   81: pop
    //   82: goto -23 -> 59
    //   85: astore_1
    ...
    //   121: aload_2
    //   122: invokevirtual 1091	atmr:b	()V
    //   125: return
    //   126: aload_2
    //   127: invokevirtual 1092	atmr:c	()V
    //   130: aload_2
    //   131: invokevirtual 1091	atmr:b	()V
    //   134: return
    //   135: astore_1
    //   136: aload_2
    //   137: invokevirtual 1091	atmr:b	()V
    //   140: aload_1
    //   141: athrow
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	142	0	this	PathTraceManager
    //   0	142	1	paramList	List<atmo>
    //   47	90	2	localatmr	atmr
    // Exception table:
    //   from	to	target	type
  ...
  public boolean a(long paramLong)
  {
    ...
    if (this.jdField_a_of_type_JavaLangRefWeakReference != null) {}
    Object localObject;
    for (barq localbarq = (barq)this.jdField_a_of_type_JavaLangRefWeakReference.get();; localObject = null)
    {
      if ((this.jdField_a_of_type_ComTencentMobileqqVashealthTracePathData.totalTime < 60L) || (this.jdField_a_of_type_ComTencentMobileqqVashealthTracePathData.distance < 100.0D))
      {
        try
        {
          ...
          if (localbarq != null) {
            localbarq.dispatchJsEvent("PathTraceEnd", localJSONObject, new JSONObject());
          }
  ...
  public boolean a(atmo paramatmo)
  {
    if ((this.jdField_a_of_type_Atmp != null) && (this.jdField_a_of_type_Atmp.a()))
    {
      if (paramatmo.getStatus() == 1000)
      {
        ...
        return paramatmo.getStatus() == 1001;
      }
  ...
  public boolean a(Long paramLong)
  {
    ...
    bool = this.jdField_a_of_type_Atmp.b(paramLong);
    try
    {
      ...
      for (;;)
      {
        paramLong = null;
        if (this.jdField_a_of_type_JavaLangRefWeakReference != null) {
          paramLong = (barq)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        }
        if (paramLong == null) {
          break;
        }
  ...
  {
    TracePathData localTracePathData = null;
    List localList = this.jdField_a_of_type_Atmp.a(TracePathData.class, "SELECT * FROM TracePathData WHERE isStop <> 1 order by startTime desc limit 1 ", null);
    if (localList != null) {
  ...
  public void b(int paramInt)
  {
    if (this.jdField_a_of_type_Basc != null)
    {
      SosoInterface.b(this.jdField_a_of_type_Basc);
      this.jdField_c_of_type_Int = paramInt;
  ...
  public void b(ArrayList<String> paramArrayList)
  {
    ...
    if (!this.jdField_d_of_type_Boolean)
    {
      ...
      {
        if (!apdh.a(this.jdField_a_of_type_JavaLangString + (String)paramArrayList.get(m) + ".mp3"))
        {
      ...
      {
        if (paramArrayList.size() == 1) {
          baan.a(Uri.fromFile(new File(this.jdField_a_of_type_JavaLangString + (String)paramArrayList.get(0) + ".mp3")), false, true);
        }
      }
      else {
        return;
