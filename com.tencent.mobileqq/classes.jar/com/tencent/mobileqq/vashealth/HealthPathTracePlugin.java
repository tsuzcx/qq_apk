  ...
  extends WebViewPlugin
{
  ...
  protected boolean handleEvent(String paramString, long paramLong, Map paramMap)
  {
    boolean bool1 = false;
    boolean bool2 = false;
    Object localObject = (PathTraceManager)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(209);
  ...
  protected boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      paramVarArgs = (PathTraceManager)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(209);
    ...
    else if ("PathTraceStart".equals(paramString3))
    {
      ...
      if (Build.VERSION.SDK_INT < 19)
      {
        ...
        WebIPCOperator.a().b(paramString2);
      ...
      else
      {
        ...
        if ("PathTraceEnd".equals(paramString3))
        {
          ...
          for (;;)
          {
            ...
            WebIPCOperator.a().b(paramString1);
  ...
  protected void onCreate()
  {
    ...
    PathTraceManager localPathTraceManager = (PathTraceManager)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(209);
