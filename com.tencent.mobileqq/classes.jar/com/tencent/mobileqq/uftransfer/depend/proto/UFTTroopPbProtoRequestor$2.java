...
class UFTTroopPbProtoRequestor$2
  extends ProtoUtils.TroopProtocolObserver
{
  UFTTroopPbProtoRequestor$2(UFTTroopPbProtoRequestor paramUFTTroopPbProtoRequestor, UFTProtoRequestor.TroopReqUploadResponseCallback paramTroopReqUploadResponseCallback) {}
  ...
  public void onResult(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    if (paramInt != 0)
    {
      ...
      paramArrayOfByte.append("=_= ^! [CS Replay] troop reupload response is failed[");
    ...
    try
    {
      ...
      if (!localRspBody.resend_file_rsp.has())
      {
        UFTLog.d("[UFTTransfer] UFTTrpPbProtoRequestor", 1, "=_= ^! [CS Replay] troop reupload response error. rspBody has not upload_file_rsp");
        paramArrayOfByte = "no resend_file_rsp";
        paramInt = i;
      }
      else
      {
        ...
        {
          UFTLog.d("[UFTTransfer] UFTTrpPbProtoRequestor", 1, "=_= ^! [CS Replay] troop reupload response error. no retCode");
          paramArrayOfByte = "no resend_file_rsp retcode";
          paramInt = i;
        }
        else
        {
    ...
    UFTLog.d("[UFTTransfer] UFTTrpPbProtoRequestor", 1, "=_= ^! [CS Replay] troop reupload response error. parse reponseContent excption");
    ...
    paramArrayOfByte = new StringBuilder();
    paramArrayOfByte.append("[CS Replay] troop reupload response. bReqSuc:");
