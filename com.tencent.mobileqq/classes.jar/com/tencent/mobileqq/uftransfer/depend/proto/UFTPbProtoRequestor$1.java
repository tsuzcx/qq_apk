...
class UFTPbProtoRequestor$1
  implements ProtoReqManagerImpl.IProtoRespBack
{
  UFTPbProtoRequestor$1(UFTPbProtoRequestor paramUFTPbProtoRequestor, UFTProtoRequestor.C2CReqUploadResponseCallback paramC2CReqUploadResponseCallback) {}
  
  public void onProtoResp(ProtoReqManagerImpl.ProtoResp paramProtoResp, ProtoReqManagerImpl.ProtoReq paramProtoReq)
  {
    UFTLog.b("[UFTTransfer] UFTPbProtoRequestor", 1, "=_= ^> [CS Replay] response V2");
    ...
    try
    {
      ...
      {
        UFTLog.d("[UFTTransfer] UFTPbProtoRequestor", 1, "=_= ^! [CS Replay] response V2 error. rspBody has not hasMsgApplyUploadRsp");
        paramProtoReq = "no msg_apply_upload_rsp_v2 ";
      }
      else
      {
        localUFTC2CUploadRsp = UFTPbProtoHelper.a((cmd0x346.ApplyUploadRspV2)localRspBody.msg_apply_upload_rsp_v2.get());
    ...
    UFTLog.d("[UFTTransfer] UFTPbProtoRequestor", 1, "=_= ^! [CS Replay] response V2 error. parse reponseContent excption");
    ...
    paramProtoResp.append("[CS Replay] response V2. bReqSuc:");
 ...
 * Qualified Name:     com.tencent.mobileqq.uftransfer.depend.proto.UFTPbProtoRequestor.1
