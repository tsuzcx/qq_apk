  ...
  implements INetInfoHandler, IUFTTransferService
{
  ...
  public void onNetMobile2None()
  {
    ...
    UFTLogicThread.a().a(new UFTTransferServiceImpl.10(this));
  }
  ...
  public void onNetNone2Mobile(String paramString)
  {
    ...
    UFTLogicThread.a().a(new UFTTransferServiceImpl.6(this, paramString));
  }
  ...
  public void stop(IUFTTransferKey paramIUFTTransferKey, Bundle paramBundle)
  {
    ...
    UFTLogicThread.a().a(new UFTTransferServiceImpl.5(this, localUFTTransferKey, paramBundle));
  }
  ...
  {
    UFTTransferKey localUFTTransferKey = new UFTTransferKey(1, paramUFTC2CUploadInfo.b());
    localUFTTransferKey.a(paramUFTC2CUploadInfo.a());
  ...
  {
    UFTTransferKey localUFTTransferKey = new UFTTransferKey(3, paramUFTDiscUploadInfo.b());
    localUFTTransferKey.a(paramUFTDiscUploadInfo.a());
    UFTLogicThread.a().a(new UFTTransferServiceImpl.4(this, paramUFTDiscUploadInfo, localUFTTransferKey, paramUFTTransferConfig, paramIUFTUploadCallback));
    return localUFTTransferKey;
  }
  ...
  {
    UFTTransferKey localUFTTransferKey = new UFTTransferKey(2, paramUFTTroopUploadInfo.b());
    localUFTTransferKey.a(paramUFTTroopUploadInfo.a());
    UFTLogicThread.a().a(new UFTTransferServiceImpl.3(this, paramUFTTroopUploadInfo, localUFTTransferKey, paramUFTTransferConfig, paramIUFTUploadCallback));
    return localUFTTransferKey;
  }
}
