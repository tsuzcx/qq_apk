...
public class VideoSprite
  extends ayck
  implements SurfaceTexture.OnFrameAvailableListener, aycd, aycl, Runnable
{
  ...
  public VideoSprite(SpriteGLView paramSpriteGLView, Context paramContext, boolean paramBoolean)
  {
    ...
    this.jdField_b_of_type_Aybf = new aybf(0.0F, 0.0F);
    ...
    for (float f1 = 0.5F;; f1 = 1.0F)
    {
      ...
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnCompletionListener(new ayco(this));
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnErrorListener(new aycp(this));
      paramSpriteGLView.a(this);
      paramSpriteGLView.b(new VideoSprite.3(this));
      return;
    }
  }
  ...
  protected String a()
  {
    return aycz.a(this.jdField_b_of_type_ComTencentMobileqqSurfaceviewactionGlSpriteGLView.getContext(), "troop" + File.separator + "shaders" + File.separator + "VertexShaderVideo.glsl");
  }
      ...
      catch (Exception localException2)
      {
        try
        {
          for (;;)
          {
            ...
            this.jdField_a_of_type_Aycs = null;
            this.jdField_b_of_type_ComTencentMobileqqSurfaceviewactionGlSpriteGLView.b(new VideoSprite.7(this));
  ...
  protected void a(int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Float != 0.0F)
    {
      ...
      f1 = this.jdField_b_of_type_Aybf.jdField_a_of_type_Float * b() / this.jdField_h_of_type_Float / paramInt1;
      label171:
      if (!this.jdField_c_of_type_Boolean) {
        break label385;
      }
    ...
    label385:
    for (float f3 = this.jdField_b_of_type_Aybf.jdField_b_of_type_Float * b() / this.jdField_h_of_type_Float / paramInt2;; f3 = (this.jdField_b_of_type_Aybf.jdField_b_of_type_Float * b() - paramInt2 / 2) / this.jdField_h_of_type_Float / paramInt2)
    {
      ...
      break label62;
      label356:
      f1 = (this.jdField_b_of_type_Aybf.jdField_a_of_type_Float * b() - paramInt1 / 2) / this.jdField_h_of_type_Float / paramInt1;
      break label171;
    }
  }
  ...
  public void a(aycs paramaycs)
  {
    this.jdField_a_of_type_Aycs = paramaycs;
  }
  
  public void a(ayct paramayct)
  {
    this.jdField_a_of_type_Ayct = paramayct;
  }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    this.jdField_b_of_type_ComTencentMobileqqSurfaceviewactionGlSpriteGLView.b(new VideoSprite.5(this, paramString, paramInt));
  }
  ...
  protected String b()
  {
    return aycz.a(this.jdField_b_of_type_ComTencentMobileqqSurfaceviewactionGlSpriteGLView.getContext(), "troop" + File.separator + "shaders" + File.separator + "FragmentShaderVideo.glsl");
  }
  ...
  public void c(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, float[] paramArrayOfFloat)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 291	com/tencent/mobileqq/surfaceviewaction/gl/VideoSprite:jdField_h_of_type_Boolean	Z
    //   6: ifne +6 -> 12
    //   9: aload_0
    //   10: monitorexit
    //   11: return
    ...
    //   13: monitorexit
    //   14: aload_0
    //   15: getfield 412	com/tencent/mobileqq/surfaceviewaction/gl/VideoSprite:m	I
    //   18: invokestatic 415	android/opengl/GLES20:glUseProgram	(I)V
    //   21: aload_0
    //   22: monitorenter
    //   23: aload_0
    //   24: getfield 417	com/tencent/mobileqq/surfaceviewaction/gl/VideoSprite:jdField_e_of_type_Boolean	Z
    //   27: istore 9
    //   29: iload 9
    //   31: ifeq +54 -> 85
    //   34: aload_0
    //   35: getfield 213	com/tencent/mobileqq/surfaceviewaction/gl/VideoSprite:jdField_a_of_type_AndroidGraphicsSurfaceTexture	Landroid/graphics/SurfaceTexture;
    //   38: invokevirtual 420	android/graphics/SurfaceTexture:updateTexImage	()V
    //   41: aload_0
    //   42: getfield 213	com/tencent/mobileqq/surfaceviewaction/gl/VideoSprite:jdField_a_of_type_AndroidGraphicsSurfaceTexture	Landroid/graphics/SurfaceTexture;
    //   45: aload_0
    //   46: getfield 68	com/tencent/mobileqq/surfaceviewaction/gl/VideoSprite:jdField_f_of_type_ArrayOfFloat	[F
    //   49: invokevirtual 424	android/graphics/SurfaceTexture:getTransformMatrix	([F)V
    //   52: aload_0
    //   53: iconst_0
    //   54: putfield 417	com/tencent/mobileqq/surfaceviewaction/gl/VideoSprite:jdField_e_of_type_Boolean	Z
    //   57: aload_0
    //   58: getfield 426	com/tencent/mobileqq/surfaceviewaction/gl/VideoSprite:jdField_i_of_type_Boolean	Z
    //   61: ifeq +24 -> 85
    //   64: aload_0
    //   65: getfield 295	com/tencent/mobileqq/surfaceviewaction/gl/VideoSprite:jdField_a_of_type_Aycs	Laycs;
    //   68: ifnull +17 -> 85
    //   71: aload_0
    //   72: iconst_0
    //   73: putfield 426	com/tencent/mobileqq/surfaceviewaction/gl/VideoSprite:jdField_i_of_type_Boolean	Z
    //   76: aload_0
    //   77: getfield 295	com/tencent/mobileqq/surfaceviewaction/gl/VideoSprite:jdField_a_of_type_Aycs	Laycs;
    //   80: invokeinterface 430 1 0
    //   85: aload_0
    //   86: monitorexit
    //   87: aload_0
    //   88: iload_1
    //   89: iload_2
    //   90: invokevirtual 432	com/tencent/mobileqq/surfaceviewaction/gl/VideoSprite:b	(II)V
    //   93: return
    //   94: astore 8
    //   96: aload_0
    //   97: monitorexit
    ...
    //   100: athrow
    //   101: astore 8
    //   103: invokestatic 237	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   106: ifeq -54 -> 52
    //   109: ldc 239
    //   111: iconst_2
    //   112: aload 8
    //   114: invokestatic 243	com/tencent/qphone/base/util/QLog:getStackTraceString	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   117: invokestatic 265	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   120: goto -68 -> 52
    //   123: astore 8
    //   125: aload_0
    //   126: monitorexit
      ...
      catch (Exception localException2)
      {
        try
        {
          for (;;)
          {
            ...
            this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnPreparedListener(new aycq(this));
            this.jdField_b_of_type_JavaLangString = paramString;
            return;
            localException1 = localException1;
            if (QLog.isColorLevel())
  ...
  protected void h()
  {
    ...
    this.jdField_b_of_type_ComTencentMobileqqSurfaceviewactionGlSpriteGLView.b(new VideoSprite.6(this));
  }
  ...
  {
    int i2;
    if ((this.jdField_a_of_type_AndroidMediaMediaPlayer != null) && (this.jdField_a_of_type_Ayct != null))
    {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Ayct.a(i1);
      return;
    }
    catch (Exception localException)
    {
