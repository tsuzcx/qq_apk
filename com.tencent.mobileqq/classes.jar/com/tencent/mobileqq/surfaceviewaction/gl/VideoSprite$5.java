  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    try
    {
      ...
      this.this$0.jdField_a_of_type_AndroidMediaMediaPlayer.setOnSeekCompleteListener(new ayct(this));
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        if (this.this$0.jdField_a_of_type_Aycd != null) {
          this.this$0.jdField_a_of_type_Aycd.a();
        }
      }
    }
  }
