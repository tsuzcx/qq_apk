  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    try
    {
      ...
      this.this$0.jdField_a_of_type_AndroidMediaMediaPlayer.setOnSeekCompleteListener(new bdyv(this));
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        if (this.this$0.jdField_a_of_type_Bdyi != null) {
          this.this$0.jdField_a_of_type_Bdyi.a();
        }
      }
    }
  }
