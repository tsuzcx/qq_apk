  ...
  extends SpriteGLView
{
  ...
  public RobotSpriteVideoView(Context paramContext, boolean paramBoolean, String paramString1, String paramString2, ImageButton.OnClickListener paramOnClickListener)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqSurfaceviewactionGlVideoSprite = new aiqd(this, this, getContext(), paramBoolean);
    ...
    try
    {
      this.jdField_a_of_type_ComTencentMobileqqSurfaceviewactionGlImageButton = new ImageButton(this, BitmapFactory.decodeResource(paramContext.getResources(), 2130844064), true);
