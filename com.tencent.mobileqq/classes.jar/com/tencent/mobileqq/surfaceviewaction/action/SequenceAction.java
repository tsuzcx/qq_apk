  ...
  extends Action
{
  ...
  public void a()
  {
    ...
    if (arrayOfAction.length > 0) {
      this.jdField_a_of_type_ComTencentMobileqqSurfaceviewactionActionAction = arrayOfAction[this.f];
    }
  }
  ...
  {
    int i = this.f;
    if ((i + 1 < this.jdField_a_of_type_ArrayOfComTencentMobileqqSurfaceviewactionActionAction.length) && (paramInt > this.jdField_a_of_type_ArrayOfInt[(i + 1)]))
    {
    ...
    i = paramInt - this.jdField_a_of_type_ArrayOfInt[this.f];
    float f2 = i;
    float f1 = f2 / this.jdField_a_of_type_ComTencentMobileqqSurfaceviewactionActionAction.jdField_c_of_type_Int;
    ...
    else if (this.jdField_a_of_type_ComTencentMobileqqSurfaceviewactionActionAction.e == 2)
    {
      f1 = f2 / this.jdField_a_of_type_ComTencentMobileqqSurfaceviewactionActionAction.jdField_c_of_type_Int;
      f1 = (2.0F - f1) * f1;
    }
