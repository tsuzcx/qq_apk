  ...
  implements PrecoverListener
{
  ...
  private PrecoverManager jdField_a_of_type_ComTencentMobileqqPrecoverPrecoverManager = null;
  private QIPCModule jdField_a_of_type_ComTencentMobileqqQipcQIPCModule = new PrecoverIPCServer.1(this, "PrecoverIPCServer_MODEL");
  ...
  private PrecoverIPCServer()
  {
    if ((BaseApplicationImpl.getApplication().getRuntime() instanceof QQAppInterface))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqPrecoverPrecoverManager = ((PrecoverManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.PRECOVER_MANAGER));
