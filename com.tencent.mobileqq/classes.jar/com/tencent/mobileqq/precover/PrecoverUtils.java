...
public class PrecoverUtils
{
  ...
  public static Pair<PrecoverBusinessInfo, List<PrecoverResource>> a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if ((localObject4 == null) || (!((PrecoverBusinessInfo)localObject4).a()) || (localArrayList.size() <= 0)) {
        break;
      }
      ...
      while (paramString.hasNext())
      {
        ...
        if (localObject1 != null) {
          ((PrecoverResource)localObject1).businessId = ((PrecoverBusinessInfo)localObject4).a;
        }
      }
      localObject3 = paramString;
      ...
      else
      {
        ...
        if ("PrecoverInfo".equalsIgnoreCase((String)localObject1))
        {
          ...
          {
            localObject3 = paramString;
            paramString = new PrecoverBusinessInfo();
          }
        }
      }
      try
