...
public class PrecoverManager$2
  implements Runnable
{
  public PrecoverManager$2(awjh paramawjh, String paramString) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      synchronized (awjh.a(this.this$0))
      {
        if (TextUtils.isEmpty(this.a))
        {
          Object localObject1 = awjh.a(this.this$0).keySet();
          ...
          localObject5 = (List)awjh.a(this.this$0).get(localObject5);
    ...
    if ((this.a == null) && (awjn.a(awjh.a(this.this$0).getApp(), "res_cover"))) {}
    for (;;)
    {
      if (bool1)
      {
        awjn.a(awjh.a(this.this$0).getApp(), "res_cover");
        awjh.a(this.this$0, true);
        awjh.a(this.this$0, new HashSet());
        awjh.a(this.this$0).a(this.this$0);
      }
      if (QLog.isColorLevel()) {
      ...
      while (((Iterator)localObject3).hasNext())
      {
        ...
        {
          if ((bool1) && (awjh.a(this.this$0) != null)) {
            awjh.a(this.this$0).add(localObject4);
          }
          boolean bool2 = awjh.a(this.this$0).a((PrecoverResource)localObject4, null, true, false);
          if ((bool1) && (awjh.a(this.this$0) != null) && (!bool2)) {
            awjh.a(this.this$0).remove(localObject4);
          }
          if (QLog.isColorLevel()) {
      ...
      if ((bool1) && (awjh.a(this.this$0) != null) && (awjh.a(this.this$0).size() == 0))
      {
        if (QLog.isColorLevel()) {
          QLog.d("PrecoverManager", 2, "startDownload, nothing need download, doing report");
        }
        awjh.a(this.this$0, false);
        awjh.a(this.this$0).b(this.this$0);
