...
public class PrecoverReporter
{
  ...
  public void a()
  {
    ...
    {
      localObject1 = "1";
      ReportController.b((AppRuntime)localObject4, "CliOper", "", "", "0X8007134", "0X8007134", 0, 0, String.valueOf(j), (String)localObject1, "id_all", "");
    ...
    {
      ReportController.b((AppRuntime)localObject5, "CliOper", "", "", "0X8007134", "0X8007134", 0, 0, String.valueOf(j), (String)localObject1, "id_" + (String)localObject4, "");
      break label471;
      localObject1 = "0";
      break;
    }
    for (;;)
    {
      ...
      {
        label578:
        localObject1 = (EarlyDownloadManager)this.a.a().getManager(QQManagerFactory.EARLY_DOWNLOAD_MANAGER);
        ...
        bool1 = ((PrecoverHandler)localObject1).i();
