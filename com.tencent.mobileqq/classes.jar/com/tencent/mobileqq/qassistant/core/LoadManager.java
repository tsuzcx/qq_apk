...
public class LoadManager
{
  ...
  public static void a(List<String> paramList, String paramString, LoadManager.LoadCallBack paramLoadCallBack)
  {
    ...
    {
      if (!a(paramList)) {
        a("voice", b(), paramList, jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean, paramString, paramLoadCallBack);
      }
      return;
    }
  }
  ...
  public static boolean a()
  {
    ...
    if ((!HelloQQHelper.a()) || (HelloQQHelper.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())) {
      return false;
    }
  ...
  public static boolean a(String paramString1, String paramString2, List<String> paramList, AtomicBoolean paramAtomicBoolean, String paramString3, LoadManager.LoadCallBack paramLoadCallBack)
  {
    ...
    if (!bool)
    {
      ...
      {
        AssistantUtils.a(paramString3, "DownLoadZipFile  mkdirs failure：" + paramList.getPath());
        return bool;
      }
      if (paramAtomicBoolean.compareAndSet(false, true)) {
        ThreadManagerV2.excute(new LoadManager.1(paramString3, paramList, paramString1, paramAtomicBoolean, paramLoadCallBack, "https://down.qq.com/helloqq/" + paramString2 + ".zip"), 128, null, true);
      }
    }
    for (;;)
    {
  ...
  public static boolean a(String paramString, List<String> paramList)
  {
    ...
    try
    {
      ...
      while (paramList.hasNext())
      {
        ...
        {
          AssistantUtils.a("HelloQQWake", "hasModel() not file :" + paramString + str);
          return false;
        }
      }
    }
