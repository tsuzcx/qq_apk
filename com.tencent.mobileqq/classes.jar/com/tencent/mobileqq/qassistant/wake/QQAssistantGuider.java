  ...
  extends ReportDialog
{
  ...
  {
    super(paramAppActivity, 2131755211);
  ...
  public static void a(boolean paramBoolean)
  {
    ...
    try
    {
      ...
      localEditor.apply();
      AssistantUtils.a("HelloQQWake", "setNeedOpenGuide:" + jdField_a_of_type_Boolean);
      return;
    }
  ...
  public static boolean a()
  {
    ...
    try
    {
      ...
      AssistantUtils.a("HelloQQWake", "getNeedOpenGuide:" + jdField_a_of_type_Boolean);
  ...
  public void dismiss()
  {
    ...
    if (this.jdField_a_of_type_Int > 0) {
      ReportController.b(null, "dc00898", "", "", "0X800B44B", "0X800B44B", this.jdField_a_of_type_Int, 0, "", "", "", "");
    }
    if (this.d) {
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    paramBundle = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131561116, null);
    ...
    this.jdField_a_of_type_ComTencentMobileqqQassistantViewVoicePanelSlideContainer = ((VoicePanelSlideContainer)paramBundle.findViewById(2131378240));
    ...
    ((ImageView)paramBundle.findViewById(2131362987)).setOnClickListener(new QQAssistantGuider.2(this));
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      localObject = (TextView)paramBundle.findViewById(2131378267);
      localButton = (Button)paramBundle.findViewById(2131363800);
      ((Button)paramBundle.findViewById(2131363799)).setOnClickListener(new QQAssistantGuider.3(this));
      if ((!bool1) || (!bool2)) {
        break;
      }
