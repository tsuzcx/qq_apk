...
public class ShowOverSelectViewCommand
  implements IVoiceCommand
{
  private IBasePresenter a;
  
  public ShowOverSelectViewCommand(IBasePresenter paramIBasePresenter)
  {
  ...
  public void a(CommandInfo paramCommandInfo)
  {
    ...
    if (localIBasePresenter != null) {
      localIBasePresenter.m(paramCommandInfo);
    }
  }
}
 ...
 * Qualified Name:     com.tencent.mobileqq.qassistant.command.ShowOverSelectViewCommand
