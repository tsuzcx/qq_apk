...
public class CancelSendCommand
  implements IVoiceCommand
{
  private IBasePresenter a;
  
  public CancelSendCommand(IBasePresenter paramIBasePresenter)
  {
  ...
  public void a(CommandInfo paramCommandInfo)
  {
    ...
    if (localIBasePresenter != null) {
      localIBasePresenter.j(paramCommandInfo);
    }
  }
}
 ...
 * Qualified Name:     com.tencent.mobileqq.qassistant.command.CancelSendCommand
