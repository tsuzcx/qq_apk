  ...
  extends MessageMicro<VoiceAssistantASRResp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 34, 40, 48, 61, 66, 74 }, new String[] { "uint32_ret_code", "str_voice_id", "uint32_is_final", "str_text", "uint32_ack_offset", "int32_ack_len", "time_use", "contact_res", "reco_res" }, new Object[] { localInteger, "", localInteger, "", localInteger, localInteger, Float.valueOf(0.0F), null, null }, VoiceAssistantASRResp.class);
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes7.jar
 * Qualified Name:     com.tencent.mobileqq.qassistant.proto.cmd67.VoiceAssistantASRResp
