...
public class VoiceViewUtils
{
  ...
  {
    return LayoutInflater.from(paramContext).inflate(2131563221, paramViewGroup, false);
  }
  ...
  public static TextView a(@NonNull Context paramContext)
  {
    ...
    paramContext.setShadowLayer(0.0F, ScreenUtil.dip2px(0.5F), ScreenUtil.dip2px(1.5F), 2131167366);
  ...
  {
    return LayoutInflater.from(paramContext).inflate(2131563219, paramViewGroup, false);
  }
  ...
  public static TextView b(@NonNull Context paramContext)
  {
    ...
    localTextView.setTextColor(paramContext.getResources().getColor(2131167356));
    localTextView.setTextSize(1, 14.0F);
    localTextView.setShadowLayer(0.0F, ScreenUtil.dip2px(0.5F), ScreenUtil.dip2px(1.5F), 2131167366);
    return localTextView;
  }
  
  public static View c(@NonNull Context paramContext, ViewGroup paramViewGroup)
  {
    return LayoutInflater.from(paramContext).inflate(2131563217, paramViewGroup, false);
  }
  ...
  {
    return LayoutInflater.from(paramContext).inflate(2131563218, paramViewGroup, false);
  }
