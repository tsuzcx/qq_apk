...
public class WifiSdkUtil
{
  ...
  public static java.util.List<String> a(File paramFile)
  {
    ...
    //   2: aconst_null
    //   3: astore 4
    //   5: new 143	java/util/ArrayList
    //   8: dup
    //   9: invokespecial 144	java/util/ArrayList:<init>	()V
    //   12: astore 6
    ...
    //   31: astore_1
    //   32: new 156	java/io/BufferedReader
    //   35: dup
    //   36: aload_1
    //   37: invokespecial 159	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   40: astore 4
    //   42: aload 4
    ...
    //   73: aload 5
    //   75: astore_0
    //   76: invokestatic 83	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   79: ifeq +31 -> 110
    //   82: ldc 85
    //   84: iconst_2
    ...
    //   97: aload_0
    //   98: invokevirtual 97	java/lang/Throwable:getMessage	()Ljava/lang/String;
    ...
    //   107: invokestatic 104	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   110: aload_2
    //   111: ifnull +7 -> 118
    //   114: aload_2
    //   115: invokevirtual 172	java/io/FileInputStream:close	()V
    //   118: aload_3
    //   119: ifnull +7 -> 126
    //   122: aload_3
    //   123: invokevirtual 173	java/io/InputStreamReader:close	()V
    //   126: aload_1
    //   127: ifnull +7 -> 134
    //   130: aload_1
    //   131: invokevirtual 174	java/io/BufferedReader:close	()V
    //   134: aload 6
    //   136: areturn
    //   137: aload_0
    //   138: ifnull +7 -> 145
    //   141: aload_0
    //   142: invokevirtual 172	java/io/FileInputStream:close	()V
    //   145: aload_1
    //   146: ifnull +7 -> 153
    //   149: aload_1
    //   150: invokevirtual 173	java/io/InputStreamReader:close	()V
    //   153: aload 4
    //   155: ifnull -21 -> 134
    //   158: aload 4
    //   160: invokevirtual 174	java/io/BufferedReader:close	()V
    //   163: aload 6
    //   165: areturn
    //   166: astore_0
    //   167: aload_0
    //   168: invokevirtual 177	java/lang/Throwable:printStackTrace	()V
    //   171: aload 6
    //   173: areturn
    //   174: astore_0
    //   175: aload_0
    ...
    //   188: ifnull +7 -> 195
    //   191: aload_2
    //   192: invokevirtual 172	java/io/FileInputStream:close	()V
    //   195: aload_3
    //   196: ifnull +7 -> 203
    //   199: aload_3
    //   200: invokevirtual 173	java/io/InputStreamReader:close	()V
    //   203: aload_1
    //   204: ifnull +7 -> 211
    //   207: aload_1
    //   208: invokevirtual 174	java/io/BufferedReader:close	()V
    //   211: aload_0
    //   212: athrow
    //   213: astore_1
    //   214: aload_1
    //   215: invokevirtual 177	java/lang/Throwable:printStackTrace	()V
    //   218: goto -7 -> 211
    //   221: astore 4
    //   223: aconst_null
    //   224: astore_1
  ...
  public static byte[] a(File paramFile)
  {
    ...
    //   0: aconst_null
    //   1: astore 6
    //   3: new 192	java/io/BufferedInputStream
    //   6: dup
    //   7: new 146	java/io/FileInputStream
    //   10: dup
    //   11: aload_0
    //   12: invokespecial 149	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   15: invokespecial 193	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   18: astore_2
    //   19: new 195	java/io/ByteArrayOutputStream
    //   22: dup
    //   23: invokespecial 196	java/io/ByteArrayOutputStream:<init>	()V
    //   26: astore_0
    //   27: aload_0
    //   28: astore 4
    //   30: aload_2
    ...
    //   44: aload_2
    //   45: aload 5
    //   47: invokevirtual 200	java/io/BufferedInputStream:read	([B)I
    //   50: istore_1
    //   51: iload_1
    //   52: iconst_m1
    //   53: if_icmpeq +90 -> 143
    ...
    //   64: iconst_0
    //   65: iload_1
    //   66: invokevirtual 204	java/io/ByteArrayOutputStream:write	([BII)V
    //   69: goto -30 -> 39
    //   72: astore 5
    //   74: aload_0
    //   75: astore 4
    //   77: aload_2
    //   78: astore_3
    //   79: invokestatic 83	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   82: ifeq +37 -> 119
    //   85: aload_0
    //   86: astore 4
    //   88: aload_2
    ...
    //   90: ldc 85
    //   92: iconst_2
    //   93: new 87	java/lang/StringBuilder
    //   96: dup
    //   97: invokespecial 88	java/lang/StringBuilder:<init>	()V
    //   100: ldc 206
    //   102: invokevirtual 94	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   105: aload 5
    //   107: invokevirtual 97	java/lang/Throwable:getMessage	()Ljava/lang/String;
    ...
    //   116: invokestatic 104	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   119: aload_0
    //   120: ifnull +7 -> 127
    //   123: aload_0
    //   124: invokevirtual 207	java/io/ByteArrayOutputStream:close	()V
    //   127: aload 6
    //   129: astore_0
    //   130: aload_2
    //   131: ifnull +10 -> 141
    //   134: aload_2
    //   135: invokevirtual 208	java/io/BufferedInputStream:close	()V
    //   138: aload 6
    //   140: astore_0
    //   141: aload_0
    //   142: areturn
    ...
    //   147: astore_3
    //   148: aload_0
    //   149: invokevirtual 212	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   152: astore 5
    //   154: aload 5
    //   156: astore_3
    //   157: aload_0
    ...
    //   168: ifnull -27 -> 141
    //   171: aload_2
    //   172: invokevirtual 208	java/io/BufferedInputStream:close	()V
    //   175: aload_3
    //   176: areturn
    //   177: astore_0
    //   178: aload_0
    //   179: invokevirtual 213	java/io/IOException:printStackTrace	()V
    //   182: aload_3
    //   183: areturn
    //   184: astore_0
    //   185: aload_0
    ...
    //   215: ifnull +8 -> 223
    //   218: aload 4
    //   220: invokevirtual 207	java/io/ByteArrayOutputStream:close	()V
    //   223: aload_2
    //   224: ifnull +7 -> 231
    //   227: aload_2
    //   228: invokevirtual 208	java/io/BufferedInputStream:close	()V
    //   231: aload_0
    //   232: athrow
    //   233: astore_3
    //   234: aload_3
    //   235: invokevirtual 213	java/io/IOException:printStackTrace	()V
    //   238: goto -15 -> 223
    //   241: astore_2
    //   242: aload_2
    //   243: invokevirtual 213	java/io/IOException:printStackTrace	()V
    //   246: goto -15 -> 231
    //   249: astore_0
    //   250: aconst_null
    //   251: astore 4
  ...
  private static String d(String paramString)
  {
    ...
    //   13: aload_0
    //   14: aastore
    //   15: invokestatic 314	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   18: invokespecial 239	java/io/File:<init>	(Ljava/lang/String;)V
    //   21: invokestatic 343	com/tencent/mobileqq/wifi/WifiSdkUtil:a	(Ljava/io/File;)Ljava/util/List;
    //   24: astore_0
    //   25: aload_0
    //   26: ifnull +87 -> 113
    //   29: aload_0
    //   30: invokeinterface 346 1 0
    //   35: iconst_1
    //   36: if_icmpne +77 -> 113
    //   39: aload_0
    //   40: iconst_0
    //   41: invokeinterface 349 2 0
    //   46: checkcast 33	java/lang/String
    //   49: astore_1
    //   50: aload_1
    //   51: astore_0
    //   52: aload_1
    //   53: invokestatic 61	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   56: ifne +8 -> 64
    //   59: aload_1
    //   60: invokevirtual 352	java/lang/String:trim	()Ljava/lang/String;
    //   63: astore_0
    //   64: aload_0
    //   65: areturn
    //   66: astore_2
    ...
    //   84: dup
    //   85: invokespecial 88	java/lang/StringBuilder:<init>	()V
    //   88: ldc_w 354
    //   91: invokevirtual 94	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   94: aload_2
    //   95: invokevirtual 97	java/lang/Throwable:getMessage	()Ljava/lang/String;
    ...
    //   104: invokestatic 104	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   107: aload_1
    //   108: areturn
    //   109: astore_2
    //   110: goto -40 -> 70
