  ...
  implements Runnable
{
  ...
  public void run()
  {
    String str = this.jdField_a_of_type_AndroidAppActivity.getString(2131692367);
    bglp.a(this.jdField_a_of_type_AndroidAppActivity, 0, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, this.jdField_c_of_type_JavaLangString, this.d, str, this.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener, this.jdField_b_of_type_AndroidContentDialogInterface$OnClickListener, this.jdField_c_of_type_AndroidContentDialogInterface$OnClickListener).show();
    if (this.jdField_a_of_type_Int == 1)
    {
      bigl.b(this.jdField_a_of_type_AndroidAppActivity, 398667);
      bigl.a("0X80094F2");
    }
    do
    {
      ...
      {
        bigl.b(this.jdField_a_of_type_AndroidAppActivity, 398670);
        bigl.a("0X80094F3");
        return;
      }
    } while (this.jdField_a_of_type_Int != 4);
    bigl.b(this.jdField_a_of_type_AndroidAppActivity, 398689);
    bigl.a("0X80094F1");
  }
}
