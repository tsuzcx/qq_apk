  ...
  implements Runnable
{
  ...
  public void run()
  {
    String str = this.jdField_a_of_type_AndroidAppActivity.getString(2131692420);
    bfur.a(this.jdField_a_of_type_AndroidAppActivity, 0, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, this.jdField_c_of_type_JavaLangString, this.d, str, this.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener, this.jdField_b_of_type_AndroidContentDialogInterface$OnClickListener, this.jdField_c_of_type_AndroidContentDialogInterface$OnClickListener).show();
    if (this.jdField_a_of_type_Int == 1)
    {
      bhnb.b(this.jdField_a_of_type_AndroidAppActivity, 398667);
      bhnb.a("0X80094F2");
    }
    do
    {
      ...
      {
        bhnb.b(this.jdField_a_of_type_AndroidAppActivity, 398670);
        bhnb.a("0X80094F3");
        return;
      }
    } while (this.jdField_a_of_type_Int != 4);
    bhnb.b(this.jdField_a_of_type_AndroidAppActivity, 398689);
    bhnb.a("0X80094F1");
  }
}
