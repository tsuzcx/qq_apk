...
public class MiniAppJumpUtil
{
  ...
  public static boolean a(Activity paramActivity, MiniAppJumpUtil.JumpParam paramJumpParam, Bundle paramBundle)
  {
    ...
    while ((paramJumpParam.jdField_a_of_type_Int == 4) || (paramJumpParam.jdField_a_of_type_Int != 3)) {
      return false;
    }
  ...
  public static boolean a(BaseActivity paramBaseActivity, String paramString, MessageRecord paramMessageRecord)
  {
    ...
    if (paramMessageRecord.istroop == 1)
    {
      ...
      if ((TroopUtils.a(localQQAppInterface, paramMessageRecord.frienduin, localQQAppInterface.getCurrentUin())) || (TroopUtils.b(localQQAppInterface, paramMessageRecord.frienduin, localQQAppInterface.getCurrentUin())))
      {
        bool = true;
