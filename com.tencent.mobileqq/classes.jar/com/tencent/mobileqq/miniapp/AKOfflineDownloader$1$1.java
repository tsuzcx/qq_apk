  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    AKOfflineDownloader.a(this.a.f.a(localBundle), this.a.b, this.a.c, 1, this.a.a, this.a.d);
    QLog.d("AKOfflineDownloader", 2, new Object[] { " checkUpByBusinessId load success. param null. cost=", Long.valueOf(System.currentTimeMillis() - this.a.e) });
  }
}
