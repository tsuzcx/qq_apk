...
public class QQGuildDiscoverRefreshHeader
  extends RelativeLayout
  implements QQGuildDiscoverRefreshLayout.SwipeRefreshTrigger, QQGuildDiscoverRefreshLayout.SwipeTrigger, IPullRefreshHeader
{
  public long a = 0L;
  private int b = 0;
  private Context c;
  ...
  private int r = 0;
  private int s;
  private QQGuildDiscoverRefreshHeader.OnRefreshHeaderUpdateListener t;
  
  public QQGuildDiscoverRefreshHeader(Context paramContext)
  {
    this(paramContext, null);
  }
  
  public QQGuildDiscoverRefreshHeader(Context paramContext, AttributeSet paramAttributeSet)
  {
    this(paramContext, paramAttributeSet, 0);
  }
  
  public QQGuildDiscoverRefreshHeader(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
  ...
  {
    QQGuildDiscoverRefreshHeader.OnRefreshHeaderUpdateListener localOnRefreshHeaderUpdateListener = this.t;
  ...
  public void setRefreshHeaderUpdateListener(QQGuildDiscoverRefreshHeader.OnRefreshHeaderUpdateListener paramOnRefreshHeaderUpdateListener)
  {
 ...
 * Qualified Name:     com.tencent.mobileqq.guild.mainframe.container.discover.view.QQGuildDiscoverRefreshHeader
