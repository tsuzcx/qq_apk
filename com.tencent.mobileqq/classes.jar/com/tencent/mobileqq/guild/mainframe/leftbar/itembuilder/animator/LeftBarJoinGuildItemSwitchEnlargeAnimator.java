...
public class LeftBarJoinGuildItemSwitchEnlargeAnimator
  implements IGuildMFAnimator
{
  private GuildBaseListItemLayout a;
  private AnimatorSet b;
  
  public LeftBarJoinGuildItemSwitchEnlargeAnimator(Object paramObject)
  {
  ...
  public void a(GuildAnimatorHelper.AnimatorInfo paramAnimatorInfo, Object paramObject)
  {
    ...
    if (paramAnimatorInfo != null)
    {
      ...
      this.b.addListener(new LeftBarJoinGuildItemSwitchEnlargeAnimator.1(this));
      this.b.start();
    }
  }
}
 ...
 * Qualified Name:     com.tencent.mobileqq.guild.mainframe.leftbar.itembuilder.animator.LeftBarJoinGuildItemSwitchEnlargeAnimator
