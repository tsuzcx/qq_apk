...
class GuildLiveShareActionSheetBuilder
{
  ...
  public GuildLiveShareActionSheetBuilder(Context paramContext)
  {
  ...
  private void b()
  {
    ...
    localIntent.putExtra("forward_type", 27).putExtra("is_ark_display_share", true).putExtra("forward_ark_app_name", "com.tencent.qun.pro").putExtra("forward_ark_app_view", "contact").putExtra("forward_ark_app_ver", "1.0.0.0").putExtra("forward_ark_app_prompt", "QQ频道").putExtra("selection_mode", 2).putExtra("guild_share_label", true).putExtra("forward_ark_app_meta", "{}").putExtras(localBundle);
    this.a.setIntentForStartForwardRecentActivity(localIntent);
  }
  
  private void c()
  {
    Iterator localIterator = Arrays.asList(new Integer[] { Integer.valueOf(2), Integer.valueOf(26), Integer.valueOf(9) }).iterator();
 ...
 * Qualified Name:     com.tencent.mobileqq.guild.share.live.GuildLiveShareActionSheetBuilder
