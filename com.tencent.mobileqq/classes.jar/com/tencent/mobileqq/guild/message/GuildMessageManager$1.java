...
class GuildMessageManager$1
  implements Runnable
{
  GuildMessageManager$1(GuildMessageManager paramGuildMessageManager, RefreshMessageContext paramRefreshMessageContext, String paramString, int paramInt, long paramLong1, long paramLong2, boolean paramBoolean) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      if ((k % 500 == 0) && (QLog.isColorLevel()))
      {
        ...
        ((StringBuilder)localObject1).append("refreshUnreadMessage() dead loop warning, firstSeq: ");
        ((StringBuilder)localObject1).append(this.e);
        ((StringBuilder)localObject1).append(" seq: ");
        ((StringBuilder)localObject1).append(i);
        ((StringBuilder)localObject1).append(", unread: ");
        ((StringBuilder)localObject1).append(this.d);
        QLog.w("Q.msg.BaseMessageManager.GuildMessageManager", 2, ((StringBuilder)localObject1).toString());
      }
      int m = (int)(l - this.d);
      j = m;
    ...
    if ((bool) && (this.f))
    {
      ...
      i = this.c;
      localObject2 = this.b;
      ((GuildMessageManager)localObject1).a(i, (String)localObject2, this.d, ((GuildMessageManager)localObject1).a((String)localObject2, i));
    }
    this.a.i = bool;
    this.this$0.b.setChangeAndNotify(this.a);
    this.this$0.b.getFacadeHandler().post(new GuildMessageManager.1.1(this));
    if (QLog.isColorLevel()) {
 ...
 * Qualified Name:     com.tencent.mobileqq.guild.message.GuildMessageManager.1
