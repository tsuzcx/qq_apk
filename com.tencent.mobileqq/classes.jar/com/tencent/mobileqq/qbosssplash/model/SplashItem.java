...
public class SplashItem
{
  ...
  {
    boolean bool = false;
    paramString = TianshuSplashUtils.a(BaseApplicationImpl.getContext(), this.jdField_a_of_type_JavaLangString).getString("splash_union_banner_res_path_" + paramString, "");
  ...
  public boolean a()
  {
    ...
    {
      if ((bool1) && (TianshuSplashUtils.a(this.l)) && (!a(this.jdField_b_of_type_JavaLangString))) {
        bool1 = bool2;
      }
      for (;;)
      {
  ...
  public boolean b()
  {
    ...
    if (!a(this.h, true))
    {
      ...
      {
        bool1 = bool2;
        if (!QbossSplashUtil.a(this.jdField_d_of_type_JavaLangString)) {
          bool1 = true;
        }
      }
    }
 ...
 * Qualified Name:     com.tencent.mobileqq.qbosssplash.model.SplashItem
