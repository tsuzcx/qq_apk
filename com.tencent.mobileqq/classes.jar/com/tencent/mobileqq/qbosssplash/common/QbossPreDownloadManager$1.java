...
class QbossPreDownloadManager$1
  extends AbsPreDownloadTask
{
  QbossPreDownloadManager$1(QbossPreDownloadManager paramQbossPreDownloadManager, QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
  ...
  public void realStart()
  {
    ...
    QbossPreDownloadManager.a("Qboss_PreDownload_Start", (HashMap)localObject);
    localObject = new HttpNetReq();
    ((HttpNetReq)localObject).mCallback = new QbossPreDownloadManager.DownLoadNetEngineListener(this.app, this.jdField_a_of_type_JavaLangString, this.b, this.c, this.d);
 ...
 * Qualified Name:     com.tencent.mobileqq.qbosssplash.common.QbossPreDownloadManager.1
