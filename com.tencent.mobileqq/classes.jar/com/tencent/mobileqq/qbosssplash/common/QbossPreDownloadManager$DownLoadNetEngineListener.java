...
public class QbossPreDownloadManager$DownLoadNetEngineListener
  implements INetEngineListener
{
  ...
  public QbossPreDownloadManager$DownLoadNetEngineListener(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4)
  {
  ...
  public void onResp(NetResp paramNetResp)
  {
    try
    {
      if (paramNetResp.mResult == 0)
      {
        ...
        QbossPreDownloadManager.a(this.b, this.jdField_a_of_type_JavaLangRefSoftReference, this.jdField_a_of_type_JavaLangString, "2");
    ...
    {
      QbossPreDownloadManager.a(this.b, this.jdField_a_of_type_JavaLangRefSoftReference, this.jdField_a_of_type_JavaLangString, "1");
 ...
 * Qualified Name:     com.tencent.mobileqq.qbosssplash.common.QbossPreDownloadManager.DownLoadNetEngineListener
