  ...
  extends GestureDetector.SimpleOnGestureListener
{
  ...
  public void onLongPress(MotionEvent paramMotionEvent)
  {
    ...
    if (localObject != null)
    {
      ...
      if (localObject != null)
      {
        if (!this.a.l.c(this.a.p, (RecyclerView.ViewHolder)localObject)) {
          return;
        }
 ...
 * Qualified Name:     com.tencent.mobileqq.wink.editor.clipping.timeline.reorder.ItemTouchHelper.ItemTouchHelperGestureListener
