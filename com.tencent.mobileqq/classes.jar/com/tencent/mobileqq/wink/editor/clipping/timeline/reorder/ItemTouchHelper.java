  ...
  implements RecyclerView.OnChildAttachStateChangeListener
{
  ...
  private int b(RecyclerView.ViewHolder paramViewHolder, int paramInt)
  {
    if ((paramInt & 0xC) != 0)
    {
      ...
      {
        localVelocityTracker.computeCurrentVelocity(1000, this.l.b(this.f));
  ...
  private List<RecyclerView.ViewHolder> c(RecyclerView.ViewHolder paramViewHolder)
  {
    ...
    while (i1 < i10)
    {
      ...
      if ((localObject2 != paramViewHolder.itemView) && (((View)localObject2).getBottom() >= i5) && (((View)localObject2).getTop() <= i7) && (((View)localObject2).getRight() >= i4) && (((View)localObject2).getLeft() <= i6))
      {
        ...
        if (this.l.a(this.p, this.b, localViewHolder))
        {
  ...
  private int d(RecyclerView.ViewHolder paramViewHolder)
  {
    if (this.m == 2) {
      return 0;
    }
  ...
  private void e()
  {
    ...
    while (i1 >= 0)
    {
      ...
      this.l.d(this.p, localRecoverAnimation.h);
      i1 -= 1;
    }
    this.o.clear();
    this.s = null;
  ...
  void a(RecyclerView.ViewHolder paramViewHolder)
  {
    ...
    Object localObject = c(paramViewHolder);
    ...
    if (this.l.b(this.p, paramViewHolder, (RecyclerView.ViewHolder)localObject)) {
  ...
  void a(RecyclerView.ViewHolder paramViewHolder, int paramInt)
  {
    ...
    if (localObject != null)
    {
      if (((RecyclerView.ViewHolder)localObject).itemView.getParent() != null)
      {
        ...
        if (i3 == 2) {
          ...
          i2 = d((RecyclerView.ViewHolder)localObject);
        }
        g();
        if ((i2 != 1) && (i2 != 2))
        {
      ...
      else
      {
        ...
        this.l.d(this.p, (RecyclerView.ViewHolder)localObject);
        i1 = 0;
      }
      this.b = null;
    }
    ...
    {
      this.n = ((this.l.b(this.p, paramViewHolder) & (1 << paramInt * 8 + 8) - 1) >> this.m * 8);
  ...
  boolean a(int paramInt1, MotionEvent paramMotionEvent, int paramInt2)
  {
    if ((this.b == null) && (paramInt1 == 2) && (this.m != 2))
    {
      ...
      paramInt1 = (this.l.b(this.p, localViewHolder) & 0xFF00) >> 8;
      if (paramInt1 == 0) {
        return false;
      }
      float f1 = paramMotionEvent.getX(paramInt2);
  ...
  {
    if (!this.l.c(this.p, paramViewHolder))
    {
      Log.e("ItemTouchHelper", "Start drag has been called but dragging is not enabled");
      return;
    }
    if (paramViewHolder.itemView.getParent() != this.p)
    {
 ...
 * Qualified Name:     com.tencent.mobileqq.wink.editor.clipping.timeline.reorder.ItemTouchHelper
