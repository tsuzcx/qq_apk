...
import com.tencent.mobileqq.wink.editor.music.lyric.common.TimerTaskManager.TimerTaskRunnable;
...
import com.tencent.mobileqq.wink.editor.music.lyric.util.LyricContext;
...
public class LyricViewController
{
  ...
  private void b(int paramInt, boolean paramBoolean)
  {
    if (!paramBoolean)
    {
      ...
      if (localOnObtainMusicPositionListener != null) {
        ...
        paramInt = (int)WinkLyricProgressCalculator.a().a(false);
      }
    }
    if (paramInt > 0) {
      this.t = paramInt;
  ...
  public void b(int paramInt)
  {
    ...
    if (localLyric != null)
    {
      ...
      this.n = paramInt;
      a(localLyric.a(paramInt), paramInt);
    }
  }
  ...
  protected void c(int paramInt)
  {
    if ((this.d != null) || (this.c != null))
    {
      ...
      if ((localObject == null) || (((Lyric)localObject).c())) {
        break label499;
      }
      long l1;
      if (paramInt == this.d.b.size() - 1)
      {
        ...
        if (this.k != null)
        {
          l1 = ((Sentence)this.d.b.get(paramInt)).b;
          this.k.a(l1, i1);
        }
        return;
      }
      ...
      Log.d("ModuleController", ((StringBuilder)localObject).toString());
      if ((paramInt >= 0) && (paramInt < this.d.b.size()))
      {
        if (this.d.b.get(paramInt) == null)
        {
          Log.w("ModuleController", "onScrollStop -> current sentence is null");
          return;
        }
        long l2 = ((Sentence)this.d.b.get(paramInt)).b;
        localObject = new StringBuilder();
  ...
  protected void d(int paramInt)
  {
    if ((this.d != null) || (this.c != null))
    {
      ...
      if ((localObject != null) && (!((Lyric)localObject).c()))
      {
        if ((i1 >= 0) && (i1 < this.d.b.size()))
        {
          if (this.d.b.get(i1) == null)
          {
            Log.w("ModuleController", "onScrollStop -> current sentence is null");
            return;
          }
          long l2 = ((Sentence)this.d.b.get(i1)).b;
          long l1 = l2;
          if (this.f)
          {
            paramInt = this.g;
 ...
 * Qualified Name:     com.tencent.mobileqq.wink.editor.music.lyric.widget.LyricViewController
