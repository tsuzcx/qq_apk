...
public class WinkMusicWaveRandomGenerator
{
  ...
  static double a(int paramInt)
  {
    ...
    {
      AEQLog.a("WinkMusicWaveRandomGenerator", "obtainRandomValue() mRandoms == null.");
      return a();
    }
    if (paramInt == localArrayList.size())
    {
      AEQLog.a("WinkMusicWaveRandomGenerator", "obtainRandomValue() index == mRandoms.size().");
      d = a();
    ...
    if (paramInt < 0)
    {
      AEQLog.a("WinkMusicWaveRandomGenerator", "obtainRandomValue() index < 0.");
      return a();
    }
    if (paramInt > b.size())
    {
 ...
 * Qualified Name:     com.tencent.mobileqq.wink.editor.music.lyric.WinkMusicWaveRandomGenerator
