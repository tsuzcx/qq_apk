  ...
  extends FrameLayout
{
  ...
  public LyricWithBuoyView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    paramContext = LayoutInflater.from(paramContext).inflate(2131629700, this);
    this.a = ((LyricViewDetail)paramContext.findViewById(2131429940));
    this.e = ((TextView)paramContext.findViewById(2131448594));
    this.c = paramContext.findViewById(2131429941);
    ...
    this.d = paramContext.findViewById(2131439052);
  ...
  public void a(String paramString1, String paramString2, int paramInt, LyricViewController.OnObtainMusicPositionListener paramOnObtainMusicPositionListener)
  {
    if ((!TextUtils.isEmpty(paramString1)) && (!TextUtils.isEmpty(paramString2)))
    {
      ...
      {
        localObject = LyricParserHelper.a(paramString1, false);
      ...
      {
        localObject = LyricParserHelper.a(paramString1, true);
        localLyricViewController = this.b;
        paramString1 = (String)localObject;
        if (localLyricViewController != null)
        {
 ...
 * Qualified Name:     com.tencent.mobileqq.wink.editor.music.lyric.widget.LyricWithBuoyView
