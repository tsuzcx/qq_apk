  ...
  extends View
{
  ...
  public RoundProgressBar(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    paramContext = paramContext.getTheme().obtainStyledAttributes(paramAttributeSet, R.styleable.dg, paramInt, 0);
    this.a = paramContext.getDimensionPixelSize(R.styleable.dm, (int)TypedValue.applyDimension(2, 16.0F, getResources().getDisplayMetrics()));
    this.b = paramContext.getColor(R.styleable.dl, -16777216);
    this.d = paramContext.getColor(R.styleable.dh, -16777216);
    this.c = paramContext.getDimensionPixelSize(R.styleable.di, (int)TypedValue.applyDimension(1, 1.0F, getResources().getDisplayMetrics()));
    this.e = paramContext.getColor(R.styleable.dj, -16777216);
    this.f = paramContext.getInt(R.styleable.dk, 10);
 ...
 * Qualified Name:     com.tencent.mobileqq.wink.view.RoundProgressBar
