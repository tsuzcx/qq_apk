  ...
  extends HeaderScrollingViewBehavior
{
  ...
  private void a(@NonNull View paramView1, @NonNull View paramView2)
  {
    ...
    if ((localObject instanceof ScrollingHeaderLayout.BaseBehavior))
    {
      ...
      ViewCompat.offsetTopAndBottom(paramView1, paramView2.getBottom() - paramView1.getTop() + ScrollingHeaderLayout.BaseBehavior.a((ScrollingHeaderLayout.BaseBehavior)localObject) + dB_() - b(paramView2));
    }
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.wink.view.scrollingheader.ScrollingHeaderLayout.ScrollingViewBehavior
