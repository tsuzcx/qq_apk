      ...
      if (this._data.containsKey("compressed"))
      {
        ...
        if (this._data.get("compressed") != null)
        {
          ...
          else
          {
            ...
            localStringBuilder.append("not compressed ");
            localStringBuilder.append(new String((byte[])localObject));
            AEQLog.d("CompressUniPacket", localStringBuilder.toString());
            bool1 = bool2;
          }
        }
      }
 ...
 * Qualified Name:     com.tencent.mobileqq.wink.edit.service.CompressUniPacket
