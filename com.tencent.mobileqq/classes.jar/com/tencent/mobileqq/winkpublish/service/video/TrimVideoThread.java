  ...
  implements Runnable
{
  ...
  private boolean p;
  private boolean q;
  private String r = QzoneConfig.getInstance().getConfig("QZoneTextSetting", "VideoFilePathNull", "视频文件路径为空");
  private String s = QzoneConfig.getInstance().getConfig("QZoneTextSetting", "VideoFileNotExist", "视频文件不存在");
  private String t = QzoneConfig.getInstance().getConfig("QZoneTextSetting", "VideoTrimTimeError", "裁剪时间错误");
  private String u = QzoneConfig.getInstance().getConfig("QZoneTextSetting", "VideoReadCacheFail", "读取缓存位置失败");
  private String v = QzoneConfig.getInstance().getConfig("QZoneTextSetting", "VideoTrimSuccess", "裁剪成功");
  private String w = QzoneConfig.getInstance().getConfig("QZoneTextSetting", "VideoTrimFail", "裁剪失败, code=");
 ...
 * Qualified Name:     com.tencent.mobileqq.winkpublish.service.video.TrimVideoThread
