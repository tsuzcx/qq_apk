...
final class PublishVideoPluginService$2
  extends Handler
{
  public void handleMessage(Message paramMessage)
  {
    ...
    case 1001: 
      ...
      QCircleHostQzoneThreadHelper.removeBackGroundThreadTask(PublishVideoPluginService.i());
      paramMessage = paramMessage.getData().getString("report_msg");
      localStringBuilder = new StringBuilder();
      localStringBuilder.append(PublishVideoPluginService.j());
      localStringBuilder.append(paramMessage);
      PublishVideoPluginService.a(false, (String)localObject, "", localStringBuilder.toString(), str);
      return;
    case 1000: 
      localStringBuilder = new StringBuilder();
      ...
      QLog.i("[upload2][compress]", 1, localStringBuilder.toString());
      QCircleHostQzoneThreadHelper.removeBackGroundThreadTask(PublishVideoPluginService.i());
      PublishVideoPluginService.a(true, (String)localObject, paramMessage.getData().getString("target_file"), PublishVideoPluginService.k(), str);
      return;
      if (paramMessage.obj != null)
      {
        ...
        try
        {
          PublishVideoPluginService.l().send(paramMessage);
          return;
        }
      ...
      return;
      QCircleHostQzoneThreadHelper.postBackGoundThreadDelayed(PublishVideoPluginService.i(), 5000L);
      return;
      i = paramMessage.arg1;
      ...
      localStringBuilder.append((String)localObject);
      QLog.i("[upload2][compress]", 1, localStringBuilder.toString());
      PublishVideoPluginService.a(paramMessage, str);
    }
  }
}
 ...
 * Qualified Name:     com.tencent.mobileqq.winkpublish.service.video.PublishVideoPluginService.2
