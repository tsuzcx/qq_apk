...
import com.tencent.mobileqq.winkpublish.uploader.service.AUploadAlphaConfig;
import com.tencent.mobileqq.winkpublish.util.MD5Util;
...
public class AUploadSoDownloader
{
  ...
  private static File b = RFApplication.getApplication().getDir("qzoneupload", 0);
  ...
  private boolean b(String paramString)
  {
    ...
    try
    {
      JSONArray localJSONArray = new JSONObject(HostFileUtils.readFileContent((File)localObject1)).getJSONArray("so_lib");
      int i = 0;
      boolean bool = false;
      while (i < localJSONArray.length())
      {
        ...
        if (!((File)localObject3).exists())
        {
          ...
          QLog.d("[upload2]AUploadSoDownloader", 1, paramString.toString());
          break;
        }
        String str = MD5Util.a((File)localObject3);
        QLog.d("[upload2]AUploadSoDownloader", 1, new Object[] { "src md5 : ", str, " dst md5 : ", localObject2, " file size :", Long.valueOf(((File)localObject3).length()), " file : ", localObject1 });
    ...
    catch (Exception paramString)
    {
      ...
      QLog.d("[upload2]AUploadSoDownloader", 1, ((StringBuilder)localObject1).toString());
    }
    return false;
  }
  ...
  {
    SharedPreferences localSharedPreferences = RFApplication.getApplication().getSharedPreferences("qzone_upload_so", 0);
    String str = "";
  ...
  private void c(boolean paramBoolean)
  {
    ...
    localObject = RFApplication.getApplication().getSharedPreferences("qzone_upload_so", 0);
    if (localObject != null) {
  ...
  private boolean c()
  {
    ...
    boolean bool = false;
    localObject = ((Context)localObject).getSharedPreferences("qzone_upload_so", 0);
    if (localObject != null) {
  ...
  private int d()
  {
    Object localObject = RFApplication.getApplication().getSharedPreferences("qzone_upload_so", 0);
    if (localObject != null)
    {
  ...
  public void a()
  {
    ...
    //   8: istore_2
    //   9: aload_0
    //   10: invokespecial 245	com/tencent/mobileqq/winkpublish/uploader/AUploadSoDownloader:c	()Z
    //   13: istore_3
    ...
    //   60: pop
    //   61: aload 4
    //   63: getstatic 34	com/tencent/mobileqq/winkpublish/uploader/AUploadSoDownloader:d	Z
    ...
    //   95: invokestatic 118	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   98: iload_2
    //   99: ifne +34 -> 133
    //   102: iload_3
    //   103: ifeq +30 -> 133
    ...
    //   108: iconst_1
    //   109: ldc_w 260
    //   112: invokestatic 118	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   115: iconst_0
    //   116: putstatic 32	com/tencent/mobileqq/winkpublish/uploader/AUploadSoDownloader:c	Z
    //   119: new 262	com/tencent/mobileqq/winkpublish/uploader/AUploadSoDownloader$1
    //   122: dup
    //   123: aload_0
    //   124: invokespecial 265	com/tencent/mobileqq/winkpublish/uploader/AUploadSoDownloader$1:<init>	(Lcom/tencent/mobileqq/winkpublish/uploader/AUploadSoDownloader;)V
    //   127: invokestatic 271	com/tencent/biz/richframework/delegate/impl/RFThreadManager:execute	(Ljava/lang/Runnable;)V
    //   130: aload_0
    //   131: monitorexit
    //   132: return
    //   133: getstatic 34	com/tencent/mobileqq/winkpublish/uploader/AUploadSoDownloader:d	Z
    //   136: istore_2
    //   137: iload_2
    //   138: ifeq +6 -> 144
    //   141: aload_0
    ...
    //   146: iconst_1
    //   147: ldc_w 273
    //   150: invokestatic 118	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   153: iconst_1
    //   154: putstatic 34	com/tencent/mobileqq/winkpublish/uploader/AUploadSoDownloader:d	Z
    //   157: iconst_0
    //   158: putstatic 32	com/tencent/mobileqq/winkpublish/uploader/AUploadSoDownloader:c	Z
    //   161: aload_0
    //   162: iconst_0
    //   163: invokespecial 42	com/tencent/mobileqq/winkpublish/uploader/AUploadSoDownloader:c	(Z)V
    ...
    //   187: iconst_0
    //   188: putstatic 34	com/tencent/mobileqq/winkpublish/uploader/AUploadSoDownloader:d	Z
    //   191: iconst_0
    //   192: putstatic 32	com/tencent/mobileqq/winkpublish/uploader/AUploadSoDownloader:c	Z
    //   195: aload_0
    //   196: monitorexit
    //   197: return
    //   198: aload_0
    //   199: invokespecial 281	com/tencent/mobileqq/winkpublish/uploader/AUploadSoDownloader:d	()I
    //   202: istore_1
    //   203: iload_1
    //   204: getstatic 283	com/tencent/mobileqq/winkpublish/uploader/AUploadSoDownloader:a	I
    //   207: iconst_2
    //   208: idiv
    //   209: if_icmple +27 -> 236
    //   212: iload_1
    //   213: getstatic 283	com/tencent/mobileqq/winkpublish/uploader/AUploadSoDownloader:a	I
    ...
    //   235: pop
    //   236: iload_1
    //   237: getstatic 283	com/tencent/mobileqq/winkpublish/uploader/AUploadSoDownloader:a	I
    ...
    //   261: aload 4
    //   263: aload_0
    //   264: invokespecial 281	com/tencent/mobileqq/winkpublish/uploader/AUploadSoDownloader:d	()I
    ...
    //   279: invokestatic 118	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   282: iconst_0
    //   283: putstatic 34	com/tencent/mobileqq/winkpublish/uploader/AUploadSoDownloader:d	Z
    //   286: aload_0
    //   287: monitorexit
    //   288: return
    //   289: aload_0
    //   290: aload 4
    //   292: invokespecial 290	com/tencent/mobileqq/winkpublish/uploader/AUploadSoDownloader:d	(Ljava/lang/String;)V
    //   295: ldc_w 292
    //   298: invokestatic 298	com/tencent/mobileqq/qroute/QRoute:api	(Ljava/lang/Class;)Lcom/tencent/mobileqq/qroute/QRouteApi;
    //   301: checkcast 292	com/tencent/qzonehub/api/IQzoneModuleManageApi
    //   304: invokestatic 238	com/tencent/biz/qcircleshadow/lib/QCircleHostConstants$QzoneModuleConst:QZONE_MODULE_UPLOAD_SO	()Ljava/lang/String;
    //   307: new 300	com/tencent/mobileqq/winkpublish/uploader/AUploadSoDownloader$2
    //   310: dup
    //   311: aload_0
    //   312: invokespecial 301	com/tencent/mobileqq/winkpublish/uploader/AUploadSoDownloader$2:<init>	(Lcom/tencent/mobileqq/winkpublish/uploader/AUploadSoDownloader;)V
    //   315: invokeinterface 305 3 0
    //   320: pop
    //   321: aload_0
    //   322: monitorexit
    //   323: return
  ...
  public boolean a(String paramString)
  {
    for (;;)
    {
      try
      {
        ...
        i = 1;
        i = AUploadAlphaConfig.a().a("QzoneUploadSetting", "UploadEnableDownloadSo", i);
        localObject = new StringBuilder();
 ...
 * Qualified Name:     com.tencent.mobileqq.winkpublish.uploader.AUploadSoDownloader
