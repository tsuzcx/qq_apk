...
import com.tencent.mobileqq.winkpublish.request.provider.UploadFlowMsgProvider;
...
public abstract class AUploadBaseUploadRequest
  extends AUploadRequest
  implements UploadFlowMsgProvider
{
  public String a;
  public String b;
  
  public AUploadBaseUploadRequest() {}
  
  public AUploadBaseUploadRequest(String paramString)
  {
    super(paramString);
  }
  ...
  protected boolean a(AbstractUploadTask paramAbstractUploadTask)
  {
    ...
    if ((LoginData.a().e() != null) && (paramAbstractUploadTask.vLoginData != null) && (paramAbstractUploadTask.vLoginData.length != 0))
    {
      ...
      if (i != 0)
      {
        localObject1 = FSUploadConst.a(i);
        localObject2 = this.m;
      ...
      boolean bool = UploadServiceBuilder.getInstance().upload(paramAbstractUploadTask);
      localObject1 = this.m;
      localObject2 = new StringBuilder();
    ...
    paramAbstractUploadTask.uploadTaskCallback.onUploadError(paramAbstractUploadTask, 1705, FSUploadConst.a(1705));
    return false;
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.winkpublish.request.AUploadBaseUploadRequest
