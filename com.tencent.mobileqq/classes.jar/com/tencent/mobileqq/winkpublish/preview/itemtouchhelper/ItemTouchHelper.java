  ...
  implements RecyclerView.OnChildAttachStateChangeListener
{
  ...
  boolean b()
  {
    ...
    localLayoutManager.calculateItemDecorationsForChild(this.b.itemView, this.A);
    if (localLayoutManager.canScrollHorizontally())
    {
      i2 = (int)(this.i + this.g);
      i1 = i2 - this.A.left - this.p.getPaddingLeft();
      if ((this.g < 0.0F) && (i1 < 0)) {
        break label200;
      }
      if (this.g > 0.0F)
      {
        i1 = i2 + this.b.itemView.getWidth() + this.A.right - (this.p.getWidth() - this.p.getPaddingRight());
        if (i1 > 0) {
          break label200;
        }
      }
    ...
    if (localLayoutManager.canScrollVertically())
    {
      ...
      i2 = i3 - this.A.top - this.p.getPaddingTop();
      if ((this.h < 0.0F) && (i2 < 0)) {
        break label308;
      }
      if (this.h > 0.0F)
      {
        i2 = i3 + this.b.itemView.getHeight() + this.A.bottom - (this.p.getHeight() - this.p.getPaddingBottom());
        if (i2 > 0) {
          break label308;
        }
      }
 ...
 * Qualified Name:     com.tencent.mobileqq.winkpublish.preview.itemtouchhelper.ItemTouchHelper
