...
public class FSPublishFeedRequest
  extends FSBaseRequest
{
  public static final String TAG = "QCirclePublishFeedRequest";
  public FeedCloudWrite.StPublishFeedReq mReq = new FeedCloudWrite.StPublishFeedReq();
  
  public FSPublishFeedRequest(FeedCloudCommon.StCommonExt paramStCommonExt, FeedCloudMeta.StFeed paramStFeed)
  {
  ...
  {
    return "FeedCloudSvr.trpc.qflash.commwriter.ComWriter.PublishFeed";
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.winkpublish.fs.request.FSPublishFeedRequest
