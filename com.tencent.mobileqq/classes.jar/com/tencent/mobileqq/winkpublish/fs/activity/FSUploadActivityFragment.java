package com.tencent.mobileqq.winkpublish.fs.activity;
...
import com.tencent.mobileqq.winkpublish.part.PublishJurisdictionPart;
...
public class FSUploadActivityFragment
  extends PublishBaseFragment
{
  ...
  private PublishJurisdictionPart k;
  private PublishViewModel l;
  private PublishLabelViewModel m;
  ...
  private void f()
  {
    ...
    if (this.l == null) {
      this.l = ((PublishViewModel)a(PublishViewModel.class));
    }
    this.l.a(this, getActivity().getIntent(), false);
    if (this.m == null) {
      this.m = ((PublishLabelViewModel)a(PublishLabelViewModel.class));
    }
  ...
  protected List<Part> d()
  {
    ...
    if (this.c == null)
    {
      ...
      this.c.add(this.j);
      this.k = new PublishJurisdictionPart();
      this.c.add(this.k);
    }
    return this.c;
  }
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    QLog.d(paramViewGroup.toString(), 1, new Object[] { "[onCreateView...] + END, time cost:", Long.valueOf(System.currentTimeMillis() - l1) });
  ...
  {
    super.onDestroy();
    PublishViewModel localPublishViewModel = this.l;
  ...
  public void onNewIntent(Intent paramIntent)
  {
    ...
    this.l.a(this, getActivity().getIntent(), true);
  }
  ...
  public void onSaveInstanceState(@NonNull Bundle paramBundle)
  {
    ...
    paramBundle = this.l;
    if ((paramBundle != null) && (paramBundle.e()) && (!this.l.f()) && (!this.l.o)) {
      this.l.a(this, 2);
    }
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.winkpublish.fs.activity.FSUploadActivityFragment
