  ...
  extends GestureDetector.SimpleOnGestureListener
{
  ...
  public boolean onFling(MotionEvent paramMotionEvent1, MotionEvent paramMotionEvent2, float paramFloat1, float paramFloat2)
  {
    ...
    {
      if (this.a.e() > PhotoViewAttacher.k()) {
        return false;
      }
      if (paramMotionEvent1.getPointerCount() <= PhotoViewAttacher.l())
      {
        if (paramMotionEvent2.getPointerCount() > PhotoViewAttacher.l()) {
          return false;
        }
 ...
 * Qualified Name:     com.tencent.mobileqq.winkpublish.widget.multitouchimg.PhotoViewAttacher.2
