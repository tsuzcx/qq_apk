  ...
  implements OnGestureListener
{
  ...
  public void a(float paramFloat1, float paramFloat2)
  {
    ...
    if (PhotoViewAttacher.b(this.a) != null) {
      PhotoViewAttacher.b(this.a).a(paramFloat1, paramFloat2);
    }
    PhotoViewAttacher.c(this.a).postTranslate(paramFloat1, paramFloat2);
    ...
    ((StringBuilder)localObject).append(PhotoViewAttacher.h(this.a));
    ((StringBuilder)localObject).append(" imageviewHashCode:");
    ((StringBuilder)localObject).append(PhotoViewAttacher.i(this.a).hashCode());
    QLog.d("PhotoViewAttacher", 4, ((StringBuilder)localObject).toString());
    localObject = PhotoViewAttacher.i(this.a).getParent();
    if (localObject != null) {
  ...
  public void a(float paramFloat1, float paramFloat2, float paramFloat3)
  {
    ...
    if (((f > PhotoViewAttacher.i()) && (paramFloat1 > 1.0F)) || ((f < PhotoViewAttacher.j()) && (paramFloat1 < 1.0F))) {
      return;
    }
    if (PhotoViewAttacher.k(this.a) != null) {
      PhotoViewAttacher.k(this.a).a(paramFloat1, paramFloat2, paramFloat3);
    }
    PhotoViewAttacher.c(this.a).postScale(paramFloat1, paramFloat1, paramFloat2, paramFloat3);
    PhotoViewAttacher.d(this.a);
  }
  ...
  public void a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    ...
    localObject = this.a;
    PhotoViewAttacher.a((PhotoViewAttacher)localObject, new PhotoViewAttacher.FlingRunnable((PhotoViewAttacher)localObject, PhotoViewAttacher.i((PhotoViewAttacher)localObject).getContext()));
    localObject = PhotoViewAttacher.j(this.a);
    PhotoViewAttacher localPhotoViewAttacher = this.a;
    int i = PhotoViewAttacher.a(localPhotoViewAttacher, PhotoViewAttacher.i(localPhotoViewAttacher));
    localPhotoViewAttacher = this.a;
    ((PhotoViewAttacher.FlingRunnable)localObject).a(i, PhotoViewAttacher.b(localPhotoViewAttacher, PhotoViewAttacher.i(localPhotoViewAttacher)), (int)paramFloat3, (int)paramFloat4);
    PhotoViewAttacher.i(this.a).post(PhotoViewAttacher.j(this.a));
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes13.jar
 * Qualified Name:     com.tencent.mobileqq.winkpublish.widget.multitouchimg.PhotoViewAttacher.1
