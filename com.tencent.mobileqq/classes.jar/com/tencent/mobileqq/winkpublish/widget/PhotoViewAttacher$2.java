  ...
  extends GestureDetector.SimpleOnGestureListener
{
  public boolean onFling(MotionEvent paramMotionEvent1, MotionEvent paramMotionEvent2, float paramFloat1, float paramFloat2)
  {
    ...
    {
      if (this.a.b() > PhotoViewAttacher.e()) {
        return false;
      }
      if (paramMotionEvent1.getPointerCount() <= PhotoViewAttacher.f())
      {
        if (paramMotionEvent2.getPointerCount() > PhotoViewAttacher.f()) {
          return false;
        }
 ...
 * Qualified Name:     com.tencent.mobileqq.winkpublish.widget.PhotoViewAttacher.2
