...
import com.tencent.mobileqq.upload.R.styleable;
  ...
  extends URLImageView
{
  ...
  public SquareImageView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.d = paramContext.getFloat(R.styleable.V, 1.0F);
    this.e = paramContext.getFloat(R.styleable.W, 0.0F);
    this.f = paramContext.getColor(R.styleable.R, -1);
    this.g = paramContext.getString(R.styleable.S);
    this.h = paramContext.getDimensionPixelSize(R.styleable.T, 40);
    this.a = paramContext.getDimensionPixelSize(R.styleable.U, 0);
 ...
 * Qualified Name:     com.tencent.mobileqq.winkpublish.widget.SquareImageView
