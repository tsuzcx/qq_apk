  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if ((!TextUtils.isEmpty(this.a)) && (!this.a.equals(this.this$0.getCacheKey()))) {
      return;
    }
    Object localObject = this.this$0;
    ((VideoCompressTask)localObject).c = false;
    ((VideoCompressTask)localObject).d += 1;
    RemoteVideoServiceHandler.a().b(this.this$0.getCacheKey());
    ...
    ((VideoCompressTask)localObject).ae = ((VideoCompressTask)localObject).j;
 ...
 * Qualified Name:     com.tencent.mobileqq.winkpublish.task.compress.VideoCompressTask.HandleVideoTimeoutRunnable
