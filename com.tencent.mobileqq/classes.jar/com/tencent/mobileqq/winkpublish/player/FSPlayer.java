...
import com.tencent.mobileqq.winkpublish.util.FSTransUtils._SceneID;
...
{
  public static String a = SharePreferenceUtils.a(FSTransUtils.e(), "key_sp_is_support_hevc");
  ...
  private void a(Surface paramSurface)
  {
    if (this.e == null)
    {
      ...
      {
        this.h = SuperPlayerFactory.createPlayerVideoView(FSTransUtils.e());
        this.e = SuperPlayerFactory.createMediaPlayer(FSTransUtils.e(), FSTransUtils._SceneID.a(), this.h);
      }
      else
      {
        this.e = SuperPlayerFactory.createMediaPlayer(FSTransUtils.e(), FSTransUtils._SceneID.a(), null);
      ...
      this.e.setOnInfoListener(this);
      this.g = (SharePreferenceUtils.a(FSTransUtils.e(), "key_sp_is_detect_hevc").equals("") ^ true);
      if (!this.g)
      {
        try
        {
        ...
        SharePreferenceUtils.a(FSTransUtils.e(), "key_sp_is_detect_hevc", "1");
        SharePreferenceUtils.a(FSTransUtils.e(), "key_sp_is_support_hevc", a);
  ...
  private void s()
  {
    if (this.A > 0L)
    {
      ...
      if (localObject1 != null)
      {
        ...
        localObject1 = String.format("%d|%d|%d|%d", new Object[] { Long.valueOf(t()), Integer.valueOf(this.p), Integer.valueOf(this.o), Long.valueOf(this.r) });
        localObject2 = new StringBuilder();
  ...
  private void w()
  {
    ...
    QLog.d("FSPlayer", 1, String.format("DownloadComplete  DownLoadSpeed:%d kb/s", new Object[] { Long.valueOf(t()) }));
  }
  ...
  public void a(String paramString1, String paramString2, int paramInt)
  {
    ...
    if ((this.e != null) && (this.j != null))
    {
      ...
      this.e.openMediaPlayer(FSTransUtils.e(), this.j, paramInt, paramString1);
 ...
 * Qualified Name:     com.tencent.mobileqq.winkpublish.player.FSPlayer
