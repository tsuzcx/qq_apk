...
import com.tencent.mobileqq.winkpublish.base.PublishFeedData;
...
public class FSVideoReporter
{
  ...
  private static void a(Object paramObject, List<FeedCloudCommon.Entry> paramList)
  {
    ...
    if ((paramObject instanceof PublishFeedData))
    {
      paramObject = (PublishFeedData)paramObject;
  ...
  private static List<FeedCloudCommon.Entry> b(long paramLong, String paramString, Object paramObject)
  {
    ...
    FeedCloudCommon.Entry localEntry2 = QCircleReportHelper.newEntry("qua", FSTransUtils.b());
 ...
 * Qualified Name:     com.tencent.mobileqq.winkpublish.player.FSVideoReporter
