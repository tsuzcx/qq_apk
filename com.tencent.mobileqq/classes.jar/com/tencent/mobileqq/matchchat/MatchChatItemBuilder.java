...
public class MatchChatItemBuilder
  extends RecentItemBaseBuilder
{
  ...
  public View a(int paramInt, Object paramObject, RecentFaceDecoder paramRecentFaceDecoder, View paramView, ViewGroup paramViewGroup, Context paramContext, View.OnClickListener paramOnClickListener, View.OnLongClickListener paramOnLongClickListener, DragFrameLayout.OnDragModeChangedListener paramOnDragModeChangedListener)
  {
    ...
    if (paramView == null)
    {
      ...
      if ((paramView == null) || (!(paramView.getTag() instanceof MatchChatItemBuilder.ViewHolder))) {
        break label179;
      }
      paramRecentFaceDecoder = (MatchChatItemBuilder.ViewHolder)paramRecentFaceDecoder;
      label35:
    ...
    for (;;)
    {
      ...
      while (paramInt != 21)
      {
        ...
        paramRecentFaceDecoder = new MatchChatItemBuilder.ViewHolder();
 ...
 * Qualified Name:     com.tencent.mobileqq.matchchat.MatchChatItemBuilder
