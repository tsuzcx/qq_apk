  ...
  implements View.OnClickListener, CompoundButton.OnCheckedChangeListener
{
  ...
  private anoj jdField_a_of_type_Anoj = new arjh(this);
  ...
  private void a()
  {
    ...
    ((anod)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(127)).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
  }
  ...
  private void a(View paramView)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem = ((FormSwitchItem)paramView.findViewById(2131307393));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131307392));
  ...
  public void onCheckedChanged(CompoundButton paramCompoundButton, boolean paramBoolean)
  {
    ...
    if (paramCompoundButton == this.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem.a())
    {
      ...
      {
        ((anod)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(127)).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), paramBoolean);
        if (paramBoolean) {
          i = 0;
        }
    ...
    {
      a(paramBoolean);
      bbmy.a(getActivity(), 2131628957, 0).a();
      return;
    }
  }
  ...
  public View onCreateCenterView()
  {
    ...
    setTitle(getActivity().getString(2131633351));
    return localView;
  }
