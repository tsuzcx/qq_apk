  ...
  implements Manager
{
  ...
  public static HashMap<String, VoiceChangeParams> a;
  public static String[] a;
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  DownloadListener jdField_a_of_type_ComTencentMobileqqVipDownloadListener = new VoiceChangeManager.1(this);
  ...
  public static void a(int paramInt1, String paramString1, String paramString2, int paramInt2, int paramInt3)
  {
    ...
    //   12: istore_0
    //   13: getstatic 24	com/tencent/mobileqq/voicechange/VoiceChangeManager:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   16: aload_1
    //   17: invokevirtual 75	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   20: checkcast 77	com/tencent/mobileqq/voicechange/VoiceChangeParams
    //   23: astore 7
    //   25: aload 7
    //   27: ifnull +88 -> 115
    //   30: aload 7
    //   32: getfield 80	com/tencent/mobileqq/voicechange/VoiceChangeParams:jdField_a_of_type_ComTencentMobileqqVoicechangeVoiceChangeParams$IOnCompressFinish	Lcom/tencent/mobileqq/voicechange/VoiceChangeParams$IOnCompressFinish;
    //   35: ifnull +84 -> 119
    //   38: aload_1
    //   39: aload_2
    //   40: iload_3
    //   41: invokestatic 85	com/tencent/mobileqq/voicechange/VoiceTuneUtil:a	(Ljava/lang/String;Ljava/lang/String;I)V
    //   44: aload 7
    //   46: getfield 80	com/tencent/mobileqq/voicechange/VoiceChangeParams:jdField_a_of_type_ComTencentMobileqqVoicechangeVoiceChangeParams$IOnCompressFinish	Lcom/tencent/mobileqq/voicechange/VoiceChangeParams$IOnCompressFinish;
    //   49: aload_1
    //   50: iload 4
    //   52: iload_0
    ...
    //   107: getstatic 24	com/tencent/mobileqq/voicechange/VoiceChangeManager:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   110: aload_1
    ...
    //   119: aload 7
    //   121: iconst_1
    //   122: putfield 118	com/tencent/mobileqq/voicechange/VoiceChangeParams:jdField_a_of_type_Boolean	Z
    //   125: aload 7
    //   127: iload_0
    //   128: putfield 121	com/tencent/mobileqq/voicechange/VoiceChangeParams:jdField_a_of_type_Int	I
    //   131: goto -16 -> 115
    //   134: astore_1
    //   135: ldc 2
    //   137: monitorexit
    ...
    for (;;)
    {
      try
      {
        ...
        if (localVoiceChangeParams.jdField_a_of_type_Boolean)
        {
          ...
          paramIOnCompressFinish.onCompressFinished(paramString, localVoiceChangeParams.jdField_a_of_type_ComTencentMobileqqVoicechangeVoiceChangeBasicParams.e, localVoiceChangeParams.jdField_a_of_type_Int);
          if (QLog.isColorLevel()) {
  ...
  public boolean a(ArrayList<VoiceChangeData> paramArrayList, JSONObject paramJSONObject)
  {
    ...
    if (paramJSONObject == null) {
      localObject1 = VasUpdateUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "changeVoice_json", false, null);
    }
    ...
    for (;;)
    {
      if (i < arrayOfInt.length)
      {
        ...
        if (j != 0)
        {
          ...
          {
            i = j;
            if (IndividuationConfigInfo.a(((JSONObject)localObject2).getString("QQVersion"), "8.5.5"))
            {
              j = 0;
              i = j;
              if (QLog.isColorLevel())
        ...
        for (localObject2 = paramJSONObject.jdField_b_of_type_JavaLangString;; localObject2 = ((JSONObject)localObject4).getString("description"))
        {
          ...
          break label1363;
          localObject3 = ClubContentJsonTask.jdField_b_of_type_JavaLangString + (String)localObject3;
      ...
      for (;;)
      {
        if (i < paramJSONObject.length)
        {
          ...
          if (localObject1 != null)
          {
            ...
            {
              localObject1 = ClubContentJsonTask.jdField_b_of_type_JavaLangString + (String)localObject1;
