  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    Object localObject1 = ((ITroopInfoService)this.c.this$0.a.getRuntimeService(ITroopInfoService.class, "")).getCommonlyUsedTroopList();
    if (QLog.isColorLevel())
    {
    ...
    if (localObject1 != null)
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        localObject3 = CommonUtils.d(this.c.this$0.a, ((CommonlyUsedTroop)localObject2).troopUin);
        if (localObject3 != null)
        {
          this.c.this$0.a((TroopInfo)localObject3, this.c.a);
          this.c.this$0.e.add(localObject3);
        }
