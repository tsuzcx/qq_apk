  ...
  implements DecodeTaskCompletionListener, AbsListView.OnScrollListener
{
  ...
  public DiscussionListAdapter2(Context paramContext, DiscussionListAdapter2.DiscussionListListener paramDiscussionListListener, ListView paramListView, AppInterface paramAppInterface, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqSelectmemberAdapterDiscussionListAdapter2$DiscussionListListener = paramDiscussionListListener;
  ...
  private void b()
  {
    this.jdField_a_of_type_JavaUtilList = ((ArrayList)((IDiscussionService)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getRuntimeService(IDiscussionService.class, "")).getDiscussList());
    ...
    while (localIterator.hasNext())
    {
      ...
      long l1 = 0L;
      String str2 = CommonUtils.a(this.jdField_a_of_type_AndroidContentContext, localDiscussionInfo);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (getItemViewType(paramInt) == 1)
    {
      ...
      Object localObject = CommonUtils.a(this.jdField_a_of_type_AndroidContentContext, localDiscussionInfo);
      localViewTag.jdField_a_of_type_AndroidWidgetTextView.setText((CharSequence)localObject);
      localViewTag.jdField_b_of_type_AndroidWidgetTextView.setText(String.format("(%d)", new Object[] { Integer.valueOf(((IDiscussionService)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getRuntimeService(IDiscussionService.class, "")).getDiscussionMemberNum(str)) }));
      localObject = this.jdField_a_of_type_ComTencentMobileqqAppFaceIFaceDecoder.getBitmapFromCache(101, str);
      if (localObject == null) {
        localViewTag.jdField_a_of_type_AndroidWidgetImageView.setBackgroundDrawable(BaseImageUtil.d());
      } else {
