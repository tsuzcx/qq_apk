  ...
  extends MSFServlet
{
  ...
  private void a(DanmuDataHolder.CacheHolder paramCacheHolder, oidb_0xdea.GetBarrageListRspBody paramGetBarrageListRspBody)
  {
    ...
    paramCacheHolder.a(DanmuDataHolder.a().a(localList1, paramCacheHolder.jdField_a_of_type_ComTencentMobileqqCommentDanmuDataContext.b)).b(localList2).a(m).b(n).c(k).a(bool).a();
  }
  ...
  void a(DanmuDataHolder.CacheHolder paramCacheHolder)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("DanmuDataHolder", 2, "request called, param:" + paramCacheHolder.a());
    }
    Object localObject = new oidb_0xdea.GetBarrageListReqBody();
    ((oidb_0xdea.GetBarrageListReqBody)localObject).uint64_group_code.set(paramCacheHolder.jdField_a_of_type_ComTencentMobileqqCommentDanmuDataContext.b);
    ((oidb_0xdea.GetBarrageListReqBody)localObject).uint64_barrage_seq.set(paramCacheHolder.jdField_a_of_type_ComTencentMobileqqCommentDanmuDataContext.jdField_a_of_type_Long);
    ((oidb_0xdea.GetBarrageListReqBody)localObject).uint32_last_update_time.set(paramCacheHolder.jdField_a_of_type_Int);
    ((oidb_0xdea.GetBarrageListReqBody)localObject).uint32_start_index.set(paramCacheHolder.e);
    ((oidb_0xdea.GetBarrageListReqBody)localObject).uint32_barrage_count.set(paramCacheHolder.f);
    int i;
    if ((paramCacheHolder.jdField_a_of_type_ComTencentMobileqqCommentDanmuDataContext.jdField_a_of_type_Int == 101) || (paramCacheHolder.jdField_a_of_type_ComTencentMobileqqCommentDanmuDataContext.jdField_a_of_type_Int == 103))
    {
      ...
      ((oidb_0xdea.GetBarrageListReqBody)localObject).uint32_video_start_time.set(paramCacheHolder.jdField_c_of_type_Int);
      ((oidb_0xdea.GetBarrageListReqBody)localObject).uint32_video_end_time.set(paramCacheHolder.jdField_d_of_type_Int);
      label182:
    ...
    for (;;)
    {
      ...
      localObject = DanmuDataHolder.a().a();
      NewIntent localNewIntent = new NewIntent(((QQAppInterface)localObject).getApp(), DanmuDataServlet.class);
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if ((l1 == 0L) || (l2 == 0L))
    {
      ...
      for (;;)
      {
        DanmuUtil.a(bool1, i, -1, false, "onReceive, topicUin:0, groupUin:0");
        return;
        bool1 = false;
      }
    }
    paramIntent = DanmuDataHolder.a().a(l2, l1);
    DanmuDataHolder.CacheHolder localCacheHolder = DanmuDataHolder.a().a(paramIntent);
    if (localCacheHolder == null)
    {
      ...
      {
        DanmuUtil.a(bool1, i, -1, false, "onReceive, holder null");
        return;
      }
    }
    if ((paramFromServiceMsg != null) && (paramFromServiceMsg.isSuccess()))
    {
      ...
      if (paramIntent != null) {
        a(localCacheHolder, paramIntent);
      }
    }
    for (bool1 = true;; bool1 = false)
    {
      ...
      {
        bool2 = true;
        int j = localCacheHolder.jdField_a_of_type_ComTencentMobileqqCommentDanmuDataContext.jdField_a_of_type_Int;
        if (!bool1) {
          break label379;
        }
        paramIntent = "DanmuRsp Valid";
        label246:
        DanmuUtil.a(bool2, i, j, bool1, paramIntent);
        if (!bool1) {
          break label395;
        }
        paramFromServiceMsg = localCacheHolder.jdField_a_of_type_ComTencentMobileqqCommentDanmuDataIPCClient$DanmuPullCallback;
        DanmuDataContext localDanmuDataContext = localCacheHolder.jdField_a_of_type_ComTencentMobileqqCommentDanmuDataContext;
        bool2 = localCacheHolder.jdField_a_of_type_Boolean;
        i = localCacheHolder.b;
        if (!localCacheHolder.jdField_a_of_type_ComTencentMobileqqCommentDanmuDataContext.jdField_a_of_type_Boolean) {
          break label386;
        }
        paramIntent = localCacheHolder.jdField_c_of_type_JavaUtilList;
        label305:
        paramFromServiceMsg.a(localDanmuDataContext, true, bool2, i, (ArrayList)paramIntent, localCacheHolder.jdField_a_of_type_JavaUtilList);
        localCacheHolder.jdField_a_of_type_ComTencentMobileqqCommentDanmuDataContext.jdField_a_of_type_Boolean = true;
      }
      for (;;)
      {
        if ((!bool1) || (localCacheHolder.jdField_a_of_type_Boolean)) {
          break label424;
        }
        if (QLog.isColorLevel()) {
        ...
        break label246;
        label386:
        paramIntent = localCacheHolder.jdField_d_of_type_JavaUtilList;
        break label305;
        label395:
        localCacheHolder.jdField_a_of_type_ComTencentMobileqqCommentDanmuDataIPCClient$DanmuPullCallback.a(localCacheHolder.jdField_a_of_type_ComTencentMobileqqCommentDanmuDataContext, false, localCacheHolder.jdField_a_of_type_Boolean, localCacheHolder.b, null, null);
      }
      label424:
      break;
    }
