  ...
  extends RelativeLayout
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new aaes(this);
  private View.OnTouchListener jdField_a_of_type_AndroidViewView$OnTouchListener = new aaer(this);
  ...
  private void e()
  {
    LayoutInflater.from(getContext()).inflate(2130970182, this, true);
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetCircleProgress.setBgAndProgressColor(100, getResources().getColor(2131492968), 100, getResources().getColor(2131493306));
  ...
  private void f()
  {
    ...
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new aaep(this));
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new aaeq(this));
