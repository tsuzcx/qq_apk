  ...
  extends VasManager<ColorScreenConfig>
{
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (!localFile3.exists())
        {
          ...
          VasMonitorDT.a("individual_v2_colorscreen_parse_fail", "errCode:1, id:" + paramInt);
      ...
      ColorScreenConfig localColorScreenConfig;
      localColorScreenConfig.jdField_a_of_type_JavaLangString = localFile2.getAbsolutePath();
      localColorScreenConfig.jdField_b_of_type_JavaLangString = (localObject1.getAbsolutePath() + File.separator + "images");
      try
      {
        Object localObject2 = new JSONObject(FileUtils.a(localFile3));
        localColorScreenConfig.jdField_a_of_type_Int = (((JSONObject)localObject2).optInt("repeatCount", localColorScreenConfig.jdField_a_of_type_Int) - 1);
        localColorScreenConfig.jdField_a_of_type_Long = ((JSONObject)localObject2).optLong("eastInTime", localColorScreenConfig.jdField_a_of_type_Long);
        localColorScreenConfig.jdField_b_of_type_Long = ((JSONObject)localObject2).optLong("eastOutTime", localColorScreenConfig.jdField_b_of_type_Long);
        localObject2 = localColorScreenConfig;
        if (QLog.isColorLevel())
        {
  ...
  public void a(int paramInt)
  {
    ...
    if (localIVasQuickUpdateService != null) {
      localIVasQuickUpdateService.downloadItem(22L, str, "ColorScreenManager");
    }
  }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    //   5: aload_0
    //   6: aload_1
    //   7: invokevirtual 258	com/tencent/mobileqq/floatscr/ColorScreenManager:a	(Ljava/lang/String;)I
    //   10: istore_3
    //   11: iload_3
    //   12: ifle +65 -> 77
    //   15: iload_2
    ...
    //   24: aload_0
    //   25: iload_3
    //   26: invokevirtual 272	com/tencent/mobileqq/floatscr/ColorScreenManager:a	(I)Lcom/tencent/mobileqq/floatscr/ColorScreenConfig;
    //   29: astore 5
    //   31: aload_0
    //   32: aload_1
    //   33: aload 5
    //   35: invokevirtual 275	com/tencent/mobileqq/floatscr/ColorScreenManager:a	(Ljava/lang/String;Ljava/lang/Object;)V
    //   38: aload 5
    //   40: ifnonnull +37 -> 77
    //   43: aload_0
    //   44: getfield 20	com/tencent/mobileqq/floatscr/ColorScreenManager:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    //   47: ldc_w 277
    //   50: iload_2
    //   51: invokestatic 280	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   54: aload 4
    //   56: iload_3
    ...
    //   62: fconst_0
    //   63: fconst_0
    //   64: invokestatic 135	com/tencent/mobileqq/vas/VasMonitorHandler:a	(Lmqq/app/AppRuntime;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;FF)V
    //   67: ldc_w 277
    //   70: iload_2
    //   71: invokestatic 280	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   74: invokestatic 145	com/tencent/mobileqq/vas/VasMonitorDT:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   77: aload_0
    //   78: monitorexit
    //   79: return
    //   80: aload_0
    //   81: iload_3
    //   82: invokevirtual 85	com/tencent/mobileqq/floatscr/ColorScreenManager:a	(I)Ljava/io/File;
    //   85: astore 6
    ...
    //   174: aload 6
    //   176: iconst_0
    //   177: invokestatic 287	com/tencent/mobileqq/utils/FileUtils:a	(Ljava/lang/String;Ljava/lang/String;Z)V
    //   180: goto -156 -> 24
    //   183: astore 6
    ...
    //   0	314	0	this	ColorScreenManager
