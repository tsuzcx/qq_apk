  ...
  extends MessageMicro<RecommendPageRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 32, 40, 48, 56, 66 }, new String[] { "uint32_new_timestamp", "rpt_msg_rcmd", "retInfo", "uint32_endFlag", "uint32_next_index", "uint32_total_num", "rcmd_col_mode", "union_channel" }, new Object[] { localInteger, null, null, localInteger, localInteger, localInteger, localInteger, "" }, RecommendPageRsp.class);
  }
}
