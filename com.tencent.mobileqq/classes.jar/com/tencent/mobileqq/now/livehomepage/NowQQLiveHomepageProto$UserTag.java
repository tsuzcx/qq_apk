...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 34, 40, 50 }, new String[] { "pic_url", "wording", "color", "change_color", "type", "background_pic_url" }, new Object[] { "", "", Integer.valueOf(0), "", Integer.valueOf(0), "" }, UserTag.class);
