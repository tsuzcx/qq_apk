  ...
  extends MessageMicro<RcmdTopicOrVideo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 18, 24, 34, 42, 48, 58, 66, 72, 80 }, new String[] { "topic_word", "topic_word_color", "pic", "url", "type", "native_url", "pic_samll", "color_a", "color_b" }, new Object[] { "", localInteger, "", "", localInteger, "", "", localLong, localLong }, RcmdTopicOrVideo.class);
  }
}
