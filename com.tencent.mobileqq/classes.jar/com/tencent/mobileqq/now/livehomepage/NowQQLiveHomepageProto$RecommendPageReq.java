...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 42, 48, 58, 66, 72, 82, 90 }, new String[] { "uint32_last_update", "uint32_index", "uint32_count", "is_need_banner_topic", "user_msg_info", "rcmd_col_mode", "channel", "union_channel", "is_no_public_room", "device_id", "qimei" }, new Object[] { Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), null, Integer.valueOf(0), "", "", Integer.valueOf(0), "", "" }, RecommendPageReq.class);
