  ...
  extends MessageMicro<AccountBaseInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "login_type", "uid", "tinyid" }, new Object[] { Integer.valueOf(0), localLong, localLong }, AccountBaseInfo.class);
  }
}
