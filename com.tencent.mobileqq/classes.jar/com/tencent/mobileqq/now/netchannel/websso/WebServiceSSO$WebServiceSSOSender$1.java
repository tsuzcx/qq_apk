...
class WebServiceSSO$WebServiceSSOSender$1
  implements Runnable
{
  WebServiceSSO$WebServiceSSOSender$1(WebServiceSSO.WebServiceSSOSender paramWebServiceSSOSender, Future paramFuture, aydx paramaydx) {}
  ...
  public void run()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Aydx.a((byte[])localObject);
      return;
    }
    catch (InterruptedException localInterruptedException)
    {
      this.jdField_a_of_type_ComTencentMobileqqNowNetchannelWebssoWebServiceSSO$WebServiceSSOSender.b.incrementAndGet();
      this.jdField_a_of_type_Aydx.a(-1, "InterruptedException");
      return;
    }
    catch (ExecutionException localExecutionException)
    {
      ...
      if ((localExecutionException.getCause() instanceof WebServiceSSO.WebServiceSSOSender.SSOException))
      {
        ...
        this.jdField_a_of_type_Aydx.a(localSSOException.errorCode, localSSOException.errorMessage);
        return;
      }
      this.jdField_a_of_type_Aydx.a(-2, localSSOException.getCause().getMessage());
      return;
    }
    catch (Exception localException)
    {
      this.jdField_a_of_type_Aydx.a(-3, localException.getCause().getMessage());
    }
  }
}
