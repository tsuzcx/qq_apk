...
class WebServiceSSO$WebServiceSSOSender$1
  implements Runnable
{
  WebServiceSSO$WebServiceSSOSender$1(WebServiceSSO.WebServiceSSOSender paramWebServiceSSOSender, Future paramFuture, aywq paramaywq) {}
  
  public void run()
  {
    Object localObject = this.jdField_a_of_type_JavaUtilConcurrentFuture;
    if (this.jdField_a_of_type_Aywq != null) {}
    try
    {
      ...
      this.jdField_a_of_type_Aywq.a((byte[])localObject);
      return;
    }
    catch (InterruptedException localInterruptedException)
    {
      this.jdField_a_of_type_ComTencentMobileqqNowNetchannelWebssoWebServiceSSO$WebServiceSSOSender.b.incrementAndGet();
      this.jdField_a_of_type_Aywq.a(-1, "InterruptedException");
      return;
    }
    catch (ExecutionException localExecutionException)
    {
      ...
      if ((localExecutionException.getCause() instanceof WebServiceSSO.WebServiceSSOSender.SSOException))
      {
        ...
        this.jdField_a_of_type_Aywq.a(localSSOException.errorCode, localSSOException.errorMessage);
        return;
      }
      this.jdField_a_of_type_Aywq.a(-2, localSSOException.getCause().getMessage());
      return;
    }
    catch (Exception localException)
    {
      this.jdField_a_of_type_Aywq.a(-3, localException.getCause().getMessage());
    }
  }
}
