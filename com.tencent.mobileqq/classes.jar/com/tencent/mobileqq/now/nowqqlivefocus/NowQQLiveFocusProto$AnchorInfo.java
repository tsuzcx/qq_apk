...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 40, 50, 58, 64, 74, 82, 90, 98, 104, 112, 120 }, new String[] { "uin", "room_id", "start_time", "cover_url", "audience_sum", "jump_url", "nick_name", "user_type", "room_city", "anchor_logo_url", "room_name", "medal_info_list", "cover_ts", "type", "content_type" }, new Object[] { Long.valueOf(0L), Integer.valueOf(0), Integer.valueOf(0), "", Integer.valueOf(0), "", "", Integer.valueOf(0), "", "", "", null, Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0) }, AnchorInfo.class);
