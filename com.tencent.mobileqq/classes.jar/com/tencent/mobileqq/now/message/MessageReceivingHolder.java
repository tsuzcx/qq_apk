  ...
  extends RecyclerHolder
{
  ...
  private ViewPager.OnPageChangeListener jdField_a_of_type_AndroidSupportV4ViewViewPager$OnPageChangeListener = new MessageReceivingHolder.1(this);
  ...
  public MessageReceivingHolder(FragmentActivity paramFragmentActivity, RecyclerView paramRecyclerView, View paramView)
  {
    super(paramView);
    this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity = paramFragmentActivity;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramFragmentActivity.app;
    this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie = new PublicAccountChatPie(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.app, this.jdField_a_of_type_ComTencentMobileqqNowWidgetDecoratorViewPager, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity);
    this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.a.jdField_a_of_type_Int = 1008;
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131371203));
    this.jdField_a_of_type_ComTencentMobileqqNowWidgetDecoratorViewPager = ((DecoratorViewPager)paramView.findViewById(2131381619));
    ...
    this.jdField_a_of_type_ComTencentMobileqqNowWidgetSimpleCircleIndicator = ((SimpleCircleIndicator)paramView.findViewById(2131364754));
  ...
  private void a(ChatMessage paramChatMessage)
  {
    if (paramChatMessage != null) {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(TimeFormatterUtils.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 3, paramChatMessage.time * 1000L, true));
    }
  }
  ...
  private void c()
  {
    ...
    for (localObject = ((PublicAccountDataManager)localObject).a(NowQQLiveConstant.a);; localObject = null)
    {
