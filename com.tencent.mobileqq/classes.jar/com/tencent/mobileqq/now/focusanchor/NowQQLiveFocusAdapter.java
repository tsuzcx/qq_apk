  ...
  implements FocusLiveStreamListener
{
  ...
  public NowQQLiveFocusAdapter(FragmentActivity paramFragmentActivity, List<NowQQLiveAnchorInfo> paramList)
  {
  ...
  {
    return new NowQQLiveFocusAdapter.ViewHolder(View.inflate(paramViewGroup.getContext(), 2131559640, null));
  }
  ...
  public void a(NowQQLiveFocusAdapter.ViewHolder paramViewHolder, int paramInt)
  {
    ...
    ImageLoader.a().a(paramViewHolder.jdField_a_of_type_ComTencentMobileqqNowWidgetCircleImageView, localNowQQLiveAnchorInfo.c(), new ColorDrawable(0), new ColorDrawable(0), 80, 80, null, false);
