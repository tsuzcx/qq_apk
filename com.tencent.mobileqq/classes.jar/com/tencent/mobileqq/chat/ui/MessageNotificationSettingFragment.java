  ...
  implements View.OnClickListener, CompoundButton.OnCheckedChangeListener, anxe
{
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_Anxb.b(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int);
    if (this.jdField_a_of_type_Int == 0) {
      azmj.b(null, "dc00898", "", "", "0X800A3C7", "0X800A3C7", 1, 0, "", "", "", "");
    }
    while (this.jdField_a_of_type_Int != 1) {
      return;
    }
    azmj.b(null, "dc00898", "", "", "0X800A3C7", "0X800A3C7", 2, 0, "", "", "", "");
  }
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem = ((FormSwitchItem)a(2131376437));
    this.b = ((FormSwitchItem)a(2131376438));
    this.jdField_a_of_type_ComTencentMobileqqWidgetFormSimpleItem = ((FormSimpleItem)a(2131376439));
    this.c = ((FormSwitchItem)a(2131376440));
    Object localObject;
    if (this.jdField_a_of_type_Int == 0)
    {
      localObject = this.jdField_a_of_type_Aloz.a(this.jdField_a_of_type_JavaLangString, true);
      if (localObject == null)
      {
  ...
  {
    this.jdField_a_of_type_Anxb.a(this.jdField_a_of_type_ComTencentMobileqqWidgetFormSimpleItem, paramInt, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int);
  }
  ...
  public void onCheckedChanged(CompoundButton paramCompoundButton, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if (i != 0)
      {
        this.jdField_a_of_type_Alzf.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), j, 1024, i4);
        if (paramBoolean) {}
        for (i = k;; i = 2)
        {
          azmj.b(null, "dc00898", "", "", "0X800A3CB", "0X800A3CB", i, 0, "", "", "", "");
          return;
        }
      }
      ...
      for (i = m;; i = 2)
      {
        azmj.b(null, "dc00898", "", "", "0X800A3C8", "0X800A3C8", i, 0, "", "", "", "");
        return;
      }
      if (this.b.a() == paramCompoundButton)
      {
        ...
        if (paramBoolean)
        {
          ...
          this.jdField_a_of_type_Alzf.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), j, 2048, i4);
          if (!paramBoolean) {
            break label435;
          }
        }
        for (i = n;; i = 2)
        {
          azmj.b(null, "dc00898", "", "", "0X800A3CC", "0X800A3CC", i, 0, "", "", "", "");
          return;
          this.jdField_a_of_type_ComTencentMobileqqWidgetFormSimpleItem.setVisibility(8);
          break;
        }
        ...
        for (i = i1;; i = 2)
        {
          azmj.b(null, "dc00898", "", "", "0X800A3C9", "0X800A3C9", i, 0, "", "", "", "");
          return;
        }
      }
    ...
    if (i != 0)
    {
      this.jdField_a_of_type_Alzf.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), j, 4096, i4);
      if (paramBoolean) {}
      for (i = i2;; i = 2)
      {
        azmj.b(null, "dc00898", "", "", "0X800A3CD", "0X800A3CD", i, 0, "", "", "", "");
        return;
      }
    }
    ...
    for (int i = i3;; i = 2)
    {
      azmj.b(null, "dc00898", "", "", "0X800A3CA", "0X800A3CA", i, 0, "", "", "", "");
      return;
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    if (this.jdField_a_of_type_Int == 0)
    {
      azmj.b(null, "dc00898", "", "", "0X800A3C5", "0X800A3C5", 1, 0, "", "", "", "");
    ...
    for (paramView = "3";; paramView = "2")
    {
      ...
      azmj.b(null, "dc00898", "", "", "0X800A3C5", "0X800A3C5", 3, 0, "", "", "", "");
  ...
  public void onResume()
  {
    ...
    if (this.jdField_a_of_type_Int == 0)
    {
      localObject = this.jdField_a_of_type_Aloz.a(this.jdField_a_of_type_JavaLangString, false);
      if (localObject == null)
      {
        QLog.d("MessageNotificationSettingFragment", 1, new Object[] { "onResume: invoked. ", " extensionInfo: ", localObject });
        this.jdField_a_of_type_Anxb.a(this.jdField_a_of_type_ComTencentMobileqqWidgetFormSimpleItem, i, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int);
      }
    }
    while (this.jdField_a_of_type_Int != 1) {
      for (;;)
    ...
    {
      this.jdField_a_of_type_Anxb.a(this.jdField_a_of_type_ComTencentMobileqqWidgetFormSimpleItem, i);
      return;
      if (QLog.isColorLevel()) {
  ...
  public void onViewCreated(View paramView, Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_Anxb = anxb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    a();
    c();
    b();
  }
