...
class ScribbleMsgUtils$SendAfterCombinePicAndDataTask
  extends AsyncTask<Void, Void, Integer>
{
  ...
  public ScribbleMsgUtils$SendAfterCombinePicAndDataTask(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, Bitmap paramBitmap, int paramInt2, ScribbleMsgUtils.CombineCallback paramCombineCallback)
  {
  ...
  int a()
  {
    String str1 = ScribbleMsgUtils.a() + "temp/" + System.currentTimeMillis();
    String str2 = ScribbleMsgUtils.a() + "temp/" + System.currentTimeMillis() + "_data";
    boolean bool = false;
 ...
 * Qualified Name:     com.tencent.mobileqq.scribble.ScribbleMsgUtils.SendAfterCombinePicAndDataTask
