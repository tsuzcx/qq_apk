...
public class ScribbleResMgr
{
  ...
  protected Handler a;
  private final ArrayList<aycj> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private Lock jdField_a_of_type_JavaUtilConcurrentLocksLock = new ReentrantLock();
  public boolean a;
  private final Handler jdField_b_of_type_AndroidOsHandler = new aycf(this, Looper.getMainLooper());
  ...
  static
  {
    jdField_a_of_type_JavaLangString = aljq.cm + "Config/";
    jdField_b_of_type_JavaLangString = aljq.cm + "Config/paint/";
    jdField_c_of_type_JavaLangString = aljq.cm + "Config/gif/";
    jdField_d_of_type_JavaLangString = aljq.cm + "Config/line_icon/";
    jdField_e_of_type_JavaLangString = aljq.cm + "Config/gif_icon/";
  ...
  public static ArrayList<ScribbleResMgr.ResInfo> a(JSONArray paramJSONArray, int paramInt)
  {
    ...
    try
    {
      ...
      while (j < k)
      {
        ScribbleResMgr.ResInfo localResInfo = (ScribbleResMgr.ResInfo)atco.a(paramJSONArray.getJSONObject(j), ScribbleResMgr.ResInfo.class);
        if (localResInfo != null)
        {
  ...
  /* Error */
  private void a(int paramInt1, int paramInt2, View paramView, ayck paramayck)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   28: checkcast 237	aycj
    //   31: astore 6
    //   33: aload 6
    //   35: invokevirtual 240	aycj:a	()Landroid/view/View;
    //   38: aload_3
    //   39: if_acmpne -28 -> 11
    //   42: aload 6
    ...
    //   53: putfield 248	aycj:b	Ljava/lang/ref/WeakReference;
    //   56: aload_0
    //   57: monitorexit
    //   58: return
    //   59: aload_0
    ...
    //   70: aload_3
    //   71: aload 4
    //   73: invokespecial 251	aycj:<init>	(Lcom/tencent/mobileqq/scribble/ScribbleResMgr;IILandroid/view/View;Layck;)V
    ...
    //   0	88	4	paramayck	ayck
    //   9	13	5	localIterator	Iterator
    //   31	12	6	localaycj	aycj
    // Exception table:
    //   from	to	target	type
    //   2	11	83	finally
    //   11	56	83	finally
  ...
  public static void a(Context paramContext, String paramString)
  {
    ...
    bdiv.a(paramContext, Boolean.valueOf(false), paramString);
  }
  ...
  private void a(QQAppInterface paramQQAppInterface)
  {
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      String str = bdiv.o(paramQQAppInterface.getApp().getApplicationContext());
      paramQQAppInterface = bdiv.n(paramQQAppInterface.getApp().getApplicationContext());
  ...
  private void a(QQAppInterface paramQQAppInterface, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      if ((k != 0) && (!this.jdField_d_of_type_Boolean))
      {
        ...
        aova.g(paramQQAppInterface, paramQQAppInterface.getCurrentAccountUin());
      }
      return;
  ...
  private void a(QQAppInterface paramQQAppInterface, ScribbleResMgr.ResInfo paramResInfo, long paramLong, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      localbavr = (bavr)paramQQAppInterface.getManager(193);
      if (localbavr.a())
      {
        str = null;
    ...
    for (;;)
    {
      ...
      paramQQAppInterface = new bavs(paramQQAppInterface, "doodle_msg_res", local4, 4000L);
      localbavr.a(10068, "prd", String.valueOf(paramResInfo.sourceId), 0, paramResInfo.sourceUrl, str, 2, 0, true, paramQQAppInterface);
      return;
  ...
  private void a(ArrayList<ScribbleResMgr.ResInfo> paramArrayList)
  {
    ...
    Collections.sort(paramArrayList, new aycg(this));
  }
  
  public static boolean a(Context paramContext, String paramString)
  {
    boolean bool = bdiv.p(paramContext, paramString);
  ...
  private boolean a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    String str = bdiv.m(paramQQAppInterface.getApp().getBaseContext());
    for (;;)
    {
      try
      {
      ...
      catch (JSONException localJSONException1)
      {
        try
        {
          ...
          bdiv.w(paramQQAppInterface.getApp().getBaseContext(), (String)localObject1);
          bdiv.y(paramQQAppInterface.getApp().getBaseContext(), paramString);
  ...
  public static boolean a(String paramString1, Context paramContext, String paramString2)
  {
    ...
    //   203: iload 10
    //   205: aload_2
    //   206: invokestatic 606	bdiv:b	(Landroid/content/Context;ZLjava/lang/String;)V
    //   209: iload 7
    //   211: ifeq +257 -> 468
    //   214: aload_1
    //   215: aload_2
    //   216: invokestatic 609	bdiv:a	(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/Float;
    ...
    //   238: aload_2
    //   239: invokestatic 277	bdiv:a	(Landroid/content/Context;Ljava/lang/Boolean;Ljava/lang/String;)V
    //   242: aload_1
    //   243: fload 5
    //   245: invokestatic 612	java/lang/Float:valueOf	(F)Ljava/lang/Float;
    //   248: aload_2
    //   249: invokestatic 615	bdiv:a	(Landroid/content/Context;Ljava/lang/Float;Ljava/lang/String;)V
    //   252: ldc 225
    //   254: iconst_2
    ...
    //   295: aload_1
    //   296: aload_2
    //   297: invokestatic 624	bdiv:b	(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/Float;
    ...
    //   317: aload_2
    //   318: invokestatic 626	bdiv:b	(Landroid/content/Context;Ljava/lang/Float;Ljava/lang/String;)V
    //   321: aload_1
    //   322: iload 9
    //   324: aload_2
    //   325: invokestatic 628	bdiv:c	(Landroid/content/Context;ZLjava/lang/String;)V
    //   328: ldc 225
    //   330: iconst_2
    ...
    //   501: aload_2
    //   502: invokestatic 277	bdiv:a	(Landroid/content/Context;Ljava/lang/Boolean;Ljava/lang/String;)V
    //   505: goto -215 -> 290
    //   508: ldc 225
    //   510: iconst_2
    ...
    //   536: iload 9
    //   538: aload_2
    //   539: invokestatic 628	bdiv:c	(Landroid/content/Context;ZLjava/lang/String;)V
    //   542: goto -177 -> 365
    //   545: astore 12
    //   547: fconst_0
    //   548: fstore 4
  ...
  {
    bdiv.c(paramContext, false, paramString);
  ...
  public static boolean b(Context paramContext, String paramString)
  {
    ...
    boolean bool2 = bdiv.q(paramContext, paramString);
  ...
  {
    Object localObject2 = null;
    String str = bdiv.l(paramQQAppInterface.getApp().getBaseContext());
    for (;;)
    {
      try
      {
      ...
      catch (JSONException localJSONException1)
      {
        try
        {
          ...
          bdiv.v(paramQQAppInterface.getApp().getBaseContext(), (String)localObject1);
          bdiv.x(paramQQAppInterface.getApp().getBaseContext(), paramString);
  ...
  {
    boolean bool = bdiv.o(paramContext, paramString);
  ...
  public void a(QQAppInterface paramQQAppInterface, int paramInt1, int paramInt2, View paramView, ayck paramayck)
  {
    a(paramInt1, paramInt2, paramView, paramayck);
