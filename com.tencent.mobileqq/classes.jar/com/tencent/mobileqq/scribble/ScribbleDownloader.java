  ...
  implements Handler.Callback, Manager
{
  ...
  public ScribbleDownloader.DownloadListManager a;
  public String a;
  ...
  public ScribbleDownloader(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqScribbleScribbleDownloader$DownloadListManager = new ScribbleDownloader.DownloadListManager(this);
  ...
  {
    int i = this.jdField_a_of_type_ComTencentMobileqqScribbleScribbleDownloader$DownloadListManager.a(paramScribbleDownloadInfo);
  ...
  {
    ThreadManager.post(new ScribbleDownloader.1(this, paramScribbleDownloadInfo), 5, null, false);
  }
  
  private void d()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqScribbleScribbleDownloader$DownloadListManager.a() < 2)
    {
      ScribbleDownloadInfo localScribbleDownloadInfo = this.jdField_a_of_type_ComTencentMobileqqScribbleScribbleDownloader$DownloadListManager.a();
  ...
  {
    int i = this.jdField_a_of_type_ComTencentMobileqqScribbleScribbleDownloader$DownloadListManager.a(paramMessageForScribble);
