...
public class WerewolvesHostInterface
{
  ...
  public GameRoomAVController mGameRoomAVController;
  ...
  public void disableMic()
  {
    if (this.manager.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildGameRoomChatPie != null) {
      this.manager.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildGameRoomChatPie.o(false);
    }
    ...
    this.mGameRoomAVController.a(new akdx(this));
  }
  
  public void enableMic()
  {
    if (this.manager.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildGameRoomChatPie != null) {
      this.manager.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildGameRoomChatPie.o(true);
    }
  }
  ...
  public void enterProfile(String paramString)
  {
    ...
    if (this.manager.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildGameRoomChatPie != null)
    {
      ...
      boolean bool1 = ((FriendsManager)localQQAppInterface.getManager(50)).b(paramString);
  ...
  public void existRoom()
  {
    ...
    if (localHotChatInfo != null) {
      ((WerewolvesHandler)localQQAppInterface.a(107)).a(localHotChatInfo);
    }
  ...
  public Bitmap getFaceBitmap(String paramString, boolean paramBoolean)
  {
    ...
    Object localObject2;
    if (this.manager.jdField_a_of_type_ComTencentMobileqqUtilFaceDecoder != null)
    {
      localObject1 = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
      localObject2 = (FriendsManager)((QQAppInterface)localObject1).getManager(50);
      ...
      localObject2 = this.manager.jdField_a_of_type_ComTencentMobileqqUtilFaceDecoder.a(1, paramString, 200);
      ...
      if (localObject2 == null)
      {
        ...
        if (paramBoolean)
        {
          this.manager.jdField_a_of_type_ComTencentMobileqqUtilFaceDecoder.a(paramString, 1, true);
          localObject1 = localObject2;
        }
      }
    }
    for (;;)
    {
      ...
      return paramString;
      label125:
      localObject2 = this.manager.jdField_a_of_type_ComTencentMobileqqUtilFaceDecoder.a(32, paramString, 200);
      localObject1 = localObject2;
      if (localObject2 == null)
      {
        localObject1 = localObject2;
        if (paramBoolean)
        {
          this.manager.jdField_a_of_type_ComTencentMobileqqUtilFaceDecoder.a(paramString, 200, true, false);
          localObject1 = localObject2;
        }
      }
    }
  ...
  public void getFollowStatus(String paramString)
  {
    ...
    localQQAppInterface.addObserver(new akeb(this, localQQAppInterface));
  ...
  {
    if (this.manager.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildGameRoomChatPie != null) {
      this.manager.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildGameRoomChatPie.ay();
    }
  }
  ...
  public boolean isFriend(String paramString)
  {
    ...
    return ((FriendsManager)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(50)).b(paramString);
  }
  ...
  public void onExist()
  {
    ...
    if ((this.manager.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildGameRoomChatPie != null) && (this.manager.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildGameRoomChatPie != null)) {
      this.manager.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildGameRoomChatPie.e("你已经退出房间");
    }
    existRoom();
  }
  ...
  {
    if (this.manager.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildGameRoomChatPie != null) {
      this.manager.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildGameRoomChatPie.e("你已经被踢出房间");
    }
    existRoom();
  }
  ...
  {
    if (this.manager.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildGameRoomChatPie != null) {
      this.manager.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildGameRoomChatPie.d(paramBoolean1, paramBoolean2);
    }
  }
  ...
  public void setFollowed(String paramString, boolean paramBoolean)
  {
    ...
    {
      QQAppInterface localQQAppInterface = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
      NearbyHandler.a(localQQAppInterface, paramString, "6", str, 1, new akea(this, localQQAppInterface, paramString, str, paramBoolean));
      return;
    }
  }
  ...
  public void setSoundEnable(boolean paramBoolean)
  {
    ...
    this.mGameRoomAVController.a(new akdy(this, paramBoolean));
  }
  ...
  public void showActionSheet(String paramString, String[] paramArrayOfString, int[] paramArrayOfInt, Object paramObject)
  {
    ...
    ActionSheet localActionSheet = ActionSheet.a(this.manager.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildGameRoomChatPie.a());
    if (!TextUtils.isEmpty(paramString)) {
    ...
    localActionSheet.a(new akdz(this, paramObject, localActionSheet));
