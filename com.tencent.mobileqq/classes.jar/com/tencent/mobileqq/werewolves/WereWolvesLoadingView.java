  ...
  extends FrameLayout
{
  ...
  Runnable jdField_b_of_type_JavaLangRunnable = new akdq(this);
  public boolean b;
  ...
  public WereWolvesLoadingView(Context paramContext)
  {
    ...
    this.jdField_a_of_type_JavaLangRunnable = new akdp(this);
  ...
  void a()
  {
    this.jdField_b_of_type_AndroidViewView = LayoutInflater.from(getContext()).inflate(2130969121, this);
    this.jdField_a_of_type_Int = findViewById(2131365244).getLayoutParams().width;
    this.jdField_a_of_type_AndroidViewView = findViewById(2131363544);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131363548));
    setProgress(0);
