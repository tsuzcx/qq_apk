  ...
  extends FrameLayout
{
  ...
  void a()
  {
    this.jdField_b_of_type_AndroidViewView = LayoutInflater.from(getContext()).inflate(2131559498, this);
    this.jdField_a_of_type_Int = findViewById(2131372938).getLayoutParams().width;
    this.jdField_a_of_type_AndroidViewView = findViewById(2131372935);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131372960));
    setProgress(0);
  ...
  public void setComplete(bhtd parambhtd)
  {
    this.jdField_b_of_type_Boolean = true;
  ...
  public void setProgress(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_Bhtd != null) && (!this.jdField_a_of_type_Boolean))
      {
        this.jdField_a_of_type_Bhtd.a();
