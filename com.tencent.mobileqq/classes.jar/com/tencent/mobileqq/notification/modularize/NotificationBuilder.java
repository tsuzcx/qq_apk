...
public final class NotificationBuilder
{
  ...
  public final Notification a(@Nullable PendingIntent paramPendingIntent, @NotNull PushComponent paramPushComponent)
  {
    ...
    localBigTextStyle.bigText((CharSequence)paramPushComponent.g);
    paramPendingIntent = new NotificationCompat.Builder((Context)BaseApplication.context).setSmallIcon(2130842313).setAutoCancel(true).setContentText((CharSequence)paramPushComponent.g).setWhen(System.currentTimeMillis()).setTicker((CharSequence)paramPushComponent.g).setContentIntent(paramPendingIntent).setPriority(2).setStyle((NotificationCompat.Style)localBigTextStyle);
    if (!TextUtils.isEmpty((CharSequence)paramPushComponent.e)) {
      paramPendingIntent.setContentTitle((CharSequence)paramPushComponent.e);
    }
    if ((SdkInfoUtil.isOreo()) && (SdkInfoUtil.isTargetSDKOreo())) {
      paramPendingIntent.setChannelId("CHANNEL_ID_OTHER");
    }
    paramPushComponent = PushUtil.a.a(paramPushComponent.f);
