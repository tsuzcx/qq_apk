  ...
  implements TextureView.SurfaceTextureListener
{
  ...
  public void d()
  {
    ...
    try
    {
      ...
      Object localObject2 = localauop2;
        ...
        if (this.jdField_a_of_type_AndroidViewSurface.isValid())
        {
          ...
          try
          {
            ...
            for (;;)
            {
              ...
              localObject2 = localCanvas;
              localauop2 = (auop)((Iterator)localObject4).next();
              if (localauop2 != null)
              {
                localObject2 = localCanvas;
                localauop2.a(localCanvas, this.jdField_a_of_type_AndroidGraphicsPaint, this.jdField_a_of_type_AndroidGraphicsMatrix);
              }
            }
            try
            {
    ...
    finally
    {
      ...
      if (this.jdField_a_of_type_Auoq != null) {
        this.jdField_a_of_type_Auoq.a();
      }
    }
  }
  ...
  public void onSurfaceTextureAvailable(SurfaceTexture paramSurfaceTexture, int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new auor(this, this.jdField_a_of_type_AndroidOsHandlerThread.getLooper());
  }
  ...
  public void setParticleListener(auoq paramauoq)
  {
    this.jdField_a_of_type_Auoq = paramauoq;
  }
}
