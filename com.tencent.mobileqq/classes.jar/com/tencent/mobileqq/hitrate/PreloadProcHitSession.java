...
public class PreloadProcHitSession
{
  ...
  public void d()
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaUtilHashMap)
      {
        ...
        if (localObject2 != null)
        {
          ...
          if (localObject2 != null)
          {
            ...
            StatisticCollector.a((Context)???).a((String)localObject2, str, true, 0L, 0L, localHashMap1, null);
          }
        }
        c();
        return;
      ...
      label98:
      StatisticCollector.a((Context)???).a((String)localObject2, str, false, 0L, 0L, localHashMap2, null);
    }
  }
}
