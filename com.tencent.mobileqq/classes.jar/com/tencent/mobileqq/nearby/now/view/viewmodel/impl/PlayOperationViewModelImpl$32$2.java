  ...
  implements Runnable
{
  ...
  public void run()
  {
    ReportTask localReportTask = new ReportTask(this.jdField_a_of_type_ComTencentMobileqqNearbyNowViewViewmodelImplPlayOperationViewModelImpl$32.a.app).a("dc00899").b("grp_lbs").c("video").d("playpage_focus").e(((INowVideoReporter)QRoute.api(INowVideoReporter.class)).getAnchorUin());
    String str1 = "";
