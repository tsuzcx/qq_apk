...
public class PlayOperationViewModel$21
  implements Runnable
{
  public PlayOperationViewModel$21(atlw paramatlw, aszf paramaszf) {}
  
  public void run()
  {
    axrc localaxrc = new axrc(this.this$0.a).a("dc00899").b("grp_lbs").c("video").d("playpage_more_click").e(atix.d);
    int i = this.a.b();
    String str2 = atix.a;
