...
public class PlayOperationViewModel$21
  implements Runnable
{
  public PlayOperationViewModel$21(ayhj paramayhj, axup paramaxup) {}
  
  public void run()
  {
    bdlq localbdlq = new bdlq(this.this$0.a).a("dc00899").b("grp_lbs").c("video").d("playpage_more_click").e(ayek.d);
    int i = this.a.b();
    String str2 = ayek.a;
