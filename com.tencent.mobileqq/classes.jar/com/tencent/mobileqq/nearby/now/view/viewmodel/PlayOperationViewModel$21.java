...
class PlayOperationViewModel$21
  implements Runnable
{
  PlayOperationViewModel$21(PlayOperationViewModel paramPlayOperationViewModel, NearbyCardManager paramNearbyCardManager) {}
  
  public void run()
  {
    ReportTask localReportTask = new ReportTask(this.this$0.a).a("dc00899").b("grp_lbs").c("video").d("playpage_more_click").e(NowVideoReporter.d);
    int i = this.a.b();
