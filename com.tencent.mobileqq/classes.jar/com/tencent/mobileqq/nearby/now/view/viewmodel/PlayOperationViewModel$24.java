...
public class PlayOperationViewModel$24
  implements Runnable
{
  public PlayOperationViewModel$24(ayhj paramayhj, axup paramaxup) {}
  
  public void run()
  {
    bdlq localbdlq = new bdlq(this.this$0.a).a("dc00899").b("grp_lbs").c("video").d("playpage_com_click").e(ayek.d);
    int i = this.a.b();
    String str2 = ayek.a;
