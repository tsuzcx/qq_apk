...
public class PlayOperationViewModel$24
  implements Runnable
{
  public PlayOperationViewModel$24(axop paramaxop, axby paramaxby) {}
  
  public void run()
  {
    bcsy localbcsy = new bcsy(this.this$0.a).a("dc00899").b("grp_lbs").c("video").d("playpage_com_click").e(axlq.d);
    int i = this.a.b();
    String str2 = axlq.a;
