...
public class PlayOperationViewModel$17
  implements Runnable
{
  public PlayOperationViewModel$17(avhf paramavhf, auul paramauul) {}
  
  public void run()
  {
    azqx localazqx = new azqx(this.this$0.a).a("dc00899").b("grp_lbs").c("video").d("playpage_post_click").e(aveg.d);
    int i = this.a.b();
    String str2 = aveg.a;
