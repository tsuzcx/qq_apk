...
public class PlayOperationViewModel$17
  implements Runnable
{
  public PlayOperationViewModel$17(awur paramawur, awhw paramawhw) {}
  
  public void run()
  {
    bcek localbcek = new bcek(this.this$0.a).a("dc00899").b("grp_lbs").c("video").d("playpage_post_click").e(awrs.d);
    int i = this.a.b();
    String str2 = awrs.a;
