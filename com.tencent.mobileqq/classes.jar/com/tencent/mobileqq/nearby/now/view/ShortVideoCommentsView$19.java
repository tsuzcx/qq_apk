...
class ShortVideoCommentsView$19
  implements Runnable
{
  ShortVideoCommentsView$19(ShortVideoCommentsView paramShortVideoCommentsView, axny paramaxny) {}
  
  public void run()
  {
    bdlf localbdlf = new bdlf(this.this$0.a).a("dc00899").b("grp_lbs").c("video").d("playpage_com_suc").e(axxu.d);
    int i = this.a.b();
    String str2 = axxu.a;
