...
class ShortVideoCommentsView$19
  implements Runnable
{
  ShortVideoCommentsView$19(ShortVideoCommentsView paramShortVideoCommentsView, auqc paramauqc) {}
  
  public void run()
  {
    azmo localazmo = new azmo(this.this$0.a).a("dc00899").b("grp_lbs").c("video").d("playpage_com_suc").e(auzx.d);
    int i = this.a.b();
    String str2 = auzx.a;
