...
public class PlayOperationViewModel$3$1
  implements Runnable
{
  public PlayOperationViewModel$3$1(axpl paramaxpl, axby paramaxby) {}
  
  public void run()
  {
    bcsy localbcsy = new bcsy(this.jdField_a_of_type_Axpl.a.a).a("dc00899").b("grp_lbs").c("video").d("playpage_double_click").e(axlq.d);
