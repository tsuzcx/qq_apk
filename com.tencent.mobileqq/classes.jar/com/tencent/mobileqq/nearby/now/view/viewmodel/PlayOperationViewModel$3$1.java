...
public class PlayOperationViewModel$3$1
  implements Runnable
{
  public PlayOperationViewModel$3$1(atms paramatms, aszf paramaszf) {}
  
  public void run()
  {
    axrc localaxrc = new axrc(this.jdField_a_of_type_Atms.a.a).a("dc00899").b("grp_lbs").c("video").d("playpage_double_click").e(atix.d);
