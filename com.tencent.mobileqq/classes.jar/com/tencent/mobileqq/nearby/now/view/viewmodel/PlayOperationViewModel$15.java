...
class PlayOperationViewModel$15
  implements NowShortVideoProtoManager.Callback
{
  PlayOperationViewModel$15(PlayOperationViewModel paramPlayOperationViewModel, VideoData paramVideoData) {}
    ...
    if ((paramInt == 0) && (paramArrayOfByte != null))
    {
      ...
      try
      {
        ...
        if (paramBundle.busi_buf.has())
        {
          ...
          ((NearbyMomentManager)this.jdField_a_of_type_ComTencentMobileqqNearbyNowViewViewmodelPlayOperationViewModel.a.getManager(QQManagerFactory.NEARBY_MOMENT_MANAGER)).b(PlayOperationViewModel.a(this.jdField_a_of_type_ComTencentMobileqqNearbyNowViewViewmodelPlayOperationViewModel), paramArrayOfByte.total.get());
          if (QLog.isColorLevel()) {
 ...
 * Qualified Name:     com.tencent.mobileqq.nearby.now.view.viewmodel.PlayOperationViewModel.15
