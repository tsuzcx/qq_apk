  ...
  extends View
{
  ...
  private ayir jdField_a_of_type_Ayir;
  private ayis jdField_a_of_type_Ayis;
  private ArrayList<ayir> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  private void a()
  {
    ...
    ayir localayir = new ayir(this, null);
    localayir.jdField_a_of_type_ArrayOfFloat = new float[] { this.jdField_b_of_type_Float + this.jdField_b_of_type_Int, f1 };
    localayir.jdField_a_of_type_Float = (this.jdField_b_of_type_Float / 4.0F * 3.0F);
    this.jdField_a_of_type_JavaUtilArrayList.add(localayir);
    int n = 1;
    while (n < 2)
    {
      localayir = new ayir(this, null);
      localayir.jdField_a_of_type_ArrayOfFloat = new float[] { (this.jdField_b_of_type_Float * 2.0F + this.jdField_b_of_type_Int) * n, f1 };
      localayir.jdField_a_of_type_Float = this.jdField_b_of_type_Float;
      this.jdField_a_of_type_JavaUtilArrayList.add(localayir);
      n += 1;
    }
  ...
  {
    Object localObject = (ayir)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt2);
    ayir localayir = (ayir)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt1);
    float f4 = a(((ayir)localObject).jdField_a_of_type_ArrayOfFloat, localayir.jdField_a_of_type_ArrayOfFloat);
    float f3 = ((ayir)localObject).jdField_a_of_type_Float;
    float f1 = localayir.jdField_a_of_type_Float;
    if (f4 > paramFloat3)
    {
      paramCanvas.drawCircle(localayir.jdField_a_of_type_ArrayOfFloat[0], localayir.jdField_a_of_type_ArrayOfFloat[1], f1, this.jdField_a_of_type_AndroidGraphicsPaint);
      if ((f3 != 0.0F) && (f1 != 0.0F)) {
        break label147;
      }
    }
    ...
    {
      float f7 = (float)Math.atan2(localayir.jdField_a_of_type_ArrayOfFloat[1] - localObject.jdField_a_of_type_ArrayOfFloat[1], localayir.jdField_a_of_type_ArrayOfFloat[0] - localObject.jdField_a_of_type_ArrayOfFloat[0]);
      ...
      this.g[0] = (this.jdField_c_of_type_ArrayOfFloat[0] + localayir.jdField_a_of_type_ArrayOfFloat[0]);
      this.g[1] = (this.jdField_c_of_type_ArrayOfFloat[1] + localayir.jdField_a_of_type_ArrayOfFloat[1]);
      this.h[0] = (this.jdField_d_of_type_ArrayOfFloat[0] + localayir.jdField_a_of_type_ArrayOfFloat[0]);
      localObject = this.h;
      f7 = this.jdField_d_of_type_ArrayOfFloat[1];
      localObject[1] = (localayir.jdField_a_of_type_ArrayOfFloat[1] + f7);
  ...
  private void c()
  {
    this.jdField_a_of_type_Ayis = new ayis(this, null);
    this.jdField_a_of_type_Ayis.setDuration(1000L);
    this.jdField_a_of_type_Ayis.setInterpolator(new AccelerateDecelerateInterpolator());
    this.jdField_a_of_type_Ayis.setRepeatCount(-1);
    this.jdField_a_of_type_Ayis.setRepeatMode(2);
    startAnimation(this.jdField_a_of_type_Ayis);
  }
  
  protected int a()
  {
    return (int)mvd.a(getContext(), 10.0F);
  }
  ...
  protected int b()
  {
    return (int)mvd.a(getContext(), 20.0F);
  }
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    this.jdField_a_of_type_Ayir = ((ayir)this.jdField_a_of_type_JavaUtilArrayList.get(0));
    this.jdField_a_of_type_Ayir.jdField_a_of_type_ArrayOfFloat[0] = (this.jdField_d_of_type_Float * this.jdField_e_of_type_Float + this.jdField_b_of_type_Float);
    paramCanvas.drawCircle(this.jdField_a_of_type_Ayir.jdField_a_of_type_ArrayOfFloat[0], this.jdField_a_of_type_Ayir.jdField_a_of_type_ArrayOfFloat[1], this.jdField_a_of_type_Ayir.jdField_a_of_type_Float, this.jdField_a_of_type_AndroidGraphicsPaint);
