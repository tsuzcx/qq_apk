  ...
  public void a(Comments.Comment paramComment, int paramInt)
  {
    if (CommentsPresenter.a(this.a) != null)
    {
      if (paramInt == 0)
      {
        ...
        CommentsPresenter.a(this.a).showToast(BaseApplicationImpl.getApplication().getString(2131696377));
        ReportController.b(null, "dc02676", "grp_lbs", "", "comment", "delete_comment", 0, 0, "", "", "", "");
        return;
      }
      CommentsPresenter.a(this.a).showToast(BaseApplicationImpl.getApplication().getString(2131696376));
    }
  }
}
