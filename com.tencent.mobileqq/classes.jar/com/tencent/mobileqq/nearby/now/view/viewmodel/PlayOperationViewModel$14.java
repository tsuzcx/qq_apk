...
class PlayOperationViewModel$14
  implements NowShortVideoProtoManager.Callback
{
  PlayOperationViewModel$14(PlayOperationViewModel paramPlayOperationViewModel, VideoData paramVideoData) {}
    ...
    if ((paramInt == 0) && (paramArrayOfByte != null))
    {
      ...
      try
      {
        ...
        if (paramBundle.busi_buf.has())
        {
          ...
          PlayOperationViewModel.b(this.jdField_a_of_type_ComTencentMobileqqNearbyNowViewViewmodelPlayOperationViewModel, false);
          ((NearbyMomentManager)this.jdField_a_of_type_ComTencentMobileqqNearbyNowViewViewmodelPlayOperationViewModel.a.getManager(QQManagerFactory.NEARBY_MOMENT_MANAGER)).a(PlayOperationViewModel.a(this.jdField_a_of_type_ComTencentMobileqqNearbyNowViewViewmodelPlayOperationViewModel), paramArrayOfByte.total.get());
          if (QLog.isColorLevel()) {
 ...
 * Qualified Name:     com.tencent.mobileqq.nearby.now.view.viewmodel.PlayOperationViewModel.14
