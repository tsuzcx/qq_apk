  ...
  implements Runnable
{
  ...
  public void run()
  {
    ReportTask localReportTask = new ReportTask(this.jdField_a_of_type_ComTencentMobileqqNearbyNowViewViewmodelImplPlayOperationViewModelImpl$10.a.app).a("dc00899").b("grp_lbs").c("video").d("playpage_fw_click").e(((INowVideoReporter)QRoute.api(INowVideoReporter.class)).getAnchorUin());
    String str1 = "";
