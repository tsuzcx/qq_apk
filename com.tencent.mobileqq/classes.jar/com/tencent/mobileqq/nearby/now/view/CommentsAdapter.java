  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments.a != null) && (this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments.a.size() > 0)) {
      if ((paramView == null) || (!(paramView.getTag() instanceof CommentsViewHolder)))
      {
        ...
        localObject = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130970417, paramViewGroup, false);
        paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)((View)localObject).findViewById(2131370493));
        paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)((View)localObject).findViewById(2131363531));
        paramView.jdField_b_of_type_AndroidWidgetTextView = ((TextView)((View)localObject).findViewById(2131361932));
        paramView.jdField_c_of_type_AndroidWidgetTextView = ((TextView)((View)localObject).findViewById(2131370496));
        paramView.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)((View)localObject).findViewById(2131370429));
        paramView.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)((View)localObject).findViewById(2131370430));
        paramView.d = ((ImageView)((View)localObject).findViewById(2131370497));
        ((View)localObject).setTag(2131362446, paramView);
        ...
        localObject = FaceDrawable.a((AppInterface)localObject, 32, str2, 3, paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.getResources().getDrawable(2130842666), paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.getResources().getDrawable(2130842666));
        ...
        paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new aejq(this, l));
        ...
        paramView.setTag(2131362447, this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments.a.get(paramInt));
        paramView.setTag(2131362448, this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments);
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        for (;;)
        {
          ...
          paramView.findViewById(2131370426).setOnClickListener(new aejr(this));
          paramView.setTag("badnet");
          return paramView;
          paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130970406, paramViewGroup, false);
        }
      }
    ...
    label839:
    paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130970407, paramViewGroup, false);
