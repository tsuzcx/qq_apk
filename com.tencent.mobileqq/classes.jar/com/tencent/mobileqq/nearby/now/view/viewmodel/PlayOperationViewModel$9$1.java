...
public class PlayOperationViewModel$9$1
  implements Runnable
{
  public PlayOperationViewModel$9$1(ayim paramayim, axup paramaxup) {}
  
  public void run()
  {
    bdlq localbdlq = new bdlq(this.jdField_a_of_type_Ayim.a.a).a("dc00899").b("grp_lbs").c("video").d("playpage_like_click").e(ayek.d);
