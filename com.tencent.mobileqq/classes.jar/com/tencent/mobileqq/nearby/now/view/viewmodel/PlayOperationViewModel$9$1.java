...
public class PlayOperationViewModel$9$1
  implements Runnable
{
  public PlayOperationViewModel$9$1(axps paramaxps, axby paramaxby) {}
  
  public void run()
  {
    bcsy localbcsy = new bcsy(this.jdField_a_of_type_Axps.a.a).a("dc00899").b("grp_lbs").c("video").d("playpage_like_click").e(axlq.d);
