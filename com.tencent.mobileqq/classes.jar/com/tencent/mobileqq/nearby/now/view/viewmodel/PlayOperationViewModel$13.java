...
public class PlayOperationViewModel$13
  implements Runnable
{
  public PlayOperationViewModel$13(atlw paramatlw, aszf paramaszf) {}
  
  public void run()
  {
    axrc localaxrc = new axrc(this.this$0.a).a("dc00899").b("grp_lbs").c("video").d("playpage_label_click").e(atix.d);
    int i = this.a.b();
    String str2 = atix.a;
