...
public class PlayOperationViewModel$13
  implements Runnable
{
  public PlayOperationViewModel$13(ayhj paramayhj, axup paramaxup) {}
  
  public void run()
  {
    bdlq localbdlq = new bdlq(this.this$0.a).a("dc00899").b("grp_lbs").c("video").d("playpage_label_click").e(ayek.d);
    int i = this.a.b();
    String str2 = ayek.a;
