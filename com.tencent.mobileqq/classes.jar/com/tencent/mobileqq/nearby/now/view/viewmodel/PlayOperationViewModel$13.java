...
public class PlayOperationViewModel$13
  implements Runnable
{
  public PlayOperationViewModel$13(avhf paramavhf, auul paramauul) {}
  
  public void run()
  {
    azqx localazqx = new azqx(this.this$0.a).a("dc00899").b("grp_lbs").c("video").d("playpage_label_click").e(aveg.d);
    int i = this.a.b();
    String str2 = aveg.a;
