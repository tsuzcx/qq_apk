...
public class PlayOperationViewModel$13
  implements Runnable
{
  public PlayOperationViewModel$13(axop paramaxop, axby paramaxby) {}
  
  public void run()
  {
    bcsy localbcsy = new bcsy(this.this$0.a).a("dc00899").b("grp_lbs").c("video").d("playpage_label_click").e(axlq.d);
    int i = this.a.b();
    String str2 = axlq.a;
