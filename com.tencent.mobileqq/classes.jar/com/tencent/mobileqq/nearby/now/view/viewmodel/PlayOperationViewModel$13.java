...
class PlayOperationViewModel$13
  implements Runnable
{
  PlayOperationViewModel$13(PlayOperationViewModel paramPlayOperationViewModel, NearbyCardManager paramNearbyCardManager) {}
  
  public void run()
  {
    ReportTask localReportTask = new ReportTask(this.this$0.a).a("dc00899").b("grp_lbs").c("video").d("playpage_label_click").e(NowVideoReporter.d);
    int i = this.a.b();
