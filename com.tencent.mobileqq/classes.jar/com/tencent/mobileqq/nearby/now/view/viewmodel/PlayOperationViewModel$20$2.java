...
class PlayOperationViewModel$20$2
  implements Runnable
{
  PlayOperationViewModel$20$2(PlayOperationViewModel.20 param20, NearbyCardManager paramNearbyCardManager) {}
  
  public void run()
  {
    ReportTask localReportTask = new ReportTask(this.jdField_a_of_type_ComTencentMobileqqNearbyNowViewViewmodelPlayOperationViewModel$20.a.a).a("dc00899").b("grp_lbs").c("video").d("playpage_focus").e(NowVideoReporter.d);
