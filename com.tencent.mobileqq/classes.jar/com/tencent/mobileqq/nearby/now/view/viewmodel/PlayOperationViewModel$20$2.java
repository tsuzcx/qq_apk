...
public class PlayOperationViewModel$20$2
  implements Runnable
{
  public PlayOperationViewModel$20$2(aybe paramaybe, axny paramaxny) {}
  
  public void run()
  {
    bdlf localbdlf = new bdlf(this.jdField_a_of_type_Aybe.a.a).a("dc00899").b("grp_lbs").c("video").d("playpage_focus").e(axxu.d);
