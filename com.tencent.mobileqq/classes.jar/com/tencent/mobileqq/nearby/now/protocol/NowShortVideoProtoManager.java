...
public class NowShortVideoProtoManager
{
  ...
  public void a(long paramLong1, long paramLong2, int paramInt1, int paramInt2, boolean paramBoolean, NowShortVideoProtoManager.Callback paramCallback)
  {
    ...
    for (paramInt2 = 1;; paramInt2 = 2)
    {
      ...
      ProtoUtils.a(this.a, new NowShortVideoProtoManager.5(this, paramCallback), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
      return;
    }
  }
  ...
  public void a(long paramLong, String paramString, NowShortVideoProtoManager.Callback paramCallback)
  {
    ...
    if (a(localReqBody))
    {
      ...
      ProtoUtils.a(this.a, new NowShortVideoProtoManager.6(this, paramCallback), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
    }
  }
  ...
  public void a(String paramString, NowShortVideoProtoManager.Callback paramCallback)
  {
    ...
    if (a(localReqBody))
    {
      ...
      ProtoUtils.a(this.a, new NowShortVideoProtoManager.2(this, paramCallback), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
    }
  }
  ...
  public void a(String paramString, NowShortVideoProtoManager.Callback paramCallback, Bundle paramBundle)
  {
    ...
    if (a(localReqBody))
    {
      ...
      ProtoUtils.a(this.a, new NowShortVideoProtoManager.1(this, paramCallback), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, paramBundle, 0L);
    }
  }
  ...
  public void b(String paramString, NowShortVideoProtoManager.Callback paramCallback)
  {
    ...
    if (a(localReqBody))
    {
      ...
      localReqBody.subcmd.set(1);
      Object localObject = new FeedsProtocol.GetMediaDetailReq();
      ((FeedsProtocol.GetMediaDetailReq)localObject).querystring.set(ByteStringMicro.copyFrom(paramString.getBytes()));
      localReqBody.busi_buf.set(ByteStringMicro.copyFrom(((FeedsProtocol.GetMediaDetailReq)localObject).toByteArray()));
      localObject = (NearbyCardManager)this.a.getManager(QQManagerFactory.NEARBY_CARD_MANAGER);
      localPBUInt32Field = localReqBody.buss_id;
      if (((NearbyCardManager)localObject).a() <= 0L) {
        break label180;
      }
    }
    label180:
    for (int i = 0;; i = 1)
    {
      ...
      ProtoUtils.a(this.a, new NowShortVideoProtoManager.4(this, paramString, paramCallback), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
      return;
    }
  }
  ...
  public void b(String paramString, NowShortVideoProtoManager.Callback paramCallback, Bundle paramBundle)
  {
    ...
    if (a(localReqBody))
    {
      ...
      ProtoUtils.a(this.a, new NowShortVideoProtoManager.3(this, paramCallback), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, paramBundle, 0L);
    }
  }
}
