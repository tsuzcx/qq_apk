  ...
  implements Runnable
{
  ...
  public void run()
  {
    ReportTask localReportTask = new ReportTask(this.this$0.app).a("dc00899").b("grp_lbs").c("video").d("playpage_right_slide").e(String.valueOf(this.a.i));
    String str1 = "";
    int i = this.b.c();
