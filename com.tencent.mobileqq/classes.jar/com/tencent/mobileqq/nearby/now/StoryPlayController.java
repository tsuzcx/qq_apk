...
public class StoryPlayController
  implements ViewPager.OnPageChangeListener, atkh
{
  public int a;
  public Context a;
  public Bundle a;
  Handler jdField_a_of_type_AndroidOsHandler = new atgm(this);
  public atgg a;
  public athd a;
  athe jdField_a_of_type_Athe = new atgn(this);
  public atje a;
  ...
  public StoryPlayController(Context paramContext, StuffContainerView paramStuffContainerView, VideoPlayerPagerAdapter paramVideoPlayerPagerAdapter, Bundle paramBundle, QQStoryVideoPlayerErrorView paramQQStoryVideoPlayerErrorView, QQAppInterface paramQQAppInterface, atgg paramatgg)
  {
    ...
    this.jdField_a_of_type_Atje = new atje(paramContext, paramatgg, paramQQAppInterface);
    ...
    this.jdField_d_of_type_Boolean = atix.a("short_video_player_guide_shown", false);
    this.jdField_a_of_type_Atgg = paramatgg;
  }
  
  private void a(int paramInt, atkl paramatkl, VideoData paramVideoData)
  {
    
    if ((nar.a(a()) != 1) && (this.jdField_b_of_type_Int != 4) && (this.jdField_b_of_type_Int != 6) && (!paramVideoData.jdField_d_of_type_Boolean))
    {
      bcpw.a(a(), ajyc.a(2131714539), 1).a();
      this.j = true;
    }
    if (this.jdField_a_of_type_Atgg != null) {
      this.jdField_a_of_type_Atgg.a();
    }
    if ((paramatkl != null) && (paramatkl.jdField_a_of_type_ComTencentMobileqqNearbyNowViewOperationView != null))
    {
      paramatkl.jdField_a_of_type_ComTencentMobileqqNearbyNowViewOperationView.a(paramVideoData);
      this.jdField_a_of_type_Atje.a((atkv)this.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(paramatkl.jdField_a_of_type_Int)));
      this.jdField_a_of_type_Atje.a(paramatkl.jdField_a_of_type_AndroidWidgetRelativeLayout, paramVideoData, new atgr(this));
    }
    this.jdField_a_of_type_ComTencentMobileqqNearbyNowViewStuffContainerView.jdField_a_of_type_Atgj.a(paramInt, 0);
  ...
  private void b(int paramInt, atkl paramatkl, VideoData paramVideoData)
  {
    this.jdField_a_of_type_ComTencentMobileqqNearbyNowViewStuffContainerView.jdField_a_of_type_Atgj.a(true);
    paramatkl.jdField_a_of_type_ComTencentMobileqqNearbyNowViewWidgetImageDisplayView.setRelayoutListener(new atgs(this, paramatkl, paramVideoData));
    if (paramVideoData.jdField_a_of_type_JavaUtilArrayList.get(0) != null)
    {
      if ((this.jdField_a_of_type_ComTencentMobileqqNearbyNowViewVideoPlayerPagerAdapter.a(paramInt) instanceof ShortVideoCommentsView))
      {
        ...
        atiy.a(paramatkl, ((athh)paramVideoData.jdField_a_of_type_JavaUtilArrayList.get(0)).jdField_b_of_type_Int, ((athh)paramVideoData.jdField_a_of_type_JavaUtilArrayList.get(0)).jdField_a_of_type_Int, paramVideoData, localShortVideoCommentsView);
      }
      paramatkl.jdField_a_of_type_ComTencentMobileqqNearbyNowViewWidgetImageDisplayView.setVisibility(8);
      paramatkl.jdField_a_of_type_ComTencentMobileqqNearbyNowViewWidgetImageDisplayView.a(paramVideoData);
      e();
    }
  }
  ...
  private void c(int paramInt)
  {
    ...
    do
    {
      do
      {
        ...
        localatkl = this.jdField_a_of_type_ComTencentMobileqqNearbyNowViewVideoPlayerPagerAdapter.a(paramInt);
      } while ((localatkl == null) || (this.jdField_a_of_type_ComTencentMobileqqNearbyNowViewVideoPlayerPagerAdapter.jdField_a_of_type_JavaUtilList.size() <= 1) || (this.jdField_d_of_type_Boolean));
      if ((localatkl != null) && (localatkl.jdField_a_of_type_AndroidWidgetRelativeLayout != null)) {
        this.jdField_a_of_type_Atje.a();
      }
    } while (this.jdField_a_of_type_Atni != null);
    this.jdField_a_of_type_Atni = new atni(this.jdField_a_of_type_ComTencentMobileqqNearbyNowViewStuffContainerView.jdField_a_of_type_AndroidAppActivity);
    this.jdField_a_of_type_Atni.a(ajyc.a(2131714549));
    HashMap localHashMap = this.jdField_a_of_type_JavaUtilHashMap;
    this.jdField_a_of_type_Atni.setOnDismissListener(new atgu(this, localatkl, localHashMap));
    this.jdField_a_of_type_Atni.show();
    this.jdField_d_of_type_Boolean = true;
    atix.a("short_video_player_guide_shown", true);
  ...
  {
    atkl localatkl = this.jdField_a_of_type_ComTencentMobileqqNearbyNowViewVideoPlayerPagerAdapter.a(paramInt);
    if (localatkl == null) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      atiw.a(localVideoData.jdField_a_of_type_JavaLangString, 2, "0", "0");
      if (QLog.isColorLevel()) {
      ...
      if (localatkl.jdField_a_of_type_ComTencentMobileqqNearbyNowViewOperationView != null)
      {
        long l = localVideoData.jdField_a_of_type_Long;
        localatkl.jdField_a_of_type_ComTencentMobileqqNearbyNowViewOperationView.setCurrentAnchorUin(l);
      }
    } while (paramInt != this.jdField_a_of_type_Int);
    if (localatkl.jdField_a_of_type_ComTencentMobileqqNearbyNowViewOperationView != null) {
      localatkl.jdField_a_of_type_ComTencentMobileqqNearbyNowViewOperationView.b();
    }
    this.jdField_b_of_type_Int = localVideoData.j;
    if (localVideoData.j == 4)
    {
      b(paramInt, localatkl, localVideoData);
      new athz(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(localVideoData.jdField_a_of_type_JavaLangString, null);
      ((atvq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(263)).f(localVideoData.jdField_a_of_type_JavaLangString);
      return;
    }
    ...
    a(paramInt, localatkl, localVideoData);
    if ((nar.a(a()) != 1) && (this.jdField_b_of_type_Int != 4) && (this.jdField_b_of_type_Int != 6) && (!localVideoData.jdField_d_of_type_Boolean))
    {
      bcpw.a(a(), ajyc.a(2131714546), 1).a();
      this.k = false;
    }
    b(paramInt);
  }
  ...
  public void a(Bundle paramBundle)
  {
    ...
    if (paramBundle.getBoolean("play_list", true))
    {
      ...
      this.g = false;
      this.jdField_a_of_type_Athd = new athr();
      if ("1".equals(paramBundle.getString("isLocal"))) {
        this.jdField_a_of_type_Athd.a(true);
      }
    }
    for (;;)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqNearbyNowViewStuffContainerView.jdField_a_of_type_Atgj.a(false);
      ...
      try
      {
        ...
        if (n == 1)
        {
          ...
          this.jdField_a_of_type_Athd.a(paramBundle);
          ...
          this.jdField_a_of_type_Athd.a(this.jdField_a_of_type_Athe);
          atiw.a();
      ...
      catch (Exception localException)
      {
        try
        {
          ...
          if (bool)
          {
            ...
            localObject = new athh();
            ((athh)localObject).jdField_b_of_type_Int = paramBundle.k;
            ((athh)localObject).jdField_a_of_type_Int = paramBundle.l;
            ((athh)localObject).jdField_a_of_type_JavaLangString = paramBundle.jdField_c_of_type_JavaLangString;
          ...
          for (;;)
          {
            this.jdField_a_of_type_Athd.a().add(paramBundle);
            this.jdField_a_of_type_Athd.a(this.jdField_a_of_type_JavaLangString, paramBundle.jdField_a_of_type_JavaLangString);
            this.jdField_a_of_type_Athe.a(1, 0);
            this.jdField_a_of_type_ComTencentMobileqqNearbyNowViewStuffContainerView.setCurrentItem(0, false);
            return;
            label629:
            this.g = true;
            this.jdField_a_of_type_Athd = new athi();
            break;
            if (n != 2) {
              break label230;
            }
  ...
  public void a(LayoutInflater paramLayoutInflater, VideoPlayerPagerAdapter paramVideoPlayerPagerAdapter, atkl paramatkl) {}
  
  public void a(View paramView) {}
  
  public void a(ImageView paramImageView, String paramString, atkw paramatkw)
  {
    atiu.a().a(paramImageView, paramString, new ColorDrawable(0), new ColorDrawable(0), muf.a(this.jdField_a_of_type_AndroidContentContext) / 2, muf.b(this.jdField_a_of_type_AndroidContentContext) / 2, new atgp(this, paramImageView, paramatkw), false);
  }
  
  public void a(atkl paramatkl, VideoData paramVideoData, boolean paramBoolean, ShortVideoCommentsView paramShortVideoCommentsView)
  {
    a(paramatkl, paramVideoData, paramBoolean, paramShortVideoCommentsView, true);
  }
  
  public void a(atkl paramatkl, VideoData paramVideoData, boolean paramBoolean1, ShortVideoCommentsView paramShortVideoCommentsView, boolean paramBoolean2)
  {
    if (QLog.isColorLevel()) {
      QLog.i("VideoPlayController", 2, "onFillData() called with: holder = [" + paramatkl + "], videoData = [" + paramVideoData + "], willToPlay = [" + paramBoolean1 + "], commentsView = [" + paramShortVideoCommentsView + "]");
    }
    paramatkl.jdField_a_of_type_ComTencentMobileqqNearbyNowViewOperationView.a(paramVideoData);
    paramatkl.jdField_a_of_type_ComTencentMobileqqNearbyNowViewOperationView.a(true);
    ...
    for (;;)
    {
      paramShortVideoCommentsView = new atkw(paramatkl, this, paramShortVideoCommentsView, atiy.a(paramatkl, paramVideoData.l, paramVideoData.k));
      this.jdField_a_of_type_JavaUtilHashMap.put(Integer.valueOf(paramatkl.jdField_a_of_type_Int), paramShortVideoCommentsView);
      if (paramVideoData.jdField_a_of_type_Int == 4)
      {
        paramatkl.jdField_a_of_type_ComTencentMobileqqNearbyNowViewOperationView.setVisibility(8);
        if (paramatkl.jdField_a_of_type_AndroidViewView != null) {
          paramatkl.jdField_a_of_type_AndroidViewView.findViewById(2131377395).setVisibility(4);
        }
      }
      a(paramBoolean1, paramatkl.jdField_a_of_type_AndroidWidgetRelativeLayout, paramVideoData, paramShortVideoCommentsView, paramBoolean2);
      return;
      ...
      paramatkl.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundDrawable((Drawable)localObject);
    }
  }
  
  public void a(boolean paramBoolean1, RelativeLayout paramRelativeLayout, VideoData paramVideoData, atkw paramatkw, boolean paramBoolean2)
  {
    ImageView localImageView1 = (ImageView)paramRelativeLayout.findViewById(2131368544);
    ImageView localImageView2 = (ImageView)paramRelativeLayout.findViewById(2131365315);
    ...
    if (QLog.isColorLevel()) {
      QLog.i("VideoPlayController", 2, "prepare() called with: willToPlay = [" + paramBoolean1 + "], rootView = [" + paramRelativeLayout + "], videoData = [" + paramVideoData + "], videoInfoListener = [" + paramatkw + "], loadCover = [" + paramBoolean2 + "]");
    }
    if ((paramBoolean2) && (paramVideoData.jdField_c_of_type_JavaLangString != null))
    {
      ...
      a(localImageView1, paramVideoData.jdField_c_of_type_JavaLangString, paramatkw);
    }
    for (;;)
    {
      atiu.a().a(localImageView2, paramVideoData.jdField_d_of_type_JavaLangString, new ColorDrawable(0), new ColorDrawable(0), new atgq(this, paramatkw));
      return;
      label196:
      paramRelativeLayout = ayog.a(paramVideoData.jdField_c_of_type_JavaLangString);
      if ((paramRelativeLayout != null) && (paramRelativeLayout.exists())) {
        try
        {
          ...
          paramatkw.a(paramVideoData.l, paramVideoData.k, true);
        }
  ...
  public void b()
  {
    this.jdField_a_of_type_Atje.b();
    if ((nar.a(a()) != 1) && (this.jdField_b_of_type_Int != 4) && (this.jdField_b_of_type_Int != 6) && (this.jdField_a_of_type_Atje.a != null) && (!this.jdField_a_of_type_Atje.a.jdField_d_of_type_Boolean)) {
      bcpw.a(a(), ajyc.a(2131714550), 1).a();
    }
    this.i = false;
  }
  ...
  public void d()
  {
    long l1;
    long l2;
    if (this.jdField_a_of_type_Atje.a != null)
    {
      l1 = this.jdField_a_of_type_Atje.b();
      l2 = this.jdField_a_of_type_Atje.c();
      if (l1 == 0L) {
        break label100;
      }
    }
    ...
    {
      atiw.a(this.jdField_a_of_type_Atje.a.jdField_a_of_type_JavaLangString, 2, String.valueOf(d1), String.valueOf(l1), String.valueOf(l2), String.valueOf(atiw.b()), this.jdField_a_of_type_Atje.a());
      this.jdField_a_of_type_Atje.c();
  ...
  public void l()
  {
    atkw localatkw = (atkw)this.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(this.jdField_a_of_type_Int));
    if (localatkw != null) {
      localatkw.e();
    }
  }
  ...
  public void onPageSelected(int paramInt)
  {
    ...
    if (paramInt < this.jdField_a_of_type_Int) {
      new ativ().h("video").i("playpage_left_slide").b().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    }
    ...
    if (paramInt > this.jdField_a_of_type_Int)
    {
      new ativ().h("video").i("playpage_right_slide").b().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      ThreadManagerV2.excute(new StoryPlayController.7(this, localVideoData, (aszd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(106)), 16, null, false);
    }
