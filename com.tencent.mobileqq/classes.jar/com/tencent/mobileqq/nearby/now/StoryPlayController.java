  ...
  implements ViewPager.OnPageChangeListener, StuffContainerView.GestureListener
{
  ...
  public Context a;
  public Bundle a;
  Handler jdField_a_of_type_AndroidOsHandler = new StoryPlayController.1(this);
  public QQAppInterface a;
  public ActCallBack a;
  BasePlayListDataModel.OnDataComeListener jdField_a_of_type_ComTencentMobileqqNearbyNowModelBasePlayListDataModel$OnDataComeListener = new StoryPlayController.2(this);
  ...
  public HashMap<Integer, VideoInfoListenerImpl> a;
  ...
  private void a(int paramInt, VideoPlayerPagerAdapter.VideoViewHolder paramVideoViewHolder, VideoData paramVideoData)
  {
    ...
    if ((NetworkUtil.a(a()) != 1) && (this.jdField_b_of_type_Int != 4) && (this.jdField_b_of_type_Int != 6) && (!paramVideoData.jdField_d_of_type_Boolean))
    {
      QQToast.a(a(), HardCodeUtil.a(2131714419), 1).a();
      this.k = true;
    }
    ...
    if ((paramVideoViewHolder != null) && (paramVideoViewHolder.jdField_a_of_type_ComTencentMobileqqNearbyNowViewOperationView != null))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqNearbyNowViewMagazinePlayerView.a(paramVideoViewHolder.jdField_a_of_type_AndroidWidgetRelativeLayout, paramVideoData, new StoryPlayController.5(this));
    }
  ...
  private void b(int paramInt, VideoPlayerPagerAdapter.VideoViewHolder paramVideoViewHolder, VideoData paramVideoData)
  {
    ...
    paramVideoViewHolder.jdField_a_of_type_ComTencentMobileqqNearbyNowViewWidgetImageDisplayView.setRelayoutListener(new StoryPlayController.6(this, paramVideoViewHolder, paramVideoData));
  ...
  private void c(int paramInt)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqNearbyNowViewWidgetStoryNewGuideDialog.a(HardCodeUtil.a(2131714429));
    HashMap localHashMap = this.jdField_a_of_type_JavaUtilHashMap;
    this.jdField_a_of_type_ComTencentMobileqqNearbyNowViewWidgetStoryNewGuideDialog.setOnDismissListener(new StoryPlayController.8(this, localVideoViewHolder, localHashMap));
  ...
  public void a(int paramInt)
  {
    ...
    do
    {
      ...
      {
        long l1 = localVideoData.jdField_a_of_type_Long;
        localVideoViewHolder.jdField_a_of_type_ComTencentMobileqqNearbyNowViewOperationView.setCurrentAnchorUin(l1);
      }
    ...
    if (localVideoData.j == 4)
    {
      ...
      ((NearbyMomentManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.NEARBY_MOMENT_MANAGER)).f(localVideoData.jdField_a_of_type_JavaLangString);
      return;
    }
    ...
    if ((NetworkUtil.a(a()) != 1) && (this.jdField_b_of_type_Int != 4) && (this.jdField_b_of_type_Int != 6) && (!localVideoData.jdField_d_of_type_Boolean))
    {
      QQToast.a(a(), HardCodeUtil.a(2131714426), 1).a();
      this.l = false;
    }
    b(paramInt);
  }
      ...
      catch (Exception localException)
      {
        try
        {
          ...
          if (bool)
          {
            ...
            ((ImageData)localObject).jdField_b_of_type_Int = paramBundle.k;
            ((ImageData)localObject).jdField_a_of_type_Int = paramBundle.l;
  ...
  {
    ImageLoader.a().a(paramImageView, paramString, new ColorDrawable(0), new ColorDrawable(0), UITools.a(this.jdField_a_of_type_AndroidContentContext) / 2, UITools.b(this.jdField_a_of_type_AndroidContentContext) / 2, new StoryPlayController.3(this, paramImageView, paramVideoInfoListenerImpl), false);
  }
  ...
  public void a(VideoPlayerPagerAdapter.VideoViewHolder paramVideoViewHolder, VideoData paramVideoData, boolean paramBoolean1, ShortVideoCommentsView paramShortVideoCommentsView, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      paramShortVideoCommentsView = new VideoInfoListenerImpl(paramVideoViewHolder, this, paramShortVideoCommentsView, StoryRelayoutUtil.a(paramVideoViewHolder, paramVideoData.l, paramVideoData.k));
      ...
      if (paramVideoData.jdField_a_of_type_Int == 4)
      {
        ...
        if (paramVideoViewHolder.jdField_a_of_type_AndroidViewView != null) {
          paramVideoViewHolder.jdField_a_of_type_AndroidViewView.findViewById(2131379482).setVisibility(4);
        }
      }
      ...
      paramVideoViewHolder.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundDrawable((Drawable)localObject);
    }
  }
  ...
  {
    ImageView localImageView1 = (ImageView)paramRelativeLayout.findViewById(2131369628);
    ImageView localImageView2 = (ImageView)paramRelativeLayout.findViewById(2131365969);
    ...
    for (;;)
    {
      ImageLoader.a().a(localImageView2, paramVideoData.jdField_d_of_type_JavaLangString, new ColorDrawable(0), new ColorDrawable(0), new StoryPlayController.4(this, paramVideoInfoListenerImpl));
      return;
      label196:
      ...
      if ((paramRelativeLayout != null) && (paramRelativeLayout.exists())) {
        try
        {
          ...
          paramVideoInfoListenerImpl.a(paramVideoData.l, paramVideoData.k, true);
        }
  ...
  public void b()
  {
    ...
    if ((NetworkUtil.a(a()) != 1) && (this.jdField_b_of_type_Int != 4) && (this.jdField_b_of_type_Int != 6) && (this.jdField_a_of_type_ComTencentMobileqqNearbyNowViewMagazinePlayerView.a != null) && (!this.jdField_a_of_type_ComTencentMobileqqNearbyNowViewMagazinePlayerView.a.jdField_d_of_type_Boolean)) {
      QQToast.a(a(), HardCodeUtil.a(2131714430), 1).a();
    }
    this.i = false;
  }
  ...
  public void onPageSelected(int paramInt)
  {
    ...
    if (paramInt > this.jdField_a_of_type_Int)
    {
      ...
      ThreadManagerV2.excute(new StoryPlayController.7(this, localVideoData, (NearbyCardManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.NEARBY_CARD_MANAGER)), 16, null, false);
    }
