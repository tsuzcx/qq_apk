...
class SmallVideoFragment$4
  implements Runnable
{
  SmallVideoFragment$4(SmallVideoFragment paramSmallVideoFragment, INearbyCardManager paramINearbyCardManager) {}
  ...
  public void run()
  {
    ...
    localReportTask.a(new String[] { "3", String.valueOf(i), str2, str1 }).a();
  }
}
