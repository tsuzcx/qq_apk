...
public class ShortVideoShareUtil$1$1$1
  implements Runnable
{
  public ShortVideoShareUtil$1$1$1(asmf paramasmf, ascz paramascz) {}
  
  public void run()
  {
    awrb localawrb = new awrb(this.jdField_a_of_type_Asmf.a.a).a("dc00899").b("grp_lbs").c("video").d("playpage_fw_suc").e(asmr.d);
    int i = this.jdField_a_of_type_Ascz.b();
    String str2 = asmr.a;
    if (TextUtils.equals(asmr.a, "2")) {}
    for (String str1 = asmr.c;; str1 = "")
    {
      localawrb.a(new String[] { "1", String.valueOf(i), str2, str1 }).a();
      return;
    }
  }
}
