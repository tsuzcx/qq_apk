...
public class ShortVideoShareUtil$1$2$1
  implements Runnable
{
  public ShortVideoShareUtil$1$2$1(axld paramaxld, axby paramaxby) {}
  
  public void run()
  {
    bcsy localbcsy = new bcsy(this.jdField_a_of_type_Axld.a.a).a("dc00899").b("grp_lbs").c("video").d("playpage_fw_suc").e(axlq.d);
    int i = this.jdField_a_of_type_Axby.b();
    String str2 = axlq.a;
    if (TextUtils.equals(axlq.a, "2")) {}
    for (String str1 = axlq.c;; str1 = "")
    {
      localbcsy.a(new String[] { "2", String.valueOf(i), str2, str1 }).a();
      return;
    }
  }
}
