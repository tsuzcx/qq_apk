...
public class NearbyTribeAppController$1
  implements Runnable
{
  public NearbyTribeAppController$1(axqg paramaxqg) {}
  
  public void run()
  {
    try
    {
      axqg.a(this.this$0, false);
      Object localObject = new Bundle();
      ((Bundle)localObject).putString("REFERER", " https://buluo.qq.com/");
      ((Bundle)localObject).putString("HOST", " buluo.qq.com");
      QLog.e(axqg.a(this.this$0), 1, "这里已经下架，如果依然发现该log，异常case");
      localObject = new JSONObject(HttpUtil.openUrl(axqg.a(this.this$0), "https://buluo.qq.com/cgi-bin/bar/post/get_entry?entry_ids=[18]", "POST", null, (Bundle)localObject));
