  ...
  implements baxu
{
  ...
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new aszu(this);
  public Context a;
  private atac jdField_a_of_type_Atac;
  bawo jdField_a_of_type_Bawo = null;
  private String jdField_a_of_type_JavaLangString;
  public HashMap<String, atab> a;
  public wxu a;
  private String b;
  private String c;
  private String d;
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    try
    {
      ...
      callJs(this.jdField_d_of_type_JavaLangString, new String[] { localJSONObject.toString() });
      return;
    }
  ...
  private void a(atab paramatab)
  {
    ...
    localIntent.putExtra("PREVIOUS_UIN", paramatab.jdField_a_of_type_JavaLangString);
    localIntent.putExtra("uin", paramatab.jdField_a_of_type_JavaLangString);
  ...
  public void clearFilterList(String paramString)
  {
    ...
    if ((localNearbyAppInterface != null) && ((localObject instanceof BaseActivity)))
    {
      ...
      if ((bbev.d(BaseApplication.getContext())) && (!paramString.isFinishing()))
      {
        localObject = (akbm)localNearbyAppInterface.a(3);
        if (localObject != null) {
          ((akbm)localObject).a();
        }
        aqhu.a(localNearbyAppInterface);
        ThreadManager.getUIHandler().postDelayed(new NearbyJsInterface.7(this, paramString), 300L);
      }
    }
    else
    {
    ...
    bcpw.a(BaseApplication.getContext(), 1, paramString.getString(2131694607), 0).b(paramString.getTitleBarHeight());
  }
  ...
  public void clearUnReadRedTouch(String paramString)
  {
    ...
    try
    {
      ...
      ((atfx)((NearbyAppInterface)BaseApplicationImpl.getApplication().getRuntime().getAppRuntime("module_nearby")).getManager(214)).a(i);
      return;
    }
  ...
  public void editSchool(String paramString)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Wxu.c(str, i);
      return;
    }
    catch (JSONException paramString)
    {
  ...
  {
    akbm localakbm = (akbm)((NearbyAppInterface)BaseApplicationImpl.getApplication().getRuntime().getAppRuntime("module_nearby")).a(3);
    if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      else
      {
        ...
        localakbm.a(i, j, k, m, n, i1, i2, i3, i4, paramString, str1, str2);
  ...
  {
    Object localObject = new NewIntent(this.mRuntime.a().getApplication().getApplicationContext(), mxh.class);
    ...
    try
    {
      ...
      ((NewIntent)localObject).setObserver(new aszz(this, paramString));
    ...
    catch (Exception paramString)
    {
      do
      {
        try
        {
          ...
          paramString = anqp.a("ipc_should_refresh_cardinfo", "", 0, (Bundle)localObject);
        ...
        if ((this.mRuntime.a() != null) && ((this.mRuntime.a() instanceof NearbyActivity)))
        {
          ...
          if (localObject2 != null)
          {
            ...
            if (localObject2 != null)
            {
              ...
              ((JSONObject)localObject2).put("sex", ((asyz)localObject1).jdField_a_of_type_Int);
              ((JSONObject)localObject2).put("time", ((asyz)localObject1).jdField_b_of_type_Int);
              ((JSONObject)localObject2).put("age", ((asyz)localObject1).jdField_c_of_type_Int);
              ((JSONObject)localObject2).put("interest", ((asyz)localObject1).jdField_d_of_type_Int);
              ((JSONObject)localObject2).put("profession", ((asyz)localObject1).f);
              ...
              ((JSONObject)localObject2).put("contellation", ((asyz)localObject1).e);
              ((JSONObject)localObject2).put("strCountry", ((asyz)localObject1).jdField_b_of_type_JavaLangString);
              ((JSONObject)localObject2).put("strProvince", ((asyz)localObject1).jdField_c_of_type_JavaLangString);
              ((JSONObject)localObject2).put("strCity", ((asyz)localObject1).jdField_d_of_type_JavaLangString);
  ...
  public void getFilterListV2(String paramString)
  {
    ...
    try
    {
      asyz localasyz = asyz.a(this.mRuntime.a().getCurrentAccountUin());
      if (localasyz != null)
      {
        localObject = new JSONObject();
        ((JSONObject)localObject).put("sex", localasyz.jdField_a_of_type_Int);
        ((JSONObject)localObject).put("time", localasyz.jdField_b_of_type_Int);
        ((JSONObject)localObject).put("age", localasyz.jdField_c_of_type_Int);
        ((JSONObject)localObject).put("interest", localasyz.jdField_d_of_type_Int);
        ((JSONObject)localObject).put("profession", localasyz.f);
        ((JSONObject)localObject).put("country", localasyz.jdField_d_of_type_ArrayOfJavaLangString[0]);
        ((JSONObject)localObject).put("province", localasyz.jdField_d_of_type_ArrayOfJavaLangString[1]);
        ((JSONObject)localObject).put("city", localasyz.jdField_d_of_type_ArrayOfJavaLangString[2]);
        ((JSONObject)localObject).put("contellation", localasyz.e);
        ((JSONObject)localObject).put("strCountry", localasyz.jdField_b_of_type_JavaLangString);
        ((JSONObject)localObject).put("strProvince", localasyz.jdField_c_of_type_JavaLangString);
        ((JSONObject)localObject).put("strCity", localasyz.jdField_d_of_type_JavaLangString);
  ...
  {
    atab localatab = (atab)this.jdField_a_of_type_JavaUtilHashMap.get(String.valueOf(paramString));
    if ((localatab != null) && (!TextUtils.isEmpty(localatab.jdField_a_of_type_JavaLangString)) && (!localatab.jdField_a_of_type_JavaLangString.equals("0")))
    {
      a(localatab);
      return;
    }
  ...
  public void getMatchPeopleInfo(String paramString, boolean paramBoolean, int paramInt)
  {
    ...
    try
    {
      ...
      localObject1 = new NewIntent(BaseApplication.getContext(), mxh.class);
      ...
      ((NewIntent)localObject1).setObserver(new aszy(this, paramString, paramBoolean));
  ...
  public void getNearbyPeopleAvatar(String paramString)
  {
    for (;;)
    {
      try
      {
        ...
        this.jdField_a_of_type_Bawo = new bazg(paramString, 32, 202, String.valueOf(Long.parseLong((String)localObject1)), (byte)1, 3, true, (Drawable)localObject2, (Drawable)localObject2, this, false);
        localObject2 = this.jdField_a_of_type_Bawo.a();
        ...
        ((StringBuilder)localObject1).append(bbca.encodeToString(paramString.toByteArray(), 2));
        localObject2 = new JSONObject();
      ...
      paramString.close();
      return;
      this.jdField_a_of_type_Bawo = new bazg(paramString, 32, 200, this.mRuntime.a().getCurrentAccountUin(), (byte)1, 3, true, (Drawable)localObject2, (Drawable)localObject2, this, false);
    }
  }
  ...
  public void getNearbyPublishBase64Images(String paramString)
  {
    try
    {
      ...
      String str = atyk.a(((AppRuntime)localObject).getAccount());
      atyk.b(((AppRuntime)localObject).getAccount(), "");
  ...
  public void getNearbyRedDotInfo(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localRedTypeInfo = ((atfx)((NearbyAppInterface)BaseApplicationImpl.getApplication().getRuntime().getAppRuntime("module_nearby")).getManager(214)).b(i);
        ...
        for (;;)
        {
          ...
          try
          {
            ...
            if (localObject2 != null)
            {
              ...
              localJSONObject.put("mTimeBeforeLoadUrl", ((bcal)localObject2).getmTimeBeforeLoadUrl());
              localJSONObject.put("mStartLoadUrlMilliTimeStamp", ((bcal)localObject2).mStartLoadUrlMilliTimeStamp);
              ...
              localJSONObject.put("isMainPageUseLocalFile", ((bcal)localObject2).isMainPageUseLocalFile());
              localJSONObject.put("mPerfFirstLoadTag", ((bcal)localObject2).ismPerfFirstLoadTag());
              localJSONObject.put("isWebViewCache", WebAccelerateHelper.isWebViewCache);
              localJSONObject.put("OpenUrlAfterCheckOfflineTime", ((bcal)localObject2).getOpenUrlAfterCheckOfflineTime());
              localJSONObject.put("ReadIndexFromOfflineTime", ((bcal)localObject2).getReadIndexFromOfflineTime());
              localJSONObject.put("IsReloadUrl", ((bcal)localObject2).getIsReloadUrl());
            }
          }
          catch (Exception localException)
          {
  ...
  public void nearbySafetyReport(String paramString)
  {
    ...
    paramString = new bazp().a(paramString.optString("text_evidence")).b(paramString.optString("img_evidence")).d(paramString.optString("video_evidence")).c(paramString.optString("url_evidence")).e(paramString.optString("file_evidence")).f(paramString.optString("audio_evidence")).g(paramString.optString("user_input_param")).a();
    bazo.a((BaseActivity)this.mRuntime.a(), l1, "0", null, i, str, paramString);
  }
  ...
  public void onDestroy()
  {
    ...
    if (this.jdField_a_of_type_Atac != null) {
      AppNetConnInfo.unregisterNetEventHandler(this.jdField_a_of_type_Atac);
    }
    super.onDestroy();
  }
  ...
  public void onLoadingStateChanged(int paramInt1, int paramInt2)
  {
    if ((paramInt1 == 0) && (paramInt2 == 1)) {
      try
      {
        Object localObject = this.jdField_a_of_type_Bawo.a();
        ...
        if (localObject != null)
        {
          ...
          localStringBuilder.append(bbca.encodeToString(localByteArrayOutputStream.toByteArray(), 2));
          localObject = new JSONObject();
  ...
  {
    NearbyAppInterface localNearbyAppInterface = (NearbyAppInterface)BaseApplicationImpl.getApplication().getRuntime().getAppRuntime("module_nearby");
    Object localObject1 = (akbm)localNearbyAppInterface.a(3);
    for (;;)
    {
      try
      {
      ...
      try
      {
        ...
        paramString = anqp.a("ipc_should_refresh_cardinfo", "", 0, (Bundle)localObject3);
        anvl.a().a(paramString);
        ...
        if (QLog.isColorLevel())
        {
          ...
          paramString = new ataa(this, (String)localObject1, j);
          akbm.a(localNearbyAppInterface, new long[] { l }, paramString);
          return;
        }
      }
      catch (Exception paramString)
  ...
  public void openVideoChat(String paramString)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        paramString = wxu.a();
        paramString.a();
        paramString.c(new aszv(this, paramString, j, i, k));
        return;
      }
      catch (JSONException paramString)
      {
  ...
  {
    ThreadManager.post(new NearbyJsInterface.5(this, paramString, System.currentTimeMillis()), 8, null, true);
  }
  ...
  public void preloadVideos(String paramString)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        paramString = anqp.a("ipc_cmd_preload_video", "", 0, localBundle);
        anvl.a().a(paramString);
        return;
      }
      catch (Exception paramString)
  ...
  public void qbrowserNetworkChange(String paramString)
  {
    try
    {
      ...
      if (this.jdField_a_of_type_Atac == null)
      {
        this.jdField_a_of_type_Atac = new atac(this);
        AppNetConnInfo.registerNetChangeReceiver(BaseApplicationImpl.getContext(), this.jdField_a_of_type_Atac);
        return;
      }
      if (QLog.isColorLevel())
      {
  ...
  public void setLiveTabWebViewUrlParam(String paramString)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramString)
      {
        try
        {
          Object localObject = atbg.a(new JSONObject((String)localObject), paramString);
    ...
    try
    {
      ...
      if ("greetingsReceive".equals(paramString.optString("key")))
      {
        ...
        if ("0".equals(paramString.optString("value")))
        {
          ...
          paramString = anqp.a("ipc_cmd_nearby_setting_change", null, 0, paramString);
          anvl.a().a(paramString);
        }
      }
      localEditor.apply();
  ...
  public void setStatusBarTextDark(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("NearbyJsInterface", 2, "isKITKAT=" + bfni.j() + ", enableForMiUI=" + ImmersiveUtils.d + ", isMIUI=" + bbay.b() + ", isFlyme=" + bbay.d() + ", SDK_INT=" + Build.VERSION.SDK_INT);
      }
      return;
      bool1 = false;
      continue;
  ...
  public void setVideoEnterVisibility(String paramString)
  {
    ...
    try
    {
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        if (paramString != null)
        {
          atbg.a(BaseApplicationImpl.getApplication().getRuntime().getAccount(), "key_nearby_publish_menu", paramString.toString());
          if (QLog.isColorLevel()) {
  ...
  public void shootAvatar()
  {
    ...
    NearbyAppInterface localNearbyAppInterface = (NearbyAppInterface)BaseApplicationImpl.getApplication().getRuntime().getAppRuntime("module_nearby");
    atbr.a(this.mRuntime.a(), localNearbyAppInterface, 1);
  }
  ...
  public void showGuideDownloadView(String paramString)
  {
    ...
    paramString = asyr.a((Context)localObject, localJSONObject);
    if (paramString != null)
    {
      paramString.f = (localJSONObject.optInt("source") + "");
      localObject = new atyb((Context)localObject);
      ((atyb)localObject).a(paramString);
      ((atyb)localObject).show();
    }
  }
  ...
  public void updateFollowStatus(String paramString)
  {
    try
    {
      ...
      for (;;)
      {
        paramString = anqp.a("ipc_should_refresh_cardinfo", "", 0, localBundle);
        anvl.a().a(paramString);
        return;
        if (!TextUtils.isEmpty((CharSequence)localObject)) {
