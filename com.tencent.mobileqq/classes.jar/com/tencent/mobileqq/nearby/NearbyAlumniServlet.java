  ...
  extends MSFServlet
{
  ...
  public OldBigDataChannelManager a()
  {
    ...
    if ((localAppRuntime instanceof NearbyAppInterface)) {
      return (OldBigDataChannelManager)localAppRuntime.getManager(216);
    }
  ...
  protected void a(Intent paramIntent, Packet paramPacket, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        paramPacket.jdField_a_of_type_ComTencentMobileqqTransfileINetEngine$INetEngineListener = new aetv(this, paramIntent, (byte[])localObject1);
      ...
      ((INetEngine)localObject1).a(paramPacket);
    } while (!NearbyUtils.b());
