  ...
  implements IGetFileInfoCallBack
{
  ...
  public void a(String paramString, long paramLong)
  {
    ...
    {
      return;
      localObject = FMSettings.a().b() + paramString;
      if (!new File((String)localObject).exists()) {
        break;
      }
      ((IUniformDownloadUtil)QRoute.api(IUniformDownloadUtil.class)).installAPK((String)localObject);
    } while (!QLog.isColorLevel());
    QLog.d(NearbyTribeAppController.a(this.a), 2, "UniformDownloadUtil.installAPK,savePath=" + (String)localObject);
    return;
    ...
    ((Bundle)localObject).putString("_notify_name_dialog", HardCodeUtil.a(2131707391));
