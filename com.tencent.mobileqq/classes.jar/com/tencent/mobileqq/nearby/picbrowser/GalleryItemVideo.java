  ...
  implements DynamicAvatarDownloadManager.IDynamicAvatarDownloadCallback
{
  ...
  WeakReference<PicBrowserImage.OnLoadListener> jdField_b_of_type_JavaLangRefWeakReference;
  int c = 0;
  ...
  public View a(int paramInt, Handler paramHandler, PicBrowserImage.OnLoadListener paramOnLoadListener)
  {
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      for (;;)
      {
        ...
        break label186;
        localURLImageView.setImageDrawable(BaseApplicationImpl.getApplication().getResources().getDrawable(2130838183));
        this.c = 2;
  ...
  public void a(String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (paramBoolean2 = true;; paramBoolean2 = false)
    {
      ...
      localObject = BaseApplicationImpl.getApplication().getResources().getDrawable(2130838183);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((localObject1 != null) && (localObject2 != null))
        {
          ...
          QLog.d("GalleryItemVideo", 2, "getAnimationDrawable ,cutValue = " + this.d);
          return localObject1;
        }
      }
