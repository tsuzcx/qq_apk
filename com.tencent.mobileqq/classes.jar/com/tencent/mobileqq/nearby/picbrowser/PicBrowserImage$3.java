...
public class PicBrowserImage$3
  implements Runnable
{
  public PicBrowserImage$3(atod paramatod, URLDrawable paramURLDrawable, atof paramatof, int paramInt) {}
  ...
  public void run()
  {
    if ((this.jdField_a_of_type_ComTencentImageURLDrawable.getStatus() != 1) && (this.jdField_a_of_type_ComTencentImageURLDrawable.getStatus() != 2)) {
      this.jdField_a_of_type_Atof.a(this.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentImageURLDrawable.getProgress());
    }
  }
}
