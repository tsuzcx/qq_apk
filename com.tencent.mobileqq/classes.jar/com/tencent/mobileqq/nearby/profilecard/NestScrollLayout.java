  ...
  extends LinearLayout
{
  ...
  public NestScrollLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    paramInt = paramContext.getResources().getDimensionPixelSize(2131298998) + ImmersiveUtils.getStatusBarHeight(paramContext);
    this.jdField_b_of_type_Int = paramInt;
    this.jdField_b_of_type_Int = paramInt;
    this.jdField_a_of_type_AndroidWidgetScroller = new Scroller(paramContext);
    this.jdField_a_of_type_Axxd = new axxd();
  ...
  public void computeScroll()
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetScroller.computeScrollOffset())
    {
      ...
      if (a())
      {
        ...
        this.jdField_a_of_type_Axxd.a(a(), k - j, m);
    ...
    for (;;)
    {
      ...
      return;
      label99:
      if (this.jdField_a_of_type_Axxd.a())
      {
  ...
  public boolean dispatchTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      for (this.jdField_a_of_type_Boolean = false;; this.jdField_a_of_type_Boolean = true) {
        ...
        {
          bool = a();
          if ((!this.jdField_a_of_type_Boolean) || (((this.jdField_d_of_type_Float <= 0.0F) || (bool)) && ((!this.jdField_a_of_type_Axxd.a()) || (this.jdField_d_of_type_Float >= 0.0F)))) {
            break;
          }
  ...
  {
    this.jdField_a_of_type_Axxd.a(paramInt);
  }
  
  public void setViewPager(ViewPager paramViewPager)
  {
    this.jdField_a_of_type_Axxd.a(paramViewPager);
  }
}
