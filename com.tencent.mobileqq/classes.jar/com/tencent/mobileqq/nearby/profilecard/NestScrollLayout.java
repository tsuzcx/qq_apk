  ...
  extends LinearLayout
{
  ...
  private aypx jdField_a_of_type_Aypx;
  ...
  public NestScrollLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    paramInt = paramContext.getResources().getDimensionPixelSize(2131299011) + ImmersiveUtils.getStatusBarHeight(paramContext);
    this.jdField_b_of_type_Int = paramInt;
    this.jdField_b_of_type_Int = paramInt;
    this.jdField_a_of_type_AndroidWidgetScroller = new Scroller(paramContext);
    this.jdField_a_of_type_Aypx = new aypx();
  ...
  public void computeScroll()
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetScroller.computeScrollOffset())
    {
      ...
      if (a())
      {
        ...
        this.jdField_a_of_type_Aypx.a(a(), k - j, m);
    ...
    for (;;)
    {
      ...
      return;
      label99:
      if (this.jdField_a_of_type_Aypx.a())
      {
  ...
  public boolean dispatchTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      for (this.jdField_a_of_type_Boolean = false;; this.jdField_a_of_type_Boolean = true) {
        ...
        {
          bool = a();
          if ((!this.jdField_a_of_type_Boolean) || (((this.jdField_d_of_type_Float <= 0.0F) || (bool)) && ((!this.jdField_a_of_type_Aypx.a()) || (this.jdField_d_of_type_Float >= 0.0F)))) {
            break;
          }
  ...
  {
    this.jdField_a_of_type_Aypx.a(paramInt);
  }
  
  public void setViewPager(ViewPager paramViewPager)
  {
    this.jdField_a_of_type_Aypx.a(paramViewPager);
  }
}
