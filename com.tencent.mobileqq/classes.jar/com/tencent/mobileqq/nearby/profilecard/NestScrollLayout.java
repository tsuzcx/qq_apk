  ...
  extends LinearLayout
{
  ...
  public NestScrollLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.jdField_a_of_type_Atui = new atui();
  ...
  public void computeScroll()
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetScroller.computeScrollOffset())
    {
      ...
      if (a())
      {
        ...
        this.jdField_a_of_type_Atui.a(a(), k - j, m);
    ...
    for (;;)
    {
      ...
      return;
      label99:
      if (this.jdField_a_of_type_Atui.a())
      {
  ...
  public boolean dispatchTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      for (this.jdField_a_of_type_Boolean = false;; this.jdField_a_of_type_Boolean = true) {
        ...
        {
          bool = a();
          if ((!this.jdField_a_of_type_Boolean) || (((this.jdField_d_of_type_Float <= 0.0F) || (bool)) && ((!this.jdField_a_of_type_Atui.a()) || (this.jdField_d_of_type_Float >= 0.0F)))) {
            break;
          }
  ...
  {
    this.jdField_a_of_type_Atui.a(paramInt);
  }
  
  public void setViewPager(ViewPager paramViewPager)
  {
    this.jdField_a_of_type_Atui.a(paramViewPager);
  }
}
