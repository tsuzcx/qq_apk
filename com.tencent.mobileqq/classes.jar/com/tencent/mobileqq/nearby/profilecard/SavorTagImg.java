  ...
  implements AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener
{
  ...
  {
    removeAllViews();
    getResources().getDimensionPixelSize(2131297258);
    int i = getResources().getDimensionPixelSize(2131297259);
    setOrientation(1);
  ...
  public String a()
  {
    ...
    StringBuilder localStringBuilder = new StringBuilder(HardCodeUtil.a(2131713460));
  ...
  public void a(String paramString, int paramInt, List<InterestTagInfo> paramList, OnTagClickListener paramOnTagClickListener)
  {
    ...
    default: 
      ...
      i = paramString.getDimensionPixelSize(2131298935);
      int m = paramString.getDimensionPixelSize(2131297259);
      paramString = new GradientDrawable();
      if (this.jdField_a_of_type_Int == 7)
      {
        paramString.setColor(getResources().getColor(2131165883));
        paramString.setCornerRadius(10.0F * f);
        paramString.setShape(0);
        int n = getResources().getDimensionPixelSize(2131297473);
  ...
  public void a(List<InterestTagInfo> paramList)
  {
    ...
    SavorImgTagAdapter localSavorImgTagAdapter = (SavorImgTagAdapter)this.jdField_a_of_type_ComTencentWidgetHorizontalListView.getAdapter();
