  ...
  implements AdapterView.OnItemClickListener
{
  ...
  public void a(QQAppInterface paramQQAppInterface, View paramView, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131370681);
    this.jdField_a_of_type_ComTencentWidgetHorizontalListView = ((HorizontalListView)paramView.findViewById(2131370682));
  ...
  {
    Object localObject = (aeoq)paramView.getTag();
    if (localObject != null)
    {
      paramView = ((aeoq)localObject).jdField_a_of_type_TencentImOidbCmd0xac5Cmd0xac5$NowFollowAnchor;
      paramAdapterView = (NearbyCardManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(105);
    }
    switch (((aeoq)localObject).jdField_a_of_type_Int)
    {
    default: 
      QLog.i("AnchorDisplayCtrl", 1, "unknowed jumpType = " + ((aeoq)localObject).jdField_a_of_type_Int);
      return;
    case 1: 
      if (paramView != null)
      {
