  ...
  extends NearbyCardObserver
{
  ...
  public void a(boolean paramBoolean)
  {
    ...
    ((NearbyCardManager)this.a.getActivity().app.getManager(QQManagerFactory.NEARBY_CARD_MANAGER)).d.put(this.a.getActivity().app.getCurrentAccountUin(), Integer.valueOf(1));
    if (paramBoolean) {
