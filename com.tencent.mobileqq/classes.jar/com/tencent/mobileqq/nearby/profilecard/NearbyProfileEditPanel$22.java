  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    NearbyProfileEditPanel.a((NearbyProfileEditPanel)localObject1, (PicInfo)((NearbyProfileEditPanel)localObject1).jdField_a_of_type_JavaUtilLinkedList.poll());
    if (NearbyProfileEditPanel.a(this.this$0) == null) {
      return;
    }
    localObject1 = new CompressInfo(NearbyProfileEditPanel.a(this.this$0).c, 0);
