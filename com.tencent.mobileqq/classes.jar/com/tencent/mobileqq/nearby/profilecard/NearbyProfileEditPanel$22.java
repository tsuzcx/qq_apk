...
public class NearbyProfileEditPanel$22
  implements Runnable
{
  public NearbyProfileEditPanel$22(atsc paramatsc) {}
  
  public void run()
  {
    atsc.a(this.this$0, (PicInfo)this.this$0.jdField_a_of_type_JavaUtilLinkedList.poll());
    if (atsc.a(this.this$0) == null) {
      return;
    }
    CompressInfo localCompressInfo = new CompressInfo(atsc.a(this.this$0).c, 0);
