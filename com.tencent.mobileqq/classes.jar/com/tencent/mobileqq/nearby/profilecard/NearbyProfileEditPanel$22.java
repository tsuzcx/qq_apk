  ...
  implements Runnable
{
  ...
  public void run()
  {
    NearbyProfileEditPanel.a(this.this$0, (PicInfo)this.this$0.jdField_a_of_type_JavaUtilLinkedList.poll());
    if (NearbyProfileEditPanel.a(this.this$0) == null) {
      return;
    }
    CompressInfo localCompressInfo = new CompressInfo(NearbyProfileEditPanel.a(this.this$0).c, 0);
    ...
    if (!StringUtil.a(localCompressInfo.e))
    {
      ...
      ((ITransFileController)this.this$0.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.getRuntimeService(ITransFileController.class)).transferAsync(localTransferRequest);
      return;
    }
