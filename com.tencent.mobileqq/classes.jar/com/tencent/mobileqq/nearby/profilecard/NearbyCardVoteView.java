  ...
  implements PraiseManager.OnPraiseLoadListener
{
  ...
  public NearbyCardVoteView(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new afha(this);
    a();
  }
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130842874);
    ...
    this.jdField_b_of_type_AndroidViewView.setBackgroundResource(2130843163);
    this.jdField_b_of_type_AndroidViewView.setId(2131368335);
    ...
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setId(2131365245);
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setBackgroundResource(2130846141);
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setId(2131365246);
  ...
  public void a(PraiseInfo paramPraiseInfo)
  {
    if ((!this.jdField_d_of_type_Boolean) && (paramPraiseInfo != null) && (!this.jdField_a_of_type_ComTencentMobileqqProfileLikePraiseAnimation.jdField_a_of_type_Boolean))
    {
      ...
      paramPraiseInfo = (NearbyLikeLimitManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(206);
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2, int paramInt1, int paramInt2, NewVoteAnimHelper paramNewVoteAnimHelper, boolean paramBoolean3, boolean paramBoolean4, List paramList)
  {
    ...
    if (paramInt1 > 0)
    {
      ...
      localObject = (NearbyLikeLimitManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(206);
    ...
    do
    {
      for (;;)
      {
        try
        {
          ...
          {
            paramNewVoteAnimHelper = getResources().getDrawable(2130840646);
            ...
            if ((!this.jdField_d_of_type_Boolean) && (!this.jdField_a_of_type_ComTencentMobileqqProfileLikePraiseAnimation.jdField_a_of_type_Boolean) && (!paramBoolean3))
            {
              ...
              if (i > 0)
              {
                paramNewVoteAnimHelper = (PraiseManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(208);
          ...
          {
            paramNewVoteAnimHelper = getResources().getDrawable(2130842889);
        ...
        catch (NumberFormatException paramNewVoteAnimHelper)
        {
          ...
          paramNewVoteAnimHelper = getResources().getDrawable(2130843163);
          this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(-15550475);
          continue;
          paramNewVoteAnimHelper = getResources().getDrawable(2130843163);
          this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(-15550475);
        ...
        if (this.jdField_a_of_type_Boolean)
        {
          paramNewVoteAnimHelper = getResources().getDrawable(2130840648);
          this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(-1);
        }
        else
        {
          paramNewVoteAnimHelper = getResources().getDrawable(2130842890);
    ...
    Object localObject = (PraiseManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(208);
    ...
    if (((PraiseManager)localObject).a(localHashSet, new afhb(this, paramInt1, paramInt2, paramList)))
    {
      paramNewVoteAnimHelper.sendToTarget();
      return;
    }
  ...
  protected void onDetachedFromWindow()
  {
    ...
    {
      PraiseManager localPraiseManager = (PraiseManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(208);
