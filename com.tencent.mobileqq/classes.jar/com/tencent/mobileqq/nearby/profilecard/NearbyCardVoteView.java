  ...
  implements auwv
{
  ...
  auwq jdField_a_of_type_Auwq = new auwq();
  ...
  public NearbyCardVoteView(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new aton(this);
    a();
  }
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_Aqyp = new aqyp(getContext());
    this.jdField_a_of_type_Auwq.jdField_a_of_type_Aqyp = this.jdField_a_of_type_Aqyp;
    ...
    this.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130844676);
    ...
    this.jdField_b_of_type_AndroidViewView.setBackgroundResource(2130845041);
    ...
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setId(2131368673);
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setBackgroundResource(2130849298);
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    localObject = this.jdField_a_of_type_Aqyp.a(paramInt2, this.jdField_a_of_type_ComTencentMobileqqHotchatAnimHeartLayout.a);
    if (paramInt1 > 0)
    {
      this.jdField_a_of_type_Auwq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqHotchatAnimHeartLayout, ((aqyn)localObject).a(), this, paramInt1, true, paramInt2, f1, f2);
      return;
    }
    if (paramInt2 == 2)
    {
      this.jdField_a_of_type_ComTencentMobileqqHotchatAnimHeartLayout.a(((aqyn)localObject).a(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (aqyn)localObject, f1 - bawz.a(getContext(), 20.0F), f2 - bawz.a(getContext(), 120.0F), bawz.a(getContext(), 75.0F), bawz.a(getContext(), 65.0F));
      return;
    }
    this.jdField_a_of_type_ComTencentMobileqqHotchatAnimHeartLayout.a(((aqyn)localObject).a(), f1, f2);
  }
  ...
  public void a(int paramInt1, auwu paramauwu, int paramInt2, String paramString)
  {
    ...
    do
    {
      ...
      paramauwu = (Pair)this.jdField_a_of_type_Auwq.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt1);
    } while (paramauwu == null);
    float f1 = ((Point)paramauwu.first).x;
    float f2 = ((Point)paramauwu.first).y;
    paramInt2 = ((Integer)paramauwu.second).intValue();
    this.jdField_a_of_type_Auwq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqHotchatAnimHeartLayout, this.jdField_a_of_type_Aqyp.a(paramInt2, this.jdField_a_of_type_ComTencentMobileqqHotchatAnimHeartLayout.a).a(), this, paramInt1, false, paramInt2, f1, f2);
    this.jdField_a_of_type_Auwq.jdField_a_of_type_AndroidUtilSparseArray.remove(paramInt1);
  }
  
  public void a(auwu paramauwu)
  {
    if ((!this.jdField_d_of_type_Boolean) && (paramauwu != null) && (!this.jdField_a_of_type_Auwq.jdField_a_of_type_Boolean))
    {
      this.jdField_a_of_type_Auwq.jdField_a_of_type_AndroidViewView = this.jdField_b_of_type_AndroidViewView;
      this.jdField_a_of_type_Auwq.jdField_a_of_type_AndroidGraphicsDrawableDrawable = new BitmapDrawable(getResources(), paramauwu.a);
      paramauwu = (atah)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(207);
      if ((this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard == null) || (!paramauwu.c(Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.uin).longValue()))) {
        break label147;
      }
    }
    label147:
    ...
    {
      this.jdField_a_of_type_Auwq.a(this.jdField_c_of_type_Boolean, bool, this.jdField_b_of_type_AndroidViewView.getBackground(), getResources());
      this.jdField_b_of_type_AndroidViewView.startAnimation(auwq.a(this.jdField_a_of_type_Auwq, 1.0F, 0.3F));
      this.jdField_a_of_type_Auwq.jdField_a_of_type_Boolean = true;
      return;
    }
  }
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2, int paramInt1, int paramInt2, anmy paramanmy, boolean paramBoolean3, boolean paramBoolean4, List<TPraiseInfo> paramList)
  {
    ...
    if (paramInt1 > 0)
    {
      ...
      localObject = (atah)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(207);
    ...
    do
    {
      for (;;)
      {
        try
        {
          if ((this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard != null) && (((atah)localObject).c(Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.uin).longValue())))
          {
            paramanmy = getResources().getDrawable(2130842078);
            this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(-13291);
            if (!this.jdField_a_of_type_Auwq.jdField_a_of_type_Boolean) {
              break label568;
            }
            if ((this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard == null) || (!((atah)localObject).c(Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.uin).longValue()))) {
              break label563;
            ...
            paramBoolean1 = true;
            this.jdField_a_of_type_Auwq.a(this.jdField_c_of_type_Boolean, paramBoolean1, paramanmy, getResources());
            if ((!this.jdField_d_of_type_Boolean) && (!this.jdField_a_of_type_Auwq.jdField_a_of_type_Boolean) && (!paramBoolean3))
            {
              i = PraiseManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
              if (i > 0)
              {
                paramanmy = (PraiseManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(209);
                paramanmy.a(this);
                a(paramanmy.a(i, true, "from_profile_card"));
              }
            }
            setContentDescription(this.jdField_a_of_type_Int + ajyc.a(2131707109));
          ...
          {
            paramanmy = getResources().getDrawable(2130844695);
            this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(-52924);
            continue;
          }
        }
        catch (NumberFormatException paramanmy)
        {
          if (QLog.isColorLevel()) {
            QLog.e("VoteView", 2, paramanmy.toString(), paramanmy);
          }
          paramanmy = getResources().getDrawable(2130845041);
          this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(-15550475);
          continue;
          paramanmy = getResources().getDrawable(2130845041);
          this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(-15550475);
        ...
        if (this.jdField_a_of_type_Boolean)
        {
          paramanmy = getResources().getDrawable(2130842080);
          this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(-1);
        }
        else
        {
          paramanmy = getResources().getDrawable(2130844697);
          ...
          paramBoolean1 = false;
          continue;
          this.jdField_b_of_type_AndroidViewView.setBackgroundDrawable(paramanmy);
          if (!this.jdField_a_of_type_Boolean)
          {
            this.jdField_a_of_type_AndroidViewView.setBackgroundDrawable(new ColorDrawable(0));
            paramanmy = new RelativeLayout.LayoutParams((int)(this.jdField_a_of_type_Double * 32.0D), (int)(this.jdField_a_of_type_Double * 32.0D));
            paramanmy.topMargin = ((int)(15.0D * this.jdField_a_of_type_Double));
            paramanmy.addRule(14);
            paramanmy.addRule(10);
            this.jdField_b_of_type_AndroidViewView.setLayoutParams(paramanmy);
            continue;
            paramInt1 = 2;
          }
        }
    ...
    label563:
    label568:
    paramanmy = this.jdField_a_of_type_AndroidOsHandler.obtainMessage(jdField_d_of_type_Int, paramInt1, paramInt2, paramList);
    label666:
    label671:
    if ((paramList == null) || (paramList.isEmpty()))
    {
      paramanmy.sendToTarget();
      return;
    }
    ...
    if (((PraiseManager)localObject).a(localHashSet, new atoo(this, paramInt1, paramInt2, paramList)))
    {
      paramanmy.sendToTarget();
      return;
    }
    this.jdField_a_of_type_AndroidOsHandler.sendMessageDelayed(paramanmy, auws.jdField_b_of_type_Int);
    return;
    label953:
    a(false, 0);
  }
  ...
  public void setHeartLayout(HeartLayout paramHeartLayout)
  {
    ...
    aqyo.a(this.jdField_a_of_type_ComTencentMobileqqHotchatAnimHeartLayout);
  }
