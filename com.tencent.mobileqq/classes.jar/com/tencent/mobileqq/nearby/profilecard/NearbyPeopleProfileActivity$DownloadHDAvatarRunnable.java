  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    File localFile1 = new File(bghy.a(String.valueOf(this.jdField_a_of_type_JavaLangString)));
    boolean bool2;
    ...
    for (int i = j;; i = 0)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          localObject = new URL(((URL)localObject).getProtocol(), aqlf.a(0), ((URL)localObject).getFile()).toString();
          if (HttpDownloadUtil.a(this.this$0.app, new arul((String)localObject, localFile2, 0), null) == 0)
          {
            bool2 = true;
            boolean bool1 = bool2;
            if (bool2) {
