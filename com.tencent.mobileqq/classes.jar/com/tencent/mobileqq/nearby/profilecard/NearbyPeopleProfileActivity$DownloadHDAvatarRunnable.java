  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    File localFile1 = new File(bfrj.a(String.valueOf(this.jdField_a_of_type_JavaLangString)));
    boolean bool2;
    ...
    for (int i = j;; i = 0)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          localObject = new URL(((URL)localObject).getProtocol(), aptw.a(0), ((URL)localObject).getFile()).toString();
          if (HttpDownloadUtil.downloadData(this.this$0.app, new ardx((String)localObject, localFile2, 0), null) == 0)
          {
            bool2 = true;
            boolean bool1 = bool2;
            if (bool2) {
