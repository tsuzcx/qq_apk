  ...
  implements View.OnClickListener
{
  ...
  static final int[] jdField_b_of_type_ArrayOfInt = { 1, 2, 3, 4, 5, 6, 7 };
  int jdField_a_of_type_Int;
  private afnu jdField_a_of_type_Afnu;
  private View.OnLongClickListener jdField_a_of_type_AndroidViewView$OnLongClickListener = new afnj(this);
  ...
  private IphonePickerView.PickerViewAdapter jdField_a_of_type_ComTencentMobileqqConditionsearchWidgetIphonePickerView$PickerViewAdapter = new afmw(this);
  ...
  private TransProcessorHandler jdField_a_of_type_ComTencentMobileqqTransfileTransProcessorHandler = new afnf(this);
  ...
  private IphonePickerView.PickerViewAdapter jdField_b_of_type_ComTencentMobileqqConditionsearchWidgetIphonePickerView$PickerViewAdapter = new afmx(this);
  ...
  private IphonePickerView.PickerViewAdapter jdField_c_of_type_ComTencentMobileqqConditionsearchWidgetIphonePickerView$PickerViewAdapter = new afnk(this);
  ...
  public NearbyProfileEditTribePanel(NearbyPeopleProfileActivity paramNearbyPeopleProfileActivity)
  {
    ...
    if (Build.VERSION.SDK_INT >= 11) {
      this.jdField_a_of_type_Afnu = new afnu(this, this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.f);
    }
    ...
    this.jdField_b_of_type_ArrayOfJavaLangString = this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getResources().getStringArray(2131296320);
    ...
    while (j < 7)
    {
      this.jdField_a_of_type_ArrayOfComTencentMobileqqNearbyInterestTagInterestTag[j] = new InterestTag(jdField_b_of_type_ArrayOfInt[j]);
      j += 1;
    }
  ...
  private RelativeLayout a(PicInfo paramPicInfo, Drawable paramDrawable)
  {
    ...
    if (Build.VERSION.SDK_INT >= 11)
    {
      ...
      localRelativeLayout.setOnDragListener(this.jdField_a_of_type_Afnu);
    }
  ...
  {
    paramView2.postDelayed(new afnl(this, paramView2, paramView1), 300L);
  }
  ...
  private void a(PicInfo paramPicInfo, View paramView)
  {
    ...
    paramPicInfo.setPositiveButton(2131433030, new afmo(this, paramPicInfo));
    paramPicInfo.show();
  }
  ...
  private void j()
  {
    ...
    if (this.jdField_h_of_type_AndroidWidgetEditText.getTag() != null)
    {
      ...
      ((IphonePickerView)localObject).setPickListener(new afnp(this, (IphonePickerView)localObject, localActionSheet));
      localActionSheet.a(new afnq(this));
  ...
  private void k()
  {
    ...
    for (;;)
    {
      this.jdField_d_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_JavaUtilArrayList.size() + "/" + NearbyPeopleProfileActivity.jdField_c_of_type_Int);
      return;
  ...
  private void m()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard != null) && (this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.godFlag))
    {
      ...
      ((QQCustomDialog)localObject).setPositiveButton(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getString(2131437553), new afnt(this, (QQCustomDialog)localObject));
      ((QQCustomDialog)localObject).show();
    }
    for (;;)
    {
      if ((this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard == null) && (QLog.isColorLevel())) {
        QLog.d("NearbyProfileEditTribePanel", 2, "mcard is null");
      }
      return;
  ...
  private void n()
  {
    ...
    localTextView.setOnClickListener(new afmz(this));
    ...
    localTextView.setOnClickListener(new afna(this));
  ...
  protected void a(View paramView)
  {
    ...
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131366705));
    this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)paramView.findViewById(2131365248));
    this.jdField_a_of_type_ComTencentImageURLImageView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131363563));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131365253));
    ...
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370669));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370668));
    ...
    this.jdField_f_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370678));
    ...
    this.jdField_g_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370681));
    this.jdField_h_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370682));
    ...
    this.jdField_i_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370685));
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_ArrayOfComTencentMobileqqNearbyProfilecardSavorTagIcon[k] = ((SavorTagIcon)this.jdField_b_of_type_AndroidViewView.findViewById(jdField_a_of_type_ArrayOfInt[k]));
      this.jdField_a_of_type_ArrayOfComTencentMobileqqNearbyProfilecardSavorTagIcon[k].a(this.jdField_b_of_type_ArrayOfJavaLangString[k], this.jdField_a_of_type_ArrayOfComTencentMobileqqNearbyInterestTagInterestTag[k].jdField_a_of_type_Int, this.jdField_a_of_type_ArrayOfComTencentMobileqqNearbyInterestTagInterestTag[k].jdField_a_of_type_JavaUtilArrayList, null);
      k += 1;
    }
    while (j < 3)
    {
      k = j + 4;
      this.jdField_a_of_type_ArrayOfComTencentMobileqqNearbyProfilecardSavorTagImg[j] = ((SavorTagImg)this.jdField_b_of_type_AndroidViewView.findViewById(jdField_a_of_type_ArrayOfInt[k]));
      this.jdField_a_of_type_ArrayOfComTencentMobileqqNearbyProfilecardSavorTagImg[j].a(this.jdField_b_of_type_ArrayOfJavaLangString[k], this.jdField_a_of_type_ArrayOfComTencentMobileqqNearbyInterestTagInterestTag[k].jdField_a_of_type_Int, this.jdField_a_of_type_ArrayOfComTencentMobileqqNearbyInterestTagInterestTag[k].jdField_a_of_type_JavaUtilArrayList, null);
      j += 1;
    }
    n();
  }
  ...
  public void a(NearbyPeopleCard paramNearbyPeopleCard)
  {
    ...
    else
    {
      ...
      this.jdField_e_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getString(2131437473));
      this.jdField_a_of_type_AndroidWidgetButton.setContentDescription("添加图片");
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new afmp(this));
      e();
      ...
      a(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.videoInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.videoInfo.d);
      ...
      this.jdField_f_of_type_AndroidWidgetTextView.setText(NearbyProfileUtil.d(j));
      ...
      {
        this.jdField_g_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.college);
        if (!TextUtils.equals(paramNearbyPeopleCard, this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.college)) {
          break label1235;
        }
        this.jdField_i_of_type_Int = ((Integer)NearbySPUtil.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.getCurrentAccountUin(), "school_valid_state", Integer.valueOf(0))).intValue();
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.godFlag)
      {
        ...
        paramNearbyPeopleCard.setPositiveButton(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getString(2131437553), new afmq(this, paramNearbyPeopleCard));
      ...
      while (j < 4)
      {
        this.jdField_a_of_type_ArrayOfComTencentMobileqqNearbyProfilecardSavorTagIcon[j].a(this.jdField_a_of_type_ArrayOfComTencentMobileqqNearbyInterestTagInterestTag[j].jdField_a_of_type_JavaUtilArrayList);
        this.jdField_a_of_type_ArrayOfComTencentMobileqqNearbyProfilecardSavorTagIcon[j].setOnClickListener(this);
        if (AppSetting.jdField_b_of_type_Boolean) {
          this.jdField_a_of_type_ArrayOfComTencentMobileqqNearbyProfilecardSavorTagIcon[j].setContentDescription(this.jdField_a_of_type_ArrayOfComTencentMobileqqNearbyProfilecardSavorTagIcon[j].a() + ",进入选择兴趣标签页面");
        }
        j += 1;
      }
      ...
      this.jdField_e_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getString(2131437474, new Object[] { this.jdField_a_of_type_JavaLangString }));
      break label292;
      label1149:
      this.jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable(new ColorDrawable(Color.parseColor("#D8D8D8")));
      ...
      break label369;
      label1201:
      this.jdField_f_of_type_AndroidWidgetTextView.setBackgroundResource(NearbyProfileUtil.b(j));
      this.jdField_f_of_type_AndroidWidgetTextView.setVisibility(0);
      break label629;
      label1223:
      ...
      for (;;)
      {
        ...
        NearbySPUtil.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.getCurrentAccountUin(), "school_valid_state", Integer.valueOf(this.jdField_i_of_type_Int));
        break;
        this.jdField_h_of_type_AndroidWidgetTextView.setVisibility(0);
    ...
    while (j < 3)
    {
      this.jdField_a_of_type_ArrayOfComTencentMobileqqNearbyProfilecardSavorTagImg[j].a(this.jdField_a_of_type_ArrayOfComTencentMobileqqNearbyInterestTagInterestTag[(j + 4)].jdField_a_of_type_JavaUtilArrayList);
      this.jdField_a_of_type_ArrayOfComTencentMobileqqNearbyProfilecardSavorTagImg[j].setOnClickListener(this);
      if (AppSetting.jdField_b_of_type_Boolean) {
        this.jdField_a_of_type_ArrayOfComTencentMobileqqNearbyProfilecardSavorTagImg[j].setContentDescription(this.jdField_a_of_type_ArrayOfComTencentMobileqqNearbyProfilecardSavorTagImg[j].a() + ",进入选择兴趣标签页面");
      }
      j += 1;
    }
    if ((this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.jdField_j_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.k == 1)) {
      this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.jdField_a_of_type_AndroidOsHandler.postDelayed(new afmr(this), 300L);
    }
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new afms(this));
    this.jdField_g_of_type_AndroidWidgetEditText.addTextChangedListener(new afmt(this));
    this.jdField_e_of_type_AndroidWidgetEditText.addTextChangedListener(new afmu(this));
    this.jdField_a_of_type_AndroidWidgetEditText.getViewTreeObserver().addOnGlobalLayoutListener(new afmv(this));
  }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    else
    {
      if (paramInt == 0)
      {
        if (TextUtils.equals(this.jdField_g_of_type_AndroidWidgetTextView.getText().toString(), paramString)) {
          if (this.jdField_i_of_type_Int == 2) {
            paramInt = j;
          }
        }
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.videoInfo.d = paramString2;
  ...
  public boolean a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard != null)
    {
      ...
      if (!StringUtil.c(this.jdField_g_of_type_AndroidWidgetTextView.getText().toString()).equals(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.college)) {
        return true;
      }
    ...
    for (int j = 1;; j = 3)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard != null) && (this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.gender == 0))
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard != null)
        {
          ...
          localObject = this.jdField_g_of_type_AndroidWidgetTextView.getText().toString();
        ...
        this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.a(new afni(this, (NearbyCardHandler)localObject, localBundle, localArrayList));
      }
      label1239:
      label1244:
      label1249:
  ...
  public void onClick(View paramView)
  {
    ...
    if ((paramView.getId() == 2131370671) || (paramView == this.jdField_b_of_type_AndroidWidgetEditText))
    {
      ...
      if (this.jdField_b_of_type_AndroidWidgetEditText.getTag() != null)
      {
        ...
        ((IphonePickerView)localObject2).setPickListener(new afmn(this, (IphonePickerView)localObject2, (ActionSheet)localObject1));
        ((ActionSheet)localObject1).a(new afmy(this));
    ...
    do
    {
      ...
      {
        paramView = this.jdField_g_of_type_AndroidWidgetTextView.getText().toString();
        paramView = URLUtil.a(URLUtil.a(URLUtil.a(URLUtil.a("https://qun.qq.com/qqweb/m/nearby/pages/school_edit.html", "_bid", "2473"), "_wv", "1031"), "schoolName", paramView), "isValid", String.valueOf(this.jdField_i_of_type_Int));
      ...
      if ((paramView.getId() != 2131370673) && (paramView != this.jdField_c_of_type_AndroidWidgetEditText)) {
        break;
      }
      localObject1 = ActionSheet.c(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity);
    ...
    for (j = 0;; j = (j & 0xFF) - 1)
    {
      ...
      ((IphonePickerView)localObject3).setPickListener(new afnm(this, (IphonePickerView)localObject3, (ActionSheet)localObject1));
      ...
      ((ActionSheet)localObject1).a(new afnn(this));
    ...
    {
      if (NearbyVideoUtils.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app)) {
        break label1024;
      }
      ...
      {
        NearbyVideoUtils.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, null, this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.videoInfo.d, this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.videoInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.uin, this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.e, true);
        j = 1;
      }
    }
    for (;;)
    {
      NearbyVideoUtils.a("clk_video_entry", new String[] { "" + j, this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.uin, "1" });
      return;
      NearbyVideoUtils.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, 2);
      j = 2;
      continue;
      j = 0;
      label845:
      if (j < 4) {
        if (paramView != this.jdField_a_of_type_ArrayOfComTencentMobileqqNearbyProfilecardSavorTagIcon[j]) {}
      }
      for (;;)
      {
        m = j;
        ...
        for (;;)
        {
          ...
          if (k < 3)
          {
            if (paramView == this.jdField_a_of_type_ArrayOfComTencentMobileqqNearbyProfilecardSavorTagImg[k]) {
              m = k + 4;
            }
          }
          else
          {
            ...
            paramView = this.jdField_a_of_type_ArrayOfComTencentMobileqqNearbyInterestTagInterestTag[m];
            ...
            paramView = jdField_a_of_type_ArrayOfJavaLangString[m];
            ThreadManager.getSubThreadHandler().post(new afno(this, paramView));
            return;
            j += 1;
            break label845;
          }
