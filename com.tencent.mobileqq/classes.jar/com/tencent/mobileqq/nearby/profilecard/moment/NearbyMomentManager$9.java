...
public class NearbyMomentManager$9
  implements Runnable
{
  public NearbyMomentManager$9(axyl paramaxyl, String paramString, int paramInt) {}
  
  public void run()
  {
    Iterator localIterator = axyl.a(this.this$0).iterator();
    while (localIterator.hasNext()) {
      ((axys)localIterator.next()).c(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int);
    }
  }
}
