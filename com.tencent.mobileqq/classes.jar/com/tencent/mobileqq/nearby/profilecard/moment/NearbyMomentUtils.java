...
public class NearbyMomentUtils
{
  ...
  public static String a(long paramLong)
  {
    ...
    if (l2 < 600000L) {
      return HardCodeUtil.a(2131707233);
    }
    if (l2 < 3600000L) {
      return l2 / 60L / 1000L + 1L + HardCodeUtil.a(2131707226);
    }
    if ((l2 < 21600000L) && (k == i)) {
      return l2 / 60L / 60L / 1000L + HardCodeUtil.a(2131707220);
    }
    if ((l2 < 86400000L) && (k == i))
    {
    ...
    {
      localSimpleDateFormat.applyPattern("HH:mm");
      return HardCodeUtil.a(2131707231) + localSimpleDateFormat.format(localCalendar.getTime());
    }
    if (m == j)
    {
