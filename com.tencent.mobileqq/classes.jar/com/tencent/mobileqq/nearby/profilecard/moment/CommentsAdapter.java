  ...
  extends BaseAdapter
{
  ...
  {
    int i = 0;
    TextView localTextView = (TextView)LayoutInflater.from(paramViewGroup.getContext()).inflate(2130970489, paramViewGroup, false);
    ...
    localTextView.setOnClickListener(new afov(this, paramViewGroup));
