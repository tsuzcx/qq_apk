  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    Object localObject2 = this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardMomentDataMomentFeedInfo.k;
    if (TextUtils.isEmpty((CharSequence)localObject2))
    {
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardMomentDataMomentFeedInfo.j;
    ...
    {
      ((ReportTask)localObject2).a(new String[] { localObject1, "", "", this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardMomentBaseMomentItemBuilder$MomentViewHolder.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardMomentDataMomentFeedInfo.c }).a();
