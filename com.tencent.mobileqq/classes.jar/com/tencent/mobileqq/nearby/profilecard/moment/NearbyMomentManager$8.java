...
public class NearbyMomentManager$8
  implements Runnable
{
  public NearbyMomentManager$8(aszm paramaszm, String paramString, int paramInt) {}
  
  public void run()
  {
    Iterator localIterator = aszm.a(this.this$0).iterator();
    while (localIterator.hasNext()) {
      ((aszt)localIterator.next()).b(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int);
    }
  }
}
