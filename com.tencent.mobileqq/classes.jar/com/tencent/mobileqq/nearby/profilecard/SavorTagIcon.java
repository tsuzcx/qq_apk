  ...
  implements View.OnClickListener
{
  ...
  protected void b()
  {
    ...
    this.b = getResources().getDimensionPixelSize(2131559110);
  ...
  protected void c()
  {
    ...
    if (i < j) {
      while (i < j)
      {
        localObject1 = LayoutInflater.from(getContext()).inflate(2130970442, null);
        localObject2 = a();
      ...
      else
      {
        ...
        catch (Exception localException1)
        {
          try
          {
            ...
            TextView localTextView = (TextView)((View)localObject1).findViewById(2131365229);
