  ...
  implements RedPointPrePostHandleObserver
{
  ...
  public LocalRedTouchManager a()
  {
    ...
    return (LocalRedTouchManager)this.jdField_a_of_type_MqqUtilWeakReference.get();
  }
  ...
  public void a(RedTouchItem paramRedTouchItem, int paramInt)
  {
    ...
    do
    {
      ...
      if (paramInt == 100601)
      {
        if (!Util.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {}
  ...
  public void a(List<RedTouchItem> paramList)
  {
    ...
    if ((paramList == null) || (localLocalRedTouchManager == null)) {
      return;
    }
    ...
    localObject2 = localLocalRedTouchManager.a(10016);
