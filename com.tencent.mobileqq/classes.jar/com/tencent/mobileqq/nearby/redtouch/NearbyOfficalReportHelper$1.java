...
public class NearbyOfficalReportHelper$1
  implements Runnable
{
  public NearbyOfficalReportHelper$1(avoe paramavoe, QQAppInterface paramQQAppInterface, String paramString1, String paramString2) {}
  ...
  public void run()
  {
    ...
    String str1;
    String str2;
    if (((avoi)localObject).b > 0)
    {
      str3 = String.valueOf(aush.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "self_gender", Integer.valueOf(-1)));
    ...
    {
      azmj.b(null, "dc00899", "grp_lbs", "", this.jdField_a_of_type_JavaLangString, this.b, 0, 0, str3, str1, str2, "");
