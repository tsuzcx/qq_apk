...
public class NearbyFragmentEnterAdapter$1
  implements Runnable
{
  public NearbyFragmentEnterAdapter$1(aszq paramaszq) {}
  
  public void run()
  {
    if (this.this$0.jdField_a_of_type_JavaUtilList != null)
    {
      aszu localaszu = this.this$0.a();
      if (localaszu != null)
      {
        Object localObject = this.this$0;
        ((aszq)localObject).b += 1;
        ...
        this.this$0.a(localaszu, (ilive_feeds_near_anchor.NearAnchorInfo)localObject);
      }
    }
