...
public class NearbyFragmentEnterAdapter$1
  implements Runnable
{
  public NearbyFragmentEnterAdapter$1(axoj paramaxoj) {}
  
  public void run()
  {
    if (this.this$0.jdField_a_of_type_JavaUtilList != null)
    {
      axoo localaxoo = this.this$0.a();
      if (localaxoo != null)
      {
        Object localObject = this.this$0;
        ((axoj)localObject).b += 1;
        ...
        this.this$0.a(localaxoo, (ilive_feeds_near_anchor.NearAnchorInfo)localObject);
      }
    }
