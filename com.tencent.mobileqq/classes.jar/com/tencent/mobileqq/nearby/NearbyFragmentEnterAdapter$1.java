...
public class NearbyFragmentEnterAdapter$1
  implements Runnable
{
  public NearbyFragmentEnterAdapter$1(aszo paramaszo) {}
  
  public void run()
  {
    if (this.this$0.jdField_a_of_type_JavaUtilList != null)
    {
      aszs localaszs = this.this$0.a();
      if (localaszs != null)
      {
        Object localObject = this.this$0;
        ((aszo)localObject).b += 1;
        ...
        this.this$0.a(localaszs, (ilive_feeds_near_anchor.NearAnchorInfo)localObject);
      }
    }
