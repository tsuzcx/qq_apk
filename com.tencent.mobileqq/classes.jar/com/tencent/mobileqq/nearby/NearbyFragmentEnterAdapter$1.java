...
public class NearbyFragmentEnterAdapter$1
  implements Runnable
{
  public NearbyFragmentEnterAdapter$1(awih paramawih) {}
  
  public void run()
  {
    if (this.this$0.jdField_a_of_type_JavaUtilList != null)
    {
      awim localawim = this.this$0.a();
      if (localawim != null)
      {
        Object localObject = this.this$0;
        ((awih)localObject).b += 1;
        ...
        this.this$0.a(localawim, (ilive_feeds_near_anchor.NearAnchorInfo)localObject);
      }
    }
