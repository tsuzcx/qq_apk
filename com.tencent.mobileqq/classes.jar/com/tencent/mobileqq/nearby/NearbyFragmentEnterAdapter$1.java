...
public class NearbyFragmentEnterAdapter$1
  implements Runnable
{
  public NearbyFragmentEnterAdapter$1(asdk paramasdk) {}
  
  public void run()
  {
    if (this.this$0.jdField_a_of_type_JavaUtilList != null)
    {
      asdo localasdo = this.this$0.a();
      if (localasdo != null)
      {
        Object localObject = this.this$0;
        ((asdk)localObject).b += 1;
        ...
        this.this$0.a(localasdo, (ilive_feeds_near_anchor.NearAnchorInfo)localObject);
      }
    }
