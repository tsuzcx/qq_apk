...
public class NearbyFragmentEnterAdapter$1
  implements Runnable
{
  public NearbyFragmentEnterAdapter$1(axva paramaxva) {}
  
  public void run()
  {
    if (this.this$0.jdField_a_of_type_JavaUtilList != null)
    {
      axve localaxve = this.this$0.a();
      if (localaxve != null)
      {
        Object localObject = this.this$0;
        ((axva)localObject).b += 1;
        ...
        this.this$0.a(localaxve, (ilive_feeds_near_anchor.NearAnchorInfo)localObject);
      }
    }
