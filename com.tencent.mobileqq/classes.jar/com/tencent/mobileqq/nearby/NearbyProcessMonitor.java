        ...
        try
        {
          ...
          if ((localObject1 instanceof QQAppInterface))
          {
            ...
            while (localObject1 != null)
            {
              ...
              {
                localObject2 = ((FriendsManager)((QQAppInterface)localObject4).getManager(QQManagerFactory.FRIENDS_MANAGER)).a(paramString);
                if (localObject2 != null)
                {
                  localObject4 = (NearbyCardManager)((QQAppInterface)localObject1).getManager(QQManagerFactory.NEARBY_CARD_MANAGER);
                  if (QLog.isColorLevel()) {
