...
public class NearbyVideoUtils
{
  ...
  private static String a(android.graphics.Bitmap paramBitmap)
  {
    ...
    //   6: dup
    //   7: getstatic 33	com/tencent/mobileqq/app/AppConstants:DYNAMIC_PROFILE	Ljava/lang/String;
    //   10: invokestatic 39	com/tencent/mobileqq/vfs/VFSAssistantUtils:getSDKPrivatePath	(Ljava/lang/String;)Ljava/lang/String;
    //   13: invokespecial 42	java/io/File:<init>	(Ljava/lang/String;)V
    //   16: astore_1
    //   17: aload_1
    //   18: invokevirtual 46	java/io/File:mkdirs	()Z
    //   21: pop
    //   22: new 28	java/io/File
    //   25: dup
    //   26: aload_1
    //   27: new 48	java/lang/StringBuilder
    //   30: dup
    ...
    //   39: invokestatic 61	java/lang/System:currentTimeMillis	()J
    ...
    //   48: invokespecial 71	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   51: astore 4
    //   53: aload 4
    //   55: invokevirtual 74	java/io/File:exists	()Z
    //   58: ifeq +9 -> 67
    //   61: aload 4
    //   63: invokevirtual 77	java/io/File:delete	()Z
    //   66: pop
    //   67: new 79	java/io/FileOutputStream
    //   70: dup
    //   71: aload 4
    //   73: invokespecial 82	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   76: astore_1
    //   77: new 84	java/io/BufferedOutputStream
    //   80: dup
    //   81: aload_1
    //   82: sipush 4096
    //   85: invokespecial 87	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;I)V
    //   88: astore 5
    //   90: aload 5
    //   92: astore_3
    //   93: aload_1
    //   94: astore_2
    //   95: aload_0
    //   96: getstatic 93	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   99: bipush 100
    //   101: aload 5
    //   103: invokevirtual 99	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   106: pop
    //   107: aload 5
    //   109: astore_3
    //   110: aload_1
    //   111: astore_2
    //   112: aload 5
    //   114: invokevirtual 102	java/io/BufferedOutputStream:flush	()V
    //   117: aload 5
    //   119: astore_3
    //   120: aload_1
    //   121: astore_2
    ...
    //   129: ifnull +7 -> 136
    //   132: aload_1
    //   133: invokevirtual 108	java/io/FileOutputStream:close	()V
    //   136: aload_0
    //   137: astore_1
    //   138: aload 5
    //   140: ifnull +10 -> 150
    //   143: aload 5
    //   145: invokevirtual 109	java/io/BufferedOutputStream:close	()V
    //   148: aload_0
    //   149: astore_1
    //   150: invokestatic 114	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   153: ifeq +28 -> 181
    //   156: ldc 116
    //   158: iconst_2
    //   159: new 48	java/lang/StringBuilder
    //   162: dup
    //   163: invokespecial 49	java/lang/StringBuilder:<init>	()V
    //   166: ldc 118
    ...
    //   175: invokevirtual 68	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   178: invokestatic 122	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   181: aload_1
    //   182: areturn
    //   183: astore_1
    //   184: aload_1
    //   185: invokevirtual 125	java/io/IOException:printStackTrace	()V
    //   188: goto -52 -> 136
    //   191: astore_1
    //   192: aload_1
    //   193: invokevirtual 125	java/io/IOException:printStackTrace	()V
    //   196: aload_0
    //   197: astore_1
    //   198: goto -48 -> 150
    //   201: astore 4
    ...
    //   209: aload_1
    //   210: astore_2
    //   211: invokestatic 114	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   214: ifeq +17 -> 231
    //   217: aload_0
    //   218: astore_3
    //   219: aload_1
    ...
    //   224: ldc 127
    //   226: aload 4
    //   228: invokestatic 131	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   231: aload_1
    //   232: ifnull +7 -> 239
    //   235: aload_1
    ...
    //   243: ifnull -93 -> 150
    //   246: aload_0
    //   247: invokevirtual 109	java/io/BufferedOutputStream:close	()V
    //   250: aload 6
    //   252: astore_1
    //   253: goto -103 -> 150
    //   256: astore_0
    //   257: aload_0
    //   258: invokevirtual 125	java/io/IOException:printStackTrace	()V
    //   261: aload 6
    //   263: astore_1
    //   264: goto -114 -> 150
    //   267: astore_1
    //   268: aload_1
    //   269: invokevirtual 125	java/io/IOException:printStackTrace	()V
    //   272: goto -33 -> 239
    //   275: astore_0
    //   276: aconst_null
    //   277: astore_3
    ...
    //   281: ifnull +7 -> 288
    //   284: aload_1
    //   285: invokevirtual 108	java/io/FileOutputStream:close	()V
    //   288: aload_3
    //   289: ifnull +7 -> 296
    //   292: aload_3
    //   293: invokevirtual 109	java/io/BufferedOutputStream:close	()V
    //   296: aload_0
    //   297: athrow
    //   298: astore_1
    //   299: aload_1
    //   300: invokevirtual 125	java/io/IOException:printStackTrace	()V
    //   303: goto -15 -> 288
    //   306: astore_1
    //   307: aload_1
    //   308: invokevirtual 125	java/io/IOException:printStackTrace	()V
    //   311: goto -15 -> 296
    //   314: astore_0
    //   315: aconst_null
    //   316: astore_3
  ...
  public static boolean a(Activity paramActivity, QQAppInterface paramQQAppInterface)
  {
    ...
    new NearbyCustomDialog(paramActivity).a(localImageView, localLayoutParams).b(HardCodeUtil.a(2131707405)).a(new BlueButtonInfo(HardCodeUtil.a(2131707407), new NearbyVideoUtils.1(paramActivity, paramQQAppInterface))).show();
