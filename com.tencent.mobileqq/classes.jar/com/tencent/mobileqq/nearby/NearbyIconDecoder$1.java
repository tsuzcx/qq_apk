...
public class NearbyIconDecoder$1
  implements Runnable
{
  public NearbyIconDecoder$1(awin paramawin, String paramString, Bitmap paramBitmap) {}
    ...
    try
    {
      ...
      if ((arrayOfString.length == 3) && (this.this$0.a != null))
      {
        ...
        while (localIterator.hasNext()) {
          ((bfqp)localIterator.next()).a(i, arrayOfString[1], j, this.jdField_a_of_type_AndroidGraphicsBitmap);
        }
      }
      return;
    }
