  ...
  implements Runnable
{
  ...
  public ItemLoader$DisplayItemRunnable(ItemLoader<Params, Result> paramItemLoader, avoq<Params, Result> paramavoq, boolean paramBoolean)
  {
  ...
  public void run()
  {
    ...
    {
      return;
      if (this.jdField_a_of_type_Avoq.c == null) {
        throw new IllegalStateException("Result should not be null when displaying an item part");
      }
      localView = (View)this.jdField_a_of_type_Avoq.b.get();
    } while (localView == null);
    Object localObject = this.jdField_a_of_type_Avoq.c.get();
    this.jdField_a_of_type_ComTencentMobileqqNearbySmoothItemLoader.a(localView, localObject, this.jdField_a_of_type_Avoq.a.intValue(), this.jdField_a_of_type_Boolean);
  }
}
