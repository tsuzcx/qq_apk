  ...
  public void a(int paramInt, oidb_0x8e4.RspBody paramRspBody)
  {
    ...
    for (String str1 = null;; str1 = null)
    {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          else
          {
            ...
            else if (paramInt == 1009)
            {
              ...
              this.jdField_a_of_type_ComTencentMobileqqNearbyGameroomGameRoomTransActivity.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setPositiveButton(HardCodeUtil.a(2131705160), new GameRoomTransActivity.3.1(this, paramRspBody));
              this.jdField_a_of_type_ComTencentMobileqqNearbyGameroomGameRoomTransActivity.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setNegativeButton(2131690601, new GameRoomTransActivity.3.2(this));
        ...
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqNearbyGameroomGameRoomTransActivity, 1, HardCodeUtil.a(2131705136), 1).a();
        this.jdField_a_of_type_ComTencentMobileqqNearbyGameroomGameRoomTransActivity.finish();
        return;
      }
    }
