  ...
  implements View.OnTouchListener
{
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqWerewolvesWerewolvesObserver = new aeak(this);
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new aeal(this);
  ...
  private void b()
  {
    ...
    for (;;)
    {
      ...
      localValueAnimator.addUpdateListener(new aeai(this, localLayoutParams, localValueAnimator));
      ...
      localValueAnimator.addUpdateListener(new aeaj(this, localLayoutParams, localValueAnimator));
      localValueAnimator.setDuration(200L);
      localValueAnimator.setTarget(this.jdField_a_of_type_AndroidWidgetTextView);
      localValueAnimator.start();
      return;
  ...
  public void a(int paramInt1, String paramString1, int paramInt2, long paramLong, String paramString2)
  {
    ...
    try
    {
      this.jdField_a_of_type_AndroidViewWindowManager.removeViewImmediate(this.jdField_a_of_type_AndroidWidgetTextView);
      label159:
      int i = this.jdField_a_of_type_AndroidViewWindowManager.getDefaultDisplay().getWidth();
      int j = this.jdField_a_of_type_AndroidViewWindowManager.getDefaultDisplay().getHeight();
      localObject = new WindowManager.LayoutParams(-2, -2, 2003, 776, -2);
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130840318);
      ...
      if (paramInt1 == 0) {
        this.jdField_a_of_type_AndroidWidgetTextView.setText("组队中");
      }
      for (;;)
      {
        this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new aeah(this, paramInt1, paramLong, paramString2, paramString1, paramInt2));
  ...
  public void a(HotChatInfo paramHotChatInfo, int paramInt, String paramString1, String paramString2)
  {
    try
    {
      ...
      ((EntityManager)localObject2).a(paramHotChatInfo);
      ((EntityManager)localObject2).a();
      localObject1 = (HotChatManager)((QQAppInterface)localObject1).getManager(59);
