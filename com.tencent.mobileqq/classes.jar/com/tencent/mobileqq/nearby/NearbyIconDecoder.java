  ...
  implements Handler.Callback, BitmapDecoder.IBitmapListener, IIconDecoder
{
  ...
  NearbyProcObserver jdField_a_of_type_ComTencentMobileqqNearbyIpcNearbyProcObserver = new adyu(this);
  ...
  public Bitmap a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localBitmap2 = BitmapManager.a(BaseApplicationImpl.getApplication().getResources(), 2130845327);
        localBitmap1 = localBitmap2;
      ...
      localBitmap1 = BitmapManager.a(BaseApplicationImpl.getApplication().getResources(), 2130845327);
      return localBitmap1;
      if (BaseApplicationImpl.sImageCache != null)
      {
        ...
        if (localBitmap2 == null)
        {
          localBitmap1 = BitmapManager.a(BaseApplicationImpl.getApplication().getResources(), 2130845328);
      ...
      {
        return BitmapManager.a(BaseApplicationImpl.getApplication().getResources(), 2130845328);
  ...
  protected void a(String paramString, Bitmap paramBitmap)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.runOnUiThread(new adyt(this, paramString, paramBitmap));
  }
