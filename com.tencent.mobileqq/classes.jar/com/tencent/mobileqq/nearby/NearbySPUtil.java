...
public class NearbySPUtil
{
  ...
  public static SosoLbsInfo a(String paramString)
  {
    try
    {
      ...
      if ((paramString.has("lat")) && (paramString.has("lon")))
      {
        ...
        localSosoLbsInfo.mLocation = new SosoLocation();
  ...
  static JSONObject a(JSONObject paramJSONObject1, JSONObject paramJSONObject2)
  {
  ...
  {
    return ((Boolean)a(paramString, BaseApplicationImpl.getApplication().getResources().getString(2131694978), Boolean.valueOf(false))).booleanValue();
  }
  ...
  {
    return a(paramString, BaseApplicationImpl.getApplication().getResources().getString(2131694978), Boolean.valueOf(paramBoolean));
  }
  ...
  public static boolean b(String paramString)
  {
    try
    {
      bool = ((Boolean)a(paramString, BaseApplicationImpl.getApplication().getResources().getString(2131694986), Boolean.valueOf(false))).booleanValue();
      if (QLog.isColorLevel()) {
  ...
  public static boolean b(String paramString, boolean paramBoolean)
  {
    try
    {
      String str = BaseApplicationImpl.getApplication().getResources().getString(2131694986);
