  ...
  implements Runnable
{
  ...
  public void run()
  {
    try
    {
      asfc.c(this.this$0.jdField_a_of_type_JavaLangString);
      ...
      localHashMap.put("param_DeviceType", ageh.a() + "");
      ...
      if ((l1 > 0L) && (l1 < 60000L) && (l2 > 0L) && (l2 < 60000L))
      {
        ...
        awrn.a(BaseApplicationImpl.getContext()).a(this.this$0.jdField_a_of_type_JavaLangString, "actEnterNearbyActCost", false, l2, l1, localHashMap, "");
      }
      while (QLog.isColorLevel())
      {
        asfl.a("NearbyProcessPerf", new Object[] { Integer.valueOf(this.this$0.jdField_a_of_type_Int), Long.valueOf(l1), Long.valueOf(l2), Long.valueOf(l3 - l4), Integer.valueOf(this.this$0.jdField_b_of_type_Int) });
        return;
        label261:
        if (this.this$0.jdField_a_of_type_Int == 1) {
          awrn.a(BaseApplicationImpl.getContext()).a(this.this$0.jdField_a_of_type_JavaLangString, "actEnterNearbyActCost", true, l2, l1, localHashMap, "");
        }
      }
      return;
    }
