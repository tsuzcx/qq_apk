  ...
  extends PopupWindow
{
  ...
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new aezo(this);
  ...
  public ShowTagNamePopupWindow(Context paramContext, int paramInt1, int paramInt2)
  {
    ...
    View localView = LayoutInflater.from(paramContext).inflate(2130969187, null);
  ...
  {
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131363834));
    ...
    RelativeLayout.LayoutParams localLayoutParams = (RelativeLayout.LayoutParams)paramView.findViewById(2131363731).getLayoutParams();
    ...
    for (;;)
    {
      ...
      setBackgroundDrawable(paramContext.getResources().getDrawable(2130846489));
      return;
