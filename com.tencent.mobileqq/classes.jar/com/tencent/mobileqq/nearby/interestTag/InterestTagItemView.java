  ...
  extends RelativeLayout
{
  ...
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new atfp(this);
  ...
  private void a(Context paramContext)
  {
    ...
    paramContext = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560859, this);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramContext.findViewById(2131368054));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramContext.findViewById(2131378538));
    this.b = ((ImageView)paramContext.findViewById(2131368036));
    setBackgroundResource(2130844241);
    int i = getResources().getColor(2131166211);
    findViewById(2131378806).setBackgroundColor(i);
  ...
  public void a()
  {
    boolean bool = this.jdField_a_of_type_Atfq.a(this.jdField_a_of_type_ComTencentMobileqqNearbyInterestTagInterestTagInfo);
    if ((!bool) && (this.jdField_a_of_type_Boolean == true)) {
      this.b.setImageResource(2130846209);
    }
    for (;;)
    {
      ...
      if ((bool == true) && (!this.jdField_a_of_type_Boolean)) {
        this.b.setImageResource(2130846210);
      }
    }
  }
  ...
  public void a(InterestTagInfo paramInterestTagInfo)
  {
    ...
    {
      localObject1 = getResources().getDrawable(2131165766);
    ...
    for (;;)
    {
      try
      {
        ...
        localObject3 = localObject4;
        localObject2 = URLDrawable.getDrawable(ayst.a(this.jdField_a_of_type_ComTencentMobileqqNearbyInterestTagInterestTagInfo.tagIconUrl), this.jdField_a_of_type_ComTencentImageURLDrawable$URLDrawableOptions);
        localObject3 = localObject2;
        if (this.jdField_a_of_type_Int != 7) {
          continue;
        }
        localObject3 = localObject2;
        ((URLDrawable)localObject2).setTag(bavw.b(j, i, (int)(10.0F * this.jdField_a_of_type_Float)));
        localObject3 = localObject2;
      ...
      catch (Exception localException)
      {
        ...
        localObject3 = localObject2;
        ((URLDrawable)localObject2).setTag(bavw.a(j, i));
        localObject3 = localObject2;
      ...
      setContentDescription(this.jdField_a_of_type_AndroidWidgetTextView.getText() + ajya.a(2131705806));
      return;
      if (this.jdField_a_of_type_Int == 7)
      {
        localObject1 = new GradientDrawable();
        ((GradientDrawable)localObject1).setColor(getResources().getColor(2131165766));
  ...
  public void setCallback(atfq paramatfq)
  {
