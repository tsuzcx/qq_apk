  ...
  extends TroopGiftPanel
{
  ...
  public void b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      for (int k = 1;; k = 0)
      {
        ((TroopGiftManager)localObject).a("OidbSvc.0x7f6", 2038, i, m, str, 2, j, l, n, k, localTroopGiftAioItemData.jdField_a_of_type_Int, 0, new aecp(this), localTroopGiftAioItemData.jdField_e_of_type_Int);
