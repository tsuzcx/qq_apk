...
final class NearbyUtils$1
  implements Runnable
{
  NearbyUtils$1(String paramString, int paramInt, QQAppInterface paramQQAppInterface) {}
  ...
  public void run()
  {
    ...
    try
    {
      ...
      localNewIntent.setObserver(new NearbyUtils.1.1(this));
