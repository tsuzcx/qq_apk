...
public class NearbySPUtil
{
  ...
  {
    return ((Boolean)a(paramString, BaseApplicationImpl.getApplication().getResources().getString(2131694968), Boolean.valueOf(false))).booleanValue();
  }
  ...
  public static boolean a(String paramString1, String paramString2, int paramInt, String paramString3, Object paramObject)
  {
    if (((!TextUtils.isEmpty(paramString1)) || (!TextUtils.isEmpty(paramString2))) && (!TextUtils.isEmpty(paramString3)) && (paramObject != null))
    {
      ...
      try
      {
        bool = a(a(paramString1, str, paramInt), paramString3, paramObject);
      }
  ...
  {
    return a(paramString, BaseApplicationImpl.getApplication().getResources().getString(2131694968), Boolean.valueOf(paramBoolean));
  }
  ...
  public static boolean b(String paramString)
  {
    ...
    try
    {
      bool = ((Boolean)a(paramString, BaseApplicationImpl.getApplication().getResources().getString(2131694976), Boolean.valueOf(false))).booleanValue();
    }
    catch (Throwable localThrowable)
    {
      if (QLog.isColorLevel()) {
  ...
  public static boolean b(String paramString, boolean paramBoolean)
  {
    ...
    try
    {
      String str = BaseApplicationImpl.getApplication().getResources().getString(2131694976);
