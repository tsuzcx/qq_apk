...
public class NearbyPublishMenuHelper
{
  ...
  public static String a(String paramString)
  {
    ...
    //   43: invokevirtual 29	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   46: astore 7
    //   48: aload 5
    //   50: astore 4
    //   52: aload 6
    //   54: astore_3
    //   55: new 46	java/io/File
    //   58: dup
    //   59: invokestatic 52	com/tencent/common/app/BaseApplicationImpl:getApplication	()Lcom/tencent/common/app/BaseApplicationImpl;
    //   62: invokevirtual 56	com/tencent/common/app/BaseApplicationImpl:getFilesDir	()Ljava/io/File;
    //   65: aload 7
    //   67: invokespecial 59	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   70: astore_0
    //   71: aload 5
    //   73: astore 4
    //   75: aload 6
    //   77: astore_3
    //   78: aload_0
    //   79: invokevirtual 63	java/io/File:isFile	()Z
    //   82: ifeq +19 -> 101
    //   85: aload 5
    //   87: astore 4
    //   89: aload 6
    //   91: astore_3
    //   92: aload_0
    //   93: invokevirtual 66	java/io/File:length	()J
    //   96: lconst_0
    //   97: lcmp
    //   98: ifne +60 -> 158
    //   101: aload 5
    ...
    //   108: ldc 68
    //   110: iconst_1
    //   111: new 13	java/lang/StringBuilder
    //   114: dup
    //   115: invokespecial 14	java/lang/StringBuilder:<init>	()V
    //   118: ldc 70
    //   120: invokevirtual 24	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   123: aload_0
    //   124: invokevirtual 73	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   127: invokevirtual 24	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   130: invokevirtual 29	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   133: invokestatic 79	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   136: ldc 81
    //   138: astore_3
    //   139: aload_3
    //   140: astore_0
    //   141: iconst_0
    //   142: ifeq +11 -> 153
    //   145: new 83	java/lang/NullPointerException
    //   148: dup
    //   149: invokespecial 84	java/lang/NullPointerException:<init>	()V
    //   152: athrow
    //   153: ldc 2
    //   155: monitorexit
    //   156: aload_0
    ...
    //   162: aload 6
    //   164: astore_3
    //   165: invokestatic 52	com/tencent/common/app/BaseApplicationImpl:getApplication	()Lcom/tencent/common/app/BaseApplicationImpl;
    //   168: aload 7
    //   170: invokevirtual 88	com/tencent/common/app/BaseApplicationImpl:openFileInput	(Ljava/lang/String;)Ljava/io/FileInputStream;
    //   173: astore 5
    //   175: aload 5
    //   177: astore 4
    //   179: aload 5
    //   181: astore_3
    //   182: aload_0
    //   183: invokevirtual 66	java/io/File:length	()J
    //   186: l2i
    //   187: newarray byte
    //   189: astore_0
    //   190: aload 5
    ...
    //   197: aload 5
    //   199: aload_0
    //   200: invokevirtual 94	java/io/FileInputStream:read	([B)I
    //   203: pop
    //   204: aload 5
    //   206: astore 4
    //   208: aload 5
    ...
    //   211: ldc 68
    //   213: iconst_1
    //   214: new 13	java/lang/StringBuilder
    //   217: dup
    //   218: invokespecial 14	java/lang/StringBuilder:<init>	()V
    //   221: ldc 96
    //   223: invokevirtual 24	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   226: invokestatic 42	java/lang/System:currentTimeMillis	()J
    //   229: lload_1
    //   230: lsub
    //   231: invokevirtual 99	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   234: ldc 101
    //   236: invokevirtual 24	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   239: aload_0
    //   240: arraylength
    //   241: invokevirtual 104	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   244: invokevirtual 29	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   247: invokestatic 79	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   250: aload 5
    //   252: astore 4
    //   254: aload 5
    //   256: astore_3
    ...
    //   260: dup
    //   261: aload_0
    //   262: invokespecial 109	java/lang/String:<init>	([B)V
    //   265: astore 6
    //   267: aload 6
    //   269: astore_0
    //   270: aload 5
    //   272: ifnull -119 -> 153
    //   275: aload 5
    //   277: invokevirtual 112	java/io/FileInputStream:close	()V
    //   280: aload 6
    //   282: astore_0
    //   283: goto -130 -> 153
    //   286: astore_0
    ...
    //   297: ldc 68
    //   299: iconst_1
    //   300: new 13	java/lang/StringBuilder
    //   303: dup
    //   304: invokespecial 14	java/lang/StringBuilder:<init>	()V
    //   307: ldc 114
    //   309: invokevirtual 24	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   312: aload_0
    //   313: invokevirtual 115	java/lang/Exception:toString	()Ljava/lang/String;
    //   316: invokevirtual 24	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   319: invokevirtual 29	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   322: invokestatic 118	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   325: aload 4
    //   327: ifnull +8 -> 335
    //   330: aload 4
    //   332: invokevirtual 112	java/io/FileInputStream:close	()V
    //   335: ldc 81
    //   337: astore_0
    //   338: goto -185 -> 153
    //   341: astore_0
    ...
    //   343: ifnull +7 -> 350
    //   346: aload_3
    //   347: invokevirtual 112	java/io/FileInputStream:close	()V
    //   350: aload_0
    //   351: athrow
    //   352: astore_0
    //   353: ldc 2
  ...
  public static ArrayList<NearbyPublishMenu.MenuItem> a()
  {
    ...
    Object localObject2 = (String)NearbySPUtil.a(((AppRuntime)localObject1).getAccount(), "key_nearby_publish_menu", "");
    if (!TextUtils.isEmpty((String)NearbySPUtil.a(((AppRuntime)localObject1).getAccount(), "cike_guide_content", ""))) {}
      ...
      for (;;)
      {
        try
        {
          ...
          if (i < ((JSONArray)localObject1).length())
          {
            ...
            NearbyPublishMenu.MenuItem localMenuItem2 = new NearbyPublishMenu.MenuItem();
        ...
        catch (Exception localException)
        {
          ...
          {
            NearbyPublishMenu.MenuItem localMenuItem1 = new NearbyPublishMenu.MenuItem();
            localMenuItem1.jdField_a_of_type_Int = 1;
            localMenuItem1.jdField_b_of_type_Int = 2130841520;
            localMenuItem1.jdField_b_of_type_JavaLangString = HardCodeUtil.a(2131707387);
            localArrayList.add(localMenuItem1);
            localMenuItem1 = new NearbyPublishMenu.MenuItem();
            localMenuItem1.jdField_a_of_type_Int = 2;
            localMenuItem1.jdField_b_of_type_Int = 2130841519;
            localMenuItem1.jdField_b_of_type_JavaLangString = HardCodeUtil.a(2131707388);
            localArrayList.add(localMenuItem1);
          }
  ...
  public static void a(Context paramContext, NearbyPublishMenu.MenuItem paramMenuItem, String paramString)
  {
    if (QLog.isColorLevel()) {
      QLog.d("NearbyPublishMenuHelper", 2, "handleMenuItemClick：id=" + paramMenuItem.jdField_a_of_type_Int);
    }
  ...
  protected static void b(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      {
        QQToast.a(paramContext, 2131718859, 0).a();
        if (QLog.isColorLevel()) {
      ...
      {
        String str = VFSAssistantUtils.getSDKPrivatePath(AppConstants.SDCARD_PATH + "photo/" + System.currentTimeMillis() + ".jpg");
        ...
        for (localObject1 = (AppActivity)paramContext;; localObject2 = null)
        {
          ...
          if ((Build.VERSION.SDK_INT >= 23) && (((AppActivity)localObject1).checkSelfPermission("android.permission.CAMERA") != 0))
          {
            ...
            ((AppActivity)localObject1).requestPermissions(new NearbyPublishMenuHelper.1(paramContext, str, (AppActivity)localObject1, localIntent), 1, new String[] { "android.permission.CAMERA" });
          }
          for (int i = 1;; i = 0) {
            for (;;)
            {
              ...
              catch (Exception localException)
              {
                ...
                QQToast.a(paramContext, 2131690797, 0).a();
                return;
              }
            }
          }
  ...
  {
    QQProgressDialog localQQProgressDialog = new QQProgressDialog(paramContext, paramContext.getResources().getDimensionPixelSize(2131299166));
    localQQProgressDialog.c(2131693940);
  ...
  public static void b(String paramString1, String paramString2)
  {
    ...
    //   33: invokevirtual 29	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   36: astore_0
    //   37: aload 7
    //   39: astore 5
    //   41: aload 6
    //   43: astore 4
    //   45: aload_1
    //   46: invokestatic 166	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   49: ifeq +35 -> 84
    //   52: aload 7
    //   54: astore 5
    //   56: aload 6
    //   58: astore 4
    //   60: invokestatic 52	com/tencent/common/app/BaseApplicationImpl:getApplication	()Lcom/tencent/common/app/BaseApplicationImpl;
    //   63: aload_0
    //   64: invokevirtual 571	com/tencent/common/app/BaseApplicationImpl:deleteFile	(Ljava/lang/String;)Z
    //   67: pop
    //   68: iconst_0
    //   69: ifeq +11 -> 80
    //   72: new 83	java/lang/NullPointerException
    //   75: dup
    //   76: invokespecial 84	java/lang/NullPointerException:<init>	()V
    //   79: athrow
    //   80: ldc 2
    //   82: monitorexit
    //   83: return
    ...
    //   88: aload 6
    //   90: astore 4
    //   92: invokestatic 42	java/lang/System:currentTimeMillis	()J
    //   95: lstore_2
    //   96: aload 7
    //   98: astore 5
    //   100: aload 6
    //   102: astore 4
    //   104: invokestatic 52	com/tencent/common/app/BaseApplicationImpl:getApplication	()Lcom/tencent/common/app/BaseApplicationImpl;
    //   107: aload_0
    //   108: iconst_0
    //   109: invokevirtual 575	com/tencent/common/app/BaseApplicationImpl:openFileOutput	(Ljava/lang/String;I)Ljava/io/FileOutputStream;
    //   112: astore_0
    //   113: aload_0
    //   114: astore 5
    //   116: aload_0
    ...
    //   119: aload_0
    //   120: aload_1
    //   121: invokevirtual 579	java/lang/String:getBytes	()[B
    //   124: invokevirtual 584	java/io/FileOutputStream:write	([B)V
    //   127: aload_0
    //   128: astore 5
    //   130: aload_0
    //   131: astore 4
    //   133: aload_0
    //   134: invokevirtual 587	java/io/FileOutputStream:flush	()V
    //   137: aload_0
    //   138: astore 5
    //   140: aload_0
    //   141: astore 4
    //   143: ldc 68
    //   145: iconst_1
    //   146: new 13	java/lang/StringBuilder
    //   149: dup
    //   150: invokespecial 14	java/lang/StringBuilder:<init>	()V
    //   153: ldc_w 589
    //   156: invokevirtual 24	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   159: invokestatic 42	java/lang/System:currentTimeMillis	()J
    //   162: lload_2
    //   163: lsub
    //   164: invokevirtual 99	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   167: ldc 101
    //   169: invokevirtual 24	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   172: aload_1
    //   173: invokevirtual 590	java/lang/String:length	()I
    //   176: invokevirtual 104	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   179: invokevirtual 29	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   182: invokestatic 79	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   185: aload_0
    //   186: ifnull -106 -> 80
    //   189: aload_0
    //   190: invokevirtual 591	java/io/FileOutputStream:close	()V
    //   193: goto -113 -> 80
    //   196: astore_0
    //   197: goto -117 -> 80
    //   200: astore_0
    ...
    //   205: ldc 68
    //   207: iconst_1
    //   208: new 13	java/lang/StringBuilder
    //   211: dup
    //   212: invokespecial 14	java/lang/StringBuilder:<init>	()V
    //   215: ldc_w 593
    //   218: invokevirtual 24	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   221: aload_0
    //   222: invokevirtual 115	java/lang/Exception:toString	()Ljava/lang/String;
    //   225: invokevirtual 24	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   228: invokevirtual 29	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   231: invokestatic 118	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   234: aload 5
    //   236: ifnull -156 -> 80
    //   239: aload 5
    //   241: invokevirtual 591	java/io/FileOutputStream:close	()V
    //   244: goto -164 -> 80
    //   247: astore_0
    //   248: goto -168 -> 80
    //   251: astore_0
    ...
    //   254: ifnull +8 -> 262
    //   257: aload 4
    //   259: invokevirtual 591	java/io/FileOutputStream:close	()V
    //   262: aload_0
    //   263: athrow
    //   264: astore_0
    //   265: ldc 2
