  ...
  extends PagerAdapter
{
  ...
  {
    paramObject = (aytr)((View)paramObject).getTag(2131378397);
    int i = 0;
  ...
  public Object instantiateItem(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    do
    {
      do
      {
        ...
        localView.setTag(2131378397, new aytr(this.jdField_a_of_type_ComTencentMobileqqNearbyWidgetAvatarWallPagerAdapter, this.jdField_a_of_type_ComTencentMobileqqNearbyWidgetAvatarWallPagerAdapter.jdField_a_of_type_JavaUtilList.get(paramInt)));
        if (paramViewGroup != null)
        {
          paramViewGroup.addView(localView);
          return localView;
