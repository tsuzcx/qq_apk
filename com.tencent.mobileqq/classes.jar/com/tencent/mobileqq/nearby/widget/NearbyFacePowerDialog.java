  ...
  extends Dialog
{
  ...
  public NearbyFacePowerDialog(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new aezl(this);
    a();
  }
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_AndroidViewView = findViewById(2131365212);
    ...
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131364034));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)findViewById(2131365215));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131363154));
