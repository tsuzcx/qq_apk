  ...
  extends RelativeLayout
{
  ...
  public AvatarWallViewPager(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new aezh(this, Looper.getMainLooper());
  ...
  protected View a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      if (this.jdField_b_of_type_AndroidGraphicsDrawableDrawable == null) {
        this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = TroopUtils.a(getResources(), Color.parseColor("#CC12B7F5"), getResources().getDrawable(2130841277));
      }
    ...
    for (Drawable localDrawable = this.jdField_b_of_type_AndroidGraphicsDrawableDrawable;; localDrawable = this.jdField_a_of_type_AndroidGraphicsDrawableDrawable)
    {
      ...
      this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = TroopUtils.a(getResources(), Color.parseColor("#66FFFFFF"), getResources().getDrawable(2130841277));
      break;
    }
  }
  ...
  protected void c()
  {
    ...
    new aezi(this, this.jdField_a_of_type_AndroidContentContext, new LinearInterpolator()).a();
  }
  ...
  public void setScrollInterpolator(Interpolator paramInterpolator)
  {
    if (paramInterpolator != null) {
      new aezi(this, this.jdField_a_of_type_AndroidContentContext, paramInterpolator).a();
    }
  }
}
