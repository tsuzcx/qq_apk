...
public class NearbyRecommenderUtils
{
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (a(paramQQAppInterface))
    {
      ...
      if (i <= Math.abs(l3 - l1) / 1000L)
      {
        ...
        localObject = paramQQAppInterface.b(AppConstants.LBS_HELLO_UIN, 1001).iterator();
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("NearbyRecommenderUtils", 2, "-----addGrayTipsMessage  frienduin:" + paramString1 + " istroop：" + paramInt + " msg:" + MessageRecordUtil.a(paramString3));
    }
    long l = MessageCache.a();
  ...
  {
    paramQQAppInterface = paramQQAppInterface.getMessageFacade().b(AppConstants.LBS_HELLO_UIN, 1001);
