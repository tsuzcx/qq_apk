...
public class SecurityUtil
{
  ...
  public static long crc64Long(byte[] paramArrayOfByte)
  {
    long l = -1L;
    int i = 0;
  ...
  public static String encrypt(File paramFile)
  {
    return encrypt(paramFile, "MD5");
  }
  
  /* Error */
  public static String encrypt(File paramFile, String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 4
    ...
    //   17: ifeq +13 -> 30
    //   20: aload_0
    //   21: invokevirtual 70	java/io/File:isFile	()Z
    //   24: ifne +8 -> 32
    //   27: aload 4
    //   29: astore_3
    //   30: aload_3
    //   31: areturn
    //   32: aload_1
    //   33: invokestatic 76	java/security/MessageDigest:getInstance	(Ljava/lang/String;)Ljava/security/MessageDigest;
    //   36: astore_1
    //   37: new 78	java/io/FileInputStream
    //   40: dup
    //   41: aload_0
    //   42: invokespecial 81	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   45: astore_0
    //   46: sipush 1024
    //   49: newarray byte
    //   51: astore_3
    //   52: aload_0
    //   53: aload_3
    //   54: invokevirtual 85	java/io/FileInputStream:read	([B)I
    //   57: istore_2
    //   58: iload_2
    //   59: ifle +30 -> 89
    //   62: aload_1
    ...
    //   64: iconst_0
    //   65: iload_2
    //   66: invokevirtual 89	java/security/MessageDigest:update	([BII)V
    //   69: goto -17 -> 52
    //   72: astore_1
    //   73: aload 4
    //   75: astore_3
    ...
    //   77: ifnull -47 -> 30
    //   80: aload_0
    //   81: invokevirtual 92	java/io/FileInputStream:close	()V
    //   84: aconst_null
    //   85: areturn
    //   86: astore_0
    //   87: aconst_null
    //   88: areturn
    //   89: aload_1
    //   90: invokevirtual 96	java/security/MessageDigest:digest	()[B
    //   93: invokestatic 98	com/tencent/mobileqq/qcircle/api/db/util/SecurityUtil:bytes2HexStr	([B)Ljava/lang/String;
    //   96: astore_1
    //   97: aload_1
    //   98: astore_3
    //   99: aload_0
    ...
    //   119: ifnull -89 -> 30
    //   122: aload_0
    //   123: invokevirtual 92	java/io/FileInputStream:close	()V
    //   126: aconst_null
    //   127: areturn
    //   128: astore_0
    //   129: aconst_null
    ...
    //   135: ifnull +7 -> 142
    //   138: aload_0
    //   139: invokevirtual 92	java/io/FileInputStream:close	()V
    //   142: aload_1
    //   143: athrow
    //   144: astore_0
    //   145: goto -3 -> 142
