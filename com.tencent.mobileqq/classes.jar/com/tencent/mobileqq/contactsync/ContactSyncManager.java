  ...
  implements Manager
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new abmj(this, ThreadManager.getSubThreadLooper());
  public QQAppInterface a;
  private ContactBindObserver jdField_a_of_type_ComTencentMobileqqPhonecontactContactBindObserver = new abmg(this);
  private Runnable jdField_a_of_type_JavaLangRunnable = new abmi(this);
  ...
  private List a()
  {
    ...
    //   25: invokestatic 230	abmo:a	(Ljava/lang/String;)Landroid/net/Uri;
    //   28: getstatic 233	abmo:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   31: aconst_null
    //   32: aconst_null
    //   33: aconst_null
  ...
  private void a(List paramList, PhoneContact paramPhoneContact, long paramLong)
  {
    ...
    //   21: astore_1
    //   22: aload_1
    //   23: getstatic 532	abmm:jdField_a_of_type_AndroidNetUri	Landroid/net/Uri;
    //   26: getstatic 533	abmm:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   29: ldc_w 535
    //   32: iconst_1
    ...
    //   138: aload 5
    //   140: astore_1
    //   141: getstatic 532	abmm:jdField_a_of_type_AndroidNetUri	Landroid/net/Uri;
    //   144: lload_3
  ...
  private Map b()
  {
    ...
    //   18: astore_1
    //   19: aload_2
    //   20: getstatic 683	abmn:jdField_a_of_type_AndroidNetUri	Landroid/net/Uri;
    //   23: getstatic 684	abmn:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   26: aconst_null
    //   27: aconst_null
    //   28: aconst_null
  ...
  private void b()
  {
    ...
    if (arrayOfAccount.length > 0)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(new abmk(this, arrayOfAccount));
    }
  }
  ...
  private void c()
  {
    ...
    //   147: dup
    //   148: aload_0
    //   149: invokespecial 729	abml:<init>	(Lcom/tencent/mobileqq/contactsync/ContactSyncManager;)V
    //   152: aconst_null
  ...
  public SimplePhoneContact a(Uri paramUri)
  {
    ...
    //   218: astore 7
    //   220: aload 6
    //   222: getstatic 532	abmm:jdField_a_of_type_AndroidNetUri	Landroid/net/Uri;
    //   225: getstatic 533	abmm:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   228: ldc_w 535
    //   231: iconst_1
    ...
    //   319: getstatic 882	abmo:b	[Ljava/lang/String;
    //   322: ldc_w 884
    //   325: iconst_1
  ...
  public void a(String paramString)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getContentResolver().delete(abmo.a(c()), "sourceid=?", new String[] { paramString });
  }
  ...
  public String b(GetOnlineInfoResp paramGetOnlineInfoResp)
  {
    ...
    while (i != 0)
    {
      return String.format(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext().getResources().getString(2131437020), new Object[] { str1, paramGetOnlineInfoResp });
      str1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext().getString(2131437027);
      paramGetOnlineInfoResp = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext().getString(2131437030);
      i = 1;
      continue;
      str1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext().getString(2131437027);
      paramGetOnlineInfoResp = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext().getString(2131437031);
      i = 1;
      continue;
      str1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext().getString(2131437027);
      paramGetOnlineInfoResp = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext().getString(2131437032);
      i = 1;
      continue;
      str1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext().getString(2131437029);
      paramGetOnlineInfoResp = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext().getString(2131437033);
      i = 1;
    }
  }
  ...
  public boolean b()
  {
    ...
    BaseApplicationImpl.sUiHandler.removeCallbacks(this.jdField_a_of_type_JavaLangRunnable);
    if (!this.jdField_c_of_type_Boolean) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(new abmh(this));
    }
    for (;;)
    {
      return true;
