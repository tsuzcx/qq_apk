...
public class ReportUtil
{
  ...
  private static int a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    //   1: astore_3
    //   2: aload_0
    //   3: invokevirtual 19	com/tencent/mobileqq/app/QQAppInterface:getApp	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   6: invokevirtual 25	com/tencent/qphone/base/util/BaseApplication:getContentResolver	()Landroid/content/ContentResolver;
    //   9: astore_0
    //   10: getstatic 31	android/provider/ContactsContract$RawContacts:CONTENT_URI	Landroid/net/Uri;
    //   13: astore 4
    //   15: iload_1
    //   16: invokestatic 37	java/lang/Integer:toString	(I)Ljava/lang/String;
    //   19: astore 5
    //   21: aload_0
    //   22: aload 4
    //   24: iconst_1
    ...
    //   43: aastore
    //   44: aconst_null
    //   45: invokevirtual 49	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   48: astore_0
    //   49: aload_0
    //   50: ifnull +26 -> 76
    //   53: aload_0
    ...
    //   84: iconst_m1
    //   85: istore_2
    //   86: invokestatic 64	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   89: ifeq +12 -> 101
    //   92: ldc 66
    //   94: iconst_2
    //   95: ldc 68
    //   97: aload_3
    //   98: invokestatic 72	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   101: aload_0
    //   102: ifnull -28 -> 74
    //   105: aload_0
 ...
 * Qualified Name:     com.tencent.mobileqq.contactsync.ReportUtil
