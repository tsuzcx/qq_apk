...
public class RequestHelper
  implements Image2Video.Image2VideoListener, BaseRequestHelper
{
  ...
  private YUV2Video jdField_a_of_type_ComTencentMobileqqIdentificationYUV2Video;
  ...
  private String a(faceproto.Request paramRequest, File paramFile)
  {
    ...
    //   3: dup
    //   4: getstatic 50	com/tencent/mobileqq/identification/RequestHelper:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   106: aload_1
    //   107: arraylength
    //   108: invokestatic 233	com/tencent/mobileqq/util/Utils:a	(I)[B
    ...
    //   128: l2i
    //   129: invokestatic 233	com/tencent/mobileqq/util/Utils:a	(I)[B
    ...
    //   223: aload 4
    //   225: invokestatic 253	com/tencent/mobileqq/util/Utils:a	(Ljava/io/Closeable;)V
    //   228: aload_1
    //   229: invokestatic 253	com/tencent/mobileqq/util/Utils:a	(Ljava/io/Closeable;)V
    //   232: aconst_null
    //   233: areturn
    //   234: aload 7
    //   236: astore 6
    ...
    //   262: aload 4
    //   264: invokestatic 253	com/tencent/mobileqq/util/Utils:a	(Ljava/io/Closeable;)V
    //   267: aload 7
    //   269: invokestatic 253	com/tencent/mobileqq/util/Utils:a	(Ljava/io/Closeable;)V
    //   272: aload 8
    ...
    //   302: aload 4
    //   304: invokestatic 253	com/tencent/mobileqq/util/Utils:a	(Ljava/io/Closeable;)V
    //   307: aload_1
    //   308: invokestatic 253	com/tencent/mobileqq/util/Utils:a	(Ljava/io/Closeable;)V
    //   311: aconst_null
    //   312: areturn
    //   313: astore_1
    //   314: aconst_null
    ...
    //   318: astore 4
    //   320: aload 4
    //   322: invokestatic 253	com/tencent/mobileqq/util/Utils:a	(Ljava/io/Closeable;)V
    //   325: aload 6
    //   327: invokestatic 253	com/tencent/mobileqq/util/Utils:a	(Ljava/io/Closeable;)V
    //   330: aload_1
    //   331: athrow
    //   332: astore_1
    //   333: aconst_null
  ...
  public void a()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqIdentificationYUV2Video != null) {
      this.jdField_a_of_type_ComTencentMobileqqIdentificationYUV2Video.a();
    }
  }
  ...
  public void a(ResultInfo paramResultInfo)
  {
    ...
    {
      paramResultInfo = new File(paramResultInfo.jdField_b_of_type_JavaLangString);
      Object localObject = a(paramResultInfo, this.jdField_d_of_type_Int);
      if (localObject != null)
      {
        paramResultInfo = a((faceproto.Request)localObject, paramResultInfo);
        if (paramResultInfo == null)
        {
          this.jdField_a_of_type_ComTencentMobileqqIdentificationRequestHelper$RequestListener.a(2, a(211, HardCodeUtil.a(2131713374), false));
          return;
        }
        localObject = MD5.getFileMd5(paramResultInfo);
        Bundle localBundle = new Bundle();
        localBundle.putString("filePath", paramResultInfo);
        ...
        QIPCClientHelper.getInstance().callServer("IdentificationIpcServer_Model", "action_upload", localBundle, new RequestHelper.1(this));
        return;
      }
      this.jdField_a_of_type_ComTencentMobileqqIdentificationRequestHelper$RequestListener.a(2, null);
      return;
    }
    this.jdField_a_of_type_ComTencentMobileqqIdentificationRequestHelper$RequestListener.a(2, a(213, HardCodeUtil.a(2131713372), false));
    QLog.e("RequestHelper", 1, "encode video failed: " + paramResultInfo.jdField_a_of_type_Int);
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes8.jar
 * Qualified Name:     com.tencent.mobileqq.identification.RequestHelper
