...
public class DraftTextManager
{
  ...
  public void a(QQAppInterface paramQQAppInterface, DraftTextInfo paramDraftTextInfo)
  {
    ...
    //   89: aload_1
    //   90: aload_2
    //   91: invokespecial 242	aeni:<init>	(Lcom/tencent/mobileqq/managers/DraftTextManager;Lcom/tencent/mobileqq/app/QQAppInterface;Lcom/tencent/mobileqq/data/DraftTextInfo;)V
    //   94: bipush 8
    //   96: aconst_null
    //   97: iconst_0
  ...
  public boolean a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      b.remove(str);
      ThreadManager.post(new aenj(this, localDraftTextInfo, paramQQAppInterface, paramString, paramInt), 8, null, false);
      return false;
    }
  }
