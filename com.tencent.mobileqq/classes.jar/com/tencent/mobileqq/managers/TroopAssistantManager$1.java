...
public class TroopAssistantManager$1
  implements Runnable
{
  public TroopAssistantManager$1(avnu paramavnu, QQAppInterface paramQQAppInterface) {}
  ...
  public void run()
  {
    ...
    if (localObject1 != null) {
      bfza.a(this.a.getApp().getSharedPreferences(this.a.getAccount(), 0).edit(), "troop_assis_new_unread_list", (Object[])localObject1).commit();
    }
  }
}
