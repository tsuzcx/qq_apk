  ...
  implements Handler.Callback, Manager
{
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        for (int i = 1;; i = 0)
        {
          ...
          localObject = AppUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp());
          if (localObject != null)
          {
            ...
            } while (!"com.tencent.tim".equals(((PackageInfo)((Iterator)localObject).next()).packageName));
          }
          for (i = 1;; i = 0)
          {
            if (i == 0)
  ...
  private void b()
  {
    ...
    str6 = ((SharedPreferences)localObject1).getString("tim_login_c", "回到TIM，享受更简洁的沟通和丰富的办公功能，支持多人同时编辑腾讯文档，让工作更轻松。");
    localObject2 = str2;
    try
    {
    ...
    DialogUtil.a(BaseActivity.sTopActivity, 230, str5, str6, (String)localObject3, (String)localObject1, new adrw(this), new adrx(this)).show();
  ...
  public void a(Bundle paramBundle)
  {
    ...
    {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 1, 2131439104, 0).a();
      if (QLog.isColorLevel()) {
        QLog.d(jdField_a_of_type_JavaLangString, 2, "jumpTimLogin tim not install ");
      }
      return;
    }
    String str = PackageUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "com.tencent.tim");
    int i = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getSharedPreferences("tim_convert_teamwork_pre_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), 0).getInt("tim_convert_teamwork_tim_version", -1);
    if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      {
        localQQProgressDialog = new QQProgressDialog(BaseActivity.sTopActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getResources().getDimensionPixelOffset(2131558448));
        localQQProgressDialog.a("正在加载，请稍候...");
        ...
        localWtloginHelper.SetListener(new adry(this, localQQProgressDialog, localWtloginHelper, paramBundle));
        paramBundle = util.getPkgSigFromApkName(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "com.tencent.tim");
        i = localWtloginHelper.GetA1WithA1(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), 16L, 16L, "com.tencent.tim".getBytes(), 1L, 16L, 16L, "7.6.0".getBytes(), paramBundle, new WUserSigInfo(), new WFastLoginInfo());
      }
      if (i == -1001) {
        break;
      }
      ...
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 1, 2131439106, 0).a();
      return;
    } while (j >= i);
    QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 1, 2131439105, 0).a();
  }
