  ...
  implements Manager
{
  ...
  {
    Object localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().a(paramSessionInfo.jdField_a_of_type_JavaLangString, paramSessionInfo.jdField_a_of_type_Int);
  ...
  private void a(SessionInfo paramSessionInfo, short paramShort, String paramString, int paramInt, BaseChatPie paramBaseChatPie)
  {
    if (!a(a(paramShort)))
    {
      paramSessionInfo = String.format(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getResources().getString(2131719857), new Object[] { paramString, paramString });
      paramSessionInfo = DialogUtil.a(paramBaseChatPie.a, 230, HardCodeUtil.a(2131714697), paramSessionInfo, 2131719855, 2131719856, a(paramBaseChatPie, paramShort), a(paramBaseChatPie, paramShort));
  ...
  {
    paramSessionInfo = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().a(paramSessionInfo.jdField_a_of_type_JavaLangString, paramSessionInfo.jdField_a_of_type_Int);
    int i;
  ...
  public void a(SessionInfo paramSessionInfo, BaseChatPie paramBaseChatPie)
  {
    ...
    default: 
      return;
    case 1000: 
      a(paramSessionInfo, (short)-23308, HardCodeUtil.a(2131714696), i, paramBaseChatPie);
      return;
    case 1006: 
      a(paramSessionInfo, (short)-23310, HardCodeUtil.a(2131714694), i, paramBaseChatPie);
      return;
    case 1001: 
    case 1003: 
      a(paramSessionInfo, (short)-23312, HardCodeUtil.a(2131714693), i, paramBaseChatPie);
      return;
    case 10002: 
      a(paramSessionInfo, (short)-23166, HardCodeUtil.a(2131714695), i, paramBaseChatPie);
      return;
    case 10010: 
      a(paramSessionInfo, (short)-23161, HardCodeUtil.a(2131694339), i, paramBaseChatPie);
      return;
    case 1005: 
      a(paramSessionInfo, (short)-23309, "QQ咨询", i, paramBaseChatPie);
      return;
    case 10008: 
      a(paramSessionInfo, (short)-23168, HardCodeUtil.a(2131719715), i, paramBaseChatPie);
      return;
    }
    a(paramSessionInfo, (short)-23158, ((GameMsgManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.GAME_CENTER_MSG_MANAGER)).a(), i, paramBaseChatPie);
  }
  ...
  public void a(SessionInfo paramSessionInfo, String paramString, int paramInt, short paramShort)
  {
    ...
    if (paramInt == 1000)
    {
      paramString = ContactUtils.o(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramSessionInfo.c);
      String str = ContactUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramSessionInfo.c, true);
      if (QLog.isColorLevel()) {
        QLog.d("TempMsgManager", 2, "getTroopNickName:" + paramString + " new From:" + str);
      }
      paramString = String.format(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getResources().getString(2131719863), new Object[] { str });
      localObject = new UniteGrayTipParam(paramSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramString, paramSessionInfo.jdField_a_of_type_Int, -5023, 655381, MessageCache.a());
      ...
      ((UniteGrayTipParam)localObject).a(5, str.length() + 5, localBundle);
      ...
      ((UniteGrayTipParam)localObject).a(paramString.length() - 5, paramString.length() - 1, paramSessionInfo);
    ...
    for (;;)
    {
      ...
      return;
      paramString = String.format(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getResources().getString(2131719862), new Object[] { paramString });
      paramSessionInfo = new UniteGrayTipParam(paramSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramString, paramSessionInfo.jdField_a_of_type_Int, -5023, 655381, MessageCache.a());
