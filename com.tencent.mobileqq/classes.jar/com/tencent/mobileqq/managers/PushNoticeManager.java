  ...
  implements Handler.Callback, Manager
{
  ...
  private boolean a(SubMsgType0x27.PushPlatform paramPushPlatform, Bundle paramBundle, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      Object localObject = (CTEntryMng)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.CTENTRY_MNG);
      if (localObject != null)
      {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackgroundPause) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackgroundStop) || (bool))
        {
          ...
          synchronized (this.jdField_a_of_type_AndroidUtilSparseArray)
          {
            ...
            if (bool)
            {
              ...
              if (SettingCloneUtil.readValue(paramString2, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramString2.getString(2131693883), "qqsetting_lock_screen_whenexit_key", true))
              {
                if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      catch (Exception paramMsgBody)
      {
        try
        {
          ...
          this.jdField_a_of_type_ComTencentUtilWeakReferenceHandler.removeMessages(1);
          localObject4 = new PushReportController.PushReportItem();
          ((PushReportController.PushReportItem)localObject4).e = "0X800923D";
          ((PushReportController.PushReportItem)localObject4).d = "收到Push协议";
          ((PushReportController.PushReportItem)localObject4).f = (((SubMsgType0x27.ClientReport)localObject3).uint32_service_id.get() + "");
          ((PushReportController.PushReportItem)localObject4).i = ((SubMsgType0x27.ClientReport)localObject3).str_content_id.get();
          PushReportController.a(paramMsgBody, (PushReportController.PushReportItem)localObject4);
          PushReportController.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (PushReportController.PushReportItem)localObject4);
          l = MessageCache.a();
          ...
          if (this.jdField_a_of_type_ComTencentMobileqqActivityRecentDataRecentItemNoticeData == null)
          {
            ...
            a(paramLong, str, paramMsgBody, (String)localObject2, i, j, ((PushReportController.PushReportItem)localObject4).f, ((PushReportController.PushReportItem)localObject4).i, (Bundle)localObject1);
            return;
