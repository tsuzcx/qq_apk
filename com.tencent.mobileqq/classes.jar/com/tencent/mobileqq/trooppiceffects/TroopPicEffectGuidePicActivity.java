  ...
  implements View.OnClickListener
{
  ...
  {
    paramView.setOnTouchListener(new ajiq(this));
  }
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    setContentView(2130971640);
    this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)findViewById(2131375177));
    this.b = ((ImageButton)findViewById(2131375174));
    this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)findViewById(2131375178));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131375175));
