  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    localObject1 = ObjectAnimator.ofPropertyValuesHolder(this.this$0.e, new PropertyValuesHolder[] { localObject1 }).setDuration(320L);
    localObject4 = ObjectAnimator.ofPropertyValuesHolder(this.this$0.e, new PropertyValuesHolder[] { localObject4 }).setDuration(320L);
    localObject2 = PropertyValuesHolder.ofKeyframe("alpha", new Keyframe[] { localObject2, localObject3, localKeyframe1, localKeyframe2 });
    localObject2 = ObjectAnimator.ofPropertyValuesHolder(this.this$0.e, new PropertyValuesHolder[] { localObject2 }).setDuration(320L);
    ...
    this.this$0.e.setTag(localObject3);
