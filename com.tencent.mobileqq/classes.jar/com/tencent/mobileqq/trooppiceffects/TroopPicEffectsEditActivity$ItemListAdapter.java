  ...
  extends BaseAdapter
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramView = LayoutInflater.from(this.a).inflate(2131563169, paramViewGroup, false);
      ((TroopPicEffectsEditActivity.ViewHolder)localObject1).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131380007));
      ((TroopPicEffectsEditActivity.ViewHolder)localObject1).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131380009));
      ((TroopPicEffectsEditActivity.ViewHolder)localObject1).jdField_a_of_type_AndroidViewView = paramView.findViewById(2131380008);
      ...
      localObject1 = ((TroopPicEffectsEditActivity.ViewHolder)localObject1).jdField_a_of_type_AndroidViewView;
