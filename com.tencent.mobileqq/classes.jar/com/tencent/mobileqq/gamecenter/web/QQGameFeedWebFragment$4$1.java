...
public class QQGameFeedWebFragment$4$1
  implements Runnable
{
  public QQGameFeedWebFragment$4$1(askj paramaskj, int paramInt, PreloadManager.PathResult paramPathResult) {}
  ...
  public void run()
  {
    if ((this.jdField_a_of_type_Int == 0) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqActivityQwalletPreloadPreloadManager$PathResult.filePath)))
    {
      ...
      {
        ((ImageView)this.jdField_a_of_type_Askj.jdField_a_of_type_AndroidViewView.findViewById(2131368099)).setImageDrawable(localDrawable);
        return;
      }
      QQGameFeedWebFragment.a(this.jdField_a_of_type_Askj.jdField_a_of_type_ComTencentMobileqqGamecenterWebQQGameFeedWebFragment);
      return;
    }
    QQGameFeedWebFragment.a(this.jdField_a_of_type_Askj.jdField_a_of_type_ComTencentMobileqqGamecenterWebQQGameFeedWebFragment);
  }
