  ...
  implements Runnable
{
  ...
  public void run()
  {
    QLog.e("GameCenterVideoViewController", 1, "[onVideoPrepared] status:" + GameCenterVideoViewController.access$400(this.this$0).get() + ",sPlayCount = " + GameCenterVideoViewController.sPlayCount + ",ConfigCount=" + QQGameConfigUtil.a);
    ...
    if (GameCenterVideoViewController.access$500(this.this$0) == 2)
    {
      ...
      if ((i >= QQGameConfigUtil.a) && (QQGameConfigUtil.a(GameCenterVideoViewController.access$300(this.this$0).gameInfo.gameAppId)))
      {
        GameCenterVideoViewController.sPlayCount = 0;
        GameCenterVideoViewController.access$700(this.this$0).sendEmptyMessageDelayed(14, QQGameConfigUtil.b - GameCenterVideoViewController.access$600(this.this$0));
      }
    }
    ...
    GameCenterVideoViewController.access$1000(this.this$0).setText(ReadInJoyDisplayUtils.a((int)l / 1000));
