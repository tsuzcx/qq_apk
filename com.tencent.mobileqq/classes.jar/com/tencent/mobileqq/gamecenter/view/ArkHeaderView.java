  ...
  implements avfh
{
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Agnx != null) {
      this.jdField_a_of_type_Agnx.doOnEvent(1);
    }
  }
  ...
  public void a(MessageRecord paramMessageRecord, Activity paramActivity)
  {
    ...
    this.jdField_a_of_type_Agnx.a(paramMessageRecord.ark_app_message.appName, paramMessageRecord.ark_app_message.appView, paramMessageRecord.ark_app_message.appMinVersion, paramMessageRecord.ark_app_message.metaList, paramActivity.getResources().getDisplayMetrics().scaledDensity, localSessionInfo);
    ...
    setClipRadius(5.0F);
    a(this.jdField_a_of_type_Agnx, null);
    setVisibility(0);
    try
    {
  ...
  public void a(QQGameMsgInfo paramQQGameMsgInfo, Activity paramActivity, int paramInt)
  {
    ...
    SessionInfo localSessionInfo = new SessionInfo();
    localSessionInfo.curFriendUin = "2747277822";
    this.jdField_a_of_type_Agnx.a(paramQQGameMsgInfo.arkAppName, paramQQGameMsgInfo.arkAppView, paramQQGameMsgInfo.arkAppMinVersion, paramQQGameMsgInfo.arkMetaList, paramActivity.getResources().getDisplayMetrics().scaledDensity, localSessionInfo);
  ...
  {
    if (this.jdField_a_of_type_Agnx != null) {
      this.jdField_a_of_type_Agnx.doOnEvent(0);
    }
  }
