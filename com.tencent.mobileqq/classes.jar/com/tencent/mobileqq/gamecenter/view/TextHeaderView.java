  ...
  implements avfh
{
  ...
  public void a(MessageRecord paramMessageRecord, Activity paramActivity)
  {
    ...
    try
    {
      ...
      Object localObject2 = (bdry)((ArrayList)((StructMsgForGeneralShare)localObject1).getStructMsgItemLists()).get(1);
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setId(2131367524);
      ...
      localLayoutParams.addRule(14);
      localLayoutParams.addRule(3, 2131367524);
      ...
      this.jdField_a_of_type_AndroidWidgetButton.setText(anvx.a(2131714235));
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setText(((bdsv)((bdry)localObject2).a.get(1)).ai);
      this.jdField_b_of_type_AndroidWidgetTextView.setText(((bdsv)((bdry)localObject2).a.get(0)).ai);
      this.c.setText(((bdsv)((bdry)localObject2).a.get(2)).ai);
      this.d.setText(((bdsv)((bdry)localObject2).a.get(3)).ai);
      ...
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new avfy(this, paramActivity, paramMessageRecord, localMessageForStructing));
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(new avfz(this, paramActivity, paramMessageRecord, localMessageForStructing));
  ...
  public void a(QQGameMsgInfo paramQQGameMsgInfo, Activity paramActivity, int paramInt)
  {
    try
    {
      ...
      localLayoutParams2.addRule(14);
      localLayoutParams2.addRule(3, 2131367524);
      this.jdField_b_of_type_AndroidWidgetTextView.setTextSize(14.0F);
      this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(-7829368);
      ...
      this.jdField_a_of_type_AndroidWidgetButton.setBackgroundDrawable(aver.a("https://cmshow.gtimg.cn/client/gameCenter/gameCenter_headerImage_button_big_click@2x.png", "https://cmshow.gtimg.cn/client/gameCenter/gameCenter_headerImage_button_big@2x.png", getContext()));
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new avga(this, paramActivity, paramQQGameMsgInfo, paramInt));
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(new avgb(this, paramActivity, paramQQGameMsgInfo, paramInt));
