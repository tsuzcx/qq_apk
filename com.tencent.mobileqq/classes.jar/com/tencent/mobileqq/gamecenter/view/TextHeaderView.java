  ...
  implements apyv
{
  ...
  public void a(MessageRecord paramMessageRecord, Activity paramActivity)
  {
    ...
    try
    {
      ...
      Object localObject2 = (awyk)((ArrayList)((StructMsgForGeneralShare)localObject1).getStructMsgItemLists()).get(1);
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = new RelativeLayout(getContext());
      localObject1 = new RelativeLayout.LayoutParams(aciy.a(355.0F, getResources()), -1);
      ((RelativeLayout.LayoutParams)localObject1).addRule(14);
      this.jdField_b_of_type_AndroidWidgetImageView = new ImageView(getContext());
      Object localObject3 = new RelativeLayout.LayoutParams(-1, aciy.a(293.0F, getResources()));
      ((RelativeLayout.LayoutParams)localObject3).topMargin = aciy.a(46.0F, getResources());
      ...
      RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, aciy.a(283.0F, getResources()));
      localLayoutParams.topMargin = aciy.a(46.0F, getResources());
      ((RelativeLayout)localObject3).setPadding(aciy.a(20.0F, getResources()), 0, aciy.a(20.0F, getResources()), 0);
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.addView((View)localObject3, localLayoutParams);
      this.jdField_a_of_type_AndroidWidgetTextView = new TextView(getContext());
      localLayoutParams = new RelativeLayout.LayoutParams(-2, -2);
      localLayoutParams.topMargin = aciy.a(60.0F, getResources());
      localLayoutParams.addRule(10);
      localLayoutParams.addRule(14);
      this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(-16777216);
      this.jdField_a_of_type_AndroidWidgetTextView.setTextSize(18.0F);
      this.jdField_a_of_type_AndroidWidgetTextView.setId(2131301305);
      ((RelativeLayout)localObject3).addView(this.jdField_a_of_type_AndroidWidgetTextView, localLayoutParams);
      this.jdField_b_of_type_AndroidWidgetTextView = new TextView(getContext());
      localLayoutParams = new RelativeLayout.LayoutParams(-2, -2);
      localLayoutParams.topMargin = aciy.a(6.0F, getResources());
      localLayoutParams.addRule(14);
      localLayoutParams.addRule(3, 2131301305);
      ...
      localLayoutParams = new RelativeLayout.LayoutParams(-2, -2);
      localLayoutParams.addRule(3, 2131301305);
      localLayoutParams.topMargin = aciy.a(56.0F, getResources());
      this.c.setTextColor(-16777216);
      this.c.setTextSize(14.0F);
      ((RelativeLayout)localObject3).addView(this.c, localLayoutParams);
      this.d = new TextView(getContext());
      localLayoutParams = new RelativeLayout.LayoutParams(-2, -2);
      localLayoutParams.topMargin = aciy.a(106.0F, getResources());
      localLayoutParams.addRule(3, 2131301305);
      ...
      localObject3 = new RelativeLayout.LayoutParams(aciy.a(188.0F, getResources()), aciy.a(51.0F, getResources()));
      ((RelativeLayout.LayoutParams)localObject3).topMargin = aciy.a(296.0F, getResources());
      ((RelativeLayout.LayoutParams)localObject3).addRule(10);
      ((RelativeLayout.LayoutParams)localObject3).addRule(14);
      this.jdField_a_of_type_AndroidWidgetButton.setText(ajjy.a(2131649064));
      ...
      localObject3 = new RelativeLayout.LayoutParams(aciy.a(92.0F, getResources()), aciy.a(92.0F, getResources()));
      ((RelativeLayout.LayoutParams)localObject3).addRule(10);
      ((RelativeLayout.LayoutParams)localObject3).addRule(14);
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setText(((awzf)((awyk)localObject2).a.get(1)).Y);
      this.jdField_b_of_type_AndroidWidgetTextView.setText(((awzf)((awyk)localObject2).a.get(0)).Y);
      this.c.setText(((awzf)((awyk)localObject2).a.get(2)).Y);
      this.d.setText(((awzf)((awyk)localObject2).a.get(3)).Y);
      ...
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new apzl(this, paramActivity, paramMessageRecord, localMessageForStructing));
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(new apzm(this, paramActivity, paramMessageRecord, localMessageForStructing));
  ...
  public void a(QQGameMsgInfo paramQQGameMsgInfo, Activity paramActivity)
  {
    try
    {
      ...
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = new RelativeLayout(getContext());
      RelativeLayout.LayoutParams localLayoutParams1 = new RelativeLayout.LayoutParams(aciy.a(355.0F, getResources()), -1);
      localLayoutParams1.addRule(14);
      this.jdField_b_of_type_AndroidWidgetImageView = new ImageView(getContext());
      Object localObject = new RelativeLayout.LayoutParams(-1, aciy.a(293.0F, getResources()));
      ((RelativeLayout.LayoutParams)localObject).topMargin = aciy.a(46.0F, getResources());
      this.jdField_b_of_type_AndroidWidgetImageView.setScaleType(ImageView.ScaleType.FIT_XY);
      ...
      RelativeLayout.LayoutParams localLayoutParams2 = new RelativeLayout.LayoutParams(-1, aciy.a(283.0F, getResources()));
      localLayoutParams2.topMargin = aciy.a(46.0F, getResources());
      ((RelativeLayout)localObject).setPadding(aciy.a(20.0F, getResources()), 0, aciy.a(20.0F, getResources()), 0);
      ...
      localLayoutParams2.topMargin = aciy.a(60.0F, getResources());
      ...
      this.jdField_b_of_type_AndroidWidgetTextView = new TextView(getContext());
      localLayoutParams2 = new RelativeLayout.LayoutParams(-2, -2);
      localLayoutParams2.topMargin = aciy.a(6.0F, getResources());
      localLayoutParams2.addRule(14);
      localLayoutParams2.addRule(3, 2131301305);
      this.jdField_b_of_type_AndroidWidgetTextView.setTextSize(14.0F);
      this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(-7829368);
      ...
      localLayoutParams2 = new RelativeLayout.LayoutParams(-2, -2);
      localLayoutParams2.addRule(3, 2131301305);
      localLayoutParams2.topMargin = aciy.a(56.0F, getResources());
      this.c.setTextColor(-16777216);
      this.c.setTextSize(14.0F);
      ((RelativeLayout)localObject).addView(this.c, localLayoutParams2);
      this.d = new TextView(getContext());
      localLayoutParams2 = new RelativeLayout.LayoutParams(-2, -2);
      localLayoutParams2.topMargin = aciy.a(106.0F, getResources());
      localLayoutParams2.addRule(3, 2131301305);
      this.d.setTextSize(14.0F);
      this.d.setTextColor(-7829368);
      ((RelativeLayout)localObject).addView(this.d, localLayoutParams2);
      this.jdField_a_of_type_AndroidWidgetButton = new Button(getContext());
      localObject = new RelativeLayout.LayoutParams(aciy.a(188.0F, getResources()), aciy.a(51.0F, getResources()));
      ((RelativeLayout.LayoutParams)localObject).topMargin = aciy.a(296.0F, getResources());
      ...
      this.jdField_a_of_type_AndroidWidgetImageView = new ImageView(getContext());
      localObject = new RelativeLayout.LayoutParams(aciy.a(92.0F, getResources()), aciy.a(92.0F, getResources()));
      ((RelativeLayout.LayoutParams)localObject).addRule(10);
      ((RelativeLayout.LayoutParams)localObject).addRule(14);
      this.jdField_a_of_type_AndroidWidgetImageView.setBackgroundColor(0);
      ...
      this.jdField_a_of_type_AndroidWidgetButton.setBackgroundDrawable(apyr.a("https://cmshow.gtimg.cn/client/gameCenter/gameCenter_headerImage_button_big_click@2x.png", "https://cmshow.gtimg.cn/client/gameCenter/gameCenter_headerImage_button_big@2x.png", getContext()));
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new apzn(this, paramActivity, paramQQGameMsgInfo));
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(new apzo(this, paramActivity, paramQQGameMsgInfo));
