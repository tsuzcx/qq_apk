  ...
  implements avmq
{
  ...
  public void a(MessageRecord paramMessageRecord, Activity paramActivity)
  {
    ...
    try
    {
      ...
      Object localObject2 = (bdso)((ArrayList)((StructMsgForGeneralShare)localObject1).getStructMsgItemLists()).get(1);
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = new RelativeLayout(getContext());
      localObject1 = new RelativeLayout.LayoutParams(agej.a(355.0F, getResources()), -1);
      ((RelativeLayout.LayoutParams)localObject1).addRule(14);
      this.jdField_b_of_type_AndroidWidgetImageView = new ImageView(getContext());
      Object localObject3 = new RelativeLayout.LayoutParams(-1, agej.a(293.0F, getResources()));
      ((RelativeLayout.LayoutParams)localObject3).topMargin = agej.a(46.0F, getResources());
      ...
      RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, agej.a(283.0F, getResources()));
      localLayoutParams.topMargin = agej.a(46.0F, getResources());
      ((RelativeLayout)localObject3).setPadding(agej.a(20.0F, getResources()), 0, agej.a(20.0F, getResources()), 0);
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.addView((View)localObject3, localLayoutParams);
      this.jdField_a_of_type_AndroidWidgetTextView = new TextView(getContext());
      localLayoutParams = new RelativeLayout.LayoutParams(-2, -2);
      localLayoutParams.topMargin = agej.a(60.0F, getResources());
      localLayoutParams.addRule(10);
      localLayoutParams.addRule(14);
      this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(-16777216);
      this.jdField_a_of_type_AndroidWidgetTextView.setTextSize(18.0F);
      this.jdField_a_of_type_AndroidWidgetTextView.setId(2131367372);
      ...
      localLayoutParams.addRule(14);
      localLayoutParams.addRule(3, 2131367372);
      ...
      localLayoutParams = new RelativeLayout.LayoutParams(-2, -2);
      localLayoutParams.addRule(3, 2131367372);
      localLayoutParams.topMargin = agej.a(56.0F, getResources());
      this.c.setTextColor(-16777216);
      this.c.setTextSize(14.0F);
      ((RelativeLayout)localObject3).addView(this.c, localLayoutParams);
      this.d = new TextView(getContext());
      localLayoutParams = new RelativeLayout.LayoutParams(-2, -2);
      localLayoutParams.topMargin = agej.a(106.0F, getResources());
      localLayoutParams.addRule(3, 2131367372);
      ...
      localObject3 = new RelativeLayout.LayoutParams(agej.a(188.0F, getResources()), agej.a(51.0F, getResources()));
      ((RelativeLayout.LayoutParams)localObject3).topMargin = agej.a(296.0F, getResources());
      ((RelativeLayout.LayoutParams)localObject3).addRule(10);
      ((RelativeLayout.LayoutParams)localObject3).addRule(14);
      this.jdField_a_of_type_AndroidWidgetButton.setText(anzj.a(2131713656));
      ...
      localObject3 = new RelativeLayout.LayoutParams(agej.a(92.0F, getResources()), agej.a(92.0F, getResources()));
      ((RelativeLayout.LayoutParams)localObject3).addRule(10);
      ((RelativeLayout.LayoutParams)localObject3).addRule(14);
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setText(((bdtj)((bdso)localObject2).a.get(1)).ai);
      this.jdField_b_of_type_AndroidWidgetTextView.setText(((bdtj)((bdso)localObject2).a.get(0)).ai);
      this.c.setText(((bdtj)((bdso)localObject2).a.get(2)).ai);
      this.d.setText(((bdtj)((bdso)localObject2).a.get(3)).ai);
      ...
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new avnh(this, paramActivity, paramMessageRecord, localMessageForStructing));
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(new avni(this, paramActivity, paramMessageRecord, localMessageForStructing));
  ...
  public void a(QQGameMsgInfo paramQQGameMsgInfo, Activity paramActivity, int paramInt)
  {
    try
    {
      ...
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = new RelativeLayout(getContext());
      RelativeLayout.LayoutParams localLayoutParams1 = new RelativeLayout.LayoutParams(agej.a(355.0F, getResources()), -1);
      localLayoutParams1.addRule(14);
      this.jdField_b_of_type_AndroidWidgetImageView = new ImageView(getContext());
      Object localObject = new RelativeLayout.LayoutParams(-1, agej.a(293.0F, getResources()));
      ((RelativeLayout.LayoutParams)localObject).topMargin = agej.a(46.0F, getResources());
      this.jdField_b_of_type_AndroidWidgetImageView.setScaleType(ImageView.ScaleType.FIT_XY);
      ...
      RelativeLayout.LayoutParams localLayoutParams2 = new RelativeLayout.LayoutParams(-1, agej.a(283.0F, getResources()));
      localLayoutParams2.topMargin = agej.a(46.0F, getResources());
      ((RelativeLayout)localObject).setPadding(agej.a(20.0F, getResources()), 0, agej.a(20.0F, getResources()), 0);
      ...
      localLayoutParams2.topMargin = agej.a(60.0F, getResources());
      ...
      this.jdField_b_of_type_AndroidWidgetTextView = new TextView(getContext());
      localLayoutParams2 = new RelativeLayout.LayoutParams(-2, -2);
      localLayoutParams2.topMargin = agej.a(6.0F, getResources());
      localLayoutParams2.addRule(14);
      localLayoutParams2.addRule(3, 2131367372);
      this.jdField_b_of_type_AndroidWidgetTextView.setTextSize(14.0F);
      this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(-7829368);
      ...
      localLayoutParams2 = new RelativeLayout.LayoutParams(-2, -2);
      localLayoutParams2.addRule(3, 2131367372);
      localLayoutParams2.topMargin = agej.a(56.0F, getResources());
      this.c.setTextColor(-16777216);
      this.c.setTextSize(14.0F);
      ((RelativeLayout)localObject).addView(this.c, localLayoutParams2);
      this.d = new TextView(getContext());
      localLayoutParams2 = new RelativeLayout.LayoutParams(-2, -2);
      localLayoutParams2.topMargin = agej.a(106.0F, getResources());
      localLayoutParams2.addRule(3, 2131367372);
      this.d.setTextSize(14.0F);
      this.d.setTextColor(-7829368);
      ((RelativeLayout)localObject).addView(this.d, localLayoutParams2);
      this.jdField_a_of_type_AndroidWidgetButton = new Button(getContext());
      localObject = new RelativeLayout.LayoutParams(agej.a(188.0F, getResources()), agej.a(51.0F, getResources()));
      ((RelativeLayout.LayoutParams)localObject).topMargin = agej.a(296.0F, getResources());
      ...
      this.jdField_a_of_type_AndroidWidgetImageView = new ImageView(getContext());
      localObject = new RelativeLayout.LayoutParams(agej.a(92.0F, getResources()), agej.a(92.0F, getResources()));
      ((RelativeLayout.LayoutParams)localObject).addRule(10);
      ((RelativeLayout.LayoutParams)localObject).addRule(14);
      this.jdField_a_of_type_AndroidWidgetImageView.setBackgroundColor(0);
      ...
      this.jdField_a_of_type_AndroidWidgetButton.setBackgroundDrawable(avmd.a("https://cmshow.gtimg.cn/client/gameCenter/gameCenter_headerImage_button_big_click@2x.png", "https://cmshow.gtimg.cn/client/gameCenter/gameCenter_headerImage_button_big@2x.png", getContext()));
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new avnj(this, paramActivity, paramQQGameMsgInfo, paramInt));
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(new avnk(this, paramActivity, paramQQGameMsgInfo, paramInt));
