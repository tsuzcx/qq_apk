  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    QQGameHelper.b(QQGameHelper.b()).g("770").e("1").f("160").d("77002").c("208126").a(2, this.a).a(4, "8").h(GamePubNav.c(this.this$0)).b(GamePubNav.b(this.this$0)).a();
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes8.jar
 * Qualified Name:     com.tencent.mobileqq.gamecenter.view.GamePubNav.4
