  ...
  extends NavBarCommon
{
  ...
  private void b()
  {
    ...
    ((RelativeLayout.LayoutParams)localObject).rightMargin = afur.a(40.0F, getResources());
    ...
    localObject = new LinearLayout.LayoutParams(afur.a(30.0F, getResources()), afur.a(64.0F, getResources()));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130844401);
    this.jdField_a_of_type_AndroidWidgetImageView.setId(2131368961);
    localObject = new RelativeLayout.LayoutParams(afur.a(24.0F, getResources()), afur.a(24.0F, getResources()));
    ((RelativeLayout.LayoutParams)localObject).addRule(15);
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130846626);
    int i = afur.a(1.0F, getResources());
    this.jdField_a_of_type_AndroidWidgetTextView.setPadding(i, i, i, i);
    localObject = new RelativeLayout.LayoutParams(afur.a(6.0F, getResources()), afur.a(6.0F, getResources()));
    ((RelativeLayout.LayoutParams)localObject).addRule(10);
    ((RelativeLayout.LayoutParams)localObject).addRule(11);
    ((RelativeLayout.LayoutParams)localObject).topMargin = afur.a(16.0F, getResources());
    ((RelativeLayout.LayoutParams)localObject).rightMargin = afur.a(6.0F, getResources());
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setOnClickListener(new auuv(this));
  ...
  public void a(String paramString1, String paramString2, String paramString3)
  {
    if (this.jdField_a_of_type_AndroidWidgetImageView != null)
    {
      ...
      localURLDrawableOptions.mFailedDrawable = getResources().getDrawable(2130844174);
      localURLDrawableOptions.mLoadingDrawable = getResources().getDrawable(2130844174);
  ...
  {
    TextView localTextView = (TextView)findViewById(2131378776);
