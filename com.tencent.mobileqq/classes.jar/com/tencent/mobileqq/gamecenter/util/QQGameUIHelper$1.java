...
final class QQGameUIHelper$1
  implements Runnable
{
  QQGameUIHelper$1(GameContentView paramGameContentView, View paramView) {}
  
  public void run()
  {
    GameSessionView localGameSessionView = this.jdField_a_of_type_ComTencentMobileqqGamecenterWebViewGameContentView.a();
    ...
    int i = localGameSessionView.getLeft();
    int j = localGameSessionView.getTop();
    ...
    localAnimationSet.setAnimationListener(new QQGameUIHelper.1.1(this, localGameSessionView));
    QQGameUIHelper.a(localGameSessionView, false);
    localGameSessionView.startAnimation(localAnimationSet);
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes8.jar
 * Qualified Name:     com.tencent.mobileqq.gamecenter.util.QQGameUIHelper.1
