  ...
  implements Parcelable.Creator<GameCenterSessionInfo>
{
  public GameCenterSessionInfo a(Parcel paramParcel)
  {
    ...
    if (paramParcel != null)
    {
      localGameCenterSessionInfo.jdField_a_of_type_ArrayOfComTencentMobileqqGamecenterMsgInfoGameCenterSessionInfo$SimpleMessage = new GameCenterSessionInfo.SimpleMessage[paramParcel.length];
      int i = 0;
      while (i < paramParcel.length)
      {
        localGameCenterSessionInfo.jdField_a_of_type_ArrayOfComTencentMobileqqGamecenterMsgInfoGameCenterSessionInfo$SimpleMessage[i] = ((GameCenterSessionInfo.SimpleMessage)paramParcel[i]);
        i += 1;
      }
    }
