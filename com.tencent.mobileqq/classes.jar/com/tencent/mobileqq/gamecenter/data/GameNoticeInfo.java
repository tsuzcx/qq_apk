  ...
  implements Cloneable
{
  ...
  public GameNoticeInfo(apxo paramapxo, Context paramContext)
  {
    this.appId = paramapxo.a;
    this.appName = paramapxo.e;
    this.packageName = paramapxo.b;
    this.apkChannel = paramapxo.g;
    this.filePath = paramapxo.l;
    this.createTime = paramapxo.c;
    this.bannerType = convertToBannerType(paramapxo);
    init(paramContext);
  }
  
  public static int convertToBannerType(apxo paramapxo)
  {
    int j = 0;
    int i;
    if (bady.a(BaseApplicationImpl.getContext(), paramapxo.b)) {
      i = 2;
    }
    do
    {
  ...
  private void init(Context paramContext)
  {
    ...
    do
    {
      do
      {
        ...
        l2 = yez.a("MILLISECONDS_DELAY");
        l3 = yez.a("MILLISECONDS_INTERVAL");
        if (l2 > 0L) {
          break label316;
        }
        l2 = l3;
      ...
      this.title = (this.appName + ajjy.a(2131639265));
    ...
    for (;;)
    {
      ...
      this.title = (this.appName + ajjy.a(2131639264));
