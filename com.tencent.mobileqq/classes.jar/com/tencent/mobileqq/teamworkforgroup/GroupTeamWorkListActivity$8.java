  ...
  implements Runnable
{
  ...
  {
    List localList;
    if (this.this$0.jdField_a_of_type_Bcym != null)
    {
      if (this.a == 1) {
        this.this$0.jdField_a_of_type_Bcym.a(this.this$0.jdField_a_of_type_Long);
      }
      localList = this.this$0.jdField_a_of_type_Bcym.a();
      if (localList == null) {}
    }
