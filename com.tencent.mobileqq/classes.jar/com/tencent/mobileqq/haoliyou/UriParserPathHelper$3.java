...
public class UriParserPathHelper$3
  implements Runnable
{
  public UriParserPathHelper$3(asmj paramasmj, String paramString, InputStream paramInputStream, long paramLong, Uri paramUri) {}
  ...
  public void run()
  {
    ...
    //   38: ifne +46 -> 84
    //   41: aload_0
    //   42: getfield 17	com/tencent/mobileqq/haoliyou/UriParserPathHelper$3:this$0	Lasmj;
    //   45: invokestatic 49	asmj:a	(Lasmj;)Lmqq/os/MqqHandler;
    //   48: iconst_1
    ...
    //   64: aload_0
    //   65: getfield 17	com/tencent/mobileqq/haoliyou/UriParserPathHelper$3:this$0	Lasmj;
    //   68: iconst_0
    //   69: putfield 68	asmj:jdField_a_of_type_Boolean	Z
    //   72: aload_0
    ...
    //   158: astore 9
    //   160: aload_0
    //   161: getfield 17	com/tencent/mobileqq/haoliyou/UriParserPathHelper$3:this$0	Lasmj;
    //   164: getfield 68	asmj:jdField_a_of_type_Boolean	Z
    //   167: ifeq +123 -> 290
    //   170: lload_2
    //   171: iload_1
    //   172: i2l
    ...
    //   241: astore 9
    //   243: aload_0
    //   244: getfield 17	com/tencent/mobileqq/haoliyou/UriParserPathHelper$3:this$0	Lasmj;
    //   247: invokestatic 49	asmj:a	(Lasmj;)Lmqq/os/MqqHandler;
    //   250: aload_0
    //   251: getfield 17	com/tencent/mobileqq/haoliyou/UriParserPathHelper$3:this$0	Lasmj;
    //   254: invokestatic 49	asmj:a	(Lasmj;)Lmqq/os/MqqHandler;
    //   257: iconst_3
    //   258: lload 4
    //   260: l2d
    //   261: aload_0
    ...
    //   333: astore 9
    //   335: aload_0
    //   336: getfield 17	com/tencent/mobileqq/haoliyou/UriParserPathHelper$3:this$0	Lasmj;
    //   339: getfield 123	asmj:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   342: ldc 124
    //   344: invokevirtual 130	android/content/Context:getString	(I)Ljava/lang/String;
    //   347: putstatic 131	asmj:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   350: aload 12
    //   352: astore 10
    //   354: aload 12
    //   356: astore 8
    ...
    //   360: astore 9
    //   362: aload_0
    //   363: getfield 17	com/tencent/mobileqq/haoliyou/UriParserPathHelper$3:this$0	Lasmj;
    //   366: invokestatic 49	asmj:a	(Lasmj;)Lmqq/os/MqqHandler;
    //   369: iconst_1
    ...
    //   384: astore 9
    //   386: aload_0
    //   387: getfield 17	com/tencent/mobileqq/haoliyou/UriParserPathHelper$3:this$0	Lasmj;
    //   390: getfield 68	asmj:jdField_a_of_type_Boolean	Z
    //   393: ifeq +314 -> 707
    //   396: aload 12
    //   398: astore 10
    //   400: aload 12
    ...
    //   406: astore 9
    //   408: aload_0
    //   409: getfield 17	com/tencent/mobileqq/haoliyou/UriParserPathHelper$3:this$0	Lasmj;
    //   412: invokestatic 134	asmj:a	(Lasmj;)Lasmp;
    //   415: ifnull +59 -> 474
    //   418: aload 12
    //   420: astore 10
    //   422: aload 12
    ...
    //   428: astore 9
    //   430: aload_0
    //   431: getfield 17	com/tencent/mobileqq/haoliyou/UriParserPathHelper$3:this$0	Lasmj;
    //   434: invokestatic 134	asmj:a	(Lasmj;)Lasmp;
    //   437: aload 13
    ...
    //   463: astore 9
    //   465: aload_0
    //   466: getfield 17	com/tencent/mobileqq/haoliyou/UriParserPathHelper$3:this$0	Lasmj;
    //   469: aconst_null
    //   470: invokestatic 148	asmj:a	(Lasmj;Lasmp;)Lasmp;
    //   473: pop
    //   474: aload 12
    //   476: astore 10
    //   478: aload 12
    ...
    //   482: aload 11
    //   484: astore 9
    //   486: invokestatic 151	asmj:a	()Ljava/util/concurrent/ConcurrentHashMap;
    //   489: aload_0
    ...
    //   515: astore 9
    //   517: aload_0
    //   518: getfield 17	com/tencent/mobileqq/haoliyou/UriParserPathHelper$3:this$0	Lasmj;
    //   521: invokestatic 49	asmj:a	(Lasmj;)Lmqq/os/MqqHandler;
    //   524: aload_0
    //   525: getfield 17	com/tencent/mobileqq/haoliyou/UriParserPathHelper$3:this$0	Lasmj;
    //   528: invokestatic 49	asmj:a	(Lasmj;)Lmqq/os/MqqHandler;
    //   531: iconst_3
    //   532: bipush 100
    //   534: iconst_0
    ...
    //   552: astore 9
    //   554: aload_0
    //   555: getfield 17	com/tencent/mobileqq/haoliyou/UriParserPathHelper$3:this$0	Lasmj;
    //   558: invokestatic 49	asmj:a	(Lasmj;)Lmqq/os/MqqHandler;
    //   561: iconst_2
    //   562: ldc2_w 158
    ...
    //   582: aload_0
    //   583: getfield 17	com/tencent/mobileqq/haoliyou/UriParserPathHelper$3:this$0	Lasmj;
    //   586: iconst_0
    //   587: putfield 68	asmj:jdField_a_of_type_Boolean	Z
    //   590: aload_0
    ...
    //   613: astore 9
    //   615: aload_0
    //   616: getfield 17	com/tencent/mobileqq/haoliyou/UriParserPathHelper$3:this$0	Lasmj;
    //   619: getfield 123	asmj:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   622: ldc 164
    //   624: invokevirtual 130	android/content/Context:getString	(I)Ljava/lang/String;
    //   627: putstatic 131	asmj:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   630: goto -280 -> 350
    //   633: astore 12
    //   635: aload 10
    //   637: astore 8
    ...
    //   659: astore 9
    //   661: aload_0
    //   662: getfield 17	com/tencent/mobileqq/haoliyou/UriParserPathHelper$3:this$0	Lasmj;
    //   665: invokestatic 49	asmj:a	(Lasmj;)Lmqq/os/MqqHandler;
    //   668: iconst_1
    ...
    //   686: aload_0
    //   687: getfield 17	com/tencent/mobileqq/haoliyou/UriParserPathHelper$3:this$0	Lasmj;
    //   690: iconst_0
    //   691: putfield 68	asmj:jdField_a_of_type_Boolean	Z
    //   694: aload_0
    ...
    //   772: aload_0
    //   773: getfield 17	com/tencent/mobileqq/haoliyou/UriParserPathHelper$3:this$0	Lasmj;
    //   776: iconst_0
    //   777: putfield 68	asmj:jdField_a_of_type_Boolean	Z
    //   780: aload_0
