  ...
  extends TextView
{
      ...
      while (i >= 0)
      {
        ...
        try
        {
          ...
          if (TextUtils.isEmpty(((BusinessInfoCheckUpdate.RedTypeInfo)localObject2).red_desc.get()))
          {
            ...
            this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130845923);
          ...
          for (;;)
          {
            ...
            if (((JSONObject)localObject1).has("cr"))
            {
              ...
              if (((JSONObject)localObject1).has("cn"))
              {
                ...
                if (k != 0)
                {
                  localObject4 = getResources().getDrawable(2130845927);
            ...
            do
            {
              ...
              if (m == 1)
              {
                ...
                localObject2 = getResources().getDrawable(2130839128);
              ...
              for (;;)
              {
                ...
                ThreadManager.post(new agrq(this, (String)localObject1, j), 8, null, true);
                break;
                this.jdField_b_of_type_AndroidGraphicsDrawableDrawable.setBounds(n, i1, this.jdField_a_of_type_Int + n, this.jdField_a_of_type_Int + i1);
                this.jdField_b_of_type_AndroidGraphicsDrawableDrawable.draw(paramCanvas);
              }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.post(new agrr(this));
  }
