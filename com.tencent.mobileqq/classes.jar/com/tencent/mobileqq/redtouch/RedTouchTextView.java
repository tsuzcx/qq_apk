  ...
  extends TextView
{
          ...
          for (;;)
          {
            ...
            if (((JSONObject)localObject1).has("cr"))
            {
              ...
              if (((JSONObject)localObject1).has("cn"))
              {
                ...
                if (k != 0)
                {
                  localObject4 = getResources().getDrawable(2130849057);
            ...
            do
            {
              ...
              if (m == 1)
              {
                ...
                localObject2 = getResources().getDrawable(2130839687);
  ...
  protected Bitmap a(File paramFile)
  {
    ...
    try
    {
      ...
      localOptions.inSampleSize = ((int)bacm.a(new BufferedInputStream(new FileInputStream(paramFile)), this.c, this.c));
