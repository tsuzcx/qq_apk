  ...
  extends VasWebviewJsPlugin
{
  ...
  private void IPCItemClick(String paramString)
  {
    ...
    super.sendRemoteReq(anqu.a("myIndividuationRedInfo", null, 0, localBundle), false, true);
  }
  ...
  private void handleRedInfoResponse(String paramString, Bundle paramBundle)
  {
    ...
    //   174: aload_0
    //   175: aload 11
    //   177: invokestatic 373	avpv:a	(Lcom/tencent/mobileqq/redtouch/RedAppInfo;)Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$AppInfo;
    //   180: sipush 1002
    ...
    //   331: astore 10
    //   333: aload_0
    //   334: getfield 393	com/tencent/mobileqq/redtouch/RedTouchWebviewHandler:mRuntime	Lbcdp;
    //   337: invokevirtual 398	bcdp:a	()Landroid/app/Activity;
    //   340: astore_2
    ...
    //   355: aload_0
    //   356: getfield 393	com/tencent/mobileqq/redtouch/RedTouchWebviewHandler:mRuntime	Lbcdp;
    //   359: invokevirtual 408	bcdp:a	()Lcom/tencent/common/app/AppInterface;
    ...
    //   397: aload 12
    //   399: invokestatic 443	avps:a	(Ljava/lang/String;)I
    ...
    //   686: ldc_w 506
    //   689: aload_0
    //   690: getfield 393	com/tencent/mobileqq/redtouch/RedTouchWebviewHandler:mRuntime	Lbcdp;
    //   693: invokevirtual 408	bcdp:a	()Lcom/tencent/common/app/AppInterface;
    ...
    //   753: lload 6
    //   755: ladd
    //   756: invokestatic 539	bbmx:a	([BIJ)V
    //   759: aload 9
    //   761: iconst_4
    //   762: aload 10
    ...
    //   767: lload 6
    //   769: l2i
    //   770: invokestatic 542	bbmx:a	([BI[BI)V
    //   773: aload 10
    //   775: aload 9
    ...
    //   807: pop
    //   808: aload_0
    //   809: getfield 393	com/tencent/mobileqq/redtouch/RedTouchWebviewHandler:mRuntime	Lbcdp;
    //   812: invokevirtual 408	bcdp:a	()Lcom/tencent/common/app/AppInterface;
    //   815: aload_2
    ...
    //   927: invokestatic 373	avpv:a	(Lcom/tencent/mobileqq/redtouch/RedAppInfo;)Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$AppInfo;
    //   930: astore 15
    //   932: bipush 254
    //   934: istore 4
    //   936: ldc_w 301
    ...
    //   1105: dup
    //   1106: aload_0
    //   1107: getfield 393	com/tencent/mobileqq/redtouch/RedTouchWebviewHandler:mRuntime	Lbcdp;
    //   1110: invokevirtual 408	bcdp:a	()Lcom/tencent/common/app/AppInterface;
    //   1113: invokespecial 591	avps:<init>	(Lcom/tencent/common/app/AppInterface;)V
    //   1116: invokevirtual 592	avps:a	()Ljava/lang/String;
    //   1119: astore_2
    //   1120: iload_3
    //   1121: istore 5
    //   1123: aload 8
    ...
    //   1223: aload_1
    //   1224: aload_0
    //   1225: getfield 611	com/tencent/mobileqq/redtouch/RedTouchWebviewHandler:mOnRemoteResp	Lanqq;
    //   1228: getfield 615	anqq:key	I
    //   1231: aload_2
    //   1232: invokestatic 94	anqu:a	(Ljava/lang/String;Ljava/lang/String;ILandroid/os/Bundle;)Landroid/os/Bundle;
    //   1235: iconst_0
    //   1236: iconst_1
  ...
  private void onReportRed(BusinessInfoCheckUpdate.AppInfo paramAppInfo, int paramInt)
  {
    ...
    try
    {
      ...
      new avps(this.mRuntime.a()).c(paramAppInfo, localJSONObject.toString());
      return;
    }
  ...
  public void getDynamicState(String paramString)
  {
    ...
    catch (Exception localException1)
    {
      ...
      try
      {
        ...
        Bundle localBundle = new Bundle();
        paramString = str;
        localBundle.putInt("path", avps.a(localObject.getString("path")));
        paramString = str;
        sendRemoteReq(anqu.a("leba_item_get", str, this.mOnRemoteResp.key, localBundle), false, false);
        return;
      }
  ...
  public void getIndividuationType(String paramString)
  {
    try
    {
      ...
      super.sendRemoteReq(anqu.a("redTouch_getRedInfo", paramString, this.mOnRemoteResp.key, localBundle), false, true);
      return;
    }
  ...
  public void getRedPointShowInfo(String paramString)
  {
    ...
    try
    {
      ...
      try
      {
        ...
        str = paramString;
        super.sendRemoteReq(anqu.a("redTouch_getRedPointShowInfo_set", paramString, this.mOnRemoteResp.key, (Bundle)localObject2), false, true);
        return;
        str = paramString;
        if (!((JSONObject)localObject3).isNull("path"))
        {
          ...
          str = paramString;
          super.sendRemoteReq(anqu.a("redTouch_getRedInfo", paramString, this.mOnRemoteResp.key, (Bundle)localObject3), false, true);
          return;
        }
        str = paramString;
        localJSONObject.put("code", -1);
    ...
    for (;;)
    {
      try
      {
        ...
        try
        {
          ...
          if (!new avps(this.mRuntime.a()).a().equals(localObject))
          {
  ...
  public void setAppInfo(String paramString)
  {
    ...
    try
    {
      ...
      localObject3 = new Bundle();
      localObject1 = paramString;
      ((Bundle)localObject3).putParcelable("red", avpv.a((BusinessInfoCheckUpdate.AppInfo)localObject2));
      localObject1 = paramString;
      super.sendRemoteReq(anqu.a("redTouch_setAppInfo", paramString, this.mOnRemoteResp.key, (Bundle)localObject3), false, true);
      return;
    }
    catch (Exception paramString)
    {
  ...
  public void setDynamicState(String paramString)
  {
    ...
    catch (Exception localException1)
    {
      ...
      try
      {
        ...
        paramString = str;
        sendRemoteReq(anqu.a("leba_item_set", str, this.mOnRemoteResp.key, localBundle), false, false);
        return;
      }
      catch (Exception localException2)
      {
