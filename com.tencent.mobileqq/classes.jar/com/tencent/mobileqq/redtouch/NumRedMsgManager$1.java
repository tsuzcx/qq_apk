...
public class NumRedMsgManager$1
  implements Runnable
{
  public NumRedMsgManager$1(auqe paramauqe, List paramList, auqd paramauqd, String paramString) {}
  
  public void run()
  {
    int k = 0;
    if ((this.jdField_a_of_type_JavaUtilList == null) || (this.jdField_a_of_type_JavaUtilList.size() < 1) || (this.jdField_a_of_type_Auqd == null)) {
      return;
    }
    if ((this.this$0.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap != null) && (!this.this$0.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(Integer.valueOf(this.jdField_a_of_type_Auqd.a)))) {
      this.this$0.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(Integer.valueOf(this.jdField_a_of_type_Auqd.a), this.jdField_a_of_type_Auqd);
    }
    ...
    for (int i = 0;; i = 1)
    {
      ...
      {
        this.jdField_a_of_type_Auqd.a(this.jdField_a_of_type_JavaLangString, (List)localObject1);
        return;
      }
      ...
      this.this$0.jdField_a_of_type_Ajnm.a(localArrayList, this.jdField_a_of_type_Auqd.a, this.jdField_a_of_type_JavaLangString, (long[])localObject1);
      return;
      label585:
      j = 0;
      break;
