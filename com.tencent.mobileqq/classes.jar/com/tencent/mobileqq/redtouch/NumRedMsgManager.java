  ...
  implements Manager
{
  ...
  {
    boolean bool = FileUtils.a(new File(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getFilesDir(), "NumRedMsgFileName_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).getAbsolutePath(), paramNumMsgRspBody.toByteArray(), false);
    if (bool) {
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqTianshuPbNumRedMsg$NumMsgRspBody != null) {
      return this.jdField_a_of_type_ComTencentMobileqqTianshuPbNumRedMsg$NumMsgRspBody;
    }
