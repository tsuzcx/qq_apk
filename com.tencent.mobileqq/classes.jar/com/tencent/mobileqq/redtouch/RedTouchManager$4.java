...
public class RedTouchManager$4
  implements Runnable
{
  public RedTouchManager$4(bbbq parambbbq, BusinessInfoCheckUpdate.AppInfo paramAppInfo, long paramLong) {}
  ...
  public void run()
  {
    ...
    localReportReqBody.clientver.set("8.4.10.4875");
    localReportReqBody.platid.set(109);
    localReportReqBody.appid.set(bbbq.a(this.jdField_a_of_type_ComTencentPbGetbusiinfoBusinessInfoCheckUpdate$AppInfo.path.get()));
    ...
    for (;;)
    {
      ...
      catch (Exception localException2)
      {
        try
        {
          ...
          localObject1 = bbbq.a(this.this$0, "RedTouchSvc.ClientReport");
          ((ToServiceMsg)localObject1).putWupBuffer(localReportReqBody.toByteArray());
          bbbq.a(this.this$0, (ToServiceMsg)localObject1);
          return;
        }
