  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject1 = new baif(this.this$0.mRuntime.a());
        if (localObject1 == null) {
          break label1573;
        }
        localObject1 = ((baif)localObject1).a();
      ...
      if (localAppInfo.red_display_info.get() != null)
      {
        ...
        localObject7 = localObject2;
        localObject8 = localObject1;
        localJSONObject2.put("redInfo", RedTouchWebviewHandler.access$100(this.this$0, (List)localObject9));
        j = m;
        localObject4 = localObject3;
        localObject6 = localAppInfo;
        i = i2;
