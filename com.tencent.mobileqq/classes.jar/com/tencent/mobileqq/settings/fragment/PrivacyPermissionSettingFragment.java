  ...
  implements View.OnClickListener
{
  ...
  private void a()
  {
    this.jdField_a_of_type_AndroidViewView = this.jdField_b_of_type_AndroidViewView.findViewById(2131372877);
    ReportController.b(null, "dc00898", "", "", "0X800B7FB", "0X800B7FB", 0, 0, "", "", "", "");
    this.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem = ((FormSwitchItem)this.jdField_b_of_type_AndroidViewView.findViewById(2131372875));
    ReportController.b(null, "dc00898", "", "", "0X800B7FC", "0X800B7FC", 0, 0, "", "", "", "");
    this.jdField_b_of_type_ComTencentMobileqqWidgetFormSwitchItem = ((FormSwitchItem)this.jdField_b_of_type_AndroidViewView.findViewById(2131372864));
    ...
    if (AppSetting.d)
    {
      this.jdField_a_of_type_AndroidViewView.setContentDescription(getResources().getString(2131699116));
      this.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem.setContentDescription(getResources().getString(2131694456));
      this.jdField_b_of_type_ComTencentMobileqqWidgetFormSwitchItem.setContentDescription(getResources().getString(2131690070));
    }
  }
  ...
  public void doOnCreateView(LayoutInflater paramLayoutInflater, @Nullable ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    setTitle(getActivity().getString(2131699155));
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      QZoneHelper.forwardToPermissionSetting(getActivity(), localUserInfo, -1);
