...
{
  private final ILocationShareService a;
  
  VenueOperateHandler(AppRuntime paramAppRuntime)
  {
  ...
  private void a(int paramInt1, int paramInt2, long paramLong, LocationRoom.Venue paramVenue)
  {
    ...
    Object localObject = LocationProtoUtil.a(this.jdField_a_of_type_MqqAppAppRuntime, paramInt2, paramLong);
    ...
    localObject = new ToServiceMsg("mobileqq.service", this.jdField_a_of_type_MqqAppAppRuntime.getAccount(), "QQLBSShareSvc.assembly_point_operation");
  ...
  {
    if ((paramRoomKey == null) || (paramVenue == null)) {
      return;
    }
