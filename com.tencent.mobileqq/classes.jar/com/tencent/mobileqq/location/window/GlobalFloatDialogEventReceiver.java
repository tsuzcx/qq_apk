  ...
  extends BroadcastReceiver
{
  ...
  public void a(arza paramarza)
  {
    this.a = paramarza;
    paramarza = new IntentFilter();
    paramarza.addAction("tencent.mobileqq.floatingscreen.statuschange");
    paramarza.addAction("mqq.intent.action.QQ_BACKGROUND");
    paramarza.addAction("mqq.intent.action.QQ_FOREGROUND");
    paramarza.addAction("mqq.intent.action.ACCOUNT_CHANGED");
    paramarza.addAction("mqq.intent.action.ACCOUNT_KICKED");
    paramarza.addAction("mqq.intent.action.ACCOUNT_EXPIRED");
    paramarza.addAction("mqq.intent.action.FORCE_LOGOUT");
    paramarza.addAction("mqq.intent.action.LOGOUT");
    paramarza.addAction("android.intent.action.SCREEN_OFF");
    BaseApplicationImpl.context.registerReceiver(this, paramarza);
  }
