  ...
  public void onSuccess(int paramInt, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget$RouteDetail.a = ((float)((TransitResultObject.Route)localObject1).duration);
        this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget$RouteDetail.b = ((TransitResultObject.Route)localObject1).distance;
