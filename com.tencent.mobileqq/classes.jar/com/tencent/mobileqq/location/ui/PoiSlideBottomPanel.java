  ...
  extends SlideBottomPanel
{
  ...
  public void a()
  {
    ...
    do
    {
      ...
      localValueAnimator.addUpdateListener(new awba(this, localView, f1, f2 - f3));
      localValueAnimator.addListener(new awbb(this));
    ...
    do
    {
      do
      {
        ...
        if ((!this.jdField_c_of_type_Boolean) && (Math.abs(paramMotionEvent.getY() - this.jdField_f_of_type_Float) > this.jdField_d_of_type_Float))
        {
          ...
          this.jdField_b_of_type_AndroidViewView.addOnLayoutChangeListener(new awaz(this));
        }
      ...
      if ((this.jdField_a_of_type_Bpti != null) && (f > this.jdField_b_of_type_Int - this.i) && (f < this.jdField_b_of_type_Int - this.j))
      {
        if (QLog.isColorLevel()) {
        ...
        this.jdField_a_of_type_Bpti.fadeBackground(1.0F - f / (this.jdField_b_of_type_Int - this.j));
      }
  ...
  public void b()
  {
    ...
    do
    {
      ...
      localValueAnimator.addUpdateListener(new awbc(this, localView, f, i));
      localValueAnimator.addListener(new awbd(this));
      localValueAnimator.start();
    } while (this.jdField_a_of_type_Bpti == null);
