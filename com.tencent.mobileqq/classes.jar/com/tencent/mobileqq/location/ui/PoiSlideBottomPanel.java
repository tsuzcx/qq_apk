  ...
  extends SlideBottomPanel
{
  ...
  public void a()
  {
    ...
    do
    {
      ...
      localValueAnimator.addUpdateListener(new arcx(this, localView, f1, f2 - f3));
      localValueAnimator.addListener(new arcy(this));
    ...
    do
    {
      do
      {
        ...
        if ((!this.jdField_c_of_type_Boolean) && (Math.abs(paramMotionEvent.getY() - this.jdField_f_of_type_Float) > this.jdField_d_of_type_Float))
        {
          ...
          this.jdField_b_of_type_AndroidViewView.addOnLayoutChangeListener(new arcw(this));
        }
      ...
      if ((this.jdField_a_of_type_Bivd != null) && (f > this.jdField_b_of_type_Int - this.i) && (f < this.jdField_b_of_type_Int - this.j))
      {
        if (QLog.isColorLevel()) {
        ...
        this.jdField_a_of_type_Bivd.fadeBackground(1.0F - f / (this.jdField_b_of_type_Int - this.j));
      }
  ...
  public void b()
  {
    ...
    do
    {
      ...
      localValueAnimator.addUpdateListener(new arcz(this, localView, f, i));
      localValueAnimator.addListener(new arda(this));
      localValueAnimator.start();
    } while (this.jdField_a_of_type_Bivd == null);
