  ...
  extends SlideBottomPanel
{
  ...
  public void a()
  {
    ...
    do
    {
      ...
      localValueAnimator.addUpdateListener(new awnb(this, localView, f1, f2 - f3));
      localValueAnimator.addListener(new awnc(this));
    ...
    do
    {
      do
      {
        ...
        if ((!this.jdField_c_of_type_Boolean) && (Math.abs(paramMotionEvent.getY() - this.jdField_f_of_type_Float) > this.jdField_d_of_type_Float))
        {
          ...
          this.jdField_b_of_type_AndroidViewView.addOnLayoutChangeListener(new awna(this));
        }
      ...
      if ((this.jdField_a_of_type_Bpfj != null) && (f > this.jdField_b_of_type_Int - this.i) && (f < this.jdField_b_of_type_Int - this.j))
      {
        if (QLog.isColorLevel()) {
        ...
        this.jdField_a_of_type_Bpfj.fadeBackground(1.0F - f / (this.jdField_b_of_type_Int - this.j));
      }
  ...
  public void b()
  {
    ...
    do
    {
      ...
      localValueAnimator.addUpdateListener(new awnd(this, localView, f, i));
      localValueAnimator.addListener(new awne(this));
      localValueAnimator.start();
    } while (this.jdField_a_of_type_Bpfj == null);
