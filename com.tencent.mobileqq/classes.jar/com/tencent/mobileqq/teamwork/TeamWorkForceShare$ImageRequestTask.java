...
public class TeamWorkForceShare$ImageRequestTask
  implements Runnable
{
  private aydp jdField_a_of_type_Aydp;
  private String jdField_a_of_type_JavaLangString;
  
  public TeamWorkForceShare$ImageRequestTask(TeamWorkForceShare paramTeamWorkForceShare, String paramString, aydp paramaydp)
  {
    this.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_Aydp = paramaydp;
  }
  ...
  private void a()
  {
    ...
    //   0: new 28	ayrp
    //   3: dup
    //   4: invokespecial 29	ayrp:<init>	()V
    //   7: astore_3
    //   8: new 31	ayff
    //   11: dup
    //   12: aload_0
    //   13: invokespecial 34	ayff:<init>	(Lcom/tencent/mobileqq/teamwork/TeamWorkForceShare$ImageRequestTask;)V
    //   16: astore 4
    ...
    //   60: invokestatic 57	ayoi:d	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   71: aload 5
    //   73: aload 4
    //   75: invokevirtual 61	ayrp:a	(Ljava/io/OutputStream;Lcom/tencent/image/DownloadParams;Lcom/tencent/image/URLDrawableHandler;)Ljava/io/File;
    //   78: pop
    //   79: aload_2
    //   80: ifnull +7 -> 87
    //   83: aload_2
  ...
  private boolean a(boolean paramBoolean)
  {
    ...
    Object localObject2 = ayrp.a(this.jdField_a_of_type_JavaLangString);
    if (localObject2 != null)
    {
      ...
      try
      {
        bbef.a(((File)localObject2).getAbsolutePath(), localOptions);
        if (localOptions.outWidth > bbdh.i()) {
          localOptions.inSampleSize = ((int)(bbdh.i() / localOptions.outWidth));
        }
        localOptions.inJustDecodeBounds = false;
        try
        {
          localObject2 = bbef.a(((File)localObject2).getAbsolutePath(), localOptions);
        ...
        if (this.jdField_a_of_type_Aydp != null) {
          this.jdField_a_of_type_Aydp.a(localObject1);
        }
        return true;
      }
    ...
    if (paramBoolean)
    {
      ...
      if (this.jdField_a_of_type_Aydp != null) {
        this.jdField_a_of_type_Aydp.a(null);
      }
    }
    return false;
  }
