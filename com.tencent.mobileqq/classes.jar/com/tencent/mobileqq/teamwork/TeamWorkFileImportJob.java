...
{
  protected TeamWorkFileImportHandler a;
  ...
  public TeamWorkFileImportJob(TeamWorkFileImportInfo paramTeamWorkFileImportInfo, QQAppInterface paramQQAppInterface)
  {
    ...
    if (paramQQAppInterface != null) {
      this.jdField_a_of_type_ComTencentMobileqqTeamworkTeamWorkFileImportHandler = ((TeamWorkFileImportHandler)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.TEAM_WORK_FILE_IMPORT_HANDLER));
    }
  }
