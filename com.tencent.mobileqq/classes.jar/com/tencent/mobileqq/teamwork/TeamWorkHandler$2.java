...
class TeamWorkHandler$2
  implements WtTicketPromise
{
  TeamWorkHandler$2(TeamWorkHandler paramTeamWorkHandler, TicketManager paramTicketManager, ReSendCmd paramReSendCmd) {}
  ...
  public void Done(Ticket paramTicket)
  {
    ...
    for (;;)
    {
      ...
      paramTicket = this.jdField_a_of_type_MqqManagerTicketManager.getSkey(TeamWorkHandler.a(this.jdField_a_of_type_ComTencentMobileqqTeamworkTeamWorkHandler).getCurrentAccountUin());
 ...
 * Qualified Name:     com.tencent.mobileqq.teamwork.TeamWorkHandler.2
