...
public class TeamWorkConvertUtils
{
  public static QQProgressDialog a(QQAppInterface paramQQAppInterface, TeamWorkFileImportInfo paramTeamWorkFileImportInfo, Context paramContext, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if (paramString2.equals(paramContext.getString(2131439109))) {}
  ...
  public static void a(QQAppInterface paramQQAppInterface, TeamWorkFileImportInfo paramTeamWorkFileImportInfo, Context paramContext, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    {
      return;
      String str = String.format(paramContext.getString(2131439113), new Object[] { paramString2 });
      ...
      {
        paramString2 = String.format(paramContext.getString(2131439113), new Object[] { paramString2 });
      ...
      for (;;)
      {
        for (;;)
        {
          ...
          try
          {
            ...
            paramString2 = paramContext.getString(2131439105);
            i = 0;
          }
      ...
      paramTeamWorkFileImportInfo.setPositiveButton(paramContext.getString(2131434592), new ahyb(paramQQAppInterface, paramContext, paramString1));
      paramTeamWorkFileImportInfo.setNegativeButton(paramContext.getString(2131435869), new ahyc(paramTeamWorkFileImportInfo));
      try
      {
