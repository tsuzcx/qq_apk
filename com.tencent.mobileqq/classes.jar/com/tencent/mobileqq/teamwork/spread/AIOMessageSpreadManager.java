  ...
  implements Manager
{
  ...
  private boolean a(ChatMessage paramChatMessage)
  {
    ...
    do
    {
      ...
      bool2 = TencentDocTipsConfigProcessor.a().a();
      bool1 = bool2;
    } while (!QLog.isColorLevel());
  ...
  public void a(ChatMessage paramChatMessage, Context paramContext, SessionInfo paramSessionInfo)
  {
    ...
    do
    {
      try
      {
        ...
        localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().b(paramChatMessage.frienduin, paramChatMessage.istroop, l);
      ...
      if ((localException1 instanceof MessageForTroopFile))
      {
        ...
        ((TeamWorkFileImportInfo)localObject3).c = ((TroopFileStatusInfo)localObject2).jdField_a_of_type_JavaLangString;
        ((TeamWorkFileImportInfo)localObject3).jdField_b_of_type_JavaLangString = ((TroopFileStatusInfo)localObject2).g;
        ((TeamWorkFileImportInfo)localObject3).j = FileManagerUtil.a(((TroopFileStatusInfo)localObject2).g);
        ...
        ((TeamWorkFileImportInfo)localObject3).jdField_b_of_type_Int = ((TroopFileStatusInfo)localObject2).h;
        ...
        TeamWorkConvertUtils.a((TeamWorkFileImportInfo)localObject3, paramContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((TeamWorkFileImportInfo)localObject3).jdField_d_of_type_Int);
        return;
      }
