  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    Object localObject4 = new StringTokenizer(TencentDocDataLineTipsConfigProcessor.a().a(), "|");
    if (!((StringTokenizer)localObject4).hasMoreTokens())
    {
      if (QLog.isColorLevel()) {
        QLog.i("BuddyFileDataLineMsgTips", 1, "config filetype is null");
      }
      this.jdField_a_of_type_ComTencentMobileqqTeamworkSpreadBuddyFileDataLineMsgTips$1.a.a((List)localObject1);
      return;
    }
    ...
    while (((Iterator)localObject3).hasNext())
    {
      ...
      if (((FileManagerEntity)localObject4).uniseq != this.jdField_a_of_type_ComTencentMobileqqTeamworkSpreadBuddyFileDataLineMsgTips$1.this$0.a.uniseq)
      {
