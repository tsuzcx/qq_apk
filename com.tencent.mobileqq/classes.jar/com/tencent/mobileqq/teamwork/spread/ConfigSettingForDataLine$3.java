...
public class ConfigSettingForDataLine$3
  implements Runnable
{
  public ConfigSettingForDataLine$3(bdkq parambdkq) {}
  ...
  public void run()
  {
    ...
    localSharedPreferences.edit().putInt("file_str_key_max_count_local", bdkq.a(this.this$0)).commit();
    localSharedPreferences.edit().putLong("file_str_lstat_show_time_local", bdkq.a(this.this$0)).commit();
  }
}
