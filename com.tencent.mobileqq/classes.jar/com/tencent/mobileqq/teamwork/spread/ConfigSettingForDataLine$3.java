...
public class ConfigSettingForDataLine$3
  implements Runnable
{
  public ConfigSettingForDataLine$3(beeb parambeeb) {}
  ...
  public void run()
  {
    ...
    localSharedPreferences.edit().putInt("file_str_key_max_count_local", beeb.a(this.this$0)).commit();
    localSharedPreferences.edit().putLong("file_str_lstat_show_time_local", beeb.a(this.this$0)).commit();
  }
}
