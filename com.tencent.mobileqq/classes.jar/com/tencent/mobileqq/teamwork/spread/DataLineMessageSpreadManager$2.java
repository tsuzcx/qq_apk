  ...
  implements Runnable
{
  ...
  public void run()
  {
    Object localObject2 = DataLineMessageSpreadManager.a(this.this$0).getMessageFacade().a(DataLineMessageSpreadManager.a(this.this$0)).a(this.jdField_a_of_type_ComTencentMobileqqDataDataLineMsgRecord.sessionid);
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_JavaLangString.contains("%s")) && (this.jdField_a_of_type_ComTencentMobileqqConfigBusinessTendocTencentDocDataLineTipsConfigBean$TeamworkKeyWords != null)) {}
      DataLineMsgRecord localDataLineMsgRecord;
      for (;;)
      {
        try
        {
          localObject3 = String.format(this.jdField_a_of_type_JavaLangString, new Object[] { this.jdField_a_of_type_ComTencentMobileqqConfigBusinessTendocTencentDocDataLineTipsConfigBean$TeamworkKeyWords.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqConfigBusinessTendocTencentDocDataLineTipsConfigBean$TeamworkKeyWords.jdField_a_of_type_JavaLangString });
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqConfigBusinessTendocTencentDocDataLineTipsConfigBean$TeamworkKeyWords != null)
        {
          localHashMap.put("tim_aio_tips_template_id", String.valueOf(this.jdField_a_of_type_ComTencentMobileqqConfigBusinessTendocTencentDocDataLineTipsConfigBean$TeamworkKeyWords.jdField_a_of_type_Int));
        ...
        localObject3 = (DataLineHandler)DataLineMessageSpreadManager.a(this.this$0).getBusinessHandler(BusinessHandlerFactory.DATALINE_HANDLER);
        localLong = ((DataLineHandler)localObject3).a(0, DataLineMessageSpreadManager.a(this.this$0));
