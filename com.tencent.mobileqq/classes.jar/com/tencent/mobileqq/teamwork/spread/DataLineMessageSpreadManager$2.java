...
public class DataLineMessageSpreadManager$2
  implements Runnable
{
  public DataLineMessageSpreadManager$2(baff parambaff, DataLineMsgRecord paramDataLineMsgRecord, String paramString1, aota paramaota, String paramString2, String paramString3) {}
  
  public void run()
  {
    Object localObject2 = baff.a(this.this$0).a().a(baff.a(this.this$0)).a(this.jdField_a_of_type_ComTencentMobileqqDataDataLineMsgRecord.sessionid);
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_JavaLangString.contains("%s")) && (this.jdField_a_of_type_Aota != null)) {}
      DataLineMsgRecord localDataLineMsgRecord;
      for (;;)
      {
        try
        {
          localObject3 = String.format(this.jdField_a_of_type_JavaLangString, new Object[] { this.jdField_a_of_type_Aota.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Aota.jdField_a_of_type_JavaLangString });
          localObject1 = localObject3;
          localHashMap.put("tim_aio_file_tips", localObject3);
          localObject1 = localObject3;
          localHashMap.put("tim_aio_file_link", String.format(this.b, new Object[] { this.jdField_a_of_type_Aota.jdField_a_of_type_JavaLangString }));
          localObject1 = localObject3;
        }
        ...
        if (this.jdField_a_of_type_Aota != null)
        {
          localHashMap.put("tim_aio_tips_template_id", String.valueOf(this.jdField_a_of_type_Aota.jdField_a_of_type_Int));
          localHashMap.put("tim_aio_tips_template_type", String.valueOf(this.jdField_a_of_type_Aota.b));
          localHashMap.put("tim_aio_tips_keyword", String.valueOf(this.jdField_a_of_type_Aota.jdField_a_of_type_JavaLangString));
          localHashMap.put("tim_aio_tips_type", String.valueOf(this.jdField_a_of_type_Aota.b));
        }
        localObject3 = (allz)baff.a(this.this$0).a(8);
        localLong = ((allz)localObject3).a(0, baff.a(this.this$0));
        ...
        localDataLineMsgRecord.selfuin = baff.a(this.this$0).getCurrentAccountUin();
        localDataLineMsgRecord.frienduin = ((DataLineMsgRecord)localObject2).frienduin;
        localDataLineMsgRecord.senderuin = baff.a(this.this$0).getCurrentAccountUin();
      ...
      azmj.b(baff.a(this.this$0), "dc00898", "", "", "0X80098F7", "0X80098F7", 0, 0, "", "", "", "");
      baff.a(this.this$0).a(baff.a(this.this$0)).b(localDataLineMsgRecord);
