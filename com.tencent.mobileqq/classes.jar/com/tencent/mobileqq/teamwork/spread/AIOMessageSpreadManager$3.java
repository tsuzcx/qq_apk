...
public class AIOMessageSpreadManager$3
  extends TimerTask
{
  public AIOMessageSpreadManager$3(bdkg parambdkg) {}
  ...
  public void run()
  {
    synchronized (this.this$0)
    {
      ...
      if (l2 >= 950L)
      {
        ...
        i = bdkg.a(this.this$0).size() - 1;
        while (i >= 0)
        {
          localMessageRecord = (MessageRecord)bdkg.a(this.this$0).get(i);
          this.this$0.a((ChatMessage)localMessageRecord);
          i -= 1;
        }
        this.this$0.a = 0L;
        bdkg.a(this.this$0).clear();
      }
