  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if ((this.jdField_a_of_type_JavaLangString.contains("%s")) && (this.jdField_a_of_type_ComTencentMobileqqConfigBusinessTendocTencentDocTipsConfigBean$TeamworkKeyWords != null)) {}
    for (;;)
    {
      try
      {
        String str = String.format(this.jdField_a_of_type_JavaLangString, new Object[] { this.jdField_a_of_type_ComTencentMobileqqConfigBusinessTendocTencentDocTipsConfigBean$TeamworkKeyWords.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqConfigBusinessTendocTencentDocTipsConfigBean$TeamworkKeyWords.jdField_a_of_type_JavaLangString });
        localObject1 = str;
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqConfigBusinessTendocTencentDocTipsConfigBean$TeamworkKeyWords != null)
      {
        localHashMap.put("tim_aio_tips_template_id", String.valueOf(this.jdField_a_of_type_ComTencentMobileqqConfigBusinessTendocTencentDocTipsConfigBean$TeamworkKeyWords.jdField_a_of_type_Int));
