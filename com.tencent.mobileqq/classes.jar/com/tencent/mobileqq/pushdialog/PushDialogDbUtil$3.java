...
public class PushDialogDbUtil$3
  implements Runnable
{
  public PushDialogDbUtil$3(audw paramaudw, atmp paramatmp, PushDialogTemplate paramPushDialogTemplate) {}
  ...
  public void run()
  {
    synchronized (audw.a(this.this$0))
    {
      try
      {
        this.jdField_a_of_type_Atmp.a(this.jdField_a_of_type_ComTencentMobileqqPushdialogPushDialogTemplate);
