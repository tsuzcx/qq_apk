...
public class PushDialogDbUtil$3
  implements Runnable
{
  public PushDialogDbUtil$3(avde paramavde, aukp paramaukp, PushDialogTemplate paramPushDialogTemplate) {}
  ...
  public void run()
  {
    synchronized (avde.a(this.this$0))
    {
      try
      {
        this.jdField_a_of_type_Aukp.a(this.jdField_a_of_type_ComTencentMobileqqPushdialogPushDialogTemplate);
