...
public class PushDialogDbUtil$1
  implements Runnable
{
  public PushDialogDbUtil$1(banf parambanf, EntityManager paramEntityManager, String[] paramArrayOfString, long paramLong1, long paramLong2, bang parambang) {}
  ...
  public void run()
  {
    synchronized (banf.a(this.this$0))
    {
      ...
      if (this.jdField_a_of_type_Bang != null) {
        this.jdField_a_of_type_Bang.a(localList);
      }
      return;
    }
  }
