  ...
  extends MessageMicro<InfoC2SCreateSessionRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 40 }, new String[] { "enum_channel_type", "rpt_msg_interface_list", "bool_client_ans", "uint32_combine_num", "enum_translator_type" }, new Object[] { localInteger, null, Boolean.valueOf(false), Integer.valueOf(0), localInteger }, InfoC2SCreateSessionRsp.class);
  }
}
