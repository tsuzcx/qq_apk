  ...
  extends MessageMicro<IntTransHead>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 32, 40 }, new String[] { "str_session_id", "str_uin", "uint32_seq", "enum_body_type", "uint32_error_no" }, new Object[] { "", "", localInteger, Integer.valueOf(1), localInteger }, IntTransHead.class);
  }
}
