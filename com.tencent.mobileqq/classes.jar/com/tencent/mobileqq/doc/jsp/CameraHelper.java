...
public final class CameraHelper
{
  ...
  public CameraHelper(WebViewPlugin paramWebViewPlugin)
  {
  ...
  private AppActivity a()
  {
    ...
    label38:
    for (Object localObject = null;; localObject = ((WebViewPlugin.PluginRuntime)localObject).a())
    {
  ...
  private void b()
  {
    ...
    localAppActivity.requestPermissions(new CameraHelper.1(this), 1819, new String[] { "android.permission.CAMERA" });
    if (this.jdField_a_of_type_AndroidOsHandler == null) {
      this.jdField_a_of_type_AndroidOsHandler = new CameraHelper.2(this, Looper.getMainLooper());
    }
 ...
 * Qualified Name:     com.tencent.mobileqq.doc.jsp.CameraHelper
