  ...
  implements Manager
{
  ...
  SubAccountMessage a(String paramString)
  {
    ...
    localSubAccountMessage.sendername = HardCodeUtil.a(2131719617);
  ...
  public List<SubAccountMessage> a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      for (localObject1 = null;; localObject1 = "containsKey=" + this.jdField_a_of_type_JavaUtilHashMap.containsKey(paramString))
      {
        ...
        label239:
        if ((localSubAccountConfigBean == null) || (localSubAccountConfigBean.jdField_a_of_type_Boolean) || (!this.jdField_a_of_type_Boolean)) {
          break;
        }
        localArrayList.add(0, a(paramString));
        break;
          ...
          if (paramString2 != null)
          {
            ...
            if (bool)
            {
              ...
              if (localSubAccountMessage.istroop == 1)
              {
                ...
                paramQQAppInterface.getMessageFacade().a(new String[] { AppConstants.SUBACCOUNT_ASSISTANT_UIN, paramString1 });
  ...
  public void a(SubAccountBackProtocData paramSubAccountBackProtocData)
  {
    ...
    label143:
    for (paramSubAccountBackProtocData = "data == null";; paramSubAccountBackProtocData = "data.mMainAccount=" + paramSubAccountBackProtocData.jdField_b_of_type_JavaLangString + " data.mSubUin=" + paramSubAccountBackProtocData.jdField_c_of_type_JavaLangString)
    {
      QLog.d("SUB_ACCOUNT", 2, paramSubAccountBackProtocData);
      return;
      localObject1 = "data.mMainAccount=" + paramSubAccountBackProtocData.jdField_b_of_type_JavaLangString + " data.mSubUin=" + paramSubAccountBackProtocData.jdField_c_of_type_JavaLangString;
      break;
    }
    label183:
    ...
    for (;;)
    {
      try
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          if ((!paramSubAccountBackProtocData.jdField_b_of_type_JavaLangString.equals(((SubAccountInfo)localObject1).trunkuin)) || (!str.equals(((SubAccountInfo)localObject1).subuin))) {
            continue;
          }
  ...
  public void c(String paramString)
  {
    ...
    SubAccountControll.SubAccountUnReadItem localSubAccountUnReadItem;
    int k;
    while (paramString.hasNext())
    {
      ...
      {
        localSubAccountUnReadItem = SubAccountControll.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localSubAccountInfo.subuin);
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getConversationFacade().d(localSubAccountInfo.subuin, 7000, localSubAccountUnReadItem.jdField_a_of_type_Int - j);
      }
    }
    label338:
    ...
    for (;;)
    {
      if (QLog.isColorLevel())
      {
        QLog.d("SUB_ACCOUNT", 2, "updateAnotherSubAccountUnreadMsg" + " info.subuin=" + localSubAccountInfo.subuin + " anotherC2cUnread=" + j + " anotherTroopUnread=" + k + " item.showRedDot=" + localSubAccountUnReadItem.jdField_a_of_type_Boolean + " item.unReadCount=" + localSubAccountUnReadItem.jdField_a_of_type_Int);
        break label198;
        break;
        if ((localSubAccountUnReadItem.jdField_a_of_type_Boolean) && (localSubAccountUnReadItem.jdField_a_of_type_Int != k))
        {
    ...
    for (int i = 1;; i = 0)
    {
      localConversationFacade.b(str, 7000, i);
      break label338;
      break;
    }
  }
