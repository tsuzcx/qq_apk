  ...
  extends MSFServlet
{
  public static NewIntent a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    Object localObject = (SubAccountManager)paramQQAppInterface.getManager(QQManagerFactory.SUB_ACCOUNT_MANAGER);
    if (localObject != null) {}
    for (localObject = ((SubAccountManager)localObject).a(paramString);; localObject = null)
    {
      if ((!TextUtils.isEmpty(paramString)) && (!TextUtils.isEmpty((CharSequence)localObject)))
      {
        localNewIntent = new NewIntent(paramQQAppInterface.getApplication(), SubAccountServlet.class);
  ...
  public void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (bool3)
    {
      try
      {
        ...
        SubAccountControll.a = ((cmd0xe34.RspBody)localObject2).ReqInterval.get();
      ...
      for (j = 1;; j = 0)
      {
        ...
        localObject3 = (SubAccountManager)getAppRuntime().getManager(QQManagerFactory.SUB_ACCOUNT_MANAGER);
        if (localObject3 != null)
        {
          ((SubAccountManager)localObject3).a((SubAccountMessage)localObject2);
          ((SubAccountManager)localObject3).b((SubAccountMessage)localObject2);
          ((SubAccountManager)localObject3).c(((SubAccountMessage)localObject2).subUin);
        }
        localObject2 = new SubAccountBackProtocData();
        ((SubAccountBackProtocData)localObject2).b = paramFromServiceMsg.getUin();
        ((SubAccountBackProtocData)localObject2).jdField_c_of_type_JavaLangString = String.valueOf(l);
  ...
  public void a(Intent paramIntent, Packet paramPacket)
  {
    ...
    do
    {
      ...
      paramPacket.putSendData(WupUtil.a(((oidb_sso.OIDBSSOPkg)localObject1).toByteArray()));
