  ...
  extends OGAbstractDao
{
  ...
  public Entity a(Entity paramEntity, Cursor paramCursor, boolean paramBoolean, NoColumnErrorHandler paramNoColumnErrorHandler)
  {
    ...
    if (i == -1)
    {
      ...
      paramNoColumnErrorHandler.a(new NoColumnError("uint32_group_flag_ext2", Integer.TYPE));
      label1976:
      i = paramCursor.getColumnIndex("isGameRoom");
      if (i != -1) {
        break label2700;
      }
      paramNoColumnErrorHandler.a(new NoColumnError("isGameRoom", Boolean.TYPE));
      i = paramCursor.getColumnIndex("isRobotHotChat");
      if (i != -1) {
        break label2727;
      }
      paramNoColumnErrorHandler.a(new NoColumnError("isRobotHotChat", Boolean.TYPE));
      i = paramCursor.getColumnIndex("robotUin");
      if (i != -1) {
        break label2755;
      }
      paramNoColumnErrorHandler.a(new NoColumnError("robotUin", Long.TYPE));
    }
    for (;;)
    {
      ...
      paramNoColumnErrorHandler.a(new NoColumnError("apolloGameId", Integer.TYPE));
      return paramEntity;
