...
public class DecodeProxy
{
  ...
  public static native String nativeWxDecode(byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7);
