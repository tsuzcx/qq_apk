...
class MessagePBElemDecoder$ParsePBMsgElemsDefaultTextElem
{
  ...
  private MessageInfo jdField_a_of_type_ComTencentMobileqqTroopDataMessageInfo;
  ...
  private AtTroopMemberInfo jdField_b_of_type_ComTencentMobileqqDataAtTroopMemberInfo;
  private StringBuilder jdField_b_of_type_JavaLangStringBuilder;
  
  public MessagePBElemDecoder$ParsePBMsgElemsDefaultTextElem(StringBuilder paramStringBuilder1, long paramLong, MessageInfo paramMessageInfo, ArrayList<AtTroopMemberInfo> paramArrayList, AtTroopMemberInfo paramAtTroopMemberInfo1, AtTroopMemberInfo paramAtTroopMemberInfo2, byte[] paramArrayOfByte, StringBuilder paramStringBuilder2, boolean paramBoolean, im_msg_body.Elem paramElem)
  {
    this.jdField_a_of_type_JavaLangStringBuilder = paramLong;
    this.jdField_a_of_type_Long = ???;
    this.jdField_a_of_type_ComTencentMobileqqTroopDataMessageInfo = paramArrayList;
    this.jdField_a_of_type_JavaUtilArrayList = paramAtTroopMemberInfo1;
    this.jdField_a_of_type_ComTencentMobileqqDataAtTroopMemberInfo = paramAtTroopMemberInfo2;
    this.jdField_b_of_type_ComTencentMobileqqDataAtTroopMemberInfo = paramArrayOfByte;
  ...
  private void a()
  {
    ...
    this.jdField_b_of_type_JavaLangStringBuilder.append(this.jdField_a_of_type_ComTencentMobileqqServiceMessageMessagePBElemDecoder.a((im_msg_body.CommonElem)this.jdField_a_of_type_TencentImMsgIm_msg_body$Elem.common_elem.get()));
  }
  ...
  private void a(int paramInt, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      if ((j < n) && (i < 2048))
      {
        localAtTroopMemberInfo = new AtTroopMemberInfo();
        if ((j == 0) && (this.jdField_a_of_type_ComTencentMobileqqDataAtTroopMemberInfo == null)) {
          this.jdField_a_of_type_ComTencentMobileqqDataAtTroopMemberInfo = localAtTroopMemberInfo;
        }
      ...
      j = m;
      i = k;
      if (localAtTroopMemberInfo.isIncludingMe(MessagePBElemDecoder.a(this.jdField_a_of_type_ComTencentMobileqqServiceMessageMessagePBElemDecoder).a.getLongAccountUin()))
      {
        ...
        j = m;
        i = k;
        if (localAtTroopMemberInfo != this.jdField_a_of_type_ComTencentMobileqqDataAtTroopMemberInfo)
        {
          j = m;
          i = k;
          if (this.jdField_b_of_type_ComTencentMobileqqDataAtTroopMemberInfo == null)
          {
            j = m;
            i = k;
            if (this.jdField_a_of_type_ComTencentMobileqqDataAtTroopMemberInfo.isIncludingMe(MessagePBElemDecoder.a(this.jdField_a_of_type_ComTencentMobileqqServiceMessageMessagePBElemDecoder).a.getLongAccountUin()))
            {
              this.jdField_b_of_type_ComTencentMobileqqDataAtTroopMemberInfo = localAtTroopMemberInfo;
              j = m;
              i = k;
            }
          }
  ...
  @Nullable
  private ParsePBMsgElemsDefaultTextElem b()
  {
    ...
    do
    {
      ...
      {
        localObject1 = MessageUtils.a(((im_msg_body.Text)localObject2).str.get().toStringUtf8(), false);
    ...
    {
      if ((this.jdField_a_of_type_ComTencentMobileqqTroopDataMessageInfo != null) && ((this.jdField_a_of_type_ComTencentMobileqqTroopDataMessageInfo.jdField_a_of_type_Int == 3000) || (this.jdField_a_of_type_ComTencentMobileqqTroopDataMessageInfo.jdField_a_of_type_Int == 1)) && (this.jdField_a_of_type_JavaUtilArrayList != null) && (localObject2 != null) && (localObject2.length != 0)) {
        b(i, (byte[])localObject2);
      }
      localObject1 = localObject3;
      if (this.jdField_a_of_type_ComTencentMobileqqTroopDataMessageInfo == null) {
        break;
      }
      if ((!this.jdField_a_of_type_ComTencentMobileqqTroopDataMessageInfo.jdField_a_of_type_ComTencentMobileqqTroopDataMessageNavInfo.a(24, this.jdField_a_of_type_Long)) && (!this.jdField_a_of_type_ComTencentMobileqqTroopDataMessageInfo.jdField_a_of_type_ComTencentMobileqqTroopDataMessageNavInfo.a(13, this.jdField_a_of_type_Long)))
      {
        localObject1 = localObject3;
        if (this.jdField_b_of_type_ComTencentMobileqqDataAtTroopMemberInfo != null) {
          break;
  ...
  private void b()
  {
    ...
    this.jdField_b_of_type_JavaLangStringBuilder.append(BaseApplication.getContext().getString(2131694638));
  }
  ...
  private void c()
  {
    ...
    char[] arrayOfChar = EmosmUtils.a(i, j);
  ...
  public ParsePBMsgElemsDefaultTextElem a()
  {
    ParsePBMsgElemsDefaultTextElem localParsePBMsgElemsDefaultTextElem1;
    if (this.jdField_a_of_type_TencentImMsgIm_msg_body$Elem.text.has())
    {
      ParsePBMsgElemsDefaultTextElem localParsePBMsgElemsDefaultTextElem2 = b();
      localParsePBMsgElemsDefaultTextElem1 = this;
      if (localParsePBMsgElemsDefaultTextElem2 != null) {
        localParsePBMsgElemsDefaultTextElem1 = localParsePBMsgElemsDefaultTextElem2;
      }
    }
    do
    {
      do
      {
        do
        {
          return localParsePBMsgElemsDefaultTextElem1;
