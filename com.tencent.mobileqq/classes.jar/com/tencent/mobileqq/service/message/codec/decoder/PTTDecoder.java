  ...
  implements Decoder<MessageHandler>
{
  ...
  public void a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, List<MessageRecord> paramList, DecodeProtoPkgContext paramDecodeProtoPkgContext)
  {
    ...
    if (SttManager.a(paramMessageHandler.a))
    {
      ...
      localObject1 = paramDecodeProtoPkgContext;
      paramDecodeProtoPkgContext = (DecodeProtoPkgContext)localObject3;
    }
    label307:
    label335:
    Object localObject4;
    ...
    {
      i1 = i6 + i5;
      localObject3 = paramDecodeProtoPkgContext;
      paramDecodeProtoPkgContext = (DecodeProtoPkgContext)localObject1;
      ...
      if (i2 == 9)
      {
        localObject3 = new byte[i5];
        PkgTools.copyData((byte[])localObject3, 0, (byte[])localObject5, i6, i5);
        n = QQRecorder.b(Utils.a(PkgTools.getLongData((byte[])localObject3, 0)));
        localObject3 = paramDecodeProtoPkgContext;
        paramDecodeProtoPkgContext = (DecodeProtoPkgContext)localObject1;
        localObject1 = localObject3;
      }
      ...
      else
      {
        ...
        try
        {
          ...
          paramDecodeProtoPkgContext = (DecodeProtoPkgContext)localObject4;
        }
        catch (Exception localException)
        {
          localObject2 = paramDecodeProtoPkgContext;
          paramDecodeProtoPkgContext = (DecodeProtoPkgContext)localObject3;
          k = i3;
          j = i2;
          i = i1;
    ...
    for (;;)
    {
      ...
      for (localObject3 = ((ByteStringMicro)localObject3).toStringUtf8();; localObject3 = "")
      {
        ...
        for (i1 = 1;; i1 = 2)
        {
          ReportController.b(paramMessageHandler.a, "CliOper", "", "", "0X80060E4", "0X80060E4", i1, 0, "", "", "", "8.5.5");
          ...
          i = VipUtils.a(paramMessageHandler.a, String.valueOf(l3));
          ...
          VoiceRedPacketHelper.b(paramDecodeProtoPkgContext, (MessageRecord)localObject2);
          return;
        }
      }
      label1250:
      localObject3 = paramDecodeProtoPkgContext;
      paramDecodeProtoPkgContext = (DecodeProtoPkgContext)localObject2;
