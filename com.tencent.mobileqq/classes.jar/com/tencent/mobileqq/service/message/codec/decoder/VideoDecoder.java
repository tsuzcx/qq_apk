  ...
  implements Decoder<MessageHandler>
{
  public void a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, List<MessageRecord> paramList, DecodeProtoPkgContext paramDecodeProtoPkgContext)
  {
        ...
        do
        {
          ...
          do
          {
            do
            {
              ...
              QLog.e("VideoDecoder", 2, "<---decodeC2CMsgPkg_Video return null:hasBody:" + paramMsg.msg_body.has() + ",hasMsgContent" + ((im_msg_body.MsgBody)paramMsg.msg_body.get()).msg_content.has() + ",isReaded:" + paramDecodeProtoPkgContext.a + "syncOther:" + paramDecodeProtoPkgContext.f);
              return;
              ...
              l3 = Long.valueOf(paramMessageHandler.a.getCurrentAccountUin()).longValue();
    ...
    } while (!VcSystemInfo.isSupportSharpAudio());
