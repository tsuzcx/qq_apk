  ...
  implements Decoder<MessageHandler>
{
  ...
  private void a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, long paramLong1, boolean paramBoolean1, boolean paramBoolean2, long paramLong2, int paramInt)
  {
    ...
    String str2 = paramMessageHandler.a.getCurrentAccountUin();
    if (i == 129)
    {
      paramMsg = str1;
  ...
  {
    a(paramMessageHandler, paramMsg, paramDecodeProtoPkgContext.e, paramDecodeProtoPkgContext.jdField_a_of_type_Boolean, paramDecodeProtoPkgContext.b, paramDecodeProtoPkgContext.d, paramDecodeProtoPkgContext.jdField_a_of_type_Int);
  }
}
