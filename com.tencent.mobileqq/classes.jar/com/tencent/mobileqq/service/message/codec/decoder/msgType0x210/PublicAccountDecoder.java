...
public class PublicAccountDecoder
  implements SubTypeDecoder
{
  ...
  {
    ((PublicAccountHandler)paramMessageHandler.a.getBusinessHandler(BusinessHandlerFactory.HANDLER_PUBLIC_ACCOUNT)).a(paramMsgType0x210.sub_msg_type.get(), paramMsgType0x210.msg_content.get().toByteArray());
  }
}
