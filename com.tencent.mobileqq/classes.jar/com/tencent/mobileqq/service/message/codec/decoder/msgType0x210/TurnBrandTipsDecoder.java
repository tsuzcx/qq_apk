  ...
  public void a(msg_comm.MsgType0x210 paramMsgType0x210, msg_comm.Msg paramMsg, List<MessageRecord> paramList, DecodeProtoPkgContext paramDecodeProtoPkgContext, MessageHandler paramMessageHandler)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        paramMsgType0x210 = (DatingProxyManager)paramMessageHandler.a.getManager(QQManagerFactory.DATING_PROXY_MANAGER);
        if (paramMsgType0x210 != null) {
    ...
    for (;;)
    {
      ...
      paramList = ((TicketManager)paramMessageHandler.a.getManager(2)).getSkey(paramMsgType0x210);
      ((VipInfoHandler)paramMessageHandler.a.getBusinessHandler(BusinessHandlerFactory.VIPINFO_HANDLER)).a(paramList, paramMsgType0x210);
      break;
      if ((i == 2003) && (paramMsgType0x210.msg_push_lost_dev_found.has()))
      {
        ...
        ((SmartDeviceProxyMgr)paramMessageHandler.a.getBusinessHandler(BusinessHandlerFactory.DEVICEPROXYMGR_HANDLER)).a(111, paramList);
        break;
      }
      ...
      if (i == 1)
      {
        ...
        paramList.upTime = MessageCache.a();
        paramList.source = paramMsgType0x210.bytes_src_wording.get().toStringUtf8();
        ((NewFriendManager)paramMessageHandler.a.getManager(QQManagerFactory.NEW_FRIEND_MANAGER)).b(paramList);
        break;
      }
      ...
      {
        paramDecodeProtoPkgContext = (SubMsgType0x6f.VideoInfo)paramMsgType0x210.rpt_msg_video_info.get(i);
        QIMNotifyAddFriend.VideoInfo localVideoInfo = new QIMNotifyAddFriend.VideoInfo();
        localVideoInfo.coverUrl = paramDecodeProtoPkgContext.bytes_video_cover_url.get().toStringUtf8();
        localVideoInfo.videoVid = paramDecodeProtoPkgContext.bytes_vid.get().toStringUtf8();
        paramList.videoInfos.add(localVideoInfo);
        i += 1;
      }
      paramList.pushTime = MessageCache.a();
      if (QLog.isColorLevel()) {
        QLog.d("QIMNewNotifyPush_offLine", 2, "receive data= " + paramList.toString());
      }
      ((QIMNewFriendManager)paramMessageHandler.a.getManager(QQManagerFactory.QIM_NEW_FRIEND_MANAGER)).a(paramList);
      break;
      label1337:
      j = 0;
      break label518;
