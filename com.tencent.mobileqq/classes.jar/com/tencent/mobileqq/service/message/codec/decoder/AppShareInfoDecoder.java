  ...
  public static void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg, long paramLong1, long paramLong2, boolean paramBoolean)
  {
    ...
    if (paramMsg.appshare_info.has())
    {
      ...
      if (localObject2 == null)
      {
        ...
        paramMessageHandler.a.getMsgCache().a(((AppShareID)localObject1).strPkgName, (AppShareID)localObject1);
      }
    }
    label296:
    label1779:
    ...
    for (int i = 1;; i = 0)
    {
      ...
      if ((paramMsg.msg_body.has()) && (((im_msg_body.MsgBody)paramMsg.msg_body.get()).rich_text.has()))
      {
        ...
        paramMsg = null;
        localObject1 = BaseApplication.getContext().getString(2131719157);
            ...
            for (;;)
            {
              ...
              for (;;)
              {
                ...
                else if (((im_msg_body.Elem)localObject3).custom_face.has())
                {
                  ...
                  localObject1 = "http://quntu.3g.qq.com/cgi/svr/chatimg/get?pic=" + (String)localObject1 + "&gid=" + paramLong1 + "&time=" + paramLong2 + "&msfid=" + paramMessageHandler.a.getCurrentAccountUin();
                  ...
                  for (;;)
                  {
                    ...
                    localObject2 = ActionMsgUtil.a((String)localObject1, (String)localObject2, l1, paramMsg.a);
                    if (QLog.isColorLevel()) {
