  ...
  implements Decoder<MessageHandler>
{
  private void a(MessageHandler paramMessageHandler, byte[] paramArrayOfByte)
  {
    ...
    paramArrayOfByte = (HotChatHandler)paramMessageHandler.a.getBusinessHandler(BusinessHandlerFactory.HOT_CHAT_HANDLER);
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          } while (!((TroopGagMgr)paramMessageHandler.a.getManager(QQManagerFactory.TROOP_GAG_MANAGER)).a((byte[])localObject2, i));
          MessageProtoCodec.a(paramMessageHandler.a.getMsgHandler(), l1, i, l2, j);
          return;
          ...
          {
            TroopTipsMsgMgr localTroopTipsMsgMgr = (TroopTipsMsgMgr)paramMessageHandler.a.getManager(QQManagerFactory.TROOP_TIPS_MSG_MANAGER);
            byte[] arrayOfByte = new byte[localObject1.length - 7];
            PkgTools.copyData(arrayOfByte, 0, (byte[])localObject1, 7, arrayOfByte.length);
            paramList.add(localTroopTipsMsgMgr.a(paramMessageHandler.a, arrayOfByte, i, paramMsg.msg_head.msg_time.get(), true, paramDecodeProtoPkgContext.d, (MsgType0x2dcDecoder.Parse0x2dcContext)localObject2));
          }
        } while (!((MsgType0x2dcDecoder.Parse0x2dcContext)localObject2).a);
        MessageProtoCodec.a(paramMessageHandler.a.getMsgHandler(), l1, i, l2, j);
