  ...
  extends BaseProtocolCoder
{
  ...
  private static ConcurrentHashMap<String, JceProtocol> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  public static void a(JceProtocol paramJceProtocol, String paramString)
  {
    jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString, paramJceProtocol);
  }
  ...
  public Object decode(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    else
    {
      ...
      if (jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(JceProtocol.a(paramToServiceMsg)))
      {
        paramToServiceMsg = ((JceProtocol)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(JceProtocol.a(paramToServiceMsg))).a(paramToServiceMsg, paramFromServiceMsg, localUniPacket);
        return paramToServiceMsg;
      }
      return null;
      paramToServiceMsg = paramFromServiceMsg;
  ...
  public boolean encodeReqMsg(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    } while (!jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(JceProtocol.a(paramToServiceMsg)));
    Object localObject = (JceProtocol)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(JceProtocol.a(paramToServiceMsg));
    int i = jdField_a_of_type_Int;
    jdField_a_of_type_Int = i + 1;
    ((JceProtocol)localObject).a(paramToServiceMsg, paramUniPacket, i);
    return true;
  }
}
