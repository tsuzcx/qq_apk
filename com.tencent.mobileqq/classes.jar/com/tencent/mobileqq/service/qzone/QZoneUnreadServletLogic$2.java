  ...
  implements Runnable
{
  ...
  public void run()
  {
    try
    {
      MobileCommConf localMobileCommConf = (MobileCommConf)awbz.a(MobileCommConf.class, (byte[])this.a.mapTransData.get("ZengzhiCommConf"));
      bgsd.a().a(localMobileCommConf);
      return;
    }
