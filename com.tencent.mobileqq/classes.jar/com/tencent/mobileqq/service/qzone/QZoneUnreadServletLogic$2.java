  ...
  implements Runnable
{
  ...
  public void run()
  {
    try
    {
      MobileCommConf localMobileCommConf = (MobileCommConf)bcbv.a(MobileCommConf.class, (byte[])this.a.mapTransData.get("ZengzhiCommConf"));
      bmwq.a().a(localMobileCommConf);
      return;
    }
