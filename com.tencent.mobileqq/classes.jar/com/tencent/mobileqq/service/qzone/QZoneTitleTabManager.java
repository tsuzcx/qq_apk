...
public class QZoneTitleTabManager
{
  ...
  private static ArrayList<QZoneTitleTabManager.TabInfo> a(ArrayList<QZoneTitleTabManager.TabInfo> paramArrayList)
  {
      ...
      if (paramArrayList.size() == 1)
      {
        ...
        if ((localTabInfo != null) && (localTabInfo.jdField_a_of_type_Int == 50))
        {
          ...
          if (TextUtils.isEmpty((CharSequence)localObject1)) {
            paramArrayList = ajyc.a(2131720020);
          }
    ...
    for (((QZoneTitleTabManager.TabInfo)localObject2).jdField_a_of_type_JavaLangString = ajyc.a(2131712379);; ((QZoneTitleTabManager.TabInfo)localObject2).jdField_a_of_type_JavaLangString = ajyc.a(2131712380))
    {
  ...
  static boolean a(QZoneTitleTabManager.TabInfo paramTabInfo)
  {
    ...
    do
    {
      ...
      {
        return false;
        if ((nam.a(paramTabInfo.jdField_b_of_type_JavaLangString)) && (!TextUtils.isEmpty(paramTabInfo.jdField_a_of_type_JavaLangString))) {
          return true;
        }
      ...
      {
        if (!nam.a(paramTabInfo.jdField_b_of_type_JavaLangString)) {
