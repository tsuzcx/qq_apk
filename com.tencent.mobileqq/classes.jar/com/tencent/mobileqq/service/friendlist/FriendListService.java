  ...
  extends BaseProtocolCoder
{
  ...
  private boolean c(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    if (l == 0L) {}
    for (paramToServiceMsg = new GetOnlineInfoReq(l, paramToServiceMsg.extraData.getLong("dwUin"), null, 31L, true);; paramToServiceMsg = new GetOnlineInfoReq(l, 0L, paramToServiceMsg.extraData.getString("strMobile"), 7L, false))
    {
      paramUniPacket.setServantName("mqq.IMService.FriendListServiceServantObj");
  ...
  private boolean f(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    if ((i == 2007) || (i == 3007) || (i == 4007) || (i == 2017) || (i == 3017)) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAVNotifyCenter().a(Long.valueOf(paramToServiceMsg).longValue(), true, i);
    }
    Object localObject1;
    ...
    for (;;)
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        ((StringBuilder)localObject1).append("handleAddFriend [uin: ").append(Utils.a(paramToServiceMsg)).append(", source_id: ").append(i).append(", sub_source_id: ").append(j);
        if (i == 3004)
        {
      ...
      catch (UnsupportedEncodingException localUnsupportedEncodingException1)
      {
        try
        {
          for (;;)
          {
            ...
            if (QLog.isColorLevel()) {
              QLog.i("FriendListService", 2, "handleAddFriend bSupportSecureTips: " + localAddFriendReq.bSupportSecureTips);
            }
            paramUniPacket.setServantName("mqq.IMService.FriendListServiceServantObj");
  ...
  private boolean i(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    Bundle localBundle = paramToServiceMsg.extraData;
    Object localObject = localBundle.getStringArray("uins");
    paramToServiceMsg = (ToServiceMsg)localObject;
    if (localObject == null) {
      paramToServiceMsg = new String[0];
    }
    localObject = new MovGroupMemReq();
    ((MovGroupMemReq)localObject).uin = l;
    ((MovGroupMemReq)localObject).reqtype = 1;
    for (;;)
    {
      try
      {
      ...
      ((MovGroupMemReq)localObject).vecBody = paramToServiceMsg;
      paramUniPacket.setServantName("mqq.IMService.FriendListServiceServantObj");
      paramUniPacket.setFuncName("MovGroupMemReq");
      paramUniPacket.put("MovGroupMemReq", localObject);
      return true;
      j = localBundle.getByte("group_id");
      if (j >= 0)
      {
  ...
  private boolean m(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    for (int i = 0;; i = 1)
    {
      ...
      paramToServiceMsg = new GetFriendListReq(3, (byte)i, Long.valueOf(paramToServiceMsg.getUin()).longValue(), s1, s2, (byte)0, (byte)i, b1, b2, (byte)0, b3, 31L, null, 0, (byte)0, (byte)0, localReqBody.toByteArray(), localReqBody1.toByteArray(), localArrayList);
      paramUniPacket.setServantName("mqq.IMService.FriendListServiceServantObj");
      paramUniPacket.setFuncName("GetFriendListReq");
  ...
  private boolean p(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    //   0: aload_2
    //   1: ldc 208
    //   3: invokevirtual 142	com/qq/jce/wup/UniPacket:setServantName	(Ljava/lang/String;)V
    //   6: aload_2
    //   7: ldc_w 858
    //   10: invokevirtual 147	com/qq/jce/wup/UniPacket:setFuncName	(Ljava/lang/String;)V
    //   13: new 860	friendlist/SetGroupReq
    //   16: dup
    //   17: invokespecial 861	friendlist/SetGroupReq:<init>	()V
    //   20: astore 4
    //   22: aload 4
    //   24: aload_1
    //   25: invokevirtual 65	com/tencent/qphone/base/remote/ToServiceMsg:getUin	()Ljava/lang/String;
    //   28: invokestatic 55	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   31: putfield 862	friendlist/SetGroupReq:uin	J
    //   34: aload 4
    //   36: aload_1
    //   37: getfield 71	com/tencent/qphone/base/remote/ToServiceMsg:extraData	Landroid/os/Bundle;
    //   40: ldc_w 864
    //   43: invokevirtual 79	android/os/Bundle:getInt	(Ljava/lang/String;)I
    //   46: putfield 865	friendlist/SetGroupReq:reqtype	I
    //   49: new 644	java/io/ByteArrayOutputStream
    //   52: dup
    //   53: bipush 10
    //   55: invokespecial 645	java/io/ByteArrayOutputStream:<init>	(I)V
    //   58: astore 5
    //   60: new 647	java/io/DataOutputStream
    //   63: dup
    //   64: aload 5
    //   66: invokespecial 650	java/io/DataOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   69: astore 6
    //   71: aload 4
    //   73: getfield 865	friendlist/SetGroupReq:reqtype	I
    //   76: tableswitch	default:+371 -> 447, 0:+32->108, 1:+140->216, 2:+225->301, 3:+262->338
    //   109: iconst_0
    //   110: dadd
    //   111: dup
    //   112: invokespecial 868	friendlist/AddGroup:<init>	()V
    //   115: astore 7
    //   117: aload 7
    //   119: aload_1
    //   120: getfield 71	com/tencent/qphone/base/remote/ToServiceMsg:extraData	Landroid/os/Bundle;
    //   123: ldc_w 870
    //   126: invokevirtual 100	android/os/Bundle:getByte	(Ljava/lang/String;)B
    //   129: putfield 873	friendlist/AddGroup:cSortId	B
    //   132: aload 7
    //   134: aload_1
    //   135: getfield 71	com/tencent/qphone/base/remote/ToServiceMsg:extraData	Landroid/os/Bundle;
    //   138: ldc_w 875
    //   141: invokevirtual 106	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   144: putfield 878	friendlist/AddGroup:sGroupName	Ljava/lang/String;
    //   147: aload 7
    //   149: getfield 878	friendlist/AddGroup:sGroupName	Ljava/lang/String;
    //   152: invokevirtual 341	java/lang/String:getBytes	()[B
    //   155: astore_1
    //   156: aload 7
    //   158: aload_1
    //   159: arraylength
    //   160: i2b
    //   161: putfield 881	friendlist/AddGroup:cLen	B
    //   164: aload 6
    //   166: aload 7
    //   168: getfield 873	friendlist/AddGroup:cSortId	B
    //   171: invokevirtual 653	java/io/DataOutputStream:writeByte	(I)V
    //   174: aload 6
    //   176: aload 7
    //   178: getfield 881	friendlist/AddGroup:cLen	B
    //   181: invokevirtual 653	java/io/DataOutputStream:writeByte	(I)V
    //   184: aload 6
    //   186: aload_1
    //   187: invokevirtual 884	java/io/DataOutputStream:write	([B)V
    //   190: aload 6
    //   192: invokevirtual 662	java/io/DataOutputStream:close	()V
    //   195: aload 4
    //   197: aload 5
    //   199: invokevirtual 663	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   202: putfield 885	friendlist/SetGroupReq:vecBody	[B
    //   205: aload_2
    //   206: ldc_w 858
    //   209: aload 4
    //   211: invokevirtual 153	com/qq/jce/wup/UniPacket:put	(Ljava/lang/String;Ljava/lang/Object;)V
    //   214: iconst_1
    //   215: ireturn
    //   216: new 887	friendlist/RenameGroup
    //   219: dup
    //   220: invokespecial 888	friendlist/RenameGroup:<init>	()V
    //   223: astore 7
    //   225: aload 7
    //   227: aload_1
    //   228: getfield 71	com/tencent/qphone/base/remote/ToServiceMsg:extraData	Landroid/os/Bundle;
    //   231: ldc_w 398
    //   234: invokevirtual 100	android/os/Bundle:getByte	(Ljava/lang/String;)B
    //   237: putfield 891	friendlist/RenameGroup:cGroupId	B
    //   240: aload 7
    //   242: aload_1
    //   243: getfield 71	com/tencent/qphone/base/remote/ToServiceMsg:extraData	Landroid/os/Bundle;
    //   246: ldc_w 875
    //   249: invokevirtual 106	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   252: putfield 892	friendlist/RenameGroup:sGroupName	Ljava/lang/String;
    //   255: aload 7
    //   257: getfield 892	friendlist/RenameGroup:sGroupName	Ljava/lang/String;
    //   260: invokevirtual 341	java/lang/String:getBytes	()[B
    //   263: astore_1
    //   264: aload 7
    //   266: aload_1
    //   267: arraylength
    //   268: i2b
    //   269: putfield 893	friendlist/RenameGroup:cLen	B
    //   272: aload 6
    //   274: aload 7
    //   276: getfield 891	friendlist/RenameGroup:cGroupId	B
    //   279: invokevirtual 895	java/io/DataOutputStream:write	(I)V
    //   282: aload 6
    //   284: aload 7
    //   286: getfield 893	friendlist/RenameGroup:cLen	B
    //   289: invokevirtual 653	java/io/DataOutputStream:writeByte	(I)V
    //   292: aload 6
    //   294: aload_1
    //   295: invokevirtual 884	java/io/DataOutputStream:write	([B)V
    //   298: goto -108 -> 190
    //   301: new 897	friendlist/DelGroup
    //   304: dup
    //   305: invokespecial 898	friendlist/DelGroup:<init>	()V
    //   308: astore 7
    //   310: aload 7
    //   312: aload_1
    //   313: getfield 71	com/tencent/qphone/base/remote/ToServiceMsg:extraData	Landroid/os/Bundle;
    //   316: ldc_w 398
    //   319: invokevirtual 100	android/os/Bundle:getByte	(Ljava/lang/String;)B
    //   322: putfield 899	friendlist/DelGroup:cGroupId	B
    //   325: aload 6
    //   327: aload 7
    //   329: getfield 899	friendlist/DelGroup:cGroupId	B
    //   332: invokevirtual 653	java/io/DataOutputStream:writeByte	(I)V
    //   335: goto -145 -> 190
    //   338: new 901	friendlist/ReSortGroup
    //   341: dup
    //   342: invokespecial 902	friendlist/ReSortGroup:<init>	()V
    //   345: astore 7
    //   347: aload 7
    //   349: aload_1
    //   350: getfield 71	com/tencent/qphone/base/remote/ToServiceMsg:extraData	Landroid/os/Bundle;
    //   353: ldc_w 904
    //   356: invokevirtual 94	android/os/Bundle:getByteArray	(Ljava/lang/String;)[B
    //   359: putfield 906	friendlist/ReSortGroup:cGroupId	[B
    //   362: aload 7
    //   364: aload_1
    //   365: getfield 71	com/tencent/qphone/base/remote/ToServiceMsg:extraData	Landroid/os/Bundle;
    //   368: ldc_w 908
    //   371: invokevirtual 94	android/os/Bundle:getByteArray	(Ljava/lang/String;)[B
    //   374: putfield 910	friendlist/ReSortGroup:cSortId	[B
    //   377: aload 7
    //   379: aload 7
    //   381: getfield 906	friendlist/ReSortGroup:cGroupId	[B
    //   384: arraylength
    //   385: i2b
    //   386: putfield 913	friendlist/ReSortGroup:cNum	B
    //   389: aload 6
    //   391: aload 7
    //   393: getfield 913	friendlist/ReSortGroup:cNum	B
    //   396: invokevirtual 653	java/io/DataOutputStream:writeByte	(I)V
    //   399: aload 7
    //   401: getfield 906	friendlist/ReSortGroup:cGroupId	[B
    //   404: astore_1
    //   405: aload 7
    //   407: getfield 910	friendlist/ReSortGroup:cSortId	[B
    //   410: astore 7
    //   412: iconst_0
    //   413: istore_3
    //   414: iload_3
    ...
    //   423: iload_3
    //   424: baload
    //   425: invokevirtual 653	java/io/DataOutputStream:writeByte	(I)V
    //   428: aload 6
    //   430: aload 7
    //   432: iload_3
    //   433: baload
    //   434: invokevirtual 653	java/io/DataOutputStream:writeByte	(I)V
    //   437: iload_3
    //   438: iconst_1
    //   439: iadd
    //   440: istore_3
