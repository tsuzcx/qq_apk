...
{
  public static final Parcelable.Creator<BusinessBuff> CREATOR = new ayze();
  ...
  public static SparseArray<ayzf> a(ArrayList<byte[]> paramArrayList)
  {
    ...
    if ((paramArrayList != null) && (paramArrayList.size() > 0))
    {
      ...
      if (i < paramArrayList.size())
      {
        ...
        for (;;)
        {
          ...
          break label58;
          label86:
          int k = (int)bdqa.a((byte[])localObject4, 1);
          int m = (int)bdqa.a((byte[])localObject4, 5);
          localObject2 = localObject1;
          if (k > 0)
          {
            localObject2 = localObject1;
            if (k + 9 < j)
            {
              ...
              bdqa.a((byte[])localObject2, 0, (byte[])localObject4, 9, k);
              if (m > 0)
              {
                localObject1 = new byte[m];
                bdqa.a((byte[])localObject1, 0, (byte[])localObject4, k + 9, m);
              }
              ...
              try
              {
                ...
                if (((SummaryCardBusiEntry.comm)localObject4).result.get() == 0) {
                  localSparseArray.put(((SummaryCardBusiEntry.comm)localObject4).service.get(), new ayzf((SummaryCardBusiEntry.comm)localObject4, (byte[])localObject1));
                }
                localObject2 = localObject1;
              }
