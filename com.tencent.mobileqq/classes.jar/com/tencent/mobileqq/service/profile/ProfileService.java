  ...
  extends BaseProtocolCoder
{
  ...
  private boolean e(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    if (bool)
    {
      ...
      while (paramToServiceMsg.hasNext())
      {
        ...
        if ((((CheckUpdateItemInterface)localObject).a() & i) != 0)
        {
    ...
    paramToServiceMsg = (CheckUpdateItemInterface)((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface).a.a().get(Integer.valueOf(101));
  ...
  private boolean o(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    for (int m = 1;; m = 0)
    {
      ...
      if (localInteger != null)
      {
        PkgTools.a(arrayOfByte, j, (short)20031);
        i = j + 2;
        PkgTools.a(arrayOfByte, i, (short)4);
        i += 2;
        PkgTools.a(arrayOfByte, i, localInteger.intValue());
        i += 4;
      }
      j = i;
      if (localByte != null)
      {
        PkgTools.a(arrayOfByte, i, (short)20009);
        i += 2;
        PkgTools.a(arrayOfByte, i, (short)1);
        i += 2;
      ...
      {
        PkgTools.a(arrayOfByte, j, (short)20032);
        i = j + 2;
        PkgTools.a(arrayOfByte, i, (short)12);
        i += 2;
        PkgTools.a(arrayOfByte, i, arrayOfInteger[0].intValue());
        i += 4;
        PkgTools.a(arrayOfByte, i, arrayOfInteger[1].intValue());
        i += 4;
        PkgTools.a(arrayOfByte, i, arrayOfInteger[2].intValue());
      }
  ...
  private boolean w(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    localGroupMngReq.uin = l1;
    long l2 = a(paramToServiceMsg.extraData.getString("troop_uin"));
    String str1 = paramToServiceMsg.extraData.getString("back_msg");
    int i = str1.getBytes().length;
    String str2 = paramToServiceMsg.extraData.getString("join_group_key");
    byte[] arrayOfByte = paramToServiceMsg.extraData.getByteArray("new_Member_Msg");
    String str3 = paramToServiceMsg.extraData.getString("pic_url");
    ByteBuffer localByteBuffer = ByteBuffer.allocate(i + 9);
    localByteBuffer.putInt((int)l2);
    localByteBuffer.putInt((int)l1);
    localByteBuffer.put((byte)i);
    localByteBuffer.put(str1.getBytes());
    localGroupMngReq.vecBody = localByteBuffer.array();
    i = paramToServiceMsg.extraData.getInt("stat_option");
    localGroupMngReq.wSourceSubID = i;
    localGroupMngReq.wSourceID = 3;
    localGroupMngReq.sJoinGroupKey = str2;
    if (!TextUtils.isEmpty(str3)) {
      localGroupMngReq.sJoinGroupPicUrl = str3;
    }
    if (arrayOfByte != null) {
