  ...
  extends BaseProtocolCoder
{
  ...
  public ProfileService()
  {
    ...
    this.requestHandles.put("ProfileService.ReqGetSettings", Integer.valueOf(4));
    this.requestHandles.put("ProfileService.ReqSetSettings", Integer.valueOf(5));
  ...
  private boolean d(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    if (bool)
    {
      ...
      while (paramToServiceMsg.hasNext())
      {
        ...
        {
          localObject = ((CheckUpdateItemInterface)localObject).a(i);
          if (localObject != null)
          {
            if (QLog.isColorLevel()) {
  ...
  {
    Object localObject;
    switch (((Integer)this.requestHandles.get(paramToServiceMsg.getServiceCmd())).intValue())
    {
    case 6: 
    case 9: 
    case 10: 
  ...
  {
    Integer localInteger = (Integer)this.requestHandles.get(paramFromServiceMsg.getServiceCmd());
    int i;
