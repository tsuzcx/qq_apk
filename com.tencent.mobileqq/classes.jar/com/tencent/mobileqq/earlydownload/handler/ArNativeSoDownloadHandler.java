  ...
  extends EarlyHandler
{
  ...
  {
    super("qq.android.ar.native.so_v7.6.5.2", paramQQAppInterface);
  }
  ...
  public void a(XmlData paramXmlData)
  {
    ...
    try
    {
      ...
      if (((SharedPreferences)localObject1).getBoolean("qq.android.ar.native.so_v7.6.5.2", true))
      {
        ((SharedPreferences)localObject1).edit().putBoolean("qq.android.ar.native.so_v7.6.5.2", false).commit();
        ...
        while (i < j)
        {
          ...
          if ((localObject2.isFile()) && (localObject2.getName().startsWith("libArMapEngine")) && (!localObject2.getName().contains("ArMapEngine7652")))
          {
            localObject2.delete();
            if (QLog.isColorLevel()) {
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        str = BaseApplicationImpl.sApplication.getSharedPreferences("mobileQQ", 0).getString("ar_native_ArMapEngine7652", "");
        if (!TextUtils.isEmpty(str))
        {
          ...
          localObject = "0";
          ReportController.b(localQQAppInterface, "dc01440", "", "", "0X8007A3D", "0X8007A3D", 0, 0, "", String.valueOf(i), (String)localObject, "qq.android.ar.native.so_v7.6.5.2");
          localObject = new HashMap();
          ((HashMap)localObject).put("config_version", String.valueOf(a().Version));
          ((HashMap)localObject).put("md5", str);
          ((HashMap)localObject).put("res_name", "qq.android.ar.native.so_v7.6.5.2");
