...
public class AppleEmojiHandler$1
  implements Runnable
{
  public AppleEmojiHandler$1(asbr paramasbr, File paramFile, String paramString) {}
  ...
  public void run()
  {
    ...
    for (String str = PreferenceManager.getDefaultSharedPreferencesName(localBaseApplication);; str = localBaseApplication.getPackageName() + "_preferences")
    {
      ...
      begp.a(this.jdField_a_of_type_JavaIoFile);
      asbr.a(this.this$0, this.jdField_a_of_type_JavaLangString);
      return;
    }
  }
}
