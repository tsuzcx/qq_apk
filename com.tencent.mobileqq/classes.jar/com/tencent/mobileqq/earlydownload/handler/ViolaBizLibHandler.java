  ...
  extends EarlyHandler
{
  ...
  public static void f()
  {
    ...
    if ((localObject instanceof QQAppInterface))
    {
      ...
      if (localObject != null)
      {
        localObject = (ViolaBizLibHandler)((EarlyDownloadManager)localObject).a("android.qq.readinjoy.viola_biz_810");
        if (localObject != null)
        {
  ...
  public void a(String paramString)
  {
    ...
    } while ((!ViolaLibHandler.i()) || (!ViolaSoLoaderManager.a.a().b()));
 ...
 * Qualified Name:     com.tencent.mobileqq.earlydownload.handler.ViolaBizLibHandler
