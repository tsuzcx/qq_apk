  ...
  extends EarlyHandler
{
  ...
  public boolean i()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("PttSilkAndChangeVoiceSoHandler", 2, "isUserNeedDownload cpuArch = " + i + " isUserNeedDownload try match version=" + "7.6.0" + " data.version=" + ((PttSilkAndChangeVoiceSoData)localObject).version);
    }
