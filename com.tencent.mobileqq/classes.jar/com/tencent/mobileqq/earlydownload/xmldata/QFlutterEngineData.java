  ...
  implements FilesListHolder
{
  ...
  public static final String STR_RES_NAME = "qq.android.flutter.engine.v8.7.0_release";
  ...
  {
    return new QFlutterDownloader("qq.android.flutter.engine.v8.7.0_release", paramQQAppInterface, new QFlutterDownloader.DownloadConfig(QFlutterEngineData.class, QFlutterEngineData.class.getSimpleName(), 10092, "prd", 0));
  }
  ...
  {
    String str = QFlutterResConfigProcessor.a().a("qq.android.flutter.engine.v8.7.0_release");
