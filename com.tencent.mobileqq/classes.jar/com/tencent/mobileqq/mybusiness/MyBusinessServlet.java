  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    if (1 == i) {
      try
      {
        ...
        SosoInterface.a(new adyc(this, 0, false, true, 60000L, false, false, "MyBusinessServlet"));
    ...
    while (2 != i)
    {
      ...
      for (;;)
      {
        localObject1 = new ReqCarrier((String)localObject2, i, (LBSInfo)localObject1, str, "7.6.0", 1);
    ...
    paramIntent = new PreLoadCarrierReq(paramIntent, i, 1, "7.6.0.3525", NetworkUtil.a(BaseApplication.getContext()));
