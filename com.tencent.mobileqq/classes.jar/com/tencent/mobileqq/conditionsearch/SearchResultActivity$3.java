...
class SearchResultActivity$3
  implements ConditionSearchManager.ISearchListener
{
  SearchResultActivity$3(SearchResultActivity paramSearchResultActivity) {}
  ...
  public void a(boolean paramBoolean1, List<CondFitUser> paramList, boolean paramBoolean2, int paramInt)
  {
    ...
    if (paramInt == 3) {
      ...
      {
        this.a.b = 3;
        this.a.jdField_a_of_type_ComTencentMobileqqConditionsearchSearchResultActivity$DataAdapter.notifyDataSetChanged();
      }
    }
    while (paramInt != 2)
    {
 ...
 * Qualified Name:     com.tencent.mobileqq.conditionsearch.SearchResultActivity.3
