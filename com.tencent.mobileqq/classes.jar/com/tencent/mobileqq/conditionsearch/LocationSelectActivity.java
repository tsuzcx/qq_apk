  ...
  implements View.OnClickListener
{
  ...
  private ajzm jdField_a_of_type_Ajzm = new ammq(this);
  amnf jdField_a_of_type_Amnf = new ammo(this);
  amng jdField_a_of_type_Amng = new ammn(this);
  DialogInterface.OnDismissListener jdField_a_of_type_AndroidContentDialogInterface$OnDismissListener = new ammr(this);
  public Handler a;
  public bfol a;
  ...
  public LocationSelectActivity()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new ammp(this);
  }
  ...
  private void a(FormSimpleItem paramFormSimpleItem, boolean paramBoolean)
  {
    ...
    for (int i = 2;; i = 0)
    {
      ...
      if ((!paramBoolean) && (AppSetting.d)) {
        this.jdField_c_of_type_ComTencentMobileqqWidgetFormSimpleItem.setContentDescription(ajyc.a(2131706307));
      }
      return;
    }
  }
  ...
  private void a(String[] paramArrayOfString)
  {
    ...
    {
      paramArrayOfString = this.jdField_a_of_type_Ajty.a(paramArrayOfString);
  ...
  private String[] a()
  {
    ...
    if (this.jdField_a_of_type_ArrayOfComTencentMobileqqConditionsearchDataBaseAddress != null)
    {
      ...
      while (i < j)
      {
        ...
        arrayOfString[(localBaseAddress.addressType - 1)] = String.valueOf(ajty.a(localBaseAddress.code));
        i += 1;
      }
    }
  ...
  private void c()
  {
    ...
    {
      b();
      if ((this.jdField_c_of_type_Int != 0) || (!this.jdField_a_of_type_Ajty.b()) || ((arrayOfString != null) && (!arrayOfString[0].equals("0")))) {
        break label51;
      }
    }
    for (;;)
  ...
  private void d()
  {
    this.jdField_a_of_type_ComTencentMobileqqConditionsearchDataBaseAddress = this.jdField_a_of_type_Ajty.a(this.jdField_a_of_type_JavaLangString);
  ...
  private void e()
  {
    ...
    {
      setRightHighlightButton(2131692600, new amml(this));
      enableRightHighlight(true);
      this.leftView.setVisibility(8);
      this.jdField_a_of_type_ComTencentMobileqqWidgetFormSimpleItem = ((FormSimpleItem)findViewById(2131364600));
      this.jdField_b_of_type_ComTencentMobileqqWidgetFormSimpleItem = ((FormSimpleItem)findViewById(2131364599));
      this.jdField_c_of_type_ComTencentMobileqqWidgetFormSimpleItem = ((FormSimpleItem)findViewById(2131364601));
      ...
      this.jdField_a_of_type_ComTencentMobileqqWidgetFormSimpleItem.setLeftText(getResources().getString(2131691030));
      ...
      if (AppSetting.d) {
        this.jdField_a_of_type_ComTencentMobileqqWidgetFormSimpleItem.setContentDescription(ajyc.a(2131706303));
      }
      this.jdField_b_of_type_ComTencentMobileqqWidgetFormSimpleItem.setLeftIcon(null);
      this.jdField_b_of_type_ComTencentMobileqqWidgetFormSimpleItem.setLeftText(getResources().getString(2131691021));
      if (this.jdField_a_of_type_ComTencentMobileqqConditionsearchDataBaseAddress == null) {
        break label488;
      }
      if (this.jdField_a_of_type_ComTencentMobileqqConditionsearchDataBaseAddress == null) {
    ...
    for (;;)
    {
      ...
      if (AppSetting.d) {
        this.jdField_b_of_type_ComTencentMobileqqWidgetFormSimpleItem.setContentDescription(ajyc.a(2131706301) + (String)localObject);
      }
      ...
      do
      {
        ...
        break label183;
        localObject = ajyc.a(2131706305);
        break label230;
        a(this.jdField_c_of_type_ComTencentMobileqqWidgetFormSimpleItem, true);
        this.jdField_b_of_type_JavaLangString = getIntent().getStringExtra("param_location_param");
        localObject = this.jdField_a_of_type_Ajty.a(this.jdField_b_of_type_JavaLangString);
      ...
      this.jdField_c_of_type_ComTencentMobileqqWidgetFormSimpleItem.setContentDescription(ajyc.a(2131706299) + this.jdField_c_of_type_ComTencentMobileqqWidgetFormSimpleItem.a().getText());
      return;
      label488:
      localObject = null;
    }
  ...
  private void f()
  {
    ...
    Drawable localDrawable = getResources().getDrawable(2130839144);
  ...
  private void g()
  {
    ...
    DispatchActionMoveScrollView localDispatchActionMoveScrollView = (DispatchActionMoveScrollView)this.jdField_a_of_type_Bfol.findViewById(2131361923);
  ...
  public void a(boolean paramBoolean, String[] paramArrayOfString)
  {
    ...
    if ((paramBoolean) && (paramArrayOfString != null) && (paramArrayOfString.length == 4))
    {
      if (this.jdField_a_of_type_Boolean)
      {
        if (!TextUtils.isEmpty(paramArrayOfString[0])) {
          localBaseAddress = this.jdField_a_of_type_Ajty.a(paramArrayOfString[0]);
        }
        if (localBaseAddress == null) {
          break label253;
        }
        ...
        this.jdField_b_of_type_ComTencentMobileqqWidgetFormSimpleItem.setContentDescription(ajyc.a(2131706302) + this.jdField_a_of_type_ComTencentMobileqqConditionsearchDataBaseAddress.name);
        if (this.jdField_a_of_type_Int != 0) {
          break label245;
        }
        paramArrayOfString = "";
        a(this.jdField_c_of_type_ComTencentMobileqqWidgetFormSimpleItem, paramArrayOfString);
        this.jdField_c_of_type_ComTencentMobileqqWidgetFormSimpleItem.setContentDescription(ajyc.a(2131706304) + paramArrayOfString);
      }
      label245:
      label253:
      while (!QLog.isColorLevel()) {
    ...
    bcpw.a(this, 2131691018, 0).b(getTitleBarHeight());
  }
  ...
  public void doOnActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    if ((paramInt1 == 1000) && (paramInt2 == -1))
    {
      ...
      {
        if (this.jdField_a_of_type_Ajty.a(paramIntent) != null) {
          break label83;
        }
        if (QLog.isColorLevel()) {
    ...
    for (paramIntent = "";; paramIntent = "不限")
    {
      ...
      if (AppSetting.d)
      {
        this.jdField_b_of_type_ComTencentMobileqqWidgetFormSimpleItem.setContentDescription(ajyc.a(2131706306) + this.jdField_a_of_type_ComTencentMobileqqConditionsearchDataBaseAddress.name);
        this.jdField_c_of_type_ComTencentMobileqqWidgetFormSimpleItem.setContentDescription(ajyc.a(2131706300) + this.jdField_c_of_type_ComTencentMobileqqWidgetFormSimpleItem.a().getText());
      }
      if (this.jdField_c_of_type_Int != 0) {
        break;
      }
      axqw.b(this.app, "CliOper", "", "", "0X8004247", "0X8004247", 0, 0, ajty.a(this.jdField_a_of_type_JavaLangString) + "", "", "", "");
      return;
    }
    axqw.b(this.app, "CliOper", "", "", "0X8004249", "0X8004249", 0, 0, ajty.a(this.jdField_a_of_type_JavaLangString) + "", "", "", "");
  }
  ...
  public void onClick(View paramView)
  {
    ...
    default: 
      return;
    case 2131364600: 
      axqw.b(this.app, "CliOper", "", "", "0X8004246", "0X8004246", 0, 0, "", "", "", "");
      this.jdField_a_of_type_Boolean = true;
