  ...
  implements Runnable
{
  ...
  public void run()
  {
    int i = this.this$0.O.getHeight();
    Object localObject = this.this$0;
    ConditionSearchFriendActivity.c((ConditionSearchFriendActivity)localObject, this.a - (((ConditionSearchFriendActivity)localObject).y.getBottom() - i) + this.b);
    ...
    if (QLog.isColorLevel())
    {
      ...
      ((StringBuilder)localObject).append(ConditionSearchFriendActivity.c(this.this$0));
      ((StringBuilder)localObject).append(" itemTop:");
      ((StringBuilder)localObject).append(this.a);
      ((StringBuilder)localObject).append("  pvTop:");
      ((StringBuilder)localObject).append(this.this$0.y.getBottom() - i);
      ((StringBuilder)localObject).append("  itemHeight:");
      ((StringBuilder)localObject).append(this.b);
      ((StringBuilder)localObject).append(" RootBottom:");
      ((StringBuilder)localObject).append(this.this$0.y.getBottom());
      ((StringBuilder)localObject).append(" pvHeight:");
      ((StringBuilder)localObject).append(i);
      QLog.d("meassure", 2, ((StringBuilder)localObject).toString());
    }
    if ((ConditionSearchFriendActivity.c(this.this$0) > 0) && (this.a != -1))
    {
      if (this.b == -1) {
        return;
      }
      this.this$0.z.scrollBy(0, ConditionSearchFriendActivity.c(this.this$0));
    }
  }
}
