  ...
  implements View.OnClickListener, FaceDecoder.DecodeTaskCompletionListener, HorizontalListView.OnItemScrollEventListener
{
  ...
  FriendListObserver jdField_a_of_type_ComTencentMobileqqAppFriendListObserver = new ynw(this);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131362874));
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131362875));
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.getPaint();
      paramViewGroup.b = ((TextView)localView.findViewById(2131362876));
      paramViewGroup.c = ((TextView)localView.findViewById(2131362877));
      paramViewGroup.d = ((TextView)localView.findViewById(2131362878));
      paramViewGroup.jdField_a_of_type_AndroidWidgetButton = ((Button)localView.findViewById(2131362873));
    ...
    for (;;)
    {
      ...
      if (localMayKnowRecommend.friendStatus == 1)
      {
        ...
        paramViewGroup.d.setText(2131433062);
        if (AppSetting.b)
        {
          paramViewGroup.d.setContentDescription(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131433062));
          ...
          if ((!this.jdField_a_of_type_ComTencentMobileqqAppFriendsManager.b(((MayKnowRecommend)localObject).uin)) && (!this.jdField_a_of_type_ComTencentMobileqqAppFriendsManager.c(((MayKnowRecommend)localObject).uin))) {
            if (TextUtils.isEmpty(((MayKnowRecommend)localObject).remark)) {
              if (TextUtils.isEmpty(((MayKnowRecommend)localObject).nick))
              {
                ...
                paramView = AddFriendLogicActivity.a(this.jdField_a_of_type_AndroidAppActivity, 1, ((MayKnowRecommend)localObject).uin, null, 3045, this.jdField_a_of_type_Int, paramView, null, null, this.jdField_a_of_type_AndroidAppActivity.getString(2131435242), null);
