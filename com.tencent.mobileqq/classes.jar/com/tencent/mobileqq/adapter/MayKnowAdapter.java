  ...
  implements View.OnClickListener, DecodeTaskCompletionListener, HorizontalListView.OnItemScrollEventListener
{
  ...
  public MayKnowAdapter(Activity paramActivity, QQAppInterface paramQQAppInterface, HorizontalListView paramHorizontalListView, MayKnowAdapter.OnRecommendsCanceledListener paramOnRecommendsCanceledListener, int paramInt1, int paramInt2)
  {
    ...
    this.c = AIOUtils.a(12.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
    ...
    for (;;)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("MayKnowAdapter", 2, "MayKnowAdapter ,mFriendObserver = " + this.jdField_a_of_type_ComTencentMobileqqAppFriendListObserver);
      }
  ...
  private View a()
  {
    ...
    if (i < this.jdField_a_of_type_ComTencentWidgetHorizontalListView.getChildCount())
    {
      ...
      {
        MayKnowAdapter.MKRViewHolder localMKRViewHolder = (MayKnowAdapter.MKRViewHolder)localView.getTag();
        if ((localMKRViewHolder == null) || (localMKRViewHolder.jdField_a_of_type_ComTencentMobileqqDataMayKnowRecommend == null) || (localMKRViewHolder.jdField_a_of_type_ComTencentMobileqqDataMayKnowRecommend.friendStatus == 0)) {}
      }
    }
    for (;;)
    {
  ...
  private View a(String paramString)
  {
    ...
    if (i < this.jdField_a_of_type_ComTencentWidgetHorizontalListView.getChildCount())
    {
      ...
      {
        MayKnowAdapter.MKRViewHolder localMKRViewHolder = (MayKnowAdapter.MKRViewHolder)localView.getTag();
        if ((localMKRViewHolder == null) || (localMKRViewHolder.jdField_a_of_type_ComTencentMobileqqDataMayKnowRecommend == null) || (!TextUtils.equals(localMKRViewHolder.jdField_a_of_type_ComTencentMobileqqDataMayKnowRecommend.uin, paramString))) {}
      }
    }
    for (;;)
    {
  ...
  private void f()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppMayknowRecommendManager != null) {
      this.jdField_a_of_type_JavaUtilList = this.jdField_a_of_type_ComTencentMobileqqAppMayknowRecommendManager.c();
    }
  ...
  public void d()
  {
    ...
    for (;;)
    {
      ...
      if ((localAppRuntime instanceof QQAppInterface)) {
        ((QQAppInterface)localAppRuntime).removeObserver(this.jdField_a_of_type_ComTencentMobileqqAppFriendListObserver);
      }
    }
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    MayKnowAdapter.MKRViewHolder localMKRViewHolder = null;
    if (paramView != null) {
      localMKRViewHolder = (MayKnowAdapter.MKRViewHolder)paramView.getTag();
    }
    if ((paramView == null) || (localMKRViewHolder == null) || (localMKRViewHolder.jdField_a_of_type_Boolean) || (!TextUtils.equals(localMKRViewHolder.jdField_b_of_type_JavaLangString, ThemeUtil.curThemeId)))
    {
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2131558472, paramViewGroup, false);
      localMKRViewHolder = new MayKnowAdapter.MKRViewHolder();
      localMKRViewHolder.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368314));
      localMKRViewHolder.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131372287));
      localMKRViewHolder.jdField_a_of_type_AndroidWidgetTextView.getPaint();
      localMKRViewHolder.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367620));
      localMKRViewHolder.c = ((TextView)paramView.findViewById(2131361946));
      localMKRViewHolder.d = ((TextView)paramView.findViewById(2131362166));
      localMKRViewHolder.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131364815);
      localMKRViewHolder.jdField_a_of_type_AndroidViewView.setOnClickListener(this);
      localMKRViewHolder.jdField_a_of_type_AndroidViewView.setOnTouchListener(this.jdField_a_of_type_AndroidViewView$OnTouchListener);
      localMKRViewHolder.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this);
      localMKRViewHolder.jdField_a_of_type_AndroidWidgetImageView.setOnTouchListener(this.jdField_b_of_type_AndroidViewView$OnTouchListener);
      if ((localMKRViewHolder.jdField_a_of_type_AndroidWidgetImageView instanceof ThemeImageView)) {
        ((ThemeImageView)localMKRViewHolder.jdField_a_of_type_AndroidWidgetImageView).setSupportMaskView(false);
      }
      localMKRViewHolder.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
      localMKRViewHolder.jdField_a_of_type_AndroidWidgetTextView.setOnTouchListener(this.jdField_a_of_type_AndroidViewView$OnTouchListener);
      paramView.setTag(localMKRViewHolder);
      if (this.jdField_a_of_type_Int != 25)
      {
        localMKRViewHolder.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131167033));
        localMKRViewHolder.jdField_b_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131167127));
      }
      localMKRViewHolder.jdField_b_of_type_JavaLangString = ThemeUtil.curThemeId;
    }
    for (;;)
    {
      MayKnowRecommend localMayKnowRecommend = a(paramInt);
      if (this.jdField_a_of_type_ComTencentMobileqqAppMayknowRecommendManager != null) {
        this.jdField_a_of_type_ComTencentMobileqqAppMayknowRecommendManager.a(localMayKnowRecommend, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, 1);
      }
      StringBuilder localStringBuilder = new StringBuilder();
      localMKRViewHolder.jdField_a_of_type_JavaLangString = localMayKnowRecommend.uin;
      localMKRViewHolder.jdField_a_of_type_ComTencentMobileqqDataMayKnowRecommend = localMayKnowRecommend;
      localMKRViewHolder.jdField_a_of_type_AndroidViewView.setTag(localMayKnowRecommend);
      localMKRViewHolder.jdField_a_of_type_AndroidWidgetImageView.setTag(localMKRViewHolder);
      localMKRViewHolder.jdField_a_of_type_AndroidWidgetTextView.setTag(localMKRViewHolder);
      localMKRViewHolder.jdField_a_of_type_AndroidWidgetImageView.setImageBitmap(a(1, localMKRViewHolder.jdField_a_of_type_JavaLangString));
      if (this.jdField_a_of_type_ComTencentMobileqqAppMayknowRecommendManager != null) {}
      for (boolean bool = this.jdField_a_of_type_ComTencentMobileqqAppMayknowRecommendManager.a();; bool = false)
      {
        ...
        localMKRViewHolder.jdField_a_of_type_AndroidWidgetTextView.setText(str);
        if ((AppSetting.d) && (!TextUtils.isEmpty(str))) {
          localStringBuilder.append(str);
        }
        if (!TextUtils.isEmpty(localMayKnowRecommend.recommendReason))
        {
          localMKRViewHolder.jdField_b_of_type_AndroidWidgetTextView.setText(localMayKnowRecommend.recommendReason);
          if (AppSetting.d) {
          ...
          localMKRViewHolder.c.setVisibility(0);
          localMKRViewHolder.c.setTag(localMayKnowRecommend);
          localMKRViewHolder.d.setVisibility(8);
          localMKRViewHolder.c.setOnClickListener(this);
          if (AppSetting.d)
          {
            localMKRViewHolder.c.setContentDescription(HardCodeUtil.a(2131689557));
        ...
        for (;;)
        {
          ...
          return paramView;
          localMKRViewHolder.jdField_b_of_type_AndroidWidgetTextView.setText("");
          break;
          label701:
          if (localMayKnowRecommend.friendStatus == 1)
          {
            localMKRViewHolder.c.setVisibility(8);
            localMKRViewHolder.d.setVisibility(0);
            localMKRViewHolder.d.setText(2131718554);
            if (!AppSetting.d) {
              break label636;
            }
            localMKRViewHolder.d.setContentDescription(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131718554));
            localStringBuilder.append(",等待验证");
            break label636;
          }
          localMKRViewHolder.c.setVisibility(8);
          localMKRViewHolder.d.setVisibility(0);
          localMKRViewHolder.d.setText(2131690072);
          if (!AppSetting.d) {
            break label636;
          }
          localMKRViewHolder.d.setContentDescription(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131690072));
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          if ((this.jdField_a_of_type_ComTencentMobileqqAppFriendsManager != null) && (!this.jdField_a_of_type_ComTencentMobileqqAppFriendsManager.b(((MayKnowRecommend)localObject1).uin)) && (!this.jdField_a_of_type_ComTencentMobileqqAppFriendsManager.d(((MayKnowRecommend)localObject1).uin)))
          {
            bool = false;
            if (this.jdField_a_of_type_ComTencentMobileqqAppMayknowRecommendManager != null) {
            ...
            localObject2 = AddFriendLogicActivity.a(this.jdField_a_of_type_AndroidAppActivity, 1, ((MayKnowRecommend)localObject1).uin, null, 3045, this.jdField_a_of_type_Int, (String)localObject2, null, null, this.jdField_a_of_type_AndroidAppActivity.getString(2131689557), null);
          ...
          {
            if (this.jdField_a_of_type_ComTencentMobileqqAppMayknowRecommendManager != null) {
              this.jdField_a_of_type_ComTencentMobileqqAppMayknowRecommendManager.a((MayKnowRecommend)localObject1, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, 3);
            }
            ...
            continue;
            if ((this.jdField_a_of_type_ComTencentMobileqqAppFriendsManager != null) && (this.jdField_a_of_type_ComTencentMobileqqAppFriendsManager.b(((MayKnowRecommend)localObject1).uin)))
            {
    ...
    default: 
      ...
      {
        j = i;
        if (this.jdField_a_of_type_ComTencentMobileqqAppFriendsManager.b(((MayKnowRecommend)localObject1).uin)) {
          j = 1;
        }
      }
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqAppMayknowRecommendManager != null) {
        this.jdField_a_of_type_ComTencentMobileqqAppMayknowRecommendManager.a((MayKnowRecommend)localObject1, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, 2);
      }
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
        switch (this.jdField_b_of_type_Int)
        {
  ...
  public void onItemScrollNonVisible(int paramInt, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppMayknowRecommendManager != null) {
      this.jdField_a_of_type_ComTencentMobileqqAppMayknowRecommendManager.b(a(paramInt), this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, 1);
    }
  }
}
