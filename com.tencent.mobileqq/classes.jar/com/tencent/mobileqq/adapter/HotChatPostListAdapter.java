  ...
  extends BaseAdapter
{
  ...
  public void c()
  {
    if (this.jdField_a_of_type_Boolean)
    {
      if (this.jdField_a_of_type_ComTencentBizViewpluginViewPluginManager != null)
      {
        this.jdField_a_of_type_ComTencentBizViewpluginViewPluginManager.a("com.tencent.biz.hotchatpostlist.widget.HotChatPostItemView");
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if ((paramView == null) && (this.jdField_a_of_type_Boolean)) {
      paramView = this.jdField_a_of_type_ComTencentBizViewpluginViewPluginManager.a("com.tencent.biz.hotchatpostlist.widget.HotChatPostItemView");
    }
    Object localObject;
    for (;;)
    {
      ...
      if (paramView != null) {
        ((View)localObject).setOnClickListener(new HotChatPostListAdapter.2(this, paramView.optString("bid"), paramView.optString("pid")));
      }
      try
      {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ViewPluginManager.a((View)localObject, paramView.toString());
  ...
  {
    Collections.sort(this.jdField_a_of_type_JavaUtilArrayList, new HotChatPostListAdapter.1(this));
 ...
 * Qualified Name:     com.tencent.mobileqq.adapter.HotChatPostListAdapter
