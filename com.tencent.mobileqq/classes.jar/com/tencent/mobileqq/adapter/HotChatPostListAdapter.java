  ...
  extends BaseAdapter
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      if (paramView != null) {
        paramViewGroup.setOnClickListener(new ynt(this, paramView.optString("bid"), paramView.optString("pid")));
      }
      try
      {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ViewPluginManager.a(paramViewGroup, paramView.toString());
        return paramViewGroup;
      }
    }
  }
  ...
  {
    Collections.sort(this.jdField_a_of_type_JavaUtilArrayList, new yns(this));
