  ...
  implements View.OnClickListener
{
  ...
  {
    if (!RobotAdapter.a(this.a))
    {
      DialogUtil.a(RobotAdapter.a(this.a), 230, "", HardCodeUtil.a(2131713404), new RobotAdapter.2.1(this), null).show();
    }
    else
    {
      ...
      if ((localObject1 != null) && ((localObject1 instanceof String)))
      {
        ...
        try
        {
          l1 = Long.parseLong(RobotAdapter.a(this.a));
          try
          {
        ...
        RobotAdapter.a(this.a).add(localObject2);
        ((ITroopRobotHandler)RobotAdapter.a(this.a).getBusinessHandler(BusinessHandlerFactory.TROOP_ROBOT_HANDLER)).a(l3, l2);
