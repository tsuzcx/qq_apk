...
{
  private static final int[] jdField_a_of_type_ArrayOfInt = { 2131434057 };
  private static final int[] jdField_b_of_type_ArrayOfInt = { 2130838690 };
  private static final int[] jdField_c_of_type_ArrayOfInt = { 2131370011 };
  private final int jdField_a_of_type_Int = 0;
  private Activity jdField_a_of_type_AndroidAppActivity;
  private View jdField_a_of_type_AndroidViewView;
  private FlingHandler jdField_a_of_type_ComTencentMobileqqActivityFlingFlingHandler;
  DiscussionObserver jdField_a_of_type_ComTencentMobileqqAppDiscussionObserver = new yoc(this);
  private FriendListObserver jdField_a_of_type_ComTencentMobileqqAppFriendListObserver = new yoa(this);
  private FriendsManager jdField_a_of_type_ComTencentMobileqqAppFriendsManager;
  private MessageObserver jdField_a_of_type_ComTencentMobileqqAppMessageObserver = new yob(this);
  ...
  private Comparator jdField_a_of_type_JavaUtilComparator = new ynx(this);
  ...
  private SwipRightMenuBuilder a(Context paramContext)
  {
    ...
    return new yoh(this, 1, 2, new int[] { i, j }, -1, paramContext, arrayOfInt1, arrayOfInt2);
  }
  ...
  private void a(NewFriendMoreSysMsgAdapter.MoreSysMsgHolder paramMoreSysMsgHolder, int paramInt, structmsg.StructMsg paramStructMsg, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject2))
      {
        ...
        localObject1 = this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130839766);
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          paramStructMsg = this.jdField_a_of_type_AndroidAppActivity.getResources().getColorStateList(2131494243);
          if (paramStructMsg != null) {
            paramMoreSysMsgHolder.jdField_a_of_type_AndroidWidgetButton.setTextColor(paramStructMsg);
          }
          paramMoreSysMsgHolder.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130838515);
          return;
  ...
  private void a(NewFriendMoreSysMsgAdapter.MoreSysMsgHolder paramMoreSysMsgHolder, PhoneContactAdd paramPhoneContactAdd)
  {
    ...
    for (;;)
    {
      paramMoreSysMsgHolder.e.setVisibility(0);
      paramMoreSysMsgHolder.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
      paramMoreSysMsgHolder.e.setText(this.jdField_a_of_type_AndroidAppActivity.getString(2131433062));
  ...
  private void a(NewFriendMoreSysMsgAdapter.MoreSysMsgHolder paramMoreSysMsgHolder, QIMNotifyAddFriend paramQIMNotifyAddFriend)
  {
    ...
    {
    default: 
      paramMoreSysMsgHolder.jdField_b_of_type_AndroidWidgetTextView.setBackgroundResource(2130843152);
      j = 0;
      i = 0;
    ...
    for (;;)
    {
      ...
      paramMoreSysMsgHolder.jdField_a_of_type_AndroidWidgetButton.setTag(paramMoreSysMsgHolder);
      paramMoreSysMsgHolder.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
      localObject = this.jdField_a_of_type_AndroidAppActivity.getResources().getColorStateList(2131494243);
      if (localObject != null) {
      ...
      break;
      j = 2130843149;
      paramMoreSysMsgHolder.jdField_b_of_type_AndroidWidgetTextView.setBackgroundResource(2130843150);
      i = 1;
      break;
  ...
  {
    ThreadManager.postImmediately(new yny(this, paramBoolean), null, true);
  }
  ...
  private void b(View paramView)
  {
    if (!NetworkUtil.g(this.jdField_a_of_type_AndroidAppActivity)) {
      QQToast.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131433023), 0).b(a());
    }
    do
    {
      Object localObject;
      ...
      {
        ThreadManager.postImmediately(new yod(this, paramView), null, true);
        return;
      }
    } while (!(paramView instanceof QIMNotifyAddFriendMsg));
    ThreadManager.postImmediately(new yof(this, paramView), null, true);
  }
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.a(this.jdField_a_of_type_AndroidAppActivity.getString(2131434469));
  ...
  private void f()
  {
    if (this.jdField_b_of_type_AndroidViewView == null) {
      this.jdField_b_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2130970651, null);
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      ...
      paramView = a(this.jdField_a_of_type_AndroidAppActivity, 2130970650, paramViewGroup);
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131366543));
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362899));
      paramViewGroup.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131371530));
      paramViewGroup.c = ((TextView)paramView.findViewById(2131369991));
      paramViewGroup.d = ((TextView)paramView.findViewById(2131369993));
      paramViewGroup.jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131368974));
      paramViewGroup.e = ((TextView)paramView.findViewById(2131368975));
      ...
      paramViewGroup.f.setBackgroundResource(2130838595);
      label186:
    ...
    do
    {
      ...
      break;
      paramViewGroup.f.setBackgroundResource(2130838591);
      break label186;
