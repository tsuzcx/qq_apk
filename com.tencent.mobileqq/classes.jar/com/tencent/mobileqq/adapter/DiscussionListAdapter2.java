  ...
  implements FaceDecoder.DecodeTaskCompletionListener, AbsListView.OnScrollListener
{
  ...
  protected boolean a;
  private View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new ynn(this);
  ...
  public DiscussionListAdapter2(Context paramContext, DiscussionListAdapter2.DiscussionListListener paramDiscussionListListener, ListView paramListView, QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new yno(this);
  ...
  private void a(String paramString, Bitmap paramBitmap)
  {
    ...
    if (i < j)
    {
      ...
      if ((localObject == null) || (!(localObject instanceof ynp))) {
        break label169;
      }
      localObject = (ynp)localObject;
      if ((paramString == null) && (!TextUtils.isEmpty(((ynp)localObject).jdField_a_of_type_JavaLangString)))
      {
        paramBitmap = this.jdField_a_of_type_ComTencentMobileqqUtilFaceDecoder.a(101, ((ynp)localObject).jdField_a_of_type_JavaLangString);
        if (paramBitmap != null) {
          ((ynp)localObject).jdField_a_of_type_AndroidWidgetImageView.setBackgroundDrawable(new BitmapDrawable(this.jdField_a_of_type_AndroidContentContext.getResources(), paramBitmap));
        }
      }
    }
    label169:
    for (;;)
    {
      i += 1;
      break;
      this.jdField_a_of_type_ComTencentMobileqqUtilFaceDecoder.a(((ynp)localObject).jdField_a_of_type_JavaLangString, 101, true);
      continue;
      if (TextUtils.equals(paramString, ((ynp)localObject).jdField_a_of_type_JavaLangString))
      {
        ((ynp)localObject).jdField_a_of_type_AndroidWidgetImageView.setBackgroundDrawable(new BitmapDrawable(this.jdField_a_of_type_AndroidContentContext.getResources(), paramBitmap));
        return;
      }
  ...
  private void b()
  {
    ...
    Object localObject2 = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131433317);
    String str1 = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131433320);
    ...
    Collections.sort(this.jdField_a_of_type_JavaUtilList, new ynm(this, (HashMap)localObject1));
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (getItemViewType(paramInt) == 1)
    {
      ...
      if (paramView == null)
      {
        paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130968945, paramViewGroup, false);
        paramViewGroup = new ynp(null);
        ...
        paramViewGroup.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131364362));
        ...
        ((Button)paramView.findViewById(2131364364)).setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
      ...
      for (;;)
      {
        ...
        return paramView;
        paramViewGroup = (ynp)paramView.getTag();
        break;
        label314:
    ...
    if (paramView == null)
    {
      paramView = new ynp(null);
      localObject1 = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130968944, paramViewGroup, false);
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)((View)localObject1).findViewById(2131364361));
    ...
    for (;;)
    {
      ...
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.setText(2131435964);
      return localObject1;
      paramViewGroup = (ynp)paramView.getTag();
      localObject1 = paramView;
    }
    paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.setText(2131435965);
    return localObject1;
  }
