  ...
  implements DecodeTaskCompletionListener, AbsListView.OnScrollListener
{
  ...
  public DiscussionListAdapter2(Context paramContext, DiscussionListAdapter2.DiscussionListListener paramDiscussionListListener, ListView paramListView, QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    this.k = ((IQQAvatarService)paramQQAppInterface.getRuntimeService(IQQAvatarService.class, "")).getInstance(paramQQAppInterface);
  ...
  private void b()
  {
    this.h = ((DiscussionManager)this.a.getManager(QQManagerFactory.DISCUSSION_MANAGER)).b();
    ...
    while (localIterator.hasNext())
    {
      ...
      long l1 = 0L;
      String str2 = ContactUtils.a(this.f, localDiscussionInfo);
  ...
  public DiscussionInfo a(int paramInt)
  {
    if ((paramInt >= 0) && (paramInt < this.j.size())) {
      return (DiscussionInfo)this.j.get(paramInt);
    }
    return null;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (getItemViewType(paramInt) == 1)
    {
      ...
      Object localObject = ContactUtils.a(this.f, localDiscussionInfo);
      localViewTag.c.setText((CharSequence)localObject);
      localObject = (DiscussionManager)this.a.getManager(QQManagerFactory.DISCUSSION_MANAGER);
      localViewTag.d.setText(String.format("(%d)", new Object[] { Integer.valueOf(((DiscussionManager)localObject).c(str)) }));
      localObject = this.k.getBitmapFromCache(101, str);
      if (localObject == null) {
        localViewTag.b.setBackgroundDrawable(ImageUtil.h());
      } else {
