  ...
  extends BaseAdapter
{
  ...
  private View a(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130971570, paramViewGroup, false);
      paramViewGroup = new AssociatedAccountListAdapter.ViewHolder(this);
      paramViewGroup.jdField_a_of_type_ComTencentWidgetSingleLineTextView = ((SingleLineTextView)paramView.findViewById(2131363360));
      paramViewGroup.b = ((SingleLineTextView)paramView.findViewById(2131365632));
      paramViewGroup.jdField_a_of_type_ComTencentWidgetFixSizeImageView = ((FixSizeImageView)paramView.findViewById(2131362701));
      ...
      if (localAssociatedAccountListItemData != null)
      {
        ...
        if (localSubAccountInfo != null)
        {
          ...
          paramView.findViewById(2131374998).setBackgroundDrawable(null);
        }
      }
    }
    for (;;)
    {
      ...
      break;
      label237:
      paramView.findViewById(2131374998).setBackgroundResource(2130845980);
    }
  }
  ...
  private void a(View paramView, AssociatedAccountListItemData paramAssociatedAccountListItemData)
  {
    ...
    for (;;)
    {
      ...
      case 3: 
      case 4: 
        localObject1 = paramView.findViewById(2131363612);
        View localView;
        float f;
        if (this.jdField_a_of_type_Boolean)
        {
          ...
          if (this.jdField_a_of_type_Boolean)
          {
            paramAssociatedAccountListItemData = (UpArrowView)paramView.findViewById(2131363425);
      ...
      if (paramAssociatedAccountListItemData.jdField_b_of_type_Boolean)
      {
        localObject2 = paramView.findViewById(2131375004);
      ...
      for (;;)
      {
        ...
        paramAssociatedAccountListItemData = paramView.findViewById(2131372927);
        if (paramAssociatedAccountListItemData != null) {
          paramAssociatedAccountListItemData.setVisibility(8);
        }
        paramView = (UpArrowView)paramView.findViewById(2131363425);
        if (paramView == null) {
          break;
        }
  ...
  private View b(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130971572, paramViewGroup, false);
      paramViewGroup = new AssociatedAccountListAdapter.ViewHolder(this);
      paramView.setTag(paramViewGroup);
      localAssociatedAccountListItemData = (AssociatedAccountListItemData)getItem(paramInt);
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqSubaccountAssociatedAccountListItemData = localAssociatedAccountListItemData;
      ...
      localFrameLayout = (FrameLayout)paramView.findViewById(2131364049);
    ...
    for (paramInt = (int)(f2 - 8.0F * f1) / j;; paramInt = 5)
    {
      ...
      for (;;)
      {
        ...
        if (k > i)
        {
          while (i < k)
          {
            localObject1 = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130971571, null, false);
            ...
            localViewHolder.jdField_a_of_type_ComTencentWidgetFixSizeImageView = ((FixSizeImageView)((View)localObject1).findViewById(2131362701));
            localViewHolder.jdField_a_of_type_ComTencentWidgetSingleLineTextView = ((SingleLineTextView)((View)localObject1).findViewById(2131363360));
            localViewHolder.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView = ((DragTextView)((View)localObject1).findViewById(2131363189));
  ...
  private View c(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130971565, paramViewGroup, false);
      paramViewGroup = new AssociatedAccountListAdapter.ViewHolder(this);
      paramViewGroup.jdField_a_of_type_ComTencentWidgetSingleLineTextView = ((SingleLineTextView)localView.findViewById(2131363360));
      paramViewGroup.jdField_a_of_type_ComTencentWidgetFixSizeImageView = ((FixSizeImageView)localView.findViewById(2131362701));
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView = ((DragTextView)localView.findViewById(2131363189));
      paramViewGroup.b = ((SingleLineTextView)localView.findViewById(2131365632));
    ...
    for (;;)
    {
      ...
      if (m > 0)
      {
        ...
        {
          paramView = "[" + localResources.getString(2131437891) + "]";
          paramInt = 0;
          i = j;
        }
      }
      for (;;)
      {
        ...
        {
          f = DeviceInfoUtil.a();
          paramView = localResources.getColorStateList(2131494258);
          localObject = localResources.getColorStateList(2131494210);
          i = localResources.getColor(2131494281);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    default: 
      ...
      if (paramView == null) {
        localView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130971568, paramViewGroup, false);
      }
      return localView;
    case 3: 
