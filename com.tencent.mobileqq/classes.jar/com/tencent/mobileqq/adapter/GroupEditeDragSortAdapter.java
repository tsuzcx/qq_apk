  ...
  extends DragSortAdapter
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null) {
      paramViewGroup = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2130970328, null);
    }
    paramViewGroup.setVisibility(0);
    paramViewGroup.findViewById(2131362723).setVisibility(8);
    paramView = (TextView)paramViewGroup.findViewById(2131370080);
    Groups localGroups = (Groups)this.jdField_a_of_type_JavaUtilList.get(paramInt);
    paramView.setText(localGroups.group_name);
    ViewCompat.setImportantForAccessibility(paramViewGroup.findViewById(2131370078), 1);
