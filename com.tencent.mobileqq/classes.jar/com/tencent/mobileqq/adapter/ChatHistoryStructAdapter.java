  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if ((localObject2 instanceof MessageForStructing))
    {
      ...
      for (;;)
      {
        ...
        paramView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131563045, null);
        ((ChatHistoryStructAdapter.HistoryStructItemHolder)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131376664));
        ((ChatHistoryStructAdapter.HistoryStructItemHolder)localObject1).jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)paramView.findViewById(2131378543));
        ((ChatHistoryStructAdapter.HistoryStructItemHolder)localObject1).jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)paramView.findViewById(2131378541));
        ((ChatHistoryStructAdapter.HistoryStructItemHolder)localObject1).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131363870));
        ((ChatHistoryStructAdapter.HistoryStructItemHolder)localObject1).b = ((TextView)paramView.findViewById(2131371971));
    ...
    for (;;)
    {
      ...
      break;
      label427:
      paramView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131563046, null);
