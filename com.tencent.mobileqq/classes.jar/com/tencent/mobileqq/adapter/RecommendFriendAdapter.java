  ...
  implements View.OnClickListener
{
  ...
  FriendListObserver jdField_a_of_type_ComTencentMobileqqAppFriendListObserver = new yoj(this);
  private MayknowRecommendManager jdField_a_of_type_ComTencentMobileqqAppMayknowRecommendManager;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private IIconListener jdField_a_of_type_ComTencentMobileqqRichstatusIIconListener = new yoi(this);
  ...
  private StringBuilder a(yok paramyok)
  {
    int j = 0;
    RichStatus localRichStatus = paramyok.jdField_a_of_type_ComTencentMobileqqDataMayKnowRecommend.getRichStatus();
    paramyok = paramyok.d;
    Object localObject1 = localRichStatus.toSpannableString(null, this.jdField_a_of_type_AndroidContentResResources.getColor(2131494283), this.jdField_a_of_type_AndroidContentResResources.getColor(2131494283));
    Object localObject2;
    ...
    if (!TextUtils.isEmpty(localRichStatus.actionText))
    {
      ...
      i = (int)(paramyok.getTextSize() * 1.1F + 0.5F);
      ...
      paramyok.setText((CharSequence)localObject1);
      paramyok = new StringBuilder();
      if (localRichStatus.actionText != null) {
        paramyok.append(localRichStatus.actionText);
      }
      if (localRichStatus.dataText != null) {
        paramyok.append(localRichStatus.dataText);
      }
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject1)) {
        paramyok.append((String)localObject1);
      }
      j += 1;
      continue;
      if (((SpannableString)localObject1).length() == 0)
      {
        paramyok.setVisibility(8);
        break;
      }
      paramyok.setVisibility(0);
      paramyok.setText((CharSequence)localObject1);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      paramView = new yok();
      localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130970650, paramViewGroup, false);
      ...
      paramView.jdField_c_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131369991));
      paramView.b = ((TextView)localView.findViewById(2131371530));
      paramView.d = ((TextView)localView.findViewById(2131369993));
      paramView.f = ((TextView)localView.findViewById(2131371531));
      paramView.e = ((Button)localView.findViewById(2131368974));
      paramView.g = ((TextView)localView.findViewById(2131368975));
    ...
    for (;;)
    {
      ...
      if (TextUtils.isEmpty(localMayKnowRecommend.remark)) {
        if (TextUtils.isEmpty(localMayKnowRecommend.nick))
        {
          ...
          default: 
            i = 0;
            paramViewGroup.b.setBackgroundResource(2130843152);
            label509:
            if (localMayKnowRecommend.age > 0)
            {
              ...
              paramViewGroup.f.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130843177, 0);
      ...
      try
      {
        for (;;)
        {
          ...
          return localView;
          paramViewGroup = (yok)paramView.getTag();
          localView = paramView;
          break;
          ...
          i = 2130843149;
          paramView.append("女,");
          paramViewGroup.b.setBackgroundResource(2130843150);
          break label509;
        ...
        for (;;)
        {
          if (QLog.isColorLevel())
          {
            ...
            if (localMayKnowRecommend.friendStatus == 1)
            {
              ...
              paramViewGroup.g.setText(2131433062);
              if (AppSetting.b)
              {
                localStringBuilder.append(",等待验证");
                paramViewGroup.g.setContentDescription(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131433062));
              }
            }
            else
            {
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      do
      {
        ...
        if ((!paramView.b(localMayKnowRecommend.uin)) && (!paramView.c(localMayKnowRecommend.uin)))
        {
          ...
          if (TextUtils.isEmpty(localMayKnowRecommend.remark)) {
            if (TextUtils.isEmpty(localMayKnowRecommend.nick))
            {
              ...
              paramView = AddFriendLogicActivity.a(this.jdField_a_of_type_AndroidContentContext, 1, localMayKnowRecommend.uin, null, i, j, paramView, null, null, this.jdField_a_of_type_AndroidContentContext.getString(2131435242), null);
        ...
        paramView = (yok)paramView.getTag();
