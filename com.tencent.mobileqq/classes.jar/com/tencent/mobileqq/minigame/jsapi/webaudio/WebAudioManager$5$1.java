  ...
  implements AudioDecoder.onDecodeProcessListener
{
  ...
  public void onDecodeProcess(byte[] paramArrayOfByte, MediaFormat paramMediaFormat, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    synchronized (WebAudioManager.access$200())
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.this$1.val$jsRuntime != null) {
          this.this$1.val$jsRuntime.evaluateSubcribeJS("onDecodeWebAudioDataDone", paramArrayOfByte.toString(), 0);
        }
        return;
 ...
 * Qualified Name:     com.tencent.mobileqq.minigame.jsapi.webaudio.WebAudioManager.5.1
