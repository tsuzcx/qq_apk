...
public class FloatDragAdDataManager
{
  ...
  private static void requestTianShu(FloatDragAdDataManager.DragAdListener paramDragAdListener, String paramString, int paramInt)
  {
    ...
    localbmvg.jdField_a_of_type_Int = 473;
    localbmvg.b = 1;
    localbmvg.jdField_a_of_type_JavaUtilHashMap = new HashMap();
    ...
    try
    {
      ...
      localbmvg.jdField_a_of_type_JavaUtilHashMap.put("FilterInfo", localJSONObject.toString());
      MiniTianShuManager.requestAdv(Collections.singletonList(localbmvg), new FloatDragAdDataManager.2(paramString, paramInt, paramDragAdListener));
      return;
    }
