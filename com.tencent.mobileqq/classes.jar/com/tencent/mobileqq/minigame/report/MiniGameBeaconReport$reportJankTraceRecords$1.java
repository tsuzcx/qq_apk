  ...
  implements Runnable
{
  ...
  public final void run()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      MiniGameBeaconReport.report("jank_trace", MapsKt.mapOf(new Pair[] { TuplesKt.to("trace_name", localRecord.getName()), TuplesKt.to("trace_time", String.valueOf(localRecord.getTimeUs())), TuplesKt.to("is_sdk", String.valueOf(this.$isSdk)), TuplesKt.to("appid", this.$appid), TuplesKt.to("isFirstFrame", String.valueOf(this.$isFirstFrame)) }));
    }
  }
}
 ...
 * Qualified Name:     com.tencent.mobileqq.minigame.report.MiniGameBeaconReport.reportJankTraceRecords.1
