  ...
  implements Runnable
{
  ...
  public final void run()
  {
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      MiniGameBeaconReport.report("jank_trace", MapsKt.mapOf(new Pair[] { TuplesKt.to("trace_name", localRecord.name), TuplesKt.to("trace_time", String.valueOf(localRecord.timeUs)), TuplesKt.to("is_sdk", String.valueOf(this.$isSdk)), TuplesKt.to("appid", this.$appid), TuplesKt.to("isFirstFrame", String.valueOf(this.$isFirstFrame)) }));
    }
  }
}
