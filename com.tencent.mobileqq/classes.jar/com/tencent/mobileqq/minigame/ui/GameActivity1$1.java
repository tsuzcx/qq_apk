  ...
  implements aocf
{
  ...
  public ColorNote getColorNote()
  {
    ...
    return new aocl().a(16842752).a(this.val$miniAppInfo.appId).b(this.val$miniAppInfo.name).c(this.val$miniAppInfo.desc).d(this.val$miniAppInfo.iconUrl).a(arrayOfByte).a();
  }
}
