  ...
  implements apkw
{
  ...
  public ColorNote getColorNote()
  {
    ...
    return new aple().a(16842752).a(this.this$0.mGameAppConfig.config.appId).b(this.this$0.mGameAppConfig.config.name).c(this.this$0.mGameAppConfig.config.desc).d(this.this$0.mGameAppConfig.config.iconUrl).a(arrayOfByte).a();
  }
}
