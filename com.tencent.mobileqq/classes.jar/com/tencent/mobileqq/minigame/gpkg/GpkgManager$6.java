  ...
  implements Downloader.DownloadListener
{
  ...
  {
    GpkgManager.access$400(false, 0, 0L, 0.0F, "", null, this.val$miniGamePkg, this.val$savePath, this.val$subRoot, this.val$listener);
  }
  
  public void onDownloadFailed(String paramString, DownloadResult paramDownloadResult)
  {
    GpkgManager.access$400(false, -1, 0L, 0.0F, paramString, paramDownloadResult, this.val$miniGamePkg, this.val$savePath, this.val$subRoot, this.val$listener);
  }
  
  public void onDownloadProgress(String paramString, long paramLong, float paramFloat)
  {
    GpkgManager.access$400(false, 2, paramLong, paramFloat, paramString, null, this.val$miniGamePkg, this.val$savePath, this.val$subRoot, this.val$listener);
  }
