      ...
      try
      {
        ...
        if (localaxxj.a())
        {
          ...
          if (paramInt == 1)
          {
            ...
            localaxxj.a(i, "prd", paramString2, 0, paramString2, paramString3, 2, 0, false, new SplashMiniGameDownloadManager.1(paramQQAppInterface, str, paramString1, paramInt, paramString3, paramString2));
          }
        }
        else
        {
