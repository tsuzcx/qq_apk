...
public class LocalGameEngine
{
  ...
  public static final String LOCAL_ENGINE_VERSION = "1.13.0.00013";
  ...
  private void initLocalBaseLibInfo()
  {
    ...
    this.mLocalBaseLibInfo.baseLibVersion = GameWnsUtils.getGameEngineVersion("1.13.0.00013");
  ...
  {
    this.mLocalEngineVersion = new EngineVersion(GameWnsUtils.getGameEngineVersion("1.13.0.00013"));
  }
