...
public class LocalGameEngine
{
  ...
  private void initLocalBaseLibInfo()
  {
    ...
    this.mLocalBaseLibInfo.baseLibVersion = GameWnsUtils.getGameEngineVersion("1.18.0.00132");
  ...
  {
    this.mLocalEngineVersion = new EngineVersion(GameWnsUtils.getGameEngineVersion("1.18.0.00132"));
  }
