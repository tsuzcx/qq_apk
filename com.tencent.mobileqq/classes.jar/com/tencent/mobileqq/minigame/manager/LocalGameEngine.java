...
public class LocalGameEngine
{
  ...
  public static final String LOCAL_ENGINE_VERSION = "1.19.0.00043";
  ...
  private void initLocalBaseLibInfo()
  {
    ...
    this.mLocalBaseLibInfo.baseLibVersion = GameWnsUtils.getGameEngineVersion("1.19.0.00043");
  ...
  {
    this.mLocalEngineVersion = new EngineVersion(GameWnsUtils.getGameEngineVersion("1.19.0.00043"));
  }
