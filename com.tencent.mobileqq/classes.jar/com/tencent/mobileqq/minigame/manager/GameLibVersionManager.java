...
public class GameLibVersionManager
{
  ...
  public String getGameJsLibPath()
  {
    ...
    str2 = BaseLibManager.g().getBaseLibDir("mini", "1.14.0.00225");
    str1 = getNewestBaseLib(EngineInstanceManager.g().getEngineInstancePath(), getNewestBaseLib(str1, str2));
    if (str1 != null) {
      setGameEngineVersion(EngineVersion.fromFolderName(str1));
    }
    GameLog.getInstance().i(this.TAG, "[MiniEng]getBaseEnginePath, [本次启动使用的小游戏基础库版本]retPath:" + str1);
    return str1;
  }
}
