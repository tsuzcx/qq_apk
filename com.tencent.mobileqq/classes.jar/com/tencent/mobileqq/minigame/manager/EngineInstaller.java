...
public class EngineInstaller
{
  ...
  private boolean unzipEngine(File paramFile, String paramString1, EngineVersion paramEngineVersion, String paramString2, boolean paramBoolean)
  {
    ...
    //   61: fconst_1
    //   62: ldc_w 416
    //   65: invokestatic 422	amtj:a	(I)Ljava/lang/String;
    //   68: invokespecial 52	com/tencent/mobileqq/minigame/manager/EngineInstaller:updateMessage	(FLjava/lang/String;)V
    //   71: aload 4
    //   73: aload_1
    //   74: invokestatic 427	npo:a	(Ljava/lang/String;Ljava/lang/String;)I
    //   77: istore 6
    //   79: iload 6
    //   81: ifne +346 -> 427
    //   84: ldc2_w 193
    ...
    //   91: fconst_1
    //   92: ldc_w 428
    //   95: invokestatic 422	amtj:a	(I)Ljava/lang/String;
    ...
    //   195: fconst_1
    //   196: ldc_w 439
    //   199: invokestatic 422	amtj:a	(I)Ljava/lang/String;
    ...
    //   280: fconst_0
    //   281: ldc_w 442
    //   284: invokestatic 422	amtj:a	(I)Ljava/lang/String;
    ...
    //   332: fconst_0
    //   333: ldc_w 445
    //   336: invokestatic 422	amtj:a	(I)Ljava/lang/String;
    ...
    //   369: fconst_0
    //   370: ldc_w 446
    //   373: invokestatic 422	amtj:a	(I)Ljava/lang/String;
    ...
    //   400: fconst_1
    //   401: ldc_w 447
    //   404: invokestatic 422	amtj:a	(I)Ljava/lang/String;
  ...
  public void installWithCallback(BaseLibInfo paramBaseLibInfo, EngineInstaller.Callback paramCallback)
  {
    ...
    for (;;)
    {
      for (;;)
      {
        workBegin();
        if (bool1) {
          updateMessage(0.0F, amtj.a(2131703254) + paramBaseLibInfo.baseLibVersion + ")");
        }
        for (;;)
        {
          ...
          workFinish();
          break;
          updateMessage(0.0F, amtj.a(2131703259) + paramBaseLibInfo.baseLibVersion + ")");
        }
        label780:
        boolean bool2 = false;
        paramCallback = null;
        ...
        try
        {
          updateMessage(0.0F, amtj.a(2131703255));
          ...
          {
            updateMessage(0.0F, amtj.a(2131703266));
      ...
      {
        updateMessage(0.0F, amtj.a(2131703258));
      ...
      if ((paramCallback[0] == l) || (l < 0L))
      {
        ...
        updateInstalledEngine();
        updateMessage(1.0F, amtj.a(2131703253));
      }
      for (;;)
      {
        workFinish();
        break;
        updateMessage(0.0F, amtj.a(2131703264));
      }
      label1143:
