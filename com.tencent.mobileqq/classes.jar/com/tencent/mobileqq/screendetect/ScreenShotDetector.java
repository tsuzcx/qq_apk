  ...
  extends xfq
{
  ...
  private static final String[] d = { "三星F9000", "三星A8S", "三星S8+", "华为MHA-AL00", "华为P30", "vivoX27", "小米9", "OPPOA59S", "魅族Pro7-H", ajjy.a(2131647796), ajjy.a(2131647797) };
  private long jdField_a_of_type_Long;
  private final Handler jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
  private avgp jdField_a_of_type_Avgp;
  private avgq jdField_a_of_type_Avgq;
  private WeakReference<Context> jdField_a_of_type_JavaLangRefWeakReference;
  private avgp jdField_b_of_type_Avgp;
  ...
  private boolean a(String paramString, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    {
      jdField_a_of_type_AndroidGraphicsPoint = avgx.a((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get());
      if (jdField_a_of_type_AndroidGraphicsPoint == null) {
        break label190;
      }
      if (QLog.isColorLevel()) {
  ...
  public void a(avgq paramavgq)
  {
    this.jdField_a_of_type_Avgq = paramavgq;
  }
  ...
  public void c(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Avgp = new avgp(this, MediaStore.Images.Media.INTERNAL_CONTENT_URI, this.jdField_a_of_type_AndroidOsHandler);
    this.jdField_b_of_type_Avgp = new avgp(this, MediaStore.Images.Media.EXTERNAL_CONTENT_URI, this.jdField_a_of_type_AndroidOsHandler);
    try
    {
      paramContext.getContentResolver().registerContentObserver(MediaStore.Images.Media.INTERNAL_CONTENT_URI, true, this.jdField_a_of_type_Avgp);
      paramContext.getContentResolver().registerContentObserver(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, true, this.jdField_b_of_type_Avgp);
      return;
    }
    catch (Exception paramContext)
    {
      QLog.e("ScreenShotDetector", 2, "ScreenShot: startListen error", paramContext);
    }
  }
  ...
  public void d(Context paramContext)
  {
    ...
    try
    {
      paramContext.getContentResolver().unregisterContentObserver(this.jdField_a_of_type_Avgp);
      this.jdField_a_of_type_Avgp = null;
      if (this.jdField_b_of_type_Avgp == null) {}
    }
    catch (Exception localException)
    {
      try
      {
        paramContext.getContentResolver().unregisterContentObserver(this.jdField_b_of_type_Avgp);
        this.jdField_b_of_type_Avgp = null;
        return;
  ...
  {
    avgx.a(paramActivity, paramMotionEvent);
  }
  ...
  public void onWindowFocusChanged(Activity paramActivity, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.removeCallbacksAndMessages(null);
    if (paramBoolean) {
      avgx.a(paramActivity, this.jdField_a_of_type_AndroidOsHandler);
    }
    while (!"XIAOMI".equalsIgnoreCase(Build.MANUFACTURER)) {
      return;
    }
    avgx.b(paramActivity);
  }
}
