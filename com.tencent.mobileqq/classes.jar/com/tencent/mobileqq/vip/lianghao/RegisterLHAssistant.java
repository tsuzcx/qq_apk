...
public class RegisterLHAssistant
{
  ...
  public RegisterLHAssistant(RegisterNewBaseActivity paramRegisterNewBaseActivity, View paramView, int paramInt)
  {
    ...
    this.jdField_a_of_type_ComTencentWidgetScrollView = ((ScrollView)this.jdField_a_of_type_AndroidViewView.findViewById(2131377376));
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131381711));
  ...
  public static void a(String paramString, Intent paramIntent)
  {
    ...
    try
    {
      ...
      if (paramIntent.hasExtra("phonenum")) {
        localStringBuilder.append("phoneNum: ").append(PhoneCodeUtils.a(paramIntent.getStringExtra("phonenum"))).append("\r\n");
      }
  ...
  private void e()
  {
    ...
    if (jdField_a_of_type_Int == 1)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131364110));
      this.jdField_a_of_type_AndroidWidgetButton.setText(2131716951);
      ...
      ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131372770)).setVisibility(0);
      localClearableEditText1 = (ClearableEditText)this.jdField_a_of_type_AndroidViewView.findViewById(2131372292);
      ClearableEditText localClearableEditText2 = (ClearableEditText)this.jdField_a_of_type_AndroidViewView.findViewById(2131372769);
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131364008));
      break;
      label377:
      if (jdField_a_of_type_Int != 2) {
        break label251;
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqRegisterQueryAccount != null) {
      this.jdField_a_of_type_ComTencentMobileqqRegisterQueryAccount.a();
    }
    ...
    if (this.jdField_a_of_type_AndroidWidgetFrameLayout != null)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqVipLianghaoRegisterLHAssistant$MyLayoutChangeListener != null) {
        this.jdField_a_of_type_AndroidWidgetFrameLayout.removeOnLayoutChangeListener(this.jdField_a_of_type_ComTencentMobileqqVipLianghaoRegisterLHAssistant$MyLayoutChangeListener);
      }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidViewView.findViewById(2131375156).getLocationOnScreen(arrayOfInt);
    j = arrayOfInt[1];
    this.jdField_a_of_type_AndroidViewView.findViewById(2131372292).getLocationOnScreen(arrayOfInt);
    int k = arrayOfInt[1];
