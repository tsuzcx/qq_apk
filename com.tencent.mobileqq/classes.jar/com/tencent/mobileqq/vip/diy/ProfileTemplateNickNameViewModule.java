  ...
  extends ViewModel
{
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      {
        SLog.e("DIYProfileTemplate.ProfileTemplateNickNameViewModule", "pf_name font id illegal :" + paramString2 + " error=" + paramString1);
        return;
      }
      if ("ft".equals(paramString1)) {
        ...
        {
          SLog.e("DIYProfileTemplate.ProfileTemplateNickNameViewModule", "pf_name font type illegal :" + paramString2 + " error=" + paramString1);
          return;
        }
      }
    }
  ...
  public void b()
  {
    ...
    for (;;)
    {
      ...
      return;
      label112:
      SLog.e("DIYProfileTemplate.ProfileTemplateNickNameViewModule", "profile nick name set font error because font id=" + this.c + " type=" + this.d + " is illegal!");
    }
  }
}
