...
public class AioVipKeywordHelper
{
  ...
  public Pair a(boolean paramBoolean, int paramInt)
  {
    String str2 = "";
    String str1 = "";
    switch (paramInt)
  ...
  public void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, String paramString, boolean paramBoolean)
  {
    try
    {
      ...
      {
        label72:
        a(paramQQAppInterface, paramSessionInfo.jdField_a_of_type_Int, paramSessionInfo.jdField_a_of_type_JavaLangString, System.currentTimeMillis());
        a(paramQQAppInterface, paramSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.senderuin, paramSessionInfo.jdField_a_of_type_Int, -4021, str1, (String)localObject, str2, paramString);
        if (this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.isSend()) {}
        for (paramQQAppInterface = "0";; paramQQAppInterface = "1")
        {
          VasWebviewUtil.reportVipKeywords(paramString, paramQQAppInterface, "0", a(paramSessionInfo.jdField_a_of_type_Int), paramSessionInfo.jdField_a_of_type_JavaLangString, "", "", "", "", "");
  ...
  void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    if (TextUtils.isEmpty(paramString2))
    {
      ...
      paramInt1 = MobileQQService.jdField_a_of_type_Int;
      MobileQQService.jdField_a_of_type_Int = paramInt1 + 1;
    ...
    label230:
    label249:
    for (long l1 = this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.time;; l1 = MessageCache.a())
    {
  ...
  {
    boolean bool2 = false;
    paramAppRuntime = VasQuickUpdateManager.a(paramAppRuntime, "vip_personal_card.json", true, null);
    ...
    if (localObject1 != null) {
      EmoticonRecDressup.a(((JSONObject)localObject1).optLong("interval", 86400L));
    }
    ...
    if (localObject1 != null)
    {
      ...
      com.tencent.mobileqq.floatscr.ColorScreenManager.jdField_a_of_type_Boolean = bool1;
      QLog.i("AioVipKeywordHelper", 1, "lottieConfig.switch is " + bool1);
    }
    localObject1 = paramAppRuntime.optJSONObject("ipProductGrayTips");
    if (localObject1 != null)
    {
      CommercialDrainageManager.jdField_a_of_type_JavaLangString = ((JSONObject)localObject1).optString("leftText", CommercialDrainageManager.jdField_a_of_type_JavaLangString);
      CommercialDrainageManager.jdField_b_of_type_JavaLangString = ((JSONObject)localObject1).optString("linkText", CommercialDrainageManager.jdField_b_of_type_JavaLangString);
      if (QLog.isColorLevel()) {
