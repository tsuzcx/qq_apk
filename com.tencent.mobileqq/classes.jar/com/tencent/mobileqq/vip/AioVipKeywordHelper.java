...
public class AioVipKeywordHelper
{
  ...
  static String g = HardCodeUtil.a(2131700225);
  static String h = HardCodeUtil.a(2131700223);
  static String i = HardCodeUtil.a(2131700224);
  static String j = HardCodeUtil.a(2131700222);
  public int a;
  public long a;
  ...
  public void a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    FileUtils.a(paramContext.getFilesDir() + File.separator + "vipKerwordJson", paramString1);
  }
  ...
  void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    for (long l1 = this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.time;; l1 = MessageCache.a())
    {
      ...
      paramQQAppInterface.getMessageFacade().a(localMessageRecord, paramQQAppInterface.getCurrentAccountUin());
      return;
  ...
  public void a(AppRuntime paramAppRuntime)
  {
    ...
    for (bool1 = true;; bool1 = false)
    {
      ...
      if (localObject1 != null)
      {
        AvatarPendantUtil.jdField_a_of_type_Int = ((JSONObject)localObject1).optInt("interval", 5000);
        QLog.d("AioVipKeywordHelper", 1, "getStrangerInterval is " + AvatarPendantUtil.jdField_a_of_type_Int);
      }
      localObject1 = paramAppRuntime.optJSONObject("downloadTimeoutConfig");
      if (localObject1 != null)
      {
        EmojiManager.jdField_b_of_type_Int = ((JSONObject)localObject1).optInt("emotion", EmojiManager.jdField_b_of_type_Int);
        bool1 = bool2;
        if (((JSONObject)localObject1).optInt("emoTryReadNoLen", 0) == 1) {
          bool1 = true;
        }
        EmojiManager.jdField_b_of_type_Boolean = bool1;
  ...
  public boolean a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    do
    {
      ...
      {
        return false;
      } while ((SimpleUIUtil.a()) || (this.jdField_d_of_type_Int == 0));
      l1 = 86400L;
      int i1;
      switch (paramSessionInfo.jdField_a_of_type_Int)
      {
