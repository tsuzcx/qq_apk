...
public class KCWraperV2$2
  implements Runnable
{
  public KCWraperV2$2(batv parambatv, baue parambaue, boolean paramBoolean) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      batv.a(this.this$0, (OrderCheckResult)localObject);
    }
    this.jdField_a_of_type_Baue.a(true, bool, i);
  }
}
