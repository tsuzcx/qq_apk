  ...
  implements Handler.Callback, View.OnClickListener, OnGetPhotoWallListener
{
  ...
  public PhotoWallView(Context paramContext, QQAppInterface paramQQAppInterface, String paramString, PhotoWallView.PhotoWallUpdaterListener paramPhotoWallUpdaterListener)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppCardHandler$NowOnliveGallayCallback = new aldf(this);
  ...
  private void b()
  {
    ...
    this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130970572, this, true);
    this.jdField_a_of_type_AndroidViewView = findViewById(2131371133);
    this.jdField_a_of_type_ComTencentMobileqqWidgetProfileCardNewPhotoWallView = ((ProfileCardNewPhotoWallView)this.jdField_a_of_type_AndroidViewView.findViewById(2131371134));
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131371135);
    this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131371136);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131371137));
    this.d = findViewById(2131371138);
    this.e = findViewById(2131371139);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131371140));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131371141));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131371142));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131371143));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131371144));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.d.findViewById(2131371145));
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin().equals(this.jdField_a_of_type_JavaLangString)) {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(2131437548);
    }
    for (;;)
    {
      ThreadManager.post(new alde(this), 5, null, true);
      return;
      this.jdField_a_of_type_AndroidWidgetTextView.setText(2131437549);
    }
  }
