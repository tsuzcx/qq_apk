  ...
  extends TextView
{
  ...
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new akfb(this);
  ...
  public ContainerView$SelectableTextView(ContainerView paramContainerView, Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    setTextSelectHandle(2130846095);
    setTextSelectHandleLeft(2130846094);
    setTextSelectHandleRight(2130846096);
    setTextSize(28.0F);
    setTextColor(-16777216);
    setVisibility(4);
    if (Build.VERSION.SDK_INT >= 11) {
      setCustomSelectionActionModeCallback(new akfa(this, paramContainerView));
    }
  }
  ...
  public void setTextIsSelectable(boolean paramBoolean)
  {
    ...
    setOnLongClickListener(new akfc(this));
  }
