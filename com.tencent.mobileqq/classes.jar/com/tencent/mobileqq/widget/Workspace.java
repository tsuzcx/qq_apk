  ...
  extends FrameLayout
{
  ...
  private bbpg jdField_a_of_type_Bbpg;
  protected boolean a;
  ...
  public Workspace(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    setBackgroundDrawable(getResources().getDrawable(2130838503));
  }
  ...
  public void a(int paramInt)
  {
    ...
    for (paramInt = 1;; paramInt = 0)
    {
      if (this.jdField_c_of_type_Int != i)
      {
        ...
        if (this.jdField_a_of_type_Bbpg != null) {
          this.jdField_a_of_type_Bbpg.a(i);
        }
      }
  ...
  public void computeScroll()
  {
    ...
    do
    {
      ...
      this.jdField_d_of_type_Int = -1;
      b();
    } while (this.jdField_a_of_type_Bbpg == null);
    this.jdField_a_of_type_Bbpg.b(this.jdField_b_of_type_Int);
  }
    ...
    do
    {
      do
      {
        do
        {
          ...
          {
            this.jdField_a_of_type_Bbpg.b(getChildCount());
            return true;
          }
          this.jdField_a_of_type_Float = f1;
          paramMotionEvent = getParent();
  ...
  public void setOnScreenChangeListener(bbpg parambbpg)
  {
