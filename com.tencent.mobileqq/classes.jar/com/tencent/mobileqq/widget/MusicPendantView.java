  ...
  implements Handler.Callback
{
  ...
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new alcp(this);
  ...
  {
    super(paramContext);
    this.jdField_a_of_type_ComTencentMobileqqMusicpendantMusicPendantListener = new alcn(this);
    c();
  ...
  private void a(int paramInt)
  {
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130839468);
      return;
      label127:
      do
      {
        if (paramInt == 3)
        {
          this.jdField_b_of_type_AndroidViewView.setVisibility(0);
          this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
          this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130839469);
          return;
        }
        this.jdField_b_of_type_AndroidViewView.setVisibility(8);
        this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
  ...
  private void c()
  {
    LayoutInflater.from(getContext()).inflate(2130970432, this, true);
    this.jdField_a_of_type_ComTencentMobileqqWidgetArcImageView = ((ArcImageView)findViewById(2131370468));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131370467));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131370469));
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new alco(this));
    this.jdField_b_of_type_AndroidViewView = findViewById(2131370465);
    this.jdField_a_of_type_AndroidViewView = findViewById(2131370466);
    this.jdField_a_of_type_AndroidViewView.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131370464));
    this.jdField_b_of_type_AndroidWidgetImageView.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131370463));
      ...
      for (;;)
      {
        try
        {
          ...
          if (paramCard.mNowShowFlag == 1)
          {
            ...
            this.jdField_c_of_type_AndroidWidgetImageView.setOnClickListener(new alcr(this, (String)localObject, paramCard));
            this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
            this.jdField_b_of_type_AndroidViewView.setVisibility(8);
