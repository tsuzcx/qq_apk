  ...
  extends ImageView
{
  ...
  public void setImageRotateBitmapResetBase(RotateBitmap paramRotateBitmap, boolean paramBoolean)
  {
    if (getWidth() <= 0)
    {
      this.mOnLayoutRunnable = new akgh(this, paramRotateBitmap, paramBoolean);
      return;
    }
  ...
  protected void zoomTo(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    ...
    this.mHandler.post(new akgi(this, paramFloat4, l, f, paramFloat1, paramFloat2, paramFloat3));
  }
