  ...
  extends RelativeLayout
{
  ...
  private double a(Canvas paramCanvas, double paramDouble)
  {
    ...
    int j = 90;
    if (this.jdField_a_of_type_Akha.jdField_a_of_type_Double > 0.0D) {}
    for (int i = (int)(1.0D * paramDouble * 90 / this.jdField_a_of_type_Akha.jdField_a_of_type_Double);; i = 0)
    {
      if (i > 90) {
        i = j;
      }
      for (;;)
      {
        ...
        return paramDouble - this.jdField_a_of_type_Akha.jdField_a_of_type_Double;
      }
    }
  }
  ...
  private boolean a()
  {
    ...
    if (this.jdField_a_of_type_Akha == null)
    {
      ...
      this.jdField_a_of_type_Akha = new akha(this);
      this.jdField_a_of_type_Akha.jdField_a_of_type_Double = (0.25D * d1 / d2);
      this.jdField_a_of_type_Akha.b = (f1 * 1.0D / d2);
      this.jdField_a_of_type_Akha.c = (0.5D * d1 / d2);
      this.jdField_a_of_type_Akha.d = (f1 * 1.0D / d2);
      this.jdField_a_of_type_Akha.e = (d1 * 0.25D / d2);
    }
    return true;
  }
  ...
  private double b(Canvas paramCanvas, double paramDouble)
  {
    ...
    if (this.jdField_a_of_type_Akha.b > 0.0D) {
      d1 = paramDouble / this.jdField_a_of_type_Akha.b;
    }
    if (d1 > 1.0D) {
      d1 = d2;
    }
    for (;;)
    {
      ...
      return paramDouble - this.jdField_a_of_type_Akha.b;
    }
  }
  ...
  private double c(Canvas paramCanvas, double paramDouble)
  {
    ...
    int j = 180;
    if (this.jdField_a_of_type_Akha.c > 0.0D) {}
    for (int i = (int)(1.0D * paramDouble * '´' / this.jdField_a_of_type_Akha.c);; i = 0)
    {
      if (i > 180) {
        i = j;
      }
      for (;;)
      {
        ...
        return paramDouble - this.jdField_a_of_type_Akha.c;
      }
    }
  }
  ...
  private double d(Canvas paramCanvas, double paramDouble)
  {
    ...
    if (this.jdField_a_of_type_Akha.d > 0.0D) {
      d1 = paramDouble / this.jdField_a_of_type_Akha.d;
    }
    double d2 = d1;
    if (d1 > 1.0D) {
      d2 = 1.0D;
    ...
    return paramDouble - this.jdField_a_of_type_Akha.d;
  }
  ...
  private double e(Canvas paramCanvas, double paramDouble)
  {
    ...
    int j = 90;
    int i;
    if (this.jdField_a_of_type_Akha.e > 0.0D) {
      if (paramDouble > this.jdField_a_of_type_Akha.e * 0.99D) {
        i = 90;
      }
    }
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        return paramDouble - this.jdField_a_of_type_Akha.e;
        i = (int)(1.0D * paramDouble * 90 / this.jdField_a_of_type_Akha.e);
        break;
      }
      i = 0;
    }
