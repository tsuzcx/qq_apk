  ...
  extends RelativeLayout
{
  ...
  private double a(Canvas paramCanvas, double paramDouble)
  {
    ...
    for (int i = (int)(1.0D * paramDouble * 90 / this.jdField_a_of_type_ComTencentMobileqqWidgetOvalProgress$TagProgress.jdField_a_of_type_Double);; i = 0)
    {
      if (i > 90) {
        i = j;
      }
  ...
  private boolean a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqWidgetOvalProgress$TagProgress == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWidgetOvalProgress$TagProgress.jdField_a_of_type_Double = (0.25D * d1 / d2);
      this.jdField_a_of_type_ComTencentMobileqqWidgetOvalProgress$TagProgress.b = (f1 * 1.0D / d2);
      this.jdField_a_of_type_ComTencentMobileqqWidgetOvalProgress$TagProgress.c = (0.5D * d1 / d2);
      this.jdField_a_of_type_ComTencentMobileqqWidgetOvalProgress$TagProgress.d = (f1 * 1.0D / d2);
      this.jdField_a_of_type_ComTencentMobileqqWidgetOvalProgress$TagProgress.e = (d1 * 0.25D / d2);
    }
    return true;
  }
  ...
  private double c(Canvas paramCanvas, double paramDouble)
  {
    ...
    for (int i = (int)(1.0D * paramDouble * '´' / this.jdField_a_of_type_ComTencentMobileqqWidgetOvalProgress$TagProgress.c);; i = 0)
    {
      if (i > 180) {
        i = j;
      }
  ...
  private double e(Canvas paramCanvas, double paramDouble)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        i = (int)(1.0D * paramDouble * 90 / this.jdField_a_of_type_ComTencentMobileqqWidgetOvalProgress$TagProgress.e);
        break;
      }
      i = 0;
    }
