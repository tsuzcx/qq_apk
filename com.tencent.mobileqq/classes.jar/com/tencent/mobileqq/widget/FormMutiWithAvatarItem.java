  ...
  extends FormMutiItem
{
  ...
  private void d()
  {
    ...
    localLayoutParams.addRule(1, 2131301014);
    localLayoutParams.addRule(0, 2131301015);
    localLayoutParams.addRule(15);
  ...
  public void setOverimgLayout(int paramInt1, int paramInt2, String[] paramArrayOfString, azwg paramazwg)
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityContactNewfriendConnectionsOverlappingImgLayout.a(paramInt1, paramInt2, paramArrayOfString, paramazwg);
  }
  ...
  public void setOverloading()
  {
    ...
    int i = getResources().getDimensionPixelSize(2131165574);
    ...
    localLayoutParams.rightMargin = ((int)bacc.a(getContext(), 5.0F));
    ...
    localLayoutParams.rightMargin = ((int)bacc.a(getContext(), 12.0F));
