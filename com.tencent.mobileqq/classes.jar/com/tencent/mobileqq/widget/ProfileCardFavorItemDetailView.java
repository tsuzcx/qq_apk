  ...
  extends LinearLayout
{
  ...
  private void a()
  {
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130969135, this, true);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131365287));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131365288));
    this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131365290));
    this.jdField_c_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131365291));
    this.d = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131365293));
    this.e = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131365294));
    this.f = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131365296));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131365289));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131365292));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131365295));
  }
  
  public void a(Drawable paramDrawable, String paramString, int paramInt1, int paramInt2)
  {
    paramDrawable = new akhi(this, this.jdField_a_of_type_AndroidContentContext, paramDrawable, paramString, paramInt1);
