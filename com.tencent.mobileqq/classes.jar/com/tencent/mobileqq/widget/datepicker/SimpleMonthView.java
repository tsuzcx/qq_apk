  ...
  extends View
{
  ...
  private besl jdField_a_of_type_Besl;
  ...
  public SimpleMonthView(Context paramContext, TypedArray paramTypedArray)
  {
    ...
    this.K = xod.a(paramContext, 16.0F);
    this.L = xod.a(paramContext, 10.0F);
    this.M = xod.a(paramContext, 50.0F);
    this.N = xod.a(paramContext, 342.0F);
    this.O = xod.a(paramContext, 12.5F);
    this.P = xod.a(paramContext, 14.0F);
    this.Q = xod.a(paramContext, 17.5F);
  ...
  private void a(CalendarDay paramCalendarDay)
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_Besl.a(this, paramCalendarDay, localMessageRecord);
      return;
      label129:
      i1 += 1;
      break;
  ...
  protected void a(Canvas paramCanvas)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        paramCanvas.drawText(alpo.a(2131714545), i9, jdField_b_of_type_Int + i2 + jdField_d_of_type_Int / 2, this.jdField_d_of_type_AndroidGraphicsPaint);
        label541:
        if (i7 == 0) {
          break label745;
        }
  ...
  public void setOnDayClickListener(besl parambesl)
  {
    this.jdField_a_of_type_Besl = parambesl;
  }
