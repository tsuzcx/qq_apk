  ...
  extends Drawable
{
  ...
  public ProgressPieDrawable(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Aldt = new aldt(this);
  ...
  public void a()
  {
    this.jdField_a_of_type_Aldt.removeMessages(0);
    this.jdField_a_of_type_Aldt.a(this.jdField_b_of_type_Int);
    invalidateSelf();
  }
  ...
  public void b(int paramInt)
  {
    ...
    this.jdField_a_of_type_Aldt.a(paramInt);
    this.jdField_a_of_type_Aldt.sendEmptyMessage(0);
    invalidateSelf();
  }
  ...
  public void c(int paramInt)
  {
    ...
    ProgressPieDrawable.OnProgressListener localOnProgressListener;
    if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
    {
      localOnProgressListener = (ProgressPieDrawable.OnProgressListener)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localOnProgressListener != null)
      {
        if (this.jdField_b_of_type_Int != this.jdField_a_of_type_Int) {
          break label99;
        }
        localOnProgressListener.a(this);
      }
    }
    for (;;)
    {
      ...
      return;
      label99:
      localOnProgressListener.a(this, this.jdField_b_of_type_Int, this.jdField_a_of_type_Int);
    }
  }
