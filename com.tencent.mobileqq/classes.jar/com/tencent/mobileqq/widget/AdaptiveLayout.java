  ...
  extends ViewGroup
{
  ...
  private Map<Integer, bcja> jdField_a_of_type_JavaUtilMap = new HashMap();
  private int b;
  private int c;
  private int d;
  private int e;
      ...
      if (localView.getVisibility() != 8)
      {
        ...
        if (i4 > 0)
        {
          ...
          if (localView.getMeasuredWidth() + m > i6)
          {
            ...
            i1 = Math.max(j, m);
            n = i + (this.c + k);
            this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(i4), new bcja(this, m, k));
            i = this.mPaddingLeft;
  ...
  private void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    for (;;)
    {
      localObject = (bcja)this.jdField_a_of_type_JavaUtilMap.get(localObject);
      int k = this.b;
      int m = this.c;
      int i3;
      switch (this.d & 0x7)
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          for (i4 = i; i2 < i1; i4 = i5)
          {
            ...
            if (localView.getVisibility() != 8)
            {
              i5 = (((bcja)localObject).b - localView.getMeasuredHeight()) / 2 + (k + j);
              localView.layout(i4, i5, localView.getMeasuredWidth() + i4, localView.getMeasuredHeight() + i5);
              i5 = i4 + (localView.getMeasuredWidth() + i3);
            }
            i2 += 1;
          }
          i = this.mPaddingLeft + paramInt3 - paramInt1 - ((bcja)localObject).jdField_a_of_type_Int;
          i3 = k;
          break label162;
          i = this.mPaddingLeft + (paramInt3 - paramInt1 - ((bcja)localObject).jdField_a_of_type_Int) / 2;
          i3 = k;
          break label162;
          i = i1 - i2;
          k = (paramInt3 - paramInt1 - (((bcja)localObject).jdField_a_of_type_Int - this.b * (i - 1))) / i;
          break;
      ...
      if (i != i4) {}
      for (int i = ((bcja)localObject).b + m + j;; i = j)
      {
        n += 1;
        j = i;
        break;
