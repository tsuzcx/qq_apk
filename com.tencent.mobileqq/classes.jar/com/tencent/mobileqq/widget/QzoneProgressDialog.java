  ...
  extends ReportDialog
{
  ...
  public QzoneProgressDialog(Context paramContext, Intent paramIntent)
  {
    ...
    Object localObject1 = LayoutInflater.from(paramContext).inflate(2131562662, null);
    Object localObject2 = getWindow();
    ((Window)localObject2).setWindowAnimations(2131755840);
    ...
    this.a = ((TextView)((View)localObject1).findViewById(2131371913));
    localObject2 = paramIntent.getStringExtra("leftViewText");
    if (localObject2 == null) {
      localObject2 = paramContext.getString(2131690778);
    }
    for (;;)
    {
      if ("com.qzone.album.business.albumlist.activity.QZonePersonalAlbumActivity".equals(str2))
      {
        localObject3 = ((ViewStub)((View)localObject1).findViewById(2131378821)).inflate();
        localObject1 = paramIntent.getStringExtra("key_left_tab_title");
        if (!TextUtils.isEmpty((CharSequence)localObject1)) {
          break label917;
        }
        localObject1 = paramContext.getString(2131717404);
      }
      label917:
      for (;;)
      {
        ...
        for (paramContext = paramContext.getString(2131717485);; paramContext = paramIntent)
        {
          paramIntent = (ExtendButton)((View)localObject3).findViewById(2131363945);
          Object localObject4 = (ExtendButton)((View)localObject3).findViewById(2131363946);
          ...
          ((TextView)paramContext.findViewById(2131369487)).setText((CharSequence)localObject2);
          ((ProgressBar)((ViewStub)paramContext.findViewById(2131369548)).inflate()).setVisibility(0);
          return;
          localObject4 = ((ViewStub)((View)localObject1).findViewById(2131365120)).inflate();
          TextView localTextView = (TextView)((ViewStub)((View)localObject4).findViewById(2131369534)).inflate();
          String str1 = "";
          long l;
          if ("com.qzone.homepage.ui.activity.QZoneUserHomeActivity".equals(str2))
          {
            ...
            {
              localObject1 = HardCodeUtil.a(2131712177);
          ...
          for (;;)
          {
            ...
            {
              localObject1 = paramContext.getString(2131717631);
              localObject3 = paramContext.getString(2131717555);
            }
            else if ("com.qzone.cover.ui.activity.QzoneCoverPhotoWallActivity".equals(str2))
            {
              localObject1 = paramContext.getString(2131717529);
              localObject3 = localObject2;
            }
            else if ("com.qzone.cover.ui.activity.QZoneCoverStoreActivity".equals(str2))
            {
              localObject1 = paramContext.getString(2131717530);
              localObject3 = localObject2;
            }
            else if ("com.qzone.detail.ui.activity.QzoneDetailActivity".equals(str2))
            {
              ...
              {
                localObject3 = paramContext.getString(2131699170);
                localObject1 = str1;
              }
            }
            else if ("com.qzone.publish.ui.activity.QZoneUploadPhotoRealActivity".equals(str2))
            {
              str1 = paramContext.getString(2131718007);
              ...
              if (!TextUtils.isEmpty(paramIntent))
              {
                ...
                for (;;)
                {
                  ...
                  case 8: 
                  case 11: 
                    localObject1 = paramContext.getString(2131717922);
                    localObject3 = localObject2;
                    break;
            ...
            {
              localObject1 = paramContext.getString(2131717947);
              localObject3 = localObject2;
            }
            else if ("com.qzone.setting.QZoneSettingManager".equals(str2))
            {
              localObject1 = paramContext.getString(2131717956);
              localObject3 = localObject2;
            }
            else if ("com.qzone.album.business.photolist.activity.QZonePersonalPhotoListActivity".equals(str2))
            {
              ...
              {
                localObject1 = paramIntent + HardCodeUtil.a(2131712176);
                localObject3 = localObject2;
              }
              else
              {
            ...
            {
              localObject1 = paramContext.getString(2131717874);
              localObject3 = localObject2;
            }
            else
            {
              ...
              {
                localObject1 = paramContext.getString(2131717763);
                localObject3 = localObject2;
              }
            }
          }
