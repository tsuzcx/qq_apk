  ...
  extends ChatThumbView
{
  ...
  private float jdField_h_of_type_Float = 10.0F;
  ...
  static
  {
    ...
    {
      jdField_i_of_type_Boolean = bool;
      return;
    }
  }
  ...
  private void a()
  {
    this.jdField_e_of_type_Boolean = jdField_i_of_type_Boolean;
    if (VersionUtils.e())
    {
      this.jdField_a_of_type_Int = 1;
      String str = Build.MODEL.toUpperCase();
      if (((Build.VERSION.SDK_INT == 27) && (str.contains("PIXEL 2"))) || (str.contains("M821"))) {
    ...
    do
    {
      ...
      if (this.jdField_d_of_type_Boolean)
      {
        ...
        if (this.jdField_a_of_type_AndroidGraphicsPath == null)
        {
          ...
          localPath.quadTo(m - a(this.j, localResources), a(this.k, localResources), f1, f2);
          localPath.close();
      ...
      for (;;)
      {
        ...
        if (this.jdField_b_of_type_AndroidGraphicsPath == null)
        {
          ...
          f2 = a(this.jdField_i_of_type_Float, localResources);
          localPath.quadTo(a(this.j, localResources), a(this.k, localResources), f1, f2);
          localPath.close();
  ...
  public void a(float paramFloat1, float paramFloat2)
  {
    ...
    do
    {
      ...
      f4 = paramFloat1 - a(this.j, localResources);
