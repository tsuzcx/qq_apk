  ...
  extends TextView
{
  ...
  public void a(long paramLong, bhla parambhla)
  {
    ...
    if (this.jdField_a_of_type_Int == 0)
    {
      ...
      if (this.jdField_a_of_type_Float <= 0.0F)
      {
        if (this.jdField_a_of_type_Bhla != null) {
          this.jdField_a_of_type_Bhla.a();
        }
        setVisibility(4);
        return;
      }
      if (this.jdField_a_of_type_Bhla != null) {
        this.jdField_a_of_type_Bhla.a(System.currentTimeMillis() - this.jdField_b_of_type_Long);
      }
