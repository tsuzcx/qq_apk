  ...
  extends Toast
{
  ...
  public void show()
  {
      ...
      if (Build.VERSION.SDK_INT == 25)
      {
        ...
        if (!this.jdField_a_of_type_Boolean)
        {
          ...
          if ((localObject1 instanceof Handler)) {
            this.jdField_a_of_type_Boolean = a(localObject1, "mCallback", new bjcb(this, (Handler)localObject1));
          }
        }
    ...
    if (QQToast.a())
    {
      ...
      jdField_a_of_type_AndroidViewWindowManager$LayoutParams.windowAnimations = 2131755556;
    }
    for (;;)
    {
      try
      {
        ...
        localObject2 = (TextView)getView().findViewById(2131379122);
