  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    ((StringBuilder)localObject).append(this.jdField_a_of_type_ComTencentMobileqqProfilecardDataProfileCardInfo.troopUin);
    ((StringBuilder)localObject).append("&uin=");
    ((StringBuilder)localObject).append(this.jdField_a_of_type_ComTencentMobileqqProfilecardDataProfileCardInfo.allInOne.uin);
