  ...
  implements PraiseManager.OnPraiseLoadListener
{
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setId(2131364894);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130843167);
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setId(2131362396);
    localObject2 = ((Resources)localObject1).getDrawable(2130845894);
    ...
    for (int j = (int)(this.jdField_a_of_type_Double * 18.0D);; j = ((Drawable)localObject2).getIntrinsicHeight())
    {
      ...
      this.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setId(2131368335);
      ...
      ((RelativeLayout.LayoutParams)localObject2).addRule(1, 2131362396);
      ...
      ((RelativeLayout.LayoutParams)localObject1).addRule(7, 2131364894);
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetFrameLayout.setBackgroundResource(2130846134);
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2, int paramInt1, int paramInt2, NewVoteAnimHelper paramNewVoteAnimHelper, boolean paramBoolean3)
  {
    ...
    if (paramInt1 > 0)
    {
      ...
      localObject = super.getResources().getDrawable(2130845896);
      label65:
    ...
    for (;;)
    {
      ...
      break label39;
      label360:
      localObject = super.getResources().getDrawable(2130845894);
      break label65;
      label374:
