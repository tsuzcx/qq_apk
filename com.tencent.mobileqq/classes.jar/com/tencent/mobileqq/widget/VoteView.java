  ...
  implements atyw
{
  ...
  private void b()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setId(2131303097);
    ...
    ViewGroup localViewGroup = (ViewGroup)LayoutInflater.from(getContext()).inflate(2131495442, null);
    localViewGroup.setId(2131303235);
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setId(2131306188);
    localObject2 = ((Resources)localObject1).getDrawable(2130848734);
    ...
    for (int j = (int)(this.jdField_a_of_type_Double * 18.0D);; j = ((Drawable)localObject2).getIntrinsicHeight())
    {
      ...
      this.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setId(2131303512);
      ...
      ((RelativeLayout.LayoutParams)localObject2).addRule(1, 2131306188);
      ...
      this.jdField_a_of_type_AndroidWidgetFrameLayout.setContentDescription(((Resources)localObject1).getString(2131625568));
      localObject1 = new RelativeLayout.LayoutParams(-2, -2);
      ((RelativeLayout.LayoutParams)localObject1).addRule(10);
      ((RelativeLayout.LayoutParams)localObject1).addRule(7, 2131303097);
  ...
  public void a(int paramInt1, atyv paramatyv, int paramInt2, String paramString)
  {
    ...
    do
    {
      ...
      {
        return;
      } while ((paramInt1 != PraiseManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) || (paramatyv == null) || (this.c));
      a(paramatyv);
  ...
  public void a(atyv paramatyv)
  {
    ...
    while ((this.c) || (paramatyv == null) || (this.jdField_a_of_type_Atyr.jdField_a_of_type_Boolean)) {
      return;
    }
    ...
    this.jdField_a_of_type_Atyr.a(this.jdField_b_of_type_Boolean, false, this.jdField_a_of_type_AndroidWidgetImageView.getDrawable(), getResources());
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetFrameLayout.setBackgroundResource(2130849054);
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2, int paramInt1, int paramInt2, amwq paramamwq, boolean paramBoolean3)
  {
    ...
    if (paramInt1 > 0)
    {
      ...
      localObject = super.getResources().getDrawable(2130848737);
      label65:
      if (!this.jdField_a_of_type_Atyr.jdField_a_of_type_Boolean) {
        break label381;
      }
      this.jdField_a_of_type_Atyr.a(this.jdField_b_of_type_Boolean, false, (Drawable)localObject, getResources());
    }
    float f1;
    float f2;
    for (;;)
    {
      ...
      setContentDescription(String.format(getContext().getString(2131625584), new Object[] { String.valueOf(this.jdField_a_of_type_Int) }));
      if (this.c) {
        break label412;
      }
      a(false, 4);
      ...
      {
        paramamwq = new int[2];
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.getLocationInWindow(paramamwq);
        if (this.jdField_a_of_type_Aqem == null) {
          this.jdField_a_of_type_Aqem = new aqem(getContext(), 2130844958);
        }
        f1 = (float)(paramamwq[0] + (this.jdField_a_of_type_AndroidWidgetImageView.getWidth() + this.jdField_a_of_type_AndroidWidgetRelativeLayout.getPaddingLeft()) * 0.5D);
        f2 = paramamwq[1];
        paramInt1 = PraiseManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        if (paramInt1 <= 0) {
          break label393;
      ...
      break label39;
      label367:
      localObject = super.getResources().getDrawable(2130848734);
      break label65;
      label381:
