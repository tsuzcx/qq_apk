  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (localObject != null) {}
    for (localObject = ajjy.a(2131642663) + wku.a(((MessageRecord)localObject).time, true, false, true).toString();; localObject = null)
    {
      if (!TextUtils.isEmpty((CharSequence)localObject)) {
        this.this$0.jdField_a_of_type_Atwx.b = ((String)localObject);
      }
