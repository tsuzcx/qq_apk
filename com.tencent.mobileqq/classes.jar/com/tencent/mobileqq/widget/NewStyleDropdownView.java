  ...
  implements PopupWindow.OnDismissListener
{
  ...
  public NewStyleDropdownView(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Biqf = new biqf(this, paramContext);
    a(paramContext);
  }
  ...
  public NewStyleDropdownView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Biqf = new biqf(this, paramContext, paramAttributeSet);
    a(paramContext);
  }
  ...
  public NewStyleDropdownView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Biqf = new biqf(this, paramContext, paramAttributeSet, paramInt);
    a(paramContext);
  }
  ...
  private void a(Context paramContext)
  {
    ...
    try
    {
      View.class.getMethod("setImportantForAutofill", new Class[] { Integer.TYPE }).invoke(this.jdField_a_of_type_Biqf, new Object[] { Integer.valueOf(8) });
      this.jdField_a_of_type_Biqf.setHintTextColor(getResources().getColor(2131165805));
      this.jdField_a_of_type_Biqf.setHighlightColor(Color.parseColor("#8000CAFC"));
      ...
      addView(this.jdField_a_of_type_Biqf, (ViewGroup.LayoutParams)localObject);
      this.jdField_a_of_type_Biqf.setDropDownVerticalOffset(AIOUtils.dp2px(12.0F, getResources()));
      this.jdField_a_of_type_Biqf.setDropDownHeight(AIOUtils.dp2px(251.5F, getResources()));
      this.jdField_a_of_type_Biqf.setPadding(AIOUtils.dp2px(63.0F, getResources()), 0, AIOUtils.dp2px(63.0F, getResources()), 0);
      this.jdField_a_of_type_Biqf.setGravity(17);
      this.jdField_a_of_type_Biqf.setDropDownBackgroundResource(2130845354);
      localObject = new SpannableString(anvx.a(2131707023));
      ((SpannableString)localObject).setSpan(new AbsoluteSizeSpan(17, true), 0, ((SpannableString)localObject).length(), 33);
      this.jdField_a_of_type_Biqf.setHint((CharSequence)localObject);
      ...
      this.jdField_a_of_type_ComTencentImageURLImageView.setURLDrawableDownListener(new biqd(this));
      ...
      this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130844652);
      this.jdField_b_of_type_AndroidWidgetImageView.setClickable(true);
      this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
      this.jdField_b_of_type_AndroidWidgetImageView.setContentDescription(anvx.a(2131707024));
      localObject = new RelativeLayout.LayoutParams(-2, -2);
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(anvx.a(2131707022));
      this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130840665);
      this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130840666);
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new biqe(this));
    }
    catch (Exception localException)
    {
      for (;;)
      {
        try
        {
          paramContext = this.jdField_a_of_type_Biqf.getClass().getSuperclass().getDeclaredField("mPopup");
          paramContext.setAccessible(true);
          paramContext = paramContext.get(this.jdField_a_of_type_Biqf);
  ...
  {
    return this.jdField_a_of_type_Biqf;
  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Biqf != null) {
      this.jdField_a_of_type_Biqf.showDropDown();
    }
  }
  ...
  public void a(boolean paramBoolean, Object paramObject)
  {
    if (paramBoolean)
    {
      ...
      this.jdField_a_of_type_ComTencentImageURLImageView.setImageResource(2130840662);
      this.c.setVisibility(0);
      return;
    }
  ...
  public void onDismiss()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
    if (this.jdField_a_of_type_Biqg != null) {
      this.jdField_a_of_type_Biqg.c();
    }
