  ...
  implements PopupWindow.OnDismissListener
{
  ...
  public NewStyleDropdownView(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Bcng = new bcng(this, paramContext);
    a(paramContext);
  }
  ...
  public NewStyleDropdownView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Bcng = new bcng(this, paramContext, paramAttributeSet);
    a(paramContext);
  }
  ...
  public NewStyleDropdownView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Bcng = new bcng(this, paramContext, paramAttributeSet, paramInt);
    a(paramContext);
  }
  ...
  private void a(Context paramContext)
  {
    ...
    try
    {
      View.class.getMethod("setImportantForAutofill", new Class[] { Integer.TYPE }).invoke(this.jdField_a_of_type_Bcng, new Object[] { Integer.valueOf(8) });
      this.jdField_a_of_type_Bcng.setHintTextColor(getResources().getColor(2131165701));
      this.jdField_a_of_type_Bcng.setHighlightColor(Color.parseColor("#8000CAFC"));
      ...
      addView(this.jdField_a_of_type_Bcng, (ViewGroup.LayoutParams)localObject);
      this.jdField_a_of_type_Bcng.setDropDownVerticalOffset(actn.a(12.0F, getResources()));
      this.jdField_a_of_type_Bcng.setDropDownHeight(actn.a(251.5F, getResources()));
      this.jdField_a_of_type_Bcng.setPadding(actn.a(63.0F, getResources()), 0, actn.a(63.0F, getResources()), 0);
      this.jdField_a_of_type_Bcng.setGravity(17);
      this.jdField_a_of_type_Bcng.setDropDownBackgroundResource(2130844540);
      localObject = new SpannableString(ajyc.a(2131707562));
      ((SpannableString)localObject).setSpan(new AbsoluteSizeSpan(17, true), 0, ((SpannableString)localObject).length(), 33);
      this.jdField_a_of_type_Bcng.setHint((CharSequence)localObject);
      this.jdField_a_of_type_AndroidWidgetFrameLayout = new FrameLayout(paramContext);
      localObject = new RelativeLayout.LayoutParams(-2, -2);
      ((RelativeLayout.LayoutParams)localObject).setMargins(actn.a(10.0F, getResources()), 0, 0, 0);
      ((RelativeLayout.LayoutParams)localObject).addRule(15);
      addView(this.jdField_a_of_type_AndroidWidgetFrameLayout, (ViewGroup.LayoutParams)localObject);
      this.c = new ImageView(paramContext);
      int i = actn.a(40.0F, getResources()) + 4;
      ...
      this.jdField_a_of_type_ComTencentImageURLImageView.setURLDrawableDownListener(new bcne(this));
      ...
      this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130843887);
      this.jdField_b_of_type_AndroidWidgetImageView.setClickable(true);
      this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
      this.jdField_b_of_type_AndroidWidgetImageView.setContentDescription(ajyc.a(2131707563));
      localObject = new RelativeLayout.LayoutParams(-2, -2);
      ...
      ((RelativeLayout.LayoutParams)localObject).setMargins(0, 0, actn.a(40.0F, getResources()), 0);
      ((RelativeLayout.LayoutParams)localObject).addRule(15);
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(ajyc.a(2131707561));
      this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130840294);
      this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130840295);
      this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
      this.jdField_a_of_type_AndroidWidgetImageView.setClickable(true);
      paramContext = new RelativeLayout.LayoutParams(-2, -2);
      paramContext.setMargins(0, 0, actn.a(15.0F, getResources()), 0);
      paramContext.addRule(15);
      paramContext.addRule(11, -1);
      addView(this.jdField_a_of_type_AndroidWidgetImageView, paramContext);
      this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new bcnf(this));
    }
    catch (Exception localException)
    {
      for (;;)
      {
        try
        {
          paramContext = this.jdField_a_of_type_Bcng.getClass().getSuperclass().getDeclaredField("mPopup");
          paramContext.setAccessible(true);
          paramContext = paramContext.get(this.jdField_a_of_type_Bcng);
  ...
  {
    return this.jdField_a_of_type_Bcng;
  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Bcng != null) {
      this.jdField_a_of_type_Bcng.showDropDown();
    }
  }
  ...
  public void a(boolean paramBoolean, Object paramObject)
  {
    if (paramBoolean)
    {
      ...
      this.jdField_a_of_type_ComTencentImageURLImageView.setImageResource(2130840291);
      this.c.setVisibility(0);
      return;
    }
  ...
  public void onDismiss()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
    if (this.jdField_a_of_type_Bcnh != null) {
      this.jdField_a_of_type_Bcnh.c();
    }
