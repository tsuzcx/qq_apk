  ...
  implements PopupWindow.OnDismissListener
{
  ...
  public NewStyleDropdownView(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Bhyo = new bhyo(this, paramContext);
    a(paramContext);
  }
  ...
  public NewStyleDropdownView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Bhyo = new bhyo(this, paramContext, paramAttributeSet);
    a(paramContext);
  }
  ...
  public NewStyleDropdownView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Bhyo = new bhyo(this, paramContext, paramAttributeSet, paramInt);
    a(paramContext);
  }
  ...
  private void a(Context paramContext)
  {
    ...
    try
    {
      View.class.getMethod("setImportantForAutofill", new Class[] { Integer.TYPE }).invoke(this.jdField_a_of_type_Bhyo, new Object[] { Integer.valueOf(8) });
      this.jdField_a_of_type_Bhyo.setHintTextColor(getResources().getColor(2131165786));
      this.jdField_a_of_type_Bhyo.setHighlightColor(Color.parseColor("#8000CAFC"));
      ...
      addView(this.jdField_a_of_type_Bhyo, (ViewGroup.LayoutParams)localObject);
      this.jdField_a_of_type_Bhyo.setDropDownVerticalOffset(afur.a(12.0F, getResources()));
      this.jdField_a_of_type_Bhyo.setDropDownHeight(afur.a(251.5F, getResources()));
      this.jdField_a_of_type_Bhyo.setPadding(afur.a(63.0F, getResources()), 0, afur.a(63.0F, getResources()), 0);
      this.jdField_a_of_type_Bhyo.setGravity(17);
      this.jdField_a_of_type_Bhyo.setDropDownBackgroundResource(2130845375);
      localObject = new SpannableString(anni.a(2131706334));
      ((SpannableString)localObject).setSpan(new AbsoluteSizeSpan(17, true), 0, ((SpannableString)localObject).length(), 33);
      this.jdField_a_of_type_Bhyo.setHint((CharSequence)localObject);
      this.jdField_a_of_type_AndroidWidgetFrameLayout = new FrameLayout(paramContext);
      localObject = new RelativeLayout.LayoutParams(-2, -2);
      ((RelativeLayout.LayoutParams)localObject).setMargins(afur.a(10.0F, getResources()), 0, 0, 0);
      ((RelativeLayout.LayoutParams)localObject).addRule(15);
      addView(this.jdField_a_of_type_AndroidWidgetFrameLayout, (ViewGroup.LayoutParams)localObject);
      this.c = new ImageView(paramContext);
      int i = afur.a(40.0F, getResources()) + 4;
      ...
      this.jdField_a_of_type_ComTencentImageURLImageView.setURLDrawableDownListener(new bhym(this));
      ...
      this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130844696);
      this.jdField_b_of_type_AndroidWidgetImageView.setClickable(true);
      this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
      this.jdField_b_of_type_AndroidWidgetImageView.setContentDescription(anni.a(2131706335));
      localObject = new RelativeLayout.LayoutParams(-2, -2);
      ...
      ((RelativeLayout.LayoutParams)localObject).setMargins(0, 0, afur.a(40.0F, getResources()), 0);
      ((RelativeLayout.LayoutParams)localObject).addRule(15);
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(anni.a(2131706333));
      this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130840581);
      this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130840582);
      this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
      this.jdField_a_of_type_AndroidWidgetImageView.setClickable(true);
      paramContext = new RelativeLayout.LayoutParams(-2, -2);
      paramContext.setMargins(0, 0, afur.a(15.0F, getResources()), 0);
      paramContext.addRule(15);
      paramContext.addRule(11, -1);
      addView(this.jdField_a_of_type_AndroidWidgetImageView, paramContext);
      this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new bhyn(this));
    }
    catch (Exception localException)
    {
      for (;;)
      {
        try
        {
          paramContext = this.jdField_a_of_type_Bhyo.getClass().getSuperclass().getDeclaredField("mPopup");
          paramContext.setAccessible(true);
          paramContext = paramContext.get(this.jdField_a_of_type_Bhyo);
  ...
  {
    return this.jdField_a_of_type_Bhyo;
  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Bhyo != null) {
      this.jdField_a_of_type_Bhyo.showDropDown();
    }
  }
  ...
  public void a(boolean paramBoolean, Object paramObject)
  {
    if (paramBoolean)
    {
      ...
      this.jdField_a_of_type_ComTencentImageURLImageView.setImageResource(2130840578);
      this.c.setVisibility(0);
      return;
    }
