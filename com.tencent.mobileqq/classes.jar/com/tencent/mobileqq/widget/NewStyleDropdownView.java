  ...
  implements PopupWindow.OnDismissListener
{
  ...
  public NewStyleDropdownView(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Bcnv = new bcnv(this, paramContext);
    a(paramContext);
  }
  ...
  public NewStyleDropdownView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Bcnv = new bcnv(this, paramContext, paramAttributeSet);
    a(paramContext);
  }
  ...
  public NewStyleDropdownView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Bcnv = new bcnv(this, paramContext, paramAttributeSet, paramInt);
    a(paramContext);
  }
  ...
  private void a(Context paramContext)
  {
    ...
    try
    {
      View.class.getMethod("setImportantForAutofill", new Class[] { Integer.TYPE }).invoke(this.jdField_a_of_type_Bcnv, new Object[] { Integer.valueOf(8) });
      this.jdField_a_of_type_Bcnv.setHintTextColor(getResources().getColor(2131165701));
      this.jdField_a_of_type_Bcnv.setHighlightColor(Color.parseColor("#8000CAFC"));
      ...
      addView(this.jdField_a_of_type_Bcnv, (ViewGroup.LayoutParams)localObject);
      this.jdField_a_of_type_Bcnv.setDropDownVerticalOffset(actj.a(12.0F, getResources()));
      this.jdField_a_of_type_Bcnv.setDropDownHeight(actj.a(251.5F, getResources()));
      this.jdField_a_of_type_Bcnv.setPadding(actj.a(63.0F, getResources()), 0, actj.a(63.0F, getResources()), 0);
      this.jdField_a_of_type_Bcnv.setGravity(17);
      this.jdField_a_of_type_Bcnv.setDropDownBackgroundResource(2130844541);
      localObject = new SpannableString(ajya.a(2131707573));
      ((SpannableString)localObject).setSpan(new AbsoluteSizeSpan(17, true), 0, ((SpannableString)localObject).length(), 33);
      this.jdField_a_of_type_Bcnv.setHint((CharSequence)localObject);
      this.jdField_a_of_type_AndroidWidgetFrameLayout = new FrameLayout(paramContext);
      localObject = new RelativeLayout.LayoutParams(-2, -2);
      ((RelativeLayout.LayoutParams)localObject).setMargins(actj.a(10.0F, getResources()), 0, 0, 0);
      ((RelativeLayout.LayoutParams)localObject).addRule(15);
      addView(this.jdField_a_of_type_AndroidWidgetFrameLayout, (ViewGroup.LayoutParams)localObject);
      this.c = new ImageView(paramContext);
      int i = actj.a(40.0F, getResources()) + 4;
      ...
      this.jdField_a_of_type_ComTencentImageURLImageView.setURLDrawableDownListener(new bcnt(this));
      ...
      this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130843888);
      this.jdField_b_of_type_AndroidWidgetImageView.setClickable(true);
      this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
      this.jdField_b_of_type_AndroidWidgetImageView.setContentDescription(ajya.a(2131707574));
      localObject = new RelativeLayout.LayoutParams(-2, -2);
      ...
      ((RelativeLayout.LayoutParams)localObject).setMargins(0, 0, actj.a(40.0F, getResources()), 0);
      ((RelativeLayout.LayoutParams)localObject).addRule(15);
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(ajya.a(2131707572));
      this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130840291);
      this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130840292);
      this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
      this.jdField_a_of_type_AndroidWidgetImageView.setClickable(true);
      paramContext = new RelativeLayout.LayoutParams(-2, -2);
      paramContext.setMargins(0, 0, actj.a(15.0F, getResources()), 0);
      paramContext.addRule(15);
      paramContext.addRule(11, -1);
      addView(this.jdField_a_of_type_AndroidWidgetImageView, paramContext);
      this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new bcnu(this));
    }
    catch (Exception localException)
    {
      for (;;)
      {
        try
        {
          paramContext = this.jdField_a_of_type_Bcnv.getClass().getSuperclass().getDeclaredField("mPopup");
          paramContext.setAccessible(true);
          paramContext = paramContext.get(this.jdField_a_of_type_Bcnv);
  ...
  {
    return this.jdField_a_of_type_Bcnv;
  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Bcnv != null) {
      this.jdField_a_of_type_Bcnv.showDropDown();
    }
  }
  ...
  public void a(boolean paramBoolean, Object paramObject)
  {
    if (paramBoolean)
    {
      ...
      this.jdField_a_of_type_ComTencentImageURLImageView.setImageResource(2130840288);
      this.c.setVisibility(0);
      return;
    }
  ...
  public void onDismiss()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
    if (this.jdField_a_of_type_Bcnw != null) {
      this.jdField_a_of_type_Bcnw.c();
    }
