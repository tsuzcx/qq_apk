  ...
  extends TextView
{
  ...
  private void a(String paramString, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Beiy != null) {}
    float f1;
    for (paramInt = this.jdField_a_of_type_Beiy.a();; paramInt = getWidth())
    {
  ...
  public void setOnGetMaxWidthCallback(beiy parambeiy)
  {
    this.jdField_a_of_type_Beiy = parambeiy;
  }
}
