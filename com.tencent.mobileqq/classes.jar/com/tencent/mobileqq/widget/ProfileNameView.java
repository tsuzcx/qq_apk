  ...
  extends RelativeLayout
{
  ...
  public ProfileNameView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.jdField_a_of_type_Int = (Math.min(paramContext.widthPixels, paramContext.heightPixels) - awmc.a(188.0F));
    this.jdField_b_of_type_Int = getResources().getColor(2131101411);
    this.c = 24;
    this.d = 20;
    a();
  }
  ...
  private void a()
  {
    this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131495436, this);
    this.jdField_a_of_type_ComTencentMobileqqWidgetColorNickTextView = ((ColorNickTextView)findViewById(2131302492));
    this.jdField_b_of_type_ComTencentMobileqqWidgetColorNickTextView = ((ColorNickTextView)findViewById(2131302493));
    this.jdField_a_of_type_ComTencentMobileqqVipDiyETTextViewPlus = ((ETTextViewPlus)findViewById(2131302494));
    this.jdField_a_of_type_ComTencentMobileqqVipDiyETTextViewPlus.setVisibility(8);
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131309557));
  ...
  private void a(QQAppInterface paramQQAppInterface, atwx paramatwx, ViewGroup paramViewGroup, TextView paramTextView)
  {
    if ((!paramatwx.b) || (paramViewGroup == null) || (paramTextView == null)) {
      return;
    }
    if (atxx.a(((TroopManager)paramQQAppInterface.getManager(52)).b(paramatwx.jdField_a_of_type_JavaLangString), paramatwx.jdField_a_of_type_ComTencentMobileqqDataTroopMemberCard, paramTextView))
    {
      paramViewGroup.setVisibility(0);
      paramTextView.setPadding(10, 2, 10, 2);
      if (TroopInfo.isQidianPrivateTroop(paramQQAppInterface, paramatwx.jdField_a_of_type_JavaLangString)) {
        ayqn.a().a(paramatwx.jdField_a_of_type_JavaLangString, paramatwx.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_JavaLangString, false);
      }
      label276:
      while (!this.jdField_a_of_type_Boolean)
      {
        ayqn.a("grp_data", "exp_medal");
        this.jdField_a_of_type_Boolean = true;
        return;
        switch (paramatwx.jdField_a_of_type_ComTencentMobileqqDataTroopMemberCard.memberRole)
        {
        }
        for (;;)
        {
          if ((!ayqn.a().a(paramatwx.jdField_a_of_type_JavaLangString, paramatwx.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_JavaLangString)) || (this.jdField_a_of_type_AndroidWidgetImageView != null)) {
            break label276;
          }
          ...
          this.jdField_a_of_type_AndroidWidgetImageView.setId(2131309284);
          ...
          break;
          paramViewGroup.setOnClickListener(new bbmd(paramQQAppInterface, paramatwx));
        }
      }
    }
  ...
  private void a(QQAppInterface paramQQAppInterface, atwx paramatwx, TroopHonorView paramTroopHonorView)
  {
    if ((paramatwx != null) && (paramatwx.jdField_a_of_type_ComTencentMobileqqDataTroopMemberCard != null))
    {
      paramQQAppInterface = (azcd)paramQQAppInterface.getManager(346);
      if (!paramQQAppInterface.a(paramatwx.jdField_a_of_type_JavaLangString, false))
      {
      ...
      {
        return;
        paramQQAppInterface = paramQQAppInterface.a(paramatwx.jdField_a_of_type_ComTencentMobileqqDataTroopMemberCard.honorList);
        paramTroopHonorView.setHonorList(paramQQAppInterface);
        if ((paramQQAppInterface != null) && (paramQQAppInterface.size() > 0))
        {
          paramTroopHonorView.setVisibility(0);
          paramTroopHonorView.setOnClickListener(new bbmc(this, paramatwx));
        }
  ...
  public int a()
  {
    ...
    Object localObject = (TextView)findViewById(2131298391);
    i = j;
    if (((TextView)localObject).getVisibility() == 0)
    {
      ...
      {
        float f1 = j;
        float f2 = bajq.b(4.0F) + ((TextView)localObject).getPaddingLeft();
    ...
    localObject = (TroopHonorView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131298394);
    j = i;
  ...
  public void a(@NonNull QQAppInterface paramQQAppInterface, @Nullable TextView paramTextView, @Nullable String paramString)
  {
    ...
    if ((paramTextView != null) && (paramString != null))
    {
      ...
      paramString = new axjq(paramString, (int)(paramTextView.getTextSize() / this.jdField_a_of_type_Float)).a();
      paramTextView.setText(paramString);
      bami.a(paramQQAppInterface, paramTextView, paramString);
    }
  }
  
  public void a(QQAppInterface paramQQAppInterface, atwx paramatwx)
  {
    if ((paramQQAppInterface == null) || (paramatwx == null) || (paramatwx.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne == null) || (paramatwx.jdField_a_of_type_Azuc == null))
    {
      setVisibility(8);
      return;
    }
    ...
    try
    {
      localObject2 = paramatwx.jdField_a_of_type_Azuc.a.jdField_a_of_type_JavaLangString;
    ...
    else
    {
      ...
      localObject2 = String.valueOf(paramatwx.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_JavaLangString);
    }
    label139:
    if ((paramatwx.jdField_a_of_type_ComTencentMobileqqDataCard != null) && (!paramatwx.jdField_a_of_type_ComTencentMobileqqDataCard.isNoCover()))
    {
      this.jdField_a_of_type_ComTencentMobileqqWidgetColorNickTextView.setShadowLayer(awmc.a(1.0F), 0.0F, 0.0F, -16777216);
      this.jdField_b_of_type_ComTencentMobileqqWidgetColorNickTextView.setShadowLayer(awmc.a(1.0F), 0.0F, 0.0F, -16777216);
      label190:
      this.jdField_a_of_type_Axjx = new axjx((String)localObject2, (int)(this.jdField_a_of_type_ComTencentMobileqqWidgetColorNickTextView.getTextSize() / this.jdField_a_of_type_Float));
      localaxjx = this.jdField_a_of_type_Axjx.b(4);
      this.jdField_a_of_type_Axjx.a(4);
      str = String.format("%s:%s", new Object[] { this.jdField_a_of_type_AndroidContentContext.getString(2131625590), this.jdField_a_of_type_Axjx });
      if ((!azzz.b(paramatwx.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_JavaLangString)) && (!paramatwx.b)) {
        break label1557;
      }
      localResources = this.jdField_a_of_type_AndroidContentContext.getResources();
      this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(0);
      localObject1 = this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131297338);
      ...
      f1 = localResources.getDimensionPixelSize(2131166296) + 0.0F;
      label347:
      localViewGroup = (ViewGroup)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131298392);
      if (!paramatwx.b) {
        break label984;
      }
      localTextView = (TextView)localViewGroup.findViewById(2131298391);
      a(paramQQAppInterface, paramatwx, localViewGroup, localTextView);
      ...
      localObject1 = (TroopHonorView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131298394);
      a(paramQQAppInterface, paramatwx, (TroopHonorView)localObject1);
      f1 = f2;
      if (((TroopHonorView)localObject1).getVisibility() == 0) {
        f1 = f2 + ((TroopHonorView)localObject1).a();
      }
      j = localResources.getDimensionPixelSize(2131166297);
      f1 += j;
      ...
      f2 = localaxjx.a((Paint)localObject1);
      if (f2 + f1 >= this.jdField_a_of_type_Int) {
        break label994;
      }
      a(paramQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqWidgetColorNickTextView, this.jdField_a_of_type_Axjx.b());
      this.jdField_b_of_type_ComTencentMobileqqWidgetColorNickTextView.setVisibility(8);
    ...
    for (;;)
    {
      ...
      paramQQAppInterface = new atuw(88, this.jdField_a_of_type_Axjx.toString());
      if ((i == 1) && (f1 > 0.0F))
      {
      ...
      setOnClickListener(paramatwx.jdField_a_of_type_AndroidViewView$OnClickListener);
      setOnLongClickListener(paramatwx.jdField_a_of_type_AndroidViewView$OnLongClickListener);
      if (!QLog.isColorLevel()) {
        break;
      }
      QLog.i("ProfileNameView", 2, String.format("update 6 [max: %s, title: %s]", new Object[] { Integer.valueOf(this.jdField_a_of_type_Int), this.jdField_a_of_type_Axjx.toString() }));
      return;
      label927:
      localObject2 = " ";
      break label139;
      ...
      break label515;
      label994:
      ((TextPaint)localObject1).setTextSize(awmc.a(this.d));
      float f3 = localaxjx.a((Paint)localObject1);
      ...
      else
      {
        ...
        continue;
        i = 3;
        localObject2 = this.jdField_a_of_type_Axjx.toString();
