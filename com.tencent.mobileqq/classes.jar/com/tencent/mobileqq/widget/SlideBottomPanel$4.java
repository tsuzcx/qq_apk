  ...
  public void onAnimationUpdate(ValueAnimator paramValueAnimator)
  {
    ...
    if ((paramValueAnimator instanceof Float))
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqWidgetSlideBottomPanel.a != null) {
        this.jdField_a_of_type_ComTencentMobileqqWidgetSlideBottomPanel.a.fadeBackground(1.0F - ((Float)paramValueAnimator).floatValue() / (this.jdField_a_of_type_ComTencentMobileqqWidgetSlideBottomPanel.b - this.jdField_a_of_type_ComTencentMobileqqWidgetSlideBottomPanel.j));
      }
    }
  }
}
