  ...
  extends RelativeLayout
{
  ...
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new bcmj(this);
  ...
  public FolderTextView(Context paramContext, @Nullable AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Int = paramAttributeSet.getDimensionPixelSize(0, bbll.a(12.0F));
      this.jdField_a_of_type_Int = bbll.e(this.jdField_a_of_type_Int);
    ...
    if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
      this.jdField_a_of_type_JavaLangString = ajya.a(2131704673);
    }
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setId(2131378181);
    ...
    localLayoutParams.addRule(8, 2131378181);
    localLayoutParams.addRule(7, 2131378181);
  ...
  private void b()
  {
    ...
    if (this.e == 0)
    {
      ...
      if ((this.jdField_a_of_type_JavaLangCharSequence instanceof aykk))
      {
