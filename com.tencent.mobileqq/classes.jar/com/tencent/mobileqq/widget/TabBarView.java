  ...
  extends LinearLayout
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new bcrz(this);
  ...
  public TabBarView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.e = paramContext.getResources().getColor(2131166862);
    this.f = paramContext.getResources().getColor(2131166854);
  ...
  private void a(int paramInt1, int paramInt2)
  {
    if (this.jdField_a_of_type_Bcsc != null) {
      this.jdField_a_of_type_Bcsc.onTabSelected(paramInt1, paramInt2);
    }
  }
  ...
  private void b()
  {
    ...
    if ((localObject != null) && (((AccessibilityManager)localObject).isEnabled()))
    {
      ...
      while (i1 < i2)
      {
        ...
        {
          ((StringBuilder)localObject).append(localRedDotTextView.getText()).append("，").append(getContext().getString(2131691105));
          if (this.o == i1) {
  ...
  public RedDotTextView a(int paramInt)
  {
    ...
    localView = localView.findViewById(2131377107);
  ...
  public RedDotTextView a(int paramInt, String paramString, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    if (!TextUtils.isEmpty(paramString)) {
      localRedDotTextView.setOnClickListener(new bcsa(this, paramInt));
    }
    ViewCompat.setAccessibilityDelegate(localRedDotTextView, new bcsb(this));
    ...
    for (;;)
    {
      ...
      if (i1 != i3)
      {
        ...
        break label397;
        label912:
        localRedDotTextView.setId(2131377107);
  ...
  public void setOnTabChangeListener(bcsc parambcsc)
  {
