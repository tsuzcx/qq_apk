  ...
  extends FormSimpleItem
{
  ...
  private void d()
  {
    ...
    int j = getResources().getDimensionPixelSize(2131165565);
    ...
    for (;;)
    {
      j = getResources().getDimensionPixelSize(2131165574);
      ...
      ((LinearLayout.LayoutParams)localObject).topMargin = getResources().getDimensionPixelOffset(2131165549);
      if (!this.c) {
        ((LinearLayout.LayoutParams)localObject).bottomMargin = getResources().getDimensionPixelOffset(2131165555);
      }
      ...
      ((RelativeLayout.LayoutParams)localObject).addRule(1, 2131301014);
      ((RelativeLayout.LayoutParams)localObject).addRule(0, 2131301016);
      ((RelativeLayout.LayoutParams)localObject).addRule(15);
      addView(this.jdField_a_of_type_AndroidWidgetLinearLayout, (ViewGroup.LayoutParams)localObject);
      setCustomHeight(getResources().getDimensionPixelSize(2131167004));
      return;
      this.jdField_b_of_type_AndroidWidgetTextView.setSingleLine(false);
      ((LinearLayout.LayoutParams)localObject).topMargin = getResources().getDimensionPixelSize(2131165559);
    }
  }
  ...
  public void setSecondLineVisible(boolean paramBoolean)
  {
    ...
    label63:
    label69:
    for (int j = getResources().getDimensionPixelSize(2131167004);; j = getResources().getDimensionPixelSize(2131166921))
    {
      setCustomHeight(j);
      return;
      j = 0;
