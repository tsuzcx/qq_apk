  ...
  extends ClearableEditText
{
  ...
  private ArrayList<QColorClearableEditText.Paragraph> n = new ArrayList();
  private int o;
  private QColorClearableEditText.SpanComparator p = new QColorClearableEditText.SpanComparator();
  ...
  public static void a(List<QColorClearableEditText.Paragraph> paramList, QColorClearableEditText.SpanComparator paramSpanComparator, Spannable paramSpannable)
  {
    ...
    for (i2 = 0; i1 < arrayOfCharacterStyle.length; i2 = i3)
    {
      ...
      if (i4 > i2) {
        paramList.add(new QColorClearableEditText.Paragraph(1, i2, i4, paramSpannable.subSequence(i2, i4).toString(), null));
      }
      ...
      paramList.add(new QColorClearableEditText.Paragraph(i2, i4, i3, paramSpanComparator, arrayOfCharacterStyle[i1]));
      if ((i1 == arrayOfCharacterStyle.length - 1) && (i3 < paramSpannable.length()))
      {
        ...
        paramList.add(new QColorClearableEditText.Paragraph(1, i3, paramSpannable.length(), paramSpanComparator, null));
      }
      i1 += 1;
    }
  }
  ...
  private PointF getContentSize()
  {
    ...
    {
      Object localObject = (QColorClearableEditText.Paragraph)this.n.get(i1);
      int i2 = ((QColorClearableEditText.Paragraph)localObject).e;
      if (i2 != 1)
      {
        if (i2 == 2)
        {
  ...
  public ArrayList<QColorClearableEditText.Paragraph> getParagraphs()
  {
    return this.n;
  }
      ...
      if ((f3 > 0.0F) && (f6 > 0.0F))
      {
        ...
        if (i1 != 1)
        {
          ...
          if (i1 != 2)
          {
            if (i1 != 3)
            {
              ...
              else
              {
                ...
                {
                  localParagraph = (QColorClearableEditText.Paragraph)this.n.get(i2);
                  i3 = localParagraph.e;
                  if (i3 != 1)
                  {
                    if (i3 == 2) {
          ...
          else
          {
            ...
            {
              localParagraph = (QColorClearableEditText.Paragraph)this.n.get(i3);
              i2 = localParagraph.e;
              if (i2 != 1)
              {
                if (i2 == 2) {
