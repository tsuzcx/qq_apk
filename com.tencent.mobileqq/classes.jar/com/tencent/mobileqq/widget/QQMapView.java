  ...
  extends MapView
{
  ...
  public QQMapView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_ComTencentTencentmapMapsdkMapsTencentMap$OnCameraChangeListener = new bcpo(this);
  ...
  public QQMapView(Context paramContext, AttributeSet paramAttributeSet, TencentMapOptions paramTencentMapOptions)
  {
    ...
    this.jdField_a_of_type_ComTencentTencentmapMapsdkMapsTencentMap$OnCameraChangeListener = new bcpn(this);
    getMap().setOnCameraChangeListener(this.jdField_a_of_type_ComTencentTencentmapMapsdkMapsTencentMap$OnCameraChangeListener);
  }
  ...
  private void a(CameraPosition paramCameraPosition)
  {
    ...
    if (!b) {
      this.jdField_a_of_type_Bcpp.onMapScrollEnd(paramCameraPosition);
    }
    for (;;)
    {
  ...
  public void a()
  {
    this.jdField_a_of_type_Bcpp = null;
  ...
  public void setObserver(bcpp parambcpp)
  {
    this.jdField_a_of_type_Bcpp = parambcpp;
  }
}
