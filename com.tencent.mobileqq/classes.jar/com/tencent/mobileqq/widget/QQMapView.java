  ...
  extends MapView
{
  ...
  public QQMapView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_ComTencentTencentmapMapsdkMapsTencentMap$OnCameraChangeListener = new bbmq(this);
  ...
  public QQMapView(Context paramContext, AttributeSet paramAttributeSet, TencentMapOptions paramTencentMapOptions)
  {
    ...
    this.jdField_a_of_type_ComTencentTencentmapMapsdkMapsTencentMap$OnCameraChangeListener = new bbmp(this);
    getMap().setOnCameraChangeListener(this.jdField_a_of_type_ComTencentTencentmapMapsdkMapsTencentMap$OnCameraChangeListener);
  }
  ...
  private void a(CameraPosition paramCameraPosition)
  {
    ...
    if (!b) {
      this.jdField_a_of_type_Bbmr.onMapScrollEnd(paramCameraPosition);
    }
    for (;;)
    {
  ...
  public void a()
  {
    this.jdField_a_of_type_Bbmr = null;
  ...
  public void setObserver(bbmr parambbmr)
  {
