    ...
    for (;;)
    {
      ...
      try
      {
        for (;;)
        {
          ...
          if ((localObject2 instanceof PopupWindow)) {
            ((PopupWindow)localObject2).setAnimationStyle(2130772315);
          }
          ...
          try
          {
            ((ListView)localObject2).setPadding(NewStyleDropdownView.a(this.jdField_a_of_type_ComTencentMobileqqWidgetNewStyleDropdownView, 13.0F, getResources()), 0, NewStyleDropdownView.a(this.jdField_a_of_type_ComTencentMobileqqWidgetNewStyleDropdownView, 13.0F, getResources()), 0);
      ...
      if ((localThrowable.getChildAt(j) != null) && ((localThrowable.getChildAt(j) instanceof LoginPopupRightMaskView)))
      {
        ...
        if (i == 0)
        {
          ...
          FrameLayout.LayoutParams localLayoutParams = new FrameLayout.LayoutParams(NewStyleDropdownView.a(this.jdField_a_of_type_ComTencentMobileqqWidgetNewStyleDropdownView, 20.0F, getResources()), -1);
        ...
        localObject4 = new FrameLayout.LayoutParams(-1, NewStyleDropdownView.a(this.jdField_a_of_type_ComTencentMobileqqWidgetNewStyleDropdownView, 14.0F, getResources()));
