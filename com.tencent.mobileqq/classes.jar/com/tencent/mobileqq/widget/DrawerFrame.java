  ...
  implements Handler.Callback
{
  ...
  public DrawerFrame(Context paramContext, ViewGroup paramViewGroup)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetScroller = new Scroller(paramContext, new bbim());
    a(paramViewGroup);
  }
  ...
  private void a(View paramView)
  {
    ...
    if ((paramView instanceof ViewGroup))
    {
      ...
      this.jdField_a_of_type_AndroidViewViewGroup.setOnClickListener(new bbik(this));
      return;
    }
  ...
  protected void a(int paramInt1, int paramInt2)
  {
    ...
    for (View localView = this.jdField_b_of_type_AndroidViewView;; localView = this.jdField_c_of_type_AndroidViewView)
    {
      ...
      if (this.jdField_a_of_type_Bbil != null) {
        this.jdField_a_of_type_Bbil.a(this.j, f1);
      }
      return;
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Bbil != null) {
        this.jdField_a_of_type_Bbil.b(this.j);
      }
      switch (paramInt)
      {
      default: 
        if (this.jdField_a_of_type_Bbil != null) {
          this.jdField_a_of_type_Bbil.e();
        }
  ...
  public void d()
  {
    ...
    this.jdField_a_of_type_Bbil = null;
  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_f_of_type_Boolean = false;
      this.jdField_a_of_type_Bbil.a(1);
      break label317;
      label422:
      bool = false;
    }
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    case 2: 
      ...
      this.jdField_d_of_type_Boolean = true;
      if ((!bool) && (this.jdField_a_of_type_Bbil != null)) {
        this.jdField_a_of_type_Bbil.b(this.j);
      }
  ...
  public void setDrawerCallbacks(bbil parambbil)
  {
