  ...
  extends PAImageView
{
  ...
  public PAHighLightImageView(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Bhyt = new bhyt(this, paramContext);
    setOnTouchListener(this.jdField_a_of_type_Bhyt);
  }
  ...
  public void a()
  {
    ...
    {
      View localView = localViewGroup.findViewById(2131373037);
      if (localView != null) {
  ...
  {
    ViewGroup localViewGroup = (ViewGroup)getParent();
    if ((localViewGroup != null) && (localViewGroup.findViewById(2131373037) == null))
    {
      View localView = new View(paramContext);
      localView.setId(2131373037);
      GradientDrawable localGradientDrawable = new GradientDrawable();
      localGradientDrawable.setColor(Color.argb(77, 0, 0, 0));
      if (paramBoolean) {
        localGradientDrawable.setCornerRadius(afur.a(5.0F, paramContext.getResources()));
      }
