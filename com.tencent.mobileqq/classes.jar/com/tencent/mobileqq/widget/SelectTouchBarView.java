  ...
  extends RelativeLayout
{
  ...
  public SelectTouchBarView(Context paramContext)
  {
    ...
    LayoutInflater.from(paramContext).inflate(2131493024, this);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131296820));
    a((RelativeLayout)findViewById(2131296819));
  }
  
  private void a(RelativeLayout paramRelativeLayout)
  {
    int i = (int)babp.a(true);
    int j = View.MeasureSpec.makeMeasureSpec(0, 0);
    this.jdField_a_of_type_AndroidWidgetTextView.measure(j, j);
    j = (i - this.jdField_a_of_type_AndroidWidgetTextView.getMeasuredWidth() - azvv.a(this.jdField_a_of_type_AndroidContentContext, 16.0F)) / 2;
    i = j;
    if (j < 0) {
      i = 0;
    }
  ...
  public void a()
  {
    RelativeLayout localRelativeLayout = (RelativeLayout)findViewById(2131296819);
