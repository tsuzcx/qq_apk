  ...
  implements PopupWindow.OnDismissListener
{
  ...
  public DropdownView(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Belf = new belf(this, paramContext);
    a(paramContext);
  }
  ...
  public DropdownView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Belf = new belf(this, paramContext, paramAttributeSet);
    a(paramContext);
  }
  ...
  public DropdownView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Belf = new belf(this, paramContext, paramAttributeSet, paramInt);
    a(paramContext);
  }
  ...
  private void a(Context paramContext)
  {
    ...
    addView(this.jdField_a_of_type_Belf, (ViewGroup.LayoutParams)localObject1);
    this.jdField_a_of_type_Belf.setDropDownVerticalOffset(0);
    ...
    ((RelativeLayout.LayoutParams)localObject2).addRule(7, this.jdField_a_of_type_Belf.getId());
    ...
    this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130839206);
    this.jdField_b_of_type_AndroidWidgetImageView.setClickable(true);
    this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
    this.jdField_b_of_type_AndroidWidgetImageView.setContentDescription(alpo.a(2131703929));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(alpo.a(2131703930));
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130840397);
    this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130840398);
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new bele(this));
    try
    {
      paramContext = this.jdField_a_of_type_Belf.getClass().getSuperclass().getDeclaredField("mPopup");
      paramContext.setAccessible(true);
      paramContext = paramContext.get(this.jdField_a_of_type_Belf);
  ...
  {
    return this.jdField_a_of_type_Belf;
  }
