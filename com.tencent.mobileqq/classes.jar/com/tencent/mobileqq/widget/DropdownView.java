  ...
  implements PopupWindow.OnDismissListener
{
  ...
  public DropdownView(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Bcmd = new bcmd(this, paramContext);
    a(paramContext);
  }
  ...
  public DropdownView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Bcmd = new bcmd(this, paramContext, paramAttributeSet);
    a(paramContext);
  }
  ...
  public DropdownView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Bcmd = new bcmd(this, paramContext, paramAttributeSet, paramInt);
    a(paramContext);
  }
  ...
  private void a(Context paramContext)
  {
    ...
    addView(this.jdField_a_of_type_Bcmd, (ViewGroup.LayoutParams)localObject1);
    this.jdField_a_of_type_Bcmd.setDropDownVerticalOffset(0);
    ...
    ((RelativeLayout.LayoutParams)localObject2).addRule(7, this.jdField_a_of_type_Bcmd.getId());
    ...
    this.jdField_b_of_type_AndroidWidgetImageView.setContentDescription(ajya.a(2131703557));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(ajya.a(2131703558));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new bcmc(this));
    try
    {
      paramContext = this.jdField_a_of_type_Bcmd.getClass().getSuperclass().getDeclaredField("mPopup");
      paramContext.setAccessible(true);
      paramContext = paramContext.get(this.jdField_a_of_type_Bcmd);
  ...
  {
    return this.jdField_a_of_type_Bcmd;
  }
