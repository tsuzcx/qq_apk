  ...
  implements PopupWindow.OnDismissListener
{
  ...
  public DropdownView(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Bclo = new bclo(this, paramContext);
    a(paramContext);
  }
  ...
  public DropdownView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Bclo = new bclo(this, paramContext, paramAttributeSet);
    a(paramContext);
  }
  ...
  public DropdownView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Bclo = new bclo(this, paramContext, paramAttributeSet, paramInt);
    a(paramContext);
  }
  ...
  private void a(Context paramContext)
  {
    ...
    addView(this.jdField_a_of_type_Bclo, (ViewGroup.LayoutParams)localObject1);
    this.jdField_a_of_type_Bclo.setDropDownVerticalOffset(0);
    ...
    ((RelativeLayout.LayoutParams)localObject2).addRule(7, this.jdField_a_of_type_Bclo.getId());
    ...
    this.jdField_b_of_type_AndroidWidgetImageView.setContentDescription(ajyc.a(2131703546));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(ajyc.a(2131703547));
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130840297);
    this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130840298);
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new bcln(this));
    try
    {
      paramContext = this.jdField_a_of_type_Bclo.getClass().getSuperclass().getDeclaredField("mPopup");
      paramContext.setAccessible(true);
      paramContext = paramContext.get(this.jdField_a_of_type_Bclo);
  ...
  {
    return this.jdField_a_of_type_Bclo;
  }
