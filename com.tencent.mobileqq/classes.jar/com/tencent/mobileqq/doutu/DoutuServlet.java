  ...
  extends MSFServlet
{
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    {
      bool = false;
      paramIntent = (DoutuManager)getAppRuntime().getManager(QQManagerFactory.DOUTU_MAGAGER);
      if (!bool) {
        break label505;
      }
    }
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    for (;;)
    {
      ...
      while (!QLog.isColorLevel())
      {
        ...
        int j = paramIntent.getByteExtra("KEY_AGE", (byte)0);
        ...
        {
          if (QLog.isColorLevel()) {
            QLog.i("DoutuServlet", 2, "onSend, CMD_DOU_TU , src_uin = " + l1 + ", age = " + j + ", gender:" + k + ", chatType:" + i + ", toUin:" + l2);
          }
