  ...
  implements View.OnClickListener
{
  ...
  URLDrawableDownListener jdField_a_of_type_ComTencentImageURLDrawableDownListener = new acfz(this);
  private SessionInfo jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo;
  private BaseActivity jdField_a_of_type_ComTencentMobileqqAppBaseActivity;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private DoutuData jdField_a_of_type_ComTencentMobileqqDoutuDoutuData = new DoutuData("abababababababababababab", null);
  private DoutuItem jdField_a_of_type_ComTencentMobileqqDoutuDoutuItem;
  public List a;
  public MqqHandler a;
  ...
  public void a()
  {
    ...
    {
      this.f = i;
      this.jdField_b_of_type_JavaUtilList.add(this.f, this.jdField_a_of_type_ComTencentMobileqqDoutuDoutuData);
      this.jdField_a_of_type_JavaUtilList.add(this.f, this.jdField_a_of_type_ComTencentMobileqqDoutuDoutuData);
      return;
    }
  }
  ...
  public void a(long paramLong)
  {
    ...
    if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_b_of_type_JavaUtilList != null))
    {
      ...
      this.jdField_b_of_type_JavaUtilList.remove(this.jdField_a_of_type_ComTencentMobileqqDoutuDoutuData);
  ...
  public void a(List paramList, boolean paramBoolean, long paramLong)
  {
    if (QLog.isColorLevel()) {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      if (localObject1 == null)
      {
        ...
        return null;
        paramViewGroup = (acga)paramView.getTag();
        break;
      }
  ...
  public void onClick(View paramView)
  {
    ...
    if ((paramView != null) && ((paramView instanceof acga))) {}
    for (paramView = (acga)paramView;; paramView = null)
    {
      if (paramView == null) {}
      ...
      do
      {
        do
        {
          ...
          ReportController.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8007FAB", "0X8007FAB", 0, 0, "", "", "", "");
          if (this.jdField_a_of_type_MqqOsMqqHandler != null) {
            this.jdField_a_of_type_MqqOsMqqHandler.obtainMessage(80).sendToTarget();
          }
        } while (!this.jdField_a_of_type_Boolean);
        paramView = (DoutuManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(213);
      } while (paramView == null);
      paramView.a(localDoutuData, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqDoutuDoutuItem.b);
      return;
    }
  }
}
