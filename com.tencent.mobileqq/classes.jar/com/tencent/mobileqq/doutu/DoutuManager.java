  ...
  implements Manager
{
  ...
  public ConcurrentHashMap<Long, DoutuItem> a;
  public MqqHandler a;
  private WeakReference<DoutuItem> jdField_a_of_type_MqqUtilWeakReference;
  ...
  private ConcurrentHashMap<String, ConcurrentHashMap<String, DoutuManager.DoutuMsgStamp>> jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  public boolean b;
  ...
  private ConcurrentHashMap<String, ConcurrentHashMap<String, DoutuManager.ComboMsgStamp>> jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  public static void a(Context paramContext)
  {
    if (!jdField_a_of_type_Boolean) {
      SharedPreUtils.d(paramContext, true);
    }
  }
  
  public static void a(RelativeLayout paramRelativeLayout, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    if (QLog.isColorLevel()) {
    ...
    if (paramQQAppInterface != null)
    {
      ...
      paramQQAppInterface.b(paramSessionInfo);
  ...
  private void a(ChatMessage paramChatMessage)
  {
    ...
    if (paramChatMessage.isSend())
    {
      ...
      if (((MessageForMarketFace)localObject2).mMarkFaceMessage != null)
      {
        ...
        paramChatMessage = EmosmUtils.a(paramChatMessage.sbufID, paramChatMessage.mediaType);
      }
      i = 1;
    }
    for (;;)
    {
      ReportController.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800AF0B", "0X800AF0B", 0, 0, String.valueOf(i), "", paramChatMessage, "");
      return;
      label84:
  ...
  private void a(NewIntent paramNewIntent, SessionInfo paramSessionInfo, DoutuItem paramDoutuItem)
  {
    int i = 1;
    if (paramSessionInfo != null)
    {
      ...
      paramNewIntent.putExtra("KEY_SRC_UIN", Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).longValue());
      if (paramSessionInfo.jdField_a_of_type_Int != 0) {
        break label90;
      }
    }
    for (;;)
    {
      ...
      return;
      label72:
      paramNewIntent.putExtra("KEY_SRC_UIN", Long.valueOf(paramSessionInfo.jdField_a_of_type_JavaLangString));
      break;
      label90:
  ...
  private boolean a(String paramString)
  {
    ...
    if (SharedPreUtils.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()))
    {
      if (QLog.isColorLevel()) {
  ...
  private void b(DoutuItem paramDoutuItem, SessionInfo paramSessionInfo)
  {
    if (QLog.isColorLevel()) {
    ...
    if ((c()) && (this.jdField_b_of_type_JavaUtilList.size() == 0)) {
      a(paramDoutuItem, paramSessionInfo);
    }
  }
  ...
  private void d()
  {
    this.jdField_f_of_type_Boolean = SharedPreUtils.j(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    this.jdField_c_of_type_Boolean = SharedPreUtils.i(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    this.jdField_d_of_type_Boolean = SharedPreUtils.k(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    this.jdField_b_of_type_Boolean = SharedPreUtils.l(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    long l1 = SharedPreUtils.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    int i = SharedPreUtils.aq(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin());
    long l2 = SharedPreUtils.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    long l3 = SharedPreUtils.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    int j = SharedPreUtils.an(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    if (l1 > 0L) {
  ...
  public int a(SessionInfo paramSessionInfo)
  {
    ...
    if ((this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str) != null) && (((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo) != null)) {
      return ((DoutuManager.ComboMsgStamp)((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo)).jdField_a_of_type_Int;
    }
    return 0;
  }
  ...
  public long a(SessionInfo paramSessionInfo)
  {
    ...
    if ((this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(str) != null) && (((ConcurrentHashMap)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo) != null)) {
      return ((DoutuManager.DoutuMsgStamp)((ConcurrentHashMap)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo)).jdField_a_of_type_Long;
    }
    return 0L;
  }
  ...
  public void a(long paramLong)
  {
    ...
    label203:
    for (int i = ((DoutuItem)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramLong))).jdField_a_of_type_Int;; i = 0)
    {
      QLog.i("DoutuManager", 2, i);
      if ((this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramLong)) != null) && (((DoutuItem)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramLong))).jdField_a_of_type_Int >= 1))
      {
  ...
  public void a(Context paramContext, ViewGroup paramViewGroup, BaseActivity paramBaseActivity, SessionInfo paramSessionInfo, MqqHandler paramMqqHandler, DoutuItem paramDoutuItem)
  {
    ...
    if (paramDoutuItem != null) {
      this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(paramDoutuItem);
    }
    Object localObject = (LinearLayout)paramViewGroup.findViewById(2131365983);
    if (localObject != null)
    {
      if (QLog.isColorLevel()) {
      ...
      paramViewGroup = (DoutuEmotionHorizonListView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131365986);
      this.jdField_a_of_type_ComTencentMobileqqDoutuDoutuEmotionAdapter = ((DoutuEmotionAdapter)paramViewGroup.getAdapter());
          ...
          if (paramContext.hasNext())
          {
            ...
            if (this.jdField_c_of_type_JavaUtilList.size() < 20)
            {
              ...
              if (!TextUtils.isEmpty(paramBaseActivity.pic_md5))
              {
                ...
                this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)View.inflate(paramContext, 2131558634, null));
                localObject = (DoutuEmotionHorizonListView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131365986);
                this.jdField_a_of_type_ComTencentMobileqqDoutuDoutuEmotionAdapter = new DoutuEmotionAdapter(paramContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramBaseActivity, paramSessionInfo, paramMqqHandler, this.jdField_b_of_type_Boolean, paramDoutuItem, this.jdField_a_of_type_Int);
                ((DoutuEmotionHorizonListView)localObject).setAdapter(this.jdField_a_of_type_ComTencentMobileqqDoutuDoutuEmotionAdapter);
                ((DoutuEmotionHorizonListView)localObject).setOnScrollStateChangedListener(new DoutuManager.1(this));
                ((DoutuEmotionHorizonListView)localObject).setTouchListener(new DoutuManager.2(this, paramMqqHandler));
  ...
  public void a(SessionInfo paramSessionInfo, ChatMessage paramChatMessage)
  {
    ...
    {
      ((ConcurrentHashMap)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramChatMessage)).put(paramSessionInfo, new DoutuManager.DoutuMsgStamp(this, l1, l2));
      return;
    }
    ConcurrentHashMap localConcurrentHashMap = new ConcurrentHashMap();
    localConcurrentHashMap.put(paramSessionInfo, new DoutuManager.DoutuMsgStamp(this, l1, l2));
  ...
  public void a(SessionInfo paramSessionInfo, ChatMessage paramChatMessage, int paramInt1, int paramInt2)
  {
    ...
    {
      ((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).put(paramSessionInfo, new DoutuManager.ComboMsgStamp(this, l1, l2, paramChatMessage.senderuin, paramInt1, paramInt2));
      return;
    }
    ConcurrentHashMap localConcurrentHashMap = new ConcurrentHashMap();
    localConcurrentHashMap.put(paramSessionInfo, new DoutuManager.ComboMsgStamp(this, l1, l2, paramChatMessage.senderuin, paramInt1, paramInt2));
    this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put(str, localConcurrentHashMap);
  }
  
  public void a(DoutuItem paramDoutuItem, SessionInfo paramSessionInfo)
  {
    ThreadManager.post(new DoutuManager.3(this, paramSessionInfo, paramDoutuItem), 5, null, true);
  }
  
  public void a(DoutuItem paramDoutuItem, SessionInfo paramSessionInfo, long paramLong)
  {
    ThreadManager.post(new DoutuManager.4(this, paramDoutuItem, paramLong, paramSessionInfo), 5, null, true);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    SharedPreUtils.h(BaseApplication.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin(), paramBoolean);
    if (paramBoolean) {
  ...
  public void a(boolean paramBoolean, List<DoutuData> paramList, long paramLong)
  {
    ...
    if (QLog.isColorLevel())
    {
      ...
      i = ((DoutuItem)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramLong))).jdField_a_of_type_Int;
  ...
  public long b(SessionInfo paramSessionInfo)
  {
    ...
    if ((this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str) != null) && (((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo) != null)) {
      return ((DoutuManager.ComboMsgStamp)((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo)).jdField_a_of_type_Long;
    }
    return 0L;
  }
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqDoutuDoutuEmotionAdapter == null) {}
    while ((this.jdField_a_of_type_ComTencentMobileqqDoutuDoutuEmotionAdapter.jdField_a_of_type_JavaUtilHashMap == null) && (this.jdField_a_of_type_ComTencentMobileqqDoutuDoutuEmotionAdapter.jdField_a_of_type_ComTencentMobileqqDoutuDoutuData == null)) {
      return;
    }
    Object localObject1 = new DoutuReportData();
    ...
    ((DoutuReportData.Data)localObject2).jdField_a_of_type_JavaLangString = String.valueOf(Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).longValue());
    if (this.jdField_a_of_type_ComTencentMobileqqDoutuDoutuEmotionAdapter.jdField_a_of_type_ComTencentMobileqqDoutuDoutuData != null)
    {
      ((DoutuReportData.Data)localObject2).d = this.jdField_a_of_type_ComTencentMobileqqDoutuDoutuEmotionAdapter.jdField_a_of_type_ComTencentMobileqqDoutuDoutuData.pic_md5;
      ((DoutuReportData.Data)localObject2).e = this.jdField_a_of_type_ComTencentMobileqqDoutuDoutuEmotionAdapter.jdField_a_of_type_ComTencentMobileqqDoutuDoutuData.pic_down_url;
    }
    if (this.jdField_a_of_type_ComTencentMobileqqDoutuDoutuEmotionAdapter.jdField_a_of_type_ComTencentMobileqqDoutuDoutuItem != null)
    {
      ((DoutuReportData.Data)localObject2).c = this.jdField_a_of_type_ComTencentMobileqqDoutuDoutuEmotionAdapter.jdField_a_of_type_ComTencentMobileqqDoutuDoutuItem.c;
      ((DoutuReportData.Data)localObject2).jdField_b_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqDoutuDoutuEmotionAdapter.jdField_a_of_type_ComTencentMobileqqDoutuDoutuItem.jdField_b_of_type_JavaLangString;
    }
    if ((this.jdField_a_of_type_ComTencentMobileqqDoutuDoutuEmotionAdapter.jdField_a_of_type_JavaUtilHashMap != null) && (this.jdField_a_of_type_ComTencentMobileqqDoutuDoutuEmotionAdapter.jdField_a_of_type_JavaUtilHashMap.size() > 0))
    {
      ArrayList localArrayList1 = new ArrayList();
      ArrayList localArrayList2 = new ArrayList();
      Iterator localIterator = this.jdField_a_of_type_ComTencentMobileqqDoutuDoutuEmotionAdapter.jdField_a_of_type_JavaUtilHashMap.keySet().iterator();
      while (localIterator.hasNext())
      {
        String str = (String)localIterator.next();
        localArrayList1.add(str);
        localArrayList2.add(this.jdField_a_of_type_ComTencentMobileqqDoutuDoutuEmotionAdapter.jdField_a_of_type_JavaUtilHashMap.get(str));
      }
    ...
    int i;
    if (this.jdField_a_of_type_ComTencentMobileqqDoutuDoutuEmotionAdapter.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo != null)
    {
      i = this.jdField_a_of_type_ComTencentMobileqqDoutuDoutuEmotionAdapter.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int;
      if (i != 0) {
        break label401;
      }
    ...
    for (;;)
    {
      ((DoutuReportData.Data)localObject2).h = this.jdField_a_of_type_ComTencentMobileqqDoutuDoutuEmotionAdapter.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString;
      ...
      localObject1 = ((DoutuReportData)localObject1).a();
      localObject2 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), DoutuServlet.class);
      ...
      this.jdField_a_of_type_ComTencentMobileqqDoutuDoutuEmotionAdapter.jdField_a_of_type_ComTencentMobileqqDoutuDoutuData = null;
      this.jdField_a_of_type_ComTencentMobileqqDoutuDoutuEmotionAdapter.jdField_a_of_type_JavaUtilHashMap = null;
  ...
  public void b(SessionInfo paramSessionInfo)
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetLinearLayout != null)
    {
      ...
      localDoutuItem = (DoutuItem)this.jdField_a_of_type_MqqUtilWeakReference.get();
      this.jdField_a_of_type_MqqUtilWeakReference = null;
    }
    for (;;)
    {
      b(localDoutuItem, paramSessionInfo);
      return;
      label103:
      localDoutuItem = null;
    }
  ...
  public long c(SessionInfo paramSessionInfo)
  {
    ...
    if ((this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str) != null) && (((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo) != null)) {
      return ((DoutuManager.ComboMsgStamp)((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo)).jdField_b_of_type_Long;
    }
    return 0L;
  }
  ...
  public void c()
  {
    ...
    String str1 = SharedPreUtils.m(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    String str2 = SharedPreUtils.l(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    ...
    if (!a(str1))
    {
      ...
      localDownloaderInterface.a(localDownloadTask, new DoutuManager.11(this, str2, str3, str1), null);
      return;
    }
    DuiButtonImageView.a();
    jdField_a_of_type_Boolean = false;
  ...
  public boolean d()
  {
    return a(SharedPreUtils.m(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()));
  }
