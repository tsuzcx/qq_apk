  ...
  implements Handler.Callback, View.OnTouchListener, Observer
{
  ...
  {
    e();
    ComboEggView localComboEggView = (ComboEggView)LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558628, null);
    ...
    if (localComboEggView.a(paramComboObject))
    {
      ...
      this.jdField_b_of_type_AndroidWidgetRelativeLayout.addView(localComboEggView, paramComboObject);
      localComboEggView.b();
  ...
  {
    e();
    ComboMasterView localComboMasterView = (ComboMasterView)LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558629, null);
    localComboMasterView.a(this);
    if (localComboMasterView.a(paramComboObject))
    {
      paramComboObject = new RelativeLayout.LayoutParams(-1, -1);
      paramComboObject.addRule(13);
      this.jdField_b_of_type_AndroidWidgetRelativeLayout.addView(localComboMasterView, paramComboObject);
  ...
  private void b(ComboObject paramComboObject)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqDoutuComboComboNavigateBar = ((ComboNavigateBar)LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558630, null));
    ...
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout.indexOfChild(this.jdField_a_of_type_ComTencentMobileqqDoutuComboComboNavigateBar) == -1)
    {
      ...
      localLayoutParams.topMargin = ((int)this.jdField_a_of_type_AndroidContentContext.getResources().getDimension(2131299166) + AIOUtils.a(22.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
  ...
  private void e()
  {
    if (this.jdField_b_of_type_AndroidWidgetRelativeLayout == null)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetRelativeLayout.setOnTouchListener(this);
    }
    FrameLayout localFrameLayout = (FrameLayout)this.jdField_a_of_type_AndroidAppActivity.getWindow().getDecorView();
    if (localFrameLayout.indexOfChild(this.jdField_b_of_type_AndroidWidgetRelativeLayout) == -1)
    {
      FrameLayout.LayoutParams localLayoutParams = new FrameLayout.LayoutParams(-1, -1);
      localFrameLayout.addView(this.jdField_b_of_type_AndroidWidgetRelativeLayout, localLayoutParams);
    }
  }
  ...
  private void f()
  {
    ...
    while (this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.a == null) {
      return;
    }
  ...
  public ComboObject a()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqDoutuComboComboMasterView.a(this.jdField_b_of_type_AndroidWidgetRelativeLayout);
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqDoutuComboComboEggView.a(this.jdField_b_of_type_AndroidWidgetRelativeLayout);
  ...
  public void a(Animator paramAnimator, ComboMasterView paramComboMasterView)
  {
    if (this.jdField_b_of_type_AndroidWidgetRelativeLayout != null)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetRelativeLayout.removeView(paramComboMasterView);
    }
    f();
    this.jdField_a_of_type_ComTencentMobileqqDoutuComboComboMasterView = null;
  }
  ...
  public void a(ComboEggView paramComboEggView)
  {
    if (this.jdField_b_of_type_AndroidWidgetRelativeLayout != null)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetRelativeLayout.removeView(paramComboEggView);
    }
    f();
    this.jdField_a_of_type_ComTencentMobileqqDoutuComboComboEggView = null;
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (!paramComboObject.jdField_a_of_type_Boolean)
        {
          ...
          if (!this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.u()) {
            break label204;
          }
          if (!QLog.isColorLevel()) {
            continue;
      ...
      continue;
      label169:
      if (paramComboObject.jdField_a_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin()))
      {
        localMessage.what = 2;
      }
      else
      {
        ...
        continue;
        label204:
        paramComboObject = this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.a();
  ...
  public void c()
  {
    if (this.jdField_b_of_type_AndroidWidgetRelativeLayout != null)
    {
      FrameLayout localFrameLayout = (FrameLayout)this.jdField_a_of_type_AndroidAppActivity.getWindow().getDecorView();
      a();
      localFrameLayout.removeView(this.jdField_b_of_type_AndroidWidgetRelativeLayout);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      else if (((ISpriteCommFunc)QRoute.api(ISpriteCommFunc.class)).isSpriteActive(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "combo"))
      {
        b(localComboObject1);
      }
      else
