  ...
  extends View
{
  ...
  private axpb a()
  {
    ...
    axpb localaxpb = new axpb();
    localaxpb.jdField_b_of_type_AndroidGraphicsRect = localRect;
    localaxpb.jdField_a_of_type_Int = i1;
    localaxpb.jdField_b_of_type_Int = i2;
    localaxpb.jdField_c_of_type_AndroidGraphicsRect = new Rect(localRect);
    localaxpb.e = 0;
  ...
  private axpb a(int paramInt, axpb paramaxpb)
  {
    int i1 = a(200.0F, getResources());
    ...
    for (;;)
    {
      ...
      for (i1 = ((Integer)((List)localObject2).get(i1)).intValue();; i1 = 0)
      {
        ...
        i1 = i8 + i9 * i2;
        i8 = i9 + i1;
        paramaxpb = new Rect(i6, i1, i7, i8);
        ...
        localObject2 = new axpb();
        ((axpb)localObject2).jdField_c_of_type_Int = 500;
        ((axpb)localObject2).d = 700;
        if (((axpb)localObject2).d < 0) {
          ((axpb)localObject2).d = 0;
        }
        ((axpb)localObject2).jdField_a_of_type_Int = i3;
        ((axpb)localObject2).jdField_b_of_type_Int = i3;
        ((axpb)localObject2).jdField_b_of_type_AndroidGraphicsRect = ((Rect)localObject1);
        ((axpb)localObject2).jdField_c_of_type_AndroidGraphicsRect = new Rect((Rect)localObject1);
        ((axpb)localObject2).e = 0;
        ((axpb)localObject2).jdField_a_of_type_AndroidGraphicsRect = paramaxpb;
        ((axpb)localObject2).f = i2;
        if (QLog.isColorLevel()) {
          QLog.i("ScanOcrView", 2, "generateScanRectAniParam, hasDoneCnt=" + paramInt + "," + i4 + "*" + i5 + "\n" + localObject2);
        }
        return localObject2;
        ((List)localObject2).remove(Integer.valueOf(paramaxpb.f));
  ...
  private void b(int paramInt)
  {
    ...
    this.jdField_c_of_type_Axpb = this.jdField_a_of_type_Axpb;
    this.jdField_a_of_type_Axpb = a(paramInt, this.jdField_c_of_type_Axpb);
    ValueAnimator localValueAnimator1 = ValueAnimator.ofFloat(new float[] { 1.1F, 1.0F });
    localValueAnimator1.addUpdateListener(new axow(this));
    localValueAnimator1.setDuration(200L);
    ValueAnimator localValueAnimator2 = ValueAnimator.ofInt(new int[] { 255, 0 });
    localValueAnimator2.addUpdateListener(new axox(this));
    localValueAnimator2.setDuration(200L);
    localValueAnimator2.addListener(new axoy(this, paramInt));
    int i1 = this.jdField_a_of_type_Axpb.d;
    if (paramInt == 0) {
      i1 = this.jdField_a_of_type_Axpb.jdField_c_of_type_Int;
    }
  ...
  private void f()
  {
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130845510);
    this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130845509);
    this.jdField_c_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130845511);
  ...
  private void h()
  {
    ...
    this.jdField_b_of_type_Axpb = a();
    ValueAnimator localValueAnimator1 = ValueAnimator.ofFloat(new float[] { 1.1F, 1.0F });
    Object localObject = this.jdField_b_of_type_Axpb;
    localValueAnimator1.addUpdateListener(new axoz(this, (axpb)localObject));
    localValueAnimator1.setDuration(200L);
    ValueAnimator localValueAnimator2 = ValueAnimator.ofInt(new int[] { 255, 0 });
    localValueAnimator2.addUpdateListener(new axpa(this, (axpb)localObject));
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Long = System.currentTimeMillis();
      invalidate();
      if ((this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Axpb != null))
      {
        this.jdField_c_of_type_AndroidGraphicsDrawableDrawable.setAlpha(this.jdField_a_of_type_Axpb.e);
        this.jdField_c_of_type_AndroidGraphicsDrawableDrawable.setBounds(this.jdField_a_of_type_Axpb.jdField_c_of_type_AndroidGraphicsRect.left, this.jdField_a_of_type_Axpb.jdField_c_of_type_AndroidGraphicsRect.top, this.jdField_a_of_type_Axpb.jdField_c_of_type_AndroidGraphicsRect.right, this.jdField_a_of_type_Axpb.jdField_c_of_type_AndroidGraphicsRect.bottom);
        this.jdField_c_of_type_AndroidGraphicsDrawableDrawable.draw(paramCanvas);
      }
      if ((!this.jdField_c_of_type_Boolean) || (this.jdField_b_of_type_Axpb == null)) {
        break;
      }
      this.jdField_c_of_type_AndroidGraphicsDrawableDrawable.setAlpha(this.jdField_b_of_type_Axpb.e);
      this.jdField_c_of_type_AndroidGraphicsDrawableDrawable.setBounds(this.jdField_b_of_type_Axpb.jdField_c_of_type_AndroidGraphicsRect.left, this.jdField_b_of_type_Axpb.jdField_c_of_type_AndroidGraphicsRect.top, this.jdField_b_of_type_Axpb.jdField_c_of_type_AndroidGraphicsRect.right, this.jdField_b_of_type_Axpb.jdField_c_of_type_AndroidGraphicsRect.bottom);
      this.jdField_c_of_type_AndroidGraphicsDrawableDrawable.draw(paramCanvas);
      return;
      label403:
      this.d = (i2 + this.d);
