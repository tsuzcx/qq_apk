  ...
  extends BusinessHandler
{
  ...
  private void a(int paramInt, Intent paramIntent, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      for (paramIntent = Integer.toString(j);; paramIntent = i + "_" + j)
      {
        ...
        StatisticCollector.getInstance(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication()).collectPerformance(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "ocrTextSearch", bool, l, 0L, paramArrayOfByte, "");
        if (QLog.isColorLevel()) {
  ...
  private void a(Intent paramIntent)
  {
    ...
    for (;;)
    {
      return;
      Object localObject2 = "";
      Object localObject3 = ConfigManager.getInstance(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getBaseContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getHwEngine());
      Object localObject1 = localObject2;
      if (localObject3 != null)
      {
        localObject3 = ((ConfigManager)localObject3).getOtherTypeIp(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getBaseContext(), 21, false);
        localObject1 = localObject2;
        if (localObject3 != null)
        {
          localObject1 = localObject2;
      ...
      for (;;)
      {
        try
        {
          ...
          if (SessionInfo.getInstance(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin()).getHttpconn_sig_session() != null)
          {
            ...
            localObject1 = new byte[i];
            System.arraycopy(SessionInfo.getInstance(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin()).getHttpconn_sig_session(), 0, localObject1, 0, i);
          }
          localObject2 = localObject4;
          if (SessionInfo.getInstance(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin()).getSessionKey() != null)
          {
            i = SessionInfo.getInstance(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin()).getSessionKey().length;
            localObject2 = new byte[i];
            System.arraycopy(SessionInfo.getInstance(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin()).getSessionKey(), 0, localObject2, 0, i);
          }
  ...
  public void a(String paramString1, String paramString2, long paramLong)
  {
    ...
    paramString2.putExtra("param_uin", Long.parseLong(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()));
