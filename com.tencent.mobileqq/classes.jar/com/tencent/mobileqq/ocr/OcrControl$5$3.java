...
public class OcrControl$5$3
  implements Runnable
{
  public OcrControl$5$3(avxc paramavxc, int paramInt1, int paramInt2, int paramInt3) {}
  ...
  public void run()
  {
    ...
    try
    {
      azri.a(BaseApplicationImpl.getContext()).a("", "ocr_server_fail", true, 0L, 0L, localHashMap, "", false);
      return;
    }
