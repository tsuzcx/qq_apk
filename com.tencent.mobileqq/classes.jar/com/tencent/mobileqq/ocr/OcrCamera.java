  ...
  implements Handler.Callback
{
  ...
  public RectF a;
  Camera.PreviewCallback jdField_a_of_type_AndroidHardwareCamera$PreviewCallback = new agfw(this);
  ...
  public OcrCamera(Context paramContext, OcrCamera.CameraCallback paramCameraCallback, SurfaceHolder paramSurfaceHolder)
  {
    ...
    this.jdField_a_of_type_AndroidViewOrientationEventListener = new agfs(this, paramContext);
  ...
  private int a()
  {
    ...
    for (;;)
    {
      ...
      Object localObject3 = a(this.jdField_a_of_type_AndroidHardwareCamera, ScreenUtil.jdField_a_of_type_Int, ScreenUtil.jdField_b_of_type_Int, false);
      if (QLog.isColorLevel()) {
      ...
      catch (Exception localException3)
      {
        try
        {
          ...
          Point localPoint = a(this.jdField_a_of_type_AndroidHardwareCamera, ScreenUtil.jdField_a_of_type_Int, ScreenUtil.jdField_b_of_type_Int, true);
  ...
  private Point a(Camera paramCamera, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    Collections.sort((List)localObject, new agft(this));
    paramCamera = null;
  ...
  private void a(byte[] paramArrayOfByte)
  {
    for (;;)
    {
      try
      {
        if (this.jdField_b_of_type_Boolean)
        {
          ...
          if (QLog.isDebugVersion()) {
            ThreadManager.getUIHandler().post(new agfu(this));
          }
      ...
      finally
      {
        try
        {
          bool = this.jdField_a_of_type_ComTencentMobileqqArArengineARCloudImageSelect.a(paramArrayOfByte, this.g, this.h);
        }
        ...
        try
        {
          ...
          ThreadManager.post(new agfv(this, l1), 5, null, false);
      ...
      else
      {
        ...
        paramArrayOfByte = OcrImageUtil.a(paramArrayOfByte, this.g, this.h, this.k, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
        if (this.jdField_a_of_type_ComTencentMobileqqOcrOcrCamera$CameraCallback != null) {
  ...
  private boolean b()
  {
    ...
    //   31: ifnull +52 -> 83
    //   34: aload_0
    //   35: getfield 255	com/tencent/mobileqq/ocr/OcrCamera:g	I
    //   38: aload_0
    //   39: getfield 257	com/tencent/mobileqq/ocr/OcrCamera:h	I
    //   42: imul
    //   43: aload_0
    //   44: getfield 264	com/tencent/mobileqq/ocr/OcrCamera:l	I
    //   47: imul
    //   48: bipush 8
    //   50: idiv
    //   51: istore_1
    ...
    //   57: iload_1
    //   58: invokespecial 503	com/tencent/mobileqq/ocr/OcrCamera:a	(Landroid/hardware/Camera;I)Z
    //   61: istore 4
    //   63: iload 4
    //   65: ifne +7 -> 72
    //   68: aload_0
    ...
    //   101: aload_0
    //   102: invokevirtual 516	com/tencent/mobileqq/ocr/OcrCamera:f	()V
    //   105: iconst_1
    //   106: istore_2
    //   107: iload_2
    //   108: ifeq +8 -> 116
    //   111: aload_0
    //   112: iconst_0
    //   113: putfield 518	com/tencent/mobileqq/ocr/OcrCamera:jdField_d_of_type_Boolean	Z
    //   116: iload_2
    //   117: istore_3
  ...
  private boolean d()
  {
    ...
    //   20: aload_0
    //   21: aconst_null
    //   22: putfield 541	com/tencent/mobileqq/ocr/OcrCamera:jdField_b_of_type_ArrayOfByte	[B
    //   25: aload_0
    //   26: monitorexit
    //   27: iload_1
    //   28: ireturn
  ...
  public void a(int paramInt)
  {
    ...
    if (this.jdField_e_of_type_Int == 1)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.i("Q.ocr.camera", 1, "setOcrMode device model: " + DeviceInfoUtil.j());
      }
    }
  }
  ...
  public boolean a()
  {
    ...
    if ((this.jdField_e_of_type_Int == 1) && (this.jdField_f_of_type_Boolean) && (this.i * this.j >= this.g * this.h)) {
      this.jdField_a_of_type_AndroidHardwareCamera.takePicture(null, null, null, new agfx(this));
    }
    for (;;)
    {
      return true;
  ...
  public boolean a(byte[] paramArrayOfByte, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_ComTencentUtilWeakReferenceHandler.post(new agfy(this, paramBoolean, paramArrayOfByte));
    return true;
  }
            ...
            for (;;)
            {
              ...
              if (!this.jdField_c_of_type_Boolean) {
                try
                {
                  ...
                  if (this.jdField_a_of_type_ComTencentMobileqqOcrOcrCamera$CameraCallback != null)
                  {
                    this.jdField_a_of_type_ComTencentMobileqqOcrOcrCamera$CameraCallback.a(m, this.g, this.h, this.k);
                    return false;
                  }
                }
