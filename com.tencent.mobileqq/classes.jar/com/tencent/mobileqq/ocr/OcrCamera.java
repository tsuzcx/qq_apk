  ...
  implements Handler.Callback
{
  ...
  public OcrCamera(Context paramContext, OcrCamera.CameraCallback paramCameraCallback, SurfaceHolder paramSurfaceHolder)
  {
    ...
    for (this.jdField_d_of_type_Int = 921600;; this.jdField_d_of_type_Int = 921600)
    {
      if (QLog.isColorLevel()) {
        QLog.d("Q.ocr.camera", 2, "OcrCamera mFrameGap:" + this.c + ",mMaxPreviewPixels:" + this.jdField_d_of_type_Int);
      }
      return;
      this.c = 100;
    }
  ...
  private int a()
  {
    ...
    for (;;)
    {
      ...
      Object localObject3 = a(this.jdField_a_of_type_AndroidHardwareCamera, ScreenUtil.SCREEN_WIDTH, ScreenUtil.SCREEN_HIGHT, false);
      if (QLog.isColorLevel()) {
      ...
      catch (Exception localException3)
      {
        try
        {
          ...
          Point localPoint = a(this.jdField_a_of_type_AndroidHardwareCamera, ScreenUtil.SCREEN_WIDTH, ScreenUtil.SCREEN_HIGHT, true);
          ...
          this.jdField_g_of_type_Int = ((Camera.Size)localObject2).width;
          this.h = ((Camera.Size)localObject2).height;
          this.k = m;
          this.l = localPixelFormat.bitsPerPixel;
          if (QLog.isColorLevel()) {
            QLog.d("Q.ocr.camera", 2, "openCamera picWidth:" + this.jdField_g_of_type_Int + ",picHeight:" + this.h + ",picFormat:" + this.k + "  mTakePicWidth:" + this.i + "   mTakePicHeight:" + this.j);
          }
          if (!b())
          {
            m = -1003;
    ...
    for (;;)
    {
      ...
      finally
      {
        ...
        try
        {
          ...
          QQToast.a(BaseApplicationImpl.getContext(), 1, 2131699001, 0).a();
        }
        catch (Throwable paramArrayOfByte)
        {
          break label310;
      ...
      else
      {
        ...
        paramArrayOfByte = OcrImageUtil.a(paramArrayOfByte, this.jdField_g_of_type_Int, this.h, this.k, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
        if (this.jdField_a_of_type_ComTencentMobileqqOcrOcrCamera$CameraCallback != null) {
  ...
  private boolean b()
  {
    ...
    //   8: monitorenter
    //   9: aload_0
    //   10: getfield 152	com/tencent/mobileqq/ocr/OcrCamera:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   13: ifnull +191 -> 204
    //   16: aload_0
    //   17: getfield 57	com/tencent/mobileqq/ocr/OcrCamera:jdField_a_of_type_AndroidViewSurfaceHolder	Landroid/view/SurfaceHolder;
    //   20: astore 5
    //   22: aload 5
    //   24: ifnull +180 -> 204
    //   27: aload_0
    //   28: getfield 53	com/tencent/mobileqq/ocr/OcrCamera:jdField_a_of_type_AndroidHardwareCamera$PreviewCallback	Landroid/hardware/Camera$PreviewCallback;
    //   31: ifnull +52 -> 83
    //   34: aload_0
    //   35: getfield 258	com/tencent/mobileqq/ocr/OcrCamera:jdField_g_of_type_Int	I
    //   38: aload_0
    //   39: getfield 260	com/tencent/mobileqq/ocr/OcrCamera:h	I
    //   42: imul
    //   43: aload_0
    //   44: getfield 267	com/tencent/mobileqq/ocr/OcrCamera:l	I
    //   47: imul
    //   48: bipush 8
    //   50: idiv
    //   51: istore_1
    //   52: aload_0
    //   53: aload_0
    //   54: getfield 152	com/tencent/mobileqq/ocr/OcrCamera:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   57: iload_1
    //   58: invokespecial 507	com/tencent/mobileqq/ocr/OcrCamera:a	(Landroid/hardware/Camera;I)Z
    //   61: istore 4
    //   63: iload 4
    //   65: ifne +7 -> 72
    //   68: aload_0
    ...
    //   71: ireturn
    //   72: aload_0
    //   73: getfield 152	com/tencent/mobileqq/ocr/OcrCamera:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   76: aload_0
    //   77: getfield 53	com/tencent/mobileqq/ocr/OcrCamera:jdField_a_of_type_AndroidHardwareCamera$PreviewCallback	Landroid/hardware/Camera$PreviewCallback;
    //   80: invokevirtual 511	android/hardware/Camera:setPreviewCallbackWithBuffer	(Landroid/hardware/Camera$PreviewCallback;)V
    //   83: aload_0
    //   84: getfield 152	com/tencent/mobileqq/ocr/OcrCamera:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   87: aload_0
    //   88: getfield 57	com/tencent/mobileqq/ocr/OcrCamera:jdField_a_of_type_AndroidViewSurfaceHolder	Landroid/view/SurfaceHolder;
    //   91: invokevirtual 515	android/hardware/Camera:setPreviewDisplay	(Landroid/view/SurfaceHolder;)V
    //   94: aload_0
    //   95: getfield 152	com/tencent/mobileqq/ocr/OcrCamera:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   98: invokevirtual 518	android/hardware/Camera:startPreview	()V
    //   101: aload_0
    //   102: invokevirtual 520	com/tencent/mobileqq/ocr/OcrCamera:f	()V
    //   105: iconst_1
    //   106: istore_2
    //   107: iload_2
    //   108: ifeq +8 -> 116
    //   111: aload_0
    //   112: iconst_0
    //   113: putfield 522	com/tencent/mobileqq/ocr/OcrCamera:jdField_e_of_type_Boolean	Z
    //   116: iload_2
    //   117: istore_3
    ...
    //   140: iload_2
    //   141: invokevirtual 422	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    ...
    //   187: aload 5
    //   189: invokevirtual 284	java/lang/Exception:getMessage	()Ljava/lang/String;
  ...
  private boolean d()
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 152	com/tencent/mobileqq/ocr/OcrCamera:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   8: astore_2
    //   9: aload_2
    //   10: ifnull +59 -> 69
    //   13: aload_0
    //   14: getfield 152	com/tencent/mobileqq/ocr/OcrCamera:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   17: invokevirtual 543	android/hardware/Camera:release	()V
    //   20: aload_0
    //   21: aconst_null
    //   22: putfield 545	com/tencent/mobileqq/ocr/OcrCamera:jdField_b_of_type_ArrayOfByte	[B
    //   25: aload_0
    //   26: monitorexit
    //   27: iload_1
    //   28: ireturn
    ...
    //   30: aload_0
    //   31: aconst_null
    //   32: putfield 152	com/tencent/mobileqq/ocr/OcrCamera:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   35: aload_0
    //   36: aconst_null
    //   37: putfield 57	com/tencent/mobileqq/ocr/OcrCamera:jdField_a_of_type_AndroidViewSurfaceHolder	Landroid/view/SurfaceHolder;
    //   40: ldc 107
    //   42: iconst_1
    ...
    //   56: aload_2
    //   57: invokevirtual 284	java/lang/Exception:getMessage	()Ljava/lang/String;
  ...
  public void a()
  {
    ...
    do
    {
      ...
      Message localMessage = this.jdField_a_of_type_ComTencentUtilWeakReferenceHandler.obtainMessage(0);
      this.jdField_a_of_type_ComTencentUtilWeakReferenceHandler.sendMessage(localMessage);
    } while (!QLog.isColorLevel());
    QLog.d("Q.ocr.camera", 2, "open isStop:" + this.jdField_e_of_type_Boolean + ",isOpen:" + this.jdField_d_of_type_Boolean);
  }
  ...
  public void a(int paramInt)
  {
    ...
    if (this.jdField_e_of_type_Int == 1)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.i("Q.ocr.camera", 1, "setOcrMode device model: " + DeviceInfoUtil.i());
      }
    }
  }
  ...
  public boolean a()
  {
    ...
    if (QLog.isColorLevel())
    {
      localObject = new StringBuilder().append("takePicture, isOpen:").append(this.jdField_d_of_type_Boolean).append(",mNeedSelectImage:").append(this.jdField_a_of_type_Boolean).append(",isStop:").append(this.jdField_e_of_type_Boolean).append(",picData:");
    ...
    label122:
    while ((!this.jdField_d_of_type_Boolean) || (this.jdField_e_of_type_Boolean) || ((!this.jdField_a_of_type_Boolean) && (this.jdField_e_of_type_Int != 1)) || (this.jdField_a_of_type_ArrayOfByte == null) || (this.jdField_f_of_type_Boolean) || (this.jdField_a_of_type_AndroidHardwareCamera == null))
    {
      return false;
      bool = false;
      break;
    ...
    if ((this.jdField_e_of_type_Int == 1) && (this.jdField_g_of_type_Boolean) && (this.i * this.j >= this.jdField_g_of_type_Int * this.h)) {
      this.jdField_a_of_type_AndroidHardwareCamera.takePicture(null, null, null, new OcrCamera.7(this));
    }
    for (;;)
    {
      return true;
  ...
  public boolean a(byte[] paramArrayOfByte, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_ComTencentUtilWeakReferenceHandler.post(new OcrCamera.8(this, paramBoolean, paramArrayOfByte));
    return true;
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
      ...
      do
      {
        do
        {
          do
          {
            for (;;)
            {
              ...
              if (!this.jdField_d_of_type_Boolean) {
                try
                {
                  ...
                  if (this.jdField_a_of_type_ComTencentMobileqqOcrOcrCamera$CameraCallback != null)
                  {
                    this.jdField_a_of_type_ComTencentMobileqqOcrOcrCamera$CameraCallback.a(m, this.jdField_g_of_type_Int, this.h, this.k);
                    return false;
                  }
                }
            ...
            bool = b();
          } while (this.jdField_a_of_type_ComTencentMobileqqOcrOcrCamera$CameraCallback == null);
          this.jdField_a_of_type_ComTencentMobileqqOcrOcrCamera$CameraCallback.a(bool);
          return false;
          bool = c();
        } while (this.jdField_a_of_type_ComTencentMobileqqOcrOcrCamera$CameraCallback == null);
        this.jdField_a_of_type_ComTencentMobileqqOcrOcrCamera$CameraCallback.b(bool);
        return false;
    ...
    this.jdField_a_of_type_ComTencentMobileqqOcrOcrCamera$CameraCallback.c(bool);
    return false;
  }
}
