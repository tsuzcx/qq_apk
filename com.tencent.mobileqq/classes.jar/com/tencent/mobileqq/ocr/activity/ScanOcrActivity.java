  ...
  implements View.OnClickListener
{
  ...
  SurfaceHolder.Callback jdField_a_of_type_AndroidViewSurfaceHolder$Callback = new avtg(this);
  private SurfaceHolder jdField_a_of_type_AndroidViewSurfaceHolder;
  private SurfaceView jdField_a_of_type_AndroidViewSurfaceView;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new avte(this);
  private View.OnTouchListener jdField_a_of_type_AndroidViewView$OnTouchListener = new avtd(this);
  ...
  avsu jdField_a_of_type_Avsu = new avth(this);
  ...
  private void a(int paramInt, OcrRecogResult paramOcrRecogResult, String paramString, long paramLong)
  {
    ...
    if ((paramInt == 0) && (paramOcrRecogResult != null) && (!paramOcrRecogResult.isEmpty()) && ((this.jdField_a_of_type_Int != 1) || ((!TextUtils.isEmpty(paramOcrRecogResult.ocrContent)) && (!TextUtils.isEmpty(paramOcrRecogResult.ocrContent.trim())))))
    {
      ...
      azmj.b(null, "dc00898", "", "", "0X80082CC", "0X80082CC", 0, 0, "", "", "", "");
      if (this.jdField_a_of_type_Int == 1) {
        azmj.b(null, "dc00898", "", "", "0X8008A1F", "0X8008A1F", 0, 0, "", "", "", "");
      }
      f();
      ...
      if (paramLong > 0L)
      {
        ...
        azmj.b(null, "dc00898", "", "", "0X80082E5", "0X80082E5", 0, 0, String.valueOf(paramLong), "", "", "");
      }
    }
    label238:
    label377:
    while (this.jdField_b_of_type_Int != 0)
    {
      ...
      if (this.jdField_a_of_type_Int == 1)
      {
        QQToast.a(BaseApplicationImpl.getContext(), 1, 2131699592, 0).a();
      ...
      for (;;)
      {
        azmj.b(null, "dc00898", "", "", "0X80082CA", "0X80082CA", 0, 0, "", "", "", "");
        if (this.jdField_a_of_type_Int != 1) {
          break;
        }
        azmj.b(null, "dc00898", "", "", "0X8008A20", "0X8008A20", 0, 0, "", "", "", "");
        break;
        if (paramInt == 1)
        {
          QQToast.a(BaseApplicationImpl.getContext(), 1, 2131699589, 0).a();
          break label238;
        }
        if (paramInt == 0)
        {
        ...
        QQToast.a(BaseApplicationImpl.getContext(), 1, 2131699587, 0).a();
        break label238;
        finish();
      }
    }
    label384:
    azmj.b(null, "dc00898", "", "", "0X80082E4", "0X80082E4", 0, 0, String.valueOf(paramLong), "", "", "");
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if (bdee.d(this))
        {
          ...
          avss localavss = this.jdField_a_of_type_Avss;
          if (!paramBoolean) {
            bool = true;
          }
          localavss.a(paramString, bool);
          if (this.jdField_b_of_type_Int == 1) {
            azmj.b(null, "dc00898", "", "", "0X80082C8", "0X80082C8", 0, 0, "", "", "", "");
          }
        }
        else
        {
          QQToast.a(BaseApplicationImpl.getContext(), 1, 2131699595, 0).a();
        }
      }
      finally {}
    }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      break;
      label103:
      if ((this.jdField_a_of_type_Avsm != null) && (this.g))
      {
  ...
  private void e()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqArmapScanSuccessView == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqArmapScanSuccessView.setScanText(alpo.a(2131713896));
    }
    for (;;)
    {
      ...
      localLayoutParams = new RelativeLayout.LayoutParams(aekt.a(40.0F, getResources()), aekt.a(40.0F, getResources()));
      localLayoutParams.addRule(14);
      localLayoutParams.addRule(12);
      localLayoutParams.bottomMargin = aekt.a(40.0F, getResources());
      this.jdField_b_of_type_AndroidWidgetImageView = new ImageView(this);
      this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130845109);
      ...
      return;
      label219:
      this.jdField_a_of_type_ComTencentMobileqqArmapScanSuccessView.setScanText(alpo.a(2131713898));
    }
  }
  ...
  public void c()
  {
    if ((this.jdField_a_of_type_Avsm != null) && (this.jdField_c_of_type_Int == 0))
    {
      if ((this.jdField_a_of_type_Avsm.a()) && (this.jdField_a_of_type_Int != 1)) {
        this.jdField_a_of_type_ComTencentMobileqqOcrViewScanOcrView.a();
      }
      if (this.jdField_a_of_type_Int == 1) {
        azmj.b(null, "dc00898", "", "", "0X8008A1D", "0X8008A1D", 0, 0, "", "", "", "");
      }
    }
  }
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    a();
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)findViewById(2131375981));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131377868));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131372230));
    this.jdField_a_of_type_ComTencentMobileqqOcrViewScanOcrView = ((ScanOcrView)findViewById(2131376097));
    this.jdField_a_of_type_AndroidViewView = findViewById(2131364823);
    this.jdField_b_of_type_AndroidViewView = findViewById(2131377898);
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131368613));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131368595));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131377402));
    ...
    this.jdField_a_of_type_ComTencentMobileqqOcrViewMaskView = ((MaskView)findViewById(2131370081));
    ...
    String str;
    for (this.jdField_c_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqOcrDataOcrConfig.tips;; this.jdField_c_of_type_JavaLangString = getResources().getString(2131699597))
    {
      str = getIntent().getStringExtra("ocr_pic_path");
      this.jdField_b_of_type_Int = getIntent().getIntExtra("ocr_from_where", -1);
      this.jdField_a_of_type_Avss = new avss(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_a_of_type_Avsu, this.jdField_b_of_type_Int);
      this.jdField_a_of_type_Avss.d();
      if (QLog.isColorLevel()) {
      ...
      QQToast.a(this, alpo.a(2131713899), 0).a();
      finish();
      return true;
    }
    if (this.jdField_b_of_type_Int == 4)
    {
      ...
      if (this.jdField_b_of_type_Boolean)
      {
        ...
        this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131377869));
        this.jdField_c_of_type_JavaLangString = getResources().getString(2131699598);
        ...
        this.jdField_b_of_type_AndroidWidgetTextView.setText(2131719385);
      }
      if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))
      {
        paramBundle = "";
        azmj.b(null, "dc00898", "", "", "0X8008A1C", "0X8008A1C", 0, 0, "", "", paramBundle, "");
      }
    }
    else
    {
    ...
    for (;;)
    {
      ...
      break;
      label688:
      QQToast.a(BaseApplicationImpl.getContext(), 1, 2131699590, 0).a();
      finish();
      continue;
      label710:
      requestPermissions(new avtc(this), 1, new String[] { "android.permission.CAMERA" });
    }
  }
  ...
  public void doOnResume()
  {
    ...
    if (!TextUtils.isEmpty(this.jdField_d_of_type_JavaLangString))
    {
      ...
      if (this.jdField_a_of_type_Int == 1) {
        azmj.b(null, "dc00898", "", "", "0X8008A1E", "0X8008A1E", 0, 0, "", "", "", "");
      }
    }
    this.jdField_a_of_type_Avss.d();
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_Avsm != null) && (this.g))
      {
        ...
        if ((!TextUtils.isEmpty(this.jdField_e_of_type_JavaLangString)) && (this.jdField_c_of_type_Boolean) && (this.jdField_e_of_type_Boolean))
        {
          ...
          for (;;)
          {
            if ((this.jdField_a_of_type_Avti == null) || (!this.jdField_e_of_type_JavaLangString.equals(this.jdField_a_of_type_Avti.jdField_a_of_type_JavaLangString))) {
              break label257;
            }
            a(this.jdField_a_of_type_Avti.jdField_a_of_type_Int, this.jdField_a_of_type_Avti.jdField_a_of_type_ComTencentMobileqqOcrDataOcrRecogResult, this.jdField_a_of_type_Avti.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Avti.jdField_a_of_type_Long);
            break;
            Object localObject = URLDrawable.URLDrawableOptions.obtain();
  ...
  public void onMultiWindowModeChanged(boolean paramBoolean)
  {
    ...
    if (isInMultiWindow())
    {
      QQToast.a(this, alpo.a(2131713897), 0).a();
      finish();
    }
  }
}
