...
class OCRResultActivity$13
  implements ActionMode.Callback
{
  OCRResultActivity$13(OCRResultActivity paramOCRResultActivity, EditText paramEditText) {}
  ...
  public boolean onActionItemClicked(ActionMode paramActionMode, MenuItem paramMenuItem)
  {
    if (paramMenuItem.getItemId() == 2131372474)
    {
      ...
      if (TextUtils.isEmpty(paramActionMode)) {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqOcrOCRResultActivity, 1, HardCodeUtil.a(2131707797), 0).a();
      }
    }
    else
    {
    ...
    this.jdField_a_of_type_ComTencentMobileqqOcrOCRResultActivity.overridePendingTransition(2130771994, 0);
    return true;
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.ocr.OCRResultActivity.13
