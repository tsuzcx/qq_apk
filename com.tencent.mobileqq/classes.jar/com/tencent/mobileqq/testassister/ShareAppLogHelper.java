...
{
  private Handler jdField_a_of_type_AndroidOsHandler = new ahzh(this, Looper.getMainLooper());
  ...
  private int a()
  {
    ...
    a();
    localObject = ((File)localObject).listFiles(new ahzj(this));
  ...
  private void a()
  {
    ...
    if (((File)localObject).exists())
    {
      localObject = ((File)localObject).listFiles(new ahzk(this));
      if ((localObject != null) && (localObject.length > 0))
      {
  ...
  public boolean a(Time paramTime1, Time paramTime2, boolean paramBoolean)
  {
    ...
    ThreadManager.post(new ahzi(this), 10, null, true);
    return true;
  }
}
