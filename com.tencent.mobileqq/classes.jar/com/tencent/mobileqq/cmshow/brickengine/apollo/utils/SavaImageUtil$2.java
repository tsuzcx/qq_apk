  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (i == -1)
    {
      Object localObject1 = (Bitmap)this.b.getParcelableExtra("data");
      ...
      ((ApolloSurfaceView)this.c).getRender().getSavaWrapper().selectPhotoCallBack(SavaImageUtil.a, 1, i, j, (byte[])localObject1);
      return;
    }
    if (i == 0)
    {
      ((ApolloSurfaceView)this.c).getRender().getSavaWrapper().selectPhotoCallBack(SavaImageUtil.a, 3, 0, 0, null);
      return;
    }
    ((ApolloSurfaceView)this.c).getRender().getSavaWrapper().selectPhotoCallBack(SavaImageUtil.a, 2, 0, 0, null);
  }
}
