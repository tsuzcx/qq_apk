...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/mobileqq/cmshow/crossengine/resource/util/CEGetResPathUtil;", "", "()V", "TAG", "", "getActionPath", "id", "", "getApolloDrawerPath", "actionId", "getApolloPanelFramePath", "getApolloResPath", "action", "Lcom/tencent/mobileqq/apollo/model/ApolloActionData;", "opType", "getAudioFilePath", "audioId", "getDressPath", "getFaceJsonFilePath", "dir", "getFaceJsonFilePathByUrl", "url", "getRealResDir", "resType", "getResAbsolutePath", "name", "type", "cmshow_impl_release"}, k=1, mv={1, 1, 16})
public final class CEGetResPathUtil
{
  public static final CEGetResPathUtil a = new CEGetResPathUtil();
  ...
  public static final String a(@Nullable ApolloActionData paramApolloActionData, int paramInt)
  {
    ...
    case 6: 
      ...
      break;
    case 5: 
      localStringBuilder.append(CEResUtil.a.a(paramApolloActionData.actionId));
      localStringBuilder.append(paramApolloActionData.actionId);
      localStringBuilder.append("/d.zip");
      break;
    case 4: 
  ...
  {
    return CMGetResPathUtil.a(paramString, "face.json");
  }
  ...
  public static final String a(@NotNull String paramString1, @NotNull String paramString2)
  {
    ...
    if (StringsKt.startsWith$default((String)localObject, "BaseJs:", false, 2, null))
    {
      ...
      localStringBuilder.append(ApolloConstant.V);
    }
    ...
    CMGetResPathUtil.a.a(paramString2, (StringBuilder)localObject);
  ...
  public static final String b(@Nullable String paramString)
  {
    ...
    return CMGetResPathUtil.a(((StringBuilder)localObject).toString(), "face.json");
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.cmshow.crossengine.resource.util.CEGetResPathUtil
