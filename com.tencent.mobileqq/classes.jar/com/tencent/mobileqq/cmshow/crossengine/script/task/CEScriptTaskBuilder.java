  ...
  implements IScriptTaskBuilder
{
  ...
  public AbsScriptTask a(@NotNull ScriptTaskType paramScriptTaskType)
  {
    ...
    int i = CEScriptTaskBuilder.WhenMappings.a[paramScriptTaskType.ordinal()];
    if (i != 1)
    {
      if (i != 2)
      {
        if (i != 3)
        {
          ...
          {
            if (i == 5) {
              return (AbsScriptTask)new CEBackgroundPlayActionTask();
            }
            throw new NoWhenBranchMatchedException();
          }
          return (AbsScriptTask)new CEBackgroundInitTask();
        }
        return (AbsScriptTask)new CEPlayActionTask();
      }
      return (AbsScriptTask)new CECommonInitTask();
    }
    return (AbsScriptTask)new CEInitSpriteTask();
  }
}
