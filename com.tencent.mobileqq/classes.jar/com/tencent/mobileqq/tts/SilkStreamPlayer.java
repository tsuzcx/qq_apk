...
public class SilkStreamPlayer
{
  ...
  public SilkStreamPlayer(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    ...
    this.jdField_a_of_type_JavaLangString = ayla.e(paramString1).replaceAll("/", " ");
    this.b = paramString2;
    this.d = paramString3;
  }
  ...
  private InputStream a()
  {
    ...
    catch (NoSuchAlgorithmException localNoSuchAlgorithmException)
    {
      try
      {
        ...
        ((JSONObject)localObject1).put("textmd5", bdhv.d(this.jdField_a_of_type_JavaLangString));
        long l = jdField_a_of_type_Long;
        jdField_a_of_type_Long = 1L + l;
        ((JSONObject)localObject1).put("seq", l);
        ((JSONObject)localObject1).put("clientVersion", "AND_" + AppSetting.a() + "_" + "8.2.8");
        ((JSONObject)localObject1).put("net", nam.a());
  ...
  {
    boolean bool2 = true;
    byte[] arrayOfByte = bbdm.a("02232153494C4B5F5633");
    int i = 1;
    for (;;)
    {
      boolean bool1 = bool2;
  ...
  public void a(bauh parambauh)
  {
    this.jdField_a_of_type_Bauh = parambauh;
  }
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Bauh != null) {
      this.jdField_a_of_type_Bauh.c();
    }
  }
