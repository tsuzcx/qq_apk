...
import com.tencent.mobileqq.intervideo.groupvideo.cschannel.ODCsChannel.CsChannelObserver;
import com.tencent.mobileqq.now.roport.ReportTask;
...
final class GroupVideoChatAppInfo$1
  implements ODCsChannel.CsChannelObserver
{
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      if ((paramArrayOfByte.app_type.get() <= 0) || (paramArrayOfByte.is_group_member.get() != 0))
      {
        ...
        paramInt = 1;
        paramBundle = new ReportTask().a("QQ_chatroom_surface").b("click_entrance").a(paramInt).d(String.valueOf(bool));
