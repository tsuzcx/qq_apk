  ...
  implements Serializable, Comparable<PlusPanelAppInfo>
{
  ...
  public void handlePanelClick(ayfu paramayfu, BaseChatPie paramBaseChatPie, SessionInfo paramSessionInfo)
  {
    boolean bool1 = false;
    ...
    if (!bool2) {
      onPlusPanelAppClick(paramayfu, paramBaseChatPie, paramSessionInfo);
    }
  }
  ...
  protected abstract void onPlusPanelAppClick(ayfu paramayfu, BaseChatPie paramBaseChatPie, SessionInfo paramSessionInfo);
  
  void showSelGAudioChatEntryActionSheet(BaseChatPie paramBaseChatPie, SessionInfo paramSessionInfo, int paramInt, boolean paramBoolean, String paramString)
  {
    if (paramInt == 10) {
      bfxl.b(paramBoolean);
    }
    agtw.a(paramBaseChatPie.app, paramBaseChatPie.mActivity, paramSessionInfo, paramInt, paramBoolean, paramBaseChatPie.app.getCurrentUin(), paramString);
 ...
 * Qualified Name:     com.tencent.mobileqq.pluspanel.appinfo.PlusPanelAppInfo
