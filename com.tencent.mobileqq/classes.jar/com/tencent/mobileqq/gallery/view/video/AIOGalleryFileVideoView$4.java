...
public class AIOGalleryFileVideoView$4
  implements Runnable
{
  public AIOGalleryFileVideoView$4(apvm paramapvm) {}
  
  public void run()
  {
    Object localObject = this.this$0.jdField_a_of_type_Aptk.a();
    int i;
    long l1;
    ...
    for (float f = (int)((float)this.this$0.jdField_a_of_type_Agez.d() / (float)l1 * 10000.0F);; f = 10000.0F)
    {
      ...
      this.this$0.jdField_a_of_type_Aptk.a.postDelayed(this.this$0.b, 100L);
      return;
