...
public class AIOGalleryFilePicView$2
  implements Runnable
{
  public AIOGalleryFilePicView$2(aqot paramaqot, int paramInt, SparseArray paramSparseArray, ArrayList paramArrayList) {}
      ...
      catch (JSONException localJSONException1)
      {
        for (;;)
        {
          try
          {
            ...
            {
              localObject = "";
              this.this$0.a(2131692915, 2130839646, 55, (String)localObject, this.jdField_a_of_type_JavaUtilArrayList);
        ...
        try
        {
          ...
          localObject = "";
          this.this$0.a(2131692914, 2130839645, 56, (String)localObject, this.jdField_a_of_type_JavaUtilArrayList);
