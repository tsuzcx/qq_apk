...
public class AIOGalleryFilePicView$3
  implements Runnable
{
  public AIOGalleryFilePicView$3(apur paramapur, File paramFile, ArrayList paramArrayList) {}
  ...
  public void run()
  {
    try
    {
      if (this.jdField_a_of_type_JavaIoFile != null)
      {
        ...
        apur.a(this.this$0, localUri, this.jdField_a_of_type_JavaUtilArrayList);
      }
      return;
    }
    catch (Exception localException)
    {
      apsm.a().a().a("AIOGalleryFilePicView", 4, "add qr action sheet error: " + localException.getMessage());
    }
  }
}
