  ...
  implements BreatheEffectView.BreatheListener
{
  ...
  {
    Object localObject1;
    if (VasProfileTagView.access$1200(this.this$0) != null)
    {
      localObject1 = VasProfileTagView.access$300(this.this$0);
      ...
      while (i < j)
      {
        ...
        if ((localObject2 != null) && (localObject2.getVisibility() != 8))
        {
          ...
          {
            localLayoutParams.a = VasProfileTagView.access$1200(this.this$0).x;
            localLayoutParams.b = VasProfileTagView.access$1200(this.this$0).y;
    ...
    {
      localObject1 = (FrameLayout)VasProfileTagView.access$1300(this.this$0).findViewById(16908290);
      if (localObject1 != null)
      {
        VasProfileTagView.access$1402(this.this$0, ((FrameLayout)localObject1).getBackground());
        if (!(VasProfileTagView.access$1400(this.this$0) instanceof IGLDrawable)) {
