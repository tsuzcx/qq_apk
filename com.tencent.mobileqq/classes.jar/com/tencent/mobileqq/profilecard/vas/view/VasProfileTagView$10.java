...
class VasProfileTagView$10
  implements ValueAnimator.AnimatorUpdateListener
{
  VasProfileTagView$10(VasProfileTagView paramVasProfileTagView, View paramView, PointF paramPointF) {}
  ...
  public void onAnimationUpdate(ValueAnimator paramValueAnimator)
  {
    ...
    float f2 = VasProfileTagView.access$1300(this.this$0).x;
    float f3 = VasProfileTagView.access$700(this.this$0).getWidth();
    float f4 = this.val$pos.y;
    float f5 = VasProfileTagView.access$1300(this.this$0).y;
 ...
 * Qualified Name:     com.tencent.mobileqq.profilecard.vas.view.VasProfileTagView.10
