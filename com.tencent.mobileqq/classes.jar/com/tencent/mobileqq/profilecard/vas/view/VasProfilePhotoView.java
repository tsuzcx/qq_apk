...
{
  public VasProfilePhotoView(BaseActivity paramBaseActivity, azfe paramazfe)
  {
  ...
  {
    return LayoutInflater.from(paramContext).inflate(2131562070, this, true);
  }
  ...
  {
    paramView = (QzonePhotoView)paramView.findViewById(2131374896);
    paramView.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, paramazfe);
    this.jdField_a_of_type_JavaUtilHashMap.put("map_key_qzonecover", paramView);
    azfl.a(paramView, "background", paramazfe.jdField_a_of_type_Azfl, "commonMaskBackground");
  }
  ...
  private void c(azfe paramazfe, View paramView)
  {
    ...
    azfl.a(paramView, "color", paramazfe.jdField_a_of_type_Azfl, "photoAddressColor");
  ...
  private void d(azfe paramazfe, View paramView)
  {
    ...
    azfl.a(paramView, "color", paramazfe.jdField_a_of_type_Azfl, "photoNickNameColor");
