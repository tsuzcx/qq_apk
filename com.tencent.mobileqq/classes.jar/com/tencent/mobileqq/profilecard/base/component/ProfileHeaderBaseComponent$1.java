  ...
  implements FriendProfilePhotoHelper.ProfilePhotoCallback
{
  ...
  public void onUploadResult(byte[] paramArrayOfByte)
  {
    if (paramArrayOfByte != null) {
      if ((ProfileHeaderBaseComponent.access$200(this.this$0) != null) && (((ProfileCardInfo)ProfileHeaderBaseComponent.access$300(this.this$0)).a != null))
      {
        if (((ProfileCardInfo)ProfileHeaderBaseComponent.access$400(this.this$0)).a.checkCoverUrl(paramArrayOfByte)) {
          ((ProfileCardInfo)ProfileHeaderBaseComponent.access$500(this.this$0)).a.updateCoverData(paramArrayOfByte);
        }
  ...
  public void updateCover(byte[] paramArrayOfByte)
  {
    if (paramArrayOfByte != null)
    {
      ((ProfileCardInfo)ProfileHeaderBaseComponent.access$000(this.this$0)).a.updateCoverData(paramArrayOfByte);
      if ((this.this$0.mHeaderView instanceof ProfileBaseView)) {
