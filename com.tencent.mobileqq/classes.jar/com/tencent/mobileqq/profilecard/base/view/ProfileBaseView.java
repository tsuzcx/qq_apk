  ...
  extends AbsProfileHeaderView
{
  ...
  public ProfileBaseView(BaseActivity paramBaseActivity, aymg paramaymg)
  {
  ...
  private void e()
  {
    ...
    for (localObject = ((Context)localObject).getString(2131691084);; localObject = ((Context)localObject).getString(2131691083))
    {
      ...
      this.c = this.jdField_a_of_type_AndroidViewView.findViewById(2131374168);
      ...
      this.d = this.jdField_a_of_type_AndroidViewView.findViewById(2131373950);
  ...
  public void a(int paramInt, aymg paramaymg)
  {
    if (QLog.isColorLevel()) {
    ...
    if (paramInt == 1)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqWidgetProfileNameView != null) {
        this.jdField_a_of_type_ComTencentMobileqqWidgetProfileNameView.setTextColor(getResources().getColor(2131167012));
      }
      ...
      paramaymg = (RelativeLayout.LayoutParams)this.jdField_b_of_type_AndroidViewView.getLayoutParams();
      paramaymg.addRule(3, 0);
      paramaymg.addRule(10, 1);
      this.jdField_b_of_type_AndroidViewView.setLayoutParams(paramaymg);
    ...
    else
    {
      ...
      ((RelativeLayout.LayoutParams)localObject).addRule(3, 2131368687);
      ...
      localObject = new aykg(17, null);
      if (paramaymg.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_Int != 0) {
        break label296;
      }
    }
    label296:
    for (paramaymg = getContext().getString(2131691079);; paramaymg = getContext().getString(2131691078))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWidgetRandomCoverView.setContentDescription(paramaymg);
      d(paramInt);
      return;
      i = 2131167176;
      break;
  ...
  {
    boolean bool = false;
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(getContext()).inflate(2131561962, this, true);
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidViewView.findViewById(2131368671));
    this.jdField_a_of_type_ComTencentMobileqqWidgetRandomCoverView = ((RandomCoverView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368687));
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqWidgetRandomCoverView = ((RandomCoverView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368687));
      this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131368664);
      ...
      String str1 = paramaymg.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_JavaLangString;
      ...
      if (ThemeUtil.isInNightMode(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))
      {
        paramaymg = (ImageView)this.jdField_a_of_type_ComTencentMobileqqVasAvatarAvatarLayout.findViewById(2131363357);
        ...
        paramaymg.setColorFilter(1996488704);
      ...
      {
        localObject1 = paramaymg.jdField_a_of_type_ComTencentMobileqqDataCard.getCoverData(this.jdField_a_of_type_Int);
        ...
        if ((TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) || (paramaymg.jdField_a_of_type_ComTencentMobileqqDataCard.isNoCover())) {}
        for (i = 1;; i = 0)
        {
          if (i == 0) {
            break label427;
  ...
  protected void b(int paramInt)
  {
    ...
    View localView = LayoutInflater.from(getContext()).inflate(2131561963, this.jdField_a_of_type_AndroidViewViewGroup, false);
    if (localView != null)
    {
  ...
  public void b(aymg paramaymg, boolean paramBoolean)
  {
    ...
    ThreadManager.post(new ProfileBaseView.1(this, paramaymg, paramBoolean), 8, null, true);
  }
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqWidgetProfileNameView != null) {
      this.jdField_a_of_type_ComTencentMobileqqWidgetProfileNameView.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramaymg);
    }
  ...
  public void d(int paramInt)
  {
    ...
    do
    {
      ...
      if (paramInt == 1)
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqWidgetProfileNameView.b() == 2)
        {
        ...
        ((RelativeLayout.LayoutParams)localObject).addRule(8, 2131367946);
        this.c.setLayoutParams((ViewGroup.LayoutParams)localObject);
        return;
      }
      ...
      i = ((Resources)localObject).getDimensionPixelSize(2131297544);
      j = ((Resources)localObject).getDimensionPixelSize(2131297546);
      localObject = (RelativeLayout.LayoutParams)this.c.getLayoutParams();
      ((RelativeLayout.LayoutParams)localObject).addRule(6, 0);
      ((RelativeLayout.LayoutParams)localObject).addRule(8, 2131367946);
      this.c.setLayoutParams((ViewGroup.LayoutParams)localObject);
  ...
  {
    if ((paramaymg.jdField_b_of_type_Boolean) && (TroopInfo.isQidianPrivateTroop(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramaymg.jdField_a_of_type_JavaLangString))) {}
    Object localObject;
    do
    {
      return;
  ...
  protected void j(aymg paramaymg)
  {
    int j = 1;
    boolean bool;
    if (paramaymg.jdField_a_of_type_ComTencentMobileqqDataCard != null)
    {
      Object localObject = paramaymg.jdField_a_of_type_ComTencentMobileqqDataCard.getCoverData(this.jdField_a_of_type_Int);
