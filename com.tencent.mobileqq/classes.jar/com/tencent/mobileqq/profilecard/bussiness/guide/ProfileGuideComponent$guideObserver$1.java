  ...
  extends ProfileGuideObserver
{
  public void onGetProfileGuide(boolean paramBoolean, @Nullable ProfileGuide paramProfileGuide)
  {
    if (QLog.isColorLevel())
    {
      ...
      QLog.d("ProfileGuideComponent", 2, (String)localObject);
    }
    if (paramBoolean) {
