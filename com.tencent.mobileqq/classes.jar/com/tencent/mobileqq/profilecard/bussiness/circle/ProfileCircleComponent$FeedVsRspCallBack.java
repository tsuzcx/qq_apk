  ...
  implements VSDispatchObserver.onVSRspCallBack<FeedCloudRead.StGetMainPageRsp>
{
  ...
  public void onReceive(BaseRequest paramBaseRequest, boolean paramBoolean, long paramLong, String paramString, FeedCloudRead.StGetMainPageRsp paramStGetMainPageRsp)
  {
    ...
    if (paramStGetMainPageRsp != null)
    {
      ...
      if (((ProfileCardInfo)ProfileCircleComponent.access$200(paramBaseRequest)).card != null) {
        ProfileCircleComponent.access$400().put(((ProfileCardInfo)ProfileCircleComponent.access$300(paramBaseRequest)).card.uin, new ProfileCircleComponent.ProfileCircleCacheBean(paramStGetMainPageRsp, System.currentTimeMillis()));
      }
