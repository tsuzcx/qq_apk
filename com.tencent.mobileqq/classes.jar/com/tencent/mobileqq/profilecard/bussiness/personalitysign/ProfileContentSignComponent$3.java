  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      int i = SigTopicManager.a().a(this.val$info, (String)((Pair)this.val$richStatus.topics.get(0)).second, this.val$richStatus.actionText, ProfileContentSignComponent.access$1800(this.this$0), ProfileContentSignComponent.access$1900(this.this$0), ProfileContentSignComponent.access$2000(this.this$0));
      if (i == -2147483648) {
        return;
      }
      UiUtils.Companion.showProfileSignGuideAsDropDown(this.val$info, -i, 0);
      SigTopicManager.a().b(ProfileContentSignComponent.access$2400(this.this$0));
