  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    ((IBigEmotionService)QRoute.api(IBigEmotionService.class)).reportCommercialDrainage(this.this$0.app.getCurrentAccountUin(), "IP", "aio_enterclk", "", 0, 0, 0, this.val$netStr, this.val$ipId, "", "", "", "", "", 0, 0, 0, 0);
