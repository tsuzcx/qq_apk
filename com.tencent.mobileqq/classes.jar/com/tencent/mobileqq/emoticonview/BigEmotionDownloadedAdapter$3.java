  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    VasWebviewUtil.openQQBrowserWithoutAD(this.this$0.mContext, this.val$vipIPSiteInfo.ipUrl, -1L, localIntent, false, -1);
    VasWebviewUtil.reportCommercialDrainage(this.this$0.app.getCurrentAccountUin(), "IP", "aio_enterclk", "", 0, 0, 0, this.val$netStr, this.val$ipId, "", "", "", "", "", 0, 0, 0, 0);
