  ...
  implements Handler.Callback
{
  ...
  private void a(URLImageView paramURLImageView, PicEmoticonInfo paramPicEmoticonInfo)
  {
    ...
    if ("push".equals(paramPicEmoticonInfo.jdField_a_of_type_JavaLangString))
    {
      ...
      ((URLDrawable.URLDrawableOptions)localObject).mLoadingDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843835);
      if (bool)
      {
    ...
    try
    {
      ...
      if (paramPicEmoticonInfo != null)
      {
        ...
        ((URLDrawable.URLDrawableOptions)localObject).mFailedDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841313);
  ...
  private RelativeLayout b()
  {
    ...
    localProgressBar.setIndeterminateDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130838592));
    ...
    for (paramEmotionPanelData = (PicEmoticonInfo)paramEmotionPanelData;; paramEmotionPanelData = null)
    {
      ...
      if (!TextUtils.isEmpty(str))
      {
        ...
        if (str.length() > 5)
        {
          ...
          {
            ((ImageView)localObject1).setImageResource(2130843844);
  ...
  public void b()
  {
    ...
    EmotionPanelDataBuilder.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.c, null, -1, 0, false, new abzg(this));
  }
