...
public class EmotionKeywordAdapter$3
  implements Runnable
{
  public EmotionKeywordAdapter$3(anzz paramanzz, EmoticonResp paramEmoticonResp, String paramString) {}
  
  public void run()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqDataEmoticonResp.resetKeywordExpose) {
      anzz.a(this.this$0).c(anzz.a(this.this$0));
    }
    Object localObject1 = new EmoticonKeywords();
    ((EmoticonKeywords)localObject1).keyword = anzz.a(this.this$0);
    ((EmoticonKeywords)localObject1).lastReqTime = System.currentTimeMillis();
    anzz.a(this.this$0).a((EmoticonKeywords)localObject1);
    localObject1 = this.jdField_a_of_type_ComTencentMobileqqDataEmoticonResp.data;
    if (QLog.isColorLevel()) {
      QLog.d("EmotionKeywordAdapter", 2, "handleCloudEmotionForKeywordResp keyword = " + anzz.a(this.this$0) + ",resp size = " + ((List)localObject1).size());
    }
    Object localObject2 = new StringBuilder();
    ((StringBuilder)localObject2).append("handleCloudEmotionForKeywordResp : eId = ");
    ArrayList localArrayList = new ArrayList();
    localArrayList.addAll(anzz.a(this.this$0));
    ...
    while (((Iterator)localObject3).hasNext())
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("EmotionKeywordAdapter", 2, "handleCloudEmotionForKeywordResp keyword = " + anzz.a(this.this$0) + "id = " + localEmoticon.epId + " ipSiteName = " + localEmoticon.ipsiteName + " ipsiteUrl = " + localEmoticon.ipsiteUrl);
      }
    ...
    for (;;)
    {
      if (anzz.a(this.this$0).a(localEmoticon.epId) == null) {
        ((anvx)anzz.a(this.this$0).getManager(43)).a(localEmoticon.epId, anvx.c);
      }
      label472:
      int i;
      label504:
      ...
      if (((List)localObject1).size() > 0)
      {
        ...
        anzz.a(this.this$0).a(localEmoticon.epId, localEmoticon, localBqAssocInfo.rpt_apng_support_size.get());
        label600:
        localObject1 = new EmotionKeyword();
        ((EmotionKeyword)localObject1).keyword = anzz.a(this.this$0).toLowerCase();
        ((EmotionKeyword)localObject1).epId = localEmoticon.epId;
        ((EmotionKeyword)localObject1).eId = localEmoticon.eId;
        anzz.a(this.this$0).a((EmotionKeyword)localObject1);
        anzz.a(this.this$0).a(localEmoticon);
        i = 0;
      }
      for (;;)
      {
        ...
        else
        {
          ...
          anzz.a(this.this$0).a(localEmoticon.epId, localEmoticon, localBqAssocInfo.rpt_support_size.get());
          break label600;
        }
        i += 1;
      }
