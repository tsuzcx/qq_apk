...
public class EmoticonMainPanel$1
  implements Runnable
{
  EmoticonMainPanel$1(EmoticonMainPanel paramEmoticonMainPanel) {}
  
  public void run()
  {
    ObjectAnimator localObjectAnimator1 = ObjectAnimator.ofFloat(this.this$0.c, "alpha", new float[] { 0.0F, 1.0F });
    ObjectAnimator localObjectAnimator2 = ObjectAnimator.ofFloat(this.this$0.c, "alpha", new float[] { 1.0F, 0.6F });
    ObjectAnimator localObjectAnimator3 = ObjectAnimator.ofFloat(this.this$0.c, "rotation", new float[] { 0.0F, 50.0F });
    ObjectAnimator localObjectAnimator4 = ObjectAnimator.ofFloat(this.this$0.c, "alpha", new float[] { 0.6F, 1.0F });
    ObjectAnimator localObjectAnimator5 = ObjectAnimator.ofFloat(this.this$0.c, "rotation", new float[] { 50.0F, 0.0F });
    ...
    this.this$0.getContext().getSharedPreferences("mobileQQ", 0).edit().putBoolean("emo_panel_mall_new_played", true).apply();
  }
}
