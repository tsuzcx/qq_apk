...
class EmoticonMainPanel$29
  implements Runnable
{
  EmoticonMainPanel$29(EmoticonMainPanel paramEmoticonMainPanel) {}
  ...
  public void run()
  {
    ...
    if (localList != null)
    {
      ...
      if (i < localList.size())
      {
        ...
        if ((localaoap == null) || (localaoap.a != 4)) {}
      }
    }
    for (;;)
    {
 ...
 * Qualified Name:     com.tencent.mobileqq.emoticonview.EmoticonMainPanel.29
