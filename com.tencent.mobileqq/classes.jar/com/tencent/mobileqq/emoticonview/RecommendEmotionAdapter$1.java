...
public class RecommendEmotionAdapter$1
  implements Runnable
{
  public RecommendEmotionAdapter$1(aobu paramaobu, aobz paramaobz) {}
      ...
      synchronized (this.this$0.jdField_a_of_type_JavaLangObject)
      {
        ...
        if (localFile == null)
        {
          if (QLog.isColorLevel()) {
            QLog.d("RecommendEmotionAdapter", 2, "emoticon Effect effectFile = null, id:" + this.a.jdField_a_of_type_Bbnt.a + ", index:" + this.a.jdField_a_of_type_Int);
          }
          ...
          i = ((aobz)this.this$0.b.get(0)).jdField_a_of_type_Int;
        ...
        else
        {
          ...
          {
            if (QLog.isColorLevel()) {
              QLog.d("RecommendEmotionAdapter", 2, "emoticon Effect postShow, id:" + this.a.jdField_a_of_type_Bbnt.a + ", index:" + this.a.jdField_a_of_type_Int);
            }
