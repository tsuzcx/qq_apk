...
public class RecommendEmotionAdapter$1
  implements Runnable
{
  public RecommendEmotionAdapter$1(asca paramasca, ascf paramascf) {}
      ...
      synchronized (this.this$0.jdField_a_of_type_JavaLangObject)
      {
        ...
        if (localFile == null)
        {
          if (QLog.isColorLevel()) {
            QLog.d("RecommendEmotionAdapter", 2, "emoticon Effect effectFile = null, id:" + this.a.jdField_a_of_type_Bgwk.a + ", index:" + this.a.jdField_a_of_type_Int);
          }
          ...
          i = ((ascf)this.this$0.b.get(0)).jdField_a_of_type_Int;
        ...
        else
        {
          ...
          {
            if (QLog.isColorLevel()) {
              QLog.d("RecommendEmotionAdapter", 2, "emoticon Effect postShow, id:" + this.a.jdField_a_of_type_Bgwk.a + ", index:" + this.a.jdField_a_of_type_Int);
            }
