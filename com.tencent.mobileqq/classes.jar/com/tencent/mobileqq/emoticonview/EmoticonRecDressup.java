...
public class EmoticonRecDressup
{
  ...
  public static EmoticonRecDressup a(String paramString, boolean paramBoolean)
  {
    ...
    do
    {
      try
      {
        paramString = new EmoticonRecDressup().a(new JSONObject(paramString));
        return paramString;
      }
  ...
  private EmoticonRecDressup a(JSONObject paramJSONObject)
  {
