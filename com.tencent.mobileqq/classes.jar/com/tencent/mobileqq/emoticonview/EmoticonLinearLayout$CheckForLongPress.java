  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      localanht = (anht)this.this$0.jdField_a_of_type_AndroidViewView.getTag();
      if (localanht != null)
      {
    ...
    label132:
    while (("setting".equals(localanht.h)) || ("add".equals(localanht.h))) {
      return;
    }
