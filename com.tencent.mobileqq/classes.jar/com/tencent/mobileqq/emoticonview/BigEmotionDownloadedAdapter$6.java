  ...
  implements View.OnClickListener
{
  ...
  {
    ((IBigEmotionService)QRoute.api(IBigEmotionService.class)).openQQBrowserWithoutAD(this.this$0.mContext, this.val$video.redirectUrl, -1L, null, false, -1);
    ((IBigEmotionService)QRoute.api(IBigEmotionService.class)).reportCommercialDrainage(this.this$0.app.getCurrentAccountUin(), "IP", "aio_movieclk", "", 0, 0, 0, this.val$netStr, this.val$ipId, "", "", "", "", "", 0, 0, 0, 0);
