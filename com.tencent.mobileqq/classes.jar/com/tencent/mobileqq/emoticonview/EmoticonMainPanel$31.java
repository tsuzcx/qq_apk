...
class EmoticonMainPanel$31
  implements Runnable
{
  EmoticonMainPanel$31(EmoticonMainPanel paramEmoticonMainPanel, int paramInt, long paramLong, HashMap paramHashMap) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        axrl.a(this.this$0.jdField_a_of_type_AndroidContentContext).a(str, (String)localObject, true, this.jdField_a_of_type_Long, 0L, this.jdField_a_of_type_JavaUtilHashMap, "", false);
        localObject = localSharedPreferences.edit();
 ...
 * Qualified Name:     com.tencent.mobileqq.emoticonview.EmoticonMainPanel.31
