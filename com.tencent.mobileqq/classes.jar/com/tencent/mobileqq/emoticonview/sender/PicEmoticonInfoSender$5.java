...
final class PicEmoticonInfoSender$5
  implements QueryCallback<EmoticonPackage>
{
  PicEmoticonInfoSender$5(Emoticon paramEmoticon, BaseQQAppInterface paramBaseQQAppInterface, int paramInt, Context paramContext, BaseSessionInfo paramBaseSessionInfo) {}
  ...
  public void postQuery(EmoticonPackage paramEmoticonPackage)
  {
    ...
    ((IEmosmService)QRoute.api(IEmosmService.class)).magicfaceAutoPlay(this.val$context, this.val$emoticon, new PicEmoticonInfoSender.5.1(this, paramEmoticonPackage));
  }
}
