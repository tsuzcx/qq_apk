...
class PicEmoticonInfoSender$1
  implements QueryCallback<EmoticonPackage>
{
  PicEmoticonInfoSender$1(PicEmoticonInfoSender paramPicEmoticonInfoSender, Emoticon paramEmoticon, QQAppInterface paramQQAppInterface, int paramInt, Context paramContext, SessionInfo paramSessionInfo) {}
  ...
  public void postQuery(EmoticonPackage paramEmoticonPackage)
  {
    ...
    ((FragmentActivity)this.val$context).getChatFragment().a().a().a(this.val$emoticon, new PicEmoticonInfoSender.1.1(this, paramEmoticonPackage));
  }
}
