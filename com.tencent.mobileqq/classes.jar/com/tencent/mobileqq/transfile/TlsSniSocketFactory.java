  ...
  implements LayeredSocketFactory
{
  ...
  public Socket createSocket(Socket paramSocket, String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    if (HOSTNAME_VERIFIER.verify(paramString, (SSLSession)localObject))
    {
      if (QLog.isColorLevel())
      {
        localStringBuilder = new StringBuilder();
        localStringBuilder.append("Established ");
        localStringBuilder.append(((SSLSession)localObject).getProtocol());
        localStringBuilder.append(" connection with ");
