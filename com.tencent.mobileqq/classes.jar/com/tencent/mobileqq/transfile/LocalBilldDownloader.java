  ...
  extends AbsDownloader
{
  ...
  public java.io.File downloadImage(java.io.OutputStream paramOutputStream, com.tencent.image.DownloadParams paramDownloadParams, com.tencent.image.URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    //   9: dup
    //   10: getstatic 35	com/tencent/mobileqq/app/AppConstants:SDCARD_BILLD_URLDRAWABLE	Ljava/lang/String;
    ...
    //   28: pop
    //   29: aload_2
    //   30: getfield 51	com/tencent/image/DownloadParams:url	Ljava/net/URL;
    //   33: invokevirtual 57	java/net/URL:getPath	()Ljava/lang/String;
    //   36: astore_1
    //   37: new 30	java/io/File
    //   40: dup
    //   41: new 59	java/lang/StringBuilder
    //   44: dup
    //   45: invokespecial 60	java/lang/StringBuilder:<init>	()V
    //   48: aload_3
    //   49: invokevirtual 64	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   52: ldc 66
    ...
    //   74: ifeq +13 -> 87
    //   77: aload 7
    //   79: invokevirtual 76	java/io/File:length	()J
    //   82: lconst_0
    //   83: lcmp
    //   84: ifne +244 -> 328
    //   87: new 30	java/io/File
    //   90: dup
    //   91: new 59	java/lang/StringBuilder
    //   94: dup
    //   95: invokespecial 60	java/lang/StringBuilder:<init>	()V
    //   98: aload_3
    ...
    //   116: invokevirtual 72	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   119: invokespecial 38	java/io/File:<init>	(Ljava/lang/String;)V
    //   122: astore 8
    //   124: aload 8
    //   126: invokevirtual 42	java/io/File:exists	()Z
    //   129: ifeq +9 -> 138
    //   132: aload 8
    //   134: invokevirtual 81	java/io/File:delete	()Z
    //   137: pop
    //   138: invokestatic 86	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   141: ifeq +53 -> 194
    //   144: ldc 14
    //   146: iconst_2
    //   147: new 59	java/lang/StringBuilder
    //   150: dup
    //   151: invokespecial 60	java/lang/StringBuilder:<init>	()V
    //   154: ldc 88
    //   156: invokevirtual 69	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   159: aload_2
    //   160: getfield 91	com/tencent/image/DownloadParams:urlStr	Ljava/lang/String;
    ...
    //   180: aload 7
    //   182: invokevirtual 98	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   185: invokevirtual 69	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   188: invokevirtual 72	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   191: invokestatic 102	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   194: aload_0
    //   195: getfield 23	com/tencent/mobileqq/transfile/LocalBilldDownloader:application	Landroid/app/Application;
    //   198: invokevirtual 108	android/app/Application:getResources	()Landroid/content/res/Resources;
    //   201: aload_1
    //   202: ldc 110
    //   204: aload_0
    //   205: getfield 23	com/tencent/mobileqq/transfile/LocalBilldDownloader:application	Landroid/app/Application;
    //   208: invokevirtual 113	android/app/Application:getPackageName	()Ljava/lang/String;
    //   211: invokevirtual 119	android/content/res/Resources:getIdentifier	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    //   214: istore 4
    //   216: aload_0
    //   217: getfield 23	com/tencent/mobileqq/transfile/LocalBilldDownloader:application	Landroid/app/Application;
    //   220: invokevirtual 108	android/app/Application:getResources	()Landroid/content/res/Resources;
    //   223: iload 4
    //   225: invokevirtual 123	android/content/res/Resources:openRawResource	(I)Ljava/io/InputStream;
    //   228: astore_1
    //   229: sipush 4096
    //   232: newarray byte
    //   234: astore_2
    //   235: new 125	java/io/FileOutputStream
    //   238: dup
    //   239: aload 8
    //   241: invokespecial 128	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   244: astore_3
    //   245: aload_1
    //   246: aload_2
    //   247: invokevirtual 134	java/io/InputStream:read	([B)I
    //   250: iconst_m1
    //   251: if_icmpeq +53 -> 304
    //   254: aload_3
    //   255: aload_2
    //   256: invokevirtual 138	java/io/FileOutputStream:write	([B)V
    //   259: aload_3
    //   260: invokevirtual 141	java/io/FileOutputStream:flush	()V
    //   263: goto -18 -> 245
    //   266: astore 5
    //   268: aload_1
    //   269: astore_2
    ...
    //   287: ifnull +7 -> 294
    //   290: aload_1
    //   291: invokevirtual 144	java/io/InputStream:close	()V
    //   294: aload_3
    //   295: ifnull +7 -> 302
    //   298: aload_3
    //   299: invokevirtual 145	java/io/FileOutputStream:close	()V
    //   302: aload_2
    //   303: athrow
    //   304: aload_1
    //   305: ifnull +7 -> 312
    //   308: aload_1
    //   309: invokevirtual 144	java/io/InputStream:close	()V
    //   312: aload_3
    //   313: ifnull +7 -> 320
    //   316: aload_3
    //   317: invokevirtual 145	java/io/FileOutputStream:close	()V
    //   320: aload 8
    //   322: aload 7
    //   324: invokevirtual 149	java/io/File:renameTo	(Ljava/io/File;)Z
    //   327: pop
    //   328: aload 7
    //   330: areturn
    //   331: astore_2
    ...
    //   0	372	0	this	LocalBilldDownloader
