...
class GuildPicUploadProcessor$1
  implements ITransactionCallback
{
  GuildPicUploadProcessor$1(GuildPicUploadProcessor paramGuildPicUploadProcessor) {}
  ...
  public void onFailed(int paramInt, byte[] paramArrayOfByte, HashMap<String, String> paramHashMap)
  {
    ...
    if (QLog.isColorLevel())
    {
      ...
      paramArrayOfByte.append("<BDH_LOG> Guild Transaction End : Failed. New : SendTotalCost:");
      paramArrayOfByte.append(l - this.this$0.startTime);
      paramArrayOfByte.append("ms");
      QLog.d("GuildPicUploadProcessor", 2, paramArrayOfByte.toString());
    }
  ...
  public void onSuccess(byte[] paramArrayOfByte, HashMap<String, String> paramHashMap)
  {
    ...
    {
      paramArrayOfByte = new StringBuilder();
      paramArrayOfByte.append("<BDH_LOG> Guild Transaction End : Success. New : SendTotalCost:");
      paramArrayOfByte.append(l - this.this$0.startTime);
  ...
  {
    long l = SystemClock.uptimeMillis();
    this.this$0.log("<BDH_LOG> Guild onSwitch2BackupChannel() switch to HTTP channel");
    this.this$0.mProcessorReport.mReportInfo.put("param_switchChannel", String.valueOf(l - this.this$0.startTime));
  }
  
  public void onTransStart()
  {
    this.this$0.log("<BDH_LOG> Guild onTransStart()");
    this.this$0.mProcessorReport.mStepTrans.logStartTime();
  }
  
  public void onUpdateProgress(int paramInt)
  {
    GuildPicUploadProcessor localGuildPicUploadProcessor = this.this$0;
    FileMsg localFileMsg = localGuildPicUploadProcessor.file;
    long l = paramInt;
    localFileMsg.transferedSize = l;
    localGuildPicUploadProcessor.mTransferedSize = l;
 ...
 * Qualified Name:     com.tencent.mobileqq.transfile.GuildPicUploadProcessor.1
