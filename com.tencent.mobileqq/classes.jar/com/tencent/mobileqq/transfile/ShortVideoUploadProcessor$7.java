  ...
  implements Runnable
{
  public void run()
  {
    ...
    bddw.a(String.valueOf(this.this$0.a.a), "submitEntireVideo", "videoPath = " + this.jdField_a_of_type_JavaLangString);
    synchronized (this.this$0)
    {
      ...
      bddw.a(String.valueOf(this.this$0.a.a), "submitEntireVideo", "mUiRequest.mLocalPath = " + this.this$0.a.i + ",mVideoPreUpStatus = " + ShortVideoUploadProcessor.b(this.this$0) + ", mVideoRecordStatus = " + ShortVideoUploadProcessor.c(this.this$0));
