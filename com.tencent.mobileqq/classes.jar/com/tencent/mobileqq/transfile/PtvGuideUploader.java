...
public class PtvGuideUploader
{
  ...
  public PtvGuideUploader(AppInterface paramAppInterface, PtvGuideUploader.IPtvGuidUpCallback paramIPtvGuidUpCallback, String paramString1, byte[] paramArrayOfByte1, String paramString2, byte[] paramArrayOfByte2, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    this.mCallback = paramIPtvGuidUpCallback;
    this.mVideoFilePath = paramString1;
    this.mThumbFilePath = paramString2;
    this.mVideoFileMd5 = paramArrayOfByte1;
    this.mThumbFileMd5 = paramArrayOfByte2;
    this.mThumbFileWidth = paramInt1;
    this.mThumbFileHeight = paramInt2;
    this.mVideoTime = paramInt3;
  ...
  private void doReport(boolean paramBoolean)
  {
    ...
    this.mReportInfo.put("param_picSize", String.valueOf(this.mVideoFileSize));
    ...
    if (paramBoolean) {
      StatisticCollector.getInstance(BaseApplication.getContext()).collectPerformance(null, "PtvGuideUpload", true, l, this.mVideoFileSize + this.mThumbFileSize, this.mReportInfo, "");
    }
    while (QLog.isColorLevel())
    {
      ...
      StatisticCollector.getInstance(BaseApplication.getContext()).collectPerformance(null, "PtvGuideUpload", false, l, this.mVideoFileSize + this.mThumbFileSize, this.mReportInfo, "");
    }
  }
  ...
  public String combineThumbAndVideo()
  {
    ...
    //   62: dup
    //   63: invokestatic 267	com/tencent/mobileqq/shortvideo/ShortVideoUtils:getShortVideoThumbPicDir	()Ljava/lang/String;
    //   66: invokespecial 270	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   69: aload_2
    //   70: invokestatic 154	com/qq/taf/jce/HexUtil:bytes2HexStr	([B)Ljava/lang/String;
    ...
    //   85: astore 8
    //   87: aload_0
    //   88: getfield 231	com/tencent/mobileqq/transfile/PtvGuideUploader:mThumbRaf	Ljava/io/RandomAccessFile;
    //   91: invokevirtual 278	java/io/RandomAccessFile:length	()J
    //   94: l2i
    //   95: newarray byte
    //   97: astore_2
    //   98: aload_0
    //   99: getfield 251	com/tencent/mobileqq/transfile/PtvGuideUploader:mVideoRaf	Ljava/io/RandomAccessFile;
    //   102: invokevirtual 278	java/io/RandomAccessFile:length	()J
    //   105: l2i
    //   106: newarray byte
    //   108: astore 4
    //   110: aload_0
    //   111: getfield 231	com/tencent/mobileqq/transfile/PtvGuideUploader:mThumbRaf	Ljava/io/RandomAccessFile;
    //   114: invokevirtual 278	java/io/RandomAccessFile:length	()J
    //   117: aload_0
    //   118: getfield 251	com/tencent/mobileqq/transfile/PtvGuideUploader:mVideoRaf	Ljava/io/RandomAccessFile;
    //   121: invokevirtual 278	java/io/RandomAccessFile:length	()J
    //   124: ladd
    //   125: l2i
    //   126: newarray byte
    //   128: astore 9
    //   130: aload_0
    //   131: getfield 231	com/tencent/mobileqq/transfile/PtvGuideUploader:mThumbRaf	Ljava/io/RandomAccessFile;
    //   134: aload_2
    //   135: invokevirtual 282	java/io/RandomAccessFile:read	([B)I
    //   138: pop
    //   139: aload_0
    //   140: getfield 251	com/tencent/mobileqq/transfile/PtvGuideUploader:mVideoRaf	Ljava/io/RandomAccessFile;
    //   143: aload 4
    //   145: invokevirtual 282	java/io/RandomAccessFile:read	([B)I
    //   148: pop
    //   149: aload_2
    //   150: iconst_0
    //   151: aload 9
    ...
    //   154: aload_2
    //   155: arraylength
    //   156: invokestatic 262	java/lang/System:arraycopy	(Ljava/lang/Object;ILjava/lang/Object;II)V
    //   159: aload 4
    //   161: iconst_0
    //   162: aload 9
    //   164: aload_2
    ...
    //   166: aload 4
    //   168: arraylength
    //   169: invokestatic 262	java/lang/System:arraycopy	(Ljava/lang/Object;ILjava/lang/Object;II)V
    //   172: new 284	java/io/File
    //   175: dup
    //   176: aload 8
    //   178: invokespecial 285	java/io/File:<init>	(Ljava/lang/String;)V
    //   181: invokevirtual 288	java/io/File:delete	()Z
    //   184: pop
    //   185: new 284	java/io/File
    //   188: dup
    //   189: aload 8
    //   191: invokespecial 285	java/io/File:<init>	(Ljava/lang/String;)V
    //   194: astore_2
    //   195: aload_2
    //   196: invokevirtual 291	java/io/File:exists	()Z
    //   199: istore_1
    //   200: iload_1
    //   201: ifne +8 -> 209
    //   204: aload_2
    //   205: invokevirtual 294	java/io/File:createNewFile	()Z
    //   208: pop
    //   209: new 296	java/io/FileOutputStream
    //   212: dup
    //   213: aload_2
    //   214: invokespecial 299	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   217: astore_2
    //   218: new 301	java/io/BufferedOutputStream
    //   221: dup
    //   222: aload_2
    //   223: invokespecial 304	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   226: astore 4
    //   228: aload 4
    //   230: aload 9
    //   232: invokevirtual 308	java/io/BufferedOutputStream:write	([B)V
    //   235: aload 4
    //   237: ifnull +8 -> 245
    //   240: aload 4
    //   242: invokevirtual 311	java/io/BufferedOutputStream:close	()V
    //   245: aload_2
    //   246: ifnull +7 -> 253
    //   249: aload_2
    //   250: invokevirtual 312	java/io/FileOutputStream:close	()V
    //   253: aload 8
    //   255: areturn
    //   256: astore 4
    //   258: aload 4
    //   260: invokevirtual 313	java/io/IOException:printStackTrace	()V
    //   263: goto -54 -> 209
    //   266: astore 4
    //   268: aconst_null
    //   269: astore_2
    //   270: aload 4
    //   272: invokevirtual 249	java/io/FileNotFoundException:printStackTrace	()V
    //   275: aload_2
    //   276: ifnull +7 -> 283
    //   279: aload_2
    //   280: invokevirtual 311	java/io/BufferedOutputStream:close	()V
    //   283: aload_3
    //   284: ifnull -31 -> 253
    //   287: aload_3
    //   288: invokevirtual 312	java/io/FileOutputStream:close	()V
    //   291: aload 8
    //   293: areturn
    //   294: astore_2
    //   295: aload_2
    //   296: invokevirtual 313	java/io/IOException:printStackTrace	()V
    //   299: aload 8
    //   301: areturn
    //   302: astore_3
    //   303: aload_3
    //   304: invokevirtual 313	java/io/IOException:printStackTrace	()V
    //   307: goto -62 -> 245
    //   310: astore_2
    //   311: aload_2
    //   312: invokevirtual 313	java/io/IOException:printStackTrace	()V
    //   315: aload 8
    //   317: areturn
    //   318: astore_2
    //   319: aload_2
    //   320: invokevirtual 313	java/io/IOException:printStackTrace	()V
    //   323: goto -40 -> 283
    //   326: astore 6
    //   328: aconst_null
    //   329: astore 4
    ...
    //   338: astore 5
    //   340: aload 6
    //   342: invokevirtual 313	java/io/IOException:printStackTrace	()V
    //   345: aload 4
    //   347: ifnull +8 -> 355
    //   350: aload 4
    //   352: invokevirtual 311	java/io/BufferedOutputStream:close	()V
    //   355: aload_2
    //   356: ifnull -103 -> 253
    //   359: aload_2
    //   360: invokevirtual 312	java/io/FileOutputStream:close	()V
    //   363: aload 8
    //   365: areturn
    //   366: astore_2
    //   367: aload_2
    //   368: invokevirtual 313	java/io/IOException:printStackTrace	()V
    //   371: aload 8
    //   373: areturn
    //   374: astore_3
    //   375: aload_3
    //   376: invokevirtual 313	java/io/IOException:printStackTrace	()V
    //   379: goto -24 -> 355
    //   382: astore_3
    //   383: aconst_null
    //   384: astore 4
    ...
    //   396: astore 5
    //   398: aload 6
    //   400: invokevirtual 314	java/lang/OutOfMemoryError:printStackTrace	()V
    //   403: aload 4
    //   405: ifnull +8 -> 413
    //   408: aload 4
    //   410: invokevirtual 311	java/io/BufferedOutputStream:close	()V
    //   413: aload_2
    //   414: ifnull -161 -> 253
    //   417: aload_2
    //   418: invokevirtual 312	java/io/FileOutputStream:close	()V
    //   421: aload 8
    //   423: areturn
    //   424: astore_2
    //   425: aload_2
    //   426: invokevirtual 313	java/io/IOException:printStackTrace	()V
    //   429: aload 8
    //   431: areturn
    //   432: astore_3
    //   433: aload_3
    //   434: invokevirtual 313	java/io/IOException:printStackTrace	()V
    //   437: goto -24 -> 413
    //   440: astore_2
    //   441: aconst_null
    //   442: astore 4
    ...
    //   449: ifnull +8 -> 457
    //   452: aload 4
    //   454: invokevirtual 311	java/io/BufferedOutputStream:close	()V
    //   457: aload_3
    //   458: ifnull +7 -> 465
    //   461: aload_3
    //   462: invokevirtual 312	java/io/FileOutputStream:close	()V
    //   465: aload_2
    //   466: athrow
    //   467: astore 4
    //   469: aload 4
    //   471: invokevirtual 313	java/io/IOException:printStackTrace	()V
    //   474: goto -17 -> 457
    //   477: astore_3
    //   478: aload_3
    //   479: invokevirtual 313	java/io/IOException:printStackTrace	()V
    //   482: goto -17 -> 465
    //   485: astore 5
    //   487: aconst_null
    //   488: astore 4
  ...
  public boolean doUpload()
  {
    ...
    String str1 = combineThumbAndVideo();
    ...
    File localFile = new File(this.mVideoFilePath);
    String str2 = localFile.getName();
    ((PttShortVideo.PttShortVideoFileInfo)localObject2).str_file_name.set(str2);
    ((PttShortVideo.PttShortVideoFileInfo)localObject2).bytes_file_md5.set(ByteStringMicro.copyFrom(this.mVideoFileMd5));
    ((PttShortVideo.PttShortVideoFileInfo)localObject2).bytes_thumb_file_md5.set(ByteStringMicro.copyFrom(this.mThumbFileMd5));
    ...
    ((PttShortVideo.PttShortVideoFileInfo)localObject2).uint32_file_res_length.set(this.mThumbFileHeight);
    ((PttShortVideo.PttShortVideoFileInfo)localObject2).uint32_file_res_width.set(this.mThumbFileWidth);
    int i = getFormatInt(str2.substring(str2.lastIndexOf(".") + 1));
    ((PttShortVideo.PttShortVideoFileInfo)localObject2).uint32_file_format.set(i);
    ((PttShortVideo.PttShortVideoFileInfo)localObject2).uint32_file_time.set(this.mVideoTime);
    ...
    this.mThumbFileSize = localFile.length();
    ...
    localObject2 = new PtvGuideUploader.1(this, str1);
    this.mTrans = new Transaction(this.mUin, 12, str1, 0, this.mVideoFileMd5, (ITransactionCallback)localObject2, (byte[])localObject1, true);
    i = this.mApp.getHwEngine().submitTransactionTask(this.mTrans);
    if (QLog.isColorLevel()) {
      QLog.d("PtvGuideUploader", 2, "<BDH_LOG>sendFileByBDH Transaction submit RetCode:" + i + " T_ID:" + this.mTrans.getTransationId() + " MD5:" + HexUtil.bytes2HexStr(this.mVideoFileMd5) + " Path:" + this.mTrans.filePath + " Cmd:" + 12);
    }
    if (i != 0)
    {
      this.mErrCode = i;
  ...
  public int getFormatInt(String paramString)
  {
    int i = -1;
