...
public class QIMWebVideoUploaderFirstFrame
{
  ...
  public boolean a()
  {
    ...
    aicn localaicn = new aicn(this);
    this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction = new Transaction(this.jdField_b_of_type_JavaLangString, 53, this.jdField_a_of_type_JavaLangString, 0, this.jdField_a_of_type_ArrayOfByte, localaicn, (byte[])localObject, false);
