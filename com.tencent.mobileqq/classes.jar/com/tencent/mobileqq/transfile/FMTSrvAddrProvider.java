...
public final class FMTSrvAddrProvider
{
  ...
  private static final String jdField_b_of_type_JavaLangString = AppConstants.bY + "fmtSrvAddr.ini";
  private static final String c = AppConstants.bY + "srvAddr.ini";
  private static final String d = AppConstants.bY + "ipDownAddr.ini";
  private static final String e = AppConstants.bY + "ipDownAddr.tmp";
  private int jdField_a_of_type_Int = 0;
  private long jdField_a_of_type_Long = -1L;
  private FileStoragePushFSSvcList jdField_a_of_type_ConfigPushFileStoragePushFSSvcList = b();
  private aipg jdField_a_of_type_Aipg = new aipg(this);
  ...
  {
    // Byte code:
    //   0: getstatic 52	com/tencent/mobileqq/transfile/FMTSrvAddrProvider:c	Ljava/lang/String;
    //   3: invokestatic 217	com/tencent/mobileqq/utils/FileUtils:a	(Ljava/lang/String;)Ljava/io/File;
    //   6: astore_2
    //   7: aload_2
    ...
    //   12: lcmp
    //   13: ifne +33 -> 46
    //   16: invokestatic 229	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   19: ifeq +11 -> 30
    //   22: ldc 231
    //   24: iconst_2
    //   25: ldc 233
    //   27: invokestatic 236	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   30: iconst_0
    //   31: ifeq +11 -> 42
    //   34: new 238	java/lang/NullPointerException
    //   37: dup
    //   38: invokespecial 239	java/lang/NullPointerException:<init>	()V
    //   41: athrow
    //   42: aconst_null
    //   43: astore_3
    //   44: aload_3
    //   45: areturn
    //   46: new 241	java/io/FileInputStream
    //   49: dup
    //   50: aload_2
    //   51: invokespecial 244	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   54: astore 5
    //   56: aload 5
    //   58: astore_3
    //   59: sipush 1024
    ...
    //   166: aload 5
    //   168: astore_3
    //   169: new 263	ConfigPush/FileStoragePushFSSvcList
    //   172: dup
    //   173: invokespecial 264	ConfigPush/FileStoragePushFSSvcList:<init>	()V
    //   176: astore_2
    //   177: aload 5
    //   179: astore_3
    //   180: aload_2
    //   181: aload 4
    //   183: invokevirtual 268	ConfigPush/FileStoragePushFSSvcList:readFrom	(Lcom/qq/taf/jce/JceInputStream;)V
    //   186: aload_2
    //   187: astore_3
    //   188: aload 5
    //   190: ifnull -146 -> 44
    //   193: aload 5
    //   195: invokevirtual 256	java/io/FileInputStream:close	()V
    //   198: aload_2
    //   199: areturn
    //   200: astore_3
    //   201: aload_2
    ...
    //   207: ifnull +7 -> 214
    //   210: aload_3
    //   211: invokevirtual 256	java/io/FileInputStream:close	()V
    //   214: aload_2
    //   215: athrow
    //   216: astore_2
    //   217: goto -175 -> 42
  ...
  private void c(FileStoragePushFSSvcList paramFileStoragePushFSSvcList)
  {
    ...
    //   5: aload_3
    //   6: astore_2
    //   7: getstatic 48	com/tencent/mobileqq/transfile/FMTSrvAddrProvider:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   10: invokestatic 217	com/tencent/mobileqq/utils/FileUtils:a	(Ljava/lang/String;)Ljava/io/File;
    //   13: astore 5
    //   15: aload_1
    //   16: ifnonnull +77 -> 93
    //   19: aload_3
    //   20: astore_2
    //   21: invokestatic 229	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   24: ifeq +14 -> 38
    //   27: aload_3
    //   28: astore_2
    //   29: ldc 231
    //   31: iconst_2
    //   32: ldc_w 352
    //   35: invokestatic 236	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   38: aload 5
    //   40: ifnull +40 -> 80
    //   43: aload_3
    //   44: astore_2
    //   45: aload 5
    //   47: invokevirtual 355	java/io/File:exists	()Z
    //   50: ifeq +30 -> 80
    //   53: aload_3
    //   54: astore_2
    //   55: invokestatic 229	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   58: ifeq +14 -> 72
    //   61: aload_3
    //   62: astore_2
    //   63: ldc 231
    //   65: iconst_2
    //   66: ldc_w 357
    //   69: invokestatic 236	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   72: aload_3
    //   73: astore_2
    //   74: aload 5
    //   76: invokevirtual 360	java/io/File:delete	()Z
    //   79: pop
    //   80: iconst_0
    //   81: ifeq +11 -> 92
    //   84: new 238	java/lang/NullPointerException
    //   87: dup
    //   88: invokespecial 239	java/lang/NullPointerException:<init>	()V
    //   91: athrow
    //   92: return
    //   93: aload_3
    //   94: astore_2
    //   95: new 362	com/qq/taf/jce/JceOutputStream
    //   98: dup
    //   99: invokespecial 363	com/qq/taf/jce/JceOutputStream:<init>	()V
    //   102: astore 6
    //   104: aload_3
    //   105: astore_2
    //   106: aload_1
    //   107: aload 6
    //   109: invokevirtual 367	ConfigPush/FileStoragePushFSSvcList:writeTo	(Lcom/qq/taf/jce/JceOutputStream;)V
    //   112: aload_3
    //   113: astore_2
    //   114: aload 6
    //   116: invokevirtual 368	com/qq/taf/jce/JceOutputStream:toByteArray	()[B
    //   119: astore 6
    //   121: aload_3
    //   122: astore_2
    //   123: new 370	java/io/FileOutputStream
    //   126: dup
    //   127: aload 5
    //   129: iconst_0
    //   130: invokespecial 373	java/io/FileOutputStream:<init>	(Ljava/io/File;Z)V
    //   133: astore_3
    //   134: aload_3
    //   135: aload 6
    //   137: invokevirtual 375	java/io/FileOutputStream:write	([B)V
    //   140: new 219	java/io/File
    //   143: dup
    //   144: getstatic 52	com/tencent/mobileqq/transfile/FMTSrvAddrProvider:c	Ljava/lang/String;
    //   147: invokespecial 377	java/io/File:<init>	(Ljava/lang/String;)V
    //   150: astore_2
    //   151: aload_2
    //   152: invokevirtual 355	java/io/File:exists	()Z
    //   155: ifeq +8 -> 163
    //   158: aload_2
    //   159: invokevirtual 360	java/io/File:delete	()Z
    //   162: pop
    //   163: aload 5
    //   165: aload_2
    //   166: invokevirtual 381	java/io/File:renameTo	(Ljava/io/File;)Z
    //   169: pop
    //   170: aload_3
    //   171: ifnull +7 -> 178
    //   174: aload_3
    //   175: invokevirtual 382	java/io/FileOutputStream:close	()V
    //   178: aload_1
    //   179: ifnull -87 -> 92
    //   182: invokestatic 229	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   185: ifeq -93 -> 92
    //   188: ldc 231
    //   190: iconst_2
    //   191: ldc_w 384
    //   194: invokestatic 236	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   197: return
    //   198: astore_2
    //   199: aload 4
    //   201: astore_3
    ...
    //   205: aload_3
    //   206: astore_2
    //   207: invokestatic 229	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   210: ifeq +16 -> 226
    //   213: aload_3
    //   214: astore_2
    //   215: ldc 231
    ...
    //   218: ldc_w 386
    //   221: aload 4
    //   223: invokestatic 255	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   226: aload_3
    //   227: ifnull -49 -> 178
    //   230: aload_3
    //   231: invokevirtual 382	java/io/FileOutputStream:close	()V
    //   234: goto -56 -> 178
    //   237: astore_2
    //   238: goto -60 -> 178
    //   241: astore_1
    ...
    //   243: ifnull +7 -> 250
    //   246: aload_2
    //   247: invokevirtual 382	java/io/FileOutputStream:close	()V
    //   250: aload_1
    //   251: athrow
    //   252: astore_1
    //   253: return
  ...
  private void d()
  {
    ...
    this.jdField_a_of_type_Aipg.a(this.jdField_a_of_type_ConfigPushFileStoragePushFSSvcList);
  ...
  public FMTSrvAddrProvider.PttIpList a(byte[] paramArrayOfByte)
  {
    ...
    //   21: aload_0
    //   22: aload_1
    //   23: invokevirtual 751	com/tencent/mobileqq/transfile/FMTSrvAddrProvider:a	([B)Z
    //   26: ifne +15 -> 41
    //   29: new 75	com/tencent/mobileqq/transfile/FMTSrvAddrProvider$PttIpList
    //   32: dup
    //   33: invokespecial 76	com/tencent/mobileqq/transfile/FMTSrvAddrProvider$PttIpList:<init>	()V
    //   36: astore 9
    //   38: aload 9
    //   40: areturn
    //   41: aload 10
    ...
    //   102: aload 17
    //   104: astore 11
    //   106: new 75	com/tencent/mobileqq/transfile/FMTSrvAddrProvider$PttIpList
    //   109: dup
    //   110: invokespecial 76	com/tencent/mobileqq/transfile/FMTSrvAddrProvider$PttIpList:<init>	()V
    //   113: astore 15
    //   115: aload_1
    //   116: iconst_1
    //   117: baload
    ...
    //   154: iconst_0
    //   155: iconst_2
    //   156: invokestatic 199	java/lang/System:arraycopy	(Ljava/lang/Object;ILjava/lang/Object;II)V
    //   159: iload_3
    //   160: iconst_2
    //   161: iadd
    //   162: istore_3
    //   163: aload 9
    //   165: iconst_0
    //   166: invokestatic 756	com/tencent/mobileqq/util/Utils:a	([BI)S
    //   169: istore 6
    //   171: aload_1
    //   172: iload_3
    //   173: iload 6
    ...
    //   177: iconst_0
    //   178: iload 6
    //   180: invokestatic 199	java/lang/System:arraycopy	(Ljava/lang/Object;ILjava/lang/Object;II)V
    //   183: iload 5
    //   185: iconst_1
    //   186: if_icmpne +117 -> 303
    //   189: new 758	java/io/ByteArrayInputStream
    //   192: dup
    //   193: aload_1
    //   194: iload_3
    //   195: iload 6
    //   197: invokespecial 760	java/io/ByteArrayInputStream:<init>	([BII)V
    //   200: astore 9
    //   202: new 762	java/io/DataInputStream
    //   205: dup
    //   206: aload 9
    //   208: invokespecial 765	java/io/DataInputStream:<init>	(Ljava/io/InputStream;)V
    //   211: astore 10
    //   213: aload 15
    //   215: aload 10
    //   217: invokevirtual 768	java/io/DataInputStream:readUTF	()Ljava/lang/String;
    //   220: putfield 160	com/tencent/mobileqq/transfile/FMTSrvAddrProvider$PttIpList:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   223: aload 9
    //   225: astore 8
    //   227: aload 10
    //   229: astore 9
    ...
    //   250: astore 11
    //   252: aload 8
    //   254: invokevirtual 769	java/io/ByteArrayInputStream:close	()V
    //   257: aload 9
    //   259: ifnull +24 -> 283
    //   262: aload 9
    //   264: astore 13
    ...
    //   276: astore 11
    //   278: aload 9
    //   280: invokevirtual 770	java/io/DataInputStream:close	()V
    //   283: iload_2
    //   284: iconst_1
    //   285: iadd
    //   286: istore_2
    ...
    //   309: new 758	java/io/ByteArrayInputStream
    //   312: dup
    //   313: aload_1
    //   314: iload_3
    //   315: iload 6
    //   317: invokespecial 760	java/io/ByteArrayInputStream:<init>	([BII)V
    //   320: astore 9
    //   322: new 762	java/io/DataInputStream
    //   325: dup
    //   326: aload 9
    //   328: invokespecial 765	java/io/DataInputStream:<init>	(Ljava/io/InputStream;)V
    //   331: astore 10
    //   333: aload 15
    //   335: aload 10
    //   337: invokevirtual 768	java/io/DataInputStream:readUTF	()Ljava/lang/String;
    //   340: putfield 172	com/tencent/mobileqq/transfile/FMTSrvAddrProvider$PttIpList:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   343: new 758	java/io/ByteArrayInputStream
    //   346: dup
    //   347: aload_1
    //   348: iload_3
    //   349: iload 6
    //   351: invokespecial 760	java/io/ByteArrayInputStream:<init>	([BII)V
    //   354: astore 12
    //   356: new 762	java/io/DataInputStream
    //   359: dup
    //   360: aload 12
    //   362: invokespecial 765	java/io/DataInputStream:<init>	(Ljava/io/InputStream;)V
    //   365: astore 9
    //   367: aload 9
    //   369: astore 13
    //   371: aload 12
    ...
    //   381: astore 11
    //   383: aload 15
    //   385: getfield 773	com/tencent/mobileqq/transfile/FMTSrvAddrProvider$PttIpList:jdField_b_of_type_ArrayOfInt	[I
    //   388: iconst_0
    //   389: aload 9
    //   391: invokevirtual 776	java/io/DataInputStream:readInt	()I
    //   394: iastore
    //   395: aload 9
    //   397: astore 13
    //   399: aload 12
    ...
    //   409: astore 11
    //   411: aload 15
    //   413: getfield 773	com/tencent/mobileqq/transfile/FMTSrvAddrProvider$PttIpList:jdField_b_of_type_ArrayOfInt	[I
    //   416: iconst_1
    //   417: aload 9
    //   419: invokevirtual 776	java/io/DataInputStream:readInt	()I
    //   422: iastore
    //   423: aload 12
    //   425: astore 8
    //   427: goto -196 -> 231
    ...
    //   444: astore 11
    //   446: aload 9
    //   448: invokevirtual 206	java/lang/Throwable:printStackTrace	()V
    //   451: aload_1
    //   452: astore 10
    //   454: aload 8
    //   456: astore 11
    //   458: new 75	com/tencent/mobileqq/transfile/FMTSrvAddrProvider$PttIpList
    //   461: dup
    //   462: invokespecial 76	com/tencent/mobileqq/transfile/FMTSrvAddrProvider$PttIpList:<init>	()V
    //   465: astore 12
    //   467: aload 8
    //   469: ifnull +8 -> 477
    //   472: aload 8
    //   474: invokevirtual 769	java/io/ByteArrayInputStream:close	()V
    //   477: aload 12
    //   479: astore 9
    //   481: aload_1
    //   482: ifnull -444 -> 38
    //   485: aload_1
    //   486: invokevirtual 770	java/io/DataInputStream:close	()V
    //   489: aload 12
    //   491: areturn
    //   492: astore_1
    //   493: aload 12
    ...
    //   508: new 758	java/io/ByteArrayInputStream
    //   511: dup
    //   512: aload_1
    //   513: iload_3
    //   514: iload 6
    //   516: invokespecial 760	java/io/ByteArrayInputStream:<init>	([BII)V
    //   519: astore 9
    //   521: new 762	java/io/DataInputStream
    //   524: dup
    //   525: aload 9
    //   527: invokespecial 765	java/io/DataInputStream:<init>	(Ljava/io/InputStream;)V
    //   530: astore 10
    //   532: aload 10
    //   534: invokevirtual 776	java/io/DataInputStream:readInt	()I
    //   537: istore 7
    //   539: aload 10
    //   541: invokevirtual 768	java/io/DataInputStream:readUTF	()Ljava/lang/String;
    //   544: astore 8
    //   546: iload 5
    //   548: iconst_3
    //   549: if_icmpne +34 -> 583
    //   552: aload 15
    //   554: getfield 142	com/tencent/mobileqq/transfile/FMTSrvAddrProvider$PttIpList:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   557: new 178	ConfigPush/FileStorageServerListInfo
    //   560: dup
    //   561: aload 8
    //   563: iload 7
    //   565: invokespecial 777	ConfigPush/FileStorageServerListInfo:<init>	(Ljava/lang/String;I)V
    //   568: invokevirtual 343	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   571: pop
    //   572: aload 9
    //   574: astore 8
    //   576: aload 10
    ...
    //   580: goto -349 -> 231
    //   583: aload 15
    //   585: getfield 151	com/tencent/mobileqq/transfile/FMTSrvAddrProvider$PttIpList:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   588: new 178	ConfigPush/FileStorageServerListInfo
    //   591: dup
    //   592: aload 8
    //   594: iload 7
    //   596: invokespecial 777	ConfigPush/FileStorageServerListInfo:<init>	(Ljava/lang/String;I)V
    //   599: invokevirtual 343	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   602: pop
    //   603: aload 9
    //   605: astore 8
    //   607: aload 10
    ...
    //   628: ifnull +8 -> 636
    //   631: aload 9
    //   633: invokevirtual 769	java/io/ByteArrayInputStream:close	()V
    //   636: aload 8
    //   638: astore 9
    //   640: aload 12
    //   642: ifnull -604 -> 38
    //   645: aload 12
    //   647: invokevirtual 770	java/io/DataInputStream:close	()V
    //   650: aload 8
    //   652: areturn
    //   653: astore_1
    //   654: aload 8
    ...
    //   668: ifnull +8 -> 676
    //   671: aload 9
    //   673: invokevirtual 769	java/io/ByteArrayInputStream:close	()V
    //   676: aload 8
    //   678: ifnull +8 -> 686
    //   681: aload 8
    //   683: invokevirtual 770	java/io/DataInputStream:close	()V
    //   686: aload_1
    //   687: athrow
    //   688: astore 8
    //   690: goto -4 -> 686
  ...
  public String a()
  {
    ...
    try
    {
      FileStorageServerListInfo localFileStorageServerListInfo = this.jdField_a_of_type_Aipg.a();
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Aipg.a(paramInt, paramString);
    }
  }
  ...
  public byte[] a(long paramLong)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 96	com/tencent/mobileqq/transfile/FMTSrvAddrProvider:jdField_a_of_type_ConfigPushFileStoragePushFSSvcList	LConfigPush/FileStoragePushFSSvcList;
    //   6: ifnull +43 -> 49
    //   9: aload_0
    //   10: getfield 96	com/tencent/mobileqq/transfile/FMTSrvAddrProvider:jdField_a_of_type_ConfigPushFileStoragePushFSSvcList	LConfigPush/FileStoragePushFSSvcList;
    //   13: getfield 317	ConfigPush/FileStoragePushFSSvcList:bigDataChannel	LConfigPush/BigDataChannel;
    //   16: ifnull +33 -> 49
    //   19: aload_0
    //   20: getfield 96	com/tencent/mobileqq/transfile/FMTSrvAddrProvider:jdField_a_of_type_ConfigPushFileStoragePushFSSvcList	LConfigPush/FileStoragePushFSSvcList;
    //   23: getfield 317	ConfigPush/FileStoragePushFSSvcList:bigDataChannel	LConfigPush/BigDataChannel;
    //   26: getfield 834	ConfigPush/BigDataChannel:uSig_Uin	J
    //   29: lload_1
    //   30: lcmp
    //   31: ifne +18 -> 49
    //   34: aload_0
    //   35: getfield 96	com/tencent/mobileqq/transfile/FMTSrvAddrProvider:jdField_a_of_type_ConfigPushFileStoragePushFSSvcList	LConfigPush/FileStoragePushFSSvcList;
    //   38: getfield 317	ConfigPush/FileStoragePushFSSvcList:bigDataChannel	LConfigPush/BigDataChannel;
    //   41: getfield 837	ConfigPush/BigDataChannel:sBigdata_sig_session	[B
    //   44: astore_3
    //   45: aload_0
    //   46: monitorexit
    //   47: aload_3
  ...
  public String b(int paramInt)
  {
    ...
    try
    {
      FileStorageServerListInfo localFileStorageServerListInfo = this.jdField_a_of_type_Aipg.a(paramInt);
      if (localFileStorageServerListInfo != null)
      {
        localObject1 = new StringBuffer(200);
        ((StringBuffer)localObject1).append("http://").append(localFileStorageServerListInfo.sIP);
  ...
  public byte[] b(long paramLong)
  {
    ...
    //   35: getfield 96	com/tencent/mobileqq/transfile/FMTSrvAddrProvider:jdField_a_of_type_ConfigPushFileStoragePushFSSvcList	LConfigPush/FileStoragePushFSSvcList;
    //   38: getfield 317	ConfigPush/FileStoragePushFSSvcList:bigDataChannel	LConfigPush/BigDataChannel;
    //   41: getfield 859	ConfigPush/BigDataChannel:sBigdata_key_session	[B
    //   44: astore_3
    //   45: aload_0
    //   46: monitorexit
    //   47: aload_3
