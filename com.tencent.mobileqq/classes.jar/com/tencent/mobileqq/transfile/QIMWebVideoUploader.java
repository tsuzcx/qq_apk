...
public class QIMWebVideoUploader
{
  ...
  private QIMWebVideoUploader.IQIMWebVideoUpCallback jdField_a_of_type_ComTencentMobileqqTransfileQIMWebVideoUploader$IQIMWebVideoUpCallback;
  ...
  private void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean) {
      StatisticCollector.a(BaseApplication.getContext()).a(null, "QIMWebVideoUploader", true, l, 0L, this.jdField_a_of_type_JavaUtilHashMap, "");
    }
    while (QLog.isColorLevel())
    {
      ...
      StatisticCollector.a(BaseApplication.getContext()).a(null, "QIMWebVideoUploader", false, l, 0L, this.jdField_a_of_type_JavaUtilHashMap, "");
    }
  }
    ...
    if (this.jdField_a_of_type_JavaIoRandomAccessFile == null) {
      try
      {
        ...
        if (this.jdField_a_of_type_JavaIoRandomAccessFile == null)
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqTransfileQIMWebVideoUploader$IQIMWebVideoUpCallback.a(this.jdField_b_of_type_Int, this.e);
          a(false);
          return false;
        }
      }
