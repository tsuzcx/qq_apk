...
public class PreDownloadConstants
{
  ...
  public static final HashMap<Integer, Integer> BUSINESS_PRIORITY = new PreDownloadConstants.3();
  ...
  public static final long SYS_VOLATILITY_COUNT = 6L;
  public static final long TIME_ON_SECOND_IN_MILLI = 60000L;
  public static Set<Integer> sPreDownloadWhiteList = new HashSet();
  
  static
  {
    sPreDownloadWhiteList.add(Integer.valueOf(10088));
    sPreDownloadWhiteList.add(Integer.valueOf(10081));
    sPreDownloadWhiteList.add(Integer.valueOf(10082));
 ...
 * Qualified Name:     com.tencent.mobileqq.transfile.predownload.schedule.PreDownloadConstants
