  ...
  extends BaseHandler
{
  void a(int paramInt, RichProto.RichProtoReq.ReqCommon paramReqCommon, cmd0x388.ReqBody paramReqBody)
  {
    ...
    for (paramInt = i;; paramInt = 2)
    {
      ...
      localGetImgUrlReq.uint32_req_transfer_type.set(paramReqCommon.jdField_c_of_type_Int);
      ...
      while (localIterator.hasNext())
      {
        ...
        if (i == 0)
        {
          ...
          while (i < paramProtoResp.size())
          {
            ...
            localServerAddr.jdField_a_of_type_Int = ((Integer)localList.get(i)).intValue();
        ...
        if (localGetImgUrlRsp.uint32_https_url_flag.has()) {
          ((RichProto.RichProtoResp.PicDownResp)localObject).jdField_a_of_type_Int = localGetImgUrlRsp.uint32_https_url_flag.get();
        }
