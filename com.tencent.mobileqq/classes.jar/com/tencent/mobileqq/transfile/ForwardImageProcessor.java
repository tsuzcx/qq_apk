  ...
  implements IHttpCommunicatorListener
{
  ...
  private TransProcessorHandler jdField_a_of_type_ComTencentMobileqqTransfileTransProcessorHandler = new aium(this);
  ...
  private void b()
  {
    ...
    localFileMsg.jdField_b_of_type_Int = 1;
    localFileMsg.jdField_b_of_type_Long = this.jdField_a_of_type_Long;
    ...
    if ((this.jdField_a_of_type_Int == 1) || (this.jdField_a_of_type_Int == 1001) || (this.jdField_a_of_type_Int == 10002) || (this.jdField_a_of_type_Int == 3000))
    {
      ...
      for (long l = AppSetting.d;; l = 19922944L)
      {
        ...
        if (new File(this.c).length() > i)
        {
          ...
          this.c = ImageUtil.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getBaseContext(), this.c, i);
        }
