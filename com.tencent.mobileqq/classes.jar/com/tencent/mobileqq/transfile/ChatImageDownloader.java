  ...
  implements ProtocolDownloaderConstants
{
  ...
  private ChatImageDownloader.DownloadData a(DownloadParams paramDownloadParams)
  {
    ...
    if ((paramDownloadParams.tag != null) && ((paramDownloadParams.tag instanceof PicUiInterface)))
    {
      ...
      a(localDownloadData, "getDownloadData", "uuid:" + localDownloadData.jdField_a_of_type_ComTencentMobileqqPicPicDownloadInfo.g + ",md5：" + localDownloadData.jdField_a_of_type_ComTencentMobileqqPicPicDownloadInfo.f);
      ...
      if (localDownloadData.jdField_a_of_type_ComTencentMobileqqPicPicDownloadInfo.jdField_e_of_type_Int == 1) {
        bool = true;
      }
      ...
      if (((PicUiInterface)localObject).isSendFromLocal())
      {
        ...
        if (localDownloadData.jdField_a_of_type_ComTencentMobileqqPicPicUploadInfo.jdField_c_of_type_Int != TranDbRecord.PicDbRecord.f) {
          break label427;
        }
  ...
  public static void a(MessageRecord paramMessageRecord)
  {
    for (int i = 0;; i = 1) {
      try
      {
        ...
        if (((TranDbRecord.PicDbRecord)localObject).jdField_a_of_type_Int == 1)
        {
          String str2 = ((TranDbRecord.PicDbRecord)localObject).jdField_b_of_type_JavaLangString;
          localObject = ((TranDbRecord.PicDbRecord)localObject).jdField_c_of_type_JavaLangString;
  ...
  TransferResult a(ChatImageDownloader.DownloadData paramDownloadData)
  {
    ...
    try
    {
      ...
      paramDownloadData.jdField_a_of_type_ComTencentMobileqqPicPicDownloadInfo.jdField_e_of_type_JavaLangString = paramDownloadData.jdField_a_of_type_JavaNetURL.getProtocol();
  ...
  public File a(OutputStream paramOutputStream, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    int j;
    if (localTransferResult.jdField_a_of_type_Int == 0)
    {
      j = 1;
      if (j == 0) {
        break label382;
