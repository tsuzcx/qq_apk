  ...
  extends AbsDownloader
{
  ...
  public java.lang.Object decodeFile(File paramFile, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    //   24: aload_2
    //   25: getfield 52	com/tencent/image/DownloadParams:url	Ljava/net/URL;
    //   28: invokevirtual 55	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   31: ldc 174
    //   33: invokevirtual 46	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   36: aload_1
    //   37: invokevirtual 177	java/io/File:getAbsolutePath	()Ljava/lang/String;
    ...
    //   46: invokestatic 63	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   49: ldc 179
    //   51: aload_2
    //   52: getfield 52	com/tencent/image/DownloadParams:url	Ljava/net/URL;
    //   55: invokevirtual 68	java/net/URL:getProtocol	()Ljava/lang/String;
    //   58: invokevirtual 124	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   61: ifeq +155 -> 216
    //   64: new 13	android/graphics/BitmapFactory$Options
    //   67: dup
    //   68: invokespecial 180	android/graphics/BitmapFactory$Options:<init>	()V
    //   71: astore 6
    //   73: aload 6
    //   75: iconst_1
    //   76: putfield 184	android/graphics/BitmapFactory$Options:inJustDecodeBounds	Z
    //   79: aload_1
    //   80: invokevirtual 177	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   83: aload 6
    //   85: invokestatic 189	android/graphics/BitmapFactory:decodeFile	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   88: pop
    //   89: aload 6
    //   91: aload 6
    //   93: sipush 160
    //   96: sipush 160
    //   99: invokestatic 191	com/tencent/mobileqq/transfile/ProfileImgDownloader:a	(Landroid/graphics/BitmapFactory$Options;II)I
    //   102: putfield 194	android/graphics/BitmapFactory$Options:inSampleSize	I
    //   105: aload 6
    //   107: iconst_0
    //   108: putfield 184	android/graphics/BitmapFactory$Options:inJustDecodeBounds	Z
    //   111: new 196	java/io/BufferedInputStream
    //   114: dup
    //   115: new 198	java/io/FileInputStream
    //   118: dup
    //   119: aload_1
    //   120: invokevirtual 177	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   123: invokespecial 199	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   126: invokespecial 202	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   129: astore 5
    //   131: aload 5
    //   133: astore 4
    //   135: aload 5
    //   137: aconst_null
    //   138: aload 6
    //   140: invokestatic 206	android/graphics/BitmapFactory:decodeStream	(Ljava/io/InputStream;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   143: astore 6
    //   145: aload 5
    //   147: ifnull +8 -> 155
    //   150: aload 5
    ...
    //   163: aload 5
    //   165: astore 4
    //   167: invokestatic 35	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   170: ifeq +36 -> 206
    //   173: aload 5
    //   175: astore 4
    //   177: ldc 37
    //   179: iconst_2
    //   180: new 39	java/lang/StringBuilder
    //   183: dup
    //   184: invokespecial 40	java/lang/StringBuilder:<init>	()V
    //   187: ldc 213
    //   189: invokevirtual 46	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   192: aload 6
    //   194: invokevirtual 216	java/lang/OutOfMemoryError:getMessage	()Ljava/lang/String;
    //   197: invokevirtual 46	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   200: invokevirtual 59	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   203: invokestatic 219	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   206: aload 5
    //   208: ifnull +8 -> 216
    //   211: aload 5
    //   213: invokevirtual 211	java/io/InputStream:close	()V
    //   216: aload_0
    //   217: aload_1
    //   218: aload_2
    //   219: aload_3
    //   220: invokespecial 221	com/tencent/mobileqq/transfile/AbsDownloader:decodeFile	(Ljava/io/File;Lcom/tencent/image/DownloadParams;Lcom/tencent/image/URLDrawableHandler;)Ljava/lang/Object;
    //   223: areturn
    //   224: astore_1
    //   225: aload 4
    //   227: astore_2
    ...
    //   229: ifnull +7 -> 236
    //   232: aload_2
    //   233: invokevirtual 211	java/io/InputStream:close	()V
    //   236: aload_1
    //   237: athrow
    //   238: astore_1
    //   239: aload 6
