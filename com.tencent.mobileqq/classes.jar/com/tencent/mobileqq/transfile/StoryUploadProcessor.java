  ...
  extends BaseUploadProcessor
{
  ...
  {
    Bosses.get().postLightWeightJob(new aidt(), 0);
  }
  ...
  public void al_()
  {
    ...
    aids localaids = new aids(this, SystemClock.uptimeMillis());
    int i = -1;
    if (this.jdField_a_of_type_ComTencentMobileqqTransfileFileMsg.jdField_b_of_type_Int == 196610)
    {
      i = 34;
      ...
      localReqStoryPic.version.set(ByteStringMicro.copyFromUtf8("7.6.0"));
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction = new Transaction(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), i, this.jdField_a_of_type_ComTencentMobileqqTransfileTransferRequest.i, (int)this.r, this.jdField_a_of_type_ArrayOfByte, localaids, this.jdField_a_of_type_ComTencentMobileqqTransfileFileMsg.jdField_a_of_type_ArrayOfByte, false);
