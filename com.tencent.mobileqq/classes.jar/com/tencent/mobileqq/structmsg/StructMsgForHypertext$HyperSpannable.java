  ...
  extends URLSpan
{
  ...
  private azrk jdField_a_of_type_Azrk;
  
  public StructMsgForHypertext$HyperSpannable(StructMsgForHypertext paramStructMsgForHypertext, azrk paramazrk)
  {
    super(paramazrk.b);
    this.jdField_a_of_type_Azrk = paramazrk;
  }
  ...
  public void onClick(View paramView)
  {
    ...
    } while ((this.jdField_a_of_type_Azrk == null) || ((paramView != null) && ((paramView instanceof StructMsgForHypertext.HyperTextView)) && (!((StructMsgForHypertext.HyperTextView)paramView).a())));
    label196:
    int m;
    int j;
    int i;
    int k;
    Object localObject1;
    if (("web".equals(this.jdField_a_of_type_Azrk.b)) || ("auto".equals(this.jdField_a_of_type_Azrk.b)) || ("replyMsg".equals(this.jdField_a_of_type_Azrk.b)) || ("replyCmd".equals(this.jdField_a_of_type_Azrk.b)) || ("plugin".equals(this.jdField_a_of_type_Azrk.b)))
    {
      new azqq(null, paramView, this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForHypertext.message).a(this.jdField_a_of_type_Azrk.b, this.jdField_a_of_type_Azrk.a, this.jdField_a_of_type_Azrk.c, this.jdField_a_of_type_Azrk.d, this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForHypertext.message.msgseq, new Object[0]);
      ...
      i = 0;
      k = 0;
      if (TextUtils.isEmpty(this.jdField_a_of_type_Azrk.f)) {
        break label1170;
      }
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForHypertext.message.getExtInfoFromExtStr(StructMsgForHypertext.access$000(this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForHypertext) + this.jdField_a_of_type_Azrk.f);
      j = m;
    }
    for (;;)
    {
      try
      {
        ...
        j = i;
        if (!TextUtils.isEmpty(this.jdField_a_of_type_Azrk.g))
        {
          j = i;
          k = Integer.valueOf(this.jdField_a_of_type_Azrk.g).intValue();
        }
        if (((i != 0) && (i >= k)) || (TextUtils.isEmpty(this.jdField_a_of_type_Azrk.b))) {
          break;
        }
        ...
        ((bfua)paramView.getManager(165)).a(this.jdField_a_of_type_Azrk.b, this.jdField_a_of_type_Azrk.d, this.jdField_a_of_type_Azrk.c, this.jdField_a_of_type_Azrk.a, 1, "");
        if (!TextUtils.isEmpty(this.jdField_a_of_type_Azrk.f))
        {
          i += 1;
          if (i <= k)
          {
            this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForHypertext.message.saveExtInfoToExtStr(StructMsgForHypertext.access$000(this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForHypertext) + this.jdField_a_of_type_Azrk.f, "" + i);
      ...
      if (!"app".equals(this.jdField_a_of_type_Azrk.b)) {
        break label196;
      }
      ...
      try
      {
        if (!TextUtils.isEmpty(this.jdField_a_of_type_Azrk.d)) {
          continue;
        }
        localObject3 = localObject1;
        localObject2 = this.jdField_a_of_type_Azrk.c;
        localObject3 = localObject1;
      ...
      catch (Exception localException)
      {
        ...
        azmj.b(null, "P_CliOper", "Pb_account_lifeservice", "", "aio_msg_url", "aio_url_clickqq", 0, 1, 0, (String)localObject3, "", "", "");
        continue;
        ...
        localContext.startActivity((Intent)localObject2);
        localObject3 = localIntent;
        azmj.b(null, "P_CliOper", "Pb_account_lifeservice", "", "aio_msg_url", "aio_url_clickqq", 0, 1, 0, localIntent, "", "", "");
        continue;
      }
      this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForHypertext.mHyperClick = true;
      break label196;
      break;
      localObject3 = localObject1;
      localObject2 = this.jdField_a_of_type_Azrk.d;
      continue;
      localObject3 = localObject1;
