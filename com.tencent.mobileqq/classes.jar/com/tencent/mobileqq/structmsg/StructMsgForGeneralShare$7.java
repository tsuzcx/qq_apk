...
class StructMsgForGeneralShare$7
  implements View.OnClickListener
{
  StructMsgForGeneralShare$7(StructMsgForGeneralShare paramStructMsgForGeneralShare, Context paramContext, Resources paramResources, PopupWindow paramPopupWindow) {}
  ...
  public void onClick(View paramView)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetPopupWindow.setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130847467));
    ...
    for (;;)
    {
      ((EcshopAdHandler)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getBusinessHandler(BusinessHandlerFactory.ESHOP_AD_HANDLER)).a(9, this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForGeneralShare.message);
      ...
      this.jdField_a_of_type_AndroidWidgetPopupWindow.setOnDismissListener(new StructMsgForGeneralShare.7.1(this));
      break;
      label269:
      this.jdField_a_of_type_AndroidWidgetPopupWindow.setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130847466));
 ...
 * Qualified Name:     com.tencent.mobileqq.structmsg.StructMsgForGeneralShare.7
