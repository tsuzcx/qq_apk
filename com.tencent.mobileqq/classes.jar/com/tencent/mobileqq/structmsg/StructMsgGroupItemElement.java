  ...
  extends AbsStructMsgElement
{
  ...
  private View a(View paramView)
  {
    ...
    ((ImageView)localObject).setImageResource(2130844589);
    int i = AIOUtils.a(9.0F, paramView.getResources());
    LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(AIOUtils.a(8.0F, paramView.getResources()), i);
    localLayoutParams.leftMargin = AIOUtils.a(24.0F, paramView.getResources());
    localLayoutParams.rightMargin = AIOUtils.a(4.0F, paramView.getResources());
    localLinearLayout.addView((View)localObject, localLayoutParams);
    paramView.setPadding(0, 0, 0, 0);
    localObject = paramView.findViewById(2131380624);
    if (localObject != null) {
  ...
  private void a(Resources paramResources, ImageView paramImageView)
  {
    ...
    {
      paramImageView.setBackgroundResource(2130844588);
      return;
    }
    paramImageView.setBackgroundResource(2130844587);
  }
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if ((paramView != null) && ((paramView instanceof LinearLayout)))
    {
      ...
      localObject2 = (AbsStructMsgElement)this.jdField_a_of_type_JavaUtilList.get(i);
      paramView = ((AbsStructMsgElement)localObject2).jdField_a_of_type_JavaLangString;
      if (!"summary".equals(paramView)) {
        break label334;
      }
      paramView = new LinearLayout(paramContext);
      paramView.setId(2131378562);
      paramView.setOrientation(0);
      localObject1 = new LinearLayout.LayoutParams(-1, AIOUtils.a(42.0F, localResources));
      ((LinearLayout.LayoutParams)localObject1).leftMargin = AIOUtils.a(13.0F, localResources);
      ((LinearLayout.LayoutParams)localObject1).rightMargin = AIOUtils.a(13.0F, localResources);
      ((LinearLayout.LayoutParams)localObject1).topMargin = 0;
      ((LinearLayout.LayoutParams)localObject1).bottomMargin = 0;
      localObject3 = (LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131378563);
      ...
      ((ImageView)localObject1).setId(2131378561);
    ...
    do
    {
      for (;;)
      {
        ...
        ((LinearLayout.LayoutParams)localObject1).topMargin = 0;
        ((LinearLayout.LayoutParams)localObject1).bottomMargin = 0;
        localObject2 = (LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131378563);
    ...
    label430:
    Object localObject1 = (LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131378563);
    paramView = (View)localObject1;
    if (localObject1 == null)
    {
      paramView = new LinearLayout(paramContext);
      paramView.setOrientation(1);
      paramView.setId(2131378563);
      if (!this.jdField_a_of_type_Boolean) {
        break label646;
      }
    ...
    for (;;)
    {
      ...
      paramView.setBackgroundColor(localResources.getColor(2131167214));
      ((LinearLayout.LayoutParams)localObject1).leftMargin = 0;
      ((LinearLayout.LayoutParams)localObject1).rightMargin = 0;
      ((LinearLayout.LayoutParams)localObject1).topMargin = 0;
      ((LinearLayout.LayoutParams)localObject1).bottomMargin = 0;
      ...
      localObject2 = new LinearLayout.LayoutParams(-1, AIOUtils.a(48.0F, localResources));
      ((LinearLayout.LayoutParams)localObject2).gravity = 16;
      paramView.addView((View)localObject1, (ViewGroup.LayoutParams)localObject2);
      this.o += 1;
      break;
  ...
  public void a()
  {
    ...
    {
      return;
      localLinearLayout = (LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131378563);
    } while (localLinearLayout == null);
    localLinearLayout.setVisibility(8);
    this.jdField_a_of_type_Boolean = false;
    a(this.jdField_a_of_type_AndroidContentContext.getResources(), (ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131378561));
  }
  ...
  public void b()
  {
    ...
    {
      return;
      localObject1 = (LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131378563);
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      for (;;)
      {
        ...
        localObject2 = (QidianHandler)((QQAppInterface)localObject3).getBusinessHandler(BusinessHandlerFactory.QIDIAN_HANDLER);
