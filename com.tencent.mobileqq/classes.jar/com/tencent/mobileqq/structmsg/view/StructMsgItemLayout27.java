  ...
  extends AbsStructMsgItem
{
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if ((paramView != null) && ((paramView instanceof LinearLayout)))
    {
      ...
      localLinearLayout.setId(2131371148);
      localBubbleViewLayout = new BubbleViewLayout(paramContext);
      localBubbleViewLayout.setId(2131371147);
      ...
      ((RelativeLayout)localObject3).setId(2131371141);
      ...
      ((RelativeLayout)localObject3).setBackgroundResource(2130844864);
      ...
      i = localResources.getDimensionPixelSize(2131296914);
      j = localResources.getDimensionPixelSize(2131296470);
      if (!bool) {
        break label673;
      }
    ...
    for (;;)
    {
      ...
      ((RelativeLayout.LayoutParams)localObject5).addRule(3, 2131371141);
      ...
      ((TextView)localObject2).setBackgroundColor(localResources.getColor(2131167374));
      ...
      break;
      label439:
      localBubbleViewLayout.setLayoutParams(new LinearLayout.LayoutParams(BaseChatItemLayout.e - AIOUtils.a(20.0F, localResources), -2));
      break label101;
      label467:
      ((RelativeLayout)localObject3).setBackgroundResource(2130844865);
      break label203;
      label477:
      if (bool)
      {
        ...
        ((RelativeLayout.LayoutParams)localObject4).addRule(0, 2131371141);
        paramView.setLayoutParams((ViewGroup.LayoutParams)localObject4);
        paramView.setId(2131374502);
        ...
        ((RelativeLayout)localObject3).setBackgroundResource(2130844857);
        paramView.setImageDrawable(localResources.getDrawable(2130844860));
      }
      for (;;)
      {
        label536:
        ...
        ((RelativeLayout.LayoutParams)localObject4).addRule(1, 2131371141);
        break label536;
        label652:
        ((RelativeLayout)localObject3).setBackgroundResource(2130844858);
        paramView.setImageDrawable(localResources.getDrawable(2130844859));
      }
      label673:
      ((RelativeLayout.LayoutParams)localObject5).setMargins(0, 0, 0, 0);
    }
    ...
    for (;;)
    {
      try
      {
        ...
        ((TextView)localObject5).setId(2131379336);
        ...
        if (this.o == 1)
        {
          ((TextView)localObject5).setTextColor(localResources.getColor(2131165280));
        }
        else
        {
      ...
      if (("head".equals(localObject5)) && ((localException instanceof StructMsgItemAvatar)))
      {
        ...
        if (BaseApplicationImpl.sApplication.getRuntime().getAccount().equalsIgnoreCase(((StructMsgItemAvatar)localException).ac))
        {
        ...
        localRelativeLayout.setId(2131363235);
        ...
        {
          paramBundle.addRule(3, 2131379336);
          ...
          ((RelativeLayout.LayoutParams)localObject1).addRule(1, 2131377757);
          ((RelativeLayout.LayoutParams)localObject1).leftMargin = AIOUtils.a(15.0F, localResources);
          paramBundle = paramView;
          if (paramView == null) {
            paramBundle = new LinearLayout(paramContext);
          }
          paramBundle.setId(2131367564);
