  ...
  extends AbsStructMsgItem
{
  ...
  View a(View paramView, Context paramContext, String paramString)
  {
    ...
    try
    {
      ...
      if (paramView == null)
      {
        ahuy localahuy1 = new ahuy(this);
        paramView = View.inflate(paramContext, 2130970896, null);
        localahuy1.jdField_a_of_type_ComTencentWidgetSingleLineTextView = ((SingleLineTextView)paramView.findViewById(2131362736));
        localahuy1.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131362701));
        localahuy1.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131365272));
        localahuy1.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131362709);
        paramView.setTag(localahuy1);
        localahuy1.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setText(paramString);
        if (i != 1) {
          break label331;
        }
        localahuy1.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
        localahuy1.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setTextColor(Color.parseColor("#777777"));
        localahuy1.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setTextSize(14.0F);
        localahuy1.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setCompoundDrawables(null, null);
        localahuy1.jdField_a_of_type_AndroidWidgetTextView.setText(this.w);
        localahuy1.jdField_a_of_type_AndroidWidgetTextView.setEnabled(true);
        localahuy1.jdField_a_of_type_AndroidWidgetTextView.setBackgroundDrawable(paramContext.getResources().getDrawable(2130838518));
        paramView.setTag(2131362185, this.b);
        localahuy1.jdField_a_of_type_AndroidWidgetTextView.setTag(2131362185, this.b);
        i = AIOUtils.a(17.0F, paramContext.getResources());
        int j = AIOUtils.a(16.0F, paramContext.getResources());
        localahuy1.jdField_a_of_type_AndroidWidgetTextView.setPadding(j, 0, j, 0);
        localahuy1.jdField_a_of_type_AndroidWidgetTextView.post(new ahux(this, i, localahuy1));
        paramView.setOnClickListener(this);
        localahuy1.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
        return paramView;
      }
    }
    catch (Exception localException)
    {
      ...
      do
      {
        for (;;)
        {
          ...
          i = 0;
          continue;
          localahuy2 = (ahuy)paramView.getTag();
        }
      } while (i != 0);
      localahuy2.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      paramString = paramContext.getResources().getDrawable(2130839128);
    ...
    localahuy2.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(paramString);
    label446:
    if (this.jdField_a_of_type_Boolean)
    {
      paramString = paramContext.getResources().getDrawable(2130839745);
      localahuy2.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setCompoundDrawablePadding(AIOUtils.a(3.0F, paramContext.getResources()));
      paramString.setBounds(0, 0, AIOUtils.a(15.0F, paramContext.getResources()), AIOUtils.a(15.0F, paramContext.getResources()));
      localahuy2.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setCompoundDrawables(null, paramString);
      localahuy2.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setTextColor(Color.parseColor("#000000"));
      localahuy2.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setTextSize(17.0F);
      localahuy2.jdField_a_of_type_AndroidWidgetTextView.setTag(localahuy2);
      if (!((PublicAccountDataManager)((BaseActivity)paramContext).app.getManager(55)).a(Long.valueOf(Long.parseLong(this.x)))) {
        break label661;
      }
      localahuy2.jdField_a_of_type_AndroidWidgetTextView.setBackgroundDrawable(null);
      localahuy2.jdField_a_of_type_AndroidWidgetTextView.setText("已关注");
      localahuy2.jdField_a_of_type_AndroidWidgetTextView.setEnabled(false);
    }
    for (;;)
    {
      label514:
      paramView.setTag(2131362184, this.x);
      localahuy2.jdField_a_of_type_AndroidWidgetTextView.setTag(2131362184, this.x);
      break;
      label636:
      localahuy2.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(paramString);
      break label446;
      localahuy2.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setCompoundDrawables(null, null);
      break label514;
      label661:
      localahuy2.jdField_a_of_type_AndroidWidgetTextView.setBackgroundDrawable(paramContext.getResources().getDrawable(2130838518));
      localahuy2.jdField_a_of_type_AndroidWidgetTextView.setText("关注");
      localahuy2.jdField_a_of_type_AndroidWidgetTextView.setEnabled(true);
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    //   300: checkcast 29	ahuy
    //   303: astore_1
    //   304: aload_1
    //   305: getfield 61	ahuy:jdField_a_of_type_AndroidWidgetTextView	Landroid/widget/TextView;
    //   308: iconst_4
    //   309: invokevirtual 500	android/widget/TextView:setVisibility	(I)V
    //   312: aload_1
    //   313: getfield 65	ahuy:jdField_a_of_type_AndroidViewView	Landroid/view/View;
    //   316: iconst_0
    ...
    //   329: aload_0
    //   330: aload_1
    //   331: invokespecial 506	ahuz:<init>	(Lcom/tencent/mobileqq/structmsg/view/StructMsgItemLayout20;Lahuy;)V
    //   334: iconst_1
    //   335: iconst_3
