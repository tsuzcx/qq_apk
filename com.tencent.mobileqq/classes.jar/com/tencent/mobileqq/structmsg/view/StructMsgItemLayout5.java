  ...
  extends AbsStructMsgItem
{
  ...
  private RelativeLayout a(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    ...
    try
    {
      ...
      ((URLDrawable.URLDrawableOptions)localObject1).mRequestWidth = AIOUtils.a(70.0F, localResources);
      ((URLDrawable.URLDrawableOptions)localObject1).mRequestHeight = AIOUtils.a(70.0F, localResources);
      localObject1 = URLDrawable.getDrawable(paramString1, (URLDrawable.URLDrawableOptions)localObject1);
      localAnyScaleTypeImageView.setId(2131368729);
  ...
  private RelativeLayout a(Context paramContext, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      k = localResources.getDimensionPixelSize(2131296463);
      if (!a(1)) {
        break label147;
      }
    ...
    for (;;)
    {
      ...
      return paramContext;
      j = localResources.getDimensionPixelSize(2131299069);
      break;
      label135:
      k = localResources.getDimensionPixelSize(2131299070);
      break label63;
      label147:
    ...
    if (((Bundle)localObject3).getBoolean("pre_dialog") == true)
    {
      ...
      if (((Iterator)localObject5).hasNext())
      {
        ...
        if ((localObject4 instanceof StructMsgItemVideo))
        {
          ...
          localObject2 = ((StructMsgItemVideo)localObject4).ac;
          localObject4 = ((StructMsgItemVideo)localObject4).ag;
    ...
    for (;;)
    {
      ...
      if ((localObject4 instanceof StructMsgItemTitle))
      {
        ...
        if (((Bundle)localObject3).getInt("accostType") == AbsStructMsg.SOURCE_ACCOUNT_TYPE_PA)
        {
          ...
          paramView.setBackgroundColor(paramContext.getResources().getColor(2131165293));
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            ...
            if ("picture".equals(str))
            {
              ...
              localObject4 = ((View)localObject1).findViewById(2131368907);
              if ((localObject4 != null) && ((localObject4 instanceof AnyScaleTypeImageView))) {
                ((AnyScaleTypeImageView)localObject4).setTag(2131373654, Integer.valueOf(1));
              }
              k = i;
            ...
            else
            {
              if ("video".equals(str))
              {
                ...
                if (localObject1 != null)
                {
                  ...
                  i = ((Resources)localObject5).getDimensionPixelSize(2131296462);
                ...
                for (k = (int)(i / 1.8F);; k = m)
                {
                  ...
                  for (;;)
                  {
                    ...
                    if ((j != 0) && (!TextUtils.isEmpty(paramBundle)) && ((localObject1 instanceof TitledImageView)))
                    {
                      ...
                      ((TitledImageView)localObject3).setTextBackground(paramContext.getResources().getColor(2131165293));
                    ...
                    {
                      paramContext = ((View)localObject1).getTag(2131378571);
                    ...
                    ((RelativeLayout)localObject2).setId(2131378568);
                    return localObject2;
                    i = ((Resources)localObject5).getDimensionPixelSize(2131299069);
                    break;
                  }
                  i = k - i * 2;
                  break label960;
