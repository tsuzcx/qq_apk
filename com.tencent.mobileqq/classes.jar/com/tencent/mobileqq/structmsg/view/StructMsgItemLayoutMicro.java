  ...
  extends AbsStructMsgItem
{
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if (paramView == null)
    {
      ...
      StructMsgItemLayoutMicro.MiniAppMsgViewHolder localMiniAppMsgViewHolder = new StructMsgItemLayoutMicro.MiniAppMsgViewHolder(null);
      paramBundle.setTag(2131375335, localMiniAppMsgViewHolder);
      ...
      if (paramView == null)
      {
        ...
        paramContext.setCompoundDrawablePadding(AIOUtils.a(5.0F, localResources));
        localObject = localResources.getDrawable(2130847700);
        ((Drawable)localObject).setBounds(0, 0, AIOUtils.a(18.0F, localResources), AIOUtils.a(10.0F, localResources));
        ...
        localMiniAppMsgViewHolder.jdField_a_of_type_AndroidWidgetTextView = paramView;
        localMiniAppMsgViewHolder.b = localTextView;
        localMiniAppMsgViewHolder.jdField_a_of_type_AndroidWidgetImageView = localImageView;
        localMiniAppMsgViewHolder.c = paramContext;
        localMiniAppMsgViewHolder.jdField_a_of_type_AndroidWidgetLinearLayout = paramBundle;
        paramView = localMiniAppMsgViewHolder;
    ...
    for (;;)
    {
      ...
      paramView = (StructMsgItemLayoutMicro.MiniAppMsgViewHolder)paramContext.getTag(2131375335);
      break label443;
      label517:
      paramContext.setPadding(0, 0, 0, 0);
      break label462;
      label528:
      i = AIOUtils.a(24.0F, localResources);
      try
      {
        ...
        paramView.c.setText(HardCodeUtil.a(2131714490));
