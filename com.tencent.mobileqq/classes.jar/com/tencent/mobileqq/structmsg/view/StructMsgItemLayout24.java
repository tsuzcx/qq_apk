  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        {
          localObject3 = ((StructMsgItemCover)localObject3).a(paramContext, ((StructMsgItemLayout24.ViewHolder)localObject1).jdField_a_of_type_AndroidViewView, true, paramBundle);
          i = AIOUtils.b(30.0F, paramContext.getResources());
          paramView.addView((View)localObject3, new RelativeLayout.LayoutParams(i, i));
          ((StructMsgItemLayout24.ViewHolder)localObject1).jdField_a_of_type_AndroidViewView = ((View)localObject3);
          ((View)localObject3).setVisibility(0);
          i = 1;
        }
        else if ("title".equals(((AbsStructMsgElement)localObject3).a))
        {
          localObject3 = (TextView)((AbsStructMsgElement)localObject3).a(paramContext, ((StructMsgItemLayout24.ViewHolder)localObject1).jdField_a_of_type_AndroidWidgetTextView, paramBundle);
          ...
          ((StructMsgItemLayout24.ViewHolder)localObject1).jdField_a_of_type_AndroidWidgetTextView = ((TextView)localObject3);
          ((TextView)localObject3).setVisibility(0);
        }
        else if ("summary".equals(((AbsStructMsgElement)localObject3).a))
        {
          ((StructMsgItemSummary)localObject3).b(2147483647);
      ...
      if ((i != 0) && (((StructMsgItemLayout24.ViewHolder)localObject1).jdField_a_of_type_AndroidWidgetTextView != null)) {
        ((RelativeLayout.LayoutParams)((StructMsgItemLayout24.ViewHolder)localObject1).jdField_a_of_type_AndroidWidgetTextView.getLayoutParams()).leftMargin = AIOUtils.b(38.0F, paramContext.getResources());
      }
