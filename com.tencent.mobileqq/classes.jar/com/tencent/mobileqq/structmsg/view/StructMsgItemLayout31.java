  ...
  extends AbsStructMsgItem
{
  ...
  private LinearLayout a(Context paramContext, RelativeLayout paramRelativeLayout)
  {
    ...
    localLayoutParams.addRule(8, 2131374856);
  ...
  private RelativeLayout a(Context paramContext)
  {
    ...
    Object localObject = new RelativeLayout.LayoutParams(-1, ViewUtils.b(74.0F));
  ...
  private TextView a(Context paramContext, RelativeLayout paramRelativeLayout)
  {
    ...
    localTextView.setId(2131374854);
    localTextView.setText(paramContext.getResources().getText(2131716962));
    localTextView.setSingleLine(false);
    localTextView.setMaxLines(2);
    localTextView.setEllipsize(TextUtils.TruncateAt.END);
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, -2);
    localLayoutParams.addRule(1, 2131374856);
    localLayoutParams.addRule(0, 2131374857);
    localLayoutParams.addRule(15);
  ...
  private void a(Context paramContext, RelativeLayout paramRelativeLayout, ImageView paramImageView, LinearLayout paramLinearLayout, TextView paramTextView)
  {
    ...
    Drawable localDrawable = paramContext.getResources().getDrawable(2130847583);
  ...
  private void a(RelativeLayout paramRelativeLayout)
  {
    ...
    paramRelativeLayout.setBackgroundResource(2130838254);
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      {
        this.t = (paramContext.getResources().getDimensionPixelSize(2131299074) - ViewUtils.a(3.0F));
        this.u = (paramContext.getResources().getDimensionPixelSize(2131299075) - ViewUtils.a(3.0F));
