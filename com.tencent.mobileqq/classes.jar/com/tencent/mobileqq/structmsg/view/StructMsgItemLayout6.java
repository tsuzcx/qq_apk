  ...
  extends AbsStructMsgItem
{
  ...
  private LinearLayout a(Context paramContext)
  {
    ...
    paramContext.setPadding(localResources.getDimensionPixelSize(2131299069), 0, localResources.getDimensionPixelSize(2131299070), 0);
  ...
  {
    int k = paramResources.getDimensionPixelSize(2131296462);
    int m = paramResources.getDimensionPixelSize(2131296463);
          ...
          else
          {
            ...
            else
            {
              if (("picture".equals(localObject3)) || ("video".equals(localObject3)))
              {
                ...
                localObject1 = ((View)localObject4).findViewById(2131368907);
                ...
                if (paramBoolean)
                {
                  ...
                  if ((localObject1 instanceof FixRatioPAHighLightImageView))
                  {
                    ...
                    if ((localObject4 != null) && ((localObject4 instanceof PAImageView))) {
                      ((PAImageView)localObject4).setUseRadiusRound(true, paramResources.getDimensionPixelSize(2131296464));
                    }
                  }
                }
                for (;;)
              ...
              {
                localObject1 = ((AbsStructMsgElement)localObject1).a(paramContext, null, paramBundle);
                ((AnyScaleTypeImageView)localObject1).setImageResource(2130841865);
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if (paramBundle.getInt("accostType") == AbsStructMsg.SOURCE_ACCOUNT_TYPE_PA)
    {
      ...
      i = localResources.getDimensionPixelSize(2131299070);
      a(paramView);
      d(paramView);
      if (bool)
      {
        ...
        i = localResources.getDimensionPixelSize(2131296462);
        j = i;
      }
      label104:
