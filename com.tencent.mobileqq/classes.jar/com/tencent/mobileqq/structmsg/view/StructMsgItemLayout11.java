  ...
  extends AbsStructMsgItem
{
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    float f;
    if ((paramView != null) && ((paramView instanceof RelativeLayout)) && ((paramView.getTag() instanceof ahun)))
    {
      localObject1 = (ahun)paramView.getTag();
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        if ("title".equals(localObject4))
        {
          ...
          for (;;)
          {
            ((StructMsgItemTitle)localObject3).a(paramContext, ((ahun)localObject1).b, paramBundle);
            break;
            ((StructMsgItemTitle)localObject3).c(String.valueOf(36));
          }
        }
        if ("pavideo".equals(localObject4)) {
          ((AbsStructMsgElement)localObject3).a(paramContext, ((ahun)localObject1).a, paramBundle);
        }
      }
      if ((localObject1 != null) && (((ahun)localObject1).b != null)) {
        ((TextView)((ahun)localObject1).b).setMaxLines(2);
      }
      return paramView;
    }
    ...
    for (;;)
    {
      ...
      if ("pavideo".equals(str))
      {
        ...
        i = (int)(i * 0.32D);
        paramBundle.setBackgroundResource(2130839743);
        ...
        paramContext.setImageResource(2130839712);
        ...
        if (paramView != null) {
          ((ahun)localObject3).a = paramView;
        }
        if (localObject1 != null)
        {
          ((ahun)localObject3).b = ((View)localObject1);
          ((TextView)((ahun)localObject3).b).setMaxLines(1);
        }
