  ...
  extends AbsStructMsgItem
{
  ...
  private FrameLayout a(Context paramContext)
  {
    ...
    localFrameLayout.setId(2131362107);
    if (AppSetting.b) {
      localFrameLayout.setContentDescription(this.u);
    }
  ...
  public void a()
  {
    ...
    if (((JSONObject)localObject8).has("cMean"))
    {
      ...
      for (i = 0;; i = Integer.valueOf(str5).intValue())
      {
        ...
        localObject9 = ((StructMsgItemCover)localObject10).u;
        str11 = b(str11);
        String str15 = b((String)localObject7);
        localObject7 = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
        Object localObject10 = (FriendsManager)((QQAppInterface)localObject7).getManager(50);
        ...
        if (!bool1)
        {
          ...
          if (j != 0)
          {
            str15 = ContactUtils.l((QQAppInterface)localObject7, str7);
            this.jdField_a_of_type_AndroidOsBundle.putString("sNick", str15);
            if (bool2) {
        ...
        if (!bool2)
        {
          ...
          if (j != 0)
          {
            localObject7 = ContactUtils.l((QQAppInterface)localObject7, str6);
      ...
      if ("summary".equals(str1))
      {
        ...
        for (;;)
        {
          ...
          this.u = ((StringBuilder)localObject5).toString();
      ...
      for (;;)
      {
        if (((Iterator)localObject2).hasNext())
        {
          ...
          if ("title".equals(localObject4))
          {
            ...
            localObject5 = (TextView)((View)localObject4).findViewById(2131361926);
            if (paramView.c == null)
            {
          ...
          else
          {
            ...
            if ("picture".equals(localObject4))
            {
              ...
              if (!((StructMsgItemCover)localObject4).u.startsWith("http://sqimg.qq.com/qq_product_operations/flower/images/aio-msg/android/%s".substring(0, 4))) {
                ((StructMsgItemCover)localObject4).u = String.format("http://sqimg.qq.com/qq_product_operations/flower/images/aio-msg/android/%s", new Object[] { ((StructMsgItemCover)localObject4).u });
              }
