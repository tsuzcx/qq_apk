  ...
  extends AbsStructMsgItem
{
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if (paramView == null)
    {
      localView = LayoutInflater.from(paramContext).inflate(2130969973, null);
      localaioa = new aioa(this);
      localaioa.jdField_a_of_type_ComTencentMobileqqWidgetBubbleImageView = ((BubbleImageView)localView.findViewById(2131368598));
      localaioa.jdField_a_of_type_ComTencentMobileqqWidgetBubbleImageView.setRadius(13.0F);
      localaioa.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131368602));
      localaioa.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131368601));
      localaioa.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131368599));
      localaioa.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131368600));
      localView.setTag(this.i, localaioa);
      ...
      localaioa.jdField_a_of_type_ComTencentMobileqqWidgetBubbleImageView.setImageDrawable(paramBundle);
      ...
      localaioa.jdField_b_of_type_AndroidWidgetTextView.setText(((StructMsgItemTitle)localObject2).A);
      label282:
      ...
      localaioa.c = String.valueOf(((StructMsgForGeneralShare)localObject1).uniseq);
    }
    label346:
    label608:
    for (;;)
    {
      ...
      {
        break label223;
        localaioa = (aioa)paramView.getTag(this.i);
        localView = paramView;
        break;
        ...
        try
        {
          ...
          localaioa.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject2);
          localaioa.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
        }
        catch (Exception localException)
        {
          QLog.e("Q.robot.StructMsg", 1, localException, new Object[0]);
          localaioa.jdField_a_of_type_AndroidWidgetImageView.setVisibility(4);
        }
      }
      break label282;
      ...
      localaioa.jdField_a_of_type_AndroidWidgetTextView.setText(localStructMsgItemVoice.e + "\"");
      break label282;
      localaioa.jdField_a_of_type_JavaLangString = paramView;
      localaioa.jdField_b_of_type_JavaLangString = paramBundle;
      if (RobotResourcesManager.a().c(localaioa.c))
      {
        if (this.jdField_a_of_type_AndroidGraphicsDrawableAnimationDrawable == null) {
          this.jdField_a_of_type_AndroidGraphicsDrawableAnimationDrawable = ((AnimationDrawable)paramContext.getResources().getDrawable(2130841508));
        }
        localaioa.jdField_b_of_type_AndroidWidgetImageView.setImageDrawable(this.jdField_a_of_type_AndroidGraphicsDrawableAnimationDrawable);
        if (!this.jdField_a_of_type_AndroidGraphicsDrawableAnimationDrawable.isRunning()) {
          this.jdField_a_of_type_AndroidGraphicsDrawableAnimationDrawable.start();
        }
        return localView;
      }
      localaioa.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130841507);
      return localView;
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    if ((paramView instanceof aioa))
    {
      paramView = (aioa)paramView;
    ...
    localRobotResourcesManager.a(paramView.jdField_a_of_type_JavaLangString, new ainz(this, str2, str1, paramView));
  }
}
