...
class StructMsgItemVideo$4
  implements View.OnClickListener
{
  StructMsgItemVideo$4(StructMsgItemVideo paramStructMsgItemVideo) {}
  ...
  public void onClick(View paramView)
  {
    ...
    Object localObject1 = paramView.getTag(2131378571);
    if ((localObject1 != null) && ((localObject1 instanceof StructMsgItemVideo.Holder)))
    {
      localObject6 = (StructMsgItemVideo.Holder)localObject1;
    ...
    for (;;)
    {
      ...
      if (this.a.v == 4)
      {
        ...
        {
          StructMsgItemVideo.a(this.a);
          localObject2 = (EcShopAssistantManager)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(QQManagerFactory.EC_SHOP_ASSISTANT_MANAGER);
          if (localObject2 != null) {
            ((EcShopAssistantManager)localObject2).a(this.a, (Activity)localContext);
          }
        }
        else
        {
          ...
          long l1 = l2;
          if (((StructMsgItemVideo.Holder)localObject6).a.getDrawable() != null)
          {
            l1 = l2;
            if ((((StructMsgItemVideo.Holder)localObject6).a.getDrawable() instanceof URLDrawable))
            {
              localObject4 = (URLDrawable)((StructMsgItemVideo.Holder)localObject6).a.getDrawable();
              l1 = l2;
          ...
          localObject4 = (String)paramView.getTag(2131378578);
          if (!TextUtils.isEmpty((CharSequence)localObject4))
          {
            String str = URLUtil.a(URLUtil.a((String)localObject4, "progress", String.valueOf(l1)), "msgId", (String)localObject2);
            ...
            for (;;)
            {
              for (;;)
              {
                ...
                try
                {
                  ...
                  localIntent.putExtra("big_brother_source_key", ((IPublicAccountUtil)QRoute.api(IPublicAccountUtil.class)).getSourceId(this.a.ab));
      ...
      {
        if (ReadInJoyUtils.a(this.a.a))
        {
          bool = StructMsgItemVideo.a(localContext, this.a.a.uinType);
          localObject2 = new StringBuilder().append(this.a.a.mMsgUrl).append("&sourceAutoPlay=");
          if (bool) {}
          for (i = 1;; i = 0)
          {
            ReadInJoyUtils.b(localContext, i);
            break;
          }
        }
        localObject2 = AIOVideoPlayController.a();
        if (!((AIOVideoPlayController)localObject2).a())
        {
        ...
        else if (((AIOVideoPlayController)localObject2).a(localContext, 3, this.a.a.uinType))
        {
          if ((this.a.a instanceof StructMsgForGeneralShare))
          {
            localObject2 = (StructMsgForGeneralShare)this.a.a;
 ...
 * Qualified Name:     com.tencent.mobileqq.structmsg.view.StructMsgItemVideo.4
