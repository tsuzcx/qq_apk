...
public class StructMsgItemButton$3$2
  implements Runnable
{
  public StructMsgItemButton$3$2(bdpu parambdpu, bdpr parambdpr, StructMsgForGeneralShare paramStructMsgForGeneralShare, QQAppInterface paramQQAppInterface, boolean paramBoolean) {}
  ...
  public void run()
  {
    ...
    int j = -1;
    int i = j;
    if (!TextUtils.isEmpty(this.jdField_a_of_type_Bdpr.aa)) {}
    try
    {
      i = Integer.parseInt(this.jdField_a_of_type_Bdpu.jdField_a_of_type_Bdpr.aa);
