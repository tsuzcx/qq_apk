...
{
  private static final String jdField_a_of_type_JavaLangString = InputStatusHelper.class.getSimpleName();
  ...
  private boolean a()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie != null) && ((this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie instanceof LimitChatPie))) {
      return c();
    }
    return b();
  }
  ...
  private boolean d()
  {
    AppRuntime.Status localStatus = this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getOnlineStatus();
  ...
  public void a(String paramString)
  {
    ...
    if (!this.jdField_b_of_type_Boolean) {
      this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.b(this.jdField_b_of_type_Boolean, this.jdField_b_of_type_JavaLangString);
    }
  }
  ...
  void a(boolean paramBoolean, String paramString)
  {
    ...
    for (;;)
    {
      localBaseChatPie.b(paramBoolean, paramString);
      return;
