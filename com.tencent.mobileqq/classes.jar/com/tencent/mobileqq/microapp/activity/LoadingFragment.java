  ...
  implements DialogInterface.OnDismissListener, Handler.Callback, View.OnClickListener, g.d, TbsListener
{
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 2: 
      do
      {
        ...
        this.x5LoadingDialog.a("浏览器组件升级中，进度" + paramMessage.arg1 + "%");
        return false;
        ...
        loadConfig();
        return false;
      } while (!(paramMessage.obj instanceof com.tencent.mobileqq.microapp.apkg.f));
      paramMessage = (com.tencent.mobileqq.microapp.apkg.f)paramMessage.obj;
      p.a().a(getActivity(), paramMessage);
  ...
  {
    return LayoutInflater.from(getActivity()).inflate(R.layout.g, null);
  }
  ...
  {
    paramDialogInterface = (com.tencent.mobileqq.microapp.widget.f)paramDialogInterface;
  ...
  public void onInitApkgInfo(int paramInt, com.tencent.mobileqq.microapp.apkg.f paramf)
  {
    ...
    {
      com.tencent.mobileqq.microapp.appbrand.utils.b.a().a(paramf);
  ...
  public void onViewCreated(View paramView, Bundle paramBundle)
  {
    ...
    new ImmersionBar(getActivity(), 0, paramView.findViewById(R.id.av));
    ...
    this.root = ((RelativeLayout)paramView.findViewById(R.id.as));
    this.mMoreView = ((ImageView)paramView.findViewById(R.id.k));
    this.mCloseView = ((ImageView)paramView.findViewById(R.id.j));
    this.mNameView = ((TextView)paramView.findViewById(R.id.x));
    this.mLogoView = ((ImageView)paramView.findViewById(R.id.af));
    ...
    if (i == 0)
    {
      this.x5LoadingDialog = new bbms(getActivity());
