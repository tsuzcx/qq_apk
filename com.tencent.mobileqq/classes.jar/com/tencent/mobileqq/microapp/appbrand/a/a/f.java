  ...
  extends a
{
  ...
  {
    paramString2 = bbdj.a(new File(paramString2));
  ...
  private boolean a(JSONArray paramJSONArray, String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      return bbdj.a(paramJSONArray, paramString3);
      ...
      for (;;)
      {
        ...
        if ("createDownloadTask".equals(paramString1))
        {
          ...
          if ((!TextUtils.isEmpty((CharSequence)localObject7)) && (this.a.a.c.m((String)localObject7)))
          {
            ...
            localObject7 = new bbwg((String)localObject7, new File((String)localObject6));
            ((bbwg)localObject7).jdField_f_of_type_JavaLangString = "mini_app";
            ((bbwg)localObject7).jdField_f_of_type_Long = 10000L;
            if (localObject2 != null)
            {
              ...
              while (((Iterator)localObject8).hasNext())
              {
                ...
                ((bbwg)localObject7).a(str3, ((JSONObject)localObject2).optString(str3));
              }
            }
            i = localObject7.hashCode();
            ahbh.a().a((bbwg)localObject7, new o(this, (WeakReference)localObject5, i, (String)localObject6), null);
          ...
          if ("getFileInfo".equals(paramString1))
          {
            ...
            for (;;)
            {
              try
              {
                ...
                str1 = nas.a((String)localObject7);
