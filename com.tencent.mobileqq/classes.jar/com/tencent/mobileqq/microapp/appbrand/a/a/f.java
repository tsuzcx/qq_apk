  ...
  extends a
{
  ...
  private boolean a(JSONArray paramJSONArray, String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      return bace.a(paramJSONArray, paramString3);
      ...
      for (;;)
      {
        ...
        if ("createDownloadTask".equals(paramString1))
        {
          ...
          if ((!TextUtils.isEmpty((CharSequence)localObject7)) && (this.a.a.c.m((String)localObject7)))
          {
            ...
            localObject7 = new batm((String)localObject7, new File((String)localObject6));
            ((batm)localObject7).jdField_f_of_type_JavaLangString = "mini_app";
            ((batm)localObject7).jdField_f_of_type_Long = 10000L;
            if (localObject2 != null)
            {
              ...
              while (((Iterator)localObject8).hasNext())
              {
                ...
                ((batm)localObject7).a(str3, ((JSONObject)localObject2).optString(str3));
              }
            }
            i = localObject7.hashCode();
            agos.a().a((batm)localObject7, new o(this, (WeakReference)localObject5, i, (String)localObject6), null);
          ...
          if ("getFileInfo".equals(paramString1))
          {
            ...
            for (;;)
            {
              try
              {
                ...
                str1 = mpr.a((String)localObject7);
