  ...
  implements SwipeRefreshLayout.OnRefreshListener, PageWebview.OnWebviewScrollListener
{
  ...
  public void insertTextView(JSONObject paramJSONObject)
  {
    ...
    if ((localObject3 != null) && (!baip.a(getActualColor(((JSONObject)localObject3).optString("bgColor")))))
    {
    ...
    if (localObject3 != null)
    {
      if (!baip.a(((JSONObject)localObject3).optString("color"))) {
    ...
    for (;;)
    {
      if (!baip.a(((JSONObject)localObject3).optString("content"))) {
  ...
  {
    CoverImageView localCoverImageView = (CoverImageView)this.imageViewSparseArray.get(paramInt);
    if ((localCoverImageView == null) || ((baip.a(paramString)) || ((paramString.startsWith("http")) || (paramString.startsWith("https"))))) {}
    for (;;)
    {
      try
      {
