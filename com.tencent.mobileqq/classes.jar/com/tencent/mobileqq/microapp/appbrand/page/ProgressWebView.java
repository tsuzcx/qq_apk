  ...
  private void init(Context paramContext)
  {
    try
    {
      if ((paramContext instanceof MutableContextWrapper))
      {
        ...
        {
          this.mWebViewDirector = new binb(new ProgressWebView.MiniAppWebviewBuilder(paramContext, localBaseActivity, localBaseActivity.getAppInterface(), this));
