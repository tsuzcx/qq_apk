  ...
  public void doOnResume()
  {
    ...
    catch (Throwable localThrowable1)
    {
      ...
      do
      {
        ...
        a(localObject1);
        if (QLog.isColorLevel()) {
          QLog.d("AppBrandUI", 4, "onResume miniConfig.launchParam.tempState=" + localObject1.launchParam.tempState + "---" + babp.a());
        }
      ...
      catch (Throwable localThrowable2)
      {
        ...
        abju.a(this, (Intent)localObject2, PublicFragmentActivityForMiniApp.class, LoadingFragment.class, 1);
