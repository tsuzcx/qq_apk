  ...
  implements View.OnClickListener, CompoundButton.OnCheckedChangeListener
{
  ...
  private a adapter;
  String appId;
  com.tencent.mobileqq.microapp.app.a authorizeCenter;
  ...
  public static void launch(Context paramContext, String paramString)
  {
    ...
    abju.a(paramContext, localIntent, PublicFragmentActivityForMiniApp.class, PermissionSettingFragment.class);
  }
  ...
  public static void launchForResult(Activity paramActivity, String paramString, int paramInt)
  {
    ...
    localIntent.putExtra("public_fragment_window_feature", 1);
    localIntent.putExtra("key_appid", paramString);
    abju.a(paramActivity, localIntent, PublicFragmentActivityForMiniApp.class, PermissionSettingFragment.class, paramInt);
  }
  ...
  public void onCheckedChanged(CompoundButton paramCompoundButton, boolean paramBoolean)
  {
    ...
    {
      this.adapter.a(paramCompoundButton, paramBoolean);
      this.authorizeCenter.a(paramCompoundButton, paramBoolean);
    }
  }
  
  public void onClick(View paramView)
  {
    if (paramView.getId() == R.id.aa) {
      getActivity().finish();
    }
  }
  ...
  {
    paramLayoutInflater = LayoutInflater.from(getActivity()).inflate(R.layout.f, null);
  ...
  public void onViewCreated(View paramView, Bundle paramBundle)
  {
    ...
    this.leftBtnView = ((TextView)paramView.findViewById(R.id.aa));
    this.titleView = ((TextView)paramView.findViewById(R.id.ab));
    ...
    this.mPermissionListView = ((ListView)paramView.findViewById(R.id.am));
    this.mPermissionNoneTextView = ((TextView)paramView.findViewById(R.id.an));
