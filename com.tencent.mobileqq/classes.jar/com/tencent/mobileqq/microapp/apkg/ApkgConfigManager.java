  ...
  implements Manager
{
  ...
  public static boolean isCanNavigate(MiniAppConfig paramMiniAppConfig1, MiniAppConfig paramMiniAppConfig2)
  {
    ...
    return agwj.c(paramMiniAppConfig1.config.union_id, paramMiniAppConfig2.config.union_id);
  }
  ...
  public BaseLibInfo getBaseLibInfo()
  {
    ...
    {
      agmq localagmq = ManagerProxy.getQWalletConfigManager(this.mApp);
      str3 = "";
      str2 = "";
      str1 = "";
      if (localagmq != null)
      {
        str3 = localagmq.a("miniapp", "", new String[] { "base_lib_url" });
        str2 = localagmq.a("miniapp", "", new String[] { "base_lib_key" });
        str1 = localagmq.a("miniapp", "", new String[] { "base_lib_version" });
      }
  ...
  public void getNewestConfig(LaunchParam paramLaunchParam, int paramInt, ApkgConfigManager.a parama)
  {
    ...
    agkg.a(localGetMiniAppReq, new c(this, parama, paramLaunchParam));
  }
