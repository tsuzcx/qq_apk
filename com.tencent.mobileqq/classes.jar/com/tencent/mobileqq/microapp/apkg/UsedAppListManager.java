  ...
  implements Manager
{
  ...
  public static void recordAppStart(AppInfo paramAppInfo)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        UsedAppListManager localUsedAppListManager = (UsedAppListManager)((QQAppInterface)localObject).getManager(QQManagerFactory.USED_APP_LIST_MANAGER);
        paramAppInfo.updateTimeStamp();
        localUsedAppListManager.insertAppInfo(paramAppInfo);
      } while (paramAppInfo.type != 2);
      paramAppInfo = (IApolloManagerService)((QQAppInterface)localObject).getRuntimeService(IApolloManagerService.class, "all");
    } while ((paramAppInfo.isMiniAppPlayed()) && (paramAppInfo.isPlusWhiteList()));
    CmGameUtil.b(4);
    return;
    ComIPCUtils.a(paramAppInfo);
  }
  ...
  {
    ((IApolloExtensionHandler)this.mApp.getBusinessHandler(BusinessHandlerFactory.APOLLO_EXTENSION_HANDLER)).a();
  }
  ...
  public void saveAppInfoList(List<AppInfo> paramList)
  {
    ...
    //   52: invokevirtual 214	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lcom/tencent/mobileqq/persistence/QQEntityManagerFactoryProxy;
    //   55: invokevirtual 220	com/tencent/mobileqq/persistence/QQEntityManagerFactoryProxy:createEntityManager	()Lcom/tencent/mobileqq/persistence/EntityManager;
    //   58: astore_3
    //   59: aload_3
    //   60: ifnull -47 -> 13
    //   63: aload_3
    //   64: invokevirtual 226	com/tencent/mobileqq/persistence/EntityManager:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   67: astore_2
    //   68: aload_2
    //   69: invokevirtual 231	com/tencent/mobileqq/persistence/EntityTransaction:begin	()V
    //   72: new 263	java/lang/StringBuilder
    //   75: dup
    //   76: invokespecial 264	java/lang/StringBuilder:<init>	()V
    //   79: astore 4
    //   81: aload_1
    ...
    //   109: aload_3
    //   110: aload 5
    //   112: invokespecial 235	com/tencent/mobileqq/microapp/apkg/UsedAppListManager:updateEntity	(Lcom/tencent/mobileqq/persistence/EntityManager;Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   115: pop
    //   116: aload 4
    //   118: ldc_w 313
    //   121: invokevirtual 270	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   124: aload 5
    //   126: getfield 316	com/tencent/mobileqq/microapp/apkg/AppInfo:name	Ljava/lang/String;
    //   129: invokevirtual 270	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   132: ldc_w 318
    //   135: invokevirtual 270	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   138: pop
    //   139: goto -51 -> 88
    //   142: astore_1
    ...
    //   152: ldc_w 320
    //   155: aload_1
    //   156: invokestatic 246	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   159: aload_2
    //   160: invokevirtual 241	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   163: return
    //   164: astore_1
    //   165: aload_2
    //   166: monitorexit
    ...
    //   199: aload_2
    //   200: invokevirtual 238	com/tencent/mobileqq/persistence/EntityTransaction:commit	()V
    //   203: aload_2
    //   204: invokevirtual 241	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   207: return
    //   208: astore_1
    //   209: aload_2
    //   210: invokevirtual 241	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   213: aload_1
    //   214: athrow
