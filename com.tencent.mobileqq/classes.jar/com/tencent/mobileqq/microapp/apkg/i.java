  ...
  implements ajal
{
  ...
  public void onResult(int paramInt, PreloadManager.PathResult paramPathResult)
  {
    if ((paramInt == 0) && (!TextUtils.isEmpty(paramPathResult.folderPath)))
    {
      ...
      try
      {
        g.a(this.c.b, a.a(BaseApplicationImpl.getApplication().getApplicationContext(), "WAWebview.js"));
        g.b(this.c.b, a.a(BaseApplicationImpl.getApplication().getApplicationContext(), "WAService.js"));
        g.c(this.c.b, a.a(BaseApplicationImpl.getApplication().getApplicationContext(), "WAVConsole.js"));
        if (!this.c.b.f())
        {
          String str = aiuv.a(this.c.a.baseLibInfo.baseLibKey, "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDsE3WI7sDFUi6QWV/oK8qozDvS\nTlxmu1a3NSFxeOrjlVEVtOx8yIMVFYIixq/Fv1XgUlyvL7bGJbaLLKaqlYruGd2z\nNbaIz90Zm4H0pMFHx4vCYhsRP1HXbVMo2ZDiHEDbnSm/99uzFPPiXqLi8jE9t4if\n0GuYdSZfe5o+SIKT5QIDAQAB");
