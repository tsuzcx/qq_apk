...
{
  private static volatile QConfigJourney jdField_a_of_type_ComTencentMobileqqConfigQConfigJourney;
  ...
  {
    Object localObject = (SharedPreferences.Editor)this.jdField_b_of_type_JavaUtilMap.get(paramString);
    if (localObject == null)
    {
  ...
  private void a(QConfigJourney.Entry paramEntry)
  {
    ...
    try
    {
      ...
      ((StringBuilder)localObject1).append(paramEntry.jdField_a_of_type_Long);
      ((StringBuilder)localObject1).append("_sharepref");
      localObject1 = ((StringBuilder)localObject1).toString();
      Object localObject2 = new StringBuilder();
      ((StringBuilder)localObject2).append("conf_");
      ((StringBuilder)localObject2).append(paramEntry.jdField_a_of_type_Long);
              ...
              if (bool1)
              {
                ...
                if (j != -1)
                {
                  ...
                  if (localObject1 != null)
                  {
                    ...
                    ((SharedPreferences.Editor)localObject1).putInt(((StringBuilder)localObject2).toString(), j);
                    bool2 = bool1;
                  }
                }
              }
  ...
  private void a(QConfigJourney.Entry paramEntry, SharedPreferences.Editor paramEditor)
  {
    ...
    {
      localObject1 = new StringBuilder();
      ((StringBuilder)localObject1).append(paramEntry.jdField_a_of_type_Int);
      ((StringBuilder)localObject1).append("-");
      ((StringBuilder)localObject1).append(paramEntry.jdField_a_of_type_JavaLangString);
      ((StringBuilder)localObject1).append("-");
      ((StringBuilder)localObject1).append(paramEntry.jdField_a_of_type_Long);
  ...
  private void b(QConfigJourney.Entry paramEntry)
  {
    ...
    try
    {
      i = Integer.valueOf(paramEntry.jdField_a_of_type_JavaLangString).intValue();
    ...
    if (bool1)
    {
      ...
      if (localObject2 != null)
      {
        ...
        j = ((SharedPreferences)localObject2).getInt(paramEntry.jdField_a_of_type_JavaLangString, -1);
        if ((j != -1) && (localObject3 != null))
        {
          localObject2 = new StringBuilder();
          ((StringBuilder)localObject2).append(paramEntry.jdField_a_of_type_JavaLangString);
        ...
        if (localObject3 != null) {
          ((SharedPreferences.Editor)localObject3).remove(paramEntry.jdField_a_of_type_JavaLangString);
        }
        localObject2 = a("q_journey_safe_mode_deleted_confs_pref");
        if (localObject2 != null)
        {
          l = System.currentTimeMillis();
          ((SharedPreferences.Editor)localObject2).putLong(paramEntry.jdField_a_of_type_JavaLangString, l);
          localObject3 = new StringBuilder();
          ((StringBuilder)localObject3).append(i);
          ((StringBuilder)localObject3).append("_version");
          ((SharedPreferences.Editor)localObject2).putInt(((StringBuilder)localObject3).toString(), j);
        }
      }
    }
    if (QLog.isColorLevel())
      ...
      if (!((Set)localObject3).isEmpty())
      {
        ...
        if (localObject4 != null)
        {
          ...
          while (((Iterator)localObject3).hasNext())
          {
            ...
            ((StringBuilder)localObject5).append(((QConfigJourney.Entry)localObject4).jdField_a_of_type_Int);
            ((StringBuilder)localObject5).append("-");
            ((StringBuilder)localObject5).append(((QConfigJourney.Entry)localObject4).jdField_a_of_type_JavaLangString);
            ((StringBuilder)localObject5).append("-");
            ((StringBuilder)localObject5).append(((QConfigJourney.Entry)localObject4).jdField_a_of_type_Long);
            localObject5 = ((StringBuilder)localObject5).toString();
            if (((QConfigJourney.Entry)localObject4).jdField_a_of_type_Int == 2) {
              localEditor.putString((String)localObject5, ((QConfigJourney.Entry)localObject4).b);
            }
  ...
  boolean a(String paramString1, String paramString2, String paramString3)
  {
    ...
    //   4: ifne +158 -> 162
    //   7: aload_3
    //   8: invokestatic 94	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   11: ifne +151 -> 162
    //   14: aload_2
    //   15: invokestatic 117	java/lang/Long:valueOf	(Ljava/lang/String;)Ljava/lang/Long;
    //   18: invokevirtual 121	java/lang/Long:longValue	()J
    //   21: lstore 4
    //   23: aload_0
    //   24: ldc 254
    //   26: invokespecial 60	com/tencent/mobileqq/config/QConfigJourney:a	(Ljava/lang/String;)Landroid/content/SharedPreferences;
    //   29: astore_2
    //   30: new 138	java/lang/StringBuilder
    //   33: dup
    //   34: invokespecial 139	java/lang/StringBuilder:<init>	()V
    //   37: astore 7
    //   39: aload 7
    //   41: ldc_w 374
    ...
    //   63: aload 7
    //   65: lload 4
    //   67: invokevirtual 151	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   70: pop
    //   71: aload 7
    //   73: invokevirtual 157	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   76: astore 7
    //   78: aload_0
    //   79: getfield 46	com/tencent/mobileqq/config/QConfigJourney:jdField_a_of_type_JavaUtilConcurrentLocksReadWriteLock	Ljava/util/concurrent/locks/ReadWriteLock;
    //   82: invokeinterface 380 1 0
    //   87: invokeinterface 385 1 0
    //   92: aconst_null
    //   93: astore_1
    //   94: aload_2
    //   95: aload 7
    //   97: aconst_null
    //   98: invokeinterface 244 3 0
    //   103: astore 7
    //   105: aload_0
    //   106: getfield 46	com/tencent/mobileqq/config/QConfigJourney:jdField_a_of_type_JavaUtilConcurrentLocksReadWriteLock	Ljava/util/concurrent/locks/ReadWriteLock;
    //   109: astore_2
    //   110: aload 7
    //   112: astore_1
    //   113: aload_2
    //   114: invokeinterface 380 1 0
    //   119: invokeinterface 388 1 0
    //   124: goto +28 -> 152
    //   127: astore_1
    //   128: aload_0
    //   129: getfield 46	com/tencent/mobileqq/config/QConfigJourney:jdField_a_of_type_JavaUtilConcurrentLocksReadWriteLock	Ljava/util/concurrent/locks/ReadWriteLock;
    //   132: invokeinterface 380 1 0
    //   137: invokeinterface 388 1 0
    //   142: aload_1
    //   143: athrow
    //   144: aload_0
    //   145: getfield 46	com/tencent/mobileqq/config/QConfigJourney:jdField_a_of_type_JavaUtilConcurrentLocksReadWriteLock	Ljava/util/concurrent/locks/ReadWriteLock;
    //   148: astore_2
    //   149: goto -36 -> 113
    //   152: aload_3
    //   153: aload_1
    //   154: invokestatic 392	android/text/TextUtils:equals	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Z
    //   157: istore 6
    //   159: iload 6
    //   161: ireturn
    //   162: iconst_0
  ...
  void b(String paramString1, String paramString2, String paramString3)
  {
    ...
    //   59: aload 6
    //   61: ldc 96
    //   63: invokevirtual 145	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   66: pop
    //   67: aload 6
    //   69: lload 4
    //   71: invokevirtual 151	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   74: pop
    //   75: aload 6
    //   77: invokevirtual 157	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   80: astore_1
    //   81: aload_3
    //   82: aload_2
    //   83: aload_1
    //   84: aconst_null
    //   85: invokeinterface 244 3 0
    //   90: invokestatic 392	android/text/TextUtils:equals	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Z
    //   93: ifeq +81 -> 174
    //   96: aload_2
    //   97: invokeinterface 66 1 0
    //   102: astore_2
    //   103: aload_0
    //   104: getfield 46	com/tencent/mobileqq/config/QConfigJourney:jdField_a_of_type_JavaUtilConcurrentLocksReadWriteLock	Ljava/util/concurrent/locks/ReadWriteLock;
    //   107: invokeinterface 402 1 0
    //   112: invokeinterface 385 1 0
    //   117: aload_2
    //   118: aload_1
    //   119: invokeinterface 197 2 0
    //   124: pop
    //   125: aload_2
    //   126: invokeinterface 359 1 0
    //   131: pop
    //   132: aload_0
    //   133: getfield 46	com/tencent/mobileqq/config/QConfigJourney:jdField_a_of_type_JavaUtilConcurrentLocksReadWriteLock	Ljava/util/concurrent/locks/ReadWriteLock;
    //   136: astore_1
    //   137: aload_1
    //   138: invokeinterface 402 1 0
    //   143: invokeinterface 388 1 0
    //   148: return
    //   149: astore_1
    //   150: aload_0
    //   151: getfield 46	com/tencent/mobileqq/config/QConfigJourney:jdField_a_of_type_JavaUtilConcurrentLocksReadWriteLock	Ljava/util/concurrent/locks/ReadWriteLock;
    //   154: invokeinterface 402 1 0
    //   159: invokeinterface 388 1 0
    //   164: aload_1
    //   165: athrow
    //   166: aload_0
    //   167: getfield 46	com/tencent/mobileqq/config/QConfigJourney:jdField_a_of_type_JavaUtilConcurrentLocksReadWriteLock	Ljava/util/concurrent/locks/ReadWriteLock;
    //   170: astore_1
    //   171: goto -34 -> 137
    //   174: return
    //   175: astore_1
