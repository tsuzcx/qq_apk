  ...
  implements Manager
{
  ...
  private void a()
  {
    try
    {
      ...
      if ((((File)localObject).exists()) && (((File)localObject).isDirectory()))
      {
        ...
        {
          Collections.sort((List)localObject, new abme(this));
          i = 10;
        }
      }
      else
  ...
  public int a()
  {
    return ((Integer)NearbySPUtil.a(this.a.getCurrentAccountUin(), "key_config_ver", Integer.valueOf(0))).intValue();
  }
  
  public Set a()
  {
    return new HashSet(Arrays.asList(((String)NearbySPUtil.a(this.a.getCurrentAccountUin(), "key_expired_banner", "")).split("\\|")));
  }
  
  public void a(int paramInt)
  {
    NearbySPUtil.a(this.a.getCurrentAccountUin(), "key_config_ver", Integer.valueOf(paramInt));
  }
  ...
  public void a(PicAndAdConf paramPicAndAdConf, int paramInt)
  {
    ...
    //   19: iconst_2
    //   20: ldc 155
    //   22: invokestatic 158	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   25: new 22	java/lang/StringBuilder
    //   28: dup
    //   29: invokespecial 23	java/lang/StringBuilder:<init>	()V
    //   32: aload_0
    //   33: getfield 15	com/tencent/mobileqq/config/struct/NearbyBannerManager:a	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   53: aload_0
    //   54: getfield 15	com/tencent/mobileqq/config/struct/NearbyBannerManager:a	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   102: aload_0
    //   103: aload 9
    //   105: invokespecial 94	com/tencent/mobileqq/config/struct/NearbyBannerManager:a	(Ljava/io/File;)V
    //   108: aload_0
    //   109: invokespecial 162	com/tencent/mobileqq/config/struct/NearbyBannerManager:a	()V
    ...
    //   128: ifne +9 -> 137
    //   131: aload 6
    //   133: invokevirtual 165	java/io/File:mkdirs	()Z
    //   136: pop
    //   137: aload 9
    //   139: invokevirtual 168	java/io/File:createNewFile	()Z
    //   142: pop
    //   143: aload 9
    //   145: ifnull +271 -> 416
    //   148: aload 9
    ...
    //   153: ifeq +263 -> 416
    //   156: new 170	java/io/BufferedOutputStream
    //   159: dup
    //   160: new 172	java/io/FileOutputStream
    //   163: dup
    //   164: aload 9
    //   166: invokespecial 174	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   169: invokespecial 177	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   172: astore 6
    //   174: new 179	java/io/DataOutputStream
    //   177: dup
    //   178: aload 6
    //   180: invokespecial 180	java/io/DataOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   183: astore 5
    //   185: aload_1
    //   186: aload 5
    //   188: invokevirtual 185	com/tencent/mobileqq/config/struct/PicAndAdConf:a	(Ljava/io/DataOutputStream;)V
    //   191: aload 6
    //   193: ifnull +8 -> 201
    //   196: aload 6
    //   198: invokevirtual 188	java/io/BufferedOutputStream:close	()V
    //   201: aload 5
    //   203: ifnull +8 -> 211
    //   206: aload 5
    //   208: invokevirtual 189	java/io/DataOutputStream:close	()V
    //   211: aload_1
    //   212: invokevirtual 191	com/tencent/mobileqq/config/struct/PicAndAdConf:d	()V
    //   215: aload_0
    //   216: iload_2
    //   217: invokevirtual 193	com/tencent/mobileqq/config/struct/NearbyBannerManager:a	(I)V
    //   220: invokestatic 198	com/tencent/mobileqq/nearby/NearbyProxy:c	()V
    //   223: iconst_0
    //   224: istore_2
    ...
    //   251: aload_1
    //   252: iload 4
    //   254: invokevirtual 203	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   257: invokevirtual 50	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   260: invokestatic 158	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   263: return
    //   264: astore 6
    ...
    //   316: ifnull +8 -> 324
    //   319: aload 6
    //   321: invokevirtual 188	java/io/BufferedOutputStream:close	()V
    //   324: aload 5
    //   326: ifnull +8 -> 334
    //   329: aload 5
    //   331: invokevirtual 189	java/io/DataOutputStream:close	()V
    //   334: aload_0
    //   335: aload 9
    //   337: invokespecial 94	com/tencent/mobileqq/config/struct/NearbyBannerManager:a	(Ljava/io/File;)V
    //   340: aload_0
    //   341: iconst_0
    //   342: invokevirtual 193	com/tencent/mobileqq/config/struct/NearbyBannerManager:a	(I)V
    //   345: iconst_1
    //   346: istore_2
    //   347: goto -122 -> 225
    //   350: astore 5
    ...
    //   359: ifnull +8 -> 367
    //   362: aload 6
    //   364: invokevirtual 188	java/io/BufferedOutputStream:close	()V
    //   367: aload 7
    //   369: ifnull +8 -> 377
    //   372: aload 7
    //   374: invokevirtual 189	java/io/DataOutputStream:close	()V
    //   377: iload_3
    //   378: ifeq +17 -> 395
    //   381: aload_0
    //   382: aload 9
    //   384: invokespecial 94	com/tencent/mobileqq/config/struct/NearbyBannerManager:a	(Ljava/io/File;)V
    //   387: aload_0
    //   388: iconst_0
    //   389: invokevirtual 193	com/tencent/mobileqq/config/struct/NearbyBannerManager:a	(I)V
    //   392: aload 5
    //   394: athrow
    //   395: aload_1
    //   396: invokevirtual 191	com/tencent/mobileqq/config/struct/PicAndAdConf:d	()V
    //   399: aload_0
    //   400: iload_2
    //   401: invokevirtual 193	com/tencent/mobileqq/config/struct/NearbyBannerManager:a	(I)V
    //   404: invokestatic 198	com/tencent/mobileqq/nearby/NearbyProxy:c	()V
    //   407: goto -15 -> 392
    //   410: iconst_0
    //   411: istore 4
    //   413: goto -165 -> 248
    ...
    //   424: iconst_2
    //   425: ldc 207
    //   427: invokestatic 158	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   430: return
    //   431: astore 6
    //   433: goto -232 -> 201
    //   436: astore 5
    ...
    //   0	507	0	this	NearbyBannerManager
    //   0	507	1	paramPicAndAdConf	PicAndAdConf
