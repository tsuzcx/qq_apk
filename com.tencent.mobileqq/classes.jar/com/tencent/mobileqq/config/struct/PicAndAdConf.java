  ...
  implements ImgConfHandler
{
  ...
  private void a(byte[] paramArrayOfByte, String paramString, long paramLong)
  {
    ...
    //   16: ifne +86 -> 102
    //   19: aload_2
    //   20: invokevirtual 55	java/io/File:createNewFile	()Z
    //   23: pop
    //   24: new 57	java/io/FileOutputStream
    //   27: dup
    //   28: aload_2
    //   29: iconst_1
    //   30: invokespecial 60	java/io/FileOutputStream:<init>	(Ljava/io/File;Z)V
    //   33: astore_2
    //   34: aload_2
    //   35: aload_1
    //   36: invokevirtual 64	java/io/FileOutputStream:write	([B)V
    //   39: aload_2
    //   40: invokevirtual 68	java/io/FileOutputStream:flush	()V
    //   43: aload_2
    //   44: invokevirtual 71	java/io/FileOutputStream:close	()V
    //   47: invokestatic 77	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   50: ldc 79
    //   52: iconst_0
    //   53: invokevirtual 83	com/tencent/qphone/base/util/BaseApplication:getSharedPreferences	(Ljava/lang/String;I)Landroid/content/SharedPreferences;
    //   56: invokeinterface 89 1 0
    //   61: astore_1
    //   62: aload_1
    //   63: ldc 91
    //   65: lload_3
    //   66: invokeinterface 97 4 0
    //   71: pop
    //   72: aload_1
    //   73: invokeinterface 100 1 0
    //   78: pop
    //   79: invokestatic 105	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   82: ifeq +11 -> 93
    //   85: ldc 107
    //   87: iconst_2
    //   88: ldc 109
    //   90: invokestatic 113	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   93: aload_2
    //   94: ifnull +7 -> 101
    //   97: aload_2
    //   98: invokevirtual 71	java/io/FileOutputStream:close	()V
    //   101: return
    //   102: aload_2
    //   103: invokevirtual 37	java/io/File:delete	()Z
    //   106: pop
    //   107: aload_2
    //   108: invokevirtual 55	java/io/File:createNewFile	()Z
    //   111: pop
    //   112: goto -88 -> 24
    //   115: astore_1
    //   116: aload 5
    ...
    //   120: ifnull -19 -> 101
    //   123: aload_1
    //   124: invokevirtual 71	java/io/FileOutputStream:close	()V
    //   127: return
    //   128: astore_1
    //   129: return
    //   130: astore_1
    ...
    //   134: ifnull +7 -> 141
    //   137: aload_2
    //   138: invokevirtual 71	java/io/FileOutputStream:close	()V
    //   141: aload_1
    //   142: athrow
    //   143: astore_1
    //   144: return
  ...
  private boolean a(byte[] paramArrayOfByte, String paramString)
  {
    ...
    //   11: dup
    //   12: new 118	java/lang/StringBuilder
    //   15: dup
    //   16: invokespecial 120	java/lang/StringBuilder:<init>	()V
    //   19: invokestatic 77	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   22: invokevirtual 124	com/tencent/qphone/base/util/BaseApplication:getFilesDir	()Ljava/io/File;
    //   25: invokevirtual 128	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   28: invokevirtual 132	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   31: ldc 134
    ...
    //   47: dup
    //   48: new 118	java/lang/StringBuilder
    //   51: dup
    //   52: invokespecial 120	java/lang/StringBuilder:<init>	()V
    //   55: invokestatic 77	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   58: invokevirtual 124	com/tencent/qphone/base/util/BaseApplication:getFilesDir	()Ljava/io/File;
    //   61: invokevirtual 128	java/io/File:getAbsolutePath	()Ljava/lang/String;
    ...
    //   76: invokevirtual 137	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   79: invokespecial 52	java/io/File:<init>	(Ljava/lang/String;)V
    //   82: astore_2
    //   83: aload 6
    //   85: invokevirtual 31	java/io/File:exists	()Z
    //   88: ifne +9 -> 97
    //   91: aload 6
    //   93: invokevirtual 142	java/io/File:mkdirs	()Z
    //   96: pop
    //   97: aload_2
    //   98: invokevirtual 31	java/io/File:exists	()Z
    //   101: ifne +45 -> 146
    //   104: aload_2
    //   105: invokevirtual 55	java/io/File:createNewFile	()Z
    //   108: pop
    //   109: new 57	java/io/FileOutputStream
    //   112: dup
    //   113: aload_2
    //   114: iconst_1
    //   115: invokespecial 60	java/io/FileOutputStream:<init>	(Ljava/io/File;Z)V
    //   118: astore_2
    //   119: aload_2
    //   120: aload_1
    //   121: invokevirtual 64	java/io/FileOutputStream:write	([B)V
    //   124: aload_2
    //   125: invokevirtual 68	java/io/FileOutputStream:flush	()V
    //   128: aload_2
    //   129: invokevirtual 71	java/io/FileOutputStream:close	()V
    //   132: iconst_0
    //   133: ifeq +11 -> 144
    //   136: new 144	java/lang/NullPointerException
    //   139: dup
    //   140: invokespecial 145	java/lang/NullPointerException:<init>	()V
    //   143: athrow
    //   144: iload_3
    //   145: ireturn
    //   146: aload_2
    //   147: invokevirtual 37	java/io/File:delete	()Z
    //   150: pop
    //   151: aload_2
    //   152: invokevirtual 55	java/io/File:createNewFile	()Z
    //   155: pop
    //   156: goto -47 -> 109
    //   159: astore_1
    //   160: aload 5
    ...
    //   175: astore_1
    //   176: aload_1
    //   177: invokevirtual 148	java/io/IOException:printStackTrace	()V
    //   180: iconst_0
    //   181: ireturn
    //   182: astore_1
    //   183: aload_1
    ...
    //   194: ifnull +7 -> 201
    //   197: aload_2
    //   198: invokevirtual 71	java/io/FileOutputStream:close	()V
    //   201: aload_1
    //   202: athrow
    //   203: astore_2
    //   204: aload_2
    //   205: invokevirtual 148	java/io/IOException:printStackTrace	()V
    //   208: goto -7 -> 201
    //   211: astore_1
    //   212: goto -19 -> 193
    //   215: astore_1
  ...
  private boolean b(byte[] paramArrayOfByte, String paramString)
  {
    ...
    //   41: invokevirtual 137	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   44: invokespecial 52	java/io/File:<init>	(Ljava/lang/String;)V
    //   47: astore 6
    //   49: new 27	java/io/File
    //   52: dup
    //   53: new 118	java/lang/StringBuilder
    //   56: dup
    //   57: invokespecial 120	java/lang/StringBuilder:<init>	()V
    //   60: invokestatic 77	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   63: invokevirtual 124	com/tencent/qphone/base/util/BaseApplication:getFilesDir	()Ljava/io/File;
    //   66: invokevirtual 128	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   69: invokevirtual 132	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   72: ldc 151
    ...
    //   87: aload_2
    //   88: invokevirtual 132	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   91: invokevirtual 137	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   94: invokespecial 52	java/io/File:<init>	(Ljava/lang/String;)V
    //   97: astore 7
    //   99: aload 4
    //   101: astore_2
    //   102: aload 6
    //   104: invokevirtual 31	java/io/File:exists	()Z
    //   107: ifne +12 -> 119
    //   110: aload 4
    //   112: astore_2
    //   113: aload 6
    //   115: invokevirtual 142	java/io/File:mkdirs	()Z
    //   118: pop
    //   119: aload 4
    //   121: astore_2
    //   122: aload 7
    //   124: invokevirtual 31	java/io/File:exists	()Z
    //   127: ifne +57 -> 184
    //   130: aload 4
    //   132: astore_2
    //   133: aload 7
    //   135: invokevirtual 55	java/io/File:createNewFile	()Z
    //   138: pop
    //   139: aload 4
    //   141: astore_2
    //   142: new 57	java/io/FileOutputStream
    //   145: dup
    //   146: aload 7
    //   148: iconst_1
    //   149: invokespecial 60	java/io/FileOutputStream:<init>	(Ljava/io/File;Z)V
    //   152: astore 4
    //   154: aload 4
    //   156: aload_1
    //   157: invokevirtual 64	java/io/FileOutputStream:write	([B)V
    //   160: aload 4
    //   162: invokevirtual 68	java/io/FileOutputStream:flush	()V
    //   165: aload 4
    //   167: invokevirtual 71	java/io/FileOutputStream:close	()V
    //   170: iconst_0
    //   171: ifeq +11 -> 182
    //   174: new 144	java/lang/NullPointerException
    //   177: dup
    //   178: invokespecial 145	java/lang/NullPointerException:<init>	()V
    //   181: athrow
    //   182: iload_3
    //   183: ireturn
    //   184: aload 4
    //   186: astore_2
    //   187: aload 7
    //   189: invokevirtual 37	java/io/File:delete	()Z
    //   192: pop
    //   193: aload 4
    //   195: astore_2
    //   196: aload 7
    //   198: invokevirtual 55	java/io/File:createNewFile	()Z
    //   201: pop
    //   202: goto -63 -> 139
    //   205: astore 4
    //   207: aload 5
    ...
    //   210: aload_1
    //   211: astore_2
    //   212: invokestatic 105	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   215: ifeq +15 -> 230
    //   218: aload_1
    //   219: astore_2
    //   220: ldc 155
    ...
    //   223: ldc 157
    //   225: aload 4
    //   227: invokestatic 160	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   230: iconst_0
    //   231: istore_3
    //   232: aload_1
    //   233: ifnull -51 -> 182
    //   236: aload_1
    //   237: invokevirtual 71	java/io/FileOutputStream:close	()V
    //   240: iconst_0
    //   241: ireturn
    //   242: astore_1
    //   243: aload_1
    //   244: invokevirtual 148	java/io/IOException:printStackTrace	()V
    //   247: iconst_0
    //   248: ireturn
    //   249: astore_1
    //   250: aload_1
    //   251: invokevirtual 148	java/io/IOException:printStackTrace	()V
    //   254: iconst_1
    //   255: ireturn
    //   256: astore_1
    //   257: aload_2
    //   258: ifnull +7 -> 265
    //   261: aload_2
    //   262: invokevirtual 71	java/io/FileOutputStream:close	()V
    //   265: aload_1
    //   266: athrow
    //   267: astore_2
    //   268: aload_2
    //   269: invokevirtual 148	java/io/IOException:printStackTrace	()V
    //   272: goto -7 -> 265
    //   275: astore_1
    //   276: aload 4
    //   278: astore_2
  ...
  public android.graphics.Bitmap a(int paramInt)
  {
    ...
    //   17: iload_1
    //   18: aload_0
    //   19: getfield 164	com/tencent/mobileqq/config/struct/PicAndAdConf:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   22: invokevirtual 170	java/util/ArrayList:size	()I
    //   25: if_icmplt +10 -> 35
    //   28: aload 4
    //   30: astore 5
    //   32: aload 5
    ...
    //   37: astore 5
    //   39: aload_0
    //   40: getfield 164	com/tencent/mobileqq/config/struct/PicAndAdConf:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   43: iload_1
    //   44: invokevirtual 174	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   47: checkcast 176	com/tencent/mobileqq/config/struct/PicAndAdConf$PicStruct
    //   50: astore 8
    //   52: aload 7
    //   54: astore 5
    //   56: aload 8
    ...
    //   96: astore 5
    //   98: aload 8
    //   100: getfield 190	com/tencent/mobileqq/config/struct/PicAndAdConf$PicStruct:b	Ljava/lang/String;
    //   103: invokestatic 195	com/tencent/mobileqq/util/BitmapManager:a	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   106: astore 4
    //   108: aload 4
    //   110: areturn
    //   111: aload 7
    //   113: astore 5
    //   115: aload_0
    //   116: getfield 164	com/tencent/mobileqq/config/struct/PicAndAdConf:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   119: iload_1
    //   120: invokevirtual 174	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   123: checkcast 176	com/tencent/mobileqq/config/struct/PicAndAdConf$PicStruct
    //   126: getfield 198	com/tencent/mobileqq/config/struct/PicAndAdConf$PicStruct:jdField_a_of_type_ArrayOfByte	[B
    //   129: astore 9
    //   131: aload 7
    //   133: astore 5
    //   135: aload_0
    //   136: getfield 164	com/tencent/mobileqq/config/struct/PicAndAdConf:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   139: iload_1
    //   140: invokevirtual 174	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   143: checkcast 176	com/tencent/mobileqq/config/struct/PicAndAdConf$PicStruct
    //   146: getfield 201	com/tencent/mobileqq/config/struct/PicAndAdConf$PicStruct:c	Ljava/lang/String;
    //   149: astore 10
    //   151: aload 10
    //   153: ifnull +47 -> 200
    //   156: aload 7
    //   158: astore 5
    //   160: aload_0
    //   161: getfield 202	com/tencent/mobileqq/config/struct/PicAndAdConf:jdField_a_of_type_Byte	B
    //   164: iconst_1
    ...
    //   192: astore 5
    //   194: aload 10
    //   196: invokestatic 195	com/tencent/mobileqq/util/BitmapManager:a	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   199: areturn
    //   200: aload 10
    //   202: ifnull +94 -> 296
    //   205: aload 7
    //   207: astore 5
    //   209: aload_0
    //   210: getfield 202	com/tencent/mobileqq/config/struct/PicAndAdConf:jdField_a_of_type_Byte	B
    //   213: ifne +83 -> 296
    //   216: aload 7
    //   218: astore 5
    ...
    //   223: dup
    //   224: aload 10
    //   226: invokespecial 52	java/io/File:<init>	(Ljava/lang/String;)V
    //   229: invokevirtual 31	java/io/File:exists	()Z
    //   232: ifeq +45 -> 277
    //   235: aload 7
    //   237: astore 5
    //   239: aload 10
    //   241: invokestatic 195	com/tencent/mobileqq/util/BitmapManager:a	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   244: astore 4
    //   246: aload 4
    //   248: ifnonnull +261 -> 509
    //   251: aload 8
    //   253: getfield 207	com/tencent/mobileqq/config/struct/PicAndAdConf$PicStruct:jdField_a_of_type_Boolean	Z
    //   256: ifeq +253 -> 509
    //   259: aload 8
    //   261: iconst_0
    //   262: putfield 207	com/tencent/mobileqq/config/struct/PicAndAdConf$PicStruct:jdField_a_of_type_Boolean	Z
    //   265: aload_0
    //   266: aload 8
    //   268: getfield 190	com/tencent/mobileqq/config/struct/PicAndAdConf$PicStruct:b	Ljava/lang/String;
    //   271: invokevirtual 209	com/tencent/mobileqq/config/struct/PicAndAdConf:c	(Ljava/lang/String;)V
    //   274: aload 4
    //   276: areturn
    //   277: aload 7
    //   279: astore 5
    //   281: aload_0
    //   282: aload 8
    //   284: getfield 190	com/tencent/mobileqq/config/struct/PicAndAdConf$PicStruct:b	Ljava/lang/String;
    //   287: invokevirtual 209	com/tencent/mobileqq/config/struct/PicAndAdConf:c	(Ljava/lang/String;)V
    //   290: aconst_null
    //   291: astore 4
    //   293: goto -19 -> 274
    //   296: aload 7
    //   298: astore 5
    //   300: aload 10
    //   302: invokestatic 215	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   305: ifne +143 -> 448
    //   308: aload 7
    //   310: astore 5
    //   312: aload_0
    //   313: getfield 202	com/tencent/mobileqq/config/struct/PicAndAdConf:jdField_a_of_type_Byte	B
    //   316: iconst_2
    //   317: if_icmpne +131 -> 448
    //   320: aload 7
    //   322: astore 5
    //   324: new 27	java/io/File
    //   327: dup
    //   328: aload 10
    //   330: invokespecial 52	java/io/File:<init>	(Ljava/lang/String;)V
    //   333: invokevirtual 31	java/io/File:exists	()Z
    //   336: istore_3
    //   337: aload 6
    //   339: astore 4
    //   341: iload_3
    ...
    //   347: astore 5
    //   349: aload 10
    //   351: invokestatic 195	com/tencent/mobileqq/util/BitmapManager:a	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   354: astore 4
    //   356: aload 4
    //   358: astore 5
    //   360: aload 4
    ...
    //   369: aload_0
    //   370: aload 8
    //   372: getfield 190	com/tencent/mobileqq/config/struct/PicAndAdConf$PicStruct:b	Ljava/lang/String;
    //   375: invokevirtual 209	com/tencent/mobileqq/config/struct/PicAndAdConf:c	(Ljava/lang/String;)V
    //   378: aload 4
    //   380: areturn
    //   381: astore 6
    //   383: aload 5
    ...
    //   387: aload 4
    //   389: astore 5
    //   391: invokestatic 105	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   394: ifeq -362 -> 32
    //   397: ldc 217
    //   399: iconst_2
    //   400: aload 6
    //   402: invokestatic 221	com/tencent/qphone/base/util/QLog:getStackTraceString	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   405: invokestatic 224	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   408: aload 4
    //   410: areturn
    //   411: astore 9
    //   413: aload 6
    ...
    //   417: aload 7
    //   419: astore 5
    //   421: invokestatic 105	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   424: ifeq -68 -> 356
    //   427: aload 7
    //   429: astore 5
    //   431: ldc 155
    ...
    //   434: ldc 226
    //   436: aload 9
    //   438: invokestatic 160	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   441: aload 6
    //   443: astore 4
    //   445: goto -89 -> 356
    //   448: aload 4
    ...
    //   476: aload 9
    //   478: arraylength
    //   479: invokestatic 232	android/graphics/BitmapFactory:decodeByteArray	([BII)Landroid/graphics/Bitmap;
    //   482: astore 4
    //   484: aload 4
    //   486: areturn
    //   487: astore 4
      ...
      if (!paramString.startsWith("/"))
      {
        ...
        if ((paramString.startsWith("http://")) && (!paramString.endsWith(".png")))
        {
          if (this.jdField_a_of_type_Byte == 6) {
            str = paramString + "_" + Config.b + "_" + Config.jdField_a_of_type_Byte + ".png";
          } else if (this.jdField_a_of_type_Byte == 0) {
            str = paramString + "_" + (Config.jdField_a_of_type_Byte - 2) + ".png";
          } else if ((this.jdField_a_of_type_Byte == 1) && (paramString.contains("[]"))) {
            str = paramString.replace("[]", DeviceInfoUtil.h() + "x" + DeviceInfoUtil.i());
          } else {
            str = paramString + "_" + Config.jdField_a_of_type_Byte + ".png";
          }
        }
        else
        {
  ...
  public void a(DataOutputStream paramDataOutputStream)
  {
    ...
    if (i < j)
    {
      localPicStruct = (PicAndAdConf.PicStruct)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      if (this.jdField_a_of_type_Byte != 2) {
        break label117;
      }
    ...
    while (i < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      ...
      if (paramHttpMsg1.a().startsWith(paramHttpMsg2.b))
      {
        ...
        while (paramHttpMsg2.hasNext()) {
          ((ConfigListener)paramHttpMsg2.next()).a(false, this.jdField_a_of_type_Short, i, paramHttpMsg1.a());
        }
      }
      i += 1;
    }
