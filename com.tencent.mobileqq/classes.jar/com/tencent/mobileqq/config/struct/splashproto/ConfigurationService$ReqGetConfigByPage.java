  ...
  extends MessageMicro<ReqGetConfigByPage>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 32, 40 }, new String[] { "type", "page_info", "device_info", "adcode", "stagger_version" }, new Object[] { localInteger, null, null, Long.valueOf(0L), localInteger }, ReqGetConfigByPage.class);
  }
}
