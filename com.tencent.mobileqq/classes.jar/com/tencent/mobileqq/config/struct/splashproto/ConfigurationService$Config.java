  ...
  extends MessageMicro<Config>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34, 42 }, new String[] { "type", "version", "content_list", "msg_content_list", "msg_rich_info" }, new Object[] { localInteger, localInteger, "", null, null }, Config.class);
  }
}
