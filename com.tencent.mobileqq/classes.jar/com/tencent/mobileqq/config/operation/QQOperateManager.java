...
public class QQOperateManager
{
  ...
  public int a(String paramString, int paramInt, QQOperationViopTipTask paramQQOperationViopTipTask, QQAppInterface paramQQAppInterface, List<ChatMessage> paramList)
  {
    ...
    if (k >= 0)
    {
      ...
      {
        if ((!MsgProxyUtils.h(paramString.msgtype)) || (paramString.extraflag != 0)) {
          break label221;
        }
  ...
  public void a(QQAppInterface paramQQAppInterface, ArrayList<QQOperationViopTipTask> paramArrayList)
  {
    ...
    //   22: aload_2
    //   23: invokevirtual 292	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    ...
    //   33: ifnull +10 -> 43
    //   36: aload_2
    //   37: invokevirtual 272	java/util/ArrayList:size	()I
    //   40: ifne +4 -> 44
    //   43: return
    //   44: aload_1
    //   45: invokevirtual 149	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lcom/tencent/mobileqq/persistence/QQEntityManagerFactoryProxy;
    //   48: invokevirtual 155	com/tencent/mobileqq/persistence/QQEntityManagerFactoryProxy:createEntityManager	()Lcom/tencent/mobileqq/persistence/EntityManager;
    //   51: astore_3
    //   52: aload_3
    //   53: invokevirtual 473	com/tencent/mobileqq/persistence/EntityManager:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   56: astore_1
    //   57: aload_1
    //   58: invokevirtual 478	com/tencent/mobileqq/persistence/EntityTransaction:begin	()V
    //   61: aload_3
    //   62: ldc 157
    //   64: invokevirtual 482	com/tencent/mobileqq/persistence/EntityManager:drop	(Ljava/lang/Class;)Z
    //   67: pop
    //   68: aload_2
    //   69: invokevirtual 273	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   72: astore 4
    //   74: aload 4
    //   76: invokeinterface 202 1 0
    //   81: ifeq +38 -> 119
    //   84: aload_3
    //   85: aload 4
    //   87: invokeinterface 206 1 0
    //   92: checkcast 157	com/tencent/mobileqq/config/operation/QQOperationViopTipTask
    //   95: invokevirtual 250	com/tencent/mobileqq/persistence/EntityManager:persistOrReplace	(Lcom/tencent/mobileqq/persistence/Entity;)V
    //   98: goto -24 -> 74
    //   101: astore_2
    //   102: aload_2
    //   103: invokevirtual 227	java/lang/Exception:printStackTrace	()V
    //   106: aload_1
    //   107: invokevirtual 485	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   110: aload_3
    //   111: invokevirtual 230	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   114: aload_0
    //   115: invokevirtual 316	com/tencent/mobileqq/config/operation/QQOperateManager:a	()V
    //   118: return
    //   119: invokestatic 178	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   122: ifeq +32 -> 154
    //   125: ldc 180
    //   127: iconst_4
    ...
    //   141: aload_2
    //   142: invokevirtual 272	java/util/ArrayList:size	()I
    //   145: invokevirtual 185	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   148: invokevirtual 111	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   151: invokestatic 189	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   154: aload_1
    //   155: invokevirtual 489	com/tencent/mobileqq/persistence/EntityTransaction:commit	()V
    //   158: aload_1
    //   159: invokevirtual 485	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   162: goto -52 -> 110
    //   165: astore_2
    //   166: aload_1
    //   167: invokevirtual 485	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   170: aload_2
    //   171: athrow
