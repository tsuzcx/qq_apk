  ...
  implements CommandListener, IHttpCommunicatorListener
{
  ...
  {
    this.jdField_a_of_type_Acaa = new acaa(this);
  ...
  public void a()
  {
    ...
    //   7: istore_2
    //   8: aload_0
    //   9: getfield 112	com/tencent/mobileqq/config/ConfigManager:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   12: ifnull +392 -> 404
    //   15: aload_0
    //   16: getfield 112	com/tencent/mobileqq/config/ConfigManager:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   19: invokevirtual 87	java/io/File:exists	()Z
    //   22: ifeq +382 -> 404
    //   25: aload_0
    //   26: getfield 112	com/tencent/mobileqq/config/ConfigManager:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   29: invokevirtual 311	java/io/File:canRead	()Z
    //   32: ifeq +372 -> 404
    //   35: aload_0
    //   36: getfield 112	com/tencent/mobileqq/config/ConfigManager:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   39: invokevirtual 315	java/io/File:length	()J
    //   42: lconst_0
    //   43: lcmp
    //   44: ifle +360 -> 404
    //   47: new 317	java/io/FileInputStream
    //   50: dup
    //   51: aload_0
    //   52: getfield 112	com/tencent/mobileqq/config/ConfigManager:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   55: invokespecial 320	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   58: astore_3
    //   59: new 322	java/io/BufferedInputStream
    //   62: dup
    //   63: aload_3
    //   64: invokespecial 325	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   67: astore 5
    //   69: aload_3
    //   70: astore 4
    //   72: aload 5
    ...
    //   85: astore 5
    //   87: aload_3
    //   88: invokevirtual 328	java/io/BufferedInputStream:available	()I
    //   91: ifle +94 -> 185
    //   94: new 330	java/io/DataInputStream
    //   97: dup
    //   98: aload_3
    //   99: invokespecial 331	java/io/DataInputStream:<init>	(Ljava/io/InputStream;)V
    //   102: astore 6
    //   104: iconst_0
    //   105: istore_1
    //   106: iload_1
    //   107: getstatic 336	com/tencent/mobileqq/config/Config:a	[Lcom/tencent/mobileqq/config/struct/BaseConf;
    //   110: arraylength
    //   111: if_icmpge +70 -> 181
    //   114: getstatic 336	com/tencent/mobileqq/config/Config:a	[Lcom/tencent/mobileqq/config/struct/BaseConf;
    //   117: iload_1
    //   118: aaload
    //   119: astore 5
    //   121: aload_0
    //   122: aload 5
    //   124: aload 6
    //   126: invokespecial 338	com/tencent/mobileqq/config/ConfigManager:a	(Lcom/tencent/mobileqq/config/struct/BaseConf;Ljava/io/DataInputStream;)V
    //   129: aload 5
    //   131: getfield 340	com/tencent/mobileqq/config/struct/BaseConf:a	B
    //   134: iconst_1
    //   135: if_icmpeq +11 -> 146
    //   138: aload 5
    //   140: getfield 340	com/tencent/mobileqq/config/struct/BaseConf:a	B
    //   143: ifne +16 -> 159
    //   146: aload 5
    //   148: invokevirtual 342	com/tencent/mobileqq/config/struct/BaseConf:a	()Z
    //   151: ifeq +8 -> 159
    //   154: aload 5
    //   156: invokevirtual 344	com/tencent/mobileqq/config/struct/BaseConf:a	()V
    //   159: iload_1
    //   160: iconst_1
    //   161: iadd
    //   162: istore_1
    ...
    //   187: ifnull +8 -> 195
    //   190: aload 4
    //   192: invokevirtual 347	java/io/FileInputStream:close	()V
    //   195: aload_3
    //   196: ifnull +7 -> 203
    //   199: aload_3
    //   200: invokevirtual 348	java/io/BufferedInputStream:close	()V
    //   203: aload 5
    //   205: ifnull +8 -> 213
    //   208: aload 5
    //   210: invokevirtual 349	java/io/DataInputStream:close	()V
    //   213: iconst_0
    //   214: istore_1
    //   215: iload_1
    //   216: ifeq +151 -> 367
    ...
    //   220: istore_1
    //   221: iload_1
    //   222: getstatic 336	com/tencent/mobileqq/config/Config:a	[Lcom/tencent/mobileqq/config/struct/BaseConf;
    //   225: arraylength
    //   226: if_icmpge +141 -> 367
    //   229: getstatic 336	com/tencent/mobileqq/config/Config:a	[Lcom/tencent/mobileqq/config/struct/BaseConf;
    //   232: iload_1
    //   233: aaload
    //   234: invokevirtual 344	com/tencent/mobileqq/config/struct/BaseConf:a	()V
    //   237: iload_1
    //   238: iconst_1
    //   239: iadd
    //   240: istore_1
    ...
    //   254: astore 5
    //   256: aload 6
    //   258: invokevirtual 128	java/lang/Exception:printStackTrace	()V
    //   261: aload 4
    //   263: ifnull +8 -> 271
    //   266: aload 4
    //   268: invokevirtual 347	java/io/FileInputStream:close	()V
    //   271: aload_3
    //   272: ifnull +7 -> 279
    //   275: aload_3
    //   276: invokevirtual 348	java/io/BufferedInputStream:close	()V
    //   279: aload 5
    //   281: ifnull +8 -> 289
    //   284: aload 5
    //   286: invokevirtual 349	java/io/DataInputStream:close	()V
    //   289: iconst_1
    //   290: istore_1
    //   291: goto -76 -> 215
    //   294: astore_3
    ...
    //   307: ifnull +8 -> 315
    //   310: aload 4
    //   312: invokevirtual 347	java/io/FileInputStream:close	()V
    //   315: aload_3
    //   316: ifnull +7 -> 323
    //   319: aload_3
    //   320: invokevirtual 348	java/io/BufferedInputStream:close	()V
    //   323: aload 6
    //   325: ifnull +8 -> 333
    //   328: aload 6
    //   330: invokevirtual 349	java/io/DataInputStream:close	()V
    //   333: aload 5
    //   335: athrow
    //   336: astore 4
    //   338: goto -143 -> 195
  ...
  public void a(HttpMsg arg1, HttpMsg paramHttpMsg2)
  {
    ...
    try
    {
      synchronized (this.jdField_a_of_type_ArrayOfInt)
      {
        ...
        ConfigParser.a(paramHttpMsg2, new acab(), this.b);
        a();
        d();
        return;
      }
  ...
  {
    boolean bool = true;
    switch (this.jdField_a_of_type_Acaa.a)
    {
    default: 
      bool = false;
    }
  ...
  public void c()
  {
    ...
    //   9: dup
    //   10: aload_0
    //   11: getfield 94	com/tencent/mobileqq/config/ConfigManager:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   14: invokespecial 83	java/io/File:<init>	(Ljava/lang/String;)V
    //   17: putfield 112	com/tencent/mobileqq/config/ConfigManager:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   20: aload_0
    //   21: getfield 112	com/tencent/mobileqq/config/ConfigManager:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   24: invokevirtual 87	java/io/File:exists	()Z
    //   27: ifne +11 -> 38
    //   30: aload_0
    //   31: getfield 112	com/tencent/mobileqq/config/ConfigManager:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   34: invokevirtual 115	java/io/File:createNewFile	()Z
    //   37: pop
    //   38: aload_0
    //   39: getfield 112	com/tencent/mobileqq/config/ConfigManager:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   42: ifnull +92 -> 134
    //   45: aload_0
    //   46: getfield 112	com/tencent/mobileqq/config/ConfigManager:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   49: invokevirtual 87	java/io/File:exists	()Z
    //   52: ifeq +82 -> 134
    //   55: new 387	java/io/BufferedOutputStream
    //   58: dup
    //   59: new 389	java/io/FileOutputStream
    //   62: dup
    //   63: aload_0
    //   64: getfield 112	com/tencent/mobileqq/config/ConfigManager:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   67: invokespecial 390	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   70: invokespecial 393	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   73: astore_2
    //   74: new 395	java/io/DataOutputStream
    //   77: dup
    //   78: aload_2
    //   79: invokespecial 396	java/io/DataOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   82: astore_3
    //   83: iconst_0
    //   84: istore_1
    //   85: iload_1
    //   86: getstatic 336	com/tencent/mobileqq/config/Config:a	[Lcom/tencent/mobileqq/config/struct/BaseConf;
    //   89: arraylength
    //   90: if_icmpge +28 -> 118
    //   93: aload_0
    //   94: getstatic 336	com/tencent/mobileqq/config/Config:a	[Lcom/tencent/mobileqq/config/struct/BaseConf;
    //   97: iload_1
    //   98: aaload
    //   99: aload_3
    //   100: invokevirtual 398	com/tencent/mobileqq/config/ConfigManager:a	(Lcom/tencent/mobileqq/config/struct/BaseConf;Ljava/io/DataOutputStream;)V
    //   103: iload_1
    //   104: iconst_1
    //   105: iadd
    //   106: istore_1
    ...
    //   110: astore_2
    //   111: aload_2
    //   112: invokevirtual 128	java/lang/Exception:printStackTrace	()V
    //   115: goto -77 -> 38
    //   118: aload_2
    //   119: ifnull +7 -> 126
    //   122: aload_2
    //   123: invokevirtual 399	java/io/BufferedOutputStream:close	()V
    //   126: aload_3
    //   127: ifnull +7 -> 134
    //   130: aload_3
    //   131: invokevirtual 400	java/io/DataOutputStream:close	()V
    //   134: return
    //   135: astore_2
    //   136: aconst_null
    //   137: astore_2
    ...
    //   139: ifnull +7 -> 146
    //   142: aload_3
    //   143: invokevirtual 399	java/io/BufferedOutputStream:close	()V
    //   146: aload_2
    //   147: ifnull +7 -> 154
    //   150: aload_2
    //   151: invokevirtual 400	java/io/DataOutputStream:close	()V
    //   154: aload_0
    //   155: getfield 112	com/tencent/mobileqq/config/ConfigManager:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   158: invokevirtual 384	java/io/File:delete	()Z
    //   161: pop
    //   162: return
    //   163: astore_3
    //   164: aconst_null
    ...
    //   167: ifnull +7 -> 174
    //   170: aload_2
    //   171: invokevirtual 399	java/io/BufferedOutputStream:close	()V
    //   174: aload 4
    //   176: ifnull +8 -> 184
    //   179: aload 4
    //   181: invokevirtual 400	java/io/DataOutputStream:close	()V
    //   184: aload_3
    //   185: athrow
    //   186: astore_2
    //   187: goto -61 -> 126
