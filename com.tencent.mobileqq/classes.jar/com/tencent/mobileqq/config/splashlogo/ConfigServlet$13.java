...
public class ConfigServlet$13
  implements Runnable
{
  public ConfigServlet$13(arcj paramarcj, ConfigurationService.Config paramConfig, QQAppInterface paramQQAppInterface) {}
  ...
  public void run()
  {
    ...
    int j = bgsg.y(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp());
    ...
    for (;;)
    {
      ...
      if ((m == 2598) || (m == 4448))
      {
        ...
        continue;
        if ((bool2) && (bool1)) {
          bgsg.p(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getBaseContext(), k);
        }
        for (;;)
        {
