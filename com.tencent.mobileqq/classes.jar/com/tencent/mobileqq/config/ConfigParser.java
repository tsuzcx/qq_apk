...
public class ConfigParser
{
    ...
    if (paramInt != 3)
    {
      if (paramInt != 4)
      {
        if (paramInt != 12)
        {
          ...
          Config.c.e();
          Config.c.a(false);
          a(Config.c, paramArrayOfByte, paramString);
          return;
        }
        Config.d.e();
        Config.d.a(false);
        a(Config.d, paramArrayOfByte);
        return;
      }
      paramString = Config.c();
      if (paramString != null) {
        a(paramString.b, paramArrayOfByte);
      }
    }
  }
  ...
  private static void a(ConfigManager.UpdateStruct paramUpdateStruct, byte[] paramArrayOfByte)
  {
    ...
    paramUpdateStruct.a = PkgTools.getUTFString(paramArrayOfByte, 2, i);
    i += 2;
    paramUpdateStruct.b = paramArrayOfByte[i];
    i += 1;
    paramUpdateStruct.c = paramArrayOfByte[i];
    i += 1;
    paramUpdateStruct.d = PkgTools.getUTFString(paramArrayOfByte, i + 2, PkgTools.getShortData(paramArrayOfByte, i));
  }
  ...
  {
    Object localObject = paramConfigRespStruct.d;
    int i = 0;
    ...
    while (i < k)
    {
      int m = PkgTools.getShortData(paramConfigRespStruct.d, j);
      int n = j + 2;
      j = PkgTools.getShortData(paramConfigRespStruct.d, n);
      n += 2;
      localObject = new byte[j];
      PkgTools.getBytesData(paramConfigRespStruct.d, n, (byte[])localObject, j);
      j = n + j;
      a(m, (byte[])localObject, paramString);
      i += 1;
    }
    paramConfigRespStruct = Config.c();
    if (paramConfigRespStruct != null) {
      paramConfigRespStruct.d();
    }
  }
  ...
  private static void a(PicAndAdConf paramPicAndAdConf, byte[] paramArrayOfByte)
  {
    ...
    int i = 0;
    paramPicAndAdConf.b = PkgTools.getLongData(paramArrayOfByte, 0);
    paramPicAndAdConf.c = (PkgTools.getLongData(paramArrayOfByte, 4) * 1000L);
    paramPicAndAdConf.d = (PkgTools.getLongData(paramArrayOfByte, 8) * 1000L);
  ...
  private static void a(byte[] paramArrayOfByte, ConfigRespStruct paramConfigRespStruct)
  {
    if (paramArrayOfByte != null)
    {
      ...
      paramConfigRespStruct.f = PkgTools.getShortData(paramArrayOfByte, 1);
      paramConfigRespStruct.a = PkgTools.getShortData(paramArrayOfByte, 3);
      paramConfigRespStruct.c = (PkgTools.getLongData(paramArrayOfByte, 5) * 1000L);
      paramConfigRespStruct.b = paramArrayOfByte[9];
      int i = paramArrayOfByte.length - 10 - 1;
      if (paramConfigRespStruct.b == 0)
      {
        paramConfigRespStruct.d = new byte[i];
        PkgTools.getBytesData(paramArrayOfByte, 10, paramConfigRespStruct.d, i);
      }
      else
      {
        paramConfigRespStruct.e = PkgTools.getUTFString(paramArrayOfByte, 10, i);
      }
  ...
  public static boolean a(byte[] paramArrayOfByte, ConfigRespStruct paramConfigRespStruct, String paramString)
  {
    if (paramArrayOfByte != null)
    {
      ...
      if (paramConfigRespStruct.f != 768) {
        return false;
      }
      if (paramConfigRespStruct.b != 0)
      {
      ...
      if (paramConfigRespStruct.d != null)
      {
        if (paramConfigRespStruct.d.length == 0) {
          return false;
        }
