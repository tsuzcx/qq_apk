...
public class OnF2FConfigListener$1
  implements Runnable
{
  public OnF2FConfigListener$1(ampe paramampe, amor paramamor, QQAppInterface paramQQAppInterface) {}
  
  public void run()
  {
    try
    {
      Object localObject = new JSONObject(this.jdField_a_of_type_Amor.a);
