      ...
      try
      {
        ...
        else
        {
          if (localJSONObject.has("picShareToWeChatSize")) {
            localPicShareToWXConifgBean.jdField_a_of_type_Long = localJSONObject.getLong("picShareToWeChatSize");
          }
          if (localJSONObject.has("PicShareToWeChatUserName")) {
            localPicShareToWXConifgBean.jdField_a_of_type_JavaLangString = localJSONObject.getString("PicShareToWeChatUserName");
          }
          if (localJSONObject.has("PicShareToWeChatPath")) {
            localPicShareToWXConifgBean.jdField_b_of_type_JavaLangString = localJSONObject.getString("PicShareToWeChatPath");
          }
          ...
          if (localJSONObject.has("PicShareToWeChatMiniType")) {
            localPicShareToWXConifgBean.jdField_a_of_type_Int = localJSONObject.getInt("PicShareToWeChatMiniType");
          }
          if (localJSONObject.has("PicShareToWeChatTitle")) {
            localPicShareToWXConifgBean.c = localJSONObject.getString("PicShareToWeChatTitle");
          }
          paramString = localPicShareToWXConifgBean;
          if (!localJSONObject.has("PicShareToWeChatDescription")) {
            break;
          }
          localPicShareToWXConifgBean.d = localJSONObject.getString("PicShareToWeChatDescription");
