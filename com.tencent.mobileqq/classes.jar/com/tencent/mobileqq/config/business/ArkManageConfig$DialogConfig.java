...
public class ArkManageConfig$DialogConfig
  implements IQStorageSafable<String>
{
  ...
  public ArkManageConfig$DialogConfig()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        for (;;)
        {
          ...
          try
          {
            ArkMsgReplyConfigMgr.a().a(localJSONObject);
 ...
 * Qualified Name:     com.tencent.mobileqq.config.business.ArkManageConfig.DialogConfig
