...
import com.tencent.mobileqq.ark.ArkAppPreDownloadMgr.PreloadItem;
...
public class ArkManageConfig$ArkPlatformConfig
  implements IQStorageSafable<String>
{
  protected String a;
  public ArrayList<String> a;
  public ConcurrentHashMap<String, ArkAppPreDownloadMgr.PreloadItem> a;
  public boolean a;
  public String b;
  ...
  public ArkManageConfig$ArkPlatformConfig()
  {
    ...
    try
    {
      ...
      if ((localObject1 != null) && (((JSONArray)localObject1).length() > 0))
      {
        ...
        if (i < ((JSONArray)localObject1).length())
        {
          ...
          if (!TextUtils.isEmpty((CharSequence)localObject2))
          {
            localObject3 = new ArkAppPreDownloadMgr.PreloadItem();
            ((ArkAppPreDownloadMgr.PreloadItem)localObject3).jdField_a_of_type_JavaLangString = ((String)localObject2);
            ((ArkAppPreDownloadMgr.PreloadItem)localObject3).jdField_a_of_type_Int = j;
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        for (bool1 = true;; bool1 = false)
        {
          ...
          this.e = bool1;
          QLog.d("ArkPlatformConfig", 1, new Object[] { "ark VipReport enable=", Boolean.valueOf(this.jdField_c_of_type_Boolean), ", mIsBackToFileSchemeEnable=", Boolean.valueOf(this.d), ", mAddBackslashEnable=", Boolean.valueOf(this.e) });
          return;
          bool1 = false;
          break;
        }
 ...
 * Qualified Name:     com.tencent.mobileqq.config.business.ArkManageConfig.ArkPlatformConfig
