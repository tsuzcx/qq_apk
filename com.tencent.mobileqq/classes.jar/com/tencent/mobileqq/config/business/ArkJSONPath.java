    ...
    for (;;)
    {
      try
      {
        if (i < localArrayList.size())
        {
          ...
          if (str1.charAt(0) == '.')
          {
            paramString.add(new ArkJSONPathObject(str1.substring(1)));
          }
          else
          {
            String str2 = ArkJSONPathUtil.a().b(str1);
            if (!TextUtils.isEmpty(str2)) {
              paramString.add(new ArkJSONPathObject(str2));
            }
          }
        }
      }
      ...
      return paramString;
      String str1 = ArkJSONPathUtil.a().a(str1);
      if (!TextUtils.isEmpty(str1)) {
        paramString.add(new ArkJSONPathArray(Integer.parseInt(str1)));
      } else {
        return null;
      }
      i += 1;
 ...
 * Qualified Name:     com.tencent.mobileqq.config.business.ArkJSONPath
