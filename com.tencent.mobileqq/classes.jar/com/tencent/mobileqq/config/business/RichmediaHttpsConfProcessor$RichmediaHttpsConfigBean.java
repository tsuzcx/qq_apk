...
public class RichmediaHttpsConfProcessor$RichmediaHttpsConfigBean
{
  ...
  /* Error */
  public static RichmediaHttpsConfigBean a(com.tencent.mobileqq.config.QConfItem[] paramArrayOfQConfItem)
  {
    // Byte code:
    //   0: new 2	com/tencent/mobileqq/config/business/RichmediaHttpsConfProcessor$RichmediaHttpsConfigBean
    //   3: dup
    //   4: invokespecial 17	com/tencent/mobileqq/config/business/RichmediaHttpsConfProcessor$RichmediaHttpsConfigBean:<init>	()V
    //   7: astore 4
    //   9: aload_0
    //   10: arraylength
    //   11: istore_2
    ...
    //   14: goto +112 -> 126
    //   17: aload 5
    //   19: getfield 22	com/tencent/mobileqq/config/QConfItem:a	Ljava/lang/String;
    //   22: astore 5
    //   24: aload 5
    ...
    //   65: putfield 45	com/tencent/mobileqq/config/business/RichmediaHttpsConfProcessor$RichmediaHttpsConfigBean:a	I
    ...
    //   0	148	0	paramArrayOfQConfItem	com.tencent.mobileqq.config.QConfItem[]
    //   13	132	1	i	int
    //   11	118	2	j	int
    //   29	2	3	bool	boolean
    //   7	107	4	localRichmediaHttpsConfigBean	RichmediaHttpsConfigBean
  ...
  {
    return "RichmediaHttpsConfigBean{mPicDownHttpsSwitch=" + this.a + '}';
  }
}
