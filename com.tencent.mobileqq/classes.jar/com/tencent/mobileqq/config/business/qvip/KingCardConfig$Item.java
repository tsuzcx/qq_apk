...
public class KingCardConfig$Item
{
  ...
  public SpannableString a(Context paramContext, CharSequence paramCharSequence)
  {
    ...
    if (i < this.jdField_a_of_type_ArrayOfJavaLangString.length)
    {
      ...
      for (;;)
      {
        ...
        localSpannableString.setSpan(new KingCardConfig.Item.1(this, str2, paramContext), j, str1.length() + j, 33);
      }
    }
    ReportController.b(null, "dc00898", "", "", this.c, this.c, 2, 0, "", "", "", "");
  ...
  public void a()
  {
    ReportController.b(null, "dc00898", "", "", this.d, this.d, 2, 0, "", "", "", "");
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.config.business.qvip.KingCardConfig.Item
