...
public class QVipTroopFileConfig
{
  ...
  QVipTroopFileConfig.Info jdField_a_of_type_ComTencentMobileqqConfigBusinessQvipQVipTroopFileConfig$Info = new QVipTroopFileConfig.Info();
  private String jdField_a_of_type_JavaLangString = "";
  boolean jdField_a_of_type_Boolean = true;
  QVipTroopFileConfig.Info jdField_b_of_type_ComTencentMobileqqConfigBusinessQvipQVipTroopFileConfig$Info = new QVipTroopFileConfig.Info();
  private String jdField_b_of_type_JavaLangString = "";
  QVipTroopFileConfig.Info jdField_c_of_type_ComTencentMobileqqConfigBusinessQvipQVipTroopFileConfig$Info = new QVipTroopFileConfig.Info();
  ...
  public static QVipTroopFileConfig a(@Nullable String paramString)
  {
    ...
    try
    {
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        localQVipTroopFileConfig.jdField_a_of_type_ComTencentMobileqqConfigBusinessQvipQVipTroopFileConfig$Info = QVipTroopFileConfig.Info.a(paramString.getJSONObject("fullSpaceMessage"));
        localQVipTroopFileConfig.jdField_b_of_type_ComTencentMobileqqConfigBusinessQvipQVipTroopFileConfig$Info = QVipTroopFileConfig.Info.a(paramString.getJSONObject("redSubString"));
        localQVipTroopFileConfig.jdField_c_of_type_ComTencentMobileqqConfigBusinessQvipQVipTroopFileConfig$Info = QVipTroopFileConfig.Info.a(paramString.getJSONObject("blueSubString"));
      ...
      if (QLog.isColorLevel()) {
        QLog.e("QVIP.TROOP_FILE.ConfigProcessor", 1, " : " + localQVipTroopFileConfig.toString());
      }
  ...
  {
    String str1 = this.jdField_a_of_type_ComTencentMobileqqConfigBusinessQvipQVipTroopFileConfig$Info.a(paramString);
    String str2 = this.jdField_b_of_type_ComTencentMobileqqConfigBusinessQvipQVipTroopFileConfig$Info.a(paramString);
    String str3 = this.jdField_c_of_type_ComTencentMobileqqConfigBusinessQvipQVipTroopFileConfig$Info.a(paramString);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        for (int j = 1;; j = 0)
        {
          ...
          localObject = new QVipTroopFileConfig.2(this, paramString2);
  ...
  {
    return "QVipTroopFileConfig{enable=" + this.jdField_a_of_type_Int + ", cacheFlag='" + this.jdField_a_of_type_JavaLangString + '\'' + ", intructionPageUrl='" + this.jdField_b_of_type_JavaLangString + '\'' + ", fullSpaceMessage=" + this.jdField_a_of_type_ComTencentMobileqqConfigBusinessQvipQVipTroopFileConfig$Info + ", redSubString=" + this.jdField_b_of_type_ComTencentMobileqqConfigBusinessQvipQVipTroopFileConfig$Info + ", blueSubString=" + this.jdField_c_of_type_ComTencentMobileqqConfigBusinessQvipQVipTroopFileConfig$Info + ", blueActionUrl=" + this.d + ", fullAlertMessage=" + this.e + ", bigFileAlertMessage=" + this.f + ", alertButtonTitle=" + this.g + ", buttonActionUrl=" + this.h + ", AIObuttonActionUrl=" + this.i + '}';
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes.jar
 * Qualified Name:     com.tencent.mobileqq.config.business.qvip.QVipTroopFileConfig
