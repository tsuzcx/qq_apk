  ...
  extends BaseQVipConfigProcessor<QVipStickerConfig>
{
  ...
  public QVipStickerConfig a(QConfItem[] paramArrayOfQConfItem)
  {
    ...
    if (i < m)
    {
      ...
      int k = localQConfItem.jdField_a_of_type_Int;
      if (k < j) {
        SLog.e("QVipStickerProcessor", "received old task id " + k + ", latest task id: " + j);
      }
      for (;;)
      {
        i += 1;
        ...
        try
        {
          JSONObject localJSONObject = new JSONObject(new String(localQConfItem.jdField_a_of_type_JavaLangString.getBytes("utf-8")));
        ...
        catch (UnsupportedEncodingException localUnsupportedEncodingException)
        {
          ...
          SLog.e("QVipStickerProcessor", "item.content=" + localQConfItem.jdField_a_of_type_JavaLangString + " e=" + localUnsupportedEncodingException);
        }
        catch (JSONException localJSONException)
        {
          localJSONException.printStackTrace();
          SLog.e("QVipStickerProcessor", "item.content=" + localQConfItem.jdField_a_of_type_JavaLangString + " e=" + localJSONException);
        }
      }
    }
    return new QVipStickerConfig();
 ...
 * Qualified Name:     com.tencent.mobileqq.config.business.qvip.QVipStickerProcessor
