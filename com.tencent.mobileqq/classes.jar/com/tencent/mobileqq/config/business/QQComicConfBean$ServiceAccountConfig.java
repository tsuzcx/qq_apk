...
public class QQComicConfBean$ServiceAccountConfig
{
  ...
  private static String a(String paramString1, String paramString2, String paramString3)
  {
    ...
    try
    {
      for (;;)
      {
        paramString2 = str + URLUtil.a(new StringBuilder().append(paramString2).append('=').append(paramString3).toString());
        if (j != -1) {
          break;
        }
  ...
  public boolean a(String paramString, Context paramContext, int paramInt, QQAppInterface paramQQAppInterface)
  {
    if ((a(paramString)) && (!TextUtils.isEmpty(this.b)))
    {
      String str3 = this.b;
      String str2 = null;
      Message localMessage = paramQQAppInterface.getMessageFacade().a(paramString, 1008);
      String str1 = str2;
      ...
      paramString = new QQComicConfBean.ServiceAccountConfig.1(this, paramQQAppInterface, paramString);
      return ((IMiniAppService)QRoute.api(IMiniAppService.class)).startMiniApp(paramContext, str2, paramInt, paramString);
    }
    return false;
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.config.business.QQComicConfBean.ServiceAccountConfig
