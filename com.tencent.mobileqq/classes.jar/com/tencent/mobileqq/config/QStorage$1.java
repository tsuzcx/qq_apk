  ...
  implements IQStorageIOProcessor<String, T>
{
  ...
  public String a(java.io.File paramFile, T paramT)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 17	com/tencent/mobileqq/config/QStorage$1:c	Lcom/tencent/mobileqq/config/QStorage;
    //   4: aload_0
    //   5: getfield 19	com/tencent/mobileqq/config/QStorage$1:a	Ljava/lang/String;
    //   8: ldc 39
    //   10: invokevirtual 44	com/tencent/mobileqq/config/QStorage:a	(Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;
    //   13: astore_2
    //   14: aconst_null
    //   15: astore_3
    //   16: aconst_null
    ...
    //   22: aconst_null
    //   23: astore_1
    //   24: new 46	java/io/ObjectOutputStream
    //   27: dup
    //   28: new 48	java/io/BufferedOutputStream
    //   31: dup
    //   32: new 50	java/io/FileOutputStream
    //   35: dup
    //   36: aload_2
    //   37: invokespecial 53	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   40: invokespecial 56	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   43: invokespecial 57	java/io/ObjectOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   46: astore_2
    //   47: aload_2
    //   48: aload_0
    //   49: getfield 21	com/tencent/mobileqq/config/QStorage$1:b	Ljava/io/Serializable;
    //   52: invokevirtual 61	java/io/ObjectOutputStream:writeObject	(Ljava/lang/Object;)V
    //   55: aload_2
    //   56: invokevirtual 64	java/io/ObjectOutputStream:flush	()V
    //   59: aload_2
    //   60: invokevirtual 67	java/io/ObjectOutputStream:close	()V
    //   63: goto +202 -> 265
    //   66: astore_3
    //   67: aload_2
    //   68: astore_1
    ...
    //   118: aload 4
    //   120: aload_0
    //   121: getfield 19	com/tencent/mobileqq/config/QStorage$1:a	Ljava/lang/String;
    ...
    //   138: aload_3
    //   139: invokestatic 88	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   142: aload_2
    //   143: ifnull +122 -> 265
    //   146: aload_2
    //   147: invokevirtual 67	java/io/ObjectOutputStream:close	()V
    //   150: goto +115 -> 265
    //   153: astore_3
    //   154: aload 5
    //   156: astore_2
    ...
    //   180: aload 4
    //   182: aload_0
    //   183: getfield 19	com/tencent/mobileqq/config/QStorage$1:a	Ljava/lang/String;
    ...
    //   200: aload_3
    //   201: invokestatic 88	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   204: aload_2
    //   205: ifnull +60 -> 265
    //   208: goto -62 -> 146
    //   211: aload_2
    ...
    //   234: aload 4
    //   236: aload_0
    //   237: getfield 19	com/tencent/mobileqq/config/QStorage$1:a	Ljava/lang/String;
    ...
    //   254: aload_3
    //   255: invokestatic 88	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   258: aload_2
    //   259: ifnull +6 -> 265
    //   262: goto -116 -> 146
    //   265: ldc 90
    ...
    //   269: ifnull +7 -> 276
    //   272: aload_1
    //   273: invokevirtual 67	java/io/ObjectOutputStream:close	()V
    //   276: goto +5 -> 281
    //   279: aload_2
    //   280: athrow
    //   281: goto -2 -> 279
