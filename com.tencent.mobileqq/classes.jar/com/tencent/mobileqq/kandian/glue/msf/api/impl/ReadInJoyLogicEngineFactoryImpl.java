  ...
  implements IReadInJoyLogicEngineFactory
{
  ...
  {
    return (IReadInJoyLogicEngine)ReadInJoyLogicEngine.a();
  }
  
  @Nullable
  public Object getAdvertisementInfo(int paramInt1, int paramInt2)
  {
    return ReadInJoyLogicEngine.a().a(paramInt1, paramInt2);
  }
  ...
  {
    return ReadInJoyLogicEngine.a().b(paramInt1, paramInt2);
  }
  
  public void removeFixPosArticleAsyncListener(int paramInt)
  {
    IRIJAdvertisementInfoModule localIRIJAdvertisementInfoModule = ReadInJoyLogicEngine.a().a();
    if (localIRIJAdvertisementInfoModule != null) {
      localIRIJAdvertisementInfoModule.a(paramInt);
    }
  }
