  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (localObject == null)
    {
      ...
      ((StringBuilder)localObject).append("viola_cache_file_viola_qq_page_data_new_main_js_");
      ((StringBuilder)localObject).append(RIJQQAppInterfaceUtil.a());
      FileUtils.writeObject(((StringBuilder)localObject).toString(), ViolaBaseView.a(this.a.a));
      return;
    }
    if (((localObject instanceof String)) && (!ViolaBaseView.a(this.a.a).equals(localObject)))
    {
      localObject = new StringBuilder();
      ((StringBuilder)localObject).append("viola_cache_file_viola_qq_page_data_new_main_js_");
      ((StringBuilder)localObject).append(RIJQQAppInterfaceUtil.a());
