...
class BridgeModule$9
  implements BusinessObserver
{
  BridgeModule$9(BridgeModule paramBridgeModule, String paramString1, String paramString2, QQAppInterface paramQQAppInterface) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (localObject2 != null)
        {
          ...
          this.d.invokeCallJS(this.a, localObject2);
          if (((WebSsoBody.WebSsoControlData)((WebSsoBody.WebSsoResponseBody)localObject1).controlData.get()).frequency.has()) {
            BridgeModule.access$102(this.d, ((WebSsoBody.WebSsoControlData)((WebSsoBody.WebSsoResponseBody)localObject1).controlData.get()).frequency.get());
          }
          if (((WebSsoBody.WebSsoControlData)((WebSsoBody.WebSsoResponseBody)localObject1).controlData.get()).packageSize.has()) {
            BridgeModule.access$202(this.d, ((WebSsoBody.WebSsoControlData)((WebSsoBody.WebSsoResponseBody)localObject1).controlData.get()).packageSize.get());
          }
      ...
      try
      {
        if ((ViolaBaseView.b) && (paramBundle.containsKey("data_error_code")) && (paramBundle.getInt("data_error_code") == 1002))
        {
    ...
    this.d.invokeCallJS(this.a, localJSONObject);
 ...
 * Qualified Name:     com.tencent.mobileqq.kandian.glue.viola.modules.BridgeModule.9
