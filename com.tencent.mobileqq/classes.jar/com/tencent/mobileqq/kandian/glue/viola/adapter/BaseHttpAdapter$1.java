  ...
  implements Runnable
{
  ...
  public void run()
  {
    GamePubAccountHelper.a(this.jdField_a_of_type_ComTencentViolaAdapterHttpRequset.url, System.currentTimeMillis());
    Object localObject1 = new HttpResponse();
    Object localObject2 = this.this$0.a();
    try
    {
      localObject3 = BaseHttpAdapter.a(this.this$0, this.jdField_a_of_type_ComTencentViolaAdapterHttpRequset, this.jdField_a_of_type_ComTencentViolaAdapterIHttpAdapter$OnHttpListener);
      ((BaseHttpAdapter.IEventReporterDelegate)localObject2).a((HttpURLConnection)localObject3, this.jdField_a_of_type_ComTencentViolaAdapterHttpRequset.body);
      ...
      if ((i >= 200) && (i <= 299))
      {
        ...
        ((HttpResponse)localObject1).originalData = BaseHttpAdapter.a(this.this$0, (InputStream)localObject2, this.jdField_a_of_type_ComTencentViolaAdapterIHttpAdapter$OnHttpListener);
      }
      else
      {
        ((HttpResponse)localObject1).errorMsg = BaseHttpAdapter.a(this.this$0, ((HttpURLConnection)localObject3).getErrorStream(), this.jdField_a_of_type_ComTencentViolaAdapterIHttpAdapter$OnHttpListener);
      }
      if (this.jdField_a_of_type_ComTencentViolaAdapterIHttpAdapter$OnHttpListener != null) {
        this.jdField_a_of_type_ComTencentViolaAdapterIHttpAdapter$OnHttpListener.onHttpFinish((HttpResponse)localObject1);
      }
      if (QLog.isColorLevel())
      {
        ...
        ((StringBuilder)localObject3).append(this.jdField_a_of_type_ComTencentViolaAdapterHttpRequset.url);
        ((StringBuilder)localObject3).append("  request body is:");
        ((StringBuilder)localObject3).append(this.jdField_a_of_type_ComTencentViolaAdapterHttpRequset.body);
    ...
    {
      BaseHttpAdapter.a(this.this$0, (HttpResponse)localObject1, this.jdField_a_of_type_ComTencentViolaAdapterIHttpAdapter$OnHttpListener, localException.getMessage());
