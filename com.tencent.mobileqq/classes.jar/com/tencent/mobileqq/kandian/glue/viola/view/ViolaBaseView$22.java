  ...
  implements Runnable
{
  ...
  public void run()
  {
    if (TextUtils.isEmpty(ViolaBaseView.s(this.this$0))) {
      return;
    }
    ...
    if (localObject == null)
    {
      ...
      ((StringBuilder)localObject).append("_");
      ((StringBuilder)localObject).append(RIJQQAppInterfaceUtil.d());
      FileUtils.writeObject(((StringBuilder)localObject).toString(), ViolaBaseView.s(this.this$0));
    }
    else if (((localObject instanceof String)) && (!localObject.equals(ViolaBaseView.s(this.this$0))))
    {
      localObject = new StringBuilder();
      ((StringBuilder)localObject).append("viola_cache_file_viola_qq_page_data_");
      ((StringBuilder)localObject).append(ViolaUtils.getPageName(this.this$0.a));
    ...
    ViolaBaseView.d(this.this$0, null);
  }
}
