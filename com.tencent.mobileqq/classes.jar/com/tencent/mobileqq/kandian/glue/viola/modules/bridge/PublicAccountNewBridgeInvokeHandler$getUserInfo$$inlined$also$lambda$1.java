  ...
  implements IReadInJoyUserInfoModule.RefreshUserInfoCallBack
{
  ...
  {
    this.b.a(this.a, ((IPublicAccountH5AbilityPlugin)QRoute.api(IPublicAccountH5AbilityPlugin.class)).getUserInfoFailStr(paramString2));
  }
  
  public void onLoadUserInfoSucceed(@Nullable String paramString, @Nullable ReadInJoyUserInfo paramReadInJoyUserInfo)
  {
    this.b.a(this.a, ReadInJoyLegacyUtils.a(paramReadInJoyUserInfo));
  }
}
