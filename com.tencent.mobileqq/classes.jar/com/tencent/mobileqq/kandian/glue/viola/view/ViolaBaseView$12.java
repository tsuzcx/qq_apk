  ...
  implements ViolaInstance.ViolaPageListener
{
  ...
  public void onComponentFloatBottom(View paramView, float paramFloat)
  {
    if (((ViolaBaseView.a(this.a) instanceof ViolaFragment)) && (((ViolaFragment)ViolaBaseView.a(this.a)).getCommonSuspensionGestureLayout() != null)) {
      ((CommonSuspensionGestureLayout)((ViolaFragment)ViolaBaseView.a(this.a)).getCommonSuspensionGestureLayout()).c(paramView, paramFloat);
    }
  }
  ...
  {
    if (((ViolaBaseView.a(this.a) instanceof ViolaFragment)) && (((ViolaFragment)ViolaBaseView.a(this.a)).getCommonSuspensionGestureLayout() != null)) {
      ((CommonSuspensionGestureLayout)((ViolaFragment)ViolaBaseView.a(this.a)).getCommonSuspensionGestureLayout()).b(paramView, paramFloat);
    }
  }
  ...
  {
    if (((ViolaBaseView.a(this.a) instanceof ViolaFragment)) && (((ViolaFragment)ViolaBaseView.a(this.a)).getCommonSuspensionGestureLayout() != null)) {
      ((CommonSuspensionGestureLayout)((ViolaFragment)ViolaBaseView.a(this.a)).getCommonSuspensionGestureLayout()).a(paramView, paramFloat);
    }
  }
  ...
  public void pageOpenSuccess()
  {
    ...
    if ((!TextUtils.isEmpty(this.a.a)) && (this.a.a.contains("VideoFeeds.js")))
    {
      ...
      localIPublicAccountReportUtils.publicAccountReportClickEvent(null, null, "0X800AF0E", "0X800AF0E", 0, 0, null, null, null, localStringBuilder.toString(), false);
    }
  }
}
