  ...
  implements Runnable
{
  ...
  public void run()
  {
    Pair localPair = ReadInJoyHelper.ai(ReadInJoyLogicEngine.a(this.this$0));
    if (this.a == 40677) {
      localPair = ReadInJoyHelper.aj(ReadInJoyLogicEngine.a(this.this$0));
    }
    ...
    if ((!(BaseActivity.sTopActivity instanceof ReadInJoyNewFeedsActivity)) && ((!ReadInJoyHelper.w()) || (!RIJAppSetting.e())) && (l1 - ((Long)localObject1).longValue() >= ((Long)localPair.first).longValue()))
    {
      l3 = l1 - l3;
      if (l3 >= ReadInJoyPageItemCache.a / 1000)
      {
        ...
        if (ReadInJoyLogicEngine.b(this.this$0) != null) {
          ReadInJoyLogicEngine.b(this.this$0).i().a(this.a, l2, ((Integer)localPair.second).intValue());
        }
