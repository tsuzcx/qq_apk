...
public class ReadinjoySPEventReport
{
  ...
  private static ReadinjoySPEventReport.ScreenReceiver jdField_a_of_type_ComTencentMobileqqKandianGlueBusinesshandlerEngineReadinjoySPEventReport$ScreenReceiver = new ReadinjoySPEventReport.ScreenReceiver(null);
  private static volatile ReadinjoySPEventReport jdField_a_of_type_ComTencentMobileqqKandianGlueBusinesshandlerEngineReadinjoySPEventReport;
  ...
  private static volatile boolean jdField_f_of_type_Boolean = false;
  ...
  private ReadinjoySPEventReport.ExitAIOAttributes jdField_a_of_type_ComTencentMobileqqKandianGlueBusinesshandlerEngineReadinjoySPEventReport$ExitAIOAttributes;
  public ReadinjoySPEventReport.UserOptInfo a;
  ...
  private List<ReadinjoySPEventReport.TabClickItem> jdField_a_of_type_JavaUtilList = new LinkedList();
  ...
  public ReadinjoySPEventReport.UserOptInfo b;
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqKandianGlueBusinesshandlerEngineReadinjoySPEventReport$UserOptInfo = new ReadinjoySPEventReport.UserOptInfo(this);
    this.jdField_b_of_type_ComTencentMobileqqKandianGlueBusinesshandlerEngineReadinjoySPEventReport$UserOptInfo = this.jdField_a_of_type_ComTencentMobileqqKandianGlueBusinesshandlerEngineReadinjoySPEventReport$UserOptInfo;
    q();
  }
  ...
  private ReadinjoySPEventReport.ExitAIOAttributes a(List<ChatMessage> paramList)
  {
    ...
    int n = 0;
    int i3;
    for (int m = 0; i1 >= 0; m = i3)
    {
      localObject1 = (ChatMessage)paramList.get(i1);
    ...
    paramList = RIJQQAppInterfaceUtil.a();
    if ((paramList != null) && ((paramList instanceof QQAppInterface))) {
      i1 = ((QQAppInterface)paramList).getMessageFacade().b();
    } else {
      i1 = 0;
    }
    ...
    ((oidb_cmd0x80a.AttributeList)localObject3).att_value.set(String.valueOf(i1));
  ...
  {
    if (jdField_a_of_type_ComTencentMobileqqKandianGlueBusinesshandlerEngineReadinjoySPEventReport == null) {
      try
      {
        if (jdField_a_of_type_ComTencentMobileqqKandianGlueBusinesshandlerEngineReadinjoySPEventReport == null) {
          jdField_a_of_type_ComTencentMobileqqKandianGlueBusinesshandlerEngineReadinjoySPEventReport = new ReadinjoySPEventReport();
        }
      }
      finally {}
    }
    return jdField_a_of_type_ComTencentMobileqqKandianGlueBusinesshandlerEngineReadinjoySPEventReport;
  }
  ...
  private String a()
  {
    ...
    while (m < localObject1.length)
    {
      ...
      str = PackageUtil.a(BaseApplicationImpl.getContext(), localObject1[m]);
  ...
  {
    String str = RIJQQAppInterfaceUtil.a().getAccount();
  ...
  private void a(ReadinjoySPEventReport.CommonAttrBuilder paramCommonAttrBuilder, int paramInt)
  {
    ...
    String str2 = KandianDailyReportUtils.a();
    paramInt = KandianDailyReportUtils.a();
    ...
    {
      bool1 = bool2;
      if (paramInt + 1 <= ((IRIJDisplayStyleManager)QRoute.api(IRIJDisplayStyleManager.class)).getRecentListReportVisibleItemCount()) {
        bool1 = true;
      }
    }
  ...
  {
    if (paramInt == FrameControllerUtil.jdField_a_of_type_Int) {
      return 1;
    }
    ...
    if (paramInt == FrameControllerUtil.jdField_d_of_type_Int) {
      return 4;
    }
    return 0;
  }
  ...
  {
    return jdField_h_of_type_Long;
  }
  
  public static void b(int paramInt1, Map<String, String> paramMap, int paramInt2)
  {
    ReadinjoySPEventReport.UserOptInfo localUserOptInfo = a().jdField_a_of_type_ComTencentMobileqqKandianGlueBusinesshandlerEngineReadinjoySPEventReport$UserOptInfo;
    boolean bool;
    if (paramInt1 == 0) {
      bool = true;
    } else {
  ...
  {
    boolean bool2 = SPEventReportSwitch.a();
    boolean bool1 = true;
    if ((!bool2) || (paramLong - jdField_f_of_type_Long < SPEventReportSwitch.c() * 1000) || (jdField_a_of_type_Int > 1))
    {
  ...
  private static int c()
  {
    ...
    if (((IQCircleConfigApi)QRoute.api(IQCircleConfigApi.class)).isShowQQCircleMainTabEntrance(StudyModeManager.a())) {
      return 2;
    }
    return 0;
  }
        ...
        if (localObject != null)
        {
          ...
          try
          {
            ...
            if (paramInt == m)
            {
              ...
              try
              {
                localObject = ((MainFragment)localObject).a();
                m = i1;
                StringBuilder localStringBuilder = new StringBuilder();
                m = i1;
                localStringBuilder.append(FrameControllerUtil.jdField_a_of_type_JavaLangString);
                m = i1;
                localStringBuilder.append("_num");
                m = i1;
                n = ((View)((HashMap)localObject).get(localStringBuilder.toString())).getVisibility();
                if (n == 0) {
                  bool = true;
                }
                m = 1;
            ...
            {
              m = FrameControllerUtil.c;
              if (paramInt == m)
              {
                m = 2;
                bool = localException1.a(FrameControllerUtil.b).c();
                m = 2;
              }
              else
              {
                m = FrameControllerUtil.g;
                if (paramInt == m)
                {
                  m = 3;
                  bool = localException1.a(FrameControllerUtil.f).c();
                  m = 3;
                }
                else
                {
                  i1 = FrameControllerUtil.jdField_d_of_type_Int;
                  m = n;
                  if (paramInt == i1)
                  {
                    m = 4;
                    bool = localException1.a(FrameControllerUtil.jdField_d_of_type_JavaLangString).c();
                    m = 4;
                  }
                }
              }
          ...
          if (paramInt != 11)
          {
            if (paramInt != 12)
            {
              if (paramInt != 14)
              {
                ...
                return NetConnInfoCenter.getServerTime() - k < jdField_c_of_type_Long;
              }
              try
              {
                localObject = ReadInJoyHelper.b();
                paramInt = (int)(Long.valueOf(RIJQQAppInterfaceUtil.a()).longValue() % 100L);
  ...
  {
    jdField_h_of_type_Long = NetConnInfoCenter.getServerTime();
  }
  ...
  public static void d(boolean paramBoolean)
  {
    ...
    if (ReadinjoySPEventReport.ForeBackGround.jdField_a_of_type_Int == 2) {
      return;
    }
  ...
  {
    int m = Calendar.getInstance().get(5);
    ...
    if (m == 0)
    {
      if ((SPEventReportSwitch.a()) && (SPEventReportSwitch.a(paramInt))) {
        return true;
      }
      bool = false;
    }
  ...
  public static void e(int paramInt)
  {
    ...
    if (TextUtils.equals((CharSequence)localObject1, (String)RIJSPUtils.a(((StringBuilder)localObject2).toString(), "")))
    {
      localObject1 = new StringBuilder();
  ...
  public static void g()
  {
    ...
    try
    {
      ...
      BaseApplicationImpl.getContext().registerReceiver(jdField_a_of_type_ComTencentMobileqqKandianGlueBusinesshandlerEngineReadinjoySPEventReport$ScreenReceiver, localIntentFilter);
      return;
    }
    catch (Exception localException)
    {
  ...
  public static void j()
  {
    ...
    long l1;
    if ((localQQAppInterface != null) && (localQQAppInterface.mAutomator != null) && (localQQAppInterface.mAutomator.b())) {
      l1 = 3000L;
    } else {
      l1 = 0L;
    }
  ...
  public static void m()
  {
    ...
    localAttributeList.att_value.set(KandianDailyReportUtils.a());
    localArrayList.add(localAttributeList);
  ...
  private void s()
  {
    ...
    {
      ArrayList localArrayList = new ArrayList();
      localArrayList.add(this.jdField_a_of_type_ComTencentMobileqqKandianGlueBusinesshandlerEngineReadinjoySPEventReport$ExitAIOAttributes.a);
      localArrayList.add(this.jdField_a_of_type_ComTencentMobileqqKandianGlueBusinesshandlerEngineReadinjoySPEventReport$ExitAIOAttributes.c);
      localArrayList.add(this.jdField_a_of_type_ComTencentMobileqqKandianGlueBusinesshandlerEngineReadinjoySPEventReport$ExitAIOAttributes.d);
  ...
  private static void t()
  {
    ...
    ((IPublicAccountReportUtils)QRoute.api(IPublicAccountReportUtils.class)).publicAccountReportClickEvent(null, "", "0X800BBCA", "0X800BBCA", 0, 0, "", "", "", ((RIJTransMergeKanDianReport.ReportR5Builder)localObject).build(), false);
  ...
  {
    ReadinjoySPEventReport.ExitAIOAttributes localExitAIOAttributes = this.jdField_a_of_type_ComTencentMobileqqKandianGlueBusinesshandlerEngineReadinjoySPEventReport$ExitAIOAttributes;
    this.jdField_a_of_type_ComTencentMobileqqKandianGlueBusinesshandlerEngineReadinjoySPEventReport$ExitAIOAttributes = null;
    return localExitAIOAttributes;
  }
  ...
  public List<oidb_cmd0x80a.AttributeList> a(int paramInt)
  {
    ...
    localObject2 = localCommonAttrBuilder.a(0, "UnreadMsg", String.valueOf(b())).a(100, "FolderStatus", String.valueOf(RIJKanDianFolderStatus.reportFolderStatus)).a(101, "KDInScreen", RIJMergeKanDianMessage.b((QQAppInterface)localObject1)).a(102, "KDAttrL", ((IPublicAccountUtil)QRoute.api(IPublicAccountUtil.class)).constructAttributeL()).a(103, "LeftBtmRedPntPulse", ReadinjoySPEventReport.Utils.a(this.jdField_b_of_type_JavaUtilList, ":", "`")).a(104, "FirstScnRedPntPulse", ReadinjoySPEventReport.Utils.a(this.jdField_c_of_type_JavaUtilList, ":", "`")).a(105, "AIOPulse", ReadinjoySPEventReport.Utils.a(this.jdField_d_of_type_JavaUtilList, ":", "`"));
    Object localObject3 = new StringBuilder();
    ((StringBuilder)localObject3).append(RIJKanDianTabReport.jdField_a_of_type_Long);
    ((StringBuilder)localObject3).append(":");
    ((StringBuilder)localObject3).append(RIJKanDianFolderStatus.reportFolderStatus);
    ((ReadinjoySPEventReport.CommonAttrBuilder)localObject2).a(106, "LastRedExposureTime", ((StringBuilder)localObject3).toString()).a(107, "dt_red", a());
    long l1;
    if (a() > 0L) {
      l1 = a();
    } else {
    ...
    localCommonAttrBuilder.a(109, "last_in_aio_time", String.valueOf(b()));
    localObject2 = a().a();
    if (localObject2 != null)
    {
    ...
    localCommonAttrBuilder.a(112, "UniversalStateBit", ((IPublicAccountUtil)QRoute.api(IPublicAccountUtil.class)).isMsgTabStoryNodeListVisible()).a(116, "wifiName", NetworkUtils.c(BaseApplicationImpl.getContext()));
    a(localCommonAttrBuilder, paramInt);
    localCommonAttrBuilder.a(120, "PushPreviewQ", SettingCloneUtil.readValue(BaseApplicationImpl.getContext(), RIJQQAppInterfaceUtil.a(), "", "qqsetting_notify_showcontent_key", true));
    localCommonAttrBuilder.a(121, "NoDisturbAtNight", FriendsStatusUtil.a(BaseApplicationImpl.getApplication()));
    paramInt = ReadInJoyHelper.a((QQAppInterface)RIJQQAppInterfaceUtil.a());
    if (paramInt != -1) {
      localCommonAttrBuilder.a(122, "DongTaiKandian", String.valueOf(paramInt));
    }
    localCommonAttrBuilder.a(123, "BSSID", DeviceInfoUtil.b(BaseApplicationImpl.getContext()));
    ...
    ((StringBuilder)localObject2).append("_");
    ((StringBuilder)localObject2).append(ReadinjoySPEventReport.Utils.a(a(), String.valueOf(1), String.valueOf(0)));
    localObject2 = ((StringBuilder)localObject2).toString();
    localObject3 = localCommonAttrBuilder.a(126, "ScreenInfo", RIJMergeKanDianMessage.a(-1)).a(128, "is_jcjj_mode", QQTheme.f());
    StringBuilder localStringBuilder = new StringBuilder();
    ...
    localStringBuilder.append("");
    ((ReadinjoySPEventReport.CommonAttrBuilder)localObject3).a(131, "sessionID", localStringBuilder.toString()).a(132, "redDot", (String)localObject2).a(133, "app_install_list", a()).a(134, "is_study_mode", StudyModeManager.a());
    ...
    localCommonAttrBuilder.a(136, "4TabRedStatus", RIJXTabBadgeReporter.a.a());
    localObject1 = new StringBuilder();
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      ReadinjoyReportUtils.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Boolean, this.jdField_b_of_type_Long);
      if (paramBoolean)
      {
  ...
  public void b()
  {
    for (;;)
    {
      try
      {
        ...
        int m = ((QQAppInterface)localObject1).getMessageFacade().b();
