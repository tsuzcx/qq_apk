  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    VideoRecommendManager.a(this.this$0, ReadInJoyHelper.R((AppRuntime)localObject));
    VideoRecommendManager.b(this.this$0, ReadInJoyHelper.S((AppRuntime)localObject));
    VideoRecommendManager.a(this.this$0, ReadInJoyHelper.T((AppRuntime)localObject));
    VideoRecommendManager.c(this.this$0, ReadInJoyHelper.U((AppRuntime)localObject));
    ...
    if (VideoRecommendManager.b(this.this$0) < 1000) {
      VideoRecommendManager.b(this.this$0, 40000);
    }
    if (VideoRecommendManager.c(this.this$0) == 1) {
    ...
    if (QLog.isColorLevel())
    {
      ...
      ((StringBuilder)localObject).append(VideoRecommendManager.d(this.this$0));
      ...
      ((StringBuilder)localObject).append(VideoRecommendManager.e(this.this$0));
