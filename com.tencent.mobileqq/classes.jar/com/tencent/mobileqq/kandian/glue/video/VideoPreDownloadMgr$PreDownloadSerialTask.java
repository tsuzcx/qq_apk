      ...
      if ((localObject1 != null) && (((List)localObject1).size() != 0))
      {
        ...
        if (QLog.isColorLevel())
        {
          ...
          for (localObject1 = ""; ((Iterator)localObject2).hasNext(); localObject1 = localStringBuilder.toString())
          {
            ...
            localStringBuilder.append(((VideoPreDownloadMgr.VideoPreDownloadParam)localObject3).jdField_a_of_type_JavaLangString);
            localStringBuilder.append(" | ");
          }
          localObject2 = VideoPreDownloadMgr.a();
        ...
        if (this.a.size() != 0)
        {
          ...
          localObject2 = VideoPreDownloadMgr.a(this.this$0);
