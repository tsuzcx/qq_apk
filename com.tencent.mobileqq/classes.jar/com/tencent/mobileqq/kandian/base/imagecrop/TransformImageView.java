  ...
  extends ImageView
{
  ...
  protected void b()
  {
    ...
    localObject = this.jdField_a_of_type_ComTencentMobileqqKandianBaseImagecropTransformImageView$TransformImageListener;
    if (localObject != null) {
  ...
  public void c(float paramFloat1, float paramFloat2, float paramFloat3)
  {
    if (paramFloat1 != 0.0F)
    {
      ...
      setImageMatrix(this.jdField_a_of_type_AndroidGraphicsMatrix);
      TransformImageView.TransformImageListener localTransformImageListener = this.jdField_a_of_type_ComTencentMobileqqKandianBaseImagecropTransformImageView$TransformImageListener;
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqKandianBaseImagecropTransformImageView$TransformImageListener = paramTransformImageListener;
  }
}
