  ...
  extends FrameLayout
{
  ...
  public ReadInjoySlideAnimLayout(@NonNull Context paramContext, @Nullable AttributeSet paramAttributeSet)
  {
    ...
    paramContext = LayoutInflater.from(paramContext).inflate(2131560285, this, true);
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)paramContext.findViewById(2131365179));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramContext.findViewById(2131376344));
  }
  ...
  public void a()
  {
    ...
    if (localView != null) {
      this.jdField_a_of_type_AndroidWidgetFrameLayout.removeView(localView);
    }
  }
