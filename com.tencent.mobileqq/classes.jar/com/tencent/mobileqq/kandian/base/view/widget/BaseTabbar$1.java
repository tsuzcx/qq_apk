  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    if (i != 0)
    {
      if (i != 1)
      {
        ...
        BaseTabbar.a(this.a);
        paramMessage = this.a;
        paramMessage.a(BaseTabbar.a(paramMessage), BaseTabbar.b(this.a));
        BaseTabbar.a(this.a, 1.0F);
        paramMessage = this.a;
        BaseTabbar.a(paramMessage, BaseTabbar.b(paramMessage));
        this.a.invalidate();
    ...
    {
      paramMessage = this.a;
      BaseTabbar.a(paramMessage, BaseTabbar.a(paramMessage), BaseTabbar.b(this.a));
    }
  }
}
