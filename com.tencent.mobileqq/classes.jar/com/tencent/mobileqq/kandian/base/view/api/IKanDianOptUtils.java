...
@QAPI(process={"all"})
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/mobileqq/kandian/base/view/api/IKanDianOptUtils;", "Lcom/tencent/mobileqq/qroute/QRouteApi;", "generateTabItem", "Landroid/view/View;", "faceId", "", "bgId", "facePressId", "bgPressId", "strId", "animateTag", "apngPlayTag", "isMainFrameInInit", "", "updateMainFrameInitStatus", "", "isRunning", "kandian-api_release"}, k=1, mv={1, 1, 16})
