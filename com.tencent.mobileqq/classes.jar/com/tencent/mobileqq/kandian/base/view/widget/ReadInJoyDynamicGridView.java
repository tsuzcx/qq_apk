  ...
  extends GridView
{
  ...
  private AdapterView.OnItemClickListener C = new ReadInJoyDynamicGridView.1(this);
  private ReadInJoyDynamicGridView.OnSelectedItemBitmapCreationListener D;
  private View E;
  private boolean F;
  private AbsListView.OnScrollListener G = new ReadInJoyDynamicGridView.6(this);
  ...
  private ReadInJoyDynamicGridView.OnDropListener x;
  private ReadInJoyDynamicGridView.OnDragListener y;
  private ReadInJoyDynamicGridView.OnEditModeChangeListener z;
  ...
  private void a(int paramInt1, int paramInt2, View paramView)
  {
    if (paramView != null)
    {
      int i1 = getPositionForView(this.E);
      int i2 = getPositionForView(paramView);
      paramView = getAdapterInterface();
      if ((i2 != -1) && (paramView.b(i1)) && (paramView.b(i2)) && (i2 >= this.A))
      {
        b(i1, i2);
        this.g = this.h;
        this.f = this.i;
  ...
  private void b(int paramInt)
  {
    ...
    if (localObject != null)
    {
      ...
      ReadInJoyDynamicGridView.OnSelectedItemBitmapCreationListener localOnSelectedItemBitmapCreationListener = this.D;
      ...
      localOnSelectedItemBitmapCreationListener = this.D;
      if (localOnSelectedItemBitmapCreationListener != null) {
      ...
      localObject = this.y;
      if (localObject != null) {
        ((ReadInJoyDynamicGridView.OnDragListener)localObject).p_(paramInt);
      }
    }
  }
  ...
  {
    ReadInJoyDynamicGridView.OnDragListener localOnDragListener = this.y;
    if (localOnDragListener != null) {
      localOnDragListener.a(paramInt1, paramInt2);
    }
    getAdapterInterface().c_(paramInt1, paramInt2);
  }
  ...
  private void c(long paramLong)
  {
    ...
    {
      if ((i2 != i1) && (getAdapterInterface().b(i1))) {
  ...
  private ReadInJoyDynamicGridView.DynamicGridAdapterInterface getAdapterInterface()
  {
  ...
  private void i()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      {
        float f4 = Math.abs(a(localView) - a(this.E));
        float f3 = Math.abs(b(localView) - b(this.E));
        if ((f4 >= f1) && (f3 >= f2))
        {
          f1 = f4;
          f2 = f3;
  ...
  public void a()
  {
    ...
    ReadInJoyDynamicGridView.OnEditModeChangeListener localOnEditModeChangeListener = this.z;
  ...
  public boolean a(int paramInt1, int paramInt2)
  {
    ...
    getAdapterInterface().a(paramInt1);
  ...
  public boolean dispatchTouchEvent(MotionEvent paramMotionEvent)
  {
    if ((paramMotionEvent.getAction() & 0xFF) == 2) {
      return (this.s) && (super.dispatchTouchEvent(paramMotionEvent));
    }
  ...
  {
    this.D = paramOnSelectedItemBitmapCreationListener;
  }
}
