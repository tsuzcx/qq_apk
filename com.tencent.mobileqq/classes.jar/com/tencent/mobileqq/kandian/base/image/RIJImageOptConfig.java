...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/mobileqq/kandian/base/image/RIJImageOptConfig;", "Lcom/tencent/mobileqq/kandian/base/image/api/IRIJImageOptConfig;", "()V", "FILE_TYPE_SHARPP", "", "FILE_TYPE_WEBP", "bitmapOpt", "decodeHttpStream", "fileTypeOpt", "isBitmapOpt", "", "()Z", "isDecodeHttpStream", "isLifoOn", "isRenderFirst", "isReportOn", "lifoOn", "monitorTime", "", "renderFirst", "reportOn", "useInnerDns", "useKandianIpConnect", "decodeSharpP", "Landroid/graphics/Bitmap;", "path", "", "dstWidth", "dstHeight", "config", "reuseBitmap", "decodeSharpPInBounds", "Landroid/graphics/BitmapFactory$Options;", "filePath", "getMonitorTime", "isSharpPAvailable", "setBitmapOpt", "", "setDecodeHttpStream", "setFileTypeOpt", "setLifoOn", "setMonitorTime", "setRenderFirst", "setReportOn", "setUseInnerDns", "setUseKanDianIpConnect", "useKanDianIpConnect", "useIpConnect", "useSharpP", "useWebp", "kandian_feature_impl_release"}, k=1, mv={1, 1, 16})
