...
public class RIJYoungsterModule
{
  public static void a()
  {
    ...
    long l2 = ((Long)RIJSPUtils.a("key_sp_readinjoy_youngster_last_pull_time", Long.valueOf(0L))).longValue();
    int i = 0;
    if (((Integer)RIJSPUtils.a("key_sp_is_readinjoy_youngster", Integer.valueOf(0))).intValue() == 0) {
      i = 1;
    }
    ...
    localGetFlagInfoReq.rpt_uint64_uin_list.add(Long.valueOf(RIJQQAppInterfaceUtil.a()));
    localGetFlagInfoReq.uint32_need_teenager_flag.set(1);
    localReqBody.msg_get_flag_info_req.set(localGetFlagInfoReq);
    ProtoUtils.a((QQAppInterface)RIJQQAppInterfaceUtil.a(), new RIJYoungsterModule.1(), localReqBody.toByteArray(), "OidbSvc.0xe1b", 3611, 1);
  }
}
