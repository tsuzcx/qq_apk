...
public final class RIJUtilsHelper
{
  ...
  public RIJUtilsHelper(@NotNull AbsBaseArticleInfo paramAbsBaseArticleInfo)
  {
    ...
    Pair localPair1 = TuplesKt.to(paramAbsBaseArticleInfo, Integer.valueOf(b(this.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityAbsBaseArticleInfo)));
    Pair localPair2 = TuplesKt.to(Integer.valueOf(39), Integer.valueOf(b(this.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityAbsBaseArticleInfo)));
    Pair localPair3 = TuplesKt.to(Integer.valueOf(116), Integer.valueOf(b(this.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityAbsBaseArticleInfo)));
    Pair localPair4 = TuplesKt.to(Integer.valueOf(3), Integer.valueOf(c(this.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityAbsBaseArticleInfo)));
    Pair localPair5 = TuplesKt.to(Integer.valueOf(105), Integer.valueOf(c(this.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityAbsBaseArticleInfo)));
    Integer localInteger1 = Integer.valueOf(4);
    Pair localPair6 = TuplesKt.to(Integer.valueOf(106), Integer.valueOf(d(this.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityAbsBaseArticleInfo)));
    Pair localPair7 = TuplesKt.to(Integer.valueOf(104), Integer.valueOf(d(this.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityAbsBaseArticleInfo)));
    Pair localPair8 = TuplesKt.to(Integer.valueOf(1), Integer.valueOf(d(this.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityAbsBaseArticleInfo)));
    Pair localPair9 = TuplesKt.to(Integer.valueOf(0), localInteger1);
    Pair localPair10 = TuplesKt.to(localInteger1, Integer.valueOf(e(this.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityAbsBaseArticleInfo)));
    Pair localPair11 = TuplesKt.to(Integer.valueOf(6), Integer.valueOf(e(this.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityAbsBaseArticleInfo)));
    Integer localInteger2 = Integer.valueOf(10);
    Pair localPair12 = TuplesKt.to(Integer.valueOf(126), Integer.valueOf(e(this.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityAbsBaseArticleInfo)));
    Pair localPair13 = TuplesKt.to(Integer.valueOf(66), Integer.valueOf(e(this.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityAbsBaseArticleInfo)));
    Pair localPair14 = TuplesKt.to(Integer.valueOf(115), Integer.valueOf(e(this.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityAbsBaseArticleInfo)));
    Pair localPair15 = TuplesKt.to(Integer.valueOf(5), Integer.valueOf(f(this.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityAbsBaseArticleInfo)));
    ...
    Pair localPair33 = TuplesKt.to(Integer.valueOf(26), Integer.valueOf(g(this.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityAbsBaseArticleInfo)));
    ...
    Pair localPair52 = TuplesKt.to(Integer.valueOf(40), Integer.valueOf(h(this.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityAbsBaseArticleInfo)));
    Pair localPair53 = TuplesKt.to(Integer.valueOf(42), Integer.valueOf(h(this.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityAbsBaseArticleInfo)));
    Pair localPair54 = TuplesKt.to(Integer.valueOf(41), Integer.valueOf(h(this.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityAbsBaseArticleInfo)));
    Integer localInteger5 = Integer.valueOf(54);
    this.jdField_a_of_type_JavaUtilMap = MapsKt.mapOf(new Pair[] { localPair1, localPair2, localPair3, localPair4, localPair5, localPair6, localPair7, localPair8, localPair9, localPair10, localPair11, localPair12, localPair13, localPair14, localPair15, localPair16, localPair17, localPair18, localPair19, localPair20, localPair21, localPair22, localPair23, localPair24, localPair25, localPair26, localPair27, localPair28, localPair29, localPair30, localPair31, localPair32, localPair33, localPair34, localPair35, localPair36, localPair37, localPair38, localPair39, localPair40, localPair41, localPair42, localPair43, localPair44, localPair45, localObject, localPair46, localPair47, localPair48, localPair49, localPair50, localPair51, localPair52, localPair53, localPair54, TuplesKt.to(Integer.valueOf(44), localInteger2), TuplesKt.to(Integer.valueOf(43), Integer.valueOf(19)), TuplesKt.to(Integer.valueOf(45), Integer.valueOf(37)), TuplesKt.to(Integer.valueOf(46), Integer.valueOf(43)), TuplesKt.to(localInteger5, Integer.valueOf(i(this.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityAbsBaseArticleInfo))), TuplesKt.to(Integer.valueOf(55), Integer.valueOf(i(this.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityAbsBaseArticleInfo))), TuplesKt.to(Integer.valueOf(56), Integer.valueOf(i(this.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityAbsBaseArticleInfo))), TuplesKt.to(Integer.valueOf(57), localInteger3), TuplesKt.to(Integer.valueOf(58), Integer.valueOf(30)), TuplesKt.to(Integer.valueOf(59), Integer.valueOf(31)), TuplesKt.to(Integer.valueOf(53), localInteger4), TuplesKt.to(Integer.valueOf(50), localInteger4), TuplesKt.to(Integer.valueOf(51), localInteger4), TuplesKt.to(Integer.valueOf(52), localInteger4), TuplesKt.to(localInteger4, Integer.valueOf(j(this.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityAbsBaseArticleInfo))), TuplesKt.to(Integer.valueOf(48), Integer.valueOf(j(this.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityAbsBaseArticleInfo))), TuplesKt.to(Integer.valueOf(101), Integer.valueOf(1005)), TuplesKt.to(Integer.valueOf(102), Integer.valueOf(1006)), TuplesKt.to(Integer.valueOf(103), Integer.valueOf(1007)), TuplesKt.to(Integer.valueOf(60), Integer.valueOf(k(this.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityAbsBaseArticleInfo))), TuplesKt.to(Integer.valueOf(64), Integer.valueOf(k(this.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityAbsBaseArticleInfo))), TuplesKt.to(Integer.valueOf(96), Integer.valueOf(80)), TuplesKt.to(Integer.valueOf(61), Integer.valueOf(50)), TuplesKt.to(Integer.valueOf(65), Integer.valueOf(50)), TuplesKt.to(Integer.valueOf(49), Integer.valueOf(51)), TuplesKt.to(Integer.valueOf(62), Integer.valueOf(52)), TuplesKt.to(Integer.valueOf(63), Integer.valueOf(53)), TuplesKt.to(Integer.valueOf(68), localInteger5), TuplesKt.to(Integer.valueOf(69), localInteger5), TuplesKt.to(Integer.valueOf(67), localInteger5), TuplesKt.to(Integer.valueOf(72), Integer.valueOf(l(this.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityAbsBaseArticleInfo))), TuplesKt.to(Integer.valueOf(73), Integer.valueOf(m(this.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityAbsBaseArticleInfo))), TuplesKt.to(Integer.valueOf(74), Integer.valueOf(65)), TuplesKt.to(Integer.valueOf(75), Integer.valueOf(66)), TuplesKt.to(Integer.valueOf(82), Integer.valueOf(70)), TuplesKt.to(Integer.valueOf(87), Integer.valueOf(73)), TuplesKt.to(Integer.valueOf(88), Integer.valueOf(74)), TuplesKt.to(Integer.valueOf(90), Integer.valueOf(72)), TuplesKt.to(Integer.valueOf(91), Integer.valueOf(71)), TuplesKt.to(Integer.valueOf(80), Integer.valueOf(n(this.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityAbsBaseArticleInfo))), TuplesKt.to(Integer.valueOf(81), Integer.valueOf(n(this.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityAbsBaseArticleInfo))), TuplesKt.to(Integer.valueOf(89), Integer.valueOf(75)), TuplesKt.to(Integer.valueOf(92), Integer.valueOf(75)), TuplesKt.to(Integer.valueOf(93), Integer.valueOf(77)), TuplesKt.to(Integer.valueOf(107), Integer.valueOf(999)), TuplesKt.to(Integer.valueOf(108), Integer.valueOf(998)), TuplesKt.to(Integer.valueOf(109), Integer.valueOf(1023)), TuplesKt.to(Integer.valueOf(112), Integer.valueOf(1023)), TuplesKt.to(Integer.valueOf(110), Integer.valueOf(1024)), TuplesKt.to(Integer.valueOf(113), Integer.valueOf(1024)), TuplesKt.to(Integer.valueOf(111), Integer.valueOf(1025)), TuplesKt.to(Integer.valueOf(114), Integer.valueOf(1025)), TuplesKt.to(Integer.valueOf(118), Integer.valueOf(1028)), TuplesKt.to(Integer.valueOf(124), Integer.valueOf(1032)), TuplesKt.to(Integer.valueOf(125), Integer.valueOf(1033)), TuplesKt.to(Integer.valueOf(123), Integer.valueOf(1034)), TuplesKt.to(Integer.valueOf(128), Integer.valueOf(1035)), TuplesKt.to(Integer.valueOf(129), Integer.valueOf(2004)), TuplesKt.to(Integer.valueOf(137), Integer.valueOf(1043)), TuplesKt.to(Integer.valueOf(139), Integer.valueOf(1043)), TuplesKt.to(Integer.valueOf(138), Integer.valueOf(1043)) });
    this.b = MapsKt.mapOf(new Pair[] { TuplesKt.to(paramAbsBaseArticleInfo, Integer.valueOf(12)), TuplesKt.to(Integer.valueOf(3), Integer.valueOf(13)), TuplesKt.to(Integer.valueOf(1), Integer.valueOf(14)), TuplesKt.to(Integer.valueOf(0), Integer.valueOf(15)), TuplesKt.to(localInteger1, Integer.valueOf(16)), TuplesKt.to(Integer.valueOf(8), Integer.valueOf(17)), TuplesKt.to(Integer.valueOf(7), Integer.valueOf(17)) });
    this.c = MapsKt.mapOf(new Pair[] { TuplesKt.to(Integer.valueOf(1), Integer.valueOf(1038)), TuplesKt.to(Integer.valueOf(3), Integer.valueOf(1040)), TuplesKt.to(localInteger1, Integer.valueOf(1041)), TuplesKt.to(paramAbsBaseArticleInfo, Integer.valueOf(1039)), TuplesKt.to(Integer.valueOf(19191924), Integer.valueOf(1042)) });
    this.d = MapsKt.mapOf(new Pair[] { TuplesKt.to(Integer.valueOf(33), Integer.valueOf(1031)), TuplesKt.to(localInteger3, Integer.valueOf(o(this.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityAbsBaseArticleInfo))), TuplesKt.to(Integer.valueOf(58), Integer.valueOf(1056)) });
  }
  ...
  {
    if (RIJFeedsType.d(paramAbsBaseArticleInfo) == 32) {
      return 2006;
    }
    return 31;
  }
  ...
  {
    if ((paramAbsBaseArticleInfo.mSocialFeedInfo != null) && (paramAbsBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityWendaInfo != null) && (paramAbsBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityWendaInfo.a)) {
      return 62;
    }
    return 61;
  }
  ...
  {
    if ((paramAbsBaseArticleInfo.mSocialFeedInfo != null) && (paramAbsBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityIconWordingInfo != null)) {
      return paramAbsBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityIconWordingInfo.a;
    }
    return 0;
  }
  ...
  private final int o(AbsBaseArticleInfo paramAbsBaseArticleInfo)
  {
    if (paramAbsBaseArticleInfo.mProteusTemplateBean != null) {
      return ProteusReportUtil.a(paramAbsBaseArticleInfo.mProteusTemplateBean);
    }
    return 0;
  }
