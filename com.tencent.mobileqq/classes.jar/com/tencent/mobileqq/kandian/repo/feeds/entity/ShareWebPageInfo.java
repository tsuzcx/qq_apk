...
public class ShareWebPageInfo
{
  ...
  public static ShareWebPageInfo a(feeds_info.ShareWebPageInfo paramShareWebPageInfo)
  {
    ...
    ShareWebPageInfo localShareWebPageInfo = new ShareWebPageInfo();
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ShareWebPageInfo", 2, "WebSharePageInfo core info is empty!");
    }
    return null;
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.kandian.repo.feeds.entity.ShareWebPageInfo
