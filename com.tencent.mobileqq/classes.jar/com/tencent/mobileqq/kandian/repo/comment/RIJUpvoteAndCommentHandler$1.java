  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    ((oidb_cmd0x8c8.ReqBody)localObject2).uint64_uin.set(Long.valueOf(RIJQQAppInterfaceUtil.a()).longValue());
    ...
    do
    {
      ...
      if (localAbsBaseArticleInfo.mSocialFeedInfo != null) {
        ((oidb_cmd0x8c8.ReqMsgInfo)localObject4).uint32_feeds_style.set(localAbsBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Int);
      }
      ((oidb_cmd0x8c8.ReqMsgInfo)localObject4).feeds_type.set(localAbsBaseArticleInfo.mFeedType);
      if ((localAbsBaseArticleInfo.mFeedType == 14) && (localAbsBaseArticleInfo.mTopicRecommendFeedsInfo != null) && (localAbsBaseArticleInfo.mTopicRecommendFeedsInfo.a != null))
      {
        Iterator localIterator = localAbsBaseArticleInfo.mTopicRecommendFeedsInfo.a.iterator();
        while (localIterator.hasNext())
        {
          ...
          ((oidb_cmd0x8c8.ReqMsgInfo)localObject4).rpt_topic_id.add(Integer.valueOf(localTopicRecommendInfo.jdField_a_of_type_Int));
        }
      }
    ...
    RIJUpvoteAndCommentHandler.a(this.this$0).sendPbReq((ToServiceMsg)localObject2);
  }
}
