  ...
  extends SimpleConfigHandler
{
  public boolean onReceiveConfig(int paramInt1, int paramInt2, String paramString)
  {
    ...
    QLog.d("KingCardConfigHandler", 2, ((StringBuilder)localObject).toString());
    ...
    try
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if (TextUtils.equals(str1, "kingcard_switch")) {
          RIJKingCardConfigSp.a(Integer.parseInt(str2));
        } else if (TextUtils.equals(str1, "kingcard_guide_url")) {
          RIJKingCardConfigSp.a(str2);
        } else if (TextUtils.equals(str1, "kingcard_tiptext")) {
          RIJKingCardConfigSp.b(str2);
        } else if (TextUtils.equals(str1, "kingcard_jumptext")) {
          RIJKingCardConfigSp.c(str2);
        }
      }
      return true;
    }
  ...
  public void onWipeConfig(int paramInt)
  {
    ...
    RIJKingCardConfigSp.a(0);
    RIJKingCardConfigSp.a("");
    RIJKingCardConfigSp.b("");
    RIJKingCardConfigSp.c("");
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes22.jar
 * Qualified Name:     com.tencent.mobileqq.kandian.repo.aladdin.handlers.KingCardConfigHandler
