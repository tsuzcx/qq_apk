...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/mobileqq/kandian/repo/aladdin/handlers/BarrageConfigHandler;", "Lcom/tencent/aladdin/config/handlers/SimpleConfigHandler;", "()V", "onReceiveConfig", "", "id", "", "version", "content", "", "onWipeConfig", "", "p0", "Companion", "kandian_feature_impl_release"}, k=1, mv={1, 1, 16})
  ...
  extends SimpleConfigHandler
{
    ...
    for (;;)
    {
      try
      {
        ...
        if (QLog.isColorLevel())
        {
          ...
          QLog.d("BarrageConfigHandler", 2, localStringBuilder.toString());
        }
        RIJBarrageConfigSp.a(paramString);
      }
      catch (UnsupportedEncodingException paramString)
      {
        ...
        localStringBuilder.append(paramString);
        QLog.e("BarrageConfigHandler", 2, localStringBuilder.toString());
      }
      return true;
      label121:
      paramString = "";
  ...
  public void onWipeConfig(int paramInt)
  {
    ...
    RIJBarrageConfigSp.a("");
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes15.jar
 * Qualified Name:     com.tencent.mobileqq.kandian.repo.aladdin.handlers.BarrageConfigHandler
