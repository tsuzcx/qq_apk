  ...
  implements AladdinConfigBean
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if (paramObject != null)
    {
      ...
      if (this.enable != paramObject.enable) {
        return false;
      }
      if (this.versionCode != paramObject.versionCode) {
        return false;
      }
      if (this.baseDelayMs != paramObject.baseDelayMs) {
        return false;
      }
      if (this.maxDownloadCount != paramObject.maxDownloadCount) {
        return false;
      }
      if (this.debounceIntervalMinutes != paramObject.debounceIntervalMinutes) {
        return false;
      }
      if (this.downloadDelayMs != paramObject.downloadDelayMs) {
        return false;
      }
      if (this.useFragmentDownload != paramObject.useFragmentDownload) {
        return false;
      }
      if (this.mustWifiDownload != paramObject.mustWifiDownload) {
        return false;
      }
      if (this.installIfJump != paramObject.installIfJump) {
        return false;
      }
      if (!this.appId.equals(paramObject.appId)) {
        return false;
      }
      if (!this.versionName.equals(paramObject.versionName)) {
        return false;
      }
      if (!this.packageName.equals(paramObject.packageName)) {
        return false;
      }
      if (!this.pushTitle.equals(paramObject.pushTitle)) {
        return false;
      }
      if (!this.md5.equals(paramObject.md5)) {
        return false;
      }
  ...
  public String toString()
  {
    ...
    localStringBuilder.append("AchillesParams{enable=");
    ...
    localStringBuilder.append('\'');
    localStringBuilder.append(", pushTitle='");
    localStringBuilder.append(this.pushTitle);
    localStringBuilder.append('\'');
    localStringBuilder.append(", baseDelayMs=");
    localStringBuilder.append(this.baseDelayMs);
    localStringBuilder.append(", maxDownloadCount=");
    localStringBuilder.append(this.maxDownloadCount);
    ...
    localStringBuilder.append('\'');
    localStringBuilder.append(", downloadDelayMs=");
    localStringBuilder.append(this.downloadDelayMs);
    localStringBuilder.append(", useFragmentDownload=");
    localStringBuilder.append(this.useFragmentDownload);
    localStringBuilder.append(", mustWifiDownload=");
    localStringBuilder.append(this.mustWifiDownload);
    localStringBuilder.append(", installIfJump=");
    localStringBuilder.append(this.installIfJump);
    localStringBuilder.append('}');
 ...
 * Qualified Name:     com.tencent.mobileqq.kandian.repo.aladdin.config.AchillesParams
