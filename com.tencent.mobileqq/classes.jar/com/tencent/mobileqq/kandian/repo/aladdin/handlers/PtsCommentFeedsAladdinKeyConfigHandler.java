...
public class PtsCommentFeedsAladdinKeyConfigHandler
  extends SimpleConfigHandler
{
  ...
  public boolean onReceiveConfig(int paramInt1, int paramInt2, String paramString)
  {
    ...
    QLog.d("PtsCommentFeedsAladdinKeyConfigHandler", 1, ((StringBuilder)localObject).toString());
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      if ("native_article_aladdin_keys".equalsIgnoreCase(str1))
      {
        ...
        QLog.d("PtsCommentFeedsAladdinKeyConfigHandler", 2, localStringBuilder.toString());
        RIJSPUtils.a("comment_feeds_aladdin_keys", str2);
      }
    }
    return true;
  }
