  ...
  extends SimpleConfigHandler
{
  public boolean onReceiveConfig(int paramInt1, int paramInt2, String paramString)
  {
    ...
    QLog.d("DefaultFeedsProteusBidConfigHandler", 1, ((StringBuilder)localObject).toString());
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      QLog.d("DefaultFeedsProteusBidConfigHandler", 2, localStringBuilder.toString());
      if (TextUtils.equals(str1, "default_feeds"))
      {
        RIJProteusOfflineBidSp.a("default_feeds_proteus_offline_bid", str2);
  ...
  public void onWipeConfig(int paramInt)
  {
    ...
    RIJProteusOfflineBidSp.a("default_feeds_proteus_offline_bid", "0");
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes22.jar
 * Qualified Name:     com.tencent.mobileqq.kandian.repo.aladdin.handlers.DefaultFeedsProteusBidConfigHandler
