...
public final class ViolaVideoFeedsConfigHandler$Companion
{
  ...
  {
    return "0".equals(RIJSPUtils.a("viola_video_feeds_version", "0"));
  }
  ...
  {
    return "1".equals(RIJSPUtils.a("viola_video_ingore_native", "0")) ^ true;
  }
  
  @JvmStatic
  public final boolean a(int paramInt)
  {
    if ("all".equals((String)RIJSPUtils.a("viola_video_feeds_config", ""))) {
      return true;
    }
