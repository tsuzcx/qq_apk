  ...
  extends SimpleConfigHandler
{
  public boolean onReceiveConfig(int paramInt1, int paramInt2, String paramString)
  {
    ...
    QLog.d("AdFeedsProteusBidConfigHandler", 1, ((StringBuilder)localObject).toString());
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      QLog.d("AdFeedsProteusBidConfigHandler", 2, localStringBuilder.toString());
      if (TextUtils.equals(str1, "commercialAd_feeds")) {
        RIJProteusOfflineBidSp.a("ad_feeds_proteus_offline_bid", str2);
      }
    }
    return true;
  }
  ...
  public void onWipeConfig(int paramInt)
  {
    ...
    RIJProteusOfflineBidSp.a("ad_feeds_proteus_offline_bid", "0");
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes15.jar
 * Qualified Name:     com.tencent.mobileqq.kandian.repo.aladdin.handlers.AdFeedsProteusBidConfigHandler
