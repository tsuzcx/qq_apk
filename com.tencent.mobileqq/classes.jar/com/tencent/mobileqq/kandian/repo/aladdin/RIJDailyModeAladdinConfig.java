...
public final class RIJDailyModeAladdinConfig
{
  ...
  public static final RIJDailyModeAladdinConfig a;
  
  static
  {
    jdField_a_of_type_ComTencentMobileqqKandianRepoAladdinRIJDailyModeAladdinConfig = new RIJDailyModeAladdinConfig();
  ...
  public final int a()
  {
    return jdField_a_of_type_ComTencentAladdinConfigAladdinConfig.getIntegerFromString("enable_dynamic_header", 0);
  }
}
