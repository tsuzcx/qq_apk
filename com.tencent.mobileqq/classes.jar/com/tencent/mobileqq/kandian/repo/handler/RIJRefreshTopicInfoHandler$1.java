  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      if (!((Boolean)this.a.get(Long.valueOf(l))).booleanValue())
      {
        Object localObject3 = (AbsBaseArticleInfo)this.b.get(Long.valueOf(l));
        if ((localObject3 != null) && (RIJFeedsType.L((AbsBaseArticleInfo)localObject3)) && (((AbsBaseArticleInfo)localObject3).mNewPolymericInfo.p != null))
        {
          localObject3 = ((AbsBaseArticleInfo)localObject3).mNewPolymericInfo.p.iterator();
          while (((Iterator)localObject3).hasNext())
          {
            ...
            if (localPackArticleInfo.p != null) {
              ((ArrayList)localObject1).add(Long.valueOf(localPackArticleInfo.p.d));
            }
          }
          this.a.put(Long.valueOf(l), Boolean.valueOf(true));
        }
      }
    }
    ...
    ((ToServiceMsg)localObject1).addAttribute("channelId", Integer.valueOf(this.c));
    ((ToServiceMsg)localObject1).addAttribute("0xa6e_articleSeqSet", this.a.keySet());
