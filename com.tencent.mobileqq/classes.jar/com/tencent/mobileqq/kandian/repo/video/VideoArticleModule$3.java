  ...
  implements Runnable
{
  public void run()
  {
    try
    {
      ...
      ((oidb_cmd0xbed.ReqChannelPara)localObject2).uint32_channel_id.set(this.a.jdField_a_of_type_Int);
      ((oidb_cmd0xbed.ReqChannelPara)localObject2).uint32_channel_type.set(this.a.jdField_b_of_type_Int);
      if (this.a.jdField_a_of_type_Long != -1L) {
        ((oidb_cmd0xbed.ReqChannelPara)localObject2).uint64_begin_recommend_seq.set(this.a.jdField_a_of_type_Long);
      }
      if (this.a.jdField_b_of_type_Long != -1L) {
        ((oidb_cmd0xbed.ReqChannelPara)localObject2).uint64_end_recommend_seq.set(this.a.jdField_b_of_type_Long);
      }
      if (!TextUtils.isEmpty(this.a.jdField_a_of_type_JavaLangString)) {
        ((oidb_cmd0xbed.ReqChannelPara)localObject2).bytes_begin_recommend_rowkey.set(ByteStringMicro.copyFromUtf8(this.a.jdField_a_of_type_JavaLangString));
      }
      if (!TextUtils.isEmpty(this.a.jdField_b_of_type_JavaLangString)) {
        ((oidb_cmd0xbed.ReqChannelPara)localObject2).bytes_end_recommend_rowkey.set(ByteStringMicro.copyFromUtf8(this.a.jdField_b_of_type_JavaLangString));
      }
      ((oidb_cmd0xbed.ReqChannelPara)localObject2).uint64_begin_collection_id.set(this.a.jdField_c_of_type_Long);
      ((oidb_cmd0xbed.ReqChannelPara)localObject2).uint64_end_collection_id.set(this.a.jdField_d_of_type_Long);
      ...
      ((oidb_cmd0xbed.ReqChannelPara)localObject2).uint32_update_times.set(this.a.jdField_c_of_type_Int);
      ...
      if (this.a.jdField_a_of_type_ArrayOfByte != null) {
        ((oidb_cmd0xbed.ReqChannelPara)localObject2).bytes_business_info.set(ByteStringMicro.copyFrom(this.a.jdField_a_of_type_ArrayOfByte));
      }
      if ((this.a.jdField_a_of_type_JavaUtilList != null) && (this.a.jdField_a_of_type_JavaUtilList.size() > 0))
      {
        ((oidb_cmd0xbed.ReqChannelPara)localObject2).rpt_subscription_article_list.set(this.a.jdField_a_of_type_JavaUtilList);
        ...
        while (localIterator.hasNext())
        {
          ...
          if (!TextUtils.isEmpty(this.a.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityReadInJoyRequestParams$Request0xbedParams$InnerMsg.c))
          {
            localInnerMsg.bytes_push_context.set(ByteStringMicro.copyFromUtf8(this.a.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityReadInJoyRequestParams$Request0xbedParams$InnerMsg.c));
            if (QLog.isColorLevel())
            {
              localObject4 = VideoArticleModule.jdField_a_of_type_JavaLangString;
              StringBuilder localStringBuilder = new StringBuilder();
              localStringBuilder.append("add push contenxt:");
              localStringBuilder.append(this.a.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityReadInJoyRequestParams$Request0xbedParams$InnerMsg.c);
              QLog.d((String)localObject4, 2, localStringBuilder.toString());
            }
          }
          localInnerMsg.uint64_algorithm_id.set(this.a.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityReadInJoyRequestParams$Request0xbedParams$InnerMsg.jdField_a_of_type_Long);
          localInnerMsg.uint32_strategy_id.set(this.a.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityReadInJoyRequestParams$Request0xbedParams$InnerMsg.jdField_a_of_type_Int);
      ...
      {
        ((ToServiceMsg)localObject1).getAttributes().put("channelID", Integer.valueOf(this.a.jdField_a_of_type_Int));
        ((ToServiceMsg)localObject1).getAttributes().put("BeginSeq", Long.valueOf(this.a.jdField_a_of_type_Long));
        ((ToServiceMsg)localObject1).getAttributes().put("EndSeq", Long.valueOf(this.a.jdField_b_of_type_Long));
    ...
    catch (Throwable localThrowable)
    {
      ...
      if (QLog.isColorLevel())
      {
        localObject2 = VideoArticleModule.jdField_a_of_type_JavaLangString;
