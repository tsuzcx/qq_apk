...
{
  public static final RIJWebTemplateFactory a = new RIJWebTemplateFactory();
  private static final HashMap<String, String> b = new HashMap();
  private static final HashMap<String, Template> c = new HashMap();
  
  private final Template c(String paramString)
  {
    try
    {
  ...
  private final void d(String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: checkcast 132	java/io/InputStream
    //   4: astore 4
    //   6: getstatic 138	com/tencent/common/app/BaseApplicationImpl:context	Lcom/tencent/qphone/base/util/BaseApplication;
    //   9: astore 5
    //   11: aload 5
    //   13: ifnull +312 -> 325
    //   16: aload 4
    ...
    //   22: aload_0
    //   23: aload_1
    //   24: invokespecial 140	com/tencent/mobileqq/kandian/repo/webarticle/RIJWebTemplateFactory:e	(Ljava/lang/String;)Ljava/lang/String;
    //   27: astore 6
    //   29: aload 4
    //   31: astore_2
    //   32: aload 4
    //   34: astore_3
    //   35: aload 5
    //   37: invokevirtual 146	com/tencent/qphone/base/util/BaseApplication:getAssets	()Landroid/content/res/AssetManager;
    //   40: aload 6
    //   42: invokevirtual 152	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   45: astore 4
    //   47: aload 4
    //   49: astore_2
    //   50: aload 4
    //   52: astore_3
    //   53: aload 4
    //   55: invokevirtual 156	java/io/InputStream:available	()I
    //   58: newarray byte
    //   60: astore 5
    //   62: aload 4
    //   64: astore_2
    ...
    //   68: aload 4
    //   70: aload 5
    //   72: invokevirtual 160	java/io/InputStream:read	([B)I
    //   75: pop
    //   76: aload 4
    //   78: astore_2
    //   79: aload 4
    //   81: astore_3
    //   82: getstatic 50	com/tencent/mobileqq/kandian/repo/webarticle/RIJWebTemplateFactory:b	Ljava/util/HashMap;
    //   85: checkcast 90	java/util/Map
    //   88: aload_1
    //   89: new 162	java/lang/String
    //   92: dup
    //   93: aload 5
    //   95: getstatic 168	kotlin/text/Charsets:UTF_8	Ljava/nio/charset/Charset;
    //   98: invokespecial 171	java/lang/String:<init>	([BLjava/nio/charset/Charset;)V
    //   101: invokeinterface 102 3 0
    //   106: pop
    //   107: aload 4
    //   109: astore_2
    //   110: aload 4
    ...
    //   116: dup
    //   117: invokespecial 105	java/lang/StringBuilder:<init>	()V
    //   120: astore 5
    //   122: aload 4
    //   124: astore_2
    //   125: aload 4
    ...
    //   157: iconst_1
    //   158: aload 5
    //   160: invokevirtual 120	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   163: invokestatic 176	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   166: aload 4
    //   168: ifnull +111 -> 279
    //   171: aload 4
    //   173: invokevirtual 179	java/io/InputStream:close	()V
    //   176: return
    //   177: astore_2
    //   178: new 104	java/lang/StringBuilder
    //   181: dup
    //   182: invokespecial 105	java/lang/StringBuilder:<init>	()V
    //   185: astore_1
    //   186: aload_1
    //   187: ldc 181
    //   189: invokevirtual 111	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   192: pop
    //   193: aload_1
    //   194: aload_2
    //   195: invokevirtual 114	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   198: pop
    //   199: ldc 116
    //   201: iconst_1
    //   202: aload_1
    //   203: invokevirtual 120	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   206: invokestatic 176	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   209: return
    //   210: astore_1
    //   211: goto +69 -> 280
    //   214: astore_1
    ...
    //   238: aload 4
    //   240: aload_1
    //   241: invokevirtual 114	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   244: pop
    //   245: aload_3
    //   246: astore_2
    //   247: ldc 116
    //   249: iconst_1
    //   250: aload 4
    //   252: invokevirtual 120	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   255: invokestatic 176	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   258: aload_3
    //   259: ifnull +20 -> 279
    //   262: aload_3
    //   263: invokevirtual 179	java/io/InputStream:close	()V
    //   266: return
    //   267: astore_2
    //   268: new 104	java/lang/StringBuilder
    //   271: dup
    //   272: invokespecial 105	java/lang/StringBuilder:<init>	()V
    //   275: astore_1
    //   276: goto -90 -> 186
    //   279: return
    //   280: aload_2
    //   281: ifnull +42 -> 323
    //   284: aload_2
    //   285: invokevirtual 179	java/io/InputStream:close	()V
    //   288: goto +35 -> 323
    //   291: astore_2
    //   292: new 104	java/lang/StringBuilder
    //   295: dup
    //   296: invokespecial 105	java/lang/StringBuilder:<init>	()V
    //   299: astore_3
    //   300: aload_3
    //   301: ldc 181
    ...
    //   307: aload_3
    //   308: aload_2
    //   309: invokevirtual 114	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   312: pop
    //   313: ldc 116
    //   315: iconst_1
    //   316: aload_3
    //   317: invokevirtual 120	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   320: invokestatic 176	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   323: aload_1
    //   324: athrow
    //   325: return
  ...
  public final Template a(@NotNull String paramString)
  {
    ...
    Object localObject2 = (Template)c.get(paramString);
