...
public class MultiVideoHelper
{
  ...
  public static Bundle a()
  {
    ...
    try
    {
      ...
      localJSONObject2.put("videoBarrageConfig", RIJBarrageConfigSp.c());
      localJSONObject2.put("dynamicVersionALDConfig", a(346));
  ...
  public static Bundle a(Intent paramIntent)
  {
    ...
    try
    {
      ...
      JSONObject localJSONObject2 = new JSONObject();
      localJSONObject2.put("from", paramIntent.getIntExtra("VIDEO_FROM_TYPE", -1));
      localJSONObject2.put("source", paramIntent.getIntExtra("key_source", -1));
      localJSONObject2.put("senceType", paramIntent.getIntExtra("RETURN_SCENE", 0));
      localJSONObject1.put("configModel", localObject);
      localJSONObject1.put("reportConfig", localJSONObject2);
      localJSONObject1.put("need_add_aladdin_config", true);
      localJSONObject1.put("runtimeName", paramIntent.getStringExtra("runtimeName"));
    }
    catch (JSONException paramIntent)
    {
      if (QLog.isColorLevel()) {
        QLog.e(a, 2, "generateParamsForViola: json error ", paramIntent);
      }
    }
    localBundle.putString("param", localJSONObject1.toString());
    if (QLog.isColorLevel())
  ...
  public static QBaseFragment a(Context paramContext, Bundle paramBundle, TabChannelCoverInfo paramTabChannelCoverInfo)
  {
    ...
    ((StringBuilder)localObject1).append(ViolaAccessHelper.d(paramTabChannelCoverInfo.mChannelCoverId));
  ...
  public static VideoInfo a(Bundle paramBundle)
  {
    ...
    if (paramBundle.getParcelable("VIDEO_OBJ") != null)
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        localStringBuilder.append(((VideoInfo)localObject1).q());
        QLog.d((String)localObject2, 2, localStringBuilder.toString());
      }
      paramBundle.putString("VIDEO_ARTICLE_ID", ((VideoInfo)localObject1).l);
      return localObject1;
    }
    ...
    if (QLog.isColorLevel())
    {
      ...
      ((StringBuilder)localObject2).append(paramBundle.q());
  ...
  private static String a(Intent paramIntent, VideoInfo paramVideoInfo)
  {
    ...
    if (localURL != null) {
      paramIntent = a(localURL.toString());
    }
    return paramIntent;
  }
  ...
  public static void a(Activity paramActivity, Intent paramIntent, int paramInt)
  {
    ...
    localIntent.putExtra("runtimeName", "video");
    paramIntent = a(localIntent);
    paramIntent.putInt("requestCode", paramInt);
    ViolaAccessHelper.a(paramActivity, null, b(localIntent), paramIntent, true);
  }
  ...
  public static void a(AbsBaseArticleInfo paramAbsBaseArticleInfo, Context paramContext)
  {
    if ((a(paramAbsBaseArticleInfo)) && ((paramContext instanceof Activity))) {
      try
      {
        paramContext = VideoFeedsHelper.e((Activity)paramContext, paramAbsBaseArticleInfo.mVideoJsonWidth, paramAbsBaseArticleInfo.mVideoJsonHeight);
        ...
        localImageRequest.a = paramContext;
        localImageRequest.c = paramAbsBaseArticleInfo.getFirstFrameHeight();
        localImageRequest.b = paramAbsBaseArticleInfo.getFirstFrameWidth();
        localImageRequest.e = true;
        ImageManager.get().loadImage(localImageRequest, new MultiVideoHelper.1(paramAbsBaseArticleInfo, paramContext));
        return;
      }
      catch (Exception paramAbsBaseArticleInfo)
      {
        QLog.e(a, 2, paramAbsBaseArticleInfo.getMessage());
      }
    }
  }
  ...
  public static String b()
  {
    ...
    {
      QLog.e(a, 1, localException.getMessage());
    }
  }
  
  private static String b(Intent paramIntent)
  {
    String str = f(paramIntent);
  ...
  private static String b(VideoInfo paramVideoInfo, Intent paramIntent)
  {
    if (paramIntent != null) {
    ...
    return paramVideoInfo.B;
  }
  
  public static JSONObject c()
  {
    JSONObject localJSONObject = new JSONObject();
    localJSONObject.put("uint32_youngster_status", RIJSPUtils.b("key_sp_is_readinjoy_youngster", Integer.valueOf(0)));
    localJSONObject.put("uint32_req_recommend_flag", VideoPlayRecommendHandler.a());
    localJSONObject.put("bytes_req_recommend_json", RIJStudyModeUtils.c());
    return localJSONObject;
  }
  ...
  public static String d()
  {
    try
    {
      String str1 = ReadInJoyUserInfoModule.a(ReadInJoyUserInfoModule.a(RIJQQAppInterfaceUtil.c(), null));
      return str1;
    }
  ...
  private static JSONObject d(Intent paramIntent)
  {
    if (paramIntent == null) {
      return null;
    }
    ...
    if (!TextUtils.isEmpty(paramIntent))
    {
      ...
      {
        QLog.e(a, 1, paramIntent.getMessage());
      }
    }
    return null;
  }
  
  private static JSONObject e(Intent paramIntent)
  {
    ...
    JSONObject localJSONObject1 = new JSONObject();
    JSONObject localJSONObject2 = localJSONObject1.put("commentId", localAnchorData.a).put("commenId", localAnchorData.a).put("subCommentId", localAnchorData.b);
    if (localAnchorData.d) {
      paramIntent = "0";
    } else {
      paramIntent = "1";
    }
    localJSONObject2.put("jumpCommentType", paramIntent).put("isAwesome", localAnchorData.c);
  ...
  private static String f(Intent paramIntent)
  {
    ...
    if (MultiVideoConfigHandler.a(k, i, j)) {
      ...
      paramIntent = ViolaAccessHelper.e();
    } else {
      paramIntent = ViolaAccessHelper.e();
    }
