  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    localReportInfoReq.basic_info.version.set("8.7.0.5295");
    localReportInfoReq.basic_info.setHasFlag(true);
    localReportInfoReq.video_info.busitype.set(this.a.b);
    ...
    localReportInfoReq.video_info.weight.set(this.a.l);
    localReportInfoReq.video_info.height.set(this.a.m);
    localReportInfoReq.video_info.rate.set(String.valueOf(this.a.p));
    localReportInfoReq.video_info.setHasFlag(true);
    localReportInfoReq.play_info.genurl_duration.set(this.a.j);
    localReportInfoReq.play_info.genurl_errcode.set(this.a.f);
    localReportInfoReq.play_info.prepare_duration.set(this.a.jdField_d_of_type_Long);
    localReportInfoReq.play_info.play_duration.set(this.a.a);
    localReportInfoReq.play_info.play_errcode.set(this.a.jdField_d_of_type_JavaLangString);
    localReportInfoReq.play_info.skipframe_cnt.set(this.a.r);
