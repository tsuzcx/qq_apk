  ...
  implements Runnable
{
  public void run()
  {
    ...
    try
    {
      ...
      ((oidb_0x6cf.ReqBody)localObject1).uint32_req_times.set(this.a);
      ...
      {
        localObject2 = ByteStringMicro.copyFromUtf8(this.c.l);
        ((oidb_0x6cf.ReqBody)localObject1).bytes_inner_id.set((ByteStringMicro)localObject2);
      }
      if (!TextUtils.isEmpty(this.d))
      {
        localObject2 = ByteStringMicro.copyFromUtf8(this.d);
      ...
      if (this.c.t)
      {
        ...
        ((oidb_0x6cf.FeedsIdInfo)localObject2).uint64_feeds_id.set(this.c.E);
        ((oidb_0x6cf.FeedsIdInfo)localObject2).uint32_feeds_type.set(this.c.F);
      ...
      ((ToServiceMsg)localObject1).addAttribute("VALUE_OBSERVER_TAG", Integer.valueOf(this.e.hashCode()));
      ...
      ((StringBuilder)localObject1).append(this.c.q());
