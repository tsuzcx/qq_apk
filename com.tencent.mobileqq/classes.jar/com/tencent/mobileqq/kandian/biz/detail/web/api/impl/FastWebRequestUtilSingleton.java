...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/mobileqq/kandian/biz/detail/web/api/impl/FastWebRequestUtilSingleton;", "Lcom/tencent/mobileqq/kandian/biz/detail/web/api/IFastWebRequestUtil;", "()V", "webAdLink", "", "webRecLink", "addHeadForUrl", "imageUrl", "isHttps", "", "getArticleDisplayParams", "", "context", "Landroid/content/Context;", "getWebAdLink", "getWebRecLink", "setWebAdLink", "", "webAdLinkStr", "setWebRecLink", "webRecLinkStr", "kandian_feature_impl_release"}, k=1, mv={1, 1, 16})
public final class FastWebRequestUtilSingleton
  implements IFastWebRequestUtil
{
  public static final FastWebRequestUtilSingleton INSTANCE = new FastWebRequestUtilSingleton();
 ...
 * Qualified Name:     com.tencent.mobileqq.kandian.biz.detail.web.api.impl.FastWebRequestUtilSingleton
