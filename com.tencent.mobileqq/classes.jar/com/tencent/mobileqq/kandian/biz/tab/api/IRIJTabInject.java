...
@QAPI(process={"all"})
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/mobileqq/kandian/biz/tab/api/IRIJTabInject;", "Lcom/tencent/mobileqq/qroute/QRouteApi;", "initKanDianTab", "", "frameFragment", "", "kanDianTabExposure", "mTabNotifyIcon", "Ljava/util/HashMap;", "", "Landroid/view/View;", "mTabs", "", "(Ljava/util/HashMap;[Landroid/view/View;)V", "updateKanDianRedTouch", "updateKanDianTab", "type", "", "kandian-api_release"}, k=1, mv={1, 1, 16})
public abstract interface IRIJTabInject
  extends QRouteApi
{
  public abstract void initKanDianTab(@Nullable Object paramObject);
