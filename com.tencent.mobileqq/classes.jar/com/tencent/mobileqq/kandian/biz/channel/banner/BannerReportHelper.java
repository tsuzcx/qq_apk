...
public class BannerReportHelper
{
  ...
  public static void a(String paramString, int paramInt1, int paramInt2, int paramInt3, TopBannerInfo.BaseItem paramBaseItem)
  {
    ...
    if ((paramBaseItem instanceof TopBannerInfo.ImgItem)) {
      str = ((TopBannerInfo.ImgItem)paramBaseItem).f;
    } else {
      str = "0";
    }
    ((IPublicAccountReportUtils)QRoute.api(IPublicAccountReportUtils.class)).publicAccountReportClickEvent(null, "", paramString, paramString, 0, 0, String.valueOf(paramInt3), String.valueOf(paramInt1), String.valueOf(paramBaseItem.jdField_a_of_type_Int), a(paramInt2, paramBaseItem.e, str, paramBaseItem.jdField_a_of_type_Boolean).build(), false);
  }
  ...
  public static void a(String paramString, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      ((IPublicAccountReportUtils)QRoute.api(IPublicAccountReportUtils.class)).publicAccountReportClickEvent(null, "", paramString, paramString, 0, 0, String.valueOf(paramInt2), "", "", localReportR5Builder.build(), false);
      return;
      paramInt1 = 0;
    }
  }
  ...
  {
    if ((paramBaseItem instanceof TopBannerInfo.ImgItem)) {
      paramBaseItem = ((TopBannerInfo.ImgItem)paramBaseItem).f;
    } else {
      paramBaseItem = "0";
    }
