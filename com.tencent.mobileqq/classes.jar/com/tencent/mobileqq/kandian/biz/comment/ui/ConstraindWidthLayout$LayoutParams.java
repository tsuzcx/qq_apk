...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/mobileqq/kandian/biz/comment/ui/ConstraindWidthLayout$LayoutParams;", "Landroid/widget/LinearLayout$LayoutParams;", "width", "", "height", "weight", "", "(IIF)V", "layoutParams", "Landroid/view/ViewGroup$LayoutParams;", "(Landroid/view/ViewGroup$LayoutParams;)V", "Landroid/view/ViewGroup$MarginLayoutParams;", "(Landroid/view/ViewGroup$MarginLayoutParams;)V", "(Landroid/widget/LinearLayout$LayoutParams;)V", "(Lcom/tencent/mobileqq/kandian/biz/comment/ui/ConstraindWidthLayout$LayoutParams;)V", "context", "Landroid/content/Context;", "attrs", "Landroid/util/AttributeSet;", "(Landroid/content/Context;Landroid/util/AttributeSet;)V", "constrainedWidth", "", "getConstrainedWidth", "()Z", "setConstrainedWidth", "(Z)V", "kandian_feature_impl_release"}, k=1, mv={1, 1, 16})
 ...
 * Qualified Name:     com.tencent.mobileqq.kandian.biz.comment.ui.ConstraindWidthLayout.LayoutParams
