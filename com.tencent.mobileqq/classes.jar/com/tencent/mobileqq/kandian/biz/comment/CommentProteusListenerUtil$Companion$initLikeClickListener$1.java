...
import com.tencent.mobileqq.kandian.biz.comment.ui.CommentLikeView;
  ...
  implements CommentProteusListenerUtil.CommentProteusOnClickListener
{
  public void a(int paramInt, @NotNull Container paramContainer, @NotNull ReadinjoyCommentListBaseAdapter paramReadinjoyCommentListBaseAdapter, @NotNull CommentViewItem paramCommentViewItem, @NotNull ViewBase paramViewBase)
  {
    ...
    if ((paramViewBase instanceof CommentLikeView)) {
      ((CommentLikeView)paramViewBase).a((ReadInJoyCommentLikeView.OnLikeStateChangeLinstener)paramReadinjoyCommentListBaseAdapter);
    }
  }
}
 ...
 * Qualified Name:     com.tencent.mobileqq.kandian.biz.comment.CommentProteusListenerUtil.Companion.initLikeClickListener.1
