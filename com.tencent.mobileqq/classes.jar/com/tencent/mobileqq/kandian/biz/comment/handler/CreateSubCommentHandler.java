...
{
  public static final CreateSubCommentHandler.Companion a = new CreateSubCommentHandler.Companion(null);
  @Nullable
  private Function2<? super oidb_0xd1e.SubCommentCreateRsp, ? super Integer, Unit> b;
  @Nullable
  private Function3<? super oidb_0xd1e.SubCommentCreateRsp, ? super Integer, ? super String, Unit> c;
  @NotNull
  private final SubCommentCreateData d;
  
  public CreateSubCommentHandler(@NotNull SubCommentCreateData paramSubCommentCreateData)
  {
    this.d = paramSubCommentCreateData;
  }
  ...
  private final void a(int paramInt, String paramString)
  {
    if (paramInt != 0)
    {
      ...
      RIJCommentAegisHelper.a(localStringBuilder.toString(), "CreateSubCommentHandler");
    }
  }
  ...
  private final oidb_0xd1e.ReqBody b()
  {
    ...
    localSubCommentCreateReq.rowkey.set(((SubCommentCreateData)localObject1).d());
    localSubCommentCreateReq.article_id.set(((SubCommentCreateData)localObject1).e());
    localSubCommentCreateReq.author_id.set(((SubCommentCreateData)localObject1).g());
    localSubCommentCreateReq.business_info.set(((SubCommentCreateData)localObject1).k());
    localSubCommentCreateReq.content_src.set(ReadInJoyCommentHelper.a(((SubCommentCreateData)localObject1).j()));
    localSubCommentCreateReq.src.set(((SubCommentCreateData)localObject1).h());
    localSubCommentCreateReq.scene.set(((SubCommentCreateData)localObject1).f());
    ...
    localSubCommentCreateReq.replied_sub_author_id.set(((SubCommentCreateData)localObject1).l());
    localSubCommentCreateReq.replied_sub_comment_id.set(((SubCommentCreateData)localObject1).m());
    localSubCommentCreateReq.detect_dirty_word.set(1);
    Object localObject2 = ((SubCommentCreateData)localObject1).c();
    ...
    localObject1 = ((SubCommentCreateData)localObject1).i();
