...
class RIJEnhancedImageSpan$AlignBaselineConfig
  extends RIJEnhancedImageSpan.BaseAlignConfig
{
  private RIJEnhancedImageSpan$AlignBaselineConfig()
  {
    super(null);
  }
  ...
  public int a(@NonNull Paint paramPaint, CharSequence paramCharSequence, int paramInt1, int paramInt2, @Nullable Paint.FontMetricsInt paramFontMetricsInt, int paramInt3, int paramInt4)
  {
    if (paramFontMetricsInt != null) {
      paramFontMetricsInt.ascent = (-paramInt4);
    }
    return paramInt3;
  }
}
 ...
 * Qualified Name:     com.tencent.mobileqq.kandian.biz.comment.util.RIJEnhancedImageSpan.AlignBaselineConfig
