  ...
  implements View.OnClickListener
{
  ...
  public View getView(int paramInt, @Nullable View paramView, @NotNull ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = LayoutInflater.from(this.a.getContext()).inflate(2131560114, paramViewGroup, false);
      ...
      paramViewGroup.a().setOnClickListener((View.OnClickListener)this);
    ...
    paramViewGroup.a().setTag(localCommentLinkData);
    paramViewGroup.a().setText((CharSequence)localCommentLinkData.wording);
