...
public final class FirstCommentSinkHandler
{
  ...
  @NotNull
  private final FirstCommentSinkData jdField_a_of_type_ComTencentMobileqqKandianBizCommentEntityFirstCommentSinkData;
  @Nullable
  ...
  static
  {
    jdField_a_of_type_ComTencentMobileqqKandianBizCommentHandlerFirstCommentSinkHandler$Companion = new FirstCommentSinkHandler.Companion(null);
  }
  
  public FirstCommentSinkHandler(@NotNull FirstCommentSinkData paramFirstCommentSinkData)
  {
    this.jdField_a_of_type_ComTencentMobileqqKandianBizCommentEntityFirstCommentSinkData = paramFirstCommentSinkData;
  }
  ...
  private final oidb_0xd1e.ReqBody a()
  {
    ...
    localFirstCommentAuthorTopSetReq.article_id.set(this.jdField_a_of_type_ComTencentMobileqqKandianBizCommentEntityFirstCommentSinkData.c());
    localFirstCommentAuthorTopSetReq.comment_id.set(this.jdField_a_of_type_ComTencentMobileqqKandianBizCommentEntityFirstCommentSinkData.a());
    localFirstCommentAuthorTopSetReq.comment_type.set(1);
    localFirstCommentAuthorTopSetReq.op_type.set(this.jdField_a_of_type_ComTencentMobileqqKandianBizCommentEntityFirstCommentSinkData.a());
    localFirstCommentAuthorTopSetReq.content_src.set(ReadInJoyCommentHelper.a(this.jdField_a_of_type_ComTencentMobileqqKandianBizCommentEntityFirstCommentSinkData.d()));
    localFirstCommentAuthorTopSetReq.src.set(0);
    localFirstCommentAuthorTopSetReq.business_info.set(this.jdField_a_of_type_ComTencentMobileqqKandianBizCommentEntityFirstCommentSinkData.e());
