...
{
  public static final String a = HardCodeUtil.a(2131702379);
  public static final String b;
  public static final String c = HardCodeUtil.a(2131702378);
  
  static
  {
    jdField_b_of_type_JavaLangString = HardCodeUtil.a(2131702380);
  }
  ...
  public static float a()
  {
    ...
    try
    {
      float f2 = ((Float)RIJSPUtils.a("readinjoy_font_size_ratio_sp", Float.valueOf(1.0F))).floatValue();
      f1 = f2;
  ...
  private static List<String> a(CommentViewItem paramCommentViewItem)
  {
    ...
    {
      if (paramCommentViewItem.jdField_a_of_type_ComTencentMobileqqKandianBizCommentEntityBaseCommentData.mediaDataList == null) {
        return localArrayList;
      }
      paramCommentViewItem = paramCommentViewItem.jdField_a_of_type_ComTencentMobileqqKandianBizCommentEntityBaseCommentData.mediaDataList;
      if (paramCommentViewItem.size() > 0)
      {
        ...
        while (paramCommentViewItem.hasNext())
        {
          ...
          {
            if (localMediaData.jdField_e_of_type_Int == 3) {
  ...
  public static JSONObject a(ReadinjoyCommentListBaseAdapter paramReadinjoyCommentListBaseAdapter, VafContext paramVafContext, CommentViewItem paramCommentViewItem, int paramInt, boolean paramBoolean)
  {
    ...
    b(paramCommentViewItem, paramReadinjoyCommentListBaseAdapter);
  ...
  {
    Object localObject = ReadInJoyCommentDataManager.a(paramCommentViewItem.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityAbsBaseArticleInfo);
    JSONObject localJSONObject = new JSONObject();
    int j = 1;
    int i;
    long l1;
  ...
  static JSONObject a(CommentViewItem paramCommentViewItem, JSONObject paramJSONObject)
  {
    if ((paramCommentViewItem != null) && (paramCommentViewItem.jdField_a_of_type_ComTencentMobileqqKandianBizCommentEntityBaseCommentData != null))
    {
      ...
      List localList = ((CommentData)paramCommentViewItem.jdField_a_of_type_ComTencentMobileqqKandianBizCommentEntityBaseCommentData).subCommentList;
        ...
        while ((j < i) && (j < 2))
        {
          ...
          if (localSubCommentData != null)
          {
            ...
            if ((localSubCommentData.hasTarget()) && (!TextUtils.isEmpty(localSubCommentData.repliedUserNickname)))
            {
              ...
              localObject = ((StringBuilder)localObject).toString();
              paramJSONObject.put(str7, HardCodeUtil.a(2131718291));
  ...
  private static void a(@NotNull VafContext paramVafContext, @NotNull JSONObject paramJSONObject, @NotNull CommentViewItem paramCommentViewItem, @NotNull BaseCommentData paramBaseCommentData)
  {
    if ((paramVafContext != null) && (paramVafContext.getContext() != null) && (paramVafContext.getContext().getResources() != null) && (paramBaseCommentData.mediaDataList != null) && (paramBaseCommentData.mediaDataList.size() > 0))
    {
      ...
      int j = paramVafContext.jdField_a_of_type_Int;
      j = paramVafContext.jdField_b_of_type_Int;
      j = paramVafContext.jdField_a_of_type_Int;
      int k = paramVafContext.jdField_b_of_type_Int;
      float f1 = 113.0F;
      float f2 = 89.0F;
      if (j < k)
      {
      ...
      else if (paramVafContext.jdField_a_of_type_Int <= paramVafContext.jdField_b_of_type_Int)
      {
        f1 = 89.0F;
      }
      paramBaseCommentData = a(paramCommentViewItem);
      StringBuilder localStringBuilder = new StringBuilder();
      ...
      if (i != 2)
      {
        if (i != 3) {
          ...
          paramVafContext = HardCodeUtil.a(2131702384);
        }
      }
      else {
        paramVafContext = HardCodeUtil.a(2131702377);
      }
  ...
  static void a(CommentViewItem paramCommentViewItem, JSONObject paramJSONObject)
  {
    if ((paramCommentViewItem != null) && (paramCommentViewItem.jdField_a_of_type_ComTencentMobileqqKandianBizCommentEntityBaseCommentData != null))
    {
      ...
      if (((SubCommentData)paramCommentViewItem.jdField_a_of_type_ComTencentMobileqqKandianBizCommentEntityBaseCommentData).repliedCommentData == null) {
        return;
      }
      SubCommentData localSubCommentData = (SubCommentData)paramCommentViewItem.jdField_a_of_type_ComTencentMobileqqKandianBizCommentEntityBaseCommentData;
  ...
  public static void a(BaseCommentData paramBaseCommentData, JSONObject paramJSONObject)
  {
    if (!paramJSONObject.has("follow_btn_show"))
    {
      ...
      if ((paramBaseCommentData.userIdentityIcon != null) && (!TextUtils.isEmpty(paramBaseCommentData.userIdentityIcon.a)))
      {
        paramJSONObject.put("rij_comment_v", paramBaseCommentData.userIdentityIcon.a);
        return;
      }
  ...
  private static void a(@NotNull JSONObject paramJSONObject, @NotNull CommentViewItem paramCommentViewItem)
  {
    ...
    {
      paramJSONObject.put("comment_text", paramCommentViewItem.jdField_a_of_type_ComTencentMobileqqKandianBizCommentEntityBaseCommentData.getWholeStringContent());
      RIJCommentRptDataUtil.a(paramCommentViewItem.jdField_a_of_type_ComTencentMobileqqKandianBizCommentEntityBaseCommentData, paramJSONObject, "rpt_data_info", false);
      if (paramCommentViewItem.jdField_a_of_type_ComTencentMobileqqKandianBizCommentEntityBaseCommentData.hasLinkData()) {
      ...
      if ((paramCommentViewItem.jdField_a_of_type_ComTencentMobileqqKandianBizCommentEntityBaseCommentData instanceof CommentData))
      {
        localObject = new StringBuilder();
        ((StringBuilder)localObject).append("more-");
        ((StringBuilder)localObject).append(paramCommentViewItem.jdField_a_of_type_ComTencentMobileqqKandianBizCommentEntityBaseCommentData.commentId);
        localObject = ((StringBuilder)localObject).toString();
      }
      else if ((paramCommentViewItem.jdField_a_of_type_ComTencentMobileqqKandianBizCommentEntityBaseCommentData instanceof SubCommentData))
      {
        localObject = new StringBuilder();
        ((StringBuilder)localObject).append("more-");
        ((StringBuilder)localObject).append(((SubCommentData)paramCommentViewItem.jdField_a_of_type_ComTencentMobileqqKandianBizCommentEntityBaseCommentData).parentCommentId);
        ((StringBuilder)localObject).append(":");
        ((StringBuilder)localObject).append(((SubCommentData)paramCommentViewItem.jdField_a_of_type_ComTencentMobileqqKandianBizCommentEntityBaseCommentData).commentId);
        localObject = ((StringBuilder)localObject).toString();
      }
      paramJSONObject.put("comment_text_more_url", localObject);
      paramJSONObject.put("comment_text_line", paramCommentViewItem.jdField_a_of_type_ComTencentMobileqqKandianBizCommentEntityBaseCommentData.maxLine);
    }
  }
  ...
  {
    AbsBaseArticleInfo localAbsBaseArticleInfo = paramReadinjoyCommentListBaseAdapter.jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsEntityAbsBaseArticleInfo;
    ...
    if (paramBaseCommentData.isAuthorReply()) {
      paramJSONObject.put("author_header_flag_one", HardCodeUtil.a(2131702389));
    }
    ...
    localObject = str;
    if (str == null) {
      localObject = HardCodeUtil.a(2131709272);
    }
    ...
    if ((paramBaseCommentData.shouldShowFollowButton) && (paramReadinjoyCommentListBaseAdapter.b() == 3))
    {
      ...
      ReadinjoyReportUtils.b(localAbsBaseArticleInfo, ReadinjoyReportUtils.g, true, paramBaseCommentData.commentId);
    }
  ...
  private static void a(@NotNull JSONObject paramJSONObject, @NotNull BaseCommentData paramBaseCommentData, boolean paramBoolean)
  {
    ...
    paramJSONObject.put("time", ((IReadInJoyTimeUtils)QRoute.api(IReadInJoyTimeUtils.class)).getRelativeDisplayForTime(l1, true));
    JSONObject localJSONObject = new JSONObject();
    ...
    if ((paramBaseCommentData instanceof CommentData))
    {
      if (paramBoolean)
      {
        ...
        if (paramBaseCommentData.subCommentNum > 0)
        {
          ...
          localStringBuilder.append(HardCodeUtil.a(2131702383));
        ...
        paramJSONObject.put("reply_count_none", HardCodeUtil.a(2131702390));
        paramJSONObject.put("id_comment_tail_center_dot", new JSONObject());
        paramJSONObject.put("id_comment_tail_3_dot", new JSONObject());
    ...
    paramJSONObject.put("reply_count_none", HardCodeUtil.a(2131702387));
    paramJSONObject.put("id_comment_tail_center_dot", new JSONObject());
    paramJSONObject.put("id_comment_tail_3_dot", new JSONObject());
    paramJSONObject.remove("reply_count");
    paramJSONObject.put("id_reply_comment_null_button", localJSONObject);
  ...
  {
    if ((paramAbsBaseArticleInfo != null) && (paramAbsBaseArticleInfo.mSubscribeID != null)) {
      return FollowListInfoModule.a(paramAbsBaseArticleInfo.mSubscribeID);
    }
    return false;
  }
  ...
  private static void b(CommentViewItem paramCommentViewItem, JSONObject paramJSONObject)
  {
    if ((paramCommentViewItem != null) && (paramCommentViewItem.jdField_a_of_type_ComTencentMobileqqKandianBizCommentEntityBaseCommentData != null))
    {
      if (paramJSONObject == null) {
      ...
      paramCommentViewItem = paramCommentViewItem.jdField_a_of_type_ComTencentMobileqqKandianBizCommentEntityBaseCommentData.styleData;
      Object localObject = new StringBuilder();
