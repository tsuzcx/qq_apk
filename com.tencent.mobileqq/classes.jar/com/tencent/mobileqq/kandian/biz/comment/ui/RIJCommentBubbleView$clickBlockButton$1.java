  ...
  implements ActionSheet.OnButtonClickListener
{
  ...
  public final void OnClick(View paramView, int paramInt)
  {
    if (paramInt == 0)
    {
      this.jdField_a_of_type_ComTencentMobileqqKandianBizCommentDataReadInJoyCommentDataManager.b(RIJCommentBubbleView.a(this.jdField_a_of_type_ComTencentMobileqqKandianBizCommentUiRIJCommentBubbleView));
      RIJCommentBubbleView.a(this.jdField_a_of_type_ComTencentMobileqqKandianBizCommentUiRIJCommentBubbleView, 9);
    }
