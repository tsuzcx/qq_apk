...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/mobileqq/kandian/biz/comment/biuAndCommentMix/api/impl/UiApiPluginImpl;", "Lcom/tencent/mobileqq/kandian/biz/comment/biuAndCommentMix/api/IUiApiPlugin;", "()V", "convertRespDataToJsonString", "Lorg/json/JSONObject;", "respData", "Lcom/tencent/mobileqq/kandian/repo/comment/entity/RIJBiuAndCommentRespData;", "replyFirstCommentId", "", "replySubCommentId", "replyNick", "handleInfoAndRequestForWeb", "", "intent", "Landroid/content/Intent;", "dataManager", "Lcom/tencent/mobileqq/kandian/biz/comment/biuAndCommentMix/api/IRIJBiuAndCommentMixDataManager;", "callBackId", "callCommentJs", "Lcom/tencent/mobileqq/kandian/biz/fastweb/CallCommentJs;", "requestBiuAndCommentForWeb", "contentSrc", "", "articleInfo", "Lcom/tencent/mobileqq/kandian/repo/feeds/entity/AbsBaseArticleInfo;", "commentType", "replyCommentId", "replyParentCommentId", "replyString", "isToFriend", "", "isSecondReply", "replyUin", "Companion", "kandian_feature_impl_release"}, k=1, mv={1, 1, 16})
public final class UiApiPluginImpl
  implements IUiApiPlugin
{
  public static final UiApiPluginImpl.Companion Companion = new UiApiPluginImpl.Companion(null);
  ...
  private final JSONObject convertRespDataToJsonString(RIJBiuAndCommentRespData paramRIJBiuAndCommentRespData, String paramString1, String paramString2, String paramString3)
  {
    ...
    try
    {
      ...
      localJSONObject.put("rspCommentId", paramRIJBiuAndCommentRespData.a());
      localJSONObject.put("replyFirstCommentId", paramString1);
      localJSONObject.put("replySubCommentId", paramString2);
      localJSONObject.put("comment", paramRIJBiuAndCommentRespData.c());
      localJSONObject.put("replyUin", paramRIJBiuAndCommentRespData.e());
  ...
  public void handleInfoAndRequestForWeb(@Nullable Intent paramIntent, @Nullable IRIJBiuAndCommentMixDataManager paramIRIJBiuAndCommentMixDataManager, @Nullable String paramString, @Nullable CallCommentJs paramCallCommentJs)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramIRIJBiuAndCommentMixDataManager.a((IRIJBiuAndCommentMixDataManager.BiuAndCommentListener)new UiApiPluginImpl.handleInfoAndRequestForWeb.1(this, paramCallCommentJs, paramString, str2, str3, (String)localObject1));
