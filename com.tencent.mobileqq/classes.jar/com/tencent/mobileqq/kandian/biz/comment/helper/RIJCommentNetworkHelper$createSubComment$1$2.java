  ...
  implements Function2<Boolean, Integer, Unit>
{
  ...
  public final void invoke(boolean paramBoolean, int paramInt)
  {
    ...
    if (localRIJCreateCommentObserver != null)
    {
      ...
      localCreateCommentResult.e = String.valueOf(this.$commentId);
      ...
      localStringBuilder.append("createSubComment: result=");
 ...
 * Qualified Name:     com.tencent.mobileqq.kandian.biz.comment.helper.RIJCommentNetworkHelper.createSubComment.1.2
