  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    ((StringBuilder)localObject).append(ReadInJoyBBCircleFragment.a(this.this$0).a() / 1000L);
    localReportR5Builder.addStringNotThrow("entry_time", ((StringBuilder)localObject).toString());
    localObject = new StringBuilder();
    ((StringBuilder)localObject).append("");
    ((StringBuilder)localObject).append(NetConnInfoCenter.getServerTime());
    localReportR5Builder.addStringNotThrow("postset_time", ((StringBuilder)localObject).toString());
    localObject = (IPublicAccountReportUtils)QRoute.api(IPublicAccountReportUtils.class);
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append("");
    localStringBuilder.append(ReadInJoyBBCircleFragment.a(this.this$0).b() / 1000L);
    ((IPublicAccountReportUtils)localObject).publicAccountReportClickEvent(null, null, "0X800978C", "0X800978C", 0, 0, localStringBuilder.toString(), "", "", localReportR5Builder.build(), false);
  }
}
