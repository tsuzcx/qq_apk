  ...
  extends ReadInJoyObserver
{
  ...
  public void b(boolean paramBoolean, List<ChannelCoverInfo> paramList)
  {
    if (paramBoolean)
    {
      ...
      ReadInJoyFeedsHeaderViewController.b(localReadInJoyFeedsHeaderViewController, ReadInJoyFeedsHeaderViewController.a(localReadInJoyFeedsHeaderViewController, paramList));
    }
  }
}
