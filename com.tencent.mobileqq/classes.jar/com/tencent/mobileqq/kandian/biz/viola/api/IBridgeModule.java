...
public abstract interface IBridgeModule
{
  ...
  public abstract void chooseVideoAddToTopic(@Nullable JSONObject paramJSONObject, @Nullable String paramString);
  
  public abstract void dwellTimeMillisReport(@Nullable JSONObject paramJSONObject);
  
  public abstract void getCreateTopicPermission(@Nullable JSONObject paramJSONObject, @Nullable String paramString);
  ...
  public abstract void openCreateTopicView(@Nullable String paramString);
  
  public abstract void openEditTopicView(@Nullable JSONObject paramJSONObject, @Nullable String paramString);
