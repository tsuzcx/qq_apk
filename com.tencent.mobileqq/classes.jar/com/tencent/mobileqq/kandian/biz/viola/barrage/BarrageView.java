...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/mobileqq/kandian/biz/viola/barrage/BarrageView;", "Landroid/widget/FrameLayout;", "context", "Landroid/content/Context;", "attrs", "Landroid/util/AttributeSet;", "defStyleAttr", "", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "viewHeight", "getViewHeight", "()I", "setViewHeight", "(I)V", "onMeasure", "", "widthMeasureSpec", "heightMeasureSpec", "kandian_feature_impl_release"}, k=1, mv={1, 1, 16})
