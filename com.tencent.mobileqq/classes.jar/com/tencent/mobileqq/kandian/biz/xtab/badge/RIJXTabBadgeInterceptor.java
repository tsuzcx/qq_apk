  ...
  implements IRIJBadgeInterceptor
{
  ...
  public RIJXTabBadgeInterceptor(@NotNull QQAppInterface paramQQAppInterface, @NotNull KandianMergeManager paramKandianMergeManager)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqKandianGlueBusinesshandlerEngineKandianMergeManager = paramKandianMergeManager;
  }
  
  private final boolean a(RIJXTabRedDotInfo paramRIJXTabRedDotInfo)
  {
    return (((IRIJXTabConfigHandler)QRoute.api(IRIJXTabConfigHandler.class)).isXTabMode()) && (b(paramRIJXTabRedDotInfo)) && ((c(paramRIJXTabRedDotInfo)) || (d(paramRIJXTabRedDotInfo))) && ((!RIJAppSetting.a(paramRIJXTabRedDotInfo.getChannelId())) || (c(paramRIJXTabRedDotInfo)));
  }
  ...
  {
    return (!RIJXTabFrameUtils.INSTANCE.isNowInKanDianTab()) && (this.jdField_a_of_type_ComTencentMobileqqKandianGlueBusinesshandlerEngineKandianMergeManager.e() > 0);
  }
  ...
  public int a(@NotNull MessageRecord paramMessageRecord)
  {
    ...
    if (localRIJXTabRedDotInfo != null)
    {
      ...
      if (bool1)
      {
        boolean bool2 = d(paramMessageRecord);
      ...
      this.jdField_a_of_type_ComTencentMobileqqKandianGlueBusinesshandlerEngineKandianMergeManager.g();
      i = j;
      if (bool1) {
        i = 1;
      }
  ...
  {
    Intrinsics.checkParameterIsNotNull(paramMessageRecord, "mr");
    boolean bool = RIJXTabBadgeInfoExtKt.a(paramMessageRecord, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    if (QLog.isColorLevel())
    {
      ...
      localStringBuilder.append(KandianMergeManager.a(paramMessageRecord, (AppInterface)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      localStringBuilder.append(',');
  ...
  public boolean b(@NotNull MessageRecord paramMessageRecord)
  {
    ...
    if (QLog.isColorLevel())
    {
      ...
      paramMessageRecord.append(((IRIJXTabConfigHandler)QRoute.api(IRIJXTabConfigHandler.class)).isXTabMode());
      paramMessageRecord.append(", ");
      paramMessageRecord.append(", ");
