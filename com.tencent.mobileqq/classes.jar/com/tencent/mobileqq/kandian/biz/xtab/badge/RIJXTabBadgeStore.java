...
public final class RIJXTabBadgeStore
{
  ...
  {
    RIJXTabRedDotInfo localRIJXTabRedDotInfo = (RIJXTabRedDotInfo)jdField_a_of_type_ComTencentMobileqqKandianBizXtabBadgeRIJXTabBadgeStore.a().remove(Integer.valueOf(paramInt));
    ...
    if (localRIJXTabRedDotInfo != null)
    {
      if (paramBoolean)
      {
        jdField_a_of_type_ComTencentMobileqqKandianBizXtabBadgeRIJXTabBadgeStore.a().set(false);
        RIJXTabBadgeReporter.b(localRIJXTabRedDotInfo);
        RIJXTabBadgeReporter.a(localRIJXTabRedDotInfo, 1);
      }
      jdField_a_of_type_ComTencentMobileqqKandianBizXtabBadgeRIJXTabBadgeStore.d();
    }
  ...
  {
    return (jdField_a_of_type_ComTencentMobileqqKandianBizXtabBadgeRIJXTabBadgeStore.b()) && (jdField_a_of_type_ComTencentMobileqqKandianBizXtabBadgeRIJXTabBadgeStore.a().get());
  }
  ...
  {
    a().clear();
    SharedPreferences localSharedPreferences = RIJSPUtils.a(RIJQQAppInterfaceUtil.a(), true, false);
    ...
    if (localObject1 != null)
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if (localObject2 != null) {
          localObject2 = (RIJXTabRedDotInfo)jdField_a_of_type_ComTencentMobileqqKandianBizXtabBadgeRIJXTabBadgeStore.a().put(Integer.valueOf(((RIJXTabRedDotInfo)localObject2).getChannelId()), localObject2);
        }
      }
      b();
  ...
  public final int a()
  {
    ...
    if ((localRIJXTabRedDotInfo != null) && (localRIJXTabRedDotInfo.getChannelId() != TabChannelCoverInfo.TYPE_CHANNEL_XTAB_KD_COMMUNITY_CONFIG))
    {
      if (localRIJXTabRedDotInfo.getChannelId() == TabChannelCoverInfo.TYPE_CHANNEL_XTAB_FRIEND_CONFIG) {
        return -1;
      }
  ...
  public final RIJXTabRedDotInfo a()
  {
    ...
    return (RIJXTabRedDotInfo)((Map.Entry)CollectionsKt.last(CollectionsKt.sortedWith((Iterable)a().entrySet(), (Comparator)new RIJXTabBadgeStore.getLatestBadgeInfo..inlined.sortedBy.1()))).getValue();
  }
  ...
  public final void b()
  {
    ...
    int m = ((IRIJXTabConfigHandler)QRoute.api(IRIJXTabConfigHandler.class)).getRedDotExpireTimeInMin();
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      boolean bool = jdField_a_of_type_ComTencentMobileqqKandianBizXtabBadgeRIJXTabBadgeStore.b(((Number)localEntry.getKey()).intValue());
      if ((i == 0) || (!bool))
      {
        StringBuilder localStringBuilder = new StringBuilder();
 ...
 * Qualified Name:     com.tencent.mobileqq.kandian.biz.xtab.badge.RIJXTabBadgeStore
