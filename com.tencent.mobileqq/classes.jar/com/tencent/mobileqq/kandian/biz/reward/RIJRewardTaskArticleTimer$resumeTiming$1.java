  ...
  implements Runnable
{
  ...
  {
    if (RIJRewardTaskArticleTimer.access$getStationaryTime$p(this.this$0) <= RIJRewardTaskConfig.d())
    {
      ...
      RIJRewardTaskArticleTimer.access$getRewardTaskTimingPresenter$p(this.this$0).a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int, 1);
    }
    else
    {
      RIJRewardTaskArticleTimer.access$getRewardTaskTimingPresenter$p(this.this$0).a();
    }
