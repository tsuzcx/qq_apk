...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"com/tencent/mobileqq/kandian/biz/publisher/api/impl/KanDianPublisherImpl$openCreateTopicPageForResult$1", "Lkotlin/Function2;", "", "Lkotlin/ParameterName;", "name", "errorCode", "Lcom/tencent/tkd/topicsdk/bean/TopicInfo;", "topicInfo", "", "Lcom/tencent/tkd/topicsdk/managetopic/CreateTopicListener;", "invoke", "kandian_feature_impl_release"}, k=1, mv={1, 1, 16})
public final class KanDianPublisherImpl$openCreateTopicPageForResult$1
  implements Function2<Integer, TopicInfo, Unit>
{
  KanDianPublisherImpl$openCreateTopicPageForResult$1(JSONObject paramJSONObject, Activity paramActivity) {}
  ...
  public void a(int paramInt, @Nullable TopicInfo paramTopicInfo)
  {
    if ((paramInt == 0) && (paramTopicInfo != null))
    {
      ...
      if ((paramInt == 1) && (RIJUgcUtils.h() == 2))
      {
        ...
        ViolaAccessHelper.a((Context)this.jdField_a_of_type_AndroidAppActivity, "", paramTopicInfo, null, false);
      }
    }
 ...
 * Qualified Name:     com.tencent.mobileqq.kandian.biz.publisher.api.impl.KanDianPublisherImpl.openCreateTopicPageForResult.1
