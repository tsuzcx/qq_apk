  ...
  extends QRouteApi
{
  ...
  public abstract void launchChannelActivity(@Nullable Context paramContext, int paramInt1, @Nullable String paramString, int paramInt2, int paramInt3, @Nullable Map<String, ? extends Object> paramMap, boolean paramBoolean);
