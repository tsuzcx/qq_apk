    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (j >= i)
        {
          ...
          if ((localObject2 != null) && (((BaseReportData)localObject2).l != null))
          {
            StringBuilder localStringBuilder = new StringBuilder();
            localStringBuilder.append(((BaseReportData)localObject2).l.mArticleID);
            localStringBuilder.append("_");
            ((StringBuilder)localObject1).append(localStringBuilder.toString());
            ((StringBuilder)localObject1).append(((BaseReportData)localObject2).l.mJumpType);
            if (j != i) {
        ...
        else
        {
          ...
          PublicAccountReportUtils.a(null, null, "0X8009CCA", "0X8009CCA", 0, 0, "", "", "", ((JSONObject)localObject2).toString(), false);
          this.a.clear();
          return;
        }
      }
