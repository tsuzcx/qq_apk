  ...
  implements Runnable
{
  ...
  public void run()
  {
    try
    {
      ...
      ((JSONObject)localObject).put("channel_id", this.a.a.c());
      PublicAccountReportUtils.a(null, "", "0X8009414", "0X8009414", 0, 0, "", "", "", ((JSONObject)localObject).toString(), false);
      localObject = new StringBuilder();
      ((StringBuilder)localObject).append("back_to_top_btn : click ; channelID : ");
      ((StringBuilder)localObject).append(this.a.a.c());
