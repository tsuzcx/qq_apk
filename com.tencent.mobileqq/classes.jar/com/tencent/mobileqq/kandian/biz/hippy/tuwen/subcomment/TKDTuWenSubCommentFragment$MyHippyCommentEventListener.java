  ...
  extends TKDHippy2NativeEventSimpleReceiver
{
  ...
  {
    if (TKDTuWenSubCommentFragment.access$400(this.this$0) != null)
    {
      HippyListView localHippyListView = (HippyListView)TKDTuWenCommentUtil.rFindView(TKDTuWenSubCommentFragment.access$500(this.this$0).getHippyRootView(), HippyListView.class);
