  ...
  extends RecyclerViewBase.ViewFlinger
{
  ...
  private void doScroll(Scroller paramScroller, RecyclerViewBase.SmoothScroller paramSmoothScroller)
  {
    ...
    NSHippyListView.access$700(this.this$0)[0] = 0;
    NSHippyListView.access$700(this.this$0)[1] = 0;
    NSHippyListView localNSHippyListView = this.this$0;
    localNSHippyListView.dispatchNestedPreScroll(m, i, NSHippyListView.access$700(localNSHippyListView), null, 1);
    m -= NSHippyListView.access$700(this.this$0)[0];
    k = i - NSHippyListView.access$700(this.this$0)[1];
    if (this.this$0.mAdapter != null)
    {
      NSHippyListView.access$700(this.this$0)[0] = 0;
      NSHippyListView.access$700(this.this$0)[1] = 0;
      NSHippyListView.access$800(this.this$0)[0] = m;
      NSHippyListView.access$800(this.this$0)[1] = k;
      scrollStep0(m, k, reflectCareSpringBackMaxDistance(), paramScroller, paramSmoothScroller, NSHippyListView.access$700(this.this$0), NSHippyListView.access$800(this.this$0));
      i = NSHippyListView.access$700(this.this$0)[0];
      j = NSHippyListView.access$700(this.this$0)[1];
      m -= i;
      k -= j;
    }
    else
    ...
    paramSmoothScroller.dispatchNestedScroll(i, j, m, k, null, 1, NSHippyListView.access$700(paramSmoothScroller));
    m -= NSHippyListView.access$700(this.this$0)[0];
    k -= NSHippyListView.access$700(this.this$0)[1];
  ...
  {
    return NSHippyListView.access$400(this.this$0).getFieldValue(this, paramString);
  }
  ...
  private void reflectOnAnimation(RecyclerViewBase.SmoothScroller paramSmoothScroller, int paramInt1, int paramInt2)
  {
    if ((paramSmoothScroller != null) && (!paramSmoothScroller.isPendingInitialRun()) && (paramSmoothScroller.isRunning())) {
      NSHippyListView.access$400(this.this$0).invokeMethodWithPrimaryType(paramSmoothScroller, "onAnimation", new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt2) });
    }
  }
  
  private void reflectReportFinishState()
  {
    NSHippyListView.access$400(this.this$0).invokeMethodWithPrimaryType(this, "reportFinishState", new Object[0]);
  }
  ...
  private void scrollStep0(int paramInt1, int paramInt2, boolean paramBoolean, Scroller paramScroller, RecyclerViewBase.SmoothScroller paramSmoothScroller, int[] paramArrayOfInt1, int[] paramArrayOfInt2)
  {
    ...
    {
      paramScroller = NSHippyListView.access$1100(this.this$0, paramInt1, paramInt2, paramBoolean, paramScroller, false);
      paramInt2 = paramScroller[0];
      paramInt1 = paramScroller[1];
      paramArrayOfInt1[0] = this.this$0.mLayout.scrollHorizontallyBy(paramInt2, NSHippyListView.access$1200(this.this$0), this.this$0.mState);
      paramArrayOfInt1[1] = this.this$0.mLayout.scrollVerticallyBy(paramInt1, NSHippyListView.access$1300(this.this$0), this.this$0.mState);
    ...
    NSHippyListView.access$1400(this.this$0, false);
  }
  
  private void setFieldValue0(String paramString, Object paramObject)
  {
    NSHippyListView.access$400(this.this$0).setFieldValue(this, paramString, paramObject);
  }
  
  public void run()
  {
    NSHippyListView.access$300(this.this$0);
    ...
    if ((localSmoothScroller != null) && (localSmoothScroller.isPendingInitialRun())) {
      NSHippyListView.access$400(this.this$0).invokeMethodWithPrimaryType(localSmoothScroller, "onAnimation", new Object[] { Integer.valueOf(0), Integer.valueOf(0) });
    }
    if (localScroller.isFinished())
    {
      reflectReportFinishState();
      NSHippyListView.access$500(this.this$0);
      this.this$0.reflectSetScrollState(0);
      NSHippyListView.access$600(this.this$0, localScroller.isFling() ^ true, false);
