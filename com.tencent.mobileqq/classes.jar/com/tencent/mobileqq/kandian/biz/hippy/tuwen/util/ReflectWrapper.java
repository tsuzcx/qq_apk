...
public class ReflectWrapper
{
  ...
  private static String getKey(Class paramClass, String paramString, int paramInt, Class<?>... paramVarArgs)
  {
    ...
    if ((paramInt >= 0) && (paramInt <= 2)) {
      buildKeyWithParamTypes(localStringBuilder, paramVarArgs);
    }
  ...
  private Method getMethod(Class<?> paramClass, String paramString, boolean paramBoolean, Class<?>... paramVarArgs)
  {
    ...
    String str = getKey(paramClass, paramString, i, paramVarArgs);
    Method localMethod2 = (Method)this.objMap.get(str);
    Method localMethod1 = localMethod2;
    if (localMethod2 == null)
    {
      localMethod1 = findMethod(paramClass, paramString, paramVarArgs);
      if (localMethod1 == null) {
        return null;
      }
      this.objMap.put(str, localMethod1);
    }
    return localMethod1;
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.kandian.biz.hippy.tuwen.util.ReflectWrapper
