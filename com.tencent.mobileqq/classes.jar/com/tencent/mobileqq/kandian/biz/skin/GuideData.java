  ...
  extends BaseResData<oidb_0x5bd.GuideInfo>
{
  ...
  public GuideData()
  {
    ...
    localStringBuilder.append(BaseApplicationImpl.getApplication().getRuntime().getLongAccountUin());
  ...
  protected void prewrite()
  {
    ...
    try
    {
      ...
      if (this.resData == null) {
        ...
        localJSONObject = new JSONObject(new String(this.resData));
      }
  ...
  public String toString()
  {
    ...
    localStringBuilder.append("GuideData{beginTime=");
    ...
    localStringBuilder.append(", skinData=");
    localStringBuilder.append(this.skinData);
    localStringBuilder.append('}');
 ...
 * Qualified Name:     com.tencent.mobileqq.kandian.biz.skin.GuideData
