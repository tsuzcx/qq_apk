  ...
  implements Manager
{
  ...
  public ReadInJoyBaseResManager(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqVipDownloaderInterface = ((IDownloaderFactory)QRoute.api(IDownloaderFactory.class)).getDownloader(4);
  ...
  private boolean a(String paramString1, String paramString2, BaseResData paramBaseResData, String paramString3, DownloadTask paramDownloadTask)
  {
    ...
    //   8: astore_1
    //   9: aload_1
    //   10: invokevirtual 88	java/io/File:exists	()Z
    //   13: istore 7
    //   15: iconst_0
    //   16: istore 6
    //   18: iload 7
    //   20: ifeq +104 -> 124
    //   23: aload_1
    //   24: invokevirtual 92	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   27: aload_0
    //   28: aload_2
    //   29: invokevirtual 95	com/tencent/mobileqq/kandian/biz/skin/ReadInJoyBaseResManager:a	(Ljava/lang/String;)Ljava/lang/String;
    //   32: iconst_0
    //   33: invokestatic 101	com/tencent/mobileqq/utils/FileUtils:uncompressZip	(Ljava/lang/String;Ljava/lang/String;Z)V
    //   36: aload_0
    //   37: aload_0
    //   38: getfield 38	com/tencent/mobileqq/kandian/biz/skin/ReadInJoyBaseResManager:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    //   41: invokevirtual 105	com/tencent/common/app/AppInterface:getApp	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   44: aload 4
    //   46: aload_3
    //   47: invokevirtual 108	com/tencent/mobileqq/kandian/biz/skin/ReadInJoyBaseResManager:a	(Landroid/content/Context;Ljava/lang/String;Lcom/tencent/mobileqq/kandian/biz/skin/entity/BaseResData;)V
    //   50: aload_1
    //   51: invokevirtual 111	java/io/File:delete	()Z
    //   54: pop
    //   55: iload 6
    //   57: ireturn
    //   58: astore_2
    //   59: goto +58 -> 117
    //   62: astore_2
    //   63: new 113	java/lang/StringBuilder
    //   66: dup
    //   67: invokespecial 114	java/lang/StringBuilder:<init>	()V
    //   70: astore_3
    //   71: aload_3
    //   72: ldc 116
    //   74: invokevirtual 120	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   77: pop
    //   78: aload_3
    //   79: aload 4
    //   81: invokevirtual 120	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   84: pop
    //   85: aload_3
    //   86: ldc 122
    ...
    //   92: aload_3
    //   93: aload_2
    //   94: invokestatic 128	com/tencent/qphone/base/util/QLog:getStackTraceString	(Ljava/lang/Throwable;)Ljava/lang/String;
    ...
    //   108: invokestatic 137	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   111: iconst_1
    //   112: istore 6
    //   114: goto -64 -> 50
    //   117: aload_1
    //   118: invokevirtual 111	java/io/File:delete	()Z
    //   121: pop
    //   122: aload_2
    //   123: athrow
    //   124: aload_0
    //   125: aload_2
    //   126: aload 4
    //   128: invokevirtual 140	com/tencent/mobileqq/kandian/biz/skin/ReadInJoyBaseResManager:a	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   131: invokestatic 144	com/tencent/mobileqq/utils/FileUtils:createDirectory	(Ljava/lang/String;)Ljava/io/File;
    //   134: pop
    //   135: aload_0
    //   136: getfield 31	com/tencent/mobileqq/kandian/biz/skin/ReadInJoyBaseResManager:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   139: aload 5
    //   141: getfield 149	com/tencent/mobileqq/vip/DownloadTask:a	Ljava/lang/String;
    //   144: invokevirtual 153	java/util/concurrent/ConcurrentHashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   147: checkcast 155	java/lang/String
    //   150: invokestatic 159	com/tencent/mobileqq/utils/FileUtils:fileExists	(Ljava/lang/String;)Z
    //   153: ifeq +192 -> 345
    //   156: aload_0
    //   157: getfield 31	com/tencent/mobileqq/kandian/biz/skin/ReadInJoyBaseResManager:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   160: aload 5
    //   162: getfield 149	com/tencent/mobileqq/vip/DownloadTask:a	Ljava/lang/String;
    //   165: invokevirtual 153	java/util/concurrent/ConcurrentHashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   168: checkcast 155	java/lang/String
    //   171: aload_0
    //   172: aload_2
    //   173: aload 4
    //   175: invokevirtual 140	com/tencent/mobileqq/kandian/biz/skin/ReadInJoyBaseResManager:a	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   178: iconst_0
    //   179: invokestatic 163	com/tencent/mobileqq/utils/FileUtils:copyDirectory	(Ljava/lang/String;Ljava/lang/String;Z)I
    //   182: pop
    //   183: new 113	java/lang/StringBuilder
    //   186: dup
    //   187: invokespecial 114	java/lang/StringBuilder:<init>	()V
    //   190: astore_1
    //   191: aload_1
    //   192: ldc 165
    ...
    //   198: aload_1
    //   199: aload_0
    //   200: getfield 31	com/tencent/mobileqq/kandian/biz/skin/ReadInJoyBaseResManager:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   203: aload 5
    //   205: getfield 149	com/tencent/mobileqq/vip/DownloadTask:a	Ljava/lang/String;
    //   208: invokevirtual 153	java/util/concurrent/ConcurrentHashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   211: checkcast 155	java/lang/String
    //   214: invokevirtual 120	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   217: pop
    //   218: aload_1
    //   219: ldc 167
    //   221: invokevirtual 120	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   224: pop
    //   225: aload_1
    //   226: aload_0
    //   227: aload_2
    //   228: aload 4
    //   230: invokevirtual 140	com/tencent/mobileqq/kandian/biz/skin/ReadInJoyBaseResManager:a	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    //   244: invokestatic 137	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   247: iconst_0
    //   248: ireturn
    //   249: astore_1
    //   250: aload_0
    //   251: getfield 26	com/tencent/mobileqq/kandian/biz/skin/ReadInJoyBaseResManager:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   254: astore_3
    //   255: new 113	java/lang/StringBuilder
    //   258: dup
    //   259: invokespecial 114	java/lang/StringBuilder:<init>	()V
    //   262: astore 5
    //   264: aload 5
    //   266: aload_2
    ...
    //   293: invokevirtual 172	java/util/HashMap:remove	(Ljava/lang/Object;)Ljava/lang/Object;
    //   296: pop
    //   297: new 113	java/lang/StringBuilder
    //   300: dup
    //   301: invokespecial 114	java/lang/StringBuilder:<init>	()V
    //   304: astore_2
    //   305: aload_2
    //   306: ldc 174
    //   308: invokevirtual 120	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   311: pop
    //   312: aload_2
    //   313: aload 4
    //   315: invokevirtual 120	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   318: pop
    //   319: aload_2
    //   320: ldc 122
    ...
    //   326: aload_2
    //   327: aload_1
    //   328: invokestatic 128	com/tencent/qphone/base/util/QLog:getStackTraceString	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   331: invokevirtual 120	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   334: pop
    //   335: ldc 130
    //   337: iconst_2
    //   338: aload_2
    //   339: invokevirtual 133	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   342: invokestatic 137	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   345: iconst_0
    //   346: ireturn
