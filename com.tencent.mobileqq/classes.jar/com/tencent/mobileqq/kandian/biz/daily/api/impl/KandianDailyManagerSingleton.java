...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/mobileqq/kandian/biz/daily/api/impl/KandianDailyManagerSingleton;", "Lcom/tencent/mobileqq/kandian/biz/daily/api/IKandianDailyManager;", "()V", "getDailyMsgBoxName", "", "message", "Lcom/tencent/imcore/message/Message;", "launchKandianDaily", "", "ctx", "Landroid/content/Context;", "clearTop", "", "b", "Landroid/os/Bundle;", "launchFrom", "", "kandian_feature_impl_release"}, k=1, mv={1, 1, 16})
public final class KandianDailyManagerSingleton
  implements IKandianDailyManager
{
  public static final KandianDailyManagerSingleton INSTANCE = new KandianDailyManagerSingleton();
  ...
  public void launchKandianDaily(@Nullable Context paramContext, boolean paramBoolean, @Nullable Bundle paramBundle, int paramInt)
  {
    ...
    if (localObject1 != null)
    {
      ...
      Object localObject3 = RIJQQAppInterfaceUtil.e();
      if (localObject3 != null)
      {
        RIJMergeKanDianMessage.a((String)localObject2, (QQAppInterface)localObject3);
        localObject3 = RIJKanDianRedDotUtils.a(((QQAppInterface)localObject1).getMessageFacade().r(AppConstants.KANDIAN_DAILY_UIN, 1008), "kandian_daily_red_pnt");
        ...
        localObject1 = ReadInJoyActivityHelper.INSTANCE;
        if (paramContext == null) {
          Intrinsics.throwNpe();
        }
        ((ReadInJoyActivityHelper)localObject1).launchKanDianDailyActivity(paramContext, paramInt, paramBundle, paramBoolean);
        return;
      }
 ...
 * Qualified Name:     com.tencent.mobileqq.kandian.biz.daily.api.impl.KandianDailyManagerSingleton
