  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    if (ReadInJoyAdIMAXBrowserFragment.c(this.a)) {
      return;
    }
    ReadInJoyAdIMAXBrowserFragment.a(this.a, true);
    paramView = new HashMap();
    paramView.put("stat_src", "5");
    ((IRIJAdService)QRoute.api(IRIJAdService.class)).report(new AdReportData().a((AppInterface)ReadInJoyAdIMAXBrowserFragment.f(this.a)).a(this.a.getQBaseActivity()).a(20).b(27).a(ReadInJoyAdIMAXBrowserFragment.e(this.a)).a(ReadInJoyAdIMAXBrowserFragment.d(this.a)).d(((IRIJAdUtilService)QRoute.api(IRIJAdUtilService.class)).getBusiJson(paramView)));
  }
}
