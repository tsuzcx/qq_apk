  ...
  extends DataSetObserver
{
  ...
  public void onChanged()
  {
    if (ReadInJoyVideoTagSelectionFragment.a(this.a).getCount() > 0)
    {
      ...
      localObject = ((ReadInJoyVideoTagSelectionFragment)localObject).getString(2131915535, new Object[] { Integer.valueOf(ReadInJoyVideoTagSelectionFragment.a((ReadInJoyVideoTagSelectionFragment)localObject).getCount()), Integer.valueOf(5) });
      ...
      ReadInJoyVideoTagSelectionFragment.c(this.a).setText(localSpannableStringBuilder);
      return;
    }
