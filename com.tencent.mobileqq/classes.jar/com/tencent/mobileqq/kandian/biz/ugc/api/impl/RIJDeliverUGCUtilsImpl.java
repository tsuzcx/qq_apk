  ...
  public String replaceUrlInLog(@Nullable String paramString)
  {
    ...
    if (paramString != null)
    {
      ...
      if (paramString != null)
      {
        ...
        return new Regex(this.URL_PREFIX).replace(paramString, "");
      }
    }
    return null;
  }
