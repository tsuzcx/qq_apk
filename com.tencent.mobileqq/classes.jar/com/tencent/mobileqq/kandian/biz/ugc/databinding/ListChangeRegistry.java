...
{
  private static final Pools.SynchronizedPool<ListChangeRegistry.ListChanges> a = new Pools.SynchronizedPool(10);
  private static final CallbackRegistry.NotifierCallback<ObservableList.OnListChangedCallback, ObservableList, ListChangeRegistry.ListChanges> b = new ListChangeRegistry.1();
  ...
  {
    ListChangeRegistry.ListChanges localListChanges2 = (ListChangeRegistry.ListChanges)a.acquire();
