  ...
  implements Runnable
{
  ...
  public void run()
  {
    Intent localIntent = new Intent(this.jdField_a_of_type_AndroidAppActivity, ReadInJoyDeliverUGCActivity.class);
    localIntent.putExtra("is_from_kan_dian", true);
    localIntent.putExtra("support_topic", true);
    localIntent.putExtra("ugcPushType", 1);
    localIntent.putExtra("key_from", this.jdField_a_of_type_Int);
