  ...
  implements View.OnClickListener, LocalMediaGridAdapter.OnItemListener, ISelectVideoView, QQPermissionCallback
{
  ...
  private SelectVideoPresenter jdField_a_of_type_ComTencentMobileqqKandianBizUgcSelectvideoSelectVideoPresenter;
  private ReadInJoyObserver jdField_a_of_type_ComTencentMobileqqKandianRepoFeedsReadInJoyObserver = new SelectVideoFragment.1(this);
  ...
  private void b()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqKandianBizUgcSelectvideoSelectVideoPresenter.a();
      return;
    }
  ...
  public int a()
  {
    return this.jdField_a_of_type_ComTencentMobileqqKandianBizUgcCoverselectLocalMediaGridAdapter.getItemCount();
  }
  
  public AlbumUtils.LocalMediaInfo a(int paramInt)
  {
    return (AlbumUtils.LocalMediaInfo)this.jdField_a_of_type_ComTencentMobileqqKandianBizUgcCoverselectLocalMediaGridAdapter.getItem(paramInt);
  }
  
  public void a(int paramInt)
  {
    this.jdField_a_of_type_ComTencentMobileqqKandianBizUgcSelectvideoSelectVideoPresenter.a(paramInt);
  }
  
  public void a(AlbumUtils.LocalMediaInfo paramLocalMediaInfo)
  {
    this.jdField_a_of_type_ComTencentMobileqqKandianBizUgcSelectvideoSelectVideoPresenter.a(paramLocalMediaInfo);
  }
  
  public void a(List<AlbumUtils.LocalMediaInfo> paramList, boolean paramBoolean)
  {
    this.jdField_a_of_type_ComTencentMobileqqKandianBizUgcCoverselectLocalMediaGridAdapter.appendList(paramList);
    if (this.jdField_a_of_type_ComTencentMobileqqKandianBizUgcCoverselectLocalMediaGridAdapter.isEmpty())
    {
  ...
  {
    return this.jdField_a_of_type_ComTencentMobileqqKandianBizUgcSelectvideoSelectVideoPresenter.a(paramLocalMediaInfo);
  }
  
  public void b(int paramInt)
  {
    this.jdField_a_of_type_ComTencentMobileqqKandianBizUgcCoverselectLocalMediaGridAdapter.a(paramInt);
  }
  ...
  public void onAttach(Activity paramActivity)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqKandianBizUgcSelectvideoSelectVideoPresenter = new SelectVideoPresenter(getBaseActivity(), this);
  ...
  public void onClick(View paramView)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqKandianBizUgcSelectvideoSelectVideoPresenter.b();
      return;
    }
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    return View.inflate(this.jdField_a_of_type_AndroidAppActivity, 2131559980, null);
  }
  
  public void onDestroy()
  {
    super.onDestroy();
    this.jdField_a_of_type_ComTencentMobileqqKandianBizUgcSelectvideoSelectVideoPresenter.a().c();
  ...
  {
    super.onPause();
    this.jdField_a_of_type_ComTencentMobileqqKandianBizUgcSelectvideoSelectVideoPresenter.a().b();
  }
  
  public void onResume()
  {
    super.onResume();
    this.jdField_a_of_type_ComTencentMobileqqKandianBizUgcSelectvideoSelectVideoPresenter.a().a();
  }
  
  public void onViewCreated(View paramView, Bundle paramBundle)
  {
    super.onViewCreated(paramView, paramBundle);
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView = ((RecyclerView)paramView.findViewById(2131380668));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131379781));
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)paramView.findViewById(2131380723));
    this.jdField_b_of_type_AndroidViewViewGroup = ((ViewGroup)paramView.findViewById(2131378810));
    this.jdField_a_of_type_ComTencentWidgetImmersiveImmersiveTitleBar2 = ((ImmersiveTitleBar2)paramView.findViewById(2131378881));
    this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131364715);
    ...
    this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131366219);
    d();
    ...
    this.jdField_a_of_type_ComTencentMobileqqKandianBaseViewWidgetAlbumPermissionView.setContextStyleBlack(false);
    this.jdField_a_of_type_ComTencentMobileqqKandianBaseViewWidgetAlbumPermissionView.setCallback(this);
    this.jdField_a_of_type_ComTencentMobileqqKandianBizUgcSelectvideoSelectVideoPresenter.a().a(this.jdField_a_of_type_AndroidViewViewGroup);
    b();
  }
}
