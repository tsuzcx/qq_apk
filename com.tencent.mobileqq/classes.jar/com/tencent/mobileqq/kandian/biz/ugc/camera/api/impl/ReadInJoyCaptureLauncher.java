  ...
  implements IReadInJoyCaptureLauncher
{
  ...
  private static volatile ReadInJoyCaptureLauncher instance;
  ...
  private static Bundle generalBundle(Bundle paramBundle)
  {
    ...
    localBundle.putInt("key_max_duration", ReadInJoyHelper.y(BaseApplicationImpl.getApplication().getRuntime()));
    return localBundle;
  }
  
  public static ReadInJoyCaptureLauncher getInstance()
  {
    if (instance == null) {
      try
      {
        if (instance == null) {
          instance = new ReadInJoyCaptureLauncher();
        }
      }
      finally {}
    }
  ...
  {
    DialogUtil.a(paramContext, 230).setMessage(HardCodeUtil.a(2131910275)).setPositiveButton(2131892267, new ReadInJoyCaptureLauncher.1()).show();
  }
  ...
  public void launchFromNative(Context paramContext, Bundle paramBundle)
  {
    ...
    {
      QQToast.makeText(paramContext, 2131915837, 0).show();
      return;
    }
    downloadFilterSo();
    if (bool)
  ...
  public void launchFromViolaForResult(Activity paramActivity, Bundle paramBundle, byte paramByte)
  {
    ...
    {
      QQToast.makeText(paramActivity, 2131915837, 0).show();
      return;
    }
    downloadFilterSo();
    if (bool)
  ...
  {
    boolean bool = ((IShortVideoGuideUtil)QRoute.api(IShortVideoGuideUtil.class)).isResourceReady(paramIPublicAccountH5AbilityPlugin.getRuntime().b());
    if (!((ICaptureUtil)QRoute.api(ICaptureUtil.class)).supportCapture())
    {
      showTip(paramContext);
      return;
 ...
 * Qualified Name:     com.tencent.mobileqq.kandian.biz.ugc.camera.api.impl.ReadInJoyCaptureLauncher
