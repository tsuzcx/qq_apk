...
{
  private VideoCompositeHelper jdField_a_of_type_ComTencentMobileqqEditorCompositeVideoCompositeHelper = new VideoCompositeHelper();
  private ReadInJoyVideoCompositeManager.OnVideoCompositeListener jdField_a_of_type_ComTencentMobileqqKandianBizUgcCaptureReadInJoyVideoCompositeManager$OnVideoCompositeListener;
  
  private void a(PublishVideoEntry paramPublishVideoEntry, int paramInt, String paramString)
  {
    ReadInJoyVideoCompositeManager.OnVideoCompositeListener localOnVideoCompositeListener = this.jdField_a_of_type_ComTencentMobileqqKandianBizUgcCaptureReadInJoyVideoCompositeManager$OnVideoCompositeListener;
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqKandianBizUgcCaptureReadInJoyVideoCompositeManager$OnVideoCompositeListener = paramOnVideoCompositeListener;
  }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    VideoCompositeHelper localVideoCompositeHelper = this.jdField_a_of_type_ComTencentMobileqqEditorCompositeVideoCompositeHelper;
