  ...
  implements Runnable
{
  ...
  public void run()
  {
    if (ReadInJoyVoicePlayController.c(this.this$0))
    {
      if (ReadInJoyVoicePlayController.d(this.this$0) != null) {
        ReadInJoyVoicePlayController.d(this.this$0).requestAudioFocus(null, 3, 2);
      }
    }
    else if (ReadInJoyVoicePlayController.d(this.this$0) != null) {
      ReadInJoyVoicePlayController.d(this.this$0).abandonAudioFocus(null);
    }
    if (QLog.isColorLevel())
    {
      ...
      localStringBuilder.append(ReadInJoyVoicePlayController.c(this.this$0));
