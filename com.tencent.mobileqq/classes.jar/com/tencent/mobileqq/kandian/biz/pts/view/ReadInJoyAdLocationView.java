  ...
  extends ViewBase
{
  ...
  private void a(VafContext paramVafContext)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = localBoringViewImpl;
  ...
  private void b()
  {
    ...
    {
      i = Utils.dp2px(3.0D);
      Object localObject = Utils.toInteger(this.jdField_a_of_type_OrgJsonJSONObject.optString("setMidMarginString:"));
      if (localObject != null) {
