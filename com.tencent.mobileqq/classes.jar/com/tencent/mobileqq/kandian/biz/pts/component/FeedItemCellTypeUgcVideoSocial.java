  ...
  extends FeedItemCellTypeUgcPlainSocial
{
  ...
  public FeedItemCell a()
  {
    ...
    return a(this.jdField_a_of_type_ComTencentMobileqqKandianBizFrameworkReadInJoyBaseAdapter, this.jdField_a_of_type_ComTencentMobileqqAppFaceIFaceDecoder).r().l().g().n().q().j();
  }
