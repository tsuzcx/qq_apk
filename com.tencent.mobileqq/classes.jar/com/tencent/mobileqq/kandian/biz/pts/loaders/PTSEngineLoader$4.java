  ...
  implements Runnable
{
  ...
  public void run()
  {
    if (!FileUtils.fileExists(PTSEngineLoader.a(this.this$0)))
    {
    ...
    ((StringBuilder)localObject).append(PTSEngineLoader.a(this.this$0));
    ...
    if (FileUtils.fileExists(PTSEngineLoader.b(this.this$0)))
    {
      ...
      FileUtils.deleteDirectory(PTSEngineLoader.b(this.this$0));
    }
    try
    {
      localObject = new StringBuilder();
      ...
      localStringBuilder.append(PTSEngineLoader.b(this.this$0));
