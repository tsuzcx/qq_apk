  ...
  extends FeedItemCell
{
  ...
  public FeedItemCell e()
  {
    if (this.h)
    {
      ...
      if ((this.l != null) && ((this.l instanceof ComponentContentGallery))) {
        localLinearLayout.addView((ComponentContentGallery)this.l);
      }
      if (this.m != null) {
  ...
  {
    this.l = new ComponentContentGallery(this.e);
    return this;
  }
  ...
  public FeedItemCell q()
  {
    ...
    if ((this.l != null) && ((this.l instanceof ComponentContentGallery)))
    {
      ((ComponentContentGallery)this.l).setAdapter(this.g);
      ((ComponentContentGallery)this.l).setPosition(this.a);
    }
    return this;
  }
}
