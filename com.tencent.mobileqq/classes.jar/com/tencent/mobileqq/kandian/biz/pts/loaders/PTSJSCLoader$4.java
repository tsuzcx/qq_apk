  ...
  implements Runnable
{
  ...
  public void run()
  {
    if (!FileUtils.fileExists(PTSJSCLoader.d(this.this$0)))
    {
      QLog.i("PTSJSCLoader", 1, "[handleDownloadPTSJSC], offline dir does not exist.");
      return;
    }
    if (!PTSOfflineUtil.a(PTSJSCLoader.d(this.this$0), "4044"))
    {
      QLog.i("PTSJSCLoader", 1, "[handleDownloadPTSJSC], offline dir is not valid.");
      return;
    }
    Object localObject = new StringBuilder();
    ((StringBuilder)localObject).append(PTSJSCLoader.d(this.this$0));
    ...
    if (FileUtils.fileExists(PTSJSCLoader.b(this.this$0)))
    {
      ...
      FileUtils.deleteDirectory(PTSJSCLoader.b(this.this$0));
    }
    try
    {
      localObject = new StringBuilder();
      ...
      localStringBuilder.append(PTSJSCLoader.b(this.this$0));
