...
public class OfflineUtils
{
  ...
  private static QQHashMap<String, TemplateFactory> d = new QQHashMap(2019, 10, 10000);
  private static Map<String, OfflineUtils.ConfigData> e = new ConcurrentHashMap();
  ...
  public static TemplateFactory a(String paramString)
  {
    try
    {
      paramString = (TemplateFactory)d.get(paramString);
      return paramString;
    }
    finally
    {
  ...
  public static List<String> a(java.io.InputStream paramInputStream)
  {
    ...
    //   15: astore_2
    //   16: new 110	java/util/ArrayList
    //   19: dup
    //   20: invokespecial 111	java/util/ArrayList:<init>	()V
    //   23: astore_1
    //   24: aload_2
    //   25: invokevirtual 114	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   28: astore_3
    //   29: aload_3
    //   30: ifnull +14 -> 44
    //   33: aload_1
    //   34: aload_3
    //   35: invokeinterface 118 2 0
    //   40: pop
    //   41: goto -17 -> 24
    //   44: aload_0
    //   45: invokevirtual 123	java/io/InputStream:close	()V
    //   48: aload_1
    //   49: areturn
    //   50: astore_1
    //   51: goto +28 -> 79
    ...
    //   56: iconst_2
    //   57: ldc 127
    //   59: invokestatic 132	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   62: aload_0
    //   63: invokevirtual 123	java/io/InputStream:close	()V
    //   66: aconst_null
    //   67: areturn
    //   68: ldc 125
    //   70: iconst_2
    //   71: ldc 134
    //   73: invokestatic 132	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   76: goto -32 -> 44
    //   79: aload_0
  ...
  public static void a(String paramString, TemplateFactory paramTemplateFactory)
  {
    try
    {
      d.put(paramString, paramTemplateFactory);
      return;
    }
    finally
    {
  ...
  public static boolean a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    if (paramString1 != null)
    {
      ...
      paramString3 = d("8.8.17");
      paramString3.add(Integer.valueOf(Integer.parseInt("5770")));
  ...
  /* Error */
  public static OfflineUtils.ConfigData b(String paramString)
  {
    // Byte code:
    //   0: getstatic 36	com/tencent/mobileqq/kandian/biz/pts/util/OfflineUtils:e	Ljava/util/Map;
    //   3: aload_0
    //   4: invokeinterface 182 2 0
    //   9: checkcast 184	com/tencent/mobileqq/kandian/biz/pts/util/OfflineUtils$ConfigData
    //   12: astore_1
    //   13: aload_1
    //   14: ifnull +5 -> 19
    //   17: aload_1
    //   18: areturn
    //   19: new 184	com/tencent/mobileqq/kandian/biz/pts/util/OfflineUtils$ConfigData
    //   22: dup
    //   23: invokespecial 185	com/tencent/mobileqq/kandian/biz/pts/util/OfflineUtils$ConfigData:<init>	()V
    //   26: astore_1
    //   27: aload_0
    //   28: invokestatic 190	com/tencent/biz/common/offline/OfflineEnvHelper:b	(Ljava/lang/String;)Ljava/lang/String;
    //   31: astore_2
    //   32: aload_2
    //   33: ifnonnull +29 -> 62
    //   36: ldc 125
    //   38: iconst_2
    //   39: ldc 192
    //   41: invokestatic 132	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   44: aload_1
    //   45: iconst_0
    //   46: putfield 195	com/tencent/mobileqq/kandian/biz/pts/util/OfflineUtils$ConfigData:a	Z
    //   49: getstatic 36	com/tencent/mobileqq/kandian/biz/pts/util/OfflineUtils:e	Ljava/util/Map;
    //   52: aload_0
    //   53: aload_1
    //   54: invokeinterface 196 3 0
    //   59: pop
    //   60: aload_1
    //   61: areturn
    ...
    //   119: astore_2
    //   120: new 200	java/io/File
    //   123: dup
    //   124: aload_2
    //   125: invokespecial 203	java/io/File:<init>	(Ljava/lang/String;)V
    //   128: astore_3
    //   129: aload_3
    //   130: invokevirtual 207	java/io/File:exists	()Z
    //   133: ifne +52 -> 185
    //   136: new 71	java/lang/StringBuilder
    //   139: dup
    //   140: invokespecial 72	java/lang/StringBuilder:<init>	()V
    //   143: astore_3
    //   144: aload_3
    //   145: ldc 209
    ...
    //   164: invokestatic 132	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   167: aload_1
    //   168: iconst_1
    //   169: putfield 195	com/tencent/mobileqq/kandian/biz/pts/util/OfflineUtils$ConfigData:a	Z
    //   172: getstatic 36	com/tencent/mobileqq/kandian/biz/pts/util/OfflineUtils:e	Ljava/util/Map;
    //   175: aload_0
    //   176: aload_1
    //   177: invokeinterface 196 3 0
    //   182: pop
    //   183: aload_1
    //   184: areturn
    //   185: aload_1
    //   186: iconst_0
    //   187: putfield 195	com/tencent/mobileqq/kandian/biz/pts/util/OfflineUtils$ConfigData:a	Z
    //   190: getstatic 36	com/tencent/mobileqq/kandian/biz/pts/util/OfflineUtils:e	Ljava/util/Map;
    //   193: aload_0
    //   194: aload_1
    //   195: invokeinterface 196 3 0
    //   200: pop
    //   201: aload_1
    //   202: areturn
    //   203: astore_2
    ...
    //   211: ldc 211
    //   213: aload_2
    //   214: invokestatic 214	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   217: getstatic 36	com/tencent/mobileqq/kandian/biz/pts/util/OfflineUtils:e	Ljava/util/Map;
    //   220: aload_0
    //   221: aload_1
    //   222: invokeinterface 196 3 0
    //   227: pop
    //   228: aload_1
    //   229: areturn
    //   230: getstatic 36	com/tencent/mobileqq/kandian/biz/pts/util/OfflineUtils:e	Ljava/util/Map;
    //   233: aload_0
    //   234: aload_1
    //   235: invokeinterface 196 3 0
    //   240: pop
    //   241: aload_2
    //   242: athrow
    // Local variable table:
  ...
  public static String b(java.io.InputStream paramInputStream)
  {
    ...
    //   12: invokespecial 108	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   15: astore_2
    //   16: new 71	java/lang/StringBuilder
    //   19: dup
    //   20: invokespecial 72	java/lang/StringBuilder:<init>	()V
    //   23: astore_1
    //   24: aload_2
    //   25: invokevirtual 114	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   28: astore_3
    ...
    //   39: goto -15 -> 24
    //   42: aload_0
    //   43: invokevirtual 123	java/io/InputStream:close	()V
    //   46: goto +32 -> 78
    //   49: astore_1
    //   50: goto +33 -> 83
    //   53: ldc 125
    //   55: iconst_2
    //   56: ldc 127
    //   58: invokestatic 132	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   61: aload_0
    //   62: invokevirtual 123	java/io/InputStream:close	()V
    //   65: aconst_null
    //   66: areturn
    //   67: ldc 125
    //   69: iconst_2
    //   70: ldc 134
    //   72: invokestatic 132	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   75: goto -33 -> 42
    //   78: aload_1
    //   79: invokevirtual 84	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   82: areturn
    //   83: aload_0
    //   84: invokevirtual 123	java/io/InputStream:close	()V
    //   87: goto +5 -> 92
    //   90: aload_1
    //   91: athrow
    //   92: goto -2 -> 90
  ...
  public static void c()
  {
    ...
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append(OfflineEnvHelper.b(str));
  ...
  private static List<Integer> d(String paramString)
  {
    if (paramString == null) {
      return null;
    }
