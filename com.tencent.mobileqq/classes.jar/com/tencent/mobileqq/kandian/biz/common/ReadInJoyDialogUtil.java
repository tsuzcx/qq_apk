...
public class ReadInJoyDialogUtil
{
  ...
  {
    paramContext = new TwoLineContentDialog(paramContext, 2131756189);
    paramContext.setContentView(2131562713);
  ...
  public static void a(@NotNull Context paramContext)
  {
    ...
    DialogUtil.a(paramContext, 230, null, paramContext.getResources().getString(2131717759), local1, local1).show();
  }
}
