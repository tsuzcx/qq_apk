...
public class Achilles
{
  ...
  public static String a(String paramString)
  {
    for (;;)
    {
      try
      {
        ((IReadInJoyHelper)QRoute.api(IReadInJoyHelper.class)).maybeInitializedAladdin();
        localObject1 = a();
      ...
      try
      {
        ...
        if ((localObject != null) && (!((Set)localObject).isEmpty()))
        {
          ...
          if ((localObject != null) && (((AchillesParams)localObject).isEnable()))
          {
            ...
            if (localObject != null)
            {
              paramBoolean = RockDownloaderProxy.b((RockDownloadInfo)localObject);
  ...
  private static void b(boolean paramBoolean, String paramString1, int paramInt, String paramString2)
  {
    ...
    localObject = ((IReadInJoyUtils)QRoute.api(IReadInJoyUtils.class)).getAccount();
    HashMap localHashMap = new HashMap();
    localHashMap.put("param_FailCode", String.valueOf(paramInt));
    localHashMap.put("param_FailMsg", paramString2);
    localHashMap.put("uin", localObject);
    StatisticCollector.getInstance(((IReadInJoyUtils)QRoute.api(IReadInJoyUtils.class)).getAppRuntime().getApplication()).collectPerformance((String)localObject, "actAchilles", paramBoolean, l2 - l1, 0L, localHashMap, null, false);
    if (paramBoolean) {
      paramString2 = "1";
    } else {
      paramString2 = "0";
