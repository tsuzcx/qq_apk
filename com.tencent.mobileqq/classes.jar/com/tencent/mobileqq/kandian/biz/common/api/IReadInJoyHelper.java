  ...
  extends QRouteApi
{
  ...
  public abstract void addKanDianChatSessionKey(@Nullable String paramString1, @Nullable String paramString2, @Nullable byte[] paramArrayOfByte);
  ...
  @Nullable
  public abstract byte[] getKanDianChatSessionKey(@Nullable String paramString1, @Nullable String paramString2);
