...
{
  public ViewModelDelegateKt$viewModels$1(KDFragmentFrame paramKDFragmentFrame)
  {
    super(0);
  }
  ...
  {
    ViewModelStore localViewModelStore = this.$this_viewModels.n().getViewModelStore();
    Intrinsics.checkExpressionValueIsNotNull(localViewModelStore, "this.frameFragment.viewModelStore");
 ...
 * Qualified Name:     com.tencent.mobileqq.kandian.biz.common.ktx.ViewModelDelegateKt.viewModels.1
