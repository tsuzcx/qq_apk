...
{
  RIJEntryViewUtils$showEntryDialog$$inlined$let$lambda$1(Function0 paramFunction01, SlidingUpDialog paramSlidingUpDialog, Function0 paramFunction02)
  {
    super(0);
  }
  ...
  {
    this.$leftIconClickListener$inlined.invoke();
