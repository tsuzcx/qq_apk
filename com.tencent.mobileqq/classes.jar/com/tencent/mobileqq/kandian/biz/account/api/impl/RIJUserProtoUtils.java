...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/mobileqq/kandian/biz/account/api/impl/RIJUserProtoUtils;", "Lcom/tencent/mobileqq/kandian/biz/account/api/IRIJUserProtoUtils;", "()V", "check", "", "context", "Landroid/content/Context;", "afterSuccess", "Ljava/lang/Runnable;", "kandian_feature_impl_release"}, k=1, mv={1, 1, 16})
public final class RIJUserProtoUtils
  implements IRIJUserProtoUtils
{
  public static final RIJUserProtoUtils INSTANCE = new RIJUserProtoUtils();
  ...
  public boolean check(@NotNull Context paramContext, @Nullable Runnable paramRunnable)
  {
    ...
    if ((!bool1) && (bool2))
    {
      ...
      PublicAccountReportUtils.a(null, "", "0X800992C", "0X800992C", 0, 0, "", "", "", "");
      return false;
    }
 ...
 * Qualified Name:     com.tencent.mobileqq.kandian.biz.account.api.impl.RIJUserProtoUtils
