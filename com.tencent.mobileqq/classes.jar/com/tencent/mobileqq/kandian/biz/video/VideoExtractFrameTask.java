...
{
  private static String jdField_a_of_type_JavaLangString = "VideoExtractFrameTask";
  private long jdField_a_of_type_Long;
  private Context jdField_a_of_type_AndroidContentContext;
  private VideoExtractFrameTask.Callback jdField_a_of_type_ComTencentMobileqqKandianBizVideoVideoExtractFrameTask$Callback = null;
  private VideoExtractFrameTask.TaskHandler jdField_a_of_type_ComTencentMobileqqKandianBizVideoVideoExtractFrameTask$TaskHandler;
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqKandianBizVideoVideoExtractFrameTask$TaskHandler = new VideoExtractFrameTask.TaskHandler(this, Looper.getMainLooper());
    this.jdField_a_of_type_ComTencentMobileqqKandianBizVideoVideoExtractFrameTask$TaskHandler.sendEmptyMessageDelayed(1, this.jdField_a_of_type_Long);
    c();
  }
  
  public void a(VideoExtractFrameTask.Callback paramCallback)
  {
    this.jdField_a_of_type_ComTencentMobileqqKandianBizVideoVideoExtractFrameTask$Callback = paramCallback;
  }
  
  public void b()
  {
    Object localObject = this.jdField_a_of_type_ComTencentMobileqqKandianBizVideoVideoExtractFrameTask$TaskHandler;
    if (localObject != null)
    {
      ((VideoExtractFrameTask.TaskHandler)localObject).removeCallbacksAndMessages(null);
      this.jdField_a_of_type_ComTencentMobileqqKandianBizVideoVideoExtractFrameTask$TaskHandler = null;
    }
    ...
    this.jdField_a_of_type_ComTencentMobileqqKandianBizVideoVideoExtractFrameTask$Callback = null;
