  ...
  implements Function1<String, Unit>
{
  ...
  public final void invoke(@Nullable String paramString)
  {
    for (;;)
    {
      try
      {
        localObject = this.$playingVideoHolder.a;
        ...
        if (localObject != null)
        {
          ...
          str = ((IVideoPlayerWrapper)localObject).c();
          if (paramString != null) {
          ...
          paramString.append(this.$videoInfo.g);
          ...
          ViolaAccessHelper.a((Context)this.this$0.a(), "", paramString, localBundle, true);
          return;
        }
      }
