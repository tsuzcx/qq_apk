...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/mobileqq/kandian/biz/video/api/IVideoVolumeController$EventListener;", "", "onFocusGain", "", "onFocusLoss", "onHeadsetStateChanged", "on", "", "onPhoneCome", "onSystemVolumeChanged", "volume", "", "kandian-api_release"}, k=1, mv={1, 1, 16})
