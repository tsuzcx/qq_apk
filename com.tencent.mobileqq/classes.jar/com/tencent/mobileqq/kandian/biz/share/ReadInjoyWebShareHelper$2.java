...
class ReadInjoyWebShareHelper$2
  implements OpensdkBusinessObserver
{
  ReadInjoyWebShareHelper$2(ReadInjoyWebShareHelper paramReadInjoyWebShareHelper, Intent paramIntent) {}
  
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ReadInjoyWebShareHelper.c(this.jdField_a_of_type_ComTencentMobileqqKandianBizShareReadInjoyWebShareHelper);
    if (paramBoolean) {
      try
      {
    ...
    else
    {
      ...
      ReadInjoyWebShareHelper.a(this.jdField_a_of_type_ComTencentMobileqqKandianBizShareReadInjoyWebShareHelper).startActivityForResult(this.jdField_a_of_type_AndroidContentIntent, (byte)1);
    }
  }
}
 ...
 * Qualified Name:     com.tencent.mobileqq.kandian.biz.share.ReadInjoyWebShareHelper.2
