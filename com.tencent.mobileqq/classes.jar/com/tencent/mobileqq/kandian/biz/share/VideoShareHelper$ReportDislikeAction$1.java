  ...
  implements ActionSheet.WatchDismissActions
{
  ...
  {
    if (VideoShareHelper.l(this.a.a))
    {
      VideoShareHelper.c(this.a.a, false);
      VideoShareHelper.a(this.a.a).a(VideoShareHelper.b(this.a.a), VideoShareHelper.c(this.a.a), true, false);
      return;
    }
    VideoShareHelper.a(this.a.a).a(VideoShareHelper.b(this.a.a), VideoShareHelper.c(this.a.a), true, true);
  }
}
