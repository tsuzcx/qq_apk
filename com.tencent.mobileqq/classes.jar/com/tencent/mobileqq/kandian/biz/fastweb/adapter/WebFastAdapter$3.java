...
class WebFastAdapter$3
  implements Runnable
{
  WebFastAdapter$3(WebFastAdapter paramWebFastAdapter, DownloadInfo paramDownloadInfo) {}
          ...
          if ((!TextUtils.isEmpty(((FastWebRecommendUGInfo)localObject).d)) && (((FastWebRecommendUGInfo)localObject).d.equals(this.a.d)))
          {
            ...
            try
            {
              if (localJSONObject.opt("id_recommend_category_txt") != null)
              {
                ...
                j = k;
                localJSONObject.put("text", ((FastWebRecommendUGInfo)localObject).k);
                j = k;
 ...
 * Qualified Name:     com.tencent.mobileqq.kandian.biz.fastweb.adapter.WebFastAdapter.3
