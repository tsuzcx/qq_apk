  ...
  extends MessageMicro<ReportReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34, 40, 50, 58, 66, 72, 80, 88, 98 }, new String[] { "uin", "platid", "clientver", "platver", "appid", "missionid", "buffer", "reportdata", "msgids", "cmd", "bHebaFlag", "extend" }, new Object[] { localLong, localInteger, "", "", localInteger, "", "", null, localLong, localInteger, Boolean.valueOf(false), "" }, ReportReqBody.class);
  }
}
