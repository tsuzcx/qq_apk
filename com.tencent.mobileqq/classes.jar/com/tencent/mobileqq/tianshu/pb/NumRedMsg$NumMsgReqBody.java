  ...
  extends MessageMicro<NumMsgReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32, 42 }, new String[] { "i_proto_ver", "ui_plat_id", "str_client_ver", "ui64_uin", "rpt_num_msg" }, new Object[] { localInteger, localInteger, "", Long.valueOf(0L), null }, NumMsgReqBody.class);
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\tmp\classes8.jar
 * Qualified Name:     com.tencent.mobileqq.tianshu.pb.NumRedMsg.NumMsgReqBody
