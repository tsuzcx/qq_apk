  ...
  extends MessageMicro<DownloadEncryptConf>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "bool_enable_encrypt_request", "bool_enable_encrypted_pic", "uint32_ctrl_flag" }, new Object[] { localBoolean, localBoolean, Integer.valueOf(0) }, DownloadEncryptConf.class);
  }
}
