...
public final class HwConfigPersistentPB
{
    ...
    extends MessageMicro<HwConfigPB>
  {
    ...
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26 }, new String[] { "rpt_config_item_list", "rpt_net_seg_conf_list", "rpt_short_video_net_conf" }, new Object[] { null, null, null }, HwConfigPB.class);
