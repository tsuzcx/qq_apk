  ...
  extends MessageMicro<ShortVideoConf>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32 }, new String[] { "uint32_channel_type", "rpt_msg_netsegconf", "bool_open_hardware_codec", "bool_send_ahead_signal" }, new Object[] { Integer.valueOf(0), null, localBoolean, localBoolean }, ShortVideoConf.class);
  }
}
