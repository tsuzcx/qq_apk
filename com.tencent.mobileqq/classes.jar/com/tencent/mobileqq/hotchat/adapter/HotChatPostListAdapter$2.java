  ...
  implements View.OnClickListener
{
  ...
  {
    paramView = new Intent(this.c.mContext, QQBrowserActivity.class).putExtra("url", String.format("https://buluo.qq.com/mobile/detail.html?bid=%s&pid=%s&_wv=1027&webview=1&from=reliao", new Object[] { this.a, this.b }));
    this.c.mContext.startActivity(paramView);
