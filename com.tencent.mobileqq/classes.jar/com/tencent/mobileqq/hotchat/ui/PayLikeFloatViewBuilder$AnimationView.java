  ...
  extends TextView
{
  ...
  public PayLikeFloatViewBuilder$AnimationView(Context paramContext, QQAppInterface paramQQAppInterface, avsx paramavsx)
  {
    super(paramContext);
    super.setGravity(17);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Avsx = paramavsx;
  ...
  public void b()
  {
    if ((this.jdField_a_of_type_AndroidGraphicsDrawableAnimationDrawable == null) || (this.jdField_a_of_type_AndroidGraphicsDrawableAnimationDrawable.getNumberOfFrames() != 20))
    {
      ...
      Drawable[] arrayOfDrawable = this.jdField_a_of_type_Avsx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
