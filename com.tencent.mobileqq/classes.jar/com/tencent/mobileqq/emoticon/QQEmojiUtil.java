...
public class QQEmojiUtil
{
  ...
  public static final Drawable loadEmojiFromDisk(Resources paramResources, int paramInt)
  {
    ...
    //   67: areturn
    //   68: invokestatic 250	com/tencent/mobileqq/utils/RandomAccessFileManager:a	()Lcom/tencent/mobileqq/utils/RandomAccessFileManager;
    //   71: getstatic 255	com/tencent/mobileqq/text/AppleEmojiManager:EMOJI_FILE	Ljava/lang/String;
    //   74: invokevirtual 258	com/tencent/mobileqq/utils/RandomAccessFileManager:a	(Ljava/lang/String;)Ljava/io/RandomAccessFile;
    //   77: astore 5
    //   79: iload_1
    //   80: sipush 1000
    //   83: isub
    ...
    //   89: aload 5
    //   91: lload_3
    //   92: invokevirtual 264	java/io/RandomAccessFile:seek	(J)V
    //   95: aload 5
    //   97: astore_0
    //   98: invokestatic 270	com/tencent/commonsdk/pool/ByteArrayPool:getGenericInstance	()Lcom/tencent/commonsdk/pool/ByteArrayPool;
    //   101: iconst_4
    //   102: invokevirtual 274	com/tencent/commonsdk/pool/ByteArrayPool:getBuf	(I)[B
    //   105: astore 7
    //   107: aload 5
    //   109: astore_0
    //   110: aload 5
    ...
    //   114: iconst_0
    //   115: iconst_4
    //   116: invokevirtual 278	java/io/RandomAccessFile:read	([BII)I
    //   119: pop
    //   120: aload 5
    //   122: astore_0
    //   123: aload 7
    //   125: invokestatic 282	com/tencent/mobileqq/text/AppleEmojiManager:bytesToInt	([B)I
    //   128: istore_2
    //   129: aload 5
    //   131: astore_0
    //   132: invokestatic 270	com/tencent/commonsdk/pool/ByteArrayPool:getGenericInstance	()Lcom/tencent/commonsdk/pool/ByteArrayPool;
    //   135: aload 7
    //   137: invokevirtual 286	com/tencent/commonsdk/pool/ByteArrayPool:returnBuf	([B)V
    //   140: aload 5
    //   142: astore_0
    ...
    //   201: aload 5
    //   203: astore_0
    //   204: invokestatic 270	com/tencent/commonsdk/pool/ByteArrayPool:getGenericInstance	()Lcom/tencent/commonsdk/pool/ByteArrayPool;
    //   207: sipush 4096
    //   210: invokevirtual 274	com/tencent/commonsdk/pool/ByteArrayPool:getBuf	(I)[B
    //   213: astore 7
    //   215: aload 5
    //   217: astore_0
    //   218: aload 7
    ...
    //   225: iconst_0
    //   226: iload_2
    //   227: invokevirtual 278	java/io/RandomAccessFile:read	([BII)I
    //   230: invokestatic 296	android/graphics/BitmapFactory:decodeByteArray	([BII)Landroid/graphics/Bitmap;
    //   233: astore 7
    //   235: aload 5
    //   237: astore_0
    //   238: aload 7
    //   240: invokestatic 301	com/tencent/mobileqq/util/Utils:a	(Landroid/graphics/Bitmap;)I
    //   243: istore_2
    //   244: aload 5
    //   246: astore_0
    ...
    //   306: aload 5
    //   308: astore_0
    //   309: new 305	android/graphics/drawable/BitmapDrawable
    //   312: dup
    //   313: aload 7
    //   315: invokespecial 308	android/graphics/drawable/BitmapDrawable:<init>	(Landroid/graphics/Bitmap;)V
    //   318: astore 7
    //   320: aload 5
    //   322: astore_0
    ...
    //   457: aload 5
    //   459: ifnull +12 -> 471
    //   462: invokestatic 250	com/tencent/mobileqq/utils/RandomAccessFileManager:a	()Lcom/tencent/mobileqq/utils/RandomAccessFileManager;
    //   465: getstatic 255	com/tencent/mobileqq/text/AppleEmojiManager:EMOJI_FILE	Ljava/lang/String;
    //   468: invokevirtual 316	com/tencent/mobileqq/utils/RandomAccessFileManager:a	(Ljava/lang/String;)V
    //   471: aload 7
    //   473: areturn
    //   474: aload 5
    //   476: ifnull +12 -> 488
    //   479: invokestatic 250	com/tencent/mobileqq/utils/RandomAccessFileManager:a	()Lcom/tencent/mobileqq/utils/RandomAccessFileManager;
    //   482: getstatic 255	com/tencent/mobileqq/text/AppleEmojiManager:EMOJI_FILE	Ljava/lang/String;
    //   485: invokevirtual 316	com/tencent/mobileqq/utils/RandomAccessFileManager:a	(Ljava/lang/String;)V
    //   488: aconst_null
    //   489: areturn
    //   490: aload 5
    //   492: astore_0
    ...
    //   539: aload 5
    //   541: ifnull +12 -> 553
    //   544: invokestatic 250	com/tencent/mobileqq/utils/RandomAccessFileManager:a	()Lcom/tencent/mobileqq/utils/RandomAccessFileManager;
    //   547: getstatic 255	com/tencent/mobileqq/text/AppleEmojiManager:EMOJI_FILE	Ljava/lang/String;
    //   550: invokevirtual 316	com/tencent/mobileqq/utils/RandomAccessFileManager:a	(Ljava/lang/String;)V
    //   553: aconst_null
    //   554: areturn
    //   555: astore 6
    //   557: goto +15 -> 572
    ...
    //   588: ldc_w 319
    //   591: aload 6
    //   593: invokestatic 323	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   596: aload 5
    //   598: ifnonnull +9 -> 607
    //   601: aload 5
    //   603: astore_0
    //   604: invokestatic 326	com/tencent/mobileqq/text/EmotcationConstants:reDownloadAppleEmoji	()V
    //   607: aload 5
    //   609: ifnull +12 -> 621
    //   612: invokestatic 250	com/tencent/mobileqq/utils/RandomAccessFileManager:a	()Lcom/tencent/mobileqq/utils/RandomAccessFileManager;
    //   615: getstatic 255	com/tencent/mobileqq/text/AppleEmojiManager:EMOJI_FILE	Ljava/lang/String;
    //   618: invokevirtual 316	com/tencent/mobileqq/utils/RandomAccessFileManager:a	(Ljava/lang/String;)V
    ...
    //   661: aload_0
    //   662: ifnull +12 -> 674
    //   665: invokestatic 250	com/tencent/mobileqq/utils/RandomAccessFileManager:a	()Lcom/tencent/mobileqq/utils/RandomAccessFileManager;
    //   668: getstatic 255	com/tencent/mobileqq/text/AppleEmojiManager:EMOJI_FILE	Ljava/lang/String;
    //   671: invokevirtual 316	com/tencent/mobileqq/utils/RandomAccessFileManager:a	(Ljava/lang/String;)V
    //   674: aload 5
    //   676: athrow
    //   677: iload_2
    //   678: iflt -188 -> 490
