...
public class SogouEmoji
{
  ...
  public SogouEmoji(BaseChatPie paramBaseChatPie)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqModelEmoticonManager = ((EmoticonManager)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.a().app.getManager(QQManagerFactory.EMOTICON_MANAGER));
    this.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiManager = ((EmojiManager)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.a().app.getManager(QQManagerFactory.CHAT_EMOTION_MANAGER));
    this.jdField_a_of_type_ComTencentMobileqqAppEmoticonHandler = ((EmoticonHandler)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.a().app.getBusinessHandler(BusinessHandlerFactory.HANDLER_EMOSM));
    this.jdField_a_of_type_ComTencentMobileqqEmoticonSogouEmojiTaskController = new SogouEmojiTaskController(this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.a());
    if (QLog.isColorLevel()) {
      QLog.d("SogouEmoji", 2, "func SogouEmoji constructor ends");
    }
    this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.a().app.addObserver(this.jdField_a_of_type_ComTencentMobileqqAppEmoticonObserver);
  }
  
  private boolean a(String paramString)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie == null) || (this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.a().app == null))
    {
      if (QLog.isColorLevel()) {
  ...
  public void a()
  {
    ...
    {
      QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.a().app;
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.a() != null) && (!NetworkUtil.d(this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.a().getApplicationContext())))
    {
      QQToast.a(BaseApplicationImpl.sApplication, 2131694457, 0).a();
      return;
    }
    this.jdField_a_of_type_ComTencentMobileqqModelEmoticonManager.a(Integer.toString(paramInt), paramString, new SogouEmoji.2(this, paramInt, paramString));
  }
  ...
  void a(Emoticon paramEmoticon)
  {
    ...
    PicEmoticonInfo localPicEmoticonInfo = new PicEmoticonInfo(this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.a().app.getCurrentAccountUin());
    localPicEmoticonInfo.type = 6;
    localPicEmoticonInfo.emoticon = paramEmoticon;
    this.jdField_a_of_type_ComTencentMobileqqModelEmoticonManager.a(paramEmoticon.epId, new SogouEmoji.5(this, localPicEmoticonInfo));
  }
