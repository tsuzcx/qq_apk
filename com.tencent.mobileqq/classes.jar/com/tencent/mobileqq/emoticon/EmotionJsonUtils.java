...
public class EmotionJsonUtils
{
  ...
  public static String a(QQAppInterface paramQQAppInterface, EmoticonPackage paramEmoticonPackage, int paramInt, byte[] paramArrayOfByte, ArrayList<Emoticon> paramArrayList, ReqInfo paramReqInfo)
  {
    if (QLog.isColorLevel()) {
      QLog.d("EmotionJsonUtils", 2, "parseJson : parseJson start");
    }
    Object localObject = a(paramQQAppInterface, paramEmoticonPackage, paramArrayOfByte, paramArrayList, paramReqInfo);
    if (localObject != null) {
    ...
    for (;;)
    {
      ...
      localObject = (EmoticonManager)paramQQAppInterface.getManager(QQManagerFactory.EMOTICON_MANAGER);
      try
      {
        ...
        paramArrayOfByte = a(paramEmoticonPackage, paramInt, (EmoticonManager)localObject, localJSONObject, str, paramQQAppInterface, "");
        ...
        for (paramEmoticonPackage.supportSize = paramQQAppInterface;; paramEmoticonPackage.supportSize = localJSONObject.getJSONArray("supportSize").toString()) {
          do
          {
            ...
            ((EmoticonManager)localObject).a(paramEmoticonPackage);
            int i = ((EmoticonManager)localObject).a(str);
            boolean bool = false;
            ...
            paramArrayOfByte = a(paramEmoticonPackage, paramInt, paramArrayList, paramReqInfo, (EmoticonManager)localObject, localJSONObject, str, i, bool);
            paramQQAppInterface = paramArrayOfByte;
            if (paramArrayOfByte != null) {
              break;
            }
  ...
  protected static String a(QQAppInterface paramQQAppInterface, EmoticonPackage paramEmoticonPackage, byte[] paramArrayOfByte, ArrayList<Emoticon> paramArrayList, ReqInfo paramReqInfo)
  {
    if (paramQQAppInterface == null)
    {
      if (QLog.isColorLevel()) {
  ...
  public static String a(QQAppInterface paramQQAppInterface, DownloadTask paramDownloadTask, boolean paramBoolean)
  {
    ...
    int i = ((Bundle)localObject).getInt("jsonType", EmojiManager.c);
  ...
  protected static String a(EmoticonPackage paramEmoticonPackage, int paramInt, EmoticonManager paramEmoticonManager, JSONObject paramJSONObject, String paramString1, String paramString2, String paramString3)
  {
    int i2 = 0;
            ...
            for (int n = paramJSONObject.getInt("updateTime");; n = 0)
            {
              ...
              for (;;)
              {
                ...
                for (int i1 = 3;; i1 = 0)
                {
                  ...
                  a(paramEmoticonPackage, paramInt, paramEmoticonManager, paramJSONObject, paramString1, m, j, n);
  ...
  protected static String a(EmoticonPackage paramEmoticonPackage, int paramInt1, ArrayList<Emoticon> paramArrayList, ReqInfo paramReqInfo, EmoticonManager paramEmoticonManager, JSONObject paramJSONObject, String paramString, int paramInt2, boolean paramBoolean)
  {
    ...
    if (j < n)
    {
      ...
      localObject = paramEmoticonManager.a(paramString, str1);
      if (localObject == null) {
        if (paramInt1 != EmojiManager.d)
        {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        k = i;
        break;
        paramEmoticonManager.b(localArrayList);
        if (paramEmoticonPackage.newSoundEp) {
          paramEmoticonManager.a(paramEmoticonPackage);
        }
        if (i == 0) {}
        for (paramBoolean = true;; paramBoolean = false)
        {
          paramReqInfo.a = paramBoolean;
          return null;
        }
      }
    }
  ...
  protected static void a(EmoticonPackage paramEmoticonPackage, int paramInt1, EmoticonManager paramEmoticonManager, JSONObject paramJSONObject, String paramString, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    paramEmoticonManager = paramEmoticonManager.b(paramString);
    if (paramEmoticonManager != null)
    {
      paramEmoticonPackage.status = paramEmoticonManager.status;
      paramEmoticonPackage.valid = paramEmoticonManager.valid;
    }
    ...
    if (paramEmoticonManager != null)
    {
      paramEmoticonPackage.wordingId = paramEmoticonManager.wordingId;
      return;
    }
    paramEmoticonPackage.wordingId = -1L;
  }
  
  protected static void a(EmoticonPackage paramEmoticonPackage, int paramInt1, ArrayList<Emoticon> paramArrayList, EmoticonManager paramEmoticonManager, JSONArray paramJSONArray, int paramInt2, boolean paramBoolean)
  {
    int i = 0;
    Object localObject;
    String str1;
    ...
    if (i < paramInt2)
    {
      ...
      localObject = paramEmoticonManager.a(str3, str1);
      if (localObject == null)
      {
        if (paramInt1 == EmojiManager.d) {
          break label362;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if ((paramBoolean) && (j == 0)) {
          paramEmoticonManager.a((Emoticon)localObject);
        }
        if (QLog.isColorLevel()) {
  ...
  protected static void a(EmoticonPackage paramEmoticonPackage, int paramInt, ArrayList<Emoticon> paramArrayList, EmoticonManager paramEmoticonManager, JSONObject paramJSONObject1, long paramLong, JSONObject paramJSONObject2, JSONArray paramJSONArray1, JSONArray paramJSONArray2)
  {
    ...
    for (int i = paramJSONArray1.getInt("isOriginal");; i = 0)
    {
      ...
      for (j = paramJSONArray2.getInt("feeType");; j = 0)
      {
        ...
        for (;;)
        {
          ...
          a(paramEmoticonPackage, paramInt, paramArrayList, paramEmoticonManager, paramJSONObject1, paramJSONObject1.length(), true);
          return;
          if (j <= 0) {
            break;
          }
          paramEmoticonPackage.extraFlags &= i;
          break;
          paramJSONObject1 = paramEmoticonManager.b(paramEmoticonPackage.epId);
