...
public class SogouEmoji$4
  implements Runnable
{
  public SogouEmoji$4(asjj paramasjj, List paramList) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        Object localObject = this.this$0.jdField_a_of_type_Awyr.a(str);
        if (localObject == null)
        {
          this.this$0.jdField_a_of_type_Asih.a(str, asih.c);
          if (QLog.isColorLevel()) {
        ...
        else
        {
          ...
          localObject = this.this$0.jdField_a_of_type_Awyr.a(str, true);
