  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        Object localObject = this.this$0.jdField_a_of_type_ComTencentMobileqqModelEmoticonManager.a(str);
        if (localObject == null)
        {
          this.this$0.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiManager.a(str, EmojiManager.c);
          if (QLog.isColorLevel()) {
        ...
        else
        {
          ...
          localObject = this.this$0.jdField_a_of_type_ComTencentMobileqqModelEmoticonManager.a(str, true);
