...
public class QQSysFaceUtil
{
  ...
  public static int convertToLocal(int paramInt)
  {
    ...
    if (i == -1)
    {
      if (paramInt < SERVER_TO_LOCALE.length) {
        return SERVER_TO_LOCALE[paramInt];
      }
  ...
  public static int convertToServer(int paramInt)
  {
    ...
    if (i == -1)
    {
      if (paramInt < LOCALE_TO_SERVER.length) {
        return LOCALE_TO_SERVER[paramInt];
      }
  ...
  public static int getAnimEmoCount()
  {
    if (sAnimEmoCount == -1)
    {
      ...
      if (!TextUtils.isEmpty(localSystemAndEmojiConfBean.a.a)) {
        sAnimEmoCount = parseAnimCountByModel(localSystemAndEmojiConfBean.a.a, Build.MODEL);
      }
      if ((sAnimEmoCount == -1) && (!TextUtils.isEmpty(localSystemAndEmojiConfBean.a.b))) {
        sAnimEmoCount = parseAnimCountByVersion(localSystemAndEmojiConfBean.a.b, Build.VERSION.SDK_INT);
      }
  ...
  public static Drawable getFaceDrawable(int paramInt)
  {
    ...
    if (paramInt < EmotcationConstants.VALID_SYS_EMOTCATION_COUNT)
    {
      ...
      if (GlobalImageCache.a != null) {
        localObject = QQEmojiUtil.getResourceDrawableThroughImageCache((Resources)localObject, paramInt);
      }
    }
    ...
    do
    {
      ...
      localDrawable = QQSysAndEmojiResMgr.getInstance().getResImpl(1).getDrawable(paramInt);
  ...
  public static Drawable getFaceGifDrawable(int paramInt)
  {
    ...
    QQSysAndEmojiResInfo localQQSysAndEmojiResInfo = QQSysAndEmojiResMgr.getInstance().getResImpl(1);
    if ((localQQSysAndEmojiResInfo instanceof QQSysFaceResImpl)) {
      return ((QQSysFaceResImpl)localQQSysAndEmojiResInfo).getGifDrawable(paramInt);
    }
    return null;
  }
