  ...
  implements Handler.Callback, Manager, BusinessObserver
{
  ...
  public SttManager.ISttListener a;
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    return ((SttManager)paramQQAppInterface.getManager(QQManagerFactory.STT_MANAGER)).a();
  }
  ...
  {
    SttTask localSttTask = SttTask.a(paramMessageForPtt, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt);
  ...
  public void a(int paramInt)
  {
    ...
    try
    {
      ...
      localHashMap.put("appversion", "8.5.5");
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localMsgBody.msg_ptt_shard_resp.has())
        {
          ...
          localSttTask = (SttTask)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramArrayOfByte);
      ...
      if (localMsgBody.msg_ptt_resp.has())
      {
        ...
        continue;
        label134:
        boolean bool = localSttTask.a(localMsgBody);
        if (QLog.isColorLevel()) {
  ...
  public Long b(MessageForPtt paramMessageForPtt, int paramInt)
  {
    ...
    boolean bool = QVipConfigManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "have_add_ptt_svip_gray_msg", false);
    if ((((QVipAutoPttConfig)localObject).jdField_a_of_type_Int == 2) && (!bool) && (VipUtils.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) && (PttSlideStateHelper.c))
    {
      localObject = new UniteGrayTipParam(paramMessageForPtt.frienduin, paramMessageForPtt.selfuin, HardCodeUtil.a(2131714499), paramMessageForPtt.istroop, -5020, 655392, paramMessageForPtt.time);
      ...
      QVipConfigManager.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "have_add_ptt_svip_gray_msg", true);
    ...
    for (;;)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("Q.stt", 1, "stage2 first translate It is need add gray msg and insert falied:conf.stage == " + ((QVipAutoPttConfig)localObject).jdField_a_of_type_Int + " && " + bool);
      }
    }
  }
  ...
  public boolean b(MessageForPtt paramMessageForPtt)
  {
    ...
    {
      return true;
      PttUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (QLog.isColorLevel()) {
        QLog.d("Q.stt", 2, "needAuotoChange AutoChangeFlag=" + PttSlideStateHelper.c + " AutoChangeSetTime=" + PttSlideStateHelper.a + " isTranslating=" + a(paramMessageForPtt) + "msgPtt.msgTime=" + paramMessageForPtt.msgTime + " msgPtt.time=" + paramMessageForPtt.time + " msgPtt.sttAbility=" + paramMessageForPtt.sttAbility + " isRedPackPTT=" + VoiceRedPacketHelper.a(paramMessageForPtt));
      }
    } while ((!a(paramMessageForPtt)) && (!VoiceRedPacketHelper.a(paramMessageForPtt)) && (PttSlideStateHelper.c) && ((PttSlideStateHelper.a < paramMessageForPtt.msgTime) || (PttSlideStateHelper.a < paramMessageForPtt.time)) && (paramMessageForPtt.voiceChangeFlag != 1) && ((paramMessageForPtt.sttAbility == 1) || (paramMessageForPtt.sttAbility == 3)));
    return false;
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    } while ((localObject1 == null) || (((SttTask)localObject1).a() == null));
    ...
    if (paramMessage != null)
    {
      ...
      this.jdField_b_of_type_AndroidOsHandler.post(new SttManager.6(this, (SttTask)localObject1));
      return true;
    }
    paramMessage = ((SttTask)localObject1).a();
    a(paramMessage, paramMessage.getSttResult().c());
    this.jdField_b_of_type_AndroidOsHandler.post(new SttManager.7(this, (SttTask)localObject1));
    return true;
  }
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        localSttTask = (SttTask)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(localLong);
        if (localSttTask != null) {
          break;
        }
      } while (!QLog.isColorLevel());
