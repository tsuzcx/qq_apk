...
public class LoginUserGuideHelper$GuideRunnable
  implements Runnable
{
  private final area jdField_a_of_type_Area;
  ...
  public LoginUserGuideHelper$GuideRunnable(Activity paramActivity, QQAppInterface paramQQAppInterface, boolean paramBoolean, area paramarea)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
    this.b = new WeakReference(paramQQAppInterface);
    this.jdField_a_of_type_Boolean = paramBoolean;
    this.jdField_a_of_type_Area = paramarea;
  }
  ...
  public void run()
  {
    ...
    LoginUserGuideHelper.a(localActivity, localQQAppInterface, this.jdField_a_of_type_Boolean, this.jdField_a_of_type_Area);
  }
}
