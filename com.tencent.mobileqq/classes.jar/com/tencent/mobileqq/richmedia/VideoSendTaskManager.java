...
public class VideoSendTaskManager
{
  ...
  {
    ThreadManager.post(new agso(this, paramHashMap), 5, null, true);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString, Bundle paramBundle)
  {
    ...
    TransferRequest localTransferRequest = a(new agsp(this, paramQQAppInterface, paramString));
  ...
  public void b(QQAppInterface paramQQAppInterface, String paramString, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_MqqOsMqqHandler.post(new agsr(this, paramString));
      return;
    }
    finally {}
  }
