...
public class CaptureVideoFilterManager
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = PathUtils.jdField_a_of_type_JavaLangString + "/capture_qsvf" + File.separator;
    jdField_b_of_type_JavaLangString = jdField_a_of_type_JavaLangString + "capture_res" + File.separator;
    jdField_b_of_type_Boolean = false;
    jdField_f_of_type_JavaLangString = PathUtils.jdField_a_of_type_JavaLangString + "/qav" + File.separator + "beauty" + File.separator;
    g = jdField_f_of_type_JavaLangString + "SKINCOLOR" + File.separator;
    jdField_c_of_type_JavaLangString = jdField_f_of_type_JavaLangString;
    jdField_b_of_type_Int = 0;
    jdField_a_of_type_JavaLangObject = new Object();
    jdField_d_of_type_JavaLangString = jdField_a_of_type_JavaLangString + "lowlight";
    jdField_e_of_type_JavaLangString = jdField_d_of_type_JavaLangString + File.separator + "LowLight.png";
  ...
  public static int a(Context paramContext)
  {
    ...
    for (;;)
    {
      AVLog.printColorLog("CaptureVideoFilterManager", "getQQShortVideoFilterConfigVersion:" + i);
      return i;
      i = j;
    }
  }
  ...
  public static String a(Context paramContext)
  {
    try
    {
      ...
      AVLog.printColorLog("CaptureVideoFilterManager", "getQQShortVideoFilterConfig:" + jdField_a_of_type_JavaLangString + "filter_config.xml" + "|" + localFile.exists());
      if (localFile.exists()) {
  ...
  {
    AVLog.printColorLog("CaptureVideoFilterManager", "setQQShortVideoFilterConfigVersion:" + paramInt);
  ...
  static void a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        AVLog.printColorLog("CaptureVideoFilterManager", "compareContent :" + (l2 - l1));
        return;
        ...
        if (paramString1 != null)
        {
          ...
          while (paramString1.hasNext())
          {
            ...
            while (localIterator.hasNext())
            {
              ...
              {
                AVLog.printColorLog("CaptureVideoFilterManager", "compareContent res:" + localFilterDesc.name + "|" + localFilterDesc.resMD5 + "|" + paramString2.resMD5);
                ...
                AVLog.printColorLog("CaptureVideoFilterManager", "compareContent iconMD5:" + localFilterDesc.name + "|" + localFilterDesc.iconMD5 + "|" + paramString2.iconMD5);
  ...
  private boolean a()
  {
    String str = FileUtils.d("filter_template.cfg");
    boolean bool = b(str);
  ...
  public static boolean a(int paramInt1, long paramLong1, long paramLong2, int paramInt2)
  {
    ...
    if (i < paramInt2)
    {
      AVLog.printColorLog("CaptureVideoFilterManager", "isSupportOfDevice error OSversion: " + i);
      return false;
    }
    paramInt2 = VcSystemInfo.getNumCores();
    if (paramInt2 < paramInt1)
    {
      AVLog.printColorLog("CaptureVideoFilterManager", "isSupportOfDevice error cpucount: " + paramInt2);
      return false;
    }
    long l = VcSystemInfo.getMaxCpuFreq();
    if (l < paramLong1)
    {
      AVLog.printColorLog("CaptureVideoFilterManager", "isSupportOfDevice error cpuFrequency: " + l);
      return false;
    }
    paramLong1 = DeviceInfoUtil.a();
    if (paramLong1 < paramLong2)
    {
      AVLog.printColorLog("CaptureVideoFilterManager", "isSupportOfDevice error memory: " + paramLong1);
      return false;
    }
    return true;
  }
  ...
  private void d()
  {
    File localFile = new File(jdField_e_of_type_JavaLangString);
    if (localFile.exists()) {
      localFile.delete();
    }
    for (;;)
  ...
  public void a(CaptureVideoFilterManager.OnResourceDownloadListener paramOnResourceDownloadListener)
  {
    if ((this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList == null) || (this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size() == 0)) {
      AVLog.printColorLog("CaptureVideoFilterManager", "preDownloadResource list is empty!");
    }
    do
    {
      return;
      ...
      AVLog.printColorLog("CaptureVideoFilterManager", "preDownloadResource list size: " + this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size());
      ...
      while (paramOnResourceDownloadListener.hasNext())
      {
        ...
        if (((FilterCategory)localObject1).a != null)
        {
          ...
          while (((Iterator)localObject1).hasNext())
          {
            ...
            {
              AVLog.printColorLog("CaptureVideoFilterManager", "preDownloadResource predownload: " + localFilterDesc.predownload + ", iconurl: " + localFilterDesc.iconurl + ", resurl:" + localFilterDesc.resurl);
              if (localFilterDesc.predownload == 1)
              {
                ...
                if (!TextUtils.isEmpty(localFilterDesc.iconurl))
                {
                  ...
                  AVLog.printColorLog("CaptureVideoFilterManager", "preDownloadResource icon " + (String)localObject2 + " exist: " + ((File)localObject3).exists());
                  if (!((File)localObject3).exists())
                  {
                    localObject3 = new HttpNetReq();
                    ((HttpNetReq)localObject3).mCallback = new CaptureVideoFilterManager.MyIconHttpListener(this);
                    ...
                    AVNetEngine.a().sendReq((NetReq)localObject3);
                ...
                if ((!TextUtils.isEmpty(localFilterDesc.resurl)) && (!TextUtils.isEmpty((CharSequence)localObject2)))
                {
                  ...
                  AVLog.printColorLog("CaptureVideoFilterManager", "preDownloadResource file " + (String)localObject2 + "params.json" + " exist: " + ((File)localObject3).exists());
                  if (!((File)localObject3).exists())
                  {
                    localObject2 = new HttpNetReq();
                    ((HttpNetReq)localObject2).mCallback = new CaptureVideoFilterManager.MyHttpListener(this);
  ...
  public void b()
  {
    ...
    AVLog.printColorLog("CaptureVideoFilterManager", "init mFilterCategoryRaw size:" + this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size());
  }
