...
public class CaptureVideoFilterManager
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = AppConstants.aK + "capture_qsvf" + File.separator;
    ...
    try
    {
      ...
      if ((paramContext != null) && (!TextUtils.isEmpty(paramContext.jdField_a_of_type_JavaLangString)))
      {
        ...
        if (!((File)localObject).exists())
        {
          ...
          ((HttpNetReq)localObject).jdField_a_of_type_ComTencentMobileqqTransfileINetEngine$INetEngineListener = new ahmh();
      ...
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataCaptureRedDotConfig.updateRedDotInfo(paramInt1, paramInt2, paramString))
        {
          ...
          else
          {
            ...
            this.jdField_a_of_type_AndroidOsHandler.post(new ahme(this));
          }
        }
        else {
          return;
              ...
              if (localFilterDesc.jdField_d_of_type_Int == 1)
              {
                ...
                if (!TextUtils.isEmpty(localFilterDesc.jdField_c_of_type_JavaLangString))
                {
                  ...
                  if (!((File)localObject3).exists())
                  {
                    ...
                    ((HttpNetReq)localObject3).jdField_a_of_type_ComTencentMobileqqTransfileINetEngine$INetEngineListener = new ahmi(this);
                ...
                if ((!TextUtils.isEmpty(localFilterDesc.jdField_a_of_type_JavaLangString)) && (!TextUtils.isEmpty((CharSequence)localObject2)))
                {
                  ...
                  if (!((File)localObject3).exists())
                  {
                    ...
                    ((HttpNetReq)localObject2).jdField_a_of_type_ComTencentMobileqqTransfileINetEngine$INetEngineListener = new ahmg(this);
