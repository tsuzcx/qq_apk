...
public class CapturePtvTemplateManager
{
  ...
  private CapturePtvTemplateManager.DLSession a(PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo, PtvTemplateManager.IPtvTemplateDownloadListener paramIPtvTemplateDownloadListener)
  {
    CapturePtvTemplateManager.DLSession localDLSession = new CapturePtvTemplateManager.DLSession();
    localDLSession.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo = paramPtvTemplateInfo;
    localDLSession.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$IPtvTemplateDownloadListener = paramIPtvTemplateDownloadListener;
    paramIPtvTemplateDownloadListener = new CapturePtvTemplateManager.DLItem();
    paramIPtvTemplateDownloadListener.jdField_a_of_type_JavaLangString = paramPtvTemplateInfo.dgStageName;
    paramIPtvTemplateDownloadListener.jdField_b_of_type_JavaLangString = paramPtvTemplateInfo.dgStageResmd5;
    paramIPtvTemplateDownloadListener.jdField_c_of_type_JavaLangString = paramPtvTemplateInfo.dgStageResurl;
    paramIPtvTemplateDownloadListener.jdField_a_of_type_Boolean = paramPtvTemplateInfo.dgStageUsable;
    paramIPtvTemplateDownloadListener.jdField_b_of_type_Boolean = false;
    localDLSession.jdField_a_of_type_JavaUtilArrayList.add(paramIPtvTemplateDownloadListener);
    paramIPtvTemplateDownloadListener = new CapturePtvTemplateManager.DLItem();
    paramIPtvTemplateDownloadListener.jdField_a_of_type_JavaLangString = paramPtvTemplateInfo.dgModelName;
    paramIPtvTemplateDownloadListener.jdField_b_of_type_JavaLangString = paramPtvTemplateInfo.dgModelResmd5;
    paramIPtvTemplateDownloadListener.jdField_c_of_type_JavaLangString = paramPtvTemplateInfo.dgModelResurl;
    paramIPtvTemplateDownloadListener.jdField_a_of_type_Boolean = paramPtvTemplateInfo.dgModelUsable;
    paramIPtvTemplateDownloadListener.jdField_b_of_type_Boolean = false;
    localDLSession.jdField_a_of_type_JavaUtilArrayList.add(paramIPtvTemplateDownloadListener);
    paramIPtvTemplateDownloadListener = new CapturePtvTemplateManager.DLItem();
    paramIPtvTemplateDownloadListener.jdField_a_of_type_JavaLangString = paramPtvTemplateInfo.name;
    paramIPtvTemplateDownloadListener.jdField_b_of_type_JavaLangString = paramPtvTemplateInfo.md5;
    paramIPtvTemplateDownloadListener.jdField_c_of_type_JavaLangString = paramPtvTemplateInfo.resurl;
    paramIPtvTemplateDownloadListener.jdField_a_of_type_Boolean = paramPtvTemplateInfo.usable;
    paramIPtvTemplateDownloadListener.jdField_b_of_type_Boolean = true;
    localDLSession.jdField_a_of_type_JavaUtilArrayList.add(paramIPtvTemplateDownloadListener);
    localDLSession.jdField_a_of_type_Int = 3;
    return localDLSession;
  }
      ...
      try
      {
        ...
        if (paramCapturePtvTemplateManager != null)
        {
          ...
          if (localJSONObject.has("gesturethreadcoldtime")) {
            com.tencent.sveffects.SvEffectSdkInitor.QQGestureResource.jdField_c_of_type_JavaLangString = localJSONObject.getString("gesturethreadcoldtime");
          }
        ...
        paramCapturePtvTemplateManager = (CapturePtvTemplateManager)localObject1;
        Object localObject3;
        if (localJSONObject.has("bigheadCommonRes"))
        {
          ...
          {
            paramCapturePtvTemplateManager = ((JSONObject)localObject3).optString("bighead_model_name", "");
        ...
        a(paramCaptureRedDotConfig, paramCapturePtvTemplateManager, str1, paramString);
  ...
  private void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        ((HttpNetReq)localObject3).mCallback = new CapturePtvTemplateManager.3(this, paramString, (String)localObject2, paramQQAppInterface, str);
        ...
        ((HttpNetReq)localObject3).mContinuErrorLimit = NetworkUtil.a(NetworkCenter.getInstance().getNetType());
        try
        {
          ...
          ((IHttpEngineService)((QQAppInterface)paramQQAppInterface).getRuntimeService(IHttpEngineService.class, "all")).sendReq((NetReq)localObject3);
          if (!QLog.isColorLevel()) {
            break;
          }
  ...
  private void a(CapturePtvTemplateManager.DLSession paramDLSession)
  {
    CapturePtvTemplateManager.BusinessParam localBusinessParam2 = (CapturePtvTemplateManager.BusinessParam)this.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(paramDLSession.jdField_a_of_type_Int));
    CapturePtvTemplateManager.BusinessParam localBusinessParam1 = localBusinessParam2;
    if (localBusinessParam2 == null)
    {
      localBusinessParam1 = new CapturePtvTemplateManager.BusinessParam();
      this.jdField_a_of_type_JavaUtilHashMap.put(Integer.valueOf(paramDLSession.jdField_a_of_type_Int), localBusinessParam1);
    }
    localBusinessParam1.b.add(paramDLSession);
  }
  ...
  private void a(CapturePtvTemplateManager.DLSession paramDLSession, CapturePtvTemplateManager.DLItem paramDLItem, long paramLong1, long paramLong2)
  {
    ...
    do
    {
      CapturePtvTemplateManager.BusinessParam localBusinessParam;
      do
      {
        return;
        localBusinessParam = (CapturePtvTemplateManager.BusinessParam)this.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(paramDLSession.jdField_a_of_type_Int));
        if (localBusinessParam != null) {
          break;
        }
      } while (!QLog.isColorLevel());
      QLog.e("CapturePtvTemplateManager", 2, "multiSessionDownloadProcessUpdate: BusinessParam=null  kind=" + paramDLSession.jdField_a_of_type_Int + " mItem.mName=" + paramDLItem.jdField_a_of_type_JavaLangString);
      return;
      paramDLItem.jdField_a_of_type_Long = paramLong1;
      paramDLItem.jdField_b_of_type_Long = paramLong2;
      paramDLItem.jdField_c_of_type_Boolean = true;
      paramLong2 = 0L;
      paramLong1 = 1L;
      ...
      while (paramDLItem.hasNext())
      {
        ...
        {
          localDLItem = (CapturePtvTemplateManager.DLItem)localBusinessParam.jdField_a_of_type_JavaUtilHashMap.get(localDLItem.jdField_a_of_type_JavaLangString);
          if (localDLItem != null) {
            if (localDLItem.jdField_c_of_type_Boolean)
            {
              paramLong2 += localDLItem.jdField_a_of_type_Long;
              paramLong1 += localDLItem.jdField_b_of_type_Long;
            }
            else
            {
              paramLong1 += 1000L;
    ...
    } while (paramDLSession.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$IPtvTemplateDownloadListener == null);
  ...
  public static boolean a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      for (;;)
      {
        try
        {
          Object localObject = FileUtils.c(localFile.getPath());
          int j = i;
          ...
          if (i != 0)
          {
            ...
            try
            {
              ZipUtils.unZipFile(localFile, a(paramString2));
              return true;
            }
  ...
  private CapturePtvTemplateManager.DLSession b(PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo, PtvTemplateManager.IPtvTemplateDownloadListener paramIPtvTemplateDownloadListener)
  {
    CapturePtvTemplateManager.DLSession localDLSession = new CapturePtvTemplateManager.DLSession();
    localDLSession.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo = paramPtvTemplateInfo;
    localDLSession.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$IPtvTemplateDownloadListener = paramIPtvTemplateDownloadListener;
    paramIPtvTemplateDownloadListener = new CapturePtvTemplateManager.DLItem();
    paramIPtvTemplateDownloadListener.jdField_a_of_type_JavaLangString = paramPtvTemplateInfo.bigHeadName;
    paramIPtvTemplateDownloadListener.jdField_b_of_type_JavaLangString = paramPtvTemplateInfo.bigHeadMd5;
    paramIPtvTemplateDownloadListener.jdField_c_of_type_JavaLangString = paramPtvTemplateInfo.bigHeadUrl;
    paramIPtvTemplateDownloadListener.jdField_a_of_type_Boolean = paramPtvTemplateInfo.bigHeadModelUsable;
    paramIPtvTemplateDownloadListener.jdField_b_of_type_Boolean = false;
    localDLSession.jdField_a_of_type_JavaUtilArrayList.add(paramIPtvTemplateDownloadListener);
    paramIPtvTemplateDownloadListener = new CapturePtvTemplateManager.DLItem();
    paramIPtvTemplateDownloadListener.jdField_a_of_type_JavaLangString = paramPtvTemplateInfo.name;
    ...
    paramIPtvTemplateDownloadListener.jdField_b_of_type_Boolean = true;
    localDLSession.jdField_a_of_type_JavaUtilArrayList.add(paramIPtvTemplateDownloadListener);
    localDLSession.jdField_a_of_type_Int = 20;
    return localDLSession;
  }
  
  private void b(CapturePtvTemplateManager.DLSession paramDLSession)
  {
    CapturePtvTemplateManager.BusinessParam localBusinessParam = (CapturePtvTemplateManager.BusinessParam)this.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(paramDLSession.jdField_a_of_type_Int));
    if (localBusinessParam != null) {
      localBusinessParam.b.remove(paramDLSession);
    }
  }
  ...
  private ArrayList<TemplateGroupItem> c()
  {
    ArrayList localArrayList = new ArrayList();
    localArrayList.addAll(this.jdField_a_of_type_JavaUtilList);
    boolean bool1 = DanceGameVideoManager.b();
  ...
  public void a(AppInterface paramAppInterface, CapturePtvTemplateManager.DLSession paramDLSession)
  {
    if ((paramDLSession.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo == null) || (paramAppInterface == null)) {}
    label98:
    label99:
    for (;;)
    {
      return;
      if ((paramDLSession.jdField_a_of_type_JavaUtilArrayList != null) && (paramDLSession.jdField_a_of_type_JavaUtilArrayList.size() > 0))
      {
        a(paramDLSession);
        Iterator localIterator = paramDLSession.jdField_a_of_type_JavaUtilArrayList.iterator();
        int i = 0;
        if (localIterator.hasNext())
        {
          CapturePtvTemplateManager.DLItem localDLItem = (CapturePtvTemplateManager.DLItem)localIterator.next();
          if (localDLItem.jdField_a_of_type_Boolean) {
            break label98;
          }
          a(paramAppInterface, paramDLSession, localDLItem);
          i = 1;
        }
        for (;;)
        {
  ...
  public void a(AppInterface paramAppInterface, CapturePtvTemplateManager.DLSession paramDLSession, CapturePtvTemplateManager.DLItem paramDLItem)
  {
    ...
    if (localObject == null) {
      if (QLog.isColorLevel()) {
        QLog.e("CapturePtvTemplateManager", 2, "[BG]downloadSessionTemplateItem url: businessParam = null kind=" + paramDLSession.jdField_a_of_type_Int);
      }
    }
    for (;;)
    {
      return;
      if (TextUtils.isEmpty(paramDLItem.jdField_a_of_type_JavaLangString)) {
        continue;
      }
      if (((CapturePtvTemplateManager.BusinessParam)localObject).jdField_a_of_type_JavaUtilHashMap.get(paramDLItem.jdField_a_of_type_JavaLangString) != null)
      {
        if (!QLog.isColorLevel()) {
          break;
        }
        QLog.i("CapturePtvTemplateManager", 2, "[BG]downloadSessionTemplateItem[no need download] url: " + paramDLItem.jdField_c_of_type_JavaLangString + " item.mName=" + paramDLItem.jdField_a_of_type_JavaLangString);
        return;
      }
      ((CapturePtvTemplateManager.BusinessParam)localObject).jdField_a_of_type_JavaUtilHashMap.put(paramDLItem.jdField_a_of_type_JavaLangString, paramDLItem);
      ((CapturePtvTemplateManager.BusinessParam)localObject).jdField_a_of_type_JavaUtilArrayList.add(paramDLItem.jdField_a_of_type_JavaLangString);
      localObject = new HttpNetReq();
      ((HttpNetReq)localObject).mCallback = new CapturePtvTemplateManager.SessionResHttpListener(this, paramDLSession, paramDLItem);
      ((HttpNetReq)localObject).mReqUrl = paramDLItem.jdField_c_of_type_JavaLangString;
      ((HttpNetReq)localObject).mHttpMethod = 0;
      ((HttpNetReq)localObject).mOutPath = new File(jdField_a_of_type_JavaIoFile, paramDLItem.jdField_a_of_type_JavaLangString).getPath();
      ((HttpNetReq)localObject).setUserData(paramDLItem);
      ((HttpNetReq)localObject).mContinuErrorLimit = NetworkUtil.a(NetworkCenter.getInstance().getNetType());
      try
      {
        ((IHttpEngineService)paramAppInterface.getRuntimeService(IHttpEngineService.class, "all")).sendReq((NetReq)localObject);
        if (!QLog.isColorLevel()) {
          continue;
        }
        QLog.i("CapturePtvTemplateManager", 2, "downloadSessionTemplateItem url: " + paramDLItem.jdField_c_of_type_JavaLangString);
        return;
      }
  ...
  public void a(AppInterface paramAppInterface, PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo, PtvTemplateManager.IPtvTemplateDownloadListener paramIPtvTemplateDownloadListener)
  {
    ...
    {
      a(paramAppInterface, a(paramPtvTemplateInfo, paramIPtvTemplateDownloadListener));
      return;
    }
    if (paramPtvTemplateInfo.kind == 20)
    {
      a(paramAppInterface, b(paramPtvTemplateInfo, paramIPtvTemplateDownloadListener));
      return;
    }
  ...
  public void a(PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo, int paramInt)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataTemplateGroupItem = new TemplateGroupItem(HardCodeUtil.a(2131701438));
  ...
  void a(List<TemplateGroupItem> paramList)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        localHttpNetReq.mCallback = new CapturePtvTemplateManager.5(this, localPtvTemplateInfo);
        ...
        try
        {
          ...
          if ((localAppRuntime != null) && ((localAppRuntime instanceof ToolRuntimePeak)))
          {
            ...
            {
              ((IHttpEngineService)((PeakAppInterface)localAppRuntime).getRuntimeService(IHttpEngineService.class, "all")).sendReq(localHttpNetReq);
              if (QLog.isColorLevel()) {
  ...
  public ArrayList<TemplateGroupItem> b()
  {
    ArrayList localArrayList = a();
    if (this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataTemplateGroupItem == null)
    {
      this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataTemplateGroupItem = new TemplateGroupItem(HardCodeUtil.a(2131701437));
      this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataTemplateGroupItem.jdField_a_of_type_JavaUtilList = new ArrayList(30);
      a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataTemplateGroupItem);
    }
  ...
  public void b(AppInterface paramAppInterface, PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo, PtvTemplateManager.IPtvTemplateDownloadListener paramIPtvTemplateDownloadListener)
  {
    ...
    for (;;)
    {
      return;
      HttpNetReq localHttpNetReq = new HttpNetReq();
      localHttpNetReq.mCallback = new CapturePtvTemplateManager.8(this, paramPtvTemplateInfo, paramIPtvTemplateDownloadListener);
