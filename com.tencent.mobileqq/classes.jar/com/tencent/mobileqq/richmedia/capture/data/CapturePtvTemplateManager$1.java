  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    //   4: getfield 31	com/tencent/mobileqq/richmedia/capture/data/CapturePtvTemplateManager:h	Ljava/util/List;
    ...
    //   131: aload_1
    //   132: aconst_null
    //   133: invokestatic 79	com/tencent/mobileqq/richmedia/capture/data/CapturePtvTemplateManager:a	(Lcom/tencent/mobileqq/richmedia/capture/data/CapturePtvTemplateManager;Ljava/lang/String;Lcom/tencent/mobileqq/richmedia/capture/data/CaptureRedDotConfig;)Ljava/util/List;
    //   136: astore_1
    //   137: aload_1
    //   138: ifnull +29 -> 167
    //   141: aload_0
    ...
    //   145: getfield 31	com/tencent/mobileqq/richmedia/capture/data/CapturePtvTemplateManager:h	Ljava/util/List;
    //   148: invokeinterface 82 1 0
    //   153: aload_0
    ...
    //   157: getfield 31	com/tencent/mobileqq/richmedia/capture/data/CapturePtvTemplateManager:h	Ljava/util/List;
    //   160: aload_1
    //   161: invokeinterface 86 2 0
    //   166: pop
    //   167: invokestatic 70	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   170: ifeq +11 -> 181
    //   173: ldc 88
    //   175: iconst_2
    //   176: ldc 90
    //   178: invokestatic 94	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   181: aload_0
    ...
    //   185: aload_1
    //   186: iconst_0
    //   187: invokevirtual 97	com/tencent/mobileqq/richmedia/capture/data/CapturePtvTemplateManager:a	(Ljava/util/List;Z)V
    //   190: aload_0
    ...
    //   194: getfield 101	com/tencent/mobileqq/richmedia/capture/data/CapturePtvTemplateManager:l	Lcom/tencent/mobileqq/richmedia/capture/data/CapturePtvTemplateManager$CapturePtvTemplateRefreshListener;
    //   197: ifnull +15 -> 212
    //   200: aload_0
    ...
    //   204: getfield 101	com/tencent/mobileqq/richmedia/capture/data/CapturePtvTemplateManager:l	Lcom/tencent/mobileqq/richmedia/capture/data/CapturePtvTemplateManager$CapturePtvTemplateRefreshListener;
    //   207: invokeinterface 105 1 0
    //   212: return
    //   213: astore_2
    //   214: aload_1
    //   215: astore_3
    ...
    //   219: ifnull +21 -> 240
    //   222: aload_3
    //   223: invokevirtual 65	java/io/InputStream:close	()V
    //   226: goto +14 -> 240
    //   229: astore_2
    //   230: invokestatic 70	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   233: ifeq +7 -> 240
    //   236: aload_2
    //   237: invokevirtual 73	java/lang/Exception:printStackTrace	()V
    //   240: aload_1
    //   241: athrow
