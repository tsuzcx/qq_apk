  ...
  implements Observer
{
  ...
  private PtvTemplateAdapter.IPtvTemplateItemCallback jdField_a_of_type_ComTencentMobileqqRichmediaCaptureAdapterPtvTemplateAdapter$IPtvTemplateItemCallback = new ahll(this);
  ...
  private PtvTemplateManager.IPtvTemplateDownloadListener jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$IPtvTemplateDownloadListener = new ahlm(this);
  ...
  public PtvTemplateAdapter(AppInterface paramAppInterface, Context paramContext, GridView paramGridView, ProviderView.ProviderViewListener paramProviderViewListener, TemplateGroupItem paramTemplateGroupItem, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataTemplateGroupItem.jdField_a_of_type_Int == CapturePtvTemplateManager.jdField_b_of_type_Int) {
      this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataCapturePtvTemplateManager.a(this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$IPtvTemplateDownloadListener);
    }
  }
  ...
  public void a(Object paramObject, int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 111)
    {
      ...
      {
        a(((TemplateGroupItem)paramVarArgs[0]).jdField_a_of_type_JavaUtilList, 1);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      paramView.a(paramInt, (PtvTemplateManager.PtvTemplateInfo)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt), this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureAdapterPtvTemplateAdapter$IPtvTemplateItemCallback);
