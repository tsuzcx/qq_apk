...
public class PtvTemplateAdapter$2$2
  implements Runnable
{
  public PtvTemplateAdapter$2$2(ause paramause, PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo, int paramInt) {}
  ...
  public void run()
  {
    ...
    if (i <= k)
    {
      ...
      do
      {
        i += 1;
        break;
        localObject = (PtvTemplateManager.PtvTemplateInfo)this.jdField_a_of_type_Ause.a.jdField_a_of_type_JavaUtilArrayList.get(i);
      ...
      localObject = this.jdField_a_of_type_Ause.a.jdField_a_of_type_ComTencentWidgetGridView.getChildAt(i - j);
