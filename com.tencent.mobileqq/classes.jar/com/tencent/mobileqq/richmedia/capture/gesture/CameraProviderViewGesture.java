  ...
  implements GLGestureListener
{
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureGestureCameraProviderViewGesture$Listener = paramListener;
  }
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent, boolean paramBoolean)
  {
    ...
    {
      if (this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureGestureCameraProviderViewGesture$Listener != null) {
        this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureGestureCameraProviderViewGesture$Listener.a();
      }
      if (this.jdField_a_of_type_JavaUtilList == null) {
        break;
      }
