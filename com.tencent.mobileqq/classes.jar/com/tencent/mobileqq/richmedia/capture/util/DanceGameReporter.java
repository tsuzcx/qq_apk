...
public class DanceGameReporter
{
  ...
  public void a(BoyDataReport paramBoyDataReport)
  {
    ...
    while (paramBoyDataReport.hasNext())
    {
      ...
      {
        localObject2 = (agwq)localHashMap.get(((BoyDataReport.BoyItem)localObject1).a);
        ((agwq)localObject2).b();
      ...
      else
      {
        ...
        for (int i = 1;; i = 0)
        {
          localObject2 = new agwq(this, (String)localObject2, 1, i);
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      paramBoyDataReport.put(localObject2, String.valueOf(((agwq)localHashMap.get(localObject2)).a()));
    }
