...
class CaptureVideoFilterViewPager$VideoFilterPagerAdapter
  extends PagerAdapter
{
  ...
  public CaptureVideoFilterViewPager$VideoFilterPagerAdapter(CaptureVideoFilterViewPager paramCaptureVideoFilterViewPager)
  {
  ...
  public Object instantiateItem(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    for (localObject1 = (View)((Queue)localObject1).poll();; localObject1 = null)
    {
      ...
      if (localObject1 == null)
      {
        localObject2 = ((LayoutInflater)this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCaptureVideoFilterViewPager.getContext().getSystemService("layout_inflater")).inflate(2131558832, null);
        ((View)localObject2).setVisibility(8);
      }
      ((View)localObject2).setContentDescription(localFilterCategoryItem.b + "," + localFilterCategoryItem.f + HardCodeUtil.a(2131701518));
 ...
 * Qualified Name:     com.tencent.mobileqq.richmedia.capture.view.CaptureVideoFilterViewPager.VideoFilterPagerAdapter
