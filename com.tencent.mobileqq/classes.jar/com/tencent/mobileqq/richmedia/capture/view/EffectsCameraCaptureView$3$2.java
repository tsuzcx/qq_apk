...
class EffectsCameraCaptureView$3$2
  implements Runnable
{
  EffectsCameraCaptureView$3$2(EffectsCameraCaptureView.3 param3, VideoMaterial paramVideoMaterial, QQFilterRenderManager paramQQFilterRenderManager, boolean paramBoolean1, boolean paramBoolean2, int paramInt) {}
  ...
  public void run()
  {
    ...
    for (Object localObject1 = localObject2;; localObject1 = null)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentTtpicOpenapiModelVideoMaterial != null) && (this.jdField_a_of_type_ComTencentTtpicOpenapiModelVideoMaterial.getChildrenPendants() != null) && (!this.jdField_a_of_type_ComTencentTtpicOpenapiModelVideoMaterial.getChildrenPendants().isEmpty()))
      {
        ...
        if ((!this.jdField_a_of_type_Boolean) || (ahhj.jdField_a_of_type_Int == 2)) {
          break label692;
        }
        i = 1;
        label563:
      ...
      for (;;)
      {
        ...
        if ((i != 0) && (!this.b))
        {
          EffectsCameraCaptureView.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewEffectsCameraCaptureView$3.this$0, ajjy.a(2131638192));
        ...
        {
          EffectsCameraCaptureView.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewEffectsCameraCaptureView$3.this$0, ahon.a());
 ...
 * Qualified Name:     com.tencent.mobileqq.richmedia.capture.view.EffectsCameraCaptureView.3.2
