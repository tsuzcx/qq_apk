  ...
  extends BaseAdapter
{
  ...
  private ShareActionSheet.ActionSheetItemAdapter.IconFactory jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewShareActionSheet$ActionSheetItemAdapter$IconFactory;
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewShareActionSheet$ActionSheetItemAdapter$IconFactory == null) {
      this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewShareActionSheet$ActionSheetItemAdapter$IconFactory = new ShareActionSheet.ActionSheetItemAdapter.IconFactory(paramViewGroup.getContext());
    }
    View localView;
    if (paramView == null)
    {
    ...
    if (paramView.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.enable)
    {
      ...
      localObject = this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewShareActionSheet$ActionSheetItemAdapter$IconFactory.a((Drawable)localObject, i, j);
      if (!paramView.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.enable) {
        break label459;
      }
      Drawable localDrawable = ShareActionSheet.ActionSheetItemAdapter.IconFactory.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewShareActionSheet$ActionSheetItemAdapter$IconFactory, (Drawable)localObject);
      localObject = this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewShareActionSheet$ActionSheetItemAdapter$IconFactory.a((Drawable)localObject, localDrawable);
    ...
    for (;;)
    {
      ...
      break label328;
      label459:
      localObject = ShareActionSheet.ActionSheetItemAdapter.IconFactory.b(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewShareActionSheet$ActionSheetItemAdapter$IconFactory, (Drawable)localObject);
      paramView.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject);
      break label408;
      label482:
 ...
 * Qualified Name:     com.tencent.mobileqq.richmedia.capture.view.ShareActionSheet.ActionSheetItemAdapter
