...
public class ShareActionSheet
{
  ...
  public ShareActionSheet(Context paramContext)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewShareActionSheet$AdViewManager = new ShareActionSheet.AdViewManager();
  ...
  protected View a()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewShareActionSheet$AdViewManager.a((RelativeLayout)localView.findViewById(2131363814));
    ...
    for (int j = 0;; j = 1)
    {
      ...
      for (int k = 0;; k = 1)
      {
        ...
        for (;;)
        {
          ...
          ((GridView)localObject4).setAdapter(new ahmw(this.jdField_a_of_type_AndroidContentContext, (List)localObject1));
          ...
          for (;;)
          {
            ...
            ((GridView)localObject1).setNumColumns(i);
            ((GridView)localObject1).setAdapter(new ahmw(this.jdField_a_of_type_AndroidContentContext, (List)localObject2));
            ...
            ((TextView)localObject1).setOnClickListener(new ahmu(this));
            if (j == 0) {
