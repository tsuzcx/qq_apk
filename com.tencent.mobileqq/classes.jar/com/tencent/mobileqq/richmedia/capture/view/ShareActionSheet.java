...
public class ShareActionSheet
{
  ...
  protected View a()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewShareActionSheet$AdViewManager.a((RelativeLayout)localView.findViewById(2131363791));
    ...
    for (int j = 0;; j = 1)
    {
      ...
      for (int k = 0;; k = 1)
      {
        ...
        for (;;)
        {
          ...
          ((GridView)localObject4).setAdapter(new agyu(this.jdField_a_of_type_AndroidContentContext, (List)localObject1));
          ...
          for (;;)
          {
            ...
            ((GridView)localObject1).setNumColumns(i);
            ((GridView)localObject1).setAdapter(new agyu(this.jdField_a_of_type_AndroidContentContext, (List)localObject2));
            ...
            ((TextView)localObject1).setOnClickListener(new agys(this));
            if (j == 0) {
