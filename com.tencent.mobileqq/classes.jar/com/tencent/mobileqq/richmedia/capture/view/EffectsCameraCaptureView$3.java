  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      return;
      localObject1 = bbia.a(EffectsCameraCaptureView.a(this.this$0));
      if (this.this$0.a((bbia)localObject1))
      {
        EffectsCameraCaptureView.a(this.this$0).a();
        return;
      }
      EffectsCameraCaptureView.a(this.this$0, (bbia)localObject1);
      if ((this.a == null) || (this.a.equalsIgnoreCase("")) || (localObject1 == null)) {
        break;
      }
      EffectsCameraCaptureView.a(this.this$0).jdField_b_of_type_Boolean = ((bbia)localObject1).jdField_b_of_type_Boolean;
      EffectsCameraCaptureView.a(this.this$0).jdField_a_of_type_Boolean = ((bbia)localObject1).c;
      EffectsCameraCaptureView.a(this.this$0).jdField_a_of_type_Int = ((bbia)localObject1).jdField_b_of_type_Int;
      com.tencent.mobileqq.shortvideo.ptvfilter.gesture.GestureFilterManager.sGestureType = ((bbia)localObject1).f;
      com.tencent.mobileqq.shortvideo.ptvfilter.gesture.GestureFilterManager.sGestureTips = ((bbia)localObject1).g;
    ...
    } while ((brhe.a((VideoMaterial)localObject1, this.this$0.jdField_a_of_type_Brig, this.this$0.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureAudioAudioCapture, (Activity)this.this$0.getContext(), this.a)) || (((VideoMaterial)localObject1).getGameParams() != null));
    ...
    for (;;)
    {
      ...
      if (VideoMaterialUtil.isWatermarkMaterial((VideoMaterial)localObject1))
      {
        ...
        new bbgn((Activity)this.this$0.getContext(), new bbib(this)).a();
      }
      if ((this.this$0.jdField_a_of_type_Bbeu != null) && (localObject1 != null)) {
        this.this$0.jdField_a_of_type_Bbeu.a(VideoMaterialUtil.needVoiceChange((VideoMaterial)localObject1), ((VideoMaterial)localObject1).getVoicekind(), ((VideoMaterial)localObject1).getEnvironment());
      }
