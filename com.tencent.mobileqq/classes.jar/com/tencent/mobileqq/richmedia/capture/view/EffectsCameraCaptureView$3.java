  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      return;
      localObject1 = avuw.a(EffectsCameraCaptureView.a(this.this$0));
      if (this.this$0.a((avuw)localObject1))
      {
        EffectsCameraCaptureView.a(this.this$0).a();
        return;
      }
      EffectsCameraCaptureView.a(this.this$0, (avuw)localObject1);
      if ((this.a == null) || (this.a.equalsIgnoreCase("")) || (localObject1 == null)) {
        break;
      }
      EffectsCameraCaptureView.a(this.this$0).jdField_b_of_type_Boolean = ((avuw)localObject1).jdField_b_of_type_Boolean;
      EffectsCameraCaptureView.a(this.this$0).jdField_a_of_type_Boolean = ((avuw)localObject1).c;
      EffectsCameraCaptureView.a(this.this$0).jdField_a_of_type_Int = ((avuw)localObject1).jdField_b_of_type_Int;
      com.tencent.mobileqq.shortvideo.ptvfilter.gesture.GestureFilterManager.sGestureType = ((avuw)localObject1).f;
      com.tencent.mobileqq.shortvideo.ptvfilter.gesture.GestureFilterManager.sGestureTips = ((avuw)localObject1).g;
    ...
    } while ((bkyn.a((VideoMaterial)localObject1, this.this$0.jdField_a_of_type_Bkzt, this.this$0.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureAudioAudioCapture, (Activity)this.this$0.getContext(), this.a)) || (((VideoMaterial)localObject1).getGameParams() != null));
    ...
    for (;;)
    {
      ...
      if (VideoMaterialUtil.isWatermarkMaterial((VideoMaterial)localObject1))
      {
        ...
        new avtj((Activity)this.this$0.getContext(), new avux(this)).a();
      }
      if ((this.this$0.jdField_a_of_type_Avrr != null) && (localObject1 != null)) {
        this.this$0.jdField_a_of_type_Avrr.a(VideoMaterialUtil.needVoiceChange((VideoMaterial)localObject1), ((VideoMaterial)localObject1).getVoicekind(), ((VideoMaterial)localObject1).getEnvironment());
      }
