  ...
  implements ReportEvent
{
  ...
  {
    ThreadManager.getSubThreadHandler().post(new ahsh(this, paramInt, paramBoolean));
  }
  ...
  public void a(AppInterface paramAppInterface, int paramInt1, int paramInt2, int paramInt3, String paramString, long paramLong)
  {
    if ((paramAppInterface != null) && ((paramInt1 == 2001) || (paramInt1 == 2002) || (paramInt1 == 2003))) {
      ThreadManager.getSubThreadHandler().post(new ahsf(this, paramAppInterface, paramInt1, paramInt3, paramString, paramInt2, paramLong));
    }
  }
  ...
  {
    if ((paramAppInterface != null) && ((paramInt1 == 2001) || (paramInt1 == 2002) || (paramInt1 == 2003))) {
      ThreadManager.getSubThreadHandler().post(new ahsg(this, paramAppInterface, paramInt1, paramInt2, paramString));
    }
  }
  
  public void a(AppInterface paramAppInterface, int paramInt1, int paramInt2, String paramString, ahsl paramahsl)
  {
    paramahsl.f = paramInt1;
    if (paramInt2 == 0) {
      paramahsl.b = 0;
    }
    for (;;)
    {
      ...
      {
        paramahsl.d = paramAppInterface.a();
        paramahsl.e = paramAppInterface.b();
      }
      paramahsl.g = Calendar.getInstance().get(11);
      paramahsl.h = NetworkUtil.a(BaseApplication.getContext());
      return;
      if (paramInt2 == 3000)
      {
        paramahsl.b = 3000;
      ...
      else
      {
        if (paramInt2 == 1)
        {
          ...
          for (;;)
          {
            ...
            paramahsl.c = paramString.wMemberNum;
            break;
            paramahsl.b = 1;
            continue;
            paramahsl.b = 3;
  ...
  public void a(QQAppInterface paramQQAppInterface, int paramInt1, int paramInt2, String paramString, int paramInt3)
  {
    if ((paramQQAppInterface != null) && ((paramInt1 == 2001) || (paramInt1 == 2002) || (paramInt1 == 2003))) {
      ThreadManager.getSubThreadHandler().post(new ahse(this, paramQQAppInterface, paramInt1, paramInt2, paramString, paramInt3));
    }
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt1, int paramInt2, String paramString2, boolean paramBoolean1, boolean paramBoolean2, int paramInt3, String paramString3, long paramLong, String paramString4)
  {
    if ((paramQQAppInterface != null) && (paramString1 != null) && ((paramInt1 == 2001) || (paramInt1 == 2002) || (paramInt1 == 2003))) {
      ThreadManager.getSubThreadHandler().post(new ahsd(this, paramString1, paramQQAppInterface, paramInt1, paramInt2, paramString2, paramLong, paramString4, paramBoolean1, paramInt3, paramString3, paramBoolean2));
    }
  }
  ...
  {
    ThreadManager.getSubThreadHandler().post(new ahsi(this, paramBoolean, paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt7, paramInt8, paramLong));
  }
}
