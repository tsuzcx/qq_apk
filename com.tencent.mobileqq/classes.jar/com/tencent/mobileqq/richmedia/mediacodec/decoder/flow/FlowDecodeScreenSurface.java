  ...
  implements SurfaceTexture.OnFrameAvailableListener, FlowDecodeSurface
{
  ...
  public void a(@NonNull DecodedFrame paramDecodedFrame, boolean paramBoolean)
  {
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      for (;;)
      {
        ...
        if (!paramBoolean) {
          ...
          catch (InterruptedException paramDecodedFrame)
          {
            throw new RuntimeException(paramDecodedFrame);
          }
        }
      }
    }
    ...
    paramDecodedFrame.jdField_a_of_type_ArrayOfFloat = ((float[])this.jdField_a_of_type_ArrayOfFloat.clone());
    this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecDecoderFlowFrameBuffer.a(paramDecodedFrame.a());
