...
class FlowDecodeScreenSurfaceBase$ComponentSizeChooser
  extends FlowDecodeScreenSurfaceBase.BaseConfigChooser
{
  protected int a;
  protected int b;
  ...
  public FlowDecodeScreenSurfaceBase$ComponentSizeChooser(FlowDecodeScreenSurfaceBase paramFlowDecodeScreenSurfaceBase, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6)
  {
 ...
 * Qualified Name:     com.tencent.mobileqq.richmedia.mediacodec.decoder.flow.FlowDecodeScreenSurfaceBase.ComponentSizeChooser
