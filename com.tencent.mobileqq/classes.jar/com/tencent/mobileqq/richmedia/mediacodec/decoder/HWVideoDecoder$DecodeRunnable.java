  ...
  implements Runnable
{
  ...
  private final avxk jdField_a_of_type_Avxk;
  @NonNull
  private final avxn jdField_a_of_type_Avxn;
  ...
  public final long b;
  private final avxk jdField_b_of_type_Avxk;
  ...
  public HWVideoDecoder$DecodeRunnable(@NonNull String paramString, Surface paramSurface, avxn paramavxn)
  {
    veg.b("HWVideoDecoder.DecodeRunnable", "create DecodeRunnable filePath: %s", paramString);
    this.jdField_a_of_type_AndroidViewSurface = paramSurface;
    if (paramavxn != null) {}
    for (;;)
    {
      this.jdField_a_of_type_Avxn = paramavxn;
      this.jdField_b_of_type_JavaLangString = paramString;
      this.jdField_b_of_type_Long = swf.a(paramString);
      this.jdField_a_of_type_Avxk = new avxk(paramString, 0, true, false, 0L, this.jdField_b_of_type_Long);
      this.jdField_b_of_type_Avxk = new avxk(paramString, 0, true, false, 0L, this.jdField_b_of_type_Long);
      return;
      paramavxn = new avxm();
    }
  }
  ...
  private long a(long paramLong)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Avxn.b(l2 / 1000L);
  ...
  private void a()
  {
    if (this.jdField_b_of_type_Avxk.jdField_a_of_type_Int == 3)
    {
      this.jdField_c_of_type_Long = (this.jdField_b_of_type_Avxk.jdField_b_of_type_Long * 1000L);
      return;
    }
  ...
  private boolean a()
  {
    ...
    //   88: aload_0
    //   89: getfield 106	com/tencent/mobileqq/richmedia/mediacodec/decoder/HWVideoDecoder$DecodeRunnable:jdField_b_of_type_Avxk	Lavxk;
    //   92: getfield 230	avxk:jdField_c_of_type_Boolean	Z
    //   95: ifeq +129 -> 224
    //   98: aload_0
    //   99: getfield 106	com/tencent/mobileqq/richmedia/mediacodec/decoder/HWVideoDecoder$DecodeRunnable:jdField_b_of_type_Avxk	Lavxk;
    //   102: getfield 231	avxk:jdField_b_of_type_Int	I
    //   105: istore_1
    //   106: aload_2
    //   107: ldc 233
    //   109: iload_1
    ...
    //   198: astore_3
    //   199: aload_0
    //   200: getfield 88	com/tencent/mobileqq/richmedia/mediacodec/decoder/HWVideoDecoder$DecodeRunnable:jdField_a_of_type_Avxn	Lavxn;
    //   203: iconst_1
    //   204: aload_3
    ...
    //   258: ifne +14 -> 272
    //   261: aload_0
    //   262: getfield 88	com/tencent/mobileqq/richmedia/mediacodec/decoder/HWVideoDecoder$DecodeRunnable:jdField_a_of_type_Avxn	Lavxn;
    //   265: iconst_1
    //   266: aload_3
  ...
  private boolean a(boolean paramBoolean)
  {
    ...
    default: 
      ...
      if ((this.jdField_b_of_type_Avxk.jdField_a_of_type_Boolean) || (!paramBoolean)) {
        break;
      }
    case -3: 
    case -2: 
    ...
    for (paramBoolean = true;; paramBoolean = false)
    {
      ...
      try
      {
        this.jdField_a_of_type_Avxn.a(this.jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo.presentationTimeUs * 1000L);
        return true;
      }
  ...
  private boolean a(boolean paramBoolean, long paramLong)
  {
    ...
    do
    {
      ...
      if ((l > this.jdField_b_of_type_Avxk.jdField_a_of_type_Long) && (l < this.jdField_b_of_type_Avxk.jdField_b_of_type_Long)) {
        break;
      }
      this.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicLong.compareAndSet(l, -1L);
    } while (!QLog.isColorLevel());
    QLog.d("HWVideoDecoder.DecodeRunnable", 2, "checkToRender, not in playrange, pos:" + l + ": [" + this.jdField_b_of_type_Avxk.jdField_a_of_type_Long + "-" + this.jdField_b_of_type_Avxk.jdField_b_of_type_Long + "]");
    return paramBoolean;
    if (l > paramLong)
    {
      if (QLog.isColorLevel()) {
  ...
  private boolean b()
  {
    ...
    catch (Throwable localThrowable)
    {
      ...
      catch (Exception localException)
      {
        ...
        this.jdField_a_of_type_Avxn.a(2, localException);
      ...
      if (!this.jdField_a_of_type_Boolean) {
        this.jdField_a_of_type_Avxn.a(2, localRuntimeException);
      }
  ...
  private boolean c()
  {
    ...
    if (i >= 0)
    {
      ...
      else
      {
        ...
        l2 = 1000L * this.jdField_b_of_type_Avxk.jdField_a_of_type_Long;
        long l4 = 1000L * this.jdField_b_of_type_Avxk.jdField_b_of_type_Long;
        if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        ...
        this.jdField_d_of_type_Long = a(this.jdField_b_of_type_Avxk.jdField_a_of_type_Int, this.jdField_d_of_type_Long, l3 - l1);
  ...
  {
    this.jdField_a_of_type_Avxk.jdField_a_of_type_Int = paramInt;
  }
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    {
      veg.e("HWVideoDecoder.DecodeRunnable", "setPlayRange ignore, startTimeMs=%d, videoDuration=%d", new Object[] { Long.valueOf(paramLong1), Long.valueOf(this.jdField_b_of_type_Long) });
      return;
    }
    ...
    for (;;)
    {
      ...
      if ((paramLong1 == this.jdField_a_of_type_Avxk.jdField_a_of_type_Long) && (l == this.jdField_a_of_type_Avxk.jdField_b_of_type_Long))
      {
        veg.d("HWVideoDecoder.DecodeRunnable", "segment not changed, setPlayRange ignore, startTimeMs=%d, endTimeMs=%d", new Object[] { Long.valueOf(paramLong1), Long.valueOf(l) });
        return;
      }
      this.jdField_a_of_type_Avxk.jdField_a_of_type_Long = paramLong1;
      this.jdField_a_of_type_Avxk.jdField_b_of_type_Long = l;
      if (this.jdField_a_of_type_Avxk.jdField_a_of_type_Int == 3)
      {
        a(l);
        return;
      }
  ...
  public void a(@NonNull avxk paramavxk)
  {
    if (!TextUtils.equals(this.jdField_b_of_type_JavaLangString, paramavxk.jdField_a_of_type_JavaLangString)) {
      veg.d("HWVideoDecoder.DecodeRunnable", "DecodeRunnable does not support changing the file");
    }
    a(paramavxk.jdField_a_of_type_Int);
    a(paramavxk.jdField_a_of_type_Long, paramavxk.jdField_b_of_type_Long);
    b(paramavxk.jdField_b_of_type_Boolean);
    a(paramavxk.jdField_a_of_type_Boolean);
    this.jdField_a_of_type_Avxk.jdField_b_of_type_Int = paramavxk.jdField_b_of_type_Int;
    this.jdField_a_of_type_Avxk.jdField_c_of_type_Boolean = paramavxk.jdField_c_of_type_Boolean;
  }
  
  public void a(boolean paramBoolean)
  {
    this.jdField_a_of_type_Avxk.jdField_a_of_type_Boolean = paramBoolean;
  }
  ...
  {
    this.jdField_a_of_type_Avxk.jdField_b_of_type_Boolean = paramBoolean;
  }
  ...
  public void run()
  {
    ...
    //   3: lstore_3
    //   4: aload_0
    //   5: getfield 106	com/tencent/mobileqq/richmedia/mediacodec/decoder/HWVideoDecoder$DecodeRunnable:jdField_b_of_type_Avxk	Lavxk;
    //   8: aload_0
    //   9: getfield 104	com/tencent/mobileqq/richmedia/mediacodec/decoder/HWVideoDecoder$DecodeRunnable:jdField_a_of_type_Avxk	Lavxk;
    //   12: invokevirtual 497	avxk:a	(Lavxk;)Z
    //   15: pop
    //   16: aload_0
    ...
    //   79: ifne +409 -> 488
    //   82: aload_0
    //   83: getfield 104	com/tencent/mobileqq/richmedia/mediacodec/decoder/HWVideoDecoder$DecodeRunnable:jdField_a_of_type_Avxk	Lavxk;
    //   86: getfield 179	avxk:jdField_a_of_type_Int	I
    //   89: aload_0
    //   90: getfield 106	com/tencent/mobileqq/richmedia/mediacodec/decoder/HWVideoDecoder$DecodeRunnable:jdField_b_of_type_Avxk	Lavxk;
    //   93: getfield 179	avxk:jdField_a_of_type_Int	I
    //   96: if_icmpeq +29 -> 125
    //   99: aload_0
    //   100: getfield 104	com/tencent/mobileqq/richmedia/mediacodec/decoder/HWVideoDecoder$DecodeRunnable:jdField_a_of_type_Avxk	Lavxk;
    //   103: getfield 179	avxk:jdField_a_of_type_Int	I
    //   106: iconst_3
    //   107: if_icmpne +18 -> 125
    //   110: aload_0
    //   111: aload_0
    //   112: getfield 106	com/tencent/mobileqq/richmedia/mediacodec/decoder/HWVideoDecoder$DecodeRunnable:jdField_b_of_type_Avxk	Lavxk;
    //   115: getfield 180	avxk:jdField_b_of_type_Long	J
    //   118: ldc2_w 136
    //   121: lmul
    ...
    //   125: aload_0
    //   126: getfield 106	com/tencent/mobileqq/richmedia/mediacodec/decoder/HWVideoDecoder$DecodeRunnable:jdField_b_of_type_Avxk	Lavxk;
    //   129: aload_0
    //   130: getfield 104	com/tencent/mobileqq/richmedia/mediacodec/decoder/HWVideoDecoder$DecodeRunnable:jdField_a_of_type_Avxk	Lavxk;
    //   133: invokevirtual 497	avxk:a	(Lavxk;)Z
    //   136: pop
    //   137: aload_0
    //   138: getfield 106	com/tencent/mobileqq/richmedia/mediacodec/decoder/HWVideoDecoder$DecodeRunnable:jdField_b_of_type_Avxk	Lavxk;
    //   141: getfield 354	avxk:jdField_a_of_type_Long	J
    //   144: ldc2_w 136
    //   147: lmul
    //   148: lstore_3
    //   149: ldc2_w 136
    //   152: aload_0
    //   153: getfield 106	com/tencent/mobileqq/richmedia/mediacodec/decoder/HWVideoDecoder$DecodeRunnable:jdField_b_of_type_Avxk	Lavxk;
    //   156: getfield 180	avxk:jdField_b_of_type_Long	J
    //   159: lmul
    //   160: lstore 5
    //   162: iconst_0
    //   163: istore_2
    ...
    //   300: aload_0
    //   301: getfield 106	com/tencent/mobileqq/richmedia/mediacodec/decoder/HWVideoDecoder$DecodeRunnable:jdField_b_of_type_Avxk	Lavxk;
    //   304: getfield 489	avxk:jdField_b_of_type_Boolean	Z
    //   307: ifeq +181 -> 488
    //   310: aload_0
    //   311: getfield 106	com/tencent/mobileqq/richmedia/mediacodec/decoder/HWVideoDecoder$DecodeRunnable:jdField_b_of_type_Avxk	Lavxk;
    //   314: getfield 179	avxk:jdField_a_of_type_Int	I
    //   317: iconst_3
    ...
    //   329: pop2
    //   330: aload_0
    //   331: getfield 88	com/tencent/mobileqq/richmedia/mediacodec/decoder/HWVideoDecoder$DecodeRunnable:jdField_a_of_type_Avxn	Lavxn;
    ...
    //   448: ifne +15 -> 463
    //   451: aload_0
    //   452: getfield 88	com/tencent/mobileqq/richmedia/mediacodec/decoder/HWVideoDecoder$DecodeRunnable:jdField_a_of_type_Avxn	Lavxn;
    //   455: iconst_3
    //   456: aload 10
    ...
    //   513: ifeq +48 -> 561
    //   516: aload_0
    //   517: getfield 88	com/tencent/mobileqq/richmedia/mediacodec/decoder/HWVideoDecoder$DecodeRunnable:jdField_a_of_type_Avxn	Lavxn;
    ...
    //   558: goto -49 -> 509
    //   561: aload_0
    //   562: getfield 88	com/tencent/mobileqq/richmedia/mediacodec/decoder/HWVideoDecoder$DecodeRunnable:jdField_a_of_type_Avxn	Lavxn;
