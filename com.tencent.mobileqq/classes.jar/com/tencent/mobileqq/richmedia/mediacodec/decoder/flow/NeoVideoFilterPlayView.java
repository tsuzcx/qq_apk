  ...
  extends VideoFilterPlayView
{
  ...
  private DecodedFrame jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecDecoderFlowDecodedFrame;
  ...
  private NeoVideoFilterPlayView.VideoTimeStamp jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecDecoderFlowNeoVideoFilterPlayView$VideoTimeStamp;
  ...
  public NeoVideoFilterPlayView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    paramContext.start();
    this.jdField_a_of_type_AndroidOsHandler = new Handler(paramContext.getLooper(), new NeoVideoFilterPlayView.1(this));
    this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecDecoderFlowVideoFlowDecodeWrapper$FlowListener = new NeoVideoFilterPlayView.2(this);
    this.k = 0;
    this.l = 0;
  ...
  private void a(GL10 paramGL10)
  {
    ...
    DecodedFrame localDecodedFrame = ((VideoFlowDecodeWrapper)localObject).c();
    int n;
    int i;
    int i1;
    int m;
    if (paramGL10 != null)
    {
      ...
      n = 0;
      if ((this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecDecoderFlowNeoVideoFilterPlayView$VideoTimeStamp == null) || (paramGL10.b() != NeoVideoFilterPlayView.VideoTimeStamp.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecDecoderFlowNeoVideoFilterPlayView$VideoTimeStamp)))
      {
        n = 1;
    ...
    {
      label201:
      if ((this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.compareAndSet(true, false)) || (this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecDecoderFlowNeoVideoFilterPlayView$VideoTimeStamp == null) || (n != 0) || (i1 != 0))
      {
        this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecDecoderFlowNeoVideoFilterPlayView$VideoTimeStamp = new NeoVideoFilterPlayView.VideoTimeStamp(SystemClock.uptimeMillis(), paramGL10.a(), paramGL10.b(), null);
        SLog.c("FlowEdit_NeoVideoFilterPlayView", "start render : " + this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecDecoderFlowNeoVideoFilterPlayView$VideoTimeStamp);
      }
      long l2 = SystemClock.uptimeMillis();
      long l3 = NeoVideoFilterPlayView.VideoTimeStamp.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecDecoderFlowNeoVideoFilterPlayView$VideoTimeStamp) + (paramGL10.a() - NeoVideoFilterPlayView.VideoTimeStamp.b(this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecDecoderFlowNeoVideoFilterPlayView$VideoTimeStamp)) * m / (i * 1000);
      long l1;
      if ((localDecodedFrame != null) && (localDecodedFrame.b() == paramGL10.b()))
      {
        l1 = NeoVideoFilterPlayView.VideoTimeStamp.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecDecoderFlowNeoVideoFilterPlayView$VideoTimeStamp) + (localDecodedFrame.a() - NeoVideoFilterPlayView.VideoTimeStamp.b(this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecDecoderFlowNeoVideoFilterPlayView$VideoTimeStamp)) * m / (i * 1000);
        label367:
        if (l2 >= l3 - 5L) {
          break label548;
        }
        paramGL10 = this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecDecoderFlowDecodedFrame;
        l1 = l3 - l2;
        label391:
        if (paramGL10 != null)
        {
          ...
          if ((this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecDecoderFlowDecodedFrame != null) && (this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecDecoderFlowDecodedFrame != paramGL10)) {
            this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecDecoderFlowDecodedFrame.b();
          }
          this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecDecoderFlowDecodedFrame = paramGL10;
      ...
      for (l1 -= 5L;; l1 = 0L)
      {
        ...
        if (l2 < l1)
        {
          ...
          SLog.a("FlowEdit_NeoVideoFilterPlayView", "drawFrameFlow : drop %d frames, decoder is slow", Integer.valueOf(this.l));
          this.l = 0;
          l1 = l2;
          paramGL10 = (GL10)localObject;
          break label391;
  ...
  public void b()
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if (localEGLContext != null)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecDecoderFlowNeoVideoFilterPlayView$VideoTimeStamp = null;
