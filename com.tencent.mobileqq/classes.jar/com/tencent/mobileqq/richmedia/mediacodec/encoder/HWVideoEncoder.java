...
public class HWVideoEncoder
{
  ...
  private MuxerDataListener jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecEncoderMuxerDataListener;
  ...
  private void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if ((paramBoolean) && (this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecEncoderMuxerDataListener != null)) {
          this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecEncoderMuxerDataListener.a();
        }
        return;
        if (QLog.isColorLevel()) {
  ...
  {
    if (QLog.isColorLevel()) {
      if (this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecRecorderMediaMuxerWrapper != null) {
        break label61;
      }
    }
    label61:
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecEncoderMuxerDataListener != null) {
      this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecEncoderMuxerDataListener.a(this.jdField_a_of_type_AndroidMediaMediaFormat);
    }
    return;
    label114:
    this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecRecorderMediaMuxerWrapper.a(0, paramMediaFormat);
  }
  ...
  public void a(EncodeConfig paramEncodeConfig)
  {
    ...
    if (paramEncodeConfig.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecRecorderMediaMuxerWrapper == null)
    {
    ...
    for (;;)
    {
      if (paramEncodeConfig.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecEncoderMuxerDataListener != null) {
        this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecEncoderMuxerDataListener = paramEncodeConfig.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecEncoderMuxerDataListener;
      }
      this.jdField_a_of_type_Int = -1;
      this.jdField_a_of_type_Boolean = false;
      return;
      this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecRecorderMediaMuxerWrapper = paramEncodeConfig.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecRecorderMediaMuxerWrapper;
      this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecRecorderMediaMuxerWrapper.jdField_a_of_type_AndroidMediaMediaMuxer.setOrientationHint(paramEncodeConfig.g);
    }
  }
  ...
  public void a(ByteBuffer paramByteBuffer, MediaCodec.BufferInfo paramBufferInfo)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecRecorderMediaMuxerWrapper == null)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecEncoderMuxerDataListener != null)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecEncoderMuxerDataListener.a(paramBufferInfo);
    ...
    this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecRecorderMediaMuxerWrapper.a(0, paramByteBuffer, paramBufferInfo);
  }
    ...
    catch (Exception localException1)
    {
      try
      {
        for (;;)
        {
          ...
          if ((this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecRecorderMediaMuxerWrapper != null) || (this.jdField_a_of_type_AndroidMediaMediaMuxer == null)) {
            break label237;
          }
          try
          {
      ...
      catch (Exception localException2)
      {
        ...
        } while (this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecRecorderMediaMuxerWrapper == null);
