...
public class HWAudioEncoder
{
  ...
  HWAudioEncoder.AudioEncodeListener jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecRecorderHWAudioEncoder$AudioEncodeListener;
  ...
  private void b(String paramString)
  {
    ...
    if (CodecParam.mAudioChannel == 16)
    {
      ...
      if (!paramString.exists()) {
        FileUtils.c(paramString.getAbsolutePath());
      }
  ...
  void a()
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecRecorderHWAudioEncoder$AudioEncodeListener != null) {
        this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecRecorderHWAudioEncoder$AudioEncodeListener.h();
      }
      return;
    }
    catch (Exception localException)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecRecorderHWAudioEncoder$AudioEncodeListener != null) {
        this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecRecorderHWAudioEncoder$AudioEncodeListener.i();
      }
      return;
    }
    finally
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecRecorderHWAudioEncoder$AudioEncodeListener = paramAudioEncodeListener;
  }
 ...
 * Qualified Name:     com.tencent.mobileqq.richmedia.mediacodec.recorder.HWAudioEncoder
