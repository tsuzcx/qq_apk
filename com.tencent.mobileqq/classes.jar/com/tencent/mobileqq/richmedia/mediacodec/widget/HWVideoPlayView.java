...
public class HWVideoPlayView
  ...
  implements SurfaceTexture.OnFrameAvailableListener, GLSurfaceView.Renderer, bary
{
  protected int a;
  public long a;
  protected SurfaceTexture a;
  private GLSurfaceView.EGLContextFactory jdField_a_of_type_AndroidOpenglGLSurfaceView$EGLContextFactory = new bauv(this);
  protected final barr a;
  protected final barv a;
  private bary jdField_a_of_type_Bary;
  protected barz a;
  ...
  public HWVideoPlayView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_Barv = new barv();
    ...
    this.jdField_a_of_type_Barr = new barr();
    a();
  }
  
  public int a()
  {
    return this.jdField_a_of_type_Barv.jdField_a_of_type_Int;
  }
  ...
  public String a()
  {
    return this.jdField_a_of_type_Barv.jdField_a_of_type_JavaLangString;
  }
  ...
  {
    if (this.jdField_a_of_type_Bary != null) {
      this.jdField_a_of_type_Bary.a(paramLong);
    }
  }
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_Barz.a();
    this.jdField_a_of_type_Barz.a(this.jdField_a_of_type_Barv, this.jdField_a_of_type_Int, this, this);
  ...
  public void onDrawFrame(GL10 paramGL10)
  {
    int i = this.g;
    this.g = (i + 1);
    yqp.a("HWVideoPlayView", "onDrawFrame index = %d", Integer.valueOf(i));
    try
    {
      if (this.jdField_a_of_type_AndroidGraphicsSurfaceTexture != null)
      {
  ...
  public void onFrameAvailable(SurfaceTexture paramSurfaceTexture)
  {
    int i = this.f;
    this.f = (i + 1);
    yqp.a("HWVideoPlayView", "yarkey onFrameAvailable %d", Integer.valueOf(i));
  ...
  public void onSurfaceCreated(GL10 paramGL10, EGLConfig paramEGLConfig)
  {
    ...
    this.jdField_a_of_type_ComTencentTtpicOpenapiFilterGPUOESBaseFilter = ((GPUOESBaseFilter)bauf.a(102));
  ...
  public void setDecodeListener(bary parambary)
  {
  ...
  {
    this.jdField_a_of_type_Barv.jdField_a_of_type_JavaLangString = paramString1;
    this.jdField_a_of_type_Barr.jdField_a_of_type_JavaLangString = paramString2;
    this.jdField_a_of_type_Barr.jdField_a_of_type_Bckv = AudioEncoder.a(paramString2, null, 0);
    if (QLog.isColorLevel()) {
      QLog.d("HWVideoPlayView", 2, "setFilePath: videoFilePath = " + this.jdField_a_of_type_Barv.jdField_a_of_type_JavaLangString + " ; audioFilePath = " + paramString2);
    }
    this.jdField_a_of_type_Long = wip.a(this.jdField_a_of_type_Barv.jdField_a_of_type_JavaLangString);
    this.jdField_a_of_type_Barr.c = this.jdField_a_of_type_Long;
    paramString2 = new bqiu();
    int i = bqit.a(paramString1, paramString2);
  ...
  {
    this.jdField_a_of_type_Barr.jdField_b_of_type_Boolean = paramBoolean;
  ...
  {
    this.jdField_a_of_type_Barv.jdField_a_of_type_Long = paramInt1;
    this.jdField_a_of_type_Barv.jdField_b_of_type_Long = paramInt2;
    this.jdField_a_of_type_Barz.a(paramInt1, paramInt2);
  ...
  public void setRepeat(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Barr.jdField_a_of_type_Boolean = paramBoolean;
  }
  
  public void setRotate(int paramInt)
  {
    this.jdField_a_of_type_Barv.jdField_c_of_type_Boolean = true;
    this.jdField_a_of_type_Barv.jdField_b_of_type_Int = paramInt;
  }
  
  public void setSpeedType(int paramInt)
  {
    this.jdField_a_of_type_Barv.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_Barr.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_Barz.a(paramInt);
    this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecAudioDecoder.a(paramInt);
  }
  
  public void setVideoDecodeConfig(barv parambarv)
  {
    this.jdField_a_of_type_Barv.a(parambarv);
  }
}
