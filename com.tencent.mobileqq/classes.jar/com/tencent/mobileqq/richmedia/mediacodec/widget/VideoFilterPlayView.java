  ...
  extends HWVideoPlayView
{
  ...
  private void o()
  {
    ...
    GPUBaseFilter localGPUBaseFilter = axwe.a(101);
  ...
  {
    this.jdField_a_of_type_Axwn.a();
    int j = paramInt;
    if (this.jdField_a_of_type_Axwn.a())
    {
      this.jdField_b_of_type_ComTencentTtpicOpenapiFilterRenderBuffer.bind();
      this.jdField_a_of_type_Axwn.drawTexture(paramInt, null, null);
  ...
  public void onSurfaceChanged(GL10 paramGL10, int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_Axwn.onOutputSizeChanged(paramInt1, paramInt2);
  ...
  {
    if ((!this.jdField_a_of_type_Axwn.a()) && (paramInt == 0)) {
      return;
    }
    this.jdField_a_of_type_Axwn.a(paramInt, this.jdField_b_of_type_Int, this.jdField_c_of_type_Int);
  }
  
  public void setColorFilterType(int paramInt1, int paramInt2, float paramFloat, int paramInt3)
  {
    this.jdField_a_of_type_Axwn.a(paramInt1, paramInt2, paramFloat, paramInt3, this.jdField_b_of_type_Int, this.jdField_c_of_type_Int);
  }
  ...
  public void setMosaicFilterType(Bitmap paramBitmap)
  {
    ...
    {
      this.jdField_c_of_type_ComTencentTtpicOpenapiFilterGPUBaseFilter = axwe.a(106);
      a(new VideoFilterPlayView.2(this));
    }
    ((axwj)this.jdField_c_of_type_ComTencentTtpicOpenapiFilterGPUBaseFilter).a(paramBitmap, this.jdField_a_of_type_Axtu.jdField_b_of_type_Int);
