  ...
  implements SurfaceTexture.OnFrameAvailableListener, HWDecodeListener, AEDecoder
{
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecDecoderDecodeConfig = new DecodeConfig(paramString, 0, false, false);
  }
  ...
  public void setTexture(int paramInt)
  {
    a();
    this.j = paramInt;
    this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecDecoderHWVideoDecoder.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecDecoderDecodeConfig, this.k, this, this);
    this.g = 2;
  }
}
