  ...
  extends GPUBaseFilter
{
  ...
  public void destroy()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecRendererGPUDrawPartFilter != null) {
      this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecRendererGPUDrawPartFilter.destroy();
    }
    if (this.b != null) {
      this.b.destroy();
    }
  ...
  public void drawTexture(int paramInt, float[] paramArrayOfFloat1, float[] paramArrayOfFloat2)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecRendererGPUDrawPartFilter != null) {
      this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecRendererGPUDrawPartFilter.drawTexture(paramInt, paramArrayOfFloat1, paramArrayOfFloat2);
    }
  ...
  public void init()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecRendererGPUDrawPartFilter != null) && (!this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecRendererGPUDrawPartFilter.isInitialized())) {
      this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecRendererGPUDrawPartFilter.init();
    }
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecRendererGPUDrawPartFilter != null) {
      this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecRendererGPUDrawPartFilter.onOutputSizeChanged(paramInt1, paramInt2);
    }
    if (this.b != null) {
