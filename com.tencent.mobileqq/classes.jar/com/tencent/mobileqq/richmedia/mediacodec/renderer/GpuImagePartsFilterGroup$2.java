  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        GpuImagePartsFilterGroup.a(this.this$0).a(true, 0.1F * 2.0F + this.jdField_a_of_type_Float);
        GpuImagePartsFilterGroup.b(this.this$0).a(false, this.jdField_a_of_type_Float);
