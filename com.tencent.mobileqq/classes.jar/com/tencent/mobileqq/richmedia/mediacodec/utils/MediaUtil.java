...
public class MediaUtil
{
  ...
  public static long a(String paramString)
  {
    ...
    {
      long l2;
      SLog.c(a, "getVideoDuration path=" + paramString + " exists=" + FileUtils.e(paramString), localRuntimeException);
    ...
    {
      label32:
      SLog.c(a, "getVideoDuration path=" + paramString + " exists=" + FileUtils.e(paramString), localError);
      localMediaMetadataRetriever.release();
      return 0L;
    }
    try
