...
public class GlUtil
{
  ...
  {
    int i = a(37305, paramString);
    if (i == 0) {
      return 0;
    }
    int j = GLES20.glCreateProgram();
    a("createComputeProgram");
    if (j == 0) {
  ...
  public static String a(android.content.Context paramContext, int paramInt)
  {
    ...
    //   7: astore 5
    //   9: aload_0
    //   10: invokevirtual 231	android/content/Context:getResources	()Landroid/content/res/Resources;
    //   13: iload_1
    //   14: invokevirtual 237	android/content/res/Resources:openRawResource	(I)Ljava/io/InputStream;
    //   17: astore 4
    //   19: new 239	java/io/InputStreamReader
    //   22: dup
    //   23: aload 4
    //   25: invokespecial 242	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   28: astore_3
    //   29: new 244	java/io/BufferedReader
    //   32: dup
    //   33: aload_3
    //   34: invokespecial 247	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   37: astore_2
    //   38: aload_2
    //   39: invokevirtual 250	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   42: astore_0
    //   43: aload_0
    //   44: ifnull +73 -> 117
    //   47: aload 5
    ...
    //   54: aload 5
    //   56: bipush 10
    //   58: invokevirtual 253	java/lang/StringBuilder:append	(C)Ljava/lang/StringBuilder;
    //   61: pop
    //   62: goto -24 -> 38
    //   65: astore_0
    //   66: aload_2
    ...
    //   75: ifnull +7 -> 82
    //   78: aload_3
    //   79: invokevirtual 257	java/io/InputStreamReader:close	()V
    //   82: aload 4
    //   84: ifnull +8 -> 92
    //   87: aload 4
    //   89: invokevirtual 260	java/io/InputStream:close	()V
    //   92: aconst_null
    //   93: areturn
    //   94: astore_0
    //   95: aload_0
    //   96: invokevirtual 263	java/io/IOException:printStackTrace	()V
    //   99: goto -25 -> 74
    //   102: astore_0
    //   103: aload_0
    //   104: invokevirtual 263	java/io/IOException:printStackTrace	()V
    //   107: goto -25 -> 82
    //   110: astore_0
    //   111: aload_0
    //   112: invokevirtual 263	java/io/IOException:printStackTrace	()V
    //   115: aconst_null
    //   116: areturn
    //   117: aload_2
    //   118: ifnull +7 -> 125
    //   121: aload_2
    //   122: invokevirtual 256	java/io/BufferedReader:close	()V
    //   125: aload_3
    //   126: ifnull +7 -> 133
    //   129: aload_3
    //   130: invokevirtual 257	java/io/InputStreamReader:close	()V
    //   133: aload 4
    //   135: ifnull +8 -> 143
    //   138: aload 4
    ...
    //   149: astore_0
    //   150: aload_0
    //   151: invokevirtual 263	java/io/IOException:printStackTrace	()V
    //   154: goto -29 -> 125
    //   157: astore_0
    //   158: aload_0
    //   159: invokevirtual 263	java/io/IOException:printStackTrace	()V
    //   162: goto -29 -> 133
    //   165: astore_0
    //   166: aload_0
    //   167: invokevirtual 263	java/io/IOException:printStackTrace	()V
    //   170: goto -27 -> 143
    //   173: astore_0
    //   174: aconst_null
    //   175: astore_3
    ...
    //   182: ifnull +7 -> 189
    //   185: aload_2
    //   186: invokevirtual 256	java/io/BufferedReader:close	()V
    //   189: aload_3
    //   190: ifnull +7 -> 197
    //   193: aload_3
    //   194: invokevirtual 257	java/io/InputStreamReader:close	()V
    //   197: aload 4
    //   199: ifnull +8 -> 207
    //   202: aload 4
    //   204: invokevirtual 260	java/io/InputStream:close	()V
    //   207: aload_0
    //   208: athrow
    //   209: astore_2
    //   210: aload_2
    //   211: invokevirtual 263	java/io/IOException:printStackTrace	()V
    //   214: goto -25 -> 189
    //   217: astore_2
    //   218: aload_2
    //   219: invokevirtual 263	java/io/IOException:printStackTrace	()V
    //   222: goto -25 -> 197
    //   225: astore_2
    //   226: aload_2
    //   227: invokevirtual 263	java/io/IOException:printStackTrace	()V
    //   230: goto -23 -> 207
    //   233: astore_0
    //   234: aconst_null
    //   235: astore_3
