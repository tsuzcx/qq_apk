...
public class OrderMediaMsgTimerController$4
  implements Runnable
{
  public OrderMediaMsgTimerController$4(axsz paramaxsz, long paramLong, int paramInt1, int paramInt2) {}
  
  public void run()
  {
    if (axsz.a(this.this$0) != null)
    {
      Message localMessage = axsz.a(this.this$0).obtainMessage(102);
