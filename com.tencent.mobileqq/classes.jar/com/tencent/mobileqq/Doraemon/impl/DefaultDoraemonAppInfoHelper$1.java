...
public class DefaultDoraemonAppInfoHelper$1
  implements Runnable
{
  public DefaultDoraemonAppInfoHelper$1(ackg paramackg) {}
  ...
  public void run()
  {
    ...
    try
    {
      ??? = "https://cgi.connect.qq.com/mqqapi/privilege_group_config?platform=1&platform_version=8.4.8&data_version=" + this.this$0.b;
    ...
    synchronized (this.this$0.jdField_a_of_type_JavaLangObject)
    {
      ...
      synchronized (this.this$0)
      {
        ...
        BaseApplicationImpl.getApplication().getSharedPreferences("DoraemonApiGroup.json", 4).edit().putString("content", (String)localObject7).putLong("version", l1).putString("app_version", "8.4.8").apply();
        return;
      }
    }
  }
