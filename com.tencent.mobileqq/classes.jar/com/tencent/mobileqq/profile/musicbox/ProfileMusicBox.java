  ...
  implements View.OnClickListener, ProfileMusicBoxController.PlayChange
{
  ...
  public static boolean a(ProfileCardInfo paramProfileCardInfo)
  {
    ...
    do
    {
      ...
      {
        int i;
        if (paramProfileCardInfo.jdField_a_of_type_ComTencentMobileqqDataCard.switchMusicBox == 0)
        {
          i = 1;
      ...
      bool1 = paramProfileCardInfo.jdField_a_of_type_ComTencentMobileqqDataCard.isVipOpen(EVIPSPEC.E_SP_SUPERVIP);
      bool2 = paramProfileCardInfo.jdField_a_of_type_ComTencentMobileqqDataCard.isVipOpen(EVIPSPEC.E_SP_BIGCLUB);
    } while ((paramProfileCardInfo.jdField_a_of_type_ComTencentMobileqqDataCard.switchMusicBox != 0) || (TextUtils.isEmpty(paramProfileCardInfo.jdField_a_of_type_ComTencentMobileqqDataCard.songId)) || ((!bool1) && (!bool2)));
    return true;
  }
  ...
  public View a(Context paramContext, String paramString)
  {
    ...
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(paramContext).inflate(2131562187, null);
    this.jdField_a_of_type_AndroidViewView.setOnClickListener(this);
    if (this.c)
    {
      this.jdField_a_of_type_AndroidViewView.findViewById(2131369072).setOnClickListener(this);
      this.jdField_a_of_type_AndroidViewView.findViewById(2131378442).setOnClickListener(this);
      this.jdField_a_of_type_ComTencentWidgetAlphaClickableImageView = ((AlphaClickableImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378442));
      this.jdField_a_of_type_AndroidViewView.findViewById(2131378298).setVisibility(8);
    }
    for (;;)
    {
      a(2);
      this.jdField_a_of_type_Int = AIOUtils.a(35.0F, paramContext.getResources());
      ...
      this.jdField_a_of_type_AndroidViewView.findViewById(2131378298).setOnClickListener(this);
      this.jdField_a_of_type_AndroidViewView.findViewById(2131369072).setVisibility(8);
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    TextView localTextView = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378298);
    localTextView.setCompoundDrawablePadding(ViewUtils.b(4.0F));
    if (paramInt == 1)
    {
      localTextView.setCompoundDrawablesWithIntrinsicBounds(2130850693, 0, 0, 0);
      return;
    }
    localTextView.setCompoundDrawablesWithIntrinsicBounds(2130850694, 0, 0, 0);
  }
  ...
  public void a(SongInfo paramSongInfo, boolean paramBoolean)
  {
    ...
    if (this.c)
    {
      ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378297)).setText(paramSongInfo.c);
      ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378296)).setText(paramSongInfo.h);
      a(paramSongInfo.e);
      return;
    }
    ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378298)).setText(paramSongInfo.c + "-" + paramSongInfo.h);
  ...
  {
    Object localObject = paramProfileCardInfo.jdField_a_of_type_ComTencentMobileqqDataCard;
    ...
    for (bool1 = true;; bool1 = false)
    {
      ...
      a(true);
      localObject = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379248);
      if (paramProfileCardInfo.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_Int != 0)
      {
        this.e = false;
        ((TextView)localObject).setText(ProfileCardMoreInfoView.a(paramProfileCardInfo) + ((TextView)localObject).getContext().getResources().getString(2131695153));
      }
      return;
    }
    a(false);
  ...
  public void a(String paramString)
  {
    ...
    localURLDrawableOptions.mLoadingDrawable = this.jdField_a_of_type_AndroidViewView.getContext().getResources().getDrawable(2130844920);
    localURLDrawableOptions.mFailedDrawable = this.jdField_a_of_type_AndroidViewView.getContext().getResources().getDrawable(2130844920);
    ...
    this.jdField_a_of_type_AndroidViewView.findViewById(2131378442).setBackgroundDrawable(paramString);
    if (this.jdField_a_of_type_Boolean) {}
    for (;;)
    {
      a(i);
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      this.jdField_a_of_type_AndroidViewView.findViewById(2131366344).setVisibility(0);
      this.jdField_a_of_type_AndroidViewView.findViewById(2131378442).setVisibility(8);
      this.jdField_a_of_type_AndroidViewView.findViewById(2131372019).setVisibility(8);
      return;
    }
    this.jdField_a_of_type_AndroidViewView.findViewById(2131366344).setVisibility(8);
    this.jdField_a_of_type_AndroidViewView.findViewById(2131378442).setVisibility(0);
    this.jdField_a_of_type_AndroidViewView.findViewById(2131372019).setVisibility(0);
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      case 2131378442: 
        ...
        if (ProfileMusicBoxController.a(Long.parseLong(this.jdField_a_of_type_JavaLangString)))
        {
