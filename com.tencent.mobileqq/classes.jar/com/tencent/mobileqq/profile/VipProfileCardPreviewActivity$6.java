  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    Bitmap localBitmap1 = this.this$0.a(bcyw.a(this.this$0.jdField_a_of_type_AndroidContentContext, (String)this.jdField_a_of_type_JavaUtilList.get(1)), true);
    Bitmap localBitmap2 = this.this$0.a(bcyw.a(this.this$0.jdField_a_of_type_AndroidContentContext, (String)this.jdField_a_of_type_JavaUtilList.get(0)), true);
    ...
    {
      localObject1 = new Pair(localObject1, Integer.valueOf(bdal.a(localBitmap1) + bdal.a(localBitmap2)));
