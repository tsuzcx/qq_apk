  ...
  implements View.OnClickListener
{
  ...
  public VipProfileCardPreviewActivity()
  {
    ...
    this.jdField_b_of_type_ComTencentMobileqqAppCardObserver = new agcd(this);
  }
  ...
  {
    ThreadManager.post(new agbx(this, paramInt, paramString), 5, null, true);
  }
  ...
  public void a(VipProfileCardPreviewActivity.StylePagerAdapter.ViewHolder paramViewHolder, ProfileCardTemplateInfo paramProfileCardTemplateInfo, int paramInt)
  {
    ...
    //   700: aload 8
    //   702: iload_3
    //   703: invokespecial 524	agbz:<init>	(Lcom/tencent/mobileqq/profile/VipProfileCardPreviewActivity;Ljava/lang/String;I)V
    //   706: bipush 8
    //   708: aconst_null
    //   709: iconst_1
    ...
    //   946: aload_2
    //   947: iload_3
    //   948: invokespecial 543	agca:<init>	(Lcom/tencent/mobileqq/profile/VipProfileCardPreviewActivity;Ljava/util/List;Ljava/lang/String;I)V
    //   951: bipush 8
    //   953: aconst_null
    //   954: iconst_1
  ...
  {
    ThreadManager.post(new agcb(this, paramString1, paramString2), 8, null, true);
  }
  ...
  protected boolean a(Message paramMessage)
  {
    ...
    {
      Toast.makeText(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 2131436739, 0).show();
      return true;
    }
    ...
    {
      Toast.makeText(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 2131436737, 0).show();
    ...
    if ((paramMessage.what == 24) || (paramMessage.what == 25))
    {
      ...
      Toast.makeText(getApplicationContext(), getResources().getString(2131436757), 1).show();
      return true;
    }
    return false;
  }
  ...
  public void b(int paramInt)
  {
    ...
    this.jdField_b_of_type_JavaLangRunnable = new agbw(this, (TransitionDrawable)localObject);
    this.jdField_a_of_type_AndroidOsHandler.postDelayed(this.jdField_b_of_type_JavaLangRunnable, 2000L);
  }
  
  void b(String paramString)
  {
    agcc localagcc = new agcc(this, Long.parseLong(this.app.getCurrentAccountUin()), paramString, VipUploadUtils.a(this.app), "qqprofile", paramString);
    localagcc.b = VipUploadUtils.a(this.app);
    localagcc.i = VipUploadUtils.a(this.app, paramString);
    m();
    paramString = (VipImageUploadManager)this.app.getManager(89);
    paramString.a(this.app, null);
    localagcc.a();
    paramString.a(this.app, localagcc, null);
  }
  ...
  public void d(int paramInt)
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetButton.setText(2131436750);
    ...
    {
      this.jdField_a_of_type_AndroidWidgetButton.setText(2131436749);
      this.jdField_c_of_type_JavaLangString = "2";
      return;
    }
    if (this.jdField_b_of_type_Int == 2)
    {
      this.jdField_a_of_type_AndroidWidgetButton.setText(2131436748);
      this.jdField_c_of_type_JavaLangString = "1";
      return;
    }
    this.jdField_a_of_type_AndroidWidgetButton.setText(2131436744);
    this.jdField_c_of_type_JavaLangString = "0";
  }
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_AndroidViewView = findViewById(2131371045);
    float f1;
    label420:
    ...
    if ((this.app != null) && (ThemeUtil.isInNightMode(this.app)))
    {
      ...
      this.jdField_a_of_type_ComTencentWidgetCirclePageIndicator = ((CirclePageIndicator)findViewById(2131372380));
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)findViewById(2131372399));
      this.jdField_a_of_type_ComTencentMobileqqProfileViewVipScaledViewPager = ((VipScaledViewPager)findViewById(2131362786));
      ...
      ThreadManager.post(new agbu(this), 8, null, true);
      i();
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
      if (this.app != null) {
        this.app.addObserver(this.jdField_a_of_type_ComTencentMobileqqAppCardObserver, true);
      }
      this.jdField_a_of_type_ComTencentWidgetCirclePageIndicator.setOnPageChangeListener(new agbv(this));
      if (this.app != null)
      {
  ...
  public void j()
  {
    ...
    if (this.jdField_b_of_type_Long == 0L)
    {
      ...
      ((ProfileCardTemplate)localObject1).jdField_a_of_type_JavaLangString = getString(2131436704);
  ...
  void m()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.c(2131436758);
    try
    {
