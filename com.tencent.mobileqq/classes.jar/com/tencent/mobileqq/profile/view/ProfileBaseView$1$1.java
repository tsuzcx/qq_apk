  ...
  implements Runnable
{
  ...
  public void run()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqDataExtensionInfo != null) && (this.jdField_a_of_type_ComTencentMobileqqDataExtensionInfo.isPendantValid()))
    {
      ...
      if (bbby.a(this.jdField_a_of_type_ComTencentMobileqqProfileViewProfileBaseView$1.this$0.jdField_a_of_type_Long)) {
        localAvatarPendantManager.a(this.jdField_a_of_type_ComTencentMobileqqProfileViewProfileBaseView$1.this$0.jdField_a_of_type_Long).a(ProfileBaseView.a(this.jdField_a_of_type_ComTencentMobileqqProfileViewProfileBaseView$1.this$0), 2, PendantInfo.c, this.jdField_a_of_type_ComTencentMobileqqProfileViewProfileBaseView$1.jdField_a_of_type_Auuw.a.a, this.jdField_a_of_type_ComTencentMobileqqDataExtensionInfo.pendantDiyId);
      }
      for (;;)
      {
        if (this.jdField_a_of_type_ComTencentMobileqqProfileViewProfileBaseView$1.jdField_a_of_type_Boolean) {
          axqw.b(this.jdField_a_of_type_ComTencentMobileqqProfileViewProfileBaseView$1.this$0.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "AvatarClick", "ppshow", 0, 0, "", "", "", "");
        }
        return;
        localAvatarPendantManager.a(this.jdField_a_of_type_ComTencentMobileqqProfileViewProfileBaseView$1.this$0.jdField_a_of_type_Long).a(ProfileBaseView.a(this.jdField_a_of_type_ComTencentMobileqqProfileViewProfileBaseView$1.this$0), 1, PendantInfo.c, this.jdField_a_of_type_ComTencentMobileqqProfileViewProfileBaseView$1.jdField_a_of_type_Auuw.a.a, this.jdField_a_of_type_ComTencentMobileqqDataExtensionInfo.pendantDiyId);
      }
    }
