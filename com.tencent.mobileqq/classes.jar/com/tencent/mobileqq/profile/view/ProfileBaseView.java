  ...
  extends ProfileHeaderView
{
  ...
  public ProfileBaseView(BaseActivity paramBaseActivity, auuy paramauuy, PullToZoomHeaderListView paramPullToZoomHeaderListView, TextView paramTextView, boolean paramBoolean)
  {
  ...
  private void d()
  {
    ...
    for (localObject = ((Context)localObject).getString(2131691185);; localObject = ((Context)localObject).getString(2131691184))
    {
      ...
      this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131373069);
      ...
      this.jdField_d_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131373013);
      ...
      this.jdField_e_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131372874);
  ...
  public void a(int paramInt, auuy paramauuy)
  {
    if (QLog.isColorLevel()) {
    ...
    if (paramInt == 1)
    {
      ...
      paramauuy = (RelativeLayout.LayoutParams)this.jdField_b_of_type_AndroidViewView.getLayoutParams();
      paramauuy.addRule(3, 0);
      paramauuy.addRule(10, 1);
      this.jdField_b_of_type_AndroidViewView.setLayoutParams(paramauuy);
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqWidgetRandomCoverView.setTag(localausw);
      this.jdField_a_of_type_ComTencentMobileqqWidgetRandomCoverView.setOnClickListener(paramauuy.jdField_a_of_type_AndroidViewView$OnClickListener);
  ...
  protected void a(int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      return;
      if (paramInt == 0) {
        localView = localLayoutInflater.inflate(2131561596, this.jdField_a_of_type_AndroidViewViewGroup, false);
      }
    }
  }
  ...
  {
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(getContext()).inflate(2131561595, this, true);
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidViewView.findViewById(2131368099));
    ...
    for (;;)
    {
      ...
      String str1 = paramauuy.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_JavaLangString;
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        if (ThemeUtil.isInNightMode(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))
        {
          paramauuy = (ImageView)this.jdField_a_of_type_ComTencentMobileqqVasAvatarAvatarLayout.findViewById(2131363079);
          ...
          paramauuy.setColorFilter(1996488704);
        ...
        localObject1 = paramauuy.jdField_a_of_type_ComTencentMobileqqDataCard.getCoverData(this.jdField_e_of_type_Int);
        ...
        if (!paramauuy.jdField_a_of_type_ComTencentMobileqqDataCard.isNoCover()) {
          break label410;
        }
        i = 1;
        break;
  ...
  public void b(int paramInt)
  {
    ...
    do
    {
      ...
      if (paramInt == 1)
      {
        ...
        ((ViewGroup.MarginLayoutParams)localObject).bottomMargin = axlk.a(5.0F);
      ...
      ((ViewGroup.MarginLayoutParams)localObject).bottomMargin = axlk.a(15.0F);
      this.jdField_a_of_type_ComTencentMobileqqHotchatAnimHeartLayout.setLayoutParams((ViewGroup.LayoutParams)localObject);
  ...
  public void b(auuy paramauuy, boolean paramBoolean)
  {
    ...
    ThreadManager.post(new ProfileBaseView.1(this, paramauuy, paramBoolean), 8, null, true);
  }
  ...
  protected void d(auuy paramauuy)
  {
    int i;
    if (paramauuy.jdField_a_of_type_ComTencentMobileqqDataCard != null)
    {
      ...
      Object localObject = paramauuy.jdField_a_of_type_ComTencentMobileqqDataCard.getCoverData(this.jdField_e_of_type_Int);
      paramauuy = (String)localObject[0];
      if ((TextUtils.isEmpty(paramauuy)) || (paramauuy.equals(this.jdField_b_of_type_JavaLangString))) {
        break label146;
      }
      this.jdField_b_of_type_JavaLangString = paramauuy;
      ...
      bool = true;
      ((RandomCoverView)localObject).a(paramauuy, bool);
    }
    label135:
    label140:
    label146:
    ...
    QLog.i("Q.profilecard.", 2, "same cover " + paramauuy);
  }
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqWidgetProfileNameView != null) {
      this.jdField_a_of_type_ComTencentMobileqqWidgetProfileNameView.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramauuy);
    }
