  ...
  extends ProfileHeaderView
{
  ...
  public ProfileBaseView(BaseActivity paramBaseActivity, atwx paramatwx, PullToZoomHeaderListView paramPullToZoomHeaderListView, TextView paramTextView, boolean paramBoolean)
  {
  ...
  private void d()
  {
    ...
    for (localObject = ((Context)localObject).getString(2131625610);; localObject = ((Context)localObject).getString(2131625609))
    {
      ...
      this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131307357);
      ...
      this.jdField_d_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131307301);
      ...
      this.jdField_e_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131307160);
  ...
  public void a(int paramInt, atwx paramatwx)
  {
    if (QLog.isColorLevel()) {
    ...
    if (paramInt == 1)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqWidgetProfileNameView != null) {
        this.jdField_a_of_type_ComTencentMobileqqWidgetProfileNameView.setTextColor(getResources().getColor(2131101260));
      }
      ...
      paramatwx = (RelativeLayout.LayoutParams)this.jdField_b_of_type_AndroidViewView.getLayoutParams();
      paramatwx.addRule(3, 0);
      paramatwx.addRule(10, 1);
      this.jdField_b_of_type_AndroidViewView.setLayoutParams(paramatwx);
    ...
    else
    {
      ...
      ((RelativeLayout.LayoutParams)localObject).addRule(3, 2131302496);
      ...
      localatuw = new atuw(17, null);
      if (paramatwx.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_Int != 0) {
        break label342;
      }
    }
    label342:
    for (Object localObject = getContext().getString(2131625608);; localObject = getContext().getString(2131625607))
    {
      this.jdField_a_of_type_ComTencentMobileqqWidgetRandomCoverView.setTag(localatuw);
      this.jdField_a_of_type_ComTencentMobileqqWidgetRandomCoverView.setOnClickListener(paramatwx.jdField_a_of_type_AndroidViewView$OnClickListener);
  ...
  protected void a(int paramInt, boolean paramBoolean)
  {
    ...
    View localView = null;
    if (paramInt == 1) {
      localView = localLayoutInflater.inflate(2131496006, this.jdField_a_of_type_AndroidViewViewGroup, false);
    }
    for (;;)
    {
      if (localView != null)
      ...
      return;
      if (paramInt == 0) {
        localView = localLayoutInflater.inflate(2131496005, this.jdField_a_of_type_AndroidViewViewGroup, false);
      }
    }
  }
  ...
  {
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(getContext()).inflate(2131496004, this, true);
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidViewView.findViewById(2131302479));
    this.jdField_a_of_type_ComTencentMobileqqWidgetRandomCoverView = ((RandomCoverView)this.jdField_a_of_type_AndroidViewView.findViewById(2131302496));
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqWidgetRandomCoverView = ((RandomCoverView)this.jdField_a_of_type_AndroidViewView.findViewById(2131302496));
      this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131302470);
      ...
      String str1 = paramatwx.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_JavaLangString;
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        if (ThemeUtil.isInNightMode(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))
        {
          paramatwx = (ImageView)this.jdField_a_of_type_ComTencentMobileqqVasAvatarAvatarLayout.findViewById(2131297539);
          ...
          paramatwx.setColorFilter(1996488704);
        ...
        localObject1 = paramatwx.jdField_a_of_type_ComTencentMobileqqDataCard.getCoverData(this.jdField_e_of_type_Int);
        ...
        if (!paramatwx.jdField_a_of_type_ComTencentMobileqqDataCard.isNoCover()) {
          break label410;
        }
        i = 1;
        break;
  ...
  public void b(int paramInt)
  {
    ...
    do
    {
      ...
      if (paramInt == 1)
      {
        ...
        ((ViewGroup.MarginLayoutParams)localObject).bottomMargin = awmc.a(5.0F);
      ...
      ((ViewGroup.MarginLayoutParams)localObject).bottomMargin = awmc.a(15.0F);
      this.jdField_a_of_type_ComTencentMobileqqHotchatAnimHeartLayout.setLayoutParams((ViewGroup.LayoutParams)localObject);
      localObject = getResources();
      i = ((Resources)localObject).getDimensionPixelSize(2131166298);
      j = ((Resources)localObject).getDimensionPixelSize(2131166300);
  ...
  public void b(atwx paramatwx, boolean paramBoolean)
  {
    ...
    ThreadManager.post(new ProfileBaseView.1(this, paramatwx, paramBoolean), 8, null, true);
  }
  ...
  protected void d(atwx paramatwx)
  {
    int i;
    if (paramatwx.jdField_a_of_type_ComTencentMobileqqDataCard != null)
    {
      ...
      Object localObject = paramatwx.jdField_a_of_type_ComTencentMobileqqDataCard.getCoverData(this.jdField_e_of_type_Int);
      paramatwx = (String)localObject[0];
      if ((TextUtils.isEmpty(paramatwx)) || (paramatwx.equals(this.jdField_b_of_type_JavaLangString))) {
        break label146;
      }
      this.jdField_b_of_type_JavaLangString = paramatwx;
      ...
      bool = true;
      ((RandomCoverView)localObject).a(paramatwx, bool);
    }
    label135:
    label140:
    label146:
    ...
    QLog.i("Q.profilecard.", 2, "same cover " + paramatwx);
  }
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqWidgetProfileNameView != null) {
      this.jdField_a_of_type_ComTencentMobileqqWidgetProfileNameView.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramatwx);
    }
