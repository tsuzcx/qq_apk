  ...
  implements Runnable
{
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      this.b = 2;
      this.jdField_a_of_type_Ayqq.a(this.b);
  ...
  public void run()
  {
    ...
    {
      this.b = 1;
      if (this.jdField_a_of_type_Ayqq != null) {
        this.jdField_a_of_type_Ayqq.a(this.b);
      }
      this.jdField_a_of_type_AndroidOsHandler.removeCallbacks(this);
      return;
  ...
  public void setOnScrollListener(ayqq paramayqq)
  {
    this.jdField_a_of_type_Ayqq = paramayqq;
  }
}
