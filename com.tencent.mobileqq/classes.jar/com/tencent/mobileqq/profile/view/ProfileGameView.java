  ...
  extends ProfileHeaderView
{
  ...
  public ProfileGameView(BaseActivity paramBaseActivity, atwx paramatwx)
  {
  ...
  public void a(atwx paramatwx)
  {
    ...
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from((Context)localObject).inflate(2131496023, this, true);
    atxe.a((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131302481), "background", paramatwx.jdField_a_of_type_Atxe, "gameHeadInfoBackground");
    ...
    for (localObject = ((Context)localObject).getString(2131625610);; localObject = ((Context)localObject).getString(2131625609))
    {
      ...
      atxe.a(this.jdField_a_of_type_ComTencentMobileqqWidgetProfileNameView, "color", paramatwx.jdField_a_of_type_Atxe, "gameNickNameColor");
      ...
      atxe.a(this.jdField_a_of_type_AndroidWidgetTextView, "color", paramatwx.jdField_a_of_type_Atxe, "gameAddressColor");
      this.jdField_a_of_type_JavaUtilHashMap.put("map_key_sex_age_area", this.jdField_a_of_type_AndroidWidgetTextView);
      super.b(paramatwx);
      this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131302530));
      this.jdField_a_of_type_JavaUtilHashMap.put("map_key_sign_common_topic", this.jdField_b_of_type_AndroidWidgetLinearLayout);
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131302529));
      atxe.a(this.jdField_b_of_type_AndroidWidgetTextView, "color", paramatwx.jdField_a_of_type_Atxe, "gameSignColor");
