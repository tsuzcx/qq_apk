  ...
  extends ProfileHeaderView
{
  ...
  public ProfileGameView(BaseActivity paramBaseActivity, awqt paramawqt)
  {
  ...
  public void a(awqt paramawqt)
  {
    ...
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from((Context)localObject).inflate(2131561823, this, true);
    awra.a((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131368250), "background", paramawqt.jdField_a_of_type_Awra, "gameHeadInfoBackground");
    ...
    for (localObject = ((Context)localObject).getString(2131691239);; localObject = ((Context)localObject).getString(2131691238))
    {
      ...
      awra.a(this.jdField_a_of_type_ComTencentMobileqqWidgetProfileNameView, "color", paramawqt.jdField_a_of_type_Awra, "gameNickNameColor");
      ...
      awra.a(this.jdField_a_of_type_AndroidWidgetTextView, "color", paramawqt.jdField_a_of_type_Awra, "gameAddressColor");
      this.jdField_a_of_type_JavaUtilHashMap.put("map_key_sex_age_area", this.jdField_a_of_type_AndroidWidgetTextView);
      super.b(paramawqt);
      this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131368307));
      this.jdField_a_of_type_JavaUtilHashMap.put("map_key_sign_common_topic", this.jdField_b_of_type_AndroidWidgetLinearLayout);
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368306));
      awra.a(this.jdField_b_of_type_AndroidWidgetTextView, "color", paramawqt.jdField_a_of_type_Awra, "gameSignColor");
