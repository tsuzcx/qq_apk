  ...
  extends BitmapDrawable
{
  ...
  public static HeartRiseDrawable[] a(int paramInt, Resources paramResources, Bitmap paramBitmap)
  {
    ...
    {
      HeartRiseDrawable[] arrayOfHeartRiseDrawable2 = new HeartRiseDrawable[paramInt];
      e = paramBitmap.getWidth() / 2;
      d = paramBitmap.getHeight() / 2;
      int i = 0;
      for (;;)
      {
        arrayOfHeartRiseDrawable1 = arrayOfHeartRiseDrawable2;
        if (i >= paramInt) {
          break;
        }
        arrayOfHeartRiseDrawable2[i] = new HeartRiseDrawable(paramResources, paramBitmap);
        i += 1;
      }
    }
    HeartRiseDrawable[] arrayOfHeartRiseDrawable1 = null;
    return arrayOfHeartRiseDrawable1;
  }
