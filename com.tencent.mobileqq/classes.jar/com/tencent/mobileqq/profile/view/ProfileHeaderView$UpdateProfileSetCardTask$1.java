  ...
  implements Runnable
{
  ...
  public void run()
  {
    try
    {
      ...
      {
        axqy.b(null, "CliOper", "", "", "card_mall", "0X80066D3", 0, 0, "", "", "", "");
        ...
        localTextView.setText(localResources.getString(2131720333));
        localImageView.setContentDescription(localResources.getString(2131720333));
        localView.setTag(new ausw(29, "CLICK_BANNER"));
        localView.setOnClickListener(this.a.jdField_a_of_type_Auuy.a);
        this.a.b.set(true);
