...
public class QzonePhotoView
  ...
  implements Handler.Callback, bfww
{
  private float jdField_a_of_type_Float;
  private int jdField_a_of_type_Int;
  private Activity jdField_a_of_type_AndroidAppActivity;
  private Handler jdField_a_of_type_AndroidOsHandler;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new avae(this);
  ...
  private List<avah> jdField_a_of_type_JavaUtilList;
  public boolean a;
  ...
  private List<avah> a(String paramString, List<Map<Integer, String>> paramList)
  {
    ...
    while ((j < i) && (j < 16))
    {
      ...
      if (paramString != null)
      {
        paramString = new avah(j, 100, paramString);
  ...
  public void a(BaseActivity paramBaseActivity, auuw paramauuw)
  {
    ...
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication()).inflate(2131561626, this, true);
    ...
    paramauuw = Message.obtain();
    paramauuw.what = 100;
    this.jdField_a_of_type_AndroidOsHandler.sendMessage(paramauuw);
  ...
  public void a(List<avah> paramList)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        this.jdField_b_of_type_AndroidViewView.setTag(new ausu(25, null));
        this.jdField_b_of_type_AndroidViewView.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
        localObject2 = bazo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, -1L);
        if (!TextUtils.isEmpty((CharSequence)localObject2))
        {
          localObject1 = URLDrawable.URLDrawableOptions.obtain();
          ((URLDrawable.URLDrawableOptions)localObject1).mRequestHeight = bazo.a(getContext(), 188);
        ...
        if (i > 0)
        {
          avaf localavaf = new avaf(this);
          localavaf.a(paramList);
          localavaf.a(this.jdField_b_of_type_Int, this.jdField_b_of_type_Int);
          paramList = new AdapterViewPagerAdapter(getContext(), localavaf, 8);
          paramList.a(new avad(this));
  ...
  public void a(boolean paramBoolean, String paramString, mobile_sub_get_photo_wall_rsp parammobile_sub_get_photo_wall_rsp)
  {
      ...
      if ((paramBoolean) && (parammobile_sub_get_photo_wall_rsp != null))
      {
        ...
        for (;;)
        {
          ...
          if (i < 16)
          {
            ...
            paramString = (avah)this.jdField_a_of_type_JavaUtilList.get(i);
            if ((localList == null) || (localList.size() <= i)) {
              break label292;
            }
          }
          for (parammobile_sub_get_photo_wall_rsp = (avah)localList.get(i);; parammobile_sub_get_photo_wall_rsp = null)
          {
    ...
    } while ((!bbev.a(BaseApplication.getContext())) || (this.d >= 3));
    label287:
    label292:
    label297:
