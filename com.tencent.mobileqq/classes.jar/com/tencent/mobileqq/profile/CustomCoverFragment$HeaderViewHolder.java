  ...
  extends RecyclerView.ViewHolder
{
  public CustomCoverFragment$HeaderViewHolder(CustomCoverFragment paramCustomCoverFragment, View paramView)
  {
    ...
    this.itemView.findViewById(2131361969).setOnClickListener(paramCustomCoverFragment);
    this.itemView.findViewById(2131361982).setOnClickListener(paramCustomCoverFragment);
    this.itemView.findViewById(2131361963).setOnClickListener(paramCustomCoverFragment);
    CustomCoverFragment.a(paramCustomCoverFragment, this.itemView.findViewById(2131369766));
    CustomCoverFragment.a(paramCustomCoverFragment).setVisibility(8);
    CustomCoverFragment.a(paramCustomCoverFragment, (ImageView)this.itemView.findViewById(2131369312));
