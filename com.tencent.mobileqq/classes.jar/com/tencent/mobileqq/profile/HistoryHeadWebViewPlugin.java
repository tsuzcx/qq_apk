  ...
  extends VasWebviewJsPlugin
{
  ...
  public static void a(Activity paramActivity, int paramInt1, int paramInt2, ArrayList paramArrayList1, ArrayList paramArrayList2, boolean paramBoolean, String paramString, int paramInt3)
  {
    ...
    if (paramArrayList1 != null) {
      localBundle.putParcelableArrayList("picInfos", paramArrayList1);
    }
    if (paramArrayList2 != null) {
      localBundle.putStringArrayList("fileIdList", paramArrayList2);
    }
      ...
      if (this.mRuntime.a() != null)
      {
        ...
        if (localObject1 != null)
        {
          ...
          if ((paramString instanceof WebViewPluginContainer)) {
            i = ((WebViewPluginContainer)paramString).a(this, (byte)100);
          }
          for (;;)
          {
            ...
            i = j;
            if (localObject2 != null) {
              i = ((WebViewFragment)localObject2).a(this, (byte)100);
            }
          }
        }
      }
