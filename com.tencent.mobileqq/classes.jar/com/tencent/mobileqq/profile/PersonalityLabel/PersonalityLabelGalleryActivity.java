...
public class PersonalityLabelGalleryActivity
  ...
  implements Handler.Callback, View.OnClickListener, ayko
{
  private float jdField_a_of_type_Float;
  public int a;
  private long jdField_a_of_type_Long;
  amsu jdField_a_of_type_Amsu = new aykt(this);
  BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new aykw(this);
  public Drawable a;
  public Handler a;
  public TextPaint a;
  ...
  public aykm a;
  private ayld jdField_a_of_type_Ayld;
  private ayln jdField_a_of_type_Ayln = new aykx(this);
  bhht jdField_a_of_type_Bhht;
  bhhv jdField_a_of_type_Bhhv = new ayku(this);
  public bjnw a;
  ...
  private void a(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      {
        aylc localaylc = (aylc)this.jdField_a_of_type_ComTencentWidgetXListView.getChildAt(i).getTag();
        if ((localaylc != null) && (localaylc.jdField_a_of_type_Long == paramLong)) {
          localaylc.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelGlowCountRecyclerView.getAdapter().notifyDataSetChanged();
        }
      }
      else
      {
  ...
  private void a(long paramLong, PersonalityLabelInfo paramPersonalityLabelInfo)
  {
    ...
    for (;;)
    {
      ...
      if (i < this.jdField_a_of_type_ComTencentWidgetXListView.getChildCount())
      {
        localaylc = (aylc)this.jdField_a_of_type_ComTencentWidgetXListView.getChildAt(i).getTag();
        if ((localaylc == null) || (localaylc.jdField_a_of_type_Long != paramLong)) {
          break label170;
        }
        ...
        i = 1;
        if (localaylc.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelGlowCountRecyclerView.getVisibility() != 0) {
          break label157;
        }
        if (j != i)
        {
          localGlowCountRecyclerView = localaylc.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelGlowCountRecyclerView;
          if (i == 0) {
            break label163;
          }
        }
      ...
      for (i = 0;; i = 8)
      {
        ...
        localaylc.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelGlowCountRecyclerView.setText(paramPersonalityLabelInfo.photoCount + "张");
        localaylc.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelGlowCountRecyclerView.getAdapter().notifyDataSetChanged();
        localaylc.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelGlowCountRecyclerView.smoothScrollToPosition(0);
        return;
        i = 0;
        break;
        j = 0;
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          ...
          if (this.jdField_b_of_type_AndroidViewView != null)
          {
            View localView1 = this.jdField_b_of_type_AndroidViewView.findViewById(2131366078);
            localTextView1 = (TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131366075);
            localTextView2 = (TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131366084);
            localView2 = this.jdField_b_of_type_AndroidViewView.findViewById(2131366045);
            if (this.f)
            {
              localTextView1.setText(2131698428);
              localTextView2.setText(getString(2131698424));
        ...
        catch (OutOfMemoryError localOutOfMemoryError1)
        {
          ...
          {
            localTextView1.setText(2131698423);
          ...
          else
          {
            localTextView1.setText(2131698428);
            localView2.setVisibility(8);
            localTextView2.setText(getString(2131698427));
          }
        }
      }
  ...
  private void a(String paramString, bhhv parambhhv)
  {
    if (isFinishing()) {}
    do
    {
      ...
      this.jdField_a_of_type_Bhht.a(parambhhv);
  ...
  private void a(boolean paramBoolean)
  {
    if (!this.jdField_b_of_type_Boolean)
    {
      ...
      {
        a(getResources().getString(2131694062));
        return;
      }
  ...
  private void e()
  {
    ...
    if (!this.f)
    {
      localTextView = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379877);
  ...
  private void g()
  {
    a("正在处理...", this.jdField_a_of_type_Bhhv);
  ...
  private void i()
  {
    ((ayll)this.app.getBusinessHandler(112)).a(this.jdField_a_of_type_JavaLangString, 1);
  }
  ...
  public void a(int paramInt, String paramString, boolean paramBoolean)
  {
    if (this.jdField_c_of_type_AndroidWidgetTextView == null) {
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131370267));
    }
  ...
  public void a(long paramLong, aykn paramaykn)
  {
    PersonalityLabelPhoto localPersonalityLabelPhoto = paramaykn.a;
    if (QLog.isColorLevel()) {
      QLog.i("PersonalityLabelGalleryActivity", 2, "personality_label onUpdateState:" + localPersonalityLabelPhoto.uniseq + " state:" + paramaykn.jdField_b_of_type_Int + " progress:" + paramaykn.jdField_c_of_type_Int);
    }
    if (paramaykn.jdField_b_of_type_Int == 4) {
      a(paramLong, true);
    }
    int i = 0;
    Object localObject1;
    if (i < this.jdField_a_of_type_ComTencentWidgetXListView.getChildCount())
    {
      localObject1 = (aylc)this.jdField_a_of_type_ComTencentWidgetXListView.getChildAt(i).getTag();
      if ((localObject1 == null) || (((aylc)localObject1).jdField_a_of_type_Long != paramLong)) {}
    }
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        Object localObject2;
        aylk localaylk;
        if (i < ((aylc)localObject1).jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelGlowCountRecyclerView.getChildCount())
        {
          localObject2 = ((aylc)localObject1).jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelGlowCountRecyclerView.getChildAt(i);
          localaylk = (aylk)((aylc)localObject1).jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelGlowCountRecyclerView.getChildViewHolder((View)localObject2);
          if (localaylk == null)
          {
            localObject2 = null;
            label212:
            if ((localObject2 == null) || (!(localObject2 instanceof aykn)) || (((aykn)localObject2).a.uniseq != localPersonalityLabelPhoto.uniseq)) {
              break label365;
            }
          }
        }
        for (localObject1 = localaylk;; localObject1 = null)
        {
          if (localObject1 == null) {
            break label400;
          }
          ...
          a(paramaykn, localPersonalityLabelPhoto, (aylk)localObject1);
          if (paramaykn.jdField_b_of_type_Int == 4)
          {
            this.g = true;
            ((aylk)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout.setTag(2131372508, null);
            if (this.jdField_a_of_type_AndroidOsHandler.hasMessages(0)) {
              this.jdField_a_of_type_AndroidOsHandler.removeMessages(0);
            }
            paramaykn = this.jdField_a_of_type_AndroidOsHandler.obtainMessage(0, this.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelPersonalityLabel);
            this.jdField_a_of_type_AndroidOsHandler.sendMessageDelayed(paramaykn, 200L);
            return;
            localObject2 = localaylk.jdField_a_of_type_AndroidWidgetRelativeLayout.getTag(2131372508);
            break label212;
            label365:
            i += 1;
            break label164;
          }
          if (paramaykn.jdField_b_of_type_Int != 3) {
            break;
          }
  ...
  public void a(View paramView, long paramLong)
  {
    ...
    localValueAnimator.addUpdateListener(new ayla(this, localValueAnimator, paramView));
    localValueAnimator.addListener(new aykr(this, paramLong));
    localValueAnimator.start();
  }
  
  public void a(aykn paramaykn, PersonalityLabelPhoto paramPersonalityLabelPhoto, aylk paramaylk)
  {
    int j = 1;
    int k = 0;
    if (QLog.isColorLevel()) {
      QLog.i("PersonalityLabelGalleryActivity", 2, "personality_label bindProgressState id:" + paramPersonalityLabelPhoto.fileId + " key:" + paramPersonalityLabelPhoto.uniseq + " item:" + paramaykn);
    }
    if (!paramPersonalityLabelPhoto.local)
    {
      if (paramaylk.jdField_a_of_type_ComTencentMobileqqWidgetMessageProgressView != null)
      {
        paramaylk.jdField_a_of_type_AndroidWidgetRelativeLayout.removeView(paramaylk.jdField_a_of_type_ComTencentMobileqqWidgetMessageProgressView);
        paramaylk.jdField_a_of_type_ComTencentMobileqqWidgetMessageProgressView = null;
      }
      if (paramaylk.b.getVisibility() != 8) {
        paramaylk.b.setVisibility(8);
      }
    }
    do
    {
      ...
      if (paramaylk.jdField_a_of_type_ComTencentMobileqqWidgetMessageProgressView != null)
      {
        paramaylk.jdField_a_of_type_ComTencentMobileqqWidgetMessageProgressView.a(paramPersonalityLabelPhoto);
        paramaylk.jdField_a_of_type_ComTencentMobileqqWidgetMessageProgressView.b(paramPersonalityLabelPhoto);
        paramaylk.jdField_a_of_type_AndroidWidgetRelativeLayout.removeView(paramaylk.jdField_a_of_type_ComTencentMobileqqWidgetMessageProgressView);
        paramaylk.jdField_a_of_type_ComTencentMobileqqWidgetMessageProgressView = null;
      }
    } while (paramaylk.b.getVisibility() == 8);
    paramaylk.b.setVisibility(8);
    return;
    switch (paramaykn.jdField_b_of_type_Int)
    {
    default: 
      return;
    case 0: 
    ...
    case 2: 
      if (paramaylk.jdField_a_of_type_ComTencentMobileqqWidgetMessageProgressView == null)
      {
        ...
        paramaylk.jdField_a_of_type_AndroidWidgetRelativeLayout.addView(localMessageProgressView, localLayoutParams);
        paramaylk.jdField_a_of_type_ComTencentMobileqqWidgetMessageProgressView = localMessageProgressView;
      }
      paramaylk.jdField_a_of_type_ComTencentMobileqqWidgetMessageProgressView.a(paramPersonalityLabelPhoto);
      if (paramaykn.jdField_b_of_type_Int != 2)
      {
        paramaylk.jdField_a_of_type_ComTencentMobileqqWidgetMessageProgressView.setDrawStatus(1);
        paramaylk.jdField_a_of_type_ComTencentMobileqqWidgetMessageProgressView.setAnimProgress(0, paramPersonalityLabelPhoto);
      }
      while (paramaylk.b.getVisibility() != 8)
      {
        paramaylk.b.setVisibility(8);
        return;
        paramaylk.jdField_a_of_type_ComTencentMobileqqWidgetMessageProgressView.setDrawStatus(1);
        paramaylk.jdField_a_of_type_ComTencentMobileqqWidgetMessageProgressView.setAnimProgress(paramaykn.jdField_c_of_type_Int, paramPersonalityLabelPhoto);
      }
    }
    if (paramaylk.jdField_a_of_type_ComTencentMobileqqWidgetMessageProgressView != null)
    {
      paramaylk.jdField_a_of_type_ComTencentMobileqqWidgetMessageProgressView.a(paramPersonalityLabelPhoto);
      if ((paramaykn.jdField_b_of_type_Int == 3) || (!paramaylk.jdField_a_of_type_ComTencentMobileqqWidgetMessageProgressView.a(paramPersonalityLabelPhoto)))
      {
        paramaylk.jdField_a_of_type_ComTencentMobileqqWidgetMessageProgressView.b(paramPersonalityLabelPhoto);
        paramaylk.jdField_a_of_type_AndroidWidgetRelativeLayout.removeView(paramaylk.jdField_a_of_type_ComTencentMobileqqWidgetMessageProgressView);
        paramaylk.jdField_a_of_type_ComTencentMobileqqWidgetMessageProgressView = null;
    ...
    else
    {
      ...
      i = 1;
      label469:
      if (paramaylk.b.getVisibility() != 0) {
        break label542;
      }
      label479:
      if (i == j) {
    ...
    for (int i = k;; i = 8)
    {
      paramaykn.setVisibility(i);
      return;
      if (paramaykn.jdField_b_of_type_Int != 4) {
        break label458;
      }
      paramaylk.jdField_a_of_type_ComTencentMobileqqWidgetMessageProgressView.setDrawStatus(1);
      paramaylk.jdField_a_of_type_ComTencentMobileqqWidgetMessageProgressView.setAnimProgress(100, paramPersonalityLabelPhoto);
      break label458;
      i = 0;
      break label469;
      j = 0;
  ...
  public void a(PersonalityLabel paramPersonalityLabel, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Ayld.notifyDataSetChanged();
    ...
    {
      this.jdField_b_of_type_AndroidWidgetTextView.setText(String.format(aykk.jdField_b_of_type_JavaLangString, new Object[] { Integer.valueOf(paramPersonalityLabel.unreadCount) }));
      this.jdField_b_of_type_AndroidWidgetTextView.setOnClickListener(new aykv(this));
      a(0);
      i = 0;
  ...
  void b()
  {
    ...
    if (this.f)
    {
      ...
      setRightButton(2131691727, this);
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setText(2131698425);
      return;
      label67:
  ...
  void c()
  {
    ...
    if (j >= 0)
    {
      ...
      if ((localObject1 == null) || (!(localObject1 instanceof aylc))) {
        break label224;
      }
      localObject1 = (aylc)localObject1;
      localView = ((aylc)localObject1).d;
    ...
    for (;;)
    {
      ...
      ((ValueAnimator)localObject2).addUpdateListener(new ayky(this, (ValueAnimator)localObject2, localView));
      ((ValueAnimator)localObject2).addListener(new aykz(this, (aylc)localObject1, localView));
      ((ValueAnimator)localObject2).setDuration(200L);
      ((ValueAnimator)localObject2).setStartDelay(i);
      ((ValueAnimator)localObject2).start();
      this.jdField_a_of_type_JavaUtilHashSet.remove(Long.valueOf(((aylc)localObject1).jdField_a_of_type_Long));
      i += 150;
      continue;
      return;
    }
  ...
  void d()
  {
    ...
    for (;;)
    {
      ...
      if (i < this.jdField_a_of_type_ComTencentWidgetXListView.getChildCount())
      {
        ...
        if ((localObject == null) || (!(localObject instanceof aylc))) {
          break label129;
        }
        localImageView = ((aylc)localObject).b;
      ...
      if (localObjectAnimator == null)
      {
        ...
        ((ObjectAnimator)localObject).addListener(new ayks(this, (ObjectAnimator)localObject));
  ...
  public void doOnActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    QQToast.a(getApplicationContext(), 0, 2131694062, 0).a();
  }
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)findViewById(2131370049));
    this.jdField_a_of_type_AndroidViewView = getLayoutInflater().inflate(2131561266, this.jdField_a_of_type_ComTencentWidgetXListView, false);
    this.jdField_a_of_type_ComTencentWidgetXListView.addHeaderView(this.jdField_a_of_type_AndroidViewView);
    this.jdField_a_of_type_AndroidViewViewStub = ((ViewStub)findViewById(2131366087));
    this.jdField_a_of_type_Ayld = new ayld(this, null);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Ayld);
    this.jdField_c_of_type_AndroidViewView = findViewById(2131363623);
    this.jdField_b_of_type_AndroidWidgetButton = ((Button)findViewById(2131377268));
    ...
    addObserver(this.jdField_a_of_type_Ayln);
    e();
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379558));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379908));
    if (this.f) {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      this.jdField_a_of_type_Aykm = ((aykm)this.app.getManager(230));
      if (this.f) {
        this.jdField_a_of_type_Aykm.a(this);
      }
      a(0, "正在加载...", true);
  ...
  public void doOnDestroy()
  {
    super.doOnDestroy();
    bfwo.a().a();
    this.jdField_a_of_type_Aykm.a(null);
    this.jdField_a_of_type_AndroidOsHandler.removeCallbacksAndMessages(null);
    this.jdField_b_of_type_AndroidOsHandler.removeCallbacksAndMessages(null);
    removeObserver(this.jdField_a_of_type_Ayln);
    ...
    do
    {
      ...
      while ((paramMessage != null) && (paramMessage.getSize() > 0))
      {
        ...
        while (i < paramMessage.personalityLabelInfos.size())
        {
          ...
          this.jdField_a_of_type_Aykm.a(((PersonalityLabelInfo)localObject).id, (PersonalityLabelInfo)localObject, false);
          i += 1;
        }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      bcef.b(this.app, "dc00898", "", "", "0X8007FD4", "0X8007FD4", 0, 0, "0", "0", "", "");
      continue;
      if ((paramView == this.jdField_a_of_type_AndroidWidgetButton) || (2131366045 == paramView.getId()))
      {
        bcef.b(this.app, "dc00898", "", "", "0X8007FD3", "0X8007FD3", 0, 0, "0", "0", "", "");
        ...
        {
          bfrj.a(this.app.getCurrentAccountUin(), this.app, this, false);
        }
      }
