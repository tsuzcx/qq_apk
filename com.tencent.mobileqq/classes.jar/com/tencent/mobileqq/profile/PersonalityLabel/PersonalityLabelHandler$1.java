...
public final class PersonalityLabelHandler$1
  implements Runnable
{
  public PersonalityLabelHandler$1(String paramString, QQAppInterface paramQQAppInterface, auuy paramauuy, byte[] paramArrayOfByte) {}
  ...
  public void run()
  {
    if (this.jdField_a_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())) {
      this.jdField_a_of_type_Auuy.a.vPersonalityLabelV2 = this.jdField_a_of_type_ArrayOfByte;
    }
  }
}
