  ...
  implements Runnable
{
  ...
  public void run()
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      bcpw.a(BaseApplicationImpl.getContext(), 2, this.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelPersonalityLabelShareActivity$2.this$0.getString(2131717236, new Object[] { this.jdField_a_of_type_JavaLangString }), 1).b(this.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelPersonalityLabelShareActivity$2.this$0.getTitleBarHeight());
    }
    for (;;)
    {
