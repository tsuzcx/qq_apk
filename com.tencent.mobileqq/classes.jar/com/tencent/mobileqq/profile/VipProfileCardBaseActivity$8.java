  ...
  implements Runnable
{
  ...
  public void run()
  {
    Object localObject = new SSummaryCardSetReq(2, Long.parseLong(this.this$0.app.getCurrentAccountUin()), 0L, "8.2.6", 109L, this.jdField_a_of_type_Long, this.b, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int, null, null, new cardDiyComplicatedInfo());
