  ...
  implements Manager
{
  ...
  private void b(QQAppInterface paramQQAppInterface, VipUploadConfigImpl paramVipUploadConfigImpl)
  {
    ...
    IUploadService.UploadServiceCreator.getInstance().init(paramQQAppInterface.getApp().getApplicationContext(), new agux(this, Long.parseLong(paramQQAppInterface.getCurrentAccountUin())), null, null, new UploadEnv());
  }
