  ...
  implements CheckUpdateItemInterface
{
  ...
  private SummaryCardUpdate.SUpdateReq a(int paramInt, String paramString)
  {
    ...
    localSUpdateReq.client_version.set("7.6.0");
  ...
  private void a(File paramFile)
  {
    ...
    //   21: aload_1
    //   22: invokevirtual 204	java/io/File:exists	()Z
    //   25: invokevirtual 207	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    ...
    //   34: aload_1
    //   35: invokevirtual 204	java/io/File:exists	()Z
    //   38: ifeq +97 -> 135
    //   41: new 209	java/io/FileInputStream
    //   44: dup
    //   45: aload_1
    ...
    //   51: aload 4
    //   53: astore_3
    //   54: new 213	java/io/ByteArrayOutputStream
    //   57: dup
    //   58: invokespecial 214	java/io/ByteArrayOutputStream:<init>	()V
    //   61: astore 5
    //   63: aload 4
    //   65: astore_3
    //   66: sipush 4096
    ...
    //   80: iconst_0
    //   81: sipush 4096
    //   84: invokevirtual 220	java/io/InputStream:read	([BII)I
    //   87: istore_2
    //   88: iload_2
    //   89: iconst_m1
    //   90: if_icmpeq +46 -> 136
    ...
    //   100: iconst_0
    //   101: iload_2
    //   102: invokevirtual 224	java/io/ByteArrayOutputStream:write	([BII)V
    //   105: goto -32 -> 73
    //   108: astore_3
    //   109: aload 4
    //   111: astore_1
    ...
    //   120: ldc 226
    //   122: aload 4
    //   124: invokestatic 230	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   127: aload_1
    //   128: ifnull +7 -> 135
    //   131: aload_1
    //   132: invokevirtual 233	java/io/InputStream:close	()V
    //   135: return
    //   136: aload 4
    //   138: astore_3
    //   139: aload 4
    //   141: invokevirtual 233	java/io/InputStream:close	()V
    //   144: aload 4
    //   146: astore_3
    //   147: aload_1
    //   148: new 201	java/io/File
    //   151: dup
    //   152: aload_0
    ...
    //   156: invokevirtual 237	com/tencent/mobileqq/app/QQAppInterface:getApplication	()Lmqq/app/MobileQQ;
    //   159: invokestatic 242	com/tencent/mobileqq/util/ProfileCardUtil:a	(Landroid/content/Context;)Ljava/lang/String;
    //   162: invokespecial 243	java/io/File:<init>	(Ljava/lang/String;)V
    //   165: invokevirtual 247	java/io/File:renameTo	(Ljava/io/File;)Z
    //   168: pop
    //   169: aload 4
    //   171: astore_3
    ...
    //   175: dup
    //   176: aload 5
    //   178: invokevirtual 251	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   181: ldc 253
    //   183: invokespecial 256	java/lang/String:<init>	([BLjava/lang/String;)V
    //   186: astore_1
    //   187: aload_1
    //   188: ifnull +21 -> 209
    //   191: aload 4
    ...
    //   204: aload_0
    //   205: aload_1
    //   206: invokespecial 258	com/tencent/mobileqq/profile/ProfileCardCheckUpdate:a	(Ljava/lang/String;)V
    //   209: aload 4
    //   211: ifnull -76 -> 135
    //   214: aload 4
    //   216: invokevirtual 233	java/io/InputStream:close	()V
    //   219: return
    //   220: astore_1
    //   221: ldc 83
    //   223: iconst_1
    //   224: ldc 226
    //   226: aload_1
    //   227: invokestatic 230	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   230: return
    //   231: astore_1
    //   232: aload 4
    //   234: astore_3
    //   235: aload_1
    //   236: invokevirtual 261	java/lang/Exception:printStackTrace	()V
    //   239: goto -70 -> 169
    //   242: astore_1
    //   243: aload_3
    //   244: ifnull +7 -> 251
    //   247: aload_3
    //   248: invokevirtual 233	java/io/InputStream:close	()V
    //   251: aload_1
    //   252: athrow
    //   253: astore_1
    //   254: ldc 83
    ...
    //   257: ldc 226
    //   259: aload_1
    //   260: invokestatic 230	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   263: return
    //   264: astore_3
    //   265: ldc 83
    //   267: iconst_1
    //   268: ldc 226
    //   270: aload_3
    //   271: invokestatic 230	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   274: goto -23 -> 251
    //   277: astore_1
    //   278: aconst_null
    //   279: astore_3
  ...
  public ReqItem a()
  {
    ...
    QLog.d("ProfileCard.ProfileCardCheckUpdate", 2, "getCheckUpdateItemData uin=" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getLongAccountUin() + ",cardVersion=" + str1 + "labelVersion=" + str2 + ",client_version=" + "7.6.0" + ",dataLen=" + j);
    return localReqItem;
  }
  ...
  public void a(SummaryCardUpdate.SUpdateRsp paramSUpdateRsp)
  {
    ...
    ReportCenter.a().a("SummaryCardUpdate.EM_RT_FUN_CALL", 100, i, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 1000277, "[资料卡]趣味来电增量更新失败", true);
  }
  
  public void a(String paramString1, String paramString2)
  {
    ThreadManager.post(new agbg(this, paramString1, paramString2), 8, null, false);
  }
  ...
  public void b(SummaryCardUpdate.SUpdateRsp paramSUpdateRsp)
  {
    ...
    if (i == 0)
    {
      ...
      if ((str1 != null) && (!str1.equals(str2)))
      {
        ...
        ThreadManager.post(new agbf(this), 5, null, true);
      }
      return;
    }
    ReportCenter.a().a("SummaryCardUpdate.EM_RT_SPECIAL_REMIND", 100, i, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 1000277, "[资料卡]特别关心更新失败", true);
  }
  ...
  public void d(SummaryCardUpdate.SUpdateRsp paramSUpdateRsp)
  {
    ...
    ReportCenter.a().a("SummaryCardUpdate.EM_RT_SUMMARY_LABEL", 100, i, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 1000277, "[资料卡]资料卡标签增量更新失败", true);
  }
  ...
  public void e(SummaryCardUpdate.SUpdateRsp paramSUpdateRsp)
  {
    ...
    ReportCenter.a().a("SummaryCardUpdate.EM_RT_SUMMARY_UPDATE", 100, i, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 1000277, "[资料卡]资料卡增量更新失败", true);
  }
}
