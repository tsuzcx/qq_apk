...
public class ProfileCardTemplate
{
  ...
  public static void a(View paramView, String paramString1, ProfileCardTemplate paramProfileCardTemplate, String paramString2)
  {
    ...
    do
    {
      ...
      } while (!(paramProfileCardTemplate instanceof URLDrawable));
      ((ImageView)paramView).setImageDrawable((URLDrawable)paramProfileCardTemplate);
      return;
  ...
  public JSONObject a(QQAppInterface paramQQAppInterface, long paramLong)
  {
    ...
    //   6: ldc_w 712
    //   9: astore 5
    //   11: invokestatic 452	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   14: ifeq +31 -> 45
    //   17: ldc_w 454
    //   20: iconst_2
    //   21: new 456	java/lang/StringBuilder
    //   24: dup
    //   25: invokespecial 457	java/lang/StringBuilder:<init>	()V
    //   28: ldc_w 714
    //   31: invokevirtual 463	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   34: aload 5
    //   36: invokevirtual 463	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   39: invokevirtual 467	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   42: invokestatic 470	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   45: lload_2
    //   46: lconst_1
    //   47: lcmp
    //   48: ifne +23 -> 71
    //   51: getstatic 716	com/tencent/mobileqq/profile/ProfileCardTemplate:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   54: ifnull +17 -> 71
    //   57: getstatic 716	com/tencent/mobileqq/profile/ProfileCardTemplate:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   60: astore_1
    //   61: aload_1
    //   62: areturn
    //   63: ldc_w 718
    ...
    //   73: lcmp
    //   74: ifeq +13 -> 87
    //   77: getstatic 720	com/tencent/mobileqq/profile/ProfileCardTemplate:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   80: ifnull +7 -> 87
    //   83: getstatic 720	com/tencent/mobileqq/profile/ProfileCardTemplate:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   86: areturn
    //   87: invokestatic 452	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   90: ifeq +31 -> 121
    //   93: ldc_w 454
    //   96: iconst_2
    //   97: new 456	java/lang/StringBuilder
    //   100: dup
    //   101: invokespecial 457	java/lang/StringBuilder:<init>	()V
    //   104: ldc_w 722
    //   107: invokevirtual 463	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   110: aload 5
    //   112: invokevirtual 463	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   115: invokevirtual 467	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   118: invokestatic 470	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   121: aload_1
    //   122: ldc2_w 483
    //   125: invokestatic 489	com/tencent/mobileqq/util/ProfileCardUtil:a	(Lcom/tencent/mobileqq/app/QQAppInterface;J)Ljava/lang/String;
    //   128: astore_1
    //   129: aload_1
    //   130: ifnull +142 -> 272
    //   133: aload_1
    //   134: invokevirtual 380	java/lang/String:length	()I
    //   137: ifle +135 -> 272
    //   140: new 456	java/lang/StringBuilder
    //   143: dup
    //   144: invokespecial 457	java/lang/StringBuilder:<init>	()V
    //   147: aload_1
    //   148: invokevirtual 463	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   151: getstatic 494	java/io/File:separator	Ljava/lang/String;
    //   154: invokevirtual 463	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   157: aload 5
    //   159: invokevirtual 463	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   162: invokevirtual 467	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   165: astore_1
    //   166: new 491	java/io/File
    //   169: dup
    //   170: aload_1
    //   171: invokespecial 723	java/io/File:<init>	(Ljava/lang/String;)V
    //   174: astore_1
    //   175: aload_1
    //   176: invokevirtual 726	java/io/File:exists	()Z
    //   179: ifeq +239 -> 418
    //   182: new 561	java/io/FileInputStream
    //   185: dup
    //   186: aload_1
    //   187: invokespecial 729	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   190: astore 5
    //   192: aload 5
    //   194: astore_1
    //   195: new 731	java/io/ByteArrayOutputStream
    //   198: dup
    //   199: invokespecial 732	java/io/ByteArrayOutputStream:<init>	()V
    //   202: astore 6
    //   204: aload 5
    //   206: astore_1
    //   207: sipush 4096
    ...
    //   221: iconst_0
    //   222: sipush 4096
    //   225: invokevirtual 738	java/io/InputStream:read	([BII)I
    //   228: istore 4
    //   230: iload 4
    //   232: iconst_m1
    ...
    //   243: iconst_0
    //   244: iload 4
    //   246: invokevirtual 742	java/io/ByteArrayOutputStream:write	([BII)V
    //   249: goto -35 -> 214
    //   252: astore 6
    //   254: aload 5
    //   256: astore_1
    //   257: aload 6
    //   259: invokevirtual 743	java/lang/Exception:printStackTrace	()V
    //   262: aload 5
    //   264: ifnull +8 -> 272
    //   267: aload 5
    //   269: invokevirtual 746	java/io/InputStream:close	()V
    //   272: aconst_null
    //   273: areturn
    //   274: aload 5
    //   276: astore_1
    //   277: new 191	java/lang/String
    //   280: dup
    //   281: aload 6
    //   283: invokevirtual 749	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   286: ldc_w 751
    //   289: invokespecial 754	java/lang/String:<init>	([BLjava/lang/String;)V
    //   292: astore 7
    //   294: aload 5
    //   296: astore 6
    //   298: aload 7
    ...
    //   309: astore_1
    //   310: aload 7
    //   312: invokevirtual 380	java/lang/String:length	()I
    //   315: ifle +106 -> 421
    //   318: lload_2
    //   319: lconst_1
    //   320: lcmp
    ...
    //   324: aload 5
    //   326: astore_1
    //   327: new 372	org/json/JSONObject
    //   330: dup
    //   331: aload 7
    //   333: invokespecial 755	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   336: putstatic 716	com/tencent/mobileqq/profile/ProfileCardTemplate:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   339: aload 5
    //   341: astore_1
    //   342: getstatic 716	com/tencent/mobileqq/profile/ProfileCardTemplate:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   345: astore 6
    //   347: aload 6
    //   349: astore_1
    //   350: aload 5
    //   352: ifnull -291 -> 61
    //   355: aload 5
    //   357: invokevirtual 746	java/io/InputStream:close	()V
    //   360: aload 6
    //   362: areturn
    //   363: astore_1
    //   364: aload_1
    //   365: invokevirtual 756	java/io/IOException:printStackTrace	()V
    //   368: aload 6
    //   370: areturn
    //   371: aload 5
    //   373: astore_1
    //   374: new 372	org/json/JSONObject
    //   377: dup
    //   378: aload 7
    //   380: invokespecial 755	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   383: putstatic 720	com/tencent/mobileqq/profile/ProfileCardTemplate:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   386: aload 5
    //   388: astore_1
    //   389: getstatic 720	com/tencent/mobileqq/profile/ProfileCardTemplate:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   392: astore 6
    //   394: aload 6
    //   396: astore_1
    //   397: aload 5
    //   399: ifnull -338 -> 61
    //   402: aload 5
    //   404: invokevirtual 746	java/io/InputStream:close	()V
    //   407: aload 6
    //   409: areturn
    //   410: astore_1
    //   411: aload_1
    //   412: invokevirtual 756	java/io/IOException:printStackTrace	()V
    //   415: aload 6
    //   417: areturn
    //   418: aconst_null
    //   419: astore 6
    ...
    //   423: ifnull -151 -> 272
    //   426: aload 6
    //   428: invokevirtual 746	java/io/InputStream:close	()V
    //   431: goto -159 -> 272
    //   434: astore_1
    //   435: aload_1
    //   436: invokevirtual 756	java/io/IOException:printStackTrace	()V
    //   439: goto -167 -> 272
    //   442: astore_1
    //   443: aload_1
    //   444: invokevirtual 756	java/io/IOException:printStackTrace	()V
    //   447: goto -175 -> 272
    //   450: astore 5
    //   452: aconst_null
    //   453: astore_1
    ...
    //   455: ifnull +7 -> 462
    //   458: aload_1
    //   459: invokevirtual 746	java/io/InputStream:close	()V
    //   462: aload 5
    //   464: athrow
    //   465: astore_1
    //   466: aload_1
    //   467: invokevirtual 756	java/io/IOException:printStackTrace	()V
    //   470: goto -8 -> 462
    //   473: astore 5
    //   475: goto -21 -> 454
    //   478: astore 6
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        catch (Exception paramQQAppInterface)
        {
          ...
          localObject2 = VasApngUtil.a(paramQQAppInterface, str1 + "logo.png", "-wzry-card-logo-", a(paramQQAppInterface, str1 + "logo.png", true, true), new int[] { 7 }, "-wzry-card-logo-", null);
