  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    //   130: ifnull +8 -> 138
    //   133: aload 7
    //   135: invokevirtual 103	java/io/BufferedInputStream:close	()V
    //   138: return
    //   139: astore 6
    //   141: ldc 105
    //   143: iconst_1
    //   144: ldc 107
    //   146: aload 6
    //   148: invokestatic 113	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   151: return
    //   152: aload 7
    //   154: astore 6
    //   156: aload 8
    //   158: invokevirtual 119	android/graphics/Bitmap:getHeight	()I
    //   161: istore_2
    //   162: aload 7
    //   164: astore 6
    //   166: aload 8
    //   168: invokevirtual 122	android/graphics/Bitmap:getWidth	()I
    //   171: istore_3
    //   172: aload 7
    //   174: astore 6
    //   176: aload_0
    ...
    //   180: getfield 125	com/tencent/mobileqq/profile/VipProfileCardPreviewActivity:k	I
    //   183: i2f
    //   184: aload_0
    ...
    //   188: getfield 128	com/tencent/mobileqq/profile/VipProfileCardPreviewActivity:j	I
    //   191: i2f
    //   192: fdiv
    //   193: fstore_1
    //   194: aload 7
    ...
    //   202: fmul
    //   203: f2i
    //   204: invokestatic 134	java/lang/Math:min	(II)I
    //   207: istore 4
    //   209: aload 7
    //   211: astore 6
    //   213: iload 4
    ...
    //   221: aload 7
    //   223: astore 6
    //   225: invokestatic 138	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   228: ifeq +476 -> 704
    //   231: aload 7
    //   233: astore 6
    //   235: ldc 105
    //   237: iconst_2
    //   238: new 140	java/lang/StringBuilder
    //   241: dup
    //   242: invokespecial 141	java/lang/StringBuilder:<init>	()V
    //   245: ldc 143
    //   247: invokevirtual 147	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   250: iload 4
    //   252: invokevirtual 150	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   255: ldc 152
    //   257: invokevirtual 147	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   260: iload 5
    //   262: invokevirtual 150	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   265: ldc 154
    //   267: invokevirtual 147	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   270: aload 9
    //   272: getfield 81	android/graphics/BitmapFactory$Options:inSampleSize	I
    //   275: invokevirtual 150	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   278: invokevirtual 158	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   281: invokestatic 162	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   284: goto +420 -> 704
    //   287: aload 8
    //   289: ifnull +99 -> 388
    //   292: aload 7
    //   294: astore 6
    //   296: aload 8
    //   298: invokestatic 167	bhbx:a	(Landroid/graphics/Bitmap;)I
    //   301: istore_2
    //   302: aload 7
    //   304: astore 6
    //   306: new 169	android/graphics/drawable/BitmapDrawable
    //   309: dup
    //   310: aload 10
    //   312: aload 8
    //   314: invokespecial 172	android/graphics/drawable/BitmapDrawable:<init>	(Landroid/content/res/Resources;Landroid/graphics/Bitmap;)V
    //   317: astore 8
    //   319: aload 7
    //   321: astore 6
    //   323: aload 8
    //   325: aload 10
    //   327: invokevirtual 178	android/content/res/Resources:getDisplayMetrics	()Landroid/util/DisplayMetrics;
    //   330: invokevirtual 182	android/graphics/drawable/BitmapDrawable:setTargetDensity	(Landroid/util/DisplayMetrics;)V
    //   333: aload 7
    //   335: astore 6
    //   337: aload_0
    //   338: getfield 19	com/tencent/mobileqq/profile/VipProfileCardPreviewActivity$7:b	Ljava/lang/String;
    //   341: ifnull +34 -> 375
    //   344: aload 7
    //   346: astore 6
    //   348: getstatic 188	com/tencent/common/app/BaseApplicationImpl:sImageCache	Landroid/support/v4/util/MQLruCache;
    //   351: aload_0
    //   352: getfield 19	com/tencent/mobileqq/profile/VipProfileCardPreviewActivity$7:b	Ljava/lang/String;
    //   355: new 190	android/util/Pair
    //   358: dup
    //   359: aload 8
    //   361: invokevirtual 194	android/graphics/drawable/BitmapDrawable:getConstantState	()Landroid/graphics/drawable/Drawable$ConstantState;
    //   364: iload_2
    //   365: invokestatic 200	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   368: invokespecial 203	android/util/Pair:<init>	(Ljava/lang/Object;Ljava/lang/Object;)V
    //   371: invokevirtual 209	android/support/v4/util/MQLruCache:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   374: pop
    //   375: aload 7
    //   377: astore 6
    //   379: aload_0
    ...
    //   383: aload 8
    //   385: putfield 212	com/tencent/mobileqq/profile/VipProfileCardPreviewActivity:jdField_a_of_type_AndroidGraphicsDrawableDrawable	Landroid/graphics/drawable/Drawable;
    //   388: aload 7
    //   390: astore 6
    //   392: aload_0
    ...
    //   396: getfield 212	com/tencent/mobileqq/profile/VipProfileCardPreviewActivity:jdField_a_of_type_AndroidGraphicsDrawableDrawable	Landroid/graphics/drawable/Drawable;
    //   399: ifnull +34 -> 433
    //   402: aload 7
    //   404: astore 6
    //   406: aload_0
    ...
    //   410: getfield 215	com/tencent/mobileqq/profile/VipProfileCardPreviewActivity:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   413: ifnull +20 -> 433
    //   416: aload 7
    //   418: astore 6
    //   420: aload_0
    ...
    //   424: getfield 215	com/tencent/mobileqq/profile/VipProfileCardPreviewActivity:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   427: bipush 27
    //   429: invokevirtual 221	android/os/Handler:sendEmptyMessage	(I)Z
    //   432: pop
    //   433: aload 7
    //   435: ifnull -297 -> 138
    //   438: aload 7
    //   440: invokevirtual 103	java/io/BufferedInputStream:close	()V
    //   443: return
    //   444: astore 6
    //   446: ldc 105
    //   448: iconst_1
    //   449: ldc 107
    //   451: aload 6
    //   453: invokestatic 113	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   456: return
    //   457: aload 7
    //   459: astore 6
    //   461: aload 8
    ...
    //   465: iload 4
    //   467: iload 5
    //   469: invokestatic 225	android/graphics/Bitmap:createBitmap	(Landroid/graphics/Bitmap;IIII)Landroid/graphics/Bitmap;
    //   472: astore 9
    //   474: aload 7
    //   476: astore 6
    //   478: aload 8
    //   480: invokevirtual 228	android/graphics/Bitmap:recycle	()V
    //   483: aload 7
    //   485: astore 6
    //   487: invokestatic 138	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   490: ifeq +15 -> 505
    //   493: aload 7
    //   495: astore 6
    //   497: ldc 105
    //   499: iconst_2
    //   500: ldc 230
    //   502: invokestatic 162	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   505: aload 9
    //   507: astore 8
    //   509: goto -222 -> 287
    //   512: astore 8
    ...
    //   517: aload 7
    //   519: astore 6
    //   521: invokestatic 138	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   524: ifeq +36 -> 560
    //   527: aload 7
    //   529: astore 6
    //   531: ldc 105
    //   533: iconst_2
    //   534: new 140	java/lang/StringBuilder
    //   537: dup
    //   538: invokespecial 141	java/lang/StringBuilder:<init>	()V
    //   541: ldc 232
    //   543: invokevirtual 147	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   546: aload 8
    //   548: invokevirtual 235	java/lang/OutOfMemoryError:getMessage	()Ljava/lang/String;
    //   551: invokevirtual 147	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   554: invokevirtual 158	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   557: invokestatic 162	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   560: aload 7
    //   562: ifnull -424 -> 138
    //   565: aload 7
    //   567: invokevirtual 103	java/io/BufferedInputStream:close	()V
    //   570: return
    //   571: astore 6
    //   573: ldc 105
    //   575: iconst_1
    //   576: ldc 107
    //   578: aload 6
    //   580: invokestatic 113	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   583: return
    //   584: astore 8
    //   586: aconst_null
    //   587: astore 7
    //   589: aload 7
    //   591: astore 6
    //   593: invokestatic 138	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   596: ifeq +36 -> 632
    //   599: aload 7
    //   601: astore 6
    //   603: ldc 105
    //   605: iconst_2
    //   606: new 140	java/lang/StringBuilder
    //   609: dup
    //   610: invokespecial 141	java/lang/StringBuilder:<init>	()V
    //   613: ldc 237
    //   615: invokevirtual 147	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   618: aload 8
    ...
    //   626: invokevirtual 158	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   629: invokestatic 162	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   632: aload 7
    //   634: ifnull -496 -> 138
    //   637: aload 7
    //   639: invokevirtual 103	java/io/BufferedInputStream:close	()V
    //   642: return
    //   643: astore 6
    //   645: ldc 105
    //   647: iconst_1
    //   648: ldc 107
    //   650: aload 6
    //   652: invokestatic 113	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   655: return
    //   656: astore 7
    //   658: aconst_null
    //   659: astore 6
    ...
    //   663: ifnull +8 -> 671
    //   666: aload 6
    //   668: invokevirtual 103	java/io/BufferedInputStream:close	()V
    //   671: aload 7
    //   673: athrow
    //   674: astore 6
    //   676: ldc 105
    ...
    //   679: ldc 107
    //   681: aload 6
    //   683: invokestatic 113	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   686: goto -15 -> 671
    //   689: astore 7
    //   691: goto -30 -> 661
    //   694: astore 8
