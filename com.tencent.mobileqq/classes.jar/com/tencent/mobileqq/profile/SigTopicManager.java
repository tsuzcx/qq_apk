...
public class SigTopicManager
{
  ...
  public CharSequence a(SigTopicConfBean paramSigTopicConfBean)
  {
    ...
    Object localObject = paramSigTopicConfBean.a().jdField_a_of_type_JavaUtilArrayList;
    localSpannableStringBuilder.append(paramSigTopicConfBean.a().jdField_a_of_type_JavaLangString);
    int i = 0;
    while (i < ((ArrayList)localObject).size()) {
      if (TextUtils.isEmpty(((SigTopicConfBean.TopicInfo)((ArrayList)localObject).get(i)).jdField_a_of_type_JavaLangString))
      {
        i += 1;
      }
      else
      {
        ...
        paramSigTopicConfBean = ((SigTopicConfBean.TopicInfo)((ArrayList)localObject).get(i)).jdField_a_of_type_JavaLangString;
