    ...
    for (;;)
    {
      ...
      try
      {
        ...
        while (i < j)
        {
          ...
          if ((??? != null) && (???.get() != null)) {
            ((azzz)???.get()).a(this.jdField_a_of_type_Int, (azzy)this.this$0.jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache.get(Integer.valueOf(this.jdField_a_of_type_Int)), this.b, this.jdField_a_of_type_JavaLangString);
          }
          i += 1;
          continue;
