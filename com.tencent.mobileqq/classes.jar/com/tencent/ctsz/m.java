  ...
  implements INetTransportProvider.INetTransportEventListener
{
  ...
  public m(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_ComTencentMsfmqpsdkbridgeMSFNetTransportProvider.a(this.g, this);
  }
  ...
  private boolean a(Context paramContext)
  {
    ...
    //   3: dup
    //   4: new 221	java/io/File
    //   7: dup
    //   8: aload_1
    //   9: invokevirtual 92	android/content/Context:getApplicationContext	()Landroid/content/Context;
    //   12: invokevirtual 96	android/content/Context:getApplicationInfo	()Landroid/content/pm/ApplicationInfo;
    //   15: getfield 101	android/content/pm/ApplicationInfo:sourceDir	Ljava/lang/String;
    //   18: invokespecial 224	java/io/File:<init>	(Ljava/lang/String;)V
    //   21: invokespecial 227	java/util/jar/JarFile:<init>	(Ljava/io/File;)V
    //   24: invokevirtual 231	java/util/jar/JarFile:entries	()Ljava/util/Enumeration;
    //   27: astore_1
    //   28: new 233	java/util/HashSet
    //   31: dup
    //   32: invokespecial 234	java/util/HashSet:<init>	()V
    //   35: astore_2
    //   36: aload_1
    //   37: invokeinterface 239 1 0
    //   42: ifeq +45 -> 87
    //   45: aload_1
    //   46: invokeinterface 243 1 0
    //   51: checkcast 245	java/util/jar/JarEntry
    //   54: invokevirtual 249	java/util/jar/JarEntry:getName	()Ljava/lang/String;
    //   57: astore_3
    //   58: aload_2
    //   59: aload_3
    //   60: invokeinterface 255 2 0
    //   65: iconst_1
    //   66: if_icmpne +5 -> 71
    //   69: iconst_1
    //   70: ireturn
    //   71: aload_2
    //   72: aload_3
    //   73: invokeinterface 258 2 0
    //   78: pop
    //   79: goto -43 -> 36
    //   82: astore_1
    //   83: aload_1
    //   84: invokevirtual 261	java/lang/Exception:printStackTrace	()V
    //   87: iconst_0
    //   88: ireturn
    //   89: astore_1
    //   90: aload_1
    //   91: invokevirtual 262	java/lang/OutOfMemoryError:printStackTrace	()V
    //   94: goto -7 -> 87
  ...
  private void b()
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      localObject3 = this.jdField_a_of_type_ComTencentMsfmqpsdkbridgeMSFNetTransportProvider.a(this.g);
      localObject1 = localObject2;
      if (localObject3 != null) {
        localObject1 = ((INetTransportProvider.INetTransportCodec)localObject3).a(localObject2);
      }
      this.jdField_a_of_type_ComTencentMsfmqpsdkbridgeMSFNetTransportProvider.a(localObject1);
      return;
    }
  }
  ...
  public void a(Object paramObject1, Object paramObject2)
  {
    ...
    do
    {
      ...
      {
        return;
        paramObject1 = this.jdField_a_of_type_ComTencentMsfmqpsdkbridgeMSFNetTransportProvider.a("sig_check");
      } while (paramObject1 == null);
      paramObject1 = (byte[])paramObject1.b(paramObject2);
    } while (paramObject1 == null);
