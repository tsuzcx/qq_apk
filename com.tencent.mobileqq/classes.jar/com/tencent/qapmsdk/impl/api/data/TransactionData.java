...
public class TransactionData
{
  ...
  public String toString()
  {
    ...
    localStringBuilder.append("url:" + this.url).append(" carrier:" + this.carrier).append(" time:" + this.time).append(" statusCode:" + this.statusCode).append(" errorCode:" + this.errorCode).append(" byteSent:" + this.byteSent).append(" bytesRecieved:" + this.bytesRecieved).append(" appData:" + this.appData).append(" formattedUrlParams:" + this.formattedUrlParams).append(" requestmethodtype:" + this.requestmethodtype).append(" cdnHeaderName :" + this.cdnHeaderName).append("contentType : " + this.contentType);
