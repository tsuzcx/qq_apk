...
public class QAPMHttpResponseEntityImpl
  implements QAPMStreamCompleteListener, HttpEntity
{
  private static final String TAG = "QAPM_Impl_QAPMHttpResponseEntityImpl";
  ...
  public QAPMHttpResponseEntityImpl(HttpResponse paramHttpResponse, QAPMTransactionState paramQAPMTransactionState, long paramLong)
  {
  ...
  private void addTransactionAndErrorData(QAPMTransactionState paramQAPMTransactionState)
  {
    // Byte code:
    //   0: aload_1
    //   1: invokevirtual 52	com/tencent/qapmsdk/impl/instrumentation/QAPMTransactionState:end	()Lcom/tencent/qapmsdk/impl/api/data/TransactionData;
    //   4: astore_3
    //   5: aload_3
    //   6: ifnonnull +24 -> 30
    //   9: getstatic 58	com/tencent/qapmsdk/common/logger/Logger:INSTANCE	Lcom/tencent/qapmsdk/common/logger/Logger;
    //   12: iconst_2
    ...
    //   23: ldc 62
    //   25: aastore
    //   26: invokevirtual 66	com/tencent/qapmsdk/common/logger/Logger:d	([Ljava/lang/String;)V
    //   29: return
    //   30: aload_1
    //   31: invokevirtual 70	com/tencent/qapmsdk/impl/instrumentation/QAPMTransactionState:isError	()Z
    //   34: ifeq +144 -> 178
    //   37: new 72	java/lang/StringBuilder
    //   40: dup
    //   41: invokespecial 73	java/lang/StringBuilder:<init>	()V
    //   44: astore_2
    //   45: aload_0
    //   46: invokevirtual 77	com/tencent/qapmsdk/impl/instrumentation/httpclient/QAPMHttpResponseEntityImpl:getContent	()Ljava/io/InputStream;
    //   49: astore 4
    //   51: aload 4
    //   53: instanceof 79
    //   56: ifeq +16 -> 72
    ...
    //   71: pop
    //   72: aload_0
    //   73: getfield 29	com/tencent/qapmsdk/impl/instrumentation/httpclient/QAPMHttpResponseEntityImpl:response	Lorg/apache/http/HttpResponse;
    ...
    //   108: astore_2
    //   109: getstatic 58	com/tencent/qapmsdk/common/logger/Logger:INSTANCE	Lcom/tencent/qapmsdk/common/logger/Logger;
    //   112: iconst_3
    //   113: anewarray 60	java/lang/String
    //   116: dup
    //   117: iconst_0
    //   118: ldc 12
    //   120: aastore
    ...
    //   128: aload_2
    //   129: aastore
    //   130: invokevirtual 66	com/tencent/qapmsdk/common/logger/Logger:d	([Ljava/lang/String;)V
    //   133: aload_3
    //   134: aload_2
    ...
    //   138: return
    //   139: astore_1
    //   140: getstatic 58	com/tencent/qapmsdk/common/logger/Logger:INSTANCE	Lcom/tencent/qapmsdk/common/logger/Logger;
    //   143: ldc 12
    //   145: ldc 125
    //   147: aload_1
    ...
    //   151: return
    //   152: astore_2
    //   153: getstatic 58	com/tencent/qapmsdk/common/logger/Logger:INSTANCE	Lcom/tencent/qapmsdk/common/logger/Logger;
    //   156: iconst_2
    //   157: anewarray 60	java/lang/String
    //   160: dup
    //   161: iconst_0
    //   162: ldc 12
    //   164: aastore
    ...
    //   0	183	0	this	QAPMHttpResponseEntityImpl
  ...
  public InputStream getContent()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          Header localHeader = ((AbstractHttpMessage)this.impl).getLastHeader("Transfer-Encoding");
          if ((localHeader != null) && ("chunked".equalsIgnoreCase(localHeader.getValue())))
          {
            bool1 = false;
            break label168;
            this.contentStream = new QAPMCountingInputStream(this.impl.getContent(), bool1);
        ...
        else
        {
          ...
          boolean bool3 = this.impl.isChunked();
          bool1 = bool2;
          if (!bool3) {
            continue;
          }
 ...
 * Qualified Name:     com.tencent.qapmsdk.impl.instrumentation.httpclient.QAPMHttpResponseEntityImpl
