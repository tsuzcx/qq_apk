  ...
  public void afterHookedMethod(MethodHookParam paramMethodHookParam)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        try
        {
          localObject1 = getAppStack().toString();
          ...
          synchronized (this.map)
          {
            ...
            {
              writeCommonLog(new String[] { "wf_rl|", localWifiLockEntity.uuid, "|", localObject1 });
    ...
    ((WifiMonitor.WifiLockEntity)???).createStack = ((String)localObject1);
    if ((paramMethodHookParam.args != null) && (paramMethodHookParam.args.length == 2)) {}
    for (((WifiMonitor.WifiLockEntity)???).tag = ((String)paramMethodHookParam.args[1]);; ((WifiMonitor.WifiLockEntity)???).tag = ((String)paramMethodHookParam.args[0])) {
      do
      {
        localObject1 = new WeakReference((WifiManager.WifiLock)paramMethodHookParam.result);
        this.map.put(localObject1, ???);
