  ...
  implements HookMethodCallback
{
  ...
  private int getGpsState()
  {
    ...
    {
      Logger.INSTANCE.exception("QAPM_battery_GPS", localThrowable);
    }
    return -1;
  }
  ...
  public void onGpsScan(String paramString, Object[] paramArrayOfObject)
  {
    ...
    Object localObject = BatteryMonitor.batteryReportListener;
    if ((localObject != null) && (this.sosoClassName == null)) {
      this.sosoClassName = ((IBatteryListener)localObject).getSosoClassName();
    }
    int i;
    label94:
    label122:
  ...
  public void onOtherProcReport(Bundle paramBundle)
  {
    ...
    if ((i == 1) || (i == 2))
    {
      Logger.INSTANCE.d(new String[] { "QAPM_battery_GPS", "GPS.onOtherProcReport:action=", i + ", type=", paramBundle.getString("key_type"), ", stack=", paramBundle.getString("key_stack") });
      if (this.isRunning)
      {
