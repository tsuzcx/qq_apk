  ...
  implements Handler.Callback, HookMethodCallback
{
  ...
  public void onHook(String paramString, Object paramObject1, Object[] paramArrayOfObject, Object paramObject2)
  {
      ...
      for (;;)
      {
        synchronized (this.map)
        {
          if ("newWakeLock".equals(paramString))
          {
            ...
            writeCommonLog(new String[] { paramString, "|", paramObject1.uuid, "|", String.valueOf(paramObject1.levelAndFlags), "|", paramObject1.tag, "|", paramObject1.createStack });
            return;
          }
        }
        ...
        while (localIterator.hasNext())
        {
          ...
          if (((WeakReference)localObject2).get() == paramObject1)
          {
            ...
            if (paramArrayOfObject.length == 0)
            {
              ...
              paramString = ((WakeLockMonitor.WakeLockEntity)localObject3).onAcquire((PowerManager.WakeLock)paramObject1, paramObject2, localObject1);
            ...
            for (;;)
            {
              ...
              onUsageAlarm(4, 0, 0, "Acquire " + ((WakeLockMonitor.WakeLockEntity)localObject3).tag + " too frequently", HighFrequencyDetector.getDescription((List)paramString.second));
              break;
    ...
    {
      localObject2 = (WeakReference)localIterator.next();
      paramString = (WakeLockMonitor.WakeLockEntity)this.map.get(localObject2);
      if (((WeakReference)localObject2).get() == paramObject1)
      {
        if (paramArrayOfObject == null) {
          break label1175;
