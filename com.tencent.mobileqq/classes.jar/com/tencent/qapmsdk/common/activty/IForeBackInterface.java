...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/qapmsdk/common/activty/IForeBackInterface;", "", "onBackground", "", "activity", "Landroid/app/Activity;", "onCreate", "onDestroy", "onForeground", "onResume", "onStop", "common_release"}, k=1, mv={1, 1, 15})
public abstract interface IForeBackInterface
{
  ...
  public abstract void onResume(@NotNull Activity paramActivity);
  
  public abstract void onStop(@NotNull Activity paramActivity);
}
