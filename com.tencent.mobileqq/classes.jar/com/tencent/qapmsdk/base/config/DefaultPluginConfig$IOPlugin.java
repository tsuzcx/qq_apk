  ...
  extends DefaultPluginConfig
{
  ...
  public DefaultPluginConfig$IOPlugin(int paramInt1, int paramInt2, int paramInt3, int paramInt4, float paramFloat, int paramInt5, @NotNull String paramString1, @NotNull String paramString2)
  {
 ...
 * Qualified Name:     com.tencent.qapmsdk.base.config.DefaultPluginConfig.IOPlugin
