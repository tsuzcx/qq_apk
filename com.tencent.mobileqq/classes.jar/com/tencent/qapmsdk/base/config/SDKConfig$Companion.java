...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/qapmsdk/base/config/SDKConfig$Companion;", "", "()V", "MAX_AUSTERITY_REPORT_NUM", "", "getMAX_AUSTERITY_REPORT_NUM", "()I", "setMAX_AUSTERITY_REPORT_NUM", "(I)V", "MAX_LOOSE_REPORT_NUM", "getMAX_LOOSE_REPORT_NUM", "setMAX_LOOSE_REPORT_NUM", "RES_TYPE", "SDK_VER", "", "USER_SAMPLE_RATIO", "", "getUSER_SAMPLE_RATIO", "()F", "setUSER_SAMPLE_RATIO", "(F)V", "VER_TYPE", "getVER_TYPE", "setVER_TYPE", "qapmbase_release"}, k=1, mv={1, 1, 15})
