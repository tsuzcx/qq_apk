...
public final class DefaultPluginConfig$HttpPlugin
  extends DefaultPluginConfig
{
  public DefaultPluginConfig$HttpPlugin()
  {
    this(0, 0, 0, 0, 0.0F, 0, null, null, 255, null);
  }
  
  public DefaultPluginConfig$HttpPlugin(int paramInt1, int paramInt2, int paramInt3, int paramInt4, float paramFloat, int paramInt5, @NotNull String paramString1, @NotNull String paramString2)
  {
 ...
 * Qualified Name:     com.tencent.qapmsdk.base.config.DefaultPluginConfig.HttpPlugin
