...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"com/tencent/qapmsdk/base/reporter/ReporterMachine$reportOnce$2", "Lcom/tencent/qapmsdk/common/reporter/IReporter$ReportResultCallback;", "onFailure", "", "errorCode", "", "errorMsg", "", "dbId", "onSuccess", "successCode", "qapmbase_release"}, k=1, mv={1, 1, 15})
public final class ReporterMachine$reportOnce$2
  implements IReporter.ReportResultCallback
{
  ReporterMachine$reportOnce$2(IReporter.ReportResultCallback paramReportResultCallback) {}
 ...
 * Qualified Name:     com.tencent.qapmsdk.base.reporter.ReporterMachine.reportOnce.2
