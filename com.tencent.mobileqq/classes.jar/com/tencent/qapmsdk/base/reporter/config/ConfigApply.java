  ...
  extends QAPMUpload
{
  ...
  {
    ConfigApply.LoadConfigMode localLoadConfigMode = ConfigApply.LoadConfigMode.NO_AUTHORITY;
    ...
    for (;;)
    {
      ...
      catch (JSONException localJSONException)
      {
        ...
        try
        {
          ...
          if (((JSONObject)localObject8).getInt("status") == 1000)
          {
            ...
            localObject7 = localJSONException;
            localObject5 = localJSONException;
            localObject1 = ConfigApply.LoadConfigMode.FROM_SERVICE;
      ...
      catch (Throwable localThrowable1)
      {
        for (;;)
        {
          ...
          localObject2 = ConfigApply.LoadConfigMode.FROM_LOCAL;
          continue;
