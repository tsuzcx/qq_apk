...
public class z
{
  ...
  public static String a(File paramFile, int paramInt, boolean paramBoolean)
  {
    ...
    //   122: astore 4
    //   124: aload_3
    //   125: invokevirtual 340	java/io/BufferedReader:close	()V
    //   128: aload 4
    //   130: areturn
    //   131: astore_0
    //   132: aload_0
    ...
    //   170: ifnull -152 -> 18
    //   173: aload_3
    //   174: invokevirtual 340	java/io/BufferedReader:close	()V
    //   177: aconst_null
    //   178: areturn
    //   179: astore_0
    //   180: aload_0
  ...
  public static void a(String paramString1, String paramString2, int paramInt)
  {
    ...
    //   81: astore_3
    //   82: aload 6
    //   84: invokevirtual 567	java/io/File:length	()J
    //   87: iload_2
    //   88: i2l
    //   89: lcmp
    //   90: iflt +61 -> 151
    ...
    //   96: aload 5
    //   98: astore_3
    //   99: new 569	java/io/FileOutputStream
    //   102: dup
    //   103: aload 6
    //   105: iconst_0
    //   106: invokespecial 572	java/io/FileOutputStream:<init>	(Ljava/io/File;Z)V
    //   109: astore_0
    //   110: aload_0
    //   111: astore 4
    //   113: aload_0
    ...
    //   116: aload_1
    //   117: ldc_w 574
    //   120: invokevirtual 578	java/lang/String:getBytes	(Ljava/lang/String;)[B
    //   123: invokevirtual 582	java/io/FileOutputStream:write	([B)V
    //   126: aload_0
    //   127: astore 4
    //   129: aload_0
    //   130: astore_3
    //   131: aload_0
    //   132: invokevirtual 585	java/io/FileOutputStream:flush	()V
    //   135: aload_0
    //   136: invokevirtual 586	java/io/FileOutputStream:close	()V
    //   139: ldc_w 588
    //   142: iconst_0
    //   143: anewarray 4	java/lang/Object
    //   146: invokestatic 554	com/tencent/bugly/proguard/x:c	(Ljava/lang/String;[Ljava/lang/Object;)Z
    //   149: pop
    //   150: return
    //   151: aload_0
    //   152: astore 4
    //   154: aload 5
    //   156: astore_3
    //   157: new 569	java/io/FileOutputStream
    //   160: dup
    //   161: aload 6
    //   163: iconst_1
    //   164: invokespecial 572	java/io/FileOutputStream:<init>	(Ljava/io/File;Z)V
    //   167: astore_0
    //   168: goto -58 -> 110
    //   171: astore_0
    //   172: aload 4
    ...
    //   191: ifnull -52 -> 139
    //   194: aload 4
    //   196: invokevirtual 586	java/io/FileOutputStream:close	()V
    //   199: goto -60 -> 139
    //   202: astore_0
    //   203: aload_0
    ...
    //   219: ifnull +7 -> 226
    //   222: aload_3
    //   223: invokevirtual 586	java/io/FileOutputStream:close	()V
    //   226: aload_0
    //   227: athrow
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  public static boolean a(File paramFile1, File paramFile2, int paramInt)
  {
    ...
    //   10: invokestatic 554	com/tencent/bugly/proguard/x:c	(Ljava/lang/String;[Ljava/lang/Object;)Z
    //   13: pop
    //   14: aload_0
    //   15: ifnull +15 -> 30
    //   18: aload_1
    ...
    //   22: aload_0
    //   23: aload_1
    //   24: invokevirtual 625	java/io/File:equals	(Ljava/lang/Object;)Z
    //   27: ifeq +16 -> 43
    //   30: ldc_w 627
    //   33: iconst_0
    ...
    //   69: ireturn
    //   70: aload_1
    //   71: invokevirtual 559	java/io/File:getParentFile	()Ljava/io/File;
    //   74: ifnull +21 -> 95
    //   77: aload_1
    //   78: invokevirtual 559	java/io/File:getParentFile	()Ljava/io/File;
    //   81: invokevirtual 36	java/io/File:exists	()Z
    //   84: ifne +11 -> 95
    //   87: aload_1
    //   88: invokevirtual 559	java/io/File:getParentFile	()Ljava/io/File;
    //   91: invokevirtual 562	java/io/File:mkdirs	()Z
    //   94: pop
    //   95: aload_1
    //   96: invokevirtual 36	java/io/File:exists	()Z
    //   99: ifne +8 -> 107
    //   102: aload_1
    //   103: invokevirtual 565	java/io/File:createNewFile	()Z
    //   106: pop
    //   107: aload_1
    ...
    //   129: astore_3
    //   130: new 631	java/util/zip/ZipOutputStream
    //   133: dup
    //   134: new 633	java/io/BufferedOutputStream
    //   137: dup
    //   138: new 569	java/io/FileOutputStream
    //   141: dup
    //   142: aload_1
    //   143: invokespecial 634	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   146: invokespecial 637	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   149: invokespecial 638	java/util/zip/ZipOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   152: astore 4
    //   154: aload 4
    //   156: bipush 8
    //   158: invokevirtual 641	java/util/zip/ZipOutputStream:setMethod	(I)V
    //   161: aload 4
    //   163: new 643	java/util/zip/ZipEntry
    //   166: dup
    //   167: aload_0
    //   168: invokevirtual 644	java/io/File:getName	()Ljava/lang/String;
    //   171: invokespecial 645	java/util/zip/ZipEntry:<init>	(Ljava/lang/String;)V
    //   174: invokevirtual 649	java/util/zip/ZipOutputStream:putNextEntry	(Ljava/util/zip/ZipEntry;)V
    //   177: sipush 5000
    //   180: newarray byte
    //   182: astore_0
    //   183: aload_3
    //   184: aload_0
    //   185: invokevirtual 653	java/io/FileInputStream:read	([B)I
    //   188: istore_2
    //   189: iload_2
    //   190: ifle +79 -> 269
    //   193: aload 4
    ...
    //   196: iconst_0
    //   197: iload_2
    //   198: invokevirtual 655	java/util/zip/ZipOutputStream:write	([BII)V
    //   201: goto -18 -> 183
    //   204: astore 5
    //   206: aload_3
    //   207: astore_1
    ...
    //   226: ifnull +7 -> 233
    //   229: aload_1
    //   230: invokevirtual 656	java/io/FileInputStream:close	()V
    //   233: aload_0
    //   234: ifnull +7 -> 241
    //   237: aload_0
    //   238: invokevirtual 657	java/util/zip/ZipOutputStream:close	()V
    //   241: ldc_w 659
    //   244: iconst_0
    //   245: anewarray 4	java/lang/Object
    //   248: invokestatic 554	com/tencent/bugly/proguard/x:c	(Ljava/lang/String;[Ljava/lang/Object;)Z
    //   251: pop
    //   252: iconst_0
    //   253: ireturn
    //   254: astore_3
    ...
    //   266: goto -159 -> 107
    //   269: aload 4
    //   271: invokevirtual 660	java/util/zip/ZipOutputStream:flush	()V
    //   274: aload 4
    //   276: invokevirtual 663	java/util/zip/ZipOutputStream:closeEntry	()V
    //   279: aload_3
    //   280: invokevirtual 656	java/io/FileInputStream:close	()V
    //   283: aload 4
    //   285: invokevirtual 657	java/util/zip/ZipOutputStream:close	()V
    //   288: ldc_w 659
    //   291: iconst_0
    //   292: anewarray 4	java/lang/Object
    //   295: invokestatic 554	com/tencent/bugly/proguard/x:c	(Ljava/lang/String;[Ljava/lang/Object;)Z
    //   298: pop
    //   299: iconst_1
    //   300: ireturn
    //   301: astore_0
    ...
    //   339: ifnull +7 -> 346
    //   342: aload_3
    //   343: invokevirtual 656	java/io/FileInputStream:close	()V
    //   346: aload_0
    //   347: ifnull +7 -> 354
    //   350: aload_0
    //   351: invokevirtual 657	java/util/zip/ZipOutputStream:close	()V
    //   354: ldc_w 659
    //   357: iconst_0
    //   358: anewarray 4	java/lang/Object
    //   361: invokestatic 554	com/tencent/bugly/proguard/x:c	(Ljava/lang/String;[Ljava/lang/Object;)Z
    //   364: pop
    //   365: aload_1
    //   366: athrow
    //   367: astore_3
  ...
  public static byte[] a(File paramFile, String paramString1, String paramString2)
  {
    ...
    //   47: astore 5
    //   49: new 631	java/util/zip/ZipOutputStream
    //   52: dup
    //   53: aload 5
    //   55: invokespecial 638	java/util/zip/ZipOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   58: astore_1
    //   59: aload_1
    //   60: astore_0
    //   61: aload_1
    //   62: bipush 8
    //   64: invokevirtual 641	java/util/zip/ZipOutputStream:setMethod	(I)V
    //   67: aload_1
    //   68: astore_0
    //   69: aload_1
    //   70: new 643	java/util/zip/ZipEntry
    //   73: dup
    //   74: aload_2
    //   75: invokespecial 645	java/util/zip/ZipEntry:<init>	(Ljava/lang/String;)V
    //   78: invokevirtual 649	java/util/zip/ZipOutputStream:putNextEntry	(Ljava/util/zip/ZipEntry;)V
    //   81: aload_1
    //   82: astore_0
    //   83: sipush 1024
    //   86: newarray byte
    ...
    //   106: iconst_0
    //   107: iload_3
    //   108: invokevirtual 655	java/util/zip/ZipOutputStream:write	([BII)V
    //   111: goto -22 -> 89
    //   114: astore_2
    //   115: aload_1
    //   116: astore_0
    ...
    //   131: ifnull +7 -> 138
    //   134: aload_1
    //   135: invokevirtual 657	java/util/zip/ZipOutputStream:close	()V
    //   138: ldc_w 659
    //   141: iconst_0
    //   142: anewarray 4	java/lang/Object
    //   145: invokestatic 554	com/tencent/bugly/proguard/x:c	(Ljava/lang/String;[Ljava/lang/Object;)Z
    //   148: pop
    //   149: aconst_null
    //   150: areturn
    //   151: aload_1
    //   152: astore_0
    //   153: aload_1
    //   154: invokevirtual 663	java/util/zip/ZipOutputStream:closeEntry	()V
    //   157: aload_1
    //   158: astore_0
    //   159: aload_1
    //   160: invokevirtual 660	java/util/zip/ZipOutputStream:flush	()V
    //   163: aload_1
    //   164: astore_0
    //   165: aload_1
    //   166: invokevirtual 708	java/util/zip/ZipOutputStream:finish	()V
    //   169: aload_1
    //   170: astore_0
    //   171: aload 5
    //   173: invokevirtual 711	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   176: astore_2
    //   177: aload_1
    //   178: invokevirtual 657	java/util/zip/ZipOutputStream:close	()V
    //   181: ldc_w 659
    //   184: iconst_0
    //   185: anewarray 4	java/lang/Object
    //   188: invokestatic 554	com/tencent/bugly/proguard/x:c	(Ljava/lang/String;[Ljava/lang/Object;)Z
    //   191: pop
    //   192: aload_2
    //   193: areturn
    //   194: astore_0
    ...
    //   228: invokestatic 554	com/tencent/bugly/proguard/x:c	(Ljava/lang/String;[Ljava/lang/Object;)Z
    //   231: pop
    //   232: aload_1
    //   233: athrow
    //   234: astore_0
  ...
  private static ArrayList<String> c(Context paramContext, String paramString)
  {
    ...
    //   1: astore_2
    //   2: aload_0
    //   3: invokestatic 828	com/tencent/bugly/crashreport/common/info/AppInfo:f	(Landroid/content/Context;)Z
    //   6: ifeq +24 -> 30
    //   9: new 468	java/util/ArrayList
    //   12: dup
    //   13: iconst_1
    ...
    //   19: ldc_w 830
    //   22: aastore
    //   23: invokestatic 836	java/util/Arrays:asList	([Ljava/lang/Object;)Ljava/util/List;
    //   26: invokespecial 839	java/util/ArrayList:<init>	(Ljava/util/Collection;)V
    //   29: areturn
    //   30: new 468	java/util/ArrayList
    //   33: dup
    //   34: invokespecial 469	java/util/ArrayList:<init>	()V
    //   37: astore_3
    //   38: ldc_w 841
    //   41: astore_0
    //   42: new 32	java/io/File
    //   45: dup
    //   46: ldc_w 841
    //   49: invokespecial 555	java/io/File:<init>	(Ljava/lang/String;)V
    //   52: invokevirtual 36	java/io/File:exists	()Z
    //   55: ifeq +295 -> 350
    //   58: new 32	java/io/File
    //   61: dup
    //   62: ldc_w 841
    //   65: invokespecial 555	java/io/File:<init>	(Ljava/lang/String;)V
    //   68: invokevirtual 844	java/io/File:canExecute	()Z
    //   71: ifne +6 -> 77
    //   74: goto +276 -> 350
    //   77: new 468	java/util/ArrayList
    //   80: dup
    //   81: iconst_2
    //   82: anewarray 176	java/lang/String
    //   85: dup
    //   86: iconst_0
    //   87: aload_0
    //   88: aastore
    ...
    //   91: ldc_w 846
    //   94: aastore
    //   95: invokestatic 836	java/util/Arrays:asList	([Ljava/lang/Object;)Ljava/util/List;
    //   98: invokespecial 839	java/util/ArrayList:<init>	(Ljava/util/Collection;)V
    //   101: astore_0
    //   102: aload_0
    //   103: aload_1
    //   104: invokeinterface 488 2 0
    //   109: pop
    //   110: invokestatic 193	java/lang/Runtime:getRuntime	()Ljava/lang/Runtime;
    //   113: aload_0
    //   114: iconst_3
    //   115: anewarray 176	java/lang/String
    //   118: invokeinterface 850 2 0
    //   123: checkcast 852	[Ljava/lang/String;
    //   126: invokevirtual 197	java/lang/Runtime:exec	([Ljava/lang/String;)Ljava/lang/Process;
    //   129: astore_0
    //   130: new 41	java/io/BufferedReader
    //   133: dup
    //   134: new 43	java/io/InputStreamReader
    //   137: dup
    //   138: aload_0
    ...
    //   145: invokespecial 56	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   148: astore_1
    //   149: aload_1
    //   150: invokevirtual 209	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   153: astore 4
    //   155: aload 4
    //   157: ifnull +45 -> 202
    //   160: aload_3
    //   161: aload 4
    //   163: invokevirtual 518	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   166: pop
    //   167: goto -18 -> 149
    //   170: astore_2
    //   171: aconst_null
    //   172: astore_0
    //   173: aload_2
    //   174: invokestatic 61	com/tencent/bugly/proguard/x:a	(Ljava/lang/Throwable;)Z
    //   177: ifne +7 -> 184
    //   180: aload_2
    //   181: invokevirtual 121	java/lang/Throwable:printStackTrace	()V
    //   184: aload_1
    //   185: ifnull +7 -> 192
    //   188: aload_1
    //   189: invokevirtual 340	java/io/BufferedReader:close	()V
    //   192: aload_0
    //   193: ifnull +7 -> 200
    //   196: aload_0
    //   197: invokevirtual 340	java/io/BufferedReader:close	()V
    //   200: aconst_null
    //   201: areturn
    //   202: new 41	java/io/BufferedReader
    //   205: dup
    //   206: new 43	java/io/InputStreamReader
    //   209: dup
    //   210: aload_0
    //   211: invokevirtual 247	java/lang/Process:getErrorStream	()Ljava/io/InputStream;
    //   214: invokespecial 206	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   217: invokespecial 56	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   220: astore_0
    //   221: aload_0
    //   222: invokevirtual 209	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   225: astore_2
    //   226: aload_2
    //   227: ifnull +16 -> 243
    //   230: aload_3
    //   231: aload_2
    //   232: invokevirtual 518	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   235: pop
    //   236: goto -15 -> 221
    //   239: astore_2
    //   240: goto -67 -> 173
    //   243: aload_1
    //   244: invokevirtual 340	java/io/BufferedReader:close	()V
    //   247: aload_0
    //   248: invokevirtual 340	java/io/BufferedReader:close	()V
    //   251: aload_3
    //   252: areturn
    //   253: astore_1
    //   254: aload_1
    //   255: invokevirtual 248	java/io/IOException:printStackTrace	()V
    //   258: goto -11 -> 247
    //   261: astore_0
    //   262: aload_0
    //   263: invokevirtual 248	java/io/IOException:printStackTrace	()V
    //   266: goto -15 -> 251
    //   269: astore_1
    //   270: aload_1
    //   271: invokevirtual 248	java/io/IOException:printStackTrace	()V
    //   274: goto -82 -> 192
    //   277: astore_0
    //   278: aload_0
    //   279: invokevirtual 248	java/io/IOException:printStackTrace	()V
    //   282: goto -82 -> 200
    //   285: astore_0
    //   286: aconst_null
    //   287: astore_1
    ...
    //   289: ifnull +7 -> 296
    //   292: aload_1
    //   293: invokevirtual 340	java/io/BufferedReader:close	()V
    //   296: aload_2
    //   297: ifnull +7 -> 304
    //   300: aload_2
    //   301: invokevirtual 340	java/io/BufferedReader:close	()V
    //   304: aload_0
    //   305: athrow
    //   306: astore_1
    //   307: aload_1
    //   308: invokevirtual 248	java/io/IOException:printStackTrace	()V
    //   311: goto -15 -> 296
    //   314: astore_1
    //   315: aload_1
    //   316: invokevirtual 248	java/io/IOException:printStackTrace	()V
    //   319: goto -15 -> 304
    //   322: astore_0
    //   323: goto -35 -> 288
    //   326: astore_3
