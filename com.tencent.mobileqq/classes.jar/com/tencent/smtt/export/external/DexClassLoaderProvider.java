  ...
  extends DexClassLoader
{
      ...
      public void run()
      {
        for (boolean bool1 = true;; bool1 = false)
        {
          try
          {
            ...
            if ((DexClassLoaderProvider.mForceLoadDexFlag) && ("tbs_jars_fusion_dex.jar".equals(paramString1)) && (DexClassLoaderProvider.mService != null))
            {
  ...
  protected Package getPackage(String paramString)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: invokespecial 170	com/tencent/smtt/export/external/DexClassLoaderProvider:useSelfClassloader	()Z
    //   6: ifeq +13 -> 19
    //   9: aload_0
    //   10: aload_1
    //   11: invokespecial 210	dalvik/system/DexClassLoader:getPackage	(Ljava/lang/String;)Ljava/lang/Package;
    //   14: astore_1
    //   15: aload_0
    //   16: monitorexit
    //   17: aload_1
    ...
    //   23: aload_1
    //   24: invokevirtual 211	com/tencent/smtt/export/external/DexClassLoaderProvider$SpeedyDexClassLoader:getPackage	(Ljava/lang/String;)Ljava/lang/Package;
    //   27: astore_1
    //   28: goto -13 -> 15
    //   31: astore_1
    //   32: aload_0
