...
public class DebugTbsPlugin
{
  ...
  @SuppressLint({"NewApi"})
  public static void downloadDebugTbsPlugin(String paramString, DebugTbsPlugin.DebugDownloadStatusListener paramDebugDownloadStatusListener)
  {
    new DebugTbsPlugin.2(paramString, paramDebugDownloadStatusListener).start();
  }
  ...
  public void downloadPlugin(String paramString, WebView paramWebView, Context paramContext)
  {
    ...
    downloadDebugTbsPlugin((String)localObject, new DebugTbsPlugin.1(this, paramWebView, paramContext, localRelativeLayout, paramString, localTextView));
  }
  ...
  public void showPluginView(String paramString, WebView paramWebView, Context paramContext, Looper paramLooper)
  {
    ...
    try
    {
      localObject4 = AppUtil.getSignatureFromApk(paramContext, true, new File((String)localObject2));
