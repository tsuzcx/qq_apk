...
public class HttpUtil
{
  ...
  private static String httpPost(HttpURLConnection paramHttpURLConnection, HttpResponseListener paramHttpResponseListener, boolean paramBoolean)
  {
    ...
    //   60: astore_0
    //   61: new 65	java/io/ByteArrayOutputStream
    //   64: dup
    //   65: invokespecial 66	java/io/ByteArrayOutputStream:<init>	()V
    //   68: astore_1
    //   69: sipush 128
    //   72: newarray byte
    //   74: astore 4
    ...
    //   91: iconst_0
    //   92: iload_3
    //   93: invokevirtual 76	java/io/ByteArrayOutputStream:write	([BII)V
    //   96: goto -20 -> 76
    //   99: astore 5
    //   101: aload_1
    //   102: astore 4
    ...
    //   111: astore 4
    //   113: aload 4
    //   115: invokevirtual 79	java/lang/Throwable:printStackTrace	()V
    //   118: aload_1
    //   119: invokestatic 81	com/tencent/smtt/utils/HttpUtil:closeStream	(Ljava/io/Closeable;)V
    //   122: aload_0
    //   123: invokestatic 81	com/tencent/smtt/utils/HttpUtil:closeStream	(Ljava/io/Closeable;)V
    //   126: aconst_null
    //   127: areturn
    //   128: aload_0
    //   129: ifnull +41 -> 170
    //   132: aload_0
    //   133: ldc 83
    //   135: invokevirtual 58	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   138: ifeq +32 -> 170
    //   141: new 85	java/util/zip/InflaterInputStream
    //   144: dup
    //   145: aload_1
    //   146: new 87	java/util/zip/Inflater
    //   149: dup
    //   150: iconst_1
    //   151: invokespecial 90	java/util/zip/Inflater:<init>	(Z)V
    //   154: invokespecial 93	java/util/zip/InflaterInputStream:<init>	(Ljava/io/InputStream;Ljava/util/zip/Inflater;)V
    //   157: astore_0
    //   158: goto -97 -> 61
    //   161: astore 4
    //   163: aconst_null
    ...
    //   175: iload_2
    //   176: ifeq +29 -> 205
    //   179: new 54	java/lang/String
    //   182: dup
    //   183: aload_1
    //   184: invokevirtual 97	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   187: ldc 11
    //   189: invokespecial 100	java/lang/String:<init>	([BLjava/lang/String;)V
    //   192: astore 4
    //   194: aload_0
    //   195: invokestatic 81	com/tencent/smtt/utils/HttpUtil:closeStream	(Ljava/io/Closeable;)V
    //   198: aload_1
    //   199: invokestatic 81	com/tencent/smtt/utils/HttpUtil:closeStream	(Ljava/io/Closeable;)V
    //   202: aload 4
    //   204: areturn
    //   205: new 54	java/lang/String
    //   208: dup
    //   209: invokestatic 106	com/tencent/smtt/utils/Post3DESEncryption:getInstance	()Lcom/tencent/smtt/utils/Post3DESEncryption;
    //   212: aload_1
    //   213: invokevirtual 97	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   216: invokevirtual 110	com/tencent/smtt/utils/Post3DESEncryption:DesDecrypt	([B)[B
    //   219: invokespecial 113	java/lang/String:<init>	([B)V
    //   222: astore 4
    //   224: goto -30 -> 194
    //   227: astore_1
    //   228: aconst_null
    //   229: astore_0
    //   230: aload_0
    //   231: invokestatic 81	com/tencent/smtt/utils/HttpUtil:closeStream	(Ljava/io/Closeable;)V
    //   234: aload 4
    //   236: invokestatic 81	com/tencent/smtt/utils/HttpUtil:closeStream	(Ljava/io/Closeable;)V
    //   239: aload_1
    //   240: athrow
    //   241: astore_1
    //   242: goto -12 -> 230
    ...
    //   0	293	1	paramHttpResponseListener	HttpResponseListener
    ...
    //   259	29	5	localHttpResponseListener	HttpResponseListener
    // Exception table:
    //   from	to	target	type
