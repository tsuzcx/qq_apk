  ...
  implements c.a
{
  ...
  public void a(String paramString)
  {
    ...
    ((SharedPreferences.Editor)localObject).putBoolean("ucup", false);
    ((SharedPreferences.Editor)localObject).commit();
    localObject = new StringBuilder();
    ((StringBuilder)localObject).append("Execute command [1005](");
 ...
 * Qualified Name:     com.tencent.smtt.utils.q.2
