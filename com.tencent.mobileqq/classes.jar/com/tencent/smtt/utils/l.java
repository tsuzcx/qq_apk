  ...
  implements Runnable
{
  ...
  public void b()
  {
    ...
    //   6: dup
    //   7: aload_0
    //   8: getfield 43	com/tencent/smtt/utils/l:b	Ljava/io/File;
    //   11: ldc 126
    //   13: invokespecial 127	java/io/RandomAccessFile:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   16: putfield 45	com/tencent/smtt/utils/l:c	Ljava/io/RandomAccessFile;
    //   19: goto +12 -> 31
    //   22: astore_3
    //   23: goto +221 -> 244
    //   26: astore_3
    ...
    //   31: aload_0
    //   32: getfield 45	com/tencent/smtt/utils/l:c	Ljava/io/RandomAccessFile;
    //   35: ifnull +195 -> 230
    //   38: aload_0
    //   39: getfield 45	com/tencent/smtt/utils/l:c	Ljava/io/RandomAccessFile;
    //   42: invokevirtual 131	java/io/RandomAccessFile:getChannel	()Ljava/nio/channels/FileChannel;
    //   45: astore 6
    //   47: aload 6
    //   49: ifnull +181 -> 230
    //   52: aload_0
    //   53: getfield 49	com/tencent/smtt/utils/l:e	J
    //   56: lconst_0
    //   57: lcmp
    //   58: ifle +16 -> 74
    //   61: aload_0
    //   62: invokevirtual 133	com/tencent/smtt/utils/l:a	()Landroid/os/Handler;
    //   65: aload_0
    //   66: aload_0
    //   67: getfield 49	com/tencent/smtt/utils/l:e	J
    ...
    //   107: getstatic 93	com/tencent/smtt/utils/l:a	Ljava/lang/String;
    //   110: ldc 151
    ...
    //   149: lcmp
    //   150: iflt -69 -> 81
    //   153: getstatic 93	com/tencent/smtt/utils/l:a	Ljava/lang/String;
    //   156: ldc 170
    //   158: invokestatic 103	android/util/Log:d	(Ljava/lang/String;Ljava/lang/String;)I
    //   161: pop
    //   162: aload_0
    //   163: aload_3
    //   164: putfield 47	com/tencent/smtt/utils/l:d	Ljava/nio/channels/FileLock;
    //   167: getstatic 93	com/tencent/smtt/utils/l:a	Ljava/lang/String;
    //   170: astore_3
    ...
    //   188: aload 4
    //   190: aload_0
    //   191: getfield 43	com/tencent/smtt/utils/l:b	Ljava/io/File;
    ...
    //   229: pop
    //   230: aload_0
    //   231: getfield 47	com/tencent/smtt/utils/l:d	Ljava/nio/channels/FileLock;
    //   234: ifnull +7 -> 241
    //   237: aload_0
    //   238: invokevirtual 179	com/tencent/smtt/utils/l:c	()V
    //   241: aload_0
    //   242: monitorexit
    //   243: return
    //   244: aload_0
