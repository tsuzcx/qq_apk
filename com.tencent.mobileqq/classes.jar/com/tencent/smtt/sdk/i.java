  ...
  extends ServiceWorkerController
{
  public ServiceWorkerWebSettings getServiceWorkerWebSettings()
  {
    ...
    return new i.1(this, android.webkit.ServiceWorkerController.getInstance().getServiceWorkerWebSettings());
  }
  
  public void setServiceWorkerClient(ServiceWorkerClient paramServiceWorkerClient)
  {
    if (Build.VERSION.SDK_INT >= 24) {
      android.webkit.ServiceWorkerController.getInstance().setServiceWorkerClient(new i.2(this, paramServiceWorkerClient));
    }
  }
}
