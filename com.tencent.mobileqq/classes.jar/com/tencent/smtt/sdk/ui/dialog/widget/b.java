  ...
  extends Button
{
  ...
  {
    this(paramContext, paramInt1, paramInt1, paramInt1, paramInt1, paramInt2);
  }
  ...
  public void a()
  {
    ...
    this.h = new c(0xFFFFFF & this.a | 0x50000000, this.c, this.d, this.e, this.f);
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (this.g != null) {
      this.g.a(paramInt3 - paramInt1, paramInt4 - paramInt2);
    }
    if (this.h != null) {
      this.h.a(paramInt3 - paramInt1, paramInt4 - paramInt2);
    }
    if (this.i != null) {
      this.i.a(paramInt3 - paramInt1, paramInt4 - paramInt2);
    }
  }
}
