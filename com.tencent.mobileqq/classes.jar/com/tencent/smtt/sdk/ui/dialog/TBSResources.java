...
public class TBSResources
{
  ...
  static
  {
    ...
    String[] arrayOfString8 = { ".doc", "application/msword" };
    String[] arrayOfString9 = { ".docx", "application/vnd.openxmlformats-officedocument.wordprocessingml.document" };
    String[] arrayOfString10 = { ".xls", "application/vnd.ms-excel" };
    String[] arrayOfString11 = { ".exe", "application/octet-stream" };
    String[] arrayOfString12 = { ".gif", "image/gif" };
    String[] arrayOfString13 = { ".gtar", "application/x-gtar" };
    String[] arrayOfString14 = { ".h", "text/plain" };
    String[] arrayOfString15 = { ".htm", "text/html" };
    String[] arrayOfString16 = { ".html", "text/html" };
    String[] arrayOfString17 = { ".java", "text/plain" };
    String[] arrayOfString18 = { ".jpeg", "image/jpeg" };
    String[] arrayOfString19 = { ".jpg", "image/jpeg" };
    String[] arrayOfString20 = { ".js", "application/x-javascript" };
    String[] arrayOfString21 = { ".log", "text/plain" };
    String[] arrayOfString22 = { ".m3u", "audio/x-mpegurl" };
    String[] arrayOfString23 = { ".m4a", "audio/mp4a-latm" };
    String[] arrayOfString24 = { ".m4b", "audio/mp4a-latm" };
    String[] arrayOfString25 = { ".m4p", "audio/mp4a-latm" };
    String[] arrayOfString26 = { ".m4v", "video/x-m4v" };
    String[] arrayOfString27 = { ".mov", "video/quicktime" };
    String[] arrayOfString28 = { ".mp3", "audio/x-mpeg" };
    String[] arrayOfString29 = { ".mp4", "video/mp4" };
    String[] arrayOfString30 = { ".mpeg", "video/mpeg" };
    String[] arrayOfString31 = { ".mpg", "video/mpeg" };
    String[] arrayOfString32 = { ".mpg4", "video/mp4" };
    String[] arrayOfString33 = { ".msg", "application/vnd.ms-outlook" };
    String[] arrayOfString34 = { ".ogg", "audio/ogg" };
    String[] arrayOfString35 = { ".pdf", "application/pdf" };
    String[] arrayOfString36 = { ".ppt", "application/vnd.ms-powerpoint" };
    String[] arrayOfString37 = { ".pptx", "application/vnd.openxmlformats-officedocument.presentationml.presentation" };
    String[] arrayOfString38 = { ".prop", "text/plain" };
    String[] arrayOfString39 = { ".rc", "text/plain" };
    String[] arrayOfString40 = { ".rmvb", "audio/x-pn-realaudio" };
    String[] arrayOfString41 = { ".tar", "application/x-tar" };
    String[] arrayOfString42 = { ".tgz", "application/x-compressed" };
    String[] arrayOfString43 = { ".wma", "audio/x-ms-wma" };
    String[] arrayOfString44 = { ".wmv", "audio/x-ms-wmv" };
    String[] arrayOfString45 = { ".wps", "application/vnd.ms-works" };
    String[] arrayOfString46 = { ".xml", "text/plain" };
    String[] arrayOfString47 = { ".z", "application/x-compress" };
    String[] arrayOfString48 = { ".7z", "application/7z" };
    String[] arrayOfString49 = { "", "*/*" };
    MIMEType_MapTable = new String[][] { arrayOfString1, arrayOfString2, arrayOfString3, arrayOfString4, { ".bin", "application/octet-stream" }, arrayOfString5, arrayOfString6, arrayOfString7, { ".conf", "text/plain" }, { ".cpp", "text/plain" }, arrayOfString8, arrayOfString9, arrayOfString10, { ".xlsx", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" }, arrayOfString11, arrayOfString12, arrayOfString13, { ".gz", "application/x-gzip" }, arrayOfString14, arrayOfString15, arrayOfString16, { ".jar", "application/java-archive" }, arrayOfString17, arrayOfString18, arrayOfString19, arrayOfString20, arrayOfString21, arrayOfString22, arrayOfString23, arrayOfString24, arrayOfString25, { ".m4u", "video/vnd.mpegurl" }, arrayOfString26, arrayOfString27, { ".mp2", "audio/x-mpeg" }, arrayOfString28, arrayOfString29, { ".mpc", "application/vnd.mpohun.certificate" }, { ".mpe", "video/mpeg" }, arrayOfString30, arrayOfString31, arrayOfString32, { ".mpga", "audio/mpeg" }, arrayOfString33, arrayOfString34, arrayOfString35, { ".png", "image/png" }, { ".pps", "application/vnd.ms-powerpoint" }, arrayOfString36, arrayOfString37, arrayOfString38, arrayOfString39, arrayOfString40, { ".rtf", "application/rtf" }, { ".sh", "text/plain" }, arrayOfString41, arrayOfString42, { ".txt", "text/plain" }, { ".wav", "audio/x-wav" }, arrayOfString43, arrayOfString44, arrayOfString45, arrayOfString46, arrayOfString47, { ".zip", "application/zip" }, arrayOfString48, arrayOfString49 };
  }
