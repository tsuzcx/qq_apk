...
class t
{
  ...
  public t(Context paramContext1, Context paramContext2, String paramString1, String paramString2, String[] paramArrayOfString, String paramString3, m paramm)
  {
    ...
    if ((bool1) && (i != 0))
    {
      ...
      if (paramm != null) {
        paramm.a("init_tbs", (byte)1);
      }
      i = b(paramContext1);
      if (paramm != null) {
        paramm.a("init_tbs", (byte)2);
      }
      if (i >= 0) {
        break label631;
      }
  ...
  private int b(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      str2 = this.f;
      str3 = QbSdk.a();
      localObject1 = ((DexLoader)localObject1).invokeStaticMethod("com.tencent.tbs.tbsshell.TBSShell", "initTesRuntimeEnvironment", new Class[] { Context.class, Context.class, DexLoader.class, String.class, String.class, String.class, localObject2, String.class }, new Object[] { paramContext, localObject3, localObject4, str1, str2, "4.3.0.36", Integer.valueOf(43936), str3 });
      break;
      label710:
  ...
  private void c()
  {
    this.e.invokeStaticMethod("com.tencent.tbs.tbsshell.TBSShell", "setTesSdkVersionName", new Class[] { String.class }, new Object[] { "4.3.0.36" });
  }
  
  private void d()
  {
    this.e.setStaticField("com.tencent.tbs.tbsshell.TBSShell", "VERSION", Integer.valueOf(43936));
  }
  ...
  public void a(Context paramContext1, Context paramContext2, String paramString1, String paramString2, String[] paramArrayOfString, String paramString3, m paramm)
  {
    this.a = paramContext1.getApplicationContext();
