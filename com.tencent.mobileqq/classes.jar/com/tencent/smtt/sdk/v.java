...
class v
{
  ...
  public w a(boolean paramBoolean)
  {
    if (paramBoolean) {
      return this.b;
    }
  ...
  public FileLock a(android.content.Context paramContext)
  {
    ...
    //   7: getstatic 17	com/tencent/smtt/sdk/v:e	Ljava/nio/channels/FileLock;
    //   10: ifnull +7 -> 17
    //   13: getstatic 17	com/tencent/smtt/sdk/v:e	Ljava/nio/channels/FileLock;
    //   16: areturn
    //   17: ldc 2
    //   19: monitorenter
    //   20: getstatic 17	com/tencent/smtt/sdk/v:e	Ljava/nio/channels/FileLock;
    //   23: ifnonnull +23 -> 46
    //   26: aload_1
    //   27: invokestatic 46	com/tencent/smtt/utils/FileUtil:e	(Landroid/content/Context;)Ljava/nio/channels/FileLock;
    //   30: putstatic 17	com/tencent/smtt/sdk/v:e	Ljava/nio/channels/FileLock;
    //   33: getstatic 17	com/tencent/smtt/sdk/v:e	Ljava/nio/channels/FileLock;
    //   36: ifnonnull +17 -> 53
    //   39: ldc 34
    //   41: ldc 48
    ...
    //   46: ldc 2
    //   48: monitorexit
    //   49: getstatic 17	com/tencent/smtt/sdk/v:e	Ljava/nio/channels/FileLock;
    //   52: areturn
    //   53: ldc 34
    ...
    //   67: getstatic 17	com/tencent/smtt/sdk/v:e	Ljava/nio/channels/FileLock;
  ...
  /* Error */
  public void a(android.content.Context paramContext, m paramm)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 6
    ...
    //   17: ldc 73
    //   19: iconst_2
    //   20: invokevirtual 78	com/tencent/smtt/sdk/m:a	(Ljava/lang/String;B)V
    //   23: iconst_1
    //   24: invokestatic 83	com/tencent/smtt/sdk/d:a	(Z)Lcom/tencent/smtt/sdk/d;
    //   27: astore 8
    //   29: aload 8
    //   31: aload_1
    //   32: iconst_0
    //   33: iconst_0
    //   34: aload_2
    //   35: invokevirtual 86	com/tencent/smtt/sdk/d:a	(Landroid/content/Context;ZZLcom/tencent/smtt/sdk/m;)V
    ...
    //   52: ldc 88
    //   54: iconst_1
    //   55: invokevirtual 78	com/tencent/smtt/sdk/m:a	(Ljava/lang/String;B)V
    //   58: aload 8
    //   60: invokevirtual 91	com/tencent/smtt/sdk/d:a	()Lcom/tencent/smtt/sdk/t;
    //   63: astore 9
    //   65: aload 8
    //   67: invokevirtual 94	com/tencent/smtt/sdk/d:b	()Z
    //   70: ifeq +430 -> 500
    //   73: aload 9
    //   75: ifnull +425 -> 500
    //   78: aload_0
    //   79: getfield 96	com/tencent/smtt/sdk/v:d	Z
    //   82: ifne +616 -> 698
    //   85: aload_2
    //   86: ifnull +8 -> 94
    //   89: aload_2
    //   90: iconst_1
    //   91: putfield 98	com/tencent/smtt/sdk/m:a	Z
    //   94: aload_0
    //   95: new 100	com/tencent/smtt/sdk/w
    //   98: dup
    //   99: aload 9
    //   101: invokevirtual 105	com/tencent/smtt/sdk/t:b	()Lcom/tencent/smtt/export/external/DexLoader;
    //   104: invokespecial 108	com/tencent/smtt/sdk/w:<init>	(Lcom/tencent/smtt/export/external/DexLoader;)V
    //   107: putfield 28	com/tencent/smtt/sdk/v:b	Lcom/tencent/smtt/sdk/w;
    //   110: aload_0
    //   111: aload_0
    //   112: getfield 28	com/tencent/smtt/sdk/v:b	Lcom/tencent/smtt/sdk/w;
    //   115: invokevirtual 110	com/tencent/smtt/sdk/w:a	()Z
    //   118: putfield 112	com/tencent/smtt/sdk/v:c	Z
    //   121: aload_0
    //   122: getfield 112	com/tencent/smtt/sdk/v:c	Z
    //   125: ifne +11 -> 136
    //   128: aload 7
    //   130: ldc 114
    ...
    //   141: astore 5
    //   143: aload_0
    //   144: getfield 112	com/tencent/smtt/sdk/v:c	Z
    //   147: ifeq +22 -> 169
    ...
    //   183: aload_0
    //   184: getfield 112	com/tencent/smtt/sdk/v:c	Z
    ...
    //   196: aload_0
    //   197: getfield 112	com/tencent/smtt/sdk/v:c	Z
    //   200: ifne +457 -> 657
    //   203: ldc 34
    //   205: ldc 132
    //   207: invokestatic 134	com/tencent/smtt/utils/TbsLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   210: aload 8
    //   212: invokevirtual 94	com/tencent/smtt/sdk/d:b	()Z
    //   215: istore_3
    //   216: iload_3
    //   217: ifeq +352 -> 569
    //   220: aload 9
    ...
    //   230: aload 9
    //   232: invokevirtual 105	com/tencent/smtt/sdk/t:b	()Lcom/tencent/smtt/export/external/DexLoader;
    //   235: astore 5
    //   237: aload 6
    //   239: astore 4
    //   241: aload 5
    ...
    //   424: aload_0
    //   425: iconst_1
    //   426: putfield 96	com/tencent/smtt/sdk/v:d	Z
    //   429: aload_2
    //   430: ifnull +10 -> 440
    //   433: aload_2
    //   434: ldc 88
    //   436: iconst_2
    //   437: invokevirtual 78	com/tencent/smtt/sdk/m:a	(Ljava/lang/String;B)V
    //   440: aload_0
    //   441: monitorexit
    //   442: return
    //   443: astore 4
    //   445: aload_0
    //   446: iconst_1
    //   447: putfield 112	com/tencent/smtt/sdk/v:c	Z
    //   450: aconst_null
    //   451: astore 4
    //   453: goto -314 -> 139
    //   456: astore 4
    //   458: aload_0
    //   459: iconst_0
    //   460: putfield 112	com/tencent/smtt/sdk/v:c	Z
    //   463: aload 7
    ...
    //   500: aload_0
    //   501: iconst_0
    //   502: putfield 112	com/tencent/smtt/sdk/v:c	Z
    //   505: aload 7
    //   507: ldc 192
    ...
    //   566: goto -142 -> 424
    //   569: aload 8
    //   571: invokevirtual 94	com/tencent/smtt/sdk/d:b	()Z
    //   574: ifeq +43 -> 617
    ...
    //   671: getstatic 17	com/tencent/smtt/sdk/v:e	Ljava/nio/channels/FileLock;
    ...
    //   683: getstatic 17	com/tencent/smtt/sdk/v:e	Ljava/nio/channels/FileLock;
    //   686: ifnonnull -262 -> 424
    //   689: aload_0
    //   690: aload_1
    //   691: invokevirtual 203	com/tencent/smtt/sdk/v:a	(Landroid/content/Context;)Ljava/nio/channels/FileLock;
    //   694: pop
    //   695: goto -271 -> 424
    //   698: aconst_null
    //   699: astore 5
