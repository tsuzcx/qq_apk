...
public class DesUtils
{
  ...
  static
  {
    ...
    int[] arrayOfInt3 = { 7, 13, 14, 3, 0, 6, 9, 10, 1, 2, 8, 5, 11, 12, 4, 15 };
    int[] arrayOfInt4 = { 13, 8, 11, 5, 6, 15, 0, 3, 4, 7, 2, 12, 1, 10, 14, 9 };
    int[] arrayOfInt5 = { 10, 6, 9, 0, 12, 11, 7, 13, 15, 1, 3, 14, 5, 2, 8, 4 };
    int[] arrayOfInt10 = { 2, 12, 4, 1, 7, 10, 11, 6, 8, 5, 3, 15, 13, 0, 14, 9 };
    int[] arrayOfInt11 = { 14, 11, 2, 12, 4, 7, 13, 1, 5, 0, 15, 10, 3, 9, 8, 6 };
    int[] arrayOfInt12 = { 4, 2, 1, 11, 10, 13, 7, 8, 15, 9, 12, 5, 6, 3, 0, 14 };
    int[] arrayOfInt13 = { 11, 8, 12, 7, 1, 14, 2, 13, 6, 15, 0, 9, 10, 4, 5, 3 };
    Object localObject1 = { 12, 1, 10, 15, 9, 2, 6, 8, 0, 13, 3, 4, 14, 7, 5, 11 };
    Object localObject2 = { 9, 14, 15, 5, 2, 8, 12, 3, 7, 0, 4, 10, 1, 13, 11, 6 };
    localObject1 = new int[][] { localObject1, { 10, 15, 4, 2, 7, 12, 9, 5, 6, 1, 13, 14, 0, 11, 3, 8 }, localObject2, { 4, 3, 2, 12, 9, 5, 15, 10, 11, 14, 1, 7, 6, 0, 8, 13 } };
    ...
    S_Box = new int[][][] { arrayOfInt1, arrayOfInt2, { arrayOfInt6, arrayOfInt7, arrayOfInt8, arrayOfInt9 }, { arrayOfInt3, arrayOfInt4, arrayOfInt5, { 3, 15, 0, 6, 10, 1, 13, 8, 9, 4, 5, 11, 12, 7, 2, 14 } }, { arrayOfInt10, arrayOfInt11, arrayOfInt12, arrayOfInt13 }, localObject1, localObject2, arrayOfInt14 };
