  ...
  extends X5ProxyWebChromeClient
{
  ...
  public boolean onCreateWindow(IX5WebViewBase paramIX5WebViewBase, boolean paramBoolean1, boolean paramBoolean2, Message paramMessage)
  {
    ...
    paramMessage = Message.obtain(paramMessage.getTarget(), new h.1(this, paramIX5WebViewBase, paramMessage));
  ...
  {
    this.b.onExceededDatabaseQuota(paramString1, paramString2, paramLong1, paramLong2, paramLong3, new h.a(this, paramQuotaUpdater));
  }
  ...
  {
    this.b.onReachedMaxAppCacheSize(paramLong1, paramLong2, new h.a(this, paramQuotaUpdater));
  }
  ...
  {
    paramValueCallback = new h.3(this, paramValueCallback);
    paramFileChooserParams = new h.4(this, paramFileChooserParams);
    this.a.a(paramIX5WebViewBase);
  ...
  {
    this.b.openFileChooser(new h.2(this, paramValueCallback), paramString1, paramString2);
  }
}
