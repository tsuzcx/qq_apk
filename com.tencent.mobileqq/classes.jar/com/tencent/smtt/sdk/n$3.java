...
class n$3
  extends Handler
{
  n$3(n paramn, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case 1: 
      ...
      n.a(this.a, (Context)paramMessage[0], (String)paramMessage[1], ((Integer)paramMessage[2]).intValue());
      return;
    case 2: 
      TbsLog.i("TbsInstaller", "TbsInstaller--handleMessage--MSG_COPY_TBS_CORE");
      paramMessage = (Object[])paramMessage.obj;
      n.a(this.a, (Context)paramMessage[0], (Context)paramMessage[1], ((Integer)paramMessage[2]).intValue());
      return;
    case 3: 
 ...
 * Qualified Name:     com.tencent.smtt.sdk.n.3
