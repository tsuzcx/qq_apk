...
class TRTCCloudImpl$29
  implements Runnable
{
  TRTCCloudImpl$29(TRTCCloudImpl paramTRTCCloudImpl, Bitmap paramBitmap, int paramInt) {}
  ...
  public void run()
  {
    ...
    this.this$0.mConfig.A = this.val$image;
    this.this$0.mConfig.C = i;
    this.this$0.mConfig.B = -1;
