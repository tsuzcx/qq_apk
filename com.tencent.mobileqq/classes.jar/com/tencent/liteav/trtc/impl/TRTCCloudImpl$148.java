...
class TRTCCloudImpl$148
  implements Runnable
{
  TRTCCloudImpl$148(TRTCCloudImpl paramTRTCCloudImpl, String paramString, int paramInt1, float paramFloat1, float paramFloat2, int paramInt2, int paramInt3) {}
  ...
  public void run()
  {
    ...
    if (localTRTCCloudListener != null)
    {
      ...
      this.this$0.apiLog(String.format("SpeedTest progress %d/%d, result: %s", new Object[] { Integer.valueOf(this.val$finishedCount), Integer.valueOf(this.val$totalCount), localTRTCSpeedTestResult.toString() }));
    }
  }
}
