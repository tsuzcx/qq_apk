...
class TRTCCloudImpl$156
  implements Runnable
{
  TRTCCloudImpl$156(TRTCCloudImpl paramTRTCCloudImpl, int paramInt, String paramString) {}
  
  public void run()
  {
    Object localObject = this.this$0;
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append("onTranscodingUpdated ");
    ...
    ((StringBuilder)localObject).append(String.format("onTranscodingUpdated err:%d, msg:%s", new Object[] { Integer.valueOf(this.val$code), this.val$msg }));
