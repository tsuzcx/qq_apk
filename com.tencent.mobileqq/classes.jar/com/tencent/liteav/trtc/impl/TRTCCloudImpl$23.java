...
class TRTCCloudImpl$23
  implements Runnable
{
  TRTCCloudImpl$23(TRTCCloudImpl paramTRTCCloudImpl, String paramString, TRTCCloudListener.TRTCSnapshotListener paramTRTCSnapshotListener, int paramInt) {}
  ...
  public void run()
  {
    if (this.val$userId == null)
    {
      ...
      this.this$0.mCaptureAndEnc.a(new TRTCCloudImpl.23.1(this));
      return;
    }
    ...
    if (localObject != null)
    {
      ((e)localObject).a(new TRTCCloudImpl.23.2(this));
      return;
    }
    this.this$0.runOnListenerThread(new TRTCCloudImpl.23.3(this));
  }
}
