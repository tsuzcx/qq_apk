  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    int j = f.e(localTRTCCloudImpl.mContext);
    int[] arrayOfInt = f.a();
    int i = f.b();
    ...
    if (f.a(localTRTCCloudImpl.mContext))
    {
    ...
    if (TRTCCloudImpl.access$8800(localTRTCCloudImpl) != j)
    {
      if ((TRTCCloudImpl.access$8800(localTRTCCloudImpl) >= 0) && (j > 0)) {
        TRTCCloudImpl.access$8900(localTRTCCloudImpl, localTRTCCloudImpl.mNativeRtcContext, 100);
      }
      long l;
      if (j == 0) {
        l = 0L;
      ...
      localStringBuilder.append(String.format("network switch from:%d to %d", new Object[] { Integer.valueOf(TRTCCloudImpl.access$8800(localTRTCCloudImpl)), Integer.valueOf(j) }));
      ...
      TRTCCloudImpl.access$8802(localTRTCCloudImpl, j);
      TXCKeyPointReportProxy.a(40039, j, 0);
    }
    if (TRTCCloudImpl.access$9000(localTRTCCloudImpl) != i)
    {
      TXCEventRecorderProxy.a("18446744073709551615", 2001, i, -1L, "", 0);
      TRTCCloudImpl.access$9002(localTRTCCloudImpl, i);
      if (i == 0)
      {
        localStringBuilder = new StringBuilder();
        localStringBuilder.append("onAppDidBecomeActive self:");
        localStringBuilder.append(localTRTCCloudImpl.hashCode());
      ...
      {
        localStringBuilder = new StringBuilder();
        localStringBuilder.append("onAppEnterBackground self:");
        localStringBuilder.append(localTRTCCloudImpl.hashCode());
        Monitor.a(1, localStringBuilder.toString(), "", 0);
      }
    ...
    TRTCCloudImpl.access$9100(localTRTCCloudImpl);
    localTRTCCloudImpl.checkDashBoard();
    TRTCCloudImpl.access$9200(localTRTCCloudImpl);
    localTRTCCloudImpl.startCollectStatus();
    if (TRTCCloudImpl.access$3100(localTRTCCloudImpl) != 0) {
      TRTCCloudImpl.access$2000(localTRTCCloudImpl).checkOrientation();
    }
  }
}
