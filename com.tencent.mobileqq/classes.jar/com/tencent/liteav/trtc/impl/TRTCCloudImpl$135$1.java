...
class TRTCCloudImpl$135$1
  implements Runnable
{
  TRTCCloudImpl$135$1(TRTCCloudImpl.135 param135) {}
  ...
  public void run()
  {
    ...
    if (localObject != null)
    {
      if ((TRTCRoomInfo.hasAudio(this.this$1.val$videoState)) && (!TRTCRoomInfo.isMuteAudio(this.this$1.val$videoState)))
      {
        ...
        TRTCCloudImpl.access$8000(this.this$1.this$0, this.this$1.this$0.mRoomInfo.getUserId(), 0, String.format("[%s]audio Available[%b]", new Object[] { this.this$1.val$userID, Boolean.valueOf(false) }));
      ...
      if (((TRTCRoomInfo.hasMainVideo(this.this$1.val$videoState)) || (TRTCRoomInfo.hasSmallVideo(this.this$1.val$videoState))) && (!TRTCRoomInfo.isMuteMainVideo(this.this$1.val$videoState)))
      {
        ...
        TRTCCloudImpl.access$8000(this.this$1.this$0, this.this$1.this$0.mRoomInfo.getUserId(), 0, String.format("[%s]video Available[%b]", new Object[] { this.this$1.val$userID, Boolean.valueOf(false) }));
        localStringBuilder = new StringBuilder();
      ...
      if ((TRTCRoomInfo.hasSubVideo(this.this$1.val$videoState)) && (!TRTCRoomInfo.isMuteSubVideo(this.this$1.val$videoState)))
      {
        ...
        TRTCCloudImpl.access$8000(this.this$1.this$0, this.this$1.this$0.mRoomInfo.getUserId(), 0, String.format("[%s]subVideo Available[%b]", new Object[] { this.this$1.val$userID, Boolean.valueOf(false) }));
        localStringBuilder = new StringBuilder();
 ...
 * Qualified Name:     com.tencent.liteav.trtc.impl.TRTCCloudImpl.135.1
