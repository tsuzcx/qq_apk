...
class TRTCCloudImpl$169
  implements Runnable
{
  TRTCCloudImpl$169(TRTCCloudImpl paramTRTCCloudImpl, long paramLong) {}
  ...
  public void run()
  {
    ...
    if (localObject2 != null)
    {
      ...
      if (((TRTCRoomInfo.hasMainVideo(localObject2.streamState)) || (TRTCRoomInfo.hasSmallVideo(localObject2.streamState))) && (!TRTCRoomInfo.isMuteMainVideo(localObject2.streamState))) {
        this.this$0.runOnListenerThread(new TRTCCloudImpl.169.1(this, (String)localObject3));
      }
    }
  }
}
 ...
 * Qualified Name:     com.tencent.liteav.trtc.impl.TRTCCloudImpl.169
