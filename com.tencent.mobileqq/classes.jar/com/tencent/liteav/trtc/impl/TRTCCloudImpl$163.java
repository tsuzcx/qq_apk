...
class TRTCCloudImpl$163
  implements Runnable
{
  TRTCCloudImpl$163(TRTCCloudImpl paramTRTCCloudImpl, TXCloudVideoView paramTXCloudVideoView, TRTCRoomInfo.RenderInfo paramRenderInfo, e parame, String paramString, TRTCCloud.TRTCViewMargin paramTRTCViewMargin) {}
  ...
  public void run()
  {
    ...
    if (localObject1 != null)
    {
      ...
      if (((SurfaceHolder)localObject2).getSurface().isValid())
      {
        ...
        this.val$videoRender.c(((SurfaceView)localObject1).getWidth(), ((SurfaceView)localObject1).getHeight());
        return;
      }
