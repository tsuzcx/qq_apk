  ...
  implements i.a
{
    ...
    if (this.l)
    {
      ...
      if (i1 != 0)
      {
        ...
        if (i2 != 0)
        {
          ...
          p localp = this.m;
          if (localp != null) {
            new Thread(new g.4(this, localByteBuffer, localBitmap, i5, i4, localp)).start();
          }
        }
      }
      this.m = null;
  ...
  public void a(int paramInt1, boolean paramBoolean1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    {
      if (this.b != null) {
        this.b.post(new g.3(this, paramInt1, paramBoolean1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, paramBoolean2, paramBoolean3));
      }
      return;
    }
    finally {}
