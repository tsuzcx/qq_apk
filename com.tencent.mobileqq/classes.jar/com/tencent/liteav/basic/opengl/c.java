...
public class c
{
  ...
  public e c()
  {
    ...
    boolean bool1 = EGL14.eglQuerySurface(this.c, this.i, 12375, arrayOfInt, 0);
    boolean bool2 = EGL14.eglQuerySurface(this.c, this.i, 12374, arrayOfInt, 1);
    if ((bool1) && (bool2)) {
      return new e(arrayOfInt[0], arrayOfInt[1]);
    }
    return new e(0, 0);
  }
