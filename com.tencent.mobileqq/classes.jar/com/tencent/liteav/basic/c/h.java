...
public class h
{
  ...
  {
    a(new h.2(this, paramInt, paramFloat));
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, float[] paramArrayOfFloat, float paramFloat, boolean paramBoolean1, boolean paramBoolean2)
  {
    if (paramArrayOfFloat == null) {
      paramArrayOfFloat = l.a(k.a, false, true);
    }
    float f2 = paramInt1;
    float f1 = paramInt2;
    float f3 = f2 / f1;
    ...
    a((float[])l.e.clone(), paramArrayOfFloat);
  }
  ...
  {
    a(new h.3(this, paramInt, paramArrayOfFloat));
  }
  ...
  public int b(int paramInt, FloatBuffer paramFloatBuffer1, FloatBuffer paramFloatBuffer2)
  {
    ...
    if ((paramFloatBuffer1 instanceof h.a)) {
  ...
  {
    a(new h.1(this, paramInt1, paramInt2));
  }
  
  public void b(int paramInt, float[] paramArrayOfFloat)
  {
    a(new h.4(this, paramInt, paramArrayOfFloat));
  }
  ...
  {
    a(new h.5(this, paramInt, paramArrayOfFloat));
  }
