...
public class f
{
  ...
  private static a<b> g = new a(new f.1());
  ...
  public static com.tencent.liteav.basic.c.a a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    return new com.tencent.liteav.basic.c.a(paramInt1, k, paramInt3, paramInt4);
  }
  ...
  public static boolean a(String paramString1, String paramString2)
  {
    ...
    //   15: aconst_null
    //   16: astore 5
    //   18: new 272	java/io/File
    //   21: dup
    //   22: aload_0
    //   23: invokespecial 274	java/io/File:<init>	(Ljava/lang/String;)V
    //   26: invokevirtual 278	java/io/File:exists	()Z
    //   29: ifne +5 -> 34
    //   32: iconst_0
    //   33: ireturn
    //   34: new 280	android/media/MediaMetadataRetriever
    //   37: dup
    //   38: invokespecial 281	android/media/MediaMetadataRetriever:<init>	()V
    //   41: astore_2
    //   42: aload 6
    //   44: astore_3
    //   45: aload_2
    ...
    //   48: aload_2
    //   49: aload_0
    //   50: invokevirtual 284	android/media/MediaMetadataRetriever:setDataSource	(Ljava/lang/String;)V
    //   53: aload 6
    //   55: astore_3
    //   56: aload_2
    //   57: astore 4
    //   59: aload_2
    //   60: invokevirtual 288	android/media/MediaMetadataRetriever:getFrameAtTime	()Landroid/graphics/Bitmap;
    //   63: astore 7
    //   65: aload 6
    //   67: astore_3
    //   68: aload_2
    //   69: astore 4
    //   71: new 272	java/io/File
    //   74: dup
    //   75: aload_1
    //   76: invokespecial 274	java/io/File:<init>	(Ljava/lang/String;)V
    //   79: astore_0
    //   80: aload 6
    //   82: astore_3
    //   83: aload_2
    //   84: astore 4
    //   86: aload_0
    //   87: invokevirtual 278	java/io/File:exists	()Z
    //   90: ifeq +14 -> 104
    //   93: aload 6
    //   95: astore_3
    //   96: aload_2
    //   97: astore 4
    //   99: aload_0
    //   100: invokevirtual 291	java/io/File:delete	()Z
    //   103: pop
    //   104: aload 6
    //   106: astore_3
    //   107: aload_2
    //   108: astore 4
    //   110: new 293	java/io/FileOutputStream
    //   113: dup
    //   114: aload_0
    //   115: invokespecial 296	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   118: astore_0
    //   119: aload 7
    //   121: getstatic 302	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   124: bipush 100
    //   126: aload_0
    //   127: invokevirtual 308	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   130: pop
    //   131: aload_0
    //   132: invokevirtual 311	java/io/FileOutputStream:flush	()V
    //   135: aload_0
    //   136: invokevirtual 314	java/io/FileOutputStream:close	()V
    //   139: aload_2
    //   140: invokevirtual 317	android/media/MediaMetadataRetriever:release	()V
    //   143: iconst_1
    //   144: ireturn
    //   145: astore_1
    //   146: aload_0
    ...
    //   183: ldc_w 319
    //   186: aload_1
    //   187: invokestatic 322	com/tencent/liteav/basic/log/TXCLog:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   190: aload_0
    //   191: ifnull +10 -> 201
    //   194: aload_0
    //   195: invokevirtual 314	java/io/FileOutputStream:close	()V
    //   198: goto +3 -> 201
    //   201: aload_2
    //   202: ifnull +7 -> 209
    //   205: aload_2
    //   206: invokevirtual 317	android/media/MediaMetadataRetriever:release	()V
    //   209: iconst_0
    //   210: ireturn
    //   211: astore_0
    //   212: aload 4
    ...
    //   216: ifnull +10 -> 226
    //   219: aload_3
    //   220: invokevirtual 314	java/io/FileOutputStream:close	()V
    //   223: goto +3 -> 226
    //   226: aload_2
    //   227: ifnull +7 -> 234
    //   230: aload_2
    //   231: invokevirtual 317	android/media/MediaMetadataRetriever:release	()V
    //   234: aload_0
    //   235: athrow
    //   236: iconst_0
    //   237: ireturn
