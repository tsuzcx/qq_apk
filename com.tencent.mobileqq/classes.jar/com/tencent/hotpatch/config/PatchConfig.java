...
public class PatchConfig
{
  ...
  public boolean a(Context paramContext, String paramString)
  {
    ...
    if (!"de12fadd".equals(this.c))
    {
      QLog.d("PatchLogTag", 1, "PatchConfig isValidConfig revision not match expect: de12fadd");
      return false;
    }
    if ((TextUtils.isEmpty(this.b)) || (!this.b.equals(ApkUtils.a(paramContext) + "." + ApkUtils.a(paramContext))))
    {
      QLog.d("PatchLogTag", 1, "PatchConfig isValidConfig app version not match expect: " + ApkUtils.a(paramContext) + "." + ApkUtils.a(paramContext));
      return false;
    }
    if ((this.jdField_a_of_type_ComTencentHotpatchConfigAbscractPatchItemConfig == null) || (!this.jdField_a_of_type_ComTencentHotpatchConfigAbscractPatchItemConfig.a(paramString)))
    {
  ...
  public boolean b()
  {
    return (this.jdField_a_of_type_ComTencentHotpatchConfigAbscractPatchItemConfig != null) && (this.jdField_a_of_type_ComTencentHotpatchConfigAbscractPatchItemConfig.a());
  }
  
  public int c()
  {
    if ((!b()) && (PatchCommonUtil.isArtGeN()) && (this.jdField_a_of_type_ComTencentHotpatchConfigAbscractPatchItemConfig != null)) {
  ...
  public boolean c()
  {
    return (this.jdField_a_of_type_ComTencentHotpatchConfigAbscractPatchItemConfig != null) && (this.jdField_a_of_type_ComTencentHotpatchConfigAbscractPatchItemConfig.b());
  }
