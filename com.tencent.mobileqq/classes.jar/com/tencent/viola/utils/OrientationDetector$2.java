  ...
  extends OrientationEventListener
{
  ...
  public void onOrientationChanged(int paramInt)
  {
    ...
    else if ((paramInt > 90 - OrientationDetector.access$500(this.this$0)) && (paramInt <= OrientationDetector.access$500(this.this$0) + 90))
    {
      i = 8;
    }
    ...
    if (i != OrientationDetector.access$100(this.this$0))
    {
      ...
      OrientationDetector.OnOrientationChangedListener localOnOrientationChangedListener = this.val$listener;
      if (localOnOrientationChangedListener != null) {
        localOnOrientationChangedListener.onOrientationChanged(i);
      }
    }
  }
}
