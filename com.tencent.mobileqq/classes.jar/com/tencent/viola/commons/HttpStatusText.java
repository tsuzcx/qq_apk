...
public class HttpStatusText
{
  ...
  public static String getStatusText(String paramString)
  {
    if (!statusMap.containsKey(paramString)) {
      return "unknown status";
    }
    return (String)statusMap.get(paramString);
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes15.jar
 * Qualified Name:     com.tencent.viola.commons.HttpStatusText
