  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (VRefreshViewGroup.access$000(this.this$0).computeScrollOffset())
    {
      ...
      if ((!this.this$0.mPullLoading) && (VRefreshViewGroup.access$200(this.this$0).isTop()) && (VRefreshViewGroup.access$100(this.this$0).hasHeaderPullDown()) && (VRefreshViewGroup.access$300(this.this$0)))
      {
    ...
    do
    {
      ...
      {
        if (VRefreshViewGroup.access$300(this.this$0))
        {
          localIterator = VRefreshViewGroup.access$400(this.this$0).iterator();
          while (localIterator.hasNext()) {
            ((RefreshMoveOberver)localIterator.next()).onRefreshMove(0);
          }
          if (VRefreshViewGroup.access$200(this.this$0).getContentViewProvider() != null) {
