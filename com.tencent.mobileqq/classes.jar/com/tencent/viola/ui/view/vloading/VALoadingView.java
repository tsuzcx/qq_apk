  ...
  implements IVView<VIndicateLoading>
{
  ...
  {
    if (this.mLoadingImageBase64Str != null) {
      return this.mLoadingImageBase64Str;
    }
  ...
  public VIndicateLoading getComponent()
  {
    if (this.mWeakReference != null) {
      return (VIndicateLoading)this.mWeakReference.get();
    }
    return null;
  }
  ...
  public boolean isAnimating()
  {
    if (this.mRotateDrawable != null) {
      return this.mRotateDrawable.isRunning();
    }
    return false;
  }
  ...
  public void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (this.mRotateDrawable != null) {
      this.mRotateDrawable.setBounds(0, 0, paramInt3 - paramInt1, paramInt4 - paramInt2);
    }
  }
