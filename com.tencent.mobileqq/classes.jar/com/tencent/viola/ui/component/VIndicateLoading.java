  ...
  extends VComponent<VALoadingView>
{
  ...
  {
    String str;
    if ((this.mDomObj != null) && (this.mDomObj.getAttributes() != null) && (ViolaUtils.getString(this.mDomObj.getAttributes().get("type"), "0").equals("1"))) {
      str = "";
    } else {
      str = null;
    }
    paramContext = new VALoadingView(paramContext, str);
  ...
  public boolean setProperty(String paramString, Object paramObject)
  {
    ...
    int i;
    if ((paramString.hashCode() == -893184644) && (paramString.equals("stopAnimating"))) {
      i = 0;
    } else {
      i = -1;
    }
