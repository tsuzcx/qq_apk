...
public class ComponentConstant
{
  ...
  public static final String CMP_TYPE_SEEK_BAR = "seek-bar";
  public static final String CMP_TYPE_SLIDER = "slider";
  public static final String CMP_TYPE_SMART_HEADER = "smart-header";
  public static final String CMP_TYPE_SMART_LAYOUT = "smart-layout";
  public static final String CMP_TYPE_SWITCH = "switch";
  public static final String CMP_TYPE_TEXT = "text";
  public static final String CMP_TYPE_TEXT_AREA = "textarea";
