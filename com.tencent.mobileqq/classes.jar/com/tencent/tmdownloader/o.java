  ...
  implements Runnable
{
  ...
  public void run()
  {
    try
    {
      ab.c("RemoteOpProxy", "<setLong> process:" + s.e() + ", getServiceInterface()");
    ...
    {
      ab.c("RemoteOpProxy", "<setLong> process:" + s.e() + ", getServiceInterface() error, error msg = " + localException.getMessage());
