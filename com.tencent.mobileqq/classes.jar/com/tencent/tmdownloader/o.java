  ...
  implements Runnable
{
  ...
  public void run()
  {
    try
    {
      ac.c("RemoteOpProxy", "<setLong> process:" + t.e() + ", getServiceInterface()");
    ...
    {
      ac.c("RemoteOpProxy", "<setLong> process:" + t.e() + ", getServiceInterface() error, error msg = " + localException.getMessage());
