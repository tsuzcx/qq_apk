  ...
  extends PostHttpRequest
{
  ...
  {
    r.c(TAG, "onFinished errorCode: " + paramInt);
    ...
    {
      r.c(TAG, "onFinished response is null!");
      r.c(TAG, "exit");
    ...
    if ((paramArrayOfByte2 != null) && (paramArrayOfByte2.body != null))
    {
      ...
      r.c(TAG, "halleyTest GetHalleyUrlHttpRequest finish jceResponse = " + paramArrayOfByte2);
      if (paramArrayOfByte2 != null) {
