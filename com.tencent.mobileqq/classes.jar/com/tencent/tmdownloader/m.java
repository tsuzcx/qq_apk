  ...
  implements Runnable
{
  ...
  public void run()
  {
    try
    {
      ac.c("RemoteOpProxy", "<setBlob> process:" + t.e() + ", getServiceInterface()");
    ...
    {
      ac.c("RemoteOpProxy", "<setBlob> process:" + t.e() + ", getServiceInterface() error, error msg = " + localException.getMessage());
