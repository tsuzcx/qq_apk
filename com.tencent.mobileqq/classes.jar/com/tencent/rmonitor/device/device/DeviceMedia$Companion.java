...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/rmonitor/device/device/DeviceMedia$Companion;", "", "()V", "TAG", "", "getMediaCodec", "rmonitor-base_release"}, k=1, mv={1, 1, 15})
public final class DeviceMedia$Companion
{
  ...
  public final String a()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        boolean bool = AndroidVersion.a.d();
        Object localObject1;
        Object localObject2;
        int j;
        if (bool)
      ...
      catch (Exception localException)
      {
        ...
        ((Logger)localObject2).d(new String[] { "RMonitor_common_DeviceMedia", str1 });
      }
      catch (NoClassDefFoundError localNoClassDefFoundError)
      {
        ...
        ((Logger)localObject2).d(new String[] { "RMonitor_common_DeviceMedia", str2, ": can not found class" });
      }
 ...
 * Qualified Name:     com.tencent.rmonitor.device.device.DeviceMedia.Companion
