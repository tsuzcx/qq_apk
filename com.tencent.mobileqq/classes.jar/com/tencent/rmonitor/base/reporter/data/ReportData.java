...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/rmonitor/base/reporter/data/ReportData;", "Lcom/tencent/rmonitor/base/reporter/data/BaseJsonObject;", "reportType", "", "eventName", "", "isSucceed", "", "elapse", "", "size", "params", "Lorg/json/JSONObject;", "isRealTime", "isMerge", "uin", "(ILjava/lang/String;ZJJLorg/json/JSONObject;ZZLjava/lang/String;)V", "dbId", "getDbId", "()I", "setDbId", "(I)V", "getElapse", "()J", "setElapse", "(J)V", "getEventName", "()Ljava/lang/String;", "setEventName", "(Ljava/lang/String;)V", "()Z", "setMerge", "(Z)V", "setRealTime", "setSucceed", "getParams", "()Lorg/json/JSONObject;", "setParams", "(Lorg/json/JSONObject;)V", "getReportType", "setReportType", "getSize", "setSize", "getUin", "setUin", "component1", "component2", "component3", "component4", "component5", "component6", "component7", "component8", "component9", "copy", "equals", "other", "", "getPlugin", "hashCode", "toString", "rmonitor-base_release"}, k=1, mv={1, 1, 15})
  ...
  extends BaseJsonObject
{
  ...
  public ReportData(int paramInt, @NotNull String paramString1, boolean paramBoolean1, long paramLong1, long paramLong2, @NotNull JSONObject paramJSONObject, boolean paramBoolean2, boolean paramBoolean3, @NotNull String paramString2)
  {
  ...
  @NotNull
  public final ReportData copy(int paramInt, @NotNull String paramString1, boolean paramBoolean1, long paramLong1, long paramLong2, @NotNull JSONObject paramJSONObject, boolean paramBoolean2, boolean paramBoolean3, @NotNull String paramString2)
  {
    ...
    return new ReportData(paramInt, paramString1, paramBoolean1, paramLong1, paramLong2, paramJSONObject, paramBoolean2, paramBoolean3, paramString2);
  }
  ...
  public final int getPlugin()
  {
    try
    {
      int i = this.params.getInt("plugin");
      return i;
    }
    catch (Throwable localThrowable)
    {
      ...
      localStringBuilder.append(": reportData lose plugin");
      localLogger.e(new String[] { "ReportData", localStringBuilder.toString() });
    }
    return 0;
  }
  ...
  {
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append("ReportData(reportType=");
 ...
 * Qualified Name:     com.tencent.rmonitor.base.reporter.data.ReportData
