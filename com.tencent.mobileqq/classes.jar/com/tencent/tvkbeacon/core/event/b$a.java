    ...
    for (;;)
    {
      if (i < j)
      {
        try
        {
          ...
          c.f("[event] pack eName: %s", new Object[] { localRDBean.getEN() });
          EventRecord localEventRecord = k.a(localRDBean);
        ...
        {
          c.d("[event] encode2MixPackage error.", new Object[0]);
          c.a(paramList);
        }
      }
      else
      {
        ...
        {
          return null;
          c.b("[event] up erList:" + localArrayList.size(), new Object[0]);
 ...
 * Qualified Name:     com.tencent.tvkbeacon.core.event.b.a
