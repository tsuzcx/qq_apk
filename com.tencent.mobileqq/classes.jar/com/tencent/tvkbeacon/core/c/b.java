...
public final class b
{
  public static String a(String paramString)
  {
    ...
    c.c("[core] channelID should be Numeric! channelID:".concat(String.valueOf(paramString)), new Object[0]);
    return "unknown";
  }
  ...
  public static String a(Map<String, String> paramMap)
  {
    ...
    if (((Set)localObject).size() > 50) {
      c.c("[core] map size should <= 50!", new Object[0]);
    }
    ...
    while (localIterator.hasNext())
    {
      ...
      for (;;)
      {
        ...
        break;
        c.c("[core] '%s' should be ASCII code in 32-126!", new Object[] { str2 });
        break;
        label280:
        localObject = str1;
        if (str1.length() > 1024) {
 ...
 * Qualified Name:     com.tencent.tvkbeacon.core.c.b
