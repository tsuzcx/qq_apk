...
import com.tencent.tvkbeacon.core.c.e;
import com.tencent.tvkbeacon.core.event.g;
  ...
  implements Runnable
{
  ...
  private void a()
  {
    ...
    if (this.b != null)
    {
      ...
      if (i > 0)
      {
        c.b("[core] mNumVisibleActivities: ".concat(String.valueOf(i)), new Object[0]);
  ...
  {
    if (this.d == 0) {
      c.b("[core] Activity Monitor Task was started.", new Object[0]);
    }
    int i = this.d;
    this.d = (i + 1);
    if (i < 10)
    {
      ...
      {
        c.b("[core] Found visible activity.", new Object[0]);
        new g(this.a).c();
        this.d = 10;
      }
    }
    ...
    {
      if (this.d == 10) {
        c.b("[core] Activity Monitor Task was exited.", new Object[0]);
      }
      return;
    }
 ...
 * Qualified Name:     com.tencent.tvkbeacon.core.a.a
