  ...
  extends SQLiteOpenHelper
{
  ...
  private void a(SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    {
      c.g("[db] drop all success recreate!", new Object[0]);
      onCreate(paramSQLiteDatabase);
    }
    do
    {
      return;
      c.c("[db] drop all fail try deleted file,may next time will success!", new Object[0]);
      paramSQLiteDatabase = this.a.getDatabasePath("tvkbeacon_db");
  ...
  private boolean b(SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    //   12: ldc 119
    //   14: iconst_1
    //   15: anewarray 53	java/lang/String
    //   18: dup
    //   19: iconst_0
    //   20: ldc 121
    //   22: aastore
    ...
    //   77: astore_3
    //   78: aload_1
    //   79: invokestatic 147	com/tencent/tvkbeacon/core/c/c:a	(Ljava/lang/Throwable;)V
    //   82: aload 4
    //   84: ifnull +20 -> 104
    //   87: aload 4
    ...
    //   150: astore_3
    //   151: aload 5
    //   153: invokeinterface 170 1 0
    //   158: checkcast 53	java/lang/String
    //   161: astore 6
    //   163: aload 4
    //   165: astore_3
    //   166: aload 6
    //   168: ldc 172
    //   170: invokevirtual 175	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   173: ifne -38 -> 135
    //   176: aload 4
    //   178: astore_3
    //   179: aload 6
    //   181: ldc 177
    //   183: invokevirtual 175	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   186: ifne -51 -> 135
    //   189: aload 4
    //   191: astore_3
    //   192: aload_1
    //   193: getstatic 183	java/util/Locale:US	Ljava/util/Locale;
    //   196: ldc 185
    //   198: iconst_1
    //   199: anewarray 76	java/lang/Object
    //   202: dup
    //   203: iconst_0
    //   204: aload 6
    //   206: aastore
    //   207: invokestatic 189	java/lang/String:format	(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    //   224: aload 6
    //   226: aastore
    //   227: invokestatic 90	com/tencent/tvkbeacon/core/c/c:g	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   230: goto -95 -> 135
    //   233: astore_1
    //   234: aload_3
    //   235: ifnull +18 -> 253
  ...
  public final SQLiteDatabase getWritableDatabase()
  {
    ...
    for (;;)
    {
      try
      {
        SQLiteDatabase localSQLiteDatabase1 = this.e;
        ...
        {
          c.c("[db] getWritableDatabase error count %d", new Object[] { Integer.valueOf(i) });
          if (i != 5) {
            break label72;
          }
        }
        c.d("[db] error get DB failed", new Object[0]);
        continue;
        try
        {
          Thread.sleep(200L);
    ...
    SQLiteDatabase localSQLiteDatabase2 = this.e;
  ...
  public final void onCreate(SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    try
    {
      ...
      while (i < 7)
      {
        ...
        c.g("[db] Table:%s", new Object[] { arrayOfString1[0] });
  ...
  public final void onDowngrade(SQLiteDatabase paramSQLiteDatabase, int paramInt1, int paramInt2)
  {
    try
    {
      com.tencent.tvkbeacon.core.info.d.a(this.a);
      if (Integer.parseInt(com.tencent.tvkbeacon.core.info.d.c()) >= 11)
      {
        c.g("[db] Downgrade a db  [%s] from v %d to  v%d , deleted all tables!", new Object[] { "tvkbeacon_db", Integer.valueOf(paramInt1), Integer.valueOf(paramInt2) });
  ...
  public final void onUpgrade(SQLiteDatabase paramSQLiteDatabase, int paramInt1, int paramInt2)
  {
    try
    {
      c.g("[db] Upgrade a db  [%s] from v %d to v %d , deleted all tables!", new Object[] { "tvkbeacon_db", Integer.valueOf(paramInt1), Integer.valueOf(paramInt2) });
      a(paramSQLiteDatabase);
      return;
    }
    finally
 ...
 * Qualified Name:     com.tencent.tvkbeacon.core.a.a.e
