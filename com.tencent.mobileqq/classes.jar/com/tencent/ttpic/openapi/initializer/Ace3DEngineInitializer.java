  ...
  extends Feature
{
  ...
  static
  {
    modelFiles = new ModelInfo[] { new ModelInfo(true, "filament", "filament_head.filamat", 0), new ModelInfo(true, "filament", "head_index.txt", 0), new ModelInfo(true, "filament", "head_vertex.txt", 0), new ModelInfo(true, "filament", "fur.filamat", 0), new ModelInfo(true, "filament", "furLight.filamat", 0), new ModelInfo(true, "filament", "bloom_blur.filamat", 0), new ModelInfo(true, "filament", "bloom_mix.filamat", 0), new ModelInfo(true, "filament", "reflection.filamat", 0), new ModelInfo(true, "filament", "locationInit.filamat", 0), new ModelInfo(true, "filament", "faceMesh.filamat", 0) };
  }
