  ...
  extends Feature
{
  ...
  public boolean loadRapidModelFrom(String arg1, String paramString2, boolean paramBoolean1, boolean paramBoolean2, int paramInt1, int paramInt2, int paramInt3)
  {
    for (;;)
    {
      try
      {
        LogUtils.i("TNNHumanSegCpuInitializer", "loadRapidNetModelImpl");
        ...
        localObject = RapidnetModelManager.copyIfInAssets(???, ((StringBuilder)localObject).toString(), FeatureManager.Features.RAPID_NET_SEG_CPU.getFinalResourcesDir());
        StringBuilder localStringBuilder = new StringBuilder();
        localStringBuilder.append(paramString2);
        localStringBuilder.append(".rapidproto.wmc");
        paramString2 = RapidnetModelManager.copyIfInAssets(???, localStringBuilder.toString(), FeatureManager.Features.RAPID_NET_SEG_CPU.getFinalResourcesDir());
        ...
        if ((FileUtils.isFileExist((String)localObject)) && (FileUtils.isFileExist(paramString2)))
        {
          ...
          synchronized (this.TNNSegHuman)
          {
            paramInt1 = this.TNNSegHuman.init(paramString2, (String)localObject, "ARM");
          }
          if (paramInt1 != 0)
          {
            ??? = new StringBuilder();
            ...
            ???.append(paramInt1);
            LogUtils.d("TNNHumanSegCpuInitializer", ???.toString());
          }
          else
          {
            ??? = new StringBuilder();
