  ...
  extends VideoFilterBase
{
  ...
  private static final String VERTEX_SHADER = "attribute vec4 position;\nattribute vec2 uvTexCoords;\nvarying vec2 v_uvTexCoords;\nvarying vec2 v_inputTexCoords;\nuniform vec2 faceDetSize; \nvoid main()\n{\n  gl_Position = vec4(position.x / faceDetSize.x * 2.0 - 1.0, 1.0 - position.y / faceDetSize.y * 2.0, -position.z / 2.0 / max(faceDetSize.x, faceDetSize.y), position.w);\n  v_uvTexCoords = vec2(uvTexCoords.x, 1.0 - uvTexCoords.y);\n  v_inputTexCoords = vec2(position.x / faceDetSize.x, 1.0 - position.y / faceDetSize.y); \n}\n";
  ...
  public void ApplyGLSLFilter()
  {
    ...
    this.mVertexBuffer = FloatBuffer.wrap(FaceKitInitializer.facekitUV);
    ...
    IntBuffer localIntBuffer = IntBuffer.wrap(FaceKitInitializer.facekitIndices);
  ...
  public void OnDrawFrameGLSL()
  {
    ...
    GLES20.glBindBuffer(34962, this.mBuffer[0]);
    GLES20.glBufferSubData(34962, 0, 77340, this.mVertexBuffer);
    ...
    GLES20.glVertexAttribPointer(getAttribParam("uvTexCoords").handle, 2, 5126, false, 8, 77340);
    GLES20.glBindBuffer(34963, this.mBuffer[1]);
  }
  ...
  public boolean renderTexture(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    GLES20.glDrawElements(4, 36180, 5125, 0);
    GLES20.glBindBuffer(34962, 0);
    GLES20.glBindBuffer(34963, 0);
  ...
  public void updatePreview(Object paramObject)
  {
    ...
    if ((paramObject instanceof PTDetectInfo))
    {
      ...
      arrayOfFloat = paramObject.faceKitFaceVertices;
      if ((arrayOfFloat != null) && (arrayOfFloat.length >= 19335)) {
        break label35;
      }
    }
    label35:
    ...
    this.mVertexBuffer.put(paramObject.faceKitFaceVertices, 0, paramObject.faceKitFaceVertices.length).position(0);
  }
 ...
 * Qualified Name:     com.tencent.ttpic.openapi.filter.Cosmetic3DFilter
