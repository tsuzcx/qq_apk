...
public class FaceFeatureAndTeethWhitenFilterSingle
  extends VideoFilterBase
{
  ...
  private boolean mRenderLipsLut;
  private String maskDir = "assets://realtimeBeauty";
  ...
  public FaceFeatureAndTeethWhitenFilterSingle()
  {
  ...
  {
    Bitmap localBitmap;
    if (!this.isMergeImageReady)
    {
      localBitmap = BitmapUtils.decodeSampleBitmap(AEModule.getContext(), this.maskDir + File.separator + this.mergeImage, 1);
    ...
    {
      localBitmap = BitmapUtils.decodeSampleBitmap(AEModule.getContext(), this.maskDir + File.separator + "lipsMask.png", 1);
      if (BitmapUtils.isLegal(localBitmap))
      {
    ...
    {
      localBitmap = BitmapUtils.decodeSampleBitmap(AEModule.getContext(), this.maskDir + File.separator + "teeth.png", 1);
      if (BitmapUtils.isLegal(localBitmap))
      {
  ...
  public Frame render(Frame paramFrame, List<List<PointF>> paramList)
  {
      ...
      if (paramList != null)
      {
        ...
        if (this.mRenderLipsLut)
        {
          ...
          for (;;)
          {
            ...
            localObject = VideoMaterialUtil.copyList((List)localIterator.next());
            FaceOffUtil.initFacePositions(getFullCoords((List)localObject), (int)(this.width * this.mFaceDetScale), (int)(this.height * this.mFaceDetScale), this.faceVertices);
            paramList = this.mCopyFilter.RenderProcess(paramFrame.getTextureId(), paramFrame.width, paramFrame.height);
            updateParam((List)localObject, this.faceVertices);
            OnDrawFrameGLSL();
    ...
    if (localAttributeParam != null)
    {
      ...
      if (localAttributeParam.vertices.length / localAttributeParam.perVertexFloat == 690)
      {
        ...
        if (localAttributeParam != null)
        {
          bool1 = bool2;
          if (localAttributeParam.vertices.length / localAttributeParam.perVertexFloat == 690) {
            bool1 = super.renderTexture(paramInt1, paramInt2, paramInt3);
          }
        }
      }
    }
  ...
  public void setLipsLut(String paramString)
  {
    ...
    for (localBitmap = BitmapUtils.decodeSampledBitmapFromFile(paramString, 1); BitmapUtils.isLegal(localBitmap); localBitmap = BitmapUtils.decodeSampleBitmapFromAssets(AEModule.getContext(), FileUtils.getRealPath(paramString), 1))
    {
      ...
      setLipsLutTexture(this.texture[3]);
      return;
    }
  ...
  public void setMaskDir(String paramString)
  {
    this.maskDir = paramString;
  }
 ...
 * Qualified Name:     com.tencent.ttpic.openapi.filter.FaceFeatureAndTeethWhitenFilterSingle
