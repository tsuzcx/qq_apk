  ...
  extends BaseFilter
{
  ...
  public ComicEffectFilter(StickerItem paramStickerItem, String paramString)
  {
    ...
    paramString = this.mDataPath + File.separator + this.mComicLutFilter;
    if ((this.mComicLutFilter == null) || (!FileUtils.exists(paramString))) {}
    for (paramString = getBitmap(this.mDataPath + File.separator + "filterEffect.lut");; paramString = getBitmap(paramString))
    {
