...
public class MatrixUtil
{
  ...
  public static float[] compose(float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, float[] paramArrayOfFloat3)
  {
    ...
    {
      double d = paramArrayOfFloat3[i] * 180.0F;
      Double.isNaN(d);
  ...
  public static void decompose(float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, float[] paramArrayOfFloat3, float[] paramArrayOfFloat4)
  {
    if (paramArrayOfFloat1 != null)
    {
      ...
      float f6 = (f11 * f5 - f4 * f9) * f1 + (f4 * f8 - f10 * f5) * f2 + (f10 * f9 - f11 * f8) * f3;
  ...
  {
    float f1 = Math.max(paramInt1, paramInt2);
    float f2 = -paramInt1;
    float f3 = paramInt1;
    float f4 = -paramInt2;
    float f5 = paramInt2;
    Matrix.frustumM(mProjectionMatrix, 0, f2 * 0.01F, f3 * 0.01F, f4 * 0.01F, f5 * 0.01F, f1 * 0.02F, f1 * 2.0F);
  ...
  public static float[] getScale(float[] paramArrayOfFloat)
  {
    ...
    if (paramArrayOfFloat != null)
    {
      ...
      arrayOfFloat[1] = f11;
      arrayOfFloat[2] = f12;
      if ((f5 * f9 - f6 * f8) * f1 + (f6 * f7 - f4 * f9) * f2 + (f4 * f8 - f5 * f7) * f3 < 0.0F) {
        while (i < arrayOfFloat.length)
        {
          arrayOfFloat[i] = (-arrayOfFloat[i]);
          i += 1;
  ...
  public static void printMat(String paramString, float[] paramArrayOfFloat)
  {
    ...
    while (i < 4)
    {
      ...
      while (j < 4)
      {
        ...
        paramString.append(paramArrayOfFloat[(i * 4 + j)]);
        paramString.append(", ");
  ...
  public static float[] rotate(float[] paramArrayOfFloat1, float[] paramArrayOfFloat2)
  {
    ...
    while (i < arrayOfFloat.length)
    {
      double d = paramArrayOfFloat2[i] * 180.0F;
      Double.isNaN(d);
      arrayOfFloat[i] = ((float)(d / 3.141592653589793D));
      i += 1;
    }
  ...
  public static void setRotateEulerM(float[] paramArrayOfFloat, int paramInt, float paramFloat1, float paramFloat2, float paramFloat3)
  {
    ...
    paramArrayOfFloat[(paramInt + 4)] = (-paramFloat2 * f3);
    paramArrayOfFloat[(paramInt + 8)] = f2;
    paramArrayOfFloat[(paramInt + 12)] = 0.0F;
    paramArrayOfFloat[(paramInt + 1)] = (f5 * paramFloat3 + paramFloat1 * f3);
    paramArrayOfFloat[(paramInt + 5)] = (-f5 * f3 + paramFloat1 * paramFloat3);
    paramArrayOfFloat[(paramInt + 9)] = (-f1 * paramFloat2);
    paramArrayOfFloat[(paramInt + 13)] = 0.0F;
    paramArrayOfFloat[(paramInt + 2)] = (-f4 * paramFloat3 + f1 * f3);
    paramArrayOfFloat[(paramInt + 6)] = (f4 * f3 + f1 * paramFloat3);
