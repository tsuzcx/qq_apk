...
public class HumanSegmentImpl
{
  ...
  private long shareContextHandler = -1L;
  ...
  public void init()
  {
    if ((this.mSegGLThread != null) && (this.shareContextHandler != EGL14.eglGetCurrentContext().getNativeHandle()))
    {
      this.mSegGLThread.destroy();
      this.mSegGLThread = null;
    }
    if ((ApiHelper.hasJellyBeanMR1()) && (this.mSegGLThread == null))
    {
      ...
      this.shareContextHandler = localEGLContext.getNativeHandle();
      this.mSegGLThread = new HumanSegmentGLThread(localEGLContext, getHumanSegmentInitializer());
