      ...
      for (;;)
      {
        ...
        synchronized (this.this$0.mCurrentState)
        {
          ...
          if (this.this$0.mCurrentState.equalState(new int[] { 8 }))
          {
            ...
            int i = this.this$0.mARecorder.read(this.this$0.mBuffer, 0, AudioRecorderAndChangerForKitKat.AUDIO_INPUT_BUFFER_SIZE);
            if ((i != -3) && (i != -2) && (i > 0))
            {
              localObject2 = this.this$0;
              ((AudioRecorderAndChangerForKitKat)localObject2).mHasRecordLength += i;
              localObject2 = this.this$0;
              ((AudioRecorderAndChangerForKitKat)localObject2).onRecording(((AudioRecorderAndChangerForKitKat)localObject2).mBuffer, i);
            }
            else
            {
          ...
          LogUtils.d("SimpleRecordThread", ((StringBuilder)localObject2).toString());
        }
      }
    }
    for (;;)
