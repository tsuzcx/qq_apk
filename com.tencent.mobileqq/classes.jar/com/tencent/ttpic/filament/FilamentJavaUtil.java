...
import com.google.android.filament.gltfio.KtxLoader.Options;
...
public class FilamentJavaUtil
{
  ...
  static
  {
    TAG = FilamentJavaUtil.class.getSimpleName();
    ...
    for (;;)
    {
      ...
      while (paramList.hasNext())
      {
        ...
        if ((localFaceStatus.denseFaceModel != null) && (localFaceStatus.denseFaceModel[0] != 0.0F) && (localFaceStatus.transform[15] >= 1.0F))
        {
          ...
          {
            if (((GLBItemJava)paramList1.get(i)).positionType == FilamentJavaUtil.PositionType.DYNAMIC.value) {
              return true;
            }
            i += 1;
          }
      ...
      while (i < paramList1.size())
      {
        if (((GLBItemJava)paramList1.get(i)).positionType == FilamentJavaUtil.PositionType.STATIC.value) {
          return true;
        }
        i += 1;
      }
  ...
  public static IndirectLight loadIndirectLight(Context paramContext, Engine paramEngine, String paramString, int paramInt)
  {
    ...
    do
    {
      ...
      {
        return paramContext;
        paramEngine = KtxLoader.createIndirectLight(paramEngine, ByteBuffer.wrap(FileUtils.loadByteArray(paramContext, paramString)), new KtxLoader.Options());
        paramContext = paramEngine;
      } while (paramEngine == null);
      paramContext = paramEngine;
    } while (paramInt <= 0);
    paramEngine.setIntensity(paramInt);
    return paramEngine;
  }
  ...
  public static void seperateGlbs(List<GLBItemJava> paramList1, List<GLBItemJava> paramList2, List<GLBItemJava> paramList3)
  {
    ...
    for (;;)
    {
      ...
      while (paramList1.hasNext())
      {
        ...
        if (localGLBItemJava.positionType == FilamentJavaUtil.PositionType.DYNAMIC.value) {
 ...
 * Qualified Name:     com.tencent.ttpic.filament.FilamentJavaUtil
