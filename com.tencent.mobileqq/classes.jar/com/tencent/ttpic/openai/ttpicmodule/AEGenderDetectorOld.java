...
public class AEGenderDetectorOld
{
  ...
  private AEGenderDetectorOld.GenderDetectOldImpl mGenderDetectOldImpl;
  ...
  private List<AEGenderDetectorOld.TraceFaceItem> mTraceFcaeList;
  ...
  private AEGenderDetectorOld.TraceFaceItem creatTraceFaceItem(FaceInfo paramFaceInfo)
  {
    long l = this.sFaceIndexCount;
    this.sFaceIndexCount = (1L + l);
    return new AEGenderDetectorOld.TraceFaceItem(this, l, paramFaceInfo);
  }
  ...
  private void realDectect(Bitmap paramBitmap, int paramInt1, int paramInt2, List<FaceInfo> paramList)
  {
    ...
    if (this.mGenderDetectOldImpl == null) {
      this.mGenderDetectOldImpl = new AEGenderDetectorOld.GenderDetectOldImpl(this, null);
    }
  ...
  private void touchGendersByFaceIDS()
  {
    ...
    do
    {
      ...
      localObject2 = AEGenderDetectorOld.GenderDetectOldImpl.access$100(this.mGenderDetectOldImpl);
    ...
    Object localObject1 = (AEGenderDetectorOld.GenderParams)((Map)localObject2).get(Long.valueOf(l));
    int i;
    label129:
    label161:
    label212:
    ...
    {
      i = ((AEGenderDetectorOld.GenderParams)localObject1).genderType;
      localFaceInfo.curGender = i;
      if (localObject1 != null) {
        break label333;
      }
      localObject1 = new AEGenderDetectorOld.GenderParams(this);
      ((AEGenderDetectorOld.GenderParams)localObject1).genderType = GenderType.DEFAULT.value;
      ...
      if (((AEGenderDetectorOld.GenderParams)localObject1).genderType <= 0) {
        break label420;
      }
      i += ((AEGenderDetectorOld.GenderParams)localObject1).genderType - 1;
    ...
    for (;;)
    {
      ...
      break label129;
      if (((AEGenderDetectorOld.GenderParams)localObject1).genderType == GenderType.DEFAULT.value)
      {
      ...
      for (;;)
      {
        ((AEGenderDetectorOld.GenderParams)localObject1).genderType = i;
        break label161;
        label368:
        break;
        label370:
  ...
  public void updateFacesTrack(List<FaceInfo> paramList)
  {
    ...
    for (;;)
    {
      ...
      while (i < j)
      {
        ((AEGenderDetectorOld.TraceFaceItem)this.mTraceFcaeList.get(i)).updatePoints((FaceInfo)paramList.get(i));
        i += 1;
      }
    }
    ...
    if (k > j)
    {
      ...
      if (localIterator1.hasNext())
      {
        ...
        {
          AEGenderDetectorOld.TraceFaceItem localTraceFaceItem = (AEGenderDetectorOld.TraceFaceItem)localIterator2.next();
    ...
    for (;;)
    {
      ...
      if (paramList != null)
      {
        ...
        Log.i("GenderDetector", "匹配上一帧人脸，ID：" + AEGenderDetectorOld.TraceFaceItem.access$900(paramList));
        break label208;
      }
