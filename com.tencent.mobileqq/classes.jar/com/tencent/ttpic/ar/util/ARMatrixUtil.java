...
public class ARMatrixUtil
{
  ...
  public static int touchTopMargin;
  ...
  private static void changeToSimpleOrientationProvider()
  {
    ...
    orientationProvider = new ImprovedOrientationSensor2Provider((SensorManager)VideoGlobalContext.getContext().getSystemService("sensor"));
    orientationProvider.start();
    Log.e("ARMatrixUtil", "changeToSimpleOrientationProvider!");
  }
  ...
  public static void setTouchTopMargin(int paramInt)
  {
    touchTopMargin = paramInt;
  }
  ...
  public static void startOrientationSensor()
  {
    ...
    {
      canUseImprovedSensorProvider = hasGyroscope();
      orientationProvider = new ImprovedOrientationSensor2Provider((SensorManager)VideoGlobalContext.getContext().getSystemService("sensor"));
    }
    orientationProvider.start();
  }
