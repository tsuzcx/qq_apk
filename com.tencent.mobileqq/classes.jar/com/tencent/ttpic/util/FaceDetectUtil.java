...
public class FaceDetectUtil
{
  ...
  public static List<FaceParam> detectFacesByBitmap(Bitmap paramBitmap, boolean paramBoolean)
  {
    ArrayList localArrayList = new ArrayList();
    if (paramBitmap == null) {}
    TTpicBitmapFaceDetect localTTpicBitmapFaceDetect;
    do
    {
      return localArrayList;
      localTTpicBitmapFaceDetect = new TTpicBitmapFaceDetect();
    ...
    } while (!(localTTpicBitmapFaceDetect instanceof TTpicBitmapFaceDetect));
