...
public class XmlParseUtils
{
  ...
  {
    ParticleConfig localParticleConfig;
    if ((paramString != null) && (!paramString.equals("")))
    {
      localParticleConfig = new ParticleConfig();
      ...
      try
      {
        ...
        for (int i = localXmlPullParser.getEventType(); i != 1; i = localXmlPullParser.next())
        {
          ...
          if (i == 2)
          {
            boolean bool = "startColor".equals(paramString);
            Object localObject1;
            Object localObject2;
            String str;
            Object localObject3;
            ...
            {
              bool = "sourcePosition".equals(paramString);
              if (bool)
              {
              ...
              {
                bool = "particleLifeSpan".equals(paramString);
                if (bool)
                {
                ...
                else if ("maxRadius".equals(paramString))
                {
                  paramString = localXmlPullParser.getAttributeValue(null, "value");
