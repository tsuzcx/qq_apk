  ...
  extends VideoFilterBase
{
  ...
  public FaceCopyFilter(String paramString1, String paramString2, StickerItem paramStickerItem)
  {
  ...
  public void renderProcess()
  {
    ...
    {
      return;
      List localList = faceSwapFacePoint(SwitchFaceUtil.getFullCoords(VideoMaterialUtil.copyList((List)this.mFaceLists.get(0))));
      VideoMaterialUtil.flipYPoints(localList, (int)(this.height * this.mScreenScale));
      setTexCords(SwitchFaceUtil.initMaterialFaceTexCoords(localList, (int)(this.width * this.mScreenScale), (int)(this.height * this.mScreenScale), this.texVertices));
      int i = 1;
      while (i < this.mFaceLists.size())
      {
        localList = faceSwapFacePoint(SwitchFaceUtil.getFullCoords(VideoMaterialUtil.copyList((List)this.mFaceLists.get(i))));
        VideoMaterialUtil.flipYPoints(localList, (int)(this.height * this.mScreenScale));
        setPositions(SwitchFaceUtil.initFacePositions(localList, (int)(this.width * this.mScreenScale), (int)(this.height * this.mScreenScale), this.faceVertices));
        setCoordNum(138);
        OnDrawFrameGLSL();
        renderTexture(this.mFaceTex, this.width, this.height);
        i += 1;
