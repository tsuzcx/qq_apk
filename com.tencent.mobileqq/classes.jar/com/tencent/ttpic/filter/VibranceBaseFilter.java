  ...
  extends BaseFilter
{
  ...
  public VibranceBaseFilter()
  {
    ...
    initParams();
    this.brightnessLutBitmap = TTPicFilterFactoryLocal.getBitmapFromEncryptedFile("assets://luts/brightness_lut.png");
    this.vibranceLeftLutBitmap = TTPicFilterFactoryLocal.getBitmapFromEncryptedFile("assets://luts/vibrance_left_lut.png");
    this.vibranceRightLutBitmap = TTPicFilterFactoryLocal.getBitmapFromEncryptedFile("assets://luts/vibrance_right_lut.png");
  }
  ...
  public void apply()
  {
    GlUtil.glGenTextures(this.lutTex.length, this.lutTex, 0);
  ...
  {
    addParam(new UniformParam.FloatParam("contrast", paramFloat / 2.0F + 1.0F));
  }
