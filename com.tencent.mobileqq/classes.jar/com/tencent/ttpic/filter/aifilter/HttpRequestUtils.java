  ...
  implements NetworkRequest
{
  ...
  public static void writeBytesToFile(Context paramContext, byte[] paramArrayOfByte)
  {
    ...
    //   18: aload 4
    //   20: aload_0
    //   21: invokevirtual 124	android/content/Context:getFilesDir	()Ljava/io/File;
    //   24: invokevirtual 129	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   27: invokevirtual 86	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   30: pop
    //   31: aload 4
    //   33: getstatic 132	java/io/File:separator	Ljava/lang/String;
    ...
    //   47: pop
    //   48: aload 4
    //   50: invokevirtual 100	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   53: astore_0
    //   54: aload_1
    //   55: ifnonnull +4 -> 59
    //   58: return
    //   59: new 150	java/io/FileOutputStream
    //   62: dup
    //   63: new 126	java/io/File
    //   66: dup
    //   67: aload_0
    //   68: invokespecial 153	java/io/File:<init>	(Ljava/lang/String;)V
    //   71: invokespecial 156	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   74: astore_0
    //   75: aload_0
    //   76: aload_1
    //   77: invokevirtual 160	java/io/FileOutputStream:write	([B)V
    //   80: aload_0
    //   81: invokevirtual 163	java/io/FileOutputStream:close	()V
    //   84: return
    //   85: astore_2
    //   86: aload_0
    //   87: astore_1
    ...
    //   100: ifnull +7 -> 107
    //   103: aload_1
    //   104: invokevirtual 163	java/io/FileOutputStream:close	()V
    //   107: aload_0
    //   108: athrow
    //   109: aload_0
    //   110: ifnull +7 -> 117
    //   113: aload_0
    //   114: invokevirtual 163	java/io/FileOutputStream:close	()V
    //   117: return
    //   118: astore_0
    //   119: aload_3
    //   120: astore_0
