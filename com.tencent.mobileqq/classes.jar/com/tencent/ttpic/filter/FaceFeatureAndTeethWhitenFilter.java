...
public class FaceFeatureAndTeethWhitenFilter
  extends VideoFilterBase
{
  ...
  {
    Bitmap localBitmap = VideoMemoryManager.getInstance().getBeautyCacheBitmap(this.softlightImage);
    AEOpenRenderConfig.checkStrictMode(BitmapUtils.isLegal(localBitmap), "softlightBitmap is illegal");
    if ((!this.isSoftLiteImageReady) && (BitmapUtils.isLegal(localBitmap)))
    {
    ...
    localBitmap = VideoMemoryManager.getInstance().getBeautyCacheBitmap(this.multiplyImage);
    AEOpenRenderConfig.checkStrictMode(BitmapUtils.isLegal(localBitmap), "multiplyBitmap is illegal");
    if ((!this.isMultiplyImageReady) && (BitmapUtils.isLegal(localBitmap)))
    {
    ...
    localBitmap = VideoMemoryManager.getInstance().getBeautyCacheBitmap(this.normalImage);
    AEOpenRenderConfig.checkStrictMode(BitmapUtils.isLegal(localBitmap), "multiplyBitmap is illegal");
    if ((!this.isNormalImageReady) && (BitmapUtils.isLegal(localBitmap)))
    {
    ...
    localBitmap = VideoMemoryManager.getInstance().getBeautyCacheBitmap("lipsMask.png");
    AEOpenRenderConfig.checkStrictMode(BitmapUtils.isLegal(localBitmap), "multiplyBitmap is illegal");
    if ((!this.isToothWhitenMaskReady) && (BitmapUtils.isLegal(localBitmap)))
    {
      GlUtil.loadTexture(this.texture[3], localBitmap);
      addParam(new UniformParam.TextureParam("inputImageTexture5", this.texture[3], 33989));
      this.isToothWhitenMaskReady = true;
    }
    localBitmap = VideoMemoryManager.getInstance().getBeautyCacheBitmap("teeth.png");
    AEOpenRenderConfig.checkStrictMode(BitmapUtils.isLegal(localBitmap), "multiplyBitmap is illegal");
    if ((!this.isToothWhitenLutReady) && (BitmapUtils.isLegal(localBitmap)))
    {
      GlUtil.loadTexture(this.texture[4], localBitmap);
  ...
  public void setLipsLutTexture(int paramInt)
  {
    if (paramInt > 0)
    {
      addParam(new UniformParam.TextureParam("inputImageTexture7", paramInt, 33991));
      return;
    }
    addParam(new UniformParam.TextureParam("inputImageTexture7", 0, 33991));
    setLipsLutAlpha(0);
  ...
  {
    setPositions(paramArrayOfFloat1);
    if ((paramArrayOfFloat2 != null) && (paramArrayOfFloat2.length > 0)) {
      addAttribParam("pointsVisValue", paramArrayOfFloat2);
    }
 ...
 * Qualified Name:     com.tencent.ttpic.filter.FaceFeatureAndTeethWhitenFilter
