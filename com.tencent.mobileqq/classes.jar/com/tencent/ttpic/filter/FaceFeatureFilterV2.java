...
public class FaceFeatureFilterV2
  extends VideoFilterBase
{
  ...
  private boolean initFaceImage()
  {
    ...
    return this.isMergeImageReady;
  }
  
  private void initFaceTexCoords()
  {
    setTexCords(FaceOffUtil.initMaterialFaceTexCoords(FaceOffUtil.getFullCoords(FaceOffUtil.genPoints(this.item.facePoints), 5.0F), this.faceImageWidth, this.faceImageHeight, this.texVertices));
  }
 ...
 * Qualified Name:     com.tencent.ttpic.filter.FaceFeatureFilterV2
