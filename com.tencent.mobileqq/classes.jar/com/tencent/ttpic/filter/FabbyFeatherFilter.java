  ...
  extends BaseFilter
{
  ...
  public void ApplyGLSLFilter(boolean paramBoolean, float paramFloat1, float paramFloat2)
  {
    ...
    addParam(new Param.FloatParam("stepX", this.stepX));
    addParam(new Param.FloatParam("stepY", this.stepY));
    addParam(new Param.FloatParam("featherWidthInPixel", this.featherWidthInPixel));
