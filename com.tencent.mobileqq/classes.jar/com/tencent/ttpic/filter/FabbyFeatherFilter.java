  ...
  extends BaseFilter
{
  ...
  {
    addParam(new UniformParam.TextureParam("inputImageTexture2", this.mMaskTex, 33986));
    addParam(new UniformParam.FloatParam("stepX", this.stepX));
    addParam(new UniformParam.FloatParam("stepY", this.stepY));
    addParam(new UniformParam.FloatParam("featherWidthInPixel", this.featherWidthInPixel));
