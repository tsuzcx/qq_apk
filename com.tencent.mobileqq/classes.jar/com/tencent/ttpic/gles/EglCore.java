...
public final class EglCore
{
  ...
  public EglCore(EGLContext paramEGLContext, int paramInt)
  {
    ...
    Log.d(TAG, "EGLContext created, client version " + paramEGLContext[0]);
  }
  ...
  private void checkEglError(String paramString)
  {
    ...
    if (i != 12288) {
      Log.e(TAG, paramString + ": EGL error: 0x" + Integer.toHexString(i));
    }
  }
  ...
  private EGLConfig getConfig(int paramInt1, int paramInt2)
  {
    ...
    {
      Log.w(TAG, "unable to find RGB8888 / " + paramInt2 + " EGLConfig");
      return null;
    }
  ...
  public static void logCurrent(String paramString)
  {
    ...
    Log.i(TAG, "Current EGL (" + paramString + "): display=" + localEGLDisplay + ", context=" + localEGLContext + ", surface=" + localEGLSurface);
  }
