...
public class Texture2dProgram
{
  ...
  public Texture2dProgram(ProgramType paramProgramType)
  {
    ...
    switch (1.$SwitchMap$com$tencent$ttpic$gles$Texture2dProgram$ProgramType[paramProgramType.ordinal()])
    {
    default: 
    ...
    Log.d(TAG, "Created program " + this.mProgramHandle + " (" + paramProgramType + ")");
