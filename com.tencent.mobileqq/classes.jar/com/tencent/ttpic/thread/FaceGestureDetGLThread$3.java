  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if ((localObject != null) && (((List)localObject).size() > 0) && (((List)((List)localObject).get(0)).size() > 0))
    {
      ...
      FaceGestureDetGLThread.access$800((FaceGestureDetGLThread)localObject, i, j, k, m, this.val$width, this.val$height, FaceGestureDetGLThread.access$700((FaceGestureDetGLThread)localObject));
      return;
    }
