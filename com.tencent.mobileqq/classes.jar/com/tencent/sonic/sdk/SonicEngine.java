...
public class SonicEngine
{
  ...
  {
    public void onSessionStateChange(SonicSession paramAnonymousSonicSession, int paramAnonymousInt1, int paramAnonymousInt2, Bundle paramAnonymousBundle)
    {
      SonicUtils.log("SonicSdk_SonicEngine", 3, "onSessionStateChange:session(" + paramAnonymousSonicSession.sId + ") from state " + paramAnonymousInt1 + " -> " + paramAnonymousInt2);
      ...
      default: 
        return;
      case 1: 
        SonicEngine.this.runningSessionHashMap.put(paramAnonymousSonicSession.id, paramAnonymousSonicSession);
        return;
      }
      SonicEngine.this.runningSessionHashMap.remove(paramAnonymousSonicSession.id);
    }
  };
  ...
  private SonicSession internalCreateSession(String paramString1, String paramString2, SonicSessionConfig paramSonicSessionConfig)
  {
    ...
    {
      if (paramSonicSessionConfig.sessionMode == 1) {}
      for (paramString1 = new QuickSonicSession(paramString1, paramString2, paramSonicSessionConfig);; paramString1 = new StandardSonicSession(paramString1, paramString2, paramSonicSessionConfig))
      {
  ...
  public SonicSession createSession(@NonNull String paramString, @NonNull SonicSessionConfig paramSonicSessionConfig)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: invokevirtual 249	com/tencent/sonic/sdk/SonicEngine:isSonicAvailable	()Z
    //   6: ifeq +64 -> 70
    //   9: aload_1
    //   10: aload_2
    //   11: getfield 252	com/tencent/sonic/sdk/SonicSessionConfig:IS_ACCOUNT_RELATED	Z
    //   14: invokestatic 253	com/tencent/sonic/sdk/SonicEngine:makeSessionId	(Ljava/lang/String;Z)Ljava/lang/String;
    //   17: astore 4
    //   19: aload 4
    //   21: invokestatic 164	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   24: ifne +60 -> 84
    //   27: aload_0
    //   28: aload_2
    //   29: aload 4
    //   31: iconst_1
    //   32: invokespecial 255	com/tencent/sonic/sdk/SonicEngine:lookupSession	(Lcom/tencent/sonic/sdk/SonicSessionConfig;Ljava/lang/String;Z)Lcom/tencent/sonic/sdk/SonicSession;
    //   35: astore_3
    //   36: aload_3
    //   37: ifnull +12 -> 49
    //   40: aload_3
    //   41: aload_1
    //   42: invokevirtual 258	com/tencent/sonic/sdk/SonicSession:setIsPreload	(Ljava/lang/String;)V
    //   45: aload_0
    //   46: monitorexit
    //   47: aload_3
    //   48: areturn
    //   49: aload_0
    //   50: aload 4
    //   52: invokespecial 260	com/tencent/sonic/sdk/SonicEngine:isSessionAvailable	(Ljava/lang/String;)Z
    //   55: ifeq -10 -> 45
    //   58: aload_0
    //   59: aload 4
    //   61: aload_1
    //   62: aload_2
    //   63: invokespecial 262	com/tencent/sonic/sdk/SonicEngine:internalCreateSession	(Ljava/lang/String;Ljava/lang/String;Lcom/tencent/sonic/sdk/SonicSessionConfig;)Lcom/tencent/sonic/sdk/SonicSession;
    //   66: astore_3
    //   67: goto -22 -> 45
    //   70: aload_0
    ...
    //   76: bipush 6
    //   78: ldc_w 264
    //   81: invokevirtual 131	com/tencent/sonic/sdk/SonicRuntime:log	(Ljava/lang/String;ILjava/lang/String;)V
    //   84: aconst_null
    //   85: astore_3
    //   86: goto -41 -> 45
    //   89: astore_1
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	94	0	this	SonicEngine
    //   0	94	1	paramString	String
    //   0	94	2	paramSonicSessionConfig	SonicSessionConfig
    //   35	51	3	localSonicSession	SonicSession
    //   17	43	4	str	String
    // Exception table:
    //   from	to	target	type
    //   2	36	89	finally
  ...
  public boolean preCreateSession(@NonNull String paramString, @NonNull SonicSessionConfig paramSonicSessionConfig, long paramLong, int paramInt)
  {
    ...
    //   4: monitorenter
    //   5: aload_0
    //   6: invokevirtual 249	com/tencent/sonic/sdk/SonicEngine:isSonicAvailable	()Z
    //   9: ifeq +77 -> 86
    //   12: aload_1
    //   13: aload_2
    //   14: getfield 252	com/tencent/sonic/sdk/SonicSessionConfig:IS_ACCOUNT_RELATED	Z
    //   17: invokestatic 253	com/tencent/sonic/sdk/SonicEngine:makeSessionId	(Ljava/lang/String;Z)Ljava/lang/String;
    //   20: astore 9
    ...
    //   92: bipush 6
    //   94: ldc_w 307
    //   97: invokevirtual 131	com/tencent/sonic/sdk/SonicRuntime:log	(Ljava/lang/String;ILjava/lang/String;)V
    //   100: goto -46 -> 54
    //   103: astore_1
    //   104: aload_0
    //   105: monitorexit
  ...
  public boolean removeSessionCache(@NonNull String paramString)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 34	com/tencent/sonic/sdk/SonicEngine:preloadSessionPool	Ljava/util/concurrent/ConcurrentHashMap;
    //   6: aload_1
    //   7: invokevirtual 168	java/util/concurrent/ConcurrentHashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   10: checkcast 93	com/tencent/sonic/sdk/SonicSession
    //   13: astore_3
    //   14: aload_3
    //   15: ifnull +51 -> 66
    //   18: aload_3
    //   19: invokevirtual 191	com/tencent/sonic/sdk/SonicSession:destroy	()V
    //   22: aload_0
    //   23: getfield 34	com/tencent/sonic/sdk/SonicEngine:preloadSessionPool	Ljava/util/concurrent/ConcurrentHashMap;
    //   26: aload_1
    //   27: invokevirtual 188	java/util/concurrent/ConcurrentHashMap:remove	(Ljava/lang/Object;)Ljava/lang/Object;
    //   30: pop
    //   31: aload_0
    //   32: getfield 43	com/tencent/sonic/sdk/SonicEngine:runtime	Lcom/tencent/sonic/sdk/SonicRuntime;
    //   35: ldc 10
    //   37: iconst_4
    //   38: new 114	java/lang/StringBuilder
    //   41: dup
    //   42: invokespecial 115	java/lang/StringBuilder:<init>	()V
    //   45: ldc 149
    ...
    //   63: invokevirtual 131	com/tencent/sonic/sdk/SonicRuntime:log	(Ljava/lang/String;ILjava/lang/String;)V
    //   66: aload_0
    //   67: getfield 36	com/tencent/sonic/sdk/SonicEngine:runningSessionHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   70: aload_1
    ...
    //   106: invokevirtual 127	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   109: invokevirtual 131	com/tencent/sonic/sdk/SonicRuntime:log	(Ljava/lang/String;ILjava/lang/String;)V
    //   112: aload_1
    //   113: invokestatic 363	com/tencent/sonic/sdk/SonicUtils:removeSessionCache	(Ljava/lang/String;)V
    //   116: iconst_1
    //   117: istore_2
    //   118: aload_0
    //   119: monitorexit
    ...
    //   126: ldc 10
    //   128: bipush 6
    //   130: new 114	java/lang/StringBuilder
    //   133: dup
    //   134: invokespecial 115	java/lang/StringBuilder:<init>	()V
    //   137: ldc 149
    ...
    //   155: invokevirtual 131	com/tencent/sonic/sdk/SonicRuntime:log	(Ljava/lang/String;ILjava/lang/String;)V
    //   158: iconst_0
    //   159: istore_2
    //   160: goto -42 -> 118
    //   163: astore_1
