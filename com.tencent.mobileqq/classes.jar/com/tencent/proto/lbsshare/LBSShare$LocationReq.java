  ...
  extends MessageMicro<LocationReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 42, 48, 56, 64, 74 }, new String[] { "lat", "lng", "coordinate", "keyword", "category", "page", "count", "requireMyLbs", "imei" }, new Object[] { localInteger, localInteger, localInteger, "", "", localInteger, localInteger, localInteger, "" }, LocationReq.class);
  }
}
