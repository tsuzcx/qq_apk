...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34, 40 }, new String[] { "uin", "tiny_id", "location", "client_info", "come_from" }, new Object[] { Long.valueOf(0L), Long.valueOf(0L), null, null, Long.valueOf(0L) }, ReqNearbySummaryCard.class);
