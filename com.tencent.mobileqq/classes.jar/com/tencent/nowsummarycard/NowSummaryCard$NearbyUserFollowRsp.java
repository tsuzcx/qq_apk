  ...
  extends MessageMicro<NearbyUserFollowRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24 }, new String[] { "ret_code", "err_msg", "status" }, new Object[] { localInteger, localByteStringMicro, localInteger }, NearbyUserFollowRsp.class);
  }
}
