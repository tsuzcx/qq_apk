  ...
  extends QWriter
{
  ...
  private CharBuffer wrap(char[] paramArrayOfChar, int paramInt1, int paramInt2)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 62	com/tencent/qphone/base/util/log/QLogWriter:mInited	Z
    //   4: ifne +23 -> 27
    //   7: aload_0
    //   8: aload_1
    //   9: iload_2
    ...
    //   14: putfield 218	com/tencent/qphone/base/util/log/QLogWriter:mRecycleBuffer	Ljava/nio/CharBuffer;
    //   17: aload_0
    //   18: iconst_1
    //   19: putfield 62	com/tencent/qphone/base/util/log/QLogWriter:mInited	Z
    //   22: aload_0
    //   23: getfield 218	com/tencent/qphone/base/util/log/QLogWriter:mRecycleBuffer	Ljava/nio/CharBuffer;
    //   26: areturn
    //   27: getstatic 24	com/tencent/qphone/base/util/log/QLogWriter:mCanRecycle	Z
    //   30: ifeq +259 -> 289
    //   33: aload_0
    //   34: getfield 218	com/tencent/qphone/base/util/log/QLogWriter:mRecycleBuffer	Ljava/nio/CharBuffer;
    //   37: invokevirtual 219	java/nio/CharBuffer:clear	()Ljava/nio/Buffer;
    //   40: pop
    //   41: getstatic 221	com/tencent/qphone/base/util/log/QLogWriter:sCharBufferClass	Ljava/lang/Class;
    //   44: ifnull +15 -> 59
    //   47: getstatic 223	com/tencent/qphone/base/util/log/QLogWriter:sBackingArrayField	Ljava/lang/reflect/Field;
    //   50: ifnull +9 -> 59
    //   53: getstatic 225	com/tencent/qphone/base/util/log/QLogWriter:sCapacityField	Ljava/lang/reflect/Field;
    //   56: ifnonnull +87 -> 143
    ...
    //   80: putstatic 221	com/tencent/qphone/base/util/log/QLogWriter:sCharBufferClass	Ljava/lang/Class;
    //   83: getstatic 221	com/tencent/qphone/base/util/log/QLogWriter:sCharBufferClass	Ljava/lang/Class;
    ...
    //   94: putstatic 223	com/tencent/qphone/base/util/log/QLogWriter:sBackingArrayField	Ljava/lang/reflect/Field;
    //   97: getstatic 221	com/tencent/qphone/base/util/log/QLogWriter:sCharBufferClass	Ljava/lang/Class;
    ...
    //   114: putstatic 225	com/tencent/qphone/base/util/log/QLogWriter:sCapacityField	Ljava/lang/reflect/Field;
    //   117: getstatic 223	com/tencent/qphone/base/util/log/QLogWriter:sBackingArrayField	Ljava/lang/reflect/Field;
    //   120: ifnull +10 -> 130
    //   123: getstatic 223	com/tencent/qphone/base/util/log/QLogWriter:sBackingArrayField	Ljava/lang/reflect/Field;
    //   126: iconst_1
    //   127: invokevirtual 255	java/lang/reflect/Field:setAccessible	(Z)V
    //   130: getstatic 225	com/tencent/qphone/base/util/log/QLogWriter:sCapacityField	Ljava/lang/reflect/Field;
    //   133: ifnull +10 -> 143
    //   136: getstatic 225	com/tencent/qphone/base/util/log/QLogWriter:sCapacityField	Ljava/lang/reflect/Field;
    //   139: iconst_1
    //   140: invokevirtual 255	java/lang/reflect/Field:setAccessible	(Z)V
    //   143: getstatic 225	com/tencent/qphone/base/util/log/QLogWriter:sCapacityField	Ljava/lang/reflect/Field;
    //   146: ifnull +134 -> 280
    //   149: getstatic 223	com/tencent/qphone/base/util/log/QLogWriter:sBackingArrayField	Ljava/lang/reflect/Field;
    //   152: ifnull +128 -> 280
    //   155: getstatic 221	com/tencent/qphone/base/util/log/QLogWriter:sCharBufferClass	Ljava/lang/Class;
    //   158: ifnull +122 -> 280
    //   161: getstatic 221	com/tencent/qphone/base/util/log/QLogWriter:sCharBufferClass	Ljava/lang/Class;
    //   164: aload_0
    //   165: getfield 218	com/tencent/qphone/base/util/log/QLogWriter:mRecycleBuffer	Ljava/nio/CharBuffer;
    //   168: invokevirtual 259	java/lang/Class:isInstance	(Ljava/lang/Object;)Z
    //   171: ifeq +109 -> 280
    //   174: getstatic 223	com/tencent/qphone/base/util/log/QLogWriter:sBackingArrayField	Ljava/lang/reflect/Field;
    //   177: aload_0
    //   178: getfield 218	com/tencent/qphone/base/util/log/QLogWriter:mRecycleBuffer	Ljava/nio/CharBuffer;
    //   181: aload_1
    //   182: invokevirtual 263	java/lang/reflect/Field:set	(Ljava/lang/Object;Ljava/lang/Object;)V
    //   185: getstatic 225	com/tencent/qphone/base/util/log/QLogWriter:sCapacityField	Ljava/lang/reflect/Field;
    //   188: aload_0
    //   189: getfield 218	com/tencent/qphone/base/util/log/QLogWriter:mRecycleBuffer	Ljava/nio/CharBuffer;
    //   192: aload_1
    //   193: arraylength
    //   194: invokestatic 269	com/tencent/qphone/base/util/log/LargerInteger:valueOf	(I)Ljava/lang/Integer;
    //   197: invokevirtual 263	java/lang/reflect/Field:set	(Ljava/lang/Object;Ljava/lang/Object;)V
    //   200: aload_0
    //   201: getfield 218	com/tencent/qphone/base/util/log/QLogWriter:mRecycleBuffer	Ljava/nio/CharBuffer;
    //   204: iload_2
    //   205: invokevirtual 272	java/nio/CharBuffer:position	(I)Ljava/nio/Buffer;
    //   208: pop
    //   209: aload_0
    //   210: getfield 218	com/tencent/qphone/base/util/log/QLogWriter:mRecycleBuffer	Ljava/nio/CharBuffer;
    //   213: iload_2
    //   214: iload_3
    //   215: iadd
    ...
    //   219: pop
    //   220: aload_0
    //   221: getfield 218	com/tencent/qphone/base/util/log/QLogWriter:mRecycleBuffer	Ljava/nio/CharBuffer;
    //   224: areturn
    ...
    //   239: putstatic 221	com/tencent/qphone/base/util/log/QLogWriter:sCharBufferClass	Ljava/lang/Class;
    //   242: getstatic 221	com/tencent/qphone/base/util/log/QLogWriter:sCharBufferClass	Ljava/lang/Class;
    //   245: ldc 244
    //   247: invokevirtual 248	java/lang/Class:getDeclaredField	(Ljava/lang/String;)Ljava/lang/reflect/Field;
    //   250: putstatic 223	com/tencent/qphone/base/util/log/QLogWriter:sBackingArrayField	Ljava/lang/reflect/Field;
    //   253: getstatic 221	com/tencent/qphone/base/util/log/QLogWriter:sCharBufferClass	Ljava/lang/Class;
    ...
    //   267: putstatic 225	com/tencent/qphone/base/util/log/QLogWriter:sCapacityField	Ljava/lang/reflect/Field;
    //   270: goto -153 -> 117
    //   273: astore 4
    //   275: aload 4
    //   277: invokevirtual 280	java/lang/ClassNotFoundException:printStackTrace	()V
    //   280: iconst_0
    //   281: putstatic 24	com/tencent/qphone/base/util/log/QLogWriter:mCanRecycle	Z
    //   284: aload_0
    //   285: aconst_null
    //   286: putfield 218	com/tencent/qphone/base/util/log/QLogWriter:mRecycleBuffer	Ljava/nio/CharBuffer;
    //   289: aload_1
    //   290: iload_2
    //   291: iload_3
