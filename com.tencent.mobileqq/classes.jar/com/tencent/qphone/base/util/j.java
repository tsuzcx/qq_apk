...
public abstract class j
{
  ...
  public static byte[] a(byte[] paramArrayOfByte)
  {
    ...
    //   7: astore_2
    //   8: aload_2
    //   9: invokevirtual 68	java/util/zip/Deflater:reset	()V
    //   12: aload_2
    //   13: aload_0
    //   14: invokevirtual 72	java/util/zip/Deflater:setInput	([B)V
    //   17: aload_2
    //   18: invokevirtual 73	java/util/zip/Deflater:finish	()V
    //   21: new 46	java/io/ByteArrayOutputStream
    //   24: dup
    //   25: aload_0
    //   26: arraylength
    //   27: invokespecial 49	java/io/ByteArrayOutputStream:<init>	(I)V
    //   30: astore_3
    //   31: sipush 1024
    //   34: newarray byte
    //   36: astore_1
    //   37: aload_2
    //   38: invokevirtual 77	java/util/zip/Deflater:finished	()Z
    //   41: ifne +32 -> 73
    //   44: aload_3
    //   45: aload_1
    //   46: iconst_0
    //   47: aload_2
    //   48: aload_1
    //   49: invokevirtual 81	java/util/zip/Deflater:deflate	([B)I
    //   52: invokevirtual 54	java/io/ByteArrayOutputStream:write	([BII)V
    //   55: goto -18 -> 37
    //   58: astore_1
    //   59: aload_1
    //   60: invokevirtual 82	java/lang/Exception:printStackTrace	()V
    //   63: aload_3
    //   64: invokevirtual 85	java/io/ByteArrayOutputStream:close	()V
    //   67: aload_2
    //   68: invokevirtual 88	java/util/zip/Deflater:end	()V
    //   71: aload_0
    //   72: areturn
    //   73: aload_3
    //   74: invokevirtual 61	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   77: astore_1
    //   78: aload_1
    //   79: astore_0
    //   80: aload_3
    //   81: invokevirtual 85	java/io/ByteArrayOutputStream:close	()V
    //   84: goto -17 -> 67
    //   87: astore_1
    //   88: aload_1
    ...
    //   95: astore_0
    //   96: aload_3
    //   97: invokevirtual 85	java/io/ByteArrayOutputStream:close	()V
    //   100: aload_0
    //   101: athrow
    //   102: astore_1
    //   103: aload_1
  ...
  {
    // Byte code:
    //   0: new 91	java/util/zip/Inflater
    //   3: dup
    //   4: invokespecial 92	java/util/zip/Inflater:<init>	()V
    //   7: astore_1
    //   8: aload_1
    //   9: invokevirtual 93	java/util/zip/Inflater:reset	()V
    //   12: aload_1
    //   13: aload_0
    //   14: invokevirtual 94	java/util/zip/Inflater:setInput	([B)V
    //   17: new 46	java/io/ByteArrayOutputStream
    //   20: dup
    //   21: aload_0
    //   22: arraylength
    //   23: invokespecial 49	java/io/ByteArrayOutputStream:<init>	(I)V
    //   26: astore_0
    //   27: sipush 1024
    //   30: newarray byte
    //   32: astore_2
    //   33: aload_1
    //   34: invokevirtual 95	java/util/zip/Inflater:finished	()Z
    //   37: ifne +37 -> 74
    //   40: aload_0
    //   41: aload_2
    //   42: iconst_0
    //   43: aload_1
    //   44: aload_2
    //   45: invokevirtual 98	java/util/zip/Inflater:inflate	([B)I
    //   48: invokevirtual 54	java/io/ByteArrayOutputStream:write	([BII)V
    //   51: goto -18 -> 33
    //   54: astore_1
    //   55: new 13	java/lang/Exception
    //   58: dup
    //   59: aload_1
    //   60: invokevirtual 99	java/lang/Exception:toString	()Ljava/lang/String;
    //   63: invokespecial 37	java/lang/Exception:<init>	(Ljava/lang/String;)V
    //   66: athrow
    //   67: astore_1
    //   68: aload_0
    //   69: invokevirtual 85	java/io/ByteArrayOutputStream:close	()V
    //   72: aload_1
    //   73: athrow
    //   74: aload_0
    //   75: invokevirtual 61	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   78: astore_2
    //   79: aload_0
    //   80: invokevirtual 85	java/io/ByteArrayOutputStream:close	()V
    //   83: aload_1
    //   84: invokevirtual 100	java/util/zip/Inflater:end	()V
    //   87: aload_2
    //   88: areturn
    //   89: astore_0
    //   90: new 13	java/lang/Exception
    //   93: dup
    //   94: aload_0
    ...
    //   101: athrow
    //   102: astore_0
    //   103: new 13	java/lang/Exception
    //   106: dup
    //   107: aload_0
