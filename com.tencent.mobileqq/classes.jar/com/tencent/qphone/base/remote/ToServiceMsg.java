  ...
  implements Parcelable
{
  ...
  private void readFromParcel(Parcel paramParcel)
  {
    ...
    //   0: aload_0
    //   1: aload_1
    //   2: invokevirtual 119	android/os/Parcel:readInt	()I
    //   5: putfield 121	com/tencent/qphone/base/remote/ToServiceMsg:appId	I
    //   8: aload_0
    //   9: aload_1
    //   10: invokevirtual 119	android/os/Parcel:readInt	()I
    //   13: putfield 61	com/tencent/qphone/base/remote/ToServiceMsg:appSeq	I
    //   16: aload_0
    //   17: aload_1
    //   18: invokevirtual 125	android/os/Parcel:readString	()Ljava/lang/String;
    //   21: putfield 100	com/tencent/qphone/base/remote/ToServiceMsg:serviceName	Ljava/lang/String;
    //   24: aload_0
    //   25: aload_1
    //   26: invokevirtual 125	android/os/Parcel:readString	()Ljava/lang/String;
    //   29: putfield 102	com/tencent/qphone/base/remote/ToServiceMsg:uin	Ljava/lang/String;
    //   32: aload_0
    //   33: aload_1
    //   34: invokevirtual 129	android/os/Parcel:readByte	()B
    //   37: putfield 90	com/tencent/qphone/base/remote/ToServiceMsg:uinType	B
    //   40: aload_0
    //   41: aload_1
    //   42: invokevirtual 125	android/os/Parcel:readString	()Ljava/lang/String;
    //   45: putfield 104	com/tencent/qphone/base/remote/ToServiceMsg:serviceCmd	Ljava/lang/String;
    //   48: aload_0
    //   49: aload_1
    //   50: invokevirtual 133	android/os/Parcel:readLong	()J
    //   53: putfield 59	com/tencent/qphone/base/remote/ToServiceMsg:timeout	J
    //   56: aload_0
    //   57: getfield 79	com/tencent/qphone/base/remote/ToServiceMsg:extraData	Landroid/os/Bundle;
    //   60: invokevirtual 136	android/os/Bundle:clear	()V
    //   63: aload_0
    //   64: getfield 79	com/tencent/qphone/base/remote/ToServiceMsg:extraData	Landroid/os/Bundle;
    //   67: aload_1
    //   68: invokestatic 142	java/lang/Thread:currentThread	()Ljava/lang/Thread;
    //   71: invokevirtual 146	java/lang/Thread:getContextClassLoader	()Ljava/lang/ClassLoader;
    //   74: invokevirtual 150	android/os/Parcel:readBundle	(Ljava/lang/ClassLoader;)Landroid/os/Bundle;
    //   77: invokevirtual 154	android/os/Bundle:putAll	(Landroid/os/Bundle;)V
    //   80: aload_0
    //   81: aload_1
    //   82: invokevirtual 158	android/os/Parcel:readStrongBinder	()Landroid/os/IBinder;
    //   85: invokestatic 164	com/tencent/qphone/base/remote/IBaseActionListener$Stub:asInterface	(Landroid/os/IBinder;)Lcom/tencent/qphone/base/remote/IBaseActionListener;
    //   88: putfield 166	com/tencent/qphone/base/remote/ToServiceMsg:actionListener	Lcom/tencent/qphone/base/remote/IBaseActionListener;
    //   91: aload_0
    //   92: aload_0
    //   93: getfield 79	com/tencent/qphone/base/remote/ToServiceMsg:extraData	Landroid/os/Bundle;
    //   96: ldc 14
    //   98: invokevirtual 170	android/os/Bundle:getByte	(Ljava/lang/String;)B
    //   101: putfield 81	com/tencent/qphone/base/remote/ToServiceMsg:toVersion	B
    //   104: aload_0
    //   105: getfield 81	com/tencent/qphone/base/remote/ToServiceMsg:toVersion	B
    //   108: ifle +82 -> 190
    //   111: aload_0
    //   112: aload_1
    //   113: invokevirtual 174	android/os/Parcel:readSerializable	()Ljava/io/Serializable;
    //   116: checkcast 83	com/tencent/mobileqq/msf/sdk/MsfCommand
    //   119: putfield 88	com/tencent/qphone/base/remote/ToServiceMsg:msfCommand	Lcom/tencent/mobileqq/msf/sdk/MsfCommand;
    //   122: aload_0
    //   123: aload_1
    //   124: invokevirtual 133	android/os/Parcel:readLong	()J
    //   127: putfield 57	com/tencent/qphone/base/remote/ToServiceMsg:sendTimeout	J
    //   130: aload_1
    //   131: invokevirtual 129	android/os/Parcel:readByte	()B
    //   134: ifne +80 -> 214
    //   137: iconst_0
    //   138: istore_2
    //   139: aload_0
    ...
    //   144: aload_0
    //   145: aload_1
    //   146: invokevirtual 119	android/os/Parcel:readInt	()I
    //   149: newarray byte
    ...
    //   159: invokevirtual 178	android/os/Parcel:readByteArray	([B)V
    //   162: aload_0
    //   163: aload_1
    //   164: invokevirtual 119	android/os/Parcel:readInt	()I
    //   167: putfield 67	com/tencent/qphone/base/remote/ToServiceMsg:ssoSeq	I
    //   170: aload_0
    //   171: getfield 74	com/tencent/qphone/base/remote/ToServiceMsg:attributes	Ljava/util/HashMap;
    //   174: invokevirtual 179	java/util/HashMap:clear	()V
    //   177: aload_1
    //   178: aload_0
    //   179: getfield 74	com/tencent/qphone/base/remote/ToServiceMsg:attributes	Ljava/util/HashMap;
    //   182: ldc 2
    //   184: invokevirtual 184	java/lang/Class:getClassLoader	()Ljava/lang/ClassLoader;
    //   187: invokevirtual 188	android/os/Parcel:readMap	(Ljava/util/Map;Ljava/lang/ClassLoader;)V
    //   190: aload_1
    //   191: invokevirtual 119	android/os/Parcel:readInt	()I
    //   194: iconst_1
    ...
    //   200: aload_0
    //   201: iload_2
    //   202: putfield 190	com/tencent/qphone/base/remote/ToServiceMsg:quickSendEnable	Z
    //   205: aload_0
    //   206: aload_1
    //   207: invokevirtual 119	android/os/Parcel:readInt	()I
    ...
    //   227: ldc 192
    //   229: aload_1
    //   230: invokestatic 198	android/util/Log:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    //   233: pop
    //   234: aload_1
    //   235: athrow
  ...
  public void writeToParcel(Parcel paramParcel, int paramInt)
  {
    ...
    //   2: aload_1
    //   3: aload_0
    //   4: getfield 121	com/tencent/qphone/base/remote/ToServiceMsg:appId	I
    ...
    //   18: aload_1
    //   19: aload_0
    //   20: getfield 100	com/tencent/qphone/base/remote/ToServiceMsg:serviceName	Ljava/lang/String;
    //   23: invokevirtual 345	android/os/Parcel:writeString	(Ljava/lang/String;)V
    //   26: aload_1
    //   27: aload_0
    //   28: getfield 102	com/tencent/qphone/base/remote/ToServiceMsg:uin	Ljava/lang/String;
    //   31: invokevirtual 345	android/os/Parcel:writeString	(Ljava/lang/String;)V
    //   34: aload_1
    //   35: aload_0
    //   36: getfield 90	com/tencent/qphone/base/remote/ToServiceMsg:uinType	B
    //   39: invokevirtual 349	android/os/Parcel:writeByte	(B)V
    //   42: aload_1
    //   43: aload_0
    //   44: getfield 104	com/tencent/qphone/base/remote/ToServiceMsg:serviceCmd	Ljava/lang/String;
    ...
    //   58: aload_1
    //   59: aload_0
    //   60: getfield 79	com/tencent/qphone/base/remote/ToServiceMsg:extraData	Landroid/os/Bundle;
    //   63: invokevirtual 355	android/os/Parcel:writeBundle	(Landroid/os/Bundle;)V
    //   66: aload_1
    //   67: aload_0
    //   68: getfield 166	com/tencent/qphone/base/remote/ToServiceMsg:actionListener	Lcom/tencent/qphone/base/remote/IBaseActionListener;
    //   71: invokevirtual 359	android/os/Parcel:writeStrongInterface	(Landroid/os/IInterface;)V
    //   74: aload_0
    //   75: getfield 81	com/tencent/qphone/base/remote/ToServiceMsg:toVersion	B
    //   78: ifle +66 -> 144
    //   81: aload_1
    //   82: aload_0
    //   83: getfield 88	com/tencent/qphone/base/remote/ToServiceMsg:msfCommand	Lcom/tencent/mobileqq/msf/sdk/MsfCommand;
    ...
    //   136: aload_1
    //   137: aload_0
    //   138: getfield 74	com/tencent/qphone/base/remote/ToServiceMsg:attributes	Ljava/util/HashMap;
    //   141: invokevirtual 370	android/os/Parcel:writeMap	(Ljava/util/Map;)V
    //   144: aload_0
    //   145: getfield 190	com/tencent/qphone/base/remote/ToServiceMsg:quickSendEnable	Z
    //   148: ifeq +22 -> 170
    //   151: aload_1
    //   152: iload_2
    ...
    //   178: ldc_w 372
    //   181: aload_1
    //   182: invokestatic 198	android/util/Log:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    //   185: pop
    //   186: aload_1
    //   187: athrow
    // Local variable table:
