...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 34, 40 }, new String[] { "uint32_error_code", "str_errmsg", "uint32_hello_interval", "str_clientip", "uint32_client_battey_get_interval" }, new Object[] { Integer.valueOf(0), "", Integer.valueOf(0), "", Integer.valueOf(0) }, RspBody.class);
