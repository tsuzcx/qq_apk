  ...
  implements Serializable
{
  ...
  public static final SIG_TYPE SIG_TYPE_D2_KEY = new SIG_TYPE(20, 20, "SIG_TYPE_D2_KEY");
  ...
  public static final SIG_TYPE SIG_TYPE_SuperKey = new SIG_TYPE(21, 21, "SIG_TYPE_SuperKey");
  ...
  private static SIG_TYPE[] __values = new SIG_TYPE[20];
  ...
  public static SIG_TYPE convert(int paramInt)
  {
    ...
    for (;;)
    {
      SIG_TYPE[] arrayOfSIG_TYPE = __values;
      if (i >= arrayOfSIG_TYPE.length) {
        break;
      }
      if (arrayOfSIG_TYPE[i].value() == paramInt) {
        return __values[i];
      }
      i += 1;
    }
  ...
  public static SIG_TYPE convert(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (arrayOfSIG_TYPE[i].toString().equals(paramString)) {
        return __values[i];
      }
      i += 1;
    }
