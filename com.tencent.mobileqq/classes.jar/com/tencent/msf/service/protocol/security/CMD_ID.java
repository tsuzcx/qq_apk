  ...
  implements Serializable
{
  ...
  public static final CMD_ID CMD_ID_AUTH_MSF_ACCOUNT_LOGIN = new CMD_ID(21, 21, "CMD_ID_AUTH_MSF_ACCOUNT_LOGIN");
  ...
  private static CMD_ID[] __values = new CMD_ID[22];
  ...
  public static CMD_ID convert(int paramInt)
  {
    ...
    for (;;)
    {
      CMD_ID[] arrayOfCMD_ID = __values;
      if (i >= arrayOfCMD_ID.length) {
        break;
      }
      if (arrayOfCMD_ID[i].value() == paramInt) {
        return __values[i];
      }
      i += 1;
    }
  ...
  public static CMD_ID convert(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (arrayOfCMD_ID[i].toString().equals(paramString)) {
        return __values[i];
      }
      i += 1;
    }
