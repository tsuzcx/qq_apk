...
public class m
{
  ...
  public static m a(ByteBuffer paramByteBuffer)
    throws IOException
  {
    ...
    m localm = new m();
    localm.a = c.c(paramByteBuffer, m);
    if (i != 0) {
      localm.c = c.c(paramByteBuffer, i);
    }
    ...
    localm.f = localByteBuffer;
    localm.b = new String[m];
    ...
    if (k != 0)
    {
      ...
      localm.d = c.c(paramByteBuffer, i / 4);
    }
    return localm;
  }
 ...
 * Qualified Name:     com.tencent.theme.m
