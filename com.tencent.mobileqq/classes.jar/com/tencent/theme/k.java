...
public class k
{
  ...
  public static k a(ByteBuffer paramByteBuffer)
  {
    ...
    k localk = new k();
    localk.a = b.c(paramByteBuffer, m);
    if (i != 0) {
      localk.c = b.c(paramByteBuffer, i);
    }
    ...
    if (k != 0)
    {
      ...
      localk.d = b.c(paramByteBuffer, i / 4);
    }
    return localk;
  }
  ...
  public String a(int paramInt)
  {
    ...
    for (Object localObject = new String((char[])localObject);; localObject = new String(b.d(this.f, i)))
    {
