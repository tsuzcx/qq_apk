...
public final class b
{
  ...
  public static e a(Context paramContext)
  {
    ...
    //   17: invokestatic 16	com/tencent/beacon/core/d/b:c	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   20: aconst_null
    //   21: astore_3
    //   22: ldc 2
    //   24: monitorexit
    ...
    //   26: areturn
    //   27: aload_0
    //   28: invokestatic 21	com/tencent/beacon/core/b/b:a	(Landroid/content/Context;)Lcom/tencent/beacon/core/b/b;
    //   31: invokevirtual 25	com/tencent/beacon/core/b/b:b	()Ljava/lang/String;
    //   34: astore 4
    //   36: aload_0
    //   37: aload 4
    //   39: invokestatic 30	com/tencent/beacon/core/a/a/e:a	(Landroid/content/Context;Ljava/lang/String;)Lcom/tencent/beacon/core/a/a/e;
    //   42: invokevirtual 34	com/tencent/beacon/core/a/a/e:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   45: astore_0
    //   46: aload_0
    //   47: ifnonnull +17 -> 64
    //   50: ldc 36
    ...
    //   56: invokestatic 16	com/tencent/beacon/core/d/b:c	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   59: aconst_null
    //   60: astore_3
    //   61: goto -39 -> 22
    //   64: aload_0
    ...
    //   155: iconst_0
    //   156: aload_2
    //   157: getfield 85	com/tencent/beacon/core/strategy/e:b	I
    //   160: invokestatic 54	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   163: aastore
    //   164: invokestatic 88	com/tencent/beacon/core/d/b:g	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   167: aload_2
    //   168: astore_3
    //   169: aload_0
    //   170: ifnull -148 -> 22
    ...
    //   207: invokestatic 99	com/tencent/beacon/core/d/b:b	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   210: new 82	com/tencent/beacon/core/strategy/e
    //   213: dup
    //   214: invokespecial 102	com/tencent/beacon/core/strategy/e:<init>	()V
    //   217: astore_2
    //   218: aload_2
    //   219: aload_0
    //   220: aload_0
    ...
    //   233: putfield 115	com/tencent/beacon/core/strategy/e:a	J
    //   236: aload_2
    //   237: aload_0
    //   238: aload_0
    //   239: ldc 48
    ...
    //   251: putfield 85	com/tencent/beacon/core/strategy/e:b	I
    //   254: aload_2
    //   255: aload_0
    //   256: aload_0
    //   257: ldc 121
    ...
    //   269: putfield 128	com/tencent/beacon/core/strategy/e:c	[B
    //   272: goto -128 -> 144
    //   275: astore_3
    //   276: aconst_null
    //   277: astore_0
    //   278: aload_3
    //   279: invokestatic 131	com/tencent/beacon/core/d/b:a	(Ljava/lang/Throwable;)V
    //   282: aload_0
    //   283: astore_3
    //   284: aload_2
    //   285: ifnull -263 -> 22
  ...
  private static boolean a(Context paramContext, e parame)
  {
    boolean bool = false;
    ...
    for (;;)
    {
      ...
      Object localObject = com.tencent.beacon.core.b.b.a(paramContext).b();
      try
      {
        paramContext = com.tencent.beacon.core.a.a.e.a(paramContext, (String)localObject).getWritableDatabase();
        if (paramContext != null) {
          break label84;
        }
      ...
      {
        com.tencent.beacon.core.d.b.d("[db] error: %s", new Object[] { paramContext.toString() });
      }
      continue;
      label84:
      localObject = new ContentValues();
      if (parame.a >= 0L) {
        ((ContentValues)localObject).put("_id", Long.valueOf(parame.a));
      }
      ((ContentValues)localObject).put("_key", Integer.valueOf(parame.b));
      ((ContentValues)localObject).put("_datas", parame.c);
      ...
      {
        parame.a = l;
        com.tencent.beacon.core.d.b.e("[db] update strategy %d true ", new Object[] { Integer.valueOf(parame.b) });
        bool = true;
      }
    }
  }
  ...
  public static int b(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      String str = com.tencent.beacon.core.b.b.a(paramContext).b();
      int i = k;
      try
      {
        paramContext = com.tencent.beacon.core.a.a.e.a(paramContext, str).getWritableDatabase();
        if (paramContext != null) {
          break label82;
        }
        i = k;
      ...
      i = j;
      com.tencent.beacon.core.d.b.g("[db] key:%d , num: %d", new Object[] { Integer.valueOf(101), Integer.valueOf(j) });
      i = j;
    }
  }
}
