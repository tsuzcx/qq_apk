  ...
  extends com.tencent.beacon.core.b
{
  ...
  private int getCPUMhz()
  {
    ...
    //   83: astore_3
    //   84: aload_3
    //   85: invokestatic 158	com/tencent/beacon/core/d/b:a	(Ljava/lang/Throwable;)V
    //   88: iload_1
    //   89: ireturn
    //   90: astore 5
    //   92: aconst_null
    ...
    //   97: astore_3
    //   98: aload 5
    //   100: invokestatic 158	com/tencent/beacon/core/d/b:a	(Ljava/lang/Throwable;)V
    //   103: iload_2
    //   104: istore_1
    //   105: aload 4
    //   107: ifnull -26 -> 81
    ...
    //   117: astore_3
    //   118: aload_3
    //   119: invokestatic 158	com/tencent/beacon/core/d/b:a	(Ljava/lang/Throwable;)V
    //   122: iconst_0
    //   123: ireturn
    //   124: astore 5
    //   126: aload_3
    ...
    //   144: astore 4
    //   146: aload 4
    //   148: invokestatic 158	com/tencent/beacon/core/d/b:a	(Ljava/lang/Throwable;)V
    //   151: goto -9 -> 142
    //   154: astore 5
    //   156: aload_3
    //   157: astore 4
  ...
  private String getCPUProcessor()
  {
    ...
    //   110: astore_1
    //   111: aload 4
    //   113: invokestatic 158	com/tencent/beacon/core/d/b:a	(Ljava/lang/Throwable;)V
    //   116: aload_3
    //   117: astore_1
    //   118: aload_2
    //   119: ifnull -23 -> 96
    ...
    //   129: astore_1
    //   130: aload_1
    //   131: invokestatic 158	com/tencent/beacon/core/d/b:a	(Ljava/lang/Throwable;)V
    //   134: ldc 160
    //   136: areturn
    //   137: astore_2
    //   138: aconst_null
    ...
    //   150: astore_1
    //   151: aload_1
    //   152: invokestatic 158	com/tencent/beacon/core/d/b:a	(Ljava/lang/Throwable;)V
    //   155: goto -7 -> 148
    //   158: astore_2
    //   159: goto -19 -> 140
    //   162: astore 4
  ...
  private String getCountry()
  {
    ...
    {
      com.tencent.beacon.core.d.b.d("[model] getCountry error!", new Object[0]);
  ...
  private String getCpuProductorName()
  {
    ...
    {
      com.tencent.beacon.core.d.b.d("[model] get cpu product error!", new Object[0]);
    }
    return null;
  }
  ...
  private DisplayMetrics getDisplayMetrics()
  {
    ...
    {
      com.tencent.beacon.core.d.b.d("[model] getDisplayMetrics error!", new Object[0]);
      com.tencent.beacon.core.d.b.a(localThrowable);
    }
    return null;
  }
  ...
  private long getFreeMem()
  {
    ...
    {
      com.tencent.beacon.core.d.b.d("[model] getFreeMem error!", new Object[0]);
      com.tencent.beacon.core.d.b.a(localThrowable);
    }
    return -1L;
  }
  ...
  private int getNumCores()
  {
    try
    {
      File[] arrayOfFile = new File("/sys/devices/system/cpu/").listFiles(new ModuleImpl.a());
      if (arrayOfFile == null) {
        return 1;
      }
    ...
    {
      com.tencent.beacon.core.d.b.d("[model] CPU Count: Failed.", new Object[0]);
  ...
  private String getRamSize()
  {
    ...
    //   19: aload 4
    //   21: sipush 8192
    //   24: invokespecial 306	java/io/BufferedReader:<init>	(Ljava/io/Reader;I)V
    //   27: astore_3
    //   28: aload_3
    //   29: astore 6
    //   31: aload 4
    ...
    //   39: ldc_w 308
    //   42: iconst_2
    //   43: invokevirtual 312	java/lang/String:split	(Ljava/lang/String;I)[Ljava/lang/String;
    //   46: iconst_1
    //   47: aaload
    //   48: invokevirtual 315	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   51: ldc_w 317
    //   54: ldc 160
    //   56: invokevirtual 321	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   59: invokevirtual 142	java/lang/String:trim	()Ljava/lang/String;
    //   62: invokestatic 327	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   65: ldc2_w 269
    //   68: ldiv
    //   69: lstore_1
    //   70: lload_1
    //   71: invokestatic 331	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   74: astore 5
    //   76: aload_3
    //   77: invokevirtual 152	java/io/BufferedReader:close	()V
    //   80: aload 4
    //   82: invokevirtual 332	java/io/FileReader:close	()V
    //   85: aload 5
    //   87: astore_3
    //   88: aload_3
    //   89: areturn
    ...
    //   98: invokestatic 192	com/tencent/beacon/core/d/b:d	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   101: aload_3
    //   102: invokestatic 158	com/tencent/beacon/core/d/b:a	(Ljava/lang/Throwable;)V
    //   105: aload 5
    //   107: areturn
    //   108: astore 7
    //   110: aconst_null
    ...
    //   129: invokestatic 192	com/tencent/beacon/core/d/b:d	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   132: aload_3
    //   133: astore 6
    //   135: aload 4
    //   137: astore 5
    //   139: aload 7
    //   141: invokestatic 158	com/tencent/beacon/core/d/b:a	(Ljava/lang/Throwable;)V
    //   144: aload_3
    //   145: ifnull +7 -> 152
    //   148: aload_3
    ...
    //   157: ifnull -69 -> 88
    //   160: aload 4
    //   162: invokevirtual 332	java/io/FileReader:close	()V
    //   165: aconst_null
    //   166: areturn
    //   167: astore_3
    //   168: ldc_w 334
    ...
    //   175: invokestatic 192	com/tencent/beacon/core/d/b:d	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   178: aload_3
    //   179: invokestatic 158	com/tencent/beacon/core/d/b:a	(Ljava/lang/Throwable;)V
    //   182: aconst_null
    //   183: areturn
    //   184: astore_3
    //   185: aconst_null
    ...
    //   203: ifnull +8 -> 211
    //   206: aload 4
    //   208: invokevirtual 332	java/io/FileReader:close	()V
    //   211: aload_3
    //   212: athrow
    //   213: astore 4
    //   215: ldc_w 334
    ...
    //   222: invokestatic 192	com/tencent/beacon/core/d/b:d	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   225: aload 4
    //   227: invokestatic 158	com/tencent/beacon/core/d/b:a	(Ljava/lang/Throwable;)V
    //   230: goto -19 -> 211
    //   233: astore_3
    //   234: aconst_null
    //   235: astore 6
  ...
  {
    ArrayList localArrayList = i.a(new String[] { "/system/bin/sh", "-c", "getprop ro.build.fingerprint" });
  ...
  {
    com.tencent.beacon.core.d.b.b("[model] getSensor start", new Object[0]);
    ...
    for (;;)
    {
      ...
      catch (Throwable localThrowable1)
      {
        ...
        localObject2 = "X";
        localObject1 = "X";
        com.tencent.beacon.core.d.b.d("[model] getSensor error!", new Object[0]);
        com.tencent.beacon.core.d.b.a(localThrowable1);
  ...
  {
    com.tencent.beacon.core.d.b.b("[model] getSensor2 start", new Object[0]);
    Object localObject1 = "X";
    ...
    for (;;)
    {
      ...
      {
        localObject3 = localObject6;
        com.tencent.beacon.core.d.b.d("[model] getSensor2 error!", new Object[0]);
  ...
  private String getWifiSSID()
  {
    ...
    {
      com.tencent.beacon.core.d.b.a(localThrowable);
      com.tencent.beacon.core.d.b.d("[model] getWifiSSID error!", new Object[0]);
    }
    return "";
  }
  ...
  private boolean isArmV7()
  {
    ...
    //   67: astore 5
    //   69: aload 7
    //   71: invokevirtual 315	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   74: ldc_w 553
    ...
    //   95: astore 5
    //   97: aload 5
    //   99: invokestatic 158	com/tencent/beacon/core/d/b:a	(Ljava/lang/Throwable;)V
    //   102: iload_2
    //   103: ireturn
    //   104: astore 7
    //   106: aconst_null
    ...
    //   111: astore 5
    //   113: aload 7
    //   115: invokestatic 158	com/tencent/beacon/core/d/b:a	(Ljava/lang/Throwable;)V
    //   118: iload 4
    //   120: istore_2
    //   121: aload 6
    //   123: ifnull -30 -> 93
    ...
    //   133: astore 5
    //   135: aload 5
    //   137: invokestatic 158	com/tencent/beacon/core/d/b:a	(Ljava/lang/Throwable;)V
    //   140: iconst_0
    //   141: ireturn
    //   142: astore 7
    //   144: aload 5
    ...
    //   165: astore 6
    //   167: aload 6
    //   169: invokestatic 158	com/tencent/beacon/core/d/b:a	(Ljava/lang/Throwable;)V
    //   172: goto -10 -> 162
    //   175: astore 7
    //   177: aload 5
    //   179: astore 6
  ...
  private void modelEvent()
  {
    ...
    try
    {
      ...
      boolean bool = i.a().equals(localObject);
      if (bool) {
        return;
      }
    }
    ...
    {
      com.tencent.beacon.core.d.b.d("[model] get upload flag failed! ", new Object[0]);
      return;
    }
    Object localObject = new ModuleImpl.1(this);
    com.tencent.beacon.core.a.b.b().a((Runnable)localObject, 50000L);
    try
    {
      localException1.a().a("rqd_model", i.a()).b();
      return;
    }
    catch (Exception localException2)
    {
      com.tencent.beacon.core.d.b.d("[model] save upload flag failed!", new Object[0]);
      com.tencent.beacon.core.d.b.a(localException2);
    }
  }
  ...
  public String getLanguage()
  {
    ...
    {
      com.tencent.beacon.core.d.b.d("[model] getLanguage error!", new Object[0]);
      com.tencent.beacon.core.d.b.a(localThrowable);
    }
    return null;
  }
  ...
  public void onModuleStarted()
  {
    ...
    com.tencent.beacon.core.d.b.a("[module] model module > %S", new Object[] { this.modelEventUsable });
  ...
  public void onModuleStrategyUpdated(int paramInt, Map<String, String> paramMap)
  {
    ...
    if (paramInt == 1) {
      this.modelEventUsable = i.a((String)paramMap.get("modelEventUsable"), this.modelEventUsable);
    }
  }
}
