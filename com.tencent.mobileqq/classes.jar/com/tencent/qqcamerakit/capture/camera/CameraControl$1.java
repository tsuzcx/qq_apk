  ...
  implements Camera.PictureCallback
{
  ...
  public void onPictureTaken(byte[] paramArrayOfByte, Camera paramCamera)
  {
    ...
    QLog.c(CameraControl.a, 1, new Object[] { "[onPictureTaken] picSize(", Integer.valueOf(paramCamera.width), ", ", Integer.valueOf(paramCamera.height), "), orientation = ", Integer.valueOf(this.b.d) });
    if (paramArrayOfByte == null) {
      return;
    }
    this.a.post(new CameraControl.1.1(this, paramArrayOfByte));
  }
}
