  ...
  extends CameraCaptureSession.StateCallback
{
  ...
  public void onConfigureFailed(@NonNull CameraCaptureSession paramCameraCaptureSession)
  {
    ...
    if (this.a.c != null) {
      this.a.c.a(3, 42, "[Camera2]onConfigureFailed", new Object[0]);
    }
  }
  ...
  public void onConfigured(@NonNull CameraCaptureSession paramCameraCaptureSession)
  {
    ...
    Camera2Control.c(this.a).set(CaptureRequest.CONTROL_AF_MODE, Integer.valueOf(Camera2Control.b(this.a)));
    Camera2Control.c(this.a).set(CaptureRequest.CONTROL_AE_MODE, Integer.valueOf(1));
    Camera2Control.c(this.a).set(CaptureRequest.CONTROL_AE_TARGET_FPS_RANGE, Camera2Control.d(this.a));
    paramCameraCaptureSession = this.a;
    Camera2Control.a(paramCameraCaptureSession, Camera2Control.c(paramCameraCaptureSession).build());
    Camera2Control.e(this.a);
    Camera2Control.a(this.a).release();
    if (this.a.c != null) {
      this.a.c.a(3, 0, "", new Object[0]);
    }
  }
}
