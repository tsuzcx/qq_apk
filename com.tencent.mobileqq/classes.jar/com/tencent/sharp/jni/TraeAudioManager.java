  ...
  extends BroadcastReceiver
{
  ...
  bhmj jdField_a_of_type_Bhmj = null;
  bhmk jdField_a_of_type_Bhmk = null;
  bhmq jdField_a_of_type_Bhmq = null;
  ...
  public static int a(boolean paramBoolean, long paramLong, Context paramContext)
  {
    ...
    {
      i = j;
      if (jdField_a_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_Bhmq != null)
      {
        if (!paramBoolean) {
          break label59;
        }
        jdField_a_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_Bhmq.a(paramLong, paramContext);
      }
    }
    for (;;)
    {
      ...
      return i;
      label59:
      jdField_a_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_Bhmq.a(paramLong);
    }
  }
  ...
  int a()
  {
    ...
    Object localObject = this.jdField_a_of_type_Bhmk.a();
    ...
    localIntent.putExtra("EXTRA_DATA_IF_HAS_BLUETOOTH_THIS_IS_NAME", this.jdField_a_of_type_Bhmk.a());
    try
    {
  ...
  int a(long paramLong, String paramString, HashMap<String, Object> paramHashMap)
  {
    ...
    do
    {
      ...
      {
        return -1;
        if ((!this.jdField_a_of_type_Bhmk.d().equals("DEVICE_NONE")) && (paramString.equals(this.jdField_a_of_type_Bhmk.d()))) {
          return 0;
        }
        if ((a(paramString) == true) && (this.jdField_a_of_type_Bhmk.b(paramString) == true)) {
          break;
        }
      } while (!QLog.isColorLevel());
    ...
    return -1;
    this.jdField_a_of_type_Bhmk.c(paramString);
  ...
  int a(long paramLong, HashMap<String, Object> paramHashMap)
  {
    ...
    for (;;)
    {
      ...
      if (i != 0)
      {
        ...
        return -1;
        if (!this.jdField_a_of_type_Bhmk.b((String)localObject1))
        {
          i = 8;
          continue;
        }
      ...
      {
        if (((String)localObject1).equals(this.jdField_a_of_type_Bhmk.d()))
        {
          if (QLog.isColorLevel()) {
  ...
  public bhmj a(Context paramContext, bhmk parambhmk)
  {
    Object localObject1;
    Object localObject2;
    if ((Build.VERSION.SDK_INT >= 11) && (Build.VERSION.SDK_INT != 18))
    {
      localObject1 = new bhmg(this);
      localObject2 = localObject1;
      if (!((bhmj)localObject1).a(paramContext, parambhmk)) {
        localObject2 = new bhmh(this);
      }
      if (QLog.isColorLevel())
      {
        parambhmk = new StringBuilder().append("CreateBluetoothCheck:").append(((bhmj)localObject2).a()).append(" skip android4.3:");
    ...
    for (paramContext = "Y";; paramContext = "N")
    {
      ...
      if (Build.VERSION.SDK_INT != 18)
      {
        localObject1 = new bhmi(this);
        break;
      }
      localObject1 = new bhmh(this);
      break;
    }
  }
  ...
  public void a()
  {
    int j = 0;
    AudioDeviceInterface.LogTraceEntry("");
    int k = this.jdField_a_of_type_Bhmk.a();
    if (QLog.isColorLevel()) {
      QLog.w("TraeAudioManager", 2, "   ConnectedDevice:" + this.jdField_a_of_type_Bhmk.d());
    }
    if (QLog.isColorLevel()) {
      QLog.w("TraeAudioManager", 2, "   ConnectingDevice:" + this.jdField_a_of_type_Bhmk.c());
    }
    if (QLog.isColorLevel()) {
      QLog.w("TraeAudioManager", 2, "   prevConnectedDevice:" + this.jdField_a_of_type_Bhmk.e());
    }
    if (QLog.isColorLevel()) {
      QLog.w("TraeAudioManager", 2, "   AHPDevice:" + this.jdField_a_of_type_Bhmk.b());
    }
    if (QLog.isColorLevel()) {
    ...
    while (i < k)
    {
      localObject = this.jdField_a_of_type_Bhmk.a(i);
      if (QLog.isColorLevel()) {
        QLog.w("TraeAudioManager", 2, "      " + i + " devName:" + (String)localObject + " Visible:" + this.jdField_a_of_type_Bhmk.b((String)localObject) + " Priority:" + this.jdField_a_of_type_Bhmk.a((String)localObject));
      }
      i += 1;
    }
    Object localObject = (String[])this.jdField_a_of_type_Bhmk.a().toArray(new String[0]);
    i = j;
    if (QLog.isColorLevel())
    {
    ...
    while (i < localObject.length)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.w("TraeAudioManager", 2, "      " + i + " devName:" + str + " Visible:" + this.jdField_a_of_type_Bhmk.b(str) + " Priority:" + this.jdField_a_of_type_Bhmk.a(str));
      }
      i += 1;
    }
    AudioDeviceInterface.LogTraceExit();
  ...
  {
    int j = this.jdField_a_of_type_Bhmk.a();
    Object localObject;
    boolean bool;
    int i;
    if (QLog.isColorLevel())
    ...
    else
    {
      ...
      bool = this.jdField_a_of_type_Bhmk.a((String)localObject, false);
    }
    for (;;)
    {
      if ((bool) && (QLog.isColorLevel())) {
        QLog.w("TraeAudioManager", 1, "updateDeviceStatus, devName[" + (String)localObject + "], Visible[" + this.jdField_a_of_type_Bhmk.b((String)localObject) + "], seq[" + paramLong + "]");
      }
      i += 1;
      break label96;
      bool = false;
      break;
      label236:
      bool = this.jdField_a_of_type_Bhmk.a((String)localObject, this.jdField_a_of_type_Bhmj.a());
      continue;
      label257:
      if (((String)localObject).equals("DEVICE_WIREDHEADSET"))
      {
        bool = this.jdField_a_of_type_Bhmk.a((String)localObject, this.jdField_a_of_type_AndroidMediaAudioManager.isWiredHeadsetOn());
      }
      else
      {
        if (((String)localObject).equals("DEVICE_SPEAKERPHONE")) {
          this.jdField_a_of_type_Bhmk.a((String)localObject, true);
        }
        label311:
        bool = false;
      }
  ...
  void a(Context paramContext, Intent paramIntent)
  {
    ...
    else
    {
      ...
      paramContext = this.jdField_a_of_type_Bhmk;
      if (1 != i) {
        break label262;
      }
    }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Bhmk.a() == true) {
      if (QLog.isColorLevel())
      {
    ...
    {
      QLog.w("TraeAudioManager", 2, (String)localObject + " connectedDev:" + this.jdField_a_of_type_Bhmk.d());
      b();
      this.jdField_a_of_type_Bhmk.b();
      if (!paramBoolean) {
        break;
      }
    ...
    localObject = this.jdField_a_of_type_Bhmk.d();
  ...
  void b()
  {
    if (this.jdField_a_of_type_Bhmk.b("DEVICE_WIREDHEADSET"))
    {
      if (QLog.isColorLevel()) {
        QLog.w("TraeAudioManager", 2, " detected headset plugin,so disable earphone");
      }
      this.jdField_a_of_type_Bhmk.a("DEVICE_EARPHONE", false);
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.w("TraeAudioManager", 2, " detected headset plugout,so enable earphone");
    }
    this.jdField_a_of_type_Bhmk.a("DEVICE_EARPHONE", true);
  }
  ...
  boolean b()
  {
    String str = this.jdField_a_of_type_Bhmk.c();
  ...
  {
    Intent localIntent = new Intent();
    localIntent.putExtra("GETCONNECTEDDEVICE_REULT_LIST", this.jdField_a_of_type_Bhmk.d());
    a(localIntent, paramHashMap, 0);
    return 0;
  }
  ...
  {
    Intent localIntent = new Intent();
    localIntent.putExtra("GETCONNECTINGDEVICE_REULT_LIST", this.jdField_a_of_type_Bhmk.c());
    a(localIntent, paramHashMap, 0);
    return 0;
  }
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_Bhmk == null)
        {
          if (QLog.isColorLevel()) {
        ...
        {
          boolean bool1 = this.jdField_a_of_type_Bhmk.b("DEVICE_WIREDHEADSET");
          boolean bool2 = this.jdField_a_of_type_Bhmk.b("DEVICE_BLUETOOTHHEADSET");
          if ("android.intent.action.HEADSET_PLUG".equals(str2))
          {
            a(paramContext, paramIntent);
            if ((!bool1) && (this.jdField_a_of_type_Bhmk.b("DEVICE_WIREDHEADSET") == true)) {
              a("DEVICE_WIREDHEADSET", true);
            }
            if ((bool1 == true) && (!this.jdField_a_of_type_Bhmk.b("DEVICE_WIREDHEADSET"))) {
          ...
          else if (!"android.media.AUDIO_BECOMING_NOISY".equals(str2))
          {
            ...
            else
            {
              ...
              {
                if (this.jdField_a_of_type_Bhmj != null) {
                  this.jdField_a_of_type_Bhmj.a(paramContext, paramIntent, this.jdField_a_of_type_Bhmk);
                }
                if ((!bool2) && (this.jdField_a_of_type_Bhmk.b("DEVICE_BLUETOOTHHEADSET") == true)) {
                  a("DEVICE_BLUETOOTHHEADSET", true);
                }
                if ((bool2 == true) && (!this.jdField_a_of_type_Bhmk.b("DEVICE_BLUETOOTHHEADSET")))
                {
