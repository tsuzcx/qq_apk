...
public class TraeAudioManager$BluetoohHeadsetCheck$1
  implements Runnable
{
  public TraeAudioManager$BluetoohHeadsetCheck$1(bhmg parambhmg) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (j == 2) {
          this.a.jdField_a_of_type_Bhmk.a(localBluetoothDevice.getName());
        }
        if (QLog.isColorLevel()) {
    ...
    if (this.a.jdField_a_of_type_Bhmk != null) {
      if (this.a.jdField_a_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_Bhmk == null) {
        break label346;
      }
    }
    label346:
    for (String str = this.a.jdField_a_of_type_ComTencentSharpJniTraeAudioManager.jdField_a_of_type_Bhmk.a();; str = null)
    {
      if (TextUtils.isEmpty(str))
      {
        this.a.jdField_a_of_type_Bhmk.a("DEVICE_BLUETOOTHHEADSET", false);
        return;
      }
      if (this.a.a())
      {
        this.a.jdField_a_of_type_Bhmk.a("DEVICE_BLUETOOTHHEADSET", true);
