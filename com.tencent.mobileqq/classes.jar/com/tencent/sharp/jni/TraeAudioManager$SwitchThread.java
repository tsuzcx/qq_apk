  ...
  extends Thread
{
  ...
  TraeAudioManager$SwitchThread(TraeAudioManager paramTraeAudioManager, long paramLong)
  {
    ...
    this.b = bool;
    this.c = BaseApplicationImpl.processName.endsWith(":video");
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.w(this.jdField_a_of_type_JavaLangString, 1, "run begin, seq[" + this.jdField_a_of_type_Long + "], isRunning[" + this.jdField_a_of_type_Boolean + "]");
    }
    this.this$0.b();
    a();
    synchronized (this.jdField_a_of_type_ArrayOfBoolean)
