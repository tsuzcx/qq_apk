  ...
  extends BroadcastReceiver
{
  ...
  private bedo jdField_a_of_type_Bedo;
  private String jdField_a_of_type_JavaLangString = "DEVICE_NONE";
  private boolean jdField_a_of_type_Boolean;
  private boolean b = true;
  
  public TraeAudioSession(Context paramContext, bedo parambedo)
  {
    ...
    if (Process.myPid() == TraeAudioManager.e)
    {
      ...
      this.jdField_a_of_type_Bedo = parambedo;
    ...
    label182:
    label189:
    for (parambedo = "null";; parambedo = "{object}")
    {
      QLog.w("TRAE", 2, parambedo);
      parambedo = new IntentFilter();
      parambedo.addAction("com.tencent.sharp.ACTION_TRAEAUDIOMANAGER_RES");
      parambedo.addAction("com.tencent.sharp.ACTION_TRAEAUDIOMANAGER_NOTIFY");
      if ((paramContext != null) && (paramContext.registerReceiver(this, parambedo) == null)) {}
      a(true);
      return;
      bool = false;
      break;
  ...
  public void a()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Bedo = null;
      return;
    }
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    do
    {
      do
      {
              ...
              do
              {
                do
                {
                  do
                  {
                    do
                    {
                      do
                      {
                        do
                        {
                            ...
                            do
                            {
                              for (;;)
                              {
                                ...
                                try
                                {
                                  ...
                                  {
                                    this.jdField_a_of_type_Bedo.a(l2, bool);
                                    return;
                                  }
                                }
                          ...
                          } while (this.jdField_a_of_type_Bedo == null);
                          this.jdField_a_of_type_Bedo.a(l2, (String[])localObject, str1, str2, str3);
                          return;
                        ...
                        this.jdField_a_of_type_Bedo.a(bool);
                        return;
                      ...
                      this.jdField_a_of_type_Bedo.a(l2, i);
                      return;
                    ...
                    } while ((this.jdField_a_of_type_Bedo == null) || (paramContext == null) || (localObject == null));
                    this.jdField_a_of_type_Bedo.a(paramContext, (String)localObject);
                    return;
                  ...
                  } while ((this.jdField_a_of_type_Bedo == null) || (paramContext == null) || (l1 == -1L));
                  this.jdField_a_of_type_Bedo.a(paramContext, l1);
                  return;
                } while (!"NOTIFY_BEGIN_CONNECTED_DEVICE".equals(localObject));
                paramContext = paramIntent.getStringExtra("CONNECTDEVICE_DEVICENAME");
              } while (this.jdField_a_of_type_Bedo == null);
              this.jdField_a_of_type_Bedo.a(paramContext);
              return;
        ...
        this.jdField_a_of_type_Bedo.a(j, (String[])localObject, str1, str2, str3);
        return;
      ...
      localObject = this.jdField_a_of_type_Bedo;
      if (j != 0) {
        break label2033;
      }
      bool = true;
      ((bedo)localObject).a(j, paramContext, bool);
      return;
    ...
    for (paramContext = "Y";; paramContext = "N")
    {
      ...
      this.jdField_a_of_type_Bedo.a(j, bool);
      return;
      if ("OPERATION_GETCONNECTEDDEVICE".equals(localObject))
      {
        ...
        this.jdField_a_of_type_Bedo.a(j, paramContext);
        return;
      }
      if ("OPERATION_GETCONNECTINGDEVICE".equals(localObject))
      {
        ...
        this.jdField_a_of_type_Bedo.b(j, paramContext);
        return;
      }
      if ("OPERATION_GETSTREAMTYPE".equals(localObject))
      {
        ...
        this.jdField_a_of_type_Bedo.a(j, i);
        return;
      }
      if ("NOTIFY_RING_COMPLETION".equals(localObject))
      {
        ...
        this.jdField_a_of_type_Bedo.a(l2, j, paramContext);
        return;
      }
      ...
      this.jdField_a_of_type_Bedo.a(j);
      return;
      bool = false;
      i += 1;
      break label362;
