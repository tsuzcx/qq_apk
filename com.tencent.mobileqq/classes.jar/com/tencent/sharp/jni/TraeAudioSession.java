  ...
  extends BroadcastReceiver
{
  ...
  public TraeAudioSession(Context paramContext, bkeg parambkeg)
  {
    ...
    label182:
    label189:
    for (parambkeg = "null";; parambkeg = "{object}")
    {
      QLog.w("TRAE", 2, parambkeg);
      parambkeg = new IntentFilter();
      parambkeg.addAction("com.tencent.sharp.ACTION_TRAEAUDIOMANAGER_RES");
      parambkeg.addAction("com.tencent.sharp.ACTION_TRAEAUDIOMANAGER_NOTIFY");
      if ((paramContext != null) && (paramContext.registerReceiver(this, parambkeg) == null)) {}
      a(true);
      return;
      bool = false;
      break;
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    do
    {
      do
      {
              ...
              do
              {
                do
                {
                  do
                  {
                    do
                    {
                      do
                      {
                        do
                        {
                            ...
                            do
                            {
                              for (;;)
                              {
                                ...
                                try
                                {
                                  ...
                                  {
                                    this.jdField_a_of_type_Bkeg.a(l2, bool);
                                    return;
                                  }
                                }
                          ...
                          } while (this.jdField_a_of_type_Bkeg == null);
                          this.jdField_a_of_type_Bkeg.a(l2, (String[])localObject, str1, str2, str3);
                          return;
                        ...
                        this.jdField_a_of_type_Bkeg.a(bool);
                        return;
                      ...
                      this.jdField_a_of_type_Bkeg.a(l2, i);
                      return;
                    ...
                    } while ((this.jdField_a_of_type_Bkeg == null) || (paramContext == null) || (localObject == null));
                    this.jdField_a_of_type_Bkeg.a(paramContext, (String)localObject);
                    return;
                  ...
                  } while ((this.jdField_a_of_type_Bkeg == null) || (paramContext == null) || (l1 == -1L));
                  this.jdField_a_of_type_Bkeg.a(paramContext, l1);
                  return;
                } while (!"NOTIFY_BEGIN_CONNECTED_DEVICE".equals(localObject));
                paramContext = paramIntent.getStringExtra("CONNECTDEVICE_DEVICENAME");
              } while (this.jdField_a_of_type_Bkeg == null);
              this.jdField_a_of_type_Bkeg.a(paramContext);
              return;
        ...
        this.jdField_a_of_type_Bkeg.a(j, (String[])localObject, str1, str2, str3);
        return;
      ...
      localObject = this.jdField_a_of_type_Bkeg;
      if (j != 0) {
        break label2033;
      }
      bool = true;
      ((bkeg)localObject).a(j, paramContext, bool);
      return;
    ...
    for (paramContext = "Y";; paramContext = "N")
    {
      ...
      this.jdField_a_of_type_Bkeg.a(j, bool);
      return;
      if ("OPERATION_GETCONNECTEDDEVICE".equals(localObject))
      {
        ...
        this.jdField_a_of_type_Bkeg.a(j, paramContext);
        return;
      }
      if ("OPERATION_GETCONNECTINGDEVICE".equals(localObject))
      {
        ...
        this.jdField_a_of_type_Bkeg.b(j, paramContext);
        return;
      }
      if ("OPERATION_GETSTREAMTYPE".equals(localObject))
      {
        ...
        this.jdField_a_of_type_Bkeg.a(j, i);
        return;
      }
      if ("NOTIFY_RING_COMPLETION".equals(localObject))
      {
        ...
        this.jdField_a_of_type_Bkeg.a(l2, j, paramContext);
        return;
      }
      ...
      this.jdField_a_of_type_Bkeg.a(j);
      return;
      bool = false;
      i += 1;
      break label362;
