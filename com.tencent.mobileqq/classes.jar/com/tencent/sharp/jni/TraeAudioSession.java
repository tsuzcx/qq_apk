  ...
  extends BroadcastReceiver
{
  ...
  private bjlo jdField_a_of_type_Bjlo;
  private String jdField_a_of_type_JavaLangString = "DEVICE_NONE";
  private boolean jdField_a_of_type_Boolean;
  private boolean b = true;
  
  public TraeAudioSession(Context paramContext, bjlo parambjlo)
  {
    ...
    if (Process.myPid() == TraeAudioManager.e)
    {
      ...
      this.jdField_a_of_type_Bjlo = parambjlo;
    ...
    label182:
    label189:
    for (parambjlo = "null";; parambjlo = "{object}")
    {
      QLog.w("TRAE", 2, parambjlo);
      parambjlo = new IntentFilter();
      parambjlo.addAction("com.tencent.sharp.ACTION_TRAEAUDIOMANAGER_RES");
      parambjlo.addAction("com.tencent.sharp.ACTION_TRAEAUDIOMANAGER_NOTIFY");
      if ((paramContext != null) && (paramContext.registerReceiver(this, parambjlo) == null)) {}
      a(true);
      return;
      bool = false;
      break;
  ...
  public void a()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Bjlo = null;
      return;
    }
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    do
    {
      do
      {
              ...
              do
              {
                do
                {
                  do
                  {
                    do
                    {
                      do
                      {
                        do
                        {
                            ...
                            do
                            {
                              for (;;)
                              {
                                ...
                                try
                                {
                                  ...
                                  if (this.jdField_a_of_type_Bjlo != null)
                                  {
                                    this.jdField_a_of_type_Bjlo.a(l2, bool);
                                    return;
                                  }
                                }
                          ...
                          } while (this.jdField_a_of_type_Bjlo == null);
                          this.jdField_a_of_type_Bjlo.a(l2, (String[])localObject, str1, str2, str3);
                          return;
                        ...
                        this.jdField_a_of_type_Bjlo.a(bool);
                        return;
                      ...
                      this.jdField_a_of_type_Bjlo.a(l2, i);
                      return;
                    ...
                    } while ((this.jdField_a_of_type_Bjlo == null) || (paramContext == null) || (localObject == null));
                    this.jdField_a_of_type_Bjlo.a(paramContext, (String)localObject);
                    return;
                  ...
                  } while ((this.jdField_a_of_type_Bjlo == null) || (paramContext == null) || (l1 == -1L));
                  this.jdField_a_of_type_Bjlo.a(paramContext, l1);
                  return;
                } while (!"NOTIFY_BEGIN_CONNECTED_DEVICE".equals(localObject));
                paramContext = paramIntent.getStringExtra("CONNECTDEVICE_DEVICENAME");
              } while (this.jdField_a_of_type_Bjlo == null);
              this.jdField_a_of_type_Bjlo.a(paramContext);
              return;
        ...
        this.jdField_a_of_type_Bjlo.a(j, (String[])localObject, str1, str2, str3);
        return;
      ...
      localObject = this.jdField_a_of_type_Bjlo;
      if (j != 0) {
        break label2033;
      }
      bool = true;
      ((bjlo)localObject).a(j, paramContext, bool);
      return;
    ...
    for (paramContext = "Y";; paramContext = "N")
    {
      ...
      this.jdField_a_of_type_Bjlo.a(j, bool);
      return;
      if ("OPERATION_GETCONNECTEDDEVICE".equals(localObject))
      {
        ...
        this.jdField_a_of_type_Bjlo.a(j, paramContext);
        return;
      }
      if ("OPERATION_GETCONNECTINGDEVICE".equals(localObject))
      {
        ...
        this.jdField_a_of_type_Bjlo.b(j, paramContext);
        return;
      }
      if ("OPERATION_GETSTREAMTYPE".equals(localObject))
      {
        ...
        this.jdField_a_of_type_Bjlo.a(j, i);
        return;
      }
      if ("NOTIFY_RING_COMPLETION".equals(localObject))
      {
        ...
        this.jdField_a_of_type_Bjlo.a(l2, j, paramContext);
        return;
      }
      ...
      this.jdField_a_of_type_Bjlo.a(j);
      return;
      bool = false;
      i += 1;
      break label362;
