  ...
  extends BroadcastReceiver
{
  ...
  public TraeAudioSession(Context paramContext, blfk paramblfk)
  {
    ...
    if (Process.myPid() == TraeAudioManager.e)
    {
      ...
      this.jdField_a_of_type_Blfk = paramblfk;
    ...
    label182:
    label189:
    for (paramblfk = "null";; paramblfk = "{object}")
    {
      QLog.w("TRAE", 2, paramblfk);
      paramblfk = new IntentFilter();
      paramblfk.addAction("com.tencent.sharp.ACTION_TRAEAUDIOMANAGER_RES");
      paramblfk.addAction("com.tencent.sharp.ACTION_TRAEAUDIOMANAGER_NOTIFY");
      if ((paramContext != null) && (paramContext.registerReceiver(this, paramblfk) == null)) {}
      a(true);
      return;
      bool = false;
      break;
  ...
  public void a()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Blfk = null;
      return;
    }
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    do
    {
      do
      {
              ...
              do
              {
                do
                {
                  do
                  {
                    do
                    {
                      do
                      {
                        do
                        {
                            ...
                            do
                            {
                              for (;;)
                              {
                                ...
                                try
                                {
                                  ...
                                  {
                                    this.jdField_a_of_type_Blfk.a(l2, bool);
                                    return;
                                  }
                                }
                          ...
                          } while (this.jdField_a_of_type_Blfk == null);
                          this.jdField_a_of_type_Blfk.a(l2, (String[])localObject, str1, str2, str3);
                          return;
                        ...
                        this.jdField_a_of_type_Blfk.a(bool);
                        return;
                      ...
                      this.jdField_a_of_type_Blfk.a(l2, i);
                      return;
                    ...
                    } while ((this.jdField_a_of_type_Blfk == null) || (paramContext == null) || (localObject == null));
                    this.jdField_a_of_type_Blfk.a(paramContext, (String)localObject);
                    return;
                  ...
                  } while ((this.jdField_a_of_type_Blfk == null) || (paramContext == null) || (l1 == -1L));
                  this.jdField_a_of_type_Blfk.a(paramContext, l1);
                  return;
        ...
        this.jdField_a_of_type_Blfk.a(j, (String[])localObject, str1, str2, str3);
        return;
      ...
      localObject = this.jdField_a_of_type_Blfk;
      if (j != 0) {
        break label2033;
      }
      bool = true;
      ((blfk)localObject).a(j, paramContext, bool);
      return;
    ...
    for (paramContext = "Y";; paramContext = "N")
    {
      ...
      this.jdField_a_of_type_Blfk.a(j, bool);
      return;
      if ("OPERATION_GETCONNECTEDDEVICE".equals(localObject))
      {
        ...
        this.jdField_a_of_type_Blfk.a(j, paramContext);
        return;
      }
      if ("OPERATION_GETCONNECTINGDEVICE".equals(localObject))
      {
        ...
        this.jdField_a_of_type_Blfk.b(j, paramContext);
        return;
      }
      if ("OPERATION_GETSTREAMTYPE".equals(localObject))
      {
        ...
        this.jdField_a_of_type_Blfk.a(j, i);
        return;
      }
      if ("NOTIFY_RING_COMPLETION".equals(localObject))
      {
        ...
        this.jdField_a_of_type_Blfk.a(l2, j, paramContext);
        return;
      }
      ...
      this.jdField_a_of_type_Blfk.a(j);
      return;
      bool = false;
      i += 1;
      break label362;
