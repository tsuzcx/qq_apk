  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 34, 40 }, new String[] { "req_type", "body_type_1", "body_type_2", "uin", "appId" }, new Object[] { localInteger, null, null, "", localInteger }, ReqBody.class);
  }
}
