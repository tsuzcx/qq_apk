  ...
  extends TimerTask
{
  ...
  private static String o = bcwx.a(bcwx.l);
  
  static
  {
    jdField_a_of_type_JavaLangString = bcwx.a(bcwx.a);
    jdField_b_of_type_JavaLangString = bcwx.a(bcwx.a);
    c = bcwx.a(bcwx.a);
    d = bcwx.a(bcwx.a);
    e = "";
    e = bcwx.a(bcwx.b);
  ...
  private String a(com.tencent.commonsdk.zip.QZipFile paramQZipFile, java.util.zip.ZipEntry paramZipEntry)
  {
    ...
    //   9: aload_2
    //   10: astore_1
    //   11: getstatic 101	bcwx:m	[B
    //   14: invokestatic 42	bcwx:a	([B)Ljava/lang/String;
    ...
    //   91: invokestatic 130	bcwy:a	([B)Ljava/lang/String;
    //   94: astore 4
    //   96: aload 4
    //   98: astore_1
    //   99: aload_2
  ...
  private String a(String paramString)
  {
    ...
    //   72: astore_1
    //   73: aload 5
    //   75: getstatic 171	bcwx:n	[B
    //   78: invokestatic 42	bcwx:a	([B)Ljava/lang/String;
    //   81: invokevirtual 175	java/lang/String:endsWith	(Ljava/lang/String;)Z
    //   84: ifeq -68 -> 16
    //   87: aload_2
    //   88: astore_1
    //   89: aload 5
    //   91: getstatic 177	bcwx:o	[B
    //   94: invokestatic 42	bcwx:a	([B)Ljava/lang/String;
  ...
  private void b()
  {
    for (;;)
    {
      try
      {
        ...
        localc.str_apkversion.set("8.3.0.4480");
      ...
      if (localObject2 != null)
      {
        bcwy.a(localException, g, (byte[])localObject2);
        c = bfmv.a((byte[])localObject2);
      }
  ...
  private void c()
  {
    try
    {
      ...
      localEditor.putString(n, "8.3.0.4480");
      localEditor.commit();
      return;
    }
    catch (Exception localException)
    ...
    try
    {
      ...
      if (!jdField_a_of_type_Boolean)
      {
        ...
        if (localObject != null)
        {
          ...
          if (localObject != null)
          {
            jdField_a_of_type_Int = bcwz.a((String)localObject, g);
