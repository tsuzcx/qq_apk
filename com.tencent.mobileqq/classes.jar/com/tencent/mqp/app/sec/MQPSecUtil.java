...
public class MQPSecUtil
{
  ...
  static
  {
    // Byte code:
    //   0: aconst_null
    //   1: putstatic 15	com/tencent/mqp/app/sec/MQPSecUtil:jdField_a_of_type_ComTencentMqpAppSecMQPSecUtil	Lcom/tencent/mqp/app/sec/MQPSecUtil;
    //   4: iconst_1
    //   5: putstatic 17	com/tencent/mqp/app/sec/MQPSecUtil:jdField_a_of_type_Int	I
    //   8: invokestatic 23	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   11: astore_3
    ...
    //   23: aload_3
    //   24: invokevirtual 36	android/content/Context:getFilesDir	()Ljava/io/File;
    //   27: invokevirtual 40	java/io/File:getParent	()Ljava/lang/String;
    ...
    //   51: invokespecial 56	java/io/File:<init>	(Ljava/lang/String;)V
    //   54: astore_2
    //   55: aload_2
    ...
    //   62: ldc 62
    //   64: astore_1
    //   65: getstatic 68	android/os/Build:CPU_ABI	Ljava/lang/String;
    //   68: ldc 70
    //   70: invokevirtual 76	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   73: ifeq +95 -> 168
    //   76: ldc 70
    //   78: astore_1
    //   79: aload_1
    ...
    //   85: aload_3
    //   86: aload_1
    //   87: invokestatic 81	com/tencent/mqp/app/sec/MQPSecUtil:a	(Landroid/content/Context;Ljava/lang/String;)V
    //   90: aload_2
    //   91: astore_1
    //   92: aload_2
    //   93: invokevirtual 60	java/io/File:exists	()Z
    //   96: ifne +46 -> 142
    //   99: new 25	java/io/File
    //   102: dup
    //   103: new 27	java/lang/StringBuilder
    //   106: dup
    //   107: invokespecial 30	java/lang/StringBuilder:<init>	()V
    //   110: aload_3
    //   111: invokevirtual 36	android/content/Context:getFilesDir	()Ljava/io/File;
    //   114: invokevirtual 40	java/io/File:getParent	()Ljava/lang/String;
    //   117: invokevirtual 44	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   120: ldc 83
    //   122: invokevirtual 44	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   125: ldc 48
    //   127: invokevirtual 44	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   130: ldc 50
    //   132: invokevirtual 44	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   135: invokevirtual 53	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   138: invokespecial 56	java/io/File:<init>	(Ljava/lang/String;)V
    //   141: astore_1
    //   142: aload_1
    //   143: invokevirtual 60	java/io/File:exists	()Z
    //   146: ifeq +82 -> 228
    //   149: aload_1
    //   150: invokevirtual 86	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   153: invokestatic 91	java/lang/System:load	(Ljava/lang/String;)V
    //   156: iconst_1
    //   157: istore_0
    //   158: iload_0
    //   159: ifne +8 -> 167
    //   162: ldc 48
    //   164: invokestatic 94	java/lang/System:loadLibrary	(Ljava/lang/String;)V
    //   167: return
    //   168: getstatic 68	android/os/Build:CPU_ABI	Ljava/lang/String;
    //   171: ldc 96
    //   173: invokevirtual 76	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   176: ifeq -97 -> 79
    //   179: ldc 78
    //   181: astore_1
    //   182: goto -103 -> 79
    //   185: astore_1
    //   186: aload_1
    //   187: invokevirtual 99	java/lang/Throwable:printStackTrace	()V
    //   190: goto -100 -> 90
    //   193: astore_2
    //   194: invokestatic 104	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   197: ifeq +31 -> 228
    //   200: ldc 106
    //   202: iconst_2
    //   203: new 27	java/lang/StringBuilder
    //   206: dup
    //   207: invokespecial 30	java/lang/StringBuilder:<init>	()V
    //   210: ldc 108
    //   212: invokevirtual 44	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   215: aload_1
    //   216: invokevirtual 86	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   219: invokevirtual 44	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   222: invokevirtual 53	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   225: invokestatic 112	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   228: iconst_0
    //   229: istore_0
    //   230: goto -72 -> 158
    //   233: astore_1
    //   234: invokestatic 104	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   237: ifeq -70 -> 167
    //   240: ldc 106
    //   242: iconst_2
    //   243: ldc 114
    //   245: invokestatic 112	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   248: return
    ...
    //   11	100	3	localBaseApplication	com.tencent.qphone.base.util.BaseApplication
    // Exception table:
    //   from	to	target	type
  ...
  private static void a(android.content.Context paramContext, String paramString)
  {
    ...
    //   43: aload_0
    //   44: invokevirtual 36	android/content/Context:getFilesDir	()Ljava/io/File;
    //   47: invokevirtual 40	java/io/File:getParent	()Ljava/lang/String;
    ...
    //   85: invokevirtual 53	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   88: astore_1
    //   89: new 25	java/io/File
    //   92: dup
    //   93: aload 6
    //   95: invokespecial 56	java/io/File:<init>	(Ljava/lang/String;)V
    //   98: invokevirtual 131	java/io/File:mkdirs	()Z
    //   101: pop
    //   102: aload_0
    //   103: invokevirtual 135	android/content/Context:getAssets	()Landroid/content/res/AssetManager;
    //   106: aload 5
    //   108: invokevirtual 141	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   111: astore_0
    //   112: new 143	java/io/FileOutputStream
    //   115: dup
    //   116: aload_1
    //   117: invokespecial 144	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   120: astore_3
    //   121: sipush 4096
    //   124: newarray byte
    //   126: astore_1
    //   127: aload_0
    //   128: aload_1
    //   129: invokevirtual 150	java/io/InputStream:read	([B)I
    //   132: istore_2
    //   133: iload_2
    //   134: ifle +35 -> 169
    //   137: aload_3
    ...
    //   139: iconst_0
    //   140: iload_2
    //   141: invokevirtual 156	java/io/OutputStream:write	([BII)V
    //   144: goto -17 -> 127
    //   147: astore_1
    //   148: aload_0
    //   149: astore_1
    ...
    //   153: ifnull +7 -> 160
    //   156: aload_1
    //   157: invokevirtual 159	java/io/InputStream:close	()V
    //   160: aload_0
    //   161: ifnull +7 -> 168
    //   164: aload_0
    //   165: invokevirtual 160	java/io/OutputStream:close	()V
    //   168: return
    //   169: aload_0
    //   170: ifnull +7 -> 177
    //   173: aload_0
    //   174: invokevirtual 159	java/io/InputStream:close	()V
    //   177: aload_3
    //   178: ifnull -10 -> 168
    //   181: aload_3
    //   182: invokevirtual 160	java/io/OutputStream:close	()V
    //   185: return
    //   186: astore_0
    //   187: aload_0
    //   188: invokevirtual 161	java/io/IOException:printStackTrace	()V
    //   191: return
    //   192: astore_0
    //   193: aload_0
    //   194: invokevirtual 161	java/io/IOException:printStackTrace	()V
    //   197: return
    //   198: astore_1
    //   199: aconst_null
    //   200: astore_0
    ...
    //   205: ifnull +7 -> 212
    //   208: aload_0
    //   209: invokevirtual 159	java/io/InputStream:close	()V
    //   212: aload_3
    //   213: ifnull +7 -> 220
    //   216: aload_3
    //   217: invokevirtual 160	java/io/OutputStream:close	()V
    //   220: aload_1
    //   221: athrow
    //   222: astore_0
    //   223: aload_0
    //   224: invokevirtual 161	java/io/IOException:printStackTrace	()V
    //   227: goto -7 -> 220
    //   230: astore_1
    //   231: aload 4
    //   233: astore_3
