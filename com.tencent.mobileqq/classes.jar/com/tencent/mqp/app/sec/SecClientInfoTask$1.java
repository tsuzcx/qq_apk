  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ((ClientInfoA.EnvParamPacket)localObject3).str_qqversion.set("8.2.6.4370");
      ...
      if (SecClientInfoTask.a(this.this$0) == 2)
      {
        ...
        {
          SecClientInfoTask.a(zpw.a(localQQAppInterface.getApplication().getApplicationInfo().sourceDir));
