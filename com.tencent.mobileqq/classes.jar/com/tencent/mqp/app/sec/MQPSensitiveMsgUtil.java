...
public class MQPSensitiveMsgUtil
{
  ...
  private static void a(SpannableStringBuilder paramSpannableStringBuilder, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      break;
      label88:
      if ((k >= paramInt1) && (m <= paramInt2) && (!(localObject instanceof EmoticonSpan)))
      {
  ...
  public static void a(MessageRecord paramMessageRecord, List<MessageRecord> paramList, boolean paramBoolean, byte[] paramArrayOfByte)
  {
    ...
    //   500: ifne +696 -> 1196
    //   503: invokestatic 215	com/tencent/mqp/app/sec/MQPSensitiveMsgUtil:a	()Lcom/tencent/mqp/app/sec/MQPSensitiveMsgUtil;
    //   506: aload 19
    //   508: invokevirtual 266	com/tencent/mqp/app/sec/MQPSensitiveMsgUtil:a	(Ljava/lang/String;)Z
    //   511: ifne +685 -> 1196
    //   514: iconst_1
    //   515: istore 16
    //   517: goto -96 -> 421
    ...
    //   707: iload 10
    //   709: isub
    //   710: invokestatic 293	com/tencent/mqp/app/sec/MQPSensitiveMsgUtil:a	(Ljava/lang/String;I)I
    //   713: istore 13
    //   715: aload 21
    ...
    //   725: iload 10
    //   727: isub
    //   728: invokestatic 293	com/tencent/mqp/app/sec/MQPSensitiveMsgUtil:a	(Ljava/lang/String;I)I
    //   731: istore 15
    //   733: iload 8
    //   735: iload 13
    //   737: iadd
    ...
    //   806: iload 7
    //   808: isub
    //   809: invokestatic 306	com/tencent/mqp/app/sec/MQPSensitiveMsgUtil:a	(Ljava/lang/String;IJZLcom/tencent/ims/bankcode_info$BankcodeCtrlInfo;IILcom/tencent/mobileqq/data/MessageForText;I)V
    //   812: iload 7
    //   814: aload 21
    ...
    //   827: invokestatic 293	com/tencent/mqp/app/sec/MQPSensitiveMsgUtil:a	(Ljava/lang/String;I)I
    //   830: aload 21
    ...
    for (k = i2;; k = 0) {
      for (;;)
      {
        ...
        if (!TextUtils.isEmpty(paramString4)) {
          ((QQCustomDialog)localObject3).setPositiveButton(paramString4, new MQPSensitiveMsgUtil.1((String)localObject2, j, i, (QQMessageFacade)localObject1, paramString1, paramInt, paramLong));
        }
        if (!TextUtils.isEmpty(paramString5)) {
          ((QQCustomDialog)localObject3).setNegativeButton(paramString5, new MQPSensitiveMsgUtil.2((String)localObject2, j, i));
        }
