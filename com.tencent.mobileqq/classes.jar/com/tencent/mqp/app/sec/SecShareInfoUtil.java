...
public class SecShareInfoUtil
{
  ...
  private void c()
  {
    ...
    try
    {
      ...
      localSharedInfoPacket.qq_version.set(a("8.5.5"));
      if (QLog.isColorLevel()) {
        QLog.d("SecShare.AV", 2, String.format("Version = %s intVersion= 0x%x", new Object[] { "8.5.5", Integer.valueOf(a("8.5.5")) }));
      }
      ...
      localObject3 = ((SecShareInfoUtil.FileInfo)localObject1).a();
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        {
          localObject2 = MD5.a((String)localObject3);
