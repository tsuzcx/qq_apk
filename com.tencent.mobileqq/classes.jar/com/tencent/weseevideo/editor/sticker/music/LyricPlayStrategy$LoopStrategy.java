  ...
  implements LyricPlayStrategy.IStrategy
{
  public float calculateProgress(long paramLong1, long paramLong2, @NotNull LyricPlayStrategy.LyricAnimation paramLyricAnimation)
  {
    ...
    if (paramLong1 < paramLong2 - paramLyricAnimation.getSuffixDuration()) {
      return (float)((paramLong1 - paramLyricAnimation.getPrefixDuration()) % paramLyricAnimation.getLoopRangeDuration() + paramLyricAnimation.getPrefixDuration()) / (float)paramLyricAnimation.getDuration();
    }
 ...
 * Qualified Name:     com.tencent.weseevideo.editor.sticker.music.LyricPlayStrategy.LoopStrategy
