...
{
  public static void wrap(String paramString, Paint paramPaint, int paramInt1, int paramInt2, int paramInt3, ArrayList<String> paramArrayList)
  {
  ...
  public static String[] wrap(String paramString, Paint paramPaint, int paramInt1, int paramInt2)
  {
    return wrap(paramString, paramPaint, paramInt1, paramInt2, 99999);
  }
  
  public static String[] wrap(String paramString, Paint paramPaint, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      break label161;
      wrap(paramString, paramPaint, k, j, paramInt2, localArrayList);
      break label183;
      if ((i > 1) && (m == 10)) {
        localArrayList.add("");
      }
