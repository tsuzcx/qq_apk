  ...
  implements IParser
{
  ...
  public com.tencent.weseevideo.editor.sticker.music.lyric.data.Lyric parse()
  {
    ...
    //   98: ldc 22
    //   100: invokevirtual 249	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   103: ifeq -33 -> 70
    //   106: aload_2
    //   107: aload_2
    //   108: ldc 22
    ...
    //   123: aload_2
    //   124: ldc 13
    //   126: invokevirtual 246	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   129: ifeq +131 -> 260
    //   132: aload_2
    //   133: ldc 13
    //   135: invokevirtual 252	java/lang/String:lastIndexOf	(Ljava/lang/String;)I
    //   138: istore_1
    //   139: iload_1
    //   140: iconst_m1
    //   141: if_icmpeq -71 -> 70
    ...
    //   151: aload_2
    //   152: ldc 22
    //   154: invokevirtual 246	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   157: ifeq +108 -> 265
    //   160: aload_2
    //   161: ldc 22
    //   163: invokevirtual 252	java/lang/String:lastIndexOf	(Ljava/lang/String;)I
    //   166: istore_1
    //   167: iload_1
    //   168: iconst_m1
    //   169: if_icmpeq -99 -> 70
    ...
    //   178: astore_2
    //   179: new 254	java/io/BufferedReader
    //   182: dup
    //   183: new 256	java/io/StringReader
    //   186: dup
    //   187: aload_2
    //   188: invokespecial 258	java/io/StringReader:<init>	(Ljava/lang/String;)V
    //   191: invokespecial 261	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   194: astore_3
    //   195: aload_3
    //   196: astore_2
    //   197: aload_3
    //   198: invokevirtual 264	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   201: astore 4
    //   203: aload 4
    //   205: ifnull +65 -> 270
    //   208: aload_3
    ...
    //   216: invokespecial 266	com/tencent/weseevideo/editor/sticker/music/lyric/parse/parser/QrcNoDecryptParserWEmptyLine:parseQrcLine	(Ljava/lang/String;)V
    //   219: goto -24 -> 195
    //   222: astore 4
    //   224: aload_3
    //   225: astore_2
    ...
    //   238: ifnull -168 -> 70
    //   241: aload_3
    //   242: invokevirtual 269	java/io/BufferedReader:close	()V
    //   245: aconst_null
    //   246: areturn
    //   247: astore_2
    //   248: ldc 25
    //   250: aload_2
    //   251: invokevirtual 270	java/io/IOException:toString	()Ljava/lang/String;
    ...
    //   271: astore_2
    //   272: aload_0
    //   273: getfield 68	com/tencent/weseevideo/editor/sticker/music/lyric/parse/parser/QrcNoDecryptParserWEmptyLine:mLineLyricList	Ljava/util/ArrayList;
    //   276: getstatic 60	com/tencent/weseevideo/editor/sticker/music/lyric/parse/parser/QrcNoDecryptParserWEmptyLine:mLineComparator	Lcom/tencent/weseevideo/editor/sticker/music/lyric/parse/parser/QrcNoDecryptParserWEmptyLine$LyricComparator;
    //   279: invokestatic 276	java/util/Collections:sort	(Ljava/util/List;Ljava/util/Comparator;)V
    //   282: aload_3
    //   283: astore_2
    //   284: new 278	com/tencent/weseevideo/editor/sticker/music/lyric/data/Lyric
    //   287: dup
    //   288: iconst_2
    //   289: aload_0
    //   290: getfield 185	com/tencent/weseevideo/editor/sticker/music/lyric/parse/parser/QrcNoDecryptParserWEmptyLine:mOffset	I
    //   293: aload_0
    //   294: getfield 68	com/tencent/weseevideo/editor/sticker/music/lyric/parse/parser/QrcNoDecryptParserWEmptyLine:mLineLyricList	Ljava/util/ArrayList;
    //   297: invokespecial 281	com/tencent/weseevideo/editor/sticker/music/lyric/data/Lyric:<init>	(IILjava/util/ArrayList;)V
    //   300: astore 4
    //   302: aload_3
    //   303: ifnull +7 -> 310
    //   306: aload_3
    //   307: invokevirtual 269	java/io/BufferedReader:close	()V
    //   310: aload 4
    //   312: areturn
    //   313: astore_2
    //   314: ldc 25
    //   316: aload_2
    //   317: invokevirtual 270	java/io/IOException:toString	()Ljava/lang/String;
    ...
    //   331: ifnull +7 -> 338
    //   334: aload_2
    //   335: invokevirtual 269	java/io/BufferedReader:close	()V
    //   338: aload_3
    //   339: athrow
    //   340: astore_2
    //   341: ldc 25
    //   343: aload_2
    //   344: invokevirtual 270	java/io/IOException:toString	()Ljava/lang/String;
    ...
    //   0	365	0	this	QrcNoDecryptParserWEmptyLine
    //   24	243	1	i	int
