...
public class QrcNoDecryptParserWEmptyLine
  implements IParser
{
  ...
  public static final String TAG = "QrcNoDecParWOEmptyLine";
  private static final QrcNoDecryptParserWEmptyLine.LyricComparator mLineComparator = new QrcNoDecryptParserWEmptyLine.LyricComparator(null);
  ...
  private int parseOffset(String paramString)
  {
    ...
    {
      Log.e("QrcNoDecParWOEmptyLine", paramString.toString());
    }
    return 0;
  }
  ...
  private void parseQrcLine(String paramString)
  {
    if (paramString != null)
    {
      ...
      try
      {
        ...
        localObject1 = paramString.substring(i).trim();
  ...
  private void parseQrcWord(String paramString, Sentence paramSentence)
  {
    ...
    {
      Log.e("QrcNoDecParWOEmptyLine", "", paramString);
    }
  }
  ...
  public com.tencent.weseevideo.editor.sticker.music.lyric.data.Lyric parse()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 237	com/tencent/weseevideo/editor/sticker/music/lyric/parse/parser/QrcNoDecryptParserWEmptyLine:mString	Ljava/lang/String;
    //   4: astore_3
    //   5: aload_3
    //   6: ifnull +371 -> 377
    //   9: aload_3
    //   10: ldc 16
    //   12: invokevirtual 246	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   15: ifeq +13 -> 28
    //   18: aload_3
    //   19: ldc 16
    ...
    //   62: ldc 19
    //   64: invokevirtual 249	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   67: ifne +5 -> 72
    //   70: aconst_null
    //   71: areturn
    //   72: aload_3
    ...
    //   89: ldc 22
    //   91: invokevirtual 249	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   94: ifne +5 -> 99
    //   97: aconst_null
    //   98: areturn
    //   99: aload_3
    ...
    //   112: aload_3
    //   113: ldc 13
    //   115: invokevirtual 246	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   118: ifeq +13 -> 131
    //   121: aload_3
    //   122: ldc 13
    //   124: invokevirtual 252	java/lang/String:lastIndexOf	(Ljava/lang/String;)I
    //   127: istore_1
    //   128: goto +5 -> 133
    //   131: iconst_m1
    //   132: istore_1
    ...
    //   147: aload_3
    //   148: ldc 22
    //   150: invokevirtual 246	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   153: ifeq +13 -> 166
    //   156: aload_3
    //   157: ldc 22
    //   159: invokevirtual 252	java/lang/String:lastIndexOf	(Ljava/lang/String;)I
    //   162: istore_1
    //   163: goto +5 -> 168
    //   166: iconst_m1
    //   167: istore_1
    ...
    //   181: astore_3
    //   182: new 254	java/io/BufferedReader
    //   185: dup
    //   186: new 256	java/io/StringReader
    //   189: dup
    //   190: aload_3
    //   191: invokespecial 258	java/io/StringReader:<init>	(Ljava/lang/String;)V
    //   194: invokespecial 261	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   197: astore 4
    //   199: aload 4
    //   201: astore_3
    //   202: aload 4
    //   204: invokevirtual 264	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   207: astore 5
    //   209: aload 5
    //   211: ifnull +18 -> 229
    //   214: aload 4
    ...
    //   223: invokespecial 266	com/tencent/weseevideo/editor/sticker/music/lyric/parse/parser/QrcNoDecryptParserWEmptyLine:parseQrcLine	(Ljava/lang/String;)V
    //   226: goto -27 -> 199
    //   229: aload 4
    //   231: astore_3
    //   232: aload_0
    //   233: getfield 68	com/tencent/weseevideo/editor/sticker/music/lyric/parse/parser/QrcNoDecryptParserWEmptyLine:mLineLyricList	Ljava/util/ArrayList;
    //   236: getstatic 60	com/tencent/weseevideo/editor/sticker/music/lyric/parse/parser/QrcNoDecryptParserWEmptyLine:mLineComparator	Lcom/tencent/weseevideo/editor/sticker/music/lyric/parse/parser/QrcNoDecryptParserWEmptyLine$LyricComparator;
    //   239: invokestatic 272	java/util/Collections:sort	(Ljava/util/List;Ljava/util/Comparator;)V
    //   242: aload 4
    //   244: astore_3
    //   245: new 274	com/tencent/weseevideo/editor/sticker/music/lyric/data/Lyric
    //   248: dup
    //   249: iconst_2
    //   250: aload_0
    //   251: getfield 185	com/tencent/weseevideo/editor/sticker/music/lyric/parse/parser/QrcNoDecryptParserWEmptyLine:mOffset	I
    //   254: aload_0
    //   255: getfield 68	com/tencent/weseevideo/editor/sticker/music/lyric/parse/parser/QrcNoDecryptParserWEmptyLine:mLineLyricList	Ljava/util/ArrayList;
    //   258: invokespecial 277	com/tencent/weseevideo/editor/sticker/music/lyric/data/Lyric:<init>	(IILjava/util/ArrayList;)V
    //   261: astore 5
    //   263: aload 4
    //   265: invokevirtual 280	java/io/BufferedReader:close	()V
    //   268: aload 5
    //   270: areturn
    //   271: astore_3
    //   272: ldc 25
    //   274: aload_3
    //   275: invokevirtual 281	java/io/IOException:toString	()Ljava/lang/String;
    ...
    //   318: ifnull +59 -> 377
    //   321: aload 4
    //   323: invokevirtual 280	java/io/BufferedReader:close	()V
    //   326: aconst_null
    //   327: areturn
    //   328: astore_3
    //   329: ldc 25
    //   331: aload_3
    //   332: invokevirtual 281	java/io/IOException:toString	()Ljava/lang/String;
    ...
    //   351: ifnull +24 -> 375
    //   354: aload 4
    //   356: invokevirtual 280	java/io/BufferedReader:close	()V
    //   359: goto +16 -> 375
    //   362: astore 4
    //   364: ldc 25
    //   366: aload 4
    //   368: invokevirtual 281	java/io/IOException:toString	()Ljava/lang/String;
    ...
    //   0	379	0	this	QrcNoDecryptParserWEmptyLine
    //   24	154	1	i	int
    //   39	11	2	j	int
 ...
 * Qualified Name:     com.tencent.weseevideo.editor.sticker.music.lyric.parse.parser.QrcNoDecryptParserWEmptyLine
