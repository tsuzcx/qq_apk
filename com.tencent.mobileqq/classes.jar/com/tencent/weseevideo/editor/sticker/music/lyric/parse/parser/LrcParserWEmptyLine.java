  ...
  implements IParser
{
  ...
  private void parseLine(String paramString)
  {
    ...
    //   8: ifne +4 -> 12
    //   11: return
    //   12: getstatic 35	com/tencent/weseevideo/editor/sticker/music/lyric/parse/parser/LrcParserWEmptyLine:mPattern	Ljava/util/regex/Pattern;
    //   15: aload_1
    ...
    //   162: invokespecial 116	com/tencent/weseevideo/editor/sticker/music/lyric/parse/parser/LrcParserWEmptyLine:parseTime	(Ljava/lang/String;)J
    //   165: lstore 5
    //   167: lload 5
    //   169: ldc2_w 117
    //   172: lcmp
    ...
    //   199: aload_0
    //   200: getfield 51	com/tencent/weseevideo/editor/sticker/music/lyric/parse/parser/LrcParserWEmptyLine:mLineLyricList	Ljava/util/ArrayList;
    //   203: aload 12
    ...
    //   295: ifne +56 -> 351
    //   298: aload_0
    //   299: getfield 148	com/tencent/weseevideo/editor/sticker/music/lyric/parse/parser/LrcParserWEmptyLine:mOffset	I
    //   302: ifne +49 -> 351
    //   305: aload 9
    ...
    //   330: invokespecial 151	com/tencent/weseevideo/editor/sticker/music/lyric/parse/parser/LrcParserWEmptyLine:parseOffset	(Ljava/lang/String;)I
    //   333: istore_2
    //   334: iload_2
    //   335: ldc 152
    ...
    //   340: aload_0
    //   341: iload_2
    //   342: putfield 148	com/tencent/weseevideo/editor/sticker/music/lyric/parse/parser/LrcParserWEmptyLine:mOffset	I
    //   345: aload 9
    ...
    //   379: invokespecial 116	com/tencent/weseevideo/editor/sticker/music/lyric/parse/parser/LrcParserWEmptyLine:parseTime	(Ljava/lang/String;)J
    //   382: lstore 5
    //   384: lload 5
    //   386: ldc2_w 117
    //   389: lcmp
    ...
    //   397: ifle -39 -> 358
    //   400: new 120	com/tencent/weseevideo/editor/sticker/music/lyric/data/Sentence
    //   403: dup
    //   404: invokespecial 121	com/tencent/weseevideo/editor/sticker/music/lyric/data/Sentence:<init>	()V
    //   407: astore 8
    //   409: aload 8
    //   411: aload_1
    //   412: putfield 124	com/tencent/weseevideo/editor/sticker/music/lyric/data/Sentence:mText	Ljava/lang/String;
    //   415: aload 8
    //   417: lload 5
    //   419: putfield 128	com/tencent/weseevideo/editor/sticker/music/lyric/data/Sentence:mStartTime	J
    //   422: aload_0
    //   423: getfield 51	com/tencent/weseevideo/editor/sticker/music/lyric/parse/parser/LrcParserWEmptyLine:mLineLyricList	Ljava/util/ArrayList;
    //   426: aload 8
  ...
  public com.tencent.weseevideo.editor.sticker.music.lyric.data.Lyric parse()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 188	com/tencent/weseevideo/editor/sticker/music/lyric/parse/parser/LrcParserWEmptyLine:mString	Ljava/lang/String;
    //   4: astore_2
    ...
    //   42: invokespecial 206	com/tencent/weseevideo/editor/sticker/music/lyric/parse/parser/LrcParserWEmptyLine:parseLine	(Ljava/lang/String;)V
    //   45: goto -24 -> 21
    //   48: aload_3
    //   49: astore_2
    //   50: aload_0
    //   51: getfield 51	com/tencent/weseevideo/editor/sticker/music/lyric/parse/parser/LrcParserWEmptyLine:mLineLyricList	Ljava/util/ArrayList;
    //   54: getstatic 43	com/tencent/weseevideo/editor/sticker/music/lyric/parse/parser/LrcParserWEmptyLine:mLineComparator	Lcom/tencent/weseevideo/editor/sticker/music/lyric/parse/parser/LrcParserWEmptyLine$LyricComparator;
    ...
    //   64: iload_1
    //   65: aload_0
    //   66: getfield 51	com/tencent/weseevideo/editor/sticker/music/lyric/parse/parser/LrcParserWEmptyLine:mLineLyricList	Ljava/util/ArrayList;
    ...
    //   77: iload_1
    //   78: aload_0
    //   79: getfield 51	com/tencent/weseevideo/editor/sticker/music/lyric/parse/parser/LrcParserWEmptyLine:mLineLyricList	Ljava/util/ArrayList;
    ...
    //   91: astore_2
    //   92: aload_0
    //   93: getfield 51	com/tencent/weseevideo/editor/sticker/music/lyric/parse/parser/LrcParserWEmptyLine:mLineLyricList	Ljava/util/ArrayList;
    //   96: iload_1
    ...
    //   103: aload_0
    //   104: getfield 51	com/tencent/weseevideo/editor/sticker/music/lyric/parse/parser/LrcParserWEmptyLine:mLineLyricList	Ljava/util/ArrayList;
    //   107: iload_1
    //   108: iconst_1
    //   109: iadd
    ...
    //   119: aload_0
    //   120: getfield 51	com/tencent/weseevideo/editor/sticker/music/lyric/parse/parser/LrcParserWEmptyLine:mLineLyricList	Ljava/util/ArrayList;
    //   123: iload_1
    ...
    //   133: lsub
    //   134: putfield 222	com/tencent/weseevideo/editor/sticker/music/lyric/data/Sentence:mDuration	J
    //   137: goto +154 -> 291
    //   140: aload_3
    //   141: astore_2
    //   142: aload_0
    //   143: getfield 51	com/tencent/weseevideo/editor/sticker/music/lyric/parse/parser/LrcParserWEmptyLine:mLineLyricList	Ljava/util/ArrayList;
    //   146: iload_1
    ...
    //   153: ldc2_w 223
    //   156: putfield 222	com/tencent/weseevideo/editor/sticker/music/lyric/data/Sentence:mDuration	J
    //   159: goto +132 -> 291
    //   162: aload_3
    //   163: astore_2
    //   164: new 226	com/tencent/weseevideo/editor/sticker/music/lyric/data/Lyric
    //   167: dup
    //   168: iconst_1
    //   169: aload_0
    //   170: getfield 148	com/tencent/weseevideo/editor/sticker/music/lyric/parse/parser/LrcParserWEmptyLine:mOffset	I
    //   173: aload_0
    //   174: getfield 51	com/tencent/weseevideo/editor/sticker/music/lyric/parse/parser/LrcParserWEmptyLine:mLineLyricList	Ljava/util/ArrayList;
    //   177: invokespecial 229	com/tencent/weseevideo/editor/sticker/music/lyric/data/Lyric:<init>	(IILjava/util/ArrayList;)V
    //   180: astore 4
    //   182: aload_3
 ...
 * Qualified Name:     com.tencent.weseevideo.editor.sticker.music.lyric.parse.parser.LrcParserWEmptyLine
