...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/weseevideo/model/WSTemplateManager;", "", "()V", "AE_FRAME_TEMPLATE_JSON", "", "clearMediaTemplateModel", "", "mediaModel", "Lcom/tencent/weseevideo/model/MediaModel;", "updateAutoTemplate", "templateDir", "templateJsonName", "isSwitchToTemplateByUser", "", "updateLightTemplate", "updateMovieTemplate", "updateTemplate", "type", "", "args", "", "(Lcom/tencent/weseevideo/model/MediaModel;ILjava/lang/String;Z[Ljava/lang/String;)V", "libtavcut_debug"}, k=1, mv={1, 1, 16})
public final class WSTemplateManager
{
  ...
  private final void updateAutoTemplate(MediaModel paramMediaModel, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    if ((com.tencent.weseevideo.model.utils.FileUtils.exists(paramString1)) && (com.tencent.weseevideo.model.utils.FileUtils.exists(((File)localObject1).getAbsolutePath())))
    {
      localObject1 = new AutomaticMediaTemplateModel();
      if ((ModelExtKt.isImageMode(paramMediaModel)) && (com.tencent.weseevideo.model.utils.FileUtils.exists(paramString1)) && (((File)localObject2).exists()))
      {
  ...
  private final void updateLightTemplate(MediaModel paramMediaModel, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    if ((com.tencent.weseevideo.model.utils.FileUtils.exists(paramString1)) && (com.tencent.weseevideo.model.utils.FileUtils.exists(paramString2.getAbsolutePath())))
    {
  ...
  private final void updateMovieTemplate(MediaModel paramMediaModel, String paramString, boolean paramBoolean)
  {
    ...
    clearMediaTemplateModel(paramMediaModel);
    paramMediaModel = paramMediaModel.getMediaTemplateModel();
    paramString = com.tencent.weseevideo.model.utils.FileUtils.getFilePathBySuffix(paramString, ".pag");
    if (com.tencent.weseevideo.model.utils.FileUtils.exists(paramString))
    {
