  ...
  implements ISPlayerViewBase.viewCreateCallBack
{
  ...
  public void onViewChanged(Object paramObject, int paramInt1, int paramInt2)
  {
    ...
    SPlayerLogUtil.i(SPlayerVideoView.access$000(), "blockCallback,onViewChanged, NO: " + SPlayerVideoView.access$200(this.this$0) + ", w: " + paramInt1 + ", h: " + paramInt2 + ", pw: " + this.this$0.getWidth() + ", ph: " + this.this$0.getHeight());
  ...
  {
    SPlayerLogUtil.i(SPlayerVideoView.access$000(), "blockCallback , onViewCreated, is textrueview: " + SPlayerVideoView.access$100(this.this$0) + "NO: " + SPlayerVideoView.access$200(this.this$0) + ", w: " + paramInt1 + ", h: " + paramInt2 + ", pw: " + this.this$0.getWidth() + ", ph: " + this.this$0.getHeight());
    SPlayerVideoView.access$302(this.this$0, paramObject);
  }
  
  public boolean onViewDestroyed(Object paramObject)
  {
    SPlayerLogUtil.i(SPlayerVideoView.access$000(), "blockCallback,surfaceDestroyed, NO: " + SPlayerVideoView.access$200(this.this$0));
