...
public class Utils
{
  ...
  public static String calculateFileIDForVideoInfo(SuperPlayerVideoInfo paramSuperPlayerVideoInfo)
  {
    ...
    if ((!TextUtils.isEmpty(paramSuperPlayerVideoInfo.getVid())) && (paramSuperPlayerVideoInfo.getTVideoNetInfo() != null)) {
      return paramSuperPlayerVideoInfo.getVid() + paramSuperPlayerVideoInfo.getTVideoNetInfo().getCurrentDefinition();
    }
