...
public class SPlayerManager
  implements ISuperPlayer, SPlayerManagerInternal.SPlayerManagerInternalListener, ISPlayerVideoView.IVideoViewCallBack
{
  private static final String API_CALL_LOG_PREFIX = "api call : ";
  private static final String FILENAME = "FCCPlayerManager.java";
  private static volatile int MGR_ID_BASE = 1000;
  private String TAG;
  private Context mContext;
  private HandlerThread mHandlerThread;
  private SPlayerListenerManager mLisMgr;
  private Looper mLooper;
  private int mMgrId;
  private SPlayerManager.ManagerInternalListenerAdapter mPlayerListenerAdpater;
  private SPlayerManagerCallBack mPlayerMgrCallBack;
  private SPlayerManagerInternal mPlayerMgrInternal;
  private SPlayerWrapper mPlayerWrapper;
  private String mTagPrefix;
  private ISPlayerVideoView mVideoView;
  
  public SPlayerManager(Context paramContext, int paramInt, ISPlayerVideoView paramISPlayerVideoView)
  {
    int i = MGR_ID_BASE + 1;
    MGR_ID_BASE = i;
    this.mMgrId = i;
    this.mTagPrefix = ("MediaPlayerMgr-" + this.mMgrId);
    this.TAG = (this.mTagPrefix + "_" + "FCCPlayerManager.java");
    initLooper();
    this.mContext = paramContext.getApplicationContext();
    this.mVideoView = paramISPlayerVideoView;
    this.mLisMgr = new SPlayerListenerManager(this.mTagPrefix);
    this.mPlayerMgrInternal = new SPlayerManagerInternal(this.TAG, this.mLooper, this);
    this.mPlayerMgrCallBack = new SPlayerManagerCallBack(this, this.mLisMgr, this.mLooper);
    this.mPlayerListenerAdpater = new SPlayerManager.ManagerInternalListenerAdapter(this.mPlayerMgrCallBack);
    this.mPlayerWrapper = new SPlayerWrapper(this.mContext, paramInt, this.mTagPrefix, this.mLooper);
  ...
  {
    this.mPlayerWrapper.setOnVideoPreparedListener(this.mPlayerListenerAdpater);
    this.mPlayerWrapper.setOnCompletionListener(this.mPlayerListenerAdpater);
    this.mPlayerWrapper.setOnInfoListener(this.mPlayerListenerAdpater);
    this.mPlayerWrapper.setOnErrorListener(this.mPlayerListenerAdpater);
    this.mPlayerWrapper.setOnSeekCompleteListener(this.mPlayerListenerAdpater);
    this.mPlayerWrapper.setOnVideoSizeChangedListener(this.mPlayerListenerAdpater);
    this.mPlayerWrapper.setOnVideoOutputFrameListener(this.mPlayerListenerAdpater);
    this.mPlayerWrapper.setOnAudioPcmDataListener(this.mPlayerListenerAdpater);
    this.mPlayerWrapper.setOnCaptureImageListener(this.mPlayerListenerAdpater);
  ...
  {
    this.mHandlerThread = new HandlerThread("FCCPlayerManager");
  ...
  {
    SPlayerLogUtil.i(this.TAG, "api call : getStreamDumpInfo");
  ...
  {
    SPlayerLogUtil.i(this.TAG, "handleOnVideoPrepared():");
  ...
  public void handleOpenMediaPlayerByUrl(Context paramContext, String[] paramArrayOfString, long paramLong, String paramString1, String paramString2)
  {
    this.mPlayerWrapper.openMediaPlayerByUrl(paramContext, paramArrayOfString, paramLong, paramString1, paramString2);
  }
  
  public void handlePause()
  {
    SPlayerLogUtil.i(this.TAG, "handlePause:");
    this.mPlayerWrapper.pause();
  }
  
  public void handleRelease()
  {
    SPlayerLogUtil.i(this.TAG, "handleRelease:");
  ...
  {
    SPlayerLogUtil.i(this.TAG, "handleReset:");
    this.mPlayerWrapper.reset();
  }
  
  public void handleSeekTo(int paramInt)
  {
    SPlayerLogUtil.i(this.TAG, "handleSeekTo, positionMilsec:" + paramInt);
    this.mPlayerWrapper.seekTo(paramInt);
  }
  
  public void handleSeekTo(int paramInt1, int paramInt2)
  {
    SPlayerLogUtil.i(this.TAG, "handleSeekToAccuratePos, positionMilsec:" + paramInt1 + ", mode:" + paramInt2);
    this.mPlayerWrapper.seekTo(paramInt1, paramInt2);
  }
  
  public void handleSetAudioGainRatio(float paramFloat)
  {
    SPlayerLogUtil.i(this.TAG, "handleSetAudioGainRatio, gainRatio:" + paramFloat);
  }
  
  public void handleSetLoopback(boolean paramBoolean)
  {
    SPlayerLogUtil.i(this.TAG, "handleSetLoopback, isLoopback:" + paramBoolean);
  ...
  {
    SPlayerLogUtil.i(this.TAG, "handleSetLoopback, isLoopback:" + paramBoolean + ", loopStartPositionMs:" + paramLong1 + ", loopEndPositionMs:" + paramLong2);
  ...
  {
    SPlayerLogUtil.i(this.TAG, "handleSetPlaySpeedRatio, speedRatio:" + paramFloat);
  ...
  {
    SPlayerLogUtil.i(this.TAG, "handleStart:");
    this.mPlayerWrapper.start();
  }
  
  public void handleStop()
  {
    SPlayerLogUtil.i(this.TAG, "handleStop:");
  ...
  public void handleUpdatePlayerVideoView(ISPlayerVideoView paramISPlayerVideoView)
  {
    ...
    } while (this.mPlayerWrapper == null);
  ...
  public void onSurfaceCreated(Object paramObject)
  {
    ...
    {
      this.mPlayerWrapper.updatePlayerVideoView(this.mVideoView);
      SPlayerLogUtil.i(this.TAG, "onSurfaceCreated view created. mediaPlayer.setSurface:");
      return;
    }
    SPlayerLogUtil.e(this.TAG, "onSurfaceCreated view created. mVideoView.getViewSurface() = null");
  }
  ...
  {
    this.mPlayerMgrInternal.openMediaPlayerByUrl(paramContext, paramString, paramLong, null, null);
  }
  ...
  {
    this.mPlayerMgrInternal.openMediaPlayerByUrl(paramContext, paramString1, paramLong, paramString2, paramString3);
  }
  ...
  {
    this.mPlayerMgrInternal.openMediaPlayerByUrl(paramContext, paramArrayOfString, paramLong, paramString1, paramString2);
  }
  ...
  {
    SPlayerLogUtil.i(this.TAG, "api call : seekTo, positionMilsec:" + paramInt);
  ...
  {
    SPlayerLogUtil.i(this.TAG, "api call : setOutputMute:" + paramBoolean);
    this.mPlayerMgrInternal.setOutputMute(paramBoolean);
  }
  
  public void setPlaySpeedRatio(float paramFloat)
  {
    SPlayerLogUtil.i(this.TAG, "api call : setPlaySpeedRatio");
  ...
  {
    SPlayerLogUtil.i(this.TAG, "api call : updatePlayerVideoView");
 ...
 * Qualified Name:     com.tencent.superplayer.player.SPlayerManager
