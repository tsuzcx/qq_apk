  ...
  implements Runnable
{
  ...
  {
    int i = 0;
    if (adkn.jdField_a_of_type_Int > Config.MAX_REPORT_NUM)
    {
      if (QLog.isColorLevel()) {
        QLog.i("Magnifier_ReporterMachine", 2, "[YunYingReport]:End, reported " + adkn.jdField_a_of_type_Int + " max_report_num " + Config.MAX_REPORT_NUM);
      }
      if (MagnifierSDK.jdField_a_of_type_Admj != null) {
        MagnifierSDK.jdField_a_of_type_Admj.a();
      }
      if (MagnifierSDK.jdField_a_of_type_AndroidContentSharedPreferences$Editor != null) {
        MagnifierSDK.jdField_a_of_type_AndroidContentSharedPreferences$Editor.putInt("count_today_reported", adkn.jdField_a_of_type_Int).apply();
      }
    }
    int j;
    do
    {
      return;
      if ((MagnifierSDK.jdField_a_of_type_Admj == null) || (1 != bevn.a().a()))
      {
        if (QLog.isColorLevel()) {
      ...
      catch (Exception localException1)
      {
        ...
        MagnifierSDK.jdField_a_of_type_Admj.a("result_objects", true);
        ...
        ReporterMachine.a().postDelayed(this, 1800000L);
        j = adkn.jdField_a_of_type_AndroidUtilSparseArray.size();
      }
    } while (MagnifierSDK.jdField_a_of_type_AndroidContentSharedPreferences$Editor == null);
    Object localObject1;
    if (i < j)
    {
      int k = adkn.jdField_a_of_type_AndroidUtilSparseArray.keyAt(i);
      if (k > 100)
      {
        localObject1 = (adko)adkn.jdField_a_of_type_AndroidUtilSparseArray.get(k);
      ...
      for (;;)
      {
        ...
        break;
        label372:
        MagnifierSDK.jdField_a_of_type_AndroidContentSharedPreferences$Editor.putInt("count_plugin_" + String.valueOf(k), ((adko)localObject1).jdField_a_of_type_Int);
      }
    }
    if (QLog.isColorLevel()) {
    ...
    return;
    this.jdField_a_of_type_JavaUtilList = MagnifierSDK.jdField_a_of_type_Admj.a(true);
