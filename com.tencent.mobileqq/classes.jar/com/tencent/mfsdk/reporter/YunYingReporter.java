  ...
  implements IReporter
{
  ...
  public YunYingReporter(HandlerThread paramHandlerThread)
  {
  ...
  public boolean a(ResultObject paramResultObject, IReporter.ReportResultCallback paramReportResultCallback)
  {
    ...
    if (localJSONObject != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        localObject3 = new YunYingFileUploadRunnable((URL)localObject2, (String)localObject3, paramReportResultCallback, paramResultObject.dbId, this.a);
    ...
    paramResultObject = new JsonUploadRunnable(new URL("http://zhizi.qq.com/json.php"), localJSONObject, paramReportResultCallback, paramResultObject.dbId, this.a);
