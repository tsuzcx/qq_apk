  ...
  extends AbsListRender<FilterModel, RenderData>
{
  ...
  public int a(@NotNull RenderData paramRenderData)
  {
    ...
    localStringBuilder.append("add lut ");
    localStringBuilder.append(paramRenderData.getId());
    localLogger.b("LutFilterModelRender", localStringBuilder.toString());
  ...
  public RenderData a(@NotNull FilterModel paramFilterModel)
  {
    ...
    paramFilterModel = FilterModelExtKt.a(paramFilterModel, false);
    if (paramFilterModel == null) {
      Intrinsics.throwNpe();
    }
    return paramFilterModel;
  }
  ...
  public List<FilterModel> a(@NotNull MediaModel paramMediaModel)
  {
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      int i;
      if (((FilterModel)localObject2).lut != null) {
        i = 1;
      } else {
        i = 0;
      }
  ...
  public void a(int paramInt, @Nullable RenderData paramRenderData1, @NotNull RenderData paramRenderData2)
  {
    ...
    ((StringBuilder)localObject).append("update lut ");
    ((StringBuilder)localObject).append(paramInt);
    paramRenderData1.b("LutFilterModelRender", ((StringBuilder)localObject).toString());
    localObject = this.b;
    paramRenderData1 = paramRenderData2.b().key;
    if (paramRenderData1 == null) {
      paramRenderData1 = "";
    }
    paramRenderData1 = ((ICutSession)localObject).a(paramRenderData1);
 ...
 * Qualified Name:     com.tencent.videocut.render.LutFilterModelRender
