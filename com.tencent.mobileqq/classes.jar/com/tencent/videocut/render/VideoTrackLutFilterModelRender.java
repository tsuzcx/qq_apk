...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/videocut/render/VideoTrackLutFilterModelRender;", "Lcom/tencent/videocut/render/AbsLutFilterModelRender;", "tavCutSession", "Lcom/tencent/tavcut/session/ICutSession;", "(Lcom/tencent/tavcut/session/ICutSession;)V", "mediaModel", "Lcom/tencent/videocut/model/MediaModel;", "addEntity", "", "data", "Lcom/tencent/videocut/render/RenderData;", "removeEntity", "", "entityId", "selector", "", "Lcom/tencent/videocut/render/FilterRenderData;", "model", "updateEntity", "originalEntityId", "oldData", "newData", "Companion", "qq-wink-impl_release"}, k=1, mv={1, 1, 16})
public final class VideoTrackLutFilterModelRender
  extends AbsLutFilterModelRender
{
  public static final VideoTrackLutFilterModelRender.Companion a = new VideoTrackLutFilterModelRender.Companion(null);
  private MediaModel b;
  
  public VideoTrackLutFilterModelRender(@NotNull ICutSession paramICutSession)
  {
  ...
  public int a(@NotNull RenderData paramRenderData)
  {
    ...
    ((StringBuilder)localObject2).append("add lut id=");
    ((StringBuilder)localObject2).append(paramRenderData.getId());
    ((StringBuilder)localObject2).append(" index=");
    ((StringBuilder)localObject2).append(i);
    ((Logger)localObject1).b("VideoTrackLutFilterModelRender", ((StringBuilder)localObject2).toString());
  ...
  public List<FilterRenderData> a(@NotNull MediaModel paramMediaModel)
  {
    ...
    while (paramMediaModel.hasNext())
    {
      ...
      if ((localObject != null) && (((FilterModel)localObject).lut != null)) {
  ...
  public void a(int paramInt)
  {
    ...
    localStringBuilder.append("remove lut ");
    localStringBuilder.append(paramInt);
    localLogger.b("VideoTrackLutFilterModelRender", localStringBuilder.toString());
    super.a(paramInt);
  }
  ...
  public void a(int paramInt, @Nullable RenderData paramRenderData1, @NotNull RenderData paramRenderData2)
  {
    ...
    Logger localLogger = Logger.a;
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append("update lut ");
    localStringBuilder.append(paramInt);
    localLogger.b("VideoTrackLutFilterModelRender", localStringBuilder.toString());
 ...
 * Qualified Name:     com.tencent.videocut.render.VideoTrackLutFilterModelRender
