...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"<anonymous>", "", "it", "Ljava/lang/reflect/Field;", "invoke"}, k=3, mv={1, 4, 2})
  ...
  implements Function1<Field, Unit>
{
  ...
  {
    Intrinsics.checkNotNullParameter(paramField, "it");
 ...
 * Qualified Name:     com.tencent.videocut.utils.ReflectUtilsKt.getFieldData.2
