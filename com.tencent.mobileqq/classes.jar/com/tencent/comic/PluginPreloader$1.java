  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    int n = (int)(DeviceInfoUtil.e() >> 20);
    Object localObject2 = this.jdField_a_of_type_ComTencentComicPluginPreloadStrategy.a.jdField_c_of_type_JavaLangString;
    int i1 = this.jdField_a_of_type_ComTencentComicPluginPreloadStrategy.a.jdField_b_of_type_Int;
    int i = this.jdField_a_of_type_ComTencentComicPluginPreloadStrategy.a.jdField_c_of_type_Int;
    int j = this.jdField_a_of_type_ComTencentComicPluginPreloadStrategy.a.d;
    int i2 = this.jdField_a_of_type_ComTencentComicPluginPreloadStrategy.a.jdField_a_of_type_Int;
    try
    {
      ...
      if (localObject3 != null)
      {
        ...
        for (;;)
        {
          if (((Iterator)localObject3).hasNext())
          {
            ...
            if (this.jdField_a_of_type_JavaLangString.equals(localRunningAppProcessInfo.processName))
            {
              if ((this.jdField_a_of_type_ComTencentComicPluginPreloadStrategy.a.jdField_b_of_type_Boolean) && (!TextUtils.isEmpty((CharSequence)localObject2)) && (!QIPCServerHelper.getInstance().isModuleRunning((String)localObject2)))
              {
                if (QLog.isColorLevel())
                {
                ...
                ((IQQComicPluginUtil.ExtraResult)localObject1).jdField_a_of_type_Int = 1;
                ((IQQComicPluginUtil.ExtraResult)localObject1).jdField_a_of_type_JavaLangString = "preload:ok:loadmodule";
                PluginPreloader.a(localAppRuntime, this.jdField_a_of_type_ComTencentComicPluginPreloadStrategy, n, (IQQComicPluginUtil.ExtraResult)localObject1);
                return;
              }
              if (QLog.isColorLevel())
              {
      ...
      int k = j;
      int m = i;
      if (!this.jdField_a_of_type_ComTencentComicPluginPreloadStrategy.a((IQQComicPluginUtil.ExtraResult)localObject1))
      {
        if (QLog.isColorLevel())
        {
        ...
        PluginPreloadReportUtils.a(localAppRuntime, 1, i1, m, ((IQQComicPluginUtil.ExtraResult)localObject1).jdField_a_of_type_Int, ((IQQComicPluginUtil.ExtraResult)localObject1).jdField_a_of_type_JavaLangString, n, new String[] { String.valueOf(k) });
        return;
      }
      if (n < i2)
      {
      ...
      if (!this.jdField_a_of_type_ComTencentComicPluginPreloadStrategy.b((IQQComicPluginUtil.ExtraResult)localObject1))
      {
        if (QLog.isColorLevel()) {
          QLog.d("PluginPreloader", 2, "the plugin is inactive.");
        }
        i2 = ((IQQComicPluginUtil.ExtraResult)localObject1).jdField_a_of_type_Int;
        localObject1 = ((IQQComicPluginUtil.ExtraResult)localObject1).jdField_a_of_type_JavaLangString;
      }
      try
      {
