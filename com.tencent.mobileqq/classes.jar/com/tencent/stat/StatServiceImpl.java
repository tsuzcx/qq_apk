...
public class StatServiceImpl
{
  ...
  static void a(Context paramContext, StatSpecifyReportedInfo paramStatSpecifyReportedInfo)
  {
    if (c(paramContext) != null)
    {
      ...
      StatConfig.a(0);
      StatConfig.b();
      new ab(new com.tencent.stat.event.g(paramContext, l, b(), paramStatSpecifyReportedInfo)).a();
    }
  }
  ...
  private static void b(Context paramContext, StatAccount paramStatAccount, StatSpecifyReportedInfo paramStatSpecifyReportedInfo)
  {
    try
    {
      new ab(new com.tencent.stat.event.a(paramContext, a(paramContext, false, paramStatSpecifyReportedInfo), paramStatAccount, paramStatSpecifyReportedInfo)).a();
      return;
    }
  ...
  {
    // Byte code:
    //   0: getstatic 231	com/tencent/stat/StatServiceImpl:d	Landroid/os/Handler;
    //   3: ifnonnull +21 -> 24
    //   6: ldc 2
    //   8: monitorenter
    //   9: getstatic 231	com/tencent/stat/StatServiceImpl:d	Landroid/os/Handler;
    //   12: astore_1
    //   13: aload_1
    //   14: ifnonnull +7 -> 21
    //   17: aload_0
    //   18: invokestatic 389	com/tencent/stat/StatServiceImpl:a	(Landroid/content/Context;)V
    //   21: ldc 2
    //   23: monitorexit
    //   24: getstatic 231	com/tencent/stat/StatServiceImpl:d	Landroid/os/Handler;
    //   27: areturn
    //   28: astore_0
    //   29: getstatic 93	com/tencent/stat/StatServiceImpl:q	Lcom/tencent/stat/common/StatLogger;
    //   32: aload_0
    //   33: invokevirtual 391	com/tencent/stat/common/StatLogger:error	(Ljava/lang/Throwable;)V
    //   36: iconst_0
    //   37: invokestatic 387	com/tencent/stat/StatConfig:setEnableStatService	(Z)V
    //   40: goto -19 -> 21
    //   43: astore_0
    //   44: ldc 2
    //   46: monitorexit
  ...
  static void e(Context paramContext)
  {
    ...
    try
    {
      com.tencent.stat.event.e locale = new com.tencent.stat.event.e(paramContext);
 ...
 * Qualified Name:     com.tencent.stat.StatServiceImpl
