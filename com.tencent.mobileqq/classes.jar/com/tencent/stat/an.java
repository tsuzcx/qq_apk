  ...
  extends SQLiteOpenHelper
{
  ...
  private void a(SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    //   21: dup
    //   22: invokespecial 74	android/content/ContentValues:<init>	()V
    //   25: astore 5
    //   27: aload_3
    //   28: astore_2
    //   29: aload_3
    //   30: invokeinterface 79 1 0
    //   35: ifeq +58 -> 93
    //   38: aload_3
    //   39: astore_2
    //   40: aload_3
    ...
    //   83: ldc 93
    //   85: aload 4
    //   87: invokestatic 99	com/tencent/stat/common/Util:encode	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   130: return
    //   131: astore_1
    //   132: invokestatic 37	com/tencent/stat/af:e	()Lcom/tencent/stat/common/StatLogger;
    //   135: aload_1
    //   136: invokevirtual 117	com/tencent/stat/common/StatLogger:e	(Ljava/lang/Throwable;)V
    //   139: return
    //   140: astore_1
    //   141: aconst_null
    //   142: astore_3
    //   143: aload_3
    //   144: astore_2
    //   145: invokestatic 37	com/tencent/stat/af:e	()Lcom/tencent/stat/common/StatLogger;
    //   148: aload_1
    //   149: invokevirtual 117	com/tencent/stat/common/StatLogger:e	(Ljava/lang/Throwable;)V
    //   152: aload_3
    //   153: ifnull -23 -> 130
    //   156: aload_3
    ...
    //   162: return
    //   163: astore_1
    //   164: invokestatic 37	com/tencent/stat/af:e	()Lcom/tencent/stat/common/StatLogger;
    //   167: aload_1
    //   168: invokevirtual 117	com/tencent/stat/common/StatLogger:e	(Ljava/lang/Throwable;)V
    //   171: return
    //   172: astore_1
    //   173: aconst_null
    //   174: astore_2
    ...
    //   176: ifnull +9 -> 185
    //   179: aload_2
    //   180: invokeinterface 114 1 0
    //   185: aload_1
    //   186: athrow
    //   187: astore_2
    //   188: invokestatic 37	com/tencent/stat/af:e	()Lcom/tencent/stat/common/StatLogger;
    //   191: aload_2
    //   192: invokevirtual 117	com/tencent/stat/common/StatLogger:e	(Ljava/lang/Throwable;)V
    //   195: goto -10 -> 185
    //   198: astore_1
    //   199: goto -24 -> 175
    //   202: astore_1
  ...
  private void b(SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    //   28: ifeq +72 -> 100
    //   31: aload 4
    //   33: new 124	com/tencent/stat/ao
    //   36: dup
    //   37: aload_2
    //   38: iconst_0
    ...
    //   65: invokespecial 127	com/tencent/stat/ao:<init>	(JLjava/lang/String;II)V
    ...
    //   80: aload_3
    //   81: astore_2
    //   82: invokestatic 37	com/tencent/stat/af:e	()Lcom/tencent/stat/common/StatLogger;
    //   85: aload_2
    //   86: invokevirtual 117	com/tencent/stat/common/StatLogger:e	(Ljava/lang/Throwable;)V
    //   89: aload_1
    //   90: ifnull +9 -> 99
    //   93: aload_1
    ...
    //   103: dup
    //   104: invokespecial 74	android/content/ContentValues:<init>	()V
    //   107: astore_3
    //   108: aload 4
    ...
    //   134: checkcast 124	com/tencent/stat/ao
    //   137: astore 5
    //   139: aload_3
    //   140: ldc 148
    //   142: aload 5
    //   144: getfield 150	com/tencent/stat/ao:b	Ljava/lang/String;
    //   147: invokestatic 99	com/tencent/stat/common/Util:encode	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   164: iconst_0
    //   165: aload 5
    //   167: getfield 155	com/tencent/stat/ao:a	J
    ...
    //   204: return
    //   205: astore_1
    //   206: invokestatic 37	com/tencent/stat/af:e	()Lcom/tencent/stat/common/StatLogger;
    //   209: aload_1
    //   210: invokevirtual 117	com/tencent/stat/common/StatLogger:e	(Ljava/lang/Throwable;)V
    //   213: return
    //   214: astore_1
    //   215: invokestatic 37	com/tencent/stat/af:e	()Lcom/tencent/stat/common/StatLogger;
    //   218: aload_1
    //   219: invokevirtual 117	com/tencent/stat/common/StatLogger:e	(Ljava/lang/Throwable;)V
    //   222: return
    //   223: astore_2
    //   224: invokestatic 37	com/tencent/stat/af:e	()Lcom/tencent/stat/common/StatLogger;
    //   227: aload_2
    //   228: invokevirtual 117	com/tencent/stat/common/StatLogger:e	(Ljava/lang/Throwable;)V
    //   231: goto -39 -> 192
    //   234: astore_1
    //   235: aconst_null
    //   236: astore_2
 ...
 * Qualified Name:     com.tencent.stat.an
