...
public class GAClientLogReportJni
{
  ...
  public GAClientLogReportJni(IClientLogReport paramIClientLogReport)
  {
    ...
    //   4: aload_0
    //   5: aload_1
    //   6: putfield 21	com/tencent/avcore/jni/log/GAClientLogReportJni:mImpl	Lcom/tencent/avcore/jni/log/IClientLogReport;
    //   9: invokestatic 24	com/tencent/avcore/jni/log/GAClientLogReportJni:cacheMethodIds	()V
    //   12: goto +12 -> 24
    //   15: astore_1
    //   16: ldc 8
    //   18: ldc 26
    ...
    //   25: istore_2
    //   26: aload_0
    //   27: invokespecial 35	com/tencent/avcore/jni/log/GAClientLogReportJni:init	()V
    //   30: iconst_1
    //   31: istore_2
    //   32: aload_0
    //   33: iload_2
    //   34: putfield 37	com/tencent/avcore/jni/log/GAClientLogReportJni:mNativeInit	Z
    //   37: return
    //   38: astore_1
    //   39: goto +15 -> 54
    //   42: astore_1
    ...
    //   54: aload_0
    //   55: iconst_0
    //   56: putfield 37	com/tencent/avcore/jni/log/GAClientLogReportJni:mNativeInit	Z
    //   59: goto +5 -> 64
    //   62: aload_1
    //   63: athrow
    //   64: goto -2 -> 62
    ...
    //   0	67	0	this	GAClientLogReportJni
  ...
  private int callbackSendLog(long paramLong, String paramString, byte[] paramArrayOfByte)
  {
    if (AVCoreLog.isColorLevel())
    {
      ...
      AVCoreLog.i("GAClientLogReport", localStringBuilder.toString());
    }
    int i = 0;
