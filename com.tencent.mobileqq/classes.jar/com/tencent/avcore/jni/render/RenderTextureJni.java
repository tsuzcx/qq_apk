  ...
  implements Handler.Callback
{
  ...
  private void notifyUpdateUI(int paramInt1, int paramInt2, Object paramObject)
  {
    if (this.mTexture != null) {
      this.mTexture.markForPerf(paramInt1);
    }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (this.mTexture != null) {
      this.mTexture.nativeFrameDataUpdate();
    }
    switch (i)
    {
    }
    for (;;)
    {
      ...
      if (this.mTexture != null)
      {
        this.mTexture.onRenderFrame();
        continue;
        if (this.mTexture != null)
        {
          this.mTexture.onRenderReset();
          continue;
          if (this.mTexture != null)
          {
            this.mTexture.onRenderFlush();
            continue;
            if (this.mTexture != null)
            {
