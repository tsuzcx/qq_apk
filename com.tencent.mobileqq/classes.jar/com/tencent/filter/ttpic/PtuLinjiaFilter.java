  ...
  extends BaseFilter
{
  ...
  public void applyFilterChain(boolean paramBoolean, float paramFloat1, float paramFloat2)
  {
    ...
    localBaseFilter2.addParam(new TextureResParam("inputImageTexture2", "sh/linjia_curve.png", 33986));
    setNextFilter(localBaseFilter2, null);
    BaseFilter localBaseFilter1 = new BaseFilter(BaseFilter.getFragmentShader(57));
    localBaseFilter1.addParam(new UniformParam.FloatsParam("shadowsShift", new float[] { 0.0F, -0.02745098F, 0.05098039F }));
    localBaseFilter1.addParam(new UniformParam.FloatsParam("midtonesShift", new float[] { 0.0F, -0.04313726F, 0.0F }));
    ...
    localBaseFilter2.addParam(new UniformParam.FloatsParam("color2", new float[] { 0.9921569F, 0.8470588F, 0.6392157F, 1.0F }));
    localBaseFilter2.addParam(new UniformParam.FloatParam("transparency", 0.4F));
