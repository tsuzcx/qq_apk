  ...
  extends BaseFilter
{
  ...
  public void ApplyGLSLFilter(boolean paramBoolean, float paramFloat1, float paramFloat2)
  {
    ...
    localBaseFilter1.addParam(new Param.FloatsParam("shadowsShift", new float[] { -0.2235294F, 0.03921569F, 0.08627451F }));
    localBaseFilter1.addParam(new Param.FloatsParam("midtonesShift", new float[] { -0.1490196F, 0.0F, 0.08627451F }));
    localBaseFilter1.addParam(new Param.FloatsParam("highlightsShift", new float[] { -0.01960784F, 0.01960784F, 0.0588235F }));
    ...
    localBaseFilter2.addParam(new Param.FloatsParam("color2", new float[] { 0.0666667F, 0.6F, 0.8745098F, 1.0F }));
