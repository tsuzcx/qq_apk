  ...
  extends BaseFilter
{
  ...
  public void ApplyGLSLFilter(boolean paramBoolean, float paramFloat1, float paramFloat2)
  {
    ...
    localBaseFilter1.addParam(new Param.FloatsParam("shadowsShift", new float[] { 0.01176471F, 0.0F, 0.0F }));
    localBaseFilter1.addParam(new Param.FloatsParam("midtonesShift", new float[] { 0.03921569F, 0.0F, -0.03921569F }));
    ...
    localBaseFilter1.addParam(new Param.TextureResParam("inputImageTexture2", "sh/meishi_curve.png", 33986));
    localBaseFilter2.setNextFilter(localBaseFilter1, null);
