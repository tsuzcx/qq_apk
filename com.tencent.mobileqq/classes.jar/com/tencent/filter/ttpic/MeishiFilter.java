  ...
  extends BaseFilter
{
  ...
  public void applyFilterChain(boolean paramBoolean, float paramFloat1, float paramFloat2)
  {
    ...
    localBaseFilter1.addParam(new UniformParam.FloatsParam("shadowsShift", new float[] { 0.01176471F, 0.0F, 0.0F }));
    localBaseFilter1.addParam(new UniformParam.FloatsParam("midtonesShift", new float[] { 0.03921569F, 0.0F, -0.03921569F }));
    ...
    localBaseFilter1.addParam(new TextureResParam("inputImageTexture2", "sh/meishi_curve.png", 33986));
    localBaseFilter2.setNextFilter(localBaseFilter1, null);
 ...
 * Qualified Name:     com.tencent.filter.ttpic.MeishiFilter
