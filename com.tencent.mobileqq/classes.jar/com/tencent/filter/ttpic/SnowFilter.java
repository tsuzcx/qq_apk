  ...
  extends BaseFilter
{
  ...
  public void applyFilterChain(boolean paramBoolean, float paramFloat1, float paramFloat2)
  {
    ...
    localBaseFilter2.addParam(new TextureResParam("inputImageTexture2", "sh/snow_curve.png", 33986));
    setNextFilter(localBaseFilter2, null);
    BaseFilter localBaseFilter1 = new BaseFilter(BaseFilter.getFragmentShader(57));
    localBaseFilter1.addParam(new UniformParam.FloatsParam("shadowsShift", new float[] { -0.09411765F, 0.0F, 0.0F }));
    localBaseFilter1.addParam(new UniformParam.FloatsParam("midtonesShift", new float[] { -0.09803922F, 0.0F, 0.0F }));
    localBaseFilter1.addParam(new UniformParam.FloatsParam("highlightsShift", new float[] { -0.0588235F, 0.0F, 0.0F }));
    localBaseFilter1.addParam(new UniformParam.IntParam("preserveLuminosity", 1));
    localBaseFilter2.setNextFilter(localBaseFilter1, null);
    localBaseFilter2 = new BaseFilter(BaseFilter.getFragmentShader(55));
    localBaseFilter2.addParam(new UniformParam.FloatParam("scaleC", -0.354F));
    ...
    localBaseFilter1.addParam(new UniformParam.FloatParam("inputV", 1.05F));
    localBaseFilter2.setNextFilter(localBaseFilter1, null);
    localBaseFilter2 = new BaseFilter("precision highp float;\n varying vec2 textureCoordinate;\n uniform sampler2D inputImageTexture;\n uniform sampler2D inputImageTexture2;\n uniform float param;\n void main(void)\n {\n     vec4 color  = texture2D(inputImageTexture, textureCoordinate);\n     vec4 color2 = texture2D(inputImageTexture2, textureCoordinate);\n     vec3 ret=color.rgb+color2.rgb*param;\n     gl_FragColor = vec4(ret.rgb,1.0);\n }\n");
    localBaseFilter2.addParam(new TextureResParam("inputImageTexture2", "sh/snow.png", 33986, paramFloat1 / paramFloat2));
    localBaseFilter2.addParam(new UniformParam.FloatParam("param", 0.35F));
    localBaseFilter1.setNextFilter(localBaseFilter2, null);
