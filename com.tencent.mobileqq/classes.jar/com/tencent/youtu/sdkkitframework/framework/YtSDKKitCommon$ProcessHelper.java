...
public class YtSDKKitCommon$ProcessHelper
{
  public static float[] calcEyeScore(float[] paramArrayOfFloat)
  {
    ...
    float f4 = paramArrayOfFloat[44];
    float f5 = paramArrayOfFloat[40];
    float f6 = paramArrayOfFloat[45];
    float f7 = paramArrayOfFloat[41];
    float f8 = paramArrayOfFloat[36];
    float f9 = paramArrayOfFloat[40];
    float f10 = paramArrayOfFloat[37];
    float f11 = paramArrayOfFloat[41];
    f1 = (Math.abs(crossProduct(f1, f2, f4 - f5, f6 - f7)) + Math.abs(crossProduct(f1, f2, f8 - f9, f10 - f11))) / (f3 * f3);
    f2 = paramArrayOfFloat[56] - paramArrayOfFloat[48];
    f3 = paramArrayOfFloat[57] - paramArrayOfFloat[49];
    f4 = (float)Math.sqrt(f2 * f2 + f3 * f3);
    f5 = paramArrayOfFloat[60];
    f6 = paramArrayOfFloat[48];
    f7 = paramArrayOfFloat[61];
    f8 = paramArrayOfFloat[49];
    f9 = paramArrayOfFloat[52];
    f10 = paramArrayOfFloat[48];
    f11 = paramArrayOfFloat[53];
    float f12 = paramArrayOfFloat[49];
    return new float[] { f1, (Math.abs(crossProduct(f2, f3, f5 - f6, f7 - f8)) + Math.abs(crossProduct(f2, f3, f9 - f10, f11 - f12))) / (f4 * f4) };
  }
  ...
  public static float[] convert90PTo5P(float[] paramArrayOfFloat)
  {
    ...
    localStringBuilder.append("90 to 5 convert size:");
    localStringBuilder.append(paramArrayOfFloat.length);
    YtLogger.d("ProcessHelper", localStringBuilder.toString());
  ...
  public static float preCheckCloseEyeScore(float[] paramArrayOfFloat)
  {
    ...
    f11 = paramArrayOfFloat[53];
    float f12 = paramArrayOfFloat[49];
    f2 = (Math.abs(crossProduct(f2, f3, f5 - f6, f7 - f8)) + Math.abs(crossProduct(f2, f3, f9 - f10, f11 - f12))) / (f4 * f4);
    if (f1 > f2) {
      return f2;
    }
    return f1;
