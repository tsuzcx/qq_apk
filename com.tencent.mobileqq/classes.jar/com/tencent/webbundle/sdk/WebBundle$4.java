  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (WebBundle.access$200(this.this$0) == WebBundle.WebBundlePreloadState.SUCCESS)
    {
      ...
      WebBundle localWebBundle = this.this$0;
      localWebBundle.resetContext(WebBundle.access$500(localWebBundle).getApplicationContext());
      return;
    }
    if (WebBundle.access$200(this.this$0) == WebBundle.WebBundlePreloadState.FAILED) {
      this.this$0.destroy();
    }
  }
}
