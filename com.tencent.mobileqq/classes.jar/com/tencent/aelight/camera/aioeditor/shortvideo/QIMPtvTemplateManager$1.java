  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    //   4: getfield 30	com/tencent/aelight/camera/aioeditor/shortvideo/QIMPtvTemplateManager:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   131: aload_1
    //   132: invokestatic 78	com/tencent/aelight/camera/aioeditor/shortvideo/QIMPtvTemplateManager:a	(Lcom/tencent/aelight/camera/aioeditor/shortvideo/QIMPtvTemplateManager;Ljava/lang/String;)Ljava/util/List;
    //   135: astore_1
    //   136: aload_1
    //   137: ifnull +233 -> 370
    //   140: aload_1
    //   141: invokeinterface 36 1 0
    //   146: ifeq +4 -> 150
    //   149: return
    //   150: aload_1
    //   151: invokeinterface 82 1 0
    //   156: astore_2
    //   157: aload_2
    ...
    //   172: checkcast 93	com/tencent/aelight/camera/aioeditor/capture/data/TemplateGroupItem
    //   175: getfield 94	com/tencent/aelight/camera/aioeditor/capture/data/TemplateGroupItem:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   178: invokeinterface 82 1 0
    //   183: astore_3
    //   184: aload_3
    //   185: invokeinterface 87 1 0
    //   190: ifeq -33 -> 157
    //   193: aload_3
    //   194: invokeinterface 91 1 0
    //   199: checkcast 96	com/tencent/aelight/camera/struct/editor/PtvTemplateInfo
    //   202: astore 4
    //   204: aload 4
    //   206: ifnull -22 -> 184
    //   209: aload 4
    ...
    //   215: aload 4
    //   217: invokevirtual 99	com/tencent/aelight/camera/aioeditor/shortvideo/QIMPtvTemplateManager:a	(Lcom/tencent/aelight/camera/struct/editor/PtvTemplateInfo;)Z
    //   220: putfield 102	com/tencent/aelight/camera/struct/editor/PtvTemplateInfo:b	Z
    //   223: aload 4
    //   225: getfield 102	com/tencent/aelight/camera/struct/editor/PtvTemplateInfo:b	Z
    //   228: ifne -44 -> 184
    //   231: invokestatic 69	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   234: ifeq -50 -> 184
    ...
    //   254: aload 5
    //   256: aload 4
    //   258: getfield 114	com/tencent/aelight/camera/struct/editor/PtvTemplateInfo:a	Ljava/lang/String;
    ...
    //   273: aload 5
    //   275: aload 4
    //   277: getfield 119	com/tencent/aelight/camera/struct/editor/PtvTemplateInfo:d	Ljava/lang/String;
    ...
    //   292: invokestatic 129	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   295: goto -111 -> 184
    //   298: aload_0
    ...
    //   302: getfield 132	com/tencent/aelight/camera/aioeditor/shortvideo/QIMPtvTemplateManager:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   305: astore_2
    //   306: aload_2
    //   307: monitorenter
    //   308: aload_0
    ...
    //   312: getfield 30	com/tencent/aelight/camera/aioeditor/shortvideo/QIMPtvTemplateManager:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   315: invokeinterface 36 1 0
    //   320: ifeq +17 -> 337
    //   323: aload_0
    ...
    //   327: getfield 30	com/tencent/aelight/camera/aioeditor/shortvideo/QIMPtvTemplateManager:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   330: aload_1
    //   331: invokeinterface 136 2 0
    //   336: pop
    //   337: aload_0
    ...
    //   341: invokevirtual 139	com/tencent/aelight/camera/aioeditor/shortvideo/QIMPtvTemplateManager:a	()Lcom/tencent/common/app/AppInterface;
    //   344: ifnull +18 -> 362
    //   347: aload_0
    ...
    //   351: invokevirtual 139	com/tencent/aelight/camera/aioeditor/shortvideo/QIMPtvTemplateManager:a	()Lcom/tencent/common/app/AppInterface;
    //   354: ldc 141
    //   356: iconst_3
    //   357: iconst_1
    //   358: aconst_null
    //   359: invokevirtual 147	com/tencent/common/app/AppInterface:notifyObservers	(Ljava/lang/Class;IZLandroid/os/Bundle;)V
    //   362: aload_2
    //   363: monitorexit
    //   364: return
    //   365: astore_1
    ...
    //   377: ifnull +21 -> 398
    //   380: aload_3
    //   381: invokevirtual 64	java/io/InputStream:close	()V
    //   384: goto +14 -> 398
    //   387: astore_2
    //   388: invokestatic 69	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   391: ifeq +7 -> 398
    //   394: aload_2
    //   395: invokevirtual 72	java/lang/Exception:printStackTrace	()V
    //   398: goto +5 -> 403
    //   401: aload_1
    //   402: athrow
    //   403: goto -2 -> 401
