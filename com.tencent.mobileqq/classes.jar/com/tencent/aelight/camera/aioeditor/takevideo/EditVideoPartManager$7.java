  ...
  implements ProgressPieDrawable.OnProgressListener
{
  ...
  public void onProgressCompleted(ProgressPieDrawable paramProgressPieDrawable)
  {
    if (QLog.isColorLevel())
    {
      ...
      QLog.i("Q.qqstory.publish.edit.EditVideoPartManager", 2, localStringBuilder.toString());
    }
  }
}
 ...
 * Qualified Name:     com.tencent.aelight.camera.aioeditor.takevideo.EditVideoPartManager.7
