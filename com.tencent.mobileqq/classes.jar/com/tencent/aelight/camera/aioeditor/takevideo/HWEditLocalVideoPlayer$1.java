  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (((ArrayList)localObject1).size() <= 0) {
      ((ArrayList)localObject1).add(new VideoUtils.VideoKeyFrameFragment(0L, this.this$0.b.mDuration));
    }
    ...
    while (i < ((ArrayList)localObject1).size())
    {
      ...
      long l2 = Math.min(localVideoKeyFrameFragment.a + localVideoKeyFrameFragment.b, this.this$0.b.mDuration);
      ...
      try
      {
        ...
        this.this$0.c.add(localObject2);
    ...
    SLog.b("Q.qqstory.record.HWEditLocalVideoPlayer", "create fragment info count = %d, cost = %dms", Integer.valueOf(this.this$0.c.size()), Long.valueOf(SystemClock.uptimeMillis() - l3));
    i = 0;
    while (i < this.this$0.c.size())
    {
      localObject1 = (HWEditLocalVideoPlayer.Mp4VideoFragmentInfo)this.this$0.c.get(i);
      String str = FileUtils.f(HWEditLocalVideoPlayer.a(this.this$0));
      ...
      {
        SLog.e("Q.qqstory.record.HWEditLocalVideoPlayer", "clipAudioFile failed. errcode =%s,  audioFilePath=%s, duration=%s, startTime=%s, endTime=%s", new Object[] { Integer.valueOf(j), str, Long.valueOf(this.this$0.b.mDuration), Long.valueOf(HWEditLocalVideoPlayer.Mp4VideoFragmentInfo.a((HWEditLocalVideoPlayer.Mp4VideoFragmentInfo)localObject1)), Long.valueOf(HWEditLocalVideoPlayer.Mp4VideoFragmentInfo.b((HWEditLocalVideoPlayer.Mp4VideoFragmentInfo)localObject1)) });
      }
      i += 1;
    }
