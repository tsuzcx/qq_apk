  ...
  implements INetEngineListener
{
  ...
  public void onResp(NetResp arg1)
  {
    ...
    if (QLog.isColorLevel())
    {
      ...
      ((StringBuilder)localObject2).append(localDynamicTextFontInfo.jdField_a_of_type_JavaLangString);
    ...
    {
      localObject2 = (ArrayList)DynamicTextConfigManager.DynamicTextResDownloader.a(this.a).remove(localDynamicTextFontInfo.jdField_a_of_type_JavaLangString);
  ...
  public void onUpdateProgeress(NetReq paramNetReq, long paramLong1, long paramLong2)
  {
    ...
    synchronized (DynamicTextConfigManager.DynamicTextResDownloader.a(this.a))
    {
      Iterator localIterator = ((ArrayList)DynamicTextConfigManager.DynamicTextResDownloader.a(this.a).get(paramNetReq.jdField_a_of_type_JavaLangString)).iterator();
      while (localIterator.hasNext())
      {
        WeakReference localWeakReference = (WeakReference)localIterator.next();
        if (localWeakReference.get() != null) {
          ((DynamicTextConfigManager.IDynamicTextResDownloadCallback)localWeakReference.get()).a((float)(100L * paramLong1 / paramLong2), paramNetReq.jdField_a_of_type_JavaLangString, paramNetReq.jdField_a_of_type_Int);
        }
      }
      ...
      if (QLog.isColorLevel())
      {
        ...
        ((StringBuilder)???).append(paramNetReq.jdField_a_of_type_JavaLangString);
