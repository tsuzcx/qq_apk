  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    Object localObject = this.this$0.jdField_a_of_type_ComTencentAelightCameraAioeditorCaptureAdapterMusicProviderPagerAdapter.b(i);
    if (localObject != null)
    {
      ((GridView)localObject).setSelection(this.a);
      localObject = this.this$0;
      ((MusicProviderView)localObject).c = i;
      ((MusicProviderView)localObject).d = this.a;
