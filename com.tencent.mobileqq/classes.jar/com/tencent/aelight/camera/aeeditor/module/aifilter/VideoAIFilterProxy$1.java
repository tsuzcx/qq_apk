...
class VideoAIFilterProxy$1
  implements Runnable
{
  VideoAIFilterProxy$1(VideoAIFilterProxy paramVideoAIFilterProxy, List paramList, Context paramContext, AIFilterProxyBase.AIFilterProxyCallback paramAIFilterProxyCallback) {}
  
  public void run()
  {
    if (this.this$0.jdField_a_of_type_ComTencentTavcutSessionTAVCutVideoSession != null)
    {
      AEQLog.a(VideoAIFilterProxy.b(), "getVideoFrame start");
      ...
      AEQLog.a(VideoAIFilterProxy.b(), "getVideoFrame end");
      ...
      ((VideoAIFilterProxy)localObject1).jdField_a_of_type_Int = ((VideoAIFilterProxy)localObject1).jdField_a_of_type_JavaUtilList.size();
      localObject1 = this.this$0;
      ((VideoAIFilterProxy)localObject1).a(this.jdField_a_of_type_AndroidContentContext, ((VideoAIFilterProxy)localObject1).jdField_a_of_type_JavaUtilList, this.jdField_a_of_type_ComTencentAelightCameraAeeditorModuleAifilterAIFilterProxyBase$AIFilterProxyCallback);
    }
  }
}
 ...
 * Qualified Name:     com.tencent.aelight.camera.aeeditor.module.aifilter.VideoAIFilterProxy.1
