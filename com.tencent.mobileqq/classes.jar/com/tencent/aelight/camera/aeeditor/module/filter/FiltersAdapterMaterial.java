  ...
  extends MaterialContentAdapter
{
  ...
  {
    return new MaterialContentAdapter.ContentItemVH(LayoutInflater.from(paramViewGroup.getContext()).inflate(2064056484, paramViewGroup, false));
  }
  ...
  public void a(MaterialContentAdapter.ContentItemVH paramContentItemVH, int paramInt, @NonNull MetaMaterial paramMetaMaterial)
  {
    ...
    AEReportUtils.c(this.a, paramMetaMaterial.id);
  }
}
