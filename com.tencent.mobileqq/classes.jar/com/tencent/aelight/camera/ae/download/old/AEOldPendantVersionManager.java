...
import dov.com.qq.im.ae.download.old.AEOldShortVideoSoManager;
import dov.com.qq.im.ae.download.old.AEOldShortVideoSoManager.CfgParser;
import java.io.File;
...
public class AEOldPendantVersionManager
{
  ...
  public static boolean a(String paramString, int paramInt)
  {
    ...
    if (i == 0)
    {
      ...
      VideoEnvironment.LogDownLoad("AEOldPendantVersionManager", ((StringBuilder)localObject).toString(), null);
      ...
      VideoEnvironment.LogDownLoad("AEOldPendantVersionManager", paramString.toString(), null);
      if (i >= paramInt) {
        return true;
      }
    }
  ...
  public static boolean a(String paramString1, String paramString2)
  {
    ...
    ((StringBuilder)localObject1).append(paramString2);
    VideoEnvironment.LogDownLoad("AEOldPendantVersionManager", ((StringBuilder)localObject1).toString(), null);
    ...
    if (!((File)localObject1).exists())
    {
      ...
      VideoEnvironment.LogDownLoad("AEOldPendantVersionManager", paramString1.toString(), null);
      return false;
    }
    ...
    while (i < paramString2.size())
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)paramString2.get(i)))
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject2))
        {
          ...
          VideoEnvironment.LogDownLoad("AEOldPendantVersionManager", ((StringBuilder)localObject1).toString(), null);
          localObject1 = AEOldShortVideoSoManager.a((String)localObject2);
          j = ((AEOldShortVideoSoManager.CfgParser)localObject1).a('|');
          if (j != 0) {
            break label484;
          }
          localObject2 = new StringBuilder();
          ((StringBuilder)localObject2).append(paramString1);
          ((StringBuilder)localObject2).append(((AEOldShortVideoSoManager.CfgParser)localObject1).b());
          ...
          j = Integer.parseInt(((AEOldShortVideoSoManager.CfgParser)localObject1).c());
