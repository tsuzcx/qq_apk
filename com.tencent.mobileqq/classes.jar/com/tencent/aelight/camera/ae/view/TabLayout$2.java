  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (TabLayout.a(this.this$0).size() > this.a) {
      localLayoutParams.setMargins((int)(((TabLayout.TabView)TabLayout.a(this.this$0).get(this.a)).getX() + ((TabLayout.TabView)TabLayout.a(this.this$0).get(this.a)).getWidth() / 2.0F - TabLayout.a(this.this$0).getWidth() / 2.0F), 0, 0, 0);
    } else {
