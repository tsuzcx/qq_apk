  ...
  extends ViewOffsetBehavior<View>
{
  ...
  protected void a(@NonNull CoordinatorLayout paramCoordinatorLayout, @NonNull View paramView, int paramInt)
  {
    ...
    if (localView != null)
    {
      ...
      GravityCompat.apply(b(localLayoutParams.gravity), paramView.getMeasuredWidth(), paramView.getMeasuredHeight(), localRect, paramCoordinatorLayout, paramInt);
 ...
 * Qualified Name:     com.tencent.aelight.camera.ae.view.scrollingheader.HeaderScrollingViewBehavior
