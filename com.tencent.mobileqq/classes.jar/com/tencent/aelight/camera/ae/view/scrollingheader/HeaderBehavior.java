  ...
  extends ViewOffsetBehavior<V>
{
  ...
  int b_(CoordinatorLayout paramCoordinatorLayout, V paramV, int paramInt)
  {
    return a(paramCoordinatorLayout, paramV, paramInt, -2147483648, 2147483647);
  }
  
  int c(@NonNull V paramV)
  {
    return paramV.getHeight();
  }
 ...
 * Qualified Name:     com.tencent.aelight.camera.ae.view.scrollingheader.HeaderBehavior
