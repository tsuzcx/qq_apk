...
public class AEPath$CAMERA$FILES
{
  ...
  static
  {
    ...
    localStringBuilder.append(a);
    localStringBuilder.append(File.separator);
    localStringBuilder.append("material_zip_download");
    d = localStringBuilder.toString();
    localStringBuilder = new StringBuilder();
    localStringBuilder.append(a);
    localStringBuilder.append(File.separator);
    localStringBuilder.append("material_usable");
    ...
    localStringBuilder.append(a);
    localStringBuilder.append(File.separator);
    localStringBuilder.append("pendent_pag_download");
    g = localStringBuilder.toString();
    localStringBuilder = new StringBuilder();
    localStringBuilder.append(a);
    localStringBuilder.append(File.separator);
    localStringBuilder.append("material_zip_download_v2");
    h = localStringBuilder.toString();
    localStringBuilder = new StringBuilder();
    localStringBuilder.append(a);
    localStringBuilder.append(File.separator);
    localStringBuilder.append("material_usable_v2");
 ...
 * Qualified Name:     com.tencent.aelight.camera.ae.AEPath.CAMERA.FILES
