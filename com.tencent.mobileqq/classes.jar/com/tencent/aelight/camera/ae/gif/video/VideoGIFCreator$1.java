  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    try
    {
      VideoGIFCreator.c(this.this$0).a(VideoGIFCreator.a(this.this$0), VideoGIFCreator.b(this.this$0), (String)localObject1);
    }
    catch (FileNotFoundException localFileNotFoundException)
    {
      String str = VideoGIFCreator.b();
    ...
    GLES20.glBindTexture(36197, VideoGIFCreator.d(this.this$0));
    GLES20.glTexParameterf(36197, 10240, 9729.0F);
    GLES20.glTexParameterf(36197, 10241, 9729.0F);
    GLES20.glTexParameterf(36197, 10242, 33071.0F);
    GLES20.glTexParameterf(36197, 10243, 33071.0F);
    VideoGIFCreator.e(this.this$0).apply();
    VideoGIFCreator.f(this.this$0).apply();
    VideoGIFCreator.g(this.this$0).apply();
    VideoGIFCreator.h(this.this$0).a(VideoGIFCreator.a(this.this$0), VideoGIFCreator.b(this.this$0));
    VideoGIFCreator.h(this.this$0).a();
    VideoGIFCreator.a(this.this$0, new SurfaceTexture(localObject2[0]));
    VideoGIFCreator.m(this.this$0).setOnFrameAvailableListener(new VideoGIFCreator.1.1(this, (String)localObject1));
    VideoGIFCreator.a(this.this$0, new VideoDecoder());
    VideoGIFCreator.k(this.this$0).a(this.a, 0L, 2147483647L, new Surface(VideoGIFCreator.m(this.this$0)));
  }
}
