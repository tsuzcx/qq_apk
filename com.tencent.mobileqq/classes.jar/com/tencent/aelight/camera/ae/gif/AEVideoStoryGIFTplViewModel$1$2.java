  ...
  implements Runnable
{
  ...
  public void run()
  {
    AEVideoStoryGIFTplViewModel.a(this.jdField_a_of_type_ComTencentAelightCameraAeGifAEVideoStoryGIFTplViewModel$1.a).setValue(new AEDownloadStateWrapper(this.jdField_a_of_type_CameraXEFFECT_MATERIALS_GENERAL_DATASTRUCTMetaMaterial, 0, 0));
  }
}
