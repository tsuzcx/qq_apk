  ...
  implements Runnable
{
  ...
  public void run()
  {
    AEGIFMaterialViewModel.a(this.jdField_a_of_type_ComTencentAelightCameraAeGifGiftextViewmodelAEGIFMaterialViewModel$1.a).setValue(new AEDownloadStateWrapper(this.jdField_a_of_type_CameraXEFFECT_MATERIALS_GENERAL_DATASTRUCTMetaMaterial, 2, 0));
  }
}
