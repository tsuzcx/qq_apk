...
class AEVideoShelfEditFragment$8
  implements ViewTreeObserver.OnGlobalLayoutListener
{
  AEVideoShelfEditFragment$8(AEVideoShelfEditFragment paramAEVideoShelfEditFragment, FaceImageViewer paramFaceImageViewer, NodeItem paramNodeItem) {}
  
  public void onGlobalLayout()
  {
    if (Build.VERSION.SDK_INT >= 16) {
      this.val$faceImageView.getViewTreeObserver().removeOnGlobalLayoutListener(this);
    } else {
      this.val$faceImageView.getViewTreeObserver().removeGlobalOnLayoutListener(this);
    }
    ViewGroup.MarginLayoutParams localMarginLayoutParams = (ViewGroup.MarginLayoutParams)this.val$faceImageView.getLayoutParams();
    ...
    this.val$faceImageView.setLayoutParams(localMarginLayoutParams);
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes19.jar
 * Qualified Name:     com.tencent.aelight.camera.ae.play.AEVideoShelfEditFragment.8
