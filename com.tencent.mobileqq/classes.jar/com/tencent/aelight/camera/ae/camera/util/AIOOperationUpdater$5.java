...
class AIOOperationUpdater$5
  extends AIOOperationUpdater.BeautyProcessor
{
  AIOOperationUpdater$5(AIOOperationUpdater paramAIOOperationUpdater, AIOOperationUpdater.OPERATION_ENUM paramOPERATION_ENUM)
  {
  ...
  {
    paramAEFilterProcessTex.c(paramOperationRecoveryInfo.a);
    return true;
  }
}
 ...
 * Qualified Name:     com.tencent.aelight.camera.ae.camera.util.AIOOperationUpdater.5
