  ...
  extends View
{
  ...
  public StartPointSeekBar(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.m = paramContext.getDrawable(12);
    if (this.m == null) {
      this.m = ResourcesCompat.getDrawable(getResources(), 2130853620, null);
    }
    this.n = paramContext.getDrawable(13);
    this.g = paramContext.getFloat(3, -100.0F);
    this.h = paramContext.getFloat(2, 100.0F);
    this.i = paramContext.getFloat(5, (float)this.g);
    setProgress(this.i);
    this.r = paramContext.getDrawable(0);
    this.p = paramContext.getDrawable(1);
    this.q = paramContext.getDrawable(4);
    if ((!a) && (this.r == null)) {
      throw new AssertionError();
    }
    this.j = paramContext.getBoolean(10, false);
    this.z = paramContext.getBoolean(11, true);
    this.H = paramContext.getBoolean(14, false);
    this.o = paramContext.getBoolean(8, true);
    this.k = paramContext.getDrawable(7);
    this.l = paramContext.getDrawable(9);
    this.s = paramContext.getBoolean(6, true);
  ...
  public static void a(StartPointSeekBar paramStartPointSeekBar, int paramInt, TextView paramTextView)
  {
    if ((paramStartPointSeekBar != null) && ((paramStartPointSeekBar instanceof StartPointSeekBar)) && (paramTextView != null))
    {
      ...
      paramTextView.measure(paramInt, paramInt);
      ...
      paramInt = (int)(paramStartPointSeekBar.getX() + paramStartPointSeekBar.getThumbRltCenterLoc() - paramInt / 2);
      int i1 = (int)(paramStartPointSeekBar.getY() - UIUtils.a(paramStartPointSeekBar.getContext(), 14.0F));
 ...
 * Qualified Name:     com.tencent.aelight.camera.ae.camera.ui.panel.StartPointSeekBar
