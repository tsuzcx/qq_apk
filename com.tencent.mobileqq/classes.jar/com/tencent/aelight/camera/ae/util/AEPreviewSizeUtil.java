...
public final class AEPreviewSizeUtil
{
  ...
  public static int a()
  {
    ...
    int n = BaseApplication.getContext().getResources().getDimensionPixelSize(2063990794);
    int i2 = BaseApplication.getContext().getResources().getDimensionPixelSize(2063990787);
    int i3 = BaseApplication.getContext().getResources().getDimensionPixelSize(2063990788);
    int i4 = (int)(AIOUtils.b(98.0F, BaseApplication.getContext().getResources()) * 1.1735F);
    int i5 = (int)(BaseApplication.getContext().getResources().getDimensionPixelSize(2063990786) + TypedValue.applyDimension(2, 14.0F, BaseApplication.getContext().getResources().getDisplayMetrics()));
  ...
  public static Size a(AECaptureMode paramAECaptureMode, Size paramSize, boolean paramBoolean, AEVideoStoryTopBarViewModel.Ratio paramRatio)
  {
    ...
    if (paramAECaptureMode == AECaptureMode.NORMAL)
    {
      ...
      if (paramRatio == AEVideoStoryTopBarViewModel.Ratio.R_4_3) {
        return new Size(paramSize.jdField_a_of_type_Int, (int)(paramSize.jdField_a_of_type_Int * 1.333333F));
      }
      if (paramRatio == AEVideoStoryTopBarViewModel.Ratio.R_16_9) {
        return new Size(paramSize.jdField_a_of_type_Int, (int)(paramSize.jdField_a_of_type_Int * 1.777778F));
      }
      return paramSize;
    }
