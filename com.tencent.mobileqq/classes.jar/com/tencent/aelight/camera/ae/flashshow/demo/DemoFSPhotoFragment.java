...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/aelight/camera/ae/flashshow/demo/DemoFSPhotoFragment;", "Landroid/app/Fragment;", "()V", "onCreateView", "Landroid/view/View;", "inflater", "Landroid/view/LayoutInflater;", "container", "Landroid/view/ViewGroup;", "savedInstanceState", "Landroid/os/Bundle;", "aelight_impl_release"}, k=1, mv={1, 1, 16})
public final class DemoFSPhotoFragment
  extends Fragment
{
  private HashMap a;
  ...
  public View onCreateView(@NotNull LayoutInflater paramLayoutInflater, @Nullable ViewGroup paramViewGroup, @Nullable Bundle paramBundle)
  {
    ...
    if (paramViewGroup != null)
    {
      ...
      if (paramViewGroup != null)
      {
        ...
        paramBundle.setText((CharSequence)"Demo 相册");
 ...
 * Qualified Name:     com.tencent.aelight.camera.ae.flashshow.demo.DemoFSPhotoFragment
