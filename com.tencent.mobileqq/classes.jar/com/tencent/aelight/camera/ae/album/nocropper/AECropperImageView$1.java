  ...
  implements ValueAnimator.AnimatorUpdateListener
{
  ...
  {
    Matrix localMatrix = this.jdField_a_of_type_ComTencentAelightCameraAeAlbumNocropperAECropperImageView.getImageMatrix();
    localMatrix.reset();
    ...
    this.jdField_a_of_type_ComTencentAelightCameraAeAlbumNocropperAECropperImageView.setImageMatrix(localMatrix);
