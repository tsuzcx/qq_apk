  ...
  implements Runnable
{
  ...
  public void run()
  {
    if (LiteTransferWrapper.access$200(this.this$0) != 0L)
    {
      ...
      localLiteTransferWrapper.CancelGroupToJNI(LiteTransferWrapper.access$200(localLiteTransferWrapper), this.jdField_a_of_type_Int, this.jdField_a_of_type_Long, this.b, this.jdField_a_of_type_Boolean);
    }
  }
}
