  ...
  extends AbstractGalleryPageView
{
  ...
  Runnable jdField_a_of_type_JavaLangRunnable = new pdn(this);
  ...
  public void a(Activity paramActivity, AbstractGalleryScene paramAbstractGalleryScene, int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setId(2131361992);
    ...
    this.jdField_a_of_type_AndroidViewAnimationAlphaAnimation.setAnimationListener(new pdl(this));
    this.b.setAnimationListener(new pdm(this));
  }
