  ...
  extends View
{
  ...
  private abkc jdField_a_of_type_Abkc;
  ...
  blhp jdField_a_of_type_Blhp = new blhp();
  public boolean a;
  ...
  private void b(Canvas paramCanvas)
  {
    ...
    case 1: 
      do
      {
        ...
        super.onDraw(paramCanvas);
      } while (this.jdField_a_of_type_Abkc == null);
      this.jdField_a_of_type_Abkc.i();
      return;
      this.jdField_b_of_type_Long = SystemClock.uptimeMillis();
    ...
    case 2: 
      ...
      f1 = Math.min(f1, 1.0F);
      f1 = this.jdField_a_of_type_Blhp.getInterpolation(f1);
      Rect localRect1 = this.jdField_a_of_type_AndroidGraphicsRect;
      Rect localRect2 = this.jdField_b_of_type_AndroidGraphicsRect;
      int[] arrayOfInt = new int[2];
      getLocationInWindow(arrayOfInt);
  ...
  private void c(Canvas paramCanvas)
  {
    ...
    for (;;)
    {
      ...
      return;
      label468:
      this.jdField_e_of_type_Float = this.jdField_a_of_type_Blhp.getInterpolation(this.jdField_e_of_type_Float);
      break;
      label486:
  ...
  public void setAnimationListener(abkc paramabkc)
  {
    this.jdField_a_of_type_Abkc = paramabkc;
  }
}
