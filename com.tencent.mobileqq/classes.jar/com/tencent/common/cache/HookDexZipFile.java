  ...
  extends ZipFile
{
  ...
  public void a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 32	com/tencent/common/cache/HookDexZipFile:jdField_a_of_type_Boolean	Z
    //   6: istore_1
    //   7: iload_1
    //   8: ifeq +6 -> 14
    //   11: aload_0
    ...
    //   13: return
    //   14: aload_0
    //   15: getfield 18	com/tencent/common/cache/HookDexZipFile:jdField_a_of_type_JavaUtilZipZipFile	Ljava/util/zip/ZipFile;
    //   18: invokevirtual 38	java/lang/Object:getClass	()Ljava/lang/Class;
    //   21: ldc 40
    //   23: invokevirtual 46	java/lang/Class:getDeclaredField	(Ljava/lang/String;)Ljava/lang/reflect/Field;
    //   26: astore_2
    //   27: aload_2
    //   28: iconst_1
    //   29: invokevirtual 52	java/lang/reflect/Field:setAccessible	(Z)V
    //   32: aload_2
    //   33: aload_0
    //   34: getfield 18	com/tencent/common/cache/HookDexZipFile:jdField_a_of_type_JavaUtilZipZipFile	Ljava/util/zip/ZipFile;
    //   37: invokevirtual 56	java/lang/reflect/Field:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   40: checkcast 58	java/util/LinkedHashMap
    //   43: invokevirtual 62	java/util/LinkedHashMap:entrySet	()Ljava/util/Set;
    //   46: invokeinterface 68 1 0
    //   51: astore_2
    //   52: aload_2
    ...
    //   67: checkcast 80	java/util/Map$Entry
    //   70: invokeinterface 83 1 0
    //   75: checkcast 85	java/lang/String
    //   78: ldc 87
    //   80: invokevirtual 91	java/lang/String:endsWith	(Ljava/lang/String;)Z
    //   83: ifne -31 -> 52
    //   86: aload_2
    ...
    //   95: astore_2
    //   96: aload_2
    //   97: invokevirtual 97	java/lang/NoSuchFieldException:printStackTrace	()V
    //   100: goto -89 -> 11
    //   103: astore_2
    //   104: aload_0
    //   105: monitorexit
    ...
    //   108: astore_2
    //   109: aload_2
    //   110: invokevirtual 98	java/lang/IllegalAccessException:printStackTrace	()V
    //   113: goto -102 -> 11
  ...
  public boolean a()
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 32	com/tencent/common/cache/HookDexZipFile:jdField_a_of_type_Boolean	Z
    //   8: istore_2
    //   9: iload_2
    //   10: ifeq +9 -> 19
    //   13: iconst_0
    ...
    //   18: ireturn
    //   19: aload_0
    //   20: getfield 18	com/tencent/common/cache/HookDexZipFile:jdField_a_of_type_JavaUtilZipZipFile	Ljava/util/zip/ZipFile;
    //   23: ifnull +15 -> 38
    //   26: aload_0
    ...
    //   38: aload_0
    //   39: iconst_1
    //   40: putfield 32	com/tencent/common/cache/HookDexZipFile:jdField_a_of_type_Boolean	Z
    //   43: goto -28 -> 15
    //   46: astore_3
    //   47: aload_0
    //   48: monitorexit
  ...
  public ZipEntry getEntry(String paramString)
  {
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Boolean) {
        MemoryClearManagerNew.a(paramString, MemoryClearManagerNew.l);
      }
    }
  }
 ...
 * Qualified Name:     com.tencent.common.cache.HookDexZipFile
