...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"com/tencent/common/danmaku/edit/views/RichEditText$initTextWatcherListener$1", "Landroid/text/TextWatcher;", "afterTextChanged", "", "s", "Landroid/text/Editable;", "beforeTextChanged", "", "start", "", "count", "after", "onTextChanged", "before", "qqdanmaku_release"}, k=1, mv={1, 1, 16})
 ...
 * Qualified Name:     com.tencent.common.danmaku.edit.views.RichEditText.initTextWatcherListener.1
