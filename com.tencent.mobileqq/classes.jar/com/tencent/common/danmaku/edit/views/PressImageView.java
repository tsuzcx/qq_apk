...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/common/danmaku/edit/views/PressImageView;", "Landroid/widget/ImageView;", "context", "Landroid/content/Context;", "attrs", "Landroid/util/AttributeSet;", "(Landroid/content/Context;Landroid/util/AttributeSet;)V", "enablePressEffect", "", "getEnablePressEffect", "()Z", "setEnablePressEffect", "(Z)V", "mIsDarkBg", "mIsScale", "onTouchEvent", "event", "Landroid/view/MotionEvent;", "onVisibilityChanged", "", "changedView", "Landroid/view/View;", "visibility", "", "qqdanmaku_release"}, k=1, mv={1, 1, 16})
 ...
 * Qualified Name:     com.tencent.common.danmaku.edit.views.PressImageView
