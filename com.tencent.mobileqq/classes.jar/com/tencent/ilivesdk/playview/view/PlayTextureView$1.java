  ...
  implements VideoFileDecodeListener
{
  ...
  {
    LogUtils.i("Render|PlayTextureView", "========= onVideoDecodeError errorCode = " + paramInt);
    switch (paramInt)
    {
    default: 
      return;
  ...
  public void onVideoFormat(MediaFormat paramMediaFormat)
  {
    ...
    LogUtils.i("Render|PlayTextureView", "mFrame Time  = " + PlayTextureView.access$1000(this.this$0));
  }
  
  public void onVideoSize(int paramInt1, int paramInt2)
  {
    LogUtils.i("Render|PlayTextureView", "onVideoSize() called with: width = [" + paramInt1 + "], height = [" + paramInt2 + "]");
