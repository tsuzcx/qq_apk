  ...
  implements TextureView.SurfaceTextureListener
{
  ...
  static final String TAG = "Render|GLTextureView";
  ...
  private void setViewAlpha(float paramFloat)
  {
    ...
    {
      setAlpha(paramFloat);
      LogUtils.d("Render|GLTextureView", "TextureView setAlpha,alpha:" + paramFloat);
    }
  }
  ...
  public void onSurfaceTextureAvailable(SurfaceTexture paramSurfaceTexture, int paramInt1, int paramInt2)
  {
    ...
    LogUtils.d("Render|GLTextureView", " TextureView onSurfaceTextureAvailable surfaceCreated use:" + (System.currentTimeMillis() - l));
  }
  ...
  public boolean onSurfaceTextureDestroyed(SurfaceTexture paramSurfaceTexture)
  {
    ...
    LogUtils.d("Render|GLTextureView", " TextureView onSurfaceTextureDestroyed");
    setViewAlpha(0.0F);
    return true;
  }
  ...
  public void onSurfaceTextureSizeChanged(SurfaceTexture paramSurfaceTexture, int paramInt1, int paramInt2)
  {
    ...
    LogUtils.d("Render|GLTextureView", " TextureView onSurfaceTextureSizeChanged surfaceChanged use:" + (System.currentTimeMillis() - l));
  }
  ...
  public void surfaceChanged(SurfaceTexture paramSurfaceTexture, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if ((this.mSurfaceWidth != paramInt2) || (this.mSurfaceHeight != paramInt3))
    {
      ...
      LogUtils.d("Render|GLTextureView", " surfaceChanged, onWindowResize");
    }
    removeCallbacks(this.mCheckAlphaTask);
    if ((this.mSurfaceTextureAvailable) && (getViewAlpha() != 1.0F)) {
      setViewAlpha(1.0F);
    }
    LogUtils.d("Render|GLTextureView", " surfaceChanged, w:" + paramInt2 + ",h:" + paramInt3 + " use:" + (System.currentTimeMillis() - l));
  }
 ...
 * Qualified Name:     com.tencent.ilivesdk.playview.view.GLTextureView
