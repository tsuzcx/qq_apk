  ...
  implements GLSurfaceView.Renderer, VideoPlayController
{
  ...
  private float calCrop(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (paramInt2 * paramInt3 > paramInt1 * paramInt4)
    {
      ...
      LogUtils.i("MediaPESdk|PlayView", " crop height = " + f);
      return f;
    }
    float f = paramInt3 * paramInt2 * 0.5F / paramInt4 / paramInt1 - 0.5F;
    LogUtils.i("MediaPESdk|PlayView", " crop width = " + f);
    return f;
  }
  ...
  private void callbackError(int paramInt)
  {
    if ((this.mPlayListener != null) && (this.mViewHandler != null)) {
      this.mViewHandler.post(new PlayView.4(this, paramInt));
    }
  }
  ...
  private boolean fileIsExists(String paramString)
  {
    try
    {
      ...
      {
        LogUtils.i("MediaPESdk|PlayView", paramString + "--------->file have exist");
        return true;
      }
      LogUtils.i("MediaPESdk|PlayView", paramString + "---------->file not exists");
      return false;
    }
  ...
  private String getAssetsFiles(String paramString)
  {
    ...
    //   0: aconst_null
    //   1: astore 7
    //   3: new 266	java/lang/StringBuilder
    //   6: dup
    //   7: invokespecial 267	java/lang/StringBuilder:<init>	()V
    //   10: aload_0
    //   11: getfield 171	com/tencent/ilivesdk/playview/view/PlayView:mContext	Landroid/content/Context;
    //   14: invokevirtual 355	android/content/Context:getFilesDir	()Ljava/io/File;
    //   17: invokevirtual 358	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   20: ldc_w 360
    //   23: invokevirtual 273	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   26: aload_1
    //   27: invokevirtual 273	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   30: invokevirtual 280	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   33: astore 6
    //   35: aload_0
    //   36: aload 6
    //   38: invokespecial 362	com/tencent/ilivesdk/playview/view/PlayView:fileIsExists	(Ljava/lang/String;)Z
    //   41: ifne +107 -> 148
    //   44: aload_0
    //   45: getfield 171	com/tencent/ilivesdk/playview/view/PlayView:mContext	Landroid/content/Context;
    //   48: invokevirtual 366	android/content/Context:getAssets	()Landroid/content/res/AssetManager;
    //   51: astore_3
    //   52: aload_3
    //   53: aload_1
    //   54: invokevirtual 372	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   57: astore_3
    //   58: aload_3
    //   59: invokevirtual 378	java/io/InputStream:available	()I
    //   62: istore_2
    //   63: ldc 12
    //   65: new 266	java/lang/StringBuilder
    //   68: dup
    //   69: invokespecial 267	java/lang/StringBuilder:<init>	()V
    //   72: ldc_w 380
    //   75: invokevirtual 273	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   78: iload_2
    //   79: invokevirtual 383	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   82: invokevirtual 280	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   85: invokestatic 263	com/tencent/ilivesdk/utils/LogUtils:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   88: iload_2
    //   89: newarray byte
    //   91: astore 8
    //   93: aload_3
    //   94: aload 8
    //   96: invokevirtual 387	java/io/InputStream:read	([B)I
    //   99: pop
    //   100: aload_0
    //   101: getfield 171	com/tencent/ilivesdk/playview/view/PlayView:mContext	Landroid/content/Context;
    //   104: aload_1
    //   105: iconst_0
    //   106: invokevirtual 391	android/content/Context:openFileOutput	(Ljava/lang/String;I)Ljava/io/FileOutputStream;
    //   109: astore_1
    //   110: aload_1
    //   111: astore 5
    //   113: aload_3
    ...
    //   116: aload_1
    //   117: aload 8
    //   119: invokevirtual 397	java/io/FileOutputStream:write	([B)V
    //   122: aload_1
    //   123: astore 5
    //   125: aload_3
    //   126: astore 4
    //   128: aload_1
    //   129: invokevirtual 400	java/io/FileOutputStream:flush	()V
    //   132: aload_3
    //   133: ifnull +7 -> 140
    //   136: aload_3
    //   137: invokevirtual 403	java/io/InputStream:close	()V
    //   140: aload_1
    //   141: ifnull +7 -> 148
    //   144: aload_1
    //   145: invokevirtual 404	java/io/FileOutputStream:close	()V
    //   148: aload 6
    //   150: astore_3
    //   151: aload_3
    //   152: areturn
    ...
    //   163: astore 4
    //   165: aload 6
    //   167: invokevirtual 405	java/io/IOException:printStackTrace	()V
    //   170: aload_3
    //   171: ifnull +7 -> 178
    //   174: aload_3
    ...
    //   182: ifnull -31 -> 151
    //   185: aload_1
    //   186: invokevirtual 404	java/io/FileOutputStream:close	()V
    //   189: aconst_null
    //   190: areturn
    //   191: astore_1
    //   192: aconst_null
    ...
    //   201: ifnull +7 -> 208
    //   204: aload_3
    //   205: invokevirtual 403	java/io/InputStream:close	()V
    //   208: aload 5
    //   210: ifnull +8 -> 218
    //   213: aload 5
    //   215: invokevirtual 404	java/io/FileOutputStream:close	()V
    //   218: aload_1
    //   219: athrow
    //   220: astore_3
    //   221: goto -81 -> 140
  ...
  private void setupDecodeRender()
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        LogUtils.i("MediaPESdk|PlayView", "mSurfaceTextureRender Exception switch  soft decode Exception=" + localException);
  ...
  public void onDrawFrame(GL10 arg1)
  {
    ...
    for (;;)
    {
      ...
      if (this.mOnPreviewFrameLogTimer.isTimeToWriteLog()) {
        LogUtils.i("MediaPESdk|PlayView", "onDrawFrame fps= " + this.mOnPreviewFrameLogTimer.getFps());
      }
  ...
  {
    LogUtils.e("MediaPESdk|PlayView", "===================gl render onSurfaceChanged " + paramInt1 + " h=" + paramInt2);
  ...
  {
    LogUtils.i("MediaPESdk|PlayView", " playAssetsFile , want to play filename =" + paramString);
  ...
  public void playFile(String paramString)
  {
    ...
    {
      LogUtils.e("MediaPESdk|PlayView", " playFile , want to play filepath =" + paramString);
      if (!this.mPlayStarting) {
        break;
      }
