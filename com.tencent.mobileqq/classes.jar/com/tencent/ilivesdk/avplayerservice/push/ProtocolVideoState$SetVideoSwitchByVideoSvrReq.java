  ...
  extends MessageMicro<SetVideoSwitchByVideoSvrReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 48, 56, 64, 72, 82, 88, 96 }, new String[] { "Uin", "RootRoomID", "FatherRoomID", "RoomID", "ClientType", "OperType", "LiveType", "Gender", "LogoTimeStamp", "Nick", "GameID", "VideoChanel" }, new Object[] { Long.valueOf(0L), Long.valueOf(0L), Long.valueOf(0L), Long.valueOf(0L), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), localByteStringMicro, Integer.valueOf(0), Integer.valueOf(0) }, SetVideoSwitchByVideoSvrReq.class);
  }
}
