  ...
  extends MessageMicro<SetVideoSwitchResp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 48, 56, 64, 74 }, new String[] { "Result", "Uin", "RoomID", "ClientType", "OperType", "LiveType", "VideoChanel", "VideoID", "ErrMsg" }, new Object[] { localInteger, localLong, localLong, localInteger, localInteger, localInteger, localInteger, localInteger, localByteStringMicro }, SetVideoSwitchResp.class);
  }
}
