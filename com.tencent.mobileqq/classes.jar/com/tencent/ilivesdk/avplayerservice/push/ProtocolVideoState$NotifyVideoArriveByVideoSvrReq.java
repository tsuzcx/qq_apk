  ...
  extends MessageMicro<NotifyVideoArriveByVideoSvrReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 48, 58, 66, 72, 80 }, new String[] { "Uin", "RoomID", "VideoID", "VideosvrInnerIP", "VideosvrOuterIP", "VideoRate", "sessionid", "uuid", "video_kind", "will_trans_flag" }, new Object[] { Long.valueOf(0L), Long.valueOf(0L), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), localByteStringMicro1, localByteStringMicro2, Integer.valueOf(0), Integer.valueOf(0) }, NotifyVideoArriveByVideoSvrReq.class);
  }
}
