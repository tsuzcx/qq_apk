  ...
  extends MessageMicro<SyncVideoPlayStat2RoomReq>
{
  ...
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "Uin", "RoomID", "RoomType", "PlayState" }, new Object[] { Long.valueOf(0L), Long.valueOf(0L), Integer.valueOf(0), Integer.valueOf(0) }, SyncVideoPlayStat2RoomReq.class);
