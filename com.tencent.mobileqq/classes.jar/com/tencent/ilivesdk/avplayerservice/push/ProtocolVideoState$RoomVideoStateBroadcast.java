  ...
  extends MessageMicro<RoomVideoStateBroadcast>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 50, 56, 64, 74, 80 }, new String[] { "Uin", "RoomID", "UserType", "OperType", "LiveType", "PlayingInfos", "VideoChanel", "CloseType", "CloseDescription", "av_type_change" }, new Object[] { Long.valueOf(0L), Long.valueOf(0L), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), null, Integer.valueOf(0), Integer.valueOf(10), localByteStringMicro, Integer.valueOf(0) }, RoomVideoStateBroadcast.class);
  }
}
