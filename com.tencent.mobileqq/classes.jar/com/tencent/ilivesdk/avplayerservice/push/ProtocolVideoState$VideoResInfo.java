  ...
  extends MessageMicro<VideoResInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 48 }, new String[] { "VideoID", "Width", "Height", "Bitrate", "definition", "OriginalFlag" }, new Object[] { localInteger, localInteger, localInteger, localInteger, localInteger, localInteger }, VideoResInfo.class);
  }
}
