  ...
  extends MessageMicro<MsgHead>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 48 }, new String[] { "send_uin", "to_uin", "random", "timestamp", "sync_other_machine", "as_admin" }, new Object[] { localLong, localLong, localInteger, localInteger, Integer.valueOf(2), Boolean.valueOf(false) }, MsgHead.class);
  }
}
