  ...
  extends MessageMicro<TinyId2UserIdRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "result", "userid", "tinyid" }, new Object[] { Integer.valueOf(0), localLong, localLong }, TinyId2UserIdRsp.class);
  }
}
