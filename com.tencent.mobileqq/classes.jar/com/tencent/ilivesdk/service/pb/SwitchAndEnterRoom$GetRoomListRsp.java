  ...
  extends MessageMicro<GetRoomListRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 42 }, new String[] { "result", "interval", "is_find", "index", "room_list" }, new Object[] { localInteger, localInteger, localInteger, localInteger, null }, GetRoomListRsp.class);
  }
}
