  ...
  extends MessageMicro<RoomInfo>
{
  ...
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24 }, new String[] { "roomid", "url", "logo" }, new Object[] { Integer.valueOf(0), "", Integer.valueOf(0) }, RoomInfo.class);
