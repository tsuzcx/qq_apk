  ...
  implements ChannelCallback
{
  ...
  public void onRecv(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      RoomHeartController.access$100(this.this$0).getLogger().d("RoomHeartController", "start heartRoom-suc-interval=" + localUserHeartBeatRsp.interval.get(), new Object[0]);
