  ...
  extends MessageMicro<GetUserListPagedReq>
{
  ...
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16 }, new String[] { "roomid", "index" }, new Object[] { Integer.valueOf(0), Integer.valueOf(0) }, GetUserListPagedReq.class);
