  ...
  implements Parcelable, Cloneable
{
  ...
  public LocationInfo copy()
  {
    ...
    localLocationInfo.lat = this.lat;
    localLocationInfo.lng = this.lng;
    localLocationInfo.city = this.city;
    localLocationInfo.address = this.address;
    localLocationInfo.name = this.name;
    localLocationInfo.isForeign = this.isForeign;
  ...
  {
    this.lng = getString(paramString1);
    this.lat = getString(paramString2);
    this.city = getString(paramString3);
    this.name = getString(paramString4);
  }
 ...
 * Qualified Name:     com.tencent.falco.base.libapi.location.LocationInfo
