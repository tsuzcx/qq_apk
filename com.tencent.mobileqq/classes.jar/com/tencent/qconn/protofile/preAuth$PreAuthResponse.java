  ...
  extends MessageMicro<PreAuthResponse>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 34, 50, 122, 130, 162, 170, 322, 328 }, new String[] { "ret", "msg", "appid", "app_name", "icons_url", "android_info", "ios_info", "auth_items", "authorized_union_text", "profiles", "vid" }, new Object[] { Integer.valueOf(0), "", localLong, "", null, null, null, null, "", null, localLong }, PreAuthResponse.class);
  }
}
