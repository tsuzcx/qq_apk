...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 34, 42, 50, 82, 90, 96, 106, 160, 168, 178, 184 }, new String[] { "appid", "sdkp", "sdkv", "icons", "qqv", "os", "scope", "skey", "md5time", "sign", "app_type", "channel_source", "appUniqueIdentifier", "referer" }, new Object[] { Long.valueOf(0L), "", "", "", "", "", "", "", Long.valueOf(0L), "", Integer.valueOf(0), Long.valueOf(0L), "", Integer.valueOf(1) }, PreAuthRequest.class);
