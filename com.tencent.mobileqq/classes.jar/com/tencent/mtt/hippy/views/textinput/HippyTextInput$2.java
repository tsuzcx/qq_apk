  ...
  implements TextWatcher
{
  ...
  public void afterTextChanged(Editable paramEditable)
  {
    ...
    if (TextUtils.isEmpty(HippyTextInput.access$500(this.this$0)))
    {
      if ((HippyTextInput.access$600(this.this$0)) && (TextUtils.equals(paramEditable.toString(), HippyTextInput.access$700(this.this$0)))) {
        return;
      }
      HippyTextInput.access$702(this.this$0, paramEditable.toString());
      HippyTextInput.access$602(this.this$0, true);
    ...
    try
    {
      boolean bool = paramEditable.toString().matches(HippyTextInput.access$500(this.this$0));
      if ((!bool) && (!"".equals(paramEditable.toString())))
      {
        ...
        ((StringBuilder)localObject).append(paramEditable.toString());
        LogUtils.d("robinsli", ((StringBuilder)localObject).toString());
        this.this$0.setText(HippyTextInput.access$400(this.this$0));
        HippyTextInput.access$802(this.this$0, HippyTextInput.access$400(this.this$0));
      ...
      HippyTextInput.access$602(this.this$0, true);
      HippyTextInput.access$702(this.this$0, paramEditable.toString());
      if ((!this.this$0.bUserSetValue) && ((TextUtils.isEmpty(HippyTextInput.access$800(this.this$0))) || (!TextUtils.equals(HippyTextInput.access$800(this.this$0), HippyTextInput.access$700(this.this$0)))))
      {
        localObject = new HippyMap();
        ((HippyMap)localObject).pushString("text", paramEditable.toString());
        ((EventDispatcher)this.this$0.mHippyContext.getModuleManager().getJavaScriptModule(EventDispatcher.class)).receiveUIComponentEvent(this.this$0.getId(), "onChangeText", localObject);
        ...
        ((StringBuilder)localObject).append(paramEditable.toString());
        LogUtils.d("robinsli", ((StringBuilder)localObject).toString());
        HippyTextInput.access$802(this.this$0, "");
      }
      label508:
      return;
    }
  ...
  {
    HippyTextInput.access$402(this.this$0, paramCharSequence.toString());
  }
