  ...
  implements INetTransportProvider.INetTransportEventListener, IIntChkStrikeResultListener
{
  ...
  private void c(String paramString)
  {
    ...
    //   1: astore_2
    //   2: aload_1
    //   3: invokevirtual 262	java/lang/String:trim	()Ljava/lang/String;
    //   6: invokestatic 90	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   9: ifeq +4 -> 13
    //   12: return
    //   13: invokestatic 309	javax/xml/parsers/DocumentBuilderFactory:newInstance	()Ljavax/xml/parsers/DocumentBuilderFactory;
    //   16: astore_3
    //   17: aload_3
    //   18: invokevirtual 313	javax/xml/parsers/DocumentBuilderFactory:newDocumentBuilder	()Ljavax/xml/parsers/DocumentBuilder;
    //   21: new 315	java/io/ByteArrayInputStream
    //   24: dup
    //   25: aload_1
    //   26: invokevirtual 318	java/lang/String:getBytes	()[B
    //   29: invokespecial 321	java/io/ByteArrayInputStream:<init>	([B)V
    //   32: invokevirtual 327	javax/xml/parsers/DocumentBuilder:parse	(Ljava/io/InputStream;)Lorg/w3c/dom/Document;
    //   35: invokeinterface 333 1 0
    //   40: astore_3
    //   41: aload_0
    //   42: iconst_0
    //   43: putfield 28	com/tencent/mqpsdk/secsrv/MQPIntChkService:c	I
    //   46: aload_3
    //   47: ldc_w 335
    //   50: invokeinterface 341 2 0
    //   55: astore_1
    //   56: aload_1
    //   57: invokevirtual 262	java/lang/String:trim	()Ljava/lang/String;
    //   60: invokevirtual 344	java/lang/String:length	()I
    //   63: ifle +11 -> 74
    //   66: aload_0
    //   67: aload_1
    //   68: invokestatic 350	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   71: putfield 28	com/tencent/mqpsdk/secsrv/MQPIntChkService:c	I
    //   74: aload_0
    //   75: getfield 28	com/tencent/mqpsdk/secsrv/MQPIntChkService:c	I
    //   78: tableswitch	default:+345 -> 423, 1:+26->104, 2:+161->239, 3:+216->294
    //   105: getfield 352	com/tencent/mqpsdk/secsrv/MQPIntChkService:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   108: ifnull -96 -> 12
    //   111: aload_0
    //   112: getfield 352	com/tencent/mqpsdk/secsrv/MQPIntChkService:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   115: iconst_1
    //   116: invokestatic 356	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   119: invokeinterface 362 2 0
    //   124: ifeq +294 -> 418
    //   127: aload_0
    //   128: getfield 352	com/tencent/mqpsdk/secsrv/MQPIntChkService:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   131: iconst_1
    //   132: invokestatic 356	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   135: invokeinterface 364 2 0
    //   140: checkcast 366	com/tencent/mqpsdk/secsrv/MQPIntChkService$IIntChkStrike
    //   143: astore_1
    //   144: aload_1
    //   145: ifnull -133 -> 12
    //   148: new 368	javax/xml/transform/dom/DOMSource
    //   151: dup
    //   152: aload_3
    //   153: invokespecial 371	javax/xml/transform/dom/DOMSource:<init>	(Lorg/w3c/dom/Node;)V
    //   156: astore_3
    //   157: new 373	java/io/StringWriter
    //   160: dup
    //   161: invokespecial 374	java/io/StringWriter:<init>	()V
    //   164: astore_2
    //   165: new 376	javax/xml/transform/stream/StreamResult
    //   168: dup
    //   169: aload_2
    //   170: invokespecial 379	javax/xml/transform/stream/StreamResult:<init>	(Ljava/io/Writer;)V
    //   173: astore 4
    //   175: invokestatic 384	javax/xml/transform/TransformerFactory:newInstance	()Ljavax/xml/transform/TransformerFactory;
    //   178: invokevirtual 388	javax/xml/transform/TransformerFactory:newTransformer	()Ljavax/xml/transform/Transformer;
    //   181: aload_3
    //   182: aload 4
    //   184: invokevirtual 394	javax/xml/transform/Transformer:transform	(Ljavax/xml/transform/Source;Ljavax/xml/transform/Result;)V
    //   187: new 396	org/json/JSONObject
    //   190: dup
    //   191: invokespecial 397	org/json/JSONObject:<init>	()V
    //   194: astore_3
    //   195: aload_3
    //   196: ldc_w 399
    //   199: aload_2
    //   200: invokevirtual 402	java/io/StringWriter:toString	()Ljava/lang/String;
    //   203: invokevirtual 406	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   206: pop
    //   207: aload_1
    //   208: aload_3
    //   209: invokevirtual 407	org/json/JSONObject:toString	()Ljava/lang/String;
    //   212: aload_0
    //   213: invokeinterface 410 3 0
    //   218: return
    //   219: astore_1
    //   220: aload_1
    //   221: invokevirtual 411	java/lang/Exception:printStackTrace	()V
    //   224: return
    //   225: astore_1
    //   226: aload_1
    //   227: invokevirtual 411	java/lang/Exception:printStackTrace	()V
    //   230: return
    //   231: astore_2
    //   232: aload_2
    //   233: invokevirtual 411	java/lang/Exception:printStackTrace	()V
    //   236: goto -29 -> 207
    //   239: aload_0
    //   240: getfield 352	com/tencent/mqpsdk/secsrv/MQPIntChkService:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   243: ifnull -231 -> 12
    //   246: aload_2
    //   247: astore_1
    //   248: aload_0
    //   249: getfield 352	com/tencent/mqpsdk/secsrv/MQPIntChkService:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   252: iconst_2
    //   253: invokestatic 356	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   256: invokeinterface 362 2 0
    //   261: ifeq +20 -> 281
    //   264: aload_0
    //   265: getfield 352	com/tencent/mqpsdk/secsrv/MQPIntChkService:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   268: iconst_2
    //   269: invokestatic 356	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   272: invokeinterface 364 2 0
    //   277: checkcast 366	com/tencent/mqpsdk/secsrv/MQPIntChkService$IIntChkStrike
    //   280: astore_1
    //   281: aload_1
    //   282: ifnull -270 -> 12
    //   285: aload_1
    //   286: aconst_null
    //   287: aload_0
    //   288: invokeinterface 410 3 0
    //   293: return
    //   294: aload_0
    //   295: getfield 352	com/tencent/mqpsdk/secsrv/MQPIntChkService:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   298: ifnull -286 -> 12
    //   301: aload_0
    //   302: getfield 352	com/tencent/mqpsdk/secsrv/MQPIntChkService:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   305: iconst_3
    //   306: invokestatic 356	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   309: invokeinterface 362 2 0
    //   314: ifeq +99 -> 413
    //   317: aload_0
    //   318: getfield 352	com/tencent/mqpsdk/secsrv/MQPIntChkService:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   321: iconst_3
    //   322: invokestatic 356	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   325: invokeinterface 364 2 0
    //   330: checkcast 366	com/tencent/mqpsdk/secsrv/MQPIntChkService$IIntChkStrike
    //   333: astore_1
    //   334: aload_1
    //   335: ifnull -323 -> 12
    //   338: aload_3
    //   339: ldc_w 413
    //   342: invokeinterface 417 2 0
    //   347: astore_2
    //   348: aload_2
    //   349: invokeinterface 422 1 0
    //   354: ifeq -342 -> 12
    //   357: aload_2
    //   358: iconst_0
    //   359: invokeinterface 426 2 0
    //   364: checkcast 337	org/w3c/dom/Element
    //   367: ldc_w 428
    //   370: invokeinterface 341 2 0
    //   375: astore_3
    //   376: new 396	org/json/JSONObject
    //   379: dup
    //   380: invokespecial 397	org/json/JSONObject:<init>	()V
    //   383: astore_2
    //   384: aload_2
    //   385: ldc_w 430
    //   388: aload_3
    //   389: invokevirtual 406	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   392: pop
    //   393: aload_1
    //   394: aload_2
    //   395: invokevirtual 407	org/json/JSONObject:toString	()Ljava/lang/String;
    //   398: aload_0
    //   399: invokeinterface 410 3 0
    //   404: return
    //   405: astore_3
    //   406: aload_3
    //   407: invokevirtual 411	java/lang/Exception:printStackTrace	()V
    //   410: goto -17 -> 393
    //   413: aconst_null
    //   414: astore_1
    //   415: goto -81 -> 334
