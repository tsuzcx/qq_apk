  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        ...
        localObject4 = ((INetTransportProvider)localObject2).getCodec("sig_check");
        paramString = (String)localObject1;
        if (localObject4 != null) {
          paramString = ((INetTransportProvider.INetTransportCodec)localObject4).encode(localObject1);
        }
        ((INetTransportProvider)localObject2).send(paramString);
        return;
      }
      try
      {
