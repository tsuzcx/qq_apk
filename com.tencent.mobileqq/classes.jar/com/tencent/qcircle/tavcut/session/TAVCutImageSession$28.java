  ...
  implements Runnable
{
  ...
  public void run()
  {
    Object localObject1 = (WeakReference)TAVCutImageSession.access$400(this.this$0).get(this.val$index);
    ...
    Object localObject2 = (Bitmap)TAVCutImageSession.access$1400(this.this$0).get(this.val$index);
    if (localObject2 != null)
    {
      ...
      if ((localObject3 instanceof ViewGroup))
      {
        ...
        TAVCutImageSession.access$1500(this.this$0, ((TAVCutImageView)localObject1).getStickerContainer(), this.val$index);
      }
    }
  }
}
 ...
 * Qualified Name:     com.tencent.qcircle.tavcut.session.TAVCutImageSession.28
