...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/qcircle/weishi/module/publisher/data/VolumeRange;", "Landroid/os/Parcelable;", "start", "", "end", "(FF)V", "getEnd", "()F", "getStart", "component1", "component2", "copy", "describeContents", "", "equals", "", "other", "", "hashCode", "toString", "", "writeToParcel", "", "parcel", "Landroid/os/Parcel;", "flags", "Companion", "libtavcut_debug"}, k=1, mv={1, 1, 16})
@Parcelize
 ...
 * Qualified Name:     com.tencent.qcircle.weishi.module.publisher.data.VolumeRange
