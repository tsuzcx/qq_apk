...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/qcircle/weishi/module/publisher/LightTemplateManager;", "", "()V", "COVER_OFFSET", "", "FONT_PROGRESS", "", "LIGHTSDK_BASE_FILE_PROGRESS", "MUSIC_PROGRESS", "PERCENT_10", "", "PERCENT_30", "RED_PACKET_KEY", "TAG", "TEMPLATE_JSON", "TEMPLATE_PROGRESS", "downloadFontComplete", "", "downloadMusicComplete", "fetchMusicInfoComplete", "progressCache", "Ljava/util/HashMap;", "Lkotlin/collections/HashMap;", "libtavcut_debug"}, k=1, mv={1, 1, 16})
 ...
 * Qualified Name:     com.tencent.qcircle.weishi.module.publisher.LightTemplateManager
