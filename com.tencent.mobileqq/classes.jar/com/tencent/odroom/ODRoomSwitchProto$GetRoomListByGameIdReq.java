...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "game_id", "index", "source" }, new Object[] { Integer.valueOf(0), Integer.valueOf(1), Integer.valueOf(0) }, GetRoomListByGameIdReq.class);
