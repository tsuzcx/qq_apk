  ...
  extends MessageMicro<RcmdRoomSwitchReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 29, 37, 40 }, new String[] { "curr_roomid", "gender", "longitude", "latitude", "source" }, new Object[] { localInteger, localInteger, localFloat, localFloat, localInteger }, RcmdRoomSwitchReq.class);
  }
}
