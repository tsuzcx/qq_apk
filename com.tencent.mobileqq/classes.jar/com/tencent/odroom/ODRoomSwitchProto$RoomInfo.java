...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 32, 42, 50, 56 }, new String[] { "room_id", "room_name", "room_logo_url", "anchor_uin", "anchor_nick", "anchor_pic", "online_num" }, new Object[] { Long.valueOf(0L), "", "", Long.valueOf(0L), "", "", Integer.valueOf(0) }, RoomInfo.class);
