...
public class Andromeda
{
  ...
  public static java.lang.String a(android.content.Context paramContext, java.lang.String paramString)
  {
    ...
    //   63: invokestatic 75	com/tencent/turingfd/sdk/xq/const:c	([B)Ljava/lang/String;
    //   66: astore_1
    //   67: aload_0
  ...
  public static java.util.List<java.lang.String> a(java.io.File paramFile)
  {
    ...
    //   24: sipush 8192
    //   27: newarray byte
    //   29: invokestatic 101	com/tencent/turingfd/sdk/xq/Andromeda:a	(Ljava/util/jar/JarFile;Ljava/util/jar/JarEntry;[B)[Ljava/security/cert/Certificate;
    //   32: astore 4
    //   34: aload 4
    //   36: ifnull +43 -> 79
    //   39: aload 4
    ...
    //   58: invokestatic 75	com/tencent/turingfd/sdk/xq/const:c	([B)Ljava/lang/String;
  ...
  public static java.security.cert.Certificate[] a(java.util.jar.JarFile paramJarFile, java.util.jar.JarEntry paramJarEntry, byte[] paramArrayOfByte)
  {
    ...
    //   11: aload_2
    //   12: arraylength
    //   13: invokevirtual 123	java/io/InputStream:read	([BII)I
    //   16: iconst_m1
    //   17: if_icmpeq +6 -> 23
    //   20: goto -12 -> 8
    //   23: aload_3
    ...
    //   26: ifnull +8 -> 34
    //   29: aload_1
    //   30: invokevirtual 129	java/util/jar/JarEntry:getCertificates	()[Ljava/security/cert/Certificate;
    //   33: astore_2
    //   34: aload_0
    ...
    //   52: ifnull +7 -> 59
    //   55: aload_1
    //   56: invokevirtual 130	java/io/InputStream:close	()V
    //   59: aload_0
    //   60: athrow
    //   61: aconst_null
    //   62: astore_0
    ...
    //   64: ifnull +7 -> 71
    //   67: aload_0
    //   68: invokevirtual 130	java/io/InputStream:close	()V
    //   71: aconst_null
    //   72: areturn
    //   73: astore_0
    //   74: goto -13 -> 61
