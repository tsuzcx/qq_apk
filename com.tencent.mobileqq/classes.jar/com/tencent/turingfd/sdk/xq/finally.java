...
{
  public static HashMap<String, Class<?>> mg = new HashMap();
  public static HashMap<Class<?>, HashMap<String, Field>> ng = new HashMap();
  public static HashMap<Class<?>, HashMap<String, Method>> og = new HashMap();
  ...
  public static Object a(Class<?> paramClass, String paramString, Object paramObject)
  {
    ...
    else
    {
      ...
      try
      {
        localObject2 = (HashMap)ng.get(paramClass);
        localObject1 = localObject2;
        if (localObject2 == null)
        {
          localObject1 = new HashMap();
          ng.put(paramClass, localObject1);
        }
  ...
  public static Method a(Class<?> paramClass, String paramString, Class<?>... paramVarArgs)
  {
    ...
    do
    {
      try
      {
        ...
        localObject2 = (HashMap)og.get(paramClass);
        localObject1 = localObject2;
        if (localObject2 == null)
        {
          localObject1 = new HashMap();
          og.put(paramClass, localObject1);
        }
  ...
  public static Object c(String paramString1, String paramString2)
  {
    ...
    try
    {
      Class localClass2 = (Class)mg.get(paramString1);
    ...
    mg.put(paramString1, localClass1);
    for (;;)
    {
      try
      {
