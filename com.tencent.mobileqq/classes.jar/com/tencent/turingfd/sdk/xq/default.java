...
public final class default
  implements long
{
  public default(String paramString) {}
  ...
  public long.do a(int paramInt1, byte[] paramArrayOfByte, int paramInt2, int paramInt3)
  {
    ...
    //   0: ldc 40
    //   2: astore 6
    //   4: new 42	com/tencent/turingfd/sdk/xq/extends
    //   7: dup
    //   8: invokespecial 43	com/tencent/turingfd/sdk/xq/extends:<init>	()V
    //   11: astore 7
    //   13: aload_0
    //   14: getfield 12	com/tencent/turingfd/sdk/xq/default:jg	Ljava/lang/String;
    //   17: astore 8
    //   19: invokestatic 49	com/tencent/turingfd/sdk/xq/void:get	()Landroid/content/Context;
    //   22: astore 5
    //   24: iconst_1
    //   25: istore 4
    //   27: aload 5
    ...
    //   77: iconst_1
    //   78: if_icmpne +11 -> 89
    //   81: getstatic 88	com/tencent/turingfd/sdk/xq/extends$do:Ji	Lcom/tencent/turingfd/sdk/xq/extends$do;
    //   84: astore 5
    //   86: goto +119 -> 205
    //   89: aload 9
    ...
    //   94: ifne +47 -> 141
    //   97: aload 5
    //   99: invokestatic 92	com/tencent/turingfd/sdk/xq/extends:v	(Landroid/content/Context;)Ljava/lang/String;
    //   102: astore 9
    //   104: aload 9
    //   106: ifnull +27 -> 133
    //   109: aload 9
    ...
    //   114: ifle +19 -> 133
    //   117: aload 5
    //   119: invokestatic 101	com/tencent/turingfd/sdk/xq/extends:w	(Landroid/content/Context;)I
    //   122: ifle +11 -> 133
    //   125: getstatic 104	com/tencent/turingfd/sdk/xq/extends$do:Ki	Lcom/tencent/turingfd/sdk/xq/extends$do;
    //   128: astore 5
    //   130: goto +75 -> 205
    //   133: getstatic 107	com/tencent/turingfd/sdk/xq/extends$do:Li	Lcom/tencent/turingfd/sdk/xq/extends$do;
    //   136: astore 5
    //   138: goto +67 -> 205
    //   141: getstatic 107	com/tencent/turingfd/sdk/xq/extends$do:Li	Lcom/tencent/turingfd/sdk/xq/extends$do;
    //   144: astore 5
    //   146: goto +59 -> 205
    //   149: getstatic 110	com/tencent/turingfd/sdk/xq/extends$do:Mi	Lcom/tencent/turingfd/sdk/xq/extends$do;
    //   152: astore 5
    //   154: goto +51 -> 205
    //   157: astore 5
    //   159: aload 5
    ...
    //   188: iload_1
    //   189: ifeq +11 -> 200
    //   192: getstatic 88	com/tencent/turingfd/sdk/xq/extends$do:Ji	Lcom/tencent/turingfd/sdk/xq/extends$do;
    //   195: astore 5
    //   197: goto +8 -> 205
    //   200: getstatic 110	com/tencent/turingfd/sdk/xq/extends$do:Mi	Lcom/tencent/turingfd/sdk/xq/extends$do;
    //   203: astore 5
    //   205: aload 5
    //   207: getstatic 110	com/tencent/turingfd/sdk/xq/extends$do:Mi	Lcom/tencent/turingfd/sdk/xq/extends$do;
    ...
    //   229: astore 8
    //   231: aload 5
    //   233: getstatic 104	com/tencent/turingfd/sdk/xq/extends$do:Ki	Lcom/tencent/turingfd/sdk/xq/extends$do;
    ...
    //   250: invokestatic 49	com/tencent/turingfd/sdk/xq/void:get	()Landroid/content/Context;
    //   253: invokestatic 92	com/tencent/turingfd/sdk/xq/extends:v	(Landroid/content/Context;)Ljava/lang/String;
    //   256: invokestatic 49	com/tencent/turingfd/sdk/xq/void:get	()Landroid/content/Context;
    //   259: invokestatic 101	com/tencent/turingfd/sdk/xq/extends:w	(Landroid/content/Context;)I
    ...
    //   274: putfield 151	com/tencent/turingfd/sdk/xq/extends:kg	Ljava/net/HttpURLConnection;
    //   277: goto +16 -> 293
    //   280: aload 7
    //   282: aload 8
    //   284: invokevirtual 154	java/net/URL:openConnection	()Ljava/net/URLConnection;
    //   287: checkcast 147	java/net/HttpURLConnection
    //   290: putfield 151	com/tencent/turingfd/sdk/xq/extends:kg	Ljava/net/HttpURLConnection;
    //   293: aload 7
    //   295: getfield 151	com/tencent/turingfd/sdk/xq/extends:kg	Ljava/net/HttpURLConnection;
    //   298: sipush 15000
    //   301: invokevirtual 158	java/net/HttpURLConnection:setReadTimeout	(I)V
    //   304: aload 7
    //   306: getfield 151	com/tencent/turingfd/sdk/xq/extends:kg	Ljava/net/HttpURLConnection;
    //   309: sipush 15000
    ...
    //   331: goto +78 -> 409
    //   334: astore 5
    //   336: invokestatic 170	com/tencent/turingfd/sdk/xq/Damson:getInstance	()Lcom/tencent/turingfd/sdk/xq/Damson;
    //   339: aload 5
    //   341: invokevirtual 173	com/tencent/turingfd/sdk/xq/Damson:a	(Ljava/lang/Throwable;)V
    //   344: sipush -1056
    //   347: istore_1
    //   348: aload 5
    ...
    //   416: aload 7
    //   418: iconst_0
    //   419: putfield 182	com/tencent/turingfd/sdk/xq/extends:lg	Z
    //   422: aload_2
    //   423: arraylength
    //   424: istore_1
    //   425: aload 7
    //   427: getfield 151	com/tencent/turingfd/sdk/xq/extends:kg	Ljava/net/HttpURLConnection;
    //   430: iconst_1
    //   431: invokevirtual 186	java/net/HttpURLConnection:setDoOutput	(Z)V
    //   434: aload 7
    //   436: getfield 151	com/tencent/turingfd/sdk/xq/extends:kg	Ljava/net/HttpURLConnection;
    //   439: iconst_1
    //   440: invokevirtual 189	java/net/HttpURLConnection:setDoInput	(Z)V
    //   443: aload 7
    //   445: getfield 151	com/tencent/turingfd/sdk/xq/extends:kg	Ljava/net/HttpURLConnection;
    //   448: iconst_0
    //   449: invokevirtual 192	java/net/HttpURLConnection:setUseCaches	(Z)V
    //   452: aload 7
    //   454: getfield 151	com/tencent/turingfd/sdk/xq/extends:kg	Ljava/net/HttpURLConnection;
    //   457: astore 5
    //   459: aload 5
    //   461: ldc 194
    //   463: invokevirtual 197	java/net/HttpURLConnection:setRequestMethod	(Ljava/lang/String;)V
    //   466: aload 7
    //   468: getfield 151	com/tencent/turingfd/sdk/xq/extends:kg	Ljava/net/HttpURLConnection;
    //   471: astore 5
    //   473: aload 5
    //   475: ldc 199
    //   477: ldc 201
    ...
    //   482: aload 7
    //   484: getfield 151	com/tencent/turingfd/sdk/xq/extends:kg	Ljava/net/HttpURLConnection;
    //   487: astore 5
    //   489: aload 5
    //   491: ldc 207
    //   493: ldc 201
    ...
    //   498: aload 7
    //   500: getfield 151	com/tencent/turingfd/sdk/xq/extends:kg	Ljava/net/HttpURLConnection;
    //   503: iconst_0
    //   504: invokevirtual 210	java/net/HttpURLConnection:setInstanceFollowRedirects	(Z)V
    //   507: aload 7
    //   509: getfield 151	com/tencent/turingfd/sdk/xq/extends:kg	Ljava/net/HttpURLConnection;
    //   512: astore 5
    //   514: aload 5
    //   516: ldc 212
    //   518: ldc 214
    ...
    //   523: aload 7
    //   525: getfield 151	com/tencent/turingfd/sdk/xq/extends:kg	Ljava/net/HttpURLConnection;
    //   528: astore 5
    //   530: aload 5
    //   532: ldc 216
    //   534: ldc 218
    ...
    //   539: aload 7
    //   541: getfield 151	com/tencent/turingfd/sdk/xq/extends:kg	Ljava/net/HttpURLConnection;
    //   544: astore 5
    //   546: aload 5
    //   548: ldc 220
    //   550: ldc 222
    ...
    //   555: aload 7
    //   557: getfield 151	com/tencent/turingfd/sdk/xq/extends:kg	Ljava/net/HttpURLConnection;
    //   560: astore 5
    //   562: aload 5
    //   564: ldc 224
    //   566: ldc 226
    ...
    //   571: aload 7
    //   573: getfield 151	com/tencent/turingfd/sdk/xq/extends:kg	Ljava/net/HttpURLConnection;
    //   576: astore 5
    ...
    //   628: aload 7
    //   630: getfield 151	com/tencent/turingfd/sdk/xq/extends:kg	Ljava/net/HttpURLConnection;
    //   633: astore 5
    //   635: aload 5
    //   637: ldc 252
    //   639: ldc 254
    ...
    //   644: aload 7
    //   646: getfield 151	com/tencent/turingfd/sdk/xq/extends:kg	Ljava/net/HttpURLConnection;
    ...
    //   670: aload 7
    //   672: getfield 151	com/tencent/turingfd/sdk/xq/extends:kg	Ljava/net/HttpURLConnection;
    ...
    //   686: aload 7
    //   688: iconst_1
    //   689: putfield 182	com/tencent/turingfd/sdk/xq/extends:lg	Z
    //   692: iconst_0
    //   693: istore_3
    //   694: goto +328 -> 1022
    //   697: iload_3
    ...
    //   699: iload 4
    //   701: ifeq +123 -> 824
    //   704: invokestatic 170	com/tencent/turingfd/sdk/xq/Damson:getInstance	()Lcom/tencent/turingfd/sdk/xq/Damson;
    //   707: astore 5
    //   709: aload 7
    //   711: getfield 151	com/tencent/turingfd/sdk/xq/extends:kg	Ljava/net/HttpURLConnection;
    //   714: astore_2
    //   715: aload_2
    //   716: ldc_w 274
    ...
    //   725: ldc_w 280
    //   728: aload_2
    //   729: invokevirtual 283	com/tencent/turingfd/sdk/xq/Damson:f	(Ljava/lang/String;Ljava/lang/String;)V
    //   732: iload_3
    //   733: istore_1
    //   734: goto +90 -> 824
    //   737: astore_2
    ...
    //   753: istore_1
    //   754: ldc_w 286
    //   757: invokestatic 291	com/tencent/turingfd/sdk/xq/do:b	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   760: astore 5
    //   762: aload 5
    //   764: aload_2
    ...
    //   829: iconst_0
    //   830: newarray byte
    //   832: invokestatic 308	com/tencent/turingfd/sdk/xq/long$do:a	(I[B)Lcom/tencent/turingfd/sdk/xq/long$do;
    //   835: areturn
    ...
    //   843: astore 5
    //   845: aload 7
    //   847: getfield 151	com/tencent/turingfd/sdk/xq/extends:kg	Ljava/net/HttpURLConnection;
    //   850: astore_2
    //   851: sipush -4000
    //   854: istore_1
    //   855: iload_1
    ...
    //   858: ifnull +109 -> 967
    //   861: aload 7
    //   863: getfield 182	com/tencent/turingfd/sdk/xq/extends:lg	Z
    //   866: ifne +8 -> 874
    //   869: iload_1
    //   870: istore_3
    //   871: goto +96 -> 967
    ...
    //   943: aload 7
    //   945: getfield 151	com/tencent/turingfd/sdk/xq/extends:kg	Ljava/net/HttpURLConnection;
    //   948: astore_2
    //   949: iload_1
    //   950: istore_3
    //   951: aload_2
    ...
    //   959: aload 7
    //   961: aconst_null
    //   962: putfield 151	com/tencent/turingfd/sdk/xq/extends:kg	Ljava/net/HttpURLConnection;
    //   965: iload_1
    //   966: istore_3
    //   967: iload_3
    //   968: ifeq +11 -> 979
    ...
    //   972: iconst_0
    //   973: newarray byte
    //   975: invokestatic 308	com/tencent/turingfd/sdk/xq/long$do:a	(I[B)Lcom/tencent/turingfd/sdk/xq/long$do;
    //   978: areturn
    //   979: iload_3
    //   980: aload 5
    //   982: invokevirtual 339	java/util/concurrent/atomic/AtomicReference:get	()Ljava/lang/Object;
    //   985: checkcast 341	[B
    //   988: invokestatic 308	com/tencent/turingfd/sdk/xq/long$do:a	(I[B)Lcom/tencent/turingfd/sdk/xq/long$do;
    //   991: areturn
    //   992: astore 5
    //   994: goto -350 -> 644
    //   997: astore_2
