  ...
  implements Fig
{
  ...
  public final int a(Context paramContext, AtomicReference<IBinder> paramAtomicReference, AtomicReference<ServiceConnection> paramAtomicReference1)
  {
    ...
    Object localObject2 = (Guava)this;
    localObject2 = new Intent(final.get(final.Yd));
    ((Intent)localObject2).setComponent(new ComponentName(final.get(final.Ud), final.get(final.Vd)));
    if (!paramContext.bindService((Intent)localObject2, new Ginkgo(this, paramAtomicReference, paramAtomicReference1, localObject1), 1)) {
      return -100;
    }
  ...
  public final int a(Context paramContext, AtomicReference<IBinder> paramAtomicReference, AtomicReference<ServiceConnection> paramAtomicReference1, AtomicReference<String> paramAtomicReference2)
  {
    ...
    new Gooseberry(this, paramAtomicReference, localAtomicReference, paramAtomicReference2, paramContext, paramAtomicReference1, localObject).start();
    try
    {
      try
      {
  ...
  public final Foxnut a(Context paramContext)
  {
    ...
    i = -1;
    return new Foxnut((String)localAtomicReference1.get(), i);
  }
  ...
  {
    Foxnut localFoxnut = this.a;
    if ((localFoxnut == null) || (localFoxnut.a != 0)) {
      this.a = a(paramContext);
    }
    return this.a;
  }
 ...
 * Qualified Name:     com.tencent.turingfd.sdk.xq.Grape
