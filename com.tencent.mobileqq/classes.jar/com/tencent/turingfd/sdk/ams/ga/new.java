...
public class new
{
  public ByteBuffer k = ByteBuffer.allocate(128);
  public String l = "GBK";
  ...
  public void b(String paramString, int paramInt)
  {
    ...
    {
      b((byte)7, paramInt);
      this.k.putInt(paramString.length);
      this.k.put(paramString);
      return;
    }
    b((byte)6, paramInt);
    this.k.put((byte)paramString.length);
    this.k.put(paramString);
  }
  
  public void c(int paramInt)
  {
    if (this.k.remaining() < paramInt)
    {
      ByteBuffer localByteBuffer = ByteBuffer.allocate((this.k.capacity() + paramInt) * 2);
      localByteBuffer.put(this.k.array(), 0, this.k.position());
 ...
 * Qualified Name:     com.tencent.turingfd.sdk.ams.ga.new
