...
public final class int
{
  ...
  {
    this.k = ByteBuffer.wrap(paramArrayOfByte);
  }
        ...
        if (i != 12)
        {
          if (i != 0)
          {
            if (i != 1)
            {
              ...
              paramInt = this.k.getInt();
            }
            else
            {
              paramInt = this.k.getShort();
            }
          }
          else {
            paramInt = this.k.get();
    ...
    if (b(paramInt))
    {
      ...
      if (i != 6)
      {
        ...
        if ((paramInt <= 104857600) && (paramInt >= 0))
        {
          ...
          this.k.get((byte[])localObject);
        }
      }
    }
    try
    {
      str = new String((byte[])localObject, this.l);
      return str;
    }
  ...
  public boolean b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ByteBuffer localByteBuffer = this.k.duplicate();
 ...
 * Qualified Name:     com.tencent.turingfd.sdk.ams.ga.int
