...
public class VsEncryptUtil
{
  ...
  public static byte[] VsDecrypt_SDCARD(byte[] paramArrayOfByte)
  {
    try
    {
  ...
  public static byte[] VsEncrypt_APPLOCAL(byte[] paramArrayOfByte)
  {
    try
    {
  ...
  public static byte[] VsEncrypt_SDCARD(byte[] paramArrayOfByte)
  {
    try
    {
