...
public final class EnterRsp
  extends ExtendableMessageNano<EnterRsp>
{
  public int a;
  public String b;
  public RoomInfo c;
  ...
  public static EnterRsp a(byte[] paramArrayOfByte)
  {
  ...
  public EnterRsp a(CodedInputByteBufferNano paramCodedInputByteBufferNano)
  {
    for (;;)
    {
            ...
            if (i != 34)
            {
              if (i != 42)
              {
                ...
                else
                {
                  ...
                  if (i != 0)
                  {
                    System.arraycopy(this.g, 0, arrayOfTlv, 0, i);
                    j = i;
                  }
 ...
 * Qualified Name:     com.tencent.qqlive.protobuf.iliveRoomPlay.nano.EnterRsp
