...
public final class BatchStreamQuery
  extends ExtendableMessageNano<BatchStreamQuery>
{
  private static volatile BatchStreamQuery[] c;
  public long a;
  public long b;
  
  public BatchStreamQuery()
  {
    b();
  }
  
  public static BatchStreamQuery[] a()
  {
    if (c == null) {
      synchronized (InternalNano.LAZY_INIT_LOCK)
      {
        if (c == null) {
          c = new BatchStreamQuery[0];
        }
      }
    }
    return c;
  ...
  public BatchStreamQuery a(CodedInputByteBufferNano paramCodedInputByteBufferNano)
  {
    for (;;)
    {
 ...
 * Qualified Name:     com.tencent.qqlive.protobuf.iliveStreamControl.nano.BatchStreamQuery
