...
public final class GetAnchorGearListRsp
  extends ExtendableMessageNano<GetAnchorGearListRsp>
{
  public int a;
  public String b;
  public int c;
  ...
  public GetAnchorGearListRsp()
  {
    a();
  }
  
  public GetAnchorGearListRsp a()
  {
    this.a = 0;
    this.b = "";
    this.c = 0;
  ...
  public GetAnchorGearListRsp a(CodedInputByteBufferNano paramCodedInputByteBufferNano)
  {
    for (;;)
    {
        ...
        if (i != 18)
        {
          if (i != 24)
          {
            ...
            else
            {
              ...
              GearInfo[] arrayOfGearInfo = this.d;
              ...
              if (i != 0)
              {
                System.arraycopy(this.d, 0, arrayOfGearInfo, 0, i);
                j = i;
              }
 ...
 * Qualified Name:     com.tencent.qqlive.protobuf.iliveStreamControl.nano.GetAnchorGearListRsp
