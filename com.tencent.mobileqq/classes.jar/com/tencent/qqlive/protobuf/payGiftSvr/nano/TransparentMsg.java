...
public final class TransparentMsg
  extends ExtendableMessageNano<TransparentMsg>
{
  private static volatile TransparentMsg[] c;
  public int a;
  public byte[] b;
  ...
  public static TransparentMsg[] a()
  {
    if (c == null) {
      synchronized (InternalNano.LAZY_INIT_LOCK)
      {
        if (c == null) {
          c = new TransparentMsg[0];
        }
      }
    }
    return c;
  ...
  public TransparentMsg a(CodedInputByteBufferNano paramCodedInputByteBufferNano)
  {
    for (;;)
    {
 ...
 * Qualified Name:     com.tencent.qqlive.protobuf.payGiftSvr.nano.TransparentMsg
