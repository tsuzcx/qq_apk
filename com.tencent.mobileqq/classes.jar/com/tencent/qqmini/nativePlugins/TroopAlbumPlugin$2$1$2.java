  ...
  implements DialogInterface.OnClickListener
{
  ...
  public void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    ...
    String str = TroopAlbumPlugin.i(this.a.a.b).getAttachedActivity().getResources().getString(2131914660);
    ...
    QzonePluginProxyActivity.launchPluingActivityForResult(TroopAlbumPlugin.j(this.a.a.b).getAttachedActivity(), paramDialogInterface, localIntent, 4);
  }
}
