...
class NativeAppBrandRuntime$2$7
  implements NativeAppBrandRuntime.TissueEventHandler
{
  NativeAppBrandRuntime$2$7(NativeAppBrandRuntime.2 param2) {}
  ...
  public void on(Map paramMap, BasicMessageChannel.Reply paramReply)
  {
    ...
    for (paramMap = (Map)paramMap.get("query");; paramMap = null)
    {
      ...
      NativeAppBrandRuntime.access$600(this.this$1.this$0).onAppRoute(str1, paramMap.getFullUrl(), paramReply.intValue());
      return;
    }
  }
}
