...
class MapViewJsPlugin$12
  implements Runnable
{
  MapViewJsPlugin$12(MapViewJsPlugin paramMapViewJsPlugin, RequestEvent paramRequestEvent) {}
  ...
  public void run()
  {
    try
    {
      ...
      if (localObject != null)
      {
        ((MapContext)localObject).addMapMarkers(localJSONObject);
        this.val$req.ok();
        return;
      }
      this.val$req.fail();
 ...
 * Qualified Name:     com.tencent.qqmini.map.MapViewJsPlugin.12
