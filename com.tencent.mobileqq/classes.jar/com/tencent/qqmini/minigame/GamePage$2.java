...
class GamePage$2
  implements Runnable
{
  GamePage$2(GamePage paramGamePage, MiniAppInfo paramMiniAppInfo, Activity paramActivity) {}
  ...
  public void run()
  {
    try
    {
      ...
      if (localObject1 != null)
      {
        ...
        Object localObject2 = RoundedBitmapDrawableFactory.create(GamePage.access$400(this.this$0).getResources(), (Bitmap)localObject1);
        ...
        if (Build.VERSION.SDK_INT >= 21)
        {
          ...
          GamePage.access$400(this.this$0).setTaskDescription((ActivityManager.TaskDescription)localObject2);
        }
