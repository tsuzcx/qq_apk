...
public class WebAudioManager
{
  ...
  private static ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(DeviceUtil.getCpuNumber(), DeviceUtil.getCpuNumber() + 5, 200L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue());
  ...
  private void startTimer(RequestEvent paramRequestEvent, int paramInt1, int paramInt2)
  {
    if (this.mAudioNativeManager == null) {
      return;
    }
    paramRequestEvent = new WebAudioManager.3(this, paramInt1, paramInt2, paramRequestEvent);
    ThreadManager.getSubThreadHandler().post(paramRequestEvent);
  }
  ...
  public void createScriptProcessor(RequestEvent paramRequestEvent, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if (this.mAudioNativeManager == null) {
      return;
    }
  ...
  @RequiresApi(api=16)
  public void decodeAudioDataAndReturnBufferIdAsync(int paramInt, byte[] paramArrayOfByte, RequestEvent paramRequestEvent)
  {
    if (this.mAudioNativeManager == null) {
      return;
    }
    threadPoolExecutor.execute(new WebAudioManager.5(this, paramInt, paramRequestEvent, paramArrayOfByte));
  }
  ...
  public JSONObject sourceStart(RequestEvent paramRequestEvent, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    if (this.mAudioNativeManager == null) {
      return null;
    }
    ...
    if (l1 > 0L)
    {
      ThreadManager.getSubThreadHandler().postDelayed(new WebAudioManager.1(this, paramInt2, paramInt4, paramRequestEvent, paramInt1), l1);
      if (l1 <= 0L) {
        break label161;
      }
    }
    ...
    for (l1 = paramInt3 * 1000;; l1 = l2)
    {
      ...
      startTimer(paramRequestEvent, paramInt2, paramInt1);
      break;
    }
  }
  ...
  public void startAudioProcess(RequestEvent paramRequestEvent, int paramInt)
  {
    if (this.mAudioNativeManager == null) {
      return;
    }
    paramRequestEvent = new WebAudioManager.6(this, paramRequestEvent, ((Integer)this.scriptProcessNodeSizeMap.get(Integer.valueOf(paramInt))).intValue() * 2 * 60 / 44100);
    ThreadManager.getSubThreadHandler().post(paramRequestEvent);
  }
 ...
 * Qualified Name:     com.tencent.qqmini.minigame.webaudio.WebAudioManager
