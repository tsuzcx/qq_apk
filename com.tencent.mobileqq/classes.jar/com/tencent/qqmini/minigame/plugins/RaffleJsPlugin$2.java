  ...
  public void onReceiveResult(boolean paramBoolean, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        QMLog.d(RaffleJsPlugin.access$200(), "doGameRaffle result: " + paramJSONObject.toString());
        ...
        default: 
          ...
          if (!paramBoolean)
          {
            ...
            RaffleJsPlugin.access$400(this.this$0, this.val$context, this.val$context.getResources().getString(R.string.mini_sdk_game_raffle_fail));
