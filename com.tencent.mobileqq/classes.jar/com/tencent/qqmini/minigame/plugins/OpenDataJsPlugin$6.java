...
class OpenDataJsPlugin$6
  implements Runnable
{
  OpenDataJsPlugin$6(OpenDataJsPlugin paramOpenDataJsPlugin, String paramString1, String paramString2, String paramString3, DialogInterface.OnClickListener paramOnClickListener1, Boolean paramBoolean, String paramString4, DialogInterface.OnClickListener paramOnClickListener2, DialogInterface.OnCancelListener paramOnCancelListener) {}
  
  public void run()
  {
    if ((OpenDataJsPlugin.access$400(this.this$0).getAttachedActivity() != null) && (!OpenDataJsPlugin.access$500(this.this$0).getAttachedActivity().isFinishing())) {
      try
      {
        MiniCustomDialog localMiniCustomDialog = new MiniCustomDialog(OpenDataJsPlugin.access$600(this.this$0).getAttachedActivity(), R.style.mini_sdk_MiniAppInputDialog);
