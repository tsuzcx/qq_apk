  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    else
    {
      ...
      RaffleJsPlugin.access$2002(localRaffleJsPlugin, localAdProxy.createRewardVideoAdView(this.a, RaffleJsPlugin.access$2100(localRaffleJsPlugin), RaffleJsPlugin.access$2200(this.this$0), new RaffleJsPlugin.10.1(this), this.b, RaffleJsPlugin.access$3300(this.this$0)));
      i = j;
    }
    try
    {
      ...
      {
        RaffleJsPlugin.access$2000(this.this$0).loadAD(this.a);
        i = 0;
      }
    }
