  ...
  implements GameActivityStatusWatcher.OnWatcherActionListener
{
  ...
  public void onHomePressed()
  {
    ...
    AppStateEvent.obtain(2053, GameStopType.HOME_PRESS).notifyRuntime(this.this$0.getRuntime());
  }
  
  public void onRecentTaskPressed()
  {
    QMLog.e("minisdk-start_UIProxy", "rencent task to front!");
    AppStateEvent.obtain(2053, GameStopType.RECENT_PRESS).notifyRuntime(this.this$0.getRuntime());
  }
  
  public void onScreenOff()
  {
    QMLog.e("minisdk-start_UIProxy", "screen off");
    AppStateEvent.obtain(2053, GameStopType.SCREEN_OFF).notifyRuntime(this.this$0.getRuntime());
  }
