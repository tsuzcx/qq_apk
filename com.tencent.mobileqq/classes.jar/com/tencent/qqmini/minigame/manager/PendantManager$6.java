    ...
    if (paramInt1 == 11007)
    {
      ...
      if ((paramInt2 == -1) && (localObject1 != null) && (((Bundle)localObject1).get("allCloseState") != null))
      {
        ...
        if (bool1)
        {
          ...
          localObject1 = this.jdField_a_of_type_ComTencentQqminiMinigameWidgetDragImageView;
          if (localObject1 != null) {
            PendantManager.showNewPendantIcon(this.jdField_a_of_type_ComTencentQqminiSdkLauncherCoreModelPendantAdInfo, (DragImageView)localObject1, this.jdField_a_of_type_AndroidAppActivity);
          }
          if (!bool2) {
            paramIntent = "4";
          }
