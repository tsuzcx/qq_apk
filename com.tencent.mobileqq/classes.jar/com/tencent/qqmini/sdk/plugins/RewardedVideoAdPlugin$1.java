  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    RewardedVideoAdPlugin.access$102(this.this$0, localAdProxy.createRewardVideoAdView(this.val$context, this.val$appid, this.val$posId, new RewardedVideoAdPlugin.1.1(this), this.val$ext, RewardedVideoAdPlugin.access$1500(this.this$0)));
    try
    {
