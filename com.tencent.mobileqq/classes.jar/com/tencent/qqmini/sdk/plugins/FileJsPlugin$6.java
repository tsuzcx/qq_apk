  ...
  implements FileJsPlugin.FileTask
{
  ...
  public String run()
  {
    ...
    Object localObject = ((MiniAppFileManager)FileJsPlugin.access$1700(this.this$0).getManager(MiniAppFileManager.class)).getAbsolutePath(this.val$tempFilePath);
    ...
    if (TextUtils.isEmpty(this.val$filePath))
    {
      ...
      if (!((MiniAppFileManager)FileJsPlugin.access$2200(this.this$0).getManager(MiniAppFileManager.class)).isFolderCanWrite(1, l2 - l3, FileJsPlugin.access$1900(this.this$0), FileJsPlugin.access$2000(this.this$0), FileJsPlugin.access$2100(this.this$0).getAttachedActivity()))
      {
        FileJsPlugin.access$900(this.this$0, this.val$req.event, false, this.val$startMS, l1, (String)localObject);
        return FileJsPlugin.access$1000(this.this$0, this.val$req, null, "the maximum size of the file storage is exceeded");
      }
      str = ((MiniAppFileManager)FileJsPlugin.access$2300(this.this$0).getManager(MiniAppFileManager.class)).savePath(this.val$tempFilePath);
      if (!TextUtils.isEmpty(str))
      {
        FileJsPlugin.access$2400(this.this$0).updateFolderSize(1, l2 - l3);
        localObject = new JSONObject();
        try
        {
          ((JSONObject)localObject).put("savedFilePath", str);
          FileJsPlugin.access$900(this.this$0, this.val$req.event, true, this.val$startMS, l1, str);
          return FileJsPlugin.access$1100(this.this$0, this.val$req, (JSONObject)localObject);
        }
      ...
      FileJsPlugin.access$900(this.this$0, this.val$req.event, false, this.val$startMS, l1, str);
    ...
    String str = FileJsPlugin.access$2400(this.this$0).getUsrPath(this.val$filePath);
    long l3 = FileUtils.getFileSizes(str);
    if (!((MiniAppFileManager)FileJsPlugin.access$2900(this.this$0).getManager(MiniAppFileManager.class)).isFolderCanWrite(2, l2 - l3, FileJsPlugin.access$2600(this.this$0), FileJsPlugin.access$2700(this.this$0), FileJsPlugin.access$2800(this.this$0).getAttachedActivity()))
    {
      FileJsPlugin.access$900(this.this$0, this.val$req.event, false, this.val$startMS, l1, this.val$filePath);
      return FileJsPlugin.access$1000(this.this$0, this.val$req, null, "the maximum size of the file storage is exceeded");
    }
    FileUtils.copyFile((String)localObject, str);
    FileJsPlugin.access$2400(this.this$0).updateFolderSize(2, l2 - l3);
    localObject = new JSONObject();
    try
    {
