  ...
  implements FileJsPlugin.FileTask
{
  ...
  public String run()
  {
    ...
    if (((MiniAppFileManager)FileJsPlugin.access$1500(this.this$0).getManager(MiniAppFileManager.class)).getWxFileType(this.val$filePath) != 2)
    {
      FileJsPlugin.access$1100(this.this$0, this.val$req.event, false, this.val$startMs, l, this.val$filePath);
      return FileJsPlugin.access$1200(this.this$0, this.val$req, null, "permission denied, open " + this.val$filePath);
    }
    String str1 = ((MiniAppFileManager)FileJsPlugin.access$1600(this.this$0).getManager(MiniAppFileManager.class)).getUsrPath(this.val$filePath);
    if (!TextUtils.isEmpty(str1))
    {
      if (str1.contains("miniprogramLog"))
      {
        MiniLog.writeMiniLog(FileJsPlugin.access$1700(this.this$0).appId, this.val$data);
        FileJsPlugin.access$1100(this.this$0, this.val$req.event, true, this.val$startMs, l, str1);
        return FileJsPlugin.access$1300(this.this$0, this.val$req, null);
      }
      try
      {
        if (FileJsPlugin.access$1800(this.this$0, this.val$nativeBufferBytes, this.val$data, this.val$encoding, str1, true))
        {
          FileJsPlugin.access$1100(this.this$0, this.val$req.event, true, this.val$startMs, l, str1);
          String str2 = FileJsPlugin.access$1300(this.this$0, this.val$req, null);
          return str2;
        }
      }
      catch (IOException localIOException)
      {
        FileJsPlugin.access$1100(this.this$0, this.val$req.event, false, this.val$startMs, l, str1);
