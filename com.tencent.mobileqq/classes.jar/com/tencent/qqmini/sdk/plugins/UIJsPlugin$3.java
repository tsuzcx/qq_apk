  ...
  implements Runnable
{
  ...
  public void run()
  {
    if ((UIJsPlugin.access$600(this.this$0) != null) && (UIJsPlugin.access$600(this.this$0).shown()))
    {
      if (UIJsPlugin.access$600(this.this$0) != null) {
        UIJsPlugin.access$600(this.this$0).hide();
      }
      this.val$req.ok();
      return;
    }
