...
class PayJsPlugin$13$1
  implements PayProxy.IPayResultCallBack
{
  PayJsPlugin$13$1(PayJsPlugin.13 param13) {}
    ...
    try
    {
      ...
      catch (JSONException localJSONException2)
      {
        for (;;)
        {
          ...
          if (this.this$1.val$toolConsume)
          {
            this.this$1.this$0.invokeMidasQuery(str1, str2, i, m, new PayJsPlugin.13.1.1(this, str2, str1, i, j, k, n, m));
          }
          else
          {
 ...
 * Qualified Name:     com.tencent.qqmini.sdk.plugins.PayJsPlugin.13.1
