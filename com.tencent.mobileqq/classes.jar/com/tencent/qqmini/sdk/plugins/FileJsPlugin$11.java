  ...
  implements FileJsPlugin.FileTask
{
  ...
  public String run()
  {
    ...
    {
      FileJsPlugin.access$900(this.this$0, this.val$req.event, false, this.val$startMS, l1, this.val$oldPath);
      return FileJsPlugin.access$1000(this.this$0, this.val$req, null, "permission denied, open " + this.val$oldPath);
    }
    if (j != 2)
    {
      FileJsPlugin.access$900(this.this$0, this.val$req.event, false, this.val$startMS, l1, this.val$newPath);
      return FileJsPlugin.access$1000(this.this$0, this.val$req, null, "permission denied, open " + this.val$newPath);
    }
    String str1 = ((MiniAppFileManager)FileJsPlugin.access$4900(this.this$0).getManager(MiniAppFileManager.class)).getAbsolutePath(this.val$oldPath);
    String str2 = ((MiniAppFileManager)FileJsPlugin.access$5000(this.this$0).getManager(MiniAppFileManager.class)).getUsrPath(this.val$newPath);
    if (!new File(str1).exists())
    {
      FileJsPlugin.access$900(this.this$0, this.val$req.event, false, this.val$startMS, l1, str1);
      return FileJsPlugin.access$1000(this.this$0, this.val$req, null, "no such file or directory, open " + this.val$oldPath);
    }
    if (FileUtils.renameFile(str1, str2))
    {
      ...
      FileJsPlugin.access$900(this.this$0, this.val$req.event, true, this.val$startMS, l1, str1);
