  ...
  implements FileJsPlugin.FileTask
{
  ...
  public String run()
  {
    ...
    if ((((MiniAppFileManager)FileJsPlugin.access$3000(this.this$0).getManager(MiniAppFileManager.class)).getWxFileType(this.val$srcPath) == 9999) && (!((MiniAppFileManager)FileJsPlugin.access$3100(this.this$0).getManager(MiniAppFileManager.class)).isPackageRelativePath(this.val$srcPath)))
    {
      ...
      return FileJsPlugin.access$1000(this.this$0, this.val$req, null, "permission denied, open " + this.val$srcPath);
    }
    ...
    String str1 = ((MiniAppFileManager)FileJsPlugin.access$3300(this.this$0).getManager(MiniAppFileManager.class)).getAbsolutePath(this.val$srcPath);
    String str2 = ((MiniAppFileManager)FileJsPlugin.access$3400(this.this$0).getManager(MiniAppFileManager.class)).getUsrPath(this.val$destPath);
    ...
    if ((!TextUtils.isEmpty(str1)) && (!TextUtils.isEmpty(str2)))
    {
      ...
      FileJsPlugin.access$900(this.this$0, this.val$req.event, bool, this.val$startMS, l1, str1);
      if (bool)
      {
