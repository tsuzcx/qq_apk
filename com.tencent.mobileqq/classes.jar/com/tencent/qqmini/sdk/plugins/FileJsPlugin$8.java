  ...
  implements FileJsPlugin.FileTask
{
  ...
  public String run()
  {
    ...
    if (((MiniAppFileManager)FileJsPlugin.access$4100(this.this$0).getManager(MiniAppFileManager.class)).getWxFileType(this.val$dirPath) == 2)
    {
      String str = ((MiniAppFileManager)FileJsPlugin.access$4200(this.this$0).getManager(MiniAppFileManager.class)).getAbsolutePath(this.val$dirPath);
      if (!TextUtils.isEmpty(str))
      {
        FileJsPlugin.access$1100(this.this$0, this.val$req.event, false, this.val$startMS, l, str);
        return FileJsPlugin.access$1200(this.this$0, this.val$req, null, "file already exists " + this.val$dirPath);
      }
      str = ((MiniAppFileManager)FileJsPlugin.access$4300(this.this$0).getManager(MiniAppFileManager.class)).getUsrPath(this.val$dirPath);
