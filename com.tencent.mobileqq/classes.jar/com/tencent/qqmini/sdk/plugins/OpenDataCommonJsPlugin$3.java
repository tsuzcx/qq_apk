  ...
  implements AsyncResult
{
  ...
  {
    StringBuilder localStringBuilder = new StringBuilder().append("getFriendCloudStorage callback appid:").append(OpenDataCommonJsPlugin.access$200(this.this$0).appId).append(", isSuc:").append(paramBoolean).append(", ret:");
    Object localObject;
    ...
    for (;;)
    {
      QMLog.i("OpenDataCommonJsPlugin", (String)localObject);
      ...
      if (paramBoolean) {
        ...
        {
          QMLog.e("OpenDataCommonJsPlugin", "getFriendCloudStorage error " + paramJSONObject.getMessage());
          this.val$req.fail();
          return;
        }
      }
