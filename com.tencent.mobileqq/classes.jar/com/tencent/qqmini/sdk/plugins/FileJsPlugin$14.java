  ...
  implements FileJsPlugin.FileTask
{
  ...
  public String run()
  {
    ...
    if (i == 9999)
    {
      ...
      return FileJsPlugin.access$1000(this.this$0, this.val$req, null, "invalid path" + this.val$filePath);
    }
    String str = ((MiniAppFileManager)FileJsPlugin.access$5800(this.this$0).getManager(MiniAppFileManager.class)).getAbsolutePath(this.val$filePath);
    ...
    if (new File(str).isDirectory())
    {
      ...
      return FileJsPlugin.access$1000(this.this$0, this.val$req, null, "operation not permitted, unlink " + this.val$filePath);
    }
