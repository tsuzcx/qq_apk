...
public final class AppJsPluginScope
{
  ...
  static
  {
    ...
    EVENT_HANDLERS.put("insertXWebExternalElement", ExternalElementJsPlugin.class);
    EVENT_HANDLERS.put("updateXWebExternalElement", ExternalElementJsPlugin.class);
    EVENT_HANDLERS.put("operateXWebExternalElement", ExternalElementJsPlugin.class);
    EVENT_HANDLERS.put("removeXWebExternalElement", ExternalElementJsPlugin.class);
    EVENT_HANDLERS.put("getSystemInfo", SystemInfoPlugin.class);
    EVENT_HANDLERS.put("getSystemInfoSync", SystemInfoPlugin.class);
    EVENT_HANDLERS.put("detectAbnormalLog", SystemInfoPlugin.class);
  }
}
