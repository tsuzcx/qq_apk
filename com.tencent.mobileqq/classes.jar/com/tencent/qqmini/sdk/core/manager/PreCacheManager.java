...
public class PreCacheManager
{
  ...
  private void doFetchPreCacheData(MiniAppInfo paramMiniAppInfo, String paramString, PreCacheManager.OnCacheListener paramOnCacheListener)
  {
    ...
    do
    {
      ...
      if ((!"periodic".equals(paramString)) || (!localPreCacheInfo.getDataUrl.equals(((PreCacheManager.PreCacheDescData)localObject).url)) || (System.currentTimeMillis() - ((PreCacheManager.PreCacheDescData)localObject).timeStamp >= this.PRECACHE_PERIOD_MILLIS)) {
        break;
      }
  ...
  public PreCacheManager.PreCacheDescData getPreFetchAppCacheData(MiniAppInfo paramMiniAppInfo, String paramString)
  {
    ...
    //   6: aload_1
    //   7: areturn
    //   8: new 140	com/tencent/qqmini/sdk/core/manager/PreCacheManager$PreCacheDescData
    //   11: dup
    //   12: aload_1
    //   13: aload_2
    //   14: invokespecial 391	com/tencent/qqmini/sdk/core/manager/PreCacheManager$PreCacheDescData:<init>	(Lcom/tencent/qqmini/sdk/launcher/model/MiniAppInfo;Ljava/lang/String;)V
    //   17: astore 5
    //   19: aload_1
    //   20: getfield 198	com/tencent/qqmini/sdk/launcher/model/MiniAppInfo:appId	Ljava/lang/String;
    //   23: aload_2
    //   24: new 100	java/lang/StringBuilder
    //   27: dup
    //   28: invokespecial 101	java/lang/StringBuilder:<init>	()V
    //   31: aload 5
    //   33: aload_2
    //   34: invokevirtual 269	com/tencent/qqmini/sdk/core/manager/PreCacheManager$PreCacheDescData:getCacheKey	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   49: invokestatic 275	com/tencent/qqmini/sdk/core/manager/MiniAppFileManager:getPreCacheFilePath	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   52: astore_1
    //   53: ldc 140
    //   55: aload_1
    //   56: invokestatic 399	com/tencent/qqmini/sdk/core/utils/ParcelableUtil:readParcelableFromFile	(Ljava/lang/Class;Ljava/lang/String;)Landroid/os/Parcelable;
    //   59: checkcast 140	com/tencent/qqmini/sdk/core/manager/PreCacheManager$PreCacheDescData
    //   62: astore_2
    //   63: aload_2
    //   64: ifnull +175 -> 239
    //   67: aload_2
    //   68: getfield 402	com/tencent/qqmini/sdk/core/manager/PreCacheManager$PreCacheDescData:filePath	Ljava/lang/String;
    //   71: ifnull +168 -> 239
    //   74: new 344	java/io/File
    //   77: dup
    //   78: aload_2
    //   79: getfield 402	com/tencent/qqmini/sdk/core/manager/PreCacheManager$PreCacheDescData:filePath	Ljava/lang/String;
    //   82: invokespecial 347	java/io/File:<init>	(Ljava/lang/String;)V
    //   85: astore_1
    //   86: aload_1
    //   87: invokevirtual 350	java/io/File:exists	()Z
    //   90: istore 4
    //   92: iload 4
    //   94: ifne +46 -> 140
    //   97: iconst_0
    //   98: ifeq +11 -> 109
    //   101: new 404	java/lang/NullPointerException
    //   104: dup
    //   105: invokespecial 405	java/lang/NullPointerException:<init>	()V
    //   108: athrow
    //   109: aconst_null
    //   110: areturn
    //   111: astore_1
    ...
    //   114: ldc_w 293
    //   117: aload_1
    //   118: invokestatic 407	com/tencent/qqmini/sdk/launcher/log/QMLog:i	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   121: aload 5
    //   123: astore_2
    //   124: goto -61 -> 63
    //   127: astore_1
    ...
    //   130: ldc_w 293
    //   133: aload_1
    //   134: invokestatic 322	com/tencent/qqmini/sdk/launcher/log/QMLog:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   137: goto -28 -> 109
    //   140: new 409	java/io/FileInputStream
    //   143: dup
    //   144: aload_1
    //   145: invokespecial 412	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   148: astore 5
    //   150: aload 5
    //   152: astore_1
    //   153: aload 5
    //   155: invokevirtual 415	java/io/FileInputStream:available	()I
    //   158: istore_3
    //   159: aload 5
    //   161: astore_1
    //   162: iload_3
    ...
    //   174: iconst_0
    //   175: iload_3
    //   176: invokevirtual 419	java/io/FileInputStream:read	([BII)I
    //   179: pop
    //   180: aload 5
    //   182: astore_1
    //   183: aload_2
    //   184: aload 6
    //   186: putfield 422	com/tencent/qqmini/sdk/core/manager/PreCacheManager$PreCacheDescData:data	[B
    //   189: aload_2
    //   190: astore_1
    //   191: aload 5
    //   193: ifnull -187 -> 6
    //   196: aload 5
    //   198: invokevirtual 425	java/io/FileInputStream:close	()V
    //   201: aload_2
    //   202: areturn
    //   203: astore_1
    //   204: ldc 17
    //   206: ldc_w 293
    //   209: aload_1
    //   210: invokestatic 322	com/tencent/qqmini/sdk/launcher/log/QMLog:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   213: aload_2
    //   214: areturn
    //   215: astore 6
    //   217: aconst_null
    ...
    //   223: ldc_w 293
    //   226: aload 6
    //   228: invokestatic 322	com/tencent/qqmini/sdk/launcher/log/QMLog:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   231: aload_2
    //   232: ifnull +7 -> 239
    //   235: aload_2
    //   236: invokevirtual 425	java/io/FileInputStream:close	()V
    //   239: aconst_null
    //   240: areturn
    //   241: astore_1
    //   242: ldc 17
    //   244: ldc_w 293
    //   247: aload_1
    //   248: invokestatic 322	com/tencent/qqmini/sdk/launcher/log/QMLog:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   251: goto -12 -> 239
    //   254: astore_2
    //   255: aconst_null
    //   256: astore_1
    ...
    //   258: ifnull +7 -> 265
    //   261: aload_1
    //   262: invokevirtual 425	java/io/FileInputStream:close	()V
    //   265: aload_2
    //   266: athrow
    //   267: astore_1
    //   268: ldc 17
    //   270: ldc_w 293
    //   273: aload_1
    //   274: invokestatic 322	com/tencent/qqmini/sdk/launcher/log/QMLog:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   277: goto -12 -> 265
    //   280: astore_2
    //   281: goto -24 -> 257
    //   284: astore 6
