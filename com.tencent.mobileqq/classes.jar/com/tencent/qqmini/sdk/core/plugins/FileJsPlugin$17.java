...
{
  FileJsPlugin$17(FileJsPlugin paramFileJsPlugin, String paramString1, byte[] paramArrayOfByte, bdfz parambdfz, String paramString2, String paramString3, long paramLong) {}
  ...
  public String run()
  {
    ...
    {
      if (((bdeu)localObject).a(2, l2, this.this$0.mIsMiniGame, l1)) {
        break label216;
      }
    ...
    label216:
    String str2 = bdeu.a().c(this.val$filePath);
    ...
    for (;;)
    {
      try
      {
        if (!FileJsPlugin.access$400(this.this$0, this.val$nativeBufferBytes, this.val$data, this.val$encoding, str2, false))
        {
          ...
          if (this.val$data != null)
          {
            ...
            bdnw.d("FileJsPlugin", localObject);
      ...
      bdnw.a("FileJsPlugin", "writeFile [minigame timecost:" + (System.currentTimeMillis() - this.val$startMS) + "ms], aboFilePath:" + str2);
 ...
 * Qualified Name:     com.tencent.qqmini.sdk.core.plugins.FileJsPlugin.17
