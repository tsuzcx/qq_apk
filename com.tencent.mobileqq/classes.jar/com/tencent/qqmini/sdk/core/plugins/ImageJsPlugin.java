  ...
  extends BaseJsPlugin
{
  ...
  private void callbackChooseImage(ArrayList<String> paramArrayList, bdfz parambdfz)
  {
    ...
    {
      callbackJsChooseImage(compressImages(paramArrayList), parambdfz);
      return;
    }
    callbackJsChooseImage(copyImages(paramArrayList), parambdfz);
  }
  
  private void callbackGetImageInfo(String paramString, bdfz parambdfz)
  {
    try
    {
      ...
      localJSONObject.put("path", bdeu.a().e(paramString));
      localJSONObject.put("type", bdgp.a(localOptions));
    ...
    catch (Exception paramString)
    {
      ...
      bdnw.d("ImageJsPlugin", "getimageinfo error,", paramString);
      parambdfz.b();
    }
  }
  
  private void callbackJsChooseImage(ArrayList<String> paramArrayList, bdfz parambdfz)
  {
    ...
    try
    {
      ...
      bdnw.a("ImageJsPlugin", "chooseImage photoArray=" + ((JSONArray)localObject1).toString() + ",fileArray=" + ((JSONArray)localObject2).toString());
    }
    catch (Exception paramArrayList)
    {
      this.mHasChoosePhoto = false;
      bdnw.d("ImageJsPlugin", paramArrayList.getMessage(), paramArrayList);
      parambdfz.b();
      return;
    }
  ...
  private String compressSingleImg(String paramString)
  {
    ...
    //   17: astore 4
    //   19: invokestatic 127	bdeu:a	()Lbdeu;
    //   22: ldc 255
    //   24: invokevirtual 257	bdeu:b	(Ljava/lang/String;)Ljava/lang/String;
    //   27: astore 11
    ...
    //   82: invokestatic 238	bdnw:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   85: aload 8
    //   87: astore 5
    //   89: aload 9
    //   91: astore_3
    ...
    //   144: astore_3
    //   145: aload_1
    //   146: invokestatic 268	bdgp:a	(Ljava/lang/String;)I
    //   149: istore_2
    //   150: aload 8
    //   152: astore 5
    //   154: aload 9
    ...
    //   179: invokestatic 238	bdnw:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   182: aload 10
    //   184: astore 6
    //   186: iload_2
    //   187: ifeq +30 -> 217
    ...
    //   197: iload_2
    //   198: aload 10
    //   200: invokestatic 276	bdgp:a	(ILandroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    //   203: astore 6
    //   205: aload 8
    //   207: astore 5
    //   209: aload 9
    ...
    //   295: invokestatic 238	bdnw:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   298: aload 4
    //   300: ifnull +8 -> 308
    //   303: aload 4
    ...
    //   323: aload 4
    //   325: invokestatic 162	bdnw:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   328: aload 5
    //   330: ifnull -323 -> 7
    //   333: aload 5
  ...
  private ArrayList<String> copyImages(ArrayList<String> paramArrayList)
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      String str = bdeu.a().h(paramArrayList);
  ...
  {
    return new File(bdeu.a().b("jpg"));
  }
  
  private void doCompressImage(String paramString, int paramInt, bdfz parambdfz)
  {
    try
    {
      Object localObject = bdgp.a(paramString);
      if (localObject != null)
      {
        ...
        paramString = bdeu.a().b(paramString.hashCode() + ".jpg");
        bdgp.a((Bitmap)localObject, new File(paramString));
        localObject = new JSONObject();
        ((JSONObject)localObject).put("tempFilePath", bdeu.a().e(paramString));
        parambdfz.a((JSONObject)localObject);
      }
      return;
    }
    catch (Exception paramString)
    {
      bdnw.d("ImageJsPlugin", "compressImage error,", paramString);
      parambdfz.b();
    }
  }
  ...
  private String getExifOrientation(String paramString)
  {
    ...
    catch (IOException paramString)
    {
      for (;;)
      {
        bdnw.d("ImageJsPlugin", "getExifOrientation error." + paramString);
        paramString = null;
      }
      return "up";
    }
  ...
  private void openCamera(bdfz parambdfz)
  {
    ...
    localIntent.putExtra("output", bdgo.a(this.mMiniAppContext.a(), localFile));
    this.mMiniAppContext.a().startActivityForResult(localIntent, 4);
    bdel.a().a(new ImageJsPlugin.3(this, parambdfz, localFile));
  }
  
  public void chooseImage(bdfz parambdfz)
  {
    int i = 9;
    int j = 1;
    for (;;)
    {
      ...
      {
        this.mHasChoosePhoto = false;
        localObject2 = new JSONObject(parambdfz.b);
      ...
      catch (Throwable localThrowable)
      {
        Object localObject2;
        Object localObject1;
        bdnw.d("ImageJsPlugin", parambdfz.a + " error,", localThrowable);
        parambdfz.b();
        return;
      }
      ...
      {
        bdgi.a(new ImageJsPlugin.1(this, parambdfz, i));
        return;
      }
      if ("camera".equals(((JSONArray)localObject2).optString(0)))
      {
        openCamera(parambdfz);
        return;
      }
      if (this.mMiniAppProxy.openChoosePhotoActivity(this.mMiniAppContext.a(), i, new ImageJsPlugin.2(this, parambdfz))) {
        break;
      }
      bdit.a(this.mMiniAppContext.a(), 0, "暂不支持在" + bdzd.a(this.mContext) + "中选择图片", 1);
      parambdfz.b();
      return;
      label269:
      do
  ...
  public void compressImage(bdfz parambdfz)
  {
    for (;;)
    {
      try
      {
        ...
        if (!TextUtils.isEmpty(str))
        {
          localObject1 = bdeu.a().a(str);
          if (!TextUtils.isEmpty((CharSequence)localObject1))
          {
            doCompressImage((String)localObject1, i, parambdfz);
            return;
          }
          parambdfz.b();
          return;
      ...
      {
        bdnw.d("ImageJsPlugin", parambdfz.a + " error", localException);
        parambdfz.b();
        return;
      }
  ...
  public void getImageInfo(bdfz parambdfz)
  {
    for (;;)
    {
      try
      {
        String str = new JSONObject(parambdfz.b).optString("src", "");
        if (!TextUtils.isEmpty(str))
        {
          str = bdeu.a().a(str);
          if (!TextUtils.isEmpty(str))
          {
            callbackGetImageInfo(str, parambdfz);
            return;
          }
          parambdfz.a("image path error.");
          return;
        }
      }
      catch (Exception localException)
  ...
  public void onCreate(bdcz parambdcz)
  {
    ...
    parambdcz.addAction("micro_api_choose_image");
    this.mMiniAppContext.a().registerReceiver(this.receiver, parambdcz);
  }
  ...
  {
    this.mCurRequestEvent = parambdfz;
    return super.onInterceptJsEvent(parambdfz);
  }
  
  public void previewImage(bdfz parambdfz)
  {
    int i = 0;
    try
    {
      ...
      while (i < ((JSONArray)localObject).length())
      {
        ...
        String str3 = bdeu.a().a(str2);
        localArrayList.add(str3);
        bdnw.a("ImageJsPlugin", "previewImage wxFilePath=" + str2 + ",localFilePath=" + str3);
        i += 1;
      }
      if ((localArrayList != null) && (!this.mMiniAppProxy.openImagePreview(this.mMiniAppContext.a(), j, localArrayList)))
      {
        bdit.a(this.mMiniAppContext.a(), 0, "暂不支持在" + bdzd.a(this.mContext) + "中预览图片", 1);
        parambdfz.b();
        return;
      }
      parambdfz.a();
  ...
  public void saveImageToPhotosAlbum(bdfz parambdfz)
  {
    try
    {
      String str = new JSONObject(parambdfz.b).optString("filePath", "");
      if (!TextUtils.isEmpty(str))
      {
        str = bdeu.a().a(str);
        Object localObject = new File(str);
        localObject = bdhb.a() + System.currentTimeMillis() / 1000L + "_" + ((File)localObject).getName();
        if (bdgo.a(this.mMiniAppContext.a(), str, (String)localObject))
        {
          parambdfz.a();
          return;
        }
        parambdfz.a("save failed.");
        return;
      }
    }
    catch (Exception localException)
