...
{
  InputJsPlugin$6(InputJsPlugin paramInputJsPlugin, EditText paramEditText, bdfz parambdfz, KeyboardLayout paramKeyboardLayout, Context paramContext) {}
  ...
  public boolean onEditorAction(TextView paramTextView, int paramInt, KeyEvent paramKeyEvent)
  {
    ...
    try
    {
      ...
      if ((this.val$context instanceof Activity)) {
        bdyn.a((Activity)this.val$context);
      }
    }
    catch (JSONException paramTextView)
    {
      for (;;)
      {
        bdnw.d("NetworkJsPlugin", "onEditorAction callback exception", paramTextView);
      }
    }
    return true;
  }
