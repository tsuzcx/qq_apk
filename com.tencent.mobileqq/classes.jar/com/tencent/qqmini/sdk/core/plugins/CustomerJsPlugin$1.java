...
{
  CustomerJsPlugin$1(CustomerJsPlugin paramCustomerJsPlugin, bdfz parambdfz) {}
  ...
  public void onReceiveResult(boolean paramBoolean, JSONObject paramJSONObject)
  {
    if ((paramBoolean) && (paramJSONObject != null))
    {
      ...
      if (((localObject instanceof String)) && (!TextUtils.isEmpty((String)localObject)))
      {
        ...
        {
          bdit.a(this.this$0.mContext, 0, "暂不支持在" + bdzd.a(this.this$0.mContext) + "中下载应用", 1);
    ...
    bdnw.d("CustomerJsPlugin", "getRobotUin failed: ");
    this.val$req.a("batchGetContact failed.");
  }
}
