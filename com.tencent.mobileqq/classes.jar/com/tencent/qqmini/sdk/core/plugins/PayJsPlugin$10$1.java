...
class PayJsPlugin$10$1
  implements PayProxy.IPayResultCallBack
{
  PayJsPlugin$10$1(PayJsPlugin.10 param10) {}
    ...
    try
    {
      ...
      catch (JSONException localJSONException2)
      {
        for (;;)
        {
          ...
          if (this.this$1.val$toolConsume)
          {
            this.this$1.this$0.invokeMidasQuery(str1, str2, i, m, new PayJsPlugin.10.1.1(this, str2, str1, i, j, k, n, m));
          }
          else
          {
 ...
 * Qualified Name:     com.tencent.qqmini.sdk.core.plugins.PayJsPlugin.10.1
