...
{
  FileJsPlugin$15(FileJsPlugin paramFileJsPlugin, String paramString1, bekr parambekr, String paramString2, long paramLong) {}
  
  public String run()
  {
    if ((bejl.a().a(this.val$zipFilePath) == 9999) && (!bejl.a().a(this.val$zipFilePath))) {
      return FileJsPlugin.access$100(this.this$0, this.val$req, null, "permission denied, open " + this.val$zipFilePath);
    }
    if (bejl.a().a(this.val$targetPath) != 2) {
      return FileJsPlugin.access$100(this.this$0, this.val$req, null, "permission denied, open " + this.val$targetPath);
    }
    String str1 = bejl.a().a(this.val$zipFilePath);
    String str2 = bejl.a().c(this.val$targetPath);
    ...
    int i = bemb.a(str1, str2);
    betc.a("FileJsPlugin", "unzip [minigame timecost:" + (System.currentTimeMillis() - this.val$startMS) + "ms], zipPath:" + str1 + ", target:" + str2);
    if (i == 0) {
