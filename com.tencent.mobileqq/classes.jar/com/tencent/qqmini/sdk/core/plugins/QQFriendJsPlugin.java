  ...
  extends BaseJsPlugin
{
  ...
  public static void doAddFriend(Context paramContext, String paramString1, String paramString2, QQFriendJsPlugin.IAddFriendCallBack paramIAddFriendCallBack)
  {
    ...
    {
      bdnw.d("QQFriendJsPlugin", "doAddFriend context is null ?!!");
      return;
    }
  ...
  public void addFriend(bdfz parambdfz)
  {
    try
    {
      String str = new JSONObject(parambdfz.b).optString("openid", "");
      QQFriendJsPlugin.1 local1 = new QQFriendJsPlugin.1(this, parambdfz);
