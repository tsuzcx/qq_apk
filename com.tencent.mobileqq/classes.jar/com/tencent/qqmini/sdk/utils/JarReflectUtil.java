...
public class JarReflectUtil
{
  ...
  public static Object callSpecifiedMethod(Object paramObject, String paramString, boolean paramBoolean, Class[] paramArrayOfClass, Object... paramVarArgs)
  {
    ...
    ((StringBuilder)localObject).append("reflect call: ");
    ((StringBuilder)localObject).append(paramString);
    QMLog.e("JarReflectUtil", ((StringBuilder)localObject).toString());
    if (paramObject != null)
    {
      ...
      try
      {
        ...
        {
          paramString = ((Class)localObject).getMethod(paramString, paramArrayOfClass);
        }
        else
        {
          paramString = ((Class)localObject).getMethod(paramString, new Class[0]);
          break label128;
          if ((paramArrayOfClass != null) && (paramArrayOfClass.length != 0)) {
            paramString = ((Class)localObject).getDeclaredMethod(paramString, paramArrayOfClass);
          } else {
            paramString = ((Class)localObject).getDeclaredMethod(paramString, new Class[0]);
          }
        }
        label128:
      ...
      catch (NullPointerException paramObject)
      {
        ...
        QMLog.e("JarReflectUtil", paramString.toString());
        return null;
      }
  ...
  public static Object callSpecifiedStaticMethod(String paramString1, String paramString2, boolean paramBoolean, Class[] paramArrayOfClass, Object... paramVarArgs)
  {
    if (!TextUtils.isEmpty(paramString1))
    {
      ...
      catch (NullPointerException paramString1)
      {
        ...
        QMLog.e("JarReflectUtil", paramString2.toString());
        return null;
      }
  ...
  public static Object creatSpecifiedObject(String paramString, Class[] paramArrayOfClass, Object... paramVarArgs)
  {
    ...
    catch (InvocationTargetException paramString)
    {
      ...
      QMLog.e("JarReflectUtil", paramArrayOfClass.toString());
