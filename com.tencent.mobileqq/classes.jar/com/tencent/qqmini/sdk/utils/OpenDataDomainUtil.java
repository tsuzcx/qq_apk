...
public class OpenDataDomainUtil
{
  ...
  private List<String> getDomainWhiteList()
  {
    try
    {
      ...
      str = WnsConfig.getConfig("qqminiapp", "opendatahosts", ".qlogo.com;.qlogo.cn;.qq.com;.tcb.qcloud.la");
      ...
      QMLog.i("[mini] http.openDataDomainValid", ((StringBuilder)localObject2).toString());
  ...
  public boolean isDomainValid(String paramString)
  {
    if (TextUtils.isEmpty(paramString))
    {
      ...
      QMLog.e("[mini] http.domainValid", ((StringBuilder)localObject).toString());
      return false;
    }
 ...
 * Qualified Name:     com.tencent.qqmini.sdk.utils.OpenDataDomainUtil
