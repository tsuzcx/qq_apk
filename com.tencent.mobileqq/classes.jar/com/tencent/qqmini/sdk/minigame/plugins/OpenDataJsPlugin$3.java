...
{
  OpenDataJsPlugin$3(OpenDataJsPlugin paramOpenDataJsPlugin, bgok parambgok) {}
  ...
  public void onReceiveResult(boolean paramBoolean, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      localbhaj.i("OpenDataJsPlugin", (String)localObject);
      ...
      if (paramBoolean) {
        ...
        {
          bhaj.a().e("OpenDataJsPlugin", "getFriendCloudStorage error " + paramJSONObject.getMessage());
          this.val$req.b();
          return;
        }
      }
