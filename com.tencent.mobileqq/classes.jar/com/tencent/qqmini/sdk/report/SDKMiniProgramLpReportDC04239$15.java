  ...
  implements Runnable
{
  ...
  public void run()
  {
    try
    {
      ...
      Object localObject = bgyg.b(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo);
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        localObject = bgyg.a(str, (String)localObject);
        str = bgyg.a(str, bgxz.b(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo));
