...
public class MD5Utils
{
  ...
  protected static byte[] encodeFile(String paramString)
  {
    ...
    //   64: goto -18 -> 46
    //   67: aload_2
    //   68: invokevirtual 137	java/security/MessageDigest:digest	()[B
    //   71: astore_2
    //   72: aload_0
    //   73: invokevirtual 174	java/io/BufferedInputStream:close	()V
    //   76: goto +8 -> 84
    //   79: astore_0
    //   80: aload_0
    //   81: invokevirtual 177	java/io/IOException:printStackTrace	()V
    //   84: aload_2
    //   85: areturn
    //   86: astore_2
    //   87: goto +21 -> 108
    //   90: astore_2
    //   91: aload_2
    //   92: invokevirtual 177	java/io/IOException:printStackTrace	()V
    //   95: aload_0
    //   96: invokevirtual 174	java/io/BufferedInputStream:close	()V
    //   99: aconst_null
    //   100: areturn
    //   101: astore_0
    //   102: aload_0
    ...
    //   107: areturn
    //   108: aload_0
    //   109: invokevirtual 174	java/io/BufferedInputStream:close	()V
    //   112: goto +8 -> 120
    //   115: astore_0
    //   116: aload_0
    //   117: invokevirtual 177	java/io/IOException:printStackTrace	()V
    //   120: aload_2
    //   121: athrow
    //   122: astore_0
    //   123: aload_0
    //   124: invokevirtual 178	java/security/NoSuchAlgorithmException:printStackTrace	()V
    //   127: aconst_null
    //   128: areturn
    //   129: astore_0
    //   130: aload_0
    //   131: invokevirtual 179	java/io/FileNotFoundException:printStackTrace	()V
    //   134: aconst_null
    //   135: areturn
  ...
  {
    int i = (int)(func_F(paramLong2, paramLong3, paramLong4) + paramLong5 + paramLong7 + paramLong1);
  ...
  {
    int i = (int)(func_G(paramLong2, paramLong3, paramLong4) + paramLong5 + paramLong7 + paramLong1);
    int j = (int)paramLong6;
    return (i >>> (int)(32L - paramLong6) | i << j) + paramLong2;
  }
  ...
  {
    int i = (int)(func_H(paramLong2, paramLong3, paramLong4) + paramLong5 + paramLong7 + paramLong1);
    int j = (int)paramLong6;
    return (i >>> (int)(32L - paramLong6) | i << j) + paramLong2;
  }
  ...
  {
    int i = (int)(func_I(paramLong2, paramLong3, paramLong4) + paramLong5 + paramLong7 + paramLong1);
    int j = (int)paramLong6;
    return (i >>> (int)(32L - paramLong6) | i << j) + paramLong2;
  }
