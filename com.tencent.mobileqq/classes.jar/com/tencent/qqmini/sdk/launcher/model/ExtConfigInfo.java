...
{
  public static final Parcelable.Creator<ExtConfigInfo> CREATOR = new bdmr();
  ...
  public static ExtConfigInfo from(INTERFACE.StExtConfigInfo paramStExtConfigInfo)
  {
    ...
    {
      bdnw.d("ExtConfigInfo", "merge from error", paramStExtConfigInfo);
    }
    for (;;)
    {
  ...
  public JSONObject toJson()
  {
    ...
    {
      bdnw.d("ExtConfigInfo", "toJson error", localException);
