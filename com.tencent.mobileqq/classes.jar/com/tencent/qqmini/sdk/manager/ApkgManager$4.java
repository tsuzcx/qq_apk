  ...
  implements Runnable
{
  public void run()
  {
    ...
    try
    {
      ...
      {
        String str1 = bdnx.b(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo);
        String str2 = bdyv.c(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo.appId);
        ...
        if (((File)localObject).isDirectory())
        {
          ...
          while (i < j)
          {
            ...
            {
              bdnw.a("ApkgManager", "delete pkg : " + localCharSequence);
              bdgo.a(str1 + localCharSequence, false);
            }
            i += 1;
          }
        }
    ...
    {
      bdnw.d("ApkgManager", "deleteOldPkg error,", localThrowable);
    }
  }
}
