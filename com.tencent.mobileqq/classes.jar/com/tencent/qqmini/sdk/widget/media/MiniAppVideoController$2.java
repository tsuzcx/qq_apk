  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    MiniAppVideoConfig localMiniAppVideoConfig = MiniAppVideoController.access$000(this.this$0);
    if (!MiniAppVideoController.access$200(this.this$0).getOutputMute()) {}
    for (boolean bool = true;; bool = false)
    {
      localMiniAppVideoConfig.muted = bool;
