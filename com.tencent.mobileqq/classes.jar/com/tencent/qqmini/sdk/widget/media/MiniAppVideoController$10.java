  ...
  implements AbsVideoPlayer.OnErrorListener
{
  ...
  {
    QMLog.e("MiniAppVideoController", "video onError: m what=" + paramInt1 + " extra=" + paramInt2);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        QMLog.d("MiniAppVideoController", "evaluateSubcribeJS onVideoError = " + paramAbsVideoPlayer.toString());
      }
