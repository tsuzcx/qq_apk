...
public class FavoritesProxyImpl$1
  implements Runnable
{
  public FavoritesProxyImpl$1(bjcy parambjcy, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, ArrayList paramArrayList, QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, Context paramContext) {}
  
  public void run()
  {
    boolean bool = bkov.a(8, this.jdField_a_of_type_JavaLangString, this.b, this.c, this.d, this.e, this.e, null, true, 0L).b("sBizDataList", this.jdField_a_of_type_JavaUtilArrayList).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord).a(this.jdField_a_of_type_AndroidContentContext);
