  ...
  extends MediaChooseJsProxy
{
  ...
  private int a(JSONObject paramJSONObject)
  {
    ...
    int i = QzoneConfig.getInstance().getConfig("qqminiapp", "MiniAppChooseMediaDefaultCount", 15);
    int j = paramJSONObject.optInt("count", i);
    if (j < 0) {}
    for (;;)
    {
      if (i > k) {
  ...
  {
    int i = 3;
    int j = QzoneConfig.getInstance().getConfig("qqminiapp", "MiniAppChooseMediaMaxDuration", 60);
    int k = paramJSONObject.optInt("maxDuration", QzoneConfig.getInstance().getConfig("qqminiapp", "MiniAppChooseMediaDefaultDuration", 10));
    if (k < 3) {}
    for (;;)
    {
      if (i > j) {
  ...
  private String a(String paramString)
  {
    ...
    //   69: ldc 127
    //   71: iconst_1
    //   72: new 129	java/lang/StringBuilder
    //   75: dup
    //   76: invokespecial 130	java/lang/StringBuilder:<init>	()V
    //   79: ldc 132
    //   81: invokevirtual 136	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   84: aload 4
    //   86: invokevirtual 140	java/io/File:length	()J
    //   89: invokevirtual 143	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   92: invokevirtual 147	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   95: invokestatic 153	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   98: aload 8
    //   100: astore 5
    //   102: aload 9
    //   104: astore_3
    //   105: new 155	android/graphics/BitmapFactory$Options
    //   108: dup
    //   109: invokespecial 156	android/graphics/BitmapFactory$Options:<init>	()V
    //   112: astore 4
    //   114: aload 8
    //   116: astore 5
    //   118: aload 9
    ...
    //   121: aload 4
    //   123: iconst_2
    //   124: putfield 159	android/graphics/BitmapFactory$Options:inSampleSize	I
    //   127: aload 8
    //   129: astore 5
    //   131: aload 9
    //   133: astore_3
    //   134: aload_1
    //   135: aload 4
    //   137: invokestatic 165	android/graphics/BitmapFactory:decodeFile	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   140: astore 10
    //   142: aload 7
    //   144: astore 4
    //   146: aload 10
    ...
    //   157: astore_3
    //   158: aload_1
    //   159: invokestatic 171	com/tencent/mobileqq/mini/util/ImageUtil:getExifOrientation	(Ljava/lang/String;)I
    //   162: istore_2
    //   163: aload 8
    //   165: astore 5
    //   167: aload 9
    ...
    //   176: dup
    //   177: invokespecial 130	java/lang/StringBuilder:<init>	()V
    //   180: ldc 173
    //   182: invokevirtual 136	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   185: iload_2
    //   186: invokevirtual 176	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   189: invokevirtual 147	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   192: invokestatic 153	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   195: aload 10
    //   197: astore 6
    //   199: iload_2
    //   200: ifeq +30 -> 230
    ...
    //   210: iload_2
    //   211: aload 10
    //   213: invokestatic 180	com/tencent/mobileqq/mini/util/ImageUtil:rotaingImageView	(ILandroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    //   216: astore 6
    //   218: aload 8
    //   220: astore 5
    //   222: aload 9
    //   224: astore_3
    //   225: aload 10
    //   227: invokevirtual 185	android/graphics/Bitmap:recycle	()V
    //   230: aload 7
    //   232: astore 4
    //   234: aload 6
    //   236: ifnull +39 -> 275
    ...
    //   243: aload 9
    //   245: astore_3
    //   246: new 187	java/io/FileOutputStream
    //   249: dup
    //   250: aload 12
    //   252: invokespecial 190	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   255: astore 4
    //   257: aload 6
    //   259: getstatic 196	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   262: bipush 50
    //   264: aload 4
    //   266: invokevirtual 200	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   269: pop
    //   270: aload 4
    //   272: invokevirtual 203	java/io/FileOutputStream:flush	()V
    //   275: aload 4
    //   277: astore 5
    //   279: aload 4
    //   281: astore_3
    //   282: ldc 127
    //   284: iconst_1
    //   285: new 129	java/lang/StringBuilder
    //   288: dup
    //   289: invokespecial 130	java/lang/StringBuilder:<init>	()V
    //   292: ldc 205
    //   294: invokevirtual 136	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   297: aload 12
    //   299: invokevirtual 140	java/io/File:length	()J
    //   302: invokevirtual 143	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   305: invokevirtual 147	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   308: invokestatic 153	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   311: aload 4
    //   313: ifnull +8 -> 321
    //   316: aload 4
    //   318: invokevirtual 208	java/io/FileOutputStream:close	()V
    //   321: aload 11
    //   323: areturn
    //   324: astore 4
    //   326: aload 5
    ...
    //   332: ldc 210
    //   334: aload 4
    //   336: invokestatic 214	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   339: aload 5
    //   341: ifnull -334 -> 7
    //   344: aload 5
    //   346: invokevirtual 208	java/io/FileOutputStream:close	()V
    //   349: aload_1
    //   350: areturn
    //   351: astore_3
    //   352: aload_1
    ...
    //   0	391	0	this	MediaChooseJsProxyImpl
  ...
  private boolean a(Bitmap paramBitmap, com.tencent.mobileqq.activity.photo.LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    //   11: iconst_2
    //   12: ldc_w 462
    //   15: invokestatic 465	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   18: iload_3
    //   19: istore 4
    //   21: iload 4
    //   23: ireturn
    ...
    //   30: iconst_2
    //   31: ldc_w 467
    //   34: invokestatic 465	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   37: iconst_0
    //   38: ireturn
    //   39: aload_0
    //   40: getfield 99	com/tencent/qqmini/proxyimpl/MediaChooseJsProxyImpl:jdField_a_of_type_ComTencentQqminiSdkLauncherCoreIMiniAppContext	Lcom/tencent/qqmini/sdk/launcher/core/IMiniAppContext;
    //   43: ldc 114
    //   45: invokeinterface 120 2 0
    //   50: checkcast 114	com/tencent/qqmini/sdk/launcher/shell/IMiniAppFileManager
    //   53: ldc_w 469
    //   56: invokeinterface 125 2 0
    //   61: astore 5
    //   63: new 109	java/io/File
    //   66: dup
    //   67: aload 5
    //   69: invokespecial 112	java/io/File:<init>	(Ljava/lang/String;)V
    //   72: astore 10
    //   74: aload 10
    //   76: invokevirtual 472	java/io/File:exists	()Z
    //   79: ifeq +9 -> 88
    //   82: aload 10
    //   84: invokevirtual 475	java/io/File:delete	()Z
    //   87: pop
    //   88: new 187	java/io/FileOutputStream
    //   91: dup
    //   92: aload 10
    //   94: invokespecial 190	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   97: astore 6
    //   99: new 477	java/io/BufferedOutputStream
    //   102: dup
    //   103: aload 6
    //   105: sipush 4096
    //   108: invokespecial 480	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;I)V
    //   111: astore 9
    //   113: aload 9
    //   115: astore 8
    //   117: aload 6
    //   119: astore 7
    //   121: aload_1
    //   122: getstatic 196	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   125: bipush 100
    //   127: aload 9
    //   129: invokevirtual 200	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   132: istore_3
    //   133: aload 9
    //   135: astore 8
    //   137: aload 6
    //   139: astore 7
    //   141: aload 9
    //   143: invokevirtual 481	java/io/BufferedOutputStream:flush	()V
    //   146: aload 9
    //   148: astore 8
    //   150: aload 6
    //   152: astore 7
    //   154: aload 10
    //   156: invokevirtual 484	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   159: astore_1
    //   160: aload 9
    //   162: astore 8
    //   164: aload 6
    ...
    //   168: aload_2
    //   169: aload_0
    //   170: getfield 99	com/tencent/qqmini/proxyimpl/MediaChooseJsProxyImpl:jdField_a_of_type_ComTencentQqminiSdkLauncherCoreIMiniAppContext	Lcom/tencent/qqmini/sdk/launcher/core/IMiniAppContext;
    //   173: ldc 114
    //   175: invokeinterface 120 2 0
    //   180: checkcast 114	com/tencent/qqmini/sdk/launcher/shell/IMiniAppFileManager
    //   183: aload_1
    //   184: invokeinterface 487 2 0
    //   189: putfield 493	com/tencent/mobileqq/activity/photo/LocalMediaInfo:thumbnailPath	Ljava/lang/String;
    //   192: aload 6
    //   194: ifnull +8 -> 202
    //   197: aload 6
    //   199: invokevirtual 208	java/io/FileOutputStream:close	()V
    //   202: aload 9
    //   204: ifnull +275 -> 479
    //   207: aload 9
    //   209: invokevirtual 494	java/io/BufferedOutputStream:close	()V
    //   212: aload_1
    //   213: astore_2
    //   214: iload_3
    //   215: istore 4
    //   217: invokestatic 218	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   220: ifeq -199 -> 21
    //   223: ldc 127
    //   225: iconst_2
    ...
    //   239: aload_2
    //   240: invokevirtual 136	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   243: invokevirtual 147	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   246: invokestatic 454	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   249: iload_3
    //   250: ireturn
    //   251: astore_2
    //   252: aload_2
    //   253: invokevirtual 499	java/io/IOException:printStackTrace	()V
    //   256: goto -54 -> 202
    //   259: astore_2
    //   260: aload_2
    //   261: invokevirtual 499	java/io/IOException:printStackTrace	()V
    //   264: aload_1
    //   265: astore_2
    //   266: goto -52 -> 214
    //   269: astore_2
    ...
    //   287: aload 6
    //   289: astore 7
    //   291: invokestatic 218	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   294: ifeq +21 -> 315
    //   297: aload 5
    //   299: astore 8
    //   301: aload 6
    ...
    //   308: ldc_w 501
    //   311: aload_2
    //   312: invokestatic 503	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   315: aload 6
    //   317: ifnull +8 -> 325
    //   320: aload 6
    ...
    //   332: ifnull -118 -> 214
    //   335: aload 5
    //   337: invokevirtual 494	java/io/BufferedOutputStream:close	()V
    //   340: aload_1
    //   341: astore_2
    //   342: iload 4
    //   344: istore_3
    ...
    //   348: astore_2
    //   349: aload_2
    //   350: invokevirtual 499	java/io/IOException:printStackTrace	()V
    //   353: aload_1
    //   354: astore_2
    //   355: iload 4
    //   357: istore_3
    ...
    //   361: astore_2
    //   362: aload_2
    //   363: invokevirtual 499	java/io/IOException:printStackTrace	()V
    //   366: goto -41 -> 325
    //   369: astore_1
    //   370: aconst_null
    //   371: astore 8
    ...
    //   378: ifnull +8 -> 386
    //   381: aload 6
    //   383: invokevirtual 208	java/io/FileOutputStream:close	()V
    //   386: aload 8
    //   388: ifnull +8 -> 396
    //   391: aload 8
    //   393: invokevirtual 494	java/io/BufferedOutputStream:close	()V
    //   396: aload_1
    //   397: athrow
    //   398: astore_2
    //   399: aload_2
    //   400: invokevirtual 499	java/io/IOException:printStackTrace	()V
    //   403: goto -17 -> 386
    //   406: astore_2
    //   407: aload_2
    //   408: invokevirtual 499	java/io/IOException:printStackTrace	()V
    //   411: goto -15 -> 396
    //   414: astore_1
    //   415: aconst_null
    //   416: astore 8
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	484	0	this	MediaChooseJsProxyImpl
