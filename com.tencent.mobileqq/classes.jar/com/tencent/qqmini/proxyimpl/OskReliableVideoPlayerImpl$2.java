  ...
  implements IMediaPlayer.OnPreparedListener
{
  ...
  {
    paramIMediaPlayer = this.jdField_a_of_type_ComTencentQqminiSdkLauncherCoreWidgetReliableVideoPlayer$OnPreparedListener;
    if (paramIMediaPlayer != null) {
      paramIMediaPlayer.onPrepared(this.jdField_a_of_type_ComTencentQqminiProxyimplOskReliableVideoPlayerImpl);
    }
  }
}
