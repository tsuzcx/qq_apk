  ...
  extends MiniAppProxy
{
  ...
  private int a(ColorNoteController paramColorNoteController)
  {
    int i = 0;
    if (paramColorNoteController.a())
    {
      if (paramColorNoteController.c()) {
        i = 2;
      }
    }
    else {
  ...
  private void a(Activity paramActivity, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    localBundle.putInt(DownloadConstants.I, 1);
  ...
  private void a(ColorNoteController paramColorNoteController)
  {
    if (paramColorNoteController != null)
    {
      ...
      if (!paramColorNoteController.b()) {
        break label23;
      }
      paramColorNoteController.e();
    }
    label23:
    label28:
    while (!paramColorNoteController.c())
    {
      return;
      paramColorNoteController.i();
      return;
    }
    paramColorNoteController.f();
  }
  ...
  private void a(MiniAppInfo paramMiniAppInfo)
  {
    ...
    QIPCClientHelper.getInstance().callServer("MiniAppTransferModule", "sync_mini_app_data", localBundle, new MiniAppProxyImpl.6(this, paramMiniAppInfo));
  }
  ...
  private void e(IMiniAppContext paramIMiniAppContext)
  {
    ...
    localObject = "https://tucao.qq.com/qq_miniprogram/tucao?appid=" + localMiniAppInfo.appId + "&openid=" + MainPageFragment.getUin() + "&avatar=" + paramIMiniAppContext + HardCodeUtil.a(2131701425);
  ...
  public void a()
  {
    ...
    if (((MiniAppInfo)localObject1).isEngineTypeMiniGame()) {
      if ((localShareState.showRestart) && (QzoneConfig.getInstance().getConfig("qqminiapp", "mini_game_capsule_show_restart_btn", 1) == 1))
      {
        ...
        i = a((ColorNoteController)localObject2);
      }
    }
    for (;;)
    {
      ...
      ((Intent)localObject2).putExtra("key_mini_app_config", MiniSdkUtil.a((MiniAppInfo)localObject1));
      ...
      if (QFileAssistantUtils.a()) {
        ((Intent)localObject2).putExtra("showShareDataline", true);
      }
      localObject1 = AppLoaderFactory.g().getMiniAppEnv().getActivityResultManager();
      ((IActivityResultManager)localObject1).addActivityResultListener(new MiniAppProxyImpl.10(this, (IActivityResultManager)localObject1));
      ...
      if ((localObject2 instanceof PageGestureProxyImpl))
      {
        localObject2 = ((PageGestureProxyImpl)localObject2).a();
        if ((!bool4) && (localObject2 != null))
        {
          i = a((ColorNoteController)localObject2);
          continue;
  ...
  public void a(Context paramContext, String paramString)
  {
    ...
    TroopUtils.a(paramContext, TroopInfoActivity.a(paramString, 5), 2);
  }
  ...
  public boolean enterQRCode(Context paramContext, boolean paramBoolean, AsyncResult paramAsyncResult)
  {
    ...
    if (!RecentOptPopBar.a(localBaseActivity))
    {
      paramAsyncResult.onReceiveResult(false, null);
      return true;
    }
    paramContext = new Intent((BaseActivity)paramContext, ScannerActivity.class);
    paramContext.putExtra("leftViewText", localBaseActivity.getString(2131690778));
    paramContext.putExtra("selfSet_leftViewText", localBaseActivity.getString(2131690778));
  ...
  public boolean onCapsuleButtonCloseClick(IMiniAppContext paramIMiniAppContext, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    do
    {
      do
      {
        ...
        localMiniAppInfo = paramIMiniAppContext.getMiniAppInfo();
      } while ((localActivity == null) || (localMiniAppInfo == null));
      str = getAppName();
    ...
    return GameCloseManager.showRetainGuideDialog(localActivity, MiniSdkUtil.a(localMiniAppInfo), paramOnClickListener);
  }
