  ...
  implements ShareProxy
{
  ...
  {
    a(paramMiniAppInfo, paramInt, paramString1, paramString2, ImageUtil.drawableToBitmap(paramActivity.getResources().getDrawable(2130848781)), paramString3);
  }
  ...
  public void a(InnerShareData paramInnerShareData)
  {
    ...
    if (paramInnerShareData.entryModel != null)
    {
      ...
      int j = 0;
      i = j;
      if (!StringUtil.a(((MiniArkShareModel)localObject).getTemplateId()))
      {
        i = j;
        if (!StringUtil.a(((MiniArkShareModel)localObject).getTemplateData())) {
          i = 2;
        }
      }
