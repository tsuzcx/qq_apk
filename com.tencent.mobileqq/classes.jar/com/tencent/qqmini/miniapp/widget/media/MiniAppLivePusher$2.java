  ...
  implements TXLivePushListenerReflect.ITXLivePushListener
{
  ...
  public void onPushEvent(int paramInt, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      {
        if (paramBundle != null) {
          paramBundle.performAction(ServiceSubscribeEvent.obtain("onLivePusherEvent", localJSONObject.toString(), this.this$0.webviewId));
        }
        this.val$req.jsService.evaluateSubscribeJS("onLivePusherEvent", localJSONObject.toString(), this.this$0.webviewId);
        return;
      }
      return;
    }
