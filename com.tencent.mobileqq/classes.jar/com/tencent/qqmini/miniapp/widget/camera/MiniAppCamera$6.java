...
class MiniAppCamera$6
  implements Runnable
{
  MiniAppCamera$6(MiniAppCamera paramMiniAppCamera, String paramString, RequestEvent paramRequestEvent) {}
  
  public void run()
  {
    try
    {
      String str = MiniAppCamera.access$500(this.this$0, this.val$videoPath);
