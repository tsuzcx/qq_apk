  ...
  extends VideoJsProxy
{
  ...
  private void handleVideoResult(File paramFile, boolean paramBoolean, VideoJsProxyDefault.BridgeInfo paramBridgeInfo)
  {
    ...
    //   14: dup
    //   15: invokespecial 128	java/lang/StringBuilder:<init>	()V
    //   18: ldc_w 474
    //   21: invokevirtual 134	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   24: aload_1
    //   25: invokevirtual 342	java/io/File:getAbsolutePath	()Ljava/lang/String;
    ...
    //   34: invokestatic 344	com/tencent/qqmini/sdk/launcher/log/QMLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   37: new 476	java/io/FileInputStream
    //   40: dup
    //   41: aload_1
    //   42: invokespecial 479	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   45: astore 7
    //   47: new 218	android/media/MediaExtractor
    //   50: dup
    //   51: invokespecial 480	android/media/MediaExtractor:<init>	()V
    //   54: astore 6
    //   56: aload 7
    //   58: astore 9
    //   60: aload 6
    ...
    //   64: aload 6
    //   66: aload 7
    //   68: invokevirtual 484	java/io/FileInputStream:getFD	()Ljava/io/FileDescriptor;
    //   71: invokevirtual 488	android/media/MediaExtractor:setDataSource	(Ljava/io/FileDescriptor;)V
    //   74: aload 7
    //   76: astore 9
    //   78: aload 6
    //   80: astore 8
    //   82: aload 6
    //   84: invokestatic 490	com/tencent/qqmini/miniapp/proxy/VideoJsProxyDefault:getAndSelectVideoTrackIndex	(Landroid/media/MediaExtractor;)I
    //   87: istore 4
    //   89: iload 4
    //   91: iconst_m1
    ...
    //   103: aload 6
    //   105: iload 4
    //   107: invokevirtual 237	android/media/MediaExtractor:getTrackFormat	(I)Landroid/media/MediaFormat;
    //   110: astore 10
    //   112: aload 7
    //   114: astore 9
    //   116: aload 6
    //   118: astore 8
    //   120: new 426	com/tencent/qqmini/sdk/launcher/utils/LocalMediaInfo
    //   123: dup
    //   124: invokespecial 491	com/tencent/qqmini/sdk/launcher/utils/LocalMediaInfo:<init>	()V
    //   127: astore 5
    //   129: iconst_0
    //   130: istore 4
    //   132: aload 7
    ...
    //   140: aload 10
    //   142: ldc_w 493
    //   145: invokevirtual 496	android/media/MediaFormat:containsKey	(Ljava/lang/String;)Z
    //   148: ifeq +426 -> 574
    //   151: aload 7
    //   153: astore 9
    //   155: aload 6
    ...
    //   159: aload 10
    //   161: ldc_w 493
    //   164: invokevirtual 500	android/media/MediaFormat:getInteger	(Ljava/lang/String;)I
    //   167: istore 4
    //   169: goto +405 -> 574
    //   172: aload 7
    //   174: astore 9
    ...
    //   182: aload 10
    //   184: ldc_w 453
    //   187: invokevirtual 500	android/media/MediaFormat:getInteger	(Ljava/lang/String;)I
    //   190: putfield 461	com/tencent/qqmini/sdk/launcher/utils/LocalMediaInfo:mediaWidth	I
    //   193: aload 7
    //   195: astore 9
    //   197: aload 6
    //   199: astore 8
    ...
    //   203: aload 10
    //   205: ldc_w 458
    //   208: invokevirtual 500	android/media/MediaFormat:getInteger	(Ljava/lang/String;)I
    //   211: putfield 456	com/tencent/qqmini/sdk/launcher/utils/LocalMediaInfo:mediaHeight	I
    //   214: aload 7
    //   216: astore 9
    //   218: aload 6
    //   220: astore 8
    ...
    //   224: aload 10
    //   226: ldc_w 502
    //   229: invokevirtual 506	android/media/MediaFormat:getLong	(Ljava/lang/String;)J
    //   232: l2d
    //   233: ldc2_w 507
    //   236: ddiv
    //   237: invokestatic 511	java/lang/Math:round	(D)J
    //   240: putfield 435	com/tencent/qqmini/sdk/launcher/utils/LocalMediaInfo:mDuration	J
    //   243: aload 7
    //   245: astore 9
    //   247: aload 6
    //   249: astore 8
    //   251: aload 5
    //   253: aload_1
    //   254: invokevirtual 342	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   257: putfield 514	com/tencent/qqmini/sdk/launcher/utils/LocalMediaInfo:path	Ljava/lang/String;
    //   260: aload 7
    //   262: astore 9
    //   264: aload 6
    //   266: astore 8
    //   268: aload 5
    //   270: aload_1
    //   271: invokevirtual 517	java/io/File:length	()J
    //   274: putfield 520	com/tencent/qqmini/sdk/launcher/utils/LocalMediaInfo:fileSize	J
    //   277: aload 5
    //   279: astore_1
    //   280: aload 7
    //   282: ifnull +8 -> 290
    //   285: aload 7
    //   287: invokevirtual 523	java/io/FileInputStream:close	()V
    //   290: aload_1
    //   291: astore 5
    //   293: aload 6
    //   295: ifnull +11 -> 306
    //   298: aload 6
    //   300: invokevirtual 526	android/media/MediaExtractor:release	()V
    //   303: aload_1
    //   304: astore 5
    //   306: aload 5
    //   308: ifnonnull +153 -> 461
    //   311: aload_0
    //   312: getfield 88	com/tencent/qqmini/miniapp/proxy/VideoJsProxyDefault:mBridge	Lcom/tencent/qqmini/sdk/launcher/core/proxy/VideoJsProxy$Bridge;
    //   315: aload_3
    //   316: getfield 301	com/tencent/qqmini/miniapp/proxy/VideoJsProxyDefault$BridgeInfo:callbackId	I
    //   319: ldc 11
    //   321: aconst_null
    //   322: ldc_w 470
    //   325: invokeinterface 312 5 0
    //   330: return
    //   331: aload 7
    //   333: astore 9
    //   335: aload 6
    ...
    //   341: aload 10
    //   343: ldc_w 458
    //   346: invokevirtual 500	android/media/MediaFormat:getInteger	(Ljava/lang/String;)I
    //   349: putfield 461	com/tencent/qqmini/sdk/launcher/utils/LocalMediaInfo:mediaWidth	I
    //   352: aload 7
    //   354: astore 9
    //   356: aload 6
    //   358: astore 8
    ...
    //   362: aload 10
    //   364: ldc_w 453
    //   367: invokevirtual 500	android/media/MediaFormat:getInteger	(Ljava/lang/String;)I
    //   370: putfield 456	com/tencent/qqmini/sdk/launcher/utils/LocalMediaInfo:mediaHeight	I
    //   373: goto -159 -> 214
    //   376: astore 8
    //   378: aload 5
    //   380: astore_1
    ...
    //   395: ldc_w 528
    //   398: aload 5
    //   400: invokestatic 531	com/tencent/qqmini/sdk/launcher/log/QMLog:w	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   403: aload 7
    //   405: ifnull +8 -> 413
    //   408: aload 7
    //   410: invokevirtual 523	java/io/FileInputStream:close	()V
    //   413: aload_1
    //   414: astore 5
    //   416: aload 6
    //   418: ifnull -112 -> 306
    //   421: aload 6
    //   423: invokevirtual 526	android/media/MediaExtractor:release	()V
    //   426: aload_1
    //   427: astore 5
    //   429: goto -123 -> 306
    //   432: astore_1
    ...
    //   441: ifnull +8 -> 449
    //   444: aload 7
    //   446: invokevirtual 523	java/io/FileInputStream:close	()V
    //   449: aload 8
    //   451: ifnull +8 -> 459
    //   454: aload 8
    //   456: invokevirtual 526	android/media/MediaExtractor:release	()V
    //   459: aload_1
    //   460: athrow
    //   461: iload_2
    //   462: ifeq +12 -> 474
    ...
    //   468: iconst_1
    //   469: aload_3
    //   470: invokespecial 109	com/tencent/qqmini/miniapp/proxy/VideoJsProxyDefault:startCompress	(Lcom/tencent/qqmini/sdk/launcher/utils/LocalMediaInfo;ZLcom/tencent/qqmini/miniapp/proxy/VideoJsProxyDefault$BridgeInfo;)V
    //   473: return
    //   474: aload_0
    //   475: aload_0
    //   476: getfield 99	com/tencent/qqmini/miniapp/proxy/VideoJsProxyDefault:mMiniAppContext	Lcom/tencent/qqmini/sdk/launcher/core/IMiniAppContext;
    //   479: ldc_w 279
    //   482: invokeinterface 285 2 0
    //   487: checkcast 279	com/tencent/qqmini/sdk/core/manager/MiniAppFileManager
    //   490: aload 5
    //   492: getfield 514	com/tencent/qqmini/sdk/launcher/utils/LocalMediaInfo:path	Ljava/lang/String;
    //   495: invokevirtual 534	com/tencent/qqmini/sdk/core/manager/MiniAppFileManager:getWxFilePath	(Ljava/lang/String;)Ljava/lang/String;
    //   498: aload 5
    //   500: getfield 520	com/tencent/qqmini/sdk/launcher/utils/LocalMediaInfo:fileSize	J
    //   503: aload 5
    //   505: aload_3
    //   506: invokespecial 103	com/tencent/qqmini/miniapp/proxy/VideoJsProxyDefault:respGetVideo	(Ljava/lang/String;JLcom/tencent/qqmini/sdk/launcher/utils/LocalMediaInfo;Lcom/tencent/qqmini/miniapp/proxy/VideoJsProxyDefault$BridgeInfo;)V
    //   509: return
    //   510: astore 5
    //   512: goto -222 -> 290
    //   515: astore 5
    ...
    //   0	592	3	paramBridgeInfo	VideoJsProxyDefault.BridgeInfo
    //   87	500	4	i	int
  ...
  private boolean saveThumbnail(Bitmap paramBitmap, LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    //   9: ldc 20
    //   11: ldc_w 559
    //   14: invokestatic 561	com/tencent/qqmini/sdk/launcher/log/QMLog:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   17: iload_3
    //   18: istore 4
    //   20: iload 4
    //   22: ireturn
    ...
    //   27: ldc 20
    //   29: ldc_w 563
    //   32: invokestatic 561	com/tencent/qqmini/sdk/launcher/log/QMLog:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   35: iconst_0
    //   36: ireturn
    //   37: aload_0
    //   38: getfield 99	com/tencent/qqmini/miniapp/proxy/VideoJsProxyDefault:mMiniAppContext	Lcom/tencent/qqmini/sdk/launcher/core/IMiniAppContext;
    //   41: ldc_w 279
    //   44: invokeinterface 285 2 0
    //   49: checkcast 279	com/tencent/qqmini/sdk/core/manager/MiniAppFileManager
    //   52: ldc_w 565
    //   55: invokevirtual 568	com/tencent/qqmini/sdk/core/manager/MiniAppFileManager:getTmpPath	(Ljava/lang/String;)Ljava/lang/String;
    //   58: astore 5
    //   60: new 164	java/io/File
    //   63: dup
    //   64: aload 5
    //   66: invokespecial 569	java/io/File:<init>	(Ljava/lang/String;)V
    //   69: astore 10
    //   71: aload 10
    //   73: invokevirtual 572	java/io/File:exists	()Z
    //   76: ifeq +9 -> 85
    //   79: aload 10
    //   81: invokevirtual 575	java/io/File:delete	()Z
    //   84: pop
    //   85: new 577	java/io/FileOutputStream
    //   88: dup
    //   89: aload 10
    //   91: invokespecial 578	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   94: astore 6
    //   96: new 580	java/io/BufferedOutputStream
    //   99: dup
    //   100: aload 6
    //   102: sipush 4096
    //   105: invokespecial 583	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;I)V
    //   108: astore 9
    //   110: aload 9
    //   112: astore 8
    //   114: aload 6
    //   116: astore 7
    //   118: aload_1
    //   119: getstatic 589	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   122: bipush 100
    //   124: aload 9
    //   126: invokevirtual 595	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   129: istore_3
    //   130: aload 9
    //   132: astore 8
    //   134: aload 6
    //   136: astore 7
    //   138: aload 9
    //   140: invokevirtual 598	java/io/BufferedOutputStream:flush	()V
    //   143: aload 9
    //   145: astore 8
    //   147: aload 6
    //   149: astore 7
    ...
    //   165: aload_2
    //   166: aload_0
    //   167: getfield 99	com/tencent/qqmini/miniapp/proxy/VideoJsProxyDefault:mMiniAppContext	Lcom/tencent/qqmini/sdk/launcher/core/IMiniAppContext;
    //   170: ldc_w 279
    //   173: invokeinterface 285 2 0
    //   178: checkcast 279	com/tencent/qqmini/sdk/core/manager/MiniAppFileManager
    //   181: aload_1
    //   182: invokevirtual 534	com/tencent/qqmini/sdk/core/manager/MiniAppFileManager:getWxFilePath	(Ljava/lang/String;)Ljava/lang/String;
    //   185: putfield 429	com/tencent/qqmini/sdk/launcher/utils/LocalMediaInfo:thumbnailPath	Ljava/lang/String;
    //   188: aload 6
    //   190: ifnull +8 -> 198
    //   193: aload 6
    //   195: invokevirtual 599	java/io/FileOutputStream:close	()V
    //   198: aload 9
    //   200: ifnull +273 -> 473
    //   203: aload 9
    //   205: invokevirtual 600	java/io/BufferedOutputStream:close	()V
    //   208: aload_1
    //   209: astore_2
    //   210: iload_3
    //   211: istore 4
    //   213: invokestatic 226	com/tencent/qqmini/sdk/launcher/log/QMLog:isColorLevel	()Z
    //   216: ifeq -196 -> 20
    //   219: ldc 20
    ...
    //   234: aload_2
    //   235: invokevirtual 134	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   238: invokevirtual 149	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   241: invokestatic 344	com/tencent/qqmini/sdk/launcher/log/QMLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   244: iload_3
    //   245: ireturn
    //   246: astore_2
    //   247: aload_2
    //   248: invokevirtual 603	java/io/IOException:printStackTrace	()V
    //   251: goto -53 -> 198
    //   254: astore_2
    //   255: aload_2
    //   256: invokevirtual 603	java/io/IOException:printStackTrace	()V
    //   259: aload_1
    //   260: astore_2
    //   261: goto -51 -> 210
    //   264: astore_2
    ...
    //   282: aload 6
    //   284: astore 7
    //   286: invokestatic 226	com/tencent/qqmini/sdk/launcher/log/QMLog:isColorLevel	()Z
    //   289: ifeq +20 -> 309
    //   292: aload 5
    //   294: astore 8
    //   296: aload 6
    ...
    //   302: ldc_w 605
    //   305: aload_2
    //   306: invokestatic 531	com/tencent/qqmini/sdk/launcher/log/QMLog:w	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   309: aload 6
    //   311: ifnull +8 -> 319
    //   314: aload 6
    //   316: invokevirtual 599	java/io/FileOutputStream:close	()V
    //   319: aload_1
    //   320: astore_2
    //   321: iload 4
    //   323: istore_3
    ...
    //   326: ifnull -116 -> 210
    //   329: aload 5
    //   331: invokevirtual 600	java/io/BufferedOutputStream:close	()V
    //   334: aload_1
    //   335: astore_2
    //   336: iload 4
    //   338: istore_3
    ...
    //   342: astore_2
    //   343: aload_2
    //   344: invokevirtual 603	java/io/IOException:printStackTrace	()V
    //   347: aload_1
    //   348: astore_2
    //   349: iload 4
    //   351: istore_3
    ...
    //   355: astore_2
    //   356: aload_2
    //   357: invokevirtual 603	java/io/IOException:printStackTrace	()V
    //   360: goto -41 -> 319
    //   363: astore_1
    //   364: aconst_null
    //   365: astore 8
    ...
    //   372: ifnull +8 -> 380
    //   375: aload 6
    //   377: invokevirtual 599	java/io/FileOutputStream:close	()V
    //   380: aload 8
    //   382: ifnull +8 -> 390
    //   385: aload 8
    //   387: invokevirtual 600	java/io/BufferedOutputStream:close	()V
    //   390: aload_1
    //   391: athrow
    //   392: astore_2
    //   393: aload_2
    //   394: invokevirtual 603	java/io/IOException:printStackTrace	()V
    //   397: goto -17 -> 380
    //   400: astore_2
    //   401: aload_2
    //   402: invokevirtual 603	java/io/IOException:printStackTrace	()V
    //   405: goto -15 -> 390
    //   408: astore_1
    //   409: aconst_null
    //   410: astore 8
