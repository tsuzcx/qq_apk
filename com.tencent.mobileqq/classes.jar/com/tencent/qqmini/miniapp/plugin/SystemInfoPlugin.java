  ...
  extends BaseJsPlugin
{
  ...
  public String handleGetSystemInfo(RequestEvent paramRequestEvent)
  {
    ...
    int i = (int)(Math.round(DisplayUtil.getStatusBarHeight(this.mContext)) / d);
    int j = (int)((float)Math.round(((DisplayMetrics)localObject2).widthPixels / d) + 0.5F);
    int k = getRelHeight((DisplayMetrics)localObject2, (Activity)localObject1);
    int m = getRelWindowHeight(d, i, k);
    try
    {
      ...
      ((JSONObject)localObject2).put("screenWidth", j);
      ((JSONObject)localObject2).put("screenHeight", k);
      ((JSONObject)localObject2).put("windowWidth", j);
      ((JSONObject)localObject2).put("windowHeight", m);
      ((JSONObject)localObject2).put("statusBarHeight", i);
      ...
      ((JSONObject)localObject2).put("safeArea", ImmersiveUtils.getDisplayCutoutSafeArea((Activity)localObject1));
