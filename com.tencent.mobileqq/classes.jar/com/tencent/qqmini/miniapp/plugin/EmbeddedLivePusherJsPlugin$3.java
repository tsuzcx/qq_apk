...
{
  EmbeddedLivePusherJsPlugin$3(EmbeddedLivePusherJsPlugin paramEmbeddedLivePusherJsPlugin, RequestEvent paramRequestEvent) {}
  ...
  public Void perform(BaseRuntime paramBaseRuntime)
  {
    ...
    {
      AppBrandTask.runTaskOnUiThread(new EmbeddedLivePusherJsPlugin.3.1(this, paramBaseRuntime));
      return null;
    }
    this.val$req.fail();
    return null;
 ...
 * Qualified Name:     com.tencent.qqmini.miniapp.plugin.EmbeddedLivePusherJsPlugin.3
