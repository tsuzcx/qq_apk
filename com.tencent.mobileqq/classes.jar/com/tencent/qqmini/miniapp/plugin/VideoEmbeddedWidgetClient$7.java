    ...
    for (;;)
    {
      ...
      try
      {
        ...
        for (l1 /= 1000L;; l1 = 0L)
        {
          ...
          ((JSONObject)localObject).put("data", VideoEmbeddedWidgetClient.access$700(this.this$0));
          ((JSONObject)localObject).put("videoPlayerId", VideoEmbeddedWidgetClient.access$800(this.this$0));
          long l2 = l1;
          if (VideoEmbeddedWidgetClient.access$1100(this.this$0) != null)
          {
            l2 = l1;
            if (VideoEmbeddedWidgetClient.access$1100(this.this$0).booleanValue()) {
              l2 = 0L;
            }
          }
          ((JSONObject)localObject).put("duration", l2);
          ((JSONObject)localObject).put("width", VideoEmbeddedWidgetClient.access$1200(this.this$0).getVideoWidth() / DisplayUtil.getDensity(AppLoaderFactory.g().getContext()));
          ((JSONObject)localObject).put("height", VideoEmbeddedWidgetClient.access$1200(this.this$0).getVideoHeight() / DisplayUtil.getDensity(AppLoaderFactory.g().getContext()));
          VideoEmbeddedWidgetClient.access$1000(this.this$0, "onXWebVideoLoadedMetaData", ((JSONObject)localObject).toString(), VideoEmbeddedWidgetClient.access$900(this.this$0));
