...
public final class MsgContent
  extends ExtendableMessageNano<MsgContent>
{
  public MsgElement[] a;
  public ExtData[] b;
  ...
  public MsgContent a(CodedInputByteBufferNano paramCodedInputByteBufferNano)
  {
    for (;;)
    {
      ...
      else
      {
        ...
        localObject = new MsgElement[j + i];
        j = i;
        if (i != 0)
        {
 ...
 * Qualified Name:     com.tencent.protobuf.iliveWordSvr.nano.MsgContent
