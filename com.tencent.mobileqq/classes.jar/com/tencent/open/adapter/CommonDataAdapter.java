...
public class CommonDataAdapter
{
  ...
  public long a()
  {
    ...
    try
    {
      ...
      localObject = ((Class)localObject).getMethod("getUinForPlugin", new Class[] { Context.class }).invoke(localObject, new Object[] { this.jdField_a_of_type_AndroidContentContext });
