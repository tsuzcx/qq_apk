...
public class ReportManager
{
  ...
  protected void a()
  {
    ...
    if (a(str)) {
      ThreadManager.executeOnNetWorkThread(new akqh(this, str));
    }
  }
  ...
  {
    ThreadManager.executeOnNetWorkThread(new akqg(this, paramBoolean, paramBatchReportInfo, paramBundle, paramString));
  }
