...
public class ReportManager$1
  implements Runnable
{
  public ReportManager$1(bfng parambfng, String paramString, Bundle paramBundle) {}
  ...
  public void run()
  {
    ...
    //   24: invokestatic 53	bflp:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   27: ldc 34
    ...
    //   51: invokestatic 53	bflp:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   54: aload_0
    //   55: getfield 15	com/tencent/open/business/cgireport/ReportManager$1:this$0	Lbfng;
    //   58: invokestatic 63	bfbm:a	()Lbfbm;
    //   61: invokevirtual 66	bfbm:a	()Landroid/content/Context;
    //   64: aconst_null
    //   65: invokestatic 71	bfmx:a	(Landroid/content/Context;Ljava/lang/String;)Lbfmx;
    //   68: ldc 73
    //   70: invokevirtual 76	bfmx:a	(Ljava/lang/String;)I
    //   73: putfield 81	bfng:jdField_a_of_type_Int	I
    //   76: aload_0
    //   77: getfield 15	com/tencent/open/business/cgireport/ReportManager$1:this$0	Lbfng;
    //   80: astore 5
    //   82: aload_0
    //   83: getfield 15	com/tencent/open/business/cgireport/ReportManager$1:this$0	Lbfng;
    //   86: getfield 81	bfng:jdField_a_of_type_Int	I
    //   89: ifne +193 -> 282
    //   92: iconst_3
    //   93: istore_1
    //   94: aload 5
    //   96: iload_1
    //   97: putfield 81	bfng:jdField_a_of_type_Int	I
    //   100: iconst_0
    //   101: istore_1
    //   102: iconst_0
    //   103: istore_3
    ...
    //   131: invokestatic 53	bflp:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   134: aconst_null
    //   135: aload_0
    ...
    //   227: ldc 34
    //   229: ldc 156
    //   231: invokestatic 159	bflp:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   234: aload_0
    //   235: getfield 15	com/tencent/open/business/cgireport/ReportManager$1:this$0	Lbfng;
    //   238: iconst_0
    //   239: putfield 162	bfng:jdField_a_of_type_Boolean	Z
    //   242: ldc 34
    ...
    //   266: invokestatic 53	bflp:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   269: iload_1
    //   270: iconst_1
    //   271: if_icmpne +101 -> 372
    //   274: ldc 34
    //   276: ldc 166
    //   278: invokestatic 53	bflp:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   281: return
    //   282: aload_0
    //   283: getfield 15	com/tencent/open/business/cgireport/ReportManager$1:this$0	Lbfng;
    //   286: getfield 81	bfng:jdField_a_of_type_Int	I
    //   289: istore_1
    //   290: goto -196 -> 94
    //   293: ldc 34
    //   295: ldc 168
    //   297: invokestatic 53	bflp:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   300: iconst_1
    //   301: istore_1
    //   302: goto -68 -> 234
    //   305: astore 5
    //   307: getstatic 169	bfng:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   310: ldc 171
    //   312: aload 5
    //   314: invokestatic 175	bflp:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   317: iload_1
    //   318: istore_2
    //   319: iload_2
    //   320: istore_1
    ...
    //   324: iload 4
    //   326: aload_0
    //   327: getfield 15	com/tencent/open/business/cgireport/ReportManager$1:this$0	Lbfng;
    //   330: getfield 81	bfng:jdField_a_of_type_Int	I
    //   333: if_icmplt -229 -> 104
    //   336: iload_2
    //   337: istore_1
    //   338: goto -104 -> 234
    //   341: astore 5
    //   343: getstatic 169	bfng:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   346: ldc 177
    //   348: aload 5
    //   350: invokestatic 175	bflp:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   353: iload_1
    //   354: istore_2
    //   355: goto -36 -> 319
    //   358: astore 5
    ...
    //   362: ldc 179
    //   364: aload 5
    //   366: invokestatic 175	bflp:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   369: goto -135 -> 234
    //   372: ldc 34
    //   374: ldc 181
    //   376: invokestatic 159	bflp:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   379: aload_0
    //   380: getfield 15	com/tencent/open/business/cgireport/ReportManager$1:this$0	Lbfng;
    //   383: getfield 184	bfng:jdField_a_of_type_Bfne	Lbfne;
    //   386: aload_0
    //   387: getfield 15	com/tencent/open/business/cgireport/ReportManager$1:this$0	Lbfng;
    //   390: getfield 187	bfng:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   393: invokevirtual 192	bfne:a	(Ljava/util/ArrayList;)I
    //   396: pop
    //   397: return
    //   398: astore 5
    //   400: goto -166 -> 234
