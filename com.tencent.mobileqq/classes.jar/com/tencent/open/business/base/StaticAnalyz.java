...
public class StaticAnalyz
{
  ...
  public static void a(android.content.Context paramContext, String paramString)
  {
    ...
    //   3: dup
    //   4: invokespecial 99	java/lang/StringBuilder:<init>	()V
    //   7: aload_0
    //   8: invokevirtual 105	android/content/Context:getFilesDir	()Ljava/io/File;
    //   11: invokevirtual 109	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   14: getstatic 114	java/io/File:separator	Ljava/lang/String;
    ...
    //   25: invokevirtual 78	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   28: astore 4
    //   30: new 121	java/io/BufferedReader
    //   33: dup
    //   34: new 123	java/io/FileReader
    //   37: dup
    //   38: aload 4
    //   40: invokespecial 124	java/io/FileReader:<init>	(Ljava/lang/String;)V
    //   43: invokespecial 127	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   46: astore_3
    //   47: aload_3
    //   48: astore_2
    //   49: aload_3
    //   50: invokevirtual 130	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   53: astore 5
    //   55: aload_3
    //   56: astore_2
    //   57: aload_3
    //   58: invokevirtual 130	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   61: astore 6
    //   63: aload_3
    //   64: astore_2
    //   65: aload_3
    //   66: invokevirtual 130	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   69: astore 7
    //   71: aload_3
    //   72: astore_2
    //   73: aload 5
    ...
    //   112: ldc 132
    //   114: invokevirtual 117	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   117: aload 5
    //   119: invokevirtual 117	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   122: ldc 134
    //   124: invokevirtual 117	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   127: aload 6
    ...
    //   145: invokestatic 88	com/tencent/open/base/LogUtility:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   148: aload_3
    //   149: astore_2
    //   150: aload 5
    //   152: aload 6
    //   154: aload_1
    //   155: aload 7
    //   157: invokestatic 140	com/tencent/open/business/base/StaticAnalyz:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   160: aload_3
    //   161: astore_2
    //   162: new 111	java/io/File
    //   165: dup
    //   166: aload 4
    //   168: invokespecial 141	java/io/File:<init>	(Ljava/lang/String;)V
    //   171: invokevirtual 145	java/io/File:exists	()Z
    //   174: ifeq +12 -> 186
    //   177: aload_3
    //   178: astore_2
    //   179: aload_0
    //   180: ldc 119
    //   182: invokevirtual 148	android/content/Context:deleteFile	(Ljava/lang/String;)Z
    //   185: pop
    //   186: aload_3
    //   187: ifnull +7 -> 194
    //   190: aload_3
    //   191: invokevirtual 151	java/io/BufferedReader:close	()V
    //   194: return
    //   195: aload_3
    //   196: astore_2
    //   197: ldc 80
    //   199: new 65	java/lang/StringBuilder
    //   202: dup
    ...
    //   239: invokestatic 156	com/tencent/open/base/LogUtility:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   242: goto -56 -> 186
    //   245: astore_0
    //   246: aload_3
    //   247: astore_2
    //   248: aload_0
    //   249: invokevirtual 159	java/io/FileNotFoundException:printStackTrace	()V
    //   252: aload_3
    //   253: ifnull -59 -> 194
    //   256: aload_3
    //   257: invokevirtual 151	java/io/BufferedReader:close	()V
    //   260: return
    //   261: astore_0
    //   262: aload_0
    //   263: invokevirtual 160	java/io/IOException:printStackTrace	()V
    //   266: return
    //   267: astore_0
    //   268: aload_0
    //   269: invokevirtual 160	java/io/IOException:printStackTrace	()V
    //   272: return
    //   273: astore_0
    //   274: aconst_null
    //   275: astore_3
    ...
    //   283: ifnull -89 -> 194
    //   286: aload_3
    //   287: invokevirtual 151	java/io/BufferedReader:close	()V
    //   290: return
    //   291: astore_0
    //   292: aload_0
    //   293: invokevirtual 160	java/io/IOException:printStackTrace	()V
    //   296: return
    //   297: astore_0
    //   298: aconst_null
    //   299: astore_2
    ...
    //   301: ifnull +7 -> 308
    //   304: aload_2
    //   305: invokevirtual 151	java/io/BufferedReader:close	()V
    //   308: aload_0
    //   309: athrow
    //   310: astore_1
    //   311: aload_1
    //   312: invokevirtual 160	java/io/IOException:printStackTrace	()V
    //   315: goto -7 -> 308
    //   318: astore_0
    //   319: goto -19 -> 300
    //   322: astore_0
  ...
  public static void a(android.content.Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    ...
    //   26: dup
    //   27: invokespecial 99	java/lang/StringBuilder:<init>	()V
    //   30: ldc 163
    ...
    //   60: invokestatic 156	com/tencent/open/base/LogUtility:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   63: return
    //   64: aconst_null
    //   65: astore 4
    //   67: new 65	java/lang/StringBuilder
    //   70: dup
    //   71: invokespecial 99	java/lang/StringBuilder:<init>	()V
    //   74: aload_0
    //   75: invokevirtual 105	android/content/Context:getFilesDir	()Ljava/io/File;
    //   78: invokevirtual 109	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   81: getstatic 114	java/io/File:separator	Ljava/lang/String;
    ...
    //   95: astore 5
    //   97: new 111	java/io/File
    //   100: dup
    //   101: aload 5
    //   103: invokespecial 141	java/io/File:<init>	(Ljava/lang/String;)V
    //   106: invokevirtual 145	java/io/File:exists	()Z
    //   109: ifeq +10 -> 119
    //   112: aload_0
    //   113: ldc 119
    //   115: invokevirtual 148	android/content/Context:deleteFile	(Ljava/lang/String;)Z
    //   118: pop
    //   119: new 165	java/io/BufferedWriter
    //   122: dup
    //   123: new 167	java/io/FileWriter
    //   126: dup
    //   127: aload 5
    //   129: invokespecial 168	java/io/FileWriter:<init>	(Ljava/lang/String;)V
    ...
    //   139: aload_0
    //   140: aload_1
    //   141: invokevirtual 174	java/io/BufferedWriter:write	(Ljava/lang/String;)V
    //   144: aload_0
    //   145: astore 4
    //   147: aload_0
    //   148: invokevirtual 177	java/io/BufferedWriter:newLine	()V
    //   151: aload_0
    //   152: astore 4
    //   154: aload_0
    //   155: aload_2
    //   156: invokevirtual 174	java/io/BufferedWriter:write	(Ljava/lang/String;)V
    //   159: aload_0
    //   160: astore 4
    //   162: aload_0
    //   163: invokevirtual 177	java/io/BufferedWriter:newLine	()V
    //   166: aload_0
    //   167: astore 4
    //   169: aload_0
    //   170: aload_3
    //   171: invokevirtual 174	java/io/BufferedWriter:write	(Ljava/lang/String;)V
    //   174: aload_0
    //   175: astore 4
    //   177: aload_0
    //   178: invokevirtual 180	java/io/BufferedWriter:flush	()V
    //   181: aload_0
    //   182: astore 4
    //   184: ldc 80
    ...
    //   193: ldc 182
    //   195: invokevirtual 117	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   198: aload_1
    //   199: invokevirtual 117	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   202: ldc 134
    ...
    //   223: invokestatic 88	com/tencent/open/base/LogUtility:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   226: aload_0
    //   227: ifnull -164 -> 63
    //   230: aload_0
    //   231: invokevirtual 183	java/io/BufferedWriter:close	()V
    //   234: return
    //   235: astore_0
    //   236: aload_0
    //   237: invokevirtual 160	java/io/IOException:printStackTrace	()V
    //   240: return
    //   241: astore_1
    //   242: aload 4
    //   244: astore_0
    //   245: aload_1
    //   246: invokevirtual 159	java/io/FileNotFoundException:printStackTrace	()V
    //   249: aload_0
    //   250: ifnull -187 -> 63
    //   253: aload_0
    //   254: invokevirtual 183	java/io/BufferedWriter:close	()V
    //   257: return
    //   258: astore_0
    //   259: aload_0
    //   260: invokevirtual 160	java/io/IOException:printStackTrace	()V
    //   263: return
    //   264: astore_1
    //   265: aconst_null
    //   266: astore_0
    ...
    //   268: astore 4
    //   270: aload_1
    //   271: invokevirtual 160	java/io/IOException:printStackTrace	()V
    //   274: aload_0
    //   275: ifnull -212 -> 63
    //   278: aload_0
    //   279: invokevirtual 183	java/io/BufferedWriter:close	()V
    //   282: return
    //   283: astore_0
    //   284: aload_0
    //   285: invokevirtual 160	java/io/IOException:printStackTrace	()V
    //   288: return
    //   289: astore_0
    //   290: aconst_null
    //   291: astore 4
    ...
    //   295: ifnull +8 -> 303
    //   298: aload 4
    //   300: invokevirtual 183	java/io/BufferedWriter:close	()V
    //   303: aload_0
    //   304: athrow
    //   305: astore_1
    //   306: aload_1
    //   307: invokevirtual 160	java/io/IOException:printStackTrace	()V
    //   310: goto -7 -> 303
    //   313: astore_0
    //   314: goto -21 -> 293
    //   317: astore_1
  ...
  public static void a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    LogUtility.b("reportForVia", "reportForVia actionType=" + paramString1 + " via=" + paramString2 + ", appid=" + paramString3);
  ...
  public static void b(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    LogUtility.b("reportForVia", "reportForVia actionType=" + paramString1 + " via=" + paramString2 + ", appid=" + paramString4);
