...
public class StaticAnalyz
{
    ...
    try
    {
      if ((!TextUtils.isEmpty(paramString1)) && (!TextUtils.isEmpty(paramString2)))
      {
        ...
        if (i != -1)
        {
          ...
          paramString1.insert(i, ".");
          paramString1.insert(i + 1, paramString2);
  ...
  public static void a(android.content.Context paramContext, String paramString)
  {
    ...
    //   7: aload_0
    //   8: invokevirtual 97	android/content/Context:getFilesDir	()Ljava/io/File;
    //   11: invokevirtual 101	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   14: getstatic 106	java/io/File:separator	Ljava/lang/String;
    ...
    //   28: astore 4
    //   30: new 113	java/io/BufferedReader
    //   33: dup
    //   34: new 115	java/io/FileReader
    //   37: dup
    //   38: aload 4
    //   40: invokespecial 116	java/io/FileReader:<init>	(Ljava/lang/String;)V
    //   43: invokespecial 119	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   46: astore_3
    //   47: aload_3
    //   48: astore_2
    //   49: aload_3
    //   50: invokevirtual 122	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   53: astore 5
    //   55: aload_3
    //   56: astore_2
    //   57: aload_3
    ...
    //   64: astore_2
    //   65: aload_3
    //   66: invokevirtual 122	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   69: astore 7
    //   71: aload_3
    //   72: astore_2
    //   73: aload 5
    //   75: invokestatic 43	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   78: ifne +117 -> 195
    //   81: aload_3
    //   82: astore_2
    //   83: aload 6
    //   85: invokestatic 43	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   88: ifne +107 -> 195
    //   91: aload_3
    //   92: astore_2
    //   93: aload 7
    //   95: invokestatic 43	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   98: ifne +97 -> 195
    //   101: aload_3
    //   102: astore_2
    //   103: ldc 72
    ...
    //   142: invokevirtual 70	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   145: invokestatic 80	com/tencent/open/base/LogUtility:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   148: aload_3
    //   149: astore_2
    //   150: aload 5
    //   152: aload 6
    //   154: aload_1
    //   155: aload 7
    //   157: invokestatic 132	com/tencent/open/business/base/StaticAnalyz:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   160: aload_3
    //   161: astore_2
    //   162: new 103	java/io/File
    //   165: dup
    //   166: aload 4
    //   168: invokespecial 133	java/io/File:<init>	(Ljava/lang/String;)V
    //   171: invokevirtual 137	java/io/File:exists	()Z
    //   174: ifeq +12 -> 186
    //   177: aload_3
    //   178: astore_2
    //   179: aload_0
    //   180: ldc 111
    //   182: invokevirtual 141	android/content/Context:deleteFile	(Ljava/lang/String;)Z
    //   185: pop
    //   186: aload_3
    //   187: ifnull +7 -> 194
    //   190: aload_3
    //   191: invokevirtual 144	java/io/BufferedReader:close	()V
    //   194: return
    //   195: aload_3
    //   196: astore_2
    //   197: ldc 72
    ...
    //   211: aload 5
    //   213: invokevirtual 109	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   216: ldc 126
    //   218: invokevirtual 109	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   221: aload 6
    //   223: invokevirtual 109	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   226: ldc 128
    //   228: invokevirtual 109	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   231: aload 7
    ...
    //   239: invokestatic 149	com/tencent/open/base/LogUtility:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   242: goto -56 -> 186
    //   245: astore_0
    //   246: aload_3
    //   247: astore_2
    //   248: aload_0
    //   249: invokevirtual 152	java/io/FileNotFoundException:printStackTrace	()V
    //   252: aload_3
    //   253: ifnull -59 -> 194
    //   256: aload_3
    //   257: invokevirtual 144	java/io/BufferedReader:close	()V
    //   260: return
    //   261: astore_0
    //   262: aload_0
    //   263: invokevirtual 153	java/io/IOException:printStackTrace	()V
    //   266: return
    //   267: astore_0
    //   268: aload_0
    //   269: invokevirtual 153	java/io/IOException:printStackTrace	()V
    //   272: return
    //   273: astore_0
    //   274: aconst_null
    //   275: astore_3
    ...
    //   277: astore_2
    //   278: aload_0
    //   279: invokevirtual 153	java/io/IOException:printStackTrace	()V
    //   282: aload_3
    //   283: ifnull -89 -> 194
    //   286: aload_3
    ...
    //   291: astore_0
    //   292: aload_0
    //   293: invokevirtual 153	java/io/IOException:printStackTrace	()V
    //   296: return
    //   297: astore_0
    //   298: aconst_null
    //   299: astore_2
    ...
    //   301: ifnull +7 -> 308
    //   304: aload_2
    //   305: invokevirtual 144	java/io/BufferedReader:close	()V
    //   308: aload_0
    //   309: athrow
    //   310: astore_1
    //   311: aload_1
    //   312: invokevirtual 153	java/io/IOException:printStackTrace	()V
    //   315: goto -7 -> 308
    //   318: astore_0
    //   319: goto -19 -> 300
    //   322: astore_0
  ...
  public static void a(android.content.Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    ...
    //   11: ifne +10 -> 21
    //   14: aload_3
    //   15: invokestatic 43	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   18: ifeq +46 -> 64
    //   21: ldc 72
    ...
    //   48: ldc 128
    //   50: invokevirtual 109	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   53: aload_3
    ...
    //   60: invokestatic 149	com/tencent/open/base/LogUtility:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   63: return
    //   64: aconst_null
    //   65: astore 4
    //   67: new 57	java/lang/StringBuilder
    //   70: dup
    //   71: invokespecial 91	java/lang/StringBuilder:<init>	()V
    //   74: aload_0
    //   75: invokevirtual 97	android/content/Context:getFilesDir	()Ljava/io/File;
    //   78: invokevirtual 101	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   81: getstatic 106	java/io/File:separator	Ljava/lang/String;
    //   84: invokevirtual 109	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   87: ldc 111
    //   89: invokevirtual 109	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   92: invokevirtual 70	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   95: astore 5
    //   97: new 103	java/io/File
    //   100: dup
    //   101: aload 5
    //   103: invokespecial 133	java/io/File:<init>	(Ljava/lang/String;)V
    //   106: invokevirtual 137	java/io/File:exists	()Z
    //   109: ifeq +10 -> 119
    //   112: aload_0
    //   113: ldc 111
    //   115: invokevirtual 141	android/content/Context:deleteFile	(Ljava/lang/String;)Z
    //   118: pop
    //   119: new 158	java/io/BufferedWriter
    //   122: dup
    //   123: new 160	java/io/FileWriter
    //   126: dup
    //   127: aload 5
    //   129: invokespecial 161	java/io/FileWriter:<init>	(Ljava/lang/String;)V
    //   132: invokespecial 164	java/io/BufferedWriter:<init>	(Ljava/io/Writer;)V
    //   135: astore_0
    //   136: aload_0
    //   137: astore 4
    //   139: aload_0
    //   140: aload_1
    //   141: invokevirtual 167	java/io/BufferedWriter:write	(Ljava/lang/String;)V
    //   144: aload_0
    //   145: astore 4
    //   147: aload_0
    //   148: invokevirtual 170	java/io/BufferedWriter:newLine	()V
    //   151: aload_0
    //   152: astore 4
    //   154: aload_0
    //   155: aload_2
    //   156: invokevirtual 167	java/io/BufferedWriter:write	(Ljava/lang/String;)V
    //   159: aload_0
    //   160: astore 4
    //   162: aload_0
    //   163: invokevirtual 170	java/io/BufferedWriter:newLine	()V
    //   166: aload_0
    //   167: astore 4
    //   169: aload_0
    //   170: aload_3
    //   171: invokevirtual 167	java/io/BufferedWriter:write	(Ljava/lang/String;)V
    //   174: aload_0
    //   175: astore 4
    //   177: aload_0
    //   178: invokevirtual 173	java/io/BufferedWriter:flush	()V
    //   181: aload_0
    //   182: astore 4
    //   184: ldc 72
    ...
    //   198: aload_1
    //   199: invokevirtual 109	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   202: ldc 126
    //   204: invokevirtual 109	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   207: aload_2
    //   208: invokevirtual 109	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   211: ldc 128
    //   213: invokevirtual 109	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    //   223: invokestatic 80	com/tencent/open/base/LogUtility:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   226: aload_0
    //   227: ifnull -164 -> 63
    //   230: aload_0
    //   231: invokevirtual 176	java/io/BufferedWriter:close	()V
    //   234: return
    //   235: astore_0
    //   236: aload_0
    //   237: invokevirtual 153	java/io/IOException:printStackTrace	()V
    //   240: return
    //   241: astore_1
    //   242: aload 4
    //   244: astore_0
    //   245: aload_1
    //   246: invokevirtual 152	java/io/FileNotFoundException:printStackTrace	()V
    //   249: aload_0
    //   250: ifnull -187 -> 63
    //   253: aload_0
    //   254: invokevirtual 176	java/io/BufferedWriter:close	()V
    //   257: return
    //   258: astore_0
    //   259: aload_0
    //   260: invokevirtual 153	java/io/IOException:printStackTrace	()V
    //   263: return
    //   264: astore_1
    //   265: aconst_null
    //   266: astore_0
    ...
    //   268: astore 4
    //   270: aload_1
    //   271: invokevirtual 153	java/io/IOException:printStackTrace	()V
    //   274: aload_0
    //   275: ifnull -212 -> 63
    //   278: aload_0
    //   279: invokevirtual 176	java/io/BufferedWriter:close	()V
    //   282: return
    //   283: astore_0
    //   284: aload_0
    //   285: invokevirtual 153	java/io/IOException:printStackTrace	()V
    //   288: return
    //   289: astore_0
    //   290: aconst_null
    //   291: astore 4
    ...
    //   295: ifnull +8 -> 303
    //   298: aload 4
    //   300: invokevirtual 176	java/io/BufferedWriter:close	()V
    //   303: aload_0
    //   304: athrow
    //   305: astore_1
    //   306: aload_1
    //   307: invokevirtual 153	java/io/IOException:printStackTrace	()V
    //   310: goto -7 -> 303
    //   313: astore_0
    //   314: goto -21 -> 293
    //   317: astore_1
  ...
  public static void a(String paramString1, String paramString2, String paramString3, String paramString4, Bundle paramBundle)
  {
    ...
    OpenSdkStatic.a().a(String.valueOf(l), paramString3, paramString2, paramString1, CommonDataAdapter.a().f(), paramBundle, paramString4, false);
  }
