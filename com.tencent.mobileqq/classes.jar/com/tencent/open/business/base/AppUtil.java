...
public class AppUtil
{
  ...
  public static String a(String[] paramArrayOfString)
  {
    ...
    //   15: aload 6
    //   17: astore_2
    //   18: new 214	java/lang/ProcessBuilder
    //   21: dup
    //   22: aload_0
    //   23: invokespecial 217	java/lang/ProcessBuilder:<init>	([Ljava/lang/String;)V
    //   26: astore_0
    //   27: aload 5
    //   29: astore 4
    //   31: aload_3
    ...
    //   36: aload_0
    //   37: iconst_0
    //   38: invokevirtual 221	java/lang/ProcessBuilder:redirectErrorStream	(Z)Ljava/lang/ProcessBuilder;
    //   41: pop
    //   42: aload 5
    //   44: astore 4
    //   46: aload_3
    ...
    //   50: astore_2
    //   51: aload_0
    //   52: invokevirtual 224	java/lang/ProcessBuilder:start	()Ljava/lang/Process;
    //   55: astore_0
    //   56: aload_0
    //   57: astore 4
    //   59: aload_3
    ...
    //   61: aload_0
    //   62: astore_2
    //   63: new 245	java/io/DataOutputStream
    //   66: dup
    //   67: aload_0
    //   68: invokevirtual 251	java/lang/Process:getOutputStream	()Ljava/io/OutputStream;
    //   71: invokespecial 254	java/io/DataOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   74: astore 5
    //   76: aload_0
    //   77: astore 4
    //   79: aload_3
    ...
    //   81: aload_0
    //   82: astore_2
    //   83: new 256	java/io/DataInputStream
    //   86: dup
    //   87: aload_0
    //   88: invokevirtual 260	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    //   91: invokespecial 263	java/io/DataInputStream:<init>	(Ljava/io/InputStream;)V
    //   94: invokevirtual 266	java/io/DataInputStream:readLine	()Ljava/lang/String;
    //   97: astore_3
    //   98: aload_0
    //   99: astore 4
    //   101: aload_3
    ...
    //   105: aload 5
    //   107: ldc_w 268
    //   110: invokevirtual 271	java/io/DataOutputStream:writeBytes	(Ljava/lang/String;)V
    //   113: aload_0
    //   114: astore 4
    //   116: aload_3
    //   117: astore_1
    ...
    //   119: astore_2
    //   120: aload 5
    //   122: invokevirtual 274	java/io/DataOutputStream:flush	()V
    //   125: aload_0
    //   126: astore 4
    //   128: aload_3
    //   129: astore_1
    ...
    //   131: astore_2
    //   132: aload_0
    //   133: invokevirtual 277	java/lang/Process:waitFor	()I
    //   136: pop
    //   137: aload_3
    //   138: astore 4
    //   140: aload_0
    ...
    //   145: astore_1
    //   146: aload_0
    //   147: invokevirtual 280	java/lang/Process:destroy	()V
    //   150: aload_1
    //   151: areturn
    //   152: astore_0
    //   153: aload 4
    //   155: ifnull +8 -> 163
    //   158: aload 4
    //   160: invokevirtual 280	java/lang/Process:destroy	()V
    //   163: aload_0
    //   164: athrow
    //   165: aload_1
    //   166: astore 4
    ...
    //   0	184	0	paramArrayOfString	String[]
    //   14	152	1	str1	String
    //   17	156	2	localObject1	Object
    //   2	143	3	str2	String
    //   11	167	4	localObject2	Object
    //   7	114	5	localDataOutputStream	DataOutputStream
    ...
    //   120	125	152	finally
    //   132	137	152	finally
    //   18	27	180	java/lang/Exception
    //   36	42	180	java/lang/Exception
    //   51	56	180	java/lang/Exception
    //   63	76	180	java/lang/Exception
    //   83	98	180	java/lang/Exception
    //   105	113	180	java/lang/Exception
    //   120	125	180	java/lang/Exception
  ...
  public static void a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    if (paramString1 != null)
    {
      ...
      catch (Exception paramString1)
      {
        ...
        Toast.makeText(paramContext, HardCodeUtil.a(2131700852), 0).show();
        return;
      }
    }
    Toast.makeText(paramContext, HardCodeUtil.a(2131700853), 0).show();
  }
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    ...
    Toast.makeText(paramContext, HardCodeUtil.a(2131700854), 0).show();
  }
  ...
  public static void a(String paramString)
  {
    ...
    //   8: invokevirtual 363	java/io/File:length	()J
    //   11: lstore 5
    //   13: new 347	com/tencent/commonsdk/zip/QZipFile
    //   16: dup
    //   17: aload_0
    //   18: invokespecial 364	com/tencent/commonsdk/zip/QZipFile:<init>	(Ljava/lang/String;)V
    //   21: astore_0
    //   22: aload_0
    //   23: invokevirtual 368	com/tencent/commonsdk/zip/QZipFile:entries	()Ljava/util/Enumeration;
    //   26: astore 11
    //   28: iconst_0
    //   29: istore_2
    //   30: iconst_0
    ...
    //   39: ifeq +219 -> 258
    //   42: aload 11
    //   44: invokeinterface 376 1 0
    //   49: checkcast 378	java/util/zip/ZipEntry
    //   52: astore 12
    //   54: aload 12
    //   56: invokevirtual 381	java/util/zip/ZipEntry:isDirectory	()Z
    //   59: ifeq +6 -> 65
    //   62: goto -30 -> 32
    //   65: aload 12
    //   67: invokevirtual 384	java/util/zip/ZipEntry:getCompressedSize	()J
    //   70: lstore 7
    //   72: aload 12
    //   74: invokevirtual 387	java/util/zip/ZipEntry:getSize	()J
    //   77: lstore 9
    //   79: lload 7
    //   81: ldc2_w 388
    //   84: lcmp
    ...
    //   114: ifgt +133 -> 247
    //   117: aload 12
    //   119: invokevirtual 394	java/util/zip/ZipEntry:getName	()Ljava/lang/String;
    //   122: ifnull +57 -> 179
    //   125: aload 12
    //   127: invokevirtual 394	java/util/zip/ZipEntry:getName	()Ljava/lang/String;
    //   130: ldc_w 396
    //   133: invokevirtual 399	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   136: ifeq +43 -> 179
    //   139: lload 7
    //   141: lconst_0
    //   142: lcmp
    ...
    //   154: aload 12
    //   156: iconst_0
    //   157: invokestatic 401	com/tencent/open/business/base/AppUtil:a	(Lcom/tencent/commonsdk/zip/QZipFile;Ljava/util/zip/ZipEntry;Z)V
    //   160: iconst_1
    //   161: istore 4
    //   163: iload_2
    //   164: istore_3
    //   165: goto +58 -> 223
    //   168: new 403	java/lang/RuntimeException
    //   171: dup
    //   172: ldc_w 405
    //   175: invokespecial 406	java/lang/RuntimeException:<init>	(Ljava/lang/String;)V
    //   178: athrow
    //   179: iload_2
    //   180: istore_3
    //   181: iload_1
    //   182: istore 4
    //   184: aload 12
    //   186: invokevirtual 394	java/util/zip/ZipEntry:getName	()Ljava/lang/String;
    //   189: ifnull +34 -> 223
    //   192: iload_2
    //   193: istore_3
    //   194: iload_1
    //   195: istore 4
    //   197: aload 12
    //   199: invokevirtual 394	java/util/zip/ZipEntry:getName	()Ljava/lang/String;
    //   202: ldc_w 408
    //   205: invokevirtual 399	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   208: ifeq +15 -> 223
    //   211: aload_0
    //   212: aload 12
    //   214: iconst_0
    //   215: invokestatic 401	com/tencent/open/business/base/AppUtil:a	(Lcom/tencent/commonsdk/zip/QZipFile;Ljava/util/zip/ZipEntry;Z)V
    //   218: iconst_1
    //   219: istore_3
    //   220: iload_1
    //   221: istore 4
    ...
    //   239: ifeq -207 -> 32
    //   242: aload_0
    //   243: invokevirtual 409	com/tencent/commonsdk/zip/QZipFile:close	()V
    //   246: return
    //   247: new 403	java/lang/RuntimeException
    //   250: dup
    //   251: ldc_w 411
    //   254: invokespecial 406	java/lang/RuntimeException:<init>	(Ljava/lang/String;)V
    //   257: athrow
    //   258: aload_0
    //   259: invokevirtual 409	com/tencent/commonsdk/zip/QZipFile:close	()V
    //   262: return
    //   263: astore 11
    //   265: goto +7 -> 272
    //   268: astore 11
    ...
    //   273: ifnull +7 -> 280
    //   276: aload_0
    //   277: invokevirtual 409	com/tencent/commonsdk/zip/QZipFile:close	()V
    //   280: goto +6 -> 286
    //   283: aload 11
    //   285: athrow
    //   286: goto -3 -> 283
  ...
  public static boolean a(Context paramContext, String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    return true;
    Toast.makeText(paramContext, HardCodeUtil.a(2131700855), 0).show();
    return false;
  }
  ...
  {
    return PackageUtil.a(CommonDataAdapter.a().a(), paramString);
  }
  ...
  {
    // Byte code:
    //   0: invokestatic 586	com/tencent/open/business/base/AppUtil:a	()Ljava/lang/Process;
    //   3: astore 7
    //   5: iconst_0
    //   6: istore 4
    //   8: iconst_0
    ...
    //   18: iconst_0
    //   19: ireturn
    //   20: new 245	java/io/DataOutputStream
    //   23: dup
    //   24: aload 7
    //   26: invokevirtual 251	java/lang/Process:getOutputStream	()Ljava/io/OutputStream;
    //   29: invokespecial 254	java/io/DataOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   32: astore 9
    //   34: new 588	java/io/BufferedReader
    //   37: dup
    //   38: new 590	java/io/InputStreamReader
    //   41: dup
    //   42: aload 7
    //   44: invokevirtual 260	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    //   47: ldc_w 592
    //   50: invokespecial 595	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;Ljava/lang/String;)V
    //   53: invokespecial 598	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   56: astore 8
    ...
    //   66: astore 13
    //   68: aload 13
    //   70: invokevirtual 601	java/io/File:getParent	()Ljava/lang/String;
    //   73: astore 12
    //   75: new 48	java/io/File
    //   78: dup
    //   79: aload 12
    //   81: invokespecial 51	java/io/File:<init>	(Ljava/lang/String;)V
    //   84: invokevirtual 601	java/io/File:getParent	()Ljava/lang/String;
    //   87: astore 11
    //   89: new 48	java/io/File
    //   92: dup
    //   93: aload 11
    //   95: invokespecial 51	java/io/File:<init>	(Ljava/lang/String;)V
    //   98: invokevirtual 601	java/io/File:getParent	()Ljava/lang/String;
    //   101: astore 10
    ...
    //   121: aload 14
    //   123: aload 13
    //   125: invokevirtual 606	java/io/File:getAbsolutePath	()Ljava/lang/String;
    ...
    //   148: invokevirtual 612	java/lang/String:getBytes	()[B
    //   151: invokevirtual 616	java/io/DataOutputStream:write	([B)V
    //   154: aload 9
    //   156: invokevirtual 274	java/io/DataOutputStream:flush	()V
    ...
    //   201: invokevirtual 271	java/io/DataOutputStream:writeBytes	(Ljava/lang/String;)V
    //   204: aload 9
    //   206: invokevirtual 274	java/io/DataOutputStream:flush	()V
    ...
    //   251: invokevirtual 271	java/io/DataOutputStream:writeBytes	(Ljava/lang/String;)V
    //   254: aload 9
    //   256: invokevirtual 274	java/io/DataOutputStream:flush	()V
    ...
    //   301: invokevirtual 271	java/io/DataOutputStream:writeBytes	(Ljava/lang/String;)V
    //   304: aload 9
    //   306: invokevirtual 274	java/io/DataOutputStream:flush	()V
    ...
    //   350: invokevirtual 612	java/lang/String:getBytes	()[B
    //   353: invokevirtual 616	java/io/DataOutputStream:write	([B)V
    //   356: aload 9
    //   358: invokevirtual 274	java/io/DataOutputStream:flush	()V
    //   361: aload 9
    //   363: invokevirtual 619	java/io/DataOutputStream:close	()V
    //   366: sipush 1024
    //   369: newarray char
    //   371: astore_0
    //   372: aload 8
    //   374: aload_0
    //   375: invokevirtual 622	java/io/BufferedReader:read	([C)I
    //   378: istore_1
    ...
    //   396: iconst_0
    //   397: iload_1
    //   398: invokevirtual 625	java/lang/StringBuilder:append	([CII)Ljava/lang/StringBuilder;
    //   401: pop
    //   402: aload 8
    ...
    //   422: iconst_0
    //   423: aload 7
    //   425: invokevirtual 628	java/lang/Process:getErrorStream	()Ljava/io/InputStream;
    //   428: aload_0
    //   429: invokevirtual 356	java/io/InputStream:read	([B)I
    //   432: invokespecial 631	java/lang/String:<init>	([BII)V
    //   435: astore_0
    //   436: iload_3
    //   437: istore_2
    //   438: aload_0
    ...
    //   442: ifne +24 -> 466
    //   445: aload_0
    //   446: invokevirtual 634	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   449: ldc_w 636
    //   452: invokevirtual 399	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   455: istore 6
    //   457: iload_3
    //   458: istore_2
    //   459: iload 6
    ...
    //   470: ifnull +33 -> 503
    //   473: aload 7
    //   475: invokevirtual 280	java/lang/Process:destroy	()V
    //   478: iload_2
    //   479: ireturn
    //   480: astore_0
    //   481: goto +24 -> 505
    //   484: astore_0
    //   485: aload_0
    //   486: invokevirtual 225	java/lang/Exception:printStackTrace	()V
    //   489: iload 5
    //   491: istore_3
    //   492: aload 7
    //   494: ifnull +9 -> 503
    ...
    //   507: ifnull +8 -> 515
    //   510: aload 7
    //   512: invokevirtual 280	java/lang/Process:destroy	()V
    //   515: goto +5 -> 520
    //   518: aload_0
    //   519: athrow
    //   520: goto -2 -> 518
