...
public class AppUtil
{
  ...
  {
    // Byte code:
    //   0: new 214	java/lang/ProcessBuilder
    //   3: dup
    //   4: aload_0
    //   5: invokespecial 217	java/lang/ProcessBuilder:<init>	([Ljava/lang/String;)V
    //   8: astore_0
    //   9: aload_0
    //   10: iconst_0
    //   11: invokevirtual 221	java/lang/ProcessBuilder:redirectErrorStream	(Z)Ljava/lang/ProcessBuilder;
    //   14: pop
    //   15: aload_0
    //   16: invokevirtual 224	java/lang/ProcessBuilder:start	()Ljava/lang/Process;
    //   19: astore_1
    //   20: new 245	java/io/DataOutputStream
    //   23: dup
    //   24: aload_1
    //   25: invokevirtual 251	java/lang/Process:getOutputStream	()Ljava/io/OutputStream;
    //   28: invokespecial 254	java/io/DataOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   31: astore_2
    //   32: new 256	java/io/DataInputStream
    //   35: dup
    //   36: aload_1
    //   37: invokevirtual 260	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    //   40: invokespecial 263	java/io/DataInputStream:<init>	(Ljava/io/InputStream;)V
    //   43: astore_0
    //   44: aload_0
    //   45: ifnull +88 -> 133
    //   48: aload_2
    //   49: ifnull +84 -> 133
    //   52: aload_0
    //   53: invokevirtual 266	java/io/DataInputStream:readLine	()Ljava/lang/String;
    //   56: astore_0
    //   57: aload_2
    //   58: ldc_w 268
    //   61: invokevirtual 271	java/io/DataOutputStream:writeBytes	(Ljava/lang/String;)V
    //   64: aload_2
    //   65: invokevirtual 274	java/io/DataOutputStream:flush	()V
    //   68: aload_1
    //   69: invokevirtual 277	java/lang/Process:waitFor	()I
    //   72: pop
    //   73: aload_0
    //   74: astore_2
    //   75: aload_1
    //   76: ifnull +9 -> 85
    //   79: aload_1
    //   80: invokevirtual 280	java/lang/Process:destroy	()V
    //   83: aload_0
    //   84: astore_2
    //   85: aload_2
    //   86: areturn
    ...
    //   96: ifnull -11 -> 85
    //   99: aload_1
    //   100: invokevirtual 280	java/lang/Process:destroy	()V
    //   103: aload_0
    //   104: areturn
    //   105: astore_0
    //   106: aconst_null
    ...
    //   109: ifnull +7 -> 116
    //   112: aload_1
    //   113: invokevirtual 280	java/lang/Process:destroy	()V
    //   116: aload_0
    //   117: athrow
    //   118: astore_0
    //   119: goto -11 -> 108
    ...
    catch (Exception localException)
    {
      ...
      if (paramString1 != null)
      {
        ...
        catch (Exception paramString1)
        {
          ...
          Toast.makeText(paramContext, HardCodeUtil.a(2131700710), 0).show();
          return;
        }
      }
      Toast.makeText(paramContext, HardCodeUtil.a(2131700711), 0).show();
    }
  }
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    ...
    {
      Toast.makeText(paramContext, HardCodeUtil.a(2131700712), 0).show();
    }
  }
  ...
  public static void a(QZipFile paramQZipFile, ZipEntry paramZipEntry, boolean paramBoolean)
  {
    ...
    //   10: aload_0
    //   11: aload_1
    //   12: invokevirtual 350	com/tencent/commonsdk/zip/QZipFile:getInputStream	(Ljava/util/zip/ZipEntry;)Ljava/io/InputStream;
    //   15: astore_0
    //   16: iload_2
    //   17: ifeq +27 -> 44
    //   20: aload_0
    ...
    //   23: aload_0
    //   24: aload 5
    //   26: invokevirtual 356	java/io/InputStream:read	([B)I
    //   29: istore_3
    //   30: iconst_m1
    //   31: iload_3
    //   32: if_icmpne -12 -> 20
    ...
    //   36: ifnull +7 -> 43
    //   39: aload_0
    //   40: invokevirtual 359	java/io/InputStream:close	()V
    //   43: return
    //   44: aload_0
    //   45: astore 4
    //   47: aload_0
    //   48: aload 5
    //   50: invokevirtual 356	java/io/InputStream:read	([B)I
    //   53: pop
    //   54: goto -19 -> 35
    //   57: astore_0
    //   58: aload 4
    //   60: ifnull +8 -> 68
    //   63: aload 4
    //   65: invokevirtual 359	java/io/InputStream:close	()V
    //   68: aload_0
    //   69: athrow
    // Local variable table:
    //   start	length	slot	name	signature
    ...
    if (localIntent == null)
    {
      ...
      try
      {
        for (;;)
        {
          ...
          try
          {
            ((StartAppCheckHandler)((BaseActivity)paramContext).app.getBusinessHandler(BusinessHandlerFactory.STARTAPPCHECK_HANDLER)).b(paramString.trim(), paramContext, localIntent);
            return true;
          }
      ...
      {
        Toast.makeText(paramContext, HardCodeUtil.a(2131700713), 0).show();
        return false;
      }
    }
  }
  ...
  public static boolean a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    try
    {
      ...
      if (new File(paramString1).exists())
      {
        ...
        {
          LogUtility.b("AppUtil", "installApp>>> put source " + paramString2);
          paramString1.putExtra("big_brother_source_key", paramString2);
        }
        if (!TextUtils.isEmpty(paramString3))
        {
          LogUtility.b("AppUtil", "installApp>>> put ref id " + paramString3);
