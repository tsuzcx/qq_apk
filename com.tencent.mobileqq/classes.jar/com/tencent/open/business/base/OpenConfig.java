...
public class OpenConfig
{
  ...
  public String a(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 22	com/tencent/open/business/base/OpenConfig:b	Ljava/lang/String;
    //   4: ifnull +102 -> 106
    //   7: new 72	java/lang/StringBuilder
    //   10: dup
    //   11: invokespecial 73	java/lang/StringBuilder:<init>	()V
    //   14: aload_1
    ...
    //   23: aload_0
    //   24: getfield 22	com/tencent/open/business/base/OpenConfig:b	Ljava/lang/String;
    ...
    //   33: astore_2
    //   34: aload_0
    //   35: getfield 20	com/tencent/open/business/base/OpenConfig:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   38: aload_2
    //   39: invokevirtual 89	android/content/Context:openFileInput	(Ljava/lang/String;)Ljava/io/FileInputStream;
    //   42: astore_2
    //   43: aload_2
    //   44: astore_1
    //   45: new 91	java/io/BufferedReader
    //   48: dup
    //   49: new 93	java/io/InputStreamReader
    //   52: dup
    //   53: aload_1
    //   54: invokespecial 96	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   57: invokespecial 99	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   60: astore_2
    //   61: new 101	java/lang/StringBuffer
    //   64: dup
    //   65: invokespecial 102	java/lang/StringBuffer:<init>	()V
    //   68: astore_3
    //   69: aload_2
    //   70: invokevirtual 105	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   73: astore 4
    //   75: aload 4
    //   77: ifnull +58 -> 135
    //   80: aload_3
    //   81: aload 4
    //   83: invokevirtual 108	java/lang/StringBuffer:append	(Ljava/lang/String;)Ljava/lang/StringBuffer;
    //   86: pop
    //   87: goto -18 -> 69
    //   90: astore_3
    //   91: aload_3
    ...
    //   95: aload_1
    //   96: invokevirtual 116	java/io/InputStream:close	()V
    //   99: aload_2
    //   100: invokevirtual 117	java/io/BufferedReader:close	()V
    //   103: ldc 119
    //   105: areturn
    //   106: aload_1
    //   107: astore_2
    ...
    //   111: astore_2
    //   112: aload_0
    //   113: getfield 20	com/tencent/open/business/base/OpenConfig:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   116: invokevirtual 123	android/content/Context:getAssets	()Landroid/content/res/AssetManager;
    //   119: aload_1
    //   120: invokevirtual 129	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   123: astore_1
    //   124: goto -79 -> 45
    //   127: astore_1
    //   128: aload_1
    ...
    //   134: areturn
    //   135: aload_3
    //   136: invokevirtual 130	java/lang/StringBuffer:toString	()Ljava/lang/String;
    //   139: astore_3
    //   140: aload_1
    //   141: invokevirtual 116	java/io/InputStream:close	()V
    //   144: aload_2
    ...
    //   157: astore_1
    //   158: aload_1
    //   159: invokevirtual 111	java/io/IOException:printStackTrace	()V
    //   162: ldc 119
    //   164: areturn
    //   165: astore_3
    //   166: aload_1
    //   167: invokevirtual 116	java/io/InputStream:close	()V
    //   170: aload_2
    //   171: invokevirtual 117	java/io/BufferedReader:close	()V
    //   174: aload_3
    //   175: athrow
    //   176: astore_1
    //   177: aload_1
    //   178: invokevirtual 111	java/io/IOException:printStackTrace	()V
    //   181: goto -7 -> 174
  ...
  protected void a()
  {
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      ThreadManager.executeOnSubThread(new akpz(this));
    }
  }
  ...
  protected void a(String paramString1, String paramString2)
  {
    ...
    //   4: astore_3
    //   5: aload_0
    //   6: getfield 22	com/tencent/open/business/base/OpenConfig:b	Ljava/lang/String;
    //   9: ifnull +30 -> 39
    ...
    //   28: aload_0
    //   29: getfield 22	com/tencent/open/business/base/OpenConfig:b	Ljava/lang/String;
    //   32: invokevirtual 77	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   35: invokevirtual 83	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   38: astore_3
    //   39: aload_0
    //   40: getfield 20	com/tencent/open/business/base/OpenConfig:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   43: aload_3
    //   44: iconst_0
    //   45: invokevirtual 147	android/content/Context:openFileOutput	(Ljava/lang/String;I)Ljava/io/FileOutputStream;
    //   48: astore_1
    //   49: new 149	java/io/OutputStreamWriter
    //   52: dup
    //   53: aload_1
    //   54: invokespecial 152	java/io/OutputStreamWriter:<init>	(Ljava/io/OutputStream;)V
    //   57: astore_3
    //   58: aload_3
    //   59: aload_2
    //   60: invokevirtual 156	java/io/OutputStreamWriter:write	(Ljava/lang/String;)V
    //   63: aload_3
    //   64: invokevirtual 159	java/io/OutputStreamWriter:flush	()V
    //   67: aload_1
    //   68: ifnull +7 -> 75
    //   71: aload_1
    //   72: invokevirtual 162	java/io/FileOutputStream:close	()V
    //   75: aload_3
    //   76: ifnull +7 -> 83
    //   79: aload_3
    //   80: invokevirtual 163	java/io/OutputStreamWriter:close	()V
    //   83: return
    //   84: astore_2
    //   85: aconst_null
    //   86: astore_1
    ...
    //   89: astore_3
    //   90: aload_2
    //   91: invokevirtual 111	java/io/IOException:printStackTrace	()V
    //   94: goto -27 -> 67
    //   97: astore_1
    //   98: aload_1
    //   99: invokevirtual 111	java/io/IOException:printStackTrace	()V
    //   102: goto -27 -> 75
    //   105: astore_1
    //   106: aload_1
    //   107: invokevirtual 111	java/io/IOException:printStackTrace	()V
    //   110: return
    //   111: astore_2
    //   112: aload 4
    //   114: astore_3
  ...
  protected void b()
  {
    ...
    ThreadManager.executeOnNetWorkThread(new akqa(this, localBundle));
  }
