...
public class SdkShareReporter
{
  ...
  public static SdkShareReporter.ArkReportData a(MessageForArkApp paramMessageForArkApp)
  {
    ...
    if ("com.tencent.structmsg".equals(str1))
    {
      ...
      {
        localArkReportData.jdField_a_of_type_JavaLangString = "2";
        localArkReportData.b = paramMessageForArkApp.getMusicTitle();
        localArkReportData.c = paramMessageForArkApp.getMusicAppid();
        localArkReportData.jdField_a_of_type_Int = 2;
      }
      else if ("news".equals(str2))
      {
        localArkReportData.jdField_a_of_type_JavaLangString = "1";
        localArkReportData.b = paramMessageForArkApp.getTitle();
        localArkReportData.c = paramMessageForArkApp.getNewsAppid();
        localArkReportData.jdField_a_of_type_Int = 2;
      }
      localArkReportData.jdField_a_of_type_Boolean = paramMessageForArkApp.isFromSdkShare();
    }
    else
    {
      localArkReportData.jdField_a_of_type_JavaLangString = "4";
      localArkReportData.b = paramMessageForArkApp.ark_app_message.promptText;
      localArkReportData.jdField_a_of_type_Boolean = false;
      localArkReportData.c = paramMessageForArkApp.ark_app_message.appId;
    }
  ...
  {
    ReportController.b(null, "dc00898", "", "", "0X800A426", "0X800A426", 0, 1, "", c(paramInt), String.valueOf(paramLong), paramString);
  ...
  public static void a(Intent paramIntent)
  {
    ...
    ReportController.b(null, "dc00898", "", "", "0X800A427", "0X800A427", 0, 1, "", c(i), str, paramIntent);
    if (QLog.isColorLevel()) {
  ...
  public static void a(Intent paramIntent, long paramLong, String paramString)
  {
    ...
    int i = paramIntent.getIntExtra("key_forward_image_share_uin_type", 0);
    ReportController.b(null, "dc00898", "", "", "0X800A631", "0X800A631", 0, 1, paramString, c(i), str, String.valueOf(paramLong));
    if (QLog.isColorLevel()) {
      QLog.d("ForwardOption.ForwardBaseOption", 2, new Object[] { "图文或者音乐转发=0X800A631, type=", paramString, ", title=", str, ", uinType=", c(i) });
    }
  }
  
  public static void a(Bundle paramBundle)
  {
    String str1 = a(paramBundle.getInt("req_type"));
    String str2 = b(paramBundle.getInt("uintype"));
  ...
  public static void a(Bundle paramBundle, int paramInt, long paramLong)
  {
    ...
    ReportController.b(null, "dc00898", "", "", "0X800B2DB", "0X800B2DB", 0, a(paramInt), String.valueOf(paramLong), a(paramInt), b(i), str);
  }
  ...
  public static void a(Bundle paramBundle, long paramLong)
  {
    ...
    ReportController.b(null, "dc00898", "", "", "0X800A631", "0X800A631", 0, j, str1, c(i), str2, String.valueOf(paramLong));
    if (QLog.isColorLevel()) {
      QLog.d("SdkShareReport", 2, new Object[] { "ARK转发=0X800A631, type=", str1, ", uinType=", c(i), ", title=", str2 });
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, Intent paramIntent, AbsShareMsg paramAbsShareMsg)
  {
          ...
          while (((Iterator)localObject1).hasNext())
          {
            ...
            if ((localObject2 instanceof StructMsgItemVideo))
            {
              ...
              if (((StructMsgItemVideo)localObject2).a()) {
                ((IVideoReporter)QRoute.api(IVideoReporter.class)).reportClickEvent("0X80065FF", paramQQAppInterface.uinType, ((IVideoReporter)QRoute.api(IVideoReporter.class)).getReportVideoType(((StructMsgItemVideo)localObject2).v, paramQQAppInterface.mSourceName), ((StructMsgItemVideo)localObject2).ae, "");
              }
            }
          }
        }
    ...
    if ((paramAbsShareMsg instanceof StructMsgForImageShare))
    {
      ...
      {
        paramAbsShareMsg = AIOGallerySceneWithBusiness.b(paramAbsShareMsg.mMsgActionData);
  ...
  {
    SdkShareReporter.ArkReportData localArkReportData = a(paramMessageForArkApp);
    if (!localArkReportData.jdField_a_of_type_Boolean) {
      return;
    }
    ReportController.b(null, "dc00898", "", "", "0X800A62F", "0X800A62F", 0, localArkReportData.jdField_a_of_type_Int, localArkReportData.jdField_a_of_type_JavaLangString, c(paramMessageForArkApp.istroop), localArkReportData.b, localArkReportData.c);
    if (QLog.isColorLevel()) {
      QLog.d("SdkShareReport", 2, new Object[] { "ARK曝光=0X800A62F, type=", localArkReportData.jdField_a_of_type_JavaLangString, ", uinType=", c(paramMessageForArkApp.istroop), ", title=", localArkReportData.b });
    }
  }
  
  public static void a(AbsStructMsg paramAbsStructMsg, int paramInt, long paramLong)
  {
    ReportController.b(null, "dc00898", "", "", "0X8009C93", "0X8009C93", 0, 1, String.valueOf(paramLong), "4", b(paramInt), ((AbsShareMsg)paramAbsStructMsg).mContentTitle);
  }
  ...
  {
    ReportController.b(null, "dc00898", "", "", "0X800A62F", "0X800A62F", 0, 1, paramString1, c(paramInt), paramString2, String.valueOf(paramLong));
    if (QLog.isColorLevel()) {
      QLog.d("SdkShareReport", 2, new Object[] { "曝光=0X800A62F, type=", paramString1, ", title=", paramString2, ", uinType=", c(paramInt) });
    }
  }
  ...
  {
    ReportController.b(null, "dc00898", "", "", "0X800A428", "0X800A428", 0, 1, "", c(paramInt), Long.toString(paramLong), paramString);
    if (QLog.isColorLevel())
    {
  ...
  public static void b(MessageForArkApp paramMessageForArkApp)
  {
    ...
    ReportController.b(null, "dc00898", "", "", "0X800A630", "0X800A630", 0, localArkReportData.jdField_a_of_type_Int, localArkReportData.jdField_a_of_type_JavaLangString, c(paramMessageForArkApp.istroop), localArkReportData.b, localArkReportData.c);
    if (QLog.isColorLevel()) {
      QLog.d("SdkShareReport", 2, new Object[] { "ARK点击=0X800A630, type=", localArkReportData.jdField_a_of_type_JavaLangString, ", uinType=", c(paramMessageForArkApp.istroop), ", title=", localArkReportData.b });
    }
    String str1;
    if (localArkReportData.jdField_a_of_type_JavaLangString == "2")
    {
    ...
    if ((localArkReportData.jdField_a_of_type_JavaLangString == "1") && ("101492711".equals(paramMessageForArkApp.getNewsAppid())))
    {
      if (paramMessageForArkApp.istroop == 0) {
        str1 = "c2c_AIO";
      } else {
  ...
  {
    ReportController.b(null, "dc00898", "", "", "0X800A630", "0X800A630", 0, 1, paramString1, c(paramInt), paramString2, String.valueOf(paramLong));
    if (QLog.isColorLevel())
    {
      StringBuilder localStringBuilder = new StringBuilder();
      localStringBuilder.append(", title=");
      localStringBuilder.append(paramString2);
      QLog.d("SdkShareReport", 2, new Object[] { "分享内容点击=", "0X800A630, type=", paramString1, localStringBuilder.toString(), ", uinType=", c(paramInt) });
    }
  }
