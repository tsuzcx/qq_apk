  ...
  implements JavaScriptInterface, IJsCallBack
{
  ...
  {
    this.jdField_a_of_type_AndroidOsHandler.post(new alrc(this, paramString));
  }
  ...
  public void getQueryDownloadAction(String paramString)
  {
    ...
    try
    {
      ...
      DownloadApi.a(localArrayList, new alra(this, (String)localObject));
      return;
    }
    catch (JSONException paramString)
    {
  ...
  public void getQueryDownloadAction(String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      {
        DownloadInfo localDownloadInfo = new DownloadInfo();
        localDownloadInfo.jdField_b_of_type_JavaLangString = paramString1.getString(i);
        paramString2.add(localDownloadInfo);
        i += 1;
      }
      DownloadApi.a(paramString2, new alrb(this));
      return;
    }
    catch (JSONException paramString1)
    {
