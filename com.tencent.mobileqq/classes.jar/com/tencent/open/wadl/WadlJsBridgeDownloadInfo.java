...
{
  public static final Parcelable.Creator CREATOR = new alrl();
  public int a;
  public long a;
  public String a;
  public boolean a;
  ...
  {
    return "DownloadInfo [appId=" + this.jdField_a_of_type_JavaLangString + ", urlStr=" + this.jdField_b_of_type_JavaLangString + ", packageName=" + this.jdField_c_of_type_JavaLangString + ", push_title=" + this.jdField_d_of_type_JavaLangString + ", sendTime=" + this.jdField_e_of_type_JavaLangString + ", progress=" + this.jdField_g_of_type_Int + ", time=" + this.jdField_a_of_type_Long + ", filePath=" + this.jdField_j_of_type_JavaLangString + ", state=" + this.jdField_f_of_type_Int + ", urlPatch=" + this.jdField_g_of_type_JavaLangString + ", updateType=" + this.jdField_a_of_type_Int + ", myAppId=" + this.jdField_h_of_type_JavaLangString + ", apkId=" + this.jdField_a_of_type_Int + ", versionCode=" + this.jdField_b_of_type_Int + ", lastDownloadSize=" + this.jdField_b_of_type_Long + ", isApk=" + this.jdField_b_of_type_Boolean + ", iconUrl=" + this.l + ", isShowNotification=" + this.i + ", writeCodeState=" + this.jdField_j_of_type_Int + ", extraInfo =" + this.m + ", isAutoInstallBySDK =" + this.jdField_c_of_type_Boolean + "]";
  }
