...
class WadlJsBridge$JsCheckUpdateCallback
  implements UpdateManager.OnCheckUpdateListener
{
  protected String a;
  
  public WadlJsBridge$JsCheckUpdateCallback(WadlJsBridge paramWadlJsBridge, String paramString)
  {
  ...
  {
    WLog.c("WadlJsBridge", "checkUpdate(End) onResult()");
    if (!this.jdField_a_of_type_ComTencentOpenWadlWadlJsBridge.hasRight()) {
      return;
    }
 ...
 * Qualified Name:     com.tencent.open.wadl.WadlJsBridge.JsCheckUpdateCallback
