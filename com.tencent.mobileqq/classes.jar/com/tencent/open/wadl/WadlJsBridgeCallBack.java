...
public class WadlJsBridgeCallBack
  implements WadlCmdListener, WadlProxyServiceCallBackInterface
{
  ...
  private void a()
  {
    if (this.jdField_a_of_type_ComTencentOpenBusinessBaseIJsCallBack == null) {}
    ...
    while (((Iterator)localObject2).hasNext()) {
      ((JSONArray)localObject1).put(WadlJsBridgeUtil.a((WadlResult)((Iterator)localObject2).next()));
    }
    localObject1 = ((JSONArray)localObject1).toString();
    localObject2 = this.jdField_a_of_type_ComTencentOpenBusinessBaseIJsCallBack.getJsCallbackMethod();
  ...
  private void b(String paramString)
  {
    ...
    {
      return;
      WLog.c(jdField_a_of_type_JavaLangString, "doJsCallBack loadJs=" + paramString);
      try
      {
  ...
  public void a(WadlResult paramWadlResult)
  {
    ...
    if ((paramWadlResult != null) && (this.jdField_a_of_type_Boolean))
    {
      ...
      str = this.jdField_a_of_type_ComTencentOpenBusinessBaseIJsCallBack.getJsCallbackMethod();
  ...
  public void a(String paramString)
  {
    ...
    {
      WLog.a(jdField_a_of_type_JavaLangString, "showToast exception", paramString);
    }
  }
  ...
  {
    WLog.c(jdField_a_of_type_JavaLangString, "onCmdRsp cmd=" + paramString + ",isSucc");
  ...
  {
    WLog.c(jdField_a_of_type_JavaLangString, "onQueryCallback params:" + paramArrayList);
  ...
  {
    WLog.c(jdField_a_of_type_JavaLangString, "onQueryCallbackVia params:" + paramArrayList);
    JSONArray localJSONArray;
    if (paramArrayList != null) {
      try
      {
  ...
  public void onWadlTaskStatusChanged(WadlResult paramWadlResult)
  {
    ...
    WLog.c(jdField_a_of_type_JavaLangString, "onWadlTaskStatusChanged:" + paramWadlResult + ",localStatus:" + i);
    switch (i)
    {
    default: 
    ...
    case -2: 
      ...
      WLog.a(jdField_a_of_type_JavaLangString, "onWadlTaskStatusChanged  error,wadlErrCode=" + i);
      c(str);
      a(i, localWadlParams);
      a(paramWadlResult);
      return;
