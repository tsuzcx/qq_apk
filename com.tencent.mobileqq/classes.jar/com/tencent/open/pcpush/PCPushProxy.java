  ...
  implements DownloadListener
{
  ...
  public void a(String paramString)
  {
    ...
    paramString.putString(DownloadConstants.jdField_b_of_type_JavaLangString, localPkgEntry.jdField_b_of_type_JavaLangString);
    paramString.putString(DownloadConstants.j, localPkgEntry.jdField_f_of_type_JavaLangString);
    paramString.putString(DownloadConstants.jdField_f_of_type_JavaLangString, localPkgEntry.jdField_d_of_type_JavaLangString);
    paramString.putString(DownloadConstants.i, localPkgEntry.jdField_c_of_type_JavaLangString);
    paramString.putString(DownloadConstants.l, localPkgEntry.jdField_e_of_type_JavaLangString);
    String str = DownloadConstants.y;
  ...
  public void onDownloadUpdate(List<DownloadInfo> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      else
      {
        ...
        for (;;)
        {
          localPkgEntry.jdField_f_of_type_Int = ((DownloadInfo)localObject).jdField_f_of_type_Int;
