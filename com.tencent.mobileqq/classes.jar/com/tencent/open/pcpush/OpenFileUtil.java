...
public final class OpenFileUtil
{
  public static Intent a(Context paramContext, File paramFile)
  {
    ...
    if (a(str, paramContext.getResources().getStringArray(2131296329)))
    {
      localIntent.setDataAndType(Uri.fromFile(paramFile), "image/*");
      return localIntent;
    }
    if (a(str, paramContext.getResources().getStringArray(2131296333)))
    {
    ...
    if (a(str, paramContext.getResources().getStringArray(2131296330)))
    {
    ...
    if (a(str, paramContext.getResources().getStringArray(2131296331)))
    {
      localIntent.addFlags(67108864);
      localIntent.putExtra("oneshot", 0);
      localIntent.putExtra("configchange", 0);
    ...
    if (a(str, paramContext.getResources().getStringArray(2131296334)))
    {
      localIntent.setDataAndType(Uri.fromFile(paramFile), "text/plain");
      return localIntent;
    }
    if (a(str, paramContext.getResources().getStringArray(2131296338)))
    {
      localIntent.setDataAndType(Uri.fromFile(paramFile), "application/pdf");
      return localIntent;
    }
    if (a(str, paramContext.getResources().getStringArray(2131296335)))
    {
      localIntent.setDataAndType(Uri.fromFile(paramFile), "application/msword");
      return localIntent;
    }
    if (a(str, paramContext.getResources().getStringArray(2131296336)))
    {
      localIntent.setDataAndType(Uri.fromFile(paramFile), "application/vnd.ms-excel");
      return localIntent;
    }
    if (a(str, paramContext.getResources().getStringArray(2131296337)))
    {
      localIntent.setDataAndType(Uri.fromFile(paramFile), "application/vnd.ms-powerpoint");
      return localIntent;
    }
    if (a(str, paramContext.getResources().getStringArray(2131296339)))
    {
