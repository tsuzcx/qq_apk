  ...
  extends QIPCModule
{
  ...
  private void a(Bundle paramBundle, int paramInt)
  {
    ...
    {
      QLog.d("Q.quicklogin.OpenSdkQIPCClient", 1, "doWtLogin uin=" + AuthorityUtil.a(str1) + ", maskPasswd=" + paramBundle + ", appId=" + str3);
      ...
      LoginHelper.a(str3, str1, str2, new OpenSdkQIPCClient.2(this, paramInt));
      return;
    }
  }
  ...
  {
    QLog.d("Q.quicklogin.OpenSdkQIPCClient", 1, "backToMainProcess uin=" + AuthorityUtil.a(paramString) + ", ssoResult=" + paramInt2 + ", epicCode=" + paramInt3);
    try
    {
  ...
  private void b(Bundle paramBundle)
  {
    ...
    if (localObject != null) {
      ((MqqHandler)localObject).sendEmptyMessage(20200515);
    }
