  ...
  extends RelativeLayout
{
  ...
  public void a(bcku parambcku)
  {
    this.jdField_a_of_type_Bcku = parambcku;
  }
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    if ((this.jdField_a_of_type_Bcku != null) && (i != 0))
    {
      if (k - j - i <= 100) {
        break label112;
      }
      this.jdField_a_of_type_Bcku.a(Math.abs(this.jdField_a_of_type_AndroidGraphicsRect.height()) - getPaddingBottom() - getPaddingTop());
    }
    for (;;)
    {
