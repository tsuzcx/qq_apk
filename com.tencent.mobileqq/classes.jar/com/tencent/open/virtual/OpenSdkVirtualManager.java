...
public class OpenSdkVirtualManager
{
  ...
  private ConcurrentHashMap<String, AccountInfo> jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  private ConcurrentHashMap<String, Bundle> c = new ConcurrentHashMap();
  private ConcurrentHashMap<String, List<CardContainer.Permission>> d = new ConcurrentHashMap();
  private ConcurrentHashMap<String, AppInfo> e = new ConcurrentHashMap();
  ...
  private void a(AccountInfo paramAccountInfo, String paramString, JSONObject paramJSONObject, AuthCallback paramAuthCallback)
  {
    ...
    paramString = new OpenSdkVirtualManager.5(this, paramAccountInfo, paramAuthCallback, paramString, paramJSONObject);
    OpenSdkVirtualUtil.a("oidb_0xc7f_25", paramAccountInfo, paramJSONObject.toString(), paramString);
  }
  ...
  private void a(preAuth.PreAuthResponse paramPreAuthResponse)
  {
    ...
    if (paramPreAuthResponse.auth_items.has())
    {
      ...
      if (((Iterator)localObject2).hasNext())
      {
        ...
        localObject4 = new CardContainer.Permission();
        ((CardContainer.Permission)localObject4).jdField_b_of_type_JavaLangString = ((appType.AuthItem)localObject3).api_list.get();
        ((CardContainer.Permission)localObject4).jdField_a_of_type_Int = ((appType.AuthItem)localObject3).default_flag.get();
        ((CardContainer.Permission)localObject4).jdField_b_of_type_Int = ((appType.AuthItem)localObject3).id.get();
        if (((appType.AuthItem)localObject3).is_new.get() != 0) {}
        for (boolean bool = true;; bool = false)
        {
          ((CardContainer.Permission)localObject4).jdField_a_of_type_Boolean = bool;
          ((CardContainer.Permission)localObject4).jdField_a_of_type_JavaLangString = ((appType.AuthItem)localObject3).title.get();
          QLog.d("SDK_LOGIN.OpenSdkVirtualManager", 1, new Object[] { "onPreAuthResponse Permission=", ((CardContainer.Permission)localObject4).toString() });
    ...
    if (paramPreAuthResponse.android_info.has()) {
      this.e.put(str, AppInfo.a(paramPreAuthResponse, paramPreAuthResponse.android_info));
    }
  ...
  public AppInfo a(String paramString)
  {
    if (TextUtils.isEmpty(paramString)) {
      return null;
    }
    return (AppInfo)this.e.get(paramString);
  }
  ...
  public AccountInfo a(String paramString)
  {
    ...
    return (AccountInfo)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
  }
  ...
  public preAuth.PreAuthRequest a(AccountInfo paramAccountInfo, String paramString, long paramLong1, long paramLong2, Bundle paramBundle)
  {
    preAuth.PreAuthRequest localPreAuthRequest = new preAuth.PreAuthRequest();
    localPreAuthRequest.appid.set(paramLong1);
    localPreAuthRequest.sdkp.set(AuthorityUtil.a(paramBundle, "sdkp", "android"));
    localPreAuthRequest.sdkv.set(AuthorityUtil.a(paramBundle, "sdkv", "1.5.9"));
    ...
    if (Build.VERSION.RELEASE == null)
    {
      ...
      localPreAuthRequest.scope.set(AuthorityUtil.a(paramBundle, "scope", ""));
      localPreAuthRequest.skey.set(paramAccountInfo.jdField_b_of_type_JavaLangString);
    ...
    for (;;)
    {
      if (paramLong2 != 0L)
      {
        paramAccountInfo = new preAuth.PreAuthProxyRequest();
        paramAccountInfo.appid.set(paramLong2);
        localPreAuthRequest.proxy_req.set(paramAccountInfo);
      }
  ...
  public List<CardContainer.Permission> a(String paramString)
  {
    if (TextUtils.isEmpty(paramString)) {
      return null;
    }
  ...
  public SSOAccountObserver a(OpenSDKAppInterface paramOpenSDKAppInterface, String paramString1, String paramString2, int paramInt, OpenSdkVirtualManager.GetTicketCallback paramGetTicketCallback)
  {
    QLog.d("SDK_LOGIN.OpenSdkVirtualManager", 1, "getTicketNoPasswd uin=" + AuthorityUtil.a(paramString1));
    new AccountInfo().jdField_a_of_type_JavaLangString = paramString1;
    paramOpenSDKAppInterface = new OpenSdkVirtualManager.7(this, paramOpenSDKAppInterface, paramGetTicketCallback);
    AccountManage.a().a(paramString1, paramOpenSDKAppInterface, paramString2, paramInt);
    return paramOpenSDKAppInterface;
  }
  
  public void a(long paramLong, String paramString1, String paramString2, AuthCallback paramAuthCallback)
  {
    AccountInfo localAccountInfo = (AccountInfo)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(paramLong));
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)) || (localAccountInfo == null))
    {
      ...
      if (paramAuthCallback != null) {
        paramAuthCallback.a(false, null, -1);
      }
      return;
    }
    ...
    try
    {
      ...
      QLog.d("SDK_LOGIN.OpenSdkVirtualManager", 1, new Object[] { "OpenVirtual.createVirtual.start:", OpenSdkVirtualUtil.a(localJSONObject.toString(), localAccountInfo.jdField_a_of_type_JavaLangString) });
      ThreadManagerV2.executeOnSubThread(new OpenSdkVirtualManager.1(this, localAccountInfo, localJSONObject, paramAuthCallback));
      return;
    }
  ...
  public void a(preAuth.PreAuthRequest paramPreAuthRequest, Activity paramActivity, AccountInfo paramAccountInfo, OpenSdkVirtualManager.PreAuthCallback paramPreAuthCallback, int paramInt)
  {
    if (paramActivity == null)
    {
      QLog.d("SDK_LOGIN.OpenSdkVirtualManager", 1, new Object[] { "preAuthWithRetry activity==null, preAuthCallback=", paramPreAuthCallback });
      if (paramPreAuthCallback != null) {
    ...
    {
      localObject = OpenSdkVirtualUtil.a(paramActivity, paramPreAuthRequest.appUniqueIdentifier.get());
    ...
    NewIntent localNewIntent = new NewIntent(BaseApplicationImpl.getApplication(), OpensdkServlet.class);
    localNewIntent.putExtra("uin", paramAccountInfo.jdField_a_of_type_JavaLangString);
    String str = AuthorityUtil.a(BaseApplicationImpl.getApplication().getRuntime(), paramAccountInfo, paramPreAuthRequest.login_sig, "QQConnectLogin.pre_auth", "QQConnectLogin.pre_auth_emp");
    boolean bool = "QQConnectLogin.pre_auth_emp".equals(str);
    byte[] arrayOfByte = paramPreAuthRequest.toByteArray();
    Object localObject = arrayOfByte;
    if (bool) {
      localObject = OpenSdkVirtualUtil.a(arrayOfByte, paramAccountInfo);
    }
    QLog.d("SDK_LOGIN.OpenSdkVirtualManager", 1, new Object[] { "preAuthWithRetry cmd=", str });
    b(paramAccountInfo.jdField_a_of_type_JavaLangString);
    ...
    ForwardStatisticsReporter.a("KEY_PRE_AUTH");
    localNewIntent.setObserver(new OpenSdkVirtualManager.8(this, paramAccountInfo, bool, paramPreAuthCallback, paramInt, paramPreAuthRequest, paramActivity));
    BaseApplicationImpl.getApplication().getRuntime().startServlet(localNewIntent);
  }
  
  public void a(String paramString)
  {
    QLog.d("SDK_LOGIN.OpenSdkVirtualManager", 1, "addForce540Account uin=" + AuthorityUtil.a(paramString));
  ...
  public void a(String paramString, long paramLong, AuthCallback paramAuthCallback)
  {
    AccountInfo localAccountInfo = (AccountInfo)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(paramString));
    if (localAccountInfo == null)
    {
      QLog.d("SDK_LOGIN.OpenSdkVirtualManager", 1, "OpenVirtual.deleteVirtual.return for account is null");
      if (paramAuthCallback != null) {
        paramAuthCallback.a(false, -1);
      }
    }
    JSONObject localJSONObject = new JSONObject();
    try
    {
      ...
      ThreadManagerV2.executeOnSubThread(new OpenSdkVirtualManager.2(this, localAccountInfo, localJSONObject, paramAuthCallback));
      return;
    }
  ...
  public void a(String paramString, AccountInfo paramAccountInfo)
  {
    if ((!TextUtils.isEmpty(paramString)) && (paramAccountInfo != null)) {
      this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString, paramAccountInfo);
    }
  }
  
  public void a(String paramString1, String paramString2, Activity paramActivity, String paramString3, Bundle paramBundle, OpenSdkVirtualManager.PreAuthCallback paramPreAuthCallback)
  {
    paramString2 = (AccountInfo)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(paramString2));
    ...
    a(a(paramString2, paramString3, ForwardUtils.a(paramString1), l, paramBundle), paramActivity, paramString2, new OpenSdkVirtualManager.3(this, paramPreAuthCallback), 2);
  }
  
  public void a(String paramString1, String paramString2, AuthCallback paramAuthCallback)
  {
    AccountInfo localAccountInfo = (AccountInfo)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(paramString1));
    if ((TextUtils.isEmpty(paramString2)) || (localAccountInfo == null))
    {
      QLog.d("SDK_LOGIN.OpenSdkVirtualManager", 1, "OpenVirtual.uploadAvatarImage.return for params error");
      if (paramAuthCallback != null) {
        paramAuthCallback.a(false, paramString2, null, -1);
      }
      return;
    }
    ThreadManagerV2.executeOnSubThread(new OpenSdkVirtualManager.4(this, paramString2, paramString1, localAccountInfo, paramAuthCallback));
  }
  
  public void a(boolean paramBoolean, String paramString1, String paramString2, List<CardContainer.Permission> paramList, long paramLong, AuthCallback paramAuthCallback, String paramString3, Activity paramActivity)
  {
    ...
    {
      localAccountInfo = (AccountInfo)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(localObject1);
      localObject1 = (Bundle)this.c.get(localObject1);
      if ((localAppRuntime != null) && (localObject1 != null) && (localAccountInfo != null)) {
        break;
      }
    ...
    if (!TextUtils.isEmpty(paramString2))
    {
      new ProxyAuthManager().a(paramBoolean, paramString1, paramString2, paramList, paramLong, paramAuthCallback, paramString3, paramActivity, localAccountInfo, (Bundle)localObject1);
      return;
    }
    ...
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      {
        localObject4 = (CardContainer.Permission)((Iterator)localObject2).next();
        if (((CardContainer.Permission)localObject4).jdField_b_of_type_Boolean)
        {
          localAuthorizeRequest.openapi.add(Integer.valueOf(((CardContainer.Permission)localObject4).jdField_b_of_type_Int));
          ((StringBuilder)localObject1).append(((CardContainer.Permission)localObject4).jdField_b_of_type_Int).append(",");
        }
      }
    }
    ...
    for (localObject1 = localObject1.toString();; localObject1 = "")
    {
      ...
      break;
      localObject2 = OpenSdkVirtualUtil.a(paramActivity, paramString3);
    ...
    localAuthorizeRequest.skey.set(localAccountInfo.jdField_b_of_type_JavaLangString);
    if (paramBoolean) {
    ...
    for (;;)
    {
      ...
      ((NewIntent)localObject3).putExtra("uin", localAccountInfo.jdField_a_of_type_JavaLangString);
      localObject4 = AuthorityUtil.a(localAppRuntime, localAccountInfo, localAuthorizeRequest.login_sig, "ConnAuthSvr.sdk_auth_api", "ConnAuthSvr.sdk_auth_api_emp");
      boolean bool = "ConnAuthSvr.sdk_auth_api_emp".equals(localObject4);
      localObject2 = localAuthorizeRequest.toByteArray();
      localObject1 = localObject2;
      if (bool) {
        localObject1 = OpenSdkVirtualUtil.a((byte[])localObject2, localAccountInfo);
      }
      ((NewIntent)localObject3).putExtra("data", (byte[])localObject1);
      ((NewIntent)localObject3).putExtra("cmd", (String)localObject4);
      OpenSdkVirtualUtil.a((NewIntent)localObject3);
      ((NewIntent)localObject3).setObserver(new OpenSdkVirtualManager.6(this, System.currentTimeMillis(), localAccountInfo, paramString1, paramBoolean, paramString2, paramList, paramLong, paramAuthCallback, paramString3, paramActivity, bool, (String)localObject4));
      localAppRuntime.startServlet((NewIntent)localObject3);
      QLog.d("SDK_LOGIN.OpenSdkVirtualManager", 1, new Object[] { "OpenVirtual.doAuthorize.send | cmd: " + (String)localObject4, " | uin : *" + AuthorityUtil.a(localAccountInfo.jdField_a_of_type_JavaLangString) });
      return;
  ...
  public boolean a(String paramString)
  {
    ...
    QLog.d("SDK_LOGIN.OpenSdkVirtualManager", 1, "isForceTo540 uin=" + AuthorityUtil.a(paramString) + ", force540=" + bool);
    return bool;
  }
}
 ...
 * Qualified Name:     com.tencent.open.virtual.OpenSdkVirtualManager
