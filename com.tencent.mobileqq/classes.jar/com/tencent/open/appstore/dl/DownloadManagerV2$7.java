...
public class DownloadManagerV2$7
  implements Runnable
{
  public DownloadManagerV2$7(bdgv parambdgv, DownloadInfo paramDownloadInfo) {}
  ...
  public void run()
  {
      ...
      if (localTMAssistantDownloadTaskInfo != null)
      {
        ...
        if ((this.a.jdField_e_of_type_Boolean) && ("com.tencent.mobileqq".equals(this.a.jdField_e_of_type_JavaLangString)))
        {
          ...
          if ((localFile.exists()) && (localUpgradeDetailWrapper != null))
          {
            ...
            {
              bdgv.a(this.this$0, this.a, -51, "download file md5 check failed(not patche)");
              localFile.delete();
              return;
            }
          }
        ...
        bdht.b("DownloadManagerV2", "onDownload complete, info.filePath = " + this.a.l);
        if ((!"com.tencent.mobileqq".equals(this.a.jdField_e_of_type_JavaLangString)) || (!this.this$0.a())) {
          break label388;
        }
        bdht.b("DownloadManagerV2", "QQ Download complete begin write code ......");
        this.a.j = bdgv.a(this.this$0, this.a);
        if (this.a.j == 0) {
          break label338;
        }
        bdht.b("DownloadManagerV2", "QQ apk write code fail......");
        this.a.a(-2);
    ...
    catch (Exception localException)
    {
      ...
      bdht.b("AppCenterReporter", "from:[doMd5CheckAndWriteCode]");
      bdhk.b(this.a);
      if (this.a.a)
      {
        ...
        return;
        label338:
        bdht.b("DownloadManagerV2", "QQ apk code suc......");
        label388:
        do
        {
          this.this$0.c(this.a);
        ...
        bdht.b("DownloadManagerV2", this.a.jdField_e_of_type_JavaLangString + " Download complete begin write code ......");
