...
public class DownloadProxy$3
  implements Runnable
{
  public DownloadProxy$3(bjtd parambjtd, Bundle paramBundle, String paramString, int paramInt, Activity paramActivity, ApkUpdateDetail paramApkUpdateDetail) {}
  ...
  public void run()
  {
    ...
    {
      bjtx.b("DownloadResolver", bool1);
      if (this.jdField_a_of_type_AndroidOsBundle != null) {
        break;
      }
      bjtx.b("DownloadResolver", "[doDownloadAction] pParams == null return");
      return;
    }
    bjsz.a().a();
    this.jdField_a_of_type_AndroidOsBundle.getString(bjwo.b);
    ...
    String str2 = this.jdField_a_of_type_AndroidOsBundle.getString(bjwo.i);
    ...
    String str1 = this.jdField_a_of_type_AndroidOsBundle.getString(bjwo.j);
    localObject = str1;
    ...
    localObject = bjsz.a().b((String)localObject);
    if ((localObject == null) && ("biz_src_yyb".equals(this.jdField_a_of_type_JavaLangString)) && (bjwj.e()))
    {
      ...
      if ((i == 5) && ("com.tencent.android.qqdownloader".equals(str1))) {
        bjtd.a(this.jdField_a_of_type_AndroidOsBundle);
      }
    }
    ...
    if (bjtd.a(this.jdField_a_of_type_AndroidOsBundle))
    {
      bjtx.a("DownloadResolver", "[doDownloadAction] installApp");
      return;
    }
    if (this.jdField_a_of_type_AndroidOsBundle.getInt(bjwo.k) == 5) {
      this.jdField_a_of_type_AndroidOsBundle.putInt(bjwo.k, 2);
    }
    if (this.jdField_a_of_type_Int == 0)
    {
      if ((localObject != null) && (((DownloadInfo)localObject).c == 1))
      {
        bjtd.a(this.this$0, this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidOsBundle, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentApkupdateLogicDataApkUpdateDetail, this.jdField_a_of_type_Int);
        return;
      }
      ...
      for (;;)
      {
        bjtx.a("DownloadResolver", "check wifi dialog isWifiActive=" + bool4 + " isFirstDownload=" + bool1 + " acIsNull=" + bool2);
        if ((!bool3) || (bool2) || (bool4) || (!bool1) || (!this.jdField_a_of_type_AndroidOsBundle.getBoolean(bjwo.r))) {
          break label645;
        }
        bjsz.a().a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidOsBundle, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentApkupdateLogicDataApkUpdateDetail, this.jdField_a_of_type_Int);
        return;
        bool1 = false;
        break;
        label640:
      ...
      label645:
      bjtd.a(this.this$0, this.jdField_a_of_type_AndroidOsBundle, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentApkupdateLogicDataApkUpdateDetail);
      return;
    }
    if ((localObject == null) || (((DownloadInfo)localObject).c == 1))
    {
