...
public class DownloadManagerV2$8
  implements Runnable
{
  public DownloadManagerV2$8(bccu parambccu, String paramString, DownloadInfo paramDownloadInfo) {}
  ...
  public void run()
  {
    try
    {
      ...
      bccu.a(this.this$0, this.jdField_a_of_type_ComTencentOpenDownloadnewDownloadInfo);
      return;
    }
