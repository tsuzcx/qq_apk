  ...
  public static void a(Context paramContext, DownloadInfo paramDownloadInfo)
  {
    ...
    for (;;)
    {
      ...
      if (TextUtils.isEmpty(paramDownloadInfo))
      {
        ...
        {
          ReportController.b(null, "dc00898", "", "", "0X800A003", "0X800A003", 1, 0, paramDownloadInfo, (String)localObject1, (String)localObject2, paramContext);
          label610:
          if (!QLog.isColorLevel()) {
            break label1177;
          }
      ...
      for (paramContext = (String)localHashMap.get("Stack1");; paramContext = "")
      {
        ReportController.b(null, "dc00898", "", "", "0X800A002", "0X800A002", 1, 0, paramDownloadInfo, (String)localObject1, (String)localObject2, paramContext);
        break label610;
        label1177:
        break;
      }
