...
public class DownloadManagerV2$20
  implements Runnable
{
  public DownloadManagerV2$20(bjsz parambjsz) {}
  ...
  public void run()
  {
    ...
    try
    {
      if (!bjjo.a().a().getSharedPreferences("opensdk_config_DownloadManagerV2", 0).getBoolean("download_clear_unuse", false))
      {
        Iterator localIterator = bjsz.a(this.this$0).values().iterator();
        for (;;)
        {
    ...
    {
      bjtx.c("DownloadManagerV2", "checkDownloadList>>>", localException);
    }
    label117:
    do
    {
      ...
      bjsz.a(this.this$0, localDownloadInfo);
      break;
    } while (bjsz.a(this.this$0).size() <= 200);
    label139:
    Object localObject = bjjo.a().a().getSharedPreferences("opensdk_config_DownloadManagerV2", 0).edit();
