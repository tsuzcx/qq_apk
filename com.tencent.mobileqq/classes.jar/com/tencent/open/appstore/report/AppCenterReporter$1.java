  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    ((DownloadStartLog)localObject).versionCode = this.a.n;
    ((DownloadStartLog)localObject).downloadUrl = this.a.d;
    try
    {
      ((DownloadStartLog)localObject).yybAppId = Long.parseLong(this.a.c);
      ((DownloadStartLog)localObject).yybApkId = Long.parseLong(this.a.m);
      label132:
      ((DownloadStartLog)localObject).traceId = this.a.S;
