  ...
  extends SQLiteOpenHelper
{
  ...
  private DownloadInfo a(String paramString, String[] paramArrayOfString)
  {
    ...
    //   58: aload_0
    //   59: aload_2
    //   60: invokespecial 283	com/tencent/open/appstore/db/DownloadInfoDB:a	(Landroid/database/Cursor;)Lcom/tencent/open/downloadnew/DownloadInfo;
    //   63: astore_1
    //   64: aload_2
    //   65: ifnull +9 -> 74
    //   68: aload_2
    ...
    //   77: ifnull +9 -> 86
    //   80: aload_3
    //   81: invokevirtual 287	android/database/sqlite/SQLiteDatabase:close	()V
    //   84: aload_1
    //   85: astore_2
    //   86: aload 7
    //   88: monitorexit
    ...
    //   99: ldc_w 291
    //   102: aload_3
    //   103: invokestatic 296	com/tencent/open/base/LogUtility:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   106: aload_2
    //   107: ifnull +9 -> 116
    //   110: aload_2
    //   111: invokeinterface 286 1 0
    //   116: aload 4
    //   118: astore_2
    //   119: aload_1
    //   120: ifnull -34 -> 86
    //   123: aload_1
    //   124: invokevirtual 287	android/database/sqlite/SQLiteDatabase:close	()V
    //   127: aload 4
    //   129: astore_2
    //   130: goto -44 -> 86
    //   133: astore_1
    ...
    //   156: ifnull +7 -> 163
    //   159: aload_1
    //   160: invokevirtual 287	android/database/sqlite/SQLiteDatabase:close	()V
    //   163: aload_2
    //   164: athrow
    //   165: astore_2
    //   166: aload_3
  ...
  private List<DownloadInfo> a(String paramString, String[] paramArrayOfString)
  {
    ...
    //   13: astore 8
    //   15: aload_0
    //   16: getfield 109	com/tencent/open/appstore/db/DownloadInfoDB:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   19: astore 7
    //   21: aload 7
    //   23: monitorenter
    //   24: aload_0
    //   25: invokevirtual 265	com/tencent/open/appstore/db/DownloadInfoDB:getReadableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   28: astore 4
    //   30: aload 4
    //   32: ldc_w 267
    //   35: getstatic 93	com/tencent/open/appstore/db/DownloadInfoDB:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   38: aload_1
    //   39: aload_2
    //   40: aconst_null
    //   41: aconst_null
    //   42: aconst_null
    //   43: invokevirtual 273	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   46: astore_1
    //   47: aload_1
    //   48: invokeinterface 277 1 0
    //   53: ifle +34 -> 87
    //   56: aload_1
    //   57: invokeinterface 281 1 0
    //   62: pop
    //   63: aload 8
    //   65: aload_0
    //   66: aload_1
    //   67: invokespecial 283	com/tencent/open/appstore/db/DownloadInfoDB:a	(Landroid/database/Cursor;)Lcom/tencent/open/downloadnew/DownloadInfo;
    ...
    //   99: ifnull +8 -> 107
    //   102: aload 4
    //   104: invokevirtual 287	android/database/sqlite/SQLiteDatabase:close	()V
    //   107: aload 7
    //   109: monitorexit
    //   110: ldc_w 289
    ...
    //   139: invokestatic 342	com/tencent/open/base/LogUtility:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   142: aload 8
    //   144: areturn
    //   145: astore 4
    //   147: aconst_null
    ...
    //   174: ifnull -67 -> 107
    //   177: aload_1
    //   178: invokevirtual 287	android/database/sqlite/SQLiteDatabase:close	()V
    //   181: goto -74 -> 107
    //   184: astore_1
    //   185: aload 7
    //   187: monitorexit
    ...
    //   210: ifnull +7 -> 217
    //   213: aload_1
    //   214: invokevirtual 287	android/database/sqlite/SQLiteDatabase:close	()V
    //   217: aload_2
    //   218: athrow
    //   219: astore_2
    //   220: aconst_null
  ...
  public java.util.concurrent.ConcurrentHashMap<String, DownloadInfo> a()
  {
    ...
    //   5: ldc_w 289
    //   8: ldc_w 382
    //   11: invokestatic 384	com/tencent/open/base/LogUtility:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   14: new 386	java/util/concurrent/ConcurrentHashMap
    //   17: dup
    //   18: invokespecial 387	java/util/concurrent/ConcurrentHashMap:<init>	()V
    //   21: astore 7
    //   23: aload_0
    //   24: getfield 109	com/tencent/open/appstore/db/DownloadInfoDB:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   27: astore 6
    //   29: aload 6
    //   31: monitorenter
    //   32: aload_0
    //   33: invokevirtual 265	com/tencent/open/appstore/db/DownloadInfoDB:getReadableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   36: astore_2
    //   37: aload_2
    //   38: ldc_w 267
    //   41: getstatic 93	com/tencent/open/appstore/db/DownloadInfoDB:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   44: aconst_null
    //   45: aconst_null
    //   46: aconst_null
    //   47: aconst_null
    //   48: aconst_null
    //   49: invokevirtual 273	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   52: astore 4
    //   54: aload 4
    //   56: invokeinterface 277 1 0
    //   61: ifle +111 -> 172
    //   64: aload 4
    //   66: invokeinterface 281 1 0
    //   71: pop
    //   72: aload 4
    //   74: aload 4
    //   76: ldc 15
    //   78: invokestatic 143	com/tencent/open/appstore/db/DownloadInfoDB:a	(Landroid/database/Cursor;Ljava/lang/String;)I
    ...
    //   110: invokestatic 384	com/tencent/open/base/LogUtility:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   113: aload_0
    //   114: aload 4
    //   116: invokespecial 283	com/tencent/open/appstore/db/DownloadInfoDB:a	(Landroid/database/Cursor;)Lcom/tencent/open/downloadnew/DownloadInfo;
    //   119: astore 5
    //   121: ldc_w 289
    ...
    //   148: invokestatic 384	com/tencent/open/base/LogUtility:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   151: aload 7
    //   153: aload_3
    //   154: aload 5
    ...
    //   174: ifnull +10 -> 184
    //   177: aload 4
    //   179: invokeinterface 286 1 0
    //   184: aload_2
    //   185: ifnull +7 -> 192
    //   188: aload_2
    //   189: invokevirtual 287	android/database/sqlite/SQLiteDatabase:close	()V
    //   192: aload 6
    //   194: monitorexit
    //   195: aload 7
    //   197: areturn
    ...
    //   211: ldc_w 398
    //   214: aload 4
    //   216: invokestatic 296	com/tencent/open/base/LogUtility:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   219: aload_3
    //   220: ifnull +9 -> 229
    //   223: aload_3
    //   224: invokeinterface 286 1 0
    //   229: aload_2
    //   230: ifnull -38 -> 192
    //   233: aload_2
    //   234: invokevirtual 287	android/database/sqlite/SQLiteDatabase:close	()V
    //   237: goto -45 -> 192
    //   240: astore_2
    //   241: aload 6
    //   243: monitorexit
    ...
    //   259: ifnull +10 -> 269
    //   262: aload 4
    //   264: invokeinterface 286 1 0
    //   269: aload_2
    //   270: ifnull +7 -> 277
    //   273: aload_2
    //   274: invokevirtual 287	android/database/sqlite/SQLiteDatabase:close	()V
    //   277: aload_3
    //   278: athrow
    //   279: astore_3
    //   280: aconst_null
  ...
  public void a(DownloadInfo paramDownloadInfo, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramDownloadInfo.jdField_c_of_type_Boolean)
        {
          ...
          localObject1 = localSQLiteDatabase;
          localObject2 = localSQLiteDatabase;
          LogUtility.a("DownloadInfoDB", "addDownloadInfo>>>update affected rowNum=" + i);
          if (i == 0)
          {
            localObject1 = localSQLiteDatabase;
            localObject2 = localSQLiteDatabase;
            ...
            localObject1 = localSQLiteDatabase;
            localObject2 = localSQLiteDatabase;
            LogUtility.a("DownloadInfoDB", "addDownloadInfo>>>insert rowID = " + l);
          }
          localObject1 = localSQLiteDatabase;
          localObject2 = localSQLiteDatabase;
      ...
      catch (Exception paramDownloadInfo)
      {
        ...
        LogUtility.c("DownloadInfoDB", "addDownloadExceptionInfo>>>", paramDownloadInfo);
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        LogUtility.c("DownloadInfoDB", "addDownloadExceptionInfo>>>", localException);
      }
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    {
      LogUtility.e("DownloadInfoDB", "[deleteInfoByTicket] ticket is empty");
      return;
    }
    Object localObject3 = this.jdField_a_of_type_JavaLangObject;
    localObject2 = null;
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = localSQLiteDatabase;
        localObject2 = localSQLiteDatabase;
        LogUtility.c("DownloadInfoDB", "[deleteInfoByTicket]ticket = ?" + Arrays.toString(new String[] { paramString }));
        localObject1 = localSQLiteDatabase;
        localObject2 = localSQLiteDatabase;
      ...
      catch (Exception paramString)
      {
        SQLiteDatabase localSQLiteDatabase;
        localObject2 = localObject1;
        LogUtility.c("DownloadInfoDB", "[deleteInfoByTicket]>>>", paramString);
        if (localObject1 == null) {
          continue;
        }
        localObject1.close();
  ...
  {
    LogUtility.b("DownloadInfoDB", "onDowngrade oldVersion=" + paramInt1 + " newVersion=" + paramInt2);
    a(paramSQLiteDatabase, paramInt1, paramInt2);
  }
  
  public void onUpgrade(SQLiteDatabase paramSQLiteDatabase, int paramInt1, int paramInt2)
  {
    LogUtility.b("DownloadInfoDB", "onUpgrade oldVersion=" + paramInt1 + " newVersion=" + paramInt2);
    a(paramSQLiteDatabase, paramInt1, paramInt2);
  }
}
