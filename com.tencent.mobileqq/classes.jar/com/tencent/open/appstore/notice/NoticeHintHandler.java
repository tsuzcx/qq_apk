  ...
  extends Handler
{
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    Object localObject3 = ((Bundle)localObject1).getString(DownloadConstants.jdField_a_of_type_JavaLangString);
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append("+++++what:");
    localStringBuilder.append(paramMessage.what);
    localStringBuilder.append("+++++");
    localStringBuilder.append(localObject1);
    LogUtility.a("NoticeHintHandler", localStringBuilder.toString());
    localObject3 = DownloadManagerV2.a().a((String)localObject3);
    if (localObject3 != null)
    {
      if (((DownloadInfo)localObject3).i == TMAssistantDownloadConst.SHOW_NOTIFICATION_TRUE)
      {
        ...
        LogUtility.c("NoticeHintHandler", paramMessage.toString());
        return;
      }
            ...
            if (i != 2)
            {
              if (i != 3)
              {
                if (i == 4)
                {
                  ...
                  LogUtility.b("NoticeHintHandler", paramMessage.toString());
      ...
      else
      {
        ...
        LogUtility.b("NoticeHintHandler", ((StringBuilder)localObject2).toString());
        this.jdField_a_of_type_AndroidAppNotification.contentView.setViewVisibility(2131371990, 0);
        this.jdField_a_of_type_AndroidAppNotification.contentView.setViewVisibility(2131371985, 8);
        this.jdField_a_of_type_AndroidAppNotification.contentView.setViewVisibility(2131371996, 8);
