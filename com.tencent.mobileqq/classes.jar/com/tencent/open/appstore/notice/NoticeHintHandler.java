  ...
  extends Handler
{
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    LogUtility.a("NoticeHintHandler", "+++++what:" + paramMessage.what + "+++++" + localObject1);
    ...
    if (localObject2 != null)
    {
      if (((DownloadInfo)localObject2).i == TMAssistantDownloadConst.SHOW_NOTIFICATION_TRUE) {
        LogUtility.c("NoticeHintHandler", "notification isShowNotification=" + ((DownloadInfo)localObject2).i);
      }
    }
    else {
      return;
    ...
    for (;;)
    {
      ...
      {
        LogUtility.c("NoticeHintHandler", "init Notification>>>", localException);
        continue;
        LogUtility.b("NoticeHintHandler", ">>downloading:" + this.jdField_a_of_type_ComTencentOpenDownloadnewCommonNoticeParam.jdField_a_of_type_JavaLangString);
        LogUtility.c("NoticeHintHandler", "size = " + ((DownloadInfo)localObject2).jdField_f_of_type_Int + " content = ");
        ...
        continue;
        LogUtility.b("NoticeHintHandler", ">>complete:" + this.jdField_a_of_type_ComTencentOpenDownloadnewCommonNoticeParam.jdField_a_of_type_JavaLangString);
      ...
      for (;;)
      {
        ...
        AppNotificationManager.a().b(this.jdField_a_of_type_ComTencentOpenDownloadnewCommonNoticeParam.jdField_f_of_type_JavaLangString);
        break;
        LogUtility.b("NoticeHintHandler", ">>download icon fail,so we use default notification icon");
        this.jdField_a_of_type_AndroidAppNotification.contentView.setImageViewResource(2131372409, 2130844526);
      }
      LogUtility.b("NoticeHintHandler", ">>pause:" + this.jdField_a_of_type_ComTencentOpenDownloadnewCommonNoticeParam.jdField_a_of_type_JavaLangString);
      ...
      AppNotificationManager.a().b(this.jdField_a_of_type_ComTencentOpenDownloadnewCommonNoticeParam.jdField_f_of_type_JavaLangString);
      continue;
      LogUtility.b("NoticeHintHandler", ">>error:" + this.jdField_a_of_type_ComTencentOpenDownloadnewCommonNoticeParam.jdField_a_of_type_JavaLangString);
      this.jdField_a_of_type_AndroidAppNotification.contentView.setViewVisibility(2131372408, 0);
      this.jdField_a_of_type_AndroidAppNotification.contentView.setViewVisibility(2131372403, 8);
      this.jdField_a_of_type_AndroidAppNotification.contentView.setViewVisibility(2131372414, 8);
 ...
 * Qualified Name:     com.tencent.open.appstore.notice.NoticeHintHandler
