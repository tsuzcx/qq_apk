...
public class BindGroupConfirmActivity$2$1
  implements Runnable
{
  public BindGroupConfirmActivity$2$1(bczs parambczs, GetAppInfoProto.MsgIconsurl paramMsgIconsurl) {}
  ...
  public void run()
  {
    ...
    if (localBitmap != null)
    {
      ...
      localMessage.what = 4;
      this.jdField_a_of_type_Bczs.a.a.sendMessage(localMessage);
    }
  }
}
