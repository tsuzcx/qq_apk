...
public class BindGroupConfirmActivity$2$1
  implements Runnable
{
  public BindGroupConfirmActivity$2$1(bczd parambczd, GetAppInfoProto.MsgIconsurl paramMsgIconsurl) {}
  ...
  public void run()
  {
    ...
    if (localBitmap != null)
    {
      ...
      localMessage.what = 4;
      this.jdField_a_of_type_Bczd.a.a.sendMessage(localMessage);
    }
  }
}
