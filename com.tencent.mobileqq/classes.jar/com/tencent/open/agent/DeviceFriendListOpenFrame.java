...
public class DeviceFriendListOpenFrame
  extends OpenFrame
  implements View.OnTouchListener, bcnf, bcot, bdeq, bfpt
{
  ...
  public DeviceFriendListOpenFrame(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new bdas(this);
  }
  ...
  public void a(String paramString)
  {
    ...
    {
      return;
      i = this.jdField_a_of_type_Bdat.a(paramString);
    } while (i == -1);
  ...
  {
    bdii.c(jdField_a_of_type_JavaLangString, "-->onImageLoaded() url = " + paramString1);
    this.jdField_a_of_type_AndroidOsHandler.post(new DeviceFriendListOpenFrame.2(this, paramString1, paramBitmap));
  }
  
  public void b(Bundle paramBundle)
  {
    bdii.c(jdField_a_of_type_JavaLangString, "-->onStart()");
    super.b(paramBundle);
    this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.setSelection(0);
    this.jdField_a_of_type_ComTencentOpenAgentFriendChooser.a(true, true, this.jdField_a_of_type_ComTencentOpenAgentFriendChooser.getString(2131690950), this.jdField_a_of_type_ComTencentOpenAgentFriendChooser.getString(2131691824), this.jdField_a_of_type_ComTencentOpenAgentFriendChooser.getString(2131690573));
    if (this.jdField_a_of_type_Bdat == null)
    {
      this.jdField_a_of_type_Bdat = new bdat(this);
      this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.setAdapter(this.jdField_a_of_type_Bdat);
    }
    this.jdField_a_of_type_Bdat.b();
  }
  
  protected void f()
  {
    this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView = ((PinnedDividerListView)super.findViewById(2131364058));
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_ComTencentOpenAgentFriendChooser.getLayoutInflater().inflate(2131562360, this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView, false));
  ...
  {
    paramAdapterView = (bdau)paramView.getTag();
    ...
    {
      return;
      paramView = (Friend)this.jdField_a_of_type_Bdat.getItem(paramInt);
    ...
    if (this.jdField_a_of_type_Bdek.a(paramView.jdField_a_of_type_JavaLangString))
    {
