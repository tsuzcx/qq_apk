...
public class DeviceFriendListOpenFrame
  extends OpenFrame
  implements View.OnTouchListener, bipq, birc, bjgv, AdapterView.OnItemClickListener
{
  ...
  public DeviceFriendListOpenFrame(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new bjcn(this);
  }
  ...
  public void a(String paramString)
  {
    ...
    {
      return;
      i = this.jdField_a_of_type_Bjco.a(paramString);
    } while (i == -1);
  ...
  {
    bjko.c(jdField_a_of_type_JavaLangString, "-->onImageLoaded() url = " + paramString1);
    this.jdField_a_of_type_AndroidOsHandler.post(new DeviceFriendListOpenFrame.2(this, paramString1, paramBitmap));
  }
  
  public void b(Bundle paramBundle)
  {
    bjko.c(jdField_a_of_type_JavaLangString, "-->onStart()");
    super.b(paramBundle);
    this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.setSelection(0);
    this.jdField_a_of_type_ComTencentOpenAgentFriendChooser.a(true, true, this.jdField_a_of_type_ComTencentOpenAgentFriendChooser.getString(2131690971), this.jdField_a_of_type_ComTencentOpenAgentFriendChooser.getString(2131691725), this.jdField_a_of_type_ComTencentOpenAgentFriendChooser.getString(2131690677));
    if (this.jdField_a_of_type_Bjco == null)
    {
      this.jdField_a_of_type_Bjco = new bjco(this);
      this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.setAdapter(this.jdField_a_of_type_Bjco);
    }
    this.jdField_a_of_type_Bjco.b();
  }
  
  protected void f()
  {
    this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView = ((PinnedDividerListView)super.findViewById(2131364473));
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_ComTencentOpenAgentFriendChooser.getLayoutInflater().inflate(2131562804, this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView, false));
  ...
  {
    paramAdapterView = (bjcp)paramView.getTag();
    ...
    {
      return;
      paramView = (Friend)this.jdField_a_of_type_Bjco.getItem(paramInt);
    ...
    if (this.jdField_a_of_type_Bjgp.a(paramView.jdField_a_of_type_JavaLangString))
    {
