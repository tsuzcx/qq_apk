  ...
  implements View.OnTouchListener, bhxy, bhzl, bipg, bkij
{
  ...
  public DeviceFriendListOpenFrame(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new bild(this);
  }
  ...
  public void a(String paramString)
  {
    ...
    {
      return;
      i = this.jdField_a_of_type_Bile.a(paramString);
    } while (i == -1);
  ...
  {
    bisy.c(jdField_a_of_type_JavaLangString, "-->onImageLoaded() url = " + paramString1);
    this.jdField_a_of_type_AndroidOsHandler.post(new DeviceFriendListOpenFrame.2(this, paramString1, paramBitmap));
  }
  
  public void b(Bundle paramBundle)
  {
    bisy.c(jdField_a_of_type_JavaLangString, "-->onStart()");
    super.b(paramBundle);
    this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.setSelection(0);
    this.jdField_a_of_type_ComTencentOpenAgentFriendChooser.a(true, true, this.jdField_a_of_type_ComTencentOpenAgentFriendChooser.getString(2131690846), this.jdField_a_of_type_ComTencentOpenAgentFriendChooser.getString(2131691593), this.jdField_a_of_type_ComTencentOpenAgentFriendChooser.getString(2131690564));
    if (this.jdField_a_of_type_Bile == null)
    {
      this.jdField_a_of_type_Bile = new bile(this);
      this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.setAdapter(this.jdField_a_of_type_Bile);
    }
  ...
  {
    paramAdapterView = (bilf)paramView.getTag();
    ...
    {
      return;
      paramView = (Friend)this.jdField_a_of_type_Bile.getItem(paramInt);
