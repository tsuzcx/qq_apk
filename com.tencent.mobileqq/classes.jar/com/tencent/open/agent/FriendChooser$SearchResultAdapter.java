  ...
  extends AgentBaseAdapter
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_ComTencentOpenAgentFriendChooser.getLayoutInflater().inflate(2131563002, paramViewGroup, false);
      paramView = new FriendChooser.ViewHolder();
      paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131369676));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131380475));
      paramView.b = ((TextView)localView.findViewById(2131380612));
    ...
    if ((((Friend)localObject1).c == null) || ("".equals(((Friend)localObject1).c)))
    {
      ...
      localObject2 = ImageLoader.a().a(((Friend)localObject1).d);
      ...
      paramView.b.setText(2131691849);
    }
    for (;;)
    {
      break;
