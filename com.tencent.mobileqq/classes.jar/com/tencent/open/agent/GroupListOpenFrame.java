  ...
  extends OpenFrame
{
  ...
  public void a(Bundle paramBundle)
  {
    ...
    super.setContentView(2130971596);
    ...
    this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)super.findViewById(2131366742));
    paramBundle = (LinearLayout)super.a().getLayoutInflater().inflate(2130969259, null);
    paramBundle.findViewById(2131368323).setVisibility(8);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramBundle.findViewById(2131365806));
    this.b = ((TextView)paramBundle.findViewById(2131365813));
    this.jdField_a_of_type_ComTencentOpenAgentRecommendListManager = ((RecommendListManager)paramBundle.findViewById(2131365807));
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.setOnTouchListener(new aljt(this));
  }
