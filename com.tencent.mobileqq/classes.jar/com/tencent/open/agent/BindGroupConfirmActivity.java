  ...
  implements DialogInterface.OnClickListener, View.OnClickListener, ImageLoader.ImageLoadListener, HttpCgiAsyncTask.Callback
{
  ...
  HttpWebCgiAsyncTask.Callback jdField_a_of_type_ComTencentMobileqqTroopUtilsHttpWebCgiAsyncTask$Callback = new aljc(this);
  public QQCustomDialog a;
  public QQProgressDialog a;
  private final HttpCgiAsyncTask.Callback jdField_a_of_type_ComTencentOpenBaseHttpHttpCgiAsyncTask$Callback = new aliu(this);
  public Runnable a;
  protected String a;
  public ImageView b;
  ...
  {
    this.jdField_a_of_type_AndroidOsHandler = new aliv(this);
    this.jdField_a_of_type_JavaLangRunnable = new alja(this);
  }
  
  private void a(String paramString)
  {
    getActivity().runOnUiThread(new aljd(this, paramString));
  }
  ...
  private void b()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)super.findViewById(2131366753));
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131366752));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)super.findViewById(2131366582));
    ...
    {
      this.jdField_g_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131363713));
    ...
    for (;;)
    {
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)super.findViewById(2131366749));
      ThreadManager.executeOnSubThread(new alix(this));
      this.jdField_f_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131364341));
  ...
  protected void a(long paramLong)
  {
    ...
    for (Object localObject = "";; localObject = Build.VERSION.RELEASE)
    {
      ...
      ((NewIntent)localObject).setObserver(new aljb(this));
  ...
  public void a(String paramString1, Bitmap paramBitmap, String paramString2)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.post(new aliz(this, paramBitmap));
  }
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    super.setContentView(2130969502);
