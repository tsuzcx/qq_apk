  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (OpenAuthorityFragment.c(this.this$0) == 0) {
      OpenAuthorityFragment.a(this.this$0).setTag(this.this$0.getResources().getString(2131694453));
    }
    for (;;)
    {
      OpenAuthorityFragment.a(this.this$0).setEnabled(true);
      bjhh.a(this.this$0.getActivity(), this.this$0.getResources().getString(2131694461), new bjdy(this));
      return;
