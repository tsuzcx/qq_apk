  ...
  implements View.OnTouchListener, bhey, bhgk, bhvu, AdapterView.OnItemClickListener
{
  ...
  public void a(String paramString)
  {
    ...
    {
      return;
      i = this.jdField_a_of_type_Bhsf.a(paramString);
    } while (i == -1);
  ...
  {
    bhzm.c("FriendListOpenFrame", "-->onImageLoaded() url = " + paramString1);
  ...
  {
    bhzm.c("FriendListOpenFrame", "-->onStart()");
    super.b(paramBundle);
    this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.setSelection(0);
    ...
    this.jdField_a_of_type_ComTencentOpenAgentFriendChooser.a(true, false, this.jdField_a_of_type_ComTencentOpenAgentFriendChooser.getString(2131718094), this.jdField_a_of_type_JavaLangString);
    if (this.jdField_a_of_type_Bhsf == null)
    {
      this.jdField_a_of_type_Bhsf = new bhsf(this);
      this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.setAdapter(this.jdField_a_of_type_Bhsf);
      return;
    }
    this.jdField_a_of_type_Bhsf.b();
  }
  
  public void g()
  {
    this.jdField_a_of_type_Bhsf.notifyDataSetChanged();
  }
  
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    paramAdapterView = (bhsg)paramView.getTag();
    ...
    {
      return;
      paramView = (Friend)this.jdField_a_of_type_Bhsf.getItem(paramInt);
