  ...
  implements View.OnTouchListener, bipq, birc, bjgv, AdapterView.OnItemClickListener
{
  ...
  public FriendListOpenFrame(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new bjdb(this);
  }
  ...
  public void a(String paramString)
  {
    ...
    {
      return;
      i = this.jdField_a_of_type_Bjdc.a(paramString);
    } while (i == -1);
  ...
  {
    bjko.c("FriendListOpenFrame", "-->onImageLoaded() url = " + paramString1);
  ...
  {
    bjko.c("FriendListOpenFrame", "-->onStart()");
    super.b(paramBundle);
    this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.setSelection(0);
    ...
    this.jdField_a_of_type_ComTencentOpenAgentFriendChooser.a(true, false, this.jdField_a_of_type_ComTencentOpenAgentFriendChooser.getString(2131718479), this.jdField_a_of_type_JavaLangString);
    if (this.jdField_a_of_type_Bjdc == null)
    {
      this.jdField_a_of_type_Bjdc = new bjdc(this);
      this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.setAdapter(this.jdField_a_of_type_Bjdc);
      return;
    }
    this.jdField_a_of_type_Bjdc.b();
  }
  
  public void g()
  {
    this.jdField_a_of_type_Bjdc.notifyDataSetChanged();
  }
  
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    paramAdapterView = (bjdd)paramView.getTag();
    ...
    {
      return;
      paramView = (Friend)this.jdField_a_of_type_Bjdc.getItem(paramInt);
