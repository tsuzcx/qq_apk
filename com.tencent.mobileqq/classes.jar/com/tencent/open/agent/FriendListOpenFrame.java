  ...
  implements View.OnTouchListener, biyw, bjaj, bjqf, bljm
{
  ...
  public FriendListOpenFrame(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new bjmq(this);
  }
  ...
  public void a(String paramString)
  {
    ...
    {
      return;
      i = this.jdField_a_of_type_Bjmr.a(paramString);
    } while (i == -1);
  ...
  {
    bjtx.c("FriendListOpenFrame", "-->onImageLoaded() url = " + paramString1);
  ...
  {
    bjtx.c("FriendListOpenFrame", "-->onStart()");
    super.b(paramBundle);
    this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.setSelection(0);
    ...
    this.jdField_a_of_type_ComTencentOpenAgentFriendChooser.a(true, false, this.jdField_a_of_type_ComTencentOpenAgentFriendChooser.getString(2131717856), this.jdField_a_of_type_JavaLangString);
    if (this.jdField_a_of_type_Bjmr == null)
    {
      this.jdField_a_of_type_Bjmr = new bjmr(this);
      this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView.setAdapter(this.jdField_a_of_type_Bjmr);
      return;
    }
    this.jdField_a_of_type_Bjmr.b();
  }
  
  public void g()
  {
    this.jdField_a_of_type_Bjmr.notifyDataSetChanged();
  }
  
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    paramAdapterView = (bjms)paramView.getTag();
    ...
    {
      return;
      paramView = (Friend)this.jdField_a_of_type_Bjmr.getItem(paramInt);
