...
class SwitchAccountActivity$2$1
  extends GestureDetector.SimpleOnGestureListener
{
  SwitchAccountActivity$2$1(SwitchAccountActivity.2 param2) {}
  ...
  public boolean onScroll(MotionEvent paramMotionEvent1, MotionEvent paramMotionEvent2, float paramFloat1, float paramFloat2)
  {
      ...
      if (Math.abs(paramFloat1) > 20.0F)
      {
        ...
        if (!this.a.jdField_a_of_type_ComTencentOpenAgentSwitchAccountActivity.a)
        {
          ...
          if ((paramFloat1 < -20.0F) && (this.a.jdField_a_of_type_JavaLangRefWeakReference != null))
          {
            ...
            {
              paramMotionEvent1 = paramMotionEvent1.findViewById(2131377928);
    ...
    for (;;)
    {
      ...
      if (this.a.jdField_a_of_type_AndroidViewView != null)
      {
        paramMotionEvent1 = this.a.jdField_a_of_type_AndroidViewView.findViewById(2131377928);
        if ((paramMotionEvent1 != null) && (paramMotionEvent1.getVisibility() != 0))
        {
 ...
 * Qualified Name:     com.tencent.open.agent.SwitchAccountActivity.2.1
