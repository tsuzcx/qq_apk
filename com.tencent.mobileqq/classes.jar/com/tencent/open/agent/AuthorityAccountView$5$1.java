  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    do
    {
      ...
      try
      {
        this.jdField_a_of_type_ComTencentOpenAgentAuthorityAccountView$5.a.setImageBitmap(BitmapFactory.decodeResource(this.jdField_a_of_type_ComTencentOpenAgentAuthorityAccountView$5.this$0.getResources(), 2130840288));
        return;
      }
