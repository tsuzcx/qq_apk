    ...
    do
    {
      for (;;)
      {
        try
        {
          ...
          ((BitmapFactory.Options)localObject1).inSampleSize = ((int)bhmq.a((InputStream)localObject2, CreateVirtualAccountFragment.a(this.this$0).getWidth(), CreateVirtualAccountFragment.a(this.this$0).getHeight()));
          ((BufferedInputStream)localObject2).close();
          localObject1 = bhgm.a(this.a, (BitmapFactory.Options)localObject1);
