  ...
  implements View.OnClickListener
{
  ...
  private void f()
  {
    ...
    setOrientation(1);
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559526, null);
    ((LinearLayout.LayoutParams)localObject).topMargin = bdaq.a(this.jdField_a_of_type_AndroidContentContext, 37.0F);
    ((LinearLayout.LayoutParams)localObject).bottomMargin = bdaq.a(this.jdField_a_of_type_AndroidContentContext, 37.0F);
    ...
    aepi.a(this.jdField_a_of_type_AndroidWidgetTextView, i, i, i, i);
    ...
    for (;;)
    {
      ...
      localObject = this.jdField_a_of_type_Bhuf.a();
      ((RelativeLayout)localObject).addOnLayoutChangeListener(new bfbr(this, (RelativeLayout)localObject));
  ...
  private void g()
  {
    ...
    localImageView.getViewTreeObserver().addOnGlobalLayoutListener(new bfbs(this, localImageView));
  }
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_AndroidViewView != null)
      {
        ...
        localObject = bflv.a((String)localObject, 12, true);
  ...
  public void b(String paramString)
  {
    ...
    paramString = new bfbv(this, paramString);
  ...
  public void d()
  {
    ...
    for (;;)
    {
      ...
      while (i < this.jdField_a_of_type_JavaUtilArrayList.size())
      {
        ...
        ((ImageView)localObject2).setOnClickListener(new bfbt(this));
        a(str, (ImageView)localObject1);
        localRelativeLayout.setOnClickListener(new bfbu(this, str));
  ...
  public void setAppInfo(String paramString, Bitmap paramBitmap)
  {
    ...
    {
      paramString = bflv.a(paramString, 12, true);
  ...
  public void setAppType(String paramString)
  {
    ...
    if (this.jdField_a_of_type_AndroidViewView != null)
    {
      ...
      str = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131695028);
      if (!"web".equals(paramString)) {
        break label91;
      }
      str = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131695029);
    }
    for (;;)
    {
