...
class AuthorityActivity$1
  extends SSOAccountObserver
{
  AuthorityActivity$1(AuthorityActivity paramAuthorityActivity) {}
  ...
  public void onFailed(String paramString, int paramInt1, int paramInt2, Bundle paramBundle)
  {
    ...
    try
    {
      ReportManager.a().a("agent_login", this.a.d, 0L, 0L, paramInt1, Long.parseLong(paramString), "1000069", "ret: " + paramInt2 + " | error: " + str, true);
      OpenSdkStatic.a().a(1, "LOGIN_GETTICKT", paramString, AuthorityActivity.jdField_e_of_type_JavaLangString, null, Long.valueOf(SystemClock.elapsedRealtime()), paramInt1, 1, str);
      ReportCenter.a().a(paramString, "", AuthorityActivity.jdField_e_of_type_JavaLangString, "1", "1", "" + paramInt1, false, true);
      ReportCenter.a().a(paramString, "", AuthorityActivity.jdField_e_of_type_JavaLangString, "1", "6", "" + paramInt1, false, true);
      ForwardStatisticsReporter.a("KEY_DELEGATE_GET_TICKET_NO_PASSWD", paramString, false);
      ForwardStatisticsReporter.a("KEY_LOGIN_STAGE_1_TOTAL", paramString, this.a.jdField_a_of_type_Long, null, true);
      ...
      if ((paramInt2 == -1000) || (paramInt2 == 154))
      {
        ...
        LogUtility.c("Authority_TimeCost", "<TimeStamp> login cost : " + (this.a.jdField_e_of_type_Long - this.a.d));
  ...
  public void onGetTicketNoPasswd(String paramString, byte[] paramArrayOfByte, int paramInt, Bundle paramBundle)
  {
    ...
    if (!bool)
    {
      ...
      ReportCenter.a().a((Bundle)localObject, AuthorityActivity.jdField_e_of_type_JavaLangString, paramString, false, true);
      QLog.d("AuthorityActivity", 1, "rec | cmd: g_t_n_p | uin : *" + AuthorityUtil.a(paramString) + " | ret : success | code: " + i);
      LogUtility.c("Authority_TimeCost", "<TimeStamp> login cost : " + (this.a.jdField_e_of_type_Long - this.a.d));
    }
    try
    {
      ReportManager.a().a("agent_login", this.a.d, this.a.jdField_a_of_type_JavaLangString.length(), paramArrayOfByte.length, 0, Long.parseLong(paramString), "1000069", null, true);
      OpenSdkStatic.a().a(0, "LOGIN_GETTICKT", paramString, AuthorityActivity.jdField_e_of_type_JavaLangString, null, Long.valueOf(SystemClock.elapsedRealtime()), i, 1, null);
      ReportCenter.a().a(paramString, "", AuthorityActivity.jdField_e_of_type_JavaLangString, "1", "1", "0", false, true);
      this.a.i = false;
      this.a.b = 0;
      localObject = null;
      if (paramInt == 4096) {
  ...
  public void onUserCancel(String paramString, int paramInt, Bundle paramBundle)
  {
    ...
    LogUtility.c("Authority_TimeCost", "<TimeStamp> login cost : " + (this.a.jdField_e_of_type_Long - this.a.d));
    ForwardStatisticsReporter.a("KEY_DELEGATE_GET_TICKET_NO_PASSWD", paramString, false);
    ForwardStatisticsReporter.a("KEY_LOGIN_STAGE_1_TOTAL", paramString, this.a.jdField_a_of_type_Long, null, false);
 ...
 * Qualified Name:     com.tencent.open.agent.AuthorityActivity.1
