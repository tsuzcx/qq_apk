  ...
  extends BaseActivity
{
  ...
  protected boolean b;
  private BroadcastReceiver jdField_c_of_type_AndroidContentBroadcastReceiver = new bjae(this);
  ...
  private void a(Bundle paramBundle1, String paramString1, Bundle paramBundle2, String paramString2, String paramString3, String paramString4)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_MqqObserverSSOAccountObserver = a().a().a(a(), paramString4, paramString1, 1, new bizz(this, paramString3, paramBundle2, paramString2, paramString4));
      return;
  ...
  private void a(String paramString1, Bundle paramBundle, String paramString2, int paramInt)
  {
    ...
    String str3 = bjhh.a(a(), bjmq.a(), getIntent());
    ...
    new bjpl().jdField_a_of_type_JavaLangString = str3;
    auuv.a("KEY_DELEGATE_GET_TICKET_NO_PASSWD");
    String str2 = paramBundle.getString("key_proxy_appid");
    if (TextUtils.isEmpty(str2)) {}
    for (String str1 = paramString2;; str1 = str2)
    {
      this.jdField_a_of_type_MqqObserverSSOAccountObserver = a().a().a(a(), str3, str1, paramInt, new bjab(this, paramString1, paramBundle, paramString2, l, str2, paramInt));
      return;
    }
  }
  ...
  private void a(String paramString1, Bundle paramBundle, String paramString2, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramBoolean1)
    {
      ...
      localObject1 = a();
      if ((!TextUtils.isEmpty((CharSequence)localObject1)) || (!arcn.a())) {
        break label641;
      }
      String str = paramBundle.getString("ppsts");
      QLog.d("SDK_LOGIN.AgentActivity", 1, new Object[] { "ppsts=", str });
      if (!TextUtils.isEmpty(str))
      {
        localObject1 = bjhi.a(paramBundle);
        localObject2 = new HashMap();
        ((HashMap)localObject2).put("appid", paramString2);
        ((HashMap)localObject2).put("ppsts", str);
        ((HashMap)localObject2).put("sha", localObject1);
        localObject1 = bjhi.a(str, (String)localObject1);
        QLog.d("SDK_LOGIN.AgentActivity", 1, new Object[] { "can not get calling package name, use ppsts callFromPackageName=", localObject1 });
        str = bjhh.a(a(), bjmq.a(), getIntent());
        localObject3 = StatisticCollector.getInstance(BaseApplicationImpl.getApplication());
        if (TextUtils.isEmpty((CharSequence)localObject1)) {
          break label635;
        }
        bool = true;
        label219:
        ((StatisticCollector)localObject3).collectPerformance(str, "use_third_pkg_name", bool, 0L, 0L, (HashMap)localObject2, "", false);
      }
      label238:
      if (TextUtils.isEmpty((CharSequence)localObject1)) {
        break label685;
      }
      Object localObject3 = bjqk.a(this, (String)localObject1);
      localObject2 = localObject3[0];
      str = localObject3[1];
      localObject3 = localObject3[2];
      QLog.d("SDK_LOGIN.AgentActivity", 1, new Object[] { "-->onCreate appid: ", paramString2, ", package: ", localObject1, ", getAuthorizeSign.sign: ", localObject2 });
      paramBundle.putString("packagename", (String)localObject1);
      paramBundle.putString("packagesign", (String)localObject2);
      paramBundle.putString("sign", str);
      paramBundle.putString("time", (String)localObject3);
      bjhh.a(0, "LOGIN_CHECK_AGENT", null, paramString2, null, Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, null);
    }
    for (;;)
    {
      localIntent.putExtra("key_params", paramBundle);
      if ((!paramBoolean2) && ((getAppInterface() == null) || (getAppInterface().isLogin()) || (!TextUtils.isEmpty(bjmq.a())))) {
        break label775;
      }
      ...
      aojy.a().a(localIntent, paramBundle, paramString2);
      ...
      break label219;
      label641:
      QLog.d("SDK_LOGIN.AgentActivity", 1, new Object[] { "isUseThirdTransformPkgName=", Boolean.valueOf(arcn.a()), ", ppsts=", paramBundle.getString("ppsts") });
      break label238;
      label685:
      ...
      localObject2 = bjhh.a(a(), bjmq.a(), getIntent());
      ...
      bjhh.a(1, "LOGIN_CHECK_AGENT", null, paramString2, null, Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "AgentActivity callFromPackageName is null");
    }
    label775:
    if (paramBoolean1) {}
    for (;;)
    {
      try
      {
        aeow.a(this, localIntent, PublicFragmentActivityForOpenSDK.class, OpenAuthorityFragment.class, 0);
  ...
  {
    long l = System.currentTimeMillis();
    arcy localarcy = arda.b(467);
    QLog.d("SDK_LOGIN.AgentActivity", 1, new Object[] { "start_auth_use_time", " load config use time: ", Long.valueOf(System.currentTimeMillis() - l), " -->OpenSdkSwitchConfBean ", "enable: " + localarcy.a().jdField_a_of_type_Boolean });
    return localarcy.a().jdField_a_of_type_Boolean;
  }
  ...
  private void b(String paramString1, Bundle paramBundle, String paramString2, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new bjaa(this, paramString1, paramBundle, paramString2, paramBoolean);
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_Bisl = new bisl(this, 0, 2131561448, 17);
  ...
  private void f()
  {
    ...
    if (arct.a())
    {
      this.jdField_b_of_type_AndroidContentBroadcastReceiver = new bizx(this);
    ...
    bkki.a(str1, str2, str3, new bizy(this, bool));
  }
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    bizq.a();
    auuv.a();
    auuv.a("KEY_LOGIN_STAGE_1_TOTAL");
    auuv.a("KEY_AUTHORITY_TOTAL");
    e();
    ...
    if ((super.getIntent() == null) || (paramBundle != null))
    {
      ...
      bjhh.a(1, "LOGIN_CHECK_AGENT", null, null, null, Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "AgentActivity getIntent is null");
    }
    Object localObject;
    for (;;)
    {
      return true;
      String str1 = bjhh.a(super.getIntent(), "key_action");
      ...
      try
      {
        ...
        if (localBundle == null)
        {
          ...
          bjhh.a(1, "LOGIN_CHECK_AGENT", null, null, null, Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "AgentActivity bundle is null");
          return true;
        }
      }
      catch (Exception paramBundle)
      {
        ...
        if ("action_login".equals(str1))
        {
          ...
          for (;;)
          {
            bjgx.a().a(getAppInterface().getCurrentAccountUin(), "", str2, "1", "8", "0", true, true);
            return true;
            paramBundle = bjhh.a(a(), bjmq.a(), getIntent());
            if ((!TextUtils.isEmpty(paramBundle)) && (paramBundle.equals(bjmq.a()))) {
        ...
        while (localObject != null)
        {
          ...
          aojy.a().a(paramBundle, localBundle, str2);
          ...
          bjhh.a(getAppInterface().getCurrentAccountUin(), "", str2, "1", "8", "0", true);
          return true;
        ...
        for (;;)
        {
          ...
          localBundle.putString("encrytoken", bjpy.a(this, "openid_encrytoken").getString((String)localObject, ""));
          localObject = paramBundle;
          break;
