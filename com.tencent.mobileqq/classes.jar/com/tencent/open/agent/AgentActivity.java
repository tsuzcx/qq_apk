  ...
  extends BaseActivity
{
  ...
  public AgentActivity()
  {
    ...
    this.jdField_b_of_type_AndroidContentBroadcastReceiver = new bhph(this);
  }
  ...
  private String a()
  {
    ...
    localObject3 = bhwf.a(getIntent(), "login_success_uin");
  ...
  private void a(String paramString1, Bundle paramBundle, String paramString2, int paramInt)
  {
    ...
    new biej().jdField_a_of_type_JavaLangString = str3;
    ...
    {
      this.jdField_a_of_type_MqqObserverSSOAccountObserver = a().a().a(a(), str3, str1, paramInt, new bhpe(this, paramString1, paramBundle, paramString2, l, str2, paramInt));
      return;
    }
  }
  ...
  private void a(String paramString1, Bundle paramBundle, String paramString2, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramBoolean1)
    {
      ...
      localObject1 = b();
      if ((!TextUtils.isEmpty((CharSequence)localObject1)) || (!apzk.a())) {
        break label628;
      }
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject2))
      {
        ...
        bool = true;
        label209:
        ((StatisticCollector)localObject2).collectPerformance((String)localObject3, "use_third_pkg_name", bool, 0L, 0L, localHashMap, "", false);
      }
      label228:
      if (TextUtils.isEmpty((CharSequence)localObject1)) {
        break label672;
      }
      Object localObject3 = bifi.a(this, (String)localObject1);
      ...
      bhwf.a(0, "LOGIN_CHECK_AGENT", null, paramString2, null, Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, null);
    }
    for (;;)
    {
      if (localIntent != null)
      {
        ...
        anhi.a().a(localIntent, paramBundle, paramString2);
      ...
      break label209;
      label628:
      QLog.d("SDK_LOGIN.AgentActivity", 1, new Object[] { "isUseThirdTransformPkgName=", Boolean.valueOf(apzk.a()), ", ppsts=", paramBundle.getString("ppsts") });
      break label228;
      label672:
      ...
      StatisticCollector.getInstance(BaseApplicationImpl.getApplication()).collectPerformance(a(), "login_pkg_name_empty", true, 0L, 0L, (HashMap)localObject1, "", false);
      bhwf.a(1, "LOGIN_CHECK_AGENT", null, paramString2, null, Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "AgentActivity callFromPackageName is null");
    }
    label748:
    if (paramBoolean1) {}
    for (;;)
    {
      try
      {
        adxr.a(this, localIntent, PublicFragmentActivityForOpenSDK.class, OpenAuthorityFragment.class, 0);
  ...
  {
    long l = System.currentTimeMillis();
    apzv localapzv = apzx.b(467);
    QLog.d("SDK_LOGIN.AgentActivity", 1, new Object[] { "start_auth_use_time", " load config use time: ", Long.valueOf(System.currentTimeMillis() - l), " -->OpenSdkSwitchConfBean ", "enable: " + localapzv.a().jdField_a_of_type_Boolean });
    return localapzv.a().jdField_a_of_type_Boolean;
  }
  ...
  private void b(String paramString1, Bundle paramBundle, String paramString2, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new bhpd(this, paramString1, paramBundle, paramString2, paramBoolean);
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_Bhht = new bhht(this, 0, 2131561386, 17);
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    bhox.a();
    atqa.a();
    atqa.a("KEY_LOGIN_STAGE_1_TOTAL");
    atqa.a("KEY_AUTHORITY_TOTAL");
    e();
    ...
    if ((super.getIntent() == null) || (paramBundle != null))
    {
      ...
      bhwf.a(1, "LOGIN_CHECK_AGENT", null, null, null, Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "AgentActivity getIntent is null");
    }
    Object localObject;
    for (;;)
    {
      return true;
      String str1 = bhwf.a(super.getIntent(), "key_action");
      ...
      try
      {
        ...
        if (localBundle == null)
        {
          ...
          bhwf.a(1, "LOGIN_CHECK_AGENT", null, null, null, Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "AgentActivity bundle is null");
          return true;
        }
      }
      catch (Exception paramBundle)
      {
        ...
        if ("action_login".equals(str1))
        {
          ...
          for (;;)
          {
            bhvw.a().a(getAppInterface().getCurrentAccountUin(), "", str2, "1", "8", "0", true);
            return true;
        ...
        while (localObject != null)
        {
          ...
          anhi.a().a(paramBundle, localBundle, str2);
          ...
          bhwf.a(getAppInterface().getCurrentAccountUin(), "", str2, "1", "8", "0", true);
          return true;
        ...
        for (;;)
        {
          ...
          localBundle.putString("encrytoken", biew.a(this, "openid_encrytoken").getString((String)localObject, ""));
          localObject = paramBundle;
          break;
