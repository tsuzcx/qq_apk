  ...
  implements View.OnClickListener, HttpImageDownloadAsyncTask.TaskCompleteCallback
{
  ...
  protected SdkAuthorize.AuthorizeResponse a;
  ...
  private ReportDef.AuthCmdCost.Record jdField_b_of_type_ComTencentOpenAgentReportReportDef$AuthCmdCost$Record = new ReportDef.AuthCmdCost.Record();
  protected String b;
  protected boolean b;
  protected int c;
  protected long c;
  ...
  private ReportDef.AuthCmdCost.Record jdField_c_of_type_ComTencentOpenAgentReportReportDef$AuthCmdCost$Record = new ReportDef.AuthCmdCost.Record();
  protected String c;
  protected boolean c;
  protected int d;
  protected long d;
  private TextView jdField_d_of_type_AndroidWidgetTextView;
  private ReportDef.AuthCmdCost.Record jdField_d_of_type_ComTencentOpenAgentReportReportDef$AuthCmdCost$Record = new ReportDef.AuthCmdCost.Record();
  protected String d;
  protected boolean d;
  private int e;
  protected long e;
  ...
  public AuthorityActivity()
  {
    ...
    this.jdField_a_of_type_ComTencentOpenModelAccountInfo = null;
    ...
    this.jdField_a_of_type_MqqObserverSSOAccountObserver = new AuthorityActivity.1(this);
    this.jdField_g_of_type_JavaLangString = "";
    this.jdField_a_of_type_JavaLangRunnable = new AuthorityActivity.5(this);
    this.jdField_e_of_type_Int = -1;
    this.jdField_a_of_type_AndroidOsHandler$Callback = new AuthorityActivity.8(this);
  ...
  private void a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    ForwardStatisticsReporter.a(paramString, this.jdField_a_of_type_ComTencentOpenModelAccountInfo, localHashMap, paramBoolean);
  }
  ...
  private void m()
  {
    ...
    if (localObject != null)
    {
      ...
      ((TextView)((AuthorityAccountView)localObject).findViewById(2131361863)).setVisibility(0);
      localTextView = (TextView)((AuthorityAccountView)localObject).findViewById(2131361862);
      str = this.jdField_a_of_type_AndroidOsBundle.getString("sdkp");
      localObject = HardCodeUtil.a(2131700879);
      if (!"web".equals(str)) {
        break label89;
      }
      localObject = HardCodeUtil.a(2131700874);
    }
    for (;;)
    {
      ...
      if ("android".equals(str)) {
        localObject = HardCodeUtil.a(2131700880);
      }
    }
  }
  ...
  private void n()
  {
    ...
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_ComTencentOpenAgentCardContainer.findViewById(2131369487));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_ComTencentOpenAgentCardContainer.findViewById(2131369534));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_ComTencentOpenAgentCardContainer.findViewById(2131369518));
  ...
  protected void a()
  {
    if ((this.jdField_a_of_type_AndroidWidgetTextView != null) && (this.jdField_d_of_type_JavaLangString != null))
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setText(String.format(getResources().getString(2131694662), new Object[] { localObject }));
    }
    ...
    this.jdField_a_of_type_ComTencentOpenAgentCardContainer.a(this.jdField_a_of_type_ComTencentOpenModelAccountInfo.jdField_a_of_type_JavaLangString, (String)localObject, null, false);
    b();
  }
  ...
  protected void a(long paramLong)
  {
    ...
    for (localObject1 = "";; localObject1 = Build.VERSION.RELEASE)
    {
      ...
      localObject1 = AuthorityUtil.a(this);
      if (!TextUtils.isEmpty((CharSequence)localObject1)) {
      ...
      ((GetAppInfoProto.GetAppinfoRequest)localObject2).skey.set(this.jdField_a_of_type_ComTencentOpenModelAccountInfo.jdField_b_of_type_JavaLangString);
      String str = AuthorityUtil.a(this.jdField_a_of_type_ComTencentQqconnectWtloginOpenSDKAppInterface, this.jdField_a_of_type_ComTencentOpenModelAccountInfo, ((GetAppInfoProto.GetAppinfoRequest)localObject2).login_sig, "ConnAuthSvr.get_app_info", "ConnAuthSvr.get_app_info_emp");
      ...
      localNewIntent.putExtra("uin", this.jdField_a_of_type_ComTencentOpenModelAccountInfo.jdField_a_of_type_JavaLangString);
      localObject2 = ((GetAppInfoProto.GetAppinfoRequest)localObject2).toByteArray();
      localObject1 = localObject2;
      if (bool) {
        localObject1 = OpenSdkVirtualUtil.a((byte[])localObject2, this.jdField_a_of_type_ComTencentOpenModelAccountInfo);
      }
      ...
      localNewIntent.setObserver(new AuthorityActivity.6(this, bool));
      ForwardStatisticsReporter.a("KEY_GET_APP_INFO_REQUEST");
      ...
      this.jdField_c_of_type_ComTencentOpenAgentReportReportDef$AuthCmdCost$Record.jdField_a_of_type_JavaLangString = str;
  ...
  protected void a(SdkAuthorize.GetAuthApiListRequest paramGetAuthApiListRequest)
  {
    ...
    localNewIntent.setWithouLogin(true);
    localNewIntent.putExtra("uin", this.jdField_a_of_type_ComTencentOpenModelAccountInfo.jdField_a_of_type_JavaLangString);
    String str = AuthorityUtil.a(this.jdField_a_of_type_ComTencentQqconnectWtloginOpenSDKAppInterface, this.jdField_a_of_type_ComTencentOpenModelAccountInfo, paramGetAuthApiListRequest.login_sig, "ConnAuthSvr.get_auth_api_list", "ConnAuthSvr.get_auth_api_list_emp");
    ...
    if (bool)
    {
      if ((this.jdField_a_of_type_ComTencentOpenModelAccountInfo.jdField_a_of_type_ArrayOfByte == null) || (this.jdField_a_of_type_ComTencentOpenModelAccountInfo.jdField_a_of_type_ArrayOfByte.length == 0))
      {
        ...
        paramGetAuthApiListRequest.obj = getResources().getString(2131694670);
        this.jdField_a_of_type_CooperationQqfavUtilHandlerPlus.sendMessage(paramGetAuthApiListRequest);
        return;
      }
      paramGetAuthApiListRequest = OpenSdkVirtualUtil.a(arrayOfByte, this.jdField_a_of_type_ComTencentOpenModelAccountInfo);
    }
    localNewIntent.putExtra("data", paramGetAuthApiListRequest);
    localNewIntent.putExtra("cmd", str);
    this.jdField_a_of_type_Int = 0;
    localNewIntent.setObserver(new AuthorityActivity.4(this, bool, str));
    if (this.jdField_c_of_type_Int == 0) {
      ForwardStatisticsReporter.a("KEY_GET_AUTH_API_LIST_REQUEST");
    }
    super.getAppRuntime().startServlet(localNewIntent);
    ...
    this.jdField_a_of_type_CooperationQqfavUtilHandlerPlus.removeCallbacks(this.jdField_a_of_type_JavaLangRunnable);
    this.jdField_a_of_type_CooperationQqfavUtilHandlerPlus.postDelayed(this.jdField_a_of_type_JavaLangRunnable, 30000L);
    QLog.d("AuthorityActivity", 1, "send | cmd: " + str + " | uin : *" + AuthorityUtil.a(this.jdField_a_of_type_ComTencentOpenModelAccountInfo.jdField_a_of_type_JavaLangString));
  }
  ...
  public void a(String paramString, Bitmap paramBitmap)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentOpenModelAccountInfo != null) && (paramString.equals(this.jdField_a_of_type_ComTencentOpenModelAccountInfo.jdField_a_of_type_JavaLangString)) && (paramBitmap != null)) {
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    {
      QLog.d("AuthorityActivity", 1, "changeAccountLogin IsNeedLoginWithPasswd | uin : *" + AuthorityUtil.a(paramString));
      c(paramString);
    }
    for (;;)
    {
      ...
      return;
      QLog.d("AuthorityActivity", 1, "changeAccountLogin send | cmd: g_t_n_p | uin : *" + AuthorityUtil.a(paramString));
      ForwardStatisticsReporter.a("KEY_DELEGATE_GET_TICKET_NO_PASSWD");
      AccountManage.a().a(paramString, this.jdField_a_of_type_MqqObserverSSOAccountObserver, jdField_e_of_type_JavaLangString, 1);
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    if (i1 > 1)
    {
      ...
      localIntent2.putExtra("param_qr_code_url", getIntent().getStringExtra("param_qr_code_url"));
  ...
  void b(int paramInt, String paramString)
  {
    ...
    if (TextUtils.isEmpty(paramString)) {
      AuthorityUtil.a(this, String.format(super.getString(2131694667), new Object[] { Integer.valueOf(paramInt) }), new AuthorityActivity.10(this));
    }
    this.jdField_a_of_type_AndroidWidgetButton.setEnabled(true);
    this.jdField_a_of_type_AndroidWidgetButton.setText(2131694674);
    this.jdField_a_of_type_AndroidWidgetButton.setTag(Integer.valueOf(2131694670));
  ...
  protected void b(int paramInt, String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ReportCenter.a().a(this.jdField_a_of_type_JavaLangString, "", jdField_e_of_type_JavaLangString, "1", "9", paramString1, true, true);
      }
          ...
          for (;;)
          {
            for (;;)
            {
              if ((!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentQqconnectWtloginOpenSDKAppInterface.getAccount())) && (!this.jdField_a_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentQqconnectWtloginOpenSDKAppInterface.getAccount()))) {
                ReportCenter.a().a(this.jdField_a_of_type_JavaLangString, "", jdField_e_of_type_JavaLangString, "1", "10", paramString1, true, true);
              }
              if (i1 != 0) {
                break label535;
              }
              paramString1 = "0X800B65E";
              AuthReporter.a(this.jdField_a_of_type_JavaLangString, paramString1);
              return;
              label384:
              ...
              case 8: 
                ...
                try
                {
                  ReportCenter.a().a(this.jdField_a_of_type_JavaLangString, "", jdField_e_of_type_JavaLangString, "1", "6", "0", false, true);
                }
  ...
  protected void b(String paramString)
  {
    ...
    if ((TextUtils.isEmpty(jdField_e_of_type_JavaLangString)) || (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentOpenModelAccountInfo.jdField_a_of_type_JavaLangString))) {
      return;
    }
    localEditor.putString(jdField_e_of_type_JavaLangString + ":" + this.jdField_a_of_type_ComTencentOpenModelAccountInfo.jdField_a_of_type_JavaLangString, paramString);
    localEditor.commit();
  }
  
  protected void b(String paramString1, String paramString2)
  {
    StatisticCollector.getInstance(BaseApplication.getContext()).reportToAds(this.jdField_a_of_type_ComTencentQqconnectWtloginOpenSDKAppInterface, paramString1, jdField_e_of_type_JavaLangString + "|" + paramString2 + "|" + this.jdField_g_of_type_JavaLangString);
  }
  ...
  void c(int paramInt, String paramString)
  {
    ...
    {
      AuthorityUtil.a(this, paramString, new AuthorityActivity.11(this, paramInt, localJSONObject));
      return;
    }
  }
  ...
  protected void d()
  {
    ...
    this.jdField_b_of_type_JavaLangString = ((String)super.getText(2131694674));
    this.jdField_c_of_type_JavaLangString = ((String)super.getText(2131694664));
    ...
    n();
    this.jdField_c_of_type_AndroidWidgetTextView.setText(2131694661);
    if (this.m)
    {
      this.jdField_c_of_type_JavaLangString = ((String)super.getText(2131694665));
      ...
      this.jdField_a_of_type_ComTencentOpenAgentCardContainer.findViewById(2131372269).setVisibility(8);
      this.jdField_a_of_type_ComTencentOpenAgentCardContainer.setVisibility(4);
    }
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetButton.setEnabled(false);
    this.jdField_a_of_type_Float = super.getResources().getDisplayMetrics().density;
    this.jdField_a_of_type_ComTencentOpenWidgetMaxHeightScrollView.getViewTreeObserver().addOnGlobalLayoutListener(new AuthorityActivity.3(this));
  }
  
  void d(int paramInt, String paramString)
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("appid", jdField_e_of_type_JavaLangString);
    ...
    for (;;)
    {
      ...
      AuthReporter.a(this.jdField_a_of_type_JavaLangString, "0X800B65F");
      return;
      label113:
  ...
  protected void f()
  {
    ...
    if (!AuthorityUtil.a(this.jdField_a_of_type_MqqManagerWtloginManager, this.jdField_a_of_type_JavaLangString))
    {
      ...
      ForwardStatisticsReporter.a("KEY_DELEGATE_GET_TICKET_NO_PASSWD");
      AccountManage.a().a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_MqqObserverSSOAccountObserver, jdField_e_of_type_JavaLangString, 1);
  ...
  protected void i()
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentOpenModelAccountInfo != null) {
        localGetAuthApiListRequest.skey.set(this.jdField_a_of_type_ComTencentOpenModelAccountInfo.jdField_b_of_type_JavaLangString);
      }
      localObject = AuthorityUtil.a(this);
      if (!TextUtils.isEmpty((CharSequence)localObject)) {
  ...
  protected void k()
  {
    ...
    if (this.k) {
      QrAgentLoginManager.a().a((Bundle)localObject3, true);
    }
    label363:
    do
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if (((CardContainer.Permission)localObject2).jdField_a_of_type_Int > 0) {
          localAuthorizeRequest.openapi.add(Integer.valueOf(((CardContainer.Permission)localObject2).b));
        }
      }
      String str;
      if (Build.VERSION.RELEASE == null)
      ...
      for (localObject1 = localObject1.toString();; localObject1 = "")
      {
        ...
        break label427;
        localObject2 = OpenSdkVirtualUtil.a(this, (String)localObject1);
      ...
      localAuthorizeRequest.skey.set(this.jdField_a_of_type_ComTencentOpenModelAccountInfo.jdField_b_of_type_JavaLangString);
      AuthorityUtil.a(localAuthorizeRequest.url_encoded_data, true);
      this.jdField_a_of_type_Int = 1;
      localObject3 = new NewIntent(this, OpensdkServlet.class);
      ((NewIntent)localObject3).setWithouLogin(true);
      ((NewIntent)localObject3).putExtra("uin", this.jdField_a_of_type_ComTencentOpenModelAccountInfo.jdField_a_of_type_JavaLangString);
      Object localObject4 = AuthorityUtil.a(this.jdField_a_of_type_ComTencentQqconnectWtloginOpenSDKAppInterface, this.jdField_a_of_type_ComTencentOpenModelAccountInfo, localAuthorizeRequest.login_sig, "ConnAuthSvr.sdk_auth_api", "ConnAuthSvr.sdk_auth_api_emp");
      ...
      ((NewIntent)localObject3).setObserver(new AuthorityActivity.7(this, bool, (String)localObject4));
      ...
      this.jdField_d_of_type_ComTencentOpenAgentReportReportDef$AuthCmdCost$Record.jdField_a_of_type_JavaLangString = ((String)localObject4);
      this.jdField_a_of_type_CooperationQqfavUtilHandlerPlus.removeCallbacks(this.jdField_a_of_type_JavaLangRunnable);
      this.jdField_a_of_type_CooperationQqfavUtilHandlerPlus.postDelayed(this.jdField_a_of_type_JavaLangRunnable, 30000L);
      QLog.d("AuthorityActivity", 1, "send | cmd: " + (String)localObject4 + " | uin : *" + AuthorityUtil.a(this.jdField_a_of_type_ComTencentOpenModelAccountInfo.jdField_a_of_type_JavaLangString));
  ...
  public void l()
  {
    int i1 = getResources().getColor(2131165952);
  ...
  public void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      if ((-1 == paramInt2) && (paramIntent != null) && (!AuthorityUtil.a(this, paramIntent)))
      {
        this.jdField_e_of_type_Long = SystemClock.elapsedRealtime();
        LogUtility.c("Authority_TimeCost", "<TimeStamp> login cost : " + (this.jdField_e_of_type_Long - this.jdField_d_of_type_Long));
        this.jdField_a_of_type_ComTencentProtofileSdkauthorizeSdkAuthorize$AuthorizeResponse = null;
        ...
        try
        {
          ...
          if (jdField_a_of_type_Boolean)
          {
            ...
            if (bool)
            {
              ...
              AuthorityUtil.a(getAppRuntime(), this.jdField_a_of_type_JavaLangString);
            }
        ...
        catch (Exception localException)
        {
          for (;;)
          {
            LogUtility.e("AuthorityActivity", "mAuthAppId " + jdField_e_of_type_JavaLangString + " can not cast to long ");
          }
          this.i = false;
          this.jdField_a_of_type_ComTencentQqconnectWtloginOpenSDKAppInterface.a().a(this.jdField_a_of_type_JavaLangString);
          i();
        }
      }
    }
  ...
  {
    if ((this.jdField_d_of_type_Boolean) && (this.jdField_a_of_type_ComTencentOpenModelAccountInfo != null)) {}
    super.setResult(0);
    super.finish();
    c();
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      {
        QLog.d("AuthorityActivity", 1, new Object[] { "<user:>authorize btn is clicked. mGetTicketFailed=", Boolean.valueOf(this.i) });
        ...
        this.jdField_a_of_type_AndroidWidgetButton.setEnabled(false);
        if ((this.i) || (this.jdField_a_of_type_ComTencentOpenModelAccountInfo == null))
        {
          f();
        }
        ...
        else if (this.jdField_a_of_type_AndroidWidgetButton.getTag().equals(super.getString(2131694670)))
        {
          f();
        }
        else
        {
          ForwardStatisticsReporter.a("KEY_LOGIN_STAGE_2_OLD_TOTAL", this.jdField_a_of_type_ComTencentOpenModelAccountInfo);
          ...
          for (;;)
          {
            ReportCenter.a().a(this.jdField_a_of_type_JavaLangString, "", jdField_e_of_type_JavaLangString, "1", "2", "0", false, true);
            break;
            if (QLog.isColorLevel()) {
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    ForwardStatisticsReporter.a("KEY_LOGIN_STAGE_2_OLD_TOTAL");
    ...
    this.jdField_a_of_type_JavaLangString = AuthorityUtil.a(this.jdField_a_of_type_ComTencentQqconnectWtloginOpenSDKAppInterface, this.jdField_a_of_type_JavaUtilList, getIntent());
    AuthReporter.a(this.jdField_a_of_type_JavaLangString, "0X800B65C");
    d();
    this.jdField_d_of_type_JavaLangString = this.jdField_a_of_type_AndroidOsBundle.getString("oauth_app_name");
    this.jdField_g_of_type_JavaLangString = this.jdField_a_of_type_AndroidOsBundle.getString("sdkv");
    ...
    for (;;)
    {
      label855:
      this.jdField_a_of_type_ComTencentOpenAgentCardContainer.a(1);
      ReportCenter.a().a(this.jdField_a_of_type_JavaLangString, "", jdField_e_of_type_JavaLangString, "1", "1", "0", false, true);
      if (this.l) {
        this.jdField_b_of_type_Boolean = true;
      }
      if (!this.k) {
