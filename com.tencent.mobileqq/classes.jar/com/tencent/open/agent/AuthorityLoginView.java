  ...
  extends LinearLayout
{
  ...
  private void d()
  {
    this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130842599);
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130842602);
    this.jdField_a_of_type_Float = super.getResources().getDisplayMetrics().density;
    LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(-1, -2);
    setOrientation(1);
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130969250, null);
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131365702));
    this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.jdField_b_of_type_AndroidGraphicsDrawableDrawable);
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new akkx(this));
  ...
  {
    ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131365699)).setText(paramString);
    TextView localTextView = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131365698);
    ...
    localObject = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131365701);
    if (this.jdField_a_of_type_Boolean) {
      ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131365702)).setVisibility(0);
    }
    ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362730)).setVisibility(8);
  ...
  {
    ThreadManager.executeOnSubThread(new akla(this, paramString, paramImageView));
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      localObject1 = this.jdField_a_of_type_AndroidViewView.findViewById(2131365700);
    ...
    while ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0))
    {
      ...
      {
        View localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130969250, null);
        String str = (String)this.jdField_a_of_type_JavaUtilArrayList.get(i);
        ((TextView)localView.findViewById(2131365699)).setText(str);
        TextView localTextView = (TextView)localView.findViewById(2131365698);
        localTextView.setMaxWidth((int)(3.0F * this.jdField_b_of_type_Float / 5.0F));
        ...
        localObject1 = (ImageView)localView.findViewById(2131365701);
        ((ImageView)localView.findViewById(2131365702)).setVisibility(8);
        localObject2 = (ImageView)localView.findViewById(2131362730);
        ((ImageView)localObject2).setVisibility(0);
        ((ImageView)localObject2).setImageResource(2130842596);
        ((ImageView)localObject2).setTag(str);
        ((ImageView)localObject2).setOnClickListener(new akky(this));
        a(str, (ImageView)localObject1);
        localView.setOnClickListener(new akkz(this, str));
  ...
  public void b(String paramString)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setTitle(getResources().getString(2131439080));
    ...
    paramString = new aklc(this, paramString);
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setNegativeButton(2131432998, paramString);
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setPositiveButton(2131433214, paramString);
