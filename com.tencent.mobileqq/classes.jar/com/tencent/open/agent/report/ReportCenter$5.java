...
public class ReportCenter$5
  implements Runnable
{
  public ReportCenter$5(bfdq parambfdq) {}
  ...
  public void run()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 12	com/tencent/open/agent/report/ReportCenter$5:this$0	Lbfdq;
    //   4: invokevirtual 37	bfdq:b	()Landroid/os/Bundle;
    //   7: astore 29
    //   9: aload 29
    //   11: ifnonnull +4 -> 15
    //   14: return
    ...
    //   117: ldc 80
    //   119: aload 29
    //   121: invokestatic 86	com/tencent/open/base/http/HttpBaseUtil:a	(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Lbfhx;
    //   124: astore 30
    //   126: iload 10
    //   128: istore 11
    //   130: iload_2
    ...
    //   160: istore 16
    //   162: aload 30
    //   164: getfield 91	bfhx:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   167: invokestatic 94	com/tencent/open/base/http/HttpBaseUtil:a	(Ljava/lang/String;)Lorg/json/JSONObject;
    //   170: astore 31
    //   172: iload 10
    //   174: istore 11
    //   176: iload_2
    ...
    //   201: aload 31
    //   203: ldc 96
    //   205: invokevirtual 102	org/json/JSONObject:getInt	(Ljava/lang/String;)I
    //   208: istore_1
    //   209: iload_1
    //   210: ifeq +514 -> 724
    //   213: iload 10
    ...
    //   253: istore 16
    //   255: aload 30
    //   257: getfield 91	bfhx:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   260: invokestatic 108	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   263: ifne +6 -> 269
    //   266: goto +458 -> 724
    //   269: iload 9
    //   271: istore 11
    ...
    //   303: istore 16
    //   305: aload 30
    //   307: getfield 111	bfhx:jdField_a_of_type_Long	J
    //   310: lstore 17
    //   312: iload 9
    //   314: istore 11
    //   316: iload_1
    ...
    //   396: lstore 25
    //   398: aload_0
    //   399: getfield 12	com/tencent/open/agent/report/ReportCenter$5:this$0	Lbfdq;
    //   402: ldc 78
    //   404: lload 21
    //   406: lload 19
    //   408: lload 25
    //   410: iload_1
    //   411: invokestatic 118	bexd:a	()Lbexd;
    //   414: invokevirtual 120	bexd:a	()J
    //   417: ldc 122
    //   419: aconst_null
    //   420: iconst_0
    //   421: invokevirtual 125	bfdq:a	(Ljava/lang/String;JJJIJLjava/lang/String;Ljava/lang/String;Z)V
    //   424: iload 9
    //   426: ifeq +257 -> 683
    //   429: invokestatic 130	bfds:a	()Lbfds;
    //   432: ldc 132
    //   434: invokevirtual 135	bfds:a	(Ljava/lang/String;)V
    //   437: aload_0
    //   438: getfield 12	com/tencent/open/agent/report/ReportCenter$5:this$0	Lbfdq;
    //   441: astore 29
    //   443: aload 29
    //   445: monitorenter
    //   446: aload_0
    //   447: getfield 12	com/tencent/open/agent/report/ReportCenter$5:this$0	Lbfdq;
    //   450: getfield 138	bfdq:b	Ljava/util/ArrayList;
    //   453: invokevirtual 143	java/util/ArrayList:clear	()V
    //   456: aload 29
    //   458: monitorexit
    ...
    //   480: iload 9
    //   482: invokevirtual 148	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    ...
    //   503: ldc 150
    //   505: aload 29
    //   507: invokestatic 153	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   510: return
    //   511: astore 31
    //   513: bipush 252
    //   515: istore_1
    ...
    //   571: astore 29
    //   573: aload_0
    //   574: getfield 12	com/tencent/open/agent/report/ReportCenter$5:this$0	Lbfdq;
    //   577: astore 29
    //   579: aload 29
    //   581: monitorenter
    //   582: aload_0
    //   583: getfield 12	com/tencent/open/agent/report/ReportCenter$5:this$0	Lbfdq;
    //   586: getfield 138	bfdq:b	Ljava/util/ArrayList;
    //   589: invokevirtual 143	java/util/ArrayList:clear	()V
    //   592: aload 29
    //   594: monitorexit
    ...
    //   622: istore 9
    //   624: aload 29
    //   626: invokevirtual 158	com/tencent/open/base/http/HttpBaseUtil$HttpStatusException:getMessage	()Ljava/lang/String;
    //   629: ldc 160
    //   631: ldc 162
    //   633: invokevirtual 168	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   636: invokestatic 173	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   639: istore_1
    //   640: iload_1
    //   641: istore_3
    //   642: iload_3
    ...
    //   661: lstore 17
    //   663: aload 30
    //   665: invokestatic 178	bfib:a	(Ljava/io/IOException;)I
    //   668: istore_1
    //   669: iload 14
    //   671: istore 9
    //   673: lload 23
    ...
    //   679: istore_2
    //   680: goto -313 -> 367
    //   683: invokestatic 130	bfds:a	()Lbfds;
    //   686: ldc 132
    //   688: aload_0
    //   689: getfield 12	com/tencent/open/agent/report/ReportCenter$5:this$0	Lbfdq;
    //   692: getfield 138	bfdq:b	Ljava/util/ArrayList;
    //   695: invokevirtual 181	bfds:a	(Ljava/lang/String;Ljava/util/List;)V
    //   698: goto -261 -> 437
    //   701: astore 30
    //   703: aload 29
    //   705: monitorexit
