...
public class ReportCenter
{
  ...
  {
    this.jdField_a_of_type_AndroidOsHandler = new aknh(this, Looper.getMainLooper());
  ...
  public void a()
  {
    this.jdField_b_of_type_JavaUtilConcurrentExecutor.execute(new aknl(this));
  }
  ...
  public void a(Bundle paramBundle, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        this.jdField_b_of_type_JavaUtilConcurrentExecutor.execute(new akni(this, paramString2, paramBundle, paramBoolean));
        return;
      }
      catch (Exception localException)
      {
  ...
  {
    this.c.execute(new aknk(this, paramString));
  }
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, String paramString3, boolean paramBoolean)
  {
    ...
    this.c.execute(new aknn(this, paramInt3, paramString1, paramString3, paramInt1, paramInt2, paramString2, paramBoolean));
  }
  ...
  public void a(String paramString1, long paramLong1, long paramLong2, long paramLong3, int paramInt, long paramLong4, String paramString2, String paramString3, boolean paramBoolean)
  {
    ...
    this.c.execute(new aknj(this, paramString2, paramString1, paramString3, paramInt, paramLong2, paramLong3, l - paramLong1, paramLong4, paramBoolean));
  }
  
  public void a(String paramString1, String paramString2, Bundle paramBundle, boolean paramBoolean)
  {
    this.jdField_a_of_type_JavaUtilConcurrentExecutor.execute(new aknm(this, paramBundle, paramString1, paramBoolean));
  }
