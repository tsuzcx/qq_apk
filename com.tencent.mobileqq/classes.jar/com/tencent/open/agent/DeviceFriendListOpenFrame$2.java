  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    for (;;)
    {
      if (i < j)
      {
        bdau localbdau = (bdau)this.this$0.a.getChildAt(i).getTag();
        if ((localbdau != null) && (this.jdField_a_of_type_JavaLangString.equals(localbdau.b))) {
          localbdau.a.setImageBitmap(this.jdField_a_of_type_AndroidGraphicsBitmap);
        }
      }
      else
      {
