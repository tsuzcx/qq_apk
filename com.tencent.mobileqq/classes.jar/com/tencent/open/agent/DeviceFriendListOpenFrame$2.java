  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    for (;;)
    {
      if (i < j)
      {
        bjcp localbjcp = (bjcp)this.this$0.a.getChildAt(i).getTag();
        if ((localbjcp != null) && (this.jdField_a_of_type_JavaLangString.equals(localbjcp.b))) {
          localbjcp.a.setImageBitmap(this.jdField_a_of_type_AndroidGraphicsBitmap);
        }
      }
      else
      {
