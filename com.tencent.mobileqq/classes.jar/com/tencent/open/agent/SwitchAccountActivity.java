  ...
  implements View.OnClickListener
{
  ...
  public SwitchAccountActivity()
  {
    ...
    this.jdField_a_of_type_MqqObserverSSOAccountObserver = new aknb(this);
    this.jdField_a_of_type_AndroidViewView$OnTouchListener = new aknc(this);
  }
  ...
  public void a()
  {
    ...
    for (;;)
    {
      ...
      if (j < this.jdField_a_of_type_JavaUtilArrayList.size())
      {
        ...
        TextView localTextView1 = (TextView)localView.findViewById(2131362725);
        TextView localTextView2 = (TextView)localView.findViewById(2131362726);
        ImageView localImageView = (ImageView)localView.findViewById(2131362721);
        ...
        ((Button)localView.findViewById(2131362724)).setOnClickListener(this);
      ...
      else
      {
        ...
        ReportCenter.a().a("", "", "", "1010", String.valueOf(k), "0", false);
        localObject1 = localLayoutInflater.inflate(2130968592, this.jdField_a_of_type_AndroidWidgetLinearLayout, false);
    ...
    for (;;)
    {
      if (i < this.jdField_a_of_type_AndroidWidgetLinearLayout.getChildCount())
      {
        ...
        if (i == 0)
        {
          ...
          paramString.setBackgroundResource(2130838619);
        }
      }
      return;
      label432:
      paramString.setBackgroundResource(2130838631);
      return;
      label439:
      i += 1;
    }
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    super.setContentView(2130971577);
    ...
    super.setTitle(2131435577);
    this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog = new QQProgressDialog(this, getTitleBarHeight());
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)super.findViewById(2131375021));
