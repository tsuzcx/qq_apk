...
public class DownloadCenterImpl
{
  ...
  private INetEventHandler jdField_a_of_type_ComTencentMobileqqMsfSdkHandlerINetEventHandler = new akpa(this);
  private DownloadListener jdField_a_of_type_ComTencentOpenDownloadnewDownloadListener = new akpb(this);
  ...
  public int a(DownloadInfo paramDownloadInfo)
  {
    ...
    int j = 0;
    Object localObject1;
    if (AppUtil.a(paramDownloadInfo.jdField_d_of_type_JavaLangString))
    {
    ...
    DownloadInfo localDownloadInfo = DownloadManager.a().a(paramDownloadInfo.jdField_b_of_type_JavaLangString);
    boolean bool;
    if ("com.tencent.now".equals(paramDownloadInfo.jdField_d_of_type_JavaLangString))
    {
      bool = NowUtil.a(paramDownloadInfo.jdField_b_of_type_JavaLangString, paramDownloadInfo.jdField_d_of_type_JavaLangString);
      if (localDownloadInfo == null)
      {
        ...
        if (bool)
        {
          ...
          localObject1 = new DownloadInfo(paramDownloadInfo.jdField_b_of_type_JavaLangString, paramDownloadInfo.jdField_c_of_type_JavaLangString, paramDownloadInfo.jdField_d_of_type_JavaLangString, paramDownloadInfo.jdField_e_of_type_JavaLangString, paramDownloadInfo.g, null, paramDownloadInfo.jdField_e_of_type_Int, paramDownloadInfo.jdField_c_of_type_Boolean);
          ((DownloadInfo)localObject1).a(4);
          ((DownloadInfo)localObject1).k = NowUtil.b();
    ...
    for (;;)
    {
      ...
      i = j;
      continue;
      localObject1 = localDownloadInfo.k;
      if ((NowUtil.b((String)localObject1)) || (bool))
      {
        if (bool)
        {
          ...
          if (NowUtil.a((String)localObject1, paramDownloadInfo.jdField_b_of_type_JavaLangString, paramDownloadInfo.jdField_d_of_type_JavaLangString))
          {
            NowUtil.a((String)localObject1);
            localDownloadInfo.k = NowUtil.b();
          }
        }
        for (;;)
        {
        ...
        label427:
        DownloadManager.a().a(localDownloadInfo.jdField_b_of_type_JavaLangString, true);
        NowUtil.a(NowUtil.b());
        NowUtil.a((String)localObject1);
        i = j;
      }
          ...
          if (localDownloadInfo != null)
          {
            ...
            if (TextUtils.isEmpty(localDownloadInfo.k)) {
              if (localDownloadInfo.jdField_c_of_type_Int == 0)
              {
                ...
                if (!TextUtils.isEmpty((CharSequence)localObject1))
                {
                  localDownloadInfo.k = ((String)localObject1);
                  localDownloadInfo.a(4);
                  DownloadManager.a().e(localDownloadInfo);
                }
              }
            }
            for (localObject2 = localObject1;; localObject2 = localDownloadInfo.k)
            {
  ...
  public int a(ArrayList paramArrayList)
  {
    ...
    ThreadManager.getSubThreadHandler().post(new akpc(this, paramArrayList));
    return 0;
  }
  ...
  {
    if (NowUtil.a(paramDownloadInfo.jdField_b_of_type_JavaLangString, paramDownloadInfo.jdField_d_of_type_JavaLangString))
    {
