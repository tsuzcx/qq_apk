...
public class AppClient
{
  ...
  public static void a(Activity paramActivity, Bundle paramBundle)
  {
    ...
    if ((!TextUtils.isEmpty(paramActivity)) && (paramActivity.contains("&")))
    {
      ...
      for (;;)
      {
        try
        {
          ...
          {
            str1 = (String)localHashMap.get(DownloadConstants.b);
            localObject4 = (String)localHashMap.get(DownloadConstants.jdField_c_of_type_JavaLangString);
            ...
            str2 = (String)localHashMap.get(DownloadConstants.e);
            localObject7 = (String)localHashMap.get("via");
            localObject3 = (String)localHashMap.get("packName");
            if (!TextUtils.isEmpty((CharSequence)localObject3)) {
              break label422;
            }
            localObject3 = (String)localHashMap.get(DownloadConstants.f);
      ...
      ((Bundle)localObject6).putString(DownloadConstants.b, localMalformedURLException);
      ((Bundle)localObject6).putString(DownloadConstants.jdField_c_of_type_JavaLangString, (String)localObject4);
      ((Bundle)localObject6).putString(DownloadConstants.d, (String)localObject5);
      ((Bundle)localObject6).putString(DownloadConstants.e, str2);
      ((Bundle)localObject6).putString(DownloadConstants.f, (String)localObject3);
      ((Bundle)localObject6).putString(DownloadConstants.i, (String)localObject7);
      ((Bundle)localObject6).putString(DownloadConstants.C, paramActivity);
    ...
    for (;;)
    {
      ...
      LogUtility.b("Jie", "APP_URL:" + (String)localObject3 + " |  PARAMS >>> " + ((Bundle)localObject7).getString("APP_PARAMS"));
      ...
      catch (Exception paramString2)
      {
        try
        {
          for (;;)
          {
            ...
            LogUtility.d("AppClient", ">>>appid=" + paramString1.jdField_c_of_type_JavaLangString + " myAppid=" + paramString1.j);
  ...
  protected static void a(Activity paramActivity, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    for (;;)
    {
      ...
      if (TextUtils.isEmpty(str2))
      {
        ...
        String str5 = (String)((HashMap)localObject2).get(DownloadConstants.jdField_c_of_type_JavaLangString);
        if (!TextUtils.isEmpty(str5)) {
          break label870;
        }
        str5 = (String)((HashMap)localObject2).get("ta");
        String str6 = (String)((HashMap)localObject2).get(DownloadConstants.d);
        ...
        ((Bundle)localObject1).putString(DownloadConstants.b, str8);
        ((Bundle)localObject1).putString(DownloadConstants.jdField_c_of_type_JavaLangString, str5);
        ((Bundle)localObject1).putString(DownloadConstants.d, str6);
        if (!TextUtils.isEmpty(str9)) {
          ((Bundle)localObject1).putString(DownloadConstants.f, str9);
        }
        ((Bundle)localObject1).putString(DownloadConstants.e, str13);
      }
      try
      {
