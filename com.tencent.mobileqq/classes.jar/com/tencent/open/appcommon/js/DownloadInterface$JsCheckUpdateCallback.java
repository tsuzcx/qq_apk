  ...
  implements UpdateManager.OnCheckUpdateListener
{
  ...
  public void onException(String paramString)
  {
    ...
    LogUtility.e("DownloadInterface", "JsCheckUpdateCallback onException >>> " + paramString);
  ...
  public void onResult(ArrayList<ApkUpdateDetail> paramArrayList)
  {
    ...
    LogUtility.a("DownloadInterface", "JsCheckUpdateCallback onResult >>> " + paramArrayList.size());
    ...
    LogUtility.b("DownloadInterface", ">>checkUpdate jsUrl:" + paramArrayList);
