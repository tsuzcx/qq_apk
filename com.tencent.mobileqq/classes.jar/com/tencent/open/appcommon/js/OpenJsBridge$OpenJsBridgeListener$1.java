...
public class OpenJsBridge$OpenJsBridgeListener$1
  implements Runnable
{
  public OpenJsBridge$OpenJsBridgeListener$1(bjin parambjin, String paramString1, String paramString2, WebView paramWebView) {}
  
  public void run()
  {
    bjko.b("OpenJsBridge", "[onOpenComplete]AsyncInterface_end:javascript:window.JsBridge&&JsBridge.callback('interface." + this.jdField_a_of_type_JavaLangString + "',{guid:" + this.this$0.b + ",'r':0,'data':" + this.b + "});");
    try
    {
