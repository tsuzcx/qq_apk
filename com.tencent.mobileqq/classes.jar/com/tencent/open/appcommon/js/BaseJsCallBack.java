  ...
  extends BaseInterface
{
  ...
  private bmig mRemoteServiceProxy;
  ...
  public BaseJsCallBack(Activity paramActivity)
  {
    ...
    for (this.activity = ((PluginBaseActivity)paramActivity).getOutActivity();; this.activity = paramActivity)
    {
      ...
      this.mRemoteServiceProxy = bmig.a(String.valueOf(bjjo.a().a()));
      return;
    }
  }
  ...
  public String appIsExistsBatch(String paramString1, String paramString2)
  {
    ...
    bjtx.c("BaseJsCallBack", "appIsExistsBatch >>>" + ((StringBuilder)localObject).substring(0, ((StringBuilder)localObject).length() - 1));
  ...
  public void cgiReport(String paramString1, String paramString2, String paramString3)
  {
    try
    {
      ...
      bjvn.a().a(paramString1, SystemClock.elapsedRealtime() - l, 0L, 0L, i, bjjo.a().a(), "1000002", null);
      return;
    }
  ...
  public int getAPNType()
  {
    ...
    for (;;)
    {
      ...
      {
        int j;
        bjtx.c("BaseJsCallBack", "getAPNType EX >>> ", localException);
        continue;
        i = -1;
        continue;
      }
  ...
  public String getAppVersionCode(String paramString)
  {
    try
    {
      ...
      int i = 0;
      if (bjva.a(paramString)) {
        i = bjva.a(paramString);
      }
      paramString = new JSONObject();
      paramString.put("installedVersionCode", i);
      paramString.put("downloadedVersionCode ", bjva.b(bjwq.a().a((String)localObject)));
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i < paramString.length())
        {
          ...
          if (!bjva.a((String)localObject1)) {
            break label145;
          }
          j = bjva.a((String)localObject1);
          localObject1 = new JSONObject();
          ((JSONObject)localObject1).put("installedVersionCode", j);
          ((JSONObject)localObject1).put("downloadedVersionCode", bjva.b(bjwq.a().a((String)localObject2)));
          localJSONObject.put((String)localObject2, localObject1);
        }
      }
      catch (Exception paramString)
      {
        bjtx.c("BaseJsCallBack", "getAppVersionCode ", paramString);
      }
  ...
  public String getUin()
  {
    ...
    return String.valueOf(bjjo.a().a());
  }
  
  public void goOldDetail(String paramString)
  {
    bjqz.a(this.activity, paramString);
  }
  
  public void goToDetailPage(String paramString1, String paramString2)
  {
    bjtx.c("TIME-STATISTIC", "JsCallBack--goToDetailPage");
    Object localObject;
    boolean bool1;
    boolean bool2;
    try
    {
      ...
      paramString2.putString(bjwo.b, paramString1.optString("appid"));
      paramString2.putString(bjwo.f, paramString1.optString("packageName"));
      paramString2.putString(bjwo.i, paramString1.optString("via"));
      paramString2.putString(bjwo.c, paramString1.optString("myAppId"));
      paramString2.putString(bjwo.d, paramString1.optString("apkId"));
      paramString2.putInt(bjwo.e, paramString1.optInt("versionCode"));
      ...
      if (this.lastActionRecord == null) {
        this.lastActionRecord = new bjru(str, (String)localObject, i);
      }
      while (!this.lastActionRecord.a(str, (String)localObject, i))
      {
        ...
        localObject = bjwq.a().a(paramString1.optString("appid"));
    ...
    {
      bjtx.c("BaseJsCallBack", "goToDetailPage>>>", paramString1);
      return;
    }
    label282:
    if ((((DownloadInfo)localObject).c == 1) && (bjxd.a().b()))
    {
  ...
  public void goToDownloadTaskList(String paramString)
  {
    ...
    try
    {
      ...
      localBundle.putString(bjwo.i, paramString.optString("via"));
      ThreadManager.getSubThreadHandler().post(new BaseJsCallBack.4(this, localBundle));
      return;
    }
    catch (JSONException paramString)
    {
      bjtx.c("BaseJsCallBack", "goToDetailPage>>>", paramString);
    }
  }
  ...
  public void goUrl(String paramString)
  {
    ...
    bjtx.c("BaseJsCallBack", paramString);
    Object localObject3;
    ...
    try
    {
      ...
      {
        bjtx.e("BaseJsCallBack", "gourl strUrl == null");
        return;
      }
    }
    catch (JSONException paramString)
    ...
    for (localObject1 = (String)localObject1 + "?";; localObject1 = (String)localObject1 + "&")
    {
      ...
      if (((String)localObject1).indexOf("{UIN}") > 0) {
        paramString = ((String)localObject1).replaceAll("\\{UIN\\}", bjjo.a().a() + "");
      }
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      bjtx.c("BaseJsCallBack", "array = " + paramString.toString() + " | " + paramString.size());
      label462:
      ...
      ((Bundle)localObject3).putString("uin", String.valueOf(bjjo.a().a()));
      ((Bundle)localObject3).putString("sid", bjjo.a().a());
  ...
  protected void goUrl(String paramString, boolean paramBoolean)
  {
    ...
    try
    {
      localJSONArray.put(this.activity.getString(2131691301));
    ...
    {
      bjtx.c("BaseJsCallBack", "gourl(onlyurl) error ", paramString);
    }
  }
  ...
  public void goWebApp(String paramString)
  {
    ...
    //   885: invokestatic 164	bjtx:c	(Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   1073: ldc_w 646
    //   1076: aload 25
    //   1078: invokestatic 274	bjtx:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   1081: aload 31
    //   1083: astore 25
    //   1085: goto -329 -> 756
    //   1088: astore 26
    ...
    //   1130: ldc_w 648
    //   1133: aload 26
    //   1135: invokestatic 274	bjtx:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   1138: aload 31
    //   1140: astore 25
    //   1142: goto -386 -> 756
    //   1145: astore 26
  ...
  {
    new AlertDialog.Builder(this.activity).setTitle("javaScript dialog").setMessage(paramString).setPositiveButton(17039370, new bjrl(this)).setCancelable(false).create().show();
  }
  ...
  public void report(String paramString)
  {
    ...
    bjtx.b("BaseJsCallBack", "[report] json=" + paramString);
    try
    {
      paramString = new JSONObject(paramString);
      bjto.a(paramString.optInt("type"), paramString.optString("data"));
      return;
    }
    catch (JSONException paramString)
    {
  ...
  public void reportBatch(String paramString)
  {
    ...
    bjtx.b("BaseJsCallBack", "[reportBatch] json=" + paramString);
    for (;;)
    {
      int i;
      try
      {
        ...
        if (localJSONObject != null) {
          bjto.a(localJSONObject.optInt("type"), localJSONObject.optString("data"));
        }
      }
      catch (JSONException paramString)
      {
  ...
  public void reportForVia(String paramString)
  {
    ...
    try
    {
      ...
      bjvg.a(paramString, str1, str2, (String)localObject, localBundle);
      bjtx.c("BaseJsCallBack", "reportForvia " + paramString + " | " + str1 + " | " + str2);
      return;
    }
    catch (JSONException paramString)
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localObject != null)
        {
          ...
          bjvg.a(str1, str2, str3, (String)localObject, localBundle);
          bjtx.c("BaseJsCallBack", "reportForvia " + str1 + " | " + str2 + " | " + str3);
        }
      }
      catch (JSONException paramString)
      {
  ...
  public void reportPV(String paramString1, String paramString2)
  {
    ...
    if (bjva.a(paramString1))
    {
      bjvg.a("100", "ANDROIDQQ.INSTALLED.APPDETAIL", paramString2);
      return;
    }
    if (bjwq.a().a(paramString2))
    {
      bjvg.a("100", "ANDROIDQQ.UNINSTALL.APPDETAIL", paramString2);
      return;
    }
    bjvg.a("100", "ANDROIDQQ.UNDOWNLOAD.APPDETAIL", paramString2);
  }
  ...
  {
    bjtx.c("BaseJsCallBack", "JsCallBack--setCommonReportData");
    if (!TextUtils.isEmpty(paramString)) {
      try
      {
        bjjo.a().c(paramString);
        return true;
      }
      catch (Exception paramString)
      {
        bjtx.c("BaseJsCallBack", "JsCallBack--setCommonReportData Exception", paramString);
      }
    }
    return false;
  }
    ...
    for (;;)
    {
      ...
      try
      {
        if (appIsExists(paramString1))
        {
          ...
          bjva.a(this.activity, paramString1, paramString2);
          return;
        }
      }
      catch (Exception paramString2)
      {
        bjtx.e("startApp", "apk not exist packName = " + paramString1);
      }
    }
  }
  ...
  public void startApp(String paramString1, String paramString2, String paramString3)
  {
    try
    {
      if (appIsExists(paramString1))
      {
        ...
        bjtx.c("add", ">>has add platformid=qzone_m");
      }
      try
      {
  ...
  public void startOpenApp(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    //   43: invokestatic 692	bjtx:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   46: aload_0
    //   47: aload_1
    ...
    //   72: aload_1
    //   73: aload_2
    //   74: invokestatic 829	bjva:a	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   77: return
    //   78: astore_1
    //   79: ldc 8
    ...
    //   104: invokestatic 224	bjtx:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   107: return
    //   108: astore_2
    //   109: aload 5
    //   111: astore_2
