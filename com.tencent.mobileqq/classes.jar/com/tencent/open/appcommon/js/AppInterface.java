  ...
  extends BaseInterface
{
  ...
  public String gSetPackageScanSetting(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      {
        bjvg.a("100", "ANDROIDQQ.STORE.UPDATECHECKBOX", "");
        paramString1 = new bjri(this, paramString2);
        this.mHandler.post(new AppInterface.2(this, paramString1));
        return null;
      }
    } while (!paramString1.equals("1"));
    paramString1 = bjjo.a().a().getSharedPreferences("package_scan", 0).edit();
  ...
  protected JSONArray getAppInfo(PackageInfo paramPackageInfo, String paramString1, String paramString2, String paramString3)
  {
    ...
    if ("true".equals(paramString1))
    {
      ...
      paramString1.put(bjtv.a(paramPackageInfo.applicationInfo.loadIcon(this.activity.getPackageManager())));
      label128:
      if (k == 0) {
        break label252;
      }
  ...
  public String getAppInfoBatch(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    paramString1 = bjud.a(paramString1, paramString2);
    ...
    for (;;)
    {
      ...
      if (i < j)
      {
        ...
        if ((TextUtils.isEmpty(localCharSequence)) || (!bhny.a(this.activity, localCharSequence))) {}
      }
      try
      {
  ...
  {
    bjtx.b("AppUpdate", "getUpdateApp , param = " + paramString);
    try
    {
      bjjo.a().a(paramString, this.activity, this.webView);
      return;
    }
  ...
  {
    if (!hasRight()) {}
    while (!bjva.b(this.activity, paramString)) {
      return -1;
    }
    return 0;
  }
