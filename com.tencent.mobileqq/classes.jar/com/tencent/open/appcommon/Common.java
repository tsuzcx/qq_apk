...
public class Common
{
  ...
  public static void a(boolean paramBoolean)
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: invokestatic 411	java/util/concurrent/Executors:newSingleThreadScheduledExecutor	()Ljava/util/concurrent/ScheduledExecutorService;
    //   6: astore_3
    //   7: new 413	aldk
    //   10: dup
    //   11: invokespecial 414	aldk:<init>	()V
    //   14: astore 4
    //   16: iload_0
    //   17: ifeq +24 -> 41
    //   20: ldc2_w 415
    ...
    //   25: aload 4
    //   27: lload_1
    //   28: getstatic 422	java/util/concurrent/TimeUnit:SECONDS	Ljava/util/concurrent/TimeUnit;
    //   31: invokeinterface 428 5 0
    //   36: pop
    //   37: ldc 2
    //   39: monitorexit
    //   40: return
  ...
  {
    return g() + File.separator + "qapp_center_base.htm";
  }
