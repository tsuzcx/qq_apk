  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    label169:
    Object localObject3;
    if (bdfn.a(this.jdField_a_of_type_AndroidOsBundle.getString("schemaUrl")).get("auto_download") != null)
    {
      bool = true;
      if (!bdlr.a().a(bcyb.a().a(), this.jdField_b_of_type_AndroidOsBundle, bool, false))
      {
        localObject1 = bdfn.g() + File.separator + "qapp_center_detail.htm";
        localObject2 = new File((String)localObject1);
        if (!((File)localObject2).exists())
        {
          bdii.d("AppClient", "file" + (String)localObject1 + " not exist copyassets.");
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        bdii.b("Jie", "APP_URL:" + (String)localObject2 + " |  PARAMS >>> " + localBundle.getString("APP_PARAMS"));
