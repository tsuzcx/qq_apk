...
public class APNUtil
{
  ...
  protected static Uri b = Uri.parse("content://telephony/carriers/preferapn");
  ...
  public static String c(Context paramContext)
  {
    ...
    //   4: getstatic 22	com/tencent/open/base/APNUtil:b	Landroid/net/Uri;
    //   7: aconst_null
    //   8: aconst_null
    //   9: aconst_null
    //   10: aconst_null
    //   11: invokevirtual 84	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   14: astore_1
    //   15: aload_1
    //   16: ifnonnull +15 -> 31
    //   19: aload_1
    ...
    //   83: astore_0
    //   84: aload_2
    //   85: invokevirtual 106	java/lang/Exception:printStackTrace	()V
    //   88: aload_1
    //   89: ifnull +9 -> 98
    //   92: aload_1
  ...
  public static String d(Context paramContext)
  {
    ...
    //   2: astore_2
    //   3: aload_0
    //   4: invokevirtual 78	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   7: getstatic 22	com/tencent/open/base/APNUtil:b	Landroid/net/Uri;
    //   10: aconst_null
    //   11: aconst_null
    //   12: aconst_null
    //   13: aconst_null
    //   14: invokevirtual 84	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   17: astore_1
    //   18: aload_1
    //   19: ifnonnull +15 -> 34
    //   22: aload_1
    ...
    //   133: astore_0
    //   134: aload_2
    //   135: invokevirtual 106	java/lang/Exception:printStackTrace	()V
    //   138: aload_1
    //   139: ifnull +9 -> 148
    //   142: aload_1
    //   143: invokeinterface 89 1 0
    //   148: ldc 111
    //   150: areturn
    //   151: astore_2
    //   152: aload_0
  ...
  public static int e(Context paramContext)
  {
    ...
    //   8: getstatic 22	com/tencent/open/base/APNUtil:b	Landroid/net/Uri;
    //   11: aconst_null
    //   12: aconst_null
    //   13: aconst_null
    //   14: aconst_null
    //   15: invokevirtual 84	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   18: astore_0
    //   19: aload_0
    //   20: ifnonnull +15 -> 35
    //   23: aload_0
  ...
  public static boolean k(Context paramContext)
  {
    ...
    {
      LogUtility.c(a, "checkNetWork Exception", paramContext);
    }
  }
}
