  ...
  extends HttpAsyncTask
{
  ...
  protected Bitmap a(java.lang.Void... paramVarArgs)
  {
    ...
    //   0: aconst_null
    //   1: astore_2
    //   2: new 113	org/apache/http/impl/client/DefaultHttpClient
    //   5: dup
    //   6: aload_0
    //   7: getfield 19	com/tencent/open/base/http/HttpImageDownloadAsyncTask:jdField_a_of_type_OrgApacheHttpImplConnTsccmThreadSafeClientConnManager	Lorg/apache/http/impl/conn/tsccm/ThreadSafeClientConnManager;
    //   10: aconst_null
    //   11: invokespecial 116	org/apache/http/impl/client/DefaultHttpClient:<init>	(Lorg/apache/http/conn/ClientConnectionManager;Lorg/apache/http/params/HttpParams;)V
    //   14: astore_1
    //   15: new 118	org/apache/http/client/methods/HttpGet
    //   18: dup
    //   19: aload_0
    //   20: getfield 120	com/tencent/open/base/http/HttpImageDownloadAsyncTask:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   23: invokespecial 121	org/apache/http/client/methods/HttpGet:<init>	(Ljava/lang/String;)V
    //   26: astore_3
    //   27: aload_0
    //   28: getfield 25	com/tencent/open/base/http/HttpImageDownloadAsyncTask:jdField_a_of_type_AndroidOsBundle	Landroid/os/Bundle;
    //   31: ifnull +93 -> 124
    //   34: aload_0
    //   35: getfield 25	com/tencent/open/base/http/HttpImageDownloadAsyncTask:jdField_a_of_type_AndroidOsBundle	Landroid/os/Bundle;
    //   38: invokevirtual 127	android/os/Bundle:keySet	()Ljava/util/Set;
    ...
    //   55: ifeq +69 -> 124
    //   58: aload 4
    //   60: invokeinterface 142 1 0
    //   65: checkcast 144	java/lang/String
    //   68: astore 5
    //   70: aload_0
    //   71: getfield 25	com/tencent/open/base/http/HttpImageDownloadAsyncTask:jdField_a_of_type_AndroidOsBundle	Landroid/os/Bundle;
    //   74: aload 5
    //   76: invokevirtual 148	android/os/Bundle:get	(Ljava/lang/String;)Ljava/lang/Object;
    //   79: astore 6
    //   81: aload 6
    //   83: instanceof 144
    //   86: ifeq -38 -> 48
    ...
    //   90: aload 5
    //   92: aload 6
    //   94: checkcast 144	java/lang/String
    //   97: invokevirtual 151	org/apache/http/client/methods/HttpGet:addHeader	(Ljava/lang/String;Ljava/lang/String;)V
    //   100: goto -52 -> 48
    //   103: astore_3
    //   104: aconst_null
    //   105: astore_1
    ...
    //   107: astore_2
    //   108: aload_3
    //   109: invokevirtual 154	java/lang/Exception:printStackTrace	()V
    //   112: aload_1
    //   113: ifnull +124 -> 237
    //   116: aload_1
    ...
    //   150: aload_0
    //   151: aload_1
    //   152: invokevirtual 180	com/tencent/open/base/http/HttpImageDownloadAsyncTask:a	(Ljava/io/InputStream;)[B
    //   155: astore_3
    //   156: aload_1
    //   157: astore_2
    //   158: aload_3
    ...
    //   160: aload_3
    //   161: arraylength
    //   162: invokestatic 186	com/tencent/image/SafeBitmapFactory:decodeByteArray	([BII)Landroid/graphics/Bitmap;
    //   165: astore_3
    //   166: aload_1
    //   167: astore_2
    //   168: aload_3
    ...
    //   173: ifnull -51 -> 122
    //   176: aload_2
    //   177: invokevirtual 159	java/io/InputStream:close	()V
    //   180: aload_1
    //   181: areturn
    //   182: astore_2
    //   183: aload_1
    ...
    //   192: astore_2
    //   193: aload_3
    //   194: invokevirtual 187	java/lang/OutOfMemoryError:printStackTrace	()V
    //   197: aload_1
    //   198: ifnull +39 -> 237
    //   201: aload_1
    //   202: invokevirtual 159	java/io/InputStream:close	()V
    //   205: aconst_null
    //   206: areturn
    //   207: astore_1
    //   208: aconst_null
    ...
    //   212: ifnull +7 -> 219
    //   215: aload_2
    //   216: invokevirtual 159	java/io/InputStream:close	()V
    //   219: aload_1
    //   220: athrow
    //   221: astore_2
    //   222: goto -3 -> 219
    ...
    //   0	246	0	this	HttpImageDownloadAsyncTask
    //   0	246	1	paramVarArgs	java.lang.Void[]
    //   1	176	2	arrayOfVoid1	java.lang.Void[]
    //   182	1	2	localIOException1	java.io.IOException
    //   192	24	2	arrayOfVoid2	java.lang.Void[]
