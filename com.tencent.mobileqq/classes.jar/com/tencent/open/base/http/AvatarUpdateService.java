  ...
  implements HttpImageDownloadAsyncTask.TaskCompleteCallback
{
  ...
  {
    QLog.d("AvatarUpdateService", 1, "-->updateAvatar--uin = " + AuthorityUtil.a(paramString1));
    ...
    str1 = "o" + str1;
    ThreadManager.post(new AvatarUpdateService.1(this, str2, "uin=" + str1 + "; skey=" + paramString2, paramString1, paramString3, paramContext, paramTaskCompleteCallback), 5, null, true);
  }
