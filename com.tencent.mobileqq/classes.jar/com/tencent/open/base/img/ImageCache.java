...
public class ImageCache
{
  ...
  static
  {
    ...
    try
    {
      File localFile = new File(Common.e() + b);
      if (localFile.exists()) {
        localFile.renameTo(new File(Common.e() + jdField_a_of_type_JavaLangString));
      }
  ...
  {
    return Common.e() + jdField_a_of_type_JavaLangString + paramString1 + File.separator + FileUtils.a(paramString2);
  }
