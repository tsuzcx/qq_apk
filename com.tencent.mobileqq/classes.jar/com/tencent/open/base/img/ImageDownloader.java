...
public class ImageDownloader
{
      ...
      try
      {
        ...
        if (APNUtil.a(CommonDataAdapter.a().a()))
        {
          ...
          if (j < 0)
          {
            ...
            localObject1 = "";
            LogUtility.c(jdField_a_of_type_JavaLangString, "https://" + (String)localObject3 + ":" + str + (String)localObject1);
  ...
  public static boolean a(ImageInfo paramImageInfo)
  {
    ...
    //   7: istore 4
    //   9: aload_0
    //   10: invokestatic 277	com/tencent/open/base/img/ImageDownloader:a	(Lcom/tencent/open/base/img/ImageInfo;)Ljava/net/HttpURLConnection;
    //   13: astore 7
    //   15: aload 7
    //   17: ifnonnull +88 -> 105
    ...
    //   43: ldc_w 281
    //   46: invokevirtual 124	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   49: invokevirtual 129	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   52: invokestatic 134	com/tencent/open/base/LogUtility:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   55: iconst_0
    //   56: ifeq +11 -> 67
    //   59: new 283	java/lang/NullPointerException
    //   62: dup
    //   63: invokespecial 284	java/lang/NullPointerException:<init>	()V
    //   66: athrow
    //   67: iconst_0
    //   68: ifeq +11 -> 79
    //   71: new 283	java/lang/NullPointerException
    //   74: dup
    //   75: invokespecial 284	java/lang/NullPointerException:<init>	()V
    //   78: athrow
    //   79: iload 4
    //   81: istore_3
    //   82: aload 7
    //   84: ifnull +11 -> 95
    //   87: aload 7
    //   89: invokevirtual 274	java/net/HttpURLConnection:disconnect	()V
    //   92: iload 4
    //   94: istore_3
    //   95: iload_3
    //   96: ireturn
    ...
    //   102: goto -23 -> 79
    //   105: aload 7
    //   107: invokevirtual 290	java/net/HttpURLConnection:getContentLength	()I
    //   110: i2l
    //   111: lstore 5
    //   113: invokestatic 294	com/tencent/open/appcommon/Common:a	()J
    //   116: lload 5
    //   118: lcmp
    //   119: ifge +85 -> 204
    ...
    //   151: invokevirtual 129	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   154: invokestatic 134	com/tencent/open/base/LogUtility:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   157: iconst_0
    //   158: ifeq +11 -> 169
    //   161: new 283	java/lang/NullPointerException
    //   164: dup
    //   165: invokespecial 284	java/lang/NullPointerException:<init>	()V
    //   168: athrow
    //   169: iconst_0
    //   170: ifeq +11 -> 181
    //   173: new 283	java/lang/NullPointerException
    //   176: dup
    //   177: invokespecial 284	java/lang/NullPointerException:<init>	()V
    //   180: athrow
    //   181: iload 4
    //   183: istore_3
    //   184: aload 7
    //   186: ifnull -91 -> 95
    //   189: aload 7
    //   191: invokevirtual 274	java/net/HttpURLConnection:disconnect	()V
    //   194: iconst_0
    //   195: ireturn
    //   196: astore_0
    //   197: aload_0
    //   198: invokevirtual 287	java/lang/Exception:printStackTrace	()V
    //   201: goto -20 -> 181
    //   204: aload 7
    //   206: invokevirtual 300	java/net/HttpURLConnection:getInputStream	()Ljava/io/InputStream;
    //   209: astore 8
    //   211: lconst_0
    //   212: lstore 5
    ...
    //   217: newarray byte
    //   219: astore 9
    //   221: new 302	java/io/ByteArrayOutputStream
    //   224: dup
    //   225: invokespecial 303	java/io/ByteArrayOutputStream:<init>	()V
    //   228: astore 13
    //   230: aload 8
    //   232: aload 9
    //   234: iconst_0
    //   235: getstatic 16	com/tencent/open/base/img/ImageDownloader:jdField_a_of_type_Int	I
    //   238: invokevirtual 309	java/io/InputStream:read	([BII)I
    //   241: istore_1
    //   242: iload_1
    //   243: ifle +79 -> 322
    ...
    //   258: iconst_0
    //   259: ifeq +11 -> 270
    //   262: new 283	java/lang/NullPointerException
    //   265: dup
    //   266: invokespecial 284	java/lang/NullPointerException:<init>	()V
    //   269: athrow
    //   270: aload 8
    //   272: ifnull +8 -> 280
    //   275: aload 8
    //   277: invokevirtual 312	java/io/InputStream:close	()V
    //   280: iload 4
    //   282: istore_3
    //   283: aload 7
    //   285: ifnull -190 -> 95
    //   288: aload 7
    //   290: invokevirtual 274	java/net/HttpURLConnection:disconnect	()V
    //   293: iconst_0
    //   294: ireturn
    //   295: astore_0
    //   296: aload_0
    //   297: invokevirtual 287	java/lang/Exception:printStackTrace	()V
    //   300: goto -20 -> 280
    //   303: aload 13
    //   305: aload 9
    //   307: iconst_0
    //   308: iload_1
    //   309: invokevirtual 316	java/io/ByteArrayOutputStream:write	([BII)V
    //   312: lload 5
    //   314: iload_1
    //   315: i2l
    //   316: ladd
    ...
    //   329: invokestatic 319	com/tencent/open/appcommon/Common:e	()Ljava/lang/String;
    //   332: invokevirtual 124	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   335: getstatic 322	com/tencent/open/base/img/ImageCache:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   338: invokevirtual 124	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   341: aload_0
    //   342: getfield 324	com/tencent/open/base/img/ImageInfo:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   345: invokevirtual 124	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   348: getstatic 329	java/io/File:separator	Ljava/lang/String;
    //   351: invokevirtual 124	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   354: aload_0
    //   355: getfield 75	com/tencent/open/base/img/ImageInfo:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   358: invokestatic 333	com/tencent/open/base/FileUtils:a	(Ljava/lang/String;)Ljava/lang/String;
    //   361: invokevirtual 124	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   364: invokevirtual 129	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   367: astore 14
    //   369: new 326	java/io/File
    //   372: dup
    ...
    //   394: invokespecial 336	java/io/File:<init>	(Ljava/lang/String;)V
    //   397: astore 10
    //   399: aload 10
    //   401: invokevirtual 339	java/io/File:getParent	()Ljava/lang/String;
    //   404: ifnull +23 -> 427
    //   407: aload 10
    //   409: invokevirtual 343	java/io/File:getParentFile	()Ljava/io/File;
    //   412: invokevirtual 347	java/io/File:exists	()Z
    //   415: ifne +12 -> 427
    //   418: aload 10
    //   420: invokevirtual 343	java/io/File:getParentFile	()Ljava/io/File;
    //   423: invokevirtual 350	java/io/File:mkdirs	()Z
    //   426: pop
    //   427: aload 10
    //   429: invokevirtual 347	java/io/File:exists	()Z
    //   432: ifeq +9 -> 441
    //   435: aload 10
    //   437: invokevirtual 353	java/io/File:delete	()Z
    //   440: pop
    //   441: aload 10
    //   443: invokevirtual 356	java/io/File:createNewFile	()Z
    //   446: pop
    //   447: new 358	java/io/FileOutputStream
    //   450: dup
    //   451: new 117	java/lang/StringBuilder
    //   454: dup
    //   455: invokespecial 118	java/lang/StringBuilder:<init>	()V
    //   458: aload 14
    //   460: invokevirtual 124	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   463: ldc_w 335
    //   466: invokevirtual 124	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   469: invokevirtual 129	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   472: invokespecial 359	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   475: astore 9
    //   477: aload 9
    //   479: aload 13
    //   481: invokevirtual 363	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   484: invokevirtual 366	java/io/FileOutputStream:write	([B)V
    //   487: aload 9
    //   489: invokevirtual 369	java/io/FileOutputStream:flush	()V
    //   492: new 326	java/io/File
    //   495: dup
    //   496: aload 14
    //   498: invokespecial 336	java/io/File:<init>	(Ljava/lang/String;)V
    //   501: astore 12
    //   503: aload 12
    //   505: invokevirtual 347	java/io/File:exists	()Z
    //   508: ifeq +9 -> 517
    //   511: aload 12
    //   513: invokevirtual 353	java/io/File:delete	()Z
    //   516: pop
    //   517: aload 10
    //   519: aload 12
    //   521: invokevirtual 373	java/io/File:renameTo	(Ljava/io/File;)Z
    //   524: pop
    //   525: ldc_w 375
    //   528: aload_0
    //   529: getfield 376	com/tencent/open/base/img/ImageInfo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   532: invokestatic 134	com/tencent/open/base/LogUtility:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   535: aload_0
    //   536: aload 7
    //   538: invokevirtual 379	java/net/HttpURLConnection:getLastModified	()J
    //   541: putfield 172	com/tencent/open/base/img/ImageInfo:jdField_c_of_type_Long	J
    //   544: iconst_1
    //   545: istore_3
    //   546: aload 9
    //   548: ifnull +8 -> 556
    //   551: aload 9
    //   553: invokevirtual 380	java/io/FileOutputStream:close	()V
    //   556: aload 8
    //   558: ifnull +8 -> 566
    //   561: aload 8
    //   563: invokevirtual 312	java/io/InputStream:close	()V
    //   566: aload 7
    //   568: ifnull -473 -> 95
    //   571: aload 7
    //   573: invokevirtual 274	java/net/HttpURLConnection:disconnect	()V
    //   576: iconst_1
    //   577: ireturn
    //   578: astore_0
    //   579: aload_0
    //   580: invokevirtual 287	java/lang/Exception:printStackTrace	()V
    //   583: goto -17 -> 566
    //   586: astore 9
    //   588: aconst_null
    //   589: astore 10
    ...
    //   602: ldc_w 382
    //   605: aload 9
    //   607: invokestatic 271	com/tencent/open/base/LogUtility:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   610: aload 10
    //   612: ifnull +17 -> 629
    //   615: aload 10
    //   617: invokevirtual 347	java/io/File:exists	()Z
    //   620: ifeq +9 -> 629
    //   623: aload 10
    //   625: invokevirtual 353	java/io/File:delete	()Z
    //   628: pop
    //   629: aload 11
    //   631: ifnull +17 -> 648
    //   634: aload 11
    //   636: invokevirtual 347	java/io/File:exists	()Z
    //   639: ifeq +9 -> 648
    //   642: aload 11
    //   644: invokevirtual 353	java/io/File:delete	()Z
    //   647: pop
    //   648: aload_0
    //   649: ifnull +7 -> 656
    //   652: aload_0
    //   653: invokevirtual 380	java/io/FileOutputStream:close	()V
    //   656: aload 7
    //   658: ifnull +8 -> 666
    //   661: aload 7
    //   663: invokevirtual 312	java/io/InputStream:close	()V
    //   666: iload 4
    //   668: istore_3
    //   669: aload 8
    //   671: ifnull -576 -> 95
    //   674: aload 8
    //   676: invokevirtual 274	java/net/HttpURLConnection:disconnect	()V
    //   679: iconst_0
    //   680: ireturn
    //   681: astore_0
    //   682: aload_0
    //   683: invokevirtual 287	java/lang/Exception:printStackTrace	()V
    //   686: goto -20 -> 666
    //   689: astore_0
    //   690: aconst_null
    //   691: astore 8
    ...
    //   702: ifnull +8 -> 710
    //   705: aload 9
    //   707: invokevirtual 380	java/io/FileOutputStream:close	()V
    //   710: aload 8
    //   712: ifnull +8 -> 720
    //   715: aload 8
    //   717: invokevirtual 312	java/io/InputStream:close	()V
    //   720: aload 7
    //   722: ifnull +8 -> 730
    //   725: aload 7
    //   727: invokevirtual 274	java/net/HttpURLConnection:disconnect	()V
    //   730: aload_0
    //   731: athrow
    //   732: astore 8
    //   734: aload 8
    //   736: invokevirtual 287	java/lang/Exception:printStackTrace	()V
    //   739: goto -19 -> 720
    //   742: astore_0
    //   743: aconst_null
    //   744: astore 8
