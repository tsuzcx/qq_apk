...
public class ImageDownloader
{
  ...
  public static boolean a(ImageInfo paramImageInfo)
  {
    ...
    //   85: ifnull +12 -> 97
    //   88: aload 7
    //   90: invokevirtual 272	java/net/HttpURLConnection:disconnect	()V
    //   93: iload 6
    //   95: istore 5
    //   97: iload 5
    //   99: ireturn
    //   100: astore_0
    //   101: aload_0
    //   102: invokevirtual 285	java/lang/Exception:printStackTrace	()V
    //   105: goto -26 -> 79
    //   108: aload 7
    //   110: invokevirtual 288	java/net/HttpURLConnection:getContentLength	()I
    //   113: i2l
    //   114: lstore_3
    //   115: invokestatic 292	com/tencent/open/appcommon/Common:a	()J
    //   118: lload_3
    //   119: lcmp
    //   120: ifge +86 -> 206
    //   123: getstatic 14	com/tencent/open/base/img/ImageDownloader:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   126: new 117	java/lang/StringBuilder
    //   129: dup
    //   130: invokespecial 118	java/lang/StringBuilder:<init>	()V
    //   133: ldc_w 277
    //   136: invokevirtual 122	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   139: aload_0
    //   140: getfield 75	com/tencent/open/base/img/ImageInfo:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   143: invokevirtual 122	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   146: ldc_w 294
    //   149: invokevirtual 122	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   152: invokevirtual 127	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   155: invokestatic 132	com/tencent/open/base/LogUtility:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   158: iconst_0
    //   159: ifeq +11 -> 170
    //   162: new 281	java/lang/NullPointerException
    //   165: dup
    //   166: invokespecial 282	java/lang/NullPointerException:<init>	()V
    //   169: athrow
    //   170: iconst_0
    //   171: ifeq +11 -> 182
    //   174: new 281	java/lang/NullPointerException
    //   177: dup
    //   178: invokespecial 282	java/lang/NullPointerException:<init>	()V
    //   181: athrow
    //   182: iload 6
    //   184: istore 5
    //   186: aload 7
    //   188: ifnull -91 -> 97
    //   191: aload 7
    //   193: invokevirtual 272	java/net/HttpURLConnection:disconnect	()V
    //   196: iconst_0
    //   197: ireturn
    //   198: astore_0
    //   199: aload_0
    //   200: invokevirtual 285	java/lang/Exception:printStackTrace	()V
    //   203: goto -21 -> 182
    //   206: aload 7
    //   208: invokevirtual 298	java/net/HttpURLConnection:getInputStream	()Ljava/io/InputStream;
    //   211: astore 8
    //   213: lconst_0
    //   214: lstore_3
    //   215: getstatic 16	com/tencent/open/base/img/ImageDownloader:jdField_a_of_type_Int	I
    //   218: newarray byte
    //   220: astore 9
    //   222: new 300	java/io/ByteArrayOutputStream
    //   225: dup
    //   226: invokespecial 301	java/io/ByteArrayOutputStream:<init>	()V
    //   229: astore 13
    //   231: aload 8
    //   233: aload 9
    //   235: iconst_0
    ...
    //   286: ifnull -189 -> 97
    //   289: aload 7
    //   291: invokevirtual 272	java/net/HttpURLConnection:disconnect	()V
    //   294: iconst_0
    //   295: ireturn
    //   296: astore_0
    //   297: aload_0
    //   298: invokevirtual 285	java/lang/Exception:printStackTrace	()V
    //   301: goto -21 -> 280
    //   304: aload 13
    //   306: aload 9
    //   308: iconst_0
    ...
    //   324: dup
    //   325: invokespecial 118	java/lang/StringBuilder:<init>	()V
    //   328: invokestatic 316	com/tencent/open/appcommon/Common:d	()Ljava/lang/String;
    //   331: invokevirtual 122	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    //   340: aload_0
    //   341: getfield 321	com/tencent/open/base/img/ImageInfo:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   344: invokevirtual 122	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   347: getstatic 326	java/io/File:separator	Ljava/lang/String;
    //   350: invokevirtual 122	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   353: aload_0
    //   354: getfield 75	com/tencent/open/base/img/ImageInfo:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   357: invokestatic 330	com/tencent/open/base/FileUtils:a	(Ljava/lang/String;)Ljava/lang/String;
    //   360: invokevirtual 122	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    //   379: aload 14
    //   381: invokevirtual 122	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   384: ldc_w 332
    //   387: invokevirtual 122	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   390: invokevirtual 127	java/lang/StringBuilder:toString	()Ljava/lang/String;
    ...
    //   449: dup
    //   450: new 117	java/lang/StringBuilder
    //   453: dup
    //   454: invokespecial 118	java/lang/StringBuilder:<init>	()V
    //   457: aload 14
    //   459: invokevirtual 122	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   462: ldc_w 332
    //   465: invokevirtual 122	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   468: invokevirtual 127	java/lang/StringBuilder:toString	()Ljava/lang/String;
    ...
    //   524: ldc_w 372
    //   527: aload_0
    //   528: getfield 373	com/tencent/open/base/img/ImageInfo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   531: invokestatic 132	com/tencent/open/base/LogUtility:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   534: aload_0
    //   535: aload 7
    //   537: invokevirtual 376	java/net/HttpURLConnection:getLastModified	()J
    //   540: putfield 170	com/tencent/open/base/img/ImageInfo:jdField_c_of_type_Long	J
    //   543: iconst_1
    //   544: istore 5
    //   546: aload 9
    //   548: ifnull +8 -> 556
    ...
    //   672: ifnull -575 -> 97
    //   675: aload 8
    //   677: invokevirtual 272	java/net/HttpURLConnection:disconnect	()V
    //   680: iconst_0
    //   681: ireturn
    //   682: astore_0
    //   683: aload_0
    //   684: invokevirtual 285	java/lang/Exception:printStackTrace	()V
    //   687: goto -21 -> 666
    //   690: astore_0
    //   691: aconst_null
    //   692: astore 8
    ...
    //   713: ifnull +8 -> 721
    //   716: aload 8
    //   718: invokevirtual 310	java/io/InputStream:close	()V
    //   721: aload 7
    //   723: ifnull +8 -> 731
    //   726: aload 7
    //   728: invokevirtual 272	java/net/HttpURLConnection:disconnect	()V
    //   731: aload_0
    //   732: athrow
    //   733: astore 8
    //   735: aload 8
    //   737: invokevirtual 285	java/lang/Exception:printStackTrace	()V
    //   740: goto -19 -> 721
    //   743: astore_0
    //   744: aconst_null
    //   745: astore 8
