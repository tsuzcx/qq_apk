...
public class BitmapUtil
{
  ...
  public static Bitmap a(java.lang.String paramString, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    //   16: aload_0
    //   17: ifnull +21 -> 38
    //   20: new 35	java/io/File
    //   23: dup
    //   24: aload_0
    //   25: invokespecial 38	java/io/File:<init>	(Ljava/lang/String;)V
    //   28: invokevirtual 42	java/io/File:exists	()Z
    //   31: ifne +10 -> 41
    //   34: aload 9
    //   36: astore 4
    //   38: aload 4
    //   40: areturn
    //   41: invokestatic 45	com/tencent/open/base/BitmapUtil:a	()Landroid/graphics/BitmapFactory$Options;
    //   44: astore 11
    //   46: new 47	java/io/BufferedInputStream
    //   49: dup
    //   50: new 49	java/io/FileInputStream
    //   53: dup
    //   54: aload_0
    //   55: invokespecial 50	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   58: sipush 8192
    //   61: invokespecial 53	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;I)V
    //   64: astore 5
    //   66: aload 5
    //   68: astore_0
    //   69: aload 5
    //   71: aconst_null
    //   72: aload 11
    //   74: invokestatic 59	android/graphics/BitmapFactory:decodeStream	(Ljava/io/InputStream;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   77: pop
    //   78: aload 10
    //   80: astore 6
    //   82: aload 5
    //   84: astore_0
    //   85: aload 11
    //   87: getfield 20	android/graphics/BitmapFactory$Options:outHeight	I
    //   90: ifle +143 -> 233
    //   93: aload 10
    //   95: astore 6
    //   97: aload 5
    //   99: astore_0
    //   100: aload 11
    //   102: getfield 17	android/graphics/BitmapFactory$Options:outWidth	I
    //   105: ifle +128 -> 233
    //   108: aload 5
    //   110: astore_0
    //   111: aload 11
    ...
    //   114: iload_2
    //   115: iload_3
    //   116: invokestatic 62	com/tencent/open/base/BitmapUtil:a	(Landroid/graphics/BitmapFactory$Options;IIZ)Landroid/graphics/BitmapFactory$Options;
    //   119: pop
    //   120: aload 5
    //   122: astore_0
    //   123: aload 5
    //   125: aconst_null
    //   126: aload 11
    //   128: invokestatic 59	android/graphics/BitmapFactory:decodeStream	(Ljava/io/InputStream;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   131: astore 4
    //   133: aload 4
    ...
    //   144: ifnull -106 -> 38
    //   147: aload 5
    //   149: invokevirtual 65	java/io/BufferedInputStream:close	()V
    //   152: aconst_null
    //   153: areturn
    //   154: astore_0
    //   155: aconst_null
    ...
    //   161: aload 11
    //   163: aload 11
    //   165: getfield 68	android/graphics/BitmapFactory$Options:inSampleSize	I
    //   168: iconst_1
    //   169: isub
    //   170: putfield 68	android/graphics/BitmapFactory$Options:inSampleSize	I
    //   173: aload 5
    //   175: astore_0
    //   176: aload 5
    //   178: aconst_null
    //   179: aload 11
    //   181: invokestatic 59	android/graphics/BitmapFactory:decodeStream	(Ljava/io/InputStream;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   184: astore 4
    //   186: goto -53 -> 133
    //   189: aload 5
    //   191: astore_0
    //   192: aload 4
    //   194: invokevirtual 71	android/graphics/Bitmap:hasAlpha	()Z
    //   197: ifeq +57 -> 254
    //   200: aload 5
    //   202: astore_0
    //   203: getstatic 77	android/graphics/Bitmap$Config:ARGB_8888	Landroid/graphics/Bitmap$Config;
    //   206: astore 6
    //   208: aload 5
    //   210: astore_0
    //   211: aload 11
    //   213: aload 6
    //   215: putfield 80	android/graphics/BitmapFactory$Options:inPreferredConfig	Landroid/graphics/Bitmap$Config;
    //   218: aload 5
    //   220: astore_0
    //   221: aload 4
    //   223: iload_1
    ...
    //   225: aload 11
    //   227: iload_3
    //   228: invokestatic 82	com/tencent/open/base/BitmapUtil:a	(Landroid/graphics/Bitmap;IILandroid/graphics/BitmapFactory$Options;Z)Landroid/graphics/Bitmap;
    //   231: astore 6
    //   233: aload 6
    //   235: astore 4
    //   237: aload 5
    //   239: ifnull -201 -> 38
    //   242: aload 5
    //   244: invokevirtual 65	java/io/BufferedInputStream:close	()V
    //   247: aload 6
    //   249: areturn
    //   250: astore_0
    //   251: aload 6
    ...
    //   254: aload 5
    //   256: astore_0
    //   257: getstatic 85	android/graphics/Bitmap$Config:RGB_565	Landroid/graphics/Bitmap$Config;
    //   260: astore 6
    //   262: goto -54 -> 208
    //   265: astore 4
    //   267: aconst_null
    ...
    //   274: aload 5
    //   276: astore_0
    //   277: invokestatic 90	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   280: ifeq +17 -> 297
    //   283: aload 5
    //   285: astore_0
    //   286: ldc 92
    //   288: iconst_2
    //   289: aload 4
    //   291: invokestatic 96	com/tencent/qphone/base/util/QLog:getStackTraceString	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   294: invokestatic 100	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   297: aload 6
    //   299: astore 4
    //   301: aload 5
    //   303: ifnull -265 -> 38
    //   306: aload 5
    //   308: invokevirtual 65	java/io/BufferedInputStream:close	()V
    //   311: aload 6
    //   313: areturn
    //   314: astore_0
    //   315: aload 6
    ...
    //   327: aload 5
    //   329: astore_0
    //   330: invokestatic 90	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   333: ifeq +17 -> 350
    //   336: aload 5
    //   338: astore_0
    //   339: ldc 92
    //   341: iconst_2
    //   342: aload 4
    //   344: invokestatic 96	com/tencent/qphone/base/util/QLog:getStackTraceString	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   347: invokestatic 100	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   350: aload 6
    //   352: astore 4
    //   354: aload 5
    //   356: ifnull -318 -> 38
    //   359: aload 5
    //   361: invokevirtual 65	java/io/BufferedInputStream:close	()V
    //   364: aload 6
    //   366: areturn
    //   367: astore_0
    //   368: aload 6
    ...
    //   376: ifnull +7 -> 383
    //   379: aload_0
    //   380: invokevirtual 65	java/io/BufferedInputStream:close	()V
    //   383: aload 4
    //   385: athrow
    //   386: astore_0
    //   387: goto -4 -> 383
