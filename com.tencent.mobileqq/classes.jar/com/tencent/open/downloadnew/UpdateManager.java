  ...
  implements ApkUpdateListener
{
  ...
  public void a(DownloadInfo paramDownloadInfo)
  {
    ...
    String str3 = paramDownloadInfo.jdField_k_of_type_JavaLangString;
    ...
    for (String str1 = Environment.getExternalStorageDirectory().getAbsolutePath() + DownloadManager.b + "newApkDir";; str1 = CommonDataAdapter.a().a().getFilesDir().getAbsolutePath())
    {
      ...
      paramDownloadInfo.jdField_k_of_type_JavaLangString = str1;
      if (("com.tencent.mobileqq".equals(paramDownloadInfo.d)) && (ConfigHandler.b((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()))) {
        paramDownloadInfo.a = false;
      }
      if ((!"com.tencent.mobileqq".equals(paramDownloadInfo.d)) || (!DownloadManager.a().b())) {
        break label400;
      }
      paramDownloadInfo.jdField_k_of_type_Int = DownloadManager.a().a(paramDownloadInfo);
      ...
      DownloadManager.a().a(paramDownloadInfo, paramDownloadInfo.jdField_k_of_type_Int, null);
      return;
    }
    paramDownloadInfo.a(4);
    DownloadManager.a().e(paramDownloadInfo);
    LogUtility.c(jdField_a_of_type_JavaLangString, "info.path = " + paramDownloadInfo.jdField_k_of_type_JavaLangString);
    ...
    ThreadManager.getSubThreadHandler().post(new alqr(this, str1, paramDownloadInfo));
    return;
    label400:
    ThreadManager.getSubThreadHandler().post(new alqs(this, str1, paramDownloadInfo));
    return;
    label418:
