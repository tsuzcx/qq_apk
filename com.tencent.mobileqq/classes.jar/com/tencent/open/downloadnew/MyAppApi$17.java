...
public class MyAppApi$17
  implements Runnable
{
  public MyAppApi$17(bdlc parambdlc, Activity paramActivity, String paramString) {}
  
  public void run()
  {
    bdht.c("MyAppApi", "---isAutoInstall:" + bdkh.c() + " url:" + bdkh.a() + " interval:" + bdkh.a());
    if ((bdho.b(this.jdField_a_of_type_AndroidAppActivity)) && (bdho.c(this.jdField_a_of_type_AndroidAppActivity)))
    {
      boolean bool1 = bdkh.b();
      boolean bool2 = bdkh.j();
      String str = bbjn.j(this.jdField_a_of_type_AndroidAppActivity, "wifiAutoPreDown");
