...
public class DownloadManager$18
  implements Runnable
{
  public DownloadManager$18(bdkp parambdkp) {}
  ...
  public void run()
  {
    ...
    try
    {
      if (!bcxm.a().a().getSharedPreferences("opensdk_config", 0).getBoolean("download_clear_unuse", false))
      {
    ...
    {
      bdht.c("DownloadManager_", "checkDownloadList>>>", localException);
    }
    label134:
    label173:
    do
    ...
    Object localObject = bcxm.a().a().getSharedPreferences("opensdk_config", 0).edit();
