...
public class DownloadManager$18
  implements Runnable
{
  public DownloadManager$18(bcgo parambcgo) {}
  ...
  public void run()
  {
    ...
    try
    {
      if (!bbtm.a().a().getSharedPreferences("opensdk_config", 0).getBoolean("download_clear_unuse", false))
      {
    ...
    {
      bcds.c("DownloadManager_", "checkDownloadList>>>", localException);
    }
    label134:
    label173:
    do
    ...
    Object localObject = bbtm.a().a().getSharedPreferences("opensdk_config", 0).edit();
