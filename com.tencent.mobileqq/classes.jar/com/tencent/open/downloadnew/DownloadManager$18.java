...
public class DownloadManager$18
  implements Runnable
{
  public DownloadManager$18(bdle parambdle) {}
  ...
  public void run()
  {
    ...
    try
    {
      if (!bcyb.a().a().getSharedPreferences("opensdk_config", 0).getBoolean("download_clear_unuse", false))
      {
    ...
    {
      bdii.c("DownloadManager_", "checkDownloadList>>>", localException);
    }
    label134:
    label173:
    do
    ...
    Object localObject = bcyb.a().a().getSharedPreferences("opensdk_config", 0).edit();
