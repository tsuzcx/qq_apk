  ...
  implements Runnable
{
  ...
  public void run()
  {
    LogUtility.b("DownloadManager_", "OnDownloadStateChanged,clientKey:" + this.jdField_a_of_type_ComTencentTmdownloaderTMAssistantDownloadClient + ",state:" + this.jdField_a_of_type_Int + ",url:" + this.jdField_a_of_type_JavaLangString);
    int i = DownloadManager.a(this.jdField_a_of_type_Int);
    LogUtility.a("DownloadManager_", "onStateChanged url: +++++loacalState=" + i + " +++++downloadInfo=" + this.jdField_a_of_type_ComTencentOpenDownloadnewDownloadManager$5.a.c(this.jdField_a_of_type_JavaLangString));
    ...
    for (;;)
    {
      try
      {
        ...
        LogUtility.a("DownloadManager_", "OnDownloadSDKTaskStateChanged info progress = " + j);
        switch (i)
        {
        default: 
          return;
        case -2: 
          this.jdField_a_of_type_ComTencentOpenDownloadnewDownloadManager$5.a.a(localDownloadInfo, l1, l2, this.jdField_b_of_type_Int);
      ...
      this.jdField_a_of_type_ComTencentOpenDownloadnewDownloadManager$5.a.a(localDownloadInfo, l1, l1 - localDownloadInfo.b, "pause");
      this.jdField_a_of_type_ComTencentOpenDownloadnewDownloadManager$5.a.a(3, localDownloadInfo);
      return;
      this.jdField_a_of_type_ComTencentOpenDownloadnewDownloadManager$5.a.a(localDownloadInfo, 0L, l2 - localDownloadInfo.b, "complete");
