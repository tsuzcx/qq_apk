...
public class DownloadManager$11
  implements Runnable
{
  public DownloadManager$11(bfok parambfok, String paramString, Map paramMap, int paramInt, DownloadInfo paramDownloadInfo1, DownloadInfo paramDownloadInfo2, DownloadInfo paramDownloadInfo3) {}
  
  public void run()
  {
    if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
      bflp.a("DownloadManager_", "startDownload download file, url = " + this.jdField_a_of_type_JavaLangString + "params = " + this.jdField_a_of_type_JavaUtilMap);
    }
    for (;;)
    {
      try
      {
        if (this.jdField_a_of_type_Int == 0)
        {
          ...
          bflp.a("DownloadManager_", "startDownloadTask downloadSDKClient result=" + i + " url=" + this.jdField_a_of_type_JavaLangString);
          if (i == 0) {
            break label282;
          }
          this.this$0.a(this.jdField_a_of_type_ComTencentOpenDownloadnewDownloadInfo, i, "");
          bfkq.a(1, this.jdField_a_of_type_JavaLangString, i, this.c);
          return;
        }
        ...
        bflp.a("DownloadManager_", "startDownload download unapk file, url = " + this.jdField_a_of_type_JavaLangString + ",filename = " + this.jdField_a_of_type_ComTencentOpenDownloadnewDownloadInfo.jdField_e_of_type_JavaLangString);
