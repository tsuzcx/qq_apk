...
public class MyAppApi$18
  implements Runnable
{
  public MyAppApi$18(bjnn parambjnn, Activity paramActivity) {}
  ...
  public void run()
  {
    ...
    if ((bjkj.b(this.a)) && (bjkj.c(this.a)))
    {
      bool4 = arqj.a("com.tencent.android.qqdownloader", BaseActivity.sTopActivity);
      bool5 = bjmt.b();
      localUpgradeDetailWrapper = bgvx.a().a();
    ...
    {
      boolean bool3 = bhhj.a();
      boolean bool2 = bool3;
      int j;
      if (bool3)
      {
        j = bhhj.a();
        if ((localUpgradeDetailWrapper == null) || (localUpgradeDetailWrapper.jdField_a_of_type_Bgwc == null)) {
          break label382;
        }
      }
      label382:
      for (int i = localUpgradeDetailWrapper.jdField_a_of_type_Bgwc.jdField_a_of_type_Int;; i = 0)
      {
        bool2 = bool3;
        if (i != j)
        {
        ...
        bjko.c("NewUpgradeDialog", "predownload flags:isInstalled=" + bool4 + " needDownloadYYB = " + bool5 + " allowPreDownload=" + bool1 + " hasPreDownloadSucc=" + bool2);
        if ((!bool4) && (!this.this$0.b()) && (bool5) && (bool1) && (!bool2))
        {
          bjko.c("NewUpgradeDialog", "---start pre Download YYB---");
          ...
          bjnn.b(this.this$0, true);
          this.this$0.a(this.a, "ANDROIDQQ.NEWYYB.QQUPDATE", 1);
          return;
        }
        bjko.c("NewUpgradeDialog", "don't need preDownload return");
        return;
      }
    }
  }
