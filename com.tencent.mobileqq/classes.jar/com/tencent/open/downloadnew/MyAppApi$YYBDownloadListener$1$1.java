  ...
  implements Runnable
{
  ...
  public void run()
  {
    if (bbtm.a().a() != null)
    {
      ...
      ((WindowManager)bbtm.a().a().getSystemService("window")).getDefaultDisplay().getMetrics((DisplayMetrics)localObject1);
      int i = ((DisplayMetrics)localObject1).widthPixels;
      float f = ((DisplayMetrics)localObject1).density;
      Object localObject2 = new RelativeLayout.LayoutParams(-2, -2);
      localObject1 = new RelativeLayout(bbtm.a().a());
      ...
      localObject2 = new TextView(bbtm.a().a());
      ((TextView)localObject2).setWidth((int)(i * 0.9D));
      ((TextView)localObject2).setHeight((int)(96.0F * f + 0.5F));
      ((TextView)localObject2).setBackgroundColor(bbtm.a().a().getResources().getColor(2131101491));
      ((TextView)localObject2).setText(2131654438);
      ((TextView)localObject2).setTextColor(bbtm.a().a().getResources().getColor(2131099738));
      ((TextView)localObject2).setSingleLine();
      ((TextView)localObject2).setGravity(17);
      ((RelativeLayout)localObject1).addView((View)localObject2);
      bcec.a().a((View)localObject1, 1);
      bcds.c("MyAppApi", ajjy.a(2131641260) + System.currentTimeMillis());
    }
  }
}
