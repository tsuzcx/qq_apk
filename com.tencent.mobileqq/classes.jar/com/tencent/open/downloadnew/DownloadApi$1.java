  ...
  implements Runnable
{
  ...
  {
    boolean bool2 = true;
    String str1 = bcgh.jdField_a_of_type_JavaLangString;
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      bcds.e(bcgh.jdField_a_of_type_JavaLangString, "doDownloadAction pParams == null return");
      return;
    }
    bcgo.a().a();
    ...
    String str2 = this.jdField_a_of_type_AndroidOsBundle.getString(bcgl.B);
    str1 = this.jdField_a_of_type_AndroidOsBundle.getString(bcgl.i);
    if ((TextUtils.isEmpty(str2)) || (str2.equals("0"))) {
      this.jdField_a_of_type_AndroidOsBundle.putString(bcgl.B, "");
    }
    localObject = bcgo.a().a((String)localObject);
    if ((localObject == null) && ("biz_src_yyb".equals(this.jdField_a_of_type_JavaLangString)) && (bcgg.e()))
    {
      ...
      if ((i == 5) && (str1.equals("com.tencent.android.qqdownloader"))) {
        bcgh.a(this.jdField_a_of_type_AndroidOsBundle);
      }
    }
    ...
    if (bcgh.a(this.jdField_a_of_type_AndroidOsBundle))
    {
      bcds.a(bcgh.jdField_a_of_type_JavaLangString, "doDownloadAction installApp");
      return;
    }
    if ((this.jdField_a_of_type_ComTencentApkupdateLogicDataApkUpdateDetail != null) && (this.jdField_a_of_type_ComTencentApkupdateLogicDataApkUpdateDetail.updatemethod == 2) && (TextUtils.isEmpty(this.jdField_a_of_type_AndroidOsBundle.getString(bcgl.j))) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentApkupdateLogicDataApkUpdateDetail.url))) {
    ...
    if (this.jdField_a_of_type_Int == 0)
    {
      ...
      {
        bcgh.b(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidOsBundle, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentApkupdateLogicDataApkUpdateDetail, this.jdField_a_of_type_Int);
        return;
      }
      ...
      for (;;)
      {
        bcds.a(bcgh.jdField_a_of_type_JavaLangString, "check wifi dialog isWifiActive=" + bool4 + " isFirstDownload=" + bool1 + " acIsNull=" + bool2);
        if ((!bool3) || (bool2) || (bool4) || (!bool1) || (!this.jdField_a_of_type_AndroidOsBundle.getBoolean(bcgl.r))) {
          break label583;
        }
        bcgo.a().a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidOsBundle, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentApkupdateLogicDataApkUpdateDetail, this.jdField_a_of_type_Int);
        return;
        bool1 = false;
        break;
        label578:
