  ...
  extends BroadcastReceiver
{
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if (paramIntent != null)
    {
      ...
      if ((!TextUtils.isEmpty(str3)) && (str3.equalsIgnoreCase(bhwr.r()))) {
        break label32;
      }
    }
    label32:
    ...
    do
    {
      ...
      str2 = str3.replace(":", ".");
      if ((bido.e + "." + str2).equals(str1))
      {
        biam.a(paramContext, paramIntent.d);
        return;
      }
      bhzm.b("vivi", "processName :" + str3 + " | formatStr:" + str2);
      str3 = paramIntent.a;
      str4 = paramIntent.d;
    ...
    if (!TextUtils.isEmpty(str3)) {
      bhyn.a.put(str3, localStringBuilder.toString());
    }
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(paramIntent.e)) {
        bhyn.a.put(paramIntent.e, localStringBuilder.toString());
      }
    }
  }
}
