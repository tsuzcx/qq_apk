...
public class AppNotificationManager
{
  ...
  public Notification a(NoticeParam paramNoticeParam)
  {
    ...
    RemoteViews localRemoteViews = new RemoteViews(CommonDataAdapter.a().a().getPackageName(), 2130969244);
    Object localObject = IntentFactory.a(1, paramNoticeParam);
    a(localRemoteViews);
    localRemoteViews.setTextViewText(2131365686, StringAddition.a(paramNoticeParam.jdField_b_of_type_JavaLangString, 18, true, true));
    if (paramNoticeParam.jdField_b_of_type_Int == 1)
    {
      localNotification.icon = 2130841632;
      localRemoteViews.setImageViewResource(2131365684, 2130841628);
      localRemoteViews.setViewVisibility(2131365688, 8);
      localRemoteViews.setViewVisibility(2131365689, 0);
      if (Build.VERSION.SDK_INT > 10) {
        localRemoteViews.setOnClickPendingIntent(2131365683, (PendingIntent)localObject);
      }
    }
    for (;;)
    {
      ...
      if ((paramNoticeParam.jdField_b_of_type_Int == 0) || (paramNoticeParam.jdField_b_of_type_Int == 2) || (paramNoticeParam.jdField_b_of_type_Int == 3))
      {
        ...
        {
          localRemoteViews.setTextViewText(2131365688, CommonDataAdapter.a().a().getString(2131428558));
        ...
        {
          localRemoteViews.setTextViewText(2131365688, CommonDataAdapter.a().a().getString(2131428555));
          localObject = AppUtil.a(paramNoticeParam.d);
          if (localObject != null) {
            localRemoteViews.setImageViewBitmap(2131365684, (Bitmap)localObject);
          }
          localNotification.flags |= 0x10;
          localNotification.defaults |= 0x1;
          localNotification.defaults |= 0x4;
        ...
        if (paramNoticeParam.jdField_b_of_type_Int == 3)
        {
          ...
          localRemoteViews.setImageViewBitmap(2131365684, localBitmap);
        }
        for (;;)
        {
          if (paramNoticeParam.jdField_b_of_type_Int == 0)
      ...
      else if (paramNoticeParam.jdField_b_of_type_Int == 4)
      {
        localNotification.icon = 2130841632;
        localRemoteViews.setImageViewResource(2131365684, 2130841628);
        localRemoteViews.setTextViewText(2131365688, CommonDataAdapter.a().a().getString(2131428565));
        localRemoteViews.setViewVisibility(2131365688, 0);
        localRemoteViews.setViewVisibility(2131365689, 8);
      ...
      {
        localNotification.icon = 2130839785;
        localRemoteViews.setImageViewResource(2131365684, 2130839786);
        localRemoteViews.setTextViewText(2131365688, paramNoticeParam.c);
        localNotification.contentIntent = ((PendingIntent)localObject);
      }
    }
  }
  ...
  public void a(RemoteViews paramRemoteViews)
  {
    ...
    if (this.jdField_a_of_type_ComTencentOpenDownloadnewCommonAppNotificationManager$NotificationStyleDiscover.b() != null) {
      paramRemoteViews.setTextColor(2131365686, this.jdField_a_of_type_ComTencentOpenDownloadnewCommonAppNotificationManager$NotificationStyleDiscover.b().intValue());
    }
    ...
    if (this.jdField_a_of_type_ComTencentOpenDownloadnewCommonAppNotificationManager$NotificationStyleDiscover.a() != null) {
      paramRemoteViews.setTextColor(2131365688, this.jdField_a_of_type_ComTencentOpenDownloadnewCommonAppNotificationManager$NotificationStyleDiscover.a().intValue());
    }
    if (this.jdField_a_of_type_ComTencentOpenDownloadnewCommonAppNotificationManager$NotificationStyleDiscover.a() != null) {
      paramRemoteViews.setTextColor(2131365687, this.jdField_a_of_type_ComTencentOpenDownloadnewCommonAppNotificationManager$NotificationStyleDiscover.a().intValue());
    }
    ...
    if (this.jdField_a_of_type_ComTencentOpenDownloadnewCommonAppNotificationManager$NotificationStyleDiscover.a() > 0.0F) {
      paramRemoteViews.setFloat(2131365688, "setTextSize", this.jdField_a_of_type_ComTencentOpenDownloadnewCommonAppNotificationManager$NotificationStyleDiscover.a());
    }
    if (this.jdField_a_of_type_ComTencentOpenDownloadnewCommonAppNotificationManager$NotificationStyleDiscover.a() > 0.0F) {
      paramRemoteViews.setFloat(2131365687, "setTextSize", this.jdField_a_of_type_ComTencentOpenDownloadnewCommonAppNotificationManager$NotificationStyleDiscover.a());
    }
    if (this.jdField_a_of_type_ComTencentOpenDownloadnewCommonAppNotificationManager$NotificationStyleDiscover.b() > 0.0F) {
      paramRemoteViews.setFloat(2131365686, "setTextSize", this.jdField_a_of_type_ComTencentOpenDownloadnewCommonAppNotificationManager$NotificationStyleDiscover.b());
    }
    ...
    try
    {
      ...
      paramRemoteViews.setInt(2131365683, "setBackgroundColor", (i & 0xFF000000) + (-1 - i));
      return;
    }
