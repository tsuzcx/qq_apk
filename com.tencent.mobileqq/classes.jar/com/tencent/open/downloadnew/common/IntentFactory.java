...
public class IntentFactory
{
  ...
  public static PendingIntent a(int paramInt, NoticeParam paramNoticeParam)
  {
    ...
    if (paramNoticeParam != null)
    {
      ...
      localIntent.putExtra("param_notifyid", AppNotificationManager.a().a(paramNoticeParam.h, paramNoticeParam.g, paramNoticeParam.a));
    }
    paramNoticeParam = Common.x();
    ...
    return PendingIntent.getBroadcast(CommonDataAdapter.a().b(), (int)(System.currentTimeMillis() & 0xFFFFFFF), localIntent, 134217728);
  }
  ...
  public static Intent a(Bundle paramBundle)
  {
    ...
    localIntent.putExtra("uinRestore", CommonDataAdapter.a().c());
    ...
    ((StringBuilder)localObject1).append(b(paramBundle));
  ...
  public static Intent a(String paramString1, String paramString2, int paramInt)
  {
    ...
    {
      Object localObject1 = Common.b(paramString1);
      ...
      String str7 = AppClient.b((String)localObject1);
      ...
      int i = AppUtil.d(str2);
      int j = AppUtil.e(DownloadManager.b().b(paramString1));
  ...
  protected static String b(Bundle paramBundle)
  {
