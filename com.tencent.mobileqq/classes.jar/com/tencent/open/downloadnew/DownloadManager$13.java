  ...
  public void run()
  {
    try
    {
      ...
      if (localTMAssistantDownloadTaskInfo != null)
      {
        ...
        LogUtility.b("DownloadManager_", "onDownload complete, info.filePath = " + this.a.l);
    ...
    catch (Exception localException)
    {
      ...
      label388:
      LogUtility.c("DownloadManager_", this.a.jdField_e_of_type_JavaLangString + " Download complete begin write code ......");
