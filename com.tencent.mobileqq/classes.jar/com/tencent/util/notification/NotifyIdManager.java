  ...
  implements Manager
{
  ...
  private ColorNickText a(String paramString)
  {
    ...
    paramString.setSpan(new ForegroundColorSpan(BaseApplicationImpl.context.getResources().getColor(2131166261)), 0, paramString.length(), 33);
    return paramString;
  }
  ...
  public static boolean a(Message paramMessage)
  {
    ...
    while ((!ProcessorFactory.a(paramMessage.istroop)) || (!a(paramMessage.frienduin))) {
      return false;
    }
    return true;
  }
  ...
  public String a(String paramString, Message paramMessage)
  {
    ...
    if (QvipSpecialCareManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + paramMessage.frienduin)) {
      str = HardCodeUtil.a(2131707622) + paramString;
    }
    return str;
  }
  ...
  public void a(Message paramMessage, Intent paramIntent, SpannableStringBuilder paramSpannableStringBuilder)
  {
    if ((a(paramMessage.frienduin, paramMessage.senderuin)) && (paramMessage.istroop == 1))
    {
      ...
      paramSpannableStringBuilder.append(new ColorNickText("[" + paramIntent + "]", 16));
      paramSpannableStringBuilder.append(a(HardCodeUtil.a(2131707621)));
  ...
  {
    if ((QvipSpecialCareManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + paramMessage.senderuin)) && (paramMessage.istroop == 0)) {
      paramSpannableStringBuilder.append(a(HardCodeUtil.a(2131707623)));
    }
  }
  
  public void a(Message paramMessage, TextView paramTextView)
  {
  ...
  public String b(String paramString, Message paramMessage)
  {
    ...
    if ((bool) || ((localObject != null) && (((Boolean)localObject).booleanValue())))
    {
      ...
      localObject = HardCodeUtil.a(2131707624) + paramString;
    }
    do
    {
      do
    ...
    return localResources.getString(2131699386) + paramString;
  }
  ...
  {
    return QvipSpecialCareManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + paramMessage.senderuin);
  }
