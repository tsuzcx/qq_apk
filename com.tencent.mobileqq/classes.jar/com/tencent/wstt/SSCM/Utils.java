...
public class Utils
{
  ...
  public static java.lang.String a()
  {
    ...
    //   0: aconst_null
    //   1: astore_2
    //   2: invokestatic 50	android/os/Process:myPid	()I
    //   5: istore_0
    ...
    //   18: iload_0
    //   19: invokestatic 65	java/lang/String:valueOf	(I)Ljava/lang/String;
    ...
    //   34: ldc 72
    //   36: astore 4
    //   38: new 74	java/io/FileReader
    //   41: dup
    //   42: aload_1
    //   43: invokespecial 77	java/io/FileReader:<init>	(Ljava/lang/String;)V
    //   46: astore_3
    //   47: new 79	java/io/BufferedReader
    //   50: dup
    //   51: aload_3
    //   52: sipush 8192
    //   55: invokespecial 82	java/io/BufferedReader:<init>	(Ljava/io/Reader;I)V
    //   58: astore 5
    //   60: aload 5
    //   62: invokevirtual 85	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   65: pop
    //   66: aload 5
    //   68: invokevirtual 85	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   71: pop
    //   72: aload 5
    ...
    //   97: aload_2
    //   98: ldc 87
    //   100: invokevirtual 91	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   103: astore_1
    //   104: aload_1
    //   105: arraylength
    //   106: bipush 9
    ...
    //   117: ifnull +7 -> 124
    //   120: aload_3
    //   121: invokevirtual 94	java/io/FileReader:close	()V
    //   124: aload_1
    //   125: astore 4
    //   127: aload 5
    //   129: ifnull +11 -> 140
    //   132: aload 5
    //   134: invokevirtual 95	java/io/BufferedReader:close	()V
    //   137: aload_1
    //   138: astore 4
    //   140: aload 4
    //   142: areturn
    ...
    //   149: astore_2
    //   150: aload_2
    //   151: invokevirtual 100	java/io/IOException:printStackTrace	()V
    //   154: aload_1
    //   155: areturn
    //   156: astore_3
    //   157: aconst_null
    //   158: astore_1
    //   159: aload_3
    //   160: invokevirtual 100	java/io/IOException:printStackTrace	()V
    //   163: aload_2
    //   164: ifnull +7 -> 171
    //   167: aload_2
    //   168: invokevirtual 94	java/io/FileReader:close	()V
    //   171: aload_1
    //   172: ifnull -32 -> 140
    //   175: aload_1
    //   176: invokevirtual 95	java/io/BufferedReader:close	()V
    //   179: ldc 72
    //   181: areturn
    //   182: astore_1
    //   183: aload_1
    //   184: invokevirtual 100	java/io/IOException:printStackTrace	()V
    //   187: ldc 72
    //   189: areturn
    //   190: astore_2
    //   191: aconst_null
    ...
    //   196: ifnull +7 -> 203
    //   199: aload_3
    //   200: invokevirtual 94	java/io/FileReader:close	()V
    //   203: aload_1
    //   204: ifnull +7 -> 211
    //   207: aload_1
    //   208: invokevirtual 95	java/io/BufferedReader:close	()V
    //   211: aload_2
    //   212: athrow
    //   213: astore_1
    //   214: aload_1
    //   215: invokevirtual 100	java/io/IOException:printStackTrace	()V
    //   218: goto -7 -> 211
    //   221: astore_2
    //   222: aconst_null
    //   223: astore_1
