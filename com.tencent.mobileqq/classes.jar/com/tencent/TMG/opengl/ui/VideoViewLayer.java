  ...
  extends GLViewGroup
{
  ...
  public GLVideoView addVideo(String paramString, int paramInt1, int paramInt2)
  {
    ...
    ((StringBuilder)localObject).append("addVideo|identifier = ");
    ((StringBuilder)localObject).append(paramString);
    ((StringBuilder)localObject).append(", videoSrcType = ");
    ((StringBuilder)localObject).append(paramInt1);
    Log.e("VideoLayerUI", ((StringBuilder)localObject).toString());
    ...
    localObject = (GLVideoView)this.mGlVideoViewFreeList.get(0);
    this.mGlVideoViewFreeList.remove(0);
    ((GLVideoView)localObject).setRender(paramString, paramInt1);
    ((GLVideoView)localObject).setMirror(false);
    ((GLVideoView)localObject).enableLoading(true);
    ((GLVideoView)localObject).setZOrder(paramInt2);
    this.mGlVideoViewBusyList.add(localObject);
    addView((GLView)localObject);
    layoutVideoView();
    return localObject;
  }
  ...
  protected void layoutVideoView()
  {
    ...
    Log.d("VideoLayerUI", localStringBuilder.toString());
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if (QLog.isColorLevel())
    {
      ...
      QLog.d("VideoLayerUI", 0, localStringBuilder.toString());
    }
    layoutVideoView();
  }
  ...
  {
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append("addVideo|identifier = ");
    localStringBuilder.append(paramString);
    localStringBuilder.append(", videoSrcType = ");
    localStringBuilder.append(paramInt);
    Log.e("VideoLayerUI", localStringBuilder.toString());
    paramInt = getViewIndexById(paramString, paramInt);
    if (paramInt >= 0)
    {
