  ...
  implements Runnable
{
  ...
  public void run()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 20	com/tencent/TMG/ptt/FileTransfer$2:val$downloadUrl	Ljava/lang/String;
    ...
    //   66: goto +622 -> 688
    //   69: aload_0
    //   70: getfield 22	com/tencent/TMG/ptt/FileTransfer$2:val$savePath	Ljava/lang/String;
    ...
    //   104: dup
    //   105: aload_0
    //   106: getfield 20	com/tencent/TMG/ptt/FileTransfer$2:val$downloadUrl	Ljava/lang/String;
    ...
    //   129: ldc 73
    //   131: aload_0
    //   132: getfield 24	com/tencent/TMG/ptt/FileTransfer$2:val$sign	Ljava/lang/String;
    ...
    //   172: dup
    //   173: aload_0
    //   174: getfield 22	com/tencent/TMG/ptt/FileTransfer$2:val$savePath	Ljava/lang/String;
    ...
    //   394: aload 5
    //   396: aload_0
    //   397: getfield 20	com/tencent/TMG/ptt/FileTransfer$2:val$downloadUrl	Ljava/lang/String;
    ...
    //   442: aload 5
    //   444: aload_0
    //   445: getfield 20	com/tencent/TMG/ptt/FileTransfer$2:val$downloadUrl	Ljava/lang/String;
    ...
    //   555: aload 8
    //   557: aload_0
    //   558: getfield 22	com/tencent/TMG/ptt/FileTransfer$2:val$savePath	Ljava/lang/String;
    ...
    //   655: aload 8
    //   657: aload_0
    //   658: getfield 20	com/tencent/TMG/ptt/FileTransfer$2:val$downloadUrl	Ljava/lang/String;
    ...
    //   738: aload_0
    //   739: getfield 26	com/tencent/TMG/ptt/FileTransfer$2:val$monitor	Lcom/tencent/TMG/ptt/PttListener$DownloadFileListener;
    //   742: astore 4
    //   744: aload 4
    //   746: ifnull +19 -> 765
    //   749: aload 4
    //   751: iload_1
    //   752: aload_0
    //   753: getfield 22	com/tencent/TMG/ptt/FileTransfer$2:val$savePath	Ljava/lang/String;
    //   756: aload_0
    //   757: getfield 20	com/tencent/TMG/ptt/FileTransfer$2:val$downloadUrl	Ljava/lang/String;
    //   760: invokeinterface 157 4 0
    //   765: return
    //   766: aload 5
    //   768: astore 6
    //   770: iconst_0
    ...
    //   742	96	4	localObject2	Object
    //   56	790	5	localObject3	Object
    ...
    //   768	28	6	localObject8	Object
    //   808	1	6	localUnknownHostException3	java.net.UnknownHostException
    //   829	1	6	localMalformedURLException3	java.net.MalformedURLException
    //   16	834	7	localObject9	Object
    //   19	829	8	localObject10	Object
    //   22	272	9	localInputStream	java.io.InputStream
    //   309	464	9	localIOException5	java.io.IOException
    //   779	15	9	localIOException6	java.io.IOException
    ...
    //   234	241	779	java/io/IOException
    //   253	260	779	java/io/IOException
    //   272	280	779	java/io/IOException
    //   297	306	779	java/io/IOException
    //   323	331	779	java/io/IOException
    //   343	348	779	java/io/IOException
    //   215	222	808	java/net/UnknownHostException
    //   234	241	808	java/net/UnknownHostException
    //   253	260	808	java/net/UnknownHostException
    //   272	280	808	java/net/UnknownHostException
    //   297	306	808	java/net/UnknownHostException
    //   323	331	808	java/net/UnknownHostException
    //   343	348	808	java/net/UnknownHostException
    //   215	222	829	java/net/MalformedURLException
    //   234	241	829	java/net/MalformedURLException
    //   253	260	829	java/net/MalformedURLException
    //   272	280	829	java/net/MalformedURLException
    //   297	306	829	java/net/MalformedURLException
    //   323	331	829	java/net/MalformedURLException
    //   343	348	829	java/net/MalformedURLException
  }
}
