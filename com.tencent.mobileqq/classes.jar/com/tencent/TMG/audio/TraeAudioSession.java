  ...
  extends BroadcastReceiver
{
  ...
  public TraeAudioSession(Context paramContext, TraeAudioSession.ITraeAudioCallback paramITraeAudioCallback)
  {
    ...
    if (paramContext != null) {
      ...
      catch (Exception paramContext)
      {
        if (QLog.isColorLevel())
        {
          ...
          QLog.e("TRAE", 0, paramITraeAudioCallback.toString());
        }
      }
    }
    ...
    Log.w("TRAE", paramContext.toString());
  }
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    bool2 = "com.tencent.sharp.ACTION_TRAEAUDIOMANAGER_NOTIFY".equals(paramIntent.getAction());
    boolean bool1 = true;
    int i;
    if (bool2)
    {
    ...
    else if ("com.tencent.sharp.ACTION_TRAEAUDIOMANAGER_RES".equals(paramIntent.getAction()))
    {
      ...
      {
        bool2 = "OPERATION_CONNECTDEVICE".equals(paramContext);
        if (bool2)
        {
