...
public final class ApkExternalInfoTool
{
  ...
  private static Pair a(ByteBuffer paramByteBuffer, int paramInt, byte[] paramArrayOfByte)
  {
  ...
  public static String a(File paramFile)
  {
    ...
    //   2: iconst_1
    //   3: ldc 167
    //   5: invokestatic 173	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   8: aload_0
    //   9: ifnonnull +5 -> 14
    //   12: aconst_null
    //   13: areturn
    ...
    //   29: aload_0
    //   30: invokevirtual 180	java/io/File:getName	()Ljava/lang/String;
    //   33: invokevirtual 83	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    //   42: aload_0
    //   43: invokevirtual 183	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   46: invokestatic 186	com/tencent/securitysdk/utils/ApkSignatureSchemeV2Verifier:a	(Ljava/lang/String;)Z
    //   49: ifeq +209 -> 258
    //   52: aload_0
    //   53: invokevirtual 183	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   56: ldc 187
    //   58: invokestatic 190	com/tencent/securitysdk/utils/ApkExternalInfoTool:a	(Ljava/lang/String;I)[B
    //   61: astore_1
    //   62: aload_1
    //   63: ifnonnull +186 -> 249
    //   66: new 192	java/io/RandomAccessFile
    //   69: dup
    //   70: aload_0
    //   71: ldc 194
    //   73: invokespecial 197	java/io/RandomAccessFile:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   76: astore_1
    //   77: aload_1
    //   78: astore_0
    //   79: aload_1
    //   80: astore_2
    //   81: aload_1
    //   82: invokestatic 200	com/tencent/securitysdk/utils/ApkExternalInfoTool:a	(Ljava/io/RandomAccessFile;)[B
    //   85: astore_3
    //   86: aload_3
    //   87: ifnonnull +45 -> 132
    //   90: aload_1
    ...
    //   96: iconst_1
    //   97: ldc 202
    //   99: invokestatic 173	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   102: aload_1
    //   103: astore_0
    //   104: aload_1
    //   105: astore_2
    ...
    //   108: iconst_1
    //   109: ldc 204
    //   111: invokestatic 173	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   114: aload_1
    //   115: ifnull +7 -> 122
    //   118: aload_1
    ...
    //   124: iconst_1
    //   125: ldc 209
    //   127: invokestatic 173	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   130: aconst_null
    //   131: areturn
    //   132: aload_1
    //   133: astore_0
    ...
    //   139: dup
    //   140: aconst_null
    //   141: invokespecial 214	aliw:<init>	(Laliv;)V
    //   144: astore 4
    //   146: aload_1
    //   147: astore_0
    //   148: aload_1
    ...
    //   150: aload 4
    //   152: aload_3
    //   153: invokevirtual 217	aliw:a	([B)V
    //   156: aload_1
    //   157: astore_0
    //   158: aload_1
    //   159: astore_2
    //   160: aload 4
    //   162: getfield 220	aliw:a	Ljava/util/Properties;
    //   165: ldc 222
    ...
    //   172: ifnull +7 -> 179
    //   175: aload_1
    //   176: invokevirtual 207	java/io/RandomAccessFile:close	()V
    //   179: ldc 165
    //   181: iconst_1
    //   182: ldc 209
    //   184: invokestatic 173	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   187: aload_3
    //   188: areturn
    //   189: astore_1
    //   190: aconst_null
    ...
    //   193: astore_0
    //   194: aload_1
    //   195: invokevirtual 231	java/lang/Throwable:printStackTrace	()V
    //   198: aload_2
    //   199: ifnull +7 -> 206
    //   202: aload_2
    //   203: invokevirtual 207	java/io/RandomAccessFile:close	()V
    //   206: ldc 165
    //   208: iconst_1
    //   209: ldc 209
    //   211: invokestatic 173	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   214: aconst_null
    //   215: areturn
    //   216: astore_0
    //   217: aconst_null
    ...
    //   222: ifnull +7 -> 229
    //   225: aload_2
    //   226: invokevirtual 207	java/io/RandomAccessFile:close	()V
    //   229: ldc 165
    //   231: iconst_1
    //   232: ldc 209
    //   234: invokestatic 173	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   237: aload_1
    //   238: athrow
    //   239: astore_1
    //   240: aload_0
  ...
  private static void b(File paramFile, String paramString)
  {
    ...
    finally
    {
      try
      {
        ...
        localaliw = new aliw(null);
        localaliw.a(paramFile);
        localaliw.a.setProperty("apkSecurityCode", paramString);
        paramFile = localaliw.a();
  ...
  private static void c(File paramFile, String paramString)
  {
    try
    {
      ...
      aliw localaliw = new aliw(null);
      localaliw.a(arrayOfByte);
      localaliw.a.setProperty("apkSecurityCode", paramString);
      paramString = localaliw.a();
