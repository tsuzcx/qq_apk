  ...
  implements INetEngine.INetEngineListener
{
  ...
  public long a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      if (paramInt1 == 2)
      {
        ...
        paramQQAppInterface.getNetEngine(0).sendReq((NetReq)localObject);
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
        return l;
      }
    } while (paramInt1 != 3);
  ...
  public void a(int paramInt, long paramLong, boolean paramBoolean)
  {
    if ((this.jdField_a_of_type_JavaUtilHashMap.containsKey(Long.valueOf(paramLong))) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null))
    {
      ...
      for (;;)
      {
        if (localIterator.hasNext())
        {
          ...
          {
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getNetEngine(0).cancelReq((NetReq)((Map.Entry)localObject).getValue());
    ...
    while (this.jdField_b_of_type_JavaUtilHashSet.contains(Long.valueOf(paramLong)))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getNetEngine(0).cancelReq((NetReq)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramLong)));
