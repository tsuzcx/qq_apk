  ...
  extends BaseShortVideoOprerator
{
  ...
  {
    ThreadManager.getSubThreadHandler().post(new DevShortVideoOperator.1(this, paramShortVideoUploadInfo));
  }
  ...
  public int a()
  {
    ...
    //   147: putfield 82	com/tencent/device/file/DevShortVideoOperator:jdField_b_of_type_Int	I
    //   150: aload_0
    //   151: aload 10
    //   153: invokevirtual 85	android/graphics/Bitmap:getHeight	()I
    //   156: putfield 87	com/tencent/device/file/DevShortVideoOperator:jdField_c_of_type_Int	I
    ...
    //   176: putfield 98	com/tencent/device/file/DevShortVideoOperator:jdField_a_of_type_Long	J
    ...
    //   189: aload_3
    //   190: aload_0
    //   191: getfield 98	com/tencent/device/file/DevShortVideoOperator:jdField_a_of_type_Long	J
    ...
    //   200: putfield 117	com/tencent/device/file/DevShortVideoOperator:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   203: aload_0
    //   204: getfield 117	com/tencent/device/file/DevShortVideoOperator:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   234: aload_0
    //   235: getfield 117	com/tencent/device/file/DevShortVideoOperator:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   281: ireturn
    //   282: aload_0
    //   283: getfield 117	com/tencent/device/file/DevShortVideoOperator:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   286: ldc 141
    ...
    //   314: invokestatic 154	com/tencent/mobileqq/utils/FileUtils:c	(Ljava/lang/String;)V
    ...
    //   331: dup
    //   332: aload 8
    //   334: invokevirtual 157	java/io/File:getParent	()Ljava/lang/String;
    //   337: invokespecial 92	java/io/File:<init>	(Ljava/lang/String;)V
    //   340: astore_2
    //   341: aload_2
    //   342: invokevirtual 160	java/io/File:exists	()Z
    //   345: ifeq +10 -> 355
    //   348: aload_2
    //   349: invokevirtual 163	java/io/File:isDirectory	()Z
    //   352: ifne +8 -> 360
    //   355: aload_2
    //   356: invokevirtual 166	java/io/File:mkdirs	()Z
    //   359: pop
    //   360: aload 8
    //   362: invokevirtual 160	java/io/File:exists	()Z
    //   365: ifeq +11 -> 376
    //   368: aload 8
    //   370: invokevirtual 169	java/io/File:isFile	()Z
    //   373: ifne +9 -> 382
    //   376: aload 8
    //   378: invokevirtual 172	java/io/File:createNewFile	()Z
    //   381: pop
    //   382: new 174	java/io/FileOutputStream
    //   385: dup
    //   386: aload 8
    //   388: invokespecial 175	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   391: astore_2
    //   392: aload 10
    //   394: getstatic 181	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   397: bipush 50
    //   399: aload_2
    //   400: invokevirtual 185	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   403: pop
    //   404: aload_2
    //   405: invokevirtual 188	java/io/FileOutputStream:flush	()V
    ...
    //   433: putfield 190	com/tencent/device/file/DevShortVideoOperator:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   436: aload_0
    //   437: getfield 190	com/tencent/device/file/DevShortVideoOperator:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   467: aload_0
    //   468: getfield 190	com/tencent/device/file/DevShortVideoOperator:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   511: aload_0
    //   512: aload_0
    //   513: getfield 190	com/tencent/device/file/DevShortVideoOperator:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   516: ldc 141
    ...
    //   521: putfield 195	com/tencent/device/file/DevShortVideoOperator:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    //   524: aload 9
    //   526: aload_0
    //   527: getfield 195	com/tencent/device/file/DevShortVideoOperator:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    //   530: invokestatic 198	com/tencent/mobileqq/utils/FileUtils:c	(Ljava/lang/String;Ljava/lang/String;)Z
    //   533: istore_1
    //   534: iload_1
    //   535: ifne +34 -> 569
    //   538: aload_3
    ...
    //   547: ifnull +7 -> 554
    //   550: aload_2
    //   551: invokevirtual 193	java/io/FileOutputStream:close	()V
    //   554: aload 4
    //   556: ifnull -481 -> 75
    //   559: aload 4
    ...
    //   568: ireturn
    //   569: aload_0
    //   570: getfield 200	com/tencent/device/file/DevShortVideoOperator:jdField_b_of_type_Long	J
    //   573: lconst_0
    //   574: lcmp
    //   575: ifne +14 -> 589
    //   578: aload_0
    ...
    //   583: invokestatic 204	com/tencent/mobileqq/shortvideo/ShortVideoUtils:getDuration	(Ljava/lang/String;)J
    //   586: putfield 200	com/tencent/device/file/DevShortVideoOperator:jdField_b_of_type_Long	J
    //   589: aload_3
    //   590: ifnull +7 -> 597
    //   593: aload_3
    ...
    //   598: ifnull +7 -> 605
    //   601: aload_2
    //   602: invokevirtual 193	java/io/FileOutputStream:close	()V
    //   605: aload 4
    //   607: ifnull +8 -> 615
    //   610: aload 4
    ...
    //   632: ldc 206
    //   634: aload 4
    //   636: invokestatic 209	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   639: aload_3
    //   640: ifnull +7 -> 647
    //   643: aload_3
    ...
    //   710: ldc 206
    //   712: aload 5
    //   714: invokestatic 209	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   717: aload 8
    //   719: ifnull +8 -> 727
    //   722: aload 8
    ...
    //   729: ifnull +8 -> 737
    //   732: aload 6
    //   734: invokevirtual 193	java/io/FileOutputStream:close	()V
    //   737: aload_2
    //   738: ifnull -663 -> 75
    //   741: aload_2
    ...
    //   786: ldc 211
    //   788: aload 5
    //   790: invokestatic 209	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   793: aload 8
    //   795: ifnull +8 -> 803
    //   798: aload 8
    ...
    //   805: ifnull +8 -> 813
    //   808: aload 6
    //   810: invokevirtual 193	java/io/FileOutputStream:close	()V
    //   813: aload_2
    //   814: ifnull -739 -> 75
    //   817: aload_2
    ...
    //   846: ifnull +8 -> 854
    //   849: aload 5
    //   851: invokevirtual 193	java/io/FileOutputStream:close	()V
    //   854: aload 4
    //   856: ifnull +8 -> 864
    //   859: aload 4
    ...
    //   0	1138	0	this	DevShortVideoOperator
    ...
    //   326	768	8	localObject21	Object
