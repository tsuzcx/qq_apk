  ...
  implements DeviceAVFileMsgObserver.DevMsgViewCallback
{
      ...
      if (paramMessageForPtt.fileSize != -1L) {
        ...
        else
        {
          ...
          if (paramMessageForPtt != null)
          {
            ...
            else if ((paramMessageForPtt.url.startsWith(AppConstants.SDCARD_ROOT)) && (FileUtils.a(paramMessageForPtt.url)))
            {
              i = 2003;
            }
  ...
  {
    PttItemBuilder.Holder localHolder = (PttItemBuilder.Holder)paramViewHolder;
    if ((localHolder == null) || (paramBubbleInfo == null)) {}
    for (;;)
    {
      return;
      if ((paramBubbleInfo.jdField_a_of_type_Int == 0) || (!paramBubbleInfo.a()))
      {
        ...
        for (paramViewHolder = paramViewHolder.getColorStateList(2131167056);; paramViewHolder = paramViewHolder.getColorStateList(2131167052))
        {
          ...
          if ((localHolder.b == null) || (paramViewHolder == null)) {
            break;
          }
      ...
      while ((paramBubbleInfo.jdField_b_of_type_Boolean) && (((ChatBackgroundManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.CHAT_BACKGROUND_MANAGER)).a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, localHolder.jdField_a_of_type_AndroidWidgetTextView.getCurrentTextColor(), 10000.0D * localHolder.jdField_a_of_type_ComTencentMobileqqBubbleBubbleInfo.jdField_a_of_type_Double) == 1))
      {
        ...
        localHolder.jdField_a_of_type_AndroidWidgetTextView.setShadowLayer(f1, 0.0F, 0.0F, paramBubbleInfo.d);
        return;
  ...
  public View b(ChatMessage paramChatMessage, BaseBubbleBuilder.ViewHolder paramViewHolder, View paramView, BaseChatItemLayout paramBaseChatItemLayout, OnLongClickAndTouchListener paramOnLongClickAndTouchListener)
  {
    ...
    if (paramView == null)
    {
      ...
      paramView.setId(2131374559);
      TextView localTextView = new TextView(this.jdField_a_of_type_AndroidContentContext);
      localTextView.setId(2131374564);
      ...
      ((RelativeLayout)localObject).setId(2131374560);
    ...
    if (paramChatMessage.isSend())
    {
      ((RelativeLayout.LayoutParams)paramBaseChatItemLayout.jdField_a_of_type_AndroidWidgetImageView.getLayoutParams()).addRule(1, 2131374564);
    ...
    for (;;)
    {
      ...
      ((RelativeLayout.LayoutParams)paramBaseChatItemLayout.jdField_a_of_type_AndroidWidgetTextView.getLayoutParams()).addRule(1, 2131374559);
  ...
  protected void b(PttItemBuilder.Holder paramHolder, MessageForPtt paramMessageForPtt, int paramInt, boolean paramBoolean)
  {
    ...
    if (paramMessageForPtt.voiceChangeFlag != 0)
    {
      ...
      default: 
        ...
        {
          j = paramInt;
          if (this.jdField_a_of_type_ComTencentMobileqqSttSliceSttManager.a(paramMessageForPtt)) {
            j = 4;
          }
        }
        switch (j)
        ...
        default: 
          ...
          if (bool2)
          {
            ...
            paramMessageForPtt = paramMessageForPtt.a("voice_pwd", HardCodeUtil.a(2131703244), new String[] { "lowTipStr" });
            label565:
          ...
          if (AppSetting.d)
          {
            paramMessageForPtt = HardCodeUtil.a(2131703246);
            if (i == 0) {
              break label3247;
            }
            paramHolder.jdField_a_of_type_AndroidWidgetRelativeLayout.setContentDescription(paramMessageForPtt + (String)localObject1 + HardCodeUtil.a(2131703248) + HardCodeUtil.a(2131703247));
            label637:
    ...
    do
    {
      ...
      paramHolder.jdField_a_of_type_AndroidWidgetTextView.setPadding(AIOUtils.a(10.0F, (Resources)localObject6), BaseChatItemLayout.m, AIOUtils.a(10.0F, (Resources)localObject6), BaseChatItemLayout.n);
      ...
      paramHolder.jdField_a_of_type_AndroidWidgetTextView.setText("");
      paramHolder.jdField_a_of_type_AndroidWidgetTextView.setPadding(AIOUtils.a(40.0F, (Resources)localObject6), BaseChatItemLayout.m, AIOUtils.a(40.0F, (Resources)localObject6), BaseChatItemLayout.n);
      if (paramHolder.jdField_a_of_type_ComTencentMobileqqActivityAioAnimVoicePrintUtils$VoicePrintView != null) {
        paramHolder.jdField_a_of_type_ComTencentMobileqqActivityAioAnimVoicePrintUtils$VoicePrintView.setVisibility(8);
      }
    ...
    if (paramMessageForPtt.voiceLength > PttItemBuilder.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Normal_MaxPtt")) {
      if (paramMessageForPtt.longPttVipFlag == 1)
      {
        if (this.jdField_a_of_type_AndroidTextSpannableString == null)
        {
          ...
          localObject1 = ((Resources)localObject6).getDrawable(2130840551);
    ...
    for (localObject1 = localObject2;; localObject1 = null)
    {
      ...
      if (paramMessageForPtt.isSend()) {
        ...
        {
          localObject3 = ((TroopRobotManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.TROOP_ROBOT_MANAGER)).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageForPtt);
      ...
      for (paramInt = 1;; paramInt = 0)
      {
        ...
        for (;;)
        {
          for (;;)
          {
            k = AIOUtils.a(9.0F, (Resources)localObject6);
            int n = AIOUtils.a(12.0F, (Resources)localObject6);
            try
            {
              m = ((Resources)localObject6).getDrawable(2130844955).getIntrinsicHeight();
              i1 = AIOUtils.a(1.0F, (Resources)localObject6);
              if (j == 1)
              {
                ...
                if (paramMessageForPtt.isSend())
                {
                  ...
                  if (bool3)
                  {
                    ...
                    localObject3 = VoicePrintUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, bool3, bool1, m + k, paramHolder);
                    if (paramHolder.jdField_a_of_type_ComTencentMobileqqActivityAioAnimVoicePrintUtils$VoicePrintView == null) {
                      break label3117;
                    }
                    ...
                    ((RelativeLayout.LayoutParams)localObject5).height = VoicePrintUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, bool3, paramHolder);
                    if (QLog.isColorLevel()) {
                      QLog.d("DevicePttItemBuilder", 2, "message seq=" + paramMessageForPtt.uniseq + ", VpLp.width=" + ((RelativeLayout.LayoutParams)localObject5).width + ", flagTimeContainer.getLeft()=" + paramHolder.jdField_a_of_type_AndroidWidgetRelativeLayout.getLeft());
                    }
                    ...
                    localObject7 = paramHolder.jdField_a_of_type_ComTencentMobileqqBubbleBubbleInfo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 7);
                    if ((((BubbleInfo.CommonAttrs)((Pair)localObject7).first).a != null) && (((BubbleInfo.CommonAttrs)((Pair)localObject7).first).a.length > 0))
                    {
                      localObject6 = paramHolder.jdField_a_of_type_ComTencentMobileqqActivityAioAnimVoicePrintUtils$VoicePrintView;
                      localObject7 = (BubbleInfo.CommonAttrs)((Pair)localObject7).first;
                      j = localObject3[0];
                      ...
                      bool1 = true;
                      ((VoicePrintUtils.VoicePrintView)localObject6).setBitmap((BubbleInfo.CommonAttrs)localObject7, j, k, m, n, bool1);
                      if (!paramBoolean) {
                        break label3098;
                      }
                    ...
                    if (this.b == null)
                    {
                      this.b = new SpannableString(HardCodeUtil.a(2131703242));
                      localObject1 = ((Resources)localObject6).getDrawable(2130840550);
                      ((Drawable)localObject1).setBounds(0, -5, ((Drawable)localObject1).getIntrinsicWidth() * 4 / 5 + 5, ((Drawable)localObject1).getIntrinsicHeight() * 4 / 5);
                      localObject1 = new OffsetableImageSpan((Drawable)localObject1, 1).setOffset(0.05F);
                      this.b.setSpan(localObject1, 0, 3, 17);
                    }
                    localObject2 = HardCodeUtil.a(2131703239);
            ...
            catch (Exception localException)
            {
              for (;;)
              {
                int i1;
                Object localObject7;
                int m = AIOUtils.a(24.0F, (Resources)localObject6);
                ...
                localObject4 = paramHolder.jdField_a_of_type_AndroidWidgetTextView;
                if (bool3) {}
                ...
                if (paramHolder.jdField_a_of_type_ComEtrumpMixlayoutETTextView == null)
                {
                  ...
                  ((ImageView)localObject5).setId(2131374580);
                  ETTextView localETTextView = new ETTextView(this.jdField_a_of_type_AndroidContentContext);
                  if (paramMessageForPtt.isSend())
                  {
                    localObject4 = ((Resources)localObject6).getColorStateList(2131167056);
                    ...
                    localImageView.setImageResource(2130844955);
                    localImageView.setScaleType(ImageView.ScaleType.FIT_END);
                    ((RelativeLayout.LayoutParams)localObject7).addRule(3, 2131374560);
                    ((RelativeLayout.LayoutParams)localObject7).addRule(14);
                    ((RelativeLayout.LayoutParams)localObject4).addRule(3, 2131374580);
                    localLayoutParams.addRule(3, 2131374580);
                    localLayoutParams.addRule(14);
                    localLayoutParams.addRule(6, 2131374579);
                    localLayoutParams.addRule(8, 2131374579);
                    paramHolder.jdField_a_of_type_ComTencentMobileqqActivityAioItemBreathAnimationLayout.addView((View)localObject5);
                    ...
                    paramHolder.e = ((ImageView)localObject5);
                    ...
                    if (TextUtils.isEmpty((CharSequence)localObject5)) {
                      localObject4 = this.jdField_a_of_type_AndroidContentContext.getString(2131719547);
                    }
                    ...
                    localObject5 = VoicePrintUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, bool3, bool1, j + k, paramHolder);
                    ...
                    j = m + AIOUtils.a(22.0F, (Resources)localObject6);
                    if (!paramMessageForPtt.isSend()) {
                      break label2957;
                    }
                    localObject4 = (RelativeLayout.LayoutParams)paramHolder.e.getLayoutParams();
                    ((RelativeLayout.LayoutParams)localObject4).addRule(5, 2131374560);
                    ((RelativeLayout.LayoutParams)localObject4).addRule(7, 2131374560);
                    localObject4 = (RelativeLayout.LayoutParams)paramHolder.jdField_a_of_type_ComEtrumpMixlayoutETTextView.getLayoutParams();
                    ((RelativeLayout.LayoutParams)localObject4).addRule(5, 2131374560);
                    ((RelativeLayout.LayoutParams)localObject4).addRule(7, 2131374560);
                    paramHolder.jdField_a_of_type_AndroidWidgetImageView.setPadding(0, 0, k, 0);
                    ...
                    paramHolder.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setPadding(k, BaseChatItemLayout.m, k, j);
                ...
                for (;;)
                {
                  ...
                  paramHolder.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setText((CharSequence)localObject4);
                  localObject4 = localObject5;
                  break;
                  localObject4 = ((Resources)localObject6).getColorStateList(2131167052);
                  break label2323;
          ...
          paramHolder.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.c.setBackgroundDrawable(null);
          Object localObject4 = paramHolder.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.c;
          if (paramMessageForPtt.isSendFromLocal()) {}
          for (paramMessageForPtt = HardCodeUtil.a(2131703243);; paramMessageForPtt = HardCodeUtil.a(2131703240))
          {
          ...
          break label518;
          paramMessageForPtt = HardCodeUtil.a(2131703244);
          break label565;
          paramHolder.jdField_a_of_type_AndroidWidgetRelativeLayout.setContentDescription(paramMessageForPtt + (String)localObject1 + HardCodeUtil.a(2131703245));
          break label637;
          i = paramInt;
          paramInt = 0;
          j = 1;
