...
public class DevLittleVideoItemBuilder$6
  implements Runnable
{
  public DevLittleVideoItemBuilder$6(abua paramabua, MessageForDevLittleVideo paramMessageForDevLittleVideo) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      synchronized (localabux.b)
      {
        Iterator localIterator = localabux.b.entrySet().iterator();
        if (localIterator.hasNext())
        {
          ...
          {
            long l = localabqn.a(this.a.videoFileKey, this.a.fileKey2, 2201);
            localabux.b.put(Long.valueOf(l), this.a);
          }
          return;
        }
      }
