  ...
  extends DeviceFileObserver
{
  ...
  private MessageRecord a(long paramLong1, long paramLong2, JSONObject paramJSONObject)
  {
    ...
    localMessageForDevPtt.msg = (ContactUtils.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForDevPtt.senderuin, true) + ": " + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131435586));
  ...
  private MessageRecord b(long paramLong1, long paramLong2, JSONObject paramJSONObject)
  {
    ...
    localMessageForDeviceFile.msg = (ContactUtils.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForDeviceFile.senderuin, true) + ": " + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131437850));
  ...
  protected MessageRecord a(long paramLong)
  {
    ...
    do
    {
      ...
      localObject2 = ((QQAppInterface)localObject2).a().a(((DeviceFileObserver.SessionPack)localObject1).jdField_a_of_type_JavaLangString, ((DeviceFileObserver.SessionPack)localObject1).jdField_a_of_type_Int, ((DeviceFileObserver.SessionPack)localObject1).jdField_a_of_type_Long);
