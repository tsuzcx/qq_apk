  ...
  extends DeviceFileObserver
{
  ...
  public long a(MessageForDeviceSingleStruct paramMessageForDeviceSingleStruct, View paramView, MessageForDeviceSingleStruct.DeviceSingleStructItemCallback paramDeviceSingleStructItemCallback)
  {
    ...
    if (paramView != null)
    {
      ...
      {
        DevSingleStructMsgProcessor.CallbackPack localCallbackPack = (DevSingleStructMsgProcessor.CallbackPack)localIterator.next();
    ...
    for (int i = 1;; i = 0)
    {
      ...
      long l2 = ((DeviceFileHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.DEVICEFILE_HANDLER)).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageForDeviceSingleStruct.strCoverKey, paramMessageForDeviceSingleStruct.strCoverKey2, paramMessageForDeviceSingleStruct.nCoverChannelType, 2154);
  ...
  public String a(DataPoint paramDataPoint)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject = ((SmartDeviceProxyMgr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.DEVICEPROXYMGR_HANDLER)).a(paramDataPoint.mDin);
        if (localObject == null) {
          break label638;
        }
