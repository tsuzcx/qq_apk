  ...
  extends BroadcastReceiver
{
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    do
    {
            ...
            do
            {
              do
              {
                do
                {
                  do
                  {
                    for (;;)
                    {
                      ...
                      else if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_receiveDPMsg"))
                      {
                        ...
                        paramIntent = ((SmartDeviceProxyMgr)DeviceMsgHandle.a(this.a).getBusinessHandler(BusinessHandlerFactory.DEVICEPROXYMGR_HANDLER)).a(((DataPoint)localObject1).mDin);
                        i = 0;
                        if (paramIntent != null) {
                          ...
                          for (;;)
                          {
                            try
                            {
                              ...
                              if (paramContext.optInt("flag") == 0)
                              {
                                ...
                                BannerManager.a().a(39, 0, paramContext);
                            ...
                            BannerManager.a().a(39, 2, paramIntent);
                          }
                        }
                        if ((10003 == ((DataPoint)localObject1).mProperityId) || (10013 == ((DataPoint)localObject1).mProperityId))
                        {
                          ...
                          SmartDeviceReport.a(DeviceMsgHandle.a(this.a), ((DataPoint)localObject1).mDin, "Usr_AIO_ReceiveMsg", 2, 0, i);
                          if (DeviceMsgHandle.a(this.a, ((DataPoint)localObject1).mValue)) {
                            continue;
                          }
                          DeviceMsgHandle.a(this.a);
                        ...
                        if (10007 == ((DataPoint)localObject1).mProperityId)
                        {
                          ...
                          SmartDeviceReport.a(DeviceMsgHandle.a(this.a), ((DataPoint)localObject1).mDin, "Usr_AIO_ReceiveMsg", 1, 0, i);
                          if (DeviceMsgHandle.a(this.a, ((DataPoint)localObject1).mValue)) {
                            continue;
                          }
                          DeviceMsgHandle.a(this.a);
                        ...
                        if (10009 == ((DataPoint)localObject1).mProperityId)
                        {
                          try
                          {
                            ...
                            ((MessageForDevLittleVideo)localObject4).msg = (ContactUtils.c(DeviceMsgHandle.a(this.a), ((MessageForDevLittleVideo)localObject4).senderuin, true) + HardCodeUtil.a(2131703209));
                        ...
                        if (((DataPoint)localObject1).mProperityId == 10008)
                        {
                          try
                          {
                            if ((!TextUtils.isEmpty(DeviceMsgHandle.a(this.a).getCurrentAccountUin())) && (String.valueOf(((DataPoint)localObject1).mDin).equals(DeviceMsgHandle.a(this.a).getCurrentAccountUin()))) {
                              continue;
                            }
                      ...
                      try
                      {
                        if (!DeviceTipActivity.a)
                        {
                          ...
                          localObject2 = SettingCloneUtil.readValue(DeviceMsgHandle.a(this.a).getApp(), DeviceMsgHandle.a(this.a).getCurrentAccountUin(), null, "account_login_success_time", "");
                          l1 = 0L;
                          ...
                          if (QLog.isColorLevel())
                          {
                            ...
                            QQToast.a(DeviceMsgHandle.a(this.a).getApp(), HardCodeUtil.a(2131703206) + i + HardCodeUtil.a(2131703208), 1).a();
                          }
                          if (l1 - l2 > 1L)
                          {
                            if (QLog.isColorLevel()) {
                              QQToast.a(DeviceMsgHandle.a(this.a).getApp(), "该消息是手Q登录前" + (l1 - l2) + HardCodeUtil.a(2131703217), 1).a();
                            }
                            this.a.a(paramContext, HardCodeUtil.a(2131703211), l2, "");
                            return;
                          }
                          if (MessageCache.a() - l2 <= 30L)
                          {
                            localObject2 = new Intent(DeviceMsgHandle.a(this.a).getApp(), DeviceTipActivity.class);
                            ((Intent)localObject2).setFlags(268435456);
                            ((Intent)localObject2).putExtra("uin", paramContext);
                            ((Intent)localObject2).putExtra("digest", paramIntent);
                            DeviceMsgHandle.a(this.a).getApp().startActivity((Intent)localObject2);
                          }
                        }
                        if (DeviceMsgHandle.a(this.a, ((DataPoint)localObject1).mValue)) {
                          continue;
                      ...
                      else if (((DataPoint)localObject1).mProperityId == 11010)
                      {
                        try
                        {
                          ...
                          paramContext = MessageRecordFactory.a(DeviceMsgHandle.a(this.a), ((SessionInfo)localObject5).jdField_a_of_type_JavaLangString, ((SessionInfo)localObject5).b, ((SessionInfo)localObject5).jdField_a_of_type_Int, paramContext);
                      ...
                      else if ((((DataPoint)localObject1).mProperityId == 11008) || (((DataPoint)localObject1).mProperityId == 11012))
                      {
                        ...
                        {
                          paramContext = new JSONObject(((DataPoint)localObject1).mValue);
                          SmartDeviceUtil.a(DeviceMsgHandle.a(this.a), paramContext, String.valueOf(((DataPoint)localObject1).mDin));
                          if (DeviceMsgHandle.a(this.a, ((DataPoint)localObject1).mValue)) {
                            continue;
                          }
                          DeviceMsgHandle.a(this.a);
                        ...
                        else
                        {
                          if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_OnMiniFileTransferComplete"))
                          {
                            ...
                            if ((l1 != 0L) && (this.a.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(Long.valueOf(l1))))
                            {
                              ...
                              paramContext.msg = (ContactUtils.c(DeviceMsgHandle.a(this.a), paramContext.senderuin, true) + ": " + DeviceMsgHandle.a(this.a).getApp().getString(2131691641));
                              paramContext.serial();
                              DeviceMsgHandle.a(this.a).getMessageFacade().a(paramContext.frienduin, paramContext.istroop, paramContext.uniseq, paramContext.msgData);
                          ...
                          if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_DeviceVasFlagChange"))
                          {
                            ...
                            if (paramIntent != null)
                            {
                              ...
                              if (localObject2 != null)
                              {
                                ...
                                {
                                  paramIntent = DeviceMsgHandle.a(this.a).getApp().getString(2131694688).split(":")[0];
                                  paramContext = paramIntent;
                                ...
                                {
                                  com.tencent.mobileqq.activity.aio.rebuild.DeviceMsgChatPie.R = true;
                                  paramContext = paramContext + DeviceMsgHandle.a(this.a).getApp().getString(2131691614);
                                  this.a.a(l1 + "", paramContext, MessageCache.a(), true, false, 1);
                                  return;
                                }
                                if ((i == 0) && (((DeviceInfo)localObject2).isAdmin != 1))
                                {
                                  com.tencent.mobileqq.activity.aio.rebuild.DeviceMsgChatPie.R = false;
                                  paramContext = paramContext + DeviceMsgHandle.a(this.a).getApp().getString(2131691613);
                          ...
                          else if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_QueryIsDeviceBinded"))
                          {
                            ...
                            if (paramIntent != null)
                            {
                              ...
                              localObject1 = ContactUtils.c(DeviceMsgHandle.a(this.a), l1 + "", true);
                          ...
                          else
                          {
                            ...
                            if (paramIntent != null)
                            {
                              ...
                              if (localObject1 != null)
                              {
                                ...
                                for (paramContext = HardCodeUtil.a(2131703219); !TextUtils.isEmpty(paramContext); paramContext = HardCodeUtil.a(2131703216) + ((ProductInfo)localObject1).deviceName)
                                {
                                  localObject1 = ContactUtils.c(DeviceMsgHandle.a(this.a), Long.toString(((Long)localObject3).longValue()), true);
                  ...
                  paramContext = HardCodeUtil.a(2131703207);
      ...
      localObject1 = ContactUtils.c(DeviceMsgHandle.a(this.a), paramContext, true);
      if ((TextUtils.isEmpty((CharSequence)localObject1)) || (paramContext.equals(localObject1))) {}
      for (paramContext = HardCodeUtil.a(2131703226);; paramContext = (String)localObject1 + HardCodeUtil.a(2131703215))
      {
      ...
      if ("SmartDevice_sendToAIO_Capture".equals(paramIntent.getAction()))
      {
        ...
        try
        {
          ...
          ((JSONObject)localObject2).put("guidewords", HardCodeUtil.a(2131703213));
          ((JSONObject)localObject2).put("appear_time", MessageCache.a());
          ((JSONObject)localObject2).put("digest", HardCodeUtil.a(2131703222));
          ((JSONObject)localObject2).put("title", HardCodeUtil.a(2131703225));
    ...
    try
    {
      ...
      ((JSONObject)localObject3).put("guidewords", HardCodeUtil.a(2131703224));
