...
public class QFindBLEScanMgr
{
  ...
  public HashMap a;
  public MqqHandler a;
  private qhl jdField_a_of_type_Qhl;
  ...
  public QFindBLEScanMgr()
  {
    ...
    if (a()) {
      ThreadManager.getSubThreadHandler().post(new qhk(this));
    }
    if (!a()) {}
    for (;;)
    {
  ...
  private void a(int paramInt, String paramString)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilHashMap.containsKey(paramString)) {
      SosoInterface.a(new qhf(this, 0, true, true, 0L, false, false, "smartdevice:lightapp", paramString));
    }
  }
      ...
      try
      {
        if ((this.jdField_a_of_type_AndroidBluetoothBluetoothAdapter != null) && (this.jdField_a_of_type_AndroidBluetoothBluetoothAdapter.isEnabled()))
        {
          ...
          if (this.jdField_a_of_type_MqqOsMqqHandler != null) {
            this.jdField_a_of_type_MqqOsMqqHandler.postDelayed(new qhg(this), this.i);
          }
        }
      }
      catch (Throwable localThrowable)
  ...
  private void f()
  {
    ...
    a(2);
    if (this.jdField_a_of_type_Qhl != null) {}
    try
    {
      this.jdField_a_of_type_AndroidContentContext.unregisterReceiver(this.jdField_a_of_type_Qhl);
      return;
    }
    catch (Throwable localThrowable)
    {
  ...
  private void g()
  {
    try
    {
      ...
      this.jdField_a_of_type_AndroidBluetoothBluetoothAdapter$LeScanCallback = new qhh(this);
      return;
    }
    catch (Throwable localThrowable) {}
  }
