  ...
  extends SQLiteOpenHelper
{
  ...
  {
    r.c("SqliteHelper", "tables count:" + b().length);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        r.c("SqliteHelper", "sql=" + (String)localObject);
      }
      catch (InstantiationException localInstantiationException)
      {
        for (;;)
        {
          r.c("SqliteHelper", "exception: ", localInstantiationException);
      ...
      catch (IllegalAccessException localIllegalAccessException)
      {
        for (;;)
        {
          r.c("SqliteHelper", "exception: ", localIllegalAccessException);
  ...
  public SQLiteDatabase getReadableDatabase()
  {
    ...
    //   35: ldc 72
    //   37: aload_2
    //   38: invokestatic 75	com/tencent/tmassistantbase/util/r:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   41: aload_2
  ...
  public void onOpen(SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    r.c("SqliteHelper", " dbversion:" + i + " newVersion:" + a());
    if (i == 0) {
      return;
    }
    if (i < a())
      ...
      for (;;)
      {
        if (i < k)
        {
          ...
          try
          {
            ...
            r.c("sqliteHelper", " upgrade:" + localObject);
            if (localObject != null)
            {
              int j = 0;
          ...
          {
            r.c("SqliteHelper", "exception: ", localException);
