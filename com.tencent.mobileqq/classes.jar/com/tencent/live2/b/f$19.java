  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      {
        f.a(this.a, localb.a.b(), V2TXLiveDef.V2TXLivePlayStatus.V2TXLivePlayStatusLoading, V2TXLiveDef.V2TXLiveStatusChangeReason.V2TXLiveStatusChangeReasonBufferingBegin);
        f.a(this.a, localb.a.b(), localb.a.c(), V2TXLiveDef.V2TXLivePlayStatus.V2TXLivePlayStatusLoading, V2TXLiveDef.V2TXLiveStatusChangeReason.V2TXLiveStatusChangeReasonBufferingBegin);
      }
    }
  }
}
 ...
 * Qualified Name:     com.tencent.live2.b.f.19
