  ...
  extends MessageMicro<RspHeadInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 42, 48, 58, 66 }, new String[] { "dstUin", "faceType", "timestamp", "faceFlag", "url", "sysid", "dstUid", "headVerify" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, localInteger, "", localInteger, "", "" }, RspHeadInfo.class);
  }
}
