  ...
  extends MessageMicro<RspHeadInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 42, 48, 58 }, new String[] { "usrType", "faceType", "timestamp", "faceFlag", "url", "sysid", "headVerify" }, new Object[] { localInteger, localInteger, localInteger, localInteger, "", localInteger, "" }, RspHeadInfo.class);
  }
}
