  ...
  extends MessageMicro<MultiBusidUrlReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 40, 48, 58 }, new String[] { "srcUidType", "srcUin", "srcTid", "srcOpenid", "dstUsrType", "dstUidType", "dstUsrInfos" }, new Object[] { localInteger, localLong, localLong, "", localInteger, localInteger, null }, MultiBusidUrlReq.class);
  }
}
