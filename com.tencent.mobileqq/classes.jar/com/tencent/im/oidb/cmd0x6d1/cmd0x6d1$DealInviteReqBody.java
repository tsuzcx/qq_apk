  ...
  extends MessageMicro<DealInviteReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32 }, new String[] { "uint64_group_code", "uint64_uin", "str_id", "uint32_deal_result" }, new Object[] { localLong, localLong, "", Integer.valueOf(0) }, DealInviteReqBody.class);
  }
}
