...
public class TPHttpUtils
{
  ...
  private static byte[] onHttp(byte[] paramArrayOfByte1, Object paramObject, byte[] paramArrayOfByte2, int paramInt)
  {
    ...
    paramArrayOfByte1 = new String(paramArrayOfByte1, Charset.forName("UTF-8"));
    if (paramArrayOfByte2 == null) {
      paramArrayOfByte2 = new byte[0];
    }
    paramArrayOfByte1 = new Request(2, paramArrayOfByte1, paramObject, paramArrayOfByte2, paramInt, null);
    try
    {
