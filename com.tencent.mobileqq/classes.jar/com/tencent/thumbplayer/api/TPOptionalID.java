...
public class TPOptionalID
{
  ...
  @TPNativeKeyMap.MapInitConfig(keyName="OPTION_ID_BEFORE_INT_AUDIO_FRAME_HZ", type=4, value=302)
  public static final int OPTION_ID_BEFORE_INT_AUDIO_FRAME_HZ = 350;
  @TPNativeKeyMap.MapInitConfig(keyName="OPTION_ID_BEFORE_INT_FRAME_SIZE_BYTE", type=4, value=303)
  public static final int OPTION_ID_BEFORE_INT_FRAME_SIZE_BYTE = 353;
  @TPNativeKeyMap.MapInitConfig(keyName="OPTION_ID_BEFORE_INT_SAMPLE_FORMAT", type=4, value=300)
  ...
  @TPNativeKeyMap.MapInitConfig(keyName="OPTION_ID_BEFORE_LONG_CHANNEL_LAYOUT", type=1, value=301)
