  ...
  implements ITPPlayerAdapter, ITPPlayerBaseListener.IOnStateChangeListener
{
  ...
  private void setPlayerParamBeforePrepare(ITPPlayerBase paramITPPlayerBase)
  {
    ...
    for (;;)
    {
      ...
      if ((TPNativeKeyMapUtil.convertToNativeInitConfig(((TPOptionalParam)localObject2).getKey()) == null) && (TPNativeKeyMapUtil.convertToNativeOptionalId(((TPOptionalParam)localObject2).getKey()) == null))
      {
        this.mLogger.warn("init param=[" + localObject2 + "] is not valid native param");
        continue;
        ...
        if (2 != this.mPlayerInitParams.dataSource().getType()) {
          break;
        }
        paramITPPlayerBase.setDataSource(this.mPlayerInitParams.dataSource().mediaAsset());
        break;
      }
      paramITPPlayerBase.setPlayerOptionalParam((TPOptionalParam)localObject2);
    }
    label387:
    int i = 0;
    Object localObject3;
