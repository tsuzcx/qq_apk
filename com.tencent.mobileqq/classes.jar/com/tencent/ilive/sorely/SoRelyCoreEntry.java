...
public class SoRelyCoreEntry
{
  public static boolean checkRely(Context paramContext, ICheckResult paramICheckResult)
  {
    ...
    return SoEntry.instanse().newEntry(paramContext, localRelyConfig, SoRelyUtil.getDownloader(paramContext)).setRelyAnnoClass(SoRelyCoreEntry.class).check(paramICheckResult);
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes4.jar
 * Qualified Name:     com.tencent.ilive.sorely.SoRelyCoreEntry
