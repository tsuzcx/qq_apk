...
final class LoadLibraryUtil$V25
{
  private static void install(ClassLoader paramClassLoader, File paramFile)
  {
    ...
    for (;;)
    {
      ...
      localObject1 = ReflectUtil.findMethod(localObject2, "makePathElements", new Class[] { List.class });
      paramClassLoader.addAll(paramFile);
      paramClassLoader = (Object[])((Method)localObject1).invoke(localObject2, new Object[] { paramClassLoader });
 ...
 * Qualified Name:     com.tencent.ilive.util.soloader.LoadLibraryUtil.V25
