  ...
  implements ThreadCenter.HandlerKeyable, IGiftAnimation, LuxuryGiftComponent
{
  ...
  {
    LiteLuxuryGiftController localLiteLuxuryGiftController = this.mHonorableGiftController;
    return (localLiteLuxuryGiftController != null) && (localLiteLuxuryGiftController.isGiftViewBuilded()) && (this.mHonorableGiftController.isWorking());
  }
  ...
  public void animViewReady()
  {
    ...
    Object localObject = getLuxuryGiftAdapter().getDataReport().newTask().setPage("room_page").setPageDesc("直播/视频房间").setModule("gift_luxury_play").setModuleDesc("豪华礼物播放").setActType("success").setActTypeDesc("成功");
    LuxuryGiftData localLuxuryGiftData = this.mCurrentLuxuryGiftData;
    int i;
    if (localLuxuryGiftData != null) {
      i = localLuxuryGiftData.giftId;
    } else {
      i = -1;
    }
    ((ReportTask)localObject).addKeyValue("zt_int1", i).send();
    if (this.mIsNeedShow)
    {
      localObject = this.mHonorableGiftController;
      if ((localObject != null) && (((LiteLuxuryGiftController)localObject).isGiftViewBuilded())) {
  ...
  {
    GiftQueue localGiftQueue = this.mToPlayGiftsList;
    if (localGiftQueue != null) {
      localGiftQueue.clearQueue();
    }
  }
  ...
  public void hideLuxuryAnimationView()
  {
    ...
    LiteLuxuryGiftController localLiteLuxuryGiftController = this.mHonorableGiftController;
    if ((localLiteLuxuryGiftController != null) && (localLiteLuxuryGiftController.isGiftViewBuilded())) {
  ...
  {
    LiteLuxuryGiftController localLiteLuxuryGiftController = this.mHonorableGiftController;
    if (localLiteLuxuryGiftController != null) {
      localLiteLuxuryGiftController.onGetLuxuryGiftResInfoList(paramList);
    }
  }
  ...
  public void showRichGiftAnimation(LuxuryGiftData paramLuxuryGiftData)
  {
    ...
    if ((localObject1 != null) && (((LiteLuxuryGiftController)localObject1).isGiftViewBuilded()))
    {
  ...
  public void stopLuxuyAnimationAndHide()
  {
    LiteLuxuryGiftController localLiteLuxuryGiftController = this.mHonorableGiftController;
    if (localLiteLuxuryGiftController != null) {
      localLiteLuxuryGiftController.cancelAnimation();
    }
