...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/luggage/opensdk/QRCodeDisplayDialog$NormalLayoutFactory;", "Lcom/tencent/luggage/opensdk/QRCodeDisplayDialog$LayoutFactory;", "()V", "onAttached", "", "dialog", "Lcom/tencent/luggage/opensdk/QRCodeDisplayDialog;", "component", "Lcom/tencent/mm/plugin/appbrand/jsapi/AppBrandComponentWithExtra;", "args", "Lorg/json/JSONObject;", "luggage-standalone-mode-ext_release"}, k=1, mv={1, 1, 16})
final class k$b
  implements k.a
{
  ...
  public void a(@NotNull k paramk, @NotNull h paramh, @NotNull JSONObject paramJSONObject)
  {
    ...
    paramh.setImageResource(2130853489);
    ...
    paramJSONObject = paramk.getContext();
    Intrinsics.checkExpressionValueIsNotNull(paramJSONObject, "dialog.context");
    int i = l.a(paramJSONObject, 49.0F);
 ...
 * Qualified Name:     com.tencent.luggage.opensdk.k.b
