...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"loge", "", "str", "", "invoke", "com/tencent/luggage/opensdk/OpenSDKTicketTransferResponseStepChecker$startCheck$2$1$2"}, k=3, mv={1, 1, 16})
final class j$e$b
  extends Lambda
  implements Function1<String, Unit>
{
  j$e$b(int paramInt, j.e parame, CoroutineScope paramCoroutineScope)
  {
    super(1);
  }
 ...
 * Qualified Name:     com.tencent.luggage.opensdk.j.e.b
