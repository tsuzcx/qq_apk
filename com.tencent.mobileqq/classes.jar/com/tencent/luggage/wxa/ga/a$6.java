...
{
  a$6(a parama, com.tencent.luggage.wxa.gf.a parama1, s params)
  {
    super(parama1, params);
  }
  ...
  public void a(@NonNull String paramString, @NonNull com.tencent.luggage.wxa.fx.a parama)
  {
    ...
    if ((!paramString.contains("insert")) && (!paramString.contains("update")))
    {
      if (paramString.contains("operate"))
      {
        ...
        if ((!af.c(paramString)) && ((paramString.equalsIgnoreCase("play")) || (paramString.equalsIgnoreCase("resume")))) {
          this.a = true;
        }
      }
  ...
  protected boolean a()
  {
    return a.h(this.c) ^ true;
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes5.jar
 * Qualified Name:     com.tencent.luggage.wxa.ga.a.6
