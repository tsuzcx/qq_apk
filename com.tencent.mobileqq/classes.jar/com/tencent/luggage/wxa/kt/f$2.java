...
class f$2
  implements b.a
{
  f$2(f paramf, a.b paramb, e parame) {}
  ...
  public void a(String paramString1, String paramString2, JSONObject paramJSONObject1, JSONObject paramJSONObject2)
  {
    ...
    o.d("MicroMsg.JsApiInsertImageView", "callback stage:%s, drag:%s, data:%s, target:%s", new Object[] { paramString1, paramJSONObject1, paramString2, paramJSONObject2 });
 ...
 * Qualified Name:     com.tencent.luggage.wxa.kt.f.2
