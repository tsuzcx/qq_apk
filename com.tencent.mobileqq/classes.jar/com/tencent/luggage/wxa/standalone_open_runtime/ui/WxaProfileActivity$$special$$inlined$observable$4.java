...
public final class WxaProfileActivity$$special$$inlined$observable$4
  extends ObservableProperty<String>
{
  public WxaProfileActivity$$special$$inlined$observable$4(Object paramObject1, Object paramObject2, WxaProfileActivity paramWxaProfileActivity)
  {
    super(paramObject2);
  }
  ...
  protected void afterChange(@NotNull KProperty<?> paramKProperty, String paramString1, String paramString2)
  {
    ...
    paramString1 = (TextView)l.a((View)WxaProfileActivity.e(this.b), "wxa_desc");
    paramKProperty = (CharSequence)paramKProperty;
    paramString1.setText(paramKProperty);
    int i;
    if ((StringsKt.isBlank(paramKProperty) ^ true)) {
      i = 0;
    } else {
      i = 8;
    }
 ...
 * Qualified Name:     com.tencent.luggage.wxa.standalone_open_runtime.ui.WxaProfileActivity..special..inlined.observable.4
