  ...
  extends d<h>
{
  ...
  public void a(h paramh, JSONObject paramJSONObject, int paramInt)
  {
    ...
    {
      o.c("MicroMsg.AppBrand.JsApiEnableLocationUpdateBackgroundWxa", "state manager not RuntimeLocationUpdateStateManagerWxa");
    ...
    localk.a(new e.1(this, localk, paramh));
    paramJSONObject = localk.m();
    if (paramJSONObject != null) {
      paramh.q().al().b(paramJSONObject);
    }
    if ((paramJSONObject == null) || (!localk.a())) {
      paramJSONObject = new e.2(this, localk);
    }
 ...
 * Qualified Name:     com.tencent.luggage.wxa.kx.e
