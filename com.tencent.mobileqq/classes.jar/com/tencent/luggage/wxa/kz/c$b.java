  ...
  implements c.c
{
  ...
  {
    com.tencent.mm.plugin.appbrand.appstorage.o localo = paramc.getFileSystem();
    if (localo == null)
    {
      com.tencent.luggage.wxa.qz.o.c("MicroMsg.JsApiCompressImage.javayhu", "compressImage fail:fileSystem is null");
      return new c.a(false, "fail:runtime fileSystem is null");
    }
    com.tencent.luggage.wxa.rt.i locali = paramc.getFileSystem().g(paramString);
    if (locali == null)
    {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString = (String)localObject1;
        Bitmap localBitmap = b.a.a((b)paramc.a(b.class)).a(locali.l(), localOptions);
        if (localBitmap == null)
        {
          paramString = (String)localObject1;
        ...
        if (com.tencent.luggage.wxa.bx.a.a(localOptions))
        {
          ...
          {
            paramString = (String)localObject2;
            com.tencent.luggage.wxa.jw.b.a(locali.l(), (String)localObject2);
          }
          paramString = (String)localObject2;
 ...
 * Qualified Name:     com.tencent.luggage.wxa.kz.c.b
