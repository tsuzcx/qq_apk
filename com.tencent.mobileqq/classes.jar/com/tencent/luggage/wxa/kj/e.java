  ...
  extends com.tencent.luggage.wxa.kl.a
{
  ...
  public void a()
  {
    ...
    if (!c.d(((BluetoothGattCharacteristic)localObject).getProperties()))
    {
      com.tencent.luggage.wxa.kn.a.a("MicroMsg.Ble.Action", "action:%s, not support notify", new Object[] { this });
      b(j.j);
      d();
      return;
    }
    ...
    if (this.c) {
      localObject = BluetoothGattDescriptor.ENABLE_NOTIFICATION_VALUE;
    } else {
  ...
  public String toString()
  {
    ...
    localStringBuilder.append("NotifyCharacteristicAction#");
 ...
 * Qualified Name:     com.tencent.luggage.wxa.kj.e
