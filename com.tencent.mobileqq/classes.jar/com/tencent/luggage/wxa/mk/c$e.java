...
class c$e
{
  ...
  void a(boolean paramBoolean, int paramInt)
  {
    ...
    o.d("MicroMsg.SameLayer.ExoMediaPlayer", ((StringBuilder)localObject).toString());
    localObject = this.a;
    if (localObject[3] == i) {
      return;
    }
    ...
    ((StringBuilder)localObject).append("new MostRecentState [");
 ...
 * Qualified Name:     com.tencent.luggage.wxa.mk.c.e
