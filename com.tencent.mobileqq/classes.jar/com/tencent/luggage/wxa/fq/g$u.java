...
{
  g$u(TdiAuthListener paramTdiAuthListener) {}
  ...
  public final void onAuthFinish(@NotNull TdiAuthErrCode paramTdiAuthErrCode, @Nullable String paramString)
  {
    ...
    {
      g.a();
      o.b("Luggage.WxaApiImpl", "sendAuth: fail: [%s, %s]", new Object[] { paramTdiAuthErrCode.name(), paramString });
    }
    else
    {
      g.a();
      o.d("Luggage.WxaApiImpl", "sendAuth:: success");
    }
 ...
 * Qualified Name:     com.tencent.luggage.wxa.fq.g.u
