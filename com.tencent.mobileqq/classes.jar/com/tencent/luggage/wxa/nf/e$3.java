  ...
  public void run()
  {
    if (e.c(this.a) != null)
    {
      ...
      if (localc != null)
      {
        ...
        {
          o.d("MicroMsg.SameLayer.AppBrandVideoEventHandler", "stopKeepScreenOn");
          try
          {
          ...
          {
            o.b("MicroMsg.SameLayer.AppBrandVideoEventHandler", "stopKeepScreenOn exception", new Object[] { localException });
          }
        }
      }
    }
 ...
 * Qualified Name:     com.tencent.luggage.wxa.nf.e.3
