    ...
    if (paramInt == 0)
    {
      ...
      if (localObject != null)
      {
        if (this.b != null)
        {
          ...
          throw new b("Not all required fields were included: filePath");
        }
        throw new b("Not all required fields were included: phoneNumber");
      }
    ...
    if (paramInt == 3)
    {
      ...
      if (paramInt != 1)
      {
        if (paramInt != 2)
        {
          ...
          localc.c = ((com.tencent.luggage.wxa.sx.a)localObject).c(paramInt);
          return 0;
        }
        localc.b = ((com.tencent.luggage.wxa.sx.a)localObject).c(paramInt);
        return 0;
      }
      localc.a = ((com.tencent.luggage.wxa.sx.a)localObject).c(paramInt);
      return 0;
    }
    return -1;
  }
 ...
 * Qualified Name:     com.tencent.luggage.wxa.ew.c
