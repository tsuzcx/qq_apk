...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/mm/plugin/appbrand/jsapi/nfc/rw/JsApiIsNFCTechConnected;", "Lcom/tencent/mm/plugin/appbrand/jsapi/AppBrandAsyncJsApi;", "Lcom/tencent/mm/plugin/appbrand/jsapi/AppBrandComponent;", "()V", "invoke", "", "env", "data", "Lorg/json/JSONObject;", "callbackId", "", "Companion", "luggage-commons-jsapi-nfc-ext_release"}, k=1, mv={1, 1, 16})
  ...
  extends a<com.tencent.luggage.wxa.jx.c>
{
  ...
  public void a(@Nullable com.tencent.luggage.wxa.jx.c paramc, @Nullable JSONObject paramJSONObject, int paramInt)
  {
    if (paramc == null)
    {
      o.c("MicroMsg.AppBrand.JsApiIsNFCTechConnected", "invoke, env is null");
      return;
    }
    if (paramJSONObject == null)
    {
      o.c("MicroMsg.AppBrand.JsApiIsNFCTechConnected", "invoke, data is null");
    ...
    if (localObject == null)
    {
      o.c("MicroMsg.AppBrand.JsApiIsNFCTechConnected", "invoke, can not get activity");
    ...
    o.d("MicroMsg.AppBrand.JsApiIsNFCTechConnected", localStringBuilder.toString());
    try
    {
      paramJSONObject = paramJSONObject.getString("tech");
      Intrinsics.checkExpressionValueIsNotNull(paramJSONObject, "tech");
      ((com.tencent.luggage.wxa.lk.c)localObject).c(paramJSONObject, (Function1)new d.b(this, paramc, paramInt));
      return;
    }
    ...
    o.c("MicroMsg.AppBrand.JsApiIsNFCTechConnected", "parse tech failed");
    paramc.a(paramInt, a("fail:invalid parameter", (Map)MapsKt.hashMapOf(new Pair[] { TuplesKt.to("errCode", Integer.valueOf(13011)) })));
  }
}
 ...
 * Qualified Name:     com.tencent.luggage.wxa.lj.d
