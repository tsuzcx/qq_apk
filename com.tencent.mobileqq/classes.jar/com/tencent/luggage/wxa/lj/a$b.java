...
{
  a$b(a parama, c paramc, int paramInt)
  {
    super(1);
  }
  ...
  public final void a(@NotNull e<Unit> parame)
  {
    ...
    ((StringBuilder)localObject).append("transceive, result: ");
    ((StringBuilder)localObject).append(parame);
    o.e("MicroMsg.AppBrand.AbsJsApiNFCConnectClose", ((StringBuilder)localObject).toString());
    ...
    if ((parame instanceof e.a))
    {
      ...
      ((c)localObject).a(i, locala.a(localStringBuilder.toString(), (Map)MapsKt.hashMapOf(new Pair[] { TuplesKt.to("errCode", Integer.valueOf(parame.a())) })));
    }
  }
}
 ...
 * Qualified Name:     com.tencent.luggage.wxa.lj.a.b
