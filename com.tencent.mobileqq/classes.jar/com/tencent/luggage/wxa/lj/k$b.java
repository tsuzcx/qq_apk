...
{
  k$b(k paramk, c paramc, int paramInt)
  {
    super(1);
  }
  ...
  public final void a(@NotNull e<Unit> parame)
  {
    ...
    o.e("MicroMsg.AppBrand.JsApiNFCSetTimeout", ((StringBuilder)localObject).toString());
    ...
    if ((parame instanceof e.a))
    {
      ...
      ((c)localObject).a(i, localk.a(localStringBuilder.toString(), (Map)MapsKt.hashMapOf(new Pair[] { TuplesKt.to("errCode", Integer.valueOf(parame.a())) })));
    }
  }
}
 ...
 * Qualified Name:     com.tencent.luggage.wxa.lj.k.b
