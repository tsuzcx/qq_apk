...
{
  o$b(o paramo, c paramc, int paramInt)
  {
    super(1);
  }
  ...
  public final void a(@NotNull e<Unit> parame)
  {
    ...
    ((StringBuilder)localObject).append("writeNdefMessage, result: ");
    ((StringBuilder)localObject).append(parame);
    com.tencent.luggage.wxa.qz.o.e("MicroMsg.AppBrand.JsApiWriteNdefMessage", ((StringBuilder)localObject).toString());
    ...
    if ((parame instanceof e.a))
    {
      ...
      ((c)localObject).a(i, localo.a(localStringBuilder.toString(), (Map)MapsKt.hashMapOf(new Pair[] { TuplesKt.to("errCode", Integer.valueOf(parame.a())) })));
    }
  }
}
 ...
 * Qualified Name:     com.tencent.luggage.wxa.lj.o.b
