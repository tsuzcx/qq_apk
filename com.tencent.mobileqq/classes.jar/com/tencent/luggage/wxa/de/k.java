...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/luggage/login/account/tdi/TdiCgiServiceClient;", "Lcom/tencent/luggage/login/account/tdi/TdiCgiService;", "()V", "TAG", "", "getTAG", "()Ljava/lang/String;", "installTdiCgi", "", "tdiCgi", "Lcom/tencent/luggage/login/account/tdi/ITdiCgi;", "sync", "RESP", "Lcom/tencent/mm/protocal/protobuf/ResponseProtoBuf;", "cmdId", "", "url", "networkType", "Lcom/tencent/ilink/tdi/TdiApiProto$TdiNetType;", "req", "Lcom/tencent/mm/protobuf/BaseProtoBuf;", "respClazz", "Ljava/lang/Class;", "(ILjava/lang/String;Lcom/tencent/ilink/tdi/TdiApiProto$TdiNetType;Lcom/tencent/mm/protobuf/BaseProtoBuf;Ljava/lang/Class;)Lcom/tencent/mm/protocal/protobuf/ResponseProtoBuf;", "syncPipeline", "Lcom/tencent/mm/vending/pipeline/Pipeable;", "uninstall", "luggage-standalone-addon-loginsession_release"}, k=1, mv={1, 1, 16})
public final class k
  extends i
{
  @NotNull
  private final String b = "Luggage.RuntimeSDK.TdiCgiServiceClient";
  ...
  public <RESP extends gu> RESP a(int paramInt, @NotNull String paramString, @NotNull b.y paramy, @Nullable a parama, @NotNull Class<RESP> paramClass)
  {
    ...
    paramy = (f)com.tencent.luggage.wxa.hj.h.a(str, (Parcelable)new e(paramInt, paramString, paramy, parama, paramClass), new k.a().getClass());
    if (paramy != null) {
  ...
  public <RESP extends gu> d<RESP> b(int paramInt, @NotNull String paramString, @NotNull b.y paramy, @Nullable a parama, @NotNull Class<RESP> paramClass)
  {
    ...
    Intrinsics.checkParameterIsNotNull(paramy, "networkType");
    Intrinsics.checkParameterIsNotNull(paramClass, "respClazz");
    paramString = com.tencent.luggage.wxa.ro.h.a().a((com.tencent.luggage.wxa.rl.b)new k.b(this, paramInt, paramString, paramy, parama, paramClass));
 ...
 * Qualified Name:     com.tencent.luggage.wxa.de.k
