  ...
  extends com.tencent.luggage.wxa.qu.a
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 3)
    {
      ...
      localObject1 = (kr)paramVarArgs[1];
      ...
      if (paramInt != 1)
      {
        if (paramInt != 2)
        {
          if (paramInt != 3)
          {
            ...
            ((kr)localObject1).d = ((com.tencent.luggage.wxa.sx.a)localObject2).c(paramInt);
            return 0;
          }
          ((kr)localObject1).c = ((com.tencent.luggage.wxa.sx.a)localObject2).c(paramInt);
          return 0;
        }
        ((kr)localObject1).b = ((com.tencent.luggage.wxa.sx.a)localObject2).c(paramInt);
        return 0;
      }
      ...
      while (paramInt < i)
      {
        ...
        ((kr)localObject1).a = ((jm)localObject2);
        paramInt += 1;
      }
      return 0;
    }
 ...
 * Qualified Name:     com.tencent.luggage.wxa.qw.kr
