  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.z != null)
      {
        ...
        if (localObject1 != null)
        {
          paramVarArgs.c(3, ((jf)localObject1).d());
    ...
    if (paramInt == 3)
    {
      ...
      localObject1 = (ef)paramVarArgs[1];
      ...
      if (paramInt != 1)
      {
        if (paramInt != 2)
        {
          ...
          while (paramInt < i)
          {
            ...
            ((ef)localObject1).b = ((jf)localObject2);
            paramInt += 1;
          }
          return 0;
        }
        ...
        while (paramInt < i)
        {
          ...
          ((ef)localObject1).a = ((dy)localObject2);
          paramInt += 1;
        }
        return 0;
      }
      ...
      while (paramInt < i)
      {
        ...
        ((ef)localObject1).z = ((aa)localObject2);
        paramInt += 1;
      }
      return 0;
    }
 ...
 * Qualified Name:     com.tencent.luggage.wxa.qw.ef
