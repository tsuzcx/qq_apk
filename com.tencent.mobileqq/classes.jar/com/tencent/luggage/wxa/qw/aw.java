  ...
  extends gu
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 1)
    {
      ...
      return paramInt + com.tencent.luggage.wxa.sw.a.b(2, this.a) + com.tencent.luggage.wxa.sw.a.b(3, this.b);
    }
    if (paramInt == 2)
    {
    ...
    if (paramInt == 3)
    {
      ...
      if (paramInt != 1)
      {
        if (paramInt != 2)
        {
          ...
          localaw.b = ((com.tencent.luggage.wxa.sx.a)localObject1).b(paramInt);
          return 0;
        }
        localaw.a = ((com.tencent.luggage.wxa.sx.a)localObject1).b(paramInt);
        return 0;
      }
 ...
 * Qualified Name:     com.tencent.luggage.wxa.qw.aw
