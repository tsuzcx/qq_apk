  ...
  extends gt
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 1)
    {
      ...
      return i + com.tencent.luggage.wxa.sw.a.b(3, this.b) + com.tencent.luggage.wxa.sw.a.a(4, 1, this.c) + com.tencent.luggage.wxa.sw.a.b(5, this.d);
    }
    if (paramInt == 2)
    {
    ...
    if (paramInt == 3)
    {
      ...
      localObject1 = (fo)paramVarArgs[1];
        ...
        if (paramInt != 2)
        {
          if (paramInt != 3)
          {
            if (paramInt != 4)
            {
              ...
              ((fo)localObject1).d = ((com.tencent.luggage.wxa.sx.a)localObject2).b(paramInt);
              return 0;
            }
            ((fo)localObject1).c.add(((com.tencent.luggage.wxa.sx.a)localObject2).c(paramInt));
            return 0;
          }
          ((fo)localObject1).b = ((com.tencent.luggage.wxa.sx.a)localObject2).b(paramInt);
          return 0;
        }
        ((fo)localObject1).a = ((com.tencent.luggage.wxa.sx.a)localObject2).c(paramInt);
        return 0;
      }
      ...
      while (paramInt < i)
      {
        ...
        ((fo)localObject1).B = ((z)localObject2);
        paramInt += 1;
      }
      return 0;
    }
 ...
 * Qualified Name:     com.tencent.luggage.wxa.qw.fo
