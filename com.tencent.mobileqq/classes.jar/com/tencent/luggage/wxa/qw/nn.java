  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.z != null)
      {
        ...
        if (localObject1 != null)
        {
          paramVarArgs.c(3, ((ir)localObject1).d());
    ...
    if (paramInt == 3)
    {
      ...
      localObject1 = (nn)paramVarArgs[1];
      ...
      if (paramInt != 1)
      {
        if (paramInt != 2)
        {
          ...
          while (paramInt < i)
          {
            ...
            for (bool = true; bool; bool = ((ir)localObject2).a((com.tencent.luggage.wxa.sx.a)localObject3, (com.tencent.luggage.wxa.qu.a)localObject2, gu.a((com.tencent.luggage.wxa.sx.a)localObject3))) {}
            ((nn)localObject1).b = ((ir)localObject2);
            paramInt += 1;
          }
          return 0;
        }
        ((nn)localObject1).a = ((com.tencent.luggage.wxa.sx.a)localObject2).h(paramInt);
        return 0;
      }
      paramVarArgs = ((com.tencent.luggage.wxa.sx.a)localObject2).i(paramInt);
      i = paramVarArgs.size();
      ...
      while (paramInt < i)
      {
        ...
        ((nn)localObject1).z = ((aa)localObject2);
        paramInt += 1;
      }
      return 0;
    }
 ...
 * Qualified Name:     com.tencent.luggage.wxa.qw.nn
