  ...
  extends gt
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 3)
    {
      ...
      localObject1 = (ax)paramVarArgs[1];
      ...
      if (paramInt != 1)
      {
        if (paramInt != 2)
        {
          if (paramInt != 3)
          {
            ...
            ((ax)localObject1).c = ((com.tencent.luggage.wxa.sx.a)localObject2).c(paramInt);
            return 0;
          }
          ((ax)localObject1).b = ((com.tencent.luggage.wxa.sx.a)localObject2).c(paramInt);
          return 0;
        }
        ((ax)localObject1).a = ((com.tencent.luggage.wxa.sx.a)localObject2).c(paramInt);
        return 0;
      }
      ...
      while (paramInt < i)
      {
        ...
        ((ax)localObject1).B = ((z)localObject2);
        paramInt += 1;
      }
      return 0;
    }
 ...
 * Qualified Name:     com.tencent.luggage.wxa.qw.ax
