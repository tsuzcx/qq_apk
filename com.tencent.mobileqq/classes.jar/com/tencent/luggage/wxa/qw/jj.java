  ...
  extends gu
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 3)
    {
      ...
      localObject1 = (jj)paramVarArgs[1];
      ...
      if (paramInt != 1)
      {
        if (paramInt != 2)
        {
          ...
          ((jj)localObject1).b = ((com.tencent.luggage.wxa.sx.a)localObject2).c(paramInt);
          return 0;
        }
        ...
        while (paramInt < i)
        {
          ...
          ((jj)localObject1).a = ((t)localObject2);
          paramInt += 1;
        }
        return 0;
      }
      ...
      while (paramInt < i)
      {
        ...
        ((jj)localObject1).z = ((aa)localObject2);
        paramInt += 1;
      }
      return 0;
    }
 ...
 * Qualified Name:     com.tencent.luggage.wxa.qw.jj
