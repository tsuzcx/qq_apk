  ...
  extends gt
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 1)
    {
      ...
      return i + com.tencent.luggage.wxa.sw.a.a(3, 2, this.b) + com.tencent.luggage.wxa.sw.a.b(4, this.c);
    }
    if (paramInt == 2)
    {
    ...
    if (paramInt == 3)
    {
      ...
      localObject1 = (hz)paramVarArgs[1];
      ...
      if (paramInt != 1)
      {
        if (paramInt != 2)
        {
          if (paramInt != 3)
          {
            ...
            ((hz)localObject1).c = ((com.tencent.luggage.wxa.sx.a)localObject2).b(paramInt);
            return 0;
          }
          ((hz)localObject1).b.add(Integer.valueOf(((com.tencent.luggage.wxa.sx.a)localObject2).b(paramInt)));
          return 0;
        }
        ((hz)localObject1).a = ((com.tencent.luggage.wxa.sx.a)localObject2).c(paramInt);
        return 0;
      }
      ...
      while (paramInt < i)
      {
        ...
        ((hz)localObject1).B = ((z)localObject2);
        paramInt += 1;
      }
      return 0;
    }
 ...
 * Qualified Name:     com.tencent.luggage.wxa.qw.hz
