  ...
  extends com.tencent.luggage.wxa.qu.a
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      localObject = this.b;
      if (localObject != null) {
        paramVarArgs.a(2, (b)localObject);
      }
      localObject = this.c;
      if (localObject != null) {
      ...
      if (paramInt != 1)
      {
        if (paramInt != 2)
        {
          if (paramInt != 3)
          {
            ...
            locallw.d = ((com.tencent.luggage.wxa.sx.a)localObject).c(paramInt);
            return 0;
          }
          locallw.c = ((com.tencent.luggage.wxa.sx.a)localObject).c(paramInt);
          return 0;
        }
        locallw.b = ((com.tencent.luggage.wxa.sx.a)localObject).h(paramInt);
        return 0;
      }
      locallw.a = ((com.tencent.luggage.wxa.sx.a)localObject).c(paramInt);
      return 0;
    }
    return -1;
  }
 ...
 * Qualified Name:     com.tencent.luggage.wxa.qw.lw
