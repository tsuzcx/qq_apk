  ...
  extends gt
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramVarArgs.b(7, this.e);
      paramVarArgs.b(8, this.f);
      localObject1 = this.g;
      if (localObject1 != null)
      {
        paramVarArgs.c(9, ((md)localObject1).d());
    ...
    if (paramInt == 1)
    {
      ...
      i = paramInt + com.tencent.luggage.wxa.sw.a.b(7, this.e) + com.tencent.luggage.wxa.sw.a.b(8, this.f);
      paramVarArgs = this.g;
      paramInt = i;
      if (paramVarArgs != null) {
        paramInt = i + com.tencent.luggage.wxa.sw.a.c(9, paramVarArgs.d());
      }
      return paramInt;
    }
    if (paramInt == 2)
    ...
    if (paramInt == 3)
    {
      ...
      localObject1 = (eo)paramVarArgs[1];
      ...
      case 9: 
        ...
        while (paramInt < i)
        {
          ...
          ((eo)localObject1).g = ((md)localObject2);
          paramInt += 1;
        }
        return 0;
      case 8: 
        ((eo)localObject1).f = ((com.tencent.luggage.wxa.sx.a)localObject2).b(paramInt);
        return 0;
      case 7: 
        ((eo)localObject1).e = ((com.tencent.luggage.wxa.sx.a)localObject2).b(paramInt);
        return 0;
      case 6: 
        ((eo)localObject1).d = ((com.tencent.luggage.wxa.sx.a)localObject2).c(paramInt);
        return 0;
      case 4: 
        ((eo)localObject1).c = ((com.tencent.luggage.wxa.sx.a)localObject2).b(paramInt);
        return 0;
      case 3: 
        ((eo)localObject1).b.add(((com.tencent.luggage.wxa.sx.a)localObject2).c(paramInt));
        return 0;
      case 2: 
        ((eo)localObject1).a = ((com.tencent.luggage.wxa.sx.a)localObject2).c(paramInt);
        return 0;
      }
      paramVarArgs = ((com.tencent.luggage.wxa.sx.a)localObject2).i(paramInt);
      i = paramVarArgs.size();
      ...
      while (paramInt < i)
      {
        ...
        ((eo)localObject1).B = ((z)localObject2);
        paramInt += 1;
      }
      return 0;
    }
 ...
 * Qualified Name:     com.tencent.luggage.wxa.qw.eo
