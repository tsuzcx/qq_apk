  ...
  extends gu
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 3)
    {
      ...
      localObject1 = (nh)paramVarArgs[1];
      ...
      if (paramInt != 1)
      {
        if (paramInt != 2)
        {
          ...
          ((nh)localObject1).b = ((com.tencent.luggage.wxa.sx.a)localObject2).b(paramInt);
          return 0;
        }
        ((nh)localObject1).a = ((com.tencent.luggage.wxa.sx.a)localObject2).c(paramInt);
        return 0;
      }
      ...
      while (paramInt < i)
      {
        ...
        ((nh)localObject1).z = ((aa)localObject2);
        paramInt += 1;
      }
      return 0;
    }
 ...
 * Qualified Name:     com.tencent.luggage.wxa.qw.nh
