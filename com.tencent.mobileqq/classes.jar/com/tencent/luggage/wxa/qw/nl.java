  ...
  extends gu
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 3)
    {
      ...
      localObject1 = (nl)paramVarArgs[1];
      ...
      if (paramInt != 1)
      {
        if (paramInt != 2)
        {
          ...
          while (paramInt < i)
          {
            ...
            ((nl)localObject1).b = ((ir)localObject2);
            paramInt += 1;
          }
          return 0;
        }
        ((nl)localObject1).a = ((com.tencent.luggage.wxa.sx.a)localObject2).h(paramInt);
        return 0;
      }
      paramVarArgs = ((com.tencent.luggage.wxa.sx.a)localObject2).i(paramInt);
      i = paramVarArgs.size();
      ...
      while (paramInt < i)
      {
        ...
        ((nl)localObject1).z = ((aa)localObject2);
        paramInt += 1;
      }
      return 0;
    }
 ...
 * Qualified Name:     com.tencent.luggage.wxa.qw.nl
