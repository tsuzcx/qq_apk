...
public class ab
  extends gt
{
  public LinkedList<bz> a = new LinkedList();
  public int b;
    ...
    if (paramInt == 3)
    {
      ...
      if (paramInt != 1)
      {
        if (paramInt != 2)
        {
          ...
          localab.b = ((com.tencent.luggage.wxa.sx.a)localObject1).b(paramInt);
          return 0;
        }
        ...
        while (paramInt < i)
        {
          ...
          for (bool = true; bool; bool = ((bz)localObject1).a((com.tencent.luggage.wxa.sx.a)localObject2, (com.tencent.luggage.wxa.qu.a)localObject1, gt.a((com.tencent.luggage.wxa.sx.a)localObject2))) {}
          localab.a.add(localObject1);
          paramInt += 1;
        }
        return 0;
      }
 ...
 * Qualified Name:     com.tencent.luggage.wxa.qw.ab
