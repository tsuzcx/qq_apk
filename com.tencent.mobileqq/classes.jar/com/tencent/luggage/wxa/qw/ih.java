  ...
  extends gt
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (localObject1 != null)
      {
        paramVarArgs.c(8, ((nt)localObject1).d());
    ...
    if (paramInt == 3)
    {
      ...
      localObject1 = (ih)paramVarArgs[1];
        ...
        if (paramInt != 2)
        {
          if (paramInt != 3)
          {
            if (paramInt != 6)
            {
              if (paramInt != 7)
              {
                ...
                while (paramInt < i)
                {
                  ...
                  for (bool = true; bool; bool = ((nt)localObject2).a((com.tencent.luggage.wxa.sx.a)localObject3, (com.tencent.luggage.wxa.qu.a)localObject2, gt.a((com.tencent.luggage.wxa.sx.a)localObject3))) {}
                  ((ih)localObject1).e = ((nt)localObject2);
                  paramInt += 1;
                }
                return 0;
              }
              ...
              while (paramInt < i)
              {
                ...
                ((ih)localObject1).d = ((mg)localObject2);
                paramInt += 1;
              }
              return 0;
            }
            ...
            while (paramInt < i)
            {
              ...
              ((ih)localObject1).c = ((mf)localObject2);
              paramInt += 1;
            }
            return 0;
          }
          ...
          while (paramInt < i)
          {
            ...
            ((ih)localObject1).b = ((me)localObject2);
            paramInt += 1;
          }
          return 0;
        }
        ((ih)localObject1).a = ((com.tencent.luggage.wxa.sx.a)localObject2).c(paramInt);
        return 0;
      }
      paramVarArgs = ((com.tencent.luggage.wxa.sx.a)localObject2).i(paramInt);
      i = paramVarArgs.size();
      ...
      while (paramInt < i)
      {
        ...
        ((ih)localObject1).B = ((z)localObject2);
        paramInt += 1;
      }
      return 0;
    }
 ...
 * Qualified Name:     com.tencent.luggage.wxa.qw.ih
