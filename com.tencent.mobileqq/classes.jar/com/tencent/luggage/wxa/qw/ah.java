...
public class ah
  extends gt
{
  public LinkedList<lw> a = new LinkedList();
  public int b;
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 1)
    {
      ...
      return paramInt + com.tencent.luggage.wxa.sw.a.a(2, 8, this.a) + com.tencent.luggage.wxa.sw.a.b(3, this.b);
    }
    if (paramInt == 2)
    {
    ...
    if (paramInt == 3)
    {
      ...
      if (paramInt != 1)
      {
        if (paramInt != 2)
        {
          ...
          localah.b = ((com.tencent.luggage.wxa.sx.a)localObject1).b(paramInt);
          return 0;
        }
        ...
        while (paramInt < i)
        {
          ...
          for (bool = true; bool; bool = ((lw)localObject1).a((com.tencent.luggage.wxa.sx.a)localObject2, (com.tencent.luggage.wxa.qu.a)localObject1, gt.a((com.tencent.luggage.wxa.sx.a)localObject2))) {}
          localah.a.add(localObject1);
          paramInt += 1;
        }
        return 0;
      }
 ...
 * Qualified Name:     com.tencent.luggage.wxa.qw.ah
