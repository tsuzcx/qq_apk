  ...
  extends gt
{
  public String a;
  public int b;
  public LinkedList<kz> c = new LinkedList();
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 1)
    {
      ...
      return i + com.tencent.luggage.wxa.sw.a.b(3, this.b) + com.tencent.luggage.wxa.sw.a.a(4, 8, this.c);
    }
    if (paramInt == 2)
    {
    ...
    if (paramInt == 3)
    {
      ...
      localObject1 = (cs)paramVarArgs[1];
        ...
        if (paramInt != 2)
        {
          if (paramInt != 3)
          {
            ...
            while (paramInt < i)
            {
              ...
              for (bool = true; bool; bool = ((kz)localObject2).a((com.tencent.luggage.wxa.sx.a)localObject3, (com.tencent.luggage.wxa.qu.a)localObject2, gt.a((com.tencent.luggage.wxa.sx.a)localObject3))) {}
              ((cs)localObject1).c.add(localObject2);
              paramInt += 1;
            }
            return 0;
          }
          ((cs)localObject1).b = ((com.tencent.luggage.wxa.sx.a)localObject2).b(paramInt);
          return 0;
        }
        ((cs)localObject1).a = ((com.tencent.luggage.wxa.sx.a)localObject2).c(paramInt);
        return 0;
      }
      paramVarArgs = ((com.tencent.luggage.wxa.sx.a)localObject2).i(paramInt);
      i = paramVarArgs.size();
      ...
      while (paramInt < i)
      {
        ...
        ((cs)localObject1).B = ((z)localObject2);
        paramInt += 1;
      }
      return 0;
    }
 ...
 * Qualified Name:     com.tencent.luggage.wxa.qw.cs
