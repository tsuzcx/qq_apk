  ...
  extends gt
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (localObject1 != null)
      {
        paramVarArgs.c(4, ((md)localObject1).d());
    ...
    if (paramInt == 1)
    {
      ...
      i += com.tencent.luggage.wxa.sw.a.b(3, this.b);
      paramVarArgs = this.c;
      paramInt = i;
      if (paramVarArgs != null) {
    ...
    if (paramInt == 3)
    {
      ...
      localObject1 = (eu)paramVarArgs[1];
        ...
        if (paramInt != 2)
        {
          if (paramInt != 3)
          {
            ...
            while (paramInt < i)
            {
              ...
              ((eu)localObject1).c = ((md)localObject2);
              paramInt += 1;
            }
            return 0;
          }
          ((eu)localObject1).b = ((com.tencent.luggage.wxa.sx.a)localObject2).b(paramInt);
          return 0;
        }
        ((eu)localObject1).a = ((com.tencent.luggage.wxa.sx.a)localObject2).c(paramInt);
        return 0;
      }
      paramVarArgs = ((com.tencent.luggage.wxa.sx.a)localObject2).i(paramInt);
      i = paramVarArgs.size();
      ...
      while (paramInt < i)
      {
        ...
        ((eu)localObject1).B = ((z)localObject2);
        paramInt += 1;
      }
      return 0;
    }
 ...
 * Qualified Name:     com.tencent.luggage.wxa.qw.eu
