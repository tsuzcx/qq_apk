...
public class gv
  extends gt
{
  public LinkedList<mx> a = new LinkedList();
    ...
    if (paramInt == 3)
    {
      ...
      if (paramInt != 1)
      {
        ...
        while (paramInt < i)
        {
          ...
          for (bool = true; bool; bool = ((mx)localObject1).a((com.tencent.luggage.wxa.sx.a)localObject2, (com.tencent.luggage.wxa.qu.a)localObject1, gt.a((com.tencent.luggage.wxa.sx.a)localObject2))) {}
          localgv.a.add(localObject1);
          paramInt += 1;
        }
        return 0;
      }
 ...
 * Qualified Name:     com.tencent.luggage.wxa.qw.gv
