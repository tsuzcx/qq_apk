  ...
  extends gu
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 3)
    {
      ...
      localObject1 = (ev)paramVarArgs[1];
      ...
      if (paramInt != 1)
      {
        if (paramInt != 2)
        {
          ...
          ((ev)localObject1).b = ((com.tencent.luggage.wxa.sx.a)localObject2).b(paramInt);
          return 0;
        }
        ...
        while (paramInt < i)
        {
          ...
          ((ev)localObject1).a = ((dy)localObject2);
          paramInt += 1;
        }
        return 0;
      }
      ...
      while (paramInt < i)
      {
        ...
        ((ev)localObject1).z = ((aa)localObject2);
        paramInt += 1;
      }
      return 0;
    }
 ...
 * Qualified Name:     com.tencent.luggage.wxa.qw.ev
