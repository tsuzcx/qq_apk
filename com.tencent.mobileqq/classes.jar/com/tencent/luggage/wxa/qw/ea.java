  ...
  extends gu
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 1)
    {
      ...
      return i + com.tencent.luggage.wxa.sw.a.b(3, this.b) + com.tencent.luggage.wxa.sw.a.b(4, this.c) + com.tencent.luggage.wxa.sw.a.b(5, this.d);
    }
    if (paramInt == 2)
    {
    ...
    if (paramInt == 3)
    {
      ...
      localObject1 = (ea)paramVarArgs[1];
      ...
      if (paramInt != 1)
      {
        if (paramInt != 2)
        {
          if (paramInt != 3)
          {
            if (paramInt != 4)
            {
              ...
              ((ea)localObject1).d = ((com.tencent.luggage.wxa.sx.a)localObject2).b(paramInt);
              return 0;
            }
            ((ea)localObject1).c = ((com.tencent.luggage.wxa.sx.a)localObject2).b(paramInt);
            return 0;
          }
          ((ea)localObject1).b = ((com.tencent.luggage.wxa.sx.a)localObject2).b(paramInt);
          return 0;
        }
        ...
        while (paramInt < i)
        {
          ...
          ((ea)localObject1).a = ((dy)localObject2);
          paramInt += 1;
        }
        return 0;
      }
      ...
      while (paramInt < i)
      {
        ...
        ((ea)localObject1).z = ((aa)localObject2);
        paramInt += 1;
      }
      return 0;
    }
 ...
 * Qualified Name:     com.tencent.luggage.wxa.qw.ea
