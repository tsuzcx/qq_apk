...
{
  public ld a;
  public LinkedList<bg> b = new LinkedList();
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 3)
    {
      ...
      localObject1 = (df)paramVarArgs[1];
      ...
      if (paramInt != 1)
      {
        if (paramInt != 2)
        {
          ...
          while (paramInt < i)
          {
            ...
            for (bool = true; bool; bool = ((bg)localObject2).a((com.tencent.luggage.wxa.sx.a)localObject3, (com.tencent.luggage.wxa.qu.a)localObject2, gu.a((com.tencent.luggage.wxa.sx.a)localObject3))) {}
            ((df)localObject1).b.add(localObject2);
            paramInt += 1;
          }
          return 0;
        }
        ...
        while (paramInt < i)
        {
          ...
          ((df)localObject1).a = ((ld)localObject2);
          paramInt += 1;
        }
        return 0;
      }
      ...
      while (paramInt < i)
      {
        ...
        ((df)localObject1).z = ((aa)localObject2);
        paramInt += 1;
      }
      return 0;
    }
 ...
 * Qualified Name:     com.tencent.luggage.wxa.qw.df
