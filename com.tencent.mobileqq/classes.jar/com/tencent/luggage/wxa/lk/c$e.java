...
final class c$e
  implements Runnable
{
  c$e(c paramc, Function1 paramFunction1, String paramString) {}
  ...
  public final void run()
  {
    ...
    if (localObject1 != null)
    {
      ...
      if (localObject2 != null)
      {
        ...
        {
          this.b.invoke(new e.a(13022, "Tech already connected"));
          return;
        }
        localObject3 = this.a;
        localObject3 = this.b;
    ...
    if (localObject1 != null) {
      try
      {
        ((TagTechnology)localObject1).connect();
        c.h(this.a).add(localObject2);
      ...
      catch (Exception localException1)
      {
        ...
        ((StringBuilder)localObject2).append("connect failed since ");
 ...
 * Qualified Name:     com.tencent.luggage.wxa.lk.c.e
