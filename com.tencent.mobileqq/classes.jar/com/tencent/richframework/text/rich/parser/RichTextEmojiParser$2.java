...
final class RichTextEmojiParser$2
  extends QCirclePicStateListener
{
  RichTextEmojiParser$2(RichTextPreloadConfig.TextImageSpanConfig paramTextImageSpanConfig, SpannableStringBuilder paramSpannableStringBuilder, int paramInt1, int paramInt2, String paramString, RichTextEmojiParser.OnDrawableListener paramOnDrawableListener) {}
  ...
  public void onStateChang(int paramInt, Option paramOption)
  {
    ...
    if (paramInt == 6)
    {
      ...
      ((StringBuilder)localObject).append(":parse emotion success");
      QLog.d("RichTextEmojiParser", 1, ((StringBuilder)localObject).toString());
    }
  }
}
 ...
 * Qualified Name:     com.tencent.richframework.text.rich.parser.RichTextEmojiParser.2
