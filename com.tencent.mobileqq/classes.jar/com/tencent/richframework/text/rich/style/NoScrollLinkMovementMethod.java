...
public class NoScrollLinkMovementMethod
  extends BaseMovementMethod
{
  private static NoScrollLinkMovementMethod a;
  
  public static NoScrollLinkMovementMethod a()
  {
    if (a == null) {
      try
      {
        if (a == null) {
          a = new NoScrollLinkMovementMethod();
        }
      }
      finally {}
    }
 ...
 * Qualified Name:     com.tencent.richframework.text.rich.style.NoScrollLinkMovementMethod
