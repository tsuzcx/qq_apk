...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/xaction/anim/Elevation;", "Lcom/tencent/xaction/api/base/BaseAnim;", "()V", "elev", "", "getElev", "()F", "setElev", "(F)V", "start", "getStart", "setStart", "doFrameUpdate", "", "animTime", "end", "preStart", "view", "Landroid/view/View;", "XActionEngine_release"}, k=1, mv={1, 1, 16})
@Keep
  ...
  extends BaseAnim
{
  ...
  public void doFrameUpdate(float paramFloat)
  {
    if (Build.VERSION.SDK_INT >= 21)
    {
      ...
      if (localView != null) {
        localView.setElevation(this.start + (this.elev - this.start) * paramFloat);
      }
    }
  }
