...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"com/tencent/xaction/api/base/DecorDrawable$baseAnim$1", "Lcom/tencent/xaction/api/base/BaseAnim;", "doFrameUpdate", "", "animTime", "", "end", "preStart", "view", "Landroid/view/View;", "XActionCore_release"}, k=1, mv={1, 1, 16})
  ...
  extends BaseAnim
{
  ...
  public void preStart(@NotNull View paramView)
  {
    ...
    if ((Intrinsics.areEqual(localView, localIXAEngine.getLayout()) ^ true)) {
