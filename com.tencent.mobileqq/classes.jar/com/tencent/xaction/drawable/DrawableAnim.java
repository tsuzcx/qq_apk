  ...
  extends BaseAnim
{
  ...
  {
    if ((!this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_ComTencentXactionApiIDrawable != null))
    {
      ...
      if (localObject != null) {
        ((DecorDrawable)localObject).play();
      }
    }
  }
  ...
  public void preStart(@NotNull View paramView)
  {
    ...
    if ((this.b != this.jdField_a_of_type_Int) && (Build.VERSION.SDK_INT >= 16))
    {
      ...
      XAEngine localXAEngine = getEngine();
      if (localXAEngine == null) {
        Intrinsics.throwNpe();
      }
      this.jdField_a_of_type_ComTencentXactionApiIDrawable = localCompanion.a(localXAEngine, this.b, this.c, paramView, true);
    }
  }
}
