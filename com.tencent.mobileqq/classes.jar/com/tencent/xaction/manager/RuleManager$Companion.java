...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/xaction/manager/RuleManager$Companion;", "", "()V", "globalRuleNameMap", "Ljava/util/HashMap;", "", "Lkotlin/collections/HashMap;", "getGlobalRuleNameMap", "()Ljava/util/HashMap;", "registerGlobalRuleLine", "", "ruleName", "value", "XActionCore_release"}, k=1, mv={1, 1, 16})
