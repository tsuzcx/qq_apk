  ...
  implements Runnable
{
  ...
  public final void run()
  {
    ...
    for (localObject = (Drawable)new NinePatchDrawable(this.this$0.jdField_a_of_type_AndroidViewView.getResources(), new NinePatch(this.a, (byte[])localObject, null));; localObject = (Drawable)new BitmapDrawable(this.this$0.jdField_a_of_type_AndroidViewView.getResources(), this.a))
    {
      DecorDrawable.Companion.a(this.this$0.jdField_a_of_type_Int, this.this$0.jdField_a_of_type_AndroidViewView, (Drawable)localObject);
      return;
    }
  }
}
