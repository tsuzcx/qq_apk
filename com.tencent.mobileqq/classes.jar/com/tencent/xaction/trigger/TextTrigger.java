  ...
  extends BaseTrigger
{
  ...
  {
    Object localObject1 = DecorDrawable.Companion;
    Object localObject2 = getEngine();
    if (localObject2 == null) {
      Intrinsics.throwNpe();
    }
    int i = paramKeyWord.getDrawableId();
    int j = paramKeyWord.getHierarchy();
    IView localIView = getIView();
    if (localIView == null) {
      Intrinsics.throwNpe();
    }
    localObject1 = ((DecorDrawable.Companion)localObject1).a((XAEngine)localObject2, i, j, localIView, true);
    if (localObject1 != null)
    {
      ...
      localObject2 = ((DecorDrawable)localObject2).getTl();
      if (localObject2 == null) {
        Intrinsics.throwNpe();
      }
      ((XATimeline)localObject2).c();
      if (Intrinsics.areEqual(paramString, "$MSG_TEXT"))
      {
        paramString = ((IDrawable)localObject1).a();
        if (paramString == null) {
          Intrinsics.throwNpe();
        }
        paramString = paramString.getTl();
        if (paramString == null) {
          Intrinsics.throwNpe();
        }
        paramString.a();
  ...
  public final boolean sendText(@NotNull String paramString1, @NotNull String paramString2)
  {
    ...
    if ((getIView() == null) || (getEngine() == null)) {
      return false;
    }
