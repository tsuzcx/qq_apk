...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/xaction/rule/LastMsgRule;", "Lcom/tencent/xaction/api/base/BaseRule;", "()V", "ruleAnimParse", "", "anim", "Lcom/tencent/xaction/api/base/BaseAnim;", "key", "", "value", "ruleParse", "viewData", "Lcom/tencent/xaction/api/data/ViewData;", "XActionCore_release"}, k=1, mv={1, 1, 16})
@Keep
  ...
  extends BaseRule
{
  public boolean ruleAnimParse(@NotNull BaseAnim paramBaseAnim, @NotNull String paramString1, @NotNull String paramString2)
  {
    ...
    if (Intrinsics.areEqual(paramString2, "$LAST_MSG"))
    {
      ...
      double d2 = 800;
      Double.isNaN(d2);
      setAnimValue(paramBaseAnim, paramString1, new float[] { (float)(d1 * d2), 600.0F });
      return true;
    }
    return false;
  }
