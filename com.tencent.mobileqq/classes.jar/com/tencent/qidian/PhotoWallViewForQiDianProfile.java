  ...
  extends LinearLayout
{
  ...
  private AdapterView.OnItemClickListener jdField_a_of_type_ComTencentWidgetAdapterView$OnItemClickListener = new akvv(this);
  public GridView a;
  public List a;
  public int b;
  private View b;
  ...
  public void a(Context paramContext, List paramList)
  {
    ...
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130969185, this, true);
    ...
    this.c = getResources().getDimensionPixelSize(2131559173);
    this.jdField_a_of_type_Int = getResources().getDimensionPixelSize(2131559171);
    this.jdField_b_of_type_Int = getResources().getDimensionPixelSize(2131559172);
    if (VersionUtils.c()) {
