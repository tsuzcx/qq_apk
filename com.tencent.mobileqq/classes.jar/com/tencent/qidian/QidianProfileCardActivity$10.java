  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      this.this$0.a.put(this.jdField_a_of_type_ComTencentQidianQidianProfileCardActivity$QidianCompoundProfileItem.jdField_a_of_type_JavaLangString, new bcql(this.jdField_a_of_type_ComTencentImageURLImageView, this.jdField_a_of_type_ComTencentQidianQidianProfileCardActivity$QidianCompoundProfileItem.jdField_a_of_type_Int, str));
