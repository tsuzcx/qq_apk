  ...
  extends BigDataHandler
{
  ...
  {
    Object localObject1 = this.b.getCurrentAccountUin();
    try
    {
      ...
      for (int i = 0;; i = paramPubAccountNavigationMenu.version)
      {
        ...
        ((subcmd0x519.CRMMsgHead)localObject1).uint32_ver_no.set(LoginUtils.a("7.6.0"));
  ...
  private void a(EntityManager paramEntityManager)
  {
    ...
    {
      paramEntityManager = paramEntityManager.a(PubAccountNavigationMenu.class);
      if (paramEntityManager != null)
      {
  ...
  private void a(PubAccountNavigationMenu paramPubAccountNavigationMenu)
  {
    ...
    ThreadManager.post(new akxy(this, paramPubAccountNavigationMenu), 5, null, true);
  }
  ...
  private void b()
  {
    ...
    localEntityManager = this.b.getEntityManagerFactory().createEntityManager();
    try
    {
  ...
  public void a(long paramLong)
  {
    if (!jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())
    {
      Object localObject = this.b.getEntityManagerFactory().createEntityManager();
      if (localObject != null)
      {
        localObject = (PubAccountNavigationMenu)((EntityManager)localObject).a(PubAccountNavigationMenu.class, new String[] { String.valueOf(paramLong) });
        if (localObject != null) {
  ...
  public void a(String paramString, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramString)
      {
        ...
        continue;
        ThreadManager.post(new akxx(this, l, paramLong), 8, null, true);
        continue;
      }
      if (QLog.isColorLevel()) {
