  ...
  extends BusinessHandler
{
  ...
  protected BigDataHandler(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_ComTencentQidianControllerQidianBusinessObserver = new akxt(this);
    ...
    else
    {
      ...
      try
      {
        ...
        while (i < "7.6.0".length())
        {
          ??? = paramMessageMicro;
          if ("7.6.0".charAt(i) != '.') {
            ??? = paramMessageMicro.concat(Character.toString("7.6.0".charAt(i)));
          }
          i += 1;
      ...
      try
      {
        ...
        ((HttpNetReq)localObject2).jdField_a_of_type_ComTencentMobileqqTransfileINetEngine$INetEngineListener = new akxu(paramInt1, this, this.jdField_a_of_type_ComTencentQidianControllerBigDataGetIpHandler.a(), paramInt2, paramObject);
