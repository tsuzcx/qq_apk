  ...
  extends MessageMicro<VerifyWpaUinAndKeyReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 34, 40, 48 }, new String[] { "uint64_dst_uin", "str_key", "str_json_info", "str_rkey", "uint32_terminal_type", "uint32_terminal_version" }, new Object[] { Long.valueOf(0L), "", "", "", localInteger, localInteger }, VerifyWpaUinAndKeyReq.class);
  }
}
