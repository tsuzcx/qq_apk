  ...
  extends MessageMicro<GetNavigationMenuConfigReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 48 }, new String[] { "uint64_puin", "uint64_uin", "uint32_ver_no", "uint32_unread_msg_count", "uint32_is_click_graytip", "uint32_is_support_cc_nav" }, new Object[] { localLong, localLong, localInteger, localInteger, localInteger, localInteger }, GetNavigationMenuConfigReqBody.class);
  }
}
