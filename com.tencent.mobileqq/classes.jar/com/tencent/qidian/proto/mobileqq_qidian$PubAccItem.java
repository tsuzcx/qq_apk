  ...
  extends MessageMicro<PubAccItem>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 34, 42, 50, 56, 64, 72, 82, 90, 98 }, new String[] { "uint32_type", "str_uin", "uint32_verity", "str_name", "str_desc", "str_verify_data", "uint64_state", "uint32_grade", "uint64_display", "str_extra", "str_face_url", "str_qr_url" }, new Object[] { localInteger, "", localInteger, "", "", "", localLong, localInteger, localLong, "", "", "" }, PubAccItem.class);
  }
}
