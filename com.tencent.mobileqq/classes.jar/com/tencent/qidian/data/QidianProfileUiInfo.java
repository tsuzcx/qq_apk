  ...
  extends aukm
{
  ...
  public List<bdvd> mConfigGroupInfos;
  @auma
  public String uin = "";
  ...
  private void initList()
  {
    ...
    try
    {
      Object localObject1 = (bdto)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(165);
      if (this.infoByte != null)
      {
        if (((bdto)localObject1).c(this.uin, true)) {
          break label164;
        }
        ...
        if (((mobileqq_qidian.GetUserDetailInfoRspBody)localObject1).rpt_msg_config_group_info.has())
        {
          ...
          if ((localObject3 != null) && (((List)localObject3).size() > 0))
          {
            ...
            {
              localObject3 = new bdvd((mobileqq_qidian.ConfigGroupInfo)((Iterator)localObject1).next());
    ...
    for (;;)
    {
      ...
      if (((mobileqq_qidian.GetCorpUinDetailInfoRspBody)localObject2).rpt_msg_config_group_info.has())
      {
        ...
        if ((localObject3 != null) && (((List)localObject3).size() > 0))
        {
          ...
          {
            localObject3 = new bdvd((mobileqq_qidian.ConfigGroupInfo)((Iterator)localObject2).next());
            this.mConfigGroupInfos.add(localObject3);
          }
        }
      }
  ...
  public List<bdvd> getConfigGroupInfos()
  {
