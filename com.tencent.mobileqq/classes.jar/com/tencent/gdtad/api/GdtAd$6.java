  ...
  implements GdtAdLoader.Listener
{
  ...
  {
    if ((paramGdtAdLoader == GdtAd.access$100(this.a)) && (this.a.isValid()) && (this.a.getParams().a != null))
    {
      ...
      else
      {
        ...
        if (j != 0) {
          ...
          paramGdtAdLoader = new com.tencent.gdtad.aditem.GdtAd((qq_ad_get.QQAdGetRsp.AdInfo)((qq_ad_get.QQAdGetRsp.PosAdInfo)paramGdtAdLoader.a().b.pos_ads_info.get(0)).ads_info.get(0));
        }
      }
      int i = this.a.getErrorCode(paramGdtAdLoader, i, k, j);
      localGdtAdError = new GdtAdError(i);
      GdtLog.b("GdtAd", localGdtAdError.b());
      if (i == 0)
      {
        GdtAd.access$202(this.a, 2);
        this.a.getParams().b.a = paramGdtAdLoader;
