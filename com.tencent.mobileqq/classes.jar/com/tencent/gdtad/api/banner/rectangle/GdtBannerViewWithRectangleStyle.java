...
public final class GdtBannerViewWithRectangleStyle
  ...
  implements acli
{
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new aclr(this);
  ...
  public GdtBannerViewWithRectangleStyle(Context paramContext, GdtHandler.Params paramParams)
  {
    ...
    {
      acqy.d("GdtBannerContainerView", "constructor");
      return;
    }
    ...
    this.jdField_a_of_type_ComTencentImageURLImageView.setId(2131367372);
    ...
    paramParams = new GradientDrawable();
    paramParams.setShape(0);
    paramParams.setCornerRadius(acsj.a(14.0F, getResources()));
    paramParams.setColor(Color.parseColor("#00CAFC"));
    Object localObject1 = new RelativeLayout.LayoutParams(acsj.a(58.0F, getResources()), acsj.a(29.0F, getResources()));
    ((RelativeLayout.LayoutParams)localObject1).rightMargin = acsj.a(12.0F, getResources());
    ((RelativeLayout.LayoutParams)localObject1).addRule(15);
    ((RelativeLayout.LayoutParams)localObject1).addRule(11);
    this.jdField_a_of_type_AndroidWidgetTextView = new TextView(paramContext);
    this.jdField_a_of_type_AndroidWidgetTextView.setId(2131367371);
    ...
    ((RelativeLayout.LayoutParams)localObject1).leftMargin = acsj.a(12.0F, getResources());
    ((RelativeLayout.LayoutParams)localObject1).rightMargin = acsj.a(12.0F, getResources());
    ((RelativeLayout.LayoutParams)localObject1).addRule(1, 2131367372);
    ((RelativeLayout.LayoutParams)localObject1).addRule(0, 2131367371);
    ((RelativeLayout.LayoutParams)localObject1).addRule(15);
    ...
    for (;;)
    {
      ...
      addView((View)localObject1, new FrameLayout.LayoutParams(acsj.a(36.0F, getResources()), acsj.a(22.0F, getResources())));
      paramParams = new LinearLayout(paramContext);
      localObject2 = new GradientDrawable();
      ((GradientDrawable)localObject2).setShape(0);
      ((GradientDrawable)localObject2).setCornerRadii(new float[] { 0.0F, 0.0F, 0.0F, 0.0F, acsj.a(4.0F, getResources()), acsj.a(4.0F, getResources()), 0.0F, 0.0F });
      ((GradientDrawable)localObject2).setColor(Color.argb(127, 0, 0, 0));
      FrameLayout.LayoutParams localLayoutParams = new FrameLayout.LayoutParams(-1, acsj.a(14.0F, getResources()));
      ...
      new LinearLayout.LayoutParams(acsj.a(8.0F, getResources()), acsj.a(8.0F, getResources())).leftMargin = acsj.a(2.0F, getResources());
      new ImageView(paramContext).setImageResource(2130840199);
      paramContext = new GradientDrawable();
      paramContext.setShape(0);
      paramContext.setStroke(1, Color.parseColor("#EBEDF5"));
      paramContext.setCornerRadius(acsj.a(6.0F, getResources()));
      paramContext.setColor(-1);
      paramParams = new RelativeLayout.LayoutParams(acsj.a(88.0F, getResources()), acsj.a(34.0F, getResources()));
      paramParams.leftMargin = acsj.a(3.0F, getResources());
      paramParams.topMargin = acsj.a(18.0F, getResources());
      ...
      if (Build.VERSION.SDK_INT > 22) {
        ViewCompat.setElevation(this.b, acsj.a(5.0F, getResources()));
      }
      ...
      if (a().getCreativeSize() == 194)
      {
        ...
        localObject1 = new LinearLayout.LayoutParams(-1, -2);
        ((LinearLayout.LayoutParams)localObject1).topMargin = acsj.a(8.0F, getResources());
        localObject2 = new TextView(paramContext);
  ...
  public void setSize(int paramInt1, int paramInt2)
  {
    if (!a())
    {
      acqy.d("GdtBannerContainerView", "setSize error");
      return;
    }
