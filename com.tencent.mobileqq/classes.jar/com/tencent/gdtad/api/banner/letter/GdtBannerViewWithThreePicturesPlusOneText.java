  ...
  implements GdtBannerView
{
  ...
  public GdtBannerViewWithThreePicturesPlusOneText(Context paramContext, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, String paramString4)
  {
    ...
    this.jdField_b_of_type_ComTencentGdtadApiBannerLetterGdtBannerImageView.setId(2131367787);
  ...
  public void setSize(int paramInt1, int paramInt2)
  {
    ...
    paramInt2 = Double.valueOf((paramInt1 - localParams.jdField_a_of_type_Int * 2) * 1.0D / 3.0D).intValue();
    int i = Double.valueOf((paramInt2 - localParams.jdField_b_of_type_Int * 2) * 1.0D / this.jdField_a_of_type_Int * this.jdField_b_of_type_Int + localParams.jdField_b_of_type_Int * 2).intValue();
