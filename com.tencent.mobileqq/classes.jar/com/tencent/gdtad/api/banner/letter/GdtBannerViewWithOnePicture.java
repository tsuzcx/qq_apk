  ...
  implements GdtBannerView
{
  ...
  public void setSize(int paramInt1, int paramInt2)
  {
    ...
    paramInt2 = Double.valueOf(1.0D * (paramInt1 - ((GdtBannerViewWithLetterStyle.Params)localObject).b * 2) / this.jdField_a_of_type_Int * this.b + ((GdtBannerViewWithLetterStyle.Params)localObject).b * 2).intValue();
