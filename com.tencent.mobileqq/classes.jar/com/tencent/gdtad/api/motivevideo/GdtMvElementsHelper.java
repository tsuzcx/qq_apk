...
public class GdtMvElementsHelper
{
  ...
  private URLDrawable a(Context paramContext, String paramString)
  {
    ...
    localURLDrawableOptions.mLoadingDrawable = paramContext.getDrawable(2130845777);
    localURLDrawableOptions.mFailedDrawable = paramContext.getDrawable(2130845777);
    paramString = URLDrawable.getDrawable(paramString, localURLDrawableOptions);
    int i = AIOUtils.a(50.0F, paramContext);
    paramString.setTag(URLDrawableDecodeHandler.b(i, i, AIOUtils.a(12.0F, paramContext)));
    paramString.setDecodeHandler(URLDrawableDecodeHandler.c);
    return paramString;
  }
  
  private boolean a(GdtMotiveVideoModel paramGdtMotiveVideoModel)
  {
  ...
  public Drawable a(Context paramContext, GdtMotiveVideoPageData paramGdtMotiveVideoPageData)
  {
    if ((paramGdtMotiveVideoPageData == null) || (TextUtils.isEmpty(paramGdtMotiveVideoPageData.bannerLogo))) {
      return paramContext.getResources().getDrawable(2130845777);
    }
  ...
  public String a(Context paramContext, GdtMotiveVideoModel paramGdtMotiveVideoModel)
  {
    String str2 = HardCodeUtil.a(2131705223);
    GdtMotiveVideoPageData localGdtMotiveVideoPageData = paramGdtMotiveVideoModel.a();
    Object localObject = paramGdtMotiveVideoModel.a();
    String str1 = str2;
    if (localObject != null)
    {
      str1 = str2;
      if (!((qq_ad_get.QQAdGetRsp.AdInfo)localObject).display_info.button_info.get().isEmpty())
      {
        ...
        {
          str1 = str2;
          if (NativeAdUtils.a(paramContext, (String)localObject))
          {
 ...
 * Qualified Name:     com.tencent.gdtad.api.motivevideo.GdtMvElementsHelper
