...
class GdtMvDownloadBtnPresenter
{
  ...
  public GdtMvDownloadBtnPresenter(String paramString, GdtMvAppBtnView paramGdtMvAppBtnView1, GdtMvAppBtnView paramGdtMvAppBtnView2, GdtMvDownloadBtnManager paramGdtMvDownloadBtnManager)
  {
    this.jdField_a_of_type_Boolean = false;
    GdtLog.a("GdtMvDownloadBtnPresenter", "GdtMvDownloadBtnPresenter: ");
  ...
  private void g(GdtMvAppBtnData paramGdtMvAppBtnData)
  {
    ...
    localBundle.putString(DownloadConstants.l, paramGdtMvAppBtnData);
  ...
  private void h(GdtMvAppBtnData paramGdtMvAppBtnData)
  {
    ...
    GdtLog.b("GdtMvDownloadBtnPresenter", "pauseDownloadUi " + paramGdtMvAppBtnData.packageName);
    this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setDownloadingUI(HardCodeUtil.a(2131705215));
    this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setDownloadingUI(HardCodeUtil.a(2131705212));
    ...
    DownloadManagerV2.a().a(paramGdtMvAppBtnData.apkUrlhttp);
  }
  ...
  private void j(GdtMvAppBtnData paramGdtMvAppBtnData)
  {
    ...
    this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setText(HardCodeUtil.a(2131705216));
    this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.a();
    this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setText(HardCodeUtil.a(2131705204));
  ...
  public void a(GdtMvAppBtnData paramGdtMvAppBtnData)
  {
    ...
    this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.a();
    this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setText(HardCodeUtil.a(2131705203));
    this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.a();
    this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setText(HardCodeUtil.a(2131705214));
  ...
  public void a(GdtMvAppBtnData paramGdtMvAppBtnData, int paramInt)
  {
    ...
    {
      GdtLog.d("GdtMvDownloadBtnPresenter", "updatUIByClick mGdtAppDownloadManager == null");
      return;
    }
    if (paramGdtMvAppBtnData == null)
    {
      GdtLog.d("GdtMvDownloadBtnPresenter", "updatUIByClick cGdtMvAppBtnData == null");
      if (this.jdField_a_of_type_Boolean)
      {
        this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setDownloadingUI(HardCodeUtil.a(2131705213));
        this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setProgress(0);
        this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setDownloadingUI(HardCodeUtil.a(2131705201));
  ...
  void b(GdtMvAppBtnData paramGdtMvAppBtnData)
  {
    if (Looper.myLooper() != Looper.getMainLooper()) {
    ...
    this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.a();
    this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setText(HardCodeUtil.a(2131705202));
    this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.a();
    this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setText(HardCodeUtil.a(2131705210));
    paramGdtMvAppBtnData.cState = 1;
  }
  
  public void b(GdtMvAppBtnData paramGdtMvAppBtnData, int paramInt)
  {
    GdtLog.b("GdtMvDownloadBtnPresenter", "updateBtnProgressUI " + paramInt);
    if (Looper.myLooper() != Looper.getMainLooper()) {}
    do
    {
  ...
  void c(GdtMvAppBtnData paramGdtMvAppBtnData)
  {
    if (Looper.myLooper() != Looper.getMainLooper()) {
  ...
  void c(DownloadInfo paramDownloadInfo, GdtMvAppBtnData paramGdtMvAppBtnData)
  {
    if (a(paramDownloadInfo, paramGdtMvAppBtnData)) {
      c(paramGdtMvAppBtnData);
    }
    ...
    do
    {
      do
      {
        do
        {
          ...
          {
            this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.a();
            this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setText(HardCodeUtil.a(2131705206));
          }
        } while (this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView == null);
        this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.a();
        this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setText(HardCodeUtil.a(2131705205));
        return;
        ...
        if (this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView != null)
        {
          ...
          this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setDownloadingUI(HardCodeUtil.a(2131705207));
        }
      } while (this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView == null);
      this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setProgress(paramGdtMvAppBtnData.cProgerss);
      this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setDownloadingUI(HardCodeUtil.a(2131705211));
      return;
      if ((paramGdtMvAppBtnData.cProgerss == 100) && (this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView != null))
      {
        this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.a();
        this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setText(HardCodeUtil.a(2131705208));
      }
    } while ((paramGdtMvAppBtnData.cProgerss != 100) || (this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView == null));
    this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.a();
    this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView.setText(HardCodeUtil.a(2131705209));
  }
  
  void d(DownloadInfo paramDownloadInfo, GdtMvAppBtnData paramGdtMvAppBtnData)
  {
    if (a(paramDownloadInfo, paramGdtMvAppBtnData)) {
  ...
  void e(DownloadInfo paramDownloadInfo, GdtMvAppBtnData paramGdtMvAppBtnData)
  {
    GdtLog.a("GdtMvDownloadBtnPresenter", "onDownloadUpdate: ");
 ...
 * Qualified Name:     com.tencent.gdtad.api.motivevideo.GdtMvDownloadBtnPresenter
