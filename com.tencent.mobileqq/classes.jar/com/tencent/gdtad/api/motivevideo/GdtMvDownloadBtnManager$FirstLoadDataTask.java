  ...
  implements Runnable
{
  ...
  {
    yny.a("FirstLoadDataTask", "postResultToUI() called with: tempAppBtnData = [" + paramGdtMvAppBtnData + "]");
    new Handler(Looper.getMainLooper()).post(new GdtMvDownloadBtnManager.FirstLoadDataTask.1(this, paramGdtMvAppBtnData));
  }
  
  public void run()
  {
    yny.a("FirstLoadDataTask", "run() called");
    ...
    GdtMvAppBtnData localGdtMvAppBtnData = new ylz().a(GdtMvDownloadBtnManager.a(localGdtMvDownloadBtnManager).getUrlForClick(), "&gd=1", 1);
    ...
    yny.b("FirstLoadDataTask", "load gdt mv app btn data error");
  }
}
