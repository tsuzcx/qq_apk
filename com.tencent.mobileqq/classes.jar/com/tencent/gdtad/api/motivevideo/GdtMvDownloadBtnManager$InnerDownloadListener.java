...
class GdtMvDownloadBtnManager$InnerDownloadListener
  implements DownloadListener
{
  private WeakReference<GdtMvDownloadBtnManager> a;
  
  GdtMvDownloadBtnManager$InnerDownloadListener(GdtMvDownloadBtnManager paramGdtMvDownloadBtnManager)
  {
  ...
  {
    GdtLog.a("GdtMvDownloadBtnManager", "onDownloadCancel: ");
    GdtMvDownloadBtnManager localGdtMvDownloadBtnManager = (GdtMvDownloadBtnManager)this.a.get();
    if (localGdtMvDownloadBtnManager != null) {
  ...
  {
    GdtLog.a("GdtMvDownloadBtnManager", "onDownloadFinish: ");
    GdtMvDownloadBtnManager localGdtMvDownloadBtnManager = (GdtMvDownloadBtnManager)this.a.get();
    if (localGdtMvDownloadBtnManager != null) {
  ...
  {
    GdtLog.a("GdtMvDownloadBtnManager", "onDownloadPause: ");
    GdtMvDownloadBtnManager localGdtMvDownloadBtnManager = (GdtMvDownloadBtnManager)this.a.get();
    if (localGdtMvDownloadBtnManager != null) {
  ...
  {
    GdtLog.a("GdtMvDownloadBtnManager", "onDownloadWait: ");
    GdtMvDownloadBtnManager localGdtMvDownloadBtnManager = (GdtMvDownloadBtnManager)this.a.get();
    if (localGdtMvDownloadBtnManager != null) {
 ...
 * Qualified Name:     com.tencent.gdtad.api.motivevideo.GdtMvDownloadBtnManager.InnerDownloadListener
