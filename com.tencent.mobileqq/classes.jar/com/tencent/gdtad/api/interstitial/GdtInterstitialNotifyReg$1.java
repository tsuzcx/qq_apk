...
public final class GdtInterstitialNotifyReg$1
  implements Runnable
{
  public GdtInterstitialNotifyReg$1(WeakReference paramWeakReference, GdtInterstitialParams paramGdtInterstitialParams) {}
  ...
  public void run()
  {
    try
    {
      ...
      if ((this.jdField_a_of_type_ComTencentGdtadApiInterstitialGdtInterstitialParams != null) && (this.jdField_a_of_type_ComTencentGdtadApiInterstitialGdtInterstitialParams.a != null))
      {
        ...
        AdReporterForAnalysis.reportForARKSendNotification(localContext, true, "interstitial_view_resume_event", str, localGdtAd);
        return;
      }
    }
