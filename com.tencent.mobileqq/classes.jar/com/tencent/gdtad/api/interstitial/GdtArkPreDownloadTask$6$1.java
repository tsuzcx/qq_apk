  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    try
    {
      Object localObject = AdJSON.fromObject(this.jdField_a_of_type_ComTencentArkOpenArkAppMgr$AppPathInfo);
    }
    ...
    if (k == 0)
    {
      localAppPathInfo = this.jdField_a_of_type_ComTencentArkOpenArkAppMgr$AppPathInfo;
      i = j;
      if (localAppPathInfo != null)
      {
        i = j;
        ...
        {
          i = j;
          if (!TextUtils.isEmpty(GdtArkPreDownloadTask.a(this.jdField_a_of_type_ComTencentGdtadApiInterstitialGdtArkPreDownloadTask$6.a))) {
            i = 1;
          }
        }
      }
