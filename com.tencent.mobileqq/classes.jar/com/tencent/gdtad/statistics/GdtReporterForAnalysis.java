...
public final class GdtReporterForAnalysis
{
  ...
  {
    paramContext = BaseApplicationImpl.getContext();
    paramGdtC2SReportInterface = a(paramContext, 1056, new GdtAd(paramGdtC2SReportInterface.jdField_a_of_type_TencentGdtQq_ad_get$QQAdGetRsp$AdInfo), paramGdtC2SReportInterface.jdField_a_of_type_Int, paramGdtC2SReportInterface.jdField_b_of_type_Int, paramString);
  ...
  {
    paramContext = BaseApplicationImpl.getContext();
    paramGdtC2SReportInterface = a(paramContext, 1060, new GdtAd(paramGdtC2SReportInterface.jdField_a_of_type_TencentGdtQq_ad_get$QQAdGetRsp$AdInfo), paramGdtC2SReportInterface.jdField_a_of_type_Int, paramGdtC2SReportInterface.jdField_b_of_type_Int, paramString);
    ...
    for (;;)
    {
      AdAnalysis.INSTANCE.handleAsync(new WeakReference(paramContext), new AdAnalysisEvent(paramGdtC2SReportInterface, 102));
      return;
      if (paramGdtC2SReportInterface.httpErrorCode == -1) {
  ...
  {
    paramContext = BaseApplicationImpl.getContext();
    paramGdtC2SReportInterface = a(paramContext, 1057, new GdtAd(paramGdtC2SReportInterface.jdField_a_of_type_TencentGdtQq_ad_get$QQAdGetRsp$AdInfo), paramGdtC2SReportInterface.jdField_a_of_type_Int, paramGdtC2SReportInterface.jdField_b_of_type_Int, paramString);
    paramGdtC2SReportInterface.httpErrorCode = paramInt;
    if (paramGdtC2SReportInterface.httpErrorCode == 200) {
      paramGdtC2SReportInterface.internalErrorCode = 0;
    }
