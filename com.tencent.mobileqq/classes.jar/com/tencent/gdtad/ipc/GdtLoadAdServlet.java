    ...
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      try
      {
        ...
        if ((paramFromServiceMsg != null) && (paramFromServiceMsg != JSONObject.NULL))
        {
          ...
          notifyObserver(paramIntent, 1, true, (Bundle)localObject, GdtSSoLoadBusinessObserver.class);
          return;
        }
        notifyObserver(paramIntent, 1, false, null, GdtSSoLoadBusinessObserver.class);
        return;
      }
 ...
 * Qualified Name:     com.tencent.gdtad.ipc.GdtLoadAdServlet
