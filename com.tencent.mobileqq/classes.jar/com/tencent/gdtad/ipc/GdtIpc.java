...
public class GdtIpc
  extends QIPCModule
{
  private static volatile GdtIpc a;
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if ("do_app_jump".equals(paramString))
    {
      ...
      {
        paramString = (GdtAdHandler)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getBusinessHandler(BusinessHandlerFactory.GDT_AD_HANDLER);
