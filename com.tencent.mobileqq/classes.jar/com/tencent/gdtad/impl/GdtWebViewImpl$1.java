  ...
  extends GdtWebViewBuilder
{
  ...
  {
    IGdtWebViewListener localIGdtWebViewListener = this.jdField_a_of_type_ComTencentGdtadInjectIGdtWebViewListener;
    if (localIGdtWebViewListener != null) {
      localIGdtWebViewListener.a(paramWebView, paramString);
    }
