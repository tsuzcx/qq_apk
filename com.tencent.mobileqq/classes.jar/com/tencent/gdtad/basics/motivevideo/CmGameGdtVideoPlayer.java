...
public class CmGameGdtVideoPlayer
  implements ICmGameVideoPlayer, ISuperPlayer.OnCompletionListener, ISuperPlayer.OnErrorListener, ISuperPlayer.OnInfoListener, ISuperPlayer.OnVideoPreparedListener
{
  ...
  private Runnable mCountRun = new CmGameGdtVideoPlayer.1(this);
  ...
  public View getVideoContainer()
  {
    if ((this.mPlayerVideoView == null) || (this.mPlayer == null)) {
      try
      {
        ...
        this.mPlayer = SuperPlayerFactory.createMediaPlayer(BaseApplication.getContext(), 110, this.mPlayerVideoView);
        this.mPlayer.setOnCompletionListener(this);
        this.mPlayer.setOnVideoPreparedListener(this);
        this.mPlayer.setOnErrorListener(this);
        this.mPlayer.setOnInfoListener(this);
        this.mStatus = 1;
        this.mPlayerVideoView.addViewCallBack(new CmGameGdtVideoPlayer.2(this));
      }
  ...
  public boolean onError(ISuperPlayer paramISuperPlayer, int paramInt1, int paramInt2, int paramInt3, String paramString)
  {
    ...
    QLog.i("CmGameGdtVideoPlayer", 1, paramISuperPlayer.toString());
    paramISuperPlayer = this.mIVideoCallback.iterator();
    while (paramISuperPlayer.hasNext())
    {
      ICmGameVideoCallback localICmGameVideoCallback = (ICmGameVideoCallback)paramISuperPlayer.next();
  ...
  public void seekTo(int paramInt)
  {
    if (this.mPlayer != null)
    {
      ...
      QLog.i("CmGameGdtVideoPlayer", 1, localStringBuilder.toString());
  ...
  public void startPlay(String paramString1, String paramString2, int paramInt)
  {
    if (this.mPlayer != null)
    {
      ...
      QLog.i("CmGameGdtVideoPlayer", 1, paramString2.toString());
      paramString1 = SuperPlayerFactory.createVideoInfoForUrl(paramString1, 104, null);
      this.mPlayer.openMediaPlayer(BaseApplication.getContext(), paramString1, paramInt);
    }
  }
 ...
 * Qualified Name:     com.tencent.gdtad.basics.motivevideo.CmGameGdtVideoPlayer
