...
public final class GdtLandingPageConfig
{
  ...
  private AdSettingsUtil.a jdField_a_of_type_ComTencentAdTangramSettingsAdSettingsUtil$a = new GdtLandingPageConfig.AddSettingListener(this, null);
  ...
  {
    GdtLog.a("GdtLandingPageConfig", "loadLandingPageReportJsAsync isLoaded ==" + this.b);
    if (this.b) {
      return;
    }
  ...
  private void b(WeakReference<Context> paramWeakReference)
  {
    ...
    {
      return;
      GdtLog.d("GdtLandingPageConfig", "isSupportNewLandingPageReport ==" + a(paramWeakReference));
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject))
        {
          ...
          try
          {
            ...
            if (((HttpResponse)localObject).getStatusLine().getStatusCode() == 200)
            {
              ...
              GdtLog.a("GdtLandingPageConfig", "load resultStr =" + (String)localObject);
          ...
          catch (Exception paramWeakReference)
          {
            ...
            GdtLog.a("GdtLandingPageConfig", "writeFileException" + paramWeakReference.getMessage());
          }
        }
      }
    }
  ...
  public String a(Context paramContext)
  {
    ...
    do
    {
      ...
      GdtLog.a("GdtLandingPageConfig", "sharedPreferences result ==" + paramContext);
