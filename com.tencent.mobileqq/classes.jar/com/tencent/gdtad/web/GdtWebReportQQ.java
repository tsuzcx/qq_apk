  ...
  implements GdtWebReportInterface
{
  ...
  private void a(GdtAd paramGdtAd)
  {
    ...
    localParams.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localParams.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(2);
    localParams.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(a());
    localParams.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localParams);
  }
  ...
  private void b(GdtAd paramGdtAd)
  {
    ...
    GdtActionReporter.Params localParams = new GdtActionReporter.Params();
    localParams.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localParams.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(1);
    localParams.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(a());
    localParams.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localParams);
  }
  ...
  private void c(GdtAd paramGdtAd)
  {
    ...
    GdtActionReporter.Params localParams = new GdtActionReporter.Params();
    localParams.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localParams.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(5);
    localParams.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(b());
    localParams.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localParams);
  }
  ...
  private void d(GdtAd paramGdtAd)
  {
    ...
    GdtActionReporter.Params localParams = new GdtActionReporter.Params();
    localParams.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localParams.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(6);
    localParams.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(b());
    localParams.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localParams);
  }
  ...
  private void f(GdtAd paramGdtAd)
  {
    ...
    GdtActionReporter.Params localParams = new GdtActionReporter.Params();
    localParams.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localParams.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(3);
    localParams.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(a());
    localParams.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localParams);
  }
