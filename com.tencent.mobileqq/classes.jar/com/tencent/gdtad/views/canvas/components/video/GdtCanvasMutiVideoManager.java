...
{
  public View a;
  private WeakReference<GdtCanvasVideoListener> jdField_a_of_type_JavaLangRefWeakReference;
  private List<WeakReference<GdtCanvasVideoListener>> jdField_a_of_type_JavaUtilList = new ArrayList();
  
  public GdtCanvasMutiVideoManager()
  {
    this.jdField_a_of_type_AndroidViewView = null;
  }
  
  private int a(WeakReference<GdtCanvasVideoListener> paramWeakReference)
  {
    int j;
  ...
  private boolean b(WeakReference<GdtCanvasVideoListener> paramWeakReference)
  {
    if ((paramWeakReference == null) || (paramWeakReference.get() == null)) {}
  ...
  private boolean c(WeakReference<GdtCanvasVideoListener> paramWeakReference)
  {
    if ((paramWeakReference == null) || (paramWeakReference.get() == null)) {}
    int i;
    do
  ...
  public void a(WeakReference<GdtCanvasVideoListener> paramWeakReference)
  {
  ...
  public boolean a(WeakReference<GdtCanvasVideoListener> paramWeakReference)
  {
    if ((paramWeakReference == null) || (paramWeakReference.get() == null)) {}
    do
    {
