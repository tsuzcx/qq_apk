  ...
  extends GdtCanvasComponentView
{
  ...
  private zaz jdField_a_of_type_Zaz = new yzq(this);
  ...
  public GdtCanvasFixedButtonWithComplexStyle(Context paramContext, GdtCanvasFixedButtonComponentData paramGdtCanvasFixedButtonComponentData, GdtAd paramGdtAd, WeakReference<zad> paramWeakReference)
  {
    super(paramContext);
    View localView = LayoutInflater.from(paramContext).inflate(2131559102, this);
    this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localView.findViewById(2131362678));
    TextView localTextView = (TextView)localView.findViewById(2131362679);
    localTextView.setText(paramGdtAd.getAppName());
    paramGdtAd = (TextView)localView.findViewById(2131362684);
    paramGdtAd.setText(yzb.b(paramGdtCanvasFixedButtonComponentData.fileSize));
    Object localObject = (TextView)localView.findViewById(2131362665);
    ...
    ((RelativeLayout.LayoutParams)localObject).setMargins(((RelativeLayout.LayoutParams)localObject).leftMargin, ((RelativeLayout.LayoutParams)localObject).topMargin, ((RelativeLayout.LayoutParams)localObject).rightMargin + yzb.a(101.0F, BaseApplicationImpl.getContext().getResources()), ((RelativeLayout.LayoutParams)localObject).bottomMargin);
    ...
    paramGdtAd = (RelativeLayout)localView.findViewById(2131365343);
    ...
    paramWeakReference = new RelativeLayout.LayoutParams(yzb.a(81.0F, BaseApplicationImpl.getContext().getResources()), yzb.a(40.0F, BaseApplicationImpl.getContext().getResources()));
    ...
    paramGdtAd.width = yzb.a(56.0F, paramContext.getResources());
    paramGdtAd.height = paramGdtAd.width;
    this.jdField_a_of_type_ComTencentImageURLImageView.setLayoutParams(paramGdtAd);
    this.jdField_a_of_type_Zax = new zax(paramGdtCanvasFixedButtonComponentData.imageUrl, new WeakReference(this.jdField_a_of_type_Zaz));
    this.jdField_a_of_type_Zax.a();
    this.jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable(this.jdField_a_of_type_Zax.a());
  }
