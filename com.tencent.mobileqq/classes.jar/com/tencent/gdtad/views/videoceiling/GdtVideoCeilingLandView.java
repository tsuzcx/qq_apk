  ...
  extends RelativeLayout
{
  ...
  public int a;
  private abuj jdField_a_of_type_Abuj;
  ...
  private boolean a()
  {
    ...
    {
      abrl.b("GdtVideoCeilingLandView", "noCanvasViewScrollY mWebView.getWebScrollY() -> " + this.jdField_a_of_type_ComTencentBizUiTouchWebView.getWebScrollY());
    ...
    do
    {
      ...
      abrl.b("GdtVideoCeilingLandView", "noCanvasViewScrollY mNativeView.getPageViewScrollY() -> " + this.jdField_a_of_type_ComTencentAdTangramCanvasViewsCanvasFrameworkAdCanvasView.getPageViewScrollY());
  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          abrl.b("GdtVideoCeilingLandView", "onInterceptTouchEvent mState " + this.jdField_a_of_type_Int);
          switch (MotionEventCompat.getActionMasked(paramMotionEvent))
          {
          default: 
            return false;
          case 0: 
            abrl.b("GdtVideoCeilingLandView", "onInterceptTouchEvent ACTION_DOWN mBeingDrag " + this.jdField_b_of_type_Boolean);
            this.jdField_b_of_type_Float = paramMotionEvent.getRawX();
            this.jdField_a_of_type_Float = paramMotionEvent.getRawY();
            return false;
          case 2: 
            abrl.b("GdtVideoCeilingLandView", "onInterceptTouchEvent ACTION_MOVE mBeingDrag " + this.jdField_b_of_type_Boolean);
      ...
      if (this.jdField_a_of_type_Int == 0)
      {
        ...
        abrl.b("GdtVideoCeilingLandView", "onInterceptTouchEvent ACTION_MOVE mState -> BOTTOM_WEBVIEW_STATE ");
        return true;
      }
      bool1 = bool3;
    ...
    abrl.b("GdtVideoCeilingLandView", "onInterceptTouchEvent ACTION_MOVE mState -> TOP_WEBVIEW_STATE, result -> " + bool1 + ", noCanvasViewScrollY -> " + a() + ", isScrollUp -> " + a(f3));
    return bool1;
    abrl.b("GdtVideoCeilingLandView", "onInterceptTouchEvent  ACTION_UP");
    ...
    do
    {
      ...
      do
      {
        ...
        if ((this.jdField_d_of_type_Float == 0.0F) || (this.jdField_c_of_type_Float == 0.0F))
        {
          ...
          if (this.jdField_a_of_type_Abuj != null) {
            this.jdField_a_of_type_Abuj.a(this.jdField_a_of_type_Int);
          }
        }
        switch (MotionEventCompat.getActionMasked(paramMotionEvent))
        {
        default: 
          return true;
        case 0: 
          abrl.c("GdtVideoCeilingLandView", "onTouchEvent  ACTION_DOWN");
          return true;
        case 2: 
          abrl.c("GdtVideoCeilingLandView", "onTouchEvent  ACTION_MOVE");
          f1 = paramMotionEvent.getRawX();
      ...
      if (this.jdField_a_of_type_Abuj != null)
      {
        abrl.c("GdtVideoCeilingLandView", "onTouchEvent  onDrag");
        this.jdField_a_of_type_Abuj.b((int)f3);
      }
      this.jdField_d_of_type_Float = f1;
      this.jdField_c_of_type_Float = f2;
      return true;
      abrl.c("GdtVideoCeilingLandView", "onTouchEvent  ACTION_UP");
      this.jdField_d_of_type_Float = 0.0F;
      this.jdField_c_of_type_Float = 0.0F;
      bool1 = bool2;
    } while (this.jdField_a_of_type_Abuj == null);
    this.jdField_a_of_type_Abuj.c(this.jdField_a_of_type_Int);
    this.jdField_b_of_type_Boolean = false;
    return true;
  }
  
  public void setGdtVideoCeilingListeners(abuj paramabuj, TouchWebView paramTouchWebView)
  {
    this.jdField_a_of_type_Abuj = paramabuj;
    this.jdField_a_of_type_ComTencentBizUiTouchWebView = paramTouchWebView;
    this.e = false;
  }
  
  public void setGdtVideoCeilingNativeListeners(abuj paramabuj, AdCanvasView paramAdCanvasView)
  {
    this.jdField_a_of_type_Abuj = paramabuj;
