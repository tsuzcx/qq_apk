  ...
  implements GdtJsCallHandler
{
  ...
  public static GdtMotiveVideoPageData a(qq_ad_get.QQAdGetRsp.AdInfo paramAdInfo, int paramInt)
  {
    ...
    if ((localGdtAd != null) && (localGdtAd.info != null))
    {
      ...
      GdtLog.d("GdtOpenMvPageHandler", "VideoUrl " + localGdtMotiveVideoPageData.url);
      Object localObject1;
  ...
  public void a(GdtMotiveVideoPageData paramGdtMotiveVideoPageData, String paramString1, String paramString2, String paramString3)
  {
    ...
    if (paramGdtMotiveVideoPageData != null)
    {
      ...
      if (str != null)
      {
        ...
        {
          paramGdtMotiveVideoPageData = (GdtAdWebPlugin)this.jdField_a_of_type_JavaLangRefWeakReference.get();
          if (paramGdtMotiveVideoPageData != null)
          {
  ...
  public boolean a(GdtAdWebPlugin paramGdtAdWebPlugin, String paramString, String... paramVarArgs)
  {
    ...
    {
      GdtLog.d("GdtOpenMvPageHandler", "GdtOpenMvPageHandler error");
      return true;
    }
    String str2 = "";
    for (;;)
    {
      try
      {
        GdtLog.a("GdtOpenMvPageHandler", "args = " + paramVarArgs[0]);
      ...
      catch (Throwable localThrowable1)
      {
        try
        {
          ...
          k = i;
          paramVarArgs = (qq_ad_get.QQAdGetRsp.AdInfo)qq_ad_get.QQAdGetRsp.AdInfo.class.cast(GdtJsonPbUtil.a(new qq_ad_get.QQAdGetRsp.AdInfo(), new JSONObject(paramVarArgs)));
        }
        ...
        try
        {
          ...
          if (localGdtMotiveVideoPageData != null)
          {
            ...
            GdtMotiveVideoFragment.b(paramGdtAdWebPlugin.a(), GdtMotiveVideoFragment.class, localGdtMotiveVideoPageData);
          }
          if (paramGdtAdWebPlugin == null) {
            break label377;
          }
          ...
          localObject1 = localObject2;
          if (paramGdtAdWebPlugin != null) {
            localObject1 = paramGdtAdWebPlugin.a();
          }
