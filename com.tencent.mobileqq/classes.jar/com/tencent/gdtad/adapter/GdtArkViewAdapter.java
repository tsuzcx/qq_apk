...
public class GdtArkViewAdapter
  implements AdArkAdapter, ArkAppNotifyCenter.INotifyReg
{
  private View jdField_a_of_type_AndroidViewView;
  private AdArkAdapter.ArkNotifyCallback jdField_a_of_type_ComTencentAdTangramArkAdArkAdapter$ArkNotifyCallback;
  
  private ArkAppContainer a(ArkAppView paramArkAppView, QQCustomArkDialog.AppInfo paramAppInfo)
  {
  ...
  private void a(ArkAppView paramArkAppView, AdArkAdapter.Params paramParams)
  {
    ...
    paramArkAppView.initArkView(a(paramArkAppView, new QQCustomArkDialog.AppInfo(QQCustomArkDialog.AppInfo.a(str1, str2, "0.0.0.1", paramParams.metaData, f, null, null))), false);
  ...
  private void a(ArkAppView paramArkAppView, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    paramArkAppView.initArkView(a(paramArkAppView, new QQCustomArkDialog.AppInfo(QQCustomArkDialog.AppInfo.a(paramString1, paramString2, "0.0.0.1", paramString4, f1, null, null))), false);
    paramArkAppView.setVisibility(0);
  }
  ...
  public View buildArkView(AdArkAdapter.Params paramParams)
  {
    if ((paramParams != null) && (paramParams.isValid()))
    {
      ...
      localArkAppView.setCallback(new GdtArkViewAdapter.1(this, localCallback));
      ...
      if ((paramParams.context.get() instanceof Activity))
      {
        ...
        if (localFrameLayout != null)
        {
          ...
          if (this.jdField_a_of_type_AndroidViewView != null) {
            this.jdField_a_of_type_AndroidViewView.getViewTreeObserver().addOnGlobalLayoutListener(new GdtArkViewAdapter.2(this, localCallback));
          }
        }
      }
      localArkAppView.setInputCallback(new GdtArkViewAdapter.3(this, localCallback));
  ...
  public String getArkFormData(AdArkAdapter.DataParams paramDataParams)
  {
    ...
    try
    {
      ...
      localObject1 = localObject3;
      localObject4 = GdtJsonPbUtil.a((PBField)localObject4);
 ...
 * Qualified Name:     com.tencent.gdtad.adapter.GdtArkViewAdapter
