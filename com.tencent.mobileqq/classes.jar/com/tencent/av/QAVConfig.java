...
public class QAVConfig
{
  ...
  public static String a(ConfigurationService.Config paramConfig, int paramInt1, int paramInt2)
  {
    ...
    while (paramInt1 < paramInt2)
    {
      ...
      else
      {
        ...
        {
          localObject1 = ArConfigUtils.a((byte[])localObject2);
  ...
  public static void b(int paramInt, String paramString, ConfigurationService.Config paramConfig)
  {
    ...
    default: 
      i = -1;
      paramString = HardCodeUtil.a(2131708886);
    }
    for (;;)
    {
      if (QLog.isDevelopLevel()) {
      ...
      if (paramConfig != null)
      {
        ...
        if (paramConfig != null)
        {
          EffectBeautyTools.a(localQQAppInterface.getApplication(), paramConfig, k, true);
          paramString = paramConfig;
          continue;
          i = SharedPreUtils.a(localQQAppInterface.getApplication());
          paramConfig = a(paramConfig, i, paramInt);
          paramString = paramConfig;
          paramInt = i;
          if (paramConfig != null)
          {
            SharedPreUtils.a(localQQAppInterface.getApplication(), k);
            paramString = SharedPreUtils.c(localQQAppInterface.getCurrentAccountUin());
            if (paramString != null) {
