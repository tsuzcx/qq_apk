  ...
  extends ViewGroup
{
  ...
  private final ArrayList<StageEffectView.StageMemberInfo> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private final Comparator<Integer> jdField_a_of_type_JavaUtilComparator = new StageEffectView.1(this);
  public boolean a;
  ...
  private Comparator<StageMemberView> jdField_b_of_type_JavaUtilComparator = new StageEffectView.3(this);
  ...
  static
  {
    ...
    int[] arrayOfInt2 = { 1, 0, 2 };
    int[] arrayOfInt3 = { 3, 1, 0, 2, 4 };
    int[] arrayOfInt4 = { 5, 3, 1, 0, 2, 4, 6 };
    jdField_a_of_type_Array2dOfInt = new int[][] { arrayOfInt1, { 0 }, { 1, 0 }, arrayOfInt2, { 3, 1, 0, 2 }, arrayOfInt3, { 5, 3, 1, 0, 2, 4 }, arrayOfInt4, { 5, 3, 1, 0, 2, 4, 6, 7 } };
  ...
  private int a(String[] paramArrayOfString, int paramInt, int[] paramArrayOfInt)
  {
    ...
    Object localObject;
    int i2;
    StageEffectView.StageMemberInfo localStageMemberInfo;
    if (i1 < paramInt)
    {
      ...
      if (i2 < this.jdField_a_of_type_Int)
      {
        ...
        do
        {
          i2 += 1;
          break;
          localStageMemberInfo = (StageEffectView.StageMemberInfo)this.jdField_a_of_type_ArrayOfComTencentAvWidgetStageviewStageMemberView[i2].getTag();
          localStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$StageMemberInfo = null;
        } while (!((String)localObject).equals(localStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$StageMember.jdField_a_of_type_JavaLangString));
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        {
          if (((String)localObject).equals(((StageEffectView.StageMemberInfo)this.jdField_a_of_type_JavaUtilArrayList.get(i2)).jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$StageMember.jdField_a_of_type_JavaLangString))
          {
          ...
          while (i3 < this.jdField_a_of_type_Int)
          {
            ...
            {
              localStageMemberInfo = (StageEffectView.StageMemberInfo)((StageMemberView)localObject).getTag();
              if ((localStageMemberInfo.jdField_a_of_type_Int == 0) && ((localStageMemberInfo.jdField_a_of_type_Int < 0) || (localStageMemberInfo.jdField_a_of_type_Int >= 10000))) {
                break label425;
              }
            }
          }
          ...
          for (i3 = paramInt;; i3 = paramInt)
          {
            ...
            for (;;)
            {
              if (paramInt < this.jdField_a_of_type_Int)
              {
                ...
                label425:
                i2 = paramInt;
                if (localStageMemberInfo.jdField_a_of_type_Int != jdField_a_of_type_ArrayOfInt[paramArrayOfString[i1]])
                {
                  a((StageMemberView)localObject, localStageMemberInfo, jdField_a_of_type_ArrayOfInt[paramArrayOfString[i1]], -1, 0);
                  i2 = Math.max(paramInt, localStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$Animation.jdField_a_of_type_Int);
                }
                i1 += 1;
                paramInt = i2;
                break;
                ...
                for (;;)
                {
                  ...
                  localStageMemberInfo = (StageEffectView.StageMemberInfo)((StageMemberView)localObject).getTag();
                  i3 = paramInt;
                  if (localStageMemberInfo.jdField_a_of_type_Int != jdField_a_of_type_ArrayOfInt[paramArrayOfString[(i5 - 1 - i2)]])
                  {
                    a((StageMemberView)localObject, localStageMemberInfo, jdField_a_of_type_ArrayOfInt[paramArrayOfString[(i5 - 1 - i2)]], -1, 0);
                    i3 = Math.max(paramInt, localStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$Animation.jdField_a_of_type_Int);
                  }
                  paramInt = i2 + 1;
                  i1 += 1;
                  i2 = i3;
    ...
    for (;;)
    {
      ...
      for (m = 8;; m = n)
      {
        ...
        while (m < this.jdField_a_of_type_Int)
        {
          ...
          localObject2 = (StageEffectView.StageMemberInfo)((StageMemberView)localObject1).getTag();
          float f1 = ((StageEffectView.StageMemberInfo)localObject2).jdField_d_of_type_Float;
          f1 = ((StageEffectView.StageMemberInfo)localObject2).jdField_e_of_type_Float;
          a((StageEffectView.StageMemberInfo)localObject2, (StageMemberView)localObject1, ((StageEffectView.StageMemberInfo)localObject2).jdField_a_of_type_Int + paramInt);
          m += 1;
        }
      }
      if ((n > 8) && (i1 != i2))
      {
        ...
        if (paramInt > 0)
        {
          ...
          for (;;)
          {
            ...
            localObject1 = (StageEffectView.StageMemberInfo)this.jdField_a_of_type_ArrayOfComTencentAvWidgetStageviewStageMemberView[paramInt].getTag();
            if ((((StageEffectView.StageMemberInfo)this.jdField_a_of_type_ArrayOfComTencentAvWidgetStageviewStageMemberView[((paramInt - 1 + 8) % 8)].getTag()).jdField_a_of_type_Int < 10000) && (((StageEffectView.StageMemberInfo)localObject1).jdField_a_of_type_Int >= 10000))
            {
              m = 0;
              while (m < n)
              {
                localObject1 = (StageEffectView.StageMemberInfo)this.jdField_a_of_type_JavaUtilArrayList.remove(0);
                localObject2 = this.jdField_a_of_type_ArrayOfComTencentAvWidgetStageviewStageMemberView[((n - 1 - m + paramInt) % 8)];
                localStageMemberInfo = (StageEffectView.StageMemberInfo)((StageMemberView)localObject2).getTag();
                ((StageEffectView.StageMemberInfo)localObject1).a(localStageMemberInfo);
                ((StageMemberView)localObject2).setTag(localObject1);
                ((StageMemberView)localObject2).setBackgroundDrawable(((StageEffectView.StageMemberInfo)localObject1).jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$StageMember.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
                ((StageMemberView)localObject2).a(((StageEffectView.StageMemberInfo)localObject1).jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$StageMember.b, false);
                a(-1, localStageMemberInfo);
                m += 1;
              }
              break;
            }
          ...
          if (paramInt < 0)
          {
            ...
            for (;;)
            {
              ...
              if ((((StageEffectView.StageMemberInfo)this.jdField_a_of_type_ArrayOfComTencentAvWidgetStageviewStageMemberView[((paramInt + 1 + 8) % 8)].getTag()).jdField_a_of_type_Int > 10000) && (((StageEffectView.StageMemberInfo)localObject1).jdField_a_of_type_Int < 10000))
              {
                ...
                while (m < n)
                {
                  localObject1 = (StageEffectView.StageMemberInfo)this.jdField_a_of_type_JavaUtilArrayList.remove(this.jdField_a_of_type_JavaUtilArrayList.size() - 1);
  ...
  private void a(int paramInt, StageEffectView.StageMemberInfo paramStageMemberInfo)
  {
    paramStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$StageMemberInfo = null;
    paramStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$Animation = null;
    if (paramInt < 0)
    {
      this.jdField_a_of_type_JavaUtilArrayList.add(paramStageMemberInfo);
      return;
    }
    this.jdField_a_of_type_JavaUtilArrayList.add(paramInt, paramStageMemberInfo);
  }
  
  private void a(StageEffectView.StageMemberInfo paramStageMemberInfo, StageMemberView paramStageMemberView)
  {
    StageEffectView.StageMemberInfo localStageMemberInfo = paramStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$StageMemberInfo;
    localStageMemberInfo.a(paramStageMemberInfo);
    paramStageMemberView.setTag(localStageMemberInfo);
    paramStageMemberView.setBackgroundDrawable(localStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$StageMember.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
    paramStageMemberView.a(localStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$StageMember.b, false);
    if (this.jdField_a_of_type_JavaUtilArrayList.remove(localStageMemberInfo)) {
      a(-1, paramStageMemberInfo);
    }
  }
  
  @TargetApi(11)
  private void a(StageEffectView.StageMemberInfo paramStageMemberInfo, StageMemberView paramStageMemberView, int paramInt)
  {
    ...
    for (double d1 = jdField_a_of_type_ArrayOfDouble[(m + 1)] - jdField_a_of_type_ArrayOfDouble[m];; d1 = 6.283185307179586D - jdField_a_of_type_ArrayOfDouble[m])
    {
      ...
      paramStageMemberInfo.jdField_a_of_type_Int = paramInt;
      ...
      paramStageMemberInfo.jdField_a_of_type_Float = this.j;
      paramStageMemberInfo.jdField_b_of_type_Float = this.k;
      paramStageMemberInfo.jdField_c_of_type_Float = this.l;
      paramStageMemberInfo.jdField_a_of_type_AndroidGraphicsMatrix.set(this.jdField_a_of_type_AndroidGraphicsMatrix);
      paramStageMemberInfo.jdField_f_of_type_Float = this.jdField_a_of_type_ArrayOfFloat[0];
      if (this.jdField_i_of_type_Float > 150.0F) {
        paramStageMemberInfo.jdField_f_of_type_Float *= (1.0F - (this.jdField_i_of_type_Float - 150.0F) / 150.0F * 0.4F);
      }
      paramStageMemberInfo.jdField_d_of_type_Float = this.jdField_a_of_type_ArrayOfFloat[2];
      paramStageMemberInfo.jdField_e_of_type_Float = this.jdField_a_of_type_ArrayOfFloat[5];
      a((int)paramStageMemberInfo.jdField_d_of_type_Float, (int)paramStageMemberInfo.jdField_e_of_type_Float, paramStageMemberView);
      if (jdField_b_of_type_Boolean)
      {
        paramStageMemberView.setScaleX(paramStageMemberInfo.jdField_f_of_type_Float);
        paramStageMemberView.setScaleY(paramStageMemberInfo.jdField_f_of_type_Float);
      }
      if ((paramStageMemberInfo.jdField_a_of_type_Int == 0) && (this.jdField_b_of_type_Int == 0))
      {
        paramStageMemberInfo = new int[2];
        paramStageMemberView.getLocationInWindow(paramStageMemberInfo);
        this.jdField_b_of_type_Int = paramStageMemberInfo[1];
      }
      return;
    }
  }
  
  private void a(StageMemberView paramStageMemberView, StageEffectView.StageMemberInfo paramStageMemberInfo, int paramInt1, int paramInt2, int paramInt3)
  {
    if (paramInt3 > 0) {
      paramStageMemberView.setVisibility(4);
    }
    paramStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$Animation = new StageEffectView.Animation(paramStageMemberInfo.jdField_a_of_type_Int, MathUtils.a(paramInt1, 20000), paramInt2, paramInt3, null);
  }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    while (m < this.jdField_a_of_type_Int)
    {
      ...
      localStageMemberView.a(((StageEffectView.StageMemberInfo)localStageMemberView.getTag()).jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$StageMember.b, true);
      m += 1;
    }
  }
  ...
  private boolean a(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidViewAnimationInterpolator = BakedBezierInterpolator.a();
  ...
  private boolean a(StageEffectView.StageMemberInfo paramStageMemberInfo, int paramInt1, boolean paramBoolean1, boolean paramBoolean2, int paramInt2)
  {
    boolean bool = false;
    int m = this.jdField_a_of_type_Int;
    ...
    localStageMemberView.jdField_a_of_type_ComTencentAvWidgetStageviewMemberEffect = paramStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$StageMember.jdField_a_of_type_ComTencentAvWidgetStageviewMemberEffect;
    localStageMemberView.setBackgroundDrawable(paramStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$StageMember.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
    localStageMemberView.layout(-54, -54, 54, 66);
    localStageMemberView.setTag(paramStageMemberInfo);
    if (this.jdField_c_of_type_Boolean) {
      localStageMemberView.a(paramStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$StageMember.b, false);
    }
    a(true);
    ...
    {
      a(paramStageMemberInfo, localStageMemberView, jdField_a_of_type_ArrayOfInt[7]);
      paramInt1 = jdField_a_of_type_ArrayOfInt[m] + paramInt1;
      paramBoolean1 = bool;
      if (paramStageMemberInfo.jdField_a_of_type_Int != paramInt1) {
        a(localStageMemberView, paramStageMemberInfo, paramInt1, -1, paramInt2);
      }
    }
    for (paramBoolean1 = true;; paramBoolean1 = bool)
    {
      ...
      a(paramStageMemberInfo, localStageMemberView, jdField_a_of_type_ArrayOfInt[m]);
      invalidate();
    }
  }
  ...
  void a()
  {
    ...
    if ((this.jdField_d_of_type_Int & 0x10) == 16)
    {
      ...
      if (m < this.jdField_a_of_type_Int)
      {
        ...
        localStageMemberInfo = (StageEffectView.StageMemberInfo)localStageMemberView.getTag();
        i1 = localStageMemberInfo.jdField_a_of_type_Int;
        if (localStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$Animation != null)
        {
          if (localStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$Animation.jdField_a_of_type_ArrayOfInt == null) {
            break label219;
          }
          n = localStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$Animation.jdField_a_of_type_ArrayOfInt[0];
          if (l1 >= localStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$Animation.jdField_a_of_type_Long) {
            break label232;
          }
        }
        for (;;)
        {
          if ((localStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$StageMemberInfo != null) && (((localStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$Animation != null) && (!localStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$Animation.jdField_a_of_type_Boolean) && (i1 < 10000) && (localStageMemberInfo.jdField_a_of_type_Int >= 10000)) || ((localStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$Animation != null) && (localStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$Animation.jdField_a_of_type_Boolean) && (i1 > 10000) && (localStageMemberInfo.jdField_a_of_type_Int <= 10000)) || ((this.jdField_d_of_type_Int == 16) && (localStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$Animation == null)))) {
            a(localStageMemberInfo, localStageMemberView);
          }
          n = 1;
          m += 1;
          break;
          n = localStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$Animation.jdField_a_of_type_Int;
          break label86;
          if (l1 < localStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$Animation.jdField_a_of_type_Long + n)
          {
            localStageMemberView.setVisibility(0);
            f1 = (float)(l1 - localStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$Animation.jdField_a_of_type_Long) / n;
            if (localStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$Animation.jdField_a_of_type_Boolean) {}
            float f2;
            for (n = (int)(localStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$Animation.jdField_b_of_type_Int - this.jdField_a_of_type_AndroidViewAnimationInterpolator.getInterpolation(f1) * localStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$Animation.jdField_d_of_type_Int);; n = (int)(this.jdField_a_of_type_AndroidViewAnimationInterpolator.getInterpolation(f1) * localStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$Animation.jdField_d_of_type_Int + f2))
            {
              i2 = localStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$Animation.jdField_e_of_type_Int;
              localStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$Animation.jdField_e_of_type_Int = n;
              a(localStageMemberInfo, localStageMemberView, localStageMemberInfo.jdField_a_of_type_Int + (n - i2));
              break;
              f2 = localStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$Animation.jdField_b_of_type_Int;
            }
          }
          localStageMemberView.setVisibility(0);
          n = localStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$Animation.jdField_c_of_type_Int;
          i2 = localStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$Animation.jdField_e_of_type_Int;
          localStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$Animation.jdField_e_of_type_Int = localStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$Animation.jdField_c_of_type_Int;
          a(localStageMemberInfo, localStageMemberView, n - i2 + localStageMemberInfo.jdField_a_of_type_Int);
          localStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$Animation = null;
        }
      }
      m = n;
      if (n == 0) {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            ...
            localStageMemberInfo = (StageEffectView.StageMemberInfo)localStageMemberView.getTag();
            m = localStageMemberInfo.jdField_a_of_type_Int;
            a(localStageMemberInfo, localStageMemberView, localStageMemberInfo.jdField_a_of_type_Int + i1);
            if ((localStageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$StageMemberInfo != null) && ((n == 0) || ((this.jdField_f_of_type_Int > 0) && (m < 10000) && (localStageMemberInfo.jdField_a_of_type_Int >= 10000)) || ((this.jdField_f_of_type_Int < 0) && (m > 10000) && (localStageMemberInfo.jdField_a_of_type_Int <= 10000)))) {
              a(localStageMemberInfo, localStageMemberView);
            }
            i2 += 1;
          }
  ...
  public boolean a(String... paramVarArgs)
  {
    ...
    for (int m = 1;; m = 0)
    {
      ...
      while (n < i2)
      {
        a((StageEffectView.StageMemberInfo)this.jdField_a_of_type_JavaUtilArrayList.remove(0), 0, true, true, 0);
        n += 1;
      }
    }
  ...
  {
    StageEffectView.StageMemberInfo localStageMemberInfo = (StageEffectView.StageMemberInfo)paramView.getTag();
    paramTransformation = paramTransformation.getMatrix();
    paramTransformation.postScale(localStageMemberInfo.jdField_f_of_type_Float, localStageMemberInfo.jdField_f_of_type_Float);
    ...
    if (paramBoolean)
    {
      ...
      for (this.jdField_d_of_type_Float = ((paramInt2 - f2 * 444.0F) / 2.0F + 96.770576F * f1);; this.jdField_d_of_type_Float = (getPaddingTop() + 96.770576F * f2))
      {
        ...
        while (paramInt1 < this.jdField_a_of_type_Int)
        {
          ...
          Object localObject = (StageEffectView.StageMemberInfo)localStageMemberView.getTag();
          a((StageEffectView.StageMemberInfo)localObject, localStageMemberView, ((StageEffectView.StageMemberInfo)localObject).jdField_a_of_type_Int);
          if ((((StageEffectView.StageMemberInfo)localObject).jdField_a_of_type_Int == 0) && (this.jdField_b_of_type_Int == 0))
          {
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    case 2: 
      ...
      do
      {
        do
        {
          ...
          do
          {
            ...
            if (((this.jdField_e_of_type_Boolean) || (this.jdField_d_of_type_Int != 0)) && (this.jdField_a_of_type_Int > 0))
            {
              ...
              while (m < this.jdField_a_of_type_Int)
              {
                ((StageEffectView.StageMemberInfo)this.jdField_a_of_type_ArrayOfComTencentAvWidgetStageviewStageMemberView[m].getTag()).jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$StageMemberInfo = null;
                m += 1;
              }
            ...
            for (;;)
            {
              ...
              for (;;)
              {
                ...
                localObject2 = (StageEffectView.StageMemberInfo)((View)localObject1).getTag();
                f3 = ((StageEffectView.StageMemberInfo)localObject2).jdField_f_of_type_Float * 54.0F;
                f4 = ((StageEffectView.StageMemberInfo)localObject2).jdField_e_of_type_Float;
                f5 = ((StageEffectView.StageMemberInfo)localObject2).jdField_e_of_type_Float;
                f6 = ((StageEffectView.StageMemberInfo)localObject2).jdField_d_of_type_Float;
                f7 = ((StageEffectView.StageMemberInfo)localObject2).jdField_d_of_type_Float;
        ...
        f2 = paramMotionEvent.getY();
        paramMotionEvent = (StageEffectView.StageMemberInfo)this.jdField_a_of_type_AndroidViewView.getTag();
    ...
    case 1: 
      ...
      if ((this.jdField_a_of_type_AndroidViewView != null) && (this.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$OnIconClickListener != null))
      {
        ...
        if (paramMotionEvent.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$StageMemberInfo != null)
        {
          paramMotionEvent = paramMotionEvent.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$StageMemberInfo.jdField_a_of_type_ComTencentAvWidgetStageviewStageEffectView$StageMember;
