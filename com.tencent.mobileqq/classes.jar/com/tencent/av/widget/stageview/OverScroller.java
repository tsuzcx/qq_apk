...
public class OverScroller
{
  ...
  private final kis jdField_a_of_type_Kis;
  private final boolean jdField_a_of_type_Boolean;
  private final kis jdField_b_of_type_Kis;
  ...
  public OverScroller(Context paramContext, Interpolator paramInterpolator, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Kis = new kis();
    this.jdField_b_of_type_Kis = new kis();
    kis.a(paramContext);
  }
  ...
  public final int a()
  {
    return kis.a(this.jdField_a_of_type_Kis);
  }
  
  public void a()
  {
    this.jdField_a_of_type_Kis.a();
    this.jdField_b_of_type_Kis.a();
  }
  
  public final void a(float paramFloat)
  {
    this.jdField_a_of_type_Kis.a(paramFloat);
    this.jdField_b_of_type_Kis.a(paramFloat);
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8, int paramInt9, int paramInt10, int paramInt11, int paramInt12)
  {
    ...
    {
      float f1 = kis.a(this.jdField_a_of_type_Kis);
      float f2 = kis.a(this.jdField_b_of_type_Kis);
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Kis.a(paramInt1, paramInt3, paramInt5, paramInt6, paramInt9, paramInt11);
      this.jdField_b_of_type_Kis.a(paramInt2, paramInt4, paramInt7, paramInt8, paramInt10, paramInt12);
      return;
    }
  }
  ...
  {
    return (kis.a(this.jdField_a_of_type_Kis)) && (kis.a(this.jdField_b_of_type_Kis));
  }
  ...
  public boolean b()
  {
    ...
    {
      return true;
      long l = AnimationUtils.currentAnimationTimeMillis() - kis.a(this.jdField_a_of_type_Kis);
      int i = kis.b(this.jdField_a_of_type_Kis);
      if (l < i)
      {
        float f = (float)l / i;
        ...
        {
          if (!kis.a(this.jdField_a_of_type_Kis)) {
            this.jdField_a_of_type_Kis.b(f);
          }
          if (kis.a(this.jdField_b_of_type_Kis)) {
            break;
          }
          this.jdField_b_of_type_Kis.b(f);
          break;
        }
      }
      a();
      continue;
      if ((!kis.a(this.jdField_a_of_type_Kis)) && (!this.jdField_a_of_type_Kis.b()) && (!this.jdField_a_of_type_Kis.a())) {
        this.jdField_a_of_type_Kis.a();
      }
      if ((!kis.a(this.jdField_b_of_type_Kis)) && (!this.jdField_b_of_type_Kis.b()) && (!this.jdField_b_of_type_Kis.a())) {
        this.jdField_b_of_type_Kis.a();
      }
    }
  }
