...
public class DeviceSharpController
{
  ...
  public DeviceSharpController(AbstractNetChannel paramAbstractNetChannel, VideoAppInterface paramVideoAppInterface)
  {
    ...
    this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().registerReceiver(this.jdField_a_of_type_Jjm, paramAbstractNetChannel, "com.tencent.smartdevice.permission.broadcast", null);
  }
