...
public class AVCallCompactHelper
{
    ...
    for (;;)
    {
      ...
      if (c.equals(paramString))
      {
        ...
        if ((j == 1) || (j == 3000))
        {
          ...
          label155:
          paramIntent = SessionMgr.a(i, paramString, new int[0]);
      ...
      do
      {
        for (;;)
        {
          ...
          paramString = SessionMgr.a(i, String.valueOf(l), new int[0]);
      ...
      for (;;)
      {
        paramString = SessionMgr.a(i, (String)localObject2, new int[0]);
        localObject1 = paramString;
        if (localStringBuilder == null) {
          break;
        }
  ...
  public boolean a(BaseActivity paramBaseActivity)
  {
    ...
    SessionInfo localSessionInfo = SessionMgr.a().a();
    if (localSessionInfo != null) {}
    for (Object localObject1 = localSessionInfo.c;; localObject1 = null)
    {
      if (!TextUtils.isEmpty((CharSequence)localObject1)) {}
      for (Intent localIntent = b(localSessionInfo.c);; localIntent = null)
      {
        label74:
        boolean bool1;
        if (localIntent != null)
