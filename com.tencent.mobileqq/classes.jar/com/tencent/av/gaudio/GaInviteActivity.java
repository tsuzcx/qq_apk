  ...
  extends BaseGaInvite
{
  ...
  lfb jdField_a_of_type_Lfb = new lnv(this);
  ...
  public void b()
  {
    if (this.jdField_c_of_type_Boolean) {
      axqy.b(null, "CliOper", "", "", "Multi_call", "Lock_popup_timeout", 0, 0, "", "", "", "");
    }
    for (;;)
    {
      ...
      a(-1041L, 8);
      return;
      axqy.b(null, "CliOper", "", "", "Multi_call", "Multi_call_timeout", 0, 0, "", "", "", "");
    }
  }
  ...
  public void e()
  {
    ...
    lnw locallnw1 = new lnw(this, 0);
    lnw locallnw2 = new lnw(this, 1);
    bbdj.a(this, 230, null, getString(2131695827), 2131720736, 2131695744, locallnw1, locallnw2).show();
  }
  ...
  public void g()
  {
    ...
    if (!this.jdField_d_of_type_Boolean)
    {
      ...
      if (!this.jdField_a_of_type_ComTencentAvVideoController.jdField_e_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_Mue = new mue(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
        localObject = this.jdField_a_of_type_Mue.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin());
        if (localObject == null) {
          break label206;
        }
        this.jdField_c_of_type_Long = bbzh.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, ((ExtensionInfo)localObject).uin, 3, true, null);
        if (this.jdField_c_of_type_Long != 0L) {
          break label214;
        }
        mtq.a().a(l, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 2131230742, -1, null);
      }
    }
    for (;;)
    {
      mtq.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, false, l);
      return;
      label206:
      this.jdField_c_of_type_Long = 0L;
      break;
      label214:
      localObject = bbpb.a(this.jdField_c_of_type_Long, 3);
      if (new File((String)localObject).exists())
      {
        mtq.a().a(l, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 0, (String)localObject, -1, null);
        axqy.b(null, "CliOper", "", "", "0X8005004", "0X8005004", 0, 0, "", this.jdField_c_of_type_Long + "", "", "");
      }
      else
      {
        mtq.a().a(l, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 2131230742, -1, null);
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    paramBundle = lcx.a(this.jdField_b_of_type_Int, String.valueOf(this.jdField_a_of_type_Long), new int[0]);
    if (lcx.a().a(paramBundle)) {}
    for (this.jdField_a_of_type_Lga = lcx.a().b(paramBundle); (this.jdField_a_of_type_ArrayOfLong == null) && (this.jdField_b_of_type_Int == 2); this.jdField_a_of_type_Lga = lcx.a().a())
    {
      super.finish();
      return;
    }
  ...
  public void onResume()
  {
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      {
        str = "1";
        axqy.b(null, "CliOper", "", "", "0X8009E92", "0X8009E92", 0, 0, str, "", "", "");
      }
    }
    else
    {
    ...
    while (this.g)
    {
      ...
      str = "2";
      break;
      axqy.b(null, "CliOper", "", "", "Multi_call", "Popup_force", 0, 0, "", "", "", "");
      break label85;
    }
    this.g = true;
    ChatActivityUtils.a(this, true, new lnt(this));
  }
  ...
  public void onStop()
  {
    ...
    if (!super.isFinishing())
    {
      ...
      this.jdField_a_of_type_Msp.a(this.jdField_a_of_type_Lga.jdField_c_of_type_JavaLangString, str2, localBitmap, str1, 43, this.jdField_a_of_type_Int, 3);
    }
  }
  ...
  public void onWindowFocusChanged(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      if (getApplicationContext().getString(2131692965).equalsIgnoreCase(this.jdField_a_of_type_AndroidWidgetTextView.getText().toString()))
      {
        float f1 = super.getResources().getDimensionPixelSize(2131297021);
        str = muc.a(super.getApplicationContext(), String.valueOf(this.jdField_b_of_type_Long), this.jdField_a_of_type_AndroidWidgetTextView, f1);
        str = String.format(getApplicationContext().getString(2131692966), new Object[] { str });
    ...
    for (;;)
    {
      ...
      findViewById(2131372283).setContentDescription(str);
      return;
      label203:
      this.jdField_a_of_type_AndroidWidgetTextView.setText(str);
      str = str + super.getApplicationContext().getString(2131692965);
    }
  }
}
