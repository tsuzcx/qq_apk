  ...
  implements Runnable
{
  ...
  WeakReference<lnw> jdField_a_of_type_JavaLangRefWeakReference;
  boolean jdField_a_of_type_Boolean = false;
  int jdField_b_of_type_Int;
  String jdField_b_of_type_JavaLangString;
  
  public BaseGaInvite$GetGaFaceRunnable(String paramString, VideoAppInterface paramVideoAppInterface, int paramInt1, int paramInt2, long paramLong1, long paramLong2, lnw paramlnw)
  {
    ...
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramlnw);
  }
  ...
  void b(String paramString)
  {
    ...
    int j = mqr.c(this.jdField_b_of_type_Int);
    ...
    {
      localObject = (lnw)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localObject == null) {}
    }
    for (boolean bool1 = ((lnw)localObject).a(localBitmap, str);; bool1 = false)
    {
      if (!bool1)
      {
