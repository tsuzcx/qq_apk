  ...
  extends GaInviteActivity
{
  ...
  protected void c()
  {
    ...
    this.jdField_a_of_type_ComTencentAvUiQavPanel.a(new jko(this));
    ...
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131365974));
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = BitmapTools.a(super.getApplicationContext(), 2130840224);
    View localView = super.findViewById(2131365964);
    if (this.jdField_a_of_type_AndroidGraphicsDrawableDrawable != null) {
      localView.setBackgroundDrawable(this.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
    }
    for (;;)
    {
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131365970));
      ...
      super.c();
      this.jdField_a_of_type_ComTencentAvUiQavInOutAnimation = new QavInOutAnimation(this, this.jdField_a_of_type_ComTencentAvVideoController, 1, this.jdField_a_of_type_ComTencentAvUiQavPanel, null, super.findViewById(2131365973), this.jdField_a_of_type_AndroidWidgetImageView, this.jdField_b_of_type_AndroidWidgetTextView, this.jdField_a_of_type_AndroidWidgetTextView, null);
      if (this.jdField_a_of_type_ComTencentAvUiQavInOutAnimation != null) {
        this.jdField_a_of_type_ComTencentAvUiQavInOutAnimation.a();
      }
      return;
      localView.setBackgroundResource(2130840224);
    }
  }
  ...
  public void g()
  {
    if (this.jdField_a_of_type_ComTencentAvUiQavInOutAnimation != null)
    {
      this.jdField_a_of_type_ComTencentAvUiQavInOutAnimation.a(new jkp(this));
      return;
    }
    super.e();
  }
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new jkq(this);
