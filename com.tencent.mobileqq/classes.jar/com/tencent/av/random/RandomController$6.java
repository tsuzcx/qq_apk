  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (!RandomController.a(this.this$0).a()) {
      PopupDialog.a(RandomController.a(this.this$0).getApp().getApplicationContext(), RandomController.a(this.this$0).getApp().getString(2131695716), RandomController.a(this.this$0, RandomController.d(this.this$0)));
    }
    do
    {
