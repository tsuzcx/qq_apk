...
public class RandomController
{
  ...
  private RandomWebProtocol.OnRequestListener jdField_a_of_type_ComTencentAvRandomRandomWebProtocol$OnRequestListener = new RandomController.1(this);
  private RandomWebProtocol jdField_a_of_type_ComTencentAvRandomRandomWebProtocol;
  private NearbyPeopleProfileHelper.INearbyPeopleProfileCallBack jdField_a_of_type_ComTencentAvUtilsNearbyPeopleProfileHelper$INearbyPeopleProfileCallBack = new RandomController.2(this);
  ...
  public String a;
  private List<RandomController.RandomListener> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  private int a()
  {
    ...
    else
    {
      ...
      this.jdField_a_of_type_ComTencentAvAppSessionInfo.jdField_d_of_type_JavaLangString = this.jdField_a_of_type_ComTencentAvAppSessionInfo.jdField_a_of_type_ComTencentAvAppSessionInfo$Anychat_Info.jdField_c_of_type_JavaLangString;
      m = this.jdField_a_of_type_ComTencentAvVideoController.a(0L, this.jdField_a_of_type_ComTencentAvAppSessionInfo.jdField_d_of_type_JavaLangString, 0, 4, this.jdField_a_of_type_ComTencentAvAppSessionInfo.i, this.jdField_a_of_type_ComTencentAvAppSessionInfo.jdField_j_of_type_JavaLangString, this.jdField_a_of_type_ComTencentAvAppSessionInfo.a(), this.jdField_c_of_type_Int, this.jdField_a_of_type_ComTencentAvAppSessionInfo.jdField_f_of_type_JavaLangString, this.jdField_a_of_type_ComTencentAvAppSessionInfo.jdField_g_of_type_JavaLangString, this.jdField_a_of_type_ComTencentAvAppSessionInfo.jdField_a_of_type_ArrayOfByte, this.jdField_c_of_type_JavaLangString, null, 0, 0, null, null);
    }
    label147:
    do
    {
      ...
      m = n;
    } while (!TextUtils.equals(this.jdField_a_of_type_ComTencentAvAppSessionInfo.jdField_d_of_type_JavaLangString, this.jdField_a_of_type_ComTencentAvAppSessionInfo.jdField_a_of_type_ComTencentAvAppSessionInfo$Anychat_Info.jdField_c_of_type_JavaLangString));
    return this.jdField_a_of_type_ComTencentAvVideoController.a(0L, this.jdField_a_of_type_ComTencentAvAppSessionInfo.jdField_d_of_type_JavaLangString, 0, 4);
  }
  ...
  private int a(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      String str = this.jdField_a_of_type_ComTencentAvAppSessionInfo.jdField_c_of_type_JavaLangString;
  ...
  {
    String str2 = this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getString(2131695715);
  ...
  private void a(RandomWebProtocol.Response paramResponse)
  {
    Object localObject1 = null;
    this.jdField_c_of_type_Int = 1011;
    if ((paramResponse instanceof RandomWebProtocol.RspDouble)) {
    ...
    for (;;)
    {
      ...
      Object localObject2 = (RandomWebProtocol.RspDouble)paramResponse;
      a(((RandomWebProtocol.RspDouble)localObject2).jdField_b_of_type_JavaLangString, ((RandomWebProtocol.RspDouble)localObject2).jdField_c_of_type_JavaLangString, ((RandomWebProtocol.RspDouble)localObject2).jdField_a_of_type_ArrayOfByte, ((RandomWebProtocol.RspDouble)localObject2).jdField_e_of_type_JavaLangString, ((RandomWebProtocol.RspDouble)localObject2).jdField_a_of_type_AndroidGraphicsBitmap, ((RandomWebProtocol.RspDouble)localObject2).jdField_d_of_type_JavaLangString, ((RandomWebProtocol.RspDouble)localObject2).jdField_f_of_type_Int);
      ...
      do
      {
        localObject2 = this.jdField_a_of_type_ComTencentAvAppSessionInfo.jdField_c_of_type_JavaLangString;
        ...
        if ((this.jdField_a_of_type_ComTencentAvAppSessionInfo.jdField_j_of_type_Int != 1011) && (!TextUtils.equals(this.jdField_a_of_type_ComTencentAvAppSessionInfo.jdField_d_of_type_JavaLangString, this.jdField_d_of_type_JavaLangString)) && (this.jdField_a_of_type_ComTencentAvAppSessionInfo.jdField_a_of_type_ComTencentAvAppSessionInfo$Anychat_Info.jdField_b_of_type_Boolean))
        {
          this.jdField_a_of_type_ComTencentAvVideoController.a(this.jdField_a_of_type_ComTencentAvAppSessionInfo.jdField_d_of_type_JavaLangString, 221);
        ...
        if ((this.jdField_h_of_type_JavaLangString != null) && (!TextUtils.isEmpty(this.jdField_h_of_type_JavaLangString))) {
          this.jdField_a_of_type_ComTencentAvAppSessionInfo.jdField_a_of_type_ComTencentAvAppSessionInfo$Anychat_Info.jdField_e_of_type_JavaLangString = (this.jdField_a_of_type_ComTencentAvVideoController.a().getString(2131695731) + this.jdField_h_of_type_JavaLangString);
        }
        ...
        return;
      } while (!(paramResponse instanceof RandomWebProtocol.RspMulti));
      localObject2 = (RandomWebProtocol.RspMulti)paramResponse;
      if (QLog.isColorLevel()) {
        QLog.d("RandomController", 2, "processWebProtocol RspMulti [random room owner]");
      }
      if (((RandomWebProtocol.RspMulti)localObject2).jdField_f_of_type_Int > 0) {
        this.jdField_b_of_type_Boolean = true;
      }
      for (;;)
      {
        this.jdField_e_of_type_Int = ((RandomWebProtocol.RspMulti)localObject2).jdField_g_of_type_Int;
        this.jdField_g_of_type_JavaLangString = ((RandomWebProtocol.RspMulti)localObject2).jdField_c_of_type_JavaLangString;
        this.jdField_h_of_type_Boolean = ((RandomWebProtocol.RspMulti)localObject2).jdField_a_of_type_Boolean;
      ...
      try
      {
        paramResponse = BitmapTools.a(this.jdField_a_of_type_AndroidGraphicsBitmap, this.jdField_a_of_type_AndroidGraphicsBitmap.getWidth() / 2);
        if (paramResponse != null) {
          this.jdField_a_of_type_ComTencentAvAppSessionInfo.jdField_a_of_type_ComTencentAvAppSessionInfo$Anychat_Info.jdField_a_of_type_AndroidGraphicsBitmap = paramResponse;
        }
        this.jdField_a_of_type_ComTencentAvAppSessionInfo.jdField_e_of_type_JavaLangString = this.jdField_e_of_type_JavaLangString;
        ...
        for (;;)
        {
          this.jdField_a_of_type_ComTencentAvAppSessionInfo.a(-1032L, "processWebProtocol", this.jdField_h_of_type_Int);
          this.jdField_a_of_type_ComTencentAvAppSessionInfo.jdField_j_of_type_Int = this.jdField_c_of_type_Int;
          this.jdField_a_of_type_ComTencentAvAppSessionInfo.S = true;
          this.jdField_a_of_type_ComTencentAvAppSessionInfo.jdField_a_of_type_ArrayOfByte = this.jdField_a_of_type_ArrayOfByte;
          this.jdField_a_of_type_ComTencentAvAppSessionInfo.N = false;
          ...
          PopupDialog.a();
          paramResponse = this.jdField_a_of_type_JavaUtilList.iterator();
          ...
          paramResponse = a(this.jdField_d_of_type_JavaLangString, false);
          if (paramResponse != null)
          {
            this.jdField_a_of_type_ComTencentAvAppSessionInfo.jdField_a_of_type_ComTencentAvAppSessionInfo$Anychat_Info.jdField_a_of_type_AndroidGraphicsBitmap = paramResponse;
            continue;
            ...
            if (this.jdField_f_of_type_Int == 2)
            {
              ...
              this.k = 0;
              if (!(paramResponse instanceof RandomWebProtocol.RspMulti)) {
                break label1316;
              }
              paramResponse = ((RandomWebProtocol.RspMulti)paramResponse).jdField_b_of_type_JavaLangString;
              if ((paramResponse == null) || (paramResponse.equals(""))) {
                break;
              }
              paramResponse = paramResponse.split(",");
              this.jdField_a_of_type_ArrayOfLong = new long[paramResponse.length];
              int m = 0;
              for (;;)
              {
                if (m < paramResponse.length) {
                  try
                  {
                    this.jdField_a_of_type_ArrayOfLong[m] = Long.parseLong(paramResponse[m].trim());
                    m += 1;
                  }
              ...
              if ((this.jdField_h_of_type_Int == 3) || (this.jdField_h_of_type_Int == 4)) {
                this.jdField_a_of_type_ComTencentAvAppSessionInfo.jdField_g_of_type_Long = this.jdField_a_of_type_Long;
              }
              if (QLog.isColorLevel()) {
              ...
              this.jdField_a_of_type_ComTencentAvAppSessionInfo.jdField_e_of_type_Boolean = false;
      ...
      catch (OutOfMemoryError paramResponse)
      {
        for (;;)
        {
          paramResponse = localNumberFormatException;
        }
      }
  ...
  private void b(RandomWebProtocol.Response paramResponse)
  {
    this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().removeCallbacks(this.jdField_a_of_type_JavaLangRunnable);
    ...
    this.jdField_i_of_type_Int = paramResponse.jdField_e_of_type_Int;
    PopupDialog.b((Context)localObject, 230, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getString(2131695716), a(this.jdField_i_of_type_Int), 2131720534, 0, null, new RandomController.8(this));
  ...
  private void f()
  {
    ...
    for (;;)
    {
      ...
      while (!this.jdField_a_of_type_ComTencentAvAppSessionInfo.l())
      {
        Context localContext = this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getApplicationContext();
        PopupDialog.b(localContext, 230, null, localContext.getString(2131695718), 2131720484, 2131695824, new RandomController.9(this), new RandomController.10(this));
  ...
  public void c()
  {
    ...
    do
    {
      ...
      if (this.jdField_f_of_type_Int == 1)
      {
        ...
        localObject = this.jdField_a_of_type_ComTencentAvAppSessionInfo.jdField_d_of_type_JavaLangString;
        if ((this.jdField_d_of_type_JavaLangString != null) && (this.jdField_d_of_type_JavaLangString.equals(localObject)))
        {
          ...
          this.jdField_a_of_type_ComTencentAvAppSessionInfo.jdField_g_of_type_Boolean = false;
          this.jdField_a_of_type_ComTencentAvVideoController.b((String)localObject, this.jdField_a_of_type_ComTencentAvAppSessionInfo.z);
        }
      }
      for (;;)
      {
      ...
      if ((this.jdField_d_of_type_JavaLangString != null) && (this.jdField_d_of_type_JavaLangString.equals(SessionMgr.a().a().jdField_d_of_type_JavaLangString))) {
        SessionMgr.a().a().b(0L);
      }
      SessionMgr.a().a().a();
      SessionMgr.a().a(-1042L, this.jdField_b_of_type_JavaLangString);
      this.jdField_a_of_type_ComTencentAvAppSessionInfo = null;
      this.jdField_b_of_type_JavaLangString = null;
      SmallScreenUtils.a(0L, 4, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp());
    } while (!QLog.isColorLevel());
