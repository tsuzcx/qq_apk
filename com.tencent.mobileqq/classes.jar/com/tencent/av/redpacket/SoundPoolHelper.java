...
public class SoundPoolHelper
{
  ...
  public SoundPoolHelper(List<String> paramList, int paramInt)
  {
  ...
  public void a(SoundPoolHelper.OnLoadFinishListener paramOnLoadFinishListener)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_AndroidMediaSoundPool == null)
      {
        ...
        this.jdField_a_of_type_AndroidMediaSoundPool.setOnLoadCompleteListener(new SoundPoolHelper.1(this, paramOnLoadFinishListener));
      }
