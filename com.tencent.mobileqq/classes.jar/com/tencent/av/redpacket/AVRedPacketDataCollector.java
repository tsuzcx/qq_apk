...
public class AVRedPacketDataCollector
{
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      return;
      i = ((AVRedPacketConfigManager)paramQQAppInterface.getManager(QQManagerFactory.AV_REDPACKET_CONFIG_MGR)).a();
      if (i > 0)
      {
  ...
  public static void b(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      return;
      int i = ((AVRedPacketConfigManager)paramQQAppInterface.getManager(QQManagerFactory.AV_REDPACKET_CONFIG_MGR)).a();
      boolean bool;
      if (i > 0)
      {
