  ...
  implements Handler.Callback, ResDownloadManager.IResDownloadListener, Manager
{
  ...
  public AVRedPacketConfigManager(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqArmapResDownloadManager = ((ResDownloadManager)paramQQAppInterface.getManager(QQManagerFactory.ARMAP_RES_DOWNLOAD));
  ...
  public void a(IAVRedPacketCallback paramIAVRedPacketCallback)
  {
    ...
    Object localObject = (PreDownloadController)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.PRE_DOWNLOAD_CONTROLLER_2);
    ...
    if (localObject != null)
    {
      ((MqqHandler)localObject).post(new AVRedPacketConfigManager.1(this, paramIAVRedPacketCallback));
      return;
    }
