  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      QQToast.a(BaseApplicationImpl.getContext(), 2, this.jdField_a_of_type_ComTencentAvRedpacketUiRedPacketShareFragment$4.this$0.getString(2131716559, new Object[] { this.jdField_a_of_type_JavaLangString }), 1).b(this.jdField_a_of_type_ComTencentAvRedpacketUiRedPacketShareFragment$4.this$0.getActivity().getTitleBarHeight());
    }
    for (;;)
    {
