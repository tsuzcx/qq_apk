  ...
  implements View.OnClickListener
{
  ...
  public RedPacketGameScore(RedPacketGameView paramRedPacketGameView)
  {
    ...
    this.jdField_a_of_type_JavaLangRunnable = new jno(this);
    ...
    ((View)localObject).setId(2131362544);
    ...
    paramRedPacketGameView.setId(2131362545);
  ...
  private void e()
  {
    View localView = this.jdField_a_of_type_ComTencentAvRedpacketUiRedPacketGameView.findViewById(2131362544);
    ...
    localView = this.jdField_a_of_type_ComTencentAvRedpacketUiRedPacketGameView.findViewById(2131362545);
  ...
  public void a(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      if (n < 8)
      {
        ...
        localView = ((Activity)this.jdField_a_of_type_ComTencentAvRedpacketUiRedPacketGameView.getContext()).findViewById(2131366260);
      }
      try
      {
        ...
        if (!this.jdField_b_of_type_Boolean)
        {
          ...
          localView = this.jdField_a_of_type_ComTencentAvRedpacketUiRedPacketGameView.findViewById(2131362544);
  ...
  public void a(boolean paramBoolean, AVRedPacketManager paramAVRedPacketManager)
  {
    ...
    if (!paramBoolean)
    {
      ...
      if (this.jdField_a_of_type_AndroidGraphicsBitmap != null) {
        localView.setBackgroundDrawable(TintStateDrawable.a(paramAVRedPacketManager, this.jdField_a_of_type_AndroidGraphicsBitmap, 2131494077));
      }
  ...
  public void b()
  {
    ...
    View localView = ((Activity)this.jdField_a_of_type_ComTencentAvRedpacketUiRedPacketGameView.getContext()).findViewById(2131366260);
    localView.setX(0.0F);
    localView.setY(0.0F);
  ...
  public void c()
  {
    RelativeLayout.LayoutParams localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_a_of_type_ComTencentAvRedpacketUiRedPacketGameView.findViewById(2131362544).getLayoutParams();
    localLayoutParams.width = (this.h * 52 / 750);
    localLayoutParams.height = (this.h * 52 / 750);
    localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_a_of_type_ComTencentAvRedpacketUiRedPacketGameView.findViewById(2131362545).getLayoutParams();
