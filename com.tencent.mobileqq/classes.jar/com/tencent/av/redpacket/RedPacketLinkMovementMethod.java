  ...
  public boolean onTouchEvent(TextView paramTextView, Spannable paramSpannable, MotionEvent paramMotionEvent)
  {
    ...
    if ((i == 1) || (i == 0))
    {
      ...
      if (localObject.length != 0)
      {
        if (i == 1)
        {
          i = a(paramTextView, 2131378906, this.b);
        ...
        for (;;)
        {
          ...
          if (i == 0)
          {
            paramSpannable.setSpan(new ForegroundColorSpan(a(paramTextView, 2131378905, this.jdField_a_of_type_Int)), paramSpannable.getSpanStart(localObject[0]), paramSpannable.getSpanEnd(localObject[0]), 33);
