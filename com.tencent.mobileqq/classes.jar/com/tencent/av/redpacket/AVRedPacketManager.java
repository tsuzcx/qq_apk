  ...
  implements Handler.Callback
{
  ...
  public ltj a;
  public ltk a;
  ltm jdField_a_of_type_Ltm = new ltm();
  public boolean a;
  public Handler b;
  public lsz b;
  ...
  public AVRedPacketManager(VideoAppInterface paramVideoAppInterface)
  {
    ...
    this.jdField_a_of_type_Ltj = new ltg(this);
    this.jdField_c_of_type_JavaLangString = "https://task.qq.com/index.php/opapi/reportCollectData";
    this.jdField_a_of_type_ComTencentAvAppVideoAppInterface = paramVideoAppInterface;
    paramVideoAppInterface = mnl.a();
    VideoAppInterface localVideoAppInterface = this.jdField_a_of_type_ComTencentAvAppVideoAppInterface;
    if ((paramVideoAppInterface.jdField_g_of_type_Int == 1) && (!mnp.a())) {}
    for (;;)
    {
      this.jdField_a_of_type_Ltk = new ltk(localVideoAppInterface, bool);
      this.jdField_a_of_type_Ltk.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a());
      return;
      bool = false;
    }
  }
  ...
  private void a(int paramInt1, int paramInt2, int paramInt3, float paramFloat)
  {
    ...
    ltb.a(paramInt1, paramInt2, paramInt3, paramFloat, this.h, this.i);
    paramInt2 = 0;
  ...
  private void a(AVRedPacketManager.GameInfoFromBusiServer paramGameInfoFromBusiServer)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        localmox = mpu.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface).a();
      } while ((localmox == null) || (localmox.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig == null));
      ArrayList localArrayList = a(localmox.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig.gameExpressionIDList, localmox.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig.gameExpressionCount);
      m = localArrayList.size();
      if (m == localmox.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig.gameExpressionCount)
      {
        int k = 0;
        while (k < m)
        {
          ...
          localLocalEmojiInfo.fallDownDuration = ((Integer)localmox.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig.gameExpressionDurationList.get(k)).intValue();
          if (k == m - 1) {
    ...
    QLog.d("AVRedPacketManager", 2, "onGameStartSuccFromServer size is not equal, size = " + m + ",ExpressionCount=" + localmox.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig.gameExpressionCount);
  }
  ...
  private void a(AVRedPacketManager.GameStateInfo paramGameStateInfo)
  {
    ...
    if (a(paramGameStateInfo))
    {
      ...
      l();
      mpu.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface).a().a(this.jdField_a_of_type_ComTencentAvRedpacketAVRedPacketManager$GameStateInfo.sendRedPacketUin, this.jdField_a_of_type_ComTencentAvRedpacketAVRedPacketManager$GameStateInfo.receiveRedPacketUin, paramGameStateInfo.enterType);
      e(1);
    }
  }
  ...
  {
    boolean bool = true;
    if (lfj.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface) == null) {
      bool = false;
    }
    if (QLog.isColorLevel()) {
  ...
  private void g(int paramInt)
  {
    ...
    if (!localmox.jdField_c_of_type_Boolean)
    {
      if (QLog.isColorLevel()) {
    ...
    this.jdField_a_of_type_Ltk.a(paramInt, localmox);
  }
  ...
  {
    mox localmox = mpu.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface).a();
    if ((localmox != null) && (localmox.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig != null))
    {
      jdField_b_of_type_Long = localmox.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig.game321MaxTimeOut;
      jdField_a_of_type_Long = localmox.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig.gameSendRedBagMaxTimeOut;
      jdField_e_of_type_Int = localmox.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig.gameMaxScore;
      jdField_f_of_type_Int = localmox.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig.gameExpressionCount;
      jdField_g_of_type_Long = localmox.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig.tipsTimeout;
    }
  ...
  {
    int m = -1;
    Object localObject = mpu.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface).a();
    int k = m;
    if (((mox)localObject).jdField_c_of_type_Boolean)
    {
      localObject = new File(((mox)localObject).jdField_b_of_type_JavaLangString).listFiles();
      k = m;
      if (localObject != null)
      {
        k = m;
  ...
  {
    return mpu.a(paramString, true);
  }
  
  public Bitmap a(String paramString, boolean paramBoolean)
  {
    return mpu.a(paramString, paramBoolean);
  }
  ...
  public void a()
  {
    this.jdField_a_of_type_Ltd = ((ltd)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(2));
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_Ltd.b(paramInt, paramBundle);
  }
  ...
  public void a(int paramInt1, String paramString1, String paramString2, int paramInt2, String paramString3)
  {
    ...
    this.jdField_a_of_type_Ltd.a(paramInt1, localBundle);
  }
  
  public void a(int paramInt, boolean paramBoolean)
  {
    this.jdField_a_of_type_Ltk.a(paramInt, paramBoolean);
  }
  ...
  public void a(List<PointF> paramList, float[] paramArrayOfFloat)
  {
    ...
    do
    {
      do
      {
        ...
        if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.size() > 0)) {
          this.jdField_a_of_type_Lsz = ((lsz)this.jdField_a_of_type_JavaUtilList.get(a(((AVRedPacketManager.LocalEmojiInfo)localObject).emojiType)));
        }
        if (QLog.isColorLevel()) {
          QLog.d("AVRedPacketManager", 2, "detectFaceExpression, targetExpression=" + this.jdField_a_of_type_Lsz.expressionID + ",emojiType=" + ((AVRedPacketManager.LocalEmojiInfo)localObject).emojiType);
        }
      } while ((paramList == null) || (paramArrayOfFloat == null) || (this.jdField_a_of_type_Lsz == null) || (this.jdField_a_of_type_Lsz.expressionFeat == null) || (this.jdField_a_of_type_Lsz.expressionAngle == null) || (this.jdField_a_of_type_Lsz.expressionWeight == null));
      locallta = lsy.a(this.jdField_a_of_type_Lsz, paramList, lsy.b(paramArrayOfFloat));
      f1 = locallta.a;
      localmox = mpu.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface).a();
      if ((a(false)) && (this.jdField_a_of_type_ComTencentAvRedpacketAVRedPacketManager$GameStateInfo.gameMode != 1) && (localmox != null)) {
        break;
      }
    } while (!QLog.isColorLevel());
    QLog.d("AVRedPacketManager", 2, "detectFaceExpression, invalid parame");
    return;
    AVRedPacketConfig.ExpressionInfo localExpressionInfo = (AVRedPacketConfig.ExpressionInfo)localmox.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig.expressionInfoList.get(((AVRedPacketManager.LocalEmojiInfo)localObject).emojiType);
    if ((f1 > localExpressionInfo.coolValue) && (this.jdField_b_of_type_Lsz != null)) {
      if ((localmox.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig.checkEyeOpenClose) && (this.jdField_a_of_type_Lsz.expressionWeight[0] > 0.0D) && (this.jdField_a_of_type_Lsz.expressionWeight[1] > 0.0D) && (!lsy.a(locallta)))
      {
        if (QLog.isColorLevel()) {
        ...
        f1 = 0.0F;
        f2 = f1;
        if (localmox.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig.checkNormalFaceExpression)
        {
          f2 = f1;
          if (lsy.a(locallta.a, this.jdField_a_of_type_Lsz.expressionWeight, this.jdField_a_of_type_Lsz.a, this.jdField_b_of_type_Lsz, paramList, lsy.b(paramArrayOfFloat)))
          {
            if (QLog.isColorLevel()) {
    ...
    {
      int m = localmox.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig.continuousHitCount;
      k = m;
      if (m < 1) {
        k = 1;
      }
  ...
  public void a(lti paramlti)
  {
    this.jdField_a_of_type_Lti = paramlti;
    if (this.jdField_a_of_type_Lti == null) {}
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (!paramBoolean)
    {
      ...
      l();
      this.jdField_c_of_type_Boolean = false;
      this.jdField_a_of_type_Ltd.b();
      i();
    }
    try
    {
      this.jdField_a_of_type_Ltk.a(7);
      this.jdField_a_of_type_Ltk.a();
      return;
    }
  ...
  public void a(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      mpu.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface).a().a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin(), str3, "", "", i2, jdField_e_of_type_Int, 0, 0, str1 + "", "" + n, str4, true, 0);
      a(false);
      return;
      if ((k == 1) || (k == 2))
      {
  ...
  public void a(boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      ...
      if (e())
      {
        paramString = new AVRedPacketManager.GameStateInfo(paramString, 1, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin(), mpu.a());
        if (a(paramString))
        {
          this.jdField_a_of_type_ComTencentAvRedpacketAVRedPacketManager$GameStateInfo.updateGameState(1);
          this.jdField_a_of_type_ComTencentAvRedpacketAVRedPacketManager$GameStateInfo.enterType = paramInt;
          mpu.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface).a().a(this.jdField_a_of_type_ComTencentAvRedpacketAVRedPacketManager$GameStateInfo.sendRedPacketUin, this.jdField_a_of_type_ComTencentAvRedpacketAVRedPacketManager$GameStateInfo.receiveRedPacketUin, paramInt);
          a(true, 1008, 0L, paramString);
          this.jdField_g_of_type_Int = a();
          a(true, 1020, 0L, null);
        }
      }
      bctj.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin(), "avRedPacketSendRedSuc", true, 0L, 0L, null, "");
    }
  }
  ...
  public boolean b(int paramInt)
  {
    ...
    Object localObject = mpu.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface).a();
    if ((localObject != null) && (((mox)localObject).jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig != null) && (((mox)localObject).jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig.shareExpressionIDList != null) && (((mox)localObject).jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig.shareExpressionIDList.contains(Integer.valueOf(paramInt)))) {
  ...
  public void d()
  {
    ...
    mpu.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
    a(true, 1027, 0L, null);
  }
    ...
    for (int k = m;; k = -1)
    {
      ...
      for (;;)
      {
        if ((paramInt != 0) && (this.jdField_a_of_type_ComTencentAvRedpacketAVRedPacketManager$GameStateInfo.gameMode == 2))
        {
          ...
          bctj.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin(), "avRedPacketEmojiSyncSuccRate", true, 0L, 0L, (HashMap)localObject1, "");
          return;
          paramInt = 1;
        }
        else
  ...
  public boolean d()
  {
    moy localmoy = mpu.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
    return (localmoy.a != null) && (localmoy.a.jdField_a_of_type_Boolean);
  }
  ...
  public void e(int paramInt)
  {
    ...
    do
    {
      ...
      if (paramInt == 1)
      {
        if (mpu.c(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface))
        {
          e(2);
          return;
        }
  ...
  public void f()
  {
    ...
    l();
    Object localObject1 = mpu.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface).a();
    if (this.jdField_a_of_type_JavaUtilList == null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("AVRedPacketManager", 2, "startGame, init expressionList");
      }
      if (((mox)localObject1).jdField_c_of_type_Boolean)
      {
        Object localObject2 = ((mox)localObject1).jdField_a_of_type_JavaLangString;
        localObject1 = localObject2;
        if (((String)localObject2).endsWith("/")) {
          localObject1 = ((String)localObject2).substring(0, ((String)localObject2).length() - 1);
        }
        this.jdField_a_of_type_JavaUtilList = lsy.a((String)localObject1, "params");
        if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.size() > 0))
        {
          this.jdField_a_of_type_Lsz = ((lsz)this.jdField_a_of_type_JavaUtilList.get(0));
          localObject1 = this.jdField_a_of_type_JavaUtilList.iterator();
          while (((Iterator)localObject1).hasNext())
          {
            localObject2 = (lsz)((Iterator)localObject1).next();
            if (((lsz)localObject2).expressionID.equals("99")) {
              this.jdField_b_of_type_Lsz = ((lsz)localObject2);
            }
          }
        }
      }
  ...
  public void f(int paramInt)
  {
    ...
    for (;;)
    {
      if (bool2)
      {
        mpu.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface).a().a(((AVRedPacketManager.GameStateInfo)localObject).sendRedPacketUin, ((AVRedPacketManager.GameStateInfo)localObject).receiveRedPacketUin, "", "", 0, jdField_e_of_type_Int, 0, jdField_f_of_type_Int, "0", "0", "", false, k);
        if (this.jdField_a_of_type_ComTencentAvRedpacketAVRedPacketManager$GameStateInfo.gameMode == 2)
        {
          localObject = new HashMap();
          ((HashMap)localObject).put("param_FailCode", Integer.toString(paramInt));
          bctj.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin(), "avRedPacketLocalExp", false, 0L, 0L, (HashMap)localObject, "");
        }
      }
      if (bool1)
      {
        ...
        do
        {
          do
          {
            do
            {
                ...
                do
                {
                  do
                  {
                    do
                    {
                        ...
                        do
                        {
                          do
                          {
                            do
                            {
                              ...
                              {
                                return false;
                              } while ((this.jdField_a_of_type_Lti == null) || (!a(false)));
                              this.jdField_a_of_type_Lti.a((AVRedPacketManager.LocalFrameSyncInfo)paramMessage.obj);
                              return false;
                            } while (this.jdField_a_of_type_Lti == null);
                            this.jdField_a_of_type_Lti.d();
                            return false;
                          } while (this.jdField_a_of_type_Lti == null);
                          this.jdField_a_of_type_Lti.e();
                          return false;
                          if (this.jdField_a_of_type_Lti != null)
                          {
                            ...
                            this.jdField_a_of_type_Lti.a(k, paramMessage);
                          }
                      ...
                      this.jdField_a_of_type_Lti.a(((Integer)paramMessage.obj).intValue());
                      return false;
                    } while (this.jdField_a_of_type_Lti == null);
                    this.jdField_a_of_type_Lti.a();
                    return false;
                  } while ((this.jdField_a_of_type_Lti == null) || (!a(false)));
                  this.jdField_a_of_type_Lti.b((AVRedPacketManager.LocalFrameSyncInfo)paramMessage.obj);
                  return false;
                } while (this.jdField_a_of_type_Lti == null);
                this.jdField_a_of_type_Lti.b();
                return false;
                paramMessage = (Object[])paramMessage.obj;
                k = ((Integer)paramMessage[0]).intValue();
              ...
              this.jdField_a_of_type_Lti.a(k, bool);
              return false;
              f(1);
              return false;
              f(2);
            ...
            this.jdField_a_of_type_Lti.a(((Boolean)paramMessage.obj).booleanValue());
            return false;
            f(8);
            return false;
            f(9);
