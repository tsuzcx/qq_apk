  ...
  implements Handler.Callback
{
  ...
  public ljo a;
  public ljp a;
  ljr jdField_a_of_type_Ljr = new ljr();
  public boolean a;
  public Handler b;
  public lje b;
  ...
  public AVRedPacketManager(VideoAppInterface paramVideoAppInterface)
  {
    ...
    this.jdField_a_of_type_Ljo = new ljl(this);
    this.jdField_c_of_type_JavaLangString = "http://task.qq.com/index.php/opapi/reportCollectData";
    this.jdField_a_of_type_ComTencentAvAppVideoAppInterface = paramVideoAppInterface;
    paramVideoAppInterface = mcq.a();
    VideoAppInterface localVideoAppInterface = this.jdField_a_of_type_ComTencentAvAppVideoAppInterface;
    if ((paramVideoAppInterface.jdField_g_of_type_Int == 1) && (!mcu.a())) {}
    for (;;)
    {
      this.jdField_a_of_type_Ljp = new ljp(localVideoAppInterface, bool);
      this.jdField_a_of_type_Ljp.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a());
      return;
      bool = false;
    }
  }
  ...
  private void a(int paramInt1, int paramInt2, int paramInt3, float paramFloat)
  {
    ...
    ljg.a(paramInt1, paramInt2, paramInt3, paramFloat, this.h, this.i);
    paramInt2 = 0;
  ...
  private void a(AVRedPacketManager.GameInfoFromBusiServer paramGameInfoFromBusiServer)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        localmec = mez.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface).a();
      } while ((localmec == null) || (localmec.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig == null));
      ArrayList localArrayList = a(localmec.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig.gameExpressionIDList, localmec.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig.gameExpressionCount);
      m = localArrayList.size();
      if (m == localmec.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig.gameExpressionCount)
      {
        int k = 0;
        while (k < m)
        {
          ...
          localLocalEmojiInfo.fallDownDuration = ((Integer)localmec.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig.gameExpressionDurationList.get(k)).intValue();
          if (k == m - 1) {
    ...
    QLog.d("AVRedPacketManager", 2, "onGameStartSuccFromServer size is not equal, size = " + m + ",ExpressionCount=" + localmec.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig.gameExpressionCount);
  }
  ...
  private void a(AVRedPacketManager.GameStateInfo paramGameStateInfo)
  {
    ...
    if (a(paramGameStateInfo))
    {
      ...
      l();
      mez.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface).a().a(this.jdField_a_of_type_ComTencentAvRedpacketAVRedPacketManager$GameStateInfo.sendRedPacketUin, this.jdField_a_of_type_ComTencentAvRedpacketAVRedPacketManager$GameStateInfo.receiveRedPacketUin, paramGameStateInfo.enterType);
      e(1);
    }
  }
  ...
  {
    boolean bool = true;
    if (kwb.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface) == null) {
      bool = false;
    }
    if (QLog.isColorLevel()) {
  ...
  private void g(int paramInt)
  {
    ...
    if (!localmec.jdField_c_of_type_Boolean)
    {
      if (QLog.isColorLevel()) {
    ...
    this.jdField_a_of_type_Ljp.a(paramInt, localmec);
  }
  ...
  {
    mec localmec = mez.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface).a();
    if ((localmec != null) && (localmec.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig != null))
    {
      jdField_b_of_type_Long = localmec.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig.game321MaxTimeOut;
      jdField_a_of_type_Long = localmec.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig.gameSendRedBagMaxTimeOut;
      jdField_e_of_type_Int = localmec.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig.gameMaxScore;
      jdField_f_of_type_Int = localmec.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig.gameExpressionCount;
      jdField_g_of_type_Long = localmec.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig.tipsTimeout;
    }
  ...
  {
    int m = -1;
    Object localObject = mez.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface).a();
    int k = m;
    if (((mec)localObject).jdField_c_of_type_Boolean)
    {
      localObject = new File(((mec)localObject).jdField_b_of_type_JavaLangString).listFiles();
      k = m;
      if (localObject != null)
      {
        k = m;
  ...
  {
    return mez.a(paramString, true);
  }
  
  public Bitmap a(String paramString, boolean paramBoolean)
  {
    return mez.a(paramString, paramBoolean);
  }
  ...
  public void a()
  {
    this.jdField_a_of_type_Lji = ((lji)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(2));
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_Lji.b(paramInt, paramBundle);
  }
  ...
  public void a(int paramInt1, String paramString1, String paramString2, int paramInt2, String paramString3)
  {
    ...
    this.jdField_a_of_type_Lji.a(paramInt1, localBundle);
  }
  
  public void a(int paramInt, boolean paramBoolean)
  {
    this.jdField_a_of_type_Ljp.a(paramInt, paramBoolean);
  }
  ...
  public void a(List<PointF> paramList, float[] paramArrayOfFloat)
  {
    ...
    do
    {
      do
      {
        ...
        if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.size() > 0)) {
          this.jdField_a_of_type_Lje = ((lje)this.jdField_a_of_type_JavaUtilList.get(a(((AVRedPacketManager.LocalEmojiInfo)localObject).emojiType)));
        }
        if (QLog.isColorLevel()) {
          QLog.d("AVRedPacketManager", 2, "detectFaceExpression, targetExpression=" + this.jdField_a_of_type_Lje.expressionID + ",emojiType=" + ((AVRedPacketManager.LocalEmojiInfo)localObject).emojiType);
        }
      } while ((paramList == null) || (paramArrayOfFloat == null) || (this.jdField_a_of_type_Lje == null) || (this.jdField_a_of_type_Lje.expressionFeat == null) || (this.jdField_a_of_type_Lje.expressionAngle == null) || (this.jdField_a_of_type_Lje.expressionWeight == null));
      localljf = ljd.a(this.jdField_a_of_type_Lje, paramList, ljd.b(paramArrayOfFloat));
      f1 = localljf.a;
      localmec = mez.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface).a();
      if ((a(false)) && (this.jdField_a_of_type_ComTencentAvRedpacketAVRedPacketManager$GameStateInfo.gameMode != 1) && (localmec != null)) {
        break;
      }
    } while (!QLog.isColorLevel());
    QLog.d("AVRedPacketManager", 2, "detectFaceExpression, invalid parame");
    return;
    AVRedPacketConfig.ExpressionInfo localExpressionInfo = (AVRedPacketConfig.ExpressionInfo)localmec.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig.expressionInfoList.get(((AVRedPacketManager.LocalEmojiInfo)localObject).emojiType);
    if ((f1 > localExpressionInfo.coolValue) && (this.jdField_b_of_type_Lje != null)) {
      if ((localmec.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig.checkEyeOpenClose) && (this.jdField_a_of_type_Lje.expressionWeight[0] > 0.0D) && (this.jdField_a_of_type_Lje.expressionWeight[1] > 0.0D) && (!ljd.a(localljf)))
      {
        if (QLog.isColorLevel()) {
        ...
        f1 = 0.0F;
        f2 = f1;
        if (localmec.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig.checkNormalFaceExpression)
        {
          f2 = f1;
          if (ljd.a(localljf.a, this.jdField_a_of_type_Lje.expressionWeight, this.jdField_a_of_type_Lje.a, this.jdField_b_of_type_Lje, paramList, ljd.b(paramArrayOfFloat)))
          {
            if (QLog.isColorLevel()) {
    ...
    {
      int m = localmec.jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig.continuousHitCount;
      k = m;
      if (m < 1) {
        k = 1;
      }
  ...
  {
    this.jdField_a_of_type_Ljn = paramljn;
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (!paramBoolean)
    {
      ...
      l();
      this.jdField_c_of_type_Boolean = false;
      this.jdField_a_of_type_Lji.b();
      i();
    }
    try
    {
      this.jdField_a_of_type_Ljp.a(7);
      this.jdField_a_of_type_Ljp.a();
      return;
    }
  ...
  public void a(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      mez.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface).a().a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin(), str3, "", "", i2, jdField_e_of_type_Int, 0, 0, str1 + "", "" + n, str4, true, 0);
      a(false);
      return;
      if ((k == 1) || (k == 2))
      {
  ...
  public void a(boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      ...
      if (e())
      {
        paramString = new AVRedPacketManager.GameStateInfo(paramString, 1, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin(), mez.a());
        if (a(paramString))
        {
          this.jdField_a_of_type_ComTencentAvRedpacketAVRedPacketManager$GameStateInfo.updateGameState(1);
          this.jdField_a_of_type_ComTencentAvRedpacketAVRedPacketManager$GameStateInfo.enterType = paramInt;
          mez.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface).a().a(this.jdField_a_of_type_ComTencentAvRedpacketAVRedPacketManager$GameStateInfo.sendRedPacketUin, this.jdField_a_of_type_ComTencentAvRedpacketAVRedPacketManager$GameStateInfo.receiveRedPacketUin, paramInt);
          a(true, 1008, 0L, paramString);
          this.jdField_g_of_type_Int = a();
          a(true, 1020, 0L, null);
        }
      }
      awrn.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin(), "avRedPacketSendRedSuc", true, 0L, 0L, null, "");
    }
  }
  ...
  public boolean b(int paramInt)
  {
    ...
    Object localObject = mez.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface).a();
    if ((localObject != null) && (((mec)localObject).jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig != null) && (((mec)localObject).jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig.shareExpressionIDList != null) && (((mec)localObject).jdField_a_of_type_ComTencentAvServiceAVRedPacketConfig.shareExpressionIDList.contains(Integer.valueOf(paramInt)))) {
  ...
  public void d()
  {
    ...
    mez.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
    a(true, 1027, 0L, null);
  }
    ...
    for (int k = m;; k = -1)
    {
      ...
      for (;;)
      {
        if ((paramInt != 0) && (this.jdField_a_of_type_ComTencentAvRedpacketAVRedPacketManager$GameStateInfo.gameMode == 2))
        {
          ...
          awrn.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin(), "avRedPacketEmojiSyncSuccRate", true, 0L, 0L, (HashMap)localObject1, "");
          return;
          paramInt = 1;
        }
        else
  ...
  public boolean d()
  {
    med localmed = mez.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
    return (localmed.a != null) && (localmed.a.jdField_a_of_type_Boolean);
  }
  ...
  public void e(int paramInt)
  {
    ...
    do
    {
      ...
      if (paramInt == 1)
      {
        if (mez.c(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface))
        {
          e(2);
          return;
        }
  ...
  public void f()
  {
    ...
    l();
    Object localObject1 = mez.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface).a();
    if (this.jdField_a_of_type_JavaUtilList == null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("AVRedPacketManager", 2, "startGame, init expressionList");
      }
      if (((mec)localObject1).jdField_c_of_type_Boolean)
      {
        Object localObject2 = ((mec)localObject1).jdField_a_of_type_JavaLangString;
        localObject1 = localObject2;
        if (((String)localObject2).endsWith("/")) {
          localObject1 = ((String)localObject2).substring(0, ((String)localObject2).length() - 1);
        }
        this.jdField_a_of_type_JavaUtilList = ljd.a((String)localObject1, "params");
        if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.size() > 0))
        {
          this.jdField_a_of_type_Lje = ((lje)this.jdField_a_of_type_JavaUtilList.get(0));
          localObject1 = this.jdField_a_of_type_JavaUtilList.iterator();
          while (((Iterator)localObject1).hasNext())
          {
            localObject2 = (lje)((Iterator)localObject1).next();
            if (((lje)localObject2).expressionID.equals("99")) {
              this.jdField_b_of_type_Lje = ((lje)localObject2);
            }
          }
        }
      }
  ...
  public void f(int paramInt)
  {
    ...
    for (;;)
    {
      if (bool2)
      {
        mez.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface).a().a(((AVRedPacketManager.GameStateInfo)localObject).sendRedPacketUin, ((AVRedPacketManager.GameStateInfo)localObject).receiveRedPacketUin, "", "", 0, jdField_e_of_type_Int, 0, jdField_f_of_type_Int, "0", "0", "", false, k);
        if (this.jdField_a_of_type_ComTencentAvRedpacketAVRedPacketManager$GameStateInfo.gameMode == 2)
        {
          localObject = new HashMap();
          ((HashMap)localObject).put("param_FailCode", Integer.toString(paramInt));
          awrn.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin(), "avRedPacketLocalExp", false, 0L, 0L, (HashMap)localObject, "");
        }
      }
      if (bool1)
      {
        ...
        do
        {
          do
          {
            do
            {
                ...
                do
                {
                  do
                  {
                    do
                    {
                        ...
                        do
                        {
                          do
                          {
                            do
                            {
                              ...
                              {
                                return false;
                              } while ((this.jdField_a_of_type_Ljn == null) || (!a(false)));
                              this.jdField_a_of_type_Ljn.a((AVRedPacketManager.LocalFrameSyncInfo)paramMessage.obj);
                              return false;
                            } while (this.jdField_a_of_type_Ljn == null);
                            this.jdField_a_of_type_Ljn.d();
                            return false;
                          } while (this.jdField_a_of_type_Ljn == null);
                          this.jdField_a_of_type_Ljn.e();
                          return false;
                          if (this.jdField_a_of_type_Ljn != null)
                          {
                            ...
                            this.jdField_a_of_type_Ljn.a(k, paramMessage);
                          }
                      ...
                      this.jdField_a_of_type_Ljn.a(((Integer)paramMessage.obj).intValue());
                      return false;
                    } while (this.jdField_a_of_type_Ljn == null);
                    this.jdField_a_of_type_Ljn.a();
                    return false;
                  } while ((this.jdField_a_of_type_Ljn == null) || (!a(false)));
                  this.jdField_a_of_type_Ljn.b((AVRedPacketManager.LocalFrameSyncInfo)paramMessage.obj);
                  return false;
                } while (this.jdField_a_of_type_Ljn == null);
              ...
              this.jdField_a_of_type_Ljn.a(k, bool);
              return false;
              f(1);
              return false;
              f(2);
            ...
            this.jdField_a_of_type_Ljn.a(((Boolean)paramMessage.obj).booleanValue());
            return false;
            f(8);
            return false;
            f(9);
