  ...
  extends ScreenLayout
{
  ...
  static
  {
    ...
    int[] arrayOfInt4 = { 3, 3, 3 };
    int[] arrayOfInt5 = { 3, 3, 3, 4 };
    int[] arrayOfInt6 = { 3, 3, 4, 4 };
    jdField_a_of_type_Array2dOfInt = new int[][] { { 1 }, arrayOfInt1, { 1, 2 }, arrayOfInt2, { 2, 2, 1 }, arrayOfInt3, { 2, 2, 3 }, { 2, 3, 3 }, arrayOfInt4, { 3, 3, 2, 2 }, { 3, 3, 3, 2 }, { 3, 3, 3, 3 }, arrayOfInt5, arrayOfInt6, { 3, 4, 4, 4 }, { 4, 4, 4, 4 } };
  ...
  public void a(SessionInfo paramSessionInfo, GLVideoView[] paramArrayOfGLVideoView, int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3, int paramInt4)
  {
    ...
    paramInt3 = Math.min(paramSessionInfo.c.size(), paramArrayOfGLVideoView.length);
    label35:
    float f1;
    float f2;
    if (paramInt3 > jdField_b_of_type_Int)
    {
      ...
      if ((paramInt3 >= 2) && (UITools.a(1))) {
        ThreadManager.getUIHandler().post(new ScreenLayoutMultipleGrid.1(this));
      }
      paramSessionInfo = a(paramInt3, paramInt1, paramInt2);
      f1 = UITools.a(this.jdField_a_of_type_AndroidContentContext, 12.0F);
      f2 = UITools.a(this.jdField_a_of_type_AndroidContentContext, 18.0F);
      paramInt2 = 0;
      label98:
      if (paramInt2 < paramInt3)
      {
        Object localObject = (Rect)paramSessionInfo.get(paramInt2);
        if (localObject == null) {
          break label356;
        }
        paramArrayOfGLVideoView[paramInt2].b(((Rect)localObject).left, ((Rect)localObject).top, ((Rect)localObject).right, ((Rect)localObject).bottom);
        paramArrayOfGLVideoView[paramInt2].a(0, 0, 0, 0);
        long l1 = AudioHelper.a(paramArrayOfGLVideoView[paramInt2].c());
        long l2 = paramArrayOfGLVideoView[paramInt2].g();
        if ((TextUtils.isEmpty(paramArrayOfGLVideoView[paramInt2].b())) && (l1 != 0L)) {
          paramArrayOfGLVideoView[paramInt2].b(String.valueOf(l1));
        }
        if (l1 != 0L)
        {
          localObject = (VideoMemberInfo)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(l1));
          if (localObject != null)
          {
            if (!((VideoMemberInfo)localObject).e()) {
              break label320;
            }
            paramInt1 = 1;
            label254:
            ...
            if ((!((VideoMemberInfo)localObject).d()) || (l2 == 2L)) {
              break label325;
            }
            paramInt1 = 2;
          }
    ...
    {
      label277:
      paramArrayOfGLVideoView[paramInt2].h(paramInt1);
      if (paramInt3 == 1)
      {
        paramArrayOfGLVideoView[paramInt2].h(false);
        paramArrayOfGLVideoView[paramInt2].a(f2);
      }
      for (;;)
      {
        paramInt2 += 1;
        ...
        if (paramInt3 >= 2)
        {
          paramArrayOfGLVideoView[paramInt2].h(true);
          paramArrayOfGLVideoView[paramInt2].a(f1);
        }
      }
      label356:
      if (!QLog.isDevelopLevel()) {
