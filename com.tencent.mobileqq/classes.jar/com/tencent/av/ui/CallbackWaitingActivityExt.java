  ...
  extends BaseActivity
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new jtc(this, Looper.getMainLooper());
  public Button a;
  ...
  PstnObserver jdField_a_of_type_ComTencentMobileqqQcallPstnObserver = new jti(this);
  public Runnable a;
  public String a;
  jtt jdField_a_of_type_Jtt = null;
  public MqqHandler a;
  public int b;
  BroadcastReceiver jdField_b_of_type_AndroidContentBroadcastReceiver = new jto(this);
  public Button b;
  ...
  public CallbackWaitingActivityExt()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler$Callback = new jtg(this);
  ...
  private void e()
  {
    ...
    {
      super.setContentView(2130969336);
  ...
  public void BtnOnClick(View paramView)
  {
    ...
    DialogUtil.a(this, 230, paramView, (String)localObject1, getString(2131428675), (String)localObject2, new jtp(this), new jtq(this)).show();
  }
  ...
  protected void b()
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Jtt != null)
      {
        localObject1 = (TelephonyManager)getSystemService("phone");
        if (localObject1 != null) {
          ((TelephonyManager)localObject1).listen(this.jdField_a_of_type_Jtt, 0);
        }
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Jtt == null) {
        this.jdField_a_of_type_Jtt = new jtt(this);
      }
      ((TelephonyManager)getSystemService("phone")).listen(this.jdField_a_of_type_Jtt, 32);
      ...
      ThreadManager.post(new jtf(this), 5, null, false);
      a(getIntent());
      if (this.jdField_a_of_type_ComTencentAvAppPstnSessionInfo != null)
      {
        paramBundle = getString(2131438374) + a(this.jdField_a_of_type_ComTencentAvAppPstnSessionInfo.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_ComTencentAvAppPstnSessionInfo.jdField_d_of_type_JavaLangString);
      ...
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131365852));
    }
  }
  ...
  protected void doOnResume()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().jdField_b_of_type_Int == -1)
    {
      ...
      if (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().e) {
        AudioUtil.a(2131230734, 1, null, null);
      }
  ...
  protected void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    DialogUtil.a(this, 230, paramIntent, str, getString(2131428675), (String)localObject, new jtd(this), new jte(this)).show();
  }
