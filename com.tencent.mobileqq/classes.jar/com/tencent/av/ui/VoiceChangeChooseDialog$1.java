  ...
  implements Runnable
{
  public void run()
  {
    if ((mml.a(this.this$0) == 1) && (!this.this$0.jdField_a_of_type_Boolean))
    {
      this.this$0.jdField_a_of_type_AndroidWidgetTextView.setText(2131695717);
      mml.a(this.this$0, 2);
    ...
    while (mml.a(this.this$0) != 2) {
      return;
    }
    this.this$0.jdField_a_of_type_AndroidWidgetTextView.setText(2131695719);
    mml.a(this.this$0, 0);
  }
}
