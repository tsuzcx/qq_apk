  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    do
    {
      ...
      if ((!this.this$0.jdField_a_of_type_ComTencentAvVideoController.e()) && (this.this$0.jdField_a_of_type_ComTencentAvVideoController.a().f == 1) && (this.this$0.jdField_a_of_type_ComTencentAvVideoController.a().j))
      {
        if (QLog.isColorLevel()) {
          QLog.w(this.this$0.c, 1, "FixTerSwitchStatus ,switch to pc ,local close camera, seq[" + l + "]");
        }
        this.this$0.j(l);
        this.this$0.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(new Object[] { Integer.valueOf(106), Long.valueOf(l) });
        lqb.a(this.this$0.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1021);
      }
