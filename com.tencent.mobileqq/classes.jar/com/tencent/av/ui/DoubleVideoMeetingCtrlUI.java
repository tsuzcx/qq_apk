  ...
  extends VideoControlUI
{
  ...
  lfb jdField_a_of_type_Lfb = new mcx(this);
  ...
  public DoubleVideoMeetingCtrlUI(VideoAppInterface paramVideoAppInterface, AVActivity paramAVActivity, ViewGroup paramViewGroup, mcf parammcf)
  {
  ...
  void a()
  {
    ...
    boolean bool = locallga.k;
    long l = AudioHelper.b();
    if (QLog.isColorLevel()) {
      QLog.w(this.jdField_c_of_type_JavaLangString, 1, "resumeVideo, remoteHasVideo[" + bool + "], displayViewList[" + locallga.jdField_c_of_type_JavaUtilArrayList.size() + "], seq[" + l + "], \nsessionInfo[" + locallga + "]");
    }
    if ((locallga.jdField_d_of_type_Int == 4) && (!locallga.j) && ((locallga.jdField_c_of_type_JavaUtilArrayList.size() == 0) || (!bool)))
    {
      locallga.a(l, "resumeVideo", 3);
      QLog.w(this.jdField_c_of_type_JavaLangString, 1, "resumeVideo, fix SessionType");
    }
    ArrayList localArrayList = new ArrayList();
    lon locallon = new lon();
    locallon.jdField_a_of_type_Long = Long.valueOf(locallga.jdField_d_of_type_JavaLangString).longValue();
    ...
    if ((locallga.a(this.jdField_b_of_type_Long, 1) == -1) || (locallga.j))
    {
      if (QLog.isColorLevel()) {
  ...
  void a(int paramInt)
  {
    ...
    View localView = this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131365323);
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_Mtc.c(bool2);
        this.jdField_a_of_type_Mtc.b(bool2);
  ...
  public void a(long paramLong, View paramView)
  {
        ...
        do
        {
          do
          {
            do
            {
              ...
              super.z(paramLong);
              axqy.b(null, "CliOper", "", "", "0X8005205", "0X8005205", 0, 0, "", "", "", "");
            } while (!lze.f());
    ...
    case 2131372211: 
      ...
      {
        this.jdField_a_of_type_Mhj.a(new mcw(this, paramLong));
        return;
      }
      mtq.a().b(paramLong);
      if (!locallga.Q) {
      ...
      super.y(paramLong);
      b(true);
      axqy.b(null, "CliOper", "", "", "0X8005206", "0X8005206", 0, 0, "", "", "", "");
      return;
    case 2131372216: 
    ...
    case 2131372208: 
      ...
      if ((locallga.N) && (locallga.a != null)) {
        axqy.b(null, "CliOper", "", "", "0X8005202", "0X8005202", 0, 0, "", "", "", "");
      }
      for (;;)
      {
        super.z(paramLong);
        return;
        axqy.b(null, "CliOper", "", "", "0X8005201", "0X8005201", 0, 0, "", "", "", "");
      }
    case 2131372213: 
      QLog.d(this.jdField_c_of_type_JavaLangString, 1, "avideo onClick QavPanel.ViewID.HIDE");
      a();
      axqy.b(null, "CliOper", "", "", "0X8005207", "0X8005207", 0, 0, "", "", "", "");
      if (locallga.j)
      {
        axqy.b(null, "CliOper", "", "", "0X8005214", "0X8005214", 0, 0, "", "", "", "");
        return;
      }
      axqy.b(null, "CliOper", "", "", "0X8005217", "0X8005217", 0, 0, "", "", "", "");
      return;
    case 2131372521: 
    ...
    case 2131372215: 
      ...
      int i = locallga.i;
      paramView = locallga.jdField_e_of_type_JavaLangString;
  ...
  public void a(long paramLong, ArrayList<lon> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      {
        if ((((lon)paramArrayList.get(i)).jdField_a_of_type_Long == this.jdField_b_of_type_Long) && (!this.jdField_a_of_type_ComTencentAvVideoController.a().j)) {
  ...
  public void a(long paramLong, boolean paramBoolean, int paramInt)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        this.jdField_a_of_type_ComTencentAvVideoController.k();
        if ((paramInt == 3) && (!locallga.N) && ("DEVICE_EARPHONE".equals(locallga.q))) {
          this.jdField_a_of_type_Mtq.d();
        }
      } while ((locallga.k) || (this.jdField_a_of_type_ComTencentAvUiQavPanel == null));
      a(locallga.jdField_d_of_type_Int);
      return;
    } while (!QLog.isColorLevel());
  ...
  void a(long paramLong1, boolean paramBoolean, int paramInt, long paramLong2)
  {
    ...
    lon locallon = new lon();
    locallon.jdField_a_of_type_Long = paramLong2;
  ...
  public void a(String arg1, int paramInt1, String paramString2, int paramInt2)
  {
    ...
    do
    {
      ...
      paramString2 = (lon)this.jdField_a_of_type_ComTencentAvVideoController.a().jdField_c_of_type_JavaUtilArrayList.get(paramInt1);
      lon locallon = (lon)this.jdField_a_of_type_ComTencentAvVideoController.a().jdField_c_of_type_JavaUtilArrayList.get(paramInt2);
      locallon.jdField_a_of_type_Boolean = true;
      paramString2.jdField_a_of_type_Boolean = false;
      this.jdField_a_of_type_ComTencentAvVideoController.a().jdField_c_of_type_JavaUtilArrayList.set(paramInt1, locallon);
      ...
      {
        this.jdField_a_of_type_ComTencentAvVideoController.a().jdField_d_of_type_JavaUtilArrayList.set(paramInt1, locallon);
        ...
        {
          axqy.b(null, "CliOper", "", "", "0X800520E", "0X800520E", 0, 0, "", "", "", "");
          return;
        }
      }
    } while (l2 != this.jdField_a_of_type_Long);
    axqy.b(null, "CliOper", "", "", "0X800520F", "0X800520F", 0, 0, "", "", "", "");
    if (this.jdField_b_of_type_Boolean)
    {
      axqy.b(null, "CliOper", "", "", "0X8005213", "0X8005213", 0, 0, "", "", "", "");
      return;
    }
    axqy.b(null, "CliOper", "", "", "0X8005212", "0X8005212", 0, 0, "", "", "", "");
  }
  ...
  public boolean a(int paramInt, KeyEvent paramKeyEvent)
  {
    ...
    {
      axqy.b(null, "CliOper", "", "", "0X8005215", "0X8005215", 0, 0, "", "", "", "");
      return false;
    }
    axqy.b(null, "CliOper", "", "", "0X8005218", "0X8005218", 0, 0, "", "", "", "");
    return false;
  }
  ...
  boolean a(long paramLong)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentAvVideoController.a().jdField_c_of_type_JavaUtilArrayList.size() == 1) && (((lon)this.jdField_a_of_type_ComTencentAvVideoController.a().jdField_c_of_type_JavaUtilArrayList.get(0)).jdField_a_of_type_Long == this.jdField_b_of_type_Long))
    {
  ...
  void b()
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvUiQavPanel != null)
    {
      ...
      if (localActivity != null)
      {
        ...
        this.jdField_a_of_type_Mtc = mtc.a(this.jdField_a_of_type_Mtc, localActivity, this.jdField_a_of_type_ComTencentAvVideoController, this.jdField_a_of_type_Mtq);
  ...
  void c(long paramLong, View paramView)
  {
    if (a(paramLong, "android.permission.RECORD_AUDIO", null))
    {
      ...
      axqy.b(null, "CliOper", "", "", "0X8005204", "0X8005204", 0, 0, "", "", "", "");
    }
    for (;;)
    {
      super.z(paramLong);
      ...
      axqy.b(null, "CliOper", "", "", "0X8005203", "0X8005203", 0, 0, "", "", "", "");
    }
  }
  ...
  public void d()
  {
    ...
    for (;;)
    {
      ...
      catch (NumberFormatException localNumberFormatException)
      {
        for (;;)
        {
          lcg.e(this.jdField_c_of_type_JavaLangString, localNumberFormatException.getMessage());
        }
      }
    }
  }
  ...
  void d(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Mag != null) {
      this.jdField_a_of_type_Mag.a(paramBoolean, new mcy(this));
    }
    if (paramBoolean)
    {
  ...
  void k(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      for (boolean bool = ((Intent)localObject).getBooleanExtra("isEnter", false); bool; bool = false)
      {
        ...
        localObject = lcx.a().b(lcx.a(100, String.valueOf(this.jdField_a_of_type_Long), new int[0]));
        if ((localObject != null) && (((lga)localObject).jdField_g_of_type_Int == 0))
        {
          if (QLog.isColorLevel()) {
  ...
  void m()
  {
    g(true);
    if (this.jdField_a_of_type_Mhj != null) {
      this.jdField_a_of_type_Mhj.a(new mcv(this));
    }
  }
  ...
  public void p()
  {
    ...
    {
      if (((lon)this.jdField_a_of_type_ComTencentAvVideoController.a().jdField_c_of_type_JavaUtilArrayList.get(i)).jdField_a_of_type_Long != this.jdField_b_of_type_Long) {
  ...
  public void r()
  {
    ...
    do
    {
      ...
      } while ((this.jdField_a_of_type_Boolean) || (!this.jdField_a_of_type_ComTencentAvVideoController.a().J) || (lcx.a().a()));
