...
public class CircleProgressWithBg
  extends ImageView
{
  int a;
  float b;
  ...
  public CircleProgressWithBg(Context paramContext)
  {
    super(paramContext);
    a();
  }
  
  public CircleProgressWithBg(Context paramContext, AttributeSet paramAttributeSet)
  {
  ...
  protected void a(Canvas paramCanvas)
  {
    ...
    int i1 = Math.max(this.i, this.j) / 2;
    paramCanvas.drawCircle(this.i / 2.0F, this.j / 2.0F, i1, this.k);
    this.k.setStyle(Paint.Style.STROKE);
 ...
 * Qualified Name:     com.tencent.av.ui.effect.view.CircleProgressWithBg
