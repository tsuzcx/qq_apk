  ...
  extends GAudioUIObserver
{
    ...
    for (boolean bool = localVideoViewInfo.jdField_a_of_type_Boolean;; bool = false)
    {
      ...
      for (;;)
      {
        ...
        else if (paramLong3 == 8L)
        {
          ...
          {
            MultiVideoCtrlLayerUIBase.a(this.a, false);
            TipsUtil.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1033, this.a.jdField_a_of_type_AndroidContentResResources.getString(2131695701));
          }
        }
        else if ((paramLong3 == 9L) && (MultiVideoCtrlLayerUIBase.a(this.a)))
        {
          MultiVideoCtrlLayerUIBase.a(this.a, false);
          TipsUtil.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1033, this.a.jdField_a_of_type_AndroidContentResResources.getString(2131695702));
        }
      }
      this.a.v(paramLong3);
      return;
  ...
  public void a(long paramLong, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    do
    {
      ...
      if ((this.a.jdField_a_of_type_ComTencentAvVideoController.a() != null) && (this.a.jdField_a_of_type_ComTencentAvVideoController.a().H != 1))
      {
        ...
        str = this.a.jdField_a_of_type_AndroidContentResResources.getString(2131695538);
        float f = EllipsisUtil.a(str, this.a.jdField_e_of_type_AndroidWidgetTextView.getPaint());
        f = Math.min(this.a.jdField_a_of_type_AndroidContentResResources.getDisplayMetrics().widthPixels - f - this.a.jdField_a_of_type_AndroidContentResResources.getDimensionPixelSize(2131298004) * 2, this.a.jdField_a_of_type_AndroidContentResResources.getDimensionPixelSize(2131297180));
    ...
    for (int i = 1;; i = 0)
    {
      ((SessionInfo)localObject).e("setRoomMicOff", i);
      return;
      ...
      localStringBuilder.append(this.a.jdField_a_of_type_AndroidContentResResources.getString(2131695535));
      break;
    }
  }
  ...
  public void a(ArrayList<Long> paramArrayList, int paramInt)
  {
    if (paramInt == 0)
    {
    ...
    {
      TipsUtil.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1034, 2131695522);
      TipsUtil.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1035, this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getString(2131695870), new MultiVideoCtrlLayerUIBase.10.1(this));
      return;
    }
    Object localObject;
    long l;
    if (this.a.jdField_e_of_type_JavaLangRunnable == null)
    {
      ...
      if (this.a.jdField_a_of_type_ComTencentAvVideoController.jdField_b_of_type_Long < 2000L)
      {
        l = 2000L;
    ...
    else
    {
      ...
      float f = this.a.jdField_a_of_type_AndroidContentResResources.getDimensionPixelSize(2131297180);
      localObject = new StringBuilder();
      EllipsisUtil.b((StringBuilder)localObject, paramArrayList, this.a.jdField_e_of_type_AndroidWidgetTextView.getPaint(), f);
      if (paramInt != 1) {
        break label419;
      }
      ((StringBuilder)localObject).append(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getString(2131695523));
      TipsUtil.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1035, this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getString(2131695871), new MultiVideoCtrlLayerUIBase.10.2(this));
    }
    for (;;)
    {
      ...
      return;
      l = this.a.jdField_a_of_type_ComTencentAvVideoController.jdField_b_of_type_Long;
      break;
      label419:
      ((StringBuilder)localObject).append(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getString(2131695524)).append(paramInt);
      ((StringBuilder)localObject).append(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getString(2131695525));
      TipsUtil.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1035, this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getString(2131695872), new MultiVideoCtrlLayerUIBase.10.3(this));
    }
  }
  ...
  public void d(long paramLong, int paramInt)
  {
    ...
    if (paramInt == 1)
    {
      ...
      float f = this.a.jdField_a_of_type_AndroidContentResResources.getDimensionPixelSize(2131297180);
      localStringBuilder.append(this.a.jdField_a_of_type_AndroidContentResResources.getString(2131695541));
      EllipsisUtil.b(localStringBuilder, (String)localObject, this.a.jdField_e_of_type_AndroidWidgetTextView.getPaint(), f);
      localStringBuilder.append(this.a.jdField_a_of_type_AndroidContentResResources.getString(2131695540));
      TipsUtil.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1033, localStringBuilder.toString());
      localObject = this.a;
      if (paramInt != 1) {
        break label287;
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      localStringBuilder.append(this.a.jdField_a_of_type_AndroidContentResResources.getString(2131695542));
      break;
    }
  }
}
