  ...
  extends BusinessManager
{
  ...
  public AVRedBagMgr(VideoAppInterface paramVideoAppInterface)
  {
    ...
    this.jdField_a_of_type_Khk = null;
  ...
  private void f()
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Khk == null) {
        this.jdField_a_of_type_Khk = new khk(this);
      }
      this.jdField_a_of_type_Khk.a("init");
    ...
    this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(new kgc(this));
  }
  ...
  {
    if (this.jdField_a_of_type_Khk != null) {
      return this.jdField_a_of_type_Khk.jdField_a_of_type_Int;
    }
    return -1;
  }
  ...
  {
    this.jdField_a_of_type_Khe = new kgg(this);
    paramAVActivity = a(paramAVActivity, paramResultData, new WeakReference(this.jdField_a_of_type_Khe));
  ...
  void a(GameSink paramGameSink)
  {
    ...
    this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().post(new kgh(this));
  }
  
  void a(ResultData paramResultData)
  {
    ResultUI localResultUI = new ResultUI(this);
    localResultUI.a(paramResultData, new kge(this));
  ...
  {
    this.jdField_a_of_type_Khe = null;
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (this.jdField_a_of_type_Khk != null) {
        this.jdField_a_of_type_Khk.jdField_b_of_type_Boolean = paramBoolean;
      }
      return;
      i = 5;
      break;
      label126:
      localObject = Boolean.valueOf(this.jdField_a_of_type_Khk.jdField_b_of_type_Boolean);
      break label54;
    }
  }
  ...
  public boolean a(AVActivity paramAVActivity, int paramInt)
  {
    ...
    boolean bool = this.jdField_a_of_type_ComTencentAvUiRedbagSendRedBag.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, paramInt, paramAVActivity, new kgd(this));
    if (bool)
    {
      this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramAVActivity);
      a(true);
  ...
  {
    if (this.jdField_a_of_type_ComTencentAvAppVideoAppInterface != null) {
      this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().post(new kgi(this));
    }
  }
  ...
  void b(ResultData paramResultData)
  {
    ...
    if (this.jdField_a_of_type_Khk != null) {
      a(this.jdField_a_of_type_Khk.jdField_b_of_type_Boolean);
    }
    c(paramResultData);
    a(paramResultData);
    if (this.jdField_a_of_type_ComTencentAvUiRedbagOtherBtnController != null)
  ...
  void c(ResultData paramResultData)
  {
    if ((!paramResultData.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_ComTencentAvAppVideoAppInterface != null)) {
      this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().post(new kgf(this, paramResultData));
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Khk != null) {
      return this.jdField_a_of_type_Khk.jdField_a_of_type_Boolean;
    }
    return false;
  }
