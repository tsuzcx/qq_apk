...
import com.tencent.av.ui.RedbagToolbar.RedBagBtnStatus;
...
public class RedBagReport
{
  ...
  public static void a(VideoAppInterface paramVideoAppInterface, BaseToolbar paramBaseToolbar)
  {
    ...
    {
      paramBaseToolbar = new RedbagToolbar.RedBagBtnStatus();
    ...
    for (int j = paramBaseToolbar.jdField_a_of_type_Int;; j = -1)
    {
      ...
      for (;;)
      {
        ...
        if (k < 32)
        {
          ...
          {
            AVRedPacketDataCollector.a(bool, String.valueOf(m));
            m <<= 1;
            k += 1;
            break label65;
            k += 1;
        ...
        ReportController.b(null, "dc00898", "", "", "0X8008977", "0X8008977", n, 0, String.valueOf(i), String.valueOf(j), jdField_a_of_type_JavaLangString, "");
        return;
        label243:
        i = 0;
      }
  ...
  public static void a(ResultData paramResultData)
  {
    if (QLog.isDevelopLevel()) {
      QLog.w("RedBagReport", 1, "reportClickEvent, key[" + "0X800897F" + "], fromType[" + jdField_a_of_type_Int + "], mSucAboutGame[" + paramResultData.jdField_a_of_type_Boolean + "], mExceptionType[" + paramResultData.jdField_f_of_type_Int + "], mRoomId[" + jdField_a_of_type_JavaLangString + "]");
    }
    int i = jdField_a_of_type_Int;
    int j = paramResultData.jdField_f_of_type_Int;
    if (paramResultData.jdField_a_of_type_Boolean) {}
    for (paramResultData = "1";; paramResultData = "0")
    {
      ReportController.b(null, "dc00898", "", "", "0X800897F", "0X800897F", i, 0, String.valueOf(j), paramResultData, jdField_a_of_type_JavaLangString, "");
      return;
    }
  }
  ...
  public static void a(String paramString1, String paramString2)
  {
    ...
    ReportController.b(null, "dc00898", "", "", paramString1, paramString1, jdField_a_of_type_Int, 0, "", "", jdField_a_of_type_JavaLangString, paramString2);
  }
  ...
  public static void a(boolean paramBoolean, int paramInt)
  {
    ...
    for (;;)
    {
      ReportController.b(null, "dc00898", "", "", "0X8008978", "0X8008978", j, i, String.valueOf(paramInt), "", jdField_a_of_type_JavaLangString, String.valueOf(j));
      return;
      i = 0;
    }
  }
  ...
  public static void b(ResultData paramResultData)
  {
    ...
    {
      if (QLog.isDevelopLevel()) {
        QLog.w("RedBagReport", 1, "reportClickEvent, key[" + str1 + "], fromType[" + jdField_a_of_type_Int + "], getRedbag_ResultCode[" + paramResultData.jdField_e_of_type_JavaLangString + "], getRedbag_ResultState[" + paramResultData.jdField_f_of_type_JavaLangString + "], mRoomId[" + jdField_a_of_type_JavaLangString + "], hitScore[" + paramResultData.jdField_a_of_type_Int + "]");
      }
      ReportController.b(null, "dc00898", "", "", str1, str1, jdField_a_of_type_Int, paramResultData.jdField_a_of_type_Int, String.valueOf(paramResultData.jdField_f_of_type_Int), paramResultData.jdField_e_of_type_JavaLangString, jdField_a_of_type_JavaLangString, paramResultData.jdField_f_of_type_JavaLangString);
      return;
      str1 = "0X800897E";
      continue;
      str1 = "0X8008983";
  ...
  public static void b(boolean paramBoolean, int paramInt)
  {
    ...
    ReportController.b(null, "dc00898", "", "", str, str, jdField_a_of_type_Int, 0, String.valueOf(paramInt), "", jdField_a_of_type_JavaLangString, null);
  }
 ...
 * Qualified Name:     com.tencent.av.ui.redbag.RedBagReport
