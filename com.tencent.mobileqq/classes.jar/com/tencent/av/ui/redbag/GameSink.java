  ...
  extends SubHandleBase
{
  ...
  public void a(String paramString1, String paramString2, String paramString3, String paramString4, int paramInt1, int paramInt2, int paramInt3, int paramInt4, String paramString5, String paramString6, String paramString7, boolean paramBoolean, int paramInt5)
  {
    ...
    for (paramInt1 = 0;; paramInt1 = paramString4.length())
    {
      ...
      if ((this.jdField_a_of_type_ComTencentAvUiRedbagResultData.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_ComTencentAvUiRedbagResultData.a()))
      {
        paramString1 = this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getString(2131695775);
        RedBagUtil.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvUiRedbagResultData.jdField_b_of_type_JavaLangString, 0, paramString1);
      }
      if (this.jdField_a_of_type_ComTencentAvUiRedbagResultData.jdField_b_of_type_Boolean) {
