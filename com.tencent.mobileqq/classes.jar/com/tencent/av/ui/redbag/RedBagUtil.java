...
public class RedBagUtil
{
  ...
  public static AVRedBagMgr a(VideoAppInterface paramVideoAppInterface)
  {
    return (AVRedBagMgr)paramVideoAppInterface.a(7);
  }
  ...
  public static boolean a()
  {
    ...
    if ((!EffectsRenderController.a(4, 1800000L)) && (!EffectsRenderController.a(8, 1400000L))) {}
    for (;;)
    {
      ...
      if ((localEffectFaceDeviceConfig != null) && (!localEffectFaceDeviceConfig.c()))
      {
        if (QLog.isColorLevel()) {
  ...
  public static boolean a(VideoAppInterface paramVideoAppInterface)
  {
    ...
    if (paramVideoAppInterface != null) {
      return paramVideoAppInterface.f;
    }
    return false;
  }
  ...
  {
    boolean bool = paramVideoAppInterface.getApp().getSharedPreferences(paramVideoAppInterface.getCurrentAccountUin() + "qav_SP", 0).getBoolean("qav_userguide_for_recever", true);
    if (QLog.isColorLevel()) {
 ...
 * Qualified Name:     com.tencent.av.ui.redbag.RedBagUtil
