...
public class SendRedBag
  extends BaseRedBag
{
  public SendRedBag.SendRedBagListener a;
  public int b = 2;
  public int c = 1;
  ...
  SendRedBag(AVRedBagMgr paramAVRedBagMgr)
  {
    ...
    this.jdField_a_of_type_ComTencentAvUiRedbagSendRedBag$SendRedBagListener = null;
  }
  ...
  void a(String paramString)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (this.jdField_a_of_type_ComTencentAvUiRedbagSendRedBag$SendRedBagListener != null)
      {
        this.jdField_a_of_type_ComTencentAvUiRedbagSendRedBag$SendRedBagListener.a(this);
        this.jdField_a_of_type_ComTencentAvUiRedbagSendRedBag$SendRedBagListener = null;
      }
      return;
    }
  ...
  public boolean a(int paramInt, Intent paramIntent)
  {
    ...
    if (paramIntent != null)
    {
      ...
      AudioHelper.a(HardCodeUtil.a(2131713776), paramIntent.getExtras());
  ...
  public boolean a(VideoAppInterface paramVideoAppInterface, int paramInt, Activity paramActivity, SendRedBag.SendRedBagListener paramSendRedBagListener)
  {
    this.b = 2;
    ...
    try
    {
      ...
      if (paramInt == 2)
      {
        ...
        this.jdField_a_of_type_ComTencentAvUiRedbagSendRedBag$SendRedBagListener = paramSendRedBagListener;
        this.b = 1;
        this.c = paramInt;
        RedBagReport.i();
        return true;
