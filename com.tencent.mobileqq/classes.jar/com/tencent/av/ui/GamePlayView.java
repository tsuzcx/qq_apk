  ...
  implements ljz
{
  ...
  ARGLSurfaceView.SurfaceStateListener jdField_a_of_type_ComTencentMobileqqArmapARGLSurfaceView$SurfaceStateListener = new meh(this);
  ...
  public void a(VideoAppInterface paramVideoAppInterface, Activity paramActivity, String paramString, int paramInt)
  {
    ...
    lcl.c("ARZimuTask_GamePlayView", "init strResPath = " + paramString + "  |  code = " + paramInt);
