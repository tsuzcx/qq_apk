  ...
  implements kzj
{
  ...
  ARGLSurfaceView.SurfaceStateListener jdField_a_of_type_ComTencentMobileqqArmapARGLSurfaceView$SurfaceStateListener = new lto(this);
  ...
  public void a(VideoAppInterface paramVideoAppInterface, Activity paramActivity, String paramString, int paramInt)
  {
    ...
    krx.c("ARZimuTask_GamePlayView", "init strResPath = " + paramString + "  |  code = " + paramInt);
    this.jdField_a_of_type_ComTencentMobileqqArmapARGLSurfaceView = ((ARGLSurfaceView)findViewById(2131301494));
