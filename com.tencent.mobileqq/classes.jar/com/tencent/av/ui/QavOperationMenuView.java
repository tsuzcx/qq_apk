  ...
  implements View.OnClickListener
{
  ...
  mhx jdField_a_of_type_Mhx = null;
  ...
  private void a(mqk parammqk, View paramView)
  {
    paramView.setClickable(parammqk.a());
    int i;
    ...
    if (parammqk.c())
    {
      ...
      if ((paramView instanceof TextView))
      {
        ...
        j = mtr.a(paramView, 2131375173);
        k = mtr.a(paramView, 2131364411);
        String str = parammqk.b();
        paramView = mtr.a(paramView, 2131375198);
        if (TextUtils.isEmpty(str)) {
          break label168;
        }
        localTextView.setTag(2131375173, Integer.valueOf(0));
        if (str != paramView)
        {
          localTextView.setTag(2131375198, str);
          paramView = a(localTextView, str);
          paramView.setBounds(0, 0, actn.a(28.0F, localTextView.getResources()), actn.a(28.0F, localTextView.getResources()));
    ...
    for (;;)
    {
      if (!bbjw.a(parammqk.a())) {
        localTextView.setText(parammqk.a());
      }
      return;
      i = 8;
      break;
      localTextView.setTag(2131375198, null);
      if (parammqk.b()) {}
      for (i = 2131165850;; i = 2131165849)
      {
        ...
        localTextView.setTag(2131375173, Integer.valueOf(parammqk.b()));
        localTextView.setTag(2131364411, Integer.valueOf(i));
        AudioHelper.a(getResources(), localTextView, parammqk.b(), i, i);
        break;
      }
    }
  }
  ...
  private void b()
  {
    ...
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)findViewById(2131363117));
    this.jdField_a_of_type_ComTencentAvUiBeautyBeautySeekView = ((BeautySeekView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131363136));
    this.jdField_a_of_type_ComTencentAvUiBeautyBeautySeekView.a(getContext().getString(2131695710), "BEAUTY_SKIN", 50, 0);
    this.jdField_a_of_type_ComTencentAvUiBeautyBeautySeekView.setBeautySeekActionListener(new mhy(this));
    ImageView localImageView = (ImageView)findViewById(2131363133);
    if (AEFilterSupport.a())
    {
      Drawable localDrawable = getResources().getDrawable(2130841432);
      mts localmts = mts.a(getResources(), 2130841432, 2131165839);
      localmts.setBounds(0, 0, localDrawable.getIntrinsicWidth(), localDrawable.getIntrinsicHeight());
      localImageView.setImageDrawable(localmts);
  ...
  {
    int i = actn.a(28.0F, paramTextView.getResources());
    ...
    paramTextView.setTag(bavi.a(i, i));
  ...
  View a(int paramInt, mqk parammqk)
  {
    ...
    {
      parammqk = a(parammqk);
      this.jdField_a_of_type_AndroidWidgetLinearLayout.addView(parammqk, paramInt);
      return parammqk;
    }
    View localView = this.jdField_a_of_type_AndroidWidgetLinearLayout.getChildAt(paramInt);
    mqk localmqk = (mqk)localView.getTag(2131371127);
    if ((localmqk != null) && (localmqk.a() == parammqk.a())) {
      return localView;
    }
    parammqk = a(parammqk);
    this.jdField_a_of_type_AndroidWidgetLinearLayout.addView(parammqk, paramInt);
  ...
  View a(mqk parammqk)
  {
    ...
    AudioHelper.a(getResources(), localButton, parammqk.b(), 2131165849, 2131165849);
    if (!bbjw.a(parammqk.a())) {
      localButton.setText(parammqk.a());
    }
    localButton.setBackgroundDrawable(null);
    localButton.setId(parammqk.a());
    localButton.setOnClickListener(this);
    localButton.setTag(2131371127, parammqk);
    localButton.setTextSize(bbkx.e(actn.a(12.0F, getResources())));
    localButton.setCompoundDrawablePadding(actn.a(8.0F, getResources()));
    parammqk.a = ((int)Math.max(muf.a(localButton), actn.a(28.0F, getResources())));
    return localButton;
  }
  ...
  public void a()
  {
    ...
    {
      if ((this.jdField_a_of_type_Mqm == null) || (!this.jdField_a_of_type_Mqm.a())) {
        break label119;
      }
      this.jdField_a_of_type_AndroidViewViewGroup.setVisibility(0);
      this.jdField_a_of_type_ComTencentAvUiBeautyBeautySeekView.a = true;
      localObject1 = (ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131363133);
    ...
    for (;;)
    {
      ...
      {
        if ((this.jdField_a_of_type_Mqm != null) && (this.jdField_a_of_type_Mqm.a().size() != 0)) {
          break;
        }
    ...
    Object localObject1 = this.jdField_a_of_type_Mqm.a().iterator();
    int i = 0;
    int j = 0;
    Object localObject2;
    View localView;
    ...
    {
      localObject2 = (mqk)((Iterator)localObject1).next();
      localView = a(j, (mqk)localObject2);
      if (localView != null) {}
    }
    else
    {
      ...
      i = this.jdField_a_of_type_Mqm.a();
      ...
      j = n / i;
      localObject1 = this.jdField_a_of_type_Mqm.b();
      if (k != 0) {
        break label668;
      }
      m = 0;
      ...
      for (;;)
      {
        ...
        localObject2 = (mqk)((ArrayList)localObject1).get(m);
        if (!((mqk)localObject2).c()) {
          break label748;
        }
        if (i == 5) {
          break;
        }
        j = ((mqk)localObject2).a + j;
        label320:
        i += 1;
        label324:
        m += 1;
    ...
    if (localView.getId() == 2131695651)
    {
      ...
      {
        k = (int)muf.b(getContext(), localView.getPaddingRight());
        m = (int)muf.b(getContext(), localView.getPaddingTop());
        this.jdField_a_of_type_ComTencentMobileqqRedtouchRedTouch.a(0, k, m, 0).a();
      }
    }
    if (localView.getId() == 2131695649)
    {
      this.b = lwa.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, localView, 6);
      if (this.b != null)
      {
        k = (int)muf.b(getContext(), localView.getPaddingRight());
        m = (int)muf.b(getContext(), localView.getPaddingTop());
    ...
    a((mqk)localObject2, localView);
    j += 1;
    if ((((mqk)localObject2).c()) && (AudioHelper.a(0) == 1)) {
      if (i % 2 == 0)
      {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        m += 1;
        break label602;
        axqw.b(null, "CliOper", "", "", "0X800A342", "0X800A342", 0, 0, "", "", "", "");
        break;
        n = 0;
        break label631;
        int i1 = i + 1;
        n = ((mqk)((ArrayList)localObject1).get(i)).a + j;
        i = i1;
        break label643;
  ...
  {
    if (paramView.getId() == 2131363133)
    {
      if (this.jdField_a_of_type_Mhx != null) {
        this.jdField_a_of_type_Mhx.a(this, 3);
      }
      if (this.c != null)
      {
    ...
    for (;;)
    {
      if ((paramView.getId() == 2131695651) && (this.jdField_a_of_type_ComTencentMobileqqRedtouchRedTouch != null))
      {
      ...
      if ((paramView.getId() == 2131695649) && (this.b != null))
      {
        lwa.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.b, 6);
        this.b = null;
      }
      return;
      if (this.jdField_a_of_type_Mhx != null) {
        this.jdField_a_of_type_Mhx.a(this, paramView);
      }
    }
  }
  ...
  public void setQavMenuActionListener(mhx parammhx)
  {
    this.jdField_a_of_type_Mhx = parammhx;
  }
  
  public void setViewController(mqm parammqm)
  {
    this.jdField_a_of_type_Mqm = parammqm;
  }
}
