...
public class QavDoubleVideoSharpnessMangaer
{
  ...
  {
    TextView localTextView = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131373871);
    String str = this.jdField_a_of_type_ComTencentAvVideoController.a.getApp().getString(2131695553);
    Object localObject = this.jdField_a_of_type_ComTencentAvVideoController.a.getApp();
    if (paramBoolean) {}
    for (int i = 2131695552;; i = 2131695551)
    {
  ...
  private void h()
  {
    Object localObject4 = (RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131374041);
    Object localObject3 = (RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131374044);
    Object localObject2 = (RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131374050);
    Object localObject1 = (RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131374046);
    ...
    ((RelativeLayout.LayoutParams)localObject4).addRule(1, 2131374041);
    ...
    ((RelativeLayout.LayoutParams)localObject3).addRule(5, 2131374041);
    ((RelativeLayout.LayoutParams)localObject3).addRule(7, 2131374041);
    ((RelativeLayout.LayoutParams)localObject3).addRule(3, 2131374041);
    ...
    ((RelativeLayout.LayoutParams)localObject2).addRule(5, 2131374044);
    ((RelativeLayout.LayoutParams)localObject2).addRule(7, 2131374044);
    ((RelativeLayout.LayoutParams)localObject2).addRule(3, 2131374044);
    ...
    ((RelativeLayout.LayoutParams)localObject1).addRule(8, 2131374052);
    ((RelativeLayout.LayoutParams)localObject1).addRule(14, -1);
    ((RelativeLayout.LayoutParams)localObject1).bottomMargin = k;
    ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131374053)).setLayoutParams((ViewGroup.LayoutParams)localObject1);
    localObject1 = new RelativeLayout.LayoutParams(-2, -2);
    ((RelativeLayout.LayoutParams)localObject1).addRule(8, 2131374048);
    ((RelativeLayout.LayoutParams)localObject1).addRule(14, -1);
    ((RelativeLayout.LayoutParams)localObject1).bottomMargin = k;
    ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131374049)).setLayoutParams((ViewGroup.LayoutParams)localObject1);
  }
  ...
  private void i()
  {
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout == null)
    {
      ...
      this.jdField_a_of_type_ArrayOfAndroidWidgetImageView[0] = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131374042));
      ...
      this.jdField_a_of_type_ArrayOfAndroidWidgetImageView[1] = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131374045));
      ...
      this.jdField_a_of_type_ArrayOfAndroidWidgetImageView[2] = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131374052));
      ...
      ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131374053)).setText(this.jdField_a_of_type_ComTencentAvVideoController.a().n);
      if (AndroidCodec.sIsSupportHwCodec1080P)
      {
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131374046).setVisibility(0);
        this.jdField_a_of_type_ArrayOfAndroidWidgetImageView[3] = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131374048));
        ...
        ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131374049)).setText(this.jdField_a_of_type_ComTencentAvVideoController.a().n);
        h();
      }
  ...
  private void j()
  {
    ...
    label164:
    label171:
    for (int i = 2130842433;; i = 2130842432)
    {
      localImageView.setBackgroundDrawable(localResources.getDrawable(i));
      return;
      i = 2130842430;
  ...
  private void l()
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvVideoController != null)
    {
      ...
      if (localSessionInfo != null) {
        this.jdField_a_of_type_ComTencentAvVideoController.a(Long.valueOf(localSessionInfo.jdField_d_of_type_JavaLangString).longValue(), this.jdField_b_of_type_Int);
      }
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          } while ((localObject == null) || (((SessionInfo)localObject).jdField_d_of_type_Int != 2) || (((SessionInfo)localObject).A()) || ((this.jdField_b_of_type_Boolean) && (this.jdField_c_of_type_Boolean)) || ((this.jdField_a_of_type_ComTencentAvVideoController.a().w != 0) && (this.jdField_a_of_type_ComTencentAvVideoController.a().w != 2)) || (this.jdField_a_of_type_ComTencentAvUiAVActivity.b() != 2));
          localObject = this.jdField_a_of_type_AndroidViewView.findViewById(2131373952);
        } while (((localObject != null) && (((View)localObject).getVisibility() == 0)) || (this.jdField_a_of_type_AndroidViewView.findViewById(2131374079).getVisibility() != 0));
        if (paramInt < 2) {
          break;
        }
      ...
      localObject = (RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131373870);
      a(true);
    ...
    this.jdField_a_of_type_ComTencentAvUiAVActivity.a.N();
    this.jdField_a_of_type_ComTencentAvUiAVActivity.a.D(AudioHelper.b());
    Object localObject = (RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131373870);
    a(true);
    ((RelativeLayout)localObject).setVisibility(0);
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    do
    {
      do
      {
        ...
        } while ((localSessionInfo == null) || (localSessionInfo.jdField_d_of_type_Int != 2) || (localSessionInfo.A()));
      ...
      TipsUtil.a(this.jdField_a_of_type_ComTencentAvVideoController.a, 1058, this.jdField_a_of_type_ComTencentAvVideoController.a.getApp().getString(2131695773));
      this.e = true;
      ReportController.b(null, "CliOper", "", "", "0X800AA60", "0X800AA60", 4, 0, "", "", "", "");
      return;
    } while ((paramInt1 < 1280) || (paramInt2 < 720) || (this.d));
    QLog.i("QavDoubleVideoSharpnessMangaer", 1, "onRecvVideoResolutionChanged. w = " + paramInt1 + ", h = " + paramInt2);
    TipsUtil.a(this.jdField_a_of_type_ComTencentAvVideoController.a, 1058, this.jdField_a_of_type_ComTencentAvVideoController.a.getApp().getString(2131695774));
    this.d = true;
  ...
  public void a(long paramLong1, long paramLong2, long paramLong3)
  {
    if (this.jdField_a_of_type_JavaUtilQueue.size() < 5)
    {
      ...
      if (((Long)localIterator.next()).longValue() >= QAVConfigUtils.b()) {
        break label239;
      }
    ...
    for (;;)
    {
      ...
      if (paramLong1 >= 4L)
      {
        ...
        if (paramLong2 - this.jdField_a_of_type_Long > 10000L)
        {
          ...
          TipsUtil.a(this.jdField_a_of_type_ComTencentAvVideoController.a, 1057, HardCodeUtil.a(2131708893));
  ...
  public void d()
  {
    ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131373870)).setVisibility(4);
    i();
    boolean bool = this.jdField_a_of_type_ComTencentAvUiQavSharpnessSVIPHelper.a();
    ...
    Object localObject = new QavDoubleVideoSharpnessMangaer.4(this);
    localObject = DialogUtil.a(this.jdField_a_of_type_ComTencentAvUiAVActivity, 0, HardCodeUtil.a(2131708888), null, HardCodeUtil.a(2131708889), HardCodeUtil.a(2131708890), (DialogInterface.OnClickListener)localObject, (DialogInterface.OnClickListener)localObject);
    if (localObject != null) {
  ...
  public void e()
  {
    if (this.jdField_a_of_type_ComTencentAvUiQavSharpnessSVIPHelper != null) {
      this.jdField_a_of_type_ComTencentAvUiQavSharpnessSVIPHelper.b();
    }
  }
  ...
  {
    if (this.jdField_a_of_type_ComTencentAvUiQavSharpnessSVIPHelper != null) {
      this.jdField_a_of_type_ComTencentAvUiQavSharpnessSVIPHelper.d();
    }
  }
  ...
  public void g()
  {
    if (this.jdField_a_of_type_ComTencentAvUiQavSharpnessSVIPHelper != null)
    {
      this.jdField_a_of_type_ComTencentAvUiQavSharpnessSVIPHelper.e();
