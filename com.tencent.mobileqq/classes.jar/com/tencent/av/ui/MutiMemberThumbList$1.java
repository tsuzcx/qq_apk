  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      {
        localObject = (ldw)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      ...
      Bitmap localBitmap = MutiMemberThumbList.a(this.this$0).a(String.valueOf(((ldw)localObject).a), String.valueOf(MutiMemberThumbList.a(this.this$0)), MutiMemberThumbList.a(this.this$0), true, true);
      Object localObject = localBitmap;
      if (MutiMemberThumbList.a(this.this$0)) {
        localObject = muf.a(localBitmap, "#4C000000", true);
      }
