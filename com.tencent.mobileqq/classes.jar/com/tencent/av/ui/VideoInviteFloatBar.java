  ...
  implements View.OnClickListener, View.OnTouchListener
{
  ...
  private int jdField_b_of_type_Int = 2131755856;
  ...
  public VideoInviteFloatBar(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)this.jdField_a_of_type_AndroidContentContext.getSystemService("layout_inflater")).inflate(2131559907, null);
    this.jdField_a_of_type_AndroidViewView.setOnTouchListener(this);
  }
  
  public TextView a()
  {
    return (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131372115);
  }
  ...
  {
    ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131366520)).setImageBitmap(paramBitmap);
  }
  
  public void a(Bitmap paramBitmap, String paramString)
  {
    ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131366520)).setImageBitmap(paramBitmap);
    ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131372115)).setText(paramString);
  }
  
  public void a(String paramString)
  {
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131371200));
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    QLog.w("VideoInviteFloatBar", 1, "show, mIsAudioMode[" + this.jdField_c_of_type_Boolean + "], misMultiCall[" + this.jdField_d_of_type_Boolean + "], mIsMultiIncomingCall[" + this.jdField_b_of_type_Boolean + "]");
    if (this.e) {
      return;
    }
    TextView localTextView = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131371200);
    Button localButton1 = (Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131361815);
    Button localButton2 = (Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131376890);
    ...
    if (paramBoolean3) {
      if (this.jdField_c_of_type_Boolean) {
        localTextView.setText(localTextView.getResources().getString(2131695340));
      }
    }
    for (;;)
    {
      ...
      return;
      localTextView.setText(localTextView.getResources().getString(2131695341));
      continue;
      if (this.jdField_c_of_type_Boolean) {
        localTextView.setText(localTextView.getResources().getString(2131695339));
      } else {
        localTextView.setText(localTextView.getResources().getString(2131695342));
      }
    }
  }
  ...
  void b()
  {
    ...
    for (;;)
    {
      ...
      {
        AVLog.printErrorLog("VideoInviteFloatBar", "startHandler error : " + localException2);
      }
  ...
  {
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379380));
  ...
  public void c()
  {
    Object localObject = (Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131361815);
    Button localButton = (Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131376890);
    ((Button)localObject).setVisibility(4);
    localButton.setVisibility(4);
    this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(4);
    localObject = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131371200);
    this.jdField_a_of_type_AndroidViewView.invalidate();
  }
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131361815: 
      l = AudioHelper.b();
      QLog.w("VideoInviteFloatBar", 1, "onClick accept, mIsMultiIncomingCall[" + this.jdField_b_of_type_Boolean + "], misMultiCall[" + this.jdField_d_of_type_Boolean + "], seq[" + l + "]");
      localIntent = new Intent();
      SeqUtil.a(localIntent, l);
      if (this.jdField_b_of_type_Boolean) {
        localIntent.setAction("tencent.video.invite.multiaccept");
      }
      for (;;)
      {
        ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131361815)).setClickable(false);
        ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131376890)).setClickable(false);
    ...
    QLog.w("VideoInviteFloatBar", 1, "onClick reject, mIsMultiIncomingCall[" + this.jdField_b_of_type_Boolean + "], misMultiCall[" + this.jdField_d_of_type_Boolean + "], seq[" + l + "]");
