  ...
  implements mmg
{
  ...
  {
    View localView = LayoutInflater.from(paramContext).inflate(2131559695, this);
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)localView.findViewById(2131369536));
    this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)localView.findViewById(2131365016));
    this.jdField_a_of_type_Mlx = new mlx(paramContext);
    ...
    this.jdField_a_of_type_AndroidWidgetListView.setAdapter(this.jdField_a_of_type_Mlx);
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)this.jdField_b_of_type_AndroidWidgetLinearLayout.findViewById(2131368654));
    this.jdField_a_of_type_AndroidWidgetEditText.setFilters(new InputFilter[] { new InputFilter.LengthFilter(40) });
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidWidgetLinearLayout.findViewById(2131365945));
    this.c = ((LinearLayout)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131365952));
    setFitsSystemWindows(true);
  }
  
  private void c(Context paramContext)
  {
    this.jdField_a_of_type_Mlz = mlz.a((Activity)paramContext).a(this).a((VideoChatRoomListView)this.jdField_a_of_type_AndroidWidgetListView).a(this.jdField_a_of_type_AndroidWidgetEditText).a(this.jdField_a_of_type_AndroidWidgetImageView).a();
    paramContext = new LinearLayout.LayoutParams(-1, -1);
    this.jdField_a_of_type_ComTencentMobileqqEmoticonviewSystemAndEmojiEmoticonPanelWithActionBar = new SystemAndEmojiEmoticonPanelWithActionBar(getContext(), this.jdField_a_of_type_Mlz);
    this.jdField_a_of_type_ComTencentMobileqqEmoticonviewSystemAndEmojiEmoticonPanelWithActionBar.setBackgroundColor(-1);
    this.jdField_a_of_type_ComTencentMobileqqEmoticonviewSystemAndEmojiEmoticonPanelWithActionBar.setId(2131373222);
    ...
    this.jdField_a_of_type_Mlz.a(this.c);
  }
  ...
  public int a()
  {
    int j = 0;
    int i;
    if (this.jdField_a_of_type_Mlz.b()) {
      i = this.c.getHeight();
    }
    do
    {
      do
      {
        return i;
        i = j;
      } while (!this.jdField_a_of_type_Mlz.c());
      i = j;
    } while (this.jdField_a_of_type_Mlz.jdField_a_of_type_Boolean);
    return ljs.jdField_a_of_type_Int;
  }
  ...
  public void a(int paramInt)
  {
    boolean bool2 = true;
    int n = 0;
    boolean bool1 = this.jdField_a_of_type_Mlz.a();
    int i;
    int j;
    label42:
    ...
    for (int m = paramInt;; m = 0)
    {
      ...
      i = this.jdField_a_of_type_Mlz.a();
      if ((i != 0) && (i != 7))
      {
        paramInt = n;
        if (this.jdField_a_of_type_Mlz.jdField_a_of_type_Boolean)
        {
          if (i != 4) {
            break label243;
          }
  ...
  {
    if (this.jdField_a_of_type_Mlz == null) {
      return;
    }
    switch (paramInt)
    {
  ...
  {
    lbc.c("VideoChatRoomContainer", "notifyEvent :" + paramInt + "|" + paramObject);
  ...
  public void a(VideoLayerUI paramVideoLayerUI, int paramInt)
  {
    ...
    if (paramInt == 1)
    {
      ...
      if ((paramVideoLayerUI == null) || (paramVideoLayerUI.jdField_a_of_type_ArrayOfMdt.length <= 1) || (paramVideoLayerUI.jdField_a_of_type_ArrayOfMdt[1] == null)) {
        break label249;
      }
      if (paramVideoLayerUI.jdField_a_of_type_ArrayOfMdt[1].a() == 0)
      {
        paramInt = 1;
        m = paramVideoLayerUI.jdField_a_of_type_ArrayOfMdt[1].b();
        i = paramInt;
      }
    }
  ...
  {
    Object localObject = mmh.a();
    ((mmh)localObject).a(1);
    ((mmh)localObject).a(paramString);
    ((mmh)localObject).b(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin());
    this.jdField_a_of_type_Mlx.a((mmh)localObject);
    this.jdField_a_of_type_AndroidWidgetListView.setSelection(this.jdField_a_of_type_Mlx.getCount() - 1);
    localObject = getContext();
    if ((localObject instanceof AVActivity))
    {
      localObject = (AVActivity)localObject;
      if (((AVActivity)localObject).jdField_a_of_type_Mmj != null) {
        ((AVActivity)localObject).jdField_a_of_type_Mmj.a(paramString);
      }
    }
  }
  ...
  {
    this.jdField_a_of_type_Mlx.a(paramList, paramBoolean);
    this.jdField_a_of_type_AndroidWidgetListView.setSelection(this.jdField_a_of_type_Mlx.getCount() - 1);
  }
  ...
  public boolean a()
  {
    if (this.jdField_a_of_type_Mlz.b())
    {
      this.jdField_a_of_type_Mlz.e();
      return true;
    }
    if (this.jdField_a_of_type_Mlz.c())
    {
      this.jdField_a_of_type_Mlz.f();
      return true;
    }
    return false;
  }
  ...
  public boolean b()
  {
    return (this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(3)) && (((lgp)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(3)).a() != null);
  }
  
  public boolean c()
  {
    return (this.jdField_a_of_type_Mlz != null) && (this.jdField_a_of_type_Mlz.c());
  }
  
  public boolean dispatchTouchEvent(MotionEvent paramMotionEvent)
  {
    if (((AVActivity)getContext()).findViewById(2131373238) != null) {}
    for (int i = 1; i != 0; i = 0)
    {
      this.jdField_a_of_type_Mlz.a();
    ...
    if ((!bool2) && (this.jdField_a_of_type_Mlz.c()))
    {
    ...
    for (boolean bool1 = paramMotionEvent.isActive();; bool1 = false)
    {
      ...
      return bool2;
      if ((!bool2) && (this.jdField_a_of_type_Mlz.b())) {
        this.jdField_a_of_type_Mlz.e();
      }
      return bool2;
    }
  ...
  public void setVisibility(int paramInt)
  {
    ...
    if ((getVisibility() == 8) && (this.jdField_a_of_type_Mlz != null))
    {
      if (this.jdField_a_of_type_Mlz.b()) {
        this.jdField_a_of_type_Mlz.e();
      }
