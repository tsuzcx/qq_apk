...
{
  MultiVideoCtrlLayerUIBase$11(MultiVideoCtrlLayerUIBase paramMultiVideoCtrlLayerUIBase, long paramLong) {}
  ...
  public void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvUiMultiVideoCtrlLayerUIBase.a.a().b() == -1) {
      this.jdField_a_of_type_ComTencentAvUiMultiVideoCtrlLayerUIBase.s(this.jdField_a_of_type_Long);
    }
    for (;;)
    {
