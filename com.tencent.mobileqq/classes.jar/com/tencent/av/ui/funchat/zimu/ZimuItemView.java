  ...
  implements IZimuItemView
{
  ...
  public ZimuItemView(Context paramContext, WeakReference paramWeakReference, int paramInt1, int paramInt2, float paramFloat)
  {
  ...
  {
    AVLog.c("ZimuItemView", "start:" + paramLong);
  }
  ...
  Bitmap b()
  {
    ...
    do
    {
      ...
      {
        return localObject3;
        AVLog.c("ZimuItemView", "build:" + toString());
        ...
        catch (OutOfMemoryError localOutOfMemoryError)
        {
          ...
          {
            QLog.e("ZimuItemView", 2, localOutOfMemoryError.getMessage());
            return localObject1;
          }
        }
    ...
    QLog.e("ZimuItemView", 2, localException.getMessage());
  ...
  void d()
  {
    AVLog.c("ZimuItemView", "releaseBitmap:" + this.jdField_a_of_type_AndroidGraphicsBitmap);
