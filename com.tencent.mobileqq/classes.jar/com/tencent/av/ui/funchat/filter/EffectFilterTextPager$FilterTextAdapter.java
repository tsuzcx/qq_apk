  ...
  extends PagerAdapter
{
  ...
  public Object instantiateItem(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    {
      ViewGroup localViewGroup = (ViewGroup)((LayoutInflater)localContext.getSystemService("layout_inflater")).inflate(2131559792, null);
      ImageView localImageView = (ImageView)localViewGroup.findViewById(2131373286);
      ...
      for (localObject = ((FilterItem)localObject).getIconurl();; localObject = null)
      {
        ...
        for (;;)
        {
          if (this.jdField_a_of_type_Boolean)
          {
            ...
            float f = localContext.getResources().getDimension(2131297705);
          ...
          localURLDrawableOptions.mRequestWidth = localContext.getResources().getDimensionPixelSize(2131297710);
          localURLDrawableOptions.mRequestHeight = localContext.getResources().getDimensionPixelSize(2131297709);
