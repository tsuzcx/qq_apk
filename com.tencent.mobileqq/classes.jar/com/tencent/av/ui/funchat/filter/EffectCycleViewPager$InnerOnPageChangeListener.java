  ...
  implements ViewPager.OnPageChangeListener
{
  ...
  public void onPageScrollStateChanged(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        AVLog.printColorLog("EffectCycleViewPager", "onPageScrollStateChanged 11:" + (this.jdField_a_of_type_ComTencentAvUiFunchatFilterEffectCycleViewPager.a.getCount() - 2));
