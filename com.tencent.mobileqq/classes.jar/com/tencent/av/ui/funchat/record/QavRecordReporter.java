...
public class QavRecordReporter
{
  ...
  public static void a(int paramInt1, int paramInt2, int paramInt3, long paramLong)
  {
    ...
    ThreadManager.post(new kdw(paramInt2, i, l1, l2, j, l3, paramLong, paramInt1, paramInt3), 5, null, false);
  }
  ...
  public static void a(long paramLong)
  {
    ...
    localHashMap.put("device_model", DeviceInfoUtil.e());
    localHashMap.put("api", DeviceInfoUtil.f());
    localHashMap.put("manufacture", DeviceInfoUtil.i());
    StatisticCollector localStatisticCollector = StatisticCollector.a(BaseApplicationImpl.getContext());
    if (!jdField_a_of_type_Boolean) {}
    for (boolean bool = true;; bool = false)
    {
      localStatisticCollector.a("", "av_record_convert_pcm_cost", bool, paramLong / 1000L, 0L, localHashMap, "", false);
      return;
    }
  }
  ...
  public static void a(boolean paramBoolean, int paramInt)
  {
    ...
    StatisticCollector.a(BaseApplicationImpl.getContext()).a("", "av_record_convert_pcm_success", paramBoolean, 0L, 0L, localHashMap, "", false);
  }
  ...
  public static void d()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      localStatisticCollector.a("", "av_record_report_end", bool, 0L, 0L, localHashMap, "", false);
      return;
    }
  }
  ...
  public static void e()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      localStatisticCollector.a("", "av_record_audio_fail", bool, 0L, 0L, localHashMap, "", false);
      return;
    }
  }
  ...
  public static void f()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      localStatisticCollector.a("", "av_record_convert_pcm_timeout", bool, 0L, 0L, localHashMap, "", false);
      return;
    }
  }
}
