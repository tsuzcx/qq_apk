...
public class PCMLoader
{
  ...
  private LruCache<String, PCMLoader.PCMData> jdField_a_of_type_AndroidUtilLruCache = new PCMLoader.1(this, 4194304);
  private PCMLoader.PlayItem jdField_a_of_type_ComTencentAvUiFunchatRecordPCMLoader$PlayItem;
  private LinkedList<PCMLoader.PlayItem> jdField_a_of_type_JavaUtilLinkedList = new LinkedList();
  ...
  public void a()
  {
    try
    {
      this.jdField_a_of_type_ComTencentAvUiFunchatRecordPCMLoader$PlayItem = null;
      return;
    }
    finally
    {
  ...
  public void a(String paramString)
  {
    for (;;)
    {
      try
      {
        ...
        PCMLoader.PCMData localPCMData = (PCMLoader.PCMData)this.jdField_a_of_type_AndroidUtilLruCache.get(paramString);
        if (localPCMData != null)
        {
          this.jdField_a_of_type_ComTencentAvUiFunchatRecordPCMLoader$PlayItem = new PCMLoader.PlayItem(localPCMData, true);
          continue;
        }
        if (!QLog.isColorLevel()) {
          break label96;
      ...
      label96:
      a(paramString);
      paramString = (PCMLoader.PCMData)this.jdField_a_of_type_AndroidUtilLruCache.get(paramString);
      if (paramString != null) {
        this.jdField_a_of_type_ComTencentAvUiFunchatRecordPCMLoader$PlayItem = new PCMLoader.PlayItem(paramString, true);
      }
    }
  }
  ...
  public void a(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    try
    {
      ...
      PCMLoader.PlayItem localPlayItem = this.jdField_a_of_type_ComTencentAvUiFunchatRecordPCMLoader$PlayItem;
      if (localPlayItem != null) {
        localPlayItem.a(this.jdField_a_of_type_ArrayOfByte, 0, paramInt);
      }
      Arrays.fill(this.b, (byte)0);
      if ((this.jdField_a_of_type_JavaUtilLinkedList.size() > 0) && (i < paramInt))
      {
        localPlayItem = (PCMLoader.PlayItem)this.jdField_a_of_type_JavaUtilLinkedList.get(0);
        if (localPlayItem != null)
        {
          int j = i + localPlayItem.a(this.b, i, paramInt);
          i = j;
          if (!localPlayItem.a()) {
            break label229;
          }
  ...
  public boolean a(String paramString)
  {
    ...
    do
    {
      ...
      if (arrayOfByte != null)
      {
        localObject = new PCMLoader.PCMData(paramString, arrayOfByte);
  ...
  public void b(String paramString)
  {
    for (;;)
    {
      try
      {
        ...
        if (localPCMData != null)
        {
          paramString = new PCMLoader.PlayItem(localPCMData, false);
      ...
      if (paramString != null)
      {
        paramString = new PCMLoader.PlayItem(paramString, false);
        this.jdField_a_of_type_JavaUtilLinkedList.add(paramString);
      }
    }
  }
