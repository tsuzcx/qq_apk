  ...
  implements Runnable
{
  ...
  public VideoLayerUI$MultiVideoOpenAnimation(VideoLayerUI paramVideoLayerUI, int paramInt)
  {
    ...
    paramVideoLayerUI = paramVideoLayerUI.jdField_a_of_type_ArrayOfLtl[this.jdField_a_of_type_Int];
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      return;
      ltl localltl = this.this$0.jdField_a_of_type_ArrayOfLtl[this.jdField_a_of_type_Int];
      Rect localRect = localltl.b();
      int i = (int)(localRect.left - this.jdField_a_of_type_Float);
      int j = localRect.width();
      localltl.b(i, localRect.top, j + i, localRect.bottom);
      localltl.b();
    }
  }
}
