  ...
  extends DiscussionObserver
{
  ...
  public void a(boolean paramBoolean, int paramInt, long paramLong1, String paramString1, String paramString2, long paramLong2)
  {
    ...
    if (paramBoolean)
    {
      ...
      {
        this.a.jdField_a_of_type_ComTencentAvUiConferenceFlyTicketActivity$OnAfterCreateDiscussionAsyncTask = new ConferenceFlyTicketActivity.OnAfterCreateDiscussionAsyncTask(this.a);
        paramString1 = new ArrayList();
        DownloadParams localDownloadParams = new DownloadParams();
        localDownloadParams.jdField_a_of_type_JavaLangString = ("https://pubacc.mobile.qq.com/mqqweb-rtx2qq/mqqweb/createConfCallback?feedkey=" + this.a.b);
  ...
  public void onUpdate(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    if (paramInt == 0)
    {
      ...
      {
        this.a.c();
        AudioHelper.b(HardCodeUtil.a(2131702434));
