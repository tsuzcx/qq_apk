...
public class ScreenRecordHelper
{
  ...
  {
    if ((!paramBoolean) && (this.jdField_a_of_type_ComTencentAvUiScreenRecordHelper$OnMediaProjectionReadyListener != null)) {
      this.jdField_a_of_type_ComTencentAvUiScreenRecordHelper$OnMediaProjectionReadyListener.b(1);
    }
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        {
          if (QLog.isDevelopLevel()) {
            QLog.i("ScreenRecordHelper", 4, "updateRecordParam, pre[" + this.jdField_a_of_type_ComTencentAvcoreDataRecordParam + "], display[" + this.jdField_b_of_type_Int + "," + this.c + "], limit[" + i + "," + j + "], come[" + paramInt1 + "," + paramInt2 + "," + paramInt3 + "], record[" + m + "," + k + "]");
          }
          this.jdField_a_of_type_ComTencentAvcoreDataRecordParam.width = m;
          this.jdField_a_of_type_ComTencentAvcoreDataRecordParam.height = k;
          if (paramInt3 > 0) {
            this.jdField_a_of_type_ComTencentAvcoreDataRecordParam.fps = paramInt3;
          }
          if (this.jdField_a_of_type_ComTencentAvOpenglEffectsEGLScreenCaptureThread != null) {
  ...
  {
    if (this.jdField_a_of_type_ComTencentAvOpenglEffectsEGLScreenCaptureThread != null) {
      this.jdField_a_of_type_ComTencentAvOpenglEffectsEGLScreenCaptureThread.a(paramonVideoFrameAvailableListener);
    }
  }
  ...
  public boolean a(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvUiScreenRecordHelper$OnMediaProjectionReadyListener != null) {
      this.jdField_a_of_type_ComTencentAvUiScreenRecordHelper$OnMediaProjectionReadyListener.a(paramInt);
    }
    a(null);
    a(null);
    ...
    if (this.jdField_a_of_type_JavaLangRefWeakReference == null) {
      if ((localContext != null) && (Build.VERSION.SDK_INT >= 21))
      {
        ...
        SmallScreenUtils.a(l, 3, localContext);
      }
    }
    label162:
    while (paramInt == 2)
  ...
  public boolean a(Intent paramIntent)
  {
    ...
    d();
    if (this.jdField_a_of_type_ComTencentAvUiScreenRecordHelper$OnMediaProjectionReadyListener != null) {
      this.jdField_a_of_type_ComTencentAvUiScreenRecordHelper$OnMediaProjectionReadyListener.a(this.jdField_a_of_type_ComTencentAvcoreDataRecordParam, this.jdField_b_of_type_Int, this.c);
    }
    paramIntent = VideoController.a().a;
    if (Build.VERSION.SDK_INT >= 21) {
      SmallScreenUtils.a(l, 3, localContext, true, paramIntent.getCurrentAccountUin(), true);
    }
  ...
  public void c()
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvOpenglEffectsEGLScreenCaptureThread != null)
    {
      this.jdField_a_of_type_ComTencentAvOpenglEffectsEGLScreenCaptureThread.a(true);
