  ...
  implements View.OnClickListener
{
  ...
  private View.OnTouchListener jdField_a_of_type_AndroidViewView$OnTouchListener = new mdr(this);
  ...
  private ArrayList<ldr> jdField_a_of_type_JavaUtilArrayList;
  private lfb jdField_a_of_type_Lfb = new mdx(this);
  private lfp jdField_a_of_type_Lfp = new mds(this);
  public mdl a;
  ...
  private void a(int paramInt)
  {
    ...
    label43:
    for (String str = ajya.a(2131705159);; str = ajya.a(2131705158))
    {
  ...
  private void a(long paramLong, boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Mdl != null) {
      this.jdField_a_of_type_Mdl.a(paramLong, paramBoolean);
    }
  }
  ...
  private void d()
  {
    RelativeLayout localRelativeLayout = (RelativeLayout)super.findViewById(2131375493);
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView = ((PinnedDividerListView)super.findViewById(2131377855));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131372378));
    ...
    if (bool)
    {
      ...
      ((TextView)super.findViewById(2131368429)).setBackgroundDrawable(getResources().getDrawable(2130849040));
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      ((View)localObject).findViewById(2131375493).setBackgroundColor(Color.parseColor("#080808"));
      ((TextView)((View)localObject).findViewById(2131377046)).setTextColor(Color.parseColor("#757575"));
    }
    label383:
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidViewView.setOnTouchListener(new mdt(this));
      this.jdField_a_of_type_AndroidViewView.setOnClickListener(new mdu(this));
      return;
      ...
      for (localObject = "#080808";; localObject = "#F5F6FA")
      {
        ...
        localView.setLayoutParams(new AbsListView.LayoutParams(-1, actj.a(12.0F, localRelativeLayout.getResources())));
  ...
  private void e()
  {
    ...
    TextView localTextView1 = (TextView)localView.findViewById(2131372262);
    localView.setLayoutParams(new ViewGroup.LayoutParams(-1, -2));
    localbfpc.a(localView);
    localView = new View(this);
    localView.setBackgroundColor(Color.parseColor("#E5E6E7"));
    localView.setLayoutParams(new ViewGroup.LayoutParams(-1, actj.a(1.0F, getResources())));
    localbfpc.a(localView);
    localView = super.getLayoutInflater().inflate(2131558434, null);
    TextView localTextView2 = (TextView)localView.findViewById(2131361913);
    localView.setId(0);
    ...
    {
      localTextView2.setText(super.getString(2131695834));
      localTextView2.setTextColor(super.getResources().getColor(2131165204));
      if (bool) {}
      for (i = 2131695835;; i = 2131695836)
      {
        localTextView1.setText(super.getString(i));
        localbfpc.a(localView);
        localbfpc.d(super.getResources().getString(2131690573));
        localView.setOnClickListener(new mdv(this, localbfpc));
        localbfpc.setOnDismissListener(new mdw(this));
    ...
    {
      localTextView2.setText(super.getString(2131695837));
      localTextView2.setTextColor(super.getResources().getColor(2131165201));
      if (bool) {}
      for (i = 2131695838;; i = 2131695839)
      {
        localTextView1.setText(super.getString(i));
        break;
      }
  ...
  public void a()
  {
    ...
    {
      if (locallga.U) {
        this.jdField_b_of_type_AndroidWidgetTextView.setText(super.getString(2131695834));
      }
    }
    else {
      return;
    }
    this.jdField_b_of_type_AndroidWidgetTextView.setText(super.getString(2131695837));
  }
  ...
  void c()
  {
    f();
    if (this.jdField_a_of_type_Mdl != null) {
      this.jdField_a_of_type_Mdl.a(this.jdField_a_of_type_JavaUtilArrayList);
    }
  }
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    f();
    this.jdField_a_of_type_Mdl = new mdl(this, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentMobileqqWidgetPinnedDividerListView, this.jdField_a_of_type_ComTencentAvVideoController.a().g, this.jdField_a_of_type_ComTencentAvVideoController.a().E, this.jdField_a_of_type_Boolean);
    this.jdField_a_of_type_Mdl.a(this.jdField_a_of_type_JavaUtilArrayList);
    a();
    ...
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new mdy(this);
  ...
  public void doOnDestroy()
  {
    ...
    this.jdField_a_of_type_Mdl.b();
    this.jdField_a_of_type_Mdl = null;
