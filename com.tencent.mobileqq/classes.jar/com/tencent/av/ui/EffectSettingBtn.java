...
public class EffectSettingBtn
{
  ...
  {
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131381088) != null)
    {
  ...
  private boolean a(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if (paramBoolean)
      {
        ...
        if (this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().a().ax) {
          return false;
        }
    ...
    } while (EffectsRenderController.d());
    return false;
  }
  ...
  private void b(TextView paramTextView)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetPopupWindow.setAnimationStyle(2131755834);
    paramTextView.measure(0, 0);
  ...
  private void d()
  {
    ...
    {
      TextView localTextView = (TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131381088);
  ...
  private void e()
  {
    ...
    do
    {
      ...
      localTextView = null;
      if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null) {
        localTextView = (TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131381088);
      }
    ...
    float f1 = i - m - this.jdField_a_of_type_AndroidViewView.getWidth() / 2 - k / 2 - i1 + AIOUtils.a(0.0F, this.jdField_a_of_type_AndroidViewView.getResources());
    float f2 = j - n - i2 - AIOUtils.a(11.0F, this.jdField_a_of_type_AndroidViewView.getResources());
