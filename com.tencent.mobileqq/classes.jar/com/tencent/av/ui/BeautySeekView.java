  ...
  extends RelativeLayout
{
  ...
  SeekBar.OnSeekBarChangeListener jdField_a_of_type_AndroidWidgetSeekBar$OnSeekBarChangeListener = new lri(this);
  ...
  private void a(Context paramContext)
  {
    ...
    paramContext = inflate(paramContext, 2131493992, this);
    this.jdField_a_of_type_AndroidViewView = paramContext.findViewById(2131306767);
    this.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130841362);
    this.jdField_a_of_type_AndroidWidgetSeekBar = ((SeekBar)paramContext.findViewById(2131306686));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramContext.findViewById(2131306685));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramContext.findViewById(2131306687));
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130841370);
    ...
    this.jdField_a_of_type_AndroidWidgetSeekBar.getViewTreeObserver().addOnGlobalLayoutListener(new lrh(this));
    this.jdField_b_of_type_Int = aciy.a(24.0F, getResources());
  ...
  private void c(int paramInt)
  {
    ...
    else
    {
      ...
      this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130841366);
    }
    for (;;)
    {
      ...
      label65:
      if (paramInt <= 30) {
        this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130841368);
      } else if (paramInt <= 60) {
        this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130841369);
      } else {
        this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130841367);
      }
    }
  }
  ...
  public void setBeautySeekActionListener(lrj paramlrj)
  {
    this.jdField_a_of_type_Lrj = paramlrj;
  }
 ...
 * Qualified Name:     com.tencent.av.ui.BeautySeekView
