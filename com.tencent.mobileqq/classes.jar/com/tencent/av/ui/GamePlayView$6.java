  ...
  implements Runnable
{
  public void run()
  {
    ...
    lek.c("ARZimuTask_GamePlayView", "createEngineBusiness " + GamePlayView.a(this.this$0).getWidth() + "|" + GamePlayView.a(this.this$0).getHeight() + "|" + this.jdField_a_of_type_Int + "|" + this.b);
