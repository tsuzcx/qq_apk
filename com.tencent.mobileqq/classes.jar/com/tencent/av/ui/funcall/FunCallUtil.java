...
public class FunCallUtil
{
  public static int a(AppRuntime paramAppRuntime, String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    label67:
    for (i = VipFunCallManager.a(paramAppRuntime, paramString, 6, paramBoolean1, null); i != 0; i = VipFunCallManager.a(paramAppRuntime, paramAppRuntime.getAccount(), 6, paramBoolean1, paramString))
    {
      if (AudioHelper.e()) {
