  ...
  extends VideoInviteActivity
{
  ...
  Runnable jdField_b_of_type_JavaLangRunnable = new kci(this);
  public TextView c;
  TextView d;
  int l;
  int m;
  ...
  protected void b()
  {
    ...
    this.jdField_a_of_type_ComTencentAvUiQavPanel.a(new kch(this));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)super.findViewById(2131364214));
    Drawable localDrawable = BitmapTools.a(super.getApplicationContext(), 2130840203);
    if (localDrawable != null)
    {
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundDrawable(localDrawable);
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)super.findViewById(2131364217));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131364218));
      ...
      this.jdField_a_of_type_ComTencentAvUiQavPanel.setViewVisibility(2131364225, 8);
      this.jdField_a_of_type_ComTencentAvUiQavPanel.a(2131364228, 2130840097);
      this.jdField_a_of_type_ComTencentAvUiQavPanel.b(2131364223, 9, 0);
      this.jdField_a_of_type_ComTencentAvUiQavPanel.a(2131364223, 1, 0);
      this.jdField_a_of_type_ComTencentAvUiQavPanel.b(2131364223, 14);
    }
    for (;;)
    {
      super.h();
      super.setTitle(this.jdField_d_of_type_JavaLangString + super.getString(2131428883));
      ...
      else if (this.jdField_b_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_ComTencentAvUiQavPanel.setViewVisibility(2131365391, 8);
        this.jdField_a_of_type_ComTencentAvUiQavPanel.b(2131364225, 11);
        this.jdField_a_of_type_ComTencentAvUiQavPanel.a(2131364225, 2, super.getResources().getDimensionPixelSize(2131559828));
        this.jdField_a_of_type_ComTencentAvUiQavPanel.a(2131364228, 2130840097);
        UITools.a(this.jdField_b_of_type_AndroidWidgetTextView, super.getResources().getString(2131429058));
      }
      else
      {
        UITools.a(this.jdField_b_of_type_AndroidWidgetTextView, super.getResources().getString(2131428837));
      }
    }
  }
  ...
  void k()
  {
    ImageView localImageView = (ImageView)super.findViewById(2131364217);
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.jdField_b_of_type_AndroidContentBroadcastReceiver = new kcj(this);
    ...
    if (i <= 320)
    {
      ...
      if ((FontSettingManager.a() == 20.0F) || (FontSettingManager.a() == 18.0F) || (FontSettingManager.a() == 17.0F))
      {
        ...
        {
          this.jdField_a_of_type_ComTencentAvUiQavPanel.a(2131364223, 1, super.getResources().getDimensionPixelSize(2131559876));
          this.jdField_a_of_type_ComTencentAvUiQavPanel.a(2131365391, 2, super.getResources().getDimensionPixelSize(2131559876));
        }
        if ((this.l <= 800) || ((e()) && (this.l <= 1280))) {
          this.jdField_a_of_type_ComTencentAvUiQavPanel.a(2131364224, 4, 0);
        }
      }
    ...
    for (;;)
    {
      ...
      int j = paramBundle.getDimensionPixelSize(2131559847);
      j = j * 2 / 3;
      break label303;
      label733:
      this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
