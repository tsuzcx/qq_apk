  ...
  implements Runnable
{
  ...
  {
    int i = 2130842374;
    if ((DoubleVideoCtrlUI.RecordInfo.a(this.this$0) == null) || (DoubleVideoCtrlUI.RecordInfo.a(this.this$0) == null) || (DoubleVideoCtrlUI.RecordInfo.a(this.this$0).a == null)) {}
    while (DoubleVideoCtrlUI.RecordInfo.b(this.this$0) != 1) {
      return;
    }
    DoubleVideoCtrlUI.RecordInfo.c(this.this$0);
    if (DoubleVideoCtrlUI.RecordInfo.d(this.this$0) < 3)
    {
    ...
    DoubleVideoCtrlUI.RecordInfo.a(this.this$0, 2130842374);
    DoubleVideoCtrlUI.RecordInfo.a(this.this$0).a.i(-1026L, 16777215);
    Object localObject = (QavRecordButtonView)DoubleVideoCtrlUI.RecordInfo.a(this.this$0).findViewById(2131376780);
    if (localObject != null) {
