  ...
  public void a(long paramLong, String[] paramArrayOfString, String paramString1, String paramString2, String paramString3)
  {
    ...
    do
    {
      do
      {
        ...
        paramString2 = "";
        String[] arrayOfString = ((SessionInfo)localObject).a;
        if (((SessionInfo)localObject).c != 3)
        {
          paramString2 = ((SessionInfo)localObject).q;
          ((SessionInfo)localObject).b("onDeviceListUpdate", paramString1);
        }
        ((SessionInfo)localObject).a = paramArrayOfString;
        ((SessionInfo)localObject).r = paramString3;
        TraeHelper.a(this.a, paramArrayOfString);
        TraeHelper.a(this.a, paramString2, paramString1);
        if (TraeHelper.a(this.a) != null) {
      ...
      } while (TraeHelper.a(this.a) == null);
