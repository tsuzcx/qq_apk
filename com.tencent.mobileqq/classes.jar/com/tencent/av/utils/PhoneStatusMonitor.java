...
public class PhoneStatusMonitor
{
  ...
  public PhoneStatusMonitor(Context paramContext, PhoneStatusMonitor.PhoneStatusListener paramPhoneStatusListener)
  {
    ...
    this.jdField_a_of_type_JavaLangRunnable = new kgr(this);
    ...
    try
    {
      this.jdField_a_of_type_AndroidTelephonyPhoneStateListener = new kgv(this);
    ...
    catch (Exception paramPhoneStatusListener)
    {
      try
      {
        do
        {
          ThreadManager.post(new kgq(this, paramContext), 5, null, false);
          if (QLog.isColorLevel()) {
          ...
          paramContext.registerReceiver(this.jdField_a_of_type_Kgt, paramPhoneStatusListener);
          if (QLog.isColorLevel()) {
  ...
  protected void finalize()
  {
    try
    {
      ...
      this.jdField_a_of_type_AndroidContentContext.unregisterReceiver(this.jdField_a_of_type_Kgt);
      this.jdField_a_of_type_ComTencentAvUtilsPhoneStatusMonitor$PhoneStatusListener = null;
      this.jdField_a_of_type_Kgt = null;
