  ...
  extends AVCoreUtil
{
  ...
  {
    int i = AIOUtils.a(paramFloat, paramContext.getResources());
      ...
      do
      {
        ...
        do
        {
          do
          {
            ...
            {
              return localObject2;
              Object localObject3 = ((FriendsManager)paramQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER)).a(paramString);
  ...
  {
    int j = 0;
    String str = HardCodeUtil.a(2131715720);
    ...
    for (;;)
    {
      if ((k > 0) || (j > 0) || (i > 0))
      {
        paramString = str;
        if (k > 0) {
          paramString = str + k + HardCodeUtil.a(2131715718);
        }
        str = paramString;
        if (j > 0) {
          str = paramString + j + HardCodeUtil.a(2131715717);
        }
        paramString = str;
        if (i > 0) {
          paramString = str + i + HardCodeUtil.a(2131715716);
        }
        return paramString;
  ...
  public static void a()
  {
    ...
    SharedPreUtils.a(BaseApplicationImpl.getApplication().getSharedPreferences("UITools", 4).edit().putBoolean("has_show_svip_dialog", false));
  }
  ...
  public static void a(int paramInt)
  {
    ...
    for (;;)
    {
      SharedPreUtils.a(BaseApplicationImpl.getApplication().getSharedPreferences("UITools", 4).edit().putInt(str, 0));
      return;
  ...
  public static void a(View paramView, String paramString, int paramInt)
  {
    if (jdField_a_of_type_Boolean)
    {
      ...
      if (paramInt == 2) {
        str = paramString.replace(paramView.getResources().getString(2131695359), HardCodeUtil.a(2131715719));
      }
      if (QLog.isColorLevel()) {
  ...
  public static void a(boolean paramBoolean)
  {
    ...
    {
      SharedPreUtils.a(localEditor.putBoolean(str, true));
      return;
  ...
  public static boolean a(int paramInt)
  {
    if (paramInt == 1)
    {
      if (jdField_a_of_type_Int == -1) {
        jdField_a_of_type_Int = BaseApplicationImpl.getApplication().getSharedPreferences("UITools", 4).getInt("grid_enable_switch", 1);
      }
      if (jdField_a_of_type_Int != 1) {}
    }
    do
    {
      ...
      if (jdField_b_of_type_Int == -1) {
        jdField_b_of_type_Int = BaseApplicationImpl.getApplication().getSharedPreferences("UITools", 4).getInt("slide_enable_switch", 1);
      }
  ...
  public static boolean a(boolean paramBoolean)
  {
    ...
    if (c == null) {
      c = Boolean.valueOf(BaseApplicationImpl.getApplication().getSharedPreferences("UITools", 4).getBoolean("press_speak_second_guider", false));
    }
