...
public class SignalStrengthReport$1
  implements Runnable
{
  public SignalStrengthReport$1(mum parammum) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      lbj.c("SignalStrengthReport", "setGatewayTestResult networkType:" + n + " | levelPercent:" + i + " | dbm:" + i1 + "| pingResult:" + this.this$0.b);
