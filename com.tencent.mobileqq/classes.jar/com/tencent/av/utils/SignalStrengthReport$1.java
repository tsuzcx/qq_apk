...
public class SignalStrengthReport$1
  implements Runnable
{
  public SignalStrengthReport$1(mtv parammtv) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      lba.f("SignalStrengthReport", "setGatewayTestResult networkType:" + n + " | levelPercent:" + i + " | dbm:" + i1 + "| pingResult:" + this.this$0.b);
