...
public class SignalStrengthReport$1
  implements Runnable
{
  public SignalStrengthReport$1(mut parammut) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      lbd.f("SignalStrengthReport", "setGatewayTestResult networkType:" + n + " | levelPercent:" + i + " | dbm:" + i1 + "| pingResult:" + this.this$0.b);
