  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if ((!QQAppInterface.isAppOnForeground(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())) || (bahj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()))) {
    ...
    for (;;)
    {
      if (!TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {
        aric.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.frienduin, this.jdField_a_of_type_Int, this.jdField_b_of_type_Boolean, "qav");
      }
      if (QLog.isColorLevel()) {
