...
public class ClassLoaderUtil
{
  ...
  public static String a(Context paramContext, String paramString)
  {
    ...
    //   3: aconst_null
    //   4: astore 4
    //   6: new 107	java/lang/StringBuilder
    //   9: dup
    //   10: invokespecial 108	java/lang/StringBuilder:<init>	()V
    //   13: aload_0
    //   14: invokevirtual 112	android/content/Context:getFilesDir	()Ljava/io/File;
    //   17: invokevirtual 115	java/io/File:getParent	()Ljava/lang/String;
    ...
    //   35: astore 6
    //   37: aload_0
    //   38: invokevirtual 112	android/content/Context:getFilesDir	()Ljava/io/File;
    //   41: invokevirtual 52	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   44: astore_0
    //   45: new 107	java/lang/StringBuilder
    //   48: dup
    //   49: invokespecial 108	java/lang/StringBuilder:<init>	()V
    //   52: aload_0
    //   53: invokevirtual 119	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   56: getstatic 128	java/io/File:separator	Ljava/lang/String;
    //   59: invokevirtual 119	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   62: aload_1
    //   63: invokevirtual 119	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   66: invokevirtual 124	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   69: astore_3
    ...
    //   78: astore_0
    //   79: aload_0
    //   80: invokevirtual 134	java/io/File:exists	()Z
    //   83: ifeq +8 -> 91
    //   86: aload_0
    //   87: invokevirtual 137	java/io/File:delete	()Z
    //   90: pop
    //   91: new 139	java/io/BufferedInputStream
    //   94: dup
    //   95: new 141	java/io/FileInputStream
    //   98: dup
    //   99: new 48	java/io/File
    //   102: dup
    //   103: aload 6
    //   105: invokespecial 131	java/io/File:<init>	(Ljava/lang/String;)V
    //   108: invokespecial 144	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   111: invokespecial 147	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   114: astore_1
    //   115: aload_0
    //   116: invokevirtual 150	java/io/File:createNewFile	()Z
    //   119: pop
    //   120: new 152	java/io/BufferedOutputStream
    //   123: dup
    //   124: new 154	java/io/FileOutputStream
    //   127: dup
    //   128: aload_0
    //   129: invokespecial 155	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   132: invokespecial 158	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   135: astore_0
    //   136: sipush 1024
    //   139: newarray byte
    //   141: astore 4
    ...
    //   147: aload 4
    //   149: arraylength
    //   150: invokevirtual 162	java/io/BufferedInputStream:read	([BII)I
    //   153: istore_2
    //   154: iload_2
    //   155: iconst_m1
    ...
    //   162: iconst_0
    //   163: iload_2
    //   164: invokevirtual 166	java/io/BufferedOutputStream:write	([BII)V
    //   167: goto -24 -> 143
    //   170: astore 5
    //   172: aload_0
    //   173: astore 4
    ...
    //   196: ifnull +7 -> 203
    //   199: aload_0
    //   200: invokevirtual 169	java/io/BufferedInputStream:close	()V
    //   203: aload_3
    //   204: astore_1
    //   205: aload 4
    //   207: ifnull +10 -> 217
    //   210: aload 4
    //   212: invokevirtual 170	java/io/BufferedOutputStream:close	()V
    //   215: aload_3
    //   216: astore_1
    //   217: aload_1
    //   218: areturn
    ...
    //   220: ifnull +7 -> 227
    //   223: aload_1
    //   224: invokevirtual 169	java/io/BufferedInputStream:close	()V
    //   227: aload_3
    //   228: astore_1
    //   229: aload_0
    //   230: ifnull -13 -> 217
    //   233: aload_0
    //   234: invokevirtual 170	java/io/BufferedOutputStream:close	()V
    //   237: aload_3
    //   238: areturn
    //   239: astore_0
    //   240: aload_3
    ...
    //   325: ifnull +7 -> 332
    //   328: aload_1
    //   329: invokevirtual 169	java/io/BufferedInputStream:close	()V
    //   332: aload 4
    //   334: ifnull +8 -> 342
    //   337: aload 4
    //   339: invokevirtual 170	java/io/BufferedOutputStream:close	()V
    //   342: aload_0
    //   343: athrow
    //   344: astore_1
