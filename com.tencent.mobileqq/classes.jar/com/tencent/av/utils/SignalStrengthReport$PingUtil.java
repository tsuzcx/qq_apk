...
public class SignalStrengthReport$PingUtil
{
  ...
  public static int a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    {
      AVLog.printColorLog("SignalStrengthReport", "getAvgRTT e:" + paramString);
    }
    return -1;
  }
  ...
  private static String a(String paramString)
  {
    ...
    {
      AVLog.printColorLog("SignalStrengthReport", "getDomain e:" + paramString);
    }
    return null;
  }
  ...
  private static String b(String paramString)
  {
    ...
    //   5: aload_0
    //   6: invokevirtual 114	java/lang/Runtime:exec	(Ljava/lang/String;)Ljava/lang/Process;
    //   9: astore_1
    //   10: aload_1
    //   11: astore_0
    //   12: aload_1
    //   13: invokevirtual 120	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    //   16: astore_2
    //   17: aload_1
    //   18: astore_0
    //   19: new 122	java/io/BufferedReader
    //   22: dup
    //   23: new 124	java/io/InputStreamReader
    //   26: dup
    //   27: aload_2
    //   28: invokespecial 127	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   31: invokespecial 130	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   34: astore 4
    //   36: aload_1
    //   37: astore_0
    ...
    //   48: astore_0
    //   49: aload 4
    //   51: invokevirtual 133	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   54: astore 6
    //   56: aload 6
    //   58: ifnull +67 -> 125
    //   61: aload_1
    ...
    //   101: aload_2
    //   102: invokevirtual 72	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   105: invokevirtual 76	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   108: invokestatic 82	com/tencent/av/AVLog:printColorLog	(Ljava/lang/String;Ljava/lang/String;)V
    //   111: aload_3
    //   112: astore_0
    //   113: aload_1
    //   114: ifnull +9 -> 123
    //   117: aload_1
    //   118: invokevirtual 140	java/lang/Process:destroy	()V
    //   121: aload_3
    //   122: astore_0
    //   123: aload_0
    //   124: areturn
    ...
    //   126: astore_0
    //   127: aload 4
    //   129: invokevirtual 143	java/io/BufferedReader:close	()V
    //   132: aload_1
    //   133: astore_0
    //   134: aload_2
    //   135: invokevirtual 146	java/io/InputStream:close	()V
    //   138: aload_1
    //   139: astore_0
    //   140: aload 5
    ...
    //   149: ifnull -26 -> 123
    //   152: aload_1
    //   153: invokevirtual 140	java/lang/Process:destroy	()V
    //   156: aload_2
    //   157: areturn
    //   158: astore_0
    //   159: aconst_null
    ...
    //   164: ifnull +7 -> 171
    //   167: aload_2
    //   168: invokevirtual 140	java/lang/Process:destroy	()V
    //   171: aload_1
    //   172: athrow
    //   173: astore_1
    //   174: aload_0
