  ...
  implements Runnable
{
  ...
  public void run()
  {
    if ((this.jdField_a_of_type_Int == 12) || (this.jdField_a_of_type_Int == 25) || (this.jdField_a_of_type_Int == 42) || (this.jdField_a_of_type_Int == 43) || (this.jdField_a_of_type_Int == 56)) {
      biki.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0);
    }
    int i = ((aogu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(13)).g();
    Object localObject;
    if (i == 2)
    {
      if ((this.jdField_a_of_type_Boolean) || ((this.jdField_a_of_type_Int != 0) && (this.jdField_a_of_type_Int != 2) && (this.jdField_a_of_type_Int != 24)) || (this.jdField_a_of_type_JavaLangString == null) || (!aivm.a())) {
        break label416;
      }
    ...
    for (i = 1;; i = 0)
    {
      int j = biki.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      int k = biki.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), 6, true, null);
      if ((j != 0) && (j != k))
      {
        k = biki.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.c, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount());
