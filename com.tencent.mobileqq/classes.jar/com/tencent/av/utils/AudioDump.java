  ...
  implements SdkAudioFrameCallback
{
  ...
  private static void a(byte[] paramArrayOfByte, int paramInt, String paramString)
  {
    ...
    //   1: ifgt +4 -> 5
    //   4: return
    //   5: new 78	java/io/DataOutputStream
    //   8: dup
    //   9: new 80	java/io/FileOutputStream
    //   12: dup
    //   13: aload_2
    //   14: invokespecial 81	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   17: invokespecial 84	java/io/DataOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   20: astore_3
    //   21: aload_3
    //   22: astore_2
    //   23: aload_3
    ...
    //   25: iconst_0
    //   26: iload_1
    //   27: invokevirtual 88	java/io/DataOutputStream:write	([BII)V
    //   30: aload_3
    //   31: astore_2
    //   32: ldc 57
    //   34: ldc 90
    //   36: invokestatic 94	com/tencent/qav/log/AVLog:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   39: aload_3
    //   40: ifnull -36 -> 4
    //   43: aload_3
    //   44: invokevirtual 97	java/io/DataOutputStream:close	()V
    //   47: return
    //   48: astore_0
    //   49: return
    //   50: astore 4
    ...
    //   58: ldc 99
    //   60: aload 4
    //   62: invokestatic 101	com/tencent/qav/log/AVLog:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   65: aload_0
    //   66: ifnull -62 -> 4
    //   69: aload_0
    //   70: invokevirtual 97	java/io/DataOutputStream:close	()V
    //   73: return
    //   74: astore_0
    //   75: return
    //   76: astore_0
    ...
    //   80: ifnull +7 -> 87
    //   83: aload_2
    //   84: invokevirtual 97	java/io/DataOutputStream:close	()V
    //   87: aload_0
    //   88: athrow
    //   89: astore_2
    //   90: goto -3 -> 87
  ...
  private boolean a(int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        AVLog.a("AudioDump", "registerAudioDataCallback failed. srcType = " + paramInt + ", ret1 = " + j + ", ret2 = " + i);
        paramBoolean = false;
      }
      return paramBoolean;
