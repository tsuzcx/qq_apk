    ...
    if (paramArrayOfString != null)
    {
      ...
      if (i < j)
      {
        ...
        if ("DEVICE_BLUETOOTHHEADSET".equals(str)) {
          this.jdField_a_of_type_JavaUtilMap.put(str, new TraeHelper.SoundOutputRes.IconAndName(this, 2130840323, "蓝牙设备", str));
        }
        for (;;)
        {
          i += 1;
          ...
          if ("DEVICE_EARPHONE".equals(str)) {
            this.jdField_a_of_type_JavaUtilMap.put(str, new TraeHelper.SoundOutputRes.IconAndName(this, 2130840325, "听筒", str));
          } else if ("DEVICE_SPEAKERPHONE".equals(str)) {
            this.jdField_a_of_type_JavaUtilMap.put(str, new TraeHelper.SoundOutputRes.IconAndName(this, 2130840328, "扬声器", str));
          } else if ("DEVICE_WIREDHEADSET".equals(str)) {
            this.jdField_a_of_type_JavaUtilMap.put(str, new TraeHelper.SoundOutputRes.IconAndName(this, 2130840330, "耳机", str));
          }
        }
      }
    }
