    ...
    if (paramArrayOfString != null)
    {
      ...
      if (i < j)
      {
        ...
        if ("DEVICE_BLUETOOTHHEADSET".equals(str)) {
          this.jdField_a_of_type_JavaUtilMap.put(str, new TraeHelper.SoundOutputRes.IconAndName(this, 2130842443, HardCodeUtil.a(2131714908), str));
        }
        for (;;)
        {
          i += 1;
          ...
          if ("DEVICE_EARPHONE".equals(str)) {
            this.jdField_a_of_type_JavaUtilMap.put(str, new TraeHelper.SoundOutputRes.IconAndName(this, 2130842445, HardCodeUtil.a(2131714909), str));
          } else if ("DEVICE_SPEAKERPHONE".equals(str)) {
            this.jdField_a_of_type_JavaUtilMap.put(str, new TraeHelper.SoundOutputRes.IconAndName(this, 2130842448, HardCodeUtil.a(2131714912), str));
          } else if ("DEVICE_WIREDHEADSET".equals(str)) {
            this.jdField_a_of_type_JavaUtilMap.put(str, new TraeHelper.SoundOutputRes.IconAndName(this, 2130842450, HardCodeUtil.a(2131714910), str));
          }
        }
      }
    }
  ...
  public void a(String paramString)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      if (localIconAndName != null) {
        localIconAndName.b = (HardCodeUtil.a(2131714911) + paramString + "）");
      }
    }
  }
