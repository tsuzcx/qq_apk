...
class NearbyPeopleProfileHelper$1
  extends BroadcastReceiver
{
  NearbyPeopleProfileHelper$1(NearbyPeopleProfileHelper paramNearbyPeopleProfileHelper) {}
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if (paramIntent.getAction().equals("tencent.video.q2v.getNearByProfile"))
    {
      ...
      paramIntent = SessionMgr.a().c(this.a.jdField_a_of_type_JavaLangString);
      if (paramIntent != null) {
        break label98;
      }
    }
    ...
    do
    {
      ...
      if (this.a.jdField_a_of_type_ComTencentAvVideoController != null)
      {
        ...
        if (localGAudioFriends != null)
        {
          ...
          localGAudioFriends.c = localNearbyProfileData.jdField_a_of_type_Int;
        }
 ...
 * Qualified Name:     com.tencent.av.utils.NearbyPeopleProfileHelper.1
