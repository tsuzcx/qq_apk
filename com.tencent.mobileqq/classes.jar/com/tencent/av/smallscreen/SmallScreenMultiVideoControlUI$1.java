  ...
  extends kur
{
  ...
  public void a(long paramLong1, int paramInt1, long paramLong2, long paramLong3, long paramLong4, int paramInt2)
  {
    ...
    {
      this.a.jdField_a_of_type_Lru.update(null, new Object[] { Integer.valueOf(105), Boolean.valueOf(bool), Long.valueOf(paramLong1) });
      this.a.o();
      return;
      paramInt1 += 1;
      break label205;
      ...
      QLog.d("SmallScreenMultiVideoControlUI", 2, "Go Off Stage-->roomMode=" + this.a.jdField_a_of_type_ComTencentAvVideoController.a().H + " isBeBan" + this.a.jdField_a_of_type_ComTencentAvVideoController.a().Z + " isPressSpeaking=" + this.a.jdField_a_of_type_ComTencentAvVideoController.a().V + " isOnlyManagerCanOnStage=" + this.a.jdField_a_of_type_ComTencentAvVideoController.a().W);
      return;
    }
  }
  ...
  public void a(long paramLong1, long paramLong2, long paramLong3, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      this.a.jdField_a_of_type_Lru.update(null, new Object[] { Integer.valueOf(104), localArrayList });
    }
  }
  ...
  public void a(long paramLong1, long paramLong2, long paramLong3, int paramInt, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if ((!badq.h((Context)this.a.jdField_a_of_type_JavaLangRefWeakReference.get())) && (this.a.jdField_a_of_type_ComTencentAvVideoController.a().a() == -1) && (!this.a.jdField_a_of_type_ComTencentAvVideoController.a().ao)) {
        break;
      }
    } while (this.a.e >= 4);
  ...
  public void a(long paramLong1, long paramLong2, String paramString)
  {
    ...
    do
    {
      ...
      localIntent.putExtra("MultiAVType", this.a.jdField_a_of_type_ComTencentAvVideoController.a().A);
  ...
  public void a(String paramString, String[] paramArrayOfString)
  {
    ...
    if (i == 1) {
      this.a.jdField_a_of_type_AndroidContentResResources.getString(2131630136);
    }
    for (;;)
    {
      this.a.a(Long.valueOf(paramString).longValue(), 82, true, -1);
      return;
      String.format(this.a.jdField_a_of_type_AndroidContentResResources.getString(2131630135), new Object[] { Integer.valueOf(i) });
    }
  }
  ...
  public void b(int paramInt1, long paramLong, int paramInt2)
  {
    ...
    case 101: 
      ...
      return;
    case 108: 
      this.a.jdField_a_of_type_ComTencentAvVideoController.a().H = 108;
      return;
    case 107: 
      this.a.jdField_a_of_type_ComTencentAvVideoController.a().H = 107;
      return;
    }
    this.a.jdField_a_of_type_ComTencentAvVideoController.a().H = 104;
  }
  ...
  public void d()
  {
    ...
    SmallScreenService localSmallScreenService = (SmallScreenService)this.a.jdField_a_of_type_JavaLangRefWeakReference.get();
    if (localSmallScreenService != null) {
      localSmallScreenService.b.post(new SmallScreenMultiVideoControlUI.1.2(this));
    }
    while (!QLog.isColorLevel()) {
      return;
    }
