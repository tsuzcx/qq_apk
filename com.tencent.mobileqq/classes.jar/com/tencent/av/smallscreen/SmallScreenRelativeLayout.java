  ...
  implements Animator.AnimatorListener, ValueAnimator.AnimatorUpdateListener
{
  ...
  lze jdField_a_of_type_Lze;
  lzf jdField_a_of_type_Lzf = null;
  ...
  public SmallScreenRelativeLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.e = getResources().getDimensionPixelSize(2131297736);
    this.f = getResources().getDimensionPixelSize(2131297737);
    this.jdField_a_of_type_Int = getResources().getDimensionPixelSize(2131297744);
    this.g = getResources().getDimensionPixelSize(2131298865);
    this.h = getResources().getDimensionPixelSize(2131297734);
    ...
    this.p = b();
    this.jdField_a_of_type_Lzf = new lzf(this, getContext(), 2);
  }
  ...
  private int b()
  {
    ...
    {
      lcl.e("SmallScreenRelativeLayout", localException.getMessage());
    }
    return 0;
  }
  ...
  public int a()
  {
    ...
    if ((this.q != 0) && (this.r != 0))
    {
      ...
      i2 = this.jdField_a_of_type_Lze.a(this);
    }
    for (int i1 = this.jdField_a_of_type_Lze.b(this);; i1 = getTop())
    {
  ...
  int a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    if ((paramInt1 < paramInt2) && (paramInt3 > paramInt4))
    {
      ...
      {
        SharedPreferences localSharedPreferences = bbjn.a(getContext());
  ...
  public void a()
  {
    ...
    try
    {
      ...
      if ((this.p != i3) || (i4 != this.q) || ((i3 == 0) && (this.r < i1)) || ((i3 != 0) && (this.r != i1)))
      {
        ...
        i1 = this.jdField_a_of_type_Lze.a(this);
        this.m = i1;
        this.i = i1;
        i1 = this.jdField_a_of_type_Lze.b(this);
        this.n = i1;
        this.j = i1;
      ...
      for (;;)
      {
        ...
        for (paramInt1 = 0;; paramInt1 = i3)
        {
          ...
          for (;;)
          {
            if (this.jdField_a_of_type_Lze != null)
            {
              this.jdField_a_of_type_Lze.a(this, i2, paramInt1, i1 + i2, paramInt1 + paramInt2);
              return;
  ...
  void a(boolean paramBoolean)
  {
    ...
    {
      setVisibility(i1);
      if ((!paramBoolean) && (this.jdField_a_of_type_Lze != null)) {
        this.jdField_a_of_type_Lze.a(this);
      }
      return;
    }
  }
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_Lzf.enable();
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Lze = null;
    this.jdField_a_of_type_Lzf.disable();
  }
  ...
  public boolean dispatchTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    case 2: 
      do
      {
        ...
        this.l = i2;
        if (this.jdField_a_of_type_Lze != null) {
          this.i = this.jdField_a_of_type_Lze.a(this);
        }
        for (this.j = this.jdField_a_of_type_Lze.b(this);; this.j = getTop())
        {
    ...
    case 1: 
      if (this.jdField_c_of_type_Boolean)
      {
        ...
        this.m = this.jdField_a_of_type_Lze.a(this);
      }
      for (this.n = this.jdField_a_of_type_Lze.b(this); !bool; this.n = getTop())
      {
        this.jdField_a_of_type_AndroidAnimationValueAnimator.start();
        return true;
        if (this.jdField_a_of_type_Lze == null) {
        ...
        bool = this.jdField_a_of_type_Lze.a(this);
        break label195;
        label266:
        this.m = getLeft();
      }
    ...
    for (this.n = this.jdField_a_of_type_Lze.b(this);; this.n = getTop())
    {
      this.jdField_a_of_type_AndroidAnimationValueAnimator.start();
      return true;
      this.m = getLeft();
  ...
  public void f()
  {
    ...
    for (int i2 = this.jdField_d_of_type_Int; this.jdField_a_of_type_Lze != null; i2 = this.jdField_c_of_type_Int)
    {
      this.jdField_a_of_type_Lze.a(this, localPoint.x, localPoint.y, i1 + localPoint.x, localPoint.y + i2);
      return;
      label87:
      i1 = this.jdField_d_of_type_Int;
    }
  ...
  public void onAnimationEnd(Animator paramAnimator)
  {
      ...
      default: 
        ...
        if ((this.p % 2 == 0) || (!this.jdField_a_of_type_Boolean))
        {
          ...
          if (paramAnimator != null) {
            axqw.b(null, "CliOper", "", "", paramAnimator, paramAnimator, 0, 0, "", "", "", "");
          }
        }
        break;
      }
    ...
    } while (this.jdField_a_of_type_Lze == null);
    this.jdField_a_of_type_Lze.a(this);
  }
  ...
  public void onAnimationUpdate(ValueAnimator paramValueAnimator)
  {
    ...
    if (paramValueAnimator == this.jdField_a_of_type_AndroidAnimationValueAnimator)
    {
      ...
      if ((this.p % 2 == 0) || (!this.jdField_a_of_type_Boolean))
      {
        ...
        this.jdField_a_of_type_Lze.a(this, i3, i4, i1 + i3, i4 + i2);
      }
    }
    label147:
  ...
  public void setCurPosition(int paramInt)
  {
    ...
    for (int i1 = this.jdField_d_of_type_Int; this.jdField_a_of_type_Lze != null; i1 = this.jdField_c_of_type_Int)
    {
      this.jdField_a_of_type_Lze.a(this, localPoint.x, localPoint.y, paramInt + localPoint.x, localPoint.y + i1);
      return;
      label179:
  ...
  public void setFloatListener(lze paramlze)
  {
