  ...
  implements Runnable
{
  ...
  public void run()
  {
    if ((this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenMultiVideoControlUI$1.a.a() == this.jdField_a_of_type_Long) && (!bhsi.a(this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenMultiVideoControlUI$1.a.a.getApp().getApplicationContext()).getBoolean("kick_out_self", false))) {
