  ...
  extends ConfigBaseParser
{
  ...
  public boolean a()
  {
    try
    {
      this.jdField_a_of_type_Int = a(jdField_a_of_type_JavaLangString, 0);
      this.jdField_b_of_type_Int = a(jdField_b_of_type_JavaLangString, 0);
      this.jdField_c_of_type_Int = a(jdField_c_of_type_JavaLangString, -1);
      this.jdField_d_of_type_Int = a(jdField_d_of_type_JavaLangString, 0);
      this.jdField_e_of_type_Int = a(jdField_e_of_type_JavaLangString, 0);
      if (QLog.isColorLevel()) {
