...
public class ScreenShareDialogUtil
{
  ...
  {
    ScreenShareQQCustomDialog localScreenShareQQCustomDialog = new ScreenShareQQCustomDialog(paramContext, 2131755842, paramString2, paramBoolean, paramInt);
    localScreenShareQQCustomDialog.setContentView(2131559084);
    ...
    localScreenShareQQCustomDialog.a(Typeface.DEFAULT_BOLD, paramContext.getResources().getColorStateList(2131165580));
