    ...
    if (paramIntent != null)
    {
      ...
      if (paramIntent.getAction().equals("tencent.video.q2v.MultiVideo"))
      {
        ...
        if (i == 26)
        {
          ...
          if ((paramContext.j) && (paramContext.k == l1))
          {
            ...
            paramContext.a(paramContext.l, paramContext.k, 88);
        ...
        else
        {
          if (i == 27)
          {
            paramContext.n.receiveMultiVideoMsg(paramIntent.getExtras());
            return;
          }
          if (i == 30)
          {
            paramContext.n.receiveMultiVideoAck(paramIntent.getExtras());
            return;
          }
          if (i == 24)
          {
          ...
          if (i == 31)
          {
            ...
            if ((paramIntent != null) && (paramIntent.length != 0))
            {
              ...
              if ((paramContext.j) && (paramContext.k == l1) && (localStringBuilder1.compareTo(str1) == 0))
              {
                paramContext.a(paramContext.l, paramContext.k, 75);
              ...
              if ((paramContext.k().i == 7) && (paramContext.Y == l1) && (localStringBuilder1.compareTo(str1) == 0))
              {
                paramContext.k().a("GAudioMsgReceiver", 0);
                this.a.a(new Object[] { Integer.valueOf(67), Long.valueOf(paramContext.Y), Integer.valueOf(4) });
                paramContext.Y = 0L;
                paramContext.Z = 0;
              }
            }
          ...
          else if (i == 34)
          {
            ...
            if ((paramContext.j) && (l1 == paramContext.k))
            {
              paramContext.a(1, l1, 76);
              paramIntent = new Intent();
              paramIntent.setAction("tencent.av.v2q.MultiVideo");
              paramIntent.putExtra("MultiAVType", paramContext.k().o);
              paramIntent.putExtra("type", 25);
              paramIntent.putExtra("relationId", l1);
      ...
      else if (paramIntent.getAction().equals("tencent.video.q2v.AddDiscussMember"))
      {
        if (paramIntent.getBooleanExtra("result", false)) {
          paramContext.a(paramIntent.getLongExtra("roomId", paramContext.k), paramIntent.getStringArrayListExtra("newMemberUin"));
        }
      }
      else
      {
        ...
        else
        {
          ...
          if (paramIntent.getAction().equals("tencent.video.q2v.GroupSystemMsg"))
          {
            ...
            if ((paramContext.j) && (paramContext.k == l1))
            {
              if (paramContext.k().o == 2)
              {
                paramIntent = this.a;
                localObject = new StringBuilder();
                ((StringBuilder)localObject).append(l1);
                ((StringBuilder)localObject).append("");
                if (paramIntent.i(((StringBuilder)localObject).toString())) {
                  return;
                }
              }
