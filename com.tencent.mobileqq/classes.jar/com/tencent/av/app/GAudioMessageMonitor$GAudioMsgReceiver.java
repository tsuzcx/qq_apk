  ...
  extends BroadcastReceiver
{
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    do
    {
          ...
          do
          {
            do
            {
                        ...
                        do
                        {
                          do
                          {
                            ...
                            do
                            {
                                ...
                                do
                                {
                                  do
                                  {
                                    do
                                    {
                                      ...
                                      do
                                      {
                                        do
                                        {
                                          do
                                          {
                                            ...
                                            QLog.d(GAudioMessageMonitor.a, 2, " onReceive: " + paramIntent.getAction());
                                            return;
                                            if (QLog.isColorLevel()) {
                                              QLog.w(GAudioMessageMonitor.a, 1, "GAudioMsgReceiver_onReceive[" + paramIntent.getAction() + "]");
                                            }
                                            ...
                                            if (QLog.isColorLevel()) {
                                              QLog.d(GAudioMessageMonitor.a, 2, "GAudioMsgReceiver type: " + i);
                                            }
                                            if (i != 26) {
                                              break;
                                            }
                                            l1 = paramIntent.getLongExtra("discussId", 0L);
                                          } while ((!paramContext.d) || (paramContext.jdField_a_of_type_Long != l1));
                                        ...
                                        if (QLog.isColorLevel()) {
                                          QLog.d(GAudioMessageMonitor.a, 2, "TYPE_GAUDIO_MEMBER_KICKOUT-->discuss id = " + l1 + ", cmdUin = " + (String)localObject + ", outUin = " + str1 + ", selfUin = " + str2 + ", uinList.size = " + paramIntent.length);
                                        }
                                        if ((paramContext.d) && (paramContext.jdField_a_of_type_Long == l1) && (str1.compareTo(str2) == 0))
                                        {
                                      ...
                                      } while ((paramContext.a().g != 7) || (paramContext.c != l1) || (str1.compareTo(str2) != 0));
                                    ...
                                    } while ((!paramContext.d) || (l1 != paramContext.jdField_a_of_type_Long));
                              ...
                              l3 = AudioHelper.b();
                              QLog.w(GAudioMessageMonitor.a, 1, "switchToMultiAudio, seq[" + l2 + "], newseq[" + l3 + "], [discussion]");
                              ...
                              if (QLog.isColorLevel()) {
                                QLog.w(GAudioMessageMonitor.a, 1, "GAudioMsgReceiver_onReceive[tencent.video.q2v.GroupSystemMsg], type[" + i + "], relationType[" + j + "], relationId[" + l1 + "], userUin[" + l2 + "], needSendCmd[" + bool + "]");
                              }
                              if ((i != 7) && (i != 8)) {
                                break label1580;
                              }
                            ...
                            if (QLog.isColorLevel()) {
                              QLog.d(GAudioMessageMonitor.a, 2, "ACTION_SELECT_MEMBER --> InviteCount = " + i + " , FirstName = " + paramIntent);
                            }
                          ...
                          {
                            paramContext.g(paramIntent.getBooleanExtra("isResume", false));
                            return;
                          }
              ...
              if ((paramContext != null) && (paramContext.a() != null))
              {
                ...
                QLog.d(GAudioMessageMonitor.a, 2, "ACTION_AUDIO_TRANS_PUSH rsptype=" + i + "|" + paramContext.length);
      ...
      QLog.d(GAudioMessageMonitor.a, 1, "ACTION_OPPOSITE_AUDIO_ENGINE_READY:" + l1 + "|" + l2);
    } while ((l1 == 0L) || (l2 == 0L));
    label1580:
    label1594:
    label2120:
