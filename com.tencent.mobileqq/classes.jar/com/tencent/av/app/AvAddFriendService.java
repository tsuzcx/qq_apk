...
public class AvAddFriendService
{
  ...
  FriendListObserver jdField_a_of_type_ComTencentMobileqqAppFriendListObserver = new AvAddFriendService.2(this);
  MessageObserver jdField_a_of_type_ComTencentMobileqqAppMessageObserver = new AvAddFriendService.3(this);
  ...
  public boolean a(String paramString, int paramInt)
  {
    ...
    {
      localAddFriendStatus = new AvAddFriendService.AddFriendStatus(this);
      this.jdField_a_of_type_JavaUtilHashMap.put(paramString, localAddFriendStatus);
      a(paramString, 4);
      a(paramString);
      return true;
    }
    ...
    AvAddFriendService.AddFriendStatus localAddFriendStatus = new AvAddFriendService.AddFriendStatus(this);
    this.jdField_a_of_type_JavaUtilHashMap.put(paramString, localAddFriendStatus);
