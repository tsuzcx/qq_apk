  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (locallcn == null)
    {
      QLog.w("DeviceCapabilityExamination", 1, "startEncoderTest, 无样本, codec[" + ((lco)localObject).b + "]");
      return;
    }
    localObject = DeviceCapabilityExamination.a(locallcn.jdField_a_of_type_JavaLangString);
    if (!new File((String)localObject).exists())
    {
      QLog.w("DeviceCapabilityExamination", 1, "startEncoderTest, error, filePath[" + (String)localObject, new Throwable("打印调用栈"));
      return;
    }
    localObject = DeviceCapabilityExamination.a(DeviceCapabilityExamination.a(), locallcn.jdField_a_of_type_JavaLangString, locallcn.jdField_a_of_type_Int, locallcn.b);
    locallcn.c = localObject[1].intValue();
    locallcn.d = localObject[4].intValue();
