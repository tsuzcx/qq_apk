  ...
  extends MessageMicro<ConfigReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 34, 40 }, new String[] { "app_id", "app_ver", "chip", "mobile", "os_version" }, new Object[] { localInteger, "", "", "", localInteger }, ConfigReq.class);
  }
}
