...
class CameraUtils$UpdateHandler
  extends Handler
{
  WeakReference<CameraUtils> a;
  
  public CameraUtils$UpdateHandler(CameraUtils paramCameraUtils, Looper paramLooper)
  {
    super(paramLooper);
 ...
 * Qualified Name:     com.tencent.av.camera.CameraUtils.UpdateHandler
