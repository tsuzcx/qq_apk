...
public class CameraUtils
{
  ...
  ljz jdField_a_of_type_Ljz = new lkc(this);
  private lke jdField_a_of_type_Lke;
  private lkf jdField_a_of_type_Lkf;
  private lkg jdField_a_of_type_Lkg;
  ...
  private CameraUtils(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Lkk = new lkk(this.jdField_a_of_type_AndroidContentContext);
    this.jdField_a_of_type_Lkk.a(this.jdField_a_of_type_Ljz);
    this.jdField_a_of_type_Int = this.jdField_a_of_type_Lkk.f();
    if (this.jdField_a_of_type_Int > 0)
    {
      ...
      this.jdField_a_of_type_Lkk.a(true, i);
      this.jdField_a_of_type_Lkk.a(false, j);
    }
    ...
    this.jdField_a_of_type_Lkg = new lkg(this, this.jdField_b_of_type_AndroidOsHandlerThread.getLooper());
    ...
    if ((this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_AndroidOsHandlerThread == null))
    {
      ...
      this.jdField_a_of_type_AndroidOsHandler = new lkd(this, this.jdField_a_of_type_AndroidOsHandlerThread.getLooper());
    }
  }
  ...
  private void b(long paramLong, int paramInt1, int paramInt2)
  {
    ...
    for (boolean bool = this.jdField_a_of_type_Lkk.a(paramLong, this.jdField_a_of_type_AndroidGraphicsSurfaceTexture, paramInt1, paramInt2);; bool = false)
    {
      if (bool) {
  ...
  {
    QLog.w("CameraUtils", 1, "closeCamera begin, mCamera[" + this.jdField_a_of_type_Lkk + "], seq[" + paramLong + "]");
    a().a(new Object[] { Integer.valueOf(3), Long.valueOf(paramLong) });
    if (this.jdField_a_of_type_Lkk != null) {
      this.jdField_a_of_type_Lkk.c(paramLong);
    }
    ...
    for (;;)
    {
      ...
      e();
      QLog.w("CameraUtils", 1, "closeCamera end, mCamera[" + this.jdField_a_of_type_Lkk + "], seq[" + paramLong + "]");
      return;
      label265:
  ...
  {
    if ((AudioHelper.e()) || (this.jdField_a_of_type_Lkk == null)) {
      QLog.w("CameraUtils", 1, "setCameraParaInSubThread begin, mCamera[" + this.jdField_a_of_type_Lkk + "], seq[" + paramLong + "]");
    }
    if (this.jdField_a_of_type_Lkk == null) {
      return;
    }
    this.jdField_a_of_type_Lkk.a(paramLong, paramInt);
  }
  
  private void e(long paramLong)
  {
    if (AudioHelper.e()) {
      QLog.w("CameraUtils", 1, "switchCamera begin, mCamera[" + this.jdField_a_of_type_Lkk + "], seq[" + paramLong + "]");
    }
    mqn.a("switch_camera", "SwitchCameraRunnable", 3, new Object[] { Long.valueOf(paramLong) });
    a().a(new Object[] { Integer.valueOf(5) });
    if (this.jdField_a_of_type_Lkk != null) {}
    for (boolean bool = this.jdField_a_of_type_Lkk.b(paramLong, this.jdField_a_of_type_AndroidGraphicsSurfaceTexture);; bool = false)
    {
      a().a(new Object[] { Integer.valueOf(6), Boolean.valueOf(bool) });
      if (AudioHelper.e()) {
        QLog.w("CameraUtils", 1, "switchCamera end, result[" + bool + "], mCamera[" + this.jdField_a_of_type_Lkk + "], seq[" + paramLong + "]");
      }
      return;
    }
  }
  ...
  private void f(long paramLong)
  {
    ...
    QLog.w("CameraUtils", 1, "openCamera begin, mCamera[" + this.jdField_a_of_type_Lkk + "], seq[" + paramLong + "]");
    a().a(new Object[] { Integer.valueOf(1), Boolean.valueOf(this.jdField_a_of_type_Lkk.c()), Long.valueOf(paramLong) });
    if (this.jdField_a_of_type_ComTencentAvVideoController != null)
    {
      this.jdField_a_of_type_ComTencentAvVideoController.e = 0;
      this.jdField_a_of_type_ComTencentAvVideoController.g = false;
    }
    boolean bool = this.jdField_a_of_type_Lkk.a(paramLong, this.jdField_a_of_type_AndroidGraphicsSurfaceTexture);
    int j;
    if (this.jdField_a_of_type_ComTencentAvVideoController != null)
    {
      j = this.jdField_a_of_type_ComTencentAvVideoController.a().d;
      if (this.jdField_a_of_type_Lkk.g() != 0) {
  ...
  {
    if (this.jdField_a_of_type_Lkk != null) {
      return this.jdField_a_of_type_Lkk.a();
    }
    return null;
  }
  ...
  public void a()
  {
    if ((this.jdField_a_of_type_Lkk != null) && (this.jdField_a_of_type_Int > 0))
    {
      if ((this.jdField_a_of_type_Int == 1) || (!this.jdField_a_of_type_Lkk.a()))
      {
        i = this.jdField_a_of_type_Lkk.c(false) + 90;
        j = i % 360 / 90;
        this.jdField_a_of_type_Lkk.a(false, i);
      }
    }
    else {
      return;
    }
    int i = this.jdField_a_of_type_Lkk.c(true) + 90;
    int j = i % 360 / 90;
    this.jdField_a_of_type_Lkk.a(true, i);
  }
  ...
  {
    if (this.jdField_a_of_type_Lkk != null) {
      this.jdField_a_of_type_Lkk.a(paramInt);
    }
  }
  
  public void a(long paramLong)
  {
    QLog.w("CameraUtils", 1, "openCamera, seq[" + paramLong + "], openCamera[" + this.jdField_a_of_type_ComTencentAvCameraCameraUtils$OpenCameraRunnable + "], closeCamera[" + this.jdField_a_of_type_ComTencentAvCameraCameraUtils$CloseCameraRunnable + "], mCamera[" + this.jdField_a_of_type_Lkk + "]");
  ...
  public void a(String paramString, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    while (this.jdField_a_of_type_Lkg == null) {
      return;
    }
    this.jdField_a_of_type_Lkg.a(paramString, paramLong, paramInt1, paramInt2);
  }
  ...
  public void a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Lkk != null)
    {
      if (this.jdField_a_of_type_Lkk.e != paramBoolean) {
        QLog.w("CameraUtils", 1, "setSupportLandscape, value[" + this.jdField_a_of_type_Lkk.e + "->" + paramBoolean + "]");
      }
      this.jdField_a_of_type_Lkk.e = paramBoolean;
    }
  }
  ...
  public boolean a()
  {
    boolean bool = false;
    if (this.jdField_a_of_type_Lkk != null) {
      bool = this.jdField_a_of_type_Lkk.a();
    }
    if (QLog.isColorLevel()) {
      QLog.w("CameraUtils", 1, "isFrontCamera[" + bool + "], mCamera[" + this.jdField_a_of_type_Lkk + "]");
    }
    return bool;
  }
  ...
  public boolean a(long paramLong)
  {
    boolean bool2 = false;
    if (this.jdField_a_of_type_Lkk != null) {}
    for (boolean bool1 = this.jdField_a_of_type_Lkk.b();; bool1 = false)
    {
      if (QLog.isColorLevel())
      {
  ...
  public boolean a(long paramLong, boolean paramBoolean)
  {
    String str = "null";
    if (this.jdField_a_of_type_Lkk != null) {
      str = this.jdField_a_of_type_Lkk.c() + "";
    }
    if (QLog.isColorLevel()) {}
    for (Throwable localThrowable = new Throwable();; localThrowable = null)
    {
      ...
      if ((this.jdField_a_of_type_Lkk != null) && (this.jdField_a_of_type_Lkk.c()))
      {
        if (this.jdField_b_of_type_Boolean) {
  ...
  public void b()
  {
    ...
    int i = this.jdField_a_of_type_Lkk.c(true);
    int j = this.jdField_a_of_type_Lkk.c(false);
  ...
  public boolean b(long paramLong)
  {
    boolean bool = false;
    if (this.jdField_a_of_type_Lkk != null) {
      bool = this.jdField_a_of_type_Lkk.c();
    }
  ...
  void d()
  {
    ...
    {
      this.jdField_a_of_type_Lke = new lke(this);
      IntentFilter localIntentFilter = new IntentFilter();
      localIntentFilter.addAction("com.tencent.mobileqq.qav.camera.availability");
      this.jdField_a_of_type_AndroidContentContext.registerReceiver(this.jdField_a_of_type_Lke, localIntentFilter);
    }
  }
  
  public void d(long paramLong)
  {
    if (this.jdField_a_of_type_Lkk.c())
    {
      if (this.jdField_b_of_type_Boolean) {
        c(paramLong);
      }
  ...
  void e()
  {
    ...
    try
    {
      this.jdField_a_of_type_AndroidContentContext.unregisterReceiver(this.jdField_a_of_type_Lke);
