  ...
  extends QQAVImageFilter
{
  ...
  public void onDraw2(int paramInt1, int paramInt2)
  {
    ...
    {
      setFloat(this.d, this.g);
      super.onDraw2(paramInt1, paramInt2);
      return;
      this.f = 1000000;
      break;
      setFloat(this.e, 0.004F);
      break label51;
    }
  }
  ...
  {
    super.onInit();
    this.a = GLES20.glGetUniformLocation(getProgram(), "imageWidth");
    this.b = GLES20.glGetUniformLocation(getProgram(), "imageHeight");
    this.c = GLES20.glGetUniformLocation(getProgram(), "u_time");
    this.d = GLES20.glGetUniformLocation(getProgram(), "noise");
    this.e = GLES20.glGetUniformLocation(getProgram(), "waveHeight");
    this.f = 1000000;
  }
