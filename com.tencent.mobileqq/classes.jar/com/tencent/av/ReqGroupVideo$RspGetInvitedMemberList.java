  ...
  extends MessageMicro<RspGetInvitedMemberList>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 34 }, new String[] { "result", "uint64_group", "uint64_room_id", "rpt_member_list" }, new Object[] { null, localLong, localLong, null }, RspGetInvitedMemberList.class);
  }
}
