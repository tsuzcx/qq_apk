  ...
  extends BusinessHandler
{
  ...
  public void a(String paramString1, long paramLong, String paramString2, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      if (NetworkUtil.g(this.appRuntime.getApplicationContext())) {
    ...
    if (bool)
    {
      ...
      for (;;)
      {
        ...
        else if (j == 6)
        {
          ...
          {
            m = paramFromServiceMsg.uint32_combine_num.get();
            QLog.d("AudioTransClientInterfaceHandler", 2, "enum_channel_type = " + this.jdField_a_of_type_ComTencentAvBusinessHandlerAudioTransClientInfoHandlerExtend$InfoInterfaceData.jdField_a_of_type_Int);
            ...
            while (paramFromServiceMsg.hasNext())
            {
              ...
              AudioTrans localAudioTrans = this.jdField_a_of_type_ComTencentAvBusinessHandlerAudioTrans;
              QLog.d("AudioTransClientInterfaceHandler", 2, AudioTrans.a(paramObject.fixed32_IP.get()));
              ...
              QLog.d("AudioTransClientInterfaceHandler", 2, AudioTrans.a(paramObject.fixed32_inner_IP.get()));
            }
          }
        }
      }
