...
class VideoNodeReporter$SeesionRecord
{
  ...
  public String a(int paramInt, long paramLong)
  {
    ...
    AVLog.printAllUserLog("VideoNodeReporter", "buildBody report error:" + paramInt);
    return null;
  }
  ...
  public void a(SessionInfo paramSessionInfo, String paramString)
  {
    if (paramSessionInfo != null)
    {
      if (paramSessionInfo.k != -1) {
        this.jdField_a_of_type_Int = paramSessionInfo.k;
      }
      if (paramSessionInfo.jdField_d_of_type_Int != 0) {
        this.jdField_b_of_type_Int = paramSessionInfo.jdField_d_of_type_Int;
      }
      if (!TextUtils.isEmpty(paramSessionInfo.jdField_d_of_type_JavaLangString)) {
        this.jdField_b_of_type_JavaLangString = paramSessionInfo.jdField_d_of_type_JavaLangString;
      }
    }
