...
public class BusinessMessageCenter
{
  ...
  private void a(Observable paramObservable, Object paramObject)
  {
    ...
    case 203: 
      ...
      {
        return;
        a(SeqUtil.a(paramObservable, 1), 2, null);
        return;
        ...
        return;
        l1 = SeqUtil.a(paramObservable, 1);
        ...
        l1 = SeqUtil.a(paramObservable, 3);
  ...
  public int a(String paramString)
  {
    ...
    label660:
    label677:
    for (EffectZimuManager localEffectZimuManager = localObject[0];; localEffectZimuManager = null)
    {
      ...
      for (String str2 = localObject[2];; str2 = null)
      {
        ...
        for (long l1 = AudioHelper.a(localObject[3]);; l1 = 0L)
        {
          ...
          if (localEffectZimuManager.startsWith("EMPTY_ITEM"))
          {
            ...
            localEffectZimuManager = (EffectZimuManager)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(0);
            localObject = (ZimuItem)localEffectZimuManager.a();
            if ((localObject == null) || (TextUtils.isEmpty(((ZimuItem)localObject).getId()))) {
              break label660;
            }
            QLog.w("BusinessMessageCenter", 1, "onReceivedChangingZimuOfPeer, 对方取消字幕, info[" + paramString + "], sessionid[" + str1 + "], cmdSeq[" + str2 + "], seq[" + l3 + "], sendTime[" + l1 + "], offset[" + (l2 - l1) + "], isTranslation[" + localEffectZimuManager.c() + "], cur[" + ((ZimuItem)localObject).getId() + "]");
            ...
            new ControlUIObserver.ZimuRequest(l3, "onReceivedChangingZimuOfPeer", 3, "0").a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
          ...
          for (;;)
          {
            ...
            localObject = (EffectZimuManager)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(0);
            ZimuItem localZimuItem1 = (ZimuItem)((EffectZimuManager)localObject).a(localEffectZimuManager);
            ZimuItem localZimuItem2 = (ZimuItem)((EffectZimuManager)localObject).a();
            QLog.w("BusinessMessageCenter", 1, "onReceivedChangingZimuOfPeer, 对方选择字幕, info[" + paramString + "], zimuId[" + localEffectZimuManager + "], sessionid[" + str1 + "], cmdSeq[" + str2 + "], seq[" + l3 + "], sendTime[" + l1 + "], offset[" + (l2 - l1) + "], isTranslation[" + ((EffectZimuManager)localObject).c() + "], ZimuItem[" + localZimuItem1 + "], CurItem[" + localZimuItem2 + "]");
            boolean bool;
            if (localZimuItem1 != null) {
              if (localZimuItem2 == null)
              {
                ...
                ((EffectZimuManager)localObject).a("onReceivedChangingZimuOfPeer", false, l3, str1);
                ((EffectZimuManager)localObject).a(l3, localEffectZimuManager);
                if (!localZimuItem1.isUsable()) {
                  ((EffectZimuManager)localObject).a(l3, localZimuItem1);
                }
                new ControlUIObserver.ZimuRequest(l3, "onReceivedChangingZimuOfPeer", 1, localEffectZimuManager).a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
                if (localZimuItem2 != null) {
                  break label650;
                }
                i = 3;
  ...
  {
    AVLog.printColorLog("BusinessMessageCenter", "notifyEvent :" + paramInteger + "|" + paramObject);
  ...
  public int b(int paramInt, String paramString)
  {
    ...
    paramString = new SentenceInfo(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().a().d, str, str, 2);
    paramString.a = true;
