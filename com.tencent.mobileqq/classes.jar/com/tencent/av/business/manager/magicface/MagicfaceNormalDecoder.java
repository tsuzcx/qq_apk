    ...
    for (;;)
    {
      if (j < m)
      {
        ...
        else
        {
          ...
          AVLog.printColorLog("MagicfaceNormalDecoder", "maigcfaceDecoder:" + this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicfaceData.a() + "|" + (String)localObject);
    ...
    for (;;)
    {
      try
      {
        ...
        if ((k == this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicfaceData.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicfaceDataAudioJason.frame_index) && (this.jdField_a_of_type_JavaLangRefWeakReference != null))
        {
          ...
          AVLog.printColorLog("MagicfaceNormalDecoder", "maigcfaceDecoder bmp null:" + (String)localObject);
          k += 1;
          l2 += l6 - l5;
          i += 1;
        }
      ...
      if (this.b.get() != null)
      {
        ...
        AVLog.printColorLog("MagicfaceNormalDecoder", String.format("maigcfaceDecoder| readCost=%s(ms), renderCost=%s(ms), r=(%s), frame(%s)", new Object[] { Long.valueOf(l2), Long.valueOf(l1), Integer.valueOf(m), Integer.valueOf(this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicfaceData.a()) }));
        if (localBitmap1 != null) {
