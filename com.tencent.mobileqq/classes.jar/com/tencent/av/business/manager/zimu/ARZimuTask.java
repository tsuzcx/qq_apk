...
public abstract class ARZimuTask
{
  ...
  protected ARZimuTask.ARZimuObserver a;
  protected ARZimuTask.IARZimuShowPlayer a;
  protected EffectZimuManager a;
  protected final List<ARZimuItemTask> a;
  
  static
  {
    jdField_a_of_type_ComTencentAvBusinessManagerZimuARZimuTask$DoubleScreenLocationInfo = null;
  }
  
  public ARZimuTask(long paramLong, VideoAppInterface paramVideoAppInterface)
  {
  ...
  private void a(SentenceInfo paramSentenceInfo, boolean paramBoolean)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (!((ARZimuItemTask)localObject3).a.a())
      {
        ...
        if (((ARZimuItemTask)localObject3).a.jdField_a_of_type_JavaLangString.equals(paramSentenceInfo.jdField_a_of_type_JavaLangString))
        {
          ...
          AVLog.printColorLog("ARZimuTask", "updateTextInner " + paramSentenceInfo.jdField_a_of_type_JavaLangString + " onTextChanged info:" + paramSentenceInfo.jdField_a_of_type_JavaLangCharSequence);
        }
      }
      i = j;
    ...
    if (i == 0)
    {
      ...
      if (localObject3 != null)
      {
        ...
        AVLog.printColorLog("ARZimuTask", "updateTextInner " + paramSentenceInfo.jdField_a_of_type_JavaLangString + " addinfo:" + paramSentenceInfo.jdField_a_of_type_JavaLangCharSequence);
      }
    }
  ...
  protected abstract List<ARZimuItemTask> a(SentenceInfo paramSentenceInfo, boolean paramBoolean);
  
  public void a()
  {
    this.jdField_a_of_type_ComTencentAvBusinessManagerZimuARZimuTask$ARZimuObserver = new ARZimuTask.ARZimuObserver(this);
    this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(this.jdField_a_of_type_ComTencentAvBusinessManagerZimuARZimuTask$ARZimuObserver);
  }
  ...
  public void a(SentenceInfo paramSentenceInfo)
  {
    if ((paramSentenceInfo == null) || (TextUtils.isEmpty(paramSentenceInfo.jdField_a_of_type_JavaLangCharSequence)) || (TextUtils.isEmpty(paramSentenceInfo.jdField_a_of_type_JavaLangString)))
    {
      ...
      {
        AVLog.printErrorLog("ARZimuTask", paramSentenceInfo);
        return;
      }
    }
    AVLog.printColorLog("ARZimuTask", "updateText :" + paramSentenceInfo.toString());
    if (!this.jdField_a_of_type_ComTencentAvBusinessManagerZimuEffectZimuManager.a()) {
      this.jdField_a_of_type_ComTencentAvBusinessManagerZimuEffectZimuManager.b("updateText1", true);
    }
  ...
  public void b()
  {
    if (this.jdField_a_of_type_ComTencentAvBusinessManagerZimuARZimuTask$ARZimuObserver != null) {
      this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.b(this.jdField_a_of_type_ComTencentAvBusinessManagerZimuARZimuTask$ARZimuObserver);
    }
  }
  ...
  public String c()
  {
    ...
    {
      AVLog.printColorLog("ARZimuTask", "getGamePlayResoucePath path = " + (String)localObject);
      return localObject;
    }
  }
  ...
  protected void c()
  {
    ...
    {
      str = d();
      localObject = (ZimuItem)this.jdField_a_of_type_ComTencentAvBusinessManagerZimuEffectZimuManager.a(str);
      if (localObject != null)
      {
