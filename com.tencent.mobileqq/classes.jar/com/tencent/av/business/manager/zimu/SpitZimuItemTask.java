  ...
  extends ARZimuItemTask
{
  ...
  protected void a(Canvas paramCanvas, int paramInt1, int paramInt2)
  {
    ...
    AVLog.printColorLog("ARZimuTask_SpitZimuItemTask", "onDraw width = " + paramInt1);
    ...
    int j = str1.length();
    str1 = str1 + str2;
    AVLog.printColorLog("ARZimuTask_SpitZimuItemTask", "onDraw showText = " + str1);
    ...
    AVLog.printColorLog("ARZimuTask_SpitZimuItemTask", "onDraw offsetX = " + i);
  }
