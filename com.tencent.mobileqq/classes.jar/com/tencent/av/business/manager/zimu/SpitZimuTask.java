  ...
  extends ARZimuTask
{
  ...
  private WeakReference<SpitZimuTask.IMouthDetector> jdField_a_of_type_JavaLangRefWeakReference;
  private Map<String, SpitZimuTask.MouthLoactionInfo> jdField_a_of_type_JavaUtilMap = null;
  protected volatile boolean a;
  
  public SpitZimuTask(long paramLong, VideoAppInterface paramVideoAppInterface)
  {
  ...
  {
    AVLog.printColorLog("ARZimuTask_SpitZimuTask", "onSmallScreenMoveChanged");
    SpitZimuTask.ISpitZimuTaskPlayer localISpitZimuTaskPlayer = a();
    if (localISpitZimuTaskPlayer == null) {
      return;
    }
    AVLog.printColorLog("ARZimuTask_SpitZimuTask", "taskPlayer has");
    if (!paramBoolean) {}
  ...
  PointF a(String paramString, boolean paramBoolean)
  {
    ...
    for (paramString = (SpitZimuTask.MouthLoactionInfo)this.jdField_a_of_type_JavaUtilMap.get(paramString);; paramString = null)
    {
      if (paramString == null)
      {
        AVLog.printColorLog("ARZimuTask_SpitZimuTask", "tryGetMouthInfoByUin info == null");
        return null;
      }
      if (!paramString.a())
      {
        AVLog.printColorLog("ARZimuTask_SpitZimuTask", "tryGetMouthInfoByUin info.checkIsOpenMouth() = false");
        paramString.a();
        return null;
      }
  ...
  protected List<ARZimuItemTask> a(SentenceInfo paramSentenceInfo, boolean paramBoolean)
  {
    c();
  ...
  {
    AVLog.printColorLog("ARZimuTask_SpitZimuTask", "requestRender, begin");
    SpitZimuTask.ISpitZimuTaskPlayer localISpitZimuTaskPlayer = a();
    if (localISpitZimuTaskPlayer == null)
    {
      AVLog.printColorLog("ARZimuTask_SpitZimuTask", "requestRender, taskPlayer is null");
      return;
    }
    AVLog.printColorLog("ARZimuTask_SpitZimuTask", "requestRender, taskPlayer has");
    ...
    for (;;)
    {
      ...
      {
        AVLog.printColorLog("ARZimuTask_SpitZimuTask", "requestRender, spitZimuItemTask is null");
        return;
      ...
      else
      {
        ...
        for (;;)
        {
          ...
          AVLog.printColorLog("ARZimuTask_SpitZimuTask", "requestRender, mouthPoint is null");
          return;
          ...
          else
          {
            if (localObject1 != null)
            {
              AVLog.printColorLog("ARZimuTask_SpitZimuTask", "requestRender, uin not equal currentPlayUin=" + (String)localObject1 + " taskUin=" + str);
              paramARZimuItemTask.b = false;
              return;
            }
            if (localObject2 != null)
            {
              AVLog.printColorLog("ARZimuTask_SpitZimuTask", "requestRender, uin not equal smallScreenUin=" + (String)localObject2 + " taskUin=" + str);
              paramARZimuItemTask.b = false;
              return;
            }
            ...
            AVLog.printColorLog("ARZimuTask_SpitZimuTask", "requestRender, uin not equal currentPlayUin&smallScreenUin=null selfUin=" + (String)localObject1 + " taskUin=" + str);
            bool = true;
          }
        }
        AVLog.printColorLog("ARZimuTask_SpitZimuTask", "requestRender, uin not equal currentPlayUin&smallScreenUin&selfUin=null taskUin=" + str);
        paramARZimuItemTask.b = false;
        return;
        label400:
        AVLog.printColorLog("ARZimuTask_SpitZimuTask", "requestRender, spitZimuItemTask=" + paramARZimuItemTask.a.jdField_a_of_type_JavaLangCharSequence);
        localISpitZimuTaskPlayer.a(((PointF)localObject1).x, ((PointF)localObject1).y, bool);
        AVLog.printColorLog("ARZimuTask_SpitZimuTask", "requestRender, updateEmitterLocation=" + ((PointF)localObject1).x + "|" + ((PointF)localObject1).y);
        ...
        if (localObject1 != null)
        {
          ...
          AVLog.printColorLog("ARZimuTask_SpitZimuTask", "requestRender, updateParticleTexture=" + i + "|" + j + "|" + k);
          paramARZimuItemTask.b = false;
        }
        while (paramARZimuItemTask.a.a())
        {
          localISpitZimuTaskPlayer.a(bool);
          AVLog.printColorLog("ARZimuTask_SpitZimuTask", "requestRender, isEnd");
          return;
          AVLog.printColorLog("ARZimuTask_SpitZimuTask", "requestRender, bitmap is null");
        }
        break;
  ...
  {
    QLog.w("ARZimuTask_SpitZimuTask", 1, "setMouthDetectorWeakReference, detector[" + paramIMouthDetector + "]");
  ...
  void a(String paramString, PointF paramPointF, boolean paramBoolean)
  {
    if (this.jdField_a_of_type_JavaUtilMap.containsKey(paramString))
    {
      localObject1 = (SpitZimuTask.MouthLoactionInfo)this.jdField_a_of_type_JavaUtilMap.get(paramString);
      Object localObject2 = ((SpitZimuTask.MouthLoactionInfo)localObject1).jdField_a_of_type_AndroidGraphicsPointF;
      ...
      if (localObject2 == null)
      {
        ...
        ((SpitZimuTask.MouthLoactionInfo)localObject1).a(paramPointF);
        ((SpitZimuTask.MouthLoactionInfo)localObject1).jdField_a_of_type_Boolean = paramBoolean;
        if (!paramBoolean) {
          break label276;
        }
        ((SpitZimuTask.MouthLoactionInfo)localObject1).jdField_a_of_type_Long = System.currentTimeMillis();
        if ((paramPointF.x < 0.0F) || (paramPointF.y < 0.0F)) {
          break label182;
        }
        a(paramString, (SpitZimuTask.MouthLoactionInfo)localObject1);
      }
      label182:
      do
      {
        do
        {
          do
          {
            do
            {
              ...
              paramPointF.a(true);
              return;
              if (System.currentTimeMillis() - ((SpitZimuTask.MouthLoactionInfo)localObject1).jdField_a_of_type_Long <= 1500L) {
                break label386;
              }
              paramPointF = a();
            } while (paramPointF == null);
    ...
    Object localObject1 = new SpitZimuTask.MouthLoactionInfo();
    ((SpitZimuTask.MouthLoactionInfo)localObject1).a(paramPointF);
    ((SpitZimuTask.MouthLoactionInfo)localObject1).jdField_a_of_type_Boolean = paramBoolean;
    if (paramBoolean) {
      ((SpitZimuTask.MouthLoactionInfo)localObject1).jdField_a_of_type_Long = System.currentTimeMillis();
      ...
      do
      {
        do
        {
          do
          {
            ...
            AVLog.printColorLog("ARZimuTask_SpitZimuTask", "handleSubNotify msgType:" + i);
  ...
  public void b(int paramInt)
  {
    ...
    if (localObject != null)
    {
      ...
      if (localObject != null)
      {
        localObject = ((VideoController)localObject).a(true);
        if (localObject != null) {
          ((EffectsRenderController)localObject).a(paramInt);
        }
        return;
      }
  ...
  protected void b(boolean paramBoolean)
  {
    ...
    {
      AVLog.printColorLog("ARZimuTask_SpitZimuTask", "requestFaceFeatureExp:" + paramBoolean + "|" + (String)localObject);
  ...
  public void c(int paramInt)
  {
    ...
    if (localObject != null)
    {
      ...
      if (localObject != null)
      {
        localObject = ((VideoController)localObject).a(false);
        if (localObject != null) {
          ((EffectsRenderController)localObject).c(paramInt);
        }
      }
    }
  }
