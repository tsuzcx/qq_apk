...
{
  public static ARZimuTask a(long paramLong, VideoAppInterface paramVideoAppInterface, Context paramContext, String paramString)
  {
    ...
    {
      paramVideoAppInterface = new SpitZimuTask(paramLong, paramVideoAppInterface);
