...
public class VideoRecoveryMonitor
{
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ...
          i = localSessionInfo.F;
          j = localSessionInfo.jdField_d_of_type_Int;
          bool1 = localSessionInfo.N;
          bool2 = localSessionInfo.P;
  ...
  public void a()
  {
    ...
    if (this.jdField_c_of_type_Boolean)
    {
      ...
      {
        localObject = this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().a();
        this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(((SessionInfo)localObject).j, ((SessionInfo)localObject).jdField_d_of_type_JavaLangString, ((SessionInfo)localObject).f);
      }
    }
    a(true);
    d();
  ...
  public void a(int paramInt, long paramLong)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject3 = SessionMgr.a(j, (String)localObject1, new int[0]);
        localObject3 = SessionMgr.a().a((String)localObject3, false);
        ((SessionInfo)localObject3).j = 0;
        ((SessionInfo)localObject3).jdField_d_of_type_JavaLangString = ((String)localObject1);
        ((SessionInfo)localObject3).e = ((String)localObject2);
        ((SessionInfo)localObject3).F = j;
        ((SessionInfo)localObject3).ak = true;
        ((SessionInfo)localObject3).i = l2;
        ((SessionInfo)localObject3).a(l3, "recoverLastCallIfNeed", 1);
        ((SessionInfo)localObject3).S = true;
        ((SessionInfo)localObject3).N = bool1;
        ((SessionInfo)localObject3).g = bool3;
        ...
        {
          SmallScreenUtils.a(l3, 1, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp(), false, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin(), false);
          localObject1 = ((VideoController)localObject2).a;
          if (localObject1 != null) {
            ((TraeHelper)localObject1).a("DEVICE_SPEAKERPHONE;DEVICE_EARPHONE;DEVICE_BLUETOOTHHEADSET;DEVICE_WIREDHEADSET;");
          }
          this.jdField_c_of_type_Boolean = true;
          this.jdField_b_of_type_Long = System.currentTimeMillis();
          this.e = bool2;
          VideoRecoveryReporter.a(paramInt, paramLong, this.jdField_c_of_type_Boolean);
          return;
        }
      }
      catch (Throwable localThrowable)
      ...
      SmallScreenUtils.a(0L, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 2);
      continue;
      label589:
