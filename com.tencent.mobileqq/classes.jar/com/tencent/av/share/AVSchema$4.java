  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (this.this$0.jdField_a_of_type_Bafb != null) {}
    try
    {
      this.this$0.jdField_a_of_type_Bafb.show();
      this.this$0.jdField_a_of_type_Bafb.getWindow().getDecorView().requestLayout();
