  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (this.this$0.jdField_a_of_type_Bbgg != null) {}
    try
    {
      this.this$0.jdField_a_of_type_Bbgg.show();
      this.this$0.jdField_a_of_type_Bbgg.getWindow().getDecorView().requestLayout();
