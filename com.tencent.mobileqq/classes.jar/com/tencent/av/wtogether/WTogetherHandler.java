  ...
  extends BusinessHandler
{
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (paramToServiceMsg = paramToServiceMsg.bytes_cmd_0x346_rsp_body.get().toByteArray();; paramToServiceMsg = null)
    {
      ...
      {
        return;
        paramToServiceMsg = (WTogetherMng)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(15);
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      localReqComResult.a((WTogetherCommon.Result)paramFromServiceMsg.res.get());
      paramToServiceMsg = localObject;
      if (paramFromServiceMsg.room_info.has()) {
        paramToServiceMsg = (WTogetherCommon.RoomInfo)paramFromServiceMsg.room_info.get();
      }
      paramFromServiceMsg = (WTogetherMng)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(15);
    ...
    catch (InvalidProtocolBufferMicroException paramToServiceMsg)
    {
      ...
      QLog.i("WTogether.Handler", 4, "handleStartWTogether, result[" + localReqComResult + "]");
    }
  }
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      ((WTogetherMng)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(15)).a(localReqComResult, paramToServiceMsg);
      notifyUI(4, localReqComResult.a, localReqComResult);
      if (QLog.isDevelopLevel()) {
        QLog.i("WTogether.Handler", 4, "handleQueryRoomInfo, result[" + localReqComResult + "]");
      }
      return;
    }
    catch (InvalidProtocolBufferMicroException paramToServiceMsg)
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    catch (InvalidProtocolBufferMicroException paramToServiceMsg)
    {
      ...
      QLog.i("WTogether.Handler", 4, "handleChangeVideoStatus, result[" + localReqComResult + "]");
    }
  }
  ...
  private void f(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      ((WTogetherMng)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(15)).b(localReqComResult, localChooseFileInfo, paramToServiceMsg);
      notifyUI(6, localReqComResult.a, localReqComResult);
      if (QLog.isDevelopLevel()) {
        QLog.i("WTogether.Handler", 4, "handleChangeVideoFile, result[" + localReqComResult + "]");
      }
      return;
    }
    catch (InvalidProtocolBufferMicroException paramToServiceMsg)
  ...
  private void g(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      ((WTogetherMng)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(15)).a(localReqComResult, l2, paramToServiceMsg);
      notifyUI(7, localReqComResult.a, localReqComResult);
      if (QLog.isDevelopLevel()) {
        QLog.i("WTogether.Handler", 4, "handleSyncPlayInfo, result[" + localReqComResult + "]");
      }
      return;
    }
    catch (InvalidProtocolBufferMicroException paramToServiceMsg)
  ...
  private void i(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    catch (InvalidProtocolBufferMicroException paramToServiceMsg)
    {
      ...
      QLog.i("WTogether.Handler", 4, "handleEnterRoom, result[" + localReqComResult + "], tryCnt[" + j + "]");
    }
  }
  ...
  public void a(int paramInt, long paramLong1, long paramLong2, WTSyncPlayInfo paramWTSyncPlayInfo)
  {
    ...
    do
    {
      ...
      localCmdSyncPlayTimeReq.video_status.set(paramWTSyncPlayInfo.a());
      localCmdSyncPlayTimeReq.cur_play_time.set(paramWTSyncPlayInfo.a());
      localCmdSyncPlayTimeReq.cur_play_rate.set((int)(paramWTSyncPlayInfo.a() * 100.0F));
    ...
    QLog.i("WTogether.Handler", 4, "syncPlayInfo, from[" + paramInt + "], room[" + paramLong1 + "], seq[" + paramLong2 + "], playStateInfo[" + paramWTSyncPlayInfo + "]");
  }
