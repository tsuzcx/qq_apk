...
public class ChatRoomUtil
{
  ...
  public static String a(QQTextBuilder paramQQTextBuilder)
  {
    ...
    if ((localObject2 != null) && (localObject2.length > 0))
    {
      ...
      {
        paramQQTextBuilder = (EmotionData)((Iterator)localObject2).next();
        localObject3 = paramQQTextBuilder.jdField_a_of_type_ComTencentMobileqqTextStyleEmoticonSpan;
        int k = paramQQTextBuilder.jdField_a_of_type_Int;
        j = paramQQTextBuilder.b;
        switch (((EmoticonSpan)localObject3).emojiType)
        {
        default: 
        ...
        for (;;)
        {
          ...
          i = j;
          break;
          paramQQTextBuilder = '\024' + ((EmoticonSpan)localObject3).getDescription();
          continue;
          paramQQTextBuilder = a(((EmoticonSpan)localObject3).index & 0x7FFFFFFF);
        }
      }
