  ...
  implements Handler.Callback
{
  ...
  private ChatRoomInfo a(chatroom_sso.RoomKey paramRoomKey)
  {
    ...
    if (i == paramRoomKey.type.get())
    {
      ...
      if (l5 == paramRoomKey.id.get())
      {
        ...
        l1 = ((SessionInfo)localObject1).b();
        l2 = ((SessionInfo)localObject1).g();
      }
    }
    if ((i == paramRoomKey.type.get()) && (l5 == paramRoomKey.id.get()) && (l1 == paramRoomKey.room_id.get()) && (l2 == paramRoomKey.create_ts.get())) {}
    for (localObject1 = a((SessionInfo)localObject1);; localObject1 = null)
    {
  ...
  {
    if ((paramChatRoomMsg == null) || (paramChatRoomMsg.jdField_a_of_type_ComTencentAvChatroomChatRoomInfo == null)) {}
    ChatRoomInfo localChatRoomInfo;
    do
    {
      return;
      localChatRoomInfo = paramChatRoomMsg.jdField_a_of_type_ComTencentAvChatroomChatRoomInfo;
      long l1 = 0L;
      try
      {
      ...
      l2 = AudioHelper.b();
      if (QLog.isColorLevel()) {
        QLog.i("ChatRoomMng", 2, "sendMsg, seq[" + l2 + "], room[" + localChatRoomInfo + "], msg[" + paramChatRoomMsg + "]");
      }
      paramChatRoomMsg.a();
      ...
      localObject = new NewIntent(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApplication(), VideoServlet.class);
      ...
      ((NewIntent)localObject).putExtra("localSeq", paramChatRoomMsg.jdField_b_of_type_Long);
      SeqUtil.a((Intent)localObject, l2);
      this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.startServlet((NewIntent)localObject);
    } while (paramChatRoomMsg.e != ChatRoomMsg.jdField_a_of_type_Int);
  ...
  public ChatRoomInfo a(SessionInfo paramSessionInfo)
  {
    ...
    for (;;)
    {
      ...
      if ((QLog.isDevelopLevel()) && (paramSessionInfo != null)) {
        QLog.i("ChatRoomMng", 4, "enterChatRoom, SessionType[" + paramSessionInfo.jdField_d_of_type_Int + "], relationType[" + paramSessionInfo.F + "], relationId[" + paramSessionInfo.g + "], peerUin[" + paramSessionInfo.jdField_d_of_type_JavaLangString + "], extraUin[" + paramSessionInfo.f + "], isDoubleVideoMeeting[" + paramSessionInfo.J + "], room[" + localChatRoomInfo + "]");
      }
      return localChatRoomInfo;
      label189:
    ...
    for (;;)
    {
      ...
      if (localChatRoomInfo2 == null)
      {
        ...
        if (paramBoolean)
        {
          ...
          {
            QLog.i("ChatRoomMng", 4, "getRoomInfo, SessionType[" + paramSessionInfo.jdField_d_of_type_Int + "], relationType[" + paramSessionInfo.F + "], relationId[" + paramSessionInfo.g + "], peerUin[" + paramSessionInfo.jdField_d_of_type_JavaLangString + "], extraUin[" + paramSessionInfo.f + "], isDoubleVideoMeeting[" + paramSessionInfo.J + "], type[" + i + "], roomID[" + l2 + "], id[" + l5 + "], createTime[" + l1 + "], room[" + localChatRoomInfo1 + "]");
            localObject = localChatRoomInfo1;
          }
        }
      }
  ...
  public ChatRoomMsg a(ChatRoomInfo paramChatRoomInfo, long paramLong)
  {
    ...
    if ((paramChatRoomInfo != null) && (paramChatRoomInfo.size() > 0))
    {
      ...
      do
      {
        ...
        paramChatRoomInfo = (ChatRoomMsg)localIterator.next();
  ...
  public void a(SessionInfo paramSessionInfo)
  {
    ...
    a(localChatRoomInfo);
    if ((QLog.isDevelopLevel()) && (paramSessionInfo != null)) {
      QLog.i("ChatRoomMng", 4, "quitChatRoom, SessionType[" + paramSessionInfo.jdField_d_of_type_Int + "], relationType[" + paramSessionInfo.F + "], relationId[" + paramSessionInfo.g + "], peerUin[" + paramSessionInfo.jdField_d_of_type_JavaLangString + "], extraUin[" + paramSessionInfo.f + "], isDoubleVideoMeeting[" + paramSessionInfo.J + "], room[" + localChatRoomInfo + "]");
    }
  }
  ...
  public void a(ChatRoomInfo paramChatRoomInfo, chatroom_sso.Msg paramMsg, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      if (localIterator.hasNext())
      {
        localChatRoomMsg = (ChatRoomMsg)localIterator.next();
        if (localChatRoomMsg != null) {
          if (localChatRoomMsg.a(paramMsg))
          {
            bool = true;
            localChatRoomMsg.jdField_c_of_type_Long = paramMsg.msg_time.get();
            localChatRoomMsg.a(ChatRoomMsg.jdField_d_of_type_Int);
          }
        }
      }
    }
    for (;;)
    {
      ...
      {
        bool = true;
        ((ChatRoomMsg)localObject).jdField_d_of_type_Long = paramMsg.msg_id.get();
        ((ChatRoomMsg)localObject).jdField_c_of_type_Long = paramMsg.msg_time.get();
        ((ChatRoomMsg)localObject).a(ChatRoomMsg.jdField_d_of_type_Int);
        label140:
        if (!bool)
        {
          localObject = new ChatRoomMsg(paramChatRoomInfo, paramMsg.uin.get(), paramMsg.msg.get(), paramMsg.msg_time.get(), paramMsg.msg_id.get(), ChatRoomMsg.jdField_d_of_type_Int);
        ...
        else
        {
          ...
          return;
          if ((localChatRoomMsg.jdField_d_of_type_Long != -9223372036854775808L) || (localChatRoomMsg.jdField_a_of_type_Long != l) || (!TextUtils.equals(localChatRoomMsg.jdField_a_of_type_JavaLangString, paramMsg.msg.get()))) {
            break label329;
          }
          localObject = localChatRoomMsg;
        }
      }
      label320:
      label329:
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("ChatRoomMng", 2, "addObserver, observer[" + paramChatRoomObserver + "]");
    }
          ...
          do
          {
            do
            {
              do
              {
                ...
                for (;;)
                {
                  ...
                  catch (InvalidProtocolBufferMicroException paramArrayOfByte)
                  {
                    try
                    {
                      ...
                      ((ChatRoomMsg)localObject1).a(ChatRoomMsg.jdField_b_of_type_Int);
                      b((ChatRoomMsg)localObject1);
                      if (!((ChatRoomMsg)localObject1).b()) {
                        break;
                      }
                ...
                ((ChatRoomMsg)localObject1).jdField_d_of_type_Long = l1;
                ((ChatRoomMsg)localObject1).a(ChatRoomMsg.jdField_c_of_type_Int);
                b((ChatRoomMsg)localObject1);
                if (!paramIntent.jdField_a_of_type_Boolean)
                {
                  ChatRoomUtil.a("0X800A8D4");
                  paramIntent.jdField_a_of_type_Boolean = true;
                }
              } while ((paramIntent.jdField_b_of_type_Boolean) || (TextUtils.isEmpty(((ChatRoomMsg)localObject1).jdField_a_of_type_JavaLangString)) || (((ChatRoomMsg)localObject1).jdField_a_of_type_JavaLangString.indexOf('\024') < 0));
              ChatRoomUtil.a("0X800A8D5");
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("ChatRoomMng", 2, "removeObserver, observer[" + paramChatRoomObserver + "]");
    }
