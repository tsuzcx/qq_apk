...
public class ConfigPBProtocol$S2CConfigInfoPBProtocol
{
  ...
  private int a()
  {
    ...
    Object localObject1 = (hd_video_putinfo.CmdToClientConfigInfoRspBody)this.jdField_a_of_type_TencentImCsLongconnPutinfoHd_video_putinfo$RspBody.msg_to_client_config_info_rsq_body.get();
    int i;
    Object localObject2;
    ...
    if (((hd_video_putinfo.CmdToClientConfigInfoRspBody)localObject1).rpt_msg_trans_buffer_list.has())
    {
      ...
      if ((localObject1 != null) && (((List)localObject1).size() > 0))
      {
        ...
        while (i < ((List)localObject1).size())
        {
          ...
          ((ConfigPBProtocol.ConfigSysInfoNew.TransBuffer)localObject2).jdField_a_of_type_Int = ((hd_video_putinfo.TransBuffer)((List)localObject1).get(i)).uint32_type.get();
          ((ConfigPBProtocol.ConfigSysInfoNew.TransBuffer)localObject2).jdField_a_of_type_JavaLangString = ((hd_video_putinfo.TransBuffer)((List)localObject1).get(i)).bytes_content.get().toStringUtf8();
          ...
          } else if (((ConfigPBProtocol.ConfigSysInfoNew.TransBuffer)localObject2).jdField_a_of_type_Int == 2) {
