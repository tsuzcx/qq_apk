  ...
  implements Parcelable, Serializable
{
  ...
  public static final Parcelable.Creator<AVRedPacketConfig> CREATOR = new lwb();
  ...
  static final String getConfigPrefix()
  {
    ...
    try
    {
      String str = bbdh.a(BaseApplicationImpl.getContext());
      localObject = str;
    }
  ...
  public static AVRedPacketConfig parse(String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        localAVRedPacketConfig.operatingEntranceBeginTime = alwt.b(localXmlPullParser.nextText());
      }
      else if (paramString.equalsIgnoreCase("activityEndTime"))
      {
        localAVRedPacketConfig.operatingEntranceEndTime = alwt.b(localXmlPullParser.nextText());
      }
