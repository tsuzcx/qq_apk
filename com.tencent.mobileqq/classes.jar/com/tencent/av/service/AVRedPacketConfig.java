  ...
  implements Parcelable, Serializable
{
  ...
  public static final Parcelable.Creator<AVRedPacketConfig> CREATOR = new lwg();
  ...
  static final String getConfigPrefix()
  {
    ...
    try
    {
      String str = bbct.a(BaseApplicationImpl.getContext());
      localObject = str;
    }
  ...
  public static AVRedPacketConfig parse(String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        localAVRedPacketConfig.operatingEntranceBeginTime = alwu.b(localXmlPullParser.nextText());
      }
      else if (paramString.equalsIgnoreCase("activityEndTime"))
      {
        localAVRedPacketConfig.operatingEntranceEndTime = alwu.b(localXmlPullParser.nextText());
      }
