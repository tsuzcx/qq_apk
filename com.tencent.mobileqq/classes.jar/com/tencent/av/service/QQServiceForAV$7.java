  ...
  extends TroopBusinessObserver
{
    ...
    synchronized (this.a.jdField_a_of_type_AndroidOsRemoteCallbackList)
    {
      ...
      if (i < j)
      {
        ...
        for (String str = "1";; str = "2") {
          try
          {
            ((IQQServiceCallback)this.a.jdField_a_of_type_AndroidOsRemoteCallbackList.getBroadcastItem(i)).a(paramBoolean1, paramString, str, "getFollowStatus");
            i += 1;
          }
  ...
  public void onGetTroopHideWebConfig(boolean paramBoolean, String paramString1, int paramInt1, String paramString2, int paramInt2, int paramInt3, String paramString3, String paramString4, int paramInt4, int paramInt5, long paramLong)
  {
    ...
    paramString3.removeObserver(this.a.jdField_a_of_type_ComTencentMobileqqAppTroopBusinessObserver);
  }
  
  public void onJoinOrExitOpenTroop(boolean paramBoolean1, String paramString, int paramInt1, boolean paramBoolean2, boolean paramBoolean3, int paramInt2, int paramInt3)
  {
    ...
    localQQAppInterface.removeObserver(this.a.jdField_a_of_type_ComTencentMobileqqAppTroopBusinessObserver);
  }
  ...
  public void onOIDB0X899_0_Ret(boolean paramBoolean, long paramLong1, int paramInt1, List<oidb_0x899.memberlist> paramList, long paramLong2, int paramInt2, String paramString)
  {
    ...
    if ((paramBoolean) && (paramInt1 == 2))
    {
      ...
      paramList.removeObserver(this.a.jdField_a_of_type_ComTencentMobileqqAppTroopBusinessObserver);
    }
  }
  
  public void onReceiveGVideoLevelInfo(RecvGVideoLevelInfo[] paramArrayOfRecvGVideoLevelInfo)
  {
    synchronized (this.a.jdField_a_of_type_AndroidOsRemoteCallbackList)
    {
      int j = this.a.jdField_a_of_type_AndroidOsRemoteCallbackList.beginBroadcast();
