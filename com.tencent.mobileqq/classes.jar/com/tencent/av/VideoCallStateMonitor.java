...
public class VideoCallStateMonitor
{
  ...
  private void a(int paramInt)
  {
    ...
    Map localMap = DeviceInfoUtil.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp());
  ...
  private void c()
  {
    ...
    int i;
    Object localObject3;
    VideoCallStateMonitor.MemoryDetail localMemoryDetail;
    if (j >= 4)
    {
      l1 = ((VideoCallStateMonitor.MemoryDetail)this.jdField_a_of_type_JavaUtilList.get(j - 1 - 1)).jdField_a_of_type_Long;
      l2 = ((VideoCallStateMonitor.MemoryDetail)this.jdField_a_of_type_JavaUtilList.get(1)).jdField_a_of_type_Long;
      l3 = ((VideoCallStateMonitor.MemoryDetail)this.jdField_a_of_type_JavaUtilList.get(j - 1 - 1)).jdField_b_of_type_Long;
      l4 = ((VideoCallStateMonitor.MemoryDetail)this.jdField_a_of_type_JavaUtilList.get(1)).jdField_b_of_type_Long;
      l5 = ((VideoCallStateMonitor.MemoryDetail)this.jdField_a_of_type_JavaUtilList.get(j - 1 - 1)).jdField_c_of_type_Long;
      l6 = ((VideoCallStateMonitor.MemoryDetail)this.jdField_a_of_type_JavaUtilList.get(1)).jdField_c_of_type_Long;
      i = 1;
      if (i >= j - 1 - 1) {
        break label1067;
      }
      localObject3 = (VideoCallStateMonitor.MemoryDetail)this.jdField_a_of_type_JavaUtilList.get(i);
      localMemoryDetail = (VideoCallStateMonitor.MemoryDetail)this.jdField_a_of_type_JavaUtilList.get(i + 1);
      if ((((VideoCallStateMonitor.MemoryDetail)localObject3).jdField_a_of_type_Int != 0) && (((VideoCallStateMonitor.MemoryDetail)localObject3).jdField_a_of_type_Int != localMemoryDetail.jdField_a_of_type_Int))
      {
        if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if (i == 0)
      {
        ...
        for (;;)
        {
          if (((Iterator)localObject3).hasNext())
          {
            ...
            continue;
            this.jdField_c_of_type_Int = localMemoryDetail.jdField_a_of_type_Int;
            if ((!((VideoCallStateMonitor.MemoryDetail)localObject3).a()) || (!localMemoryDetail.a())) {
              if (QLog.isColorLevel()) {
      ...
      do
      {
        ...
        {
          return;
          d1 = localMemoryDetail.f - ((VideoCallStateMonitor.MemoryDetail)localObject3).f;
          d2 = localMemoryDetail.jdField_a_of_type_Long - ((VideoCallStateMonitor.MemoryDetail)localObject3).jdField_a_of_type_Long;
          d3 = localMemoryDetail.jdField_b_of_type_Long - ((VideoCallStateMonitor.MemoryDetail)localObject3).jdField_b_of_type_Long;
          double d4 = localMemoryDetail.jdField_c_of_type_Long - ((VideoCallStateMonitor.MemoryDetail)localObject3).jdField_c_of_type_Long;
          if (d1 <= 0.0D)
          {
            if (QLog.isColorLevel()) {
