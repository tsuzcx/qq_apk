...
final class MediaDataManager$loadVideos$1
  extends Lambda
  implements Function0<Unit>
{
  MediaDataManager$loadVideos$1(Context paramContext, Function2 paramFunction2)
  {
    super(0);
  }
  ...
  public final void invoke()
  {
    ...
    Object localObject1 = MediaStore.Video.Media.EXTERNAL_CONTENT_URI;
    Cursor localCursor = this.$context.getContentResolver().query((Uri)localObject1, new String[] { "_id", "_data", "_size", "date_modified", "duration", "title", "width", "height" }, null, null, "date_modified desc");
    if (localCursor != null)
    {
    ...
    ThreadManagerKt.a((Function0)new MediaDataManager.loadVideos.1.1(this, localArrayList, localHashMap));
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes22.jar
 * Qualified Name:     com.tencent.tkd.topicsdk.mediaselector.MediaDataManager.loadVideos.1
