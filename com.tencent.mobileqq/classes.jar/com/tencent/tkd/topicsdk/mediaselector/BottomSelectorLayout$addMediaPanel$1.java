  ...
  implements Runnable
{
  ...
  {
    Object localObject = this.this$0.getRootView();
    Intrinsics.checkExpressionValueIsNotNull(localObject, "rootView");
    localObject = new RelativeLayout.LayoutParams(-1, ViewKt.c((View)localObject));
    this.a.a().setLayoutParams((ViewGroup.LayoutParams)localObject);
    this.a.a().setLayoutParams((ViewGroup.LayoutParams)localObject);
  }
}
