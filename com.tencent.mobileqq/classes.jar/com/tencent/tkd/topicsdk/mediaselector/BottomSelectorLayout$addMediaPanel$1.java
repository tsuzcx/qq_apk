  ...
  implements Runnable
{
  public final void run()
  {
    ...
    Object localObject2 = new RelativeLayout.LayoutParams(-1, ViewKt.b((View)localObject1));
    localObject1 = this.a.getAlbumPermissionView();
    ...
    this.a.getAlbumEmptyView().setLayoutParams((ViewGroup.LayoutParams)localObject2);
  }
}
