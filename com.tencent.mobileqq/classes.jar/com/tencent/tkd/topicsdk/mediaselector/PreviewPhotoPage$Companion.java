...
public final class PreviewPhotoPage$Companion
{
  ...
  public final void a(@NotNull Activity paramActivity, @NotNull List<String> paramList1, int paramInt1, int paramInt2, @NotNull List<String> paramList2, int paramInt3)
  {
    Intrinsics.checkParameterIsNotNull(paramActivity, "context");
