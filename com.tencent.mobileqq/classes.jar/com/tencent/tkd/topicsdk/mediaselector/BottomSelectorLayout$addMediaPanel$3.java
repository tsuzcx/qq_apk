  ...
  implements Function1<Integer, Unit>
{
  ...
  public final void invoke(int paramInt)
  {
    ...
    if ((this.$panelType == PanelType.PHOTO) && (localObject1 != null))
    {
      ...
      String str = this.$mediaSelectorView.a();
      Object localObject3 = (Iterable)this.$mediaSelectorView.c();
    ...
    if ((this.$panelType == PanelType.VIDEO) && (localObject1 != null))
    {
      ...
      {
        VideoCropPage.a.a((Activity)localObject1, ((Media)this.$mediaSelectorView.a().get(paramInt)).getFilePath(), this.this$0.c(), this.this$0.d(), 4);
        return;
      }
