...
import com.tencent.tkd.topicsdk.widget.ucrop.callback.OverlayViewChangeListener;
  ...
  extends View
{
  ...
  private OverlayViewChangeListener jdField_a_of_type_ComTencentTkdTopicsdkWidgetUcropCallbackOverlayViewChangeListener;
  ...
  private int f = 0;
  private int g = -1;
  private int h = getResources().getDimensionPixelSize(R.dimen.e);
  private int i = getResources().getDimensionPixelSize(R.dimen.f);
  private int j = getResources().getDimensionPixelSize(R.dimen.jdField_d_of_type_Int);
  ...
  private void b(@NotNull TypedArray paramTypedArray)
  {
    int k = paramTypedArray.getDimensionPixelSize(R.styleable.l, getResources().getDimensionPixelSize(R.dimen.jdField_b_of_type_Int));
    int m = paramTypedArray.getColor(R.styleable.k, getResources().getColor(R.color.f));
  ...
  private void c(@NotNull TypedArray paramTypedArray)
  {
    int k = paramTypedArray.getDimensionPixelSize(R.styleable.p, getResources().getDimensionPixelSize(R.dimen.jdField_c_of_type_Int));
    int m = paramTypedArray.getColor(R.styleable.m, getResources().getColor(R.color.g));
    this.jdField_b_of_type_AndroidGraphicsPaint.setStrokeWidth(k);
    this.jdField_b_of_type_AndroidGraphicsPaint.setColor(m);
    this.jdField_c_of_type_Int = paramTypedArray.getInt(R.styleable.o, 2);
    this.jdField_d_of_type_Int = paramTypedArray.getInt(R.styleable.n, 2);
  }
  ...
  protected void a(@NotNull TypedArray paramTypedArray)
  {
    this.jdField_c_of_type_Boolean = paramTypedArray.getBoolean(R.styleable.i, false);
    this.e = paramTypedArray.getColor(R.styleable.j, getResources().getColor(R.color.h));
    this.jdField_a_of_type_AndroidGraphicsPaint.setColor(this.e);
    this.jdField_a_of_type_AndroidGraphicsPaint.setStyle(Paint.Style.STROKE);
    this.jdField_a_of_type_AndroidGraphicsPaint.setStrokeWidth(1.0F);
    b(paramTypedArray);
    this.jdField_a_of_type_Boolean = paramTypedArray.getBoolean(R.styleable.q, true);
    c(paramTypedArray);
    this.jdField_b_of_type_Boolean = paramTypedArray.getBoolean(R.styleable.r, true);
  }
  
  protected void a(@NotNull Canvas paramCanvas)
  {
    paramCanvas.save();
  ...
  protected void b(@NotNull Canvas paramCanvas)
  {
    int i2 = 0;
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    if ((paramMotionEvent.getAction() & 0xFF) == 1)
    {
      ...
      this.jdField_c_of_type_Float = -1.0F;
      this.g = -1;
      if (this.jdField_a_of_type_ComTencentTkdTopicsdkWidgetUcropCallbackOverlayViewChangeListener != null) {
        this.jdField_a_of_type_ComTencentTkdTopicsdkWidgetUcropCallbackOverlayViewChangeListener.a(this.jdField_a_of_type_AndroidGraphicsRectF);
      }
    }
    return false;
  }
  ...
  {
    this.jdField_a_of_type_ComTencentTkdTopicsdkWidgetUcropCallbackOverlayViewChangeListener = paramOverlayViewChangeListener;
  }
 ...
 * Qualified Name:     com.tencent.tkd.topicsdk.widget.ucrop.OverlayView
