...
import com.tencent.tkd.topicsdk.widget.ucrop.callback.CropBoundsChangeListener;
  ...
  extends TransformImageView
{
  ...
  private CropBoundsChangeListener jdField_a_of_type_ComTencentTkdTopicsdkWidgetUcropCallbackCropBoundsChangeListener;
  ...
  private void a(String paramString, boolean paramBoolean, @Nullable CropCallback paramCropCallback)
  {
    ...
    ThreadManager.a.a().post(new CropImageView.2(this, paramBoolean, paramCropCallback, paramString));
  }
  ...
  {
    float f1 = Math.abs(paramTypedArray.getFloat(R.styleable.g, 0.0F));
    float f2 = Math.abs(paramTypedArray.getFloat(R.styleable.h, 0.0F));
    if ((f1 == 0.0F) || (f2 == 0.0F))
    {
  ...
  public void a(@NotNull Bitmap.CompressFormat paramCompressFormat, int paramInt1, int paramInt2, int paramInt3, @Nullable CropCallback paramCropCallback)
  {
    a();
    ...
    ThreadManager.a.a(ThreadType.FILE, new CropImageView.1(this, localBitmap, localImageState, paramCompressFormat, paramInt1, paramCropCallback));
  }
  ...
  protected void b()
  {
    ...
    for (;;)
    {
      b(f1, f2);
      c(f1, f2);
      if (this.jdField_a_of_type_ComTencentTkdTopicsdkWidgetUcropCallbackCropBoundsChangeListener != null) {
        this.jdField_a_of_type_ComTencentTkdTopicsdkWidgetUcropCallbackCropBoundsChangeListener.a(this.jdField_c_of_type_Float);
      }
      if (this.jdField_a_of_type_ComTencentTkdTopicsdkWidgetUcropTransformImageView$TransformImageListener == null) {
        break;
      }
      this.jdField_a_of_type_ComTencentTkdTopicsdkWidgetUcropTransformImageView$TransformImageListener.b(d());
      this.jdField_a_of_type_ComTencentTkdTopicsdkWidgetUcropTransformImageView$TransformImageListener.a(e());
      return;
  ...
  {
    this.jdField_a_of_type_ComTencentTkdTopicsdkWidgetUcropCallbackCropBoundsChangeListener = paramCropBoundsChangeListener;
  }
  ...
  public void setTargetAspectRatio(float paramFloat)
  {
    ...
    for (;;)
    {
      return;
      if (paramFloat == 0.0F) {}
      for (this.jdField_c_of_type_Float = (localDrawable.getIntrinsicWidth() / localDrawable.getIntrinsicHeight()); this.jdField_a_of_type_ComTencentTkdTopicsdkWidgetUcropCallbackCropBoundsChangeListener != null; this.jdField_c_of_type_Float = paramFloat)
      {
        this.jdField_a_of_type_ComTencentTkdTopicsdkWidgetUcropCallbackCropBoundsChangeListener.a(this.jdField_c_of_type_Float);
        return;
      }
 ...
 * Qualified Name:     com.tencent.tkd.topicsdk.widget.ucrop.CropImageView
