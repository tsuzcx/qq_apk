...
import com.tencent.tkd.topicsdk.widget.ucrop.util.RectUtils;
  ...
  extends ImageView
{
  ...
  public float a(@NotNull Matrix paramMatrix)
  {
    return (float)Math.sqrt(Math.pow(a(paramMatrix, 0), 2.0D) + Math.pow(a(paramMatrix, 3), 2.0D));
  }
  
  protected float a(@NotNull Matrix paramMatrix, @IntRange(from=0L, to=9L) int paramInt)
  {
  ...
  public float b(@NotNull Matrix paramMatrix)
  {
  ...
  protected void b()
  {
    ...
    } while (this.jdField_a_of_type_ComTencentTkdTopicsdkWidgetUcropTransformImageView$TransformImageListener == null);
    this.jdField_a_of_type_ComTencentTkdTopicsdkWidgetUcropTransformImageView$TransformImageListener.a();
  }
  ...
  public void c(float paramFloat1, float paramFloat2, float paramFloat3)
  {
    if (paramFloat1 != 0.0F)
    {
      ...
      setImageMatrix(this.jdField_a_of_type_AndroidGraphicsMatrix);
      if (this.jdField_a_of_type_ComTencentTkdTopicsdkWidgetUcropTransformImageView$TransformImageListener != null) {
        this.jdField_a_of_type_ComTencentTkdTopicsdkWidgetUcropTransformImageView$TransformImageListener.b(a(this.jdField_a_of_type_AndroidGraphicsMatrix));
      }
    }
  }
  ...
  {
    this.jdField_a_of_type_ComTencentTkdTopicsdkWidgetUcropTransformImageView$TransformImageListener = paramTransformImageListener;
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes12.jar
 * Qualified Name:     com.tencent.tkd.topicsdk.widget.ucrop.TransformImageView
