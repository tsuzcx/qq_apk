  ...
  implements Runnable
{
  ...
  {
    Object localObject1 = (RelativeLayout)this.this$0.findViewById(R.id.aE);
    Intrinsics.checkExpressionValueIsNotNull(localObject1, "rootView");
    ((RelativeLayout)localObject1).setVisibility(0);
    localObject1 = this.this$0;
    Object localObject2 = (RelativeLayout)((Dialog)localObject1).findViewById(R.id.aE);
    Intrinsics.checkExpressionValueIsNotNull(localObject2, "rootView");
    localObject2 = (View)localObject2;
    RelativeLayout localRelativeLayout = (RelativeLayout)this.this$0.findViewById(R.id.aE);
