...
final class PublishArticlePage$initBottomSelectorLayout$6
  extends Lambda
  implements Function1<PanelType, Unit>
{
  PublishArticlePage$initBottomSelectorLayout$6(PublishArticlePage paramPublishArticlePage)
  {
    super(1);
  }
  ...
  public final void invoke(@NotNull PanelType paramPanelType)
  {
    ...
    for (localObject = PublishArticlePage.a(this.this$0, (MediaType)localObject);; localObject = null)
    {
      if (localObject == paramPanelType)
      {
        PublishArticlePage.b(this.this$0, true);
        if (PublishArticlePage.b(this.this$0)) {
          PublishArticlePage.c(this.this$0);
        }
      }
      return;
    }
 ...
 * Qualified Name:     com.tencent.tkd.topicsdk.publisharticle.PublishArticlePage.initBottomSelectorLayout.6
