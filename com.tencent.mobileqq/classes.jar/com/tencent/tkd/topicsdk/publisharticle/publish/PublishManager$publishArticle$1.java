...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"<anonymous>", "", "errorCode", "", "errorMsg", "", "id", "serverData", "invoke"}, k=3, mv={1, 1, 16})
  ...
  implements Function4<Integer, String, String, String, Unit>
{
  ...
  public final void invoke(int paramInt, @NotNull String paramString1, @NotNull String paramString2, @NotNull String paramString3)
  {
    ...
    Intrinsics.checkParameterIsNotNull(paramString3, "serverData");
 ...
 * Qualified Name:     com.tencent.tkd.topicsdk.publisharticle.publish.PublishManager.publishArticle.1
