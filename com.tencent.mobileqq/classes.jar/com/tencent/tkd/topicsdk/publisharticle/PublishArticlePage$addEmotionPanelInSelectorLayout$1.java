  ...
  implements Function1<Emotion, Unit>
{
  ...
  public final void invoke(@NotNull Emotion paramEmotion)
  {
    ...
    if ((paramEmotion.getEmotionType() == 0) && ((paramEmotion.actualEmotion instanceof EmoJiEmotion)))
    {
      ...
      localObject = (EmoJiEmotion)paramEmotion;
      paramEmotion = TopicSDK.a.a().a().a().a(((EmoJiEmotion)localObject).emoJiResourceId);
      if (paramEmotion != null)
      {
        localRichEditText = PublishArticlePage.a(this.this$0);
    ...
    while (paramEmotion.getEmotionType() != -1)
    {
      Object localObject;
      RichEditText localRichEditText;
      return;
    }
 ...
 * Qualified Name:     com.tencent.tkd.topicsdk.publisharticle.PublishArticlePage.addEmotionPanelInSelectorLayout.1
