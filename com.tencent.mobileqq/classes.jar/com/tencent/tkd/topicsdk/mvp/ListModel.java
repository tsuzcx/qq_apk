...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/tkd/topicsdk/mvp/ListModel;", "BEAN", "COOKIE", "Lcom/tencent/tkd/topicsdk/mvp/ListContract$IListModel;", "()V", "mCookie", "Ljava/lang/Object;", "mErrorCode", "", "mErrorMsg", "", "mHasLoadedDataFromDB", "", "mHasLoadedDataFromNetwork", "mHasNextPage", "getMHasNextPage", "()Z", "setMHasNextPage", "(Z)V", "mIsFirstLoadNetworkFailed", "mList", "Ljava/util/concurrent/CopyOnWriteArrayList;", "getMList", "()Ljava/util/concurrent/CopyOnWriteArrayList;", "setMList", "(Ljava/util/concurrent/CopyOnWriteArrayList;)V", "mTotalSize", "getMTotalSize", "()I", "setMTotalSize", "(I)V", "total", "getTotal", "handleFirstPageDataFromDB", "", "list", "", "callback", "Lkotlin/Function6;", "Lkotlin/ParameterName;", "name", "isSuccess", "isCacheData", "errorCode", "errorMsg", "Lcom/tencent/tkd/topicsdk/mvp/FirstPageCallback;", "handleFirstPageDataFromNetwork", "needCache", "isEnd", "totalSize", "cookie", "(ZZZILjava/util/List;Ljava/lang/Object;ILjava/lang/String;Lkotlin/jvm/functions/Function6;)V", "hasNextPage", "loadDataFromDB", "Lkotlin/Function1;", "loadDataFromNetwork", "Lkotlin/Function7;", "Ljava/util/ArrayList;", "Lkotlin/collections/ArrayList;", "Lcom/tencent/tkd/topicsdk/mvp/LoadDataFromNetworkCallback;", "(Ljava/lang/Object;Lkotlin/jvm/functions/Function7;)V", "loadFirstPage", "loadNextPage", "Lkotlin/Function4;", "allList", "Lcom/tencent/tkd/topicsdk/mvp/NextPageCallback;", "resetStates", "saveDataToDB", "Companion", "topicsdk-framework_release"}, k=1, mv={1, 1, 16})
  ...
  implements ListContract.IListModel<BEAN>
{
  ...
  static
  {
    jdField_a_of_type_ComTencentTkdTopicsdkMvpListModel$Companion = new ListModel.Companion(null);
  }
