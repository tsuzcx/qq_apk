...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"<anonymous>", "", "communityInfo", "Lcom/tencent/tkd/topicsdk/bean/CommunityInfo;", "invoke", "com/tencent/tkd/topicsdk/adapter/publisharticle/PublishArticlePage$initEditVideoSettingsLayout$6$1$1"}, k=3, mv={1, 1, 16})
final class PublishArticlePage$initEditVideoSettingsLayout$6$$special$$inlined$let$lambda$1
  extends Lambda
  implements Function1<CommunityInfo, Unit>
{
  PublishArticlePage$initEditVideoSettingsLayout$6$$special$$inlined$let$lambda$1(Activity paramActivity, PublishArticlePage.initEditVideoSettingsLayout.6 param6)
  {
    super(1);
  }
  ...
  {
    String str = this.$it.getString(R.string.d);
    if (paramCommunityInfo != null) {
      localObject1 = paramCommunityInfo.getCommunityId();
    } else {
      localObject1 = null;
    }
    Object localObject2 = PublishArticlePage.e(this.this$0.a);
    ...
    if (Intrinsics.areEqual(localObject1, localObject2))
    {
      ...
      PublishArticlePage.f(this.this$0.a).setText((CharSequence)str);
      QQPublishArticleReportUtils.a.a(paramCommunityInfo, ReportEventElement.BUTTON_CANCEL);
      return;
    }
    QQPublishArticleReportUtils.a.a(PublishArticlePage.e(this.this$0.a), ReportEventElement.BUTTON_CANCEL);
    ...
    Object localObject1 = PublishArticlePage.f(this.this$0.a);
    if (paramCommunityInfo != null)
    {
 ...
 * Qualified Name:     com.tencent.tkd.topicsdk.adapter.publisharticle.PublishArticlePage.initEditVideoSettingsLayout.6..special..inlined.let.lambda.1
