...
final class PublishArticlePage$initBottomSelectorLayout$3
  implements View.OnTouchListener
{
  PublishArticlePage$initBottomSelectorLayout$3(PublishArticlePage paramPublishArticlePage, ViewGroup paramViewGroup) {}
  ...
  public final boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    if (paramMotionEvent.getAction() == 0)
    {
      ...
      IBinder localIBinder = PublishArticlePage.a(this.jdField_a_of_type_ComTencentTkdTopicsdkAdapterPublisharticlePublishArticlePage).getWindowToken();
 ...
 * Qualified Name:     com.tencent.tkd.topicsdk.adapter.publisharticle.PublishArticlePage.initBottomSelectorLayout.3
