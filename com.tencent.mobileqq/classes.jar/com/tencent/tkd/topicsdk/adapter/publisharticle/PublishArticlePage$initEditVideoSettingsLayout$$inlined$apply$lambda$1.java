...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"<anonymous>", "", "allowReprint", "", "invoke", "com/tencent/tkd/topicsdk/adapter/publisharticle/PublishArticlePage$initEditVideoSettingsLayout$4$1"}, k=3, mv={1, 1, 16})
