...
final class PublishArticlePage$initEditVideoSettingsLayout$8
  implements View.OnClickListener
{
  PublishArticlePage$initEditVideoSettingsLayout$8(PublishArticlePage paramPublishArticlePage) {}
  ...
  public final void onClick(View paramView)
  {
    ...
    if (localActivity != null)
    {
      ...
      paramView = PublishArticlePage.a(this.a);
      if (paramView != null)
      {
      ...
      localCompanion.a(localActivity, paramView, (Function1)new PublishArticlePage.initEditVideoSettingsLayout.8..special..inlined.let.lambda.1(localActivity, this));
    }
  }
}
 ...
 * Qualified Name:     com.tencent.tkd.topicsdk.adapter.publisharticle.PublishArticlePage.initEditVideoSettingsLayout.8
