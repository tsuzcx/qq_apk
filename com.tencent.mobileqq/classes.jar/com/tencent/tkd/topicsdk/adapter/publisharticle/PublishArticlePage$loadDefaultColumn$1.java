...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"<anonymous>", "", "isSuccess", "", "list", "", "Lcom/tencent/tkd/topicsdk/bean/TopicInfo;", "<anonymous parameter 2>", "", "<anonymous parameter 3>", "<anonymous parameter 4>", "<anonymous parameter 5>", "", "invoke"}, k=3, mv={1, 1, 16})
