...
final class PermissionUtils$requestPosPermission$1
  implements IPermission.Callback
{
  PermissionUtils$requestPosPermission$1(Function1 paramFunction1) {}
  ...
  public final void a(int paramInt, @NotNull String[] paramArrayOfString, @NotNull int[] paramArrayOfInt)
  {
    ...
    if (paramInt == 4)
    {
      ...
      {
        bool1 = bool2;
        if (Intrinsics.areEqual(paramArrayOfString[0], "android.permission.ACCESS_FINE_LOCATION"))
        {
    ...
    DispatchManager.a.a((IEvent)new PosPermissionEvent(bool1));
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes22.jar
 * Qualified Name:     com.tencent.tkd.topicsdk.common.PermissionUtils.requestPosPermission.1
