  ...
  extends CropImageView
{
  ...
  private RotationGestureDetector jdField_a_of_type_ComTencentTkdTopicsdkUcropUtilRotationGestureDetector;
  private float b;
  ...
  private void d()
  {
    ...
    this.jdField_a_of_type_ComTencentTkdTopicsdkUcropUtilRotationGestureDetector = new RotationGestureDetector(new GestureCropImageView.RotateListener(this, null));
  }
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    {
      this.jdField_a_of_type_Float = ((paramMotionEvent.getX(0) + paramMotionEvent.getX(1)) / 2.0F);
      this.b = ((paramMotionEvent.getY(0) + paramMotionEvent.getY(1)) / 2.0F);
    }
    ...
    if (this.jdField_c_of_type_Boolean) {
      this.jdField_a_of_type_ComTencentTkdTopicsdkUcropUtilRotationGestureDetector.a(paramMotionEvent);
    }
