  ...
  extends TransformImageView
{
  ...
  private CropBoundsChangeListener jdField_a_of_type_ComTencentTkdTopicsdkUcropCallbackCropBoundsChangeListener;
  ...
  private void a(String paramString, boolean paramBoolean, @Nullable BitmapCropCallback paramBitmapCropCallback)
  {
    ...
    new Handler(Looper.getMainLooper()).post(new CropImageView.2(this, paramBoolean, paramBitmapCropCallback, paramString));
  }
  ...
  {
    this.jdField_d_of_type_Float = Math.min(Math.min(this.jdField_a_of_type_AndroidGraphicsRectF.width() / paramFloat1, this.jdField_a_of_type_AndroidGraphicsRectF.width() / paramFloat2), Math.min(this.jdField_a_of_type_AndroidGraphicsRectF.height() / paramFloat2, this.jdField_a_of_type_AndroidGraphicsRectF.height() / paramFloat1));
    this.jdField_c_of_type_Float = (this.jdField_d_of_type_Float * this.jdField_b_of_type_Float);
  }
  ...
  {
    if (paramFloat1 <= a()) {
      b(paramFloat1 / d(), paramFloat2, paramFloat3);
    }
  }
  ...
  protected void a(float paramFloat1, float paramFloat2, float paramFloat3, long paramLong)
  {
    ...
    paramFloat1 = d();
    CropImageView.ZoomImageToPosition localZoomImageToPosition = new CropImageView.ZoomImageToPosition(this, paramLong, paramFloat1, f - paramFloat1, paramFloat2, paramFloat3);
  ...
  {
    float f1 = Math.abs(paramTypedArray.getFloat(R.styleable.jdField_a_of_type_Int, 0.0F));
    float f2 = Math.abs(paramTypedArray.getFloat(R.styleable.jdField_b_of_type_Int, 0.0F));
    if ((f1 != 0.0F) && (f2 != 0.0F))
    {
      this.jdField_a_of_type_Float = (f1 / f2);
      return;
    }
  ...
  public void a(@NotNull Bitmap.CompressFormat paramCompressFormat, int paramInt, String paramString, @Nullable BitmapCropCallback paramBitmapCropCallback)
  {
    ...
    ImageState localImageState = new ImageState(this.jdField_a_of_type_AndroidGraphicsRectF, RectUtils.a(this.jdField_a_of_type_ArrayOfFloat), d(), e());
    Executors.newSingleThreadExecutor().execute(new CropImageView.1(this, localBitmap, localImageState, paramString, paramCompressFormat, paramInt, paramBitmapCropCallback));
  }
  ...
  protected void b()
  {
    ...
    int i = (int)(this.jdField_a_of_type_Int / this.jdField_a_of_type_Float);
    int j;
    if (i > this.jdField_b_of_type_Int)
    {
      i = (int)(this.jdField_b_of_type_Int * this.jdField_a_of_type_Float);
    ...
    b(f1, f2);
    c(f1, f2);
    localObject = this.jdField_a_of_type_ComTencentTkdTopicsdkUcropCallbackCropBoundsChangeListener;
    if (localObject != null) {
      ((CropBoundsChangeListener)localObject).a(this.jdField_a_of_type_Float);
    }
    if (this.jdField_a_of_type_ComTencentTkdTopicsdkUcropViewTransformImageView$TransformImageListener != null)
    {
      this.jdField_a_of_type_ComTencentTkdTopicsdkUcropViewTransformImageView$TransformImageListener.b(d());
      this.jdField_a_of_type_ComTencentTkdTopicsdkUcropViewTransformImageView$TransformImageListener.a(e());
    }
  }
  
  public void b(float paramFloat1, float paramFloat2, float paramFloat3)
  {
    if ((paramFloat1 > 1.0F) && (d() * paramFloat1 <= a()))
    {
      super.b(paramFloat1, paramFloat2, paramFloat3);
      return;
    }
    if ((paramFloat1 < 1.0F) && (d() * paramFloat1 >= b())) {
      super.b(paramFloat1, paramFloat2, paramFloat3);
    }
  }
  ...
  {
    this.jdField_a_of_type_ComTencentTkdTopicsdkUcropCallbackCropBoundsChangeListener = paramCropBoundsChangeListener;
  }
  
  public void setCropRect(RectF paramRectF)
  {
    this.jdField_a_of_type_Float = (paramRectF.width() / paramRectF.height());
  ...
  public void setImageToWrapCropBounds(boolean paramBoolean)
  {
    if ((this.jdField_b_of_type_Boolean) && (!a()))
    {
      ...
      a(f1, f2);
      if (!bool) {
        a(f6 + f3, this.jdField_a_of_type_AndroidGraphicsRectF.centerX(), this.jdField_a_of_type_AndroidGraphicsRectF.centerY());
      }
    }
  }
  ...
  public void setTargetAspectRatio(float paramFloat)
  {
    ...
    if (paramFloat == 0.0F) {
      this.jdField_a_of_type_Float = (((Drawable)localObject).getIntrinsicWidth() / ((Drawable)localObject).getIntrinsicHeight());
    } else {
      this.jdField_a_of_type_Float = paramFloat;
    }
    localObject = this.jdField_a_of_type_ComTencentTkdTopicsdkUcropCallbackCropBoundsChangeListener;
 ...
 * Qualified Name:     com.tencent.tkd.topicsdk.ucrop.view.CropImageView
