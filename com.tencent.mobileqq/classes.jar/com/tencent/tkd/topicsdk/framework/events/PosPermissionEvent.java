...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/tkd/topicsdk/framework/events/PosPermissionEvent;", "Lcom/tencent/tkd/topicsdk/framework/eventdispatch/IEvent;", "isGranted", "", "(Z)V", "()Z", "component1", "copy", "equals", "other", "", "hashCode", "", "toString", "", "topicsdk_release"}, k=1, mv={1, 1, 16})
public final class PosPermissionEvent
  implements IEvent
{
  private final boolean a;
  
  public PosPermissionEvent(boolean paramBoolean)
  {
    this.a = paramBoolean;
  }
