...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/tkd/topicsdk/selecttopic/SelectTopicView;", "Lcom/tencent/tkd/topicsdk/selecttopic/BaseSelectView;", "Lcom/tencent/tkd/topicsdk/bean/TopicInfo;", "Lcom/tencent/tkd/topicsdk/selecttopic/SelectTopicView$MyTopicViewHolder;", "context", "Landroid/app/Activity;", "selectedTopicId", "", "listPresenter", "Lcom/tencent/tkd/topicsdk/mvp/ListPresenter;", "Lcom/tencent/tkd/topicsdk/mvp/ListContract$IListView;", "(Landroid/app/Activity;JLcom/tencent/tkd/topicsdk/mvp/ListPresenter;)V", "adapter", "Lcom/tencent/tkd/topicsdk/list/CommonListAdapter;", "getAdapter", "()Lcom/tencent/tkd/topicsdk/list/CommonListAdapter;", "getContext", "()Landroid/app/Activity;", "createTopicListener", "Lkotlin/Function2;", "", "", "mTopicAdapter", "com/tencent/tkd/topicsdk/selecttopic/SelectTopicView$mTopicAdapter$1", "Lcom/tencent/tkd/topicsdk/selecttopic/SelectTopicView$mTopicAdapter$1;", "rightActionText", "", "getRightActionText", "()Ljava/lang/String;", "selectTip", "getSelectTip", "getSelectedTopicId", "()J", "handleRightActionClick", "onAttachedToWindow", "onDetachedFromWindow", "Companion", "MyTopicViewHolder", "topicsdk_release"}, k=1, mv={1, 1, 16})
  ...
  extends BaseSelectView<TopicInfo, SelectTopicView.MyTopicViewHolder>
{
  ...
  private final SelectTopicView.mTopicAdapter.1 jdField_a_of_type_ComTencentTkdTopicsdkSelecttopicSelectTopicView$mTopicAdapter$1;
  private HashMap jdField_a_of_type_JavaUtilHashMap;
  private final Function2<Integer, TopicInfo, Unit> jdField_a_of_type_KotlinJvmFunctionsFunction2;
  
  static
  {
    jdField_a_of_type_ComTencentTkdTopicsdkSelecttopicSelectTopicView$Companion = new SelectTopicView.Companion(null);
  }
  ...
  public SelectTopicView(@NotNull Activity paramActivity, long paramLong, @NotNull ListPresenter<TopicInfo, ListContract.IListView<TopicInfo>> paramListPresenter)
  {
    ...
    this.jdField_a_of_type_ComTencentTkdTopicsdkSelecttopicSelectTopicView$mTopicAdapter$1 = new SelectTopicView.mTopicAdapter.1(this, (Context)this.jdField_a_of_type_AndroidAppActivity);
  ...
  {
    return (CommonListAdapter)this.jdField_a_of_type_ComTencentTkdTopicsdkSelecttopicSelectTopicView$mTopicAdapter$1;
  }
  
  @NotNull
  public String a()
  {
    String str = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(R.string.Y);
  ...
  public String b()
  {
    String str = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(R.string.q);
 ...
 * Qualified Name:     com.tencent.tkd.topicsdk.selecttopic.SelectTopicView
