  ...
  implements Function0<Unit>
{
  ...
  public final void invoke()
  {
    if (this.$errorCode == 0)
    {
      ...
      if (localObject2 != null) {}
      for (localObject2 = (Collection)localObject2;; localObject2 = (Collection)CollectionsKt.emptyList())
      {
        localFunction7.invoke(Boolean.valueOf(true), Boolean.valueOf(bool), Integer.valueOf(0), new ArrayList((Collection)localObject2), localObject1, Integer.valueOf(this.$errorCode), this.$errorMsg);
        return;
      }
    }
    this.this$0.$callback.invoke(Boolean.valueOf(false), Boolean.valueOf(true), Integer.valueOf(0), new ArrayList(), null, Integer.valueOf(this.$errorCode), this.$errorMsg);
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes12.jar
 * Qualified Name:     com.tencent.tkd.topicsdk.selecttopic.SelectCommunityModel.loadDataFromNetwork.1.1
