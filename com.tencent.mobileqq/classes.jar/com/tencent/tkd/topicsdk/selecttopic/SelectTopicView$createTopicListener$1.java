  ...
  implements Function2<Integer, TopicInfo, Unit>
{
  ...
  {
    TLog.a("SelectTopicView", "create Topic result, errorCode = " + paramInt + ", topic=" + paramTopicInfo);
 ...
 * Qualified Name:     com.tencent.tkd.topicsdk.selecttopic.SelectTopicView.createTopicListener.1
