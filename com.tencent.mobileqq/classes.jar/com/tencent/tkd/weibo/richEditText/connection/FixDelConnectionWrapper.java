...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/tkd/weibo/richEditText/connection/FixDelConnectionWrapper;", "Landroid/view/inputmethod/InputConnectionWrapper;", "connection", "Landroid/view/inputmethod/InputConnection;", "mutable", "", "(Landroid/view/inputmethod/InputConnection;Z)V", "deleteSurroundingText", "beforeLength", "", "afterLength", "Companion", "tkd-weibo-richtext_release"}, k=1, mv={1, 1, 16})
 ...
 * Qualified Name:     com.tencent.tkd.weibo.richEditText.connection.FixDelConnectionWrapper
