...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"<anonymous>", "", "it", "Lcom/tencent/tkd/weibo/bean/TweetTopicItem;", "invoke", "com/tencent/tkd/weibo/tweetTopic/TweetTopicView$initTopicList$1$1"}, k=3, mv={1, 1, 16})
final class TweetTopicView$initTopicList$$inlined$apply$lambda$1
  extends Lambda
  implements Function1<TweetTopicItem, Unit>
{
  TweetTopicView$initTopicList$$inlined$apply$lambda$1(TweetTopicView paramTweetTopicView, Context paramContext)
  {
    super(1);
  }
