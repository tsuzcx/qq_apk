...
{
  TweetHotTopicListModel$loadDataFromNetwork$1(Function7 paramFunction7)
  {
    super(5);
  }
  ...
  public final void invoke(int paramInt, @NotNull String paramString, @Nullable byte[] paramArrayOfByte, boolean paramBoolean, @Nullable List<TweetTopicItem> paramList)
  {
    ...
    new Handler(Looper.getMainLooper()).post((Runnable)new TweetHotTopicListModel.loadDataFromNetwork.1.1(this, paramInt, paramBoolean, paramList, paramArrayOfByte, paramString));
  }
}
