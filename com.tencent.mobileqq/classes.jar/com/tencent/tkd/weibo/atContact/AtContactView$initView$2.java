...
import com.tencent.tkd.weibo.bean.AtPersonItemKt;
...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"<anonymous>", "", "it", "Lcom/tencent/tkd/weibo/bean/AtPersonItem;", "invoke"}, k=3, mv={1, 1, 16})
  ...
  implements Function1<AtPersonItem, Unit>
{
  ...
  public final void invoke(@NotNull AtPersonItem paramAtPersonItem)
  {
    ...
    this.this$0.a(AtPersonItemKt.a(paramAtPersonItem));
  }
}
