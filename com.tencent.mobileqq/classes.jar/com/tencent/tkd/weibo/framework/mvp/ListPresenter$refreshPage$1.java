...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"<anonymous>", "", "BEAN", "VIEW", "Lcom/tencent/tkd/weibo/framework/mvp/ListContract$IListView;", "isSuccess", "", "list", "", "total", "", "<anonymous parameter 3>", "errorCode", "errorMsg", "", "invoke"}, k=3, mv={1, 1, 16})
  ...
  implements Function6<Boolean, List<? extends BEAN>, Integer, Boolean, Integer, String, Unit>
{
  ...
  public final void invoke(boolean paramBoolean1, @NotNull List<? extends BEAN> paramList, int paramInt1, boolean paramBoolean2, int paramInt2, @Nullable String paramString)
  {
    ...
    for (;;)
    {
      return;
      label41:
      Log.i("ListPresenter", "refreshPage error, errorCode=" + paramInt2 + ", errorMsg= " + paramString);
 ...
 * Qualified Name:     com.tencent.tkd.weibo.framework.mvp.ListPresenter.refreshPage.1
