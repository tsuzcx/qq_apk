...
public abstract class MediaCodecRender
{
  ...
  public long a(long paramLong)
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_ComTencentQgVideoVideodecoderMediaDecoder$DecodeListener != null) {
        this.jdField_a_of_type_ComTencentQgVideoVideodecoderMediaDecoder$DecodeListener.b(l2 / 1000L);
      }
      ...
      SLog.b(a(), "end seekTo timecost=" + (System.currentTimeMillis() - l1) + " seekTargetTimeUs:" + paramLong + " realStartTime:" + l2);
      return l2;
    }
  ...
  {
    boolean bool2 = false;
    VideoPerformanceMonitor.a(this.jdField_a_of_type_ComTencentQgVideoVideodecoderMediaCodecRender$MediaContext.jdField_a_of_type_Long, "[" + a() + "] init now");
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        VideoPerformanceMonitor.a(this.jdField_a_of_type_ComTencentQgVideoVideodecoderMediaCodecRender$MediaContext.jdField_a_of_type_Long, "[" + a() + "] extractor setDataSource");
        i = 0;
        bool1 = bool2;
        if (i < this.jdField_a_of_type_AndroidMediaMediaExtractor.getTrackCount())
        {
          ...
          if (!str.startsWith(this.jdField_a_of_type_ComTencentQgVideoVideodecoderMediaCodecRender$MediaCodecInfo.a)) {
            break label353;
          }
          this.jdField_a_of_type_AndroidMediaMediaExtractor.selectTrack(i);
          VideoPerformanceMonitor.a(this.jdField_a_of_type_ComTencentQgVideoVideodecoderMediaCodecRender$MediaContext.jdField_a_of_type_Long, "[" + a() + "] find and selectTrack");
        }
      }
      ...
      try
      {
        ...
        VideoPerformanceMonitor.a(this.jdField_a_of_type_ComTencentQgVideoVideodecoderMediaCodecRender$MediaContext.jdField_a_of_type_Long, "[" + a() + "] create codec");
        ...
        VideoPerformanceMonitor.a(this.jdField_a_of_type_ComTencentQgVideoVideodecoderMediaCodecRender$MediaContext.jdField_a_of_type_Long, "[" + a() + "] configureCodec");
        bool1 = true;
      }
