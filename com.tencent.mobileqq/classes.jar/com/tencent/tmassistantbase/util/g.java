...
public class g
{
  ...
  public static int c()
  {
    try
    {
      File[] arrayOfFile = new File("/sys/devices/system/cpu/").listFiles(new h());
      if (arrayOfFile == null) {
        return 1;
      }
  ...
  public static int h()
  {
    ...
    try
    {
      ...
      ac.c("DeviceInfoUtil_", "<getRamAvailable> :" + i);
      return i;
    }
  ...
  public static int i()
  {
    try
    {
      ...
      ac.c("DeviceInfoUtil_", "<getSDFreeSize> blockSize " + l1);
      ac.c("DeviceInfoUtil_", "<getSDFreeSize> freeBlocks " + l2);
      int i = (int)(l2 * l1 / 1024L / 1024L);
      ac.c("DeviceInfoUtil_", "<getSDFreeSize> " + i);
      return i;
    }
    catch (Throwable localThrowable) {}
    return 0;
  ...
  public static int j()
  {
    try
    {
      StatFs localStatFs = new StatFs(Environment.getExternalStorageDirectory().getPath());
      long l1 = localStatFs.getBlockSize();
      ac.c("DeviceInfoUtil_", "<getSDAllSize> blockSize " + l1);
      long l2 = localStatFs.getBlockCount();
      ac.c("DeviceInfoUtil_", "<getSDAllSize> allBlocks " + l2);
      int i = (int)(l2 * l1 / 1024L / 1024L);
      ac.c("DeviceInfoUtil_", "<getSDAllSize> " + i);
      return i;
    }
    catch (Throwable localThrowable) {}
    return 0;
