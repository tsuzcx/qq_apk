...
public class x
{
  ...
  public static x a(Class<?> paramClass)
  {
    return new x(paramClass);
  }
  
  public static x a(Object paramObject)
  {
    return new x(paramObject);
  }
  ...
  private static x a(Method paramMethod, Object paramObject, Object... paramVarArgs)
  {
    try
    {
      a(paramMethod);
  ...
  private boolean a(Class<?>[] paramArrayOfClass1, Class<?>[] paramArrayOfClass2)
  {
    if (paramArrayOfClass1.length == paramArrayOfClass2.length)
    {
      ...
      {
        if (paramArrayOfClass2[i] == y.class) {}
  ...
  private static Class<?>[] a(Object... paramVarArgs)
  {
    ...
    if (i < paramVarArgs.length)
    {
      ...
      if (localObject == null) {}
      for (localObject = y.class;; localObject = localObject.getClass())
      {
  ...
  public x a(String paramString, Object... paramVarArgs)
  {
    Class[] arrayOfClass = a(paramVarArgs);
    try
    {
      x localx = a(a(paramString, arrayOfClass), this.a, paramVarArgs);
      return localx;
    }
  ...
  public boolean equals(Object paramObject)
  {
    if ((paramObject instanceof x)) {
      return this.a.equals(((x)paramObject).a());
    }
    return false;
  }
 ...
 * Qualified Name:     com.tencent.tmassistantbase.util.x
