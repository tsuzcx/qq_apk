...
public class t
{
  ...
  public static boolean a()
  {
    ...
    try
    {
      ...
      if (!TextUtils.isEmpty(a))
      {
        ac.c("DSDK_ProcessUtils", "current process:" + a + ",is remote op process:" + a.equals(c));
        return a.equals(c);
      }
    }
  ...
  public static boolean b()
  {
    ...
    try
    {
      ...
      if (!TextUtils.isEmpty(a))
      {
        ac.c("DSDK_ProcessUtils", "current process:" + a + ",is sdk download service process:" + a.contains(b));
        return a.contains(b);
      }
    }
    catch (IOException localIOException)
  ...
  public static void c()
  {
    ...
    {
      a = f();
      ac.c("DSDK_ProcessUtils", "remote op process is:" + a);
      if (!a.equals(c))
      {
        c = a;
        ac.c("DSDK_ProcessUtils", "remote op process don't equals \"com.tencent.mobileqq\" set PROCESS_REMOTE_OP = " + c);
      }
      return;
    }
    catch (IOException localIOException)
  ...
  public static void d()
  {
    ...
    {
      a = f();
      ac.c("DSDK_ProcessUtils", "SDK process is:" + a);
      if (!a.contains(b))
      {
        b = a;
        ac.c("DSDK_ProcessUtils", "SDK process don't contain \"TMAssistantDownloadSDKService\" set PROCESS_SDK_DOWNLOAD = " + b);
      }
      return;
    }
    catch (IOException localIOException)
  ...
  public static String e()
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 25	com/tencent/tmassistantbase/util/t:a	Ljava/lang/String;
    //   6: invokestatic 31	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   9: istore_0
    //   10: iload_0
    //   11: ifeq +9 -> 20
    //   14: invokestatic 35	com/tencent/tmassistantbase/util/t:f	()Ljava/lang/String;
    //   17: putstatic 25	com/tencent/tmassistantbase/util/t:a	Ljava/lang/String;
    //   20: ldc 37
    ...
    //   34: getstatic 25	com/tencent/tmassistantbase/util/t:a	Ljava/lang/String;
    ...
    //   43: invokestatic 89	com/tencent/tmassistantbase/util/ac:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   46: getstatic 25	com/tencent/tmassistantbase/util/t:a	Ljava/lang/String;
    //   49: astore_1
    //   50: ldc 2
    //   52: monitorexit
    //   53: aload_1
  ...
  private static String f()
  {
    ...
    //   23: iload_0
    //   24: iconst_0
    //   25: invokestatic 104	com/tencent/tmassistantbase/util/t:a	([BIIB)I
    //   28: istore_1
    //   29: iload_1
    //   30: ifle +22 -> 52
    //   33: iload_1
