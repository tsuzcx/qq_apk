...
public class r
{
  ...
  public static PackageInfo b(String paramString)
  {
    ...
    {
      ac.d("PackageUtils", ">> getPackageInfo filePath is " + paramString);
      return null;
    }
    Object localObject = GlobalUtil.getInstance().getContext();
    if (localObject == null)
  ...
  public static PackageInfo c(String paramString)
  {
    if (TextUtils.isEmpty(paramString))
    {
      ac.d("PackageUtils", ">> getInstalledPackageInfo packageName is " + paramString);
      return null;
    }
    Object localObject = GlobalUtil.getInstance().getContext();
    if (localObject == null)
  ...
  {
    if (TextUtils.isEmpty(paramString)) {
      ac.d("PackageUtils", ">> getInstalledPackageInfoByAppName appName is " + paramString);
    }
    Object localObject1;
    do
    {
