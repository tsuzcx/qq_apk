...
public class r
{
  protected static ArrayList<WeakReference<h>> A;
  private static List<String> B;
  private static long C;
  private static Field D;
  private static Boolean E = Boolean.valueOf(true);
  private static ThreadLocal<char[]> F = new s();
  ...
  protected static Runnable x = new t();
  static Thread y = new v();
  protected static ReferenceQueue<h> z;
  ...
  public static boolean a(h paramh)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        Log.d("TMLog", "registerLogListener : " + paramh);
        if (A == null) {
          A = new ArrayList();
        }
        if (z == null) {
      ...
      for (;;)
      {
        if (((Iterator)localObject).hasNext()) {
          if ((h)((WeakReference)((Iterator)localObject).next()).get() == paramh)
          {
            bool = true;
            break;
          }
      ...
      paramh = new WeakReference(paramh, z);
      A.add(paramh);
      bool = true;
    }
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          if ((h)localWeakReference.get() != paramh) {
            break label84;
          }
  ...
  private static void m()
  {
    ...
    //   16: dup
    //   17: invokestatic 495	com/tencent/tmassistantbase/util/r:h	()Ljava/lang/String;
    ...
    //   47: invokestatic 495	com/tencent/tmassistantbase/util/r:h	()Ljava/lang/String;
    //   50: invokevirtual 304	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   53: getstatic 106	com/tencent/tmassistantbase/util/r:o	Ljava/lang/String;
    ...
    //   83: istore_0
    //   84: invokestatic 509	com/tencent/tmassistantbase/util/r:n	()V
    //   87: getstatic 407	com/tencent/tmassistantbase/util/r:k	Ljava/io/BufferedWriter;
    //   90: ifnull +102 -> 192
    //   93: invokestatic 360	com/tencent/tmassistantbase/util/r:g	()Z
    //   96: ifeq +96 -> 192
    //   99: getstatic 407	com/tencent/tmassistantbase/util/r:k	Ljava/io/BufferedWriter;
    //   102: new 297	java/lang/StringBuilder
    //   105: dup
    //   106: invokespecial 298	java/lang/StringBuilder:<init>	()V
    //   109: invokestatic 376	com/tencent/tmassistantbase/util/r:i	()Ljava/lang/String;
    ...
    //   121: getstatic 106	com/tencent/tmassistantbase/util/r:o	Ljava/lang/String;
    ...
    //   186: getstatic 407	com/tencent/tmassistantbase/util/r:k	Ljava/io/BufferedWriter;
    ...
    //   211: putstatic 407	com/tencent/tmassistantbase/util/r:k	Ljava/io/BufferedWriter;
    //   214: invokestatic 509	com/tencent/tmassistantbase/util/r:n	()V
    //   217: ldc 2
    //   219: monitorexit
    //   220: return
    //   221: aload_1
    ...
    //   277: pop
    //   278: invokestatic 509	com/tencent/tmassistantbase/util/r:n	()V
    //   281: getstatic 407	com/tencent/tmassistantbase/util/r:k	Ljava/io/BufferedWriter;
    //   284: ifnull -92 -> 192
    //   287: invokestatic 360	com/tencent/tmassistantbase/util/r:g	()Z
    //   290: ifeq -98 -> 192
    //   293: getstatic 407	com/tencent/tmassistantbase/util/r:k	Ljava/io/BufferedWriter;
    //   296: new 297	java/lang/StringBuilder
    //   299: dup
    //   300: invokespecial 298	java/lang/StringBuilder:<init>	()V
    //   303: invokestatic 376	com/tencent/tmassistantbase/util/r:i	()Ljava/lang/String;
    ...
    //   315: getstatic 106	com/tencent/tmassistantbase/util/r:o	Ljava/lang/String;
    ...
    //   370: getstatic 407	com/tencent/tmassistantbase/util/r:k	Ljava/io/BufferedWriter;
  ...
  private static void o()
  {
    ...
    //   93: ifeq +340 -> 433
    //   96: iconst_1
    //   97: invokestatic 593	com/tencent/tmassistantbase/util/r:c	(Z)V
    //   100: aload_1
    //   101: ldc_w 595
    //   104: ldc 68
    ...
    //   126: invokestatic 605	com/tencent/tmassistantbase/util/r:b	(I)V
    //   129: aload_1
    //   130: ldc_w 607
    //   133: ldc 68
    ...
    //   158: invokestatic 609	com/tencent/tmassistantbase/util/r:a	(I)V
    //   161: aload_1
    //   162: ldc_w 611
    //   165: ldc 68
    ...
    //   170: astore 5
    //   172: aload 5
    //   174: invokestatic 613	com/tencent/tmassistantbase/util/r:a	(Ljava/lang/String;)V
    //   177: aload_1
    //   178: ldc_w 615
    //   181: ldc 68
    ...
    //   199: ifeq +261 -> 460
    //   202: iconst_0
    //   203: invokestatic 619	com/tencent/tmassistantbase/util/r:a	(Z)V
    //   206: aload_1
    //   207: ldc_w 621
    //   210: ldc 68
    ...
    //   224: ifeq +243 -> 467
    //   227: iconst_1
    //   228: invokestatic 623	com/tencent/tmassistantbase/util/r:b	(Z)V
    //   231: ldc_w 295
    ...
    //   300: invokestatic 183	com/tencent/tmassistantbase/util/r:e	()Z
    ...
    //   312: invokestatic 374	com/tencent/tmassistantbase/util/r:f	()Z
    ...
    //   341: invokestatic 360	com/tencent/tmassistantbase/util/r:g	()Z
    ...
    //   353: invokestatic 178	com/tencent/tmassistantbase/util/r:c	()I
    ...
    //   365: invokestatic 180	com/tencent/tmassistantbase/util/r:b	()I
    ...
    //   377: invokestatic 495	com/tencent/tmassistantbase/util/r:h	()Ljava/lang/String;
    ...
    //   389: invokestatic 430	com/tencent/tmassistantbase/util/r:d	()Z
    ...
    //   401: invokestatic 183	com/tencent/tmassistantbase/util/r:e	()Z
    ...
    //   413: invokestatic 374	com/tencent/tmassistantbase/util/r:f	()Z
    ...
    //   432: return
    //   433: iconst_0
    //   434: invokestatic 593	com/tencent/tmassistantbase/util/r:c	(Z)V
    //   437: goto -337 -> 100
    //   440: astore 4
    //   442: aload 4
    ...
    //   457: goto -296 -> 161
    //   460: iconst_1
    //   461: invokestatic 619	com/tencent/tmassistantbase/util/r:a	(Z)V
    //   464: goto -258 -> 206
    //   467: iconst_0
    //   468: invokestatic 623	com/tencent/tmassistantbase/util/r:b	(Z)V
    //   471: goto -240 -> 231
    //   474: iconst_0
    //   475: invokestatic 593	com/tencent/tmassistantbase/util/r:c	(Z)V
    //   478: return
    // Local variable table:
    //   start	length	slot	name	signature
