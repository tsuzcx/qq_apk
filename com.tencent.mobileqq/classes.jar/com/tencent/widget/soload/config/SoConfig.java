  ...
  implements Serializable
{
  ...
  public static SoConfig readConfig()
  {
    ...
    //   2: aconst_null
    //   3: astore_1
    //   4: invokestatic 63	com/tencent/widget/soload/config/SoConfig:a	()Ljava/lang/String;
    //   7: astore 4
    //   9: aload 4
    ...
    //   17: aload_2
    //   18: astore_0
    //   19: getstatic 15	com/tencent/widget/soload/config/SoConfig:a	[B
    //   22: astore_3
    //   23: aload_2
    //   24: astore_0
    //   25: aload_3
    //   26: monitorenter
    //   27: aload 4
    //   29: invokestatic 78	agwj:a	(Ljava/lang/String;)Ljava/lang/Object;
    //   32: checkcast 2	com/tencent/widget/soload/config/SoConfig
    //   35: astore_0
    //   36: aload_3
    //   37: monitorexit
    //   38: aload_0
    ...
    //   40: aload_0
    //   41: ifnonnull +11 -> 52
    //   44: new 2	com/tencent/widget/soload/config/SoConfig
    //   47: dup
    //   48: invokespecial 79	com/tencent/widget/soload/config/SoConfig:<init>	()V
    //   51: astore_1
  ...
  public void update(besp parambesp)
  {
    HashMap localHashMap = new HashMap();
    int i;
    Object localObject;
    if ((parambesp != null) && (parambesp.a != null))
    {
      parambesp = parambesp.a;
      int k = parambesp.length;
      i = 0;
      if (i < k)
      {
        localObject = parambesp[i];
 ...
 * Qualified Name:     com.tencent.widget.soload.config.SoConfig
