  ...
  implements Serializable
{
  ...
  public static SoInfo create(JSONObject paramJSONObject)
  {
    ...
    do
    {
      ...
      localSoDetailInfo = SoConfig.SoDetailInfo.create(paramJSONObject.optJSONObject("arm32"));
      paramJSONObject = SoConfig.SoDetailInfo.create(paramJSONObject.optJSONObject("arm64"));
 ...
 * Qualified Name:     com.tencent.widget.soload.config.SoConfig.SoInfo
