  ...
  implements blih
{
  ...
  private blob jdField_a_of_type_Blob;
  bloc jdField_a_of_type_Bloc = null;
  bloj jdField_a_of_type_Bloj = null;
  ...
  private void b()
  {
    ...
    if (!(localObject instanceof bloj)) {
      return;
    }
    localObject = (bloj)localObject;
    ...
    int i5 = c(a(j));
    int i;
    if (i3 == ((bloj)localObject).getGroupCount() - 1)
    {
      i = 1;
      label98:
      if ((j < 0) || (i5 == i3)) {
    ...
    for (j = m;; j = k)
    {
      ...
      {
        j = i3 + 1;
        if ((this.jdField_a_of_type_Bloj != null) && (j < this.jdField_a_of_type_Bloj.getGroupCount()))
        {
          this.jdField_c_of_type_Int = j;
          this.jdField_a_of_type_Bloj.a(this.jdField_a_of_type_AndroidViewView, j);
        }
      ...
      if ((this.jdField_a_of_type_Bloj != null) && (i3 < this.jdField_a_of_type_Bloj.getGroupCount()))
      {
        this.jdField_c_of_type_Int = i3;
        this.jdField_a_of_type_Bloj.a(this.jdField_a_of_type_AndroidViewView, i3);
      }
      if ((i != 0) && (j != k))
      {
        this.jdField_c_of_type_Int = -1;
      ...
      if (b(a(m)) == 0)
      {
        ...
        if (this.jdField_a_of_type_Blob != null) {
          this.jdField_a_of_type_Blob.a();
        }
        this.jdField_c_of_type_Int = -1;
        this.jdField_a_of_type_AndroidViewView.layout(0, -n, this.jdField_a_of_type_Int, -this.jdField_b_of_type_Int);
        return;
      ...
      {
        i = i3 + 1;
        if ((this.jdField_a_of_type_Bloj == null) || (i >= this.jdField_a_of_type_Bloj.getGroupCount())) {
          break;
        }
        this.jdField_c_of_type_Int = i;
        this.jdField_a_of_type_Bloj.a(this.jdField_a_of_type_AndroidViewView, i);
        return;
        this.jdField_a_of_type_AndroidViewView.layout(0, i4, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int + i4);
      }
    }
  ...
  public void a()
  {
    ...
    do
    {
      ...
      } while (!(localExpandableListAdapter instanceof bloj));
      this.jdField_a_of_type_Bloj = ((bloj)localExpandableListAdapter);
      i = this.jdField_a_of_type_Bloj.c_();
    } while (i == 0);
    ...
    if (this.jdField_a_of_type_AndroidViewView != null) {
      this.jdField_a_of_type_AndroidViewView.setOnClickListener(new bloa(this, this));
    }
    requestLayout();
  }
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (this.jdField_a_of_type_Bloc != null) {
      this.jdField_a_of_type_Bloc.a(this, paramInt1, paramInt2, paramInt3, paramInt4);
    }
  }
  ...
  public void setListener(blob paramblob)
  {
    this.jdField_a_of_type_Blob = paramblob;
  }
  
  public void setOnLayoutListener(bloc parambloc)
  {
