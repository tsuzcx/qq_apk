  ...
  implements Handler.Callback
{
  ...
  private blfj jdField_a_of_type_Blfj;
  ...
  public SwipPinnedHeaderExpandableListView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetScroller = new Scroller(paramContext, new blfi());
  ...
  private void a(View paramView)
  {
    ...
    {
      if (this.jdField_a_of_type_Blfj != null) {
        this.jdField_a_of_type_Blfj.a(null);
      }
      if (i != 0) {
      ...
      for (int j = ((Integer)paramView.getTag(-3)).intValue();; j = 0)
      {
        ...
        this.jdField_a_of_type_Blfh.b(this.jdField_c_of_type_AndroidViewView);
        return;
      }
    }
  }
  ...
  private void b(View paramView)
  {
    ...
    if (paramView != null)
    {
      ...
      i = j;
      if (this.jdField_a_of_type_Blfj != null) {
        this.jdField_a_of_type_Blfj.a(paramView);
      }
    }
    for (int i = j;; i = 0)
    {
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_Blfh.a(paramView);
        return;
      }
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Blfj != null) {
      return this.jdField_a_of_type_Blfj.a(paramView);
    }
    return true;
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Blfh != null) {
        this.jdField_a_of_type_Blfh.a(this.jdField_c_of_type_AndroidViewView);
      }
      this.jdField_c_of_type_AndroidViewView = null;
      return true;
      bool = this.jdField_a_of_type_AndroidWidgetScroller.computeScrollOffset();
      ...
      this.jdField_c_of_type_AndroidViewView = null;
      return true;
    } while (this.jdField_a_of_type_Blfj == null);
    this.jdField_a_of_type_Blfj.b();
    return true;
  }
  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    default: 
      ...
      {
        if (this.jdField_a_of_type_Blfj != null) {
          this.jdField_a_of_type_Blfj.a(true);
        }
        d();
      }
      break;
    ...
    for (;;)
    {
      ...
      this.d = -1;
      break label72;
      if (((k == 1) || (k == 3)) && (this.jdField_a_of_type_Blfj != null)) {
        this.jdField_a_of_type_Blfj.a(false);
      }
    }
  }
  ...
  public void setAdapter(ExpandableListAdapter paramExpandableListAdapter)
  {
    ...
    if ((paramExpandableListAdapter instanceof blfj)) {
      this.jdField_a_of_type_Blfj = ((blfj)paramExpandableListAdapter);
    }
  }
  ...
  public void setRightIconMenuListener(blfh paramblfh)
  {
    this.jdField_a_of_type_Blfh = paramblfh;
  }
  
  public void setSwipListListener(blfj paramblfj)
  {
    this.jdField_a_of_type_Blfj = paramblfj;
  }
}
