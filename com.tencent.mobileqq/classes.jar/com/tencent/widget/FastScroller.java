...
public class FastScroller
{
  ...
  private void a(Context paramContext)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        b();
        this.jdField_e_of_type_Int = paramContext.getResources().getDimensionPixelSize(2131296870);
  ...
  private void a(Context paramContext, Drawable paramDrawable)
  {
    ...
    if ((paramDrawable instanceof NinePatchDrawable)) {
      this.jdField_b_of_type_Int = paramContext.getResources().getDimensionPixelSize(2131296872);
    }
    for (this.jdField_a_of_type_Int = paramContext.getResources().getDimensionPixelSize(2131296871);; this.jdField_a_of_type_Int = paramDrawable.getIntrinsicHeight())
    {
