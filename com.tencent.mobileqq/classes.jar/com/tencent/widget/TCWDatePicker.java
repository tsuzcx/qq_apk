...
public class TCWDatePicker
  extends FrameLayout
{
  private bjud jdField_a_of_type_Bjud;
  ...
  public TCWDatePicker(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    a(Locale.getDefault());
    ((LayoutInflater)paramContext.getSystemService("layout_inflater")).inflate(2131559074, this, true);
    Object localObject1 = new bjuc(this);
    this.jdField_a_of_type_ComTencentWidgetTCWNumberPicker = ((TCWNumberPicker)findViewById(2131365324));
    ...
    this.jdField_a_of_type_ComTencentWidgetTCWNumberPicker.setOnChangeListener((bjuj)localObject1);
    this.jdField_b_of_type_ComTencentWidgetTCWNumberPicker = ((TCWNumberPicker)findViewById(2131371334));
    ...
    this.jdField_b_of_type_ComTencentWidgetTCWNumberPicker.setOnChangeListener((bjuj)localObject1);
    this.jdField_c_of_type_ComTencentWidgetTCWNumberPicker = ((TCWNumberPicker)findViewById(2131381274));
    this.jdField_c_of_type_ComTencentWidgetTCWNumberPicker.setSpeed(100L);
    this.jdField_c_of_type_ComTencentWidgetTCWNumberPicker.setOnChangeListener((bjuj)localObject1);
    if (AppSetting.c)
    {
      localObject1 = (TCWNumberPickerButton)this.jdField_a_of_type_ComTencentWidgetTCWNumberPicker.findViewById(2131368641);
      localObject2 = (TCWNumberPickerButton)this.jdField_a_of_type_ComTencentWidgetTCWNumberPicker.findViewById(2131365359);
      ((TCWNumberPickerButton)localObject1).setContentDescription(getContext().getString(2131689559));
      ((TCWNumberPickerButton)localObject2).setContentDescription(getContext().getString(2131693828));
      localObject1 = (TCWNumberPickerButton)this.jdField_b_of_type_ComTencentWidgetTCWNumberPicker.findViewById(2131368641);
      localObject2 = (TCWNumberPickerButton)this.jdField_b_of_type_ComTencentWidgetTCWNumberPicker.findViewById(2131365359);
      ((TCWNumberPickerButton)localObject1).setContentDescription(getContext().getString(2131689584));
      ((TCWNumberPickerButton)localObject2).setContentDescription(getContext().getString(2131693829));
      localObject1 = (TCWNumberPickerButton)this.jdField_c_of_type_ComTencentWidgetTCWNumberPicker.findViewById(2131368641);
      localObject2 = (TCWNumberPickerButton)this.jdField_c_of_type_ComTencentWidgetTCWNumberPicker.findViewById(2131365359);
      ((TCWNumberPickerButton)localObject1).setContentDescription(getContext().getString(2131689619));
      ((TCWNumberPickerButton)localObject2).setContentDescription(getContext().getString(2131693830));
    }
  ...
  private void a()
  {
    ...
    LinearLayout localLinearLayout = (LinearLayout)findViewById(2131372239);
  ...
  private void d()
  {
    if (this.jdField_a_of_type_Bjud != null) {
      this.jdField_a_of_type_Bjud.a(this, a(), b(), c());
    }
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, bjud parambjud)
  {
    a(paramInt1, paramInt2, paramInt3);
    this.jdField_a_of_type_Bjud = parambjud;
    b();
    d();
  }
