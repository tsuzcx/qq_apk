  ...
  extends LinearLayout
{
  ...
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new bhuv(this);
  ...
  {
    paramContext = LayoutInflater.from(paramContext).inflate(2131560078, this);
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramContext.findViewById(2131370008));
    this.jdField_a_of_type_AndroidViewView = paramContext.findViewById(2131366382);
    paramContext = this.jdField_a_of_type_AndroidViewView.findViewById(2131376388);
  ...
  private void a(View paramView, DislikeInfo paramDislikeInfo, String paramString, boolean paramBoolean)
  {
    for (;;)
    {
      try
      {
        ImageView localImageView = (ImageView)paramView.findViewById(2131369331);
        TextView localTextView1 = (TextView)paramView.findViewById(2131378143);
        TextView localTextView2 = (TextView)paramView.findViewById(2131368524);
        j = 8;
        str = "";
        if (!paramBoolean) {
          continue;
  ...
  public void a(DislikeInfo paramDislikeInfo)
  {
    ...
    View localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560079, this.jdField_a_of_type_AndroidWidgetLinearLayout, false);
  ...
  public void setData(ArrayList<DislikeInfo> paramArrayList, String paramString, bhtv parambhtv)
  {
  ...
  public void setLastSeparateLineUnvis()
  {
    ...
    if (i < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      ...
      localView2 = localView1.findViewById(2131376388);
      if (i != this.jdField_a_of_type_Int) {
        break label68;
      }
      localView1.setBackgroundResource(2130842557);
    }
    label68:
    for (int j = 4;; j = 0)
    {
