...
class RangeButtonView$UnitBar
{
  ...
  public void a(Canvas paramCanvas, Paint paramPaint, RangeButtonView.RangeButtonParams paramRangeButtonParams)
  {
    ...
    paramPaint.setColor(paramRangeButtonParams.b);
    paramPaint.setStrokeWidth(paramRangeButtonParams.e);
    paramCanvas.drawLine(this.b, this.d, this.c, this.d, paramPaint);
    paramRangeButtonParams = this.jdField_a_of_type_JavaUtilArrayList.iterator();
