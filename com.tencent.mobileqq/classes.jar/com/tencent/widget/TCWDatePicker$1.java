  ...
  implements TCWNumberPicker.OnChangedListener
{
  ...
  public void a(TCWNumberPicker paramTCWNumberPicker, int paramInt1, int paramInt2)
  {
    ...
    if (paramTCWNumberPicker == TCWDatePicker.c(this.a))
    {
    ...
    else if (paramTCWNumberPicker == TCWDatePicker.d(this.a))
    {
      TCWDatePicker.e(this.a);
    ...
    else if (paramTCWNumberPicker == TCWDatePicker.f(this.a))
    {
    ...
    TCWDatePicker.g(this.a);
    TCWDatePicker.h(this.a);
  }
}
