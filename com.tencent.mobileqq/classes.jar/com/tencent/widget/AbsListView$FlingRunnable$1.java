  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    bldq localbldq = AbsListView.FlingRunnable.access$1100(this.this$1);
    ...
    for (float f = -localVelocityTracker.getYVelocity(i); (Math.abs(f) >= AbsListView.access$1500(this.this$1.this$0)) && (localbldq.a(0.0F, f)); f = -localVelocityTracker.getYVelocity())
    {
