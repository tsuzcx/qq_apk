  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (VersionUtils.b()) {}
    for (float f = -localVelocityTracker.getYVelocity(i); (Math.abs(f) >= AbsListView.access$1500(this.this$1.this$0)) && (localOverScroller.isScrollingInDirection(0.0F, f)); f = -localVelocityTracker.getYVelocity())
    {
