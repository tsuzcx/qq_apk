  ...
  extends AbsListView
{
  ...
  private void a(View paramView, int paramInt1, int paramInt2, boolean paramBoolean1, int paramInt3, boolean paramBoolean2, boolean paramBoolean3, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if ((bfni.e()) && (paramBoolean3) && (((AbsListView.LayoutParams)paramView.getLayoutParams()).jdField_b_of_type_Int != paramInt1)) {
  ...
  private boolean a(int paramInt1, int paramInt2, KeyEvent paramKeyEvent)
  {
    ...
    for (;;)
    {
      ...
      return true;
      if ((!bfni.e()) || (!paramKeyEvent.hasNoModifiers())) {
        break;
      }
      ...
      else
      {
        ...
        else
        {
          ...
          {
            if ((!bfni.e()) || (!paramKeyEvent.hasModifiers(2))) {
              break;
            }
                  ...
                  if (!bool)
                  {
                    ...
                    if (paramKeyEvent.getRepeatCount() == 0)
                    {
                      ...
                      if (getChildCount() > 0)
                      {
                        ...
                        {
                          if ((!bfni.e()) || (!paramKeyEvent.hasModifiers(1))) {
                            break;
                          }
    ...
    for (;;)
    {
      try
      {
        ...
        case 6: 
          ...
          localbfoc = this.mRecycler;
          if (bool2)
          {
            m = 0;
            if (m < i2)
            {
              localbfoc.a(getChildAt(m), i3 + m);
              m += 1;
              continue;
            }
          }
  ...
  public void setAdapter(ListAdapter paramListAdapter)
  {
    ...
    if (this.mAdapter != null)
    {
      ...
      checkFocus();
      this.mDataSetObserver = new bfnx(this);
