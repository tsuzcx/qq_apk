  ...
  implements TextWatcher, ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnTouchModeChangeListener, Filter.FilterListener
{
  ...
  int mOverscrollMax;
  private alkb mPendingCheckForKeyLongPress;
  private alkc mPendingCheckForLongPress;
  private Runnable mPendingCheckForTap;
  private alki mPerformClick;
  PopupWindow mPopup;
  private boolean mPopupHidden;
  public alkj mPositionScroller;
  private InputConnectionWrapper mPublicInputConnection;
  public final alkk mRecycler = new alkk(this);
  ...
  private boolean checkScrap(ArrayList paramArrayList)
  {
    boolean bool1 = true;
    boolean bool2 = true;
  ...
  private void clearScrollingCache()
  {
    if (this.mClearScrollingCache == null) {
      this.mClearScrollingCache = new aljy(this);
    }
  ...
  private void createTextFilter(boolean paramBoolean)
  {
    if (this.mPopup == null)
    {
      ...
      this.mTextFilter = ((EditText)((LayoutInflater)localContext.getSystemService("layout_inflater")).inflate(2130971648, null));
    ...
    if (paramBoolean)
    {
      this.mPopup.setAnimationStyle(2131624476);
      return;
    }
    this.mPopup.setAnimationStyle(2131624477);
  }
  ...
  private void dispatchFinishTemporaryDetachForView(View paramView)
  {
    try
    {
  ...
  public static View retrieveFromScrap(ArrayList paramArrayList, int paramInt)
  {
    int j = paramArrayList.size();
    if (j > 0)
    {
  ...
  public boolean dispatchTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      ...
      if (this.mFlingRunnable == null) {
        this.mFlingRunnable = new alke(this);
      }
      i = 0;
      if (this.mForHongBao) {
  ...
  public long[] getCheckedItemIds()
  {
    ...
    for (;;)
    {
      ...
      arrayOfLong[i] = localLongSparseArray.a(i);
      i += 1;
    }
  }
  ...
  {
    if ((this.mFlingRunnable != null) && (alke.a(this.mFlingRunnable) != null)) {
      return alke.a(this.mFlingRunnable).a();
    }
    return -1.0F;
  }
        ...
        else
        {
          ...
          while ((bool) && (!this.mDataChanged))
          {
            if (this.mPendingCheckForKeyLongPress == null) {
              this.mPendingCheckForKeyLongPress = new alkb(this, null);
            }
  ...
  protected boolean onConsistencyCheck(int paramInt)
  {
    ...
    for (paramInt = 1;; paramInt = 0)
    {
      ...
      localObject = alkk.a(this.mRecycler);
    ...
    if (!checkScrap(alkk.a(this.mRecycler))) {
      bool1 = false;
    }
    Object localObject = alkk.a(this.mRecycler);
  ...
  public InputConnection onCreateInputConnection(EditorInfo paramEditorInfo)
  {
    if (isTextFilterEnabled())
    {
      ...
      if (this.mPublicInputConnection == null)
      {
        ...
        this.mPublicInputConnection = new aljz(this, this.mTextFilter.onCreateInputConnection(paramEditorInfo), true);
      }
  ...
  public void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    try
    {
      ...
      {
        if (this.mBottomScroller == null) {
          this.mBottomScroller = new alkg(this);
        }
  ...
  public void onRestoreInstanceState(Parcelable paramParcelable)
  {
    ...
    for (;;)
    {
      ...
      if (paramParcelable.jdField_a_of_type_ComTencentUtilLongSparseArray != null) {
        this.mCheckedIdStates = paramParcelable.jdField_a_of_type_ComTencentUtilLongSparseArray;
      }
      this.mCheckedItemCount = paramParcelable.d;
      if ((VersionUtils.e()) && (paramParcelable.jdField_a_of_type_Boolean) && (this.mChoiceMode == 3) && (this.mMultiChoiceModeCallback != null)) {
  ...
  public Parcelable onSaveInstanceState()
  {
    ...
    for (;;)
    {
      ...
      while (i < j)
      {
        ((LongSparseArray)localObject).a(this.mCheckedIdStates.a(i), this.mCheckedIdStates.a(i));
        i += 1;
      }
      i = 0;
      break;
        ...
        if (!this.mDataChanged) {
          if ((this.mTouchMode != 4) && (i >= 0) && (((ListAdapter)getAdapter()).isEnabled(i)))
          {
            ...
            if (this.mPendingCheckForTap == null) {
              this.mPendingCheckForTap = new alkd(this);
            }
          ...
          case 3: 
            for (;;)
            {
              ...
              if ((f > this.mListPadding.left) && (f < getWidth() - this.mListPadding.right))
              {
                i = 1;
                if (this.mPerformClick == null) {
                  this.mPerformClick = new alki(this, null);
                }
                localalki = this.mPerformClick;
                localalki.jdField_a_of_type_Int = j;
                localalki.a();
              ...
              for (paramMotionEvent = this.mPendingCheckForTap;; paramMotionEvent = this.mPendingCheckForLongPress)
              {
                ...
                this.mTouchModeReset = new aljx(this, (View)localObject, localalki);
  ...
  public boolean overScrollBy(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if ((!this.mForHongBao) || (paramInt2 <= 0)) {
  ...
  @TargetApi(11)
  public boolean performLongPress(View paramView, int paramInt, long paramLong)
  {
    boolean bool1 = true;
  ...
  {
    int j = getChildCount();
    AbsListView.RecyclerListener localRecyclerListener = alkk.a(this.mRecycler);
    int i = 0;
    while (i < j)
    {
      View localView = getChildAt(i);
  ...
  public void reportScrollStateChange(int paramInt)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (this.mOnScrollListener != null) {
        this.mOnScrollListener.a(this, paramInt);
      }
      return;
    }
  }
  ...
  public void setFriction(float paramFloat)
  {
    ...
    alke.a(this.mFlingRunnable).a(paramFloat);
  }
  ...
  public void setMultiChoiceModeListener(AbsListView.MultiChoiceModeListener paramMultiChoiceModeListener)
  {
    if (this.mMultiChoiceModeCallback == null) {
      this.mMultiChoiceModeCallback = new alkh(this);
    }
  ...
  public void setOverScrollFlingMode(int paramInt)
  {
    ...
    alke.a(this.mFlingRunnable).a(paramInt);
  }
  ...
  {
    alkk.a(this.mRecycler, paramRecyclerListener);
  }
  ...
  {
    if (this.mPositionScroller == null) {
      this.mPositionScroller = new alkj(this);
    }
        ...
        if (paramInt1 < 0)
        {
          ...
          if (paramInt2 < 0)
          {
            ...
            if ((this.mOnScrollButtomListener != null) && (n <= 0)) {
              this.mOnScrollButtomListener.s(n);
            }
            if (n == 0) {
              break label782;
            }
