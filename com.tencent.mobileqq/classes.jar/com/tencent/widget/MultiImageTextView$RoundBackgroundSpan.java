  ...
  extends ReplacementSpan
{
  ...
  private float a(Paint paramPaint, CharSequence paramCharSequence, int paramInt1, int paramInt2)
  {
    ...
    for (float f = paramPaint.measureText(paramCharSequence, paramInt1, paramInt2) + 10.0F + this.jdField_a_of_type_AndroidGraphicsBitmap.getWidth();; f = paramPaint.measureText(paramCharSequence, paramInt1, paramInt2)) {
      return f + 40.0F;
    }
  }
  ...
  public void draw(Canvas paramCanvas, CharSequence paramCharSequence, int paramInt1, int paramInt2, float paramFloat, int paramInt3, int paramInt4, int paramInt5, Paint paramPaint)
  {
    ...
    if (localObject != null)
    {
      ...
      if (i < paramInt3)
      {
        ...
        paramCanvas.drawText(paramCharSequence, paramInt1, paramInt2, paramFloat + 10.0F + this.jdField_a_of_type_AndroidGraphicsBitmap.getWidth(), paramInt4, paramPaint);
        return;
      }
