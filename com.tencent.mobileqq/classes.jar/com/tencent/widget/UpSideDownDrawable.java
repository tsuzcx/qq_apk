  ...
  implements Handler.Callback
{
  ...
  public UpSideDownDrawable(Context paramContext, Bitmap paramBitmap, int paramInt1, int paramInt2)
  {
    ...
    for (this.d = (ScreenUtil.jdField_a_of_type_Int - paramContext.getResources().getDimensionPixelSize(2131558887));; this.d = (ScreenUtil.jdField_a_of_type_Int - ScreenUtil.a(55.0F)))
    {
      ...
      this.c = this.f;
      this.jdField_a_of_type_Amlk = new amlk(this);
      return;
    }
  }
  ...
  private void e()
  {
    this.jdField_a_of_type_Amlk.jdField_a_of_type_Int = (this.g - this.e);
    this.jdField_a_of_type_Amlk.jdField_b_of_type_Int = (-(this.g - this.f - this.e));
    this.jdField_a_of_type_Amlk.c = 8000;
    this.jdField_a_of_type_Amlk.d = 3;
  }
  
  private void f()
  {
    this.jdField_a_of_type_Amlk.jdField_a_of_type_Int = this.f;
    this.jdField_a_of_type_Amlk.jdField_b_of_type_Int = (this.g - this.f - this.e);
    this.jdField_a_of_type_Amlk.c = 8000;
    this.jdField_a_of_type_Amlk.d = 2;
  }
  ...
  public void c()
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_Amlk.jdField_a_of_type_Int = this.c;
      this.jdField_a_of_type_Amlk.c = (this.jdField_a_of_type_AndroidWidgetScroller.getDuration() - this.jdField_a_of_type_AndroidWidgetScroller.timePassed());
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    default: 
      return false;
    case 1: 
      this.jdField_a_of_type_AndroidWidgetScroller.startScroll(0, this.jdField_a_of_type_Amlk.jdField_a_of_type_Int, 0, this.jdField_a_of_type_Amlk.jdField_b_of_type_Int, this.jdField_a_of_type_Amlk.c);
      this.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(this.jdField_a_of_type_Amlk.d);
