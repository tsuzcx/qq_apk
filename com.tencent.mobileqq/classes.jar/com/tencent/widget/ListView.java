  ...
  implements SkinnableView
{
  ...
  private final belb mArrowScrollFocusResult = new belb(null);
  ...
  private ArrayList<belc> mFooterViewInfos = new ArrayList();
  private boolean mHeaderDividersEnabled;
  protected ArrayList<belc> mHeaderViewInfos = new ArrayList();
  protected int[] mHeaderViewLevelIndex = { 0, 0, 0 };
  private Animation mInsertAnimation;
  private boolean mIsCacheColorOpaque;
  private boolean mItemsCanFocus;
  private bele mOnScrollChangeListener;
  ...
  protected belq mOverScrollViewListener;
  ...
  public ListView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    paramAttributeSet = new beol(paramContext.obtainStyledAttributes(paramAttributeSet, getStyleableValues("ListView"), paramInt, 0));
  ...
  private belb arrowScrollFocused(int paramInt)
  {
    int j = 1;
    int i = 1;
  ...
  private boolean arrowScrollImpl(int paramInt)
  {
    ...
    if (this.mItemsCanFocus)
    {
      ...
      if (localObject != null)
      {
        i = ((belb)localObject).a();
        j = ((belb)localObject).b();
      }
      if (localObject == null) {
        break label311;
      }
  ...
  private void checkOverScrollHeaderIsVisable()
  {
    ...
    if ((this.mTouchMode == 5) && (getScrollY() != 0))
    {
      ...
      if ((this.mOverScrollViewListener != null) && ((this.mOverScrollViewListener instanceof qsb)))
      {
        localqsb = (qsb)this.mOverScrollViewListener;
        localView = this.mOverscrollHeaderViewContainer.getChildAt(0);
        if (getOverScrollHeight() <= 0) {
          break label174;
        }
        i = -j * 100 / getOverScrollHeight();
        localqsb.a(0, localView, this, i);
        ((qsb)this.mOverScrollViewListener).a(this.mOverscrollHeaderViewContainer.getChildAt(0), this, -j);
      }
    }
    label174:
    label179:
    ...
    do
    {
      do
      {
        ...
        } while ((this.mOverScrollViewListener == null) || (!(this.mOverScrollViewListener instanceof qsb)));
        localqsb = (qsb)this.mOverScrollViewListener;
        localView = this.mOverscrollFooterView.getChildAt(0);
        if (getOverScrollFooterHeight() == 0) {}
        for (i = 0;; i = j * 100 / getOverScrollFooterHeight())
        {
          localqsb.a(1, localView, this, i);
          ((qsb)this.mOverScrollViewListener).a(this.mOverscrollFooterView.getChildAt(0), this, j);
          return;
        }
      ...
      ((qsb)this.mOverScrollViewListener).a(this.mOverscrollHeaderViewContainer.getChildAt(0), this, -j);
      return;
    } while ((j <= 0) || (this.mOverscrollFooterView == null) || (!(this.mOverScrollViewListener instanceof qsb)));
    label387:
    ((qsb)this.mOverScrollViewListener).a(this.mOverscrollFooterView.getChildAt(0), this, j);
  }
  ...
  private void clearRecycledState(ArrayList<belc> paramArrayList)
  {
    if (paramArrayList != null)
    {
      ...
      while (i < j)
      {
        AbsListView.LayoutParams localLayoutParams = (AbsListView.LayoutParams)((belc)paramArrayList.get(i)).jdField_a_of_type_AndroidViewView.getLayoutParams();
                  ...
                  if (paramKeyEvent.getRepeatCount() == 0)
                  {
                    ...
                    if (getChildCount() > 0)
                    {
                      ...
                      for (;;)
                      {
                        ...
                        i = paramInt2;
                        break;
                        if ((!befo.e()) || (!paramKeyEvent.hasModifiers(1)) || (resurrectSelectionIfNeeded()) || (!pageScroll(33))) {}
                      }
                      if ((befo.e()) && (paramKeyEvent.hasNoModifiers()))
                      {
  ...
  private void removeFixedViewInfo(View paramView, ArrayList<belc> paramArrayList)
  {
    int j = paramArrayList.size();
    int i = 0;
    for (;;)
    {
      if (i < j)
      {
        if (((belc)paramArrayList.get(i)).jdField_a_of_type_AndroidViewView == paramView) {
  ...
  private void scrollListItemsBy(int paramInt)
  {
    ...
    if (paramInt < 0)
    {
      ...
      if (localView.getBottom() < j)
      {
        if (localbegi.a(((AbsListView.LayoutParams)localView.getLayoutParams()).jdField_a_of_type_Int))
        {
          detachViewFromParent(localView);
          localbegi.a(localView, this.mFirstPosition);
        }
        for (;;)
        {
          localView = getChildAt(0);
    ...
    else
    {
      ...
      if (localView.getTop() > i)
      {
        ...
        {
          detachViewFromParent(localView);
          localbegi.a(localView, this.mFirstPosition + paramInt);
        }
        for (;;)
        {
          paramInt -= 1;
    ...
    catch (NullPointerException paramView)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          setStatisticCollector();
          continue;
          if ((getContext().getApplicationInfo().targetSdkVersion < 11) || (!befo.e())) {
            continue;
          }
  ...
  private int updateChild(View paramView, int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if ((befo.e()) && (((AbsListView.LayoutParams)localView.getLayoutParams()).jdField_b_of_type_Int != paramInt1)) {
  ...
  {
    belc localbelc = new belc(this);
    localbelc.jdField_a_of_type_AndroidViewView = paramView;
    localbelc.jdField_a_of_type_JavaLangObject = paramObject;
    localbelc.jdField_a_of_type_Boolean = paramBoolean;
    this.mFooterViewInfos.add(localbelc);
  ...
  {
    if ((this.mAdapter != null) && (!(this.mAdapter instanceof bejx))) {
    ...
    do
    {
      ...
      this.mHeaderViewInfos.add(this.mHeaderViewLevelIndex[paramInt], localbelc);
      while (paramInt < 3)
      {
  ...
  public int findHeaderViewPosition(View paramView)
  {
    ...
    while (i < j)
    {
      if (((belc)this.mHeaderViewInfos.get(i)).jdField_a_of_type_AndroidViewView == paramView) {
        return i;
      }
      i += 1;
    }
  ...
  public int getListViewScrollY()
  {
    ...
    if (k >= this.mHeaderViewInfos.size())
    {
      ...
      for (i = 0; localIterator.hasNext(); i = ((belc)localIterator.next()).jdField_a_of_type_AndroidViewView.getHeight() + i) {}
    ...
    while (i < k)
    {
      j += ((belc)this.mHeaderViewInfos.get(i)).jdField_a_of_type_AndroidViewView.getHeight();
      i += 1;
    }
  ...
  public boolean isDirectChildHeaderOrFooter(View paramView)
  {
    ...
    while (i < j)
    {
      if (paramView == ((belc)localArrayList.get(i)).jdField_a_of_type_AndroidViewView) {
        return true;
      }
      i += 1;
    }
    ...
    try
    {
      ...
      case 2: 
        ...
        if (this.mItemCount != this.mAdapter.getCount())
        {
          ...
          if ((this.mAdapter instanceof bejx)) {
            localObject1 = ((bejx)this.mAdapter).getWrappedAdapter().getClass();
          }
  ...
  final int measureHeightOfChildren(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    for (;;)
    {
      if ((bool) && (((begi)localObject).a(((AbsListView.LayoutParams)localView.getLayoutParams()).jdField_a_of_type_Int))) {
        ((begi)localObject).a(localView, -1);
      }
  ...
  public void onThemeChanged()
  {
    ...
    while (localIterator.hasNext()) {
      SkinEngine.invalidateAll(((belc)localIterator.next()).jdField_a_of_type_AndroidViewView);
    }
  ...
  public boolean removeFooterView(View paramView)
  {
    ...
    {
      if ((this.mAdapter == null) || (!((bejx)this.mAdapter).b(paramView))) {
        break label60;
      }
  ...
  public boolean removeHeaderView(View paramView)
  {
    ...
    for (;;)
    {
      if ((this.mAdapter != null) && (((bejx)this.mAdapter).a(paramView))) {
        if (this.mDataSetObserver != null) {
          this.mDataSetObserver.onChanged();
        }
      }
  ...
  public void setAdapter(ListAdapter paramListAdapter)
  {
    ...
    {
      this.mAdapter = new bejx(this.mHeaderViewInfos, this.mFooterViewInfos, paramListAdapter);
      ...
      checkFocus();
      this.mDataSetObserver = new beld(this);
  ...
  public void setOnScrollChangeListener(bele parambele)
  {
    this.mOnScrollChangeListener = parambele;
  }
  ...
  {
    this.mOverScrollViewListener = parambelq;
  }
  ...
  public void setStatisticCollector()
  {
    ...
    {
      localListAdapter = ((bejx)localListAdapter).getWrappedAdapter();
