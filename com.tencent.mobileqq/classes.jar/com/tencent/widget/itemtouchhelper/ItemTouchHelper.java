  ...
  implements RecyclerView.OnChildAttachStateChangeListener
{
  ...
  private void initGestureDetector()
  {
    ...
    this.mGestureDetector = new GestureDetectorCompat(this.mRecyclerView.getContext(), new ItemTouchHelper.ItemTouchHelperGestureListener(this));
  }
  ...
  private int swipeIfNecessary(RecyclerView.ViewHolder paramViewHolder)
  {
    ...
    do
    {
      do
      {
        ...
        {
          if ((j & k) == 0) {
            return ItemTouchHelper.Callback.convertToRelativeDirection(k, ViewCompat.getLayoutDirection(this.mRecyclerView));
          }
          return k;
        }
    ...
    if ((j & i) == 0) {
      return ItemTouchHelper.Callback.convertToRelativeDirection(i, ViewCompat.getLayoutDirection(this.mRecyclerView));
    }
    return i;
  }
