...
{
  public static final Parcelable.Creator<SavedState> CREATOR = new bfov();
  int jdField_a_of_type_Int;
  long jdField_a_of_type_Long = -1L;
  SparseBooleanArray jdField_a_of_type_AndroidUtilSparseBooleanArray;
  bfnj<Integer> jdField_a_of_type_Bfnj;
  ...
  private AbsListView$SavedState(Parcel paramParcel)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      this.jdField_a_of_type_Bfnj = new bfnj();
      while (i < j)
      {
        long l = paramParcel.readLong();
        int k = paramParcel.readInt();
        this.jdField_a_of_type_Bfnj.a(l, Integer.valueOf(k));
        i += 1;
      }
    }
  }
  ...
  public void writeToParcel(Parcel paramParcel, int paramInt)
  {
    ...
    label154:
    for (paramInt = this.jdField_a_of_type_Bfnj.a();; paramInt = 0)
    {
      paramParcel.writeInt(paramInt);
      while (i < paramInt)
      {
        paramParcel.writeLong(this.jdField_a_of_type_Bfnj.a(i));
        paramParcel.writeInt(((Integer)this.jdField_a_of_type_Bfnj.a(i)).intValue());
        i += 1;
      }
      paramInt = 0;
      break;
