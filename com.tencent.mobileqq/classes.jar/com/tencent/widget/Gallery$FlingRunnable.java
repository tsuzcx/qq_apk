  ...
  implements Runnable
{
  ...
  {
    this.jdField_a_of_type_Bjse = new bjse(paramGallery.getContext());
    this.jdField_a_of_type_Bjse.a(0.04F);
  }
  ...
  {
    this.jdField_a_of_type_Bjse.a(true);
    this.jdField_a_of_type_Long = -1L;
    if (this.this$0.jdField_a_of_type_Bjqs != null) {
      this.this$0.jdField_a_of_type_Bjqs.b(this.this$0.mSelectedPosition);
    }
    if (this.this$0.j == 2)
    {
  ...
  {
    this.jdField_a_of_type_Bjse.a(paramInt1, 0, paramInt2, 0, -2147483648, 2147483647, 0, 0);
    return this.jdField_a_of_type_Bjse.d();
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Bjse.a(0, 0, paramInt1, paramInt2, Gallery.b(this.this$0));
      this.this$0.post(this);
    } while (this.this$0.jdField_a_of_type_Bjqs == null);
    this.this$0.jdField_a_of_type_Bjqs.a(this.this$0.mSelectedPosition);
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6)
  {
    ...
    if (AnimationUtils.currentAnimationTimeMillis() - this.this$0.jdField_a_of_type_Long > 15L) {
      this.jdField_a_of_type_Bjse.a(this.this$0.jdField_a_of_type_Long + 15L, 0, 0, paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, Gallery.a(this.this$0), Gallery.a(this.this$0));
    }
    for (;;)
    {
      this.this$0.post(this);
      ...
      this.this$0.jdField_a_of_type_Bjqs.a(this.this$0.mSelectedPosition);
      return;
      this.jdField_a_of_type_Bjse.a(0, 0, paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, Gallery.a(this.this$0), Gallery.a(this.this$0));
    }
  }
  ...
  public void run()
  {
    ...
    Object localObject = this.jdField_a_of_type_Bjse;
    boolean bool = ((bjse)localObject).b();
    int i = ((bjse)localObject).a();
    int j = ((bjse)localObject).b();
