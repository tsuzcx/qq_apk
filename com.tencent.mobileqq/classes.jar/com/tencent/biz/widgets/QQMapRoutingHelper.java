  ...
  implements ActionSheet.OnButtonClickListener
{
  ...
  public void a(GeoPoint paramGeoPoint1, GeoPoint paramGeoPoint2)
  {
    if (!NetworkUtil.g(this.jdField_a_of_type_AndroidContentContext))
    {
      ...
      QQToast.a(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 1, paramGeoPoint1.getString(2131434827), 1).b(paramGeoPoint1.getDimensionPixelSize(2131558448));
      return;
    }
    ...
    for (;;)
    {
      ...
      new HttpWebCgiAsyncTask(str, "GET", new pim(this), 1000, localBundle2, true).execute(new HashMap[] { paramGeoPoint1 });
      return;
