...
public class MineWSPanel$3
  implements Runnable
{
  public MineWSPanel$3(aaoj paramaaoj, byte[] paramArrayOfByte) {}
  ...
  public void run()
  {
    ...
    EntityManager localEntityManager = aaoj.a(this.this$0).app.getEntityManagerFactory().createEntityManager();
    WSPersonalEntity localWSPersonalEntity2 = (WSPersonalEntity)localEntityManager.find(WSPersonalEntity.class, aaoj.a(this.this$0));
    ...
    localWSPersonalEntity1.updateWeiShiFeedListEntity(aaoj.a(this.this$0), this.a);
