  ...
  implements Handler.Callback
{
  ...
  {
    return new SmartMusicAdapter.SmartMusicVH(this, LayoutInflater.from(paramViewGroup.getContext()).inflate(2131563200, null));
  }
  ...
  public void a(SmartMusicAdapter.SmartMusicVH paramSmartMusicVH, int paramInt)
  {
    ...
    do
    {
      EventCollector.getInstance().onRecyclerBindViewHolder(paramSmartMusicVH, paramInt, getItemId(paramInt));
      return;
      if (paramInt >= a()) {
        break;
      }
  ...
  public void onAttachedToRecyclerView(RecyclerView paramRecyclerView)
  {
    ...
    this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewCircleLayoutManager = this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewSmartMusicRecyclerView.a();
  }
 ...
 * Qualified Name:     com.tencent.biz.videostory.widget.view.smartmusicview.SmartMusicAdapter
