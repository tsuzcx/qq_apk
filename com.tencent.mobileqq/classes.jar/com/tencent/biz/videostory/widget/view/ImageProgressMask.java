  ...
  extends View
{
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsPaint.setColor(getResources().getColor(2131165498));
  ...
  protected void onSizeChanged(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if ((paramInt1 != 0) && (paramInt2 != 0) && ((paramInt1 != paramInt3) || (paramInt2 != paramInt4))) {
      this.jdField_a_of_type_AndroidGraphicsPath = bfsp.a(paramInt1, paramInt2);
    }
  }
