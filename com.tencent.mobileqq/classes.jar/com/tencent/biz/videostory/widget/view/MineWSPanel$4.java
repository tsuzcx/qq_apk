...
public class MineWSPanel$4
  implements Runnable
{
  public MineWSPanel$4(aayj paramaayj) {}
  
  public void run()
  {
    if (TextUtils.isEmpty(aayj.a(this.this$0))) {
    ...
    do
    {
      ...
      Object localObject = aayj.a(this.this$0).app.a().createEntityManager();
      WSPersonalEntity localWSPersonalEntity = (WSPersonalEntity)((EntityManager)localObject).find(WSPersonalEntity.class, aayj.a(this.this$0));
      ...
      try
      {
        ...
        if ((localObject != null) && (aayj.a(this.this$0) != null)) {
          aayj.a(this.this$0).runOnUiThread(new MineWSPanel.4.1(this, (WEISHI.stGetPersonalPageRsp)localObject));
        }
        this.this$0.a();
        return;
      }
