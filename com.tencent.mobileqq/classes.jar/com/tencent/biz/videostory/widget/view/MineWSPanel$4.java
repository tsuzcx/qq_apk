...
public class MineWSPanel$4
  implements Runnable
{
  public MineWSPanel$4(xim paramxim) {}
  
  public void run()
  {
    if (TextUtils.isEmpty(xim.a(this.this$0))) {
    ...
    do
    {
      ...
      Object localObject = xim.a(this.this$0).app.getEntityManagerFactory().createEntityManager();
      WSPersonalEntity localWSPersonalEntity = (WSPersonalEntity)((aukn)localObject).a(WSPersonalEntity.class, xim.a(this.this$0));
      ((aukn)localObject).a();
      ...
      try
      {
        ...
        if ((localObject != null) && (xim.a(this.this$0) != null)) {
          xim.a(this.this$0).runOnUiThread(new MineWSPanel.4.1(this, (WEISHI.stGetPersonalPageRsp)localObject));
        }
        this.this$0.a();
        return;
      }
