...
public class VSDispatchObserver$3
  implements Runnable
{
  public VSDispatchObserver$3(yvm paramyvm, boolean paramBoolean, long paramLong1, VSBaseRequest paramVSBaseRequest, byte[] paramArrayOfByte, yvn paramyvn, String paramString, MessageMicro paramMessageMicro, long paramLong2) {}
  ...
  public void run()
  {
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Long == 0L) && (this.jdField_a_of_type_ComTencentBizVideostoryNetworkRequestVSBaseRequest.isEnableCache())) {
      yvm.a(this.this$0, this.jdField_a_of_type_ComTencentBizVideostoryNetworkRequestVSBaseRequest, this.jdField_a_of_type_ArrayOfByte);
    }
    this.jdField_a_of_type_Yvn.a(this.jdField_a_of_type_Boolean, this.jdField_a_of_type_Long, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqPbMessageMicro);
