...
{
  private static VideoStoryPicToVideo jdField_a_of_type_ComTencentBizVideostorySupportVideoStoryPicToVideo;
  ...
  private MuiltiImageToVideo jdField_a_of_type_ComTencentBizVideostoryVideoMuiltiImageToVideo;
  ...
  {
    if (jdField_a_of_type_ComTencentBizVideostorySupportVideoStoryPicToVideo == null) {}
    try
    {
      if (jdField_a_of_type_ComTencentBizVideostorySupportVideoStoryPicToVideo == null) {
        jdField_a_of_type_ComTencentBizVideostorySupportVideoStoryPicToVideo = new VideoStoryPicToVideo();
      }
      return jdField_a_of_type_ComTencentBizVideostorySupportVideoStoryPicToVideo;
    }
    finally {}
  }
  ...
  {
    // Byte code:
    //   0: new 95	com/tencent/biz/videostory/support/VideoStoryPicToVideo$RetCode
    //   3: dup
    //   4: iconst_0
    //   5: ldc 97
    //   7: invokespecial 100	com/tencent/biz/videostory/support/VideoStoryPicToVideo$RetCode:<init>	(ILjava/lang/String;)V
    //   10: astore 19
    //   12: aconst_null
    //   13: astore 18
    ...
    //   41: iload 4
    //   43: iload 5
    //   45: invokestatic 153	com/tencent/mobileqq/util/BitmapManager:a	(Ljava/io/InputStream;Landroid/graphics/Rect;II)Landroid/graphics/Bitmap;
    //   48: astore 18
    //   50: aload 16
    //   52: ifnull +16 -> 68
    //   55: iload 4
    ...
    //   61: istore 14
    //   63: aload 16
    //   65: invokevirtual 156	java/io/BufferedInputStream:close	()V
    //   68: aload 18
    //   70: astore 16
    //   72: aload 17
    //   74: ifnull +20 -> 94
    ...
    //   83: istore 14
    //   85: aload 17
    //   87: invokevirtual 157	java/io/FileInputStream:close	()V
    //   90: aload 18
    //   92: astore 16
    //   94: aload 16
    //   96: astore 17
    ...
    //   120: iload 4
    //   122: iload 5
    //   124: invokestatic 160	com/tencent/mobileqq/util/BitmapManager:a	(Ljava/lang/String;II)Landroid/graphics/Bitmap;
    //   127: astore 17
    //   129: aload 17
    ...
    //   155: aload 19
    //   157: ldc 161
    //   159: invokevirtual 118	com/tencent/biz/videostory/support/VideoStoryPicToVideo$RetCode:a	(I)V
    //   162: iload 4
    //   164: istore 11
    //   166: iload 5
    //   168: istore 13
    ...
    //   178: aload 19
    //   180: ldc 163
    //   182: invokevirtual 123	com/tencent/biz/videostory/support/VideoStoryPicToVideo$RetCode:a	(Ljava/lang/String;)V
    //   185: iload 4
    //   187: istore 11
    //   189: iload 5
    //   191: istore 13
    ...
    //   235: istore 14
    //   237: aload 16
    //   239: invokevirtual 156	java/io/BufferedInputStream:close	()V
    //   242: aload 17
    //   244: ifnull +502 -> 746
    //   247: iload 4
    //   249: istore 12
    ...
    //   253: istore 14
    //   255: aload 17
    //   257: invokevirtual 157	java/io/FileInputStream:close	()V
    //   260: aconst_null
    //   261: astore 16
    //   263: goto -169 -> 94
    //   266: astore 16
    ...
    //   293: istore 14
    //   295: aload 16
    //   297: invokevirtual 156	java/io/BufferedInputStream:close	()V
    //   300: aload 17
    //   302: ifnull +16 -> 318
    //   305: iload 4
    //   307: istore 12
    ...
    //   311: istore 14
    //   313: aload 17
    //   315: invokevirtual 157	java/io/FileInputStream:close	()V
    //   318: iload 4
    //   320: istore 11
    //   322: iload 5
    //   324: istore 13
    ...
    //   356: aload 19
    //   358: ldc 161
    //   360: invokevirtual 118	com/tencent/biz/videostory/support/VideoStoryPicToVideo$RetCode:a	(I)V
    //   363: aload 19
    //   365: ldc 163
    //   367: invokevirtual 123	com/tencent/biz/videostory/support/VideoStoryPicToVideo$RetCode:a	(Ljava/lang/String;)V
    //   370: aload 8
    //   372: aload 19
    ...
    //   394: istore 14
    //   396: aload_1
    //   397: invokestatic 170	com/tencent/mobileqq/utils/ImageUtil:c	(Ljava/lang/String;)I
    //   400: istore 15
    //   402: aload 17
    //   404: astore_1
    //   405: iload 4
    ...
    //   606: goto -259 -> 347
    //   609: aload_0
    //   610: new 195	com/tencent/biz/videostory/video/MuiltiImageToVideo
    //   613: dup
    //   614: aload_2
    //   615: iload 4
    //   617: iload 5
    //   619: invokestatic 200	com/tencent/mobileqq/richmedia/capture/util/SVParamManager:a	()Lcom/tencent/mobileqq/richmedia/capture/util/SVParamManager;
    //   622: iconst_1
    //   623: invokevirtual 203	com/tencent/mobileqq/richmedia/capture/util/SVParamManager:a	(I)I
    //   626: iconst_4
    //   627: imul
    //   628: sipush 1000
    //   631: imul
    ...
    //   644: iload 6
    //   646: iload 7
    //   648: invokespecial 215	com/tencent/biz/videostory/video/MuiltiImageToVideo:<init>	(Ljava/lang/String;IIIJZI)V
    //   651: putfield 217	com/tencent/biz/videostory/support/VideoStoryPicToVideo:jdField_a_of_type_ComTencentBizVideostoryVideoMuiltiImageToVideo	Lcom/tencent/biz/videostory/video/MuiltiImageToVideo;
    //   654: aload_0
    //   655: getfield 217	com/tencent/biz/videostory/support/VideoStoryPicToVideo:jdField_a_of_type_ComTencentBizVideostoryVideoMuiltiImageToVideo	Lcom/tencent/biz/videostory/video/MuiltiImageToVideo;
    //   658: bipush 16
    //   660: invokevirtual 218	com/tencent/biz/videostory/video/MuiltiImageToVideo:a	(I)V
    ...
    //   676: pop
    //   677: aload_0
    //   678: getfield 217	com/tencent/biz/videostory/support/VideoStoryPicToVideo:jdField_a_of_type_ComTencentBizVideostoryVideoMuiltiImageToVideo	Lcom/tencent/biz/videostory/video/MuiltiImageToVideo;
    //   681: aload_2
    //   682: aload 8
    //   684: invokevirtual 228	com/tencent/biz/videostory/video/MuiltiImageToVideo:a	(Ljava/util/List;Lcom/tencent/biz/videostory/support/VideoStoryPicToVideo$ConvertListener;)V
    //   687: return
    //   688: astore 16
    //   690: goto -622 -> 68
    //   693: astore 16
    ...
    //   0	763	0	this	VideoStoryPicToVideo
    ...
    //   0	763	8	paramConvertListener	VideoStoryPicToVideo.ConvertListener
    //   407	348	9	i	int
    //   411	348	10	j	int
    //   105	461	11	k	int
    //   57	546	12	m	int
    ...
    //   10	363	19	localRetCode	VideoStoryPicToVideo.RetCode
    // Exception table:
    //   from	to	target	type
  ...
  public void a(String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3, VideoStoryPicToVideo.ConvertListener paramConvertListener)
  {
    ...
    } while (paramConvertListener == null);
    localRetCode.a(0);
 ...
 * Qualified Name:     com.tencent.biz.videostory.support.VideoStoryPicToVideo
