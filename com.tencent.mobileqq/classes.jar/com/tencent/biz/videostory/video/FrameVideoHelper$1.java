  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    long l3 = FrameVideoHelper.c(this.this$0, this.a);
    long l2 = this.a;
    for (;;)
    {
      int i;
      try
      {
        FrameVideoHelper.e(this.this$0).a(FrameVideoHelper.d(this.this$0));
        localObject1 = new ByteArrayOutputStream();
        long l1 = 0L;
        l2 += l3;
        i = 0;
        long l4 = i;
        long l5 = FrameVideoHelper.f(this.this$0);
        if ((l4 < l5) && (l2 < FrameVideoHelper.g(this.this$0)))
        {
          Object localObject2 = FrameVideoHelper.e(this.this$0).a(l2);
          l2 += l3;
          if (localObject2 == null) {
            break label485;
          }
          ((Bitmap)localObject2).compress(Bitmap.CompressFormat.JPEG, (int)FrameVideoHelper.h(this.this$0), (OutputStream)localObject1);
          localObject2 = ((ByteArrayOutputStream)localObject1).toByteArray();
          l1 += localObject2.length;
          if (l1 >= FrameVideoHelper.i(this.this$0))
          {
          ...
          {
            FrameVideoHelper.d(this.this$0, FrameVideoHelper.j(this.this$0) + localObject2.length);
            FrameVideoHelper.k(this.this$0).add(new FrameVideoHelper.FrameBuffer((byte[])localObject2));
            ((ByteArrayOutputStream)localObject1).reset();
            break label485;
          }
        }
        FrameVideoHelper.e(this.this$0, System.currentTimeMillis() - FrameVideoHelper.l(this.this$0));
        ((ByteArrayOutputStream)localObject1).close();
        localObject1 = new StringBuilder();
        ((StringBuilder)localObject1).append("extract Frame cost time:");
        ((StringBuilder)localObject1).append(FrameVideoHelper.m(this.this$0));
        QLog.i("FrameVideoHelper", 0, ((StringBuilder)localObject1).toString());
        if (this.b != null) {
          this.b.a(true, FrameVideoHelper.k(this.this$0), FrameVideoHelper.j(this.this$0));
        }
      }
      catch (Exception localException)
      {
        localException.printStackTrace();
        this.b.a(false, FrameVideoHelper.k(this.this$0), FrameVideoHelper.j(this.this$0));
      }
