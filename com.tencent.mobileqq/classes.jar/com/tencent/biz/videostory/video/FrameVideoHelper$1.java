...
class FrameVideoHelper$1
  implements Runnable
{
  FrameVideoHelper$1(FrameVideoHelper paramFrameVideoHelper, long paramLong, wyj paramwyj) {}
  ...
  public void run()
  {
    ...
    FrameVideoHelper.a(this.this$0, new wyl(FrameVideoHelper.b(this.this$0), FrameVideoHelper.c(this.this$0)));
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_Wyj != null) {
          this.jdField_a_of_type_Wyj.a(true, FrameVideoHelper.a(this.this$0), FrameVideoHelper.g(this.this$0));
        }
      }
      catch (Exception localException)
      {
        ...
        this.jdField_a_of_type_Wyj.a(false, FrameVideoHelper.a(this.this$0), FrameVideoHelper.g(this.this$0));
        continue;
      }
