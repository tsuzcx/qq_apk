...
public class MuiltiImageToVideo
{
  ...
  public void a(List<Bitmap> paramList, VideoStoryPicToVideo.ConvertListener paramConvertListener)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecRecorderHWVideoRecorder.a(localEncodeConfig, new MuiltiImageToVideo.1(this, paramList, paramConvertListener, localRetCode));
    try
    {
      try
      {
 ...
 * Qualified Name:     com.tencent.biz.videostory.video.MuiltiImageToVideo
