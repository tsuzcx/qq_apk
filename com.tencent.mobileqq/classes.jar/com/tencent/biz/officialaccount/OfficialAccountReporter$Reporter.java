...
public final class OfficialAccountReporter$Reporter
{
  private final void a(String paramString1, String paramString2, CharSequence paramCharSequence, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    if (paramString2 != null) {
      ((Map)localHashMap).put("tianshu_transfer", ((Reporter)this).m(paramString2));
    }
  ...
  private final void a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    if (paramString4 != null) {
      ((Map)localHashMap).put("tianshu_transfer", ((Reporter)this).m(paramString4));
    }
  ...
  private final void b(String paramString1, String paramString2, CharSequence paramCharSequence, String paramString3, int paramInt1, int paramInt2)
  {
    ...
    if (paramString2 != null)
    {
      paramString2 = ((Reporter)this).m(paramString2);
  ...
  private final int d()
  {
    if (OfficialAccountReporter.f() > 0) {
      return OfficialAccountReporter.f();
    }
  ...
  private final int e()
  {
    if (OfficialAccountReporter.g() > 0) {
      return OfficialAccountReporter.g();
    }
  ...
  private final void l(String paramString)
  {
    ...
    long l2 = OfficialAccountReporter.e();
    Reporter localReporter = (Reporter)this;
    if (l1 > l2 + localReporter.d())
    {
  ...
  private final String m(String paramString)
  {
    try
    {
  ...
  public final void a(@Nullable RecentBaseData paramRecentBaseData)
  {
    if (paramRecentBaseData != null) {
      try
      {
        ...
        if (!OfficialAccountReporter.h().contains(Integer.valueOf(i)))
        {
          if (!((Reporter)this).f()) {
            return;
          }
          OfficialAccountReporter.h().add(Integer.valueOf(i));
          Object localObject1;
          Object localObject2;
          if ((paramRecentBaseData instanceof RecentItemPublicAccountChatMsgData))
          {
            localObject1 = ((RecentItemPublicAccountChatMsgData)paramRecentBaseData).c();
  ...
  public final void a(@Nullable AbsStructMsgElement paramAbsStructMsgElement, @Nullable String paramString)
  {
    if (paramAbsStructMsgElement != null) {
      try
      {
        ((Reporter)this).a(paramAbsStructMsgElement.an, paramAbsStructMsgElement.d, paramAbsStructMsgElement.ap, paramString);
        return;
      }
  ...
  public final void a(@Nullable Object paramObject)
  {
    try
    {
      ...
      {
        localObject1 = ((RecentItemPublicAccountChatMsgData)paramObject).c();
        if (localObject1 == null) {
          return;
        }
      ...
      try
      {
        ...
        while (paramList.hasNext())
        {
          ...
          if ((localMessageRecord.istroop == 1008) || (localMessageRecord.istroop == 7230) || (localMessageRecord.istroop == 7120))
          {
            ...
            ((Map)localHashMap).put("tianshu_transfer", ((Reporter)this).m(str3));
  ...
  public final void b(@Nullable String paramString)
  {
    try
    {
      if (OfficialAccountReporter.c() > 0L)
      {
        HashMap localHashMap = new HashMap();
        ((Map)localHashMap).put("duration_ms", String.valueOf(SystemClock.elapsedRealtime() - OfficialAccountReporter.c()));
  ...
  public final void c()
  {
    try
    {
      ...
      int i = ((Reporter)this).e();
      if (l <= OfficialAccountReporter.i() + i) {
        return;
      }
      i = ((Reporter)this).d();
      if ((OfficialAccountReporter.j() > 0L) && (l <= OfficialAccountReporter.j() + i)) {
        return;
      }
      OfficialAccountReporter.h().clear();
      OfficialAccountReporter.d(SystemClock.elapsedRealtime());
      StringBuilder localStringBuilder = new StringBuilder();
      localStringBuilder.append("refreshAioExpoRecord ");
      localStringBuilder.append(OfficialAccountReporter.j() - l);
  ...
  public final void c(@Nullable String paramString1, int paramInt, @Nullable String paramString2)
  {
    try
    {
      ...
      long l = SystemClock.elapsedRealtime();
      localObject = (Long)OfficialAccountReporter.d().get(Integer.valueOf(i));
      if ((localObject != null) && (l <= ((Long)localObject).longValue() + ((Reporter)this).d())) {
        return;
      }
      ...
      ((Map)OfficialAccountReporter.d()).put(Integer.valueOf(i), Long.valueOf(SystemClock.elapsedRealtime()));
      return;
    }
    catch (Exception paramString1)
    {
