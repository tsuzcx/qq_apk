  ...
  extends XBaseAdapter
{
  ...
  {
    paramView = paramView.findViewById(2131362822);
    if (paramView == null) {
      return;
    }
    ValueAnimator localValueAnimator = ValueAnimator.ofInt(new int[] { -paramView.getHeight(), 0 });
    localValueAnimator.setDuration(500L);
    localValueAnimator.addUpdateListener(new oxx(this, paramView));
  ...
  public View a(View paramView, int paramInt)
  {
    ...
    paramView.getViewTreeObserver().addOnPreDrawListener(new oxw(this, paramView));
    return paramView;
  }
