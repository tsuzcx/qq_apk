  ...
  implements TouchWebView.OnOverScrollHandler
{
  ...
  public void a(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Blnu.a(getScrollX(), getScrollY(), 0, 0, -paramInt, 0)) {
      invalidate();
    }
  }
  ...
  protected void a(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_Blnu = new blnu(getContext());
    try
    {
  ...
  public void computeScroll()
  {
    ...
    if ((this.jdField_a_of_type_Blnu != null) && (this.jdField_a_of_type_Blnu.b()))
    {
      int i = getScrollX();
      int j = getScrollY();
      int k = this.jdField_a_of_type_Blnu.a();
      int m = this.jdField_a_of_type_Blnu.b();
  ...
  public void onBack()
  {
    ...
    if (this.jdField_a_of_type_Blnu.a(getScrollX(), getScrollY(), 0, 0, 0, 0)) {
      invalidate();
    }
  }
  ...
  protected void onOverScrolled(int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (!this.jdField_a_of_type_Blnu.a())
    {
      super.scrollTo(paramInt1, paramInt2);
      if ((paramBoolean1) || (paramBoolean2)) {
        this.jdField_a_of_type_Blnu.a(getScrollX(), getScrollY(), 0, 0, 0, 0);
      }
    }
    for (;;)
    {
  ...
  public void setOnFlingGesture(aayn paramaayn)
  {
    if ((paramaayn instanceof WebViewFragment))
    {
      Object localObject = ((WebViewFragment)paramaayn).getActivity();
      if ((localObject != null) && ((localObject instanceof QQBrowserActivity)))
      {
        localObject = ((QQBrowserActivity)localObject).a();
        if (localObject != null)
        {
          localObject = ((aqre)localObject).a();
        ...
        if (this.jdField_a_of_type_ComTencentBizPubaccountUtilPublicAccountCompactSwipeBackLayout != null) {
          this.jdField_a_of_type_ComTencentBizPubaccountUtilPublicAccountCompactSwipeBackLayout.setWebViewFragment((WebViewFragment)paramaayn);
        }
      }
    }
  }
