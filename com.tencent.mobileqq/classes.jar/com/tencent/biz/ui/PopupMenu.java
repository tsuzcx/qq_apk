  ...
  extends PopupWindows
{
  ...
  public void a(int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidViewView.findViewById(2131364602));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131364603));
  ...
  public void a(MenuItem paramMenuItem)
  {
    ...
    if (this.jdField_a_of_type_Int != 0)
    {
      ...
      ((ImageView)localObject1).setBackgroundResource(2130838920);
    ...
    Object localObject1 = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130968983, null);
    Object localObject2 = (ImageView)((View)localObject1).findViewById(2131364598);
    TextView localTextView = (TextView)((View)localObject1).findViewById(2131364599);
    ...
    for (;;)
    {
      ((View)localObject1).setOnClickListener(new pep(this, paramMenuItem.b(), paramMenuItem.a()));
