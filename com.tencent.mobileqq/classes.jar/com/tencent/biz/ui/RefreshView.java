  ...
  extends CustomScrollView
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new RefreshView.1(this);
  ...
  private OverScrollViewListener jdField_a_of_type_ComTencentWidgetOverScrollViewListener = new RefreshView.2(this);
  ...
  private int a()
  {
    return this.jdField_a_of_type_ComTencentMobileqqWidgetIPullRefreshHeader.a().getMeasuredHeight();
  }
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetIPullRefreshHeader.a().setMinimumHeight((int)(f * 60.0F));
    this.jdField_a_of_type_ComTencentMobileqqWidgetIPullRefreshHeader.a().setVisibility(8);
  }
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqWidgetIPullRefreshHeader.a() == 0L)
    {
      a();
      return;
    }
    this.jdField_a_of_type_AndroidOsHandler.sendEmptyMessageDelayed(0, this.jdField_a_of_type_ComTencentMobileqqWidgetIPullRefreshHeader.a());
  }
  ...
  public void setHeader(IPullRefreshHeader paramIPullRefreshHeader)
  {
    ...
    removeViewAt(0);
    this.jdField_a_of_type_ComTencentMobileqqWidgetIPullRefreshHeader = paramIPullRefreshHeader;
    addView(this.jdField_a_of_type_ComTencentMobileqqWidgetIPullRefreshHeader.a(), 0);
    c();
  }
  ...
  public void setOnRefreshListener(RefreshView.OnRefreshListener paramOnRefreshListener)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetIPullRefreshHeader.a().setVisibility(0);
  }
}
