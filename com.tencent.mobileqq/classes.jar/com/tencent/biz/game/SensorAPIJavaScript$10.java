  ...
  extends Thread
{
  ...
  public void run()
  {
    ...
    Object localObject = new go(this.jdField_a_of_type_JavaLangString, this.b, this.c, this.jdField_a_of_type_Boolean);
    if (new gm(this.jdField_a_of_type_AndroidNetWifiWifiManager).a((go)localObject))
    {
    ...
    this.this$0.c = false;
    this.this$0.callJs(this.d, new String[] { mpw.a(Integer.toString(1)) });
  }
}
