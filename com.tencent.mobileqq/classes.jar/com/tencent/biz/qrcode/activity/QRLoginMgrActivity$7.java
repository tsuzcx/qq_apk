  ...
  extends FriendListObserver
{
  ...
  public void onKickOutDevFResult(boolean paramBoolean, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    if ((QRLoginMgrActivity.a(this.a) == null) || (QRLoginMgrActivity.a(this.a).size() == 0))
    {
      ...
      this.a.finish();
      if ((QRLoginMgrActivity.a(this.a) != null) && (QRLoginMgrActivity.a(this.a).size() > 0)) {
        QQToast.a(this.a.getApplicationContext(), 1, 2131717017, 0).a();
      }
    }
    while (paramInt2 != 100)
    {
      return;
      QQToast.a(this.a.getApplicationContext(), 2, 2131717018, 0).a();
    ...
    if (paramBoolean)
    {
      QQToast.a(this.a.getApplicationContext(), 2, 2131717044, 0).a();
      return;
    }
    QQToast.a(this.a.getApplicationContext(), 1, 2131717017, 0).a();
  }
