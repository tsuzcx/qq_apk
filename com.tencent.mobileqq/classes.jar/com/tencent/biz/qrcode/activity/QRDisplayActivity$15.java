  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    try
    {
      str = znl.a(this.this$0.getApplicationContext(), str, this.this$0.b);
    ...
    catch (OutOfMemoryError localOutOfMemoryError)
    {
      if (this.this$0.jdField_c_of_type_Int == 2) {
        bhbu.a("Grp_share", "grpData_admin", "qr_qzone", 0, 0, new String[] { this.this$0.jdField_c_of_type_JavaLangString, String.valueOf(this.this$0.a), "1" });
      }
