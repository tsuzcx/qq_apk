  ...
  implements Runnable
{
  public void run()
  {
    Bitmap localBitmap = zyx.a(this.jdField_a_of_type_AndroidContentResResources, this.jdField_a_of_type_Int, Integer.valueOf(this.jdField_a_of_type_AndroidViewView.getWidth()), Integer.valueOf(this.jdField_a_of_type_AndroidViewView.getHeight()));
