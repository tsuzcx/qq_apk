...
public class CodeMaskManager
{
  ...
  static
  {
    if (bgjq.a())
    {
      jdField_a_of_type_JavaLangString = anhk.ba + "qbiz/qrcode/";
      return;
    }
  }
  ...
  private Bitmap a(String paramString)
  {
    ...
    //   35: aload_1
    //   36: ldc 176
    //   38: invokevirtual 174	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   41: ifne +24 -> 65
    ...
    //   63: astore 6
    //   65: aload 6
    //   67: invokestatic 184	bdsh:c	(Ljava/lang/String;)Ljava/lang/String;
    //   70: astore 7
    //   72: new 186	java/io/FileInputStream
    //   75: dup
    ...
    //   97: invokespecial 187	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   100: astore_2
    //   101: new 189	java/io/BufferedInputStream
    //   104: dup
    //   105: aload_2
    //   106: sipush 8192
    //   109: invokespecial 192	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;I)V
    //   112: astore_1
    //   113: aload_1
    //   114: astore 4
    //   116: aload_2
    //   117: astore_3
    //   118: aload_1
    //   119: invokestatic 198	android/graphics/BitmapFactory:decodeStream	(Ljava/io/InputStream;)Landroid/graphics/Bitmap;
    //   122: astore 5
    //   124: aload 5
    //   126: astore_3
    //   127: aload_1
    //   128: ifnull +7 -> 135
    //   131: aload_1
    //   132: invokevirtual 201	java/io/BufferedInputStream:close	()V
    //   135: aload_3
    //   136: astore_1
    //   137: aload_2
    //   138: ifnull +9 -> 147
    //   141: aload_2
    //   142: invokevirtual 202	java/io/FileInputStream:close	()V
    //   145: aload_3
    //   146: astore_1
    //   147: aload_1
    //   148: astore_2
    ...
    //   153: aload_0
    //   154: getfield 70	com/tencent/biz/qrcode/CodeMaskManager:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   157: ldc 204
    //   159: aload 6
    //   161: invokestatic 209	com/tencent/mobileqq/msf/sdk/MsfSdkUtils:insertMtype	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   164: ldc 211
    //   166: aconst_null
    //   167: aconst_null
    //   168: invokestatic 216	nlw:a	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;Landroid/os/Bundle;)[B
    //   171: astore_2
    //   172: aload_2
    //   173: ifnull +11 -> 184
    //   176: aload_2
    ...
    //   178: aload_2
    //   179: arraylength
    //   180: invokestatic 220	android/graphics/BitmapFactory:decodeByteArray	([BII)Landroid/graphics/Bitmap;
    //   183: astore_1
    //   184: aload_1
    //   185: ifnonnull +99 -> 284
    //   188: new 160	java/io/IOException
    //   191: dup
    //   192: ldc 221
    //   194: invokestatic 226	anni:a	(I)Ljava/lang/String;
    //   197: invokespecial 227	java/io/IOException:<init>	(Ljava/lang/String;)V
    //   200: athrow
    //   201: astore 5
    //   203: aconst_null
    //   204: astore_1
    ...
    //   210: aload_2
    //   211: astore_3
    //   212: invokestatic 232	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   215: ifeq +19 -> 234
    //   218: aload_1
    //   219: astore 4
    //   221: aload_2
    ...
    //   225: iconst_2
    //   226: aload 5
    //   228: invokevirtual 237	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   231: invokestatic 241	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   234: aload_1
    //   235: ifnull +7 -> 242
    //   238: aload_1
    //   239: invokevirtual 201	java/io/BufferedInputStream:close	()V
    //   242: aload_2
    //   243: ifnull +95 -> 338
    //   246: aload_2
    //   247: invokevirtual 202	java/io/FileInputStream:close	()V
    //   250: aconst_null
    //   251: astore_1
    //   252: goto -105 -> 147
    //   255: astore_1
    ...
    //   266: ifnull +8 -> 274
    //   269: aload 4
    //   271: invokevirtual 201	java/io/BufferedInputStream:close	()V
    //   274: aload_2
    //   275: ifnull +7 -> 282
    //   278: aload_2
    //   279: invokevirtual 202	java/io/FileInputStream:close	()V
    //   282: aload_1
    //   283: athrow
    //   284: aload_0
    //   285: aload 7
    //   287: aload_2
    //   288: invokespecial 244	com/tencent/biz/qrcode/CodeMaskManager:a	(Ljava/lang/String;[B)Z
    //   291: pop
    //   292: aload_1
    //   293: areturn
    //   294: astore_1
  ...
  private void a(int paramInt)
  {
    ...
    if (paramInt == 1)
    {
      localBundle.putInt("qrbkgRes", 2130843189);
  ...
  private boolean a(String paramString, byte[] paramArrayOfByte)
  {
    ...
    //   19: invokespecial 383	java/io/File:<init>	(Ljava/lang/String;)V
    //   22: invokevirtual 386	java/io/File:mkdirs	()Z
    //   25: pop
    ...
    //   50: invokespecial 383	java/io/File:<init>	(Ljava/lang/String;)V
    //   53: astore_1
    //   54: aload_1
    //   55: invokevirtual 389	java/io/File:exists	()Z
    //   58: ifne +8 -> 66
    //   61: aload_1
    //   62: invokevirtual 392	java/io/File:createNewFile	()Z
    //   65: pop
    //   66: new 394	java/io/FileOutputStream
    //   69: dup
    //   70: aload_1
    //   71: invokespecial 397	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   74: astore_1
    //   75: aload_1
    //   76: aload_2
    //   77: invokevirtual 401	java/io/FileOutputStream:write	([B)V
    //   80: iconst_1
    //   81: istore 4
    //   83: iload 4
    //   85: istore_3
    ...
    //   87: ifnull +10 -> 97
    //   90: aload_1
    //   91: invokevirtual 402	java/io/FileOutputStream:close	()V
    //   94: iload 4
    //   96: istore_3
    //   97: iload_3
    //   98: ireturn
    //   99: iconst_0
    //   100: ifeq -3 -> 97
    //   103: new 404	java/lang/NullPointerException
    //   106: dup
    //   107: invokespecial 405	java/lang/NullPointerException:<init>	()V
    //   110: athrow
    //   111: astore_1
    //   112: iconst_0
    //   113: ireturn
    ...
    //   119: ifnull -22 -> 97
    //   122: aload_1
    //   123: invokevirtual 402	java/io/FileOutputStream:close	()V
    //   126: iconst_0
    //   127: ireturn
    //   128: astore_1
    //   129: iconst_0
    ...
    //   136: ifnull +7 -> 143
    //   139: aload_2
    //   140: invokevirtual 402	java/io/FileOutputStream:close	()V
    //   143: aload_1
    //   144: athrow
    //   145: astore_1
    //   146: iconst_1
  ...
  public void a(zro paramzro, boolean paramBoolean1, boolean paramBoolean2, int paramInt, boolean paramBoolean3)
  {
    if (this.jdField_a_of_type_Boolean) {
      return;
    }
    if (paramBoolean3)
    {
      ...
      paramzro.a(a((Bundle)localObject));
      return;
    }
    if ((paramBoolean1) && (paramBoolean2) && ((paramInt == 2) || (paramInt == 1)))
    {
      ...
      for (;;)
      {
        ...
        paramzro.a(a(this.jdField_a_of_type_AndroidOsBundle));
        return;
        label256:
        if (paramInt == 1) {
    ...
    localObject = new CodeMaskManager.PrepareBundleTask(this, paramzro, (Bundle)localObject);
    this.jdField_a_of_type_AndroidOsHandler.postDelayed(new CodeMaskManager.2(this, (CodeMaskManager.PrepareBundleTask)localObject, paramzro), 10000L);
