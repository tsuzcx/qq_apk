  ...
  extends Thread
{
  ...
  zjn jdField_a_of_type_Zjn;
  
  CodeMaskManager$PrepareBundleTask(CodeMaskManager paramCodeMaskManager, zjn paramzjn, Bundle paramBundle)
  {
    super("qr_code_mask_prepare_thread");
    this.jdField_a_of_type_Zjn = paramzjn;
    ...
    try
    {
      if (this.jdField_a_of_type_AndroidOsBundle.containsKey("qrsz"))
      {
        ...
        if (!bool) {
          try
          {
            localObject1 = znl.a((String)localObject1, this.jdField_a_of_type_AndroidOsBundle.getInt("qrsz"));
