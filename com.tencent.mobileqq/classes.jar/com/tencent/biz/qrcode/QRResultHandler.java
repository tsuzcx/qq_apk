...
public class QRResultHandler
{
  public static int a(QQAppInterface paramQQAppInterface, Activity paramActivity, QRActionEntity paramQRActionEntity, String paramString, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      a(paramQQAppInterface, paramActivity, paramQRActionEntity.a().a() + "", str2, str1, paramBundle.getString("authKey"), str5);
      return 2;
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString)
  {
    ...
    paramQQAppInterface.putExtra("title", paramActivity.getString(2131718705));
  ...
  private static final void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString, Bundle paramBundle)
  {
    ...
    ((IPublicAccountUtil)QRoute.api(IPublicAccountUtil.class)).gotoProfile(localIntent, paramQQAppInterface, paramActivity, paramString, -1);
  ...
  private static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    for (;;)
    {
      ...
      paramQQAppInterface = JumpParser.a(paramQQAppInterface, paramActivity, Uri.parse("mqqapi://card/show_pslcard?" + HttpUtil.encodeUrl(localBundle)).toString());
