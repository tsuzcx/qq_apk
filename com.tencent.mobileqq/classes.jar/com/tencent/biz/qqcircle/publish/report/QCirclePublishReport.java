package com.tencent.biz.qqcircle.publish.report;
...
public class QCirclePublishReport
{
  public static void a(int paramInt1, int paramInt2, int paramInt3, QCircleLpReportDc05504.DataBuilder paramDataBuilder)
  {
    if (paramDataBuilder != null)
    {
      paramDataBuilder.setToUin(HostDataTransUtils.getAccount()).setActionType(paramInt1).setSubActionType(paramInt2).setThrActionType(paramInt3).setPageId(0).setfPageId(0);
      QCircleLpReportDc05504.report(paramDataBuilder);
    }
  }
  
  public static void a(int paramInt1, int paramInt2, int paramInt3, String paramString1, String paramString2)
  {
    QLog.d("[QcirclePublish]QCirclePublishReport", 1, new Object[] { "reportToDc05504... actionType:", Integer.valueOf(paramInt1), " subActionType:", Integer.valueOf(paramInt2), " thrActionType:", Integer.valueOf(paramInt3), " ext1:", paramString1, " ext6:", paramString2 });
    QCircleLpReportDc05504.report(new QCircleLpReportDc05504.DataBuilder().setToUin(HostDataTransUtils.getAccount()).setActionType(paramInt1).setSubActionType(paramInt2).setThrActionType(paramInt3).setExt1(paramString1).setExt6(paramString2).setPageId(QCircleReportHelper.getInstance().getPageId()));
  }
  
  public static void a(int paramInt1, int paramInt2, int paramInt3, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    QLog.d("[QcirclePublish]QCirclePublishReport", 1, new Object[] { "reportToDc05504... actionType:", Integer.valueOf(paramInt1), " subActionType:", Integer.valueOf(paramInt2), " thrActionType:", Integer.valueOf(paramInt3), " ext1:", paramString1, " ext6:", paramString2, " ext7:", paramString3, " ext8:", paramString4 });
    QCircleLpReportDc05504.report(new QCircleLpReportDc05504.DataBuilder().setToUin(HostDataTransUtils.getAccount()).setActionType(paramInt1).setSubActionType(paramInt2).setThrActionType(paramInt3).setExt1(paramString1).setExt6(paramString2).setExt7(paramString3).setExt8(paramString4).setPageId(0).setfPageId(0));
  }
 ...
 * Qualified Name:     com.tencent.biz.qqcircle.publish.report.QCirclePublishReport
