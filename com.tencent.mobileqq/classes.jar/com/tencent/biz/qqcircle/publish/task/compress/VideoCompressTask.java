  ...
  extends QCircleQueueTask
{
  ...
  void B()
  {
    ...
    RemoteVideoServiceHandler.a().a(i());
    I();
    this.i.a = i();
    this.o = 0;
    this.b = this.a.b;
  ...
  public void w()
  {
    ...
    if (this.c)
    {
      ...
      Intent localIntent = new Intent();
      localIntent.putExtra("client_key", i());
      ((Message)localObject).obj = localIntent;
      RemoteVideoServiceHandler.a().b((Message)localObject);
 ...
 * Qualified Name:     com.tencent.biz.qqcircle.publish.task.compress.VideoCompressTask
