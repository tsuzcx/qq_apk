  ...
  public void run()
  {
    while (!this.this$0.b.isEmpty())
    {
      ...
      if (localObject != null) {
        ...
        {
          QLog.w("[QcirclePublish]RemoteVideoServiceHandler", 1, localException.getMessage());
 ...
 * Qualified Name:     com.tencent.biz.qqcircle.publish.service.video.RemoteVideoServiceHandler.3
