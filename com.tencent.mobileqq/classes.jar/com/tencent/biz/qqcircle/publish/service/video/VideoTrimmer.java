...
import com.tencent.biz.qqcircle.publish.service.video.util.QCircleVideoCommonUtils;
import com.tencent.biz.qqcircle.publish.service.video.util.QCircleVideoCommonUtils.VideoSupport;
import com.tencent.biz.qqcircle.publish.service.video.util.QCircleVideoUtils;
import com.tencent.biz.qqcircle.publish.util.CheckListUtil;
...
public class VideoTrimmer
{
  ...
  private static int a(String paramString1, String paramString2, String paramString3, long paramLong1, long paramLong2, boolean paramBoolean, int paramInt, Handler paramHandler, String paramString4)
  {
    ...
    paramInt = QCircleVideoCompressor.a(paramString4, paramString1);
  ...
  public static int a(String paramString1, String paramString2, String paramString3, String paramString4, long paramLong1, long paramLong2, long paramLong3, boolean paramBoolean1, int paramInt, Handler paramHandler, String paramString5, String paramString6, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (;;)
    {
      ...
      if (i1 == 0)
      {
        int i2 = QCircleVideoCompressor.a(paramString6, new String[] { "-i", paramString5, "-acodec", "copy", "-vcodec", "copy", "-movflags", "faststart", "-y", paramString4 });
        paramString1 = new StringBuilder();
  ...
  private static int a(String paramString1, String paramString2, boolean paramBoolean, long paramLong1, long paramLong2)
  {
    ...
    if (Build.VERSION.SDK_INT >= 18)
    {
      ...
      if (bool)
      {
        ...
        i.setCompressMode(1);
        i2 = i.startCompress(QCircleApplication.APP, paramString1, paramString2, true);
        if ((i2 != 0) && (i2 != -1002))
        {
          if (QLog.isColorLevel()) {
  ...
  public static void a(String paramString)
  {
    ...
    QCircleVideoCompressor.a(paramString);
  }
  ...
  private static String[] a(String paramString1, String paramString2, String paramString3, long paramLong1, long paramLong2, boolean paramBoolean, int paramInt)
  {
    ...
    if (localObject2.length >= 4)
    {
      ...
      try
      {
        localObject3 = (ActivityManager)QCircleApplication.APP.getSystemService("activity");
        ...
        i1 = QCircleVideoUtils.a(s, paramBoolean);
        try
        {
          if (((ActivityManager.MemoryInfo)localObject1).availMem < i1) {
            ...
            {
              i3 = QCircleVideoUtils.a("ultrafast", true);
      ...
      label414:
      int i1 = QCircleConfigHelper.a("TrimVideo", "videoRetryDownLow", Integer.valueOf(f)).intValue();
      int i3 = QCircleConfigHelper.a("TrimVideo", "videoRetryDownMedium", Integer.valueOf(g)).intValue();
      int i4 = QCircleConfigHelper.a("TrimVideo", "videoRetryDownHigh", Integer.valueOf(h)).intValue();
      if (paramInt >= i1) {
        s = "ultrafast";
      }
      String str1;
  ...
  private static void l()
  {
    ...
    j = QCircleConfigHelper.a("MiniVideo", "videoTrimEnableHw", (Integer)localObject).intValue();
    l = QCircleConfigHelper.a("MiniVideo", "videoTimeNoTrimThreshold", Integer.valueOf(1000)).intValue();
    boolean bool1;
    if (QCircleConfigHelper.a("MiniVideo", "ClientCompress", (Integer)localObject).intValue() == 1) {
      bool1 = true;
    } else {
      bool1 = false;
    }
    m = bool1;
    n = QCircleConfigHelper.a("MiniVideo", "VideoMaxBitrate", Integer.valueOf(700000)).intValue();
    o = QCircleConfigHelper.a("MiniVideo", "VideoLongestEdge", Integer.valueOf(960)).intValue();
    p = QCircleConfigHelper.a("MiniVideo", "FrameRate", Integer.valueOf(24)).intValue();
    q = QCircleConfigHelper.a("MiniVideo", "AudioMaxSample", Integer.valueOf(44100)).intValue();
    r = QCircleConfigHelper.a("MiniVideo", "AudioMaxBitrate", Integer.valueOf(64000)).intValue();
    if (QCircleHostQzoneHelper.meetHardwareRestriction(QCircleHostQzoneHelper.HARDWARE_LOWLEVEL(), QCircleHostQzoneHelper.HARDWARE_HIGHLEVEL())) {
      s = QCircleConfigHelper.a("MiniVideo", "VideoPreset", "medium");
    } else {
      s = QCircleConfigHelper.a("MiniVideo", "VideoPresetForLowCpu", "veryfast");
    }
    t = QCircleConfigHelper.a("MiniVideo", "VideoTune", "ssim");
    u = QCircleConfigHelper.a("MiniVideo", "VideoProfile", "high");
    v = QCircleConfigHelper.a("MiniVideo", "VideoLevel", "3.0");
    H = QCircleConfigHelper.a("MiniVideo", "iFrameInterval", (Integer)localObject).intValue();
    w = QCircleConfigHelper.a("MiniVideo", "OtherConfig", "-refs 2 -subq 3 -me_method hex -sws_flags lanczos -rc-lookahead 30  -weightp 1");
    x = QCircleConfigHelper.a("MiniVideo", "HwVideoProfile", "high");
    y = QCircleConfigHelper.a("MiniVideo", "HwFrameRate", Integer.valueOf(30)).intValue();
    A = QCircleConfigHelper.a("MiniVideo", "HwVideoLongestEdge", Integer.valueOf(960)).intValue();
    B = QCircleConfigHelper.a("MiniVideo", "HwVideoMaxBitrate", Integer.valueOf(700000)).intValue();
    F = QCircleConfigHelper.a("MiniVideo", "HwCompressBlackList", "TRT-AL00|TRT-AL00A|KNT-AL10|NXT-AL10|HUAWEI NXT-TL00|HUAWEI NXT-DL00|HUAWEI NXT-CL00|OPPO R9s|OPPO R9s Plus|OPPO R11|OPPO R11 Plus|OPPO R11t|OPPO R11t Plus|OPPO R11s|OPPO R11s Plus|OPPO R11st|OPPO R11s Plust|PACM00|PACT00|PAAM00|PAAT00|vivo x9|vivo x9Plus|vivo x20|vivo X20A|vivo X20Plus A|vivo x20Plus|x21a|x21ud|x21uda|vivo y85|vivo y85a|M5 Note");
    G = QCircleConfigHelper.a("MiniVideo", "HwCompressWhiteListAndroidVersion", Integer.valueOf(24)).intValue();
    z = QCircleConfigHelper.a("MiniVideo", "HwVideoLevel", "4.0");
    C = QCircleConfigHelper.a("MiniVideo", "HwVideoBitrateMode", (Integer)localObject).intValue();
    E = QCircleConfigHelper.a("MiniVideo", "ForceHwCompressList", "BKL-AL20|EML-AL00");
    L = QCircleConfigHelper.a("MiniVideo", "videoTrimSupportMultiThread", (Integer)localObject).intValue();
    String[] arrayOfString3 = QCircleConfigHelper.a("MiniVideo", "VideoNewVideoCompressParamAll", "0,1280,2000000|0,1280,2000000|960,700000|960,700000").split("\\|");
    D = true;
    try
    {
    ...
    if (K)
    {
      ...
      arrayOfString1 = QCircleConfigHelper.a("MiniVideo", "QcircleVideoNewVideoCompressParamAll", "1280,3000000|1280,3000000").split("\\|");
    }
    try
    {
    ...
    if (J)
    {
      n = QCircleConfigHelper.a("MiniVideo", "WeishiVideoMaxBitrate", Integer.valueOf(3000000)).intValue();
      o = QCircleConfigHelper.a("MiniVideo", "WeishiVideoLongestEdge", Integer.valueOf(1280)).intValue();
    }
  }
  
  private static boolean m()
  {
    Object localObject = QCircleVideoCommonUtils.a();
    if (!((QCircleVideoCommonUtils.VideoSupport)localObject).a())
    {
      StringBuilder localStringBuilder = new StringBuilder();
      localStringBuilder.append("isHwCompressEnable: hardware trim support not available : ");
      localStringBuilder.append(((QCircleVideoCommonUtils.VideoSupport)localObject).b());
 ...
 * Qualified Name:     com.tencent.biz.qqcircle.publish.service.video.VideoTrimmer
