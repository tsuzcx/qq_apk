...
public class QcircleUploadEnv
  implements IUploadEnv, IUploadSoLoader
{
  QcircleUploadSoDownloader a = new QcircleUploadSoDownloader();
  private volatile boolean b = true;
  
  public QcircleUploadEnv()
  {
    this.a.a();
  }
  ...
  public static boolean a(int paramInt)
  {
    ...
    if (paramInt != 1)
    {
      ...
      QLog.d("[upload2]QcircleUploadEnv", 1, localStringBuilder.toString());
    }
  ...
  private static NetworkInfo b(Context paramContext)
  {
    try
    {
      ...
      QLog.d("[upload2]QcircleUploadEnv", 1, paramContext);
      return localObject;
    }
    catch (Throwable paramContext)
    {
      ...
      QLog.d("[upload2]QcircleUploadEnv", 1, ((StringBuilder)localObject).toString());
    }
    return null;
  }
  ...
  public boolean isAvailable()
  {
    ...
    this.b = a(QCircleApplication.APP);
    StringBuilder localStringBuilder = new StringBuilder();
  ...
  public boolean loadLibrary(String paramString)
  {
    ...
    try
    {
      ...
      if (localObject == null)
      {
        ...
        QLog.e("[upload2]QcircleUploadEnv", 1, new Object[] { localStringBuilder.toString(), localObject });
        return false;
      }
      localStringBuilder = new StringBuilder();
      ...
      localStringBuilder.append(FileUtils.a((String)localObject));
      QLog.d("[upload2]QcircleUploadEnv", 1, localStringBuilder.toString());
    ...
    catch (Throwable localThrowable)
    {
      ...
      localStringBuilder.append(paramString);
      localStringBuilder.append(" from system lib");
      QLog.e("[upload2]QcircleUploadEnv", 1, localStringBuilder.toString(), localThrowable);
    }
    return false;
  }
  ...
  public void registerNetworkStateObserver(UploadConfiguration.NetworkStateObserver paramNetworkStateObserver)
  {
    if (QLog.isColorLevel()) {
      QLog.d("[upload2]QcircleUploadEnv", 2, "registerNetworkStateObserver");
    }
    NetworkState.addListener(new QcircleUploadEnv.1(this, paramNetworkStateObserver));
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes3.jar
 * Qualified Name:     com.tencent.biz.qqcircle.publish.uploader.QcircleUploadEnv
