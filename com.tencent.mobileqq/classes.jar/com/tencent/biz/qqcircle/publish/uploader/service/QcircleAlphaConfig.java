package com.tencent.biz.qqcircle.publish.uploader.service;
...
public class QcircleAlphaConfig
{
  private static volatile QcircleAlphaConfig a;
  private Pattern b = Pattern.compile("(\\d+)\\.(\\d+).(\\d+)_(\\d+)");
  
  public static QcircleAlphaConfig a()
  {
    if (a == null) {
      try
      {
        if (a == null) {
          a = new QcircleAlphaConfig();
        }
      }
      finally {}
    }
  ...
  private boolean a(JSONObject paramJSONObject)
  {
    ...
    if (!TextUtils.isEmpty(paramJSONObject))
    {
      ...
      k = (int)(Long.valueOf(HostDataTransUtils.getAccount()).longValue() % k);
      if ((k < i) || (k > j)) {
        return false;
      }
    }
 ...
 * Qualified Name:     com.tencent.biz.qqcircle.publish.uploader.service.QcircleAlphaConfig
