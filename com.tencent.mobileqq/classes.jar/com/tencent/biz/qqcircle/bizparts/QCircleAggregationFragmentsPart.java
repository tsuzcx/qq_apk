  ...
  implements tja, zwr
{
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_Vul.a().observe(a(), new uzs(this));
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    {
      uzo localuzo = ((QCircleBaseAggregationFragment)this.jdField_c_of_type_JavaUtilArrayList.get(paramInt1)).a();
      if (localuzo == null) {
        break label153;
      }
      if (localuzo.a() != 1) {
  ...
  private void a(uzo paramuzo)
  {
    ...
    {
      ((QCircleBaseAggregationFragment)localObject).a(paramuzo);
    ...
    try
    {
      if ((QzoneConfig.getQQCircleEnableReuseFragment()) && (paramList.size() == this.jdField_c_of_type_JavaUtilArrayList.size()) && (paramList.size() == this.jdField_b_of_type_JavaUtilArrayList.size()))
      {
        ...
        while (i < paramList.size())
        {
          ...
          localQCircleBaseAggregationFragment.b(uzo.a(localStTabInfo).a(false));
          i += 1;
        }
  ...
  public void a(View paramView)
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetTabLayoutCompat.setViewPagerTabEventListener(new uzq(this));
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetViewPagerCompat.addOnPageChangeListener(new uzr(this));
  ...
  {
    ((QCircleBaseAggregationFragment)this.jdField_c_of_type_JavaUtilArrayList.get(paramtjf.a())).a();
  }
