...
class QCircleFeedPicPreloadScroller$7
  extends QCirclePicStateListener
{
  QCircleFeedPicPreloadScroller$7(QCircleFeedPicPreloadScroller paramQCircleFeedPicPreloadScroller) {}
  
  public void onStateChang(int paramInt, Option paramOption)
  {
    if ((paramInt == 6) || (paramInt == 3)) {
      QCircleFeedPicPreloadScroller.a(this.a).put(paramOption.getCacheKey(), Boolean.valueOf(true));
    }
  }
}
