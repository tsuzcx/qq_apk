...
import com.tencent.biz.qqcircle.richframework.widget.BaseVideoUtils;
...
public final class QCirclePlayer
...
{
  public static String a = SharePreferenceUtils.a(QCircleApplication.APP, "key_sp_is_support_hevc");
  ...
  private QCirclePlayerCallback i;
  ...
  private void a(long paramLong1, long paramLong2)
  {
    try
    {
      ...
      QLog.d("QCirclePlayer", 1, ((StringBuilder)localObject1).toString());
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if ((paramLong1 <= ((Long)localPair.first).longValue()) && (paramLong2 >= ((Long)localPair.second).longValue()))
        {
          ...
          QLog.d("QCirclePlayer", 1, localStringBuilder.toString());
  ...
  private void a(Surface paramSurface)
  {
    if (this.e == null)
    {
      ...
      {
        this.h = SuperPlayerFactory.createPlayerVideoView(QCircleApplication.APP);
        this.e = SuperPlayerFactory.createMediaPlayer(QCircleApplication.APP, QCircleHostConstants._SceneID.QZONE_VIDEO(), this.h);
      }
      else
      {
        this.e = SuperPlayerFactory.createMediaPlayer(QCircleApplication.APP, QCircleHostConstants._SceneID.QZONE_VIDEO(), null);
      ...
      this.e.setOnInfoListener(this);
      this.g = (SharePreferenceUtils.a(QCircleApplication.APP, "key_sp_is_detect_hevc").equals("") ^ true);
      if (!this.g)
      {
        try
        {
        ...
        {
          QLog.e("QCirclePlayer", 1, "getThumbPlayerVCodecTypeMaxCapability() error,", paramSurface);
        }
        SharePreferenceUtils.a(QCircleApplication.APP, "key_sp_is_detect_hevc", "1");
        SharePreferenceUtils.a(QCircleApplication.APP, "key_sp_is_support_hevc", a);
        QLog.i("QCirclePlayer", 1, "this phone is support hevc");
      }
    }
  }
  ...
  private void a(String paramString)
  {
    ...
    this.I = new QUICStatus(paramString);
    this.I.a(new QCirclePlayer.2(this, paramString));
  }
  
  private void a(String paramString1, String paramString2)
  {
    this.D = QCircleVideoUtils.b(paramString2, paramString1);
  }
  
  private void a(String paramString, List paramList)
  {
    QCirclePlayerCallback localQCirclePlayerCallback = this.i;
    if (localQCirclePlayerCallback == null)
    {
      QLog.w("QCirclePlayer", 1, "[report] invalid mPlayerCallback");
      return;
    }
    QCircleVideoReporter.a().a(this.d, paramString, localQCirclePlayerCallback.getReportData(), a(paramList));
  }
  
  private void a(JSONObject paramJSONObject)
  {
    if (paramJSONObject.has("isDownloadByQuic")) {
      this.I.e();
    }
  }
  ...
  {
    if (this.I == null) {
      QLog.d("QCirclePlayer", 1, "mQUICStatus null ");
    }
    if (TextUtils.isEmpty(paramString))
    {
      QLog.d("QCirclePlayer", 1, "onQUICInfoUpdate np json");
      return;
    }
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append("onQUICInfoUpdate:");
  ...
  {
    if (paramJSONObject.has("downloadComplete"))
    {
      paramJSONObject = paramJSONObject.getString("downloadComplete");
      if (TextUtils.equals(paramJSONObject, "quic"))
      {
        this.I.a();
        return;
      }
      if (TextUtils.equals(paramJSONObject, "http")) {
        this.I.b();
      }
    }
  }
  ...
  {
    if (paramJSONObject.has("downloadFailed"))
    {
      paramJSONObject = paramJSONObject.getString("downloadFailed");
      if (TextUtils.equals(paramJSONObject, "quic"))
      {
        this.I.c();
        return;
  ...
  private void t()
  {
    if ((this.A > 0L) && (this.e != null))
    {
      ...
      if (localObject1 != null)
      {
        ...
        ((StringBuilder)localObject2).append((String)localObject1);
        QLog.i("QCirclePlayer", 1, ((StringBuilder)localObject2).toString());
      ...
      if (this.x > 0)
      {
        if (!this.b)
        {
          ...
          QLog.i("QCirclePlayer", 1, String.format("PLAYER_INFO_BUFFERING_HAS_NOT_END mSecondBufferCount:%d, mSecondBufferTime:%d", new Object[] { Integer.valueOf(this.x), Long.valueOf(this.y / 1000L) }));
        }
        QLog.i("QCirclePlayer", 1, String.format("PLAYER_INFO_BUFFERING_REPORT mSecondBufferCount:%d, mSecondBufferTime:%d", new Object[] { Integer.valueOf(this.x), Long.valueOf(this.y / 1000L) }));
  ...
  private void x()
  {
    ...
    QLog.d("QCirclePlayer", 1, String.format("DownloadComplete  DownLoadSpeed:%d kb/s", new Object[] { Long.valueOf(u()) }));
  }
  
  private boolean y()
  {
    QCirclePlayerCallback localQCirclePlayerCallback = this.i;
    if ((localQCirclePlayerCallback != null) && (localQCirclePlayerCallback.getReportData() != null)) {
      return QCirclePluginUtil.a(localQCirclePlayerCallback.getReportData());
    }
    QLog.w("QCirclePlayer", 1, "isQUIC() false? invalid mPlayerCallback");
    return false;
  }
  ...
  public void a()
  {
    ...
    {
      QLog.w("QCirclePlayer", 1, "[start] null mPlayer");
      return;
    }
    if (localISuperPlayer.isPlaying())
    {
      QLog.w("QCirclePlayer", 1, "[start] mPlayer is playing");
      return;
    }
    if ((m()) && (this.m > 0L))
    {
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if (localISuperPlayer == null)
    {
      QLog.w("QCirclePlayer", 1, "[onStopTrackingTouch] null mPlayer");
      return;
    }
    paramInt2 = (int)(paramInt1 / (paramInt2 * 1.0F) * (float)localISuperPlayer.getDurationMs());
    long l1 = paramInt2;
    this.C = l1;
    QLog.d("QCirclePlayer", 1, String.format("seek onStopTrackingTouch seekBar progress:%d, position:%d", new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt2) }));
    a(l1);
  }
  ...
  public void a(long paramLong)
  {
    ...
    if (localObject == null)
    {
      QLog.w("QCirclePlayer", 1, "[seek] null mPlayer");
      return;
    }
    try
    {
      ...
      if (paramLong > l2)
      {
        ...
        if (l2 != 0L)
        {
          ...
          QLog.d("QCirclePlayer", 1, ((StringBuilder)localObject).toString());
          l1 = l2;
        }
      }
      paramLong = l1;
    ...
    {
      QLog.e("QCirclePlayer", 1, "[seek]", localException);
    }
  }
  
  @UiThread
  public void a(@Nullable QCirclePlayerCallback paramQCirclePlayerCallback, @Nullable Surface paramSurface)
  {
    if (Looper.myLooper() == Looper.getMainLooper())
    {
      this.i = paramQCirclePlayerCallback;
      if (!QCirclePluginInitHelper.isVideoSDKReady()) {
        try
        {
          HostDataTransUtils.initVideoSdk(new QCirclePlayer.1(this, paramSurface));
          return;
        }
        catch (RuntimeException paramQCirclePlayerCallback)
        {
          QLog.e("QCirclePlayer", 1, paramQCirclePlayerCallback.getMessage());
          paramQCirclePlayerCallback.printStackTrace();
          return;
        }
      }
      a(paramSurface);
      if (paramQCirclePlayerCallback != null) {
        paramQCirclePlayerCallback.c();
      }
      return;
    }
    throw new RuntimeException("QCirclePlayer must initialized in Main Thread");
  }
  
  public void a(String paramString1, String paramString2, int paramInt)
  {
    s();
    QCircleVideoReporter.b();
    this.d = QCircleVideoReporter.c();
    this.j = QCircleVideoUtils.a(paramString1, paramString2);
    ...
    if ((this.e != null) && (this.j != null))
    {
      ...
      this.e.openMediaPlayer(QCircleApplication.APP, this.j, paramInt, paramString1);
  ...
  public void a(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    ISuperPlayer localISuperPlayer = this.e;
    if (localISuperPlayer != null) {
      localISuperPlayer.setLoopback(paramBoolean, paramInt1, paramInt2);
    }
  }
  ...
  public void b()
  {
    ...
    if (localISuperPlayer == null)
    {
      QLog.w("QCirclePlayer", 1, "[pause] null mPlayer");
      return;
    }
  ...
  public void d()
  {
    ...
    if (localObject == null)
    {
      QLog.w("QCirclePlayer", 1, "[replay] no replay data");
      return;
    }
  ...
  public long e()
  {
    ...
    if (localISuperPlayer == null)
    {
      QLog.w("QCirclePlayer", 1, "[getCurrentPositionMs] null mPlayer");
      return -1L;
    }
  ...
  public void f()
  {
    ...
    RFThreadManager.execute(new QCirclePlayer.3(this));
  }
  ...
  public void g()
  {
    if (this.e == null)
    {
      QLog.w("QCirclePlayer", 1, "[onStartTrackingTouch] null mPlayer");
      return;
    }
  ...
  public void onCompletion(ISuperPlayer paramISuperPlayer)
  {
    QCirclePlayerCallback localQCirclePlayerCallback = this.i;
    if (localQCirclePlayerCallback != null) {
      localQCirclePlayerCallback.b(paramISuperPlayer);
    }
  }
  ...
  public boolean onError(ISuperPlayer paramISuperPlayer, int paramInt1, int paramInt2, int paramInt3, String paramString)
  {
    ...
    QLog.e("QCirclePlayer", 1, paramString);
    paramISuperPlayer = this.i;
    if (paramISuperPlayer != null) {
      paramISuperPlayer.a(paramInt3, paramInt1, 0L, 0L);
    }
  ...
  public boolean onInfo(ISuperPlayer paramISuperPlayer, int paramInt, long paramLong1, long paramLong2, Object paramObject)
  {
    ...
    QLog.i("QCirclePlayer", 1, String.format("onInfo: hashCode:%d, what:%s, extra:%s, url:%s", new Object[] { Integer.valueOf(i1), str2, paramISuperPlayer, str1 }));
    if (paramInt != 105)
    {
      if (paramInt != 201)
      {
                ...
                if (paramInt != 108)
                {
                  if (paramInt != 112)
                  {
                    ...
                    if (!this.v)
                    {
                      ...
                      paramISuperPlayer = this.i;
                      if (paramISuperPlayer != null) {
                        paramISuperPlayer.a(this.j);
                      }
                      QLog.i("QCirclePlayer", 1, String.format("PLAYER_INFO_BUFFERING_END mSecondBufferCount:%d, mSecondBufferTime:%d", new Object[] { Integer.valueOf(this.x), Long.valueOf(this.y) }));
                      return false;
                    }
                  }
                  else
                  {
                    ...
                    if (!this.v)
                    {
                      this.b = false;
                      this.x += 1;
                      QLog.i("QCirclePlayer", 1, String.format("PLAYER_INFO_BUFFERING_START mSecondBufferCount:%d, mSecondBufferTime:%d", new Object[] { Integer.valueOf(this.x), Long.valueOf(this.y) }));
                      return false;
                    }
                  }
                }
        ...
        else if ((paramObject instanceof TPPlayerMsg.TPCDNURLInfo))
        {
          ...
          a(paramISuperPlayer);
          QLog.i("QCirclePlayer", 1, String.format("hashCode:%d,TPPlayerMsg.TPCDNURLInfo:cdnIp:%s, errStr:%s, ip:%s, url:%s", new Object[] { Integer.valueOf(hashCode()), paramISuperPlayer.cdnIp, paramISuperPlayer.errorStr, paramISuperPlayer.uIp, paramISuperPlayer.url }));
          return false;
        }
      }
      else
      ...
      RFThreadManager.getUIHandler().post(new QCirclePlayer.4(this));
    }
    return false;
  }
  ...
  public void onVideoPrepared(ISuperPlayer paramISuperPlayer)
  {
    ...
    localObject = this.i;
    if (localObject != null) {
      ((QCirclePlayerCallback)localObject).a(paramISuperPlayer);
    }
  }
  ...
  protected void q()
  {
    ...
    if (localObject == null)
    {
      QLog.w("QCirclePlayer", 1, "[reportVideoBufferPercent] invalid mPlayerCallback");
      return;
    }
    localObject = ((QCirclePlayerCallback)localObject).getReportData();
    if ((localObject instanceof FeedCloudMeta.StFeed))
    {
      ...
      QLog.d("QCirclePlayer", 1, new Object[] { "reportVideoBufferPercent localCacheSize:", Long.valueOf(this.E), ",FileSize:", Long.valueOf(l1), ",rate:", Double.valueOf(d1) });
    }
  }
 ...
 * Qualified Name:     com.tencent.biz.qqcircle.richframework.video.QCirclePlayer
