  ...
  extends URLImageView
{
  ...
  public SquareImageView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    paramContext = paramContext.obtainStyledAttributes(paramAttributeSet, R.styleable.et);
    this.d = paramContext.getFloat(R.styleable.ey, 1.0F);
    this.e = paramContext.getFloat(R.styleable.ez, 0.0F);
    this.f = paramContext.getColor(R.styleable.eu, -1);
    this.g = paramContext.getString(R.styleable.ev);
    this.h = paramContext.getDimensionPixelSize(R.styleable.ew, 40);
    this.a = paramContext.getDimensionPixelSize(R.styleable.ex, 0);
 ...
 * Qualified Name:     com.tencent.biz.qqcircle.richframework.widget.SquareImageView
