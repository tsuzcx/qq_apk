...
public class QCircleRankTagListView
  ...
  implements View.OnClickListener
{
  ...
  private View f;
  private String g;
  private QCircleRankTagListView.OnQCircleRankTagListActionListener h;
  
  public QCircleRankTagListView(@NonNull Context paramContext)
  {
    super(paramContext);
  }
  
  public QCircleRankTagListView(@NonNull Context paramContext, int paramInt)
  {
    super(paramContext, paramInt);
  }
  
  public QCircleRankTagListView(@NonNull Context paramContext, @Nullable AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
  }
  
  public QCircleRankTagListView(@NonNull Context paramContext, @Nullable AttributeSet paramAttributeSet, int paramInt)
  {
  ...
  {
    QCircleRankTagListView.OnQCircleRankTagListActionListener localOnQCircleRankTagListActionListener = this.h;
    if (localOnQCircleRankTagListActionListener == null)
    {
      QLog.w("RANK-QCircleRankTagListView", 1, "[handlerRankTagSwitchClick] rank tag list action listener should not be null.");
      return;
    }
    localOnQCircleRankTagListActionListener.a(paramString);
  }
  ...
  protected void bindData(Object paramObject, int paramInt)
  {
    ...
    {
      QLog.d("RANK-QCircleRankTagListView", 1, "[bindData] bind data not is StGetMainPageRsp type, not handler.");
      return;
    }
    Object localObject = (FeedCloudRead.StGetMainPageRsp)paramObject;
    paramObject = ((FeedCloudRead.StGetMainPageRsp)localObject).medalWall;
    if (paramObject == null)
    {
      QLog.d("RANK-QCircleRankTagListView", 1, "[bindData] medal wall should not be null.");
      return;
    }
    this.g = paramObject.medalWallJumpUrl.get();
    boolean bool = QCirclePluginUtil.b(((FeedCloudRead.StGetMainPageRsp)localObject).user);
    localObject = paramObject.medalInfos.get();
    if ((localObject != null) && (!((List)localObject).isEmpty()))
    {
      a(bool, paramObject.needRedPoint.get(), (List)localObject);
      return;
    }
    a(bool);
  }
  ...
  public void setOnQCircleRankTagListActionListener(QCircleRankTagListView.OnQCircleRankTagListActionListener paramOnQCircleRankTagListActionListener)
  {
    this.h = paramOnQCircleRankTagListActionListener;
  }
 ...
 * Qualified Name:     com.tencent.biz.qqcircle.widgets.QCircleRankTagListView
