...
public class QCircleTailExpandText
  extends AppCompatTextView
{
  private static final String a = HardCodeUtil.a(2131895709);
  private static final String b = HardCodeUtil.a(2131895710);
  private static final int c = 2131167084;
  private int d;
  private String e = "...";
  private String f = b;
  private String g = a;
  ...
  private int k;
  private boolean l;
  private QCircleTailExpandText.OnExpandCallback m;
  private int n;
  private boolean o;
  ...
  public QCircleTailExpandText(Context paramContext)
  {
    this(paramContext, null);
  }
  
  public QCircleTailExpandText(Context paramContext, AttributeSet paramAttributeSet)
  {
    this(paramContext, paramAttributeSet, 0);
  }
  
  public QCircleTailExpandText(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
  ...
  private void a(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    {
      paramAttributeSet = paramContext.obtainStyledAttributes(paramAttributeSet, R.styleable.eM);
      setLimitLine(paramAttributeSet.getInt(R.styleable.eU, 7));
      int i2 = ImmersiveUtils.a(paramAttributeSet.getDimension(R.styleable.eX, 0.0F));
      int i1 = i2;
      if (i2 == 0) {
        i1 = ImmersiveUtils.b();
      }
      a(i1);
      if (paramAttributeSet.getString(R.styleable.eP) == null) {
        paramContext = b;
      } else {
        paramContext = paramAttributeSet.getString(R.styleable.eP);
      }
      setCloseEndText(paramContext);
      if (paramAttributeSet.getString(R.styleable.eV) == null) {
        paramContext = a;
      } else {
        paramContext = paramAttributeSet.getString(R.styleable.eV);
      }
      setOpenEndText(paramContext);
      if (paramAttributeSet.getString(R.styleable.eS) == null) {
        paramContext = "...";
      } else {
        paramContext = paramAttributeSet.getString(R.styleable.eS);
      }
      setEllipseText(paramContext);
      setOpen(paramAttributeSet.getBoolean(R.styleable.eR, false));
      setAnimDuring(paramAttributeSet.getInt(R.styleable.eO, 400));
      setAllowAnim(paramAttributeSet.getBoolean(R.styleable.eN, true));
      setOpenTextColor(paramAttributeSet.getResourceId(R.styleable.eW, c));
      setCloseTextColor(paramAttributeSet.getResourceId(R.styleable.eQ, c));
      setEndTextBold(paramAttributeSet.getBoolean(R.styleable.eT, true));
  ...
  private void a(boolean paramBoolean)
  {
    ...
    QCircleTailExpandText.OnExpandCallback localOnExpandCallback = this.m;
  ...
  private void b(SpannableStringBuilder paramSpannableStringBuilder)
  {
    ...
    localValueAnimator.addUpdateListener(new QCircleTailExpandText.2(this));
    localValueAnimator.addListener(new QCircleTailExpandText.3(this, paramSpannableStringBuilder));
  ...
  private void c(SpannableStringBuilder paramSpannableStringBuilder)
  {
    ...
    localValueAnimator.setDuration(this.n);
    localValueAnimator.addUpdateListener(new QCircleTailExpandText.4(this));
    localValueAnimator.addListener(new QCircleTailExpandText.5(this, paramSpannableStringBuilder));
    localValueAnimator.start();
  }
  ...
  private SpannableString getEndSpannable()
  {
    ...
    Object localObject2 = QCircleSkinHelper.getInstance();
    int i1;
    if (this.i) {
      i1 = this.s;
    } else {
    ...
    localObject2 = new ForegroundColorSpan(((QCircleSkinHelper)localObject2).getColor(i1));
    setHighlightColor(0);
    ((SpannableString)localObject1).setSpan(new QCircleTailExpandText.1(this), 0, ((SpannableString)localObject1).length(), 17);
    setMovementMethod(LinkMovementMethod.getInstance());
    ((SpannableString)localObject1).setSpan(localObject2, 0, ((SpannableString)localObject1).length(), 17);
    return localObject1;
  }
  ...
  public void setOnExpandCallback(QCircleTailExpandText.OnExpandCallback paramOnExpandCallback)
  {
 ...
 * Qualified Name:     com.tencent.biz.qqcircle.widgets.textview.QCircleTailExpandText
