...
class QCircleLightInteractPushWidget$1
  implements View.OnClickListener
{
  QCircleLightInteractPushWidget$1(QCircleLightInteractPushWidget paramQCircleLightInteractPushWidget, FeedCloudMeta.StUser paramStUser) {}
  ...
  public void onClick(View paramView)
  {
    ...
    localObject = QCirclePluginReportUtil.b((FeedCloudMeta.StFeed)localObject).setActionType(87);
    int i;
    if (paramView == QCircleLightInteractPushWidget.a(this.b)) {
      i = 2;
    } else {
      i = 3;
    }
    QCircleLpReportDc05501.DataBuilder localDataBuilder = ((QCircleLpReportDc05501.DataBuilder)localObject).setSubActionType(i);
 ...
 * Qualified Name:     com.tencent.biz.qqcircle.widgets.QCircleLightInteractPushWidget.1
