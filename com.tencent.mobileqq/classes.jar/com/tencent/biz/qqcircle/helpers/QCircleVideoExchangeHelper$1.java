...
class QCircleVideoExchangeHelper$1
  implements VSDispatchObserver.onVSRspCallBack<QQCircleVideourlexchange.StGetVideoAdaptRsp>
{
  QCircleVideoExchangeHelper$1(QCircleVideoExchangeHelper paramQCircleVideoExchangeHelper, FeedCloudMeta.StVideo paramStVideo, QCircleVideoExchangeHelper.VideoUrlAdapterCallBack paramVideoUrlAdapterCallBack) {}
  ...
  public void a(BaseRequest paramBaseRequest, boolean paramBoolean, long paramLong, String paramString, QQCircleVideourlexchange.StGetVideoAdaptRsp paramStGetVideoAdaptRsp)
  {
    if ((paramBoolean) && (paramLong == 0L) && (paramStGetVideoAdaptRsp.videos.size() > 0))
    {
      ...
      if (paramBaseRequest.playUrl.get().trim().length() > 0)
      {
        ...
        QCircleVideoExchangeHelper.a(this.c).put(this.a.fileId.get(), paramBaseRequest);
 ...
 * Qualified Name:     com.tencent.biz.qqcircle.helpers.QCircleVideoExchangeHelper.1
