...
public class QFSBlackStrokeTextView
  extends RFWAsyncRichTextView
{
  private TextView a = null;
  
  public QFSBlackStrokeTextView(Context paramContext)
  {
    this(paramContext, null);
  }
  
  public QFSBlackStrokeTextView(Context paramContext, @Nullable AttributeSet paramAttributeSet)
  {
    this(paramContext, paramAttributeSet, 0);
  }
  
  public QFSBlackStrokeTextView(Context paramContext, @Nullable AttributeSet paramAttributeSet, int paramInt)
  {
    super(paramContext, paramAttributeSet, paramInt);
    this.a = new TextView(getContext(), paramAttributeSet, paramInt);
    setSpecialClickAreaColor(2131165557);
 ...
 * Qualified Name:     com.tencent.biz.qqcircle.immersive.viewmodel.barrage.widgets.QFSBlackStrokeTextView
