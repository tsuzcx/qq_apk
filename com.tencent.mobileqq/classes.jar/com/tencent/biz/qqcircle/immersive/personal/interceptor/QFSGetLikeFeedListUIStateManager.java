...
public class QFSGetLikeFeedListUIStateManager
  extends QFSUIStateBaseManager<FeedBlockData, QFSGetLikeFeedListRequest, FeedCloudRead.StGetFeedListRsp>
{
  private String a;
  private String b;
  ...
  protected void a(QFSGetLikeFeedListRequest paramQFSGetLikeFeedListRequest)
  {
    if (paramQFSGetLikeFeedListRequest != null)
    {
      if (TextUtils.isEmpty(this.a)) {
        return;
      }
      paramQFSGetLikeFeedListRequest.setAttachInfo(this.a);
    }
  }
  ...
  protected void b(QFSGetLikeFeedListRequest paramQFSGetLikeFeedListRequest)
  {
    if (paramQFSGetLikeFeedListRequest != null)
    {
      ...
      paramQFSGetLikeFeedListRequest.setRefreshAttachInfo(this.b);
    }
  }
}
 ...
 * Qualified Name:     com.tencent.biz.qqcircle.immersive.personal.interceptor.QFSGetLikeFeedListUIStateManager
