...
public class QFSFolderFragmentPart
  extends QFSBasePart
  implements IQFSFolderIoc, SimpleEventReceiver
{
  ...
  private int e = 0;
  private QFSHomePageFragment f;
  private QFSFolderRightProfileFragment g;
  
  public QFSFolderFragmentPart(PartManager paramPartManager)
  {
    this.a = paramPartManager;
    QCircleHostGlobalInfo.setFolderUIType(2);
  }
  ...
  private void d()
  {
    this.f = new QFSHomePageFragment();
    this.f.p().a(this.a);
    this.d.add(this.f);
    this.g = new QFSFolderRightProfileFragment();
    this.d.add(this.g);
  }
  
  private void e()
  {
    this.b.addOnPageChangeListener(new QFSFolderFragmentPart.1(this));
  }
  ...
  public void a(String paramString, Object paramObject)
  {
    ...
    if ("qfs_set_folder_viewpage_scrollable".equals(paramString)) {
      a(new Object[] { paramObject });
    }
  }
  ...
  public boolean ah_()
  {
    ...
    if (((QFSViewPager)localObject).getCurrentItem() != 0)
    {
 ...
 * Qualified Name:     com.tencent.biz.qqcircle.immersive.part.folder.QFSFolderFragmentPart
