...
class QCircleTagPreLoaderTask$1
  implements VSDispatchObserver.onVSRspCallBack<FeedCloudRead.StGetFeedListRsp>
{
  QCircleTagPreLoaderTask$1(QCircleTagPreLoaderTask paramQCircleTagPreLoaderTask, OnPreLoadListener paramOnPreLoadListener) {}
  ...
  public void a(BaseRequest paramBaseRequest, boolean paramBoolean, long paramLong, String paramString, FeedCloudRead.StGetFeedListRsp paramStGetFeedListRsp)
  {
    ...
    localStringBuilder.append("QCircleTagPreLoaderTask->onReceive: dispatch Success:");
    ...
    QLog.d("QCircleTagPreLoaderTask", 1, localStringBuilder.toString());
 ...
 * Qualified Name:     com.tencent.biz.qqcircle.preload.task.QCircleTagPreLoaderTask.1
