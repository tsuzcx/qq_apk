  ...
  implements Runnable
{
  ...
  public void run()
  {
    Object localObject = new ArrayList(Arrays.asList(new FeedCloudCommon.Entry[] { tzy.a("touin", this.jdField_a_of_type_JavaLangString), tzy.a("actiontype", String.valueOf(this.jdField_a_of_type_Int)), tzy.a("subactiontype", String.valueOf(this.jdField_b_of_type_Int)), tzy.a("feedid", this.jdField_b_of_type_JavaLangString), tzy.a("author_uin", this.jdField_c_of_type_JavaLangString), tzy.a("play_scene", String.valueOf(this.jdField_c_of_type_Int)), tzy.a("page_id", String.valueOf(this.jdField_d_of_type_Int)), tzy.a("fpage_id", String.valueOf(this.jdField_e_of_type_Int)), tzy.a("position_id", String.valueOf(this.jdField_f_of_type_Int + 1)), tzy.a("feed_tag", this.jdField_d_of_type_JavaLangString), tzy.a("video_tag", this.jdField_e_of_type_JavaLangString), tzy.a("pic_info", this.jdField_f_of_type_JavaLangString), tzy.a("item_detail", this.jdField_g_of_type_JavaLangString), tzy.a("acttime", String.valueOf(System.currentTimeMillis())), tzy.a("lloc", this.jdField_h_of_type_JavaLangString) }));
    ...
    for (;;)
    {
      ...
      if (i == 0) {
        ((List)localObject).addAll(Arrays.asList(new FeedCloudCommon.Entry[] { tzy.a("feedtype1", String.valueOf(this.jdField_g_of_type_Int)), tzy.a("feedtype2", String.valueOf(this.jdField_h_of_type_Int)) }));
      }
      ((List)localObject).addAll(tzy.a().a());
      localObject = tzy.a(tzw.a(), (List)localObject, null, tzy.a().a(this.jdField_d_of_type_Int, this.jdField_a_of_type_FeedcloudFeedCloudMeta$StFeed));
      if (tzy.a().a())
      {
