...
public class QCircleVideoReporter
{
  ...
  public static QCircleVideoReporter a()
  {
    return QCircleVideoReporter.SingleHolder.a;
  }
  ...
  {
    FeedCloudCommon.Entry localEntry1 = QCircleReportHelper.newEntry("host_uin", String.valueOf(QCirclePluginUtil.c()));
    FeedCloudCommon.Entry localEntry2 = QCircleReportHelper.newEntry("qua", HostDataTransUtils.getQUA3());
    ...
    paramString = new ArrayList(Arrays.asList(new FeedCloudCommon.Entry[] { localEntry1, localEntry2, localEntry3, localEntry4, paramString, QCircleReportHelper.newEntry("mobile_type", localStringBuilder.toString()), QCircleReportHelper.newEntry("version", QCircleHostConstants._AppSetting.reportVersionName()), QCircleReportHelper.newEntry("platform", "AND"), QCircleReportHelper.newEntry("video_play_id", String.valueOf(paramLong)), QCircleReportHelper.newEntry("unique_id", String.valueOf(d())) }));
  ...
  {
    QCircleReporter.getInstance().getReportHandler().post(new QCircleVideoReporter.1(this, paramObject, paramLong, paramString, paramList));
  }
  
  public void e()
  {
    QCircleReporter.getInstance().getReportHandler().post(new QCircleVideoReporter.2(this));
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes3.jar
 * Qualified Name:     com.tencent.biz.qqcircle.report.QCircleVideoReporter
