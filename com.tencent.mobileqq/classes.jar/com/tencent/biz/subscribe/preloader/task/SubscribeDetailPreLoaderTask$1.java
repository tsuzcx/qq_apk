  ...
  implements VSDispatchObserver.onVSRspCallBack<CertifiedAccountRead.StGetFeedDetailRsp>
{
  ...
  public void a(BaseRequest paramBaseRequest, boolean paramBoolean, long paramLong, String paramString, CertifiedAccountRead.StGetFeedDetailRsp paramStGetFeedDetailRsp)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqEngineeringPreloadInterOnPreLoadListener != null) {
      this.jdField_a_of_type_ComTencentMobileqqEngineeringPreloadInterOnPreLoadListener.onLoaded(new Object[] { Boolean.valueOf(paramBoolean), Long.valueOf(paramLong), paramString, paramStGetFeedDetailRsp });
    }
  }
}
