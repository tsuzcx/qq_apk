...
public class SimpleEventBus$1$1
  implements Runnable
{
  public SimpleEventBus$1$1(wpx paramwpx, String paramString, Bundle paramBundle) {}
  
  public void run()
  {
    QLog.d("SimpleEventBus", 4, "onServerCall action" + this.jdField_a_of_type_JavaLangString);
    if (wpw.b.equals(this.jdField_a_of_type_JavaLangString)) {
      if (this.jdField_a_of_type_AndroidOsBundle != null)
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject)) {
          this.jdField_a_of_type_Wpx.a.a(new PraisedUpdateEvents((String)localObject, i, j));
        }
      }
    }
    while (!wpw.c.equals(this.jdField_a_of_type_JavaLangString))
    {
      int i;
      int j;
      return;
    ...
    this.jdField_a_of_type_Wpx.a.a((SimpleBaseEvent)localObject);
  }
}
