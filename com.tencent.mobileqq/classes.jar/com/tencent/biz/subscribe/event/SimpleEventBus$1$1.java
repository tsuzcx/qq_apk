...
public class SimpleEventBus$1$1
  implements Runnable
{
  public SimpleEventBus$1$1(yix paramyix, String paramString, Bundle paramBundle) {}
  
  public void run()
  {
    QLog.d("SimpleEventBus", 4, "onServerCall action" + this.jdField_a_of_type_JavaLangString);
    if (yiw.b.equals(this.jdField_a_of_type_JavaLangString)) {
      if (this.jdField_a_of_type_AndroidOsBundle != null)
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject)) {
          this.jdField_a_of_type_Yix.a.a(new PraisedUpdateEvents((String)localObject, i, j));
        }
      }
    }
    while (!yiw.c.equals(this.jdField_a_of_type_JavaLangString))
    {
      int i;
      int j;
      return;
    ...
    this.jdField_a_of_type_Yix.a.a((SimpleBaseEvent)localObject);
  }
}
