...
public class Patterns
{
  ...
  static
  {
    ...
    jdField_a_of_type_ArrayOfInt = new int[] { 2130839771, 2130839781, 2130839778, 2130839772, 2130839773, 2130839768, 2130839774, 2130839777, 2130839776, 2130839779, 2130839780, 2130837868, 2130837869, 2130837870, 2130837872, 2130837876, 2130837878, 2130837879, 2130837880, 2130837883, 2130837890, 2130837900, 2130837901, 2130839787, 2130839791, 2130839783, 2130839784, 2130839789, 2130839786, 2130839792, 2130839750, 2130839753, 2130839754, 2130839755, 2130839756, 2130839757, 2130839758, 2130839759, 2130839760, 2130839761, 2130839762, 2130839763, 2130839764, 2130839766, 2130839767 };
  ...
  private static void a()
  {
    ...
    for (;;)
    {
      ...
      jdField_a_of_type_JavaUtilHashMap.put(arrayOfString[j], Integer.valueOf(j));
      j += 1;
    }
  }
  ...
  private static void b()
  {
    if (jdField_b_of_type_JavaUtilHashMap == null)
    {
      ...
      for (;;)
      {
        ...
        jdField_b_of_type_JavaUtilHashMap.put(arrayOfString[j], Integer.valueOf(j));
        j += 1;
      }
    }
  }
