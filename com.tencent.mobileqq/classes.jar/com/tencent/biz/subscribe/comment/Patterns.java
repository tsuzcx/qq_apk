...
public class Patterns
{
  ...
  public static int b(String paramString)
  {
    ...
    {
      paramString = (Integer)r.get(paramString);
      if (paramString == null) {
        return -2;
      }
      return paramString.intValue();
  ...
  private static void b()
  {
    if (r == null)
    {
      ...
      for (;;)
      {
        ...
        r.put(arrayOfString[i1], Integer.valueOf(i1));
        i1 += 1;
      }
    }
  }
 ...
 * Qualified Name:     com.tencent.biz.subscribe.comment.Patterns
