  ...
  implements SimpleEventReceiver
{
  ...
  private String a(CertifiedAccountMeta.StComment paramStComment, CertifiedAccountMeta.StReply paramStReply)
  {
    if (paramStReply != null)
    {
      ...
      paramStReply = String.format(getContext().getString(2131692316), new Object[] { paramStReply.postUser.nick.get() });
    ...
    do
    {
      ...
      paramStReply = String.format(getContext().getString(2131692316), new Object[] { paramStComment.postUser.nick.get() });
      paramStComment = paramStReply;
  ...
  private void a(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setBackgroundResource(2130839182);
    if (paramBoolean) {}
    for (ScaleAnimation localScaleAnimation = new ScaleAnimation(0.0F, 1.0F, 0.0F, 1.0F, 1, 0.5F, 1, 0.5F);; localScaleAnimation = new ScaleAnimation(1.0F, 0.0F, 1.0F, 0.0F, 1, 0.5F, 1, 0.5F))
    {
      ...
      localScaleAnimation.setAnimationListener(new CommentBottomBar.6(this, paramBoolean));
  ...
  private void c(int paramInt)
  {
    ...
    label35:
    for (paramInt = 2130839173;; paramInt = 2130839174)
    {
  ...
  private void f()
  {
    ...
    setGravity(16);
    LayoutInflater.from(getContext()).inflate(2131558877, this);
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131369755));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131380187));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131369807));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131369622));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131369621));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131369757));
  ...
  private void h()
  {
    ...
    a(getContext().getString(2131701567));
  }
  
  private void i()
  {
    this.jdField_a_of_type_AndroidWidgetImageView.setBackgroundResource(2130847884);
  ...
  public void a()
  {
    if (this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentPresenter != null) {
      this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentPresenter.h();
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    if (paramInt > 0)
    {
      this.jdField_b_of_type_AndroidWidgetTextView.setText(Formatter.a(paramInt));
  ...
  {
    if (this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentPresenter != null) {
      this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentPresenter.a(paramStFeed);
    }
  }
  ...
  public void b()
  {
    ...
    {
      QQToast.a(getContext(), HardCodeUtil.a(2131702226), 0).a();
      return;
    }
    ...
    VSNetworkHelper.getInstance().sendRequest(localDoLikeRequest, new CommentBottomBar.5(this));
  }
  ...
  public void b(int paramInt)
  {
    ...
    if (paramInt > 0)
    {
      this.jdField_c_of_type_AndroidWidgetTextView.setText(Formatter.a(paramInt));
  ...
  {
    if (this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentPresenter != null) {
      return this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentPresenter.b();
    }
    return false;
  }
  ...
  {
    if (this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentPresenter != null) {
      this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentPresenter.f();
    }
  ...
  public boolean c()
  {
    return (this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentPresenter != null) && (this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentPresenter.c());
  }
  ...
  public boolean d()
  {
    return (this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentPresenter != null) && (this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentPresenter.d());
  }
