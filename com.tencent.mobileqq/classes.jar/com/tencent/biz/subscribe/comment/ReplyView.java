  ...
  implements View.OnClickListener, View.OnLongClickListener
{
  ...
  private final String jdField_b_of_type_JavaLangString = ajjy.a(2131647621);
  TextView c;
  TextView d;
  ...
  private void a()
  {
    View localView = LayoutInflater.from(getContext()).inflate(2131493160, this, true);
    this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeDiscoverRoundCornerImageView = ((RoundCornerImageView)localView.findViewById(2131302880));
    this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeDiscoverRoundCornerImageView.setCorner(ImmersiveUtils.a(18.0F));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131309392));
    this.jdField_a_of_type_ComTencentBizSubscribeWidgetTextviewAsyncRichTextView = ((AsyncRichTextView)localView.findViewById(2131309390));
    this.jdField_a_of_type_ComTencentBizSubscribeWidgetTextviewAsyncRichTextView.setNeedParseColor(true);
    this.c = ((TextView)localView.findViewById(2131309391));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131298080));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)localView.findViewById(2131309385));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131309384));
    this.d = ((TextView)localView.findViewById(2131309386));
  ...
  public void onClick(View paramView)
  {
    ...
    {
    default: 
      if ((((paramView instanceof ReplyView)) || (paramView.getId() == 2131298080)) && (this.jdField_a_of_type_Wbf != null))
      {
        ...
        this.jdField_a_of_type_Wbf.a(paramView, 7, this.jdField_a_of_type_Int, new Object[] { localStComment, localStReply });
      }
      break;
    }
    do
    {
      do
      {
        ...
        {
          return;
        } while ((this.jdField_a_of_type_Wbf == null) || (this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StReply == null));
        this.jdField_a_of_type_Wbf.a(paramView, 1, this.jdField_a_of_type_Int, this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StReply.postUser);
        return;
      } while ((this.jdField_a_of_type_Wbf == null) || (this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StReply == null));
      this.jdField_a_of_type_Wbf.a(paramView, 2, this.jdField_a_of_type_Int, this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StReply.postUser);
      return;
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    CertifiedAccountMeta.StComment localStComment = this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StComment;
    CertifiedAccountMeta.StReply localStReply = this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StReply;
    this.jdField_a_of_type_Wbf.b(paramView, 8, this.jdField_a_of_type_Int, new Object[] { localStComment, localStReply });
    return true;
  }
  ...
  public void setData(CertifiedAccountMeta.StComment paramStComment, CertifiedAccountMeta.StReply paramStReply, String paramString)
  {
    ...
    {
      if ((BaseApplicationImpl.getApplication().getRuntime().getAccount().equals(paramStReply.postUser.id.get())) && (baip.a(paramStReply.postUser.icon.get())))
      {
        if (this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable == null) {
          this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable = new BitmapDrawable(bacm.c(wbd.a(wbd.a(null, 1, paramStReply.postUser.id.get(), 0)).a, 50, 50));
        }
        vms.a(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeDiscoverRoundCornerImageView, "", vms.a(getContext(), 35.0F), vms.a(getContext(), 35.0F), vms.a(getContext(), 18.0F), this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable, null);
    ...
    else
    {
      ...
      {
        paramString.append("{text:").append(this.jdField_b_of_type_JavaLangString).append(",color:").append(Integer.toHexString(getResources().getColor(2131101422))).append(",useDefaultFont:1,useSuperFont:0}");
        paramString.append(a(paramStReply.targetUser.id.get(), paramStReply.targetUser.nick.get()));
        paramString.append("{text:").append("：").append(",color:").append(Integer.toHexString(getResources().getColor(2131101423))).append(",useDefaultFont:1,useSuperFont:0}");
      }
      ...
      this.c.setText(was.a(paramStReply.createTime.get() * 1000L));
    ...
    for (int i = 0;; i = 8)
    {
      ...
      return;
      vms.a(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeDiscoverRoundCornerImageView, paramStReply.postUser.icon.get(), vms.a(getContext(), 22.0F), vms.a(getContext(), 22.0F), vms.a(getContext(), 11.0F), bacm.b(), null);
      break;
