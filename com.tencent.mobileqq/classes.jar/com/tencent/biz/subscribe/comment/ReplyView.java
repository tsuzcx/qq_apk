  ...
  implements View.OnClickListener, View.OnLongClickListener
{
  ...
  private final String jdField_b_of_type_JavaLangString = amtj.a(2131712524);
  TextView c;
  TextView d;
  ...
  private void a()
  {
    View localView = LayoutInflater.from(getContext()).inflate(2131558823, this, true);
    ...
    this.jdField_a_of_type_ComTencentBizSubscribeWidgetTextviewAsyncRichTextView = ((AsyncRichTextView)localView.findViewById(2131376293));
    this.jdField_a_of_type_ComTencentBizSubscribeWidgetTextviewAsyncRichTextView.setNeedParseColor(true);
    this.c = ((TextView)localView.findViewById(2131376294));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131363939));
    ...
    this.d = ((TextView)localView.findViewById(2131376289));
  ...
  public void onClick(View paramView)
  {
    ...
    {
    default: 
      if ((((paramView instanceof ReplyView)) || (paramView.getId() == 2131363939)) && (this.jdField_a_of_type_Zgz != null))
      {
        ...
        this.jdField_a_of_type_Zgz.a(paramView, 7, this.jdField_a_of_type_Int, new Object[] { localStComment, localStReply });
      }
      break;
    }
    for (;;)
    {
      ...
      return;
      if ((this.jdField_a_of_type_Zgz != null) && (this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StReply != null))
      {
        this.jdField_a_of_type_Zgz.a(paramView, 1, this.jdField_a_of_type_Int, this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StReply.postUser);
        continue;
        if ((this.jdField_a_of_type_Zgz != null) && (this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StReply != null))
        {
          this.jdField_a_of_type_Zgz.a(paramView, 2, this.jdField_a_of_type_Int, this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StReply.postUser);
          continue;
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    {
      return bool;
    } while (this.jdField_a_of_type_Zgz == null);
    ...
    this.jdField_a_of_type_Zgz.b(paramView, 8, this.jdField_a_of_type_Int, new Object[] { localStComment, localStReply });
    return true;
  }
  ...
  public void setData(CertifiedAccountMeta.StComment paramStComment, CertifiedAccountMeta.StReply paramStReply, String paramString)
  {
    ...
    if (paramStReply.postUser != null)
    {
      if ((BaseApplicationImpl.getApplication().getRuntime().getAccount().equals(paramStReply.postUser.id.get())) && (StringUtil.isEmpty(paramStReply.postUser.icon.get())))
      {
        if (this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable == null) {
          this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable = new BitmapDrawable(bfvo.c(zgx.a(zgx.a(null, 1, paramStReply.postUser.id.get(), 0)).a, 50, 50));
        }
        UIUtils.setRoundCornerViewByURL(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeDiscoverRoundCornerImageView, "", UIUtils.dip2px(getContext(), 35.0F), UIUtils.dip2px(getContext(), 35.0F), UIUtils.dip2px(getContext(), 18.0F), this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable, null);
    ...
    else
    {
      ...
      {
        paramString.append("{text:").append(this.jdField_b_of_type_JavaLangString).append(",color:").append(Integer.toHexString(getResources().getColor(2131167195))).append(",useDefaultFont:1,useSuperFont:0}");
        paramString.append(a(paramStReply.targetUser.id.get(), paramStReply.targetUser.nick.get()));
        paramString.append("{text:").append("：").append(",color:").append(Integer.toHexString(getResources().getColor(2131167196))).append(",useDefaultFont:1,useSuperFont:0}");
      }
      ...
      this.c.setText(zgm.a(paramStReply.createTime.get() * 1000L));
    ...
    for (int i = 0;; i = 8)
    {
      ...
      return;
      UIUtils.setRoundCornerViewByURL(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeDiscoverRoundCornerImageView, paramStReply.postUser.icon.get(), UIUtils.dip2px(getContext(), 22.0F), UIUtils.dip2px(getContext(), 22.0F), UIUtils.dip2px(getContext(), 11.0F), bfvo.b(), null);
      break;
