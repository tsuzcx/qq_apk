...
public class DateUtils
{
  ...
  public static String a(long paramLong)
  {
    ...
    try
    {
      localObject1 = BaseApplicationImpl.getContext().getString(2131918185);
      String str1 = BaseApplicationImpl.getContext().getString(2131918186);
      str2 = BaseApplicationImpl.getContext().getString(2131918184);
    }
    catch (Exception localException)
    {
      localObject1 = HardCodeUtil.a(2131900988);
      QZLog.d(e, 1, localException, new Object[0]);
      str2 = "%d小时前";
      localObject2 = "%d分钟前";
    }
