...
{
  private static final String jdField_a_of_type_JavaLangString = DateUtils.class.getSimpleName();
  ...
  public static String a(long paramLong)
  {
    ...
    try
    {
      str = BaseApplicationImpl.getContext().getString(2131720760);
      localObject2 = BaseApplicationImpl.getContext().getString(2131720761);
      localObject1 = BaseApplicationImpl.getContext().getString(2131720759);
    ...
    catch (Exception localException)
    {
      ...
      for (;;)
      {
        String str = HardCodeUtil.a(2131702883);
        localObject2 = "%d分钟前";
        localObject1 = "%d小时前";
