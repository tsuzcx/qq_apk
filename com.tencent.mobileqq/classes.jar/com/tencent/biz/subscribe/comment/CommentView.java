  ...
  implements View.OnClickListener, View.OnLongClickListener
{
  ...
  private void a()
  {
    View localView = LayoutInflater.from(getContext()).inflate(2131558814, this, true);
    ...
    this.jdField_a_of_type_ComTencentBizSubscribeWidgetTextviewAsyncRichTextView = ((AsyncRichTextView)localView.findViewById(2131372901));
    this.jdField_a_of_type_ComTencentBizSubscribeCommentReplyContainer = ((ReplyContainer)localView.findViewById(2131376512));
    ...
    this.jdField_a_of_type_Aajn = new aajn();
    this.jdField_a_of_type_Aajn.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)localView.findViewById(2131377621));
    this.jdField_a_of_type_Aajn.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131364811));
    this.jdField_a_of_type_Aajn.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131371416));
    this.jdField_a_of_type_Aajn.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)localView.findViewById(2131363857));
    this.jdField_a_of_type_Aajn.c = ((TextView)localView.findViewById(2131363914));
    this.jdField_a_of_type_Aajn.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131365640));
  }
  
  private void a(CertifiedAccountMeta.StComment paramStComment, boolean paramBoolean)
  {
    if ((this.jdField_a_of_type_Aajn != null) && (this.jdField_a_of_type_Aajn.jdField_b_of_type_AndroidWidgetLinearLayout != null))
    {
      if ((!paramBoolean) || (paramStComment == null) || (paramStComment.vecReply.size() <= 0)) {
        break label129;
      }
      String str = aajo.a(paramStComment.createTime.get() * 1000L);
      this.jdField_a_of_type_Aajn.jdField_b_of_type_AndroidWidgetLinearLayout.setVisibility(0);
      this.jdField_a_of_type_Aajn.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      this.jdField_a_of_type_Aajn.jdField_a_of_type_AndroidWidgetTextView.setText(str);
      if (paramStComment.vecReply.size() > 0) {
        this.jdField_a_of_type_Aajn.jdField_b_of_type_AndroidWidgetTextView.setText(paramStComment.replyCount + anzj.a(2131701128));
      }
    }
    return;
    label129:
    this.jdField_a_of_type_Aajn.jdField_b_of_type_AndroidWidgetLinearLayout.setVisibility(8);
    this.jdField_a_of_type_Aajn.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      return;
      if ((this.jdField_a_of_type_Aakb != null) && (this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StComment != null))
      {
        this.jdField_a_of_type_Aakb.a(paramView, 1, this.jdField_a_of_type_Int, this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StComment.postUser);
        continue;
        if ((this.jdField_a_of_type_Aakb != null) && (this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StComment != null))
        {
          this.jdField_a_of_type_Aakb.a(paramView, 2, this.jdField_a_of_type_Int, this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StComment.postUser);
          continue;
          if (this.jdField_a_of_type_Aakb != null) {
            this.jdField_a_of_type_Aakb.a(paramView, 4, this.jdField_a_of_type_Int, this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StComment);
          }
        }
      }
    }
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    if (this.jdField_a_of_type_Aakb != null) {
      this.jdField_a_of_type_Aakb.b(paramView, 5, this.jdField_a_of_type_Int, this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StComment);
    }
    return true;
  }
  ...
  public void setData(CertifiedAccountMeta.StComment paramStComment, int paramInt, String paramString)
  {
    ...
    {
      if ((BaseApplicationImpl.getApplication().getRuntime().getAccount().equals(paramStComment.postUser.id.get())) && (bhsr.a(paramStComment.postUser.icon.get())))
      {
        if (this.jdField_b_of_type_AndroidGraphicsDrawableDrawable == null) {
          this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = new BitmapDrawable(bhmq.c(aajz.a(aajz.a(null, 1, paramStComment.postUser.id.get(), 0)).a, 50, 50));
        }
    ...
    else
    {
      ...
      this.jdField_a_of_type_Aajn.jdField_a_of_type_AndroidWidgetTextView.setText(aajo.a(paramStComment.createTime.get() * 1000L));
    ...
    for (paramInt = 0;; paramInt = 8)
    {
      ...
      return;
      zps.a(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeDiscoverRoundCornerImageView, paramStComment.postUser.icon.get(), zps.a(getContext(), 35.0F), zps.a(getContext(), 35.0F), zps.a(getContext(), 18.0F), bhmq.b(), null);
      break;
  ...
  public void setOnCommentElementClickListener(aakb paramaakb)
  {
    ...
    this.jdField_a_of_type_ComTencentBizSubscribeCommentReplyContainer.setOnCommentElementClickListener(paramaakb);
    if ((this.jdField_a_of_type_Aajn != null) && (this.jdField_a_of_type_Aajn.jdField_b_of_type_AndroidWidgetLinearLayout != null)) {
      this.jdField_a_of_type_Aajn.jdField_b_of_type_AndroidWidgetLinearLayout.setOnClickListener(new aajm(this));
    }
  }
