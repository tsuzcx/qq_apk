  ...
  implements SimpleEventReceiver
{
  ...
  private void b(CertifiedAccountMeta.StFeed paramStFeed)
  {
    ...
    label88:
    for (int i = 2130839186;; i = 2130839184)
    {
  ...
  public float a(CertifiedAccountMeta.StFeed paramStFeed)
  {
    ...
    for (;;)
    {
      SLog.c("RelativeFeedItemView", "getImageScale()  feed.width:" + paramStFeed.cover.width.get() + "  feed.height:" + paramStFeed.cover.height.get() + "  realHeight=" + f1);
      return f1;
      f1 = f2;
    }
  }
  ...
  protected void a(CertifiedAccountMeta.StFeed paramStFeed)
  {
    ...
    do
    {
      ...
      if (TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        SubImageLoader.a(paramStFeed.cover.url.get(), this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeDiscoverRoundCornerImageView, null, FileUtils.c(paramStFeed.cover.url.get()));
  ...
  public void a(Context paramContext, View paramView)
  {
    ...
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131380351));
    ...
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131380348));
    this.jdField_a_of_type_AndroidViewView = findViewById(2131370694);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131369758));
  }
