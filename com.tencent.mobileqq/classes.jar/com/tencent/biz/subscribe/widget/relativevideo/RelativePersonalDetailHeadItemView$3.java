  ...
  implements Runnable
{
  ...
  public void run()
  {
    if ((!RelativePersonalDetailHeadItemView.a(this.this$0)) || (this.a.taskCount <= 0))
    {
      ...
      yqp.c("RelativePersonalDetailH", "updateUploadBoxStatus  PublishBoxStatusEvent  GONE");
      return;
    }
    ...
    yqp.c("RelativePersonalDetailH", "updateUploadBoxStatus  PublishBoxStatusEvent  VISIBLE  taskCount = " + this.a.taskCount + "  hasRunningTask:" + this.a.hasRunningTask + "  hasOfflineWaitingTask:" + this.a.hasOfflineWaitingTask);
    if (this.a.hasRunningTask)
    {
      RelativePersonalDetailHeadItemView.a(this.this$0);
      RelativePersonalDetailHeadItemView.b(this.this$0).setBackgroundResource(2130850392);
    ...
    if (this.a.hasOfflineWaitingTask)
    {
      ...
      RelativePersonalDetailHeadItemView.b(this.this$0).setBackgroundResource(2130848639);
      RelativePersonalDetailHeadItemView.b(this.this$0).setText("");
      return;
    }
    RelativePersonalDetailHeadItemView.b(this.this$0);
    RelativePersonalDetailHeadItemView.b(this.this$0).setBackgroundResource(2130848638);
    RelativePersonalDetailHeadItemView.b(this.this$0).setText("");
  }
}
