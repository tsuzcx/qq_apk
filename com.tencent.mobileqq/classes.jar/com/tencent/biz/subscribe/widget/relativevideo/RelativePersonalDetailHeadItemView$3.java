  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    SLog.c("RelativePersonalDetailH", "updateUploadBoxStatus  PublishBoxStatusEvent  VISIBLE  taskCount = " + this.a.taskCount + "  hasRunningTask:" + this.a.hasRunningTask + "  hasOfflineWaitingTask:" + this.a.hasOfflineWaitingTask);
    if (this.a.hasRunningTask)
    {
      RelativePersonalDetailHeadItemView.a(this.this$0);
      RelativePersonalDetailHeadItemView.b(this.this$0).setBackgroundResource(2130850834);
    ...
    if (this.a.hasOfflineWaitingTask)
    {
      ...
      RelativePersonalDetailHeadItemView.b(this.this$0).setBackgroundResource(2130849041);
      RelativePersonalDetailHeadItemView.b(this.this$0).setText("");
      return;
    }
    RelativePersonalDetailHeadItemView.b(this.this$0);
    RelativePersonalDetailHeadItemView.b(this.this$0).setBackgroundResource(2130849040);
    RelativePersonalDetailHeadItemView.b(this.this$0).setText("");
  }
}
