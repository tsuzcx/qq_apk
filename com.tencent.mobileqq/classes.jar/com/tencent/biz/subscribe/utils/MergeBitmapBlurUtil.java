...
public class MergeBitmapBlurUtil
{
  ...
  private static void b(String paramString, Bitmap paramBitmap, ImageView paramImageView)
  {
    ...
    if (paramBitmap != null)
    {
      localBitmap = ImageUtil.a(paramImageView.getContext(), paramBitmap, 0.25F, 20.0F);
      if (localBitmap != null)
      {
    ...
    for (Object localObject = localBitmap;; localObject = localBitmap.copy(localBitmap.getConfig(), true))
    {
      ...
      localObject = VideoUtils.a(paramBitmap.getWidth(), paramBitmap.getHeight(), paramImageView.getWidth(), paramImageView.getHeight());
