...
public class TopPanelPresenter$1$1
  implements Runnable
{
  public TopPanelPresenter$1$1(aafr paramaafr, CertifiedAccountRead.StGetRecommendUserListRsp paramStGetRecommendUserListRsp, List paramList, boolean paramBoolean) {}
  
  public void run()
  {
    aafp localaafp = aafq.a(this.jdField_a_of_type_Aafr.a);
    ...
    if (localaafp != null)
    {
      localaafp.a((CertifiedAccountMeta.StEntry)localObject1, this.jdField_a_of_type_JavaUtilList, this.jdField_a_of_type_Boolean);
