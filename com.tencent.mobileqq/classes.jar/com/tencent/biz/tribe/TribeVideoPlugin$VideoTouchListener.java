...
class TribeVideoPlugin$VideoTouchListener
  implements View.OnTouchListener
{
  private String jdField_a_of_type_JavaLangString;
  private WeakReference<TribeVideoPlugin> jdField_a_of_type_JavaLangRefWeakReference;
  
  TribeVideoPlugin$VideoTouchListener(TribeVideoPlugin paramTribeVideoPlugin, String paramString)
  {
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    {
      return false;
      Object localObject1 = TribeVideoPlugin.VideoWrapper.a((TribeVideoPlugin.VideoWrapper)TribeVideoPlugin.a(paramView).get(this.jdField_a_of_type_JavaLangString));
      if ((localObject1 != null) && (TribeVideoPlugin.VideoLayoutHolder.a((TribeVideoPlugin.VideoLayoutHolder)localObject1) == 2))
      {
        ...
        if ((Math.abs(TribeVideoPlugin.a(paramView).y - TribeVideoPlugin.b(paramView).y) < 8) && (Math.abs(TribeVideoPlugin.a(paramView).x - TribeVideoPlugin.b(paramView).x) < 8))
        {
          ...
          while (((Iterator)localObject1).hasNext())
          {
            ...
            Object localObject2 = TribeVideoPlugin.VideoWrapper.a((TribeVideoPlugin.VideoWrapper)TribeVideoPlugin.a(paramView).get(str));
            SeekBar localSeekBar = TribeVideoPlugin.VideoLayoutHolder.a(TribeVideoPlugin.VideoWrapper.a((TribeVideoPlugin.VideoWrapper)TribeVideoPlugin.a(paramView).get(str)));
 ...
 * Qualified Name:     com.tencent.biz.tribe.TribeVideoPlugin.VideoTouchListener
