...
class TribeVideoPlugin$UIHandler
  extends Handler
{
  private WeakReference<TribeVideoPlugin> a;
  
  public TribeVideoPlugin$UIHandler(TribeVideoPlugin paramTribeVideoPlugin)
  {
          ...
          do
          {
            do
            {
              ...
              case 2: 
                ...
                return;
              case 3: 
                paramMessage = (TribeVideoPlugin.VideoWrapper)TribeVideoPlugin.a(localTribeVideoPlugin).get((String)localObject);
              }
            } while ((paramMessage == null) || (TribeVideoPlugin.VideoWrapper.c(paramMessage)));
            if (QLog.isColorLevel()) {
              QLog.d("TribeVideoPlugin", 2, "sdk player is not prepared");
            }
            TribeVideoPlugin.a(localTribeVideoPlugin, (String)localObject, 5);
            TribeVideoPlugin.VideoWrapper.b(paramMessage, true);
            return;
            paramMessage = (TribeVideoPlugin.VideoWrapper)TribeVideoPlugin.a(localTribeVideoPlugin).get((String)localObject);
          } while (paramMessage == null);
          if ((TribeVideoPlugin.a(localTribeVideoPlugin) == 0) && (!TribeVideoPlugin.a(localTribeVideoPlugin)))
          {
            QLog.d("TribeVideoPlugin", 2, "MSG_SHOW_PLAYER_LAYOUT plugin.mPlayMode == PARAM_RESULT_PLAY_FRONT videoWrapper.mPlayerID = " + TribeVideoPlugin.VideoWrapper.a(paramMessage));
            TribeVideoPlugin.a(localTribeVideoPlugin).bringToFront();
            TribeVideoPlugin.a(localTribeVideoPlugin, true);
          }
          TribeVideoPlugin.a(localTribeVideoPlugin, TribeVideoPlugin.VideoWrapper.a(paramMessage), 1);
          return;
          paramMessage = (TribeVideoPlugin.VideoWrapper)TribeVideoPlugin.a(localTribeVideoPlugin).get((String)localObject);
        } while (paramMessage == null);
 ...
 * Qualified Name:     com.tencent.biz.tribe.TribeVideoPlugin.UIHandler
