...
class TroopRedTouchHandler$7
  implements BusinessObserver
{
  TroopRedTouchHandler$7(TroopRedTouchHandler paramTroopRedTouchHandler) {}
        ...
        if ((paramBundle.uint32_result.has()) && (paramBundle.uint32_result.get() == 0) && (paramBundle.bytes_bodybuffer.has()))
        {
          ...
          if (localObject != null)
          {
            ...
            if ((!TextUtils.isEmpty(paramBundle)) && (QLog.isColorLevel()))
            {
              ...
              ((StringBuilder)localObject).append("setRedDotInfo failed result is:");
 ...
 * Qualified Name:     com.tencent.biz.TroopRedpoint.TroopRedTouchHandler.7
