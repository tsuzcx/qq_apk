...
public class AuthorizeConfig$2
  implements Runnable
{
  public AuthorizeConfig$2(nko paramnko, boolean paramBoolean) {}
  ...
  public void run()
  {
    ...
    try
    {
      ...
      if ((!TextUtils.isEmpty((CharSequence)localObject1)) && ("2013 8.4.8".equals(str3)))
      {
      ...
      {
        ((mobileqq_mp.WebviewWhiteListRequset)localObject4).qqversion.set("8.4.8");
        ...
        localObject1 = new NewIntent(this.this$0.jdField_a_of_type_AndroidContentContext, nma.class);
    ...
    catch (InterruptedException localInterruptedException)
    {
      try
      {
        ...
        ((NewIntent)localObject1).setObserver(new nkp(this));
      ...
      for (;;)
      {
        try
        {
          ...
          if (localObject3 != null)
          {
            ...
            bcef.b(null, "P_CliOper", "Pb_account_lifeservice", "", "webview_whitelist", "update_success", 1, 1, 0, "", "", "", "");
          }
        }
        catch (Exception localException2)
        {
          ...
          this.this$0.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(0);
          bcef.b(null, "P_CliOper", "Pb_account_lifeservice", "", "webview_whitelist", "update_failed", 1, 1, 0, "", "", "", "");
          return;
        }
    ...
    bcef.b(null, "P_CliOper", "Pb_account_lifeservice", "", "webview_whitelist", "update_not_modify", 1, 1, 0, "", "", "", "");
  }
}
