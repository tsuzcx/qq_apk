...
public class AuthorizeConfig$2
  implements Runnable
{
  public AuthorizeConfig$2(mvs parammvs, boolean paramBoolean) {}
  ...
  public void run()
  {
    ...
    try
    {
      ...
      if ((!TextUtils.isEmpty((CharSequence)localObject1)) && ("2013 8.3.0".equals(str3)))
      {
      ...
      {
        ((mobileqq_mp.WebviewWhiteListRequset)localObject4).qqversion.set("8.3.0");
        ...
        localObject1 = new NewIntent(this.this$0.jdField_a_of_type_AndroidContentContext, mxe.class);
    ...
    catch (InterruptedException localInterruptedException)
    {
      try
      {
        ...
        ((NewIntent)localObject1).setObserver(new mvt(this));
    ...
    do
    {
      for (;;)
      {
        try
        {
          localObject3 = naj.a(this.this$0.jdField_a_of_type_AndroidContentContext, (String)localObject4, (String)localObject3, "GET", null, (Bundle)localObject2);
          if (localObject3 != null)
          {
            ...
            localObject2 = null;
            localObject3 = naj.a((HttpResponse)localObject3);
            this.this$0.a((String)localObject3, (String)localObject2, "lastMod");
            axqy.b(null, "P_CliOper", "Pb_account_lifeservice", "", "webview_whitelist", "update_success", 1, 1, 0, "", "", "", "");
          }
        }
        catch (Exception localException2)
        {
          ...
          this.this$0.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(0);
          axqy.b(null, "P_CliOper", "Pb_account_lifeservice", "", "webview_whitelist", "update_failed", 1, 1, 0, "", "", "", "");
          return;
        }
    ...
    axqy.b(null, "P_CliOper", "Pb_account_lifeservice", "", "webview_whitelist", "update_not_modify", 1, 1, 0, "", "", "", "");
  }
}
