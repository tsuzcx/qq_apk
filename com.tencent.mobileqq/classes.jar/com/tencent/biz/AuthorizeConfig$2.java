  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    try
    {
      ...
      if ((!TextUtils.isEmpty((CharSequence)localObject1)) && ("2013 8.5.5".equals(str3)))
      {
      ...
      {
        ((mobileqq_mp.WebviewWhiteListRequset)localObject4).qqversion.set("8.5.5");
