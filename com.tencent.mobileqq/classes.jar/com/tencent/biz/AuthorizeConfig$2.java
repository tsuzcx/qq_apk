...
public class AuthorizeConfig$2
  implements Runnable
{
  public AuthorizeConfig$2(mvv parammvv, boolean paramBoolean) {}
  ...
  public void run()
  {
    ...
    try
    {
      ...
      if ((!TextUtils.isEmpty((CharSequence)localObject1)) && ("2013 8.2.8".equals(str3)))
      {
      ...
      {
        ((mobileqq_mp.WebviewWhiteListRequset)localObject4).qqversion.set("8.2.8");
        ...
        localObject1 = new NewIntent(this.this$0.jdField_a_of_type_AndroidContentContext, mxh.class);
    ...
    catch (InterruptedException localInterruptedException)
    {
      try
      {
        ...
        ((NewIntent)localObject1).setObserver(new mvw(this));
    ...
    do
    {
      for (;;)
      {
        try
        {
          localObject3 = nam.a(this.this$0.jdField_a_of_type_AndroidContentContext, (String)localObject4, (String)localObject3, "GET", null, (Bundle)localObject2);
          if (localObject3 != null)
          {
            ...
            localObject2 = null;
            localObject3 = nam.a((HttpResponse)localObject3);
