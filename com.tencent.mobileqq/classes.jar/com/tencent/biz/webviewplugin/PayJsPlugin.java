  ...
  extends bini
{
      ...
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        if (!TextUtils.isEmpty(paramString))
        {
          ...
          if (QWalletHelper.sFullWindowActivitySource == 1) {
            bdll.b(null, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "index.layila.intopage", 0, 0, "", "", "", "");
          }
  ...
  protected void a()
  {
    ...
    for (Object localObject = ((TicketManager)localObject).getSkey(localQQAppInterface.getCurrentAccountUin());; localObject = null)
    {
      ...
      ((bmgt)localObject).e = "com.qwallet.receiver.QWallPreloadReceiver";
      ((bmgt)localObject).a = localIntent;
      bmgk.b(this.mRuntime.a(), (bmgt)localObject);
      return;
    }
  }
