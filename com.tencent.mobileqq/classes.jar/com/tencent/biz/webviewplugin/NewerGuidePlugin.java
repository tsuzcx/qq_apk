  ...
  extends WebViewPlugin
{
  ...
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new ozs(this);
  private Uri jdField_a_of_type_AndroidNetUri;
  private Client.onRemoteRespObserver jdField_a_of_type_ComTencentMobileqqEmosmClient$onRemoteRespObserver = new ozr(this);
  ...
  private void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    IphonePickerView localIphonePickerView = (IphonePickerView)((Activity)localObject1).getLayoutInflater().inflate(2130970344, null);
    localIphonePickerView.a(new ozx(this, -1));
    ...
    Object localObject2 = (DispatchActionMoveScrollView)((ActionSheet)localObject1).findViewById(2131362787);
    ...
    localIphonePickerView.setPickListener(new ozw(this, localIphonePickerView, (ActionSheet)localObject1));
    this.b = (k - 1897);
    this.c = (j - 1);
    this.d = (i - 1);
  ...
  private void a(String[] paramArrayOfString, int paramInt)
  {
    ...
    IphonePickerView localIphonePickerView = (IphonePickerView)((Activity)localObject).getLayoutInflater().inflate(2130970344, null);
    localIphonePickerView.a(new ozu(this, paramArrayOfString));
    ...
    localObject = (DispatchActionMoveScrollView)paramArrayOfString.findViewById(2131362787);
    ...
    localIphonePickerView.setPickListener(new ozv(this, paramArrayOfString));
  ...
  private void c()
  {
    ...
    localActionSheet.a(new ozt(this, localActivity, localActionSheet));
