...
{
  NewReportPlugin$2(BaseActivity paramBaseActivity, String paramString1, String paramString2, int paramInt, String paramString3, QQProgressDialog paramQQProgressDialog, Bundle paramBundle, long paramLong) {}
  
  public void a(long paramLong1, long paramLong2)
  {
    if (paramLong2 > 0L) {
      NewReportPlugin.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, String.valueOf(paramLong2), this.jdField_a_of_type_JavaLangString, this.b, NewReportPlugin.b(this.jdField_a_of_type_Int), NewReportPlugin.a(this.jdField_a_of_type_Int, this.c), this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog, this.jdField_a_of_type_AndroidOsBundle);
    }
    for (;;)
    {
      ...
      return;
      this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.runOnUiThread(new NewReportPlugin.2.1(this));
    }
  }
}
