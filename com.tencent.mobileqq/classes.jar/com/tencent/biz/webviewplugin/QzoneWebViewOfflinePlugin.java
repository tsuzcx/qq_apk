  ...
  extends WebViewPlugin
{
  ...
  private void a(String... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.mRuntime != null) {}
        for (paramVarArgs = this.mRuntime.a(); QzoneZipCacheHelper.checkAndDownLoadFileIfNeeded(paramVarArgs, str1, str2, str3, i, new QzoneWebViewOfflinePlugin.2(this, str2, str3, str4)); paramVarArgs = null)
        {
  ...
  private void c(String... paramVarArgs)
  {
    ...
    for (localObject1 = localObject1.toString();; localObject1 = null)
    {
      ...
      if (this.jdField_b_of_type_AndroidOsHandler == null) {
        this.jdField_b_of_type_AndroidOsHandler = new QzoneWebViewOfflinePlugin.3(this, Looper.getMainLooper());
      }
  ...
  protected void a(WebSoCgiService.WebSoCgiState paramWebSoCgiState)
  {
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      if ((paramJsBridgeListener.has("proxyUrl")) && (paramJsBridgeListener.has("isCheckCache")))
      {
        ...
        if ((bool) && (!TextUtils.isEmpty(WebSoUtils.d(this.jdField_a_of_type_JavaLangString))))
        {
        ...
        if (this.jdField_a_of_type_AndroidOsHandler == null) {
          this.jdField_a_of_type_AndroidOsHandler = new QzoneWebViewOfflinePlugin.1(this, Looper.getMainLooper());
        }
