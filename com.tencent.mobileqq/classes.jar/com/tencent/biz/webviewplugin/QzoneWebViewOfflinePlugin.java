  ...
  extends WebViewPlugin
{
  ...
  private void a(String... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.mRuntime != null) {}
        for (paramVarArgs = this.mRuntime.a(); QzoneZipCacheHelper.checkAndDownLoadFileIfNeeded(paramVarArgs, str1, str2, str3, i, new phj(this, str2, str3, str4)); paramVarArgs = null)
        {
  ...
  private void c(String... paramVarArgs)
  {
    ...
    for (localObject1 = localObject1.toString();; localObject1 = null)
    {
      ...
      if (this.jdField_b_of_type_AndroidOsHandler == null) {
        this.jdField_b_of_type_AndroidOsHandler = new phk(this, Looper.getMainLooper());
      }
  ...
  protected boolean handleEvent(String paramString, long paramLong, Map paramMap)
  {
    if ((8589934594L == paramLong) || (8589934593L == paramLong)) {
      QzoneHandlerThreadFactory.getHandlerThread("Report_HandlerThread").post(new phl(this, paramString, paramLong));
    }
    return false;
  }
    ...
    try
    {
      ...
      if ((paramJsBridgeListener.has("proxyUrl")) && (paramJsBridgeListener.has("isCheckCache")))
      {
        ...
        if (this.jdField_a_of_type_AndroidOsHandler == null) {
          this.jdField_a_of_type_AndroidOsHandler = new phi(this, Looper.getMainLooper());
        }
