...
public class PubAccountWebViewHttpBridge
{
  ...
  public WebResourceResponse a(String arg1, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        PublicAccountReportUtils.a(null, "", "0X8007775", "0X8007775", 0, 0, this.jdField_c_of_type_Boolean + "", "" + i, localJSONObject.toString(), this.jdField_b_of_type_JavaLangString);
        continue;
  ...
  void a(long paramLong, HttpURLConnection paramHttpURLConnection, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        this.jdField_a_of_type_ComTencentSmttExportExternalInterfacesWebResourceResponse = new WebResourceResponse(a(this.jdField_a_of_type_JavaLangString), "utf-8", new phf(this, (BufferedInputStream)localObject1, (BufferedInputStream)localObject3, (ByteArrayOutputStream)localObject2, paramHttpURLConnection));
        if (!QLog.isColorLevel()) {
          break;
        }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    //   13: return
    //   14: aload_0
    //   15: getfield 51	com/tencent/biz/webviewplugin/PubAccountWebViewHttpBridge:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   18: iconst_0
    //   19: iconst_1
    ...
    //   28: putfield 295	com/tencent/biz/webviewplugin/PubAccountWebViewHttpBridge:jdField_e_of_type_Long	J
    //   31: aload_0
    //   32: aload_1
    //   33: putfield 25	com/tencent/biz/webviewplugin/PubAccountWebViewHttpBridge:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   36: aload_0
    //   37: iload_2
    ...
    //   45: dup
    //   46: aload_0
    //   47: invokespecial 477	phe:<init>	(Lcom/tencent/biz/webviewplugin/PubAccountWebViewHttpBridge;)V
    //   50: ldc 118
    //   52: iconst_5
    ...
    //   56: putfield 359	com/tencent/biz/webviewplugin/PubAccountWebViewHttpBridge:jdField_a_of_type_JavaLangThread	Ljava/lang/Thread;
    ...
    //   86: invokestatic 490	com/tencent/biz/common/util/Util:b	(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    //   98: aload_0
    //   99: getfield 359	com/tencent/biz/webviewplugin/PubAccountWebViewHttpBridge:jdField_a_of_type_JavaLangThread	Ljava/lang/Thread;
