...
public class OfflineWebResManager
{
  ...
  private JSONObject a(String paramString)
  {
    ...
    //   1: astore_2
    //   2: aload_1
    //   3: invokestatic 72	com/tencent/biz/common/offline/OfflineEnvHelper:a	(Ljava/lang/String;)Ljava/lang/String;
    //   6: astore_3
    //   7: aload_3
    //   8: invokestatic 78	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   11: ifeq +5 -> 16
    //   14: aconst_null
    //   15: areturn
    //   16: new 80	java/lang/StringBuilder
    //   19: dup
    //   20: invokespecial 81	java/lang/StringBuilder:<init>	()V
    //   23: aload_3
    ...
    //   38: dup
    //   39: aload_3
    //   40: invokespecial 94	java/io/File:<init>	(Ljava/lang/String;)V
    //   43: invokevirtual 98	java/io/File:exists	()Z
    //   46: ifne +10 -> 56
    //   49: aload_0
    //   50: aload_1
    //   51: invokevirtual 101	com/tencent/biz/webviewplugin/OfflineWebResManager:c	(Ljava/lang/String;)V
    //   54: aconst_null
    //   55: areturn
    //   56: getstatic 106	com/tencent/biz/common/offline/HtmlOffline:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   59: ifnull +42 -> 101
    //   62: getstatic 106	com/tencent/biz/common/offline/HtmlOffline:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   65: aload_1
    //   66: invokevirtual 112	java/util/concurrent/ConcurrentHashMap:containsKey	(Ljava/lang/Object;)Z
    //   69: ifeq +32 -> 101
    //   72: getstatic 106	com/tencent/biz/common/offline/HtmlOffline:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   75: aload_1
    //   76: invokevirtual 116	java/util/concurrent/ConcurrentHashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   79: checkcast 118	java/lang/String
    //   82: astore_3
    //   83: aload_3
    //   84: invokestatic 78	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   87: ifne +194 -> 281
    //   90: new 120	org/json/JSONObject
    //   93: dup
    //   94: aload_3
    //   95: invokespecial 121	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   98: astore_1
    //   99: aload_1
    //   100: areturn
    //   101: new 123	java/io/BufferedInputStream
    //   104: dup
    //   105: new 125	java/io/FileInputStream
    //   108: dup
    ...
    //   128: invokespecial 128	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   131: invokespecial 131	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   134: astore 4
    //   136: aload 4
    //   138: astore_3
    //   139: aload 4
    //   141: invokestatic 136	com/tencent/biz/common/util/OfflineSecurity:a	(Ljava/io/BufferedInputStream;)Ljava/lang/String;
    //   144: astore_2
    //   145: aload 4
    //   147: astore_3
    //   148: getstatic 106	com/tencent/biz/common/offline/HtmlOffline:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   151: aload_1
    //   152: aload_2
    //   153: invokevirtual 140	java/util/concurrent/ConcurrentHashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   156: pop
    //   157: aload_2
    //   158: astore_3
    //   159: aload 4
    //   161: ifnull -78 -> 83
    //   164: aload 4
    //   166: invokevirtual 143	java/io/BufferedInputStream:close	()V
    //   169: aload_2
    //   170: astore_3
    //   171: goto -88 -> 83
    //   174: astore_3
    //   175: aload_3
    //   176: invokevirtual 146	java/io/IOException:printStackTrace	()V
    //   179: aload_2
    //   180: astore_3
    //   181: goto -98 -> 83
    //   184: astore 5
    ...
    //   192: aload 4
    //   194: astore_3
    //   195: invokestatic 151	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   198: ifeq +16 -> 214
    //   201: aload 4
    //   203: astore_3
    //   204: ldc 153
    ...
    //   207: ldc 37
    //   209: aload 5
    //   211: invokestatic 157	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   214: aload_2
    //   215: astore_3
    //   216: aload 4
    //   218: ifnull -135 -> 83
    //   221: aload 4
    //   223: invokevirtual 143	java/io/BufferedInputStream:close	()V
    //   226: aload_2
    //   227: astore_3
    //   228: goto -145 -> 83
    //   231: astore_3
    //   232: aload_3
    //   233: invokevirtual 146	java/io/IOException:printStackTrace	()V
    //   236: aload_2
    //   237: astore_3
    //   238: goto -155 -> 83
    //   241: astore_1
    ...
    //   243: ifnull +7 -> 250
    //   246: aload_2
    //   247: invokevirtual 143	java/io/BufferedInputStream:close	()V
    //   250: aload_1
    //   251: athrow
    //   252: astore_2
    //   253: aload_2
    //   254: invokevirtual 146	java/io/IOException:printStackTrace	()V
    //   257: goto -7 -> 250
    //   260: astore_1
    //   261: invokestatic 151	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   264: ifeq +12 -> 276
    //   267: ldc 153
    //   269: iconst_2
    //   270: ldc 37
    //   272: aload_1
    //   273: invokestatic 157	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   276: aconst_null
    //   277: astore_1
    //   278: goto -179 -> 99
    //   281: aload_0
    //   282: aload_1
    //   283: invokevirtual 101	com/tencent/biz/webviewplugin/OfflineWebResManager:c	(Ljava/lang/String;)V
    //   286: getstatic 106	com/tencent/biz/common/offline/HtmlOffline:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   289: aload_1
    //   290: invokevirtual 160	java/util/concurrent/ConcurrentHashMap:remove	(Ljava/lang/Object;)Ljava/lang/Object;
    //   293: pop
    //   294: aconst_null
    //   295: areturn
    //   296: astore_1
    ...
    //   0	315	0	this	OfflineWebResManager
  ...
  public void a()
  {
    ...
    ThreadManager.post(new pgu(this, localSharedPreferences), 5, null, false);
  }
  ...
  public void a(int paramInt)
  {
    ...
    ThreadManager.post(new pgv(this, paramInt), 5, null, false);
  }
