...
public class NewReportPlugin
{
  ...
  public static String a(Activity paramActivity, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt1, String paramString5, String paramString6, int paramInt2, String paramString7, Bundle paramBundle)
  {
    ...
    paramActivity.append("&msgs=").append(paramString7);
    paramActivity.append("&msg_count=").append(paramInt2);
  ...
  public static String a(Activity paramActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, int paramInt, String paramString7, String paramString8, String paramString9, String paramString10, String paramString11, String paramString12, String paramString13, String paramString14, String paramString15, Bundle paramBundle)
  {
    ...
    localStringBuilder.append("&version=").append("8.5.5");
      ...
      if (TextUtils.isEmpty(paramString8))
      {
        ...
        if (paramActivity != null)
        {
          ...
          if ((paramActivity instanceof BaseActivity)) {
            paramString2 = a(((BaseActivity)paramActivity).app, paramString1, paramString4, paramInt, paramBundle);
          }
        }
      }
    ...
    for (;;)
    {
      try
      {
        paramActivity = HttpBaseUtil.a("https://jubao.qq.com/uniform_impeach/impeach_cryptokey", "GET", new Bundle()).jdField_a_of_type_JavaLangString;
        if (QLog.isColorLevel()) {
          QLog.d("NewReportPlugin", 2, String.format("makePostData step1: %s", new Object[] { paramActivity }));
        }
      ...
      catch (Exception paramString2)
      {
        label1052:
        label1064:
        paramActivity = "abcdabcdabcdabcd";
      }
      try
      {
        if (QLog.isColorLevel())
        {
          QLog.d("NewReportPlugin", 2, String.format("makePostData step2: %s", new Object[] { paramActivity }));
          paramString2 = paramActivity;
        }
        ...
        if ((paramBundle != null) && (paramBundle.containsKey("chatuin")) && (paramBundle.containsKey("chattype")))
        {
          ...
          if (!TextUtils.equals(paramString1, paramString2)) {
            paramActivity = b(paramString1, b(1));
          }
          paramActivity = String.format("&%s=%s&%s=%s&%s=%s", new Object[] { "chatuin", paramActivity, "groupcode", paramString2, "chattype", Integer.valueOf(paramInt) });
      ...
      else if ((paramInt == 1033) || (paramInt == 1034))
      {
        ...
        if (!TextUtils.isEmpty(paramString1)) {
          paramActivity = Base64.encodeToString(paramString1.getBytes(), 0);
        }
        paramActivity = String.format("&%s=%s&%s=%s&%s=%s&%s=%s", new Object[] { "chatuin", b(paramString2, b(1)), "chattype", Integer.valueOf(paramInt), "topicid", Integer.valueOf(i), "uinname", paramActivity });
      }
      else
      {
        paramActivity = String.format("&%s=%s&%s=%s", new Object[] { "chatuin", b(paramString2, b(1)), "chattype", Integer.valueOf(paramInt) });
      }
    }
  }
        ...
        for (;;)
        {
          for (;;)
          {
            ...
            try
            {
              ...
              localStringBuilder.append("uin=").append((String)localObject1);
              localStringBuilder.append(";");
              localStringBuilder.append("content=").append((String)localObject3);
              localStringBuilder.append(";");
              localStringBuilder.append("type=").append((String)localObject2);
              localStringBuilder.append("]");
      ...
      if (paramList != null)
      {
        ...
        for (;;)
        {
          for (;;)
          {
            try
            {
              localObject2 = paramList.replace("\"", "\\\"");
              paramList = (List<ChatMessage>)localObject2;
            }
            catch (Throwable localThrowable1) {}
            try
            {
              ...
              ((StringBuilder)localObject4).append("uin=").append(str);
              ((StringBuilder)localObject4).append(";");
              ((StringBuilder)localObject4).append("content=").append((String)localObject2);
              ((StringBuilder)localObject4).append(";");
              ((StringBuilder)localObject4).append("type=").append((String)localObject1);
              ((StringBuilder)localObject4).append("]");
          ...
          i = 0;
          break label246;
          QLog.e("NewReportPlugin", 1, localThrowable1, new Object[0]);
          localList = paramList;
        }
      }
    }
  ...
  public static void a(BaseActivity paramBaseActivity, long paramLong, String paramString1, String paramString2, int paramInt, String paramString3, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      if (paramLong <= 0L)
      {
        ...
        ((NearbyFaceScoreManager)paramBaseActivity.getAppInterface().getManager(QQManagerFactory.FACE_SCORE_MANAGER)).a(Long.parseLong(paramString1), new NewReportPlugin.2(paramBaseActivity, paramString1, paramString2, paramInt, paramString3, localQQProgressDialog, paramBundle, paramLong));
        return;
      }
    }
    catch (Exception localException)
    {
      ...
      b(paramBaseActivity, String.valueOf(paramLong), paramString1, paramString2, c(paramInt), b(paramInt, paramString3), localQQProgressDialog, paramBundle);
    }
  }
  ...
  public static void a(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt1, String paramString5, int paramInt2, String paramString6, Bundle paramBundle)
  {
    if ((paramBaseActivity == null) || (TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString4)))
    {
      if (QLog.isColorLevel()) {
    ...
    {
      localQQProgressDialog.show();
      ThreadManager.excute(new NewReportPlugin.5(paramInt1, paramBaseActivity, paramString1, paramString3, paramBundle, paramString2, paramString4, paramString5, paramInt2, paramString6, localQQProgressDialog), 16, null, false);
      return;
    }
    catch (Exception localException)
    {
  ...
  public static void a(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt, String paramString6, Bundle paramBundle)
  {
    ...
    {
      localQQProgressDialog.show();
      ThreadManager.excute(new NewReportPlugin.4(paramInt, paramBaseActivity, paramString1, paramString4, paramBundle, paramString2, paramString3, paramString5, paramString6, localQQProgressDialog), 16, null, false);
      return;
    }
    catch (Exception localException)
    {
  ...
  public static String b(String paramString1, String paramString2)
  {
    ...
    try
    {
      str = Utils.a(a(paramString1.getBytes("utf-8"), paramString2, 1));
      return str;
    }
  ...
  private static void b(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, int paramInt, String paramString4, QQProgressDialog paramQQProgressDialog, Bundle paramBundle)
  {
    ThreadManager.excute(new NewReportPlugin.3(paramBundle, paramString4, paramInt, paramBaseActivity, paramString2, paramString3, paramString1, paramQQProgressDialog), 16, null, false);
  }
