...
{
  public static TroopFileProtoReqMgr.ProtoRequest a(QQAppInterface paramQQAppInterface, long paramLong, TroopFileTransferManager.Item paramItem, int paramInt, boolean paramBoolean1, boolean paramBoolean2, TroopFileReqDownloadFileObserver paramTroopFileReqDownloadFileObserver)
  {
  ...
  public static TroopFileProtoReqMgr.ProtoRequest a(QQAppInterface paramQQAppInterface, long paramLong, TroopFileTransferManager.Item paramItem, TroopFileReqResendFileObserver paramTroopFileReqResendFileObserver)
  {
    if ((paramLong == 0L) || (paramItem == null)) {
      return null;
    }
    ...
    ((Bundle)localObject).putString("itemKey", paramItem.Id.toString());
    ((Bundle)localObject).putLong("troopUin", paramLong);
    return a(paramQQAppInterface, paramTroopFileReqResendFileObserver, localReqBody.toByteArray(), "OidbSvc.0x6d6_1", 1750, 1, (Bundle)localObject);
  }
  
  public static TroopFileProtoReqMgr.ProtoRequest a(QQAppInterface paramQQAppInterface, long paramLong, TroopFileTransferManager.Item paramItem, TroopFileReqUploadFileObserver paramTroopFileReqUploadFileObserver)
  {
    if ((paramLong == 0L) || (paramItem == null)) {
      return null;
    }
  ...
  public static TroopFileProtoReqMgr.ProtoRequest a(QQAppInterface paramQQAppInterface, long paramLong, String paramString, int paramInt, TroopFileGetFilePreviewObserver paramTroopFileGetFilePreviewObserver)
  {
  ...
  public static TroopFileProtoReqMgr.ProtoRequest a(QQAppInterface paramQQAppInterface, long paramLong1, String paramString1, String paramString2, long paramLong2, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, int paramInt, String paramString3, Bundle paramBundle, TroopFileReqUploadFileObserver paramTroopFileReqUploadFileObserver)
  {
    if (paramLong1 == 0L) {
      return null;
    }
    return a(paramQQAppInterface, paramLong1, paramString1, paramString2, paramLong2, true, paramArrayOfByte1, paramArrayOfByte2, null, paramInt, paramString3, paramBundle, paramTroopFileReqUploadFileObserver);
  }
  ...
  {
    paramString1 = new HttpWebCgiAsyncTask2("http://" + paramString1 + ":" + paramString2 + "/ftn_compress_list/rkey=" + paramString3 + "&filetype=" + paramInt + "&path=" + URLUtil.a(paramString4) + "&", "GET", new TroopFileProtocol.1(new ArrayList(), paramString4, paramFileManagerEntity, paramQQAppInterface, paramInt, paramOnGetZipFileList), 1000, null);
