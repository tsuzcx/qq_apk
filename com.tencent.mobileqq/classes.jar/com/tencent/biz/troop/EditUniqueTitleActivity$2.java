  ...
  implements TextWatcher
{
  ...
  public void afterTextChanged(Editable paramEditable)
  {
    ...
    for (paramEditable = this.a.getResources().getColorStateList(2131167175);; paramEditable = this.a.getResources().getColorStateList(2131167119))
    {
      ...
      this.a.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(String.format(this.a.getString(2131696126), new Object[] { Integer.valueOf(i) }));
      return;
