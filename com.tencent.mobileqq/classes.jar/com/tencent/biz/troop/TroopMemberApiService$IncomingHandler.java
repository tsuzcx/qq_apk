  ...
  extends Handler
{
  ...
  private void b(Bundle paramBundle)
  {
    ...
    ((IRIJUserLevelModule)QRoute.api(IRIJUserLevelModule.class)).requestUserLevel(10, new TroopMemberApiService.IncomingHandler.13(this, paramBundle));
  }
  
  private void c(Bundle paramBundle)
  {
    IRIJEntryViewUtils localIRIJEntryViewUtils = (IRIJEntryViewUtils)QRoute.api(IRIJEntryViewUtils.class);
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append(paramBundle.getInt("seq", 0));
    localStringBuilder.append("");
    localIRIJEntryViewUtils.jumpUGCPublisherActivity(5, paramBundle, localStringBuilder.toString());
  }
  ...
  private void d(Bundle paramBundle)
  {
    ...
    ProtoUtils.a(TroopMemberApiService.k(this.a), new TroopMemberApiService.IncomingHandler.14(this, true, paramBundle), localReqBody.toByteArray(), "OidbSvc.0xe2a", 3626, 8, null, 0L);
  }
  ...
  private void e(Bundle paramBundle)
  {
    ...
    TroopMemberApiService.IncomingHandler.15 local15 = new TroopMemberApiService.IncomingHandler.15(this, paramBundle, (QQAppInterface)localObject);
    if (localObject != null) {
      ((IRIJUgcVideoPublishService)((QQAppInterface)localObject).getRuntimeService(IRIJUgcVideoPublishService.class)).addVideoPublishCallback(local15);
    }
  ...
  private void h(Bundle paramBundle)
  {
    ...
    if ((str != null) && (localObject1 != null))
    {
      ...
      {
        localObject2 = new TroopMemberApiService.IncomingHandler.16(this).getType();
        localObject2 = (List)new Gson().fromJson(localJSONArray.toString(), (Type)localObject2);
      }
      j = ((JSONObject)localObject1).optInt("feedsType");
      paramBundle = new TroopMemberApiService.IncomingHandler.17(this, (JSONObject)localObject1, localCommentData, localJSONArray, paramBundle);
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    if ((paramMessage != null) && (localObject11 != null))
    {
      ...
      {
        break;
        if ((BaseActivity.sTopActivity != null) && (localObject11 != null))
        {
          ((IReadInjoyWebShareHelper)QRoute.api(IReadInjoyWebShareHelper.class)).showShareActionSheet(BaseActivity.sTopActivity, (QQAppInterface)localObject11, (Bundle)localObject10, new TroopMemberApiService.IncomingHandler.12(this));
        }
        else
        {
          ...
          if (localObject1 != null)
          {
            ...
            if (localObject1 != null)
            {
              ...
              if (localObject1 != null)
              {
                ...
                if (this.a.g == null)
                {
                  this.a.g = ((ConditionSearchManager)((AppRuntime)localObject11).getManager(QQManagerFactory.CONDITION_SEARCH_MANAGER));
                  this.a.g.a(this);
                }
                ...
                ((Intent)localObject6).putExtra("param_location_param", this.a.g.e((String[])localObject1));
                BaseApplicationImpl.getContext().startActivity((Intent)localObject6);
                continue;
                this.a.b().a((AppRuntime)localObject11, (Bundle)localObject10);
                continue;
                    ...
                    if ((localObject2 != null) && ((localObject2 instanceof GameLoadData)))
                    {
                      ...
                      else
                      {
                        ...
                        else
                        {
                          ...
                          localObject6 = ((FriendsManager)((AppRuntime)localObject11).getManager(QQManagerFactory.FRIENDS_MANAGER)).f(((QQAppInterface)localObject3).getCurrentUin());
                          ...
                          else
                          {
                            ...
                            if (localObject3 != null)
                            {
                              ...
                              if ((i == 2) || (i == 1))
                              {
                                ...
                                i = ((Bundle)localObject10).getInt("seq");
                                if (this.a.u == null) {
                                  this.a.u = new DoraemonBridge((AppRuntime)localObject11);
                                }
                                localObject7 = this.a.b;
                                if (localObject10 != null) {
                                  localObject3 = ((Bundle)localObject10).getString("processName");
                                } else {
                                  localObject3 = null;
                                ...
                                if (localObject3 != null)
                                {
                                  ...
                                  {
                                    localObject6 = localObject7;
                                    if (this.a.c.get(localObject3) != null) {
                                      localObject6 = (Messenger)this.a.c.get(localObject3);
                                    }
                                  }
                                }
                                this.a.u.a(118, (Bundle)localObject10, i, (Messenger)localObject6);
                                continue;
                                if (QLog.isColorLevel()) {
                                ...
                                if (bool4)
                                {
                                  ...
                                  if ((!TextUtils.isEmpty((CharSequence)localObject3)) && (String.valueOf(1104445552).equals(localObject6)))
                                  {
                                    ...
                                    if (((IHWTroopUtilsApi)localObject6).getAIOHomeworkBtnRedPoint((AppRuntime)localObject7, (String)localObject3) != 0)
                                    {
                                      ...
                                      continue;
                                      this.a.s = ((Bundle)localObject10).getString("callback");
                                      this.a.t = ((Bundle)localObject10).getInt("seq");
                                      localObject7 = ((Bundle)localObject10).getString("troopUin");
                                      localObject3 = ((Bundle)localObject10).getString("chatType");
                                      if ((!TextUtils.isEmpty((CharSequence)localObject7)) && ("group".equals(localObject3)))
                                      {
                                        localObject3 = (ITroopInfoHandler)((QQAppInterface)localObject11).getBusinessHandler(BusinessHandlerFactory.TROOP_INFO_HANDLER);
                                        if (localObject3 != null) {
                                          ((ITroopInfoHandler)localObject3).a((String)localObject7, false, "TroopMemberApiService.create_troop", true, true, false, false);
                                        }
                                      }
                                      else if ((!TextUtils.isEmpty((CharSequence)localObject7)) && ("groupPro".equals(localObject3)))
                                      {
                                        localObject8 = ((Bundle)localObject10).getString("packageId");
                                        localObject6 = new Bundle();
                                        localObject3 = localObject6;
                                        if (!TextUtils.isEmpty((CharSequence)localObject8))
                                        {
                                          localObject8 = ((IGuildOpenApi)((AppRuntime)localObject11).getRuntimeService(IGuildOpenApi.class, "")).getGuildOpenDataFromApp((String)localObject8);
                                          localObject3 = localObject6;
                                          if (localObject8 != null)
                                          {
                                            localObject3 = new Bundle();
                                            ((Bundle)localObject3).putString("guild_from", "guildOpenCreate");
                                            ((Bundle)localObject3).putString("guild_from_app_name", ((QQGuildOpenData)localObject8).appName);
                                          }
                                        }
                                        localObject6 = (SplashActivity)SplashActivity.sWeakInstance.get();
                                        ((IQQGuildRouterApi)QRoute.api(IQQGuildRouterApi.class)).openGuild((AppRuntime)localObject11, (Context)localObject6, true, (Bundle)localObject3, (String)localObject7);
                                      }
                                      else
                                      {
                                        ...
                                        ((Bundle)localObject3).putInt("seq", this.a.t);
                                        ((Bundle)localObject3).putString("callback", this.a.s);
                                        this.a.a(112, (Bundle)localObject3);
                                        continue;
                                        if (this.a.x == null) {
                                          this.a.x = ((IReadInJoySkinHelperFactory)QRoute.api(IReadInJoySkinHelperFactory.class)).createReadInJoySkinHelper((AppRuntime)localObject11, this.a);
                                        }
                                        this.a.x.c((Bundle)localObject10);
                                        continue;
                                        if (this.a.x == null) {
                                          this.a.x = ((IReadInJoySkinHelperFactory)QRoute.api(IReadInJoySkinHelperFactory.class)).createReadInJoySkinHelper((AppRuntime)localObject11, this.a);
                                        }
                                        this.a.x.b((Bundle)localObject10);
                                        continue;
                                        if (this.a.x == null) {
                                          this.a.x = ((IReadInJoySkinHelperFactory)QRoute.api(IReadInJoySkinHelperFactory.class)).createReadInJoySkinHelper((AppRuntime)localObject11, this.a);
                                        }
                                        this.a.x.a((Bundle)localObject10);
                                        continue;
                                        i = ((Bundle)localObject10).getInt("topicId");
                                        j = ((Bundle)localObject10).getInt("followInfo");
                                        if (!((IReadInJoyLogicEngineFactory)QRoute.api(IReadInJoyLogicEngineFactory.class)).createReadInJoyLogicEngine().g(i, j))
                                        {
                                          ((IReadInJoyLogicEngineFactory)QRoute.api(IReadInJoyLogicEngineFactory.class)).createReadInJoyLogicEngine().h(i, j);
                                          continue;
                                          ...
                                          if (localObject3 != null)
                                          {
                                            ...
                                            if (localObject6 != null)
                                            {
                                              ...
                                              continue;
                                              this.a.o = ((Bundle)localObject10).getInt("seq", -1);
                                                    ...
                                                    if (localObject6 != null)
                                                    {
                                                      ...
                                                      if (localObject7 != null)
                                                      {
                                                        ...
                                                        if (localObject8 != null)
                                                        {
                                                          ...
                                                          localObject3 = AdvertisementRecentUserManager.a().b((String)localObject3);
                                                          if (localObject3 != null)
                                                          {
                                                            ...
                                                            if (localObject6 != null)
                                                            {
                                                              ...
                                                              if (bool1)
                                                              {
                                                                VideoEnvironment.LogDownLoad("TroopMemberApiService", HardCodeUtil.a(2131912899), null);
                                                              ...
                                                              else
                                                              {
                                                                ...
                                                                localObject7 = new StringBuilder();
                                                                ((StringBuilder)localObject7).append(NearbyConstants.n);
                                                                ...
                                                                {
                                                                  localObject6 = (QQAppInterface)localObject11;
                                                                  if ((((QQAppInterface)localObject6).isVideoChatting()) && (!((QQAppInterface)localObject6).getAVNotifyCenter().D()))
                                                                  {
                                                                    bool1 = bool2;
                                                                    break label5912;
                                                                  }
                                                                ...
                                                                if (bool4)
                                                                {
                                                                  ...
                                                                  if (QLog.isColorLevel())
                                                                  {
                                                                    ...
                                                                    this.a.h = ((Bundle)localObject10).getString("photoPath");
                                                                    this.a.l = ((Bundle)localObject10).getInt("seq", -1);
                                                                    ((INearbyVideoUtils)QRoute.api(INearbyVideoUtils.class)).upload640Video((QQAppInterface)localObject11, (String)localObject3, this.a.N);
                                                                    continue;
                                                                          ...
                                                                          if (localObject9 != null)
                                                                          {
                                                                            ...
                                                                            if (QLog.isColorLevel())
                                                                            {
                                                                              ...
                                                                              if (localObject7 != null)
                                                                              {
                                                                                ...
                                                                                ((Bundle)localObject10).putByteArray("decryptResult", PreloadManager.a().f((String)localObject3));
                                                                                ...
                                                                                if (localObject3 != null)
                                                                                {
                                                                                  ...
                                                                                  TroopRewardMgr.b = ((Bundle)localObject10).getInt("imageMaxWidthPixels", 1080);
                                                                                  TroopRewardMgr.c = ((Bundle)localObject10).getInt("imageMaxHeightPixels", 1920);
                                                                                  ...
                                                                                  if (localObject6 != null)
                                                                                  {
                                                                                    localObject3 = ((TroopManager)localObject6).f((String)localObject3);
                                                                                  ...
                                                                                  try
                                                                                  {
                                                                                    ...
                                                                                    while (i < localObject3.length)
                                                                                    {
                                                                                      ...
                                                                                      localObject7 = ((TroopManager)localObject6).f(((StringBuilder)localObject7).toString());
                                                                                      if (localObject7 != null) {
                                                                                  ...
                                                                                  continue;
                                                                                  this.a.m = ((Bundle)localObject10).getInt("appId");
                                                                                  this.a.n = ((Bundle)localObject10).getInt("seq");
                                                                                  if (this.a.m != 0)
                                                                                  {
                                                                                    ...
                                                                                    if ((((ITroopAppService)localObject4).isCheckedUpdateAfterLogined(0)) && (!((ITroopAppService)localObject4).getAppListChangedFromWebOperate(0)))
                                                                                    {
                                                                                      ...
                                                                                      if ((localObject7 != null) && (!((List)localObject7).isEmpty()))
                                                                                      {
                                                                                        ...
                                                                                        while (((Iterator)localObject7).hasNext())
                                                                                        {
                                                                                          ...
                                                                                          if (((TroopAIOAppInfo)localObject8).appid == this.a.m)
                                                                                          {
                                                                                      ...
                                                                                      ((ArrayList)localObject6).add(Integer.valueOf(this.a.m));
                                                                                      localObject7 = new ArrayList();
                                                                                      ((ArrayList)localObject7).add(Integer.valueOf(this.a.m));
                                                                                    ...
                                                                                    else
                                                                                    {
                                                                                      ...
                                                                                      if (localObject6 != null)
                                                                                      {
                                                                                        localObject4 = ((TroopManager)localObject6).f((String)localObject4);
                                                                                                    ...
                                                                                                    if ((!TextUtils.isEmpty((CharSequence)localObject6)) && (!TextUtils.isEmpty((CharSequence)localObject4))) {
                                                                                                      ...
                                                                                                      else if (((String)localObject6).equals("g_troop_reward"))
                                                                                                      {
                                                                                                        ...
                                                                                                        if ((localObject7 != null) && (i > 0))
                                                                                                        {
                                                                                                          ...
                                                                                                          if (this.a.H != null)
                                                                                                          {
                                                                                                            this.a.H.cancleAllTask();
                                                                                                            continue;
                                                                                                            if ((bool4) && (localObject10 != null))
                                                                                                            {
                                                                                                              if (this.a.H == null)
                                                                                                              {
                                                                                                                this.a.H = ((IPublicAccountH5Manager)QRoute.api(IPublicAccountH5Manager.class));
                                                                                                                this.a.H.init(this.a, (QQAppInterface)localObject11);
                                                                                                              }
                                                                                                              if (((Bundle)localObject10).getBoolean("is_pic_or_voice"))
                                                                                                              {
                                                                                                                this.a.H.startDownloadPic((Bundle)localObject10);
                                                                                                              }
                                                                                                              else
                                                                                                              {
                                                                                                                this.a.H.downloadPtt((Bundle)localObject10);
                                                                                                                continue;
                                                                                                                if ((bool4) && (localObject10 != null))
                                                                                                                {
                                                                                                                  if (this.a.H == null)
                                                                                                                  ...
                                                                                                                  if (((Bundle)localObject10).getBoolean("is_pic_or_voice"))
                                                                                                                  {
                                                                                                                    this.a.H.startUploadPic((Bundle)localObject10);
                                                                                                                  }
                                                                                                                  else
                                                                                                                  {
                                                                                                                    this.a.H.uploadPtt((Bundle)localObject10);
                                                                                                                    continue;
                                                                                                                    if ((bool4) && (localObject10 != null))
                                                                                                                    {
                                                                                                                      ...
                                                                                                                      if (localObject8 != null)
                                                                                                                      {
                                                                                                                        localObject6 = ((TroopManager)localObject8).f((String)localObject7);
                                                                                                                      ...
                                                                                                                      if (bool4)
                                                                                                                      {
                                                                                                                        ...
                                                                                                                        if ((localObject4 != null) && (((LebaViewItem)localObject4).b != null))
                                                                                                                        {
                                                                                                                          ((Bundle)localObject10).putString("packageName", ((LebaViewItem)localObject4).b.strPkgName);
                                                                                                                          ((Bundle)localObject10).putString("imageUrl", ((LebaViewItem)localObject4).b.strResURL);
                                                                                                                          ((Bundle)localObject10).putString("name", ((LebaViewItem)localObject4).b.strResName);
                                                                                                                          if (((LebaViewItem)localObject4).f == 0) {
                                                                                                                            bool1 = true;
                                                                                                                          } else {
                                                                                                                            bool1 = false;
                                                                                                                          }
                                                                                                                              ...
                                                                                                                              else if ("getNewNearbyTroop".equals(localObject4))
                                                                                                                              {
                                                                                                                                ...
                                                                                                                                if ((!TextUtils.isEmpty((CharSequence)localObject7)) && (!TextUtils.isEmpty((CharSequence)localObject4)) && (!TextUtils.isEmpty((CharSequence)localObject6)))
                                                                                                                                {
                                                                                                                                  ...
                                                                                                                                  if (QLog.isDevelopLevel())
                                                                                                                                  {
                                                                                                                                    ...
                                                                                                                                    continue;
                                                                                                                                    this.a.f = new QQMapActivityProxy(((AppRuntime)localObject11).getAccount());
                                                                                                                                    continue;
                                                                                                                                    this.a.b = null;
                                                                                                                                    if (paramMessage.obj != null)
                                                                                                                                    {
                                                                                                                                      ...
                                                                                                                                      if (localObject4 != null)
                                                                                                                                      {
                                                                                                                                        ...
                                                                                                                                        if (paramMessage.obj != null)
                                                                                                                                        {
                                                                                                                                          localObject4 = ((Bundle)paramMessage.obj).getString("processName");
                                                                                                                                          if (localObject4 != null) {
                                                                                                                                            this.a.c.put(localObject4, paramMessage.replyTo);
                                                                                                                                          }
                                                                                                                                        }
                                                                                                                                      }
                                                                                                                                    }
