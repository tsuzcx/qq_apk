...
public class AuthorizeConfig$1
  implements Runnable
{
  public AuthorizeConfig$1(nhe paramnhe) {}
  
  public void run()
  {
    long l = SystemClock.currentThreadTimeMillis();
    if (l > nhe.jdField_a_of_type_Long + 10000L)
    {
      this.this$0.jdField_a_of_type_AndroidContentContext.getSharedPreferences("domainCmdRight", 4);
      nhe.jdField_a_of_type_Long = l;
    }
    FlatBuffersParser.b();
    l = this.this$0.jdField_a_of_type_AndroidContentSharedPreferences.getLong("lastUpdate", 0L);
    if (l != nhe.jdField_b_of_type_Long)
    {
      nhe.jdField_b_of_type_Long = l;
      this.this$0.jdField_a_of_type_Nkd.b();
      this.this$0.jdField_a_of_type_Nkc.a();
      this.this$0.i = null;
