  ...
  extends MessageMicro<QidianGroupMsg>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 42 }, new String[] { "uint32_group_task_id", "uint32_group_msg_type", "uint64_kfuin", "uint32_show_tip", "str_tip_text" }, new Object[] { localInteger, localInteger, Long.valueOf(0L), localInteger, "" }, QidianGroupMsg.class);
  }
}
