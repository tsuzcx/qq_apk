  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      String str = bbcz.h((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_a_of_type_JavaLangString, this.b);
    ...
    xcc.b(this.jdField_a_of_type_JavaLangString, "");
  }
}
