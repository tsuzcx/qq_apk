  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      String str = bbcl.h((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_a_of_type_JavaLangString, this.b);
    ...
    xcf.b(this.jdField_a_of_type_JavaLangString, "");
  }
}
