  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      String str = babh.h((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_a_of_type_JavaLangString, this.b);
    ...
    wnc.b(this.jdField_a_of_type_JavaLangString, "");
  }
}
