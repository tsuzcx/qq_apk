  ...
  implements Observer
{
  ...
  QQLiveDrawable.OnStateListener jdField_a_of_type_ComTencentImageQQLiveDrawable$OnStateListener = new kot(this);
  ...
  public String a;
  Thread jdField_a_of_type_JavaLangThread = new kov(this);
  public List a;
  ...
  public NowVideoView(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new kos(this);
  ...
  public void a(QQAppInterface paramQQAppInterface, StructMsgItemLive paramStructMsgItemLive, MessageRecord paramMessageRecord)
  {
    ...
    this.jdField_a_of_type_Int = paramStructMsgItemLive.e;
    this.jdField_b_of_type_Int = paramStructMsgItemLive.f;
    if (this.jdField_a_of_type_Int == 0)
    {
      this.jdField_b_of_type_Int = 800;
      this.jdField_a_of_type_Int = 640;
    }
    this.jdField_a_of_type_JavaLangString = paramStructMsgItemLive.u;
    this.jdField_b_of_type_JavaLangString = paramStructMsgItemLive.y;
    this.jdField_c_of_type_JavaLangString = paramStructMsgItemLive.v;
    ...
    for (;;)
    {
      ...
      if (g == 0) {
        g = getResources().getDimensionPixelSize(2131558448);
      }
  ...
  public boolean a(int paramInt)
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetImageView.clearAnimation();
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130840883);
  ...
  public void b()
  {
    ...
    if (!NetworkUtil.g(getContext())) {
      QQToast.a(getContext(), 1, 2131434794, 0).b(g);
    }
    for (;;)
    {
      return;
      ...
      if ((((koo)localObject1).jdField_a_of_type_Int == 2) || (((koo)localObject1).jdField_a_of_type_Int == 1))
      {
        if (TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {}
        for (;;)
        {
      ...
      this.jdField_a_of_type_JavaUtilList = new ArrayList(((koo)localObject1).jdField_a_of_type_JavaUtilList);
  ...
  public void e()
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizNowNowLiveManager != null)
    {
      ...
      if (localObject != null) {
        ((koo)localObject).jdField_a_of_type_JavaUtilList.clear();
      }
    }
  ...
  public void update(Observable paramObservable, Object paramObject)
  {
    ...
    paramObservable = (koo)paramObject[2];
    ...
    for (bool = paramObject.getBoolean("needReqUrl");; bool = false)
    {
      ...
      return;
      label517:
      if ((i != 1001) || (!this.jdField_a_of_type_ComTencentBizNowNowLiveManager.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.frienduin, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.time))) {
        break;
      }
      d();
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.clearAnimation();
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130840879);
      return;
    }
  }
}
