  ...
  implements Observer
{
  ...
  public ImageView a;
  QQLiveDrawable.OnStateListener jdField_a_of_type_ComTencentImageQQLiveDrawable$OnStateListener = new mso(this);
  ...
  public NowVideoView(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new msn(this);
    this.jdField_c_of_type_Int = 0;
    this.jdField_d_of_type_Int = 0;
    this.jdField_a_of_type_Msp = new msp(this);
    msl.a().a(this);
  }
  ...
  {
    Object localObject = jdField_a_of_type_Amym;
    if (!TextUtils.isEmpty(paramString)) {}
    try
    {
      localObject = URLDrawable.getDrawable(paramString, jdField_a_of_type_Amym, jdField_a_of_type_Amym);
      return localObject;
    }
  ...
  QQLiveDrawable.QQLiveDrawableParams a()
  {
    ...
    for (int i = 200;; i = this.jdField_b_of_type_Int)
    {
      ...
      this.jdField_a_of_type_ComTencentImageQQLiveDrawable$QQLiveDrawableParams.mDataSourceAdapter = this.jdField_a_of_type_Msp;
      ...
      this.jdField_a_of_type_ComTencentImageQQLiveDrawable$QQLiveDrawableParams.mCoverLoadingDrawable = jdField_a_of_type_Amym;
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if (paramInt2 == 5) {
      this.jdField_a_of_type_Msg.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.frienduin, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.time, true);
    }
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, awvu paramawvu, MessageRecord paramMessageRecord)
  {
    ...
    this.jdField_a_of_type_Int = paramawvu.i;
    this.jdField_b_of_type_Int = paramawvu.j;
    if (this.jdField_a_of_type_Int == 0)
    {
      this.jdField_b_of_type_Int = 800;
      this.jdField_a_of_type_Int = 640;
    }
    this.jdField_a_of_type_JavaLangString = paramawvu.S;
    this.jdField_b_of_type_JavaLangString = paramawvu.W;
    this.jdField_c_of_type_JavaLangString = paramawvu.T;
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Msg == null) {
        this.jdField_a_of_type_Msg = ((msg)paramQQAppInterface.getManager(171));
      }
      setImageDrawable(a(this.jdField_c_of_type_JavaLangString));
      if (g == 0) {
        g = getResources().getDimensionPixelSize(2131167766);
      }
      this.jdField_a_of_type_Msg.addObserver(this);
      this.jdField_a_of_type_JavaUtilList.clear();
      if (this.jdField_a_of_type_Msg.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.frienduin, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.time)) {
        msl.a().a();
      }
      this.e = 0;
      this.f = 0;
  ...
  public void b()
  {
    ...
    if (!badq.g(getContext())) {
      bbmy.a(getContext(), 1, 2131628948, 0).b(g);
    }
    for (;;)
    {
      return;
      ...
      Object localObject1 = this.jdField_a_of_type_Msg.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.frienduin, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.time);
      if ((((msi)localObject1).jdField_a_of_type_Int == 2) || (((msi)localObject1).jdField_a_of_type_Int == 1))
      {
        if (TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {}
        for (;;)
        {
      ...
      this.jdField_a_of_type_JavaUtilList = new ArrayList(((msi)localObject1).jdField_a_of_type_JavaUtilList);
  ...
  public void e()
  {
    ...
    if (this.jdField_a_of_type_Msg != null)
    {
      this.jdField_a_of_type_Msg.deleteObserver(this);
      localObject = this.jdField_a_of_type_Msg.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.frienduin, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.time);
      if (localObject != null) {
        ((msi)localObject).jdField_a_of_type_JavaUtilList.clear();
      }
    }
  ...
  public void update(Observable paramObservable, Object paramObject)
  {
    ...
    paramObservable = (msi)paramObject[2];
    ...
    do
    {
      do
      {
        ...
        } while (!this.jdField_a_of_type_Msg.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.frienduin, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.time));
      ...
      } while (this.jdField_a_of_type_Msp.a());
      a(1);
      b();
      return;
      d();
    ...
    for (bool = paramObject.getBoolean("needReqUrl");; bool = false)
    {
      ...
      a(1);
      if ((!msl.a().a(getContext(), this)) && (this.jdField_a_of_type_AndroidWidgetImageView != null))
      {
        this.jdField_a_of_type_AndroidWidgetImageView.clearAnimation();
        this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130842556);
        this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      ...
      if (this.f < 3)
      {
        ...
        if (this.jdField_a_of_type_JavaUtilList.size() == 0) {
          this.jdField_a_of_type_Msg.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.frienduin, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.time);
        }
        this.e += 1;
        return;
      }
      bbmy.a(getContext(), 1, ajjy.a(2131641889), 1).a();
      return;
      label520:
      if ((i != 1001) || (!this.jdField_a_of_type_Msg.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.frienduin, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.time))) {
        break;
      }
      d();
      bbmy.a(getContext(), ajjy.a(2131641888), 0).a();
      if (this.jdField_a_of_type_AndroidWidgetImageView == null) {
        break;
      }
      this.jdField_a_of_type_AndroidWidgetImageView.clearAnimation();
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130842552);
      return;
    }
  }
}
