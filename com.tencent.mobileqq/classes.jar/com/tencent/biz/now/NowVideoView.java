  ...
  implements Observer
{
  ...
  public ImageView a;
  QQLiveDrawable.OnStateListener jdField_a_of_type_ComTencentImageQQLiveDrawable$OnStateListener = new nzd(this);
  ...
  public NowVideoView(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new nzc(this);
    this.jdField_c_of_type_Int = 0;
    this.jdField_d_of_type_Int = 0;
    this.jdField_a_of_type_Nze = new nze(this);
    nza.a().a(this);
  }
  ...
  {
    Object localObject = jdField_a_of_type_Asbg;
    if (!TextUtils.isEmpty(paramString)) {}
    try
    {
      localObject = URLDrawable.getDrawable(paramString, jdField_a_of_type_Asbg, jdField_a_of_type_Asbg);
      return localObject;
    }
  ...
  QQLiveDrawable.QQLiveDrawableParams a()
  {
    ...
    for (int i = 200;; i = this.jdField_b_of_type_Int)
    {
      ...
      this.jdField_a_of_type_ComTencentImageQQLiveDrawable$QQLiveDrawableParams.mDataSourceAdapter = this.jdField_a_of_type_Nze;
      ...
      this.jdField_a_of_type_ComTencentImageQQLiveDrawable$QQLiveDrawableParams.mCoverLoadingDrawable = jdField_a_of_type_Asbg;
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if (paramInt2 == 5) {
      this.jdField_a_of_type_Nyv.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.frienduin, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.time, true);
    }
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, bdpd parambdpd, MessageRecord paramMessageRecord)
  {
    ...
    this.jdField_a_of_type_Int = parambdpd.o;
    this.jdField_b_of_type_Int = parambdpd.p;
    if (this.jdField_a_of_type_Int == 0)
    {
      this.jdField_b_of_type_Int = 800;
      this.jdField_a_of_type_Int = 640;
    }
    this.jdField_a_of_type_JavaLangString = parambdpd.ac;
    this.jdField_b_of_type_JavaLangString = parambdpd.ag;
    this.jdField_c_of_type_JavaLangString = parambdpd.ad;
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Nyv == null) {
        this.jdField_a_of_type_Nyv = ((nyv)paramQQAppInterface.getManager(QQManagerFactory.NOW_LIVE_MANAGER));
      }
      setImageDrawable(a(this.jdField_c_of_type_JavaLangString));
      if (g == 0) {
        g = getResources().getDimensionPixelSize(2131299080);
      }
      this.jdField_a_of_type_Nyv.addObserver(this);
      this.jdField_a_of_type_JavaUtilList.clear();
      if (this.jdField_a_of_type_Nyv.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.frienduin, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.time)) {
        nza.a().a();
      }
      this.e = 0;
      this.f = 0;
  ...
  public void b()
  {
    ...
    if (!NetworkUtil.isNetworkAvailable(getContext())) {
      QQToast.a(getContext(), 1, 2131694255, 0).b(g);
    }
    for (;;)
    {
      return;
      ...
      Object localObject1 = this.jdField_a_of_type_Nyv.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.frienduin, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.time);
      if ((((nyx)localObject1).jdField_a_of_type_Int == 2) || (((nyx)localObject1).jdField_a_of_type_Int == 1))
      {
        if (TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {}
        for (;;)
        {
      ...
      this.jdField_a_of_type_JavaUtilList = new ArrayList(((nyx)localObject1).jdField_a_of_type_JavaUtilList);
  ...
  public void e()
  {
    ...
    if (this.jdField_a_of_type_Nyv != null)
    {
      this.jdField_a_of_type_Nyv.deleteObserver(this);
      localObject = this.jdField_a_of_type_Nyv.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.frienduin, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.time);
      if (localObject != null) {
        ((nyx)localObject).jdField_a_of_type_JavaUtilList.clear();
      }
    }
  ...
  public void update(Observable paramObservable, Object paramObject)
  {
    ...
    paramObservable = (nyx)paramObject[2];
    ...
    do
    {
      do
      {
        ...
        } while (!this.jdField_a_of_type_Nyv.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.frienduin, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.time));
      ...
      } while (this.jdField_a_of_type_Nze.a());
      a(1);
      b();
      return;
      d();
    ...
    for (bool = paramObject.getBoolean("needReqUrl");; bool = false)
    {
      ...
      a(1);
      if ((!nza.a().a(getContext(), this)) && (this.jdField_a_of_type_AndroidWidgetImageView != null))
      {
        this.jdField_a_of_type_AndroidWidgetImageView.clearAnimation();
        this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130843294);
        this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      ...
      if (this.f < 3)
      {
        ...
        if (this.jdField_a_of_type_JavaUtilList.size() == 0) {
          this.jdField_a_of_type_Nyv.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.frienduin, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.time);
        }
        this.e += 1;
        return;
      }
      QQToast.a(getContext(), 1, anvx.a(2131707129), 1).a();
      return;
      label520:
      if ((i != 1001) || (!this.jdField_a_of_type_Nyv.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.frienduin, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.time))) {
        break;
      }
      d();
      QQToast.a(getContext(), anvx.a(2131707128), 0).a();
      if (this.jdField_a_of_type_AndroidWidgetImageView == null) {
        break;
      }
      this.jdField_a_of_type_AndroidWidgetImageView.clearAnimation();
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130843290);
      return;
    }
  }
}
