  ...
  implements Manager
{
  ...
  {
    NowLiveManager.NowLiveInfo localNowLiveInfo2 = (NowLiveManager.NowLiveInfo)this.jdField_a_of_type_JavaUtilHashMap.get(paramString + paramLong);
    NowLiveManager.NowLiveInfo localNowLiveInfo1 = localNowLiveInfo2;
    if (localNowLiveInfo2 == null)
    {
      localNowLiveInfo1 = new NowLiveManager.NowLiveInfo(this);
      localNowLiveInfo1.jdField_a_of_type_JavaLangString = paramString;
      localNowLiveInfo1.jdField_a_of_type_Long = paramLong;
      this.jdField_a_of_type_JavaUtilHashMap.put(localNowLiveInfo1.a(), localNowLiveInfo1);
    }
    return localNowLiveInfo1;
  }
  ...
  public boolean b()
  {
    ...
    Iterator localIterator = ((RedTouchManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.MGR_RED_TOUCH)).a().iterator();
