  ...
  implements Manager
{
  ...
  public void a()
  {
    ...
    this.jdField_b_of_type_Int = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getSharedPreferences("now_tab_sp", 0).getInt("now_index_key", 3);
    ...
    if (localObject[0] == '1') {
      if ((localObject[3] == '0') || (c1 == '0') || (c1 == '1'))
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.i("Q.qqstory.fourTab", 2, "uin:" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + ",isNowTabShow mIsNowTabShow=" + this.jdField_a_of_type_Int + " plan=" + c1);
        }
  ...
  public void a(Integer[] paramArrayOfInteger, boolean paramBoolean)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.i("Q.qqstory.fourTab", 2, "writeNowTabStateVal fullVal=" + (String)localObject2 + " vals:" + Arrays.toString(paramArrayOfInteger) + "     mNowTabShowState=" + this.jdField_a_of_type_Int);
    }
    ...
    if ('1' == ((StringBuilder)localObject1).charAt(0))
    {
      ...
      for (bool = false;; bool = true)
      {
        ...
        LebaShowListManager.jdField_a_of_type_Int |= 0x2;
        if (QLog.isColorLevel()) {
          QLog.i("Q.qqstory.fourTab", 2, "userChange mNowTabShowState=" + this.jdField_a_of_type_Int + " result:" + localObject1 + "  plan=" + c1);
        }
        if (QLog.isColorLevel()) {
          QLog.i("Q.qqstory.fourTab", 2, "uin:" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + ",writeNowTabStateVal vals=" + Arrays.toString(paramArrayOfInteger) + ",mIsNowTabShow=" + this.jdField_a_of_type_Int + ",isNowTabShow=" + this.jdField_a_of_type_Boolean);
        }
        localObject1 = ((StringBuilder)localObject1).toString();
        this.jdField_b_of_type_JavaLangString = ((String)localObject1);
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getSharedPreferences("now_tab_sp", 0).edit().putString("now_show_key" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), (String)localObject1);
        if (this.jdField_a_of_type_Boolean) {}
    ...
    for (boolean bool = false;; bool = true)
    {
      ...
      QLog.i("Q.qqstory.fourTab", 2, "userNoChange mNowTabShowState=" + this.jdField_a_of_type_Int + " result:" + localObject1 + "  plan=" + c1);
      break;
      i = 1;
      break label691;
    }
  ...
  public boolean b()
  {
    if (a())
    {
      Iterator localIterator = ((RedTouchManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(35)).b().iterator();
