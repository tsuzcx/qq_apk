...
public class PluginJumpManager
{
  ...
  public HashMap<String, aayb> mBidInfos;
  public int mConfigVersion;
  public Context mContext;
  public PluginManagerClient mPluginManager;
  public SharedPreferences mPref;
  public HashMap<String, aayc> mUrlmappingInfos;
  ...
  {
    bdll.b(null, "P_CliOper", paramString1, "", paramString2, paramString3, 0, paramInt, paramString4, paramString5, paramString6, paramString7);
  }
  
  public boolean checkQVerAndModel(aayc paramaayc)
  {
    boolean bool2 = true;
    int i;
    boolean bool1;
    ...
    try
    {
      ...
      if (TextUtils.isEmpty(paramaayc.e)) {
        if (TextUtils.isEmpty(paramaayc.d))
        {
          bool1 = bool2;
          bool2 = bool1;
          if (!TextUtils.isEmpty(paramaayc.f))
          {
            Object localObject = Build.BRAND;
            String str2 = Build.MODEL;
            String str1 = Build.VERSION.RELEASE;
            paramaayc = paramaayc.f.split(",");
            ...
            if (i < j)
            {
              localObject = paramaayc[i].toLowerCase();
    ...
    for (;;)
    {
      try
      {
        j = Integer.valueOf(paramaayc.d).intValue();
        if (i < j) {
          break label294;
        }
        bool1 = true;
      ...
      String[] arrayOfString = paramaayc.e.split(",");
    ...
    catch (NumberFormatException localNumberFormatException)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          while (i < k)
          {
            localObject3 = new aayb(this);
            JSONObject localJSONObject = ((JSONArray)localObject2).getJSONObject(i);
            ((aayb)localObject3).jdField_a_of_type_JavaLangString = localJSONObject.optString("bid");
            ((aayb)localObject3).b = localJSONObject.optString("pluginid");
            ((aayb)localObject3).c = localJSONObject.optString("pluginname");
            this.mBidInfos.put(((aayb)localObject3).jdField_a_of_type_JavaLangString, localObject3);
            i += 1;
          }
          ...
          while (i < k)
          {
            localObject2 = new aayc(this);
            localObject3 = ((JSONArray)localObject1).getJSONObject(i);
            ((aayc)localObject2).jdField_a_of_type_JavaLangString = ((JSONObject)localObject3).optString("url");
            ((aayc)localObject2).b = ((JSONObject)localObject3).optString("activity");
            ((aayc)localObject2).c = ((JSONObject)localObject3).optString("bid");
            ((aayc)localObject2).f = ((JSONObject)localObject3).optString("a_black_ver");
            ((aayc)localObject2).d = ((JSONObject)localObject3).optString("q_min_ver");
            ((aayc)localObject2).e = ((JSONObject)localObject3).optString("q_white_ver");
            ((aayc)localObject2).jdField_a_of_type_Boolean = ((JSONObject)localObject3).optBoolean("useiphonetitlebar");
            ((aayc)localObject2).g = ((JSONObject)localObject3).optString("extra");
            this.mUrlmappingInfos.put(((aayc)localObject2).jdField_a_of_type_JavaLangString, localObject2);
            i += 1;
          }
          if (!QLog.isColorLevel()) {}
        }
  ...
  {
    Object localObject1 = new File(nmp.a("1007") + "1007" + "/urlplugin.cfg");
    ...
    label103:
    Object localObject2 = noe.a(localInputStream);
    try
    {
      localObject2 = new JSONObject((String)localObject2);
      SharedPreferences.Editor localEditor = this.mPref.edit();
      localEditor.putString("config_file_version", nmj.a("1007"));
  ...
  public boolean openView(Activity paramActivity, String paramString1, String paramString2, String paramString3, String paramString4, boolean paramBoolean)
  {
    ...
    localObject1 = (aayc)this.mUrlmappingInfos.get(localObject1);
    Object localObject2 = ((aayc)localObject1).c;
    if ((TextUtils.isEmpty((CharSequence)localObject2)) || (!this.mBidInfos.containsKey(localObject2))) {
      return false;
    }
    if (!checkQVerAndModel((aayc)localObject1)) {
      return false;
    }
    if (!TextUtils.isEmpty(((aayc)localObject1).g))
    {
      String[] arrayOfString;
      int j;
      if (((aayc)localObject1).g.contains(","))
      {
        arrayOfString = ((aayc)localObject1).g.split(",");
        int k = arrayOfString.length;
        j = 0;
        i = 0;
        while (i < k)
      ...
      else
      {
        ...
        if (!paramString1.contains(((aayc)localObject1).g)) {
          return false;
        }
      }
    }
    localObject2 = (aayb)this.mBidInfos.get(localObject2);
    PluginManagerHelper.getPluginInterface(paramActivity.getApplicationContext(), new aaya(this, (aayb)localObject2, paramActivity, paramString3, paramString1, paramString4, l, (aayc)localObject1, paramString2));
    return true;
  }
  ...
  public void updateConfig(AppRuntime paramAppRuntime)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      nmj.b("1007", paramAppRuntime, true, new aaxy(this));
      return;
    }
  }
}
