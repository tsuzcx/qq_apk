...
public class VSDispatchObserver$3
  implements Runnable
{
  public VSDispatchObserver$3(zwz paramzwz, boolean paramBoolean, long paramLong1, VSBaseRequest paramVSBaseRequest, byte[] paramArrayOfByte, zxa paramzxa, String paramString, MessageMicro paramMessageMicro, long paramLong2) {}
  ...
  public void run()
  {
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Long == 0L) && (this.jdField_a_of_type_ComTencentBizRichframeworkNetworkRequestVSBaseRequest.isEnableCache())) {
      zwz.a(this.this$0, this.jdField_a_of_type_ComTencentBizRichframeworkNetworkRequestVSBaseRequest, this.jdField_a_of_type_ArrayOfByte);
    }
    zwz.a(this.this$0, this.jdField_a_of_type_ComTencentBizRichframeworkNetworkRequestVSBaseRequest, this.jdField_a_of_type_Zxa, this.jdField_a_of_type_Long, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Boolean, this.jdField_a_of_type_ComTencentMobileqqPbMessageMicro);
