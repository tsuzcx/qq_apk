...
public class SimpleEventBus$1$1
  implements Runnable
{
  public SimpleEventBus$1$1(zwq paramzwq, String paramString, Bundle paramBundle) {}
  
  public void run()
  {
    QLog.d("SimpleEventBus", 4, "onServerCall action" + this.jdField_a_of_type_JavaLangString);
    if (zwp.b.equals(this.jdField_a_of_type_JavaLangString)) {
      if (this.jdField_a_of_type_AndroidOsBundle != null)
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject)) {
          this.jdField_a_of_type_Zwq.a.a(new PraisedUpdateEvents((String)localObject, i, j));
        }
      }
    }
    while (!zwp.c.equals(this.jdField_a_of_type_JavaLangString))
    {
      int i;
      int j;
      return;
    ...
    this.jdField_a_of_type_Zwq.a.a((SimpleBaseEvent)localObject);
  }
}
