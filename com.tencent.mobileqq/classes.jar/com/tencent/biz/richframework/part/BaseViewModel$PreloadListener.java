  ...
  implements OnTaskListener
{
  ...
  BaseViewModel$PreloadListener(BaseViewModel paramBaseViewModel)
  {
    this.a = new WeakReference(paramBaseViewModel);
  }
  ...
  public void onComplete(Object[] paramArrayOfObject)
  {
    ...
    if (localObject != null)
    {
      ...
      if (localObject != null) {
        ((BaseViewModel)localObject).c(paramArrayOfObject);
      }
    }
  }
}
 ...
 * Qualified Name:     com.tencent.biz.richframework.part.BaseViewModel.PreloadListener
