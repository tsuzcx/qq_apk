...
class PublicAccountImageCollectionMainActivity$ScaleGestureListener
  implements ScaleGestureDetector.OnScaleGestureListener
{
  private PublicAccountImageCollectionMainActivity$ScaleGestureListener(PublicAccountImageCollectionMainActivity paramPublicAccountImageCollectionMainActivity) {}
  ...
  public boolean onScale(ScaleGestureDetector paramScaleGestureDetector)
  {
    ...
    if ((this.a.jdField_b_of_type_AndroidViewViewGroup != null) && ((this.a.jdField_b_of_type_AndroidViewViewGroup.getTag() instanceof PublicAccountImageCollectionAdapter.ImageItemHolder)))
    {
      ...
      if ((paramScaleGestureDetector != null) && ((paramScaleGestureDetector instanceof ZImageView)))
      {
        ...
        i = ((PublicAccountImageCollectionAdapter.ImageItemHolder)this.a.jdField_b_of_type_AndroidViewViewGroup.getTag()).jdField_a_of_type_Int;
        if (PublicAccountImageCollectionMainActivity.a(this.a).a != null)
        {
          ...
          ((IPublicAccountReportUtils)QRoute.api(IPublicAccountReportUtils.class)).publicAccountReportClickEvent(null, this.a.jdField_a_of_type_JavaLangString, "0X8007B91", "0X8007B91", 0, 0, this.a.jdField_b_of_type_JavaLangString, this.a.jdField_c_of_type_JavaLangString, paramScaleGestureDetector, "1", false);
        }
      }
    }
 ...
 * Qualified Name:     com.tencent.biz.publicAccountImageCollection.PublicAccountImageCollectionMainActivity.ScaleGestureListener
