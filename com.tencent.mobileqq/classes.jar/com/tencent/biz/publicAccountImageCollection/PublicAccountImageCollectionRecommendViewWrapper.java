...
public class PublicAccountImageCollectionRecommendViewWrapper
{
  ...
  static ArrayList<PublicAccountImageCollectionUtils.RecommendItemInfo> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  static boolean jdField_a_of_type_Boolean = false;
  private static int b;
  private Activity jdField_a_of_type_AndroidAppActivity;
  protected AdapterView.OnItemClickListener a;
  
  public PublicAccountImageCollectionRecommendViewWrapper(Activity paramActivity, ArrayList<PublicAccountImageCollectionUtils.RecommendItemInfo> paramArrayList, int paramInt1, int paramInt2, boolean paramBoolean)
  {
  ...
  private ArrayList<PublicAccountImageCollectionUtils.RecommendItemInfo> a(ArrayList<PublicAccountImageCollectionUtils.RecommendItemInfo> paramArrayList)
  {
  ...
  private void a(RelativeLayout paramRelativeLayout)
  {
    ...
    int j = (b - i) / 2;
    paramRelativeLayout = (GridView)paramRelativeLayout.findViewById(2131376741);
  ...
  public View a(Activity paramActivity, View paramView, ViewGroup paramViewGroup)
  {
    ...
    paramActivity = (RelativeLayout)LayoutInflater.from(paramActivity).inflate(2131559709, paramViewGroup, false);
    ...
    paramView.jdField_a_of_type_ComTencentWidgetGridView = ((GridView)paramActivity.findViewById(2131376741));
    paramView.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsAlphaMaskView = ((VideoFeedsAlphaMaskView)paramActivity.findViewById(2131371077));
    paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramActivity.findViewById(2131376727));
