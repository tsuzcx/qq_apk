...
public class PublicAccountImageCollectionPreloadManager
{
  ...
  {
    ThreadManager.postImmediately(new mxt(this, paramString, paramArrayOfByte), null, true);
  }
  
  private void a(List paramList)
  {
    ThreadManager.post(new mxu(this, paramList), 5, null, true);
  }
  ...
  {
    ThreadManager.executeOnFileThread(new mxx(this, paramString));
  }
  ...
  private void d(String paramString)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      {
        this.jdField_b_of_type_ComTencentBizPubaccountPublicAccountArticleObserver = new mxr(this, l);
        localPublicAccountArticleHandler.a(this.jdField_b_of_type_ComTencentBizPubaccountPublicAccountArticleObserver);
      }
      ThreadManager.executeOnSubThread(new mxs(this, localPublicAccountArticleHandler, paramString));
    }
  }
  ...
  public void a()
  {
    ThreadManager.executeOnSubThread(new mxw(this));
  }
  ...
  {
    this.jdField_a_of_type_AndroidOsHandler.post(new mxq(this, paramPhotoCollectionInfo));
  }
  ...
  {
    StatisticCollector.a(BaseApplication.getContext()).a(BaseApplicationImpl.getApplication().getRuntime().getAccount(), "eventPAAlbumRequestAlbumHitStatics", paramBoolean, 0L, 0L, null, "");
    if (QLog.isColorLevel())
    {
  ...
  public void a(boolean paramBoolean, int paramInt)
  {
    ...
    StatisticCollector.a(BaseApplication.getContext()).a(BaseApplicationImpl.getApplication().getRuntime().getAccount(), "eventPAAlbumCacheHitStatics", paramBoolean, 0L, 0L, (HashMap)localObject, "");
    if (QLog.isColorLevel())
    {
  ...
  public void a(boolean paramBoolean, long paramLong)
  {
    ...
    StatisticCollector.a(BaseApplication.getContext()).a(BaseApplicationImpl.getApplication().getRuntime().getAccount(), "eventPAAlbumRequestAlbumTime", paramBoolean, paramLong, 0L, null, "");
    if (QLog.isColorLevel())
    {
      StringBuilder localStringBuilder = new StringBuilder("\n");
  ...
  {
    paramLong = NetConnInfoCenter.getServerTimeMillis() - paramLong;
    StatisticCollector.a(BaseApplication.getContext()).a(BaseApplicationImpl.getApplication().getRuntime().getAccount(), "eventPAAlbumPreDownPhotoTime", paramBoolean, paramLong, 0L, null, "");
    if (QLog.isColorLevel())
    {
      StringBuilder localStringBuilder = new StringBuilder("\n");
  ...
  public void d()
  {
    ThreadManager.post(new mxv(this), 5, null, false);
  }
}
