  ...
  extends BaseAdapter
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = LayoutInflater.from(PublicAccountImageCollectionRecommendViewWrapper.a()).inflate(2130969196, paramViewGroup, false);
      paramViewGroup = new mxz(this);
      ...
      paramViewGroup.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)paramView.findViewById(2131365537));
      ...
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131365538));
    ...
    for (;;)
    {
      ...
      i = 1;
      break;
      paramViewGroup = (mxz)paramView.getTag();
    }
  }
}
