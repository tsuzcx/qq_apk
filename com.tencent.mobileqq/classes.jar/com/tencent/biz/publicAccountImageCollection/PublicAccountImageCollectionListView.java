  ...
  implements AbsListView.OnScrollListener
{
  ...
  private ArrayList<PublicAccountImageCollectionUtils.PhotoItemInfo> jdField_b_of_type_JavaUtilArrayList = null;
  private boolean jdField_b_of_type_Boolean = false;
  private int jdField_c_of_type_Int = 0;
  private ArrayList<PublicAccountImageCollectionUtils.RecommendItemInfo> jdField_c_of_type_JavaUtilArrayList = null;
  ...
  private void a(int paramInt)
  {
    ...
    if ((((View)localObject).getTag() instanceof PublicAccountImageCollectionAdapter.ImageItemHolder))
    {
      ...
      if (((PublicAccountImageCollectionAdapter.ImageItemHolder)localObject).jdField_a_of_type_AndroidWidgetTextView.getBottom() != ((PublicAccountImageCollectionAdapter.ImageItemHolder)localObject).jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewImageloaderZImageView.getBottom()) {
        paramInt = ((PublicAccountImageCollectionAdapter.ImageItemHolder)localObject).jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewImageloaderZImageView.getBottom() + i;
      }
    }
    for (;;)
    {
  ...
  private void d()
  {
    ...
    if (this.jdField_c_of_type_JavaUtilArrayList != null)
    {
      ...
      while (i < j)
      {
        PublicAccountImageCollectionPreloadManager.a().a(((PublicAccountImageCollectionUtils.RecommendItemInfo)this.jdField_c_of_type_JavaUtilArrayList.get(i)).d);
        i += 1;
      }
    }
  ...
  void a(View paramView)
  {
    ...
    if ((paramView != null) && (paramView.getTag() != null))
    {
      ...
      localVideoFeedsAlphaMaskView = ((PublicAccountImageCollectionAdapter.ImageItemHolder)paramView.getTag()).jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsAlphaMaskView;
    ...
    for (;;)
    {
      ...
      {
        localVideoFeedsAlphaMaskView = ((PublicAccountImageCollectionAdapter.CoverHolder)paramView.getTag()).jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsAlphaMaskView;
        break;
      }
      if (!(paramView.getTag() instanceof PublicAccountImageCollectionRecommendViewWrapper.RecommendHolder)) {
        break;
      }
      localVideoFeedsAlphaMaskView = ((PublicAccountImageCollectionRecommendViewWrapper.RecommendHolder)paramView.getTag()).jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsAlphaMaskView;
      break;
      label160:
      f1 = f2;
    }
      ...
      do
      {
        ...
        if ((this.d) && (this.jdField_a_of_type_JavaUtilArrayList != null) && (localViewGroup != null))
        {
          ...
          while (localIterator.hasNext()) {
            ((PublicAccountImageCollectionListView.ListViewEventListener)localIterator.next()).a(localViewGroup.getTag());
          }
        }
        ImageManager.a().c();
  ...
  public void setPhotoCollectionInfo(ArrayList<PublicAccountImageCollectionUtils.PhotoItemInfo> paramArrayList)
  {
    this.jdField_b_of_type_JavaUtilArrayList = paramArrayList;
    a(1, 1);
  }
  
  public void setRecommendInfo(ArrayList<PublicAccountImageCollectionUtils.RecommendItemInfo> paramArrayList)
  {
