...
public class TroopInfoActivityHelper
{
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, ProtoUtils.TroopProtocolObserver paramTroopProtocolObserver)
  {
    ...
    ProtoUtils.b(paramQQAppInterface, paramTroopProtocolObserver, localReqBody.toByteArray(), "OidbSvc.0x6f6_0", 1782, 0);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, TroopInfoActivityHelper.IGetSameCityCheckTypeInfo paramIGetSameCityCheckTypeInfo)
  {
    ...
    ((NewIntent)localObject).setObserver(new TroopInfoActivityHelper.1(paramQQAppInterface, paramIGetSameCityCheckTypeInfo));
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong1, String paramString1, int paramInt1, long paramLong2, long paramLong3, long paramLong4, String paramString2, long paramLong5, List<String> paramList, String paramString3, long paramLong6, int paramInt2, String paramString4, TroopInfoActivityHelper.ISetSameCityCheckTypeInfo paramISetSameCityCheckTypeInfo)
  {
    ...
    paramString1.setObserver(new TroopInfoActivityHelper.2(paramQQAppInterface, paramISetSameCityCheckTypeInfo));
  ...
  private static void b(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, TroopInfoActivityHelper.ISetSameCityCheckTypeInfo paramISetSameCityCheckTypeInfo)
  {
    try
    {
      ...
      if ((paramQQAppInterface == null) || (!paramQQAppInterface.uint32_result.has()) || (paramQQAppInterface.uint32_result.get() != 0) || (!paramQQAppInterface.bytes_bodybuffer.has()) || (paramQQAppInterface.bytes_bodybuffer.get() == null))
      {
        paramISetSameCityCheckTypeInfo.a(paramQQAppInterface.str_error_msg.get());
        return;
      }
