...
public class TroopCardAppInfoHelper
{
  ...
  private void a(List<Long> paramList)
  {
    ...
    ((NewIntent)localObject).setObserver(new TroopCardAppInfoHelper.2(this));
  ...
  {
    return a(paramString, paramIGetAppInfoCB, false);
  }
  
  public boolean a(String paramString, TroopCardAppInfoHelper.IGetAppInfoCB paramIGetAppInfoCB, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      paramIGetAppInfoCB.setObserver(new TroopCardAppInfoHelper.1(this, paramBoolean));
