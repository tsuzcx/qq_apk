...
public class CrmUtils
{
  ...
  public static int a(String paramString)
  {
    ...
    //   2: aload_0
    //   3: ldc 71
    //   5: invokevirtual 77	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   8: astore_0
    //   9: iconst_0
    //   10: istore_1
    //   11: iload_1
    ...
    //   30: iload_2
    //   31: aaload
    //   32: invokestatic 83	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   35: lstore 8
    //   37: lload 4
    //   39: ldc2_w 84
    //   42: lload 6
    ...
    //   60: istore_1
    //   61: aload_0
    //   62: invokevirtual 88	java/lang/Exception:printStackTrace	()V
    //   65: iload_1
    //   66: istore_3
    //   67: iload_3
    //   68: ireturn
  ...
  public static Intent a(Context paramContext, Intent paramIntent, String paramString, boolean paramBoolean1, int paramInt1, boolean paramBoolean2, int paramInt2)
  {
    try
    {
      bool = ((QidianManager)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(QQManagerFactory.QIDIAN_MANAGER)).c(paramString, false);
      if (bool) {
        if (paramIntent == null)
        {
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, String paramString)
  {
    ...
    for (;;)
    {
        ...
        if (localObject == null)
        {
          ...
          if (localObject != null)
          {
            ...
            if (localObject == null)
            {
              ...
              if ((paramContext instanceof Activity)) {
                localQQProgressDialog = new QQProgressDialog(paramContext, paramContext.getResources().getDimensionPixelSize(2131299166));
              }
      ...
      try
      {
        ...
        ((NewIntent)localObject).setObserver(new CrmUtils.2(paramContext, paramQQAppInterface, localQQProgressDialog, paramSessionInfo, paramString));
        ...
        try
        {
          ...
          a(2131695271, localQQProgressDialog);
          return;
        }
  ...
  private static void b(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, PublicAccountInfo paramPublicAccountInfo, EqqDetail paramEqqDetail, String paramString)
  {
    ...
    for (;;)
    {
      if (bool)
      {
        ...
        if ((paramContext instanceof Activity)) {
          paramPublicAccountInfo = new QQProgressDialog(paramContext, paramContext.getResources().getDimensionPixelSize(2131299166));
        }
        if (paramPublicAccountInfo != null) {
          paramPublicAccountInfo.setCanceledOnTouchOutside(true);
        }
        NewIntent localNewIntent = new NewIntent(paramContext.getApplicationContext(), ((IPublicAccountServlet)QRoute.api(IPublicAccountServlet.class)).getServletClass());
        ...
        localNewIntent.setObserver(new CrmUtils.3(paramContext, paramQQAppInterface, paramPublicAccountInfo, paramEqqDetail, paramSessionInfo, paramString));
        paramQQAppInterface.startServlet(localNewIntent);
      }
      try
      {
        if (((paramContext instanceof Activity)) && (!((Activity)paramContext).isFinishing())) {
          a(2131695271, paramPublicAccountInfo);
        }
        label268:
        if (QLog.isColorLevel()) {
  ...
  public static void b(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2)
  {
    ...
    {
      new QQToastNotifier(paramContext).a(2131693379, paramContext.getResources().getDimensionPixelSize(2131299166), 0, 1);
      return;
    }
