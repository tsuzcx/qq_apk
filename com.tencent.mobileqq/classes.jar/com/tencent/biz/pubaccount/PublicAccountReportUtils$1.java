  ...
  public void run()
  {
    ...
    try
    {
      ...
      if ((localObject instanceof QQAppInterface))
      {
        ...
        if (localObject != null) {
          if (!((anrs)((AppInterface)localObject).getManager(56)).a(Long.valueOf(this.jdField_b_of_type_JavaLangString))) {
            break label135;
          }
        }
        label135:
        for (localObject = "1";; localObject = "0")
        {
          ...
          oat.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_b_of_type_JavaLangString, this.c, this.d, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, this.e, this.f, this.g, (String)localObject, this.jdField_a_of_type_Boolean);
          return;
        }
      }
    }
