  ...
  implements Runnable
{
  public void run()
  {
    try
    {
      ...
      ((oidb_0x6cf.ReqBody)localObject1).uint32_req_network.set(ofc.a(this.this$0));
      ((oidb_0x6cf.ReqBody)localObject1).uint32_req_os.set(1);
      ((oidb_0x6cf.ReqBody)localObject1).uint32_req_sim_type.set(bkwm.d());
      ...
      for (;;)
      {
        ...
        ((ToServiceMsg)localObject1).addAttribute("VALUE_OBSERVER_TAG", Integer.valueOf(this.jdField_a_of_type_Ofd.hashCode()));
