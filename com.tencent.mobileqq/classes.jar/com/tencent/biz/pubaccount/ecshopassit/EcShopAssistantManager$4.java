  ...
  public void onReceive(Context arg1, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      if ("action_get_PA_head".equals(???))
      {
        ...
        if ((TextUtils.isEmpty(???)) || (this.a.jdField_a_of_type_ComTencentMobileqqAppFaceIFaceDecoder == null)) {
          continue;
        }
      ...
      if ("action_folder_set_read".equals(???))
      {
        ...
        {
          ??? = this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().a(???, 1008);
          if (??? != null) {
            this.a.a(???.time);
          }
        }
      ...
      try
      {
        ...
        bool = ((PublicAccountDataManager)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.PUBLICACCOUNTDATA_MANAGER)).a(Long.valueOf(l));
