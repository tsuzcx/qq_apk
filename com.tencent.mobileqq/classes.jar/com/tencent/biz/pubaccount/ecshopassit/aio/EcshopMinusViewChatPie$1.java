...
{
  EcshopMinusViewChatPie$1(EcshopMinusViewChatPie paramEcshopMinusViewChatPie, IEcshopChatPie.IRefreshCallback paramIRefreshCallback) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localQQAdGetRsp.qgg_msgs.has())
        {
          ...
          if ((paramBundle != null) && (!paramBundle.isEmpty()))
          {
            ...
            while (paramBundle.hasNext())
            {
              ...
              {
                EcshopMinusViewChatPie.a(this.jdField_a_of_type_ComTencentBizPubaccountEcshopassitAioEcshopMinusViewChatPie).add(localMessageForArkApp);
              ...
              ReportUtil.a().a.put(Long.valueOf(localMessageForArkApp.uniseq), localMessageForArkApp);
              paramInt += 1;
            }
          }
        }
        ...
        {
          paramBundle = (EcshopAdHandler)((QQAppInterface)paramBundle).getBusinessHandler(BusinessHandlerFactory.ESHOP_AD_HANDLER);
          if (paramBundle != null)
          {
            if (QLog.isColorLevel()) {
        ...
        if (this.jdField_a_of_type_ComTencentBizPubaccountEcshopassitAioIEcshopChatPie$IRefreshCallback != null) {
          this.jdField_a_of_type_ComTencentBizPubaccountEcshopassitAioIEcshopChatPie$IRefreshCallback.a(EcshopMinusViewChatPie.a(this.jdField_a_of_type_ComTencentBizPubaccountEcshopassitAioEcshopMinusViewChatPie));
        }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.ecshopassit.aio.EcshopMinusViewChatPie.1
