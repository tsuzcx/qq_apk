  ...
  extends BusinessHandler
{
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    do
    {
      ...
      paramMessageRecord = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().a(((EcShopData)localObject).mUin, 1008);
      ...
      if ("1".equals(paramMessageRecord.getExtInfoFromExtStr("is_AdArrive_Msg")))
      {
        if ((paramMessageRecord instanceof MessageForStructing))
        {
          ...
          if ((paramString instanceof StructMsgForGeneralShare))
          {
            ...
            {
              paramString = (AbsStructMsgElement)paramString.mStructMsgItemLists.get(0);
              if ((paramString != null) && (!EcShopAssistantManager.b(paramString.Y)))
              {
                paramString = new EcshopAdHandler.ReportInfo();
                paramString.a = 3;
                paramMessageRecord = EcshopAdHandler.a(paramString, paramMessageRecord);
                paramMessageRecord.f = paramInt;
                ((EcshopAdHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.ESHOP_AD_HANDLER)).a(paramMessageRecord, null);
              }
            }
          }
        }
  ...
  public void b(MessageRecord paramMessageRecord)
  {
    ...
    try
    {
      ...
      {
        localObject1 = new EcshopAdHandler.ReportInfo();
        ((EcshopAdHandler.ReportInfo)localObject1).a = 1;
        localObject1 = EcshopAdHandler.a((EcshopAdHandler.ReportInfo)localObject1, paramMessageRecord);
        ((EcshopAdHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.ESHOP_AD_HANDLER)).a((EcshopAdHandler.ReportInfo)localObject1, null);
      }
    }
    catch (Throwable paramMessageRecord)
    {
    ...
    try
    {
      j = Integer.parseInt(EcshopUtils.a(paramMessageRecord));
      i = j;
    }
    ...
    if ((paramMessageRecord instanceof MessageForStructing))
    {
      ...
      if ((paramMessageRecord instanceof StructMsgForGeneralShare))
      {
        ...
        if ((paramMessageRecord.mStructMsgItemLists != null) && (paramMessageRecord.mStructMsgItemLists.size() > 0))
        {
          ...
          GdtC2SReporter.a(0, 2, EcShopAssistantManager.a(paramMessageRecord));
          if ((paramMessageRecord.a instanceof StructMsgForGeneralShare))
          {
            EcshopUtils.a(paramMessageRecord.g, false);
            ReportUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "qgg.push.arrive", ((StructMsgForGeneralShare)paramMessageRecord.a).mContentTitle, NetConnInfoCenter.getServerTimeMillis() + "", "", i);
            ReportUtil.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "qgg_push_arrive", ((StructMsgForGeneralShare)paramMessageRecord.a).mContentTitle, NetConnInfoCenter.getServerTimeMillis() + "", "", i);
          }
        }
      }
    }
    ...
    {
      localObject1 = EcShopAssistantManager.a(paramMessageRecord);
      if (localObject1 != null) {
        GdtC2SReporter.a(0, 2, (qq_ad_get.QQAdGetRsp.AdInfo)localObject1);
      }
      localObject1 = (MessageForArkApp)paramMessageRecord;
      localObject2 = ((MessageForArkApp)localObject1).ark_app_message;
      if ((localObject2 != null) && (!StringUtil.a(((ArkAppMessage)localObject2).mSourceAd)) && ("gw".equals(new JSONObject(((ArkAppMessage)localObject2).mSourceAd).optString("from"))))
      {
        paramMessageRecord = ReportUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord);
        ReportUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "qgg.push.arrive", ((MessageForArkApp)localObject1).msg, NetConnInfoCenter.getServerTimeMillis() + "", paramMessageRecord, i);
        ReportUtil.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "qgg_push_arrive", ((MessageForArkApp)localObject1).msg, NetConnInfoCenter.getServerTimeMillis() + "", paramMessageRecord, i);
        return;
        if ((paramMessageRecord instanceof MessageForArkApp))
        {
          localObject2 = (MessageForArkApp)paramMessageRecord;
          localObject3 = ((MessageForArkApp)localObject2).ark_app_message;
          if ((localObject3 != null) && (!StringUtil.a(((ArkAppMessage)localObject3).mSourceAd)))
          {
            ...
            if ("gw".equals(((JSONObject)localObject3).optString("from"))) {
              localObject3 = ReportUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord);
            }
          }
        }
        try
        {
          i = Integer.parseInt(EcshopUtils.a(paramMessageRecord));
          ReportUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "qgg.push.arrive", ((MessageForArkApp)localObject2).msg, NetConnInfoCenter.getServerTimeMillis() + "", (String)localObject3, i);
          ReportUtil.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "qgg_push_arrive", ((MessageForArkApp)localObject2).msg, NetConnInfoCenter.getServerTimeMillis() + "", (String)localObject3, i);
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((!"SQQShopMsgSvc.GetRichMsgInfo".equals(paramToServiceMsg.getServiceCmd())) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null) || (paramObject == null)) {}
    label433:
    do
    {
      do
    ...
    Object localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getSharedPreferences("ecshop_sp" + (String)localObject1, 0);
