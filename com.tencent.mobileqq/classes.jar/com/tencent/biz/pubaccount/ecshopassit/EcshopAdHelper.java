    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ...
          {
            paramTextView.setBackgroundResource(2130847469);
            paramTextView.setVisibility(0);
            paramTextView.setText(HardCodeUtil.a(2131703644));
            localObject1 = paramContext.getResources().getDrawable(2130847472);
            ((Drawable)localObject1).setBounds(0, 0, 24, 16);
            paramTextView.setCompoundDrawables(null, null, (Drawable)localObject1, null);
            i = UIUtils.a(paramContext, 6.0F);
            paramTextView.setPadding(i, 0, i, 0);
            paramTextView.setCompoundDrawablePadding(UIUtils.a(paramContext, 2.0F));
            ...
            localObject1 = LayoutInflater.from(paramContext).inflate(2131559693, null);
            LinearLayout localLinearLayout = (LinearLayout)((View)localObject1).findViewById(2131370587);
            ...
            if (i < paramString.length())
            {
              ...
              ((LinearLayout)localObject3).setOnClickListener(new EcshopAdHelper.1(this, j, (JSONObject)localObject2, paramContext, paramMessageRecord));
              ...
              ((LinearLayout.LayoutParams)localObject4).height = UIUtils.a(paramContext, 50.0F);
              ...
              ((LinearLayout.LayoutParams)localObject5).width = UIUtils.a(paramContext, 20.0F);
              ((LinearLayout.LayoutParams)localObject5).height = UIUtils.a(paramContext, 18.0F);
              ((LinearLayout.LayoutParams)localObject5).leftMargin = UIUtils.a(paramContext, 15.0F);
              localObject5 = ((JSONObject)localObject2).optString("icon_url", "");
              if (!StringUtil.a((String)localObject5))
              {
                URLDrawable.URLDrawableOptions localURLDrawableOptions = URLDrawable.URLDrawableOptions.obtain();
                localURLDrawableOptions.mRequestHeight = UIUtils.a(paramContext, 20.0F);
                localURLDrawableOptions.mRequestWidth = UIUtils.a(paramContext, 18.0F);
              ...
              ((LinearLayout.LayoutParams)localObject3).leftMargin = UIUtils.a(paramContext, 10.0F);
              ...
              ((LinearLayout.LayoutParams)localObject3).height = UIUtils.a(paramContext, 1.0F);
        ...
        catch (JSONException paramString)
        {
          ...
          paramTextView.setOnClickListener(new EcshopAdHelper.2(this, paramContext, paramTextView, paramMessageRecord));
          return true;
        }
        return false;
      }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.ecshopassit.EcshopAdHelper
