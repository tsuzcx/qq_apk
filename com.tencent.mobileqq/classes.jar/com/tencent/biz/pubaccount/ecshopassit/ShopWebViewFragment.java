  ...
  implements ahpo
{
  ...
  akuo jdField_a_of_type_Akuo = new nrp(this, 0, true, false, 600000L, false, false, "ecshop");
  BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new nro(this);
    ...
    do
    {
      for (;;)
      {
        ...
        while (this.jdField_a_of_type_AndroidViewView != null)
        {
          ...
          this.jdField_a_of_type_Nrj.a(this.jdField_a_of_type_JavaUtilList);
  ...
  {
    this.jdField_a_of_type_ComTencentWidgetSwipListView = ((SwipListView)paramLayoutInflater.inflate(2131559776, null));
    paramLayoutInflater = paramLayoutInflater.inflate(2131561493, null);
    paramLayoutInflater.findViewById(2131363515).setOnClickListener(new nrm(this));
    if (this.jdField_a_of_type_Boolean)
    {
      localObject = paramLayoutInflater.findViewById(2131377557);
      View localView = paramLayoutInflater.findViewById(2131363515);
      if (localObject != null) {
        ((View)localObject).setBackgroundColor(Color.parseColor("#FFFFFFFF"));
      }
      if (localView != null) {
        localView.setBackgroundResource(2130846193);
      }
      localObject = (TextView)paramLayoutInflater.findViewById(2131363682);
      ((TextView)localObject).setTextColor(Color.parseColor("#FF000000"));
      ((TextView)localObject).setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130838564, 0);
      paramLayoutInflater.findViewById(2131365268).setBackgroundColor(Color.parseColor("#FFF9F9FB"));
      this.jdField_a_of_type_ComTencentWidgetSwipListView.setBackgroundResource(2131166107);
    }
    this.jdField_a_of_type_ComTencentWidgetSwipListView.addHeaderView(paramLayoutInflater);
    this.jdField_a_of_type_Nrj = new nrj(getActivity(), this.jdField_a_of_type_ComTencentWidgetSwipListView, this.jdField_a_of_type_Nrd, this.jdField_a_of_type_ArrayOfJavaLangString[0]);
    this.jdField_a_of_type_ComTencentWidgetSwipListView.setAdapter(this.jdField_a_of_type_Nrj);
    this.jdField_a_of_type_Nrj.a(this.jdField_a_of_type_JavaUtilList);
    this.jdField_a_of_type_Nrj.a(this.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragFrameLayout);
    this.jdField_a_of_type_ComTencentWidgetSwipListView.setDragEnable(true);
    if ((getActivity() instanceof bfvx)) {
      this.jdField_a_of_type_ComTencentWidgetSwipListView.setRightIconMenuListener((bfvx)getActivity());
    }
    if (!this.jdField_a_of_type_Boolean) {
      return;
    }
    ...
    this.jdField_a_of_type_ComTencentWidgetSwipListView.setOnTouchListener(new nrn(this, paramLayoutInflater, (JSONObject)localObject));
  }
  ...
  public void a(boolean paramBoolean, int paramInt, DragFrameLayout paramDragFrameLayout)
  {
    ...
    {
      paramDragFrameLayout = (RecentShopParcel)paramDragFrameLayout.a().getTag(2131373502);
  ...
  public boolean a(Bundle paramBundle)
  {
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      this.jdField_d_of_type_AndroidViewView.setId(2131376457);
      this.jdField_d_of_type_AndroidViewView.setBackgroundResource(2130849032);
      ...
      LayoutInflater.from(getActivity()).inflate(2131558656, this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebBrowserViewContainer);
      this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebBrowserViewContainer.findViewById(2131375329));
      ...
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131368429));
      this.jdField_b_of_type_AndroidWidgetTextView.setOnClickListener(this);
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131368472));
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131368457));
      this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131368441));
  ...
  public int b(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_AndroidViewViewGroup = this.jdField_a_of_type_Bccj.jdField_a_of_type_AndroidViewViewGroup;
    this.jdField_b_of_type_AndroidWidgetTextView = this.jdField_a_of_type_Bccj.jdField_a_of_type_AndroidWidgetTextView;
    this.jdField_c_of_type_AndroidWidgetTextView = this.jdField_a_of_type_Bccj.jdField_b_of_type_AndroidWidgetTextView;
    this.jdField_d_of_type_AndroidWidgetTextView = this.jdField_a_of_type_Bccj.jdField_c_of_type_AndroidWidgetTextView;
    this.jdField_c_of_type_AndroidWidgetImageView = this.jdField_a_of_type_Bccj.jdField_a_of_type_AndroidWidgetImageView;
    v_();
    if (this.h)
    {
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Nrd.b(getActivity(), this.jdField_a_of_type_ArrayOfJavaLangString[3]);
      try
      {
        this.jdField_a_of_type_Nrd.jdField_a_of_type_Nrf.a(134248547, null, null, null, null, 0L, false);
        return;
      }
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    //   32: aload_0
    //   33: invokespecial 436	nrd:<init>	(Lcom/tencent/common/app/AppInterface;Lcom/tencent/biz/pubaccount/ecshopassit/ShopWebViewFragment;)V
    //   36: putfield 216	com/tencent/biz/pubaccount/ecshopassit/ShopWebViewFragment:jdField_a_of_type_Nrd	Lnrd;
    //   39: aload_0
    ...
    //   182: aload_0
    //   183: getfield 216	com/tencent/biz/pubaccount/ecshopassit/ShopWebViewFragment:jdField_a_of_type_Nrd	Lnrd;
    //   186: aload_0
    //   187: getfield 176	com/tencent/biz/pubaccount/ecshopassit/ShopWebViewFragment:jdField_a_of_type_Boolean	Z
    //   190: putfield 508	nrd:jdField_a_of_type_Boolean	Z
    //   193: aload_0
    //   194: getfield 176	com/tencent/biz/pubaccount/ecshopassit/ShopWebViewFragment:jdField_a_of_type_Boolean	Z
    //   197: ifeq +22 -> 219
    //   200: aload_0
    //   201: getfield 216	com/tencent/biz/pubaccount/ecshopassit/ShopWebViewFragment:jdField_a_of_type_Nrd	Lnrd;
    //   204: getfield 414	nrd:jdField_a_of_type_Nrf	Lnrf;
    //   207: ldc_w 509
    //   210: aconst_null
    //   211: aconst_null
    //   212: aconst_null
    ...
    //   214: lconst_0
    //   215: iconst_0
    //   216: invokevirtual 420	nrf:a	(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;JZ)V
    //   219: aload_0
    //   220: getfield 216	com/tencent/biz/pubaccount/ecshopassit/ShopWebViewFragment:jdField_a_of_type_Nrd	Lnrd;
    //   223: getfield 414	nrd:jdField_a_of_type_Nrf	Lnrf;
    //   226: astore 6
    //   228: iload 5
    //   230: ifeq +116 -> 346
    //   233: ldc_w 511
    ...
    //   249: lconst_0
    //   250: iconst_0
    //   251: invokevirtual 420	nrf:a	(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;JZ)V
    //   254: aload_0
    //   255: aload_0
    ...
    //   269: aload_0
    //   270: iconst_0
    //   271: invokevirtual 522	com/tencent/mobileqq/activity/recent/cur/DragFrameLayout:a	(Lahpo;Z)V
    ...
    //   308: pop
    //   309: aload_0
    //   310: getfield 216	com/tencent/biz/pubaccount/ecshopassit/ShopWebViewFragment:jdField_a_of_type_Nrd	Lnrd;
    //   313: astore_1
    //   314: aload_0
    ...
    //   330: aload 6
    //   332: iload_2
    //   333: invokevirtual 539	nrd:a	(Lmqq/app/AppRuntime;I)V
    //   336: return
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    paramViewGroup.addRule(3, 2131375363);
  ...
  public void onDestroy()
  {
    ...
    try
    {
      ...
      label15:
      if (this.jdField_a_of_type_Nrj != null)
      {
        this.jdField_a_of_type_Nrj.a();
        this.jdField_a_of_type_Nrj = null;
      }
  ...
  public void onResume()
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Nrj != null) {
        this.jdField_a_of_type_Nrj.notifyDataSetChanged();
      }
      return;
      label98:
      i = 0;
  ...
  void v_()
  {
    ...
    if (!this.jdField_a_of_type_Boolean)
    {
      this.jdField_c_of_type_AndroidWidgetTextView.setText(ajya.a(2131714008));
      this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
      this.jdField_a_of_type_AndroidWidgetImageView.setId(2131368742);
      this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this);
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130849548);
      localObject1 = (RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131375450);
      localObject2 = new RelativeLayout.LayoutParams(-2, -2);
      ((RelativeLayout.LayoutParams)localObject2).addRule(15);
      ((RelativeLayout.LayoutParams)localObject2).leftMargin = actj.a(10.0F, getResources());
      ((RelativeLayout)localObject1).addView(this.jdField_a_of_type_AndroidWidgetImageView, (ViewGroup.LayoutParams)localObject2);
      this.jdField_a_of_type_AndroidWidgetTextView.setId(2131378015);
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130837689);
      this.jdField_a_of_type_AndroidWidgetTextView.setGravity(17);
      i = actj.a(3.0F, getResources());
      int j = actj.a(4.0F, getResources());
      this.jdField_a_of_type_AndroidWidgetTextView.setPadding(i, 0, i, 0);
      localObject2 = new RelativeLayout.LayoutParams(-2, -2);
      ((RelativeLayout.LayoutParams)localObject2).addRule(15);
      ((RelativeLayout.LayoutParams)localObject2).addRule(1, 2131368742);
      ...
      if (!this.jdField_a_of_type_Boolean)
      {
        ...
        localObject2 = getResources().getColorStateList(2131166852);
    ...
    try
    {
      ...
      ((ViewGroup.MarginLayoutParams)localObject2).topMargin = (axlk.a(29.0F) - ImmersiveUtils.getStatusBarHeight(getActivity().getApplicationContext()));
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if (this.jdField_d_of_type_AndroidViewView != null) {
        this.jdField_d_of_type_AndroidViewView.setBackgroundResource(2130849717);
      }
      i = actj.a(3.0F, getResources());
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setBackgroundResource(2130848498);
      ...
      this.jdField_b_of_type_AndroidWidgetImageView.setImageDrawable(bbef.a(2130846200, getActivity()));
      this.jdField_c_of_type_AndroidWidgetImageView.setImageDrawable(bbef.a(2130846201, getActivity()));
      this.jdField_c_of_type_AndroidWidgetImageView.setOnClickListener(this);
      this.jdField_b_of_type_AndroidWidgetImageView.setOnClickListener(this);
      i = actj.a(4.0F, getResources());
    ...
    for (;;)
    {
      w_();
      return;
      i = actj.a(30.0F, getResources());
      this.jdField_b_of_type_AndroidWidgetImageView = new FadeIconImageView(getActivity());
      this.jdField_b_of_type_AndroidWidgetImageView.setId(2131368446);
      ...
      ((RelativeLayout.LayoutParams)localObject1).addRule(1, 2131368441);
      ...
      if (this.jdField_d_of_type_AndroidViewView != null)
      {
        if ((this.jdField_a_of_type_Bcga != null) && (this.jdField_a_of_type_Bcga.a != null))
        {
          this.jdField_d_of_type_AndroidViewView.setBackgroundColor(this.jdField_a_of_type_Bcga.a.jdField_a_of_type_Int);
          axmv.a(true, this.jdField_a_of_type_Bcga.a.jdField_a_of_type_Int, a().getWindow());
          break label520;
        }
      ...
      F();
      break label520;
      this.jdField_d_of_type_AndroidWidgetTextView.setText(ajya.a(2131714009));
  ...
  void w_()
  {
    ...
    if ((this.jdField_c_of_type_Boolean) && (!this.jdField_a_of_type_Boolean))
    {
      ...
      localObject1 = getString(2131720034) + "(" + this.jdField_a_of_type_Int + ")";
      if (this.jdField_a_of_type_Int > 99) {
        localObject1 = getString(2131720034) + "(99+)";
      }
    }
    Object localObject3;
    for (;;)
    {
      ...
      localObject1 = getString(2131720034);
      localObject3 = localObject1;
      if (!this.jdField_c_of_type_Boolean) {
        break label285;
      }
    ...
    for (;;)
    {
      localObject2 = getResources().getString(2131690572);
