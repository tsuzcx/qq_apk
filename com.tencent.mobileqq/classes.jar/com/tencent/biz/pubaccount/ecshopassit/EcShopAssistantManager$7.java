...
public final class EcShopAssistantManager$7
  implements Runnable
{
  public EcShopAssistantManager$7(Context paramContext, RelativeLayout paramRelativeLayout, Bitmap paramBitmap) {}
  ...
  public void run()
  {
    ...
    localEcShopRainView.post(new EcShopAssistantManager.7.1(this, localEcShopRainView, new opo(this.jdField_a_of_type_AndroidGraphicsBitmap, i)));
  }
}
