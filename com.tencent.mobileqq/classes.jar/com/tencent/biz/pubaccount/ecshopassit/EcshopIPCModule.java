  ...
  extends QIPCModule
{
  ...
  private int a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    int i = ((IPublicAccountUtil)QRoute.api(IPublicAccountUtil.class)).getUinType(paramQQAppInterface, paramString);
  ...
  private int b(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    RecentUser localRecentUser2 = localRecentUserProxy.b(paramString, i);
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.ecshopassit.EcshopIPCModule
