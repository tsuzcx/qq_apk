  ...
  implements Manager
{
  ...
  FaceDecoder.DecodeTaskCompletionListener jdField_a_of_type_ComTencentMobileqqUtilFaceDecoder$DecodeTaskCompletionListener = new lci(this);
  public FaceDecoder a;
  DownloadListener jdField_a_of_type_ComTencentMobileqqVipDownloadListener = new lcg(this);
  ...
  static
  {
    ...
    jdField_b_of_type_JavaLangString = AppConstants.aK + ".shop_assit/image/";
  ...
  public EcShopAssistantManager(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new lch(this);
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      ThreadManager.post(new lcd(this), 5, null, true);
  ...
  public static Drawable a(Context paramContext)
  {
    ...
    {
      Object localObject1 = paramContext.getResources().getDrawable(2130838688);
      ...
      catch (MalformedURLException localMalformedURLException)
      {
        ...
        return paramContext.getResources().getDrawable(2130843974);
      }
    }
    return paramContext.getResources().getDrawable(2130843974);
  }
  ...
  private void h()
  {
    ThreadManager.executeOnSubThread(new lce(this));
  }
  ...
  public List b()
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        {
          ((RecentShopParcel)localObject3).jdField_a_of_type_Int = 2130839766;
    ...
    for (localRecentShopParcel.jdField_a_of_type_Int = 2130839766;; localRecentShopParcel.jdField_a_of_type_Int = 0)
    {
  ...
  {
    ThreadManager.post(new lcf(this, paramString), 5, null, true);
  }
