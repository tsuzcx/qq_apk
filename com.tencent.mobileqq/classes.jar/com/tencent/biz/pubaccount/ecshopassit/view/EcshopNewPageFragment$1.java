  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.i("Ecshop_EcshopNewPageFragment", 2, "redpoint info: " + EcshopUtils.a(localQQAdGetRsp.red_point.get()));
        }
        EcshopNewPageFragment.a(this.a, EcshopUtils.a(localQQAdGetRsp.red_point.get()));
        if ((localQQAdGetRsp.qgg_prompt.has()) && (localQQAdGetRsp.qgg_prompt_id.has()))
        {
          EcshopUtils.a(localQQAdGetRsp.qgg_prompt.get(), localQQAdGetRsp.qgg_prompt_id.get());
          return;
        }
      }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.ecshopassit.view.EcshopNewPageFragment.1
