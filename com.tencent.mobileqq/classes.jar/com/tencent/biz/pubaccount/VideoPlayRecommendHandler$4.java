...
public class VideoPlayRecommendHandler$4
  implements Runnable
{
  public VideoPlayRecommendHandler$4(npv paramnpv, long paramLong, int paramInt, String paramString, npw paramnpw, VideoInfo paramVideoInfo) {}
  ...
  public void run()
  {
    ...
    ((oidb_0x6cf.ReqBody)localObject).uint32_req_sim_type.set(bhvh.c());
    ...
    localObject = pow.a("OidbSvc.0x6cf", 1743, 3, ((oidb_0x6cf.ReqBody)localObject).toByteArray());
    ((ToServiceMsg)localObject).addAttribute("VALUE_OBSERVER_TAG", Integer.valueOf(this.jdField_a_of_type_Npw.hashCode()));
