...
public class VideoPlayRecommendHandler$4
  implements Runnable
{
  public VideoPlayRecommendHandler$4(nps paramnps, long paramLong, int paramInt, String paramString, npt paramnpt, VideoInfo paramVideoInfo) {}
  ...
  public void run()
  {
    ...
    localObject = pot.a("OidbSvc.0x6cf", 1743, 3, ((oidb_0x6cf.ReqBody)localObject).toByteArray());
