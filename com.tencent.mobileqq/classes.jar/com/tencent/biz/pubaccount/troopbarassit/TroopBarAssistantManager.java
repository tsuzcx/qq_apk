...
public class TroopBarAssistantManager
{
  ...
  private List<TroopBarData> a(QQAppInterface paramQQAppInterface, List<TroopBarData> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if (ServiceAccountFolderManager.d(paramQQAppInterface, localTroopBarData.mUin)) {
  ...
  {
    if (!ServiceAccountFolderManager.d(paramQQAppInterface, paramString)) {
      return;
    }
  ...
  private void b(EntityManager arg1, QQAppInterface paramQQAppInterface)
  {
    for (;;)
    {
      ...
      ((TroopBarData)this.jdField_a_of_type_JavaUtilList.get(i)).mLatestMessage = paramQQAppInterface.getMessageFacade().b((String)localObject, 1008);
      break label371;
      label368:
      return;
      label371:
        ...
        if (!this.jdField_a_of_type_JavaLangBoolean.booleanValue())
        {
          ...
          try
          {
            ...
            if (i < ((JSONArray)localObject).length())
            {
              ...
              if (!ServiceAccountFolderManager.d(paramQQAppInterface, str)) {
                continue;
              }
  ...
  {
    paramString = ((PublicAccountDataManager)paramQQAppInterface.getManager(QQManagerFactory.PUBLICACCOUNTDATA_MANAGER)).a(paramString);
    if (paramString != null) {
      return paramString.name;
    }
    return "";
        ...
        if (this.jdField_a_of_type_JavaUtilList != null)
        {
          ...
          if (j >= 0)
          {
            ...
            else
            {
              ...
              {
                MessageRecord localMessageRecord = paramQQAppInterface.getMessageFacade().b(localTroopBarData.mUin, 1008);
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      if (this.jdField_a_of_type_JavaUtilList == null)
      {
        ...
        if (i != 0)
        {
          ...
          ((EntityManager)???).close();
          paramQQAppInterface = ((PublicAccountDataManager)paramQQAppInterface.getManager(QQManagerFactory.PUBLICACCOUNTDATA_MANAGER)).a();
  ...
  public void a(QQAppInterface paramQQAppInterface, List<PublicAccountInfo> paramList)
  {
    ...
    {
      return;
      if (((PublicAccountDataManager)paramQQAppInterface.getManager(QQManagerFactory.PUBLICACCOUNTDATA_MANAGER)).jdField_a_of_type_Boolean) {
        break;
      }
  ...
  public void a(MessageRecord paramMessageRecord, String paramString, long paramLong, EntityManager paramEntityManager, QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      Message localMessage = paramQQAppInterface.getMessageFacade().a(localTroopBarData.mUin, 1008);
    ...
    try
    {
      ...
      if (((List)localObject1).size() > 0)
      {
        ...
        if (((Iterator)localObject1).hasNext())
        {
          ...
          {
            localMessage = paramQQAppInterface.getMessageFacade().a(((TroopBarData)localObject3).mUin, 1008);
            if (localMessage == null) {}
          }
  ...
  {
    ((IPublicAccountUtil)QRoute.api(IPublicAccountUtil.class)).unfollowUin(paramQQAppInterface, paramContext, paramString, true, paramPublicAccountObserver);
  }
  ...
  {
    return (paramInt == 1008) && (ServiceAccountFolderManager.d(paramQQAppInterface, paramString));
  }
  ...
  {
    Object localObject = ((PublicAccountDataManager)paramQQAppInterface.getManager(QQManagerFactory.PUBLICACCOUNTDATA_MANAGER)).a();
    if (localObject != null)
    {
      ArrayList localArrayList = new ArrayList();
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if (ServiceAccountFolderManager.d(paramQQAppInterface, localPublicAccountInfo.getUin())) {
  ...
  public void f(QQAppInterface paramQQAppInterface)
  {
    ...
    if (((ArrayList)localObject2).size() > 0)
    {
      ...
      if (((Iterator)localObject2).hasNext())
      {
        ...
        {
          localObject5 = paramQQAppInterface.getMessageFacade().a(((TroopBarData)localObject4).mUin, 1008);
          if (localObject5 == null) {}
        }
        for (((TroopBarData)localObject4).mLastMsgTime = ((Message)localObject5).time;; ((TroopBarData)localObject4).mLastMsgTime = ((RecentUser)???).lastmsgtime)
        {
    ...
    if (((ArrayList)localObject1).size() > 0)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        if (ReadInJoyHelper.b())
        {
          localObject1 = (PublicAccountDataManager)paramQQAppInterface.getManager(QQManagerFactory.PUBLICACCOUNTDATA_MANAGER);
