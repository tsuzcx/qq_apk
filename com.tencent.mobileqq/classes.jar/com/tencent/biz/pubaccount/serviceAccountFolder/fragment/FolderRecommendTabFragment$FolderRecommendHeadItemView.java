  ...
  extends RelativeFeedBaseHeaderView
{
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqWidgetQQViewPager = ((QQViewPager)paramView.findViewById(2131376319));
    ...
    this.jdField_a_of_type_Aacg.a(zqn.a());
    ...
    this.jdField_a_of_type_Aacg.a(FolderRecommendTabFragment.a());
    this.jdField_a_of_type_Upc = new upc(null);
    this.jdField_a_of_type_ComTencentMobileqqWidgetQQViewPager.setAdapter(this.jdField_a_of_type_Upc);
    this.jdField_a_of_type_ComTencentWidgetCirclePageIndicator = ((CirclePageIndicator)paramView.findViewById(2131376320));
    ...
    this.jdField_a_of_type_ComTencentWidgetCirclePageIndicator.setOnPageChangeListener(new upe(this));
