...
public class ServiceAccountFolderManager$6
  implements Runnable
{
  public ServiceAccountFolderManager$6(saz paramsaz, QQAppInterface paramQQAppInterface) {}
  ...
  public void run()
  {
    ...
    if (localObject != null)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("ServiceAccountFolderManager", 2, "setFolderLastEnterTime->mFolderLastEnterTime:" + saz.a(this.this$0));
      }
    }
  }
}
