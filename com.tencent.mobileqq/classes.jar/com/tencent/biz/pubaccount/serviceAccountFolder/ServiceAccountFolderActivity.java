  ...
  implements Handler.Callback, View.OnClickListener, DragFrameLayout.OnDragModeChangedListener, SwipListView.RightIconMenuListener
{
  ...
  private void a()
  {
    this.jdField_a_of_type_AndroidViewView = super.findViewById(2131364094);
    ...
    this.jdField_a_of_type_AndroidViewViewStub = ((ViewStub)super.findViewById(2131363098));
  }
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_ComTencentWidgetSwipListView.setContentBackground(getResources().getDrawable(2130838211), false);
    this.jdField_a_of_type_ComTencentWidgetSwipListView.setBackgroundResource(2130838211);
  ...
  private void d()
  {
    View localView = super.findViewById(2131363226);
    if (localView != null) {
      IphoneTitleBarActivity.setLayerType(localView);
    }
    localView = super.findViewById(2131362577);
    if (localView != null) {
      IphoneTitleBarActivity.setLayerType(localView);
    }
    localView = super.findViewById(2131363227);
    if (localView != null) {
      IphoneTitleBarActivity.setLayerType(localView);
    }
  }
  ...
  private void e()
  {
    ...
    if ((this.jdField_b_of_type_AndroidWidgetTextView != null) && ("from_msg_tab".equals(this.jdField_a_of_type_JavaLangString)))
    {
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setText(2131433280);
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
      ...
      label75:
      if (i > 99) {
        this.jdField_b_of_type_AndroidWidgetTextView.setText(String.format("%s(%d+)", new Object[] { getString(2131433280), Integer.valueOf(99) }));
      } else {
        this.jdField_b_of_type_AndroidWidgetTextView.setText(String.format("%s(%d)", new Object[] { getString(2131433280), Integer.valueOf(i) }));
      }
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      ...
      {
        this.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130838211);
  ...
  public void a(boolean paramBoolean, int paramInt, DragFrameLayout paramDragFrameLayout)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragFrameLayout.a() == -1) && (paramDragFrameLayout.a() != null) && (paramDragFrameLayout.a().getId() == 2131363189))
    {
  ...
  public void b(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog != null)
    {
      ...
      this.jdField_a_of_type_MqqOsMqqHandler.postDelayed(new mqi(this), 5000L);
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    super.setContentView(2130969236);
  ...
  {
    super.doOnResume();
    ThreadManager.executeOnSubThread(new mqh(this, ServiceAccountFolderManager.a()));
  ...
  public boolean handleMessage(Message paramMessage)
  {
    if (paramMessage.what == 100)
    {
      ...
      ThreadManager.executeOnSubThread(new mqg(this));
    }
    do
    {
      return true;
