  ...
  implements Runnable
{
  ...
  public void run()
  {
    try
    {
      ...
      int j = arrayOfInt[0];
      int k = this.b;
      int m = aekt.a(2.0F, this.this$0.getResources());
      SubscriptFeedsActivity.a(this.this$0).showAsDropDown(this.this$0.rightViewText, i - j - k - m, -aekt.a(5.0F, this.this$0.getResources()));
      return;
    }
