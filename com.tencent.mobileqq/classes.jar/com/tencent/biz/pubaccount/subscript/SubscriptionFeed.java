...
public class SubscriptionFeed
{
  ...
  public static SubscriptionFeed a(QQAppInterface paramQQAppInterface, Context paramContext, TroopBarData paramTroopBarData)
  {
    ...
    {
      localObject2 = paramQQAppInterface.getMessageFacade().a(paramTroopBarData.mUin, 1008);
    ...
    for (int i = ((ConversationFacade)localObject3).a(((MessageRecord)localObject2).frienduin, ((MessageRecord)localObject2).istroop);; i = 0)
    {
      ...
      for (;;)
      {
              ...
              for (;;)
              {
                ...
                if (paramTroopBarData.hasNext())
                {
                  ...
                  for (;;)
                  {
                    ...
                    {
                      localSubscriptionFeedItem.jdField_a_of_type_JavaLangString = ((StructMsgItemCover)localObject4).ac;
                    }
                    ...
                    {
                      localSubscriptionFeedItem.jdField_a_of_type_JavaLangString = ((StructMsgItemVideo)localObject4).ac;
                    }
                    else if ((localObject4 instanceof StructMsgItemPAAudio))
                    {
                      localSubscriptionFeedItem.jdField_a_of_type_JavaLangString = ((StructMsgItemPAAudio)localObject4).ac;
                    }
                    else if ((localObject4 instanceof StructMsgItemPAVideo))
                    {
                      localSubscriptionFeedItem.jdField_a_of_type_JavaLangString = ((StructMsgItemPAVideo)localObject4).ac;
                    }
        ...
        else
        {
          ...
          paramTroopBarData.c = paramQQAppInterface.getMessageFacade().b(paramContext, (MessageRecord)localObject2, false);
  ...
  public void a()
  {
    ...
    {
      return;
      int i = ((IPublicAccountUtil)QRoute.api(IPublicAccountUtil.class)).getUinType((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), this.jdField_a_of_type_JavaLangString);
      Object localObject = ((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getMessageFacade();
      if (localObject != null) {}
      for (localObject = ((QQMessageFacade)localObject).a(this.jdField_a_of_type_JavaLangString, i);; localObject = null)
      {
        if (localObject == null) {
          break label139;
        }
        this.jdField_b_of_type_Int = 0;
        TroopBarAssistantManager.a().a((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), ((Message)localObject).frienduin);
        ConversationFacade localConversationFacade = ((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getConversationFacade();
        if (localConversationFacade == null) {
          break;
        }
        localConversationFacade.a(((Message)localObject).frienduin, ((Message)localObject).istroop, true);
        return;
      }
    }
  }
