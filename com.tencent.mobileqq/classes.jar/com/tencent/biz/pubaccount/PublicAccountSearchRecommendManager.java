...
public class PublicAccountSearchRecommendManager
{
  ...
  private ArrayList<PublicAccountSearchRecommendManager.PublicAccountSearchRecommendItem> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private HashMap<String, PublicAccountSearchRecommendManager.PublicAccountSearchHistoryItem> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  private ArrayList<PublicAccountSearchRecommendManager.PublicAccountSearchHistoryItem> jdField_b_of_type_JavaUtilArrayList = new ArrayList();
  ...
  private ArrayList<PublicAccountSearchRecommendManager.PublicAccountSearchRecommendItem> a()
  {
  ...
  private ArrayList<PublicAccountSearchRecommendManager.PublicAccountSearchRecommendItem> a(QQAppInterface paramQQAppInterface)
  {
  ...
  private void b(QQAppInterface paramQQAppInterface)
  {
    ...
    if (paramQQAppInterface != null)
    {
      ...
      if (!TextUtils.isEmpty(paramQQAppInterface)) {
        try
        {
          paramQQAppInterface = ((IPublicAccountUtil)QRoute.api(IPublicAccountUtil.class)).parseString2Json(paramQQAppInterface);
          if (paramQQAppInterface != null)
          {
  ...
  private void b(QQAppInterface paramQQAppInterface, PublicAccountSearchRecommendManager.GetRecommendListListener paramGetRecommendListListener)
  {
    ...
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApplication().getApplicationContext(), PublicAccountServletImpl.class);
    ...
    localNewIntent.setObserver(new PublicAccountSearchRecommendManager.3(this, localNewIntent, paramQQAppInterface, paramGetRecommendListListener));
