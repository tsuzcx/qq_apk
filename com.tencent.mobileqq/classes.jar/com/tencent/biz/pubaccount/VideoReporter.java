...
import com.tencent.biz.pubaccount.readinjoy.decoupling.uilayer.framewrok.util.RIJSoSoUtils;
...
public class VideoReporter
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = "8.5.5".replace(".", "");
    jdField_a_of_type_JavaUtilHashMap = new HashMap();
  }
  
  public static int a()
  {
    boolean bool1 = ReadInJoyHelper.m();
    boolean bool2 = ReadInJoyHelper.n();
    if (!bool1) {
      return 0;
    }
    if (bool2) {
  ...
  public static void a(long paramLong1, String paramString1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, long paramLong2, ReportInfo.VideoExtraRepoerData paramVideoExtraRepoerData, int paramInt5, String paramString2)
  {
    ...
    label366:
    for (paramString1 = paramVideoExtraRepoerData.toString();; paramString1 = "null")
    {
  ...
  public static void a(BaseArticleInfo paramBaseArticleInfo, int paramInt1, int paramInt2, long paramLong, ReportInfo.VideoExtraRepoerData paramVideoExtraRepoerData)
  {
    ...
    {
      a(l, str, paramInt1, j, k, paramInt2, paramLong, paramVideoExtraRepoerData, i, paramBaseArticleInfo.videoReportInfo);
      return;
    }
  }
  ...
  public static void a(String paramString1, String paramString2, String paramString3, String paramString4, JSONObject paramJSONObject)
  {
    for (;;)
    {
      try
      {
        ...
        paramJSONObject.put("imei", ReadInJoyUtils.b());
        paramJSONObject.put("imsi", ReadInJoyUtils.c());
      ...
      paramJSONObject.put("diandianfeeds_type", RecommendFeedsDiandianEntranceManager.a().b());
