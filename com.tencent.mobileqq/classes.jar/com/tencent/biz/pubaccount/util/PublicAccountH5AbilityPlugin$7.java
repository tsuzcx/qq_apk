...
public class PublicAccountH5AbilityPlugin$7
  implements Runnable
{
  public PublicAccountH5AbilityPlugin$7(ufd paramufd, String[] paramArrayOfString) {}
  
  public void run()
  {
    if (!babd.a()) {
      bfur.a(this.this$0.jdField_a_of_type_AndroidAppActivity, 230, null, amtj.a(2131707900), null, this.this$0.jdField_a_of_type_AndroidAppActivity.getString(2131694201), new ufw(this), null).show();
    }
    Object localObject2;
    String str2;
    int i;
    ...
    do
    {
      ...
      catch (Exception localException2)
      {
        ...
        localObject2 = new bhht(this.this$0.mRuntime.a(), this.this$0.mRuntime.a().getResources().getDimensionPixelSize(2131299076));
        ((bhht)localObject2).c(2131717563);
        ufx localufx = new ufx(this, (bhht)localObject2, str2, localException1, i, j, localException2, str3, str4, str5, str6, str7);
        this.this$0.jdField_a_of_type_Rxk.a(localufx);
        this.this$0.jdField_a_of_type_Rxk.a("CMD_CAMERA_CAPTURE_SO_DOWNLOAD", null);
        ((bhht)localObject2).a(new ufz(this, localufx));
        ((bhht)localObject2).show();
        return;
        ufd.a(this.this$0, str2, localufx, i, j, localException2, str3, str4, str5, str6, str7);
      }
      String str1 = ((JSONObject)localObject2).optString("callback");
      localObject2 = this.this$0.jdField_a_of_type_Rxk.a("CMD_CAMERA_CAPTURE_CHECK_SO_READY", null);
      ...
      QQToast.a(this.this$0.mRuntime.a(), 0, 2131718468, 0).a();
      return;
