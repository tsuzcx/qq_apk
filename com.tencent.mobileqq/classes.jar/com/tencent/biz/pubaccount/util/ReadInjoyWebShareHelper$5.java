...
public class ReadInjoyWebShareHelper$5
  implements Runnable
{
  public ReadInjoyWebShareHelper$5(uvh paramuvh, String paramString1, boolean paramBoolean1, Map paramMap, Runnable paramRunnable, boolean paramBoolean2, String paramString2) {}
  ...
  public void run()
  {
    ...
    label135:
    if (uvh.a(this.this$0).a().getClass().getName().equalsIgnoreCase("com.tencent.qqreadinjoy.detailspage.ReadInJoyArticleDetailActivity"))
    {
      uvh.a(this.this$0).a().runOnUiThread(this.jdField_a_of_type_JavaLangRunnable);
    ...
    for (i = 3;; i = 4)
    {
      ...
      bjgx.a().a((Bundle)localObject1, "", uvh.a(this.this$0).a().getAccount(), false);
      return;
      uvh.a(this.this$0).a().runOnUiThread(this.jdField_a_of_type_JavaLangRunnable);
      break;
      i = 0;
