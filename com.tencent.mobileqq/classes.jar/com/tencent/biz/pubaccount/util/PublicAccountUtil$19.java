      ...
      if (!TextUtils.isEmpty((CharSequence)localObject3))
      {
        ...
        if (localObject1 != null)
        {
          ...
          if (!TextUtils.isEmpty((CharSequence)localObject4))
          {
            ...
            new bghj((String)localObject1, "GET", (bghi)localObject4, 0, null).executeOnExecutor(ThreadManagerV2.getNetExcutor(), new HashMap[] { localObject3 });
            return;
          }
        }
      }
