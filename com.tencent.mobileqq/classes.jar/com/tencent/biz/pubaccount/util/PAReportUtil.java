...
public class PAReportUtil
{
  public static void a(AppInterface paramAppInterface, String paramString1, String paramString2, String paramString3)
  {
    ...
    NewIntent localNewIntent = new NewIntent(paramAppInterface.getApplication(), PublicAccountServlet.class);
    ...
    localNewIntent.setObserver(new mtk());
    paramAppInterface.startServlet(localNewIntent);
  }
  
  public static void a(AppInterface paramAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt1, int paramInt2, int paramInt3, String paramString6, String paramString7, String paramString8, List paramList)
  {
    ...
    Object localObject = new NewIntent(paramAppInterface.getApplication(), PublicAccountServlet.class);
    ...
    ((NewIntent)localObject).setObserver(new mtj(paramAppInterface, paramList, paramString1, paramString2, paramString3, paramString4, paramString5, paramInt1, paramInt2, paramInt3, paramString6, paramString7, paramString8));
    paramAppInterface.startServlet((NewIntent)localObject);
  }
  
  public static void a(AppInterface paramAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, List paramList)
  {
    if (QLog.isColorLevel()) {
  ...
  public static void a(AppInterface paramAppInterface, String paramString1, String paramString2, String paramString3, List paramList1, List paramList2, List paramList3)
  {
    if (QLog.isColorLevel()) {
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.util.PAReportUtil
