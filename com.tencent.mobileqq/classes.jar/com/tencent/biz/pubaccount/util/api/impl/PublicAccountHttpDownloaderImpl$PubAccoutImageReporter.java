  ...
  public void a(int paramInt, DownloadParams paramDownloadParams)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        if (((localObject1 instanceof MessageForStructing)) && (((MessageForStructing)localObject1).structingMsg != null))
        {
          localObject2 = "" + ((MessageForStructing)localObject1).structingMsg.msgId;
          localObject1 = paramDownloadParams;
          paramDownloadParams = (DownloadParams)localObject2;
          break;
        }
        if ((!(localObject1 instanceof MessageForPubAccount)) || (((MessageForPubAccount)localObject1).mPAMessage == null)) {
          break label931;
        }
        localObject2 = "" + ((MessageForPubAccount)localObject1).mPAMessage.mMsgId;
        localObject1 = paramDownloadParams;
        paramDownloadParams = (DownloadParams)localObject2;
        break;
        ...
        switch (((IPublicAccountUtil)QRoute.api(IPublicAccountUtil.class)).getAccountType((AppInterface)localObject2, (String)localObject1))
        {
        }
