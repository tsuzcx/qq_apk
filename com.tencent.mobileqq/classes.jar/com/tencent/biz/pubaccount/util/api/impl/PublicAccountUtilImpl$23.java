...
class PublicAccountUtilImpl$23
  implements Runnable
{
  PublicAccountUtilImpl$23(PublicAccountUtilImpl paramPublicAccountUtilImpl, QQAppInterface paramQQAppInterface, int paramInt) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      ReportController.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "auth_entry", "clk_msg", 0, 0, "", "", "", "");
      return;
      if (j == 2) {
        str = "0X80067E9";
      }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.util.api.impl.PublicAccountUtilImpl.23
