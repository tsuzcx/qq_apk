...
class PublicAccountUtilImpl$19
  implements Runnable
{
  PublicAccountUtilImpl$19(PublicAccountUtilImpl paramPublicAccountUtilImpl, String paramString1, String paramString2, int paramInt1, int paramInt2) {}
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject3))
      {
        ...
        if (localObject1 != null)
        {
          ...
          if (!TextUtils.isEmpty((CharSequence)localObject4))
          {
            ...
            localObject4 = new PublicAccountUtilImpl.19.1(this);
            localObject1 = str;
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.util.api.impl.PublicAccountUtilImpl.19
