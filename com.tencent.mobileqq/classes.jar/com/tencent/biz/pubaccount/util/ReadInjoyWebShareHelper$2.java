  ...
  implements BusinessObserver
{
  ...
  {
    ReadInjoyWebShareHelper.c(this.jdField_a_of_type_ComTencentBizPubaccountUtilReadInjoyWebShareHelper);
    if (paramBoolean) {}
    for (;;)
    {
      try
      ...
      catch (Exception paramBundle)
      {
        ...
        ReadInjoyWebShareHelper.a(this.jdField_a_of_type_ComTencentBizPubaccountUtilReadInjoyWebShareHelper).startActivityForResult(this.jdField_a_of_type_AndroidContentIntent, (byte)1);
      }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.util.ReadInjoyWebShareHelper.2
