...
public final class ReadInJoyShareHelperV2$Companion
{
  ...
  public final List<ActionItem> a(@NotNull JSONArray paramJSONArray, @Nullable JSONObject paramJSONObject)
  {
    ...
    Object localObject2 = (Integer)ReadInJoyShareHelperV2.a().get(localObject1);
    if (localObject2 != null) {
      j = ((Integer)localObject2).intValue();
    }
    for (;;)
  ...
  public final List<ActionItem> b()
  {
    ...
    localArrayList.add(new ActionItem("qq_browser", 5, false));
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.util.ReadInJoyShareHelperV2.Companion
