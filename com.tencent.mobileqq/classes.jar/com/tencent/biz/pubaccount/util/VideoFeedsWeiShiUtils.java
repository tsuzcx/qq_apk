...
public class VideoFeedsWeiShiUtils
{
  ...
  public static DownloadInfo a(String paramString)
  {
    ...
    try
    {
      ...
      for (int i = TMAssistantDownloadConst.SHOW_NOTIFICATION_TRUE;; i = TMAssistantDownloadConst.SHOW_NOTIFICATION_FALSE)
      {
        ...
        localDownloadInfo.m = RIJJumpUtils.a(40677);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (!localJSONObject.optBoolean("isWeb", false))
        {
          ...
          localDownloadInfo.m = RIJJumpUtils.a(0);
          return localDownloadInfo;
        }
      }
      catch (JSONException localJSONException)
  ...
  public static void b(Context paramContext, String paramString)
  {
    ...
    if (a != null)
    {
      ...
      paramContext.setMessage(HardCodeUtil.a(2131716048));
      paramContext.setNegativeButton(HardCodeUtil.a(2131716036), new VideoFeedsWeiShiUtils.3()).setPositiveButton(HardCodeUtil.a(2131715992), new VideoFeedsWeiShiUtils.2());
      paramContext.show();
      return;
    }
