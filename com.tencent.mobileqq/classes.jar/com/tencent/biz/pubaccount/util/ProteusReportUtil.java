...
public class ProteusReportUtil
{
  ...
  public static void a(int paramInt, String paramString)
  {
    ...
    localArrayList.add(localObject);
    localObject = HtmlOffline.a(paramString) + "";
    if (paramInt != 1)
    {
    ...
    if (3 == paramInt)
    {
      if (((Boolean)ReadInJoyHelper.a(paramString, Boolean.valueOf(false))).booleanValue()) {
        return;
      }
      ReadInJoyHelper.a(paramString, Boolean.valueOf(true));
    }
    ((IPublicAccountUtil)QRoute.api(IPublicAccountUtil.class)).reportPushEffectEvent(200, localArrayList);
  }
    ...
    try
    {
      ...
      if ((paramMap != null) && (paramMap.entrySet() != null))
      {
        ...
        while ((paramMap != null) && (paramMap.hasNext()))
        {
          ...
          continue;
          ((IPublicAccountReportUtils)QRoute.api(IPublicAccountReportUtils.class)).publicAccountReportClickEvent(null, RIJFeedsType.b(paramArticleInfo), paramString1, paramString2, 0, 0, RIJStringUtils.a(paramArticleInfo.mFeedId), String.valueOf(paramArticleInfo.mArticleID), Integer.toString(paramArticleInfo.mStrategyId), paramMap, false);
        }
      }
    }
  ...
  {
    paramBaseArticleInfo = UGRuleManager.a(paramBaseArticleInfo);
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.util.ProteusReportUtil
