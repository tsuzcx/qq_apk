    ...
    for (boolean bool1 = bdne.v(this.jdField_a_of_type_AndroidAppActivity, ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).getCurrentAccountUin());; bool1 = false)
    {
      ...
      for (Object localObject1 = ((qja)((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).app.getManager(261)).a();; localObject1 = "0")
      {
        ...
        if ((TextUtils.isEmpty((CharSequence)localObject1)) || (((String)localObject1).equals("0")))
        {
          ...
          localObject3 = (qiu)((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).app.getManager(270);
          k = i;
          localObject2 = localObject1;
          m = j;
          if (((qiu)localObject3).a() != 1) {
            break label609;
          }
          k = i;
          localObject2 = localObject1;
          m = j;
          if (!((qiu)localObject3).b()) {
            break label609;
          }
          localObject1 = ((qiu)localObject3).a();
          bool1 = ((qiu)localObject3).a();
          i = 0;
        }
        for (int j = 2;; j = k)
        {
          for (;;)
          {
            ...
            {
              localObject2 = qiu.b(this.jdField_a_of_type_AndroidAppActivity, 0);
            ...
            try
            {
              ...
              {
                k = 1;
                localObject3 = ors.a(m, (String)localObject1, i, j, bool2, k);
              ...
              try
              {
                ...
                k = 1;
                ((orz)localObject3).a("ad_page", k);
                ((orz)localObject3).a("banner_refresh_length", this.b);
              }
              ...
              if (this.jdField_a_of_type_Int == 70)
              {
                ...
                {
                  k = 1;
                  nrt.a(null, "CliOper", "", "", "0X8009861", "0X8009861", 0, 0, (String)localObject2, "", "", ors.a(m, (String)localObject1, i, j, bool2, k).a(), false);
                  nrt.a("0X8009861", "", "", "", "", ors.b(this.jdField_a_of_type_Int));
                }
              }
              else
              {
