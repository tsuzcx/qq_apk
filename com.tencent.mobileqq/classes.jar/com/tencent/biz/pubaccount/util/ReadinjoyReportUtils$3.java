  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    label609:
    label631:
    for (boolean bool1 = baig.u(this.jdField_a_of_type_AndroidAppActivity, ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).getCurrentAccountUin());; bool1 = false)
    {
      if ((this.jdField_a_of_type_AndroidAppActivity instanceof BaseActivity)) {}
      for (Object localObject1 = ((pnn)((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).app.getManager(261)).a();; localObject1 = "0")
      {
        int i;
        Object localObject3;
        if ((TextUtils.isEmpty((CharSequence)localObject1)) || (((String)localObject1).equals("0")))
        {
          ...
          localObject3 = (pnh)((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).app.getManager(270);
          k = i;
          localObject2 = localObject1;
          m = j;
          if (((pnh)localObject3).a() != 1) {
            break label609;
          }
          k = i;
          localObject2 = localObject1;
          m = j;
          if (!((pnh)localObject3).b()) {
            break label609;
          }
          localObject1 = ((pnh)localObject3).a();
          bool1 = ((pnh)localObject3).a();
          i = 0;
        }
        for (int j = 2;; j = k)
        {
          for (;;)
          {
            ...
            {
              localObject2 = pnh.b(this.jdField_a_of_type_AndroidAppActivity, 0);
            ...
            try
            {
              ...
              yof.a(0, 1, (qq_ad_get.QQAdGetRsp.AdInfo)localObject3);
              m = this.jdField_a_of_type_Int;
              boolean bool2 = this.jdField_a_of_type_Boolean;
              if (bool1)
              {
                k = 1;
                localObject3 = obz.a(m, (String)localObject1, i, j, bool2, k);
              ...
              try
              {
                ...
                k = 1;
                ((ocg)localObject3).a("ad_page", k);
                ((ocg)localObject3).a("banner_refresh_length", this.b);
              }
              ...
              ndn.a(null, "CliOper", "", "", "0X80066F8", "0X80066F8", 0, 0, bgmq.a("default_feeds_proteus_offline_bid"), "", "", ((ocg)localObject3).a(), false);
              ndn.a("0X80066F8", "", "", "", "", obz.b(this.jdField_a_of_type_Int));
              if (this.jdField_a_of_type_Int == 70)
              {
                localObject2 = bgmq.a("default_feeds_proteus_offline_bid");
                m = this.jdField_a_of_type_Int;
                bool2 = this.jdField_a_of_type_Boolean;
                if (bool1)
                {
                  k = 1;
                  ndn.a(null, "CliOper", "", "", "0X8009861", "0X8009861", 0, 0, (String)localObject2, "", "", obz.a(m, (String)localObject1, i, j, bool2, k).a(), false);
                  ndn.a("0X8009861", "", "", "", "", obz.b(this.jdField_a_of_type_Int));
                }
              }
              else
              {
