...
public class PublicAccountUtil$10$1
  implements Runnable
{
  public PublicAccountUtil$10$1(rts paramrts, boolean paramBoolean, Bundle paramBundle) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
            ...
            if (localGetPublicAccountDetailInfoResponse.ret_info.has())
            {
              ...
              if (((mobileqq_mp.RetInfo)localGetPublicAccountDetailInfoResponse.ret_info.get()).ret_code.has())
              {
                ...
                if (((mobileqq_mp.RetInfo)localGetPublicAccountDetailInfoResponse.ret_info.get()).ret_code.get() == 0)
                {
                  ...
                  {
                    j = i1;
                    ((atmp)localObject4).b((atmo)localObject3);
                    if (localObject3 != null)
                    {
                      j = i1;
                      localObject4 = (ajoy)this.this$0.a.getManager(56);
                      if (localObject4 != null)
                      {
                        j = i1;
                        ((ajoy)localObject4).a((AccountDetail)localObject3);
                        j = i1;
                        if (((ajoy)localObject4).b(((AccountDetail)localObject3).uin) == null)
                        {
                          j = i1;
                          if (((AccountDetail)localObject3).followType == 1)
                          {
                            j = i1;
                            ((ajoy)localObject4).a(PublicAccountInfo.createPublicAccount((AccountDetail)localObject3, 0L));
                          }
                        }
                      }
                    }
      ...
      try
      {
        if (rtr.a != null)
        {
          ...
          if (rtr.a() != null)
          {
            ...
            if (rtr.a().get() != null)
            {
              ...
              if (localGetPublicAccountDetailInfoResponse.uin.has())
              {
                ...
                j = i;
                ((Handler)rtr.a().get()).sendMessage((Message)localObject4);
              }
            }
          }
          j = i;
          ...
          if (localGetPublicAccountDetailInfoResponse.uin.has())
          {
            ...
            {
              j = i;
              rol.a().a(this.this$0.a, (AccountDetail)localObject3);
              k = i;
            }
          }
          j = k;
      ...
      j = i1;
      bool = rtr.a((byte[])localObject3, (oidb_cmd0xcf8.GetPublicAccountDetailInfoResponse)localObject4, localGetPublicAccountDetailInfoResponse);
      continue;
      j = n;
