...
public class DiffUtil$DiffResult
{
  ...
  private static mst a(List paramList, int paramInt, boolean paramBoolean)
  {
    int i = paramList.size() - 1;
    while (i >= 0)
    {
      mst localmst2 = (mst)paramList.get(i);
      if ((localmst2.jdField_a_of_type_Int == paramInt) && (localmst2.jdField_a_of_type_Boolean == paramBoolean))
      {
        paramList.remove(i);
        paramInt = i;
        localmst1 = localmst2;
        ...
        localmst1 = (mst)paramList.get(paramInt);
        int j = localmst1.jdField_b_of_type_Int;
        if (paramBoolean) {}
        for (i = 1;; i = -1)
        {
          localmst1.jdField_b_of_type_Int = (i + j);
          paramInt += 1;
          break;
        }
      }
  ...
  private void a()
  {
    ...
    for (msv localmsv = null;; localmsv = (msv)this.jdField_a_of_type_JavaUtilList.get(0))
    {
      if ((localmsv == null) || (localmsv.jdField_a_of_type_Int != 0) || (localmsv.jdField_b_of_type_Int != 0))
      {
        localmsv = new msv();
        localmsv.jdField_a_of_type_Int = 0;
        localmsv.jdField_b_of_type_Int = 0;
        localmsv.jdField_a_of_type_Boolean = false;
        localmsv.c = 0;
        localmsv.jdField_b_of_type_Boolean = false;
        this.jdField_a_of_type_JavaUtilList.add(0, localmsv);
      }
      return;
    }
  }
  ...
  private void a(List paramList, ListUpdateCallback paramListUpdateCallback, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    case 8: 
      ...
      {
        mst localmst = (mst)((Iterator)localObject).next();
        localmst.jdField_b_of_type_Int += 1;
        continue;
        int j = this.jdField_b_of_type_ArrayOfInt[(paramInt3 + paramInt2)] >> 5;
        localObject = a(paramList, j, true);
        if (localObject != null) {
          paramListUpdateCallback.c(((mst)localObject).jdField_b_of_type_Int, paramInt1);
        }
        if (i == 4) {
    ...
    for (;;)
    {
      paramInt2 -= 1;
      break;
      paramList.add(new mst(paramInt3 + paramInt2, paramInt1, false));
    }
  }
  ...
  private boolean a(int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      msv localmsv = (msv)this.jdField_a_of_type_JavaUtilList.get(paramInt3);
      k = localmsv.jdField_a_of_type_Int;
      int n = localmsv.c;
      int i1 = localmsv.jdField_b_of_type_Int;
      int i2 = localmsv.c;
      if (paramBoolean)
      {
        paramInt2 -= 1;
      ...
      label269:
      paramInt2 = localmsv.jdField_a_of_type_Int;
      i = localmsv.jdField_b_of_type_Int;
      paramInt3 -= 1;
    }
    label289:
    return false;
  ...
  private void b()
  {
    ...
    while (k >= 0)
    {
      msv localmsv = (msv)this.jdField_a_of_type_JavaUtilList.get(k);
      int i2 = localmsv.jdField_a_of_type_Int;
      int i3 = localmsv.c;
      int n = localmsv.jdField_b_of_type_Int;
      int i1 = localmsv.c;
      int m;
      if (this.jdField_a_of_type_Boolean)
      {
      ...
      if (i < localmsv.c)
      {
        m = localmsv.jdField_a_of_type_Int + i;
        n = localmsv.jdField_b_of_type_Int + i;
      ...
      j = localmsv.jdField_a_of_type_Int;
      i = localmsv.jdField_b_of_type_Int;
      k -= 1;
    }
  }
  ...
  private void b(List paramList, ListUpdateCallback paramListUpdateCallback, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    case 8: 
      while (((Iterator)localObject).hasNext())
      {
        ...
        if (localObject != null)
        {
          paramListUpdateCallback.c(paramInt1 + paramInt2, ((mst)localObject).jdField_b_of_type_Int - 1);
          if (i == 4) {
            paramListUpdateCallback.a(((mst)localObject).jdField_b_of_type_Int - 1, 1, this.jdField_a_of_type_ComTencentBizPubaccountUtilDiffUtil$Callback.a(paramInt3 + paramInt2, j));
          }
        }
      }
    }
    for (;;)
    {
      paramInt2 -= 1;
      break;
      paramList.add(new mst(paramInt3 + paramInt2, paramInt1 + paramInt2, true));
    }
  }
  
  public void a(RecyclerView.Adapter paramAdapter)
  {
    a(new mss(this, paramAdapter));
  }
  ...
  public void a(ListUpdateCallback paramListUpdateCallback)
  {
    ...
    for (;;)
    {
      ...
      msv localmsv = (msv)this.jdField_a_of_type_JavaUtilList.get(i);
      int m = localmsv.c;
      int n = localmsv.jdField_a_of_type_Int + m;
      int i1 = localmsv.jdField_b_of_type_Int + m;
      if (n < j) {
      ...
      for (;;)
      {
        if (j >= 0)
        {
          if ((this.jdField_a_of_type_ArrayOfInt[(localmsv.jdField_a_of_type_Int + j)] & 0x1F) == 2) {
            paramListUpdateCallback.a(localmsv.jdField_a_of_type_Int + j, 1, this.jdField_a_of_type_ComTencentBizPubaccountUtilDiffUtil$Callback.a(localmsv.jdField_a_of_type_Int + j, localmsv.jdField_b_of_type_Int + j));
          }
          j -= 1;
          continue;
      ...
      j = localmsv.jdField_a_of_type_Int;
      k = localmsv.jdField_b_of_type_Int;
      i -= 1;
    }
    label234:
