...
public class DiffUtil$DiffResult
{
  ...
  private final List<DiffUtil.Snake> jdField_a_of_type_JavaUtilList;
  ...
  private static DiffUtil.PostponedUpdate a(List<DiffUtil.PostponedUpdate> paramList, int paramInt, boolean paramBoolean)
  {
    int i = paramList.size() - 1;
    while (i >= 0)
    {
      DiffUtil.PostponedUpdate localPostponedUpdate2 = (DiffUtil.PostponedUpdate)paramList.get(i);
      if ((localPostponedUpdate2.jdField_a_of_type_Int == paramInt) && (localPostponedUpdate2.jdField_a_of_type_Boolean == paramBoolean))
      {
        paramList.remove(i);
        paramInt = i;
        ...
        int j = localPostponedUpdate1.jdField_b_of_type_Int;
        if (paramBoolean) {}
        for (i = 1;; i = -1)
        {
          localPostponedUpdate1.jdField_b_of_type_Int = (i + j);
          paramInt += 1;
          break;
        }
      }
  ...
  private void a()
  {
    ...
    for (DiffUtil.Snake localSnake = null;; localSnake = (DiffUtil.Snake)this.jdField_a_of_type_JavaUtilList.get(0))
    {
      if ((localSnake == null) || (localSnake.jdField_a_of_type_Int != 0) || (localSnake.jdField_b_of_type_Int != 0))
      {
        localSnake = new DiffUtil.Snake();
        localSnake.jdField_a_of_type_Int = 0;
        localSnake.jdField_b_of_type_Int = 0;
        localSnake.jdField_a_of_type_Boolean = false;
        localSnake.c = 0;
        localSnake.jdField_b_of_type_Boolean = false;
        this.jdField_a_of_type_JavaUtilList.add(0, localSnake);
      }
      return;
    }
  }
  ...
  private void a(List<DiffUtil.PostponedUpdate> paramList, ListUpdateCallback paramListUpdateCallback, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    case 8: 
      while (((Iterator)localObject).hasNext())
      {
        ...
        localPostponedUpdate.jdField_b_of_type_Int += 1;
        continue;
        int j = this.jdField_b_of_type_ArrayOfInt[(paramInt3 + paramInt2)] >> 5;
        localObject = a(paramList, j, true);
        if (localObject != null)
        {
          paramListUpdateCallback.c(((DiffUtil.PostponedUpdate)localObject).jdField_b_of_type_Int, paramInt1);
          if (i == 4) {
  ...
  private boolean a(int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      DiffUtil.Snake localSnake = (DiffUtil.Snake)this.jdField_a_of_type_JavaUtilList.get(paramInt3);
      k = localSnake.jdField_a_of_type_Int;
      int n = localSnake.c;
      int i1 = localSnake.jdField_b_of_type_Int;
      int i2 = localSnake.c;
      if (paramBoolean)
      {
        paramInt2 -= 1;
      ...
      label269:
      paramInt2 = localSnake.jdField_a_of_type_Int;
      i = localSnake.jdField_b_of_type_Int;
      paramInt3 -= 1;
    }
    label289:
    return false;
  ...
  private void b()
  {
    ...
    while (k >= 0)
    {
      DiffUtil.Snake localSnake = (DiffUtil.Snake)this.jdField_a_of_type_JavaUtilList.get(k);
      int i2 = localSnake.jdField_a_of_type_Int;
      int i3 = localSnake.c;
      int n = localSnake.jdField_b_of_type_Int;
      int i1 = localSnake.c;
      int m;
      if (this.jdField_a_of_type_Boolean)
      {
      ...
      if (i < localSnake.c)
      {
        m = localSnake.jdField_a_of_type_Int + i;
        n = localSnake.jdField_b_of_type_Int + i;
      ...
      j = localSnake.jdField_a_of_type_Int;
      i = localSnake.jdField_b_of_type_Int;
      k -= 1;
    }
  }
  ...
  private void b(List<DiffUtil.PostponedUpdate> paramList, ListUpdateCallback paramListUpdateCallback, int paramInt1, int paramInt2, int paramInt3)
  {
    if (!this.jdField_a_of_type_Boolean) {
    ...
    case 8: 
      while (((Iterator)localObject).hasNext())
      {
        ...
        if (localObject != null)
        {
          paramListUpdateCallback.c(paramInt1 + paramInt2, ((DiffUtil.PostponedUpdate)localObject).jdField_b_of_type_Int - 1);
          if (i == 4) {
            paramListUpdateCallback.a(((DiffUtil.PostponedUpdate)localObject).jdField_b_of_type_Int - 1, 1, this.jdField_a_of_type_ComTencentBizPubaccountUtilDiffUtil$Callback.a(paramInt3 + paramInt2, j));
          }
        }
      }
    }
  ...
  {
    a(new AdapterListUpdateCallback(paramAdapter));
  }
  
  public void a(@NonNull ListUpdateCallback paramListUpdateCallback)
  {
    ...
    for (;;)
    {
      ...
      DiffUtil.Snake localSnake = (DiffUtil.Snake)this.jdField_a_of_type_JavaUtilList.get(i);
      int m = localSnake.c;
      int n = localSnake.jdField_a_of_type_Int + m;
      int i1 = localSnake.jdField_b_of_type_Int + m;
      if (n < j) {
        b(localArrayList, paramListUpdateCallback, n, j - n, n);
      }
      if (i1 < k) {
        a(localArrayList, paramListUpdateCallback, i1, k - i1, i1);
      }
      j = m - 1;
      for (;;)
      {
        if (j >= 0)
        {
          if ((this.jdField_a_of_type_ArrayOfInt[(localSnake.jdField_a_of_type_Int + j)] & 0x1F) == 2) {
            paramListUpdateCallback.a(localSnake.jdField_a_of_type_Int + j, 1, this.jdField_a_of_type_ComTencentBizPubaccountUtilDiffUtil$Callback.a(localSnake.jdField_a_of_type_Int + j, localSnake.jdField_b_of_type_Int + j));
          }
          j -= 1;
          continue;
      ...
      j = localSnake.jdField_a_of_type_Int;
      k = localSnake.jdField_b_of_type_Int;
      i -= 1;
    }
    label234:
