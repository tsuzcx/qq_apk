...
final class QualityReporter$1
  implements Runnable
{
  QualityReporter$1(ReadinjoyVideoReportData paramReadinjoyVideoReportData) {}
  ...
  public void run()
  {
    ...
    localReportInfoReq.basic_info.version.set("8.5.5.5105");
    localReportInfoReq.basic_info.setHasFlag(true);
    localReportInfoReq.video_info.busitype.set(this.a.jdField_a_of_type_Int);
    localReportInfoReq.video_info.file_size.set(this.a.jdField_q_of_type_Long);
    ...
    for (int i = 2;; i = 1)
    {
      ...
      localReportInfoReq.video_info.weight.set(this.a.k);
      localReportInfoReq.video_info.height.set(this.a.l);
      ...
      localReportInfoReq.play_info.skipframe_cnt.set(this.a.jdField_q_of_type_Int);
