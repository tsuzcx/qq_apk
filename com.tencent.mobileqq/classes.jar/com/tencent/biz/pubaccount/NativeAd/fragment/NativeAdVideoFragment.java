...
public class NativeAdVideoFragment
  ...
  implements View.OnClickListener, nbm
{
  ...
  private void d()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Nas.e = localAdvertisementInfo.mAdImg;
      this.jdField_a_of_type_Nas.jdField_d_of_type_JavaLangString = localAdvertisementInfo.mAdVideoUrl;
      this.jdField_a_of_type_Nas.jdField_a_of_type_Long = localAdvertisementInfo.mVideoDuration;
      this.jdField_a_of_type_Nas.jdField_d_of_type_Int = 1;
      this.jdField_a_of_type_Nas.f = "";
      localObject = new nat();
      this.jdField_a_of_type_Nas.jdField_a_of_type_Nat = ((nat)localObject);
      return;
    }
  ...
  public void onClick(View paramView)
  {
    ...
    {
    default: 
      rvb.a(getActivity(), this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo, null, 4, true);
      j = paramView.getId();
      i = 1000;
      if (j == 2131296476) {
        i = 2;
    ...
    for (;;)
    {
      ...
      return;
      this.jdField_a_of_type_Naz.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo, this.jdField_a_of_type_JavaUtilArrayList);
      return;
      if ((this.jdField_a_of_type_ComTencentBizPubaccountNativeAdViewNativeAdVideoContainer != null) && (this.jdField_a_of_type_ComTencentBizPubaccountNativeAdViewNativeAdVideoContainer.a()))
      {
        this.jdField_a_of_type_ComTencentBizPubaccountNativeAdViewNativeAdVideoContainer.d();
  ...
  {
    paramLayoutInflater = paramLayoutInflater.inflate(2131494404, paramViewGroup, false);
    this.jdField_a_of_type_ComTencentBizPubaccountNativeAdViewNativeAdVideoContainer = ((NativeAdVideoContainer)paramLayoutInflater.findViewById(2131304997));
    if (this.jdField_a_of_type_ComTencentBizPubaccountNativeAdViewNativeAdVideoContainer != null)
    {
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountNativeAdViewNativeAdVideoContainer.a(this.jdField_a_of_type_Nas, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo, this.jdField_a_of_type_ComTencentCommonAppAppInterface);
      this.jdField_a_of_type_ComTencentBizPubaccountNativeAdViewNativeAdVideoContainer.setOnVideoFullScreen(this);
    }
    this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)paramLayoutInflater.findViewById(2131304232));
    this.jdField_a_of_type_AndroidWidgetImageButton.setOnClickListener(this);
    this.jdField_b_of_type_AndroidWidgetImageButton = ((ImageButton)paramLayoutInflater.findViewById(2131310248));
    this.jdField_b_of_type_AndroidWidgetImageButton.setOnClickListener(this);
    this.jdField_b_of_type_AndroidWidgetImageButton.setVisibility(0);
    this.jdField_a_of_type_Naz = new naz(getActivity(), this.jdField_a_of_type_ComTencentCommonAppAppInterface);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramLayoutInflater.findViewById(2131303967));
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyHeadImageView = ((ReadInJoyHeadImageView)paramLayoutInflater.findViewById(2131296476));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramLayoutInflater.findViewById(2131296478));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramLayoutInflater.findViewById(2131296453));
