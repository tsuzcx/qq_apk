  ...
  extends PublicBaseFragment
{
  ...
  private void a()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          localObject2 = nyy.a(getActivity().app, ((JSONArray)localObject1).getJSONObject(i));
  ...
  public static void a(Activity paramActivity, Class<? extends ReadInJoyNativeAdAppFragment> paramClass, Bundle paramBundle)
  {
    ...
    afez.a(paramActivity, localIntent, PublicFragmentActivityForTool.class, paramClass);
  }
  ...
  {
    paramLayoutInflater = paramLayoutInflater.inflate(2131560223, paramViewGroup, false);
    this.jdField_a_of_type_ComTencentBizPubaccountNativeAdViewReadInJoyNativeAdAppContentView = ((ReadInJoyNativeAdAppContentView)paramLayoutInflater.findViewById(2131371662));
    if (this.jdField_a_of_type_ComTencentBizPubaccountNativeAdViewReadInJoyNativeAdAppContentView != null)
    {
      ...
      if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0)) {
        this.jdField_a_of_type_ComTencentBizPubaccountNativeAdViewReadInJoyNativeAdAppContentView.setData((nzg)this.jdField_a_of_type_JavaUtilArrayList.get(0), this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
    }
