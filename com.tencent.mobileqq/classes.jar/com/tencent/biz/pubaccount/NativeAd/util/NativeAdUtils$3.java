  ...
  public void run()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localJSONObject.put("device_info", nbe.a(this.jdField_a_of_type_AndroidContentContext));
        localJSONObject.put("ad_info", nbe.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo, this.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo, this.jdField_d_of_type_Int));
        ...
        if (this.jdField_a_of_type_Int == nbe.jdField_c_of_type_Int)
        {
          localObject2 = new JSONObject();
          if (this.jdField_a_of_type_AndroidOsBundle != null)
          {
            ((JSONObject)localObject2).put("type_id", nbe.az);
            ((JSONObject)localObject2).put("tel", this.jdField_a_of_type_AndroidOsBundle.getString(nbe.jdField_a_of_type_JavaLangString, ""));
            ((JSONObject)localObject2).put("txt", this.jdField_a_of_type_AndroidOsBundle.getString(nbe.jdField_b_of_type_JavaLangString, ""));
            localJSONObject.put("neg_info", localObject2);
          }
        }
        else
        {
          if (rvb.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo))
          {
            new JSONObject();
            ...
            localObject2 = new JSONObject();
            ((JSONObject)localObject2).put("type", npb.a(this.jdField_b_of_type_Int));
          ...
          localObject2 = new JSONObject();
          if ((npj.l(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo)) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.clickType == 2) && (this.e != null))
          {
          ...
          if (npj.m(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo))
          {
            ...
            if (this.jdField_a_of_type_Int != nbe.jdField_a_of_type_Int) {
              break label882;
            }
            nbe.a(null, "0X8009819", "0X8009819", 0, 0, "", "", "", npl.b());
        ...
        ((JSONObject)localObject2).put("type_id", nbe.ay);
      ...
      if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo.l == 2)
      {
        ...
        continue;
        label882:
        if (this.jdField_a_of_type_Int == nbe.jdField_b_of_type_Int)
        {
          if (this.e != null) {
            this.e.put("exposure_info_report", String.valueOf(localObject2));
          }
          nbe.a(null, "0X8008C80", "0X8008C80", 0, 0, "", "", "", npl.b());
        }
      }
    }
    if (this.jdField_a_of_type_Int == nbe.A)
    {
    ...
    Object localObject2 = new NewIntent(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApplication(), ndt.class);
    ...
    ((NewIntent)localObject2).setObserver(new nbh(this));
    ...
    if (npj.m(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo))
    {
      ...
      {
        if ((!npl.a().a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdAid, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo.h)) || (this.jdField_a_of_type_Int != nbe.jdField_b_of_type_Int)) {
          break label1279;
        }
        i = 1;
        break label1281;
    ...
    for (;;)
    {
      if ((this.jdField_d_of_type_Int != nbe.aw) && (!nbe.a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo, this.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo)) && (!this.jdField_a_of_type_Boolean) && (i == 0))
      {
        nbe.a(this.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo, this.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo);
        if ((npj.m(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo)) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo != null)) {
          npl.a().a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdAid, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo.h);
        }
      }
      localObject2 = "";
      ...
      nbe.a(null, "0X8009E3E", "0X8009E3E", 0, 0, String.valueOf(this.jdField_b_of_type_Int), String.valueOf(this.jdField_a_of_type_Int), (String)localObject1, (String)localObject3);
      return;
      label1279:
      i = 0;
    }
