  ...
  implements PublicAccountImageDownListener
{
  ...
  public void a(URL paramURL, CloseableBitmap paramCloseableBitmap)
  {
    ...
    this.jdField_a_of_type_AndroidViewView.findViewById(2131370727).setVisibility(8);
  ...
  public void a(URL paramURL, Throwable paramThrowable)
  {
    ...
    this.jdField_a_of_type_AndroidViewView.findViewById(2131370727).setVisibility(8);
    this.jdField_a_of_type_AndroidViewView.findViewById(2131366586).setVisibility(0);
    this.jdField_a_of_type_AndroidViewView.findViewById(2131366586).setOnClickListener(new AdModuleSinglePic.1.1(this));
  }
}
