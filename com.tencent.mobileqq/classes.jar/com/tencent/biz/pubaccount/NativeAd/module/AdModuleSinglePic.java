  ...
  extends AdModuleBase
{
  ...
  public View a(Context paramContext, String paramString1, String paramString2, String paramString3, int paramInt, BannerInfo paramBannerInfo, boolean paramBoolean)
  {
    ...
    paramString1 = LayoutInflater.from(paramContext).inflate(2131560351, null);
    paramString2 = (ResizeURLImageView)paramString1.findViewById(2131373138);
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_ComTencentBizPublicAccountImageCollectionPublicAccountImageDownListener = new AdModuleSinglePic.1(this, paramString1, paramString2);
        ...
        paramString1.findViewById(2131370727).setVisibility(0);
      }
    }
  ...
  {
    this.jdField_a_of_type_Int = 1;
    this.jdField_a_of_type_AndroidViewView.findViewById(2131370727).setVisibility(0);
    this.jdField_a_of_type_AndroidViewView.findViewById(2131366586).setVisibility(8);
    try
    {
      URL localURL = new URL(this.jdField_d_of_type_JavaLangString);
      ((ResizeURLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131373138)).setImage(localURL);
      return;
    }
