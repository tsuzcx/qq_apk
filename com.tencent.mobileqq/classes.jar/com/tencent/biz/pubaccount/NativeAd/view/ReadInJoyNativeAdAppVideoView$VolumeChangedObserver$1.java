...
public class ReadInJoyNativeAdAppVideoView$VolumeChangedObserver$1
  implements Runnable
{
  public ReadInJoyNativeAdAppVideoView$VolumeChangedObserver$1(nbs paramnbs) {}
  
  public void run()
  {
    if (ReadInJoyNativeAdAppVideoView.a(this.a.a).getStreamVolume(3) > 0)
    {
      ReadInJoyNativeAdAppVideoView.b(this.a.a).setImageResource(2130841081);
      ReadInJoyNativeAdAppVideoView.a(this.a.a).setOutputMute(false);
      return;
    }
    ReadInJoyNativeAdAppVideoView.b(this.a.a).setImageResource(2130841080);
