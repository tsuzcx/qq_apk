...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/biz/pubaccount/weishi_new/combo/msg/holder/WSMsgHasPicHolder;", "Lcom/tencent/widget/pull2refresh/BaseViewHolder;", "Lcom/tencent/biz/pubaccount/weishi_new/combo/msg/bean/WSMsgSectionData;", "parent", "Landroid/view/ViewGroup;", "(Landroid/view/ViewGroup;)V", "mData", "rivAvatar", "Lcom/tencent/biz/pubaccount/weishi_new/view/WSRoundedImageView;", "rivCover", "Lcom/tencent/biz/pubaccount/weishi_new/view/RoundCornerImageView;", "tvBtn", "Landroid/widget/TextView;", "tvContent", "Lcom/tencent/biz/pubaccount/weishi_new/richtext/FeedRichTextView;", "tvMedal", "tvName", "tvTime", "bindData", "", "data", "jumpProfilePage", "setItemBackground", "qqweishi_impl_release"}, k=1, mv={1, 1, 16})
public final class WSMsgHasPicHolder
  extends BaseViewHolder<WSMsgSectionData>
{
  ...
  private TextView g;
  private WSMsgSectionData h;
  
  public WSMsgHasPicHolder(@NotNull ViewGroup paramViewGroup)
  {
    super(paramViewGroup, 1929773074);
    ...
    paramViewGroup = this.itemView.findViewById(1929707567);
    Intrinsics.checkExpressionValueIsNotNull(paramViewGroup, "itemView.findViewById(R.id.riv_msg_cover)");
    this.f = ((RoundCornerImageView)paramViewGroup);
    ...
    this.g = ((TextView)paramViewGroup);
    this.f.setCorner(WeishiUIUtil.u, 0);
    this.a.setOnClickListener((View.OnClickListener)new WSMsgHasPicHolder.1(this));
    this.b.setOnClickListener((View.OnClickListener)new WSMsgHasPicHolder.2(this));
  }
  ...
  public void a(@Nullable WSMsgSectionData paramWSMsgSectionData)
  {
    ...
    localObject3 = WSPicLoader.a();
    localObject4 = (KandianUrlImageView)this.f;
    if (paramWSMsgSectionData != null)
    {
      localObject1 = paramWSMsgSectionData.d();
      if (localObject1 != null)
      {
        ...
        if (localObject1 != null)
        {
          localObject1 = ((stMsgContent)localObject1).picURL;
          break label138;
        }
      }
    }
    localObject1 = null;
    label138:
    ((WSPicLoader)localObject3).a((KandianUrlImageView)localObject4, (String)localObject1, WSFeedUtils.f(2131166336));
    localObject3 = this.b;
    if (paramWSMsgSectionData != null)
    {
      localObject1 = paramWSMsgSectionData.d();
    ...
    else if ((localObject1 != null) && (((Integer)localObject1).intValue() == 4))
    {
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.weishi_new.combo.msg.holder.WSMsgHasPicHolder
