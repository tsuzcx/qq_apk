  ...
  public void run()
  {
    ...
    if (localObject1 != null)
    {
      ...
      for (;;)
      {
        try
        {
          localJSONObject = new JSONObject(utx.a());
          if ((localObject1 == null) || (localObject1 == JSONObject.NULL)) {
            break label146;
          }
          utx.a((JSONObject)localObject1, localJSONObject);
          abrl.d("WSRecommendFragmentPresenter", "setGdtArgs success args =" + utx.a());
          return;
        }
        catch (JSONException localJSONException)
        {
          Object localObject2;
          abrl.a("WSRecommendFragmentPresenter", localJSONException.getMessage());
          return;
        }
        ...
        if (localObject2 != null)
        {
          ...
          if ((localObject2 instanceof JSONObject))
          {
            ...
            continue;
            label146:
            abrl.d("WSRecommendFragmentPresenter", "onResult error");
          }
        }
      }
    }
