  ...
  implements Runnable
{
  ...
  public void run()
  {
    if (!WSRecommendFragment.a(this.this$0).containsKey(Integer.valueOf(this.jdField_a_of_type_Int)))
    {
      ...
      stReportItem localstReportItem = tjr.a(this.jdField_a_of_type_UserGrowthStSimpleMetaFeed, this.jdField_a_of_type_Int);
      if ((this.jdField_a_of_type_UserGrowthStSimpleMetaFeed.video_type != 1) && (this.jdField_a_of_type_UserGrowthStSimpleMetaFeed.video_type != 6)) {
        WSPublicAccReport.getInstance().feedsItemReport("gzh_exposure", tlv.a(1), this.jdField_a_of_type_UserGrowthStSimpleMetaFeed, localstReportItem, 0);
      }
