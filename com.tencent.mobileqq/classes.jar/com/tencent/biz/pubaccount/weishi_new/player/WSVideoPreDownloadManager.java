  ...
  implements usa
{
  ...
  private usn jdField_a_of_type_Usn;
  ...
  public WSVideoPreDownloadManager(Context paramContext)
  {
    ...
    if (!this.jdField_a_of_type_Ury.a())
    {
  ...
  private usj a(String paramString, int paramInt)
  {
    if (this.jdField_a_of_type_Usl == null) {
      return null;
    }
    usj localusj = this.jdField_a_of_type_Usl.a();
    localusj.a(urv.a(paramString), paramString, 101, paramInt);
    return localusj;
  }
  
  private void a(use paramuse)
  {
    if ((paramuse == null) || (TextUtils.isEmpty(paramuse.b))) {}
    usn localusn;
    do
    {
      return;
      localusn = this.jdField_a_of_type_Usn;
      if (localusn == null)
      {
        uya.d("WS_VIDEO_PRE_DL", "[WSVideoPreDownloadManager.java][innerDoPreDownload] start preload ERROR preDownloader == null!");
        return;
      }
      uya.e("WS_VIDEO_PRE_DL", "[WSVideoPreDownloadManager.java][innerDoPreDownload] START DOWNLOAD!! duration:" + paramuse.a + ", title:" + paramuse.c + ", url:" + paramuse.b);
    } while (TextUtils.isEmpty(paramuse.b));
    localusn.a(a(paramuse.b, paramuse.a));
  }
  
  private void c()
  {
    this.jdField_a_of_type_Usl = ust.a().a();
    this.jdField_a_of_type_Usn = this.jdField_a_of_type_Usl.a(BaseApplicationImpl.getContext());
    uya.e("WS_VIDEO_PRE_DL", "[WSVideoPreDownloadManager.java][initCacheMgr] mPreDownloader=" + this.jdField_a_of_type_Usn);
  ...
  private void d()
  {
    ...
    this.jdField_a_of_type_Usn.a(new usc(this));
  }
  ...
  private void e()
  {
    ...
    if (this.jdField_a_of_type_Usn != null)
    {
      this.jdField_a_of_type_Usn.a(null);
      this.jdField_a_of_type_Usn.b();
    }
  }
  ...
  private void f()
  {
    ...
    //   38: ifnull +13 -> 51
    //   41: aload_1
    //   42: getfield 95	use:b	Ljava/lang/String;
    ...
    //   83: invokestatic 110	uya:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   86: goto -49 -> 37
    //   89: aload_0
    //   90: aload_1
    //   91: getfield 95	use:b	Ljava/lang/String;
    ...
    //   122: aload_1
    //   123: getfield 129	use:c	Ljava/lang/String;
    ...
    //   132: invokestatic 137	uya:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   135: aload_0
    //   136: aconst_null
    ...
    //   159: aload_1
    //   160: getfield 129	use:c	Ljava/lang/String;
    ...
    //   169: invokestatic 137	uya:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   172: aload_0
    //   173: aload_1
    //   174: invokespecial 217	com/tencent/biz/pubaccount/weishi_new/player/WSVideoPreDownloadManager:a	(Luse;)V
    //   177: return
    //   178: ldc 103
    //   180: ldc 219
    //   182: invokestatic 137	uya:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   185: return
    //   186: astore_2
    //   187: goto -128 -> 59
  ...
  {
    if (this.jdField_a_of_type_Usd == null) {}
    List localList;
    do
    {
      return;
      ...
      localList = this.jdField_a_of_type_Usd.a(paramInt, paramBoolean);
    } while ((localList == null) || (localList.size() <= 0));
    uya.f("WS_VIDEO_PRE_DL", ">>>>>>[WSVideoPreDownloadManager.java][requestPreDownload] START!! preDownloadList size:" + localList.size());
  ...
  public void a(usd paramusd)
  {
    this.jdField_a_of_type_Usd = paramusd;
  }
  ...
  {
    if (this.jdField_a_of_type_Usn == null) {}
    while ((!this.jdField_a_of_type_Usn.a(a(paramString, 0))) && ((this.jdField_a_of_type_JavaUtilSet == null) || (!this.jdField_a_of_type_JavaUtilSet.contains(paramString)))) {
      return false;
    }
    return true;
  }
