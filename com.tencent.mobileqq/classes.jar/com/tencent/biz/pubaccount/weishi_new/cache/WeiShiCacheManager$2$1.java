  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      tlo.b("CacheResponseLog", "getCacheDataForFollow endTime = " + System.currentTimeMillis() + ", thread = " + Thread.currentThread());
      ((tcm)this.jdField_a_of_type_ComTencentBizPubaccountWeishi_newCacheWeiShiCacheManager$2.a.get()).a(this.jdField_a_of_type_UserGrowthStFollowFeedsRsp);
    }
  }
}
