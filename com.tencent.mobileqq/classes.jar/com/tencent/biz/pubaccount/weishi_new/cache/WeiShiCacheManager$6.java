...
public class WeiShiCacheManager$6
  implements Runnable
{
  public WeiShiCacheManager$6(ulf paramulf, ArrayList paramArrayList, int paramInt) {}
  
  public void run()
  {
    ArrayList localArrayList = new ArrayList();
    if (this.jdField_a_of_type_JavaUtilArrayList.size() >= ulf.b(this.this$0))
    {
      int i = this.jdField_a_of_type_JavaUtilArrayList.size();
      if (this.jdField_a_of_type_JavaUtilArrayList.size() - this.jdField_a_of_type_Int > ulf.b(this.this$0)) {
        i = this.jdField_a_of_type_JavaUtilArrayList.size() - this.jdField_a_of_type_Int;
      }
      for (;;)
      {
        int j = i - ulf.b(this.this$0);
        while (j < i)
        {
    ...
    if (ulf.a(this.this$0, localstSimpleGetFeedListRsp, ulf.b(this.this$0), localArrayList.size())) {
