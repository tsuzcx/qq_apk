...
public class WeiShiCacheManager$1
  implements Runnable
{
  public WeiShiCacheManager$1(uen paramuen, uej paramuej) {}
  ...
  public void run()
  {
    ...
    if (localObject != null) {
      bool = ups.a((pnp)localObject);
    }
    upe.b("WeiShiCacheManager", "isRedDotMsg = " + bool);
    if (bool) {
      if ((this.this$0.a()) && (this.this$0.a() >= 8))
      {
        upe.b("WeiShiCacheManager", "仅读取红点缓存");
        localObject = uen.a(this.this$0, 2);
      }
    }
    for (;;)
    {
      ujn.a().a(new WeiShiCacheManager.1.1(this, (stSimpleGetFeedListRsp)localObject));
      return;
      upe.b("WeiShiCacheManager", "读取红点缓存和瀑布流缓存");
      localObject = uen.a(this.this$0, 2);
      stSimpleGetFeedListRsp localstSimpleGetFeedListRsp2 = uen.a(this.this$0, 1);
      ...
      if (localObject != null)
      {
        upe.b("WeiShiCacheManager", "红点缓存数量 = " + ((stSimpleGetFeedListRsp)localObject).feeds.size());
      ...
      {
        upe.b("WeiShiCacheManager", "瀑布流缓存数量 = " + localstSimpleGetFeedListRsp2.feeds.size());
        localstSimpleGetFeedListRsp1.feeds.addAll(localstSimpleGetFeedListRsp2.feeds);
        localObject = localstSimpleGetFeedListRsp1;
        continue;
        upe.b("WeiShiCacheManager", "读取瀑布流缓存数据");
        localObject = uen.a(this.this$0, 1);
      }
    }
  }
}
