...
class WSVerticalPageEventHandler$3
  implements WSVerticalPageEventHandler.OnLoopHandle<WSVerticalVideoHolder>
{
  WSVerticalPageEventHandler$3(WSVerticalPageEventHandler paramWSVerticalPageEventHandler, String paramString) {}
  ...
  public void a(WSVerticalVideoHolder paramWSVerticalVideoHolder)
  {
    ...
    if ((localstSimpleMetaFeed != null) && (TextUtils.equals(localstSimpleMetaFeed.id, this.a))) {
      paramWSVerticalVideoHolder.c.d(2);
    }
  }
}
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.weishi_new.verticalvideo.WSVerticalPageEventHandler.3
