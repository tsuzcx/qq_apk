...
class WSVerticalVideoOperationRightItemView$1
  implements WSVerticalItemWidgetAdvBigCardController.BigCardStatusChangeListener
{
  WSVerticalVideoOperationRightItemView$1(WSVerticalVideoOperationRightItemView paramWSVerticalVideoOperationRightItemView) {}
  
  public void a()
  {
    WSLog.a("WSVerticalVideoOperationRightItemView", "onBigCardShow");
    this.a.b(false);
  }
  
  public void b()
  {
    WSLog.a("WSVerticalVideoOperationRightItemView", "onBigCardHide");
    this.a.b(true);
  }
}
