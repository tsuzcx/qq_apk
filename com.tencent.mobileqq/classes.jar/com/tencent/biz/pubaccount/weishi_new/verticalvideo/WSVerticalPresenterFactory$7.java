...
import com.tencent.biz.pubaccount.weishi_new.verticalvideo.presenter.WSVerticalForCollectionPresenter;
  ...
  implements WSVerticalPresenterFactory.OnCreatePresenterListener
{
  ...
  {
    return new WSVerticalForCollectionPresenter(paramView);
  }
}
