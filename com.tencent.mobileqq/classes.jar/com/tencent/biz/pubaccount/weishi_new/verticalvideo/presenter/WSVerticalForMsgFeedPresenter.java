...
public class WSVerticalForMsgFeedPresenter
  extends AbsWSVerticalPagePresenter
{
  private String a;
  
  public WSVerticalForMsgFeedPresenter(WSVerticalPageContract.View paramView)
  {
    super(paramView);
  }
  ...
  public void a(RecyclerView.ViewHolder paramViewHolder, int paramInt)
  {
    ...
    WSLog.d("WSVerticalForMsgFeedPresenter", localStringBuilder.toString());
    if ((paramViewHolder instanceof WSVerticalVideoHolder))
    {
      paramViewHolder = new WSCommentEvent(4, new Object[] { Integer.valueOf(paramInt), ((WSVerticalVideoHolder)paramViewHolder).e });
  ...
  {
    paramString = new WeishiTask(new GetFeedDetailRequest(paramString), null, new WSVerticalForMsgFeedPresenter.1(this, paramLong, paramIFetchDataRspListener), 4002);
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.weishi_new.verticalvideo.presenter.WSVerticalForMsgFeedPresenter
