  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    {
      WSVerticalBeaconReport.f(WSVerticalPageBackTopAreaController.a(this.a).a(), WSVerticalPageBackTopAreaController.a(this.a).b(), WSVerticalPageBackTopAreaController.a(this.a).a(), ((WSVerticalPageContract.Presenter)WSVerticalPageBackTopAreaController.a(this.a).b()).a());
