  ...
  implements WeishiUtils.OnDownloadOpenWeishiGoH5Listener
{
  ...
  {
    WeishiScehmeUtil.a(WSFollowFeedHolder.f(this.a), "biz_src_jc_gzh_weishi", paramString);
  ...
  public void c(String paramString, int paramInt)
  {
    ...
    WeishiDownloadUtil.a((Activity)WSFollowFeedHolder.g(this.a), localWSDownloadParams, false);
