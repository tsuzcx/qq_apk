  ...
  extends LinearLayout
{
  ...
  private void a(int paramInt, String paramString)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilArrayList.size() > paramInt)
    {
      ...
      Drawable localDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130845265);
      sam.a(localRoundImageView, paramString, localDrawable, localDrawable, "avatar" + paramInt);
    }
    for (;;)
    {
      ...
      return;
      label78:
      localRoundImageView.setImageResource(2130845265);
    }
  }
  ...
  private void a(String paramString)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      Drawable localDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841183);
      sam.a(this.jdField_a_of_type_AndroidWidgetImageView, paramString, localDrawable, localDrawable, "banner");
      return;
    }
  ...
  private void b()
  {
    this.jdField_a_of_type_ComTencentBizPubaccountWeishi_newViewRoundImageView = ((RoundImageView)findViewById(2131297410));
    ...
    this.b = ((RoundImageView)findViewById(2131297411));
    this.b.setBorderColor(Color.parseColor("#c1c1c1"));
    this.b.setBorderWidth(1);
    this.c = ((RoundImageView)findViewById(2131297412));
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131305276));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131305272));
    ViewGroup.LayoutParams localLayoutParams = this.jdField_a_of_type_AndroidWidgetImageView.getLayoutParams();
    int i = bjlo.jdField_a_of_type_Int * 120 / 750;
    if (i > 0)
    {
      localLayoutParams.height = i;
      this.jdField_a_of_type_AndroidWidgetImageView.setLayoutParams(localLayoutParams);
    }
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131312348));
  }
  ...
  public void a(stNotificationRsp paramstNotificationRsp, ryp paramryp)
  {
    ...
    setVisibility(0);
    rzw.a(6, this.jdField_a_of_type_Int, paramstNotificationRsp.cid);
    ...
    {
      paramryp = (stSimpleMetaPerson)paramstNotificationRsp.get(i);
      if ((paramryp != null) && (!TextUtils.isEmpty(paramryp.avatar))) {
        a(i, paramryp.avatar);
      }
      i += 1;
    }
    sai.a("813", "mAvatar1 :" + this.jdField_a_of_type_ComTencentBizPubaccountWeishi_newViewRoundImageView.getVisibility());
    sai.a("813", "mAvatar2 :" + this.b.getVisibility());
    sai.a("813", "mAvatar3 :" + this.c.getVisibility());
  }
