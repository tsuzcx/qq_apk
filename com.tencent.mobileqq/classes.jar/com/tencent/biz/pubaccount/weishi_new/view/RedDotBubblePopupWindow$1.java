  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    do
    {
      ...
      WSLog.d("RedDotBubblePopupWindow", "popupWidth:" + i + " popupHeight:" + j + "   location[0]:" + arrayOfInt[0] + " location[1]:" + arrayOfInt[1] + " getWidth:" + this.a.getWidth() + " getHeight:" + this.a.getHeight());
    ...
    this.this$0.showAtLocation(this.a, 0, arrayOfInt[0] + this.a.getWidth() / 2 - i / 2, arrayOfInt[1] + this.a.getHeight() + ViewUtils.a(2.0F));
