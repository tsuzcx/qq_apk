...
public class WSCommentBeaconReport
{
  ...
  {
    return new WSStatisticsReporter.Builder().setTabId(d(paramString)).setSopName(paramString).setTestId(WeishiUtils.a(10003)).setPushId(WSInitializeHelper.a().a()).setFlush(true).setImmediatelyUpload(WeishiUtils.d());
  }
