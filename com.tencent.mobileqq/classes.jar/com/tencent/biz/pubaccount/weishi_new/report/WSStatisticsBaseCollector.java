...
public class WSStatisticsBaseCollector
{
  ...
  public static Map<String, String> getBaseParams()
  {
    ...
    localHashMap.put("imsi", babp.b());
    localHashMap.put("imei", bcez.c());
    localHashMap.put("mac", bcez.a());
    ...
    localHashMap.put("screen_res", bcez.e());
    ...
    localHashMap.put("wifiBssid", sam.d());
    ...
    localHashMap.put("android_id", babp.f());
    localHashMap.put("qq", sam.a().getAccount());
    ...
    for (String str = "1";; str = "0")
    {
      ...
      localHashMap.put("network_type", sam.c());
