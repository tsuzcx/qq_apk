...
public class WSHardwareUtil
{
  ...
  public static int a()
  {
    ...
    //   3: istore_0
    //   4: iload_2
    //   5: invokestatic 34	com/tencent/biz/pubaccount/weishi_new/util/WSHardwareUtil:b	()I
    //   8: if_icmpge +163 -> 171
    ...
    //   28: aload 4
    //   30: iload_2
    //   31: invokevirtual 46	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   34: pop
    //   35: aload 4
    //   37: ldc 48
    ...
    //   52: invokespecial 57	java/io/File:<init>	(Ljava/lang/String;)V
    //   55: astore 4
    //   57: iload_0
    //   58: istore_1
    //   59: aload 4
    ...
    //   68: istore_1
    //   69: aload 4
    //   71: invokevirtual 64	java/io/File:canRead	()Z
    //   74: ifeq +167 -> 241
    //   77: sipush 128
    //   80: newarray byte
    //   82: astore 5
    ...
    //   87: dup
    //   88: aload 4
    //   90: invokespecial 69	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   93: astore 4
    //   95: aload 4
    //   97: aload 5
    ...
    //   107: iload_1
    //   108: baload
    //   109: invokestatic 79	java/lang/Character:isDigit	(I)Z
    //   112: ifeq +17 -> 129
    //   115: iload_1
    //   116: aload 5
    //   118: arraylength
    ...
    //   125: istore_1
    //   126: goto -21 -> 105
    //   129: new 81	java/lang/String
    //   132: dup
    //   133: aload 5
    //   135: iconst_0
    //   136: iload_1
    //   137: invokespecial 84	java/lang/String:<init>	([BII)V
    //   140: invokestatic 90	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   143: istore_3
    //   144: iload_0
    //   145: istore_1
    //   146: iload_3
    ...
    //   161: astore 5
    //   163: aload 4
    //   165: invokevirtual 93	java/io/FileInputStream:close	()V
    //   168: aload 5
    //   170: athrow
    //   171: iload_0
    //   172: iconst_m1
    //   173: if_icmpne +55 -> 228
    //   176: new 66	java/io/FileInputStream
    //   179: dup
    //   180: ldc 95
    //   182: invokespecial 96	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   185: astore 4
    //   187: ldc 98
    //   189: aload 4
    //   191: invokestatic 101	com/tencent/biz/pubaccount/weishi_new/util/WSHardwareUtil:a	(Ljava/lang/String;Ljava/io/FileInputStream;)I
    //   194: istore_1
    //   195: iload_1
    //   196: sipush 1000
    //   199: imul
    ...
    //   218: astore 5
    //   220: aload 4
    //   222: invokevirtual 93	java/io/FileInputStream:close	()V
    //   225: aload 5
    //   227: athrow
    //   228: iload_0
    //   229: ireturn
  ...
  private static int a(String paramString)
  {
    ...
    //   3: dup
    //   4: aload_0
    //   5: invokespecial 96	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   8: astore_0
    //   9: new 111	java/io/BufferedReader
    //   12: dup
    //   13: new 113	java/io/InputStreamReader
    //   16: dup
    //   17: aload_0
    //   18: invokespecial 116	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    ...
    //   29: astore_3
    //   30: aload_2
    //   31: invokevirtual 123	java/io/BufferedReader:close	()V
    //   34: aload_3
    //   35: invokestatic 125	com/tencent/biz/pubaccount/weishi_new/util/WSHardwareUtil:b	(Ljava/lang/String;)I
    //   38: istore_1
    //   39: aload_0
    //   40: invokevirtual 128	java/io/InputStream:close	()V
    //   43: iload_1
    //   44: ireturn
    //   45: astore_3
    //   46: aload_0
    ...
    //   72: ifnull +7 -> 79
    //   75: aload_0
    //   76: invokevirtual 128	java/io/InputStream:close	()V
    //   79: iconst_m1
    //   80: ireturn
    //   81: astore_0
    //   82: goto -13 -> 69
  ...
  {
    // Byte code:
    //   0: new 283	java/io/FileReader
    //   3: dup
    //   4: ldc 95
    //   6: invokespecial 284	java/io/FileReader:<init>	(Ljava/lang/String;)V
    //   9: astore_1
    //   10: aload_1
    //   11: astore_0
    //   12: new 111	java/io/BufferedReader
    //   15: dup
    //   16: aload_1
    //   17: invokespecial 119	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   20: astore 4
    //   22: ldc_w 286
    //   25: astore_2
    //   26: aload_1
    //   27: astore_0
    //   28: aload 4
    //   30: invokevirtual 122	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   33: astore_3
    //   34: aload_3
    //   35: ifnull +8 -> 43
    //   38: aload_3
    ...
    //   45: aload_2
    //   46: ldc_w 288
    //   49: invokevirtual 292	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   52: ifeq +29 -> 81
    //   55: aload_1
    //   56: astore_0
    //   57: aload_2
    //   58: ldc_w 294
    //   61: iconst_2
    //   62: invokevirtual 298	java/lang/String:split	(Ljava/lang/String;I)[Ljava/lang/String;
    //   65: iconst_1
    //   66: aaload
    //   67: astore_2
    //   68: aload_1
    //   69: invokevirtual 299	java/io/FileReader:close	()V
    //   72: aload_2
    //   73: areturn
    //   74: astore_0
    //   75: aload_0
    //   76: invokevirtual 300	java/lang/Exception:printStackTrace	()V
    //   79: aload_2
    //   80: areturn
    //   81: aload_1
    //   82: invokevirtual 299	java/io/FileReader:close	()V
    //   85: goto +38 -> 123
    //   88: astore_2
    //   89: goto +12 -> 101
    //   92: astore_0
    ...
    //   102: astore_0
    //   103: aload_2
    //   104: invokevirtual 300	java/lang/Exception:printStackTrace	()V
    //   107: aload_1
    //   108: ifnull +15 -> 123
    //   111: aload_1
    //   112: invokevirtual 299	java/io/FileReader:close	()V
    //   115: goto +8 -> 123
    //   118: astore_0
    //   119: aload_0
    //   120: invokevirtual 300	java/lang/Exception:printStackTrace	()V
    //   123: getstatic 303	android/os/Build:HARDWARE	Ljava/lang/String;
    //   126: areturn
    //   127: astore_2
    //   128: aload_0
    //   129: astore_1
    ...
    //   133: ifnull +15 -> 148
    //   136: aload_1
    //   137: invokevirtual 299	java/io/FileReader:close	()V
    //   140: goto +8 -> 148
    //   143: astore_1
    //   144: aload_1
    //   145: invokevirtual 300	java/lang/Exception:printStackTrace	()V
    //   148: goto +5 -> 153
    //   151: aload_0
    //   152: athrow
    //   153: goto -2 -> 151
