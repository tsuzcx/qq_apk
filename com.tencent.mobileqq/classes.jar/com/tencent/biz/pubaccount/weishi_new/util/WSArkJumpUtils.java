...
public class WSArkJumpUtils
{
  ...
  private static void a(stSimpleMetaFeed paramstSimpleMetaFeed, Context paramContext)
  {
    if (paramContext != null)
    {
      ...
      WSLauncher.VerticalPageLauncher.a(new WSVerticalPageOpenParams(paramContext, "qqchat", "qqchat").a(paramstSimpleMetaFeed).a(true));
    }
  }
  ...
  private static stSimpleMetaFeed b(String paramString)
  {
    try
    {
      paramString = new JSONObject(paramString);
