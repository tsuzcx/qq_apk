...
public class PublicAccountAdUtil
{
              ...
              if (((AbsStructMsgItem)localObject3).a.size() > 0)
              {
                ...
                for (;;)
                {
                  ...
                  if ((localObject4 instanceof StructMsgItemVideo))
                  {
                    ...
                    if ((!TextUtils.isEmpty(((StructMsgItemVideo)localObject4).ac)) && (!TextUtils.isEmpty(((StructMsgItemVideo)localObject4).ad)))
                    {
                      localObject4 = new VideoCoverItem(i, ((StructMsgItemVideo)localObject4).ac, ((StructMsgItemVideo)localObject4).ad);
                      i += 1;
  ...
  public static oidb_cmd0x886.PhoneInfo a()
  {
    ...
    Object localObject = AdDeviceInfoUtil.a();
    String str = AdDeviceInfoUtil.c();
