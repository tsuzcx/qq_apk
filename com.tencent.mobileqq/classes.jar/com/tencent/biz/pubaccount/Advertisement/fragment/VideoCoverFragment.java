  ...
  implements View.OnClickListener
{
  ...
  private void d()
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Nis.jdField_a_of_type_Niu.jdField_b_of_type_Int == this.jdField_c_of_type_Int)
      {
      ...
      while (f())
      {
        ...
        if (this.jdField_a_of_type_Nis.jdField_a_of_type_Niu.jdField_b_of_type_Int == this.jdField_e_of_type_Int) {
          g();
        }
      }
    }
  ...
  private void d(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      ...
      if ((this.jdField_a_of_type_Nis.jdField_a_of_type_Niu != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_Nis.jdField_a_of_type_Niu.o)))
      {
        this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
        this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Nis.jdField_a_of_type_Niu.o);
      }
      ...
      for (;;)
      {
        ...
        localLayoutParams.setMargins(0, 0, 0, actj.a(18.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
        return;
        this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
      }
      localLayoutParams.setMargins(0, 0, 0, actj.a(30.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      return;
    }
  ...
  {
    boolean bool3 = false;
    niu localniu = this.jdField_a_of_type_Nis.jdField_a_of_type_Niu;
    if ((localniu == null) || (!this.jdField_d_of_type_Boolean)) {}
    ...
    do
    {
      ...
      {
        return false;
      } while (!localniu.jdField_b_of_type_Boolean);
      if (QLog.isColorLevel())
      {
        localStringBuilder = new StringBuilder().append("canShowBanner bannerImgUrl == null ");
        if (TextUtils.isEmpty(localniu.f)) {
          break;
        }
        bool1 = true;
        localStringBuilder = localStringBuilder.append(bool1).append("，bannerButtonText == null");
        if (TextUtils.isEmpty(localniu.h)) {
          break label433;
        }
        bool1 = true;
        localStringBuilder = localStringBuilder.append(bool1).append("，bannerText == null");
        if (TextUtils.isEmpty(localniu.g)) {
          break label438;
        }
        bool1 = true;
        localStringBuilder = localStringBuilder.append(bool1).append("，mNickName == null");
        if (TextUtils.isEmpty(localniu.jdField_b_of_type_JavaLangString)) {
          break label443;
        }
        bool1 = true;
        localStringBuilder = localStringBuilder.append(bool1).append("，mTrueUin == null");
        if (TextUtils.isEmpty(localniu.jdField_a_of_type_JavaLangString)) {
          break label448;
        }
        bool1 = true;
        localStringBuilder = localStringBuilder.append(bool1).append("，adId == null");
        if (TextUtils.isEmpty(localniu.jdField_c_of_type_JavaLangString)) {
          break label453;
        }
        bool1 = true;
        localStringBuilder = localStringBuilder.append(bool1).append("，adPosId == null");
        if (TextUtils.isEmpty(localniu.jdField_d_of_type_JavaLangString)) {
          break label458;
        }
        bool1 = true;
        QLog.d("VideoCoverFragment", 2, bool1);
      }
    } while ((TextUtils.isEmpty(localniu.f)) || (TextUtils.isEmpty(localniu.h)) || (TextUtils.isEmpty(localniu.g)) || (TextUtils.isEmpty(localniu.jdField_b_of_type_JavaLangString)) || (TextUtils.isEmpty(localniu.jdField_a_of_type_JavaLangString)) || (TextUtils.isEmpty(localniu.jdField_c_of_type_JavaLangString)) || (TextUtils.isEmpty(localniu.jdField_d_of_type_JavaLangString)));
    label148:
    label175:
    label202:
    label229:
    if (QLog.isColorLevel()) {
      QLog.d("VideoCoverFragment", 2, "canShowBanner jumpType = " + localniu.jdField_d_of_type_Int);
    }
    if (localniu.jdField_d_of_type_Int == 2)
    {
      if (QLog.isColorLevel())
      {
        localStringBuilder = new StringBuilder().append("canShowBanner jumpUrl = null ");
        if (TextUtils.isEmpty(localniu.n)) {
          break label463;
        }
      }
      label433:
    ...
    if (localniu.jdField_d_of_type_Int == 1) {
      if (QLog.isColorLevel())
      {
        localStringBuilder = new StringBuilder().append("canShowBanner myappDownloadUrl = null ");
        if (!TextUtils.isEmpty(localniu.jdField_j_of_type_JavaLangString))
        {
          bool1 = true;
          QLog.d("VideoCoverFragment", 2, bool1);
        }
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      for (boolean bool2 = true;; bool2 = false)
      {
        ...
        bool2 = bool3;
        if (!TextUtils.isEmpty(localniu.jdField_i_of_type_JavaLangString)) {
          bool2 = true;
        }
        QLog.d("VideoCoverFragment", 2, bool2);
        if ((TextUtils.isEmpty(localniu.k)) || (TextUtils.isEmpty(localniu.m)) || (TextUtils.isEmpty(localniu.l)) || (TextUtils.isEmpty(localniu.jdField_i_of_type_JavaLangString))) {
          break label739;
        }
        return true;
        bool1 = false;
  ...
  private void e()
  {
    ...
    if (localTVK_IMediaPlayer.getOutputMute())
    {
      ...
      this.i = true;
      this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdControlView.b().setBackgroundResource(2130841155);
      axqy.a(null, "dc00898", "", this.jdField_a_of_type_Nis.jdField_a_of_type_Niu.jdField_a_of_type_JavaLangString, "0X8008F62", "0X8008F62", 0, 0, this.jdField_a_of_type_Nis.jdField_a_of_type_Niu.jdField_c_of_type_JavaLangString, "", ((nit)this.jdField_a_of_type_Nis.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_b_of_type_Int)).jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Nis.jdField_a_of_type_Niu.jdField_b_of_type_JavaLangString);
      return;
    }
    ...
    this.i = true;
    this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdControlView.b().setBackgroundResource(2130841154);
    axqy.a(null, "dc00898", "", this.jdField_a_of_type_Nis.jdField_a_of_type_Niu.jdField_a_of_type_JavaLangString, "0X8008F63", "0X8008F63", 0, 0, this.jdField_a_of_type_Nis.jdField_a_of_type_Niu.jdField_c_of_type_JavaLangString, "", ((nit)this.jdField_a_of_type_Nis.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_b_of_type_Int)).jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Nis.jdField_a_of_type_Niu.jdField_b_of_type_JavaLangString);
  }
  ...
  private boolean e()
  {
    ...
    try
    {
      ...
      if ((this.jdField_a_of_type_Nis == null) || (this.jdField_a_of_type_Nis.jdField_a_of_type_JavaUtilArrayList == null) || (this.jdField_a_of_type_Nis.jdField_a_of_type_JavaUtilArrayList.size() <= 0))
      {
        if (QLog.isColorLevel()) {
  ...
  private void f()
  {
    ...
    if (d())
    {
      ...
      if (!TextUtils.isEmpty(localniu.f))
      {
        ...
        localObject1 = URLDrawable.getDrawable(localniu.f, (URLDrawable.URLDrawableOptions)localObject1);
        if ((localObject1 != null) && (((URLDrawable)localObject1).getStatus() == 1))
        {
          ...
          ((ViewGroup.LayoutParams)localObject2).width = (j * actj.a(23.0F, this.jdField_a_of_type_AndroidContentContext.getResources()) / k);
          this.jdField_a_of_type_ComTencentImageURLImageView.setLayoutParams((ViewGroup.LayoutParams)localObject2);
        }
        this.jdField_a_of_type_ComTencentImageURLImageView.setURLDrawableDownListener(new niy(this));
        this.jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable((Drawable)localObject1);
      }
      this.jdField_b_of_type_AndroidWidgetTextView.setText(localniu.g);
      if (localniu.jdField_c_of_type_Int == 1)
      {
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setVisibility(0);
        this.jdField_g_of_type_AndroidViewView.setVisibility(8);
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setText(localniu.h);
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("VideoCoverFragment", 2, "canShowBanner scrollUpToJump = " + localniu.jdField_d_of_type_Boolean);
      }
      if (((this.jdField_a_of_type_Nis.jdField_a_of_type_Niu.jdField_d_of_type_Int != 1) || (TextUtils.isEmpty(this.jdField_a_of_type_Nis.jdField_a_of_type_Niu.jdField_j_of_type_JavaLangString))) && ((this.jdField_a_of_type_Nis.jdField_a_of_type_Niu.jdField_d_of_type_Int < 2) || (TextUtils.isEmpty(this.jdField_a_of_type_Nis.jdField_a_of_type_Niu.n)) || (!this.jdField_a_of_type_Nis.jdField_a_of_type_Niu.jdField_d_of_type_Boolean) || (!this.jdField_d_of_type_Boolean))) {
        break;
      }
      d(true);
      return;
      if (localniu.jdField_c_of_type_Int == 2)
      {
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setVisibility(8);
        this.jdField_g_of_type_AndroidViewView.setVisibility(0);
        this.jdField_c_of_type_AndroidWidgetTextView.setText(localniu.h);
  ...
  private void g()
  {
    ...
    do
    {
      ...
      n = this.jdField_a_of_type_Nis.jdField_a_of_type_Niu.jdField_a_of_type_Int;
      if (QLog.isColorLevel()) {
  ...
  public void a(int paramInt)
  {
    ...
    if (this.jdField_g_of_type_Boolean)
    {
      ...
      if (((PublicAccountAdvertisementActivity)getActivity()).b())
      {
        ...
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setText(ajya.a(2131716137));
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setTextColor(-1);
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setBackgroundResource(2130839047);
      ...
      if (((PublicAccountAdvertisementActivity)getActivity()).c())
      {
        ...
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setText(ajya.a(2131716139));
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setTextColor(-1);
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setBackgroundResource(2130839047);
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setProgress(0);
        return;
      ...
      if (paramInt == 0)
      {
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setText(this.jdField_a_of_type_Nis.jdField_a_of_type_Niu.h);
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setTextColor(-1);
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setBackgroundResource(2130839047);
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setProgress(0);
        return;
      ...
      if (paramInt == 100)
      {
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setText(ajya.a(2131716135));
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setTextColor(-1);
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setBackgroundResource(2130839047);
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setProgress(0);
        return;
      }
      this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setText(ajya.a(2131716133));
    ...
    if (((PublicAccountAdvertisementActivity)getActivity()).b())
    {
      this.jdField_c_of_type_AndroidWidgetTextView.setText(ajya.a(2131716131));
      return;
    }
    if (((PublicAccountAdvertisementActivity)getActivity()).c())
    {
      this.jdField_c_of_type_AndroidWidgetTextView.setText(ajya.a(2131716138));
      return;
    }
    if (paramInt == 0)
    {
    ...
    if (paramInt == 100)
    {
      this.jdField_c_of_type_AndroidWidgetTextView.setText(ajya.a(2131716132));
      return;
    }
    this.jdField_c_of_type_AndroidWidgetTextView.setText(ajya.a(2131716136) + paramInt + "%");
  }
  
  public void a(nis paramnis, ViewPager.OnPageChangeListener paramOnPageChangeListener, View.OnClickListener paramOnClickListener, AudioManager paramAudioManager, AdControlView paramAdControlView, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidSupportV4ViewViewPager$OnPageChangeListener = new niv(this, paramOnPageChangeListener);
  ...
  public void a(boolean paramBoolean, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      ...
      axqy.a(null, "dc00898", "", this.jdField_a_of_type_Nis.jdField_a_of_type_Niu.jdField_a_of_type_JavaLangString, "0X8008F67", "0X8008F67", 0, 0, this.jdField_a_of_type_Nis.jdField_a_of_type_Niu.jdField_c_of_type_JavaLangString, "", "", this.jdField_a_of_type_Nis.jdField_a_of_type_Niu.jdField_b_of_type_JavaLangString);
      return;
    }
  ...
  {
    if (QLog.isColorLevel()) {
      if ("forceSetControllerPanelVisible " + this.jdField_a_of_type_Nis.jdField_a_of_type_Niu == null) {
        break label103;
      }
    }
    label103:
    for (Object localObject = Integer.valueOf(this.jdField_a_of_type_Nis.jdField_a_of_type_Niu.jdField_i_of_type_Int);; localObject = "null")
    {
      QLog.d("VideoCoverFragment", 2, new Object[] { localObject });
      if (this.jdField_a_of_type_Nis.jdField_a_of_type_Niu.jdField_i_of_type_Int != 2) {
        break;
      }
      this.jdField_b_of_type_AndroidViewView.setVisibility(0);
  ...
  {
    return paramLayoutInflater.inflate(2131559414, paramViewGroup, false);
  }
  ...
  public void onResume()
  {
    ...
    {
      if ((f()) || (this.jdField_a_of_type_Nis.jdField_a_of_type_Niu.jdField_b_of_type_Int == this.jdField_c_of_type_Int)) {
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdControlView.a();
      }
      if ((this.jdField_a_of_type_Nis.jdField_a_of_type_Niu.jdField_b_of_type_Int == this.jdField_e_of_type_Int) && (this.jdField_a_of_type_Int == 0)) {
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdControlView.a();
      }
    }
  ...
  {
    if ((this.jdField_a_of_type_Nis == null) && (!e())) {
      getActivity().finish();
    }
    do
    {
    ...
    this.jdField_a_of_type_AndroidSupportV4ViewViewPager = ((ViewPager)localViewGroup.findViewById(2131379032));
    this.jdField_b_of_type_AndroidViewView = localViewGroup.findViewById(2131367903);
    if ((!a()) && (this.jdField_a_of_type_Nis != null) && (this.jdField_a_of_type_Nis.jdField_a_of_type_Niu != null) && (this.jdField_a_of_type_Nis.jdField_a_of_type_Niu.jdField_j_of_type_Int > 0)) {
      a(true, this.jdField_a_of_type_Nis.jdField_a_of_type_Niu.jdField_j_of_type_Int);
    }
    this.jdField_a_of_type_AndroidViewView = localViewGroup.findViewById(2131367904);
    this.jdField_a_of_type_AndroidViewView.setOnTouchListener(new niw(this));
    this.jdField_c_of_type_AndroidViewView = localViewGroup.findViewById(2131378959);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localViewGroup.findViewById(2131378932));
    this.jdField_d_of_type_AndroidViewView = localViewGroup.findViewById(2131378755);
    this.jdField_e_of_type_AndroidViewView = localViewGroup.findViewById(2131378756);
    this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementAdapterVideoCoverAdapter = new VideoCoverAdapter(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdControlView.a(), this.jdField_a_of_type_Nis, new nix(this));
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdControlView.a().setTotalCount(this.jdField_a_of_type_Nis.jdField_a_of_type_JavaUtilArrayList.size());
    this.jdField_c_of_type_AndroidViewView.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
    this.jdField_f_of_type_AndroidViewView = localViewGroup.findViewById(2131378952);
    this.jdField_f_of_type_AndroidViewView.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
    this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localViewGroup.findViewById(2131378954));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localViewGroup.findViewById(2131378953));
    this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton = ((AdProgressButton)localViewGroup.findViewById(2131378958));
    this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setProgressColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131165297));
    this.jdField_g_of_type_AndroidViewView = localViewGroup.findViewById(2131378956);
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)localViewGroup.findViewById(2131378955));
    f();
    d();
