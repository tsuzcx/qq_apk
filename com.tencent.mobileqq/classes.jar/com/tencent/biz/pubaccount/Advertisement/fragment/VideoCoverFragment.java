  ...
  implements View.OnClickListener
{
  ...
  private void d()
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Mxu.jdField_a_of_type_Mxw.jdField_b_of_type_Int == this.jdField_c_of_type_Int)
      {
      ...
      while (f())
      {
        ...
        if (this.jdField_a_of_type_Mxu.jdField_a_of_type_Mxw.jdField_b_of_type_Int == this.jdField_e_of_type_Int) {
          g();
        }
      }
    }
  ...
  private void d(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      ...
      if ((this.jdField_a_of_type_Mxu.jdField_a_of_type_Mxw != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_Mxu.jdField_a_of_type_Mxw.o)))
      {
        this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
        this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Mxu.jdField_a_of_type_Mxw.o);
      }
      ...
      for (;;)
      {
        ...
        localLayoutParams.setMargins(0, 0, 0, aciy.a(18.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
        return;
        this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
      }
      localLayoutParams.setMargins(0, 0, 0, aciy.a(30.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      return;
    }
  ...
  {
    boolean bool3 = false;
    mxw localmxw = this.jdField_a_of_type_Mxu.jdField_a_of_type_Mxw;
    if ((localmxw == null) || (!this.jdField_d_of_type_Boolean)) {}
    ...
    do
    {
      ...
      {
        return false;
      } while (!localmxw.jdField_b_of_type_Boolean);
      if (QLog.isColorLevel())
      {
        localStringBuilder = new StringBuilder().append("canShowBanner bannerImgUrl == null ");
        if (TextUtils.isEmpty(localmxw.f)) {
          break;
        }
        bool1 = true;
        localStringBuilder = localStringBuilder.append(bool1).append("，bannerButtonText == null");
        if (TextUtils.isEmpty(localmxw.h)) {
          break label433;
        }
        bool1 = true;
        localStringBuilder = localStringBuilder.append(bool1).append("，bannerText == null");
        if (TextUtils.isEmpty(localmxw.g)) {
          break label438;
        }
        bool1 = true;
        localStringBuilder = localStringBuilder.append(bool1).append("，mNickName == null");
        if (TextUtils.isEmpty(localmxw.jdField_b_of_type_JavaLangString)) {
          break label443;
        }
        bool1 = true;
        localStringBuilder = localStringBuilder.append(bool1).append("，mTrueUin == null");
        if (TextUtils.isEmpty(localmxw.jdField_a_of_type_JavaLangString)) {
          break label448;
        }
        bool1 = true;
        localStringBuilder = localStringBuilder.append(bool1).append("，adId == null");
        if (TextUtils.isEmpty(localmxw.jdField_c_of_type_JavaLangString)) {
          break label453;
        }
        bool1 = true;
        localStringBuilder = localStringBuilder.append(bool1).append("，adPosId == null");
        if (TextUtils.isEmpty(localmxw.jdField_d_of_type_JavaLangString)) {
          break label458;
        }
        bool1 = true;
        QLog.d("VideoCoverFragment", 2, bool1);
      }
    } while ((TextUtils.isEmpty(localmxw.f)) || (TextUtils.isEmpty(localmxw.h)) || (TextUtils.isEmpty(localmxw.g)) || (TextUtils.isEmpty(localmxw.jdField_b_of_type_JavaLangString)) || (TextUtils.isEmpty(localmxw.jdField_a_of_type_JavaLangString)) || (TextUtils.isEmpty(localmxw.jdField_c_of_type_JavaLangString)) || (TextUtils.isEmpty(localmxw.jdField_d_of_type_JavaLangString)));
    label148:
    label175:
    label202:
    label229:
    if (QLog.isColorLevel()) {
      QLog.d("VideoCoverFragment", 2, "canShowBanner jumpType = " + localmxw.jdField_d_of_type_Int);
    }
    if (localmxw.jdField_d_of_type_Int == 2)
    {
      if (QLog.isColorLevel())
      {
        localStringBuilder = new StringBuilder().append("canShowBanner jumpUrl = null ");
        if (TextUtils.isEmpty(localmxw.n)) {
          break label463;
        }
      }
      label433:
    ...
    if (localmxw.jdField_d_of_type_Int == 1) {
      if (QLog.isColorLevel())
      {
        localStringBuilder = new StringBuilder().append("canShowBanner myappDownloadUrl = null ");
        if (!TextUtils.isEmpty(localmxw.jdField_j_of_type_JavaLangString))
        {
          bool1 = true;
          QLog.d("VideoCoverFragment", 2, bool1);
        }
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      for (boolean bool2 = true;; bool2 = false)
      {
        ...
        bool2 = bool3;
        if (!TextUtils.isEmpty(localmxw.jdField_i_of_type_JavaLangString)) {
          bool2 = true;
        }
        QLog.d("VideoCoverFragment", 2, bool2);
        if ((TextUtils.isEmpty(localmxw.k)) || (TextUtils.isEmpty(localmxw.m)) || (TextUtils.isEmpty(localmxw.l)) || (TextUtils.isEmpty(localmxw.jdField_i_of_type_JavaLangString))) {
          break label739;
        }
        return true;
        bool1 = false;
  ...
  private void e()
  {
    ...
    if (localTVK_IMediaPlayer.getOutputMute())
    {
      ...
      this.i = true;
      this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdControlView.b().setBackgroundResource(2130841081);
      awqx.a(null, "dc00898", "", this.jdField_a_of_type_Mxu.jdField_a_of_type_Mxw.jdField_a_of_type_JavaLangString, "0X8008F62", "0X8008F62", 0, 0, this.jdField_a_of_type_Mxu.jdField_a_of_type_Mxw.jdField_c_of_type_JavaLangString, "", ((mxv)this.jdField_a_of_type_Mxu.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_b_of_type_Int)).jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Mxu.jdField_a_of_type_Mxw.jdField_b_of_type_JavaLangString);
      return;
    }
    ...
    this.i = true;
    this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdControlView.b().setBackgroundResource(2130841080);
    awqx.a(null, "dc00898", "", this.jdField_a_of_type_Mxu.jdField_a_of_type_Mxw.jdField_a_of_type_JavaLangString, "0X8008F63", "0X8008F63", 0, 0, this.jdField_a_of_type_Mxu.jdField_a_of_type_Mxw.jdField_c_of_type_JavaLangString, "", ((mxv)this.jdField_a_of_type_Mxu.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_b_of_type_Int)).jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Mxu.jdField_a_of_type_Mxw.jdField_b_of_type_JavaLangString);
  }
  ...
  private boolean e()
  {
    ...
    try
    {
      ...
      if ((this.jdField_a_of_type_Mxu == null) || (this.jdField_a_of_type_Mxu.jdField_a_of_type_JavaUtilArrayList == null) || (this.jdField_a_of_type_Mxu.jdField_a_of_type_JavaUtilArrayList.size() <= 0))
      {
        if (QLog.isColorLevel()) {
  ...
  private void f()
  {
    ...
    if (d())
    {
      ...
      if (!TextUtils.isEmpty(localmxw.f))
      {
        ...
        localObject1 = URLDrawable.getDrawable(localmxw.f, (URLDrawable.URLDrawableOptions)localObject1);
        if ((localObject1 != null) && (((URLDrawable)localObject1).getStatus() == 1))
        {
          ...
          ((ViewGroup.LayoutParams)localObject2).width = (j * aciy.a(23.0F, this.jdField_a_of_type_AndroidContentContext.getResources()) / k);
          this.jdField_a_of_type_ComTencentImageURLImageView.setLayoutParams((ViewGroup.LayoutParams)localObject2);
        }
        this.jdField_a_of_type_ComTencentImageURLImageView.setURLDrawableDownListener(new mya(this));
        this.jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable((Drawable)localObject1);
      }
      this.jdField_b_of_type_AndroidWidgetTextView.setText(localmxw.g);
      if (localmxw.jdField_c_of_type_Int == 1)
      {
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setVisibility(0);
        this.jdField_g_of_type_AndroidViewView.setVisibility(8);
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setText(localmxw.h);
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("VideoCoverFragment", 2, "canShowBanner scrollUpToJump = " + localmxw.jdField_d_of_type_Boolean);
      }
      if (((this.jdField_a_of_type_Mxu.jdField_a_of_type_Mxw.jdField_d_of_type_Int != 1) || (TextUtils.isEmpty(this.jdField_a_of_type_Mxu.jdField_a_of_type_Mxw.jdField_j_of_type_JavaLangString))) && ((this.jdField_a_of_type_Mxu.jdField_a_of_type_Mxw.jdField_d_of_type_Int < 2) || (TextUtils.isEmpty(this.jdField_a_of_type_Mxu.jdField_a_of_type_Mxw.n)) || (!this.jdField_a_of_type_Mxu.jdField_a_of_type_Mxw.jdField_d_of_type_Boolean) || (!this.jdField_d_of_type_Boolean))) {
        break;
      }
      d(true);
      return;
      if (localmxw.jdField_c_of_type_Int == 2)
      {
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setVisibility(8);
        this.jdField_g_of_type_AndroidViewView.setVisibility(0);
        this.jdField_c_of_type_AndroidWidgetTextView.setText(localmxw.h);
  ...
  private void g()
  {
    ...
    do
    {
      ...
      n = this.jdField_a_of_type_Mxu.jdField_a_of_type_Mxw.jdField_a_of_type_Int;
      if (QLog.isColorLevel()) {
  ...
  public void a(int paramInt)
  {
    ...
    if (this.jdField_g_of_type_Boolean)
    {
      ...
      if (((PublicAccountAdvertisementActivity)getActivity()).b())
      {
        ...
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setText(ajjy.a(2131650335));
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setTextColor(-1);
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setBackgroundResource(2130839019);
      ...
      if (((PublicAccountAdvertisementActivity)getActivity()).c())
      {
        ...
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setText(ajjy.a(2131650337));
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setTextColor(-1);
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setBackgroundResource(2130839019);
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setProgress(0);
        return;
      ...
      if (paramInt == 0)
      {
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setText(this.jdField_a_of_type_Mxu.jdField_a_of_type_Mxw.h);
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setTextColor(-1);
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setBackgroundResource(2130839019);
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setProgress(0);
        return;
      ...
      if (paramInt == 100)
      {
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setText(ajjy.a(2131650333));
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setTextColor(-1);
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setBackgroundResource(2130839019);
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setProgress(0);
        return;
      }
      this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setText(ajjy.a(2131650331));
    ...
    if (((PublicAccountAdvertisementActivity)getActivity()).b())
    {
      this.jdField_c_of_type_AndroidWidgetTextView.setText(ajjy.a(2131650329));
      return;
    }
    if (((PublicAccountAdvertisementActivity)getActivity()).c())
    {
      this.jdField_c_of_type_AndroidWidgetTextView.setText(ajjy.a(2131650336));
      return;
    }
    if (paramInt == 0)
    {
    ...
    if (paramInt == 100)
    {
      this.jdField_c_of_type_AndroidWidgetTextView.setText(ajjy.a(2131650330));
      return;
    }
    this.jdField_c_of_type_AndroidWidgetTextView.setText(ajjy.a(2131650334) + paramInt + "%");
  }
  
  public void a(mxu parammxu, ViewPager.OnPageChangeListener paramOnPageChangeListener, View.OnClickListener paramOnClickListener, AudioManager paramAudioManager, AdControlView paramAdControlView, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidSupportV4ViewViewPager$OnPageChangeListener = new mxx(this, paramOnPageChangeListener);
  ...
  public void a(boolean paramBoolean, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      ...
      awqx.a(null, "dc00898", "", this.jdField_a_of_type_Mxu.jdField_a_of_type_Mxw.jdField_a_of_type_JavaLangString, "0X8008F67", "0X8008F67", 0, 0, this.jdField_a_of_type_Mxu.jdField_a_of_type_Mxw.jdField_c_of_type_JavaLangString, "", "", this.jdField_a_of_type_Mxu.jdField_a_of_type_Mxw.jdField_b_of_type_JavaLangString);
      return;
    }
  ...
  {
    if (QLog.isColorLevel()) {
      if ("forceSetControllerPanelVisible " + this.jdField_a_of_type_Mxu.jdField_a_of_type_Mxw == null) {
        break label103;
      }
    }
    label103:
    for (Object localObject = Integer.valueOf(this.jdField_a_of_type_Mxu.jdField_a_of_type_Mxw.jdField_i_of_type_Int);; localObject = "null")
    {
      QLog.d("VideoCoverFragment", 2, new Object[] { localObject });
      if (this.jdField_a_of_type_Mxu.jdField_a_of_type_Mxw.jdField_i_of_type_Int != 2) {
        break;
      }
      this.jdField_b_of_type_AndroidViewView.setVisibility(0);
  ...
  {
    return paramLayoutInflater.inflate(2131493846, paramViewGroup, false);
  }
  ...
  public void onResume()
  {
    ...
    {
      if ((f()) || (this.jdField_a_of_type_Mxu.jdField_a_of_type_Mxw.jdField_b_of_type_Int == this.jdField_c_of_type_Int)) {
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdControlView.a();
      }
      if ((this.jdField_a_of_type_Mxu.jdField_a_of_type_Mxw.jdField_b_of_type_Int == this.jdField_e_of_type_Int) && (this.jdField_a_of_type_Int == 0)) {
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdControlView.a();
      }
    }
  ...
  {
    if ((this.jdField_a_of_type_Mxu == null) && (!e())) {
      getActivity().finish();
    }
    do
    {
    ...
    this.jdField_a_of_type_AndroidSupportV4ViewViewPager = ((ViewPager)localViewGroup.findViewById(2131313192));
    this.jdField_b_of_type_AndroidViewView = localViewGroup.findViewById(2131302283);
    if ((!a()) && (this.jdField_a_of_type_Mxu != null) && (this.jdField_a_of_type_Mxu.jdField_a_of_type_Mxw != null) && (this.jdField_a_of_type_Mxu.jdField_a_of_type_Mxw.jdField_j_of_type_Int > 0)) {
      a(true, this.jdField_a_of_type_Mxu.jdField_a_of_type_Mxw.jdField_j_of_type_Int);
    }
    this.jdField_a_of_type_AndroidViewView = localViewGroup.findViewById(2131302284);
    this.jdField_a_of_type_AndroidViewView.setOnTouchListener(new mxy(this));
    this.jdField_c_of_type_AndroidViewView = localViewGroup.findViewById(2131313130);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localViewGroup.findViewById(2131313103));
    this.jdField_d_of_type_AndroidViewView = localViewGroup.findViewById(2131312925);
    this.jdField_e_of_type_AndroidViewView = localViewGroup.findViewById(2131312926);
    this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementAdapterVideoCoverAdapter = new VideoCoverAdapter(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdControlView.a(), this.jdField_a_of_type_Mxu, new mxz(this));
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdControlView.a().setTotalCount(this.jdField_a_of_type_Mxu.jdField_a_of_type_JavaUtilArrayList.size());
    this.jdField_c_of_type_AndroidViewView.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
    this.jdField_f_of_type_AndroidViewView = localViewGroup.findViewById(2131313123);
    this.jdField_f_of_type_AndroidViewView.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
    this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localViewGroup.findViewById(2131313125));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localViewGroup.findViewById(2131313124));
    this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton = ((AdProgressButton)localViewGroup.findViewById(2131313129));
    this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setProgressColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131099760));
    this.jdField_g_of_type_AndroidViewView = localViewGroup.findViewById(2131313127);
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)localViewGroup.findViewById(2131313126));
    f();
    d();
