  ...
  extends RelativeLayout
{
  ...
  public VideoCoverView(Context paramContext, niw paramniw, int paramInt, AdvertisementSplitedProgressBar paramAdvertisementSplitedProgressBar, TVK_IMediaPlayer.OnCompletionListener paramOnCompletionListener, ArrayList<niw> paramArrayList, niv paramniv, wxu paramwxu)
  {
    super(paramContext);
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    LayoutInflater.from(getContext()).inflate(2131559413, this);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131378997));
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewResizeURLImageView = ((ResizeURLImageView)findViewById(2131378943));
    this.jdField_b_of_type_AndroidViewView = findViewById(2131369513);
    this.jdField_c_of_type_AndroidViewView = findViewById(2131365894);
    this.jdField_c_of_type_AndroidViewView.setOnClickListener(new njw(this, paramContext));
    this.jdField_d_of_type_AndroidViewView = findViewById(2131376513);
    this.jdField_d_of_type_AndroidViewView.setOnClickListener(new njx(this));
    this.jdField_c_of_type_Int = paramniw.jdField_a_of_type_Int;
    this.jdField_a_of_type_JavaLangString = paramniw.b;
    ...
    this.jdField_a_of_type_Njs = new njs(this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdvertisementSplitedProgressBar);
    ...
    this.jdField_c_of_type_Boolean = this.jdField_a_of_type_Niv.jdField_a_of_type_Nix.jdField_a_of_type_Boolean;
    ...
    this.jdField_a_of_type_AndroidAnimationAnimatorListenerAdapter = new njy(this);
    ...
    if (!TextUtils.isEmpty(paramniw.jdField_a_of_type_JavaLangString)) {}
    try
    {
      paramContext = new URL(paramniw.jdField_a_of_type_JavaLangString);
  ...
  {
    boolean bool = nji.a(this.jdField_a_of_type_JavaLangString);
  ...
  private void d(Context paramContext)
  {
    ...
    for (RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(this.jdField_e_of_type_Int, (int)(this.jdField_e_of_type_Int * 0.5626F));; localLayoutParams = new RelativeLayout.LayoutParams(-1, -1))
    {
      ...
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnVideoPreparedListener(new nka(this));
      if (this.jdField_c_of_type_Boolean)
      {
        this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(this.jdField_a_of_type_Nkd);
      ...
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnErrorListener(new nkb(this));
      a(false);
      return;
    }
  }
  ...
  public void a()
  {
    if ((PublicAccountAdvertisementActivity.class.isInstance(this.jdField_a_of_type_AndroidContentContext)) && (!((PublicAccountAdvertisementActivity)this.jdField_a_of_type_AndroidContentContext).isFinishing()))
    {
      ...
      aptr.a(this.jdField_a_of_type_AndroidContentContext, 2131692672, 2131689625, new nkc(this));
    }
  }
  ...
  public void b(Context paramContext)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer != null) && (!this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.isPlaying()))
    {
      ...
      {
        bool2 = nji.a(this.jdField_a_of_type_JavaLangString);
        ...
        this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_PlayerVideoInfo.setConfigMap("file_dir", nji.a());
        ...
        localObject = nji.a(this.jdField_a_of_type_JavaLangString);
        ...
        paramContext = this.jdField_a_of_type_Niv.jdField_a_of_type_Nix.jdField_a_of_type_JavaLangString;
        if (!bool2) {
          break label627;
        }
      }
    ...
    for (int i = 1;; i = 0)
    {
      axqw.a(null, "dc00898", "", paramContext, "0X8008F78", "0X8008F78", 0, 0, String.valueOf(i), "", this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Niv.jdField_a_of_type_Nix.b);
      njf.a().a(this.jdField_a_of_type_JavaLangString, bool2);
      if (this.jdField_c_of_type_Int + 1 < this.jdField_b_of_type_Int)
      {
        if (QLog.isColorLevel()) {
          QLog.d("VideoCoverView", 2, "start to preload next video,vid =" + ((niw)this.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_c_of_type_Int + 1)).b);
        }
        if (this.jdField_a_of_type_Wxu != null) {
          this.jdField_a_of_type_Wxu.b(this.jdField_a_of_type_Niv.jdField_a_of_type_JavaLangString, this.jdField_c_of_type_Int + 1);
        }
      }
      return;
      bool1 = false;
  ...
  public void g()
  {
    ...
    {
    default: 
      if (nji.a(this.jdField_a_of_type_JavaLangString)) {
