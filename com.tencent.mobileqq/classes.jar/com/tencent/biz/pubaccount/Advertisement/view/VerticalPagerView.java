  ...
  extends ViewGroup
{
    ...
    for (;;)
    {
      ...
      if ((!this.jdField_a_of_type_Boolean) && (this.jdField_b_of_type_Int != this.jdField_c_of_type_Int))
      {
        ...
        if (this.jdField_a_of_type_Njv != null) {
          this.jdField_a_of_type_Njv.a(this, super.getChildAt(this.jdField_c_of_type_Int), this.jdField_c_of_type_Int);
        }
  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      ...
      if ((f2 < bawz.a(super.getContext(), 10.0F)) || (f2 < f1))
      {
        this.jdField_a_of_type_Int = ((int)paramMotionEvent.getY());
        return false;
      }
      ...
      if (i > 0)
      {
        if (this.jdField_a_of_type_Nju != null) {
          return this.jdField_a_of_type_Nju.b(this.jdField_c_of_type_Int);
        }
        return b(this.jdField_c_of_type_Int);
      }
    } while (i >= 0);
    if (this.jdField_a_of_type_Nju != null) {
      return this.jdField_a_of_type_Nju.a(this.jdField_c_of_type_Int);
    }
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    if (i == 2)
    {
      ...
      if (Math.abs(this.d - this.jdField_b_of_type_Float) < bawz.a(super.getContext(), 10.0F))
      {
        this.jdField_a_of_type_Int = ((int)paramMotionEvent.getY());
      ...
      if (i < 0)
      {
        this.jdField_a_of_type_Int = ((int)paramMotionEvent.getY());
        if (this.jdField_a_of_type_Njv != null) {
          this.jdField_a_of_type_Njv.a(false, this.jdField_c_of_type_Int);
        }
        this.f = (this.d - this.e);
        this.e = this.d;
        return false;
      ...
      super.invalidate();
      if (this.jdField_a_of_type_Njv != null) {
        this.jdField_a_of_type_Njv.a(true, this.jdField_c_of_type_Int);
      }
    }
    while ((i != 1) && (i != 3))
    {
    ...
    if ((i > super.getHeight() / 4) || ((i > 0) && (f1 > bawz.a(super.getContext(), 7.0F))))
    {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Njv.a(false, this.jdField_c_of_type_Int);
      break;
      if ((i < -super.getHeight() / 4) || ((i < 0) && (f1 > bawz.a(super.getContext(), 5.0F))))
      {
        this.jdField_c_of_type_Int -= 1;
  ...
  public void setOnInterceptTouchListener(nju paramnju)
  {
    this.jdField_a_of_type_Nju = paramnju;
  }
  
  public void setOnPagerChangedListener(njv paramnjv)
  {
