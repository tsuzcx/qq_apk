  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (!this.this$0.loadDatabase()) {}
    for (boolean bool = true;; bool = false)
    {
      localPublicAccountDetailActivityImpl.isFirst = bool;
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.AccountDetail.activity.api.impl.PublicAccountDetailActivityImpl.12
