  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (this.this$0.jdField_a_of_type_ComTencentMobileqqDataEqqDetail != null)
    {
      ...
      this.this$0.d();
      aslc.a(EqqAccountDetailActivity.g(this.this$0)).a(EqqAccountDetailActivity.f(this.this$0), this.this$0.jdField_a_of_type_ComTencentMobileqqDataEqqDetail.uin, true);
