  ...
  implements View.OnClickListener, AccountDetailVideoManager.OnVideoPlayListener
{
  ...
  public ImageView c;
  private ArrayList<PaConfigAttr> jdField_c_of_type_JavaUtilArrayList = new ArrayList();
  boolean jdField_c_of_type_Boolean = false;
  final int jdField_d_of_type_Int = 2;
  private ArrayList<PaConfigAttr> jdField_d_of_type_JavaUtilArrayList = new ArrayList();
  public boolean d;
  ...
  public AccountDetailBaseAdapter(QQAppInterface paramQQAppInterface, Context paramContext, AccountDetail paramAccountDetail, String paramString, boolean paramBoolean, AccountDetailXListView paramAccountDetailXListView, AccountDetailTopGestureLayout paramAccountDetailTopGestureLayout)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail != null) {
      this.u = PublicAccountReportUtilsImpl.getReportAccountType(paramQQAppInterface, paramString, paramAccountDetail);
    }
    ...
    if (paramBoolean)
    {
      ...
      paramQQAppInterface = ((IPublicAccountDetailDynamicDataManagerService)paramQQAppInterface.getRuntimeService(IPublicAccountDetailDynamicDataManagerService.class, "all")).getAccountDetailDynamicInfoFromCache(paramString);
  ...
  protected static boolean a(AccountDetail paramAccountDetail)
  {
    ...
    if (((IPublicAccountUtil)QRoute.api(IPublicAccountUtil.class)).getAccountType(paramAccountDetail.accountFlag) == -2) {}
  ...
  void a(View paramView)
  {
    if (this.jdField_b_of_type_Boolean) {
      paramView.findViewById(2131373637).setVisibility(8);
    }
    do
    {
      return;
      paramView = (TextView)paramView.findViewById(2131373636);
  ...
  void a(AccountDetailBaseAdapter.DynamicItemHolder paramDynamicItemHolder, View paramView, int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          ReportController.b((AppRuntime)localObject3, "dc01160", "Pb_account_lifeservice", str2, "0X8007CA2", "0X8007CA2", 0, 0, str1, String.valueOf(localDynamicInfo.jdField_a_of_type_ComTencentBizPubaccountAccountDetailBeanMsgAttr.jdField_a_of_type_Int), String.valueOf(localDynamicInfo.jdField_a_of_type_ComTencentBizPubaccountAccountDetailBeanMsgAttr.jdField_a_of_type_Long), ((JSONObject)localObject2).toString());
          if (QLog.isColorLevel()) {
          ...
          if (localDynamicInfo.jdField_a_of_type_ComTencentBizPubaccountAccountDetailBeanPictureAttr != null)
          {
            ...
            for (;;)
            {
              try
              {
                ...
                paramDynamicItemHolder.jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable((Drawable)localObject1);
                paramDynamicItemHolder.jdField_a_of_type_AndroidWidgetTextView.setText((CharSequence)localObject2);
                paramDynamicItemHolder.jdField_b_of_type_AndroidWidgetTextView.setText(ReadInJoyTimeUtils.b(((Long)localObject3).longValue()));
                paramView.setOnClickListener(new AccountDetailBaseAdapter.5(this, paramInt, str2, localDynamicInfo));
                return;
              }
            ...
            QLog.d("AccountDetailBaseAdapter", 2, "setDataForDynamicMsg:" + paramDynamicItemHolder);
            return;
          }
          label887:
          localObject1 = "";
  ...
  void a(AccountDetailBaseAdapter.ErrorItemHolder paramErrorItemHolder, View paramView)
  {
    ...
    if (this.jdField_h_of_type_Boolean)
    {
      ...
      paramErrorItemHolder.jdField_a_of_type_AndroidWidgetTextView.setText(2131689505);
    ...
    for (;;)
    {
      ...
      {
        paramErrorItemHolder.jdField_a_of_type_AndroidWidgetTextView.setText(2131695222);
        paramErrorItemHolder.jdField_a_of_type_AndroidWidgetTextView.setPadding(0, (int)(5.0F * f1), 0, (int)(f1 * 5.0F));
        paramErrorItemHolder.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130839418);
      ...
      {
        paramErrorItemHolder.jdField_a_of_type_AndroidWidgetTextView.setText(2131689508);
        paramErrorItemHolder.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130841864);
        paramErrorItemHolder.jdField_a_of_type_AndroidWidgetTextView.setPadding(0, (int)(5.0F * f1), 0, (int)(f1 * 5.0F));
        paramErrorItemHolder.jdField_b_of_type_AndroidWidgetTextView.setVisibility(4);
      }
    }
  ...
  void a(AccountDetailBaseAdapter.FullScreenTopContainerHolder paramFullScreenTopContainerHolder)
  {
    ...
    do
    {
      do
      {
        ...
        paramFullScreenTopContainerHolder.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130837513);
        this.jdField_b_of_type_AndroidWidgetButton.setText(2131695266);
    ...
    for (;;)
    {
      ...
      label419:
      paramFullScreenTopContainerHolder.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
      paramFullScreenTopContainerHolder.jdField_a_of_type_AndroidWidgetButton.setText(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131695197));
      this.jdField_b_of_type_AndroidWidgetButton.setText(2131695267);
      break label176;
  ...
  void a(AccountDetailBaseAdapter.OtherTopHolder paramOtherTopHolder)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.protocolVersion == 0)
      {
        ...
        paramOtherTopHolder.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.name);
        if (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.certifiedDescription)) {
          break label516;
        }
        paramOtherTopHolder.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.certifiedDescription);
      }
      for (;;)
      {
        if (this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.certifiedGrade == 0) {
        ...
        paramOtherTopHolder.jdField_c_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.summary);
        ...
        paramOtherTopHolder.jdField_d_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.sharedFollowerCount + "位好友关注");
        paramOtherTopHolder.jdField_a_of_type_AndroidViewView.setBackgroundColor(-1);
        if (((IPublicAccountUtil)QRoute.api(IPublicAccountUtil.class)).getMessageHistoryInfo(this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail) != null)
        {
  ...
  void a(AccountDetailBaseAdapter.SubscriptTopHolder paramSubscriptTopHolder)
  {
    ...
    paramSubscriptTopHolder.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.name);
    if (this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.certifiedGrade != 0)
    {
      ...
      paramSubscriptTopHolder.jdField_c_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.certifiedDescription);
      label133:
      ...
      paramSubscriptTopHolder.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130837513);
    ...
    label255:
    paramSubscriptTopHolder.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
    paramSubscriptTopHolder.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130839424);
    paramSubscriptTopHolder.jdField_a_of_type_AndroidWidgetButton.setText(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131695197));
  ...
  public boolean a()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if ((!this.jdField_h_of_type_Boolean) || ((this.t != PublicAccountDetailActivityImpl.NETWORK_UNKNOW) && (this.t != PublicAccountDetailActivityImpl.NETWORK_ERROR) && (this.t != PublicAccountDetailActivityImpl.NO_MORE_DATA))) {
        break;
      }
      return true;
    }
  ...
  boolean a(int paramInt1, View paramView, int paramInt2)
  {
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            do
            {
              do
              {
                do
                {
                  ...
                  {
                    bool1 = a(paramInt2);
                    if ((paramView.getTag() != null) && ((paramView.getTag() instanceof AccountDetailBaseAdapter.DynamicItemHolder)) && (bool1 == ((AccountDetailBaseAdapter.DynamicItemHolder)paramView.getTag()).jdField_a_of_type_Boolean)) {}
                  ...
                  bool1 = bool2;
                } while ((paramView.getTag() instanceof AccountDetailBaseAdapter.ErrorItemHolder));
                return false;
                if (paramInt1 != 0) {
                  break label124;
                }
                ...
                bool1 = bool2;
              } while ((paramView.getTag() instanceof AccountDetailBaseAdapter.OtherTopHolder));
              return false;
              if (paramInt1 != 8) {
                break label153;
              }
              ...
              bool1 = bool2;
            } while ((paramView.getTag() instanceof AccountDetailBaseAdapter.SubscriptTopHolder));
            return false;
            if (paramInt1 != 9) {
              break label182;
            }
            ...
            bool1 = bool2;
          } while ((paramView.getTag() instanceof AccountDetailBaseAdapter.LoadingItemHolder));
          return false;
          if (paramInt1 != 10) {
            break label211;
          }
      ...
      bool1 = bool2;
    } while ((paramView.getTag() instanceof AccountDetailBaseAdapter.MenuHolder));
    label153:
    label182:
    label211:
    return false;
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      if (i1 == 0) {
        a((AccountDetailBaseAdapter.OtherTopHolder)localObject4);
      }
      for (;;)
      {
        EventCollector.getInstance().onListGetView(paramInt, paramView, paramViewGroup, getItemId(paramInt));
        return paramView;
        localObject3 = (AccountDetailBaseAdapter.OtherTopHolder)paramView.getTag();
        bool1 = false;
        localObject1 = null;
        localObject2 = null;
        localObject4 = null;
        ...
        localObject5 = null;
        break;
        localObject4 = (AccountDetailBaseAdapter.SubscriptTopHolder)paramView.getTag();
        bool1 = false;
        localObject1 = null;
        localObject2 = null;
        localObject3 = null;
        ...
        localObject5 = null;
        break;
        localObject7 = (AccountDetailBaseAdapter.FullScreenTopContainerHolder)paramView.getTag();
        if (this.jdField_a_of_type_ComTencentBizPubaccountAccountDetailModelAccountDetailVideoManager == null) {
          break label2639;
        }
        ...
        localObject6 = null;
        break;
        localObject6 = (AccountDetailBaseAdapter.DynamicItemHolder)paramView.getTag();
        bool1 = a(paramInt);
        localObject1 = null;
        localObject2 = null;
        localObject3 = null;
        ...
        localObject5 = null;
        break;
        localObject5 = (AccountDetailBaseAdapter.ErrorItemHolder)paramView.getTag();
        bool1 = false;
        localObject1 = null;
        localObject2 = null;
        localObject3 = null;
        ...
        localObject6 = null;
        break;
        localObject2 = (AccountDetailBaseAdapter.LoadingItemHolder)paramView.getTag();
        bool1 = false;
        localObject1 = null;
        localObject3 = null;
        localObject4 = null;
        ...
        localObject5 = null;
        break;
        localObject1 = (AccountDetailBaseAdapter.MenuHolder)paramView.getTag();
        bool1 = false;
        localObject2 = null;
        localObject3 = null;
        localObject4 = null;
        ...
        case 0: 
          ...
          paramView.setOnClickListener(null);
          localObject4 = new AccountDetailBaseAdapter.OtherTopHolder(this);
          ((AccountDetailBaseAdapter.OtherTopHolder)localObject4).jdField_a_of_type_AndroidViewView = paramView.findViewById(2131379659);
          ((AccountDetailBaseAdapter.OtherTopHolder)localObject4).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131371007));
          ((AccountDetailBaseAdapter.OtherTopHolder)localObject4).jdField_b_of_type_AndroidViewView = paramView.findViewById(2131378727);
          ((AccountDetailBaseAdapter.OtherTopHolder)localObject4).jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368603));
          ((AccountDetailBaseAdapter.OtherTopHolder)localObject4).jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368615));
          ((AccountDetailBaseAdapter.OtherTopHolder)localObject4).jdField_d_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131364541));
          ((AccountDetailBaseAdapter.OtherTopHolder)localObject4).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131361885));
          ((AccountDetailBaseAdapter.OtherTopHolder)localObject4).jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131361884));
          ((AccountDetailBaseAdapter.OtherTopHolder)localObject4).jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131361887));
          ((AccountDetailBaseAdapter.OtherTopHolder)localObject4).e = ((ImageView)paramView.findViewById(2131361888));
          ((AccountDetailBaseAdapter.OtherTopHolder)localObject4).jdField_d_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131377989));
          ((AccountDetailBaseAdapter.OtherTopHolder)localObject4).jdField_b_of_type_AndroidViewView.setOnClickListener(this);
          ((AccountDetailBaseAdapter.OtherTopHolder)localObject4).jdField_c_of_type_AndroidViewView = paramView.findViewById(2131365922);
          ((AccountDetailBaseAdapter.OtherTopHolder)localObject4).jdField_d_of_type_AndroidViewView = paramView.findViewById(2131368447);
          ((AccountDetailBaseAdapter.OtherTopHolder)localObject4).jdField_d_of_type_AndroidViewView.setOnClickListener(this);
        ...
        case 8: 
          ...
          paramView.setOnClickListener(null);
          localObject5 = new AccountDetailBaseAdapter.SubscriptTopHolder(this);
          ((AccountDetailBaseAdapter.SubscriptTopHolder)localObject5).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131371007));
          ((AccountDetailBaseAdapter.SubscriptTopHolder)localObject5).jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368603));
          ((AccountDetailBaseAdapter.SubscriptTopHolder)localObject5).jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368615));
          ((AccountDetailBaseAdapter.SubscriptTopHolder)localObject5).jdField_d_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131364541));
          ((AccountDetailBaseAdapter.SubscriptTopHolder)localObject5).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131361885));
          ((AccountDetailBaseAdapter.SubscriptTopHolder)localObject5).jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131361887));
          ((AccountDetailBaseAdapter.SubscriptTopHolder)localObject5).jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131361884));
          ((AccountDetailBaseAdapter.SubscriptTopHolder)localObject5).jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131361883));
          this.jdField_a_of_type_AndroidWidgetButton = ((AccountDetailBaseAdapter.SubscriptTopHolder)localObject5).jdField_a_of_type_AndroidWidgetButton;
          this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
          paramView.findViewById(2131361889).setOnClickListener(new AccountDetailBaseAdapter.1(this));
          f1 = FontSettingManager.getFontLevel() / 16.0F;
          if (f1 > 1.0F) {
            ((AccountDetailBaseAdapter.SubscriptTopHolder)localObject5).jdField_b_of_type_AndroidWidgetTextView.setTextSize(14 / f1);
          }
          for (;;)
          {
            ...
            localObject7 = localObject13;
            break;
            ((AccountDetailBaseAdapter.SubscriptTopHolder)localObject5).jdField_b_of_type_AndroidWidgetTextView.setTextSize(14);
          }
        case 10: 
          ...
          AccountDetailBaseAdapter.FullScreenTopContainerHolder localFullScreenTopContainerHolder = new AccountDetailBaseAdapter.FullScreenTopContainerHolder(this);
          localFullScreenTopContainerHolder.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localView.findViewById(2131381307));
          localFullScreenTopContainerHolder.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131368603));
          localFullScreenTopContainerHolder.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131364541));
          localFullScreenTopContainerHolder.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131361885));
          localFullScreenTopContainerHolder.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131361887));
          localFullScreenTopContainerHolder.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)localView.findViewById(2131381442));
          localFullScreenTopContainerHolder.jdField_a_of_type_AndroidWidgetButton = ((Button)localView.findViewById(2131361883));
          localFullScreenTopContainerHolder.jdField_a_of_type_AndroidViewView = localView.findViewById(2131361881);
          localFullScreenTopContainerHolder.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131361879));
          localFullScreenTopContainerHolder.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131361880));
          localFullScreenTopContainerHolder.e = ((ImageView)localView.findViewById(2131370723));
          localFullScreenTopContainerHolder.jdField_c_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131379394));
          f1 = FontSettingManager.getFontLevel() / 16.0F;
          if (f1 > 1.0F) {
            localFullScreenTopContainerHolder.jdField_b_of_type_AndroidWidgetTextView.setTextSize(14 / f1);
          }
          for (;;)
          {
            this.jdField_a_of_type_AndroidWidgetButton = localFullScreenTopContainerHolder.jdField_a_of_type_AndroidWidgetButton;
            this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
            localFullScreenTopContainerHolder.jdField_a_of_type_AndroidViewView.setOnClickListener(new AccountDetailBaseAdapter.2(this));
            localView.findViewById(2131361889).setOnClickListener(new AccountDetailBaseAdapter.3(this));
            localView.setTag(localFullScreenTopContainerHolder);
            paramView = localView;
            localObject1 = localFullScreenTopContainerHolder;
            bool1 = bool2;
            localObject2 = localObject12;
            localObject3 = localObject11;
            localObject4 = localObject10;
            ...
            localObject7 = localObject13;
            break;
            localFullScreenTopContainerHolder.jdField_b_of_type_AndroidWidgetTextView.setTextSize(14);
          }
        case 1: 
          bool1 = a(paramInt);
          if (bool1) {}
          for (paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131559735, paramViewGroup, false);; paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131559726, paramViewGroup, false))
          {
            localObject7 = new AccountDetailBaseAdapter.DynamicItemHolder(this);
            ((AccountDetailBaseAdapter.DynamicItemHolder)localObject7).jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)paramView.findViewById(2131366086));
            ((AccountDetailBaseAdapter.DynamicItemHolder)localObject7).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131366089));
            ((AccountDetailBaseAdapter.DynamicItemHolder)localObject7).jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131366088));
            ((AccountDetailBaseAdapter.DynamicItemHolder)localObject7).jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131366101));
            ((AccountDetailBaseAdapter.DynamicItemHolder)localObject7).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131366100));
            ((AccountDetailBaseAdapter.DynamicItemHolder)localObject7).jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131366087));
            ((AccountDetailBaseAdapter.DynamicItemHolder)localObject7).jdField_a_of_type_Boolean = bool1;
        ...
        case 2: 
          paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131559725, paramViewGroup, false);
          localObject6 = new AccountDetailBaseAdapter.ErrorItemHolder(this);
          ((AccountDetailBaseAdapter.ErrorItemHolder)localObject6).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131361882));
          ((AccountDetailBaseAdapter.ErrorItemHolder)localObject6).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131373635));
          ((AccountDetailBaseAdapter.ErrorItemHolder)localObject6).jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131373651));
        ...
        case 9: 
          ...
          paramView.setOnClickListener(null);
          localObject3 = new AccountDetailBaseAdapter.LoadingItemHolder(this);
          ((AccountDetailBaseAdapter.LoadingItemHolder)localObject3).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370757));
          ((AccountDetailBaseAdapter.LoadingItemHolder)localObject3).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131370743));
          ((AccountDetailBaseAdapter.LoadingItemHolder)localObject3).jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131377006));
        ...
        case 11: 
          ...
          localObject2 = new AccountDetailBaseAdapter.MenuHolder(this);
          ((AccountDetailBaseAdapter.MenuHolder)localObject2).a = ((PublicAccountMenuBar)paramView.findViewById(2131371199));
          ...
          if (i1 == 8)
          {
            a((AccountDetailBaseAdapter.SubscriptTopHolder)localObject5);
          }
          else if (i1 == 10)
          {
            a((AccountDetailBaseAdapter.FullScreenTopContainerHolder)localObject1);
          }
          else if (i1 == 1)
          {
            a((AccountDetailBaseAdapter.DynamicItemHolder)localObject7, paramView, paramInt, bool1);
          }
          else if (i1 == 6)
          {
            a(paramView);
          ...
          {
            a((AccountDetailBaseAdapter.ErrorItemHolder)localObject6, paramView);
          }
          else if (i1 == 9)
          {
            if (this.jdField_i_of_type_Boolean)
            {
              ((AccountDetailBaseAdapter.LoadingItemHolder)localObject3).jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
              ((AccountDetailBaseAdapter.LoadingItemHolder)localObject3).jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
              ((AccountDetailBaseAdapter.LoadingItemHolder)localObject3).jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
            }
            else
            {
              ((AccountDetailBaseAdapter.LoadingItemHolder)localObject3).jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
              ((AccountDetailBaseAdapter.LoadingItemHolder)localObject3).jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
              ((AccountDetailBaseAdapter.LoadingItemHolder)localObject3).jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
            }
          }
          else if (i1 == 11)
          {
            a((AccountDetailBaseAdapter.MenuHolder)localObject2, paramView);
          }
          else
          {
            ...
            case 4: 
              do
              {
                ...
                paramView = (View)localObject1;
                break;
                localObject1 = AccountDetailWindowViewWrapper.a(this.jdField_a_of_type_AndroidContentContext, paramView, paramViewGroup, (PaConfigAttr)localObject1, this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.followType, this.jdField_a_of_type_ComTencentBizPubaccountAccountDetailHandlerAccountDetailBaseItemClickHandler, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString);
                paramView = (View)localObject1;
              } while (this.jdField_a_of_type_ComTencentBizPubaccountAccountDetailViewAccountDetailTopGestureLayout == null);
              this.jdField_a_of_type_ComTencentBizPubaccountAccountDetailViewAccountDetailTopGestureLayout.a((View)localObject1);
              paramView = (View)localObject1;
              break;
            case 5: 
              paramView = AccountDetailJigsawViewWrapper.a(this.jdField_a_of_type_AndroidContentContext, paramView, paramViewGroup, (PaConfigAttr)localObject1, this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.followType, this.jdField_a_of_type_ComTencentBizPubaccountAccountDetailHandlerAccountDetailBaseItemClickHandler, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString);
            }
          }
          break;
        }
  ...
  void j()
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountAccountDetailAdapterAccountDetailBaseAdapter$FullScreenTopContainerHolder.e.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843457));
  ...
  void l()
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountAccountDetailAdapterAccountDetailBaseAdapter$FullScreenTopContainerHolder.e.clearAnimation();
    this.jdField_a_of_type_ComTencentBizPubaccountAccountDetailAdapterAccountDetailBaseAdapter$FullScreenTopContainerHolder.e.setVisibility(0);
    this.jdField_a_of_type_ComTencentBizPubaccountAccountDetailAdapterAccountDetailBaseAdapter$FullScreenTopContainerHolder.e.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130837517));
