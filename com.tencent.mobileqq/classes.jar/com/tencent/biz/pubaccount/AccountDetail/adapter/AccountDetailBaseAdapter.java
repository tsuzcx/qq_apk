  ...
  implements View.OnClickListener, AccountDetailVideoManager.OnVideoPlayListener
{
  ...
  private URLDrawableDownListener.Adapter jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new krs(this);
  public QQAppInterface a;
  public AccountDetail a;
  public EqqDetail a;
  private AbsListView.OnScrollListener jdField_a_of_type_ComTencentWidgetAbsListView$OnScrollListener = new kry(this);
  public String a;
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    ThreadManager.post(new krt(this, this.jdField_a_of_type_Long, localArrayList, paramInt1, paramInt2, l1), 5, null, true);
  }
  ...
  private void o()
  {
    ...
    this.jdField_a_of_type_AndroidViewAnimationTranslateAnimation.setAnimationListener(new krq(this));
    this.jdField_b_of_type_AndroidViewAnimationTranslateAnimation.setAnimationListener(new krr(this));
  ...
  public void a(int paramInt, View paramView)
  {
    ...
    paramView = (ksf)paramView.getTag();
    float f1;
    ...
    for (;;)
    {
      paramView.jdField_b_of_type_AndroidWidgetImageView.post(new ksa(this, paramView, localLayoutParams1, localLayoutParams2, localLayoutParams3));
      a(paramInt, f1);
      return;
  ...
  void a(View paramView)
  {
    if (this.jdField_b_of_type_Boolean) {
      paramView.findViewById(2131362710).setVisibility(8);
    }
    do
    {
      return;
      paramView = (TextView)paramView.findViewById(2131362711);
  ...
  void a(AccountDetailBaseAdapter.FullScreenTopContainerHolder paramFullScreenTopContainerHolder)
  {
    ...
    do
    {
      do
      {
        ...
        this.jdField_b_of_type_AndroidWidgetButton.setText(2131430065);
    ...
    for (;;)
    {
      ...
      label419:
      paramFullScreenTopContainerHolder.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
      paramFullScreenTopContainerHolder.jdField_a_of_type_AndroidWidgetButton.setText(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131430017));
      this.jdField_b_of_type_AndroidWidgetButton.setText(2131430064);
      break label176;
  ...
  void a(ksc paramksc, View paramView, int paramInt, boolean paramBoolean)
  {
    if (paramksc == null) {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        for (String str1 = "02";; str1 = "01")
        {
          ...
          paramksc.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
          paramksc.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
          paramksc.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
          ...
          paramksc.jdField_c_of_type_AndroidWidgetTextView.setText(UITools.a(localDynamicInfo.jdField_a_of_type_ComTencentBizPubaccountAccountDetailBeanVideoAttr.jdField_b_of_type_Int));
          if (QLog.isColorLevel()) {
      ...
      catch (JSONException localJSONException)
      {
        for (;;)
        {
          ...
          continue;
          label666:
          paramksc.jdField_c_of_type_AndroidWidgetTextView.setVisibility(4);
          paramksc.jdField_b_of_type_AndroidWidgetImageView.setVisibility(4);
          paramksc.jdField_a_of_type_AndroidWidgetImageView.setVisibility(4);
          if (localDynamicInfo.jdField_a_of_type_ComTencentBizPubaccountAccountDetailBeanPictureAttr != null)
          {
            ...
            for (;;)
            {
              try
              {
                ...
                paramksc.jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable((Drawable)localObject1);
                paramksc.jdField_a_of_type_AndroidWidgetTextView.setText((CharSequence)localObject2);
                paramksc.jdField_b_of_type_AndroidWidgetTextView.setText(ReadInJoyTimeUtils.b(((Long)localObject3).longValue()));
                paramView.setOnClickListener(new krx(this, paramInt, str2, localDynamicInfo));
                return;
              }
              catch (Exception paramksc) {}
            ...
            QLog.d("AccountDetailBaseAdapter", 2, "setDataForDynamicMsg:" + paramksc);
            return;
          }
          label887:
          localObject1 = "";
  ...
  void a(ksd paramksd, View paramView)
  {
    ...
    if (this.jdField_h_of_type_Boolean)
    {
      ...
      paramksd.jdField_a_of_type_AndroidWidgetTextView.setText(2131438582);
      paramksd.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
      paramksd.jdField_b_of_type_AndroidWidgetTextView.setVisibility(4);
      paramksd.jdField_a_of_type_AndroidWidgetImageView.setVisibility(4);
    }
    for (;;)
    {
      paramksd.jdField_b_of_type_AndroidWidgetTextView.setOnClickListener(new krw(this, paramksd));
      return;
      label92:
      if (this.r == AccountDetailActivity.j)
      {
        paramksd.jdField_a_of_type_AndroidWidgetTextView.setText(2131430035);
        paramksd.jdField_a_of_type_AndroidWidgetTextView.setPadding(0, (int)(5.0F * f1), 0, (int)(f1 * 5.0F));
        paramksd.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130838494);
        paramksd.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
      }
      else if (this.r == AccountDetailActivity.k)
      {
        paramksd.jdField_a_of_type_AndroidWidgetTextView.setText(2131438586);
        paramksd.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130839732);
        paramksd.jdField_a_of_type_AndroidWidgetTextView.setPadding(0, (int)(5.0F * f1), 0, (int)(f1 * 5.0F));
        paramksd.jdField_b_of_type_AndroidWidgetTextView.setVisibility(4);
      }
    }
  ...
  void a(ksf paramksf)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      paramksf.jdField_a_of_type_AndroidWidgetImageView.setBackgroundColor(Color.parseColor("#3d7fe3"));
      i1 = this.jdField_a_of_type_ComTencentMobileqqDataEqqDetail.name.length();
      if ((i1 > 8) && (i1 < 13)) {
        paramksf.jdField_a_of_type_AndroidWidgetTextView.setTextSize(2, 20.0F);
      }
      paramksf.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqDataEqqDetail.name);
      if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqDataEqqDetail.displayNumber))
      {
        paramksf.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqDataEqqDetail.displayNumber);
        label103:
        if (this.jdField_a_of_type_ComTencentMobileqqDataEqqDetail.certifiedGrade == 0) {
          break label145;
        }
        paramksf.d.setVisibility(0);
      }
    }
    for (;;)
    {
      paramksf.jdField_b_of_type_AndroidWidgetImageView.setImageDrawable(this.jdField_c_of_type_AndroidGraphicsDrawableDrawable);
      return;
      paramksf.jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
      break label103;
      label145:
      paramksf.d.setVisibility(8);
      continue;
      if (this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail == null) {
        break;
      }
      paramksf.jdField_a_of_type_AndroidWidgetImageView.setBackgroundDrawable(this.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
      paramksf.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.jdField_b_of_type_AndroidGraphicsDrawableDrawable);
      i1 = this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.name.length();
      if ((i1 > 8) && (i1 < 13)) {
        paramksf.jdField_a_of_type_AndroidWidgetTextView.setTextSize(2, 20.0F);
      }
      paramksf.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.name);
      if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.certifiedDescription)) {
        paramksf.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.certifiedDescription);
      }
      for (;;)
      {
        if (this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.certifiedGrade == 0) {
  ...
  void a(ksh paramksh)
  {
    ...
    paramksh.jdField_a_of_type_AndroidWidgetImageView.setBackgroundDrawable(this.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
    paramksh.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.jdField_b_of_type_AndroidGraphicsDrawableDrawable);
    int i1 = this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.name.length();
    if ((i1 > 8) && (i1 < 13)) {
      paramksh.jdField_a_of_type_AndroidWidgetTextView.setTextSize(2, 20.0F);
    }
    paramksh.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.name);
    if (this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.certifiedGrade != 0)
    {
      paramksh.d.setVisibility(0);
      ...
      paramksh.jdField_c_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.certifiedDescription);
      label133:
      String str = a(this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.summary);
      paramksh.jdField_b_of_type_AndroidWidgetTextView.setText(str);
      paramksh.jdField_b_of_type_AndroidWidgetImageView.setImageDrawable(this.jdField_c_of_type_AndroidGraphicsDrawableDrawable);
      if (this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.followType != 1) {
        break label255;
      }
      if (!this.jdField_g_of_type_Boolean) {
      ...
      paramksh.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
      paramksh.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130837509);
      paramksh.jdField_a_of_type_AndroidWidgetButton.setText(null);
    }
    for (;;)
    {
      this.jdField_b_of_type_AndroidWidgetButton.setText(2131430065);
      return;
      paramksh.d.setVisibility(8);
      break;
      label231:
      paramksh.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
      break label133;
      label243:
      paramksh.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
    }
    label255:
    paramksh.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
    paramksh.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130838497);
    paramksh.jdField_a_of_type_AndroidWidgetButton.setText(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131430017));
    paramksh.jdField_a_of_type_AndroidWidgetButton.setTextColor(-1);
    this.jdField_b_of_type_AndroidWidgetButton.setText(2131430064);
  }
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            do
            {
              do
              {
                ...
                {
                  bool1 = a(paramInt2);
                  if ((paramView.getTag() != null) && ((paramView.getTag() instanceof ksc)) && (bool1 == ((ksc)paramView.getTag()).jdField_a_of_type_Boolean)) {}
                ...
                bool1 = bool2;
              } while ((paramView.getTag() instanceof ksd));
              return false;
              if (paramInt1 != 0) {
                break label124;
              }
              ...
              bool1 = bool2;
            } while ((paramView.getTag() instanceof ksf));
            return false;
            if (paramInt1 != 8) {
              break label153;
            }
            ...
            bool1 = bool2;
          } while ((paramView.getTag() instanceof ksh));
          return false;
          if (paramInt1 != 9) {
            break label182;
          }
          ...
          bool1 = bool2;
        } while ((paramView.getTag() instanceof kse));
        return false;
        bool1 = bool2;
      } while (paramInt1 != 10);
      if (paramView.getTag() == null) {
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountAccountDetailViewAccountDetailXListView.setOnEndScrollListener(new krz(this));
  }
  ...
  public void b(int paramInt, View paramView)
  {
    ...
    if (b())
    {
      ...
      label181:
      paramView.jdField_a_of_type_AndroidWidgetImageView.post(new ksb(this, paramView, localLayoutParams1, localLayoutParams2));
    }
    for (;;)
    {
      a(paramInt, f1);
  ...
  public void c(int paramInt, View paramView)
  {
    ...
    paramView = (ksh)paramView.getTag();
    float f1;
    RelativeLayout.LayoutParams localLayoutParams1;
    RelativeLayout.LayoutParams localLayoutParams3;
    label106:
    ...
    if (b())
    {
      ...
      label260:
      paramView.jdField_b_of_type_AndroidWidgetImageView.post(new krp(this, paramView, localLayoutParams1, localLayoutParams2, localLayoutParams3));
    }
    for (;;)
    {
      a(paramInt, f1);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        do
        {
          ...
          {
            return paramView;
            localObject1 = (ksf)paramView.getTag();
            bool = false;
            localObject2 = null;
            localObject3 = null;
            localObject4 = null;
            ...
            localObject6 = localObject7;
            break;
            localObject2 = (ksh)paramView.getTag();
            bool = false;
            localObject1 = null;
            localObject3 = null;
            localObject4 = null;
            ...
            localObject6 = localObject7;
            break;
            localObject4 = (ksc)paramView.getTag();
            bool = a(paramInt);
            localObject1 = null;
            localObject2 = null;
            localObject3 = null;
            ...
            localObject6 = localObject7;
            break;
            localObject3 = (ksd)paramView.getTag();
            bool = false;
            localObject1 = null;
            localObject2 = null;
            localObject4 = null;
            ...
            localObject6 = localObject7;
            break;
            localObject6 = (kse)paramView.getTag();
            bool = false;
            localObject1 = null;
            localObject2 = null;
            localObject3 = null;
            ...
            case 0: 
              ...
              paramView.setOnClickListener(null);
              localObject2 = new ksf(this);
              ((ksf)localObject2).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131362722));
              ((ksf)localObject2).jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131362724));
              ((ksf)localObject2).jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131362723));
              ((ksf)localObject2).d = ((ImageView)paramView.findViewById(2131362725));
              ((ksf)localObject2).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362726));
              ((ksf)localObject2).jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362727));
              ((ksf)localObject2).jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362728));
            ...
            case 8: 
              ...
              paramView.setOnClickListener(null);
              localObject3 = new ksh(this);
              ((ksh)localObject3).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131362722));
              ((ksh)localObject3).jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131362724));
              ((ksh)localObject3).jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131362723));
              ((ksh)localObject3).d = ((ImageView)paramView.findViewById(2131362725));
              ((ksh)localObject3).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362726));
              ((ksh)localObject3).jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362728));
              ((ksh)localObject3).jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362727));
              ((ksh)localObject3).jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131362736));
              this.jdField_a_of_type_AndroidWidgetButton = ((ksh)localObject3).jdField_a_of_type_AndroidWidgetButton;
              this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
              paramView.findViewById(2131362735).setOnClickListener(new kro(this));
              f1 = FontSettingManager.a() / 16.0F;
              if (f1 > 1.0F) {
                ((ksh)localObject3).jdField_b_of_type_AndroidWidgetTextView.setTextSize(14 / f1);
              }
              for (;;)
              {
                ...
                localObject2 = null;
                break;
                ((ksh)localObject3).jdField_b_of_type_AndroidWidgetTextView.setTextSize(14);
              }
            case 10: 
              ...
              ((AccountDetailBaseAdapter.FullScreenTopContainerHolder)localObject1).jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)paramView.findViewById(2131362730));
              ((AccountDetailBaseAdapter.FullScreenTopContainerHolder)localObject1).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131362724));
              ((AccountDetailBaseAdapter.FullScreenTopContainerHolder)localObject1).jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131362725));
              ((AccountDetailBaseAdapter.FullScreenTopContainerHolder)localObject1).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362726));
              ((AccountDetailBaseAdapter.FullScreenTopContainerHolder)localObject1).jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362728));
              ((AccountDetailBaseAdapter.FullScreenTopContainerHolder)localObject1).jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)paramView.findViewById(2131362729));
              ((AccountDetailBaseAdapter.FullScreenTopContainerHolder)localObject1).jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131362736));
              ((AccountDetailBaseAdapter.FullScreenTopContainerHolder)localObject1).jdField_a_of_type_AndroidViewView = paramView.findViewById(2131362737);
              ((AccountDetailBaseAdapter.FullScreenTopContainerHolder)localObject1).jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131362738));
              ((AccountDetailBaseAdapter.FullScreenTopContainerHolder)localObject1).d = ((ImageView)paramView.findViewById(2131362739));
              ((AccountDetailBaseAdapter.FullScreenTopContainerHolder)localObject1).e = ((ImageView)paramView.findViewById(2131362732));
              ((AccountDetailBaseAdapter.FullScreenTopContainerHolder)localObject1).jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362733));
              f1 = FontSettingManager.a() / 16.0F;
              if (f1 > 1.0F) {
              ...
              for (;;)
              {
                ...
                this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
                ((AccountDetailBaseAdapter.FullScreenTopContainerHolder)localObject1).jdField_a_of_type_AndroidViewView.setOnClickListener(new kru(this));
                paramView.findViewById(2131362735).setOnClickListener(new krv(this));
            ...
            case 1: 
              bool = a(paramInt);
              if (bool) {}
              for (paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130969215, paramViewGroup, false);; paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130969206, paramViewGroup, false))
              {
                localObject5 = new ksc(this);
                ((ksc)localObject5).jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)paramView.findViewById(2131365615));
                ((ksc)localObject5).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131365613));
                ((ksc)localObject5).jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131365614));
                ((ksc)localObject5).jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131365616));
                ((ksc)localObject5).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131365587));
                ((ksc)localObject5).jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131365586));
                ((ksc)localObject5).jdField_a_of_type_Boolean = bool;
            ...
            case 2: 
              paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130969205, paramViewGroup, false);
              localObject4 = new ksd(this);
              ((ksd)localObject4).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131365610));
              ((ksd)localObject4).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131365609));
              ((ksd)localObject4).jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131365611));
            ...
            case 9: 
              ...
              paramView.setOnClickListener(null);
              localObject1 = new kse(this);
              ((kse)localObject1).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362713));
              ((kse)localObject1).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131362714));
              ((kse)localObject1).jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362715));
              paramView.setTag(localObject1);
              bool = false;
              localObject2 = null;
              localObject3 = null;
              ...
              if (i1 == 1)
              {
                a((ksc)localObject5, paramView, paramInt, bool);
                return paramView;
              }
              if (i1 == 6)
              {
              ...
              if (i1 == 9)
              {
                ...
                {
                  ((kse)localObject1).jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
                  ((kse)localObject1).jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
                  ((kse)localObject1).jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
                  return paramView;
                }
                ((kse)localObject1).jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
                ((kse)localObject1).jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
                ((kse)localObject1).jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
                return paramView;
              }
  ...
  void j()
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountAccountDetailAdapterAccountDetailBaseAdapter$FullScreenTopContainerHolder.e.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130840938));
