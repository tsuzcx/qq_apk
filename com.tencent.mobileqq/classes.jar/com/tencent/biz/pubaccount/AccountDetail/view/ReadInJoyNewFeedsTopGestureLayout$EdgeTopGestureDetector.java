...
public class ReadInJoyNewFeedsTopGestureLayout$EdgeTopGestureDetector
  extends TopGestureLayout.TopGestureDetector
{
  public ReadInJoyNewFeedsTopGestureLayout$EdgeTopGestureDetector(ReadInJoyNewFeedsTopGestureLayout paramReadInJoyNewFeedsTopGestureLayout, Context paramContext)
  {
  ...
  public boolean onFling(MotionEvent paramMotionEvent1, MotionEvent paramMotionEvent2, float paramFloat1, float paramFloat2)
  {
    ...
    if (this.a.hasGestureFlag(1)) {
      if (paramMotionEvent1.getX() <= 0.2133333333333334D * DeviceInfoUtil.j())
      {
        i = 1;
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.AccountDetail.view.ReadInJoyNewFeedsTopGestureLayout.EdgeTopGestureDetector
