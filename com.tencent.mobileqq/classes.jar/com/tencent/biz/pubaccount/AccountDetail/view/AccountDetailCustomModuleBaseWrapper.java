...
public class AccountDetailCustomModuleBaseWrapper
{
  ...
  public AccountDetailCustomModuleBaseWrapper(Context paramContext, ArrayList paramArrayList, AccountDetailBaseItemClickHandler paramAccountDetailBaseItemClickHandler, String paramString1, String paramString2)
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new krh(this);
    this.jdField_a_of_type_ComTencentWidgetAdapterView$OnItemClickListener = new kri(this);
  ...
  protected static ArrayList a(PaConfigAttr paramPaConfigAttr, int paramInt)
  {
  ...
  public void a(PaConfigAttr.PaConfigInfo paramPaConfigInfo)
  {
    ...
    for (localObject1 = (QQAppInterface)localObject1;; localObject1 = null)
    {
      ...
      {
        localObject2 = (PublicAccountDataManager)((QQAppInterface)localObject1).getManager(55);
      ...
      for (int i = 1;; i = 0)
      {
        ...
        for (int j = PublicAccountReportUtils.a((QQAppInterface)localObject1, this.jdField_a_of_type_JavaLangString, null);; j = 1)
        {
          if ((paramPaConfigInfo.jdField_a_of_type_Int == 3) && (paramPaConfigInfo.jdField_c_of_type_Int == 23))
          {
            ...
            if (i != 0)
            {
              ...
              PublicAccountReportUtils.a(null, (String)localObject2, "0X80077F9", "0X80077F9", 0, 0, "2", (String)localObject1, paramPaConfigInfo, String.valueOf(j), false);
            }
          }
          ...
          try
          {
            ...
            if (TextUtils.isEmpty(paramPaConfigInfo))
            {
              ...
              {
                localObject1 = "02";
                PublicAccountReportUtils.a(null, (String)localObject2, "0X80077F9", "0X80077F9", 0, 0, "1", paramPaConfigInfo, (String)localObject1, String.valueOf(j), false);
                return;
              }
            }
          }
