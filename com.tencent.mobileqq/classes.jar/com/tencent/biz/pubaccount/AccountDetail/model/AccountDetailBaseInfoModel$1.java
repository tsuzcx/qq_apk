...
{
  AccountDetailBaseInfoModel$1(QQAppInterface paramQQAppInterface, PaConfigAttr.PaConfigInfo paramPaConfigInfo, int paramInt, String paramString) {}
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramBundle != null)
        {
          ...
          if (((mobileqq_mp.RetInfo)((mobileqq_mp.SetFunctionFlagResponse)localObject).ret_info.get()).ret_code.get() == 0)
          {
            ...
            if (paramBundle != null)
            {
              if (this.jdField_a_of_type_ComTencentBizPubaccountPaConfigAttr$PaConfigInfo.e == 6)
              {
                ...
                localPublicAccountHandler.notifyUI(109, true, this.jdField_a_of_type_ComTencentBizPubaccountPaConfigAttr$PaConfigInfo);
                return;
              }
          ...
          {
            localPublicAccountHandler.notifyUI(109, false, this.jdField_a_of_type_ComTencentBizPubaccountPaConfigAttr$PaConfigInfo);
          }
        }
        else
        {
