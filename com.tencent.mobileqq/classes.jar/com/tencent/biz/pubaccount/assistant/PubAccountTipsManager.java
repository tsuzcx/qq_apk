  ...
  implements View.OnClickListener
{
  ...
  public View a(String paramString, View.OnClickListener paramOnClickListener)
  {
    ...
    if (this.jdField_a_of_type_AndroidViewView == null)
    {
      ...
      ((TextView)this.jdField_a_of_type_AndroidViewView).setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131492968));
      this.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130843823);
    ...
    localLayoutParams.addRule(3, 2131363490);
  ...
  public void a(String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    do
    {
      ...
      try
      {
        localObject2 = (ViewGroup)((FragmentActivity)this.jdField_a_of_type_AndroidContentContext).getChatFragment().a().c.findViewById(2131363474);
    ...
    if (this.b == null)
    {
      ...
      ((RelativeLayout.LayoutParams)localObject2).addRule(3, 2131363490);
      ((RelativeLayout.LayoutParams)localObject2).addRule(11);
      this.b.setLayoutParams((ViewGroup.LayoutParams)localObject2);
    }
    this.b.setTag(2131362189, paramString2);
    this.b.setTag(2131362190, String.valueOf(paramInt1));
    this.b.setTag(2131362191, String.valueOf(paramInt2));
    this.b.setTag(2131362192, Integer.valueOf(paramInt3));
    ...
    try
    {
      ...
      ((URLImageView)this.b).setURLDrawableDownListener(new lae(this));
    }
  ...
  public void onClick(View paramView)
  {
    ...
    } while ((paramView.getId() != 2131362188) || (this.jdField_a_of_type_AndroidContentContext == null));
    String str1 = (String)paramView.getTag(2131362189);
    String str2 = (String)paramView.getTag(2131362190);
    String str3 = (String)paramView.getTag(2131362191);
    if (((Integer)paramView.getTag(2131362192)).intValue() == 1)
    {
