  ...
  implements View.OnClickListener
{
  ...
  public View a(String paramString, View.OnClickListener paramOnClickListener)
  {
    ...
    if (this.jdField_a_of_type_AndroidViewView == null)
    {
      ...
      ((TextView)this.jdField_a_of_type_AndroidViewView).setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131167374));
      this.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130847464);
    ...
    localLayoutParams.addRule(3, 2131374581);
  ...
  public void a(String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    do
    {
      ...
      try
      {
        localObject2 = (ViewGroup)((FragmentActivity)this.jdField_a_of_type_AndroidContentContext).getChatFragment().a().c.findViewById(2131364598);
    ...
    if (this.b == null)
    {
      ...
      this.b.setId(2131362591);
      i = DisplayUtil.a(this.jdField_a_of_type_AndroidContentContext, 62.0F);
      ...
      ((RelativeLayout.LayoutParams)localObject2).addRule(3, 2131374581);
      ((RelativeLayout.LayoutParams)localObject2).addRule(11);
      this.b.setLayoutParams((ViewGroup.LayoutParams)localObject2);
    }
    this.b.setTag(2131362594, paramString2);
    this.b.setTag(2131362592, String.valueOf(paramInt1));
    this.b.setTag(2131362593, String.valueOf(paramInt2));
    this.b.setTag(2131362595, Integer.valueOf(paramInt3));
    ...
    try
    {
      ...
      ((URLImageView)this.b).setURLDrawableDownListener(new PubAccountTipsManager.1(this));
    }
  ...
  public void onClick(View paramView)
  {
    ...
    } while ((paramView.getId() != 2131362591) || (this.jdField_a_of_type_AndroidContentContext == null));
    String str1 = (String)paramView.getTag(2131362594);
    String str2 = (String)paramView.getTag(2131362592);
    String str3 = (String)paramView.getTag(2131362593);
    Intent localIntent;
    if (((Integer)paramView.getTag(2131362595)).intValue() == 1)
    {
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.assistant.PubAccountTipsManager
