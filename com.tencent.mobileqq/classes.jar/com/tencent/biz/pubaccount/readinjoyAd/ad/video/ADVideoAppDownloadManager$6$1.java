...
public class ADVideoAppDownloadManager$6$1
  implements Runnable
{
  public ADVideoAppDownloadManager$6$1(txj paramtxj, String paramString, int paramInt) {}
  
  public void run()
  {
    Object localObject1 = this.jdField_a_of_type_Txj.a.a.iterator();
    txh localtxh;
    label233:
    do
    {
      ...
      {
        localtxh = (txh)((Iterator)localObject1).next();
        Object localObject2 = localtxh.c;
        j = this.jdField_a_of_type_Txj.a.a(localtxh);
        if ((!TextUtils.isEmpty((CharSequence)localObject2)) && (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) && (((String)localObject2).equals(this.jdField_a_of_type_JavaLangString)) && ((j == 0) || (j == 4) || (j == 3)))
        {
          ...
          this.jdField_a_of_type_Txj.a.c(localtxh);
          localObject1 = new DownloadInfo();
          ((DownloadInfo)localObject1).e = localtxh.d;
          ((DownloadInfo)localObject1).f = i;
          ((DownloadInfo)localObject1).c = localtxh.jdField_a_of_type_JavaLangString;
          ADVideoAppDownloadManager.a(this.jdField_a_of_type_Txj.a).a = true;
          ADVideoAppDownloadManager.a(this.jdField_a_of_type_Txj.a).a();
          this.jdField_a_of_type_Txj.a.a((DownloadInfo)localObject1, 4);
        }
      }
      return;
      if ((j == 4) && ((this.jdField_a_of_type_Int == 2) || (this.jdField_a_of_type_Int == 1)))
      {
        this.jdField_a_of_type_Txj.a.a(localtxh);
        localObject1 = new DownloadInfo();
        ((DownloadInfo)localObject1).e = localtxh.d;
        ((DownloadInfo)localObject1).f = i;
        ((DownloadInfo)localObject1).c = localtxh.jdField_a_of_type_JavaLangString;
        ADVideoAppDownloadManager.a(this.jdField_a_of_type_Txj.a).a = true;
        ADVideoAppDownloadManager.a(this.jdField_a_of_type_Txj.a).a();
        this.jdField_a_of_type_Txj.a.a((DownloadInfo)localObject1, 3);
        return;
      }
    ...
    ADVideoAppDownloadManager.a(this.jdField_a_of_type_Txj.a).a = true;
    ADVideoAppDownloadManager.a(this.jdField_a_of_type_Txj.a).a();
    this.jdField_a_of_type_Txj.a.a((DownloadInfo)localObject1, 5);
  }
}
