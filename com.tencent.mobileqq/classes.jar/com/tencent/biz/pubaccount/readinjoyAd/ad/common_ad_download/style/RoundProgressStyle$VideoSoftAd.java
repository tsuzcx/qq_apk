  ...
  extends RoundProgressStyle
{
  ...
  private float btnTextSize = 11.0F;
  private float imageIconHeight = 16.0F;
  private float imageIconWidth = 14.0F;
  @NotNull
  private String pauseRectColor = "#FFFFFF";
  private float pauseRectWidth = 9.0F;
  @NotNull
  private String progressColorHighLight = "#FFFFFF";
  @NotNull
  private String progressColorNormal = "#66FFFFFF";
  private float progressHighLightWidth = 1.0F;
  private float progressWidthNormal = 1.0F;
  private float roundSize = 28.0F;
  private int startAngle = 270;
  
  RoundProgressStyle$VideoSoftAd()
  {
    super(str, i, null);
  }
