...
{
  AdVideo185UIStateUtil$onProgressUpdate$$inlined$let$lambda$2(ReadInJoyAdVideoGuide paramReadInJoyAdVideoGuide, AdvertisementInfo paramAdvertisementInfo, RecommendADVideoFeedsManager paramRecommendADVideoFeedsManager, VideoPlayManager.VideoPlayParam paramVideoPlayParam) {}
  
  public final void a(View paramView, int paramInt)
  {
    paramView = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoRecommendADVideoFeedsManager;
    if (paramView != null) {
      paramView.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInJoyAdVideoGuide.getContext(), paramInt, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoPlayManager$VideoPlayParam.a);
    }
  }
}
