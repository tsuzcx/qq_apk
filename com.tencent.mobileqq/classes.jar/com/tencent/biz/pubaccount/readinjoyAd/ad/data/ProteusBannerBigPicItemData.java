  ...
  extends AdData
{
  ...
  private JSONObject a()
  {
    ...
    if (FastWeqAdUtils.b(this)) {
      localObject1 = ReadInjoyAdBannerPkCell.a(localJSONObject, this);
    }
    for (;;)
    {
      return localObject1;
      ...
      try
      {
        ...
        d1 = ParseUtil.a(this.aa, 0.0D);
        d2 = ParseUtil.a((String)localObject1, 0.0D);
        if (d2 == 0.0D)
        {
          localObject1 = str1;
          if (d1 == 0.0D) {}
    ...
    do
    {
      for (;;)
      {
        ...
        case 1: 
          ...
          {
            localObject1 = ((IPublicAccountHttpDownloader)QRoute.api(IPublicAccountHttpDownloader.class)).makeURL(this.d, 4);
          ...
          case 1: 
            ...
            case 1: 
              ...
              break label966;
              d1 = NativeAdUtils.a((double[])localObject1, BaseApplicationImpl.getContext());
              break label140;
              d1 = Math.ceil(d1);
