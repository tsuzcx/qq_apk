  ...
  extends AdData
{
  ...
  private JSONObject a()
  {
    ...
    if (tpp.a(this)) {
      return tos.a(localJSONObject, this);
    }
    if (this.y == 2) {
  ...
  private void a(JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Tmc = new tmc(this, ((JSONObject)localObject2).optInt("regexType"), ((JSONObject)localObject2).optString("name"), ((JSONObject)localObject2).optString("placeholder"), paramJSONObject.optString("text"), (JSONObject)localObject2, Pattern.compile((String)localObject1));
      return;
    }
  ...
  private JSONObject b(JSONObject paramJSONObject)
  {
    try
    {
      ...
      if (!TextUtils.isEmpty(this.A))
      {
        ...
        ((JSONObject)localObject).put("text", tpw.a(this.A, 16));
      }
      for (;;)
      {
        ...
        return paramJSONObject;
        label262:
        ((JSONObject)localObject).put("text", tpw.a(this.A, 12));
      }
      ...
      try
      {
        ...
        if (this.jdField_b_of_type_OrgJsonJSONObject != null)
        {
          ...
          if (i != 1)
          {
            ...
            ((JSONObject)localObject3).put("image_url", tye.a(this.jdField_b_of_type_OrgJsonJSONObject.optString("adImg", ""), 4).toString());
            if (!f()) {
              break label775;
            }
            localObject1 = "8.0";
