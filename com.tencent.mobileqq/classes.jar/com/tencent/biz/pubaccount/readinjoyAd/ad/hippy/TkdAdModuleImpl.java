  ...
  implements ITKDAdModule
{
  ...
  public void loadUrl(String paramString, HippyMap paramHippyMap)
  {
    ...
    if (ViolaAccessHelper.b(paramString)) {
      ViolaAccessHelper.a(paramHippyMap.getGlobalConfigs().getContext(), "小游戏", ViolaAccessHelper.c(paramString), null);
    }
    for (;;)
    {
      QLog.d(jdField_a_of_type_JavaLangString, 2, "loadUrl url:" + paramString);
      return;
      RIJJumpUtils.a(paramHippyMap.getGlobalConfigs().getContext(), paramString);
    }
  }
  ...
  public void openQQMiniGameByLink(HippyMap paramHippyMap, Promise paramPromise)
  {
    ...
    try
    {
      ...
      ((IMiniAppService)QRoute.api(IMiniAppService.class)).startMiniApp(paramPromise.getGlobalConfigs().getContext(), str, i, null);
      return;
    }
