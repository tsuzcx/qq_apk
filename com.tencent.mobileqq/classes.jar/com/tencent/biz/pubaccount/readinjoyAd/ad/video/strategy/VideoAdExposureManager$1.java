...
public class VideoAdExposureManager$1
  implements Runnable
{
  public VideoAdExposureManager$1(txu paramtxu, int paramInt1, int paramInt2, oaa paramoaa) {}
  ...
  public void run()
  {
    ...
    pkm.a().a(this.b, this.jdField_a_of_type_Int, 0, 10000, this.jdField_a_of_type_Oaa);
  }
}
