...
public class ReadInJoyArticleBottomVideoView
  extends ViewBase
  implements View.OnClickListener, TVK_IMediaPlayer.OnCompletionListener, TVK_IMediaPlayer.OnErrorListener, TVK_IMediaPlayer.OnVideoPreparedListener, tmz
{
  ...
  private void A()
  {
    if ((this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer != null) && (!tno.jdField_c_of_type_Boolean))
    {
  ...
  private void B()
  {
    tno.jdField_b_of_type_Boolean = false;
    tno.jdField_c_of_type_Boolean = false;
  ...
  private void a(long paramLong)
  {
    ...
    tno.jdField_b_of_type_Boolean = false;
    tno.jdField_c_of_type_Boolean = true;
  }
  ...
  private void a(View paramView, boolean paramBoolean, int paramInt)
  {
    ...
    {
      localObject2 = tqb.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdDataProteusBannerVideoItemData);
      localObject1 = localObject2;
      if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdDataProteusBannerVideoItemData.jdField_g_of_type_Boolean)
      {
        localObject1 = localObject2;
      ...
      if (!ubd.a(paramView.getContext(), this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdDataProteusBannerVideoItemData, (AdvertisementInfo)localObject1)) {}
    }
    else
    {
      return;
    ...
    {
      localObject2 = ubd.a(paramView.getContext(), (AdvertisementInfo)localObject1, null, 2, paramBoolean, new tlt(bool));
      if (localObject2 == null) {
        break;
      }
      ((GdtHandler.Params)localObject2).jdField_f_of_type_Boolean = tpz.b(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdDataProteusBannerVideoItemData);
      long l = 0L;
      ...
      {
        tpk.a(paramView.getContext(), l, (AdvertisementInfo)localObject1);
        if (localObject1 != null) {
          ((AdvertisementInfo)localObject1).setClickPos(paramInt);
        }
        tno.jdField_a_of_type_ComTencentGdtadAditemGdtHandler$Params = (GdtHandler.Params)localObject2;
        if (tno.jdField_a_of_type_ComTencentGdtadAditemGdtHandler$Params == null) {
          break label322;
        }
      }
      label322:
      ...
      {
        tno.jdField_a_of_type_Long = l;
        if ((localObject1 != null) && (!((AdvertisementInfo)localObject1).isCommentAd())) {
          nzq.a(new tlx().a(this.jdField_a_of_type_ComTencentCommonAppAppInterface).a(BaseApplication.getContext()).a(nzq.jdField_a_of_type_Int).b(nzq.T).a((AdvertisementInfo)localObject1).d(nzq.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdDataProteusBannerVideoItemData)).d(paramInt).a());
        }
        q();
        return;
        ubd.a((GdtHandler.Params)localObject2, paramView.getContext(), (AdvertisementInfo)localObject1);
        break;
      }
    }
  }
  ...
  private void a(ProteusBannerVideoItemData paramProteusBannerVideoItemData)
  {
    ...
    String str2 = anzj.a(2131711930);
    String str1;
    if (bihq.a() == 1) {
      str1 = anzj.a(2131711663);
    }
    for (;;)
    {
      ...
      {
        str1 = str2;
        if (paramProteusBannerVideoItemData.jdField_f_of_type_Long > 0L) {
          str1 = rpt.b(paramProteusBannerVideoItemData.jdField_f_of_type_Long) + anzj.a(2131711687);
        }
      }
    }
  }
  ...
  private void b(Context paramContext)
  {
    ...
    this.jdField_d_of_type_AndroidViewView = ((LayoutInflater)paramContext.getSystemService("layout_inflater")).inflate(2131560062, null);
  ...
  public static boolean b()
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 410	tno:jdField_a_of_type_Boolean	Z
    //   6: ifeq +18 -> 24
    //   9: getstatic 350	com/tencent/biz/pubaccount/readinjoyAd/ad/view/ReadInJoyArticleBottomVideoView:jdField_c_of_type_Boolean	Z
    //   12: istore_0
    //   13: iload_0
    //   14: ifne +10 -> 24
    //   17: iconst_1
  ...
  private void c(Context paramContext)
  {
    if (!this.jdField_g_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_Tsw = new tsw(this);
      AppNetConnInfo.registerConnectionChangeReceiver(paramContext, this.jdField_a_of_type_Tsw);
    }
  }
  ...
  private void d(Context paramContext)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IProxyFactory != null) && (paramContext != null) && (this.jdField_a_of_type_Nzg != null))
    {
      ...
      tsy localtsy = new tsy(this);
      ((IVideoViewBase)localObject).addViewCallBack(localtsy);
      ...
      if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null)
      {
        ...
        if (this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer != null)
        {
          this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnVideoPreparedListener(localtsy);
          this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnErrorListener(localtsy);
          this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnCompletionListener(localtsy);
  ...
  private void e(Context paramContext)
  {
    ...
    try
    {
      TVK_SDKMgr.installPlugin(paramContext.getApplicationContext(), new tsu(this));
      return;
    }
    catch (Throwable paramContext)
    {
      acvc.a("ReadInJoyArticleBottomVideoView", "installSDK t==" + paramContext.toString());
    }
  }
  ...
  private void f(Context paramContext)
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoPreDownloadMgr.a(new tsx(this));
  ...
  private void t()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_d_of_type_AndroidViewView.findViewById(2131380720));
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this);
    this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_d_of_type_AndroidViewView.findViewById(2131362804));
    this.jdField_a_of_type_ComTencentImageURLImageView.setScaleType(ImageView.ScaleType.CENTER_CROP);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_d_of_type_AndroidViewView.findViewById(2131362805));
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidViewView = this.jdField_d_of_type_AndroidViewView.findViewById(2131362808);
    this.jdField_a_of_type_AndroidViewView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_d_of_type_AndroidViewView.findViewById(2131362810));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_d_of_type_AndroidViewView.findViewById(2131380786));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(this);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInJoyAdVideoGuide = ((ReadInJoyAdVideoGuide)this.jdField_d_of_type_AndroidViewView.findViewById(2131362064));
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInJoyAdVideoGuide.setAdGuideClickListener(new tst(this));
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_d_of_type_AndroidViewView.findViewById(2131380721));
    this.jdField_b_of_type_AndroidViewView = this.jdField_d_of_type_AndroidViewView.findViewById(2131380910);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_d_of_type_AndroidViewView.findViewById(2131381543));
  ...
  private void u()
  {
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdDataProteusBannerVideoItemData != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdDataProteusBannerVideoItemData.jdField_g_of_type_Boolean) && (this.jdField_a_of_type_AndroidWidgetImageView != null))
    {
      this.jdField_a_of_type_AndroidWidgetImageView.setBackgroundResource(2130843196);
      ViewGroup.LayoutParams localLayoutParams = this.jdField_a_of_type_AndroidWidgetImageView.getLayoutParams();
      localLayoutParams.width = agej.a(50.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
      localLayoutParams.height = agej.a(50.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
  ...
  {
    int k;
    if ((!this.jdField_f_of_type_Boolean) && (this.jdField_a_of_type_Nzg != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo != null))
    {
      ...
      {
        k = 1;
        ocd.a(null, str, "0X80093B8", "0X80093B8", 0, k, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdTraceId, "", "", "");
      }
    }
    else if (this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer != null)
    {
      ...
      tno.jdField_b_of_type_Boolean = true;
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.start();
      this.jdField_a_of_type_Int = 4;
    ...
    } while ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdDataProteusBannerVideoItemData == null) || (!this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdDataProteusBannerVideoItemData.jdField_g_of_type_Boolean) || (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo == null) || (this.i == this.j));
    n();
  }
  ...
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdDataProteusBannerVideoItemData == null) {}
    while (!this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdDataProteusBannerVideoItemData.jdField_g_of_type_Boolean) {
      return 2;
    }
    return 3;
  }
  ...
  {
    if (paramContext == null) {}
    while ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdDataProteusBannerVideoItemData != null) && (!this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdDataProteusBannerVideoItemData.jdField_g_of_type_Boolean) && (tno.jdField_c_of_type_Boolean)) {
      return;
    }
  ...
  public void a(nzg paramnzg, AdvertisementInfo paramAdvertisementInfo, ProteusBannerVideoItemData paramProteusBannerVideoItemData1, ProteusBannerVideoItemData paramProteusBannerVideoItemData2)
  {
    ...
    o();
    u();
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInJoyAdVideoGuide != null) && (paramProteusBannerVideoItemData1 != null)) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInJoyAdVideoGuide.setAppInfo(paramProteusBannerVideoItemData1.jdField_b_of_type_Int, paramProteusBannerVideoItemData1.B, paramProteusBannerVideoItemData1.i, paramProteusBannerVideoItemData1.h, tpp.g(paramProteusBannerVideoItemData1), this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo);
    }
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdDataProteusBannerVideoItemData.jdField_f_of_type_Boolean) {
      w();
    }
    for (;;)
    {
      if (((jdField_a_of_type_Long == -1L) || (System.currentTimeMillis() - jdField_a_of_type_Long > 1000L) || (a(paramProteusBannerVideoItemData1, paramProteusBannerVideoItemData2))) && (tpz.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdDataProteusBannerVideoItemData, a(), a())))
      {
        a(a());
  ...
  public void h()
  {
    if (!tpz.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdDataProteusBannerVideoItemData, a(), a())) {
      z();
    }
  }
  ...
  public void j()
  {
    ...
    do
    {
      ...
      case 6: 
        v();
        this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
        if (tno.jdField_c_of_type_Boolean) {
        ...
        for (;;)
        {
          ...
          if (c()) {
            nzq.a(new tlx().a(this.jdField_a_of_type_ComTencentCommonAppAppInterface).a(a()).a(nzq.jdField_f_of_type_Int).b(b()).a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo).a(nzq.a(this.jdField_c_of_type_Int, this.jdField_d_of_type_Int, this.jdField_e_of_type_Int, this.jdField_f_of_type_Int, this.jdField_g_of_type_Int, this.jdField_h_of_type_Int, (int)this.jdField_c_of_type_Long, nzq.aN, 0)).a());
          }
          a(l);
          return;
          this.jdField_a_of_type_ComTencentImageURLImageView.setVisibility(8);
    ...
    nzq.a(new tlx().a(this.jdField_a_of_type_ComTencentCommonAppAppInterface).a(a()).a(nzq.jdField_f_of_type_Int).b(b()).a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo).a(nzq.a(0, 0, 0, 0, 0, 0, (int)this.jdField_c_of_type_Long, nzq.aN, 2)).a());
    return;
  ...
  public void k()
  {
    ...
    if (this.jdField_a_of_type_Tsw != null)
    {
      AppNetConnInfo.unregisterNetInfoHandler(this.jdField_a_of_type_Tsw);
      this.jdField_a_of_type_Tsw = null;
    }
  ...
  public void l()
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInJoyAdVideoGuide = null;
  }
  ...
  public void n()
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.i("ReadInJoyArticleBottomVideoView", 0, "net switch:" + tpz.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdDataProteusBannerVideoItemData, a(), a()));
      }
      QLog.d("ReadInJoyArticleBottomVideoView", 1, "net switch:" + tpz.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdDataProteusBannerVideoItemData, a(), a()));
    }
    for (int k = 0;; k = 1)
    {
      if (!tqb.a(this.jdField_a_of_type_ComTencentImageURLImageView))
      {
        if (QLog.isColorLevel()) {
          QLog.i("ReadInJoyArticleBottomVideoView", 0, "is auto play:" + tqb.a(this.jdField_a_of_type_ComTencentImageURLImageView));
        }
        QLog.d("ReadInJoyArticleBottomVideoView", 1, "is auto play:" + tqb.a(this.jdField_a_of_type_ComTencentImageURLImageView));
        k = 0;
      }
      int m = k;
      if (tno.jdField_b_of_type_Boolean)
      {
        m = k;
        if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdDataProteusBannerVideoItemData != null)
        {
          ...
          {
            if (QLog.isColorLevel()) {
              QLog.i("ReadInJoyArticleBottomVideoView", 0, "isCommentAd:" + tno.jdField_b_of_type_Boolean);
            }
            QLog.d("ReadInJoyArticleBottomVideoView", 1, "isCommentAd:" + tno.jdField_b_of_type_Boolean);
            m = 0;
          }
        }
      }
  ...
  public void o()
  {
    ...
    {
      return;
      if ((!this.jdField_h_of_type_Boolean) && (!this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdDataProteusBannerVideoItemData.jdField_f_of_type_Boolean))
      {
        v();
        this.jdField_a_of_type_ComTencentImageURLImageView.setVisibility(0);
      }
      try
      {
        if ((this.jdField_a_of_type_Nzg != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_Nzg.e)))
        {
          jdField_a_of_type_JavaLangString = this.jdField_a_of_type_Nzg.e;
          ...
          localObject = URLDrawable.getDrawable(tye.a(jdField_a_of_type_JavaLangString, 4), (URLDrawable.URLDrawableOptions)localObject);
  ...
  public void p()
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInJoyAdVideoGuide != null) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInJoyAdVideoGuide.c();
    }
  }
