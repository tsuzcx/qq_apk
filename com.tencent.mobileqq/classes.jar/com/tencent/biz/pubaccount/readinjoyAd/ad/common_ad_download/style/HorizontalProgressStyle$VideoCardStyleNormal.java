...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/biz/pubaccount/readinjoyAd/ad/common_ad_download/style/HorizontalProgressStyle$VideoCardStyleNormal;", "Lcom/tencent/biz/pubaccount/readinjoyAd/ad/common_ad_download/style/HorizontalProgressStyle;", "btnDrawableActiveColor", "", "getBtnDrawableActiveColor", "()Ljava/lang/String;", "setBtnDrawableActiveColor", "(Ljava/lang/String;)V", "btnDrawableActiveRadius", "", "getBtnDrawableActiveRadius", "()F", "setBtnDrawableActiveRadius", "(F)V", "btnDrawableNormalColor", "getBtnDrawableNormalColor", "setBtnDrawableNormalColor", "btnDrawableNormalRadius", "getBtnDrawableNormalRadius", "setBtnDrawableNormalRadius", "btnTextColor", "getBtnTextColor", "setBtnTextColor", "btnTextSize", "getBtnTextSize", "setBtnTextSize", "progressDrawable", "", "getProgressDrawable", "()I", "setProgressDrawable", "(I)V", "progressTextColor", "getProgressTextColor", "setProgressTextColor", "progressTextSize", "getProgressTextSize", "setProgressTextSize", "AQQLiteApp_release"}, k=1, mv={1, 1, 16})
final class HorizontalProgressStyle$VideoCardStyleNormal
  extends HorizontalProgressStyle
{
  @NotNull
  private String btnDrawableActiveColor = "#FF12B7F6";
  private float btnDrawableActiveRadius = 6.0F;
  @NotNull
  private String btnDrawableNormalColor = "#FF12B7F6";
  private float btnDrawableNormalRadius = 6.0F;
  @NotNull
  private String btnTextColor = "#FFFFFF";
  private float btnTextSize = 14.0F;
  private int progressDrawable = 2130842914;
  @NotNull
  private String progressTextColor = "#FFFFFF";
  private float progressTextSize = 14.0F;
  
  HorizontalProgressStyle$VideoCardStyleNormal()
  {
    super(str, i, null);
  }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoyAd.ad.common_ad_download.style.HorizontalProgressStyle.VideoCardStyleNormal
