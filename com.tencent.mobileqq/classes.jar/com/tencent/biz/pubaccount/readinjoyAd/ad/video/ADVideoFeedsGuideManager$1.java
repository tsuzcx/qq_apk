  ...
  extends AnimatorListenerAdapter
{
  ...
  {
    if ((ADVideoFeedsGuideManager.a(this.a) != null) && (ADVideoFeedsGuideManager.a(this.a).l != null))
    {
      ADVideoFeedsGuideManager.a(this.a).l.setVisibility(0);
      paramAnimator = new AnimatorSet();
      ObjectAnimator localObjectAnimator1 = ObjectAnimator.ofFloat(ADVideoFeedsGuideManager.a(this.a).l, "alpha", new float[] { 0.0F, 1.0F });
      localObjectAnimator1.setDuration(200L);
      localObjectAnimator1.setInterpolator(new DecelerateInterpolator());
      ObjectAnimator localObjectAnimator2 = ObjectAnimator.ofFloat(ADVideoFeedsGuideManager.a(this.a).l, "translationY", new float[] { AIOUtils.b(15.0F, ADVideoFeedsGuideManager.a(this.a).l.getResources()), 0.0F });
