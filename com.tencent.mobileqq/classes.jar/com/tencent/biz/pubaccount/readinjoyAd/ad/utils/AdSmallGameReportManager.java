  ...
  implements IAdSmallGameReportManager
{
  ...
  {
    if ((this.a != null) && (paramIReadInJoyModel.a() != null) && (paramIReadInJoyModel.a().mSmallMiniGameInfo != null))
    {
      if (paramIReadInJoyModel.a().mSmallMiniGameInfo.a == null) {
        return;
      }
      Object localObject = new StringBuilder();
      ((StringBuilder)localObject).append(paramIReadInJoyModel.a().mSmallMiniGameInfo.b);
      ((StringBuilder)localObject).append("_");
      ((StringBuilder)localObject).append(((SmallMiniGameInfo.SmallMiniGameData)paramIReadInJoyModel.a().mSmallMiniGameInfo.a.get(paramInt1)).a);
      localObject = ((StringBuilder)localObject).toString();
      if (!this.a.contains(localObject))
      {
        this.a.add(localObject);
        ((IRIJAdUtilService)QRoute.api(IRIJAdUtilService.class)).reportMiniGameFromRecommendCard(paramContext, paramIReadInJoyModel.a(), paramIReadInJoyModel.g(), paramInt1, paramInt2);
      }
    }
  }
}
