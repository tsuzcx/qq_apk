  ...
  implements ValueAnimator.AnimatorUpdateListener
{
  ...
  public void onAnimationUpdate(ValueAnimator paramValueAnimator)
  {
    ...
    VideoFeedsSoftAdBarDelegateForAd.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdSoft_componentVideoFeedsSoftAdBarDelegateForAd).setScaleX(f2);
    VideoFeedsSoftAdBarDelegateForAd.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdSoft_componentVideoFeedsSoftAdBarDelegateForAd).setScaleY(f2);
    ...
    paramValueAnimator.height = ((int)(this.c * f1));
