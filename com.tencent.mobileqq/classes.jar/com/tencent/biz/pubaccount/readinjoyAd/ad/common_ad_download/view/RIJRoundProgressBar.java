  ...
  implements ufm
{
  ...
  private int jdField_c_of_type_Int = oix.a(this.jdField_a_of_type_JavaLangString, "#CCE5E5E5");
  private String jdField_c_of_type_JavaLangString = "#FF00CAFC";
  private int d = oix.a(this.jdField_b_of_type_JavaLangString, "#FF00CAFC");
  private int e = oix.a(this.jdField_c_of_type_JavaLangString, "#FF00CAFC");
  private int f = -1;
  ...
  protected void onDraw(@Nullable Canvas paramCanvas)
  {
    ...
    int i = getWidth() / 2;
    int j = getHeight() / 2;
    int k = i - AIOUtils.dp2px(this.jdField_a_of_type_Float, getResources()) / 2;
    Object localObject = this.jdField_a_of_type_AndroidGraphicsPaint;
    ((Paint)localObject).setStrokeWidth(AIOUtils.dp2px(this.jdField_a_of_type_Float, getResources()));
    ...
    this.jdField_a_of_type_AndroidGraphicsPaint.setStrokeWidth(AIOUtils.dp2px(this.jdField_b_of_type_Float, getResources()));
    ...
    if (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())
    {
      ...
      float f1 = AIOUtils.dp2px(this.jdField_c_of_type_Float, getResources()) / 2.0F;
  ...
  public void setProgressStyle(@Nullable ufa paramufa)
  {
    ...
    this.jdField_a_of_type_Float = ((RoundProgressStyle)paramufa).getProgressWidthNormal();
    this.jdField_b_of_type_Float = ((RoundProgressStyle)paramufa).getProgressHighLightWidth();
    this.jdField_c_of_type_Float = ((RoundProgressStyle)paramufa).getPauseRectWidth();
    this.jdField_a_of_type_JavaLangString = ((RoundProgressStyle)paramufa).getProgressColorNormal();
    this.jdField_b_of_type_JavaLangString = ((RoundProgressStyle)paramufa).getProgressColorHighLight();
    this.jdField_c_of_type_JavaLangString = ((RoundProgressStyle)paramufa).getPauseRectColor();
    this.jdField_c_of_type_Int = oix.a(this.jdField_a_of_type_JavaLangString, "#CCE5E5E5");
    this.d = oix.a(this.jdField_b_of_type_JavaLangString, "#FF00CAFC");
    this.e = oix.a(this.jdField_c_of_type_JavaLangString, "#FF00CAFC");
    this.jdField_a_of_type_Int = ((RoundProgressStyle)paramufa).getStartAngle();
    this.f = ((RoundProgressStyle)paramufa).getBtnResource();
  }
