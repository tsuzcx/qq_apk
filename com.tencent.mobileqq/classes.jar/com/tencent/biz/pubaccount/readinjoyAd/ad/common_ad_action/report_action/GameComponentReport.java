...
public class GameComponentReport
{
  ...
  public static JSONObject a(AdvertisementInfo paramAdvertisementInfo, long paramLong1, long paramLong2, String paramString1, String paramString2)
  {
    ...
    if (i >= 0)
    {
      ...
      str = paramAdvertisementInfo.gameAdComData.d;
      label167:
    ...
    label406:
    label413:
    for (paramAdvertisementInfo = "2";; paramAdvertisementInfo = "1")
    {
      localHashMap.put("obj_type", paramAdvertisementInfo);
  ...
  public static void a(AdvertisementInfo paramAdvertisementInfo, int paramInt, String paramString)
  {
    ...
    a(paramAdvertisementInfo, NativeAdUtils.a(paramAdvertisementInfo), a(paramAdvertisementInfo, l1, 10L, str, paramString), ReportAction.CLICK, ActionEntity.GamePopWindow, Integer.valueOf(20));
  }
  ...
  public static void a(AdvertisementInfo paramAdvertisementInfo, JSONObject paramJSONObject1, JSONObject paramJSONObject2, ReportAction paramReportAction, ActionEntity paramActionEntity, Integer paramInteger)
  {
    ...
    NativeAdUtils.a(new AdReportData().a(localQQAppInterface).a(BaseApplication.getContext()).a(119).b(39).a(paramReportAction).b(paramInteger).a(paramActionEntity).e(paramJSONObject2).a(paramAdvertisementInfo).d(paramJSONObject1));
  }
  ...
  public static void a(Integer paramInteger, AdvertisementInfo paramAdvertisementInfo, int paramInt, String paramString)
  {
    long l = 3010205L;
    if (paramAdvertisementInfo == null) {
      ReadInJoyAdLog.a("GameComponentReport", "doGameDownloadStateReport:advertisementInfo is null");
    }
    boolean bool1;
    boolean bool2;
    do
    {
      return;
      bool1 = FastWeqAdUtils.c(paramAdvertisementInfo);
      bool2 = FastWeqAdUtils.b(paramAdvertisementInfo);
    } while ((!bool1) && (!bool2));
    ...
    {
      paramAdvertisementInfo.adClickPos = AdClickPos.SoftAdClickBtn;
      a(paramAdvertisementInfo, NativeAdUtils.a(paramAdvertisementInfo), a(paramAdvertisementInfo, l, 9L, str, paramString), ReportAction.CLICK, ActionEntity.GamePopWindow, paramInteger);
      return;
      if (bool2) {
        l = 3010307L;
      }
