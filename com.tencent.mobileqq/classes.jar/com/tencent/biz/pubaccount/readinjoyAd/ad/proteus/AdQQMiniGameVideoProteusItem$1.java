  ...
  implements Runnable
{
  ...
  public void run()
  {
    if ((AdQQMiniGameVideoProteusItem.a(this.this$0) != null) && (!TextUtils.isEmpty(AdQQMiniGameVideoProteusItem.b(this.this$0))))
    {
      ((ReadInjoyImageView)AdQQMiniGameVideoProteusItem.a(this.this$0)).mSrc = AdQQMiniGameVideoProteusItem.b(this.this$0);
      ((ReadInjoyImageView)AdQQMiniGameVideoProteusItem.a(this.this$0)).loadImage(AdQQMiniGameVideoProteusItem.b(this.this$0));
    }
  }
}
