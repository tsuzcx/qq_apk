...
public class ExposureSupplementUtil
{
  ...
  public ExposureSupplementUtil(int paramInt)
  {
  ...
  private static JSONObject a(Context paramContext, AdvertisementInfo paramAdvertisementInfo, int paramInt1, int paramInt2)
  {
    ...
    try
    {
      ...
      localJSONObject1.put("statistics_data_report", ReadInJoyAdUtils.a(paramContext, paramAdvertisementInfo, localJSONObject2).toString());
  ...
  private static void a(Activity paramActivity, int paramInt, VideoAdInfo paramVideoAdInfo)
  {
    ...
    AdvertisementInfo localAdvertisementInfo = NativeAdUtils.a(paramVideoAdInfo);
  ...
  public static void a(Activity paramActivity, int paramInt, boolean paramBoolean)
  {
    ...
    AdvertisementInfo localAdvertisementInfo = NativeAdUtils.a(localVideoAdInfo);
    if (QLog.isColorLevel()) {
  ...
  private static void a(Activity paramActivity, VideoAdInfo paramVideoAdInfo, AdvertisementInfo paramAdvertisementInfo, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    NativeAdUtils.a(new AdReportData().a(paramActivity).a(25).b(paramInt1).a(paramAdvertisementInfo).a(paramVideoAdInfo).e(a(paramActivity, paramAdvertisementInfo, paramInt2, paramInt3)));
  }
  ...
  private void a(Activity paramActivity, AdvertisementInfo paramAdvertisementInfo, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    NativeAdUtils.a(new AdReportData().a(paramActivity).a(25).b(paramInt1).a(paramAdvertisementInfo).e(a(paramActivity, paramAdvertisementInfo, paramInt2, paramInt3)));
  }
  ...
  {
    boolean bool = "1".equals(ReadInJoyHelper.a("readinjjoy_ad_supplement_config"));
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if ((localObject1 != null) && (((Long)localObject1).longValue() != 0L))
        {
          ...
          AdvertisementInfo localAdvertisementInfo = NativeAdUtils.a((VideoAdInfo)localObject2);
  ...
  public void a(ReadInJoyBaseAdapter paramReadInJoyBaseAdapter, Activity paramActivity)
  {
    if ((paramReadInJoyBaseAdapter == null) || (paramActivity == null) || (this.jdField_c_of_type_Boolean)) {}
    ReadInJoyXListView localReadInJoyXListView;
    List localList;
    do
    {
      return;
      localReadInJoyXListView = (ReadInJoyXListView)paramReadInJoyBaseAdapter.a();
      localList = paramReadInJoyBaseAdapter.a();
      i = paramReadInJoyBaseAdapter.a();
    } while ((localReadInJoyXListView == null) || (localList == null) || (!ReadInJoyAdUtils.a(i)));
    c();
    ...
    if (i <= m)
    {
      ...
      for (;;)
      {
        i += 1;
        break;
        paramReadInJoyBaseAdapter = (BaseArticleInfo)localList.get(i - k);
        if (AdvertisementInfo.isAdvertisementInfo(paramReadInJoyBaseAdapter)) {
          a(localReadInJoyXListView, j, m, i, (AdvertisementInfo)paramReadInJoyBaseAdapter, paramActivity);
        }
      }
    }
    a(paramActivity);
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoyAd.ad.utils.ExposureSupplementUtil
