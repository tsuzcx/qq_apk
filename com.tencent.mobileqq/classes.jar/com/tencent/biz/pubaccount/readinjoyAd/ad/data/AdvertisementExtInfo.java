  ...
  public AdvertisementExtInfo(String paramString)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        localJSONArray = paramString.optJSONArray("container_ad_item");
      ...
      {
        localObject = new AdPKImageData(localJSONArray.getJSONObject(i1));
        this.jdField_a_of_type_JavaUtilList.add(localObject);
        if (!QLog.isColorLevel()) {
          break;
        }
        QLog.d("AdvertisementExtInfo", 2, "adPKImageData = " + ((AdPKImageData)localObject).toString());
        break;
      }
