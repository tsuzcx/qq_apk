...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/biz/pubaccount/readinjoyAd/ad/common_ad_download/style/RoundProgressStyle$FastWebSoftAd;", "Lcom/tencent/biz/pubaccount/readinjoyAd/ad/common_ad_download/style/RoundProgressStyle;", "btnDrawableNormalColor", "", "getBtnDrawableNormalColor", "()Ljava/lang/String;", "setBtnDrawableNormalColor", "(Ljava/lang/String;)V", "btnDrawableNormalRadius", "", "getBtnDrawableNormalRadius", "()F", "setBtnDrawableNormalRadius", "(F)V", "btnTextColor", "getBtnTextColor", "setBtnTextColor", "btnTextSize", "getBtnTextSize", "setBtnTextSize", "pauseRectColor", "getPauseRectColor", "setPauseRectColor", "pauseRectWidth", "getPauseRectWidth", "setPauseRectWidth", "progressColorHighLight", "getProgressColorHighLight", "setProgressColorHighLight", "progressColorNormal", "getProgressColorNormal", "setProgressColorNormal", "progressHighLightWidth", "getProgressHighLightWidth", "setProgressHighLightWidth", "progressWidthNormal", "getProgressWidthNormal", "setProgressWidthNormal", "roundSize", "getRoundSize", "setRoundSize", "startAngle", "", "getStartAngle", "()I", "setStartAngle", "(I)V", "AQQLiteApp_release"}, k=1, mv={1, 1, 16})
final class RoundProgressStyle$FastWebSoftAd
  extends RoundProgressStyle
{
  @NotNull
  private String btnDrawableNormalColor = "##00cafc";
  private float btnDrawableNormalRadius = 12.0F;
  @NotNull
  private String btnTextColor = "#FF12B7F5";
  private float btnTextSize = 14.0F;
  @NotNull
  private String pauseRectColor = "#FF00CAFC";
  private float pauseRectWidth = 7.0F;
  @NotNull
  ...
  private float roundSize = 23.0F;
  private int startAngle = 270;
  
  RoundProgressStyle$FastWebSoftAd()
  {
    super(str, i, null);
  }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoyAd.ad.common_ad_download.style.RoundProgressStyle.FastWebSoftAd
