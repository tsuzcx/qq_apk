...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/biz/pubaccount/readinjoyAd/ad/common_ad_download/event/AdDownloadStateHandler$OnProgressUpdate;", "Lcom/tencent/biz/pubaccount/readinjoyAd/ad/common_ad_download/event/AdDownloadStateHandler;", "onCallBack", "", "viewRIJ", "Lcom/tencent/biz/pubaccount/readinjoyAd/ad/common_ad_download/view/RIJDownloadView;", "info", "Lcom/tencent/biz/pubaccount/readinjoyAd/ad/common_ad_download/data/AdDownloadInfo;", "AQQLiteApp_release"}, k=1, mv={1, 1, 16})
final class AdDownloadStateHandler$OnProgressUpdate
  extends AdDownloadStateHandler
{
  AdDownloadStateHandler$OnProgressUpdate()
  {
    super(str, i, null);
  }
  ...
  protected void onCallBack(@Nullable RIJDownloadView paramRIJDownloadView, @Nullable AdDownloadInfo paramAdDownloadInfo)
  {
    ...
    label159:
    label165:
    for (int i = paramAdDownloadInfo.b();; i = 0)
    {
      reportPercentIfNeed(paramAdDownloadInfo, i);
      return;
      localObject1 = null;
      break;
      localObject1 = null;
