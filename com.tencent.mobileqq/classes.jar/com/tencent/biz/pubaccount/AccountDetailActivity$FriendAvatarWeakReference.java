...
public class AccountDetailActivity$FriendAvatarWeakReference
{
  ...
  public AccountDetailActivity$FriendAvatarWeakReference(QQAppInterface paramQQAppInterface, AccountDetailActivity paramAccountDetailActivity)
  {
    ...
    this.jdField_a_of_type_Kvh = new kvh(paramAccountDetailActivity);
  }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileImageAvatar.a(this.jdField_a_of_type_Kvh);
    ...
    new kvg(this, localProfileImageInfo).execute(new Void[0]);
  }
