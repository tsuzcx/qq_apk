...
class PublicAccountSearchRecommendManager$1
  implements Runnable
{
  PublicAccountSearchRecommendManager$1(PublicAccountSearchRecommendManager paramPublicAccountSearchRecommendManager, QQAppInterface paramQQAppInterface) {}
  ...
  public void run()
  {
    ...
    if (localSharedPreferences != null) {
      try
      {
        ...
        localObject2 = PublicAccountSearchRecommendManager.a(this.this$0).iterator();
      ...
      catch (Exception localException)
      {
        if (QLog.isColorLevel()) {
          QLog.d(PublicAccountSearchRecommendManager.b(this.this$0), 2, "saveRecommendListToLocal->error:" + localException);
        }
        localException.printStackTrace();
      }
    }
    Object localObject2 = new JSONObject();
    ((JSONObject)localObject2).put("recommend_title", PublicAccountSearchRecommendManager.a(this.this$0));
    ((JSONObject)localObject2).put("recommend_cache_time", PublicAccountSearchRecommendManager.a(this.this$0));
    ((JSONObject)localObject2).put("recommend_fetch_time", PublicAccountSearchRecommendManager.b(this.this$0));
    ((JSONObject)localObject2).put("recommend_is_forbidden", PublicAccountSearchRecommendManager.a(this.this$0));
    ((JSONObject)localObject2).put("recommend_content_list", localObject1);
    Object localObject1 = ((JSONObject)localObject2).toString();
    if (QLog.isColorLevel()) {
      QLog.d(PublicAccountSearchRecommendManager.b(this.this$0), 2, "saveRecommendListToLocal->json:" + (String)localObject1);
    }
