  ...
  extends BusinessHandler
{
  ...
  PublicAccountArticleObserver jdField_a_of_type_ComTencentBizPubaccountPublicAccountArticleObserver;
  public String a;
  protected Set a;
  
  public PublicAccountArticleHandler(AppInterface paramAppInterface)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if ((!localGetArticleLikeCountRespond.ret.ret_code.has()) || (localGetArticleLikeCountRespond.ret.ret_code.get() != 0))
        {
          ...
          this.jdField_a_of_type_ComTencentBizPubaccountPublicAccountArticleObserver.a(bool, paramToServiceMsg, i);
          return;
        }
      }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((!paramFromServiceMsg.ret.ret_code.has()) || (paramFromServiceMsg.ret.ret_code.get() != 0))
        {
          ...
          this.jdField_a_of_type_ComTencentBizPubaccountPublicAccountArticleObserver.a(bool2, paramToServiceMsg, bool1);
          return;
        }
      }
      catch (Exception paramToServiceMsg)
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.jdField_a_of_type_ComTencentBizPubaccountPublicAccountArticleObserver.a(bool1, paramToServiceMsg);
        return;
      }
      catch (Exception paramToServiceMsg)
      {
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_ComTencentBizPubaccountPublicAccountArticleObserver != null) {
        this.jdField_a_of_type_ComTencentBizPubaccountPublicAccountArticleObserver.a(bool1);
      }
      return;
    }
    catch (Exception paramToServiceMsg)
  ...
  private void f(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_ComTencentBizPubaccountPublicAccountArticleObserver != null) {
        this.jdField_a_of_type_ComTencentBizPubaccountPublicAccountArticleObserver.a(bool1, i);
      }
      return;
    }
    catch (Exception paramToServiceMsg)
    ...
    for (;;)
    {
      try
      {
        ...
        if ((!paramToServiceMsg.ret.ret_code.has()) || (paramToServiceMsg.ret.ret_code.get() == 0))
        {
          ...
          if (this.jdField_a_of_type_ComTencentBizPubaccountPublicAccountArticleObserver != null) {
            this.jdField_a_of_type_ComTencentBizPubaccountPublicAccountArticleObserver.b(bool2, i);
          }
          return;
        }
      }
  ...
  private void h(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    PublicAccountImageCollectionUtils.PhotoItemInfo localPhotoItemInfo = null;
    boolean bool;
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      {
        paramFromServiceMsg.mergeFrom((byte[])paramObject);
        localPhotoCollectionInfo.jdField_a_of_type_JavaLangString = ((String)paramToServiceMsg.extraData.get(this.jdField_a_of_type_JavaLangString));
        paramToServiceMsg = localPhotoCollectionInfo.jdField_a_of_type_JavaLangString;
        if (paramFromServiceMsg.ret.has()) {
          if ((!paramFromServiceMsg.ret.ret_code.has()) || (paramFromServiceMsg.ret.ret_code.get() == 0))
          {
            bool = true;
            if (paramFromServiceMsg.article_share_url.has()) {
              localPhotoCollectionInfo.jdField_b_of_type_JavaLangString = paramFromServiceMsg.article_share_url.get().toStringUtf8();
            }
            if (paramFromServiceMsg.puin.has()) {
              localPhotoCollectionInfo.c = (paramFromServiceMsg.puin.get() + "");
            }
            if (paramFromServiceMsg.article_img_url.has()) {
              localPhotoCollectionInfo.d = paramFromServiceMsg.article_img_url.get().toStringUtf8();
            }
            if (paramFromServiceMsg.article_title.has()) {
              localPhotoCollectionInfo.e = paramFromServiceMsg.article_title.get().toStringUtf8();
            }
            if (paramFromServiceMsg.enable_comment.has()) {
              localPhotoCollectionInfo.jdField_a_of_type_Int = paramFromServiceMsg.enable_comment.get();
            }
            if (paramFromServiceMsg.comment_url.has()) {
              localPhotoCollectionInfo.f = paramFromServiceMsg.comment_url.get().toStringUtf8();
            }
            if (paramFromServiceMsg.firstItem.has())
            {
              ...
              localPhotoCollectionInfo.jdField_a_of_type_ComTencentBizPublicAccountImageCollectionPublicAccountImageCollectionUtils$PhotoFirstItemInfo.jdField_a_of_type_JavaLangString = paramFromServiceMsg.firstItem.url.get().toStringUtf8();
              localPhotoCollectionInfo.jdField_a_of_type_ComTencentBizPublicAccountImageCollectionPublicAccountImageCollectionUtils$PhotoFirstItemInfo.d = paramFromServiceMsg.firstItem.photo_author_name.get().toStringUtf8();
              localPhotoCollectionInfo.jdField_a_of_type_ComTencentBizPublicAccountImageCollectionPublicAccountImageCollectionUtils$PhotoFirstItemInfo.c = paramFromServiceMsg.firstItem.photo_time.get().toStringUtf8();
              localPhotoCollectionInfo.jdField_a_of_type_ComTencentBizPublicAccountImageCollectionPublicAccountImageCollectionUtils$PhotoFirstItemInfo.jdField_b_of_type_JavaLangString = paramFromServiceMsg.firstItem.publicaccount_name.get().toStringUtf8();
            }
            ...
            while (i < j)
            {
              localPhotoItemInfo = new PublicAccountImageCollectionUtils.PhotoItemInfo();
              localPhotoItemInfo.jdField_a_of_type_JavaLangString = ((ArticleComment.PhotoItemInfo)paramFromServiceMsg.item.get(i)).url.get().toStringUtf8();
              localPhotoItemInfo.jdField_b_of_type_JavaLangString = ((ArticleComment.PhotoItemInfo)paramFromServiceMsg.item.get(i)).content.get().toStringUtf8();
              localPhotoItemInfo.c = ((ArticleComment.PhotoItemInfo)paramFromServiceMsg.item.get(i)).static_url.get().toStringUtf8();
              localPhotoItemInfo.jdField_a_of_type_Int = ((ArticleComment.PhotoItemInfo)paramFromServiceMsg.item.get(i)).width.get();
              localPhotoItemInfo.jdField_b_of_type_Int = ((ArticleComment.PhotoItemInfo)paramFromServiceMsg.item.get(i)).height.get();
    ...
    for (;;)
    {
      ...
      break;
      label628:
      while (this.jdField_a_of_type_ComTencentBizPubaccountPublicAccountArticleObserver != null)
      {
        this.jdField_a_of_type_ComTencentBizPubaccountPublicAccountArticleObserver.a(bool, localPhotoCollectionInfo, (byte[])paramObject, paramToServiceMsg);
        return;
        bool = false;
        continue;
        bool = false;
        paramToServiceMsg = localPhotoItemInfo;
      }
    }
  }
  ...
  private void i(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      try
      {
        ...
        if ((paramFromServiceMsg.ret.has()) && (((!paramFromServiceMsg.ret.ret_code.has()) || (paramFromServiceMsg.ret.ret_code.get() != 0)) || ((paramFromServiceMsg.item.has()) && (paramFromServiceMsg.item.get().size() > 0))))
        {
          ...
          while (i < j)
          {
            paramObject = new PublicAccountImageCollectionUtils.RecommendItemInfo();
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountPublicAccountArticleObserver.a(bool, paramToServiceMsg);
  }
      ...
      try
      {
        ...
        if ((paramFromServiceMsg.uint32_ret_code.has()) && (paramFromServiceMsg.uint32_ret_code.get() == 0))
        {
          if (paramFromServiceMsg.uint32_read_count.has())
          {
            ...
            if (this.jdField_a_of_type_ComTencentBizPubaccountPublicAccountArticleObserver != null) {
              this.jdField_a_of_type_ComTencentBizPubaccountPublicAccountArticleObserver.c(bool, i);
            }
            return;
            bool = false;
            break;
  ...
  public void a(String paramString)
  {
    ...
    localObject = a("PubAccountArticleCenter.GetArticleCommentCount");
  ...
  public void a(String paramString1, String paramString2, int paramInt)
  {
    ...
    paramString1.uin.set(Long.valueOf(c()).longValue());
    paramString1.hide_name.set(paramInt);
    paramString2 = a("PubAccountArticleCenter.CreateArticleComment");
  ...
  public void a(String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    localGetPhotoCollectionInfoRequest.versionInfo.set("7.6.8,3,3615");
    ...
    paramString2 = a("PubAccountArticleCenter.PictureInfo");
  ...
  public void a(String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, String paramString4, int paramInt3, ArrayList paramArrayList)
  {
    if (QLog.isColorLevel()) {
    ...
    localReportGalleryInfoRequest.uin.set(Long.valueOf(c()).longValue());
    ...
    paramString2 = ByteStringMicro.copyFromUtf8("7.6.8");
    localReportGalleryInfoRequest.mv.set(paramString2);
    paramString2 = ByteStringMicro.copyFromUtf8("3615");
    ...
    if ((paramArrayList != null) && (paramArrayList.size() > 0) && (paramInt1 == 2))
    {
      ...
      {
        paramString3 = (PublicAccountImageCollectionUtils.RecommendItemInfo)paramString2.next();
    ...
    paramString1 = a("PubAccountArticleCenter.GalleryReport");
  ...
  public void a(String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    localArticleLikeRequest.uin.set(Long.valueOf(c()).longValue());
    if (paramBoolean1)
    {
  ...
  public void b()
  {
    this.jdField_a_of_type_ComTencentBizPubaccountPublicAccountArticleObserver = null;
  }
  ...
  public void b(String paramString)
  {
    ...
    localGetRecommendInfoRequest.versionInfo.set("7.6.8,3,3615");
  ...
  public void d(String paramString)
  {
    ...
    super.b(super.a("OidbSvc.0x6a6", 1702, 0, localReqBody.toByteArray()));
  }
  ...
  public void e(String paramString)
  {
    ...
    localCheckArticleLikeRequest.uins.add(Long.valueOf(c()));
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.PublicAccountArticleHandler
