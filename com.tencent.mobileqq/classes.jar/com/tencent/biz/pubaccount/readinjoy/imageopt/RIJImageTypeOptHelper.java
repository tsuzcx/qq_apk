...
public final class RIJImageTypeOptHelper
{
  ...
  static
  {
    jdField_a_of_type_ComTencentBizPubaccountReadinjoyImageoptRIJImageTypeOptHelper = new RIJImageTypeOptHelper();
  ...
  public final Bitmap a(@NotNull String paramString, int paramInt1, int paramInt2, @Nullable Bitmap paramBitmap)
  {
    ...
    return new RIJSharpPDecoder().a(paramString, paramInt1, paramInt2, Bitmap.Config.ARGB_8888, paramBitmap);
  }
  ...
  public final String a(@NotNull String paramString)
  {
    ...
    {
      return paramString;
      if (RIJImageOptConfig.a.f()) {
        return a(paramString, c);
      }
    } while ((!RIJImageOptConfig.a.g()) || (!QQSharpPUtil.a((Context)BaseApplicationImpl.context)));
  ...
  public final String b(@NotNull String paramString1, @NotNull String paramString2)
  {
    ...
    return str;
    label129:
    paramString1 = URLUtil.a(paramString1, "tp");
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.imageopt.RIJImageTypeOptHelper
