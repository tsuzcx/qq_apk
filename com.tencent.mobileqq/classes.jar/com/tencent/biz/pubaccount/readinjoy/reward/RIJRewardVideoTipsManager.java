...
public final class RIJRewardVideoTipsManager
{
  ...
  static
  {
    jdField_a_of_type_ComTencentBizPubaccountReadinjoyRewardRIJRewardVideoTipsManager$Companion = new RIJRewardVideoTipsManager.Companion(null);
  }
  ...
  private final void a(View paramView1, View paramView2, int paramInt1, int paramInt2, int paramInt3, Function1<? super BubblePopupWindow, Unit> paramFunction1)
  {
    ...
    {
      localObject = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoDiscoveryBubblePopupWindow;
      if ((localObject == null) || (((BubblePopupWindow)localObject).isShowing() != true)) {}
    }
    for (;;)
    {
      return;
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoDiscoveryBubblePopupWindow = new BubblePopupWindow((Context)this.jdField_a_of_type_AndroidAppActivity);
      localObject = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoDiscoveryBubblePopupWindow;
      if (localObject != null) {
        ((BubblePopupWindow)localObject).setContentView(paramView1);
      }
      paramView1 = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoDiscoveryBubblePopupWindow;
      if (paramView1 != null) {
      ...
      paramFunction1.invoke(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoDiscoveryBubblePopupWindow);
      if (ReadInJoyHelper.d())
      {
        paramView1 = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoDiscoveryBubblePopupWindow;
        if (paramView1 != null) {
          paramView1.setAnimationStyle(2131755864);
        }
        try
        {
          paramView1 = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoDiscoveryBubblePopupWindow;
      ...
      else
      {
        paramView1 = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoDiscoveryBubblePopupWindow;
        if (paramView1 != null) {
          paramView1.setAnimationStyle(2131755865);
        }
        try
        {
          paramView1 = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoDiscoveryBubblePopupWindow;
  ...
  private final void c()
  {
    ...
    e();
    Object localObject = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideofeedsShortVideoItemHolder;
    int i;
    if (localObject != null)
    {
      localObject = ((ShortVideoItemHolder)localObject).b;
      if (localObject != null)
      {
    ...
    label144:
    label149:
    for (int j = -((ReadInJoyHeadImageView)localObject).getHeight() + ViewUtils.a(5.0F);; j = -((ReadInJoyHeadImageView)localObject).getHeight() - ViewUtils.a(50.0F))
    {
  ...
  private final void d()
  {
    ...
    label130:
    label150:
    for (int j = -((ViewGroup)localObject).getHeight() + ViewUtils.a(5.0F);; j = -((ViewGroup)localObject).getHeight() - ViewUtils.a(30.0F))
    {
  ...
  private final void e()
  {
    if (this.jdField_a_of_type_AndroidWidgetTextView == null)
    {
      ...
      this.jdField_a_of_type_Int = ((int)(localTextView.getPaint().measureText(this.jdField_a_of_type_JavaLangString) + j * 2 + ViewUtils.a(6.0F)));
      this.jdField_b_of_type_Int = ((int)(localTextView.getPaint().measureText(this.jdField_b_of_type_JavaLangString) + j * 2 + ViewUtils.a(6.0F)));
  ...
  private final void f()
  {
    try
    {
      BubblePopupWindow localBubblePopupWindow = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoDiscoveryBubblePopupWindow;
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoDiscoveryBubblePopupWindow = ((BubblePopupWindow)null);
  }
  
  public final void a()
  {
    this.jdField_a_of_type_AndroidAppActivity = ((Activity)null);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRewardRIJVideoRewardCoinManager = ((RIJVideoRewardCoinManager)null);
    b();
  }
  ...
  public final void a(int paramInt)
  {
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      {
      default: 
        localObject1 = "https://kd.qpic.cn/bankjiang/images/oneCoinAnimation_1109_cb1cc6ed.mp4";
  ...
  public final void a(long paramLong1, long paramLong2, boolean paramBoolean)
  {
    ...
    if (!paramBoolean)
    {
      ...
      if (localObject != null)
      {
        ...
        {
          i = 1;
          localObject = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRewardRIJVideoRewardCoinManager;
          if (localObject == null) {
            break label149;
          }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.reward.RIJRewardVideoTipsManager
