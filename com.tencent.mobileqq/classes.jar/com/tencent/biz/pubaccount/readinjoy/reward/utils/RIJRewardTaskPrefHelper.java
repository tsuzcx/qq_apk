...
public final class RIJRewardTaskPrefHelper
{
  ...
  static
  {
    jdField_a_of_type_ComTencentBizPubaccountReadinjoyRewardUtilsRIJRewardTaskPrefHelper = new RIJRewardTaskPrefHelper();
  ...
  public static final RIJRewardTask a(@NotNull String paramString)
  {
    ...
    str3 = jdField_a_of_type_ComTencentBizPubaccountReadinjoyRewardUtilsRIJRewardTaskPrefHelper.a().getString(str3, "");
    int j = jdField_a_of_type_ComTencentBizPubaccountReadinjoyRewardUtilsRIJRewardTaskPrefHelper.a().getInt(str1, 0);
    int k = jdField_a_of_type_ComTencentBizPubaccountReadinjoyRewardUtilsRIJRewardTaskPrefHelper.a().getInt(str2, 0);
    int m = jdField_a_of_type_ComTencentBizPubaccountReadinjoyRewardUtilsRIJRewardTaskPrefHelper.a().getInt(paramString, 0);
  ...
  {
    Intrinsics.checkParameterIsNotNull(paramString, "key");
    return paramString + ReadInJoyUtils.a();
  }
  ...
  public static final void a(@NotNull String paramString, @Nullable RIJRewardTask paramRIJRewardTask)
  {
    ...
    SharedPreferences.Editor localEditor = jdField_a_of_type_ComTencentBizPubaccountReadinjoyRewardUtilsRIJRewardTaskPrefHelper.a().edit();
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.reward.utils.RIJRewardTaskPrefHelper
