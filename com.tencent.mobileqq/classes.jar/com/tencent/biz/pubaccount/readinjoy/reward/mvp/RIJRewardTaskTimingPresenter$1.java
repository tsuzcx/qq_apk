...
import com.tencent.biz.pubaccount.readinjoy.reward.RIJRewardTask.ITransaction;
  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    boolean bool1;
    if (RIJRewardTaskTimingPresenter.a(this.this$0).b() >= RIJRewardTaskConfig.b())
    {
      bool1 = true;
      label44:
    ...
    for (;;)
    {
      if (QLog.isColorLevel()) {
        QLog.d("RIJRewardTaskTimingPresenter", 2, "start timing --> taskAllCompletedToday: " + bool1 + ", overMaxTaskTime: " + bool2 + ", rowKey: " + this.jdField_a_of_type_JavaLangString + ", maxTaskTimeInMs: " + this.jdField_a_of_type_Int + ", type: " + this.b + ", timeDiff: " + RIJRewardTaskTimingPresenter.a(this.this$0));
      }
      if (RIJRewardTaskTimingPresenter.a(this.this$0, bool1, localRIJRewardTask, this.jdField_a_of_type_Int)) {
        break;
      }
      i = RIJRewardTaskTimingPresenter.a(this.this$0);
      RIJRewardTaskTimingPresenter.a(this.this$0, NetConnInfoCenter.getServerTimeMillis());
      int j = RIJRewardTaskConfig.a();
      k = RIJRewardTaskTimingPresenter.a(this.this$0).a();
      localRIJRewardTask.a().a(localRIJRewardTask.c() + i).a("RIJ_REWARD_TASK_KEY_KEY_CURRENT_TASK");
      if (!RIJRewardTaskTimingPresenter.a(this.this$0, k, j)) {
        break label309;
      }
    ...
    label309:
    RIJRewardTaskTimingPresenter.a(this.this$0).a(k + i);
    if (RIJRewardTaskTimingPresenter.a(this.this$0) != null) {
      RIJRewardTaskTimingPresenter.a(this.this$0).a(k + i);
    }
