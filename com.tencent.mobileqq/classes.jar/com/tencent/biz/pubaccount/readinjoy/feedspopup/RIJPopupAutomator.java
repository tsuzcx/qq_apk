...
public class RIJPopupAutomator
{
  ...
  void a(BasePopupStep paramBasePopupStep, boolean paramBoolean)
  {
    if (QLog.isColorLevel()) {
      QLog.d("RIJPopupAutomator", 2, "finishStep(" + paramBasePopupStep.toString() + "): isShown = " + paramBoolean);
    }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.feedspopup.RIJPopupAutomator
