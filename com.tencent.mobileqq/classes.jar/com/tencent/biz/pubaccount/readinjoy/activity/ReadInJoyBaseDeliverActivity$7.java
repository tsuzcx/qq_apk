...
final class ReadInJoyBaseDeliverActivity$7
  implements QueryTask.Query<SmallEmoticonInfo, char[]>
{
  public char[] a(SmallEmoticonInfo paramSmallEmoticonInfo)
  {
    try
    {
      ...
      {
        localObject = ((EmoticonManager)((AppRuntime)localObject).getManager(QQManagerFactory.EMOTICON_MANAGER)).a(String.valueOf(j));
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.activity.ReadInJoyBaseDeliverActivity.7
