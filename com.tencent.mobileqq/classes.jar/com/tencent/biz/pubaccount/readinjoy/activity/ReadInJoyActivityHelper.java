...
import com.tencent.biz.pubaccount.readinjoy.common.RIJNumericUtils;
...
public class ReadInJoyActivityHelper
{
  ...
  private static String a(String paramString1, String paramString2)
  {
    ...
    paramString1 = PreLoader.a().a(paramString2);
    return paramString1;
  }
  ...
  private static void a(Activity paramActivity, HashMap<String, String> paramHashMap)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        boolean bool = "nativeArticleRecommend".equalsIgnoreCase((String)localObject);
        if (!bool) {
          continue;
        }
        i = 10;
      ...
      catch (Exception localException)
      {
        ...
        QLog.e("ReadInJoyActivityHelper", 2, "openEmptyFullPlayActivity: ", localException);
        i = j;
        continue;
        i = -1;
        continue;
      ...
      ((Bundle)localObject).putBoolean("VIDEO_ENTER_FROM_KD_TAB", "1".equals(paramHashMap.get("enter_from_kdtab")));
      VideoFeedsHelper.a(paramActivity, (Bundle)localObject, str, i);
      return;
  ...
  {
    if (paramContext == null) {}
    while (PTSHelper.a(paramContext)) {
      return;
    }
  ...
  public static void a(Context paramContext, int paramInt1, String paramString, int paramInt2, int paramInt3, Map<String, Object> paramMap, boolean paramBoolean)
  {
    ...
    default: 
      ...
      if ((paramContext instanceof Activity)) {
        ((Activity)paramContext).overridePendingTransition(2130771983, 0);
      }
      return;
    }
    paramMap = new Intent();
  ...
  public static void a(Context paramContext, ArticleInfo paramArticleInfo1, ArticleInfo paramArticleInfo2, boolean paramBoolean)
  {
    ...
    localIntent.putExtra("channel_name", HardCodeUtil.a(2131712979));
    ...
    if (paramArticleInfo1 != paramArticleInfo2)
    {
      ...
      if (RIJItemViewType.q(paramArticleInfo2)) {
        break label215;
      }
    }
    label215:
  ...
  public static void a(Context paramContext, String paramString, int paramInt)
  {
    ...
    //   9: ifne +189 -> 198
    //   12: new 555	org/json/JSONObject
    //   15: dup
    //   16: aload_1
    //   17: invokespecial 558	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   20: ldc_w 560
    //   23: iconst_m1
    //   24: invokevirtual 563	org/json/JSONObject:optInt	(Ljava/lang/String;I)I
    //   27: i2l
    //   28: lstore_3
    //   29: new 76	java/util/HashMap
    //   32: dup
    //   33: invokespecial 564	java/util/HashMap:<init>	()V
    //   36: astore 5
    //   38: lload_3
    //   39: ldc2_w 565
    //   42: lcmp
    ...
    //   48: ldc 94
    //   50: lload_3
    //   51: invokestatic 569	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   54: invokeinterface 570 3 0
    //   59: pop
    //   60: aload 5
    //   62: ldc_w 572
    //   65: aload_1
    //   66: invokeinterface 570 3 0
    //   71: pop
    //   72: ldc 2
    //   74: invokevirtual 577	java/lang/Class:getSimpleName	()Ljava/lang/String;
    //   77: iconst_1
    ...
    //   91: lload_3
    //   92: invokevirtual 582	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   95: ldc_w 584
    ...
    //   113: astore_1
    //   114: ldc_w 586
    //   117: invokestatic 592	com/tencent/mobileqq/qroute/QRoute:api	(Ljava/lang/Class;)Lcom/tencent/mobileqq/qroute/QRouteApi;
    //   120: checkcast 586	com/tencent/biz/pubaccount/api/IPublicAccountReportUtils
    //   123: aconst_null
    //   124: ldc_w 594
    //   127: ldc_w 596
    //   130: ldc_w 596
    ...
    //   141: ldc_w 596
    //   144: iload_2
    //   145: invokestatic 600	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   148: ldc_w 596
    //   151: invokestatic 604	com/tencent/biz/pubaccount/readinjoy/activity/ReadInJoyBaseDeliverActivity:a	()Ljava/lang/String;
    //   154: iconst_0
    //   155: invokeinterface 608 14 0
    //   160: aload_0
    //   161: ldc_w 609
    //   164: getstatic 613	com/tencent/biz/pubaccount/readinjoy/common/ReadInJoyConstants:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   167: iconst_0
    //   168: iload_2
    //   169: aload_1
    //   170: invokestatic 446	com/tencent/biz/pubaccount/readinjoy/activity/ReadInJoyActivityHelper:a	(Landroid/content/Context;ILjava/lang/String;IILjava/util/Map;)V
    //   173: return
    //   174: astore 5
    //   176: aconst_null
    //   177: astore_1
    //   178: aload 5
    //   180: invokevirtual 614	org/json/JSONException:printStackTrace	()V
    //   183: goto -69 -> 114
    //   186: astore 6
    //   188: aload 5
    //   190: astore_1
    ...
    //   174	15	5	localJSONException1	org.json.JSONException
    //   193	1	5	localObject	Object
    //   186	6	6	localJSONException2	org.json.JSONException
    // Exception table:
    //   from	to	target	type
    //   12	38	174	org/json/JSONException
    //   46	60	186	org/json/JSONException
    //   60	111	186	org/json/JSONException
  }
  ...
  public static void a(Context paramContext, String paramString1, int paramInt, String paramString2, boolean paramBoolean)
  {
    ...
    paramString1 = new ReadInJoyActivityHelper.1(new WeakReference(paramContext), paramBoolean, paramString2, paramString1);
    jdField_a_of_type_Int = TeleScreen.a().a(paramString1);
  ...
  public static void a(Context paramContext, HashMap<String, String> paramHashMap)
  {
    ...
    {
      boolean bool2 = PackageUtil.a(paramContext, str1);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt1, int paramInt2, Bundle paramBundle)
  {
    ...
    for (localIntent = new Intent(paramContext, ReadInJoySettingActivity.class);; localIntent = a(paramContext, paramInt1))
    {
      ...
      paramContext.startActivity(localIntent);
      if ((paramInt2 == 0) && (!ReadInJoyHelper.o())) {
  ...
  private static void a(HashMap<String, String> paramHashMap, Bundle paramBundle)
  {
    ...
    {
      QLog.e("ReadInJoyActivityHelper", 1, "parse videoinfo error = ", paramHashMap);
    }
  }
  ...
  public static Intent b(Context paramContext, int paramInt1, int paramInt2)
  {
    ...
    localIntent2.putExtra("tab_index", FrameControllerUtil.h);
    ...
    {
      ReadinjoyJumpUtils.a(localIntent2);
  ...
  public static Intent b(Context paramContext, HashMap<String, String> paramHashMap)
  {
    ...
    try
    {
      ...
      if (TextUtils.isEmpty(paramContext))
      {
        ...
        if (str2 != null) {
          localArticleInfo.mArticleContentUrl = new String(Base64Util.decode(str2, 0));
        }
        if (localObject != null) {
  ...
  public static void b(Context paramContext, HashMap<String, String> paramHashMap)
  {
    ...
    String str2 = (String)paramHashMap.get("articleContentUrl");
    ...
    for (str1 = "#" + str1;; str1 = null)
    {
      ...
      Bundle localBundle = new Bundle();
      localBundle.putBoolean("FLAG_ACTIVITY_NEW_TASK", "1".equals(paramHashMap.get("isNewTask")));
      if ("1".equals(paramHashMap.get("showComment"))) {
        localBundle.putBoolean("VIDEO_SHOW_COMMENT", true);
      }
      if (!TextUtils.isEmpty(str28))
      {
        AnchorData localAnchorData = new AnchorData();
        localAnchorData.jdField_a_of_type_JavaLangString = str28;
        localAnchorData.jdField_b_of_type_JavaLangString = str29;
        localAnchorData.jdField_a_of_type_Boolean = "1".equals(str30);
        localAnchorData.jdField_b_of_type_Boolean = "0".equals(str31);
        localBundle.putBoolean("VIDEO_SHOW_COMMENT", true);
        localBundle.putParcelable("VIDEO_COMMENT_ANCHOR", localAnchorData);
      }
      localBundle.putBoolean("VIDEO_ENTER_FROM_KD_TAB", "1".equals(paramHashMap.get("enter_from_kdtab")));
      if (str2 != null) {}
      label984:
      label989:
      for (;;)
      {
        try
        {
          ...
          str3 = URLDecoder.decode(str3, "utf-8");
          int j = RIJNumericUtils.a(str5, 0);
          int k = RIJNumericUtils.a(str7, 0);
          int m = RIJNumericUtils.a(str8, 0);
          int n = RIJNumericUtils.a(str9, 0);
          ...
          {
            i = 10;
            RIJNumericUtils.b(localBundle, "VIDEO_STRATEGY_ID", str14);
            RIJNumericUtils.a(localBundle, "VIDEO_ALGORITHM_ID", str15);
            RIJNumericUtils.b(localBundle, "REPORT_VIDEO_FEEDS_CHANNEL_ID", str16);
            RIJNumericUtils.a(localBundle, "VIDEO_PLAY_POSITION", str17);
            ...
            RIJNumericUtils.b(localBundle, "VIDEO_COLUMN_ID", str20);
            if (i == 31) {
            ...
            a(paramHashMap, localBundle);
            localBundle.putString("FIRST_VIDEO_TOKEN", str21);
            VideoFeedsHelper.a((Activity)paramContext, localBundle, i, str4, j, str6, k, m, n, str10, str3, str2, str12, str11, 0L, false, 0L, 0, null, null, null, null, null);
            return;
          }
        }
        catch (Exception paramContext)
  ...
  public static void c(Context paramContext, HashMap<String, String> paramHashMap)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (!TextUtils.isEmpty(paramContext)) {
          ReadInJoyHelper.a("DAILY_CHILD_FEEDS_REQUEST_CONFIG" + str1, paramContext);
        }
