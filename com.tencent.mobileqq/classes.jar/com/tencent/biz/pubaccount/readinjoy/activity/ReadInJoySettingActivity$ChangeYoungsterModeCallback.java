  ...
  extends ProtoUtils.TroopProtocolObserver
{
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    try
    {
      QQToast.a(this.a.getApplicationContext(), 2131718465, 0).a();
    ...
    if ((paramBundle.msg_set_flag_info_rsp.has()) && (paramBundle.msg_set_flag_info_rsp.rpt_msg_flag_info_list.has()))
    {
      ...
      if ((this.b) && (j == 1))
      {
        QQToast.a(this.a.getApplicationContext(), 2131718467, 0).a();
      ...
      if ((!this.b) && (j == 0))
      {
        QQToast.a(this.a.getApplicationContext(), 2131718466, 0).a();
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.activity.ReadInJoySettingActivity.ChangeYoungsterModeCallback
