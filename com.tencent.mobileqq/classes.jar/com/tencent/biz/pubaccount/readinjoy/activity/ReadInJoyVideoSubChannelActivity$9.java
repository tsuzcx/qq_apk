    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.a.mIsTopic)
        {
          ...
          olh.a(null, "", str1, (String)localObject, 0, 0, "2", "", "", omx.a(this.a.mChannelID, localJSONObject), false);
          return;
        }
      ...
      for (;;)
      {
        try
        {
          ...
          if (this.a.mIsFollowed)
          {
            ...
            olh.a(null, "", "0X80088BB", "0X80088BB", 0, 0, "3", "", "", omx.a(this.a.mChannelID, (JSONObject)localObject), false);
            return;
          }
        }
