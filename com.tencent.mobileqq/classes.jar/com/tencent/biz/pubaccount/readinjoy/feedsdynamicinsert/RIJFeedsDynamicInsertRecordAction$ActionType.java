...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/biz/pubaccount/readinjoy/feedsdynamicinsert/RIJFeedsDynamicInsertRecordAction$ActionType;", "", "actionType", "", "(Ljava/lang/String;II)V", "getActionType", "()I", "toPBInt", "ACTION_ENTER", "ACTION_NONE", "ACTION_FOLLOW", "ACTION_LOVE", "ACTION_SEE_LATER", "ACTION_SHARE", "ACTION_VIDEO_PLAY_PROGRESS", "ACTION_ARTICLE_READ_PROGRESS", "ACTION_DATA_CARD_FOLLOW", "Companion", "AQQLiteApp_release"}, k=1, mv={1, 1, 16})
public enum RIJFeedsDynamicInsertRecordAction$ActionType
{
  public static final RIJFeedsDynamicInsertRecordAction.ActionType.Companion Companion = new RIJFeedsDynamicInsertRecordAction.ActionType.Companion(null);
  ...
  private RIJFeedsDynamicInsertRecordAction$ActionType(int paramInt)
  {
  ...
  {
    switch (RIJFeedsDynamicInsertRecordAction.ActionType.WhenMappings.a[ordinal()])
    {
    default: 
      return 0;
    case 1: 
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.feedsdynamicinsert.RIJFeedsDynamicInsertRecordAction.ActionType
