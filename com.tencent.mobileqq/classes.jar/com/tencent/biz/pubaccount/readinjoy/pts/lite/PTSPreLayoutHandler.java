  ...
  public static void a(List<? extends BaseArticleInfo> paramList)
  {
    ...
    for (;;)
    {
      ...
      while (paramList.hasNext())
      {
        ...
        if (!PTSLiteItemViewBuilder.a(localBaseArticleInfo))
        {
        ...
        else
        {
          ...
          String str2 = PTSStyleManager.a().a("default_feeds", str1);
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.pts.lite.PTSPreLayoutHandler
