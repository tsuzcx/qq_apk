...
public class PTSJSCLoader$2
  implements Runnable
{
  public PTSJSCLoader$2(qgw paramqgw, Runnable paramRunnable) {}
  ...
  public void run()
  {
    ...
    {
      return;
      String str = qgw.a(this.this$0) + "/" + "libjsc.so";
      ...
      catch (Throwable localThrowable)
      {
        ...
        qhy.a(localThrowable.toString(), "1");
        return;
      }
    }
