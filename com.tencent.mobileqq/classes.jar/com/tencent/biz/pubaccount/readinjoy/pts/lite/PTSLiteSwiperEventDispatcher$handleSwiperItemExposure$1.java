...
public final class PTSLiteSwiperEventDispatcher$handleSwiperItemExposure$1
  implements Runnable
{
  public PTSLiteSwiperEventDispatcher$handleSwiperItemExposure$1(qnz paramqnz, String paramString1, String paramString2, HashMap paramHashMap) {}
  ...
  public final void run()
  {
    ...
    ArticleInfo localArticleInfo = (ArticleInfo)((Map)qnz.a(this.this$0)).get(this.jdField_a_of_type_JavaLangString);
    ...
    Object localObject2 = qnz.a(this.this$0, (int)l1);
    ...
    if (localArticleInfo.hasChannelInfo())
    {
      ...
      localObject3 = pha.d((BaseArticleInfo)localArticleInfo);
      String str2 = localArticleInfo.mStrCircleId;
      String str3 = localArticleInfo.innerUniqueID;
      String str4 = pha.f((BaseArticleInfo)localArticleInfo);
      ...
      localObject2 = pha.a(l2, k, m, i, j, bool, (String)localObject3, str2, str3, str4, localArticleInfo, l3, ((Integer)localObject2).intValue(), pha.d(), pha.e(), 0, false, localArticleInfo.mVideoAdsJumpType, localArticleInfo.mVideoAdsSource, ReadInJoyBaseFragment.a((int)l1));
    }
    for (;;)
    {
      try
      {
        ...
        ((JSONObject)localObject3).put("is_change", pig.a(pha.a(), (int)l1));
        localObject1 = qnz.a(this.this$0);
        if (localObject1 == null) {
          continue;
        }
        localObject1 = ((snh)localObject1).a();
        if (localObject1 == null) {
          continue;
        }
      ...
      if ((!pil.a((int)l1)) && (!bmqa.a(l1))) {
        continue;
      }
      localObject1 = "0X8009CC8";
      localObject2 = qpm.a((String)localObject2, this.jdField_a_of_type_JavaUtilHashMap);
      oat.a(null, localArticleInfo.mSubscribeID, (String)localObject1, (String)localObject1, 0, 0, String.valueOf(localArticleInfo.mFeedId), String.valueOf(localArticleInfo.mArticleID), String.valueOf(localArticleInfo.mStrategyId), (String)localObject2, false);
