...
class KandianMergeManager$36
  implements Runnable
{
  KandianMergeManager$36(KandianMergeManager paramKandianMergeManager, MySelfNormalItemRedPointInfo paramMySelfNormalItemRedPointInfo) {}
  
  public void run()
  {
    SharedPreferences.Editor localEditor = bhvy.a(KandianMergeManager.a(this.this$0), true, false).edit();
