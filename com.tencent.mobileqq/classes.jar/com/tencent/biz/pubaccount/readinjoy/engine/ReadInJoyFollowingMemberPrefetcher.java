  ...
  extends ReadInJoyObserver
{
  ...
  private WeakReference<FollowListInfoModule> jdField_b_of_type_JavaLangRefWeakReference;
  ...
  public ReadInJoyFollowingMemberPrefetcher(AppInterface paramAppInterface, FollowListInfoModule paramFollowListInfoModule)
  {
    ...
    this.jdField_b_of_type_JavaLangRefWeakReference = new WeakReference(paramFollowListInfoModule);
  ...
  private void a(List<FollowingMember> paramList, boolean paramBoolean)
  {
    ...
    {
      return;
      paramList = (FollowListInfoModule)this.jdField_b_of_type_JavaLangRefWeakReference.get();
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.engine.ReadInJoyFollowingMemberPrefetcher
