  ...
  implements Comparable<ArticleExposureInfoForReport>
{
  ...
  {
    if (paramArticleExposureInfoForReport.jdField_a_of_type_Long > this.jdField_a_of_type_Long) {
      return 1;
    }
    if (paramArticleExposureInfoForReport.jdField_a_of_type_Long == this.jdField_a_of_type_Long) {
      return 0;
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.engine.ReadinjoySPEventReport.ArticleExposureInfoForReport
