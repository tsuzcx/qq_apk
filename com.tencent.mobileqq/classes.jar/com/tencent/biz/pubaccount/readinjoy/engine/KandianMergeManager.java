  ...
  implements Manager
{
  ...
  private FriendListObserver jdField_a_of_type_ComTencentMobileqqAppFriendListObserver = new lly(this);
  ...
  public static int a(MessageRecord paramMessageRecord, QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      {
        return -1;
      } while (((paramMessageRecord.extInt == 3) || (paramMessageRecord.extInt == 4)) && (TextUtils.equals(paramMessageRecord.frienduin, AppConstants.as)));
      if ((paramMessageRecord.extInt == 1) && (TextUtils.equals(paramMessageRecord.frienduin, AppConstants.as))) {
        return 0;
      }
      if ((paramMessageRecord.extInt == 2) && (TextUtils.equals(paramMessageRecord.frienduin, AppConstants.as))) {
        return 1;
      }
      if (TextUtils.equals(paramMessageRecord.frienduin, AppConstants.ar)) {
        return 0;
      }
  ...
  private MessageRecord a(String paramString1, String paramString2, long paramLong1, long paramLong2, long paramLong3, long paramLong4, long paramLong5)
  {
    MessageRecord localMessageRecord = MessageRecordFactory.a(-1000);
    localMessageRecord.selfuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c();
    localMessageRecord.frienduin = AppConstants.as;
    localMessageRecord.senderuin = AppConstants.ar;
  ...
  {
    MessageRecord localMessageRecord = MessageRecordFactory.a(-1000);
    boolean bool = ReadInJoyHelper.j();
    localMessageRecord.selfuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c();
    localMessageRecord.frienduin = AppConstants.as;
    localMessageRecord.senderuin = AppConstants.ar;
    localMessageRecord.istroop = 7220;
  ...
  private void a(KandianOx210MsgInfo paramKandianOx210MsgInfo, long paramLong)
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructKandianOx210MsgInfo.jdField_d_of_type_Int == 1)
    {
      ...
      if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructKandianOx210MsgInfo.f == 0) {
        bool1 = true;
      }
    }
  ...
  private void a(MessageRecord paramMessageRecord, String paramString1, String paramString2, int paramInt)
  {
    ...
    paramMessageRecord.frienduin = AppConstants.as;
    paramMessageRecord.senderuin = AppConstants.as;
  ...
  {
    return (KandianOx210MsgInfo.c(paramArrayOfByte) != 2) && (KandianOx210MsgInfo.a(paramArrayOfByte) == KandianOx210MsgInfo.j) && (KandianOx210MsgInfo.b(paramArrayOfByte) == KandianOx210MsgInfo.m);
  }
  ...
  private void b(KandianOx210MsgInfo paramKandianOx210MsgInfo, long paramLong)
  {
    ...
    if (this.jdField_b_of_type_ComTencentBizPubaccountReadinjoyStructKandianOx210MsgInfo.jdField_d_of_type_Int == 1)
    {
      ...
      if (this.jdField_b_of_type_ComTencentBizPubaccountReadinjoyStructKandianOx210MsgInfo.f == 0) {
        bool1 = true;
      }
    }
  ...
  private void q()
  {
    ThreadManager.post(new llx(this), 8, null, false);
  }
  ...
  private void r()
  {
    ...
    Object localObject2;
    if (this.jdField_c_of_type_ComTencentBizPubaccountReadinjoyStructKandianOx210MsgInfo.jdField_d_of_type_Int == 1)
    {
      ...
      if (this.jdField_c_of_type_ComTencentBizPubaccountReadinjoyStructKandianOx210MsgInfo.f == 0)
      {
        bool1 = true;
  ...
  {
    Object localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(AppConstants.as, 7220);
    ...
    for (;;)
    {
      ...
      if (localMessageRecord == null) {
        localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(AppConstants.as, 7220, "extInt=1 OR extInt=3");
      }
      return localObject;
  ...
  public MessageRecord a(MessageRecord paramMessageRecord)
  {
    ...
    label836:
    label866:
    for (Object localObject1 = localQQMessageFacade.b(AppConstants.as, 7220);; localObject1 = null)
    {
      String str;
      Object localObject2;
      if ((localObject1 != null) && (a(paramMessageRecord, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) == 1) && (((MessageRecord)localObject1).extInt == 2) && (!((MessageRecord)localObject1).isread)) {
        if (QLog.isColorLevel())
        {
          str = "lastMr_info 【" + "msg: " + ReadInJoyUtils.c(((MessageRecord)localObject1).msg) + ", msguid : " + ((MessageRecord)localObject1).msgUid;
          localObject2 = str;
          if ((localObject1 instanceof MessageForStructing))
          {
            ...
            if (localMessageForStructing.structingMsg != null) {
              localObject2 = str + ", title : " + ReadInJoyUtils.c(localMessageForStructing.structingMsg.mMsgBrief) + " 】";
            }
          }
          str = "newMr_info 【" + "msg: " + ReadInJoyUtils.c(paramMessageRecord.msg) + ", senderUin : " + paramMessageRecord.senderuin + " , msguid : " + paramMessageRecord.msgUid;
          ...
          str = str + ", title : " + ReadInJoyUtils.c(localMessageForStructing.structingMsg.mMsgBrief) + " 】";
        }
      }
      int i;
      label616:
      ...
      for (;;)
      {
        ...
        ((MessageRecord)localObject2).frienduin = AppConstants.as;
  ...
  public MessageRecord a(String paramString)
  {
    ...
    localMessageForStructing.frienduin = AppConstants.as;
  ...
  public void a()
  {
    ...
    do
    {
      ...
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(AppConstants.as, 7220);
      if (localObject1 == null) {
        break label288;
      }
    ...
    if (localObject1 == null) {
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131428458);
    }
    for (;;)
    {
      Object localObject2 = localObject1;
      if (TextUtils.isEmpty((CharSequence)localObject1)) {
        localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131428458);
      }
  ...
  public void a(int paramInt)
  {
    ...
    ThreadManager.post(new llm(this, paramInt), 8, null, false);
  }
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    {
      paramMessageRecord.isread = true;
      ThreadManager.post(new lmb(this, paramMessageRecord), 10, null, false);
    }
  }
  ...
  public void a(String paramString1, String paramString2, int paramInt, boolean paramBoolean)
  {
    ...
    ThreadManager.post(new llz(this, localQQMessageFacade, paramString1, paramString2, paramInt, paramBoolean), 10, null, false);
  }
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (localRecentUser == null)
    {
      ...
      ((RecentUser)localObject).uin = AppConstants.as;
  ...
  public void a(byte[] paramArrayOfByte)
  {
    try
    {
      ...
      else if ((localMsgBody.msg_notify_infos.has()) && (localMsgBody.msg_notify_infos.get() != null) && (((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.has()) && (((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.get() != null) && (((submsgtype0xc5.StyleSheet)((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.get()).msg_biu_body.has()) && (((submsgtype0xc5.StyleSheet)((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.get()).msg_biu_body.get() != null) && (((submsgtype0xc5.BiuBody)((submsgtype0xc5.StyleSheet)((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.get()).msg_biu_body.get()).uint64_biu_uin.has()))
      {
        ...
        a(null, KandianOx210MsgInfo.k, null);
        return;
      }
    }
          ...
          do
          {
            do
            {
              do
              {
                ...
                if (paramArrayOfByte.jdField_d_of_type_Int != 1) {
                  break;
                }
                if (QLog.isColorLevel()) {
                ...
                if ((this.jdField_d_of_type_ComTencentBizPubaccountReadinjoyStructKandianOx210MsgInfo == null) || (paramArrayOfByte.jdField_b_of_type_Long > this.jdField_d_of_type_ComTencentBizPubaccountReadinjoyStructKandianOx210MsgInfo.jdField_b_of_type_Long))
                {
                  ...
                  for (boolean bool1 = true;; bool1 = false)
                  {
                    ...
                    QLog.d("KandianMergeManager", 1, bool1 + ", redType : " + this.jdField_c_of_type_ComTencentBizPubaccountReadinjoyStructKandianOx210MsgInfo.f + ", msgSeq : " + this.jdField_c_of_type_ComTencentBizPubaccountReadinjoyStructKandianOx210MsgInfo.jdField_b_of_type_Long + ", orangeWord : " + this.jdField_c_of_type_ComTencentBizPubaccountReadinjoyStructKandianOx210MsgInfo.jdField_a_of_type_JavaLangString + ", msgCount : " + this.jdField_c_of_type_ComTencentBizPubaccountReadinjoyStructKandianOx210MsgInfo.jdField_a_of_type_Int);
                    a((MessageRecord)localObject, KandianOx210MsgInfo.k, null);
                    return;
                    bool1 = false;
                    break;
                  }
  ...
  public boolean a()
  {
    ...
    {
      return false;
      QLog.d("KandianMergeManager", 1, "SubUnread : " + this.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() + ", SubStatus : " + this.jdField_c_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() + ", mSubTitle : " + ReadInJoyUtils.c(this.f) + ", KDUnread : " + this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get());
  ...
  public boolean a(int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      {
        if (b(1) > 0) {
          ThreadManager.getSubThreadHandler().post(new lls(this));
        }
        d(1);
        return true;
      }
      ...
      {
        if (b(1) > 0) {
          ThreadManager.getSubThreadHandler().post(new llt(this));
        }
        d(1);
        return true;
      }
        ...
        if (l > this.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicLong.get())
        {
          if (!paramBoolean)
          {
            ...
            if (PublicAccountUtil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str, paramMessageRecord.msgtype))
            {
              ...
              ThreadManager.getSubThreadHandler().post(new lmc(this, l, str, 1, (String)localObject1, j));
  ...
  public MessageRecord b()
  {
    ...
    for (;;)
    {
      localObject = localMessageRecord;
      if (localMessageRecord == null) {
        localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(AppConstants.as, 7220, "extInt=1");
      }
      return localObject;
      localMessageRecord = null;
    }
  ...
  public void b()
  {
    ...
    if ((localMessageRecord != null) && (!localMessageRecord.isread))
    {
      ...
      ThreadManager.post(new lma(this, localMessageRecord), 10, null, false);
    }
  }
  ...
  public boolean b(MessageRecord paramMessageRecord)
  {
    ...
    if (l > this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicLong.get())
    {
      this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicLong.set(l);
      this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(1);
      ThreadManager.getSubThreadHandler().post(new lmf(this, paramMessageRecord, l));
  ...
  public void c()
  {
    try
    {
      ...
      this.jdField_e_of_type_JavaLangString = "";
      this.jdField_c_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(-1);
      ThreadManager.getSubThreadHandler().post(new lme(this));
      return;
    }
    finally
    {
  ...
  public void c(int paramInt)
  {
    ...
    //   11: invokevirtual 563	java/util/concurrent/atomic/AtomicInteger:get	()I
    //   14: iconst_2
    //   15: if_icmpne +10 -> 25
    //   18: aload_0
    //   19: invokevirtual 903	com/tencent/biz/pubaccount/readinjoy/engine/KandianMergeManager:c	()V
    //   22: aload_0
    //   23: monitorexit
    //   24: return
    //   25: aload_0
    ...
    //   29: iconst_0
    //   30: invokevirtual 530	java/util/concurrent/atomic/AtomicInteger:set	(I)V
    //   33: aload_0
    ...
    //   37: iload_1
    //   38: invokevirtual 530	java/util/concurrent/atomic/AtomicInteger:set	(I)V
    //   41: invokestatic 1216	com/tencent/mobileqq/app/ThreadManager:getSubThreadHandler	()Lmqq/os/MqqHandler;
    //   44: new 1427	lmd
    //   47: dup
    //   48: aload_0
    //   49: iload_1
    //   50: invokespecial 1428	lmd:<init>	(Lcom/tencent/biz/pubaccount/readinjoy/engine/KandianMergeManager;I)V
    //   53: invokevirtual 1222	mqq/os/MqqHandler:post	(Ljava/lang/Runnable;)Z
    //   56: pop
    //   57: goto -35 -> 22
    //   60: astore_2
    //   61: aload_0
  ...
  public boolean c()
  {
    RecentUser localRecentUser = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().b(AppConstants.as, 7220);
    if (localRecentUser == null) {
      ...
      try
      {
        if ((paramMessageRecord instanceof MessageForStructing))
        {
          ...
          if (paramMessageRecord.time > this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicLong.get())
          {
            ...
            ThreadManager.getSubThreadHandler().post(new lln(this, (String)localObject, l));
            if ((this.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() > 0) && (this.jdField_c_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() != 2))
            {
              c(2);
              if (!QLog.isColorLevel()) {
  ...
  public void d()
  {
    try
    {
      ...
      ThreadManager.getSubThreadHandler().post(new llo(this));
      return;
    }
    finally {}
  }
  ...
  public boolean d()
  {
    return (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructKandianOx210MsgInfo != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructKandianOx210MsgInfo.jdField_d_of_type_Int == 1) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructKandianOx210MsgInfo.jdField_e_of_type_Int == 1);
  }
  ...
  public void e()
  {
    ...
    for (int i = 7220;; i = 1008)
    {
      if ((localConversationFacade != null) && (localConversationFacade.a(str, i) > 0)) {
        ThreadManager.post(new llp(this, str, i), 8, null, false);
      }
      return;
      str = AppConstants.ar;
    }
  ...
  public KandianOx210MsgInfo f()
  {
    ...
    localKandianOx210MsgInfo.jdField_a_of_type_Int = e();
  ...
  public void g()
  {
    ...
    localNewIntent.setObserver(new llq(this));
  ...
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyEngineKandianMergeManager$KandianSetTopInfo != null) {
      ThreadManager.executeOnSubThread(new llr(this));
    }
  }
  ...
  public void i()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(AppConstants.as, 7220, ((MessageRecord)localObject).uniseq, "time", Long.valueOf(l));
  ...
  public void l()
  {
    ThreadManager.getUIHandler().post(new llv(this));
  }
  ...
  public void o()
  {
    ThreadManager.executeOnSubThread(new llw(this));
  }
