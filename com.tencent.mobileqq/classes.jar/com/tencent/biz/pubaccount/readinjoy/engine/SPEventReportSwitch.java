...
public class SPEventReportSwitch
{
  ...
  public static int a()
  {
    if (e == -1)
    {
      SharedPreferences localSharedPreferences = bnrf.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), true, true);
  ...
  public static void a(List<oidb_cmd0x80a.ReportConditionParam> paramList)
  {
    ...
    for (int i1 = 1;; i1 = 0)
    {
      ...
      for (;;)
      {
        ...
        ozs.a("idle_high_frequency_report_condition", jdField_a_of_type_JavaUtilHashMap, true);
        return;
        i4 = 0;
        break label292;
        break label174;
