    ...
    if (ReadinjoySPEventReport.b(24))
    {
      ...
      for (;;)
      {
        try
        {
          ...
          localObject1 = (View)((MainFragment)localObject2).a().get(FrameControllerUtil.a + "_num");
        ...
        ((IPublicAccountUtil)QRoute.api(IPublicAccountUtil.class)).reportPushEffectEvent(24, localArrayList);
        return;
