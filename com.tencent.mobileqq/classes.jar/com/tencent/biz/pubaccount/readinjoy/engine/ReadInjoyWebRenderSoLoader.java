...
public class ReadInjoyWebRenderSoLoader
{
  ...
  {
    SharedPreferences localSharedPreferences = ReadInJoyHelper.a(ReadInJoyUtils.a(), true, true);
  ...
  public static boolean a(ReadInJoyWebRenderEngine.LoadLibCallback paramLoadLibCallback)
  {
    if (a()) {
      return true;
    }
  ...
  public static boolean a(String paramString)
  {
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      ...
      try
      {
        ...
        FileUtils.a(paramString, c, false);
