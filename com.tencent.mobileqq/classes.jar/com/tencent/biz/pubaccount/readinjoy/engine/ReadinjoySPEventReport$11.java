...
public class ReadinjoySPEventReport$11
  implements Runnable
{
  public ReadinjoySPEventReport$11(pwb parampwb, String paramString, long paramLong) {}
  ...
  public void run()
  {
    ...
    localAttributeList2.att_value.set(String.valueOf(pwb.a(this.jdField_a_of_type_Long) / 1000L));
    localArrayList.add(localAttributeList1);
    localArrayList.add(localAttributeList2);
    uuc.a(21, localArrayList);
  }
}
