...
public class ReadinjoySPEventReport$11
  implements Runnable
{
  public ReadinjoySPEventReport$11(pmy parampmy, String paramString, long paramLong) {}
  ...
  public void run()
  {
    ...
    localAttributeList2.att_value.set(String.valueOf(pmy.a(this.jdField_a_of_type_Long) / 1000L));
    localArrayList.add(localAttributeList1);
    localArrayList.add(localAttributeList2);
    tzo.a(21, localArrayList);
  }
}
