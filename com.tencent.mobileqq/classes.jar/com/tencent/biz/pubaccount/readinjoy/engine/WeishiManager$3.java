...
public class WeishiManager$3
  implements Runnable
{
  public WeishiManager$3(otp paramotp, String paramString1, long paramLong, QQMessageFacade paramQQMessageFacade, String paramString2, Map paramMap) {}
  
  public void run()
  {
    Object localObject = this.this$0.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long);
    if (localObject != null) {
      this.jdField_a_of_type_ComTencentMobileqqAppMessageQQMessageFacade.a((MessageRecord)localObject, otp.a(this.this$0).c());
    }
    sni.jdField_a_of_type_JavaLangString = this.b;
    sne.a("WSAioLog", "saveLastFeedInfo feedId:" + this.b + ", title:" + this.jdField_a_of_type_JavaLangString);
    try
    {
      long l = Long.parseLong(otp.a(this.this$0).getCurrentAccountUin());
      localObject = PreferenceManager.getDefaultPreference(otp.a(this.this$0).getApplication(), l).edit();
      ...
      if (this.jdField_a_of_type_JavaUtilMap.containsKey(Integer.valueOf(1)))
      {
        ...
        {
          bbdj.a((byte[])this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(1)), this.this$0.b(), false);
          Log.i("weishi-report", "save map passback length:" + ((byte[])this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(1))).length);
          Log.d("weishi-report", "save map passback:" + sni.a((byte[])this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(1))));
        }
      }
      else
      {
