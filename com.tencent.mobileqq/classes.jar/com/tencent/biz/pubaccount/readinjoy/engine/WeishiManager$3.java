...
public class WeishiManager$3
  implements Runnable
{
  public WeishiManager$3(pws parampws, String paramString1, long paramLong, QQMessageFacade paramQQMessageFacade, String paramString2, String paramString3, Map paramMap) {}
  
  public void run()
  {
    Object localObject = this.this$0.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long);
    if (localObject != null) {
      this.jdField_a_of_type_ComTencentImcoreMessageQQMessageFacade.addMessage((MessageRecord)localObject, pws.a(this.this$0).getCurrentUin());
    }
    vnd.jdField_a_of_type_JavaLangString = this.b;
    vmp.a("WSAioLog", "saveLastFeedInfo feedId:" + this.b + ", title:" + this.jdField_a_of_type_JavaLangString);
    try
    {
      long l = Long.parseLong(pws.a(this.this$0).getCurrentAccountUin());
      localObject = PreferenceManager.getDefaultPreference(pws.a(this.this$0).getApplication(), l).edit();
      ...
      {
        vmp.a("weishi-report", "save map passback error, no key 1!");
      ...
      vmp.e("weishi-report", "save map saveSuccess : " + bool + ", passback : " + vnd.a((byte[])this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(1))));
      return;
    }
