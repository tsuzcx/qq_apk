  ...
  implements Manager
{
  ...
  private void a(stSimpleMetaFeed paramstSimpleMetaFeed, String paramString)
  {
    ...
    boolean bool = a();
    WSLog.b("WeishiManager", 2, "from:" + paramString + ", hasRedInfo : " + bool + ", id:" + str1 + ", feed_desc:" + str2);
    if ((bool) || (this.a == null)) {}
  ...
  public static void b(stSimpleMetaFeed paramstSimpleMetaFeed)
  {
    ...
    do
    {
      ...
      localObject = FileUtils.a(((WeishiManager)localObject).b());
    } while (localObject == null);
    WSLog.a("weishi-report", "load map passback length:" + localObject.length);
    WSLog.b("weishi-report", "load map passback:" + WeishiUtils.a((byte[])localObject));
  ...
  public WeishiRedDotInfo a()
  {
    ...
    if (this.a.getMessageFacade().a().a(AppConstants.WEISHI_UIN, 1008) > 0)
    {
      MessageRecord localMessageRecord = this.a.getMessageFacade().b(AppConstants.WEISHI_UIN, 1008);
  ...
  {
    if ((this.a == null) || (this.a.getMessageFacade() == null) || (this.a.getMessageFacade().a() == null)) {
      return null;
    }
    MessageRecord localMessageRecord = this.a.getMessageFacade().b(AppConstants.WEISHI_UIN, 1008);
    if ((localMessageRecord instanceof MessageForStructing)) {
  ...
  {
    WSInitializeHelper.a().a(true, paramstSimpleMetaFeed);
  ...
  public void a(Activity paramActivity)
  {
    ...
    } while ((localObject == null) || (((ConversationFacade)localObject).a(AppConstants.WEISHI_UIN, 1008) <= 0));
  ...
  public boolean a()
  {
    return (this.a != null) && (this.a.getMessageFacade() != null) && (this.a.getMessageFacade().a() != null) && (this.a.getMessageFacade().a().a(AppConstants.WEISHI_UIN, 1008) > 0);
  }
  
  public boolean a(stSimpleMetaFeed paramstSimpleMetaFeed)
  {
    if (WSInitializeHelper.a().a()) {
      return false;
    }
