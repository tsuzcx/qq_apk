...
import com.tencent.biz.pubaccount.readinjoy.viola.adapter.WebRenderAdapter;
...
{
  private static volatile ReadInJoyWebRenderEngine jdField_a_of_type_ComTencentBizPubaccountReadinjoyEngineReadInJoyWebRenderEngine;
  ...
  public ReadInJoyWebRenderEngine()
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyEngineReadInJoyWebRenderStateMachineScheduler = new ReadInJoyWebRenderStateMachineScheduler(new ReadInJoyWebRenderEngine.1(this));
  }
  ...
  /* Error */
  public static void a(String paramString, ReadInJoyWebRenderEngine.LoadLibCallback paramLoadLibCallback)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 25	com/tencent/biz/pubaccount/readinjoy/engine/ReadInJoyWebRenderEngine:jdField_a_of_type_Boolean	Z
    //   6: ifeq +20 -> 26
    //   9: aload_1
    //   10: ifnull +12 -> 22
    //   13: aload_1
    //   14: getstatic 53	com/tencent/biz/pubaccount/readinjoy/engine/ReadInJoyWebRenderEngine:g	I
    //   17: invokeinterface 145 2 0
    //   22: ldc 2
    //   24: monitorexit
    //   25: return
    //   26: invokestatic 151	com/tencent/viola/core/ViolaSDKManager:getInstance	()Lcom/tencent/viola/core/ViolaSDKManager;
    //   29: new 153	com/tencent/biz/pubaccount/readinjoy/engine/ReadInJoyWebRenderEngine$3
    //   32: dup
    //   33: aload_1
    //   34: aload_0
    //   35: invokespecial 156	com/tencent/biz/pubaccount/readinjoy/engine/ReadInJoyWebRenderEngine$3:<init>	(Lcom/tencent/biz/pubaccount/readinjoy/engine/ReadInJoyWebRenderEngine$LoadLibCallback;Ljava/lang/String;)V
    //   38: invokevirtual 160	com/tencent/viola/core/ViolaSDKManager:postOnThreadPool	(Ljava/lang/Runnable;)V
    //   41: goto -19 -> 22
    //   44: astore_0
    //   45: ldc 2
    //   47: monitorexit
    ...
    //   0	50	1	paramLoadLibCallback	ReadInJoyWebRenderEngine.LoadLibCallback
    // Exception table:
    //   from	to	target	type
    //   3	9	44	finally
    //   13	22	44	finally
  ...
  public int h(Bundle paramBundle)
  {
    ...
    if (paramBundle != null)
    {
      if (!TextUtils.isEmpty(paramBundle.getString(WebRenderAdapter.jdField_a_of_type_JavaLangString))) {
        str1 = paramBundle.getString(WebRenderAdapter.jdField_a_of_type_JavaLangString);
      }
      if (!TextUtils.isEmpty(paramBundle.getString(WebRenderAdapter.jdField_e_of_type_JavaLangString))) {
        str2 = paramBundle.getString(WebRenderAdapter.jdField_e_of_type_JavaLangString);
      }
      if (!TextUtils.isEmpty(paramBundle.getString(WebRenderAdapter.jdField_c_of_type_JavaLangString))) {
        str3 = paramBundle.getString(WebRenderAdapter.jdField_c_of_type_JavaLangString);
      }
      str4 = str1;
      str5 = str2;
      str6 = str3;
