  ...
  implements ReadInJoyPicWaterFallFragment.PicWaterFallViewInterface
{
  ...
  {
    if ((this.a.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyPicWaterFallFragment$WaterFallPicAdapter.a.size() > 0) && (paramInt < this.a.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyPicWaterFallFragment$WaterFallPicAdapter.a.size())) {
      return (BaseArticleInfo)this.a.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyPicWaterFallFragment$WaterFallPicAdapter.a.get(paramInt);
    }
    return null;
  }
  ...
  {
    return this.a.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyPicWaterFallFragment$WaterFallPicAdapter.a;
  }
  
  public void a()
  {
    this.a.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyPicWaterFallFragment$WaterFallPicAdapter.notifyDataSetChanged();
  }
  
  public void a(BaseArticleInfo paramBaseArticleInfo, int paramInt)
  {
    ReadInJoyPicWaterFallFragment.b(this.a);
    this.a.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyPicWaterFallFragment$WaterFallPicAdapter.a.remove(paramBaseArticleInfo);
    this.a.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyPicWaterFallFragment$WaterFallPicAdapter.notifyItemRemoved(paramInt);
  }
  
  public void a(List<BaseArticleInfo> paramList)
  {
    this.a.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyPicWaterFallFragment$WaterFallPicAdapter.a(paramList);
  }
  
  public void a(Map<Long, BaseReportData> paramMap, boolean paramBoolean)
  {
    Map localMap = ReadinjoyReportUtils.a(this.a.a());
    String str = RIJKanDianFolderStatus.a(this.a.a());
  ...
  public boolean a()
  {
    return this.a.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyPicWaterFallFragment$WaterFallPicAdapter.getItemCount() == 0;
  }
  ...
  {
    this.a.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyPicWaterFallFragment$WaterFallPicAdapter.a.removeAll(paramList);
  }
  ...
  public void c(List<ChannelCoverInfo> paramList)
  {
    ...
    if (this.a.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewChannelClassificationListView != null)
    {
      ...
      while (paramList.hasNext())
      {
        ...
        this.a.jdField_a_of_type_JavaUtilArrayList.add(new ReadInJoyPicWaterFallFragment.ClassData(localChannelCoverInfo, localChannelCoverInfo.mChannelCoverName, String.valueOf(localChannelCoverInfo.mChannelCoverId)));
      }
      this.a.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyPicWaterFallFragment$WaterFallPicAdapter.notifyDataSetChanged();
    }
  }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.fragment.ReadInJoyPicWaterFallFragment.6
