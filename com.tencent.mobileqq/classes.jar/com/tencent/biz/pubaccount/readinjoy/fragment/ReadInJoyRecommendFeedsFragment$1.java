  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    pzc localpzc = (pzc)((QQAppInterface)localObject1).a(121);
    pzf localpzf = (pzf)((QQAppInterface)localObject1).getManager(261);
    Object localObject2 = (pyy)((QQAppInterface)localObject1).getManager(271);
    Object localObject3 = (pyz)((QQAppInterface)localObject1).getManager(270);
    localObject1 = ((pyz)localObject3).a(this.this$0.getActivity(), 0);
    boolean bool1;
    label143:
    boolean bool2;
    label168:
    ...
    else
    {
      ...
      bool3 = pzx.a(((RefreshData)localObject1).id);
      if (QLog.isColorLevel()) {
      ...
      ((pyz)localObject3).a(1, ((RefreshData)localObject1).id, ((RefreshData)localObject1).seq, 0);
      ((pyz)localObject3).a(true);
      bool1 = true;
      label277:
      localObject2 = (GuideData)((pyy)localObject2).a("operation_guide");
      localObject3 = localpzf.a(this.this$0.getActivity());
      if ((localObject3 == null) || (i < ((SkinData)localObject3).beginTime) || (i > ((SkinData)localObject3).endTime)) {
        break label526;
      }
      if (!pyu.a(((SkinData)localObject3).id)) {
        break label506;
      }
      localpzf.a(1, ((SkinData)localObject3).id, bool1);
    }
    for (;;)
    {
      localpzc.a((SkinData)localObject3, null, (RefreshData)localObject1, (GuideData)localObject2, 0);
      return;
      ...
      break label168;
      label405:
      ((pyz)localObject3).a(0, "", -1L, 0);
      bool1 = false;
      break label277;
      label422:
      ((pyz)localObject3).a(0, "", -1L, 0);
      ((pyz)localObject3).a((RefreshData)localObject1, 0);
      bool1 = false;
      break label277;
      label448:
      if (QLog.isColorLevel()) {
      ...
      label506:
      localpzf.a(0, "", bool1);
      localpzf.a((SkinData)localObject3);
      continue;
      label526:
      localpzf.a(0, "", bool1);
    }
