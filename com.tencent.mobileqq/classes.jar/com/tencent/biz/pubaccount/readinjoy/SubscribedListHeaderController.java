...
public class SubscribedListHeaderController
{
  ...
  private TemplateFactory jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusFactoryTemplateFactory;
  ...
  public SubscribedListHeaderController(Activity paramActivity, FrameLayout paramFrameLayout)
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusFactoryTemplateFactory = TemplateFactory.a("default_feeds", true);
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext.setTemplateFactory(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusFactoryTemplateFactory);
  ...
  private void a()
  {
    try
    {
      String str = (String)ReadInJoyHelper.a("readinjoy_follow_subscribed_list_data_key", "");
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      try
      {
        if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusFactoryTemplateFactory != null)
        {
          localTemplateBean = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusFactoryTemplateFactory.getTemplateBean(paramJSONObject);
          ...
          if (this.jdField_a_of_type_OrgJsonJSONObject == null)
          {
            ...
            localContainer.setBackgroundResource(2130841884);
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.SubscribedListHeaderController
