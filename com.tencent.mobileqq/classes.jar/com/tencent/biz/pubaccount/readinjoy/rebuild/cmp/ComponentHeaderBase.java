  ...
  implements ComponentInheritView
{
  ...
  {
    return LayoutInflater.from(paramContext).inflate(2131560254, this, true);
  }
  ...
  public boolean a()
  {
    ...
    } while (((RIJFeedsType.c(localArticleInfo)) || (RIJFeedsType.d(localArticleInfo)) || (RIJFeedsType.f(localArticleInfo)) || (RIJFeedsType.g(localArticleInfo))) && ((localArticleInfo.mChannelID != 70L) || ((!this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpCmpCtxt.a()) && (localArticleInfo.mChannelID != 70L) && ((localArticleInfo.mSocialFeedInfo == null) || (localArticleInfo.mSocialFeedInfo.h != 1)))));
    return true;
  }
