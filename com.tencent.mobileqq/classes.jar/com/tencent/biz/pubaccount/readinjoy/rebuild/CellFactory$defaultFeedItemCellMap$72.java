...
public final class CellFactory$defaultFeedItemCellMap$72
  extends Lambda
  implements Function3<Context, aobu, snh, qtb>
{
  ...
  @NotNull
  public final qtb invoke(@NotNull Context paramContext, @Nullable aobu paramaobu, @Nullable snh paramsnh)
  {
    Intrinsics.checkParameterIsNotNull(paramContext, "context");
    return new qtb(paramContext, paramaobu, paramsnh);
  }
}
