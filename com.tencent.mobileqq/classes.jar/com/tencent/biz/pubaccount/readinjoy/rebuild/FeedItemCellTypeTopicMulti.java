  ...
  extends FeedItemCell
{
  ...
  public FeedItemCell d()
  {
    ...
    {
      RelativeLayout localRelativeLayout = (RelativeLayout)LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560311, localLinearLayout, false);
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localRelativeLayout.findViewById(2131379432));
      this.b = ((TextView)localRelativeLayout.findViewById(2131371850));
      ...
      localObject = (LinearLayout)localRelativeLayout.findViewById(2131365296);
      int i = 0;
      while (i < 2)
      {
  ...
  public FeedItemCell o()
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        break label78;
        label251:
        this.b.setOnClickListener(new FeedItemCellTypeTopicMulti.2(this, localArticleInfo, localTopicRecommendFeedsInfo));
        continue;
