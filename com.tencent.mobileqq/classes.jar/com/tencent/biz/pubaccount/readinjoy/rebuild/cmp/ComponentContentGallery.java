  ...
  implements ComponentInheritView
{
  ...
  private Pair<Integer, Integer> a()
  {
    ...
    for (;;)
    {
      ...
      j = localResources.getDimensionPixelSize(2131298830);
    }
  }
  ...
  private void a(List<KandianUrlImageView> paramList, ArticleInfo paramArticleInfo, int[] paramArrayOfInt, String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        ((KandianUrlImageView)paramList.get(j)).setOnClickListener(new ComponentContentGallery.1(this, paramArticleInfo, paramArrayOfInt[j], paramString, j));
        j += 1;
      }
    }
  }
  ...
  public void setContent(IReadInJoyModel paramIReadInJoyModel)
  {
    ...
    do
    {
      do
      {
        ...
        localObject4 = RIJR5JsonManager.a(((ArticleInfo)localObject2).mJsonPictureList, "pictures");
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        ((TextView)((View)localObject1).findViewById(2131380511)).setText(((ArticleInfo)localObject2).mGalleryPicNumber + HardCodeUtil.a(2131702336));
      ...
      if (j == 4)
      {
        ...
        paramIReadInJoyModel = LayoutInflater.from(getContext()).inflate(2131560237, null);
        ((TextView)paramIReadInJoyModel.findViewById(2131380511)).setText(((ArticleInfo)localObject2).mGalleryPicNumber + HardCodeUtil.a(2131702357));
        ...
        this.c = ((KandianUrlImageView)paramIReadInJoyModel.findViewById(2131368729));
    ...
    if (j < 9)
    {
      ...
      if (localJSONObject == null)
      {
        ...
        paramIReadInJoyModel = RIJPreParseData.a(paramIReadInJoyModel, ((Integer)((Pair)localObject5).second).intValue(), ((Integer)((Pair)localObject5).first).intValue(), 1);
      }
    }
    label1559:
    for (;;)
    {
      ...
      localObject1 = LayoutInflater.from(getContext()).inflate(2131560237, null);
      ((TextView)((View)localObject1).findViewById(2131380511)).setText(((ArticleInfo)localObject2).mGalleryPicNumber + HardCodeUtil.a(2131702382));
