...
{
  public FeedItemCellTypeUgcVideoSocial(Context paramContext, FaceDecoder paramFaceDecoder, ReadInJoyBaseAdapter paramReadInJoyBaseAdapter)
  {
  ...
  public FeedItemCell a()
  {
    ...
    return a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyBaseAdapter, this.jdField_a_of_type_ComTencentMobileqqUtilFaceDecoder).r().l().g().n().q().j();
  }
  ...
  public FeedItemCell d()
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildComponentView != null)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildComponentView instanceof ComponentContentBigImageVideo))
      {
        ...
        localLinearLayout3.setOnClickListener(new lym(this));
      }
    ...
    localLinearLayout2.setOnClickListener(new lyn(this));
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.rebuild.FeedItemCellTypeUgcVideoSocial
