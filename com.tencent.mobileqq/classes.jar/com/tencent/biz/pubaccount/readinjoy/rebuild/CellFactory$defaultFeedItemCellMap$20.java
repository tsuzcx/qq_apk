...
public final class CellFactory$defaultFeedItemCellMap$20
  extends Lambda
  implements Function3<Context, FaceDecoder, szd, rck>
{
  ...
  @NotNull
  public final rck invoke(@NotNull Context paramContext, @Nullable FaceDecoder paramFaceDecoder, @Nullable szd paramszd)
  {
    Intrinsics.checkParameterIsNotNull(paramContext, "context");
    return new rck(paramContext, paramFaceDecoder, paramszd);
  }
}
