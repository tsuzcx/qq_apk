  ...
  extends BaseAdapter
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = LayoutInflater.from(paramViewGroup.getContext()).inflate(2131560376, paramViewGroup, false);
      paramView = new ComponentContentRecommendFollowGroup.ViewHolder(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentContentRecommendFollowGroup, null);
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131368123));
      paramView.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131367297));
      paramView.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)localView.findViewById(2131367289));
      paramView.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)localView.findViewById(2131368096));
      ...
      while (i < paramView.jdField_b_of_type_AndroidWidgetLinearLayout.getChildCount())
      {
        ...
        paramView.jdField_a_of_type_ArrayOfAndroidWidgetRelativeLayout[i] = ((RelativeLayout)((RelativeLayout)localObject1).findViewById(2131368315));
        paramView.jdField_a_of_type_ArrayOfAndroidWidgetImageView[i] = ((ImageView)((RelativeLayout)localObject1).findViewById(2131368306));
        paramView.jdField_b_of_type_ArrayOfAndroidWidgetImageView[i] = ((ImageView)((RelativeLayout)localObject1).findViewById(2131381108));
        paramView.c[i] = ((ImageView)((RelativeLayout)localObject1).findViewById(2131378406));
        paramView.jdField_a_of_type_ArrayOfAndroidWidgetTextView[i] = ((TextView)((RelativeLayout)localObject1).findViewById(2131372296));
      ...
      paramView.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructGroupRecommendAccount = ((GroupRecommendAccount)this.jdField_a_of_type_JavaUtilList.get(paramInt));
      paramView.jdField_a_of_type_AndroidWidgetTextView.setText(paramView.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructGroupRecommendAccount.jdField_a_of_type_JavaLangString);
      i = 0;
      if (i >= paramView.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructGroupRecommendAccount.jdField_a_of_type_JavaUtilList.size()) {
        break label611;
      }
      localObject1 = (RecommendFollowInfo)paramView.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructGroupRecommendAccount.jdField_a_of_type_JavaUtilList.get(i);
    ...
    for (int j = 0;; j = 8)
    {
      ...
      i += 1;
      break label325;
      localObject1 = (ComponentContentRecommendFollowGroup.ViewHolder)paramView.getTag();
      localView = paramView;
      paramView = (View)localObject1;
      break;
      paramView.jdField_a_of_type_ArrayOfAndroidWidgetImageView[i].setImageDrawable(ImageUtil.c());
      break label473;
      j = 8;
      break label493;
    }
    ...
    int i = 0;
    if (i < paramView.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructGroupRecommendAccount.jdField_a_of_type_JavaUtilList.size()) {
      if (((RecommendFollowInfo)paramView.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructGroupRecommendAccount.jdField_a_of_type_JavaUtilList.get(i)).isFollowed) {}
    }
    for (i = k;; i = 1)
    {
      if (i != 0)
      {
        paramView.jdField_b_of_type_AndroidWidgetTextView.setText(HardCodeUtil.a(2131702309));
        paramView.jdField_b_of_type_AndroidWidgetTextView.setTextColor(-8947849);
        paramView.jdField_a_of_type_AndroidWidgetLinearLayout.setBackgroundResource(2130849835);
      }
      for (;;)
      {
        ...
        i += 1;
        break;
        paramView.jdField_b_of_type_AndroidWidgetTextView.setText(HardCodeUtil.a(2131702344));
        paramView.jdField_b_of_type_AndroidWidgetTextView.setTextColor(-1);
        paramView.jdField_a_of_type_AndroidWidgetLinearLayout.setBackgroundResource(2130849791);
      }
    }
  }
}
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.rebuild.cmp.ComponentContentRecommendFollowGroup.FollowListAdapter
