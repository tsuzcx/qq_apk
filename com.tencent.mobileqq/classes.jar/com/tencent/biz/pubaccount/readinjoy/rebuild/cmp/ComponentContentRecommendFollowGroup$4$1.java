...
public class ComponentContentRecommendFollowGroup$4$1
  implements Runnable
{
  public ComponentContentRecommendFollowGroup$4$1(pkp parampkp, long paramLong, boolean paramBoolean) {}
  ...
  public void run()
  {
    ...
    Iterator localIterator = ComponentContentRecommendFollowGroup.a(this.jdField_a_of_type_Pkp.a).mRecommendFollowInfos.a.iterator();
    while (localIterator.hasNext())
    {
      ...
      if (this.jdField_a_of_type_Long == localRecommendFollowInfo.uin)
      {
        ...
        this.jdField_a_of_type_Pkp.a.b(localRecommendFollowInfo);
      }
    }
    ComponentContentRecommendFollowGroup.a(this.jdField_a_of_type_Pkp.a).notifyDataSetChanged();
  }
}
