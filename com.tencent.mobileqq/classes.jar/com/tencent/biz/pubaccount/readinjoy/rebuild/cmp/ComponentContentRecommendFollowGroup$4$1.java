...
public class ComponentContentRecommendFollowGroup$4$1
  implements Runnable
{
  public ComponentContentRecommendFollowGroup$4$1(pwk parampwk, long paramLong, boolean paramBoolean) {}
  ...
  public void run()
  {
    ...
    Iterator localIterator = ComponentContentRecommendFollowGroup.a(this.jdField_a_of_type_Pwk.a).mRecommendFollowInfos.a.iterator();
    while (localIterator.hasNext())
    {
      ...
      if (this.jdField_a_of_type_Long == localRecommendFollowInfo.uin)
      {
        ...
        this.jdField_a_of_type_Pwk.a.b(localRecommendFollowInfo);
      }
    }
    ComponentContentRecommendFollowGroup.a(this.jdField_a_of_type_Pwk.a).notifyDataSetChanged();
  }
}
