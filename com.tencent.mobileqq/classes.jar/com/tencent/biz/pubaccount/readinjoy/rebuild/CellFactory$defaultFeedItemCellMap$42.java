...
public final class CellFactory$defaultFeedItemCellMap$42
  extends Lambda
  implements Function3<Context, aobu, snh, qth>
{
  ...
  @NotNull
  public final qth invoke(@NotNull Context paramContext, @Nullable aobu paramaobu, @Nullable snh paramsnh)
  {
    Intrinsics.checkParameterIsNotNull(paramContext, "context");
    return new qth(paramContext, paramaobu, paramsnh);
  }
}
