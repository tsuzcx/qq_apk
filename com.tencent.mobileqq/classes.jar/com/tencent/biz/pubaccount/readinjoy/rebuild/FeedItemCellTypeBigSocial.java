...
{
  public FeedItemCellTypeBigSocial(Context paramContext, FaceDecoder paramFaceDecoder, ReadInJoyBaseAdapter paramReadInJoyBaseAdapter)
  {
  ...
  public FeedItemCell a()
  {
    ...
    return a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyBaseAdapter, this.jdField_a_of_type_ComTencentMobileqqUtilFaceDecoder).f().g().h().q().l().n().j();
  }
  ...
  public FeedItemCell d()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildComponentView != null) && ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildComponentView instanceof ComponentContentBig)) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentTitle != null))
    {
      ...
      ((ComponentContentBig)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildComponentView).setId(1);
      ((ComponentContentBig)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildComponentView).setLayoutParams(localLayoutParams);
      localLinearLayout3.addView((ComponentContentBig)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildComponentView);
      ...
      localLinearLayout3.setOnClickListener(new lwq(this, localLinearLayout1, localLinearLayout3, localLinearLayout2));
      localLinearLayout3.setDuplicateParentStateEnabled(true);
      localLinearLayout3.setOnTouchListener(new lwr(this, localLinearLayout3));
      localLinearLayout2.setOnTouchListener(new lws(this, localLinearLayout3));
      ...
      localLinearLayout2.setOnTouchListener(new lwt(this, localLinearLayout2));
      localLinearLayout1.setOnTouchListener(new lwu(this, localLinearLayout2, localLinearLayout3));
    }
    localLinearLayout2.setOnClickListener(new lwv(this));
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.rebuild.FeedItemCellTypeBigSocial
