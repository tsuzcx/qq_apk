  ...
  implements ComponentView
{
  ...
  private void a(ArticleInfo paramArticleInfo)
  {
    ...
    for (;;)
    {
      ...
      break;
      label199:
      if (RIJFeedsType.a(paramArticleInfo.mSocialFeedInfo.a))
      {
  ...
  public void a(Context paramContext)
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyYAFolderTextView.setSpanText(HardCodeUtil.a(2131702392));
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyYAFolderTextView.setMaxLines(7);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyYAFolderTextView.setMoreSpan(new ComponentContentUgcOriginalHeader.1(this));
  ...
  public void a(Object paramObject)
  {
    ...
    do
    {
      return;
      a(paramObject);
    } while ((!RIJItemViewType.m(paramObject)) || (!TextUtils.isEmpty(paramObject.businessName)));
