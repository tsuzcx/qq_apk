  ...
  implements ComponentView
{
  ...
  {
    String str1 = this.jdField_a_of_type_Lyu.a();
    String str2 = this.jdField_a_of_type_Lyu.b();
    if ((this.jdField_a_of_type_JavaLangObject instanceof IReadInJoyModel)) {}
  ...
  public void a()
  {
    setOnItemClickListener(new lyt(this));
  }
  ...
  public void a(Object paramObject)
  {
    ...
    if (this.jdField_a_of_type_Lyu == null)
    {
      this.jdField_a_of_type_Lyu = new lyu((ComponentContentGridImage.Model)paramObject);
      setAdapter(this.jdField_a_of_type_Lyu);
    }
    for (;;)
    {
      b();
      ...
      return;
      this.jdField_a_of_type_Lyu.a((ComponentContentGridImage.Model)paramObject);
      this.jdField_a_of_type_Lyu.notifyDataSetChanged();
    }
  }
