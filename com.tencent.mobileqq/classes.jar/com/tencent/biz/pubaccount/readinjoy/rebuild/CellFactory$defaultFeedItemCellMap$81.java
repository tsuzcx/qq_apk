...
public final class CellFactory$defaultFeedItemCellMap$81
  extends Lambda
  implements Function3<Context, aobu, snh, qsf>
{
  ...
  @NotNull
  public final qsf invoke(@NotNull Context paramContext, @Nullable aobu paramaobu, @Nullable snh paramsnh)
  {
    Intrinsics.checkParameterIsNotNull(paramContext, "context");
    return new qsf(paramContext, paramaobu, paramsnh);
  }
}
