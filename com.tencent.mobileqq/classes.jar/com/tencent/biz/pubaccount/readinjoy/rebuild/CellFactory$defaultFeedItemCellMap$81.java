...
public final class CellFactory$defaultFeedItemCellMap$81
  extends Lambda
  implements Function3<Context, aoof, sel, qkt>
{
  ...
  @NotNull
  public final qkt invoke(@NotNull Context paramContext, @Nullable aoof paramaoof, @Nullable sel paramsel)
  {
    Intrinsics.checkParameterIsNotNull(paramContext, "context");
    return new qkt(paramContext, paramaoof, paramsel);
  }
}
