...
public final class CellFactory
{
  ...
  @JvmStatic
  @Nullable
  public static final View a(int paramInt1, @Nullable Object paramObject, int paramInt2, @Nullable View paramView, @NotNull Context paramContext, @Nullable ReadInJoyBaseAdapter paramReadInJoyBaseAdapter, @Nullable IFaceDecoder paramIFaceDecoder)
  {
    ...
    for (paramContext = (FeedItemCell)paramContext;; paramContext = paramReadInJoyBaseAdapter) {
      for (;;)
      {
        if (paramContext != null)
        {
        ...
        return paramView;
        paramReadInJoyBaseAdapter = jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCellFactory.a(paramInt2, paramContext, paramObject, paramIFaceDecoder, paramReadInJoyBaseAdapter);
        if (paramReadInJoyBaseAdapter != null) {
          try
          {
            ...
            {
              ApiCompatibilityUtils.a(paramView, paramContext.getResources().getDrawable(2130841884));
              paramContext = paramReadInJoyBaseAdapter;
            }
            else
            {
              ApiCompatibilityUtils.a(paramView, paramContext.getResources().getDrawable(2131166912));
              paramContext = paramReadInJoyBaseAdapter;
            }
          }
  ...
  private final FeedItemCell a(int paramInt, Context paramContext, Object paramObject, IFaceDecoder paramIFaceDecoder, ReadInJoyBaseAdapter paramReadInJoyBaseAdapter)
  {
    paramContext = a(paramInt, paramContext, paramIFaceDecoder, paramReadInJoyBaseAdapter);
    if (paramContext != null) {}
    try
    {
  ...
  @VisibleForTesting
  @Nullable
  public final FeedItemCell a(int paramInt, @NotNull Context paramContext, @Nullable IFaceDecoder paramIFaceDecoder, @Nullable ReadInJoyBaseAdapter paramReadInJoyBaseAdapter)
  {
    Intrinsics.checkParameterIsNotNull(paramContext, "context");
