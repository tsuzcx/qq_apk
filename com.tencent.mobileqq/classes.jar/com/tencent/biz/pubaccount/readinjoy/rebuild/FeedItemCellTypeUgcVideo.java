...
{
  public FeedItemCellTypeUgcVideo(Context paramContext, FaceDecoder paramFaceDecoder, ReadInJoyBaseAdapter paramReadInJoyBaseAdapter)
  {
  ...
  public FeedItemCell a()
  {
    ...
    return d(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyBaseAdapter, this.jdField_a_of_type_ComTencentMobileqqUtilFaceDecoder).q().g().l().j().n();
  }
  ...
  public FeedItemCell d()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildComponentView != null) && ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildComponentView instanceof ComponentContentBigImageVideo)))
    {
      ...
      ((ComponentContentBigImageVideo)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildComponentView).setOnClickListener(new lyl(this));
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.rebuild.FeedItemCellTypeUgcVideo
