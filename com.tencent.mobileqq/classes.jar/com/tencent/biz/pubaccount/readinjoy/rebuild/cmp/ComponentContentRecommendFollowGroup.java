  ...
  implements pex, rex
{
  ...
  private pkq jdField_a_of_type_Pkq;
  private View b;
  
  public ComponentContentRecommendFollowGroup(Context paramContext)
  {
    super(paramContext);
    this.jdField_a_of_type_Ohe = new pkp(this);
    a(paramContext);
  }
  ...
  public void a(View paramView)
  {
    ...
    this.jdField_a_of_type_Pkq = new pkq(this, null);
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetDisableSlideHorizontalListView.setAdapter(this.jdField_a_of_type_Pkq);
    ...
    this.b.setOnClickListener(new pkn(this));
  }
  ...
  public void a(Object paramObject)
  {
    ...
    this.jdField_a_of_type_Pkq.a(paramObject.jdField_b_of_type_JavaUtilList);
  ...
  protected void a(String paramString, long paramLong1, long paramLong2, int paramInt1, int paramInt2, List<RecommendFollowInfo> paramList)
  {
    ...
    ndn.a(null, obz.a() + "", paramString, paramString, 0, 0, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mRecommendFollowId + "", this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mArticleID + "", paramInt1 + "", paramList, false);
  }
  ...
  public void a(List<RecommendFollowInfo> paramList, boolean paramBoolean)
  {
    ...
    while (i < paramList.size())
    {
      ...
      {
        localArrayList1.add(new ooz(localRecommendFollowInfo.uin, localRecommendFollowInfo.type));
    ...
    for (;;)
    {
      paramList = new pko(this, paramList, paramBoolean);
      if (!paramBoolean) {
        break;
      }
      ogy.a().a().a(localArrayList1, paramList, 2);
      return;
      label174:
    ...
    ogy.a().a().b(localArrayList1, paramList, 2);
  }
