  ...
  implements ComponentInheritView
{
  ...
  {
    return LayoutInflater.from(paramContext).inflate(2131560249, this, true);
  }
  ...
  {
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131376575));
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKandianUrlImageView = ((KandianUrlImageView)paramView.findViewById(2131370257));
    this.b = ((KandianUrlImageView)paramView.findViewById(2131364507));
    this.c = ((KandianUrlImageView)paramView.findViewById(2131377058));
  ...
  public void setContent(IReadInJoyModel paramIReadInJoyModel)
  {
    ...
    do
    {
      ...
      localObject3 = RIJR5JsonManager.a(((ArticleInfo)localObject2).mJsonPictureList, "pictures");
    ...
    {
      ReadInJoyDisplayUtils.a(this.jdField_a_of_type_JavaUtilList, Arrays.asList(new URL[] { RIJPreParseData.a(paramIReadInJoyModel), RIJPreParseData.a((String)localObject1), RIJPreParseData.a((String)localObject2) }), getContext());
      return;
