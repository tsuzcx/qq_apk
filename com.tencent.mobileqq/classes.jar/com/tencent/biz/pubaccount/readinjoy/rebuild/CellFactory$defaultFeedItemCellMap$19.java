...
public final class CellFactory$defaultFeedItemCellMap$19
  extends Lambda
  implements Function3<Context, aobu, snh, qrc>
{
  ...
  @NotNull
  public final qrc invoke(@NotNull Context paramContext, @Nullable aobu paramaobu, @Nullable snh paramsnh)
  {
    Intrinsics.checkParameterIsNotNull(paramContext, "context");
    return new qrc(paramContext, paramaobu, paramsnh);
  }
}
