...
public final class CellFactory$defaultFeedItemCellMap$19
  extends Lambda
  implements Function3<Context, aoof, sel, qjq>
{
  ...
  @NotNull
  public final qjq invoke(@NotNull Context paramContext, @Nullable aoof paramaoof, @Nullable sel paramsel)
  {
    Intrinsics.checkParameterIsNotNull(paramContext, "context");
    return new qjq(paramContext, paramaoof, paramsel);
  }
}
