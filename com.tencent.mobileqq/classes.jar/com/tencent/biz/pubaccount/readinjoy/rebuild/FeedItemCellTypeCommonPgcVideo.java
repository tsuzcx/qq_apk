...
{
  public FeedItemCellTypeCommonPgcVideo(Context paramContext, FaceDecoder paramFaceDecoder, ReadInJoyBaseAdapter paramReadInJoyBaseAdapter)
  {
  ...
  public FeedItemCell a()
  {
    ...
    return c(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyBaseAdapter, this.jdField_a_of_type_ComTencentMobileqqUtilFaceDecoder).q().l().n().g().j();
  }
  ...
  public FeedItemCell d()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildComponentView != null) && ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildComponentView instanceof ComponentContentBigImageVideo)))
    {
      ...
      ((ComponentContentBigImageVideo)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildComponentView).setOnClickListener(new lww(this));
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.rebuild.FeedItemCellTypeCommonPgcVideo
