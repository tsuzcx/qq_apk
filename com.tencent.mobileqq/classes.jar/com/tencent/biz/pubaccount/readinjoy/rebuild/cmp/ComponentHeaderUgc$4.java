  ...
  extends ReadInJoyObserver
{
  ...
  public void b(long paramLong, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      localArticleInfo = this.a.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpCmpCtxt.a.a();
    } while (paramLong != localArticleInfo.mSocialFeedInfo.a.a);
    if (paramBoolean)
    {
      this.a.jdField_a_of_type_AndroidWidgetButton.setEnabled(false);
      this.a.jdField_a_of_type_AndroidWidgetButton.setText(HardCodeUtil.a(2131702347));
    ...
    for (;;)
    {
      ...
      this.a.jdField_a_of_type_AndroidWidgetButton.setText(HardCodeUtil.a(2131702352));
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.rebuild.cmp.ComponentHeaderUgc.4
