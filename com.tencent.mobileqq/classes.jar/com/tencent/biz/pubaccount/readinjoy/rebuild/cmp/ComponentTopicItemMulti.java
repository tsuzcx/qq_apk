  ...
  implements ComponentInheritView
{
  ...
  TopicRecommendFeedsInfo.TopicRecommendInfo jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructTopicRecommendFeedsInfo$TopicRecommendInfo;
  ...
  {
    return LayoutInflater.from(paramContext).inflate(2131560270, this, true);
  }
  ...
  public void a(Object paramObject)
  {
    ...
    try
    {
      ...
      paramObject = String.format(getResources().getString(2131718399), new Object[] { ReadInJoyHelper.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructTopicRecommendFeedsInfo$TopicRecommendInfo.jdField_b_of_type_Int) });
