  ...
  extends FeedItemCell
{
  ...
  public FeedItemCell a()
  {
    ...
    return a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyBaseAdapter, this.jdField_a_of_type_ComTencentMobileqqAppFaceIFaceDecoder).f().g().q().l().n().j();
  }
  ...
  public FeedItemCell d()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildComponentView != null) && ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildComponentView instanceof ComponentContentGridImage)))
    {
      ...
      ApiCompatibilityUtils.a((ComponentContentGridImage)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildComponentView, this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841885));
      ((ComponentContentGridImage)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildComponentView).setOnNoItemClickListener(new FeedItemCellTypePgcGridSocial.1(this));
  ...
  public FeedItemCell o()
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildComponentView != null)
    {
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentContentGridImage$Model = ComponentContentGridImage.a(this.jdField_a_of_type_JavaLangObject, 0);
