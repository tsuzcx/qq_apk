  ...
  implements View.OnClickListener, pqp
{
  ...
  public static String a(int paramInt)
  {
    ...
    {
      paramInt /= 10000;
      return String.valueOf(paramInt) + ajya.a(2131702285);
    }
    paramInt /= 100000000;
    return String.valueOf(paramInt) + ajya.a(2131702251);
  }
  ...
  public void a(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramContext.findViewById(2131364514));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramContext.findViewById(2131378722));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramContext.findViewById(2131378721));
    this.jdField_a_of_type_AndroidViewView = paramContext.findViewById(2131378720);
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramContext.findViewById(2131363289));
    ...
    this.jdField_a_of_type_AndroidViewAnimationScaleAnimation.setAnimationListener(new pyf(this));
    this.jdField_b_of_type_AndroidViewAnimationScaleAnimation.setAnimationListener(new pyg(this));
    this.jdField_c_of_type_AndroidViewAnimationScaleAnimation.setAnimationListener(new pyh(this));
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130845463);
      ...
      for (;;)
      {
        ...
        break label86;
        label180:
        this.jdField_b_of_type_AndroidWidgetTextView.setText(2131718615);
      }
      label190:
      break;
      label192:
      this.jdField_a_of_type_AndroidWidgetTextView.setText(2131718362);
    }
    label204:
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        ((JSONObject)localObject4).put("folder_status", onh.d);
        ...
        ((JSONObject)localObject4).put("feeds_type", "" + onh.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo));
        ((JSONObject)localObject4).put("kandian_mode", "" + onh.e());
        ((JSONObject)localObject4).put("tab_source", "" + onh.d());
      ...
      catch (JSONException localJSONException)
      {
        ...
        continue;
        onh.a(getContext(), this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo, true);
        continue;
        if (paramView.getId() != 2131378720) {
          continue;
        }
        if (this.jdField_a_of_type_Boolean) {
          continue;
        ...
        if ((!ram.i(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo)) && (!ram.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo)) && (!ram.j(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo)) && (!ram.k(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo))) {
          continue;
        }
        if (ram.o(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo)) {
          continue;
        }
        nol.a(null, String.valueOf(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo.jdField_a_of_type_Qda.jdField_a_of_type_Long), (String)localObject3, (String)localObject3, 0, 0, String.valueOf(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo.jdField_a_of_type_Long), "0", "" + this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mStrategyId, (String)localObject2, false);
        ...
        osg.a().a(onh.a(), this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo.jdField_a_of_type_Long, this.jdField_a_of_type_Boolean, paramView);
        continue;
        bool = false;
        continue;
        ...
        if (this.jdField_a_of_type_Puy.a.e() != 70) {
          continue;
        }
      ...
      bool = shu.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mChannelID);
      if (!bool) {
        continue;
      }
      ...
      if (!ram.a(this.jdField_a_of_type_Puy.a.a())) {
        continue;
      }
      onh.a(getContext(), this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo, 1, true, 0, true);
      if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo == null) {
        continue;
      }
      paramView = new qbz();
      ...
      if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo.jdField_a_of_type_Qci != null) {
        paramView.jdField_b_of_type_Long = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo.jdField_a_of_type_Qci.jdField_a_of_type_Long;
      }
      ...
      localObject3 = (qci)((Iterator)localObject1).next();
      if (localObject3 != null)
      {
        paramView.jdField_a_of_type_JavaUtilList.add(Long.valueOf(((qci)localObject3).jdField_a_of_type_Long));
        continue;
        ((JSONObject)localObject4).put("feeds_source", this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo.jdField_a_of_type_Qci.jdField_a_of_type_Long);
      }
    }
  }
}
