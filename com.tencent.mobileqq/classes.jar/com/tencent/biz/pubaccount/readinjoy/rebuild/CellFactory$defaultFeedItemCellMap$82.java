...
public final class CellFactory$defaultFeedItemCellMap$82
  extends Lambda
  implements Function3<Context, FaceDecoder, slt, qrf>
{
  ...
  @NotNull
  public final qrf invoke(@NotNull Context paramContext, @Nullable FaceDecoder paramFaceDecoder, @Nullable slt paramslt)
  {
    Intrinsics.checkParameterIsNotNull(paramContext, "context");
    return new qrf(paramContext, paramFaceDecoder, paramslt);
  }
}
