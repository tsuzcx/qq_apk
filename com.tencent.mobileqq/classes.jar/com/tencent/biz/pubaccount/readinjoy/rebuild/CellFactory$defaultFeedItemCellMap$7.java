...
public final class CellFactory$defaultFeedItemCellMap$7
  extends Lambda
  implements Function3<Context, FaceDecoder, szd, rbz>
{
  ...
  @NotNull
  public final rbz invoke(@NotNull Context paramContext, @Nullable FaceDecoder paramFaceDecoder, @Nullable szd paramszd)
  {
    Intrinsics.checkParameterIsNotNull(paramContext, "context");
    return new rbz(paramContext, paramFaceDecoder, paramszd);
  }
}
