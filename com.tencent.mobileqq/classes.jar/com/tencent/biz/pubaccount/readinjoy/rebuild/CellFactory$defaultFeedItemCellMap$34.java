...
public final class CellFactory$defaultFeedItemCellMap$34
  extends Lambda
  implements Function3<Context, FaceDecoder, slt, qte>
{
  ...
  @NotNull
  public final qte invoke(@NotNull Context paramContext, @Nullable FaceDecoder paramFaceDecoder, @Nullable slt paramslt)
  {
    Intrinsics.checkParameterIsNotNull(paramContext, "context");
    return new qte(paramContext, paramFaceDecoder, paramslt);
  }
}
