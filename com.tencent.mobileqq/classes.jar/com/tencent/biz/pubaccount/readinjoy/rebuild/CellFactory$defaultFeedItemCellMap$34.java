...
public final class CellFactory$defaultFeedItemCellMap$34
  extends Lambda
  implements Function3<Context, aoof, sel, qnb>
{
  ...
  @NotNull
  public final qnb invoke(@NotNull Context paramContext, @Nullable aoof paramaoof, @Nullable sel paramsel)
  {
    Intrinsics.checkParameterIsNotNull(paramContext, "context");
    return new qnb(paramContext, paramaoof, paramsel);
  }
}
