...
public final class CellFactory$defaultFeedItemCellMap$35
  extends Lambda
  implements Function3<Context, aoof, sel, qnj>
{
  ...
  @NotNull
  public final qnj invoke(@NotNull Context paramContext, @Nullable aoof paramaoof, @Nullable sel paramsel)
  {
    Intrinsics.checkParameterIsNotNull(paramContext, "context");
    return new qnj(paramContext, paramaoof, paramsel);
  }
}
