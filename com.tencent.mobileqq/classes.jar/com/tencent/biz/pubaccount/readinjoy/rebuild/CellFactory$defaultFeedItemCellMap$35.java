...
public final class CellFactory$defaultFeedItemCellMap$35
  extends Lambda
  implements Function3<Context, aobu, snh, quv>
{
  ...
  @NotNull
  public final quv invoke(@NotNull Context paramContext, @Nullable aobu paramaobu, @Nullable snh paramsnh)
  {
    Intrinsics.checkParameterIsNotNull(paramContext, "context");
    return new quv(paramContext, paramaobu, paramsnh);
  }
}
