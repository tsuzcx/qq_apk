  ...
  implements View.OnClickListener
{
  ...
  {
    super(paramContext);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyEngineReadInJoyObserver = new lvj(this);
  }
  ...
  private void a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    if (ReadInJoyUtils.f(paramBaseArticleInfo))
    {
      ...
      String str = ReadinjoyReportUtils.a(getContext(), localBaseArticleInfo.mAlgorithmID, ReadInJoyUtils.a(paramBaseArticleInfo), this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyBaseAdapter.a(), localBaseArticleInfo.innerUniqueID, localBaseArticleInfo.mVideoVid);
      PublicAccountReportUtils.a(null, "CliOper", "", String.valueOf(paramBaseArticleInfo.mPolymericInfo.jdField_b_of_type_Long), "0X8007625", "0X8007625", 0, 0, ReadInJoyBaseAdapter.a(localBaseArticleInfo.mFeedId), String.valueOf(localBaseArticleInfo.businessId), Integer.toString(localBaseArticleInfo.mStrategyId), str, false);
      return;
    }
  ...
  {
    super.a(paramView);
    this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131366774);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131366996));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131366997));
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKandianUrlImageView = ((KandianUrlImageView)paramView.findViewById(2131366995));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131366981));
    this.c = ((TextView)paramView.findViewById(2131366998));
    this.d = ((TextView)paramView.findViewById(2131366999));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131366982));
    this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131362822);
  ...
  public void a(Object paramObject)
  {
    ...
    if ((localArticleInfo != null) && (localArticleInfo.mPolymericInfo != null))
    {
      ...
      case 8: 
      default: 
        this.jdField_a_of_type_AndroidWidgetTextView.setText(localArticleInfo.mPolymericInfo.jdField_a_of_type_JavaLangString);
        ...
        {
          this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKandianUrlImageView.a(ReadInJoyUtils.b(localArticleInfo.mPolymericInfo.c));
          localObject1 = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKandianUrlImageView;
    ...
    {
      ((KandianUrlImageView)localObject1).setRound(bool);
      for (;;)
      {
        ...
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKandianUrlImageView.setImageDrawable(SearchUtils.a(this.jdField_a_of_type_ComTencentMobileqqUtilFaceDecoder, String.valueOf(this.jdField_a_of_type_Long), 1));
        continue;
        ...
        if (((String)localObject2).startsWith("#"))
        {
          ...
          ((SpannableString)localObject1).setSpan(new ForegroundColorSpan(getResources().getColor(2131493396)), 0, 1, 33);
          ((SpannableString)localObject1).setSpan(new ImageSpan(getContext(), 2130840776), 1, 2, 33);
        ...
        for (;;)
        {
          ...
          localObject1 = URLDrawable.getDrawable(ReadInJoyUtils.b(localArticleInfo.mPolymericInfo.c), (URLDrawable.URLDrawableOptions)localObject1);
          ((URLDrawable)localObject1).setTag(URLDrawableDecodeHandler.a(72, 72, DisplayUtil.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKandianUrlImageView.getContext(), 2.0F)));
          ((URLDrawable)localObject1).setDecodeHandler(URLDrawableDecodeHandler.g);
          this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKandianUrlImageView.setImageDrawable((Drawable)localObject1);
          break;
          this.jdField_a_of_type_AndroidWidgetTextView.setText(localArticleInfo.mPolymericInfo.jdField_a_of_type_JavaLangString);
        }
        this.c.setText(localArticleInfo.mPolymericInfo.jdField_b_of_type_JavaLangString);
        continue;
        this.jdField_a_of_type_AndroidWidgetTextView.setText(localArticleInfo.mPolymericInfo.jdField_a_of_type_JavaLangString);
        this.jdField_b_of_type_AndroidWidgetTextView.setText(localArticleInfo.mPolymericInfo.jdField_b_of_type_JavaLangString);
        this.jdField_a_of_type_Long = localArticleInfo.mPolymericInfo.jdField_b_of_type_Long;
    ...
    if (localArticleInfo.mPolymericInfo.jdField_a_of_type_Int == 11)
    {
      ...
      {
        i = 1;
        this.d.setTag(String.valueOf(((SocializeFeedsInfo)localObject1).a.jdField_a_of_type_Long));
    ...
    for (;;)
    {
      ...
      if (i == 0)
      {
        ...
        this.d.setTextColor(getResources().getColor(2131493396));
        this.d.setText("关注");
        label926:
        localObject1 = (LinearLayout.LayoutParams)this.d.getLayoutParams();
        if (!a()) {
          break label1233;
        }
      }
      ...
      for (((LinearLayout.LayoutParams)localObject1).rightMargin = DisplayUtil.a(getContext(), 12.0F);; ((LinearLayout.LayoutParams)localObject1).rightMargin = DisplayUtil.a(getContext(), 0.0F))
      {
        ...
        this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
        break label879;
        if ((localArticleInfo.mPolymericInfo.jdField_a_of_type_Int != 9) || (((BaseArticleInfo)localArticleInfo.mGroupSubArticleList.get(0)).mTopicRecommendFeedsInfo == null)) {
          break label1269;
        }
        ...
        for (i = 1;; i = 0)
        {
          this.d.setTag(String.valueOf(((TopicRecommendFeedsInfo.TopicRecommendInfo)localObject1).jdField_a_of_type_Int));
          break;
        }
        this.d.setVisibility(8);
        break label926;
  ...
  protected void d()
  {
    ...
    if (localAppRuntime != null)
    {
      ...
      if (localSocializeFeedsInfo != null)
      {
        ...
        ReadInJoyLogicEngine.a().a().a(localAppRuntime.getAccount(), String.valueOf(l), true, new lvg(this, localSocializeFeedsInfo, localArticleInfo), 1);
      }
    }
  }
  ...
  protected void e()
  {
    ...
    ReadInJoyLogicEngine.a().a().a((String)localObject, Long.toString(localTopicRecommendInfo.jdField_a_of_type_Int), true, new lvh(this, localTopicRecommendInfo), 3);
  }
