...
public final class CellFactory$defaultFeedItemCellMap$27
  extends Lambda
  implements Function3<Context, aoof, sel, qle>
{
  ...
  @NotNull
  public final qle invoke(@NotNull Context paramContext, @Nullable aoof paramaoof, @Nullable sel paramsel)
  {
    Intrinsics.checkParameterIsNotNull(paramContext, "context");
    return new qle(paramContext, paramaoof, paramsel);
  }
}
