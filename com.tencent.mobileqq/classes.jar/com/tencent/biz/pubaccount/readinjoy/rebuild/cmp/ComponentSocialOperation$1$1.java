...
public class ComponentSocialOperation$1$1
  implements Runnable
{
  public ComponentSocialOperation$1$1(qwy paramqwy) {}
  
  public void run()
  {
    if (this.a.a.jdField_a_of_type_Boolean)
    {
      this.a.a.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130846279);
    ...
    for (;;)
    {
      ...
      return;
      this.a.a.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130846282);
      ...
      for (;;)
      {
        ...
        break;
        this.a.a.jdField_b_of_type_AndroidWidgetTextView.setText(2131717568);
      }
    }
  }
}
