  ...
  extends FeedItemCell
{
  ...
  public FeedItemCell a()
  {
    ...
    return f(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyBaseAdapter, this.jdField_a_of_type_ComTencentMobileqqAppFaceIFaceDecoder).q().l().h().g();
  }
  ...
  public FeedItemCell d()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildComponentView != null) && ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildComponentView instanceof ComponentContentGridImage)))
    {
      ...
      ((ComponentContentGridImage)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildComponentView).setOnNoItemClickListener(new FeedItemCellTypeTopicRecommendGrid.1(this));
