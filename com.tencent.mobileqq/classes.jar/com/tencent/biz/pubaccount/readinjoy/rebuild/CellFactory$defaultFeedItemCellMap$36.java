...
public final class CellFactory$defaultFeedItemCellMap$36
  extends Lambda
  implements Function3<Context, aoof, sel, qne>
{
  ...
  @NotNull
  public final qne invoke(@NotNull Context paramContext, @Nullable aoof paramaoof, @Nullable sel paramsel)
  {
    Intrinsics.checkParameterIsNotNull(paramContext, "context");
    return new qne(paramContext, paramaoof, paramsel);
  }
}
