...
public final class CellFactory$defaultFeedItemCellMap$36
  extends Lambda
  implements Function3<Context, FaceDecoder, szd, rft>
{
  ...
  @NotNull
  public final rft invoke(@NotNull Context paramContext, @Nullable FaceDecoder paramFaceDecoder, @Nullable szd paramszd)
  {
    Intrinsics.checkParameterIsNotNull(paramContext, "context");
    return new rft(paramContext, paramFaceDecoder, paramszd);
  }
}
