...
public final class CellFactory$defaultFeedItemCellMap$36
  extends Lambda
  implements Function3<Context, aobu, snh, quq>
{
  ...
  @NotNull
  public final quq invoke(@NotNull Context paramContext, @Nullable aobu paramaobu, @Nullable snh paramsnh)
  {
    Intrinsics.checkParameterIsNotNull(paramContext, "context");
    return new quq(paramContext, paramaobu, paramsnh);
  }
}
