...
public final class CellFactory$defaultFeedItemCellMap$1
  extends Lambda
  implements Function3<Context, aoof, sel, qku>
{
  ...
  @NotNull
  public final qku invoke(@NotNull Context paramContext, @Nullable aoof paramaoof, @Nullable sel paramsel)
  {
    Intrinsics.checkParameterIsNotNull(paramContext, "context");
    return new qku(paramContext, paramaoof, paramsel);
  }
}
