...
public final class CellFactory$defaultFeedItemCellMap$1
  extends Lambda
  implements Function3<Context, aobu, snh, qsg>
{
  ...
  @NotNull
  public final qsg invoke(@NotNull Context paramContext, @Nullable aobu paramaobu, @Nullable snh paramsnh)
  {
    Intrinsics.checkParameterIsNotNull(paramContext, "context");
    return new qsg(paramContext, paramaobu, paramsnh);
  }
}
