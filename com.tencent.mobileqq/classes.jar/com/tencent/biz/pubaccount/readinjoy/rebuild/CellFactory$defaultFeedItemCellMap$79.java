...
public final class CellFactory$defaultFeedItemCellMap$79
  extends Lambda
  implements Function3<Context, FaceDecoder, szd, rdb>
{
  ...
  @NotNull
  public final rdb invoke(@NotNull Context paramContext, @Nullable FaceDecoder paramFaceDecoder, @Nullable szd paramszd)
  {
    Intrinsics.checkParameterIsNotNull(paramContext, "context");
    return new rdb(paramContext, paramFaceDecoder, paramszd);
  }
}
