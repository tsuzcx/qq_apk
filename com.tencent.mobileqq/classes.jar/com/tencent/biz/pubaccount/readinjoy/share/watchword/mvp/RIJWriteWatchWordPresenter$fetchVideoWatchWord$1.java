...
{
  public RIJWriteWatchWordPresenter$fetchVideoWatchWord$1(qtj paramqtj, String paramString1, String paramString2)
  {
    super(3);
  }
  ...
  public final void invoke(@Nullable String paramString1, @NotNull String paramString2, boolean paramBoolean)
  {
    ...
    if (paramString1 != null) {
      if (((CharSequence)paramString1).length() > 0)
      {
        ...
        localObject = qtj.a(this.this$0);
        if (localObject != null) {
          ((qsx)localObject).showSuccessToast(qtj.a(this.this$0).a());
        }
        qsw localqsw = qtj.a(this.this$0);
        localObject = this.$title;
        if (localObject == null) {
          break label118;
        }
        label84:
        localqsw.a(paramString1, paramString2, (String)localObject, paramBoolean, 1);
        qsp.a.a().a(paramString1, this.$url);
      }
    }
    label118:
    label125:
    do
    {
      ...
      localObject = "";
      break label84;
      paramString1 = qtj.a(this.this$0);
    } while (paramString1 == null);
    paramString1.showFailedToast(qtj.a(this.this$0).b());
  }
}
