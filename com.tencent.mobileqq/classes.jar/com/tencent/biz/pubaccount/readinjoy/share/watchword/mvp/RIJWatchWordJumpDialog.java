...
public abstract class RIJWatchWordJumpDialog
  implements View.OnClickListener
{
  public static final RIJWatchWordJumpDialog.Companion a;
  @Nullable
  ...
  static
  {
    jdField_a_of_type_ComTencentBizPubaccountReadinjoyShareWatchwordMvpRIJWatchWordJumpDialog$Companion = new RIJWatchWordJumpDialog.Companion(null);
  }
  
  public RIJWatchWordJumpDialog(@NotNull ViewGroup paramViewGroup, @Nullable Function1<? super Integer, Unit> paramFunction1)
  {
    this.jdField_a_of_type_AndroidViewViewGroup = paramViewGroup;
    this.jdField_a_of_type_KotlinJvmFunctionsFunction1 = paramFunction1;
    this.jdField_a_of_type_AndroidViewView = b();
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131364832));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131371859));
    this.b = this.jdField_a_of_type_AndroidViewView.findViewById(2131371077);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131365829));
    c();
  }
  ...
  public final void b(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      ...
      localAlphaAnimation.setDuration(250L);
      localAlphaAnimation.setFillAfter(true);
      localAlphaAnimation.setAnimationListener((Animation.AnimationListener)new RIJWatchWordJumpDialog.dismiss.1(this));
      View localView = this.jdField_a_of_type_AndroidViewView;
      if (localView != null) {
        localView.startAnimation((Animation)localAlphaAnimation);
      }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.share.watchword.mvp.RIJWatchWordJumpDialog
