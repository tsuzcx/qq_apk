...
public final class RIJWriteWatchWordModel
  implements IRIJWriteWatchWordShareContract.IModel
{
  public static final RIJWriteWatchWordModel.Companion a = new RIJWriteWatchWordModel.Companion(null);
  
  @NotNull
  public String a()
  {
    String str = ReadInJoyUtils.a(2131718167);
  ...
  public void a(@NotNull String paramString1, @NotNull String paramString2, @Nullable String paramString3, @NotNull String paramString4, @Nullable Function3<? super String, ? super String, ? super Boolean, Unit> paramFunction3)
  {
    ...
    ProtoUtils.a((AppRuntime)paramString1, (ProtoUtils.TroopProtocolObserver)new RIJWriteWatchWordModel.fetchVideoWatchWord.1(paramFunction3), paramString4.toByteArray(), "OidbSvc.0xe5c", 3676, 1, new Bundle(), 5000L);
  }
  ...
  public void a(@NotNull String paramString1, @NotNull String paramString2, @NotNull String paramString3, @Nullable Function3<? super String, ? super String, ? super Boolean, Unit> paramFunction3)
  {
    ...
    ProtoUtils.a((AppRuntime)paramString1, (ProtoUtils.TroopProtocolObserver)new RIJWriteWatchWordModel.fetchTopicWatchWord.1(paramFunction3), paramString3.toByteArray(), "OidbSvc.0xe5c", 3676, 1, new Bundle(), 5000L);
  }
  ...
  public void a(@NotNull String paramString1, @NotNull String paramString2, @NotNull String paramString3, boolean paramBoolean, int paramInt)
  {
    ...
    if (paramString2 != null) {
      paramString2.setPrimaryClip(ClipData.newPlainText((CharSequence)"RIJShareClip", (CharSequence)RIJWatchWordShareManager.a.a().a(paramString1, paramBoolean, paramInt, paramString3)));
    }
  }
  ...
  public String b()
  {
    String str = ReadInJoyUtils.a(2131718166);
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.share.watchword.mvp.RIJWriteWatchWordModel
