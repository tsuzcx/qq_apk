...
public class ReadInjoyPlayer
  extends LitePlayer
  implements PlayerStatusListener, ReadinjoyPlayerReporter.ReportDelegate
{
  ...
  public ReadInjoyPlayer(int paramInt, String paramString, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoPlayerReadinjoyPlayerReporter = new ReadinjoyPlayerReporter(paramInt, this);
    a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoPlayerReadinjoyPlayerReporter);
    a(this);
  }
  ...
  {
    paramReadinjoyVideoReportData.jdField_a_of_type_Int = this.jdField_a_of_type_Int;
    paramReadinjoyVideoReportData.k = b();
    paramReadinjoyVideoReportData.l = c();
  }
  ...
  public void b(String paramString)
  {
    this.d = paramString;
    if (h()) {
      VideoFeedsHelper.a(new ReadInjoyPlayer.2(this));
    }
  }
  ...
  {
    VideoFeedsHelper.a(new ReadInjoyPlayer.4(this));
  }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.video.player.ReadInjoyPlayer
