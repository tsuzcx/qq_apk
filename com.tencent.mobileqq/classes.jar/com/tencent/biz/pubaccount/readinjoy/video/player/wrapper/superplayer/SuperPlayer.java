  ...
  implements IPlayer, ISuperPlayer.OnCaptureImageListener, ISuperPlayer.OnCompletionListener, ISuperPlayer.OnErrorListener, ISuperPlayer.OnInfoListener, ISuperPlayer.OnSeekCompleteListener, ISuperPlayer.OnVideoPreparedListener
{
  ...
  public void a(@Nullable Context paramContext, @NotNull PlayerVideoInfo paramPlayerVideoInfo, long paramLong, @NotNull SuperPlayerOption paramSuperPlayerOption)
  {
    ...
    {
      localISuperPlayer.openMediaPlayer(paramContext, PlayerVideoInfoKt.a(paramPlayerVideoInfo), paramLong, paramSuperPlayerOption);
      return;
    }
  }
  ...
  {
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoPlayerWrapperIEventListener = paramIEventListener;
  ...
  public void a(@Nullable IVideoView paramIVideoView)
  {
    ...
    label47:
    for (paramIVideoView = paramIVideoView.a();; paramIVideoView = null)
    {
  ...
  public void c()
  {
    ...
    localObject = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoPlayerWrapperIVideoView;
    if (localObject != null)
    {
      ISuperPlayer localISuperPlayer = this.jdField_a_of_type_ComTencentSuperplayerApiISuperPlayer;
      if (localISuperPlayer != null)
  ...
  {
    paramISuperPlayer = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoPlayerWrapperIEventListener;
  ...
  public boolean onInfo(@Nullable ISuperPlayer paramISuperPlayer, int paramInt, long paramLong1, long paramLong2, @Nullable Object paramObject)
  {
    ...
    for (paramISuperPlayer = Long.valueOf(paramLong1);; paramISuperPlayer = paramObject)
    {
      ...
      if (paramInt == 207)
      {
        ...
        paramObject = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoPlayerWrapperIEventListener;
        if (paramObject != null) {
      ...
      paramObject = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoPlayerWrapperIEventListener;
      if ((paramObject != null) && (paramObject.a((IPlayer)this, i, paramISuperPlayer) == true)) {}
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.video.player.wrapper.superplayer.SuperPlayer
