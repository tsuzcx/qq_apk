...
{
  private static final String jdField_a_of_type_JavaLangString = VideoFeedsShuntBarConfigure.class.getSimpleName();
  ...
  public VideoFeedsShuntBarConfigure(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_b_of_type_JavaLangString = ReadInJoyUtils.a();
  }
  ...
  public boolean a(VideoInfo.ECommerceEntranceInfo paramECommerceEntranceInfo)
  {
    ...
    try
    {
      ...
      if (!bool) {
        ReadInJoyHelper.a(this.jdField_b_of_type_JavaLangString + paramECommerceEntranceInfo.g, Integer.valueOf(0));
      }
      if (bool) {}
      for (int i = ((Integer)ReadInJoyHelper.a(this.jdField_b_of_type_JavaLangString + paramECommerceEntranceInfo.g, Integer.valueOf(0))).intValue();; i = 0)
      {
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.video.VideoFeedsShuntBarConfigure
