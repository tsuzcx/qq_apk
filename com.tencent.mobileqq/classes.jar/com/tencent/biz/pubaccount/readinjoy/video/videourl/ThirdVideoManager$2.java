...
{
  ThirdVideoManager$2(ThirdVideoManager paramThirdVideoManager, long paramLong, NewIntent paramNewIntent, ThirdVideoManager.UrlToUUIDCallback paramUrlToUUIDCallback, String paramString) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (!paramBoolean)
    {
      if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideourlThirdVideoManager$UrlToUUIDCallback != null) {
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideourlThirdVideoManager$UrlToUUIDCallback.a(this.jdField_a_of_type_JavaLangString, "error");
      }
      if (QLog.isColorLevel()) {
    ...
    do
    {
      do
      {
        ...
        if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideourlThirdVideoManager$UrlToUUIDCallback != null)
        {
          ...
          this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideourlThirdVideoManager$UrlToUUIDCallback.a(this.jdField_a_of_type_JavaLangString, paramBundle);
        }
      } while (!QLog.isColorLevel());
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.video.videourl.ThirdVideoManager.2
