...
{
  private static final String jdField_d_of_type_JavaLangString = HardCodeUtil.a(2131716748);
  private WeishiManager jdField_a_of_type_ComTencentBizPubaccountReadinjoyEngineWeishiManager = (WeishiManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.WEISHI_MANAGER);
  private WeishiRedDotInfo jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructWeishiRedDotInfo;
  private boolean jdField_d_of_type_Boolean = false;
  private boolean e = false;
  
  public WeishiVideoFeedsLazyLoadDelegate(IVideoFeedsLoadDelegate.LifeCycleCallBack paramLifeCycleCallBack, Bundle paramBundle, QQAppInterface paramQQAppInterface, FragmentActivity paramFragmentActivity, String paramString1, String paramString2, String paramString3, boolean paramBoolean, int paramInt)
  {
    super(paramLifeCycleCallBack, paramBundle, paramQQAppInterface, paramFragmentActivity, paramString1, paramString2, paramString3, paramBoolean, paramInt);
  }
  ...
  private void a(WeishiRedDotInfo paramWeishiRedDotInfo)
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountVideoPlayRecommendHandler.a(this.jdField_a_of_type_ComTencentBizPubaccountVideoPlayRecommendObserver, l1, a(), i, null, str1, l3, true, 0, str2, str3, paramWeishiRedDotInfo, 0, null, null, 0, null, 0);
  }
  ...
  public void a(int paramInt)
  {
    if (paramInt == 0)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130843411);
      return;
    }
    super.a(paramInt);
  }
  ...
  protected boolean a(Bundle paramBundle)
  {
    if (this.jdField_d_of_type_Boolean)
    {
      ...
      if (this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo != null)
      {
        ...
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyEngineWeishiManager.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity);
        return true;
      }
    }
  ...
  void b(VideoInfo paramVideoInfo)
  {
    if ((paramVideoInfo != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyEngineWeishiManager != null))
    {
      if (paramVideoInfo.a == null) {
        VideoFeedsHelper.a(paramVideoInfo);
      }
      long l = NetConnInfoCenter.getServerTime();
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyEngineWeishiManager.a(((IPublicAccountUtil)QRoute.api(IPublicAccountUtil.class)).createStructingMsgBrief(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramVideoInfo.a), l);
    }
  }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.video.WeishiVideoFeedsLazyLoadDelegate
