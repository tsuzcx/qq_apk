...
{
  private static VideoWebPreDownload jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoWebPreDownload = null;
  private static final String jdField_a_of_type_JavaLangString = VideoWebPreDownload.class.getSimpleName();
  private Context jdField_a_of_type_AndroidContentContext;
  private VideoPluginInstall jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoPluginInstall = null;
  private VideoWebPreDownload.CallbackListener jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoWebPreDownload$CallbackListener = null;
  ...
  private void a(String paramString1, int paramInt1, long paramLong, int paramInt2, String paramString2)
  {
    ...
    do
    {
      ...
      } while (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoWebPreDownload$CallbackListener == null);
      paramString2 = (String)this.jdField_a_of_type_JavaUtilHashMap.get(paramString1);
    } while (TextUtils.isEmpty(paramString2));
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoWebPreDownload$CallbackListener.a(paramString1, 1, paramString2);
  }
  ...
  private void a(String paramString1, String paramString2, long paramLong, int paramInt)
  {
    ...
    ((TVK_PlayerVideoInfo)localObject).setConfigMap("cache_servers_type", VideoPlayUtils.jdField_a_of_type_JavaLangString);
    if (paramLong > 0L) {
  ...
  public void a(VideoWebPreDownload.CallbackListener paramCallbackListener)
  {
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoWebPreDownload$CallbackListener = paramCallbackListener;
  }
  ...
  public void b()
  {
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoWebPreDownload$CallbackListener = null;
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.video.VideoWebPreDownload
