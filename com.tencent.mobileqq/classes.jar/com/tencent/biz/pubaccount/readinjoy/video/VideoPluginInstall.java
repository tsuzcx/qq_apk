...
public class VideoPluginInstall
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(new mdx(this));
  ...
  private void c()
  {
    try
    {
      if (!b)
      {
        ...
        TVK_SDKMgr.setOnLogListener(new mdz(null));
  ...
  public void a()
  {
    if ((!a()) && (!this.jdField_a_of_type_Boolean)) {
      ThreadManager.post(new mdw(this), 8, null, true);
    }
  }
