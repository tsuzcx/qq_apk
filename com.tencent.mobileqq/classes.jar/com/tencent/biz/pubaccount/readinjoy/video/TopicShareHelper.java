  ...
  implements AdapterView.OnItemClickListener
{
  ...
  private View a()
  {
    ...
    ((TextView)localObject1).setOnClickListener(new lze(this));
    this.jdField_a_of_type_ComTencentWidgetActionSheet.setOnDismissListener(new lzf(this));
    ...
    for (localObject2 = localObject2[1];; localObject2 = new ArrayList(0))
    {
      ...
      localView.post(new lzg(this, localElasticHorScrView1, i, localElasticHorScrView2, ((ViewGroup.LayoutParams)localObject1).width));
      return localView;
  ...
  private void a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        ThreadManager.executeOnSubThread(new lzi(this, paramString4, paramString1, paramString3, (ApplicationInfo)localObject, paramString2));
      }
  ...
  private void b()
  {
    ...
    this.jdField_a_of_type_ComTencentImageURLDrawable.setURLDrawableListener(new lzd(this));
  ...
  public void onItemClick(AdapterView paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    for (;;)
    {
      ThreadManager.executeOnSubThread(new lzh(this, paramInt + ""));
      return;
      if (i == 3)
      {
        this.jdField_a_of_type_Boolean = false;
