  ...
  implements View.OnClickListener, DownloadListener
{
  ...
  private void a(Context paramContext)
  {
    ...
    this.c.setOnClickListener(new sov(this));
  ...
  {
    if (this.jdField_a_of_type_Omr == null)
    {
      setVisibility(8);
      return;
    }
    if (!DateUtils.isToday(bhhr.b("ug_prefix_ug_1get3_ug_show_time")))
    {
      bhhr.a("ug_prefix_ug_1get3_ug_show_time", System.currentTimeMillis());
      bhhr.a("ug_prefix_ug_1get3_ug_click_count" + this.jdField_a_of_type_Omr.n, 0);
      bhhr.a("ug_prefix_ug_1get3_ug_exp_count" + this.jdField_a_of_type_Omr.n, 0);
    }
    if (DateUtils.isToday(bhhr.b("ug_prefix_ug_1get3_ug_close_time")))
    {
      setVisibility(8);
      return;
    }
    if (bhhr.a("ug_prefix_ug_1get3_ug_click_count" + this.jdField_a_of_type_Omr.n) >= this.jdField_a_of_type_Omr.jdField_a_of_type_Int)
    {
      setVisibility(8);
      return;
    }
    if (bhhr.a("ug_prefix_ug_1get3_ug_exp_count" + this.jdField_a_of_type_Omr.n) >= this.jdField_a_of_type_Omr.jdField_b_of_type_Int)
    {
      setVisibility(8);
      return;
    }
    if ((this.jdField_a_of_type_Omr.jdField_c_of_type_Int == 1) && (bhfn.a(BaseApplicationImpl.getContext(), this.jdField_a_of_type_Omr.j)))
    {
      setVisibility(8);
      return;
    }
    if ((this.jdField_a_of_type_Omr.jdField_c_of_type_Int == 2) && (!bhfn.a(BaseApplicationImpl.getContext(), this.jdField_a_of_type_Omr.j)))
    {
      setVisibility(8);
      return;
    }
    if (paramBoolean)
    {
      bhhr.a("ug_prefix_ug_1get3_ug_exp_count" + this.jdField_a_of_type_Omr.n, bhhr.a("ug_prefix_ug_1get3_ug_exp_count" + this.jdField_a_of_type_Omr.n) + 1);
      oqt.a(oqt.b(this.jdField_a_of_type_Omr.i, "2", this.jdField_a_of_type_JavaLangString));
    }
    setVisibility(0);
    if (this.jdField_a_of_type_Omr.jdField_c_of_type_Int == 2)
    {
    ...
    for (;;)
    {
      ...
      invalidate();
      return;
      localDownloadInfo = bjjq.a().b(this.jdField_a_of_type_Omr.f);
    ...
    if (localDownloadInfo.a() == 4) {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Omr.m);
    }
    for (;;)
    {
      ...
      if ((localDownloadInfo.a() == 20) || (localDownloadInfo.a() == 1) || (localDownloadInfo.a() == 2)) {
        this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Omr.k + localDownloadInfo.f + "%");
      } else {
        this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Omr.l);
      }
    }
  }
  ...
  private void b()
  {
    ...
    try
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(Color.parseColor(this.jdField_a_of_type_Omr.e));
      label25:
      ...
      setBackgroundDrawable(URLDrawable.getDrawable(this.jdField_a_of_type_Omr.jdField_a_of_type_JavaLangString, (URLDrawable.URLDrawableOptions)localObject));
      ...
      localObject = URLDrawable.getDrawable(this.jdField_a_of_type_Omr.jdField_b_of_type_JavaLangString, (URLDrawable.URLDrawableOptions)localObject);
      ...
      localObject = URLDrawable.getDrawable(this.jdField_a_of_type_Omr.jdField_c_of_type_JavaLangString, (URLDrawable.URLDrawableOptions)localObject);
      ...
      localObject = URLDrawable.getDrawable(this.jdField_a_of_type_Omr.d, (URLDrawable.URLDrawableOptions)localObject);
  ...
  public void a()
  {
    this.jdField_a_of_type_Omr = null;
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Omr.jdField_c_of_type_Int == 2)
      {
        ...
        ((Intent)localObject).setData(Uri.parse(this.jdField_a_of_type_Omr.g));
        if (six.a(getContext(), (Intent)localObject)) {
          getContext().startActivity((Intent)localObject);
        }
        oqt.a(oqt.b(this.jdField_a_of_type_Omr.i, "7", this.jdField_a_of_type_JavaLangString));
        bhhr.a("ug_prefix_ug_1get3_ug_click_count" + this.jdField_a_of_type_Omr.n, bhhr.a("ug_prefix_ug_1get3_ug_click_count" + this.jdField_a_of_type_Omr.n) + 1);
        continue;
      }
      Object localObject = new sou();
      ((sou)localObject).jdField_c_of_type_JavaLangString = this.jdField_a_of_type_Omr.f;
      ((sou)localObject).jdField_a_of_type_JavaLangString = this.jdField_a_of_type_Omr.i;
      ((sou)localObject).jdField_b_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
      jdField_a_of_type_Sot.a(this.jdField_a_of_type_Omr.j, (sou)localObject);
      bjjq.a().a(jdField_a_of_type_Sot);
      localObject = this.jdField_a_of_type_Omr.h;
      try
      {
        ((ClipboardManager)getContext().getSystemService("clipboard")).setText((CharSequence)localObject);
        label254:
        oqt.a(oqt.b(this.jdField_a_of_type_Omr.i, "3", this.jdField_a_of_type_JavaLangString));
        this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
        this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
        localObject = bjjq.a().b(this.jdField_a_of_type_Omr.f);
        if (localObject == null)
        {
          localObject = new DownloadInfo();
          ((DownloadInfo)localObject).d = this.jdField_a_of_type_Omr.f;
          ((DownloadInfo)localObject).m = "biz_src_kandian_videos";
          ((DownloadInfo)localObject).e = this.jdField_a_of_type_Omr.j;
          bjjq.a().b((DownloadInfo)localObject);
          bhhr.a("ug_prefix_ug_1get3_ug_click_count" + this.jdField_a_of_type_Omr.n, bhhr.a("ug_prefix_ug_1get3_ug_click_count" + this.jdField_a_of_type_Omr.n) + 1);
          oqt.a(oqt.b(this.jdField_a_of_type_Omr.i, "9", this.jdField_a_of_type_JavaLangString));
          oqt.a(oqt.b(this.jdField_a_of_type_Omr.i, "10", this.jdField_a_of_type_JavaLangString));
          this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Omr.k + "0%");
          this.jdField_a_of_type_Int = 0;
          continue;
        }
        if (((DownloadInfo)localObject).a() == 4)
        {
          oqt.a(oqt.b(this.jdField_a_of_type_Omr.i, "102", this.jdField_a_of_type_JavaLangString));
          oqt.a(oqt.b(this.jdField_a_of_type_Omr.i, "20", this.jdField_a_of_type_JavaLangString));
          if (!bjjq.a().a((DownloadInfo)localObject)) {
            bjjq.a().b((DownloadInfo)localObject);
          }
          bhhr.a("ug_prefix_ug_1get3_ug_click_count" + this.jdField_a_of_type_Omr.n, bhhr.a("ug_prefix_ug_1get3_ug_click_count" + this.jdField_a_of_type_Omr.n) + 1);
          this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Omr.m);
        ...
        {
          oqt.a(oqt.b(this.jdField_a_of_type_Omr.i, "22", this.jdField_a_of_type_JavaLangString));
          bjjq.a().a(this.jdField_a_of_type_Omr.f);
          this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Omr.l);
          continue;
        }
        bjjq.a().b((DownloadInfo)localObject);
        bhhr.a("ug_prefix_ug_1get3_ug_click_count" + this.jdField_a_of_type_Omr.n, bhhr.a("ug_prefix_ug_1get3_ug_click_count" + this.jdField_a_of_type_Omr.n) + 1);
        oqt.a(oqt.b(this.jdField_a_of_type_Omr.i, "10", this.jdField_a_of_type_JavaLangString));
        this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Omr.k + ((DownloadInfo)localObject).f + "%");
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    if ((this.jdField_a_of_type_Omr != null) && (this.jdField_a_of_type_Int != 0))
    {
      paramCanvas.save();
  ...
  public void setInfo(omr paramomr, String paramString1, String paramString2)
  {
