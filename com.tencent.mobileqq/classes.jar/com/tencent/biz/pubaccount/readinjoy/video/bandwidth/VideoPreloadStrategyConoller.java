...
public class VideoPreloadStrategyConoller
{
  ...
  {
    return Math.round(((Float)ReadInJoyHelper.a(a(paramString), Float.valueOf(0.0F))).floatValue());
  }
  ...
  {
    float f = ((Float)ReadInJoyHelper.a(a(paramString), Float.valueOf(0.0F))).floatValue();
    if (f > 0.0F) {}
    for (f = f * 0.5F + paramInt * 0.5F;; f = paramInt)
    {
      ReadInJoyHelper.a(paramString + "_watch_length", Float.valueOf(f));
      if (QLog.isColorLevel()) {
  ...
  {
    long l1 = BandwidthPredictor.a().a();
  ...
  public boolean a(VideoPlayerWrapper paramVideoPlayerWrapper)
  {
    ...
    {
      i = j;
      if (paramVideoPlayerWrapper.b() > 0L) {
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.video.bandwidth.VideoPreloadStrategyConoller
