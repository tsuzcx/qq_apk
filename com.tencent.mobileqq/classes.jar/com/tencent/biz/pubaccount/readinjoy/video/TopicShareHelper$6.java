  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    String str = ImageUtil.a(TopicShareHelper.a(this.this$0), this.jdField_a_of_type_JavaLangString, null);
    if (QLog.isColorLevel()) {
    ...
    for (int i = TopicShareHelper.a(this.this$0).mChannelID;; i = 0)
    {
      localIntent.putExtra("big_brother_source_key", RIJJumpUtils.a(i));
