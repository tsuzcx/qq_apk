...
public class TopicShareHelper$6
  implements Runnable
{
  public TopicShareHelper$6(qkl paramqkl, String paramString1, String paramString2, String paramString3, ApplicationInfo paramApplicationInfo, Activity paramActivity) {}
  ...
  public void run()
  {
    ...
    String str = nam.a(qkl.a(this.this$0), this.jdField_a_of_type_JavaLangString, null);
    if (QLog.isColorLevel()) {
    ...
    if (qkl.a(this.this$0) != null) {}
    for (int i = qkl.a(this.this$0).mChannelID;; i = 0)
    {
      localIntent.putExtra("big_brother_source_key", onh.f(i));
