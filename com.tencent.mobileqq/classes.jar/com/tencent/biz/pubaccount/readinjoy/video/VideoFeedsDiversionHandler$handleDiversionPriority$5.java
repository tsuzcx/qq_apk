  ...
  implements Function0<Unit>
{
  ...
  {
    VideoInfo.UGDownloadInfo localUGDownloadInfo1 = this.$videoInfo.a;
    VideoInfo.UGDownloadInfo localUGDownloadInfo2 = this.$videoInfo.b;
    VideoFeedsDiversionHandler.a(VideoFeedsDiversionHandler.a, this.$videoInfo);
    this.$videoInfo.a = localUGDownloadInfo1;
    this.$videoInfo.b = localUGDownloadInfo2;
  }
}
