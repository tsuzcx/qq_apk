...
{
  private static final String d = HardCodeUtil.a(2131715983);
  private static final String e = HardCodeUtil.a(2131716007);
  private static final String f = HardCodeUtil.a(2131716027);
  ...
  public VideoFeedsLazyLoadDelegate(IVideoFeedsLoadDelegate.LifeCycleCallBack paramLifeCycleCallBack, Bundle paramBundle, QQAppInterface paramQQAppInterface, FragmentActivity paramFragmentActivity, String paramString1, String paramString2, String paramString3, boolean paramBoolean, int paramInt)
  {
  ...
  {
    paramLayoutInflater = paramLayoutInflater.inflate(2131560435, paramViewGroup, false);
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)paramLayoutInflater.findViewById(2131381336));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramLayoutInflater.findViewById(2131381351));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramLayoutInflater.findViewById(2131381373));
    paramLayoutInflater.findViewById(2131381334).setOnClickListener(this);
    b();
    a(0);
  ...
  protected VideoFeedsRecommendFragment a()
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountVideoPlayRecommendObserver = new VideoFeedsLazyLoadDelegate.1(this);
    this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.addObserver(this.jdField_a_of_type_ComTencentBizPubaccountVideoPlayRecommendObserver);
    d();
    return null;
  }
  ...
  protected void a()
  {
    this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.removeObserver(this.jdField_a_of_type_ComTencentBizPubaccountVideoPlayRecommendObserver);
    this.jdField_a_of_type_ComTencentBizPubaccountVideoPlayRecommendObserver = null;
  ...
  {
    VideoFeedsHelper.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity);
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsRecommendFragment.b(1);
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoIVideoFeedsLoadDelegate$LifeCycleCallBack != null) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoIVideoFeedsLoadDelegate$LifeCycleCallBack.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsRecommendFragment);
    }
  ...
  public void a(DragFrameLayout paramDragFrameLayout)
  {
    ...
    int[] arrayOfInt = VideoFeedsHelper.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity);
    int j = arrayOfInt[0];
    int m = arrayOfInt[1];
    if ((i1 == 0) || (i == 0))
    {
    ...
    for (j = (m - i) / 2;; j = arrayOfInt[1])
    {
      ...
      return;
      arrayOfInt = VideoFeedsHelper.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, k, n);
      k = arrayOfInt[0];
    }
  }
  ...
  protected void c()
  {
    if (this.jdField_a_of_type_Boolean)
    {
      d();
      this.jdField_a_of_type_Boolean = false;
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130843284);
  ...
  protected void d()
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountVideoPlayRecommendHandler.a(this.jdField_a_of_type_ComTencentBizPubaccountVideoPlayRecommendObserver, l1, a(), i, null, str1, l3, true, 0, str2, str3, null, 0, null, null, 0, null, 0);
  }
