  ...
  extends GestureDetector.SimpleOnGestureListener
{
  ...
  {
    if ((ADVideoItemDelegate.a(this.a) != null) && (ADVideoItemDelegate.a(this.a).jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsGestureLayout != null)) {
      this.a.a.a(ADVideoItemDelegate.a(this.a).jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsGestureLayout, (int)paramMotionEvent.getX(), (int)paramMotionEvent.getY());
    }
    return true;
  }
