  ...
  extends IBandwidthPredictor
{
  ...
  private MoveAvgPredictor jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoBandwidthMoveAvgPredictor;
  ...
  public ExoPredictor(float paramFloat)
  {
    ...
    this.b = 500;
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoBandwidthMoveAvgPredictor = new MoveAvgPredictor((int)paramFloat);
    a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoBandwidthMoveAvgPredictor);
  }
  
  private void c()
  {
    int i = (int)(Math.sqrt(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoBandwidthMoveAvgPredictor.a) * this.jdField_a_of_type_Float);
    if (i > 0) {
      this.b = i;
    }
  }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.video.bandwidth.ExoPredictor
