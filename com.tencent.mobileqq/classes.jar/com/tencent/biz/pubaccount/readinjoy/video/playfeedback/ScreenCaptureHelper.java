...
public final class ScreenCaptureHelper
{
  ...
  static
  {
    jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoPlayfeedbackScreenCaptureHelper$Companion = new ScreenCaptureHelper.Companion(null);
  }
  ...
  private final void a(Bitmap paramBitmap, IImageUploadListener paramIImageUploadListener)
  {
    ...
    SavePicTask localSavePicTask = new SavePicTask(paramBitmap, str);
    localSavePicTask.a((URLDrawable.DownloadListener)new ScreenCaptureHelper.saveBitmapAndUpload.1(this, str, paramIImageUploadListener, paramBitmap));
    localSavePicTask.a();
  }
  ...
  private final void a(Bitmap paramBitmap, ScreenCaptureHelper.CaptureViewCallback paramCaptureViewCallback)
  {
    ...
    label30:
    while (paramCaptureViewCallback == null)
    {
      return;
      i = 0;
      break;
  ...
  private final boolean b(TextureView paramTextureView)
  {
    ...
    tmp9_5;
    paramTextureView.getLocationOnScreen(arrayOfInt);
    if ((arrayOfInt[0] < 0) || (arrayOfInt[0] > DisplayUtil.a((Context)BaseApplicationImpl.getContext()))) {
      return false;
    }
    return (arrayOfInt[1] >= 0) && (arrayOfInt[1] <= DisplayUtil.b((Context)BaseApplicationImpl.getContext()));
  }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.video.playfeedback.ScreenCaptureHelper
