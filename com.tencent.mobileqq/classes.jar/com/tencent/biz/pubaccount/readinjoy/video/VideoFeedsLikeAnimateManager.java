...
public class VideoFeedsLikeAnimateManager
{
  ...
  private VideoFeedsLikeAnimateHandler jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsLikeAnimateHandler;
  private VideoFeedsLikeAnimateManager.LikeAnimateObserver jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsLikeAnimateManager$LikeAnimateObserver;
    ...
    do
    {
      do
      {
        do
        {
          ...
          jdField_a_of_type_Int = AIOUtils.a(28.0F, paramActivity.getResources());
          this.jdField_a_of_type_AndroidViewViewGroup.getLocationInWindow(this.jdField_a_of_type_ArrayOfInt);
          this.jdField_a_of_type_JavaUtilRandom = new Random();
          paramActivity = a();
          if (paramActivity != null)
          {
            this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsLikeAnimateHandler = ((VideoFeedsLikeAnimateHandler)paramActivity.getBusinessHandler(BusinessHandlerFactory.VIDEO_FEEDS_LIKE_ANIMATION_CONFIG));
            this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsLikeAnimateManager$LikeAnimateObserver = new VideoFeedsLikeAnimateManager.LikeAnimateObserver(this);
            paramActivity.addObserver(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsLikeAnimateManager$LikeAnimateObserver);
          }
          this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoLikeAnimationInfo = ReadInJoyHelper.a();
          if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoLikeAnimationInfo == null) {
            break label236;
          }
          if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsLikeAnimateHandler == null) || (!ReadInJoyHelper.b(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoLikeAnimationInfo.jdField_a_of_type_Int))) {
            break;
          }
          this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsLikeAnimateHandler.a(paramInt);
      ...
      return;
    } while (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsLikeAnimateHandler == null);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsLikeAnimateHandler.a(paramInt);
    ReadInJoyHelper.a(System.currentTimeMillis());
  }
  ...
  public void a()
  {
    ...
    if (localQQAppInterface != null) {
      localQQAppInterface.removeObserver(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsLikeAnimateManager$LikeAnimateObserver);
    }
  }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.video.VideoFeedsLikeAnimateManager
