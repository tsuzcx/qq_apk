...
public class OrientationDetector
{
  ...
  private volatile OrientationDetector.RotationObserver jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoOrientationDetector$RotationObserver;
  ...
  public OrientationDetector(Activity paramActivity, OrientationDetector.OnOrientationChangedListener paramOnOrientationChangedListener)
  {
    ...
    {
      this.jdField_a_of_type_AndroidViewOrientationEventListener = new OrientationDetector.1(this, paramActivity, new WeakReference(paramOnOrientationChangedListener));
  ...
  public void a()
  {
    ...
    a(false, true);
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoOrientationDetector$RotationObserver != null)
    {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoOrientationDetector$RotationObserver.b();
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoOrientationDetector$RotationObserver = null;
    }
  }
