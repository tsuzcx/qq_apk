  ...
  extends View
{
  ...
  private List<rxy> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  public void a()
  {
    ...
    localAnimatorSet.addListener(new rxv(this));
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      ...
      while (localIterator.hasNext()) {
        ((rxy)localIterator.next()).a(paramCanvas);
      }
    }
  }
        ...
        while (i < 4)
        {
          ...
          for (;;)
          {
            ...
            try
            {
              ...
              this.jdField_a_of_type_JavaUtilList.add(new rxw(this, m));
              j += 1;
            }
  ...
  public void setExplosionFraction(float paramFloat)
  {
    ...
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
      ((rxy)localIterator.next()).a(paramFloat);
    }
    invalidate();
  }
  ...
  public void setExplosionSize(int paramInt)
  {
    ...
    while (i < paramInt)
    {
      this.jdField_a_of_type_JavaUtilList.add(new rxw(this));
      i += 1;
    }
  }
    ...
    do
    {
      ...
      while (i < paramInt1) {
        try
        {
          ...
          this.jdField_a_of_type_JavaUtilList.add(new rxx(this, paramArrayOfDrawable[j], paramInt2, arrayOfInt[k]));
          i += 1;
        }
  ...
  public void setIconExplosionEachDirection(Drawable[] paramArrayOfDrawable, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      if (j < paramInt1)
      {
        ...
        this.jdField_a_of_type_JavaUtilList.add(new rxx(this, paramArrayOfDrawable[m], paramInt2, arrayOfInt[n], i1));
        j += 1;
      }
      else
      {
