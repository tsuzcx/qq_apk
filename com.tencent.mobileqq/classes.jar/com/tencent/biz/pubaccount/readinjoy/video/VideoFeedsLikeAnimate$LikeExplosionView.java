  ...
  extends View
{
  ...
  public void a()
  {
    ...
    localAnimatorSet.addListener(new reu(this));
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      ...
      while (localIterator.hasNext()) {
        ((rex)localIterator.next()).a(paramCanvas);
      }
    }
  }
        ...
        while (i < 4)
        {
          ...
          for (;;)
          {
            ...
            try
            {
              ...
              this.jdField_a_of_type_JavaUtilList.add(new rev(this, m));
              j += 1;
            }
  ...
  public void setExplosionFraction(float paramFloat)
  {
    ...
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
      ((rex)localIterator.next()).a(paramFloat);
    }
    invalidate();
  }
  ...
  public void setExplosionSize(int paramInt)
  {
    ...
    while (i < paramInt)
    {
      this.jdField_a_of_type_JavaUtilList.add(new rev(this));
      i += 1;
    }
  }
    ...
    do
    {
      ...
      while (i < paramInt1) {
        try
        {
          ...
          this.jdField_a_of_type_JavaUtilList.add(new rew(this, paramArrayOfDrawable[j], paramInt2, arrayOfInt[k]));
          i += 1;
        }
  ...
  public void setIconExplosionEachDirection(Drawable[] paramArrayOfDrawable, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      if (j < paramInt1)
      {
        ...
        this.jdField_a_of_type_JavaUtilList.add(new rew(this, paramArrayOfDrawable[m], paramInt2, arrayOfInt[n], i1));
        j += 1;
      }
      else
      {
