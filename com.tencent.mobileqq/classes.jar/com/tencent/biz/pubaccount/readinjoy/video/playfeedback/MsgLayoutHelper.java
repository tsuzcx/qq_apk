...
public class MsgLayoutHelper
{
  ...
  {
    a(paramInt, paramString1, paramString2, 2130843382);
  }
  ...
  public void a(int paramInt1, String paramString1, String paramString2, int paramInt2)
  {
    if (this.jdField_b_of_type_AndroidViewView == null)
    {
      this.jdField_b_of_type_AndroidViewView = ((ViewStub)this.jdField_a_of_type_AndroidViewView.findViewById(2131366415)).inflate();
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131366417));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131366410));
      this.c = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131381440));
    ...
    paramInt2 = DisplayUtil.b(this.jdField_a_of_type_AndroidContentContext, 18.6F);
    ...
    this.jdField_b_of_type_AndroidWidgetTextView.setCompoundDrawablePadding(AIOUtils.a(6.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
    this.jdField_a_of_type_AndroidWidgetTextView.setText(paramString1);
    this.jdField_b_of_type_AndroidWidgetTextView.setText(paramString2);
    if (paramInt1 == 1)
    {
      this.c.setVisibility(0);
      paramString1 = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841978);
      paramInt1 = DisplayUtil.b(this.jdField_a_of_type_AndroidContentContext, 18.6F);
      paramString1.setBounds(0, 0, paramInt1, paramInt1);
      this.c.setCompoundDrawables(paramString1, null, null, null);
      this.c.setCompoundDrawablePadding(AIOUtils.a(6.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      return;
    }
  ...
  {
    if (this.jdField_b_of_type_AndroidViewView != null) {
      VideoFeedsHelper.a(this.jdField_b_of_type_AndroidViewView, 8, 300, true);
    }
  }
}
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.video.playfeedback.MsgLayoutHelper
