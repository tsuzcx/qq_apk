  ...
  implements Runnable
{
  ...
  public VideoPreDownloadMgr$PreDownloadSerialTask(List<qul> paramList)
  {
    Object localObject;
    this.a = localObject;
  }
  ...
  public void run()
  {
    ...
    do
    {
      ...
      {
        localObject1 = (qul)this.a.get(i);
        j = i;
        if (VideoPreDownloadMgr.a(this.this$0).contains(((qul)localObject1).jdField_a_of_type_JavaLangString))
        {
          this.a.remove(i);
          j = i - 1;
        }
      ...
      if (!VideoPreDownloadMgr.a(this.this$0).a()) {
        ...
        {
          j = i;
          if (!((qul)this.a.get(i)).jdField_a_of_type_Boolean)
          {
            this.a.remove(i);
            j = i - 1;
          }
      ...
      if (QLog.isColorLevel())
      {
        ...
        qul localqul;
        for (localObject1 = ""; ((Iterator)localObject2).hasNext(); localObject1 = (String)localObject1 + localqul.jdField_a_of_type_JavaLangString + " | ") {
          localqul = (qul)((Iterator)localObject2).next();
        }
        QLog.i(VideoPreDownloadMgr.a(), 2, "当前预下载列表: " + (String)localObject1);
      }
    } while (this.a.size() == 0);
    Object localObject1 = (qul)this.a.get(0);
    ...
    if (((String)localObject2).equals(((qul)localObject1).jdField_a_of_type_JavaLangString))
    {
      if (QLog.isColorLevel()) {
