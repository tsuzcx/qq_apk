  ...
  implements Runnable
{
  ...
  public VideoPreDownloadMgr$PreDownloadSerialTask(List<qig> paramList)
  {
    Object localObject;
    this.a = localObject;
  }
  ...
  public void run()
  {
    ...
    do
    {
      ...
      {
        localObject1 = (qig)this.a.get(i);
        j = i;
        if (VideoPreDownloadMgr.a(this.this$0).contains(((qig)localObject1).jdField_a_of_type_JavaLangString))
        {
          this.a.remove(i);
          j = i - 1;
        }
      ...
      if (!VideoPreDownloadMgr.a(this.this$0).a()) {
        ...
        {
          j = i;
          if (!((qig)this.a.get(i)).jdField_a_of_type_Boolean)
          {
            this.a.remove(i);
            j = i - 1;
          }
      ...
      if (QLog.isColorLevel())
      {
        ...
        qig localqig;
        for (localObject1 = ""; ((Iterator)localObject2).hasNext(); localObject1 = (String)localObject1 + localqig.jdField_a_of_type_JavaLangString + " | ") {
          localqig = (qig)((Iterator)localObject2).next();
        }
        QLog.i(VideoPreDownloadMgr.a(), 2, "当前预下载列表: " + (String)localObject1);
      }
    } while (this.a.size() == 0);
    Object localObject1 = (qig)this.a.get(0);
    ...
    if (((String)localObject2).equals(((qig)localObject1).jdField_a_of_type_JavaLangString))
    {
      if (QLog.isColorLevel()) {
