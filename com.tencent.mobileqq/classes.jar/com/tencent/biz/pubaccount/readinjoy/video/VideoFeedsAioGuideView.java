  ...
  implements View.OnClickListener
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajjy.a(2131650388);
  }
  ...
  public VideoFeedsAioGuideView(Activity paramActivity, QQAppInterface paramQQAppInterface, VideoFeedsRecyclerView paramVideoFeedsRecyclerView)
  {
    ...
    this.jdField_a_of_type_Int = azvv.a(paramActivity, 5.0F);
    setVisibility(8);
  }
  
  private void d()
  {
    setBackgroundResource(2130842097);
    int i = azvv.a(this.jdField_a_of_type_AndroidAppActivity, 6.0F);
    int j = azvv.a(this.jdField_a_of_type_AndroidAppActivity, 3.0F);
    setPadding(i, j, i, j);
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130842456);
    this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130842456);
    FrameLayout.LayoutParams localLayoutParams = new FrameLayout.LayoutParams(-2, -2);
    localLayoutParams.gravity = 19;
    localLayoutParams.rightMargin = azvv.a(this.jdField_a_of_type_AndroidAppActivity, 10.0F);
    addView(this.jdField_a_of_type_AndroidWidgetTextView, localLayoutParams);
    localLayoutParams = new FrameLayout.LayoutParams(-2, -2);
    localLayoutParams.gravity = 21;
    localLayoutParams.topMargin = (-azvv.a(this.jdField_a_of_type_AndroidAppActivity, 2.0F));
    addView(this.jdField_a_of_type_AndroidWidgetImageView, localLayoutParams);
    localLayoutParams = new FrameLayout.LayoutParams(-2, -2);
    localLayoutParams.gravity = 21;
    localLayoutParams.topMargin = azvv.a(this.jdField_a_of_type_AndroidAppActivity, 3.0F);
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_AndroidViewAnimationAnimation == null)
    {
      ...
      this.jdField_a_of_type_AndroidViewAnimationAnimation.setAnimationListener(new qav(this));
    }
    if (this.jdField_b_of_type_AndroidViewAnimationAnimation == null)
    {
      ...
      this.jdField_b_of_type_AndroidViewAnimationAnimation.setAnimationListener(new qaw(this));
    }
    ...
    if (!this.jdField_b_of_type_Boolean)
    {
      ...
      ndn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.j, "0X8009833", "0X8009833", 0, 0, "", "", "", localqmv.a().a(), false);
    }
  }
  
  public void a(qap paramqap)
  {
    this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo = paramqap.a.jdField_a_of_type_ComTencentBizPubaccountVideoInfo;
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetFrameLayout$LayoutParams.bottomMargin = azvv.a(this.jdField_a_of_type_AndroidAppActivity, 63.0F);
      this.jdField_a_of_type_AndroidWidgetFrameLayout$LayoutParams.rightMargin = azvv.a(this.jdField_a_of_type_AndroidAppActivity, 12.0F);
      setOnClickListener(this);
    }
    if (getParent() != paramqap.d)
    {
      if (getParent() != null) {
        ((ViewGroup)getParent()).removeView(this);
      }
      paramqap.d.addView(this, this.jdField_a_of_type_AndroidWidgetFrameLayout$LayoutParams);
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    paramView = new qmv(this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo);
    ndn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.j, "0X8009834", "0X8009834", 0, 0, "", "", "", paramView.a().a(), false);
  }
}
