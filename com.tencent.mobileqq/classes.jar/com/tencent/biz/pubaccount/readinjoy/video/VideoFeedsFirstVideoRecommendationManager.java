...
{
  private static final String jdField_a_of_type_JavaLangString = VideoFeedsFirstVideoRecommendationManager.class.getSimpleName();
  ...
  private VideoFeedsFirstVideoRecommendationManager.VideoFeedsFirstVideoObserver jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsFirstVideoRecommendationManager$VideoFeedsFirstVideoObserver;
  ...
  public VideoFeedsFirstVideoRecommendationManager(ColorBandVideoEntranceButton paramColorBandVideoEntranceButton, Context paramContext)
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_ComTencentBizPubaccountVideoPlayRecommendHandler = ((VideoPlayRecommendHandler)paramColorBandVideoEntranceButton.getBusinessHandler(BusinessHandlerFactory.VIDEOPLAYRECOMMEND_HANDLER));
      this.jdField_a_of_type_ComTencentBizPubaccountVideoPlayRecommendObserver = new VideoFeedsFirstVideoRecommendationManager.VideoFeedsFirstRecommendObserver(this);
      paramColorBandVideoEntranceButton.addObserver(this.jdField_a_of_type_ComTencentBizPubaccountVideoPlayRecommendObserver);
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsFirstVideoRecommendationManager$VideoFeedsFirstVideoObserver = new VideoFeedsFirstVideoRecommendationManager.VideoFeedsFirstVideoObserver(this, null);
      ReadInJoyLogicEngineEventDispatcher.a().a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsFirstVideoRecommendationManager$VideoFeedsFirstVideoObserver);
      return;
      label130:
      if (ReadInJoyHelper.f() == 2)
      {
  ...
  {
    SharedPreferences localSharedPreferences = ReadInJoyHelper.a(this.jdField_c_of_type_JavaLangString);
  ...
  private VideoInfo a()
  {
    Object localObject = ReadInJoyHelper.a(this.jdField_c_of_type_JavaLangString);
  ...
  private void a(VideoInfo.EntranceDownloadInfo paramEntranceDownloadInfo)
  {
    ...
    do
    {
      ...
      {
        return;
        i = EntranceButtonExposureHelper.a().b();
        j = VideoFeedsHelper.j();
        if ((j <= 0) || (i < j)) {
          break;
        }
    ...
    do
    {
      ...
      do
      {
        ...
        for (;;)
        {
          try
          {
            if (!(paramIEntranceButtonDataSource instanceof VideoInfo)) {
              break label277;
            }
            localObject = (VideoInfo)paramIEntranceButtonDataSource;
            ...
            if (localObject != null)
            {
              ...
              paramIEntranceButtonDataSource = ((VideoInfo)localObject).jdField_g_of_type_JavaLangString;
              ...
              ((IPublicAccountReportUtils)QRoute.api(IPublicAccountReportUtils.class)).publicAccountReportClickEvent(null, "", "0X8009A22", "0X8009A22", 0, 0, "", "", "", RIJVideoReportManager.a((VideoInfo)localObject, i), false);
              return;
            }
          }
          ...
          i = 1;
          continue;
          paramIEntranceButtonDataSource = "";
        }
      } while (i != 2);
      ((IPublicAccountReportUtils)QRoute.api(IPublicAccountReportUtils.class)).publicAccountReportClickEvent(null, "", "0X80094FE", "0X80094FE", 0, 0, "", "", "", RIJVideoReportManager.a((VideoInfo)localObject, i), false);
      return;
    } while (!(paramIEntranceButtonDataSource instanceof VideoInfo.EntranceDownloadInfo));
    label277:
  ...
  private void e()
  {
    ...
    {
      localObject = ReadInJoyHelper.a(this.jdField_c_of_type_JavaLangString);
      if (localObject != null) {
  ...
  {
    boolean bool;
    if ((this.jdField_a_of_type_ComTencentBizPubaccountVideoPlayRecommendHandler != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetReddotColorBandVideoEntranceButton != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetReddotColorBandVideoEntranceButton.getVisibility() == 0) && (!this.jdField_a_of_type_Boolean))
    {
      VideoPlayRecommendHandler localVideoPlayRecommendHandler = this.jdField_a_of_type_ComTencentBizPubaccountVideoPlayRecommendHandler;
      VideoPlayRecommendObserver localVideoPlayRecommendObserver = this.jdField_a_of_type_ComTencentBizPubaccountVideoPlayRecommendObserver;
      String str = this.jdField_b_of_type_JavaLangString;
      if (this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo != null)
      {
        bool = true;
        localVideoPlayRecommendHandler.a(localVideoPlayRecommendObserver, str, paramInt, bool);
        if (QLog.isColorLevel()) {
  ...
  public void b()
  {
    ...
    if ((localQQAppInterface != null) && (this.jdField_a_of_type_ComTencentBizPubaccountVideoPlayRecommendObserver != null)) {
      localQQAppInterface.removeObserver(this.jdField_a_of_type_ComTencentBizPubaccountVideoPlayRecommendObserver);
    }
  }
  ...
  public void c()
  {
    ...
    ReadInJoyLogicEngineEventDispatcher.a().b(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsFirstVideoRecommendationManager$VideoFeedsFirstVideoObserver);
  }
  ...
  public void d()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentBizPubaccountVideoPlayRecommendHandler = ((VideoPlayRecommendHandler)localQQAppInterface.getBusinessHandler(BusinessHandlerFactory.VIDEOPLAYRECOMMEND_HANDLER));
      localQQAppInterface.addObserver(this.jdField_a_of_type_ComTencentBizPubaccountVideoPlayRecommendObserver);
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.video.VideoFeedsFirstVideoRecommendationManager
