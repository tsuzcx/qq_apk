  ...
  implements Runnable
{
  ...
  public void run()
  {
    try
    {
      ...
      localObject1 = new ReadInJoyWebDataManager.6.1(this);
      new HttpWebCgiAsyncTask2("https://node.kandian.qq.com/cgi/stats/multy?g_tk=" + ReadInJoyWebDataManager.a((String)localObject2), "POST", (HttpWebCgiAsyncTask.Callback)localObject1, 0, null).executeOnExecutor(ThreadManagerV2.getNetExcutor(), new HashMap[] { localObject3 });
      return;
    }
