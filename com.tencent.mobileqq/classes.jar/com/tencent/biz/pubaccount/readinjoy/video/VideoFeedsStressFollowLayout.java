  ...
  extends FrameLayout
{
  ...
  private final float jdField_a_of_type_Float = bhmg.a((Context)BaseApplication.getContext(), 48.0F);
  ...
  private final ArrayList<rvj> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  static
  {
    jdField_a_of_type_Rvi = new rvi(null);
  }
  
  public VideoFeedsStressFollowLayout(@NotNull Context paramContext)
  {
    super(paramContext);
    LayoutInflater.from(getContext()).inflate(2131560334, (ViewGroup)this, true);
    setBackgroundResource(2130843174);
    paramContext = findViewById(2131368703);
    ...
    paramContext = findViewById(2131366764);
    ...
    paramContext = findViewById(2131367947);
    ...
    paramContext = findViewById(2131379849);
    ...
    this.e.setOnClickListener((View.OnClickListener)new rvh(this));
  }
  ...
  public final void a(@NotNull rvj paramrvj)
  {
    Intrinsics.checkParameterIsNotNull(paramrvj, "onFollowActionListener");
    this.jdField_a_of_type_JavaUtilArrayList.add(paramrvj);
  }
  
  public final boolean a()
  {
    VideoInfo localVideoInfo = this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo;
    return (localVideoInfo != null) && (!localVideoInfo.n);
  }
  ...
  public final void setVideoInfo(@NotNull VideoInfo paramVideoInfo)
  {
    ...
    localTextView.setText((CharSequence)localBaseApplication.getResources().getString(2131717155, new Object[] { a(paramVideoInfo.o) }));
  }
}
