...
{
  public static final VideoColumnGuideManager.Companion a;
  ...
  static
  {
    jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoColumnVideoColumnGuideManager$Companion = new VideoColumnGuideManager.Companion(null);
  }
  
  @SuppressLint({"ClickableViewAccessibility"})
  private final void a(View paramView)
  {
    paramView = (ViewStub)paramView.findViewById(2131381296);
  ...
  private final void a(Function0<Unit> paramFunction0)
  {
    ...
    if (localView != null)
    {
      ...
      this.jdField_a_of_type_AndroidViewViewPropertyAnimator = localView.animate().alpha(1.0F).setDuration(300L).setListener((Animator.AnimatorListener)new VideoColumnGuideManager.showGuideRootView..inlined.also.lambda.1(this, paramFunction0));
  ...
  private final boolean a()
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      if ((i == 0) || (!ReadInJoyHelper.a("video_column", j)) || (this.d)) {
        break;
      }
      return true;
    }
  ...
  {
    paramView = (ViewStub)paramView.findViewById(2131381294);
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView = ((DiniFlyAnimationView)paramView.findViewById(2131381295));
  ...
  public final boolean a(@NotNull View paramView1, @NotNull View paramView2)
  {
    ...
    ReadInJoyHelper.m("video_column");
    return true;
  }
}
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.video.column.VideoColumnGuideManager
