...
public class MultiVideoDataManager$1
  implements Runnable
{
  public MultiVideoDataManager$1(qle paramqle, int paramInt1, int paramInt2) {}
  
  public void run()
  {
    HashMap localHashMap = new HashMap();
    int i = this.a;
    if ((i < this.a + this.b) && (i < qle.a(this.this$0).a().size()))
    {
      localObject = (VideoInfo)qle.a(this.this$0).a().get(i);
    ...
    for (;;)
    {
      ...
      if (((Iterator)localObject).hasNext())
      {
        ...
        boolean bool = qcn.a(qle.a(this.this$0), Long.valueOf(str).longValue());
      ...
      for (;;)
      {
        ...
        qle.a(this.this$0).post(new MultiVideoDataManager.1.1(this, str));
        break;
        return;
      }
    }
