  ...
  public void onScrolled(RecyclerView paramRecyclerView, int paramInt1, int paramInt2)
  {
    ...
    if (paramRecyclerView != null)
    {
      ...
      if ((paramRecyclerView instanceof BaseItemHolder)) {
        ((BaseItemHolder)paramRecyclerView).a(VideoFeedsRecommendFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsRecommendFragment), VideoFeedsRecommendFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsRecommendFragment), true);
      }
      if ((localViewHolder1 instanceof BaseItemHolder)) {
        ((BaseItemHolder)localViewHolder1).a(VideoFeedsRecommendFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsRecommendFragment), VideoFeedsRecommendFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsRecommendFragment), false);
      }
      if ((localViewHolder2 instanceof BaseItemHolder)) {
        ((BaseItemHolder)localViewHolder2).a(VideoFeedsRecommendFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsRecommendFragment), VideoFeedsRecommendFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsRecommendFragment), false);
      }
    }
  }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.video.VideoFeedsRecommendFragment.ScrollEventListenerImpl
