  ...
  extends SimpleConfigHandler
{
  public boolean onReceiveConfig(int paramInt1, int paramInt2, String paramString)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (TextUtils.equals("readinjoy_drop_frame_monitor", str1)) {
        ReadInJoyHelper.a("sp_key_readinjoy_feeds_drop_frame_switch", Boolean.valueOf(TextUtils.equals("1", str2)));
      }
    }
    return true;
  }
  ...
  public void onWipeConfig(int paramInt)
  {
    ...
    ReadInJoyHelper.a("sp_key_readinjoy_feeds_drop_frame_switch", Boolean.valueOf(false));
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes3.jar
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.ReadInJoyDropFrameAladdinCfgHandler
