...
public class ChannelCoverView$2
  implements Runnable
{
  public ChannelCoverView$2(nti paramnti, ChannelCoverInfo paramChannelCoverInfo) {}
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.a.mIsTopic)
        {
          ...
          {
            str3 = "0X80088BB";
            ndn.a(null, "", str1, str3, 0, 0, "1", "", "", new.a(this.a.mChannelCoverId, localJSONObject), false);
            return;
          }
