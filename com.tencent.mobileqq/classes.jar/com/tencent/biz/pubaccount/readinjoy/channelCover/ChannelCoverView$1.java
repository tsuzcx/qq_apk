...
public class ChannelCoverView$1
  implements Runnable
{
  public ChannelCoverView$1(oxo paramoxo, ChannelCoverInfo paramChannelCoverInfo) {}
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.a.mIsTopic)
        {
          ...
          {
            str3 = "0X80088BB";
            olh.a(null, "", str1, str3, 0, 0, "1", "", "", omx.a(this.a.mChannelCoverId, localJSONObject), false);
            return;
          }
