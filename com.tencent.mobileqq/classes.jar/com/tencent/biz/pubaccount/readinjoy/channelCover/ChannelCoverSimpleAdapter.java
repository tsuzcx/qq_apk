  ...
  implements View.OnClickListener
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (getItemViewType(paramInt) == 0)
    {
      ...
      if (paramView == null)
      {
        ...
        ((View)localObject1).setLayoutParams(new ViewGroup.LayoutParams(AIOUtils.a(2.0F, (Resources)localObject2), AIOUtils.a(30.0F, (Resources)localObject2)));
      }
    ...
    if (paramView == null)
    {
      localObject1 = new ChannelCoverSimpleAdapter.SimpleViewHolder(this);
      ...
      ((ChannelCoverSimpleAdapter.SimpleViewHolder)localObject1).jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyVideoTopicTextView = paramView;
      ...
      if (localObject2 != null)
      {
        ...
        ((ChannelCoverSimpleAdapter.SimpleViewHolder)localObject1).jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyVideoTopicTextView.setTopicText(((ChannelCoverInfo)localObject2).mChannelCoverName);
        label192:
        if (this.jdField_a_of_type_Int != 56) {
          break label454;
        }
        ((ChannelCoverSimpleAdapter.SimpleViewHolder)localObject1).jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyVideoTopicTextView.setTextColor(7566195);
        label211:
        if (TextUtils.isEmpty(((ChannelCoverInfo)localObject2).mIconUrl)) {
          break label470;
        }
        int i = ViewUtils.a(21.0F);
        Object localObject3 = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130840616);
        ...
        ((ChannelCoverSimpleAdapter.SimpleViewHolder)localObject1).jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyVideoTopicTextView.setCompoundDrawables((Drawable)localObject3, null, null, null);
        label304:
        if (!((ChannelCoverInfo)localObject2).isReport)
        {
          ...
          ChannelCoverView.a("0X8007BE5", "1", "", "", (ChannelCoverInfo)localObject2, i);
        }
      }
    }
    for (;;)
    {
      ChannelCoverView.a("0X8007F01", (ChannelCoverInfo)localObject2, ChannelCoverView.b);
      ((ChannelCoverSimpleAdapter.SimpleViewHolder)localObject1).jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyVideoTopicTextView.setOnClickListener(this);
      ((ChannelCoverSimpleAdapter.SimpleViewHolder)localObject1).jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructChannelCoverInfo = ((ChannelCoverInfo)localObject2);
      localObject1 = paramView;
      ...
      break label152;
      label438:
      ((ChannelCoverSimpleAdapter.SimpleViewHolder)localObject1).jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyVideoTopicTextView.setSubChannelText(((ChannelCoverInfo)localObject2).mChannelCoverName);
      break label192;
      label454:
      ((ChannelCoverSimpleAdapter.SimpleViewHolder)localObject1).jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyVideoTopicTextView.setTextColor(((ChannelCoverInfo)localObject2).mFontColor);
      break label211;
      label470:
      ((ChannelCoverSimpleAdapter.SimpleViewHolder)localObject1).jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyVideoTopicTextView.setCompoundDrawables(null, null, null, null);
      break label304;
      label485:
      if (RIJFeedsType.a(this.jdField_a_of_type_Int)) {
        GalleryReportedUtils.a(this.jdField_a_of_type_AndroidContentContext, "0X8009A70", this.jdField_a_of_type_Int, ((ChannelCoverInfo)localObject2).mChannelCoverId);
      }
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      localChannelCoverInfo = ((ChannelCoverSimpleAdapter.SimpleViewHolder)paramView.getTag()).jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructChannelCoverInfo;
    ...
    if (TextUtils.isEmpty(localChannelCoverInfo.mChannelJumpUrl))
    {
      ...
      if (this.jdField_a_of_type_Int == 56)
      {
        ReadInJoyActivityHelper.b(this.jdField_a_of_type_AndroidContentContext, localChannelCoverInfo.mChannelCoverId, localChannelCoverInfo.mChannelCoverName, localChannelCoverInfo.mChannelType, 4, (Map)localObject);
        label155:
        if (QLog.isColorLevel()) {
    ...
    {
      if (RIJFeedsType.a(this.jdField_a_of_type_Int)) {
        GalleryReportedUtils.a(this.jdField_a_of_type_AndroidContentContext, "0X8009A71", this.jdField_a_of_type_Int, localChannelCoverInfo.mChannelCoverId);
      }
      ...
      if (ViolaAccessHelper.b(localChannelCoverInfo.mChannelJumpUrl)) {
        ViolaAccessHelper.a(this.jdField_a_of_type_AndroidContentContext, "", ViolaAccessHelper.c(localChannelCoverInfo.mChannelJumpUrl), null);
      }
      for (;;)
      {
        if (!QLog.isColorLevel()) {
