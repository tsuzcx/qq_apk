  ...
  implements AdapterView.OnItemClickListener
{
  ...
  {
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyEngineReadInJoyObserver = new lip(this);
    this.c = paramInt;
  ...
  {
    ThreadManager.post(new lis(paramChannelCoverInfo, paramInt, paramString), 5, null, true);
  }
  ...
  {
    ThreadManager.executeOnSubThread(new lir(paramChannelCoverInfo, paramString1, paramString2, paramString3, paramString4));
  }
  ...
  void a(Context paramContext)
  {
    ...
    this.jdField_a_of_type_ComTencentWidgetHorizontalListView = ((HorizontalListView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131363472));
  ...
  public void a(AdapterView paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    if (this.jdField_a_of_type_JavaUtilArrayList.size() > paramInt)
    {
      ...
      if (this.c == 56) {
        ThreadManager.executeOnSubThread(new liq(this, paramAdapterView));
      }
    }
    for (;;)
    {
