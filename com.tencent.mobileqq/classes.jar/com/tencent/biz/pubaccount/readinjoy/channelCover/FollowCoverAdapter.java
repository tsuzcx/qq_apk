  ...
  extends BaseAdapter
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    do
    {
      ...
      localliu.jdField_a_of_type_ComTencentMobileqqWidgetBubbleImageView = paramViewGroup;
      ...
      localliu.jdField_b_of_type_ComTencentMobileqqWidgetBubbleImageView = paramViewGroup;
      paramView.addView(paramViewGroup);
      ...
      localliu.jdField_a_of_type_AndroidWidgetTextView = paramViewGroup;
      paramView.addView(paramViewGroup);
      paramViewGroup = new TextView(this.jdField_a_of_type_AndroidContentContext);
      ...
      paramViewGroup.setBackgroundResource(2130840803);
      localliu.jdField_b_of_type_AndroidWidgetTextView = paramViewGroup;
      paramView.addView(paramViewGroup);
      paramView.setTag(localliu);
    ...
    if (!TextUtils.isEmpty(((TopicRecommendFeedsInfo.TopicRecommendInfo)localObject1).d))
    {
      ...
      localliu.jdField_a_of_type_ComTencentMobileqqWidgetBubbleImageView.setImageDrawable(paramViewGroup);
    }
    for (;;)
    {
      ...
      localliu.jdField_a_of_type_AndroidWidgetTextView.setText(paramViewGroup.toString());
      if (((TopicRecommendFeedsInfo.TopicRecommendInfo)localObject1).b > 0) {
        break label642;
      }
      localliu.jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
      return paramView;
      localliu = (liu)paramView.getTag();
      break;
      localliu.jdField_a_of_type_ComTencentMobileqqWidgetBubbleImageView.setImageDrawable(paramViewGroup);
    }
    label642:
    ...
    {
      localliu.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
      localliu.jdField_b_of_type_AndroidWidgetTextView.setText("+" + ((TopicRecommendFeedsInfo.TopicRecommendInfo)localObject1).b);
      return paramView;
    }
    localliu.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
    localliu.jdField_b_of_type_AndroidWidgetTextView.setText("+999");
    return paramView;
  }
