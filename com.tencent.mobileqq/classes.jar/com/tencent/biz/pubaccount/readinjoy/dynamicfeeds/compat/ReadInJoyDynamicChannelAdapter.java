...
import com.tencent.biz.pubaccount.readinjoy.view.ReadInJoyBaseAdapterInterface;
...
public class ReadInJoyDynamicChannelAdapter
  extends ReadInJoyDynamicChannelAbstractAdapter<Long, BaseArticleInfo>
  implements ReadInJoyBaseAdapterInterface
{
  ...
  private DynamicItemViewHelperCompat jdField_a_of_type_ComTencentBizPubaccountReadinjoyDynamicfeedsCompatDynamicItemViewHelperCompat = new DynamicItemViewHelperCompat();
  private int b = -1;
  ...
  public ReadInJoyDynamicChannelAdapter(Activity paramActivity, RecyclerViewWithHeaderFooter paramRecyclerViewWithHeaderFooter, int paramInt)
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyDynamicfeedsCompatDynamicItemViewHelperCompat.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, 3);
  }
  ...
  private void a(ArticleInfo paramArticleInfo)
  {
    ...
    if (localFastWebModule != null) {
      this.b = localFastWebModule.a(localArticleInfo.mArticleContentUrl, String.valueOf(localArticleInfo.innerUniqueID), localArticleInfo.mSubscribeID, 1, null);
    }
    b(localArticleInfo);
  }
  ...
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyDynamicfeedsCompatDynamicItemViewHelperCompat.a(paramInt))
    {
    ...
    for (;;)
    {
      paramViewGroup = null;
      break;
      if (ProteusSupportUtilDynamic.a(paramInt))
      {
  ...
  public void a(int paramInt, View paramView)
  {
    ...
    while (!RIJFeedsType.a(paramView.mArticleContentUrl, paramView.mChannelID, paramView)) {
      return;
    }
    a(paramView);
  }
  ...
  public void a(BaseViewHolder paramBaseViewHolder, int paramInt)
  {
    ...
    {
      if (!this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyDynamicfeedsCompatDynamicItemViewHelperCompat.a(i)) {
        break label160;
      }
    ...
    for (;;)
    {
      ...
      return;
      label140:
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyDynamicfeedsCompatDynamicItemViewHelperCompat.a(localProteusItemView, i, localBaseArticleInfo, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, paramInt);
      continue;
      label160:
      if (ProteusSupportUtilDynamic.a(i)) {
        ProteusSupportUtilDynamic.a(localProteusItemView, i, localBaseArticleInfo, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, paramInt, a());
      } else {
  ...
  public int getItemViewType(int paramInt)
  {
    ...
    if (localBaseArticleInfo != null)
    {
      if (!this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyDynamicfeedsCompatDynamicItemViewHelperCompat.a(localBaseArticleInfo)) {
        break label42;
      }
      paramInt = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyDynamicfeedsCompatDynamicItemViewHelperCompat.a(localBaseArticleInfo);
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.dynamicfeeds.compat.ReadInJoyDynamicChannelAdapter
