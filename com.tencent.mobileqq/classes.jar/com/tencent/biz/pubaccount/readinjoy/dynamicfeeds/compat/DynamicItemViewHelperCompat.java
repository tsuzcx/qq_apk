...
public class DynamicItemViewHelperCompat
  extends DynamicItemViewHelperCompatBase<BaseArticleInfo>
{
  ...
  public int a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    {
      AIOUtils.a("DynamicItemViewHelperCompat", "", new IllegalArgumentException(HardCodeUtil.a(2131703603)));
      return b;
    }
  ...
  protected TemplateBean a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    try
    {
      if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusItemDynamicProteusItem == null) {
        return null;
      }
      localTemplateBean1 = localTemplateBean2;
      JSONObject localJSONObject = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusItemDynamicProteusItem.a(i, paramBaseArticleInfo);
      localTemplateBean1 = localTemplateBean2;
      localTemplateBean2 = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusItemDynamicProteusItem.a(i, localJSONObject);
      localTemplateBean1 = localTemplateBean2;
  ...
  public void a(ProteusItemView paramProteusItemView, int paramInt1, BaseArticleInfo paramBaseArticleInfo, VafContext paramVafContext, int paramInt2)
  {
    ...
    if (localTemplateBean1 != null)
    {
      ...
      if (localTemplateBean2 != null)
      {
        ...
        if (!localTemplateBean2.equals(localTemplateBean1))
        {
          ...
          if (localObject != null)
          {
            ((Container)localObject).setBackgroundDrawable(paramVafContext.getContext().getResources().getDrawable(2130841884));
    ...
    if (localTemplateBean2 != null) {
      ProteusSupportUtil.a(paramBaseArticleInfo, (TemplateBean)localObject, localTemplateBean2);
    }
    ProteusSupportUtil.a(paramBaseArticleInfo, paramVafContext, localTemplateBean2);
    TraceUtils.traceEnd();
  }
  ...
  public void a(VafContext paramVafContext, int paramInt)
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusItemDynamicProteusItem = new DynamicProteusItem(paramVafContext);
  }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.dynamicfeeds.compat.DynamicItemViewHelperCompat
