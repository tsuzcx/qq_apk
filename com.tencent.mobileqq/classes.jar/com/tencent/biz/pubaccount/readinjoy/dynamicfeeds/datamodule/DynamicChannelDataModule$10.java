...
public class DynamicChannelDataModule$10
  implements Runnable
{
  public DynamicChannelDataModule$10(ofz paramofz, int paramInt) {}
  
  public void run()
  {
    boolean bool = ofz.a(this.this$0).b("DELETE FROM " + DynamicChannelDataModel.class.getSimpleName() + " WHERE channelID = " + this.a);
