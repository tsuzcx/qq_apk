...
{
  private bjxz jdField_a_of_type_Bjxz = new pjk(this);
  ...
  private pkt jdField_a_of_type_Pkt = new pjj(this);
  private int e = 1;
  ...
  private void a(TopBannerInfo paramTopBannerInfo)
  {
    ...
    if (paramTopBannerInfo.dynamicItems.size() > 0)
    {
      ...
      {
        rfu localrfu = (rfu)paramTopBannerInfo.dynamicItems.get(i);
        if ((localrfu == null) || (TextUtils.isEmpty(localrfu.a))) {
          break label190;
        }
        QLog.d("ReadInJoyDynamicChannelFragment", 2, new Object[] { "json = ", localrfu.a });
        ProteusItemView localProteusItemView = pit.a(this.jdField_a_of_type_Pjg.a(), a(), pit.a(localrfu.a));
        pit.a(localProteusItemView, this.jdField_a_of_type_Pjg.a(), a(), localrfu.a);
  ...
  public void a(RecyclerView.ViewHolder paramViewHolder, int paramInt)
  {
    ...
    {
      rfu localrfu = (rfu)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructTopBannerInfo.dynamicItems.get(paramInt);
      if ((localrfu != null) && (!TextUtils.isEmpty(localrfu.a)))
      {
        paramViewHolder = (ProteusItemView)paramViewHolder.itemView;
        if (paramViewHolder != null)
        {
          QLog.d("ReadInJoyDynamicChannelFragment", 2, new Object[] { "onBindHeader, json = ", localrfu.a });
          pit.a(paramViewHolder, this.jdField_a_of_type_Pjg.a(), a(), localrfu.a);
        }
      }
    }
  }
  ...
  public void b()
  {
    this.jdField_a_of_type_Pjg.notifyDataSetChanged();
  }
  
  public void b(int paramInt)
  {
    pkm.a().a(this.jdField_b_of_type_Int, null, -1, true, false, this.e, null, -1L, null, this.c, 0L, 0L, null, paramInt, false, null, 0, null);
    this.e += 1;
  }
  
  public void c()
  {
    this.jdField_a_of_type_Pjg = new pjg(getActivity(), this.jdField_a_of_type_ComTencentWidgetPull2refreshXRecyclerView.a(), this.jdField_b_of_type_Int);
    this.jdField_a_of_type_ComTencentWidgetPull2refreshXRecyclerView.a().setAdapter(this.jdField_a_of_type_Pjg);
  }
