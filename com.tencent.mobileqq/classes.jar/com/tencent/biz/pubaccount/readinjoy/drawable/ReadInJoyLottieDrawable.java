  ...
  extends LottieDrawable
{
  ...
  public static ReadInJoyLottieDrawable a(String paramString)
  {
    ...
    if (a(localFile1)) {
      localReadInJoyLottieDrawable.a(localFile1);
    }
    for (;;)
    {
      ...
      for (boolean bool = localFile2.mkdirs(); bool; bool = true)
      {
        ...
        paramString = new DownloadTask(paramString, localFile2);
        paramString.b = 3;
        paramString.d = 60L;
        Bundle localBundle = new Bundle();
        localBundle.putLong("bgLottieResId", l);
        localBundle.putString("bgLottieResPath", str);
        localDownloaderInterface.a(paramString, new ReadInJoyLottieDrawable.5(l, str, localFile2, localFile1, new WeakReference(localReadInJoyLottieDrawable)), localBundle);
        return localReadInJoyLottieDrawable;
      }
    }
  }
  ...
  private void a(File paramFile)
  {
    ...
    File[] arrayOfFile = paramFile.listFiles(new ReadInJoyLottieDrawable.1(this));
    Object localObject = paramFile.listFiles(new ReadInJoyLottieDrawable.2(this));
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.drawable.ReadInJoyLottieDrawable
