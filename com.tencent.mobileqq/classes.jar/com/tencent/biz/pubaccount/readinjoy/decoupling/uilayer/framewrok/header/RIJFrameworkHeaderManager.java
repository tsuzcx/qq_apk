...
{
  private ChannelCoverView jdField_a_of_type_ComTencentBizPubaccountReadinjoyChannelCoverChannelCoverView;
  ...
  {
    return this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyChannelCoverChannelCoverView;
  }
  ...
  {
    ReadInjoySlideAnimLayout localReadInjoySlideAnimLayout = (ReadInjoySlideAnimLayout)paramActivity.findViewById(2131362006);
    View localView = paramActivity.findViewById(2131379458);
    int j = AIOUtils.a(50.0F, paramActivity.getResources());
    int i = j;
    ...
    paramView = paramView.findViewById(2131367373);
  ...
  public void a(Activity paramActivity, ReadInJoyXListView paramReadInJoyXListView, View paramView, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    ReadInjoySlideAnimLayout localReadInjoySlideAnimLayout = (ReadInjoySlideAnimLayout)paramActivity.findViewById(2131362005);
    View localView = paramActivity.findViewById(2131378451);
    paramView = paramView.findViewById(2131367373);
    if (paramBoolean1)
    {
      i = 2131298855;
    ...
    label233:
    for (int i = ImmersiveUtils.getStatusBarHeight(paramActivity) + i;; i = AIOUtils.a(50.0F, paramActivity.getResources()) + ImmersiveUtils.getStatusBarHeight(paramActivity) + i)
    {
      int j = AIOUtils.a(50.0F, paramActivity.getResources());
      int k = ImmersiveUtils.getStatusBarHeight(paramActivity);
      int m = paramActivity.getResources().getDimensionPixelOffset(2131298859);
      paramView.setPadding(0, i, 0, 0);
      paramReadInJoyXListView.setPadding(0, i, 0, 0);
      paramReadInJoyXListView.initPaddingManual();
      if (QLog.isColorLevel()) {
  ...
  public void a(View paramView, int paramInt)
  {
    ...
    {
      if (this.b == null) {
        this.b = ((ChannelTopPositionView)paramView.findViewById(2131376632));
      }
      a(0);
    }
  }
  ...
  public void a(TopBannerInfo paramTopBannerInfo, ReadInJoyXListView paramReadInJoyXListView, Activity paramActivity, int paramInt, ReadInJoyBaseAdapter paramReadInJoyBaseAdapter)
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetBannerChannelTopBanner.a(paramReadInJoyBaseAdapter, paramTopBannerInfo);
  }
  
  public void a(ReadInJoyXListView paramReadInJoyXListView)
  {
    if (paramReadInJoyXListView != null) {
      paramReadInJoyXListView.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewPullrefreshReadInJoyAnimBaseManager$PullRefreshComplete);
    }
  }
  ...
  public void a(ReadInJoyXListView paramReadInJoyXListView, Context paramContext, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt == 56)
      {
        if (ReadInJoyHelper.s(ReadInJoyUtils.a()) != 2)
        {
          this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyChannelCoverChannelCoverView = new ChannelCoverView(paramContext, paramInt, paramReadInJoyXListView);
          a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyChannelCoverChannelCoverView.a(), paramContext);
        }
      }
      else if (paramInt == 70)
      {
      ...
      else if ((paramInt == 41523) && (ReadInJoyHelper.t(ReadInJoyUtils.a()) != 1))
      {
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyChannelCoverChannelCoverView = new ChannelCoverView(paramContext, paramInt, paramReadInJoyXListView);
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyChannelCoverChannelCoverView.a().setBackgroundColor(-1);
        a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyChannelCoverChannelCoverView.a(), paramContext);
      }
    }
  }
  
  public void a(ReadInJoyAnimBaseManager.PullRefreshComplete paramPullRefreshComplete, ReadInJoyXListView paramReadInJoyXListView)
  {
    if (paramReadInJoyXListView != null)
    {
  ...
  public void b()
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
      ((HeaderViewController)localIterator.next()).c();
    }
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetBannerChannelTopBanner != null) {
  ...
  public void c()
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
      ((HeaderViewController)localIterator.next()).d();
    }
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetBannerChannelTopBanner != null) {
  ...
  public void d()
  {
    ...
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
      ((HeaderViewController)localIterator.next()).b();
    }
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewSlideActiveAnimController != null) {
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.decoupling.uilayer.framewrok.header.RIJFrameworkHeaderManager
