...
import com.tencent.biz.pubaccount.readinjoy.common.ReportR5WithTimeBuilder;
...
public class RIJTransMergeKanDianReport
{
    ...
    for (;;)
    {
      ...
      catch (OutOfMemoryError paramQQAppInterface)
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject1))
        {
          ...
          localObject1 = new AggregateAvatarUrlDrawable((Bitmap)localObject2, AIOUtils.a(50.0F, localResources), localResources, (String)localObject1, 1);
        ...
        paramQQAppInterface = new AggregateAvatarUrlDrawable(paramQQAppInterface, (String)localObject2, AIOUtils.a(50.0F, localResources), localResources, 1);
  ...
  public static RIJTransMergeKanDianReport.ReportR5Builder a(int paramInt1, long paramLong, int paramInt2, String paramString1, String paramString2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7)
  {
    ...
    try
    {
      paramString1 = localReportR5Builder.a(paramLong).b().c().k(paramInt2).a(paramInt1).l().e(paramString1).j().k().b(paramString2).f(paramInt3).g(paramInt4).h(paramInt5).i(paramInt6).j(paramInt7).d().e().f().g();
      return paramString1;
    }
  ...
  public static RIJTransMergeKanDianReport.ReportR5Builder a(int paramInt1, String paramString, int paramInt2, int paramInt3, boolean paramBoolean, int paramInt4)
  {
    ...
    try
    {
      RIJTransMergeKanDianReport.ReportR5Builder localReportR5Builder2 = localReportR5Builder1.b().c().a(paramInt1).e().f().g().h().a(paramString).d(paramInt2).e(paramInt3).a();
      if (paramBoolean) {}
      for (paramString = "1";; paramString = "2")
      {
        localReportR5Builder2.a("refresh_way", paramString).i().m();
        if (paramInt4 == -1) {
          break;
        }
        localReportR5Builder1.a("pull_image", String.valueOf(paramInt4));
  ...
  public static RIJTransMergeKanDianReport.ReportR5Builder a(ArticleInfo paramArticleInfo)
  {
    if ((paramArticleInfo != null) && (paramArticleInfo.mSocialFeedInfo != null))
    {
      ...
      for (int j = 0;; j = 1)
      {
        ...
        for (localObject = Long.valueOf(localSocializeFeedsInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$FeedsInfoUser.a);; localObject = "")
        {
  ...
  public static String a()
  {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        ((JSONObject)localObject).put("session_id", RIJKanDianFolderStatus.jdField_a_of_type_JavaLangString);
  ...
  public static String a(long paramLong1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean1, String paramString1, String paramString2, String paramString3, String paramString4, ArticleInfo paramArticleInfo, long paramLong2, int paramInt5, int paramInt6, int paramInt7, int paramInt8, boolean paramBoolean2, int paramInt9, int paramInt10, int paramInt11)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString1 = paramString3;
        paramString4.put("proteus_bid", ReadInJoyHelper.a("default_feeds_proteus_offline_bid"));
        paramString1 = paramString3;
        paramString4.put("ads_jump", paramInt9);
        paramString1 = paramString3;
        paramString4.put("ads_source", paramInt10);
        paramString1 = paramString3;
        paramString4.put("star_logo", RIJFeedsType.a(paramArticleInfo));
        paramString1 = paramString3;
        if (CUKingCardHelper.a() == 1)
        {
          ...
          paramString1 = paramString3;
          RIJJsonUtils.a(paramString4, "daily_article_first_timestamp", ((Long)ReadInJoyHelper.a("readinjoy_daily_article_first_exposure_" + paramArticleInfo.mArticleID, Long.valueOf(0L))).longValue(), paramBoolean1);
          paramString1 = paramString3;
          if (paramArticleInfo.isShowGif)
          {
            ...
            paramString1 = paramString3;
            if (!RIJItemViewType.n(paramArticleInfo)) {
              continue;
            }
            paramBoolean1 = true;
            paramString1 = paramString3;
            ...
            a(paramString4);
            paramString1 = paramString3;
            RIJJsonUtils.b(paramString4, "jump_src", UGRuleManager.a(paramArticleInfo), UGRuleManager.c(paramArticleInfo));
            paramString1 = paramString3;
            RIJJsonUtils.a(paramString4, "short_content_size", ComponentPGCShortContentBig.jdField_a_of_type_JavaLangString, paramArticleInfo.isPGCShortContent());
            paramString1 = paramString3;
            ...
            paramString1 = paramString3;
            paramString4.put("default_feeds_aladdin_keys", ((String)ReadInJoyHelper.a("default_feeds_aladdin_keys", "")).replace("|", "_"));
            paramString1 = paramString3;
            paramString2 = paramString4.toString();
            paramString1 = paramString2;
            return new VideoR5.Builder(paramString2).c(paramArticleInfo).d(paramArticleInfo).a(paramArticleInfo.videoReportInfo).a(paramArticleInfo, true).a().a();
          }
        }
        else
        {
  ...
  public static String a(long paramLong, int paramInt1, int paramInt2, boolean paramBoolean, String paramString1, String paramString2, ArticleInfo paramArticleInfo, String paramString3)
  {
    ...
    try
    {
      ...
      paramString2.put("proteus_bid", ReadInJoyHelper.a("default_feeds_proteus_offline_bid"));
  ...
  {
    if ((paramBaseArticleInfo == null) || (!DailyModeConfigHandler.c((int)paramBaseArticleInfo.mChannelID)) || (TextUtils.isEmpty(paramBaseArticleInfo.proteusItemsData))) {
      return "";
    }
    try
    {
  ...
  public static String a(String paramString, long paramLong, int paramInt)
  {
    try
    {
      ...
      localJSONObject.put("session_id", RIJKanDianFolderStatus.jdField_a_of_type_JavaLangString);
  ...
  public static String a(String paramString, ArticleInfo paramArticleInfo)
  {
    ...
    try
    {
      JSONObject localJSONObject = new JSONObject();
      localJSONObject.put("folder_status", RIJKanDianFolderStatus.jdField_a_of_type_Int);
      localJSONObject.put("feeds_source", ((TopicRecommendFeedsInfo.TopicRecommendInfo)paramArticleInfo.mTopicRecommendFeedsInfo.a.get(0)).jdField_a_of_type_Int);
  ...
  public static String a(String paramString, ArticleInfo paramArticleInfo, long paramLong)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        return localJSONObject.toString();
        localJSONObject.put("feeds_source", localSocializeFeedsInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$FeedsInfoUser.a);
      }
      return "";
    }
    catch (JSONException paramString)
  ...
  public static String a(String paramString1, String paramString2, String paramString3, String paramString4, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      if (paramBoolean)
      {
        ...
        localJSONObject.put("kd_pos", RIJKanDianFolderStatus.b);
        if (!TextUtils.isEmpty(paramString3)) {
          localJSONObject.put("stick", paramString3);
        }
        if (RIJKanDianFolderStatus.jdField_a_of_type_Int == 6)
        {
    ...
    for (;;)
    {
      try
      {
        if (VideoReporter.jdField_a_of_type_JavaLangString == null) {
          VideoReporter.jdField_a_of_type_JavaLangString = "8.5.5".replace(".", "");
        }
        ...
        int i = RIJAladdinUtils.a();
        ReportR5WithTimeBuilder localReportR5WithTimeBuilder = new ReportR5WithTimeBuilder().a(paramLong).a(RIJKanDianFolderStatus.a(paramInt2)).a(paramInt1).a().b(paramInt2);
        if (paramBoolean)
        {
          paramInt1 = 2;
          paramString1 = localReportR5WithTimeBuilder.c(paramInt1).b(paramString1).c(RIJAppSetting.b()).d(RIJAppSetting.c()).e(RIJKanDianFolderStatus.jdField_a_of_type_JavaLangString).I(paramInt2).b(paramInt2, paramArticleInfo).g(paramString2).h(paramString3).b(paramArticleInfo, RIJFeedsType.a(paramArticleInfo));
          if (ReadInJoyHelper.z(BaseApplicationImpl.getApplication().getRuntime()) != 1) {
            break label707;
          }
          paramInt1 = 1;
          paramString1 = paramString1.d(paramInt1).a(RIJFeedsType.a(paramArticleInfo)).e(RIJAppSetting.a()).f(VideoReporter.a()).g(paramInt4).h(paramInt3).s(paramArticleInfo);
          if (!ReadInJoyHelper.C(RIJQQAppInterfaceUtil.a())) {
            break label712;
          }
          paramInt1 = 1;
          paramString2 = paramString1.j(paramInt1).i(ReadInJoyHelper.a("default_feeds_proteus_offline_bid")).c().k(RIJFeedsType.a(paramArticleInfo)).r(paramArticleInfo).b(ReportR5WithTimeBuilder.a(paramArticleInfo)).m(VideoReporter.jdField_a_of_type_JavaLangString).n("1").H(paramInt2).a(RIJQQAppInterfaceUtil.a(), paramString2, paramArticleInfo).b();
          if (CUKingCardHelper.a() != 1) {
            break label717;
          }
          paramString1 = "1";
          paramString1 = paramString2.q(paramString1).q(paramArticleInfo).a(paramArticleInfo, RIJItemViewType.n(paramArticleInfo)).p(paramArticleInfo).n(j).o(paramArticleInfo).G(paramInt2);
          if (!RIJAladdinUtils.a()) {
            break label725;
          }
          paramInt1 = 1;
          ...
          if (!TextUtils.isEmpty(Build.MODEL))
          {
            ...
            {
              paramInt1 = 1;
              paramString1 = paramString1.z(paramInt1).f(paramArticleInfo).e(paramArticleInfo).c("default_feeds_aladdin_keys", (String)ReadInJoyHelper.a("default_feeds_aladdin_keys", "")).a(paramArticleInfo, a(Long.valueOf(paramArticleInfo.mArticleID))).d(paramArticleInfo);
    ...
    for (;;)
    {
      try
      {
        ...
        if (NetworkUtil.h(paramContext))
        {
          ...
          localJSONObject.put("os", "1");
          localJSONObject.put("version", "8.5.5".replace(".", ""));
          localJSONObject.put("imei", RIJAppSetting.b());
          localJSONObject.put("imsi", RIJAppSetting.c());
  ...
  public static void a(JSONObject paramJSONObject, ArticleInfo paramArticleInfo)
  {
    for (;;)
    {
      ...
      {
        SocializeFeedsInfo localSocializeFeedsInfo = paramArticleInfo.mSocialFeedInfo;
        paramJSONObject.put("folder_status", RIJKanDianFolderStatus.jdField_a_of_type_Int);
        if (RIJItemViewType.a(paramArticleInfo))
        {
          paramJSONObject.put("feeds_source", paramArticleInfo.mSubscribeID);
          paramJSONObject.put("rowkey", paramArticleInfo.innerUniqueID);
          paramJSONObject.put("feeds_type", "" + RIJFeedsType.a(paramArticleInfo));
        ...
        {
          if ((localSocializeFeedsInfo == null) || (localSocializeFeedsInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$FeedsInfoUser == null)) {
            continue;
          }
          paramJSONObject.put("feeds_source", localSocializeFeedsInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$FeedsInfoUser.a);
          continue;
        }
        paramArticleInfo = "0";
      }
  ...
  {
    boolean bool1 = true;
    if ((paramBaseArticleInfo.mChannelID != 0L) && (!DailyModeConfigHandler.c((int)paramBaseArticleInfo.mChannelID))) {
    ...
    do
    {
      for (;;)
      {
        ...
        i = RIJItemViewType.a((ArticleInfo)paramBaseArticleInfo);
        int j;
        int k;
        boolean bool3;
      ...
      if (i == 1)
      {
        if (!PackageUtil.a(paramContext, paramBaseArticleInfo)) {}
        for (;;)
        {
          return bool1;
          bool1 = false;
    ...
    label351:
    label357:
    return PackageUtil.a(paramContext, paramBaseArticleInfo);
  }
  ...
  private static String b(ArticleInfo paramArticleInfo)
  {
    ...
    try
    {
      bool = ((PublicAccountDataManager)BaseApplicationImpl.getApplication().getRuntime().getManager(QQManagerFactory.PUBLICACCOUNTDATA_MANAGER)).a(Long.valueOf(l), true);
      if (bool) {
        return "1";
      }
    }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.decoupling.uilayer.framewrok.report.RIJTransMergeKanDianReport
