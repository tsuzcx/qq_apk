...
public class RIJSPUtils
{
  ...
  public static void b(String paramString, Object paramObject, boolean paramBoolean)
  {
    try
    {
      ...
      localObject = ReadInJoyHelper.a(RIJQQAppInterfaceUtil.a(), true, paramBoolean);
      if (localObject != null)
      {
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.decoupling.uilayer.framewrok.util.RIJSPUtils
