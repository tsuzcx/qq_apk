...
public class RIJAppSetting
{
  ...
  public static String a(long paramLong)
  {
    ...
    for (;;)
    {
      localObject = ReadInJoyHelper.a(RIJQQAppInterfaceUtil.a(), true, false);
      if (localObject != null) {
        break label148;
      }
  ...
  public static String a(java.lang.Throwable paramThrowable)
  {
    ...
    //   0: aconst_null
    //   1: astore_2
    //   2: new 192	java/io/StringWriter
    //   5: dup
    //   6: invokespecial 193	java/io/StringWriter:<init>	()V
    //   9: astore_1
    //   10: new 195	java/io/PrintWriter
    //   13: dup
    //   14: aload_1
    //   15: invokespecial 198	java/io/PrintWriter:<init>	(Ljava/io/Writer;)V
    //   18: astore_3
    //   19: aload_0
    //   20: aload_3
    //   21: invokevirtual 204	java/lang/Throwable:printStackTrace	(Ljava/io/PrintWriter;)V
    //   24: aload_3
    //   25: invokevirtual 207	java/io/PrintWriter:flush	()V
    //   28: aload_1
    //   29: invokevirtual 208	java/io/StringWriter:flush	()V
    //   32: aload_1
    //   33: ifnull +7 -> 40
    //   36: aload_1
    //   37: invokevirtual 211	java/io/StringWriter:close	()V
    //   40: aload_3
    //   41: ifnull +7 -> 48
    //   44: aload_3
    //   45: invokevirtual 212	java/io/PrintWriter:close	()V
    //   48: aload_1
    //   49: invokevirtual 213	java/io/StringWriter:toString	()Ljava/lang/String;
    //   52: areturn
    //   53: astore_0
    //   54: aload_0
    //   55: invokevirtual 215	java/io/IOException:printStackTrace	()V
    //   58: goto -18 -> 40
    //   61: astore_0
    //   62: aconst_null
    //   63: astore_1
    ...
    //   65: ifnull +7 -> 72
    //   68: aload_2
    //   69: invokevirtual 211	java/io/StringWriter:close	()V
    //   72: aload_1
    //   73: ifnull +7 -> 80
    //   76: aload_1
    //   77: invokevirtual 212	java/io/PrintWriter:close	()V
    //   80: aload_0
    //   81: athrow
    //   82: astore_2
    //   83: aload_2
    //   84: invokevirtual 215	java/io/IOException:printStackTrace	()V
    //   87: goto -15 -> 72
    //   90: astore_0
    //   91: aconst_null
    //   92: astore_3
  ...
  {
    Object localObject = ReadInJoyHelper.a(RIJQQAppInterfaceUtil.a(), true, false);
    if (localObject == null)
    {
  ...
  {
    paramContext = RIJQQAppInterfaceUtil.a();
  ...
  public static void b(Activity paramActivity, boolean paramBoolean)
  {
    ...
    {
      paramActivity = ((FragmentActivity)paramActivity).getSupportFragmentManager().findFragmentByTag(MainFragment.class.getName());
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.decoupling.uilayer.framewrok.util.RIJAppSetting
