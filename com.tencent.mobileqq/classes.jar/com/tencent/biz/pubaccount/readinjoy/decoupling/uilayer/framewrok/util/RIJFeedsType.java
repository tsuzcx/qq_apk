...
public class RIJFeedsType
{
  ...
  private static boolean A(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    {
      i = 1;
      if ((!a((ArticleInfo)paramBaseArticleInfo)) && (!RIJItemViewType.g(paramBaseArticleInfo)) && (!RIJItemViewType.i((ArticleInfo)paramBaseArticleInfo)) && (!RIJItemViewType.j((ArticleInfo)paramBaseArticleInfo)) && (!RIJItemViewType.k((ArticleInfo)paramBaseArticleInfo))) {
        break label83;
      }
    }
    label83:
  ...
  {
    return (UtilsForComponent.a((ArticleInfo)paramBaseArticleInfo) == 3) || (RIJItemViewType.a((ArticleInfo)paramBaseArticleInfo)) || (RIJItemViewType.i(paramBaseArticleInfo)) || (RIJItemViewType.n((ArticleInfo)paramBaseArticleInfo)) || (g(paramBaseArticleInfo)) || (paramBaseArticleInfo.isPGCShortContent()) || (paramBaseArticleInfo.isAccountShown) || (paramBaseArticleInfo.mKdLiveInfo != null);
  }
  ...
  public static int a(ArticleInfo paramArticleInfo)
  {
    ...
    if ((paramArticleInfo.mSocialFeedInfo != null) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$WendaInfo != null))
    {
      if (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$WendaInfo.jdField_a_of_type_Boolean) {
        return 4;
      }
      return 2;
    }
  ...
  {
    if ((paramArticleInfo == null) || (paramArticleInfo.mSocialFeedInfo == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$UGCFeedsInfo == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$WendaInfo == null) || ((!paramBoolean) && (paramArticleInfo.mFeedType != 21) && (paramArticleInfo.mFeedType != 22)) || ((paramBoolean) && (!o(paramArticleInfo)))) {
    ...
    {
      return 7;
      if ((paramBoolean) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$UGCFeedsInfo.b == 3)) {
        return 75;
      }
      if (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$UGCFeedsInfo.b == 3) {
        return 74;
      }
      if ((paramBoolean) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$UGCFeedsInfo.b == 4)) {
        return 73;
      }
      if (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$UGCFeedsInfo.b == 4) {
        return 72;
      }
    } while (!QLog.isColorLevel());
    QLog.e("RIJFeedsType", 1, "error ugcFeedsSrc = " + paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$UGCFeedsInfo.b);
    return 7;
  }
  
  public static int a(BaseArticleInfo paramBaseArticleInfo)
  {
    int j = RIJItemViewType.a((ArticleInfo)paramBaseArticleInfo);
    RIJUtilsHelper localRIJUtilsHelper = new RIJUtilsHelper(paramBaseArticleInfo);
    int i = localRIJUtilsHelper.a(j, 0);
    if (UtilsForComponent.a((ArticleInfo)paramBaseArticleInfo) == 3) {
      i = localRIJUtilsHelper.b(j, i);
    }
    for (;;)
    {
      i = localRIJUtilsHelper.a(paramBaseArticleInfo, i);
      if (paramBaseArticleInfo.isTwoItem) {
        i = 43;
      }
      if (ExtraBiuBriefInfo.b(paramBaseArticleInfo)) {
        i = 69;
      }
      j = localRIJUtilsHelper.d(paramBaseArticleInfo.mFeedType, i);
      i = j;
      if (paramBaseArticleInfo.mSocialFeedInfo != null)
      {
        i = j;
        if (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$LongContentInfo != null) {
          i = localRIJUtilsHelper.c(paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$LongContentInfo.jdField_a_of_type_Int, j);
        }
      }
  ...
  public static String a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    do
    {
      ...
      str = ViolaAccessHelper.c(paramBaseArticleInfo);
    } while ((!ViolaAccessHelper.b(paramBaseArticleInfo)) || (TextUtils.isEmpty(str)));
    return str;
  }
  ...
  public static void a(String paramString)
  {
    if (jdField_a_of_type_JavaLangString != null) {
      TimeSliceHelper.a(jdField_a_of_type_JavaLangString);
    }
  ...
  public static boolean a(int paramInt1, int paramInt2)
  {
    ...
    {
      return false;
      float f = ReadInJoyHelper.b(RIJQQAppInterfaceUtil.a());
      if (f > 0.0F) {}
  ...
  public static boolean a(ArticleInfo paramArticleInfo)
  {
    ...
    return UtilsForComponent.b(RIJItemViewType.a(paramArticleInfo));
  }
  ...
  {
    if (!ReadInJoyHelper.C(RIJQQAppInterfaceUtil.a())) {
      return false;
    }
  ...
  public static int b(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    NewPolymericInfo.PackArticleInfo localPackArticleInfo = (NewPolymericInfo.PackArticleInfo)paramBaseArticleInfo.mNewPolymericInfo.jdField_a_of_type_JavaUtilList.get(0);
    ...
    if ((localPackArticleInfo.b == 6) || (localPackArticleInfo.b == 7) || (localPackArticleInfo.b == 8) || (localPackArticleInfo.b == 9) || (localPackArticleInfo.b == 12)) {
      return 77;
    }
    if (localPackArticleInfo.b == 0) {
      return 77;
    }
    QLog.e("FeedItemCellTypeNewPolymericBaseHeader", 1, "新聚合类卡片没有找到对应的FeedCell feedType = " + localPackArticleInfo.b);
    return 77;
  }
  ...
  public static String b(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    for (;;)
    {
      ...
      return String.valueOf(paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$FeedsInfoUser.a);
      i = 0;
      break;
      label52:
      j = 0;
  ...
  public static boolean b(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    {
      paramBaseArticleInfo = (NewPolymericInfo.PackArticleInfo)paramBaseArticleInfo.mNewPolymericInfo.jdField_a_of_type_JavaUtilList.get(0);
        ...
        if (paramBaseArticleInfo.articleStyle != 4)
        {
          ...
          if (paramBaseArticleInfo.articleStyle != 5)
          {
            ...
            if (paramBaseArticleInfo.articleStyle != 6) {
              if (!RIJPreParseData.a(paramBaseArticleInfo)) {
                break label75;
              }
            }
          }
  ...
  {
    return (paramArticleInfo != null) && (paramArticleInfo.mSocialFeedInfo != null) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$BiuInfo != null) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$BiuInfo.b != null) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$BiuInfo.b.longValue() == 23L);
  }
  
  public static boolean e(BaseArticleInfo paramBaseArticleInfo)
  {
    return (paramBaseArticleInfo != null) && (paramBaseArticleInfo.mSocialFeedInfo != null) && (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$BiuInfo != null) && (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$BiuInfo.jdField_a_of_type_JavaUtilList != null) && (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$BiuInfo.jdField_a_of_type_JavaUtilList.size() > 0);
  }
  ...
  {
    return ((paramBaseArticleInfo instanceof ArticleInfo)) && (!RIJItemViewType.q((ArticleInfo)paramBaseArticleInfo)) && (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$UGCFeedsInfo.jdField_a_of_type_Int == 6);
  }
  ...
  public static boolean h(ArticleInfo paramArticleInfo)
  {
    ...
    while ((paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$BiuInfo.b.longValue() != 17L) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$BiuInfo.b.longValue() != 16L)) {
      return false;
    }
    return true;
  }
  ...
  {
    if ((paramArticleInfo == null) || (paramArticleInfo.mSocialFeedInfo == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$BiuInfo == null)) {}
    while ((paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$BiuInfo.b.longValue() != 19L) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$BiuInfo.b.longValue() != 18L)) {
      return false;
    }
    return true;
  }
  ...
  {
    return (paramArticleInfo.mSocialFeedInfo == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$WendaInfo == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$WendaInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAnswerDetailInfo == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$WendaInfo.c == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$WendaInfo.c.size() <= 0) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$WendaInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAnswerDetailInfo.b != 1);
  }
  ...
  {
    boolean bool = true;
    if ((paramArticleInfo == null) || (paramArticleInfo.mSocialFeedInfo == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$UGCFeedsInfo == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$WendaInfo == null)) {
      bool = false;
    }
    do
    {
      ...
      return false;
      if ((paramArticleInfo.mFeedType != 1) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$BiuInfo == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$BiuInfo.b == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$BiuInfo.b.intValue() != 21)) {
        break;
      }
  ...
  public static boolean m(ArticleInfo paramArticleInfo)
  {
    ...
    do
    {
      do
      {
        ...
        return false;
        if ((paramArticleInfo.mFeedType != 1) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$BiuInfo == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$BiuInfo.b == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$BiuInfo.b.intValue() != 22)) {
          break;
        }
      } while (a(paramArticleInfo, true) == 73);
      return false;
    } while ((paramArticleInfo.mFeedType == 1) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$UGCFeedsInfo.b == 4));
    return false;
  }
  ...
  {
    if ((paramArticleInfo == null) || (paramArticleInfo.mSocialFeedInfo == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$WendaInfo == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$BiuInfo == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$BiuInfo.b == null)) {}
    while (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$BiuInfo.b.intValue() != 21) {
      return false;
    }
    return true;
  }
  ...
  {
    if ((paramArticleInfo == null) || (paramArticleInfo.mSocialFeedInfo == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$WendaInfo == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$BiuInfo == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$BiuInfo.b == null)) {}
    while (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$BiuInfo.b.intValue() != 22) {
      return false;
    }
    return true;
  }
  ...
  public static boolean v(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    return a(DynamicItemViewHelper.a(paramBaseArticleInfo.mProteusTemplateBean));
  }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.decoupling.uilayer.framewrok.util.RIJFeedsType
