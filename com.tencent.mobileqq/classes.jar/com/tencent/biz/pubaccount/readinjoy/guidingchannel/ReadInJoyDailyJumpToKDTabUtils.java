...
public class ReadInJoyDailyJumpToKDTabUtils
{
  public static boolean a(Context paramContext, String paramString)
  {
    ...
    do
    {
      ...
      {
        ReadInJoyUtils.a(paramContext, str5);
        QLog.i("ReadInJoyDailyJumpToKDTabUtils", 1, "[jumpToKDTab], open article directly.");
        return true;
      }
    } while (!bool);
    paramContext.startActivity(ReadInJoyActivityHelper.a(paramContext, 12, str2, str4));
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.guidingchannel.ReadInJoyDailyJumpToKDTabUtils
