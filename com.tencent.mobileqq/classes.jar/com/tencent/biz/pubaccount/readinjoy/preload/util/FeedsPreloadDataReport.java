...
public class FeedsPreloadDataReport
{
  public static void a(ToServiceMsg paramToServiceMsg, int paramInt)
  {
    ...
    if (paramToServiceMsg != null)
    {
      ...
      Long localLong = (Long)paramToServiceMsg.getAttribute(ReadInJoyEngineModule.d);
    ...
    for (;;)
    {
      try
      {
        ((RIJTransMergeKanDianReport.ReportR5Builder)localObject).a("is_reddot", paramToServiceMsg);
        if (!bool1) {
          continue;
        }
        paramToServiceMsg = "1";
        ((RIJTransMergeKanDianReport.ReportR5Builder)localObject).a("hit_preload", paramToServiceMsg);
        ((RIJTransMergeKanDianReport.ReportR5Builder)localObject).a("refresh_cost", String.valueOf(l));
        ((RIJTransMergeKanDianReport.ReportR5Builder)localObject).a("refresh_num", String.valueOf(paramInt));
      }
      ...
      a("0X8009C16", ((RIJTransMergeKanDianReport.ReportR5Builder)localObject).a());
  ...
  public static void a(boolean paramBoolean, int paramInt)
  {
    ...
    try
    {
      for (;;)
      {
        localReportR5Builder.a("preload_reddot", str);
        localReportR5Builder.a("preload_num", String.valueOf(paramInt));
        a("0X8009C15", localReportR5Builder.a());
        return;
        str = "0";
      }
    }
  ...
  public static void a(boolean paramBoolean, int paramInt, long paramLong)
  {
    ...
    for (;;)
    {
      try
      {
        localReportR5Builder.a("preload_reddot", str);
        localReportR5Builder.a("preload_num", String.valueOf(paramInt));
        localReportR5Builder.a("package_size", String.valueOf(paramLong));
        if (paramLong <= 20000L) {
          continue;
        }
        str = "1";
        localReportR5Builder.a("is_too_large", str);
      }
      catch (JSONException localJSONException)
      {
      ...
      a("0X8009C14", localReportR5Builder.a());
      return;
      str = "0";
      continue;
      str = "0";
  ...
  public static void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        str = "1";
        localReportR5Builder.a("has_exception", str);
      }
      catch (JSONException localJSONException)
      {
      ...
      a("0X8009C13", localReportR5Builder.a());
      return;
      str = "0";
      continue;
      str = "0";
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.preload.util.FeedsPreloadDataReport
