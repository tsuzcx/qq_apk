...
public class FeedsPreloadHelper
{
  ...
  public static void a()
  {
    ...
    ReadInJoyHelper.a("sp_key_readinjoy_feeds_preload_last_enter_kd_millisecond", Long.valueOf(l));
  }
  ...
  public static boolean a()
  {
    ...
    if (!((Boolean)ReadInJoyHelper.a("sp_key_readinjoy_feeds_preload_switch", Boolean.valueOf(false))).booleanValue())
    {
  ...
  public static boolean a(boolean paramBoolean)
  {
    ...
    long l1 = ((Long)ReadInJoyHelper.a("sp_key_readinjoy_feeds_preload_last_enter_kd_millisecond", Long.valueOf(-1L))).longValue();
    if (l1 == -1L)
    {
    ...
    long l3 = ((Long)ReadInJoyHelper.a("sp_key_readinjoy_feeds_preload_last_enter_kd_day", Long.valueOf(90L))).longValue();
    ...
    l2 = ((Long)ReadInJoyHelper.a("sp_key_readinjoy_feeds_preload_last_preload_millisecond", Long.valueOf(-1L))).longValue();
    if (l2 != -1L)
    {
      l3 = System.currentTimeMillis();
      l1 = ((Long)ReadInJoyHelper.a("sp_key_readinjoy_feeds_preload_interval", Long.valueOf(30L))).longValue();
      l2 = (l3 - l2) / 1000L / 60L;
  ...
  public static void b()
  {
    ...
    ReadInJoyHelper.a("sp_key_readinjoy_feeds_preload_last_preload_millisecond", Long.valueOf(l));
  }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.preload.util.FeedsPreloadHelper
