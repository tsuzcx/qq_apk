...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/biz/pubaccount/readinjoy/plugin/jsMethodAction/ReadInJoyJsMethodActionController;", "", "()V", "mWebPlugin", "Lcom/tencent/mobileqq/webview/swift/WebViewPlugin;", "map", "Ljava/util/HashMap;", "", "Lcom/tencent/biz/pubaccount/readinjoy/plugin/jsMethodAction/JsMethodAction;", "Lkotlin/collections/HashMap;", "callBackToWebView", "", "jsCallbackFunc", "jsMethodModel", "Lcom/tencent/biz/pubaccount/readinjoy/plugin/jsMethodAction/JsMethodModel;", "retCode", "", "msg", "data", "Lorg/json/JSONObject;", "func", "jsonObject", "getActionByName", "name", "init", "webViewPlugin", "registerAction", "action", "AQQLiteApp_release"}, k=1, mv={1, 1, 16})
public final class ReadInJoyJsMethodActionController
{
  ...
  static
  {
    jdField_a_of_type_ComTencentBizPubaccountReadinjoyPluginJsMethodActionReadInJoyJsMethodActionController = new ReadInJoyJsMethodActionController();
  }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.plugin.jsMethodAction.ReadInJoyJsMethodActionController
