  ...
  protected boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramJsBridgeListener = paramString1;
        this.jdField_a_of_type_ComTencentBizTroopTroopMemberApiClient.h(new lru(this, paramString1));
      }
      ...
      try
      {
        ...
        try
        {
          ...
          this.jdField_a_of_type_ComTencentBizTroopTroopMemberApiClient.a(paramJsBridgeListener, l1, paramString2, paramString3, l2, l3, new lrv(this, paramString1));
      ...
      if ("cancelLoadSkin".equals(paramString3))
      {
        ...
        try
        {
          ...
          paramJsBridgeListener = paramString2;
          this.jdField_a_of_type_ComTencentBizTroopTroopMemberApiClient.e(paramString3, paramString1, new lrw(this, paramString2));
          paramJsBridgeListener = paramString2;
      ...
      try
      {
        ...
        this.jdField_a_of_type_ComTencentBizTroopTroopMemberApiClient.a(paramString3, l1, paramJsBridgeListener, paramString1, l2, l3, i, new lrx(this, paramString2));
