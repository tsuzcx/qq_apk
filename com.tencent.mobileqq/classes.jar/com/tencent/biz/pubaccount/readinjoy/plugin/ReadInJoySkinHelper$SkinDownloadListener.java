  ...
  extends DownloadListener
{
  ...
  public void onCancel(DownloadTask paramDownloadTask)
  {
    ...
    {
      ((ReadInJoySkinManager)this.jdField_a_of_type_MqqAppAppRuntime.getManager(260)).b(this);
      if (paramDownloadTask != null)
      {
        ...
        paramDownloadTask.a(110, (Bundle)localObject);
  ...
  public void onDone(DownloadTask paramDownloadTask)
  {
    ...
    if (TextUtils.equals((CharSequence)localObject, this.jdField_a_of_type_JavaLangString))
    {
      ...
      if (localTroopMemberApiService != null)
      {
        ...
        localTroopMemberApiService.a(110, (Bundle)localObject);
      }
    }
    for (;;)
    {
