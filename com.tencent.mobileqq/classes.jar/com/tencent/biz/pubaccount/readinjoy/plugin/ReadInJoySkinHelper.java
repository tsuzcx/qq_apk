...
public class ReadInJoySkinHelper
{
  ...
  public void a(Bundle paramBundle)
  {
    ...
    String str = ((ReadInJoySkinManager)this.jdField_a_of_type_MqqAppAppRuntime.getManager(QQManagerFactory.READ_INJOY_SKIN_MANAGER)).a();
    if (!CommonSkinRes.a(str)) {
      str = "";
    }
    for (;;)
    {
      boolean bool = SharedPreUtils.t(((AppInterface)this.jdField_a_of_type_MqqAppAppRuntime).getApp().getApplicationContext(), ((AppInterface)this.jdField_a_of_type_MqqAppAppRuntime).getCurrentAccountUin());
  ...
  public void b(Bundle paramBundle)
  {
    ...
    do
    {
      ...
      ReadInJoySkinHelper.SkinDownloadListener localSkinDownloadListener = new ReadInJoySkinHelper.SkinDownloadListener(this.jdField_a_of_type_MqqAppAppRuntime, str1, paramBundle, this.jdField_a_of_type_ComTencentBizTroopTroopMemberApiService);
      this.jdField_a_of_type_JavaUtilHashMap.put(str1, localSkinDownloadListener);
      bool = ((ReadInJoySkinManager)localObject).a(str1, str2, str3, l1, l2, l3, localSkinDownloadListener);
      if (QLog.isColorLevel()) {
