  ...
  extends AladdinRequestHandler
{
  ...
  private static void b(Bundle paramBundle)
  {
    ...
    paramBundle = StatisticCollector.getInstance(ReadInJoyUtils.a().getApplication());
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.config.QQAladdinRequestHandler
