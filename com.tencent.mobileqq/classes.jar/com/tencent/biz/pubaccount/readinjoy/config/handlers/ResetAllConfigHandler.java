    ...
    for (;;)
    {
      ...
      if (TextUtils.equals(str, "reset_version"))
      {
        ...
        try
        {
          ...
          SharedPreUtils.q(BaseApplicationImpl.getApplication(), paramInt1, ReadInJoyUtils.a());
          return true;
        }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.config.handlers.ResetAllConfigHandler
