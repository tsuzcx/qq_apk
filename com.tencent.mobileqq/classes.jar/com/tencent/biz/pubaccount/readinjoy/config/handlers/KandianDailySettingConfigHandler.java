      ...
      catch (JSONException localJSONException1)
      {
        for (;;)
        {
          try
          {
            ...
            {
              localArrayList.add(ReadInJoyDailySettingModel.a(((JSONArray)localObject1).optJSONObject(paramInt1)));
              paramInt1 += 1;
              continue;
            }
            ...
            {
              paramInt1 = 0;
              localObject1 = new ReadInJoyDailySettingModel();
            }
            ((ReadInJoyDailySettingModel)localObject1).jdField_b_of_type_JavaLangString = arrayOfString[0];
            ((ReadInJoyDailySettingModel)localObject1).jdField_a_of_type_JavaLangString = ((String)localObject5);
            localObject3 = arrayOfString[1].split(",");
            localObject5 = arrayOfString[2].split(",");
            ((ReadInJoyDailySettingModel)localObject1).jdField_b_of_type_JavaUtilList = new ArrayList();
            ((ReadInJoyDailySettingModel)localObject1).jdField_a_of_type_JavaUtilList = new ArrayList();
            ((ReadInJoyDailySettingModel)localObject1).jdField_b_of_type_JavaUtilList.add("");
            ((ReadInJoyDailySettingModel)localObject1).jdField_a_of_type_JavaUtilList.add("");
            paramInt2 = 0;
            if (paramInt2 >= localObject3.length) {
              continue;
            }
            ((ReadInJoyDailySettingModel)localObject1).jdField_a_of_type_JavaUtilList.add(localObject3[paramInt2]);
            paramInt2 += 1;
            continue;
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.config.handlers.KandianDailySettingConfigHandler
