      ...
      try
      {
        ...
        if (((Iterator)localObject).hasNext())
        {
          ...
          if (TextUtils.equals(str1, "dynamic_buffer_switch")) {
            ReadInJoyHelper.k(Integer.parseInt(str2));
          }
        }
        else
        {
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.config.handlers.VideoDynamicBufferConfigHandler
