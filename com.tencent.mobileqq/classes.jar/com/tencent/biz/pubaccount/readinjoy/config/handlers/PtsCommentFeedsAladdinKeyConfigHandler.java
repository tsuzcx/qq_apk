  ...
  extends SimpleConfigHandler
{
  ...
  private static Set<String> b()
  {
    ...
    Object localObject = (String)ReadInJoyHelper.a("comment_feeds_aladdin_keys", "");
  ...
  public boolean onReceiveConfig(int paramInt1, int paramInt2, String paramString)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if ("native_article_aladdin_keys".equalsIgnoreCase(str1))
      {
        ...
        ReadInJoyHelper.a("comment_feeds_aladdin_keys", str2);
      }
    }
    return true;
  }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.config.handlers.PtsCommentFeedsAladdinKeyConfigHandler
