  ...
  extends SimpleConfigHandler
{
  ...
  public static int a()
  {
    String[] arrayOfString = ((String)ReadInJoyHelper.a("readinjoy_comment_guide_show_num_one_day", "0_0")).split("_");
  ...
  {
    String str = (String)ReadInJoyHelper.a("readinjoy_comment_guide_wording", HardCodeUtil.a(2131702234));
  ...
  {
    String str2 = (String)ReadInJoyHelper.a("readinjoy_comment_guide_base_jump_url", "");
    ...
    do
    {
      ...
      str3 = (String)URLUtil.a(str2).get("appSchema");
      str1 = str2;
    ...
    try
    {
      ...
      paramString = URLUtil.a(URLUtil.a(str2, "appSchema"), "appSchema", paramString);
  ...
  public static JSONObject a()
  {
    ...
    try
    {
      ...
      localJSONObject.put("guide_image", ReadInJoyHelper.a("readinjoy_comment_guide_image_url", "readinjoy_comment_guide_big_bg"));
      localJSONObject.put("guide_wording", a());
      localJSONObject.put("jump_button_text", HardCodeUtil.a(2131702233));
  ...
  public static void a(int paramInt)
  {
    ...
    ReadInJoyHelper.a("readinjoy_comment_guide_show_num_one_day", str + "_" + paramInt);
  }
  
  public static boolean a()
  {
    if (((Integer)ReadInJoyHelper.a("readinjoy_comment_guide_pic_button_should_show", Integer.valueOf(-1))).intValue() == 1) {}
  ...
  {
    boolean bool1;
    if (((Integer)ReadInJoyHelper.a("readinjoy_comment_guide_should_show", Integer.valueOf(-1))).intValue() == 1)
    {
      bool1 = true;
      bool2 = bool1;
      if (bool1)
      {
        int i = ((Integer)ReadInJoyHelper.a("readinjoy_comment_guide_max_show_count", Integer.valueOf(3))).intValue();
        int j = a();
  ...
  public boolean onReceiveConfig(int paramInt1, int paramInt2, String paramString)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (TextUtils.equals(str1, "should_show")) {
        ReadInJoyHelper.a("readinjoy_comment_guide_should_show", Integer.valueOf(Integer.valueOf(str2).intValue()));
      } else if (TextUtils.equals(str1, "wording")) {
        ReadInJoyHelper.a("readinjoy_comment_guide_wording", str2);
      } else if (TextUtils.equals(str1, "image_url")) {
        ReadInJoyHelper.a("readinjoy_comment_guide_image_url", str2);
      } else if (TextUtils.equals(str1, "base_jump_url")) {
        ReadInJoyHelper.a("readinjoy_comment_guide_base_jump_url", str2);
      } else if (TextUtils.equals(str1, "max_show_count")) {
        ReadInJoyHelper.a("readinjoy_comment_guide_max_show_count", Integer.valueOf(Integer.valueOf(str2).intValue()));
      } else if (TextUtils.equals(str1, "pic_button_should_show")) {
        ReadInJoyHelper.a("readinjoy_comment_guide_pic_button_should_show", Integer.valueOf(Integer.valueOf(str2).intValue()));
      }
    }
    return true;
  }
  ...
  public void onWipeConfig(int paramInt)
  {
    ...
    ReadInJoyHelper.a("readinjoy_comment_guide_should_show", Integer.valueOf(0));
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes3.jar
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.config.handlers.CommentGuideConfigHandler
