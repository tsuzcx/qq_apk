  ...
  extends MSFServlet
{
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      try
      {
        Object localObject = QQAladdinRequestHandler.a(paramFromServiceMsg.getWupBuffer());
        ...
        if (localObject != null)
        {
          ...
          if ((paramFromServiceMsg.bytes_bodybuffer.has()) && (paramFromServiceMsg.bytes_bodybuffer.get() != null))
          {
            ...
            QQAladdinRequestHandler.a((Bundle)localObject);
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.config.QQAladdinRequestHandler.AladdinConfigServlet
