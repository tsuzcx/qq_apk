  ...
  extends SimpleConfigHandler
{
  public boolean onReceiveConfig(int paramInt1, int paramInt2, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          if (TextUtils.equals(str1, "video_channel_feeds_type")) {
            ReadInJoyHelper.a(Integer.parseInt(str2));
          }
        }
        else
        {
      ...
      {
        ReadInJoyHelper.b(Integer.parseInt(str2));
        continue;
        label209:
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.config.handlers.VideoColumnHandler
