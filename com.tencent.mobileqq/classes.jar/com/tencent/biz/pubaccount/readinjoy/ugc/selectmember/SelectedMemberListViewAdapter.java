  ...
  implements ObservableList.OnListChangedCallback<ObservableArrayList<ResultRecord>>
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      return paramView;
      paramView = LayoutInflater.from(paramViewGroup.getContext()).inflate(2131560393, paramViewGroup, false);
      localObject1 = (ReadInJoyHeadImageView)paramView.findViewById(2131368854);
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.ugc.selectmember.SelectedMemberListViewAdapter
