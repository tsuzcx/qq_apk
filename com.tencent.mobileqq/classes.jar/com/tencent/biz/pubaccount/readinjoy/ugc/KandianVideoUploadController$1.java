  ...
  extends ReadInJoyObserver
{
  ...
  public void a(String paramString1, int paramInt1, long paramLong, String paramString2, int paramInt2, String paramString3, String paramString4)
  {
    ...
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(KandianVideoUploadController.a(this.a))) || (!paramString1.equals(KandianVideoUploadController.a(this.a)))) {
      return;
    }
    if (paramInt1 == 0)
    {
      ...
      this.a.b = true;
      if (KandianVideoUploadController.a(this.a)) {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          str = paramString1;
          if (KandianVideoUploadController.c(this.a) != 12) {
            continue;
          }
          str = paramString1;
      ...
      this.a.a(0);
      ReadInJoyHelper.B(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1);
      paramString1 = paramString3;
    }
    for (;;)
    {
      if (KandianVideoUploadController.a(this.a) != null) {
        KandianVideoUploadController.a(this.a).a(this.a.jdField_a_of_type_JavaLangString, paramInt1, paramLong, paramString2, paramInt2, paramString1, paramString4);
      }
      ...
      break;
      str = paramString1;
      if (KandianVideoUploadController.c(this.a) != 13) {
        break label369;
      }
      str = paramString1;
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.ugc.KandianVideoUploadController.1
