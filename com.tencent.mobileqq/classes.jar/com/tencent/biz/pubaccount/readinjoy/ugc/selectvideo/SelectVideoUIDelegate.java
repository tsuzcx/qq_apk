  ...
  implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, PlayerStatusListener
{
  ...
  private ViewGroup jdField_a_of_type_AndroidViewViewGroup = (ViewGroup)LayoutInflater.from(BaseApplication.getContext()).inflate(2131560166, null, false);
  ...
  private ReadInjoyPlayer jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoPlayerReadInjoyPlayer;
  ...
  private void a(int paramInt)
  {
    ...
    default: 
      return;
    case 1: 
      this.jdField_a_of_type_AndroidWidgetImageButton.setImageDrawable(localResources.getDrawable(2130843459));
      this.jdField_a_of_type_AndroidWidgetImageButton.setTag(Integer.valueOf(1));
      return;
    }
    this.jdField_a_of_type_AndroidWidgetImageButton.setImageDrawable(localResources.getDrawable(2130843458));
  ...
  private void d()
  {
    this.jdField_a_of_type_AndroidWidgetSeekBar = ((SeekBar)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131377688));
    this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131381475));
    this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131373247));
    this.jdField_b_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131381301));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131381477));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131381322));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131365428));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131380651));
  ...
  private void e()
  {
    int i = (int)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoPlayerReadInjoyPlayer.a() / 1000;
  ...
  private void f()
  {
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoPlayerReadInjoyPlayer = new ReadInjoyPlayer(1000);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoPlayerReadInjoyPlayer.a(this);
  }
  
  private void g()
  {
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoPlayerReadInjoyPlayer.d(true);
  ...
  public void a(ViewGroup paramViewGroup)
  {
    ...
    d();
    f();
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoPlayerReadInjoyPlayer.a(paramViewGroup);
  ...
  public void onStopTrackingTouch(SeekBar paramSeekBar)
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoPlayerReadInjoyPlayer.b(i * 1000);
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.ugc.selectvideo.SelectVideoUIDelegate
