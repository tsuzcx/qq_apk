  ...
  extends BaseSelectAdapter<ColumnInfo, SelectTopicView.MyTopicViewHolder>
{
  ...
  public View a(@NotNull Context paramContext, @Nullable ViewGroup paramViewGroup)
  {
    ...
    paramContext = LayoutInflater.from(paramContext).inflate(2131560334, paramViewGroup, false);
  ...
  public SelectTopicView.MyTopicViewHolder a(@NotNull Context paramContext, @NotNull View paramView)
  {
    ...
    paramContext = (TextView)paramView.findViewById(2131379527);
    TextView localTextView = (TextView)paramView.findViewById(2131379693);
    paramView = (ImageView)paramView.findViewById(2131369628);
  ...
  public void a(@NotNull ColumnInfo paramColumnInfo, @NotNull SelectTopicView.MyTopicViewHolder paramMyTopicViewHolder)
  {
    ...
    Drawable localDrawable = a().getResources().getDrawable(2130843242);
    ...
    paramColumnInfo = a().getResources().getString(2131718369, new Object[] { Integer.valueOf(paramColumnInfo.videoCount), Integer.valueOf(paramColumnInfo.subscribeCount) });
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.ugc.selecttopic.SelectTopicView.topicAdapter.1
