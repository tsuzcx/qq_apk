...
public class SelectMemberBuddyListAdapter
  ...
  implements View.OnClickListener, View.OnLongClickListener, ObservableList.OnListChangedCallback<ObservableArrayList<ResultRecord>>, PhoneContactManager.IPhoneContactListener
{
  private static final SelectMemberBuddyListAdapter.MyComparator jdField_a_of_type_ComTencentBizPubaccountReadinjoyUgcSelectmemberSelectMemberBuddyListAdapter$MyComparator = new SelectMemberBuddyListAdapter.MyComparator(null);
  ...
  private final View.OnClickListener c = new SelectMemberBuddyListAdapter.4(this);
  ...
  private void a(List<SelectMemberBuddyListAdapter.FriendHolder> paramList)
  {
    try
    {
      Collections.sort(paramList, jdField_a_of_type_ComTencentBizPubaccountReadinjoyUgcSelectmemberSelectMemberBuddyListAdapter$MyComparator);
      return;
    }
  ...
  private View b(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      if ((AppSetting.d) && (paramViewGroup.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
      {
        ...
        paramView.setContentDescription(localPhoneContact.name + HardCodeUtil.a(2131713691));
      }
      return paramView;
    ...
    paramView.setContentDescription(localPhoneContact.name + HardCodeUtil.a(2131713705));
    return paramView;
  }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        while (i < ((List)localObject2).size())
        {
          ...
          if ((!((Friends)localObject5).uin.equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())) && (!Utils.b(((Friends)localObject5).uin)) && (!QidianManager.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((Friends)localObject5).uin))) {
  ...
  protected View a(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      if ((AppSetting.d) && (paramViewGroup.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
      {
        ...
        paramView.setContentDescription((String)localObject + HardCodeUtil.a(2131713676));
      }
      return paramView;
      paramViewGroup = (SelectMemberBuddyListAdapter.SelectBuddyChildTag)paramView.getTag();
      paramViewGroup.d.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
    ...
    label355:
    paramView.setContentDescription((String)localObject + HardCodeUtil.a(2131713681));
    return paramView;
  }
  ...
  public View getGroupView(int paramInt, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView != null)
    {
      ...
      if (AppSetting.d)
      {
        ...
        paramViewGroup.setContentDescription(((Groups)localObject).group_name + HardCodeUtil.a(2131713708));
      }
    }
    for (;;)
    {
      ...
      break;
      label153:
      paramViewGroup.setContentDescription(((Groups)localObject).group_name + HardCodeUtil.a(2131713670));
    }
  }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.ugc.selectmember.SelectMemberBuddyListAdapter
