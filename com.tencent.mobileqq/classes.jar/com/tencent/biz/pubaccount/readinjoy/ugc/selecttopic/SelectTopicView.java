...
public final class SelectTopicView
  extends BaseSelectView<ColumnInfo, rpu>
{
  ...
  private final rpv jdField_a_of_type_Rpv;
  
  static
  {
    jdField_a_of_type_Rpt = new rpt(null);
  }
  
  public SelectTopicView(@NotNull FragmentActivity paramFragmentActivity, @NotNull pxp<ColumnInfo, pxh<ColumnInfo>> parampxp)
  {
    super((Activity)paramFragmentActivity, parampxp);
    this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity = paramFragmentActivity;
    this.jdField_a_of_type_Rpv = new rpv(this, (Context)this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity);
  ...
  public String a()
  {
    String str = this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131717462);
    Intrinsics.checkExpressionValueIsNotNull(str, "context.resources.getStr…joy_publish_to_topic_tip)");
    return str;
  }
  
  @NotNull
  public rpj<ColumnInfo, rpu> a()
  {
    return (rpj)this.jdField_a_of_type_Rpv;
  }
  
  public void a()
  {
    rha.a((Context)this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 4);
    QQAppInterface localQQAppInterface = pay.a();
    if (localQQAppInterface != null)
    {
      odq.a("0X800AC60", new pbg().a("uin", localQQAppInterface.getCurrentAccountUin()).a("source", Integer.valueOf(1)).a());
      return;
    }
  ...
  public String b()
  {
    if (rha.h())
    {
      String str = this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131717303);
  ...
  protected void onAttachedToWindow()
  {
    ...
    rmp.a(this.jdField_a_of_type_KotlinJvmFunctionsFunction1);
  }
  
  protected void onDetachedFromWindow()
  {
    rmp.b(this.jdField_a_of_type_KotlinJvmFunctionsFunction1);
