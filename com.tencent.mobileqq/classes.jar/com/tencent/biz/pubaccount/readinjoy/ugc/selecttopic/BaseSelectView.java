...
public abstract class BaseSelectView<BEAN, HOLDER extends rro>
  ...
  implements pzd<BEAN>
{
  ...
  private final pzl<BEAN, pzd<BEAN>> jdField_a_of_type_Pzl;
  ...
  public BaseSelectView(@NotNull Activity paramActivity, @NotNull pzl<BEAN, pzd<BEAN>> parampzl)
  {
    super((Context)paramActivity);
    this.jdField_a_of_type_Pzl = parampzl;
    this.jdField_a_of_type_Rrs = new rrs(this);
    LayoutInflater.from((Context)paramActivity).inflate(2131560254, (ViewGroup)this, true);
    paramActivity = findViewById(2131377121);
    ...
    paramActivity = findViewById(2131366060);
    ...
    paramActivity = findViewById(2131376512);
    ...
    paramActivity = findViewById(2131369921);
    ...
    paramActivity = findViewById(2131370200);
    ...
    this.jdField_a_of_type_AndroidViewView.setOnClickListener((View.OnClickListener)new rrp(this));
  ...
  @NotNull
  public abstract rrn<BEAN, HOLDER> a();
  ...
  protected void onAttachedToWindow()
  {
    ...
    for (int i = 1;; i = 0)
    {
      if (i != 0)
      {
        ...
        this.jdField_b_of_type_AndroidWidgetTextView.setOnClickListener((View.OnClickListener)new rrq(this));
      }
      this.jdField_a_of_type_AndroidWidgetListView.setAdapter((ListAdapter)a());
      this.jdField_a_of_type_AndroidWidgetListView.setOnItemClickListener((AdapterView.OnItemClickListener)new rrr(this));
      this.jdField_a_of_type_AndroidWidgetListView.setOnScrollListener((AbsListView.OnScrollListener)this.jdField_a_of_type_Rrs);
      this.jdField_a_of_type_Pzl.a((pzd)this);
      this.jdField_a_of_type_Pzl.b();
      return;
    }
  }
