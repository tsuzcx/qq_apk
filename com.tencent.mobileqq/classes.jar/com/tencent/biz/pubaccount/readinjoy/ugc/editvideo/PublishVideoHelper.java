...
public class PublishVideoHelper
{
  ...
  public static void a(boolean paramBoolean, List<UgcVideo> paramList, @Nullable PublishVideoHelper.IPublishVideoCallback paramIPublishVideoCallback)
  {
    ...
    for (int i = 0;; i = 1)
    {
      ...
      ProtoUtils.a(RIJQQAppInterfaceUtil.a(), new PublishVideoHelper.1(paramIPublishVideoCallback), paramList.toByteArray(), "OidbSvc.0xe2a", 3626, 1, null, 120000L);
      return;
    }
  }
}
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.ugc.editvideo.PublishVideoHelper
