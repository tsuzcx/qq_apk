...
public class ReadInJoySelectMemberFragment
  ...
  implements View.OnClickListener, qgz<ObservableArrayList<ResultRecord>>, qie
{
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new qhl(this);
  ...
  public ReadInJoySelectMemberFragment()
  {
    ...
    this.jdField_a_of_type_Qhx = new qhx();
  }
  ...
  private void a(Bundle paramBundle)
  {
    if (this.mContentView.findViewById(2131366671) != null)
    {
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyUgcSelectmemberFriendListFragment.a(this.jdField_a_of_type_Qhx);
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyUgcSelectmemberFollowingListFragment.a(this.jdField_a_of_type_Qhx);
  ...
  private void g()
  {
    ...
    if (localObject != null)
    {
      this.jdField_a_of_type_Qhx.a(((Bundle)localObject).getInt("opentype", 0));
      this.jdField_a_of_type_Qhx.b(((Bundle)localObject).getInt("maxSelect", 10));
      this.jdField_a_of_type_Qhx.c(((Bundle)localObject).getInt("maxCount", 30));
      this.jdField_a_of_type_Qhx.b(((Bundle)localObject).getString("rowkey", ""));
      this.jdField_a_of_type_Qhx.a(((Bundle)localObject).getString("callback", ""));
      if (((Bundle)localObject).containsKey("filterUins"))
      {
        ...
        if ((!TextUtils.isEmpty((CharSequence)localObject)) && (((String)localObject).length() > 0)) {
          this.jdField_a_of_type_Qhx.a(Arrays.asList(((String)localObject).split(",")));
        }
      }
    }
  }
  ...
  private void h()
  {
    ...
    this.jdField_a_of_type_AndroidViewView = this.mContentView.findViewById(2131375672);
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)this.mContentView.findViewById(2131375721));
    this.jdField_a_of_type_AndroidWidgetEditText.setOnKeyListener(new qhi(this));
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new qhj(this));
  }
  ...
  private void i()
  {
    ...
    if (j > 4)
    {
      ...
      if (this.jdField_a_of_type_Qhx.a() != 1) {
        break label124;
      }
      localTextView.setText(MessageFormat.format(getString(2131718552), new Object[] { Integer.valueOf(j) }));
    }
    for (;;)
    {
      if (i == 0) {
      ...
      this.jdField_a_of_type_ComTencentWidgetHorizontalListView.getLayoutParams().width = actn.a(200.0F, getResources());
      ...
      break;
      label124:
      localTextView.setText(MessageFormat.format(getString(2131719217), new Object[] { Integer.valueOf(j) }));
    }
    label152:
    this.jdField_a_of_type_AndroidViewView.setVisibility(0);
    if (this.jdField_a_of_type_Qhx.a() == 1) {
      localTextView.setText(2131718549);
    }
    for (;;)
    {
      setRightViewTextDisable(0);
      break;
      localTextView.setText(2131719216);
    }
    label196:
  ...
  private void j()
  {
    ...
    if (this.jdField_a_of_type_Qhx.a() == 1)
    {
      setTitle(localResources.getString(2131718547));
      setRightButton(2131718549, this);
    }
    for (;;)
    {
      setRightViewTextDisable(0);
      return;
      setTitle(localResources.getString(2131719200));
      setRightButton(2131719216, this);
    }
  }
  ...
  {
    ResultRecord localResultRecord = ResultRecord.a(paramawog.b(), paramawog.a().toString());
    ...
    for (;;)
    {
      ...
      {
        if ((this.jdField_a_of_type_Qhx.a() != 1) || (TextUtils.isEmpty(paramawog.b())) || (this.jdField_a_of_type_Qhx.a() == null)) {
          break label194;
        }
        if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyUgcDatabindingObservableArrayList.size() < this.jdField_a_of_type_Qhx.b()) {
          break;
        }
        paramawog = getActivity().getResources().getString(2131718554, new Object[] { String.valueOf(this.jdField_a_of_type_Qhx.c()) });
        bcpw.a(getActivity(), paramawog, 0).a();
      }
      return;
      localResultRecord.a(1);
    }
    if (this.jdField_a_of_type_Qhx.a().contains(paramawog.b()))
    {
  ...
  public void b(ObservableArrayList<ResultRecord> paramObservableArrayList, int paramInt1, int paramInt2)
  {
    ...
    if (paramObservableArrayList.size() > this.jdField_a_of_type_Qhx.b())
    {
      String str = String.format(getString(2131694936), new Object[] { Integer.valueOf(this.jdField_a_of_type_Qhx.b()) });
      if (this.jdField_a_of_type_Qhx.a() == 1) {
        str = getString(2131718554, new Object[] { String.valueOf(this.jdField_a_of_type_Qhx.c()) });
      }
      paramObservableArrayList.subList(paramInt1, paramInt1 + paramInt2).clear();
      bcpw.a(getActivity(), str, 0).a();
      return;
    }
    i();
  }
  ...
  protected void d()
  {
    this.jdField_a_of_type_ComTencentWidgetHorizontalListView = ((HorizontalListView)this.mContentView.findViewById(2131375822));
    this.jdField_a_of_type_Qhy = new qhy(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyUgcDatabindingObservableArrayList);
    this.jdField_a_of_type_ComTencentWidgetHorizontalListView.setAdapter(this.jdField_a_of_type_Qhy);
    this.jdField_a_of_type_ComTencentWidgetHorizontalListView.setOverScrollMode(2);
    this.jdField_a_of_type_ComTencentWidgetHorizontalListView.setOnItemClickListener(new qhk(this));
  }
