...
public class ReadInJoySelectMemberFragment
  ...
  implements View.OnClickListener, pvb<ObservableArrayList<ResultRecord>>, pwg
{
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new pvn(this);
  ...
  protected pvz a;
  private pwa jdField_a_of_type_Pwa;
  ...
  public ReadInJoySelectMemberFragment()
  {
    ...
    this.jdField_a_of_type_Pvz = new pvz();
  }
  ...
  {
    if (this.mContentView.findViewById(2131301060) != null)
    {
      if (paramBundle != null) {
        return;
      }
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyUgcSelectmemberFriendListFragment.a(this.jdField_a_of_type_Pvz);
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyUgcSelectmemberFollowingListFragment.a(this.jdField_a_of_type_Pvz);
      getChildFragmentManager().beginTransaction().add(2131301060, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyUgcSelectmemberFriendListFragment).commit();
    }
  ...
  private void g()
  {
    ...
    if (localObject != null)
    {
      this.jdField_a_of_type_Pvz.a(((Bundle)localObject).getInt("opentype", 0));
      this.jdField_a_of_type_Pvz.b(((Bundle)localObject).getInt("maxSelect", 10));
      this.jdField_a_of_type_Pvz.c(((Bundle)localObject).getInt("maxCount", 30));
      this.jdField_a_of_type_Pvz.b(((Bundle)localObject).getString("rowkey", ""));
      this.jdField_a_of_type_Pvz.a(((Bundle)localObject).getString("callback", ""));
      if (((Bundle)localObject).containsKey("filterUins"))
      {
        ...
        if ((!TextUtils.isEmpty((CharSequence)localObject)) && (((String)localObject).length() > 0)) {
          this.jdField_a_of_type_Pvz.a(Arrays.asList(((String)localObject).split(",")));
        }
      }
    }
  }
  ...
  private void h()
  {
    ...
    this.jdField_a_of_type_AndroidViewView = this.mContentView.findViewById(2131309911);
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)this.mContentView.findViewById(2131309960));
    this.jdField_a_of_type_AndroidWidgetEditText.setOnKeyListener(new pvk(this));
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new pvl(this));
  }
  ...
  private void i()
  {
    ...
    if (j > 4)
    {
      ...
      if (this.jdField_a_of_type_Pvz.a() != 1) {
        break label124;
      }
      localTextView.setText(MessageFormat.format(getString(2131652728), new Object[] { Integer.valueOf(j) }));
    }
    for (;;)
    {
      if (i == 0) {
      ...
      this.jdField_a_of_type_ComTencentWidgetHorizontalListView.getLayoutParams().width = aciy.a(200.0F, getResources());
      ...
      break;
      label124:
      localTextView.setText(MessageFormat.format(getString(2131653388), new Object[] { Integer.valueOf(j) }));
    }
    label152:
    this.jdField_a_of_type_AndroidViewView.setVisibility(0);
    if (this.jdField_a_of_type_Pvz.a() == 1) {
      localTextView.setText(2131652725);
    }
    for (;;)
    {
      setRightViewTextDisable(0);
      break;
      localTextView.setText(2131653387);
    }
    label196:
  ...
  private void j()
  {
    ...
    if (this.jdField_a_of_type_Pvz.a() == 1)
    {
      setTitle(localResources.getString(2131652723));
      setRightButton(2131652725, this);
    }
    for (;;)
    {
      setRightViewTextDisable(0);
      return;
      setTitle(localResources.getString(2131653371));
      setRightButton(2131653387, this);
    }
  }
  ...
  {
    ResultRecord localResultRecord = ResultRecord.a(paramavon.b(), paramavon.a().toString());
    ...
    for (;;)
    {
      ...
      {
        if ((this.jdField_a_of_type_Pvz.a() != 1) || (TextUtils.isEmpty(paramavon.b())) || (this.jdField_a_of_type_Pvz.a() == null)) {
          break label194;
        }
        if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyUgcDatabindingObservableArrayList.size() < this.jdField_a_of_type_Pvz.b()) {
          break;
        }
        paramavon = getActivity().getResources().getString(2131652730, new Object[] { String.valueOf(this.jdField_a_of_type_Pvz.c()) });
        bbmy.a(getActivity(), paramavon, 0).a();
      }
      return;
      localResultRecord.a(1);
    }
    if (this.jdField_a_of_type_Pvz.a().contains(paramavon.b()))
    {
  ...
  public void b(ObservableArrayList<ResultRecord> paramObservableArrayList, int paramInt1, int paramInt2)
  {
    ...
    if (paramObservableArrayList.size() > this.jdField_a_of_type_Pvz.b())
    {
      String str = String.format(getString(2131629259), new Object[] { Integer.valueOf(this.jdField_a_of_type_Pvz.b()) });
      if (this.jdField_a_of_type_Pvz.a() == 1) {
        str = getString(2131652730, new Object[] { String.valueOf(this.jdField_a_of_type_Pvz.c()) });
      }
      paramObservableArrayList.subList(paramInt1, paramInt1 + paramInt2).clear();
      bbmy.a(getActivity(), str, 0).a();
      return;
    }
    i();
  }
  ...
  protected void d()
  {
    this.jdField_a_of_type_ComTencentWidgetHorizontalListView = ((HorizontalListView)this.mContentView.findViewById(2131310058));
    this.jdField_a_of_type_Pwa = new pwa(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyUgcDatabindingObservableArrayList);
    this.jdField_a_of_type_ComTencentWidgetHorizontalListView.setAdapter(this.jdField_a_of_type_Pwa);
    this.jdField_a_of_type_ComTencentWidgetHorizontalListView.setOverScrollMode(2);
    this.jdField_a_of_type_ComTencentWidgetHorizontalListView.setOnItemClickListener(new pvm(this));
  }
