  ...
  extends ReportDialog
{
  ...
  public SlidingUpDialog(@NotNull Activity paramActivity, @NotNull View paramView, @NotNull RelativeLayout.LayoutParams paramLayoutParams)
  {
  ...
  {
    findViewById(2131365302).setOnTouchListener((View.OnTouchListener)new SlidingUpDialog.setCancelOnTouchOutside.1(this));
  ...
  protected void onCreate(@Nullable Bundle paramBundle)
  {
    ...
    setContentView(2131560341);
    this.jdField_a_of_type_AndroidViewView.setId(2131376574);
    paramBundle = findViewById(2131363739);
    localObject = findViewById(2131377361);
    ...
    a();
    findViewById(2131364357).setOnClickListener((View.OnClickListener)new SlidingUpDialog.onCreate.2(this));
    b();
  }
}
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.ugc.selecttopic.SlidingUpDialog
