  ...
  extends BaseAdapter
{
  ...
  private ReadInJoyDraftboxModule jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelReadInJoyDraftboxModule = ReadInJoyLogicEngine.a().a();
  ...
  {
    if (paramView == null) {}
    for (View localView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131560293, null);; localView = paramView)
    {
      Object localObject2 = (TextView)localView.findViewById(2131380324);
      MiddleBracketsTitleTextView localMiddleBracketsTitleTextView = (MiddleBracketsTitleTextView)localView.findViewById(2131380322);
      paramView = (TextView)localView.findViewById(2131380323);
      ImageView localImageView = (ImageView)localView.findViewById(2131369643);
      TextView localTextView = (TextView)localView.findViewById(2131380298);
      ...
      if ((this.jdField_a_of_type_JavaUtilList != null) && (paramInt >= 0) && (paramInt < this.jdField_a_of_type_JavaUtilList.size()))
      {
        ...
        paramView.setText(ReadInJoyTimeUtils.a(localReadInJoyDraftboxItem.time, false));
        paramView = localReadInJoyDraftboxItem.title;
        if (localReadInJoyDraftboxItem.type == 3) {
          paramView = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131718335);
        }
        ...
        if (localReadInJoyDraftboxItem.type == 2) {
          localObject1 = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131718334) + ": " + paramView;
        }
      ...
      for (;;)
      {
        localView.setOnClickListener(new ReadInJoyDraftboxAdapter.1(this, localReadInJoyDraftboxItem));
        localTextView.setOnClickListener(new ReadInJoyDraftboxAdapter.2(this, localReadInJoyDraftboxItem, paramInt));
        localView.setTag(-3, Integer.valueOf(ViewUtils.a(66.0F)));
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.ugc.ReadInJoyDraftboxAdapter
