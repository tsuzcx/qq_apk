...
public abstract class KandianVideoUploadController
{
  ...
  ReadInJoyObserver jdField_a_of_type_ComTencentBizPubaccountReadinjoyEngineReadInJoyObserver = new KandianVideoUploadController.1(this);
  private VisibleSetParam jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructVisibleSetParam;
  private KandianVideoUploadController.DeliverVideoTaskListener jdField_a_of_type_ComTencentBizPubaccountReadinjoyUgcKandianVideoUploadController$DeliverVideoTaskListener;
  ...
  private void a(Bundle paramBundle, VideoMetaInfo paramVideoMetaInfo, int paramInt)
  {
    ...
    try
    {
      ...
      ((JSONObject)localObject).put("video_bit_rate", Long.valueOf(paramVideoMetaInfo.b()).toString());
      ((JSONObject)localObject).put("video_capacity", Long.valueOf(paramVideoMetaInfo.a()).toString());
      ...
      ((IPublicAccountReportUtils)QRoute.api(IPublicAccountReportUtils.class)).publicAccountReportClickEvent(null, "", "0X80093D4", "0X80093D4", 0, 0, "", "", "", ((JSONObject)localObject).toString(), false);
      return;
    }
  ...
  public void a(boolean paramBoolean, Context paramContext, Bundle paramBundle, VideoMetaInfo paramVideoMetaInfo, KandianVideoUploadController.DeliverVideoTaskListener paramDeliverVideoTaskListener)
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyUgcKandianVideoUploadController$DeliverVideoTaskListener = paramDeliverVideoTaskListener;
    if (paramBundle == null) {}
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.ugc.KandianVideoUploadController
