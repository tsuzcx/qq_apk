  ...
  extends BaseAdapter
{
  ...
  public View getView(int paramInt, @Nullable View paramView, @Nullable ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      a(this.jdField_a_of_type_JavaUtilList.get(paramInt), (BaseSelectAdapter.BaseSelectViewHolder)localObject);
      ...
      localObject = (BaseSelectAdapter.BaseSelectViewHolder)localObject;
      localView = paramView;
    }
  }
}
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.ugc.selecttopic.BaseSelectAdapter
