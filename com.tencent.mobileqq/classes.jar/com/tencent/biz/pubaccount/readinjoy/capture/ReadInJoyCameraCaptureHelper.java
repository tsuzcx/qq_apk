...
public class ReadInJoyCameraCaptureHelper
{
  ...
  public static android.graphics.drawable.BitmapDrawable a(Context paramContext)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 22	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   4: astore 8
    //   6: aload 8
    //   8: getstatic 28	android/provider/MediaStore$Video$Media:EXTERNAL_CONTENT_URI	Landroid/net/Uri;
    //   11: aconst_null
    //   12: aconst_null
    //   13: aconst_null
    //   14: aconst_null
    //   15: invokevirtual 34	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   18: astore 4
    //   20: aload 4
    //   22: ifnull +254 -> 276
    //   25: aload 4
    ...
    //   73: aload 7
    //   75: astore 6
    //   77: invokestatic 55	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   80: ifeq +36 -> 116
    //   83: aload 4
    //   85: astore 5
    //   87: aload 7
    ...
    //   113: invokestatic 77	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   116: aload 4
    //   118: astore 5
    //   120: aload 7
    //   122: astore 6
    ...
    //   128: iconst_3
    //   129: aconst_null
    //   130: invokestatic 83	android/provider/MediaStore$Video$Thumbnails:getThumbnail	(Landroid/content/ContentResolver;JILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   133: astore_3
    //   134: aload_3
    //   135: ifnull +40 -> 175
    //   138: aload_3
    ...
    //   143: ifnull +13 -> 156
    //   146: aload 4
    //   148: invokeinterface 86 1 0
    //   153: aload_3
    //   154: astore 5
    //   156: aload 5
    //   158: ifnull +97 -> 255
    //   161: new 88	android/graphics/drawable/BitmapDrawable
    //   164: dup
    //   165: aload_0
    //   166: invokevirtual 92	android/content/Context:getResources	()Landroid/content/res/Resources;
    //   169: aload 5
    //   171: invokespecial 95	android/graphics/drawable/BitmapDrawable:<init>	(Landroid/content/res/Resources;Landroid/graphics/Bitmap;)V
    //   174: areturn
    //   175: aload 4
    //   177: astore 5
    //   179: aload_3
    ...
    //   209: astore 5
    //   211: aload 7
    //   213: invokevirtual 101	java/lang/Exception:printStackTrace	()V
    //   216: aload_3
    //   217: astore 5
    //   219: aload 4
    //   221: ifnull -65 -> 156
