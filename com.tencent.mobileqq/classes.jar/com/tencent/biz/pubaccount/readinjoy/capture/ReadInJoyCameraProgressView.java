  ...
  extends View
{
  ...
  public void a()
  {
    ...
    for (float f = ((Float)this.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_a_of_type_JavaUtilArrayList.size() - 2)).floatValue();; f = 0.0F)
    {
      ...
      if (this.jdField_a_of_type_AndroidOsHandler != null) {
        this.jdField_a_of_type_AndroidOsHandler.post(new lkc(this));
      }
      return;
    }
  }
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_AndroidOsHandler.post(new lkd(this));
        return;
        f1 = f2;
        break;
  ...
  public void setProgress(long paramLong1, long paramLong2)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidOsHandler.post(new lke(this));
      return;
