  ...
  implements DialogInterface.OnDismissListener, View.OnClickListener
{
  ...
  private lih jdField_a_of_type_Lih;
  private ViewGroup b;
  ...
  private void d()
  {
    RelativeLayout localRelativeLayout = (RelativeLayout)View.inflate(this.jdField_a_of_type_AndroidAppActivity, 2130969552, null);
    ...
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)localRelativeLayout.findViewById(2131362822));
    this.jdField_a_of_type_AndroidViewViewGroup.setOnClickListener(this);
    this.b = ((ViewGroup)localRelativeLayout.findViewById(2131364634));
    ...
    localWindow.setWindowAnimations(2131624712);
    this.jdField_a_of_type_AndroidViewView = localRelativeLayout.findViewById(2131366081);
    this.jdField_a_of_type_AndroidViewView.setOnClickListener(this);
    this.jdField_a_of_type_ComTencentWidgetHorizontalListView = ((HorizontalListView)localRelativeLayout.findViewById(2131366926));
  ...
  {
    if (this.jdField_a_of_type_Lih != null) {
      this.jdField_a_of_type_Lih.c();
    }
  }
}
