  ...
  implements TaskOfflineUtils.OfflineCallBack
{
  ...
  public void onStateChange(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      return;
      if ((paramInt1 != 7) && (paramInt1 != 8) && (paramInt1 != 5) && (!((Boolean)bhvh.a("kd_fc_so_download", Boolean.valueOf(false))).booleanValue())) {
        noo.a(null, "", "0X8009A1C", "0X8009A1C", 0, 0, "", "", "" + paramInt1, "download fail", false);
      }
