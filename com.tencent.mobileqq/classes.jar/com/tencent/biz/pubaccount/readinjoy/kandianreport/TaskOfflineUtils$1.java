  ...
  implements Runnable
{
  ...
  public void run()
  {
    try
    {
      HtmlOffline.a(this.val$bid, BaseApplicationImpl.getApplication().getRuntime(), new TaskOfflineUtils.TaskAsyncBack(this.val$bid, this.val$supportVersion, this.val$offlineCallBack), true, 5, true);
      return;
    }
