...
public class TaskException
{
  ...
  public static void reportCrash(String paramString)
  {
    ...
    //   158: ldc 95
    //   160: ldc 97
    //   162: invokestatic 103	bmhv:a	(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    //   361: invokestatic 161	bmhv:a	(Ljava/lang/String;Ljava/lang/Object;)V
    //   364: aconst_null
    //   365: ldc 97
    //   367: ldc 163
    //   369: ldc 163
    ...
    //   384: iconst_0
    //   385: invokestatic 169	olh:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)V
    //   388: ldc 95
    //   390: aload_0
    //   391: invokestatic 161	bmhv:a	(Ljava/lang/String;Ljava/lang/Object;)V
    //   394: bipush 81
    //   396: getstatic 175	com/tencent/biz/pubaccount/readinjoy/kandianreport/TaskManager:scriptVersion	I
    //   399: aload 13
    //   401: invokevirtual 164	org/json/JSONObject:toString	()Ljava/lang/String;
    //   404: invokestatic 181	com/tencent/biz/pubaccount/readinjoy/kandianreport/TaskDistribution:getAttrList	(Ljava/lang/String;)Ljava/util/List;
    //   407: invokestatic 186	uuc:a	(IILjava/util/List;)V
    //   410: return
    //   411: astore 11
    //   413: getstatic 12	com/tencent/biz/pubaccount/readinjoy/kandianreport/TaskException:TAG	Ljava/lang/String;
    //   416: iconst_2
    //   417: aload 11
    //   419: invokevirtual 189	org/json/JSONException:getMessage	()Ljava/lang/String;
    ...
    //   436: iconst_1
    //   437: aload_0
    //   438: invokevirtual 190	java/lang/Throwable:getMessage	()Ljava/lang/String;
    ...
    //   459: iconst_1
    //   460: aload 11
    //   462: invokevirtual 189	org/json/JSONException:getMessage	()Ljava/lang/String;
  ...
  public static void reportException(String paramString)
  {
    try
    {
      ...
      localJSONObject.put("sys_version", DeviceInfoUtil.getDeviceOSVersion());
      localJSONObject.put("qq_version", DeviceInfoUtil.getQQVersion());
      localJSONObject.put("appid", AppSetting.a() + "");
      QLog.d(TAG, 1, "reportException: " + localJSONObject.toString());
      olh.a(null, "", "0X8009831", "0X8009831", 0, 0, "", "", "", localJSONObject.toString(), false);
      return;
    }
  ...
  public static void reportException(String paramString1, String paramString2)
  {
    try
    {
      ...
      localJSONObject.put("version", TaskManager.scriptVersion + "");
      localJSONObject.put("appid", AppSetting.a() + "");
      olh.a(null, "", "0X8009830", "0X8009830", 0, 0, "", "", "", localJSONObject.toString(), false);
      return;
    }
  ...
  public static void reportSOException(String paramString)
  {
    try
    {
      ...
      localJSONObject.put("version", TaskManager.scriptVersion + "");
      localJSONObject.put("appid", AppSetting.a() + "");
      olh.a(null, "", "0X800982E", "0X800982E", 0, 0, "", "", "", localJSONObject.toString(), false);
      return;
    }
    catch (Exception paramString)
    {
