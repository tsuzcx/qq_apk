...
public class TaskManager
{
  ...
  static
  {
    ...
    try
    {
      ...
      SCRIPT_ROOT_PATH = mol.a("3412") + "3412";
  ...
  {
    return ((Integer)bgmq.a("kandianreport_ON", Integer.valueOf(0))).intValue() == 1;
  }
  ...
  {
    int i = ((Integer)bgmq.a("kandianreport.taskmanager" + paramTask.id, Integer.valueOf(0))).intValue();
    return (i != Task.STATUS_FAIL) && (i != Task.STATUS_QUIT);
  }
  
  private Task readTaskConfigFile(File paramFile)
  {
    return readTaskConfigJson(bace.a(paramFile));
  }
  ...
  private void reportToServer(JSContext paramJSContext, String paramString1, String paramString2)
  {
    ...
    paramString1.put("sys_version", babp.e());
    paramString1.put("qq_version", babp.c());
    paramString1.put("appid", AppSetting.a() + "");
    ndn.a(null, "", "0X800982F", "0X800982F", 0, 0, "", "", "", paramString1.toString(), false);
  }
  ...
  private void startTasksIfExist()
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        try
        {
          if (mpr.a(SCRIPT_ROOT_PATH, "3412")) {
            continue;
          }
  ...
  public void markTaskFail(Task paramTask)
  {
    ...
    bgmq.a("kandianreport.taskmanager" + paramTask.id, Integer.valueOf(Task.STATUS_FAIL));
  }
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localTask.id == paramString) {
        try
        {
          ...
          bgmq.a("kandianreport.taskmanager" + paramString, Integer.valueOf(Task.STATUS_ACCEPT));
        }
        catch (Exception localException)
        {
          markTaskFail(localTask);
  ...
  public void restore()
  {
    ...
    bgmq.a("kandianreport_ON", Integer.valueOf(1));
  }
