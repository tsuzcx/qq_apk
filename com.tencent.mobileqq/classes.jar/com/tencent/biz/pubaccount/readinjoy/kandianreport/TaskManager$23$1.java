  ...
  implements bapx
{
  ...
  {
    if (parambaqw.jdField_a_of_type_ArrayOfByte != null) {}
    for (String str1 = new String(parambaqw.jdField_a_of_type_ArrayOfByte);; str1 = "")
    {
      StringBuffer localStringBuffer = new StringBuffer();
      if (parambaqw.jdField_a_of_type_JavaUtilHashMap != null)
      {
        localObject1 = new JSONObject();
        Iterator localIterator = parambaqw.jdField_a_of_type_JavaUtilHashMap.entrySet().iterator();
      ...
      for (Object localObject1 = ((JSONObject)localObject1).toString();; localObject1 = "")
      {
        ...
        parambaqw = this.val$callbackMethod + "(" + parambaqw.c + ",'" + (String)localObject1 + "','" + str1 + "')";
        if (this.val$jsContext != null)
        {
          this.val$jsContext.evaluteStringWithException(parambaqw, localStringBuffer);
          if (!TextUtils.isEmpty(localStringBuffer))
          {
            this.this$1.this$0.markTaskFail(this.this$1.val$task);
            QLog.d("kandianreport.taskmanager", 1, "evaluate js exception: " + parambaqw + " " + localStringBuffer);
            TaskException.reportException(this.this$1.val$task.id, "evaluate js exception: " + parambaqw + " " + localStringBuffer);
          }
        }
        return;
      }
