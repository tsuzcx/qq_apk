...
public class WeakNetHelper
{
  ...
  static boolean a()
  {
    ...
    {
      boolean bool = RIJXTabFrameUtils.a.a();
      if (bool) {}
  ...
  static boolean a(ToServiceMsg paramToServiceMsg)
  {
    if (paramToServiceMsg != null)
    {
      ...
      paramToServiceMsg = (Long)paramToServiceMsg.getAttribute(ReadInJoyEngineModule.d);
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.weaknet.WeakNetHelper
