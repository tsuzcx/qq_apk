  ...
  extends ReadInJoyEngineModule
{
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      ...
      i = ReadInJoyOidbHelper.a(paramFromServiceMsg, paramObject, paramToServiceMsg);
  ...
  public void a()
  {
    ...
    localReqBody.uint32_req_recommend_flag.set(VideoPlayRecommendHandler.a());
    localReqBody.uint64_uin.set(ReadInJoyUtils.a());
    String str = (String)ReadInJoyHelper.a(RIJColumnDataSource.f, "");
    if (!TextUtils.isEmpty(str)) {
      localReqBody.bytes_entrance_cookie.set(ByteStringMicro.copyFromUtf8(str));
    }
    a(ReadInJoyOidbHelper.a("OidbSvc.0x6cf", 1743, 1, localReqBody.toByteArray()));
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.model.ReadInJoyDianDianEntranceModule
