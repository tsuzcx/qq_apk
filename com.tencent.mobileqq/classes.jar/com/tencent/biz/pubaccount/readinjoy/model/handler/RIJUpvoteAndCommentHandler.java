  ...
  extends RIJBaseArticleInfoHandler
{
  ...
  {
    Iterator localIterator = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelArticleInfoModule.a().c(paramInt).values().iterator();
    while (localIterator.hasNext())
    {
      ...
      {
        TopicRecommendFeedsInfo localTopicRecommendFeedsInfo = localArticleInfo.mTopicRecommendFeedsInfo;
  ...
  private void a(ArticleInfo paramArticleInfo1, ArticleInfo paramArticleInfo2)
  {
    if ((paramArticleInfo2.mFeedId != paramArticleInfo1.mFeedId) && (paramArticleInfo2.mSocialFeedInfo != null))
    {
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelArticleInfoModule.a(paramArticleInfo2);
      paramArticleInfo1 = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelArticleInfoModule.a().a(paramArticleInfo2, (int)paramArticleInfo2.mChannelID);
  ...
  private void a(ArticleInfo paramArticleInfo, oidb_cmd0x8c8.SocializeFeedsInfo paramSocializeFeedsInfo, int paramInt)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelArticleInfoModule.a(paramArticleInfo);
      paramSocializeFeedsInfo = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelArticleInfoModule.a().a(paramArticleInfo, paramInt);
  ...
  private void a(ConcurrentMap<Long, ArticleInfo> paramConcurrentMap, long paramLong, int paramInt, List<Long> paramList)
  {
    ...
    for (;;)
    {
      if (localArticleInfo != null)
      {
        ...
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelArticleInfoModule.a().a(Integer.valueOf(0), localArticleInfo);
  ...
  private void b(ConcurrentMap<Long, ArticleInfo> paramConcurrentMap, long paramLong, int paramInt, List<Long> paramList)
  {
    ...
    for (;;)
    {
      ...
      {
        paramConcurrentMap.remove(Long.valueOf(localArticleInfo.mRecommendSeq));
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelArticleInfoModule.a().a(Integer.valueOf(70), localArticleInfo);
        paramList.add(Long.valueOf(localArticleInfo.mRecommendSeq));
      }
      return;
      localArticleInfo = null;
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.model.handler.RIJUpvoteAndCommentHandler
