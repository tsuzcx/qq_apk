  ...
  public void run()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localReqChannelPara.uint32_sim_type.set(bnrf.c());
        localReqChannelPara.uint32_network_type.set(pon.b());
        ...
        if (this.a.jdField_d_of_type_Int > 0)
        {
          ...
          if (!TextUtils.isEmpty(this.a.jdField_a_of_type_Qfw.c))
          {
            localInnerMsg.bytes_push_context.set(ByteStringMicro.copyFromUtf8(this.a.jdField_a_of_type_Qfw.c));
            if (QLog.isColorLevel()) {
              QLog.d(prf.jdField_a_of_type_JavaLangString, 2, "add push contenxt:" + this.a.jdField_a_of_type_Qfw.c);
            }
          }
          localInnerMsg.uint64_algorithm_id.set(this.a.jdField_a_of_type_Qfw.jdField_a_of_type_Long);
          localInnerMsg.uint32_strategy_id.set(this.a.jdField_a_of_type_Qfw.jdField_a_of_type_Int);
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.e(prf.jdField_a_of_type_JavaLangString, 2, "request0xbedSendWeiShiArticleInfoList makeParams:" + ozs.a(localThrowable));
        }
        return;
      }
    }
    ...
    ToServiceMsg localToServiceMsg = qfq.a("OidbSvc.0xbed", 3053, 1, localThrowable.toByteArray());
    if (localToServiceMsg != null)
    {
      localToServiceMsg.getAttributes().put("channelID", Integer.valueOf(this.a.jdField_a_of_type_Int));
      localToServiceMsg.getAttributes().put(pqj.d, Long.valueOf(this.a.jdField_a_of_type_Long));
      localToServiceMsg.getAttributes().put(pqj.e, Long.valueOf(this.a.jdField_b_of_type_Long));
