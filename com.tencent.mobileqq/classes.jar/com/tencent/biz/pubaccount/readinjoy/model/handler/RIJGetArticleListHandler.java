...
import com.tencent.biz.pubaccount.readinjoy.model.ArticleInfoModuleUtils.CommonChannelDataHandle;
import com.tencent.biz.pubaccount.readinjoy.model.ArticleInfoModuleUtils.FollowChannelDataHandler;
...
import com.tencent.biz.pubaccount.readinjoy.readinfo.UserReadUnReadInfoManager.ReadUnRead;
...
import com.tencent.biz.pubaccount.readinjoy.weaknet.WeakNetReportUtil;
...
{
  private static volatile com.tencent.util.Pair<List<Long>, oidb_cmd0x68b.RspBody> jdField_a_of_type_ComTencentUtilPair = null;
  ...
  private ToServiceMsg a(ReadInJoyRequestParams.Request0x68bParams paramRequest0x68bParams)
  {
    ...
    long l2 = Long.valueOf(ReadInJoyUtils.a()).longValue();
    ...
    UGRuleManager.a(localReqChannelPara, String.valueOf(paramRequest0x68bParams.jdField_b_of_type_Int));
    localReqChannelPara.uint32_residence_time.set((int)UGRuleManager.a(paramRequest0x68bParams.jdField_b_of_type_Int));
    ...
    if (StudyModeManager.a())
    {
      ...
      QLog.d("RIJGetArticleListHandler", 1, "is study mode! channelID=" + paramRequest0x68bParams.jdField_b_of_type_Int);
    }
    ...
    localReqChannelPara.uint32_privacy_status.set(ReadInJoyUserDataUtils.b());
    Object localObject;
    ...
    for (String str = Build.MODEL;; str = "")
    {
      ...
      if (paramRequest0x68bParams.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelSelectPositionModule$PositionData != null)
      {
        oidb_cmd0x68b.ChannelLocationInfo localChannelLocationInfo = new oidb_cmd0x68b.ChannelLocationInfo();
        localChannelLocationInfo.city.set(ByteStringMicro.copyFromUtf8(paramRequest0x68bParams.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelSelectPositionModule$PositionData.city));
        localChannelLocationInfo.province.set(ByteStringMicro.copyFromUtf8(paramRequest0x68bParams.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelSelectPositionModule$PositionData.province));
        localChannelLocationInfo.nation.set(ByteStringMicro.copyFromUtf8(paramRequest0x68bParams.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelSelectPositionModule$PositionData.country));
        localChannelLocationInfo.city_code.set(ByteStringMicro.copyFromUtf8(paramRequest0x68bParams.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelSelectPositionModule$PositionData.cityCode));
        localReqChannelPara.msg_channel_location_info.set(localChannelLocationInfo);
        if (QLog.isColorLevel()) {
          QLog.i("RIJGetArticleListHandler", 1, "0x68b request positionInfo = " + paramRequest0x68bParams.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelSelectPositionModule$PositionData);
        }
      }
      QLog.i("RIJGetArticleListHandler", 1, "0x68b request brand = " + (String)localObject + ", model = " + str);
      localObject = a(paramRequest0x68bParams, localReqChannelPara);
      ReadInJoyChannelGuidingManager.a(paramRequest0x68bParams, (List)localObject);
      ...
      int i = ((Integer)ReadInJoyHelper.a("key_sp_is_readinjoy_youngster", Integer.valueOf(0))).intValue();
      ...
      if (ReadInJoyRefreshOptimizeUtil.b(l1)) {
  ...
  private ToServiceMsg a(ReadInJoyRequestParams.Request0x68bParams paramRequest0x68bParams, oidb_cmd0x68b.ReqBody paramReqBody, long paramLong)
  {
    ...
    if (paramRequest0x68bParams.jdField_b_of_type_Int == 41403)
    {
      ...
      ((ToServiceMsg)localObject).getAttributes().put(ReadInJoyEngineModule.jdField_c_of_type_JavaLangString, Integer.valueOf(paramRequest0x68bParams.jdField_a_of_type_Int));
      ((ToServiceMsg)localObject).getAttributes().put(ReadInJoyEngineModule.d, Long.valueOf(paramRequest0x68bParams.jdField_a_of_type_Long));
      ((ToServiceMsg)localObject).getAttributes().put(ReadInJoyEngineModule.e, Long.valueOf(paramRequest0x68bParams.jdField_b_of_type_Long));
      ((ToServiceMsg)localObject).getAttributes().put(ReadInJoyEngineModule.f, Integer.valueOf(1));
      ((ToServiceMsg)localObject).getAttributes().put(ReadInJoyEngineModule.jdField_b_of_type_JavaLangString, Integer.valueOf(paramRequest0x68bParams.jdField_g_of_type_Int));
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      return localObject;
      if ((DailyModeConfigHandler.c(paramRequest0x68bParams.jdField_b_of_type_Int)) || (ReadInJoyHelper.a(paramRequest0x68bParams.jdField_b_of_type_Int)))
      {
  ...
  private List<oidb_cmd0x68b.ExposeArticleInfo> a(int paramInt)
  {
    ...
    {
      return null;
      localObject = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelArticleInfoModule.a().b(paramInt);
  ...
  private void a(ReadInJoyRequestParams.Request0x68bParams paramRequest0x68bParams, List<oidb_cmd0x68b.InnerMsg> paramList)
  {
    ...
    if (paramRequest0x68bParams.jdField_h_of_type_Int == 5)
    {
      ...
      if (!TextUtils.isEmpty(paramRequest0x68bParams.jdField_c_of_type_JavaLangString))
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("RIJGetArticleListHandler", 2, "add push contenxt:" + paramRequest0x68bParams.jdField_c_of_type_JavaLangString);
        }
      }
    }
    for (;;)
  ...
  {
    if (paramRequest0x68bParams.jdField_a_of_type_ComTencentBizPubaccountReadinjoyReadinfoUserReadUnReadInfoManager$ReadUnRead != null)
    {
      ...
      ArrayList localArrayList = new ArrayList();
      Iterator localIterator = paramRequest0x68bParams.jdField_a_of_type_ComTencentBizPubaccountReadinjoyReadinfoUserReadUnReadInfoManager$ReadUnRead.a.iterator();
      ...
      localArrayList = new ArrayList();
      paramRequest0x68bParams = paramRequest0x68bParams.jdField_a_of_type_ComTencentBizPubaccountReadinjoyReadinfoUserReadUnReadInfoManager$ReadUnRead.b.iterator();
  ...
  private void a(ToServiceMsg paramToServiceMsg, Object paramObject, int paramInt, Integer paramInteger)
  {
    ...
    j = com.tencent.biz.common.util.NetworkUtil.a(BaseApplicationImpl.context);
    boolean bool = com.tencent.mobileqq.utils.NetworkUtil.g(BaseApplicationImpl.context);
    paramObject = (Long)paramToServiceMsg.getAttribute(ReadInJoyEngineModule.d);
    if (paramObject != null)
    {
      ...
      if (ReadInJoyRefreshOptimizeUtil.b(localLong2.longValue()))
      {
        if (str1 == null) {
          break label780;
        }
    ...
    {
      RIJStatisticCollectorReport.a(paramObject, bool, System.currentTimeMillis() - paramToServiceMsg.extraData.getLong("sendtimekey"), localHashMap);
      return;
    }
  }
  ...
  {
    switch (((Integer)paramToServiceMsg.getAttribute(ReadInJoyEngineModule.jdField_c_of_type_JavaLangString)).intValue())
    {
    default: 
      return;
    case 5: 
      long l1 = ((Long)paramToServiceMsg.getAttribute(ReadInJoyEngineModule.d)).longValue();
      long l2 = ((Long)paramToServiceMsg.getAttribute(ReadInJoyEngineModule.e)).longValue();
      int j = ((Integer)paramToServiceMsg.getAttribute(ReadInJoyEngineModule.f)).intValue();
      int k = ((Integer)paramToServiceMsg.getAttribute(ReadInJoyEngineModule.jdField_b_of_type_JavaLangString)).intValue();
      if (QLog.isColorLevel()) {
        if (paramList1 != null) {
          break label409;
        }
      ...
      for (int i = 0;; i = paramList1.size())
      {
        ...
        paramToServiceMsg.getAttributes().put(ReadInJoyEngineModule.f, Integer.valueOf(2));
      ...
      if (paramInt2 == 2901)
      {
        ...
        for (;;)
        {
          ...
          this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelArticleInfoModule.a(paramBoolean1, paramInt1, paramBoolean2, paramList1, l1, l2, paramList2, paramArrayOfByte, paramToServiceMsg);
        }
      }
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelArticleInfoModule.a(paramBoolean1, paramInt1, paramBoolean2, paramList1, l1, l2, paramList2, paramArrayOfByte, paramToServiceMsg);
      return;
  ...
  private void a(ToServiceMsg paramToServiceMsg, oidb_cmd0x68b.RspBody paramRspBody, int paramInt)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (ArticleInfoModuleUtils.a.a(l, paramRspBody))
      {
        ...
        localObject2 = RIJPBFieldUtils.a(((oidb_cmd0x68b.RspGetFollowTabData)localObject3).bytes_set_top_cookie);
        QLog.d("RIJGetArticleListHandler", 1, "follow request back cookie is " + RIJPBFieldUtils.a(((oidb_cmd0x68b.RspGetFollowTabData)localObject3).bytes_set_top_cookie, ""));
        oidb_cmd0x68b.RspChannelArticle localRspChannelArticle;
        if (RIJPBFieldUtils.a(((oidb_cmd0x68b.RspGetFollowTabData)localObject3).uint32_is_no_more_data, 0) == 1)
        {
          bool1 = true;
          localList = ArticleInfoModuleUtils.FollowChannelDataHandler.a.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelArticleInfoModule, (oidb_cmd0x68b.RspChannelArticle)paramRspBody.rspChannelArticle.get(), ((oidb_cmd0x68b.RspGetFollowTabData)localObject3).rpt_article_list);
          ArticleInfoModuleUtils.FollowChannelDataHandler.a.a(((oidb_cmd0x68b.RspGetFollowTabData)localObject3).uint32_has_followed_topic);
          ArticleInfoModuleUtils.FollowChannelDataHandler.a.b(((oidb_cmd0x68b.RspGetFollowTabData)localObject3).uint32_topic_reddot_update_num);
          ArticleInfoModuleUtils.FollowChannelDataHandler.a.a(((oidb_cmd0x68b.RspGetFollowTabData)localObject3).uint32_refresh_topic_update_info, ((oidb_cmd0x68b.RspGetFollowTabData)localObject3).topic_update_info);
          ArticleInfoModuleUtils.FollowChannelDataHandler.a.a(((oidb_cmd0x68b.RspGetFollowTabData)localObject3).uint32_hint_index, localList);
          ArticleInfoModuleUtils.FollowChannelDataHandler.a.a(((oidb_cmd0x68b.RspGetFollowTabData)localObject3).bytes_refresh_cookie);
          localObject3 = paramToServiceMsg.getAttributes().get("realTimeServiceKey");
          ArticleInfoModuleUtils.a.a(localObject3, paramRspBody.bytes_new_style_params);
        ...
        for (bool1 = true;; bool1 = false)
        {
          ...
          localList = ArticleInfoModuleUtils.CommonChannelDataHandle.a.a(paramToServiceMsg, ((Integer)localObject3).intValue(), i, j, localRspChannelArticle, localRspChannelArticle.rpt_article_list);
          localObject4 = ReadInJoyMSFHandlerUtils.a(localRspChannelArticle, localRspChannelArticle.rpt_deleted_article_list.get(), ((Integer)localObject3).intValue(), i, j);
          localObject2 = RIJPBFieldUtils.a(localRspChannelArticle.bytes_set_top_cookie);
          localObject1 = (ReadInJoyLogicManager)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(QQManagerFactory.READINJOY_LOGIC_MANAGER);
          ReadInJoyAdLog.a("AdDataLink", "handleAdvertisementResp in article request");
          ((ReadInJoyLogicManager)localObject1).a().a(paramToServiceMsg, localRspChannelArticle);
          ArticleInfoModuleUtils.CommonChannelDataHandle.a.a(localRspChannelArticle.bytes_nearby_cookie);
          localObject1 = RIJPBFieldUtils.a(localRspChannelArticle.bytes_pre_load_req_info);
          QLog.d("RIJGetArticleListHandler", 1, new Object[] { "feedsPreload, req info = ", localObject1 });
          ArticleInfoModuleUtils.CommonChannelDataHandle.a.a(localList, localRspChannelArticle.rpt_back_off_group_info, ((Integer)localObject3).intValue());
          if (!ArticleInfoModuleUtils.a.a(l)) {
            break label545;
          }
          paramToServiceMsg = (List)paramToServiceMsg.getAttribute("SubscriptionArticles");
          this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelArticleInfoModule.a(true, ((Integer)localObject3).intValue(), paramToServiceMsg, localList);
          return;
          bool1 = false;
          break;
        }
    ...
    for (localObject2 = localObject4;; localObject2 = null)
    {
      if (FeedsPreloadHelper.a(paramToServiceMsg))
      {
        ...
        localObject4 = new FeedsPreloadDataModule.PreloadCache();
        paramToServiceMsg = ((FeedsPreloadDataModule.PreloadCache)localObject4).a(paramToServiceMsg).a(paramRspBody.intValue()).b(paramInt).a(localList).b((List)localObject2).a(bool1).b(bool2).a((byte[])localObject3);
        if (!TextUtils.isEmpty((CharSequence)localObject1)) {}
        for (;;)
        {
          paramToServiceMsg.a((String)localObject1);
          FeedsPreloadManager.a().a((FeedsPreloadDataModule.PreloadCache)localObject4);
          return;
          localObject1 = "";
        }
      }
    ...
    for (;;)
    {
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        if (paramList.equals(jdField_a_of_type_JavaUtilList))
        {
          ...
          QLog.d("RIJGetArticleListHandler", 2, "savePreloadRedPntPushArticle2Cache :  [red_pnt_push preload resp cached] , article list [ " + ArticleInfoModuleUtils.a(paramList) + " ]");
          i = 1;
          paramList = "";
        }
        try
        ...
        ((IPublicAccountReportUtils)QRoute.api(IPublicAccountReportUtils.class)).publicAccountReportClickEvent(null, "", "0X8009483", "0X8009483", 0, 0, paramRspBody.toString(), "", "", "", false);
        return;
      }
      ...
      QLog.d("RIJGetArticleListHandler", 2, "savePreloadRedPntPushArticle2Cache :  [red_pnt_push preload resp outdated] , article list [" + ArticleInfoModuleUtils.a(paramList) + " ]");
      i = 0;
  ...
  private void a(oidb_cmd0x68b.ReqBody paramReqBody, ToServiceMsg paramToServiceMsg, long paramLong)
  {
    ...
    i = com.tencent.biz.common.util.NetworkUtil.a(BaseApplicationImpl.context);
    bool = com.tencent.mobileqq.utils.NetworkUtil.g(BaseApplicationImpl.context);
    ...
    paramToServiceMsg.getAttributes().put("compressFlag", Boolean.valueOf(ReadInJoyRefreshOptimizeUtil.b(paramLong)));
  }
  ...
  private void a(oidb_cmd0x68b.ReqChannelPara paramReqChannelPara)
  {
    ...
    if (i < k)
    {
      ...
      for (int j = 1;; j = 0)
      {
        ...
        ((oidb_cmd0x68b.PkgInstallInfo)localObject3).bytes_version.set(ByteStringMicro.copyFromUtf8(PackageUtil.a(BaseApplicationImpl.getContext(), (String)localObject1)));
  ...
  private boolean a(ReadInJoyRequestParams.Request0x68bParams paramRequest0x68bParams, long paramLong)
  {
    if ((FeedsPreloadHelper.a(paramRequest0x68bParams)) && (!FeedsPreloadHelper.b(paramRequest0x68bParams)))
    {
      ...
      if (paramRequest0x68bParams != null)
      {
        ...
        long l2 = ((Long)ReadInJoyHelper.a("sp_key_readinjoy_feeds_preload_loading_time", Long.valueOf(50L))).longValue();
  ...
  private void b(ReadInJoyRequestParams.Request0x68bParams paramRequest0x68bParams, List<oidb_cmd0x68b.InnerMsg> paramList)
  {
    if ((paramRequest0x68bParams.jdField_i_of_type_Boolean) && (paramRequest0x68bParams.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructLebaKDCellInfo != null))
    {
      ...
      localInnerMsg.bytes_inner_uniq_id.set(ByteStringMicro.copyFromUtf8(String.valueOf(paramRequest0x68bParams.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructLebaKDCellInfo.articleID)));
      localInnerMsg.template_id.set(paramRequest0x68bParams.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructLebaKDCellInfo.templateID);
      localInnerMsg.bytes_push_context.set(ByteStringMicro.copyFromUtf8(paramRequest0x68bParams.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructLebaKDCellInfo.extraInfo));
      paramList.add(localInnerMsg);
    }
  }
  ...
  private void b(ReadInJoyRequestParams.Request0x68bParams paramRequest0x68bParams, oidb_cmd0x68b.ReqBody paramReqBody)
  {
    if ((paramRequest0x68bParams.jdField_b_of_type_Int == 0) && (RIJQQAppInterfaceUtil.a()))
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("RIJGetArticleListHandler", 2, "session_id = " + RIJThreadHandler.a() + ", history = " + RIJThreadHandler.a().toString());
      }
  ...
  private void c(ReadInJoyRequestParams.Request0x68bParams paramRequest0x68bParams, List<oidb_cmd0x68b.InnerMsg> paramList)
  {
    if ((paramRequest0x68bParams.jdField_c_of_type_JavaUtilList != null) && (!paramRequest0x68bParams.jdField_c_of_type_JavaUtilList.isEmpty()))
    {
      ...
      while (localIterator.hasNext())
      {
        KandianMergeManager.InsertArticleInfo localInsertArticleInfo = (KandianMergeManager.InsertArticleInfo)localIterator.next();
        QLog.d("RIJGetArticleListHandler", 2, "InsertArticleInfo :" + localInsertArticleInfo);
        oidb_cmd0x68b.InnerMsg localInnerMsg = new oidb_cmd0x68b.InnerMsg();
        localInnerMsg.uint32_jump_src_type.set(ReadInJoyRequestParams.Request0x68bParams.a(localInsertArticleInfo));
        localInnerMsg.bytes_inner_uniq_id.set(ByteStringMicro.copyFromUtf8(String.valueOf(localInsertArticleInfo.jdField_a_of_type_Long)));
        if (!TextUtils.isEmpty(paramRequest0x68bParams.jdField_c_of_type_JavaLangString)) {
          localInnerMsg.bytes_push_context.set(ByteStringMicro.copyFromUtf8(paramRequest0x68bParams.jdField_c_of_type_JavaLangString));
        }
  ...
  {
    int k = 1;
    ReadInJoyLogicManager localReadInJoyLogicManager;
    int j;
    int i;
    if (paramRequest0x68bParams.jdField_h_of_type_Boolean)
    {
      localReadInJoyLogicManager = (ReadInJoyLogicManager)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(QQManagerFactory.READINJOY_LOGIC_MANAGER);
      if (localReadInJoyLogicManager != null)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("RIJGetArticleListHandler", 2, "AdvertisementInfoModule reqAdvertisementList params.beginRecommendSeq = " + paramRequest0x68bParams.jdField_a_of_type_Long);
        }
        j = 30;
    ...
    for (;;)
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("RIJGetArticleListHandler", 2, "AdvertisementInfoModule reqAdvertisementList needRequestAdvertisement channelID= " + paramRequest0x68bParams.jdField_b_of_type_Int);
        }
        ...
        SuperMaskExtKt.a((AdRequestData)localObject, paramRequest0x68bParams.jdField_b_of_type_Int);
        localObject = localReadInJoyLogicManager.a().a(paramRequest0x68bParams, paramRequest0x68bParams.jdField_b_of_type_Int, k, i, j, (AdRequestData)localObject);
        localReadInJoyLogicManager.a().a(paramRequest0x68bParams.jdField_b_of_type_Int, i, j);
        if (localObject != null)
        {
      ...
      return;
      label311:
      Object localObject = ReadInJoyLogicEngine.a().a(paramRequest0x68bParams.jdField_b_of_type_Int);
      if (localObject != null)
      {
        if (QLog.isColorLevel()) {
        ...
        j = i + AdvertisementInfoModule.jdField_b_of_type_Int;
      }
      else
      {
        localObject = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelArticleInfoModule.a().c(paramRequest0x68bParams.jdField_b_of_type_Int);
        if (localObject != null)
        {
          if (QLog.isColorLevel()) {
  ...
  private void d(ReadInJoyRequestParams.Request0x68bParams paramRequest0x68bParams, List<oidb_cmd0x68b.InnerMsg> paramList)
  {
    ...
    {
      localObject = paramRequest0x68bParams.jdField_b_of_type_JavaUtilList.iterator();
    ...
    else if (paramRequest0x68bParams.jdField_b_of_type_Int == 40830)
    {
      localObject = new oidb_cmd0x68b.InnerMsg();
      if (paramRequest0x68bParams.jdField_h_of_type_Int <= 0) {
        break label306;
      }
      ((oidb_cmd0x68b.InnerMsg)localObject).uint32_jump_src_type.set(paramRequest0x68bParams.jdField_h_of_type_Int);
    }
    for (;;)
    {
      if (!TextUtils.isEmpty(paramRequest0x68bParams.jdField_c_of_type_JavaLangString))
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("RIJGetArticleListHandler", 2, "troop subscribe add push contenxt:" + paramRequest0x68bParams.jdField_c_of_type_JavaLangString);
        }
      }
  ...
  private void d(ReadInJoyRequestParams.Request0x68bParams paramRequest0x68bParams, oidb_cmd0x68b.ReqBody paramReqBody)
  {
    if (paramRequest0x68bParams.jdField_b_of_type_Int == 41403)
    {
      ...
      if (paramRequest0x68bParams.jdField_a_of_type_Long != -1L)
      {
        paramRequest0x68bParams = (String)ReadInJoyHelper.a("readinjoy_nearby_people_last_refresh_cookie_sp_key", "");
  ...
  {
    oidb_cmd0x68b.ReqBody localReqBody = new oidb_cmd0x68b.ReqBody();
    long l1 = Long.valueOf(ReadInJoyUtils.a()).longValue();
    localReqBody.uint64_uin.set(l1);
    localReqBody.uint32_network_type.set(ArticleInfoModuleUtils.a());
    long l2 = ReadInJoyRefreshOptimizeUtil.a();
    l1 = 768L;
    if (ReadInJoyRefreshOptimizeUtil.b(l2))
    {
      l1 = 0x300 | 0x4000;
    ...
    paramHashMap = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelArticleInfoModule.a().a(Integer.valueOf(70));
    ...
    paramHashMap.getAttributes().put(ReadInJoyEngineModule.jdField_c_of_type_JavaLangString, Integer.valueOf(5));
    l1 = paramLong1;
    if (paramLong1 == 0L) {
      l1 = -1L;
    }
    ...
    paramHashMap.getAttributes().put(ReadInJoyEngineModule.d, Long.valueOf(l1));
    paramHashMap.getAttributes().put(ReadInJoyEngineModule.e, Long.valueOf(paramLong1));
    paramHashMap.getAttributes().put("isSingleHighLight", Boolean.valueOf(false));
    paramHashMap.getAttributes().put(ReadInJoyEngineModule.f, Integer.valueOf(1));
    paramHashMap.getAttributes().put(ReadInJoyEngineModule.jdField_b_of_type_JavaLangString, Integer.valueOf(0));
    paramHashMap.getAttributes().put("channelID", Integer.valueOf(70));
    a(localReqBody, paramHashMap, l2);
    ReadInJoyRefreshOptimizeUtil.a(paramHashMap, l2);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelArticleInfoModule.a(paramHashMap);
  ...
  public void a(ReadInJoyRequestParams.Request0x68bParams paramRequest0x68bParams)
  {
    ...
    } while (a(paramRequest0x68bParams, l1));
    ...
    ArticleInfoModule.b(true);
    ArticleInfoModule.b(paramRequest0x68bParams.jdField_g_of_type_Int);
    ...
    for (boolean bool = ((Boolean)localObject).booleanValue();; bool = false)
    {
      ...
      if (bool)
      {
        ...
        if (i == 0)
        {
          ...
          QLog.d("RIJGetArticleListHandler", 2, "handle0x68bGetArticleList  : [red_pnt_push preload resp back] , article list [ " + ArticleInfoModuleUtils.a((List)localObject) + " ]");
          return;
        }
      }
      try
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.model.handler.RIJGetArticleListHandler
