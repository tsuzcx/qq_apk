...
public class ReadInJoyUserInfoModule$1
  implements Runnable
{
  ReadInJoyUserInfoModule$1(ReadInJoyUserInfoModule paramReadInJoyUserInfoModule, String paramString, boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3) {}
  ...
  public void run()
  {
    ...
    if (ReadInJoyUserInfoModule.a(this.this$0) != null)
    {
      ...
      if ((localObject1 != null) && ((!this.jdField_a_of_type_Boolean) || (!((ReadInJoyUserInfo)localObject1).isReadlTimeRead())))
      {
    ...
    for (;;)
    {
      localObject1 = ((pqo)localObject1).a((String)localObject2, bool);
      if ((localObject1 != null) && (((List)localObject1).size() > 0))
      {
        localObject2 = (ReadInJoyUserInfo)((List)localObject1).get(0);
        if ((localObject2 != null) && ((!this.jdField_a_of_type_Boolean) || (!((ReadInJoyUserInfo)localObject2).isReadlTimeRead()))) {
          break;
        }
      }
      if ((localObject1 != null) && (((List)localObject1).size() > 0) && (!this.jdField_a_of_type_Boolean)) {
        break;
      }
      localObject1 = new ArrayList();
      ((List)localObject1).add(this.jdField_a_of_type_JavaLangString);
      this.this$0.a((List)localObject1, this.jdField_a_of_type_Int, this.b, this.c);
      return;
      bool = false;
    }
  }
