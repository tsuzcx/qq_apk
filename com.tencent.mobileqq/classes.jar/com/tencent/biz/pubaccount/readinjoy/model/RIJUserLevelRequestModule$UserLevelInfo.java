  ...
  implements Serializable
{
  ...
  {
    return "UserLevelInfo{uin=" + this.uin + ", level=" + this.level + ", jumpUrl='" + this.jumpUrl + '\'' + ", opesAllowed=" + this.opesAllowedMap + ", currentOpType=" + this.currentOpType + ", dailyTopicNum" + this.dailyTopicNum + '}';
  }
}
