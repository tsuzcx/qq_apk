...
public class FollowCoverInfoModule$2
  implements Runnable
{
  public FollowCoverInfoModule$2(pxc parampxc, rii paramrii) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ((SharedPreferences.Editor)localObject).putInt("follow_tab_topic_update_info_exists", pxc.a(this.this$0));
