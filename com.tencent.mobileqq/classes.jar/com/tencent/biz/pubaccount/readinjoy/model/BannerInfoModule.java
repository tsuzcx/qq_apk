  ...
  extends ReadInJoyEngineModule
{
  ...
  public BannerInfoModule(AppInterface paramAppInterface, EntityManager paramEntityManager, ExecutorService paramExecutorService, ReadInJoyMSFService paramReadInJoyMSFService, Handler paramHandler, ArticleInfoModule paramArticleInfoModule)
  {
    ...
    if (paramArticleInfoModule != null) {
      paramArticleInfoModule.a().a(new BannerInfoModule.1(this));
    }
  }
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
      ...
      if ((paramObject.rpt_msg_banner_list.has()) && (paramObject.rpt_msg_banner_list.size() > 0))
      {
        ...
        if (i < paramObject.rpt_msg_banner_list.size())
        {
          ...
          if (paramToServiceMsg.uint32_banner_type.has())
          {
            ...
            paramToServiceMsg = TopBannerInfo.VideoItem.b(paramToServiceMsg);
          }
        }
      }
    }
    ...
    for (;;)
    {
      ...
      {
        paramToServiceMsg = TopBannerInfo.ImgItem.b(paramToServiceMsg);
        continue;
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    for (localObject1 = "";; localObject1 = ((TopBannerInfo)localObject1).mCookie)
    {
      ...
      a(ReadInJoyOidbHelper.a("OidbSvc.0xbc9", 3017, paramInt2, ((oidb_cmd0xbc9.ReqBody)localObject1).toByteArray()));
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.model.BannerInfoModule
