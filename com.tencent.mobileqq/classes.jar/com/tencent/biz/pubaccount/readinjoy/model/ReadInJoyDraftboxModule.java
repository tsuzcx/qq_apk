...
import com.tencent.biz.pubaccount.readinjoy.ugc.ReadInJoyDraftboxFragment.LoadDraftCallback;
  ...
  extends ReadInJoyEngineModule
{
    ...
    do
    {
      ...
      if (paramLong == -1L)
      {
        ...
        if (TextUtils.isEmpty(localReadInJoyDraftboxItem.title))
        {
          ...
          localReadInJoyDraftboxItem.title = HardCodeUtil.a(2131712720);
        }
        localReadInJoyDraftboxItem.content = ParcelableUtil.a(paramReadInJoyDraftboxContent);
        ...
        if ((paramReadInJoyDraftboxContent != null) && (paramReadInJoyDraftboxContent.size() > 0)) {
          localReadInJoyDraftboxItem.firstPic = ParcelableUtil.a((ReadInJoyDraftboxItem.PicData)paramReadInJoyDraftboxContent.get(0));
        }
  ...
  public SpannableStringBuilder a(List<SocializeFeedsInfo.BiuCommentInfo> paramList, Context paramContext, EditText paramEditText, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (localBiuCommentInfo.mBiuComment == null)
      {
        ...
        localArrayList.add(new PositionalSpanStruct(j, j + ((String)localObject).length(), new BiuNicknameSpan(localBiuCommentInfo.mUin.toString(), localBiuCommentInfo.mFeedId.longValue(), (CharSequence)localObject, paramContext, paramEditText.getPaint(), paramInt)));
        j = localStringBuilder.length();
        i += 1;
        break;
        ...
        if (localBiuCommentInfo.mBiuComment == null)
        {
          ...
          localArrayList.add(new PositionalSpanStruct(j, str2.length() + j, new JumpSpan(str3, 13421772)));
          continue;
        }
        ...
        if (localBiuCommentInfo.mBiuComment == null)
        {
          ...
          localArrayList.add(new PositionalSpanStruct(j, str2.length() + j, new TopicSpan((TopicInfo)localObject)));
          continue;
        }
        localObject = localBiuCommentInfo.mBiuComment;
        continue;
      ...
      str2 = EmotionCodecUtils.b(localBiuCommentInfo.mBiuComment);
      continue;
      if (localBiuCommentInfo.mBiuComment == null) {}
      for (String str1 = "";; str1 = EmotionCodecUtils.b(localBiuCommentInfo.mBiuComment))
      {
  ...
  public ReadInJoyDraftboxItem.ReadInJoyDraftboxContent a(long paramLong)
  {
    ...
    if (localReadInJoyDraftboxItem != null)
    {
      ...
      if (localReadInJoyDraftboxItem.content != null)
      {
        ...
        {
          localReadInJoyDraftboxContent2 = (ReadInJoyDraftboxItem.ReadInJoyDraftboxContent)ParcelableUtil.a(localReadInJoyDraftboxItem.content, ReadInJoyDraftboxItem.ReadInJoyDraftboxContent.CREATOR);
          localReadInJoyDraftboxContent1 = localReadInJoyDraftboxContent2;
          if (QLog.isColorLevel())
          {
  ...
  public void a(ReadInJoyDraftboxFragment.LoadDraftCallback paramLoadDraftCallback)
  {
    List localList = a();
    if (QLog.isColorLevel())
    {
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.model.ReadInJoyDraftboxModule
