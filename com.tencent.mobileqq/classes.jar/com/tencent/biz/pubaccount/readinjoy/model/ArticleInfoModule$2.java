...
public class ArticleInfoModule$2
  implements Runnable
{
  public ArticleInfoModule$2(qep paramqep, boolean paramBoolean1, List paramList1, List paramList2, int paramInt, boolean paramBoolean2) {}
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      do
      {
        ...
        do
        {
          do
          {
            do
            {
              ...
              localObject1 = qep.a(this.this$0).a(Integer.valueOf(this.jdField_a_of_type_Int));
            ...
            while (((Iterator)localObject2).hasNext())
            {
              ...
              ArticleInfo localArticleInfo = qep.a(this.this$0).a(Integer.valueOf(this.jdField_a_of_type_Int), (Long)localObject3);
              if (l2 == localArticleInfo.mArticleID)
              {
                l1 = ((Long)localObject3).longValue();
                QLog.i("ArticleInfoModule", 1, "###onGetVideoRealtimeReplaceList find the original article seq：" + localObject3 + ", reqArticleID: " + l2 + ", title : " + pqu.a(localArticleInfo.mTitle));
              }
            }
          } while (l1 == -1L);
          if (QLog.isColorLevel())
          {
            ...
            {
              localObject2 = qep.a(this.this$0).a(Integer.valueOf(this.jdField_a_of_type_Int), (Long)((List)localObject1).get(i));
              localStringBuilder.append("article [" + i + "] seq : " + ((List)localObject1).get(i) + ", id : " + ((ArticleInfo)localObject2).mArticleID + " title : " + pqu.a(((ArticleInfo)localObject2).mTitle));
              localStringBuilder.append("\n");
              i += 1;
            }
            QLog.d("ArticleInfoModule", 2, localStringBuilder.toString());
          }
          localObject2 = qep.a(this.this$0).c(this.jdField_a_of_type_Int);
        ...
        while (i < k)
        {
          ...
          {
            localObject3 = qep.a(this.this$0).a(Integer.valueOf(this.jdField_a_of_type_Int), Long.valueOf(l3));
            ((ArticleInfo)localObject3).mRecommendSeq = (j + l3);
            ((ConcurrentMap)localObject2).remove(Long.valueOf(l3));
            qep.a(this.this$0).a(Integer.valueOf(this.jdField_a_of_type_Int), (ArticleInfo)localObject3, true);
          }
          i += 1;
        }
        i = j - 1;
        while (i >= 0)
        {
          ...
          qep.a(this.this$0).a(Integer.valueOf(this.jdField_a_of_type_Int), (ArticleInfo)localObject1, true);
          i -= 1;
        }
        localObject1 = qep.a(this.this$0).a(Integer.valueOf(this.jdField_a_of_type_Int));
        if (QLog.isColorLevel())
      ...
      pvm.a().a(this.jdField_a_of_type_Boolean, this.jdField_a_of_type_Int, l2, (List)localObject1, this.jdField_b_of_type_JavaUtilList);
      return;
    }
