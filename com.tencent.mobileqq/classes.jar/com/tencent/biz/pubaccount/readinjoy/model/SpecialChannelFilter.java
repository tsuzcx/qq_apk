...
{
  private static SpecialChannelFilter jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelSpecialChannelFilter = null;
  ...
  public void b(List<Integer> paramList)
  {
    ...
    for (;;)
    {
      ...
      while (i < j)
      {
        ...
        if ((!RIJAppSetting.a(k)) && (!paramList.contains(Integer.valueOf(k)))) {
