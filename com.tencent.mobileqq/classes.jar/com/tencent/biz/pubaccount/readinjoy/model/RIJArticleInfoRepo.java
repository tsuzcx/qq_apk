...
public class RIJArticleInfoRepo
{
  ...
  private final ArticleInfoModule jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelArticleInfoModule;
  private final PackMsgProcessor jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelPackMsgProcessor;
  private RIJArticleInfoRepo.PreLoadDBListener jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelRIJArticleInfoRepo$PreLoadDBListener;
  ...
  public RIJArticleInfoRepo(ExecutorService paramExecutorService, EntityManager paramEntityManager, Handler paramHandler, ArticleInfoModule paramArticleInfoModule, AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelPackMsgProcessor = new PackMsgProcessor(paramArticleInfoModule);
  }
  
  private ArticleInfo a(ArticleInfo paramArticleInfo)
  {
    ArticleInfo localArticleInfo = paramArticleInfo;
    if (ArticleInfoHelper.a(paramArticleInfo))
    {
  ...
  private void a(int paramInt, List<Long> paramList, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      {
        localObject = ((IPublicAccountUtil)QRoute.api(IPublicAccountUtil.class)).createStructingMsgBriefPrefix((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, paramList);
        String str = ((IPublicAccountUtil)QRoute.api(IPublicAccountUtil.class)).createStructingMsgBriefSuffix(paramList);
      ...
      {
        localObject = (WeishiManager)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(QQManagerFactory.WEISHI_MANAGER);
        if (localObject != null) {
          ((WeishiManager)localObject).a(((IPublicAccountUtil)QRoute.api(IPublicAccountUtil.class)).createStructingMsgBrief((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, paramList), l);
        }
      }
    ...
    } while ((!DailyModeConfigHandler.c(paramInt)) || (!(this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof QQAppInterface)) || (paramList == null));
  ...
  private void b(List<ArticleInfo> paramList)
  {
    ...
    for (;;)
    {
      if (paramList.hasNext())
      {
        ...
        else
        {
          ...
          PackMsgProcessor.a(localArticleInfo2);
          if (ProteusSupportUtil.a(RIJItemViewType.a(localArticleInfo2)))
          {
    ...
    for (;;)
    {
      localArticleInfo1.articleViewModel = ArticleViewModel.a(localArticleInfo1);
      break label12;
      break;
      label112:
      ProteusSupportUtil.a(localArticleInfo2);
    }
  }
  ...
  private void b(boolean paramBoolean1, int paramInt, boolean paramBoolean2, List<ArticleInfo> paramList1, long paramLong1, long paramLong2, List<ArticleInfo> paramList2, ToServiceMsg paramToServiceMsg)
  {
    if (paramBoolean1)
    {
      ...
      if ((paramInt == 70) || (paramInt == 41403) || (DailyModeConfigHandler.a(paramInt)) || (ReadInJoyHelper.a(paramInt))) {
        break label247;
      }
      if ((!paramBoolean2) || (RIJAladdinUtils.a(paramInt))) {
        break label182;
      }
  ...
  private void c(List<ArticleInfo> paramList)
  {
    ...
    do
    {
      ...
      {
        ArticleInfo localArticleInfo = (ArticleInfo)localIterator.next();
        if ((localArticleInfo != null) && (!WhiteListBidConfigHandler.a(localArticleInfo))) {
  ...
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelRIJArticleInfoRepo$PreLoadDBListener != null) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelRIJArticleInfoRepo$PreLoadDBListener.a(paramInt);
    }
  }
  ...
  {
    if (RIJAladdinUtils.a(paramInteger.intValue()))
    {
      paramInteger = null;
      return paramInteger;
    }
  ...
  public void a(int paramInt)
  {
    ...
    while ((paramInt != 0) && (!DailyModeConfigHandler.c(paramInt))) {
      return;
    }
    ...
    for (;;)
    {
      for (;;)
      {
        if ((((ArticleInfo)localArrayList.get(i)).mTopicRecommendFeedsInfo != null) && (((ArticleInfo)localArrayList.get(i)).mTopicRecommendFeedsInfo.a.size() > 0)) {
          ((TopicRecommendFeedsInfo.TopicRecommendInfo)((ArticleInfo)localArrayList.get(i)).mTopicRecommendFeedsInfo.a.get(0)).c = paramInt2;
        }
        int k;
        Object localObject2;
        ...
        try
        {
          ...
          if (localObject1 != null)
          {
            if ((((ArticleInfo)localObject1).mTopicRecommendFeedsInfo != null) && (((ArticleInfo)localObject1).mTopicRecommendFeedsInfo.a != null) && (((ArticleInfo)localObject1).mTopicRecommendFeedsInfo.a.size() > 0)) {
              ((TopicRecommendFeedsInfo.TopicRecommendInfo)((ArticleInfo)localObject1).mTopicRecommendFeedsInfo.a.get(0)).c = paramInt2;
            }
  ...
  public void a(int paramInt1, int paramInt2, long paramLong1, boolean paramBoolean, long paramLong2)
  {
    ...
    {
      PreLoader.a().a(paramInt1, localList);
      if ((Looper.myLooper() == Looper.getMainLooper()) && (ReadInJoyUtils.c()))
      {
        PTSEventDispatcher.a().a(paramInt1, localList, paramLong2);
        return;
      }
      if (this.jdField_a_of_type_AndroidOsHandler != null)
      {
  ...
  public void a(int paramInt1, long paramLong, int paramInt2)
  {
    ...
    if (j < paramInt2)
    {
      Collections.sort((List)localObject1, new RIJArticleInfoRepo.10(this));
      int i = 0;
      for (;;)
      {
        if (i >= paramInt2 - j) {
  ...
  public void a(int paramInt, List<ArticleInfo> paramList)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        {
          return;
        } while ((paramList == null) || (paramList.isEmpty()) || ((paramInt != 0) && (!DailyModeConfigHandler.c(paramInt))));
  ...
  {
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelRIJArticleInfoRepo$PreLoadDBListener = paramPreLoadDBListener;
  }
  ...
  public void a(List<ArticleInfo> paramList, int paramInt)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 53	com/tencent/biz/pubaccount/readinjoy/model/RIJArticleInfoRepo:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   4: invokevirtual 853	com/tencent/mobileqq/persistence/EntityManager:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   7: invokevirtual 858	com/tencent/mobileqq/persistence/EntityTransaction:begin	()V
    //   10: aload_1
    //   11: invokeinterface 406 1 0
    //   16: astore_1
    //   17: aload_1
    ...
    //   32: checkcast 93	com/tencent/biz/pubaccount/readinjoy/struct/ArticleInfo
    //   35: astore_3
    //   36: aload_3
    //   37: getfield 862	com/tencent/biz/pubaccount/readinjoy/struct/ArticleInfo:mExtraBiuBriefInfo	Lcom/tencent/biz/pubaccount/readinjoy/struct/ExtraBiuBriefInfo;
    //   40: ifnull -23 -> 17
    //   43: aload_3
    //   44: getfield 862	com/tencent/biz/pubaccount/readinjoy/struct/ArticleInfo:mExtraBiuBriefInfo	Lcom/tencent/biz/pubaccount/readinjoy/struct/ExtraBiuBriefInfo;
    //   47: getfield 865	com/tencent/biz/pubaccount/readinjoy/struct/ExtraBiuBriefInfo:a	Ljava/util/ArrayList;
    //   50: ifnull -33 -> 17
    //   53: aload_3
    //   54: getfield 862	com/tencent/biz/pubaccount/readinjoy/struct/ArticleInfo:mExtraBiuBriefInfo	Lcom/tencent/biz/pubaccount/readinjoy/struct/ExtraBiuBriefInfo;
    //   57: getfield 865	com/tencent/biz/pubaccount/readinjoy/struct/ExtraBiuBriefInfo:a	Ljava/util/ArrayList;
    //   60: invokevirtual 760	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   63: astore_3
    //   64: aload_3
    ...
    //   79: checkcast 867	com/tencent/biz/pubaccount/readinjoy/struct/ExtraBiuBriefInfo$BiuBriefInfoItem
    //   82: astore 4
    //   84: aload_0
    //   85: getfield 53	com/tencent/biz/pubaccount/readinjoy/model/RIJArticleInfoRepo:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   88: ldc 93
    //   90: ldc_w 869
    //   93: iconst_2
    //   94: anewarray 124	java/lang/String
    //   97: dup
    //   98: iconst_0
    //   99: iload_2
    //   100: invokestatic 128	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   103: aastore
    //   104: dup
    //   105: iconst_1
    //   106: aload 4
    //   108: getfield 870	com/tencent/biz/pubaccount/readinjoy/struct/ExtraBiuBriefInfo$BiuBriefInfoItem:a	J
    //   111: invokestatic 182	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   114: aastore
    //   115: invokevirtual 874	com/tencent/mobileqq/persistence/EntityManager:find	(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/String;)Lcom/tencent/mobileqq/persistence/Entity;
    //   118: astore 4
    //   120: aload 4
    //   122: ifnull -58 -> 64
    //   125: aload_0
    //   126: getfield 53	com/tencent/biz/pubaccount/readinjoy/model/RIJArticleInfoRepo:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   129: aload 4
    //   131: invokevirtual 877	com/tencent/mobileqq/persistence/EntityManager:remove	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   134: pop
    //   135: goto -71 -> 64
    //   138: astore_1
    //   139: aload_1
    //   140: invokevirtual 848	java/lang/Exception:printStackTrace	()V
    //   143: ldc 77
    //   145: iconst_2
    ...
    //   159: aload_1
    //   160: invokevirtual 882	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   163: invokevirtual 86	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   166: invokevirtual 101	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   169: invokestatic 885	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   172: aload_0
    //   173: getfield 53	com/tencent/biz/pubaccount/readinjoy/model/RIJArticleInfoRepo:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   176: invokevirtual 853	com/tencent/mobileqq/persistence/EntityManager:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   179: invokevirtual 888	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   182: return
    //   183: aload_0
    //   184: getfield 53	com/tencent/biz/pubaccount/readinjoy/model/RIJArticleInfoRepo:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   187: invokevirtual 853	com/tencent/mobileqq/persistence/EntityManager:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   190: invokevirtual 891	com/tencent/mobileqq/persistence/EntityTransaction:commit	()V
    //   193: aload_0
    //   194: getfield 53	com/tencent/biz/pubaccount/readinjoy/model/RIJArticleInfoRepo:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   197: invokevirtual 853	com/tencent/mobileqq/persistence/EntityManager:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   200: invokevirtual 888	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   203: return
    //   204: astore_1
    //   205: aload_0
    //   206: getfield 53	com/tencent/biz/pubaccount/readinjoy/model/RIJArticleInfoRepo:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   209: invokevirtual 853	com/tencent/mobileqq/persistence/EntityManager:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   212: invokevirtual 888	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   215: aload_1
    //   216: athrow
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	217	0	this	RIJArticleInfoRepo
  ...
  public boolean a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      if ((((ArticleInfo)localArrayList.get(paramInt1)).mTopicRecommendFeedsInfo != null) && (((ArticleInfo)localArrayList.get(paramInt1)).mTopicRecommendFeedsInfo.a.size() > 0)) {
        ((TopicRecommendFeedsInfo.TopicRecommendInfo)((ArticleInfo)localArrayList.get(paramInt1)).mTopicRecommendFeedsInfo.a.get(0)).c = paramInt2;
      }
      ...
      if (localObject != null)
      {
        if ((((ArticleInfo)localObject).mTopicRecommendFeedsInfo != null) && (((ArticleInfo)localObject).mTopicRecommendFeedsInfo.a != null) && (((ArticleInfo)localObject).mTopicRecommendFeedsInfo.a.size() > 0)) {
          ((TopicRecommendFeedsInfo.TopicRecommendInfo)((ArticleInfo)localObject).mTopicRecommendFeedsInfo.a.get(0)).c = paramInt2;
        }
  ...
  {
    if (paramArticleInfo == null) {}
    while (!WhiteListBidConfigHandler.a(paramArticleInfo)) {
      return false;
    }
        ...
        for (;;)
        {
          if (localConcurrentHashMap.get(paramArticleInfo.mVideoVid) != null)
          {
            ...
            if (localArticleInfo.mArticleID != paramArticleInfo.mArticleID)
            {
              ...
              if (QLog.isColorLevel()) {
                QLog.e("RIJArticleInfoRepo", 2, "saveArticleInfo, find article vid duplicated! old article: channelID=" + paramInteger + ", id=" + localArticleInfo.mArticleID + "，seq: " + localArticleInfo.mRecommendSeq + ", title: " + RIJAppSetting.a(localArticleInfo.mTitle) + "，vid =" + localArticleInfo.mVideoVid + "\n new article  id : " + paramArticleInfo.mArticleID + " seq : " + paramArticleInfo.mRecommendSeq + " title : " + RIJAppSetting.a(paramArticleInfo.mTitle) + "，vid =" + paramArticleInfo.mVideoVid);
              }
            }
          }
  ...
  public List<ArticleInfo> b(Integer paramInteger)
  {
    ...
    Collections.sort(localArrayList, new RIJArticleInfoRepo.12(this));
    return localArrayList;
  }
  ...
  public void b(int paramInt1, int paramInt2, long paramLong, boolean paramBoolean)
  {
    ...
    List localList2 = ReadInJoyLogicEngine.a().a(Integer.valueOf(paramInt1), localList1);
    if ((localList1 != null) && (localList1.size() > 0))
    {
      PreLoader.a().a(paramInt1, localList1);
      PTSPreLayoutHandler.a(localList2);
      if ((Looper.myLooper() == Looper.getMainLooper()) && (ReadInJoyUtils.c()))
      {
        ReadInJoyLogicEngineEventDispatcher.a().a(paramInt1, localList1);
        return;
      }
      if (this.jdField_a_of_type_AndroidOsHandler != null)
      {
  ...
  public void b(int paramInt, List<ArticleInfo> paramList)
  {
        ...
        if (localIterator2.hasNext())
        {
          ...
          if (((ArticleInfo)localEntry.getValue()).mNewPolymericInfo != null)
          {
            ...
            do
            {
              ...
              localPackArticleInfo = (NewPolymericInfo.PackArticleInfo)localIterator3.next();
            } while (localPackArticleInfo.a != localArticleInfo.mArticleID);
            paramList = (ArticleInfo)localEntry.getValue();
            paramList.mNewPolymericInfo.a.remove(localPackArticleInfo);
          }
          else
          {
            label308:
    ...
    for (;;)
    {
      ...
      if ((paramList.mNewPolymericInfo != null) && (((RIJFeedsType.m(paramList)) && (paramList.mNewPolymericInfo.a.size() >= 3)) || ((!RIJFeedsType.m(paramList)) && (paramList.mNewPolymericInfo.a.size() >= 2))))
      {
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.model.RIJArticleInfoRepo
