  ...
  extends RIJCommentInLikeFeedHandler
{
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    paramToServiceMsg = BaseApplication.getContext().getString(2131718211);
    ...
    for (;;)
    {
      ...
      catch (Exception paramString1)
      {
        ...
        if ((paramInt1 == 21) && (paramAccountProfileInfo != null))
        {
          ...
          paramList.bytes_desc.set(ByteStringMicro.copyFromUtf8(paramAccountProfileInfo.c));
          paramList.bytes_nick.set(ByteStringMicro.copyFromUtf8(paramAccountProfileInfo.jdField_a_of_type_JavaLangString));
          paramList.bytes_profile_photo_url.set(ByteStringMicro.copyFromUtf8(paramAccountProfileInfo.b));
          paramList.uint64_uin.set(paramAccountProfileInfo.jdField_a_of_type_Long);
          paramList.uint32_account_type.set(paramAccountProfileInfo.jdField_a_of_type_Int);
        ...
        paramString1 = String.valueOf(ReadInJoyUtils.a()) + System.currentTimeMillis();
        paramString2.bytes_req_seq.set(ByteStringMicro.copyFromUtf8(paramString1));
        paramString1 = ReadInJoyOidbHelper.a("OidbSvc.0x83e", 2110, 0, paramString2.toByteArray());
        paramString1.addAttribute("ugc_deliver", Integer.valueOf(1));
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelArticleInfoModule.b(paramString1);
      }
    }
  }
}
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.model.handler.RIJCommentInLikeFeedUgcDeliverHandler
