...
public class ReadInJoyUserInfoModule
  extends oqg
{
  private ConcurrentHashMap<String, List<oqi>> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  private oql jdField_a_of_type_Oql;
  private ConcurrentHashMap<String, Boolean> b = new ConcurrentHashMap();
  
  public ReadInJoyUserInfoModule(AppInterface paramAppInterface, atmp paramatmp, ExecutorService paramExecutorService, pdc parampdc, Handler paramHandler)
  {
    super(paramAppInterface, paramatmp, paramExecutorService, parampdc, paramHandler);
    this.jdField_a_of_type_Oql = new oql(paramExecutorService, this, paramatmp);
  }
  
  public static ReadInJoyUserInfo a(long paramLong, oqi paramoqi)
  {
    if (paramLong != 0L)
    {
      ...
      if (localObject != null)
      {
        localObject = ((ohd)((QQAppInterface)localObject).getManager(163)).a().a();
        if (localObject != null) {
          return ((ReadInJoyUserInfoModule)localObject).a(String.valueOf(paramLong), paramoqi);
        }
      }
    }
    return null;
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int j = pde.a(paramFromServiceMsg, paramObject, (MessageMicro)localObject1);
    ...
    {
      bool = true;
      obz.b(paramFromServiceMsg, bool, l, j);
      if (j != 0) {
        break label704;
      }
    ...
    for (paramToServiceMsg = String.valueOf(((oidb_cmd0xb81.AccountInfo)((oidb_cmd0xb81.UserInfoItem)localObject2).msg_account_info.get()).uint64_uin.get());; paramToServiceMsg = "")
    {
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_Oql.a(paramToServiceMsg, (ReadInJoyUserInfo)localObject1, true, true);
      ...
      if (paramObject.intValue() < 1)
      {
        ...
        obz.a("handle0xb81UserInfo", new ReadInJoyUserInfoModule.4(this, paramToServiceMsg), this.jdField_a_of_type_JavaUtilConcurrentExecutorService);
        label883:
        return;
      }
      if ((paramFromServiceMsg != null) && (paramFromServiceMsg.size() > 0))
      {
        ...
        if (i < paramFromServiceMsg.size())
        {
          ...
          {
            oqi localoqi = (oqi)((Iterator)localObject2).next();
            if (localoqi != null)
            {
              localoqi.a(paramToServiceMsg, "request0xb81UserInfo result = " + j);
              paramObject.add(localoqi);
            }
          }
  ...
  private void b(List<String> paramList, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (paramList.hasNext())
    {
      ...
      if ((localAppRuntime instanceof QQAppInterface)) {
        if (!((ajjj)((QQAppInterface)localAppRuntime).getManager(51)).b(str)) {
          break label136;
        }
      }
      label136:
      for (l = 1L;; l = 2L)
      {
        try
        {
          localArrayList.add(new oqj().a(Long.valueOf(str).longValue()).b(l).a());
        }
    ...
    a(new oqk().a(paramInt1).b(paramInt2).c(paramInt3).a(localArrayList).a());
  }
  
  public ReadInJoyUserInfo a(String paramString, int paramInt1, int paramInt2, int paramInt3, oqi paramoqi)
  {
    if (TextUtils.isEmpty(paramString))
    {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Oql == null) {
        break;
      }
      localReadInJoyUserInfo = this.jdField_a_of_type_Oql.a(paramString);
    ...
    if ((paramoqi != null) && (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap != null))
    {
      ...
      ((List)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString)).add(paramoqi);
    }
    obz.a("getSingleReadInJoyUserInfoWithParams", new ReadInJoyUserInfoModule.1(this, paramString, paramInt1, paramInt2, paramInt3), this.jdField_a_of_type_JavaUtilConcurrentExecutorService);
    return null;
  }
  
  public ReadInJoyUserInfo a(String paramString, oqi paramoqi)
  {
    if (TextUtils.isEmpty(paramString))
    {
    ...
    return a(paramString, 1, 1, 0, paramoqi);
  }
  
  public ConcurrentHashMap<String, List<oqi>> a()
  {
  ...
  public oql a()
  {
    return this.jdField_a_of_type_Oql;
  }
  
  public void a()
  {
    this.jdField_a_of_type_Oql.b();
  ...
  public void a(List<String> paramList, int paramInt1, int paramInt2, int paramInt3)
  {
    if (obz.j())
    {
      obz.a("requestReadInJoyUserInfoWithParamsInSubThread", new ReadInJoyUserInfoModule.3(this, paramList, paramInt1, paramInt2, paramInt3), this.jdField_a_of_type_JavaUtilConcurrentExecutorService);
      return;
    }
