  ...
  implements IReadInJoyModel
{
  ...
  {
    if (this.d == 7) {}
    while (((this.d == 3) && (((RIJFeedsType.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo)) && (!this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.isTwoItemVideoFeed())) || (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.isTwoItemVideoFeed()))) || ((this.jdField_a_of_type_Int == 0) && (118 == RIJItemViewType.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo))) || (g()) || (this.jdField_b_of_type_Int == this.e - 1)) {
      return false;
    }
    return true;
  }
  ...
  public boolean g()
  {
    ...
    do
    {
      ...
      {
        return false;
      } while ((this.jdField_a_of_type_Int == 41403) || (DailyModeConfigHandler.a(this.jdField_a_of_type_Int)) || (ReadInJoyHelper.a(this.jdField_a_of_type_Int)));
    ...
    if (RIJFeedsType.j(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo))
    {
