  ...
  extends ReadInJoyEngineModule
{
  ...
  private SparseArray<WeakReference<UserOperationModule.BaseOx978RespCallBack>> jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
  ...
  private oidb_cmd0x64e.ReportInfo a(ReportInfo paramReportInfo)
  {
    ...
    d(localReportInfo, paramReportInfo);
  ...
  private void a(int paramInt1, String paramString1, String paramString2, int paramInt2, boolean paramBoolean)
  {
    ...
    {
      RIJPushNotifyManager.a.a().a(paramInt1, paramString1, paramString2, paramInt2, paramBoolean);
      return;
    }
  ...
  private void a(oidb_cmd0x80a.RspBody paramRspBody)
  {
    ...
    {
      ReadInJoyHelper.a("sp_msg_box_80a_enable_receive", Boolean.valueOf(bool));
    ...
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      ...
      while (paramList.hasNext())
      {
        ...
        if (localReportInfo.mFolderStatus == 0) {
          localReportInfo.mFolderStatus = RIJKanDianFolderStatus.jdField_a_of_type_Int;
        }
  ...
  private void b(oidb_cmd0x64e.ReportInfo paramReportInfo, ReportInfo paramReportInfo1)
  {
    ...
    if (localObject != null)
    {
      ...
      paramReportInfo1.uint64_feeds_id.set(((ReportInfo.FeedsReportData)localObject).jdField_a_of_type_Long);
      paramReportInfo1.uint64_publish_uin.set(((ReportInfo.FeedsReportData)localObject).jdField_b_of_type_Long);
      paramReportInfo1.uint32_like_total_count.set(((ReportInfo.FeedsReportData)localObject).jdField_a_of_type_Int);
      paramReportInfo1.uint32_comment_total_count.set(((ReportInfo.FeedsReportData)localObject).jdField_b_of_type_Int);
      ArrayList localArrayList2 = new ArrayList();
      if ((((ReportInfo.FeedsReportData)localObject).jdField_a_of_type_JavaUtilList != null) && (!((ReportInfo.FeedsReportData)localObject).jdField_a_of_type_JavaUtilList.isEmpty()))
      {
        localObject = ((ReportInfo.FeedsReportData)localObject).jdField_a_of_type_JavaUtilList.iterator();
        while (((Iterator)localObject).hasNext()) {
  ...
  private void d(oidb_cmd0x64e.ReportInfo paramReportInfo, ReportInfo paramReportInfo1)
  {
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      ...
      if (paramToServiceMsg.leftBtmRedCntMaxForExitAIO.has()) {
        ReadInJoyHelper.e((int)paramToServiceMsg.leftBtmRedCntMaxForExitAIO.get());
      }
      if ((paramToServiceMsg.uint64_main_video_tab_red.has()) && (paramToServiceMsg.uint64_main_video_tab_red.get() > 0L)) {
        ((KandianMergeManager)ReadInJoyUtils.a().getManager(QQManagerFactory.KANDIAN_MERGE_MANAGER)).a(new KandianRedDotInfo("kandian_video_tab_reddot_info"));
      }
  ...
  public void a(int paramInt1, String paramString1, int paramInt2, List<oidb_cmd0x80a.AttributeList> paramList, String paramString2, int paramInt3)
  {
    ...
    if (SimpleUIUtil.a())
    {
      ...
      localReqBody.uint32_privacy_status.set(ReadInJoyUserDataUtils.b());
      if (!RIJXTabConfigHandler.b().a()) {
        break label226;
      }
      localReqBody.uint32_kandian_mode.set(4);
    }
    for (;;)
    {
      ...
      a(ReadInJoyOidbHelper.a(paramString2, paramInt3, 0, localReqBody.toByteArray()));
      return;
      i = 0;
      break;
      label226:
  ...
  public void a(UserActionCollector paramUserActionCollector, Context paramContext)
  {
  ...
  public void a(String paramString1, long paramLong, boolean paramBoolean, String paramString2, UserOperationModule.Ox978RespCallBack paramOx978RespCallBack, int paramInt)
  {
    a(paramString1, String.valueOf(paramLong), paramBoolean, paramString2, paramOx978RespCallBack, paramInt);
  }
  
  public void a(String paramString1, String paramString2, boolean paramBoolean, String paramString3, UserOperationModule.Ox978RespCallBack paramOx978RespCallBack)
  {
    a(paramString1, paramString2, paramBoolean, paramString3, paramOx978RespCallBack, 2);
  }
  
  public void a(String paramString1, String paramString2, boolean paramBoolean, String paramString3, UserOperationModule.Ox978RespCallBack paramOx978RespCallBack, int paramInt)
  {
    a(paramString1, paramString2, paramBoolean, paramString3, paramOx978RespCallBack, paramInt, false);
  }
  
  public void a(String paramString1, String paramString2, boolean paramBoolean1, String paramString3, UserOperationModule.Ox978RespCallBack paramOx978RespCallBack, int paramInt, boolean paramBoolean2)
  {
    int i = 2;
    if (QLog.isColorLevel()) {
    ...
    catch (NumberFormatException localNumberFormatException1)
    {
      try
      {
        ...
        Object localObject1 = ReadInJoyOidbHelper.a("OidbSvc.0x978", 2424, 0, ((oidb_cmd0x978.ReqBody)localObject2).toByteArray());
  ...
  public void a(ArrayList<BatchFollowModel> paramArrayList, UserOperationModule.BatchFollowCallBack paramBatchFollowCallBack, int paramInt)
  {
    a(paramArrayList, true, paramBatchFollowCallBack, paramInt);
  }
  
  protected void a(ArrayList<BatchFollowModel> paramArrayList, boolean paramBoolean, UserOperationModule.BaseOx978RespCallBack paramBaseOx978RespCallBack, int paramInt)
  {
    int i = 2;
    if (QLog.isColorLevel()) {
      QLog.d("UserOperationModule", 2, "batch0x978, followList = " + paramArrayList + ", isFollow = " + paramBoolean + ", callback = " + paramBaseOx978RespCallBack + ", refer = " + paramInt);
    }
    ...
    {
      localObject = (BatchFollowModel)paramArrayList.get(i);
      oidb_cmd0x978.OneFollowOperationInfo localOneFollowOperationInfo = new oidb_cmd0x978.OneFollowOperationInfo();
      localOneFollowOperationInfo.uint64_dst_uin.set(Long.valueOf(((BatchFollowModel)localObject).jdField_a_of_type_Long).longValue());
      localOneFollowOperationInfo.uint32_op_account_type.set(((BatchFollowModel)localObject).jdField_a_of_type_Int);
    ...
    paramInt = this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.incrementAndGet();
    this.jdField_a_of_type_AndroidUtilSparseArray.put(paramInt, new WeakReference(paramBaseOx978RespCallBack));
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (paramToServiceMsg.getAttribute("distUin") != null)
    {
      ...
      paramToServiceMsg = (UserOperationModule.BaseOx978RespCallBack)((WeakReference)this.jdField_a_of_type_AndroidUtilSparseArray.get(i)).get();
  ...
  public void b(ArrayList<BatchFollowModel> paramArrayList, UserOperationModule.BatchFollowCallBack paramBatchFollowCallBack, int paramInt)
  {
    a(paramArrayList, false, paramBatchFollowCallBack, paramInt);
  }
