  ...
  extends ReadInJoyEngineModule
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = VideoArticleModule.class.getSimpleName();
  }
  ...
  private void a(int paramInt, BaseVideoArticleInfo paramBaseVideoArticleInfo)
  {
    ...
    WeishiManager localWeishiManager;
    do
    {
      do
      {
      ...
      localWeishiManager = (WeishiManager)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(QQManagerFactory.WEISHI_MANAGER);
    } while (localWeishiManager == null);
    long l = NetConnInfoCenter.getServerTime();
    localWeishiManager.a(((IPublicAccountUtil)QRoute.api(IPublicAccountUtil.class)).createStructingMsgBrief((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, paramBaseVideoArticleInfo), l);
  }
  ...
  public List<WeiShiVideoArticleInfo> a(Integer paramInteger)
  {
    ...
    Collections.sort(localArrayList, new VideoArticleModule.6(this));
    return localArrayList;
  }
  ...
  public void a(int paramInt1, long paramLong, int paramInt2)
  {
    ...
    if (j < paramInt2)
    {
      Collections.sort((List)localObject1, new VideoArticleModule.7(this));
      int i = 0;
      for (;;)
      {
        if (i >= paramInt2 - j) {
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.model.VideoArticleModule
