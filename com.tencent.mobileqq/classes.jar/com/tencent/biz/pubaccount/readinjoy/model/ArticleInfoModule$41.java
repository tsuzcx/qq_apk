...
public class ArticleInfoModule$41
  implements Runnable
{
  public ArticleInfoModule$41(ooq paramooq, List paramList, ConcurrentHashMap paramConcurrentHashMap) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      if (localIterator1.hasNext())
      {
        ...
        if ((((oidb_cmd0x8c8.FeedsInfo)localObject).feeds_type.has()) && (((oidb_cmd0x8c8.FeedsInfo)localObject).msg_social_fees_info.has()) && (((oidb_cmd0x8c8.FeedsInfo)localObject).msg_social_fees_info.uint64_feeds_id.has()))
        {
          ...
          if (localObject != null)
          {
            this.this$0.a((atmo)localObject);
            localConcurrentHashMap = (ConcurrentHashMap)ooq.a(this.this$0).get(Integer.valueOf(0));
    ...
    for (;;)
    {
      if (localObject != null)
      {
        ...
        ooq.a(this.this$0, Integer.valueOf(0), (ArticleInfo)localObject);
        localArrayList2.add(Long.valueOf(((ArticleInfo)localObject).mRecommendSeq));
      }
      localConcurrentHashMap = (ConcurrentHashMap)ooq.a(this.this$0).get(Integer.valueOf(70));
      if (localConcurrentHashMap == null) {
        break;
      }
      localIterator2 = localConcurrentHashMap.values().iterator();
      ...
      for (;;)
      {
        ...
        localConcurrentHashMap.remove(Long.valueOf(((ArticleInfo)localObject).mRecommendSeq));
        ooq.a(this.this$0, Integer.valueOf(70), (ArticleInfo)localObject);
        ...
        ThreadManager.getUIHandler().post(new ArticleInfoModule.41.1(this, (List)localObject, localArrayList1));
        return;
        localObject = null;
      }
      label499:
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.model.ArticleInfoModule.41
