  ...
  public static String a(int paramInt)
  {
    for (;;)
    {
      try
      {
        ...
        if (ReadInJoyHelper.a(paramInt))
        {
          if (-1 == paramInt) {
            break label203;
          }
          localObject1 = (String)ReadInJoyHelper.a("DAILY_CHILD_FEEDS_REQUEST_CONFIG" + paramInt, "");
          ...
          if (ReadInJoyHelper.B()) {
            localJSONArray.put(ReadInJoyHelper.a());
          }
          localJSONArray.put(ReadInJoyHelper.b());
          return localJSONArray.toString();
        }
        Object localObject1 = ReadInJoyMMapKvStorage.getInstance().getValeForKey("KANDIAN_DAILY_SETTING_CONFIG");
        Object localObject3 = (String)ReadInJoyHelper.a("KANDIAN_DAILY_LCAOL_SETTING_CONFIG", "");
        if (TextUtils.isEmpty((CharSequence)localObject1)) {
          break label198;
        }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.model.ReadInJoyDailySettingModel
