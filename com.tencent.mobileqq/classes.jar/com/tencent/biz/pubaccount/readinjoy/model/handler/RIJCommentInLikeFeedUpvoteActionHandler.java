  ...
  extends RIJCommentInLikeFeedHandler
{
  ...
  public void a(long paramLong1, long paramLong2, boolean paramBoolean, ArticleInfo paramArticleInfo)
  {
    ...
    for (int i = 2;; i = 3)
    {
      ...
      localObject2 = String.valueOf(ReadInJoyUtils.a()) + System.currentTimeMillis();
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.model.handler.RIJCommentInLikeFeedUpvoteActionHandler
