...
public class ChannelCoverInfoModule$7
  implements Runnable
{
  public ChannelCoverInfoModule$7(pab parampab, int paramInt, List paramList) {}
  ...
  public void run()
  {
    ...
    if (this.jdField_a_of_type_Int == 0) {
      osm.a().f(true, this.jdField_a_of_type_JavaUtilList);
    }
    for (;;)
    {
      osm.a().a(this.jdField_a_of_type_Int, true, this.jdField_a_of_type_JavaUtilList);
      return;
      if (this.jdField_a_of_type_Int == 56) {
        osm.a().g(true, this.jdField_a_of_type_JavaUtilList);
      } else if (this.jdField_a_of_type_Int == 41402) {
        osm.a().h(true, this.jdField_a_of_type_JavaUtilList);
      }
    }
  }
}
