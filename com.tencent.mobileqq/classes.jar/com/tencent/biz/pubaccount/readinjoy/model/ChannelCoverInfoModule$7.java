...
public class ChannelCoverInfoModule$7
  implements Runnable
{
  public ChannelCoverInfoModule$7(qez paramqez, int paramInt, List paramList) {}
  ...
  public void run()
  {
    ...
    if (this.jdField_a_of_type_Int == 0) {
      pvm.a().f(true, this.jdField_a_of_type_JavaUtilList);
    }
    for (;;)
    {
      pvm.a().a(this.jdField_a_of_type_Int, true, this.jdField_a_of_type_JavaUtilList);
      return;
      if (this.jdField_a_of_type_Int == 56) {
        pvm.a().g(true, this.jdField_a_of_type_JavaUtilList);
      } else if (this.jdField_a_of_type_Int == 41402) {
        pvm.a().h(true, this.jdField_a_of_type_JavaUtilList);
      }
    }
  }
}
