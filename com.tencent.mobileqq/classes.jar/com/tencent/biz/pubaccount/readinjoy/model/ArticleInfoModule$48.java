...
public class ArticleInfoModule$48
  implements Runnable
{
  public ArticleInfoModule$48(ozo paramozo, ConcurrentHashMap paramConcurrentHashMap1, ConcurrentHashMap paramConcurrentHashMap2, int paramInt) {}
  ...
  public void run()
  {
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      if (!((Boolean)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(l))).booleanValue())
      {
        ...
        if ((localObject3 != null) && (onh.o((BaseArticleInfo)localObject3)) && (((ArticleInfo)localObject3).mNewPolymericInfo.a != null))
        {
          localObject3 = ((ArticleInfo)localObject3).mNewPolymericInfo.a.iterator();
          while (((Iterator)localObject3).hasNext())
          {
            qbo localqbo = (qbo)((Iterator)localObject3).next();
            if (localqbo.a != null) {
              ((ArrayList)localObject1).add(Long.valueOf(localqbo.a.b));
            }
          }
    ...
    localObject1 = pot.a("OidbSvc.0xa6e", 2670, 4, ((oidb_cmd0xa6e.ReqBody)localObject2).toByteArray());
