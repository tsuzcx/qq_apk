  ...
  implements Runnable
{
  public void run()
  {
    ...
    try
    {
      if (this.jdField_a_of_type_Pdh.b != null)
      {
        l1 = l2;
        if (this.jdField_a_of_type_Pdh.b.size() > 0) {
          l1 = ((Long)this.jdField_a_of_type_Pdh.b.get(0)).longValue();
        }
      }
      ...
      ndn.a(null, "", "0X8009410", "0X8009410", 0, 0, localJSONObject.toString(), "", "", "", false);
      return;
    }
