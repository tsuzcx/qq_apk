...
import com.tencent.biz.pubaccount.readinjoy.struct.SubscriptInfo;
...
public class ReadInJoyMSFHandlerUtils
{
  ...
  private static String[] jdField_a_of_type_ArrayOfJavaLangString = { HardCodeUtil.a(2131712784), HardCodeUtil.a(2131713081), HardCodeUtil.a(2131712770), HardCodeUtil.a(2131712817), HardCodeUtil.a(2131712777), HardCodeUtil.a(2131713088), HardCodeUtil.a(2131712952), HardCodeUtil.a(2131713023), HardCodeUtil.a(2131712900), HardCodeUtil.a(2131712727) };
  ...
  public static ArticleInfo a(articlesummary.ArticleSummary paramArticleSummary, int paramInt1, int paramInt2, ArticleInfo paramArticleInfo)
  {
    ...
    paramArticleInfo = new RIJMsfHandlerHelper();
    ...
    if (localArticleInfo.scripCmsInfo != null)
    {
      ...
      ReadInJoyNoteCardUtil.a(BaseApplicationImpl.getApplication(), (String)localObject, ReadInJoyNoteCardUtil.a(BaseApplicationImpl.getApplication(), (String)localObject) + 1);
    }
    Object localObject = (articlesummary.AwesomeCommentInfo)PBFieldUtils.a(paramArticleSummary.awesome_comment_icon, null);
    if (localObject != null)
    {
      localArticleInfo.hasAwesome = true;
      AwesomeCommentInfo.a(localArticleInfo, (articlesummary.AwesomeCommentInfo)localObject);
    }
    localObject = (articlesummary.SubscriptInfo)PBFieldUtils.a(paramArticleSummary.msg_subscript_20, null);
    if (localObject != null) {
      SubscriptInfo.a(localArticleInfo, (articlesummary.SubscriptInfo)localObject);
    }
    RIJPreParseData.b(localArticleInfo);
    paramArticleInfo.l(paramArticleSummary, localArticleInfo);
  ...
  public static void a(TabChannelCoverInfo paramTabChannelCoverInfo)
  {
    if ((paramTabChannelCoverInfo != null) && (paramTabChannelCoverInfo.mChannelCoverId == 70) && (!TextUtils.isEmpty(paramTabChannelCoverInfo.mChannelJumpUrl))) {
      ReadInJoyHelper.a("readinjoy_channel_follow_viola_url", paramTabChannelCoverInfo.mChannelJumpUrl);
    }
  }
  ...
  public static void a(List<ArticleInfo> paramList)
  {
    ...
    for (;;)
    {
      ...
      paramList = paramList.iterator();
      while (paramList.hasNext()) {
        RIJPreParseData.b((ArticleInfo)paramList.next());
      }
    }
  }
