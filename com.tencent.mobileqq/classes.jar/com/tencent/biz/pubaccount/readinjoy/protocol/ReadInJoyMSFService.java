...
{
  private static ReadInJoyMSFService jdField_a_of_type_ComTencentBizPubaccountReadinjoyProtocolReadInJoyMSFService = null;
  private int jdField_a_of_type_Int = 0;
  private DecimalFormat jdField_a_of_type_JavaTextDecimalFormat = new DecimalFormat("0.00");
  private ConcurrentHashMap<Integer, WeakReference<ReadInJoyEngineModule>> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  private boolean a(ToServiceMsg paramToServiceMsg)
  {
    int i;
    int k;
    if (paramToServiceMsg.getAttribute(ReadInJoyEngineModule.f) != null)
    {
      i = ((Integer)paramToServiceMsg.getAttribute(ReadInJoyEngineModule.f)).intValue();
      if (i == 2)
      {
        k = 1;
  ...
  public final void a(ToServiceMsg paramToServiceMsg, ReadInJoyEngineModule paramReadInJoyEngineModule)
  {
    ...
    RIJThreadHandler.a().post(new ReadInJoyMSFService.1(this, paramToServiceMsg, paramReadInJoyEngineModule));
    a(paramToServiceMsg);
  }
