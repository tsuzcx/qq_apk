...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/biz/pubaccount/readinjoy/webarticle/data/ArticleDetailInfo;", "", "()V", "accountAvatarUrl", "", "getAccountAvatarUrl", "()Ljava/lang/String;", "setAccountAvatarUrl", "(Ljava/lang/String;)V", "accountName", "getAccountName", "setAccountName", "articleContentJson", "getArticleContentJson", "setArticleContentJson", "articleId", "", "getArticleId", "()J", "setArticleId", "(J)V", "coverImageUrl", "getCoverImageUrl", "setCoverImageUrl", "extendInfoJson", "getExtendInfoJson", "setExtendInfoJson", "isOverLength", "", "()Z", "setOverLength", "(Z)V", "pUin", "getPUin", "setPUin", "publishTime", "getPublishTime", "setPublishTime", "readCount", "getReadCount", "setReadCount", "rowKey", "getRowKey", "setRowKey", "tags", "getTags", "setTags", "title", "getTitle", "setTitle", "toString", "AQQLiteApp_release"}, k=1, mv={1, 1, 16})
public final class ArticleDetailInfo
{
  ...
  {
    return "rowKey = " + this.rowKey + ", " + "articleId = " + this.articleId + ", " + "isOverLength = " + this.isOverLength + ", " + "title = " + this.title + ", " + "coverImageUrl = " + this.coverImageUrl + ", " + "readCount = " + this.readCount + ", " + "publishTime = " + this.publishTime + ", " + "pUin = " + this.pUin + ", " + "accountAvatarUrl = " + this.accountAvatarUrl + ", " + "accountName = " + this.accountName + ", " + "extendInfoJson = " + this.extendInfoJson + ", " + "articleContentJson = " + this.articleContentJson + ", " + "tags = " + this.tags;
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes4.jar
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.webarticle.data.ArticleDetailInfo
