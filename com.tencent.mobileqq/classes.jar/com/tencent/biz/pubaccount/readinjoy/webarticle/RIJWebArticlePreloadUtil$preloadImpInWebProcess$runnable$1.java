  ...
  implements Runnable
{
  ...
  public final void run()
  {
    ...
    if (!bool)
    {
      ...
      if ((localObject2 != null) && (!TextUtils.isEmpty((CharSequence)((RIJWebArticlePreloadUtil.PreloadData)localObject2).b())))
      {
        String str = ((RIJWebArticlePreloadUtil.PreloadData)localObject2).b();
        if (str == null) {
          Intrinsics.throwNpe();
        }
        bool = localSonicEngine.removeSessionCache(str);
        QLog.i("RIJWebArticlePreloadUtil", 1, "[preloadImpInWebProcess] removeRes = " + bool + ", url = " + this.a + ", firstPreloadData url = " + ((RIJWebArticlePreloadUtil.PreloadData)localObject2).a());
    ...
    for (;;)
    {
      ...
      localObject1 = new RIJWebArticlePreloadUtil.PreloadData(this.a, SonicEngine.makeSessionId(this.a, true));
      if (!bool) {
        break;
      }
