...
public class VideoPredownloadManager
{
  public static void a(String paramString)
  {
    ...
    if (localObject != null)
    {
      ...
      if (localObject != null)
      {
        TVK_PlayerVideoInfo localTVK_PlayerVideoInfo = new TVK_PlayerVideoInfo(2, NativeAdUtils.a(paramString), "");
  ...
  public static boolean a(String paramString)
  {
    ...
    Object localObject2 = NativeAdUtils.a(paramString);
    ...
    ((TVK_PlayerVideoInfo)localObject2).setConfigMap("cache_servers_type", VideoPlayUtils.a);
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.gifvideo.base.video.VideoPredownloadManager
