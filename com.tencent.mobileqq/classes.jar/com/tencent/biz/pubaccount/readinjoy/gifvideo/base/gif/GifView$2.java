  ...
  implements URLDrawableDownListener
{
  ...
  public void onLoadSuccessed(View paramView, URLDrawable paramURLDrawable)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      ((IPublicAccountReportUtils)QRoute.api(IPublicAccountReportUtils.class)).publicAccountReportClickEvent(null, "", "0X800A148", "0X800A148", 0, i, this.c + "", this.d + "", l1 + "", this.b + " " + l2, false);
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.gifvideo.base.gif.GifView.2
