...
{
  private static KandianShortContentGifStrategy jdField_a_of_type_ComTencentBizPubaccountReadinjoyGifvideoUtilsKandianShortContentGifStrategy = new KandianShortContentGifStrategy();
  ...
  {
    super(null, null, null, ReadInJoyMSFService.a(), null);
  }
  
  public static KandianShortContentGifStrategy a()
  {
    return jdField_a_of_type_ComTencentBizPubaccountReadinjoyGifvideoUtilsKandianShortContentGifStrategy;
  }
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (boolean bool = ((Boolean)localObject2).booleanValue();; bool = false)
    {
      ...
      for (paramFromServiceMsg = paramObject.toString();; paramFromServiceMsg = "null")
      {
        ...
        while (paramObject.hasNext())
        {
          ...
          if (localObject2 != null)
          {
            ...
            localVideoUrlInfo.b = ((content_vidurl_svr.UrlInfo)localObject2).vid.get();
            localVideoUrlInfo.jdField_a_of_type_JavaLangString = ((content_vidurl_svr.UrlInfo)localObject2).url.get();
            ThirdVideoManager.a(localVideoUrlInfo);
          }
        }
      ...
      if (paramToServiceMsg != null)
      {
        ...
        paramToServiceMsg.a((String[])((List)localObject1).toArray(new String[((List)localObject1).size()]), (String[])paramFromServiceMsg.toArray(new String[paramFromServiceMsg.size()]), null);
        label546:
        return;
      }
  ...
  public void a(String[] paramArrayOfString, IStrategy.URLCallback paramURLCallback)
  {
    if ((paramArrayOfString != null) && (paramArrayOfString.length > 0))
    {
      ...
      localObject = IPUtils.a(BaseApplicationImpl.getContext());
      if (!TextUtils.isEmpty((CharSequence)localObject)) {
      ...
      localObject = ReadInJoyOidbHelper.a("OidbSvc.0xda2", 3490, 0, ((oidb_cmd0xda2.ReqBody)localObject).toByteArray());
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.gifvideo.utils.KandianShortContentGifStrategy
