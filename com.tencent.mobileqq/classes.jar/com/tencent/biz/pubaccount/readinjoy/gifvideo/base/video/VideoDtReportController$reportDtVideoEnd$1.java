...
final class VideoDtReportController$reportDtVideoEnd$1
  extends Lambda
  implements Function4<IPlayer, IVideoView, View, BaseArticleInfo, Unit>
{
  VideoDtReportController$reportDtVideoEnd$1(VideoDtReportController paramVideoDtReportController)
  {
    super(4);
  }
  ...
  public final void invoke(@NotNull IPlayer paramIPlayer, @NotNull IVideoView paramIVideoView, @NotNull View paramView, @NotNull BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    Intrinsics.checkExpressionValueIsNotNull(VideoDTReport.Builder.a((VideoInfo)null).a(this.this$0.a()).a(paramBaseArticleInfo.mChannelID).b(paramBaseArticleInfo.innerUniqueID).c(paramBaseArticleInfo.getSubscribeUin()).b(paramIPlayer.a()).d(this.this$0.b()).c(1).e(paramView.getWidth()).f(paramView.getHeight()), "VideoDTReport.Builder.ma…Height(originView.height)");
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.gifvideo.base.video.VideoDtReportController.reportDtVideoEnd.1
