...
class ReadInJoyAdPingUrlUtil$URLConnectionPingRunner
  implements Runnable
{
  private final JSONObject a;
  
  public ReadInJoyAdPingUrlUtil$URLConnectionPingRunner(JSONObject paramJSONObject)
  {
  ...
  public void run()
  {
    ...
    Object localObject2 = new acry();
    ((acry)localObject2).a = "ce2d9f";
    localObject2 = acrx.a(BaseApplication.getContext(), (acry)localObject2);
    if (localObject2 != null) {}
    for (localObject2 = ((acrz)localObject2).a;; localObject2 = null)
    {
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.ad.utils.ReadInJoyAdPingUrlUtil.URLConnectionPingRunner
