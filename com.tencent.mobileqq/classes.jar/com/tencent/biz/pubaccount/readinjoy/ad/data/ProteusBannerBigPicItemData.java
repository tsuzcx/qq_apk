  ...
  extends AdData
{
  ...
  private JSONObject a()
  {
    ...
    Object localObject1;
    if (opz.b(this)) {
      localObject1 = opi.a(localJSONObject, this);
    }
    for (;;)
    {
      return localObject1;
      if (opz.a(this)) {
        return opg.a(localJSONObject, this);
      }
      localObject1 = str1;
      Object localObject5;
      try
      ...
      {
        localObject1 = this.e;
        d1 = nya.a(this.d, 0.0D);
        d2 = nya.a((String)localObject1, 0.0D);
        if (d2 == 0.0D)
        {
          localObject1 = str1;
          if (d1 == 0.0D) {}
      ...
      for (;;)
      {
        ...
        case 1: 
          ...
          case 1: 
            ...
            {
              localObject1 = new JSONObject();
              if ((this.jdField_a_of_type_Boolean) && (this.jdField_q_of_type_JavaLangString.length() > 8)) {
                this.jdField_q_of_type_JavaLangString = this.jdField_q_of_type_JavaLangString.substring(0, 8).concat("...");
              }
              ((JSONObject)localObject1).put("text", this.jdField_q_of_type_JavaLangString);
            }
            switch (this.jdField_q_of_type_Int)
            {
            case 1: 
              ...
              olk.a(this, localJSONObject);
              break label954;
              d1 = nxw.a((double[])localObject1, BaseApplicationImpl.getContext());
              break label140;
              d1 = Math.ceil(d1);
  ...
  {
    return (!TextUtils.isEmpty(this.j)) && (!TextUtils.isEmpty(this.l)) && (!TextUtils.isEmpty(this.jdField_q_of_type_JavaLangString));
  }
  ...
  public void a()
  {
    ...
    try
    {
      ...
      if (localteh != null) {
        localObject1 = localteh.getTemplateBean(this.jdField_c_of_type_OrgJsonJSONObject);
      }
    }
    catch (JSONException localJSONException)
    {
