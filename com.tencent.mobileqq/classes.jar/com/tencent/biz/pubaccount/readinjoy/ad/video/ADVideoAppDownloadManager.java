  ...
  implements DownloadListener
{
  ...
  private ITMAssistantDownloadClientListener jdField_a_of_type_ComTencentTmdownloaderITMAssistantDownloadClientListener = new ord(this);
  private Runnable jdField_a_of_type_JavaLangRunnable = new ADVideoAppDownloadManager.1(this);
  protected List<orb> a;
  protected ConcurrentHashMap<String, orb> a;
  private orb jdField_a_of_type_Orb;
  private ore jdField_a_of_type_Ore;
  ...
  private int a(Context paramContext, orb paramorb)
  {
    if ((paramContext == null) || (paramorb == null)) {}
    do
    {
      ...
      do
      {
        ...
        {
          return -1;
          paramContext = paramorb.d;
          paramorb = paramorb.jdField_a_of_type_JavaLangString;
          if ((!TextUtils.isEmpty(paramContext)) && (!TextUtils.isEmpty(paramorb))) {
            break;
          }
        } while (!QLog.isColorLevel());
        QLog.d("ADVideoAppDownloadManager", 2, "isPkgDownloading pkg:" + paramContext + ", appid:" + paramorb + " false");
        return -1;
        localDownloadInfo = bisa.a().c(paramContext);
      ...
      if (localDownloadInfo.a() == 2)
      {
        if (QLog.isColorLevel()) {
          QLog.d("ADVideoAppDownloadManager", 2, "isPkgDownloading pkg:" + paramContext + ", appid:" + paramorb + " true");
        }
  ...
  private DownloadInfo a(orb paramorb, int paramInt)
  {
    DownloadInfo localDownloadInfo = new DownloadInfo();
    localDownloadInfo.e = paramorb.d;
    localDownloadInfo.f = paramInt;
    localDownloadInfo.jdField_c_of_type_JavaLangString = paramorb.jdField_a_of_type_JavaLangString;
  ...
  private String a(String paramString, int paramInt)
  {
    ...
    //   200: invokespecial 252	com/tencent/biz/pubaccount/readinjoy/ad/video/ADVideoAppDownloadManager:a	(Ljava/io/InputStream;)Ljava/lang/String;
    //   203: astore_1
    //   204: aload_1
    ...
    //   220: invokespecial 258	com/tencent/biz/pubaccount/readinjoy/ad/video/ADVideoAppDownloadManager:a	(Lorg/json/JSONObject;)Ljava/lang/String;
    //   223: astore_1
    //   224: aload_1
    //   225: astore 4
    //   227: aload_3
  ...
  private void a(Activity paramActivity, orb paramorb)
  {
    ...
    ThreadManager.getSubThreadHandler().post(new ADVideoAppDownloadManager.3(this, paramorb, paramActivity));
  }
  
  private void a(boolean paramBoolean, long paramLong) {}
  
  private boolean a(Context paramContext, orb paramorb)
  {
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            return bool2;
            str1 = paramorb.d;
            str2 = paramorb.jdField_a_of_type_JavaLangString;
            bool2 = bool1;
          } while (TextUtils.isEmpty(str1));
          bool2 = bool1;
        } while (TextUtils.isEmpty(str2));
        localDownloadInfo = bisa.a().c(str1);
        bool2 = bool1;
      ...
      paramorb = localDownloadInfo.l;
      bool1 = bool3;
      if (!TextUtils.isEmpty(paramorb))
      {
        bool1 = bool3;
        if (new File(paramorb).exists()) {
          bool1 = true;
        }
      }
      bool2 = bool1;
    } while (!QLog.isColorLevel());
    QLog.d("ADVideoAppDownloadManager", 2, "isPkgExist(" + bool1 + ") pkg:" + str1 + ", appid:" + str2 + ", path:" + paramorb);
    return bool1;
  ...
  private void h()
  {
    ...
    this.jdField_a_of_type_Orb = null;
  }
  
  protected int a(orb paramorb)
  {
    if (paramorb != null) {
      return paramorb.jdField_a_of_type_Int;
    }
    return 0;
  }
  ...
  public void a()
  {
    ...
    if ((this.jdField_a_of_type_Orb != null) && (this.jdField_a_of_type_Rxl != null) && (this.jdField_a_of_type_Rxl.jdField_a_of_type_Sar != null) && (this.jdField_a_of_type_Rxl.jdField_a_of_type_Sar.a != null) && (oqi.d(this.jdField_a_of_type_Rxl.jdField_a_of_type_Sar.a.a))) {
      g();
    }
  }
  ...
  {
    if ((this.jdField_a_of_type_AndroidContentContext == null) || (this.jdField_a_of_type_Ore == null) || (paramorb == null) || (!paramorb.a()))
    {
    ...
    if (nxw.a(this.jdField_a_of_type_AndroidContentContext, paramorb.d))
    {
      QLog.d("ADVideoAppDownloadManager", 1, "already installed." + paramorb.d);
      this.jdField_a_of_type_Ore.jdField_a_of_type_Boolean = true;
      this.jdField_a_of_type_Ore.a();
      this.jdField_a_of_type_Ore.b(paramorb);
      return;
    }
    olc.a(paramorb, new orc(this, paramorb));
  }
  
  public void a(orb paramorb, int paramInt)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ADVideoAppDownloadManager", 2, "startDownload " + paramorb.d + " progress " + paramInt);
    }
    paramorb.jdField_a_of_type_Int = 3;
    this.jdField_a_of_type_Ore.b(paramorb, paramInt);
    Activity localActivity = (Activity)this.jdField_a_of_type_AndroidContentContext;
    this.jdField_a_of_type_Ore.jdField_a_of_type_Boolean = true;
    a(localActivity, paramorb);
  }
  
  protected void a(orb paramorb, int paramInt1, int paramInt2) {}
  ...
  public void a(rxy paramrxy)
  {
    ...
    {
      this.jdField_a_of_type_Rxl.jdField_a_of_type_Boolean = false;
      this.jdField_a_of_type_Rxl.jdField_a_of_type_AndroidViewView.setVisibility(8);
      this.jdField_a_of_type_Rxl.jdField_a_of_type_Rur.a(this.jdField_a_of_type_Rxl.jdField_a_of_type_Sar.a);
    }
    if ((paramrxy instanceof rxl))
    {
      ...
      if (this.jdField_a_of_type_Rxl != null)
      {
        paramrxy = this.jdField_a_of_type_Rxl.jdField_a_of_type_Sar.a;
        if (paramrxy != null) {
          break label96;
        }
      }
    ...
    {
      return;
      localVideoAdInfo = paramrxy.a;
    } while ((localVideoAdInfo == null) || (!paramrxy.c) || (!AdvertisementInfo.isAppAdvertisementInfo(oqu.a(localVideoAdInfo))));
    paramrxy = orb.a(localVideoAdInfo);
    if (TextUtils.isEmpty(paramrxy)) {
      paramrxy = "STUB_PACK_NAME_" + jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.incrementAndGet();
    }
    for (;;)
    {
      orb localorb2 = (orb)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramrxy);
      orb localorb1 = localorb2;
      if (localorb2 == null) {
        localorb1 = orb.a(localVideoAdInfo);
      }
      if (localorb1 == null) {
        break;
      }
      localorb1.d = paramrxy;
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramrxy, localorb1);
      this.jdField_a_of_type_Orb = localorb1;
      this.jdField_a_of_type_Ore = new ore(this.jdField_a_of_type_Rxl, this, this.jdField_a_of_type_AndroidContentContext);
      bisa.a().a(this);
      if (QLog.isColorLevel()) {
        QLog.d("ADVideoAppDownloadManager", 2, " onCenterViewChanged  mState = " + this.jdField_a_of_type_Orb.jdField_a_of_type_Int);
      }
      if ((oqi.d(localVideoAdInfo)) && ((localorb1.jdField_a_of_type_Int == 4) || (localorb1.jdField_a_of_type_Int == 3)))
      {
        this.jdField_a_of_type_Ore.jdField_a_of_type_Boolean = true;
        this.jdField_a_of_type_Ore.a();
        if (localorb1.jdField_a_of_type_Int != 3) {
          break label341;
        }
        this.jdField_a_of_type_Ore.b(localorb1, localorb1.b);
      }
      for (;;)
      {
        d();
        return;
        label341:
        if (localorb1.jdField_a_of_type_Int == 4) {
          this.jdField_a_of_type_Ore.a(localorb1);
        }
      }
    }
  }
  ...
  public boolean a(VideoInfo paramVideoInfo)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        boolean bool2 = bgnw.a(this.jdField_a_of_type_AndroidContentContext, paramVideoInfo.optString("pkg_name"));
        if (bool2) {
          return bool1;
        }
      }
  ...
  {
    if (paramorb != null) {
      ThreadManager.excute(new ADVideoAppDownloadManager.4(this, paramorb), 128, null, true);
    }
    return false;
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("ADVideoAppDownloadManager", 2, "startDownload " + paramorb.d);
    }
    Activity localActivity = (Activity)this.jdField_a_of_type_AndroidContentContext;
    this.jdField_a_of_type_Ore.jdField_a_of_type_Boolean = true;
    a(localActivity, paramorb);
  ...
  {
    String str = paramorb.jdField_c_of_type_JavaLangString;
    if (!TextUtils.isEmpty(str))
    {
      bisa.a().a(str);
      oqh.a("ADVideoAppDownloadManager", "pauseDownload : url = " + str);
      return;
    }
    ThreadManager.getSubThreadHandler().post(new ADVideoAppDownloadManager.5(this, paramorb));
  }
  
  public void d()
  {
    if ((!this.jdField_b_of_type_Boolean) && (acra.a(this.jdField_a_of_type_AndroidContentContext)))
    {
      this.jdField_b_of_type_Boolean = true;
      ADVideoAppDownloadManager.LoadTask localLoadTask = new ADVideoAppDownloadManager.LoadTask(this, this.jdField_a_of_type_Orb);
  ...
  public void e()
  {
    if ((acra.a(this.jdField_a_of_type_AndroidContentContext)) && (!this.jdField_b_of_type_Boolean))
    {
      this.jdField_b_of_type_Boolean = true;
  ...
  public void f()
  {
    ...
    {
      this.jdField_a_of_type_Ore.a(null, 0);
      oqh.a("ADVideoAppDownloadManager", "mADVideoAppDownloadData = null");
      return;
    }
    if (this.jdField_a_of_type_Orb.jdField_a_of_type_Int == 5)
    {
      oqh.a("ADVideoAppDownloadManager", this.jdField_a_of_type_Orb.d + " download finish");
      b(this.jdField_a_of_type_Orb);
      return;
    }
    this.jdField_a_of_type_Ore.a(this.jdField_a_of_type_Orb, this.jdField_a_of_type_Orb.jdField_a_of_type_Int);
  }
  ...
  {
    oqh.a("ADVideoAppDownloadManager", "installSucceed " + paramString2);
    DownloadInfo localDownloadInfo = new DownloadInfo();
    localDownloadInfo.jdField_c_of_type_JavaLangString = paramString1;
    localDownloadInfo.e = paramString2;
    this.jdField_a_of_type_Ore.a(paramString1, paramString2, this.jdField_a_of_type_Orb);
  }
  ...
  public void onDownloadCancel(DownloadInfo paramDownloadInfo)
  {
    ...
    this.jdField_a_of_type_Ore.c(paramDownloadInfo, this.jdField_a_of_type_Orb);
  }
  ...
  public void onDownloadError(DownloadInfo paramDownloadInfo, int paramInt1, String paramString, int paramInt2)
  {
    ...
    this.jdField_a_of_type_Ore.a(paramDownloadInfo, paramInt1, paramString, paramInt2, this.jdField_a_of_type_Orb);
  }
  
  public void onDownloadFinish(DownloadInfo paramDownloadInfo)
  {
    oqh.a("ADVideoAppDownloadManager", "onDownloadFinish " + paramDownloadInfo.e);
    this.jdField_a_of_type_Ore.d(paramDownloadInfo, this.jdField_a_of_type_Orb);
  }
  
  public void onDownloadPause(DownloadInfo paramDownloadInfo)
  {
    oqh.a("ADVideoAppDownloadManager", "onDownloadPause " + paramDownloadInfo.e);
    if ((paramDownloadInfo != null) && (this.jdField_a_of_type_Orb != null) && (this.jdField_a_of_type_Orb.d != null) && (this.jdField_a_of_type_Orb.d.equals(paramDownloadInfo.e)) && (paramDownloadInfo.f != 0) && (paramDownloadInfo.f != 100)) {
      this.jdField_a_of_type_Orb.b = paramDownloadInfo.f;
    }
    this.jdField_a_of_type_Ore.a(paramDownloadInfo, this.jdField_a_of_type_Orb);
  }
  
  public void onDownloadUpdate(List<DownloadInfo> paramList)
  {
    this.jdField_a_of_type_Ore.a(paramList, this.jdField_a_of_type_Orb);
  }
  ...
  public void onDownloadWait(DownloadInfo paramDownloadInfo)
  {
    ...
    this.jdField_a_of_type_Ore.b(paramDownloadInfo, this.jdField_a_of_type_Orb);
  }
  ...
  public void packageReplaced(String paramString1, String paramString2)
  {
    ...
    localDownloadInfo.jdField_c_of_type_JavaLangString = paramString1;
    localDownloadInfo.e = paramString2;
    this.jdField_a_of_type_Ore.c(paramString1, paramString2, this.jdField_a_of_type_Orb);
  }
  ...
  public void uninstallSucceed(String paramString1, String paramString2)
  {
    ...
    localDownloadInfo.jdField_c_of_type_JavaLangString = paramString1;
    localDownloadInfo.e = paramString2;
    this.jdField_a_of_type_Ore.b(paramString1, paramString2, this.jdField_a_of_type_Orb);
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes6.jar
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.ad.video.ADVideoAppDownloadManager
