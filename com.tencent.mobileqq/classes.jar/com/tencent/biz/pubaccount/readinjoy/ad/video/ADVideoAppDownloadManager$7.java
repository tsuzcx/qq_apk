  ...
  implements Runnable
{
  ...
  public void run()
  {
    orb localorb = ADVideoAppDownloadManager.a(this.this$0);
    if (localorb == null) {}
    int k;
    do
    {
      ...
      {
        return;
        j = localorb.jdField_a_of_type_Int;
        if (olc.a(localorb))
        {
          localorb.jdField_a_of_type_Int = 1;
          this.this$0.a(ADVideoAppDownloadManager.a(this.this$0, localorb, 100), localorb.jdField_a_of_type_Int);
          return;
        }
        localObject = localorb.c;
        ...
        if ((j == 5) || (j == 0))
        {
          ...
          if ((j == 2) || (j == 1)) {
            localorb.jdField_a_of_type_Int = 3;
          }
          for (;;)
          {
            localObject = new DownloadInfo();
            ((DownloadInfo)localObject).e = localorb.d;
            ((DownloadInfo)localObject).f = i;
            ((DownloadInfo)localObject).c = localorb.jdField_a_of_type_JavaLangString;
            ...
            this.this$0.a((DownloadInfo)localObject, localorb.jdField_a_of_type_Int);
            return;
            if (j == 3) {
              localorb.jdField_a_of_type_Int = 4;
            } else if (j == 4) {
              localorb.jdField_a_of_type_Int = 5;
            } else {
              localorb.jdField_a_of_type_Int = 0;
            }
          }
        }
      } while ((j != 4) && (j != 3));
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.ad.video.ADVideoAppDownloadManager.7
