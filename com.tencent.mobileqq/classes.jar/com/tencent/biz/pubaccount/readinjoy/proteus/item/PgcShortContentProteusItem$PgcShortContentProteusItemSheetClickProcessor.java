  ...
  extends ReadInJoyShareHelperV2.BaseSheetItemClickProcessor
{
  ...
  PgcShortContentProteusItem$PgcShortContentProteusItemSheetClickProcessor(ArticleInfo paramArticleInfo, WeakReference<Activity> paramWeakReference)
  {
  ...
  public boolean a(int paramInt, @NotNull ShareActionSheetBuilder.ActionSheetItem paramActionSheetItem)
  {
    try
    {
      ...
      {
        Object localObject1 = ((SocializeFeedsInfo.PGCPicInfo)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mSocialFeedInfo.a.jdField_a_of_type_JavaUtilArrayList.get(0)).c;
        if (paramActionSheetItem.action == 13)
        {
          localObject1 = (Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get();
          if (localObject1 != null)
          {
            localObject2 = OnBiuClickListener.a((Activity)localObject1, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo);
            if (BiuBehaviour.a() == 1)
            {
              bool = true;
    ...
    catch (NullPointerException localNullPointerException1)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          if (PgcShortContentProteusItem.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusItemPgcShortContentProteusItem) == null) {
            PgcShortContentProteusItem.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusItemPgcShortContentProteusItem, new QShareUtils());
          }
          str1 = null;
          if (paramActionSheetItem.action == 72) {
            str1 = paramActionSheetItem.uin;
          }
          PgcShortContentProteusItem.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusItemPgcShortContentProteusItem).a(localJSONObject, paramInt, (Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get(), str1, paramActionSheetItem.uinType, paramActionSheetItem.label);
        }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.proteus.item.PgcShortContentProteusItem.PgcShortContentProteusItemSheetClickProcessor
