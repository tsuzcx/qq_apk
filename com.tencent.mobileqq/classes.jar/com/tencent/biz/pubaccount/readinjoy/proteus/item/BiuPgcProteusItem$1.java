  ...
  implements ViewBase.OnClickListener
{
  ...
  public void onClick(ViewBase paramViewBase)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("BiuPgcProteusItem", 2, "click gallery summary for jumping to gallery articleinfo = " + this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelIReadInJoyModel.a() + " position = " + this.jdField_a_of_type_Int);
    }
  }
}
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.proteus.item.BiuPgcProteusItem.1
