  ...
  extends ViewBase
{
  ...
  private void a(int paramInt)
  {
    ...
    if (!this.jdField_a_of_type_JavaUtilArrayList.isEmpty())
    {
      ...
      localObject = "还Biu了" + this.i + HardCodeUtil.a(2131712942);
    }
    label132:
    label183:
    label332:
    ...
    for (;;)
    {
      ...
      for (paramInt = this.c * paramInt;; paramInt = (paramInt - 1) * this.c)
      {
        ...
        localObject = HardCodeUtil.a(2131713068) + k + "人也Biu了";
        break;
        k = this.jdField_a_of_type_JavaUtilArrayList.size();
        break label132;
        k = m * this.c + this.d;
  ...
  private void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    for (int m = 20;; m = 0)
    {
      ...
      localImageView.setBackgroundResource(2130849816);
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.proteus.view.ReadInJoyFriendsBiu
