...
import com.tencent.biz.pubaccount.readinjoy.popup.RIJFollowPackUtils;
import com.tencent.biz.pubaccount.readinjoy.popup.RIJFollowPackUtils.RIJFollowPackData;
  ...
  implements PolymericContainer
{
  ...
  private RecycleViewAdapterHelper.OnErrorListener jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericHelperRecycleViewAdapterHelper$OnErrorListener;
  private RecycleViewAdapterHelper.OnItemClickListener jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericHelperRecycleViewAdapterHelper$OnItemClickListener;
  ...
  private AdSmallGameReportManager jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdUtilsAdSmallGameReportManager = new AdSmallGameReportManager();
  ...
  {
    QLog.d("RecycleViewAdapterHelper", 1, "addExportItem curPosition: " + paramInt + "  model :" + this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelIReadInJoyModel);
    ...
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelIReadInJoyModel != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelIReadInJoyModel.a() != null) && (localTemplateBean != null)) {}
    try
    {
      if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelIReadInJoyModel.a().mGroupSubArticleList != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelIReadInJoyModel.a().mGroupSubArticleList.size() > paramInt) && (RIJFeedsType.g(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelIReadInJoyModel.a())) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelIReadInJoyModel.a().mNewPolymericInfo.jdField_a_of_type_Boolean)) {
        a((BaseArticleInfo)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelIReadInJoyModel.a().mGroupSubArticleList.get(paramInt), paramInt);
      }
      for (;;)
      {
        ...
        {
          return;
          localObject2 = (List)c.get(Long.valueOf(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelIReadInJoyModel.a().mArticleID));
          localObject1 = localObject2;
          if (localObject2 == null)
          {
            localObject1 = new ArrayList();
            c.put(Long.valueOf(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelIReadInJoyModel.a().mArticleID), localObject1);
          }
        } while (paramInt < ((List)localObject1).size());
        Object localObject2 = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelIReadInJoyModel.a().clone();
  ...
  private void a(BaseArticleInfo paramBaseArticleInfo, int paramInt)
  {
    ...
    {
      localObject = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelIReadInJoyModel.a().getContext();
    ...
    for (int i = 1;; i = 0)
    {
      localObject = new ReadInJoyModelImpl((Context)localObject, localArticleInfo, j, k, i, paramInt, false, a(), null, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelIReadInJoyModel.a());
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelIReadInJoyModel.a().a(paramBaseArticleInfo, (IReadInJoyModel)localObject, System.currentTimeMillis(), paramInt);
      return;
    }
  }
  ...
  private void a(Runnable paramRunnable)
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView.postDelayed(new RecycleViewAdapterHelper.6(this, paramRunnable), 100L);
  }
  ...
  {
    if (!(this.jdField_a_of_type_JavaLangObject instanceof RIJFollowPackUtils.RIJFollowPackData)) {}
    ArticleInfo localArticleInfo;
    ...
    do
    {
      ...
      {
        return;
        localArticleInfo = ((RIJFollowPackUtils.RIJFollowPackData)this.jdField_a_of_type_JavaLangObject).a();
      } while (localArticleInfo.mRecommendFollowInfos == null);
      if (paramInt < 0) {
        localArticleInfo.mRecommendFollowInfos.jdField_a_of_type_JavaUtilList.size();
      }
      localRecommendFollowInfo = (RecommendFollowInfo)localArticleInfo.mRecommendFollowInfos.jdField_a_of_type_JavaUtilList.get(paramInt);
    } while ((localRecommendFollowInfo == null) || (this.d.containsKey(localRecommendFollowInfo)));
    this.d.put(localRecommendFollowInfo, Long.valueOf(localRecommendFollowInfo.uin));
    paramInt = localArticleInfo.mRecommendFollowInfos.jdField_b_of_type_Int;
  ...
  {
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelIReadInJoyModel != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelIReadInJoyModel != paramIReadInJoyModel) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelIReadInJoyModel.a() != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelIReadInJoyModel.a().getId() != paramIReadInJoyModel.a().getId()) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView != null)) {
  ...
  {
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdUtilsAdSmallGameReportManager != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelIReadInJoyModel != null)) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdUtilsAdSmallGameReportManager.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext.getContext(), this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelIReadInJoyModel, paramInt, 2);
    }
  }
  ...
  public void a(IReadInJoyModel paramIReadInJoyModel)
  {
    ...
    } while (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelIReadInJoyModel.a() == null);
    a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelIReadInJoyModel.a().mGroupSubArticleList);
  }
  ...
  {
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericHelperRecycleViewAdapterHelper$OnErrorListener = paramOnErrorListener;
  }
  
  public void a(RecycleViewAdapterHelper.OnItemClickListener paramOnItemClickListener)
  {
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericHelperRecycleViewAdapterHelper$OnItemClickListener = paramOnItemClickListener;
  ...
  public void onBindViewHolder(RecyclerView.ViewHolder paramViewHolder, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      a(i);
      c(i);
      Object localObject2 = (RecycleViewAdapterHelper.SimpleHolder)paramViewHolder;
      Container localContainer = (Container)((RecycleViewAdapterHelper.SimpleHolder)localObject2).itemView;
      BindDataUtil.bindDynamicValueWithoutRecursion(localContainer, ((RecycleViewAdapterHelper.SimpleHolder)localObject2).a, (TemplateBean)localObject1);
      ...
      a((RecycleViewAdapterHelper.SimpleHolder)localObject2, i, (TemplateBean)localObject1);
      continue;
      if ((paramViewHolder instanceof RecycleViewAdapterHelper.ErrorHolder))
      {
        localObject1 = (RecycleViewAdapterHelper.ErrorHolder)paramViewHolder;
        localObject2 = ((RecycleViewAdapterHelper.ErrorHolder)localObject1).itemView.getLayoutParams();
        if (localObject2 != null)
        {
          ((ViewGroup.LayoutParams)localObject2).width = 0;
          ((ViewGroup.LayoutParams)localObject2).height = 0;
          ((RecycleViewAdapterHelper.ErrorHolder)localObject1).itemView.setLayoutParams((ViewGroup.LayoutParams)localObject2);
        }
      }
    }
  }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.proteus.view.polymeric.helper.RecycleViewAdapterHelper
