  ...
  extends ViewBase
{
  ...
  public void a()
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyDrawableReadInJoyLottieDrawable != null) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyDrawableReadInJoyLottieDrawable.resumeAnimation();
    }
  }
  ...
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyDrawableReadInJoyLottieDrawable != null) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyDrawableReadInJoyLottieDrawable.pauseAnimation();
    }
  }
  ...
  public boolean setAttribute(int paramInt, String paramString)
  {
    ...
    try
    {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyDrawableReadInJoyLottieDrawable = ReadInJoyLottieDrawable.a(paramString);
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView.setImageDrawable(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyDrawableReadInJoyLottieDrawable);
      return true;
    }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.proteus.view.ReadInJoyLottieView
