  ...
  implements ProteusItem
{
  ...
  public JSONObject a(int paramInt, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    for (;;)
    {
      try
      {
        localProteusItemDataBuilder.a(str1).d(paramBaseArticleInfo, str2).j(paramBaseArticleInfo).r(paramBaseArticleInfo);
  ...
  public void a(int paramInt1, Container paramContainer, IReadInJoyModel paramIReadInJoyModel, int paramInt2)
  {
    ...
    if ((localObject == null) || (paramIReadInJoyModel == null) || (paramIReadInJoyModel.a() == null)) {}
    ...
    for (localObject = "#999999";; localObject = "#4c4c4c")
    {
      ...
      {
        paramInt1 = paramInt2;
        if (!RIJFeedsType.k(paramIReadInJoyModel.a())) {
          paramInt1 = 2;
        }
      }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.proteus.item.QuestionAnswerCardProteusItem
