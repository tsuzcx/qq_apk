...
public class NativeArticleCommentSummaryView$ReadArticleSpan
  ...
  implements ReadInJoyYAFolderTextView.ClickableSpanPressed
{
  ...
  public NativeArticleCommentSummaryView$ReadArticleSpan(ArticleInfo paramArticleInfo, int paramInt, Context paramContext, Resources paramResources, CmpCtxt paramCmpCtxt)
  {
  ...
  public void updateDrawState(TextPaint paramTextPaint)
  {
    ...
    for (int i = this.jdField_a_of_type_Int;; i = 16777215)
    {
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.proteus.view.impl.NativeArticleCommentSummaryView.ReadArticleSpan
