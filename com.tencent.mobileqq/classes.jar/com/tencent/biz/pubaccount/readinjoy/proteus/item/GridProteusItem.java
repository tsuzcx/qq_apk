  ...
  implements ProteusItem
{
  ...
  {
    paramBaseArticleInfo = new ProteusItemDataBuilder().M(paramBaseArticleInfo).C(paramBaseArticleInfo);
    switch (paramInt)
    {
    default: 
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.proteus.item.GridProteusItem
