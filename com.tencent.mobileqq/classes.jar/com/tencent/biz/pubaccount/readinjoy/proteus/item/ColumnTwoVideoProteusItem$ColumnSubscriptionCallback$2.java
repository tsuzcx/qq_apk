...
public class ColumnTwoVideoProteusItem$ColumnSubscriptionCallback$2
  implements Runnable
{
  public ColumnTwoVideoProteusItem$ColumnSubscriptionCallback$2(qno paramqno, Bundle paramBundle, int paramInt) {}
  ...
  public void run()
  {
    ...
    if ((i == 1) && (this.jdField_a_of_type_Int != 0))
    {
      ...
      rao.a.a().a(this.jdField_a_of_type_Int, str, String.valueOf(i), 1);
    }
    while (i != 2)
    {
      String str;
