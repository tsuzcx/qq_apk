  ...
  implements IReadInJoyListItemAutoPlayCallback
{
  ...
  public boolean a()
  {
    ...
    if (localView2 != null)
    {
      ...
      if (localView3 != null)
      {
        ...
        if ((!this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusItemPgcShortContentProteusItem$Bool.a()) || (i + j - k < -localView1.getHeight() * 0.3D) || (m - n - i1 < -localView1.getHeight() * 0.3D)) {
          break label159;
        }
      }
    }
  ...
  public void b()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyGifvideoBaseVideoVideoView.getPlayMode() == VideoView.PLAYMODE_AUTO) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyGifvideoBaseVideoVideoView.getAction() != 6)) {
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.proteus.item.PgcShortContentProteusItem.7
