  ...
  implements IView
{
  ...
  private pvb jdField_a_of_type_Pvb = new pvb();
  ...
  private void a(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130848467);
    ...
    localLayoutParams.addRule(13);
    int i = actn.a(3.5F, paramContext.getResources());
    ...
    localLayoutParams = new RelativeLayout.LayoutParams(actn.a(12.0F, paramContext.getResources()), actn.a(12.0F, paramContext.getResources()));
    localLayoutParams.addRule(12);
    localLayoutParams.addRule(11);
    i = actn.a(3.0F, paramContext.getResources());
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKandianUrlImageView.setImageResource(2130842324);
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        a(this.jdField_a_of_type_Pvb.a);
        qjd.a(this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKandianUrlImageView);
        return;
        localObject = "";
      }
  ...
  {
    setModel(parampax, true);
  }
  
  public void setModel(pax parampax, boolean paramBoolean)
  {
  ...
  public void setUin(long paramLong)
  {
    ...
    qjd.a(paramLong, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKandianUrlImageView);
  }
}
