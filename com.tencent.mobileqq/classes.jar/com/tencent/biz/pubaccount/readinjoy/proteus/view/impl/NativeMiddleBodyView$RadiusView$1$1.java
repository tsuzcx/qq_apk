...
public class NativeMiddleBodyView$RadiusView$1$1
  implements Runnable
{
  public NativeMiddleBodyView$RadiusView$1$1(pnf parampnf, int paramInt1, int paramInt2, RelativeLayout.LayoutParams paramLayoutParams) {}
  ...
  public void run()
  {
    ...
    this.jdField_a_of_type_Pnf.a.setLayoutParams(this.jdField_a_of_type_AndroidWidgetRelativeLayout$LayoutParams);
  }
}
