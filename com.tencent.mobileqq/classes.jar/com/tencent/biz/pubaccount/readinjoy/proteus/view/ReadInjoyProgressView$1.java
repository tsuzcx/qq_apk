  ...
  extends NativeTextImp
{
  ...
  public void draw(Canvas paramCanvas)
  {
    if (!TextUtils.isEmpty(getText()))
    {
      ...
      paramCanvas.drawRoundRect(this.a.jdField_a_of_type_AndroidGraphicsRectF, AIOUtils.a(2.0F, getResources()), AIOUtils.a(2.0F, getResources()), this.a.jdField_a_of_type_AndroidGraphicsPaint);
      this.a.jdField_a_of_type_AndroidGraphicsPaint.setColor(Color.parseColor(ReadInjoyProgressView.b(this.a)));
      paramCanvas.drawRoundRect(this.a.b, AIOUtils.a(2.0F, getResources()), AIOUtils.a(2.0F, getResources()), this.a.jdField_a_of_type_AndroidGraphicsPaint);
    }
