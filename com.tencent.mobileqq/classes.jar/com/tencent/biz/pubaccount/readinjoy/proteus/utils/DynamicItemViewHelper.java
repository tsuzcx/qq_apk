...
{
  private static int jdField_a_of_type_Int = 149;
  ...
  private DynamicProteusItem jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusItemDynamicProteusItem;
  ...
  public static String a(BaseArticleInfo paramBaseArticleInfo)
  {
    try
    {
      paramBaseArticleInfo = new JSONObject(paramBaseArticleInfo.proteusItemsData).optString("style_ID");
      return paramBaseArticleInfo;
    }
    catch (JSONException paramBaseArticleInfo)
    {
      QLog.e(jdField_a_of_type_JavaLangString, 1, paramBaseArticleInfo.getMessage());
    }
    return null;
  }
  ...
  {
    paramVafContext = paramIReadInJoyModel.a();
    if (paramVafContext != null)
    {
      paramIReadInJoyModel = paramVafContext.b(paramIReadInJoyModel.g() + 1);
  ...
  public int a()
  {
    if (b == 2147483647)
    {
      AIOUtils.a(jdField_a_of_type_JavaLangString, "", new IllegalArgumentException(HardCodeUtil.a(2131703604)));
      return jdField_a_of_type_Int - 148 + 1;
    }
    return b - 148 + 1;
  }
  ...
  public int a(ArticleInfo paramArticleInfo)
  {
    ...
    if (!TextUtils.isEmpty(paramArticleInfo.proteusItemsData))
    {
      ...
      {
        a(str);
        localObject1 = (Integer)jdField_a_of_type_JavaUtilMap.get(str);
      }
    }
    if (localObject1 == null)
    {
      QLog.d(jdField_a_of_type_JavaLangString, 2, "getType: templateBean, data: " + paramArticleInfo.proteusItemsData);
      return 148;
    }
    if ((((Integer)localObject1).intValue() < 148) || (((Integer)localObject1).intValue() >= jdField_a_of_type_Int))
    {
      AIOUtils.a(jdField_a_of_type_JavaLangString, "", new IllegalArgumentException(HardCodeUtil.a(2131703605)));
      return 148;
    }
  ...
  public ProteusItemView a(VafContext paramVafContext, int paramInt, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = localObject2;
        ReadInJoyPTSCostHelper.a(str, (String)localObject3, "DynamicPTS.getView", l2 - l1);
        localObject1 = localObject2;
      }
      catch (Exception localException)
      {
        ...
        AIOUtils.a(jdField_a_of_type_JavaLangString, "getView:", new IllegalArgumentException(paramBaseArticleInfo.proteusItemsData, localException));
        continue;
      }
  ...
  public ProteusItemView a(VafContext paramVafContext, JSONObject paramJSONObject)
  {
    ...
    //   0: ldc_w 327
    //   3: iconst_1
    //   4: invokestatic 332	com/tencent/biz/pubaccount/readinjoy/view/proteus/factory/TemplateFactory:a	(Ljava/lang/String;Z)Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/factory/TemplateFactory;
    //   7: astore_3
    //   8: aload_3
    //   9: ifnull +64 -> 73
    //   12: aload_3
    //   13: aload_2
    //   14: invokevirtual 336	com/tencent/biz/pubaccount/readinjoy/view/proteus/factory/TemplateFactory:getTemplateBean	(Lorg/json/JSONObject;)Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/bean/TemplateBean;
    //   17: astore_2
    //   18: aload_1
    ...
    //   54: aconst_null
    //   55: aload_2
    //   56: invokestatic 341	com/tencent/biz/pubaccount/readinjoy/common/ProteusSupportUtil:a	(Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/virtualview/container/Container;Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/bean/TemplateBean;Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/bean/TemplateBean;)V
    //   59: aload_3
    //   60: aload_2
    //   61: invokevirtual 345	com/tencent/biz/pubaccount/readinjoy/proteus/item/ProteusItemView:setTemplateBean	(Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/bean/TemplateBean;)V
    //   64: aload 4
    //   66: aload_1
    //   67: aload_2
    //   68: invokestatic 348	com/tencent/biz/pubaccount/readinjoy/common/ProteusSupportUtil:a	(Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/virtualview/container/Container;Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/virtualview/core/VafContext;Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/bean/TemplateBean;)V
    //   71: aload_3
    //   72: areturn
    //   73: aconst_null
    //   74: astore_2
    ...
    //   79: aconst_null
    //   80: astore_1
    //   81: getstatic 18	com/tencent/biz/pubaccount/readinjoy/proteus/utils/DynamicItemViewHelper:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   84: iconst_1
    //   85: aload_2
    //   86: iconst_0
    //   87: anewarray 4	java/lang/Object
    //   90: invokestatic 319	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   93: aload_1
    //   94: areturn
    //   95: astore_2
    //   96: aload_3
    ...
    //   0	103	0	this	DynamicItemViewHelper
  ...
  public TemplateBean a(BaseArticleInfo paramBaseArticleInfo)
  {
    if (QLog.isColorLevel()) {
      QLog.d(jdField_a_of_type_JavaLangString, 2, "getTemplateBean : " + paramBaseArticleInfo);
    }
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusFactoryBaseTemplateFactory == null) || (paramBaseArticleInfo == null)) {
    ...
    for (;;)
    {
      ...
      try
      {
        if ((paramBaseArticleInfo.mProteusTemplateBean != null) && (!((TemplateFactory)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusFactoryBaseTemplateFactory).a(paramBaseArticleInfo.mProteusTemplateBean))) {
        ...
        JSONObject localJSONObject = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusItemDynamicProteusItem.a(148, paramBaseArticleInfo);
        localTemplateBean = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusItemDynamicProteusItem.a(148, localJSONObject);
        try
        {
  ...
  public void a(ProteusItemView paramProteusItemView, int paramInt1, BaseArticleInfo paramBaseArticleInfo, VafContext paramVafContext, IFaceDecoder paramIFaceDecoder, ReadInJoyBaseAdapter paramReadInJoyBaseAdapter, IReadInJoyModel paramIReadInJoyModel, int paramInt2)
  {
    ...
    if (LogUtils.a()) {
      LogUtils.a(jdField_a_of_type_JavaLangString, "[bindData] " + paramBaseArticleInfo + " adapterViewType: " + paramInt1);
    }
    Object localObject1 = localObject2;
    if (localObject2 != null)
    {
      ...
      if (localTemplateBean != null)
      {
        ...
        if (!localTemplateBean.equals(localObject2))
        {
          ...
          if (localObject1 != null)
          {
            ((Container)localObject1).setBackgroundDrawable(paramVafContext.getContext().getResources().getDrawable(2130841884));
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusItemDynamicProteusItem.a(paramInt1, (Container)localObject2, paramIReadInJoyModel, paramInt2);
    TraceUtils.traceEnd();
    ProteusSupportUtil.a(paramInt1, paramProteusItemView, paramVafContext, paramIFaceDecoder, paramReadInJoyBaseAdapter, paramIReadInJoyModel, paramBaseArticleInfo);
    ...
    {
      ReadInJoyPTSCostHelper.a(paramBaseArticleInfo, paramProteusItemView, "DynamicPTS.bindData", l2 - l1);
      TraceUtils.traceEnd();
      return;
    }
  }
  ...
  public void a(VafContext paramVafContext)
  {
    ...
    if ((jdField_a_of_type_Int < j + 149) && (j > 0) && (jdField_a_of_type_Int < b))
    {
  ...
  {
    return (paramInt >= 148) && (paramInt < jdField_a_of_type_Int);
  }
  
  public String b(BaseArticleInfo paramBaseArticleInfo)
  {
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.proteus.utils.DynamicItemViewHelper
