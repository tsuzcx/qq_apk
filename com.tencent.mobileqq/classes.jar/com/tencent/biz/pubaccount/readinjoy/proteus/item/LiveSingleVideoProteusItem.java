  ...
  implements ProteusItem
{
  private void a(BaseArticleInfo paramBaseArticleInfo, JSONObject paramJSONObject)
  {
    ...
    for (str1 = str1 + "...";; str1 = paramBaseArticleInfo.mSubscribeName)
    {
      ...
      Util.c(paramJSONObject, paramBaseArticleInfo);
      return;
    }
  }
  ...
  private void b(BaseArticleInfo paramBaseArticleInfo, JSONObject paramJSONObject)
  {
    ...
    for (int i = 1; (i != 0) && (!Util.c(paramBaseArticleInfo)); i = 0)
    {
      paramJSONObject.put("user_desc_follow_text", ReadInJoyUtils.a(2131718469));
  ...
  public JSONObject a(int paramInt, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    ((ProteusItemDataBuilder)localObject).a(paramBaseArticleInfo).b(paramBaseArticleInfo).g(paramBaseArticleInfo).i(paramBaseArticleInfo);
    try
    {
      ((ProteusItemDataBuilder)localObject).a(paramBaseArticleInfo, Long.parseLong(paramBaseArticleInfo.mSubscribeID));
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.proteus.item.LiveSingleVideoProteusItem
