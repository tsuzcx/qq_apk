  ...
  public void a()
  {
    ...
    for (;;)
    {
      if (i == 1)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetTextView.setText(2131718405);
      }
      ...
      if ((f2 < j) && (f1 > k))
      {
        if (f1 / f2 > 4.0F)
        {
          ...
          this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
          this.jdField_a_of_type_AndroidWidgetTextView.setText(2131718406);
        }
        else
        {
          f2 *= k / f1;
      ...
      else if ((f2 > j) && (f1 < k))
      {
        if (f2 / f1 > 4.0F)
        {
          ...
          this.jdField_a_of_type_AndroidWidgetTextView.setText(2131718407);
          this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
        }
        else
        {
