...
public class PGCShortContentUtils
{
  ...
  public static void a(Context paramContext, ArticleInfo paramArticleInfo, boolean paramBoolean)
  {
    ...
    if (paramArticleInfo.isCardJumpUrlAvailable == 1)
    {
      ...
      RIJJumpUtils.a(paramContext, paramArticleInfo.getCardJumpUrl());
      return;
    }
    paramArticleInfo.clickJumpTarget = a(ReadInJoyConstants.e, "-1");
    RIJJumpUtils.a(paramContext, paramArticleInfo, paramBoolean);
  }
  ...
  public static boolean a(String paramString)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      return ViolaAccessHelper.b(ViolaAccessHelper.c(paramString));
    }
    return false;
  }
}
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.proteus.utils.PGCShortContentUtils
