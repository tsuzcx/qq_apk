...
{
  private void a(Context paramContext, BaseArticleInfo paramBaseArticleInfo, ReadInJoyBaseAdapter paramReadInJoyBaseAdapter)
  {
    if ((paramBaseArticleInfo != null) && (paramBaseArticleInfo.mVideoDownloadBarInfo != null) && (paramBaseArticleInfo.mVideoDownloadBarInfo.get() != null)) {
      VideoFeedsHelper.a(paramContext, UrlJumpInfo.a(paramBaseArticleInfo.mVideoDownloadBarInfo.msg_url_jump_info));
    }
    while ((paramReadInJoyBaseAdapter == null) || (paramBaseArticleInfo == null)) {
      return;
    }
    paramReadInJoyBaseAdapter.a(ReadInJoyBaseAdapter.a(paramBaseArticleInfo), paramBaseArticleInfo, false, false);
  }
  ...
  private void a(BaseArticleInfo paramBaseArticleInfo, boolean paramBoolean, JSONObject paramJSONObject)
  {
    ...
    for (int i = paramBaseArticleInfo.mVideoColumnInfo.a;; i = -1)
    {
      ...
      for (int j = 0;; j = 1)
      {
        paramJSONObject = new VideoR5.Builder(null, null, null, null).W(Integer.valueOf("1031").intValue()).i(paramBaseArticleInfo.getInnerUniqueID()).Z(j).q(paramJSONObject.optString("double_videocard_jump_page")).r(paramJSONObject.optString("double_videocard_jump_src")).s(paramBaseArticleInfo.mSubscribeName).a((int)paramBaseArticleInfo.mChannelID);
        j = k;
        if (ReadinjoyReportUtils.b() > 0) {
          j = 0;
        }
        paramBaseArticleInfo = paramJSONObject.ag(j).f(paramBaseArticleInfo);
        if (i != -1) {
          paramBaseArticleInfo.Y(i);
        }
        paramBaseArticleInfo = paramBaseArticleInfo.a().a();
        ((IPublicAccountReportUtils)QRoute.api(IPublicAccountReportUtils.class)).publicAccountReportClickEvent(null, null, "0X8007625", "0X8007625", 0, 0, "", "", "", paramBaseArticleInfo, false);
        ((IPublicAccountReportUtils)QRoute.api(IPublicAccountReportUtils.class)).publicAccountReportClickEvent(null, null, "0X800A5A9", "0X800A5A9", 0, 0, "", "", "", paramBaseArticleInfo, false);
        return;
      }
    }
  }
    ...
    catch (Exception localException1)
    {
      for (;;)
      {
        try
        {
          ...
          localObject1 = new JSONObject();
          ((JSONObject)localObject1).put("cover_image_url_1", RIJSmartCropUtils.a(paramBaseArticleInfo.mFirstPagePicUrl, ViewUtils.b(180.5F), ViewUtils.b(102.0F)));
          localJSONObject2.put("cover_image_1", localObject1);
          localJSONObject2.put("id_paly_wrapper_1", new JSONObject());
          localObject1 = new JSONObject();
          localObject2 = VideoFeedsHelper.a(paramBaseArticleInfo.mVideoDuration * 1000);
          ...
          ((JSONObject)localObject2).put("article_title_1_textsize", DoubleShortVideoFontSizeConfigHandler.a());
          ...
          localObject1 = new JSONObject();
          localObject2 = VideoFeedsHelper.d(paramBaseArticleInfo.mVideoCommentCount);
          if (!TextUtils.isEmpty((CharSequence)localObject2))
          {
            ((JSONObject)localObject1).put("comment_num_1", (String)localObject2 + HardCodeUtil.a(2131703465));
          ...
          localJSONObject2.put("id_container_1", localObject1);
          localObject1 = new JSONObject();
          ((JSONObject)localObject1).put("cover_image_url_2", RIJSmartCropUtils.a(localBaseArticleInfo.mFirstPagePicUrl, ViewUtils.b(180.5F), ViewUtils.b(102.0F)));
          localJSONObject2.put("cover_image_2", localObject1);
          localJSONObject2.put("id_play_wrapper_2", new JSONObject());
          localObject1 = new JSONObject();
          localObject2 = VideoFeedsHelper.a(localBaseArticleInfo.mVideoDuration * 1000);
          if (localObject2 != null)
          {
            localObject2 = ((StringBuilder)localObject2).toString();
            if (!TextUtils.isEmpty((CharSequence)localObject2))
          ...
          if (!ReadInJoyLogicEngine.a().a(localBaseArticleInfo.mArticleID)) {
            continue;
          }
          localObject1 = "#999999";
          ((JSONObject)localObject2).put("article_title_2_color", localObject1);
          ((JSONObject)localObject2).put("article_title_2_textsize", DoubleShortVideoFontSizeConfigHandler.a());
          ...
          localObject1 = new JSONObject();
          localObject2 = VideoFeedsHelper.d(localBaseArticleInfo.mVideoCommentCount);
          if (!TextUtils.isEmpty((CharSequence)localObject2))
          {
            ((JSONObject)localObject1).put("comment_num_2", (String)localObject2 + HardCodeUtil.a(2131703466));
  ...
  public void a(int paramInt1, Container paramContainer, IReadInJoyModel paramIReadInJoyModel, int paramInt2)
  {
    ...
    {
      return;
      a(paramContainer.findViewBaseByName("id_artilce_title_1"), paramIReadInJoyModel.a());
    } while ((paramIReadInJoyModel.a() == null) || (paramIReadInJoyModel.a().mSubArtilceList == null) || (paramIReadInJoyModel.a().mSubArtilceList.size() <= 0) || (paramIReadInJoyModel.a().mSubArtilceList.get(0) == null));
    a(paramContainer.findViewBaseByName("id_artilce_title_2"), (BaseArticleInfo)paramIReadInJoyModel.a().mSubArtilceList.get(0));
  }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.proteus.item.DoubleShortVideoProteusItem
