  ...
  implements AdapterView.OnItemClickListener
{
  ...
  private NativeShareView.ActionSheetItemAdapter.IconFactory jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeShareView$ActionSheetItemAdapter$IconFactory;
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeShareView$ActionSheetItemAdapter$IconFactory == null) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeShareView$ActionSheetItemAdapter$IconFactory = new NativeShareView.ActionSheetItemAdapter.IconFactory(paramViewGroup.getContext());
    }
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131560107, paramViewGroup, false);
    ...
    if (((ScreenShotFragment.ActionSheetItemViewHolder)localObject1).jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.firstLineCount > 0)
    {
      ...
      localObject2 = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeShareView$ActionSheetItemAdapter$IconFactory.a((Drawable)localObject2, i, j);
      if (!((ScreenShotFragment.ActionSheetItemViewHolder)localObject1).jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.enable) {
        break label538;
      }
      localObject3 = NativeShareView.ActionSheetItemAdapter.IconFactory.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeShareView$ActionSheetItemAdapter$IconFactory, (Drawable)localObject2);
      localObject2 = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeShareView$ActionSheetItemAdapter$IconFactory.a((Drawable)localObject2, (Drawable)localObject3);
    ...
    for (Object localObject1 = ((ScreenShotFragment.ActionSheetItemViewHolder)localObject1).jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.label;; localObject1 = "")
    {
      ...
      break label363;
      label538:
      localObject2 = NativeShareView.ActionSheetItemAdapter.IconFactory.b(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeShareView$ActionSheetItemAdapter$IconFactory, (Drawable)localObject2);
      ((ScreenShotFragment.ActionSheetItemViewHolder)localObject1).jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject2);
      break label445;
      label562:
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.proteus.view.impl.NativeShareView.ActionSheetItemAdapter
