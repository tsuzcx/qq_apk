  ...
  extends ReadInJoyEngineModule
{
  ...
  private oidb_cmd0xe16.ReqBody a(RIJBiuAndCommentRequestData paramRIJBiuAndCommentRequestData, ArticleInfo paramArticleInfo)
  {
    ...
    for (;;)
    {
      ...
      label235:
      paramArticleInfo = ReadInJoyCommentDataManager.a(paramArticleInfo);
  ...
  public void a(ArticleInfo paramArticleInfo, RIJBiuAndCommentRequestData paramRIJBiuAndCommentRequestData)
  {
    ...
    do
    {
      ...
      localToServiceMsg = ReadInJoyOidbHelper.a("OidbSvc.0xe16", 3606, 1, a(paramRIJBiuAndCommentRequestData, paramArticleInfo).toByteArray());
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.biuAndCommentMix.RIJBiuAndCommentMixPBModule
