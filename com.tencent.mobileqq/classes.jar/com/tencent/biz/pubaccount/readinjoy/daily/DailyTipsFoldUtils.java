...
public class DailyTipsFoldUtils
{
  ...
  {
    if ((paramBaseArticleInfo == null) || (!DailyModeConfigHandler.c((int)paramBaseArticleInfo.mChannelID))) {
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.daily.DailyTipsFoldUtils
