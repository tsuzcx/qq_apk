  ...
  implements VComponentAdapter
{
  ...
  {
    if ((paramImageAction == null) || (paramImageAction.getTarget() == null) || (paramURLDrawable == null) || (!NetworkUtil.g(paramImageAction.getTarget().getContext()))) {}
    do
    {
      return;
      ...
      if (paramString.contains("item_image_width"))
      {
        ...
        if ((!TextUtils.isEmpty((CharSequence)localObject1)) && (!TextUtils.isEmpty(str))) {
          try
          {
            ...
            localObject2 = ImageManager.a().a((ImageRequest)localObject1);
            if ((localObject2 != null) && (((CloseableBitmap)localObject2).a() != null))
            {
              localObject1 = null;
              if (paramBoolean)
              {
              ...
              paramImageAction.onSuccess(((CloseableBitmap)localObject2).a(), paramString, (Bundle)localObject1);
              return true;
            }
          }
  ...
  {
    PullRefreshHeader localPullRefreshHeader = (PullRefreshHeader)LayoutInflater.from(paramVRefreshLayout.getContext()).inflate(2131562889, paramVRefreshLayout, false);
    RefreshAnimView localRefreshAnimView = (RefreshAnimView)localPullRefreshHeader.findViewById(2131376845);
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.viola.adapter.ui.ComponentAdapter
