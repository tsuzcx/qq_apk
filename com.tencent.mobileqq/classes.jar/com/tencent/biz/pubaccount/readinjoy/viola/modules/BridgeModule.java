...
public class BridgeModule
  extends BaseModule
  implements aaea, Destroyable, IActivityState, rmb
{
  ...
  private tyj bridgeInvokeHandler = new tyj(this);
  private Map<Long, String> columnToUploadCallbackMap = new HashMap();
  private String commentCallbaclId;
  private owx dataManager;
  private tvm mActionSheetHelper;
  private tzo mBridgeApiHelper;
  private String mCallBack;
  private aady mClient;
  private ubq mCommentManager;
  private int mCommentSeq;
  private DownloadListener mDownloadListener;
  private txk mEventHelper;
  private Map<String, Object> mObjectMap = new ArrayMap();
  private SparseArray<twr> mResultActionMap = new SparseArray();
  protected ShareActionSheetBuilder mShareActionSheet;
  public uuw mShareHelper;
  public txn mShareUtils = new txn();
  ...
  public rmn rijWatchWordPresenter;
  ...
  private san videoPublishCallback = new tvt(this);
  private sas violaVideoUpdateController;
  
  public BridgeModule()
  {
    this.mObjectMap.put("predownload", this.mVideoPreDownloadMgr);
    this.rijWatchWordPresenter = new rmn(new rmj());
  ...
  {
    tzr.a(paramJSONObject, paramInt);
  }
  ...
  {
    twu.a(this, paramInt1, paramInt2, paramIntent);
  }
  
  private AnchorData createAnchorData(JSONObject paramJSONObject)
  {
    return tzr.a(paramJSONObject);
  }
  ...
  {
    twu.b(this, paramInt, paramIntent);
  }
  ...
  private void dealForwardResult(int paramInt, Intent paramIntent)
  {
    ...
    if (paramInt == -1)
    {
      ...
      {
        ForwardUtils.handleForwardData((QQAppInterface)pkh.a(), getViolaInstance().getActivity(), getViolaInstance().getActivity(), paramIntent, null);
        ...
        do
        {
          do
          {
            try
            {
              ...
              paramIntent.put("msg", anvx.a(2131700688));
  ...
  private void doPostShowComment(FragmentActivity paramFragmentActivity, VVideoView paramVVideoView, View paramView, ViewGroup paramViewGroup, JSONObject paramJSONObject)
  {
    ...
    {
      this.mCommentManager = new ubq(paramFragmentActivity, paramFragmentActivity.getSupportFragmentManager(), i, paramViewGroup);
      ...
      this.mCommentManager.a(new tvs(this));
  ...
  private void ensureEventHelper()
  {
    if (this.mEventHelper == null) {
      this.mEventHelper = new txk(this);
    }
  }
  ...
  {
    tzr.a(this, paramQQAppInterface, paramLong, paramString);
  }
    ...
    do
    {
      for (;;)
      {
        ...
        catch (JSONException localJSONException)
        {
          ...
          localObject1 = new twe(this, (JSONObject)localObject1, str2, (String)localObject2);
          ...
          if ((paramIntent instanceof FirstCommentCreateData))
          {
            ...
            for (;;)
            {
              ((pgv)localObject2).a(paramIntent, (pgx)localObject1, str1, i, false, bool1);
              return;
              bool1 = false;
            }
          }
  ...
  private void handleCommentEditorResult(int paramInt, Intent paramIntent)
  {
    ...
    if (paramInt == 1699)
    {
      ...
      this.dataManager = new owx();
      UiApiPlugin.a(paramIntent, this.dataManager, str, new twd(this));
      return;
    }
  ...
  {
    this.mResultActionMap.put(114, new twl(this));
    this.mResultActionMap.put(115, new twl(this));
    this.mResultActionMap.put(116, new twl(this));
    this.mResultActionMap.put(122, new twl(this));
    this.mResultActionMap.put(113, new twg(this));
    this.mResultActionMap.put(119, new two(this));
    this.mResultActionMap.put(118, new twt(this));
    this.mResultActionMap.put(121, new twt(this));
    this.mResultActionMap.put(117, new twj(this));
    this.mResultActionMap.put(126, new twk(this));
    this.mResultActionMap.put(21, new twn(this));
    this.mResultActionMap.put(123, new twp(this));
    this.mResultActionMap.put(124, new twf(this));
    this.mResultActionMap.put(101, new twq(this));
    this.mResultActionMap.put(125, new tws(this));
  }
  ...
  {
    tzr.a(this, paramLong, paramList, paramString1, paramInt, paramString2, paramBoolean);
  }
  ...
  public void adFreshAddAdId(JSONObject paramJSONObject, String paramString)
  {
    try
    {
      odz.a().a(paramJSONObject.optString("scene"), Long.valueOf(paramJSONObject.optLong("adId")));
  ...
  public void adFreshFlushSceneAds(JSONObject paramJSONObject, String paramString)
  {
    try
    {
      odz.a().a(paramJSONObject.optString("scene"));
      invokeCallJS(paramString, new JSONObject());
      return;
    }
    catch (Throwable paramJSONObject)
  ...
  public void adFreshGetExposeRate(String paramString)
  {
    ...
    {
      JSONObject localJSONObject = new JSONObject();
      localJSONObject.put("value", odz.a().a());
  ...
  public void adFreshRemoveAdId(JSONObject paramJSONObject, String paramString)
  {
    try
    {
      odz.a().a(Long.valueOf(paramJSONObject.optLong("adId")));
      invokeCallJS(paramString, new JSONObject());
      return;
    }
    catch (Throwable paramJSONObject)
  ...
  {
    twu.B(this, paramJSONObject, paramString);
  }
  
  @JSMethod
  public void c2sReport(JSONObject paramJSONObject)
  {
    twu.g(paramJSONObject);
  }
  ...
  {
    twu.q(this, paramJSONObject, paramString);
  }
  ...
  {
    tzr.b(this, paramJSONObject, paramString);
  }
  ...
  {
    paramString1 = bjkp.a("QQ_" + pkh.a() + "_" + paramString1).toLowerCase();
  ...
  {
    tzr.e(this, paramJSONObject, paramString);
  }
  ...
  public void destroy()
  {
    ...
    if (localQQAppInterface != null) {
      sad.a(localQQAppInterface).b(this.videoPublishCallback);
    }
    if (QLog.isColorLevel()) {
  ...
  {
    twu.w(this, paramJSONObject, paramString);
  }
  ...
  public void doSelectAndUploadAvatar(JSONObject paramJSONObject, String paramString)
  {
    ...
    twu.a(paramJSONObject, paramString, getViolaInstance().getActivity());
  }
  
  public void doUploadTopicPic(JSONObject paramJSONObject, String paramString)
  {
    this.mUploadCallBack = paramString;
    twu.b(paramJSONObject, paramString, getViolaInstance().getActivity());
  }
  ...
  public void downloadApk(JSONObject paramJSONObject, String paramString)
  {
    if ((paramJSONObject != null) && (!TextUtils.isEmpty(paramJSONObject.optString("apkUrl"))))
    {
      ...
      if (this.mDownloadListener == null) {
        this.mDownloadListener = new twm(this, str, paramString);
      }
      bjjq.a().a(this.mDownloadListener);
      localDownloadInfo.a();
  ...
  {
    twu.a(this, paramString, paramJSONObject, paramBoolean);
  }
  
  public void getGdtInfo(String paramString)
  {
    twu.l(this, paramString);
  }
  
  @JSMethod
  public void getMotiveAd(String paramString, JSONObject paramJSONObject)
  {
    twu.a(this, paramString, paramJSONObject);
  }
  ...
  {
    twu.c(this, paramString, paramBoolean);
  }
  ...
  {
    tzr.a(this, paramJSONObject, paramString, paramInt);
  }
  
  public void getRecommendFlag(String paramString)
  {
    twu.m(this, paramString);
  }
  ...
  public void getUploadingVideoInfo(JSONObject paramJSONObject, String paramString)
  {
    ...
    paramJSONObject = pnn.a();
    if (paramJSONObject != null) {
      sad.a(paramJSONObject).a(this.videoPublishCallback);
    }
    if (this.violaVideoUpdateController == null) {
      this.violaVideoUpdateController = new sas(new BridgeModule.12(this, i, paramString), 500L);
    }
  ...
  public void handleClick(JSONObject paramJSONObject)
  {
    ...
    try
    {
      acho.b(TAG, paramJSONObject.toString());
      ...
      paramJSONObject = (qq_ad_get.QQAdGetRsp.AdInfo)achn.a(new qq_ad_get.QQAdGetRsp.AdInfo(), paramJSONObject.getJSONObject("adInfo"));
    ...
    {
      acho.d(TAG, "handleJsCallRequest error", paramJSONObject);
    }
  }
  ...
  {
    twu.a(this, paramString1, paramString2, paramBoolean);
  }
  
  public void hasRedPacketSharePermission(String paramString)
  {
    twu.b(this, paramString);
  }
  ...
  public void invoke(JSONObject paramJSONObject, String paramString)
  {
    ...
    {
      invokeErrorCallJS(paramString, anvx.a(2131700699));
    ...
    for (String str1 = paramJSONObject.toString();; str1 = " null ")
    {
      ...
      invokeErrorCallJS(paramString, "ns:" + str2 + anvx.a(2131700695) + str3 + anvx.a(2131700690));
      return;
    }
  }
  ...
  public void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    twr localtwr = (twr)this.mResultActionMap.get(paramInt1);
    if (localtwr != null) {
      localtwr.a(paramInt1, paramInt2, paramIntent);
    }
  }
  ...
  public void openAddVideoView(JSONObject paramJSONObject, String paramString)
  {
    ...
    rth.a(BaseActivity.sTopActivity, paramJSONObject, j, paramString, 124);
  }
  ...
  {
    twu.a(this, paramString1, paramString2, paramString3);
  }
  
  @JSMethod
  public void openCreateTopicView(String paramString)
  {
    rth.a(BaseActivity.sTopActivity, paramString, 123);
  }
  ...
  public void openEditTopicView(JSONObject paramJSONObject, String paramString)
  {
    ...
    rth.a(BaseActivity.sTopActivity, i, str1, str2, str3, j, paramString, 123);
  }
  ...
  public void openLevelDialog(JSONObject paramJSONObject, String paramString)
  {
    ...
    pqx.a((Context)localObject, paramJSONObject, new tvr(this, paramString));
  }
  
  @JSMethod
  public void openMiniApp(String paramString, JSONObject paramJSONObject)
  {
    twu.b(this, paramString, paramJSONObject);
  }
  
  public void openPage(JSONObject paramJSONObject, String paramString)
  {
    twu.c(paramJSONObject, paramString);
  }
  
  public void openPrivateLetter()
  {
    twu.a(getViolaInstance().getContext());
  }
  ...
  {
    if ((getViolaInstance() != null) && ((getViolaInstance().getFragment() instanceof ViolaFragment))) {
      ((ViolaFragment)getViolaInstance().getFragment()).setViolaGestureLayoutListener(new tvy(this, paramString));
    }
  }
  ...
  public void preLoadAfterAdLoaded(String paramString, JSONObject paramJSONObject)
  {
    try
    {
      acho.a(TAG, paramJSONObject.toString());
      paramJSONObject = new GdtAd((qq_ad_get.QQAdGetRsp.AdInfo)achn.a(new qq_ad_get.QQAdGetRsp.AdInfo(), paramJSONObject.getJSONObject("adInfo")));
    ...
    {
      acho.d(TAG, "handleJsCallRequest", paramJSONObject);
  ...
  {
    twu.a(this, paramString1, paramString2, paramInt1, paramInt2, paramInt3, paramBoolean, paramInt4, paramString3, paramString4, paramString5);
  }
  
  public void requestRedPacketContentShareToast(String paramString)
  {
    twu.c(this, paramString);
  }
  ...
  {
    tzr.c(this, paramJSONObject, paramString);
  }
  
  public void saveImage(JSONObject paramJSONObject, String paramString)
  {
    twu.y(this, paramJSONObject, paramString);
  }
  ...
  public void savePlayPosition(JSONObject paramJSONObject)
  {
    ...
    if (paramJSONObject != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        sqb.a.a(str, paramJSONObject.optLong(str));
      }
    }
  }
  ...
  {
    twu.b(paramJSONObject, paramString);
  }
  ...
  public void sendRequest(JSONObject paramJSONObject, String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject1 = new NewIntent(localQQAppInterface.getApplication(), nta.class);
        ...
        ((NewIntent)localObject1).setObserver(new twc(this, paramString));
        if (localQQAppInterface == null) {
          break;
        }
  ...
  {
    twu.r(this, paramJSONObject, paramString);
  }
  ...
  {
    twu.a(this, paramJSONObject, paramString, paramFragment);
  }
  ...
  {
    twu.s(this, paramJSONObject, paramString);
  }
  ...
  public void shareVideoWithFriend(JSONObject paramJSONObject, String paramString)
  {
    ...
    smg.a(paramString, getViolaInstance().getActivity(), 1, this.shareToFriendUin, this.shareToFriendUinType, this.shareToFriendUinName);
  }
  
  public void showActionSheet(JSONObject paramJSONObject, String paramString)
  {
    if (this.mActionSheetHelper == null) {
      this.mActionSheetHelper = new tvm(this);
    }
  ...
  public void showShareMenu(JSONObject paramJSONObject, @NonNull String paramString)
  {
    ...
    String str = paramJSONObject.optString("menu_title", anvx.a(2131700689));
    ...
    this.mShareHelper = new uuw((Activity)localObject, localAppInterface, new txq(false, null, null, localJSONObject, new WeakReference(localObject), paramString, this));
    this.mShareHelper.a().setActionSheetTitle(str);
    int i = paramJSONObject.optInt("report_from");
    this.mShareHelper.a(txn.a(bool, localHashSet), i);
  }
  ...
  public void showShareReadInJoyMenu(JSONObject paramJSONObject, String paramString, Fragment paramFragment)
  {
    ...
    label167:
    for (localObject2 = uuw.c();; localObject2 = uuw.a((JSONArray)localObject2, paramJSONObject))
    {
      localArrayList1 = new ArrayList();
      localObject3 = ((List)localObject1).iterator();
      while (((Iterator)localObject3).hasNext()) {
        localArrayList1.add(Integer.valueOf(((urb)((Iterator)localObject3).next()).jdField_a_of_type_Int));
      }
      localObject1 = uuw.a((JSONArray)localObject1, paramJSONObject);
      break;
    }
    ArrayList localArrayList2 = new ArrayList();
    Object localObject3 = ((List)localObject2).iterator();
    while (((Iterator)localObject3).hasNext()) {
      localArrayList2.add(Integer.valueOf(((urb)((Iterator)localObject3).next()).jdField_a_of_type_Int));
    }
    String str3;
    String str1;
    ...
    try
    {
      if (!TextUtils.isEmpty(str1)) {
        localObject3 = pkf.a(String.format(str1, new Object[] { paramJSONObject.optString("share_url") }), "\\n", '\n');
      }
    ...
    this.mShareHelper = new uuw(paramFragment, localAppInterface, new txq(true, (List)localObject1, (List)localObject2, paramJSONObject, new WeakReference(paramFragment), paramString, this));
    ...
    this.mShareHelper.a().setCancelListener(new twa(this, j, paramFragment, (String)localObject1, i, (String)localObject2, (String)localObject3, paramJSONObject));
    this.mShareHelper.a().setOnDismissListener(new twb(this, paramString));
  }
  ...
  public void startVideoPreDownload(JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      while (i < paramJSONObject.length())
      {
        ...
        localArrayList.add(new spw(localJSONObject.optString("videoVid"), localJSONObject.optString("articleID"), localJSONObject.optInt("busitype"), localJSONObject.optInt("duration")));
        i += 1;
      }
      return;
    }
    catch (JSONException paramJSONObject)
    {
      ...
      if ((this.mVideoPreDownloadMgr != null) && (getViolaInstance() != null) && (getViolaInstance().getActivity() != null))
      {
        ...
        this.mVideoPreDownloadMgr.a = new spx(spx.d, spx.f);
        this.mVideoPreDownloadMgr.a(new tvq(this, localArrayList));
  ...
  {
    prh.a(paramJSONObject.optString("selectedGradeList", ""));
  ...
  public void vaNetworkChange(String paramString)
  {
    ...
    this.netInfoHandler = new tvx(this, paramString);
  ...
  public void videoPlayFeedback(JSONObject paramJSONObject, String paramString)
  {
    ...
    for (;;)
    {
      sug.a((Activity)localObject, paramJSONObject);
