...
public final class AppBridgeInvokeHandler$register$3
  extends Lambda
  implements Function2<JSONObject, String, Unit>
{
  public AppBridgeInvokeHandler$register$3(tyh paramtyh)
  {
    super(2);
  }
  ...
  public final void invoke(@Nullable JSONObject paramJSONObject, @Nullable String paramString)
  {
    ...
    for (paramJSONObject = paramJSONObject.optString("identifier");; paramJSONObject = null)
    {
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.viola.modules.bridge.AppBridgeInvokeHandler.register.3
