  ...
  extends AbsBridgeInvokeHandler
{
  ...
  private final void a(JSONObject paramJSONObject, String paramString)
  {
    if (paramJSONObject != null)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.e("BridgeModule", 2, "nowlive openRoom  roomid = " + paramString);
      }
      ...
      if ((paramString instanceof QQAppInterface))
      {
        ...
        ((DynamicNowManager)paramString).a(paramJSONObject);
      }
    }
  }
  ...
  public void a()
  {
    a("openRoom", (Function2)new NowLiveBridgeInvokeHandler.register.1((NowLiveBridgeInvokeHandler)this));
    a("preload", (Function2)new NowLiveBridgeInvokeHandler.register.2((NowLiveBridgeInvokeHandler)this));
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes4.jar
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.viola.modules.bridge.NowLiveBridgeInvokeHandler
