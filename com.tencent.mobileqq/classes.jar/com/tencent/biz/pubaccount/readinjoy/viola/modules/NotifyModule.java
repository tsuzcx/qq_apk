...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/biz/pubaccount/readinjoy/viola/modules/NotifyModule;", "Lcom/tencent/viola/module/BaseModule;", "Lcom/tencent/viola/commons/Destroyable;", "Lcom/tencent/biz/richframework/eventbus/SimpleEventReceiver;", "Lcom/tencent/biz/pubaccount/readinjoy/viola/event/ViolaEvent;", "()V", "toViolaEventMap", "", "", "addNotify", "", "eventName", "callback", "destroy", "getEventClass", "Ljava/util/ArrayList;", "Ljava/lang/Class;", "invokeJS", "result", "Lorg/json/JSONObject;", "onReceiveEvent", "event", "Lcom/tencent/biz/richframework/eventbus/SimpleBaseEvent;", "postNotify", "data", "Companion", "AQQLiteApp_release"}, k=1, mv={1, 1, 16})
  ...
  implements SimpleEventReceiver<ViolaEvent>, Destroyable
{
  ...
  public void onReceiveEvent(@Nullable SimpleBaseEvent paramSimpleBaseEvent)
  {
    ...
    {
      String str = (String)this.toViolaEventMap.get(((ViolaEvent)paramSimpleBaseEvent).eventName);
      if (str != null) {
        invokeJS(str, ((ViolaEvent)paramSimpleBaseEvent).data);
      }
    }
  }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.viola.modules.NotifyModule
