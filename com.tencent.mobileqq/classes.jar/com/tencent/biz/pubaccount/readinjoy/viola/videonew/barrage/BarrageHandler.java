    ...
    try
    {
      ...
      if (paramSessionParams != null)
      {
        if (!TextUtils.isEmpty(paramSessionParams.jdField_a_of_type_JavaLangString)) {
          localReqBody.bytes_cookie.set(ByteStringMicro.copyFromUtf8(paramSessionParams.jdField_a_of_type_JavaLangString));
        }
        if (!TextUtils.isEmpty(paramSessionParams.b)) {
          localReqBody.bytes_common_data.set(ByteStringMicro.copyFromUtf8(paramSessionParams.b));
        }
      }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.viola.videonew.barrage.BarrageHandler
