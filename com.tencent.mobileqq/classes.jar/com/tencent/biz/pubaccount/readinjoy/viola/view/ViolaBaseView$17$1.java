...
public class ViolaBaseView$17$1
  implements Runnable
{
  public ViolaBaseView$17$1(sqz paramsqz, String paramString) {}
  
  public void run()
  {
    String str2 = ViolaBaseView.a();
    StringBuilder localStringBuilder = new StringBuilder().append("loadJSSource process from downJsFromOfflineForNext url: ").append(this.jdField_a_of_type_Sqz.a.jdField_a_of_type_JavaLangString).append(" , js source Md5 :");
