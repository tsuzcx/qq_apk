...
{
  QShareUtils$4(QShareUtils paramQShareUtils, Intent paramIntent, Activity paramActivity) {}
  
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    QShareUtils.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaModulesQShareUtils).dismiss();
    if (paramBoolean) {}
    for (;;)
    {
      try
      ...
      catch (Exception paramBundle)
      {
        ...
        QLog.d(QShareUtils.a, 2, paramBundle.getMessage());
        continue;
      ...
      if (QLog.isColorLevel()) {
        QLog.d(QShareUtils.a, 2, "build struct msg fail");
      }
      return;
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.viola.modules.QShareUtils.4
