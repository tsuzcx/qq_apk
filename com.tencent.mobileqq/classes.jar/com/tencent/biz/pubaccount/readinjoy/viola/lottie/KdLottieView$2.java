  ...
  public void onHttpFinish(HttpResponse paramHttpResponse)
  {
    ...
    try
    {
      if (paramHttpResponse.originalData != null)
      {
        ...
        bool1 = true;
        LottieComposition.Factory.fromJson(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaLottieKdLottieView.getContext().getResources(), paramHttpResponse, new KdLottieView.2.1(this));
      }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.viola.lottie.KdLottieView.2
