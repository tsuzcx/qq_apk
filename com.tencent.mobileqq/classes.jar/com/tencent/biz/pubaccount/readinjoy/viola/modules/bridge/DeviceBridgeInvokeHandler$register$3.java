...
final class DeviceBridgeInvokeHandler$register$3
  extends Lambda
  implements Function2<JSONObject, String, Unit>
{
  DeviceBridgeInvokeHandler$register$3(DeviceBridgeInvokeHandler paramDeviceBridgeInvokeHandler)
  {
    super(2);
  }
  ...
  {
    this.this$0.a().getNetType(paramString, true);
  }
}
