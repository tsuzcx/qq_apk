...
public final class BridgeInvokeHandler
{
  ...
  public final boolean a(@NotNull String paramString1, @NotNull String paramString2, @NotNull JSONObject paramJSONObject, @Nullable String paramString3)
  {
    ...
    for (;;)
    {
      ...
      AbsBridgeInvokeHandler localAbsBridgeInvokeHandler;
      do
      {
        if (!localIterator.hasNext()) {
          break;
        }
        localAbsBridgeInvokeHandler = (AbsBridgeInvokeHandler)localIterator.next();
      } while (!localAbsBridgeInvokeHandler.a(paramString1));
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.viola.modules.bridge.BridgeInvokeHandler
