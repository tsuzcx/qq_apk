...
import com.tencent.biz.pubaccount.readinjoy.model.ArticleInfoModule.LoadMorePreDealListener;
  ...
  implements ArticleInfoModule.LoadMorePreDealListener
{
  ...
  {
    if ((!DailyModeConfigHandler.c(paramInt)) || (paramList2 == null) || (paramList1 == null) || (paramList2.isEmpty())) {
      return null;
    }
    long l = a(paramList2);
    if (l < 1000L)
    ...
    ReadInJoyHelper.a(ReadInJoyDailyViewController.a(), Boolean.valueOf(true));
    ReadInJoyDailyViewController.a(true);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelArticleInfoModule.a(null);
    return paramList2;
  }
}
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.ReadInJoyDailyViewController.2
