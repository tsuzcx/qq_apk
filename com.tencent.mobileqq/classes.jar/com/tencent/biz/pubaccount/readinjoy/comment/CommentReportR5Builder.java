...
public class CommentReportR5Builder
{
  ...
  public CommentReportR5Builder(CommentViewItem paramCommentViewItem)
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo = paramCommentViewItem.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo;
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData = paramCommentViewItem.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData;
    this.jdField_a_of_type_Int = paramCommentViewItem.b;
  }
  
  public CommentReportR5Builder(ArticleInfo paramArticleInfo, BaseCommentData paramBaseCommentData)
  {
  ...
  private int a()
  {
    ...
    return this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData.contentSrc;
  }
  ...
  private CommentReportR5Builder l()
  {
    ...
    {
      localReadInJoyCommentDataManager = ReadInJoyCommentDataManager.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo);
    ...
    for (;;)
    {
      this.jdField_a_of_type_Int = localReadInJoyCommentDataManager.a(str);
      try
      {
  ...
  public CommentReportR5Builder b()
  {
    try
    {
      ...
      if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData.isAuthorReply()) {
        localStringBuilder.append(1).append(",");
      }
      if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData.isAuthorLike) {
        localStringBuilder.append(2).append(",");
      }
      if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData.isFollowing) {
        localStringBuilder.append(3).append(",");
      }
      if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData.isAuthorSticky) {
  ...
  public CommentReportR5Builder b(int paramInt)
  {
    try
    {
      ...
      if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData == null) {}
      for (paramInt = 0;; paramInt = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData.commentApp)
      {
  ...
  public CommentReportR5Builder g()
  {
    try
    {
      this.jdField_a_of_type_OrgJsonJSONObject.put("fromuin", ReadInJoyUtils.a());
      return this;
    }
    catch (JSONException localJSONException)
    {
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.comment.CommentReportR5Builder
