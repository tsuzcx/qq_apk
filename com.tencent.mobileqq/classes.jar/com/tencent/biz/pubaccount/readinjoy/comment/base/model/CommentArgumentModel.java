package com.tencent.biz.pubaccount.readinjoy.comment.base.model;
...
public class CommentArgumentModel
{
  ...
  private TkdQQArticleInfo a()
  {
    ...
    localTkdQQArticleInfo.toUin = ReadInJoyCommentUtils.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo);
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_ComTencentTkdCommentPublisherQqModelTkdQQArgument.innerUniqueID = a();
    this.jdField_a_of_type_ComTencentTkdCommentPublisherQqModelTkdQQArgument.commentId = b();
    this.jdField_a_of_type_ComTencentTkdCommentPublisherQqModelTkdQQArgument.firstCommentId = c();
    ...
    this.jdField_a_of_type_ComTencentTkdCommentPublisherQqModelTkdQQArgument.defaultInput = d();
    this.jdField_a_of_type_ComTencentTkdCommentPublisherQqModelTkdQQArgument.recreateDraft = this.jdField_g_of_type_JavaLangString;
  ...
  private void b()
  {
    ...
    this.jdField_g_of_type_JavaLangString = this.jdField_a_of_type_AndroidContentIntent.getStringExtra("comment_recreate_draft");
    a(localBundle);
    e(localBundle);
    ...
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo != null)
    {
      ...
      if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mSocialFeedInfo != null) {
        if ((RIJItemViewType.f(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo)) || (!ArticleInfoHelper.b(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo)))
        {
          bool2 = bool3;
  ...
  private String d()
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo != null)
    {
      ...
      if (localReadInJoyCommentDataManager != null) {
        str1 = localReadInJoyCommentDataManager.a();
      }
    }
    return str1;
  }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.comment.base.model.CommentArgumentModel
