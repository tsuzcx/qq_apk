...
public class ReadInJoyCommentHelper
{
  ...
  {
    long l = ((Long)ReadInJoyHelper.a("family_comment_card_hide_timestamp", Long.valueOf(-1L))).longValue();
    if (l == -1L)
    {
  ...
  public ReadInJoyCommentListFragment a(String paramString, ReadInJoyCommentListFragment.OnCreateViewListener paramOnCreateViewListener, ReadInJoyCommentItemHeightHelper.OnScrollYOffsetListener paramOnScrollYOffsetListener)
  {
    ...
    try
    {
      ...
      localReadInJoyCommentListFragment.a(paramOnCreateViewListener);
      localReadInJoyCommentListFragment.a(paramOnScrollYOffsetListener);
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.comment.ReadInJoyCommentHelper
