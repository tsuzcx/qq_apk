...
import com.tencent.biz.pubaccount.readinjoy.comment.ui.ExposeReplyCommentView;
...
public final class CommentProteusListenerUtil$Companion$initExposeCommentClickListener$1
  implements CommentProteusListenerUtil.CommentProteusOnClickListener
{
  public void a(int paramInt, @NotNull Container paramContainer, @NotNull ReadinjoyCommentListBaseAdapter paramReadinjoyCommentListBaseAdapter, @NotNull CommentViewItem paramCommentViewItem, @NotNull ViewBase paramViewBase)
  {
    ...
    if (((paramViewBase instanceof ExposeReplyCommentView)) && ((paramReadinjoyCommentListBaseAdapter instanceof ReadInJoyCommentListAdapter))) {
      ((ExposeReplyCommentView)paramViewBase).a((ReadInJoyCommentListAdapter)paramReadinjoyCommentListBaseAdapter);
    }
  }
}
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.comment.CommentProteusListenerUtil.Companion.initExposeCommentClickListener.1
