...
public final class CommentProteusListenerUtil$Companion$initExposeSubCommentTwoClickListener$1
  implements CommentProteusListenerUtil.CommentProteusOnClickListener
{
  public void a(int paramInt, @NotNull Container paramContainer, @NotNull ReadinjoyCommentListBaseAdapter paramReadinjoyCommentListBaseAdapter, @NotNull CommentViewItem paramCommentViewItem, @NotNull ViewBase paramViewBase)
  {
    ...
    paramViewBase.setOnClickListener((ViewBase.OnClickListener)new CommentProteusListenerUtil.Companion.initExposeSubCommentTwoClickListener.1.configClickListener.1(paramReadinjoyCommentListBaseAdapter, paramCommentViewItem));
    paramCommentViewItem = paramViewBase.findViewBaseByName("id_comment_expose_subcomment_two");
    if ((paramCommentViewItem instanceof CommentContentView)) {
      ((CommentContentView)paramCommentViewItem).a(paramReadinjoyCommentListBaseAdapter, (View)paramContainer, 1);
    }
  }
}
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.comment.CommentProteusListenerUtil.Companion.initExposeSubCommentTwoClickListener.1
