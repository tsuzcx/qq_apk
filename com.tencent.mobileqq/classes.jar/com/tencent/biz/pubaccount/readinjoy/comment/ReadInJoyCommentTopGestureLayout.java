  ...
  implements View.OnTouchListener
{
  ...
  private void a()
  {
    ...
    if (j > 200)
    {
      ...
      localObject = this.jdField_a_of_type_Ohh;
      if (this.jdField_a_of_type_Boolean) {}
      for (int i = 1;; i = 2)
      {
        ((ohh)localObject).a(i, j);
        return;
      }
    }
    a(0, 0, 200);
  ...
  public void setFirstLevelCommentContainer(ohh paramohh, boolean paramBoolean)
  {
