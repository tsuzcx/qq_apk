...
public final class CreateSubCommentHandler$send0xd1eRequest$1
  extends ProtoUtils.TroopProtocolObserver
{
  public void a(int paramInt, @Nullable byte[] paramArrayOfByte, @Nullable Bundle paramBundle)
  {
    ...
    this.a.a(CreateSubCommentHandler.a(this.a, paramArrayOfByte), paramInt, "Empty error message.");
  }
  
  public boolean a(int paramInt, @Nullable String paramString, @Nullable Bundle paramBundle)
  {
    paramBundle = this.a;
    oidb_0xd1e.SubCommentCreateRsp localSubCommentCreateRsp = CreateSubCommentHandler.a(this.a, null);
    if (paramString != null) {}
    for (;;)
    {
      paramBundle.a(localSubCommentCreateRsp, paramInt, paramString);
      return true;
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.comment.handler.CreateSubCommentHandler.send0xd1eRequest.1
