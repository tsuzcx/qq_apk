...
class QQViewBridgeImpl$LinkUi
  implements CommentLinkView.OnLinkDeleteListener, SimpleEventReceiver
{
  @Deprecated
  ...
  private void a(Context paramContext)
  {
    ...
    int j = QQViewBridgeImpl.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentBaseBridgeimplQQViewBridgeImpl).g;
    if (this.jdField_a_of_type_JavaUtilList == null) {}
    for (int i = 0;; i = this.jdField_a_of_type_JavaUtilList.size())
    {
      RIJJumpUtils.a(paramContext, "https://viola.qq.com/js/commLinkSelector.js?_rij_violaUrl=1&v_tid=6&v_bundleName=commLinkSelector&hideNav=1&v_nav_immer=1&v_bid=3740&remainLinkCount=" + (j - i), localBundle);
      return;
    }
  }
  ...
  private void b(BaseCommentData.CommentLinkData paramCommentLinkData)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilList == null) {
      this.jdField_a_of_type_JavaUtilList = new ArrayList(QQViewBridgeImpl.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentBaseBridgeimplQQViewBridgeImpl).g);
    }
    ...
    QQViewBridgeImpl.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentBaseBridgeimplQQViewBridgeImpl).onAddLink(localTkdCommentLinkData);
  }
  ...
  void b()
  {
    Object localObject = QQViewBridgeImpl.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentBaseBridgeimplQQViewBridgeImpl).getCommentLinkData();
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.comment.base.bridgeimpl.QQViewBridgeImpl.LinkUi
