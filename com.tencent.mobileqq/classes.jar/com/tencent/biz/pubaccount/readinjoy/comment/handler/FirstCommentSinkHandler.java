...
{
  public static final FirstCommentSinkHandler.Companion a;
  @NotNull
  ...
  static
  {
    jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentHandlerFirstCommentSinkHandler$Companion = new FirstCommentSinkHandler.Companion(null);
  }
  ...
  private final oidb_0xd1e.ReqBody a()
  {
    ...
    localFirstCommentAuthorTopSetReq.article_id.set(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentHandlerBeanFirstCommentSinkData.c());
    ...
    localFirstCommentAuthorTopSetReq.op_type.set(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentHandlerBeanFirstCommentSinkData.a());
    localFirstCommentAuthorTopSetReq.content_src.set(ReadInJoyCommentHelper.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentHandlerBeanFirstCommentSinkData.d()));
    localFirstCommentAuthorTopSetReq.src.set(0);
    localFirstCommentAuthorTopSetReq.business_info.set(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentHandlerBeanFirstCommentSinkData.e());
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.comment.handler.FirstCommentSinkHandler
