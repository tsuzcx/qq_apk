...
{
  RIJCommentBubbleView$clickStickyButton$1(RIJCommentBubbleView paramRIJCommentBubbleView, Ref.ObjectRef paramObjectRef, Ref.BooleanRef paramBooleanRef, ActionSheet paramActionSheet) {}
  ...
  public final void OnClick(View paramView, int paramInt)
  {
    ...
    {
      localReadInJoyCommentDataManager.c(paramView, this.jdField_a_of_type_KotlinJvmInternalRef$BooleanRef.element);
      RIJCommentBubbleView.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentUiRIJCommentBubbleView, 6);
      break;
    }
  }
}
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.comment.ui.RIJCommentBubbleView.clickStickyButton.1
