...
{
  private CommentLinkView.LinkAdatper jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentUiCommentLinkView$LinkAdatper;
  @Nullable
  private CommentLinkView.OnLinkDeleteListener jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentUiCommentLinkView$OnLinkDeleteListener;
  ...
  {
    return this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentUiCommentLinkView$OnLinkDeleteListener;
  }
  ...
  public final void setData(@Nullable List<BaseCommentData.CommentLinkData> paramList)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentUiCommentLinkView$LinkAdatper != null) {
        break;
      }
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentUiCommentLinkView$LinkAdatper = new CommentLinkView.LinkAdatper(this);
      setAdapter((ListAdapter)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentUiCommentLinkView$LinkAdatper);
      return;
      paramList = (List)new ArrayList(0);
    }
    paramList = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentUiCommentLinkView$LinkAdatper;
    if (paramList == null) {
      Intrinsics.throwNpe();
    }
  ...
  {
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentUiCommentLinkView$OnLinkDeleteListener = paramOnLinkDeleteListener;
  }
}
