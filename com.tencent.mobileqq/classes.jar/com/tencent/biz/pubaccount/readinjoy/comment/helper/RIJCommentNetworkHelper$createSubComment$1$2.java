...
final class RIJCommentNetworkHelper$createSubComment$1$2
  extends Lambda
  implements Function2<Boolean, Integer, Unit>
{
  RIJCommentNetworkHelper$createSubComment$1$2(RIJCommentNetworkHelper.createSubComment.1 param1, int paramInt, oidb_0xd1e.SubCommentCreateRsp paramSubCommentCreateRsp)
  {
    super(2);
  }
  ...
  public final void invoke(boolean paramBoolean, int paramInt)
  {
    ...
    localCreateCommentResult.jdField_a_of_type_JavaLangString = String.valueOf(this.$commentId);
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.comment.helper.RIJCommentNetworkHelper.createSubComment.1.2
