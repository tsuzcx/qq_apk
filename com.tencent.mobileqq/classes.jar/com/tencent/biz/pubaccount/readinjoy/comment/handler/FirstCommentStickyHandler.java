...
public final class FirstCommentStickyHandler
{
  ...
  static
  {
    jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentHandlerFirstCommentStickyHandler$Companion = new FirstCommentStickyHandler.Companion(null);
  }
  ...
  private final oidb_0xd1e.ReqBody a()
  {
    ...
    localFirstCommentAuthorTopSetReq.article_id.set(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentHandlerBeanFirstCommentStickyData.c());
    ...
    localFirstCommentAuthorTopSetReq.content_src.set(ReadInJoyCommentHelper.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentHandlerBeanFirstCommentStickyData.d()));
    localFirstCommentAuthorTopSetReq.src.set(0);
    localFirstCommentAuthorTopSetReq.business_info.set(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentHandlerBeanFirstCommentStickyData.e());
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.comment.handler.FirstCommentStickyHandler
