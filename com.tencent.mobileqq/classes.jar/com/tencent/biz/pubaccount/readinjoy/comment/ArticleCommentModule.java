  ...
  extends CommentInfo
{
  ...
  {
    NativeCommentServlet.a(paramQQAppInterface, this.articleInfo, paramString1, paramInt1, paramString2, paramString3, paramInt2, paramString4, paramInt3, new llh(this, paramCommentLikeObserver, paramInt2));
  }
  ...
  {
    NativeCommentServlet.a(paramQQAppInterface, this.articleInfo, this.uuid, paramInt1, paramString1, paramString2, paramString3, paramJSONArray, paramInt2, paramInt3, paramString4, paramString5, new llf(this, paramCreateCommentObserver, paramString3));
  }
  ...
  {
    NativeCommentServlet.a(paramQQAppInterface, this.articleInfo, this.uuid, paramInt1, paramString1, paramString2, paramString3, paramInt2, new llg(this, paramString1, paramString3, paramDeleteCommentObserver));
  }
  ...
  public boolean fetchNextCommentInfo(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    NativeCommentServlet.a(paramQQAppInterface, this.articleInfo, this.uuid, this.commentType, this.commentId, this.page, 10, paramInt, new lle(this));
    this.page += 1;
    return true;
  }
