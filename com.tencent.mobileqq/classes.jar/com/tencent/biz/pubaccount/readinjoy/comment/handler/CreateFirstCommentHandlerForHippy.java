...
public final class CreateFirstCommentHandlerForHippy
{
  ...
  public final oidb_0xefd.ReqBody a()
  {
    ...
    localFirstCommentCreateReq.rowkey.set(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentHandlerBeanFirstCommentCreateData.c());
    localFirstCommentCreateReq.article_id.set(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentHandlerBeanFirstCommentCreateData.d());
    ...
    localFirstCommentCreateReq.business_info.set(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentHandlerBeanFirstCommentCreateData.e());
    localFirstCommentCreateReq.content_src.set(ReadInJoyCommentHelper.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentHandlerBeanFirstCommentCreateData.d()));
    ...
    Object localObject1 = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentHandlerBeanFirstCommentCreateData.b();
    Object localObject2;
    ...
    localObject1 = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentHandlerBeanFirstCommentCreateData.a();
    if (localObject1 != null)
    {
      localObject1 = ((Iterable)localObject1).iterator();
      while (((Iterator)localObject1).hasNext())
  ...
  public final void a()
  {
    ...
    ProtoUtils.a((AppRuntime)RIJQQAppInterfaceUtil.a(), (ProtoUtils.TroopProtocolObserver)new CreateFirstCommentHandlerForHippy.send0xefdRequest.1(this), localReqBody.toByteArray(), "OidbSvc.0xefd", 3837, 4);
  }
  ...
  public final void a(@NotNull byte[] paramArrayOfByte)
  {
    ...
    int j = ((oidb_0xefd.RspBody)localObject).retcode.get();
    ...
    a(j, "create first comment failed");
  }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.comment.handler.CreateFirstCommentHandlerForHippy
