...
public class ReadinjoyVideoReportData
{
  ...
  private static int a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      return (int)((l1 >>> 4) % 100L);
      while (i1 < 8)
      {
        l1 = l1 << 8 | paramString1[i1] & 0xFF;
        i1 += 1;
      }
    }
  }
  ...
  {
    int i2 = 0;
    AladdinConfig localAladdinConfig = Aladdin.getConfig(428);
    String str1 = ReadInJoyUtils.a();
    if ((str1 != null) && (!str1.equals(jdField_q_of_type_JavaLangString)))
    {
      jdField_v_of_type_Int = 0;
      jdField_a_of_type_ArrayOfInt = null;
      jdField_q_of_type_JavaLangString = str1;
    }
    if (jdField_v_of_type_Int <= 0)
    {
      jdField_v_of_type_Int = localAladdinConfig.getIntegerFromString("config_ver", 0);
      if (jdField_v_of_type_Int > 0) {}
    }
    for (;;)
    {
      ...
      while (i1 < 5)
      {
        jdField_a_of_type_ArrayOfInt[i1] = -1;
        String str2 = localAladdinConfig.getString("bucekt_key" + (i1 + 1), null);
        if (str2 != null) {
          jdField_a_of_type_ArrayOfInt[i1] = a(str1, str2);
        }
        i1 += 1;
      }
      i1 = i2;
      if (jdField_v_of_type_Int > 0)
      {
        paramHashMap.put("param_config_ver", String.valueOf(jdField_v_of_type_Int));
        i1 = i2;
      }
      while (i1 < 5)
      {
        if (jdField_a_of_type_ArrayOfInt[i1] >= 0) {
          paramHashMap.put("param_bucket" + (i1 + 1), String.valueOf(jdField_a_of_type_ArrayOfInt[i1]));
        }
        i1 += 1;
      }
    }
  ...
  private HashMap<String, String> c()
  {
    ...
    try
    {
      ...
      localHashMap.put("param_vid2UrlErrorCode", String.valueOf(this.jdField_e_of_type_Int));
      localHashMap.put("param_isHitCache", String.valueOf(this.jdField_c_of_type_Boolean));
      localHashMap.put("param_jumpFromScene", String.valueOf(this.jdField_i_of_type_Int));
      localHashMap.put("param_index", String.valueOf(this.jdField_j_of_type_Int));
      ...
      localHashMap.put("param_preloadStatus", String.valueOf(this.jdField_o_of_type_Int));
      if (this.jdField_a_of_type_JavaLangString == null) {}
      for (String str = "";; str = this.jdField_a_of_type_JavaLangString)
      {
        localHashMap.put("param_rowKey", str);
        localHashMap.put("param_version", "8.5.5.5105");
        localHashMap.put("param_subversion", "8.5.5");
  ...
  public HashMap<String, String> a()
  {
    ...
    localHashMap.put("param_secondBufferCount", String.valueOf(this.jdField_g_of_type_Int));
    localHashMap.put("param_videoFormat", String.valueOf(this.jdField_h_of_type_Int));
    ...
    localHashMap.put("param_width", String.valueOf(this.jdField_m_of_type_Int));
    localHashMap.put("param_height", String.valueOf(this.jdField_n_of_type_Int));
    if (this.jdField_a_of_type_Int == 2)
    {
      localHashMap.put("param_skipFramesErrorCount", String.valueOf(this.jdField_p_of_type_Int));
    ...
    if (this.jdField_a_of_type_Int == 2)
    {
      ...
      localHashMap.put("param_ipAddressCnt", String.valueOf(this.jdField_s_of_type_Int));
      localHashMap.put("param_ipAddressList", this.jdField_i_of_type_JavaLangString);
      localHashMap.put("param_skipFramesTotalCount", String.valueOf(this.jdField_q_of_type_Int));
      localHashMap.put("param_skipFramesFinalCount", String.valueOf(this.jdField_r_of_type_Int));
    }
    localHashMap.put("param_isChangeHWBackup", String.valueOf(this.jdField_g_of_type_Boolean));
    localHashMap.put("param_continuousPlay", String.valueOf(this.jdField_t_of_type_Int));
    ...
    localHashMap.put("param_prepareOptimizeConfigJson", RIJJsonUtils.a());
    localHashMap.put("param_httpbuffertime_for_playpreload", String.valueOf(ReadInJoyHelper.g()));
    localHashMap.put("param_dynamic_buffer_switch", String.valueOf(ReadInJoyHelper.h()));
    localHashMap.put("param_dynamic_buffer_config_json", ReadInJoyHelper.c());
    ...
    localHashMap.put("param_codecReuseConfigVersion", String.valueOf(CodecReuseHelper.a.a()));
    localHashMap.put("param_codecReuseDeviceSupport", String.valueOf(CodecReuseHelper.a.a()));
    ...
    localHashMap.put("param_videoFrameCheckCode", String.valueOf(this.jdField_u_of_type_Int));
