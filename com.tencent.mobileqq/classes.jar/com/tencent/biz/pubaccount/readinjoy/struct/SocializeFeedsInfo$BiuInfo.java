  ...
  implements Cloneable
{
  ...
  public SocializeFeedsInfo$BiuInfo()
  {
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.jdField_a_of_type_JavaLangLong = Long.valueOf(0L);
  }
  
  public SpannableStringBuilder a(int paramInt, ArticleInfo paramArticleInfo, String paramString, ReadInJoyUserInfoModule.RefreshUserInfoCallBack paramRefreshUserInfoCallBack)
  {
    return SocializeFeedsInfo.a(paramInt, paramArticleInfo, paramString, paramRefreshUserInfoCallBack, this.jdField_a_of_type_JavaUtilList);
  }
  
  public SpannableStringBuilder a(ArticleInfo paramArticleInfo, String paramString, ReadInJoyUserInfoModule.RefreshUserInfoCallBack paramRefreshUserInfoCallBack)
  {
    return SocializeFeedsInfo.a(paramArticleInfo, paramString, paramRefreshUserInfoCallBack, this.jdField_a_of_type_JavaUtilList);
  }
    ...
    try
    {
      ...
      try
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          localBiuInfo.jdField_a_of_type_JavaUtilList.add(localBiuCommentInfo.clone());
        }
        return localBiuInfo;
      }
