...
public final class WeiShiVideoArticleInfo$Companion
{
  ...
  private final void c(Readinjoy.ArticleSummary paramArticleSummary, WeiShiVideoArticleInfo paramWeiShiVideoArticleInfo)
  {
    if (paramArticleSummary.rpt_label_list.has())
    {
      ...
      while (paramArticleSummary.hasNext())
      {
        ...
        paramWeiShiVideoArticleInfo.labelList.add(VideoProtoHelper.a(localChannelInfo));
      }
    }
  }
  ...
  public final WeiShiVideoArticleInfo a(@Nullable Readinjoy.ArticleSummary paramArticleSummary)
  {
    ...
    try
    {
      ...
      localWeiShiVideoArticleInfo.rowkey = PBFieldUtils.a(localPBBytesField);
      ...
      for (;;)
      {
        ...
        localWeiShiVideoArticleInfo.title = PBFieldUtils.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.summary = PBFieldUtils.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.pagePicUrl = PBFieldUtils.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.articleContentUrl = PBFieldUtils.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.subscribeName = PBFieldUtils.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.subscribeIcon = PBFieldUtils.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.subscribeID = PBFieldUtils.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.recommendReason = PBFieldUtils.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.pushContext = PBFieldUtils.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.adsJumpUrl = PBFieldUtils.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.videoReportInfo = PBFieldUtils.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.businessInfo = PBFieldUtils.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.videoSubscriptTxt = PBFieldUtils.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.videoSubscriptColor = PBFieldUtils.a(localPBBytesField);
    ...
    if (paramArticleSummary != null)
    {
      ...
      for (;;)
      {
        ...
        catch (Throwable paramArticleSummary)
        {
          ...
          QLog.e("VideoProtoHelper", 0, "cmd0xbedToWeiShiVideoArticleInfo error:" + RIJAppSetting.a(paramArticleSummary));
          continue;
        }
        return localWeiShiVideoArticleInfo;
        bool = false;
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.struct.WeiShiVideoArticleInfo.Companion
