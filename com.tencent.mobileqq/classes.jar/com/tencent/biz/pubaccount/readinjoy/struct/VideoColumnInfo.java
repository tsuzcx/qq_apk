...
{
  public static final Parcelable.Creator<VideoColumnInfo> CREATOR = new qdw();
  public int a;
  public long a;
  ...
  public static VideoColumnInfo a(articlesummary.VideoColumnInfo paramVideoColumnInfo)
  {
    ...
    if (paramVideoColumnInfo != null)
    {
      ...
      if (paramVideoColumnInfo.has())
      {
        ...
        if (paramVideoColumnInfo.get() != null)
        {
          ...
          ((VideoColumnInfo)localObject1).jdField_a_of_type_JavaLangString = onh.a(paramVideoColumnInfo.bytes_column_name);
          ((VideoColumnInfo)localObject1).jdField_b_of_type_JavaLangString = onh.a(paramVideoColumnInfo.bytes_column_icon_url);
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      ((VideoColumnInfo)localObject1).jdField_c_of_type_JavaLangString = onh.a(paramVideoColumnInfo.bytes_column_card_bg_url);
      ((VideoColumnInfo)localObject1).jdField_d_of_type_JavaLangString = onh.a(paramVideoColumnInfo.bytes_column_card_bg_color);
      ((VideoColumnInfo)localObject1).e = onh.a(paramVideoColumnInfo.bytes_column_card_icon_url);
      ((VideoColumnInfo)localObject1).f = onh.a(paramVideoColumnInfo.bytes_app_name);
      ((VideoColumnInfo)localObject1).g = onh.a(paramVideoColumnInfo.bytes_app_icon_url);
      ...
      ((VideoColumnInfo)localObject1).h = onh.a(paramVideoColumnInfo.bytes_from_txt);
      ((VideoColumnInfo)localObject1).i = onh.a(paramVideoColumnInfo.bytes_column_name_color);
      return localObject1;
    }
  }
