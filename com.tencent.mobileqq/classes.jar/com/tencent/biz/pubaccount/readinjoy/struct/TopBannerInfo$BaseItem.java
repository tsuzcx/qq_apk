  ...
  protected void a(oidb_cmd0xbc9.BannerItem paramBannerItem)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      while (localIterator.hasNext()) {
        ((List)localObject).add(((TopBannerInfo.AdReport)localIterator.next()).a());
      }
    }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.struct.TopBannerInfo.BaseItem
