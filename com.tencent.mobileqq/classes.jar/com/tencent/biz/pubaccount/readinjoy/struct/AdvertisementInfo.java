  ...
  implements Parcelable
{
  ...
  public static final Parcelable.Creator<AdvertisementInfo> CREATOR = new pop();
  ...
  @atnz
  public nmw mAdvertisementExtInfo;
  @atnz
  public nmx mAdvertisementSoftInfo;
  @atnz
  ...
  public AdvertisementInfo(Parcel paramParcel)
  {
    ...
    this.mAdvertisementExtInfo = new nmw(this.mAdExtInfo);
  ...
  public AdvertisementInfo(articlesummary.AdInfo paramAdInfo)
  {
    ...
    processAdExtraDataInfo(this.mAdExtInfo);
    this.mLocalInfo = new ppr(paramAdInfo.local_info);
  ...
  public static int getAdStyle(AdvertisementInfo paramAdvertisementInfo)
  {
    if (isAdvertisementInfo(paramAdvertisementInfo)) {
      return npi.b(paramAdvertisementInfo);
    }
    return 0;
  }
  ...
  {
    return (this.mAdvertisementExtInfo != null) && (this.mAdvertisementExtInfo.h == 32768);
  }
    ...
    for (;;)
    {
      try
      {
        ...
        else
        {
          ...
          this.mImaxStyle = bgmq.a("sp_key_ad_imax_style");
  ...
  {
    this.mAdvertisementSoftInfo = new nmx(paramString);
  }
