...
public class ReadInJoyNaviController
{
  ...
  public ReadInJoyNaviController(ViewGroup paramViewGroup, ReadInJoyNavigationGridview paramReadInJoyNavigationGridview, ImageView paramImageView)
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyEngineReadInJoyObserver = new ReadInJoyNaviController.3(this);
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyNavigationGridview.setChannelButtonListener(new ReadInJoyNaviController.ChannelButtonListenerImpl(this));
  ...
  public void a()
  {
    try
    {
      ...
      {
        localReadInJoyLogicManager.a().c(0);
