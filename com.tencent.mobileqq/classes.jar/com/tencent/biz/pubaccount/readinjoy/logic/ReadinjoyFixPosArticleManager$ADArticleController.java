...
{
  public int a;
  private FixPosArticleInterface.FixPosArticleAsyncListener jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelFixPosArticleInterface$FixPosArticleAsyncListener = new ReadinjoyFixPosArticleManager.ADArticleController.1(this);
  ...
  private FixPosArticleInterface a()
  {
    ...
    if (localAppRuntime != null) {
      return ((ReadInJoyLogicManager)localAppRuntime.getManager(QQManagerFactory.READINJOY_LOGIC_MANAGER)).a().a();
    }
    return null;
  }
  ...
  void a(int paramInt)
  {
    ...
    Collections.sort((List)localObject1, new ReadinjoyFixPosArticleManager.ADArticleController.2(this));
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.logic.ReadinjoyFixPosArticleManager.ADArticleController
