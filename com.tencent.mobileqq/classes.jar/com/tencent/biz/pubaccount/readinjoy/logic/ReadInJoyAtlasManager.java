...
public class ReadInJoyAtlasManager
{
  ...
  private AtlasStackInfo jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelAtlasStackInfo = new AtlasStackInfo();
  
  static
  {
    jdField_a_of_type_JavaLangString = "Q.readinjoy.atlas.." + ReadInJoyAtlasManager.class.getSimpleName();
    b = HardCodeUtil.a(2131712869);
    c = HardCodeUtil.a(2131712783);
    d = HardCodeUtil.a(2131712936);
  ...
  {
    boolean bool = false;
    if (RIJSPUtils.a(BaseApplicationImpl.getApplication().getRuntime(), "Key_First_ReadInJoy_Favorite", true) == null)
    {
      RIJSPUtils.a("Key_First_ReadInJoy_Favorite", Integer.valueOf(1), true);
      if (!paramBoolean) {
        DialogUtil.a(paramContext, 230, paramContext.getString(2131692303), "你可在看点内点击“我的”找到“我的收藏”。\n收藏的内容将会上传保存，在其他手机上登录QQ，也可以在看点内找到你收藏的内容。\n", 2131690800, 2131692301, new ReadInJoyAtlasManager.8(), null).setMessageCount(null).show();
      }
      bool = true;
    }
    return bool;
  ...
  public void a(Activity paramActivity, String paramString1, int paramInt, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, Bundle paramBundle, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (paramBoolean)
      {
        new QfavBuilder(6).a("nLinkType", 0).b("sTitle", paramString3).b("sUrl", paramString6).a("bAppShare", false).a("lAppId", 0L).b("sPublisher", paramString2).b("sBrief", paramString4).b("sPath", paramString5).b("sResUrl", paramString6).a("lCategory", 8L).b("sBizDataList", localArrayList).a(paramActivity, paramString1);
        return;
      }
  ...
  public void a(List<String> paramList, ReadInJoyAtlasManager.AtlasCallback paramAtlasCallback)
  {
    ...
    ProtoUtils.a(BaseApplicationImpl.getApplication().getRuntime(), new ReadInJoyAtlasManager.6(this, paramAtlasCallback), localReqBody.toByteArray(), "OidbSvc.0xb40", 2880, 1, paramList, 0L);
  }
}
