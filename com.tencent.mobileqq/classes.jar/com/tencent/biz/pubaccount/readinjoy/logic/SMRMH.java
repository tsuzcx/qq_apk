  ...
  public static void a(int paramInt, long paramLong1, long paramLong2, List paramList)
  {
    ...
    else
    {
      ...
      for (;;)
      {
        try
        {
          ...
          {
            locallrk = (lrk)((Iterator)localObject3).next();
            localJSONObject = new JSONObject();
            localJSONObject.put("u", a(locallrk.jdField_a_of_type_Long));
            localJSONObject.put("cn", locallrk.jdField_a_of_type_Int);
            localJSONObject.put("ic", locallrk.jdField_b_of_type_Int);
      ...
      if (((Iterator)localObject1).hasNext())
      {
        ...
        while (((Iterator)localObject3).hasNext())
        {
          ...
          localJSONObject.put("cn", locallrk.jdField_a_of_type_Int);
          localJSONObject.put("ic", locallrk.jdField_b_of_type_Int);
          localJSONObject.put("seg", locallrk.d);
          localJSONObject.put("mi", locallrk.c);
          localJSONObject.put("gu", locallrk.jdField_b_of_type_Long);
    ...
    for (paramList = "0X8007F08";; paramList = "0X8007F09")
    {
      ...
      while (paramList.hasNext())
      {
        ...
        localObject3 = ((List)localObject3).iterator();
        while (((Iterator)localObject3).hasNext()) {
          ((JSONArray)localObject2).put(a(((lrk)((Iterator)localObject3).next()).jdField_a_of_type_Long));
        }
