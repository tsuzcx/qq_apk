  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    try
    {
      ...
      qdx.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyLogicDiandianTopConfigManager$2.this$0, localRspBody);
      return;
    }
    catch (Exception localException)
    {
      if (QLog.isColorLevel()) {
        QLog.e(qdx.a, 2, "loadDiandianTopConfig, e = " + localException);
      }
      pvm.a().a(false, null);
    }
  }
