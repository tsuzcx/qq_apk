...
public class SMRM
{
  ...
  private void c(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localCursor1 = localCursor2;
        localObject = localCursor2;
        locallrk.jdField_a_of_type_Int = k;
        localCursor1 = localCursor2;
        localObject = localCursor2;
        locallrk.jdField_b_of_type_Int = i;
        localCursor1 = localCursor2;
        localObject = localCursor2;
        locallrk.jdField_a_of_type_Long = Long.parseLong(localRecentUser.uin);
        localCursor1 = localCursor2;
        localObject = localCursor2;
        localLinkedList.add(locallrk);
        localCursor1 = localCursor2;
        localObject = localCursor2;
        if (a())
        {
          localCursor1 = localCursor2;
          localObject = localCursor2;
          QLog.d("SMRM", 2, locallrk.toString());
        }
        if (localCursor2 == null) {
          break;
        }
  ...
  private void d(QQAppInterface paramQQAppInterface)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localObject != null)
      {
        ...
        {
          lrk locallrk = new lrk();
          locallrk.jdField_a_of_type_Long = Long.parseLong(((Friends)localObject).uin);
          localLinkedList.add(locallrk);
          if (a()) {
            QLog.d("SMRM", 2, locallrk.toString());
          }
  ...
  private void e(QQAppInterface paramQQAppInterface)
  {
    ...
    //   658: new 328	lrk
    //   661: dup
    //   662: invokespecial 329	lrk:<init>	()V
    //   665: astore 9
    //   667: aload 9
    //   669: aload 9
    //   671: getfield 331	lrk:jdField_a_of_type_Int	I
    //   674: iconst_1
    //   675: iadd
    //   676: putfield 331	lrk:jdField_a_of_type_Int	I
    //   679: aload 9
    //   681: iconst_1
    //   682: putfield 333	lrk:jdField_b_of_type_Int	I
    //   685: iconst_1
    //   686: istore_2
    //   687: aload 7
    //   689: astore 6
    ...
    //   721: ifnull +32 -> 753
    //   724: aload 9
    //   726: getfield 333	lrk:jdField_b_of_type_Int	I
    //   729: iconst_3
    ...
    //   890: new 328	lrk
    //   893: dup
    //   894: invokespecial 329	lrk:<init>	()V
    //   897: astore 9
    //   899: aload 9
    //   901: aload 7
    //   903: invokestatic 258	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   906: putfield 335	lrk:jdField_a_of_type_Long	J
    //   909: aload 9
    //   911: aload 22
    ...
    //   919: putfield 420	lrk:jdField_b_of_type_Long	J
    //   922: aload 10
    ...
    //   948: checkcast 328	lrk
    //   951: astore 12
    //   953: aload 9
    //   955: aload 9
    //   957: getfield 331	lrk:jdField_a_of_type_Int	I
    //   960: aload 12
    //   962: getfield 331	lrk:jdField_a_of_type_Int	I
    //   965: iadd
    //   966: putfield 331	lrk:jdField_a_of_type_Int	I
    //   969: aload 9
    //   971: aload 9
    //   973: getfield 333	lrk:jdField_b_of_type_Int	I
    //   976: aload 12
    //   978: getfield 333	lrk:jdField_b_of_type_Int	I
    //   981: iadd
    //   982: putfield 333	lrk:jdField_b_of_type_Int	I
    //   985: aload 9
    //   987: aload 9
    //   989: getfield 422	lrk:d	I
    //   992: iconst_1
    //   993: iadd
    //   994: putfield 422	lrk:d	I
    //   997: aload 9
    //   999: getfield 424	lrk:c	I
    //   1002: aload 12
    //   1004: getfield 333	lrk:jdField_b_of_type_Int	I
    //   1007: if_icmpge -76 -> 931
    //   1010: aload 9
    //   1012: aload 12
    //   1014: getfield 333	lrk:jdField_b_of_type_Int	I
    //   1017: putfield 424	lrk:c	I
    //   1020: goto -89 -> 931
    //   1023: astore 7
    //   1025: aload 8
    //   1027: astore 6
    ...
    //   1060: aload 13
    //   1062: aload 13
    //   1064: getfield 331	lrk:jdField_a_of_type_Int	I
    //   1067: iconst_1
    //   1068: iadd
    //   1069: putfield 331	lrk:jdField_a_of_type_Int	I
    //   1072: aload 14
    //   1074: astore 6
    //   1076: aload 13
    //   1078: astore 9
    ...
    //   1125: aload 13
    //   1127: aload 13
    //   1129: getfield 333	lrk:jdField_b_of_type_Int	I
    //   1132: iconst_1
    //   1133: iadd
    //   1134: putfield 333	lrk:jdField_b_of_type_Int	I
    //   1137: aload 7
    //   1139: astore 6
    //   1141: aload 13
    //   1143: astore 9
    ...
    //   1171: ifne +35 -> 1206
    //   1174: aload 13
    //   1176: getfield 333	lrk:jdField_b_of_type_Int	I
    //   1179: iconst_3
    ...
    //   1206: aload 13
    //   1208: aload 13
    //   1210: getfield 331	lrk:jdField_a_of_type_Int	I
    //   1213: iconst_1
    //   1214: iadd
    //   1215: putfield 331	lrk:jdField_a_of_type_Int	I
    //   1218: aload 14
    //   1220: astore 6
    //   1222: aload 13
    //   1224: astore 9
    ...
    //   1242: aload 13
    //   1244: aload 13
    //   1246: getfield 333	lrk:jdField_b_of_type_Int	I
    //   1249: iconst_1
    //   1250: iadd
    //   1251: putfield 333	lrk:jdField_b_of_type_Int	I
    //   1254: aload 7
    //   1256: astore 6
    //   1258: aload 13
    //   1260: astore 9
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    //   42: aload_0
    //   43: aload_1
    //   44: invokespecial 459	lrj:<init>	(Lcom/tencent/biz/pubaccount/readinjoy/logic/SMRM;Lcom/tencent/mobileqq/app/QQAppInterface;)V
