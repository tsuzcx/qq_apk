package com.tencent.biz.pubaccount.readinjoy.qnreading;
...
public class PreLoader
{
  ...
  private void a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    try
    {
      ...
      {
        paramBaseArticleInfo = URLUtil.a(paramBaseArticleInfo);
        ...
        {
          paramBaseArticleInfo = (String)URLUtil.a(Uri.decode(str)).get("rowkey");
  ...
  private void c()
  {
    ...
    for (;;)
    {
      ...
      this.d = PackageUtil.a(BaseApplicationImpl.getApplication(), "com.tencent.reading");
      c = false;
      return;
      bool = false;
    }
  ...
  public String a(String paramString)
  {
    ...
    {
      return paramString;
      str = (String)URLUtil.a(paramString).get("rowkey");
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.qnreading.PreLoader
