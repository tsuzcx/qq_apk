...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/biz/pubaccount/readinjoy/view/fastweb/data/PtsData;", "Lcom/tencent/biz/pubaccount/readinjoy/view/fastweb/data/BaseData;", "ptsLitePageName", "", "ptsLiteItemId", "dataJson", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", "isValid", "", "()Z", "setValid", "(Z)V", "ptsComposer", "Lcom/tencent/pts/core/PTSComposer;", "ptsItemData", "Lcom/tencent/pts/core/itemview/PTSItemData;", "getPtsItemData", "()Lcom/tencent/pts/core/itemview/PTSItemData;", "setPtsItemData", "(Lcom/tencent/pts/core/itemview/PTSItemData;)V", "getPtsLiteItemId", "()Ljava/lang/String;", "setPtsLiteItemId", "(Ljava/lang/String;)V", "type", "buildComposer", "", "eventListener", "Lcom/tencent/pts/core/lite/IPTSLiteEventListener;", "AQQLiteApp_release"}, k=1, mv={1, 1, 16})
  ...
  extends BaseData
{
  ...
  public PtsData(@NotNull String paramString1, @NotNull String paramString2, @Nullable String paramString3)
  {
    ...
    paramString1 = qpn.a().a("native_article", this.b);
  ...
  public final void a(@Nullable IPTSLiteEventListener paramIPTSLiteEventListener)
  {
    ...
    for (Object localObject = ((PTSItemData)localObject).getFrameTreeJson();; localObject = null)
    {
      ...
      this.jdField_a_of_type_ComTencentPtsCorePTSComposer = PTSComposer.buildComposer(str2, (String)localObject, str1, paramIPTSLiteEventListener);
      return;
    }
  }
}
