  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      f1 = shu.a(f2, 0.0F, this.jdField_b_of_type_Float, (float)this.jdField_a_of_type_Long);
    ...
    for (;;)
    {
      ...
      return;
      f1 = shu.b(f2, 0.0F, this.jdField_b_of_type_Float, (float)this.jdField_a_of_type_Long);
      break;
      label121:
