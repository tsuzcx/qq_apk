  ...
  implements ItemCreator, OnStateChangeListener
{
  ...
  private FastWebRecommendAdHelper jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebUtilFastWebRecommendAdHelper = new FastWebRecommendAdHelper();
  ...
  private void a(Container paramContainer, RecommendAdData paramRecommendAdData)
  {
    ...
    for (;;)
    {
      ...
      if (localObject != null)
      {
        if (!NativeAdUtils.a(BaseApplicationImpl.getContext(), paramRecommendAdData.h)) {
          break label197;
        }
      ...
      for (;;)
      {
        ...
        paramContainer.getComLayoutParams().mLayoutMarginLeft = AIOUtils.a(16.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
        return;
  ...
  public BaseItemViewHolder a(Context paramContext, BaseData paramBaseData, ViewGroup paramViewGroup)
  {
    ...
    if ((paramBaseData != null) && (paramBaseData.b != null)) {
      RIJFeedsDynamicInsertController.a.a(paramBaseData.b.innerUniqueID);
    }
    return new WebFastProteusViewAdCreator.ProteusItemViewHolder(this, (View)localObject, localProteusItemData);
  }
