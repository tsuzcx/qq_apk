...
public class HtmlChangeUtil
{
  ...
  private static BaseData a(int paramInt, HtmlChangeUtil.XmlPullParserWrapper paramXmlPullParserWrapper)
  {
    ...
    try
    {
      if (!TextUtils.isEmpty(paramXmlPullParserWrapper))
      {
        ...
        if (FastWebPtsLiteDataUtil.a(paramXmlPullParserWrapper))
        {
          ...
          return FastWebPtsLiteDataUtil.a(paramXmlPullParserWrapper);
        }
    ...
    {
      QLog.d(jdField_a_of_type_JavaLangString, 1, "parseProteusData error!  msg=" + paramXmlPullParserWrapper);
    }
    return null;
  }
  
  public static BaseData a(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, HtmlChangeUtil.XmlPullParserWrapper paramXmlPullParserWrapper, SparseArray<Float> paramSparseArray)
  {
    Object localObject2 = "";
    Object localObject3 = "";
    Object localObject1 = "";
      ...
      case 2: 
        for (;;)
        {
          ...
          if (i1 < i2)
          {
            ...
            if (str.equals("src"))
            {
              localObject1 = paramXmlPullParserWrapper.b(i1);
              localObject5 = localObject3;
            ...
            for (;;)
            {
              ...
              if (str.equals("width"))
              {
                localObject6 = paramXmlPullParserWrapper.b(i1);
                localObject5 = localObject3;
                localObject4 = localObject1;
              }
              else
    ...
    label404:
    return FastWebPTSDataConverter.a(paramArticleInfo, paramFastWebArticleInfo, (String)localObject2, (String)localObject3, (String)localObject1, paramSparseArray);
  }
    ...
    if (i1 != 1)
    {
      ...
      case 2: 
        ...
        do
        {
          ...
          i2 = paramXmlPullParserWrapper.b();
          i1 = 0;
          localObject4 = localObject2;
        ...
        for (;;)
        {
          ...
          {
            localObject2 = a(i1, paramXmlPullParserWrapper);
      ...
      case 4: 
        for (;;)
        {
          ...
          if (!((String)localObject2).equals(i)) {
            throw new IllegalArgumentException(HardCodeUtil.a(2131705652));
          }
  ...
  private static ProteusBookData a(JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      Object localObject = TemplateFactory.a("native_article", true);
      if (localObject != null) {}
      for (localObject = ((TemplateFactory)localObject).getTemplateBean(paramJSONObject);; localObject = null)
      {
    ...
    while (i1 != 1)
    {
      ...
      for (;;)
      {
        if (localXmlPullParserWrapper.c() != 2)
        {
          ...
          {
            a(paramArticleInfo, paramFastWebArticleInfo, localXmlPullParserWrapper, localArrayList, localTextStyleInfo, paramSparseArray);
          }
          ...
          else
          {
            ...
            if (((String)localObject).equals(o))
            {
              ...
              c(paramArticleInfo, paramFastWebArticleInfo, localXmlPullParserWrapper, localArrayList, localTextStyleInfo, paramSparseArray);
            }
            else if (((String)localObject).equals(g))
            {
              localObject = a(paramArticleInfo, paramFastWebArticleInfo, localXmlPullParserWrapper, paramSparseArray);
              if (localObject != null) {
            ...
            {
              localArrayList.add(b(paramArticleInfo, paramFastWebArticleInfo, localXmlPullParserWrapper, paramSparseArray));
            }
            ...
            {
              b(paramArticleInfo, paramFastWebArticleInfo, localXmlPullParserWrapper, localArrayList, localTextStyleInfo, paramSparseArray);
            }
            else
            {
              throw new IllegalArgumentException(HardCodeUtil.a(2131705651) + (String)localObject);
              a(localXmlPullParserWrapper, localTextStyleInfo, localArrayList, paramSparseArray);
              if (2 == localXmlPullParserWrapper.c())
              {
                i1 = localXmlPullParserWrapper.c();
  ...
  public static void a(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, HtmlChangeUtil.XmlPullParserWrapper paramXmlPullParserWrapper, List<BaseData> paramList, HtmlChangeUtil.TextStyleInfo paramTextStyleInfo, SparseArray<Float> paramSparseArray)
  {
    int i1 = paramXmlPullParserWrapper.c();
    ...
    for (;;)
    {
      int i2;
      if (i1 != 1) {
        i2 = paramXmlPullParserWrapper.c();
      }
      switch (i2)
      {
      case 0: 
      ...
      case 3: 
        do
        {
          ...
          do
          {
            i1 = paramXmlPullParserWrapper.d();
            break;
            localObject = paramXmlPullParserWrapper.b();
            ...
            {
              localObject = a(paramArticleInfo, paramFastWebArticleInfo, paramXmlPullParserWrapper, paramSparseArray);
              i1 = i2;
              if (localObject == null) {
                break;
              }
            ...
            {
              paramList.add(b(paramArticleInfo, paramFastWebArticleInfo, paramXmlPullParserWrapper, paramSparseArray));
              i1 = i2;
              break;
            }
            ...
            {
              b(paramArticleInfo, paramFastWebArticleInfo, paramXmlPullParserWrapper, paramList, paramTextStyleInfo, paramSparseArray);
              i1 = i2;
              break;
            }
            if (((String)localObject).equals(o))
            {
              ...
              c(paramArticleInfo, paramFastWebArticleInfo, paramXmlPullParserWrapper, paramList, paramTextStyleInfo, paramSparseArray);
              i1 = i2;
              break;
            }
          } while ((((String)localObject).equals(b)) || (((String)localObject).equals(c)));
          return;
        } while (((!paramXmlPullParserWrapper.b().equals(b)) && (!paramXmlPullParserWrapper.b().equals(c))) || (i3 != paramXmlPullParserWrapper.a()));
        return;
      }
      a(paramXmlPullParserWrapper, paramTextStyleInfo, paramList, paramSparseArray);
      i1 = i2;
  ...
  public static BaseData b(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, HtmlChangeUtil.XmlPullParserWrapper paramXmlPullParserWrapper, SparseArray<Float> paramSparseArray)
  {
    int i7 = paramXmlPullParserWrapper.c();
    Object localObject5 = "";
    Object localObject3 = "";
    Object localObject4 = "";
    Object localObject1 = "";
    ...
    if (i7 != 1)
    {
      ...
      case 2: 
        for (;;)
        {
          i7 = paramXmlPullParserWrapper.d();
          ...
          i7 = paramXmlPullParserWrapper.b();
          i4 = 0;
          i5 = i1;
          localObject6 = localObject2;
          localObject2 = localObject1;
          ...
          if (i4 < i7)
          {
            ...
            for (;;)
            {
              ...
              else
              {
                ...
                {
                  i3 = Integer.valueOf(paramXmlPullParserWrapper.b(i4)).intValue();
                  i5 = i2;
                  i6 = i1;
                  localObject6 = localObject4;
                  localObject7 = localObject2;
    ...
    {
      return FastWebPTSDataConverter.a(paramArticleInfo, paramFastWebArticleInfo, (String)localObject3, (String)localObject5, i2, i3, (String)localObject1, (String)localObject2, (String)localObject4, i1, paramSparseArray);
    }
      ...
      if ("line-through".equals(localObject))
      {
        ...
        if ((q.equals(paramString)) || (r.equals(paramString)))
        {
          ...
          while (i1 != -1)
          {
            ...
            for (paramString = HtmlChangeUtil.SpanBuilder.a(2, new Object[] { Integer.valueOf(i1) });; paramString = HtmlChangeUtil.SpanBuilder.a(1, new Object[] { Integer.valueOf(i1) }))
            {
  ...
  public static void b(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, HtmlChangeUtil.XmlPullParserWrapper paramXmlPullParserWrapper, List<BaseData> paramList, HtmlChangeUtil.TextStyleInfo paramTextStyleInfo, SparseArray<Float> paramSparseArray)
  {
    int i1 = paramXmlPullParserWrapper.c();
    int i3 = paramXmlPullParserWrapper.a();
    for (;;)
    {
      ...
      case 3: 
        ...
        do
        {
          ...
          a(paramArticleInfo, paramFastWebArticleInfo, paramXmlPullParserWrapper, paramList, paramTextStyleInfo, paramSparseArray);
        } while (i3 != paramXmlPullParserWrapper.a());
        return;
  ...
  public static void c(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, HtmlChangeUtil.XmlPullParserWrapper paramXmlPullParserWrapper, List<BaseData> paramList, HtmlChangeUtil.TextStyleInfo paramTextStyleInfo, SparseArray<Float> paramSparseArray)
  {
    int i1 = paramXmlPullParserWrapper.c();
    switch (i1)
    {
    ...
    } while (!paramXmlPullParserWrapper.b().equals(o));
  }
}
