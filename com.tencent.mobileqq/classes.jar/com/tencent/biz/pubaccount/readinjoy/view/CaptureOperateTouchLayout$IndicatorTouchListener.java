  ...
  implements View.OnTouchListener
{
  ...
  private CaptureOperateTouchLayout.IndicatorLongPressCallback jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewCaptureOperateTouchLayout$IndicatorLongPressCallback;
  ...
  {
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewCaptureOperateTouchLayout$IndicatorLongPressCallback = paramIndicatorLongPressCallback;
  }
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (CaptureOperateTouchLayout.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewCaptureOperateTouchLayout))
      {
        ...
        localValueAnimator.addUpdateListener(new CaptureOperateTouchLayout.IndicatorTouchListener.3(this, paramView));
        localValueAnimator.start();
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewCaptureOperateTouchLayout$IndicatorLongPressCallback.a(true);
      }
      for (;;)
      {
        ...
        break;
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewCaptureOperateTouchLayout$IndicatorLongPressCallback.a(false);
      }
      ...
      if ((!CaptureOperateTouchLayout.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewCaptureOperateTouchLayout)) && ((Math.abs(this.e - paramView.getX()) > 10.0F) || (Math.abs(this.f - paramView.getY()) > 10.0F)))
      {
        ...
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewCaptureOperateTouchLayout$IndicatorLongPressCallback.c();
      }
    }
  }
}
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.view.CaptureOperateTouchLayout.IndicatorTouchListener
