  ...
  public void run()
  {
    ...
    do
    {
      ...
      do
      {
        ...
        f2 = shu.a(f1, 0.0F, this.c, (float)this.jdField_a_of_type_Long);
        f3 = shu.a(f1, 0.0F, this.d, (float)this.jdField_a_of_type_Long);
        f4 = shu.b(f1, 0.0F, this.f, (float)this.jdField_a_of_type_Long);
