  ...
  implements Runnable
{
  ...
  public void run()
  {
    String str1 = bbvj.a(ajsd.cD + this.a + ".7z");
    ...
    do
    {
      ...
      do
      {
        ...
        String str3 = bbvj.a(ajsd.cD);
        str2 = bbvj.a(ajsd.cD + this.a + ".zip");
