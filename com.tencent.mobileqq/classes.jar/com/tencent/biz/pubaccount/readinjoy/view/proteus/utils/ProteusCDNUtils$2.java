  ...
  implements Runnable
{
  ...
  public void run()
  {
    String str1 = bigv.a(antf.cH + this.a + ".7z");
    ...
    do
    {
      ...
      do
      {
        ...
        String str3 = bigv.a(antf.cH);
        str2 = bigv.a(antf.cH + this.a + ".zip");
