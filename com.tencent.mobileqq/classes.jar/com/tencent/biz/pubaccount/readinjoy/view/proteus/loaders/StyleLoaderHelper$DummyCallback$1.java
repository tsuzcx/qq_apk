...
public class StyleLoaderHelper$DummyCallback$1
  implements Runnable
{
  public StyleLoaderHelper$DummyCallback$1(tmo paramtmo, String paramString, int paramInt) {}
  ...
  public void run()
  {
    ...
    if (this.jdField_a_of_type_Int == 0) {
      this.jdField_a_of_type_Tmo.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int);
    }
    tnc.a(tmo.a(this.jdField_a_of_type_Tmo), this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int);
  }
}
