  ...
  implements Releaser<Bitmap>
{
  ...
  public void a(Bitmap paramBitmap)
  {
    ...
    Utils.a(BitmapCache.a, "recycle:" + paramBitmap);
    if (!Utils.a())
    {
      paramBitmap.recycle();
      return;
    ...
    for (;;)
    {
      ...
      QLog.e(BitmapCache.a, 1, "reuse same bitmap " + paramBitmap);
      return;
      label226:
      int i = 0;
      continue;
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.view.imageloader.BitmapCache.1
