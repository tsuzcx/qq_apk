  ...
  implements View.OnClickListener
{
  ...
  {
    return LayoutInflater.from(paramContext).inflate(2131560296, (ViewGroup)this.jdField_a_of_type_AndroidViewView, false);
  }
  ...
  private void a(String paramString, ArticleTopicData.TopicInfo paramTopicInfo, ArticleInfo paramArticleInfo)
  {
    ...
    ((IPublicAccountReportUtils)QRoute.api(IPublicAccountReportUtils.class)).publicAccountReportClickEventForMigrate(null, "CliOper", "", ReadInJoyUtils.a(), paramString, paramString, 0, 0, String.valueOf(l1), String.valueOf(l2), paramArticleInfo.innerUniqueID, "", false);
  }
  ...
  public void b(BaseData paramBaseData1, BaseData paramBaseData2, boolean paramBoolean)
  {
    ...
    if (i < this.jdField_a_of_type_ComTencentWidgetHorizontalLabelLayout.getChildCount())
    {
      ...
      if (i < j)
      {
        ...
        ((TextView)localView.findViewById(2131376539)).setText(a(localTopicInfo.jdField_a_of_type_JavaLangString));
        if ((!paramBoolean) && (!paramBaseData1.jdField_a_of_type_Boolean))
        {
          a("0X800919F", localTopicInfo, paramBaseData2.b);
  ...
  public void onClick(View paramView)
  {
    ...
    if (localTopicInfo != null)
    {
      ...
      a("0X80091A0", localTopicInfo, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataBaseData.b);
    }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.view.fastweb.item.SimpleViewCreator.ArticleTopicFlagViewHolder
