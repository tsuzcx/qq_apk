  ...
  implements View.OnClickListener
{
  ...
  public WebFastAttachedAdCreator$AdViewHolder(View paramView, BaseData paramBaseData)
  {
    ...
    this.b = ((TextView)paramView.findViewById(2131380302));
    PublicDrawableUtil.a((FrameLayout)paramView.findViewById(2131367260), 0.0F, Color.parseColor("#dedfe0"), 1);
    PublicDrawableUtil.a((TextView)paramView.findViewById(2131380375), AIOUtils.a(2.0F, paramView.getResources()), Color.parseColor("#fa8726"), 1);
    PublicDrawableUtil.a((TextView)paramView.findViewById(2131380514), AIOUtils.a(2.0F, paramView.getResources()), Color.parseColor("#12b7f5"), 1);
  }
  ...
  public void b(BaseData paramBaseData1, BaseData paramBaseData2, boolean paramBoolean)
  {
    ...
    paramBaseData1 = URLDrawable.getDrawable(((IPublicAccountHttpDownloader)QRoute.api(IPublicAccountHttpDownloader.class)).makeURL(paramBaseData1.d, 4), paramBaseData2);
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.view.fastweb.item.WebFastAttachedAdCreator.AdViewHolder
