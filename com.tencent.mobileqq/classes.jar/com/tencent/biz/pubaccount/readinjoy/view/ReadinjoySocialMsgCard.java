  ...
  implements ReadinjoySocialMsgUI
{
  ...
  private static void b(boolean paramBoolean, int paramInt, KandianMsgBoxRedPntInfo paramKandianMsgBoxRedPntInfo)
  {
    ...
    for (;;)
    {
      try
      {
        localReportR5Builder.k(1037);
        localReportR5Builder.a(0);
        localReportR5Builder.a("message_type", String.valueOf(paramKandianMsgBoxRedPntInfo.messageType));
        localReportR5Builder.a("feedsid", String.valueOf(paramKandianMsgBoxRedPntInfo.feedsID));
        localReportR5Builder.a("feedstype", String.valueOf(paramKandianMsgBoxRedPntInfo.feedsType));
        if (paramKandianMsgBoxRedPntInfo.mMsgType == 2)
        {
          localReportR5Builder.a("sys_msg_id", String.valueOf(paramKandianMsgBoxRedPntInfo.sysMsgID));
          localReportR5Builder.a("sys_msg_from", String.valueOf(paramKandianMsgBoxRedPntInfo.sysMsgFrom));
        }
        localReportR5Builder.a("reddot_num", String.valueOf(paramKandianMsgBoxRedPntInfo.mMsgCnt));
        localReportR5Builder.b("msgbox1000000000");
        if (paramBoolean) {
          break label230;
        }
        localReportR5Builder.a("behavior_type", String.valueOf(paramInt));
      }
      ...
      ((IPublicAccountReportUtils)QRoute.api(IPublicAccountReportUtils.class)).publicAccountReportClickEventForMigrate(null, "CliOper", "", String.valueOf(paramKandianMsgBoxRedPntInfo.mUin), str, str, 0, 0, String.valueOf(paramKandianMsgBoxRedPntInfo.mUin), "", "", localReportR5Builder.a(), false);
      return;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (TextUtils.isEmpty((CharSequence)localObject2)) {
          localObject1 = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131694330);
        }
        ...
        localJSONObject.put("msgbox_redpoint_count", String.format(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131694331), new Object[] { ReadInJoyHelper.b(paramKandianMsgBoxRedPntInfo.mMsgCnt) }));
        ...
        {
          localTemplateBean = ProteusParser.getTemplateBean(TemplateFactory.a("default_feeds", true), localJSONObject);
        }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.view.ReadinjoySocialMsgCard
