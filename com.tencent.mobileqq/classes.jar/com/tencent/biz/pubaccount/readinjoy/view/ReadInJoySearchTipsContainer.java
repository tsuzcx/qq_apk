  ...
  implements View.OnClickListener
{
  ...
  ReadInJoySearchTipsContainer.OnTipClickListener jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoySearchTipsContainer$OnTipClickListener;
  private List<ReadInJoySearchTipsContainer.TipsInfo> jdField_a_of_type_JavaUtilList = null;
  private int jdField_b_of_type_Int = 5;
  private List<SearchProtocol.WordItem> jdField_b_of_type_JavaUtilList = null;
  ...
  private void a(String paramString1, int paramInt1, int paramInt2, String paramString2)
  {
    ...
    localButton.setBackgroundResource(2130849868);
