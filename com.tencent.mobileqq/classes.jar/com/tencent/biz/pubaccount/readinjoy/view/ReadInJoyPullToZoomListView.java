...
{
  private static final Interpolator jdField_a_of_type_AndroidViewAnimationInterpolator = new mhu();
  ...
  private mhv jdField_a_of_type_Mhv;
  ...
  private void e()
  {
    if ((this.jdField_b_of_type_AndroidWidgetTextView != null) && (this.jdField_b_of_type_AndroidWidgetTextView.getVisibility() == 8))
    {
      ...
      Drawable localDrawable = getResources().getDrawable(2130838594);
  ...
  private void i()
  {
    ...
    this.jdField_a_of_type_Mhv.a(300L);
  }
  ...
  protected void a(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_Mhv = new mhv(this);
  }
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (!this.jdField_a_of_type_Mhv.a) {
        this.jdField_a_of_type_Mhv.a();
      }
