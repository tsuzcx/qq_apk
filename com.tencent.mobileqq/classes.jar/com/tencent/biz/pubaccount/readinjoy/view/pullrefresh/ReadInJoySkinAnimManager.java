  ...
  extends rec
{
  ...
  private ArrayList<rej> jdField_a_of_type_JavaUtilArrayList;
  private List<String> jdField_a_of_type_JavaUtilList;
  private rek jdField_a_of_type_Rek;
  ...
  private ArrayList<rej> jdField_b_of_type_JavaUtilArrayList;
  ...
  public ReadInJoySkinAnimManager(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Rek = new rek(this);
    boolean bool;
    pnh localpnh;
    if ((float)Runtime.getRuntime().maxMemory() <= 1.415578E+008F)
    {
      ...
      {
        localpnh = (pnh)((BaseActivity)paramContext).app.getManager(270);
        if ((localpnh.a() != 1) || (!localpnh.b())) {
          break label279;
        }
        this.jdField_a_of_type_JavaUtilList = pof.a();
        this.jdField_d_of_type_Int = pof.a();
        this.jdField_a_of_type_JavaLangString = pof.c();
        this.jdField_b_of_type_JavaLangString = localpnh.a();
        this.jdField_c_of_type_JavaLangString = pof.e();
        this.l = 1;
        label179:
    ...
    for (;;)
    {
      ...
      break;
      label279:
      this.jdField_a_of_type_JavaUtilList = pnc.a();
      this.jdField_d_of_type_Int = pnc.b();
      this.jdField_a_of_type_JavaLangString = pnc.c();
      this.jdField_b_of_type_JavaLangString = ((pnn)((BaseActivity)paramContext).app.getManager(261)).a();
      this.jdField_c_of_type_JavaLangString = pnc.d();
      this.l = 2;
      break label179;
      label338:
  ...
  private int a(String paramString)
  {
    ...
    try
    {
      paramString = bacm.a(paramString.toString(), localOptions);
      int n = a(paramString);
      m = n;
      if (QLog.isColorLevel())
      {
  ...
  private Drawable a(String paramString1, String paramString2, String paramString3, Resources paramResources, int paramInt1, int paramInt2)
  {
    ...
    if (new File(paramString2.toString()).exists())
    {
      ...
      if ((this.j == -2) && (this.jdField_c_of_type_Int != -2))
      {
        ...
        bacm.a(paramString2.toString(), paramString3);
        if (this.jdField_d_of_type_Int == 1) {
    ...
    for (;;)
    {
      try
      {
        paramString2 = bacm.a(paramString2.toString(), paramString3);
      ...
      {
        awqx.b(null, "dc00899", "BizTechReport", "", "kan_dian_skin_pull_refresh", "decode_bitmap_oom", paramString3.inSampleSize, paramInt1, this.jdField_b_of_type_JavaLangString, String.valueOf(paramString3.outHeight), String.valueOf(paramString3.outWidth), null);
      ...
      for (;;)
      {
        if (paramInt == 100) {
          if (this.jdField_e_of_type_Int != n - 1)
          {
            ...
            a(((rej)this.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_e_of_type_Int)).jdField_a_of_type_AndroidGraphicsDrawableDrawable);
          }
        }
        label342:
        for (;;)
        {
          ...
          label117:
          if (m < n) {
            if (((rej)this.jdField_a_of_type_JavaUtilArrayList.get(m)).jdField_a_of_type_Int < paramInt) {}
          }
          for (;;)
          {
            ...
            a(((rej)this.jdField_a_of_type_JavaUtilArrayList.get(m)).jdField_a_of_type_AndroidGraphicsDrawableDrawable);
            return;
            m += 1;
            break label117;
            ...
            ((SkinPullRefreshHeader)this.jdField_a_of_type_Wpa).removeCallbacks(this.jdField_a_of_type_JavaLangRunnable);
            ((SkinPullRefreshHeader)this.jdField_a_of_type_Wpa).post(this.jdField_a_of_type_JavaLangRunnable);
            return;
            m = 0;
          }
        }
  ...
  {
    SkinPullRefreshHeader localSkinPullRefreshHeader = (SkinPullRefreshHeader)this.jdField_a_of_type_Wpa;
  ...
  private void b(int paramInt)
  {
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      if (this.jdField_d_of_type_Boolean)
      {
        ...
        if ((localAppInterface != null) && (((baig.u(this.jdField_b_of_type_AndroidContentContext, localAppInterface.getCurrentAccountUin())) && (this.l == 2)) || (this.l == 1))) {
          j();
        }
      }
  ...
  private void b(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      if (localObject != null)
      {
        ...
        this.jdField_a_of_type_Rek.sendEmptyMessage(2);
      }
    }
    else
    {
    ...
    for (int n = a(localList.size(), i1);; n = 1)
    {
      ...
      if ((this.jdField_d_of_type_Int == 1) || (this.jdField_d_of_type_Int == 2) || (this.jdField_d_of_type_Int == 3)) {
        awqx.b(null, "dc00899", "BizTechReport", "", "kan_dian_skin_pull_refresh", "decode_bitmap_times", 0, 0, this.jdField_b_of_type_JavaLangString, null, null, null);
      }
      String str2;
      ...
      if ((this.jdField_d_of_type_Int == 1) || (this.jdField_d_of_type_Int == 3))
      {
        ...
        for (;;)
        {
          ...
          if ((i3 != -2) && (localDrawable != null)) {
            ((ArrayList)localObject).add(new rej(str2, i3, localDrawable));
          }
        }
        label366:
        ...
        this.jdField_a_of_type_Rek.sendEmptyMessage(1);
        return;
      }
      if (this.jdField_d_of_type_Int != 2) {
        break;
      ...
      while (localIterator.hasNext())
      {
        ...
        if (localDrawable != null) {
          ((ArrayList)localObject).add(new rej(str2, 0, localDrawable));
        }
      }
      if (QLog.isColorLevel()) {
        QLog.d("ReadInJoySkinAnimManager", 1, "initResources size = " + ((ArrayList)localObject).size());
  ...
  private void h()
  {
    if (this.jdField_a_of_type_JavaUtilArrayList == null)
    {
      ...
      if ((this.jdField_a_of_type_JavaUtilArrayList.size() > 0) && (this.jdField_a_of_type_Wpa != null))
      {
        if (!this.jdField_h_of_type_Boolean) {
          break label98;
        }
        a(((rej)this.jdField_a_of_type_JavaUtilArrayList.get(0)).jdField_a_of_type_AndroidGraphicsDrawableDrawable);
        ((SkinPullRefreshHeader)this.jdField_a_of_type_Wpa).removeCallbacks(this.jdField_a_of_type_JavaLangRunnable);
        ((SkinPullRefreshHeader)this.jdField_a_of_type_Wpa).post(this.jdField_a_of_type_JavaLangRunnable);
      }
    }
  ...
  private void i()
  {
    ...
    for (;;)
    {
      ...
      if ((str != null) && (new File(str).exists()) && (this.jdField_a_of_type_AndroidMediaSoundPool != null))
      {
        ...
        this.jdField_a_of_type_AndroidMediaSoundPool.setOnLoadCompleteListener(new rei(this, l1));
      }
      return;
  ...
  public int a()
  {
    this.jdField_i_of_type_Int = this.jdField_b_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131167544);
  ...
  public View a(ViewGroup paramViewGroup)
  {
    ...
    if (this.jdField_a_of_type_Wpa == null)
    {
      this.jdField_a_of_type_Wpa = ((SkinPullRefreshHeader)LayoutInflater.from(this.jdField_b_of_type_AndroidContentContext).inflate(2131496831, paramViewGroup, false));
      if (((this.jdField_a_of_type_Wpa instanceof RelativeLayout)) && (this.jdField_b_of_type_Int > 0))
      {
        localObject1 = (RelativeLayout)this.jdField_a_of_type_Wpa;
        ...
        bacm.a(paramViewGroup.toString(), (BitmapFactory.Options)localObject2);
    ...
    for (int n = m;; n = 0)
    {
      if (n != 0)
      {
        ...
        {
          paramViewGroup = (ImageView)((RelativeLayout)localObject1).findViewById(2131309310);
        ...
        {
          paramViewGroup = (pnh)((BaseActivity)this.jdField_b_of_type_AndroidContentContext).app.getManager(270);
          ...
          localObject1 = (SkinPullRefreshHeader)this.jdField_a_of_type_Wpa;
  ...
  public void a()
  {
    ...
    if ((this.jdField_a_of_type_Wpa instanceof SkinPullRefreshHeader)) {
      ((SkinPullRefreshHeader)this.jdField_a_of_type_Wpa).a(false, "");
    }
    ...
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewSlideActiveAnimController != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewSlideActiveAnimController.b())) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewSlideActiveAnimController.a((SkinPullRefreshHeader)this.jdField_a_of_type_Wpa);
    }
    if (this.jdField_a_of_type_JavaUtilArrayList != null) {}
    for (int n = this.jdField_a_of_type_JavaUtilArrayList.size();; n = 0)
    {
      ...
      if ((n > 0) && (this.jdField_d_of_type_Int == 1))
      {
        ...
        if (((rej)this.jdField_a_of_type_JavaUtilArrayList.get(m)).jdField_a_of_type_Int < i1) {}
      }
      for (;;)
      {
        this.jdField_e_of_type_Int = m;
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    do
    {
      return;
      if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewSlideActiveAnimController != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewSlideActiveAnimController.b())) {
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewSlideActiveAnimController.a((SkinPullRefreshHeader)this.jdField_a_of_type_Wpa, paramInt1, paramInt2);
      }
      a(paramInt1);
      b(paramInt1);
    ...
    awqx.b(null, "dc00899", "BizTechReport", "", "kan_dian_skin_pull_refresh", "refresh_times", this.jdField_d_of_type_Int, paramInt1, this.jdField_b_of_type_JavaLangString, null, null, null);
    String str = this.jdField_c_of_type_JavaLangString;
    if ((str != null) && (new File(str).exists()))
    {
      ...
      awqx.b(null, "dc00899", "BizTechReport", "", "kan_dian_skin_pull_refresh", "sound_play_times", paramInt1, 0, this.jdField_b_of_type_JavaLangString, null, null, null);
    }
  ...
  public void a(SlideActiveAnimController paramSlideActiveAnimController)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewSlideActiveAnimController != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewSlideActiveAnimController.b())) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewSlideActiveAnimController.a(this.jdField_b_of_type_JavaLangString, pof.d(), 261);
    }
  }
