...
public class ClickHelper
{
  ...
  public ClickHelper(IContainer paramIContainer)
  {
    ...
    this.jdField_a_of_type_Mpo = new mpo(this);
  }
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    case 0: 
      ...
      ((Handler)localObject).removeCallbacks(this.jdField_a_of_type_Mpo);
      this.jdField_a_of_type_Mpo.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreIContainer.a());
      this.jdField_a_of_type_Mpo.a(localView);
      ((Handler)localObject).postDelayed(this.jdField_a_of_type_Mpo, 500L);
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      if (Math.sqrt(Math.pow(i - this.jdField_a_of_type_Int, 2.0D) + Math.pow(j - this.jdField_b_of_type_Int, 2.0D)) > 5.0D) {
        localView.removeCallbacks(this.jdField_a_of_type_Mpo);
      }
