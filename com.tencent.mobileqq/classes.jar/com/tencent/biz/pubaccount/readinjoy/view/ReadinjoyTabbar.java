  ...
  extends BaseTabbar
{
  ...
  public void b(int paramInt)
  {
    ...
    localTab.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewBaseTabbar$TabHolder.a.post(new mjs(this, paramInt, localTab));
  }
      ...
      try
      {
        ...
        if (paramInt1 < paramInt2)
        {
          ...
          if (!localTab.jdField_a_of_type_Boolean) {
            paramFragmentManager.add(2131363926, localTab.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyBaseFragment, String.valueOf(paramInt1));
          }
