...
public class KandianAppInPush
{
  ...
  private AppInPushNotification.OnDismissListener jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewAppinpushAppInPushNotification$OnDismissListener = new mkf(this);
    ...
    for (localObject1 = str3;; localObject1 = "")
    {
      try
      {
        for (;;)
        {
          ...
          default: 
            i = 0;
            return AppInPushNotification.a().a(paramContext).a((QQAppInterface)ReadInJoyUtils.a()).b((String)localObject3).c(str5).a(str2).d(str7).f(str3).e(str6).g(str1).b(i).a(j).h((String)localObject2).i((String)localObject1).a(l).a(new mki(this, str8, k, paramNotifyInfo)).a(paramOnDismissListener).a();
            str2 = "";
            break label67;
    ...
    for (;;)
    {
      try
      {
        ...
        if (localNotifyInfo.endTime <= l) {
          ...
          ThreadManager.getUIHandler().post(new mkh(this, paramKandian210Msg0xeeInfo, localNotifyInfo));
        }
      }
      finally {}
    }
