...
public class WebFastAdapter$4
  implements Runnable
{
  public WebFastAdapter$4(rzv paramrzv, DownloadInfo paramDownloadInfo) {}
      ...
      for (;;)
      {
        try
        {
          if (((JSONObject)localObject).opt("id_recommend_category_txt") != null)
          {
            ...
            i = k;
            ((JSONObject)localObject).put("text", "下载中..." + this.a.f + "%");
            i = k;
            ((JSONObject)localObject).put("label_ug_progress_progress", this.a.f);
          }
          i = j;
        }
