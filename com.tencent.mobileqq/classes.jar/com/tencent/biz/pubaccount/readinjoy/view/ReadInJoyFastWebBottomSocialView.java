  ...
  implements View.OnClickListener, View.OnLongClickListener
{
  ...
  private static final String jdField_c_of_type_JavaLangString = amtj.a(2131712147);
  private static final String jdField_d_of_type_JavaLangString = amtj.a(2131711915);
  public int a;
  ...
  pti jdField_a_of_type_Pti = new smm(this);
    ...
    try
    {
      ...
      if (localObject1 != null)
      {
        ...
        if (j != 1)
        {
          ...
          this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131379531));
          this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131379530));
          this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131369200));
          this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131369284));
          this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131379694));
          this.jdField_d_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131363565));
          this.e = ((TextView)findViewById(2131379494));
          this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
          this.jdField_a_of_type_AndroidViewView = findViewById(2131380413);
          this.jdField_b_of_type_AndroidViewView = findViewById(2131380414);
          this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131364860));
          this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131369924));
          this.jdField_b_of_type_AndroidWidgetLinearLayout.setOnClickListener(this);
          this.jdField_c_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131364704));
          this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131369198));
          this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131379524));
          ...
          this.f = ((TextView)findViewById(2131379529));
          this.g = ((TextView)findViewById(2131379693));
          return;
        }
      }
    }
  ...
  private boolean a(oww paramoww)
  {
    if (this.jdField_a_of_type_Ows == null) {
      this.jdField_a_of_type_Ows = new ows(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebFastWebActivity, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo);
    }
    if ((!this.jdField_a_of_type_Ows.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.innerUniqueID)) && (pcj.b()))
    {
      if (this.jdField_c_of_type_AndroidViewView == null) {
        this.jdField_c_of_type_AndroidViewView = ((ViewStub)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebFastWebActivity.findViewById(2131375937)).inflate();
      }
      this.jdField_a_of_type_Ows.a(new smn(this, paramoww));
      this.jdField_c_of_type_AndroidViewView.setVisibility(0);
      this.jdField_a_of_type_Ows.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo);
      this.jdField_a_of_type_Ows.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebFastWebActivity.getWindow().getDecorView());
      return true;
    }
    return false;
  }
  ...
  private void b()
  {
    ...
    this.jdField_a_of_type_AndroidViewAnimationAnimation.setAnimationListener(new sml(this));
    this.jdField_b_of_type_AndroidWidgetImageView.startAnimation(this.jdField_a_of_type_AndroidViewAnimationAnimation);
  }
  
  private void b(boolean paramBoolean)
  {
    oto.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebFastWebActivity, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo, null, 4, "", null, false, null, -1, paramBoolean);
    String str = new otr(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo, null).a(1).a();
    ...
    for (str = "2";; str = "1")
    {
      swy.a(localArticleInfo1, "0X8008990", pay.a(localContext, localArticleInfo2, i, str).toString());
      return;
    }
  }
  ...
  private void c()
  {
    ...
    ptf.a().a(localArrayList, this.jdField_a_of_type_Pti);
  }
  ...
  private void c(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      str = bkwm.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebUtilFastWebArticleInfo.b, 99990000L, "9999万+", jdField_c_of_type_JavaLangString);
      if (this.f != null)
      {
  ...
  private void d()
  {
    ...
    for (;;)
    {
      ...
      return;
      getResources().getDimension(2131298767);
      this.f.setTextColor(Color.parseColor("#FF4222"));
      this.f.setBackgroundResource(2130842769);
      this.g.setBackgroundResource(2130842769);
    }
  }
  ...
  private void d(boolean paramBoolean)
  {
    ...
    {
      ptf.a();
      ptf.a(this.jdField_a_of_type_AndroidContentContext, false);
    }
    ...
    if (paramBoolean)
    {
      ...
      this.jdField_a_of_type_Aadf = new aadf((QQAppInterface)pay.a(), (Activity)localObject);
      this.jdField_a_of_type_Aadf.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo);
      this.jdField_a_of_type_Aadf.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mArticleContentUrl, 9, false);
    ...
    for (;;)
    {
      try
      {
        ...
        odq.a(null, "", "0X8009D0F", "0X8009D0F", 0, 0, "", this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mArticleID + "", "", ((JSONObject)localObject).toString(), false);
        return;
      }
      catch (Exception localException)
      {
      ...
      ptf.a().a(localException, localQQAppInterface.getAccount(), 1, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.innerUniqueID, (ArrayList)this.jdField_a_of_type_JavaUtilHashMap.get(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.innerUniqueID));
      break;
      label343:
      i = 0;
    }
  ...
  private void f(boolean paramBoolean)
  {
    ...
    for (String str = amtj.a(2131712167);; str = amtj.a(2131711890))
    {
  ...
  public void a(int paramInt)
  {
    ...
    String str = bkwm.a(paramInt, 99990000L, "9999万+", jdField_d_of_type_JavaLangString);
    if (this.g != null) {
      if (this.jdField_b_of_type_Boolean)
      {
        int j = 8;
  ...
  public void b(long paramLong)
  {
    ...
    if (bkwm.j(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebFastWebActivity.getAppRuntime()) == 0)
    {
      this.e.setText(bkwm.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebUtilFastWebArticleInfo.c, 99990000L, "9999万+", "Biu"));
  ...
  public void onClick(View paramView)
  {
    ...
    {
      swy.a(localArticleInfo1, "0X8008991", pay.a(localContext, localArticleInfo2, i, (String)localObject, 0).toString());
      break;
      if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebFastWebActivity == null) || (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo == null) || (a(new smk(this)))) {
        break;
      }
      b(true);
      break;
      if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebFastWebActivity != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo != null))
      {
        ...
        {
          swy.a(localArticleInfo1, "0X8008990", pay.a(localContext, localArticleInfo2, i, (String)localObject).toString());
          break;
        }
      }
      ...
      if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebUtilFastWebArticleInfo.jdField_a_of_type_Boolean)
      {
        ...
        swy.b(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo, "0X8009765", "1");
      }
      for (;;)
      {
        b();
        ...
        pkp.a().c();
        pkm.a().a(pay.a(), this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebUtilFastWebArticleInfo.jdField_a_of_type_Boolean, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebUtilFastWebArticleInfo);
        break;
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebUtilFastWebArticleInfo.jdField_a_of_type_Boolean = true;
        localObject = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebUtilFastWebArticleInfo;
        ((FastWebArticleInfo)localObject).jdField_a_of_type_Int += 1;
        swy.b(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo, "0X8009764", "1");
      }
      bool = false;
      break label140;
    }
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    {
      swy.a(localArticleInfo1, "0X8008991", pay.a(localContext, localArticleInfo2, i, paramView, 0).toString());
      return false;
      bool = false;
      break;
    }
