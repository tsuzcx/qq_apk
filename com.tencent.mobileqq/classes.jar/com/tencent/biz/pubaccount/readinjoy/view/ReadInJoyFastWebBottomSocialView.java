  ...
  implements View.OnClickListener, View.OnLongClickListener
{
  ...
  private static final String jdField_c_of_type_JavaLangString = anvx.a(2131712494);
  private static final String jdField_d_of_type_JavaLangString = anvx.a(2131712262);
  public int a;
  ...
  qef jdField_a_of_type_Qef = new szw(this);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = anvx.a(2131712293);
    jdField_b_of_type_JavaLangString = anvx.a(2131712483);
  }
    ...
    try
    {
      ...
      if (localObject1 != null)
      {
        ...
        if (j != 1)
        {
          ...
          this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131379842));
          this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131379841));
          this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131369363));
          this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131369451));
          this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131380008));
          this.jdField_d_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131363634));
          this.e = ((TextView)findViewById(2131379803));
          this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
          this.jdField_a_of_type_AndroidViewView = findViewById(2131380752);
          this.jdField_b_of_type_AndroidViewView = findViewById(2131380753);
          this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131364947));
          this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131370094));
          this.jdField_b_of_type_AndroidWidgetLinearLayout.setOnClickListener(this);
          this.jdField_c_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131364791));
          this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131369361));
          this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131379835));
          ...
          this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyLogicKandianFavoriteBroadcastReceiver = new KandianFavoriteBroadcastReceiver(this.jdField_a_of_type_Qef);
          ...
          this.f = ((TextView)findViewById(2131379840));
          this.g = ((TextView)findViewById(2131380007));
          return;
        }
      }
    }
  ...
  private boolean a(pfw parampfw)
  {
    if (this.jdField_a_of_type_Pfs == null) {
      this.jdField_a_of_type_Pfs = new pfs(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebFastWebActivity, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo);
    }
    if ((!this.jdField_a_of_type_Pfs.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.innerUniqueID)) && (plk.b()))
    {
      if (this.jdField_c_of_type_AndroidViewView == null) {
        this.jdField_c_of_type_AndroidViewView = ((ViewStub)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebFastWebActivity.findViewById(2131376184)).inflate();
      }
      this.jdField_a_of_type_Pfs.a(new szx(this, parampfw));
      this.jdField_c_of_type_AndroidViewView.setVisibility(0);
      this.jdField_a_of_type_Pfs.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo);
      this.jdField_a_of_type_Pfs.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebFastWebActivity.getWindow().getDecorView());
      return true;
    }
    return false;
  }
  ...
  private void b()
  {
    ...
    this.jdField_a_of_type_AndroidViewAnimationAnimation.setAnimationListener(new szv(this));
    this.jdField_b_of_type_AndroidWidgetImageView.startAnimation(this.jdField_a_of_type_AndroidViewAnimationAnimation);
  }
  
  private void b(boolean paramBoolean)
  {
    pbq.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebFastWebActivity, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo, null, 4, "", null, false, null, -1, paramBoolean);
    String str = new pbu(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo, null).a(1).a();
    ...
    for (str = "2";; str = "1")
    {
      tkj.a(localArticleInfo1, "0X8008990", pqf.a(localContext, localArticleInfo2, i, str).toString());
      return;
    }
  }
  ...
  private void c()
  {
    ...
    qec.a().a(localArrayList, this.jdField_a_of_type_Qef);
  }
  ...
  private void c(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      str = bmhv.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebUtilFastWebArticleInfo.b, 99990000L, "9999万+", jdField_c_of_type_JavaLangString);
      if (this.f != null)
      {
  ...
  private void d()
  {
    ...
    for (;;)
    {
      ...
      return;
      getResources().getDimension(2131298771);
      this.f.setTextColor(Color.parseColor("#FF4222"));
      this.f.setBackgroundResource(2130842801);
      this.g.setBackgroundResource(2130842801);
    }
  }
  ...
  private void d(boolean paramBoolean)
  {
    ...
    {
      qec.a();
      qec.a(this.jdField_a_of_type_AndroidContentContext, false);
    }
    ...
    if (paramBoolean)
    {
      ...
      this.jdField_a_of_type_Aasr = new aasr((QQAppInterface)pkh.a(), (Activity)localObject);
      this.jdField_a_of_type_Aasr.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo);
      this.jdField_a_of_type_Aasr.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mArticleContentUrl, 9, false);
    ...
    for (;;)
    {
      try
      {
        ...
        olh.a(null, "", "0X8009D0F", "0X8009D0F", 0, 0, "", this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mArticleID + "", "", ((JSONObject)localObject).toString(), false);
        return;
      }
      catch (Exception localException)
      {
      ...
      qec.a().a(localException, localQQAppInterface.getAccount(), 1, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.innerUniqueID, (ArrayList)this.jdField_a_of_type_JavaUtilHashMap.get(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.innerUniqueID));
      break;
      label343:
      i = 0;
    }
  ...
  private void f(boolean paramBoolean)
  {
    ...
    for (String str = anvx.a(2131712514);; str = anvx.a(2131712237))
    {
  ...
  public void a(int paramInt)
  {
    ...
    String str = bmhv.a(paramInt, 99990000L, "9999万+", jdField_d_of_type_JavaLangString);
    if (this.g != null) {
      if (this.jdField_b_of_type_Boolean)
      {
        int j = 8;
  ...
  public void b(long paramLong)
  {
    ...
    if (bmhv.j(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebFastWebActivity.getAppRuntime()) == 0)
    {
      this.e.setText(bmhv.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebUtilFastWebArticleInfo.c, 99990000L, "9999万+", "Biu"));
  ...
  public void onClick(View paramView)
  {
    ...
    {
      tkj.a(localArticleInfo1, "0X8008991", pqf.a(localContext, localArticleInfo2, i, (String)localObject, 0).toString());
      break;
      if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebFastWebActivity == null) || (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo == null) || (a(new szu(this)))) {
        break;
      }
      b(true);
      break;
      if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebFastWebActivity != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo != null))
      {
        ...
        {
          tkj.a(localArticleInfo1, "0X8008990", pqf.a(localContext, localArticleInfo2, i, (String)localObject).toString());
          break;
        }
      }
      ...
      if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebUtilFastWebArticleInfo.jdField_a_of_type_Boolean)
      {
        ...
        tkj.b(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo, "0X8009765", "1");
      }
      for (;;)
      {
        b();
        ...
        pvm.a().c();
        pvj.a().a(pkh.a(), this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebUtilFastWebArticleInfo.jdField_a_of_type_Boolean, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebUtilFastWebArticleInfo);
        break;
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebUtilFastWebArticleInfo.jdField_a_of_type_Boolean = true;
        localObject = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebUtilFastWebArticleInfo;
        ((FastWebArticleInfo)localObject).jdField_a_of_type_Int += 1;
        tkj.b(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo, "0X8009764", "1");
      }
      bool = false;
      break label140;
    }
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    {
      tkj.a(localArticleInfo1, "0X8008991", pqf.a(localContext, localArticleInfo2, i, paramView, 0).toString());
      return false;
      bool = false;
      break;
    }
