...
final class FastWebRequestUtil$6
  implements Runnable
{
  FastWebRequestUtil$6(ArticleInfo paramArticleInfo, ReadInJoyFeedbackPopupWindow.FeedbackCallback paramFeedbackCallback) {}
  ...
  public void run()
  {
    try
    {
      ...
      if (str2 == null) {}
      for (localObject1 = "";; localObject1 = ReadInJoyWebDataManager.a(str2))
      {
