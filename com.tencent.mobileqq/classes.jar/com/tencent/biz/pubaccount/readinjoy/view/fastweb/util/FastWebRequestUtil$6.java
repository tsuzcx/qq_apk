...
public final class FastWebRequestUtil$6
  implements Runnable
{
  public FastWebRequestUtil$6(ArticleInfo paramArticleInfo, sjc paramsjc) {}
  ...
  public void run()
  {
    try
    {
      ...
      if (str2 == null) {}
      for (localObject = "";; localObject = qzi.a(str2))
      {
        ...
        localObject = new String(ndd.a(BaseApplicationImpl.getContext(), "https://kandian.qq.com/qz_kandian_social/kandian_ext/deleteFeeds", "GET", localBundle, (Bundle)localObject));
