...
public class ReadInJoyTabTopSearchHeaderController
  implements View.OnClickListener, ReadinjoyTabFrame.CallHotwordChange
{
  public static int a;
  ...
  public ReadInJoyTabTopSearchHeaderController(Context paramContext, ViewGroup paramViewGroup)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131380586));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131380585));
    this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131363581));
  ...
  protected void a()
  {
    ...
    for (;;)
    {
      ...
      return;
      this.jdField_a_of_type_AndroidWidgetTextView.setText(2131718907);
      this.jdField_b_of_type_AndroidWidgetTextView.setText(2131718907);
    }
  }
  ...
  protected void a(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    if (!SearchEntryConfigManager.a((QQAppInterface)localObject1))
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(2131718907);
      this.jdField_b_of_type_AndroidWidgetTextView.setText(2131718907);
      return;
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel$HotSearchItem.showType == 3)
    {
      ...
      {
        i = 1;
        bool = SearchEntryConfigManager.a((QQAppInterface)localObject1, (String)localObject2, i);
    ...
    else
    {
      ...
      if ((paramInt1 != -1) && (paramInt2 != -1))
      {
        ...
        localObject1 = "1";
        label446:
        UniteSearchReportController.a(null, ((ReportModelDC02528)localObject2).ver1((String)localObject1).obj3(paramInt2 + ""));
    ...
    for (;;)
    {
      try
      {
        ((RIJTransMergeKanDianReport.ReportR5Builder)localObject2).a("channelid", paramInt2 + "");
        if (paramInt1 != 0) {
          continue;
        }
        localObject1 = "1";
        ((RIJTransMergeKanDianReport.ReportR5Builder)localObject2).a("refresh_way", (String)localObject1);
      }
      ...
      a("0X800A4C5", ((RIJTransMergeKanDianReport.ReportR5Builder)localObject2).a());
  ...
  public void onClick(View paramView)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel$HotSearchItem == null)
    {
      localObject1 = "";
      label119:
      UniteSearchReportController.a(localQQAppInterface, ((ReportModelDC02528)localObject2).ver4((String)localObject1).ver7("{experiment_id:" + UniteSearchReportController.jdField_b_of_type_JavaLangString + ",source:" + SearchEntryConfigManager.jdField_b_of_type_JavaLangString + "}"));
      ...
      localObject2 = "";
      label224:
      localUniteSearchHandler.b(localQQAppInterface, "clk_default_word", "search_box", str, (String)localObject1, (String)localObject2, "{experiment_id:" + UniteSearchReportController.jdField_b_of_type_JavaLangString + ",source:" + SearchEntryConfigManager.jdField_b_of_type_JavaLangString + "}");
      this.jdField_b_of_type_Int = 1;
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.view.headers.ReadInJoyTabTopSearchHeaderController
