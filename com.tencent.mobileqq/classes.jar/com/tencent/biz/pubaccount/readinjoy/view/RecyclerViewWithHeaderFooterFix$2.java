  ...
  extends RecyclerView.RecycledViewPool
{
  ...
  public RecyclerView.ViewHolder getRecycledView(int paramInt)
  {
    ...
    if ((localViewHolder != null) && ((localObject instanceof RecyclerViewHeaderViewAdapter)))
    {
      ...
      else if ((((RecyclerViewHeaderViewAdapter)localObject).c(paramInt)) && (!RecyclerViewWithHeaderFooterFix.b(this.a).contains(localViewHolder.itemView)))
      {
        putRecycledView(localViewHolder);
        return null;
      }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.view.RecyclerViewWithHeaderFooterFix.2
