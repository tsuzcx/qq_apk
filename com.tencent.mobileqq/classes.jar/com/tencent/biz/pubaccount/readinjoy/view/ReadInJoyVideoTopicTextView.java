  ...
  extends TextView
{
  ...
  private void a(int paramInt)
  {
    ...
    int j = DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 5.5F);
    int i;
    if (paramInt == 1)
    {
      ...
      i = DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 4.5F);
      setTextSize(2, 12.0F);
    }
    for (;;)
    {
      ...
      if (paramInt == 2)
      {
        ...
        setHeight(DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 27.0F));
        setTextSize(2, 14.0F);
        i = j;
      }
    }
  ...
  public int a()
  {
    ...
    return localRect.width() + DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 8.0F) * 2;
  }
