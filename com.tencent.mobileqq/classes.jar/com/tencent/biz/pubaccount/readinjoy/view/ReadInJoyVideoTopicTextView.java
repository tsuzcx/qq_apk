  ...
  extends TextView
{
  ...
  private void a(int paramInt)
  {
    ...
    int j = DisplayUtil.a(this.jdField_a_of_type_AndroidContentContext, 5.5F);
    int i;
    if (paramInt == 1)
    {
      localObject = getResources().getDrawable(2130843407);
      ...
      i = DisplayUtil.a(this.jdField_a_of_type_AndroidContentContext, 4.5F);
      setTextSize(2, 12.0F);
    }
    for (;;)
    {
      ...
      setPadding(DisplayUtil.a(this.jdField_a_of_type_AndroidContentContext, 8.0F), i, DisplayUtil.a(this.jdField_a_of_type_AndroidContentContext, 8.0F), i);
      setClickable(true);
      setFocusable(true);
      setBackgroundResource(2130843404);
      setSingleLine(true);
      setGravity(17);
      return;
      i = j;
