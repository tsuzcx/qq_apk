  ...
  extends LinearLayout
{
  ...
  private ref jdField_a_of_type_Ref;
  private rek jdField_a_of_type_Rek;
  private rel jdField_a_of_type_Rel;
  private boolean jdField_a_of_type_Boolean;
  
  public ReadInJoyNavigationGridview(Context paramContext, rel paramrel)
  {
    super(paramContext);
    a(paramContext);
  ...
  private void a(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Ref = new ref(paramContext);
    ...
    this.jdField_a_of_type_AndroidWidgetGridView.setAdapter(this.jdField_a_of_type_Ref);
    this.jdField_a_of_type_AndroidViewView.setOnTouchListener(new rej(this));
  }
  
  private void b()
  {
    if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.size() > 0)) {
      this.jdField_a_of_type_Ref.a(this.jdField_a_of_type_JavaUtilList);
    }
  }
  
  public int a()
  {
    return this.jdField_a_of_type_Ref.getCount();
  }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Rek.removeMessages(1);
  }
  ...
  public void setChannelButtonListener(reh paramreh)
  {
    this.jdField_a_of_type_Ref.a(paramreh);
  }
