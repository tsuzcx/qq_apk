...
public class ReadInJoyBaseAdapter$44
  implements Runnable
{
  public void run()
  {
    try
    {
      if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo.mSubscribeID))
      {
        ...
        if (localObject != null) {
          if (!((aody)((AppInterface)localObject).getManager(56)).a(Long.valueOf(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo.mSubscribeID))) {
            break label151;
          }
        }
      }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.view.ReadInJoyBaseAdapter.44
