...
public class ReadInJoyFeedbackPopupWindow$3
  implements Runnable
{
  public ReadInJoyFeedbackPopupWindow$3(rsj paramrsj) {}
  
  public void run()
  {
    if (!rsj.a(this.this$0, "reportFeeds")) {}
    String str1;
    String str3;
    String str4;
    do
    {
      return;
      str1 = onh.c(rsj.a(this.this$0));
      str3 = onh.a();
      str4 = String.valueOf(rsj.a(this.this$0).publishUin);
    ...
    for (int i = 1;; i = 0)
    {
      ...
      try
      {
        ...
        if (i != 0)
        {
          ...
          String str2 = bdik.b(str1 + 200 + str5 + "jubao@article@123");
          localObject2 = str2;
          if (str2 != null)
          {
            localObject2 = str2;
