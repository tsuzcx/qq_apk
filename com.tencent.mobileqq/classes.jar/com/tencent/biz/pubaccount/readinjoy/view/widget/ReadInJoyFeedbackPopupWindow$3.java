...
public class ReadInJoyFeedbackPopupWindow$3
  implements Runnable
{
  public ReadInJoyFeedbackPopupWindow$3(siw paramsiw) {}
  
  public void run()
  {
    if (!siw.a(this.this$0, "reportFeeds")) {}
    String str1;
    String str3;
    String str4;
    do
    {
      return;
      str1 = ors.c(siw.a(this.this$0));
      str3 = ors.a();
      str4 = String.valueOf(siw.a(this.this$0).publishUin);
