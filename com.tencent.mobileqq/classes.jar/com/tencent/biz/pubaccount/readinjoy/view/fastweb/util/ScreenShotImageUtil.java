...
public class ScreenShotImageUtil
{
  ...
  public static Pair<String, Bitmap> a(String paramString1, int paramInt, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        int n = AIOUtils.a(0.5F, localResources);
        int i = AIOUtils.a(90.0F, localResources);
        ...
        if (k >= paramInt)
        {
          ...
          localCanvas.drawBitmap(BitmapFactory.decodeResource(localResources, 2130841842), AIOUtils.a(13.0F, localResources), AIOUtils.a(25.0F, localResources) + paramInt, localPaint);
          localPaint.setColor(-16777216);
          localPaint.setTextSize(AIOUtils.a(2, 18, localResources));
          localCanvas.drawText("QQ看点", AIOUtils.a(60.0F, localResources), AIOUtils.a(42.0F, localResources) + paramInt, localPaint);
          localPaint.setColor(Color.parseColor("#777777"));
          localPaint.setTextSize(AIOUtils.a(2, 14, localResources));
          localCanvas.drawText(localResources.getString(2131695247), AIOUtils.a(60.0F, localResources), AIOUtils.a(61.0F, localResources) + paramInt, localPaint);
      ...
      catch (Exception paramString1)
      {
        try
        {
          ...
          paramString1 = TroopShareUtility.a(paramString2, localResources, AIOUtils.a(80.0F, localResources), 0, false);
          paramString2 = paramString1;
          if (paramString1 == null)
          {
            if (QLog.isColorLevel()) {
            ...
            paramString2 = BitmapFactory.decodeResource(localResources, 2130841848);
          }
          localCanvas.drawBitmap(paramString2, j - AIOUtils.a(5.0F, localResources) - paramString2.getWidth(), AIOUtils.a(5.0F, localResources) + paramInt, localPaint);
  ...
  {
    // Byte code:
    //   0: new 344	java/io/File
    //   3: dup
    //   4: getstatic 350	com/tencent/mobileqq/app/AppConstants:SDCARD_PATH_PUBLIC_ACCOUNT_SCREENSHOTS	Ljava/lang/String;
    //   7: invokestatic 355	com/tencent/mobileqq/vfs/VFSAssistantUtils:getSDKPrivatePath	(Ljava/lang/String;)Ljava/lang/String;
    //   10: invokespecial 358	java/io/File:<init>	(Ljava/lang/String;)V
    //   13: astore_3
    //   14: aload_3
    //   15: invokevirtual 361	java/io/File:exists	()Z
    //   18: ifne +8 -> 26
    //   21: aload_3
    //   22: invokevirtual 364	java/io/File:mkdirs	()Z
    //   25: pop
    //   26: new 366	java/text/SimpleDateFormat
    //   29: dup
    //   30: ldc_w 368
    //   33: invokespecial 369	java/text/SimpleDateFormat:<init>	(Ljava/lang/String;)V
    //   36: new 371	java/util/Date
    //   39: dup
    //   40: invokestatic 83	java/lang/System:currentTimeMillis	()J
    //   43: invokespecial 374	java/util/Date:<init>	(J)V
    //   46: invokevirtual 378	java/text/SimpleDateFormat:format	(Ljava/util/Date;)Ljava/lang/String;
    //   49: astore_3
    //   50: new 70	java/lang/StringBuilder
    //   53: dup
    //   54: invokespecial 71	java/lang/StringBuilder:<init>	()V
    //   57: getstatic 350	com/tencent/mobileqq/app/AppConstants:SDCARD_PATH_PUBLIC_ACCOUNT_SCREENSHOTS	Ljava/lang/String;
    ...
    //   77: invokevirtual 90	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   80: invokestatic 355	com/tencent/mobileqq/vfs/VFSAssistantUtils:getSDKPrivatePath	(Ljava/lang/String;)Ljava/lang/String;
    //   83: astore 4
    //   85: new 344	java/io/File
    //   88: dup
    //   89: aload 4
    //   91: invokespecial 358	java/io/File:<init>	(Ljava/lang/String;)V
    //   94: astore_3
    //   95: aload 4
    //   97: astore_1
    //   98: aload_3
    //   99: invokevirtual 361	java/io/File:exists	()Z
    //   102: ifne +38 -> 140
    //   105: new 382	java/io/FileOutputStream
    //   108: dup
    //   109: aload_3
    //   110: invokespecial 385	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   113: astore_3
    //   114: aload_3
    //   115: astore_1
    //   116: aload_0
    //   117: getstatic 391	android/graphics/Bitmap$CompressFormat:PNG	Landroid/graphics/Bitmap$CompressFormat;
    //   120: bipush 100
    //   122: aload_3
    //   123: invokevirtual 395	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   126: istore_2
    //   127: iload_2
    //   128: ifeq +53 -> 181
    //   131: aload 4
    //   133: astore_0
    //   134: aload_3
    //   135: invokestatic 401	com/tencent/ttpic/baseutils/io/IOUtils:closeQuietly	(Ljava/io/OutputStream;)V
    //   138: aload_0
    //   139: astore_1
    //   140: aload_1
    //   141: areturn
    ...
    //   147: astore_1
    //   148: aload 4
    //   150: invokevirtual 59	java/lang/Exception:printStackTrace	()V
    //   153: aload_0
    //   154: invokestatic 401	com/tencent/ttpic/baseutils/io/IOUtils:closeQuietly	(Ljava/io/OutputStream;)V
    //   157: ldc_w 264
    //   160: areturn
    //   161: astore_0
    //   162: aconst_null
    //   163: astore_1
    //   164: aload_1
    //   165: invokestatic 401	com/tencent/ttpic/baseutils/io/IOUtils:closeQuietly	(Ljava/io/OutputStream;)V
    //   168: aload_0
    //   169: athrow
    //   170: astore_0
    //   171: goto -7 -> 164
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.view.fastweb.util.ScreenShotImageUtil
