  ...
  extends BaseItemViewHolder
{
  ...
  public void b(@NotNull BaseData paramBaseData1, @NotNull BaseData paramBaseData2, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      {
        NewPtsViewCreator localNewPtsViewCreator = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebItemNewPtsViewCreator;
        ...
        localPTSComposer.layoutToView((PTSItemView)paramBaseData1, (IPTSLiteEventListener)NewPtsViewCreator.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebItemNewPtsViewCreator), true);
      }
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebItemNewPtsViewCreator.a(false, paramBaseData2);
    }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.view.fastweb.item.NewPtsViewCreator.PTSLiteItemViewHolder
