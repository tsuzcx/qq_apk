...
public class AggregateAvatarUrlDrawable
  extends Drawable
  implements ReadInJoyUserInfoModule.RefreshUserInfoCallBack, Sizeable, URLDrawable.URLDrawableListener
{
  ...
  private void a()
  {
    ...
    try
    {
      localBitmap3 = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidContentResResources, 2130845075);
    ...
    {
      this.jdField_b_of_type_AndroidGraphicsBitmap = PuzzleAvatarUtil.a(localBitmap2, localBitmap3, 0.0F, 1.0F);
