...
public class RefreshAnimView$3$1
  implements Runnable
{
  public RefreshAnimView$3$1(rqx paramrqx) {}
  ...
  public void run()
  {
    ...
    if (this.a.jdField_a_of_type_Boolean) {
      RefreshAnimView.a(this.a.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewPullrefreshRefreshAnimView).setCompoundDrawablesWithIntrinsicBounds(2130848445, 0, 0, 0);
    }
    for (;;)
    {
      ...
      return;
      RefreshAnimView.a(this.a.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewPullrefreshRefreshAnimView).setCompoundDrawablesWithIntrinsicBounds(2130848446, 0, 0, 0);
    }
  }
}
