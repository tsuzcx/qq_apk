...
public class RefreshAnimView$3$1
  implements Runnable
{
  public RefreshAnimView$3$1(tnn paramtnn) {}
  ...
  public void run()
  {
    ...
    if (this.a.jdField_a_of_type_Boolean) {
      RefreshAnimView.a(this.a.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewPullrefreshRefreshAnimView).setCompoundDrawablesWithIntrinsicBounds(2130849453, 0, 0, 0);
    }
    for (;;)
    {
      ...
      return;
      RefreshAnimView.a(this.a.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewPullrefreshRefreshAnimView).setCompoundDrawablesWithIntrinsicBounds(2130849454, 0, 0, 0);
    }
  }
}
