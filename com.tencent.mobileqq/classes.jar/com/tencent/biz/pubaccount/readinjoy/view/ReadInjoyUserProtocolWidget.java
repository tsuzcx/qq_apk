...
{
  private static final String jdField_a_of_type_JavaLangString = HardCodeUtil.a(2131713095);
  ...
  private Drawable a()
  {
    float f = AIOUtils.a(3.0F, getContext().getResources());
  ...
  private SpannableString a()
  {
    ...
    localSpannableString.setSpan(new ReadInjoyUserProtocolWidget.1(this, Color.parseColor("#12B7F5")), i, "《QQ看点用户行为规范》".length() + i, 33);
  ...
  public static boolean a(BaseActivity paramBaseActivity, Runnable paramRunnable)
  {
    ...
    paramRunnable = new ReadInjoyUserProtocolWidget(paramBaseActivity, paramRunnable);
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    paramBundle = LayoutInflater.from(getContext()).inflate(2131560289, null);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramBundle.findViewById(2131365326));
    this.jdField_a_of_type_AndroidWidgetTextView.setFocusable(false);
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)paramBundle.findViewById(2131362353));
    this.jdField_a_of_type_AndroidViewView = paramBundle.findViewById(2131364832);
    ...
    paramBundle.findViewById(2131363590).setBackgroundDrawable(localDrawable);
    setContentView(paramBundle);
    paramBundle = getWindow().getAttributes();
    paramBundle.height = -2;
    paramBundle.width = AIOUtils.a(320.0F, getContext().getResources());
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.view.ReadInjoyUserProtocolWidget
