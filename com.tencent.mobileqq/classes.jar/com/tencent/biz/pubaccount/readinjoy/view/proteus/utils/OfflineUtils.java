...
public class OfflineUtils
{
  ...
  {
    OfflineUtils.ConfigData localConfigData = (OfflineUtils.ConfigData)jdField_a_of_type_JavaUtilMap.get(paramString);
    if (localConfigData != null) {
      return localConfigData;
    }
    localConfigData = new OfflineUtils.ConfigData();
    String str = OfflineEnvHelper.a(paramString);
    if (str == null)
    {
      QLog.d("OfflineUtils", 2, "checkOffLineProteusConfig: offline root dir is null");
      localConfigData.a = false;
      jdField_a_of_type_JavaUtilMap.put(paramString, localConfigData);
      return localConfigData;
    }
    str = str + paramString;
  ...
  {
    // Byte code:
    //   0: new 142	java/io/BufferedReader
    //   3: dup
    //   4: new 144	java/io/InputStreamReader
    //   7: dup
    //   8: aload_0
    //   9: invokespecial 147	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   12: invokespecial 150	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   15: astore_2
    ...
    //   33: aload_1
    //   34: aload_3
    //   35: invokevirtual 110	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   38: pop
    //   39: goto -15 -> 24
    //   42: astore_2
    //   43: ldc 88
    //   45: iconst_2
    //   46: ldc 155
    //   48: invokestatic 96	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   51: aload_0
    //   52: invokevirtual 160	java/io/InputStream:close	()V
    //   55: aload_1
    //   56: invokevirtual 114	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   59: areturn
    //   60: aload_0
    //   61: invokevirtual 160	java/io/InputStream:close	()V
    //   64: goto -9 -> 55
    //   67: astore_0
    //   68: goto -13 -> 55
    //   71: astore_1
    ...
    //   74: iconst_2
    //   75: ldc 162
    //   77: invokestatic 96	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   80: aload_0
    //   81: invokevirtual 160	java/io/InputStream:close	()V
    //   84: aconst_null
    //   85: areturn
    //   86: astore_0
    //   87: aconst_null
    ...
    //   89: astore_1
    //   90: aload_0
    //   91: invokevirtual 160	java/io/InputStream:close	()V
    //   94: aload_1
    //   95: athrow
    //   96: astore_0
    //   97: goto -42 -> 55
  ...
  public static List<String> a(java.io.InputStream paramInputStream)
  {
    ...
    //   12: invokespecial 150	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   15: astore_2
    //   16: new 177	java/util/ArrayList
    //   19: dup
    //   20: invokespecial 178	java/util/ArrayList:<init>	()V
    //   23: astore_1
    //   24: aload_2
    //   25: invokevirtual 153	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   28: astore_3
    ...
    //   47: iconst_2
    //   48: ldc 155
    //   50: invokestatic 96	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   53: aload_0
    //   54: invokevirtual 160	java/io/InputStream:close	()V
    //   57: aload_1
    //   58: areturn
    //   59: aload_0
    //   60: invokevirtual 160	java/io/InputStream:close	()V
    //   63: aload_1
    //   64: areturn
    //   65: astore_0
    //   66: aload_1
    ...
    //   71: iconst_2
    //   72: ldc 162
    //   74: invokestatic 96	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   77: aload_0
    //   78: invokevirtual 160	java/io/InputStream:close	()V
    //   81: aconst_null
    //   82: areturn
    //   83: astore_0
    //   84: aconst_null
    ...
    //   86: astore_1
    //   87: aload_0
    //   88: invokevirtual 160	java/io/InputStream:close	()V
    //   91: aload_1
    //   92: athrow
    //   93: astore_0
    //   94: aload_1
  ...
  public static boolean a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    {
      return false;
      paramString3 = a("8.5.5");
      paramString3.add(Integer.valueOf(Integer.parseInt("5105")));
  ...
  {
    String str = ReadInJoyHelper.a("default_feeds_proteus_offline_bid");
    FileUtils.a(OfflineEnvHelper.a(str) + str);
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes4.jar
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.view.proteus.utils.OfflineUtils
