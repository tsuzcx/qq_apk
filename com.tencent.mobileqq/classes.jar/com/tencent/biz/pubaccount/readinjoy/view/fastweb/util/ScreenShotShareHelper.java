  ...
  implements Handler.Callback, AdapterView.OnItemClickListener
{
  ...
  public ScreenShotShareHelper(Activity paramActivity)
  {
    ...
    this.jdField_b_of_type_Int = BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131299166);
  ...
  public String a()
  {
    String str2 = BaseApplicationImpl.getApplication().getString(2131719275);
    String str1 = str2;
    try
    {
  ...
  public List<ShareActionSheetBuilder.ActionSheetItem>[] a()
  {
    ...
    localActionSheetItem.label = BaseApplicationImpl.getContext().getString(2131696380);
    ...
    localActionSheetItem.label = BaseApplicationImpl.getContext().getString(2131696394);
    ...
    localArrayList.add(localActionSheetItem);
    localActionSheetItem = new ShareActionSheetBuilder.ActionSheetItem();
    localActionSheetItem.label = BaseApplicationImpl.getContext().getString(2131696401);
    localActionSheetItem.icon = 2130839218;
    localActionSheetItem.action = 9;
    localActionSheetItem.argus = "";
    localArrayList.add(localActionSheetItem);
    localActionSheetItem = new ShareActionSheetBuilder.ActionSheetItem();
    localActionSheetItem.label = BaseApplicationImpl.getContext().getString(2131696383);
    localActionSheetItem.icon = 2130839212;
    localActionSheetItem.action = 10;
    localActionSheetItem.argus = "";
    localArrayList.add(localActionSheetItem);
    localActionSheetItem = new ShareActionSheetBuilder.ActionSheetItem();
    localActionSheetItem.label = BaseApplicationImpl.getContext().getString(2131696398);
  ...
  public void b()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        return;
        this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder.setActionSheetTitle(BaseApplicationImpl.getContext().getString(2131719311));
      }
      catch (Exception localException)
      {
        for (;;)
  ...
  public void c()
  {
    ...
    if ((!this.jdField_a_of_type_Boolean) && (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)))
    {
      ...
      QZoneHelper.forwardToPublishMood(this.jdField_a_of_type_AndroidAppActivity, localUserInfo, this.jdField_a_of_type_JavaLangString, BaseApplicationImpl.getContext().getString(2131720697), "", -1);
      return;
    }
  ...
  public void d(String paramString)
  {
    ...
    if (TextUtils.isEmpty(this.jdField_d_of_type_JavaLangString))
    {
      ...
      str = BaseApplicationImpl.getContext().getResources().getString(2131695243);
      label115:
    ...
    for (paramString = paramString.concat("|1");; paramString = paramString.concat("|0"))
    {
      ...
      localIntent.putExtra("brief_key", HardCodeUtil.a(2131713536));
  ...
  public void g()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = BaseApplicationImpl.getContext().getResources().getString(2131695243);
      ...
      catch (PackageManager.NameNotFoundException localNameNotFoundException)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.dismiss();
        QQToast.a(BaseApplicationImpl.getContext(), 0, 2131695249, 0).b(BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131299166));
        continue;
      }
      if (QLog.isColorLevel()) {
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.view.fastweb.util.ScreenShotShareHelper
