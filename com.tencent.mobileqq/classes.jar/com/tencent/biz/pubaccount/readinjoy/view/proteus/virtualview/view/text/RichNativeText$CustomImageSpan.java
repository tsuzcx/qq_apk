...
class RichNativeText$CustomImageSpan
  extends ImageSpan
{
  public static final int ALIGN_VERTICAL_CENTER = 101;
  private WeakReference<Drawable> mDrawableRef;
  
  RichNativeText$CustomImageSpan(RichNativeText paramRichNativeText, @NonNull Drawable paramDrawable, int paramInt)
  {
  ...
  public void draw(@NonNull Canvas paramCanvas, CharSequence paramCharSequence, int paramInt1, int paramInt2, float paramFloat, int paramInt3, int paramInt4, int paramInt5, @NonNull Paint paramPaint)
  {
    ...
    for (;;)
    {
      ...
      {
        paramInt3 = paramInt5 / 2 - paramCharSequence.getBounds().bottom / 2 - RichNativeText.access$000(this.this$0) / 2;
        paramInt1 = paramInt3;
        if (paramInt3 <= 0) {
          paramInt1 = paramInt2 - paramPaint.getFontMetricsInt().descent;
        }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.view.proteus.virtualview.view.text.RichNativeText.CustomImageSpan
