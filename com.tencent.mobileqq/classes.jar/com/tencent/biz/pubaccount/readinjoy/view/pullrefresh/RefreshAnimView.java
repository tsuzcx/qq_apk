  ...
  extends RelativeLayout
{
  ...
  public RefreshAnimView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    inflate(paramContext, 2131562748, this);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131370565));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131376465));
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewPullrefreshRefreshEyeView = ((RefreshEyeView)findViewById(2131376459));
  ...
  public void a(boolean paramBoolean, String paramString)
  {
    ...
    localScaleAnimation.setAnimationListener(new tnn(this, paramString, paramBoolean));
