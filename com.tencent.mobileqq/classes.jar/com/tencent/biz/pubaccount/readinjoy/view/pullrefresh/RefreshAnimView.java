  ...
  extends RelativeLayout
{
  ...
  public RefreshAnimView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    inflate(paramContext, 2131562677, this);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131370382));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131376217));
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewPullrefreshRefreshEyeView = ((RefreshEyeView)findViewById(2131376211));
  ...
  public void a(boolean paramBoolean, String paramString)
  {
    ...
    localScaleAnimation.setAnimationListener(new taf(this, paramString, paramBoolean));
