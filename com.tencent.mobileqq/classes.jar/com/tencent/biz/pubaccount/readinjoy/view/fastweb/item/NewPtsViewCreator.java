  ...
  implements ItemCreator
{
  ...
  private final PtsItemViewEventListener jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebItemPtsItemViewEventListener = new PtsItemViewEventListener();
  ...
  static
  {
    jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebItemNewPtsViewCreator$Companion = new NewPtsViewCreator.Companion(null);
  }
  ...
  @NotNull
  public BaseItemViewHolder a(@NotNull Context paramContext, @NotNull BaseData paramBaseData, @NotNull ViewGroup paramViewGroup)
  {
    ...
    if (paramViewGroup != null) {
      paramViewGroup.layoutToView(paramContext, (IPTSLiteEventListener)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebItemPtsItemViewEventListener, true);
    }
  ...
  public final void a()
  {
    ...
    QLog.i("NewPtsViewCreator", 1, "[initPtsLiteTypeCount], view type count = " + BaseItemViewHolder.a);
  }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.view.fastweb.item.NewPtsViewCreator
