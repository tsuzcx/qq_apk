  ...
  implements ReadInJoyFeedsHeaderViewController.GifPlayOnceEventMultiCaster.GifStateListener, URLDrawable.URLDrawableListener
{
  ...
  void a(ChannelCoverInfo paramChannelCoverInfo, View.OnClickListener paramOnClickListener)
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyCapsuleView.setOnClickListener(new ReadInJoyFeedsHeaderViewController.CapsuleViewStateController.1(this, paramOnClickListener));
    if ((TextUtils.isEmpty(paramChannelCoverInfo.externalExposureBackgroundUrl)) || (ReadInJoyHelper.c(paramChannelCoverInfo.mChannelCoverId)))
    {
      c();
      return;
    }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.view.headers.ReadInJoyFeedsHeaderViewController.CapsuleViewStateController
