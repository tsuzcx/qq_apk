...
public class FastWebPTSUtils
{
  ...
  public static int a(String paramString, Map<Long, FollowingMember> paramMap)
  {
    ...
    {
      paramString = (FollowingMember)paramMap.get(Long.valueOf(paramString));
      if (paramString != null)
      {
        if (paramString.a()) {
          return 1;
  ...
  public static Float a()
  {
    return (Float)ReadInJoyHelper.a("readinjoy_font_size_ratio_sp", Float.valueOf(1.0F));
  }
  ...
  public static void a(Context paramContext, ArticleInfo paramArticleInfo, String paramString, FastWebArticleInfo paramFastWebArticleInfo, boolean paramBoolean)
  {
    ...
    paramFastWebArticleInfo = b(paramContext, paramArticleInfo, paramFastWebArticleInfo, paramArticleInfo.mChannelID);
    if ((localReadInJoyUserInfo != null) && (localReadInJoyUserInfo.isLiving()))
    {
      ...
      ReportUtil.a(paramArticleInfo, "", paramFastWebArticleInfo.toString());
      ReportUtil.a(paramArticleInfo, paramContext, paramFastWebArticleInfo.toString());
      return;
    }
    RIJJumpUtils.a(paramString, paramArticleInfo);
    if (paramBoolean) {}
    for (;;)
    {
      RIJJsonUtils.a(paramFastWebArticleInfo, "is_intensify", Integer.valueOf(i));
  ...
  public static void a(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, long paramLong, String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ReadinjoyReportUtils.a(paramArticleInfo, ReadinjoyReportUtils.d, paramBoolean, "");
        ...
        paramFastWebArticleInfo = new FastWebPTSUtils.1(paramArticleInfo, paramFastWebArticleInfo, paramBoolean);
        if (RIJItemViewType.g(paramArticleInfo))
        {
          i = 2;
          localUserOperationModule.a((String)localObject, paramLong, true, paramString, paramFastWebArticleInfo, i);
          return;
        }
      }
  ...
  public static void a(List<BaseData> paramList)
  {
    ...
    } while ((((ProteusItemData)localObject).x != 1) || (((ProteusItemData)localObject).e));
  ...
  {
    if ((paramBaseData.s == 26) && ((paramBaseData instanceof ProteusItemData)) && (((ProteusItemData)paramBaseData).x == 1)) {}
  ...
  private static JSONObject b(Context paramContext, ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, long paramLong)
  {
    ...
    for (paramFastWebArticleInfo = "2";; paramFastWebArticleInfo = "1") {
      return RIJTransMergeKanDianReport.a(paramContext, paramArticleInfo, i, paramFastWebArticleInfo);
    }
  }
}
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.view.fastweb.util.FastWebPTSUtils
