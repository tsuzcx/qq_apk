...
public class ShortContentWithLinkSpan
{
  public static CharSequence a(String paramString1, String paramString2, String paramString3, String paramString4, ArticleInfo paramArticleInfo)
  {
    ...
    {
      paramString4.setBounds(0, 0, DisplayUtil.b(BaseApplicationImpl.getContext(), 17.0F), DisplayUtil.b(BaseApplicationImpl.getContext(), 17.0F));
      ...
      paramString3.setSpan(new ShortContentWithLinkSpan.1(-15504151, 16777215, 860716207, paramString2, paramArticleInfo), 0, paramString1.length(), 33);
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.view.text.ShortContentWithLinkSpan
