...
public class ReadinjoyTabFrame$28$1
  implements Runnable
{
  public ReadinjoyTabFrame$28$1(qut paramqut, oidb_0x5bd.GuideInfo paramGuideInfo1, int paramInt, oidb_0x5bd.RefreshInfo paramRefreshInfo, oidb_0x5bd.SkinInfo paramSkinInfo, oidb_0x5bd.GuideInfo paramGuideInfo2) {}
  
  public void run()
  {
    int j = (int)(System.currentTimeMillis() / 1000L);
    Object localObject2 = (png)this.jdField_a_of_type_Qut.a.a.getManager(271);
    Object localObject1;
    Object localObject4;
    int i;
    if (this.jdField_a_of_type_TencentImOidbCmd0x5bdOidb_0x5bd$GuideInfo.has())
    {
      ...
      localObject3 = this.jdField_a_of_type_Qut.a.a.getEntityManagerFactory().createEntityManager();
      ...
      this.jdField_a_of_type_Qut.a.a(271, "operation_guide", (BaseResData)localObject3);
      ReadinjoyTabFrame.a(this.jdField_a_of_type_Qut.a, true);
      npl.a().a(4);
    }
    for (;;)
    {
      ...
      break;
      label298:
      if ((j <= ((GuideData)localObject3).endTime) && (badq.h(this.jdField_a_of_type_Qut.a.a()))) {
    ...
    label346:
    Object localObject3 = (pnh)this.jdField_a_of_type_Qut.a.a.getManager(270);
    if (this.jdField_a_of_type_TencentImOidbCmd0x5bdOidb_0x5bd$RefreshInfo.has())
    {
      ...
      localObject2 = ((pnh)localObject3).a(this.jdField_a_of_type_Qut.a.a(), this.jdField_a_of_type_Int);
      if (QLog.isColorLevel())
      {
      ...
      if (localObject2 != null)
      {
        baig.f(this.jdField_a_of_type_Qut.a.a(), this.jdField_a_of_type_Qut.a.a.getCurrentAccountUin(), null, this.jdField_a_of_type_Int);
        bace.b(pof.a());
      ...
      if (localObject1 != null)
      {
        ...
        baig.f(this.jdField_a_of_type_Qut.a.a(), this.jdField_a_of_type_Qut.a.a.getCurrentAccountUin(), ((RefreshData)localObject1).toJson().toString(), this.jdField_a_of_type_Int);
      }
      ...
      localObject3 = (pnn)this.jdField_a_of_type_Qut.a.a.getManager(261);
      if ((ReadinjoyTabFrame.b(this.jdField_a_of_type_Qut.a)) || (localObject4 == null) || (j < ((GuideData)localObject4).beginTime) || (j > ((GuideData)localObject4).endTime)) {
        break label1061;
      }
      this.jdField_a_of_type_Qut.a.a(261, "", (BaseResData)localObject4);
      label750:
      localObject4 = ((pnn)localObject3).a(this.jdField_a_of_type_Qut.a.a());
      if ((localObject1 != null) || (((pnn)localObject3).a() != 1)) {
        break label1113;
      }
      ReadinjoyTabFrame.a(this.jdField_a_of_type_Qut.a, ((pnn)localObject3).a());
      baig.r(this.jdField_a_of_type_Qut.a.a(), this.jdField_a_of_type_Qut.a.a.getCurrentAccountUin(), null);
      if ((localObject2 != null) && (j <= ((RefreshData)localObject2).endTime))
      {
        ((RefreshData)localObject2).isShown = true;
        baig.f(this.jdField_a_of_type_Qut.a.a(), this.jdField_a_of_type_Qut.a.a.getCurrentAccountUin(), ((RefreshData)localObject2).toJson().toString(), this.jdField_a_of_type_Int);
      }
    }
    label887:
    while ((localObject1 == null) || (localObject4 == null) || (!((SkinData)localObject4).id.equals(((SkinData)localObject1).id)) || (((SkinData)localObject4).seq == ((SkinData)localObject1).seq))
    {
      ...
      ((pnh)localObject3).a(0, "", -1L, this.jdField_a_of_type_Int);
      bace.b(pof.a());
      ((pnh)localObject3).a((RefreshData)localObject1, this.jdField_a_of_type_Int);
      if (!QLog.isColorLevel()) {
        break label545;
      }
      ...
      localObject1 = null;
      break label627;
      if ((localObject4 == null) || (j > ((GuideData)localObject4).endTime) || (!badq.h(this.jdField_a_of_type_Qut.a.a()))) {
        break label750;
      }
    ...
    label950:
    label1113:
    baig.r(this.jdField_a_of_type_Qut.a.a(), this.jdField_a_of_type_Qut.a.a.getCurrentAccountUin(), ((SkinData)localObject1).toJson().toString());
    label1056:
    label1061:
    if (((SkinData)localObject1).id.equals(((pnn)localObject3).a()))
    {
      ReadinjoyTabFrame.a(this.jdField_a_of_type_Qut.a, ((SkinData)localObject1).id);
      return;
    }
