  ...
  implements qsb
{
  ...
  private ThreadLocal<Integer> jdField_a_of_type_JavaLangThreadLocal = new qtc(this);
  private qnt jdField_a_of_type_Qnt;
  private rec jdField_a_of_type_Rec;
  private red jdField_a_of_type_Red;
  public float[] a;
  public float[] b;
  protected boolean d;
  protected int e;
  ...
  private void c(boolean paramBoolean)
  {
    ...
    obz.b().post(new ReadInJoyXListView.3(this, paramBoolean));
  }
  ...
  private void d(int paramInt)
  {
    ...
    int k;
    if (pnh.b(getContext(), 0) != null)
    {
      k = 1;
      label42:
      if ((!(this.jdField_a_of_type_Rec instanceof ReadInJoySkinAnimManager)) || ((paramInt != 2) && (paramInt != 3)) || (this.jdField_d_of_type_Int != 0) || (k == 0)) {
        break label223;
      }
      k = 1;
      label75:
    ...
    for (;;)
    {
      ...
      if ((!this.jdField_e_of_type_Boolean) && (this.jdField_a_of_type_Rec != null)) {
        this.jdField_a_of_type_Rec.a();
      }
      if ((this.jdField_a_of_type_Rec == null) || (k == 0)) {
        break;
      }
      setOverScrollHeight(this.jdField_a_of_type_Rec.a());
      return;
      k = 0;
      break label42;
      k = 0;
  ...
  private void e(int paramInt)
  {
    ...
    {
      this.jdField_g_of_type_Boolean = false;
      if ((getAdapter() instanceof bejx)) {
        setAdapter(((bejx)getAdapter()).getWrappedAdapter());
      }
      for (;;)
      {
        d(1);
  ...
  private void g()
  {
    if ((this.jdField_a_of_type_Rec != null) && (!this.jdField_h_of_type_Boolean))
    {
      this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_Rec.a(this);
      setOverScrollHeader(this.jdField_a_of_type_Rec.a(this));
  ...
  public rec a(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Red != null) {
      this.jdField_a_of_type_Rec.a(this.jdField_a_of_type_Red);
    }
  ...
  public void a(int paramInt1, View paramView, ListView paramListView, int paramInt2)
  {
    ...
    while ((this.jdField_a_of_type_Rec == null) || (paramView != this.jdField_a_of_type_Rec.a(this)) || (this.jdField_e_of_type_Boolean)) {
      return;
    }
    this.jdField_a_of_type_Rec.a(paramInt2, this.jdField_f_of_type_Boolean);
  }
  ...
  protected void a(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_f_of_type_Int = ((int)babp.j());
  ...
  public void a(View paramView, ListView paramListView, int paramInt)
  {
    ...
    this.jdField_a_of_type_Rec.a(paramInt, this.mTouchMode);
  }
  ...
  {
    if ((this.jdField_a_of_type_Rec != null) && (this.jdField_f_of_type_Boolean))
    {
  ...
  public boolean a(int paramInt, View paramView, ListView paramListView)
  {
    ...
    } while ((this.jdField_f_of_type_Boolean) || (this.jdField_a_of_type_Rec == null) || (paramView != this.jdField_a_of_type_Rec.a(this)));
    if (!this.jdField_e_of_type_Boolean)
    {
      paramView = this.jdField_a_of_type_Rec;
      if (paramInt == 0) {
        break label108;
      }
    }
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      c(true);
      this.jdField_a_of_type_Qpp.a(this, paramInt);
      return true;
    }
  }
  ...
  {
    if (paramListView != this) {}
    while ((this.jdField_a_of_type_Rec == null) || (paramView != this.jdField_a_of_type_Rec.a(this)) || (this.jdField_f_of_type_Boolean) || (this.jdField_e_of_type_Boolean)) {
      return;
    }
    this.jdField_a_of_type_Rec.a(100, false);
  }
  ...
  public void c()
  {
    ...
    {
      this.jdField_a_of_type_Rec.d();
      this.jdField_a_of_type_Rec = null;
    }
  ...
  {
    if ((!this.jdField_f_of_type_Boolean) && (this.jdField_a_of_type_Rec != null) && (paramView == this.jdField_a_of_type_Rec.a(this)) && (!this.jdField_e_of_type_Boolean)) {
      this.jdField_a_of_type_Rec.c();
    }
  }
  ...
  {
    if ((this.jdField_a_of_type_Rec != null) && ((this.jdField_a_of_type_Rec instanceof ReadInJoySkinAnimManager))) {
      ((ReadInJoySkinAnimManager)this.jdField_a_of_type_Rec).e();
    }
  }
  ...
  {
    if ((this.jdField_a_of_type_Rec != null) && ((this.jdField_a_of_type_Rec instanceof ReadInJoySkinAnimManager))) {
      ((ReadInJoySkinAnimManager)this.jdField_a_of_type_Rec).f();
    }
  }
  ...
  public void i()
  {
    ...
    if (this.jdField_a_of_type_Qpp != null) {
      this.jdField_a_of_type_Qpp.b();
    }
    if ((!this.jdField_f_of_type_Boolean) && (this.jdField_a_of_type_Rec != null) && (!this.jdField_e_of_type_Boolean)) {
  ...
  {
    if (((paramView instanceof qns)) && (!((qns)paramView).a()))
    {
      ((qns)paramView).setIsResume(true);
      ((qns)paramView).a();
    }
    if ((paramView instanceof ProteusItemView))
    {
      paramView = (ProteusItemView)paramView;
      if ((paramView.a().a() != null) && (paramView.a().a().a() != null) && (paramView.a().a().a().mResolvedFeedType == 123) && (this.jdField_a_of_type_Qnt != null)) {
  ...
  public void onDetachChildView(View paramView)
  {
    if (((paramView instanceof qns)) && (((qns)paramView).a()))
    {
      ((qns)paramView).setIsResume(false);
      ((qns)paramView).b();
    }
    if ((paramView instanceof ProteusItemView))
    {
  ...
  public void onFinishInflate()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new Handler(new qte(this));
  }
  ...
  public void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    {
      ruf.a("KANDIAN_NEW_FEEDS_LOAD_ARTICLE_FINISH_TO_MEASURE", null);
      ruf.a(null, "KANDIAN_NEW_FEEDS_LIST_VIEW_GROUP_MEASURE_LAYOUT_DRAW");
  ...
  public void onScrollStateChanged(AbsListView paramAbsListView, int paramInt)
  {
    ...
    do
    {
      ...
      paramAbsListView = obz.a(getContext());
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    while ((this.jdField_a_of_type_Rec != null) && (this.jdField_a_of_type_Rec.a(paramMotionEvent)))
    {
      return true;
      ...
      if ((this.jdField_a_of_type_Rec != null) && ((this.jdField_a_of_type_Rec instanceof ReadInJoySkinAnimManager)) && (((ReadInJoySkinAnimManager)this.jdField_a_of_type_Rec).a())) {
        return true;
      }
    }
  ...
  public void setNoteCardLifeCycle(qnt paramqnt)
  {
    this.jdField_a_of_type_Qnt = paramqnt;
  }
  
  public void setRefreshPullDistanceListener(red paramred)
  {
    this.jdField_a_of_type_Red = paramred;
    if (this.jdField_a_of_type_Rec != null) {
      this.jdField_a_of_type_Rec.a(paramred);
    }
  }
}
