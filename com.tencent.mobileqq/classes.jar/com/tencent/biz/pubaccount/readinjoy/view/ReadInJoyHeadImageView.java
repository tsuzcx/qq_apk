...
public class ReadInJoyHeadImageView
  ...
  implements IView, oqi
{
  private static final Drawable b = new BitmapDrawable(BitmapFactory.decodeResource(BaseApplicationImpl.getApplication().getResources(), 2130841200));
  private long a;
