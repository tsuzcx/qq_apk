...
public class ReadInJoyNaviController$2
  implements Runnable
{
  public ReadInJoyNaviController$2(nud paramnud, ChannelCoverInfo paramChannelCoverInfo) {}
  ...
  public void run()
  {
    ...
    if ((localObject != null) && (nud.a(this.this$0)))
    {
      ...
      localTranslateAnimation.setAnimationListener(new nug(this));
