...
public class ReadInJoyNaviController$2
  implements Runnable
{
  public ReadInJoyNaviController$2(ors paramors, ChannelCoverInfo paramChannelCoverInfo) {}
  ...
  public void run()
  {
    ...
    if ((localObject != null) && (ors.a(this.this$0)))
    {
      ...
      localTranslateAnimation.setAnimationListener(new orv(this));
