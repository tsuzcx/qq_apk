...
public class ReadInJoyNaviController$2
  implements Runnable
{
  public ReadInJoyNaviController$2(nit paramnit, ChannelCoverInfo paramChannelCoverInfo) {}
  ...
  public void run()
  {
    ...
    if ((localObject != null) && (nit.a(this.this$0)))
    {
      ...
      localTranslateAnimation.setAnimationListener(new niw(this));
