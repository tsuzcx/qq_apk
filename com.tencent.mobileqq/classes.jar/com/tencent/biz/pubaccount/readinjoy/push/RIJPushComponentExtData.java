...
public final class RIJPushComponentExtData
{
  ...
  public boolean equals(@Nullable Object paramObject)
  {
    ...
    localObject = (RIJPushComponentExtData)paramObject;
    if ((Intrinsics.areEqual(this.jdField_a_of_type_JavaLangString, ((RIJPushComponentExtData)paramObject).jdField_a_of_type_JavaLangString) ^ true)) {
      return false;
    }
    if ((Intrinsics.areEqual(this.b, ((RIJPushComponentExtData)paramObject).b) ^ true)) {
      return false;
    }
    if ((Intrinsics.areEqual(this.c, ((RIJPushComponentExtData)paramObject).c) ^ true)) {
      return false;
    }
    if ((Intrinsics.areEqual(this.d, ((RIJPushComponentExtData)paramObject).d) ^ true)) {
      return false;
    }
    if ((Intrinsics.areEqual(this.e, ((RIJPushComponentExtData)paramObject).e) ^ true)) {
      return false;
    }
    return Arrays.equals(this.jdField_a_of_type_ArrayOfByte, ((RIJPushComponentExtData)paramObject).jdField_a_of_type_ArrayOfByte);
  }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.push.RIJPushComponentExtData
