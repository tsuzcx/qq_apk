...
public final class RIJPushNotifyDialog
{
  ...
  private final RIJPushNotifyParam jdField_a_of_type_ComTencentBizPubaccountReadinjoyPushRIJPushNotifyParam;
  ...
  static
  {
    jdField_a_of_type_ComTencentBizPubaccountReadinjoyPushMvpRIJPushNotifyDialog$Companion = new RIJPushNotifyDialog.Companion(null);
  }
  ...
  public RIJPushNotifyDialog(@NotNull ViewGroup paramViewGroup, @NotNull RIJPushNotifyParam paramRIJPushNotifyParam)
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyPushRIJPushNotifyParam = paramRIJPushNotifyParam;
    this.jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
    this.jdField_b_of_type_AndroidViewView = LayoutInflater.from(this.jdField_b_of_type_AndroidViewViewGroup.getContext()).inflate(2131562890, this.jdField_b_of_type_AndroidViewViewGroup, false);
    paramViewGroup = this.jdField_b_of_type_AndroidViewView;
    if (paramViewGroup != null)
    {
      paramViewGroup = paramViewGroup.findViewById(2131373719);
      this.jdField_a_of_type_AndroidViewView = paramViewGroup;
      paramViewGroup = this.jdField_a_of_type_AndroidViewView;
      if (paramViewGroup == null) {
        break label310;
      }
      paramViewGroup = (ImageView)paramViewGroup.findViewById(2131373713);
      label104:
      ...
      paramViewGroup = (TextView)paramViewGroup.findViewById(2131373723);
      label128:
      ...
      paramViewGroup = (TextView)paramViewGroup.findViewById(2131373717);
      label152:
      ...
      paramViewGroup = (TextView)paramViewGroup.findViewById(2131365620);
      label176:
      ...
      paramViewGroup = (TextView)paramViewGroup.findViewById(2131373721);
      label200:
      ...
      paramViewGroup = (ImageView)paramViewGroup.findViewById(2131364832);
      label224:
      ...
      paramViewGroup = (TextView)paramViewGroup.findViewById(2131373718);
      label248:
    ...
    label340:
    label345:
    for (paramViewGroup = (ViewGroup)paramViewGroup.findViewById(2131373716);; paramViewGroup = null)
    {
      this.jdField_a_of_type_AndroidViewViewGroup = paramViewGroup;
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyEngineReadInJoyObserver = ((ReadInJoyObserver)new RIJPushNotifyDialog.1(this));
      b();
      c();
      a();
      return;
  ...
  private final void b()
  {
    ...
    {
      if (((CharSequence)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyPushRIJPushNotifyParam.a()).length() == 0)
      {
        i = 1;
        if (i == 0) {
          break label599;
    ...
    else
    {
      ...
      if (localObject1 != null) {
        ((RelativeLayout.LayoutParams)localObject1).bottomMargin = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyPushRIJPushNotifyParam.b();
      }
      localObject1 = this.c;
      if (localObject1 != null) {
        ((TextView)localObject1).setText((CharSequence)RIJPushNotifyManager.a.a().a());
      }
      if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyPushRIJPushNotifyParam.a() != 1) {
        break label615;
      }
      localObject1 = this.d;
      if (localObject1 != null) {
        ((TextView)localObject1).setText((CharSequence)RIJPushNotifyManager.a.a().b());
      }
      ...
      localObject1 = this.e;
      if (localObject1 != null) {
        ((TextView)localObject1).setText((CharSequence)RIJPushNotifyManager.a.a().c());
      }
      ...
      label266:
      if (!this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyPushRIJPushNotifyParam.a()) {
        break label763;
      }
      localObject1 = this.c;
      if (localObject1 != null) {
        ((TextView)localObject1).setCompoundDrawablesWithIntrinsicBounds(2130849829, 0, 0, 0);
      }
      localObject1 = this.jdField_a_of_type_AndroidViewView;
      if (localObject1 != null) {
      ...
      if (localObject2 != null)
      {
        ...
        localObject1 = ((Resources)localObject1).getDrawable(2130849825);
        label352:
      ...
      if (localObject2 != null)
      {
        ...
        localObject1 = ((Resources)localObject1).getDrawable(2130849831);
        label433:
      ...
      if (localObject2 != null)
      {
        ...
        if (localObject4 != null)
        {
          ...
          localObject1 = localObject3;
          if (localObject4 != null) {
            localObject1 = ((Resources)localObject4).getDrawable(2130849827);
          }
        }
        ((TextView)localObject2).setBackgroundDrawable((Drawable)localObject1);
      }
      ...
      if (localObject1 != null)
      {
        localObject1 = ((View)localObject1).findViewById(2131372300);
        if (localObject1 != null) {
          if (!this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyPushRIJPushNotifyParam.b()) {
            break label1060;
          }
        }
      }
    ...
    for (int i = 0;; i = 8)
    {
      ...
      break;
      label599:
      localObject1 = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyPushRIJPushNotifyParam.a();
      break label79;
      label610:
      localObject1 = null;
      break label106;
      label615:
      if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyPushRIJPushNotifyParam.a() != 2) {
        break label266;
      }
      localObject1 = this.jdField_b_of_type_AndroidWidgetImageView;
      if (localObject1 != null) {
      ...
      localObject1 = this.d;
      if (localObject1 != null) {
        ((TextView)localObject1).setText((CharSequence)RIJPushNotifyManager.a.a().d());
      }
      localObject1 = this.jdField_a_of_type_AndroidWidgetTextView;
      if (localObject1 != null) {
        ((TextView)localObject1).setText((CharSequence)RIJPushNotifyManager.a.a().e());
      }
      localObject1 = this.jdField_b_of_type_AndroidWidgetTextView;
      if (localObject1 == null) {
        break label266;
      }
      ((TextView)localObject1).setText((CharSequence)RIJPushNotifyManager.a.a().f());
      break label266;
      label748:
      localObject1 = null;
      break label352;
      ...
      localObject1 = this.c;
      if (localObject1 != null) {
        ((TextView)localObject1).setCompoundDrawablesWithIntrinsicBounds(2130849830, 0, 0, 0);
      }
      localObject1 = this.jdField_a_of_type_AndroidViewView;
      if (localObject1 != null) {
      ...
      if (localObject2 != null)
      {
        ...
        if (localObject1 != null)
        {
          ...
          if (localObject1 != null)
          {
            localObject1 = ((Resources)localObject1).getDrawable(2130849826);
            label839:
            ((ImageView)localObject2).setImageDrawable((Drawable)localObject1);
          }
        }
      ...
      else
      {
        ...
        if (localObject2 != null)
        {
          ...
          localObject1 = ((Resources)localObject1).getDrawable(2130849821);
          ((TextView)localObject2).setBackgroundDrawable((Drawable)localObject1);
        }
        localObject2 = this.jdField_b_of_type_AndroidWidgetTextView;
        if (localObject2 != null)
      ...
      for (localObject1 = ((Resources)localObject1).getDrawable(2130849821);; localObject1 = null)
      {
        ((TextView)localObject2).setBackgroundDrawable((Drawable)localObject1);
        localObject2 = this.jdField_a_of_type_AndroidWidgetTextView;
        if (localObject2 != null)
        {
          ...
          if (localObject3 != null)
          {
            ...
            localObject1 = localObject4;
            if (localObject3 != null) {
              localObject1 = ((Resources)localObject3).getDrawable(2130849822);
            }
          }
          ((TextView)localObject2).setBackgroundDrawable((Drawable)localObject1);
        }
  ...
  public final void a(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.postDelayed((Runnable)new RIJPushNotifyDialog.show.1(this), RIJPushNotifyManager.a.a().a());
  }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.push.mvp.RIJPushNotifyDialog
