  ...
  implements ReadinjoySPEventReport.ForeBackGroundCallback
{
  ...
  private static ReadInJoyProteusFamilyUtil jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommonReadInJoyProteusFamilyUtil;
  ...
  private ReadInJoyProteusFamilyUtil.OnProteusFamilyDataLoaded jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommonReadInJoyProteusFamilyUtil$OnProteusFamilyDataLoaded;
  private List<View> jdField_a_of_type_JavaUtilList = new ArrayList();
  private Map<Pair<Long, Pair<View, BaseArticleInfo>>, Long> jdField_a_of_type_JavaUtilMap = new TreeMap(new ReadInJoyProteusFamilyUtil.1(this));
  ...
  static
  {
    ...
    jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommonReadInJoyProteusFamilyUtil = null;
  ...
  {
    return RIJItemViewType.a(paramArticleInfo, paramInt);
  }
  ...
  {
    if (jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommonReadInJoyProteusFamilyUtil == null) {}
    try
    {
      if (jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommonReadInJoyProteusFamilyUtil == null) {
        jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommonReadInJoyProteusFamilyUtil = new ReadInJoyProteusFamilyUtil();
      }
      return jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommonReadInJoyProteusFamilyUtil;
    }
    finally {}
  }
  ...
  {
    int i1 = a(paramArticleInfo, paramInt);
    if (ProteusSupportAdUtil.a(i1)) {
      return String.valueOf(i1);
    }
    if ((paramArticleInfo != null) && (paramArticleInfo.mFeedType == 29)) {}
    for (paramInt = 1; (!ProteusSupportUtil.a(i1)) && (paramInt == 0); paramInt = 0) {
      return "";
    }
    if (paramInt == 0) {}
    for (paramArticleInfo = String.valueOf(i1);; paramArticleInfo = a(paramArticleInfo))
    {
  ...
  public static List<BaseArticleInfo> a(String paramString)
  {
    ...
    catch (JSONException paramString)
    {
      for (;;)
      {
        ...
        if (i2 == 1)
        {
          ...
          localObject1 = ReadInJoyMSFHandlerUtils.a((articlesummary.ArticleSummary)((oidb_cmd0x68b.RspGetFollowTabFeeds)localObject3).msg_article_summary.get(), 70, 0, null);
              ...
              if (((articlesummary.FeedsInfo)((articlesummary.ArticleSummary)localObject3).msg_feeds_info.get()).msg_pos_ad_info.has())
              {
                ...
                if (localObject2 != null)
                {
                  ...
                  if (((articlesummary.PosAdInfo)localObject2).int32_ret.get() == 0)
                  {
                    ...
                    ReadInJoyMSFHandlerUtils.a((articlesummary.ArticleSummary)localObject3, 0, 0, paramString);
    ...
    if ((localIterator != null) && (localIterator.hasNext()))
    {
      ...
      for (;;)
      {
        localObject2 = Base64Util.decode(paramString.getBytes(), 0);
        i2 = localObject2[0];
        localObject1 = null;
        if (i2 != 0) {
          break;
        ...
        paramString = ReadInJoyMSFHandlerUtils.a(paramString, 0, 0, null);
  ...
  private void a(List<BaseArticleInfo> paramList)
  {
    ...
    for (;;)
    {
      ...
      while (paramList.hasNext())
      {
        ...
        {
          localBaseArticleInfo.articleViewModel = ArticleViewModel.a(localBaseArticleInfo);
  ...
  {
    paramArticleInfo = ReadInJoyBaseAdapter.a(paramArticleInfo, paramInt);
  ...
  private static String c(String paramString)
  {
    try
    {
      ...
      for (;;)
      {
        ...
        paramString = HttpUtil.openUrlForByte(BaseApplicationImpl.getContext(), str, "GET", localBundle, a());
        if (paramString != null) {
          break;
        }
        return "";
    ...
    if ((paramString != null) && (Integer.parseInt(paramString.getString(d)) > 0))
    {
      ...
      ReadInJoyHelper.a(d, Integer.valueOf(jdField_a_of_type_Int));
  ...
  private void c()
  {
    jdField_a_of_type_Int = ((Integer)ReadInJoyHelper.a(d, Integer.valueOf(0))).intValue();
    QLog.d(jdField_b_of_type_JavaLangString, 2, "local version " + jdField_a_of_type_Int);
    try
    {
      jdField_a_of_type_OrgJsonJSONObject = new JSONObject((String)ReadInJoyHelper.a(f, ""));
      jdField_b_of_type_OrgJsonJSONObject = new JSONObject((String)ReadInJoyHelper.a(g, ""));
      jdField_c_of_type_OrgJsonJSONObject = new JSONObject((String)ReadInJoyHelper.a(e, ""));
      return;
    }
  ...
  private static void e()
  {
    ...
    {
      return;
      ReadInJoyHelper.a(f, jdField_a_of_type_OrgJsonJSONObject.toString());
    } while ((jdField_c_of_type_OrgJsonJSONObject == null) || (jdField_c_of_type_OrgJsonJSONObject.length() == 0));
    ReadInJoyHelper.a(e, jdField_c_of_type_OrgJsonJSONObject.toString());
  }
  
  private static String f()
  {
    Object localObject2 = RIJQQAppInterfaceUtil.b();
    if (localObject2 == null)
    {
    ...
    if (localObject1 != null)
    {
      ...
      localObject2 = new ReadInJoyProteusFamilyUtil.3((TicketManager)localObject1, (QQAppInterface)localObject2);
  ...
  public void a()
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommonReadInJoyProteusFamilyUtil$OnProteusFamilyDataLoaded == null) {
      return;
    }
  ...
  {
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommonReadInJoyProteusFamilyUtil$OnProteusFamilyDataLoaded = paramOnProteusFamilyDataLoaded;
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (a(str))
        {
          ...
          paramArticleSummary = new String(Base64Util.encode(paramArticleInfo, 0));
          if (jdField_c_of_type_OrgJsonJSONObject != null)
          {
  ...
  public void b()
  {
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommonReadInJoyProteusFamilyUtil$OnProteusFamilyDataLoaded = null;
  }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.common.ReadInJoyProteusFamilyUtil
