...
public class ReadInJoyResetUtils
{
  ...
  {
    int i = SharedPreUtils.O(BaseApplicationImpl.getApplication(), ReadInJoyUtils.a());
    int j = a();
  ...
  public static void b()
  {
    ...
    SharedPreUtils.a(BaseApplicationImpl.getApplication(), "readinjoy_search_jump_url_version", ReadInJoyUtils.a(), 0);
  }
  ...
  public static void d()
  {
    ...
    if (localObject != null)
    {
      ...
      if (((SharedPreferences.Editor)localObject).commit())
      {
        ...
        localObject = ReadInJoyHelper.a(ReadInJoyUtils.a(), false, true);
        if (localObject == null) {
          break label138;
        }
        localObject = ((SharedPreferences)localObject).edit();
  ...
  private static void g()
  {
    ...
    SettingCloneUtil.writeValue(BaseApplicationImpl.getApplication(), ReadInJoyUtils.a(), null, "qqsetting_kandian_download_pic_flag", false);
  ...
  private static void h()
  {
    ...
    try
    {
      localObject = (ReadInJoyOperationManager)ReadInJoyUtils.a().getManager(QQManagerFactory.READ_IN_JOY_OPERATION_MANAGER);
      if (localObject != null)
      {
        ((ReadInJoyOperationManager)localObject).b();
  ...
  private static void j()
  {
    ...
    try
    {
      Object localObject = ((QQAppInterface)ReadInJoyUtils.a()).getMessageFacade();
      ...
      localObject = ReadInJoyHelper.a((QQAppInterface)ReadInJoyUtils.a(), 1);
      if (localObject != null)
      {
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.common.ReadInJoyResetUtils
