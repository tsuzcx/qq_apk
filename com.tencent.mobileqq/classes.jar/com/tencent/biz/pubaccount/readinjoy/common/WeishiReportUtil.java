...
public class WeishiReportUtil
{
  ...
  {
    return ((WeishiManager)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(QQManagerFactory.WEISHI_MANAGER)).a();
  }
  ...
  public static void a(RecentBaseData paramRecentBaseData, int paramInt)
  {
    ...
    MessageForStructing localMessageForStructing = ((WeishiManager)localQQAppInterface.getManager(QQManagerFactory.WEISHI_MANAGER)).a();
  ...
  public static void c()
  {
    ...
    ((IPublicAccountUtil)QRoute.api(IPublicAccountUtil.class)).reportPushEffectEvent(27, localArrayList);
  }
