...
public class GalleryReportedUtils
{
  ...
  public static int a(int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      paramInt2 = i;
    } while (!RIJFeedsType.a(paramInt1));
    return 3;
  }
  
  public static String a()
  {
    return (int)Math.ceil(Float.valueOf((float)DeviceInfoUtil.a()).floatValue() / 1024.0F / 1024.0F / 1024.0F) + "";
  }
  ...
  public static HashMap<String, String> a(Context paramContext, int paramInt, String paramString)
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("param_cmd", paramString);
    localHashMap.put("param_errorCode", String.valueOf(paramInt));
    localHashMap.put("param_network", a(paramContext));
    return localHashMap;
  }
  ...
  public static JSONObject a(Context paramContext, int paramInt1, int paramInt2, int paramInt3, ArticleInfo paramArticleInfo)
  {
    ...
    try
    {
      ...
      localJSONObject.put("rowkey", ReadinjoyReportUtils.a(paramArticleInfo));
  ...
  public static void a(int paramInt1, long paramLong1, int paramInt2, int paramInt3, long paramLong2, int paramInt4, String paramString1, String paramString2)
  {
    ...
    if (!TextUtils.isEmpty("8.5.5")) {
      localGalleryExpReported.client_ver.set(ByteStringMicro.copyFromUtf8("8.5.5"));
    }
  ...
  public static void a(Context paramContext, ArticleInfo paramArticleInfo, ReadInJoyBaseAdapter paramReadInJoyBaseAdapter)
  {
    if ((RIJFeedsType.c(paramArticleInfo)) || (RIJFeedsType.e(paramArticleInfo)) || (RIJPreParseData.a(paramArticleInfo)))
    {
      paramContext = a(paramContext, ReadInJoyUtils.a() + "", ComponentContentGalleryBiu.a(paramArticleInfo, paramReadInJoyBaseAdapter), paramArticleInfo.mArticleID, paramReadInJoyBaseAdapter.a().indexOf(paramArticleInfo), paramArticleInfo.innerUniqueID, paramArticleInfo.galleryReprotExdData, a(RIJFeedsType.a(paramArticleInfo)), 0, (int)paramArticleInfo.mChannelID, null);
      ((IPublicAccountReportUtils)QRoute.api(IPublicAccountReportUtils.class)).publicAccountReportClickEvent(null, "" + paramArticleInfo.publishUin, "0X8008E2F", "0X8008E2F", 0, 0, "", paramArticleInfo.mArticleID + "", paramArticleInfo.mAlgorithmID + "", paramContext, false);
    }
  }
  
  public static void a(Context paramContext, ArticleInfo paramArticleInfo, String paramString, JSONObject paramJSONObject)
  {
    int i = RIJFeedsType.a(paramArticleInfo);
    ...
    for (;;)
    {
      try
      {
        ...
        paramContext = a(paramContext, ReadInJoyUtils.a() + "", i, paramArticleInfo.mArticleID, 0, paramArticleInfo.innerUniqueID, paramArticleInfo.galleryReprotExdData, a(RIJFeedsType.a(paramArticleInfo)), 0, (int)paramArticleInfo.mChannelID, paramJSONObject);
        ((IPublicAccountReportUtils)QRoute.api(IPublicAccountReportUtils.class)).publicAccountReportClickEvent(null, "" + paramArticleInfo.publishUin, paramString, paramString, 0, 0, "", paramArticleInfo.mArticleID + "", paramArticleInfo.mAlgorithmID + "", paramContext, false);
        return;
      }
