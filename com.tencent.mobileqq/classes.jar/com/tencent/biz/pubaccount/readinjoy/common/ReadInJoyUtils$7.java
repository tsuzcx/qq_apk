  ...
  implements Runnable
{
  ...
  public void run()
  {
    try
    {
      ...
      awrn.a(this.jdField_a_of_type_MqqAppAppRuntime.getApplication()).a(null, "actKanDianViolaPageDataNew", this.jdField_a_of_type_Boolean, -1L, -1L, localException, null, true);
    }
