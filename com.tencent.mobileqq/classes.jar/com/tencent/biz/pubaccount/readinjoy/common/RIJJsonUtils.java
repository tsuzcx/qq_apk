...
public class RIJJsonUtils
{
  public static String a()
  {
    ...
    a(localStringBuilder, "probesize", Long.valueOf(ReadInJoyHelper.b()));
    localStringBuilder.append(",");
    a(localStringBuilder, "isFFProbelistSwitch", Boolean.valueOf(ReadInJoyHelper.v()));
    localStringBuilder.append(",");
    a(localStringBuilder, "isDownloadAsyncIo", Boolean.valueOf(ReadInJoyHelper.w()));
    localStringBuilder.append("}");
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.common.RIJJsonUtils
