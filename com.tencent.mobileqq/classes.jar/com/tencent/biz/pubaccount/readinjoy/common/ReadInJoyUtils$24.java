  ...
  implements Runnable
{
  ...
  public void run()
  {
    try
    {
      ...
      for (;;)
      {
        oat.a(null, "CliOper", "", "", "0X8009EB2", "0X8009EB2", 0, 0, String.valueOf(this.jdField_a_of_type_Int), String.valueOf(this.jdField_a_of_type_Long), "1", localJSONObject.toString(), false);
        return;
