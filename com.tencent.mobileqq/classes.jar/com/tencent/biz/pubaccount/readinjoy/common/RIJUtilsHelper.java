...
public final class RIJUtilsHelper
{
  ...
  static
  {
    jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommonRIJUtilsHelper$Companion = new RIJUtilsHelper.Companion(null);
  }
  
  public RIJUtilsHelper(@NotNull BaseArticleInfo paramBaseArticleInfo)
  {
  ...
  {
    if (RIJFeedsType.m(paramBaseArticleInfo)) {
      return 67;
    }
    if (RIJFeedsType.p(paramBaseArticleInfo)) {
      return 82;
    }
    if (RIJFeedsType.o(paramBaseArticleInfo)) {
      return 83;
    }
    return 68;
  }
  ...
  {
    if (ReadInjoyFeedsUtils.a(paramBaseArticleInfo) == 32) {
      return 2006;
    }
    return 31;
  }
  ...
  private final int h(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    if (RIJFeedsType.c((ArticleInfo)paramBaseArticleInfo)) {
      return 41;
    }
    return 42;
  }
  ...
  {
    if (RIJFeedsType.f((ArticleInfo)paramBaseArticleInfo)) {
      return 45;
    }
    return 46;
  }
  ...
  {
    if ((paramBaseArticleInfo.mSocialFeedInfo != null) && (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$WendaInfo != null) && (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$WendaInfo.a)) {
      return 62;
    }
    return 61;
  }
  ...
  {
    if ((paramBaseArticleInfo.mSocialFeedInfo != null) && (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$IconWordingInfo != null)) {
      return paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$IconWordingInfo.a;
    }
    return 0;
  }
  ...
  private final int o(BaseArticleInfo paramBaseArticleInfo)
  {
    if (paramBaseArticleInfo.mProteusTemplateBean != null) {
      return DynamicItemViewHelper.a(paramBaseArticleInfo.mProteusTemplateBean);
    }
    return 0;
  }
  ...
  public final int a(@NotNull BaseArticleInfo paramBaseArticleInfo, int paramInt)
  {
    ...
    } while (!RIJFeedsType.i(paramBaseArticleInfo));
    return 47;
  }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.common.RIJUtilsHelper
