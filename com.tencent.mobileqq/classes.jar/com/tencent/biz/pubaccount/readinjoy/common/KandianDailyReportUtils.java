...
public class KandianDailyReportUtils
{
  ...
  public static void a()
  {
    ...
    {
      return;
      localMessageRecord = localQQAppInterface.getMessageFacade().b(AppConstants.KANDIAN_DAILY_UIN, 1008);
  ...
  {
    String str4 = ((IPublicAccountUtil)QRoute.api(IPublicAccountUtil.class)).getPubAccountRecentUserPosInMessageList(AppConstants.KANDIAN_DAILY_UIN) + "";
    ...
    for (Object localObject1 = str3;; localObject2 = null)
    {
      ...
      for (;;)
      {
        ...
        for (i = 1;; i = 0)
        {
          ...
          ((IPublicAccountReportUtils)QRoute.api(IPublicAccountReportUtils.class)).publicAccountReportClickEventForMigrate(null, "CliOper", "", "", paramString, paramString, 0, 0, str4, localObject3, str1, localJSONObject.toString(), false);
          if (!paramMessageRecord.isread)
          {
            ...
            paramMessageRecord.mUin = ReadInJoyUtils.a();
          }
          try
          {
          ...
          new UserOperationModule(null, null, ReadInJoyMSFService.a(), null).a(paramString);
          return;
          localObject1 = null;
          break;
        }
  ...
  public static void a(List<ArticleInfo> paramList, List<Long> paramList1, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      while (paramList.hasNext())
      {
        ...
        if ((RIJFeedsType.a(localArticleInfo) > 0) && (paramList1.contains(Long.valueOf(localArticleInfo.mRecommendSeq))))
        {
  ...
  {
    return "" + ReadInJoyHelper.a("readinjoy_daily_mode_channel_id", Integer.valueOf(41505));
  }
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.common.KandianDailyReportUtils
