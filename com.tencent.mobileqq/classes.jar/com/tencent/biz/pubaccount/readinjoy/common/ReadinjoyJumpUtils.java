...
public class ReadinjoyJumpUtils
{
  public static int a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    if (RIJFeedsType.c(paramBaseArticleInfo)) {
      return 3;
    }
  ...
  public static Intent a(Context paramContext, ArticleInfo paramArticleInfo)
  {
    ...
    for (;;)
    {
      ...
      paramContext.putExtra("req_create_time", ReadInJoyTimeUtils.b(paramArticleInfo.mTime));
  ...
  {
    // Byte code:
    //   0: invokestatic 217	com/tencent/biz/pubaccount/readinjoy/common/ReadInJoyUtils:a	()Lmqq/app/AppRuntime;
    //   3: checkcast 219	com/tencent/mobileqq/app/QQAppInterface
    //   6: astore 5
    //   8: aload 5
    //   10: ifnonnull +4 -> 14
    //   13: return
    //   14: aload 5
    //   16: getstatic 224	com/tencent/mobileqq/app/QQManagerFactory:KANDIAN_MERGE_MANAGER	I
    //   19: invokevirtual 228	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   22: checkcast 230	com/tencent/biz/pubaccount/readinjoy/engine/KandianMergeManager
    //   25: invokevirtual 233	com/tencent/biz/pubaccount/readinjoy/engine/KandianMergeManager:a	()Lcom/tencent/biz/pubaccount/readinjoy/struct/KandianRedDotInfo;
    //   28: astore 6
    //   30: aload 6
    //   32: ifnonnull +12 -> 44
    //   35: ldc 235
    //   37: iconst_2
    //   38: ldc 237
    //   40: invokestatic 243	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   43: return
    //   44: aload 6
    //   46: invokevirtual 249	com/tencent/biz/pubaccount/readinjoy/struct/KandianRedDotInfo:getMessageRecord	()Lcom/tencent/mobileqq/data/MessageRecord;
    //   49: astore 5
    //   51: aload 5
    //   53: instanceof 251
    //   56: ifeq +267 -> 323
    //   59: aload 5
    //   61: checkcast 251	com/tencent/mobileqq/data/MessageForStructing
    //   64: astore 5
    //   66: aload 5
    //   68: getfield 255	com/tencent/mobileqq/data/MessageForStructing:structingMsg	Lcom/tencent/mobileqq/structmsg/AbsStructMsg;
    //   71: ifnull +239 -> 310
    //   74: aload 5
    //   76: getfield 255	com/tencent/mobileqq/data/MessageForStructing:structingMsg	Lcom/tencent/mobileqq/structmsg/AbsStructMsg;
    //   79: getfield 260	com/tencent/mobileqq/structmsg/AbsStructMsg:mExtraData	Ljava/lang/String;
    //   82: invokestatic 266	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   85: ifne +225 -> 310
    //   88: new 268	org/json/JSONObject
    //   91: dup
    //   92: aload 5
    //   94: getfield 255	com/tencent/mobileqq/data/MessageForStructing:structingMsg	Lcom/tencent/mobileqq/structmsg/AbsStructMsg;
    //   97: getfield 260	com/tencent/mobileqq/structmsg/AbsStructMsg:mExtraData	Ljava/lang/String;
    //   100: invokespecial 269	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   103: astore 5
    //   105: aload 5
    //   107: ldc_w 271
    //   110: invokevirtual 275	org/json/JSONObject:getInt	(Ljava/lang/String;)I
    //   113: istore_2
    //   114: aload 5
    //   116: ldc_w 277
    //   119: ldc_w 279
    //   122: invokevirtual 283	org/json/JSONObject:optString	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   125: astore 5
    //   127: aload 5
    //   129: invokestatic 288	java/lang/Integer:valueOf	(Ljava/lang/String;)Ljava/lang/Integer;
    //   132: invokevirtual 292	java/lang/Integer:intValue	()I
    //   135: istore_1
    //   136: aload_0
    //   137: ldc_w 294
    //   140: iload_1
    //   141: invokevirtual 89	android/content/Intent:putExtra	(Ljava/lang/String;I)Landroid/content/Intent;
    //   144: pop
    //   145: iload_2
    //   146: istore_3
    //   147: iload_1
    ...
    //   154: ldc 235
    //   156: iconst_1
    //   157: new 174	java/lang/StringBuilder
    //   160: dup
    //   161: invokespecial 175	java/lang/StringBuilder:<init>	()V
    //   164: ldc_w 296
    //   167: invokevirtual 179	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   170: aload 6
    //   172: getfield 300	com/tencent/biz/pubaccount/readinjoy/struct/KandianRedDotInfo:articleIDList	Ljava/util/ArrayList;
    //   175: invokevirtual 303	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   178: invokevirtual 184	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   181: invokestatic 243	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   184: return
    //   185: astore 5
    //   187: aload 5
    //   189: invokevirtual 306	java/lang/Exception:printStackTrace	()V
    //   192: ldc 235
    //   194: iconst_2
    //   195: ldc_w 308
    //   198: invokestatic 243	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   201: iload_2
    //   202: istore_3
    //   203: iload_1
    //   204: istore_2
    ...
    //   206: istore_1
    //   207: aload 6
    //   209: getfield 300	com/tencent/biz/pubaccount/readinjoy/struct/KandianRedDotInfo:articleIDList	Ljava/util/ArrayList;
    //   212: astore 5
    //   214: aload 5
    //   216: ifnull +46 -> 262
    //   219: aload 5
    //   221: invokevirtual 313	java/util/ArrayList:size	()I
    //   224: ifle +38 -> 262
    //   227: aload_0
    //   228: ldc_w 315
    //   231: aload 5
    //   233: iconst_0
    //   234: invokevirtual 319	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   237: checkcast 321	java/io/Serializable
    //   240: invokevirtual 324	android/content/Intent:putExtra	(Ljava/lang/String;Ljava/io/Serializable;)Landroid/content/Intent;
    //   243: pop
    //   244: aload_0
    //   245: ldc_w 326
    //   248: iconst_0
    //   249: invokevirtual 89	android/content/Intent:putExtra	(Ljava/lang/String;I)Landroid/content/Intent;
    //   252: pop
    //   253: aload_0
    //   254: ldc_w 328
    //   257: iload_2
    //   258: invokevirtual 89	android/content/Intent:putExtra	(Ljava/lang/String;I)Landroid/content/Intent;
    //   261: pop
    //   262: ldc 235
    //   264: iconst_1
    ...
    //   278: aload 5
    //   280: invokevirtual 303	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   283: ldc_w 332
    //   286: invokevirtual 179	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   289: iload_2
    //   290: invokevirtual 335	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   293: ldc_w 337
    //   296: invokevirtual 179	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   299: iload_1
    //   300: invokevirtual 335	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   303: invokevirtual 184	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   306: invokestatic 243	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   309: return
    //   310: iconst_0
    //   311: istore_3
    //   312: iconst_0
    ...
    //   325: iconst_2
    //   326: ldc_w 339
    //   329: invokestatic 243	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   332: iconst_0
    //   333: istore_1
    //   334: iconst_0
    //   335: istore_2
  ...
  public static Intent b(Context paramContext, ArticleInfo paramArticleInfo)
  {
    if (RIJFeedsType.a(paramArticleInfo.mArticleContentUrl, paramArticleInfo.mChannelID, paramArticleInfo))
    {
      ...
      if (localObject1 != null) {
        ((FastWebModule)localObject1).a(paramArticleInfo.mArticleContentUrl, String.valueOf(paramArticleInfo.innerUniqueID), paramArticleInfo.mSubscribeID, 1, null);
      }
    ...
    if (RIJItemViewType.h(paramArticleInfo))
    {
      ...
      if (!RIJItemViewType.l(paramArticleInfo)) {
        localObject1 = ((TopicRecommendFeedsInfo.TopicRecommendInfo)paramArticleInfo.mSocialFeedInfo.a.a.get(0)).b;
      }
    }
    ...
    else
    {
      ...
      if ((FileUtils.b(AppConstants.SDCARD_PATH_PUBLIC_ACCOUNT_PRELOAD + paramContext)) && (PreloadManager.a().b(paramContext) != null))
      {
        localBundle.putString("read_in_joy_from_cache", paramContext);
        if (!ReadInJoyLogicEngine.a().a(paramArticleInfo.mArticleID))
        {
          ...
          {
            ThreadManager.post(new ReadinjoyJumpUtils.1(paramArticleInfo, (PreloadManager.ImgStruct)paramContext.get(0)), 5, null, false);
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.common.ReadinjoyJumpUtils
