...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"set", "", "Lcom/tencent/biz/pubaccount/readinjoy/decoupling/uilayer/framewrok/report/RIJTransMergeKanDianReport$ReportR5Builder;", "key", "", "value", "", "AQQLiteApp_release"}, k=2, mv={1, 1, 16})
public final class ReportR5BuilderExtensionsKt
{
  public static final void a(@NotNull RIJTransMergeKanDianReport.ReportR5Builder paramReportR5Builder, @NotNull String paramString, @NotNull Object paramObject)
  {
    ...
    paramReportR5Builder.a(paramString, paramObject);
  }
}
