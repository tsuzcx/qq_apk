  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      break label26;
      label80:
      localObject2 = ((QQMessageFacade)localObject1).b(ajsf.aA, 7220);
      if (localObject2 != null)
      {
        if ((onk.jdField_a_of_type_Qbl.jdField_a_of_type_ComTencentMobileqqDataMessageRecord != null) && (onk.jdField_a_of_type_Qbl.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.time >= ((MessageRecord)localObject2).time)) {
          localObject2 = onk.jdField_a_of_type_Qbl.jdField_a_of_type_ComTencentMobileqqDataMessageRecord;
        }
        for (;;)
        {
          ...
          onk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageRecord)localObject2);
          String str3;
          ...
          for (;;)
          {
            ...
            if (onk.jdField_a_of_type_Qbl.jdField_a_of_type_Int == 1) {
              break;
            }
            onk.b(String.valueOf(System.currentTimeMillis()));
            onk.jdField_a_of_type_Long = System.currentTimeMillis() / 1000L;
            for (;;)
            {
              try
              {
                localObject4 = new JSONObject();
                ((JSONObject)localObject4).put("folder_status", onk.jdField_a_of_type_Qbl.jdField_a_of_type_Int);
                ((JSONObject)localObject4).put("algorithm_id", onk.jdField_a_of_type_Qbl.jdField_a_of_type_JavaLangString);
                ((JSONObject)localObject4).put("strategy_id", onk.jdField_a_of_type_Qbl.b);
                ((JSONObject)localObject4).put("time", System.currentTimeMillis());
                if (onk.jdField_a_of_type_Qbl.jdField_a_of_type_Int == 6)
                {
                ...
                ((JSONObject)localObject4).put("kandian_mode_new", npx.a());
                if (i == 3) {
                  ((JSONObject)localObject4).put("reddot_num", str4);
                }
                noo.a(null, "CliOper", "", (String)localObject2, "0X80091DC", "0X80091DC", 0, 0, "0", onk.g(onk.jdField_a_of_type_Qbl.c), onk.jdField_a_of_type_Qbl.b, ((JSONObject)localObject4).toString(), false);
                if (bhvh.k()) {
                  onk.a(20, onk.g(onk.jdField_a_of_type_Qbl.c), onk.jdField_a_of_type_Qbl.b, onk.jdField_a_of_type_Qbl.jdField_a_of_type_JavaLangString, (String)localObject2, onk.jdField_a_of_type_Qbl.jdField_a_of_type_Int);
                }
              ...
              {
                localObject1 = onk.a();
                ((JSONObject)localObject1).put("kandian_mode", onk.e());
                ((JSONObject)localObject1).put("tab_source", onk.d());
                noo.a(null, "CliOper", "", null, "0X80081C6", "0X80081C6", 0, 1, null, null, null, ((JSONObject)localObject1).toString(), false);
                return;
              }
