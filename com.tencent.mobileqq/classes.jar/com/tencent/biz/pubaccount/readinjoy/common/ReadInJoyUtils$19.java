  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      {
        if ((pha.jdField_a_of_type_Rfq.jdField_a_of_type_ComTencentMobileqqDataMessageRecord != null) && (pha.jdField_a_of_type_Rfq.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.time >= ((MessageRecord)localObject2).time)) {
          localObject2 = pha.jdField_a_of_type_Rfq.jdField_a_of_type_ComTencentMobileqqDataMessageRecord;
        }
        for (;;)
        {
          ...
          pha.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageRecord)localObject2);
          String str3;
          ...
          for (;;)
          {
            ...
            if (pha.jdField_a_of_type_Rfq.jdField_a_of_type_Int == 1) {
              break;
            }
            pha.b(String.valueOf(System.currentTimeMillis()));
            pha.jdField_a_of_type_Long = System.currentTimeMillis() / 1000L;
            for (;;)
            {
              try
              {
                localObject4 = new JSONObject();
                ((JSONObject)localObject4).put("folder_status", pha.jdField_a_of_type_Rfq.jdField_a_of_type_Int);
                ((JSONObject)localObject4).put("algorithm_id", pha.jdField_a_of_type_Rfq.jdField_a_of_type_JavaLangString);
                ((JSONObject)localObject4).put("strategy_id", pha.jdField_a_of_type_Rfq.b);
                ((JSONObject)localObject4).put("time", System.currentTimeMillis());
                if (pha.jdField_a_of_type_Rfq.jdField_a_of_type_Int == 6)
                {
                ...
                ((JSONObject)localObject4).put("kandian_mode_new", och.a());
                if (i == 3) {
                  ((JSONObject)localObject4).put("reddot_num", str4);
                }
                oat.a(null, "CliOper", "", (String)localObject2, "0X80091DC", "0X80091DC", 0, 0, "0", pha.g(pha.jdField_a_of_type_Rfq.c), pha.jdField_a_of_type_Rfq.b, ((JSONObject)localObject4).toString(), false);
                if (bmqa.j()) {
                  pha.a(20, pha.g(pha.jdField_a_of_type_Rfq.c), pha.jdField_a_of_type_Rfq.b, pha.jdField_a_of_type_Rfq.jdField_a_of_type_JavaLangString, (String)localObject2, pha.jdField_a_of_type_Rfq.jdField_a_of_type_Int);
                }
              ...
              try
              {
                ...
                ((JSONObject)localObject1).put("tab_source", pha.d());
                oat.a(null, "CliOper", "", null, "0X80081C6", "0X80081C6", 0, 1, null, null, null, ((JSONObject)localObject1).toString(), false);
                return;
              }
