  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (this.jdField_a_of_type_AndroidGraphicsBitmap != null)
    {
      ...
      {
        localObject1 = vlc.a(vlc.a(this.jdField_a_of_type_AndroidGraphicsBitmap, i, j, false, true), BitmapFactory.decodeResource(BaseApplicationImpl.getApplication().getResources(), 2130841220), true);
    ...
    for (;;)
    {
      ...
      return;
      localObject1 = vlc.a(this.jdField_a_of_type_AndroidGraphicsBitmap, i, j, false, true);
      break;
