  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (this.jdField_a_of_type_AndroidGraphicsBitmap != null)
    {
      ...
      {
        localObject1 = vxy.a(vxy.a(this.jdField_a_of_type_AndroidGraphicsBitmap, i, j, false, true), BitmapFactory.decodeResource(BaseApplicationImpl.getApplication().getResources(), 2130841299), true);
    ...
    for (;;)
    {
      ...
      return;
      localObject1 = vxy.a(this.jdField_a_of_type_AndroidGraphicsBitmap, i, j, false, true);
      break;
