  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    localAttributeList.att_value.set(pbo.a(this.jdField_a_of_type_Int));
    ...
    localAttributeList.att_value.set(String.valueOf(ple.a(this.jdField_a_of_type_Long) / 1000L));
    localArrayList.add(localAttributeList);
