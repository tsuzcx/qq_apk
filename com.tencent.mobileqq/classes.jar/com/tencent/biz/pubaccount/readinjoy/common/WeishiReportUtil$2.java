  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    localAttributeList.att_value.set(oct.a(this.jdField_a_of_type_Int));
    ...
    localAttributeList.att_value.set(String.valueOf(ohp.a(this.jdField_a_of_type_Long) / 1000L));
    localArrayList.add(localAttributeList);
