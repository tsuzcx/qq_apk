...
public class ReadInJoyDisplayUtils
{
  ...
  public static float a(Context paramContext, VideoPlayManager.VideoPlayParam paramVideoPlayParam)
  {
    int j = 28;
    int i;
    ...
    while ((paramVideoPlayParam != null) && (paramVideoPlayParam.b) && (paramVideoPlayParam.l > 0))
    {
      return paramVideoPlayParam.l;
      label67:
      if ((paramVideoPlayParam.a != null) && (paramVideoPlayParam.a.mChannelID == 56L))
      {
        i = j;
  ...
  public static float a(android.view.View paramView)
  {
    ...
    //   5: monitorenter
    //   6: aload_0
    //   7: getstatic 31	com/tencent/biz/pubaccount/readinjoy/common/ReadInJoyDisplayUtils:jdField_a_of_type_AndroidGraphicsRect	Landroid/graphics/Rect;
    //   10: invokevirtual 96	android/view/View:getLocalVisibleRect	(Landroid/graphics/Rect;)Z
    //   13: pop
    //   14: aload_0
    //   15: invokevirtual 100	android/view/View:getHeight	()I
    //   18: istore_3
    //   19: getstatic 31	com/tencent/biz/pubaccount/readinjoy/common/ReadInJoyDisplayUtils:jdField_a_of_type_AndroidGraphicsRect	Landroid/graphics/Rect;
    //   22: getfield 103	android/graphics/Rect:top	I
    //   25: ifne +24 -> 49
    //   28: getstatic 31	com/tencent/biz/pubaccount/readinjoy/common/ReadInJoyDisplayUtils:jdField_a_of_type_AndroidGraphicsRect	Landroid/graphics/Rect;
    //   31: getfield 106	android/graphics/Rect:bottom	I
    //   34: istore 4
    //   36: iload 4
    //   38: iload_3
    //   39: if_icmpne +10 -> 49
    ...
    //   47: fload_1
    //   48: freturn
    //   49: getstatic 31	com/tencent/biz/pubaccount/readinjoy/common/ReadInJoyDisplayUtils:jdField_a_of_type_AndroidGraphicsRect	Landroid/graphics/Rect;
    //   52: getfield 103	android/graphics/Rect:top	I
    //   55: ifle +22 -> 77
    //   58: ldc 90
    //   60: iload_3
    //   61: getstatic 31	com/tencent/biz/pubaccount/readinjoy/common/ReadInJoyDisplayUtils:jdField_a_of_type_AndroidGraphicsRect	Landroid/graphics/Rect;
    //   64: getfield 103	android/graphics/Rect:top	I
    //   67: isub
    //   68: i2f
    //   69: fmul
    //   70: iload_3
    ...
    //   77: fload_2
    //   78: fstore_1
    //   79: getstatic 31	com/tencent/biz/pubaccount/readinjoy/common/ReadInJoyDisplayUtils:jdField_a_of_type_AndroidGraphicsRect	Landroid/graphics/Rect;
    //   82: getfield 106	android/graphics/Rect:bottom	I
    //   85: ifle -41 -> 44
    //   88: fload_2
    //   89: fstore_1
    //   90: getstatic 31	com/tencent/biz/pubaccount/readinjoy/common/ReadInJoyDisplayUtils:jdField_a_of_type_AndroidGraphicsRect	Landroid/graphics/Rect;
    //   93: getfield 106	android/graphics/Rect:bottom	I
    //   96: iload_3
    //   97: if_icmpge -53 -> 44
    //   100: getstatic 31	com/tencent/biz/pubaccount/readinjoy/common/ReadInJoyDisplayUtils:jdField_a_of_type_AndroidGraphicsRect	Landroid/graphics/Rect;
    //   103: getfield 106	android/graphics/Rect:bottom	I
    //   106: istore 4
    //   108: ldc 90
    //   110: iload 4
    //   112: i2f
  ...
  {
    return (paramInt - (AIOUtils.a(24.0F, paramResources) + AIOUtils.a(3.0F, paramResources))) / 2;
  }
  ...
  {
    Resources localResources = BaseApplicationImpl.getApplication().getResources();
    int i = AIOUtils.a(1.5F, localResources);
    if (paramInt2 == 56) {
      i = AIOUtils.a(3.0F, localResources);
    }
    ...
    if (localVideoPackSetting != null)
    {
      ...
      paramInt2 = AIOUtils.a(localVideoPackSetting.jdField_b_of_type_Int, localResources);
    }
    for (;;)
    {
      switch (paramInt1)
      ...
      for (paramInt1 = (int)((localResources.getDisplayMetrics().widthPixels - AIOUtils.a(6, localResources) - i * 2) / 2.1F);; paramInt1 = paramInt2)
      {
        i = (int)(paramInt1 / f2);
        paramInt2 = paramInt1;
        paramInt1 = i;
        for (;;)
        {
          ...
          paramInt2 = localResources.getDisplayMetrics().widthPixels - AIOUtils.a(12, localResources);
          paramInt1 = (int)((localResources.getDisplayMetrics().widthPixels - AIOUtils.a(6, localResources) - i * 2) / 2.5F * 1.3356F);
          continue;
          paramInt2 = (int)((localResources.getDisplayMetrics().widthPixels - AIOUtils.a(12, localResources) - i) * 0.5F);
  ...
  {
    a(paramImageView, RIJPreParseData.a(paramString), paramContext);
  }
  ...
  public static void a(ImageView paramImageView, URL paramURL, Context paramContext)
  {
    if (paramURL == null)
    {
      ...
      paramImageView.setImageResource(2130841881);
      return;
    }
    ...
    for (Object localObject = (BaseActivity)paramContext;; localObject = null)
    {
      ...
      for (boolean bool = SettingCloneUtil.readValue((Context)localObject, ((BaseActivity)localObject).app.getCurrentAccountUin(), null, "qqsetting_kandian_download_pic_flag", false);; bool = false)
      {
        ...
        ((URLDrawable.URLDrawableOptions)localObject).mLoadingDrawable = paramContext.getResources().getDrawable(2130841881);
        ((URLDrawable.URLDrawableOptions)localObject).mFailedDrawable = paramContext.getResources().getDrawable(2130841881);
  ...
  public static void a(KandianUrlImageView paramKandianUrlImageView, URL paramURL, Context paramContext, boolean paramBoolean)
  {
    if (paramURL == null)
    {
      ...
      paramKandianUrlImageView.setImageResource(2130841881);
      return;
    }
    ...
    if (!paramBoolean)
    {
      ...
      {
        paramKandianUrlImageView.setImagePlaceHolder(paramContext.getResources().getDrawable(2130840616)).setImage(paramURL);
        return;
      }
      paramKandianUrlImageView.setImagePlaceHolder(paramContext.getResources().getDrawable(2130841881)).setImage(paramURL);
      return;
    }
  ...
  public static void a(boolean paramBoolean, ViewBase paramViewBase, FreeNetFlowInfoModule paramFreeNetFlowInfoModule)
  {
    ...
    if ((paramBoolean) && (paramFreeNetFlowInfoModule != null))
    {
      ...
      FreeNetFlowInfoModule.a("0X8009660");
      return;
    }
  ...
  private static boolean a(Context paramContext)
  {
    ...
    for (paramContext = (BaseActivity)paramContext;; paramContext = null)
    {
      if (paramContext != null)
      {
        ...
        for (String str = paramContext.app.getCurrentAccountUin();; str = ReadInJoyUtils.a()) {
  ...
  {
    return (a(paramContext)) && (!NetworkUtil.h(paramContext)) && (!ImageManager.a().a(paramURL));
  }
  ...
  public static boolean a(VideoPlayManager.VideoPlayParam paramVideoPlayParam)
  {
    ...
    return a(paramVideoPlayParam.c, paramVideoPlayParam.d);
  }
  ...
  {
    Resources localResources = BaseApplicationImpl.getApplication().getResources();
    int i = (localResources.getDisplayMetrics().widthPixels - AIOUtils.a(3.0F, localResources)) / 2;
  ...
  {
    Resources localResources = BaseApplicationImpl.getApplication().getResources();
    int i = (localResources.getDisplayMetrics().widthPixels - AIOUtils.a(3.0F, localResources)) / 3;
