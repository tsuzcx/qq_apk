  ...
  implements Runnable
{
  public void run()
  {
    ...
    try
    {
      if (aney.a("com.tencent.reading", (Context)localObject))
      {
    ...
    olg.a(System.currentTimeMillis());
    opz.a().a(olg.a());
    opz.a().a((DownloadInfo)localObject);
