  ...
  implements Runnable
{
  public void run()
  {
    ...
    try
    {
      if (arqj.a("com.tencent.reading", (Context)localObject))
      {
    ...
    pik.a(System.currentTimeMillis());
    psy.a().a(pik.a());
    psy.a().a((DownloadInfo)localObject);
