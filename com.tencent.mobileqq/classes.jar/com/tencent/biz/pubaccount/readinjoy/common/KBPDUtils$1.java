  ...
  implements Runnable
{
  public void run()
  {
    ...
    try
    {
      if (amom.a("com.tencent.reading", (Context)localObject))
      {
    ...
    nzy.a(System.currentTimeMillis());
    oer.a().a(nzy.a());
    oer.a().a((DownloadInfo)localObject);
