...
public class ReadInJoyRefreshOptimizeUtil
{
  ...
  {
    Long localLong = (Long)ReadInJoyHelper.a("sp_key_readinjoy_refresh_optimize_id", Long.valueOf(0L));
    if (localLong != null) {}
  ...
  public static void a(String paramString)
  {
    ...
    ReadInJoyHelper.a("sp_key_readinjoy_refresh_optimize_id", Long.valueOf(l1));
  }
  ...
  {
    // Byte code:
    //   0: invokestatic 188	java/lang/System:currentTimeMillis	()J
    //   3: lstore_3
    //   4: new 190	java/io/ByteArrayInputStream
    //   7: dup
    //   8: aload_0
    //   9: invokespecial 193	java/io/ByteArrayInputStream:<init>	([B)V
    //   12: astore 5
    //   14: new 195	java/io/ByteArrayOutputStream
    //   17: dup
    //   18: invokespecial 196	java/io/ByteArrayOutputStream:<init>	()V
    //   21: astore_0
    //   22: new 198	java/util/zip/GZIPInputStream
    //   25: dup
    //   26: aload 5
    //   28: invokespecial 201	java/util/zip/GZIPInputStream:<init>	(Ljava/io/InputStream;)V
    //   31: astore 5
    //   33: sipush 1024
    //   36: newarray byte
    //   38: astore 6
    //   40: aload 5
    //   42: aload 6
    //   44: invokevirtual 205	java/util/zip/GZIPInputStream:read	([B)I
    //   47: istore_2
    //   48: iload_2
    //   49: iconst_m1
    ...
    //   56: iconst_0
    //   57: iload_2
    //   58: invokevirtual 209	java/io/ByteArrayOutputStream:write	([BII)V
    //   61: goto -21 -> 40
    //   64: astore_0
    //   65: iconst_0
    //   66: newarray byte
    ...
    //   83: iconst_1
    //   84: aload_0
    //   85: invokevirtual 212	java/io/IOException:toString	()Ljava/lang/String;
    //   88: aastore
    //   89: dup
    //   90: iconst_2
    //   91: ldc 214
    //   93: aastore
    //   94: invokestatic 106	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   97: aload_0
    //   98: invokevirtual 215	java/io/IOException:printStackTrace	()V
    //   101: aload 5
    //   103: astore_0
    //   104: aload_1
    //   105: ifnull +18 -> 123
    //   108: aload_1
    //   109: invokevirtual 73	com/tencent/qphone/base/remote/ToServiceMsg:getAttributes	()Ljava/util/HashMap;
    //   112: ldc 217
    //   114: ldc 118
    //   116: invokevirtual 85	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   119: pop
    //   120: aload 5
    //   122: astore_0
    //   123: invokestatic 188	java/lang/System:currentTimeMillis	()J
    //   126: lload_3
    //   127: lsub
    //   128: lstore_3
    //   129: aload_1
    //   130: ifnull +17 -> 147
    //   133: aload_1
    //   134: invokevirtual 73	com/tencent/qphone/base/remote/ToServiceMsg:getAttributes	()Ljava/util/HashMap;
    //   137: ldc 219
    //   139: lload_3
    //   140: invokestatic 134	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   143: invokevirtual 85	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   146: pop
    //   147: ldc 94
    //   149: iconst_1
    //   150: iconst_2
    ...
    //   160: iconst_1
    //   161: lload_3
    //   162: invokestatic 134	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   165: aastore
    //   166: invokestatic 106	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   169: aload_0
    //   170: areturn
    //   171: aload_0
    //   172: invokevirtual 222	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   175: astore_0
    //   176: aload_1
    //   177: ifnull +15 -> 192
    //   180: aload_1
    //   181: invokevirtual 73	com/tencent/qphone/base/remote/ToServiceMsg:getAttributes	()Ljava/util/HashMap;
    //   184: ldc 217
    //   186: ldc 92
    //   188: invokevirtual 85	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   191: pop
    //   192: ldc 94
    //   194: iconst_1
    //   195: ldc 224
    //   197: invokestatic 114	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   200: goto -77 -> 123
    //   203: astore_0
    //   204: iconst_0
    //   205: newarray byte
    ...
    //   222: iconst_1
    //   223: aload_0
    //   224: invokevirtual 227	java/lang/Throwable:toString	()Ljava/lang/String;
    //   227: aastore
    //   228: dup
    //   229: iconst_2
    //   230: ldc 214
    //   232: aastore
    //   233: invokestatic 106	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   236: aload_0
    //   237: invokevirtual 228	java/lang/Throwable:printStackTrace	()V
    //   240: aload 5
    //   242: astore_0
    //   243: aload_1
    //   244: ifnull -121 -> 123
    //   247: aload_1
    //   248: invokevirtual 73	com/tencent/qphone/base/remote/ToServiceMsg:getAttributes	()Ljava/util/HashMap;
    //   251: ldc 217
    //   253: ldc 230
    //   255: invokevirtual 85	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   258: pop
    //   259: aload 5
    //   261: astore_0
    //   262: goto -139 -> 123
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.common.ReadInJoyRefreshOptimizeUtil
