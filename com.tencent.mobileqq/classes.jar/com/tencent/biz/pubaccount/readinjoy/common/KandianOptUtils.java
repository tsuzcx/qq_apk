...
public class KandianOptUtils
{
  ...
  public static View a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7)
  {
    ...
    View localView = View.inflate(BaseApplicationImpl.sApplication, 2131563079, null);
    ((DragTextView)localView.findViewById(2131380896)).setDragViewType(2);
    ((ReadInjoyTabDragAnimationView)localView.findViewById(2131378843)).setEmotionDrawable(paramInt1, paramInt2, paramInt3, paramInt4, paramInt6, paramInt7);
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.common.KandianOptUtils
