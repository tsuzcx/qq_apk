...
public class KBPDUtils
{
  private static long jdField_a_of_type_Long;
  private static KBPDUtils.KBDownloadListener jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommonKBPDUtils$KBDownloadListener = new KBPDUtils.KBDownloadListener(null);
  private static KBPDUtils.NetInfoHandler jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommonKBPDUtils$NetInfoHandler = new KBPDUtils.NetInfoHandler(null);
    ...
    for (;;)
    {
      try
      {
        ...
        else
        {
          ...
          localObject2 = DownloadDBHelper.a().a("com.tencent.reading");
          boolean bool;
  ...
  {
    String str = b(ReadInJoyUtils.a(), "sp_key_local_apk_path");
  ...
  private static void b(Context paramContext, String paramString)
  {
    ...
    {
      a(ReadInJoyUtils.a(), "sp_key_current_app_version_name", paramContext.versionName);
    ...
    {
      a(ReadInJoyUtils.a(), "sp_key_local_apk_path", paramString);
      a(ReadInJoyUtils.a(), "sp_key_current_app_md5", paramContext);
  ...
  private static void b(String paramString1, String paramString2)
  {
    ...
    DownloadDBHelper.a().a(localDownloadInfo);
  }
  ...
  private static void b(boolean paramBoolean, long paramLong, int paramInt)
  {
    ...
    StatisticCollector.getInstance(ReadInJoyUtils.a().getApplication()).collectPerformance(str, "actKBPreDownload", paramBoolean, paramLong, 0L, localHashMap, null, false);
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes3.jar
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.common.KBPDUtils
