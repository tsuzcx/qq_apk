...
public class RefreshData
  extends SkinData
{
  public List<poe> adClickReports;
  public List<poe> adExposureReports;
  public Long adId;
  public boolean isAD;
  ...
  public RefreshData(JSONObject paramJSONObject)
  {
    ...
    if (localObject1 != null)
    {
      ...
      while (i < ((JSONArray)localObject1).length())
      {
        ...
        if (localObject2 != null)
        {
          ...
          localpoe.a = ((JSONObject)localObject2).optString("reportUrl", "");
          this.adClickReports.add(localpoe);
        }
        i += 1;
      }
    }
    ...
    if (paramJSONObject != null)
    {
      ...
      while (i < paramJSONObject.length())
      {
        ...
        if (localObject1 != null)
        {
          localObject2 = new poe();
          ((poe)localObject2).a = ((JSONObject)localObject1).optString("reportUrl", "");
  ...
  public RefreshData(oidb_0x5bd.RefreshInfo paramRefreshInfo)
  {
    ...
    for (;;)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        this.adClickReports.add(poe.a(localAdReport));
      }
      bool = false;
    }
    ...
    if ((paramRefreshInfo != null) && (paramRefreshInfo.size() > 0))
    {
      ...
      while (paramRefreshInfo.hasNext())
      {
        ...
        this.adExposureReports.add(poe.a((oidb_0x5bd.AdReport)localObject));
      }
    }
  }
  
  public List<String> getUrls(List<poe> paramList)
  {
    ...
    while (paramList.hasNext()) {
      localArrayList.add(((poe)paramList.next()).a);
    }
  ...
  public JSONObject toJson()
  {
    ...
    try
    {
      ...
      while ((this.adClickReports != null) && (i < this.adClickReports.size()))
      {
        ...
        localJSONObject2.put("reportUrl", ((poe)this.adClickReports.get(i)).a);
      ...
      {
        localJSONObject2 = new JSONObject();
        localJSONObject2.put("reportUrl", ((poe)this.adExposureReports.get(i)).a);
        localJSONArray.put(localJSONObject2);
        i += 1;
      }
