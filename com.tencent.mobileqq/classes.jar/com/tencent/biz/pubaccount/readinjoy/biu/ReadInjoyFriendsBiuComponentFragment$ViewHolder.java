...
public class ReadInjoyFriendsBiuComponentFragment$ViewHolder
{
  ...
  ReadInJoyUserInfoModule.RefreshUserInfoCallBack jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelReadInJoyUserInfoModule$RefreshUserInfoCallBack = new ReadInjoyFriendsBiuComponentFragment.ViewHolder.1(this);
  ...
  public String a;
  ArrayList<SocializeFeedsInfo.BiuCommentInfo> jdField_a_of_type_JavaUtilArrayList;
  ...
  {
    paramArrayList = SocializeFeedsInfo.a(null, "5", this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelReadInJoyUserInfoModule$RefreshUserInfoCallBack, paramArrayList);
  ...
  private boolean a(ArrayList<SocializeFeedsInfo.BiuCommentInfo> paramArrayList)
  {
    if (paramArrayList != null)
    {
      ...
      while (paramArrayList.hasNext()) {
        if (!TextUtils.isEmpty(((SocializeFeedsInfo.BiuCommentInfo)paramArrayList.next()).mBiuComment)) {
          return false;
        }
      }
    }
  ...
  {
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(paramContext).inflate(2131560322, null);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyHeadImageView = ((ReadInJoyHeadImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368312));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131372273));
    this.c = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131365027));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363730));
  }
  ...
  public void a(MultiBiuSameContent paramMultiBiuSameContent, int paramInt)
  {
    ...
    Object localObject = ReadInJoyTimeUtils.a(paramMultiBiuSameContent.jdField_b_of_type_Int, true);
    if (localObject != null) {
 ...
 * Qualified Name:     com.tencent.biz.pubaccount.readinjoy.biu.ReadInjoyFriendsBiuComponentFragment.ViewHolder
