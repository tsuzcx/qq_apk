...
public final class VideoReporter$1
  implements Runnable
{
  public VideoReporter$1(int paramInt1, long paramLong, String paramString1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, qxb paramqxb, int paramInt7, String paramString2, String paramString3) {}
  ...
  public void run()
  {
    ...
    localReportInfo.mVideoExtraRepoerData = this.jdField_a_of_type_Qxb;
    ...
    label344:
    for (String str = this.jdField_a_of_type_Qxb.toString();; str = "null")
    {
