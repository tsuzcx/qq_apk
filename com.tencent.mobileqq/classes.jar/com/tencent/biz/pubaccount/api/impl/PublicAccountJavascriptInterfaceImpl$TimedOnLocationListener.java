  ...
  extends SosoInterfaceOnLocationListener
{
  ...
  public void onConsecutiveFailure(int paramInt1, int paramInt2)
  {
    ...
    ReportController.b(null, "P_CliOper", "BizTechReport", "", "getlocation", "getdata", 0, 3, this.jdField_a_of_type_ComTencentBizPubaccountApiImplPublicAccountJavascriptInterfaceImpl.getNetworkType(), str, "", "");
    ...
    if (!this.jdField_c_of_type_Boolean)
    {
      if (paramInt == 0)
      {
        ...
        if (this.jdField_b_of_type_Boolean) {
          this.jdField_a_of_type_ComTencentBizPubaccountApiImplPublicAccountJavascriptInterfaceImpl.callJs(this.jdField_a_of_type_JavaLangString, new String[] { "0", "{type:2, lat:" + d1 + ", lon:" + d2 + "}" });
        }
        for (;;)
        {
    ...
    for (byte[] arrayOfByte = paramSosoLbsInfo.rawData;; arrayOfByte = null)
    {
      ...
      if (arrayOfByte != null)
      {
        ...
        for (;;)
        {
          try
          {
            paramSosoLbsInfo = ThreeDes.a(PublicAccountJavascriptInterfaceImpl.access$400(this.jdField_a_of_type_ComTencentBizPubaccountApiImplPublicAccountJavascriptInterfaceImpl, arrayOfByte), "nbyvie");
            ...
            this.jdField_a_of_type_Boolean = false;
            this.jdField_a_of_type_ComTencentBizPubaccountApiImplPublicAccountJavascriptInterfaceImpl.callJs(this.jdField_a_of_type_JavaLangString, new String[] { "0", "{type:1, decrypt_padding:" + this.jdField_a_of_type_Int + ",data:\"" + paramSosoLbsInfo + "\"}" });
            paramSosoLbsInfo = Long.toString(System.currentTimeMillis() - this.jdField_a_of_type_Long);
      ...
      for (;;)
      {
        ...
        if ((this.jdField_b_of_type_Boolean) && (paramInt != -10000) && (paramInt != 2))
        {
          ...
          if (l3 > 0L)
          {
            ...
            ((ISosoInterfaceApi)QRoute.api(ISosoInterfaceApi.class)).startLocation(new TimedOnLocationListener(this.jdField_a_of_type_ComTencentBizPubaccountApiImplPublicAccountJavascriptInterfaceImpl, 0, l3, l1, false, false, 0, true, this.jdField_a_of_type_JavaLangString));
          }
          for (;;)
          {
            paramSosoLbsInfo = Long.toString(System.currentTimeMillis() - this.jdField_a_of_type_Long);
