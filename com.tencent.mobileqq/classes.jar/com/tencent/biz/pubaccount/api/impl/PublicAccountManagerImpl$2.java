...
{
  PublicAccountManagerImpl$2(PublicAccountManagerImpl paramPublicAccountManagerImpl, NewIntent paramNewIntent, QQAppInterface paramQQAppInterface, String paramString, Context paramContext, BusinessObserver paramBusinessObserver) {}
      ...
      try
      {
        for (;;)
        {
          ...
          try
          {
            ...
            if (localGetPublicAccountMenuResponse.uin.has())
            {
              ...
              if (PAWeatherItemBuilder.a(String.valueOf(l)))
              {
                ...
                if ((localObject3 == null) || (((List)localObject3).size() == 0))
                {
                  ...
                  ((mobileqq_mp.ButtonInfo)localObject3).name.set(HardCodeUtil.a(2131708760));
                  ...
                  localButtonInfo.name.set(HardCodeUtil.a(2131708735));
              ...
              localObject2 = this.jdField_a_of_type_ComTencentBizPubaccountApiImplPublicAccountManagerImpl.getLocalPublicAccountMenuSetting(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString);
              ...
              label445:
              j = this.jdField_a_of_type_ComTencentBizPubaccountApiImplPublicAccountManagerImpl.getMenusettingLocalSeqno("" + l);
              if (i == j) {
                break;
              }
            }
            ...
            {
              ThreadManager.executeOnSubThread(new PublicAccountManagerImpl.2.1(this, localGetPublicAccountMenuResponse, paramInt, paramBoolean, paramBundle));
              return;
              l = 0L;
              break label101;
              label509:
