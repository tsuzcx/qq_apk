  ...
  implements Runnable
{
  ...
  public void run()
  {
    try
    {
      int i = azvv.a(this.this$0, 110.0F);
      Bitmap localBitmap = bacm.a(this.a, i, i);
      this.this$0.jdField_a_of_type_AndroidGraphicsDrawableDrawable = new BitmapDrawable(bacm.c(localBitmap, i, i));
