  ...
  extends WebChromeClient
{
  ...
  private String a(Context paramContext, String paramString)
  {
    ...
    if (paramString.startsWith("data:")) {
      return paramContext.getString(2131693564);
    }
    try
    {
  ...
  public boolean onJsAlert(WebView paramWebView, String paramString1, String paramString2, JsResult paramJsResult)
  {
    ...
    if (((localContext instanceof Activity)) && (!((Activity)localContext).isFinishing()) && ((!(paramWebView instanceof CustomWebView)) || (!((CustomWebView)paramWebView).isPaused)))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setPositiveButton(2131694615, new CustomWebChromeClient.1(this, paramJsResult));
      if (this.jdField_a_of_type_Int > 2) {
        this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setNegativeButton(localContext.getString(2131690769), localContext.getResources().getColor(2131165381), new CustomWebChromeClient.2(this, paramJsResult, localContext));
      }
  ...
  public boolean onJsBeforeUnload(WebView paramWebView, String paramString1, String paramString2, JsResult paramJsResult)
  {
    ...
    if (((paramString1 instanceof Activity)) && (!((Activity)paramString1).isFinishing()) && ((!(paramWebView instanceof CustomWebView)) || (!((CustomWebView)paramWebView).isPaused)))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setTitle(2131693563);
      this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setMessage(paramString2);
      this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setPositiveButton(2131690702, new CustomWebChromeClient.8(this, paramJsResult));
      if (this.jdField_a_of_type_Int > 2) {
        this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setNegativeButton(paramString1.getString(2131690769), paramString1.getResources().getColor(2131165381), new CustomWebChromeClient.9(this, paramJsResult, paramString1));
      }
      for (;;)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.show();
        return true;
        this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setNegativeButton(2131690701, new CustomWebChromeClient.10(this, paramJsResult));
      }
    }
    paramJsResult.cancel();
    return true;
  ...
  public boolean onJsConfirm(WebView paramWebView, String paramString1, String paramString2, JsResult paramJsResult)
  {
    ...
    if (((localContext instanceof Activity)) && (!((Activity)localContext).isFinishing()) && ((!(paramWebView instanceof CustomWebView)) || (!((CustomWebView)paramWebView).isPaused)))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setTitle(a(localContext, paramString1));
      this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setMessage(paramString2);
      this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setPositiveButton(2131694615, new CustomWebChromeClient.4(this, paramJsResult));
      if (this.jdField_a_of_type_Int > 2) {
        this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setNegativeButton(localContext.getString(2131690769), localContext.getResources().getColor(2131165381), new CustomWebChromeClient.5(this, paramJsResult, localContext));
      }
      for (;;)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.show();
        return true;
        this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setNegativeButton(2131690800, new CustomWebChromeClient.6(this, paramJsResult));
      }
    }
    paramJsResult.cancel();
    return true;
