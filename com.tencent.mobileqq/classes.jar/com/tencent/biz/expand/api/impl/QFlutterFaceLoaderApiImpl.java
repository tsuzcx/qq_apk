...
import com.tencent.biz.expand.api.ApiDecodeRequest;
import com.tencent.biz.expand.api.IQFlutterFaceLoaderApi;
  ...
  implements IQFlutterFaceLoaderApi
{
  ...
  private Map<Integer, QFlutterFaceLoaderApiImpl.InnerFaceObserver> mObserverList = new HashMap();
  ...
  public com.tencent.biz.expand.api.Pair<Bitmap, Boolean> getBitmap(ApiDecodeRequest paramApiDecodeRequest)
  {
    paramApiDecodeRequest = this.mLoader.a(convert2Rep(paramApiDecodeRequest));
    return new com.tencent.biz.expand.api.Pair(paramApiDecodeRequest.first, paramApiDecodeRequest.second);
  }
 ...
 * Qualified Name:     com.tencent.biz.expand.api.impl.QFlutterFaceLoaderApiImpl
