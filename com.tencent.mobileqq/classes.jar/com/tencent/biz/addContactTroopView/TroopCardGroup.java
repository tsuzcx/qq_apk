  ...
  extends BaseTroopCardView
{
  ...
  private void f()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131366386));
    this.b = ((TextView)findViewById(2131366387));
    this.jdField_a_of_type_ComTencentBizWidgetsListViewForListview = ((ListViewForListview)findViewById(2131366388));
    ...
    this.jdField_a_of_type_ComTencentBizWidgetsListViewForListview.setOnItemClickListener(new klb(this));
  }
  ...
  private void h()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new klc(this));
  }
  ...
  public void a(searchtab.Card paramCard)
  {
    if (paramCard != null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130846196);
  ...
  public void e()
  {
    if (this.jdField_a_of_type_ComTencentBizAddContactTroopViewTroopCardGroup$CMyAdapter != null) {
      this.jdField_a_of_type_ComTencentBizAddContactTroopViewTroopCardGroup$CMyAdapter.V_();
    }
    super.e();
  }
}
