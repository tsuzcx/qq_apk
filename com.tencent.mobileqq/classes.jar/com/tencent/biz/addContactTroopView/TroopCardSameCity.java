  ...
  extends BaseTroopCardView
{
  ...
  public TroopCardSameCity(ContactBaseView.IAddContactContext paramIAddContactContext)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetBaseAdapter = new klg(this);
  }
  
  private void f()
  {
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131366386));
    this.b = ((TextView)findViewById(2131366389));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131366387));
    this.jdField_a_of_type_ComTencentBizWidgetsGridViewForScrollView = ((GridViewForScrollView)findViewById(2131366391));
  ...
  private void g()
  {
    this.jdField_a_of_type_ComTencentBizWidgetsGridViewForScrollView.setOnItemClickListener(new kle(this));
  }
  ...
  private void i()
  {
    ...
    this.b.setOnClickListener(new klf(this));
  }
