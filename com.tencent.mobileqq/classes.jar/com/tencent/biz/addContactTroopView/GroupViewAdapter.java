...
public class GroupViewAdapter
{
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (((oidb_0x935.RgroupInfo)localObject).rpt_group_label.has()) {
          paramRecommendTroopItem.labelList = RecommendTroopManagerImp.a(((oidb_0x935.RgroupInfo)localObject).rpt_group_label.get());
        }
  ...
  {
    paramContext = NearbyTroops.a(paramContext, paramViewGroup, paramInt2, 2131561589);
    paramViewGroup = (NearbyTroops.CustomViewHolder)paramContext.getTag();
    paramViewGroup.a.setMaxLabelCount(paramInt1);
    paramViewGroup.a.setmIsNeedPriority(paramBoolean);
    paramViewGroup.b = 1;
