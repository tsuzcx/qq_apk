  ...
  implements Manager
{
  ...
  {
    ThreadManager.post(new kmp(this, paramRspBody), 8, null, false);
  }
  ...
  private boolean a(troopviewInfo.RspBody paramRspBody)
  {
    ...
    return FileUtils.a(new File(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApplication().getFilesDir(), "AddContactTroopManage" + this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin()).getAbsolutePath(), paramRspBody.toByteArray(), false);
  }
  ...
  private troopviewInfo.RspBody b()
  {
    ...
    //   42: invokestatic 96	com/tencent/mobileqq/utils/FileUtils:a	(Ljava/io/File;)[B
    //   45: astore_2
