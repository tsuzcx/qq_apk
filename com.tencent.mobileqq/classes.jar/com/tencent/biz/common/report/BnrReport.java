...
public class BnrReport
{
  ...
  protected static SparseIntArray a()
  {
    ...
    //   0: iconst_0
    //   1: istore_1
    //   2: new 27	java/util/ArrayList
    //   5: dup
    //   6: invokespecial 46	java/util/ArrayList:<init>	()V
    //   9: pop
    //   10: invokestatic 49	com/tencent/biz/common/report/BnrReport:a	()Lorg/json/JSONObject;
    //   13: astore 4
    //   15: aload 4
    //   17: ifnonnull +5 -> 22
    //   20: aconst_null
    //   21: areturn
    //   22: new 51	android/util/SparseIntArray
    //   25: dup
    //   26: invokespecial 52	android/util/SparseIntArray:<init>	()V
    //   29: astore_3
    //   30: aload 4
    //   32: ldc 54
    //   34: invokevirtual 60	org/json/JSONObject:getJSONArray	(Ljava/lang/String;)Lorg/json/JSONArray;
    //   37: astore 4
    //   39: aload 4
    //   41: invokevirtual 65	org/json/JSONArray:length	()I
    //   44: istore_2
    //   45: iconst_0
    //   46: istore_0
    //   47: iload_0
    ...
    //   53: aload 4
    //   55: iload_0
    //   56: invokevirtual 69	org/json/JSONArray:getJSONObject	(I)Lorg/json/JSONObject;
    //   59: ldc 71
    //   61: invokevirtual 75	org/json/JSONObject:getInt	(Ljava/lang/String;)I
    //   64: iconst_0
    //   65: invokevirtual 79	android/util/SparseIntArray:put	(II)V
    //   68: iload_0
    //   69: iconst_1
    //   70: iadd
    //   71: istore_0
    ...
    //   75: astore_3
    //   76: aload_3
    //   77: invokevirtual 82	org/json/JSONException:printStackTrace	()V
    //   80: aconst_null
    //   81: areturn
    //   82: astore 5
    //   84: aload 5
    //   86: invokevirtual 82	org/json/JSONException:printStackTrace	()V
    //   89: goto -21 -> 68
    //   92: invokestatic 88	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   95: ldc 90
    //   97: iconst_0
    //   98: invokevirtual 94	com/tencent/qphone/base/util/BaseApplication:getSharedPreferences	(Ljava/lang/String;I)Landroid/content/SharedPreferences;
    //   101: ldc 96
    //   103: ldc 98
    //   105: invokeinterface 104 3 0
    //   110: astore 4
    //   112: invokestatic 110	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   115: ifeq +29 -> 144
    //   118: ldc 112
    //   120: iconst_4
    ...
    //   141: invokestatic 129	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   144: aload 4
    //   146: invokestatic 135	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   149: ifne +75 -> 224
    //   152: aload 4
    //   154: ldc 137
    //   156: invokevirtual 143	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   159: astore 4
    //   161: aload 4
    //   163: arraylength
    //   164: istore_2
    ...
    //   175: aaload
    //   176: ldc 145
    //   178: invokevirtual 143	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   181: astore 5
    //   183: aload_3
    //   184: aload 5
    //   186: iconst_0
    //   187: aaload
    //   188: invokestatic 149	java/lang/Integer:valueOf	(Ljava/lang/String;)Ljava/lang/Integer;
    //   191: invokevirtual 40	java/lang/Integer:intValue	()I
    //   194: aload 5
    //   196: iconst_1
    //   197: aaload
    //   198: invokestatic 149	java/lang/Integer:valueOf	(Ljava/lang/String;)Ljava/lang/Integer;
    //   201: invokevirtual 40	java/lang/Integer:intValue	()I
    //   204: invokevirtual 79	android/util/SparseIntArray:put	(II)V
    //   207: iload_0
    //   208: iconst_1
    //   209: iadd
    //   210: istore_0
    ...
    //   214: astore 5
    //   216: aload 5
    //   218: invokevirtual 150	java/lang/NumberFormatException:printStackTrace	()V
    //   221: goto -14 -> 207
    //   224: aload_3
    //   225: areturn
  ...
  protected static void a(JSONObject paramJSONObject, int paramInt, boolean paramBoolean)
  {
    ...
    //   5: iconst_1
    //   6: if_icmplt +18 -> 24
    //   9: getstatic 25	com/tencent/biz/common/report/BnrReport:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   12: ifnull +12 -> 24
    //   15: getstatic 25	com/tencent/biz/common/report/BnrReport:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   18: invokevirtual 31	java/util/ArrayList:size	()I
    //   21: ifne +4 -> 25
    //   24: return
    //   25: aload_0
    //   26: ldc 71
    //   28: invokevirtual 75	org/json/JSONObject:getInt	(Ljava/lang/String;)I
    //   31: istore_3
    //   32: iload_3
    //   33: invokestatic 432	com/tencent/biz/common/report/BnrReport:a	(I)I
    //   36: iconst_m1
    //   37: if_icmple +14 -> 51
    //   40: getstatic 25	com/tencent/biz/common/report/BnrReport:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   43: iload_3
    //   44: invokestatic 432	com/tencent/biz/common/report/BnrReport:a	(I)I
    //   47: invokevirtual 435	java/util/ArrayList:remove	(I)Ljava/lang/Object;
    //   50: pop
    //   51: aload_0
    //   52: ldc 54
    //   54: invokevirtual 60	org/json/JSONObject:getJSONArray	(Ljava/lang/String;)Lorg/json/JSONArray;
    //   57: astore_0
    //   58: aload_0
    //   59: ifnull -35 -> 24
    //   62: aload_0
    //   63: invokevirtual 65	org/json/JSONArray:length	()I
    //   66: istore 4
    //   68: iconst_0
    //   69: istore_3
    //   70: iload_3
    ...
    //   76: aload_0
    //   77: iload_3
    //   78: invokevirtual 69	org/json/JSONArray:getJSONObject	(I)Lorg/json/JSONObject;
    //   81: astore 5
    //   83: aload 5
    //   85: ldc 71
    //   87: invokevirtual 75	org/json/JSONObject:getInt	(Ljava/lang/String;)I
    //   90: iload_1
    //   91: if_icmpeq +7 -> 98
    //   94: iload_2
    //   95: ifeq +10 -> 105
    ...
    //   100: iload_1
    //   101: iconst_1
    //   102: invokestatic 414	com/tencent/biz/common/report/BnrReport:a	(Lorg/json/JSONObject;IZ)V
    //   105: iload_3
    //   106: iconst_1
    //   107: iadd
    //   108: istore_3
    ...
    //   112: astore_0
    //   113: aload_0
    //   114: invokevirtual 82	org/json/JSONException:printStackTrace	()V
    //   117: return
    //   118: astore_0
    //   119: aload_0
    //   120: invokevirtual 82	org/json/JSONException:printStackTrace	()V
    //   123: aconst_null
    //   124: astore_0
    //   125: goto -67 -> 58
    //   128: astore 5
    //   130: aload 5
    //   132: invokevirtual 82	org/json/JSONException:printStackTrace	()V
    //   135: goto -30 -> 105
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  protected static void a(JSONObject paramJSONObject, List<Integer> paramList, boolean paramBoolean)
  {
    ...
    //   5: ifnull +12 -> 17
    //   8: aload_1
    //   9: invokeinterface 403 1 0
    //   14: ifne +4 -> 18
    //   17: return
    //   18: getstatic 25	com/tencent/biz/common/report/BnrReport:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   21: ifnonnull +13 -> 34
    //   24: new 27	java/util/ArrayList
    //   27: dup
    //   28: invokespecial 46	java/util/ArrayList:<init>	()V
    //   31: putstatic 25	com/tencent/biz/common/report/BnrReport:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   34: aload_0
    //   35: ldc 71
    //   37: invokevirtual 75	org/json/JSONObject:getInt	(Ljava/lang/String;)I
    //   40: istore_3
    //   41: aload_1
    //   42: iload_3
    //   43: invokestatic 438	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   46: invokeinterface 442 2 0
    //   51: iconst_m1
    //   52: if_icmpgt +7 -> 59
    //   55: iload_2
    //   56: ifeq +100 -> 156
    ...
    //   64: aload_0
    //   65: ldc 54
    //   67: invokevirtual 60	org/json/JSONObject:getJSONArray	(Ljava/lang/String;)Lorg/json/JSONArray;
    //   70: astore_0
    //   71: aload_0
    //   72: ifnull +61 -> 133
    //   75: aload_0
    //   76: invokevirtual 65	org/json/JSONArray:length	()I
    //   79: istore 4
    //   81: iconst_0
    //   82: istore_3
    //   83: iload_3
    ...
    //   89: aload_0
    //   90: iload_3
    //   91: invokevirtual 69	org/json/JSONArray:getJSONObject	(I)Lorg/json/JSONObject;
    //   94: aload_1
    //   95: iload_2
    //   96: invokestatic 424	com/tencent/biz/common/report/BnrReport:a	(Lorg/json/JSONObject;Ljava/util/List;Z)V
    //   99: iload_3
    //   100: iconst_1
    //   101: iadd
    //   102: istore_3
    ...
    //   106: astore_0
    //   107: aload_0
    //   108: invokevirtual 82	org/json/JSONException:printStackTrace	()V
    //   111: return
    //   112: astore_0
    //   113: aload_0
    //   114: invokevirtual 82	org/json/JSONException:printStackTrace	()V
    ...
    //   123: astore 5
    //   125: aload 5
    //   127: invokevirtual 82	org/json/JSONException:printStackTrace	()V
    //   130: goto -31 -> 99
    //   133: iload_2
    //   134: ifeq -117 -> 17
    //   137: iload_3
    //   138: invokestatic 363	com/tencent/biz/common/report/BnrReport:a	(I)Z
    //   141: ifne -124 -> 17
    //   144: getstatic 25	com/tencent/biz/common/report/BnrReport:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   147: iload_3
    //   148: invokestatic 438	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   151: invokevirtual 445	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   154: pop
    //   155: return
    //   156: iconst_0
    //   157: istore_2
