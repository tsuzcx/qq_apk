...
public class ImageUtil
{
  ...
  public static final Bitmap a(String paramString, int paramInt)
  {
    ...
    //   185: goto -107 -> 78
    //   188: astore_0
    //   189: invokestatic 60	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   192: ifeq -41 -> 151
    ...
    //   235: areturn
    //   236: astore_0
    //   237: invokestatic 60	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   240: ifeq -6 -> 234
    ...
    //   260: aload_0
    //   261: astore 4
    //   263: invokestatic 60	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   266: ifeq +17 -> 283
    //   269: aload_0
    //   270: astore 4
    ...
    //   292: areturn
    //   293: astore_0
    //   294: invokestatic 60	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   297: ifeq -6 -> 291
    ...
    //   328: athrow
    //   329: astore 4
    //   331: invokestatic 60	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   334: ifeq -7 -> 327
  ...
  public static String a(android.content.Context paramContext, String paramString, android.os.Bundle paramBundle)
  {
    ...
    //   170: invokestatic 60	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   173: ifeq -145 -> 28
    ...
    //   275: aload_1
    //   276: astore_0
    //   277: invokestatic 60	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   280: ifeq +15 -> 295
    //   283: aload_1
    //   284: astore_0
  ...
  public static String a(Bitmap paramBitmap)
  {
    ...
    //   166: aload_2
    //   167: astore_1
    //   168: invokestatic 60	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   171: ifeq +15 -> 186
    //   174: aload_2
    //   175: astore_1
    //   176: getstatic 18	com/tencent/biz/common/util/ImageUtil:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   245: aload 4
    //   247: astore_1
    //   248: invokestatic 60	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   251: ifeq -9 -> 242
    ...
    //   268: aload_2
    //   269: astore_1
    //   270: invokestatic 60	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   273: ifeq +15 -> 288
    //   276: aload_2
    //   277: astore_1
    ...
    //   400: aload_0
    //   401: astore_1
    //   402: invokestatic 60	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   405: ifeq +16 -> 421
    //   408: aload_0
    //   409: astore_1
    ...
    //   438: aload_2
    //   439: astore_1
    //   440: invokestatic 60	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   443: ifeq -201 -> 242
    ...
    //   470: athrow
    //   471: astore_1
    //   472: invokestatic 60	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   475: ifeq -6 -> 469
