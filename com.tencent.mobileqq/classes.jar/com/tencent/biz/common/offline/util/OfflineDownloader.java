      ...
      try
      {
        ...
        if (i == 0)
        {
          ...
          try
          {
            ...
            DownloadInfoReport.a(paramContext, paramString3);
            return;
          }
  ...
  public void a(TMAssistantDownloadClient paramTMAssistantDownloadClient, DownloadInfo paramDownloadInfo, String paramString)
  {
    ...
    try
    {
      ...
      for (paramTMAssistantDownloadClient = localObject;; paramTMAssistantDownloadClient = paramTMAssistantDownloadClient.mSavePath)
      {
        ...
        a(paramDownloadInfo.jdField_a_of_type_ComTencentBizCommonOfflineAsyncBack, paramString, paramDownloadInfo.c, 14, "get current download path fail after download");
        return;
      }
    ...
    {
      a(paramDownloadInfo.jdField_a_of_type_ComTencentBizCommonOfflineAsyncBack, paramString, paramDownloadInfo.c, 15, "cannot get current file after download");
      return;
    }
    if (!FileUtils.d(localTMAssistantDownloadClient, paramDownloadInfo.b))
    {
      a(paramDownloadInfo.jdField_a_of_type_ComTencentBizCommonOfflineAsyncBack, paramString, paramDownloadInfo.c, 16, "rename file fail after download");
      paramTMAssistantDownloadClient.delete();
      return;
    }
    a(paramDownloadInfo.jdField_a_of_type_ComTencentBizCommonOfflineAsyncBack, paramString, paramDownloadInfo.c, 0, "offline zip download success");
  }
