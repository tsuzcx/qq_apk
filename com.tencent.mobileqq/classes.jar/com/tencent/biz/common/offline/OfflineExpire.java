    ...
    for (paramInt = 300000;; paramInt = 0)
    {
      ...
      for (;;)
      {
        ...
        if ((k > 0) && (k < 10))
        {
          ...
          BidDownloader localBidDownloader = new BidDownloader(str1, paramQQAppInterface, new knu(paramContext, str2, m, str1), true, k);
          ...
          if ((localJSONObject == null) || (localJSONObject.optInt("version", 0) < localBidDownloader.d))
          {
            ...
            for (boolean bool = true;; bool = false)
            {
              ...
              localObject = new knx(paramQQAppInterface, str1, localBidDownloader);
      ...
      label399:
      ThreadManager.getSubThreadHandler().postDelayed(new knv(paramContext, localArrayList), paramInt);
      return;
    }
  }
