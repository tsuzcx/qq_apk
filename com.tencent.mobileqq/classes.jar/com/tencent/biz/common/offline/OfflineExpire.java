...
public class OfflineExpire
{
  ...
  protected static void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (k > 0)
      {
        localObject = OfflineEnvHelper.a(k + "");
    ...
    for (paramInt = 300000;; paramInt = 0)
    {
      ...
      for (;;)
      {
        ...
        if ((k > 0) && (k < 10))
        {
          ...
          BidDownloader localBidDownloader = new BidDownloader(str1, paramQQAppInterface, new OfflineExpire.1(paramContext, str2, m, str1), true, k);
          ...
          if ((localJSONObject == null) || (localJSONObject.optInt("version", 0) < localBidDownloader.d))
          {
            ...
            for (boolean bool = true;; bool = false)
            {
              ...
              localBidDownloader.jdField_a_of_type_Boolean = true;
              localObject = new OfflineExpire.OfflinePreDownloadTask(paramQQAppInterface, str1, localBidDownloader);
