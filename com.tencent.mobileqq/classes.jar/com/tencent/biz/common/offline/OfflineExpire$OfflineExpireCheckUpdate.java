  ...
  implements CheckUpdateItemInterface
{
  ...
  public ReqItem a()
  {
    ...
    if ((localObject instanceof QQAppInterface))
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d(OfflineExpire.jdField_a_of_type_JavaLangString, 1, String.format("OfflineExpireCheckUpdate, check update QQ Version: %s", new Object[] { "7.6.0.3525" }));
      }
  ...
  public void a(RespItem paramRespItem)
  {
    ...
    while (!QLog.isColorLevel()) {
      try
      {
        ...
        ThreadManager.getSubThreadHandler().postDelayed(new kme(this), 180000L);
        return;
      }
