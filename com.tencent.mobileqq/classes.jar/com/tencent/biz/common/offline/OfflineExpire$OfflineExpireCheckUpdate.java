  ...
  implements CheckUpdateItemInterface
{
  ...
  public ReqItem a(int paramInt)
  {
    ...
    if ((localObject instanceof QQAppInterface))
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d(OfflineExpire.jdField_a_of_type_JavaLangString, 1, String.format("OfflineExpireCheckUpdate, check update QQ Version: %s", new Object[] { "8.5.5.5105" }));
      }
      ...
      paramInt = NetworkUtil.a(((QQAppInterface)localObject).getApp());
