  ...
  implements Handler.Callback
{
  ...
  static
  {
    jdField_a_of_type_Nmy = new nob();
    jdField_a_of_type_Nmx = new nna();
    jdField_d_of_type_JavaLangString = "BidDownloader";
  }
  
  public BidDownloader(String paramString, AppRuntime paramAppRuntime, nmg paramnmg, boolean paramBoolean, int paramInt)
  {
    ...
    this.jdField_a_of_type_Nmg = paramnmg;
    ...
    if (paramInt == 1)
    {
      ...
      paramString = nmp.b(this.jdField_a_of_type_JavaLangString);
      if (!TextUtils.isEmpty(paramString))
      {
        if (!this.e) {
          break label205;
  ...
  private void a(int paramInt1, int paramInt2)
  {
    if (this.jdField_a_of_type_Nmg != null) {
      this.jdField_a_of_type_Nmg.loaded(null, paramInt1);
    }
  }
  ...
  public static void b(String paramString)
  {
    ...
    do
    {
      ...
      if ((paramString.f) && (nny.a(jdField_a_of_type_AndroidContentContext) != 1) && (!g))
      {
  ...
  private void d()
  {
    ...
    return;
    nmj.a(jdField_a_of_type_AndroidContentContext.getApplicationContext(), this.jdField_a_of_type_JavaLangString);
    b();
    if (QLog.isColorLevel()) {
      QLog.i(jdField_d_of_type_JavaLangString, 2, this.jdField_a_of_type_JavaLangString + this.jdField_c_of_type_JavaLangString + this.jdField_b_of_type_Nmg);
    }
  ...
  public boolean a()
  {
    ...
    this.jdField_b_of_type_Nmg = new nmi(this, l);
  ...
  public void b()
  {
    jdField_a_of_type_Nmy.c(new BidDownloader.2(this));
  }
  ...
  public boolean b()
  {
    ...
    try
    {
      ...
      for (;;)
      {
        return bool2;
        bool2 = bool1;
        if (!TextUtils.isEmpty(nmp.b(str1)))
        {
      ...
      if (((String)localObject2).equals("7z"))
      {
        ...
        if (this.e)
        {
          ...
          if (((File)localObject2).exists())
          {
            ...
            bool1 = bool2;
            if (!bool2) {
              bool1 = bhmi.b(str4, (String)localObject1);
            }
            if (!bool1)
            {
              nmj.a(str2, 13, 0L, i, "lixian_update", "0");
            ...
            nmj.a(str2, 13, 0L, i, "lixian_time", "0");
            bool1 = true;
            break label691;
          }
          nmj.a(str2, 13, 0L, i, "lixian_update", "0");
  ...
  public void c()
  {
    ...
    jdField_a_of_type_Nmy.c(new BidDownloader.4(this));
  }
