  ...
  private void a(View paramView, float paramFloat)
  {
    ...
    if ((this.jdField_a_of_type_Int == 0) && (paramFloat < 0.0F) && (paramFloat >= -1.0F))
    {
      ...
      if (this.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(i)) == null)
      {
        ...
        yqp.b("ThreeDTransformer", "mInitMatcher viewId: " + i + " | count: " + 0);
      }
    }
    ...
    {
      yqp.b("ThreeDTransformer", paramView);
      return;
      this.jdField_a_of_type_Int = i;
      this.jdField_a_of_type_Float = paramFloat;
      this.jdField_a_of_type_JavaUtilHashMap.clear();
      yqp.b("ThreeDTransformer", "initDrawingView pos: " + this.jdField_a_of_type_Int);
      return;
      bool = false;
      break;
    }
