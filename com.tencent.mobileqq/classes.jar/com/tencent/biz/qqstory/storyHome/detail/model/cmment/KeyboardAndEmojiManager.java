  ...
  implements View.OnClickListener
{
  ...
  EmoticonCallback jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonCallback = new nzs(this);
  ...
  public KeyboardAndEmojiManager(Context paramContext, View paramView, nzt paramnzt)
  {
  ...
  private void c()
  {
    ((PatchedButton)this.jdField_a_of_type_AndroidViewView.findViewById(2131363518)).setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetImageButton.setOnClickListener(this);
    this.jdField_a_of_type_AndroidViewView.getViewTreeObserver().addOnGlobalLayoutListener(new nzq(this));
  }
  ...
  private void d()
  {
    ...
    if (this.jdField_a_of_type_Nzt != null) {
      this.jdField_a_of_type_Nzt.b(this.d);
    }
    this.d = false;
  ...
  private void e()
  {
    ...
    {
      if (this.jdField_a_of_type_Nzt != null) {
        this.jdField_a_of_type_Nzt.c(bool);
      }
      this.c = false;
      this.d = false;
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      } while ((this.jdField_a_of_type_Nzt != null) && (this.jdField_a_of_type_Nzt.b()));
      this.c = true;
