  ...
  implements View.OnTouchListener, RequestDataListener, AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener
{
  ...
  private void a(String paramString, boolean paramBoolean)
  {
    ...
    localIntent.putExtra("new_video_extra_info", paramString);
    if (paramBoolean) {
      localIntent.putExtra("selfSet_leftViewText", getActivity().getString(2131433712));
    }
    startActivity(localIntent);
  }
    ...
    for (;;)
    {
      ...
      else
      {
        if (this.jdField_a_of_type_Boolean)
        {
          ...
          getView().postDelayed(new nzv(this), 100);
  ...
  public void b(DetailFeedItem paramDetailFeedItem, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeDetailViewStoryDetailListView.setOnLoadMoreListener("StoryDetailFragment", new nzw(this));
  ...
  public void onActivityCreated(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeDetailViewStoryDetailListView.setOnLoadMoreListener("StoryDetailFragment", new nzu(this));
  ...
  public void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeDetailModelCmmentDetailCommentHelper != null)
      {
        ...
        ThreadManager.getUIHandler().postDelayed(new nzx(this), 100L);
      }
    }
  }
  ...
  {
    paramLayoutInflater = paramLayoutInflater.inflate(2130970720, paramViewGroup, false);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramLayoutInflater.findViewById(2131362846));
    this.jdField_a_of_type_ComTencentBizQqstoryViewWidgetQQStoryLoadingView = ((QQStoryLoadingView)paramLayoutInflater.findViewById(2131362956));
    this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeDetailViewStoryDetailListView = ((StoryDetailListView)paramLayoutInflater.findViewById(2131364313));
