  ...
  implements View.OnTouchListener, RequestDataListener, AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener
{
  ...
  private void a(String paramString, boolean paramBoolean)
  {
    ...
    localIntent.putExtra("new_video_extra_info", paramString);
    if (paramBoolean) {
      localIntent.putExtra("selfSet_leftViewText", getActivity().getString(2131433681));
    }
    startActivity(localIntent);
  }
    ...
    for (;;)
    {
      ...
      else
      {
        if (this.jdField_a_of_type_Boolean)
        {
          ...
          getView().postDelayed(new nts(this), 100);
  ...
  public void b(DetailFeedItem paramDetailFeedItem, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeDetailViewStoryDetailListView.setOnLoadMoreListener("StoryDetailFragment", new ntt(this));
  ...
  public void onActivityCreated(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeDetailViewStoryDetailListView.setOnLoadMoreListener("StoryDetailFragment", new ntr(this));
  ...
  {
    paramLayoutInflater = paramLayoutInflater.inflate(2130970658, paramViewGroup, false);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramLayoutInflater.findViewById(2131362823));
    this.jdField_a_of_type_ComTencentBizQqstoryViewWidgetQQStoryLoadingView = ((QQStoryLoadingView)paramLayoutInflater.findViewById(2131362933));
    this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeDetailViewStoryDetailListView = ((StoryDetailListView)paramLayoutInflater.findViewById(2131364264));
