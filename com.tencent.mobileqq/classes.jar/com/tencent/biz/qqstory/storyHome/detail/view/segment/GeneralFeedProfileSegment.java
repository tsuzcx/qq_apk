  ...
  implements View.OnClickListener, QQStoryAutoPlayView.StoryCoverClickListener, StoryHomeHorizontalListView.OnOverScrollRightListener, StoryHomeHorizontalListView.OnScrollChangeListener, LoadingMoreHelper.OnLoadMoreListener
{
  ...
  private View a(int paramInt, BaseViewHolder paramBaseViewHolder)
  {
    ...
    Object localObject = (RelativeLayout)paramBaseViewHolder.a(2131371678);
    ImageView localImageView = (ImageView)paramBaseViewHolder.a(2131371692);
    TextView localTextView3 = (TextView)paramBaseViewHolder.a(2131362748);
    ...
    TextView localTextView2 = (TextView)paramBaseViewHolder.a(2131371693);
    RelativeLayout localRelativeLayout = (RelativeLayout)paramBaseViewHolder.a(2131371647);
    StoryHomeHorizontalListView localStoryHomeHorizontalListView = (StoryHomeHorizontalListView)paramBaseViewHolder.a(2131371699);
  ...
  {
    this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeQqstorylistViewBaseViewHolder = new BaseViewHolder(LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130970719, paramViewGroup, false));
  ...
  protected void a(int paramInt, BaseViewHolder paramBaseViewHolder, RelativeLayout paramRelativeLayout, StoryHomeHorizontalListView paramStoryHomeHorizontalListView)
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeDetailModelDetailFeedItem.a().size() == 1)
    {
      ...
      paramStoryHomeHorizontalListView = (QQStoryAutoPlayView)paramBaseViewHolder.a(2131371648);
      TextView localTextView = (TextView)paramBaseViewHolder.a(2131371649);
      paramBaseViewHolder = (TextView)paramBaseViewHolder.a(2131371650);
    ...
    if (paramRelativeLayout == null)
    {
      ...
      paramStoryHomeHorizontalListView.setDividerWidth(this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131560281));
    ...
    for (paramBaseViewHolder = paramRelativeLayout;; paramBaseViewHolder = paramRelativeLayout)
    {
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          paramStoryHomeHorizontalListView.setOnScrollStateChangedListener(new oai(this, paramStoryHomeHorizontalListView, paramBaseViewHolder));
          return;
        }
        paramInt += 1;
      }
  ...
  protected void a(TextView paramTextView, int paramInt, String paramString)
  {
    ...
    case 1: 
      ...
      paramTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131494220));
      paramTextView.setBackgroundResource(2130843523);
  ...
  {
    LinearLayout localLinearLayout = (LinearLayout)paramBaseViewHolder.a(2131371697);
    paramBaseViewHolder = (TextView)paramBaseViewHolder.a(2131371698);
    ...
    for (;;)
    {
      ...
      if (i > 0)
      {
        ...
        paramBaseViewHolder.setText(StoryApi.a(2131432106, new Object[] { Integer.valueOf(i) }));
        return;
      }
      localLinearLayout.setVisibility(8);
