...
{
  private CommentEntry jdField_a_of_type_ComTencentBizQqstoryDatabaseCommentEntry;
  public CommentLikeFeedItem a;
  private String jdField_a_of_type_JavaLangString;
  private HashSet jdField_a_of_type_JavaUtilHashSet = new HashSet();
  private List jdField_a_of_type_JavaUtilList = new ArrayList(0);
  private boolean jdField_a_of_type_Boolean = true;
  private CommentEntry jdField_b_of_type_ComTencentBizQqstoryDatabaseCommentEntry;
  private String jdField_b_of_type_JavaLangString;
  private HashSet jdField_b_of_type_JavaUtilHashSet = new HashSet();
  private List jdField_b_of_type_JavaUtilList = new ArrayList(0);
  private boolean jdField_b_of_type_Boolean = true;
  private HashSet jdField_c_of_type_JavaUtilHashSet = new HashSet();
  private List jdField_c_of_type_JavaUtilList = new ArrayList(0);
  private HashSet jdField_d_of_type_JavaUtilHashSet = new HashSet();
  private List jdField_d_of_type_JavaUtilList = new ArrayList(0);
  private HashSet jdField_e_of_type_JavaUtilHashSet = new HashSet();
  private List jdField_e_of_type_JavaUtilList = new ArrayList(0);
  ...
  public void b(CommentEntry paramCommentEntry, boolean paramBoolean)
  {
    if (paramBoolean)
    {
      this.jdField_b_of_type_JavaUtilList.remove(paramCommentEntry);
    ...
    for (;;)
    {
      ...
      return;
      this.jdField_d_of_type_JavaUtilList.remove(paramCommentEntry);
  ...
  public void b(List paramList, boolean paramBoolean1, boolean paramBoolean2)
  {
