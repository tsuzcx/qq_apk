    ...
    for (;;)
    {
      ...
      if (paramStoryMessage.share_info.has())
      {
        ...
        for (bool1 = bool7;; bool1 = false)
        {
          ...
          this.jdField_e_of_type_JavaLangString = StoryApi.a(2131432117, new Object[] { this.k });
          break label1008;
          this.jdField_a_of_type_Int = 7;
          this.l = ((qqstory_710_message.ShareGroupInfo)localObject).share_new_name.get().toStringUtf8();
          this.jdField_e_of_type_JavaLangString = StoryApi.a(2131432118, new Object[] { this.l });
          break label1008;
          this.jdField_a_of_type_Int = 8;
          break label1008;
          this.jdField_a_of_type_Int = 9;
          this.jdField_e_of_type_JavaLangString = StoryApi.a(2131432119, new Object[] { this.k });
          break label1008;
