...
class StoryMessageListActivity$2
  extends ProtoUtils.StoryProtocolObserver
{
  StoryMessageListActivity$2(StoryMessageListActivity paramStoryMessageListActivity) {}
  ...
  public qqstory_struct.ErrorInfo a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    if (k == 0) {
      QQToast.makeText(this.d.getApplicationContext(), 1, HardCodeUtil.a(2131911842), 0).show();
    }
    return paramBundle;
  }
}
