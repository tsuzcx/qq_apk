  ...
  implements View.OnClickListener
{
  ...
  oct jdField_a_of_type_Oct = new oct();
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (a(paramInt))
    {
      if (paramView == null)
      {
        paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130970794, paramViewGroup, false);
        ...
        paramView = this.jdField_a_of_type_Oct.a(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeMessagenotifyStoryMessageListActivity, paramView, paramViewGroup, -1);
      ...
      for (;;)
      {
        if (localMessageData.jdField_e_of_type_Int == 4)
        {
          ...
          if (!localMessageData.b().equals(paramViewGroup.jdField_b_of_type_JavaLangString))
          {
            ...
            localObject1 = this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeMessagenotifyStoryMessageListActivity.getResources().getDrawable(2130843867);
          }
        }
        try
        {
          ...
          if (paramInt == this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeMessagenotifyStoryMessageListActivity.a.size() - 1) {
            if (getCount() == this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeMessagenotifyStoryMessageListActivity.a.size())
            {
              ...
              this.jdField_a_of_type_Oct.a(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeMessagenotifyStoryMessageListActivity, paramView, paramInt, localMessageData, paramViewGroup, this);
              ...
              {
                paramViewGroup.jdField_b_of_type_AndroidWidgetTextView.setText(2131432120);
                paramViewGroup.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
                paramViewGroup.c.setVisibility(8);
                paramViewGroup.jdField_a_of_type_AndroidViewView.setVisibility(8);
                break label316;
    ...
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130970795, paramViewGroup, false);
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeMessagenotifyStoryMessageListActivity.jdField_b_of_type_Boolean)
      {
        ...
        paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.setText(2131432131);
