  ...
  implements wcl, wpi, wpm
{
  ...
  private avqs jdField_a_of_type_Avqs = new wct(this);
  public best a;
  ...
  private wck jdField_a_of_type_Wck;
  public wcw a;
  public wde a;
  public wkp a;
  public wou a;
  ...
  static
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      jdField_b_of_type_ArrayOfInt = new int[] { 2131380161, 2131380160, 2131373759, 2131373783 };
      jdField_c_of_type_ArrayOfInt = new int[] { 2131380161, 2131380160, 2131373759, 2131373758 };
      return;
    }
  }
  
  public QQStoryMainController(wcw paramwcw, int[] paramArrayOfInt)
  {
    this.jdField_a_of_type_Wde = new wde();
    this.jdField_a_of_type_Best = new wcu(this);
    this.jdField_a_of_type_Wcw = paramwcw;
    this.jdField_a_of_type_ArrayOfInt = paramArrayOfInt;
    this.jdField_a_of_type_AndroidOsHandler = new wcv(this, null);
  }
  ...
  public static void a(Activity paramActivity, String paramString, ImageView paramImageView, TextView paramTextView)
  {
    ...
    for (;;)
    {
      ...
      Object localObject1 = new wco(paramString);
      wsv.d("Q.qqstory.home.QQStoryMainActivity", "initRightHallButton config = " + localObject1);
      if ((((wco)localObject1).jdField_a_of_type_Int != 0) && (((wco)localObject1).jdField_a_of_type_Int != 3))
      {
        Drawable localDrawable = paramActivity.getResources().getDrawable(2130846160);
        if ((!TextUtils.isEmpty(((wco)localObject1).jdField_a_of_type_JavaLangString)) && (ndd.a(((wco)localObject1).jdField_a_of_type_JavaLangString)))
        {
          Object localObject2 = URLDrawable.URLDrawableOptions.obtain();
          ((URLDrawable.URLDrawableOptions)localObject2).mRequestWidth = xee.b(paramActivity, 28.0F);
          ...
          localObject2 = URLDrawable.getDrawable(((wco)localObject1).jdField_a_of_type_JavaLangString, (URLDrawable.URLDrawableOptions)localObject2);
          ((URLDrawable)localObject2).setURLDrawableListener(new wcp(paramImageView, localDrawable));
          paramImageView.setVisibility(0);
          paramImageView.setContentDescription(alpo.a(2131711303));
          paramImageView.setImageDrawable((Drawable)localObject2);
          paramImageView.getLayoutParams().width = -2;
          paramImageView.setPadding(0, 0, xee.b(paramActivity, 5.0F), 0);
          localObject1 = new wcq((wco)localObject1, paramActivity, paramString);
          ...
          wta.a("story_grp", "exp_find_left", 0, 0, new String[] { "", "", "", "" });
        }
        for (;;)
        {
          ...
          wta.a("content_flow", "exp_entry", 0, 0, new String[0]);
          return;
          if (!TextUtils.isEmpty(((wco)localObject1).b))
          {
            paramTextView.setVisibility(0);
            paramTextView.setText(((wco)localObject1).b);
            break;
          }
          paramImageView.setVisibility(0);
          paramImageView.setContentDescription(alpo.a(2131711313));
          paramImageView.setImageDrawable(localDrawable);
          break;
          wta.a("home_page", "push_find", 0, 0, new String[0]);
        }
      }
    }
  }
  ...
  private void l()
  {
    ...
    Object localObject = (uhl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(181);
    ...
    wsv.b("Q.qqstory.home.position", "story main from lebaVersion " + (String)localObject + str);
    this.jdField_a_of_type_Wkp = ((wkp)urr.a(11));
    wkp localwkp = this.jdField_a_of_type_Wkp;
    boolean bool2 = "old".equals(localObject);
    if (!TextUtils.isEmpty(str)) {}
    for (boolean bool1 = true;; bool1 = false)
    {
      this.jdField_a_of_type_Boolean = localwkp.a(bool2, bool1);
      Bosses.get().postJob(new wcr(this, "QQStoryMainController"));
      this.jdField_a_of_type_Wkp = ((wkp)urr.a(11));
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeQqstorylistViewMystoryListView.getChildAt(0) != null) {
      localwkp.b = this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeQqstorylistViewMystoryListView.getChildAt(0).getTop();
    }
    localwkp.jdField_a_of_type_Int = this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeQqstorylistViewMystoryListView.getFirstVisiblePosition();
    wsv.a("Q.qqstory.home.position", "save position:%d, offset:%d", Integer.valueOf(localwkp.jdField_a_of_type_Int), Integer.valueOf(localwkp.b));
    if (this.jdField_a_of_type_Wou != null) {
      this.jdField_a_of_type_Wou.f();
    }
  }
  
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    wsv.b("QQStoryMainController", "onActivityResult %d %d", Integer.valueOf(paramInt1), Integer.valueOf(paramInt2));
    this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeQqstorylistViewMystoryListView.a(paramInt1, paramInt2, paramIntent);
    if (this.jdField_a_of_type_Wou != null) {
      this.jdField_a_of_type_Wou.a(paramInt1, paramInt2, paramIntent);
    }
    if (paramInt2 == -1) {
      switch (paramInt1)
      {
    ...
    while ((paramInt1 != 20000) || (paramIntent == null) || (!paramIntent.getBooleanExtra("back_when_cancel_from_shot", false)))
    {
      ...
      ukd.b("QQStoryMainController onActivityResult");
      return;
  ...
  public void a(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Wcw.a(paramBoolean);
  }
  
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    if ((paramBoolean1) && (this.jdField_a_of_type_Wou != null)) {
      this.jdField_a_of_type_Wou.a(NetConnInfoCenter.getServerTimeMillis());
    }
    this.jdField_a_of_type_Wde.b();
  }
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2, int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      wsv.c("QQStoryMainController", "launchNewVideoTakeActivity by StoryPublishLauncher");
      this.jdField_a_of_type_AndroidAppActivity.overridePendingTransition(2130772232, 2130772038);
      return;
  ...
  public boolean a(Bundle paramBundle)
  {
    ...
    {
      this.d = bool;
      this.jdField_a_of_type_Wck = new wck(this.jdField_a_of_type_AndroidAppActivity, this);
      if ((i == 0) || (this.d)) {
        break;
      }
      bool = this.jdField_a_of_type_Wck.a(i, this.jdField_a_of_type_AndroidAppActivity.getIntent());
      wsv.a("QQStoryMainController", "handleAction pass action=%d, hasJump=%b, result=%b", Integer.valueOf(i), Boolean.valueOf(this.d), Boolean.valueOf(bool));
      if (bool)
      {
        this.d = true;
        this.e = true;
    ...
    wsv.a("QQStoryMainController", "handleAction pass action=%d, hasJump=%b", Integer.valueOf(i), Boolean.valueOf(this.d));
    return false;
  }
  ...
  public boolean a(String paramString)
  {
    ...
    ((wps)this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeQqstorylistViewMystoryListView.a("FeedSegment")).c(paramString);
    return true;
  }
  
  public void b()
  {
    wsv.b("QQStoryMainController", "reInitData");
    if (this.jdField_a_of_type_Wou != null)
    {
      this.jdField_a_of_type_Wou.g();
      this.jdField_a_of_type_Wou = null;
    }
    this.jdField_a_of_type_Wou = ((wou)ume.a(wou.class, new Object[] { this.jdField_a_of_type_AndroidAppActivity }));
    this.jdField_a_of_type_Wou.a(this);
  ...
  public void b(Activity paramActivity)
  {
    ...
    if (this.e)
    {
      this.e = false;
      c(true);
      wsv.c("QQStoryMainController", "force request net");
    }
    ukd.b("QQStoryMainController onResume");
  }
  ...
  {
    this.jdField_a_of_type_Wcw.b(paramBoolean);
  }
  ...
  public void c(boolean paramBoolean)
  {
    if (!bdee.g(this.jdField_a_of_type_AndroidAppActivity)) {
      QQToast.a(BaseApplication.getContext(), 1, alpo.a(2131711300), 0).a();
    }
    do
    {
      return;
      if (this.jdField_a_of_type_Wou == null)
      {
        wsv.d("QQStoryMainController", "refreshIfNecessary, myStoryListPresenter = null!");
        return;
      }
    } while ((!(this.jdField_a_of_type_Wou.b() | paramBoolean | this.jdField_a_of_type_Wou.c())) || (!this.jdField_a_of_type_Wou.d()));
    wsv.a("QQStoryMainController", "refreshIfNecessary, forceUpdate: %b, redPoint: %b, overTime: %b", Boolean.valueOf(paramBoolean), Boolean.valueOf(this.jdField_a_of_type_Wou.b()), Boolean.valueOf(this.jdField_a_of_type_Wou.c()));
    f();
  }
  ...
  public void d(Activity paramActivity)
  {
    ...
    localusd.d();
    localuro.c();
    ((ujl)urr.a(6)).a(10000L);
    localwkp.jdField_a_of_type_JavaUtilMap.clear();
    QQLiveImage.releaseAll(paramActivity);
  }
  
  public void e()
  {
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_Wcw.a();
    this.jdField_a_of_type_Wcw.a(ugx.jdField_a_of_type_JavaLangString);
    this.jdField_a_of_type_AndroidViewView = this.jdField_b_of_type_AndroidViewView.findViewById(2131373778);
    this.jdField_a_of_type_Wye = new wye(new wcs(this), this.jdField_a_of_type_AndroidViewView);
    this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeQqstorylistViewMystoryListView = ((MystoryListView)this.jdField_b_of_type_AndroidViewView.findViewById(2131373815));
    ...
    ((ViewGroup)this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeQqstorylistViewMystoryListView.getParent()).setBackgroundColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131166959));
  ...
  public void g()
  {
    this.jdField_a_of_type_Wcw.c();
  }
  
  public void h()
  {
    this.jdField_a_of_type_Wcw.b();
  }
  
  public void i()
  {
    this.jdField_a_of_type_Wou.d();
  }
  ...
  public void j()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = QQStoryContext.a();
    c();
    if (this.jdField_a_of_type_Wde != null) {
      this.jdField_a_of_type_Wde.c();
    }
  }
}
