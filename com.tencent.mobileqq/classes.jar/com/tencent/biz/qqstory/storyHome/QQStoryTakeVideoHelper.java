...
public class QQStoryTakeVideoHelper
{
  ...
  public QQStoryTakeVideoHelper(@NonNull Activity paramActivity, @NonNull RMVideoStateMgr paramRMVideoStateMgr, @NonNull Intent paramIntent)
  {
    ...
    this.jdField_a_of_type_Boolean = paramIntent.getBooleanExtra("extra_now_tab", StoryApi.a(2131755009).booleanValue());
  ...
  private void a(PublishParam paramPublishParam, String paramString, int paramInt)
  {
    ...
    if (!this.jdField_b_of_type_Boolean)
    {
      ...
      if (StoryDepends.a())
      {
        StoryTransitionActivity.a(this.jdField_a_of_type_AndroidAppActivity, nrr.class.getName(), null);
  ...
  public String a(String paramString)
  {
    ...
    int i = ((Integer)((StoryConfigManager)localObject).b("StoryVideoWidth", Integer.valueOf(-1))).intValue();
    int j = ((Integer)((StoryConfigManager)localObject).b("StoryVideoHeight", Integer.valueOf(-1))).intValue();
    int k = ((Integer)((StoryConfigManager)localObject).b("StoryVideoMaxrate", Integer.valueOf(-1))).intValue();
    int m = ((Integer)((StoryConfigManager)localObject).b("StoryVideoMinrate", Integer.valueOf(-1))).intValue();
    String str = (String)((StoryConfigManager)localObject).b("StoryVideoKey", "960*720#600#1000;640*480#450#750");
    SLog.b("QQStoryTakeVideoHelper", "setupStoryVideoConfig : key = " + str + " width = " + i + " height = " + j + " maxrate = " + k + " minrate = " + m);
    ...
    SLog.d("QQStoryTakeVideoHelper", "setupStoryVideoConfig(): newConfig = " + paramString);
    return paramString;
  }
  
  public void a()
  {
    QQStoryNetReqUtils.a(new nsm(this, (StoryConfigManager)SuperManager.a(10)));
  }
  ...
  public void a(Intent paramIntent, @NonNull ImageView paramImageView)
  {
    ...
    try
    {
      ...
      if (!a())
      {
        ...
        a(new nsk(this, localPublishParam, str, i));
        return;
      }
  ...
  public void a(QQStoryTakeVideoHelper.GenerateManifestCallback paramGenerateManifestCallback)
  {
    ...
    Stream.of(this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaStateRMVideoStateMgr).map(new ThreadOffFunction(2)).map(new GenerateVideoManifestSegment()).subscribe(new nsl(this, paramGenerateManifestCallback));
  }
