  ...
  extends BaseAdapter
{
  ...
  private static void b(TextView paramTextView)
  {
    ...
    if ("2040".equals(str))
    {
      paramTextView.setBackgroundResource(2130843631);
      return;
    }
    if ("1103".equals(str))
    {
      paramTextView.setBackgroundResource(2130843632);
      return;
    }
    paramTextView.setBackgroundResource(2130843633);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (i == 1)
    {
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130970805, null);
      ((ImageView)paramView.findViewById(2131364786)).setOnClickListener(new oak(this));
      paramView.setTag(2131362456, Integer.valueOf(i));
      return paramView;
    }
    if (i == 2)
    {
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130970803, null);
      paramViewGroup = (TextView)paramView.findViewById(2131371473);
    ...
    if (i == 3)
    {
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130970801, null);
      paramViewGroup = (TextView)paramView.findViewById(2131367202);
      paramViewGroup.setText(this.jdField_a_of_type_JavaLangString);
      paramViewGroup.setOnClickListener(new oal(this));
      b(paramViewGroup);
      paramView.setTag(2131362456, Integer.valueOf(i));
      return paramView;
    }
    if (i == 4)
    {
      ...
      paramViewGroup.setOnClickListener(new oam(this));
      b(paramViewGroup);
      paramView.setTag(2131362456, Integer.valueOf(i));
      return paramView;
    }
    ...
    {
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130970801, null);
      paramViewGroup = new oan(paramView);
    ...
    for (TagItem.TagInfoBase localTagInfoBase = (TagItem.TagInfoBase)this.jdField_b_of_type_JavaUtilList.get(paramInt - 1);; localTagInfoBase = (TagItem.TagInfoBase)this.jdField_b_of_type_JavaUtilList.get(paramInt))
    {
      ...
      paramView.setTag(2131362456, Integer.valueOf(i));
      return paramView;
      paramViewGroup = (oan)paramView.getTag();
      break;
    }
  }
