  ...
  extends BaseAdapter
{
  ...
  private void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        j = i;
        if (localTextPaint.measureText(HardCodeUtil.a(2131714600) + (i2 - i) + HardCodeUtil.a(2131714603)) + UIUtils.a(this.jdField_a_of_type_AndroidContentContext, 18.0F) + f1 > i1) {
          j = i - 1;
        }
        i = j;
        j = m;
  ...
  private static void b(TextView paramTextView)
  {
    ...
    if ("2040".equals(str))
    {
      paramTextView.setBackgroundResource(2130847196);
      return;
    }
    if ("1103".equals(str))
    {
      paramTextView.setBackgroundResource(2130847197);
      return;
    }
    paramTextView.setBackgroundResource(2130847198);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (i == 1)
    {
      localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131561941, null);
      ((ImageView)localView.findViewById(2131371865)).setOnClickListener(new TagAdapter.1(this));
      localView.setTag(2131375097, Integer.valueOf(i));
    }
    Object localObject1;
    for (;;)
    {
      ...
      if (i == 2)
      {
        localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131561939, null);
        localObject1 = (TextView)localView.findViewById(2131368436);
        int j = this.jdField_a_of_type_JavaUtilList.size();
        int k = this.jdField_b_of_type_JavaUtilList.size();
        ((TextView)localObject1).setText(HardCodeUtil.a(2131714601) + (j - k) + HardCodeUtil.a(2131714602));
        localView.setTag(2131375097, Integer.valueOf(i));
      }
      else if (i == 3)
      {
        localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131561937, null);
        localObject1 = (TextView)localView.findViewById(2131378870);
        ((TextView)localObject1).setText(this.jdField_a_of_type_JavaLangString);
        ((TextView)localObject1).setOnClickListener(new TagAdapter.2(this));
      ...
      else
      {
        ...
        ((TextView)localObject1).setOnClickListener(new TagAdapter.3(this));
        b((TextView)localObject1);
        localView.setTag(2131375097, Integer.valueOf(i));
      }
    }
    ...
    {
      localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131561937, null);
      localObject1 = new TagAdapter.TagViewHolder(localView);
    ...
    label540:
    for (paramView = (TagItem.TagInfoBase)this.jdField_b_of_type_JavaUtilList.get(paramInt - 1);; paramView = (TagItem.TagInfoBase)this.jdField_b_of_type_JavaUtilList.get(paramInt))
    {
      ((TagAdapter.TagViewHolder)localObject1).a(paramView, this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeTagTagAdapter$OnItemClickListener);
      localView.setTag(2131375097, Integer.valueOf(i));
      paramView = localView;
      break;
