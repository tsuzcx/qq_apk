  ...
  extends QQStoryBaseActivity
{
  ...
  {
    this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeQQStoryMainController = new QQStoryMainController(new ubb(this), QQStoryMainController.c);
  ...
  private void a(Intent paramIntent, String paramString)
  {
    ...
    String str2 = this.app.getApplication().getString(2131653579);
    String str1 = str2;
    if (paramString != null) {
      str1 = str2 + paramString;
    }
    paramIntent = new ubc(this, paramIntent);
    this.jdField_a_of_type_Xez.a(str1, paramIntent);
    this.jdField_a_of_type_Xez.a(paramIntent);
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    urk.d("Q.qqstory.home.QQStoryMainActivity", "QQStoryMainActivity start");
    ...
    a();
    int i = ((Integer)((spz)sqg.a(10)).b("string_story_global_log_level", Integer.valueOf(-1))).intValue();
    urj.a().a(i);
    bheo.a(BaseApplicationImpl.getContext(), new QQStoryMainActivity.2(this), null);
    a(getIntent());
    return true;
  }
