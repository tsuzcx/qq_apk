  ...
  implements Handler.Callback, ILocalVideoPusher
{
  ...
  private ContentObserver jdField_a_of_type_AndroidDatabaseContentObserver = new nxt(this, new Handler());
  protected Handler a;
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      localAddressHelper.a(localLocalMediaInfo.latitude, localLocalMediaInfo.longitude, new nxu(this, paramMessage, localLocalMediaInfo));
      return true;
