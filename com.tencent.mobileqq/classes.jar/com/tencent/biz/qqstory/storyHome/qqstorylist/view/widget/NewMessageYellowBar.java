  ...
  extends FrameLayout
{
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      {
        setVisibility(0);
        post(new oad(this, paramInt1));
        return;
      }
      setVisibility(8);
      this.jdField_a_of_type_AndroidWidgetTextView.setText("没有更新");
  ...
  {
    LayoutInflater.from(getContext()).inflate(2130970861, this, true);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131372001));
    ...
    this.jdField_a_of_type_AndroidViewAnimationAnimationSet.setAnimationListener(new oac(this));
    setVisibility(8);
  }
}
