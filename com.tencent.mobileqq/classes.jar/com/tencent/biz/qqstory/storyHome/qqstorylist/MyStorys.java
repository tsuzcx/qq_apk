...
public class MyStorys
{
  ...
  static
  {
    jdField_a_of_type_ArrayOfJavaLangString = StoryApi.a(2131296352);
  }
  ...
  public String a(int paramInt, TextPaint paramTextPaint)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        localStringBuilder.append(StoryApi.a(2131432129, new Object[] { Integer.valueOf(this.g) }));
        return localStringBuilder.toString();
        if (this.jdField_a_of_type_Boolean)
        {
          localStringBuilder.append(UIUtils.a(j)).append("个小视频");
        ...
        if (this.jdField_a_of_type_JavaUtilArrayList.size() > 0)
        {
          ...
          {
            i = this.jdField_a_of_type_ComTencentBizQqstoryModelItemFeedFeatureItem.b;
            k = this.jdField_a_of_type_ComTencentBizQqstoryModelItemFeedFeatureItem.jdField_a_of_type_Int;
            l1 = this.jdField_a_of_type_ComTencentBizQqstoryModelItemFeedFeatureItem.c;
            j = m;
          }
        }
        localStringBuilder.append(UIUtils.a(j)).append("个小视频");
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        else
        {
          ...
          this.jdField_a_of_type_ComTencentBizQqstoryModelItemFeedFeatureItem.b = 0;
          this.jdField_a_of_type_ComTencentBizQqstoryModelItemFeedFeatureItem.jdField_a_of_type_Int = 0;
          this.jdField_a_of_type_ComTencentBizQqstoryModelItemFeedFeatureItem.c = 0;
