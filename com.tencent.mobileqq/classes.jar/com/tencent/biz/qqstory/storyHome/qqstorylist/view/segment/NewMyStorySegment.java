  ...
  implements Handler.Callback, IEventReceiver
{
  ...
  private boolean c;
  public final UncheckedCallable d = new ofv(this);
  
  public NewMyStorySegment(Activity paramActivity, IMyStoryListView paramIMyStoryListView)
  {
    super(paramActivity);
    this.jdField_a_of_type_ComTencentBizQqstoryUtilsUncheckedCallable = new ofp(this);
    this.jdField_b_of_type_ComTencentBizQqstoryUtilsUncheckedCallable = new oft(this);
    this.jdField_c_of_type_ComTencentBizQqstoryUtilsUncheckedCallable = new ofu(this);
    this.jdField_a_of_type_ComTencentBizQqstoryBaseQQStoryObserver = new ofx(this);
  ...
  private void a(int paramInt, BaseViewHolder paramBaseViewHolder, ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup = (ImageView)paramBaseViewHolder.a(2131372013);
    TextView localTextView = (TextView)paramBaseViewHolder.a(2131372017);
    ImageView localImageView1 = (ImageView)paramBaseViewHolder.a(2131372014);
    ImageView localImageView2 = (ImageView)paramBaseViewHolder.a(2131372018);
    View localView = paramBaseViewHolder.a(2131372015);
    ...
    {
      paramViewGroup.setImageResource(2130843811);
      localTextView.post(new ogd(this, localTextView, localView, localImageView2));
      ...
      localImageView2.setImageResource(2130843676);
      label170:
    ...
    for (;;)
    {
      ...
      paramBaseViewHolder.a().findViewById(2131372012).setOnClickListener(paramBaseViewHolder);
      if (paramBaseViewHolder.jdField_a_of_type_ComTencentBizQqstoryStoryHomeQqstorylistCommonChildViewClickListener == null) {
        paramBaseViewHolder.a(new oge(this));
      }
      return;
      ...
      break;
      label321:
      localImageView2.setImageResource(2130843675);
      break label170;
      label332:
      if (bool) {
        localImageView2.setImageResource(2130843674);
      }
      for (;;)
      {
        localImageView2.setContentDescription("更多");
        break;
        localImageView2.setImageResource(2130843673);
      }
      label367:
      if (this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeQqstorylistMyStorys.b() != 0)
      {
  ...
  private void b(int paramInt, StoryVideoItem paramStoryVideoItem, View paramView)
  {
    ...
    View localView = paramView.findViewById(2131372019);
    if (paramStoryVideoItem.mUnreadLikeCount > 0)
    {
  ...
  {
    int i = paramInt - 1;
    Object localObject1 = (StoryCoverView)paramBaseViewHolder.a(2131372019);
    ImageView localImageView1 = (ImageView)paramBaseViewHolder.a(2131372029);
    TextView localTextView1 = (TextView)paramBaseViewHolder.a(2131372026);
    TextView localTextView3 = (TextView)paramBaseViewHolder.a(2131372025);
    ImageView localImageView2 = (ImageView)paramBaseViewHolder.a(2131372021);
    TextView localTextView2 = (TextView)paramBaseViewHolder.a(2131372030);
    TextView localTextView4 = (TextView)paramBaseViewHolder.a(2131372027);
    ImageView localImageView3 = (ImageView)paramBaseViewHolder.a(2131372022);
    paramViewGroup = (Button)paramBaseViewHolder.a(2131372031);
    ImageView localImageView4 = (ImageView)paramBaseViewHolder.a(2131372020);
    ...
    paramViewGroup.setOnClickListener(paramBaseViewHolder);
    paramViewGroup = (ImageView)paramBaseViewHolder.a(2131372020);
    Object localObject2 = (ImageView)paramBaseViewHolder.a(2131372023);
    paramInt = -657931;
    QQStoryContext.a();
    ...
    case 9: 
      for (;;)
      {
        ...
        continue;
        localTextView4.setVisibility(0);
        localTextView4.setText(2131432130);
        localTextView1.setVisibility(8);
        localTextView3.setVisibility(8);
        localTextView2.setVisibility(8);
        localImageView3.setVisibility(0);
  ...
  {
    TextView localTextView1 = (TextView)paramBaseViewHolder.a(2131372026);
    TextView localTextView2 = (TextView)paramBaseViewHolder.a(2131372025);
    ImageView localImageView = (ImageView)paramBaseViewHolder.a(2131372021);
    TextView localTextView3 = (TextView)paramBaseViewHolder.a(2131372030);
    paramBaseViewHolder = (ImageView)paramBaseViewHolder.a(2131372022);
    switch (paramInt)
    {
    case 7: 
    case 8: 
  ...
  {
    paramViewGroup = paramBaseViewHolder.a(2131365559);
    View localView1 = paramBaseViewHolder.a(2131371784);
    View localView2 = paramBaseViewHolder.a(2131371786);
    ...
    paramViewGroup = paramBaseViewHolder.a(2131371787);
    localView1 = paramBaseViewHolder.a(2131371785);
    paramViewGroup.setOnClickListener(paramBaseViewHolder);
    localView1.setOnClickListener(paramBaseViewHolder);
    if (paramBaseViewHolder.jdField_a_of_type_ComTencentBizQqstoryStoryHomeQqstorylistCommonChildViewClickListener == null) {
      paramBaseViewHolder.a(new ofr(this));
    }
  }
  ...
  public BaseViewHolder a(int paramInt, ViewGroup paramViewGroup)
  {
    ...
    while (paramViewGroup != null)
    {
      ...
      paramViewGroup = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130970860, paramViewGroup, false);
      continue;
      paramViewGroup = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130970861, paramViewGroup, false);
      continue;
      paramViewGroup = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130970757, paramViewGroup, false);
    }
  ...
  protected void a(StoryVideoUploadManager.StoryVideoPublishStatusEvent paramStoryVideoPublishStatusEvent)
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeQqstorylistMyStorys.a(((StoryVideoItem)localObject1).mVid) == null)
    {
      ...
      if (paramStoryVideoPublishStatusEvent.errorInfo == null) {
        break label268;
      }
      ((StoryVideoItem)localObject1).mUpLoadFailedError = paramStoryVideoPublishStatusEvent.errorInfo.errorCode;
    }
    for (;;)
    {
      if (paramStoryVideoPublishStatusEvent.b != null)
      {
        ...
        if ((!TextUtils.isEmpty(paramStoryVideoPublishStatusEvent.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelGeneralFeedItem.feedId)) && (!TextUtils.equals(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeQqstorylistMyStorys.jdField_a_of_type_ComTencentBizQqstoryModelItemFeedFeatureItem.jdField_a_of_type_JavaLangString, paramStoryVideoPublishStatusEvent.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelGeneralFeedItem.feedId)))
        {
          ...
          localObject2 = new SimpleStep.GetResultSimpleStep(new ofs(this, (String)localObject2));
  ...
  public void a(BaseViewHolder paramBaseViewHolder, int paramInt)
  {
    ...
    Object localObject = (TextView)paramBaseViewHolder.a(2131372027);
  ...
  protected void a(Step[] paramArrayOfStep, SerialStepExecutor paramSerialStepExecutor)
  {
    ...
    paramSerialStepExecutor.a(new ogb(this)).a(new ofz(this));
  ...
  public void a_(BaseViewHolder paramBaseViewHolder)
  {
    ...
    ImageView localImageView1 = (ImageView)paramBaseViewHolder.a(2131372020);
    ImageView localImageView2 = (ImageView)paramBaseViewHolder.a(2131372021);
    ImageView localImageView3 = (ImageView)paramBaseViewHolder.a(2131372022);
  ...
  public void b_(BaseViewHolder paramBaseViewHolder)
  {
    ...
    ((ImageView)paramBaseViewHolder.a(2131372020)).setVisibility(0);
    if (this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeQqstorylistMyStorys.a().size() > paramBaseViewHolder.jdField_b_of_type_Int) {
