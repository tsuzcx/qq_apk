  ...
  implements QQLiveDrawable.OnStateListener
{
  ...
  public Drawable a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (paramString = new BitmapDrawable(paramString);; paramString = null)
    {
      ...
      if (paramString == null) {
        localObject = new anoz(-2631721, paramInt1, paramInt2);
      }
      return localObject;
    }
  }
  ...
  public QQLiveDrawable.QQLiveDrawableParams a(int paramInt1, int paramInt2, long paramLong, String paramString1, String paramString2, QQLiveDrawable.OnStateListener paramOnStateListener)
  {
    ...
    paramOnStateListener.mCoverLoadingDrawable = new anoz(-2631721, i, paramInt1);
  ...
  public void a()
  {
    ved.b("AutoPlayImageView", "pausePlay last mState=" + this.jdField_a_of_type_Int);
  ...
  {
    ved.a("AutoPlayImageView", "doPlay last mState=%s", Integer.valueOf(this.jdField_a_of_type_Int));
    this.jdField_a_of_type_Boolean = true;
    ...
    paramString1.setURLDrawableListener(new uyd(this));
  ...
  public void b()
  {
    ved.b("AutoPlayImageView", "resumePlay last mState=" + this.jdField_a_of_type_Int);
    if (this.jdField_a_of_type_Int == 3) {}
    do
    {
      return;
