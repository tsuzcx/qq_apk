  ...
  implements QQLiveDrawable.OnStateListener
{
  ...
  public Drawable a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (paramString = new BitmapDrawable(paramString);; paramString = null)
    {
      ...
      if (paramString == null) {
        localObject = new apgg(-2631721, paramInt1, paramInt2);
      }
      return localObject;
    }
  }
  ...
  public QQLiveDrawable.QQLiveDrawableParams a(int paramInt1, int paramInt2, long paramLong, String paramString1, String paramString2, QQLiveDrawable.OnStateListener paramOnStateListener)
  {
    ...
    paramOnStateListener.mCoverLoadingDrawable = new apgg(-2631721, i, paramInt1);
  ...
  public void a()
  {
    wsv.b("AutoPlayImageView", "pausePlay last mState=" + this.jdField_a_of_type_Int);
  ...
  {
    wsv.a("AutoPlayImageView", "doPlay last mState=%s", Integer.valueOf(this.jdField_a_of_type_Int));
    this.jdField_a_of_type_Boolean = true;
    ...
    paramString1.setURLDrawableListener(new wmv(this));
  ...
  public void b()
  {
    wsv.b("AutoPlayImageView", "resumePlay last mState=" + this.jdField_a_of_type_Int);
    if (this.jdField_a_of_type_Int == 3) {}
    do
    {
      return;
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidGraphicsPath.addRoundRect(localRectF, i, i, Path.Direction.CCW);
      if (QQStoryContext.a()) {
        this.jdField_a_of_type_AndroidGraphicsPaint.setColor(getContext().getResources().getColor(2131166401));
      }
