...
public class MemoriesVideoListSegment$5
  implements Runnable
{
  public MemoriesVideoListSegment$5(wjf paramwjf, MemoriesInnerListView paramMemoriesInnerListView, int paramInt, String paramString) {}
  ...
  public void run()
  {
    ...
    if (localView != null)
    {
      wsv.a("Q.qqstory.memories.MemoriesVideoListSegment", "doScrollHorizal broadcast close animation2 %s", this.jdField_a_of_type_JavaLangString);
