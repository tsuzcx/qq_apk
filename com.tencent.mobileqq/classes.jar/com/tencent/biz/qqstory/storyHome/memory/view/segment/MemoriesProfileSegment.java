  ...
  implements View.OnClickListener, MemoriesProfilePresenter.ProfilePresenterListener
{
  ...
  private void a(ViewGroup paramViewGroup, ProgressBar paramProgressBar, TextView paramTextView, ImageView paramImageView)
  {
    ...
    case 0: 
      ...
      {
        paramImageView.setImageResource(2130846964);
        return;
      }
      paramImageView.setVisibility(8);
      return;
    case 1: 
      paramImageView.setImageResource(2130846961);
      return;
    case 2: 
      paramImageView.setImageResource(2130846963);
      return;
    }
    paramImageView.setImageResource(2130846962);
  }
  ...
  private void i()
  {
    ...
    localIntent.putExtra("selfSet_leftViewText", HardCodeUtil.a(2131706537));
  ...
  private void j()
  {
    ...
    localIntent.putExtra("selfSet_leftViewText", HardCodeUtil.a(2131706535));
    localIntent.putExtra("isShowAd", false);
    this.jdField_a_of_type_AndroidContentContext.startActivity(localIntent);
  ...
  private void n()
  {
    ...
    if (this.jdField_a_of_type_AndroidViewView != null)
    {
      ...
      {
        k = this.jdField_a_of_type_AndroidViewView.getBottom() - (int)this.jdField_a_of_type_AndroidContentContext.getResources().getDimension(2131299166);
        if ((!ImmersiveTitleBar2.TRANSLUCENT_STATUS_BAR) || (ImmersiveUtils.isSupporImmersive() != 1)) {
          break label93;
        }
      }
    }
  ...
  public View a(int paramInt, BaseViewHolder paramBaseViewHolder, ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup = (ImageView)paramBaseViewHolder.a(2131368774);
    Object localObject1 = (ImageView)paramBaseViewHolder.a(2131368772);
    TextView localTextView3 = (TextView)paramBaseViewHolder.a(2131379200);
    StoryUserBadgeView localStoryUserBadgeView = (StoryUserBadgeView)paramBaseViewHolder.a(2131368842);
    TextView localTextView4 = (TextView)paramBaseViewHolder.a(2131379227);
    View localView2 = paramBaseViewHolder.a(2131370111);
    View localView3 = paramBaseViewHolder.a(2131370087);
    View localView4 = paramBaseViewHolder.a(2131370216);
    TextView localTextView5 = (TextView)paramBaseViewHolder.a(2131379154);
    TextView localTextView6 = (TextView)paramBaseViewHolder.a(2131379158);
    TextView localTextView7 = (TextView)paramBaseViewHolder.a(2131379251);
    Object localObject3 = (TextView)paramBaseViewHolder.a(2131378675);
    TextView localTextView8 = (TextView)paramBaseViewHolder.a(2131379144);
    TextView localTextView9 = (TextView)paramBaseViewHolder.a(2131379142);
    TextView localTextView10 = (TextView)paramBaseViewHolder.a(2131379143);
    View localView1 = paramBaseViewHolder.a(2131363579);
    ViewGroup localViewGroup = (ViewGroup)paramBaseViewHolder.a(2131368012);
    ProgressBar localProgressBar = (ProgressBar)paramBaseViewHolder.a(2131368013);
    TextView localTextView1 = (TextView)paramBaseViewHolder.a(2131368014);
    ImageView localImageView = (ImageView)paramBaseViewHolder.a(2131371104);
    Object localObject2 = (RedTouch)paramBaseViewHolder.a("redTouch");
    FrameLayout localFrameLayout = (FrameLayout)paramBaseViewHolder.a(2131370075);
    TextView localTextView2 = (TextView)paramBaseViewHolder.a(2131380529);
    View localView5 = paramBaseViewHolder.a(2131366601);
    View localView6 = paramBaseViewHolder.a(2131367279);
    if (QQStoryContext.a())
    {
      localTextView3.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166514));
      localTextView4.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166514));
      localTextView7.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166514));
      localTextView5.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166514));
      localTextView6.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166514));
      ((TextView)localObject3).setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166514));
      localTextView8.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166514));
      localTextView9.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166514));
      localTextView10.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166514));
      localFrameLayout.setBackgroundResource(2130846756);
      paramViewGroup.setColorFilter(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166515));
      localView5.setBackgroundColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166514));
      localView6.setBackgroundColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166514));
      ((TextView)localObject3).setBackgroundResource(2130846893);
    }
    if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeMemoryControllerMemoriesProfilePresenter.jdField_a_of_type_ComTencentBizQqstoryModelItemQQUserUIItem.backgroundUrl)) {
      UIUtils.a(paramViewGroup, this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeMemoryControllerMemoriesProfilePresenter.jdField_a_of_type_ComTencentBizQqstoryModelItemQQUserUIItem.backgroundUrl, 0, 0, null);
    }
    UIUtils.b((ImageView)localObject1, ThumbnailUrlHelper.b(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeMemoryControllerMemoriesProfilePresenter.jdField_a_of_type_ComTencentBizQqstoryModelItemQQUserUIItem.headUrl), 200, 200, ImageUtil.a(1), "QQStory200");
    ((ImageView)localObject1).setContentDescription(PlayModeUtils.a(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeMemoryControllerMemoriesProfilePresenter.jdField_a_of_type_ComTencentBizQqstoryModelItemQQUserUIItem));
    ...
    if (localStoryUserBadgeView.getVisibility() == 0)
    {
      ...
      paramInt = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298156);
    ...
    for (;;)
    {
      ...
      {
        ((TextView)localObject3).setText(HardCodeUtil.a(2131706539));
        break label954;
      }
      ((TextView)localObject3).setText(HardCodeUtil.a(2131706546));
      break label954;
      label1338:
      paramViewGroup = RedPointUtils.a(4, "+" + UIUtils.a(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeMemoryControllerMemoriesProfilePresenter.jdField_a_of_type_ComTencentBizQqstoryModelItemQQUserUIItem.fansCountExtra), 0);
  ...
  {
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131561853, paramViewGroup, false);
    paramViewGroup = new BaseViewHolder(this.jdField_a_of_type_AndroidViewView);
    View localView = paramViewGroup.a(2131376838);
  ...
  public void f()
  {
    ...
    int j = this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeMemoryControllerMemoriesProfilePresenter.jdField_a_of_type_ComTencentBizQqstoryModelItemQQUserUIItem.isSubscribe;
    Object localObject = (QQStoryHandler)PlayModeUtils.a().getBusinessHandler(BusinessHandlerFactory.QQSTORY_HANDLER);
    int i;
    if (this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeMemoryControllerMemoriesProfilePresenter.jdField_a_of_type_ComTencentBizQqstoryModelItemQQUserUIItem.isVip())
    {
      i = 1;
      ((QQStoryHandler)localObject).a(i, this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeMemoryControllerMemoriesProfilePresenter.jdField_a_of_type_ComTencentBizQqstoryModelItemQQUserUIItem.uid, j, 2);
