...
public class StoryQQ2UidConverter$1
  implements Runnable
{
  public StoryQQ2UidConverter$1(yam paramyam, long paramLong) {}
  
  public void run()
  {
    String str = this.this$0.a(this.a);
    ykq.a("Q.qqstory.memories.StoryQQ2UidConverter", "get uid by qq from cache. qq = %d, uid = %s.", Long.valueOf(this.a), str);
