  ...
  implements StoryQQ2UidConverter.StoryQQ2UidCallback, QQStoryPullToRefreshListView.PullToRefreshListener
{
  ...
  private void b()
  {
    setContentViewNoTitle(2130970781);
  }
  ...
  private void c(String paramString)
  {
    ...
    findViewById(2131362956).setVisibility(8);
    ...
    localFragmentTransaction.replace(2131362846, this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeMemoryStoryMemoriesFragment);
    localFragmentTransaction.commitAllowingStateLoss();
  }
  
  private void d()
  {
    View localView1 = findViewById(2131362956);
    View localView2 = findViewById(2131371859);
    localView1.setVisibility(8);
    if (localView2 != null)
    {
      SLog.b("Q.qqstory.memories.QQStoryMemoriesActivity", "get invalid uid. inflate reload list.");
      ((ViewStub)localView2).inflate();
      this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeMemoryViewStoryMemoriesReloadListView = ((StoryMemoriesReloadListView)findViewById(2131371898));
