  ...
  implements CmdTaskManger.CommandCallback
{
  ...
  private void d()
  {
    ...
    localGetShareGroupListRequest.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
    localGetShareGroupListRequest.jdField_a_of_type_JavaLangString = this.jdField_b_of_type_JavaLangString;
    localGetShareGroupListRequest.jdField_a_of_type_Long = 0L;
  ...
  public void a(@NonNull GetShareGroupListRequest paramGetShareGroupListRequest, @Nullable GetShareGroupListResponse paramGetShareGroupListResponse, @NonNull ErrorMessage paramErrorMessage)
  {
    ...
    ShareGroupPageLoader.GetShareGroupListEvent localGetShareGroupListEvent = new ShareGroupPageLoader.GetShareGroupListEvent(paramErrorMessage, this.jdField_c_of_type_JavaLangString);
    ...
    {
      Dispatchers.get().dispatch(localGetShareGroupListEvent);
      return;
    }
    this.jdField_b_of_type_JavaLangString = paramGetShareGroupListResponse.jdField_a_of_type_JavaLangString;
