...
public class MemoriesVideoListSegment$4
  implements Runnable
{
  public MemoriesVideoListSegment$4(yba paramyba, MemoriesInnerListView paramMemoriesInnerListView, int paramInt, String paramString) {}
  ...
  public void run()
  {
    ...
    if (localView != null)
    {
      ykq.a("Q.qqstory.memories.MemoriesVideoListSegment", "doScrollHorizal broadcast close animation %s", this.jdField_a_of_type_JavaLangString);
