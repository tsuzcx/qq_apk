...
class MemoriesVideoListSegment$4
  implements Runnable
{
  MemoriesVideoListSegment$4(MemoriesVideoListSegment paramMemoriesVideoListSegment, MemoriesInnerListView paramMemoriesInnerListView, int paramInt, String paramString) {}
  ...
  public void run()
  {
    ...
    if (localView != null)
    {
      SLog.a("Q.qqstory.memories.MemoriesVideoListSegment", "doScrollHorizal broadcast close animation %s", this.jdField_a_of_type_JavaLangString);
