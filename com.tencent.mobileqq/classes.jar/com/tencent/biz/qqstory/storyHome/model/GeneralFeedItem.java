...
public class GeneralFeedItem
  extends VideoListFeedItem<ycs, QQUserUIItem>
{
  ...
  public static GeneralFeedItem createFakeFeedItem(String paramString)
  {
    ...
    localGeneralFeedItem.mUserUIItem = ((wke)wjs.a(2)).a();
    if (localGeneralFeedItem.mUserUIItem == null)
    {
      ...
      localGeneralFeedItem.mUserUIItem.qq = wzk.a().getCurrentAccountUin();
      localGeneralFeedItem.mUserUIItem.nickName = wzk.a().getCurrentNickname();
      localGeneralFeedItem.mUserUIItem.headUrl = "";
      ykq.e("VideoListFeedItem", "create fake feed item while QQUserUIItem is null! use fake QQUserUIItem to instead.", new Object[] { localGeneralFeedItem.mUserUIItem.toString() });
    }
  ...
  protected void onCovertFromEntry()
  {
    ...
    this.mUserUIItem = ((wke)wjs.a(2)).b(this.ownerId);
    if (this.mUserUIItem == null)
    {
      this.mUserUIItem = new QQUserUIItem();
      this.mUserUIItem.uid = QQStoryContext.a().b();
      this.mUserUIItem.qq = wzk.a().getCurrentAccountUin();
      this.mUserUIItem.nickName = wzk.a().getCurrentNickname();
      this.mUserUIItem.headUrl = "";
      ykq.e("VideoListFeedItem", "create fake feed item while QQUserUIItem is null! use fake QQUserUIItem to instead.", new Object[] { this.mUserUIItem.toString() });
    }
  }
