  ...
  extends RecyclerView.Adapter
{
  ...
  StoryDiscoverAdapter(RecyclerView paramRecyclerView, int paramInt1, int paramInt2)
  {
    ...
    this.g = paramInt1;
    this.h = paramInt2;
    this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeDiscoverViewStoryDiscoverAdapter$OnHolderItemClickListener = new nux(this);
    ...
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.getResources().getDrawable(2130843327);
    ...
    this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.getResources().getDrawable(2130843326);
    ...
    this.jdField_d_of_type_AndroidGraphicsDrawableDrawable = this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.getResources().getDrawable(2130843664);
    ...
    this.jdField_c_of_type_AndroidGraphicsDrawableDrawable = this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.getResources().getDrawable(2130843328);
  ...
  private void a(StoryDiscoverAdapter.StoryDiscoverViewHolder paramStoryDiscoverViewHolder, CardItem.ActivityCardInfo paramActivityCardInfo)
  {
    ...
    a(paramStoryDiscoverViewHolder.jdField_a_of_type_AndroidWidgetTextView, 0, 2130843329, "热门话题");
  ...
  private void a(StoryDiscoverAdapter.StoryDiscoverViewHolder paramStoryDiscoverViewHolder, CardItem.OperationCardInfo paramOperationCardInfo)
  {
    ...
    paramStoryDiscoverViewHolder.jdField_a_of_type_AndroidWidgetImageView.getLayoutParams().height = this.jdField_c_of_type_Int;
    a(paramStoryDiscoverViewHolder.jdField_a_of_type_AndroidWidgetTextView, 0, 2130843325, paramOperationCardInfo.a());
    String str;
    label82:
    long l;
  ...
  public void a(String paramString1, int paramInt, String paramString2, String paramString3)
  {
    ...
    ImageView localImageView = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131371637);
    TextView localTextView1 = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131371639);
    TextView localTextView2 = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131371640);
    TextView localTextView3 = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131371641);
    localTextView1.setText(paramString1);
    localTextView2.setText(String.format("%d次参与", new Object[] { Integer.valueOf(paramInt) }));
    localTextView3.setText(paramString2);
    UIUtils.a(localImageView, paramString3, UIUtils.jdField_c_of_type_Int, UIUtils.a(this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.getContext(), 180.0F), 0, this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.getResources().getDrawable(2131493760), "QQStoryDiscoverHeader");
  }
