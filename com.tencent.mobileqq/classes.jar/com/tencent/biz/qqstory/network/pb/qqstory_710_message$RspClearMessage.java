  ...
  extends MessageMicro<RspClearMessage>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 32, 42, 50 }, new String[] { "errinfo", "remain_num", "image_uid", "last_time", "msg_tab", "msg_dynamic" }, new Object[] { null, localInteger, Long.valueOf(0L), localInteger, null, null }, RspClearMessage.class);
  }
}
