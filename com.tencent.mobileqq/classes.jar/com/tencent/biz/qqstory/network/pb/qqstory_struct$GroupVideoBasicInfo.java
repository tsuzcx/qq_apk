  ...
  extends MessageMicro<GroupVideoBasicInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34, 40, 48, 56, 66 }, new String[] { "author", "msg_time", "file_id", "video_vid", "group_gid", "story_source", "duration", "video_attr" }, new Object[] { localLong, localInteger, "", "", localLong, localInteger, localInteger, "" }, GroupVideoBasicInfo.class);
  }
}
