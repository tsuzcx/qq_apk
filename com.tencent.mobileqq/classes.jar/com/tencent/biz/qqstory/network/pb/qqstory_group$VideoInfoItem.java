  ...
  extends MessageMicro<VideoInfoItem>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 32, 42, 48, 56, 66, 74, 80, 90, 98, 104, 114, 120, 128 }, new String[] { "error", "story_id", "vid", "uin", "union_id", "publish_time", "duration", "cover_url", "download_url", "url_flag", "video_attr", "address", "group_id", "doodle_url", "del_flag", "video_source" }, new Object[] { localInteger, localByteStringMicro1, localByteStringMicro2, Long.valueOf(0L), localByteStringMicro3, localInteger, localInteger, localByteStringMicro4, localByteStringMicro5, localInteger, localByteStringMicro6, null, Long.valueOf(0L), localByteStringMicro7, localInteger, localInteger }, VideoInfoItem.class);
  }
}
