  ...
  extends MessageMicro<FeedLike>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 34, 40, 48, 58 }, new String[] { "from_uid_num", "from_uid_list", "to_uid", "feed_id", "video_isend", "video_next", "video_list" }, new Object[] { localInteger, null, null, localByteStringMicro, localInteger, localInteger, null }, FeedLike.class);
  }
}
