  ...
  extends MessageMicro
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 34, 40, 48 }, new String[] { "result", "feed_seq_info_list", "is_end", "next_cookie", "is_today_end", "is_playable" }, new Object[] { null, null, Integer.valueOf(0), localByteStringMicro, Integer.valueOf(0), Integer.valueOf(0) }, RspStoryFeedIdList.class);
  }
}
