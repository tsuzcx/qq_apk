  ...
  extends MessageMicro<RspGetPublicCommentList>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 32 }, new String[] { "result", "comment_list", "is_end", "total_comment_num" }, new Object[] { null, null, localInteger, localInteger }, RspGetPublicCommentList.class);
  }
}
