  ...
  extends MessageMicro<ReqGetWeather>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "longitude", "latitude", "coordinate" }, new Object[] { localInteger, localInteger, localInteger }, ReqGetWeather.class);
  }
}
