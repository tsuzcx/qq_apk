  ...
  extends MessageMicro<VideoItem>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 26, 32, 40, 48, 56 }, new String[] { "vid", "to_union_id", "is_live_video", "source", "create_time", "vid_type" }, new Object[] { localByteStringMicro1, localByteStringMicro2, localInteger, localInteger, Long.valueOf(0L), localInteger }, VideoItem.class);
  }
}
