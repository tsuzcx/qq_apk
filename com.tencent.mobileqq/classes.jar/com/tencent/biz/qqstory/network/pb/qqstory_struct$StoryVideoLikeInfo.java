  ...
  extends MessageMicro<StoryVideoLikeInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34 }, new String[] { "uid", "like_time", "role", "union_id" }, new Object[] { localLong, localLong, Integer.valueOf(0), "" }, StoryVideoLikeInfo.class);
  }
}
