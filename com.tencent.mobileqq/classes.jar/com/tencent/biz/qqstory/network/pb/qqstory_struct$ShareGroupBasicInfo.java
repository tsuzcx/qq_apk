  ...
  extends MessageMicro<ShareGroupBasicInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 34, 40, 50, 56, 64, 72 }, new String[] { "shared_group_id", "name", "owner", "header_unionid_list", "allow_stranger_visit_and_post", "background_url", "type", "group_code", "has_disband" }, new Object[] { "", "", "", "", localInteger, "", localInteger, Long.valueOf(0L), localInteger }, ShareGroupBasicInfo.class);
  }
}
