  ...
  extends MessageMicro<StoryAnswerInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 40, 50, 58, 64, 72, 82, 88 }, new String[] { "answer_uid", "answer_time", "is_bigv", "union_id", "answer_type", "answer_question", "answer_text", "video_del", "is_my_answer", "nick_postfix", "at_video_ts" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, localByteStringMicro1, localInteger, localByteStringMicro2, localByteStringMicro3, localInteger, localInteger, localByteStringMicro4, localInteger }, StoryAnswerInfo.class);
  }
}
