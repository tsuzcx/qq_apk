  ...
  extends MessageMicro
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 40, 50, 58, 64, 72, 82 }, new String[] { "answer_uid", "answer_time", "is_bigv", "union_id", "answer_type", "answer_question", "answer_text", "video_del", "is_my_answer", "nick_postfix" }, new Object[] { Long.valueOf(0L), Integer.valueOf(0), Integer.valueOf(0), localByteStringMicro1, Integer.valueOf(0), localByteStringMicro2, localByteStringMicro3, Integer.valueOf(0), Integer.valueOf(0), localByteStringMicro4 }, StoryAnswerInfo.class);
  }
}
