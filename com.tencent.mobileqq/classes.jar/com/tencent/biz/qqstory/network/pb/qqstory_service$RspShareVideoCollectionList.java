  ...
  extends MessageMicro<RspShareVideoCollectionList>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 34, 40, 48 }, new String[] { "result", "collection_list", "is_end", "next_cookie", "total_share_group_count", "seqno" }, new Object[] { null, null, localInteger, localByteStringMicro, localInteger, Long.valueOf(0L) }, RspShareVideoCollectionList.class);
  }
}
