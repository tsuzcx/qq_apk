  ...
  extends MessageMicro<RspDateVideoCollectionList>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 34, 40, 48, 56 }, new String[] { "result", "collection_list", "is_end", "next_cookie", "total_video_count", "seqno", "is_friend" }, new Object[] { null, null, localInteger, localByteStringMicro, localInteger, Long.valueOf(0L), localInteger }, RspDateVideoCollectionList.class);
  }
}
