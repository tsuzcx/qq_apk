  ...
  extends MessageMicro<RspStoryMessageList>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 32, 40 }, new String[] { "errinfo", "message_list", "message_num", "is_end", "has_read_msg" }, new Object[] { null, null, localInteger, localInteger, localInteger }, RspStoryMessageList.class);
  }
}
