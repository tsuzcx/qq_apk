  ...
  extends MessageMicro<ReqBatchFeedLike>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24 }, new String[] { "feed_id_list", "source", "type" }, new Object[] { localByteStringMicro, localInteger, localInteger }, ReqBatchFeedLike.class);
  }
}
