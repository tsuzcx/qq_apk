  ...
  extends MessageMicro<RspGetOfficialRecommends>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 32, 42 }, new String[] { "result", "recom_item_list", "recom_count", "is_end", "next_cookie" }, new Object[] { null, null, localInteger, localInteger, localByteStringMicro }, RspGetOfficialRecommends.class);
  }
}
