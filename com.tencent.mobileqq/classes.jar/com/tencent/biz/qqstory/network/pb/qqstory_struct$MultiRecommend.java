  ...
  extends MessageMicro<MultiRecommend>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 34, 40, 48, 56, 66, 74 }, new String[] { "recommend_feed", "recommend_id", "top_location", "next_cookie", "is_end", "seq", "date", "user", "rcmd_word" }, new Object[] { null, Long.valueOf(0L), localInteger, localByteStringMicro1, localInteger, localInteger, localInteger, null, localByteStringMicro2 }, MultiRecommend.class);
  }
}
