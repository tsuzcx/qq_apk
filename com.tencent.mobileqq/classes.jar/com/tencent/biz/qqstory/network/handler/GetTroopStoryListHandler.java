  ...
  implements CmdTaskManger.CommandCallback
{
  ...
  private void a(long paramLong, int paramInt1, int paramInt2)
  {
    ...
    localGetTroopStoryListRequest.a = paramLong;
  ...
  public void a(@NonNull GetTroopStoryListRequest paramGetTroopStoryListRequest, @Nullable GetTroopStoryListResponse paramGetTroopStoryListResponse, @NonNull ErrorMessage paramErrorMessage)
  {
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      Dispatchers.get().dispatch(localGetTroopStoryListEvent);
      return;
    }
    ...
    if (paramGetTroopStoryListResponse.c != paramGetTroopStoryListRequest.f)
    {
      ...
      this.jdField_a_of_type_ComTencentBizQqstoryModelStoryConfigManager.b("TROOP_STORY_COOKIE" + String.valueOf(paramGetTroopStoryListRequest.a), Integer.valueOf(paramGetTroopStoryListResponse.b));
      this.jdField_a_of_type_ComTencentBizQqstoryModelStoryConfigManager.b("TROOP_STORY_PAGE_IS_END" + String.valueOf(paramGetTroopStoryListRequest.a), Boolean.valueOf(paramGetTroopStoryListResponse.jdField_a_of_type_Boolean));
      if (localGetTroopStoryListEvent.e) {
        this.jdField_a_of_type_ComTencentBizQqstoryModelStoryConfigManager.b("TROOP_STORY_SEQ710" + String.valueOf(paramGetTroopStoryListRequest.a), Integer.valueOf(paramGetTroopStoryListResponse.c));
      }
    }
    for (;;)
    {
