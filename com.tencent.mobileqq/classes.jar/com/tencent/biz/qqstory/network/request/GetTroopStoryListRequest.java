  ...
  extends NetworkRequest
{
  ...
  protected byte[] a()
  {
    ...
    localReqGetGroupVideoList.group_id.set(this.a);
  ...
  {
    return "GetTroopStoryListRequest{groupId='" + this.a + "startCookie='" + this.c + " pageSize='" + this.d + " seq='" + this.f + " timeZone=" + this.e + '\'' + '}';
  }
}
