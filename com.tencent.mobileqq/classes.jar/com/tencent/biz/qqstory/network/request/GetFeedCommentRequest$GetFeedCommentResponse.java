  ...
  extends BasePageResponse
{
  ...
  public GetFeedCommentRequest$GetFeedCommentResponse(qqstory_service.RspFeedCommentList paramRspFeedCommentList)
  {
    ...
    this.g = paramRspFeedCommentList.feed_comment_info.feed_id.get().toStringUtf8();
    this.f = paramRspFeedCommentList.feed_comment_info.comment_total_num.get();
    ...
    while (paramRspFeedCommentList.hasNext())
    {
      ...
      localCommentEntry.feedId = this.g;
      this.e.add(localCommentEntry);
    }
  }
}
