  ...
  extends NetworkRequest
{
  ...
  protected byte[] a()
  {
    ...
    localReqPublishVideo.source.set(this.jdField_f_of_type_Int);
    Object localObject1 = localReqPublishVideo.sync_to_qzone;
    int i1;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_e_of_type_Int == 0)
        {
          ...
          if (this.jdField_h_of_type_Int != 0) {
            ((JSONObject)localObject1).put("lon", this.jdField_h_of_type_Int);
          }
          if (this.jdField_g_of_type_Int != 0) {
            ((JSONObject)localObject1).put("lat", this.jdField_g_of_type_Int);
          }
          if (this.q != null)
          {
      ...
      catch (Exception localException)
      {
        try
        {
          for (;;)
          {
            localObject1 = new JSONArray(this.n);
        ...
        catch (JSONException localInvalidProtocolBufferMicroException2)
        {
          ...
          catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException2)
          {
            try
            {
              ...
              localReqPublishVideo.group_source.set(this.jdField_i_of_type_Int);
        ...
        if (TextUtils.isEmpty(this.jdField_i_of_type_JavaLangString))
        {
          ...
          if (!TextUtils.isEmpty(this.j)) {
            localReqPublishVideo.video_cover.set(ByteStringMicro.copyFromUtf8(this.j));
          }
  ...
  {
    return "PublishStoryVideoRequest{title='" + this.jdField_c_of_type_JavaLangString + '\'' + ", vid='" + this.jdField_d_of_type_JavaLangString + '\'' + ", videoThumbnailUrl='" + this.j + '\'' + ", mOriginalMaskPicUrl='" + this.k + '\'' + '}';
  }
}
