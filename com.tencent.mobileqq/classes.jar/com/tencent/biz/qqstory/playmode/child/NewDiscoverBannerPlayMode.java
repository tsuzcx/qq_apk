  ...
  implements MultiGroupVideoDataProvider.DataObserver
{
  ...
  public void a(Bundle paramBundle)
  {
    ...
    if (!TextUtils.isEmpty(paramBundle))
    {
      ...
      ThreadManager.post(new nol(this), 8, null, true);
    }
  }
  ...
  public void a(VideoData paramVideoData)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        this.jdField_a_of_type_ComTencentBizQqstoryVideoplayerStoryVideoPlayer.jdField_a_of_type_ComTencentBizQqstoryPlayvideoQQStoryVideoPlayerErrorView.setOnTipsClickListener(new nom(this));
        return;
        if (QLog.isColorLevel()) {
    ...
    for (int i = this.jdField_a_of_type_ComTencentBizQqstoryPlaymodeUtilNewDiscoverBannerDataProvider.jdField_a_of_type_Int;; i = 1)
    {
      ...
      this.jdField_a_of_type_AndroidOsHandler.post(new noo(this));
      return;
  ...
  public void a(VideoPlayerPagerAdapter.VideoViewHolder paramVideoViewHolder, StoryVideoItem paramStoryVideoItem)
  {
    ...
    paramStoryVideoItem = (ImageView)paramVideoViewHolder.a.get(2131372148);
    paramVideoViewHolder = (TextView)paramVideoViewHolder.a.get(2131372147);
  ...
  protected boolean a(View paramView, String paramString, StoryVideoItem paramStoryVideoItem)
  {
    ...
    if ((localQQUserUIItem != null) && (localQQUserUIItem.isVip))
    {
      ...
      a().a(2131433114).a(new nop(this, this, localVideoListFeedItem, paramView, paramStoryVideoItem)).a(new MyContentStoryShareMode(paramStoryVideoItem, false, paramView)).a();
      if (!bool) {
        break label351;
      }
      i = 1;
    ...
    for (paramView = "";; paramView = localVideoListFeedItem.feedId)
    {
      ...
      if (bool)
      {
        ...
        label242:
        a().a(2131433114).a(new noq(this, this, bool, localVideoListFeedItem, paramView, paramStoryVideoItem)).a(paramString).a();
        if (!bool) {
          break label345;
        }
      }
    ...
    if (paramString.equals(paramView.getString(2131435132)))
    {
      ...
      PlayModeUtils.a(this.jdField_a_of_type_ComTencentBizQqstoryVideoplayerStoryVideoPlayer.jdField_a_of_type_AndroidAppActivity, paramStoryVideoItem, new nor(this));
      if (bool)
      {
        i = 1;
