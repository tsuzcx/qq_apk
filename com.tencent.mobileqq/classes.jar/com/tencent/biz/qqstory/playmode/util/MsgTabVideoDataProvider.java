...
public class MsgTabVideoDataProvider
{
  ...
  private void a(MsgTabNodeInfo paramMsgTabNodeInfo1, MsgTabNodeInfo paramMsgTabNodeInfo2, int paramInt1, List paramList, boolean paramBoolean1, int paramInt2, boolean paramBoolean2, long paramLong)
  {
    ...
    for (int j = 1;; j = 2)
    {
      ...
      ThreadManager.getUIHandler().post(new nlf(this, paramMsgTabNodeInfo2, paramMsgTabNodeInfo1, paramInt1, paramBoolean1, paramList, paramInt2, paramBoolean2));
      return;
      i = 2;
      break;
    }
  ...
  public void a(MsgTabNodeInfo paramMsgTabNodeInfo1, MsgTabNodeInfo paramMsgTabNodeInfo2, int paramInt)
  {
    ...
    Stream.of(paramMsgTabNodeInfo1).map(new ThreadOffFunction(2)).map(new MsgTabNodeVidListPullSegment(false)).map(new MsgTabNodePullVideoBasicInfoSegment()).map(new MsgTabNodeInsertLocalVideoInfoSegment(paramMsgTabNodeInfo1)).subscribe(new nle(this, paramMsgTabNodeInfo1, paramMsgTabNodeInfo2, paramInt, l));
  }
