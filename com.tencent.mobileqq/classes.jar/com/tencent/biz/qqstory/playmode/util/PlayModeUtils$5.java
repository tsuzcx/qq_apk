  ...
  implements Runnable
{
  ...
  public void run()
  {
    String str2 = wkp.a(this.jdField_a_of_type_ComTencentBizQqstoryModelItemStoryVideoItem.mVid, true);
    File localFile = new File(str2);
    Object localObject1 = UIUtils.getLocalVideoThumbnail(this.jdField_a_of_type_ComTencentBizQqstoryModelItemStoryVideoItem.mLocalVideoPath, wkp.a().getResources().getDisplayMetrics().widthPixels, wkp.a().getResources().getDisplayMetrics().heightPixels);
    if ((!ypi.c(this.jdField_a_of_type_ComTencentBizQqstoryModelItemStoryVideoItem.mLocalVideoPath)) || (localObject1 == null))
    {
      ...
      localObject1 = new wky(this.jdField_a_of_type_JavaLangString, 3, this.jdField_a_of_type_ComTencentBizQqstoryModelItemStoryVideoItem);
      vli.a().dispatch((Dispatcher.Dispatchable)localObject1);
      return;
    }
    Object localObject2 = FFmpegUtils.getVideoDownloadWatermarkPath(wkp.a(), this.jdField_a_of_type_ComTencentBizQqstoryModelItemStoryVideoItem.mVid, this.jdField_a_of_type_ComTencentBizQqstoryModelItemStoryVideoItem.mVideoWidth, this.jdField_a_of_type_ComTencentBizQqstoryModelItemStoryVideoItem.mVideoHeight, this.jdField_a_of_type_Int);
    ...
    for (;;)
    {
      ...
      label433:
      localObject1 = UIUtils.getLocalVideoThumbnail(this.jdField_a_of_type_ComTencentBizQqstoryModelItemStoryVideoItem.mLocalVideoPath, wkp.a().getResources().getDisplayMetrics().widthPixels, wkp.a().getResources().getDisplayMetrics().heightPixels);
    ...
    if (!TextUtils.isEmpty((CharSequence)localObject3))
    {
      ...
      localObject2 = yoy.c((Bitmap)localObject1, (Bitmap)localObject3);
    ...
    for (;;)
    {
      try
      {
        bfvo.a((Bitmap)localObject1, new File(str2));
        ((Bitmap)localObject1).recycle();
        ypi.b(wkp.a(), localFile);
        localObject1 = new wky(this.jdField_a_of_type_JavaLangString, 2, this.jdField_a_of_type_ComTencentBizQqstoryModelItemStoryVideoItem);
        ((wky)localObject1).b = str2;
        vli.a().dispatch((Dispatcher.Dispatchable)localObject1);
        return;
      }
      catch (IOException localIOException)
      {
        localObject2 = new wky(this.jdField_a_of_type_JavaLangString, 3, this.jdField_a_of_type_ComTencentBizQqstoryModelItemStoryVideoItem);
