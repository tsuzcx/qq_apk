  ...
  implements View.OnClickListener
{
  ...
  public QQStoryDiscoverSearchDialog(AppInterface paramAppInterface, Activity paramActivity, boolean paramBoolean, DialogInterface.OnCancelListener paramOnCancelListener, String paramString)
  {
    ...
    super.setContentView(2130970814);
  ...
  private void b()
  {
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131371940));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131371941));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131371942));
    this.jdField_b_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)findViewById(2131368325));
    this.jdField_a_of_type_AndroidWidgetImageButton.setOnClickListener(this);
    this.jdField_a_of_type_AndroidViewView = findViewById(2131369826);
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new nmi(this));
    ...
    this.jdField_a_of_type_ComTencentBizQqstoryViewWidgetQQStoryPullToRefreshListView = ((QQStoryPullToRefreshListView)findViewById(2131365674));
    ...
    this.jdField_a_of_type_ComTencentBizQqstoryViewWidgetQQStoryPullToRefreshListView.setOnItemClickListener(new nmj(this));
    this.jdField_a_of_type_ComTencentBizQqstoryViewWidgetQQStoryPullToRefreshListView.setOnTouchListener(new nmk(this));
    this.jdField_a_of_type_ComTencentBizQqstoryViewWidgetQQStoryPullToRefreshListView.setPullToRefreshListener(new nml(this));
    this.jdField_a_of_type_ComTencentBizQqstoryViewWidgetQQStoryPullToRefreshListView.a.a(new nmm(this));
  ...
  public void a(AppInterface paramAppInterface, Context paramContext, String paramString, List paramList, boolean paramBoolean)
  {
    ...
    paramContext.setObserver(new nmo(this));
  ...
  public void a(boolean paramBoolean1, int paramInt, List paramList1, boolean paramBoolean2, String paramString, List paramList2)
  {
    ...
    for (paramBoolean2 = bool;; paramBoolean2 = false)
    {
      ...
      if (this.jdField_a_of_type_Int == 0)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetTextView.setCompoundDrawablesWithIntrinsicBounds(null, this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130841359), null, null);
      ...
      if (this.jdField_a_of_type_Int == 0)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetTextView.setCompoundDrawablesWithIntrinsicBounds(null, this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130838598), null, null);
        this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new nmn(this));
  ...
  public boolean a(String paramString)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Int == 0)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetTextView.setCompoundDrawablesWithIntrinsicBounds(null, this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130843538), null, null);
        this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(null);
        this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
        return false;
      }
