  ...
  implements IManager, ITrimmable
{
  ...
  private Bitmap a()
  {
    this.b.compareAndSet(null, Bitmap.createBitmap(ImageUtil.f()));
  ...
  public Drawable a(List<String> paramList, String paramString)
  {
    ...
    synchronized (this.jdField_a_of_type_AndroidUtilLruCache)
    {
      ...
      if (localShareGroupDrawableState == null)
      {
        ...
        paramList.a(new ShareGroupIconManager.4(this, localList, String.valueOf(System.identityHashCode(paramList)) + "." + paramString));
