  ...
  implements View.OnClickListener
{
  ...
  public ShareGroupsListAdapter$DayCollectionViewHolder(View paramView, ShareGroupsListAdapter paramShareGroupsListAdapter)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131366702));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131371863));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131371864));
    this.c = ((TextView)paramView.findViewById(2131371867));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131371868));
    this.jdField_a_of_type_ComTencentBizQqstoryShareGroupInfocardViewShareGroupInnerListView = ((ShareGroupInnerListView)paramView.findViewById(2131371870));
    ...
    this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131371861);
    this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131371862);
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131371865));
    this.d = ((TextView)paramView.findViewById(2131371869));
    a();
  }
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130843594);
    ...
    this.jdField_b_of_type_AndroidWidgetImageView.setBackgroundResource(2130843590);
  ...
  public void a(VideoCollectionItem paramVideoCollectionItem, View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      label649:
      this.c.setText(this.jdField_a_of_type_AndroidContentContext.getString(2131438732, new Object[] { Integer.valueOf(paramVideoCollectionItem.collectionCount) }));
      break label379;
      label683:
