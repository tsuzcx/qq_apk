  ...
  implements View.OnClickListener
{
  ...
  public ShareGroupsListAdapter$ProfilePlaceholderViewHolder(View paramView, ShareGroupsListAdapter paramShareGroupsListAdapter)
  {
    ...
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131371886));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131371889));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131372001));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131371693));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131372002));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131371883));
  ...
  public void a(VideoCollectionItem paramVideoCollectionItem, View paramView, int paramInt)
  {
    ...
    if (paramView.type == 1)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130843793);
