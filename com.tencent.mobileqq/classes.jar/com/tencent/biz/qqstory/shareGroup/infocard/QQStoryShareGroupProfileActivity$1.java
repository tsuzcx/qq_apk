  ...
  implements Runnable
{
  ...
  public void run()
  {
    wjg localwjg = (wjg)wjs.a(18);
    ArrayList localArrayList = localwjg.a(this.this$0);
    int i = localArrayList.size();
    if (i >= 4)
    {
      localwjg.a(((Integer)localArrayList.get(0)).intValue() + 1, ((Integer)localArrayList.get(i - 1)).intValue());
