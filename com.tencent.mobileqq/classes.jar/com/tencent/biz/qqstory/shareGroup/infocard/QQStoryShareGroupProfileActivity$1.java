  ...
  implements Runnable
{
  ...
  public void run()
  {
    tcn localtcn = (tcn)tcz.a(18);
    ArrayList localArrayList = localtcn.a(this.this$0);
    int i = localArrayList.size();
    if (i >= 4)
    {
      localtcn.a(((Integer)localArrayList.get(0)).intValue() + 1, ((Integer)localArrayList.get(i - 1)).intValue());
