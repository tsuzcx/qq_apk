  ...
  implements View.OnClickListener, CompoundButton.OnCheckedChangeListener
{
  ...
  sfz jdField_a_of_type_Sfz;
  sga jdField_a_of_type_Sga;
  sgc jdField_a_of_type_Sgc = new txh(this);
  ...
  {
    this.jdField_a_of_type_Sfz.a(this.jdField_a_of_type_JavaLangString);
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    paramBundle = a(0, ajjy.a(2131645242));
    paramBundle.setBackgroundResource(2130839151);
    ...
    paramBundle.setText(ajjy.a(2131645260) + sfm.b);
    paramBundle.setContentDescription(ajjy.a(2131645229) + sfm.b);
    ...
    paramBundle.setText(ajjy.a(2131645246) + sfm.b);
    paramBundle.setContentDescription(ajjy.a(2131645217) + sfm.b);
    ...
    this.jdField_a_of_type_AndroidViewViewGroup.addView(paramBundle);
    paramBundle = this.jdField_a_of_type_Sga.a(this.jdField_a_of_type_JavaLangString);
    boolean bool;
    if (paramBundle != null)
    {
    ...
    else
    {
      ...
      super.setTitle(sfm.jdField_a_of_type_JavaLangString + ajjy.a(2131645218));
      label624:
      this.jdField_a_of_type_Bbmv = new bbmv(this, 2131495446);
      if (badq.g(this)) {
        break label801;
      }
      bbmy.a(this, 1, ajjy.a(2131645214), 0).b(getTitleBarHeight());
      super.startTitleProgress();
    }
    for (;;)
    {
      urp.a("friend_story_settings", "exp_set", this.jdField_a_of_type_Int, 0, new String[] { "2", "", "", "" });
      return true;
      bool = false;
      break;
      label717:
      ...
      if (this.jdField_a_of_type_Int == 2)
      {
        ...
        {
          super.setTitle(sfm.jdField_a_of_type_JavaLangString + ajjy.a(2131645259));
          break label624;
        }
        super.setTitle(ajjy.a(2131645238));
        break label624;
      }
      super.setTitle(ajjy.a(2131645255));
      break label624;
      label801:
      this.jdField_a_of_type_Sfz.a(this.jdField_a_of_type_JavaLangString);
    }
  ...
  public void onCheckedChanged(CompoundButton paramCompoundButton, boolean paramBoolean)
  {
    ...
    if (!badq.g(this)) {
      bbmy.a(this, 1, ajjy.a(2131645257), 0).b(getTitleBarHeight());
    }
    for (int i = 0;; i = 1)
    {
      ...
      for (;;)
      {
        ...
        urp.a("person_data_set", paramCompoundButton, 0, 0, new String[] { "", "", "", "" });
        return;
        if (i != 0)
        {
          this.jdField_a_of_type_Sfz.a(paramCompoundButton, true, paramBoolean);
        ...
        if (i != 0)
        {
          this.jdField_a_of_type_Sfz.a(paramCompoundButton, false, paramBoolean);
          this.jdField_a_of_type_Bbmv.b(0, 2131652843, 0);
          break;
        }
      ...
      label277:
      urp.a("list_settings", paramCompoundButton, 0, 0, new String[] { "", "", "", "" });
      return;
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    if (((ajjj)this.app.getManager(51)).b(this.jdField_a_of_type_JavaLangString)) {}
    for (int i = 1;; i = 19)
    {
      paramView = new ProfileActivity.AllInOne(this.jdField_a_of_type_JavaLangString, i);
      ProfileActivity.b(getActivity(), paramView);
      urp.a("list_settings", "clk_person_data", 0, 0, new String[] { "", "", "", "" });
      return;
    }
  }
}
