  ...
  implements View.OnClickListener
{
  ...
  QQStoryObserver jdField_a_of_type_ComTencentBizQqstoryBaseQQStoryObserver = new npn(this);
  ...
  protected View a(int paramInt, String paramString)
  {
    ...
    paramString = (ImageView)localView.findViewById(2131363425);
    paramString.setVisibility(4);
    paramString.setBackgroundResource(2130838486);
  ...
  void a()
  {
    ...
    ((LinearLayout)localObject).setBackgroundResource(2130838210);
    ...
    this.jdField_a_of_type_AndroidViewViewGroup.addView((View)localObject);
    ((View)localObject).setBackgroundResource(2130838629);
    this.jdField_a_of_type_AndroidViewView = ((View)localObject);
    localObject = a(2, "关闭");
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    {
      QQToast.a(this, 1, 2131432992, 0).b(getTitleBarHeight());
