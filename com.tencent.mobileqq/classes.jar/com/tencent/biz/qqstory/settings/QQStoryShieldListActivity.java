  ...
  implements View.OnClickListener, FaceDecoder.DecodeTaskCompletionListener
{
  ...
  QQStoryObserver jdField_a_of_type_ComTencentBizQqstoryBaseQQStoryObserver = new npu(this);
  FaceDecoder jdField_a_of_type_ComTencentMobileqqUtilFaceDecoder;
  public QQProgressNotifier a;
  XListView jdField_a_of_type_ComTencentWidgetXListView;
  npv jdField_a_of_type_Npv;
  ...
  public void a(List paramList)
  {
    ...
    this.jdField_a_of_type_Npv.a(paramList);
  }
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    if (this.jdField_a_of_type_Int == 2)
    {
      ...
      super.setContentView(2130970787);
      super.setTitle(paramBundle);
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131362710));
      if (this.jdField_a_of_type_Int != 2) {
        break label373;
      }
      paramBundle = "把好友添加到这里后，发日迹他将无法看到。";
      this.jdField_a_of_type_AndroidWidgetTextView.setText(paramBundle);
      this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)super.findViewById(2131371827));
      ...
      this.jdField_a_of_type_Npv = new npv(this, paramBundle);
      this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Npv);
      this.jdField_a_of_type_AndroidViewView = super.findViewById(2131371826);
      ...
      label242:
      ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131367910)).setText(paramBundle);
  ...
  {
    this.jdField_a_of_type_Npv.notifyDataSetChanged();
  }
}
