...
public class TroopStoryUtil
{
  public static MessageRecord a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    {
      TroopStoryManager localTroopStoryManager = (TroopStoryManager)paramQQAppInterface.getManager(207);
  ...
  {
    return ("gs_" + paramMessageForShortVideo.frienduin + '_' + paramMessageForShortVideo.getMd5() + '_' + MD5Utils.d(paramMessageForShortVideo.uuid) + "-700").toLowerCase();
  }
  ...
  {
    return (QQStoryManager.j()) && (paramInt == 1) && ((paramMessageRecord instanceof MessageForShortVideo)) && (((MessageForShortVideo)paramMessageRecord).busiType == 1);
  }
