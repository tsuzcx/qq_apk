  ...
  extends TroopStoryMemoriesListAdapter.VideoItemViewHolder
{
  ...
  public void a(TroopStoryItemInfo paramTroopStoryItemInfo, int paramInt)
  {
    ...
    Drawable localDrawable = this.jdField_a_of_type_ComTencentBizQqstoryTroopMemoriesTroopStoryMemoriesListAdapter.a.getResources().getDrawable(2130847249);
    try
    {
      ...
      paramTroopStoryItemInfo = this.jdField_a_of_type_ComTencentBizQqstoryTroopMemoriesTroopStoryMemoriesListAdapter.a.getResources().getDrawable(2130839545);
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setText(HardCodeUtil.a(2131715648));
      ((Animatable)paramTroopStoryItemInfo).start();
      this.jdField_a_of_type_AndroidViewView.setOnClickListener(new TroopStoryMemoriesListAdapter.UploadVideoItemViewHolder.1(this));
      return;
    }
