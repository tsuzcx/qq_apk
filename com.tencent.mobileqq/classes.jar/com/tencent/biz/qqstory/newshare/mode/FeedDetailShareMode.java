  ...
  extends MultiVideoShareModeBase
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = "https://story.now.qq.com/mobile/transfer.html?src_type=app&version=1&fromId=17&videoOwnerUin=%s&videoId=%s&unionid=%s&ptype=%d&actionnamekey=1&storysharefrom=%s&sharefromtype=%d&one_page=0" + StoryApi.a(2131699762);
  }
  ...
  public FeedDetailShareMode(StoryVideoItem paramStoryVideoItem, String paramString, int paramInt)
  {
    ...
    this.jdField_d_of_type_JavaLangString = (((QQUserUIItem)localObject).nickName + HardCodeUtil.a(2131704465) + QQStoryConstant.jdField_a_of_type_JavaLangString);
    this.e = (((QQUserUIItem)localObject).nickName + HardCodeUtil.a(2131704464) + QQStoryConstant.jdField_a_of_type_JavaLangString);
    ...
    if (((QQUserUIItem)localObject).isMe())
    {
      ...
      this.i = (paramStoryVideoItem + " · " + this.jdField_d_of_type_Int + HardCodeUtil.a(2131704467));
      this.j = ("#" + QQStoryConstant.jdField_a_of_type_JavaLangString + "# " + this.jdField_c_of_type_JavaLangString + HardCodeUtil.a(2131704466) + QQStoryConstant.jdField_a_of_type_JavaLangString + "（" + this.i + "）");
  ...
  public String a(String paramString, long paramLong)
  {
    ...
    return paramString + HardCodeUtil.a(2131704460) + str;
  }
}
