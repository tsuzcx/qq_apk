  ...
  extends VideoShareModeBase
{
  ...
  {
    if (paramInt == 1) {
      return String.format("mqqapi://qstory/openVideo?src_type=app&version=1&fromId=17&videoOwnerUin=%s&videoId=%s&unionid=%s&feedid=%s&ptype=%d&identify=1", new Object[] { this.f, this.j.mVid, this.g, this.i, Integer.valueOf(this.b) });
    }
    return String.format(a, new Object[] { this.f, this.j.mVid, this.g, this.i, Integer.valueOf(this.b), b(paramInt), Integer.valueOf(this.c[paramInt]) });
  }
}
