  ...
  extends CardShareModeBase
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = "src_type=internal&version=1&uin=%s&usertype=%s&unionid=%s&fromId=%s&storysharefrom=%s" + StoryApi.a(2131432097);
  ...
  public InfoCardShareMode(QQUserUIItem paramQQUserUIItem)
  {
    ...
    if (paramQQUserUIItem.isVip)
    {
      ...
      this.e = (paramQQUserUIItem.nickName + "的" + "小视频");
      this.g = ("[小视频]分享" + paramQQUserUIItem.nickName + "的" + "小视频");
      this.h = (paramQQUserUIItem.nickName + "的" + "小视频" + "[来自" + "小视频" + "，请使用新版手机" + StoryApi.a(2131432096) + "查看]");
