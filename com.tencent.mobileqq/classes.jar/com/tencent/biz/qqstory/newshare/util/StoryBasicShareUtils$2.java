...
public final class StoryBasicShareUtils$2
  implements Runnable
{
  public StoryBasicShareUtils$2(ApplicationInfo paramApplicationInfo, tew paramtew, Context paramContext, tcp paramtcp) {}
  ...
  public void run()
  {
    ...
    localIntent.putExtra("android.intent.extra.TEXT", this.jdField_a_of_type_Tew.a + this.jdField_a_of_type_Tew.c);
    if (!TextUtils.isEmpty(this.jdField_a_of_type_Tew.d)) {
      localIntent.putExtra("android.intent.extra.STREAM", Uri.fromFile(new File(this.jdField_a_of_type_Tew.d)));
    }
