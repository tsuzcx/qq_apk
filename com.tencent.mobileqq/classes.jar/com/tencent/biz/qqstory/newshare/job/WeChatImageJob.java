  ...
  extends Job
{
  ...
  public static Bitmap a(Drawable paramDrawable)
  {
    ...
    try
    {
      ...
      {
        SLog.e("WeChatImageJob", "drawableToBitmapWhiteBg " + paramDrawable.getMessage());
        return null;
      }
      return null;
    }
  ...
  public static Bitmap b(Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      ...
      Bitmap localBitmap2 = ImageUtil.a(BaseApplicationImpl.sApplication.getResources(), 2130847159);
  ...
  public void a()
  {
    ...
    for (;;)
    {
      ...
      catch (OutOfMemoryError localOutOfMemoryError)
      {
        for (;;)
        {
          SLog.c("WeChatImageJob", "addPlayIconInBitmapForWeChat oom error" + localOutOfMemoryError.getMessage());
