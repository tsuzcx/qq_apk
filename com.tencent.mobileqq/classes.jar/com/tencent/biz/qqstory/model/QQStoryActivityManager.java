  ...
  implements IManager
{
  ...
  public ArrayList a(QQStoryBaseActivity paramQQStoryBaseActivity)
  {
  ...
  public void a(QQStoryBaseActivity paramQQStoryBaseActivity)
  {
    ...
    WeakReference localWeakReference = new WeakReference(paramQQStoryBaseActivity);
    this.jdField_a_of_type_JavaUtilHashMap.put(str, localWeakReference);
    if (((paramQQStoryBaseActivity instanceof StoryPlayVideoActivity)) && (!this.jdField_a_of_type_Boolean))
    {
    ...
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_JavaUtilMap != null)) {
      this.jdField_a_of_type_JavaUtilMap.put(str, localWeakReference);
    }
  }
