  ...
  implements uha
{
  ...
  public StoryItem(StoryEntry paramStoryEntry)
  {
    ...
    this.user = ((usd)urr.a(2)).b(this.unionId);
    if (this.user == null)
    {
  ...
  public void convertFrom(int paramInt, qqstory_struct.StoryDes paramStoryDes)
  {
    ...
    this.user = ((usd)localObject).a(localQQUserUIItem);
    localObject = ((uro)urr.a(5)).a(this.user.uid, paramInt);
    ...
    while (localObject == null)
    {
      ...
      {
        wsv.b("Q.qqstory.home.StoryItem", "decode json fail", paramStoryDes);
        return;
      }
      if (localObject != null)
      {
