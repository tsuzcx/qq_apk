  ...
  implements IManager
{
  ...
  public ShareGroupCollectionItem a(String paramString)
  {
    ...
    {
      return localObject;
      localShareGroupCollectionItem = (ShareGroupCollectionItem)this.jdField_a_of_type_ComTencentBizQqstoryBaseOneObjectCacheList.a(paramString);
  ...
  public void a(List<VideoCollectionItem> paramList, String paramString, boolean paramBoolean)
  {
    ...
    for (paramString = new MemoryInfoEntry(paramString);; paramString = (String)localObject)
    {
      ...
      while (paramList.hasNext())
      {
        ...
        localEntityManager.persistOrReplace(((VideoCollectionItem)this.jdField_a_of_type_ComTencentBizQqstoryBaseOneObjectCacheList.a(((VideoCollectionItem)localObject).key, (Copyable)localObject)).convertTo());
      }
