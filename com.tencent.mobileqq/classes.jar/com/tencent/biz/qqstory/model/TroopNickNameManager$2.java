...
public class TroopNickNameManager$2
  implements Runnable
{
  public TroopNickNameManager$2(urz paramurz, String paramString, QQUserUIItem paramQQUserUIItem, boolean paramBoolean1, boolean paramBoolean2) {}
  ...
  public void run()
  {
    if (this.this$0.a.c(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentBizQqstoryModelItemQQUserUIItem.qq) != null)
    {
      ...
      localusb.jdField_a_of_type_JavaUtilList = localArrayList;
      localusb.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
      uht.a().dispatch(localusb);
    }
