  ...
  implements IManager
{
  ...
  {
    c();
    new Handler().postDelayed(new nhs(this, paramInt), paramInt);
  }
  ...
  public void a(@NonNull BasicLocation paramBasicLocation, LbsManager.POIListRequestSession paramPOIListRequestSession, LbsManager.POIListRequestCallback paramPOIListRequestCallback)
  {
    ...
    for (;;)
    {
      ...
      CmdTaskManger.a().a(new CommonRequest(paramPOIListRequestSession, localReqGetPOIList, paramBasicLocation), new nht(this, localWeakReference, paramPOIListRequestCallback));
      return;
  ...
  public void c()
  {
    ...
    SosoInterface.a(new nhr(this, 0, true, false, 60000L, false, false, "NewStoryTakeVideoActivity"));
  }
}
