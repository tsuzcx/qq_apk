  ...
  implements IManager
{
  ...
  private CopyOnWriteArraySet jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArraySet = new CopyOnWriteArraySet();
  ...
  {
    this.jdField_a_of_type_AndroidOsHandler.post(new ngw(this, paramInt));
  }
