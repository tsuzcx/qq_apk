  ...
  implements IManager
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = QQStoryConstant.e + "filter";
  ...
  private boolean a()
  {
    ...
    //   13: getstatic 52	com/tencent/biz/qqstory/model/filter/VideoFilterManager:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   32: invokestatic 151	com/tencent/biz/qqstory/utils/FileUtils:d	(Ljava/lang/String;)Z
    //   35: pop
    //   36: new 153	java/io/ByteArrayOutputStream
    //   39: dup
    //   40: sipush 4096
    //   43: invokespecial 156	java/io/ByteArrayOutputStream:<init>	(I)V
    //   46: astore_2
    //   47: new 158	java/io/ObjectOutputStream
    //   50: dup
    //   51: aload_2
    //   52: invokespecial 161	java/io/ObjectOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   55: astore_3
    //   56: aload_3
    //   57: aload_0
    //   58: getfield 163	com/tencent/biz/qqstory/model/filter/VideoFilterManager:jdField_a_of_type_Long	J
    //   61: invokevirtual 167	java/io/ObjectOutputStream:writeLong	(J)V
    //   64: aload_3
    //   65: aload_0
    //   66: getfield 169	com/tencent/biz/qqstory/model/filter/VideoFilterManager:jdField_a_of_type_Int	I
    //   69: invokevirtual 172	java/io/ObjectOutputStream:writeInt	(I)V
    //   72: aload_3
    //   73: aload_0
    //   74: getfield 72	com/tencent/biz/qqstory/model/filter/VideoFilterManager:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   77: invokevirtual 176	java/io/ObjectOutputStream:writeObject	(Ljava/lang/Object;)V
    //   80: aload_3
    //   81: invokevirtual 179	java/io/ObjectOutputStream:flush	()V
    //   84: aload_3
    //   85: invokevirtual 182	java/io/ObjectOutputStream:close	()V
    //   88: new 184	java/io/FileOutputStream
    //   91: dup
    //   92: new 28	java/lang/StringBuilder
    //   95: dup
    //   96: invokespecial 31	java/lang/StringBuilder:<init>	()V
    //   99: getstatic 52	com/tencent/biz/qqstory/model/filter/VideoFilterManager:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   118: invokespecial 185	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   121: astore_1
    //   122: aload_2
    //   123: aload_1
    //   124: invokevirtual 188	java/io/ByteArrayOutputStream:writeTo	(Ljava/io/OutputStream;)V
    //   127: aload_2
    //   128: invokevirtual 189	java/io/ByteArrayOutputStream:flush	()V
    //   131: aload_2
    //   132: invokevirtual 190	java/io/ByteArrayOutputStream:close	()V
    //   135: aload_1
    //   136: invokevirtual 191	java/io/FileOutputStream:close	()V
    //   139: ldc 115
    //   141: ldc 193
    //   143: aload_0
    //   144: getfield 72	com/tencent/biz/qqstory/model/filter/VideoFilterManager:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   147: invokeinterface 199 1 0
    //   152: invokestatic 204	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   155: invokestatic 207	com/tencent/biz/qqstory/support/logging/SLog:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    //   158: aload_2
    //   159: ifnull +7 -> 166
    //   162: aload_2
    //   163: invokevirtual 190	java/io/ByteArrayOutputStream:close	()V
    //   166: aload_3
    //   167: ifnull +7 -> 174
    //   170: aload_3
    //   171: invokevirtual 182	java/io/ObjectOutputStream:close	()V
    //   174: aload_1
    //   175: ifnull +7 -> 182
    //   178: aload_1
    ...
    //   214: ldc 212
    //   216: aload_3
    //   217: invokestatic 215	com/tencent/biz/qqstory/support/logging/SLog:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   220: aload_2
    //   221: ifnull +7 -> 228
    //   224: aload_2
    //   225: invokevirtual 190	java/io/ByteArrayOutputStream:close	()V
    //   228: aload_1
    //   229: ifnull +7 -> 236
    //   232: aload_1
    //   233: invokevirtual 182	java/io/ObjectOutputStream:close	()V
    //   236: aload 4
    //   238: ifnull +8 -> 246
    //   241: aload 4
    //   243: invokevirtual 191	java/io/FileOutputStream:close	()V
    //   246: iconst_0
    //   247: ireturn
    //   248: astore_2
    //   249: aload_2
    ...
    //   282: ifnull +7 -> 289
    //   285: aload_2
    //   286: invokevirtual 190	java/io/ByteArrayOutputStream:close	()V
    //   289: aload_3
    //   290: ifnull +7 -> 297
    //   293: aload_3
    //   294: invokevirtual 182	java/io/ObjectOutputStream:close	()V
    //   297: aload 4
    //   299: ifnull +8 -> 307
    //   302: aload 4
    //   304: invokevirtual 191	java/io/FileOutputStream:close	()V
    //   307: aload_1
    //   308: athrow
    //   309: astore_2
    //   310: aload_2
    //   311: invokevirtual 210	java/io/IOException:printStackTrace	()V
    //   314: goto -25 -> 289
    //   317: astore_2
    //   318: aload_2
    //   319: invokevirtual 210	java/io/IOException:printStackTrace	()V
    //   322: goto -25 -> 297
    //   325: astore_2
    //   326: aload_2
    //   327: invokevirtual 210	java/io/IOException:printStackTrace	()V
    //   330: goto -23 -> 307
    //   333: astore_1
    //   334: aconst_null
    //   335: astore_3
    ...
    //   0	409	0	this	VideoFilterManager
  ...
  private boolean b()
  {
    ...
    //   0: aconst_null
    //   1: astore 4
    //   3: new 236	java/io/ByteArrayInputStream
    //   6: dup
    ...
    //   18: getstatic 52	com/tencent/biz/qqstory/model/filter/VideoFilterManager:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   21: invokevirtual 40	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   24: ldc 104
    //   26: invokevirtual 40	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   29: ldc 146
    ...
    //   40: invokestatic 239	com/tencent/biz/qqstory/utils/FileUtils:b	(Ljava/io/File;)[B
    //   43: invokespecial 242	java/io/ByteArrayInputStream:<init>	([B)V
    //   46: astore_2
    //   47: new 244	java/io/ObjectInputStream
    //   50: dup
    //   51: aload_2
    //   52: invokespecial 247	java/io/ObjectInputStream:<init>	(Ljava/io/InputStream;)V
    //   55: astore_3
    //   56: aload_3
    //   57: astore 4
    //   59: aload_2
    //   60: astore 5
    //   62: aload_0
    //   63: getfield 72	com/tencent/biz/qqstory/model/filter/VideoFilterManager:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   66: invokeinterface 250 1 0
    //   71: aload_3
    //   72: astore 4
    //   74: aload_2
    //   75: astore 5
    //   77: aload_0
    //   78: aload_3
    //   79: invokevirtual 254	java/io/ObjectInputStream:readLong	()J
    //   82: putfield 163	com/tencent/biz/qqstory/model/filter/VideoFilterManager:jdField_a_of_type_Long	J
    //   85: aload_3
    //   86: astore 4
    //   88: aload_2
    //   89: astore 5
    //   91: aload_0
    //   92: aload_3
    //   93: invokevirtual 257	java/io/ObjectInputStream:readInt	()I
    //   96: putfield 169	com/tencent/biz/qqstory/model/filter/VideoFilterManager:jdField_a_of_type_Int	I
    //   99: aload_3
    //   100: astore 4
    //   102: aload_2
    //   103: astore 5
    //   105: aload_3
    //   106: invokevirtual 261	java/io/ObjectInputStream:readObject	()Ljava/lang/Object;
    //   109: checkcast 195	java/util/List
    //   112: astore 6
    //   114: aload 6
    //   116: ifnull +21 -> 137
    //   119: aload_3
    ...
    //   123: astore 5
    //   125: aload_0
    //   126: getfield 72	com/tencent/biz/qqstory/model/filter/VideoFilterManager:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   129: aload 6
    //   131: invokeinterface 265 2 0
    //   136: pop
    //   137: aload 6
    //   139: ifnull +53 -> 192
    //   142: aload_3
    ...
    //   164: ldc_w 267
    //   167: iload_1
    //   168: invokestatic 204	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   171: invokestatic 207	com/tencent/biz/qqstory/support/logging/SLog:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    //   174: aload_2
    //   175: ifnull +7 -> 182
    //   178: aload_2
    //   179: invokevirtual 268	java/io/ByteArrayInputStream:close	()V
    //   182: aload_3
    //   183: ifnull +7 -> 190
    //   186: aload_3
    //   187: invokevirtual 269	java/io/ObjectInputStream:close	()V
    //   190: iconst_1
    //   191: ireturn
    //   192: iconst_0
    //   193: istore_1
    ...
    //   203: ldc 115
    //   205: ldc_w 271
    //   208: invokestatic 273	com/tencent/biz/qqstory/support/logging/SLog:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   211: aload_2
    //   212: ifnull +7 -> 219
    //   215: aload_2
    //   216: invokevirtual 268	java/io/ByteArrayInputStream:close	()V
    //   219: aload_3
    //   220: ifnull +7 -> 227
    //   223: aload_3
    //   224: invokevirtual 269	java/io/ObjectInputStream:close	()V
    //   227: iconst_0
    //   228: ireturn
    //   229: astore 6
    //   231: aconst_null
    ...
    //   243: ldc_w 275
    //   246: aload 6
    //   248: invokestatic 215	com/tencent/biz/qqstory/support/logging/SLog:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   251: aload_2
    //   252: ifnull +7 -> 259
    //   255: aload_2
    //   256: invokevirtual 268	java/io/ByteArrayInputStream:close	()V
    //   259: aload_3
    //   260: ifnull -33 -> 227
    //   263: aload_3
    //   264: invokevirtual 269	java/io/ObjectInputStream:close	()V
    //   267: goto -40 -> 227
    //   270: astore_2
    //   271: goto -44 -> 227
    //   274: astore_3
    ...
    //   281: ifnull +7 -> 288
    //   284: aload_2
    //   285: invokevirtual 268	java/io/ByteArrayInputStream:close	()V
    //   288: aload 4
    //   290: ifnull +8 -> 298
    //   293: aload 4
    //   295: invokevirtual 269	java/io/ObjectInputStream:close	()V
    //   298: aload_3
    //   299: athrow
    //   300: astore_2
    //   301: goto -119 -> 182
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	376	0	this	VideoFilterManager
    //   155	39	1	i	int
  ...
  @Nullable
  public PictureFilterConfig a(FilterItem paramFilterItem)
  {
    ...
    do
    {
      do
      {
        ...
        localObject = (PictureFilterConfig)this.jdField_a_of_type_JavaUtilMap.get(str);
      ...
      catch (Exception paramFilterItem)
      {
        for (;;)
        {
          SLog.b("VideoFilterManager", "getFilterItemConfig, parse config file failed", paramFilterItem);
        }
      }
      paramFilterItem = (FilterItem)localObject;
    } while (localObject == null);
  ...
  public PictureFilterConfig a(File paramFile)
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_b_of_type_JavaUtilList)
      {
        ...
        if ((localFilterItem.isLocalType()) || (a(localFilterItem)))
        {
          ...
          SLog.a("VideoFilterManager", "add to display : %s", localFilterItem);
        }
      }
      SLog.a("VideoFilterManager", "ignore display : %s", localFilterItem);
    }
  ...
  public boolean a(boolean paramBoolean)
  {
    ...
    {
      return false;
      SLog.d("VideoFilterManager", "fireGetFilterList ignore because you request too frequently, frequency = %d s", new Object[] { Integer.valueOf(this.jdField_a_of_type_Int) });
    }
  }
  ...
  public void c()
  {
    ...
    CmdTaskManger.a().a(new VideoFilterManager.GetFilterListRequest(this.c), new nck(this, null));
  }
  ...
  public void d()
  {
    ...
    synchronized (this.jdField_b_of_type_JavaUtilList)
    {
      ...
      if (localFilterItem != null)
      {
        ...
        new ncj(this, this.jdField_a_of_type_ComTencentBizQqstoryBaseDownloadDownloader).executeOnExecutor(Bosses.get().getExecutor(16), new FileDownloadTask.Input[] { new FileDownloadTask.Input(localFilterItem.filterConfigUrl, b(localFilterItem), localFilterItem.filterConfigMd5) });
      }
      return;
    }
  }
