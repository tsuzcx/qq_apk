  ...
  implements IManager
{
  ...
  TroopMemberInfoHandler jdField_a_of_type_ComTencentMobileqqTroopHandlerTroopMemberInfoHandler;
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqTroopHandlerTroopMemberInfoHandler = ((TroopMemberInfoHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.TROOP_MEMBER_INFO_HANDLER));
      ...
      if (localIterator.hasNext())
      {
        ...
        else
        {
          ...
          if (((Iterator)localObject2).hasNext())
          {
            ...
            if (this.jdField_a_of_type_ComTencentMobileqqTroopHandlerTroopMemberInfoHandler != null) {
              this.jdField_a_of_type_ComTencentMobileqqTroopHandlerTroopMemberInfoHandler.a(str1, localTroopInfo.troopcode, (ArrayList)localObject1);
            }
            localObject1 = new ArrayList(20);
            i = 1;
          }
