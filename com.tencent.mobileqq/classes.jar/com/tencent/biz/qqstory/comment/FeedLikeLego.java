  ...
  extends LegoBase<LikeEntry>
{
  ...
  {
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370367));
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      for (((CommentLikeFeedItem)localObject).mLikeCount += 1;; this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem.mLikeCount = 1)
      {
        ...
        ThreadManager.post(new FeedLikeLego.2(this, (UserManager)SuperManager.a(2), str, (LikeEntry)localObject), 5, null, true);
        return;
      }
    }
