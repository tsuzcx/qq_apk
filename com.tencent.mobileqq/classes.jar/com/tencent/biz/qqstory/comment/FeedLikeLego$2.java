...
public class FeedLikeLego$2
  implements Runnable
{
  public FeedLikeLego$2(snr paramsnr, sqs paramsqs, String paramString, LikeEntry paramLikeEntry) {}
  ...
  public void run()
  {
    ...
    for (long l = 2L;; l = 0L)
    {
      ...
      this.this$0.jdField_a_of_type_Sps.a(this.jdField_a_of_type_ComTencentBizQqstoryDatabaseLikeEntry);
      this.this$0.jdField_a_of_type_Uje.a(this.this$0.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem);
