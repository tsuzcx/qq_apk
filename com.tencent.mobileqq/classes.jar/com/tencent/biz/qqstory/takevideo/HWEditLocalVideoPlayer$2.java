  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      if (i < ((ArrayList)localObject1).size())
      {
        ...
        yvq localyvq = new yvq(i, bauq.a(HWEditLocalVideoPlayer.a(this.this$0), (int)((zmh)localObject2).a));
        yvq.a(localyvq, ((zmh)localObject2).a);
        yvq.b(localyvq, l1);
        this.this$0.jdField_a_of_type_JavaUtilList.add(localyvq);
        yqp.b("Q.qqstory.record.HWEditLocalVideoPlayer", "create FRAGMENT info = %s, cost = %dms", localyvq, Long.valueOf(SystemClock.uptimeMillis() - l4));
      ...
      else
      {
        ...
        localObject1 = (yvq)this.this$0.jdField_a_of_type_JavaUtilList.get(i);
        localObject2 = zkr.a(HWEditLocalVideoPlayer.a(this.this$0));
        localObject2 = anhk.ck + (String)localObject2 + "_" + i + ".IFrames.audio";
        j = baup.a(HWEditLocalVideoPlayer.b(this.this$0), (String)localObject2, (float)yvq.a((yvq)localObject1) * 1.0F / (float)this.this$0.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.mDuration, (float)yvq.b((yvq)localObject1) * 1.0F / (float)this.this$0.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.mDuration);
        if (j != 0) {
          break label557;
        }
        yqp.b("Q.qqstory.record.HWEditLocalVideoPlayer", "clipAudioFile finished audioFilePath" + (String)localObject2);
        ((yvq)localObject1).b = ((String)localObject2);
      }
      for (;;)
      {
        i += 1;
        ...
        break;
        label557:
        yqp.e("Q.qqstory.record.HWEditLocalVideoPlayer", "clipAudioFile failed. errcode =%s,  audioFilePath=%s, duration=%s, startTime=%s, endTime=%s", new Object[] { Integer.valueOf(j), localObject2, Long.valueOf(this.this$0.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.mDuration), Long.valueOf(yvq.a((yvq)localObject1)), Long.valueOf(yvq.b((yvq)localObject1)) });
      }
      label621:
