  ...
  implements yan
{
  ...
  {
    this.jdField_a_of_type_Xzd = new xxb();
    this.jdField_a_of_type_Bbpx = new xwy(this);
  }
  ...
  public Intent a(yjh paramyjh)
  {
    ...
    ((Intent)localObject2).putExtra("PhotoConst.HAS_CROP", paramyjh.a.d);
    ArrayList localArrayList = new ArrayList();
    Object localObject1;
    if ((paramyjh.a.jdField_b_of_type_Boolean) || (!paramyjh.a.jdField_a_of_type_Boolean))
    {
      QLog.d("EditPicActivity", 1, "send sourcePath");
      localObject1 = this.jdField_a_of_type_Xzd.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.mEditSource.getSourcePath();
      ...
      ((Intent)localObject2).putExtra("video_sync_to_story", paramyjh.d);
      ...
      localObject1 = a((Intent)localObject2, this.jdField_a_of_type_Xzd.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.getBussinessId(), (String)localObject1, str1, str2);
      paramyjh = (yjh)localObject1;
      if (str1.contains("ForwardRecentActivity")) {
        paramyjh = a((Intent)localObject1);
      }
      localObject1 = paramyjh.getStringExtra("PhotoConst.INIT_ACTIVITY_CLASS_NAME");
      localObject2 = paramyjh.getStringExtra("PhotoConst.DEST_ACTIVITY_CLASS_NAME");
      ...
      paramyjh.setClassName(paramyjh.getStringExtra("PhotoConst.INIT_ACTIVITY_PACKAGE_NAME"), (String)localObject1);
    }
    for (;;)
    {
      paramyjh.putExtra("open_chatfragment_fromphoto", true);
      return paramyjh;
      localObject1 = paramyjh.a.jdField_b_of_type_JavaLangString;
      if (getIntent().getIntExtra("camera_type", -1) != -1)
      {
        FileUtils.deleteFile(paramyjh.a.jdField_a_of_type_JavaLangString);
        new File(paramyjh.a.jdField_a_of_type_JavaLangString);
        bfvo.a(this, paramyjh.a.jdField_a_of_type_JavaLangString);
      }
      ...
      if ("com.tencent.mobileqq.activity.aio.photo.AIOGalleryActivity".equals(str1)) {
        paramyjh.setClassName("com.tencent.mobileqq", (String)localObject1);
      }
    }
  }
  ...
  public void doOnActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    this.jdField_a_of_type_Xzd.a(paramInt1, paramInt2, paramIntent);
    Object localObject2;
    Object localObject1;
    if (paramInt1 == 666)
    {
      if (paramInt2 == -1)
      {
        ...
        for (paramIntent = this.jdField_a_of_type_Xzd.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.mEditSource.getSourcePath();; paramIntent = ((Intent)localObject2).getStringExtra("image_path"))
        {
          if (QLog.isColorLevel()) {
          ...
          QQToast.a(this, amtj.a(2131702803), 0).a();
          finish();
          return;
        }
        paramIntent = new EditVideoParams(this.jdField_a_of_type_Xzd.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.mBusinessId, this.jdField_a_of_type_Xzd.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.mEnableMasks, new EditTakePhotoSource((String)localObject1, 2, 0, 0), EditVideoParams.setBundleForBusiness(this.jdField_a_of_type_Xzd.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.getBussinessId()));
    ...
    for (;;)
    {
      if (paramInt1 == 1003)
      {
        ...
        this.jdField_a_of_type_Xzd.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.mBusinessId = 1;
        this.jdField_a_of_type_Xzd.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.mEditSource = new EditTakePhotoSource(paramIntent, 2, this.jdField_a_of_type_Xzd.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.mEditSource.getWidth(), this.jdField_a_of_type_Xzd.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.mEditSource.getHeight());
        this.jdField_a_of_type_Xzd.g();
        return;
      }
  ...
  public void doOnBackPressed()
  {
    ...
    if (!this.jdField_a_of_type_Xzd.b()) {
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    aktv.a("finish jump activity", aktv.a(getIntent()));
    xvv.d("EditPicActivity", "doOnCreate instance=%d, video params=%s", new Object[] { Integer.valueOf(System.identityHashCode(this)), localEditVideoParams });
    if ((localEditVideoParams == null) || (TextUtils.isEmpty(localEditVideoParams.mEditSource.getSourcePath())))
    {
      QQToast.a(this, amtj.a(2131702800), 0).a();
      finish();
      return true;
    }
    if (QLog.isColorLevel()) {
    ...
    {
      QQToast.a(this, amtj.a(2131702799), 0).a();
      finish();
      return true;
    }
    ...
    try
    {
      for (;;)
      {
        ...
        setContentViewC(2131559579);
        a(paramBundle);
        if (localEditVideoParams.mExtra == null) {
          break;
        }
        localEditVideoParams.mExtra.putInt("uintype", i);
        this.jdField_a_of_type_Xzd.a(this, localEditVideoParams);
        if (this.jdField_a_of_type_Xzd.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoArtFilter != null)
        {
          this.jdField_a_of_type_Xzd.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoArtFilter.jdField_b_of_type_JavaLangString = getIntent().getStringExtra("FILTER_STRING");
          this.jdField_a_of_type_Xzd.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoArtFilter.a = getIntent().getIntExtra("FILTER_MAXSIDE", 640);
          this.jdField_a_of_type_Xzd.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoArtFilter.c = getIntent().getStringExtra("FILTER_LOADING_PATH");
        }
        if ((this.jdField_a_of_type_Xzd.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditPicRawImage != null) && (this.jdField_a_of_type_Xzd.jdField_a_of_type_Xxa != null))
        {
          long l = getIntent().getLongExtra("babyq_ability", 0L) & 0x2;
          paramBundle = this.jdField_a_of_type_Xzd.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditPicRawImage;
          if (l <= 0L) {
            break label672;
          }
          bool = true;
          paramBundle.jdField_a_of_type_Boolean = bool;
          paramBundle = this.jdField_a_of_type_Xzd.jdField_a_of_type_Xxa;
          if (l <= 0L) {
            break label678;
          }
          bool = true;
        ...
        this.jdField_a_of_type_Xzd.i();
        PtvTemplateManager.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface).a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_a_of_type_Bbpx, false);
        if (localEditVideoParams.mExtra != null) {
          xwb.a(localEditVideoParams.mExtra.getInt("pic_entrance_type", 0));
        }
        yjl.a(null);
        if (localEditVideoParams.mBusinessId == 2)
        {
          ...
          paramBundle = "3";
          xwa.a("aio_shoot", "exp_edit", 0, 0, new String[] { "2", paramBundle });
        }
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        continue;
        xvv.e("EditPicActivity", "pic editVideoParams.mExtra is null!!");
        continue;
        label672:
        boolean bool = false;
        continue;
  ...
  public void doOnResume()
  {
    ...
    this.jdField_a_of_type_Xzd.k();
    aktv.a("resume activity");
  }
  ...
  public void doOnStart()
  {
    ...
    this.jdField_a_of_type_Xzd.j();
    xwb.jdField_a_of_type_JavaLangString = xwb.a(this.jdField_a_of_type_Xzd.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.mBusinessId);
  ...
  {
    super.doOnStop();
    xvv.c("EditPicActivity", "doOnStop");
    this.jdField_a_of_type_Xzd.m();
