  ...
  implements uwe
{
  ...
  {
    this.jdField_a_of_type_Uut = new usq();
    this.jdField_a_of_type_Awdy = new usn(this);
  }
  ...
  public Intent a(vfh paramvfh)
  {
    ...
    ((Intent)localObject2).putExtra("PhotoConst.HAS_CROP", paramvfh.a.d);
    ArrayList localArrayList = new ArrayList();
    Object localObject1;
    if ((paramvfh.a.jdField_b_of_type_Boolean) || (!paramvfh.a.jdField_a_of_type_Boolean))
    {
      ...
      ((Intent)localObject2).putExtra("video_sync_to_story", paramvfh.d);
      ...
      localObject1 = a((Intent)localObject2, this.jdField_a_of_type_Uut.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.a(), (String)localObject1, str1, str2);
      paramvfh = (vfh)localObject1;
      if (str1.contains("ForwardRecentActivity")) {
        paramvfh = a((Intent)localObject1);
      }
      localObject1 = paramvfh.getStringExtra("PhotoConst.INIT_ACTIVITY_CLASS_NAME");
      localObject2 = paramvfh.getStringExtra("PhotoConst.DEST_ACTIVITY_CLASS_NAME");
      ...
      paramvfh.setClassName(paramvfh.getStringExtra("PhotoConst.INIT_ACTIVITY_PACKAGE_NAME"), (String)localObject1);
    }
    for (;;)
    {
      paramvfh.putExtra("open_chatfragment_fromphoto", true);
      return paramvfh;
      localObject1 = paramvfh.a.jdField_b_of_type_JavaLangString;
      if (getIntent().getIntExtra("camera_type", -1) != -1)
      {
        bace.d(paramvfh.a.jdField_a_of_type_JavaLangString);
        new File(paramvfh.a.jdField_a_of_type_JavaLangString);
        bacm.a(this, paramvfh.a.jdField_a_of_type_JavaLangString);
      }
      ...
      if ("com.tencent.mobileqq.activity.aio.photo.AIOGalleryActivity".equals(str1)) {
        paramvfh.setClassName("com.tencent.mobileqq", (String)localObject1);
      }
    }
  }
  ...
  public void doOnActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    this.jdField_a_of_type_Uut.a(paramInt1, paramInt2, paramIntent);
    Object localObject2;
    Object localObject1;
    if (paramInt1 == 666)
    {
      if (paramInt2 == -1)
      {
        ...
        for (paramIntent = this.jdField_a_of_type_Uut.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams$EditSource.a();; paramIntent = ((Intent)localObject2).getStringExtra("image_path"))
        {
          if (QLog.isColorLevel()) {
          ...
          bbmy.a(this, ajjy.a(2131637884), 0).a();
          finish();
          return;
        }
        paramIntent = new EditVideoParams(this.jdField_a_of_type_Uut.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int, this.jdField_a_of_type_Uut.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.b, new EditTakePhotoSource((String)localObject1, 2, 0, 0), EditVideoParams.a(this.jdField_a_of_type_Uut.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.a()));
    ...
    for (;;)
    {
      if (paramInt1 == 1003)
      {
        ...
        this.jdField_a_of_type_Uut.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int = 1;
        this.jdField_a_of_type_Uut.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams$EditSource = new EditTakePhotoSource(paramIntent, 2, this.jdField_a_of_type_Uut.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams$EditSource.a(), this.jdField_a_of_type_Uut.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams$EditSource.b());
        this.jdField_a_of_type_Uut.g();
        return;
      }
  ...
  public void doOnBackPressed()
  {
    ...
    if (!this.jdField_a_of_type_Uut.b()) {
  ...
  {
    bedt.jdField_a_of_type_Boolean = false;
    bedt.a();
    bgxr.a();
    ...
    ahji.a("finish jump activity", ahji.a(getIntent()));
    urk.d("EditPicActivity", "doOnCreate instance=%d, video params=%s", new Object[] { Integer.valueOf(System.identityHashCode(this)), localEditVideoParams });
    ...
    {
      bbmy.a(this, ajjy.a(2131637881), 0).a();
      finish();
    }
    for (;;)
    {
      ...
      if (!bace.a(localEditVideoParams.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams$EditSource.a()))
      {
        bbmy.a(this, ajjy.a(2131637880), 0).a();
        finish();
        return true;
      }
      ...
      try
      {
        for (;;)
        {
          ...
          this.jdField_a_of_type_Uut.a(this, localEditVideoParams);
          if (this.jdField_a_of_type_Uut.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoArtFilter != null)
          {
            this.jdField_a_of_type_Uut.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoArtFilter.jdField_b_of_type_JavaLangString = getIntent().getStringExtra("FILTER_STRING");
            this.jdField_a_of_type_Uut.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoArtFilter.jdField_a_of_type_Int = getIntent().getIntExtra("FILTER_MAXSIDE", 640);
            this.jdField_a_of_type_Uut.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoArtFilter.c = getIntent().getStringExtra("FILTER_LOADING_PATH");
          }
          if ((this.jdField_a_of_type_Uut.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditPicRawImage != null) && (this.jdField_a_of_type_Uut.jdField_a_of_type_Usp != null))
          {
            ...
            paramBundle = this.jdField_a_of_type_Uut.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditPicRawImage;
            if (l1 <= 0L) {
              break label691;
            }
            bool = true;
            paramBundle.jdField_a_of_type_Boolean = bool;
            paramBundle = this.jdField_a_of_type_Uut.jdField_a_of_type_Usp;
            if (l1 <= 0L) {
              break label697;
            }
            bool = true;
          ...
          this.jdField_a_of_type_Uut.i();
          PtvTemplateManager.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface).a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_a_of_type_Awdy, false);
          if (localEditVideoParams.jdField_a_of_type_AndroidOsBundle != null) {
            urq.a(localEditVideoParams.jdField_a_of_type_AndroidOsBundle.getInt("pic_entrance_type", 0));
          }
          vfl.a(null);
          ...
          paramBundle = "3";
          urp.a("aio_shoot", "exp_edit", 0, 0, new String[] { "2", paramBundle });
          return true;
          if (j == 2) {
            ahji.i();
          }
      ...
      catch (Exception localException)
      {
        for (;;)
        {
          ...
          continue;
          label680:
          urk.e("EditPicActivity", "pic editVideoParams.mExtra is null!!");
          continue;
          label691:
          boolean bool = false;
          continue;
  ...
  public void doOnResume()
  {
    ...
    this.jdField_a_of_type_Uut.k();
    ahji.a("resume activity");
  }
  ...
  public void doOnStart()
  {
    ...
    this.jdField_a_of_type_Uut.j();
    urq.jdField_a_of_type_JavaLangString = urq.a(this.jdField_a_of_type_Uut.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int);
  ...
  {
    super.doOnStop();
    urk.c("EditPicActivity", "doOnStop");
    this.jdField_a_of_type_Uut.m();
