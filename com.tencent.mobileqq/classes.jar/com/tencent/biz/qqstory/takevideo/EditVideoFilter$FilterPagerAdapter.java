  ...
  extends PagerAdapter
{
  ...
  public Object instantiateItem(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    for (localObject1 = (FilterData.FilterPageItem)((Queue)localObject1).poll();; localObject1 = null)
    {
      ...
      ((FilterData.FilterPageItem)localObject2).jdField_a_of_type_AndroidViewView.setOnTouchListener(new ojc(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoFilter$ItemViewGestureListener));
