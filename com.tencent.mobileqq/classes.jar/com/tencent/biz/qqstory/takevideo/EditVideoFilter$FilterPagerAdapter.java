  ...
  extends PagerAdapter
{
  ...
  private final List<FilterData> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  public Object instantiateItem(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    for (localObject1 = (FilterData.FilterPageItem)((Queue)localObject1).poll();; localObject1 = null)
    {
      ...
      ((FilterData.FilterPageItem)localObject2).jdField_a_of_type_AndroidViewView.setOnTouchListener(new EditVideoFilter.ItemViewTouchEventListener(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoFilter$ItemViewGestureListener));
