  ...
  extends QIPCModule
{
  ...
  static
  {
    jdField_a_of_type_ComTencentBizQqstoryTakevideoArtfilterArtFilterModule = null;
  }
  ...
  {
    Object localObject1 = (ArtFilterManager)BaseApplicationImpl.sApplication.getRuntime().getManager(QQManagerFactory.ART_FILTER_MANAGER);
  ...
  {
    return ((ArtFilterManager)BaseApplicationImpl.sApplication.getRuntime().getManager(QQManagerFactory.ART_FILTER_MANAGER)).a();
  }
  ...
  public ArtFilterUploadProcessor a()
  {
    ...
    return new ArtFilterUploadProcessor((BaseTransFileController)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getRuntimeService(ITransFileController.class), localTransferRequest, this.jdField_a_of_type_JavaLangString);
  }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if ("action_img_preupload".equals(paramString))
    {
      ...
      a().begin(paramInt, -1, "", 0, this.jdField_a_of_type_ComTencentBizQqstoryTakevideoArtfilterFilterUploadInfo, true);
    }
    for (;;)
    {
      return null;
      if ("action_get_art_filter_path".equals(paramString))
      {
        ...
        if ((this.b != null) && (this.b.equals(str)))
        {
          if (this.jdField_a_of_type_AndroidUtilSparseArray.get(i) == null)
          {
            ...
            for (bool1 = false;; bool1 = bool2)
            {
              ...
              paramBundle.begin(paramInt, i, paramString, j, this.jdField_a_of_type_ComTencentBizQqstoryTakevideoArtfilterFilterUploadInfo, bool1);
        ...
        else
        {
          ...
          paramBundle = a();
          this.jdField_a_of_type_AndroidUtilSparseArray.put(i, paramBundle);
          paramBundle.begin(paramInt, i, paramString, j, this.jdField_a_of_type_ComTencentBizQqstoryTakevideoArtfilterFilterUploadInfo, true);
        }
      }
