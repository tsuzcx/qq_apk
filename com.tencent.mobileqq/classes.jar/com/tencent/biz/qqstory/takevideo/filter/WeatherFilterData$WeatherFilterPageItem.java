...
class WeatherFilterData$WeatherFilterPageItem
  extends FilterData.FilterPageItem<WeatherFilterData>
{
  private Context jdField_a_of_type_AndroidContentContext;
  private LinearLayout jdField_a_of_type_AndroidWidgetLinearLayout;
  
  protected WeatherFilterData$WeatherFilterPageItem(WeatherFilterData paramWeatherFilterData, @NonNull Context paramContext, ViewGroup paramViewGroup)
  {
    super(paramContext, paramViewGroup);
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131379003));
  }
  ...
  private void a(ImageView paramImageView, char paramChar)
  {
    ...
    default: 
      return;
    case '-': 
      paramImageView.setImageResource(2130847204);
      return;
    case '0': 
      paramImageView.setImageResource(2130847205);
      return;
    case '1': 
      paramImageView.setImageResource(2130847206);
      return;
    case '2': 
      paramImageView.setImageResource(2130847207);
      return;
    case '3': 
      paramImageView.setImageResource(2130847208);
      return;
    case '4': 
      paramImageView.setImageResource(2130847209);
      return;
    case '5': 
      paramImageView.setImageResource(2130847210);
      return;
    case '6': 
      paramImageView.setImageResource(2130847211);
      return;
    case '7': 
      paramImageView.setImageResource(2130847212);
      return;
    case '8': 
      paramImageView.setImageResource(2130847213);
      return;
    }
    paramImageView.setImageResource(2130847214);
  }
  
  protected View a(@NonNull Context paramContext, ViewGroup paramViewGroup)
  {
    return LayoutInflater.from(paramContext).inflate(2131562003, paramViewGroup, false);
  }
 ...
 * Qualified Name:     com.tencent.biz.qqstory.takevideo.filter.WeatherFilterData.WeatherFilterPageItem
