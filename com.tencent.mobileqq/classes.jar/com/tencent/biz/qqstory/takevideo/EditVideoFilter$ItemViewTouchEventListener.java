...
class EditVideoFilter$ItemViewTouchEventListener
  implements View.OnTouchListener
{
  ...
  public EditVideoFilter$ItemViewTouchEventListener(EditVideoFilter.ItemViewGestureListener paramItemViewGestureListener)
  {
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    if (!this.jdField_a_of_type_Boolean) {
      this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoFilter$ItemViewGestureListener.onClick(paramView);
    }
 ...
 * Qualified Name:     com.tencent.biz.qqstory.takevideo.EditVideoFilter.ItemViewTouchEventListener
