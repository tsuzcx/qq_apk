  ...
  implements Handler.Callback, View.OnLayoutChangeListener, View.OnTouchListener, Runnable
{
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if ((Math.abs(f1 - this.jdField_a_of_type_Float) < 10.0F) && (Math.abs(f2 - this.jdField_b_of_type_Float) < 10.0F) && (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.b != 12)) {
        ...
        else if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.b == 0)
        {
          this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.a(27);
        }
        else if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.b == 27)
        {
