  ...
  implements View.OnClickListener, vjk
{
  ...
  private void a()
  {
    ...
    this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131297747));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131297745));
    this.jdField_e_of_type_Boolean = bjeh.a(this.jdField_b_of_type_AndroidWidgetLinearLayout, this.jdField_a_of_type_AndroidWidgetRelativeLayout, 0);
  }
  ...
  protected void c(int paramInt1, int paramInt2)
  {
    ...
    for (String str = String.format(ajjy.a(2131640505), new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt2) });; str = String.format(ajjy.a(2131640506), new Object[] { Integer.valueOf(paramInt1) }))
    {
  ...
  public boolean doOnCreate(@Nullable Bundle paramBundle)
  {
    ...
    if (this.jdField_e_of_type_Boolean)
    {
      paramBundle = (RelativeLayout)findViewById(2131297527);
      ...
      ((RelativeLayout.LayoutParams)localObject1).topMargin = bajq.a(14.0F);
      ((RelativeLayout.LayoutParams)localObject1).leftMargin = bajq.a(12.0F);
      ((RelativeLayout.LayoutParams)localObject1).rightMargin = bajq.a(12.0F);
    ...
    for (;;)
    {
      ...
      if (QQStoryFlowCallback.a != null)
      {
        ...
        urk.b("Q.qqstory.publish.edit.LocalVideoSelectActivity", "onCreate mCoverView.setImageBitmap()");
      }
      ...
      this.jdField_a_of_type_ComTencentBizQqstoryBoundariesExtensionWidgetsTrimTextureVideoView.setOnPreparedListener(new uwm(this));
      this.jdField_a_of_type_ComTencentBizQqstoryBoundariesExtensionWidgetsTrimTextureVideoView.setOnErrorListener(new uwn(this));
  ...
  public void onClick(View paramView)
  {
    if (paramView == this.jdField_a_of_type_AndroidWidgetButton) {
      if (this.jdField_b_of_type_Boolean)
      {
        ...
        urp.a("pic_choose", "done_cutVideo", this.jdField_d_of_type_Int, 0, new String[] { this.jdField_a_of_type_JavaLangString, j + "-" + k });
        finish();
      }
    }
    while (paramView != this.jdField_a_of_type_AndroidWidgetLinearLayout)
    {
      ...
      if (i1 - n > 10000) {
        urp.a("video_edit", "edit_split", 0, 0, new String[] { String.valueOf(Math.ceil((i1 - n) / 1000.0F)) });
      }
      paramView = getIntent().getBundleExtra("bundle_extra");
      if (paramView != null)
      {
        urk.b("Q.qqstory.publish.edit.LocalVideoSelectActivity", "LocalVideoSelectActivity start edit video activity");
        vjs.a("Q.qqstory.publish.edit.LocalVideoSelectActivity", paramView);
