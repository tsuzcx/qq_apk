  ...
  implements View.OnClickListener, xkv
{
  ...
  private void a()
  {
    ...
    this.jdField_e_of_type_Boolean = bngs.a(this.jdField_b_of_type_AndroidWidgetLinearLayout, this.jdField_a_of_type_AndroidWidgetRelativeLayout, 0);
  }
  ...
  protected void c(int paramInt1, int paramInt2)
  {
    ...
    for (String str = String.format(alpo.a(2131706673), new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt2) });; str = String.format(alpo.a(2131706674), new Object[] { Integer.valueOf(paramInt1) }))
    {
  ...
  public boolean doOnCreate(@Nullable Bundle paramBundle)
  {
    ...
    if (this.jdField_e_of_type_Boolean)
    {
      ...
      ((RelativeLayout.LayoutParams)localObject1).topMargin = bdkf.a(14.0F);
      ((RelativeLayout.LayoutParams)localObject1).leftMargin = bdkf.a(12.0F);
      ((RelativeLayout.LayoutParams)localObject1).rightMargin = bdkf.a(12.0F);
    ...
    for (;;)
    {
      ...
      if (QQStoryFlowCallback.a != null)
      {
        ...
        wsv.b("Q.qqstory.publish.edit.LocalVideoSelectActivity", "onCreate mCoverView.setImageBitmap()");
      }
      ...
      this.jdField_a_of_type_ComTencentBizQqstoryBoundariesExtensionWidgetsTrimTextureVideoView.setOnPreparedListener(new wxx(this));
      this.jdField_a_of_type_ComTencentBizQqstoryBoundariesExtensionWidgetsTrimTextureVideoView.setOnErrorListener(new wxy(this));
  ...
  public void onClick(View paramView)
  {
    if (paramView == this.jdField_a_of_type_AndroidWidgetButton) {
      if (this.jdField_b_of_type_Boolean)
      {
        ...
        wta.a("pic_choose", "done_cutVideo", this.jdField_d_of_type_Int, 0, new String[] { this.jdField_a_of_type_JavaLangString, j + "-" + k });
        finish();
      }
    }
    while (paramView != this.jdField_a_of_type_AndroidWidgetLinearLayout)
    {
      ...
      if (i1 - n > 10000) {
        wta.a("video_edit", "edit_split", 0, 0, new String[] { String.valueOf(Math.ceil((i1 - n) / 1000.0F)) });
      }
      paramView = getIntent().getBundleExtra("bundle_extra");
      if (paramView != null)
      {
        wsv.b("Q.qqstory.publish.edit.LocalVideoSelectActivity", "LocalVideoSelectActivity start edit video activity");
        xld.a("Q.qqstory.publish.edit.LocalVideoSelectActivity", paramView);
