...
class EditVideoFragment$FragmentOnTouchListener
  implements View.OnTouchListener
{
  ...
  public EditVideoFragment$FragmentOnTouchListener(EditVideoFragment paramEditVideoFragment, int paramInt)
  {
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      do
      {
        for (;;)
        {
          ...
          this.g = (ScreenUtil.getInstantScreenHeight(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoFragment.a()) - paramView.getBottom());
          this.m = 0;
          this.n = 0;
          ...
          this.n = (ScreenUtil.getInstantScreenHeight(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoFragment.a()) - paramView.getBottom() - this.g);
          this.l = i3;
        }
        this.h = (i1 - this.d);
        this.i = (this.e - i2);
      ...
      if (this.k + paramView.getHeight() > ScreenUtil.getInstantScreenHeight(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoFragment.a())) {
        this.k = (ScreenUtil.getInstantScreenHeight(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoFragment.a()) - paramView.getHeight());
      }
    ...
    for (;;)
    {
      ...
      break;
      this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoFragment.a(paramView, paramView.getLeft(), ScreenUtil.getInstantScreenHeight(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoFragment.a()) - paramView.getBottom(), this.f, this.g);
 ...
 * Qualified Name:     com.tencent.biz.qqstory.takevideo.EditVideoFragment.FragmentOnTouchListener
