...
class EditVideoArtFilter$MyUIHandler
  extends Handler
{
  EditVideoArtFilter$MyUIHandler(EditVideoArtFilter paramEditVideoArtFilter) {}
  ...
  public void dispatchMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        QQToast.a(this.a.jdField_a_of_type_AndroidContentContext, this.a.jdField_a_of_type_AndroidContentContext.getResources().getString(2131690254), 0).a();
        return;
        if (QLog.isColorLevel()) {
 ...
 * Qualified Name:     com.tencent.biz.qqstory.takevideo.EditVideoArtFilter.MyUIHandler
