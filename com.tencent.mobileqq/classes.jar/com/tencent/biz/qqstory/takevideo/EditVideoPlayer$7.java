...
class EditVideoPlayer$7
  implements Runnable
{
  EditVideoPlayer$7(EditVideoPlayer paramEditVideoPlayer) {}
  ...
  public void run()
  {
    ...
    try
    {
      ((MultiBlockVideoPlayer)this.this$0.jdField_a_of_type_ComTencentMobileqqShortvideoWidgetImageViewVideoPlayer).setCurrentVideoFragment((MultiBlockVideoPlayer.RecordVideoBlockInfo)this.this$0.jdField_a_of_type_JavaUtilList.get(0));
