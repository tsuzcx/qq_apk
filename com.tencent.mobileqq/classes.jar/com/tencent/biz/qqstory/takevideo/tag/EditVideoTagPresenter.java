...
public class EditVideoTagPresenter
{
  ...
  private EditVideoTag.EditBehavior jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoTag$EditBehavior;
  private final IEditVideoTagView jdField_a_of_type_ComTencentBizQqstoryTakevideoTagIEditVideoTagView;
  ...
  {
    this.jdField_a_of_type_ComTencentBizQqstoryTakevideoTagIEditVideoTagView = paramIEditVideoTagView;
    this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager = paramEntityManager;
  }
  
  public static List<TagItem> a(EntityManager paramEntityManager)
  {
  ...
  public static void a(EntityManager paramEntityManager, List<TagItem> paramList)
  {
    try
    {
      Object localObject = a(paramEntityManager, TagItemEntry.class, TagItemEntry.class.getSimpleName(), null, null);
    ...
    while (paramList.hasNext()) {
      paramEntityManager.persistOrReplace(((TagItem)paramList.next()).a());
    }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoTag$EditBehavior = null;
  ...
  public void a(@Nonnull EditVideoTag.EditBehavior paramEditBehavior)
  {
    ...
    this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoTag$EditBehavior = paramEditBehavior;
    ...
    {
      CmdTaskManger.a().a(paramEditBehavior, new EditVideoTagPresenter.1(this));
      return;
    }
  }
  ...
  {
    if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoTag$EditBehavior != null) {
      if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoTag$EditBehavior.equals(paramEditBehavior)) {}
    }
  ...
  public void b(@Nonnull EditVideoTag.EditBehavior paramEditBehavior)
  {
    ...
    {
      CmdTaskManger.a().a(paramEditBehavior, new EditVideoTagPresenter.2(this));
      return;
    }
  }
}
 ...
 * Qualified Name:     com.tencent.biz.qqstory.takevideo.tag.EditVideoTagPresenter
