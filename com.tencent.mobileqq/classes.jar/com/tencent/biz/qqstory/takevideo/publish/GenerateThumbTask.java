...
public class GenerateThumbTask
{
  ...
  public GenerateThumbTask(int paramInt1, int paramInt2, String paramString1, float paramFloat, boolean paramBoolean1, int paramInt3, double paramDouble1, double paramDouble2, String paramString2, int paramInt4, boolean paramBoolean2)
  {
    this.d = paramInt1;
    this.e = paramInt2;
  ...
  private int a()
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        localBitmap = BitmapUtils.a(this.jdField_a_of_type_AndroidGraphicsBitmap, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, true);
        if (localBitmap != null) {
          break;
        }
      ...
      if (!BitmapUtils.a(localBitmap, this.jdField_a_of_type_JavaLangString))
      {
  ...
  private int b()
  {
    ...
    {
      SLog.e("Q.qqstory.publish.edit.GenerateThumbTask", "generateThumb, getNativeCover result is empty, vf dir = %s", new Object[] { this.jdField_b_of_type_JavaLangString });
      i = 1;
    }
    for (;;)
    {
      ...
      try
      {
        ...
        if (!new File(this.jdField_a_of_type_JavaLangString).exists())
        {
          SLog.e("Q.qqstory.publish.edit.GenerateThumbTask", "generateThumb, coverFile not exists, vf dir = %s, mThumbPath = %s", new Object[] { this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString });
          return 1;
        }
      }
      catch (UnsupportedOperationException localUnsupportedOperationException)
 ...
 * Qualified Name:     com.tencent.biz.qqstory.takevideo.publish.GenerateThumbTask
