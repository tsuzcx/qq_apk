    ...
    if ((localEditDoodleExport != null) && ((!localEditDoodleExport.a(this.jdField_a_of_type_Int)) || ((localEditFilterExport != null) && (localEditFilterExport.a(this.jdField_a_of_type_Int)))))
    {
      ...
      if (localObject != null)
      {
        ...
        else
        {
          ...
          paramJobContext = UIUtils.a((Bitmap)localObject, 360 - i);
          SLog.b("Q.qqstory.publish.edit.GenerateDoodleImageSegment", "rotate mosaic bitmap for tribe, orientation=" + i);
        }
      ...
      catch (IOException paramJobContext)
      {
        try
        {
          ...
          try
          {
            ...
            localObject = BitmapUtils.c(localBitmap, i, j, true, false);
