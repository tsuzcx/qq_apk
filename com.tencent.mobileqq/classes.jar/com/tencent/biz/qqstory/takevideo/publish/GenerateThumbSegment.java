  ...
  protected void a(JobContext paramJobContext, GenerateContext paramGenerateContext)
  {
    ...
    while (paramJobContext != null)
    {
      ...
      if (localBitmap != null)
      {
        ...
        super.notifyError(new ErrorMessage(-1, HardCodeUtil.a(2131705267) + this.jdField_a_of_type_Int));
      }
      else
      {
        ...
        super.notifyError(new ErrorMessage(-1, HardCodeUtil.a(2131705266) + this.jdField_a_of_type_Int));
        return;
      }
    }
    ...
    super.notifyError(new ErrorMessage(-1, HardCodeUtil.a(2131705270) + this.jdField_a_of_type_Int));
  }
}
