...
public class PublishFileManager
{
  ...
  public static String a(int paramInt)
  {
    ...
    if (paramInt == 1)
    {
      FileUtils.c(QQStoryConstant.e + ".nomedia");
      str = QQStoryConstant.e + b(paramInt) + "/";
    }
    for (;;)
    {
      a(str);
      return str;
      str = AppConstants.SDCARD_FILE_SAVE_TMP_PATH + "edit_video/business_" + paramInt + "/" + b(paramInt) + "/";
 ...
 * Qualified Name:     com.tencent.biz.qqstory.takevideo.publish.PublishFileManager
