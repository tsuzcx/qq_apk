  ...
  protected void a(JobContext paramJobContext, GenerateContext paramGenerateContext)
  {
    ...
    if ((str2 != null) || (str1 != null))
    {
      try
      {
        ...
        super.notifyError(new ErrorMessage(-1, HardCodeUtil.a(2131706569)));
        return;
      }
      ...
      catch (IOException localIOException)
      {
        for (;;)
        {
          try
          {
            ...
            localObject2 = BitmapUtils.b((Bitmap)localObject3, paramJobContext);
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        break;
        super.notifyError(new ErrorMessage(-1, HardCodeUtil.a(2131706568)));
        return;
        paramJobContext = null;
        break label219;
      }
