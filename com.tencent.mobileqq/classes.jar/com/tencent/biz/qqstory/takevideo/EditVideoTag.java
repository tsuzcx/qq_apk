  ...
  implements View.OnClickListener, EditVideoTagExport, IEditVideoTagView, AdapterView.OnItemClickListener
{
  ...
  private SparseArray<EditVideoTagPresenter> jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
  ...
  private void a(List<TagItem> paramList)
  {
  ...
  private void b(int paramInt)
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(HardCodeUtil.a(2131703749));
      return;
    }
  ...
  private void g()
  {
    if (this.jdField_a_of_type_AndroidViewView == null)
    {
      ...
      this.jdField_a_of_type_ComTencentBizQqstoryViewWidgetQQStoryPullToRefreshListView = ((QQStoryPullToRefreshListView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378907));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369487));
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369495));
      this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131366350);
      this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131377020);
      this.jdField_c_of_type_AndroidViewView.setOnClickListener(this);
      this.jdField_d_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131370761);
      this.e = this.jdField_a_of_type_AndroidViewView.findViewById(2131368436);
      this.f = this.jdField_a_of_type_AndroidViewView.findViewById(2131364746);
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131364745));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131365664));
      ...
      this.jdField_a_of_type_ComTencentBizQqstoryViewWidgetQQStoryPullToRefreshListView.setPullToRefreshListener(new EditVideoTag.1(this));
      this.jdField_a_of_type_ComTencentBizQqstoryViewWidgetQQStoryPullToRefreshListView.setOnScrollListener(new EditVideoTag.2(this));
  ...
  {
    super.a();
    this.jdField_a_of_type_AndroidViewViewStub = ((ViewStub)a(2131362216));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)a(2131378870));
  ...
  public void a(int paramInt, @Nonnull List<TagItem> paramList, boolean paramBoolean)
  {
  ...
  public void b(int paramInt, @Nonnull List<TagItem> paramList, boolean paramBoolean)
  {
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      k();
      EditVideoTag.EditBehavior localEditBehavior = a();
      a(this.jdField_a_of_type_Int).a(localEditBehavior);
      continue;
      this.jdField_a_of_type_ComTencentBizQqstoryTakevideoTagQQStoryTagAdapter.a(null);
      this.jdField_a_of_type_ComTencentBizQqstoryTakevideoTagQQStoryTagAdapter.notifyDataSetChanged();
      a(null, false);
