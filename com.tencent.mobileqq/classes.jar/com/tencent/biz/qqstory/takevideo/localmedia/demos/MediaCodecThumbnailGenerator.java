...
public class MediaCodecThumbnailGenerator
{
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_ComTencentBizQqstoryTakevideoLocalmediaDemosMediaCodecThumbnailGenerator$CodecHandler = new MediaCodecThumbnailGenerator.CodecHandler(this, this.jdField_a_of_type_AndroidOsHandlerThread.getLooper());
  ...
  public void a(String paramString1, String paramString2, boolean paramBoolean1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean2, Callbacks.Callback paramCallback1, Callbacks.Callback paramCallback2)
  {
    ...
    localThumbnailArgs.jdField_b_of_type_ComTencentBizQqstoryTakevideoLocalmediaBaoutilsCommonCallbacks$Callback = paramCallback1;
    localThumbnailArgs.jdField_a_of_type_ComTencentBizQqstoryTakevideoLocalmediaBaoutilsCommonCallbacks$Callback = paramCallback2;
    Message.obtain(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoLocalmediaDemosMediaCodecThumbnailGenerator$CodecHandler, 1, localThumbnailArgs).sendToTarget();
  }
 ...
 * Qualified Name:     com.tencent.biz.qqstory.takevideo.localmedia.demos.MediaCodecThumbnailGenerator
