  ...
  implements Handler.Callback
{
  ...
  {
    ulq.b("Q.qqstory.home:FeedSegment_animation", new Object[] { ajjy.a(2131645264), Float.valueOf(paramFloat1), ",bottom:", Float.valueOf(paramFloat4) });
    ...
    localViewPropertyAnimator.setListener(new uwr(this));
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    urk.b("Q.qqstory.home:FeedSegment_animation", "动画activity终于 OnCreate 了！！！");
    this.jdField_a_of_type_AndroidWidgetImageView.setScaleType(ImageView.ScaleType.CENTER_CROP);
    this.jdField_a_of_type_Uws = new uws(this);
    sgi.a().registerSubscriber(this.jdField_a_of_type_Uws);
    try
    {
  ...
  public void doOnDestroy()
  {
    ...
    if (this.jdField_a_of_type_Uws != null) {
      sgi.a().unRegisterSubscriber(this.jdField_a_of_type_Uws);
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    {
      return true;
      urk.b("Q.qqstory:QQStoryTakeVideoCloseAnimationActivity", "动画等超时了");
