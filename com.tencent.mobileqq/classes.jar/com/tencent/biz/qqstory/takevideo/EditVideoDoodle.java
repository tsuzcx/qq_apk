  ...
  implements EditDoodleExport, DoodleLayout.DoodleBtnOperationHelper, DoodleLayout.DoodleEventListener, Publishable, IEventReceiver
{
  ...
  EditVideoDoodle.DoodleEmojiDownloadEventReceiver jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoDoodle$DoodleEmojiDownloadEventReceiver;
  EditVideoDoodle.DoodleEmojiListEventReceiver jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoDoodle$DoodleEmojiListEventReceiver;
  EditVideoDoodle.DoodleEmojiPoiPostersReceiver jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoDoodle$DoodleEmojiPoiPostersReceiver;
  protected EditVideoDoodle.DoodleFacePanelAdapter a;
  private EditVideoPoiPickerCallback jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPoiPickerCallback = new EditVideoDoodle.1(this);
  DoodleEmojiManager.POIPostersRequestCallback jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleModelDoodleEmojiManager$POIPostersRequestCallback = new EditVideoDoodle.5(this);
  protected DoodleLayout a;
  private FaceListPage.FacePackagePageEventListener jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiFaceFaceListPage$FacePackagePageEventListener = new EditVideoDoodle.6(this);
  protected LocationFacePackage a;
  PtvTemplateManager.DoodleInfoLoadObserver jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$DoodleInfoLoadObserver = new EditVideoDoodle.9(this);
  ...
  private void a(int paramInt)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoDoodle$DoodleFacePanelAdapter.a(a());
  ...
  private void j()
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout == null)
    {
      ...
      this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a().setAdapter(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoDoodle$DoodleFacePanelAdapter);
      ...
      if (localObject1 != null) {
        ((DoodleEditView)localObject1).setDoodleEditViewListener(new EditVideoDoodle.2(this));
      }
      if ((this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.a.jdField_a_of_type_Int == 10) || (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.a.jdField_a_of_type_Int == 12))
      {
        ...
        if ((i == 270) || (i == 90))
        {
          ...
          this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a((int)DeviceInfoUtil.k(), (int)(DeviceInfoUtil.k() * this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.a.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams$EditSource.a() / this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.a.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams$EditSource.b()));
        }
      }
    }
    for (;;)
    {
      ...
      this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoDoodle$DoodleEmojiListEventReceiver = ((EditVideoDoodle.DoodleEmojiListEventReceiver)localObject2);
      ...
      this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoDoodle$DoodleEmojiDownloadEventReceiver = ((EditVideoDoodle.DoodleEmojiDownloadEventReceiver)localObject2);
      ((Dispatcher)localObject1).registerSubscriber((Subscriber)localObject2);
      localObject1 = StoryDispatcher.a();
      localObject2 = new EditVideoDoodle.DoodleEmojiPoiPostersReceiver(this);
      this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoDoodle$DoodleEmojiPoiPostersReceiver = ((EditVideoDoodle.DoodleEmojiPoiPostersReceiver)localObject2);
      ((Dispatcher)localObject1).registerSubscriber((Subscriber)localObject2);
      return;
      label459:
      this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout = ((DoodleLayout)a(2131365966));
      break;
      label476:
      if ((this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.a.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditLocalVideoSource))
      {
        ...
        if ((((EditLocalVideoSource)localObject1).a() * 1.0F / ((EditLocalVideoSource)localObject1).b() >= (float)DeviceInfoUtil.k() * 1.0F / (float)DeviceInfoUtil.l()) && (((EditLocalVideoSource)localObject1).a.rotation == 0))
        {
          ...
          this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a((int)DeviceInfoUtil.k(), (int)(DeviceInfoUtil.k() * this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.a.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams$EditSource.b() / this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.a.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams$EditSource.a()));
        }
  ...
  private void k()
  {
    new LocationPermissionHelper(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoUi.getActivity(), new EditVideoDoodle.3(this)).a();
  }
  ...
  @NonNull
  protected Collection<FacePackage> a()
  {
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      if (localDoodleEmojiItem.jdField_a_of_type_Int == 1)
      {
        ...
        if (("1".equals(localNormalFacePackage.jdField_a_of_type_JavaLangString)) && (!NetworkUtil.g(a()))) {
          localNormalFacePackage.jdField_a_of_type_AndroidGraphicsDrawableDrawable = a().getDrawable(2130846814);
        }
      ...
      else if (localDoodleEmojiItem.jdField_a_of_type_Int == 2)
      {
        ...
        for (;;)
        {
          ...
          break;
          this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiFaceLocationFacePackage.jdField_a_of_type_AndroidGraphicsDrawableDrawable = a().getDrawable(2130846957);
        }
      }
    }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoDoodle$DoodleFacePanelAdapter = new EditVideoDoodle.DoodleFacePanelAdapter(null);
  ...
  public void b(int paramInt1, int paramInt2)
  {
    ...
    QQToast.a(a(), HardCodeUtil.a(2131703743), 0).a();
  }
  ...
  public void d()
  {
    if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoDoodle$DoodleEmojiListEventReceiver != null) {
      StoryDispatcher.a().unRegisterSubscriber(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoDoodle$DoodleEmojiListEventReceiver);
    }
    if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoDoodle$DoodleEmojiDownloadEventReceiver != null) {
      StoryDispatcher.a().unRegisterSubscriber(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoDoodle$DoodleEmojiDownloadEventReceiver);
    }
    if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoDoodle$DoodleEmojiPoiPostersReceiver != null) {
      StoryDispatcher.a().unRegisterSubscriber(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoDoodle$DoodleEmojiPoiPostersReceiver);
    }
    if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout != null)
    {
    ...
    this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoDoodle$DoodleFacePanelAdapter = null;
  ...
  public void g()
  {
    this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoUi.a().postDelayed(new EditVideoDoodle.7(this), 200L);
  }
  ...
  public boolean g_()
  {
    if ((EditVideoPartManager.a(this.jdField_b_of_type_Int, 4)) && (TextUtils.isEmpty(a().a(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.a()))))
    {
      ...
      {
        return true;
        if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_b_of_type_Int == 0)
        {
          this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.a(27);
          return true;
        }
      } while (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_b_of_type_Int != 27);
      this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.a(0);
      return true;
    }
    return false;
