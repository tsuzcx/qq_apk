...
{
  public static final Parcelable.Creator<SlideItemInfo> CREATOR = new vgw();
  public int a;
  public long a;
  ...
  public SlideItemInfo(LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    try
    {
      ...
      this.jdField_b_of_type_Int = baaf.a(paramLocalMediaInfo);
      ...
      case 0: 
        ...
        this.jdField_a_of_type_JavaNetURL = baaf.a(paramLocalMediaInfo);
    ...
    for (this.jdField_a_of_type_JavaNetURL = baaf.a(paramLocalMediaInfo, "VIDEO");; this.jdField_a_of_type_JavaNetURL = baaf.a(paramLocalMediaInfo, "APP_VIDEO"))
    {
