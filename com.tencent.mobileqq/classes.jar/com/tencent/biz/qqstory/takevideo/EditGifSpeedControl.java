  ...
  implements View.OnClickListener
{
  ...
  public void a()
  {
    ...
    g();
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)a(2131377702));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)a(2131377697));
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)a(2131377698));
    this.jdField_b_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetSeekBar = ((SeekBar)a(2131367924));
    ...
    this.jdField_a_of_type_AndroidWidgetSeekBar.setOnSeekBarChangeListener(new EditGifSpeedControl.1(this));
  }
  ...
  public void a(int paramInt, Object paramObject)
  {
    ...
    if (this.e == -1)
    {
      if (!this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.a.jdField_a_of_type_Boolean) {
        break label193;
      }
      paramInt = (int)this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.a.jdField_a_of_type_CooperationQzoneWidgetFastAnimationDrawable.getDuration();
      this.e = paramInt;
      this.c = paramInt;
    }
  ...
  public void a(@NonNull GenerateContext paramGenerateContext)
  {
    if (this.e == -1) {
      if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.a.jdField_a_of_type_Boolean)
      {
        paramGenerateContext.a.jdField_b_of_type_Int = ((int)this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.a.jdField_a_of_type_CooperationQzoneWidgetFastAnimationDrawable.getDuration());
  ...
  public boolean a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_b_of_type_Int == 21)
    {
      ...
      if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.a.jdField_a_of_type_CooperationQzoneWidgetFastAnimationDrawable != null) {
        this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.a.jdField_a_of_type_CooperationQzoneWidgetFastAnimationDrawable.setDuration(NativeGifImage.QZONE_DELAY);
      }
      this.e = this.c;
 ...
 * Qualified Name:     com.tencent.biz.qqstory.takevideo.EditGifSpeedControl
