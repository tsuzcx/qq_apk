  ...
  implements View.OnClickListener
{
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetSeekBar.setOnSeekBarChangeListener(new obc(this));
  }
  ...
  public void a(int paramInt, Object paramObject)
  {
    ...
    if (this.e == -1)
    {
      ...
      paramInt = (int)this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.a.jdField_a_of_type_CooperationQzoneWidgetFastAnimationDrawable.a();
      this.e = paramInt;
      this.c = paramInt;
    }
  ...
  public void a(@NonNull GenerateContext paramGenerateContext)
  {
    if (this.e == -1) {
      if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.a.jdField_a_of_type_Boolean)
      {
        paramGenerateContext.a.jdField_b_of_type_Int = ((int)this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.a.jdField_a_of_type_CooperationQzoneWidgetFastAnimationDrawable.a());
  ...
  public boolean a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.f == 21)
    {
      ...
      if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.a.jdField_a_of_type_CooperationQzoneWidgetFastAnimationDrawable != null) {
        this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.a.jdField_a_of_type_CooperationQzoneWidgetFastAnimationDrawable.a(NativeGifImage.QZONE_DELAY);
      }
      this.e = this.c;
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131371614: 
      do
      {
        return;
        this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
      } while (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.f != 21);
      this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.a(0);
      return;
    }
    a();
