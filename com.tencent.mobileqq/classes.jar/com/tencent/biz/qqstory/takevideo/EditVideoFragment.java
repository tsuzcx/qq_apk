  ...
  extends EditVideoPart
{
  ...
  private EditVideoFragment.ProcessThumbBitmapUtil jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoFragment$ProcessThumbBitmapUtil;
  protected ElasticImageView a;
  private List<EditVideoFragment.VideoFragmentDisplayInfo> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  static
  {
    jdField_a_of_type_ArrayOfInt = new int[] { 2131367449, 2131367450, 2131367451, 2131367452, 2131367453, 2131367454 };
    jdField_b_of_type_ArrayOfInt = new int[] { 2131367431, 2131367432, 2131367433, 2131367434, 2131367435, 2131367436 };
  }
  ...
  private void a(List<? extends VideoFragmentInfo> paramList)
  {
    int i;
    int j;
    if (paramList == null)
    ...
    for (;;)
    {
      ...
      if (i == 1)
      {
        this.jdField_a_of_type_JavaUtilList.add(new EditVideoFragment.VideoFragmentDisplayInfo((VideoFragmentInfo)paramList.get(0), null, null));
        return;
      }
      ...
      for (Object localObject = "0";; localObject = "1")
      {
        ...
        if ((this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.a.d()) && ((this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.a.a instanceof EditLocalVideoSource)))
        {
          localObject = (EditLocalVideoSource)this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.a.a;
        ...
        m = AIOUtils.a(2.0F, a());
        k = (ScreenUtil.SCREEN_WIDTH - j * 2 - k * 5) / 6 - m * 2;
        m = k * 8 / 5;
      ...
      {
        this.jdField_a_of_type_JavaUtilList.add(new EditVideoFragment.VideoFragmentDisplayInfo(localVideoFragmentInfo, (Bitmap)localObject, null));
        break;
      }
    }
  }
  
  private void a(List<? extends VideoFragmentInfo> paramList, boolean paramBoolean)
  {
    int j = 0;
    if (paramList == null)
    {
    ...
    if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoFragment$ProcessThumbBitmapUtil == null) {
      this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoFragment$ProcessThumbBitmapUtil = new EditVideoFragment.ProcessThumbBitmapUtil(this);
    }
    int i;
    if (paramBoolean)
    {
    ...
    for (;;)
    {
      ...
      } while (((EditVideoFragment.VideoFragmentDisplayInfo)this.jdField_a_of_type_JavaUtilList.get(j)).jdField_c_of_type_Int != this.jdField_b_of_type_Int);
      SLog.b("Q.qqstory.record.EditVideoFragment", "update the %d fragment's thumb.", Integer.valueOf(j));
      this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoFragment$ProcessThumbBitmapUtil.a((VideoFragmentInfo)paramList.get(i), (EditVideoFragment.VideoFragmentDisplayInfo)this.jdField_a_of_type_JavaUtilList.get(j));
      return;
      i = 0;
      while (i < paramList.size())
      {
        ...
        if (j < this.jdField_a_of_type_JavaUtilList.size())
        {
          ...
          while (((VideoFragmentInfo)paramList.get(i)).jdField_c_of_type_Int != ((EditVideoFragment.VideoFragmentDisplayInfo)this.jdField_a_of_type_JavaUtilList.get(j)).jdField_c_of_type_Int)
          {
            j += 1;
            break;
          }
  ...
  private void b(List<EditVideoFragment.VideoFragmentDisplayInfo> paramList)
  {
    int j = 0;
    if (paramList == null) {}
    ...
    {
      this.jdField_a_of_type_AndroidViewViewStub = ((ViewStub)a(2131367442));
      this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewViewStub.inflate());
    }
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131377418));
    this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiWidgetElasticImageView = ((ElasticImageView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131369798));
  ...
  private void c(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        if (paramInt == ((EditVideoFragment.VideoFragmentDisplayInfo)this.jdField_a_of_type_JavaUtilList.get(i)).jdField_c_of_type_Int)
        {
          ...
          ((EditVideoFragment.VideoFragmentDisplayInfo)this.jdField_a_of_type_JavaUtilList.get(i)).a = this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoFragment$ProcessThumbBitmapUtil.a(paramInt);
        }
      }
      else {
        return;
  ...
  private void c(List<EditVideoFragment.VideoFragmentDisplayInfo> paramList)
  {
    if (paramList == null) {}
    for (int i = 0; (i < 2) || (i > 6); i = paramList.size())
    {
    ...
    int n = (ScreenUtil.SCREEN_WIDTH - k * 2 - m * 5) / 6;
  ...
  private void d(List<EditVideoFragment.VideoFragmentDisplayInfo> paramList)
  {
    int j = 0;
    ...
    for (;;)
    {
      ...
      while (i < paramList.size())
      {
        this.jdField_a_of_type_ArrayOfAndroidWidgetRelativeLayout[i].setOnTouchListener(new EditVideoFragment.FragmentOnTouchListener(this, i));
        i += 1;
      }
    }
  }
  
  private void e(List<EditVideoFragment.VideoFragmentDisplayInfo> paramList)
  {
    if (!this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())
    {
    ...
    if (i < this.jdField_a_of_type_ArrayOfAndroidWidgetRelativeLayout.length)
    {
      ...
      this.jdField_a_of_type_ArrayOfAndroidWidgetImageView[i].setBackgroundDrawable(new BitmapDrawable(((EditVideoFragment.VideoFragmentDisplayInfo)paramList.get(i)).b));
      this.jdField_a_of_type_ArrayOfAndroidWidgetImageView[i].setImageBitmap(((EditVideoFragment.VideoFragmentDisplayInfo)paramList.get(i)).a);
  ...
  protected void a(int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_Int == ((EditVideoFragment.VideoFragmentDisplayInfo)this.jdField_a_of_type_JavaUtilList.get(paramInt)).jdField_c_of_type_Int) && (!this.jdField_a_of_type_Boolean))
    {
    ...
    {
      if (i == paramInt) {
        this.jdField_a_of_type_ArrayOfAndroidWidgetRelativeLayout[i].setBackgroundResource(2130847224);
      }
      for (;;)
      {
        i += 1;
    ...
    this.jdField_a_of_type_Int = ((EditVideoFragment.VideoFragmentDisplayInfo)this.jdField_a_of_type_JavaUtilList.get(paramInt)).jdField_c_of_type_Int;
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.a(Message.obtain(null, 6, this.jdField_b_of_type_Int, this.jdField_a_of_type_Int));
  ...
  protected void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.a(Message.obtain(null, 7, paramInt2, 0));
  ...
  public void a(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    localValueAnimator.addListener(new EditVideoFragment.1(this, paramView));
    localValueAnimator.addUpdateListener(new EditVideoFragment.2(this, paramInt3, paramInt1, paramInt4, paramInt2, paramView));
 ...
 * Qualified Name:     com.tencent.biz.qqstory.takevideo.EditVideoFragment
