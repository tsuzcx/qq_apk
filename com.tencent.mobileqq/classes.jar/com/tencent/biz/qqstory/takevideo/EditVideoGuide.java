  ...
  implements View.OnClickListener
{
  ...
  private boolean a(int paramInt)
  {
    ...
    default: 
      ...
      return false;
    case 1: 
      this.jdField_a_of_type_AndroidWidgetTextView.setText(HardCodeUtil.a(2131703856));
    ...
    for (;;)
    {
      ...
      return true;
      this.jdField_a_of_type_AndroidWidgetTextView.setText(HardCodeUtil.a(2131703943));
      ...
      paramInt -= k;
      continue;
      this.jdField_a_of_type_AndroidWidgetTextView.setText(HardCodeUtil.a(2131703882));
      this.jdField_a_of_type_AndroidWidgetTextView.measure(i, k);
      i = this.jdField_a_of_type_AndroidWidgetTextView.getMeasuredWidth();
      ...
      paramInt -= k;
      continue;
      this.jdField_a_of_type_AndroidWidgetTextView.setText(HardCodeUtil.a(2131703884));
      this.jdField_a_of_type_AndroidWidgetTextView.measure(i, k);
      i = this.jdField_a_of_type_AndroidWidgetTextView.getMeasuredWidth();
      paramInt = AIOUtils.a(114.0F, a().getResources());
      k = i / 2;
      ...
      paramInt -= k;
      continue;
      this.jdField_a_of_type_AndroidWidgetTextView.setText(HardCodeUtil.a(2131703872));
  ...
  private void j()
  {
    ...
    localTranslateAnimation.setAnimationListener(new EditVideoGuide.3(this));
  }
  ...
  {
    super.a();
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)a(2131375102));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)a(2131375103));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)a(2131375104));
              ...
              do
              {
                do
                {
                  do
                  {
                    ...
                    localStoryAddDescribeGuideDialog.a(HardCodeUtil.a(2131703886));
                    localStoryAddDescribeGuideDialog.show();
                    localStoryAddDescribeGuideDialog.setOnDismissListener(new EditVideoGuide.1(this));
                    ...
                    paramObject.a(HardCodeUtil.a(2131703931));
                  } while (((Activity)a()).isFinishing());
                  paramObject.show();
                  paramObject.setOnDismissListener(new EditVideoGuide.2(this));
