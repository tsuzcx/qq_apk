  ...
  implements View.OnClickListener
{
  ...
  public EditVideoGuide(@NonNull vhm paramvhm)
  {
    super(paramvhm);
  ...
  private boolean a(int paramInt)
  {
    ...
    default: 
      ...
      return false;
    case 1: 
      this.jdField_a_of_type_AndroidWidgetTextView.setText(ajya.a(2131703837));
    ...
    for (;;)
    {
      ...
      return true;
      this.jdField_a_of_type_AndroidWidgetTextView.setText(ajya.a(2131703925));
      ...
      paramInt -= k;
      continue;
      this.jdField_a_of_type_AndroidWidgetTextView.setText(ajya.a(2131703863));
      this.jdField_a_of_type_AndroidWidgetTextView.measure(i, k);
      i = this.jdField_a_of_type_AndroidWidgetTextView.getMeasuredWidth();
      ...
      paramInt -= k;
      continue;
      this.jdField_a_of_type_AndroidWidgetTextView.setText(ajya.a(2131703865));
      this.jdField_a_of_type_AndroidWidgetTextView.measure(i, k);
      i = this.jdField_a_of_type_AndroidWidgetTextView.getMeasuredWidth();
      paramInt = actj.a(114.0F, a().getResources());
      k = i / 2;
      ...
      paramInt -= k;
      continue;
      this.jdField_a_of_type_AndroidWidgetTextView.setText(ajya.a(2131703853));
      paramInt = actj.a(15.0F, a());
      k = actj.a(12.0F, a());
      i = actj.a(12.0F, a());
      k = (axlk.jdField_a_of_type_Int - paramInt * 2 - k * 5) / 6;
  ...
  private void j()
  {
    ...
    localTranslateAnimation.setAnimationListener(new vhc(this));
  }
            ...
            do
            {
              do
              {
                do
                {
                  ...
                  {
                    return;
                    wdo localwdo = new wdo(this.jdField_a_of_type_Vix.a());
                    localwdo.a(ajya.a(2131703867));
                    localwdo.show();
                    localwdo.setOnDismissListener(new vha(this));
                    paramObject.b("has_show_basal_guide", Boolean.valueOf(true));
                    vei.a("video_edit", "guide_txt", 0, 0, new String[0]);
                    return;
                    paramObject = new wbw(this.jdField_a_of_type_Vix.a());
                    paramObject.a(ajya.a(2131703912));
                  } while (((Activity)a()).isFinishing());
                  paramObject.show();
                  paramObject.setOnDismissListener(new vhb(this));
  ...
  public boolean a(Message paramMessage)
  {
    ...
    for (paramMessage = paramMessage.a();; paramMessage = null)
    {
      ...
      if (paramMessage == null)
      {
        i = 0;
        int j = i;
        if (i > this.jdField_a_of_type_Vhm.a.c()) {
  ...
  protected void f()
  {
    ...
    default: 
      return;
    case 7: 
      this.jdField_a_of_type_Vhm.a(24);
      return;
    case 1: 
      this.jdField_a_of_type_Vhm.a(13);
      return;
    case 4: 
      this.jdField_a_of_type_Vhm.a(15);
      return;
    case 5: 
      this.jdField_a_of_type_Vhm.a(16);
      return;
    }
    this.jdField_a_of_type_Vhm.a(17);
  }
