...
public class ComplexPart$Group
{
  ...
  @NonNull
  private final List<ComplexPart.Friend> jdField_a_of_type_JavaUtilList;
  private boolean jdField_a_of_type_Boolean;
  @NonNull
  private final List<ComplexPart.Friend> b = new ArrayList();
  
  public ComplexPart$Group(@NonNull Groups paramGroups, @NonNull List<ComplexPart.Friend> paramList)
  {
  ...
  @NonNull
  public List<ComplexPart.Friend> b()
  {
 ...
 * Qualified Name:     com.tencent.biz.qqstory.takevideo.permission.ComplexPart.Group
