  ...
  extends PermissionPart
{
  ...
  public EmptyPart(Context paramContext, String paramString, int paramInt)
  {
  ...
  public View a(int paramInt, ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup.setBackgroundResource(2130850506);
    paramInt = -2170912;
    QQStoryContext.a();
    ...
    Object localObject = new RelativeLayout.LayoutParams(-1, UIUtils.a(this.a, 1.0F));
    ((RelativeLayout.LayoutParams)localObject).addRule(10);
    localView.setLayoutParams((ViewGroup.LayoutParams)localObject);
    localView.setBackgroundColor(paramInt);
    localObject = new View(this.a);
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, UIUtils.a(this.a, 1.0F));
 ...
 * Qualified Name:     com.tencent.biz.qqstory.takevideo.permission.EmptyPart
