  ...
  extends QQStoryBaseActivity
{
  ...
  private ComplexPart.Group a(Groups paramGroups, List<Friends> paramList, @NonNull List<String> paramList1)
  {
  ...
  private void a(int paramInt, List<String> paramList)
  {
    ...
    Object localObject1 = ((QQStoryManager)this.app.getManager(QQManagerFactory.QQSTORY_MANAGER)).a(true);
    ...
    Object localObject5 = (FriendsManager)this.app.getManager(QQManagerFactory.FRIENDS_MANAGER);
    ...
    localObject5 = new SinglePart(this, getString(2131699264), 10004);
    ((SinglePart)localObject5).c(true);
    localObject6 = new SinglePart(this, getString(2131699260), 10000);
    ((SinglePart)localObject6).c(true);
    Object localObject7 = new SinglePart(this, getString(2131699261), 10001);
    ...
    localObject3 = new ComplexPart(this, getString(2131699263), 10002, (List)localObject3, this.app);
    localObject2 = new ComplexPart(this, getString(2131699262), 10003, (List)localObject2, this.app);
    switch (paramInt)
    {
    }
    for (;;)
  ...
  private void a(@Nonnull PermissionPart paramPermissionPart)
  {
    ...
    for (;;)
    {
      ...
      if (paramPermissionPart.isEmpty())
      {
        ...
        QQToast.a(this, HardCodeUtil.a(2131707914), 0).a();
        return;
      }
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    setContentView(2131561901);
    super.setTitle(HardCodeUtil.a(2131707909));
    this.rightViewImg.setVisibility(8);
    this.rightViewText.setVisibility(0);
    this.rightViewText.setText(HardCodeUtil.a(2131707920));
    this.rightViewText.setContentDescription(HardCodeUtil.a(2131707916));
    this.rightViewText.setOnClickListener(new PermissionSettingActivity.1(this));
    ...
    {
      this.jdField_a_of_type_AndroidWidgetListView = ((ListView)findViewById(2131372874));
      a(i, paramBundle);
      ((ViewGroup)this.jdField_a_of_type_AndroidWidgetListView.getParent()).setBackgroundColor(getResources().getColor(2131167093));
