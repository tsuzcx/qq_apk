  ...
  implements View.OnTouchListener, StrokePicker.OnStrokeDrawableSelectedListener
{
  ...
  private SelectStrokeLayout.StrokeLayoutListener jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarSelectStrokeLayout$StrokeLayoutListener;
  private StrokePicker jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarStrokePicker;
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarStrokePicker.getLayoutParams().width = this.f;
    this.jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarStrokePicker.setPadding(this.h, 0, this.h, 0);
    if (this.e > this.c) {}
    for (int k = this.e;; k = this.c)
    {
      ...
      ((RelativeLayout.LayoutParams)this.jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarStrokePicker.getLayoutParams()).topMargin = this.jdField_a_of_type_Int;
      ((RelativeLayout.LayoutParams)this.jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarStrokePicker.getLayoutParams()).bottomMargin = this.jdField_b_of_type_Int;
  ...
  {
    Stroke localStroke = this.jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarStrokePicker.a(paramFloat);
    if (localStroke != null)
    {
  ...
  public void a(@NonNull MotionEvent paramMotionEvent, @Nullable Drawable paramDrawable1, @Nullable Drawable paramDrawable2, @NonNull Stroke paramStroke)
  {
    ...
    for (;;)
    {
      ...
      {
        f2 = f1;
        if (f1 > this.jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarStrokePicker.getHeight()) {
          f2 = this.jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarStrokePicker.getHeight();
        }
      }
      f1 = f2;
      if (!this.jdField_b_of_type_Boolean)
      {
        f1 = f2;
        if (f2 > this.jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarStrokePicker.getHeight() - this.c / 2) {
          f1 = this.jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarStrokePicker.getHeight() - this.c / 2;
        }
      }
      ...
      for (;;)
      {
        ...
        a(paramStroke);
        this.j = ((int)f1);
        if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarSelectStrokeLayout$StrokeLayoutListener == null) {
          break;
        }
        this.jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarSelectStrokeLayout$StrokeLayoutListener.a(paramMotionEvent, paramStroke);
        return;
  ...
  {
    super.onMeasure(paramInt1, View.MeasureSpec.makeMeasureSpec(this.jdField_a_of_type_Int * 2 + this.jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarStrokePicker.a(), 1073741824));
  }
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarStrokePicker.a(paramView);
      paramView.recycle();
      return true;
  ...
  {
    Object localObject = this.jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarStrokePicker.a();
  ...
  {
    this.jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarSelectStrokeLayout$StrokeLayoutListener = paramStrokeLayoutListener;
  }
  ...
  public void setStrokeStrategy(StrokeStrategy paramStrokeStrategy)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarStrokePicker.a(paramStrokeStrategy);
      Object localObject = this.jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarStrokePicker.a();
      a(0.0F);
      if (!((List)localObject).isEmpty())
      {
 ...
 * Qualified Name:     com.tencent.biz.qqstory.takevideo.view.widget.colorbar.SelectStrokeLayout
