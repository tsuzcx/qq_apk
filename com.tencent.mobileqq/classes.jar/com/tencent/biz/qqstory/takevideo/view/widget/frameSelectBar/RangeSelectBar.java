  ...
  extends View
{
  ...
  private void a()
  {
    this.l = bhgr.a(getContext(), ScrollFrameSelectBar.jdField_a_of_type_Int);
    this.g = zps.a(getContext());
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      yuk.a("Q.qqstory.frameWidget.RangeSelectBar", "ACTION_DOWN x=%s,y=%s,mstart=%s,end=%s", Float.valueOf(f1), Float.valueOf(f2), Integer.valueOf(this.h), Integer.valueOf(this.i));
      ...
      yuk.b("Q.qqstory.frameWidget.RangeSelectBar", "没有触摸到");
      continue;
      ...
      if (this.jdField_a_of_type_Boolean) {
        ...
        {
          yuk.b("Q.qqstory.frameWidget.RangeSelectBar", "mStartIndex不能再截取小于1s的视频");
      ...
      for (;;)
      {
        ...
        {
          yuk.b("Q.qqstory.frameWidget.RangeSelectBar", "向左边边滑动");
          this.h = this.j;
          invalidate();
        }
        else
        {
          ...
          if (this.jdField_b_of_type_Boolean) {
            ...
            {
              yuk.b("Q.qqstory.frameWidget.RangeSelectBar", "mEndIndex不能再截取小于1s的视频");
            ...
            {
              this.i = this.k;
              yuk.b("Q.qqstory.frameWidget.RangeSelectBar", "向右边边滑动");
              invalidate();
            }
            else
            {
      ...
      yuk.b("Q.qqstory.frameWidget.RangeSelectBar", "ACTION_UP");
      if ((this.jdField_a_of_type_Boolean) || (this.jdField_b_of_type_Boolean))
      {
        this.jdField_a_of_type_Boolean = false;
        this.jdField_b_of_type_Boolean = false;
        if (this.jdField_a_of_type_Zmi != null) {
          this.jdField_a_of_type_Zmi.a(this.h - 20, this.i - 20);
        }
        return true;
      }
      this.jdField_a_of_type_Boolean = false;
      this.jdField_b_of_type_Boolean = false;
      continue;
      yuk.b("Q.qqstory.frameWidget.RangeSelectBar", "ACTION_CANCEL");
      if ((this.jdField_a_of_type_Boolean) || (this.jdField_b_of_type_Boolean))
      {
        this.jdField_a_of_type_Boolean = false;
        this.jdField_b_of_type_Boolean = false;
  ...
  public void setFrameSize(int paramInt1, int paramInt2, int paramInt3, float paramFloat1, float paramFloat2)
  {
    ...
    for (int n = 100;; n = this.l)
    {
      ...
      Bitmap localBitmap1 = zps.a(getContext().getResources(), 2130849159, this.l / 2, paramInt1 / 2);
      Bitmap localBitmap2 = zps.a(getContext().getResources(), 2130849161, this.l / 2, paramInt1 / 2);
      ...
      localGradientDrawable.setStroke(bhgr.a(getContext(), 3.0F), this.m);
  ...
  public void setRangeChangeListener(zmi paramzmi)
  {
