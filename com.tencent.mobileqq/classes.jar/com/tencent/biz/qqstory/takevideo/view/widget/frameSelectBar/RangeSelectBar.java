  ...
  extends View
{
  ...
  public void setFrameSize(int paramInt1, int paramInt2, int paramInt3, float paramFloat)
  {
    ...
    Bitmap localBitmap1 = UIUtils.a(getContext().getResources(), 2130845351, this.l / 2, paramInt1 / 2);
    Bitmap localBitmap2 = UIUtils.a(getContext().getResources(), 2130845353, this.l / 2, paramInt1 / 2);
