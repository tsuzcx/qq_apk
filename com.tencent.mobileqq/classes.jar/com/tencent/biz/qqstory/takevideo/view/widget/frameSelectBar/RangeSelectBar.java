  ...
  extends View
{
  ...
  private zin jdField_a_of_type_Zin;
  ...
  private void a()
  {
    this.l = bggq.a(getContext(), ScrollFrameSelectBar.jdField_a_of_type_Int);
    this.g = zlx.a(getContext());
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      yqp.a("Q.qqstory.frameWidget.RangeSelectBar", "ACTION_DOWN x=%s,y=%s,mstart=%s,end=%s", Float.valueOf(f1), Float.valueOf(f2), Integer.valueOf(this.h), Integer.valueOf(this.i));
      ...
      yqp.b("Q.qqstory.frameWidget.RangeSelectBar", "没有触摸到");
      continue;
      ...
      if (this.jdField_a_of_type_Boolean) {
        ...
        {
          yqp.b("Q.qqstory.frameWidget.RangeSelectBar", "mStartIndex不能再截取小于1s的视频");
      ...
      for (;;)
      {
        if (this.jdField_a_of_type_Zin != null) {
          this.jdField_a_of_type_Zin.a();
        }
        return true;
        if (paramMotionEvent.getX() <= this.j)
        {
          yqp.b("Q.qqstory.frameWidget.RangeSelectBar", "向左边边滑动");
          this.h = this.j;
          invalidate();
        }
        else
        {
          ...
          if (this.jdField_b_of_type_Boolean) {
            ...
            {
              yqp.b("Q.qqstory.frameWidget.RangeSelectBar", "mEndIndex不能再截取小于1s的视频");
            ...
            {
              this.i = this.k;
              yqp.b("Q.qqstory.frameWidget.RangeSelectBar", "向右边边滑动");
              invalidate();
            }
            else
            {
      ...
      yqp.b("Q.qqstory.frameWidget.RangeSelectBar", "ACTION_UP");
      if ((this.jdField_a_of_type_Boolean) || (this.jdField_b_of_type_Boolean))
      {
        this.jdField_a_of_type_Boolean = false;
        this.jdField_b_of_type_Boolean = false;
        if (this.jdField_a_of_type_Zin != null) {
          this.jdField_a_of_type_Zin.a(this.h - 20, this.i - 20);
        }
        return true;
      }
      this.jdField_a_of_type_Boolean = false;
      this.jdField_b_of_type_Boolean = false;
      continue;
      yqp.b("Q.qqstory.frameWidget.RangeSelectBar", "ACTION_CANCEL");
      if ((this.jdField_a_of_type_Boolean) || (this.jdField_b_of_type_Boolean))
      {
        this.jdField_a_of_type_Boolean = false;
        this.jdField_b_of_type_Boolean = false;
  ...
  public void setFrameSize(int paramInt1, int paramInt2, int paramInt3, float paramFloat1, float paramFloat2)
  {
    ...
    for (int n = 100;; n = this.l)
    {
      ...
      Bitmap localBitmap1 = zlx.a(getContext().getResources(), 2130849140, this.l / 2, paramInt1 / 2);
      Bitmap localBitmap2 = zlx.a(getContext().getResources(), 2130849142, this.l / 2, paramInt1 / 2);
      ...
      localGradientDrawable.setStroke(bggq.a(getContext(), 3.0F), this.m);
  ...
  public void setRangeChangeListener(zin paramzin)
  {
    this.jdField_a_of_type_Zin = paramzin;
  }
