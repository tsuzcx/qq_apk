...
class DanceMachineUploadVideoFragment$1
  extends MessageObserver
{
  DanceMachineUploadVideoFragment$1(DanceMachineUploadVideoFragment paramDanceMachineUploadVideoFragment) {}
  
  public void onDanceMachineUploaded(MessageForDanceMachine paramMessageForDanceMachine)
  {
    super.onDanceMachineUploaded(paramMessageForDanceMachine);
    ...
    if (paramMessageForDanceMachine.errorCode == 0)
    {
      ...
      localIntent.putExtra("current_uin", this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin());
 ...
 * Qualified Name:     com.tencent.biz.qqstory.takevideo.DanceMachineUploadVideoFragment.1
