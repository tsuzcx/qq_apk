...
class EditVideoMusicDialog$2
  extends Handler
{
  EditVideoMusicDialog$2(EditVideoMusicDialog paramEditVideoMusicDialog) {}
  ...
  public void handleMessage(Message paramMessage)
  {
      ...
      do
      {
        do
        {
          do
          {
            ...
            {
              this.a.jdField_a_of_type_ComTencentBizQqstoryTakevideoMusicMusicGridAdapter.a(this.a.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoMusic.a);
    ...
    case 3: 
      ...
      this.a.jdField_b_of_type_AndroidWidgetTextView.setText(HardCodeUtil.a(2131703745));
      this.a.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
      this.a.jdField_a_of_type_AndroidViewView.setVisibility(8);
      this.a.a(true);
      return;
    case 6: 
      if ((this.a.c) && (this.a.jdField_a_of_type_ComTencentBizQqstoryTakevideoMusicBlessVoiceChangeManager != null)) {
      ...
      this.a.jdField_a_of_type_AndroidWidgetTextView.setText("");
      this.a.jdField_b_of_type_AndroidWidgetTextView.setText(HardCodeUtil.a(2131703868));
      this.a.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
      this.a.jdField_a_of_type_AndroidViewView.setVisibility(8);
      this.a.a(true);
      return;
    ...
    case 10: 
      ...
      this.a.jdField_a_of_type_AndroidWidgetTextView.setText("");
      this.a.jdField_b_of_type_AndroidWidgetTextView.setText(HardCodeUtil.a(2131703783) + paramMessage.jdField_b_of_type_JavaLangString);
      this.a.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
      this.a.jdField_a_of_type_AndroidViewView.setVisibility(8);
      this.a.a(true);
      return;
 ...
 * Qualified Name:     com.tencent.biz.qqstory.takevideo.music.EditVideoMusicDialog.2
