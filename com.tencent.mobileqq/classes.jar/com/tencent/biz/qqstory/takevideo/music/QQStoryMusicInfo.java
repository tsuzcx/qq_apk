...
public class QQStoryMusicInfo
{
  ...
  static
  {
    jdField_a_of_type_ComTencentBizQqstoryTakevideoMusicQQStoryMusicInfo = new QQStoryMusicInfo(0, "静音");
    jdField_b_of_type_ComTencentBizQqstoryTakevideoMusicQQStoryMusicInfo = new QQStoryMusicInfo(1, "视频原声");
  ...
  public static final ArrayList a(Context paramContext)
  {
    ...
    //   0: aload_0
    //   1: ldc 133
    //   3: invokestatic 138	com/tencent/mobileqq/util/SharePreferenceUtils:a	(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    //   6: astore_0
    //   7: new 140	org/json/JSONArray
    //   10: dup
    //   11: aload_0
    //   12: invokespecial 141	org/json/JSONArray:<init>	(Ljava/lang/String;)V
    //   15: astore 4
    //   17: aload 4
    //   19: invokevirtual 144	org/json/JSONArray:length	()I
    //   22: istore_2
    //   23: new 146	java/util/ArrayList
    //   26: dup
    //   27: iload_2
    //   28: invokespecial 149	java/util/ArrayList:<init>	(I)V
    //   31: astore_0
    //   32: iconst_0
    //   33: istore_1
    //   34: aload_0
    ...
    //   46: aload 4
    //   48: iload_1
    //   49: invokevirtual 151	org/json/JSONArray:optString	(I)Ljava/lang/String;
    //   52: invokespecial 152	com/tencent/biz/qqstory/takevideo/music/QQStoryMusicInfo:<init>	(Ljava/lang/String;)V
    //   55: invokevirtual 156	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   58: pop
    //   59: iload_1
    //   60: iconst_1
    //   61: iadd
    ...
    //   70: aload_0
    //   71: astore_3
    //   72: invokestatic 121	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   75: ifeq +16 -> 91
    //   78: ldc 123
    //   80: iconst_2
    //   81: aload 4
    //   83: invokestatic 127	com/tencent/qphone/base/util/QLog:getStackTraceString	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   86: invokestatic 130	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   89: aload_0
    //   90: astore_3
    //   91: aload_3
    //   92: areturn
