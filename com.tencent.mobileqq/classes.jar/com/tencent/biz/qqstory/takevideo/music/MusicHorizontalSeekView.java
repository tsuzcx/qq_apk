  ...
  implements View.OnTouchListener
{
  ...
  public MusicHorizontalSeekView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.m = ((int)bgme.a(paramContext, 2.0F));
    this.n = ((int)bgme.a(paramContext, 1.0F));
    jdField_b_of_type_Int = (int)bgme.a(paramContext, 10.0F);
    jdField_c_of_type_Int = (int)bgme.a(paramContext, 21.0F);
    int i1 = 0;
    while (i1 < jdField_a_of_type_Int)
    {
      jdField_b_of_type_ArrayOfInt[i1] = ((int)bgme.a(paramContext, jdField_a_of_type_ArrayOfInt[i1]));
      i1 += 1;
    }
    paramContext = paramContext.getResources();
    this.jdField_a_of_type_AndroidGraphicsPaint = new Paint();
    this.jdField_a_of_type_AndroidGraphicsPaint.setAntiAlias(true);
    this.jdField_a_of_type_AndroidGraphicsPaint.setColor(paramContext.getColor(2131165545));
    this.jdField_b_of_type_AndroidGraphicsPaint = new Paint();
    this.jdField_b_of_type_AndroidGraphicsPaint.setAntiAlias(true);
    this.jdField_b_of_type_AndroidGraphicsPaint.setColor(paramContext.getColor(2131166468));
    this.jdField_c_of_type_AndroidGraphicsPaint = new Paint();
    this.jdField_c_of_type_AndroidGraphicsPaint.setAntiAlias(true);
    this.jdField_c_of_type_AndroidGraphicsPaint.setColor(paramContext.getColor(2131166470));
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Zdu != null) {
      this.jdField_a_of_type_Zdu.a(this.j, this.f);
    }
  }
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        this.jdField_a_of_type_Zdu.a(this.g, this.f, this.h);
        break;
      ...
      if (f1 > this.jdField_a_of_type_Float)
      {
        if (this.h <= jdField_b_of_type_Int)
        {
          ...
          super.invalidate();
          if (this.jdField_a_of_type_Zdu != null) {
            this.jdField_a_of_type_Zdu.b(this.g, this.f, this.h);
          }
      ...
      super.invalidate();
      if (this.jdField_a_of_type_Zdu != null) {
        this.jdField_a_of_type_Zdu.c(this.g, this.f, this.h);
      }
    }
  }
  ...
  public void setOnSeekListener(zdu paramzdu)
  {
    this.jdField_a_of_type_Zdu = paramzdu;
  }
