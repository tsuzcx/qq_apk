  ...
  implements View.OnTouchListener
{
  ...
  public MusicHorizontalSeekView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.m = ((int)bhmg.a(paramContext, 2.0F));
    this.n = ((int)bhmg.a(paramContext, 1.0F));
    jdField_b_of_type_Int = (int)bhmg.a(paramContext, 10.0F);
    jdField_c_of_type_Int = (int)bhmg.a(paramContext, 21.0F);
    int i1 = 0;
    while (i1 < jdField_a_of_type_Int)
    {
      jdField_b_of_type_ArrayOfInt[i1] = ((int)bhmg.a(paramContext, jdField_a_of_type_ArrayOfInt[i1]));
      i1 += 1;
    }
    ...
    this.jdField_b_of_type_AndroidGraphicsPaint.setColor(paramContext.getColor(2131166472));
    this.jdField_c_of_type_AndroidGraphicsPaint = new Paint();
    this.jdField_c_of_type_AndroidGraphicsPaint.setAntiAlias(true);
    this.jdField_c_of_type_AndroidGraphicsPaint.setColor(paramContext.getColor(2131166474));
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Zhp != null) {
      this.jdField_a_of_type_Zhp.a(this.j, this.f);
    }
  }
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        this.jdField_a_of_type_Zhp.a(this.g, this.f, this.h);
        break;
      ...
      if (f1 > this.jdField_a_of_type_Float)
      {
        if (this.h <= jdField_b_of_type_Int)
        {
          ...
          super.invalidate();
          if (this.jdField_a_of_type_Zhp != null) {
            this.jdField_a_of_type_Zhp.b(this.g, this.f, this.h);
          }
      ...
      super.invalidate();
      if (this.jdField_a_of_type_Zhp != null) {
        this.jdField_a_of_type_Zhp.c(this.g, this.f, this.h);
      }
    }
  }
  ...
  public void setOnSeekListener(zhp paramzhp)
  {
