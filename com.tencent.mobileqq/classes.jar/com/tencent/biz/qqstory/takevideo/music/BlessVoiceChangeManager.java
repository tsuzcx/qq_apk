...
public class BlessVoiceChangeManager
{
  ...
  ArrayList<VoiceChangeData> b;
  private ArrayList<QQStoryMusicInfo> jdField_c_of_type_JavaUtilArrayList = new ArrayList();
  ...
  private boolean a()
  {
    ...
    localObject1 = VasUpdateUtil.a(BaseApplicationImpl.getApplication().getRuntime(), "blessVoiceList.json", false, null);
    ...
    if (this.jdField_b_of_type_JavaUtilArrayList != null)
    {
      ...
      else
      {
        ...
        if (k != 0)
        {
          ...
          {
            j = k;
            if (IndividuationConfigInfo.a(((JSONObject)localObject4).getString("QQVersion"), "8.5.5"))
            {
              k = 0;
              j = k;
              if (QLog.isColorLevel())
        ...
        else
        {
          ...
          for (;;)
          {
            ...
            break label1632;
            localObject5 = ClubContentJsonTask.jdField_b_of_type_JavaLangString + (String)localObject5;
  ...
  private void d()
  {
    ...
    new BlessVoiceChangeManager.1(this, this.jdField_a_of_type_ComTencentBizQqstoryBaseDownloadDownloaderImp, l).executeOnExecutor(Bosses.get().getExecutor(16), new FileDownloadTask.Input[] { new FileDownloadTask.Input(str1, str2, null) });
  }
  ...
  protected void a(QQStoryMusicInfo paramQQStoryMusicInfo)
  {
    ...
    if (a((Object[])localObject))
    {
      ...
      VoiceChangeManager.a(BaseApplicationImpl.getContext(), (VoiceChangeBasicParams)localObject, jdField_c_of_type_JavaLangString, new BlessVoiceChangeManager.EditMusicVoiceChangeListener(paramQQStoryMusicInfo, str), new VoiceChangeModeParams(false, false, false, true, true, null));
    }
  }
 ...
 * Qualified Name:     com.tencent.biz.qqstory.takevideo.music.BlessVoiceChangeManager
