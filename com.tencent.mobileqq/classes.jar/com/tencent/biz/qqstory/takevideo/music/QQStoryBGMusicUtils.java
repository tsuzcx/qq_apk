...
public class QQStoryBGMusicUtils
{
  ...
  public static final String a(String paramString)
  {
    ...
    File localFile = new File(QQStoryConstant.f);
    if ((!localFile.exists()) || (!localFile.isDirectory())) {
      localFile.mkdirs();
    }
    paramString = QQStoryConstant.f + MD5.a(paramString) + "." + FileUtils.c(paramString);
  ...
  protected static void a(BaseActivity paramBaseActivity, int paramInt)
  {
    paramInt = MusicProviderView.a(paramInt);
    Intent localIntent = new Intent(paramBaseActivity, QQBrowserActivity.class);
    localIntent.putExtra("url", String.format("https://ti.qq.com/music/index.html?_wv=5&_bid=2831&device_id=%s&client_ip=%s&bustype=%s", new Object[] { DeviceInfoUtil.a(), "", Integer.valueOf(paramInt) }));
    localIntent.putExtra("finish_animation_up_down", true);
    paramBaseActivity.startActivityForResult(localIntent, 1000);
    paramBaseActivity.overridePendingTransition(2130771981, 0);
    if (QLog.isColorLevel()) {
