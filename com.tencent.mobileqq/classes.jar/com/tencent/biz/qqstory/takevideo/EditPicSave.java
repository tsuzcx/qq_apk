  ...
  extends EditVideoPart
{
  ...
  public EditPicSave(@NonNull EditVideoPartManager paramEditVideoPartManager)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppThreadExcutor$IThreadListener = new obs(this);
  }
  ...
  private ProgressPieDrawable a()
  {
    ...
    localProgressPieDrawable.a(new oby(this));
  ...
  private void i()
  {
    ...
    a("正在保存...", false, 0);
    a(20);
    Stream.of(localGenerateContext).map(new GenerateEditPicDoodleSegment((EditDoodleExport)a(EditDoodleExport.class), null)).map(new ThreadOffFunction(2)).map(new MergePicSegment(EditPicConstants.a + "qq_pic_merged_" + System.currentTimeMillis() + ".jpg")).map(new UIThreadOffFunction(this)).subscribe(new obu(this));
  }
  ...
  public void a(String paramString, boolean paramBoolean, int paramInt)
  {
    ...
    a().a().postDelayed(new obw(this), paramInt);
  }
  ...
  public void e()
  {
    this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoUi.a().postDelayed(new obx(this), 1000L);
  }
