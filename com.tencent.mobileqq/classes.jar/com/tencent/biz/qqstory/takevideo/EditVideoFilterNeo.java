  ...
  extends EditVideoFilter
{
  ...
  public static final String i = HardCodeUtil.a(2131703939);
  public static final String j = HardCodeUtil.a(2131703757);
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
  private DataProvider.DataUpdateListener<WeatherDataProvider.WeatherInfo> jdField_a_of_type_ComTencentBizQqstoryModelDataProvider$DataUpdateListener = new EditVideoFilterNeo.1(this);
  private WeatherFilterData jdField_a_of_type_ComTencentBizQqstoryTakevideoFilterWeatherFilterData;
  private SparseArray<FilterData> b;
  ...
  private FilterData a(int paramInt1, @NonNull String paramString, int paramInt2, EditVideoParams.EditSource paramEditSource)
  {
    ...
    if (k >= 0)
    {
      paramString = (FilterData)this.jdField_b_of_type_AndroidUtilSparseArray.valueAt(k);
      return paramString;
    }
        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              {
                localObject = new VideoEffectsFilterData(paramString, paramInt2, 2130846875, 2);
                continue;
                localObject = localFilterData;
                if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoFilterPOIFilterData != null)
                {
                  ...
                  {
                    localObject = new VideoEffectsFilterData(paramString, paramInt2, 2130846874, 1);
                    continue;
                    if (!(paramEditSource instanceof EditRecordVideoSource))
                    {
                      localObject = localFilterData;
                    ...
                    else
                    {
                      ...
                      if (!"X9000".equalsIgnoreCase(Build.MODEL))
                      {
                        ...
                        {
                          localObject = new VideoEffectsFilterData(paramString, paramInt2, 2130846876, 3);
                          continue;
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    CmdTaskManger.a().a(localGetLocationRequest, new EditVideoFilterNeo.2(this));
  }
  ...
  public void a(int paramInt, AddressDataProvider.AddressInfo paramAddressInfo)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (localActivity != null) {
        localActivity.runOnUiThread(new EditVideoFilterNeo.3(this, paramAddressInfo));
      }
    }
    else
    {
  ...
  public void h()
  {
    ...
    if (((List)localObject1).isEmpty())
    {
      ...
      {
        localObject1 = a(jdField_a_of_type_ArrayOfInt[k], jdField_a_of_type_ArrayOfJavaLangString[k], jdField_b_of_type_ArrayOfInt[k], this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPartManager.a.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams$EditSource);
