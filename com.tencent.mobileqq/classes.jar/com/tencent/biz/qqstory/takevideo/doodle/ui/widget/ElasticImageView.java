  ...
  extends ImageView
{
  ...
  {
    return vmx.a(paramLong, paramFloat1, paramFloat2, new vpj(this));
  }
  ...
  private void b(float paramFloat)
  {
    ...
    ved.b("ElasticImageView", "updateMatrix:" + paramFloat);
  ...
  private void d()
  {
    ...
    for (;;)
    {
      ved.b("ElasticImageView", "drawableWidth:" + k + ",drawableHeight:" + j + ",AvaliableWidth:" + this.jdField_c_of_type_Int + ",AvaliableHeight:" + this.jdField_d_of_type_Int + ",scaleValue:" + f1);
  ...
  protected void onSizeChanged(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    ved.b("ElasticImageView", "ImageViewWidth:" + this.jdField_a_of_type_Int + ",ImageViewHeight:" + this.jdField_b_of_type_Int + ",centerX:" + this.jdField_e_of_type_Int + ",centerY:" + this.jdField_f_of_type_Int + ",AvaliableWidth:" + this.jdField_c_of_type_Int + ",AvaliableHeight:" + this.jdField_d_of_type_Int);
    d();
