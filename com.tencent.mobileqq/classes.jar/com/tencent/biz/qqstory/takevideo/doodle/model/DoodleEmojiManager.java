  ...
  implements IManager
{
  ...
  private LocationListener jdField_a_of_type_AndroidLocationLocationListener = new DoodleEmojiManager.4(this);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = QQStoryConstant.g + "emoji";
  ...
  public DoodleEmojiManager()
  {
    ...
    this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleModelDoodleEmojiItem = null;
  ...
  public static void a(GetEmojiPackInfoListResponse paramGetEmojiPackInfoListResponse)
  {
    ...
    //   12: getstatic 51	com/tencent/biz/qqstory/takevideo/doodle/model/DoodleEmojiManager:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   31: invokestatic 257	com/tencent/biz/qqstory/utils/FileUtils:d	(Ljava/lang/String;)Z
    //   34: pop
    //   35: getstatic 51	com/tencent/biz/qqstory/takevideo/doodle/model/DoodleEmojiManager:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   38: invokestatic 54	com/tencent/biz/qqstory/takevideo/doodle/model/DoodleEmojiManager:a	(Ljava/lang/String;)V
    //   41: new 259	java/io/ByteArrayOutputStream
    //   44: dup
    //   45: sipush 8192
    //   48: invokespecial 260	java/io/ByteArrayOutputStream:<init>	(I)V
    //   51: astore_1
    //   52: new 262	java/io/ObjectOutputStream
    //   55: dup
    //   56: aload_1
    //   57: invokespecial 265	java/io/ObjectOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   60: astore_2
    //   61: aload_2
    //   62: bipush 18
    //   64: invokevirtual 268	java/io/ObjectOutputStream:writeInt	(I)V
    //   67: aload_2
    //   68: aload_0
    //   69: getfield 269	com/tencent/biz/qqstory/network/response/GetEmojiPackInfoListResponse:jdField_a_of_type_Long	J
    //   72: invokevirtual 273	java/io/ObjectOutputStream:writeLong	(J)V
    //   75: aload_2
    //   76: aload_0
    //   77: getfield 276	com/tencent/biz/qqstory/network/response/GetEmojiPackInfoListResponse:jdField_a_of_type_ArrayOfByte	[B
    //   80: arraylength
    //   81: invokevirtual 268	java/io/ObjectOutputStream:writeInt	(I)V
    //   84: aload_2
    //   85: aload_0
    //   86: getfield 276	com/tencent/biz/qqstory/network/response/GetEmojiPackInfoListResponse:jdField_a_of_type_ArrayOfByte	[B
    //   89: invokevirtual 279	java/io/ObjectOutputStream:write	([B)V
    //   92: aload_2
    //   93: invokevirtual 282	java/io/ObjectOutputStream:flush	()V
    //   96: aload_2
    //   97: invokevirtual 285	java/io/ObjectOutputStream:close	()V
    //   100: new 287	java/io/FileOutputStream
    //   103: dup
    //   104: new 31	java/lang/StringBuilder
    //   107: dup
    //   108: invokespecial 34	java/lang/StringBuilder:<init>	()V
    //   111: getstatic 51	com/tencent/biz/qqstory/takevideo/doodle/model/DoodleEmojiManager:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   130: invokespecial 288	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   133: astore_2
    //   134: aload_1
    //   135: aload_2
    //   136: invokevirtual 291	java/io/ByteArrayOutputStream:writeTo	(Ljava/io/OutputStream;)V
    //   139: aload_1
    //   140: invokevirtual 292	java/io/ByteArrayOutputStream:flush	()V
    //   143: aload_1
    //   144: invokevirtual 293	java/io/ByteArrayOutputStream:close	()V
    //   147: aload_2
    //   148: invokevirtual 294	java/io/FileOutputStream:close	()V
    //   151: ldc 153
    //   153: ldc_w 296
    //   156: aload_0
    //   157: getfield 276	com/tencent/biz/qqstory/network/response/GetEmojiPackInfoListResponse:jdField_a_of_type_ArrayOfByte	[B
    //   160: arraylength
    //   161: invokestatic 161	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   164: invokestatic 166	com/tencent/biz/qqstory/support/logging/SLog:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    //   167: aload_1
    //   168: ifnull +7 -> 175
    //   171: aload_1
    //   172: invokevirtual 293	java/io/ByteArrayOutputStream:close	()V
    //   175: aload_2
    //   176: ifnull +7 -> 183
    //   179: aload_2
    //   180: invokevirtual 294	java/io/FileOutputStream:close	()V
    //   183: return
    //   184: astore_0
    //   185: aload_0
    //   186: invokevirtual 299	java/io/IOException:printStackTrace	()V
    //   189: goto -14 -> 175
    //   192: astore_0
    //   193: aload_0
    //   194: invokevirtual 299	java/io/IOException:printStackTrace	()V
    //   197: return
    //   198: astore_2
    //   199: aconst_null
    //   200: astore_0
    ...
    //   205: ldc_w 301
    //   208: aload_2
    //   209: invokestatic 224	com/tencent/biz/qqstory/support/logging/SLog:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   212: aload_0
    //   213: ifnull +7 -> 220
    //   216: aload_0
    //   217: invokevirtual 293	java/io/ByteArrayOutputStream:close	()V
    //   220: aload_1
    //   221: ifnull -38 -> 183
    //   224: aload_1
    //   225: invokevirtual 294	java/io/FileOutputStream:close	()V
    //   228: return
    //   229: astore_0
    //   230: aload_0
    //   231: invokevirtual 299	java/io/IOException:printStackTrace	()V
    //   234: return
    //   235: astore_0
    //   236: aload_0
    //   237: invokevirtual 299	java/io/IOException:printStackTrace	()V
    //   240: goto -20 -> 220
    //   243: astore_0
    //   244: aconst_null
    //   245: astore_1
    ...
    //   250: ifnull +7 -> 257
    //   253: aload_1
    //   254: invokevirtual 293	java/io/ByteArrayOutputStream:close	()V
    //   257: aload_2
    //   258: ifnull +7 -> 265
    //   261: aload_2
    //   262: invokevirtual 294	java/io/FileOutputStream:close	()V
    //   265: aload_0
    //   266: athrow
    //   267: astore_1
    //   268: aload_1
    //   269: invokevirtual 299	java/io/IOException:printStackTrace	()V
    //   272: goto -15 -> 257
    //   275: astore_1
    //   276: aload_1
    //   277: invokevirtual 299	java/io/IOException:printStackTrace	()V
    //   280: goto -15 -> 265
    //   283: astore_0
    //   284: aload 4
    //   286: astore_2
  ...
  private static boolean a(File paramFile)
  {
    ...
    {
      return false;
      paramFile = paramFile.listFiles(new DoodleEmojiManager.8());
  ...
  private void e()
  {
    ...
    else
    {
      ...
      CmdTaskManger.a().a(new GetEmojiPackInfoListRequest(this.jdField_b_of_type_JavaLangString, 50), new DoodleEmojiManager.7(this));
      return;
    }
  ...
  @NonNull
  public List<DoodleEmojiItem> a(boolean paramBoolean)
  {
    if (!a()) {
      return Collections.EMPTY_LIST;
    }
  ...
  public void a(int paramInt1, int paramInt2, DoodleEmojiManager.POIPostersRequestCallback paramPOIPostersRequestCallback)
  {
    ...
    CmdTaskManger.a().a(new GetPoiFacesRequest(paramInt1, paramInt2), new DoodleEmojiManager.6(this, paramPOIPostersRequestCallback));
  }
  ...
  public void a(BasicLocation paramBasicLocation, DoodleEmojiManager.POIPostersRequestCallback paramPOIPostersRequestCallback)
  {
    ...
    localLbsManager.a(new DoodleEmojiManager.5(this, paramPOIPostersRequestCallback));
    localLbsManager.c();
  }
  ...
  protected void a(boolean paramBoolean1, @NonNull GetEmojiPackInfoListResponse paramGetEmojiPackInfoListResponse, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        synchronized (this.jdField_a_of_type_JavaUtilList)
        {
          ...
          StoryDispatcher.a().dispatch(new DoodleEmojiManager.DoodleEmojiUpdateEvent());
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleModelDoodleEmojiItem == null)
      {
        ...
        if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleModelDoodleEmojiItem != null)
        {
          ...
          Bosses.get().postJob(new DoodleEmojiManager.3(this, this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleModelDoodleEmojiItem));
        }
        return;
      }
