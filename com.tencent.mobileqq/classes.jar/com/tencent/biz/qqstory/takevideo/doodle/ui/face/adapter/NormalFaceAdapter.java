  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    int j = ((Integer)localImageView.getTag(2131378913)).intValue();
    ...
    try
    {
      ...
      if (localObject1 != null)
      {
        ...
        localObject3 = (NormalFaceAdapter.NormalItemLayout)paramView.getParent();
        j = (int)ViewCompat.b((View)localObject3);
        f2 = ViewCompat.a(paramView);
        f3 = paramView.getWidth() / 2;
        f4 = i;
        f5 = ((NormalFaceAdapter.NormalItemLayout)localObject3).getHeight() / 2 + j;
        ...
        {
          f1 = (((j - i) / 2 - k) * 2 + i) / i;
          localObject1 = new SelectedItem(localNormalFacePackage.b, str, (Drawable)localObject1);
          this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiFaceFacePanel$OnFaceSelectedListener.a((SelectedItem)localObject1, f4 + (f2 + f3), f5, f1 * 1.2F);
