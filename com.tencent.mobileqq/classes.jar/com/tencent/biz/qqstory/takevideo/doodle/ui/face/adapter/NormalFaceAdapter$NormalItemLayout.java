  ...
  extends LinearLayout
{
  ...
  public NormalFaceAdapter$NormalItemLayout(Context paramContext, int paramInt1, int paramInt2, float paramFloat, View.OnClickListener paramOnClickListener)
  {
    super(paramContext);
  ...
  public void a(NormalFacePackage paramNormalFacePackage, int paramInt1, int paramInt2)
  {
    ...
    for (paramInt1 = paramNormalFacePackage.b();; paramInt1 = this.b + i)
    {
      ...
      while (paramInt2 < paramInt1)
      {
        ...
        localImageView.setTag(2131378926, str);
        localImageView.setTag(2131378913, Integer.valueOf(paramInt2));
        localImageView.setContentDescription(HardCodeUtil.a(2131707583) + paramInt2);
 ...
 * Qualified Name:     com.tencent.biz.qqstory.takevideo.doodle.ui.face.adapter.NormalFaceAdapter.NormalItemLayout
