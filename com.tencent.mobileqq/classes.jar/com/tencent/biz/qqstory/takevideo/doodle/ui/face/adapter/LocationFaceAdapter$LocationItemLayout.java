  ...
  extends LinearLayout
{
  ...
  private void a()
  {
    setOrientation(0);
    setGravity(17);
    int j = DisplayUtil.b(getContext(), 3.0F);
    int k = (int)((this.c - j * 2) * this.jdField_a_of_type_Float);
    int i = 0;
    while (i < this.b)
    {
      View localView = LayoutInflater.from(getContext()).inflate(2131561843, null);
      localView.setLayoutParams(new ViewGroup.LayoutParams(this.c - j * 2, this.c - j * 2));
      ((ImageView)localView.findViewById(2131370791)).setPadding(k, k, k, k);
      addView(localView);
      i += 1;
    }
  }
  ...
  public void a(LocationFacePackage paramLocationFacePackage, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 == paramInt2 - 1)
    {
      ...
      localURLImageView = (URLImageView)((View)localObject3).findViewById(2131370791);
      localTextView = (TextView)((View)localObject3).findViewById(2131370807);
      localObject2 = (ProgressBar)((View)localObject3).findViewById(2131370805);
    ...
    for (;;)
    {
      ...
      localObject3 = (Boolean)localURLImageView.getTag(2131378891);
      if ((localObject3 != null) && (((Boolean)localObject3).booleanValue()) && (((String)localObject1).equals(localURLImageView.getTag(2131378926))))
      {
      ...
      else
      {
        ...
        localObject2 = new LocationFaceAdapter.URLDrawableListener((String)localObject1, localURLImageView, (ProgressBar)localObject2);
 ...
 * Qualified Name:     com.tencent.biz.qqstory.takevideo.doodle.ui.face.adapter.LocationFaceAdapter.LocationItemLayout
