  ...
  implements BaseLayer.OnLayerTouchListener<LineLayer>
{
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    ((AlphaAnimation)localObject).setAnimationListener(new DoodleLayout.LineLayerTouchListener.1(this));
    ...
    localAlphaAnimation.setAnimationListener(new DoodleLayout.LineLayerTouchListener.2(this));
    if (paramBoolean2) {
 ...
 * Qualified Name:     com.tencent.biz.qqstory.takevideo.doodle.ui.doodle.DoodleLayout.LineLayerTouchListener
