  ...
  extends GestureHelper.ZoomItem
{
  ...
  public TextLayer$TextItem(TextLayer paramTextLayer)
  {
    ...
    this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleLayerModelTextInfo.b = paramTextLayer.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131299131);
  ...
  public void a(Canvas paramCanvas)
  {
    ...
    for (;;)
    {
      ...
      DisplayUtil.a(paramCanvas, this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleLayerTextLayer.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUtilGestureHelper, this, 0, 2130844742, 2130844749);
      return;
      this.jdField_a_of_type_AndroidTextTextPaint.setTextAlign(Paint.Align.LEFT);
  ...
  public void b()
  {
    if (this.jdField_a_of_type_AndroidAnimationValueAnimator == null)
    {
      ...
      this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new TextLayer.TextItem.2(this));
      this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new TextLayer.TextItem.3(this));
    }
