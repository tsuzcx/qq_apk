...
public class DoodleConfig$Builder
{
  ...
  private DoodleStrategy jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleLayerBaseDoodleStrategy = new DefaultDoodleStrategy();
  private int b;
 ...
 * Qualified Name:     com.tencent.biz.qqstory.takevideo.doodle.layer.config.DoodleConfig.Builder
