  ...
  implements Handler.Callback, View.OnTouchListener
{
  ...
  private Bitmap a(int[] paramArrayOfInt)
  {
    ...
    //   66: ldc 150
    //   68: ldc 152
    //   70: invokestatic 157	wxe:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   73: aload_0
    ...
    //   380: invokestatic 206	wxe:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   383: ldc 150
    ...
    //   407: invokestatic 157	wxe:b	(Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   461: ldc 228
    //   463: aload 9
    //   465: invokestatic 231	wxe:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   468: aload_1
    //   469: ifnull +8 -> 477
    //   472: aload_1
    //   473: iconst_0
    ...
    //   505: invokestatic 157	wxe:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   508: aload 10
    ...
    //   583: invokestatic 157	wxe:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   586: aload_0
    ...
    //   673: invokestatic 157	wxe:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   676: iload 6
    //   678: iload 5
    ...
    //   824: invokestatic 157	wxe:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   827: aload_1
    //   828: ifnull +7 -> 835
    //   831: aload_1
    //   832: iconst_0
    ...
    //   847: ldc 228
    //   849: aload 10
    //   851: invokestatic 231	wxe:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   854: aload_1
    //   855: ifnull +8 -> 863
    //   858: aload_1
    //   859: iconst_0
    ...
    //   874: ldc 228
    //   876: aload 10
    //   878: invokestatic 231	wxe:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   881: aload_1
    //   882: ifnull +7 -> 889
    //   885: aload_1
    //   886: iconst_0
  ...
  private void a(float paramFloat1, float paramFloat2)
  {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_Xgd != null) && (paramFloat1 > 0.0F) && (paramFloat2 > 0.0F)) {
        this.jdField_a_of_type_Xgd.a(this.jdField_c_of_type_Boolean);
      }
      return;
  ...
  private void b()
  {
    ...
    wxe.b("EditPicActivityCropView", "setBitmap scale : " + this.h);
    this.k = (f1 * this.h);
    this.l = (this.h * f2);
    wxe.b("EditPicActivityCropView", "setBitmap image width " + this.k + " image height " + this.l);
  ...
  public void a(int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsMatrix.setScale(1.0F, 1.0F);
    if (this.jdField_a_of_type_AndroidGraphicsBitmap == null) {
      wxe.e("EditPicActivityCropView", "cropview rotate bitmap is null..");
    }
    float f1;
    float f2;
    float f3;
    ...
    do
    {
      ...
      default: 
        ...
        this.h = (this.g / f2);
        f1 = this.h;
        wxe.b("EditPicActivityCropView", "calculate picscale : " + this.h + " final : " + f1);
    ...
    } while (this.jdField_a_of_type_Xgd == null);
    if ((this.jdField_c_of_type_Boolean) || (this.jdField_b_of_type_Int != 0)) {}
    for (boolean bool = true;; bool = false)
    {
      this.jdField_a_of_type_Xgd.a(bool);
      return;
      this.jdField_d_of_type_Boolean = true;
      break;
  ...
  public boolean a()
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Xgd != null) {
        this.jdField_a_of_type_Xgd.a(7);
      }
    ...
    if (this.jdField_a_of_type_Xgd != null) {
      this.jdField_a_of_type_Xgd.a(localBitmap);
    }
    return true;
  }
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    case 0: 
      ...
      wxe.b("EditPicActivityCropView", "hitResizeCorner " + this.jdField_a_of_type_Int);
    ...
    case 1: 
      ...
      if (this.jdField_b_of_type_Boolean) {
        this.jdField_a_of_type_Bhtd.sendEmptyMessageDelayed(1001, 1000L);
      }
      return true;
    }
  ...
  public void setCropListener(xgd paramxgd)
  {
