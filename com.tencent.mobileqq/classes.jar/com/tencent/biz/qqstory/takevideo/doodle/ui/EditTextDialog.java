  ...
  implements View.OnClickListener
{
  ...
  private void a()
  {
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)LayoutInflater.from(getContext()).inflate(2131561792, null));
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.setBackgroundColor(super.getContext().getResources().getColor(2131166489));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131379180));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131379181));
    if (TextLayer.jdField_a_of_type_Int > DisplayUtil.b(getContext(), 14.0F)) {
      this.jdField_a_of_type_AndroidWidgetEditText.setPadding(TextLayer.jdField_a_of_type_Int, DisplayUtil.b(getContext(), 5.0F), TextLayer.jdField_a_of_type_Int, DisplayUtil.b(getContext(), 5.0F));
    }
    for (;;)
    {
      this.jdField_a_of_type_AndroidWidgetEditText.requestFocus();
      this.jdField_a_of_type_AndroidWidgetEditText.setCursorVisible(false);
      this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new EditTextDialog.1(this));
      this.jdField_a_of_type_AndroidWidgetEditText.setOnTouchListener(new EditTextDialog.2(this));
      this.jdField_a_of_type_AndroidWidgetEditText.setOnFocusChangeListener(new EditTextDialog.3(this));
      this.jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout = ((HorizontalSelectColorLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131372228));
      ...
      this.jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout.setSelectedStrokeWithColor(com.tencent.biz.qqstory.takevideo.view.widget.colorbar.stroke.HorizontalStroke.a[1]);
      this.jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout.setOnStrokeSelectedListener(new EditTextDialog.4(this));
      this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new EditTextDialog.5(this));
      this.jdField_b_of_type_AndroidWidgetTextView.setOnClickListener(new EditTextDialog.6(this));
      return;
      this.jdField_a_of_type_AndroidWidgetEditText.setPadding(DisplayUtil.b(getContext(), 14.0F), DisplayUtil.b(getContext(), 5.0F), DisplayUtil.b(getContext(), 14.0F), DisplayUtil.b(getContext(), 5.0F));
    }
  }
  ...
  public void a(TextInfo paramTextInfo)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetEditText.setTextSize(DisplayUtil.c(getContext(), this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleLayerModelTextInfo.jdField_b_of_type_Int));
