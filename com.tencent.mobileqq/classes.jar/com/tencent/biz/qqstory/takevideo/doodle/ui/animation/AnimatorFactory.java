...
public class AnimatorFactory
{
  public static ValueAnimator a(long paramLong, float paramFloat1, float paramFloat2, AnimatorFactory.AnimatorListener paramAnimatorListener)
  {
    ...
    localValueAnimator.addUpdateListener(new AnimatorFactory.1(paramAnimatorListener));
    localValueAnimator.addListener(new AnimatorFactory.2(paramAnimatorListener, localValueAnimator));
