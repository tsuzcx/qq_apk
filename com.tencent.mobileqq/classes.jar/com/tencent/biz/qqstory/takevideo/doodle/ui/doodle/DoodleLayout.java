  ...
  implements View.OnClickListener
{
  ...
  public oog a;
  private ool jdField_a_of_type_Ool;
  public oom a;
  public int b;
  public Rect b;
  ...
  public DoodleLayout(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_Oom = new oom(this, null);
  ...
  private void b(boolean paramBoolean)
  {
    if (this.jdField_d_of_type_Boolean != paramBoolean)
    {
      ...
      if (paramBoolean)
      {
        ...
        this.jdField_b_of_type_AndroidWidgetRelativeLayout.setBackgroundColor(getResources().getColor(2131493784));
      }
    }
    else
    {
    ...
    this.jdField_b_of_type_AndroidWidgetRelativeLayout.setBackgroundColor(getResources().getColor(2131493783));
  }
  ...
  private void e(int paramInt)
  {
    ...
    if ((localObject1 == null) || (localObject2 == null))
    {
      ...
      if (this.f != -1)
      {
        ...
        localLineLayer.a(new ooi(this, null));
        localLineLayer.a(new ooa(this));
        ((FaceLayer)localObject1).a(this.jdField_a_of_type_Oom);
        ((FaceLayer)localObject1).a(new oob(this));
        localObject1 = localObject2;
        if (!this.jdField_c_of_type_Boolean)
        {
          localTextLayer.a(this.jdField_a_of_type_Oom);
          localTextLayer.a(new ooo(this, null));
          localObject1 = localObject2;
        }
      }
    }
    for (;;)
    {
      ...
      ((LineLayer)localObject2).a.a(new ooc(this));
  ...
  private void k()
  {
    LayoutInflater.from(super.getContext()).inflate(2130970725, this);
    l();
  ...
  private void l()
  {
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)super.findViewById(2131366707));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131371704));
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)super.findViewById(2131364395));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)super.findViewById(2131364396));
    this.jdField_a_of_type_AndroidViewView = super.findViewById(2131365602);
    this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiFaceFacePanel = ((FacePanel)super.findViewById(2131371705));
    this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiFaceFacePanel.setOnFaceSelectedListener(new ooh(this, null));
    this.jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout = ((HorizontalSelectColorLayout)super.findViewById(2131364400));
    this.jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout.setOnUndoViewClickListener(new onx(this));
    this.jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout.setOnStrokeSelectedListener(new ony(this));
    n();
    this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView = ((DoodleView)super.findViewById(2131364397));
    ...
    this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleEditView = ((DoodleEditView)super.findViewById(2131364401));
  ...
  private void m()
  {
    ...
    this.jdField_a_of_type_Oog = new oog(this, null);
    ...
    this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiEditTextDialog.setContentView(2130970729);
    this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiEditTextDialog.a(this.jdField_a_of_type_Oog);
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      j = getResources().getColor(2131493765);
  ...
  public Bitmap b(int paramInt)
  {
    ...
    //   390: iload_2
    //   391: aload 10
    //   393: invokespecial 965	ooe:<init>	(Lcom/tencent/biz/qqstory/takevideo/doodle/ui/doodle/DoodleLayout;Lcom/tencent/biz/qqstory/takevideo/doodle/layer/LineLayer;I[I)V
  ...
  public void b()
  {
    if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout != null) {
      this.jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout.post(new onz(this));
    }
  }
  ...
  public void d()
  {
    ...
    a(true);
    super.setBackgroundColor(getResources().getColor(2131493765));
    ...
    for (;;)
    {
      ...
      if (this.jdField_b_of_type_Int == 3)
      {
        c(1);
        this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiEditTextDialog.dismiss();
        super.postDelayed(new ood(this), 100L);
        return;
      }
  ...
  public void j()
  {
    ...
    for (;;)
    {
      ...
      localAlphaAnimation.setAnimationListener(new oof(this));
  ...
  public void setOnTextDialogShowListener(ool paramool)
  {
    this.jdField_a_of_type_Ool = paramool;
  }
}
