  ...
  implements View.OnClickListener
{
  ...
  public DoodleLayout(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_Zef = new zef(this, null);
  ...
  {
    a();
    yuk.b("DoodleLayout", "onBackPressed, buttonState:" + this.jdField_b_of_type_Int + ",activeLayer:" + this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.a());
  ...
  private void b(boolean paramBoolean)
  {
    if (this.jdField_d_of_type_Boolean != paramBoolean)
    {
      ...
      if (paramBoolean)
      {
        ...
        this.jdField_b_of_type_AndroidWidgetRelativeLayout.setBackgroundColor(getResources().getColor(2131166339));
      }
    }
    else
    {
    ...
    this.jdField_b_of_type_AndroidWidgetRelativeLayout.setBackgroundColor(getResources().getColor(2131166340));
  }
  
  private void e(int paramInt)
  {
    Object localObject1 = (zdy)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt);
    Object localObject2 = (zbs)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt);
    int j;
    if ((localObject1 == null) || (localObject2 == null))
    {
      yuk.b("DoodleLayout", "initDoodleView for the %d video", Integer.valueOf(paramInt));
      localObject1 = new zat(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView);
      zbd localzbd = new zbd(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView);
      zbh localzbh = new zbh(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView);
      localObject2 = (zen)localzbd.a(103);
      if ((localObject2 != null) && (this.jdField_c_of_type_Int != -1)) {
        ((zen)localObject2).b(this.jdField_c_of_type_Int);
      }
      if ((localObject2 != null) && (this.jdField_d_of_type_Int != -1) && (this.e != -1)) {
        ((zen)localObject2).b(this.jdField_d_of_type_Int, this.e);
      }
      localObject2 = new zbu().a(new zec(new zbn[] { localObject1, localzbd, localzbh }));
      if (this.f != -1)
      {
        j = this.f;
        localObject2 = ((zbu)localObject2).a(j);
        if (this.g == -1) {
          break label465;
        }
        j = this.g;
        label222:
        zbs localzbs = ((zbu)localObject2).b(j).a();
        this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.setDoodleConfig(localzbs);
        ...
        localObject2 = new zdy(localzbh, localzbd, (zat)localObject1, (zas)this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.a("EmptyLayer"));
        this.jdField_a_of_type_AndroidUtilSparseArray.put(paramInt, localzbs);
        this.jdField_b_of_type_AndroidUtilSparseArray.put(paramInt, localObject2);
        localzbd.a(new zdz(this, null));
        localzbd.a(new zdq(this));
        ((zat)localObject1).a(this.jdField_a_of_type_Zef);
        ((zat)localObject1).a(new zdr(this));
        localObject1 = localObject2;
        if (!this.jdField_c_of_type_Boolean)
        {
          localzbh.a(this.jdField_a_of_type_Zef);
          localzbh.a(new zeg(this, null));
          localObject1 = localObject2;
        }
      }
    }
    ...
    {
      localObject2 = a();
      ((zbd)localObject2).a(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleTextureView, this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView);
      ((zbd)localObject2).a.a(new zds(this));
      ((zes)((zbd)localObject2).a.a(102)).a(false);
      ((zdy)localObject1).jdField_a_of_type_Zbd.b();
      return;
      j = 480;
      break;
      label465:
  ...
  private void k()
  {
    LayoutInflater.from(super.getContext()).inflate(2131561707, this);
    l();
  ...
  private void l()
  {
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)super.findViewById(2131365100));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131379703));
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)super.findViewById(2131376987));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)super.findViewById(2131369361));
    this.jdField_a_of_type_AndroidViewView = super.findViewById(2131370633);
    this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiFaceFacePanel = ((FacePanel)super.findViewById(2131366238));
    this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiFaceFacePanel.setOnFaceSelectedListener(new zdx(this, null));
    this.jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout = ((HorizontalSelectColorLayout)super.findViewById(2131371769));
    this.jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout.setOnUndoViewClickListener(new zdo(this));
    this.jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout.setOnStrokeSelectedListener(new zdp(this));
    n();
    this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView = ((DoodleView)super.findViewById(2131365673));
    ...
    this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleEditView = ((DoodleEditView)super.findViewById(2131365674));
    ...
    this.jdField_b_of_type_Boolean = bdek.b();
  ...
  private void m()
  {
    yuk.b("DoodleLayout", "onClickInside: showEditTextDialog.");
    this.jdField_a_of_type_Zdw = new zdw(this, null);
    this.jdField_a_of_type_Zcn = new zcn(super.getContext());
    this.jdField_a_of_type_Zcn.a(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams);
    this.jdField_a_of_type_Zcn.a(a());
    this.jdField_a_of_type_Zcn.setContentView(2131561713);
    this.jdField_a_of_type_Zcn.a(this.jdField_a_of_type_Zdw);
    this.jdField_a_of_type_Zcn.show();
  }
  ...
  private void n()
  {
    ...
    {
      bool1 = true;
      if ((this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams == null) || (yxt.a(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.jdField_b_of_type_Int, 32768))) {
        break label133;
      }
    }
    label133:
    ...
    {
      this.jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout.setStrokeStrategy(new zlx(localAppInterface, bool1, bool2), true, 1);
      this.jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout.setSelectedStrokeWithColor(zma.a[0]);
      return;
      bool1 = false;
      break;
    }
  ...
  {
    zdy localzdy = (zdy)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt);
    if (localzdy != null)
    {
      paramInt = localzdy.jdField_a_of_type_Zbh.a();
      int j = localzdy.jdField_a_of_type_Zbd.a();
      int k = localzdy.jdField_a_of_type_Zat.a();
      yuk.b("DoodleLayout", "DoodleCount: text->" + paramInt + ",line->" + j + ",face->" + k);
      return k + (paramInt + j);
    }
    return 0;
  }
  ...
  public Bitmap a(int paramInt)
  {
    zdy localzdy = (zdy)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt);
    if (localzdy != null) {
      return localzdy.jdField_a_of_type_Zbd.a();
    }
    return null;
  }
  ...
  {
    Object localObject = (zdy)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt);
    if (localObject != null)
    {
      localObject = ((zdy)localObject).jdField_a_of_type_Zbh.a();
      if (localObject != null)
      {
        yuk.b("DoodleLayout", "doodle text :" + ((zbw)localObject).a);
        return ((zbw)localObject).a;
      }
    }
    return null;
  }
  ...
  public List<String> a(int paramInt)
  {
    ...
    if (localObject != null)
    {
      localObject = ((zdy)localObject).jdField_a_of_type_Zbd.a.a();
  ...
  public Map<String, List<String>> a(int paramInt)
  {
    ...
    if (localObject != null)
    {
      localObject = ((zdy)localObject).jdField_a_of_type_Zat.a;
  ...
  public zas a()
  {
    zdy localzdy = (zdy)this.jdField_b_of_type_AndroidUtilSparseArray.get(this.jdField_a_of_type_Int);
    if (localzdy == null)
    {
      yuk.d("DoodleLayout", "can not find LayerCollection by video index %d", new Object[] { Integer.valueOf(this.jdField_a_of_type_Int) });
      return null;
    }
    return localzdy.jdField_a_of_type_Zas;
  }
  ...
  public zat a()
  {
    ...
    return localzdy.jdField_a_of_type_Zat;
  }
  ...
  public zbd a()
  {
    ...
    return localzdy.jdField_a_of_type_Zbd;
  }
  ...
  public zbh a()
  {
    ...
    return localzdy.jdField_a_of_type_Zbh;
  }
  ...
  {
    yuk.b("DoodleLayout", "changeVideoIndex from %d to %d", Integer.valueOf(this.jdField_a_of_type_Int), Integer.valueOf(paramInt));
  ...
  {
    if (this.jdField_a_of_type_Zdv != null) {
      this.jdField_a_of_type_Zdv.b(paramInt, paramObject);
    }
  }
  ...
  public void a(MotionEvent paramMotionEvent)
  {
    ...
    {
      this.jdField_a_of_type_Zbn.d(paramMotionEvent);
  ...
  public void a(zfb paramzfb)
  {
    ...
    {
      return;
      yuk.b("DoodleLayout", "addLocationFaceItem:" + paramzfb.toString());
      zbb localzbb = zfu.a(paramzfb, this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.getWidth(), this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.getHeight());
      if (localzbb == null) {
        break;
      }
      bool = false;
      if (paramzfb.a != null) {
        bool = a().a(null, paramzfb.c, paramzfb.a, localzbb);
      }
    } while (!bool);
    this.jdField_a_of_type_Zdv.a(paramzfb);
    yuq.a("0X80076CE");
    return;
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    {
      yuk.b("DoodleLayout", "layer accept the outside MotionEvent. Layer->" + paramMotionEvent.toString());
      this.jdField_a_of_type_Zbn = paramMotionEvent;
      return true;
    }
    yuk.b("DoodleLayout", "no layer accept the outside MotionEvent.");
    this.jdField_a_of_type_Zbn = a();
    return false;
  }
  ...
  public int b()
  {
    ...
    {
      zdy localzdy = (zdy)this.jdField_b_of_type_AndroidUtilSparseArray.valueAt(j);
      k = k + localzdy.jdField_a_of_type_Zbh.a() + localzdy.jdField_a_of_type_Zbd.a() + localzdy.jdField_a_of_type_Zat.a();
      j += 1;
    }
    return k;
  }
  ...
  public Bitmap b()
  {
    ...
    return this.jdField_a_of_type_Zdu.b();
  }
  ...
  public Bitmap b(int paramInt)
  {
    ...
    //   46: aastore
    //   47: invokestatic 869	yuk:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   50: aconst_null
    //   51: areturn
    //   52: aload_0
    ...
    //   95: ldc 179
    //   97: ldc_w 884
    //   100: invokestatic 886	yuk:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   103: aload_0
    ...
    //   141: aastore
    //   142: invokestatic 669	yuk:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   145: aload_0
    ...
    //   161: invokestatic 920	yuk:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   164: goto -80 -> 84
    //   167: astore 6
    //   169: ldc 179
    //   171: ldc_w 922
    //   174: aload 6
    //   176: invokestatic 920	yuk:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   179: goto -95 -> 84
    //   182: astore 6
    //   184: aload_0
    ...
    //   200: ldc_w 924
    //   203: aload 6
    //   205: invokestatic 926	yuk:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   208: aconst_null
    //   209: areturn
    //   210: aload_0
    ...
    //   297: aastore
    //   298: invokestatic 869	yuk:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   301: aload_0
    ...
    //   316: lstore 4
    //   318: aload 8
    //   320: getfield 387	zdy:jdField_a_of_type_Zbd	Lzbd;
    //   323: astore 9
    //   325: aload 9
    //   327: getfield 371	zbd:a	Lzej;
    //   330: invokevirtual 960	zej:a	()Z
    //   333: ifeq +126 -> 459
    //   336: ldc 179
    //   338: ldc_w 962
    //   341: invokestatic 886	yuk:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   344: aload_0
    ...
    //   355: aload 9
    //   357: getfield 371	zbd:a	Lzej;
    //   360: invokevirtual 964	zej:b	()Z
    //   363: ifeq +87 -> 450
    //   366: iconst_1
    //   367: newarray int
    //   369: astore 10
    ...
    //   390: iload_2
    //   391: aload 10
    //   393: invokespecial 969	com/tencent/biz/qqstory/takevideo/doodle/ui/doodle/DoodleLayout$8:<init>	(Lcom/tencent/biz/qqstory/takevideo/doodle/ui/doodle/DoodleLayout;Lzbd;I[I)V
    //   396: invokevirtual 972	zej:a	(Ljava/lang/Runnable;)V
    //   399: aload 10
    //   401: iconst_0
    //   402: iaload
    //   403: istore_2
    ...
    //   432: invokestatic 263	yuk:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    //   435: iload_2
    //   436: istore_1
    //   437: goto -38 -> 399
    //   440: astore 11
    ...
    //   447: goto -24 -> 423
    //   450: aload 9
    //   452: getfield 371	zbd:a	Lzej;
    //   455: iload_2
    //   456: invokevirtual 982	zej:b	(I)V
    //   459: aload_0
    ...
    //   476: aload 9
    //   478: aload 7
    //   480: invokevirtual 986	zbd:c	(Landroid/graphics/Canvas;)V
    //   483: aload 8
    //   485: getfield 989	zdy:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   510: checkcast 291	zbn
    //   513: aload 7
    //   515: invokevirtual 1006	zbn:b	(Landroid/graphics/Canvas;)V
    //   518: goto -25 -> 493
    //   521: ldc 179
    ...
    //   548: invokestatic 212	yuk:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   551: aload_0
  ...
  public List<zau> b(int paramInt)
  {
    Object localObject = (zdy)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt);
    if (localObject != null)
    {
      localObject = ((zdy)localObject).jdField_a_of_type_Zat.b;
      yuk.b("DoodleLayout", "Using poi list:" + localObject.toString());
  ...
  {
    a();
    yuk.b("DoodleLayout", "onTextPressed, buttonState:" + this.jdField_b_of_type_Int + ",activeLayer:" + this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.a());
    String str;
    if (paramInt == 2)
    {
      str = "add_text";
      ...
      yuq.a("0X80076B9", yuq.jdField_b_of_type_Int);
      label74:
      if (this.jdField_b_of_type_Int != 3) {
        break label113;
      }
      if (this.jdField_a_of_type_Zcn != null) {
        this.jdField_a_of_type_Zcn.dismiss();
      }
    }
    label104:
    label113:
  ...
  public void c()
  {
    a();
    zbd localzbd = a();
    yuk.b("DoodleLayout", "undo, activeLayer:" + this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.a() + ",pathCount:" + localzbd.a.a());
    if (localzbd.d())
    {
      localzbd.c();
      if (localzbd.a.a() == 0) {
  ...
  public boolean c(int paramInt)
  {
    ...
    if (localObject != null)
    {
      localObject = ((zdy)localObject).jdField_a_of_type_JavaUtilArrayList.iterator();
      while (((Iterator)localObject).hasNext()) {
        if (!((zbn)((Iterator)localObject).next()).a()) {
          return false;
        }
      }
    }
  ...
  {
    a();
    yuk.b("DoodleLayout", "onFacePressed, buttonState:" + this.jdField_b_of_type_Int + ",activeLayer:" + this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.a());
  ...
  {
    a();
    yuk.b("DoodleLayout", "onLinePressed, buttonState:" + this.jdField_b_of_type_Int + ",activeLayer:" + this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.a());
    ...
    if (localzbd.b())
    {
      zev localzev = (zev)localzbd.a(101);
      if (localzev != null) {
        this.jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout.setSelectedStrokeWithColor(localzev.jdField_b_of_type_Int);
      }
    }
    if (localzbd.a.a() > 0)
    {
  ...
  public void f()
  {
    ...
    a(false);
    this.jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout.setUndoViewEnable(false);
    if ((this.jdField_a_of_type_Zcn != null) && (this.jdField_a_of_type_Zcn.isShowing()))
    {
      this.jdField_a_of_type_Zcn.dismiss();
      return;
    }
  ...
  public void i()
  {
    ...
    while (j < this.jdField_b_of_type_AndroidUtilSparseArray.size())
    {
      zbh localzbh = ((zdy)this.jdField_b_of_type_AndroidUtilSparseArray.valueAt(j)).jdField_a_of_type_Zbh;
      localzbh.a(null);
      localzbh.a(null);
      j += 1;
    }
  ...
  public void j()
  {
    ...
    for (;;)
    {
      ...
      localAlphaAnimation.setAnimationListener(new zdt(this));
      ...
      if (this.jdField_a_of_type_Zdu != null) {
        this.jdField_a_of_type_Zdu.b(localAlphaAnimation);
      }
      if (QLog.isColorLevel()) {
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      return;
      if ((paramView == this.jdField_a_of_type_AndroidWidgetTextView) && (!a(false)) && (this.jdField_a_of_type_Zdv != null)) {
        this.jdField_a_of_type_Zdv.g();
      }
    }
  }
  ...
  public void setDoodleBitmapMaxSize(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      {
        ((zbs)this.jdField_a_of_type_AndroidUtilSparseArray.get(j)).jdField_a_of_type_Int = paramInt1;
        ((zbs)this.jdField_a_of_type_AndroidUtilSparseArray.get(j)).jdField_b_of_type_Int = paramInt2;
        j += 1;
      }
    }
  }
  
  public void setDoodleBtnOperationHelper(zdu paramzdu)
  {
    this.jdField_a_of_type_Zdu = paramzdu;
  }
  
  public void setDoodleEventListener(zdv paramzdv)
  {
    this.jdField_a_of_type_Zdv = paramzdv;
  }
  ...
  {
    if (this.jdField_a_of_type_Zau == null)
    {
      yuk.e("DoodleLayout", "ClickFaceItem not found.");
      return;
    }
    yuk.b("DoodleLayout", "setLocation: clickItem-->" + this.jdField_a_of_type_Zau);
    a().a(this.jdField_a_of_type_Zau, paramString);
    this.jdField_a_of_type_Zau = null;
  }
  ...
  public void setMosaicSize(int paramInt)
  {
    ...
    {
      zen localzen = (zen)((zdy)this.jdField_b_of_type_AndroidUtilSparseArray.valueAt(paramInt)).jdField_a_of_type_Zbd.a(103);
      if (localzen != null) {
        localzen.b(j);
      }
      paramInt += 1;
  ...
  public void setMosaicStandardSize(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      while (j < this.jdField_b_of_type_AndroidUtilSparseArray.size())
      {
        zen localzen = (zen)((zdy)this.jdField_b_of_type_AndroidUtilSparseArray.valueAt(j)).jdField_a_of_type_Zbd.a(103);
        if (localzen != null) {
          localzen.b(paramInt1, paramInt2);
        }
        j += 1;
      }
    }
  ...
  public void setOnTextDialogShowListener(zed paramzed)
  {
    this.jdField_a_of_type_Zed = paramzed;
  }
}
