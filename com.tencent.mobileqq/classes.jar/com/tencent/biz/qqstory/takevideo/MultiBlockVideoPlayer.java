  ...
  extends ImageViewVideoPlayer
{
  ...
  private yvu jdField_a_of_type_Yvu;
  private Bitmap b;
  ...
  @NonNull
  public List<yvt> a(boolean paramBoolean, long paramLong, int paramInt1, int paramInt2, int paramInt3, float paramFloat)
  {
    ...
    if ((paramInt1 < arrayOfLong.length) && (paramInt1 + 2 < arrayOfLong.length))
    {
      ...
      for (;;)
      {
        ...
        localArrayList.add(new yvt(paramInt1 / 2, arrayOfLong[paramInt1], arrayOfLong[(paramInt1 + 2)], arrayOfLong[(paramInt1 + 1)], arrayOfLong[(paramInt1 + 3)], (Bitmap)localObject));
        paramInt1 += 2;
        break;
        label571:
  ...
  public void onLoadCancelled(View paramView, URLDrawable paramURLDrawable)
  {
    ...
    paramView = this.jdField_a_of_type_Yvu;
    if (paramView != null) {
      paramView.l();
    }
  }
  ...
  public void setCurrentVideoFragment(yvt paramyvt)
  {
    if (paramyvt != null)
    {
      VideoSourceHelper localVideoSourceHelper = null;
      ...
      int i = localVideoSourceHelper.setCurrentVideoFrameRange(true, paramyvt.a, paramyvt.c, paramyvt.b, paramyvt.d);
      if (i != 0) {
  ...
  public void setVideoLoadListener(yvu paramyvu)
  {
    this.jdField_a_of_type_Yvu = paramyvu;
  }
}
