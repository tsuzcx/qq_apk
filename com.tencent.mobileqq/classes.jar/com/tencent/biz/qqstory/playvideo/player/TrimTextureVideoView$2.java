  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      SLog.a(this.this$0.a, "[%d]not attach! not schedule!", Integer.valueOf(this.this$0.jdField_i_of_type_Int));
      return;
    }
    ...
    if ((this.this$0.isPlaying()) && (i == this.this$0.p) && (this.this$0.q > 0))
    {
      if (this.this$0.q > 1)
      {
        SLog.e(this.this$0.a, "[%d]Position not change for %d times, restart! 命中异常播放容错逻辑", new Object[] { Integer.valueOf(this.this$0.jdField_i_of_type_Int), Integer.valueOf(this.this$0.q) });
        this.this$0.a(true);
        return;
      }
    ...
    if ((!this.this$0.isPlaying()) && (i != this.this$0.n))
    {
      if (this.this$0.o > 1)
      {
        SLog.e(this.this$0.a, "[%d]Position change for %d times, but is pause, restart! 命中异常播放容错逻辑", new Object[] { Integer.valueOf(this.this$0.jdField_i_of_type_Int), Integer.valueOf(this.this$0.o) });
        this.this$0.a(true);
        return;
      }
      this.this$0.postDelayed(this, 250L);
    ...
    SLog.b(this.this$0.a, "[%d] CheckNeedRestart good for now", Integer.valueOf(this.this$0.jdField_i_of_type_Int));
  }
}
