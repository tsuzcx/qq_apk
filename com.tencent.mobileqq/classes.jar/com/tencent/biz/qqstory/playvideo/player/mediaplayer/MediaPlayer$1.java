  ...
  implements MediaCodecDecoder.OnDecoderEventListener
{
  ...
  public void a(MediaCodecDecoder paramMediaCodecDecoder)
  {
    ...
    {
      this.a.e = true;
      this.a.jdField_a_of_type_ComTencentBizQqstoryPlayvideoPlayerMediaplayerMediaPlayer$EventHandler.sendMessage(this.a.jdField_a_of_type_ComTencentBizQqstoryPlayvideoPlayerMediaplayerMediaPlayer$EventHandler.obtainMessage(200, 701, 0));
    }
  }
}
