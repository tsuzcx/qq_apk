  ...
  extends Thread
{
  ...
  public void run()
  {
    ...
    //   49: getfield 50	com/tencent/biz/qqstory/playvideo/player/mediaplayer/AudioPlayback:a	Lxrd;
    //   52: invokevirtual 55	xrd:a	()Lxre;
    //   55: astore_2
    //   56: aload_2
    //   57: ifnonnull +18 -> 75
    //   60: aload_0
    ...
    //   81: aload_2
    //   82: getfield 60	xre:jdField_a_of_type_JavaNioByteBuffer	Ljava/nio/ByteBuffer;
    //   85: aload_2
    //   86: getfield 63	xre:jdField_a_of_type_Long	J
    ...
    //   96: getfield 50	com/tencent/biz/qqstory/playvideo/player/mediaplayer/AudioPlayback:a	Lxrd;
    //   99: aload_2
    //   100: invokevirtual 70	xrd:a	(Lxre;)V
    //   103: goto -103 -> 0
    //   106: return
    ...
    //   55	2	2	localxre1	xre
    //   70	30	2	localxre2	xre
    // Exception table:
    //   from	to	target	type
    //   9	20	23	finally
    //   24	26	23	finally
