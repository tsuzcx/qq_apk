...
public class AnimationUtils
{
  public static void a(ViewGroup paramViewGroup, @NonNull AnimationParam paramAnimationParam, Animator.AnimatorListener paramAnimatorListener)
  {
    ...
    View localView = paramViewGroup.findViewById(2131377356);
    ImageView localImageView2 = (ImageView)paramViewGroup.findViewById(2131362735);
    ViewGroup localViewGroup = (ViewGroup)paramViewGroup.findViewById(2131381592);
    ...
    paramViewGroup.addUpdateListener(new AnimationUtils.1(localViewGroup, localDrawable, localImageView1, localImageView2));
    paramViewGroup.addListener(new AnimationUtils.2(paramAnimatorListener));
  ...
  public static void b(ViewGroup paramViewGroup, @NonNull AnimationParam paramAnimationParam, Animator.AnimatorListener paramAnimatorListener)
  {
    ...
    Object localObject = paramViewGroup.findViewById(2131377356);
    ImageView localImageView = (ImageView)paramViewGroup.findViewById(2131362735);
    ViewGroup localViewGroup = (ViewGroup)paramViewGroup.findViewById(2131381592);
