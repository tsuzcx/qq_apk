...
{
  private static final String jdField_b_of_type_JavaLangString = ajya.a(2131711137);
  public int a;
  ...
  public QQStoryWatcherListActivity()
  {
    ...
    this.jdField_a_of_type_Uyi = new tui(this);
  }
  ...
  private void b(boolean paramBoolean1, boolean paramBoolean2, List<QQUserUIItem> paramList)
  {
    ...
    if (paramList != null)
    {
      ...
      for (;;)
      {
        ...
        break;
        this.jdField_a_of_type_Ujp.b(paramList);
      }
      label153:
      a(1);
      return;
  ...
  public void a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_c_of_type_AndroidWidgetTextView.setText(ajya.a(2131711136));
      ...
      this.jdField_c_of_type_AndroidWidgetTextView.setOnClickListener(null);
      continue;
      if (this.jdField_a_of_type_Tuj.a >= 2000L)
      {
        a(0);
      }
      else
      {
        this.jdField_b_of_type_AndroidViewView.setVisibility(0);
        String str = String.format("%s人累计浏览%s次", new Object[] { vzl.a(this.jdField_a_of_type_Tuj.a), vzl.a(this.jdField_a_of_type_Tuj.b) });
        ...
        continue;
        this.jdField_b_of_type_AndroidViewView.setVisibility(0);
        this.jdField_c_of_type_AndroidWidgetTextView.setText(ajya.a(2131711142));
        this.jdField_c_of_type_AndroidWidgetTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
        ((Animatable)this.jdField_a_of_type_AndroidGraphicsDrawableDrawable).stop();
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    super.setContentView(2131561441);
    super.setTitle(jdField_b_of_type_JavaLangString);
    this.leftView.setText(2131690572);
    super.findViewById(2131375493).setBackgroundColor(getResources().getColor(2131166912));
    this.jdField_a_of_type_AndroidViewView = super.findViewById(2131373215);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131373392));
    this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)super.findViewById(2131379360));
    this.jdField_c_of_type_AndroidViewView = super.findViewById(2131365680);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131375205));
    try
    {
      this.jdField_b_of_type_AndroidWidgetTextView.setCompoundDrawablesWithIntrinsicBounds(0, 2130845722, 0, 0);
      this.jdField_b_of_type_AndroidWidgetTextView.setOnClickListener(this);
      this.jdField_b_of_type_AndroidViewView = LayoutInflater.from(this).inflate(2131561439, null);
      ...
      this.jdField_a_of_type_Ujp = new ujp(this, null);
      this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Ujp);
      this.jdField_a_of_type_ComTencentWidgetXListView.setOnScrollListener(new tuh(this));
    ...
    catch (OutOfMemoryError paramBundle)
    {
      ...
      this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelVideoListFeedItem = ((VideoListFeedItem)((uvx)tcz.a(11)).a(this.jdField_a_of_type_JavaLangString));
      if ((this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelVideoListFeedItem != null) && (this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelVideoListFeedItem.mViewTotalTime > 0L)) {
        super.setTitle(jdField_b_of_type_JavaLangString + vzl.a(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelVideoListFeedItem.mViewTotalTime));
      }
      ...
      this.jdField_a_of_type_Tuj = new tuj(this, this.jdField_a_of_type_JavaLangString);
      this.jdField_a_of_type_Tuj.a();
    }
    return true;
  }
  ...
  public void onClick(View paramView)
  {
    ...
    if (i == 2131375205) {
      if (this.jdField_a_of_type_Tuj != null)
      {
        this.jdField_a_of_type_Tuj.a();
    ...
    a(1);
    tuj.a(this.jdField_a_of_type_Tuj);
  }
}
