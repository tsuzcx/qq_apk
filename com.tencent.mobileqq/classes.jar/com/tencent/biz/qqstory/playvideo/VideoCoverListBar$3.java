  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    xvv.a("Q.qqstory.player:VideoCoverListBar", "notify cover list changed , new index = %d , total size = %d", Integer.valueOf(this.a), Integer.valueOf(VideoCoverListBar.a(this.this$0).size()));
  }
}
