  ...
  extends OnSimpleShareListener
{
  ...
  public void b(int paramInt)
  {
    ...
    if (SendVideoToFriendHelper.a().a()) {
      QQToast.a(this.jdField_a_of_type_ComTencentBizQqstoryPlayvideoPlayerwidgetBottomVideoInfoWidget.b(), 0, HardCodeUtil.a(2131701254), 0).a();
    }
    for (;;)
    {
      ...
      {
        QQToast.a(this.jdField_a_of_type_ComTencentBizQqstoryPlayvideoPlayerwidgetBottomVideoInfoWidget.b(), 1, HardCodeUtil.a(2131701256), 0).a();
    ...
    if (SendVideoToFriendHelper.a().a())
    {
      QQToast.a(this.jdField_a_of_type_ComTencentBizQqstoryPlayvideoPlayerwidgetBottomVideoInfoWidget.b(), 0, HardCodeUtil.a(2131701249), 0).a();
      return;
    }
    if (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentBizQqstoryModelItemStoryVideoItem.mLocalVideoPath))
    {
      ...
      str2 = this.jdField_a_of_type_ComTencentBizQqstoryPlayvideoPlayerwidgetBottomVideoInfoWidget.a(this.jdField_a_of_type_ComTencentBizQqstoryModelItemStoryVideoItem);
    ...
    for (String str1 = "2";; str1 = "1")
    {
      ...
      PlayModeUtils.a(this.jdField_a_of_type_ComTencentBizQqstoryModelItemStoryVideoItem, this.jdField_a_of_type_ComTencentBizQqstoryModelItemStoryVideoItem.mStoryType, String.valueOf(this.jdField_a_of_type_ComTencentBizQqstoryPlayvideoPlayerwidgetBottomVideoInfoWidget.hashCode()));
      break;
