...
{
  public static final String TAG = "QimSegmentMergeUtil";
  
  public ArrayList<Long> getMergeVideoPositions(List<String> paramList)
  {
  ...
  public ArrayList<Long> getMergeVideoPositionsForFFmpeg(List<String> paramList, String paramString)
  {
  ...
  public ArrayList<Long> getMergeVideoPositionsForFFmpegNewClip(List<String> paramList, String paramString)
  {
    if ((paramList == null) || (paramList.size() == 1) || (TextUtils.isEmpty(paramString))) {
      return null;
    }
  ...
  public ArrayList<Long> getMergeVideoPositionsNewClip(List<String> paramList)
  {
    if ((paramList == null) || (paramList.size() == 1)) {
      return null;
    }
  ...
  /* Error */
  public boolean mergeAudioCache(List<String> paramList, String paramString)
  {
    // Byte code:
    //   0: new 123	java/io/FileOutputStream
    //   3: dup
    //   4: new 125	java/io/File
    //   7: dup
    //   8: aload_2
    //   9: invokespecial 128	java/io/File:<init>	(Ljava/lang/String;)V
    //   12: invokespecial 131	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   15: astore 6
    //   17: iconst_0
    //   18: istore_3
    //   19: aload 6
    ...
    //   22: iload_3
    //   23: aload_1
    //   24: invokeinterface 24 1 0
    //   29: if_icmpge +202 -> 231
    //   32: aload 6
    //   34: astore_2
    //   35: new 133	java/io/RandomAccessFile
    //   38: dup
    //   39: aload_1
    //   40: iload_3
    //   41: invokeinterface 134 2 0
    //   46: checkcast 45	java/lang/String
    //   49: ldc 136
    //   51: invokespecial 139	java/io/RandomAccessFile:<init>	(Ljava/lang/String;Ljava/lang/String;)V
    //   54: astore 7
    //   56: aload 6
    //   58: astore_2
    //   59: ldc 140
    ...
    //   65: aload 7
    //   67: aload 8
    //   69: invokevirtual 144	java/io/RandomAccessFile:read	([B)I
    //   72: istore 4
    //   74: iload 4
    //   76: iconst_m1
    //   77: if_icmpeq +45 -> 122
    ...
    //   84: iconst_0
    //   85: iload 4
    //   87: invokevirtual 148	java/io/FileOutputStream:write	([BII)V
    //   90: goto -25 -> 65
    //   93: astore_1
    //   94: aload_1
    //   95: invokevirtual 151	java/lang/Exception:printStackTrace	()V
    //   98: aload 6
    //   100: astore_2
    //   101: aload 7
    //   103: invokevirtual 154	java/io/RandomAccessFile:close	()V
    //   106: aload 6
    //   108: ifnull +8 -> 116
    //   111: aload 6
    //   113: invokevirtual 155	java/io/FileOutputStream:close	()V
    //   116: iconst_0
    //   117: istore 5
    //   119: iload 5
    //   121: ireturn
    ...
    //   124: astore_2
    //   125: aload 7
    //   127: invokevirtual 154	java/io/RandomAccessFile:close	()V
    //   130: iload_3
    //   131: iconst_1
    //   132: iadd
    //   133: istore_3
    ...
    //   141: astore_2
    //   142: aload 7
    //   144: invokevirtual 151	java/lang/Exception:printStackTrace	()V
    //   147: goto -17 -> 130
    //   150: astore_2
    //   151: aload 6
    //   153: astore_1
    ...
    //   158: astore_2
    //   159: aload 6
    //   161: invokevirtual 151	java/lang/Exception:printStackTrace	()V
    //   164: aload_1
    //   165: ifnull +7 -> 172
    //   168: aload_1
    ...
    //   177: astore_2
    //   178: aload_1
    //   179: invokevirtual 151	java/lang/Exception:printStackTrace	()V
    //   182: goto -76 -> 106
    //   185: astore_1
    //   186: aload_2
    //   187: ifnull +7 -> 194
    //   190: aload_2
    //   191: invokevirtual 155	java/io/FileOutputStream:close	()V
    //   194: aload_1
    //   195: athrow
    //   196: astore_1
    //   197: aload_1
    ...
    //   207: astore_2
    //   208: aload 7
    //   210: invokevirtual 154	java/io/RandomAccessFile:close	()V
    //   213: aload 6
    //   215: astore_2
    //   216: aload_1
    //   217: athrow
    ...
    //   233: astore_2
    //   234: aload 6
    //   236: invokevirtual 155	java/io/FileOutputStream:close	()V
    //   239: iconst_1
    //   240: istore 5
    //   242: aload 6
    //   244: ifnull -125 -> 119
    ...
    //   254: astore_1
    //   255: aload_1
    //   256: invokevirtual 156	java/io/IOException:printStackTrace	()V
    //   259: iconst_1
    //   260: ireturn
    //   261: astore_1
    //   262: aload_1
    //   263: invokevirtual 156	java/io/IOException:printStackTrace	()V
    //   266: goto -94 -> 172
    //   269: astore_2
    //   270: aload_2
    //   271: invokevirtual 156	java/io/IOException:printStackTrace	()V
    //   274: goto -80 -> 194
    //   277: astore_1
    //   278: aconst_null
    //   279: astore_2
  ...
  public boolean startMergeVideoWithoutAudioSync(List<String> paramList, String paramString, int paramInt1, int paramInt2, MediaFormat paramMediaFormat)
  {
    int i = 0;
    Object localObject4;
