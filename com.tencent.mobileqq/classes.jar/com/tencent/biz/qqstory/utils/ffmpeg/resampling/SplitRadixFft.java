...
public class SplitRadixFft
{
  private void a(int paramInt1, double[] paramArrayOfDouble1, int paramInt2, int paramInt3, double[] paramArrayOfDouble2)
  {
    int i = paramInt1 >> 2;
    int j = i * 2;
    a(paramInt1, paramArrayOfDouble1, paramInt2, paramArrayOfDouble2, paramInt3 - j);
    if (paramInt1 > 512)
    {
      ...
      a(i, paramArrayOfDouble1, paramInt2 + j, paramInt3, paramArrayOfDouble2);
  ...
  private void c(int paramInt1, double[] paramArrayOfDouble1, int paramInt2, int paramInt3, double[] paramArrayOfDouble2)
  {
    ...
    while (i > 128)
    {
      ...
      while (j < paramInt1)
      {
        ...
        {
          m = paramInt3 - (i >> 1);
          a(i, paramArrayOfDouble1, paramInt2 + k, paramArrayOfDouble2, m);
          b(i, paramArrayOfDouble1, paramInt2 + j + k, paramArrayOfDouble2, paramInt3 - i);
          a(i, paramArrayOfDouble1, paramInt2 + j * 2 + k, paramArrayOfDouble2, m);
          k += j * 4;
        }
        j <<= 2;
      }
    ...
    while (j < paramInt1)
    {
      ...
      while (k < paramInt1)
      {
        int n = paramInt2 + k;
        m = paramInt3 - (i >> 1);
        a(i, paramArrayOfDouble1, n, paramArrayOfDouble2, m);
        e(i, paramArrayOfDouble1, n, paramInt3, paramArrayOfDouble2);
        n = paramInt2 + j + k;
        b(i, paramArrayOfDouble1, n, paramArrayOfDouble2, paramInt3 - i);
        f(i, paramArrayOfDouble1, n, paramInt3, paramArrayOfDouble2);
        n = paramInt2 + j * 2 + k;
        a(i, paramArrayOfDouble1, n, paramArrayOfDouble2, m);
        e(i, paramArrayOfDouble1, n, paramInt3, paramArrayOfDouble2);
        k += j * 4;
    ...
    a(i, paramArrayOfDouble1, paramInt1, paramArrayOfDouble2, paramInt3 - (i >> 1));
    e(i, paramArrayOfDouble1, paramInt1, paramInt3, paramArrayOfDouble2);
  }
  ...
  private void d(int paramInt1, double[] paramArrayOfDouble1, int paramInt2, int paramInt3, double[] paramArrayOfDouble2)
  {
    ...
    while (paramInt1 > 128)
    {
      ...
      while (i < k)
      {
        ...
        while (j < k)
        {
          ...
          a(paramInt1, paramArrayOfDouble1, paramInt2 + j, paramArrayOfDouble2, m);
          a(paramInt1, paramArrayOfDouble1, paramInt2 + k + j, paramArrayOfDouble2, m);
          j += i * 2;
        }
        j = i * 2 - paramInt1;
        while (j < k)
        {
          ...
          b(paramInt1, paramArrayOfDouble1, paramInt2 + j, paramArrayOfDouble2, m);
          b(paramInt1, paramArrayOfDouble1, paramInt2 + k + j, paramArrayOfDouble2, m);
          j += i * 4;
        }
        i <<= 2;
      }
    ...
    while (i < k)
    {
      ...
      while (j < k)
      {
        n = paramInt2 + j;
        m = paramInt3 - (paramInt1 >> 1);
        a(paramInt1, paramArrayOfDouble1, n, paramArrayOfDouble2, m);
        e(paramInt1, paramArrayOfDouble1, n, paramInt3, paramArrayOfDouble2);
        n = paramInt2 + k + j;
        a(paramInt1, paramArrayOfDouble1, n, paramArrayOfDouble2, m);
        e(paramInt1, paramArrayOfDouble1, n, paramInt3, paramArrayOfDouble2);
        j += i * 2;
      ...
      while (j < k)
      {
        n = paramInt2 + j;
        m = paramInt3 - paramInt1;
        b(paramInt1, paramArrayOfDouble1, n, paramArrayOfDouble2, m);
        f(paramInt1, paramArrayOfDouble1, n, paramInt3, paramArrayOfDouble2);
        n = paramInt2 + k + j;
        b(paramInt1, paramArrayOfDouble1, n, paramArrayOfDouble2, m);
        f(paramInt1, paramArrayOfDouble1, n, paramInt3, paramArrayOfDouble2);
        j += i * 4;
  ...
  private void e(int paramInt1, double[] paramArrayOfDouble1, int paramInt2, int paramInt3, double[] paramArrayOfDouble2)
  {
    if (paramInt1 == 128)
    {
      ...
      a(paramArrayOfDouble1, paramInt2, paramArrayOfDouble2, paramInt1);
      b(paramArrayOfDouble1, paramInt2 + 32, paramArrayOfDouble2, paramInt3 - 32);
      a(paramArrayOfDouble1, paramInt2 + 64, paramArrayOfDouble2, paramInt1);
      a(paramArrayOfDouble1, paramInt2 + 96, paramArrayOfDouble2, paramInt1);
      return;
    }
    paramInt1 = paramInt3 - 16;
    c(paramArrayOfDouble1, paramInt2, paramArrayOfDouble2, paramInt1);
    d(paramArrayOfDouble1, paramInt2 + 16, paramArrayOfDouble2, paramInt1);
    c(paramArrayOfDouble1, paramInt2 + 32, paramArrayOfDouble2, paramInt1);
    c(paramArrayOfDouble1, paramInt2 + 48, paramArrayOfDouble2, paramInt1);
  }
  ...
  private void f(int paramInt1, double[] paramArrayOfDouble1, int paramInt2, int paramInt3, double[] paramArrayOfDouble2)
  {
    if (paramInt1 == 128)
    {
      ...
      a(paramArrayOfDouble1, paramInt2, paramArrayOfDouble2, paramInt1);
      paramInt3 -= 32;
      b(paramArrayOfDouble1, paramInt2 + 32, paramArrayOfDouble2, paramInt3);
      a(paramArrayOfDouble1, paramInt2 + 64, paramArrayOfDouble2, paramInt1);
      b(paramArrayOfDouble1, paramInt2 + 96, paramArrayOfDouble2, paramInt3);
      return;
    }
    paramInt1 = paramInt3 - 16;
    c(paramArrayOfDouble1, paramInt2, paramArrayOfDouble2, paramInt1);
    d(paramArrayOfDouble1, paramInt2 + 16, paramArrayOfDouble2, paramInt1);
    c(paramArrayOfDouble1, paramInt2 + 32, paramArrayOfDouble2, paramInt1);
    d(paramArrayOfDouble1, paramInt2 + 48, paramArrayOfDouble2, paramInt1);
  }
 ...
 * Qualified Name:     com.tencent.biz.qqstory.utils.ffmpeg.resampling.SplitRadixFft
