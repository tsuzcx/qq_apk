  ...
  implements View.OnAttachStateChangeListener, View.OnClickListener, View.OnLayoutChangeListener, PollWidgetUtils.IPollWidget
{
  ...
  public PollWidgetUtils$WidgetWrapper(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)LayoutInflater.from(paramContext).inflate(2131561013, null, false));
    ...
    this.jdField_a_of_type_ComTencentBizQqstoryUtilsPollWidgetUtils$QuestionElement = new PollWidgetUtils.QuestionElement(this, this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131379129));
    this.jdField_a_of_type_ComTencentBizQqstoryUtilsPollWidgetUtils$OptionElement = new PollWidgetUtils.SingleOptionElement(this, this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131370156), 0);
    ...
    this.jdField_b_of_type_ComTencentBizQqstoryUtilsPollWidgetUtils$OptionElement = new PollWidgetUtils.SingleOptionElement(this, this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131370157), 1);
  ...
  public void a(List<QQUserUIItem> paramList, int paramInt)
  {
    ...
    do
    {
      ...
      localObject1 = (ViewGroup)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131370211);
    ...
    while (paramInt < i)
    {
      ...
      for (;;)
      {
        ...
        break;
        Drawable localDrawable = BaseApplicationImpl.getApplication().getResources().getDrawable(2130846815);
    ...
    if (k <= j) {}
    for (paramList = String.format(Locale.getDefault(), "%d人参与 >", new Object[] { Integer.valueOf(k) });; paramList = String.format(Locale.getDefault(), HardCodeUtil.a(2131708314), new Object[] { Integer.valueOf(k) }))
    {
      ((TextView)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131379246)).setText(paramList);
      return;
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    while (i < j)
    {
      arrayOfWidgetElement[i].d(paramBoolean);
      i += 1;
    }
  }
  ...
  {
    AnimationDrawable localAnimationDrawable = (AnimationDrawable)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131363419).getBackground();
    ...
    for (;;)
    {
      ((PollWidgetUtils.SingleOptionElement)this.jdField_a_of_type_ComTencentBizQqstoryUtilsPollWidgetUtils$OptionElement).c(paramBoolean);
      ((PollWidgetUtils.SingleOptionElement)this.jdField_b_of_type_ComTencentBizQqstoryUtilsPollWidgetUtils$OptionElement).c(paramBoolean);
      return;
      label52:
  ...
  public void onViewAttachedToWindow(View paramView)
  {
    ...
    if (paramView.getId() == 2131373354)
    {
      this.jdField_b_of_type_AndroidViewViewGroup = ((ViewGroup)((ViewGroup)LayoutInflater.from(this.jdField_a_of_type_AndroidViewViewGroup.getContext()).inflate(2131561012, paramView)).findViewById(2131365731));
      ((TextView)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131379140)).setText(String.format(Locale.getDefault(), "%d", new Object[] { Integer.valueOf(this.jdField_b_of_type_AndroidViewViewGroup.hashCode()) }));
