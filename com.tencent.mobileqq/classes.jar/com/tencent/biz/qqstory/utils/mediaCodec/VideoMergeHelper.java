...
public class VideoMergeHelper
{
  ...
  private VideoMergeHelper.SampaleData jdField_a_of_type_ComTencentBizQqstoryUtilsMediaCodecVideoMergeHelper$SampaleData = new VideoMergeHelper.SampaleData(null);
  ...
  public VideoMergeHelper(String paramString1, String paramString2, long paramLong1, long paramLong2)
  {
  ...
  {
    paramString2 = new VideoMergeHelper(paramString1, paramString2, 0L, 0L);
  ...
  {
    paramString2 = new VideoMergeHelper(paramString1, paramString2, paramLong1, paramLong2);
    int i = paramString2.a(paramString3, paramInt);
    if ((i == -2) || (i == -4) || (i == -6)) {
      if (new File(paramString1).renameTo(new File(paramString3))) {
        paramInt = 0;
  ...
  private void a()
  {
    ...
    while ((!bool2) || (i == 0))
    {
      ...
      if (!bool2)
      {
        ...
        if (!bool2)
        {
          this.jdField_a_of_type_AndroidMediaMediaMuxer.writeSampleData(this.jdField_a_of_type_ComTencentBizQqstoryUtilsMediaCodecVideoMergeHelper$SampaleData.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentBizQqstoryUtilsMediaCodecVideoMergeHelper$SampaleData.jdField_a_of_type_JavaNioByteBuffer, this.jdField_a_of_type_ComTencentBizQqstoryUtilsMediaCodecVideoMergeHelper$SampaleData.jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo);
          bool1 = bool2;
        }
      }
      bool2 = bool1;
      if (i == 0)
      {
        ...
        if (!bool3)
        {
          this.jdField_a_of_type_AndroidMediaMediaMuxer.writeSampleData(this.jdField_a_of_type_ComTencentBizQqstoryUtilsMediaCodecVideoMergeHelper$SampaleData.jdField_b_of_type_Int, this.jdField_a_of_type_ComTencentBizQqstoryUtilsMediaCodecVideoMergeHelper$SampaleData.jdField_a_of_type_JavaNioByteBuffer, this.jdField_a_of_type_ComTencentBizQqstoryUtilsMediaCodecVideoMergeHelper$SampaleData.jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo);
          bool2 = bool1;
          i = bool3;
        }
      }
  ...
  private boolean a()
  {
    this.jdField_a_of_type_ComTencentBizQqstoryUtilsMediaCodecVideoMergeHelper$SampaleData.jdField_a_of_type_JavaNioByteBuffer.position(0);
    if (this.jdField_a_of_type_AndroidMediaMediaExtractor == null) {}
    int i;
    do
    {
      return true;
      i = this.jdField_a_of_type_AndroidMediaMediaExtractor.readSampleData(this.jdField_a_of_type_ComTencentBizQqstoryUtilsMediaCodecVideoMergeHelper$SampaleData.jdField_a_of_type_JavaNioByteBuffer, 0);
    } while (i <= 0);
    this.jdField_a_of_type_ComTencentBizQqstoryUtilsMediaCodecVideoMergeHelper$SampaleData.jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo.presentationTimeUs = this.jdField_a_of_type_AndroidMediaMediaExtractor.getSampleTime();
    this.jdField_a_of_type_ComTencentBizQqstoryUtilsMediaCodecVideoMergeHelper$SampaleData.jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo.size = i;
    this.jdField_a_of_type_ComTencentBizQqstoryUtilsMediaCodecVideoMergeHelper$SampaleData.jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo.offset = 0;
    this.jdField_a_of_type_ComTencentBizQqstoryUtilsMediaCodecVideoMergeHelper$SampaleData.jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo.flags = this.jdField_a_of_type_AndroidMediaMediaExtractor.getSampleFlags();
  ...
  private int b()
  {
    int i = 0;
    this.jdField_a_of_type_ComTencentBizQqstoryUtilsMediaCodecVideoMergeHelper$SampaleData.jdField_a_of_type_JavaNioByteBuffer.position(0);
    if (this.jdField_a_of_type_AndroidMediaMediaExtractor.readSampleData(this.jdField_a_of_type_ComTencentBizQqstoryUtilsMediaCodecVideoMergeHelper$SampaleData.jdField_a_of_type_JavaNioByteBuffer, 0) <= 0)
    {
      b();
      i = -5;
    }
    do
    {
      return i;
      this.jdField_a_of_type_ComTencentBizQqstoryUtilsMediaCodecVideoMergeHelper$SampaleData.jdField_a_of_type_JavaNioByteBuffer.position(0);
    } while (this.jdField_b_of_type_AndroidMediaMediaExtractor.readSampleData(this.jdField_a_of_type_ComTencentBizQqstoryUtilsMediaCodecVideoMergeHelper$SampaleData.jdField_a_of_type_JavaNioByteBuffer, 0) > 0);
    b();
    return -6;
  }
  ...
  private boolean b()
  {
    ...
    int i = this.jdField_b_of_type_AndroidMediaMediaExtractor.readSampleData(this.jdField_a_of_type_ComTencentBizQqstoryUtilsMediaCodecVideoMergeHelper$SampaleData.jdField_a_of_type_JavaNioByteBuffer, 0);
    ...
    this.jdField_a_of_type_ComTencentBizQqstoryUtilsMediaCodecVideoMergeHelper$SampaleData.jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo.presentationTimeUs = l;
    this.jdField_a_of_type_ComTencentBizQqstoryUtilsMediaCodecVideoMergeHelper$SampaleData.jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo.size = i;
    this.jdField_a_of_type_ComTencentBizQqstoryUtilsMediaCodecVideoMergeHelper$SampaleData.jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo.offset = 0;
    this.jdField_a_of_type_ComTencentBizQqstoryUtilsMediaCodecVideoMergeHelper$SampaleData.jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo.flags = this.jdField_b_of_type_AndroidMediaMediaExtractor.getSampleFlags();
  ...
  public int a(String paramString, int paramInt)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_ComTencentBizQqstoryUtilsMediaCodecVideoMergeHelper$SampaleData.a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
      j = b();
      i = j;
    } while (j != 0);
    if (TextUtils.isEmpty(paramString))
    ...
    try
    {
      ...
      this.jdField_a_of_type_ComTencentBizQqstoryUtilsMediaCodecVideoMergeHelper$SampaleData.jdField_a_of_type_Int = this.jdField_a_of_type_AndroidMediaMediaMuxer.addTrack(localMediaFormat1);
      this.jdField_a_of_type_ComTencentBizQqstoryUtilsMediaCodecVideoMergeHelper$SampaleData.jdField_b_of_type_Int = this.jdField_a_of_type_AndroidMediaMediaMuxer.addTrack(localMediaFormat2);
      return j;
    }
