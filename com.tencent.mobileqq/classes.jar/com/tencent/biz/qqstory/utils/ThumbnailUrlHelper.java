...
public class ThumbnailUrlHelper
{
  ...
  public static String a(Context paramContext, String paramString)
  {
    ...
    if (!a(paramString))
    {
      SLog.d("Q.qqstory.home.ThumbnailUrlHelper", "not qqstory url for getFullScreenThumbnailPath " + paramString);
      return paramString;
    }
    paramString = d(paramString);
    int i = a(UIUtils.a(paramContext));
    SLog.b("Q.qqstory.home.ThumbnailUrlHelper", "get fullscreen thumbnail url " + paramString + i);
  ...
  public static String a(String paramString)
  {
    ...
    if (i < 0)
    {
      SLog.d("Q.qqstory.home.ThumbnailUrlHelper", "cannot find thumbsize in getMinimumThumbnailPath " + paramString);
      return paramString;
    }
    paramString = d(paramString);
    SLog.b("Q.qqstory.home.ThumbnailUrlHelper", "getMinimumThumbnailPath " + paramString + i);
    return paramString + i;
  }
  
  private static void a()
  {
    Object localObject = StoryConfigManager.h();
    SLog.b("Q.qqstory.home.ThumbnailUrlHelper", "Json config in string " + (String)localObject);
    ...
    for (;;)
    {
      ...
      try
      {
        SLog.b("Q.qqstory.home.ThumbnailUrlHelper", "json " + (String)localObject);
        ...
        while (i < localJSONArray1.length())
        {
          ...
          SLog.b("Q.qqstory.home.ThumbnailUrlHelper", "get key " + str);
          JSONArray localJSONArray2 = ((JSONObject)localObject).getJSONArray(str);
          SLog.b("Q.qqstory.home.ThumbnailUrlHelper", "get specs " + localJSONArray2);
  ...
  private static int b(String paramString, int paramInt)
  {
    ...
    if (str == null)
    {
      SLog.d("Q.qqstory.home.ThumbnailUrlHelper", "cannot find bid with url " + paramString);
      return -1;
    }
    paramString = (List)jdField_a_of_type_JavaUtilMap.get(str);
    if (paramString == null)
    {
      SLog.d("Q.qqstory.home.ThumbnailUrlHelper", "cannot find specs with bid " + str + ", check log");
      return -1;
    }
    return a(paramString, paramInt);
  }
  ...
  {
    SLog.b("Q.qqstory.home.ThumbnailUrlHelper", "get thumbnail in 200 " + paramString);
    int i = b(paramString, 200);
    if (i < 0)
    {
      SLog.d("Q.qqstory.home.ThumbnailUrlHelper", "get invalid thumbsize 200 with url " + paramString);
      return paramString;
    }
    paramString = d(paramString);
    SLog.b("Q.qqstory.home.ThumbnailUrlHelper", "return thumbnail in 200 " + paramString + i);
    return paramString + i;
  }
  ...
  {
    SLog.b("Q.qqstory.home.ThumbnailUrlHelper", "get thumbnail in 320 " + paramString);
    int i = b(paramString, 320);
    if (i < 0)
    {
      SLog.d("Q.qqstory.home.ThumbnailUrlHelper", "get invalid thumbsize 320 with url " + paramString);
      return paramString;
    }
    paramString = d(paramString);
    SLog.b("Q.qqstory.home.ThumbnailUrlHelper", "return thumbnail in 320 " + paramString + i);
    return paramString + i;
  }
