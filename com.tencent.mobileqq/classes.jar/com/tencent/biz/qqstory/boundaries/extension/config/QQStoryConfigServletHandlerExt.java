  ...
  extends QQStoryConfigServletHandler
{
  private boolean a(List paramList)
  {
    ...
    for (;;)
    {
      ((QQStoryHandler)localQQAppInterface.a(98)).a(1021, true, null);
      return bool;
      ...
      if (paramList != null)
      {
        ...
        try
        {
          if (new JSONObject(paramList).getInt("StoryShowInMsgTab") != 0) {}
  ...
  public boolean a(int paramInt, Intent paramIntent, ConfigurationService.Config paramConfig, List paramList)
  {
    switch (paramInt)
    {
    default: 
