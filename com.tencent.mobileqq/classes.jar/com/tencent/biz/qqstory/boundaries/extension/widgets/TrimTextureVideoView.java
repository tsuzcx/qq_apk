  ...
  extends com.tencent.biz.qqstory.playvideo.player.TrimTextureVideoView
{
  ...
  {
    return Math.max(1.0F / bjzg.a(getResources()), Math.min(paramInt2, paramInt1) * 1.0F / Math.max(paramInt2, paramInt1));
  }
    ...
    for (int i = 0 + paramInt1;; i = 0)
    {
      ...
      if ((paramInt1 % 180 == 0) && (paramInt2 > paramInt3))
      {
        ...
        for (;;)
        {
          ...
          veg.a(this.jdField_a_of_type_JavaLangString, "adjustRotation([rotation]%d, [width]%d, [height]%d), no need rotate but need scale!", Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Integer.valueOf(paramInt3));
          return false;
