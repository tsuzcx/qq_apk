...
public class ScanTask
{
  ...
  public List<StoryAlbum.PicInfo> a(Context paramContext, long paramLong, boolean paramBoolean, int paramInt)
  {
    SLog.d("Q.qqstory.recommendAlbum.logic.StoryScanManager.ScanTask", "queryFromMediaStore : " + paramLong);
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        str = "_size<=12582912 and (_data like '%" + (String)localObject1 + "%' or " + "_data" + HardCodeUtil.a(2131713476);
        localObject1 = str;
        if (paramLong > 0L) {
        ...
        for (;;)
        {
          ...
          {
            SLog.e("Q.qqstory.recommendAlbum.logic.StoryScanManager.ScanTask", "query cursor error:" + paramContext);
            paramContext = null;
            continue;
            SLog.d("Q.qqstory.recommendAlbum.logic.StoryScanManager.ScanTask", "queryFromMediaStore DB result = " + paramContext.getCount());
            ...
            try
            {
              ...
              localObject1 = new StoryAlbum.PicInfo();
              ((StoryAlbum.PicInfo)localObject1).jdField_a_of_type_Long = paramContext.getInt(paramInt);
              ((StoryAlbum.PicInfo)localObject1).jdField_b_of_type_Long = paramContext.getLong(i);
              ((StoryAlbum.PicInfo)localObject1).jdField_a_of_type_Double = paramContext.getDouble(j);
              ((StoryAlbum.PicInfo)localObject1).jdField_b_of_type_Double = paramContext.getDouble(k);
              ((StoryAlbum.PicInfo)localObject1).jdField_b_of_type_Int = paramContext.getInt(n);
              ((StoryAlbum.PicInfo)localObject1).jdField_a_of_type_Int = paramContext.getInt(i1);
              ((StoryAlbum.PicInfo)localObject1).jdField_c_of_type_Int = paramContext.getInt(i2);
              ((StoryAlbum.PicInfo)localObject1).jdField_a_of_type_JavaLangString = paramContext.getString(i3);
              ((StoryAlbum.PicInfo)localObject1).e = paramContext.getLong(m);
              ((StoryAlbum.PicInfo)localObject1).jdField_b_of_type_JavaLangString = "";
              ((StoryAlbum.PicInfo)localObject1).jdField_d_of_type_JavaLangString = paramContext.getString(i4);
              ((StoryAlbum.PicInfo)localObject1).jdField_c_of_type_Long = paramContext.getLong(i5);
              ((StoryAlbum.PicInfo)localObject1).jdField_d_of_type_Long = ((StoryAlbum.PicInfo)localObject1).jdField_b_of_type_Long;
              if (FileUtil.b(((StoryAlbum.PicInfo)localObject1).jdField_a_of_type_JavaLangString)) {
                continue;
              }
            ...
            {
              SLog.e("Q.qqstory.recommendAlbum.logic.StoryScanManager.ScanTask", "write to db error:" + localException);
              paramContext.close();
            ...
            SLog.d("Q.qqstory.recommendAlbum.logic.StoryScanManager.ScanTask", "queryFromMediaStore match result = " + localArrayList.size());
            return localArrayList;
            if (!a((StoryAlbum.PicInfo)localObject1)) {
              continue;
            }
            ((EntityManager)localObject3).persistOrReplace(((StoryAlbum.PicInfo)localObject1).a());
