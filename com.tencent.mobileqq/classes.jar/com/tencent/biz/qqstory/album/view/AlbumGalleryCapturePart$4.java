...
public class AlbumGalleryCapturePart$4
  implements Runnable
{
  public AlbumGalleryCapturePart$4(sez paramsez) {}
  
  public void run()
  {
    sez.a(this.this$0, true);
    ...
    if ((sez.b(this.this$0)) && (localView != null) && (sez.a(this.this$0).getPosition(localView) == 0)) {
      sez.a(this.this$0).a(-(sez.a(this.this$0) - (int)vms.a(sez.a(this.this$0).getContext(), 30.0F)), 0, 1250);
    }
    sez.b(this.this$0, false);
  }
}
