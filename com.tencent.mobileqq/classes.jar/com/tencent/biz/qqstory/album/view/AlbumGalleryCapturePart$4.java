...
public class AlbumGalleryCapturePart$4
  implements Runnable
{
  public AlbumGalleryCapturePart$4(ugk paramugk) {}
  
  public void run()
  {
    ugk.a(this.this$0, true);
    ...
    if ((ugk.b(this.this$0)) && (localView != null) && (ugk.a(this.this$0).getPosition(localView) == 0)) {
      ugk.a(this.this$0).a(-(ugk.a(this.this$0) - (int)xod.a(ugk.a(this.this$0).getContext(), 30.0F)), 0, 1250);
    }
    ugk.b(this.this$0, false);
  }
}
