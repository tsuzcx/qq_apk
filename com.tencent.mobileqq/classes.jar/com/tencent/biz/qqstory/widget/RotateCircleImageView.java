  ...
  extends ImageView
{
  ...
  private static final SparseArray<RotateCircleImageView.BorderStyle> jdField_a_of_type_AndroidUtilSparseArray = new vru(2);
  ...
  private void f()
  {
    if (this.jdField_a_of_type_AndroidAnimationValueAnimator == null)
    {
      ...
      this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new vrv(this));
    ...
    if (this.jdField_b_of_type_AndroidAnimationValueAnimator == null)
    {
      ...
      this.jdField_b_of_type_AndroidAnimationValueAnimator.addUpdateListener(new vrw(this));
      this.jdField_b_of_type_AndroidAnimationValueAnimator.addListener(new vrx(this));
    }
    if (this.jdField_c_of_type_AndroidAnimationValueAnimator == null)
    {
      ...
      this.jdField_c_of_type_AndroidAnimationValueAnimator.addUpdateListener(new vry(this));
    }
    ...
    if (this.jdField_d_of_type_AndroidAnimationValueAnimator == null)
    {
      ...
      this.jdField_d_of_type_AndroidAnimationValueAnimator.addUpdateListener(new vrz(this));
      this.jdField_d_of_type_AndroidAnimationValueAnimator.addListener(new vsa(this));
    }
    if (this.jdField_e_of_type_AndroidAnimationValueAnimator == null)
    {
      ...
      this.jdField_e_of_type_AndroidAnimationValueAnimator.addUpdateListener(new vsb(this));
    }
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    switch (vsc.jdField_a_of_type_ArrayOfInt[this.jdField_a_of_type_ComTencentBizQqstoryWidgetRotateCircleImageView$BorderStyle.ordinal()])
    {
    default: 
      return;
    case 1: 
