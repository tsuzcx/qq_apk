  ...
  extends ImageView
{
  ...
  private static final SparseArray<RotateCircleImageView.BorderStyle> jdField_a_of_type_AndroidUtilSparseArray = new wen(2);
  ...
  private void f()
  {
    if (this.jdField_a_of_type_AndroidAnimationValueAnimator == null)
    {
      ...
      this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new weo(this));
    ...
    if (this.jdField_b_of_type_AndroidAnimationValueAnimator == null)
    {
      ...
      this.jdField_b_of_type_AndroidAnimationValueAnimator.addUpdateListener(new wep(this));
      this.jdField_b_of_type_AndroidAnimationValueAnimator.addListener(new weq(this));
    }
    if (this.jdField_c_of_type_AndroidAnimationValueAnimator == null)
    {
      ...
      this.jdField_c_of_type_AndroidAnimationValueAnimator.addUpdateListener(new wer(this));
    }
    ...
    if (this.jdField_d_of_type_AndroidAnimationValueAnimator == null)
    {
      ...
      this.jdField_d_of_type_AndroidAnimationValueAnimator.addUpdateListener(new wes(this));
      this.jdField_d_of_type_AndroidAnimationValueAnimator.addListener(new wet(this));
    }
    if (this.jdField_e_of_type_AndroidAnimationValueAnimator == null)
    {
      ...
      this.jdField_e_of_type_AndroidAnimationValueAnimator.addUpdateListener(new weu(this));
    }
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    switch (wev.jdField_a_of_type_ArrayOfInt[this.jdField_a_of_type_ComTencentBizQqstoryWidgetRotateCircleImageView$BorderStyle.ordinal()])
    {
    default: 
      return;
    case 1: 
