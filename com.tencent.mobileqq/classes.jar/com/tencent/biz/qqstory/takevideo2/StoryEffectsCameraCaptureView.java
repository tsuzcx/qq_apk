  ...
  extends EffectsCameraCaptureView
{
  ...
  public void a(int paramInt1, int paramInt2, float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, long paramLong)
  {
    if ((this.jdField_a_of_type_Boolean) && (this.r == 1)) {
      urk.b("zhiqiang", "frameToMediaCodec the last frame=" + paramLong);
    }
  ...
  public void onDrawFrame(GL10 paramGL10)
  {
    ...
    paramGL10 = this.jdField_a_of_type_Vjp;
    if (paramGL10 != null)
    {
      paramGL10.a(GlUtil.captureFrame(b(this.t), this.n, this.o, 0));
      this.jdField_a_of_type_Vjp = null;
    }
  }
  
  public void setCaptureRequest(vjp paramvjp)
  {
    this.jdField_a_of_type_Vjp = paramvjp;
  }
}
