  ...
  implements View.OnClickListener, RateWidgetRatingBar.OnRatingChangeListener
{
  ...
  private TextView jdField_a_of_type_AndroidWidgetTextView = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131380543);
  ...
  private RateWidgetRatingBar jdField_a_of_type_DovComTencentBizQqstoryTakevideoInteractRateWidgetRatingBar = (RateWidgetRatingBar)this.jdField_a_of_type_AndroidViewView.findViewById(2131376478);
  private ViewGroup jdField_b_of_type_AndroidViewViewGroup = (ViewGroup)this.jdField_a_of_type_AndroidViewView.findViewById(2131376475);
  ...
  {
    super(paramContext, 2131561015);
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoInteractRateWidgetRatingBar.setOnRatingChangeListener(this);
    try
    {
      this.jdField_b_of_type_AndroidViewViewGroup.setBackgroundResource(2130844735);
      return;
    }
    catch (OutOfMemoryError paramContext)
    {
      SLog.c("RateWidget", "RateWidget set background failed : %s", paramContext);
    }
  }
  ...
  public void a(long paramLong, int paramInt)
  {
    ...
    for (;;)
    {
      this.jdField_d_of_type_AndroidWidgetTextView.setText(paramInt + HardCodeUtil.a(2131712676));
      return;
  ...
  protected View b()
  {
    View localView = LayoutInflater.from(this.jdField_a_of_type_AndroidViewView.getContext()).inflate(2131561014, null).findViewById(2131376474);
    ...
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131380541));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131380542));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131380203));
    this.jdField_c_of_type_AndroidViewViewGroup = ((ViewGroup)localView.findViewById(2131370562));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131363027));
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      return;
      if (this.jdField_a_of_type_ComTencentBizQqstoryViewWidgetRateWidget$AttendViewClickListener != null) {
