  ...
  extends View
{
  ...
  public static void a(Context paramContext, View paramView, String paramString, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7)
  {
    ...
    {
      if (paramInt1 == 1) {}
      for (float f = bawz.a(paramContext, 5.0F);; f = -paramView.getHeight() - localTipsView.b() - bawz.a(paramContext, 5.0F))
      {
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsPaint.setTextSize(bawz.a(super.getContext(), 14.0F));
    this.jdField_b_of_type_AndroidGraphicsPaint = new Paint();
    this.jdField_b_of_type_AndroidGraphicsPaint.setAntiAlias(true);
    this.jdField_b_of_type_AndroidGraphicsPaint.setColor(Color.argb(178, 0, 0, 0));
    this.jdField_a_of_type_AndroidGraphicsPath = new Path();
    int i = bawz.a(super.getContext(), 10.0F);
  ...
  public float b()
  {
    if (this.jdField_b_of_type_Float == 0.0F)
    {
      ...
      return localFontMetrics.bottom - localFontMetrics.top + (super.getPaddingTop() + super.getPaddingBottom()) + bawz.a(super.getContext(), 6.5F);
    }
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    {
      i = bawz.a(super.getContext(), 6.5F);
      ...
      paramCanvas.drawRoundRect(this.jdField_a_of_type_AndroidGraphicsRectF, bawz.a(super.getContext(), 4.0F), bawz.a(super.getContext(), 4.0F), this.jdField_b_of_type_AndroidGraphicsPaint);
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidGraphicsPath.lineTo(f1 - bawz.a(super.getContext(), 6.5F), i);
      this.jdField_a_of_type_AndroidGraphicsPath.lineTo(f1 + bawz.a(super.getContext(), 6.5F), i);
      ...
      break;
      label289:
      j = bawz.a(super.getContext(), 6.5F);
      break label91;
      label303:
    ...
    f2 = bawz.a(super.getContext(), 6.5F);
    ...
    label470:
    for (int i = k;; i = bawz.a(super.getContext(), 6.5F))
    {
      ((Path)localObject).lineTo(f1 + f2, f3 - i);
      this.jdField_a_of_type_AndroidGraphicsPath.close();
      paramCanvas.drawPath(this.jdField_a_of_type_AndroidGraphicsPath, this.jdField_b_of_type_AndroidGraphicsPaint);
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    Paint.FontMetrics localFontMetrics = this.jdField_a_of_type_AndroidGraphicsPaint.getFontMetrics();
    this.jdField_b_of_type_Float = (localFontMetrics.bottom - localFontMetrics.top + (super.getPaddingTop() + super.getPaddingBottom()) + bawz.a(super.getContext(), 6.5F));
