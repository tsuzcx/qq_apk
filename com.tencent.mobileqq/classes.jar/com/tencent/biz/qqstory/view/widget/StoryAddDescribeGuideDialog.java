  ...
  extends ReportDialog
{
  ...
  public StoryAddDescribeGuideDialog(Context paramContext)
  {
    ...
    paramContext = LayoutInflater.from(paramContext).inflate(2131561760, null);
    super.setCanceledOnTouchOutside(true);
    super.setContentView(paramContext);
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)super.findViewById(2131368148));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)super.findViewById(2131368146));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131368177));
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setOnTouchListener(new StoryAddDescribeGuideDialog.1(this));
  }
