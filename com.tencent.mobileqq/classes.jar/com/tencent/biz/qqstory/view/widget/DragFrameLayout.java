  ...
  extends FrameLayout
{
  ...
  private zpe jdField_a_of_type_Zpe;
  protected boolean a;
  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    if (i == 2)
    {
      ...
      if (Math.abs(f2) > 1.2D * Math.abs(f1))
      {
        ...
        {
          if ((this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Zpe.a()))
          {
            this.jdField_a_of_type_Float = this.jdField_c_of_type_Float;
            this.jdField_b_of_type_Float = this.jdField_d_of_type_Float;
      ...
      else if (f1 < 0.0F)
      {
        if (this.jdField_d_of_type_Int == 0)
        {
          if ((this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Zpe.b()))
          {
            this.jdField_a_of_type_Float = this.jdField_c_of_type_Float;
            this.jdField_b_of_type_Float = this.jdField_d_of_type_Float;
      ...
      else if (f1 > 0.0F)
      {
        if (this.jdField_d_of_type_Int == 0)
        {
          if ((this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Zpe != null) && (this.jdField_a_of_type_Zpe.c()))
          {
            this.jdField_a_of_type_Float = this.jdField_c_of_type_Float;
            this.jdField_b_of_type_Float = this.jdField_d_of_type_Float;
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_d_of_type_Int != 0)
      {
        ...
        if (this.jdField_a_of_type_Zpe != null)
        {
  ...
  public void setOnDraggingListener(zpe paramzpe)
  {
    this.jdField_a_of_type_Zpe = paramzpe;
  }
  ...
  public void setSizeAndPosition(float paramFloat, int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Zpe != null) {
      this.jdField_a_of_type_Zpe.a(paramInt1, paramInt2, this.jdField_b_of_type_Int, this.jdField_c_of_type_Int, (int)(this.jdField_b_of_type_Int * f), (int)(this.jdField_c_of_type_Int * f));
    }
  }
}
