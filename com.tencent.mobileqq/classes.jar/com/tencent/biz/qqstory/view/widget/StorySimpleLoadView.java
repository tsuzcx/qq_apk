  ...
  extends RelativeLayout
{
  ...
  private void a()
  {
    ...
    localProgressBar.setIndeterminateDrawable(getContext().getResources().getDrawable(2130847135));
    localProgressBar.setId(2131370381);
    ...
    ((TextView)localObject).setText(HardCodeUtil.a(2131714359));
