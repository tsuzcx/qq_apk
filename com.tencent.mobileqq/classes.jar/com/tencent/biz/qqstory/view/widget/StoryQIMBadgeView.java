...
{
  private static final LruCache jdField_a_of_type_AndroidUtilLruCache = new LruCache(50);
  ...
  {
    if (StoryDepends.b()) {
      this.jdField_a_of_type_ComTencentMobileqqAppFriendListObserver = new ovz(this);
    }
  }
