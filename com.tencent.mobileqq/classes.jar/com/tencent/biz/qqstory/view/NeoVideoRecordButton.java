  ...
  extends RingView
{
  ...
  public NeoVideoRecordButton(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    paramContext = new yrh(-90, 270, this.jdField_a_of_type_Int, 0.0F, this.jdField_b_of_type_Int, 0.0F, -15550475, -1, Paint.Style.STROKE);
    this.jdField_a_of_type_Yrh = paramContext;
    super.a(paramContext);
    paramContext = new yrh(-90, 270, 1, 0.0F, 1, 0.0F, 1090519039, 0, Paint.Style.FILL);
    this.jdField_c_of_type_Yrh = paramContext;
    super.a(paramContext);
    paramContext = new yrh(-90, 270, this.jdField_c_of_type_Int, 0.0F, 1, 0.0F, -1, 0, Paint.Style.FILL);
    this.jdField_b_of_type_Yrh = paramContext;
    super.a(paramContext);
    ...
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new yrc(this));
    ...
    this.jdField_b_of_type_AndroidAnimationValueAnimator.addUpdateListener(new yrd(this));
    ...
    this.jdField_c_of_type_AndroidAnimationValueAnimator.addUpdateListener(new yre(this));
    setProgress(this.jdField_a_of_type_Float);
    this.jdField_b_of_type_Yrh.a();
    this.jdField_c_of_type_Yrh.a();
  }
  ...
  public void setProgress(float paramFloat)
  {
    ...
    this.jdField_a_of_type_Yrh.d = a(this.jdField_a_of_type_Float);
    b();
  }
}
