  ...
  extends RingView
{
  ...
  public NeoVideoRecordButton(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    paramContext = new wbs(-90, 270, this.jdField_a_of_type_Int, 0.0F, this.jdField_b_of_type_Int, 0.0F, -15550475, -1, Paint.Style.STROKE);
    this.jdField_a_of_type_Wbs = paramContext;
    super.a(paramContext);
    paramContext = new wbs(-90, 270, 1, 0.0F, 1, 0.0F, 1090519039, 0, Paint.Style.FILL);
    this.jdField_c_of_type_Wbs = paramContext;
    super.a(paramContext);
    paramContext = new wbs(-90, 270, this.jdField_c_of_type_Int, 0.0F, 1, 0.0F, -1, 0, Paint.Style.FILL);
    this.jdField_b_of_type_Wbs = paramContext;
    super.a(paramContext);
    ...
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new wbn(this));
    ...
    this.jdField_b_of_type_AndroidAnimationValueAnimator.addUpdateListener(new wbo(this));
    ...
    this.jdField_c_of_type_AndroidAnimationValueAnimator.addUpdateListener(new wbp(this));
    setProgress(this.jdField_a_of_type_Float);
    this.jdField_b_of_type_Wbs.a();
    this.jdField_c_of_type_Wbs.a();
  }
  ...
  public void setProgress(float paramFloat)
  {
    ...
    this.jdField_a_of_type_Wbs.d = a(this.jdField_a_of_type_Float);
    b();
  }
}
