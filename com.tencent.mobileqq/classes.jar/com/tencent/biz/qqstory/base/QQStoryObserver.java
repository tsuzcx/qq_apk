  ...
  implements BusinessObserver
{
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2, int paramInt, String paramString)
  {
    ...
    label58:
    label68:
    for (String str = HardCodeUtil.a(2131710936);; str = HardCodeUtil.a(2131710934))
    {
      ToastUtil.a().a(paramString + str + HardCodeUtil.a(2131710937));
      return;
      paramString = HardCodeUtil.a(2131710935);
      break;
    }
  }
            ...
            do
            {
              do
              {
                do
                {
                  ...
                  if (paramBoolean)
                  {
                    Bosses.get().postJob(new QQStoryObserver.1(this, "QQStoryObserver", paramObject, (Boolean)localObject1, paramBoolean, paramInt));
                    return;
                  }
                  localObject1 = ((UserManager)SuperManager.a(2)).b(paramObject);
                  if (localObject1 != null)
                  {
