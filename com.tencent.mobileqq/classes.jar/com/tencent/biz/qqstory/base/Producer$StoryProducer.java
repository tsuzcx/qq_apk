  ...
  implements Producer.IProducer<T>
{
  ...
  public T a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 30	com/tencent/biz/qqstory/base/Producer$StoryProducer:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   6: invokevirtual 45	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   9: ifne +17 -> 26
    //   12: aload_0
    //   13: getfield 23	com/tencent/biz/qqstory/base/Producer$StoryProducer:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   31: areturn
    //   32: aload_0
    //   33: getfield 23	com/tencent/biz/qqstory/base/Producer$StoryProducer:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   36: iconst_0
