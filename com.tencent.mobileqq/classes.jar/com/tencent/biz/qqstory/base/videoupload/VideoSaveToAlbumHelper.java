...
public class VideoSaveToAlbumHelper
{
  ...
  private void a(VideoSaveToAlbumHelper.VideoSaveToAlbumTaskInfo paramVideoSaveToAlbumTaskInfo)
  {
    ...
    {
      i = 2;
      str1 = FFmpegUtils.getVideoDownloadWatermarkPath(BaseApplication.getContext(), paramVideoSaveToAlbumTaskInfo.jdField_a_of_type_JavaLangString, paramVideoSaveToAlbumTaskInfo.jdField_a_of_type_Int, paramVideoSaveToAlbumTaskInfo.jdField_b_of_type_Int, i);
      ...
      localObject1 = FFmpegUtils.generateVideoVoteWidgetImage(paramVideoSaveToAlbumTaskInfo.jdField_a_of_type_ComTencentBizQqstoryModelItemStoryVideoItem$PollLayout, paramVideoSaveToAlbumTaskInfo.jdField_a_of_type_Int, paramVideoSaveToAlbumTaskInfo.jdField_b_of_type_Int);
      str2 = FFmpegUtils.generateInteractWidgetImage(paramVideoSaveToAlbumTaskInfo.jdField_a_of_type_ComTencentBizQqstoryModelItemStoryVideoItem$InteractPasterLayout, paramVideoSaveToAlbumTaskInfo.jdField_a_of_type_Int, paramVideoSaveToAlbumTaskInfo.jdField_b_of_type_Int);
    ...
    for (;;)
    {
      if ((!TextUtils.isEmpty((CharSequence)localObject2)) && (!TextUtils.isEmpty((CharSequence)localObject1)))
      {
        ...
        str2 = QQStoryConstant.k + paramVideoSaveToAlbumTaskInfo.jdField_a_of_type_JavaLangString + "_newDownloadMask.mp4";
    ...
    for (;;)
    {
      ...
      localObject1 = QQStoryConstant.k + "hflip" + paramVideoSaveToAlbumTaskInfo.jdField_a_of_type_JavaLangString + ".mp4";
      ...
      ((FFmpegCommandUnit)localObject2).arguments = new VideoSaveToAlbumHelper.2(this, paramVideoSaveToAlbumTaskInfo, j, (String)localObject1);
