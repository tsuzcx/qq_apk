  ...
  public void a(@NonNull PublishStoryVideoRequest paramPublishStoryVideoRequest, @Nullable PublishStoryVideoRespond paramPublishStoryVideoRespond, @NonNull ErrorMessage paramErrorMessage)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        break;
        if (!paramErrorMessage.feedId.equals(paramPublishStoryVideoRespond.jdField_a_of_type_JavaLangString)) {
    ...
    } while ((paramPublishStoryVideoRequest.a == null) || (paramPublishStoryVideoRequest.a.jdField_a_of_type_Int != 1));
    int i;
    int j;
    switch (((StoryVideoTaskInfo)this.a.jdField_a_of_type_ComTencentBizQqstoryBaseVideouploadTaskBaseTaskInfo).f)
    {
    default: 
      i = 0;
    ...
    label727:
    for (paramPublishStoryVideoRequest = "2";; paramPublishStoryVideoRequest = "1")
    {
