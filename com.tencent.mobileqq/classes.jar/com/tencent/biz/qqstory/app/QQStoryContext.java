  ...
  implements bdlp
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = aljq.aW + "/Tencent/com/tencent/mobileqq/";
  ...
  public static QQStoryContext a()
  {
    ...
    if ((localAppRuntime instanceof QQAppInterface)) {
      return ((uhl)BaseApplicationImpl.getApplication().getRuntime().getManager(181)).a;
    }
  ...
  public awbx a()
  {
    ...
    try
    {
      ...
      {
        localObject1 = new uqh((String)localObject1);
  ...
  public void a()
  {
    ...
    //   37: invokespecial 149	uhp:<init>	(Landroid/content/Context;)V
    //   40: invokestatic 155	com/tribe/async/async/Bosses:initWithBoss	(Landroid/content/Context;Lcom/tribe/async/async/Boss;)V
    //   43: invokestatic 160	wsu:a	()Lwsu;
    //   46: invokestatic 165	wsv:a	(Lwst;)V
    //   49: ldc 2
    //   51: monitorexit
    //   52: ldc 167
    //   54: ldc 169
    //   56: invokestatic 172	wsv:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   59: aload_0
  ...
  {
    wsv.d("Q.qqstory.user.QQStoryRuntime", "update current unionId %s", new Object[] { paramString });
    if ((!this.d.equals(paramString)) && (!"0_1000".equals(paramString)) && (!TextUtils.isEmpty(paramString)))
    {
      this.d = paramString;
      ((urk)urr.a(10)).b("qqstory_my_union_id", this.d);
    }
  }
  ...
  public String b()
  {
    ...
    {
      this.d = ((String)((urk)urr.a(10)).b("qqstory_my_union_id", "0_1000"));
      wsv.d("Q.qqstory.user.QQStoryRuntime", "get current unionId from sp %s", new Object[] { this.d });
    }
    return this.d;
  }
