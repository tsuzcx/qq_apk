  ...
  extends ImageView
{
  ...
  public int d;
  private boolean d;
  private int jdField_e_of_type_Int = aciy.a(8.0F, getResources());
  private boolean jdField_e_of_type_Boolean = true;
  private int jdField_f_of_type_Int = aciy.a(1.5F, getResources());
  private boolean jdField_f_of_type_Boolean;
  private int g = 9;
  private int h = 5;
  private int i = -16776961;
  private int j = -7829368;
  private int k = aciy.a(3.0F, getResources());
  ...
  public RoundBorderImageView(Context paramContext, @Nullable AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_Int = aciy.a(8.0F, getResources());
  ...
  private void g()
  {
    ...
    if (this.jdField_c_of_type_Float > 0.0F)
    {
      ...
      urk.a("RoundBorderImageView", "mBoarderLength = %f, gapLength = %d, max segment count = %d", Float.valueOf(this.jdField_c_of_type_Float), Integer.valueOf(this.k), Integer.valueOf(this.jdField_b_of_type_Int));
      return;
    }
    this.jdField_b_of_type_Int = 1;
    urk.a("RoundBorderImageView", "mBoarderLength = %f, gapLength = %d, max segment count fallback to %d", Float.valueOf(this.jdField_c_of_type_Float), Integer.valueOf(this.k), Integer.valueOf(this.jdField_b_of_type_Int));
  }
  ...
  {
    int m = aciy.a(paramFloat, getResources());
  ...
  public void c()
  {
    ...
    if (this.g > this.jdField_b_of_type_Int)
    {
      ...
      f1 = f2;
      if (f2 < this.jdField_f_of_type_Int + aciy.a(1.0F, getResources())) {
        f1 = this.jdField_f_of_type_Int + aciy.a(1.0F, getResources());
      }
      f2 = a();
    ...
    urk.a("RoundBorderImageView", "buildDashes length (%d), %s, %s, hash:%d", Integer.valueOf(arrayOfFloat.length), this.jdField_a_of_type_AndroidGraphicsDashPathEffect, this.jdField_b_of_type_AndroidGraphicsDashPathEffect, Integer.valueOf(hashCode()));
  }
  
  public void invalidateDrawable(@NonNull Drawable paramDrawable)
  {
    if (this.jdField_c_of_type_Boolean) {
      urk.a("RoundBorderImageView", "[DEBUG] before invalidateDrawable %d %d type %s, matrix:%s", Integer.valueOf(getDrawable().getIntrinsicWidth()), Integer.valueOf(getDrawable().getIntrinsicHeight()), getScaleType(), getImageMatrix().toShortString());
    }
    if (a(paramDrawable)) {
      urk.b("RoundBorderImageView", "[PATCH] PATCH for vivo");
    }
    for (;;)
    {
      if (this.jdField_c_of_type_Boolean) {
        urk.a("RoundBorderImageView", "[DEBUG] after invalidateDrawable %d %d type %s, matrix:%s", Integer.valueOf(getDrawable().getIntrinsicWidth()), Integer.valueOf(getDrawable().getIntrinsicHeight()), getScaleType(), getImageMatrix().toShortString());
      }
  ...
  {
    if (this.jdField_c_of_type_Boolean) {
      urk.a("RoundBorderImageView", "[DEBUG] requestLayout %d %d type %s, matrix:%s", Integer.valueOf(getDrawable().getIntrinsicWidth()), Integer.valueOf(getDrawable().getIntrinsicHeight()), getScaleType(), getImageMatrix().toShortString());
    }
    super.requestLayout();
  }
  ...
  public void setImageDrawable(@Nullable Drawable paramDrawable)
  {
    if ((this.jdField_c_of_type_Boolean) && (paramDrawable != null)) {
      urk.a("RoundBorderImageView", "[DEBUG] before set %d %d type %s matrix:%s", Integer.valueOf(paramDrawable.getIntrinsicWidth()), Integer.valueOf(paramDrawable.getIntrinsicHeight()), getScaleType(), getImageMatrix().toShortString());
    }
    super.setImageDrawable(paramDrawable);
    if ((this.jdField_c_of_type_Boolean) && (paramDrawable != null)) {
      urk.a("RoundBorderImageView", "[DEBUG] after set %d %d type %s, matrix:%s", Integer.valueOf(paramDrawable.getIntrinsicWidth()), Integer.valueOf(paramDrawable.getIntrinsicHeight()), getScaleType(), getImageMatrix().toShortString());
    }
  }
