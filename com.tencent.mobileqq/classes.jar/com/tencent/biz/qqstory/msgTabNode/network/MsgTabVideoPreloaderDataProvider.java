  ...
  public void a(@NonNull MsgTabNodeInfo paramMsgTabNodeInfo, MsgTabVideoPreloaderDataProvider.DataProviderListener paramDataProviderListener)
  {
    if (this.jdField_a_of_type_Boolean)
    {
      if (this.b)
      {
        ...
        Stream.of(paramMsgTabNodeInfo).map(new MsgTabNodeVidListPullSegment(false)).map(new MsgTabNodePullVideoBasicInfoSegment(null)).subscribe(new niq(this, paramDataProviderListener, paramMsgTabNodeInfo));
      }
    }
    else {
      return;
    ...
    Stream.of(paramMsgTabNodeInfo).map(new MsgTabNodeVidListPullSegment(false)).subscribe(new nis(this, paramDataProviderListener, paramMsgTabNodeInfo));
  }
