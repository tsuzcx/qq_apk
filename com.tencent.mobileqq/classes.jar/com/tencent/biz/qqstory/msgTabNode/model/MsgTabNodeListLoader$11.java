...
public class MsgTabNodeListLoader$11
  implements Runnable
{
  public MsgTabNodeListLoader$11(vxi paramvxi, vxd paramvxd, boolean paramBoolean1, int paramInt1, int paramInt2, boolean paramBoolean2) {}
  ...
  public void run()
  {
    synchronized (this.this$0.d)
    {
      ...
      if (localIterator.hasNext()) {
        ((vxp)localIterator.next()).a(this.jdField_a_of_type_Vxd, this.jdField_a_of_type_Boolean, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, this.jdField_b_of_type_Boolean);
      }
    }
