...
public class MsgTabNodeListLoader$11
  implements Runnable
{
  public MsgTabNodeListLoader$11(wvs paramwvs, wvn paramwvn, boolean paramBoolean1, int paramInt1, int paramInt2, boolean paramBoolean2) {}
  ...
  public void run()
  {
    synchronized (this.this$0.d)
    {
      ...
      if (localIterator.hasNext()) {
        ((wvz)localIterator.next()).a(this.jdField_a_of_type_Wvn, this.jdField_a_of_type_Boolean, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, this.jdField_b_of_type_Boolean);
      }
    }
