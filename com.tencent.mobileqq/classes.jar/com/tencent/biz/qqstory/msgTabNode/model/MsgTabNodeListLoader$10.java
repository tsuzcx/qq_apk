...
public class MsgTabNodeListLoader$10
  implements Runnable
{
  public MsgTabNodeListLoader$10(wvs paramwvs, ArrayList paramArrayList, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3) {}
  ...
  public void run()
  {
    synchronized (this.this$0.d)
    {
      ...
      if (localIterator.hasNext()) {
        ((wvz)localIterator.next()).a(this.jdField_a_of_type_JavaUtilArrayList, this.jdField_a_of_type_Boolean, this.b, this.c);
      }
    }
