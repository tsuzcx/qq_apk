  ...
  extends com.tencent.biz.qqstory.common.recyclerview.BaseViewHolder
{
  ...
  protected ImageView c = (ImageView)a(2131371917);
  
  public BaseViewHolder(ViewGroup paramViewGroup, int paramInt)
  {
    super(paramViewGroup, paramInt);
    this.jdField_a_of_type_ComTencentBizQqstoryWidgetRotateCircleImageView = ((RotateCircleImageView)a(2131371916));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)a(2131371915));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)a(2131371919));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)a(2131363397));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)a(2131371918));
  }
