...
public class FSPluginLoadingDialog
  extends ReportDialog
{
  ...
  private Handler f;
  private final AnimationDrawableFactory.CreateResultListener h = new FSPluginLoadingDialog.1(this);
  
  static
  {
    g.addTask(new RFWMultiDownloadHelper.DownloadTask("https://downv6.qq.com/video_story/wezone_url/defaultmode/qq_video/Qvideo_loading_seq.zip", QCircleDownloadConfig.a()));
    g.start();
  }
  
  public FSPluginLoadingDialog(@NonNull Context paramContext)
  {
    super(paramContext, 2131953412);
    this.a = LayoutInflater.from(paramContext);
    this.b = this.a.inflate(2131626904, null);
    this.c = ((ImageView)this.b.findViewById(2131441729));
    this.d = paramContext.getResources().getDrawable(2130840383);
  }
  ...
  public void a()
  {
    if (this.e == null)
    {
      if (RFWDownloaderFactory.getDownloader(QCircleDownloadConfig.a()).isFileDownLoaded("https://downv6.qq.com/video_story/wezone_url/defaultmode/qq_video/Qvideo_loading_seq.zip"))
      {
 ...
 * Qualified Name:     com.tencent.biz.qcircleshadow.local.fragment.flashshow.FSPluginLoadingDialog
