  ...
  extends FrameLayout
{
  ...
  protected void a(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    {
      this.jdField_a_of_type_Int = ((int)paramContext.getDimension(4, DisplayUtil.dip2px(getContext(), 24.0F)));
      this.jdField_b_of_type_Int = ((int)paramContext.getDimension(1, DisplayUtil.dip2px(getContext(), 24.0F)));
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqWidgetSquareImageView != null) {
      QCircleImageLoader.loadImageFromUrl(paramString, this.jdField_a_of_type_ComTencentMobileqqWidgetSquareImageView);
    }
  }
