...
public class QCircleFileUtils
{
  ...
  public static boolean a(File paramFile1, File paramFile2, boolean paramBoolean)
  {
    ...
    //   7: astore 5
    //   9: aload_1
    //   10: invokevirtual 24	java/io/File:getParentFile	()Ljava/io/File;
    //   13: ifnull +21 -> 34
    //   16: aload_1
    //   17: invokevirtual 24	java/io/File:getParentFile	()Ljava/io/File;
    //   20: invokevirtual 20	java/io/File:exists	()Z
    //   23: ifne +11 -> 34
    //   26: aload_1
    //   27: invokevirtual 24	java/io/File:getParentFile	()Ljava/io/File;
    //   30: invokevirtual 27	java/io/File:mkdirs	()Z
    //   33: pop
    ...
    //   120: ldc 83
    //   122: aload_1
    //   123: invokestatic 89	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   126: aload_0
    //   127: invokevirtual 90	java/io/BufferedInputStream:close	()V
    //   130: goto +17 -> 147
    //   133: astore_0
    //   134: iload_2
    //   135: ifeq +12 -> 147
    ...
    //   141: ldc 83
    //   143: aload_0
    //   144: invokestatic 89	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   147: iconst_1
    //   148: ireturn
    //   149: astore 4
    //   151: goto +171 -> 322
    ...
    //   226: ldc 83
    //   228: aload 6
    //   230: invokestatic 89	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   233: aload 5
    //   235: ifnull +25 -> 260
    //   238: aload 5
    ...
    //   254: ldc 83
    //   256: aload_0
    //   257: invokestatic 89	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   260: aload 4
    //   262: ifnull +171 -> 433
    //   265: aload 4
    //   267: invokevirtual 90	java/io/BufferedInputStream:close	()V
    //   270: iconst_0
    //   271: ireturn
    //   272: astore_0
    //   273: iload_2
    ...
    //   280: ldc 83
    //   282: aload_0
    //   283: invokestatic 89	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   286: iconst_0
    //   287: ireturn
    //   288: astore 6
    //   290: aconst_null
    ...
    //   310: ldc 83
    //   312: aload 6
    //   314: invokestatic 89	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   317: goto +69 -> 386
    //   320: astore 4
    //   322: aload_0
    //   323: astore 5
    ...
    //   351: ldc 83
    //   353: aload_1
    //   354: invokestatic 89	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   357: aload 4
    //   359: ifnull +25 -> 384
    //   362: aload 4
    //   364: invokevirtual 90	java/io/BufferedInputStream:close	()V
    //   367: goto +17 -> 384
    //   370: astore_1
    //   371: iload_2
    //   372: ifeq +12 -> 384
    ...
    //   378: ldc 83
    //   380: aload_1
    //   381: invokestatic 89	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   384: aload_0
    //   385: athrow
    //   386: aload 5
    //   388: ifnull +25 -> 413
    ...
    //   407: ldc 83
    //   409: aload_0
    //   410: invokestatic 89	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   413: aload 4
    //   415: ifnull +18 -> 433
    //   418: aload 4
    //   420: invokevirtual 90	java/io/BufferedInputStream:close	()V
    //   423: iconst_0
    //   424: ireturn
    //   425: astore_0
    //   426: iload_2
 ...
 * Qualified Name:     com.tencent.biz.qcircleshadow.local.util.QCircleFileUtils
