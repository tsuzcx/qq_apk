...
public class MSFNetTransportProvider
  ...
  implements bihy
{
  private Map<String, bihz> mCodecMap;
  private Map<String, biia> mEventListenerMap;
  ...
  public bihz getCodec(String paramString)
  {
    ...
    {
      localObject2 = (bihz)this.mCodecMap.get(paramString);
      return localObject2;
    }
    Object localObject1;
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (biia)this.mEventListenerMap.get(paramObject);
  ...
  public void setNetTransportEventListener(String paramString, biia parambiia)
  {
    if (TextUtils.isEmpty(paramString)) {}
    while (parambiia == null) {
      return;
    }
    if (this.mEventListenerMap == null) {
      this.mEventListenerMap = new LinkedHashMap();
    }
    this.mEventListenerMap.put(paramString, parambiia);
  }
}
