  ...
  extends Preference
{
  ...
  protected View onCreateView(ViewGroup paramViewGroup)
  {
    ...
    View.inflate(getContext(), 2131625599, localViewGroup);
  ...
  public void setDescVisibility(int paramInt)
  {
    this.i = paramInt;
    TextView localTextView = this.A;
    if (localTextView != null) {
  ...
  public void setIsTv1OnlyRedDot(boolean paramBoolean)
  {
    this.H = paramBoolean;
  }
  
  public void setItemDisable(boolean paramBoolean)
  {
    this.J = paramBoolean;
  }
  
  public void setRightArrow(int paramInt)
  {
    this.t = paramInt;
  ...
  public void setRightCenterProspectVisibility(int paramInt)
  {
    this.s = paramInt;
  ...
  public void setRightImageSrc(int paramInt)
  {
    this.a = paramInt;
    this.o = null;
    ImageView localImageView = this.b;
  ...
  public void setRightIvVivibility(int paramInt)
  {
    this.p = paramInt;
    ImageView localImageView = this.b;
    if (localImageView != null) {
  ...
  public void setRightProspectVisibility(int paramInt)
  {
    this.r = paramInt;
    View localView = this.w;
    if (localView != null) {
      localView.setVisibility(this.r);
    }
  }
  
  public void setRightRLVisibility(int paramInt)
  {
    this.q = paramInt;
  ...
  public void setRightSize(int paramInt1, int paramInt2)
  {
  ...
  public void setText1Vivibility(int paramInt)
  {
    this.g = paramInt;
  ...
  public void setText2Vivibility(int paramInt)
  {
    this.m = paramInt;
  ...
  public void setTextDotVisibility(int paramInt)
  {
    this.h = paramInt;
  ...
  public void setTextIv(int paramInt1, int paramInt2)
  {
    this.h = paramInt1;
    this.I = paramInt2;
  }
  
  public void setTextView1(String paramString, int paramInt)
  {
    this.e = paramString;
    this.f = paramInt;
  }
  
  public void setTextView2(String paramString, int paramInt)
  {
    setTextView2(paramString, paramInt, this.n);
  }
  
  public void setTextView2(String paramString, int paramInt1, int paramInt2)
  {
    this.k = paramString;
    this.l = paramInt1;
    this.n = paramInt2;
    ...
    if (localTextView != null)
    {
      localTextView.setText(paramString);
      if (paramInt1 != -1) {
        this.B.setBackgroundDrawable(this.F.getResources().getDrawable(paramInt1));
      }
      if (paramInt2 != -1) {
  ...
  public void setTextView2WithRedDot(boolean paramBoolean)
  {
    this.G = paramBoolean;
    TextView localTextView = this.B;
    if (localTextView != null)
    {
      if (paramBoolean)
      {
        localTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130853407, 0);
        this.B.setCompoundDrawablePadding((int)this.F.getResources().getDimension(2131296404));
        return;
      }
  ...
  public void setTitleTvMaxWidth(int paramInt)
  {
    TextView localTextView = this.z;
    if (localTextView != null)
    {
