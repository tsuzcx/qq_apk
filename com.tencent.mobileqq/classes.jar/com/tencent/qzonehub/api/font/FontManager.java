...
{
  private static final Singleton<FontManager, Void> jdField_a_of_type_ComTencentMobileqqLyricUtilSingleton = new FontManager.1();
  private static FileCacheService jdField_a_of_type_CooperationQzoneCacheFileCacheService;
  private FileFilter jdField_a_of_type_JavaIoFileFilter = new FontManager.5(this);
  ...
  private FileFilter jdField_b_of_type_JavaIoFileFilter = new FontManager.6(this);
  private String jdField_b_of_type_JavaLangString;
  private ConcurrentHashMap<Integer, ArrayList<FontManager.DownLoadFontTask>> jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap;
  private String c;
  ...
  {
    return (FontManager)jdField_a_of_type_ComTencentMobileqqLyricUtilSingleton.get(null);
  }
  ...
  private String a()
  {
    ...
    this.jdField_a_of_type_JavaLangString = CacheManager.getPersonaliseFontDir();
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap)
      {
        ...
        do
        {
          ...
          localFontResult = (FontInterface.FontResult)((FontManager.DownLoadFontTask)localObject2).jdField_a_of_type_JavaLangRefWeakReference.get();
        } while (localFontResult == null);
        localFontResult.a(paramInt, b(paramInt, ((FontManager.DownLoadFontTask)localObject2).b), ((FontManager.DownLoadFontTask)localObject2).jdField_a_of_type_JavaLangString);
      }
    }
  }
  ...
  private boolean a(int paramInt)
  {
    ...
    //   0: aload_0
    //   1: iload_1
    //   2: invokespecial 136	com/tencent/qzonehub/api/font/FontManager:a	(I)Ljava/lang/String;
    //   5: astore 5
    //   7: aload_0
    //   8: iload_1
    //   9: invokespecial 271	com/tencent/qzonehub/api/font/FontManager:b	(I)Ljava/lang/String;
    //   12: astore 6
    //   14: new 55	java/io/File
    //   17: dup
    //   18: aload 5
    //   20: invokespecial 114	java/io/File:<init>	(Ljava/lang/String;)V
    //   23: new 55	java/io/File
    //   26: dup
    //   27: aload 6
    //   29: invokespecial 114	java/io/File:<init>	(Ljava/lang/String;)V
    //   32: invokestatic 277	cooperation/qzone/util/FileUtils:unzip	(Ljava/io/File;Ljava/io/File;)Z
    //   35: istore 4
    //   37: iload 4
    //   39: ifeq +440 -> 479
    ...
    //   45: dup
    //   46: aload 6
    //   48: invokespecial 114	java/io/File:<init>	(Ljava/lang/String;)V
    //   51: invokevirtual 281	java/io/File:listFiles	()[Ljava/io/File;
    //   54: astore 7
    //   56: aload 7
    //   58: ifnull +375 -> 433
    //   61: aload 7
    ...
    //   70: aaload
    //   71: astore 7
    //   73: invokestatic 286	com/etrump/mixlayout/ETEngine:getInstanceForSpace	()Lcom/etrump/mixlayout/ETEngine;
    //   76: pop
    //   77: aload 7
    //   79: invokevirtual 289	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   82: invokestatic 292	com/etrump/mixlayout/ETEngine:native_getFontType	(Ljava/lang/String;)I
    //   85: istore_2
    //   86: iload_2
    //   87: iconst_2
    ...
    //   96: iload_1
    //   97: iconst_1
    //   98: invokespecial 139	com/tencent/qzonehub/api/font/FontManager:a	(II)Ljava/lang/String;
    //   101: invokespecial 114	java/io/File:<init>	(Ljava/lang/String;)V
    //   104: astore 8
    //   106: aload 8
    //   108: invokevirtual 142	java/io/File:exists	()Z
    //   111: ifne +12 -> 123
    //   114: aload 7
    //   116: aload 8
    //   118: invokevirtual 296	java/io/File:renameTo	(Ljava/io/File;)Z
    //   121: istore 4
    //   123: iload 4
    //   125: istore_3
    //   126: iload 4
    //   128: ifeq +18 -> 146
    //   131: invokestatic 85	com/tencent/qzonehub/api/font/FontManager:b	()Lcooperation/qzone/cache/FileCacheService;
    //   134: aload 8
    //   136: invokevirtual 289	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   139: iconst_1
    //   140: invokevirtual 302	cooperation/qzone/cache/FileCacheService:updateLruFile	(Ljava/lang/String;Z)V
    //   143: iload 4
    //   145: istore_3
    //   146: iload_3
    //   147: ifeq +209 -> 356
    //   150: new 304	com/tencent/qzonehub/api/font/FontInfo
    //   153: dup
    //   154: invokespecial 305	com/tencent/qzonehub/api/font/FontInfo:<init>	()V
    //   157: astore 7
    //   159: aload 7
    //   161: iload_1
    //   162: putfield 307	com/tencent/qzonehub/api/font/FontInfo:jdField_a_of_type_Int	I
    //   165: aload_0
    //   166: getfield 31	com/tencent/qzonehub/api/font/FontManager:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   169: aload 7
    //   171: getfield 307	com/tencent/qzonehub/api/font/FontInfo:jdField_a_of_type_Int	I
    //   174: invokestatic 167	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   177: aload 7
    //   179: invokevirtual 311	java/util/concurrent/ConcurrentHashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   182: pop
    //   183: new 55	java/io/File
    //   186: dup
    //   187: aload 5
    //   189: invokespecial 114	java/io/File:<init>	(Ljava/lang/String;)V
    //   192: invokestatic 314	cooperation/qzone/util/FileUtils:deleteFile	(Ljava/io/File;)Z
    //   195: pop
    //   196: new 55	java/io/File
    //   199: dup
    //   200: aload 6
    //   202: invokespecial 114	java/io/File:<init>	(Ljava/lang/String;)V
    //   205: invokestatic 314	cooperation/qzone/util/FileUtils:deleteFile	(Ljava/io/File;)Z
    //   208: pop
    //   209: iload_3
    //   210: ireturn
    //   211: astore 7
    ...
    //   219: dup
    //   220: invokespecial 96	java/lang/StringBuilder:<init>	()V
    //   223: ldc_w 316
    //   226: invokevirtual 100	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   229: aload 7
    //   231: invokevirtual 317	java/lang/Throwable:toString	()Ljava/lang/String;
    ...
    //   240: invokestatic 320	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   243: new 55	java/io/File
    //   246: dup
    //   247: aload 5
    //   249: invokespecial 114	java/io/File:<init>	(Ljava/lang/String;)V
    //   252: invokestatic 314	cooperation/qzone/util/FileUtils:deleteFile	(Ljava/io/File;)Z
    //   255: pop
    //   256: new 55	java/io/File
    //   259: dup
    //   260: aload 6
    //   262: invokespecial 114	java/io/File:<init>	(Ljava/lang/String;)V
    //   265: invokestatic 314	cooperation/qzone/util/FileUtils:deleteFile	(Ljava/io/File;)Z
    //   268: pop
    //   269: iconst_0
    //   270: ireturn
    //   271: astore 5
    //   273: aload 5
    //   275: invokevirtual 323	java/lang/Exception:printStackTrace	()V
    //   278: iconst_0
    //   279: ireturn
    //   280: iload_2
    //   281: iconst_1
    ...
    //   290: iload_1
    //   291: iconst_0
    //   292: invokespecial 139	com/tencent/qzonehub/api/font/FontManager:a	(II)Ljava/lang/String;
    //   295: invokespecial 114	java/io/File:<init>	(Ljava/lang/String;)V
    //   298: astore 8
    //   300: aload 8
    //   302: invokevirtual 142	java/io/File:exists	()Z
    //   305: ifne +12 -> 317
    //   308: aload 7
    //   310: aload 8
    //   312: invokevirtual 296	java/io/File:renameTo	(Ljava/io/File;)Z
    //   315: istore 4
    //   317: iload 4
    //   319: istore_3
    //   320: iload 4
    //   322: ifeq -176 -> 146
    //   325: invokestatic 85	com/tencent/qzonehub/api/font/FontManager:b	()Lcooperation/qzone/cache/FileCacheService;
    //   328: aload 8
    //   330: invokevirtual 289	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   333: iconst_1
    //   334: invokevirtual 302	cooperation/qzone/cache/FileCacheService:updateLruFile	(Ljava/lang/String;Z)V
    //   337: aload_0
    //   338: aload 8
    //   340: invokevirtual 289	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   343: aload_0
    //   344: iload_1
    //   345: iconst_1
    //   346: invokespecial 139	com/tencent/qzonehub/api/font/FontManager:a	(II)Ljava/lang/String;
    //   349: invokespecial 326	com/tencent/qzonehub/api/font/FontManager:a	(Ljava/lang/String;Ljava/lang/String;)Z
    //   352: istore_3
    //   353: goto -207 -> 146
    //   356: ldc 144
    //   358: iconst_1
    //   359: new 95	java/lang/StringBuilder
    //   362: dup
    //   363: invokespecial 96	java/lang/StringBuilder:<init>	()V
    //   366: ldc_w 328
    //   369: invokevirtual 100	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   372: aload 7
    //   374: invokevirtual 289	java/io/File:getAbsolutePath	()Ljava/lang/String;
    ...
    //   383: invokestatic 320	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   386: goto -203 -> 183
    //   389: astore 7
    //   391: ldc 144
    //   393: iconst_1
    //   394: ldc_w 330
    //   397: aload 7
    //   399: invokestatic 334	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   402: new 55	java/io/File
    //   405: dup
    //   406: aload 5
    //   408: invokespecial 114	java/io/File:<init>	(Ljava/lang/String;)V
    //   411: invokestatic 314	cooperation/qzone/util/FileUtils:deleteFile	(Ljava/io/File;)Z
    //   414: pop
    //   415: new 55	java/io/File
    //   418: dup
    //   419: aload 6
    //   421: invokespecial 114	java/io/File:<init>	(Ljava/lang/String;)V
    //   424: invokestatic 314	cooperation/qzone/util/FileUtils:deleteFile	(Ljava/io/File;)Z
    //   427: pop
    //   428: iconst_0
    //   429: istore_3
    //   430: goto -221 -> 209
    ...
    //   435: iconst_1
    //   436: ldc_w 336
    //   439: invokestatic 320	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   442: iload 4
    //   444: istore_3
    //   445: goto -262 -> 183
    //   448: astore 7
    ...
    //   453: dup
    //   454: aload 5
    //   456: invokespecial 114	java/io/File:<init>	(Ljava/lang/String;)V
    //   459: invokestatic 314	cooperation/qzone/util/FileUtils:deleteFile	(Ljava/io/File;)Z
    //   462: pop
    //   463: new 55	java/io/File
    //   466: dup
    //   467: aload 6
    //   469: invokespecial 114	java/io/File:<init>	(Ljava/lang/String;)V
    //   472: invokestatic 314	cooperation/qzone/util/FileUtils:deleteFile	(Ljava/io/File;)Z
    //   475: pop
    //   476: aload 7
    //   478: athrow
    //   479: ldc 144
    //   481: iconst_1
    //   482: new 95	java/lang/StringBuilder
    //   485: dup
    //   486: invokespecial 96	java/lang/StringBuilder:<init>	()V
    //   489: ldc_w 338
    ...
    //   500: invokevirtual 106	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   503: invokestatic 320	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   506: iload 4
    //   508: istore_3
    //   509: goto -326 -> 183
    //   512: astore 5
    //   514: aload 5
    //   516: invokevirtual 323	java/lang/Exception:printStackTrace	()V
    //   519: goto -310 -> 209
    //   522: astore 5
    //   524: aload 5
    //   526: invokevirtual 323	java/lang/Exception:printStackTrace	()V
    //   529: iconst_0
    //   530: istore_3
    //   531: goto -322 -> 209
    //   534: astore 5
    //   536: aload 5
    //   538: invokevirtual 323	java/lang/Exception:printStackTrace	()V
    //   541: goto -65 -> 476
    //   544: iconst_0
    //   545: istore_3
    //   546: goto -400 -> 146
  ...
  private boolean a(int paramInt1, String paramString1, int paramInt2, String arg4, FontInterface.FontResult paramFontResult)
  {
    ...
    localDownLoadFontTask.jdField_a_of_type_Int = paramInt1;
    localDownLoadFontTask.b = paramInt2;
    localDownLoadFontTask.jdField_a_of_type_JavaLangString = ???;
    localDownLoadFontTask.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramFontResult);
    synchronized (this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap)
    {
  ...
  private boolean a(String paramString1, String paramString2)
  {
    ...
    b().updateLruFile(paramString2, true);
    return bool;
    label178:
  ...
  private static FileCacheService b()
  {
    if (jdField_a_of_type_CooperationQzoneCacheFileCacheService == null) {
      jdField_a_of_type_CooperationQzoneCacheFileCacheService = CacheManager.getPersonaliseFontCacheService();
    }
  ...
  private String b()
  {
    ...
    {
      str = MobileQQ.sMobileQQ.waitAppRuntime(null).getApplication().getQQProcessName();
      i = str.indexOf(':');
 ...
 * Qualified Name:     com.tencent.qzonehub.api.font.FontManager
