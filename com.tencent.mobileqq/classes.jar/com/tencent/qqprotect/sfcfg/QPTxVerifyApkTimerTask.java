  ...
  extends TimerTask
{
  ...
  private String a(com.tencent.commonsdk.zip.QZipFile paramQZipFile, java.util.zip.ZipEntry paramZipEntry)
  {
    ...
    //   87: invokestatic 77	bfjv:a	([B)Ljava/lang/String;
    //   90: astore 4
    //   92: aload 4
    //   94: astore_1
    //   95: aload_2
  ...
  private void b()
  {
    for (;;)
    {
      ...
      try
      {
        ...
        if (jdField_c_of_type_Boolean)
        {
          ...
          if (!jdField_b_of_type_Boolean)
          {
            ...
            if ((str2 == null) || (!str2.equalsIgnoreCase(jdField_b_of_type_JavaLangString)) || (localObject3 == null) || (!((String)localObject3).equalsIgnoreCase("8.2.8.4440"))) {
              break label455;
            }
          ...
          localReportDetectResultPacket.str_apkversion.set("8.2.8.4440");
      ...
      continue;
      label455:
      d = bfme.a(BaseApplication.getContext());
      jdField_a_of_type_JavaLangString = bfme.a(localException);
      Object localObject2 = new byte[16];
      if (localObject2 != null)
      {
        bfjv.a(localException, "txsfcfg.dat", (byte[])localObject2);
        jdField_c_of_type_JavaLangString = bfme.a((byte[])localObject2);
      }
  ...
  private void c()
  {
    try
    {
      ...
      localEditor.putString("SecVer", "8.2.8.4440");
      localEditor.commit();
      return;
    }
    catch (Exception localException)
    ...
    try
    {
      ...
      if (!jdField_a_of_type_Boolean)
      {
        ...
        if (localObject != null)
        {
          ...
          if (localObject != null)
          {
            jdField_a_of_type_Int = bfjw.a((String)localObject, "txsfcfg.dat");
