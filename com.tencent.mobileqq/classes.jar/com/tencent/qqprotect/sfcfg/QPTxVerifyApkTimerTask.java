  ...
  extends TimerTask
{
  ...
  {
    // Byte code:
    //   0: new 44	java/util/zip/ZipFile
    //   3: dup
    //   4: aload_1
    //   5: invokespecial 47	java/util/zip/ZipFile:<init>	(Ljava/lang/String;)V
    //   8: astore_2
    //   9: aload_2
    //   10: astore_1
    //   11: aload_2
    //   12: invokevirtual 51	java/util/zip/ZipFile:entries	()Ljava/util/Enumeration;
    //   15: astore_3
    //   16: aload_2
    //   17: astore_1
    //   18: aload_3
    ...
    //   28: astore_1
    //   29: aload_3
    //   30: invokeinterface 61 1 0
    //   35: checkcast 63	java/util/zip/ZipEntry
    //   38: astore 4
    //   40: aload_2
    //   41: astore_1
    //   42: aload 4
    //   44: invokevirtual 66	java/util/zip/ZipEntry:isDirectory	()Z
    //   47: ifne -31 -> 16
    //   50: aload_2
    //   51: astore_1
    //   52: aload 4
    //   54: invokevirtual 70	java/util/zip/ZipEntry:getName	()Ljava/lang/String;
    //   57: astore 5
    //   59: aload_2
    //   60: astore_1
    //   61: aload 5
    //   63: ldc 72
    //   65: invokevirtual 78	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   68: ifne -52 -> 16
    //   71: aload_2
    //   72: astore_1
    //   73: aload 5
    //   75: ldc 80
    //   77: invokevirtual 84	java/lang/String:endsWith	(Ljava/lang/String;)Z
    //   80: ifeq -64 -> 16
    //   83: aload_2
    //   84: astore_1
    //   85: aload 5
    //   87: ldc 86
    //   89: invokevirtual 89	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   92: ifeq -76 -> 16
    //   95: aload_2
    //   96: astore_1
    //   97: aload 5
    //   99: bipush 47
    //   101: invokevirtual 93	java/lang/String:lastIndexOf	(I)I
    //   104: bipush 8
    //   106: if_icmpne -90 -> 16
    //   109: aload_2
    //   110: astore_1
    ...
    //   112: aload_2
    //   113: aload 4
    //   115: invokespecial 96	com/tencent/qqprotect/sfcfg/QPTxVerifyApkTimerTask:a	(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;)Ljava/lang/String;
    //   118: astore_3
    //   119: aload_2
    //   120: ifnull +7 -> 127
    //   123: aload_2
    //   124: invokevirtual 99	java/util/zip/ZipFile:close	()V
    //   127: aload_3
    //   128: areturn
    //   129: astore_1
    //   130: aload_1
    //   131: invokevirtual 102	java/io/IOException:printStackTrace	()V
    //   134: aload_3
    //   135: areturn
    //   136: aload_2
    //   137: ifnull +7 -> 144
    //   140: aload_2
    //   141: invokevirtual 99	java/util/zip/ZipFile:close	()V
    //   144: aconst_null
    //   145: areturn
    //   146: astore_1
    //   147: aload_1
    //   148: invokevirtual 102	java/io/IOException:printStackTrace	()V
    //   151: goto -7 -> 144
    //   154: astore_3
    //   155: aconst_null
    //   156: astore_2
    ...
    //   158: astore_1
    //   159: aload_3
    //   160: invokevirtual 103	java/lang/Exception:printStackTrace	()V
    //   163: aload_2
    //   164: ifnull -20 -> 144
    //   167: aload_2
    //   168: invokevirtual 99	java/util/zip/ZipFile:close	()V
    //   171: goto -27 -> 144
    //   174: astore_1
    //   175: aload_1
    //   176: invokevirtual 102	java/io/IOException:printStackTrace	()V
    //   179: goto -35 -> 144
    //   182: astore_3
    //   183: aconst_null
    //   184: astore_2
    ...
    //   186: astore_1
    //   187: aload_3
    //   188: invokevirtual 104	java/lang/OutOfMemoryError:printStackTrace	()V
    //   191: aload_2
    //   192: ifnull -48 -> 144
    //   195: aload_2
    //   196: invokevirtual 99	java/util/zip/ZipFile:close	()V
    //   199: goto -55 -> 144
    //   202: astore_1
    //   203: aload_1
    //   204: invokevirtual 102	java/io/IOException:printStackTrace	()V
    //   207: goto -63 -> 144
    //   210: astore_2
    //   211: aconst_null
    //   212: astore_1
    ...
    //   214: ifnull +7 -> 221
    //   217: aload_1
    //   218: invokevirtual 99	java/util/zip/ZipFile:close	()V
    //   221: aload_2
    //   222: athrow
    //   223: astore_1
    //   224: aload_1
    //   225: invokevirtual 102	java/io/IOException:printStackTrace	()V
    //   228: goto -7 -> 221
    //   231: astore_2
    //   232: goto -19 -> 213
    //   235: astore_3
    ...
    //   8	188	2	localZipFile	java.util.zip.ZipFile
  ...
  /* Error */
  private String a(java.util.zip.ZipFile paramZipFile, java.util.zip.ZipEntry paramZipEntry)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 5
    //   3: aload_1
    //   4: aload_2
    //   5: invokevirtual 108	java/util/zip/ZipFile:getInputStream	(Ljava/util/zip/ZipEntry;)Ljava/io/InputStream;
    //   8: astore_2
    //   9: aload_2
    //   10: astore_1
    //   11: ldc 110
    //   13: invokestatic 116	java/security/MessageDigest:getInstance	(Ljava/lang/String;)Ljava/security/MessageDigest;
    //   16: astore 4
    //   18: aload_2
    //   19: astore_1
    //   20: sipush 8192
    ...
    //   29: aload_2
    //   30: aload 6
    //   32: invokevirtual 122	java/io/InputStream:read	([B)I
    //   35: istore_3
    //   36: iload_3
    //   37: iconst_m1
    //   38: if_icmpeq +42 -> 80
    ...
    //   47: iconst_0
    //   48: iload_3
    //   49: invokevirtual 126	java/security/MessageDigest:update	([BII)V
    //   52: goto -25 -> 27
    //   55: astore 4
    //   57: aload_2
    //   58: astore_1
    //   59: aload 4
    //   61: invokevirtual 103	java/lang/Exception:printStackTrace	()V
    //   64: aload 5
    //   66: astore_1
    //   67: aload_2
    //   68: ifnull +10 -> 78
    //   71: aload_2
    //   72: invokevirtual 127	java/io/InputStream:close	()V
    //   75: aload 5
    //   77: astore_1
    //   78: aload_1
    //   79: areturn
    ...
    //   81: astore_1
    //   82: aload 4
    //   84: invokevirtual 131	java/security/MessageDigest:digest	()[B
    //   87: invokestatic 136	com/tencent/qqprotect/sfcfg/TXSafeCheckUtil:a	([B)Ljava/lang/String;
    //   90: astore 4
    //   92: aload 4
    //   94: astore_1
    //   95: aload_2
    //   96: ifnull -18 -> 78
    //   99: aload_2
    //   100: invokevirtual 127	java/io/InputStream:close	()V
    //   103: aload 4
    //   105: areturn
    //   106: astore_1
    //   107: aload_1
    //   108: invokevirtual 103	java/lang/Exception:printStackTrace	()V
    //   111: aload 4
    //   113: areturn
    //   114: astore_1
    //   115: aload_1
    //   116: invokevirtual 103	java/lang/Exception:printStackTrace	()V
    //   119: aconst_null
    //   120: areturn
    //   121: astore_2
    //   122: aconst_null
    ...
    //   125: ifnull +7 -> 132
    //   128: aload_1
    //   129: invokevirtual 127	java/io/InputStream:close	()V
    //   132: aload_2
    //   133: athrow
    //   134: astore_1
    //   135: aload_1
    //   136: invokevirtual 103	java/lang/Exception:printStackTrace	()V
    //   139: goto -7 -> 132
    //   142: astore_2
    //   143: goto -19 -> 124
    //   146: astore 4
    ...
    //   0	153	1	paramZipFile	java.util.zip.ZipFile
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (jdField_c_of_type_Boolean)
        {
          ...
          localReportDetectResultPacket.uint32_appid.set(AppSetting.jdField_a_of_type_Int);
          ...
          if (!jdField_b_of_type_Boolean)
          {
            ...
            if ((str2 == null) || (!str2.equalsIgnoreCase(jdField_b_of_type_JavaLangString)) || (localObject3 == null) || (!((String)localObject3).equalsIgnoreCase("7.6.0.3525"))) {
              break label455;
            }
          ...
          localReportDetectResultPacket.str_apkversion.set("7.6.0.3525");
          localReportDetectResultPacket.str_channelid.set("10000665");
      ...
      if (localObject2 != null)
      {
        TXSafeCheckUtil.a(localException, "txsfcfg.dat", (byte[])localObject2);
  ...
  private void c()
  {
    try
    {
      ...
      localEditor.putString("SecVer", "7.6.0.3525");
      localEditor.commit();
      return;
    }
    catch (Exception localException)
  ...
  public void a()
  {
    try
    {
      ...
      else if ((jdField_c_of_type_Boolean) || (jdField_a_of_type_Int != 0))
      {
        long l2 = System.currentTimeMillis();
        b();
  ...
  public void run()
  {
    ThreadManager.post(new alin(this), 5, null, true);
  }
}
