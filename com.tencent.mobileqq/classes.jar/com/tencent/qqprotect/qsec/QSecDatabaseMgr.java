...
public class QSecDatabaseMgr
{
  ...
  private Pair<Integer, List<QSecDatabaseMgr.LibEntry>> a(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    //   208: aload_0
    //   209: aload 8
    //   211: invokespecial 172	com/tencent/qqprotect/qsec/QSecDatabaseMgr:a	(Lorg/w3c/dom/Node;)Lcom/tencent/qqprotect/qsec/QSecDatabaseMgr$LibEntry;
    //   214: astore 8
    //   216: aload 8
    //   218: ifnull +127 -> 345
    //   221: aload 5
  ...
  private byte[] a(int paramInt, List<QSecDatabaseMgr.LibEntry> paramList)
  {
    ...
    //   0	368	2	paramList	List<QSecDatabaseMgr.LibEntry>
