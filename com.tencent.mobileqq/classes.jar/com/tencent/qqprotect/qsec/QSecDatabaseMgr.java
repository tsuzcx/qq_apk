...
public class QSecDatabaseMgr
{
  ...
  private Pair a(String paramString, int paramInt)
  {
    ...
    byte[] arrayOfByte = new QSecStoreUtil().a(paramString, null, 1);
  ...
  /* Error */
  private Pair a(byte[] paramArrayOfByte, int paramInt)
  {
    // Byte code:
    //   0: invokestatic 129	javax/xml/parsers/DocumentBuilderFactory:newInstance	()Ljavax/xml/parsers/DocumentBuilderFactory;
    //   3: astore 5
    //   5: aload 5
    //   7: invokevirtual 133	javax/xml/parsers/DocumentBuilderFactory:newDocumentBuilder	()Ljavax/xml/parsers/DocumentBuilder;
    //   10: astore 6
    //   12: new 135	java/io/ByteArrayInputStream
    //   15: dup
    //   16: aload_1
    //   17: invokespecial 138	java/io/ByteArrayInputStream:<init>	([B)V
    //   20: astore 5
    //   22: aload 5
    //   24: astore_1
    //   25: aload 6
    //   27: aload 5
    //   29: invokevirtual 144	javax/xml/parsers/DocumentBuilder:parse	(Ljava/io/InputStream;)Lorg/w3c/dom/Document;
    ...
    //   42: aload_0
    //   43: aload 7
    //   45: invokespecial 152	com/tencent/qqprotect/qsec/QSecDatabaseMgr:a	(Lorg/w3c/dom/Element;)I
    //   48: istore_3
    //   49: iload_3
    //   50: ifeq +8 -> 58
    //   53: iload_3
    ...
    //   58: aload 5
    //   60: astore_1
    //   61: new 21	android/util/Pair
    //   64: dup
    //   65: iload_3
    //   66: invokestatic 156	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   69: aconst_null
    //   70: invokespecial 159	android/util/Pair:<init>	(Ljava/lang/Object;Ljava/lang/Object;)V
    //   73: astore 6
    //   75: aload 6
    //   77: astore_1
    //   78: aload 5
    //   80: ifnull +11 -> 91
    //   83: aload 5
    //   85: invokevirtual 162	java/io/ByteArrayInputStream:close	()V
    //   88: aload 6
    //   90: astore_1
    //   91: aload_1
    //   92: areturn
    //   93: astore_1
    //   94: aload_1
    //   95: invokevirtual 163	java/io/IOException:printStackTrace	()V
    //   98: aload 6
    //   100: areturn
    //   101: aload 5
    //   103: astore_1
    //   104: new 40	java/util/LinkedList
    //   107: dup
    //   108: invokespecial 41	java/util/LinkedList:<init>	()V
    //   111: astore 6
    //   113: aload 5
    //   115: astore_1
    //   116: aload 7
    ...
    //   195: aload 9
    //   197: ldc 166
    //   199: invokevirtual 73	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   202: ifeq +143 -> 345
    //   205: aload 5
    //   207: astore_1
    //   208: aload_0
    //   209: aload 8
    //   211: invokespecial 169	com/tencent/qqprotect/qsec/QSecDatabaseMgr:a	(Lorg/w3c/dom/Node;)Lcom/tencent/qqprotect/qsec/QSecDatabaseMgr$LibEntry;
    //   214: astore 8
    //   216: aload 8
    //   218: ifnull +127 -> 345
    //   221: aload 5
    ...
    //   241: astore_1
    //   242: aload 6
    //   244: invokevirtual 83	java/lang/Exception:printStackTrace	()V
    //   247: aload 5
    //   249: ifnull +8 -> 257
    //   252: aload 5
    //   254: invokevirtual 162	java/io/ByteArrayInputStream:close	()V
    //   257: aconst_null
    //   258: areturn
    //   259: aload 5
    //   261: astore_1
    //   262: new 21	android/util/Pair
    //   265: dup
    //   266: iload_3
    //   267: invokestatic 156	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   270: aload 6
    //   272: invokespecial 159	android/util/Pair:<init>	(Ljava/lang/Object;Ljava/lang/Object;)V
    //   275: astore 6
    //   277: aload 6
    //   279: astore_1
    //   280: aload 5
    //   282: ifnull -191 -> 91
    //   285: aload 5
    //   287: invokevirtual 162	java/io/ByteArrayInputStream:close	()V
    //   290: aload 6
    //   292: areturn
    //   293: astore_1
    //   294: aload_1
    //   295: invokevirtual 163	java/io/IOException:printStackTrace	()V
    //   298: aload 6
    //   300: areturn
    //   301: astore_1
    //   302: aload_1
    //   303: invokevirtual 163	java/io/IOException:printStackTrace	()V
    //   306: goto -49 -> 257
    //   309: astore 5
    //   311: aconst_null
    //   312: astore_1
    ...
    //   314: ifnull +7 -> 321
    //   317: aload_1
    //   318: invokevirtual 162	java/io/ByteArrayInputStream:close	()V
    //   321: aload 5
    //   323: athrow
    //   324: astore_1
    //   325: aload_1
    //   326: invokevirtual 163	java/io/IOException:printStackTrace	()V
    //   329: goto -8 -> 321
    //   332: astore 5
    //   334: goto -21 -> 313
    //   337: astore 6
  ...
  private String a()
  {
    return QPDirUtils.a() + File.separator + "QSec.dat";
  }
  ...
  private boolean a(String paramString, int paramInt, List paramList)
  {
  ...
  /* Error */
  private byte[] a(int paramInt, List paramList)
  {
    // Byte code:
    //   0: invokestatic 240	android/util/Xml:newSerializer	()Lorg/xmlpull/v1/XmlSerializer;
    //   3: astore 5
    //   5: new 242	java/io/ByteArrayOutputStream
    //   8: dup
    //   9: invokespecial 243	java/io/ByteArrayOutputStream:<init>	()V
    //   12: astore 4
    //   14: aload 4
    //   16: astore_3
    //   17: aload 5
    //   19: aload 4
    //   21: ldc 245
    //   23: invokeinterface 251 3 0
    //   28: aload 4
    //   30: astore_3
    //   31: aload 5
    //   33: aconst_null
    //   34: iconst_1
    //   35: invokestatic 256	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   38: invokeinterface 260 3 0
    //   43: aload 4
    //   45: astore_3
    //   46: aload 5
    //   48: aconst_null
    //   49: ldc_w 262
    //   52: invokeinterface 266 3 0
    //   57: pop
    //   58: aload 4
    //   60: astore_3
    //   61: aload 5
    ...
    //   64: ldc 67
    //   66: iload_1
    //   67: invokestatic 269	java/lang/Integer:toString	(I)Ljava/lang/String;
    ...
    //   88: astore_3
    //   89: aload_2
    //   90: invokeinterface 283 1 0
    //   95: ifeq +178 -> 273
    //   98: aload 4
    //   100: astore_3
    //   101: aload_2
    //   102: invokeinterface 287 1 0
    //   107: checkcast 175	com/tencent/qqprotect/qsec/QSecDatabaseMgr$LibEntry
    //   110: astore 6
    //   112: aload 4
    //   114: astore_3
    //   115: aload 5
    ...
    //   132: ldc 178
    //   134: aload 6
    //   136: getfield 179	com/tencent/qqprotect/qsec/QSecDatabaseMgr$LibEntry:jdField_a_of_type_Int	I
    //   139: invokestatic 269	java/lang/Integer:toString	(I)Ljava/lang/String;
    //   142: invokeinterface 273 4 0
    //   147: pop
    //   148: aload 4
    //   150: astore_3
    //   151: aload 5
    ...
    //   154: ldc 181
    //   156: aload 6
    //   158: getfield 184	com/tencent/qqprotect/qsec/QSecDatabaseMgr$LibEntry:jdField_b_of_type_Int	I
    //   161: invokestatic 269	java/lang/Integer:toString	(I)Ljava/lang/String;
    //   164: invokeinterface 273 4 0
    //   169: pop
    //   170: aload 4
    //   172: astore_3
    //   173: aload 5
    ...
    //   176: ldc 186
    //   178: aload 6
    //   180: getfield 189	com/tencent/qqprotect/qsec/QSecDatabaseMgr$LibEntry:c	I
    //   183: invokestatic 269	java/lang/Integer:toString	(I)Ljava/lang/String;
    //   186: invokeinterface 273 4 0
    //   191: pop
    //   192: aload 4
    //   194: astore_3
    //   195: aload 5
    ...
    //   198: ldc 196
    //   200: aload 6
    //   202: getfield 198	com/tencent/qqprotect/qsec/QSecDatabaseMgr$LibEntry:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   205: invokeinterface 273 4 0
    //   210: pop
    //   211: aload 4
    //   213: astore_3
    //   214: aload 5
    ...
    //   217: ldc 191
    //   219: aload 6
    //   221: getfield 194	com/tencent/qqprotect/qsec/QSecDatabaseMgr$LibEntry:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   224: invokeinterface 273 4 0
    //   229: pop
    //   230: aload 4
    //   232: astore_3
    //   233: aload 5
    ...
    //   262: ifnull +7 -> 269
    //   265: aload_2
    //   266: invokevirtual 291	java/io/ByteArrayOutputStream:close	()V
    //   269: aconst_null
    //   270: astore_3
    //   271: aload_3
    //   272: areturn
    ...
    //   278: aconst_null
    //   279: ldc_w 262
    //   282: invokeinterface 290 3 0
    //   287: pop
    //   288: aload 4
    //   290: astore_3
    //   291: aload 5
    //   293: invokeinterface 294 1 0
    //   298: aload 4
    //   300: astore_3
    //   301: aload 4
    //   303: invokevirtual 298	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   306: astore_2
    //   307: aload_2
    //   308: astore_3
    //   309: aload 4
    //   311: ifnull -40 -> 271
    //   314: aload 4
    //   316: invokevirtual 291	java/io/ByteArrayOutputStream:close	()V
    //   319: aload_2
    //   320: areturn
    //   321: astore_3
    //   322: aload_3
    //   323: invokevirtual 163	java/io/IOException:printStackTrace	()V
    //   326: aload_2
    //   327: areturn
    //   328: astore_2
    //   329: aload_2
    //   330: invokevirtual 163	java/io/IOException:printStackTrace	()V
    //   333: goto -64 -> 269
    //   336: astore_2
    //   337: aconst_null
    //   338: astore_3
    ...
    //   340: ifnull +7 -> 347
    //   343: aload_3
    //   344: invokevirtual 291	java/io/ByteArrayOutputStream:close	()V
    //   347: aload_2
    //   348: athrow
    //   349: astore_3
    //   350: aload_3
    //   351: invokevirtual 163	java/io/IOException:printStackTrace	()V
    //   354: goto -7 -> 347
    //   357: astore_2
    //   358: goto -19 -> 339
    //   361: astore 4
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	368	0	this	QSecDatabaseMgr
    //   0	368	1	paramInt	int
    //   0	368	2	paramList	List
