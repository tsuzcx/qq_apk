...
public class CrashProtector
{
  ...
  private void a()
  {
    ...
    Object localObject = BaseApplication.getContext().getSharedPreferences(jdField_a_of_type_JavaLangString + "_" + a(), 0);
    try
    {
  ...
  private boolean a()
  {
    ...
    localObject = ((SharedPreferences)localObject).edit();
    ((SharedPreferences.Editor)localObject).putLong(this.b, l1);
    ((SharedPreferences.Editor)localObject).commit();
    return false;
    label146:
  ...
  public String a()
  {
    ...
    //   22: invokestatic 99	android/os/Process:myPid	()I
    //   25: invokevirtual 102	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   28: ldc 104
    ...
    //   36: invokespecial 107	java/io/File:<init>	(Ljava/lang/String;)V
    //   39: astore_1
    //   40: aload_1
    //   41: invokevirtual 110	java/io/File:exists	()Z
    //   44: ifne +6 -> 50
    //   47: ldc 112
    //   49: areturn
    //   50: new 114	java/io/FileReader
    //   53: dup
    //   54: aload_1
    //   55: invokespecial 117	java/io/FileReader:<init>	(Ljava/io/File;)V
    //   58: astore_2
    //   59: aload_2
    //   60: ifnull +272 -> 332
    //   63: new 119	java/io/BufferedReader
    //   66: dup
    //   67: aload_2
    //   68: invokespecial 122	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   71: astore_1
    //   72: aload 8
    //   74: astore 5
    //   76: aload_1
    ...
    //   87: astore_3
    //   88: aload_1
    //   89: invokevirtual 125	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   92: astore 9
    //   94: aload 8
    //   96: astore 5
    //   98: aload_1
    ...
    //   105: astore_3
    //   106: aload 9
    //   108: invokestatic 131	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   111: ifne +18 -> 129
    //   114: aload_1
    //   115: astore 4
    //   117: aload_2
    //   118: astore_3
    //   119: aload 9
    //   121: invokevirtual 136	java/lang/String:trim	()Ljava/lang/String;
    //   124: astore 5
    //   126: aload_1
    //   127: astore 6
    //   129: aload_2
    //   130: ifnull +7 -> 137
    //   133: aload_2
    //   134: invokevirtual 139	java/io/FileReader:close	()V
    //   137: aload 5
    //   139: astore_2
    //   140: aload 6
    //   142: ifnull +11 -> 153
    //   145: aload 6
    //   147: invokevirtual 140	java/io/BufferedReader:close	()V
    //   150: aload 5
    //   152: astore_2
    //   153: aload_2
    //   154: invokestatic 131	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   157: ifne +147 -> 304
    //   160: aload_2
    //   161: ldc 142
    //   163: invokevirtual 146	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   166: astore_1
    //   167: aload_1
    //   168: arraylength
    //   169: iconst_1
    ...
    //   188: astore_1
    //   189: aload_1
    //   190: invokevirtual 147	java/io/IOException:printStackTrace	()V
    //   193: aload 5
    //   195: astore_2
    //   196: goto -43 -> 153
    //   199: astore 5
    ...
    //   227: ifnull -74 -> 153
    //   230: aload_1
    //   231: invokevirtual 140	java/io/BufferedReader:close	()V
    //   234: aload 7
    //   236: astore_2
    //   237: goto -84 -> 153
    //   240: astore_1
    ...
    //   251: astore_2
    //   252: aload_2
    //   253: invokevirtual 147	java/io/IOException:printStackTrace	()V
    //   256: goto -33 -> 223
    //   259: astore_1
    //   260: aconst_null
    //   261: astore 4
    ...
    //   266: ifnull +7 -> 273
    //   269: aload_2
    //   270: invokevirtual 139	java/io/FileReader:close	()V
    //   273: aload 4
    //   275: ifnull +8 -> 283
    //   278: aload 4
    //   280: invokevirtual 140	java/io/BufferedReader:close	()V
    //   283: aload_1
    //   284: athrow
    //   285: astore_2
    //   286: aload_2
    //   287: invokevirtual 147	java/io/IOException:printStackTrace	()V
    //   290: goto -17 -> 273
    //   293: astore_2
    //   294: aload_2
    //   295: invokevirtual 147	java/io/IOException:printStackTrace	()V
    //   298: goto -15 -> 283
    //   301: ldc 112
    //   303: areturn
    //   304: ldc 112
