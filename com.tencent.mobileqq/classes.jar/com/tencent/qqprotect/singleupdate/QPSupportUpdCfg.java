  ...
  implements Serializable
{
  ...
  public boolean CheckFileState()
  {
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        {
          if (a(localFile)) {
            str = bhli.a(this.fileItem[i].strFilePath);
          }
  ...
  {
    paramString = bhlj.a(paramString);
    if (this.fileItem == null) {}
    for (;;)
    {
      return false;
      ...
      while (i < j)
      {
        if (paramString.equalsIgnoreCase(bhlj.a(this.fileItem[i].strFilePath))) {
          return true;
        }
        i += 1;
      }
  ...
  public void addFileItem(String paramString1, File paramFile, String paramString2)
  {
    ...
    if (a(paramFile))
    {
      paramString1 = bhli.a(paramString1);
  ...
  public void updateCfgHash()
  {
    ...
    label10:
    if (i < this.fileItem.length) {
      if (!bhlj.a(this.fileItem[i].strFilePath).equalsIgnoreCase("SupportUpd.cfg")) {
        break label46;
      }
    }
    for (;;)
    {
      ...
      {
        localObject = bhli.a(this.fileItem[i].strFilePath);
        if (localObject != null) {
