  ...
  implements Handler.Callback, INetEngine.IBreakDownFix, INetEngine.INetEngineListener, Manager
{
  ...
  private void a(boolean paramBoolean, NetReq paramNetReq)
  {
    ...
    amfo localamfo = (amfo)paramNetReq.a();
    if ((!localFile.exists()) || (localamfo == null))
    {
      a(3);
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] http download complete: %s, %s", new Object[] { paramNetReq.jdField_c_of_type_JavaLangString, localamfo.jdField_c_of_type_JavaLangString }));
    }
    switch (localamfo.jdField_a_of_type_Int)
    {
    default: 
      return;
    case 1: 
      ...
      a("0X80078AC", localamfo.jdField_c_of_type_Int, "", "");
      if (this.jdField_a_of_type_ComTencentQqprotectSingleupdateQPUpdateConfig.a(localFile.toString()))
      {
        this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putInt("last_update_config_version", localamfo.jdField_c_of_type_Int).commit();
      ...
      a("0X80078AC", localamfo.jdField_c_of_type_Int, localamfo.jdField_b_of_type_JavaLangString, localamfo.jdField_c_of_type_JavaLangString);
      if (QLog.isColorLevel()) {
    ...
    a("0X80078AE", localamfo.jdField_c_of_type_Int, "", "");
    d(7);
  }
  ...
  private boolean a(amfo paramamfo)
  {
    if (paramamfo == null) {}
    do
    {
      return false;
      if ((paramamfo.jdField_a_of_type_Int == 2) && (paramamfo.e != 1) && (!NetworkUtils.isWifiConnected(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication())))
      {
        if (QLog.isColorLevel()) {
    ...
    } while ((paramamfo.jdField_d_of_type_Int < 3) && (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.contains(paramamfo.jdField_d_of_type_JavaLangString.toLowerCase())));
    ...
    localHttpNetReq.jdField_a_of_type_JavaLangString = paramamfo.jdField_c_of_type_JavaLangString;
    localHttpNetReq.jdField_a_of_type_Int = 0;
    localHttpNetReq.jdField_c_of_type_JavaLangString = (paramamfo.jdField_a_of_type_JavaLangString + paramamfo.jdField_b_of_type_JavaLangString);
    paramamfo.jdField_d_of_type_Int += 1;
    paramamfo.jdField_a_of_type_Long = new Date().getTime();
    localHttpNetReq.a(paramamfo);
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramamfo.jdField_d_of_type_JavaLangString.toLowerCase(), localHttpNetReq);
    localINetEngine.a(localHttpNetReq);
    if (QLog.isColorLevel()) {
      QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] begin http download %s", new Object[] { paramamfo.jdField_c_of_type_JavaLangString }));
    }
    return true;
  }
  ...
  private void b(NetResp paramNetResp)
  {
    ...
    do
    {
      ...
      return;
      localamfo = (amfo)paramNetResp.jdField_a_of_type_ComTencentMobileqqTransfileNetReq.a();
    } while (localamfo == null);
    if (paramNetResp.jdField_a_of_type_Int == 0) {}
    while (!bool)
    {
      try
      {
        if (localamfo.jdField_d_of_type_Int >= 3) {
          break label146;
        }
        if (QLog.isColorLevel()) {
          QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] retried to download, retry=%d, result=%b, url=%s", new Object[] { Integer.valueOf(localamfo.jdField_d_of_type_Int), Boolean.valueOf(bool), localamfo.jdField_c_of_type_JavaLangString }));
        }
        a(localamfo);
        return;
      }
    ...
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(localamfo.jdField_d_of_type_JavaLangString.toLowerCase());
  ...
  private boolean h(SFU.UpdateSection paramUpdateSection)
  {
    ...
    if (paramUpdateSection != null)
    {
      ...
      bool = a(new amfo(2, 0, a(paramUpdateSection), paramUpdateSection.jdField_a_of_type_JavaLangString, paramUpdateSection.jdField_c_of_type_JavaLangString, paramUpdateSection.jdField_b_of_type_JavaLangString, 0, true, 0, new Date().getTime(), paramUpdateSection.jdField_b_of_type_Int));
    }
    return bool;
  }
      ...
      try
      {
        ...
        if (localUpdateQueryResponse != null)
        {
          ...
          if ((i1 == 0) && (k == 1))
          {
            ...
            bool1 = a(new amfo(1, k, a(), "qp_sfu_config.dat", paramFromServiceMsg, paramToServiceMsg, m, bool1, 0, new Date().getTime(), 1));
          }
        }
        else
        {
