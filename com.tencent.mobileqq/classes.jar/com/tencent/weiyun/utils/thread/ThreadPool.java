...
public class ThreadPool
{
  ...
  public ThreadPool(String paramString, int paramInt1, int paramInt2, long paramLong, TimeUnit paramTimeUnit, BlockingQueue<Runnable> paramBlockingQueue)
  {
    ...
    this.mExecutor = new ThreadPoolExecutor(i, paramInt1, paramLong, paramTimeUnit, paramBlockingQueue, this.mThreadFactory);
  }
    ...
    implements ThreadFactory
  {
    ...
    public Thread newThread(Runnable paramRunnable)
    {
      new Thread(paramRunnable, this.mName + '-' + this.mNumber.getAndIncrement())
      {
        public void run()
        {
          Process.setThreadPriority(ThreadPool.PriorityThreadFactory.this.mPriority);
          super.run();
        }
      };
    }
  ...
  private class Worker<T>
    implements Runnable, Future<T>, ThreadPool.JobContext, Comparable<Worker>
  {
