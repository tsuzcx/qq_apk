...
public class ThreadPool
{
  ...
  public ThreadPool(String paramString, int paramInt1, int paramInt2, BlockingQueue<Runnable> paramBlockingQueue)
  {
    ...
    this.mExecutor = new ThreadPoolExecutor(i, paramInt1, 10L, TimeUnit.SECONDS, paramBlockingQueue, new PriorityThreadFactory(paramString, 10));
  }
    ...
    implements Runnable, Future<T>, ThreadPool.JobContext, Comparable<Worker>
  {
    ...
    private boolean acquireResource(ThreadPool.ResourceCounter paramResourceCounter)
    {
      ...
      //   1: monitorenter
      //   2: aload_0
      //   3: getfield 59	com/tencent/weiyun/transmission/utils/thread/ThreadPool$Worker:mIsCancelled	Z
      //   6: ifeq +12 -> 18
      //   9: aload_0
      //   10: aconst_null
      //   11: putfield 61	com/tencent/weiyun/transmission/utils/thread/ThreadPool$Worker:mWaitOnResource	Lcom/tencent/weiyun/transmission/utils/thread/ThreadPool$ResourceCounter;
      //   14: aload_0
      //   15: monitorexit
      //   16: iconst_0
      //   17: ireturn
      //   18: aload_0
      //   19: aload_1
      //   20: putfield 61	com/tencent/weiyun/transmission/utils/thread/ThreadPool$Worker:mWaitOnResource	Lcom/tencent/weiyun/transmission/utils/thread/ThreadPool$ResourceCounter;
      //   23: aload_0
      //   24: monitorexit
      //   25: aload_1
      //   26: monitorenter
      //   27: aload_1
      //   28: getfield 66	com/tencent/weiyun/transmission/utils/thread/ThreadPool$ResourceCounter:value	I
      //   31: ifle +31 -> 62
      //   34: aload_1
      //   35: aload_1
      //   36: getfield 66	com/tencent/weiyun/transmission/utils/thread/ThreadPool$ResourceCounter:value	I
      //   39: iconst_1
      //   40: isub
      //   41: putfield 66	com/tencent/weiyun/transmission/utils/thread/ThreadPool$ResourceCounter:value	I
      //   44: aload_1
      //   45: monitorexit
      //   46: aload_0
      //   47: monitorenter
      //   48: aload_0
      //   49: aconst_null
      //   50: putfield 61	com/tencent/weiyun/transmission/utils/thread/ThreadPool$Worker:mWaitOnResource	Lcom/tencent/weiyun/transmission/utils/thread/ThreadPool$ResourceCounter;
      //   53: aload_0
      //   54: monitorexit
      //   55: iconst_1
      //   56: ireturn
    ...
    public void cancel()
    {
      ...
      //   14: aload_0
      //   15: iconst_1
      //   16: putfield 59	com/tencent/weiyun/transmission/utils/thread/ThreadPool$Worker:mIsCancelled	Z
      //   19: aload_0
      //   20: getfield 61	com/tencent/weiyun/transmission/utils/thread/ThreadPool$Worker:mWaitOnResource	Lcom/tencent/weiyun/transmission/utils/thread/ThreadPool$ResourceCounter;
      //   23: ifnull +19 -> 42
      //   26: aload_0
      //   27: getfield 61	com/tencent/weiyun/transmission/utils/thread/ThreadPool$Worker:mWaitOnResource	Lcom/tencent/weiyun/transmission/utils/thread/ThreadPool$ResourceCounter;
      //   30: astore_2
      //   31: aload_2
      //   32: monitorenter
      //   33: aload_0
      //   34: getfield 61	com/tencent/weiyun/transmission/utils/thread/ThreadPool$Worker:mWaitOnResource	Lcom/tencent/weiyun/transmission/utils/thread/ThreadPool$ResourceCounter;
      //   37: invokevirtual 82	java/lang/Object:notifyAll	()V
      //   40: aload_2
      //   41: monitorexit
      //   42: aload_0
      //   43: getfield 85	com/tencent/weiyun/transmission/utils/thread/ThreadPool$Worker:mCancelListener	Lcom/tencent/weiyun/transmission/utils/thread/ThreadPool$CancelListener;
      //   46: ifnull -35 -> 11
      //   49: aload_0
      //   50: getfield 85	com/tencent/weiyun/transmission/utils/thread/ThreadPool$Worker:mCancelListener	Lcom/tencent/weiyun/transmission/utils/thread/ThreadPool$CancelListener;
    ...
    public T get()
    {
      try
      {
        for (;;)
        {
          ...
          {
            TsLog.w("Worker", "ignore exception", localException);
          }
        }
    ...
    public void run()
    {
      ...
      catch (Throwable localThrowable)
      {
        for (;;)
        {
          ...
          TsLog.w("Worker", "Exception in running a job", localThrowable);
