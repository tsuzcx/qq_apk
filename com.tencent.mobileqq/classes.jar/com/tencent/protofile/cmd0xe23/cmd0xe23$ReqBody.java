  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "uin", "continue_finish_day", "today_ad_count" }, new Object[] { Long.valueOf(0L), localInteger, localInteger }, ReqBody.class);
  }
}
