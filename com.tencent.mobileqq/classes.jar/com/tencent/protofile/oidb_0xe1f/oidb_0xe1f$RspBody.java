  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32 }, new String[] { "have_redpacket", "id", "start_time", "end_time" }, new Object[] { Boolean.valueOf(false), "", localInteger, localInteger }, RspBody.class);
  }
}
