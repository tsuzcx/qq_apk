  ...
  extends MessageMicro<ReqSubmitHomework>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 42, 50 }, new String[] { "hw_id", "gid", "status", "comment_info", "examination", "openId" }, new Object[] { localLong, localLong, Integer.valueOf(0), null, null, "" }, ReqSubmitHomework.class);
  }
}
