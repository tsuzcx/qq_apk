  ...
  extends MessageMicro<ReqReciteScore>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "error_times", "remind_times", "total_time", "total_word" }, new Object[] { localInteger, localInteger, localInteger, localInteger }, ReqReciteScore.class);
  }
}
