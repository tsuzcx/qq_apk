  ...
  extends MessageMicro<BatchCheckBusinessUpdateResp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "retcode", "bids", "source_ids", "ts_list" }, new Object[] { localInteger, localInteger, localInteger, Long.valueOf(0L) }, BatchCheckBusinessUpdateResp.class);
  }
}
