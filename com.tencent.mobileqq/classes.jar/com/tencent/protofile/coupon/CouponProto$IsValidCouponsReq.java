  ...
  extends MessageMicro<IsValidCouponsReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "bids", "cids", "source_ids" }, new Object[] { localInteger, localInteger, localInteger }, IsValidCouponsReq.class);
  }
}
