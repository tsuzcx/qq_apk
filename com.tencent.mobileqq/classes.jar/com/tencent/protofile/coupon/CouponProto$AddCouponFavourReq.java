  ...
  extends MessageMicro<AddCouponFavourReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34 }, new String[] { "bid", "cid", "source_id", "city" }, new Object[] { localInteger, localInteger, localInteger, "" }, AddCouponFavourReq.class);
  }
}
