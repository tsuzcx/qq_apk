  ...
  extends MessageMicro<ConsumeReportItem>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 16, 24, 34, 40, 48, 56, 66, 72 }, new String[] { "current_progress", "total_progress", "rowkey", "current_rowkey_progress", "need_record", "next_request_time", "rpt_tips_items", "current_rowkey_incr_progress" }, new Object[] { localInteger, localInteger, "", localInteger, localInteger, Long.valueOf(0L), null, localInteger }, ConsumeReportItem.class);
  }
}
