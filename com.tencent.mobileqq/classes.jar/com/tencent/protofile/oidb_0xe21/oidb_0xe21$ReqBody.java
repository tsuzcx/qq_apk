  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 34, 82, 122 }, new String[] { "rowkey", "type", "progress", "skey", "ad_report_req", "terminal_info" }, new Object[] { "", localInteger, localInteger, "", null, null }, ReqBody.class);
  }
}
