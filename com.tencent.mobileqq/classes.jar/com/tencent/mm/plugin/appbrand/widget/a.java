  ...
  extends Resources
{
  ...
  {
    return this.a.getColor(paramInt, paramTheme);
  }
  ...
  @NonNull
  @RequiresApi(api=23)
  public ColorStateList getColorStateList(int paramInt, @Nullable Resources.Theme paramTheme)
  {
    return this.a.getColorStateList(paramInt, paramTheme);
  }
