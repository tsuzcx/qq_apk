  ...
  implements SchemeResolver.ResolverContext
{
  ...
  final List<ResolverState.MountPointEntry> mActiveMountPoints;
  ...
  private static List<ResolverState.MountPointEntry> generateMountPoints(Map<String, FileSystem> paramMap, SortedMap<String, String> paramSortedMap, Map<String, String> paramMap1)
  {
