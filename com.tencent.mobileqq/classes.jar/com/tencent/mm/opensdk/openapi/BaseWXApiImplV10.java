  ...
  implements IWXAPI
{
  ...
  private String getTokenFromWX(Context paramContext)
  {
    ...
    Cursor localCursor = paramContext.getContentResolver().query(Uri.parse("content://com.tencent.mm.sdk.comm.provider/genTokenForOpenSdk"), null, null, new String[] { this.appId, "621086464" }, null);
