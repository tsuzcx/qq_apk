...
final class k
  ...
  implements Runnable
{
  public k(@NotNull MBRuntime paramMBRuntime, @NotNull c paramc)
  {
  ...
  public void run()
  {
    c.c.b("AnimationFrameHandler", "hy: start native raf looper", new Object[0]);
    k().d();
  }
}
