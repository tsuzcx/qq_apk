...
public final class GetViewInfoCgiRsp
  extends ExtendableMessageNano<GetViewInfoCgiRsp>
{
  public ViewInfo[] a;
  public long b;
  public int c;
  ...
  public GetViewInfoCgiRsp()
  {
    a();
  }
  
  public GetViewInfoCgiRsp a()
  {
    this.a = ViewInfo.a();
    this.b = 0L;
    this.c = 0;
  ...
  public GetViewInfoCgiRsp a(CodedInputByteBufferNano paramCodedInputByteBufferNano)
  {
    for (;;)
    {
 ...
 * Qualified Name:     com.tencent.trpcprotocol.pendant.ilivePendantSvr.ilivePendantSvr.nano.GetViewInfoCgiRsp
