...
public final class GetViewInfoRsp
  extends ExtendableMessageNano<GetViewInfoRsp>
{
  public ViewInfo[] a;
  public long b;
  
  public GetViewInfoRsp()
  {
    a();
  }
  
  public GetViewInfoRsp a()
  {
    this.a = ViewInfo.a();
    this.b = 0L;
  ...
  public GetViewInfoRsp a(CodedInputByteBufferNano paramCodedInputByteBufferNano)
  {
    for (;;)
    {
 ...
 * Qualified Name:     com.tencent.trpcprotocol.pendant.ilivePendantSvr.ilivePendantSvr.nano.GetViewInfoRsp
