...
public final class PullViewInfoRsp
  extends ExtendableMessageNano<PullViewInfoRsp>
{
  public ViewInfo[] a;
  public long b;
  
  public PullViewInfoRsp()
  {
    a();
  }
  
  public static PullViewInfoRsp a(byte[] paramArrayOfByte)
  {
    return (PullViewInfoRsp)MessageNano.mergeFrom(new PullViewInfoRsp(), paramArrayOfByte);
  }
  
  public PullViewInfoRsp a()
  {
    this.a = ViewInfo.a();
    this.b = 0L;
  ...
  public PullViewInfoRsp a(CodedInputByteBufferNano paramCodedInputByteBufferNano)
  {
    for (;;)
    {
 ...
 * Qualified Name:     com.tencent.trpcprotocol.pendant.ilivePendantSvr.ilivePendantSvr.nano.PullViewInfoRsp
