...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24 }, new String[] { "configType", "conf", "ret" }, new Object[] { Integer.valueOf(0), "", Integer.valueOf(0) }, MobileConfRsp.class);
