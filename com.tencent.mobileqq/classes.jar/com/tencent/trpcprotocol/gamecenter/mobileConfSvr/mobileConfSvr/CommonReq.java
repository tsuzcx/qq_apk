...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 32, 40, 48, 56, 64 }, new String[] { "qqVersion", "manufacturer", "model", "osVersionCode", "totalMemory", "cpuCoreCount", "lastPreDownloadTime", "lastUpdateTime" }, new Object[] { "", "", "", Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Long.valueOf(0L), Long.valueOf(0L) }, CommonReq.class);
