...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 32, 41, 48, 56 }, new String[] { "gradeDistributedList", "fightScore", "fightScoreRank", "weekPlayGameCount", "weekPlayUserCount" }, new Object[] { null, Long.valueOf(0L), Double.valueOf(0.0D), Long.valueOf(0L), Long.valueOf(0L) }, QueryGroupInfoRsp.class);
