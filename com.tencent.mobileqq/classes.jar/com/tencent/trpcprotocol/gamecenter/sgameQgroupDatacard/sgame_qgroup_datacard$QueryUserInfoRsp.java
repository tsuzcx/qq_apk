...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 17, 24, 32, 40, 58 }, new String[] { "grade", "seasonWinRate", "gamesTotal", "mvpTotal", "bestOccupation", "bestHeroList" }, new Object[] { Integer.valueOf(0), Double.valueOf(0.0D), Long.valueOf(0L), Long.valueOf(0L), Integer.valueOf(0), null }, QueryUserInfoRsp.class);
