...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16 }, new String[] { "groupId", "showUin" }, new Object[] { Long.valueOf(0L), Long.valueOf(0L) }, QueryUserInfoReq.class);
