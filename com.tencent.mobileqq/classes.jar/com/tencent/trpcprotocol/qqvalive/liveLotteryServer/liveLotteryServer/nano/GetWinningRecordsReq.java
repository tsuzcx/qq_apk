...
public final class GetWinningRecordsReq
  extends ExtendableMessageNano<GetWinningRecordsReq>
{
  public int a;
  public int b;
  
  public GetWinningRecordsReq()
  {
    a();
  }
  
  public GetWinningRecordsReq a()
  {
    this.a = 0;
    this.b = 0;
  ...
  public GetWinningRecordsReq a(CodedInputByteBufferNano paramCodedInputByteBufferNano)
  {
    for (;;)
    {
 ...
 * Qualified Name:     com.tencent.trpcprotocol.qqvalive.liveLotteryServer.liveLotteryServer.nano.GetWinningRecordsReq
