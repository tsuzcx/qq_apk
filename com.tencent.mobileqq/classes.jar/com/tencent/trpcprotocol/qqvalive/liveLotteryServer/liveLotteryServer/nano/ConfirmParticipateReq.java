...
public final class ConfirmParticipateReq
  extends ExtendableMessageNano<ConfirmParticipateReq>
{
  public String a;
  public long b;
  public String c;
  ...
  public ConfirmParticipateReq()
  {
    a();
  }
  
  public ConfirmParticipateReq a()
  {
    this.a = "";
    this.b = 0L;
    this.c = "";
  ...
  public ConfirmParticipateReq a(CodedInputByteBufferNano paramCodedInputByteBufferNano)
  {
    for (;;)
    {
 ...
 * Qualified Name:     com.tencent.trpcprotocol.qqvalive.liveLotteryServer.liveLotteryServer.nano.ConfirmParticipateReq
