...
public final class ClearUserDataReq
  extends ExtendableMessageNano<ClearUserDataReq>
{
  public long a;
  public long b;
  public long c;
  ...
  public ClearUserDataReq()
  {
    a();
  }
  
  public ClearUserDataReq a()
  {
    this.a = 0L;
    this.b = 0L;
    this.c = 0L;
  ...
  public ClearUserDataReq a(CodedInputByteBufferNano paramCodedInputByteBufferNano)
  {
    for (;;)
    {
 ...
 * Qualified Name:     com.tencent.trpcprotocol.qqvalive.liveLotteryServer.liveLotteryServer.nano.ClearUserDataReq
