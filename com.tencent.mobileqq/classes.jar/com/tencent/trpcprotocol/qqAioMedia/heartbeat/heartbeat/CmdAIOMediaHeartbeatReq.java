  ...
  extends MessageMicro<CmdAIOMediaHeartbeatReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "enum_aio_type", "uint64_id", "enum_media_type" }, new Object[] { localInteger, Long.valueOf(0L), localInteger }, CmdAIOMediaHeartbeatReq.class);
  }
}
