...
public class PropertyUtil
{
  ...
  private static String c(String paramString1, String paramString2)
  {
    ...
    //   29: aconst_null
    //   30: astore 4
    //   32: new 81	java/io/BufferedReader
    //   35: dup
    //   36: new 83	java/io/InputStreamReader
    //   39: dup
    //   40: aload 5
    //   42: invokevirtual 89	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    //   45: invokespecial 92	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   48: invokespecial 95	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   51: astore_0
    ...
    //   59: astore_3
    //   60: aload_0
    //   61: invokevirtual 98	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   64: astore 4
    //   66: aload 4
    //   68: ifnull +33 -> 101
    //   71: aload_3
    ...
    //   87: astore_3
    //   88: aload_0
    //   89: invokevirtual 101	java/io/BufferedReader:close	()V
    //   92: aload_1
    //   93: astore_0
    //   94: aload 5
    //   96: invokevirtual 104	java/lang/Process:destroy	()V
    //   99: aload_0
    //   100: areturn
    //   101: aload_3
    //   102: invokevirtual 75	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   105: astore_3
    //   106: aload_3
    //   107: invokestatic 42	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   110: istore_2
    //   111: iload_2
    //   112: ifne +5 -> 117
    //   115: aload_3
    ...
    //   122: astore_3
    //   123: aload_0
    //   124: invokevirtual 101	java/io/BufferedReader:close	()V
    //   127: goto +44 -> 171
    //   130: aload 4
    //   132: ifnull +10 -> 142
    //   135: aload_1
    //   136: astore_3
    //   137: aload 4
    //   139: invokevirtual 101	java/io/BufferedReader:close	()V
    //   142: aload_1
    //   143: astore_3
    //   144: aload_0
    //   145: athrow
