...
public class PortConfigStrategy
{
  ...
  private List a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        QDLog.c("PortConfigStrategy", "findPortConfig", localThrowable);
  ...
  public final void a(String paramString)
  {
    ...
    if (QDLog.b()) {
      QDLog.b("PortConfigStrategy", "Downloader port config:" + paramString);
    }
    ...
    for (;;)
    {
      ...
      if (j < localJSONArray2.length())
      {
        ...
        QDLog.b("PortConfigStrategy", "downloader port: domain:" + str + " port:" + localInteger);
        continue;
      }
