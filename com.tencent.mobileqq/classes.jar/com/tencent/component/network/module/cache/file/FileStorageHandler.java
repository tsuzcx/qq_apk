  ...
  implements FileCacheService.StorageHandler
{
  ...
  public void a(FileCacheService paramFileCacheService, long paramLong1, long paramLong2, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_ComTencentComponentNetworkUtilsThreadFuture = PriorityThreadPool.getDefault().submit(new pin(this, paramBoolean, paramFileCacheService));
  }
}
