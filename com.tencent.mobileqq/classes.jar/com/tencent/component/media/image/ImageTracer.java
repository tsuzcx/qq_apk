...
public class ImageTracer
{
  ...
  private static ConcurrentHashMap a = new ConcurrentHashMap(50, 0.75F, 8);
  
  private static void a(String paramString, long[] paramArrayOfLong)
  {
  ...
  public static void end(String paramString)
  {
    ...
    if ((localObject != null) && (localObject.length > 5))
    {
      ...
      a(paramString, (long[])localObject);
    }
  }
  ...
  public static void endSuperResolution(String paramString)
  {
    ...
    if ((localObject != null) && (localObject.length > 10))
    {
      ...
      if (localObject[9] > localObject[10])
      {
        ...
        ((HashMap)localObject).put("isHighScale", String.valueOf(RapidNetUtils.isHighScaleUrl(paramString)));
        ((HashMap)localObject).put("modelId", String.valueOf(RapidNetUtils.currentModelId));
  ...
  {
    Object localObject = ImageKey.getUrlKey(paramString, true);
    long[] arrayOfLong = (long[])a.get(localObject);
  ...
  {
    paramString = ImageKey.getUrlKey(paramString, true);
    long[] arrayOfLong = (long[])a.get(paramString);
    ImageManagerEnv localImageManagerEnv;
  ...
  public static void start(String paramString)
  {
    ...
    long[] arrayOfLong = (long[])a.get(str);
