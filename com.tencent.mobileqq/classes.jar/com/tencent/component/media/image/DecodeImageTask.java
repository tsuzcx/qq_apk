  ...
  extends pfn
{
  ...
  protected DecodeImageTask(pfn parampfn)
  {
    super(parampfn);
  }
  ...
  private void a(BitmapReference paramBitmapReference, ImageKey paramImageKey, int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        ImageManager.getSuperResolutionHandler().postAtFrontOfQueue(new pel(this, paramImageKey, paramBitmapReference, j, k, paramInt));
        i = 1;
        break;
  ...
  private void a(ImageKey paramImageKey)
  {
    ...
    //   260: new 431	pep
    //   263: dup
    //   264: invokespecial 436	pep:<init>	()V
    //   267: astore 15
    ...
    //   309: aload 15
    //   311: aload 16
    //   313: invokespecial 447	com/tencent/component/media/image/DecodeImageTask:a	(Lcom/tencent/component/media/image/ImageKey;Ljava/io/InputStream;Lpep;Landroid/graphics/BitmapFactory$Options;)V
    //   316: aload 10
    //   318: astore 11
    //   320: aload 10
    //   322: astore 12
    ...
    //   333: aload_1
    //   334: aload 15
    //   336: invokespecial 450	com/tencent/component/media/image/DecodeImageTask:a	(Lcom/tencent/component/media/image/ImageKey;Lpep;)Z
    //   339: ifne +302 -> 641
    //   342: aload 10
    ...
    //   386: aload 10
    //   388: aload 16
    //   390: invokespecial 458	com/tencent/component/media/image/DecodeImageTask:a	(Lcom/tencent/component/media/image/ImageKey;Lpep;Ljava/io/FileInputStream;Landroid/graphics/BitmapFactory$Options;)Z
    //   393: istore 9
    //   395: aload 10
    //   397: astore 11
    //   399: aload 15
    //   401: getfield 459	pep:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   404: astore 13
    //   406: aload 10
    //   408: astore 11
  ...
  private void a(ImageKey paramImageKey, InputStream paramInputStream, pep parampep, BitmapFactory.Options paramOptions)
  {
    ...
    {
      parampep.jdField_a_of_type_JavaLangString = paramInputStream;
      parampep.b = paramOptions.outHeight;
      parampep.jdField_a_of_type_Int = paramOptions.outWidth;
      jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramImageKey.filePath, parampep);
      return;
    }
  }
  ...
  private boolean a(ImageKey paramImageKey)
  {
    ...
    pep localpep = (pep)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramImageKey.filePath);
    Object localObject2 = localSharpPDecoderHelper.a();
    Object localObject1;
    if ((localpep == null) || (localpep.jdField_a_of_type_JavaLangString.equals("unknown")))
    {
      localpep = new pep();
      localpep.b = ((SharpPDecoderWrapper.SharpPFeatureWrapper)localObject2).b();
      localpep.jdField_a_of_type_Int = ((SharpPDecoderWrapper.SharpPFeatureWrapper)localObject2).a();
      localObject1 = localSharpPDecoderHelper.a();
      if (localObject1 != null)
      {
        localpep.jdField_a_of_type_JavaLangString = ((String)localObject1);
        jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramImageKey.filePath, localpep);
      }
    }
    label267:
    label547:
    ...
    for (;;)
    {
      ...
      if (localObject1 == null)
      {
        ...
        if ((!b(localpep.jdField_a_of_type_JavaLangString)) || (paramImageKey.options == null) || (!paramImageKey.options.needShowGifAnimation)) {
          break label547;
        }
        ImageManagerLog.d(jdField_a_of_type_JavaLangString, "handlerSharpPDecodeMessage -- url: " + paramImageKey.url + " --is sharp gif：" + localpep.jdField_a_of_type_JavaLangString);
      ...
      for (localObject1 = ((NewGifImage)localObject2).getDrawable();; localObject1 = null)
      {
        ...
        for (;;)
        {
          ...
          if ((paramImageKey.options != null) && (paramImageKey.options.imageConfig != null))
          {
            ...
            m /= i;
            i = k / i;
            if (!SharpPUtils.b(localpep.jdField_a_of_type_JavaLangString)) {
              break label836;
            }
          }
  ...
  private boolean a(ImageKey paramImageKey, pep parampep)
  {
    int i;
    NewGifImage localNewGifImage;
    if ((b(parampep.jdField_a_of_type_JavaLangString)) && (paramImageKey.options != null) && (paramImageKey.options.needShowGifAnimation))
    {
    ...
    label363:
    label366:
    for (parampep = localNewGifImage.getDrawable();; parampep = null)
    {
      ...
      if (parampep != null)
      {
        ...
        parampep = paramImageKey.options.extraProcessor.doProcess(parampep);
      }
      for (;;)
      {
        i = paramImageKey.hashCodeEx();
        ImageManager.getInstance().a(paramImageKey.urlKey, i, localNewGifImage, parampep, paramImageKey.options);
        setResult(8, new Object[] { parampep, null, paramImageKey.urlKey, Integer.valueOf(i), localNewGifImage, parampep });
        ImageTaskTracer.removeImageDecodeThreadDecodingRecord(paramImageKey.hashCodeEx());
        for (;;)
        {
          boolean bool1 = true;
  ...
  private boolean a(ImageKey paramImageKey, pep parampep, FileInputStream paramFileInputStream, BitmapFactory.Options paramOptions)
  {
    int j = paramImageKey.hashCodeEx();
    ...
    {
      i = ImageOptionSampleSize.computeSampleSize(paramImageKey.options, parampep.jdField_a_of_type_Int, parampep.b);
      c.put(Integer.valueOf(j), Integer.valueOf(i));
      if ((paramImageKey.options == null) || (paramImageKey.options.imageConfig == null)) {
        break label434;
      }
      ...
      {
        float f = parampep.b / parampep.jdField_a_of_type_Int;
        if (((f > 2.0F) || (f < 0.5F)) && (parampep.b * parampep.jdField_a_of_type_Int > ImageManagerEnv.g().getScreenHeight() * ImageManagerEnv.g().getScreenWidth())) {
    ...
    for (;;)
    {
      paramOptions.outWidth = parampep.jdField_a_of_type_Int;
      paramOptions.outHeight = parampep.b;
      paramOptions.inPurgeable = true;
      paramOptions.inInputShareable = true;
      paramOptions.inSampleSize = i;
      paramOptions.outMimeType = parampep.jdField_a_of_type_JavaLangString;
      parampep = a(ImageManager.getInstance().getDecoder(), paramFileInputStream, paramOptions, false);
      if ((parampep != null) || (TextUtils.isEmpty(paramImageKey.filePath)) || (!SharpPUtils.a(new File(paramImageKey.filePath)))) {
        break label517;
      }
      ...
      break;
      label434:
      if (c(parampep.jdField_a_of_type_JavaLangString))
      {
      ...
      break label90;
      label466:
      if ((parampep.jdField_a_of_type_Int != 0) && (parampep.b != 0) && (parampep.jdField_a_of_type_Int / parampep.b == 2.0F)) {
        paramOptions.inPreferredConfig = Bitmap.Config.RGB_565;
      } else {
        paramOptions.inPreferredConfig = Bitmap.Config.ARGB_8888;
      }
    ...
    label517:
    a(parampep, paramImageKey, j, true);
    return parampep != null;
  }
  ...
  public static DecodeImageTask obtain(pfn parampfn)
  {
    if (needRecycle) {}
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (jdField_a_of_type_ComTencentComponentMediaImageDecodeImageTask != null)
      {
        ...
        localDecodeImageTask.jdField_b_of_type_ComTencentComponentMediaImageDecodeImageTask = null;
        jdField_a_of_type_Int -= 1;
        localDecodeImageTask.setImageTask(parampfn);
        return localDecodeImageTask;
      }
      return new DecodeImageTask(parampfn);
    }
  }
