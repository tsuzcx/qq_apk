  ...
  implements Animatable
{
  ...
  private Runnable jdField_a_of_type_JavaLangRunnable = new phd(this, null);
  ...
  public NewAnimationDrawable(ImageLoader.Options paramOptions)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new phb(this, Looper.getMainLooper());
    ...
    this.jdField_a_of_type_ComTencentComponentMediaUtilsLruCache = new phc(this, getByteCount());
  }
  ...
  private void d()
  {
    ...
    while (i < this.jdField_a_of_type_Int)
    {
      ...
      if (localObject != null)
      {
        localObject = (phe)((WeakReference)localObject).get();
        if ((localObject != null) && (((phe)localObject).jdField_a_of_type_ComTencentComponentMediaImageBitmapReference.getBitmap().getGenerationId() == ((phe)localObject).jdField_a_of_type_Int))
        {
          this.jdField_a_of_type_ComTencentComponentMediaUtilsLruCache.put(str, ((phe)localObject).jdField_a_of_type_ComTencentComponentMediaImageBitmapReference);
