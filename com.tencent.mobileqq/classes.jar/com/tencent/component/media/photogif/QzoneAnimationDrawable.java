  ...
  implements Animatable
{
  ...
  private pns jdField_a_of_type_Pns;
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_Pnt = new pnt(this, null);
    this.jdField_a_of_type_Pns = new pns(this, null);
  ...
  private boolean a()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      {
        this.jdField_a_of_type_JavaUtilConcurrentScheduledFuture = this.jdField_a_of_type_JavaUtilConcurrentScheduledThreadPoolExecutor.schedule(this.jdField_a_of_type_Pns, this.jdField_a_of_type_ComTencentComponentMediaImageImageKey.options.photoDelayTimeInMs, TimeUnit.MILLISECONDS);
  ...
  private void c()
  {
    if (this.jdField_a_of_type_Int < this.jdField_a_of_type_ComTencentComponentMediaImageImageKey.options.photoList.size())
    {
      ...
      ImageLoader.getInstance().loadImageAsync(str, this.jdField_a_of_type_Pnt, this.jdField_a_of_type_ComTencentComponentMediaImageImageLoader$Options);
