  ...
  implements Parcelable
{
  ...
  {
    Object localObject = sClassLoader;
    if (localObject != null) {
      return localObject;
    }
    localObject = BaseApplicationImpl.getContext();
    if (PluginUtils.getInstalledPluginPath((Context)localObject, "qzone_plugin.apk").exists()) {
      try
      {
        sClassLoader = QzonePluginProxyActivity.getQZonePluginClassLoader((Context)localObject);
      }
    ...
    if (paramString != null)
    {
      ...
      if (localObject == null)
      {
        ...
        if (paramClass == null) {
          try
          {
            localObject = ClassLoadUtils.load(getClassLoader(), paramString);
          }
          catch (ClassNotFoundException paramClass)
          {
            ...
            QZLog.e("ParcelableWrapper", ((StringBuilder)localObject).toString(), paramClass);
  ...
  private static ParcelableWrapper.ParcableInfo parseParcableInfo(Class paramClass)
  {
    ...
    if (((localObject1 == null) || (localObject1.length <= 0)) && (localList2.size() <= 0))
    {
      ...
      QZLog.e("ParcelableWrapper", ((StringBuilder)localObject1).toString());
