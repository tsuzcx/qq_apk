...
class YoloRoomManager$21
  implements DoYoloRoomCmdResultListsner
{
  YoloRoomManager$21(YoloRoomManager paramYoloRoomManager, IResultListener paramIResultListener) {}
  ...
  public void a(YoloRoomOuterClass.YoloRoomCmdRsp paramYoloRoomCmdRsp, long paramLong, boolean paramBoolean)
  {
    ...
    if (localIResultListener != null)
    {
      if (paramYoloRoomCmdRsp != null) {
        paramYoloRoomCmdRsp = paramYoloRoomCmdRsp.yolo_room_start_game_cmd_rsp;
      } else {
 ...
 * Qualified Name:     com.tencent.timi.game.room.impl.YoloRoomManager.21
