...
final class UserInfoDbUtil$updateUserSmobaInfo$1
  implements Runnable
{
  UserInfoDbUtil$updateUserSmobaInfo$1(List paramList) {}
  ...
  public final void run()
  {
    ...
    {
      Object localObject1 = (GameDataServerOuterClass.UserDefaultRole)localIterator.next();
      Object localObject2 = UserInfoDbUtil.a;
      long l = ((GameDataServerOuterClass.UserDefaultRole)localObject1).uid.get();
      ...
      {
        ((UserInfoEntity)localObject2).defaultSmobaRoleExtInfo = ((GameDataServerOuterClass.SmobaGameRoleInfo)((GameDataServerOuterClass.UserDefaultRole)localObject1).role_info.get()).toByteArray();
        ((UserInfoEntity)localObject2).authStatus = ((GameDataServerOuterClass.UserDefaultRole)localObject1).auth_status.get();
        localYesDataBaseHelper.a((Entity)localObject2);
        localObject1 = UserInfoDbUtil.a.b((UserInfoEntity)localObject2);
 ...
 * Qualified Name:     com.tencent.timi.game.userinfo.impl.util.UserInfoDbUtil.updateUserSmobaInfo.1
