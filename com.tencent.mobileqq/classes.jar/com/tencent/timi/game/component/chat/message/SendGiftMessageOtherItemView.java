...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcom/tencent/timi/game/component/chat/message/SendGiftMessageOtherItemView;", "Lcom/tencent/timi/game/component/chat/message/SendGiftMessageBaseItemView;", "ctx", "Landroid/content/Context;", "attr", "Landroid/util/AttributeSet;", "def", "", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "giftIv", "Lcom/tencent/image/URLImageView;", "sendGiftDetailTv", "Landroid/widget/TextView;", "usrNameClickView", "Landroid/view/View;", "usrNameTv", "Lcom/tencent/timi/game/userinfo/api/view/AvatarTextView;", "getGiftImageView", "getSendGiftDetailTextView", "getUsrNameClickView", "getUsrNameTextView", "timi-game-impl_release"}, k=1, mv={1, 1, 16})
public final class SendGiftMessageOtherItemView
  extends SendGiftMessageBaseItemView
{
  ...
  @JvmOverloads
  public SendGiftMessageOtherItemView(@NotNull Context paramContext)
  {
    this(paramContext, null, 0, 6, null);
  }
  
  @JvmOverloads
  public SendGiftMessageOtherItemView(@NotNull Context paramContext, @Nullable AttributeSet paramAttributeSet)
  {
    this(paramContext, paramAttributeSet, 0, 4, null);
  }
  
  @JvmOverloads
  public SendGiftMessageOtherItemView(@NotNull Context paramContext, @Nullable AttributeSet paramAttributeSet, int paramInt)
  {
    super(paramContext, paramAttributeSet, paramInt);
    setContentView(2131629480);
 ...
 * Qualified Name:     com.tencent.timi.game.component.chat.message.SendGiftMessageOtherItemView
