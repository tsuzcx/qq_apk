...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"com/tencent/timi/game/team/impl/floating/TeamFloatingView$msgListener$1", "Lcom/tencent/timi/game/tim/api/message/IMsgListener;", "onDeleted", "", "msg", "Lcom/tencent/timi/game/tim/api/message/IMsg;", "onHistoryMsgs", "historyMessages", "", "onMsgRevoked", "msgId", "", "onNewMsg", "onResend", "onSend", "onSendFailed", "code", "", "desc", "onSendSuc", "timi-game-impl_release"}, k=1, mv={1, 1, 16})
public final class TeamFloatingView$msgListener$1
  implements IMsgListener
{
  ...
  {
    Intrinsics.checkParameterIsNotNull(paramIMsg, "msg");
    if ((!TeamFloatingView.a.a()) && (TeamFloatingView.a(this.a, paramIMsg))) {
      TeamFloatingView.a(this.a, "@我", true);
    }
  }
}
 ...
 * Qualified Name:     com.tencent.timi.game.team.impl.floating.TeamFloatingView.msgListener.1
