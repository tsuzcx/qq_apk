...
final class ExpandHallServiceImpl$hallDestroy$1
  implements Runnable
{
  ExpandHallServiceImpl$hallDestroy$1(ExpandHallServiceImpl paramExpandHallServiceImpl, IExpandHall paramIExpandHall) {}
  ...
  public final void run()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localExpandHallLifeCycleListener != null) {
        localExpandHallLifeCycleListener.b(this.a);
      }
    }
  }
}
 ...
 * Qualified Name:     com.tencent.timi.game.expand.hall.impl.ExpandHallServiceImpl.hallDestroy.1
