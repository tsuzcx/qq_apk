...
final class ExpandHallServiceImpl$hallOnCreate$1
  implements Runnable
{
  ExpandHallServiceImpl$hallOnCreate$1(ExpandHallServiceImpl paramExpandHallServiceImpl, IExpandHall paramIExpandHall) {}
  ...
  public final void run()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localExpandHallLifeCycleListener != null) {
        localExpandHallLifeCycleListener.a(this.a);
      }
    }
  }
}
 ...
 * Qualified Name:     com.tencent.timi.game.expand.hall.impl.ExpandHallServiceImpl.hallOnCreate.1
