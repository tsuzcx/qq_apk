...
final class ExpandHallServiceImpl$joinHallRoomFailed$1
  implements Runnable
{
  ExpandHallServiceImpl$joinHallRoomFailed$1(ExpandHallServiceImpl paramExpandHallServiceImpl, int paramInt, String paramString, IExpandHall paramIExpandHall) {}
  ...
  public final void run()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localExpandHallLifeCycleListener != null) {
        localExpandHallLifeCycleListener.a(this.a, this.b, this.c);
      }
    }
  }
}
 ...
 * Qualified Name:     com.tencent.timi.game.expand.hall.impl.ExpandHallServiceImpl.joinHallRoomFailed.1
