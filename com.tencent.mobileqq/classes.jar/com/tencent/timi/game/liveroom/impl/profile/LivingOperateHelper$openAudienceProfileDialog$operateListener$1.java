...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"com/tencent/timi/game/liveroom/impl/profile/LivingOperateHelper$openAudienceProfileDialog$operateListener$1", "Lcom/tencent/timi/game/liveroom/impl/profile/operate/ProfileOperateDialog$ItemClickListener;", "onItemClick", "", "type", "", "data", "Lcom/tencent/mobileqq/qqlive/data/room/AdminReason;", "timi-game-impl_release"}, k=1, mv={1, 1, 16})
public final class LivingOperateHelper$openAudienceProfileDialog$operateListener$1
  implements ProfileOperateDialog.ItemClickListener
{
  LivingOperateHelper$openAudienceProfileDialog$operateListener$1(long paramLong, LiveUserInfo paramLiveUserInfo) {}
 ...
 * Qualified Name:     com.tencent.timi.game.liveroom.impl.profile.LivingOperateHelper.openAudienceProfileDialog.operateListener.1
