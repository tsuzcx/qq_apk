...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"com/tencent/timi/game/api/impl/TimiGameApp$createExpandHallFragment$task$1", "Lcom/tencent/timi/game/api/impl/TimiGameApp$IStartTask;", "runStartTask", "", "locker", "Ljava/util/concurrent/CountDownLatch;", "dialog", "Lcom/tencent/timi/game/ui/widget/EmptyDialog;", "timeOutFlag", "Ljava/util/concurrent/atomic/AtomicBoolean;", "alreadyStart", "timi-game-impl_release"}, k=1, mv={1, 1, 16})
public final class TimiGameApp$createExpandHallFragment$task$1
  implements TimiGameApp.IStartTask
{
  TimiGameApp$createExpandHallFragment$task$1(long paramLong) {}
  ...
  public void a(@NotNull CountDownLatch paramCountDownLatch, @Nullable EmptyDialog paramEmptyDialog, @NotNull AtomicBoolean paramAtomicBoolean1, @NotNull AtomicBoolean paramAtomicBoolean2)
  {
    ...
    paramAtomicBoolean1.append("createExpandHallFragment ");
    paramAtomicBoolean1.append(System.currentTimeMillis() - this.a);
 ...
 * Qualified Name:     com.tencent.timi.game.api.impl.TimiGameApp.createExpandHallFragment.task.1
