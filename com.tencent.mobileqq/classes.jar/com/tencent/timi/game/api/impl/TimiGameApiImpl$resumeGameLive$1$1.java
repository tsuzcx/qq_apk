...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"com/tencent/timi/game/api/impl/TimiGameApiImpl$resumeGameLive$1$1", "Lcom/tencent/timi/game/component/qqlive/api/SimpleTgLiveAnchorStartListener;", "onFinalError", "", "step", "", "errorCode", "errorDisplayMsg", "", "onFinalLiveStreamResult", "isSuccess", "", "result", "Lcom/tencent/mobileqq/qqlive/data/anchor/sso/QQLiveAnchorDataBase;", "videoView", "Landroid/view/View;", "timi-game-impl_release"}, k=1, mv={1, 1, 16})
public final class TimiGameApiImpl$resumeGameLive$1$1
  extends SimpleTgLiveAnchorStartListener
{
  public void a(int paramInt1, int paramInt2, @Nullable String paramString)
  {
    GameLiveResultListener localGameLiveResultListener = this.a.d;
  ...
  public void a(boolean paramBoolean, @Nullable QQLiveAnchorDataBase paramQQLiveAnchorDataBase, @Nullable View paramView)
  {
    if (paramBoolean)
    {
      ((IAnchorRoomService)ServiceCenter.a(IAnchorRoomService.class)).a(this.a.c, true);
      paramQQLiveAnchorDataBase = this.a.d;
 ...
 * Qualified Name:     com.tencent.timi.game.api.impl.TimiGameApiImpl.resumeGameLive.1.1
