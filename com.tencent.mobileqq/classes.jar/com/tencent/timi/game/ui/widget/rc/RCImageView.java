...
public class RCImageView
  extends ImageView
  implements Checkable, RCAttrs
{
  RCHelper a = new RCHelper();
  
  public RCImageView(Context paramContext)
  {
    this(paramContext, null);
  }
  
  public RCImageView(Context paramContext, AttributeSet paramAttributeSet)
  {
    this(paramContext, paramAttributeSet, 0);
  }
  
  public RCImageView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
 ...
 * Qualified Name:     com.tencent.timi.game.ui.widget.rc.RCImageView
