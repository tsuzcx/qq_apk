...
class C2CMessageProcessor$ProcessMsgPushPBSlaveMaster
{
  ...
  public C2CMessageProcessor$ProcessMsgPushPBSlaveMaster(msg_comm.Msg paramMsg, ArrayList<MessageRecord> paramArrayList1, boolean paramBoolean, String paramString, ArrayList<DelMsgInfo> paramArrayList, ArrayList<MessageRecord> paramArrayList2)
  {
  ...
  private boolean a(MessageRecord paramMessageRecord, boolean paramBoolean, MessageForStructing paramMessageForStructing)
  {
    ...
    try
    {
      ...
      if ((i & 0x4) == 4)
      {
        ...
        i = C2CMessageProcessor.a(this.jdField_a_of_type_ComTencentImcoreMessageC2CMessageProcessor, this.jdField_a_of_type_MsfMsgcommMsg_comm$Msg);
        paramBoolean = bool2;
        if (i == 1) {
          paramBoolean = true;
        }
  ...
  public ProcessMsgPushPBSlaveMaster a()
  {
    ...
    {
      if (!bool) {
        this.jdField_a_of_type_ComTencentImcoreMessageC2CMessageProcessor.a.getMessageFacade().a(localMessageRecord.frienduin, localMessageRecord.istroop, localMessageRecord.time);
      }
