...
public class FlashPictureElemDecoder
  extends SimplePBElemDecoder
{
  ...
  {
    new MessagePBElemDecoder().a(paramList, paramList1, paramStringBuilder, paramMsg, paramBoolean2);
    return true;
  }
 ...
 * Qualified Name:     com.tencent.imcore.message.ext.codec.decoder.pbelement.FlashPictureElemDecoder
