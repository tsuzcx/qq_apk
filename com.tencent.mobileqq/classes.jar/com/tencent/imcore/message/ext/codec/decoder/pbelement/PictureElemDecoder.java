...
public class PictureElemDecoder
  extends SimplePBElemDecoder
{
  ...
  {
    new MessagePBElemDecoder().b(paramList, paramList1, paramStringBuilder, paramMsg, paramMessageInfo, paramBoolean2);
    return true;
  }
 ...
 * Qualified Name:     com.tencent.imcore.message.ext.codec.decoder.pbelement.PictureElemDecoder
