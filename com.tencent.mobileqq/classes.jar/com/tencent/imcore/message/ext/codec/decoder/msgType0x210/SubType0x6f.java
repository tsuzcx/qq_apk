  ...
  implements Msg0X210SubTypeDecoder
{
  private static void a(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler, MsgInfo paramMsgInfo, MsgType0x210 paramMsgType0x210)
  {
    ...
    Object localObject2 = (IndividualRedPacketManager)paramQQAppInterface.getManager(QQManagerFactory.INDIVIDUAL_RED_PACKET_MANAGER);
    ((IndividualRedPacketManager)localObject2).a(m, n, true);
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        if (j == 1)
        {
          ...
          ((NewFriendManager)paramQQAppInterface.getManager(QQManagerFactory.NEW_FRIEND_MANAGER)).b((QIMFollwerAdd)localObject1);
          break;
        }
        ...
        ((QIMNotifyAddFriend)localObject1).pushTime = MessageCache.a();
        if (QLog.isColorLevel()) {
          QLog.d("QIMNewNotifyPush", 2, "receive data= " + ((QIMNotifyAddFriend)localObject1).toString());
        }
        ((QIMNewFriendManager)paramQQAppInterface.getManager(QQManagerFactory.QIM_NEW_FRIEND_MANAGER)).a((QIMNotifyAddFriend)localObject1);
        break;
        k = 0;
        break label498;
        j = 0;
