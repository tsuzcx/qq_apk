...
public class FlashChatElemDecoder
  extends SimplePBElemDecoder
{
  ...
  {
    new MessagePBElemDecoder().a(paramList, paramList1, paramStringBuilder, paramMsg, paramMessageInfo);
    return true;
  }
 ...
 * Qualified Name:     com.tencent.imcore.message.ext.codec.decoder.pbelement.FlashChatElemDecoder
