...
public class TroopStoryCommentElemDecoder
  extends SimplePBElemDecoder
{
  ...
  {
    new MessagePBElemDecoder().d(paramList, paramList1, paramStringBuilder);
    return true;
  }
 ...
 * Qualified Name:     com.tencent.imcore.message.ext.codec.decoder.pbelement.TroopStoryCommentElemDecoder
