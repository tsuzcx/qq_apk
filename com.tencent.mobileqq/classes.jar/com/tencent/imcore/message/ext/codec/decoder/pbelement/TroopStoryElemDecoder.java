...
public class TroopStoryElemDecoder
  extends SimplePBElemDecoder
{
  ...
  {
    new MessagePBElemDecoder().e(paramList, paramList1, paramStringBuilder);
    return true;
  }
 ...
 * Qualified Name:     com.tencent.imcore.message.ext.codec.decoder.pbelement.TroopStoryElemDecoder
