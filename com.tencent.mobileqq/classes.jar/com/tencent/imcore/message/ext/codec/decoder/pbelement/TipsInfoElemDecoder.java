...
public class TipsInfoElemDecoder
  extends SimplePBElemDecoder
{
  ...
  {
    new MessagePBElemDecoder().b(paramList, paramList1, paramStringBuilder);
    return true;
  }
 ...
 * Qualified Name:     com.tencent.imcore.message.ext.codec.decoder.pbelement.TipsInfoElemDecoder
