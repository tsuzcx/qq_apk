...
public class QWalletElemDecoder
  extends SimplePBElemDecoder
{
  ...
  {
    new MessagePBElemDecoder().e(paramList, paramList1, paramStringBuilder, paramMsg, paramMessageInfo);
    return true;
  }
 ...
 * Qualified Name:     com.tencent.imcore.message.ext.codec.decoder.pbelement.QWalletElemDecoder
