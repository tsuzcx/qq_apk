  ...
  implements Msg0X210SubTypeDecoder
{
  private static void a(QQAppInterface paramQQAppInterface, long paramLong, MsgType0x210 paramMsgType0x210)
  {
    ...
    try
    {
      ...
      if (((submsgtype0xdf.MsgBody)localObject).msg_game_state.has())
      {
        ...
        l = Utils.a(((apollo_game_status.STCMGameMessage.STMsgComm)localObject).uint32_session_id.get());
        paramQQAppInterface = (ApolloGameManager)paramQQAppInterface.getManager(QQManagerFactory.APOLLO_GAME_MANAGER);
        if (paramLong != l) {
          break label194;
        }
  ...
  {
    a(paramOnLinePushMessageProcessor.a(), paramLong, paramMsgType0x210);
    return null;
  }
}
