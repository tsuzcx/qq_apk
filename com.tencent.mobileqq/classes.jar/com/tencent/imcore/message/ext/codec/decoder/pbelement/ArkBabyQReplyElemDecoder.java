...
public class ArkBabyQReplyElemDecoder
  extends SimplePBElemDecoder
{
  ...
  {
    new MessagePBElemDecoder().b(paramList, paramList1, paramStringBuilder, paramMsg, paramMessageInfo);
    return true;
  }
 ...
 * Qualified Name:     com.tencent.imcore.message.ext.codec.decoder.pbelement.ArkBabyQReplyElemDecoder
