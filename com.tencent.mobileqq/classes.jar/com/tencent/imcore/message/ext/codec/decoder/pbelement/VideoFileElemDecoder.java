  ...
  private MessageForShortVideo a(im_msg_body.GeneralFlags paramGeneralFlags, RichMsg.VideoFile paramVideoFile)
  {
    ...
    for (localMessageForShortVideo.msg = ShortVideoConstants.MESSAGE_FOR_SHORT_VIDEO_PTV;; localMessageForShortVideo.msg = ShortVideoConstants.MESSAGEFORSHORTVIDEO_MSG)
    {
      ...
      try
      {
        ...
        ((BabyQHandler)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getBusinessHandler(BusinessHandlerFactory.BABY_Q_HANDLER)).a(arrayOfByte);
      }
      ...
      if (localMessageForShortVideo.redBagType == LocalMediaInfo.REDBAG_TYPE_GET)
      {
        ...
        RedBagVideoManager.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), false);
