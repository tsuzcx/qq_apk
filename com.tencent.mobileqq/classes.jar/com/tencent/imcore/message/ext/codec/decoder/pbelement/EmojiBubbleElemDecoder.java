...
public class EmojiBubbleElemDecoder
  extends SimplePBElemDecoder
{
  ...
  {
    new MessagePBElemDecoder().f(paramList, paramList1, paramStringBuilder);
    return true;
  }
 ...
 * Qualified Name:     com.tencent.imcore.message.ext.codec.decoder.pbelement.EmojiBubbleElemDecoder
