...
public class QQStoryCommentElemDecoder
  extends SimplePBElemDecoder
{
  ...
  {
    new MessagePBElemDecoder().c(paramList, paramList1, paramStringBuilder);
    return true;
  }
 ...
 * Qualified Name:     com.tencent.imcore.message.ext.codec.decoder.pbelement.QQStoryCommentElemDecoder
