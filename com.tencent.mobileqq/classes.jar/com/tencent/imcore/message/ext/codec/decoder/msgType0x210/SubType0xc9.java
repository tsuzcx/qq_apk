  ...
  implements Msg0X210SubTypeDecoder
{
  private static void a(QQAppInterface paramQQAppInterface, MsgType0x210 paramMsgType0x210)
  {
        ...
        try
        {
          ...
          if (((submsgtype0xc9.MsgBody)localObject1).uint32_type.get() == 1)
          {
            ...
            if (((Iterator)localObject1).hasNext())
            {
              ...
              ((MessageForText)localObject3).init(paramQQAppInterface.getCurrentAccountUin(), str1, str2, ((submsgtype0xc9.BusinessMsg)localObject2).bytes_msg_data.get().toStringUtf8(), NetConnInfoCenter.getServerTime(), -1000, i, paramQQAppInterface.getMessageFacade().a(str1, i).shmsgseq + 1L);
    ...
    if (bool)
    {
      localObject3 = (MessageForNewGrayTips)MessageRecordFactory.a(-5001);
      ((MessageForNewGrayTips)localObject3).init(paramQQAppInterface.getCurrentAccountUin(), str1, str1, (String)localObject2, NetConnInfoCenter.getServerTime(), -5001, i, 1L + paramQQAppInterface.getMessageFacade().a(str1, i).shmsgseq);
    ...
    while (QLog.isColorLevel())
    {
      ...
      break;
      localObject3 = MessageRecordFactory.a(-5000);
      ((MessageRecord)localObject3).init(paramQQAppInterface.getCurrentAccountUin(), str1, str1, (String)localObject2, NetConnInfoCenter.getServerTime(), -5000, i, 1L + paramQQAppInterface.getMessageFacade().a(str1, i).shmsgseq);
