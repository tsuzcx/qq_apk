...
class SubAccountAssistantFilter
  implements UnreadMsgFilter
{
  ...
  {
    return paramConversationInfo.type == 7000;
  }
 ...
 * Qualified Name:     com.tencent.imcore.message.facade.unread.filter.SubAccountAssistantFilter
