  ...
  implements UnreadMsgFilter
{
  ...
  {
    return TextUtils.equals(AppConstants.LBS_HELLO_UIN, paramConversationInfo.uin);
  }
 ...
 * Qualified Name:     com.tencent.imcore.message.facade.unread.filter.LSBHelloFilter
