...
{
  static void a(QQAppInterface paramQQAppInterface, BaseMessageManager paramBaseMessageManager, QQMessageFacade paramQQMessageFacade, String paramString1, int paramInt1, String paramString2, String paramString3, int paramInt2, int paramInt3, boolean paramBoolean)
  {
  ...
  static void a(QQAppInterface paramQQAppInterface, BaseMessageManager paramBaseMessageManager, QQMessageFacade paramQQMessageFacade, String paramString1, int paramInt, String paramString2, String paramString3, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        for (;;)
        {
          ...
          break label34;
          Message localMessage = paramQQMessageFacade.a(paramString1, paramInt);
