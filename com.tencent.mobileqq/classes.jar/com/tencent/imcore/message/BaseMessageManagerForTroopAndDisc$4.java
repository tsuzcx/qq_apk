  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      BaseMessageManager.a.b(this.this$0.a, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord, 15000L);
      return;
    }
    ...
    if (this.this$0.c(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord)) {
      BaseMessageManager.a.b(this.this$0.a, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord, 15000L - (l1 - l2));
    } else {
