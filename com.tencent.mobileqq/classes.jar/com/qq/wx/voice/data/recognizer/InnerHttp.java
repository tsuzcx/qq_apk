  ...
  implements Runnable
{
  ...
  private int a(String paramString, int paramInt)
  {
    ...
    if (paramInt == 6)
    {
      ...
      if (((InfoHttp.f == 0) && (this.j == 1)) || (InfoHttp.f == 1))
      {
        ...
        {
          if (InfoRecognizer.g) {
            paramString.voiceRecordPCMData = InfoRecognizer.k.toByteArray();
          }
          if (InfoRecognizer.g) {
            paramString.voiceSpeexData = InfoRecognizer.l.toByteArray();
          }
          paramString.startTime = ((this.l / 32.0D - InfoRecorder.e) / 1000.0D);
          if (this.j == 1) {
  ...
  private String a(String paramString, byte[] paramArrayOfByte)
  {
    ...
    //   21: aload_0
    //   22: getfield 79	com/qq/wx/voice/data/recognizer/InnerHttp:n	Lorg/apache/http/impl/client/DefaultHttpClient;
    //   25: aload_1
  ...
  private String c(int paramInt)
  {
    ...
    if (!InfoRecognizer.m) {
      localStringBuilder.append("http://" + InfoSender.Domain + ":" + InfoSender.Port + InfoSender.Uri + "?");
    }
    if (paramInt == 1)
    {
    ...
    if (paramInt == 6)
    {
      ...
      if (InfoRecognizer.n != null) {
        localStringBuilder.append(InfoRecognizer.n);
      }
    }
 ...
 * Qualified Name:     com.qq.wx.voice.data.recognizer.InnerHttp
