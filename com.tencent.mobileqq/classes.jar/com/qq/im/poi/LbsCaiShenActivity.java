  ...
  implements CameraSurfaceView.CameraSurfaceViewCallBack
{
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    this.mNickNameView = ((TextView)super.findViewById(2131369501));
  ...
  public void onStartPreview(boolean paramBoolean)
  {
    ...
    if (!paramBoolean)
    {
      ...
      if (this.mCameraNoPermissionDialog == null) {
        this.mCameraNoPermissionDialog = DialogUtil.a(this, 230, getResources().getString(2131438735), getResources().getString(2131438736), getResources().getString(2131438732), "", null, new LbsCaiShenActivity.3(this));
      }
