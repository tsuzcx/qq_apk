  ...
  implements Manager
{
  ...
  public void a()
  {
    ThreadManager.post(new anz(this), 5, null, false);
  }
      ...
      if (i != 0)
      {
        if (this.jdField_a_of_type_JavaLangRefSoftReference != null)
        {
          ...
          if ((localObject != null) && (((ARMapActivity)localObject).jdField_a_of_type_ComTencentMobileqqArmapMapARMapEngine != null) && (((ARMapActivity)localObject).jdField_a_of_type_ComTencentMobileqqArmapARGLSurfaceView != null)) {
            ((ARMapActivity)localObject).jdField_a_of_type_ComTencentMobileqqArmapARGLSurfaceView.queueEvent(new anx(this, (ARMapActivity)localObject, paramLong, paramString));
          }
        }
        return;
  ...
  public void a(String paramString)
  {
    ...
    if (this.jdField_a_of_type_JavaLangRefSoftReference != null)
    {
      ...
      if ((localARMapActivity != null) && (localARMapActivity.jdField_a_of_type_ComTencentMobileqqArmapMapARMapEngine != null) && (localARMapActivity.jdField_a_of_type_ComTencentMobileqqArmapARGLSurfaceView != null)) {
        localARMapActivity.jdField_a_of_type_ComTencentMobileqqArmapARGLSurfaceView.queueEvent(new any(this, localARMapActivity, paramString));
      }
    }
  }
  ...
  public void a(String paramString, Bitmap paramBitmap)
  {
    ...
    ThreadManager.post(new aoa(this, paramBitmap, paramBitmap.getWidth(), paramBitmap.getHeight(), paramString), 5, null, false);
  }
