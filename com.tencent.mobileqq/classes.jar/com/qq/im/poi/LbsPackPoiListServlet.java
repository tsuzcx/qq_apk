  ...
  extends MSFServlet
{
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (paramFromServiceMsg == null)
    {
      ...
      localObject1 = (LbsPackManager)getAppRuntime().getManager(214);
    ...
    for (;;)
    {
      ...
      break;
      localObject2 = new MqqLbsPack.RspGetPOIList();
      ((MqqLbsPack.RspGetPOIList)localObject2).mergeFrom(paramFromServiceMsg);
      int k;
      if (((MqqLbsPack.RspGetPOIList)localObject2).rpt_msg_poi_info_list.has())
      {
        paramFromServiceMsg = ((MqqLbsPack.RspGetPOIList)localObject2).rpt_msg_poi_info_list.get();
        if (QLog.isColorLevel()) {
          QLog.d("LbsPack", 2, "LbsPackPoiListServlet onReceive CMD_GET_POI_LIST_REQ poiList.size = " + paramFromServiceMsg.size());
        }
        ((LbsPackManager)localObject1).a(paramFromServiceMsg);
        if (((MqqLbsPack.RspGetPOIList)localObject2).msg_head.has())
        {
          paramFromServiceMsg = (MqqLbsPack.RspHead)((MqqLbsPack.RspGetPOIList)localObject2).msg_head.get();
      ...
      for (;;)
      {
        ...
        if (!((MqqLbsPack.RspGetPOIList)localObject2).bytes_search_id.has()) {
          break label1192;
        }
        ((LbsPackManager)localObject1).jdField_a_of_type_JavaLangString = ((MqqLbsPack.RspGetPOIList)localObject2).bytes_search_id.get().toStringUtf8();
        break label1192;
        ((LbsPackManager)localObject1).jdField_a_of_type_JavaUtilArrayList.clear();
        break;
        label455:
            ...
            if (paramFromServiceMsg.rpt_addon_list.has())
            {
              ...
              if (localObject1 != null)
              {
                ...
                while (((Iterator)localObject1).hasNext())
                {
                  ...
                  paramFromServiceMsg.add(((oidb_cmd0x983.AddonItem)localObject2).uint32_addon_id.get() + "");
                }
 ...
 * Qualified Name:     com.qq.im.poi.LbsPackPoiListServlet
