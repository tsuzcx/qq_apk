...
public class a
{
  ...
  public static String createQADID(Context paramContext)
  {
    try
    {
      ...
      localObject1 = getCountryCode((Context)localObject2);
  ...
  private static String getKernelVersion()
  {
    // Byte code:
    //   0: ldc_w 294
    //   3: invokestatic 299	java/lang/System:getProperty	(Ljava/lang/String;)Ljava/lang/String;
    //   6: astore_2
    //   7: aconst_null
    //   8: astore 4
    //   10: aconst_null
    ...
    //   13: aconst_null
    //   14: astore_3
    //   15: new 301	java/io/FileReader
    //   18: dup
    //   19: ldc_w 303
    //   22: invokespecial 304	java/io/FileReader:<init>	(Ljava/lang/String;)V
    //   25: astore_0
    //   26: new 306	java/io/BufferedReader
    //   29: dup
    //   30: aload_0
    //   31: sipush 8192
    //   34: invokespecial 309	java/io/BufferedReader:<init>	(Ljava/io/Reader;I)V
    //   37: astore_1
    //   38: aload_1
    //   39: invokevirtual 312	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   42: astore_3
    //   43: aload_3
    //   44: ifnull +5 -> 49
    //   47: aload_3
    //   48: astore_2
    //   49: aload_1
    //   50: invokevirtual 315	java/io/BufferedReader:close	()V
    //   53: aload_0
    //   54: invokevirtual 316	java/io/FileReader:close	()V
    //   57: aload_2
    //   58: areturn
    //   59: astore_3
    //   60: aload_1
    ...
    //   97: ifnull +10 -> 107
    //   100: aload_2
    //   101: invokevirtual 315	java/io/BufferedReader:close	()V
    //   104: goto +3 -> 107
    //   107: aload_0
    //   108: ifnull +7 -> 115
    //   111: aload_0
    //   112: invokevirtual 316	java/io/FileReader:close	()V
    //   115: aload_1
    //   116: athrow
    //   117: aconst_null
    //   118: astore_0
    ...
    //   123: ifnull +10 -> 133
    //   126: aload_1
    //   127: invokevirtual 315	java/io/BufferedReader:close	()V
    //   130: goto +3 -> 133
    //   133: aload_0
    //   134: ifnull +29 -> 163
    //   137: goto -84 -> 53
    ...
    //   146: ifnull +10 -> 156
    //   149: aload_1
    //   150: invokevirtual 315	java/io/BufferedReader:close	()V
    //   153: goto +3 -> 156
    //   156: aload_0
    //   157: ifnull +6 -> 163
    //   160: goto -107 -> 53
  ...
  {
    // Byte code:
    //   0: getstatic 276	android/os/Build$VERSION:SDK_INT	I
    //   3: istore_1
    //   4: lconst_0
    //   5: lstore 4
    //   7: iload_1
    ...
    //   13: aload_0
    //   14: ldc_w 323
    //   17: invokevirtual 327	android/content/Context:getSystemService	(Ljava/lang/String;)Ljava/lang/Object;
    //   20: checkcast 329	android/app/ActivityManager
    //   23: astore_0
    //   24: new 331	android/app/ActivityManager$MemoryInfo
    //   27: dup
    //   28: invokespecial 332	android/app/ActivityManager$MemoryInfo:<init>	()V
    //   31: astore 6
    //   33: aload_0
    //   34: ifnull +236 -> 270
    //   37: aload_0
    //   38: aload 6
    //   40: invokevirtual 336	android/app/ActivityManager:getMemoryInfo	(Landroid/app/ActivityManager$MemoryInfo;)V
    //   43: aload 6
    //   45: getfield 339	android/app/ActivityManager$MemoryInfo:totalMem	J
    //   48: lreturn
    //   49: new 301	java/io/FileReader
    //   52: dup
    //   53: ldc_w 341
    //   56: invokespecial 304	java/io/FileReader:<init>	(Ljava/lang/String;)V
    //   59: astore_0
    //   60: new 306	java/io/BufferedReader
    //   63: dup
    //   64: aload_0
    //   65: sipush 4096
    //   68: invokespecial 309	java/io/BufferedReader:<init>	(Ljava/io/Reader;I)V
    //   71: astore 6
    //   73: aload 6
    //   75: invokevirtual 312	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   78: astore 7
    //   80: aload 7
    //   82: ifnull +14 -> 96
    //   85: aload 7
    //   87: ldc_w 343
    //   90: invokevirtual 347	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   93: ifeq -20 -> 73
    //   96: lload 4
    //   98: lstore_2
    //   99: aload 7
    ...
    //   104: aload 7
    //   106: ldc_w 349
    //   109: invokevirtual 353	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   112: iconst_1
    //   113: aaload
    //   114: invokestatic 356	java/lang/Long:valueOf	(Ljava/lang/String;)Ljava/lang/Long;
    //   117: invokevirtual 359	java/lang/Long:longValue	()J
    //   120: lstore_2
    //   121: lload_2
    //   122: ldc2_w 360
    //   125: lmul
    //   126: lstore_2
    //   127: aload 6
    //   129: invokevirtual 315	java/io/BufferedReader:close	()V
    //   132: aload_0
    //   133: invokevirtual 316	java/io/FileReader:close	()V
    //   136: lload_2
    //   137: lreturn
    //   138: astore 8
    //   140: aload_0
    ...
    //   191: ifnull +11 -> 202
    //   194: aload 6
    //   196: invokevirtual 315	java/io/BufferedReader:close	()V
    //   199: goto +3 -> 202
    //   202: aload 7
    //   204: ifnull +8 -> 212
    //   207: aload 7
    //   209: invokevirtual 316	java/io/FileReader:close	()V
    //   212: aload_0
    //   213: athrow
    //   214: aconst_null
    //   215: astore_0
    ...
    //   221: ifnull +11 -> 232
    //   224: aload 6
    //   226: invokevirtual 315	java/io/BufferedReader:close	()V
    //   229: goto +3 -> 232
    //   232: aload_0
    //   233: ifnull +37 -> 270
    //   236: lload 4
    ...
    //   249: ifnull +11 -> 260
    //   252: aload 6
    //   254: invokevirtual 315	java/io/BufferedReader:close	()V
    //   257: goto +3 -> 260
    //   260: aload_0
    //   261: ifnull +9 -> 270
    //   264: lload 4
