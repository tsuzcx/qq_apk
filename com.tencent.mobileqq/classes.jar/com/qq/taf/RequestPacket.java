  ...
  extends JceStruct
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    int i = paramObject.iVersion;
    Integer localInteger = Integer.valueOf(1);
    return (JceUtil.equals(1, i)) && (JceUtil.equals(1, paramObject.cPacketType)) && (JceUtil.equals(1, paramObject.iMessageType)) && (JceUtil.equals(1, paramObject.iRequestId)) && (JceUtil.equals(localInteger, paramObject.sServantName)) && (JceUtil.equals(localInteger, paramObject.sFuncName)) && (JceUtil.equals(localInteger, paramObject.sBuffer)) && (JceUtil.equals(1, paramObject.iTimeout)) && (JceUtil.equals(localInteger, paramObject.context)) && (JceUtil.equals(localInteger, paramObject.status));
  }
