  ...
  extends MSFServlet
{
  ...
  private final List<lbk> jdField_a_of_type_JavaUtilList = new ArrayList(2);
  
  public ldc()
  {
    this.jdField_a_of_type_JavaUtilList.add(new lbw());
  }
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    paramArrayOfByte = lcx.a(paramArrayOfByte);
    ...
    lii.a(34);
    mtx.a("VideoServlet", lbz.a(3, String.valueOf(paramArrayOfByte.c), new int[0]), this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, paramArrayOfByte);
  }
  ...
  private void b(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    //   63: astore_2
    //   64: aload_2
    //   65: invokestatic 387	lgk:a	(Lcom/tencent/av/common$ErrorInfo;)I
    //   68: istore 4
    //   70: aload_2
    ...
    //   187: i2l
    //   188: invokespecial 432	lny:<init>	(JJ)V
    ...
    //   210: istore 9
    //   212: aload_0
    //   213: getfield 121	ldc:jdField_a_of_type_ComTencentAvAppVideoAppInterface	Lcom/tencent/av/app/VideoAppInterface;
    //   216: instanceof 123
    //   219: ifeq +170 -> 389
    //   222: aload_0
    //   223: getfield 121	ldc:jdField_a_of_type_ComTencentAvAppVideoAppInterface	Lcom/tencent/av/app/VideoAppInterface;
    //   226: astore_1
    //   227: iload 9
    //   229: ifne +104 -> 333
    //   232: aload_1
    ...
    //   332: return
    //   333: aload_0
    //   334: getfield 121	ldc:jdField_a_of_type_ComTencentAvAppVideoAppInterface	Lcom/tencent/av/app/VideoAppInterface;
    //   337: iconst_4
    ...
    //   388: return
    //   389: aload_0
    //   390: getfield 121	ldc:jdField_a_of_type_ComTencentAvAppVideoAppInterface	Lcom/tencent/av/app/VideoAppInterface;
    //   393: iconst_4
  ...
  private void c(Packet paramPacket, Bundle paramBundle)
  {
    ...
    paramPacket.putSendData(bhjl.a(paramBundle.toByteArray()));
  }
  ...
  public lbk a(String paramString)
  {
    ...
    do
    {
      ...
      locallbk = (lbk)localIterator.next();
    } while ((locallbk == null) || (!locallbk.a(paramString)));
    for (paramString = locallbk;; paramString = null) {
      return paramString;
    }
  }
  ...
  void a(SharpVideoMsg paramSharpVideoMsg)
  {
    ...
    if (localFriends != null)
    {
      ...
      localBundle.putString("fromUin", mry.a(l1));
      ...
      this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().a.e(localBundle);
      if (QLog.isColorLevel())
      {
  ...
  void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (MsfMsgUtil.getGatewayIpMsg(null).getServiceCmd().equalsIgnoreCase(str2))
    {
      ...
      if (paramIntent != null)
      {
        ...
        this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().h(paramIntent, 0);
      }
    }
    label648:
    label664:
    ...
    do
    {
      ...
      if ("QQRTCSvc.echo".equalsIgnoreCase(str2))
      {
        ...
        this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().q(bool);
        return;
      }
  ...
  void a(String paramString, Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    lkf locallkf = null;
    int i = paramFromServiceMsg.getWupBuffer().length - 4;
    Object localObject = locallkf;
    if (paramFromServiceMsg.isSuccess())
    {
      localObject = locallkf;
      if (i > 0)
      {
    ...
    if (locallkf != null) {
      locallkf.a(paramString, paramFromServiceMsg.isSuccess(), paramFromServiceMsg.getResultCode(), paramIntent, (byte[])localObject);
    }
  }
  ...
  void a(String paramString, Packet paramPacket, Bundle paramBundle)
  {
    ...
    if (paramString != null) {
      paramPacket.putSendData(bhjl.a(paramString));
    }
  }
  ...
  void a(Packet paramPacket, Bundle paramBundle)
  {
    ...
    if (locallbk != null)
    {
      paramPacket.setServantName(locallbk.a());
      paramPacket.setFuncName(locallbk.b());
    }
    paramPacket.setSSOCommand(str);
    paramPacket.setTimeout(10000L);
    paramBundle = paramBundle.getByteArray("vMsg");
    if (paramBundle != null) {
      paramPacket.putSendData(bhjl.a(paramBundle));
    }
  }
  ...
  void b(SharpVideoMsg paramSharpVideoMsg)
  {
    ...
    this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().a.f(localBundle);
    if (QLog.isColorLevel()) {
  ...
  public void onCreate()
  {
    ...
    lwa.a().jdField_a_of_type_Boolean = true;
    lwa.a().jdField_b_of_type_Long = System.currentTimeMillis();
  }
          ...
          for (;;)
          {
            ...
            for (boolean bool = true;; bool = false)
            {
              ...
              if ("SharpSvr.c2s".equalsIgnoreCase(str)) {
                bdla.b(null, "CliOper", "", "", "0X80088B1", "0X80088B1", 0, 0, "", "", "", "");
              }
              if (paramIntent == null) {
                break;
              }
            ...
            if ("SharpSvr.s2c".equalsIgnoreCase(str))
            {
              ...
              if (i != 1013)
              {
                ...
                {
                  lde.a("Video:Servlet", 5000L);
                  a(paramIntent.video_buff);
                  this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().b(209, String.valueOf(paramIntent.from_uin));
                  this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().b(200, String.valueOf(paramIntent.from_uin));
                  if (this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().a() != 0) {
                    break label733;
                  }
                  this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().b(205, String.valueOf(paramIntent.from_uin));
                }
                for (;;)
                {
                  if (!lwa.a().jdField_b_of_type_Boolean) {
                    lwa.a().a(paramIntent.msg_seq);
                  }
                  lwa.a().a("eVideoRecvInviteMsg", 3L, paramIntent.msg_seq, ((Long)paramIntent.to_uin.get(0)).longValue(), paramIntent.from_uin, 0);
                  localObject = paramIntent.msg_seq + "-" + paramIntent.msg_uid;
                  this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(paramIntent.from_uin, (String)localObject, bcrg.a());
                  ...
                  try
                  {
                    localObject = lcx.a(paramIntent.video_buff);
                    QLog.w("tagSharpSvr", 1, "<-- onReceive() cmd = " + str + " , msg_type = " + paramIntent.msg_type + ", bodyType = " + ((lcy)localObject).jdField_a_of_type_Int);
                    c(paramIntent);
                    if ((!lvy.a().jdField_a_of_type_Boolean) && (lvy.a().b != 1) && (paramFromServiceMsg.getAttributes() != null))
                    {
                      paramFromServiceMsg = paramFromServiceMsg.getAttributes().get("__timestamp_net2msf_boot");
                      if (paramFromServiceMsg != null) {
                        lvy.a().q = ((Long)paramFromServiceMsg).longValue();
                      }
                    }
                    a(paramIntent);
                    return;
                    this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().b(204, String.valueOf(paramIntent.from_uin));
                    continue;
                    lii.a(l2);
                  }
            ...
            else
            {
              ...
              {
                if ((lvy.a().jdField_a_of_type_Boolean) && (paramFromServiceMsg.getAttributes() != null))
                {
                  if (lvy.a().jdField_a_of_type_Int != 0) {
                    break label1159;
                  }
                  paramIntent = paramFromServiceMsg.getAttributes().get("__timestamp_net2msf_boot");
                  if (paramIntent != null) {
                    lvy.a().d = ((Long)paramIntent).longValue();
                  }
                  paramIntent = paramFromServiceMsg.getAttributes().get("__timestamp_msf2net_boot_sharp_c2s");
                  if (paramIntent != null) {
                    lvy.a().c = ((Long)paramIntent).longValue();
                  }
                }
                for (;;)
                {
                  ...
                  if (paramIntent.msg_type == 2L)
                  {
                    ...
                    if (paramFromServiceMsg != null)
                    {
                      ...
                      ((lik)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(4)).a(l1);
                    }
                  }
                  try
                  {
                    paramFromServiceMsg = lcx.a(paramIntent.video_buff);
                    ...
                    b(paramIntent);
                    return;
                    if (lvy.a().jdField_a_of_type_Int == 2)
                    {
                      lvy.a().jdField_a_of_type_Int = 4;
                      paramIntent = paramFromServiceMsg.getAttributes().get("__timestamp_msf2net_boot_sharp_c2s");
                      if (paramIntent != null) {
                        lvy.a().g = ((Long)paramIntent).longValue();
                      }
                    }
                  }
              ...
              if ("MultiVideo.s2c".equalsIgnoreCase(localException))
              {
                ...
                this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().a.g(paramFromServiceMsg);
                return;
              }
              if ("MultiVideo.c2sack".equalsIgnoreCase(localException))
              {
                ...
                paramFromServiceMsg = new Bundle();
                paramFromServiceMsg.putByteArray("buffer", paramIntent.video_buff);
                this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().a.h(paramFromServiceMsg);
                return;
              }
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    for (paramIntent = "null";; paramIntent = ((ToServiceMsg)localObject2).getServiceCmd())
    {
      ...
      return;
      bdla.b(null, "CliOper", "", "", "0X80088B0", "0X80088B0", 0, 0, "", "", "", "");
      if (QLog.isColorLevel()) {
      ...
      try
      {
        paramPacket = lcx.a(paramIntent.video_buff);
      ...
      {
        lwa.a().a("eVideoSendACK", ((SharpVideoMsg)localObject3).msg_type, ((SharpVideoMsg)localObject3).msg_seq, ((Long)((SharpVideoMsg)localObject3).to_uin.get(0)).longValue(), ((SharpVideoMsg)localObject3).from_uin, 0);
        lwa.a().b();
      }
      if (QLog.isColorLevel()) {
      ...
      try
      {
        localObject1 = lcx.a(((SharpVideoMsg)localObject3).video_buff);
        QLog.w("tagSharpSvr", 1, "--> onSend() cmd = SharpSvr.s2cack , msg_type = " + ((SharpVideoMsg)localObject3).msg_type + ", bodyType = " + ((lcy)localObject1).jdField_a_of_type_Int);
      ...
      paramPacket.putSendData(bhjl.a(((Bundle)localObject2).getByteArray("vMsg")));
      return;
