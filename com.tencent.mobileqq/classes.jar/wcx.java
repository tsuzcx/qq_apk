...
public class wcx
{
  ...
  public wcx(@NonNull QQAppInterface paramQQAppInterface)
  {
  ...
  public Intent a(Context paramContext, boolean paramBoolean1, boolean paramBoolean2, Intent paramIntent)
  {
    ...
    Object localObject1 = (axho)this.a.getManager(36);
    Object localObject2 = ((axho)localObject1).a("103100.103500.103501");
    ...
    for (;;)
    {
      ...
      {
        ((axho)localObject1).b("103100.103500.103501");
      ...
      for (;;)
      {
        ...
        boolean bool2 = azgk.a(this.a, BaseApplicationImpl.getContext());
        localObject1 = aepf.a(ugx.e);
        localObject2 = new File(aljq.bk);
        if (!((File)localObject2).exists()) {
          ((File)localObject2).mkdirs();
        }
        return umg.a(paramContext, paramBoolean2, paramIntent, paramBoolean1, bool1, bool2, (String)localObject1, this.a.getAccount());
        paramBoolean1 = false;
        break;
      }
      paramBoolean1 = false;
