  ...
  implements anpq
{
  ...
  WeakReference<avff> jdField_b_of_type_JavaLangRefWeakReference;
  int d = 0;
  
  public avet(Context paramContext, PicInfo paramPicInfo)
  {
    ...
    if ((paramContext instanceof QQAppInterface)) {
      this.jdField_a_of_type_Anpx = ((anpx)paramContext.getManager(180));
    }
    for (;;)
    {
      if (this.jdField_a_of_type_Anpx == null) {}
      this.jdField_a_of_type_Anpo = this.jdField_a_of_type_Anpx.a();
      this.jdField_a_of_type_Anpo.a(this);
      return;
  ...
  public View a(int paramInt, Handler paramHandler, avff paramavff)
  {
    ...
    this.jdField_b_of_type_JavaLangRefWeakReference = new WeakReference(paramavff);
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      if (!bool1)
      {
        ...
        {
          bool1 = anpo.b(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.d);
          bool2 = bool1;
          if (bool1)
          {
            localURLImageView.setImageDrawable(URLDrawable.getDrawable(anpo.a(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.d), a(paramHandler)));
            bool2 = bool1;
          }
        }
      }
      if (!bool2) {
        if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.d))
        {
          ...
          if (this.jdField_a_of_type_Anpo.a(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.d)) {
            this.jdField_b_of_type_Int = 0;
          }
          paramavff.a(paramInt, this.jdField_b_of_type_Int);
          label396:
          if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        ...
        paramHandler = baul.a;
        break label186;
        localURLImageView.setImageDrawable(BaseApplicationImpl.getApplication().getResources().getDrawable(2130837967));
        this.d = 2;
        paramavff.a(paramInt, false);
        break label396;
        this.jdField_b_of_type_Int = 0;
        this.d = 1;
        paramavff.a(paramInt, true);
      }
    }
  }
  ...
  public void a()
  {
    if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.d))
    {
      ...
      if (!anpo.b(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.d)) {
        this.jdField_a_of_type_Anpo.a(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.d);
      }
    }
  }
  
  public void a(View paramView, int paramInt, avff paramavff)
  {
    boolean bool2 = true;
    ...
    if ((this.d != 1) && (this.d != 2) && (this.d != 3) && (this.d != 4))
    {
      ...
      if (this.jdField_b_of_type_Int > 0) {
        paramavff.b(paramInt, this.jdField_b_of_type_Int / 100);
      }
  ...
  public void a(String paramString, int paramInt)
  {
    if (paramString.equals(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.d))
    {
      ...
      if ((this.jdField_b_of_type_JavaLangRefWeakReference != null) && (this.jdField_b_of_type_JavaLangRefWeakReference.get() != null)) {
        ((avff)this.jdField_b_of_type_JavaLangRefWeakReference.get()).b(this.jdField_a_of_type_Int, paramInt);
      }
    }
  }
  ...
  public void a(String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    Object localObject = (avff)this.jdField_b_of_type_JavaLangRefWeakReference.get();
    paramString = (URLImageView)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if (localObject != null)
    {
      ((avff)localObject).a(this.jdField_a_of_type_Int, paramBoolean1);
      ((avff)localObject).a(this.jdField_a_of_type_Int);
    }
    ...
    for (paramBoolean2 = true;; paramBoolean2 = false)
    {
      ...
      if (paramBoolean1)
      {
        ...
        if (anpo.b(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.d))
        {
          localObject = URLDrawable.getDrawable(anpo.a(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.d), a(paramString.getDrawable()));
      ...
      localObject = BaseApplicationImpl.getApplication().getResources().getDrawable(2130837967);
