...
public class akiq
{
  private static akiq jdField_a_of_type_Akiq = new akiq();
  ...
  private akiq()
  {
    ...
    if (!AppSetting.f().equals(localObject2))
    {
      ...
      baig.a((SharedPreferences.Editor)localObject2);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_Boolean)
        {
          ...
          baig.a((SharedPreferences.Editor)localObject1);
          this.jdField_d_of_type_Int = 0;
          bool2 = bool1;
          continue;
        }
