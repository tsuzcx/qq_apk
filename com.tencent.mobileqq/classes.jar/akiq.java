...
public class akiq
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new akir(this, Looper.getMainLooper());
  ...
  public boolean a()
  {
    ...
    akiu localakiu = new akiu();
    try
    {
      SAXParserFactory.newInstance().newSAXParser().parse(new InputSource(new InputStreamReader(new FileInputStream((File)localObject), "UTF-8")), localakiu);
      this.jdField_a_of_type_Int = localakiu.a();
      this.jdField_a_of_type_JavaUtilArrayList = localakiu.a();
      return true;
    }
