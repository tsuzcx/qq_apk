  ...
  implements ViewTreeObserver.OnGlobalLayoutListener
{
  ...
  public nch(GameRoomFragment paramGameRoomFragment) {}
  ...
  public void onGlobalLayout()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentAvgameGameroomGameRoomFragment.jdField_a_of_type_Ncq.a().a(this.jdField_a_of_type_ComTencentAvgameGameroomGameRoomFragment.getString(2131690307), localRectF, 146);
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_AndroidGraphicsRectF != null) && ((this.jdField_a_of_type_AndroidGraphicsRectF.left != localRectF.left) || (this.jdField_a_of_type_AndroidGraphicsRectF.top != localRectF.top))) {
        this.jdField_a_of_type_ComTencentAvgameGameroomGameRoomFragment.jdField_a_of_type_Ncq.a().b(this.jdField_a_of_type_ComTencentAvgameGameroomGameRoomFragment.getString(2131690307), localRectF, 146);
      }
    }
  }
}
