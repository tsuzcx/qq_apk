...
public class amub
{
  ...
  public static android.graphics.drawable.Drawable a(Context paramContext, int paramInt1, int paramInt2, String paramString)
  {
    ...
    //   22: iload_1
    //   23: iload_2
    //   24: invokespecial 38	asbh:<init>	(IFII)V
    //   27: astore 5
    //   29: new 27	asbh
    //   32: dup
    //   33: ldc 29
    ...
    //   42: iload_1
    //   43: iload_2
    //   44: invokespecial 38	asbh:<init>	(IFII)V
    //   47: astore_0
    //   48: new 27	asbh
    //   51: dup
    //   52: aload_3
    ...
    //   60: iload_1
    //   61: iload_2
    //   62: invokespecial 38	asbh:<init>	(IFII)V
    //   65: astore 4
    //   67: new 27	asbh
    //   70: dup
    ...
    //   108: iload_1
    //   109: iload_2
    //   110: invokespecial 38	asbh:<init>	(IFII)V
    //   113: astore_3
    //   114: aload_3
    //   115: sipush 204
        ...
        if (paramInt1 >= 0)
        {
          ...
          for (;;)
          {
            ...
            if ((((MessageForApollo)localObject2).gameId == paramInt2) && (((MessageForApollo)localObject2).roomId == paramLong))
            {
              ...
              if (a()) {
                localamma.a().a((MessageForApollo)localObject2);
              }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, ApolloGameData paramApolloGameData, int paramInt)
  {
    ...
    if (!bhfn.a(paramContext, paramApolloGameData.gameAppPkgName))
    {
    ...
    ((amme)paramQQAppInterface.getManager(QQManagerFactory.APOLLO_MANAGER)).a().a(paramApolloGameData.gameId, paramApolloGameData.gameAppid, 0, paramSessionInfo.curFriendUin, paramInt);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, long paramLong, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localamri.e = 1;
        localamri.d = 3;
        a(paramQQAppInterface, paramString, localamri);
        return;
        localamri.jdField_b_of_type_JavaLangString = anvx.a(2131701613);
        i = 0;
      }
    }
  }
  
  public static void a(QQAppInterface paramQQAppInterface, String paramString, amri paramamri)
  {
    if ((paramamri == null) || (paramQQAppInterface == null))
    {
      QLog.e("CmGameTemp_CmGameSessionUtil", 1, "[sendGameMsg], errInfo->param is null.");
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.d("CmGameTemp_CmGameSessionUtil", 2, new Object[] { "[sendGameMsg], gameId:", Integer.valueOf(paramamri.jdField_a_of_type_Int), ",roomId:", Long.valueOf(paramamri.jdField_a_of_type_Long), ",extendInfo:", paramamri.jdField_c_of_type_JavaLangString });
    }
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramamri.jdField_a_of_type_Int == 1)
        {
          ...
          ((JSONObject)localObject).put("gameStatus", paramamri.e);
          if (localObject != null) {
          ...
          paramString = bcsa.a(paramQQAppInterface, paramString, paramQQAppInterface.getCurrentAccountUin(), 1036, localApolloMessage);
          if (paramamri.jdField_a_of_type_Int == 1)
          {
            paramString.msgType = 2;
            paramString.gameId = paramamri.jdField_a_of_type_Int;
            paramString.mGameMode = paramamri.jdField_c_of_type_Int;
            paramString.roomId = paramamri.jdField_a_of_type_Long;
            paramString.mApolloMessage.id = paramamri.jdField_b_of_type_Int;
            paramString.gameName = paramamri.jdField_b_of_type_JavaLangString;
            paramString.gameExtendJson = paramamri.jdField_c_of_type_JavaLangString;
            paramString.gameStatus = paramamri.e;
            paramString.extendJson = ("{\"gameStatus\":" + paramamri.e + "}");
        ...
        paramString.msgType = paramamri.d;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    ((amme)paramQQAppInterface.getManager(QQManagerFactory.APOLLO_MANAGER)).a().b(paramString1, paramString2);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, long paramLong, int paramInt)
  {
    ...
    ApolloGameData localApolloGameData = ((ankc)localObject2).a(paramInt);
    Object localObject1 = anvx.a(2131701612);
    if ((localApolloGameData != null) && (!TextUtils.isEmpty(localApolloGameData.name)))
    {
      localObject2 = ((ankc)localObject2).a(localApolloGameData.actionId);
    ...
    for (;;)
    {
      int i = localApolloGameData.actionId;
      localamri.jdField_b_of_type_JavaLangString = localApolloGameData.name;
      localamri.jdField_a_of_type_JavaLangString = ((String)localObject1);
      localamri.jdField_b_of_type_Int = i;
      localamri.jdField_a_of_type_Int = paramInt;
      localamri.jdField_a_of_type_Long = paramLong;
      localamri.e = 0;
      ...
      if (!TextUtils.isEmpty(localamri.jdField_a_of_type_JavaLangString)) {
        ((ApolloMessage)localObject2).name = localamri.jdField_a_of_type_JavaLangString.getBytes();
      }
      localObject1 = null;
      if (0 == 0) {}
      for (;;)
      {
        try
        {
          ...
          ((JSONObject)localObject1).put("gameId", localamri.jdField_a_of_type_Int);
          ((JSONObject)localObject1).put("gameMode", localamri.jdField_c_of_type_Int);
          ((JSONObject)localObject1).put("roomid", localamri.jdField_a_of_type_Long);
          if (localamri.jdField_a_of_type_Int == 1)
          {
            ((JSONObject)localObject1).put("msgTyep", 2);
            ((JSONObject)localObject1).put("gameName", localamri.jdField_b_of_type_JavaLangString);
            if (!TextUtils.isEmpty(localamri.jdField_c_of_type_JavaLangString)) {
              ((JSONObject)localObject1).put("gameExtendJson", localamri.jdField_c_of_type_JavaLangString);
            }
            ((JSONObject)localObject1).put("gameStatus", localamri.e);
            if (localObject1 != null) {
              ((ApolloMessage)localObject2).extStr = ((JSONObject)localObject1).toString();
            }
            localObject1 = ((amme)paramQQAppInterface.getManager(QQManagerFactory.APOLLO_MANAGER)).b(paramQQAppInterface.getCurrentAccountUin());
            ((ApolloMessage)localObject2).sender_ts = bhbx.a(((ApolloBaseInfo)localObject1).apolloServerTS);
            ...
            localObject1 = bcsa.a(paramQQAppInterface, paramString1, paramQQAppInterface.getCurrentAccountUin(), 1036, (ApolloMessage)localObject2);
            if (localamri.jdField_a_of_type_Int != 1) {
              break label698;
            }
            ((MessageForApollo)localObject1).msgType = 2;
            ((MessageForApollo)localObject1).gameId = localamri.jdField_a_of_type_Int;
            ((MessageForApollo)localObject1).mGameMode = localamri.jdField_c_of_type_Int;
            ((MessageForApollo)localObject1).roomId = localamri.jdField_a_of_type_Long;
            ((MessageForApollo)localObject1).mApolloMessage.id = localamri.jdField_b_of_type_Int;
            ((MessageForApollo)localObject1).gameName = localamri.jdField_b_of_type_JavaLangString;
            ((MessageForApollo)localObject1).gameExtendJson = localamri.jdField_c_of_type_JavaLangString;
            ((MessageForApollo)localObject1).gameStatus = localamri.e;
            ((MessageForApollo)localObject1).extendJson = ("{\"gameStatus\":" + localamri.e + ",\"robotOpenId\":" + paramString2 + "}");
            ...
            jdField_a_of_type_Long = System.currentTimeMillis();
            return;
            localamri.jdField_b_of_type_JavaLangString = anvx.a(2131701614);
            i = 0;
            break;
          }
          ((JSONObject)localObject1).put("msgTyep", localamri.d);
          continue;
          ((MessageForApollo)localObject1).msgType = localamri.d;
        }
        catch (Throwable paramQQAppInterface)
        {
          QLog.d("CmGameTemp_CmGameSessionUtil", 2, paramQQAppInterface, new Object[0]);
  ...
  public static boolean a()
  {
    if ((BaseActivity.sTopActivity instanceof FragmentActivity))
    {
      ...
      if (localObject != null)
      {
        ...
        if (!(localObject instanceof ahzc)) {}
      }
    }
    for (Object localObject = (ahzc)localObject;; localObject = null) {
      return (localObject != null) && (((ahzc)localObject).a());
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      admh.b(paramQQAppInterface, localSessionInfo, (ArkAppMessage)localObject);
      return true;
    }
