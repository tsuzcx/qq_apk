...
{
  bfvy(bfvp parambfvp, bhht parambhht, String paramString1, String paramString2, String paramString3) {}
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (paramInt != 0)
        {
          ...
          if (this.jdField_a_of_type_Bfvp.a != null) {
            ArkFullScreenAppActivity.a(this.jdField_a_of_type_Bfvp.a, this.c, paramAppPathInfo, "0.0.0.1", paramObject, ArkAppCenterUtil.getDensity(), null, 1);
          }
        }
        do
        {
          ...
          } while (this.jdField_a_of_type_Bfvp.a == null);
          this.jdField_a_of_type_Bfvp.a.startActivity(paramObject);
          return;
          QQToast.a(this.jdField_a_of_type_Bfvp.a, 2131690113, 0).a();
