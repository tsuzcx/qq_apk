  ...
  extends VasWebviewJsPlugin
{
  ...
  bghr jdField_a_of_type_Bghr = new bght(this);
  public bghv a;
  public String a;
  ...
  private void a(JSONObject paramJSONObject)
  {
    ...
    bgiv.a(str1, false, bgiv.b);
    for (;;)
    {
      a(localIntent.getExtras());
      bggu.a(paramJSONObject, localIntent, 100);
      return;
      label126:
      bgiv.a(str1, false, bgiv.e);
    }
  }
  ...
  private static String c()
  {
    ...
    return bbuv.a("tencent/MobileQQ/qqcomic/cache/");
  }
  ...
  public void a(String paramString)
  {
    ...
    //   1: monitorenter
    //   2: aload_1
    //   3: putstatic 181	bghs:f	Ljava/lang/String;
    //   6: getstatic 26	bghs:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   18: monitorexit
    //   19: return
    //   20: getstatic 26	bghs:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   23: iconst_1
    //   24: invokevirtual 273	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   27: new 275	cooperation/comic/jsp/QQComicJsPlugin$4
    //   30: dup
    //   31: aload_0
    //   32: invokespecial 276	cooperation/comic/jsp/QQComicJsPlugin$4:<init>	(Lbghs;)V
    //   35: iconst_5
    //   36: aconst_null
    //   37: iconst_1
  ...
  {
    if (this.jdField_a_of_type_Bghv == null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQComicDebug", 2, "create a new js plugin");
      }
      this.jdField_a_of_type_Bghv = bgij.a(this.mRuntime, this.jdField_a_of_type_Bghr);
    }
    if (this.jdField_a_of_type_Bghv != null) {
      this.jdField_a_of_type_Bghv.a(paramString1, paramJSONObject);
    }
    do
    {
      return;
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      {
        paramJsBridgeListener = (String)bggu.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicReference.get();
        paramString1 = new JSONObject();
        ...
        for (;;)
        {
          ...
          paramString1.put("message", ajyc.a(2131710171));
    ...
    else
    {
      ...
      if ("setSwitchChannel".equals(paramString3))
      {
        ...
        if ((paramString3 != null) && (paramString3.length() > 0))
        {
          ...
          paramVarArgs.a.a(new bccc(m, k, paramString1, paramString2, paramJsBridgeListener));
          break label2092;
        }
      }
      else
      {
        ...
        else
        {
          ...
          if ("setTabRedPoint".equals(paramString3))
          {
            ...
            break label2092;
            label1078:
            paramVarArgs.a.a(new bccd(paramJsBridgeListener, j, paramString2));
            break label2092;
          }
          ...
          if ("openQQBrowser".equals(paramString3))
          {
            ...
            bggu.a(paramString1, paramString2, -1);
            break label2092;
          }
          ...
          if ("setTitleAndBottomBar".equals(paramString3))
          {
            ...
            paramJsBridgeListener = (bcce)paramString1;
            bool1 = bool2;
            if (!bool3) {
              bool1 = true;
            }
          ...
          if ("getReporterInfo".equals(paramString3))
          {
            paramJsBridgeListener = new JSONObject();
            paramString1 = new JSONObject();
            paramString1.put("mod", bggu.jdField_a_of_type_JavaLangString);
            paramString1.put("land_page", bggu.c);
            paramString1.put("obj_ownerid", bggu.b);
            paramJsBridgeListener.put("data", paramString1);
