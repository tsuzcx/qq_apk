  ...
  extends bgix
{
  public boolean a(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    do
    {
      ...
      PluginManagerHelper.getPluginInterface(paramString2, new bght(this, paramString1, paramJsBridgeListener, bool));
      return false;
    } while ((!paramString2.equals("qzone_live_video_plugin_hack.apk")) || (TextUtils.isEmpty(paramJsBridgeListener)));
    bgax.a(BaseApplicationImpl.getContext(), new bghu(this, paramString1, bool, paramJsBridgeListener));
    return false;
  }
}
