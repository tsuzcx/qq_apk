...
public class ahlz
{
  ...
  public static int a(@NonNull String paramString)
  {
    try
    {
      ...
      {
        jdField_a_of_type_Int = bfyz.b(paramString);
  ...
  @Nullable
  public static ahmb a(String paramString)
  {
    return (ahmb)bfuj.a("StickerBubbleGifCache_" + paramString);
  }
  
  public static ahme a(int paramInt1, String paramString, int paramInt2, int[] paramArrayOfInt)
  {
    ...
    {
      return new ahme(paramArrayOfInt, paramString, bool, new ahlv(d1, d2), new ahlu(0.0D, 200.0D), 49);
      d1 = -jdField_a_of_type_JavaUtilRandom.nextInt(8000) + 4000;
      break;
    }
  }
  
  public static ahme a(@NonNull Point paramPoint, @NonNull String paramString, int paramInt)
  {
    ...
    {
      return new ahme(paramPoint, paramString, bool, new ahlv(d1, d2), new ahlu(0.0D, 200.0D), 85);
  ...
  public static Drawable a(@NonNull String paramString)
  {
    try
    {
      if (((!paramString.equals(jdField_a_of_type_JavaLangString)) || (jdField_a_of_type_AndroidGraphicsDrawableDrawable == null)) && (a(paramString) > 0)) {
        jdField_a_of_type_AndroidGraphicsDrawableDrawable = ahly.a(a(paramString));
      }
  ...
  {
    int i = AIOUtils.dp2px(8.0F, paramContext.getResources());
  ...
  public static void a(@NonNull ahlx paramahlx, @NonNull String paramString)
  {
    try
    {
      jdField_a_of_type_Int = paramahlx.jdField_a_of_type_Int;
      jdField_a_of_type_AndroidGraphicsDrawableDrawable = ahly.a(jdField_a_of_type_Int);
      bfyz.b(paramahlx.jdField_a_of_type_Int, paramString);
      jdField_a_of_type_JavaLangString = paramString;
      return;
    }
    finally
  ...
  public static void a(String paramString, BitmapDrawable[] paramArrayOfBitmapDrawable, int paramInt)
  {
    if (a())
    {
      ...
      if (bfuj.a(str) == null) {
        bfuj.a(str, new ahmb(paramString, paramArrayOfBitmapDrawable, paramInt));
      }
    }
  }
  ...
  public static int[] a(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      paramQQAppInterface = agkg.a(paramQQAppInterface, 7);
  ...
  public static ahme b(@NonNull Point paramPoint, @NonNull String paramString, int paramInt)
  {
    boolean bool = a(paramInt);
    double d1;
    if (bool)
    ...
    for (double d2 = -1000 - jdField_a_of_type_JavaUtilRandom.nextInt(500);; d2 = -2000 - jdField_a_of_type_JavaUtilRandom.nextInt(1000))
    {
      return new ahme(paramPoint, paramString, bool, new ahlv(d1, d2), new ahlu(0.0D, 200.0D), 81);
      d1 = -jdField_a_of_type_JavaUtilRandom.nextInt(6000) + 3000;
      break;
    }
  }
  ...
  public static void b(Object paramObject, View paramView)
  {
    ...
    if (jdField_a_of_type_AndroidViewAnimationAnimation == null)
    {
      ...
      jdField_a_of_type_AndroidViewAnimationAnimation.setAnimationListener(new ahma());
    }
    if (QLog.isColorLevel()) {
