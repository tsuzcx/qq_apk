...
public class bhbp
{
  private static bhbt jdField_a_of_type_Bhbt;
  private static Object jdField_a_of_type_JavaLangObject;
  private static String jdField_a_of_type_JavaLangString = "";
  private static final HashMap<String, bhbr> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  public static bhbr a()
  {
    return a("audio", 104857600, 41943040);
  }
  
  public static bhbr a(String paramString, int paramInt1, int paramInt2)
  {
    boolean bool = true;
    ...
    for (;;)
    {
      ...
      {
        bhbr localbhbr2 = (bhbr)jdField_a_of_type_JavaUtilHashMap.get(paramString);
        bhbr localbhbr1 = localbhbr2;
        if (localbhbr2 == null)
        {
          localbhbr1 = new bhbr(paramString, 1, paramInt1, paramInt2);
          localbhbr1.a(a());
          jdField_a_of_type_JavaUtilHashMap.put(paramString, localbhbr1);
        }
        return localbhbr1;
      }
      bool = false;
  ...
  public static bhbt a()
  {
    ...
    {
      if (jdField_a_of_type_Bhbt == null) {
        jdField_a_of_type_Bhbt = new bhbt(new bhbq());
      }
  ...
  static void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      jdField_b_of_type_JavaLangString = bhbz.jdField_b_of_type_JavaLangString;
    }
  }
  ...
  {
    Object localObject = bhbz.jdField_b_of_type_JavaLangString;
    if (localObject != null)
    {
  ...
  {
    return bbuv.a(ajsf.bc + UUID.randomUUID().toString() + ".jpg");
  }
