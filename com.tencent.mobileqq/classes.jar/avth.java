...
public class avth
{
  ...
  private MsgBackupUserData a(submsgtype0x11a.UserData paramUserData)
  {
    ...
    if (paramUserData.bytes_ip.has()) {
      localavup.a(paramUserData.bytes_ip.get().toStringUtf8());
    }
    if (paramUserData.rpt_fixed32_port.has()) {
      localavup.a(paramUserData.rpt_fixed32_port.get());
    }
    if (paramUserData.bytes_bssid.has()) {
      localavup.c(paramUserData.bytes_bssid.get().toStringUtf8());
    }
    if (paramUserData.bytes_ssid.has()) {
      localavup.b(paramUserData.bytes_ssid.get().toStringUtf8());
    }
    if (paramUserData.enum_platform.has()) {
      localavup.a(paramUserData.enum_platform.get());
    }
    return localavup.a();
  }
  ...
  public void a(String paramString)
  {
    ...
    localObject1 = new bbln();
    localObject2 = ((SubMsgType0x7.MsgBody)localObject2).toByteArray();
    ((bbln)localObject1).jdField_a_of_type_Int = 7;
    ((bbln)localObject1).jdField_a_of_type_ArrayOfByte = ((byte[])localObject2);
    long l1 = aszt.b();
    long l2 = aszt.a();
    localObject1 = bblf.a(paramString, 13, paramString.getCurrentUin(), (bbln)localObject1, l2, bblk.b(l1));
    ...
    if (paramMsgBody != null)
    {
      ...
      if (paramMsgBody.enum_result.has())
      {
        ...
        if (paramMsgBody.bytes_token.has()) {
          localavub.a(paramMsgBody.bytes_token.get().toStringUtf8());
        }
        if (paramMsgBody.bytes_encrypt_key.has()) {
          localavub.b(paramMsgBody.bytes_encrypt_key.get().toStringUtf8());
        }
        if (paramMsgBody.msg_user_data.has()) {
          localavub.a(a((submsgtype0x11a.UserData)paramMsgBody.msg_user_data.get()));
        }
        if (paramMsgBody.enum_biz_type.has()) {
          localavub.a(paramMsgBody.enum_biz_type.get());
        }
        paramMsgBody = localavub.a();
        if (QLog.isColorLevel()) {
          QLog.d("MsgBackup.MsgBackupPushHandler", 2, "processOnLinePush receive processOnLinePush0x11a response = " + paramMsgBody);
        }
        avtq.a().a(paramMsgBody);
      }
    }
    label180:
    do
  ...
  public void a(submsgtype0x11b.MsgBody paramMsgBody)
  {
    if (paramMsgBody != null)
    {
      ...
      if (paramMsgBody.bytes_qr_sig.has()) {
        localavuj.a(paramMsgBody.bytes_qr_sig.get().toStringUtf8());
      }
      if (paramMsgBody.enum_biz_type.has()) {
        localavuj.a(paramMsgBody.enum_biz_type.get());
      }
      paramMsgBody = localavuj.a();
      if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      if (paramGenericSubCmd.length() == 1)
      {
        ...
        if ("exit".equals(paramGenericSubCmd.optString("cmd")))
        {
          ...
          if (TextUtils.equals(paramGenericSubCmd, avtf.a().a())) {
            avwk.a().b(true);
          }
        }
      }
