...
public class azan
  extends JobSegment<azal, azal>
{
  private int jdField_a_of_type_Int;
  private WeakReference<XMediaEditor> jdField_a_of_type_JavaLangRefWeakReference;
  private boolean jdField_a_of_type_Boolean;
  
  public azan(XMediaEditor paramXMediaEditor, int paramInt)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramXMediaEditor);
    this.jdField_a_of_type_Int = paramInt;
  }
  
  protected void a(JobContext paramJobContext, azal paramazal)
  {
    if (QLog.isColorLevel()) {
      QLog.d("GenerateVideoPosterSegment", 2, new Object[] { "GenerateVideoPosterSegment start. info status=", Integer.valueOf(paramazal.g) });
    }
    String str2 = azaf.b();
    ...
    for (;;)
    {
      try
      {
        localMediaMetadataRetriever.setDataSource(paramazal.f);
        localObject3 = str1;
      ...
      finally
      {
        ...
        catch (RuntimeException paramazal)
        {
          continue;
        }
      }
      ...
      localObject4 = localObject5;
      localObject1 = localBitmap1;
      arrayOfInt = azbc.a(this.jdField_a_of_type_Int, 200, 300, paramazal.jdField_a_of_type_Int, paramazal.b);
      localObject3 = str1;
      localObject4 = localObject5;
      localObject1 = localBitmap1;
      ...
      else
      {
        ...
        localObject4 = localBitmap1;
        localObject1 = localBitmap1;
        bacm.a(localBitmap1, new File(str1));
        localObject3 = localBitmap1;
        localObject4 = localBitmap1;
        localObject1 = localBitmap1;
        paramazal.c = str1;
        ...
        localObject4 = localBitmap1;
        localObject1 = localBitmap1;
        ThreadManager.getUIHandler().post(new VideoInfo.GenerateVideoPosterSegment.1(this, paramazal, str1));
        localObject3 = localBitmap1;
        localObject4 = localBitmap1;
        localObject1 = localBitmap1;
        if (!isCanceled())
        {
          ...
          if (QLog.isColorLevel())
          {
            ...
            localObject4 = localBitmap1;
            localObject1 = localBitmap1;
            QLog.d("GenerateVideoPosterSegment", 2, new Object[] { "GenerateVideoPosterSegment notifyResult. info status=", Integer.valueOf(paramazal.g) });
          }
          localObject3 = localBitmap1;
          localObject4 = localBitmap1;
          localObject1 = localBitmap1;
          notifyResult(paramazal);
        }
        try
        {
          localMediaMetadataRetriever.release();
