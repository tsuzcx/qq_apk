  ...
  extends zhu
{
  ...
  public azan(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_Azbc = new azbc(paramAppInterface);
  }
  ...
  private boolean e(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    if (bool)
    {
      ...
      while (paramToServiceMsg.hasNext())
      {
        ...
        localObject = (azal)((Map.Entry)localObject).getValue();
        if ((((azal)localObject).a() & i) != 0)
        {
          localObject = ((azal)localObject).a(i);
          if (localObject != null)
          {
            if (QLog.isColorLevel()) {
    ...
    paramToServiceMsg = (azal)((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface).a.a().get(Integer.valueOf(101));
  ...
  private boolean o(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    for (int m = 1;; m = 0)
    {
      ...
      if (localObject != null)
      {
        ...
        bdqa.a(arrayOfByte, 0, (short)20002);
        bdqa.a(arrayOfByte, 2, s);
        bdqa.a(arrayOfByte, 4, (byte[])localObject, localObject.length);
        j = s + 4;
      }
      i = j;
      if (localInteger != null)
      {
        bdqa.a(arrayOfByte, j, (short)20031);
        i = j + 2;
        bdqa.a(arrayOfByte, i, (short)4);
        i += 2;
        bdqa.a(arrayOfByte, i, localInteger.intValue());
        i += 4;
      }
      j = i;
      if (localByte != null)
      {
        bdqa.a(arrayOfByte, i, (short)20009);
        i += 2;
        bdqa.a(arrayOfByte, i, (short)1);
        i += 2;
      ...
      {
        bdqa.a(arrayOfByte, j, (short)20032);
        i = j + 2;
        bdqa.a(arrayOfByte, i, (short)12);
        i += 2;
        bdqa.a(arrayOfByte, i, arrayOfInteger[0].intValue());
        i += 4;
        bdqa.a(arrayOfByte, i, arrayOfInteger[1].intValue());
        i += 4;
        bdqa.a(arrayOfByte, i, arrayOfInteger[2].intValue());
      }
  ...
  private boolean r(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    alto localalto = (alto)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(51);
