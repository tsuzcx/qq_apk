...
{
  public azan(TribeVideoListPlayerFragment paramTribeVideoListPlayerFragment) {}
  ...
  public void onClick(View paramView)
  {
    if ((this.a.jdField_a_of_type_Boolean) || (this.a.b))
    {
      ...
      this.a.c = true;
      paramView = (azbj)((View)this.a.jdField_a_of_type_ComTencentQqliveMediaplayerViewIVideoViewBase).getTag();
      if ((paramView instanceof azbi))
      {
        paramView = ((azbi)paramView).a;
    ...
    for (;;)
    {
      ...
      this.a.b((azbj)((View)this.a.jdField_a_of_type_ComTencentQqliveMediaplayerViewIVideoViewBase).getTag());
