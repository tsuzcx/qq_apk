  ...
  implements Manager
{
  ...
  public akpd(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(long paramLong, akpg paramakpg, String paramString, Map<String, String> paramMap)
  {
    if (a())
    {
    ...
    for (long l2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getLongAccountUin();; l2 = 0L)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("QWalletConfigManager", 2, "realGetConfig:" + paramLong + "|" + paramakpg + "|" + paramString + "|" + paramMap + "|" + localReqWalletConfig);
      }
      akmf.a(localReqWalletConfig, new akpe(this, paramLong, paramakpg, new WeakReference(this)), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      return;
      l1 = 0L;
      break;
    }
  ...
  public static void a(String paramString, akph paramakph)
  {
    AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    if ((localAppRuntime instanceof QQAppInterface))
    {
      ((akpd)localAppRuntime.getManager(245)).c(paramString, paramakph);
      return;
    }
    akwm.a(paramString, paramakph);
  }
  
  public static void b(String paramString, akph paramakph)
  {
    AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    if ((localAppRuntime instanceof QQAppInterface))
    {
      ((akpd)localAppRuntime.getManager(245)).d(paramString, paramakph);
      return;
    }
    akwm.b(paramString, paramakph);
  }
  
  public int a(String paramString, int paramInt, String... paramVarArgs)
  {
    return akpa.a(a(paramString), paramInt, paramVarArgs);
  }
  ...
  public akpb a(String paramString)
  {
  ...
  {
    return akpa.a(a(paramString1), paramString2, paramVarArgs);
  }
  
  public JSONArray a(String paramString, String... paramVarArgs)
  {
    return akpa.a(a(paramString), paramVarArgs);
  }
  ...
  public void a(Map<String, String> paramMap)
  {
    ...
    do
    {
      ...
      akmf.a(paramMap, 1, new akpf(this));
    } while (!QLog.isColorLevel());
  ...
  public void b(int paramInt)
  {
    ...
    try
    {
      String str = ((akti)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(273)).a();
  ...
  public void c(String paramString, akph paramakph)
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityQwalletConfigQWalletConfig.addUpdateListener(paramString, paramakph);
  }
  
  public void d(String paramString, akph paramakph)
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityQwalletConfigQWalletConfig.removeUpdateListener(paramString, paramakph);
  }
