  ...
  private void a(Object paramObject)
  {
    ...
    case 3: 
      for (;;)
      {
        ...
        QLog.i("FMObserver<FileAssistant>", 1, "OnFileCome uniseq[" + String.valueOf(l1) + "],nSessionId[" + String.valueOf(l2) + "], strUin[" + apck.e((String)localObject1) + "], peerType[" + String.valueOf(i) + "]");
        ...
        localObject1 = (String)paramObject[3];
        i = ((Integer)paramObject[4]).intValue();
        QLog.i("FMObserver<FileAssistant>", 1, "OnFileTransferStart uniseq[" + String.valueOf(l1) + "],nSessionId[" + String.valueOf(l2) + "], strUin[" + apck.e((String)localObject1) + "], peerType[" + String.valueOf(i) + "]");
        ...
        {
          paramObject = (Object[])paramObject[2];
          localObject1 = new aooa();
          ((aooa)localObject1).jdField_a_of_type_JavaLangString = ((String)paramObject[0]);
          ((aooa)localObject1).jdField_a_of_type_Int = ((Integer)paramObject[1]).intValue();
          ((aooa)localObject1).jdField_b_of_type_JavaLangString = ((String)paramObject[2]);
          ((aooa)localObject1).jdField_a_of_type_JavaLangObject = paramObject[3];
          QLog.i("FMObserver<FileAssistant>", 1, "OnThumbDownLoadSuccess,fileId[" + ((aooa)localObject1).jdField_a_of_type_JavaLangString + "],filePath[" + ((aooa)localObject1).jdField_b_of_type_JavaLangString + "]");
          if ((((aooa)localObject1).jdField_a_of_type_JavaLangObject != null) && (((aooa)localObject1).jdField_b_of_type_JavaLangString != null) && (((aooa)localObject1).jdField_b_of_type_JavaLangString.length() > 0))
          {
            if (!(((aooa)localObject1).jdField_a_of_type_JavaLangObject instanceof WeiYunFileInfo)) {
              break label3135;
            }
            ((WeiYunFileInfo)((aooa)localObject1).jdField_a_of_type_JavaLangObject).h = ((aooa)localObject1).jdField_b_of_type_JavaLangString;
          }
          for (;;)
          {
            a((aooa)localObject1);
            return;
            if ((((aooa)localObject1).jdField_a_of_type_JavaLangObject instanceof OfflineFileInfo)) {
              ((OfflineFileInfo)((aooa)localObject1).jdField_a_of_type_JavaLangObject).c = ((aooa)localObject1).jdField_b_of_type_JavaLangString;
            } else if ((((aooa)localObject1).jdField_a_of_type_JavaLangObject instanceof FileManagerEntity)) {
              ((FileManagerEntity)((aooa)localObject1).jdField_a_of_type_JavaLangObject).strThumbPath = ((aooa)localObject1).jdField_b_of_type_JavaLangString;
            }
          }
        }
        localObject1 = (Object[])paramObject[2];
        localObject2 = (String)localObject1[0];
        paramObject = new aooa();
    ...
    for (i = ((Integer)localObject1[1]).intValue();; i = 0)
    {
      ...
      {
        localObject1 = new aooa();
        ((aooa)localObject1).jdField_a_of_type_JavaLangObject = paramObject;
        ((aooa)localObject1).jdField_a_of_type_JavaLangString = paramObject.Uuid;
        ((aooa)localObject1).jdField_b_of_type_Int = i;
        if (i == 7) {
          ((aooa)localObject1).jdField_b_of_type_JavaLangString = paramObject.strLargeThumPath;
        }
        for (;;)
        {
          ((aooa)localObject1).jdField_a_of_type_Long = paramObject.nSessionId;
          a((aooa)localObject1);
          return;
          if (i == 5) {
            ((aooa)localObject1).jdField_b_of_type_JavaLangString = paramObject.strMiddleThumPath;
          } else {
            ((aooa)localObject1).jdField_b_of_type_JavaLangString = paramObject.strThumbPath;
          }
        }
      }
      localObject1 = new aooa();
      ((aooa)localObject1).jdField_a_of_type_JavaLangObject = paramObject;
      ((aooa)localObject1).jdField_a_of_type_JavaLangString = paramObject.Uuid;
      ((aooa)localObject1).jdField_b_of_type_JavaLangString = null;
      ((aooa)localObject1).jdField_b_of_type_Int = i;
      ((aooa)localObject1).jdField_a_of_type_Long = paramObject.nSessionId;
      a((aooa)localObject1);
      return;
