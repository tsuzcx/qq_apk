  ...
  implements URLDrawableDownListener
{
  ...
  public aodp(Context paramContext, Handler paramHandler, aodo paramaodo)
  {
  ...
  public int a(aodo paramaodo)
  {
    return paramaodo.a(this.jdField_a_of_type_JavaUtilList);
  }
  
  public aodo a(int paramInt)
  {
    if ((this.jdField_a_of_type_JavaUtilList != null) && (!this.jdField_a_of_type_JavaUtilList.isEmpty()) && (paramInt >= 0) && (paramInt < this.jdField_a_of_type_JavaUtilList.size())) {
      return (aodo)this.jdField_a_of_type_JavaUtilList.get(paramInt);
    }
    return this.jdField_a_of_type_Aodo;
  }
  ...
  public void a(List<aodo> paramList)
  {
  ...
  {
    return a(paramInt).a(this.jdField_a_of_type_Aodo);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      {
        paramViewGroup = (aodo)this.jdField_a_of_type_JavaUtilList.get(paramInt);
        ...
        label106:
        if ((!(localDrawable instanceof asbz)) || (((asbz)localDrawable).a() == null)) {
          break label211;
        }
        int i = actn.a(100.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
        paramViewGroup = a(((asbz)localDrawable).a(), i, i);
      ...
      for (;;)
      {
        ...
        return paramView;
        paramViewGroup = this.jdField_a_of_type_Aodo;
        break;
        label200:
