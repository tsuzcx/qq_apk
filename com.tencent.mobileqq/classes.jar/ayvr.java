...
public class ayvr
{
  ...
  public static MessageForQQWalletMsg a(String paramString1, String paramString2)
  {
    try
    {
      ...
      {
        MessageForQQWalletMsg localMessageForQQWalletMsg = (MessageForQQWalletMsg)ayvw.a(-2025);
  ...
  public static MessageForVIPDonate a(String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        MessageForVIPDonate localMessageForVIPDonate = (MessageForVIPDonate)ayvw.a(-2047);
        ...
        if (localJSONObject.has("title"))
        {
          ...
          localMessageForVIPDonate.msgData = ammq.a(localVIPDonateMsg);
    ...
    for (;;)
    {
      ...
      if (paramList != null)
      {
        ...
        if (paramList.str.has())
        {
          ...
          if (paramBoolean)
          {
            str = ayvy.a(paramList, false);
            localObject = paramList;
            if (str.length() > 0)
            {
              localObject = (MessageForText)ayvw.a(-1000);
  ...
  private void a(im_msg_body.Elem paramElem, List<MessageRecord> paramList, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, aywa paramaywa)
  {
    ...
    if (localObject != null)
    {
      ...
      if (i == 1)
      {
        ...
        {
          paramStringBuilder = (bfua)this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.getManager(165);
          if (!paramStringBuilder.a.containsKey(paramElem)) {
            paramStringBuilder.a(new BmqqAccountType(paramElem, 1));
          }
        }
        if ((paramaywa != null) && (paramaywa.jdField_a_of_type_Int == 1024)) {
          paramaywa.jdField_a_of_type_Int = 1025;
        }
      }
    ...
    while (!QLog.isColorLevel()) {
      try
      {
        ...
        if ((i == 8) && (paramElem.qidian_group_msg.has()))
        {
          ...
          ayvu.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, l1, k, l2, m);
          if (j != 0)
          {
            paramStringBuilder = (bfvi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(85);
        ...
        if ((i == 11) && (paramElem.msg_gray_msg.has()))
        {
          ...
          bfvv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1), paramStringBuilder, 1024, ((StringBuilder)localObject).toString());
        }
        if (paramElem.str_check_id.has()) {
          bfvv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramList, paramMsg, paramaywa, paramElem);
        }
        if ((paramaywa != null) && (paramaywa.jdField_a_of_type_Int == 1024) && (paramElem.str_ext_nick_name.has()))
        {
  ...
  {
    BaseApplication.getContext().getString(2131695013);
    boolean bool;
          ...
          for (int k = paramNotOnlineImage.uint32_file_id.get();; k = 0)
          {
            ...
            for (;;)
            {
                ...
                if (paramNotOnlineImage.pic_md5.has())
                {
                  ...
                  if (localObject2 != null)
                  {
                    ...
                    if (localObject2.length > 0) {
                      paramMsg = bdcv.a((byte[])localObject2);
                    }
                  }
                }
                Object localObject2 = bauj.a(paramElem, j, 1, false, paramElem, paramMsg, "picplatform", str1, str2, str3, str4, i5, 0);
              ...
              for (;;)
              {
                ...
                paramElem = (MessageForPic)ayvw.a(-2000);
                if (bool) {
                  alnp.a(paramElem, false);
                }
                ...
                azmz.a(BaseApplication.getContext()).a(paramNotOnlineImage, "actMessageEvent", false, 0L, 0L, paramElem, "");
                return;
                label1192:
                j = n;
                k = m;
  ...
  public ayvs a(List<im_msg_body.Elem> paramList, StringBuilder paramStringBuilder, long paramLong, bbku parambbku)
  {
    ayvs localayvs = new ayvs(this);
    localayvs.jdField_a_of_type_ComTencentMobileqqDataMessageForReplyText$SourceMsgInfo = a(paramList, paramStringBuilder);
    ayvt localayvt = new ayvt();
    ArrayList localArrayList = localayvt.jdField_a_of_type_JavaUtilArrayList;
    StringBuilder localStringBuilder = a(null, paramList, paramStringBuilder, paramLong, parambbku, localayvt, null);
    if ((localArrayList != null) && (localArrayList.size() == 2)) {
      if (localArrayList.get(0) != null)
      {
        ...
        if (localArrayList.get(1) != null) {
          localayvs.jdField_a_of_type_ArrayOfByte = ((byte[])localArrayList.get(1));
        }
      }
    }
    for (paramStringBuilder = paramList;; paramStringBuilder = null)
    {
      if ((localStringBuilder.length() > 0) && (localayvs.jdField_a_of_type_ComTencentMobileqqDataMessageForReplyText$SourceMsgInfo != null))
      {
        localayvs.jdField_a_of_type_JavaLangString = localStringBuilder.toString();
        if ((TextUtils.isEmpty(localayvs.jdField_a_of_type_ComTencentMobileqqDataMessageForReplyText$SourceMsgInfo.mAnonymousNickName)) && (paramStringBuilder != null) && (!TextUtils.isEmpty(localayvs.jdField_a_of_type_JavaLangString)) && (localayvs.jdField_a_of_type_JavaLangString.length() >= paramStringBuilder.textLen + paramStringBuilder.startPos))
        {
          localayvs.jdField_a_of_type_ComTencentMobileqqDataMessageForText$AtTroopMemberInfo = paramStringBuilder;
          paramList = localayvs.jdField_a_of_type_JavaLangString;
          localayvs.jdField_a_of_type_JavaLangString = "";
          if (paramStringBuilder.startPos > 0) {
            localayvs.jdField_a_of_type_JavaLangString = paramList.substring(0, paramStringBuilder.startPos);
          }
          localayvs.jdField_a_of_type_JavaLangString += paramList.substring(paramStringBuilder.startPos + paramStringBuilder.textLen);
          localayvs.b = paramList.substring(paramStringBuilder.startPos, paramStringBuilder.startPos + paramStringBuilder.textLen);
          if ((paramStringBuilder.isIncludingMe(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.getLongAccountUin())) && (localayvt.jdField_a_of_type_ComTencentMobileqqDataMessageForText$AtTroopMemberInfo == null)) {
            parambbku.jdField_a_of_type_Bbkv.a = -1L;
          }
        }
      }
      return localayvs;
    ...
    if (localMarketFace != null)
    {
      ...
      catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException)
      {
        try
        {
          for (;;)
          {
            paramStringBuilder.msgData = ammq.a(paramElem);
      ...
      if (localResvAttr.uint32_has_ip_product.get() == 1)
      {
        ...
        paramStringBuilder = (MessageForMarketFace)ayvw.a(-2007);
        ...
        if ((paramElem.mobileparam != null) && (paramElem.mobileparam.length > 0)) {
          azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app, "CliOper", "", "", "MbJieshou", "MbXiaoxi", 0, 0, "", "", "", "");
        }
      }
    }
    label593:
  ...
  public MessageForDeliverGiftTips a(String paramString1, String paramString2, im_msg_body.DeliverGiftMsg paramDeliverGiftMsg, List<MessageRecord> paramList, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg)
  {
    ...
    {
      paramStringBuilder = (MessageForDeliverGiftTips)ayvw.a(-2035);
    ...
    for (;;)
    {
      ...
      paramString1 = (bclk)this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.getManager(81);
      if (paramString1 != null)
      {
        ...
        if (paramStringBuilder.grayTipsEntity.highlightNum != 0) {
          bclk.a(paramStringBuilder, paramStringBuilder.grayTipsEntity.highlightItems);
        }
        if ((paramStringBuilder instanceof MessageForTroopGift)) {
      ...
      {
        paramDeliverGiftMsg = Pattern.compile(alpo.a(2131707029));
      ...
      paramStringBuilder = (MessageForTroopGift)ayvw.a(-2038);
    ...
    if (j < k)
    {
      ...
      for (;;)
      {
        ...
        if (((im_msg_body.Text)localObject).str.has()) {
          localStringBuilder1.append(ayvy.a(((im_msg_body.Text)localObject).str.get().toStringUtf8(), false));
        }
        continue;
        int m;
        if (((im_msg_body.Elem)localObject).face.has())
        {
          ...
          {
            m = apog.b(((im_msg_body.Face)((im_msg_body.Elem)localObject).face.get()).index.get());
            if (m >= 0)
            {
  ...
  public String a(im_msg_body.CommonElem paramCommonElem)
  {
    ...
    try
    {
      ...
      int i = apog.b(((hummer_commelem.MsgElemInfo_servtype33)localObject).uint32_index.get());
      localObject = str;
      if (i >= 0) {
        localObject = apog.b(i);
      }
      return localObject;
    }
  ...
  public StringBuilder a(StringBuilder paramStringBuilder1, List<im_msg_body.Elem> paramList, StringBuilder paramStringBuilder2, long paramLong, bbku parambbku, ayvt paramayvt, ArrayList<MessageForText.AtTroopMemberInfo> paramArrayList)
  {
    ayvt localayvt = paramayvt;
    if (paramayvt == null) {
      localayvt = new ayvt();
    }
    Object localObject2 = null;
    Object localObject1 = localayvt.jdField_a_of_type_ComTencentMobileqqDataMessageForText$AtTroopMemberInfo;
    paramayvt = null;
    ...
    if (((im_msg_body.Text)localObject1).str.has()) {
      localStringBuilder.append(ayvy.a(((im_msg_body.Text)localObject1).str.get().toStringUtf8(), false));
    }
    label219:
    int k;
    int j;
    ...
    if (((im_msg_body.Text)localObject1).attr_6_buf.has())
    {
      ...
      if (localObject1 != null)
      {
        ...
        if ((parambbku != null) && ((parambbku.jdField_a_of_type_Int == 3000) || (parambbku.jdField_a_of_type_Int == 1)) && (paramArrayList != null) && (localObject2 != null) && (localObject2.length != 0))
        {
          n = bdlr.a((byte[])localObject2, 0);
          k = 2;
          j = 0;
          if ((j < n) && (k < 2048))
          {
        ...
        if ((parambbku == null) || ((!parambbku.jdField_a_of_type_Bbkv.a(paramLong)) && (!parambbku.f.a(paramLong)) && (paramList != null)) || (localObject2 == null) || (localObject2.length == 0)) {
          break label1406;
        }
        int n = bdlr.a((byte[])localObject2, 0);
        k = 2;
        j = 0;
    ...
    for (;;)
    {
      localObject1 = paramayvt;
      paramayvt = paramList;
      paramList = paramStringBuilder1;
      paramStringBuilder1 = (StringBuilder)localObject1;
      label448:
      localObject1 = paramayvt;
      paramayvt = paramStringBuilder1;
      paramStringBuilder1 = (StringBuilder)localObject1;
      break;
      localObject2 = null;
      break label219;
      ...
      if (localAtTroopMemberInfo.isIncludingAll()) {
        parambbku.f.a = paramLong;
      }
      if ((localAtTroopMemberInfo.isIncludingMe(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.getLongAccountUin())) && (parambbku.jdField_a_of_type_Bbkv != null))
      {
        parambbku.jdField_a_of_type_Bbkv.a = paramLong;
      ...
      for (;;)
      {
        ...
        if (((im_msg_body.Elem)localObject1).face.has())
        {
          ...
          j = apog.b(((im_msg_body.Face)((im_msg_body.Elem)localObject1).face.get()).index.get());
          if (j >= 0)
          {
          ...
          localObject1 = paramStringBuilder1;
          paramStringBuilder1 = paramayvt;
          paramayvt = (ayvt)localObject1;
          break label448;
        }
        ...
        if (((im_msg_body.Elem)localObject1).online_image.has())
        {
          ...
          localStringBuilder.append(BaseApplication.getContext().getString(2131695013));
          localObject1 = paramStringBuilder1;
          paramStringBuilder1 = paramayvt;
          paramayvt = (ayvt)localObject1;
          break label448;
        ...
        break label448;
        label1268:
        localayvt.jdField_a_of_type_ComTencentMobileqqDataMessageForText$AtTroopMemberInfo = paramList;
        paramList = localayvt.jdField_a_of_type_JavaUtilArrayList;
        if ((paramList != null) && ((paramStringBuilder1 != null) || (paramayvt != null)))
        {
          if (!paramList.isEmpty()) {
            break label1316;
          }
          paramList.add(paramStringBuilder1);
          paramList.add(paramayvt);
        }
        label1316:
  ...
  public void a(MessageHandler paramMessageHandler, List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bbku parambbku)
  {
    paramList = a(paramList, paramStringBuilder, paramMsg.msg_head.msg_seq.get(), parambbku);
    ...
    {
      paramStringBuilder = (ChatMessage)ayvw.a(-1049);
      paramStringBuilder.msg = paramList.jdField_a_of_type_JavaLangString;
      parambbku = (MessageForReplyText)paramStringBuilder;
    }
    try
    {
      parambbku.extLong |= 0x1;
      if (paramMsg.getSourceMsg() != null)
      {
        parambbku.setSourceMessageRecord(paramMsg.unPackSourceMsg(paramMessageHandler.app));
        if ((parambbku.getSourceMessage() != null) && (arni.a(parambbku.getSourceMessage())))
        {
          paramMessageHandler = parambbku.getSourceMessage().getExtInfoFromExtStr("_m_ForwardFileType");
          ChatMessage localChatMessage = arni.a((ChatMessage)parambbku.getSourceMessage());
          aroo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localChatMessage, parambbku.getSourceMessage());
          if ((!TextUtils.isEmpty(paramMessageHandler)) && (localChatMessage != null))
          {
            ...
            if ((i == 1) || (i == 2))
            {
              ...
              arni.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localChatMessage.uniseq, localChatMessage.frienduin, localChatMessage.istroop, (ChatMessage)parambbku.getSourceMessage());
            }
          }
        }
      }
      paramMessageHandler = bdcv.a(ammq.a(paramMsg));
      parambbku.mSourceMsgInfo = paramMsg;
      parambbku.saveExtInfoToExtStr("sens_msg_source_msg_info", paramMessageHandler);
      if (QLog.isColorLevel()) {
        QLog.d("SendMsgBtn", 2, "reply:" + parambbku + " sourceMsg=" + parambbku.getSourceMessage());
      }
    }
    ...
    if (paramList.jdField_a_of_type_ArrayOfByte != null) {
      paramStringBuilder.saveExtInfoToExtStr("sens_msg_ctrl_info", bdcv.a(paramList.jdField_a_of_type_ArrayOfByte));
    }
    paramList1.add(paramStringBuilder);
    if (QLog.isColorLevel()) {
      QLog.d("DecodeMsg", 2, "reply msgRand = " + ayvy.a(paramStringBuilder.msgUid) + ", msgUid = " + paramStringBuilder.msgUid);
    }
  }
  
  public void a(MessageHandler paramMessageHandler, List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bbku parambbku, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      if (localIterator.hasNext())
      {
        ...
        if (localElem.custom_face.has())
        {
          ...
          {
            localMessageForText = (MessageForText)ayvw.a(-1000);
          ...
          a(localElem, null, localArrayList, paramStringBuilder, paramMsg, paramBoolean, parambbku);
        }
    ...
    for (;;)
    {
      ...
      localObject1 = a((StringBuilder)localObject1, (List)localObject3, paramStringBuilder, paramMsg.msg_head.msg_seq.get(), parambbku, localayvt, (ArrayList)localObject2);
      break;
      if (localElem.general_flags.has())
      {
        ...
        if (((StringBuilder)localObject1).length() > 0)
        {
          ...
          if (parambbku != null) {
            bceh.a(parambbku.jdField_a_of_type_Int, (ArrayList)localObject2, (ChatMessage)localObject3);
          }
          localArrayList.add(localObject3);
          ((StringBuilder)localObject1).delete(0, ((StringBuilder)localObject1).length());
        }
        localObject2 = localayvt.jdField_a_of_type_JavaUtilArrayList;
        ...
        for (;;)
        {
          ...
          if (paramList != null) {
            paramStringBuilder = (MessageForReplyText)ayvw.a(-1049);
          }
          try
          {
            ...
            if (paramList.getSourceMsg() != null)
            {
              ...
              if ((paramStringBuilder.getSourceMessage() != null) && (arni.a(paramStringBuilder.getSourceMessage())))
              {
                localObject3 = paramStringBuilder.getSourceMessage().getExtInfoFromExtStr("_m_ForwardFileType");
                localChatMessage = arni.a((ChatMessage)paramStringBuilder.getSourceMessage());
                aroo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localChatMessage, paramStringBuilder.getSourceMessage());
                if ((!TextUtils.isEmpty((CharSequence)localObject3)) && (localChatMessage != null))
                {
                  ...
                  if ((i == 1) || (i == 2))
                  {
                    ...
                    arni.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localChatMessage.uniseq, localChatMessage.frienduin, localChatMessage.istroop, (ChatMessage)paramStringBuilder.getSourceMessage());
                  }
                }
              }
            }
            paramStringBuilder.saveExtInfoToExtStr("sens_msg_source_msg_info", bdcv.a(ammq.a(paramList)));
          }
          ...
          if (TextUtils.isEmpty(paramStringBuilder.mSourceMsgInfo.mAnonymousNickName))
          {
            ...
            if (localObject2 != null)
            {
              ...
              paramList = (MessageForReplyText)ayvw.a(-1049);
              ...
              if ((!TextUtils.isEmpty(paramList.msg)) && (paramList.msg.length() >= ((MessageForText.AtTroopMemberInfo)localObject2).textLen + ((MessageForText.AtTroopMemberInfo)localObject2).startPos))
              {
                ...
                if ((((MessageForText.AtTroopMemberInfo)localObject2).isIncludingMe(paramMessageHandler.app.getLongAccountUin())) && (localayvt.jdField_a_of_type_ComTencentMobileqqDataMessageForText$AtTroopMemberInfo == null)) {
                  parambbku.jdField_a_of_type_Bbkv.a = -1L;
                }
              }
          ...
          try
          {
            if (localArrayList.size() > 0)
            {
              ...
              localObject3 = bdal.a(paramStringBuilder);
              if (QLog.isColorLevel()) {
              ...
              ((aljv)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(53)).a(paramStringBuilder);
            }
          }
          catch (Exception paramList)
          {
                  ...
                  if (j != 0)
                  {
                    ...
                    while (paramStringBuilder.hasNext())
                    {
                      ...
                      if ((paramMsg.msgtype != -1000) && (paramMsg.msgtype != -1049) && (paramMsg.msgtype != -2000))
                      {
                        ...
                        {
                          paramList1.add(ayvu.a(paramList, paramMessageHandler, parambbku));
                          paramList.clear();
                    ...
                    if (paramList.size() > 0)
                    {
                      ...
                      paramMessageHandler = ayvu.a(paramList, (byte[])localObject1, parambbku);
                  ...
                  for (;;)
                  {
                    ...
                    while (paramMessageHandler.hasNext())
                    {
                      ...
                      if (((paramList instanceof MessageForText)) && (k == 0)) {
                        paramList.saveExtInfoToExtStr("sens_msg_ctrl_info", bdcv.a((byte[])localObject1));
                      }
  ...
  public void a(ArrayList<String> paramArrayList, List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bbku parambbku, aywa paramaywa, ayva paramayva)
  {
    if (paramArrayList.contains("lifeOnline")) {
      a(paramList, paramList1, paramStringBuilder, paramMsg, parambbku);
    }
    ...
    if (paramArrayList.hasNext())
    {
      ...
      if (paramList.crm_elem.has()) {
        a(paramList, paramList1, paramStringBuilder, paramMsg, paramaywa);
      }
      if (paramList.general_flags.has())
      {
        ...
        {
          parambbku = new generalflags.ResvAttr();
          j = n;
        }
      }
      try
      {
        parambbku.mergeFrom(paramList.general_flags.bytes_pb_reserve.get().toByteArray());
        j = n;
        if (parambbku.float_sticker_x.has())
        {
          j = n;
          localObject1 = new EmojiStickerManager.StickerInfo();
          j = n;
          ((EmojiStickerManager.StickerInfo)localObject1).x = parambbku.float_sticker_x.get();
          j = n;
          if (!parambbku.float_sticker_y.has()) {
            break label2591;
          }
          j = n;
          f = parambbku.float_sticker_y.get();
          label519:
          j = n;
          ((EmojiStickerManager.StickerInfo)localObject1).y = f;
          j = n;
          if (!parambbku.float_sticker_width.has()) {
            break label2597;
          }
          j = n;
          f = parambbku.float_sticker_width.get();
          label559:
          j = n;
          ((EmojiStickerManager.StickerInfo)localObject1).width = f;
          j = n;
          if (!parambbku.float_sticker_height.has()) {
            break label2603;
          }
          j = n;
          f = parambbku.float_sticker_height.get();
          label599:
          j = n;
          ((EmojiStickerManager.StickerInfo)localObject1).height = f;
          j = n;
          if (!parambbku.uint32_sticker_rotate.has()) {
            break label2609;
          }
          j = n;
          i = parambbku.uint32_sticker_rotate.get();
          label639:
          j = n;
          ((EmojiStickerManager.StickerInfo)localObject1).rotate = i;
          j = n;
          if (!parambbku.uint64_sticker_host_msgseq.has()) {
            break label2615;
          }
          j = n;
          l = parambbku.uint64_sticker_host_msgseq.get();
          label679:
          j = n;
          ((EmojiStickerManager.StickerInfo)localObject1).hostMsgSeq = l;
          j = n;
          if (!parambbku.uint64_sticker_host_msguid.has()) {
            break label2621;
          }
          j = n;
          l = parambbku.uint64_sticker_host_msguid.get();
          label719:
          j = n;
          ((EmojiStickerManager.StickerInfo)localObject1).hostMsgUid = l;
          j = n;
          if (!parambbku.uint64_sticker_host_time.has()) {
            break label2627;
          }
          j = n;
          l = parambbku.uint64_sticker_host_time.get();
          label759:
          j = n;
        ...
        j = n;
        if (!parambbku.uint32_mobile_custom_font.has()) {
          break label2633;
        }
        j = n;
        l = parambbku.uint32_mobile_custom_font.get() & 0xFFFFFFFF;
        j = n;
        if (!paramList1.isEmpty())
        {
          j = n;
      ...
      catch (InvalidProtocolBufferMicroException parambbku)
      {
        for (;;)
        {
          Object localObject1;
      ...
      j = i;
      if (parambbku.uint64_subfont_id.has())
      {
        j = i;
        l = parambbku.uint64_subfont_id.get();
        j = i;
        if (!paramList1.isEmpty())
        {
          j = i;
      ...
      j = i;
      if (parambbku.uint32_diy_font_timestamp.has())
      {
        j = i;
        l = parambbku.uint32_diy_font_timestamp.get();
        j = i;
        if (!paramList1.isEmpty())
        {
          j = i;
        ...
        j = i;
        if (parambbku.uint32_tail_key.has())
        {
          j = i;
          if (2 == parambbku.uint32_tail_key.get())
          {
            j = i;
            if (parambbku.uint32_show_tail_flag.has())
            {
              j = i;
              if (1 != parambbku.uint32_show_tail_flag.get())
              {
                j = i;
                parambbku.uint32_tail_key.clear();
                j = i;
                if (QLog.isColorLevel())
                {
                  j = i;
        ...
        {
          j = i;
          k = parambbku.uint32_tail_key.get();
          j = i;
          if (!paramList1.isEmpty())
          {
            j = i;
        ...
        j = i;
        if (parambbku.uint32_bot_message_class_id.has())
        {
          j = i;
          k = parambbku.uint32_bot_message_class_id.get();
          j = i;
          if (!paramList1.isEmpty())
          {
            j = i;
        ...
        j = i;
        if (parambbku.uint32_holiday_flag.has())
        {
          j = i;
          k = parambbku.uint32_holiday_flag.get();
          if (k == 1)
          {
            j = i;
            if (!paramList1.isEmpty())
            {
              j = i;
              ((MessageRecord)paramList1.get(0)).saveExtInfoToExtStr(ayvj.c, String.valueOf(k));
            }
          }
          j = i;
          if (QLog.isColorLevel())
        ...
        j = i;
        if (parambbku.uint32_service_msg_type.has())
        {
          j = i;
          k = parambbku.uint32_service_msg_type.get();
          j = i;
          if (!paramList1.isEmpty())
          {
            j = i;
            ((MessageRecord)paramList1.get(0)).saveExtInfoToExtStr(ayvj.w, String.valueOf(k));
          }
          j = i;
          ((StringBuilder)localObject1).append("---uint32_service_msg_type = ").append(k).append("---");
        }
        j = i;
        if (parambbku.uint32_service_msg_remind_type.has())
        {
          j = i;
          k = parambbku.uint32_service_msg_remind_type.get();
          j = i;
          if (!paramList1.isEmpty())
          {
            j = i;
            ((MessageRecord)paramList1.get(0)).saveExtInfoToExtStr(ayvj.x, String.valueOf(k));
          }
          j = i;
          ((StringBuilder)localObject1).append("---uint32_service_msg_remind_type = ").append(k).append("---");
        }
        j = i;
        if (parambbku.bytes_service_msg_name.has())
        {
          j = i;
          localObject2 = parambbku.bytes_service_msg_name.get().toStringUtf8();
          j = i;
          if (!paramList1.isEmpty())
          {
            j = i;
            ((MessageRecord)paramList1.get(0)).saveExtInfoToExtStr(ayvj.y, (String)localObject2);
          }
          j = i;
    ...
    try
    {
      if (parambbku.uint32_msg_info_flag.has())
      {
        j = i;
        k = parambbku.uint32_msg_info_flag.get();
        j = i;
        if (!paramList1.isEmpty())
        {
          j = i;
    ...
    int k = i;
    int j = i;
    if (parambbku.uint32_comment_flag.has())
    {
      k = i;
      j = i;
      if (parambbku.uint64_comment_location.has())
      {
        k = i;
        j = i;
        if (!paramList1.isEmpty())
        {
          j = i;
          if (parambbku.uint32_comment_flag.get() != 1) {
            break label2756;
          }
        }
      }
    ...
    {
      j = i;
      l = parambbku.uint64_comment_location.get();
      j = i;
      ...
      try
      {
        ...
        j = i;
        ((oidb_0xdea.PassThrough)localObject2).mergeFrom(parambbku.bytes_pass_through.get().toByteArray());
        j = i;
        ((MessageForReplyText)localObject1).barrageSourceMsgType = ((oidb_0xdea.PassThrough)localObject2).entrance.get();
      }
      catch (Exception parambbku)
      {
        for (;;)
        {
          j = i;
          QLog.i("DecodeMsg", 1, "handleGeneralSettingFlags fail, " + parambbku);
        }
      }
      k = i;
      j = i;
      ...
      if ((paramList.common_elem.has()) && (21 == paramList.common_elem.uint32_service_type.get())) {
        aoep.a(paramMsg, paramList, paramList1, this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app);
      }
      if ((!paramList.common_elem.has()) || (34 != paramList.common_elem.uint32_service_type.get())) {
        break;
      }
      asiu.a(paramMsg, paramList, paramList1, this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app, paramayva);
      break;
      f = 0.0F;
      break label519;
      f = 0.0F;
            ...
            catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException)
            {
              try
              {
                do
                {
                  ...
                  localObject1 = (MessageForShortVideo)ayvw.a(-2022);
                  ...
                  ((MessageForShortVideo)localObject1).msg = ayyw.b;
                  ...
                  try
                  {
                    ...
                    {
                      String str = bdal.a((byte[])localObject3);
                      if (QLog.isColorLevel()) {
                    ...
                    ((aljv)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(53)).a((byte[])localObject3);
                  }
                  catch (Exception paramList)
                  {
                    for (;;)
                  ...
                  if (((MessageForShortVideo)localObject1).redBagType == LocalMediaInfo.REDBAG_TYPE_GET)
                  {
                    ...
                    azey.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false);
              ...
              catch (Exception localException)
              {
                for (;;)
                {
                  if (QLog.isColorLevel())
                  {
                    ...
                    continue;
                    localException.msg = ayyw.jdField_a_of_type_JavaLangString;
                  }
                }
              }
            }
  ...
  public void a(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg)
  {
    ...
    for (;;)
    {
      ...
      if (alsh.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app, 3000, String.valueOf(l1), String.valueOf(l4), l6, l7)) {
        continue;
      }
      paramStringBuilder = "";
      try
      {
        ...
        if (paramMsg.msg_body.has())
        {
          ...
          if (paramMsg.rich_text.attr.has()) {
            l2 = ayvy.a(((im_msg_body.Attr)paramMsg.rich_text.attr.get()).random.get());
          }
        }
      ...
      catch (UnsupportedEncodingException localInvalidProtocolBufferMicroException)
      {
        try
        {
          ...
          {
            bool = true;
            paramMsg.msg = bauj.a(paramStringBuilder, l1, 0, bool);
            paramMsg.doParse();
          }
        }
        catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException)
        {
          try
          {
            for (;;)
            {
              paramMsg.fileName = arni.a(new String(paramList.bytes_filename.get().toByteArray(), "UTF-8"));
              paramList1.add(paramMsg);
              ((baet)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(272)).a(paramMsg);
              if (!QLog.isColorLevel()) {
                break;
              }
  ...
  public void a(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bbku parambbku)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        parambbku = localElem.life_online.gdt_cli_data.get().toStringUtf8();
        ...
        if (parambbku.length() <= 100) {
          break label1714;
        }
        paramStringBuilder = parambbku.substring(0, 100);
        i2 = j;
      }
      for (;;)
      {
          ...
          if ((localElem.life_online.uint64_bitmap.get() & 0x1000) == 4096L)
          {
            ...
            if (i1 != 0)
            {
              ...
              if (QLog.isColorLevel())
              {
                ...
                parambbku = Long.valueOf(localElem.life_online.uint64_bitmap.get());
                QLog.d("DecodeMsg", 2, parambbku);
              }
              ThreadManager.getSubThreadHandler().postDelayed(new MessagePBElemDecoder.1(this), 1000L);
            }
            if (!paramList1.isEmpty())
            {
              parambbku = (MessageRecord)paramList1.get(0);
              parambbku.extLong |= 0x1;
              ...
              if (m != 0)
              {
                ...
                label1132:
                parambbku.saveExtInfoToExtStr("gdt_singleAd", paramStringBuilder);
                parambbku = (MessageRecord)paramList1.get(0);
                if (i2 == 0) {
                  break label1591;
                }
                paramStringBuilder = "1";
                parambbku.saveExtInfoToExtStr("gdt_mulAd", paramStringBuilder);
                parambbku = (MessageRecord)paramList1.get(0);
                if (k == 0) {
                  break label1598;
                }
                paramStringBuilder = "1";
                parambbku.saveExtInfoToExtStr("gdt_followAd", paramStringBuilder);
  ...
  public void a(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bbku parambbku, boolean paramBoolean)
  {
    int i = 0;
    im_msg_body.Elem localElem = null;
    ArrayList localArrayList = new ArrayList();
    ...
    if (localIterator.hasNext())
    {
      ...
      if (localElem.market_face.has())
      {
        ...
        {
          a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, localArrayList, paramList1, paramStringBuilder, paramMsg, parambbku, paramBoolean);
      ...
      for (;;)
      {
        for (;;)
        {
          ...
          if ((i != 0) && (localElem.text.has()) && (paramList != null))
          {
            ...
            try
            {
              ((MessageRecord)paramList1.get(paramList1.size() - 1)).msgData = ammq.a(paramList);
              if (QLog.isColorLevel()) {
  ...
  public void a(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      localObject = (MessageForShakeWindow)ayvw.a(-2020);
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if ((paramStringBuilder.uint32_sys_head_id.has()) && (paramStringBuilder.uint32_head_flag.has()))
          {
            ...
            paramList = (ammg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(199);
  ...
  public void a(im_msg_body.Elem paramElem, im_msg_body.CustomFace paramCustomFace, List<MessageRecord> paramList, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, boolean paramBoolean, bbku parambbku)
  {
    if (paramElem != null) {}
    for (boolean bool1 = paramElem.hc_flash_pic.has();; bool1 = false)
    {
      ...
      for (boolean bool2 = true;; bool2 = false)
      {
        ...
        if (paramBoolean)
        {
          ...
          azmz.a(BaseApplication.getContext()).a(paramCustomFace, "actMessageEvent", false, 0L, 0L, paramElem, "");
          if (QLog.isColorLevel()) {
        ...
        {
          localObject1 = (MessageForText)ayvw.a(-1000);
        ...
        bdcv.a((byte[])localObject1);
        bdcv.a((byte[])localObject3);
        int i3 = paramCustomFace.uint32_origin.get();
        localObject3 = batv.a(paramElem, 0L, 1, false, paramElem, (String)localObject2, "picplatform", str3, str4, str1, str2, i3, 0);
        localObject1 = new RichMsg.PicRec();
        ((RichMsg.PicRec)localObject1).localPath.set(paramElem);
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            try
            {
              ...
              {
                paramElem = (MessageForPic)ayvw.a(-5015);
                ...
                paramElem.istroop = 1;
                paramCustomFace = (bcfr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(223);
                if (paramCustomFace != null) {
                  paramCustomFace.a((bcgf)paramElem, false);
                }
                i = 1;
                if (i == 0)
                {
                ...
                if (bool1) {
                  alpw.a(paramElem, false);
                }
                if (bool2) {
                  alnp.a(paramElem, false);
                }
                if (parambbku != null) {
                  paramElem.istroop = parambbku.jdField_a_of_type_Int;
                }
                paramElem.msgData = ((RichMsg.PicRec)localObject1).toByteArray();
                paramElem.parse();
                paramList.add(paramElem);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          paramList1 = (bcfr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(223);
          if (paramList1 != null) {
  ...
  public void b(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder)
  {
    ...
    for (;;)
    {
      ...
      paramList = (MessageForLightVideo)ayvw.a(-2071);
      paramList.msgtype = -2071;
      paramList.msgData = localVideoFile.toByteArray();
      paramList.msg = BaseApplication.getContext().getString(2131691347);
      paramList.parse();
      paramList1.add(paramList);
      if (!QLog.isColorLevel()) {
        break;
  ...
  public void b(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg)
  {
    ...
    for (;;)
    {
        ...
        do
        {
          do
          {
            ...
            default: 
              return;
            case 3: 
              paramList = BaseApplication.getContext().getString(2131695013);
              paramStringBuilder = (MessageForText)ayvw.a(-1000);
          ...
          i = bdlr.a((byte[])localObject3, 1);
          j = localObject3[3];
          localObject2 = new byte[i - 1];
          bdlr.a((byte[])localObject2, 0, (byte[])localObject3, 4, i - 1);
      ...
      paramMsg = (MessageForPubAccount)ayvw.a(-3006);
      ...
      for (;;)
      {
        for (;;)
        {
          ...
          for (;;)
          {
            ...
            int i1 = bdlr.a(localStringBuilder, i + 1);
            j = k - (i1 + 3);
            k = i1 + 3 + i;
            if (n != 1)
            {
            ...
            else
            {
              ...
              bdlr.a(paramList, 0, localStringBuilder, i + 3, i1);
          ...
          try
          {
            ...
            paramStringBuilder.dspFileName = arni.a(paramStringBuilder.dspFileName);
            paramStringBuilder.dspFileSize = new String(((ByteStringMicro)paramList.rpt_bytes_abstact.get(0)).toByteArray());
            bcif.a(paramMsg.msg_head.group_info.group_code.get()).a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app, paramStringBuilder.fileUrl, paramStringBuilder);
            ...
            if (paramList != null)
            {
              ...
              localObject2 = (MessageForTroopFile)ayvw.a(-2017);
              ((MessageForTroopFile)localObject2).msgtype = -2017;
              ((MessageForTroopFile)localObject2).msg = alpo.a(2131707032);
            }
          }
          catch (Exception localException1)
          {
            try
            {
              ((MessageForTroopFile)localObject2).msgData = ammq.a(paramStringBuilder);
  ...
  public void b(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bbku parambbku)
  {
    int j = 0;
    Object localObject1 = null;
    ...
    for (;;)
    {
      ...
      for (int i = ((im_msg_body.CommonElem)localObject1).uint32_business_type.get();; i = 0)
      {
        ...
        try
        {
          ...
          {
            g(paramList, paramList1, paramStringBuilder, paramMsg, parambbku);
            return;
          }
        }
        catch (InvalidProtocolBufferMicroException paramList)
        ...
        localObject1 = null;
        localObject2 = azsd.a((byte[])localObject2, -1);
        if (localObject2 != null)
        {
          ...
          if (i > 0)
          {
            ...
            localObject3 = (MessageForArkFlashChat)ayvw.a(-5013);
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          try
          {
            ...
            f1 = f2;
            i2 = i5;
            localArrayList.add(Long.valueOf(bdal.a(((Integer)localIterator.next()).intValue())));
            continue;
          ...
          localApolloMessage.peer_uin = bdal.a(localApolloActMsg.uint32_peer_uin.get());
          localApolloMessage.sender_ts = bdal.a(localApolloActMsg.uint32_sender_ts.get());
          localApolloMessage.peer_ts = bdal.a(localApolloActMsg.uint32_peer_ts.get());
  ...
  public void c(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder)
  {
    ...
    for (;;)
    {
      ...
      localObject1 = azqu.a(((im_msg_body.MarketTrans)localObject1).bytes_xml.get().toByteArray(), i);
      if (localObject1 == null)
      {
        if (QLog.isColorLevel()) {
          paramStringBuilder.append("c2cMsgContent.data:null;\n");
      ...
      paramList = (MessageForStructing)ayvw.a(-2011);
  ...
  public void c(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg)
  {
    ...
    for (paramList = (im_msg_body.CommonElem)paramMsg.common_elem.get();; paramList = null)
    {
      ...
      {
        paramStringBuilder.mergeFrom(paramList.bytes_pb_elem.get().toByteArray());
        paramList = (MessageForScribble)ayvw.a(-7001);
  ...
  public void c(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bbku parambbku)
  {
    Object localObject1 = null;
    Object localObject2 = paramList.iterator();
    Object localObject3;
    ...
    if (((hummer_commelem.MsgElemInfo_servtype19)localObject2).bytes_data.has())
    {
      ...
      if (localObject2 != null)
      {
        ...
        if (i > 0)
        {
          ...
          localObject3 = (MessageForArkBabyqReply)ayvw.a(-5016);
  ...
  public void d(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder)
  {
    ...
    do
    {
      ...
      localMessageForIncompatibleGrayTips = (MessageForIncompatibleGrayTips)ayvw.a(-5002);
  ...
  public void d(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bbku parambbku)
  {
    Object localObject2 = null;
    Object localObject1 = null;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          {
            return;
            paramList = (MessageForText)ayvw.a(-1000);
            paramList.msgtype = -1000;
            paramList.msg = BaseApplication.getContext().getString(2131693912);
            paramList1.add(paramList);
            return;
            if (ArkAppCenter.b())
            {
            ...
            localObject4 = (MessageForArkApp)ayvw.a(-5008);
  ...
  public void e(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder)
  {
    ...
    for (paramList = (im_msg_body.CommonElem)localElem.common_elem.get();; paramList = null)
    {
      ...
      {
        paramStringBuilder.mergeFrom(paramList.bytes_pb_elem.get().toByteArray());
        paramList = (MessageForQQStoryComment)ayvw.a(-2052);
  ...
  public void e(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bbku parambbku)
  {
    Object localObject2 = null;
    Object localObject3 = paramList.iterator();
    Object localObject1 = null;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localObject3 = azsd.a((byte[])localObject3, -1);
        if (localObject3 != null)
        {
  ...
  public void f(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bbku parambbku)
  {
    ...
    for (localObject1 = (im_msg_body.QQWalletMsg)((im_msg_body.Elem)localObject2).qqwallet_msg.get();; localObject1 = null)
    {
      ...
      if (n > 2000)
      {
        ...
        localMessageForQQWalletMsg = (MessageForQQWalletMsg)ayvw.a(-2025);
        localMessageForQQWalletMsg.msgtype = -2025;
      ...
      for (int i = 1;; i = 0)
      {
        for (;;)
        {
          if ((i != 0) && (parambbku != null) && (parambbku.c != null))
          {
            parambbku.c.a(paramMsg.msg_head.msg_seq.get(), localMessageForQQWalletMsg.msgseq);
            localMessageForQQWalletMsg.mMessageInfo = parambbku;
          }
          label563:
          label583:
          Object localObject4;
          if ((n == 6) || (n == 13) || (n == 15) || (n == 18) || (n == 19) || (n == 21) || (n == 22) || (n == 23) || (n == 24))
          {
            ...
            localObject2 = (aipw)this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.getManager(125);
            if (localObject2 != null) {
          ...
          try
          {
            ...
            ((aipw)localObject2).a((im_msg_body.QQWalletAioBody)((im_msg_body.QQWalletMsg)localObject1).aio_body.get(), j, l, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_time.get(), i, (String)localObject3, ((JSONObject)localObject4).toString());
            label882:
            localMessageForQQWalletMsg.msg = localMessageForQQWalletMsg.getMsgSummary();
            localMessageForQQWalletMsg.msgData = localMessageForQQWalletMsg.getBytes();
        ...
        for (localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.getCurrentAccountUin();; localObject2 = "")
        {
          if ((n == 10) && (localMessageForQQWalletMsg.mQQWalletTransferMsg.elem != null) && (!TextUtils.isEmpty(localMessageForQQWalletMsg.mQQWalletTransferMsg.elem.nativeAndroid)))
          {
            ...
            {
              aiqr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)((HashMap)localObject3).get("tokenid"), ((im_msg_body.QQWalletMsg)localObject1).aio_body.uint64_senduin.get());
              if ((l == 0L) || (TextUtils.isEmpty((CharSequence)localObject2)) || (((String)localObject2).compareTo("" + l) == 0)) {
                break;
              }
              azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "friendpay.payaio.buyershow", 0, 0, "", "", "", "");
              break;
            }
          }
          ...
          azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "friendpay.askaio.payershow", 0, 0, "", "", "", "");
          break label882;
          label1556:
          ...
          if (paramList1.isEmpty())
          {
            i(paramList, paramList1, paramStringBuilder, paramMsg, parambbku);
            return;
          }
          paramList1.add(localMessageForQQWalletMsg);
          return;
    ...
    for (;;)
    {
      ...
      for (paramList = new hummer_commelem.MsgElemInfo_servtype16();; paramList = ((im_msg_body.Text)localObject).str.get().toStringUtf8()) {
        try
        {
          ...
          paramStringBuilder = (MessageForTroopStory)ayvw.a(-2057);
  ...
  public void g(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bbku parambbku)
  {
    if (QLog.isColorLevel()) {
        ...
        for (localObject4 = (im_msg_body.Text)((im_msg_body.Elem)localObject6).text.get();; localObject4 = localObject5)
        {
          ...
          for (localObject1 = ((im_msg_body.RichMsg)localObject3).bytes_template_1.get().toByteArray();; localObject2 = null)
          {
            ...
            for (localObject7 = ((ByteStringMicro)localObject3).toStringUtf8();; localObject7 = "")
            {
              ...
              {
                if ((!bdje.a((String)localObject6)) && (!bdje.a((String)localObject3)) && (!bdje.a((String)localObject7)))
                {
                ...
                for (boolean bool = true;; bool = false) {
                  for (;;)
                  {
                    localObject3 = ayvu.a(paramMsg, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
                    if ((((aywa)localObject3).jdField_a_of_type_Int == 1008) && (QLog.isColorLevel()))
                    {
                    ...
                    try
                    {
                      ...
                      localObject8 = bdal.a((byte[])localObject6);
                      if (QLog.isColorLevel()) {
                      ...
                      ((aljv)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(53)).a((byte[])localObject6);
                      if (bool)
                      {
                        if (QLog.isColorLevel()) {
                          QLog.d("DecodeMsg", 2, "begin getEmptyGeneralStructMsg");
                        }
                        localMessageForStructing.structingMsg = ((StructMsgForGeneralShare)azqu.a());
                    ...
                    catch (Exception localException2)
                    {
                      for (;;)
                      {
                        if (QLog.isColorLevel())
                        {
                          ...
                          {
                            if ((((aywa)localObject3).jdField_a_of_type_Int == 1008) && (!TextUtils.isEmpty((CharSequence)localObject7)))
                            {
                              if (QLog.isColorLevel()) {
                          ...
                          else
                          {
                            ...
                            localObject3 = bdkd.a((byte[])localObject1, (im_msg_body.GeneralFlags)localObject4, -1);
                            if (localObject3 != null) {
                              i = 0;
                            }
                            for (;;)
                            {
                              localMessageForStructing.structingMsg = azqu.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app, m, l2, (byte[])localObject3, i);
                              localObject1 = localObject3;
                              if (!QLog.isColorLevel()) {
                                break label917;
                              }
                              ...
                              {
                                paramList = (MessageForTroopFee)ayvw.a(-2036);
                              ...
                              {
                                if (QLog.isColorLevel()) {
                                  QLog.d(alsy.class.getSimpleName(), 2, "Received flower message");
                                }
                              ...
                              {
                                if (QLog.isColorLevel()) {
                                  QLog.i(alsy.class.getSimpleName(), 2, "decodePBMsgElems, groupCode:" + l2);
                                }
                                l3 = l1;
                                if (l2 <= 0L)
                                {
                                  ...
                                  paramList1.add(((alsy)this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.getManager(124)).a(Long.toString(l1), Long.toString(l2), localMessageForStructing.istroop, localMessageForStructing.structingMsg));
                                  l3 = l1;
                                }
                                do
                                {
                                  for (;;)
                                  {
                                    ...
                                    if ((localMessageForStructing.structingMsg.mMsgServiceID == 80) && ((localMessageForStructing.structingMsg instanceof StructMsgForGeneralShare)))
                                    {
                                      if (uhl.i())
                                      {
                                        paramList = (MessageForQQStory)ayvw.a(-2051);
                                      ...
                                      if (localObject5 != null)
                                      {
                                        ((im_msg_body.Text)localObject5).str.set(ByteStringMicro.copyFromUtf8(uhl.a()));
                                        return;
                                      }
                                      l3 = l1;
                                      if (QLog.isColorLevel())
                                    ...
                                    else
                                    {
                                      ...
                                      {
                                        paramList = (MessageForTribeShortVideo)ayvw.a(-7002);
                                      ...
                                      {
                                        paramList = (MessageForTroopPobing)ayvw.a(-2059);
                                        ...
                                        try
                                        {
                                          ...
                                          paramList1.add(paramList);
                                          localMessageForStructing.structingMsg = null;
                                          new azmo(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_AIO").c("newman_join").d("exp_obj").a(new String[] { l2 + "" }).a();
                                          new azmo(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_AIO").c("newman_join").d("exp_welcome").a(new String[] { l2 + "", "", "" + bclo.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l2)) }).a();
                                          return;
                                        }
                                      ...
                                      {
                                        paramList = (MessageForTroopSign)ayvw.a(-2054);
                                      ...
                                      if (localMessageForStructing.structingMsg.mMsgServiceID != 43)
                                      {
                                        ...
                                        else
                                        {
                                          ...
                                          if ((localMessageForStructing.structingMsg instanceof StructMsgForGeneralShare))
                                          {
                                            ...
                                            bcdy.a().a((String)localObject3, null);
                                            bcdy.a().a(((StructMsgForGeneralShare)localObject2).atMembers);
                                            l3 = l1;
                                          }
                                        }
                                      }
                                ...
                                {
                                  parambbku = new generalflags.ResvAttr();
                                  parambbku.mergeFrom(((im_msg_body.GeneralFlags)localObject4).bytes_pb_reserve.get().toByteArray());
                                  paramStringBuilder = paramMsg;
                                  j = m;
                                  if (parambbku.bytes_kpl_info.has())
                                  {
                                    paramStringBuilder = paramMsg;
                                    j = m;
                                    if (parambbku.bytes_kpl_info.has())
                                    {
                                      j = 1;
                                      paramStringBuilder = parambbku.bytes_kpl_info.get().toStringUtf8();
                                    }
                                  }
                                  paramList = paramStringBuilder;
                                  i = j;
                                  if (parambbku.bytes_oac_msg_extend.has())
                                  {
                                    localMessageForStructing.saveExtInfoToExtStr("report_key_bytes_oac_msg_extend", parambbku.bytes_oac_msg_extend.get().toStringUtf8());
                                    i = j;
                                    paramList = paramStringBuilder;
                                  }
                                }
                                ...
                                if (k != 0)
                                {
                                  ...
                                  try
                                  {
                                    ...
                                    {
                                      paramList = (ChatMessage)ayvw.a(-1051);
                                      ...
                                      if (paramStringBuilder != null)
                                      {
                                        ...
                                        for (;;)
                                        {
                                          if (paramStringBuilder.hasNext())
                                          {
                                            paramMsg = (azqj)paramStringBuilder.next();
                                            if ((paramMsg instanceof azqk))
                                            {
                                              paramMsg = ((azqk)paramMsg).jdField_a_of_type_JavaUtilArrayList;
                                              if (paramMsg != null)
                                              {
                                                paramMsg = paramMsg.iterator();
                                                if (paramMsg.hasNext())
                                                {
                                                  parambbku = (azqj)paramMsg.next();
                                                  if (!(parambbku instanceof StructMsgItemTitle)) {
                                                    break;
                                                  }
                                                  paramList.msg = ((StructMsgItemTitle)parambbku).b();
                                                  if (QLog.isDevelopLevel())
                                                  {
  ...
  public void h(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bbku parambbku)
  {
    Object localObject2 = null;
    ...
    for (localObject1 = (im_msg_body.GeneralFlags)((im_msg_body.Elem)localObject7).general_flags.get();; localObject1 = localObject2)
    {
      ...
      localObject1 = null;
      int i = 0;
      localObject7 = (MessageForPubAccount)ayvw.a(-3006);
      ...
      for (;;)
      {
        ...
        if (((im_msg_body.Elem)localObject3).trans_elem_info.has())
        {
          ...
          if (localObject3[0] == 1)
          {
            ...
            bdlr.a((byte[])localObject6, 0, (byte[])localObject3, 4, i - 1);
  ...
  public void i(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bbku parambbku)
  {
    String str = null;
    int k = 0;
    Object localObject1 = paramList.iterator();
    ...
    if (((Iterator)localObject1).hasNext())
    {
      ...
      {
        str = bdcv.a(localElem.text.str.get().toByteArray());
        label264:
        n = k;
        if (localElem.text.has())
        {
    ...
    for (;;)
    {
      ...
      break label264;
      Object localObject2 = null;
      localObject1 = new ayvt();
      ArrayList localArrayList1 = ((ayvt)localObject1).jdField_a_of_type_JavaUtilArrayList;
      ArrayList localArrayList2 = new ArrayList(2);
      Object localObject3 = a(null, paramList, paramStringBuilder, paramMsg.msg_head.msg_seq.get(), parambbku, (ayvt)localObject1, localArrayList2);
      localObject1 = localObject2;
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (localGeneralFlags.uint32_prp_fold.get() == 1)
          {
            ...
            bool1 = aipw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
            if ((j == 0) || (!aipw.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app))) {
              break label1894;
            }
            ...
            bool1 = true;
            if (QLog.isColorLevel()) {
              QLog.d("msgFold", 2, String.format("Recv, recv foldMsg, redBagSender: %s, foldFlag: %s, redBagId: %s, index: %s, foldSwitch: %s, isValidFoldMsg: %s", new Object[] { Long.valueOf(l1), Boolean.valueOf(bool2), paramList, paramStringBuilder, Boolean.valueOf(aipw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)), Boolean.valueOf(bool1) }));
            }
            ...
            parambbku = new MessageForFoldMsg();
            ((MessageForFoldMsg)parambbku).init(bool1, paramList, paramStringBuilder, l1, true);
            paramList = parambbku;
        ...
        {
          paramStringBuilder = localGeneralFlags.babyq_guide_msg_cookie.get().toByteArray();
          paramMsg = bdal.a(paramStringBuilder);
          if (QLog.isColorLevel()) {
        ...
        {
          parambbku = new generalflags.ResvAttr();
          parambbku.mergeFrom(localGeneralFlags.bytes_pb_reserve.get().toByteArray());
          paramStringBuilder = paramMsg;
          i = j;
          if (parambbku.bytes_kpl_info.has())
          {
        ...
        if ((!TextUtils.isEmpty(paramStringBuilder)) && (bool1))
        {
          ...
          {
            paramList = (ChatMessage)ayvw.a(-1000);
            if ((parambbku != null) && (localArrayList2 != null)) {
              bceh.a(parambbku.jdField_a_of_type_Int, localArrayList2, paramList);
            }
            if (localArrayList1.size() > 0)
            {
              paramStringBuilder = new ArrayList(localArrayList1.size());
              parambbku = localArrayList1.iterator();
              while (parambbku.hasNext())
              {
                localObject2 = parambbku.next();
  ...
  public void j(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder)
  {
    ...
    for (;;)
    {
      ...
      {
        paramStringBuilder.mergeFrom(paramList.bytes_pb_elem.get().toByteArray());
        localMessageForLimitChatConfirm = (MessageForLimitChatConfirm)ayvw.a(-7005);
