...
public class apfy
{
  public static int a(String paramString)
  {
    try
    {
      int i = apga.a("arfeature", "v8.0.0", apga.b("arfeature", "v8.0.0", "arfeature"), paramString);
      return i;
    }
    finally
    {
  ...
  public static int a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        apga.a("arfeature", "v8.0.0", "arfeature", paramString2);
        try
        {
          apfw.a(paramString1, apga.a("arfeature", "v8.0.0", apga.b("arfeature", "v8.0.0", "arfeature")));
          paramString2 = apga.a("arfeature", "v8.0.0", apga.b("arfeature", "v8.0.0", "arfeature")) + File.separator + "md5_config.xml";
        ...
        catch (IOException paramString2)
        {
          ...
          String str;
          i = -6;
          FileUtils.delete(apga.a("arfeature", "v8.0.0", apga.b("arfeature", "v8.0.0", "arfeature")), false);
      ...
      try
      {
        ...
        {
          paramString1 = apga.a("arfeature", "v8.0.0", apga.b("arfeature", "v8.0.0", "arfeature")) + File.separator + (String)((Map.Entry)localObject).getKey() + ".so";
          apga.a("arfeature", "v8.0.0", "libARFeature", (String)((Map.Entry)localObject).getValue());
        }
  ...
  {
    return new File(apga.a("arfeature", "v8.0.0", apga.b("arfeature", "v8.0.0", "arfeature")) + File.separator + "libARFeature" + ".so").exists();
  }
}
