  ...
  implements VComponentAdapter
{
  ...
  {
    if ((paramImageAction == null) || (paramImageAction.getTarget() == null) || (paramURLDrawable == null) || (!bhnv.g(paramImageAction.getTarget().getContext()))) {}
    do
    {
      return;
  ...
  private void a(ImageAction paramImageAction, String paramString, int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    paramString.setURLDrawableListener(new tdh(this, paramBoolean1, paramImageAction));
  }
      ...
      if (paramString.contains("item_image_width"))
      {
        ...
        if ((!TextUtils.isEmpty((CharSequence)localObject1)) && (!TextUtils.isEmpty(str))) {
          try
          {
            ...
            localObject1 = new suo();
            ((suo)localObject1).jdField_a_of_type_JavaNetURL = new URL((String)localObject2);
            ((suo)localObject1).jdField_a_of_type_Int = i;
            ((suo)localObject1).b = j;
            localObject2 = sun.a().a((suo)localObject1);
            if ((localObject2 != null) && (((suk)localObject2).a() != null))
            {
              localObject1 = null;
              if (paramBoolean)
              {
              ...
              paramImageAction.onSuccess(((suk)localObject2).a(), paramString, (Bundle)localObject1);
              return true;
            }
          }
  ...
  {
    PullRefreshHeader localPullRefreshHeader = (PullRefreshHeader)LayoutInflater.from(paramVRefreshLayout.getContext()).inflate(2131562797, paramVRefreshLayout, false);
    RefreshAnimView localRefreshAnimView = (RefreshAnimView)localPullRefreshHeader.findViewById(2131376436);
    paramVRefreshLayout.addView(localPullRefreshHeader);
    paramVRefreshLayout.setonRefreshStateChangeListener(new tdg(this, localRefreshAnimView, paramVRefreshLayout));
  }
  
  public void onClick(View paramView, Object paramObject)
  {
    thz.a(paramView, paramObject);
  }
  ...
  public CharSequence setEmoticonText(@NonNull CharSequence paramCharSequence, int paramInt)
  {
    ...
    try
    {
      paramCharSequence = new begp(a(paramCharSequence.toString()), 2, paramInt * 2 / 3);
