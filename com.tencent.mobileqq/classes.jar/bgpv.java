...
public class bgpv
{
  ...
  public azvp a;
  private bgpy jdField_a_of_type_Bgpy;
  ...
  private MqqHandler jdField_a_of_type_MqqOsMqqHandler = new bgpw(this);
  public boolean a;
  ...
  public bgpv(RegisterNewBaseActivity paramRegisterNewBaseActivity, View paramView, int paramInt)
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity = paramRegisterNewBaseActivity;
    this.jdField_a_of_type_Bgpz = new bgpz(paramRegisterNewBaseActivity, this);
    this.jdField_a_of_type_AndroidViewView = paramView;
    this.jdField_a_of_type_ComTencentWidgetScrollView = ((ScrollView)this.jdField_a_of_type_AndroidViewView.findViewById(2131376699));
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131380897));
  ...
  public static void a(Context paramContext, boolean paramBoolean, String paramString1, String paramString2, Intent paramIntent)
  {
    ...
    if (jdField_a_of_type_Int == 1)
    {
      ...
      for (str = "1";; str = "2")
      {
        bcef.a(null, "new_reg", "setting_page_yes", "result", "", 1, "", "", str, "", "", "", "", "", "");
    ...
    {
      bcef.a(null, "new_reg", "setting_page_no", "result", "", 1, "", "", str, "", "", "", "", "", "");
      break;
    }
    label211:
    if (bool) {
  ...
  public static void a(String paramString, Intent paramIntent)
  {
    ...
    try
    {
      ...
      if (paramIntent.hasExtra("phonenum")) {
        localStringBuilder.append("phoneNum: ").append(bfxb.a(paramIntent.getStringExtra("phonenum"))).append("\r\n");
      }
  ...
  private void e()
  {
    ...
    if (jdField_a_of_type_Int == 1)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131363937));
      this.jdField_a_of_type_AndroidWidgetButton.setText(2131716109);
      ...
      ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131372268)).setVisibility(0);
      localClearableEditText1 = (ClearableEditText)this.jdField_a_of_type_AndroidViewView.findViewById(2131371795);
      ClearableEditText localClearableEditText2 = (ClearableEditText)this.jdField_a_of_type_AndroidViewView.findViewById(2131372267);
      ...
      this.jdField_a_of_type_AndroidWidgetFrameLayout.addView(this.jdField_a_of_type_Bgpz.a(new bgqd(localIntent)));
    }
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131363838));
      break;
      label375:
      if (jdField_a_of_type_Int != 2) {
        break label250;
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Azvp = new azvp(this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity);
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      this.jdField_a_of_type_Azvp.a(localIntent);
  ...
  public void b()
  {
    ...
    {
      if (this.jdField_a_of_type_Bgpy != null) {
        this.jdField_a_of_type_AndroidWidgetFrameLayout.removeOnLayoutChangeListener(this.jdField_a_of_type_Bgpy);
      }
      this.jdField_a_of_type_Bgpy = null;
      this.jdField_a_of_type_AndroidWidgetFrameLayout.removeAllViews();
    }
  }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if ((i == 0) && (paramBoolean))
      {
        this.jdField_a_of_type_Bgpz.a().a(true);
        return;
      }
      if (i == 0)
      {
        this.jdField_a_of_type_Bgpz.a().a(false);
        return;
      }
    ...
    this.jdField_a_of_type_AndroidViewView.findViewById(2131374547).getLocationOnScreen(arrayOfInt);
    j = arrayOfInt[1];
    this.jdField_a_of_type_AndroidViewView.findViewById(2131371795).getLocationOnScreen(arrayOfInt);
    int k = arrayOfInt[1];
    ...
    this.jdField_a_of_type_AndroidWidgetFrameLayout.addView(this.jdField_a_of_type_Bgpz.a());
    if (QLog.isColorLevel()) {
      QLog.i(jdField_a_of_type_JavaLangString, 2, String.format(Locale.getDefault(), "miniHeight: %d", new Object[] { Integer.valueOf(i) }));
    }
    if (this.jdField_a_of_type_Bgpy == null) {
      this.jdField_a_of_type_Bgpy = new bgpy(this.jdField_a_of_type_ComTencentWidgetScrollView, this.jdField_b_of_type_Int, null);
    }
    this.jdField_a_of_type_AndroidWidgetFrameLayout.addOnLayoutChangeListener(this.jdField_a_of_type_Bgpy);
  }
  
  public void c()
  {
    if (jdField_a_of_type_Int == 1) {
      bcef.a(null, "new_reg", "setting_page_yes", "lianghao_clk", "", 1, "");
    }
    while (jdField_a_of_type_Int != 2) {
      return;
    }
    bcef.a(null, "new_reg", "setting_page_no", "lianghao_clk", "", 1, "");
  }
