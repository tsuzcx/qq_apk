...
public final class bgpv
{
  ...
  static ContentValues a(aukm paramaukm, String paramString)
  {
    ContentValues localContentValues = new ContentValues();
    Iterator localIterator = a(paramaukm).iterator();
    while (localIterator.hasNext())
    {
      ...
      try
      {
        ...
        if ((localObject1 instanceof aukm)) {
          localContentValues.putAll(a((aukm)localObject1, str + "."));
        }
      }
  ...
  private static ContentValues a(List<aukm> paramList, String paramString)
  {
    ContentValues localContentValues = new ContentValues();
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      {
        localContentValues.put(paramString + i + ".-", ((aukm)paramList.get(i)).getClass().getName());
        localContentValues.putAll(a((aukm)paramList.get(i), paramString + i + "."));
        i += 1;
      }
    }
    return localContentValues;
  ...
  public static aukm a(ContentValues paramContentValues, String paramString)
  {
    return a(paramContentValues, paramString, "");
  }
  
  private static aukm a(ContentValues paramContentValues, String paramString1, String paramString2)
  {
    try
    {
      aukm localaukm = (aukm)Class.forName(paramString1).newInstance();
      paramString1 = localaukm;
      if (localaukm != null)
      {
        paramString1 = a(localaukm).iterator();
        while (paramString1.hasNext())
        {
          ...
          else if (localObject2 == List.class)
          {
            ...
            localField.set(localaukm, localObject2);
          }
          else if (localObject2 == Long.TYPE)
          {
            localField.set(localaukm, paramContentValues.getAsLong((String)localObject1));
          }
          else if (localObject2 == Integer.TYPE)
          {
            localField.set(localaukm, paramContentValues.getAsInteger((String)localObject1));
          }
          else if (localObject2 == String.class)
          {
            localField.set(localaukm, paramContentValues.getAsString((String)localObject1));
          }
          else if (localObject2 == Byte.TYPE)
          {
            localField.set(localaukm, paramContentValues.getAsByte((String)localObject1));
          }
          else if (localObject2 == [B.class)
          {
            localField.set(localaukm, paramContentValues.getAsByteArray((String)localObject1));
          }
          else if (localObject2 == Short.TYPE)
          {
            localField.set(localaukm, paramContentValues.getAsShort((String)localObject1));
          }
          else if (localObject2 == Boolean.TYPE)
          {
            localField.set(localaukm, paramContentValues.getAsBoolean((String)localObject1));
          }
          else if (localObject2 == Float.TYPE)
          {
            localField.set(localaukm, paramContentValues.getAsFloat((String)localObject1));
          }
          else if (localObject2 == Double.TYPE)
          {
            localField.set(localaukm, paramContentValues.getAsDouble((String)localObject1));
          }
        }
        if (localaukm.getId() != -1L)
        {
  ...
  public static axwt a(StructMsgForImageShare paramStructMsgForImageShare)
  {
    if (paramStructMsgForImageShare.getItemCount() > 0)
    {
      paramStructMsgForImageShare = paramStructMsgForImageShare.getItemByIndex(0);
      if ((paramStructMsgForImageShare instanceof axym))
      {
        paramStructMsgForImageShare = (axym)paramStructMsgForImageShare;
        if ((paramStructMsgForImageShare.a.size() > 0) && ((paramStructMsgForImageShare.a.get(0) instanceof axwt))) {
          return (axwt)paramStructMsgForImageShare.a.get(0);
        }
      }
    }
    return null;
  ...
  public static bgpq a(byte[] paramArrayOfByte)
  {
    if ((paramArrayOfByte == null) || (paramArrayOfByte.length <= 16)) {
      return null;
    }
    ...
    if ((localObject2 instanceof ChatMessage))
    {
      if ((localObject2 instanceof MessageForStructing))
      {
        ...
        {
          localObject1 = axuy.a((byte[])localObject1);
          ((MessageForStructing)localObject2).structingMsg = ((AbsStructMsg)localObject1);
        }
        return new bgpq((ChatMessage)localObject2, paramArrayOfByte);
      }
      return new bgpq((ChatMessage)localObject2, paramArrayOfByte);
    }
    return null;
  ...
  private static List<Field> a(aukm paramaukm)
  {
    Class localClass = paramaukm.getClass();
    Object localObject1 = (List)a.get(localClass);
    paramaukm = (aukm)localObject1;
    if (localObject1 == null)
    {
      paramaukm = new ArrayList();
      ...
      a.put(localClass.getName(), paramaukm);
    }
    return paramaukm;
  }
  
  public static List<bgpp> a(List<byte[]> paramList)
  {
    if ((paramList == null) || (paramList.size() == 0)) {
      return null;
    }
    ...
    while (paramList.hasNext())
    {
      ...
      if (l1 != 2L)
      {
        ...
        if (l1 == 1L)
        {
          ...
          if (localObject != null) {
            localArrayList.add(new bgpp(l2, l1, ((bgpq)localObject).jdField_a_of_type_ComTencentMobileqqDataChatMessage, ((bgpq)localObject).jdField_a_of_type_JavaLangString));
        ...
        else if (l1 == 3L)
        {
          ...
          localObject = a((byte[])localObject);
          if (localObject != null) {
            localArrayList.add(new bgpp(l2, l1, (ContentValues)localObject));
          }
        }
      }
    }
  ...
  public static void a(long paramLong, List<bgpp> paramList1, List<bgpp> paramList2)
  {
    ...
    for (;;)
    {
      ...
      {
        bgpp localbgpp = (bgpp)paramList1.next();
        if (localbgpp.b == paramLong) {
          paramList2.add(localbgpp);
        }
      }
    }
  }
  ...
  {
    bcpw.a(paramContext, paramInt2, paramInt1, 2000).b(paramContext.getResources().getDimensionPixelSize(2131298865) - (int)bbdh.a(paramContext, 5.0F));
  }
  
  public static void a(Context paramContext, String paramString, int paramInt)
  {
    bcpw.a(paramContext, paramInt, paramString, 2000).b(paramContext.getResources().getDimensionPixelSize(2131298865) - (int)bbdh.a(paramContext, 5.0F));
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageForStructing paramMessageForStructing, List<ChatMessage> paramList, Map<String, String> paramMap, ArrayList<byte[]> paramArrayList)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramList = (String)paramMap.get(akpy.c(localChatMessage));
        ...
        continue;
        paramList = asty.a().a(paramQQAppInterface, paramMessageForStructing.uniseq);
      }
  ...
  public static boolean a(Activity paramActivity)
  {
    if (!bbay.a())
    {
      a(paramActivity, 2131693956, 1);
      return false;
    }
    if (bbay.a() < 500L)
    {
      a(paramActivity, 2131693955, 1);
      return false;
    }
    return true;
  }
  ...
  public static byte[] a(QQAppInterface paramQQAppInterface, long paramLong, ChatMessage paramChatMessage, String paramString)
  {
    ...
    if (TextUtils.isEmpty(paramString)) {
      str = adin.a(paramQQAppInterface, paramChatMessage);
    }
  ...
  public static String[] a(byte[] paramArrayOfByte)
  {
    ...
    //   864: astore 21
    //   866: aload 9
    //   868: invokestatic 869	bgpv:a	(Lorg/w3c/dom/Node;)Ljava/lang/String;
    //   871: astore 25
    //   873: aload 4
    //   875: astore 23
    //   877: aload 5
    ...
    //   1070: astore 21
    //   1072: aload 9
    //   1074: invokestatic 869	bgpv:a	(Lorg/w3c/dom/Node;)Ljava/lang/String;
    //   1077: astore 24
    //   1079: aload 4
    //   1081: astore 23
    //   1083: aload 5
  ...
  public static byte[] b(QQAppInterface paramQQAppInterface, long paramLong, ChatMessage paramChatMessage, String paramString)
  {
    ...
    if (((paramChatMessage instanceof MessageForTroopFile)) || ((paramChatMessage instanceof MessageForFile)))
    {
      ...
      localObject = adin.a(paramQQAppInterface, paramChatMessage);
      a((FileManagerEntity)localObject);
      if (localObject == null) {
        break label219;
      }
      localbgpd.a(paramQQAppInterface, null, (FileManagerEntity)localObject, paramChatMessage, true);
    }
    for (;;)
    {
      paramQQAppInterface = new ContentValues();
      localObject = (ContentValues)localbgpd.a().getExtras().getParcelable("fileContents");
      if (localObject != null) {
        paramQQAppInterface.put("fileContents", a((ContentValues)localObject));
      }
      localObject = akpy.c(paramChatMessage);
      ...
      localObject = apue.a(paramQQAppInterface, (MessageForFile)paramChatMessage);
      break;
      label219:
      label483:
      if (QLog.isColorLevel())
      {
        ...
        if ((paramChatMessage instanceof MessageForTroopFile))
        {
          ...
          {
            a((FileManagerEntity)localObject);
            adin.a((FileManagerEntity)localObject, localMessageForTroopFile);
            if (localObject == null) {
              break label483;
            }
            localbgpd.a(paramQQAppInterface, null, (FileManagerEntity)localObject, localMessageForTroopFile, true);
            break;
            if (QLog.isColorLevel()) {
              QLog.d("qqfav", 2, "parcelFileMsg, isMultiMsg T, find in db");
            }
            localObject = bakj.a(paramQQAppInterface, localMessageForTroopFile);
            if (localObject != null)
            {
              FileManagerEntity localFileManagerEntity = adin.a((azqt)localObject);
              localObject = bajk.a(paramQQAppInterface, ((azqt)localObject).b);
              if ((localObject != null) && (localFileManagerEntity != null) && (!TextUtils.isEmpty(localFileManagerEntity.strTroopFilePath)))
              {
                azpg localazpg = ((bajk)localObject).a(localFileManagerEntity.strTroopFilePath);
                localObject = localFileManagerEntity;
                if (localazpg != null)
                {
                  localFileManagerEntity.lastTime = localazpg.c;
                  localFileManagerEntity.selfUin = String.valueOf(localazpg.b);
                  localObject = localFileManagerEntity;
                }
              }
              else
