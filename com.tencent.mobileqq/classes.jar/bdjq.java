...
public class bdjq
{
  protected static bdjq a;
  
  private long a(SQLiteDatabase paramSQLiteDatabase, String paramString, bdjn parambdjn)
  {
    try
    {
      ContentValues localContentValues = new ContentValues();
      localContentValues.put("actiontype", parambdjn.c);
      localContentValues.put("appid", parambdjn.a);
      localContentValues.put("qua", parambdjn.e);
      localContentValues.put("uin", parambdjn.d);
      localContentValues.put("via", parambdjn.b);
      localContentValues.put("network", parambdjn.a());
      localContentValues.put("timestamp", parambdjn.g);
      localContentValues.put("expand1", parambdjn.h);
      localContentValues.put("expand2", parambdjn.i);
      localContentValues.put("expand3", parambdjn.j);
      localContentValues.put("expand4", parambdjn.k);
      localContentValues.put("expand5", parambdjn.l);
      long l1 = -1L;
      try
      {
      ...
      catch (SQLException paramSQLiteDatabase)
      {
        for (;;)
        {
          ...
          bdht.e("BusinessReport", paramSQLiteDatabase.getLocalizedMessage());
        }
      }
      return l1;
    }
  ...
  public int a(String paramString)
  {
    try
    {
      ...
      bdht.b("Jie", "new_table>>count=" + i);
      i += b("table_old_data", paramString);
      bdht.b("Jie", "all_table>>>count=" + i);
      return i;
    }
    finally
    {
  ...
  public int a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramString1)
      {
        ...
        localObject2 = localObject1;
        bdht.e("BusinessReport", paramString1.getLocalizedMessage());
      }
      finally
      {
  ...
  /* Error */
  public int a(String paramString, ArrayList<bdjn> paramArrayList)
  {
    // Byte code:
    //   0: iconst_0
    //   1: istore 4
    ...
    //   10: aload_0
    //   11: invokevirtual 143	bdjq:a	()Landroid/database/sqlite/SQLiteDatabase;
    //   14: astore 5
    //   16: aload 5
    //   18: ifnonnull +7 -> 25
    //   21: aload_0
    ...
    //   56: checkcast 21	bdjn
    //   59: invokespecial 189	bdjq:a	(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Lbdjn;)J
    //   62: pop2
    //   63: iload_3
    //   64: iconst_1
    //   65: iadd
    ...
    //   97: ldc 200
    //   99: aload_1
    //   100: invokestatic 203	bdht:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   103: aload 5
    ...
    //   0	144	2	paramArrayList	ArrayList<bdjn>
    //   4	91	3	i	int
    //   1	92	4	j	int
  ...
  public int a(ArrayList<bdjn> paramArrayList)
  {
    try
    {
  ...
  /* Error */
  public long a(String paramString, bdjn parambdjn)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   5: lstore 5
    //   7: aload_0
    //   8: invokevirtual 143	bdjq:a	()Landroid/database/sqlite/SQLiteDatabase;
    //   11: astore 7
    //   13: lload 5
    //   15: lstore_3
    //   16: aload 7
    ...
    //   24: aload_1
    //   25: aload_2
    //   26: invokespecial 189	bdjq:a	(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Lbdjn;)J
    //   29: lstore_3
    //   30: aload 7
    ...
    //   42: ldc 212
    //   44: aload_1
    //   45: invokestatic 203	bdht:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   48: aload 7
  ...
  protected SQLiteDatabase a()
  {
    try
    {
      SQLiteDatabase localSQLiteDatabase = bdjs.a(bcxm.a().a()).getWritableDatabase();
  ...
  public ArrayList<bdjn> a(String paramString)
  {
    try
    {
  ...
  /* Error */
  public ArrayList<bdjn> a(String paramString1, String paramString2)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 4
    ...
    //   43: astore 7
    //   45: aload_0
    //   46: invokevirtual 143	bdjq:a	()Landroid/database/sqlite/SQLiteDatabase;
    //   49: astore 5
    //   51: aload 10
    //   53: astore 4
    //   55: aload 9
    ...
    //   104: new 21	bdjn
    //   107: dup
    //   108: invokespecial 247	bdjn:<init>	()V
    //   111: astore 6
    //   113: aload_1
    //   114: astore 4
    //   116: aload_1
    ...
    //   134: putfield 25	bdjn:c	Ljava/lang/String;
    //   137: aload_1
    //   138: astore 4
    //   140: aload_1
    //   141: astore_2
    ...
    //   158: putfield 33	bdjn:a	Ljava/lang/String;
    //   161: aload_1
    //   162: astore 4
    //   164: aload_1
    //   165: astore_2
    ...
    //   182: putfield 38	bdjn:e	Ljava/lang/String;
    //   185: aload_1
    //   186: astore 4
    //   188: aload_1
    //   189: astore_2
    ...
    //   206: putfield 43	bdjn:d	Ljava/lang/String;
    //   209: aload_1
    //   210: astore 4
    //   212: aload_1
    //   213: astore_2
    ...
    //   230: putfield 48	bdjn:b	Ljava/lang/String;
    //   233: aload_1
    //   234: astore 4
    //   236: aload_1
    //   237: astore_2
    ...
    //   254: putfield 257	bdjn:f	Ljava/lang/String;
    //   257: aload_1
    //   258: astore 4
    //   260: aload_1
    //   261: astore_2
    ...
    //   278: putfield 58	bdjn:g	Ljava/lang/String;
    //   281: aload_1
    //   282: astore 4
    //   284: aload_1
    //   285: astore_2
    ...
    //   302: putfield 63	bdjn:h	Ljava/lang/String;
    //   305: aload_1
    //   306: astore 4
    //   308: aload_1
    //   309: astore_2
    ...
    //   326: putfield 68	bdjn:i	Ljava/lang/String;
    //   329: aload_1
    //   330: astore 4
    //   332: aload_1
    //   333: astore_2
    ...
    //   350: putfield 73	bdjn:j	Ljava/lang/String;
    //   353: aload_1
    //   354: astore 4
    //   356: aload_1
    //   357: astore_2
    ...
    //   374: putfield 78	bdjn:k	Ljava/lang/String;
    //   377: aload_1
    //   378: astore 4
    //   380: aload_1
    //   381: astore_2
    ...
    //   398: putfield 83	bdjn:l	Ljava/lang/String;
    //   401: aload_1
    //   402: astore 4
    //   404: aload_1
    //   405: astore_2
    ...
    //   443: invokestatic 105	bdht:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   446: aload 4
    //   448: ifnull +10 -> 458
    //   451: aload 4
  ...
  public int b(String paramString1, String paramString2)
  {
    ...
    //   36: astore 8
    //   38: aload_0
    //   39: invokevirtual 143	bdjq:a	()Landroid/database/sqlite/SQLiteDatabase;
    //   42: astore 7
    //   44: aload 11
    //   46: astore_2
    //   47: aload 10
    ...
    //   145: invokestatic 105	bdht:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   148: aload 5
    //   150: ifnull +10 -> 160
    //   153: aload 5
  ...
  public ArrayList<bdjn> b(String paramString)
  {
    try
    {
