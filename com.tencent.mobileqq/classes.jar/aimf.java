  ...
  extends Handler
{
  ...
  public aimf(NewPhotoListActivity paramNewPhotoListActivity)
  {
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      QQToast.a((Context)localObject2, ((NewPhotoListActivity)localObject2).getResources().getString(2131695262), 0).a();
      return;
    ...
    for (;;)
    {
      ...
      return;
      QQToast.a((Context)localObject2, String.format(((NewPhotoListActivity)localObject2).getResources().getString(2131695258), new Object[] { Integer.valueOf(aimj.getInstance().maxSelectNum) }), 0).a();
    }
  }
}
