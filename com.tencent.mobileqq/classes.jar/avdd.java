...
public class avdd
{
  ...
  public avdd(Context paramContext)
  {
    this(paramContext, null);
  }
  
  public avdd(Context paramContext, QQAppInterface paramQQAppInterface)
  {
  ...
  private void b()
  {
    ...
    try
    {
      String str2 = xkn.b(str1, xkn.b(2));
      ...
      localObject1 = xkn.a(str1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 25004, 10, (List)localObject2);
      localObject2 = ((String)localObject1).replaceAll(str1, str2);
      Bundle localBundle = xkn.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
      if (QLog.isColorLevel()) {
        QLog.i("HttpMqqJumper", 2, "openMoreOptions safetyReport reportMsgOrg: " + (String)localObject1 + "  reportMsg: " + (String)localObject2);
      }
      xkn.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a, str1, str2, null, null, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 25004, (String)localObject2, localBundle);
      return;
    }
  ...
  public avdd a(BaseChatPie paramBaseChatPie)
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie = paramBaseChatPie;
    return this;
  }
  
  public avdd a(SessionInfo paramSessionInfo)
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo = paramSessionInfo;
    return this;
  }
  
  public avdd a(String paramString)
  {
  ...
  public void a()
  {
    ...
    do
    {
      ...
      localObject = bbex.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangString);
    } while (localObject == null);
    ((bbeg)localObject).a();
    ((bbeg)localObject).c();
  }
