...
public class ayxt
  implements Manager
{
  ayxv jdField_a_of_type_Ayxv = new ayxu(this);
  public QQAppInterface a;
  public OcrConfig a;
  EntityManager jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager;
  private Object jdField_a_of_type_JavaLangObject = new Object();
  
  public ayxt(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(this.jdField_a_of_type_Ayxv);
  ...
  public static boolean a(String paramString, int paramInt)
  {
    ...
    {
      boolean bool2;
      if (azag.a().jdField_a_of_type_Int == 1)
      {
        bool2 = true;
        label68:
        if (QLog.isColorLevel()) {
          QLog.d("Q.ocr", 2, "isSupportOcr, uin:" + paramString + "form:" + paramInt + ",isSupport:" + bool1 + ",dpcSwitch:" + bool2 + ",sdcard:" + ayzp.a);
        }
        if ((!bool1) || (!bool2) || (!ayzp.a)) {
          break label218;
        }
      }
      label218:
  ...
  public ayzf a(List<OCRTextSearchInfo.SougouSearchInfo> paramList)
  {
    ayzf localayzf = new ayzf();
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      localayzf.jdField_a_of_type_JavaUtilList = new ArrayList();
      ayzd localayzd = new ayzd();
      localayzd.jdField_a_of_type_Int = 2049;
      localayzd.jdField_a_of_type_JavaLangString = anzj.a(2131706693);
      ...
      while (paramList.hasNext())
      {
        ...
        localayze.jdField_a_of_type_JavaLangObject = localSougouSearchInfo;
        localayzd.jdField_a_of_type_JavaUtilList.add(localayze);
      }
      localayzf.jdField_a_of_type_JavaUtilList.add(localayzd);
    }
    return localayzf;
  }
  ...
  {
    if (!bhnv.g(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())) {
      ((ayxr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(113)).notifyUI(3, false, new Object[] { Integer.valueOf(-2), paramString1, null });
    }
    ...
    ((ayxr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(113)).a(paramString1, str, paramLong);
  }
  ...
  public void a(boolean paramBoolean, OcrConfig paramOcrConfig)
  {
    ...
    //   45: ifeq +31 -> 76
    //   48: aload_0
    //   49: getfield 26	ayxt:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   52: astore_3
    //   53: aload_3
    //   54: monitorenter
    //   55: aload_0
    //   56: aload_2
    //   57: putfield 283	ayxt:jdField_a_of_type_ComTencentMobileqqOcrDataOcrConfig	Lcom/tencent/mobileqq/ocr/data/OcrConfig;
    //   60: aload_0
    //   61: getfield 28	ayxt:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   64: invokevirtual 63	com/tencent/mobileqq/app/QQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   67: aload_0
    //   68: getfield 283	ayxt:jdField_a_of_type_ComTencentMobileqqOcrDataOcrConfig	Lcom/tencent/mobileqq/ocr/data/OcrConfig;
    //   71: invokestatic 298	ayxt:a	(Ljava/lang/String;Lcom/tencent/mobileqq/ocr/data/OcrConfig;)V
    //   74: aload_3
    //   75: monitorexit
    ...
    //   80: aload_0
    //   81: iload_1
    //   82: invokespecial 345	com/tencent/mobileqq/ocr/OCRManager$3:<init>	(Layxt;Z)V
    //   85: bipush 8
    //   87: aconst_null
    //   88: iconst_0
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Ayxv);
