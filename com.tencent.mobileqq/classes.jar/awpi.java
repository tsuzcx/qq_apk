...
public class awpi
  implements awpz
{
  public awpi(StoryPlayController paramStoryPlayController) {}
  
  public void a()
  {
    if ((NetworkUtil.isNetworkAvailable(this.a.a())) && (this.a.jdField_a_of_type_ComTencentMobileqqNearbyNowViewVideoPlayerPagerAdapter.jdField_a_of_type_JavaUtilList.size() != 0))
    {
      ...
      this.a.jdField_a_of_type_ComTencentMobileqqNearbyNowViewStuffContainerView.jdField_a_of_type_ComTencentMobileqqNearbyNowViewQQStoryVideoPlayerErrorView.setOnRetryClickListener(new awpj(this));
    }
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if ((paramInt2 > 0) || (this.a.jdField_a_of_type_Awpy.a().size() == 0))
    {
      QLog.e("VideoPlayController", 1, "onDataCome errorCode > 0, errorCode=" + paramInt2 + " mPlayListDataModel.getDataList().size() is : " + this.a.jdField_a_of_type_Awpy.a().size());
    ...
    this.a.jdField_a_of_type_ComTencentMobileqqNearbyNowViewStuffContainerView.jdField_a_of_type_Awpe.a(this.a.jdField_a_of_type_Awpy.a());
    this.a.jdField_a_of_type_ComTencentMobileqqNearbyNowViewStuffContainerView.jdField_a_of_type_Awpe.b(this.a.jdField_a_of_type_Awpy.a());
    if (this.a.jdField_a_of_type_ComTencentMobileqqNearbyNowViewVideoPlayerPagerAdapter.jdField_a_of_type_Boolean) {
      ...
      {
        paramInt2 = 0;
        if (paramInt2 >= this.a.jdField_a_of_type_Awpy.a().size()) {
          break label661;
        }
        if (!((VideoData)this.a.jdField_a_of_type_Awpy.a().get(paramInt2)).jdField_a_of_type_JavaLangString.equals(StoryPlayController.a(this.a))) {}
      }
    }
    for (;;)
    {
      int i = paramInt2;
      if (paramInt2 == -1) {
        i = this.a.jdField_a_of_type_Awpy.a().size() / 2 - 1;
      }
      this.a.c = i;
      if (i != -1)
      {
      ...
      for (;;)
      {
        this.a.jdField_a_of_type_ComTencentMobileqqNearbyNowViewVideoPlayerPagerAdapter.a(paramInt1, this.a.jdField_a_of_type_Awpy.a());
        this.a.a();
        if (StoryPlayController.a(this.a))
        {
        ...
        if (paramInt1 == 0)
        {
          ...
          this.a.jdField_a_of_type_Awpy.a().size();
        }
      }
      if (this.a.jdField_a_of_type_ComTencentMobileqqNearbyNowViewVideoPlayerPagerAdapter.jdField_a_of_type_Boolean) {
        break;
  ...
  public void a(VideoData paramVideoData)
  {
    ...
    if ((this.a.jdField_a_of_type_ComTencentMobileqqNearbyNowViewVideoPlayerPagerAdapter.jdField_a_of_type_JavaUtilList.size() == 1) && (this.a.jdField_a_of_type_ComTencentMobileqqNearbyNowViewVideoPlayerPagerAdapter.jdField_a_of_type_AndroidUtilSparseArray.size() == 1) && (this.a.jdField_a_of_type_ComTencentMobileqqNearbyNowViewVideoPlayerPagerAdapter.b.size() == 1))
    {
      ...
      ((awti)this.a.jdField_a_of_type_ComTencentMobileqqNearbyNowViewVideoPlayerPagerAdapter.jdField_a_of_type_AndroidUtilSparseArray.get(0)).jdField_a_of_type_ComTencentMobileqqNearbyNowModelVideoData = paramVideoData;
      awti localawti = (awti)this.a.jdField_a_of_type_ComTencentMobileqqNearbyNowViewVideoPlayerPagerAdapter.jdField_a_of_type_AndroidUtilSparseArray.get(0);
      ...
      localawti.jdField_a_of_type_ComTencentMobileqqNearbyNowViewOperationView.setCurrentAnchorUin(paramVideoData.jdField_a_of_type_Long);
      this.a.a(localawti, paramVideoData, false, localShortVideoCommentsView, false);
    }
  }
}
