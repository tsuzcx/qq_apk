  ...
  implements bhlf
{
  ...
  private void a(WebViewPlugin paramWebViewPlugin, bcdp parambcdp, String[] paramArrayOfString)
  {
    ...
    do
    {
      for (;;)
      {
        try
        {
          ...
          paramWebViewPlugin = parambcdp.getString("giftid");
      ...
      paramWebViewPlugin = new File(bgzz.a(paramWebViewPlugin) + asdg.a());
    ...
    paramWebViewPlugin = "window." + parambcdp + "({checkGift:" + i + "})";
  ...
  {
    parambcdp.a().getHandler(bhsb.class).post(new QZoneGiftFullScreenJsPlugin.1(this, paramArrayOfString));
  }
  ...
  private void c(WebViewPlugin paramWebViewPlugin, bcdp parambcdp, String[] paramArrayOfString)
  {
    ...
    do
    {
      do
      {
        ...
        paramArrayOfString = bgzz.a(paramWebViewPlugin);
    ...
    this.jdField_a_of_type_Bhac.a(paramWebViewPlugin, paramArrayOfString, new bhra(this, parambcdp));
  }
