...
public class ajjt
{
  private WeakReference<ajke> jdField_a_of_type_JavaLangRefWeakReference;
  private final ConcurrentHashMap<String, ajjz> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
  
  ajjt(ajke paramajke)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramajke);
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
    if (!a())
    {
      paramajke = (AppInterface)MobileQQ.sMobileQQ.waitAppRuntime(null).getAppRuntime("modular_web");
      if (paramajke != null)
      {
  ...
  public static void a(ajjt paramajjt, AppInterface paramAppInterface, int paramInt, boolean paramBoolean)
  {
    boolean bool2 = true;
    ...
    do
    {
      do
      {
        ...
        Object localObject = new File(ajje.a());
        ...
        localObject = new bbwg("https://cmshow.gtimg.cn/qqshow/admindata/comdata/vipApollo_thunder_config/xydata.json", (File)localObject);
        ...
        ((bbwg)localObject).a(new ajjv(localSharedPreferences, paramInt, paramajjt));
        paramajjt = (bbwi)paramAppInterface.getManager(47);
        paramBoolean = bool2;
        if (paramajjt != null)
        {
          paramajjt = paramajjt.a(3);
          paramBoolean = bool2;
          if (paramajjt != null)
          {
            paramajjt.a((bbwg)localObject, ((bbwg)localObject).a(), null);
            paramBoolean = false;
          }
        }
        if (paramBoolean) {
          ThreadManager.executeOnNetWorkThread(new ApolloSSOConfig.3((bbwg)localObject));
        }
  ...
  private boolean a()
  {
    ...
    Object localObject1 = new File(ajje.a());
    Object localObject2;
    int i;
    Object localObject4;
    int i1;
    ...
    if (((File)localObject1).exists())
    {
      try
      {
        localObject2 = ajje.a((File)localObject1);
        ...
        localObject2 = new ajjz();
        ((ajjz)localObject2).jdField_a_of_type_Int = n;
        ((ajjz)localObject2).jdField_a_of_type_JavaLangString = ((String)localObject4);
        ...
        if (k < i2)
        {
          ...
          localObject8 = new ajjy(null);
          ((ajjy)localObject8).jdField_a_of_type_JavaLangString = str1;
          ((ajjy)localObject8).jdField_a_of_type_Int = i3;
          ((ajjy)localObject8).b = str2;
      ...
      localObject7 = new ajjx();
      ((ajjx)localObject7).jdField_a_of_type_JavaLangString = ((String)localObject5);
      ((ajjx)localObject7).jdField_a_of_type_Int = n;
      ((ajjx)localObject7).jdField_a_of_type_JavaUtilList.addAll((Collection)localObject6);
      ((ajjz)localObject2).jdField_a_of_type_JavaUtilList.add(localObject7);
      break label1055;
      label543:
      ...
      localObject4 = new ajjw();
      ((ajjw)localObject4).jdField_a_of_type_JavaLangString = str1;
      ((ajjw)localObject4).b = str2;
    ...
    for (;;)
    {
      if (k < i1)
      {
        ...
        if (localObject8 != null)
        {
          ...
          if (!TextUtils.isEmpty(str1))
          {
            ...
            localObject8 = new ajjy(null);
            ((ajjy)localObject8).jdField_a_of_type_JavaLangString = str1;
            ((ajjy)localObject8).jdField_a_of_type_Int = i2;
            ((ajjy)localObject8).b = str2;
      ...
      {
        ((ajjw)localObject4).jdField_a_of_type_JavaUtilList.addAll((Collection)localObject7);
        ...
        if (localObject5 != null)
        {
          ...
          while (((Iterator)localObject6).hasNext())
          {
            ...
            ((ajjw)localObject4).jdField_a_of_type_JavaUtilHashMap.put(localObject7, ((JSONObject)localObject5).optString((String)localObject7));
          }
        }
        ((ajjz)localObject2).b.add(localObject4);
        break label1069;
        label935:
        if (QLog.isColorLevel())
        {
  ...
  public String a(String paramString)
  {
    ...
    {
      paramString = (ajjz)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
      if (paramString != null) {
  ...
  public Set<String> a(String paramString)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      Object localObject = (ajjz)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
      if (localObject != null)
      {
        paramString = new HashSet();
        localObject = ((ajjz)localObject).jdField_a_of_type_JavaUtilList.iterator();
        while (((Iterator)localObject).hasNext())
        {
          ajjx localajjx = (ajjx)((Iterator)localObject).next();
          if ((localajjx != null) && (!TextUtils.isEmpty(localajjx.jdField_a_of_type_JavaLangString))) {
            paramString.add(localajjx.jdField_a_of_type_JavaLangString);
          }
        }
        return paramString;
      }
  ...
  public JSONObject a(String paramString1, String paramString2, String paramString3, AppInterface paramAppInterface)
  {
    ...
    paramString2 = (ajjz)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString2);
    if (paramString2 != null)
    {
      paramString2 = paramString2.jdField_a_of_type_JavaUtilList.iterator();
      while (paramString2.hasNext())
      {
        ajjx localajjx = (ajjx)paramString2.next();
        if ((localajjx != null) && (paramString3.equals(localajjx.jdField_a_of_type_JavaLangString))) {
          return localajjx.a(paramString1, paramAppInterface);
        }
      }
    }
    return null;
  ...
  void a(AppInterface paramAppInterface)
  {
    ...
    localObject1 = new NewIntent(paramAppInterface.getApp(), arpb.class);
    ...
    ((NewIntent)localObject1).setObserver(new ajju(this, paramAppInterface));
  ...
  public boolean a(String paramString1, String paramString2)
  {
    ...
    {
      paramString1 = (ajjz)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString1);
      if (paramString1 != null)
      {
        paramString1 = paramString1.jdField_a_of_type_JavaUtilList.iterator();
        while (paramString1.hasNext())
        {
          ajjx localajjx = (ajjx)paramString1.next();
          if ((localajjx != null) && (paramString2.equals(localajjx.jdField_a_of_type_JavaLangString))) {
            return true;
          }
        }
      }
