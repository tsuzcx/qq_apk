  ...
  extends WebViewPlugin
{
  ...
  public long b()
  {
    ...
    //   13: dup
    //   14: new 145	java/io/FileReader
    //   17: dup
    //   18: ldc 147
    //   20: invokespecial 150	java/io/FileReader:<init>	(Ljava/lang/String;)V
    //   23: bipush 8
    //   25: invokespecial 153	java/io/BufferedReader:<init>	(Ljava/io/Reader;I)V
    //   28: astore 4
    //   30: aload 4
    //   32: astore_3
    //   33: aload 4
    //   35: invokevirtual 156	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   38: astore 7
    //   40: aload 5
    //   42: astore_3
    //   43: aload 7
    ...
    //   56: ifnull +11 -> 67
    //   59: aload 4
    //   61: invokevirtual 159	java/io/BufferedReader:close	()V
    //   64: aload_3
    //   65: astore 5
    //   67: aload 5
    //   69: ifnull +32 -> 101
    ...
    //   74: aload 5
    //   76: bipush 58
    //   78: invokevirtual 165	java/lang/String:indexOf	(I)I
    //   81: iconst_1
    //   82: iadd
    //   83: aload 5
    //   85: bipush 107
    //   87: invokevirtual 165	java/lang/String:indexOf	(I)I
    //   90: invokevirtual 169	java/lang/String:substring	(II)Ljava/lang/String;
    //   93: invokevirtual 172	java/lang/String:trim	()Ljava/lang/String;
    ...
    //   103: astore 4
    //   105: aload 4
    //   107: invokevirtual 181	java/io/IOException:printStackTrace	()V
    //   110: aload_3
    //   111: astore 5
    //   113: goto -46 -> 67
    //   116: astore 5
    ...
    //   123: astore_3
    //   124: aload 5
    //   126: invokevirtual 182	java/io/FileNotFoundException:printStackTrace	()V
    //   129: aload 6
    //   131: astore 5
    //   133: aload 4
    //   135: ifnull -68 -> 67
    //   138: aload 4
    //   140: invokevirtual 159	java/io/BufferedReader:close	()V
    //   143: aload 6
    //   145: astore 5
    //   147: goto -80 -> 67
    //   150: astore_3
    //   151: aload_3
    //   152: invokevirtual 181	java/io/IOException:printStackTrace	()V
    //   155: aload 6
    //   157: astore 5
    //   159: goto -92 -> 67
    //   162: astore 5
    ...
    //   181: ifnull -114 -> 67
    //   184: aload 4
    //   186: invokevirtual 159	java/io/BufferedReader:close	()V
    //   189: aload 6
    //   191: astore 5
    //   193: goto -126 -> 67
    //   196: astore_3
    //   197: aload_3
    //   198: invokevirtual 181	java/io/IOException:printStackTrace	()V
    //   201: aload 6
    //   203: astore 5
    //   205: goto -138 -> 67
    //   208: astore 5
    ...
    //   218: ifnull +8 -> 226
    //   221: aload 4
    //   223: invokevirtual 159	java/io/BufferedReader:close	()V
    //   226: aload_3
    //   227: athrow
    //   228: astore 4
    //   230: aload 4
    //   232: invokevirtual 181	java/io/IOException:printStackTrace	()V
    //   235: goto -9 -> 226
    //   238: astore 5
    //   240: aload_3
    //   241: astore 4
  ...
  public String d()
  {
    ...
    //   27: aload_1
    //   28: astore 4
    //   30: new 143	java/io/BufferedReader
    //   33: dup
    //   34: aload_1
    //   35: invokespecial 233	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   38: astore_2
    //   39: aload_2
    //   40: invokevirtual 156	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   43: astore_3
    //   44: aload_1
    //   45: invokevirtual 234	java/io/FileReader:close	()V
    //   48: aload_2
    //   49: invokevirtual 159	java/io/BufferedReader:close	()V
    //   52: aload_3
    //   53: invokevirtual 172	java/lang/String:trim	()Ljava/lang/String;
    //   56: astore_3
    //   57: aload_1
    //   58: ifnull +7 -> 65
    //   61: aload_1
    //   62: invokevirtual 234	java/io/FileReader:close	()V
    //   65: aload_3
    //   66: astore 4
    //   68: aload_2
    //   69: ifnull +10 -> 79
    //   72: aload_2
    //   73: invokevirtual 159	java/io/BufferedReader:close	()V
    //   76: aload_3
    //   77: astore 4
    //   79: aload 4
    //   81: areturn
    ...
    //   90: astore_1
    //   91: aload_1
    //   92: invokevirtual 181	java/io/IOException:printStackTrace	()V
    //   95: aload_3
    //   96: areturn
    //   97: astore_3
    //   98: aconst_null
    //   99: astore_1
    //   100: aload_3
    //   101: invokevirtual 182	java/io/FileNotFoundException:printStackTrace	()V
    //   104: aload_2
    //   105: ifnull +7 -> 112
    //   108: aload_2
    //   109: invokevirtual 234	java/io/FileReader:close	()V
    //   112: aload 6
    //   114: astore 4
    //   116: aload_1
    //   117: ifnull -38 -> 79
    //   120: aload_1
    //   121: invokevirtual 159	java/io/BufferedReader:close	()V
    //   124: ldc 228
    //   126: areturn
    //   127: astore_1
    //   128: aload_1
    ...
    //   135: astore_2
    //   136: aload_2
    //   137: invokevirtual 181	java/io/IOException:printStackTrace	()V
    //   140: goto -28 -> 112
    //   143: astore 5
    //   145: aconst_null
    //   146: astore_1
    ...
    //   161: ifnull +7 -> 168
    //   164: aload_1
    //   165: invokevirtual 234	java/io/FileReader:close	()V
    //   168: aload 6
    //   170: astore 4
    //   172: aload_2
    //   173: ifnull -94 -> 79
    //   176: aload_2
    //   177: invokevirtual 159	java/io/BufferedReader:close	()V
    //   180: ldc 228
    //   182: areturn
    //   183: astore_1
    //   184: aload_1
    ...
    //   203: ifnull +7 -> 210
    //   206: aload_1
    //   207: invokevirtual 234	java/io/FileReader:close	()V
    //   210: aload_3
    //   211: ifnull +7 -> 218
    //   214: aload_3
    //   215: invokevirtual 159	java/io/BufferedReader:close	()V
    //   218: aload_2
    //   219: athrow
    //   220: astore_1
    //   221: aload_1
    //   222: invokevirtual 181	java/io/IOException:printStackTrace	()V
    //   225: goto -15 -> 210
    //   228: astore_1
    //   229: aload_1
    //   230: invokevirtual 181	java/io/IOException:printStackTrace	()V
    //   233: goto -15 -> 218
    //   236: astore_2
    //   237: aload 4
    //   239: astore_1
  ...
  public String e()
  {
    ...
    //   0: aconst_null
    //   1: astore 7
    //   3: new 145	java/io/FileReader
    //   6: dup
    //   7: ldc 236
    //   9: invokespecial 150	java/io/FileReader:<init>	(Ljava/lang/String;)V
    //   12: astore_2
    //   13: new 143	java/io/BufferedReader
    //   16: dup
    //   17: aload_2
    //   18: invokespecial 233	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   21: astore 5
    //   23: aload 5
    //   25: astore 4
    //   27: aload_2
    //   28: astore_3
    //   29: aload 5
    //   31: invokevirtual 156	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   34: ldc 238
    //   36: iconst_2
    //   37: invokevirtual 242	java/lang/String:split	(Ljava/lang/String;I)[Ljava/lang/String;
    //   40: astore 6
    //   42: iconst_0
    //   43: istore_1
    //   44: aload 5
    ...
    //   70: ifnull +7 -> 77
    //   73: aload_2
    //   74: invokevirtual 234	java/io/FileReader:close	()V
    //   77: aload_3
    //   78: astore_2
    //   79: aload 5
    //   81: ifnull +10 -> 91
    //   84: aload 5
    //   86: invokevirtual 159	java/io/BufferedReader:close	()V
    //   89: aload_3
    //   90: astore_2
    //   91: aload_2
    //   92: areturn
    //   93: astore_2
    //   94: aload_2
    //   95: invokevirtual 181	java/io/IOException:printStackTrace	()V
    //   98: goto -21 -> 77
    //   101: astore_2
    //   102: aload_2
    ...
    //   120: astore_3
    //   121: aload 6
    //   123: invokevirtual 182	java/io/FileNotFoundException:printStackTrace	()V
    //   126: aload_2
    //   127: ifnull +7 -> 134
    //   130: aload_2
    //   131: invokevirtual 234	java/io/FileReader:close	()V
    //   134: aload 7
    //   136: astore_2
    //   137: aload 5
    //   139: ifnull -48 -> 91
    //   142: aload 5
    //   144: invokevirtual 159	java/io/BufferedReader:close	()V
    //   147: aconst_null
    //   148: areturn
    //   149: astore_2
    //   150: aload_2
    //   151: invokevirtual 181	java/io/IOException:printStackTrace	()V
    //   154: aconst_null
    //   155: areturn
    //   156: astore_2
    //   157: aload_2
    //   158: invokevirtual 181	java/io/IOException:printStackTrace	()V
    //   161: goto -27 -> 134
    //   164: astore 6
    //   166: aconst_null
    //   167: astore 5
    ...
    //   176: astore_3
    //   177: aload 6
    //   179: invokevirtual 181	java/io/IOException:printStackTrace	()V
    //   182: aload_2
    //   183: ifnull +7 -> 190
    //   186: aload_2
    //   187: invokevirtual 234	java/io/FileReader:close	()V
    //   190: aload 7
    //   192: astore_2
    //   193: aload 5
    //   195: ifnull -104 -> 91
    ...
    //   212: astore_2
    //   213: aload_2
    //   214: invokevirtual 181	java/io/IOException:printStackTrace	()V
    //   217: goto -27 -> 190
    //   220: astore 5
    //   222: aconst_null
    //   223: astore 4
    ...
    //   228: ifnull +7 -> 235
    //   231: aload_2
    //   232: invokevirtual 234	java/io/FileReader:close	()V
    //   235: aload 4
    //   237: ifnull +8 -> 245
    //   240: aload 4
    //   242: invokevirtual 159	java/io/BufferedReader:close	()V
    //   245: aload 5
    //   247: athrow
    //   248: astore_2
    //   249: aload_2
    //   250: invokevirtual 181	java/io/IOException:printStackTrace	()V
    //   253: goto -18 -> 235
    //   256: astore_2
    //   257: aload_2
    //   258: invokevirtual 181	java/io/IOException:printStackTrace	()V
    //   261: goto -16 -> 245
    //   264: astore 5
    //   266: aconst_null
    //   267: astore 4
