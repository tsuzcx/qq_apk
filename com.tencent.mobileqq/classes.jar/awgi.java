...
public class awgi
{
  public static long a(String paramString)
  {
    ...
    {
      awen.b("compress.Utils", "getFileSize()", "path is empty, or file does not exist. path:" + paramString);
      return 0L;
    }
  ...
  public static Bitmap a(Bitmap paramBitmap)
  {
    ...
    awen.a("compress.Utils", "compositingWhiteBg()", "compositingWhiteBg is success");
    return paramBitmap;
  }
  
  private static awgk a(int paramInt1, int paramInt2, int paramInt3)
  {
    return a(paramInt1, paramInt2, paramInt3, null);
  }
  
  private static awgk a(int paramInt1, int paramInt2, int paramInt3, ThumbWidthHeightDP paramThumbWidthHeightDP)
  {
    int k = 1;
    int m = 0;
    int i;
    ...
    for (;;)
    {
      paramThumbWidthHeightDP = new awgk(null);
      paramThumbWidthHeightDP.a = paramInt2;
      paramThumbWidthHeightDP.b = paramInt1;
      awen.a("compress.Utils", "getType()", " type=" + paramThumbWidthHeightDP);
  ...
  {
    if ((!TextUtils.isEmpty(paramString)) && (bdcs.a(paramString)))
    {
      String str2 = bayb.a(aljq.aX + "thumb/");
    ...
    awen.a("compress.Utils", "getThumbnailPath()", "realpath is empty, or file does not exist, realpath:" + paramString);
    return "";
  }
  
  public static String a(String paramString, int paramInt)
  {
    if ((!TextUtils.isEmpty(paramString)) && (bdcs.a(paramString)) && (awgb.a(paramInt)))
    {
      int i = paramString.lastIndexOf("/");
      int j = paramString.lastIndexOf(".");
      Object localObject;
    ...
    awen.a("compress.Utils", "getSendPhotoPath()", "realpath is empty, or file does not exist, or picQuality Illegal realpath:" + paramString + " picQuality:" + paramInt);
    return "";
  }
  ...
  public static void a(Context paramContext, List<CompressInfo> paramList)
  {
    ...
    if (paramList.size() > 1)
    {
      ...
      j = 0;
      localObject1 = "";
      str2 = BaseApplication.getContext().getString(2131691060);
      str3 = BaseApplication.getContext().getString(2131691061);
      str4 = BaseApplication.getContext().getString(2131691056);
      str5 = BaseApplication.getContext().getString(2131691057);
      i1 = 0;
      i = 0;
      str1 = "";
      str6 = BaseApplication.getContext().getString(2131691058);
      str7 = BaseApplication.getContext().getString(2131691059);
      localObject3 = BaseApplication.getContext().getString(2131691063);
      localObject2 = BaseApplication.getContext().getString(2131691064);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        QQToast.a(paramContext, (CharSequence)localObject3, 0).b(paramContext.getResources().getDimensionPixelSize(2131298914));
        return;
        n = 0;
        break;
        k = 1;
          ...
          if (((CompressInfo)localObject2).e)
          {
            ...
            if (((CompressInfo)localObject2).jdField_b_of_type_Boolean)
            {
              ...
              if (i == 0)
              {
                ...
                if (m != 0)
                {
                  QQToast.a(paramContext, (CharSequence)localObject2, 0).b(paramContext.getResources().getDimensionPixelSize(2131298914));
                  return;
                }
                if (i1 == 0) {
                  break;
                }
                QQToast.a(paramContext, (CharSequence)localObject4, 0).b(paramContext.getResources().getDimensionPixelSize(2131298914));
                return;
              }
            }
          }
  ...
  {
    return bdee.b(BaseApplication.getContext()) == 1;
  }
  ...
  public static boolean a(Bitmap paramBitmap, awgk paramawgk, boolean paramBoolean, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt)
  {
    return a(paramBitmap, paramawgk, paramBoolean, paramString1, paramString2, paramString3, paramString4, paramInt, null);
  }
  
  public static boolean a(Bitmap paramBitmap, awgk paramawgk, boolean paramBoolean, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt, ThumbWidthHeightDP paramThumbWidthHeightDP)
  {
    ...
    for (;;)
    {
      ...
      {
        awen.a("compress.Utils", paramString3, paramString4 + " sample after W:" + k + " H:" + j + " isLongImg:" + a(0, 0, paramInt) + " type:" + paramawgk + " needRotate:" + bool2);
        int i3;
        if (i1 > n) {
          i3 = i1;
        }
        ...
        for (i2 = n;; i2 = i1) {
          ...
          default: 
            bool1 = false;
            paramBoolean = false;
            awen.a("compress.Utils", paramString3, paramString4 + " destWidth：" + i1 + " destHeight:" + n + " needCut:" + bool1 + " needScale:" + paramBoolean + " needRotate:" + bool2);
            paramBitmap = a(paramBitmap);
            if (paramInt == 3)
            {
              paramBoolean = a(paramBitmap);
              awen.a("compress.Utils", paramString3, paramString4 + " isDrawGIFSucc：" + paramBoolean);
            }
            ...
            m = aroa.d;
            break label52;
            awen.a("compress.Utils", paramString3, paramString4 + " type.type2:136");
            if (n > i2)
            {
              j = i2;
              label507:
            ...
            for (;;)
            {
              for (;;)
              {
                ...
                catch (OutOfMemoryError paramString1)
                {
                  ...
                  awen.b("compress.Utils", paramString3, paramString4 + " cut 3:1 createBitmap OutOfMemoryError, type:" + paramawgk);
                  return false;
                }
              }
              j = n;
          ...
          for (;;)
          {
            ...
            catch (OutOfMemoryError paramString1)
            {
              ...
              catch (OutOfMemoryError paramBitmap)
              {
                ...
                paramBitmap.printStackTrace();
                awen.b("compress.Utils", paramString3, paramString4 + " case 1: cut createBitmap OutOfMemoryError, type:" + paramawgk);
                return false;
              }
              paramString1 = paramString1;
              paramBitmap.recycle();
              paramString1.printStackTrace();
              awen.b("compress.Utils", paramString3, paramString4 + " case 1: scale or rotate createBitmap OutOfMemoryError, type:" + paramawgk);
              return false;
            }
            j = i;
            i = m;
            ...
            for (;;)
            {
              for (;;)
              {
                ...
                catch (OutOfMemoryError paramString1)
                {
                  paramBitmap.recycle();
                  paramString1.printStackTrace();
                  awen.b("compress.Utils", paramString3, paramString4 + " case 2: scale or rotate createBitmap OutOfMemoryError, type:" + paramawgk);
                  return false;
                }
              }
              n = i;
            ...
            catch (OutOfMemoryError paramString1)
            {
              paramBitmap.recycle();
              paramString1.printStackTrace();
              awen.b("compress.Utils", paramString3, paramString4 + " case 3: rotate createBitmap OutOfMemoryError, type:" + paramawgk);
              return false;
            }
          }
          if (bool2)
          ...
          for (;;)
          {
            ...
            catch (OutOfMemoryError paramString1)
            {
              ...
              catch (OutOfMemoryError paramString1)
              {
                ...
                paramBitmap.recycle();
                paramString1.printStackTrace();
                awen.b("compress.Utils", paramString3, paramString4 + " case 4: cut createBitmap OutOfMemoryError, type:" + paramawgk);
                return false;
              }
              paramString1 = paramString1;
              paramBitmap.recycle();
              paramString1.printStackTrace();
              awen.b("compress.Utils", paramString3, paramString4 + " case 4: rotate createBitmap OutOfMemoryError, type:" + paramawgk);
              return false;
            }
            i = i2 * 3;
            continue;
  ...
  private static boolean a(BitmapFactory.Options paramOptions, int paramInt)
  {
    ...
    {
      awen.b("compress.Utils", "calculateInSampleSizeThumbnail()", "options is null");
      return false;
    }
    ...
    if ((m == 0) || (n == 0))
    {
      awen.b("compress.Utils", "calculateInSampleSizeThumbnail()", "width == 0 || height ==0");
      return false;
    }
    int j = n;
    int k = m;
    ...
    for (paramInt = paramOptions.inSampleSize;; paramInt = 1)
    {
      ...
      awen.a("compress.Utils", "calculateInSampleSizeThumbnail()", "options.inSampleSize=" + paramOptions.inSampleSize + " srcWidth:" + m + " srcHeight:" + n);
      return true;
      i *= 2;
      break;
    }
  ...
  public static boolean a(BitmapFactory.Options paramOptions, String paramString, int paramInt1, int paramInt2)
  {
    ...
    {
      awen.b("compress.Utils", "calculateInSampleSize()", "options == null || TextUtils.isEmpty(filepath)");
      return false;
    }
    ...
    bdda.a(paramString, paramOptions);
    ...
    for (paramInt1 = paramOptions.inSampleSize;; paramInt1 = 1)
    {
      ...
      awen.a("compress.Utils", "calculateInSampleSize()", "options.inSampleSize=" + paramOptions.inSampleSize);
      return true;
      break;
    }
  }
  ...
  private static boolean a(JpegOptions paramJpegOptions, int paramInt)
  {
    ...
    for (paramInt = paramJpegOptions.inSampleSize;; paramInt = 1)
    {
      ...
      awen.a("compress.Utils", "calculateInSampleSizeThumbnail()", "options.inSampleSize=" + paramJpegOptions.inSampleSize + " srcWidth:" + m + " srcHeight:" + n);
      return true;
      i *= 2;
      break;
    }
  ...
  public static boolean a(String paramString1, String paramString2, boolean paramBoolean, String paramString3, int paramInt, ThumbWidthHeightDP paramThumbWidthHeightDP)
  {
    ...
    {
      awen.b("compress.Utils", "compressAIOThumbnail", paramString3 + " infilePath is empty, or outfilePath is empty, or file does not exist. infilePath:" + paramString1 + " outfilePath:" + paramString2);
      return false;
    }
    awen.a("compress.Utils", "compressAIOThumbnail", paramString3);
    BitmapFactory.Options localOptions = new BitmapFactory.Options();
    localOptions.inJustDecodeBounds = true;
    bdda.a(paramString1, localOptions);
    int j;
    int i;
    awgk localawgk;
    if (localOptions.outWidth > localOptions.outHeight)
    {
      ...
      localawgk = a(i, j, paramInt, paramThumbWidthHeightDP);
      if (paramThumbWidthHeightDP == null) {
        break label232;
      }
      i = paramThumbWidthHeightDP.maxPx();
    ...
    for (;;)
    {
      ...
      awen.b("compress.Utils", "compressAIOThumbnail", paramString3 + " calculateInSampleSize fail");
      return false;
    ...
    try
    {
      ...
      {
        awen.b("compress.Utils", "compressAIOThumbnail", paramString3 + " bm == null, maybe is broken");
        return false;
      }
    }
    catch (OutOfMemoryError localOutOfMemoryError)
    {
      localOutOfMemoryError.printStackTrace();
      awen.b("compress.Utils", "compressAIOThumbnail", paramString3 + " decodeFile OutOfMemoryError");
      localOptions.inSampleSize *= 2;
      try
      {
        Bitmap localBitmap2 = bdda.a(paramString1, localOptions);
        i = localBitmap2.getWidth();
        j = localBitmap2.getHeight();
        awen.a("compress.Utils", "compressAIOThumbnail", paramString3 + " sample after W:" + i + " H:" + j);
        return a(localBitmap2, localawgk, paramBoolean, paramString1, paramString2, "compressAIOThumbnail", paramString3, paramInt, paramThumbWidthHeightDP);
      }
      catch (OutOfMemoryError paramString1)
      {
        paramString1.printStackTrace();
        awen.b("compress.Utils", "compressAIOThumbnail", paramString3 + " decodeFile OutOfMemoryError, op.inSampleSize:" + localOptions.inSampleSize);
      }
    }
    return false;
  }
  ...
  public static boolean b(String paramString)
  {
    ...
    {
      bool1 = bool3;
      if (!bdcs.b(paramString).equals("jpg")) {}
    }
    try
    {
      ...
      awen.a("compress.Utils", "isMatchQualityAndSizeCondition()", "getJpegQuality = " + f + ",picSize = " + l + "result = " + bool1);
      return bool1;
    }
    catch (RuntimeException paramString)
    {
      awen.b("compress.Utils", "isMatchQualityAndSizeCondition()", "getJpegQuality RuntimeException error = " + paramString + ",return false!");
      return false;
    }
    catch (OutOfMemoryError paramString)
    {
      awen.b("compress.Utils", "isMatchQualityAndSizeCondition()", "getJpegQuality OutOfMemoryError error = " + paramString + ",return false!");
    }
    return false;
  }
  ...
  private static boolean b(String paramString1, Bitmap paramBitmap, int paramInt, String paramString2, CompressInfo paramCompressInfo)
  {
    ...
    {
      awen.b("compress.Utils", "compressQualityWithProgressive()", paramString2 + " TextUtils.isEmpty(destPath) || bm == null || quality > 100 || quality <= 0");
      return false;
    }
    awen.a("compress.Utils", "compressQualityWithProgressive()", paramString2 + " quality:" + paramInt);
    ...
    try
    {
      ...
      localObject = new JpegCompressor(new awgj((File)localObject, paramCompressInfo));
      ((JpegCompressor)localObject).setParams(paramInt, true, true, false);
      try
      {
        bddw.a();
        ((JpegCompressor)localObject).compress(paramBitmap);
        bddw.a("peak_pgjpeg", "pgjpeg " + paramBitmap.getWidth() + "x" + paramBitmap.getHeight() + " compress");
        awen.a("compress.Utils", "compressQualityWithProgressive()", paramString2 + " quality:" + paramInt);
        return true;
      }
    ...
    {
      awen.b("compress.Utils", "compressQualityWithProgressive()", paramString2 + " FileOutputStream FileNotFoundException");
      paramString1.printStackTrace();
      return false;
    }
    catch (IOException paramString1)
    {
      awen.b("compress.Utils", "compressQualityWithProgressive()", paramString2 + " createNewFile IOException");
      paramString1.printStackTrace();
    }
  }
  ...
  public static boolean b(String paramString1, String paramString2, boolean paramBoolean, String paramString3, int paramInt)
  {
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)) || (!bdcs.b(paramString1)))
    {
      awen.b("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3 + " infilePath is empty, or outfilePath is empty, or file does not exist. infilePath:" + paramString1 + " outfilePath:" + paramString2);
      return false;
    }
    awen.a("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3);
    ...
    for (;;)
    {
      ...
      awen.b("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3 + " calculateInSampleSize fail");
      return false;
    ...
    try
    {
      ...
      if (localBitmap3 == null)
      {
        awen.b("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3 + " bm == null, maybe is broken");
        return false;
      }
    }
    catch (OutOfMemoryError localOutOfMemoryError)
    {
      localOutOfMemoryError.printStackTrace();
      awen.b("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3 + " decodeFile OutOfMemoryError");
      ...
      try
      {
        ...
        i = localBitmap2.getWidth();
        j = localBitmap2.getHeight();
        awen.a("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3 + " sample after W:" + i + " H:" + j);
        return a(localBitmap2, localawgk, paramBoolean, paramString1, paramString2, "compressAIOThumbnailWithTrubo", paramString3, paramInt);
      }
      catch (OutOfMemoryError paramString1)
      {
        paramString1.printStackTrace();
        awen.b("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3 + " decodeFile OutOfMemoryError, op.inSampleSize:" + localJpegOptions.inSampleSize);
      }
    }
    return false;
  }
  ...
  private static boolean c(String paramString1, Bitmap paramBitmap, int paramInt, String paramString2, CompressInfo paramCompressInfo)
  {
    ...
    //   49: invokestatic 43	awen:b	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   52: iconst_0
    //   53: istore 5
    //   55: iload 5
    //   57: ireturn
    ...
    //   87: invokestatic 115	awen:a	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   113: pop
    //   114: aload_0
    //   115: invokestatic 684	bdcs:a	(Ljava/lang/String;)Ljava/io/File;
    //   118: pop
    ...
    //   208: aload_0
    //   209: invokestatic 18	bdcs:b	(Ljava/lang/String;)Z
    //   212: ifne -157 -> 55
    //   215: ldc 20
    //   217: ldc_w 681
    ...
    //   240: invokestatic 43	awen:b	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   243: iconst_0
    //   244: ireturn
    //   245: astore_1
    //   246: aload 4
    ...
    //   267: ldc_w 681
    //   270: ldc_w 728
    //   273: invokestatic 43	awen:b	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   276: goto -78 -> 198
    //   279: astore_0
    //   280: aload 7
    //   282: astore 6
    ...
    //   309: invokestatic 43	awen:b	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   312: aload 7
    //   314: astore 6
    //   316: aload_0
    ...
    //   354: ldc_w 681
    //   357: ldc_w 730
    //   360: invokestatic 43	awen:b	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   363: goto -165 -> 198
    //   366: astore_0
    //   367: aload 7
    //   369: astore 6
    ...
    //   396: invokestatic 43	awen:b	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   399: aload 7
    //   401: astore 6
    //   403: aload_0
