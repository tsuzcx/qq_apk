...
class rpe
  extends niv
{
  rpe(rpd paramrpd, rox paramrox, int paramInt) {}
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    if (paramArrayOfByte != null) {
      try
      {
        ...
        if (paramBundle.topic_info_set_rsp.has())
        {
          ...
          this.jdField_a_of_type_Rox.a(paramInt, paramArrayOfByte.err_msg.get(), paramArrayOfByte.ret_code.get(), paramArrayOfByte.topic_id.get());
          return;
        }
      }
    ...
    for (;;)
    {
      this.jdField_a_of_type_Rox.a(paramInt, "", -1, 0);
      return;
      label123:
