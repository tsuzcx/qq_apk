...
public class rpe
  implements Runnable
{
  public rpe(BaseChatPie paramBaseChatPie) {}
  ...
  public void run()
  {
    ...
    try
    {
      this.a.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843835);
      this.a.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843836);
