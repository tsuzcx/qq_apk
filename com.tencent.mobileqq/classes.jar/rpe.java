...
public final class rpe
{
  ...
  private final void b(VideoInfo paramVideoInfo)
  {
    ...
    if (localObject != null) {
      ((AdvertisementInfo)localObject).mAdvertisementSoftInfo = ((tlz)null);
    }
    ...
    paramVideoInfo.jdField_a_of_type_Odl = ((odl)null);
    paramVideoInfo.b = ((odl)null);
  }
  ...
  public final void a(@NotNull VideoInfo paramVideoInfo)
  {
    ...
    for (;;)
    {
      ...
      if ((paramVideoInfo.jdField_a_of_type_Odl != null) || (paramVideoInfo.b != null)) {
  ...
  public final void a(@NotNull rol paramrol)
  {
    Intrinsics.checkParameterIsNotNull(paramrol, "holder");
    paramrol = paramrol.a;
    if (paramrol != null)
    {
      paramrol = paramrol.a;
      if (paramrol != null) {
        jdField_a_of_type_Rpe.a(paramrol);
      }
    }
  }
}
