...
public class akcg
  implements Runnable
{
  public akcg(TroopGiftActionButton paramTroopGiftActionButton, String paramString) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqTroopgiftTroopGiftActionButton.jdField_a_of_type_AndroidOsHandler.postDelayed(new akch(this), 350L);
        return;
      }
