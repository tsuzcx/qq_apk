...
public class aids
  extends ailz
{
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new aidt(this);
  ...
  public aids(PhoneContactTabView paramPhoneContactTabView, Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, boolean paramBoolean)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null) {
      localView = aidz.a(paramViewGroup, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberPhoneContactTabView.jdField_a_of_type_AndroidViewLayoutInflater, 2131558857);
    }
    paramView = (aidz)localView.getTag();
    if (i < 0)
    {
      i = -(i + 1) - 1;
      ...
      aidz.a(this, paramView, paramViewGroup);
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberPhoneContactTabView.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.b(paramView.jdField_a_of_type_JavaLangString))
      {
        ...
        if ((AppSetting.d) && (paramView.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
        {
          ...
          localView.setContentDescription(paramViewGroup.name + ajya.a(2131708002));
        }
      }
      for (;;)
      {
        ...
        break;
        label265:
        localView.setContentDescription(paramViewGroup.name + ajya.a(2131708000));
      }
    }
