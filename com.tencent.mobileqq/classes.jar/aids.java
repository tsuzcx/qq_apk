  ...
  extends anqd
{
  ...
  protected void a(boolean paramBoolean, String[] paramArrayOfString)
  {
    if ((paramBoolean) && (paramArrayOfString != null))
    {
      ...
      if (this.a.jdField_a_of_type_Bers.b.contains(paramArrayOfString))
      {
        this.a.jdField_a_of_type_Bers.a.put(paramArrayOfString, Integer.valueOf(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(paramArrayOfString, 1)));
