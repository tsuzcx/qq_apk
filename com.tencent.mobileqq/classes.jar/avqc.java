  ...
  extends avpz
{
  ...
  public String a;
  private AccountObserver jdField_a_of_type_MqqObserverAccountObserver = new avqd(this);
  public boolean a;
  ...
  public avqc(RegisterNewBaseActivity paramRegisterNewBaseActivity)
  {
  ...
  private void a(Intent paramIntent, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Aals != null)
      {
        this.jdField_a_of_type_Aals.d();
        this.jdField_a_of_type_Aals = null;
      }
      this.jdField_a_of_type_Aals = new aals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity, this.jdField_a_of_type_AndroidContentIntent);
      this.jdField_a_of_type_Aals.a();
      this.jdField_a_of_type_Aals.e();
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    try
    {
      if (this.jdField_a_of_type_Boolean) {
        localAccountManager.getQuickRegisterAccount(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.jdField_d_of_type_JavaLangString, this.jdField_e_of_type_JavaLangString, AppSetting.a(), "8.2.8", this.jdField_a_of_type_MqqObserverAccountObserver);
      }
      for (;;)
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.b(2131717069);
        return;
        aumi.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, true);
        localAccountManager.sendRegisterBySetPass(paramString2, paramString1, this.jdField_a_of_type_JavaLangString, this.f, this.jdField_e_of_type_Boolean, "8.2.8", this.jdField_a_of_type_MqqObserverAccountObserver);
      }
      return;
    }
