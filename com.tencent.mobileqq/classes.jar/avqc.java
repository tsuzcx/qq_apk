  ...
  extends avqb
{
  ...
  private WtloginObserver jdField_a_of_type_MqqObserverWtloginObserver = new avqd(this);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = avqc.class.getSimpleName();
  }
  ...
  public void a(String paramString)
  {
    try
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.b(2131717080);
      if (aumk.a().a(this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.app, this.c.getBytes(), paramString.getBytes(), this.d, this.jdField_a_of_type_MqqObserverWtloginObserver) != 0)
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.c();
        this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.a(2131717143, 1);
      }
      return;
    }
