...
public class akgm
{
  public static int a()
  {
    int j = 1;
    int i;
    if ((bgln.d() >>> 20 < 600L) || (bgln.b() == 1)) {
      i = 0;
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
        QLog.d("StatisticConstants", 2, "getDeviceType,DeviceInfoUtil.getSystemTotalMemory() =" + (bgln.d() >>> 20) + ",DeviceInfoUtil.getCpuNumber() = " + bgln.b() + ",phoneType = " + i);
      }
      return i;
      i = j;
      if (bgln.d() >>> 20 >= 1536.0D)
      {
        i = j;
        if (bgln.b() >= 4) {
          i = 2;
  ...
  public static void a(int paramInt1, int paramInt2)
  {
    ...
    if ((paramInt1 > 0) && (paramInt2 > 0))
    {
      ...
      if (l2 - l1 > 86400000L)
      {
        ...
        bctj.a(BaseApplication.getContext()).a(null, "PhotoConst.photopreviewactivity_send", false, 0L, 0L, localHashMap, "", false);
  ...
  public static void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8, int paramInt9, int paramInt10, int paramInt11)
  {
    ...
    if (l2 - l1 > 86400000L)
    {
      ...
      bctj.a(BaseApplication.getContext()).a(null, "actAlbumPicSourceType", false, 0L, 0L, localHashMap, "", false);
  ...
  public static void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8, int paramInt9, int paramInt10, int paramInt11, int paramInt12, int paramInt13, int paramInt14, int paramInt15, int paramInt16)
  {
    ...
    if (l2 - l1 > 86400000L)
    {
      ...
      bctj.a(BaseApplication.getContext()).a(null, "actDaySendPicSourceType", false, 0L, 0L, localHashMap, "", false);
  ...
  public static void a(long paramLong)
  {
    ...
    for (int i = 1002;; i = 1001)
    {
      ...
      bctj.a(BaseApplication.getContext()).a(null, "actPSdayWastedSize", false, 0L, 0L, localHashMap, "", false);
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  public static void a(long paramLong, int paramInt)
  {
    ...
    for (int i = 1002;; i = 1001)
    {
      ...
      bctj.a(BaseApplication.getContext()).a(null, "actPSWaste", false, 0L, 0L, localHashMap, "", false);
      if (QLog.isColorLevel()) {
  ...
  public static void a(long paramLong, int paramInt, boolean paramBoolean)
  {
    ...
    for (int i = 1002;; i = 1001)
    {
      ...
      bctj.a(BaseApplication.getContext()).a(null, "actPSdonecompressPic", false, 0L, 0L, localHashMap, "", false);
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  public static void a(long paramLong1, long paramLong2, boolean paramBoolean, double paramDouble)
  {
    ...
    for (int i = 1002;; i = 1001)
    {
      ...
      bctj.a(BaseApplication.getContext()).a(null, "actPSdoneaioduration", false, 0L, 0L, localHashMap, "", false);
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  public static void a(Intent paramIntent)
  {
    ...
    for (l1 = l2 / i;; l1 = 0L)
    {
      ...
      bctj.a(BaseApplication.getContext()).a(null, "actPScompressPic", false, 0L, 0L, localHashMap, "", false);
  ...
  public static void a(Intent paramIntent, int paramInt)
  {
    ...
    if ((paramInt > 0) && (i > 0))
    {
      ...
      if (l2 - l1 > 86400000L)
      {
        ...
        bctj.a(BaseApplication.getContext()).a(null, "actPSdaySelSend", false, 0L, 0L, localHashMap, "", false);
  ...
  public static void a(Intent paramIntent, int paramInt1, int paramInt2)
  {
    ...
    for (l1 = l2 / paramInt1;; l1 = 0L)
    {
      ...
      localHashMap.put("param_averageTime", l1 + "");
      bctj.a(BaseApplication.getContext()).a(null, "actPSselectSendPic", false, 0L, 0L, localHashMap, "", false);
  ...
  public static void a(String paramString, int paramInt, QQAppInterface paramQQAppInterface)
  {
    ...
    //   11: checkcast 420	axby
    //   14: astore_2
    //   15: aload_2
    //   16: ifnull +962 -> 978
    //   19: aload_2
    //   20: invokevirtual 421	axby:a	()I
    //   23: istore 4
    //   25: aload_2
    //   26: invokevirtual 422	axby:b	()I
    //   29: istore_3
    ...
    //   43: aload_0
    //   44: aload_2
    //   45: invokestatic 434	bgmo:a	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   48: pop
    //   49: aload_2
    ...
    //   64: iload 8
    //   66: i2l
    //   67: invokestatic 446	baro:a	(JJ)I
    //   70: istore 9
    //   72: iload_1
    //   73: istore 5
    //   75: iload_1
    ...
    //   153: astore_2
    //   154: aload_0
    //   155: invokestatic 476	bgmg:b	(Ljava/lang/String;)Ljava/lang/String;
    //   158: astore 16
    //   160: aload 16
    ...
    //   578: invokestatic 133	bctj:a	(Landroid/content/Context;)Lbctj;
    //   581: aconst_null
    //   582: ldc_w 534
    //   585: iconst_0
    //   586: lconst_0
    ...
    //   589: ldc 119
    //   591: iconst_0
    //   592: invokevirtual 138	bctj:a	(Ljava/lang/String;Ljava/lang/String;ZJJLjava/util/HashMap;Ljava/lang/String;Z)V
    ...
    //   762: invokestatic 133	bctj:a	(Landroid/content/Context;)Lbctj;
    //   765: aconst_null
    //   766: ldc_w 542
    //   769: iconst_0
    //   770: lconst_0
    ...
    //   773: ldc 119
    //   775: iconst_0
    //   776: invokevirtual 138	bctj:a	(Ljava/lang/String;Ljava/lang/String;ZJJLjava/util/HashMap;Ljava/lang/String;Z)V
    //   779: aload_0
    ...
    //   829: ifeq +144 -> 973
    //   832: aload_2
    //   833: invokestatic 550	bkcx:a	(Ljava/io/File;)Ljava/lang/String;
    //   836: astore_2
    //   837: aload_2
    //   838: ifnull +11 -> 849
    //   841: aload_2
  ...
  private static void a(String paramString, int paramInt1, boolean paramBoolean1, boolean paramBoolean2, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7)
  {
    ...
    for (;;)
    {
      try
      {
        bgmo.a(paramString, (BitmapFactory.Options)localObject1);
        ...
        try
        {
          ...
          if ((localObject1 != null) && (paramString.contains((CharSequence)localObject1)))
          {
            ...
            if (paramString.toLowerCase(Locale.US).contains("gif"))
            {
              ...
              int m = i2;
              int n = i1;
              if (paramString.contains(anhk.bk))
              {
              ...
              i = baro.a(n, m);
              i1 = bgnt.a(BaseApplication.getContext());
              if (QLog.isDevelopLevel()) {
              ...
              bctj.a(BaseApplication.getContext()).a(null, "actPhotoSourceDetailUrl", false, 0L, 0L, paramString, "", false);
              return;
  ...
  public static void a(String[] paramArrayOfString, int paramInt1, boolean paramBoolean1, boolean paramBoolean2, int paramInt2, QQAppInterface paramQQAppInterface)
  {
    ...
    {
      return;
      paramQQAppInterface = (axby)paramQQAppInterface.getManager(106);
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        else if ((str3.contains("screenshot")) || (str3.contains(anni.a(2131713045))) || (str3.contains(anni.a(2131713048))) || (str3.equals("screen_cap")) || (str3.equals("ScreenCapture")))
        {
          i1 += 1;
          i14 = i;
          k = 1010;
        ...
        else if ((paramQQAppInterface.contains("camera")) || (paramQQAppInterface.equals("dcim")) || (paramQQAppInterface.equals("100MEDIA")) || (paramQQAppInterface.equals("100ANDRO")) || (paramQQAppInterface.contains(anni.a(2131713044))) || (paramQQAppInterface.contains(anni.a(2131713047))) || (paramQQAppInterface.contains(anni.a(2131713046))))
        {
          k = 1011;
          i14 = i + 1;
          i = j;
  ...
  public static void b()
  {
    ...
    if (l2 - l1 > 86400000L)
    {
      ...
      bctj.a(BaseApplication.getContext()).a(null, "actPSdayCameraSend", false, 0L, 0L, localHashMap, "", false);
  ...
  public static void b(Intent paramIntent, int paramInt)
  {
    ...
    do
    {
      ...
      bctj.a(BaseApplication.getContext()).a(null, "actPScancelSend", false, 0L, 0L, localHashMap, "", false);
      paramIntent.removeExtra("param_initTime");
      paramIntent.removeExtra("param_cancelSelNum");
      paramIntent.removeExtra("param_totalSelNum");
    } while (!QLog.isColorLevel());
  ...
  public static void d()
  {
    ...
    if (l2 - l1 > 86400000L)
    {
      ...
      bctj.a(BaseApplication.getContext()).a(null, "actPSdayQuickSend", false, 0L, 0L, localHashMap, "", false);
  ...
  public static void e()
  {
    ...
    for (int i = 1002;; i = 1001)
    {
      ...
      localHashMap.put("param_phone_type", k + "");
      localHashMap.put("param_userType", i + "");
      bctj.a(BaseApplication.getContext()).a(null, "actPSCompressTimeOut", false, 0L, 0L, localHashMap, "", false);
      if (QLog.isColorLevel()) {
