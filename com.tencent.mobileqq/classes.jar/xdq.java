...
{
  xdq(xdo paramxdo, long paramLong, String paramString) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (((WebSSOAgent.UniSsoServerRsp)localObject3).comm.has())
        {
          ...
          if (!TextUtils.isEmpty(paramBundle))
          {
            if (((WebSSOAgent.UniSsoServerRsp)localObject3).comm.delayms.has())
            {
              ...
              this.jdField_a_of_type_Xdo.e.put(paramBundle, Integer.valueOf(2147483647));
              if (QLog.isColorLevel()) {
            ...
            if (((WebSSOAgent.UniSsoServerRsp)localObject3).comm.packagesize.has())
            {
              ...
              this.jdField_a_of_type_Xdo.b.put(paramBundle, Long.valueOf(l1));
              if (QLog.isColorLevel()) {
        ...
        xdo.a(this.jdField_a_of_type_Xdo, this.jdField_a_of_type_JavaLangString, l2, paramInt);
        ...
        aquf.d = System.currentTimeMillis();
        l1 = aquf.d - aquf.jdField_a_of_type_Long;
        long l3 = aquf.b - aquf.jdField_a_of_type_Long;
        long l4 = aquf.c - aquf.b;
        long l5 = aquf.d - aquf.c;
        if (QLog.isColorLevel()) {
        ...
        this.jdField_a_of_type_Xdo.callJs((String)localObject1, new String[] { ((JSONObject)localObject2).toString() });
        try
        {
          ...
          localObject3 = this.jdField_a_of_type_Xdo.mRuntime.a().getCurrentAccountUin();
          ...
          localObject1 = awrn.a(this.jdField_a_of_type_Xdo.mRuntime.a());
          if (0L != l6) {
            break;
          }
          paramBoolean = true;
          label1110:
          ((awrn)localObject1).a((String)localObject3, paramBundle, paramBoolean, l1, 0L, (HashMap)localObject2, "", false);
          return;
        }
      ...
      return;
      label1197:
      this.jdField_a_of_type_Xdo.e.put(paramBundle, Integer.valueOf((int)l1));
      continue;
      label1218:
      xdo.a(this.jdField_a_of_type_Xdo, this.jdField_a_of_type_JavaLangString, paramInt);
      continue;
      label1233:
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject3)) {
        xdo.b(this.jdField_a_of_type_Xdo, (String)localObject3, paramInt);
      }
      ...
      ((JSONObject)localObject2).put("businessRet", 0);
      ((JSONObject)localObject2).put("msg", ajjy.a(2131648546));
    }
    for (;;)
    {
      label1431:
      ...
      ((JSONObject)localObject2).put("businessRet", 0);
      ((JSONObject)localObject2).put("msg", ajjy.a(2131648552));
      break;
      label1510:
      label1511:
      do
      {
        ((JSONObject)localObject2).put("ssoRet", 255);
        ((JSONObject)localObject2).put("businessRet", 0);
        ((JSONObject)localObject2).put("msg", ajjy.a(2131648551));
        break;
        paramBoolean = false;
        break label1110;
        return;
