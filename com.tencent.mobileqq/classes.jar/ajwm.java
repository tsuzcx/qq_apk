...
public class ajwm
  extends ajwi
{
  public ajwm(QQAppInterface paramQQAppInterface, ajwh paramajwh)
  {
    super(paramQQAppInterface, paramajwh, RoamDate.class);
  }
  ...
  {
    paramatmo = (RoamDate)paramatmo;
    return paramatmo.uin + "&" + paramatmo.date;
  }
  ...
  public Calendar a(String paramString, Calendar paramCalendar, List<Map.Entry<String, atmo>> paramList)
  {
  ...
  public void a(String paramString)
  {
    ...
    paramString = ((atmp)localObject).a(RoamDate.class, false, "uin=?", new String[] { paramString }, null, null, null, null);
    ((atmp)localObject).a();
    if (paramString != null)
    {
      c();
  ...
  public boolean a(String paramString, Calendar paramCalendar, List<Map.Entry<String, atmo>> paramList)
  {
    boolean bool2 = false;
    boolean bool1 = bool2;
    int j;
  ...
  public Calendar b(String paramString, Calendar paramCalendar, List<Map.Entry<String, atmo>> paramList)
  {
    Object localObject3 = null;
    Object localObject2 = null;
    Object localObject1 = paramList;
