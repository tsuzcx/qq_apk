...
public class akmx
{
  ...
  public static FullMessageSearchResult.SearchResultItem a(QQAppInterface paramQQAppInterface, aukp paramaukp, Cursor paramCursor, String paramString1, int paramInt, String paramString2, akmv paramakmv)
  {
    ...
    {
      if ((paramakmv.c == 3) || (paramakmv.c == 2)) {
        return null;
      }
    ...
    for (;;)
    {
      ...
      if (paramInt != 0)
      {
        ...
        {
          paramString1 = (MessageRecord)paramaukp.a(MessageRecord.class, null, paramCursor);
              ...
              if (bool)
              {
                ...
                if (TextUtils.isEmpty(paramString2))
                {
                  ...
                  if ((localObject instanceof AbsStructMsg))
                  {
                    ...
                    paramString1 = paramakmv.a;
                    paramaukp = paramQQAppInterface;
                    if (paramString1 == null) {
                      break;
                    }
