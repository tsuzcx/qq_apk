  ...
  extends ailz
{
  public int a;
  public String a;
  public LinkedHashMap<String, List<agas>> a;
  public List<agas> a;
  public int[] a;
  public String[] a;
  public int b;
  ...
  public agau(ChatHistoryTroopMemberFragment paramChatHistoryTroopMemberFragment)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 5) {
        paramChatHistoryTroopMemberFragment = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131696604);
      } else {
        paramChatHistoryTroopMemberFragment = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131720560);
      }
    }
  }
  ...
  public void a(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        ((TextView)paramView).setText(this.jdField_a_of_type_ArrayOfJavaLangString[paramInt] + this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131720927, new Object[] { Integer.valueOf(localList.size()) }));
        if (!this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_n_of_type_Boolean) {
          break label207;
        }
        paramView.setBackgroundResource(2130838514);
      }
      for (;;)
      {
        ...
        break;
        label207:
        paramView.setBackgroundResource(2130849030);
      }
    }
  }
  ...
  public Object[] a()
  {
    ...
    Object localObject6 = (bamk)this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getManager(203);
    Object localObject9;
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment)
      {
        ...
        if (((bamk)localObject6).b(localagas.jdField_a_of_type_JavaLangString))
        {
          ...
          ((List)localObject8).add(localagas);
        }
      }
      ...
      {
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_n_of_type_JavaLangString != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_n_of_type_JavaLangString.contains(localagas.jdField_a_of_type_JavaLangString))) {
          localArrayList2.add(localagas);
        }
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_JavaLangString != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_JavaLangString.contains(localagas.jdField_a_of_type_JavaLangString)) && (!this.jdField_a_of_type_JavaUtilList.contains(localagas))) {
          this.jdField_a_of_type_JavaUtilList.add(localagas);
        }
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_b_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_b_of_type_JavaUtilArrayList.contains(localagas.jdField_a_of_type_JavaLangString)) && (!this.jdField_a_of_type_JavaUtilList.contains(localagas)))
        {
          this.jdField_a_of_type_JavaUtilList.add(localagas);
          this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_b_of_type_JavaUtilArrayList.remove(localagas.jdField_a_of_type_JavaLangString);
        }
      }
      ...
      {
        if ((!this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.e) && ((localagas.jdField_a_of_type_Boolean) || (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_JavaUtilList.contains(localagas.jdField_a_of_type_JavaLangString)))) {
          ((List)localObject9).add(localagas);
        }
        if ((!this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.e) && (localagas.jdField_b_of_type_Boolean)) {
          localArrayList1.add(localagas);
        }
        if ((!localagas.jdField_a_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())) && (localagas.jdField_d_of_type_Long == 1L)) {
          ((List)localObject10).add(localagas);
        }
      }
      if (((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.f != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.f.equals(localagas.jdField_a_of_type_JavaLangString))) || ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_g_of_type_JavaLangString != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_g_of_type_JavaLangString.contains(localagas.jdField_a_of_type_JavaLangString))) || ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.e) && ((localagas.jdField_a_of_type_Int == 332) || (localagas.jdField_a_of_type_Int == 333))))
      {
        ((List)localObject7).add(localagas);
        if (QLog.isColorLevel()) {
          QLog.d("zivonchen", 2, "constructHashStruct uin = " + localagas.jdField_a_of_type_JavaLangString + ", name = " + localagas.jdField_g_of_type_JavaLangString + ", level = " + localagas.jdField_a_of_type_Int);
        }
      }
      else if ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 5) && (!TextUtils.isEmpty(localagas.u)))
      {
        ((List)localObject7).add(localagas);
      }
      else
      {
        if (localagas.jdField_c_of_type_JavaLangString == null) {
          break label4292;
        }
        if (localagas.jdField_c_of_type_JavaLangString.length() == 0) {
          break label4292;
        }
        for (;;)
        {
          ...
          ((List)localObject1.get(localObject4)).add(localagas);
          break;
          localObject3 = localagas.jdField_c_of_type_JavaLangString.substring(0, 1);
        }
      }
    }
    localObject6 = new agav(0, true);
    ...
    else
    {
      for (;;)
      {
        if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.h) {
          localObject1.remove(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131719729));
        }
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 21)
        {
          this.jdField_a_of_type_Int = 0;
          Collections.sort((List)localObject7, (Comparator)localObject6);
          ((LinkedHashMap)localObject4).put(ajya.a(2131701593), this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_a_of_type_JavaUtilList);
          break label4323;
        }
        if ((((List)localObject9).size() > 0) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int != 12))
        {
          ...
          ((LinkedHashMap)localObject4).put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131719729), localObject9);
        }
        if ((localArrayList1.size() > 0) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int != 3))
        {
          ...
          ((LinkedHashMap)localObject4).put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131720546), localArrayList1);
        }
        if ((((List)localObject10).size() > 0) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int != 3))
        {
          ...
          ((LinkedHashMap)localObject4).put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131691319), localObject10);
        }
        if (((List)localObject7).size() > 0)
        {
          Collections.sort((List)localObject7, (Comparator)localObject6);
        ...
        for (localObject3 = ChatHistoryTroopMemberFragment.a(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment);; localObject3 = this.jdField_a_of_type_JavaLangString)
        {
          ...
          ((LinkedHashMap)localObject4).put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131720562), localObject8);
          break label4330;
          if (c1 > 'Z') {
            break;
          }
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_Int == 2)
        {
          ...
          {
            localObject7 = (agas)((Iterator)localObject6).next();
            if (TextUtils.isEmpty(((agas)localObject7).r)) {
              ((agas)localObject7).r = a((String[])localObject4, ((agas)localObject7).jdField_b_of_type_Long, (Calendar)localObject3);
            }
            if (localObject1.get(((agas)localObject7).r) == null) {
              localObject1.put(((agas)localObject7).r, new ArrayList());
            }
            ((List)localObject1.get(((agas)localObject7).r)).add(localObject7);
          }
          ...
          if (i >= 0)
          {
            ...
            Collections.sort((List)localObject1.get(localObject4[i]), new agav(2, false));
        ...
        else if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_Int == 6)
        {
          ...
          {
            localObject6 = (agas)((Iterator)localObject4).next();
            if (TextUtils.isEmpty(((agas)localObject6).r))
            {
              if (((agas)localObject6).jdField_b_of_type_Long == 0L) {
                ((agas)localObject6).jdField_b_of_type_Long = ((agas)localObject6).jdField_a_of_type_Long;
              }
              ((agas)localObject6).r = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.a(((agas)localObject6).jdField_b_of_type_Long, (Calendar)localObject3, ChatHistoryTroopMemberFragment.d(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment), ChatHistoryTroopMemberFragment.e(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment));
            }
            if (localObject2.get(((agas)localObject6).r) == null) {
              localObject2.put(((agas)localObject6).r, new ArrayList());
            }
            if (!TextUtils.isEmpty(((agas)localObject6).r)) {
              ((List)localObject2.get(((agas)localObject6).r)).add(localObject6);
            }
          }
          localObject3 = new LinkedHashMap();
          ...
          if (i >= 0)
          {
            ...
            Collections.sort((List)localObject2.get(ChatHistoryTroopMemberFragment.e(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment).get(i)), new agav(2, false));
        ...
        else
        {
          ...
          localObject4 = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getResources().getStringArray(2130968675);
          localObject3 = Calendar.getInstance();
          ((Calendar)localObject3).setTimeInMillis(NetConnInfoCenter.getServerTime() * 1000L);
          localObject6 = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_a_of_type_JavaUtilList.iterator();
          while (((Iterator)localObject6).hasNext())
          {
            localObject7 = (agas)((Iterator)localObject6).next();
            if (TextUtils.isEmpty(((agas)localObject7).q)) {
              ((agas)localObject7).q = b((String[])localObject4, ((agas)localObject7).jdField_a_of_type_Long, (Calendar)localObject3);
            }
            if (localObject2.get(((agas)localObject7).q) == null) {
              localObject2.put(((agas)localObject7).q, new ArrayList());
            }
            ((List)localObject2.get(((agas)localObject7).q)).add(localObject7);
          }
          localObject3 = new LinkedHashMap();
          i = localObject4.length - 1;
          if (i >= 0)
          {
            ...
            Collections.sort((List)localObject2.get(localObject4[i]), new agav(3, false));
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_Int == 1)
      {
        ...
        {
          localObject10 = (agas)((Iterator)localObject9).next();
          if (((bamk)localObject6).b(((agas)localObject10).jdField_a_of_type_JavaLangString))
          {
            if ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int != 5) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int != 2) && (!ChatHistoryTroopMemberFragment.f(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment))) {
              if ((this.jdField_c_of_type_JavaUtilList != null) && (this.jdField_c_of_type_JavaUtilList.contains(((agas)localObject10).jdField_a_of_type_JavaLangString)))
              {
                ((List)localObject3).add(localObject10);
                ((agas)localObject10).jdField_d_of_type_Boolean = true;
              }
              else
              {
                ((List)localObject8).add(localObject10);
                ((agas)localObject10).jdField_d_of_type_Boolean = false;
              }
            }
          }
          else if ((this.jdField_c_of_type_JavaUtilList != null) && (this.jdField_c_of_type_JavaUtilList.contains(((agas)localObject10).jdField_a_of_type_JavaLangString)))
          {
            ((agas)localObject10).jdField_d_of_type_Boolean = true;
            if (((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.f != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.f.equals(((agas)localObject10).jdField_a_of_type_JavaLangString))) || ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_g_of_type_JavaLangString != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_g_of_type_JavaLangString.contains(((agas)localObject10).jdField_a_of_type_JavaLangString))) || ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.e) && ((((agas)localObject10).jdField_a_of_type_Int == 332) || (((agas)localObject10).jdField_a_of_type_Int == 333)))) {
        ...
        localObject2.clear();
        Collections.sort((List)localObject3, new agav(1, false));
        if (((List)localObject3).size() > 0) {
          localObject2.put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131720562), localObject3);
        }
        if (((List)localObject4).size() > 0)
        {
          Collections.sort((List)localObject4, new agav(1, false));
        ...
        for (localObject3 = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131694860);; localObject3 = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131694859))
        {
          localObject2.put(localObject3, localObject4);
          Collections.sort((List)localObject7, new agav(1, false));
          if (((List)localObject7).size() > 0) {
            localObject2.put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131720558), localObject7);
          }
          Collections.sort((List)localObject8, new agav(1, false));
          if (((List)localObject8).size() <= 0) {
            break;
          }
          localObject2.put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131720557), localObject8);
          break;
        }
      }
      if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_Int == 7)
      {
        ...
        while (i < j)
        {
          localObject9 = (agas)this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_a_of_type_JavaUtilList.get(i);
          ((agas)localObject9).k = 0;
          ((HashMap)localObject8).put(((agas)localObject9).jdField_a_of_type_JavaLangString, localObject9);
          i += 1;
        }
        if (ChatHistoryTroopMemberFragment.a(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment) != null)
        {
          ...
          {
            localObject9 = (agas)((HashMap)localObject8).remove(String.valueOf(ChatHistoryTroopMemberFragment.a(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment)[i]));
        ...
        if (ChatHistoryTroopMemberFragment.b(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment) != null)
        {
          ...
          {
            localObject9 = (agas)((HashMap)localObject8).remove(String.valueOf(ChatHistoryTroopMemberFragment.b(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment)[i]));
            if (localObject9 == null) {
              break label4375;
            }
        ...
        if (ChatHistoryTroopMemberFragment.c(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment) != null)
        {
          ...
          {
            localObject9 = (agas)((HashMap)localObject8).remove(String.valueOf(ChatHistoryTroopMemberFragment.c(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment)[i]));
            if (localObject9 == null) {
              break label4382;
            }
        ...
        Collections.sort((List)localObject3, new agav(2, true));
        if (!((List)localObject3).isEmpty()) {
          localObject2.put(ajya.a(2131701606), localObject3);
        }
        if (!((List)localObject4).isEmpty()) {
          localObject2.put(ajya.a(2131701666), localObject4);
        }
        if (!((List)localObject6).isEmpty()) {
          localObject2.put(ajya.a(2131701632), localObject6);
        }
        Collections.sort((List)localObject7, new agav(2, true));
        if (((List)localObject7).isEmpty()) {
          break label4389;
        }
        localObject2.put(ajya.a(2131701591), localObject7);
        break label4389;
      }
      if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_Int == 8)
      {
        ...
        {
          localObject8 = (agas)((Iterator)localObject7).next();
          localObject9 = (oidb_0xa2a.UserInfo)((HashMap)localObject6).get(((agas)localObject8).jdField_a_of_type_JavaLangString);
          if (localObject9 != null)
          {
            ((List)localObject3).add(localObject8);
            ((agas)localObject8).l = ((oidb_0xa2a.UserInfo)localObject9).score.get();
          }
          else
          {
        ...
        if (((List)localObject3).size() > 0)
        {
          Collections.sort((List)localObject3, new agav(8, false));
          localObject2.put(ajya.a(2131701628), localObject3);
        }
        if (((List)localObject4).size() <= 0) {
          break label4392;
        }
        Collections.sort((List)localObject4, new agav(8, false));
        localObject2.put(ajya.a(2131701621), localObject4);
        break label4392;
      }
      if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_Int == 4)
      {
        localObject3 = new LinkedHashMap();
        localObject4 = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getResources().getStringArray(2130968669);
        localObject6 = ajya.a(2131701597);
        localObject7 = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_a_of_type_JavaUtilList.iterator();
        while (((Iterator)localObject7).hasNext())
        {
          localObject8 = (agas)((Iterator)localObject7).next();
          j = ((agas)localObject8).jdField_a_of_type_Int;
          i = j;
          if (j >= 10000) {
            i = ((agas)localObject8).jdField_a_of_type_Int - 10000;
          }
          if ((i >= 321) && (i <= 327))
          {
    ...
    for (;;)
    {
      if (i >= 0)
      {
        ...
        {
          Collections.sort((List)((LinkedHashMap)localObject3).get(localObject4[i]), new agav(0, false));
      ...
      else
      {
        if (((LinkedHashMap)localObject3).get(localObject6) != null)
        {
          Collections.sort((List)((LinkedHashMap)localObject3).get(localObject6), new agav(0, false));
          localObject2.put(localObject6, ((LinkedHashMap)localObject3).get(localObject6));
        }
        yoa.a(null, "846", "205607", "", "84601", "1", "145");
        break label976;
        label4065:
        localObject3[0] = 0;
        i = 1;
  ...
  public Object getItem(int paramInt)
  {
    ...
    int i = -(i + 1) - 1;
    return (agas)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[i])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[i] - 1);
  }
  ...
  public int getItemViewType(int paramInt)
  {
    if (ChatHistoryTroopMemberFragment.e(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment))
    {
      ...
      {
        i = -(i + 1) - 1;
        agas localagas = (agas)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[i])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[i] - 1);
        if ((TextUtils.isEmpty(localagas.jdField_m_of_type_JavaLangString)) && (!TextUtils.isEmpty(localagas.p)) && (!TextUtils.isEmpty(localagas.jdField_g_of_type_JavaLangString)) && (!localagas.jdField_g_of_type_JavaLangString.equals(localagas.p))) {
          return 1;
        }
      }
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null) {
      if (i == 0)
      {
        paramViewGroup = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562550, paramViewGroup, false);
        paramView = new agaz(paramViewGroup, false);
        if (!this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_n_of_type_Boolean) {
          break label253;
        }
        paramView.jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setBackgroundResource(2130839132);
        ...
        localObject1 = (agas)this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_a_of_type_JavaUtilList.get(paramInt);
        paramViewGroup.g.setTag(((agas)localObject1).jdField_a_of_type_JavaLangString);
        paramViewGroup.jdField_b_of_type_AndroidViewView.setTag(((agas)localObject1).jdField_a_of_type_JavaLangString);
        paramViewGroup.jdField_a_of_type_AndroidViewView.setTag(((agas)localObject1).jdField_a_of_type_JavaLangString);
        paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setTag(Integer.valueOf(paramInt));
        this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.a(paramViewGroup, (agas)localObject1, a(((agas)localObject1).jdField_a_of_type_JavaLangString, 2), false, false);
      }
    }
    label253:
    int j;
    for (;;)
    {
      ...
      return paramView;
      paramViewGroup = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562554, paramViewGroup, false);
      paramView = new agaz(paramViewGroup, true);
      break;
      paramView.jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setBackgroundResource(2130839129);
      break label65;
      ...
      j = -(j + 1) - 1;
      localObject1 = (agas)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[j])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[j] - 1);
      paramViewGroup.g.setTag(((agas)localObject1).jdField_a_of_type_JavaLangString);
      paramViewGroup.jdField_b_of_type_AndroidViewView.setTag(((agas)localObject1).jdField_a_of_type_JavaLangString);
      paramViewGroup.jdField_a_of_type_AndroidViewView.setTag(((agas)localObject1).jdField_a_of_type_JavaLangString);
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setTag(Integer.valueOf(paramInt));
      Object localObject2;
      if (((agas)localObject1).jdField_c_of_type_Boolean)
      {
        localObject2 = new ayjw(((agas)localObject1).jdField_b_of_type_JavaLangString, 16).a();
        paramViewGroup.jdField_e_of_type_AndroidWidgetTextView.setText((CharSequence)localObject2);
        bbos.a(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, paramViewGroup.jdField_e_of_type_AndroidWidgetTextView, (Spannable)localObject2);
        paramViewGroup.c.setImageResource(2130839295);
      ...
      for (;;)
      {
        ...
        Bitmap localBitmap = a(((agas)localObject1).jdField_a_of_type_JavaLangString, 2);
        if (i == 1) {}
        for (;;)
        {
          ((ChatHistoryTroopMemberFragment)localObject2).a(paramViewGroup, (agas)localObject1, localBitmap, false, bool);
          break;
          bool = false;
        }
        label564:
      ...
      label576:
      if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_a_of_type_Agbf != null)
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_a_of_type_Agbf.a(paramViewGroup, (agas)localObject1);
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 9) || (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 19))
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 12)
      {
        ...
        {
          localObject1 = (agas)((List)localObject1).get(paramInt);
          if (!this.jdField_a_of_type_JavaUtilList.contains(localObject1)) {
            break label1012;
          }
          paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131720562).equals(String.valueOf(this.jdField_a_of_type_ArrayOfJavaLangString[j])))
      {
      ...
      paramViewGroup.jdField_b_of_type_AndroidWidgetTextView.setText(String.valueOf(this.jdField_a_of_type_ArrayOfJavaLangString[j]) + this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131720927, new Object[] { Integer.valueOf(((List)localObject1).size()) }));
      break label766;
      label1012:
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
    }
