...
public class aayr
  extends bpen
  implements aaxp, Handler.Callback, View.OnClickListener, bpam
{
  public float a;
  public int a;
  ...
  private String jdField_d_of_type_JavaLangString = (String)aavz.a().a("KEY_SMART_MUSIC_ENTER_ANIM_DOWNLOAD_URL", "https://down.qq.com/video_story/smart_music_anim.zip");
  ...
  public aayr(@NonNull bpep parambpep)
  {
    super(parambpep);
    ...
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new aayy(this);
  }
  ...
  private bpez a()
  {
    if (this.jdField_a_of_type_Bpez == null) {
      this.jdField_a_of_type_Bpez = ((bpez)this.jdField_a_of_type_Bpep.a(bpez.class));
    }
  ...
  private void a(int paramInt, aazd paramaazd)
  {
    if (paramaazd == null) {
      paramaazd = (aazd)this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewSmartMusicRecyclerView.findViewHolderForAdapterPosition(paramInt);
    }
    for (;;)
    {
      this.jdField_a_of_type_Int = paramInt;
      this.jdField_a_of_type_Aazd = paramaazd;
      if ((this.jdField_a_of_type_Aazd != null) && (!this.jdField_a_of_type_Boolean))
      {
  ...
  private void a(Intent paramIntent)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        try
        {
          ...
          if (this.jdField_a_of_type_Aaxo != null)
          {
            this.jdField_a_of_type_Aaxo.c();
            i();
          }
          ...
          if (this.jdField_a_of_type_Aaza.a() <= 0) {
            break label280;
          }
          i = 1;
          if (i == 0) {
          ...
          if (this.jdField_a_of_type_Aaza.a(this.jdField_a_of_type_Int, paramIntent))
          {
          ...
          this.jdField_d_of_type_Int = (this.jdField_a_of_type_Aaza.a(paramIntent.mSongMid) + a());
          if (this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewSmartMusicRecyclerView == null) {
            break;
          }
    ...
    this.jdField_a_of_type_Aaza.a((ArrayList)localObject1);
  }
  
  private void a(VsMusicItemInfo paramVsMusicItemInfo, int paramInt, aazd paramaazd)
  {
  ...
  private void a(ArrayList<FrameVideoHelper.FrameBuffer> paramArrayList)
  {
    ...
    paramArrayList = new SmartMusicMatchRequest(paramArrayList, bnnx.a().a(), this.jdField_f_of_type_Boolean, this.jdField_c_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo);
    this.jdField_c_of_type_JavaLangString = paramArrayList.getCmdName();
    VSNetworkHelper.a().a(a(), paramArrayList, new aayx(this));
  }
  ...
  {
    if (this.jdField_a_of_type_Aaza != null) {
      this.jdField_a_of_type_Aaza.a(paramArrayList, true);
    }
  }
  ...
  {
    Object localObject;
    if ((this.jdField_a_of_type_Bpep.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a instanceof EditTakeVideoSource))
    {
      localObject = (EditTakeVideoSource)this.jdField_a_of_type_Bpep.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a;
      ...
      this.jdField_a_of_type_Aaxo = new aaxo();
      this.jdField_a_of_type_Aaxo.a(this);
      if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo != null)
      {
        this.jdField_a_of_type_Aaxo.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.mDuration);
        a(anni.a(2131702615) + "\n视频时长：" + this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.mDuration / 1000L + "s");
        a(anni.a(2131702632) + this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.mediaWidth + "  " + this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.mediaHeight);
        bnyl.a().a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.mDuration / 1000L);
      }
      if (this.g) {
        this.jdField_a_of_type_Aaxo.a(60000);
      }
      this.jdField_a_of_type_JavaUtilArrayList = ((ArrayList)this.jdField_a_of_type_Bpep.a().getSerializable("KEY_VIDEO_STORY_CAPTYRE_FRAMES"));
      if (this.jdField_a_of_type_Bpep.a().getInt("KEY_VIDEO_STORY_CAMERA_TYPE", 2) != 2) {
        break label345;
      }
    }
    label345:
    for (int i = 0;; i = 1)
    {
      ...
      this.jdField_a_of_type_Long = this.jdField_a_of_type_Bpep.a().getLong("KEY_VIDEO_STORY_CAPTYRE_FRAMES_SIZE");
      k();
      return;
      ...
      localObject = (EditLocalVideoSource)this.jdField_a_of_type_Bpep.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a;
  ...
  private void k()
  {
    ...
    l();
    if ((this.jdField_a_of_type_JavaIoFile.exists()) || (bgsp.a(this.jdField_d_of_type_JavaLangString)))
    {
  ...
  private void n()
  {
    this.jdField_e_of_type_AndroidViewView = a(2131380797);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)a(2131379564));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)a(2131379897));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)a(2131380784));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)a(2131369214));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)a(2131369194));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)a(2131379777));
    this.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)a(2131369112));
    this.jdField_a_of_type_ComTencentBizVideostoryWidgetEasylyricSingleLyricView = ((SingleLyricView)a(2131377657));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)a(2131377667));
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = a().getResources().getDrawable(2130850754);
    this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = a().getResources().getDrawable(2130850753);
    this.jdField_c_of_type_AndroidViewView = a(2131370114);
    this.jdField_c_of_type_AndroidViewView.setOnClickListener(this);
    this.jdField_d_of_type_AndroidViewView = a(2131370107);
    this.jdField_d_of_type_AndroidViewView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)a(2131366700));
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_Bpep.jdField_a_of_type_Bpfx.getActivity().findViewById(2131363524);
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_Bpep.jdField_a_of_type_Bpfx.getActivity().findViewById(2131363522);
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setOnClickListener(this);
    o();
    this.jdField_b_of_type_AndroidWidgetTextView.setOnClickListener(new aayt(this));
    this.jdField_c_of_type_AndroidWidgetTextView.setOnClickListener(new aayu(this));
    if ((this.jdField_c_of_type_AndroidViewView != null) && (this.g)) {
      this.jdField_c_of_type_AndroidViewView.setVisibility(8);
    }
    QLog.d("EditVideoSmartMusicPart", 2, "getRealHeight" + bclx.c(a()) + "ScreenUtil.getRealWidth(getContext())" + bclx.e(a()));
    int i;
    int m;
    int k;
    int j;
    if (bclx.c(a()) / bclx.e(a()) >= 2.0F)
    {
      bqcd.c((Activity)a());
      this.jdField_a_of_type_AndroidViewView.setVisibility(8);
      this.jdField_b_of_type_AndroidViewView.setVisibility(8);
      if ((!bnqb.c.a(this.jdField_a_of_type_Bpep.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.f)) || ((!this.jdField_a_of_type_Bpep.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.c()) && (!this.jdField_a_of_type_Bpep.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a()) && (!this.jdField_a_of_type_Bpep.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.b()))) {
        break label667;
      }
      i = afur.a(105.0F, a().getResources());
      m = afur.a(34.0F, a().getResources());
      k = afur.a(19.0F, a().getResources());
      j = i;
    }
    for (;;)
    {
      ...
      return;
      if ((this.jdField_a_of_type_Bpep.jdField_a_of_type_AndroidWidgetRelativeLayout == null) || (this.jdField_a_of_type_Bpep.jdField_a_of_type_AndroidWidgetRelativeLayout.getLayoutParams() == null)) {
        break;
      }
      this.jdField_e_of_type_AndroidViewView.setPadding(0, 0, 0, this.jdField_a_of_type_Bpep.jdField_a_of_type_AndroidWidgetRelativeLayout.getLayoutParams().height);
      break;
      label667:
      j = afur.a(17.0F, a().getResources());
      i = afur.a(0.0F, a().getResources());
      k = afur.a(-15.0F, a().getResources());
      m = i;
    }
  }
  ...
  private void o()
  {
    this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewSmartMusicRecyclerView = ((SmartMusicRecyclerView)a(2131365174));
    this.jdField_a_of_type_Aaza = ((aaza)this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewSmartMusicRecyclerView.getAdapter());
    this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewSmartMusicRecyclerView.setListener(new aayv(this));
  }
  ...
  private void p()
  {
    ...
    {
      return;
      localVsMusicItemInfo = this.jdField_a_of_type_Aaza.a(this.jdField_a_of_type_Int);
    ...
    try
    {
      ...
      aaxb.a("mystatus_edit", "aimusic_exp_clk", 0, 0, new String[] { String.valueOf(localVsMusicItemInfo.jdField_a_of_type_Int), "", localJSONObject.toString() });
      this.jdField_f_of_type_Long = System.currentTimeMillis();
      yqp.c("EditVideoSmartMusicPart", "reportSmartMusic   reportClickMusic() args3:" + localJSONObject.toString());
      return;
    }
  ...
  private void q()
  {
    ...
    if ((this.jdField_a_of_type_JavaUtilArrayList == null) || (this.jdField_a_of_type_JavaUtilArrayList.size() == 0))
    {
      ...
      this.jdField_a_of_type_ComTencentBizVideostoryVideoFrameVideoHelper.a(this.jdField_e_of_type_Long, new aayw(this));
      return;
    }
  ...
  private void r()
  {
    ...
    {
      q();
      aaxb.a("mystatus_edit", "musiclib_entry_clk", 0, 0, new String[0]);
    }
    if (!this.jdField_a_of_type_Boolean) {
      bool = true;
    }
  ...
  private void v()
  {
    ...
    else if (this.jdField_a_of_type_Aazd != null)
    {
      localObject = this.jdField_a_of_type_Aazd;
      if (this.jdField_a_of_type_Boolean) {
        break label74;
      }
    }
  ...
  private void w()
  {
    ...
    localIntent.putExtra("url", String.format("https://ti.qq.com/music/index.html?_wv=5&_bid=2831&device_id=%s&client_ip=%s&bustype=%s", new Object[] { bgln.a(), "", Integer.valueOf(6) }));
  ...
  private void x()
  {
    ...
    {
      this.jdField_e_of_type_AndroidViewView.setBackgroundResource(2130838761);
  ...
  private void y()
  {
    ...
    try
    {
      if (this.jdField_a_of_type_Aaza.a(this.jdField_a_of_type_Int - 1) != null) {
        localJSONObject.put("mid1", this.jdField_a_of_type_Aaza.a(this.jdField_a_of_type_Int - 1).mSongMid);
      }
      if (this.jdField_a_of_type_Aaza.a(this.jdField_a_of_type_Int) != null) {
        localJSONObject.put("mid2", this.jdField_a_of_type_Aaza.a(this.jdField_a_of_type_Int).mSongMid);
      }
      if (this.jdField_a_of_type_Aaza.a(this.jdField_a_of_type_Int + 1) != null) {
        localJSONObject.put("mid3", this.jdField_a_of_type_Aaza.a(this.jdField_a_of_type_Int + 1).mSongMid);
      }
    }
    catch (JSONException localJSONException)
    {
    ...
    aaxb.a("mystatus_edit", "aimusic_exp", 0, 0, new String[] { "", "", localJSONObject.toString() });
    yqp.c("EditVideoSmartMusicPart", "reportSmartMusic   reportShowMusic() args3:" + localJSONObject.toString());
  }
  ...
  public int a()
  {
    if ((this.jdField_a_of_type_Aaza.a() == null) || (this.jdField_a_of_type_Aaza.a().size() == 0)) {
      return 0;
    }
    return (int)(Math.floor(this.jdField_a_of_type_Aaza.getItemCount() / this.jdField_a_of_type_Aaza.a().size() / 2) * this.jdField_a_of_type_Aaza.a().size());
  }
  ...
  public bkgm a()
  {
    ...
    return this.jdField_a_of_type_Bkgm;
  }
  ...
  {
    super.a();
    this.jdField_f_of_type_Boolean = this.jdField_a_of_type_Bpep.b();
    this.g = this.jdField_a_of_type_Bpep.c();
    n();
    j();
    a(bpam.class, this);
    ...
    this.jdField_b_of_type_Int = ((Long)aavz.a().a("SmartMatchMusicSwitch", Long.valueOf(0L))).intValue();
  ...
  public void a(int paramInt, bpsf parambpsf)
  {
    boolean bool2 = false;
    ...
    Object localObject = parambpsf.a;
    boolean bool1;
    if (!this.jdField_b_of_type_Boolean)
    {
      bool1 = true;
      ((PublishVideoEntry)localObject).putExtra("isMixOriginal", Boolean.valueOf(bool1));
      localObject = parambpsf.a;
      bool1 = bool2;
      if (!this.jdField_b_of_type_Boolean) {
        bool1 = true;
      }
      ((PublishVideoEntry)localObject).isMixOriginal = bool1;
      parambpsf.a.isMuteRecordVoice = this.jdField_b_of_type_Boolean;
      parambpsf.a.putExtra("KEY_PIC_TO_VIDEO_LOCAL_PIC_PATH", this.jdField_a_of_type_Bpep.a().getString("KEY_PIC_TO_VIDEO_LOCAL_PIC_PATH"));
      parambpsf.a.putExtra("KEY_FROM_PIC_TO_VIDEO", Boolean.valueOf(this.g));
      parambpsf.a.putExtra("KEY_VIDEO_STORY_CAMERA_TYPE", Boolean.valueOf(this.jdField_a_of_type_Bpep.a().isLandTakePicToVideo()));
      if (!this.jdField_a_of_type_Boolean) {
        break label200;
      }
    ...
    {
      if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo != null) {
        this.jdField_a_of_type_Bpep.a().setVideoDuration(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.mDuration);
      }
      return;
      bool1 = false;
      break;
      label200:
      if ((this.jdField_a_of_type_Aaxo != null) && (this.jdField_a_of_type_Aaxo.a() != null))
      {
        localObject = this.jdField_a_of_type_Aaxo.a();
        parambpsf.a.backgroundMusicOffset = ((VsMusicItemInfo)localObject).musicStart;
        ...
        if (!this.g)
        {
          ...
          j = Math.min(j, (int)this.jdField_a_of_type_Bpep.a(paramInt));
        }
        parambpsf.a.backgroundMusicDuration = j;
        parambpsf.a.backgroundMusicPath = ((VsMusicItemInfo)localObject).getLocalPath();
        parambpsf.a.putExtra("vs_publish_entry_json_key_music_id", Integer.valueOf(((VsMusicItemInfo)localObject).mItemId));
        parambpsf.a.putExtra("vs_publish_entry_json_key_music_mid_id", ((VsMusicItemInfo)localObject).mSongMid);
        parambpsf.a.putExtra("vs_publish_entry_json_key_song_name", ((VsMusicItemInfo)localObject).mMusicName);
        parambpsf.a.putExtra("vs_publish_entry_json_key_music_album_pic", ((VsMusicItemInfo)localObject).mAlbumUrl);
        parambpsf.a.putExtra("vs_publish_entry_json_key_music_download_url", ((VsMusicItemInfo)localObject).mUrl);
        parambpsf.a.putExtra("vs_publish_entry_json_key_music_source_from", Integer.valueOf(((VsMusicItemInfo)localObject).jdField_a_of_type_Int));
        parambpsf.a.putExtra("originalRecordVolume", Float.valueOf(a(1)));
        parambpsf.a.putExtra("backgroundVolume", Float.valueOf(a(2)));
        this.jdField_a_of_type_Bpep.a().setSongMid(((VsMusicItemInfo)localObject).mSongMid);
        this.jdField_a_of_type_Bpep.a().setMusicType(((VsMusicItemInfo)localObject).jdField_a_of_type_Int);
        this.jdField_a_of_type_Bpep.a().setMusciPlayTime(System.currentTimeMillis() - this.jdField_f_of_type_Long);
      }
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Aaxo != null) {
      this.jdField_a_of_type_Aaxo.b(paramLong);
    }
  }
  ...
  public void a(VsMusicItemInfo paramVsMusicItemInfo)
  {
    ...
    do
    {
      ...
      a(paramVsMusicItemInfo);
      if (this.jdField_a_of_type_Aazd != null) {
        this.jdField_a_of_type_Aazd.b(true);
      }
    } while ((this.jdField_a_of_type_Aaxo == null) || (this.jdField_a_of_type_Boolean));
    this.jdField_a_of_type_Aaxo.a(a(2));
    this.jdField_a_of_type_Aaxo.a(paramVsMusicItemInfo);
  }
  ...
  public void a(List<META.StMusic> paramList)
  {
    ...
    if (((paramList == null) || (paramList.size() == 0)) && (this.jdField_a_of_type_Aaza.a() == 0))
    {
  ...
  public void b()
  {
    ...
    while (this.jdField_a_of_type_Aaxo == null) {
      return;
    }
    if (this.jdField_a_of_type_Aazd != null)
    {
