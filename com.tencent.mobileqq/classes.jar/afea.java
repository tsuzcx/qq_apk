  ...
  extends BaseAdapter
{
  ...
  public afea(List<ProfileLabelInfo> paramList)
  {
    Object localObject;
  ...
  private void a(ProfileLabelInfo paramProfileLabelInfo)
  {
    ...
    Iterator localIterator = this.jdField_a_of_type_ComTencentMobileqqActivityProfileLabelEditorActivity.jdField_a_of_type_Bacd.a().keySet().iterator();
    ...
    {
      break;
      if ((localObject != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityProfileLabelEditorActivity.jdField_a_of_type_Bacd.a(localObject)))
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityProfileLabelEditorActivity.jdField_a_of_type_Bacd.c(localObject, this.jdField_a_of_type_ComTencentMobileqqActivityProfileLabelEditorActivity.jdField_a_of_type_Bacd.a(localObject));
        return;
      }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_ComTencentMobileqqActivityProfileLabelEditorActivity.getLayoutInflater().inflate(2131562982, null);
      ...
      paramView = new afdz();
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131378387));
    ...
    for (;;)
    {
      ...
      return localView;
      afdz localafdz = (afdz)paramView.getTag();
      localView = paramView;
      paramView = localafdz;
    }
  }
