...
public class azhz
{
  ...
  public static azie a(tAdvDesc paramtAdvDesc, SharedPreferences paramSharedPreferences, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        case 0: 
          paramSharedPreferences = localObject3;
          k = azid.a(((JSONObject)localObject4).getString("showPriority"));
          paramSharedPreferences = localObject3;
          ...
          if (m == 1)
          {
            ...
            paramSharedPreferences = localObject3;
            int n = azid.a(((JSONObject)localObject4).getString("androidMinimumMemorySize"));
            paramSharedPreferences = localObject3;
            int i1 = azid.a(((JSONObject)localObject4).getString("androidMinimumOSVersion"));
            paramSharedPreferences = localObject3;
            i2 = azid.a(((JSONObject)localObject4).getString("thirdPartyReportPlatform"));
            paramSharedPreferences = localObject3;
            localObject2 = ((JSONObject)localObject4).getString("thirdPartyReportURLForExposure");
            paramSharedPreferences = localObject3;
            i3 = azid.a(((JSONObject)localObject4).getString("shouldShowAdMark"));
            if ((i1 != 0) || (n != 0)) {
              break label678;
            }
            i = 0;
        ...
        case 2: 
          ...
          continue;
          paramSharedPreferences = localObject3;
          localObject4 = new azif();
          paramSharedPreferences = localObject3;
          ((azif)localObject4).h(paramString).b(str1).c(str3).d(str4).c(j).e(paramtAdvDesc).d(m).f((String)localObject1).b(bool).g((String)localObject2).b(k).e(i2).i(str2).j("").a(i3);
          paramSharedPreferences = localObject3;
          paramString = ((azif)localObject4).a();
  ...
  public static ArrayList<azie> a(ArrayList<tAdvDesc> paramArrayList, QQAppInterface paramQQAppInterface, String paramString)
  {
    return a(paramArrayList, paramQQAppInterface, paramString, "qboss", null);
  }
  
  /* Error */
  public static ArrayList<azie> a(ArrayList<tAdvDesc> paramArrayList, QQAppInterface paramQQAppInterface, String paramString1, String paramString2, java.util.List<cooperation.vip.pb.TianShuAccess.AdItem> paramList)
  {
    // Byte code:
    ...
    //   13: aload_2
    //   14: invokestatic 217	azid:a	(Ljava/lang/String;)J
    //   17: invokestatic 222	bbzy:a	(Landroid/content/Context;J)V
    //   20: ldc 224
    //   22: aload_3
    ...
    //   37: aload_2
    //   38: invokestatic 237	bkzh:a	(Landroid/content/Context;Ljava/lang/String;)Landroid/content/SharedPreferences;
    //   41: astore 8
    //   43: aload 4
    ...
    //   96: aload_1
    //   97: aload_2
    //   98: invokestatic 257	bkzf:a	(Lcooperation/vip/pb/TianShuAccess$AdItem;Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;)Lazie;
    //   101: astore 7
    //   103: aload 7
    //   105: ifnull +580 -> 685
    //   108: aload 7
    //   110: getfield 260	azie:l	Ljava/lang/String;
    //   113: invokestatic 262	bkzh:a	(Ljava/lang/String;)Z
    //   116: ifeq +569 -> 685
    //   119: aload 4
    //   121: iload 6
    ...
    //   131: aload 7
    //   133: getfield 260	azie:l	Ljava/lang/String;
    //   136: invokestatic 267	akke:a	(Lcooperation/vip/pb/TianShuAccess$AdItem;Ljava/lang/String;)Lakke;
    //   139: astore 10
    //   141: invokestatic 272	akkg:a	()Lakkg;
    //   144: aload_1
    //   145: aload 10
    //   147: iconst_0
    //   148: invokevirtual 275	akkg:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Lakke;Z)V
    //   151: aload 10
    //   153: aload_2
    //   154: aload 8
    //   156: invokevirtual 278	akke:a	(Ljava/lang/String;Landroid/content/SharedPreferences;)V
    //   159: aload 7
    //   161: ifnull +56 -> 217
    //   164: aload 9
    //   166: aload 7
    ...
    //   171: pop
    //   172: aload 7
    //   174: getfield 283	azie:jdField_b_of_type_Int	I
    //   177: iconst_3
    //   178: if_icmpeq +12 -> 190
    //   181: aload 7
    //   183: getfield 283	azie:jdField_b_of_type_Int	I
    //   186: iconst_2
    ...
    //   193: aload 7
    //   195: getfield 291	azie:f	Ljava/lang/String;
    //   198: iconst_0
    //   199: aconst_null
    ...
    //   203: getstatic 298	azid:a	Ljava/util/HashMap;
    //   206: aload 7
    //   208: getfield 300	azie:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   211: aload 7
    ...
    //   229: aload_2
    //   230: invokestatic 307	azhz:a	(Landroid/content/Context;Ljava/lang/String;)Landroid/content/SharedPreferences;
    //   233: astore 8
    //   235: aload_0
    ...
    //   273: aload 8
    //   275: aload_2
    //   276: invokestatic 314	azhz:a	(LBOSSStrategyCenter/tAdvDesc;Landroid/content/SharedPreferences;Ljava/lang/String;)Lazie;
    //   279: astore 7
    //   281: goto -122 -> 159
    //   284: aload 9
    //   286: monitorexit
    ...
    //   316: aload_2
    //   317: invokestatic 323	bkzh:a	(Landroid/content/Context;Ljava/lang/String;)Ljava/util/Set;
    //   320: astore_0
    ...
    //   363: checkcast 196	azie
    //   366: astore 11
    //   368: aload 11
    //   370: getfield 300	azie:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   373: astore 12
    //   375: aload 7
    //   377: aload 12
    ...
    //   398: aload 11
    //   400: getfield 352	azie:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   412: aload 11
    //   414: getfield 354	azie:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   449: aload 11
    //   451: iconst_0
    //   452: invokestatic 362	azhz:a	(Landroid/content/SharedPreferences$Editor;Lazie;Z)V
    //   455: goto -109 -> 346
    //   458: astore_0
    //   459: aload 9
    //   461: areturn
    ...
    //   471: aload_2
    //   472: invokestatic 363	azid:a	(Landroid/content/Context;Ljava/lang/String;)Ljava/util/Set;
    //   475: astore_0
    //   476: goto -155 -> 321
    //   479: aload 4
    //   481: aload 11
    //   483: iconst_1
    //   484: invokestatic 362	azhz:a	(Landroid/content/SharedPreferences$Editor;Lazie;Z)V
    //   487: goto -141 -> 346
    ...
    //   513: ldc_w 371
    //   516: aload 7
    //   518: invokestatic 374	azid:a	(Ljava/util/Set;)Ljava/lang/String;
    ...
    //   617: aload_1
    //   618: aload 9
    //   620: invokestatic 404	azia:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/util/Collection;)V
    //   623: aload 9
    //   625: areturn
    //   626: aload 4
    //   628: ldc_w 406
    //   631: aload 7
    //   633: invokestatic 374	azid:a	(Ljava/util/Set;)Ljava/lang/String;
  ...
  public static void a(SharedPreferences.Editor paramEditor, azie paramazie, boolean paramBoolean)
  {
    paramEditor.putString("qboss_splash_ad_begin_time_" + paramazie.jdField_b_of_type_JavaLangString, paramazie.jdField_c_of_type_JavaLangString);
    paramEditor.putString("qboss_splash_ad_end_time_" + paramazie.jdField_b_of_type_JavaLangString, paramazie.jdField_d_of_type_JavaLangString);
    paramEditor.putInt("qbosss_plash_ad_content_type_" + paramazie.jdField_b_of_type_JavaLangString, paramazie.jdField_a_of_type_Int);
    paramEditor.putString("qbosss_splash_ad_download_url_" + paramazie.jdField_b_of_type_JavaLangString, paramazie.jdField_e_of_type_JavaLangString);
    paramEditor.putInt("qbosss_splash_ad_jumptype_" + paramazie.jdField_b_of_type_JavaLangString, paramazie.jdField_b_of_type_Int);
    paramEditor.putString("qbosss_splash_ad_jump_h5_url_" + paramazie.jdField_b_of_type_JavaLangString, paramazie.f);
    paramEditor.putInt("qboss_splash_ad_showpriority_" + paramazie.jdField_b_of_type_JavaLangString, paramazie.jdField_d_of_type_Int);
    paramEditor.putBoolean("qboss_exposure_is_low_device_limit_" + paramazie.jdField_b_of_type_JavaLangString, paramazie.jdField_a_of_type_Boolean);
    paramEditor.putInt("qboss_splash_ad_exposure_platform_" + paramazie.jdField_b_of_type_JavaLangString, paramazie.jdField_c_of_type_Int);
    paramEditor.putString("qboss_splash_info_report_" + paramazie.jdField_b_of_type_JavaLangString, paramazie.j);
    paramEditor.putString("qboss_splash_resource_md5_" + paramazie.jdField_b_of_type_JavaLangString, paramazie.k);
    paramEditor.putInt("qboss_splash_should_show_ad_mark_" + paramazie.jdField_b_of_type_JavaLangString, paramazie.jdField_e_of_type_Int);
    paramEditor.putString("qboss_splash_union_banner_type_" + paramazie.jdField_b_of_type_JavaLangString, paramazie.l);
    String str2 = paramazie.g;
    String str1 = str2;
    if (!TextUtils.isEmpty(str2))
    {
      str1 = str2;
      if (!str2.startsWith("https")) {
        str1 = paramazie.g.replaceFirst("http", "https");
      }
    }
    paramEditor.putString("qboss_exposure_url_" + paramazie.jdField_b_of_type_JavaLangString, str1);
    paramBoolean = azie.a(paramazie.h, true);
    if ((!paramazie.jdField_a_of_type_Boolean) && (paramBoolean)) {}
    for (paramBoolean = true;; paramBoolean = false)
    {
      paramazie.jdField_b_of_type_Boolean = paramBoolean;
      paramEditor.putBoolean("qboss_splash_ad_is_limited_" + paramazie.jdField_b_of_type_JavaLangString, paramazie.jdField_b_of_type_Boolean);
      return;
    }
  }
