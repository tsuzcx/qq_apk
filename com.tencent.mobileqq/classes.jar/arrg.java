  ...
  implements arsk
{
  ...
  public arrg()
  {
    this.jdField_a_of_type_EipcEIPCResultCallback = new arrh(this);
    this.jdField_b_of_type_EipcEIPCResultCallback = new arri(this);
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if ("listenTogether".equals(paramString2))
    {
      ...
      do
      {
        ...
        arsh.a(paramJsBridgeListener, "isOpener", this.jdField_b_of_type_EipcEIPCResultCallback);
        return true;
        if (!"isShowAtmosphere".equals(paramString3)) {
          break;
        }
      } while (TextUtils.isEmpty(this.c));
      arsh.a(paramJsBridgeListener, "isShowAtmosphere", this.jdField_a_of_type_EipcEIPCResultCallback);
      return true;
      if ("setPlayerId".equals(paramString3))
      {
        arsh.a(paramJsBridgeListener, "setPlayerId", null);
        return true;
      }
      if ("setThemeEnabled".equals(paramString3))
      {
        arsh.a(paramJsBridgeListener, "setThemeEnabled", null);
        return true;
      }
    }
    return false;
