  ...
  extends awoe
{
  ...
  public awpm(QQAppInterface paramQQAppInterface, PublicAccountInfo paramPublicAccountInfo, int paramInt)
  {
  ...
  protected long a(String paramString)
  {
    ...
    long l2 = awwa.b(paramString, this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.name, 1073741824L);
    long l1 = l2;
  ...
  public void a(View paramView)
  {
    ...
    do
    {
      ...
      {
        awwa.a("all_result", "clk_public_uin", new String[] { "" + this.jdField_a_of_type_JavaLangString });
        awsq.a(null, 0, this.c, "0X8009D51", 0, 0, this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.getUin(), null);
      }
      str = this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.getUin();
      bbfq.a(null, "pubAcc_aio_open", str);
      localObject1 = (akdh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(56);
      if (!ajsd.aP.equals(str)) {
        break;
      }
      sjp.a((Context)localObject2, "from_search_result", 1, true);
      awwa.a(this.jdField_a_of_type_JavaLangString, 50, 0, paramView, str, this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.isOffLine, this.c);
      akgb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString);
      awwa.a(this.jdField_a_of_type_JavaLangString, 50, paramView, false);
    ...
    if ((localObject2 instanceof UniteSearchActivity))
    {
      ...
      axqy.b((QQAppInterface)localObject2, "CliOper", "", "", (String)localObject1, (String)localObject1, 0, 1, 0, this.jdField_a_of_type_Int + "", "", str, this.jdField_a_of_type_JavaLangString);
      label285:
      paramView = nom.a();
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      return;
      if (ajsd.aU.equals(str))
      {
        sgg.a((Context)localObject2, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        break label133;
      }
      ...
      if ((TextUtils.equals("3046055438", str)) && (nrt.a()))
      {
        nrh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (Context)localObject2, str, ((Context)localObject2).getResources().getString(2131691960));
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a("3046055438", 1008, false);
        break label133;
      }
      if (((localObject1 != null) && (((akdh)localObject1).a(Long.valueOf(str)))) || ((localObject1 == null) && (sgg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str))))
      {
        ...
        ((akdh)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo);
        break label133;
      }
      if (TextUtils.isEmpty(str))
      {
      ...
      break;
      label887:
      nol.a((QQAppInterface)localObject2, "P_CliOper", "Pb_account_lifeservice", str, paramView, paramView, 0, 0, this.jdField_a_of_type_Int + "", "", this.jdField_a_of_type_JavaLangString, "", false);
      break label285;
    }
  }
  ...
  {
    SpannableString localSpannableString = new awvp(new ArrayList(), a()).a(awwa.a(this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.summary));
