  ...
  implements View.OnClickListener
{
  ...
  public aacd(RelativePersonalDetailHeadItemView paramRelativePersonalDetailHeadItemView, View paramView)
  {
    super(paramView);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131380038));
    this.b = ((TextView)paramView.findViewById(2131380070));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131363973));
  ...
  public void a(CertifiedAccountMeta.StQQGroup paramStQQGroup)
  {
    ...
    if (paramStQQGroup != null)
    {
      ...
      this.b.setText(paramStQQGroup.memberNum.get() + anvx.a(2131712833));
    ...
    {
      aanb.a(str, "auth_fan", paramStQQGroup, 0, 0, new String[0]);
      return;
      str = anvx.a(2131712828);
      break;
    }
  }
