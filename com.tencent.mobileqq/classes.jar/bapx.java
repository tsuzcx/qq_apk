...
public class bapx
{
  ...
  Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new baqc(this);
  ...
  public bapx()
  {
    ...
    this.jdField_a_of_type_Int = aepi.a(4.0F, ((Context)localObject).getResources());
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate((Context)localObject, 2131561340, null));
    ...
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367519));
    int i = 0;
  ...
  void b()
  {
    ...
    int i = aepi.a(1.0F, ((Context)localObject2).getResources());
    this.d.setPadding(i, i, i, i);
    this.d.setBackgroundResource(2130844733);
    ...
    try
    {
      ...
      ((ScaleAnimation)localObject1).setAnimationListener(new bapy(this));
  ...
  void e()
  {
    int j = this.jdField_a_of_type_AndroidWidgetImageView.getWidth() - aepi.a(5.0F, BaseApplicationImpl.getContext().getResources());
    ...
    localObject2 = new baqa(this, localAnimatorSet);
