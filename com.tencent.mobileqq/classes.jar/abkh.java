  ...
  extends abjo
{
  ...
  public void a(Activity paramActivity, abjp paramabjp, int paramInt)
  {
    RelativeLayout localRelativeLayout = (RelativeLayout)paramabjp.a();
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setId(2131367349);
    localRelativeLayout.addView(this.jdField_a_of_type_AndroidWidgetTextView, localLayoutParams);
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(4);
    this.jdField_a_of_type_AndroidViewAnimationAlphaAnimation.setDuration(300L);
    this.b.setDuration(300L);
    this.jdField_a_of_type_Abjp = paramabjp;
    this.jdField_a_of_type_AndroidViewAnimationAlphaAnimation.setAnimationListener(new abki(this));
    this.b.setAnimationListener(new abkj(this));
  }
