...
public class aufs
{
  ...
  public static void a(int paramInt, long paramLong1, long paramLong2, long paramLong3, long paramLong4, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (String str = "1";; str = "0")
    {
      ...
      bctj.a(BaseApplicationImpl.getContext()).a("", "qq_flutter_launch_result_v2", true, 0L, 0L, localHashMap, "", false);
  ...
  public static void a(String paramString)
  {
    if (a())
    {
      ...
      bctj.a(BaseApplicationImpl.getContext()).a("", "qq_flutter_exception", true, 0L, 0L, localHashMap, "", false);
    }
  }
  ...
  public static void a(String paramString, int paramInt, double paramDouble)
  {
    if (a())
    {
      ...
      bctj.a(BaseApplicationImpl.getContext()).a("", "qq_flutter_fps", true, 0L, 0L, localHashMap, "", false);
    }
  }
  ...
  public static void a(String paramString, long paramLong)
  {
    if (a())
    {
      ...
      bctj.a(BaseApplicationImpl.getContext()).a("", "qq_flutter_page_render_cost", true, 0L, 0L, localHashMap, "", false);
    }
  }
  ...
  public static void a(boolean paramBoolean1, long paramLong, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    {
      localHashMap.put("isLocalAppExist", str);
      bctj.a(BaseApplicationImpl.getContext()).a("", "qq_flutter_download_cost", true, 0L, 0L, localHashMap, "", false);
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  public static void a(boolean paramBoolean1, boolean paramBoolean2, long paramLong1, long paramLong2, long paramLong3, long paramLong4, aufn paramaufn)
  {
    if ((paramBoolean2) && (paramaufn == null))
    {
    ...
    if (paramBoolean1)
    {
      ...
      l2 = paramaufn.a;
      l1 = paramaufn.b;
      paramLong1 = paramaufn.c;
      long l3 = paramaufn.d - l2 - l1 - paramLong1;
    ...
    for (;;)
    {
      ...
      localHashMap.put("flutterUin", a());
      bctj.a(BaseApplicationImpl.getContext()).a("", "qq_flutter_first_frame", true, 0L, 0L, localHashMap, "", false);
      if (!QLog.isColorLevel()) {
        break;
      }
      ...
      if (paramaufn != null) {}
      for (paramLong1 = paramaufn.d;; paramLong1 = 0L)
      {
  ...
  public static void a(boolean paramBoolean1, boolean paramBoolean2, Map<String, Integer> paramMap)
  {
    ...
    Object localObject = bgln.a(BaseApplicationImpl.getContext());
    ...
    for (paramMap = "1";; paramMap = "0")
    {
      ...
      bctj.a(BaseApplicationImpl.getContext()).a("", "qq_flutter_enter_memory_increment", true, 0L, 0L, localHashMap, "", false);
      return;
    }
    bctj.a(BaseApplicationImpl.getContext()).a("", "qq_flutter_exit_memory_increment", true, 0L, 0L, localHashMap, "", false);
  }
  ...
  public static void b(String paramString)
  {
    if (a())
    {
      HashMap localHashMap = new HashMap();
      localHashMap.put("pagePath", paramString);
      bctj.a(BaseApplicationImpl.getContext()).a("", "qq_flutter_pv", true, 0L, 0L, localHashMap, "", false);
    }
  }
}
