...
class kqt
  extends kpy
{
  kqt(kqr paramkqr, List paramList, krd paramkrd, Long paramLong) {}
  ...
  public void a(int paramInt, Header[] paramArrayOfHeader, String paramString)
  {
    ...
    try
    {
      localObject = this.jdField_a_of_type_Kqr.a.parse(new InputSource(new StringReader(paramString)));
    ...
    catch (IOException localIOException)
    {
      ...
      this.jdField_a_of_type_Krd.a(localIOException, paramString, this.jdField_a_of_type_JavaLangLong);
    }
