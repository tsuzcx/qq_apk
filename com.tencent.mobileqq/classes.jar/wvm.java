  ...
  extends wwc
{
  ...
  private List<wvr> jdField_a_of_type_JavaUtilList = new ArrayList();
  private AtomicBoolean jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
  private wvq jdField_a_of_type_Wvq;
  ...
  public wvm(@NonNull wwe paramwwe)
  {
    super(paramwwe);
  }
  
  private void a(List<? extends wyj> paramList)
  {
    int i;
    int j;
    if (paramList == null)
    ...
    for (;;)
    {
      ...
      if (i == 1)
      {
        this.jdField_a_of_type_JavaUtilList.add(new wvr((wyj)paramList.get(0), null, null));
        return;
      }
      ...
      for (Object localObject = "0";; localObject = "1")
      {
        ...
        if ((this.jdField_a_of_type_Wwe.a.d()) && ((this.jdField_a_of_type_Wwe.a.a instanceof EditLocalVideoSource)))
        {
          localObject = (EditLocalVideoSource)this.jdField_a_of_type_Wwe.a.a;
        ...
        k = aekt.a(12.0F, a());
        m = aekt.a(2.0F, a());
        k = (azgq.jdField_a_of_type_Int - j * 2 - k * 5) / 6 - m * 2;
        m = k * 8 / 5;
        localwmn = new wmn(aekt.a(3.0F, a()), 0, m * 1.0F / k, null, null);
        j = 0;
        while (j < i)
        {
          localwyj = (wyj)paramList.get(j);
          if (localwyj != null) {
            break label368;
          }
          j += 1;
      ...
      label368:
      localObject = xmn.a(localwyj.jdField_c_of_type_AndroidGraphicsBitmap, k, m, false);
      if (localObject != null) {}
      for (localObject = localwmn.a((Bitmap)localObject);; localObject = null)
      {
        this.jdField_a_of_type_JavaUtilList.add(new wvr(localwyj, (Bitmap)localObject, null));
        break;
      }
    }
  }
  
  private void a(List<? extends wyj> paramList, boolean paramBoolean)
  {
    int j = 0;
    if (paramList == null)
    {
    ...
    if (this.jdField_a_of_type_Wvq == null) {
      this.jdField_a_of_type_Wvq = new wvq(this);
    }
    int i;
    if (paramBoolean)
    {
      ...
      if (((wyj)paramList.get(i)).jdField_c_of_type_Int != this.jdField_b_of_type_Int) {}
    }
    for (;;)
    {
      if (i < 0)
      ...
      } while (((wvr)this.jdField_a_of_type_JavaUtilList.get(j)).jdField_c_of_type_Int != this.jdField_b_of_type_Int);
      wsv.b("Q.qqstory.record.EditVideoFragment", "update the %d fragment's thumb.", Integer.valueOf(j));
      this.jdField_a_of_type_Wvq.a((wyj)paramList.get(i), (wvr)this.jdField_a_of_type_JavaUtilList.get(j));
      return;
      i = 0;
      while (i < paramList.size())
      {
        ...
        if (j < this.jdField_a_of_type_JavaUtilList.size())
        {
          ...
          while (((wyj)paramList.get(i)).jdField_c_of_type_Int != ((wvr)this.jdField_a_of_type_JavaUtilList.get(j)).jdField_c_of_type_Int)
          {
            j += 1;
            break;
          }
  ...
  private void b(List<wvr> paramList)
  {
    int j = 0;
    if (paramList == null) {}
    ...
    this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiWidgetElasticImageView = ((ElasticImageView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131368887));
  ...
  private void c(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        if (paramInt == ((wvr)this.jdField_a_of_type_JavaUtilList.get(i)).jdField_c_of_type_Int)
        {
          ...
          ((wvr)this.jdField_a_of_type_JavaUtilList.get(i)).a = this.jdField_a_of_type_Wvq.a(paramInt);
        }
      }
      else {
        return;
  ...
  private void c(List<wvr> paramList)
  {
    if (paramList == null) {}
    for (int i = 0; (i < 2) || (i > 6); i = paramList.size())
    {
    ...
    int j = aekt.a(2.0F, a());
    int n = (azgq.jdField_a_of_type_Int - k * 2 - m * 5) / 6;
  ...
  private void d(List<wvr> paramList)
  {
    int j = 0;
    ...
    for (;;)
    {
      ...
      while (i < paramList.size())
      {
        this.jdField_a_of_type_ArrayOfAndroidWidgetRelativeLayout[i].setOnTouchListener(new wvp(this, i));
        i += 1;
      }
    }
  }
  
  private void e(List<wvr> paramList)
  {
    if (!this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())
    {
    ...
    if (i < this.jdField_a_of_type_ArrayOfAndroidWidgetRelativeLayout.length)
    {
      ...
      this.jdField_a_of_type_ArrayOfAndroidWidgetImageView[i].setBackgroundDrawable(new BitmapDrawable(((wvr)paramList.get(i)).b));
      this.jdField_a_of_type_ArrayOfAndroidWidgetImageView[i].setImageBitmap(((wvr)paramList.get(i)).a);
  ...
  protected void a(int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_Int == ((wvr)this.jdField_a_of_type_JavaUtilList.get(paramInt)).jdField_c_of_type_Int) && (!this.jdField_a_of_type_Boolean))
    {
    ...
    this.jdField_a_of_type_Int = ((wvr)this.jdField_a_of_type_JavaUtilList.get(paramInt)).jdField_c_of_type_Int;
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_Wwe.a(Message.obtain(null, 6, this.jdField_b_of_type_Int, this.jdField_a_of_type_Int));
  ...
  protected void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    localObject = (wyj)this.jdField_a_of_type_JavaUtilList.get(paramInt1);
    if (localObject == null)
    {
      wsv.e("Q.qqstory.record.EditVideoFragment", "deleteFragment error. VideoFragmentInfo = null.");
      return;
    }
    paramInt2 = ((wyj)localObject).jdField_c_of_type_Int;
    ...
    this.jdField_a_of_type_Wwe.a(Message.obtain(null, 7, paramInt2, 0));
    wwe localwwe = this.jdField_a_of_type_Wwe;
    if (this.jdField_a_of_type_Wwe.a.d()) {}
    for (localObject = "0";; localObject = "1")
    {
      localwwe.b("clk_del", 0, 0, new String[] { "", localObject });
      return;
    }
  }
  ...
  public void a(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    localValueAnimator.addListener(new wvn(this, paramView));
    localValueAnimator.addUpdateListener(new wvo(this, paramInt3, paramInt1, paramInt4, paramInt2, paramView));
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    if (this.jdField_b_of_type_AndroidWidgetRelativeLayout != null)
    {
      ...
      if (paramBoolean1) {
        wyg.b(this.jdField_b_of_type_AndroidWidgetRelativeLayout, paramBoolean3);
      }
    }
    else
    {
    ...
    wyg.a(this.jdField_b_of_type_AndroidWidgetRelativeLayout, paramBoolean3);
    return;
    label33:
