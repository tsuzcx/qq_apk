  ...
  implements Handler.Callback, View.OnClickListener
{
  ...
  public WeakReference<akzm> a;
  private boolean jdField_a_of_type_Boolean;
  private int jdField_b_of_type_Int = -1;
  WeakReference<Context> jdField_b_of_type_JavaLangRefWeakReference;
  
  public akzx(Activity paramActivity, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    this.jdField_a_of_type_Akzw = new akzw((Context)this.jdField_b_of_type_JavaLangRefWeakReference.get(), this);
    ...
    if (alit.jdField_a_of_type_Int > 0)
    {
      jdField_a_of_type_Int = alit.jdField_a_of_type_Int * 1000;
  ...
  private BaseChatPie a()
  {
    ...
    if (localObject2 != null)
    {
      ...
      {
        localObject2 = (aknx)((AppInterface)localObject2).getManager(153);
        localObject1 = localChatFragment;
        if (localObject2 != null)
        {
          localObject2 = ((aknx)localObject2).a();
          localObject1 = localChatFragment;
          if (localObject2 != null) {
  ...
  private void g()
  {
    ...
    if ((localBaseChatPie != null) && (this.jdField_a_of_type_Akzw != null) && (localBaseChatPie.a().a() == this.jdField_a_of_type_Akzw) && (this.jdField_a_of_type_Akzw.jdField_a_of_type_AndroidWidgetRelativeLayout.isShown()))
    {
      this.jdField_a_of_type_Akzw.a();
      this.jdField_a_of_type_Bhtd.removeMessages(20);
      this.jdField_a_of_type_Bhtd.sendEmptyMessageDelayed(20, 1000L);
    }
  }
  ...
  public void a(akzm paramakzm)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramakzm);
  }
  
  public void a(Activity paramActivity)
  {
    this.jdField_a_of_type_Akzw = new akzw(paramActivity, this);
  }
  ...
  public void b()
  {
    ...
    if (localObject != null)
    {
      ...
      if ((localObject != null) && (((ahap)localObject).a() == this.jdField_a_of_type_Akzw))
      {
        ((ahap)localObject).a();
        if (QLog.isColorLevel()) {
  ...
  public void c()
  {
    ...
    for (localObject1 = null;; localObject1 = this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.game.name)
    {
      ...
      if (TextUtils.isEmpty((CharSequence)localObject1)) {
        localObject2 = alud.a(2131702523);
      }
      localMessage.obj = (alud.a(2131702519) + (String)localObject2);
  ...
  public void d()
  {
    ...
    if (this.jdField_a_of_type_Akzw != null)
    {
      ...
      this.jdField_a_of_type_Akzw.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_JavaLangString);
      this.jdField_a_of_type_Akzw.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
      this.jdField_a_of_type_Akzw.c.setVisibility(8);
    }
    label251:
    while (this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam == null)
    {
      ...
      if (this.jdField_a_of_type_Akzw != null)
      {
        if ((this.jdField_a_of_type_Akzw.jdField_a_of_type_AndroidWidgetRelativeLayout.getParent() instanceof ViewGroup)) {
          ((ViewGroup)this.jdField_a_of_type_Akzw.jdField_a_of_type_AndroidWidgetRelativeLayout.getParent()).removeView(this.jdField_a_of_type_Akzw.jdField_a_of_type_AndroidWidgetRelativeLayout);
        }
        ((ahap)localObject1).a(this.jdField_a_of_type_Akzw, new Object[0]);
      }
      if (!QLog.isColorLevel()) {
        break;
      }
    ...
    for (Object localObject1 = null;; localObject1 = this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.game.name)
    {
      Object localObject2 = localObject1;
      if (TextUtils.isEmpty((CharSequence)localObject1)) {
        localObject2 = alud.a(2131702522);
      }
      localObject1 = alud.a(2131702524) + (String)localObject2;
      this.jdField_a_of_type_Akzw.jdField_a_of_type_AndroidWidgetTextView.setText((CharSequence)localObject1);
      this.jdField_a_of_type_Akzw.jdField_b_of_type_AndroidWidgetTextView.setText((CharSequence)localObject1);
      break;
    }
  }
  ...
  public void e()
  {
    this.jdField_a_of_type_Bhtd.removeMessages(25);
  ...
  {
    this.jdField_a_of_type_Bhtd.removeMessages(25);
    this.jdField_a_of_type_Bhtd.sendEmptyMessageDelayed(25, jdField_a_of_type_Int);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            do
            {
                ...
                do
                {
                  do
                  {
                    do
                    {
                      ...
                      paramMessage.ar();
                      return false;
                      if ((this.jdField_a_of_type_Akzw != null) && ((paramMessage.obj instanceof String)))
                      {
                    ...
                    if (paramMessage != null)
                    {
                      ...
                      if ((localObject3 != null) && (this.jdField_a_of_type_Akzw != null))
                      {
                        if ((this.jdField_a_of_type_Akzw.jdField_a_of_type_AndroidWidgetRelativeLayout.getParent() instanceof ViewGroup)) {
                          ((ViewGroup)this.jdField_a_of_type_Akzw.jdField_a_of_type_AndroidWidgetRelativeLayout.getParent()).removeView(this.jdField_a_of_type_Akzw.jdField_a_of_type_AndroidWidgetRelativeLayout);
                        }
                        if (this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null)
                        {
                          ...
                          if (TextUtils.isEmpty(paramMessage)) {
                            localObject1 = alud.a(2131702525);
                          }
                          paramMessage = alud.a(2131702520) + (String)localObject1;
                          this.jdField_a_of_type_Akzw.jdField_a_of_type_AndroidWidgetTextView.setText(paramMessage);
                          this.jdField_a_of_type_Akzw.jdField_b_of_type_AndroidWidgetTextView.setText(paramMessage);
                        }
                        this.jdField_a_of_type_Akzw.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
                        this.jdField_a_of_type_Akzw.c.setVisibility(8);
                        ((ahap)localObject3).a(this.jdField_a_of_type_Akzw, new Object[0]);
                        if (QLog.isColorLevel()) {
                          QLog.d("cmgame_process.CmGameUIManager", 2, "showGameTips");
                        }
                      }
                    }
                    Object localObject3 = akwd.a();
                    MqqHandler localMqqHandler;
                    Message localMessage;
                    ...
                    for (paramMessage = (Message)localObject2;; paramMessage = this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.game.name)
                    {
                      localObject1 = paramMessage;
                      if (TextUtils.isEmpty(paramMessage)) {
                        localObject1 = alud.a(2131702516);
                      }
                      localMessage.obj = (alud.a(2131702518) + (String)localObject1);
                      localMqqHandler.sendMessage(localMessage);
                      ...
                      {
                        paramMessage = (akzm)this.jdField_a_of_type_JavaLangRefWeakReference.get();
                        if (paramMessage != null) {
                          paramMessage.a();
                        }
                      }
                    ...
                    for (paramMessage = "";; paramMessage = this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.game.name)
                    {
                      ...
                      akvt.a(this.jdField_b_of_type_Int);
                    ...
                    if (localObject2 != null)
                    {
                      ...
                      if (localObject2 != null)
                      {
                        if ((this.jdField_a_of_type_Akzw == null) || (this.jdField_a_of_type_Akzw != ((ahap)localObject2).a())) {
                          break label964;
                        }
                        ((ahap)localObject2).a();
                        if (QLog.isColorLevel()) {
                    ...
                    for (;;)
                    {
                      ...
                      {
                        localObject2 = (akzm)this.jdField_a_of_type_JavaLangRefWeakReference.get();
                        if ((paramMessage.obj instanceof String)) {
                          localObject1 = (String)paramMessage.obj;
                        }
                        if (localObject2 != null) {
                          ((akzm)localObject2).d((String)localObject1);
                        }
                      }
                      paramMessage = akwd.a();
                      ...
                      VipUtils.a(paramMessage, "cmshow", "Apollo", "shutdown_game", 0, 0, new String[] { Integer.toString(this.jdField_b_of_type_Int), Integer.toString(akwd.b()), Integer.toString(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.commFlag & 0x1) });
                      return false;
                      if (QLog.isColorLevel()) {
                    ...
                    if ((paramMessage.obj instanceof String))
                    {
                      ...
                      if (this.jdField_a_of_type_Akzw != null)
                      {
                        this.jdField_a_of_type_Akzw.c.setVisibility(8);
                        this.jdField_a_of_type_Akzw.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
                        this.jdField_a_of_type_Akzw.jdField_a_of_type_AndroidWidgetTextView.setText((String)paramMessage.obj);
                      }
                    }
                    paramMessage = akwd.a();
              ...
              this.jdField_a_of_type_Bhtd.sendEmptyMessageDelayed(24, 500L);
              return false;
              paramMessage = a();
            } while (paramMessage == null);
            paramMessage.ar();
        ...
        if ((!this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Akzw != null))
        {
          localObject1 = (String)paramMessage.obj;
          localObject2 = new SpannableString((String)localObject1 + alud.a(2131702521));
          ((SpannableString)localObject2).setSpan(new ForegroundColorSpan(-16776961), 0, ((String)localObject1).length(), 17);
          this.jdField_a_of_type_Akzw.jdField_b_of_type_AndroidWidgetTextView.setText((CharSequence)localObject2);
          g();
        }
      } while (!QLog.isColorLevel());
      ...
      paramMessage = a();
    } while ((paramMessage == null) || (this.jdField_a_of_type_Akzw == null) || (paramMessage.a().a() != this.jdField_a_of_type_Akzw) || (!this.jdField_a_of_type_Akzw.jdField_a_of_type_AndroidWidgetRelativeLayout.isShown()));
    label733:
  ...
  public void onClick(View paramView)
  {
    ...
    for (paramView = "";; paramView = this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.game.name)
    {
      ...
      this.jdField_a_of_type_Bhtd.sendEmptyMessageDelayed(18, 300L);
      return;
