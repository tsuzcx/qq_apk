...
public class anfe
  implements anfp, ISuperPlayer.OnCompletionListener, ISuperPlayer.OnErrorListener, ISuperPlayer.OnInfoListener, ISuperPlayer.OnVideoPreparedListener
{
  ...
  public View a()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_ComTencentSuperplayerViewISPlayerVideoView.addViewCallBack(new anff(this));
  ...
  public void onCompletion(ISuperPlayer paramISuperPlayer)
  {
    ...
    {
      anfo localanfo = (anfo)paramISuperPlayer.next();
      if (localanfo != null) {
        localanfo.g();
      }
    }
  ...
  {
    QLog.i("CmGameGdtVideoPlayer", 1, "[onError]extra model = " + paramInt1 + ", what = " + paramInt2 + ", extra = " + paramInt3 + ", detailInfo = " + paramString);
    paramISuperPlayer = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
    while (paramISuperPlayer.hasNext())
    {
      anfo localanfo = (anfo)paramISuperPlayer.next();
      if (localanfo != null) {
        localanfo.a(paramInt1, paramInt2, paramString);
      }
    }
    d();
    return false;
