  ...
  implements View.OnClickListener
{
  ...
  private TextWatcher jdField_a_of_type_AndroidTextTextWatcher = new anff(this);
  ...
  public anfe(Context paramContext, ViewGroup paramViewGroup, QQAppInterface paramQQAppInterface, XEditTextEx paramXEditTextEx)
  {
  ...
  private View a(String paramString)
  {
    ...
    paramString.leftMargin = actj.a(14.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    ((RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131364075)).addView(localView, paramString);
    return localView;
  }
  ...
  public void onClick(View paramView)
  {
    ...
    if ((paramView instanceof anfd))
    {
      paramView = ((anfd)paramView).a();
      if (!TextUtils.isEmpty(paramView))
      {
        ...
        arrayOfmxk[0] = new mxk(this.jdField_a_of_type_AndroidViewViewGroup, new anfg(this, arrayOfmxk));
        this.jdField_a_of_type_AndroidViewView.setOnClickListener(new anfh(this, paramView));
      }
    }
  }
}
