...
public class yha
  extends Handler
{
  public yha(SelectMemberActivity paramSelectMemberActivity, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      if (!TextUtils.isEmpty(this.a.jdField_g_of_type_JavaLangString))
      {
        ...
        postDelayed(new yhb(this), 1500L);
        return;
      }
      if (this.a.jdField_g_of_type_Boolean) {}
      for (int i = 2131436016;; i = 2131436017)
      {
    ...
    paramMessage = str;
    if (str == null) {
      paramMessage = this.a.getString(2131436018);
    }
