  ...
  extends PopupWindow
{
  ...
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new bfsv(this);
  View jdField_a_of_type_AndroidViewView;
  ImageView jdField_a_of_type_AndroidWidgetImageView;
  LinearLayout jdField_a_of_type_AndroidWidgetLinearLayout;
  bfsx jdField_a_of_type_Bfsx;
  bfsy jdField_a_of_type_Bfsy = new bfsw(this);
  ...
  public bfst(@NonNull Context paramContext)
  {
    super(paramContext);
    ...
    this.jdField_b_of_type_JavaLangString = ajya.a(2131705925);
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559981, null);
  ...
  private void a(Object paramObject, boolean paramBoolean)
  {
    ...
    nol.a(null, "", "0X8009990", "0X8009990", 0, 0, String.valueOf(this.r), "", this.jdField_c_of_type_JavaLangString, localJSONObject.toString(), false);
  }
  ...
  private void e()
  {
    ...
    {
      if (i1 <= 1) {
        ((View)this.jdField_f_of_type_JavaUtilArrayList.get(0)).setBackgroundResource(2130842385);
      }
    }
    else {
      return;
    }
    ((View)this.jdField_f_of_type_JavaUtilArrayList.get(0)).setBackgroundResource(2130842387);
    ((View)this.jdField_f_of_type_JavaUtilArrayList.get(i1 - 1)).setBackgroundResource(2130842386);
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, ArrayList<DislikeInfo> paramArrayList, String paramString)
  {
    ...
    for (paramInt1 = paramArrayList.size();; paramInt1 = 0)
    {
      ...
      paramArrayList = new DislikeInfo();
      paramArrayList.jdField_a_of_type_JavaLangString = BaseApplicationImpl.getContext().getString(2131718479);
      paramArrayList.jdField_c_of_type_Int = 8;
      paramArrayList.jdField_b_of_type_JavaLangString = "";
      this.jdField_e_of_type_JavaUtilArrayList.add(paramArrayList);
      a(this.jdField_a_of_type_JavaUtilArrayList, this.jdField_b_of_type_AndroidViewView, 2130841223, ajya.a(2131705931), true);
      a(this.jdField_b_of_type_JavaUtilArrayList, this.jdField_c_of_type_AndroidViewView, 2130841227, ajya.a(2131705941), true);
      a(this.jdField_c_of_type_JavaUtilArrayList, this.jdField_d_of_type_AndroidViewView, 2130841216, a(this.jdField_c_of_type_JavaUtilArrayList), false);
      a(this.jdField_d_of_type_JavaUtilArrayList, this.jdField_e_of_type_AndroidViewView, 2130841220, ajya.a(2131705937), false);
      a(this.jdField_e_of_type_JavaUtilArrayList, this.jdField_f_of_type_AndroidViewView, 2130841215, BaseApplicationImpl.getContext().getString(2131718479), false);
      a();
  ...
  {
    this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131370711);
    this.jdField_c_of_type_AndroidViewView = paramView.findViewById(2131370707);
    this.jdField_d_of_type_AndroidViewView = paramView.findViewById(2131370713);
    this.jdField_e_of_type_AndroidViewView = paramView.findViewById(2131370710);
    this.jdField_f_of_type_AndroidViewView = paramView.findViewById(2131370709);
    ...
    this.jdField_a_of_type_ComTencentWidgetNegativeChildrenLayout = ((NegativeChildrenLayout)paramView.findViewById(2131364202));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131369744));
    ((ImageView)paramView.findViewById(2131366288).findViewById(2131369099)).setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
    this.i = ((int)bbdh.i());
    this.j = ((int)bbdh.j());
    this.l = ((int)this.jdField_a_of_type_AndroidContentContext.getResources().getDimension(2131298591));
    this.k = (this.i - this.l * 2);
    setWidth(this.k);
    this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131364691));
    this.jdField_a_of_type_JavaUtilMap.put(Long.valueOf(1L), ajya.a(2131705938));
    this.jdField_a_of_type_JavaUtilMap.put(Long.valueOf(2L), ajya.a(2131705936));
    this.jdField_a_of_type_JavaUtilMap.put(Long.valueOf(3L), ajya.a(2131705927));
    this.jdField_a_of_type_JavaUtilMap.put(Long.valueOf(4L), ajya.a(2131705928));
    this.jdField_a_of_type_JavaUtilMap.put(Long.valueOf(5L), ajya.a(2131705933));
    this.jdField_a_of_type_JavaUtilMap.put(Long.valueOf(6L), ajya.a(2131705932));
    this.m = ((int)this.jdField_a_of_type_AndroidContentContext.getResources().getDimension(2131298568));
    this.jdField_e_of_type_AndroidViewView.findViewById(2131375889).setVisibility(4);
    setBackgroundDrawable(new ColorDrawable());
    setOnDismissListener(new bfsu(this));
    this.jdField_a_of_type_AndroidViewView.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
  }
  
  public void a(View paramView, bfsx parambfsx)
  {
    if (isShowing()) {
      dismiss();
    }
    this.jdField_a_of_type_Bfsx = parambfsx;
    parambfsx = new int[2];
    try
    {
      bool = a(paramView, parambfsx);
      if (bool)
      {
        showAtLocation(paramView, 51, parambfsx[0], parambfsx[1]);
        a(0.8F);
        a(this);
      }
      return;
  ...
  protected void a(ArrayList<DislikeInfo> paramArrayList, View paramView, int paramInt, String paramString, boolean paramBoolean)
  {
    ...
    if (!paramArrayList.isEmpty())
    {
      ...
      {
        ((TextView)paramView.findViewById(2131368383)).setText(paramString);
        localTextView = (TextView)paramView.findViewById(2131368379);
        localImageView = (ImageView)paramView.findViewById(2131368368);
        ((ImageView)paramView.findViewById(2131368335)).setImageResource(paramInt);
        paramString = "";
        if (!paramBoolean) {
          break label150;
        }
  ...
  public void a(pbf parampbf, ArrayList<DislikeInfo> paramArrayList)
  {
    int i2 = 0;
    String str = null;
    if (parampbf != null) {}
    for (;;)
    {
      try
      {
        i1 = parampbf.jdField_b_of_type_Int;
        i2 = parampbf.jdField_a_of_type_Int;
        parampbf = parampbf.a();
        int i3 = onh.a(parampbf);
        str = "";
        if (parampbf != null) {
          str = parampbf.innerUniqueID;
        }
        a(i1, i2, i3, paramArrayList, str);
        return;
      }
      catch (Exception parampbf)
      {
        return;
      }
      int i1 = 0;
  ...
  protected void c(View paramView)
  {
    ...
    do
    {
      ...
      {
        return;
      } while (this.jdField_a_of_type_Bfsx == null);
      paramView = paramView.getTag();
    } while (!(paramView instanceof DislikeInfo));
    ArrayList localArrayList = new ArrayList();
    localArrayList.add((DislikeInfo)paramView);
    this.jdField_a_of_type_Bfsx.a(null, this.o, localArrayList, null);
  }
