  ...
  extends ynw
{
  ...
  private void b(int paramInt)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("EditPicActivity.EditPicPartManager", 2, "reset2Camera begin " + this.jdField_a_of_type_Ypg.getActivity() + " new path " + str);
    }
    PreferenceManager.getDefaultSharedPreferences(this.jdField_a_of_type_Ypg.a()).edit().putString("edit_pic_new_path", str).commit();
    Intent localIntent;
    if (paramInt == 101)
    {
    ...
    try
    {
      QQToast.a(localActivity, anvx.a(2131703165), 0).a();
  ...
  private void w()
  {
    ...
    localyya.b = yyq.a(2);
    localyya.jdField_a_of_type_Yye = new yye(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.mEditSource.getSourcePath());
    localyya.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064 = new LpReportInfo_pf00064();
    localyya.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.actionType = 615;
    localyya.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.subactionType = 8;
    ...
    if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.mBusinessId == 3)
    {
      ...
      int i = 0;
      while (i < localyya.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reservesArray.size())
      {
        ((StringBuilder)localObject).append((String)localyya.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reservesArray.get(i) + ",");
        i += 1;
      }
      if (((StringBuilder)localObject).length() > 0) {
        ((StringBuilder)localObject).deleteCharAt(((StringBuilder)localObject).length() - 1);
      }
      localyya.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reserves5 = ((StringBuilder)localObject).toString();
      LpReportManager.getInstance().reportToPF00064(localyya.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064, true, false);
    }
    ykw.b("0X80076EA");
    ykq.d("EditPicActivity.EditPicPartManager", "PUBLISH start ...");
    this.jdField_a_of_type_Ypg.a(anvx.a(2131703164), false, 500L);
    Stream.of(localyya).map(new yyc((ylc)a(ylc.class), null)).map(new ThreadOffFunction("EditPicActivity.EditPicPartManager", 2)).map(new yyo(yls.jdField_a_of_type_JavaLangString + "qq_pic_merged_" + System.currentTimeMillis() + ".jpg")).map(new UIThreadOffFunction(this)).subscribe(new ylv(this, localyya));
  }
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if ((paramInt1 == 1000) && (paramInt2 != -1) && (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)))
    {
      ...
      zeb.b(BaseApplication.getContext(), new File(this.jdField_a_of_type_JavaLangString));
  ...
  void a(Activity paramActivity, int paramInt, Intent paramIntent)
  {
    ...
    default: 
      ...
      this.jdField_a_of_type_Ypg.a(-1, null, 2130772030, 0);
      return;
    case 104: 
    ...
    case 5: 
      ...
      paramIntent.putExtra("param_title", paramActivity.getString(2131690638));
      paramIntent.putExtra("param_done_button_wording", paramActivity.getString(2131691037));
  ...
  protected void a(@NonNull EditVideoParams paramEditVideoParams)
  {
    ...
    Object localObject = new ymj(this, paramEditVideoParams.mEnableMasks);
    this.jdField_a_of_type_Ymj = ((ymj)localObject);
    localArrayList.add(localObject);
    localObject = new yml(this, paramEditVideoParams.mEnableMasks);
    ...
    {
      localObject = new ylh(this);
      this.jdField_a_of_type_Ylh = ((ylh)localObject);
      localArrayList.add(localObject);
    }
    a(localArrayList);
  ...
  public void b()
  {
    Object localObject = this.jdField_a_of_type_Ypg.getActivity().getIntent();
    ...
    if ((i == 103) && (i == 103))
    {
      ...
      bdla.b(null, "dc00898", "", "", "0X80072C5", "0X80072C5", 0, 0, (String)localObject, "" + j, "", "");
      if (bool) {
        bdla.b(null, "dc00898", "", "", "0X80083B2", "0X80083B2", 0, 0, (String)localObject, "" + j, "", "");
      }
      ykw.b("0X80075E8");
    }
    for (;;)
    {
      ...
      break;
      label379:
      bdla.b(null, "dc00898", "", "", "0X80072C4", "0X80072C4", 0, 0, (String)localObject, "" + j, "", "");
    }
  }
  ...
  protected void c()
  {
    ...
    if (i != -1)
    {
      ...
      bheg.a(this.jdField_a_of_type_Ypg.a(), this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.mEditSource.getSourcePath());
      ...
      if (i == 103)
      {
        ...
        for (;;)
        {
          this.jdField_a_of_type_Ypg.a(0, localIntent, 2130772030, 0);
          return;
          localObject = "1";
          break;
          label264:
