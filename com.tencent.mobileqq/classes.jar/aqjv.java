...
public class aqjv
  extends aqjn
{
  public aqjv(BusinessCardEditActivity paramBusinessCardEditActivity) {}
  ...
  public void a(boolean paramBoolean, String paramString)
  {
    ...
    if (paramBoolean)
    {
      QQToast.a(this.a.getActivity(), 2, anvx.a(2131700756), 0).b(this.a.getTitleBarHeight());
      this.a.finish();
      return;
    }
    QQToast.a(this.a.getActivity(), 1, anvx.a(2131700751), 0).b(this.a.getTitleBarHeight());
  }
  ...
  public void a(boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    if ((paramBoolean) && (paramString.equals(this.a.jdField_a_of_type_JavaLangString)))
    {
      ...
      {
        this.a.c = 0;
        this.a.jdField_a_of_type_Aqjm.a(false);
      }
      if ((!this.a.jdField_a_of_type_Boolean) || (!this.a.b) || (this.a.isFinishing())) {
        break label190;
      }
      this.a.jdField_a_of_type_Aqjm.a(paramString);
    ...
    {
      return;
      paramString = this.a.jdField_a_of_type_Aqjm.a(paramString);
  ...
  public void b(boolean paramBoolean, String paramString)
  {
    ...
    if (paramBoolean)
    {
      this.a.b(anvx.a(2131700753));
      bdla.b(this.a.app, "CliOper", "", "", "0X8007748", "0X8007748", this.a.d, 0, "", "", "", "");
      return;
    }
    QQToast.a(this.a.getActivity(), 2, anvx.a(2131700761), 0).b(this.a.getTitleBarHeight());
  }
  ...
  public void b(boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      localObject = ((Resources)localObject).getString(2131698309);
    ...
    paramString = ((Resources)localObject).getString(2131698307);
    if (paramInt == 66) {
      paramString = ((Resources)localObject).getString(2131698308);
    }
