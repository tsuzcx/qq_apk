  ...
  extends MSFServlet
{
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    if ("QQApkSvc.pre_download_apk".equals(str))
    {
      ...
      paramPacket.putSendData(bhuf.a(((ServerApi.ReqPreDownloadRecmd)localObject).toByteArray()));
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
      ...
      if ("QQApkSvc.update_download_count".equals(str))
      {
        ...
        paramPacket.setSSOCommand(str);
        paramPacket.putSendData(bhuf.a(((ServerApi.ReqUpdateDownCountRecmd)localObject).toByteArray()));
      }
    }
  }
}
