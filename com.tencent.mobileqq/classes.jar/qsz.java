...
public class qsz
  extends xfi<TabChannelCoverInfo>
{
  public static final String a;
  private Map<Integer, pov> jdField_a_of_type_JavaUtilMap;
  private nia jdField_a_of_type_Nia;
  private TabLayout b;
  
  static
  {
    jdField_a_of_type_JavaLangString = qsz.class.getSimpleName();
  }
  
  public qsz(Context paramContext, List<TabChannelCoverInfo> paramList, TabLayout paramTabLayout, nia paramnia)
  {
  ...
  protected void a(xfj paramxfj, TabChannelCoverInfo paramTabChannelCoverInfo, int paramInt)
  {
    TextView localTextView = (TextView)paramxfj.a(2131312553);
    Object localObject2 = (ImageView)paramxfj.a(2131302963);
    ImageView localImageView2 = (ImageView)paramxfj.a(2131302966);
    Object localObject1 = (ImageView)paramxfj.a(2131305089);
    a(new View[] { localTextView, localObject2, localImageView2, localObject1 });
    ImageView localImageView1 = (ImageView)paramxfj.a(2131303038);
    ...
    try
    {
      ...
      else
      {
        ...
        paramxfj.a().setOnClickListener(new qta(this, paramInt, paramTabChannelCoverInfo, localImageView1));
        if (this.b != null)
        {
          ...
          {
            localObject1 = new pqf();
            ((pov)localObject1).a = paramTabChannelCoverInfo;
            ((pov)localObject1).l = paramInt;
        ...
        {
          paramxfj = paramxfj.a(2131302725);
          if (paramInt != this.jdField_a_of_type_Nia.c()) {
            break label784;
          }
          localTextView.setTextColor(localTextView.getResources().getColor(2131101156));
          localTextView.setTypeface(Typeface.defaultFromStyle(1));
          paramxfj.setVisibility(0);
          if (this.jdField_a_of_type_Nia.a() == 0)
          {
            paramTabChannelCoverInfo = (ViewGroup.MarginLayoutParams)paramxfj.getLayoutParams();
            paramTabChannelCoverInfo.leftMargin = bajq.b(0.0F);
            paramTabChannelCoverInfo.rightMargin = bajq.b(0.0F);
            paramxfj.setLayoutParams(paramTabChannelCoverInfo);
          }
        }
        return;
      }
    ...
    catch (Exception localException)
    {
      ...
      for (;;)
      {
        ...
        if (QLog.isColorLevel())
        {
          ...
          if ((paramInt < b()) && (i == 0))
          {
            Object localObject3 = this.jdField_a_of_type_Nia;
            if (nia.b)
            {
            ...
            ((ImageView)localObject1).setVisibility(8);
            continue;
            localTextView.setTextColor(localTextView.getResources().getColor(2131101157));
            localTextView.setTypeface(Typeface.defaultFromStyle(0));
            paramxfj.setVisibility(4);
          }
        }
      }
    }
