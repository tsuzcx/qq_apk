...
public class bkzf
{
  ...
  public bkzf(AbsSpinner paramAbsSpinner) {}
  ...
  public void b()
  {
    ...
    if (i < j)
    {
      ...
      if ((localView == null) || (!(localView.getTag(2131367491) instanceof Boolean))) {
        break label94;
      }
    }
    label94:
    for (boolean bool = ((Boolean)localView.getTag(2131367491)).booleanValue();; bool = true)
    {
