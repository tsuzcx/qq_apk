  ...
  implements Closeable
{
  ...
  public bkzf(String paramString, int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3)
  {
  ...
  private boolean a(RandomAccessFile paramRandomAccessFile, int paramInt, bkzg parambkzg)
  {
    ...
    try
    {
      ...
      l2 = a(arrayOfByte, 0);
      long l3 = parambkzg.jdField_a_of_type_Long;
      if (l2 != l3) {
        return false;
      }
      k = a(arrayOfByte, 8);
      ...
      if ((parambkzg.jdField_a_of_type_ArrayOfByte == null) || (parambkzg.jdField_a_of_type_ArrayOfByte.length < m)) {
        parambkzg.jdField_a_of_type_ArrayOfByte = new byte[m];
      }
      arrayOfByte = parambkzg.jdField_a_of_type_ArrayOfByte;
      parambkzg.jdField_a_of_type_Int = m;
    ...
    catch (Throwable parambkzg)
    {
      QLog.e("BlobCache", 2, "getBlob failed.", parambkzg);
      return false;
    }
    finally
    {
  ...
  public boolean a(bkzg parambkzg)
  {
    if ((a(parambkzg.jdField_a_of_type_Long, this.g)) && (a(this.jdField_d_of_type_JavaIoRandomAccessFile, this.j, parambkzg))) {}
    int k;
    do
    {
      return true;
      k = this.i;
      if ((!a(parambkzg.jdField_a_of_type_Long, this.h)) || (!a(this.jdField_e_of_type_JavaIoRandomAccessFile, this.j, parambkzg))) {
        break;
      }
    } while ((this.jdField_e_of_type_Int + 20 + parambkzg.jdField_a_of_type_Int > this.jdField_b_of_type_Int) || (this.jdField_d_of_type_Int * 2 >= this.jdField_a_of_type_Int));
    this.i = k;
    try
    {
      b(parambkzg.jdField_a_of_type_Long, parambkzg.jdField_a_of_type_ArrayOfByte, parambkzg.jdField_a_of_type_Int);
      this.jdField_d_of_type_Int += 1;
      a(this.jdField_a_of_type_ArrayOfByte, 16, this.jdField_d_of_type_Int);
      f();
      return true;
