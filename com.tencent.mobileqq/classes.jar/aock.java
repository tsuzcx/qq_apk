...
public class aock
{
  public static int a(String paramString)
  {
    try
    {
      int i = aocy.a("arcloud", "v8.4.1.1", aocy.b("arcloud", "v8.4.1.1", "arcloud"), paramString);
      return i;
    }
    finally
    {
  ...
  public static int a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        aocy.a("arcloud", "v8.4.1.1", "arcloud", paramString2);
        paramString2 = aocy.a("arcloud", "v8.4.1.1", paramString2);
        try
        {
      ...
      try
      {
        ...
        aocy.a("arcloud", "v8.4.1.1", (String)localObject3, (String)((Map.Entry)localObject2).getValue());
        localObject3 = new File((String)localObject1);
        QLog.i("AREngine_ArCloudNativeSoLoader", 2, "doOnDownloadSuccess. soFilename = " + (String)localObject1);
        if (!((File)localObject3).exists()) {
          break label516;
        }
        str = ayja.a((String)localObject1);
  ...
  {
    return new File(aocy.a("arcloud", "v8.4.1.1", aocy.b("arcloud", "v8.4.1.1", "arcloud")) + File.separator + a() + ".so").exists();
  }
  ...
  public static boolean a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        String str = aocy.a("arcloud", "v8.4.1.1", aocy.b("arcloud", "v8.4.1.1", "arcloud")) + File.separator + paramString + ".so";
        ...
        {
          paramString = aocy.b("arcloud", "v8.4.1.1", paramString);
