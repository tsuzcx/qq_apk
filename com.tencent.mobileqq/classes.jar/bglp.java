...
{
  /* Error */
  public static bfgs a(android.os.Bundle paramBundle, java.lang.String paramString1, java.lang.String paramString2)
  {
    // Byte code:
    //   0: iconst_0
    //   1: istore 4
    ...
    //   75: aload 10
    //   77: invokestatic 58	com/tencent/mobileqq/utils/FileUtils:getFileSizes	(Ljava/lang/String;)J
    ...
    //   94: ifne +11 -> 105
    //   97: aload 10
    //   99: invokestatic 79	com/tencent/mobileqq/utils/FileUtils:fileExists	(Ljava/lang/String;)Z
    //   102: ifne +39 -> 141
    ...
    //   263: ldc 136
    //   265: aload 10
    //   267: invokestatic 58	com/tencent/mobileqq/utils/FileUtils:getFileSizes	(Ljava/lang/String;)J
    ...
    //   287: ldc 144
    //   289: aload 10
    //   291: invokestatic 149	auea:a	(Ljava/lang/String;)[B
    ...
    //   314: ldc 160
    //   316: aload 10
    //   318: invokestatic 162	auea:e	(Ljava/lang/String;)[B
    ...
    //   355: aload_2
    //   356: invokestatic 172	com/tencent/mobileqq/troop/utils/TroopUtils:getBknBySkey	(Ljava/lang/String;)I
    ...
    //   653: dup
    //   654: aload 8
    //   656: invokespecial 263	bfgs:<init>	(Lorg/json/JSONObject;)V
    //   659: astore 8
    //   661: aload_0
    //   662: astore_2
    //   663: aload 8
    ...
    //   705: lload 6
    //   707: lsub
    //   708: invokevirtual 61	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   711: invokevirtual 65	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   714: invokestatic 69	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   717: aload_0
    //   718: areturn
    //   719: aload_0
    ...
    //   752: invokestatic 69	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   755: aload_2
    //   756: ifnull +7 -> 763
    //   759: aload_2
