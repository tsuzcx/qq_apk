...
public class ahcj
  ...
  implements bcwt, nrw
{
  private ajfa jdField_a_of_type_Ajfa = new ajfa(paramClassificationSearchFragment.a, this, false);
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new ahck(this);
  private String jdField_a_of_type_JavaLangString;
  private ArrayList<nry> jdField_a_of_type_JavaUtilArrayList;
  private boolean jdField_a_of_type_Boolean;
  
  public ahcj(ClassificationSearchFragment paramClassificationSearchFragment)
  {
    a(true);
  }
  ...
  public void a(ArrayList<nry> paramArrayList, String paramString, boolean paramBoolean)
  {
    ...
    if (ClassificationSearchFragment.a(this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment) != null)
    {
      if (getCount() == 0)
      {
        ((TextView)ClassificationSearchFragment.a(this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment).findViewById(2131376209)).setText(alpo.a(2131702294));
    ...
    for (;;)
    {
      ...
      if (TextUtils.isEmpty(paramString)) {
        ((TextView)ClassificationSearchFragment.a(this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment).findViewById(2131376209)).setText(alpo.a(2131702299));
      }
      for (;;)
      {
        ...
        break;
        ((TextView)ClassificationSearchFragment.a(this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment).findViewById(2131376209)).setText(paramString);
      }
      label271:
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null) {
      paramViewGroup = LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.getActivity()).inflate(2131559501, null);
    }
    ...
    if (paramView != null)
    {
      if (this.jdField_a_of_type_Ajfa != null)
      {
        Drawable localDrawable = this.jdField_a_of_type_Ajfa.a(1008, paramView.jdField_a_of_type_JavaLangString);
        ((URLImageView)paramViewGroup.findViewById(2131367506)).setImageDrawable(localDrawable);
      }
      ((TextView)paramViewGroup.findViewById(2131370958)).setText(paramView.b);
      paramViewGroup.findViewById(2131364735).setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
      paramViewGroup.findViewById(2131364735).setTag(paramView);
  ...
  public void onDecodeTaskCompleted(int paramInt1, int paramInt2, String paramString, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      ...
      {
        GridView localGridView = (GridView)ClassificationSearchFragment.a(this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment).findViewById(2131376205);
        ...
        while (paramInt1 < paramInt2)
        {
          ...
          if (paramString.equals(((nry)localView.getTag()).jdField_a_of_type_JavaLangString)) {
            ((URLImageView)localView.findViewById(2131367506)).setImageBitmap(paramBitmap);
          }
          paramInt1 += 1;
        }
      }
