...
public class llz
{
  ...
  static lmb jdField_a_of_type_Lmb = new lmb();
  ...
  private Camera.PreviewCallback jdField_a_of_type_AndroidHardwareCamera$PreviewCallback = new lma(this);
  Camera jdField_a_of_type_AndroidHardwareCamera = null;
  Display jdField_a_of_type_AndroidViewDisplay;
  String jdField_a_of_type_JavaLangString;
  lmc jdField_a_of_type_Lmc = null;
  lmd jdField_a_of_type_Lmd = new lmd();
  ...
  public llz(Context paramContext)
  {
    ...
    jdField_a_of_type_Lmb.jdField_c_of_type_Int = -1;
  ...
  private void a(long paramLong)
  {
    ...
    if ((this.jdField_b_of_type_Boolean) && (a() != null)) {
      if (a(a(a().getPreviewFormat())))
      {
        ...
        if (i1 < lmk.a().a())
        {
          byte[] arrayOfByte = lmk.a().a(0);
          n = i2;
          if (arrayOfByte != null)
          {
            lmk.a().a(arrayOfByte, 1);
  ...
  int a(int paramInt, boolean paramBoolean)
  {
    ...
    while (paramBoolean)
    {
      return lno.a(this.jdField_a_of_type_AndroidContentContext, true, false, b1, false) * 90;
      b1 = 0;
      continue;
      b1 = 1;
      continue;
    ...
    return lno.b(this.jdField_a_of_type_AndroidContentContext, true, false, b1, false) * 90;
  }
  
  int a(boolean paramBoolean)
  {
    if (paramBoolean) {
      return 360 - lno.a(this.jdField_a_of_type_AndroidContentContext, true, true, (byte)0, false) * 90;
    }
    return 360 - lno.b(this.jdField_a_of_type_AndroidContentContext, true, true, (byte)0, false) * 90;
  }
  ...
  protected lmb a(int paramInt, Camera paramCamera)
  {
    paramCamera = new lmb();
    try
    {
  ...
  {
    int n = jdField_a_of_type_Lmb.jdField_c_of_type_Int;
    jdField_a_of_type_Lmb.jdField_c_of_type_Int = ((this.h + paramInt) % 360);
    if (n != jdField_a_of_type_Lmb.jdField_c_of_type_Int) {
      QLog.w("AndroidCamera", 1, "setMobileRotation, rotation[" + n + "->" + jdField_a_of_type_Lmb.jdField_c_of_type_Int + "], CompenSateSendAngle[" + this.h + "]");
    }
  }
  ...
  public void a(long paramLong, int paramInt)
  {
    ...
    {
      return;
      synchronized (jdField_a_of_type_Lmb)
      {
  ...
  public void a(lmc paramlmc)
  {
    this.jdField_a_of_type_Lmc = paramlmc;
  }
  ...
  public void a(boolean paramBoolean, int paramInt)
  {
    ...
    for (;;)
    {
      lek.c("AndroidCamera", "mFrontCameraAngle: " + this.i + ", mBackCameraAngle: " + this.j);
      return;
      this.j = (paramInt % 360);
    }
  }
  ...
  {
    lmb locallmb = a(paramInt, paramCamera);
    this.h = b();
    this.g = c();
    int i1 = d();
    int i2 = e();
    int i3;
    int i4;
    if (locallmb.jdField_a_of_type_Int == 1)
    {
      n = (360 - (i1 + i2) % 360) % 360;
    ...
    {
      QLog.w("AndroidCamera", 1, "setCameraDisplayOrientation, cameraId[" + paramInt + "], orientation[" + jdField_a_of_type_Lmb.jdField_b_of_type_Int + "->" + locallmb.jdField_b_of_type_Int + "], rotation[" + jdField_a_of_type_Lmb.jdField_c_of_type_Int + "->" + locallmb.jdField_c_of_type_Int + "], CompenSateSendAngle[" + this.h + "], CompenSateRecvAngle[" + this.g + "], mSupportLandscape[" + this.jdField_e_of_type_Boolean + "], previewAngleForFrontCamera[" + i3 + "], previewAngleForBackCamera[" + i4 + "], cameraImageOrientation[" + i1 + "], mobileRotation[" + i2 + "], result[" + n + "], seq[" + paramLong + "]");
      a(paramCamera, n);
      jdField_a_of_type_Lmb.jdField_a_of_type_Int = locallmb.jdField_a_of_type_Int;
      jdField_a_of_type_Lmb.jdField_b_of_type_Int = locallmb.jdField_b_of_type_Int;
      return true;
      n = (i1 - i2 + 360) % 360;
      break;
    }
  ...
  public boolean a(long paramLong, SurfaceTexture paramSurfaceTexture)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (jdField_a_of_type_Boolean)
        {
          ...
          lmm.a(BaseApplicationImpl.getContext(), "openCamera");
          return bool1;
        }
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      if (this.jdField_a_of_type_AndroidHardwareCamera != null)
      {
        ...
        break label581;
        label563:
        lmm.b(BaseApplicationImpl.getContext(), "openCamera");
        break label154;
        bool1 = false;
        break label321;
      }
      ...
      try
      {
        ...
        if (this.jdField_d_of_type_Int >= 1) {
          if (this.jdField_a_of_type_AndroidHardwareCamera == null)
          {
            ...
            if (bool1)
            {
              lmm.a(BaseApplicationImpl.getContext(), "reopenCamera");
              return bool1;
            }
          }
          else
        ...
        case 1: 
          ...
          break label371;
          lmm.b(BaseApplicationImpl.getContext(), "reopenCamera");
          continue;
          bool1 = false;
        }
      }
  ...
  int b(int paramInt, boolean paramBoolean)
  {
    ...
    while (paramBoolean)
    {
      return lno.a(this.jdField_a_of_type_AndroidContentContext, false, false, b1, false) * 90;
      b1 = 0;
      continue;
      b1 = 1;
      continue;
    ...
    return lno.b(this.jdField_a_of_type_AndroidContentContext, false, false, b1, false) * 90;
  }
  
  int b(boolean paramBoolean)
  {
    if (paramBoolean) {
      return lno.a(this.jdField_a_of_type_AndroidContentContext, false, true, (byte)0, false) * 90;
    }
    return lno.b(this.jdField_a_of_type_AndroidContentContext, false, true, (byte)0, false) * 90;
  }
  ...
  protected Camera b(long paramLong)
  {
    ...
    //   6: aload_0
    //   7: iconst_0
    //   8: putfield 411	llz:jdField_f_of_type_Int	I
    //   11: aload_0
    //   12: getfield 57	llz:jdField_d_of_type_Int	I
    //   15: ifne +11 -> 26
    //   18: aload_0
    //   19: aload_0
    //   20: invokevirtual 412	llz:a	()I
    //   23: putfield 57	llz:jdField_d_of_type_Int	I
    //   26: aload_0
    //   27: getfield 57	llz:jdField_d_of_type_Int	I
    //   30: ifle +240 -> 270
    ...
    //   44: iload_3
    //   45: aload_0
    //   46: getfield 57	llz:jdField_d_of_type_Int	I
    ...
    //   134: aload_0
    //   135: iload_3
    //   136: putfield 411	llz:jdField_f_of_type_Int	I
    //   139: aload 5
    //   141: astore 6
    ...
    //   176: aload_0
    //   177: getfield 411	llz:jdField_f_of_type_Int	I
    ...
    //   189: aload_0
    //   190: getfield 57	llz:jdField_d_of_type_Int	I
    ...
    //   229: aload_0
    //   230: iconst_0
    //   231: putfield 411	llz:jdField_f_of_type_Int	I
    //   234: ldc 135
    //   236: iconst_1
    ...
    //   292: aload_0
    //   293: getfield 57	llz:jdField_d_of_type_Int	I
      ...
      try
      {
        if (this.jdField_d_of_type_Int >= 1)
        {
          if (this.jdField_a_of_type_AndroidHardwareCamera == null)
          {
            ...
            if (bool1)
            {
              lmm.a(BaseApplicationImpl.getContext(), "switchCamera");
              return bool1;
            }
          }
          else
          ...
          lmm.b(BaseApplicationImpl.getContext(), "switchCamera");
          continue;
        }
        bool1 = false;
      }
  ...
  public boolean c(long paramLong)
  {
    try
    {
      ...
      lmm.b(BaseApplicationImpl.getContext(), "closeCamera");
      return true;
    }
    finally {}
  }
  ...
  public int d()
  {
    if (jdField_a_of_type_Lmb.jdField_b_of_type_Int == -1)
    {
    ...
    return jdField_a_of_type_Lmb.jdField_b_of_type_Int;
  }
  
  public int e()
  {
    if (jdField_a_of_type_Lmb.jdField_c_of_type_Int == -1) {
      return 0;
    }
    return jdField_a_of_type_Lmb.jdField_c_of_type_Int;
  }
