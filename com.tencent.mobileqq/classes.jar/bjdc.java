  ...
  extends birb
{
  ...
  public bjdc(FriendListOpenFrame paramFriendListOpenFrame)
  {
  ...
  protected void a()
  {
    ...
    Object localObject1 = this.jdField_a_of_type_ComTencentOpenAgentFriendListOpenFrame.jdField_a_of_type_Bjgp.a(this.jdField_a_of_type_ComTencentOpenAgentFriendListOpenFrame.jdField_a_of_type_Int);
    bjko.c("FriendListOpenFrame", "-->start constructHashStruct()");
    ...
    bjko.c("FriendListOpenFrame", "-->end constructHashStruct()");
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_ComTencentOpenAgentFriendListOpenFrame.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562851, paramViewGroup, false);
      paramView = new bjdd();
      ...
      if (!this.jdField_a_of_type_ComTencentOpenAgentFriendListOpenFrame.jdField_a_of_type_Bjgp.a(((Friend)localObject).a)) {
        break label399;
      }
      ...
      if ((((Friend)localObject).d == null) || ("".equals(((Friend)localObject).d))) {
        ((Friend)localObject).d = bjgw.a(this.jdField_a_of_type_ComTencentOpenAgentFriendListOpenFrame.jdField_a_of_type_ComTencentOpenAgentFriendChooser.a(), ((Friend)localObject).a);
      }
      ...
      bjgt.a().a(((Friend)localObject).d, this.jdField_a_of_type_ComTencentOpenAgentFriendListOpenFrame);
      label330:
    ...
    for (;;)
    {
      ...
      return localView;
      localObject = (bjdd)paramView.getTag();
      localView = paramView;
