...
public class bfdg
{
  ...
  private static HashMap<String, bfdf> d;
  ...
  public static bfdf a(QQAppInterface paramQQAppInterface, String paramString)
  {
    Object localObject;
    if (paramString == null)
    {
      QLog.e("TroopNotificationHelper", 1, "HasUnReadRepeatTroopNotification, troopUin is NULL!");
      localObject = (bfdf)jdField_d_of_type_JavaUtilHashMap.get(paramString);
      if (localObject == null) {
        break label141;
      }
      ...
      {
        paramString = new StringBuilder().append("HasUnReadRepeatTroopNotification. found in mTroopNotificationRepeatAIOFlag. type = ").append(((bfdf)localObject).jdField_a_of_type_Int).append(", feedsId = ");
        if (!TextUtils.isEmpty(((bfdf)localObject).jdField_a_of_type_JavaLangString)) {
          break label133;
        }
        paramQQAppInterface = "";
        label78:
    ...
    do
    {
      do
      {
        ...
        break;
        paramQQAppInterface = ((bfdf)localObject).jdField_a_of_type_JavaLangString;
        break label78;
        ...
        paramString = (bfdf)jdField_d_of_type_JavaUtilHashMap.get(paramString);
      ...
      return null;
      paramString = new bfdf(((TroopInfo)localObject).feeds_id, ((TroopInfo)localObject).troopRepeatType);
      paramQQAppInterface = paramString;
    } while (!QLog.isColorLevel());
  ...
  public static bfdh a(DataInputStream paramDataInputStream, boolean paramBoolean)
  {
  ...
  public static bfdh a(String paramString, byte[] paramArrayOfByte, boolean paramBoolean)
  {
    boolean bool1 = true;
    boolean bool2 = false;
    label851:
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((i == 5) || (i == 19))
        {
          ...
          localObject5 = new bfdh();
          ((bfdh)localObject5).jdField_a_of_type_JavaLangString = paramArrayOfByte;
          ((bfdh)localObject5).jdField_b_of_type_JavaLangString = paramString;
          ((bfdh)localObject5).jdField_c_of_type_JavaLangString = ((String)localObject3);
          ((bfdh)localObject5).jdField_d_of_type_JavaLangString = ((String)localObject1);
          ((bfdh)localObject5).jdField_a_of_type_Int = 1;
          if (!localGroupFeedsMessage.opt_uint32_ctl_flag.has()) {
            break label899;
          }
          i = localGroupFeedsMessage.opt_uint32_ctl_flag.get();
          ((bfdh)localObject5).jdField_e_of_type_Int = i;
          ...
          paramBoolean = bool1;
          ((bfdh)localObject5).jdField_a_of_type_Boolean = paramBoolean;
          break label896;
        }
        if (i == 22)
        {
          ...
          localObject3 = new bfdh();
          ((bfdh)localObject3).jdField_b_of_type_JavaLangString = paramString;
          ((bfdh)localObject3).jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
          ((bfdh)localObject3).jdField_e_of_type_JavaLangString = ((String)localObject1);
          ((bfdh)localObject3).jdField_a_of_type_Int = 2;
          ((bfdh)localObject3).jdField_b_of_type_Long = l1;
          ((bfdh)localObject3).jdField_d_of_type_Int = i;
          if (localGroupFeedsMessage.opt_uint32_ctl_flag.has())
          {
            i = localGroupFeedsMessage.opt_uint32_ctl_flag.get();
            ((bfdh)localObject3).jdField_e_of_type_Int = i;
            if ((!localGroupFeedsMessage.memo_ctrl_info.has()) || (!((group_feeds.GroupFeedsMessage.MemoCtrlInfo)localGroupFeedsMessage.memo_ctrl_info.get()).uint32_need_confirmation.has())) {
              break;
            }
            paramBoolean = bool2;
            ...
            ((bfdh)localObject3).jdField_a_of_type_Boolean = paramBoolean;
            break;
          }
        }
        return null;
  ...
  public static TroopNotificationCache a(bfdh parambfdh, String paramString, int paramInt1, int paramInt2, long paramLong)
  {
    if (parambfdh != null)
    {
      if (parambfdh.jdField_a_of_type_Int == 1)
      {
        String str2 = a(parambfdh.jdField_c_of_type_JavaLangString);
        ...
        str2 = a(parambfdh.jdField_a_of_type_JavaLangString);
        if (TextUtils.isEmpty(parambfdh.jdField_a_of_type_JavaLangString))
        {
          str2 = new SimpleDateFormat("yyyy年M月d日").format(new Date(parambfdh.jdField_c_of_type_Int * 1000L));
          str2 = str2 + " 群公告";
        }
        ...
        localTroopNotificationCache.title = parambfdh.jdField_a_of_type_JavaLangString;
        localTroopNotificationCache.feedType = paramInt1;
        localTroopNotificationCache.appId = paramInt2;
        localTroopNotificationCache.userUin = parambfdh.jdField_a_of_type_Long;
        localTroopNotificationCache.troopUin = paramLong;
        localTroopNotificationCache.time = parambfdh.jdField_c_of_type_Int;
        localTroopNotificationCache.feedsId = parambfdh.jdField_b_of_type_JavaLangString;
        localTroopNotificationCache.serviceID = 27;
        localTroopNotificationCache.needConfirm = parambfdh.jdField_a_of_type_Boolean;
        String str3 = new SimpleDateFormat("M-d HH:mm").format(new Date(localTroopNotificationCache.time * 1000L));
        if (TextUtils.isEmpty(parambfdh.jdField_d_of_type_JavaLangString)) {}
        for (localTroopNotificationCache.xmlBytes = String.format("<?xml version=\"1.0\" encoding=\"utf-8\" ?><msg action=\"web\" serviceID=\"27\" templateID=\"\" actionData=\"\" url=\"%s\" flag=\"5\" brief=\"%s\"><item layout=\"1\"><title size=\"30\" color=\"#000000\">[公告] %s</title><hr /><title size=\"22\" color=\"#000000\">%s</title><summary size=\"28\" color=\"#808080\">%s</summary></item></msg>", new Object[] { paramString, "", str2, str3, str1 }).getBytes();; localTroopNotificationCache.xmlBytes = String.format("<?xml version=\"1.0\" encoding=\"utf-8\" ?><msg action=\"web\" serviceID=\"27\" templateID=\"\" actionData=\"\" url=\"%s\" flag=\"5\" brief=\"%s\"><item layout=\"6\"><title size=\"30\" color=\"#000000\">[公告] %s</title><hr /></item><item layout=\"2\"><picture cover=\"%s\"/><title size=\"22\" color=\"#000000\">%s</title><summary size=\"28\" color=\"#808080\">%s</summary></item></msg>", new Object[] { paramString, "", str2, parambfdh.jdField_d_of_type_JavaLangString, str3, str1 }).getBytes()) {
          return localTroopNotificationCache;
        }
      }
      if (parambfdh.jdField_a_of_type_Int == 2)
      {
        paramString = new TroopNotificationCache();
        paramString.feedType = paramInt1;
        paramString.appId = paramInt2;
        paramString.userUin = parambfdh.jdField_a_of_type_Long;
        paramString.troopUin = paramLong;
        paramString.time = parambfdh.jdField_c_of_type_Int;
        paramString.feedsId = parambfdh.jdField_b_of_type_JavaLangString;
        paramString.ctrlStr = parambfdh.jdField_e_of_type_JavaLangString;
        paramString.xmlBytes = parambfdh.jdField_a_of_type_ArrayOfByte;
        paramString.src = parambfdh.jdField_d_of_type_Int;
        paramString.filterID = parambfdh.jdField_b_of_type_Long;
  ...
  public static TroopNotificationCache a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, byte[] paramArrayOfByte, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramQQAppInterface)
      {
        ...
        QLog.d(bfdg.class.getSimpleName(), 2, paramQQAppInterface.getMessage());
        continue;
      }
      return null;
      label337:
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt1, long paramLong1, long paramLong2, long paramLong3, String paramString1, int paramInt2, String paramString2, short paramShort, boolean paramBoolean)
  {
    ...
    catch (Exception localException)
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d(bfdg.class.getSimpleName(), 2, localException.getMessage());
        }
      }
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt1, long paramLong1, long paramLong2, long paramLong3, String paramString, int paramInt2, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      {
        paramArrayOfByte = null;
        if ((((bfdh)localObject).jdField_a_of_type_Int == 1) || (((bfdh)localObject).jdField_a_of_type_Int == 2)) {
          paramArrayOfByte = a((bfdh)localObject, paramString, 23, paramInt1, paramLong2);
        }
        QQMessageFacade localQQMessageFacade = paramQQAppInterface.getMessageFacade();
        ArrayList localArrayList = new ArrayList();
        localArrayList.add(paramArrayOfByte);
        paramInt1 = (int)bbko.a();
        localQQMessageFacade.getTroopMessageManager().a(paramQQAppInterface, String.valueOf(paramLong1), String.valueOf(paramLong2), localArrayList, 23, paramInt1, ((bfdh)localObject).jdField_e_of_type_Int, ((bfdh)localObject).jdField_b_of_type_JavaLangString);
      }
    }
    catch (Exception paramQQAppInterface)
    {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    if ((jdField_a_of_type_JavaUtilHashMap != null) && (jdField_a_of_type_JavaUtilHashMap.containsKey(paramString)))
    {
      ...
      ((anca)paramQQAppInterface.getBusinessHandler(20)).a(paramQQAppInterface, paramString, arrayOfByte, paramInt);
      return;
    }
    try
    {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    paramQQAppInterface = new bfdf(paramString1, paramInt);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (paramInt2 == 1)
        {
          ...
          paramQQAppInterface = akla.a(paramString1.uin, paramString1.getType());
          akla.a().a(paramQQAppInterface);
          if (paramInt2 != 1) {
            break label537;
          }
          i = 29;
          paramString1.msgType = i;
          if (!(paramString1.msg instanceof akoi)) {
            break label557;
          }
          localObject1 = (akoi)paramString1.msg;
          if (!bool1) {
            break label544;
          }
          paramQQAppInterface = BaseApplication.getContext().getString(2131718960);
          label470:
          ((akoi)localObject1).jdField_a_of_type_JavaLangString = paramQQAppInterface;
        }
        for (;;)
        {
          ((akoi)paramString1.msg).jdField_c_of_type_Int = paramInt2;
          paramString1.lastmsgtime = paramInt1;
          paramString2.a().saveRecentUser(paramString1);
          paramList.sendEmptyMessage(1009);
          return;
          if ((!(paramString1.msg instanceof akoi)) || (((akoi)paramString1.msg).jdField_c_of_type_Int != 1)) {
            break;
          }
          return;
          i = 11;
          break label430;
          paramQQAppInterface = BaseApplication.getContext().getString(2131718959);
          break label470;
          paramString1.msg = new akoi(BaseApplication.getContext(), bool1);
        }
      }
    }
  }
  ...
  public static void a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    QLog.d("TroopNotificationHelper", 2, bfdg.class.getSimpleName() + "-->clearTroopNotification. troop = " + paramString);
  }
  ...
  public static byte[] a(long paramLong, short paramShort, byte[] paramArrayOfByte, String paramString)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d(bfdg.class.getSimpleName(), 2, paramArrayOfByte.getMessage());
      }
    }
    return null;
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(bfdg.class.getSimpleName(), 2, "handGetTroopAuth");
    }
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    for (;;)
    {
      if (paramString != null)
      {
        ...
        zqq.b("https://gdynamic.qpic.cn/gdynamic/");
      }
      return;
      if (QLog.isColorLevel()) {
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    } while (((paramString2.msg instanceof akoi)) && (((akoi)paramString2.msg).jdField_c_of_type_Int == 1));
    if (QLog.isColorLevel()) {
      QLog.d("TroopNotificationHelper", 2, "setUnReadRepeatTroopNotificationPre, update recent user list");
    }
    Object localObject = akla.a(paramString2.uin, paramString2.getType());
    akla.a().a((String)localObject);
    paramString2.msgType = 11;
    localObject = new akoi(BaseApplication.getContext(), true);
    ((akoi)localObject).jdField_c_of_type_Int = 0;
