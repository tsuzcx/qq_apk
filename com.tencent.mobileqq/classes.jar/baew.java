  ...
  extends bafb
{
  ...
  private adam jdField_a_of_type_Adam = new baex(this);
  private ArkViewImplement.LoadCallback jdField_a_of_type_ComTencentArkArkViewImplement$LoadCallback = new baey(this);
  ...
  public baew(Context paramContext, int paramInt)
  {
    super(paramContext, paramInt);
  }
  
  private adaj a(baez parambaez)
  {
    this.jdField_a_of_type_Adaj = new adai();
    ...
    if (QLog.isDebugVersion()) {
      QLog.d("QQCustomArkDialog", 4, "w=" + i + ",h=" + j + ", appName:" + parambaez.jdField_a_of_type_JavaLangString);
    }
    this.jdField_a_of_type_Adaj.a(parambaez.jdField_a_of_type_JavaLangString, parambaez.b, parambaez.c, parambaez.d, parambaez.jdField_a_of_type_Float, parambaez.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
    if ((this.e != 0) && (this.f != 0)) {
      this.jdField_a_of_type_Adaj.setFixSize(this.e, this.f);
    }
    for (;;)
    {
      alar.a = false;
      return this.jdField_a_of_type_Adaj;
      this.jdField_a_of_type_Adaj.setFixSize(this.d, this.g);
      this.jdField_a_of_type_Adaj.setMaxSize(this.d, this.jdField_a_of_type_Int);
      this.jdField_a_of_type_Adaj.setMinSize(this.b, this.c);
    }
  }
  ...
  {
    paramBundle = a(new baez(paramBundle));
  ...
  public void a(Context paramContext, Bundle paramBundle)
  {
    try
    {
      ...
      localView.findViewById(2131297250).setPadding(0, 0, 0, 0);
