  ...
  extends SSOAccountObserver
{
  ...
  {
    if (this.a.jdField_a_of_type_Bdir != null) {
      this.a.jdField_a_of_type_Bdir.a();
    }
  }
  ...
  public void onGetA1WithA1(String paramString, int paramInt1, byte[] paramArrayOfByte, int paramInt2, Bundle paramBundle)
  {
    if (paramInt1 == 0)
    {
      ...
      if ((paramArrayOfByte != null) && (paramArrayOfByte.length > 0))
      {
        ...
        paramArrayOfByte = new RSACrypt(bcyb.a().a()).EncryptData(this.a.a(bcyb.a().a(), this.a.jdField_a_of_type_Long, 1L), paramArrayOfByte);
        util.LOGD("encrypt buff:" + util.buf_to_string(paramArrayOfByte));
        if (this.a.jdField_a_of_type_Bdir != null) {
          this.a.jdField_a_of_type_Bdir.a(paramString, paramArrayOfByte);
        }
      }
    }
    while (this.a.jdField_a_of_type_Bdir == null) {
      return;
    }
    this.a.jdField_a_of_type_Bdir.a();
  }
