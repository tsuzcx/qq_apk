...
public class whz
{
  protected static whz a;
  protected SessionInfo a;
  protected HashMap<String, wia> a;
  ...
  public static whz a()
  {
    if (jdField_a_of_type_Whz == null) {
      jdField_a_of_type_Whz = new whz();
    }
    return jdField_a_of_type_Whz;
  }
  ...
  public static void a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    awqx.a(null, "P_CliOper", "Pb_account_lifeservice", "", "aio_app", paramString2, 0, 0, paramString1, paramString3, paramString4, paramString5);
  }
  ...
  {
    wia localwia = (wia)this.jdField_a_of_type_JavaUtilHashMap.get(paramString1);
    if (localwia == null) {
      return;
    }
    this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo = paramSessionInfo;
    if (!why.b(paramContext, localwia.b, paramString1, "android.intent.action.VIEW", "com.tencent.mobileqq", "com.tencent.mobileqq.activity.JumpActivity"))
    {
      if (!why.b(paramContext, localwia.c, paramString1, "android.intent.action.VIEW", "com.tencent.mobileqq", "com.tencent.mobileqq.activity.JumpActivity"))
      {
        paramSessionInfo = new Intent(paramContext, QQBrowserActivity.class);
        if ((localwia != null) && (!TextUtils.isEmpty(localwia.jdField_a_of_type_JavaLangString))) {
          paramSessionInfo.putExtra("url", localwia.jdField_a_of_type_JavaLangString);
        }
        for (;;)
        {
  ...
  public boolean a(Intent paramIntent, Activity paramActivity, QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      do
      {
        ...
        bool1 = bool2;
      } while (!((whz)localObject).a(String.valueOf(localLong)));
      ...
      localObject = ((whz)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo;
      bool1 = bool2;
    } while (localObject == null);
    paramIntent = apjx.a(paramIntent, paramQQAppInterface, paramActivity);
    ...
    paramIntent.a(aphf.a.intValue(), paramActivity);
  ...
  public void b()
  {
    Object localObject2 = mkw.a().a("aio_pluginApp", "");
    ...
    catch (JSONException localJSONException2)
    {
      for (;;)
      {
        try
        {
          ...
          localwia = new wia(this);
          localwia.jdField_a_of_type_JavaLangString = ((JSONObject)localObject2).optString("downloadLink");
          localwia.b = String.format("tencent%s.provider://", new Object[] { str });
          localwia.c = ((JSONObject)localObject2).optString("defaultScheme_a");
          this.jdField_a_of_type_JavaUtilHashMap.put(str, localwia);
          i += 1;
        }
