  ...
  public void onReceive(Context arg1, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      if ("action_shop_set_read".equals(???))
      {
        ...
        synchronized (ntw.a(this.a))
        {
          paramIntent = (EcShopData)ntw.a(this.a).get(localObject);
          if (paramIntent == null) {
            continue;
          }
          ??? = null;
          ...
          if (((String)localObject).equals(ntw.g))
          {
            l = ntw.a().getLong("ad_id", 0L);
            ((nup)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(88)).a(134246438, null, null, null, null, l, false);
            ??? = ntw.a().edit();
            ???.remove("ad_id");
      ...
      if ("action_folder_destroy".equals(???))
      {
        if (paramIntent.getLongExtra("stay_time", 0L) >= this.a.jdField_a_of_type_Long) {
          ntw.a().edit().putLong("last_stay_folder", System.currentTimeMillis());
        }
        this.a.f = false;
        return;
      }
      ...
      {
        ntw.a().edit().putBoolean("folder_tab_red", true).commit();
        return;
      }
