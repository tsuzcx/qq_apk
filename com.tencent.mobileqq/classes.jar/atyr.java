...
public class atyr
{
  public static void a(Context paramContext, String paramString, List<Object> paramList)
  {
    ...
    bbdx.a(paramString + "v5.8.nbr", new Object[] { paramList });
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (a(paramQQAppInterface))
    {
      ...
      if (i <= Math.abs(l3 - l1) / 1000L)
      {
        ...
        localObject = paramQQAppInterface.b(ajsd.H, 1001).iterator();
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, long paramLong)
  {
    ...
    MessageForNearbyRecommenderTips localMessageForNearbyRecommenderTips = (MessageForNearbyRecommenderTips)axas.a(-4011);
    long l = awzy.a();
    localMessageForNearbyRecommenderTips.init(paramQQAppInterface.getCurrentAccountUin(), ajsd.as, ajsd.as, "", l, -4011, 1001, l);
    localMessageForNearbyRecommenderTips.isread = true;
    akpx.a(localMessageForNearbyRecommenderTips, false);
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("NearbyRecommenderUtils", 2, "-----addGrayTipsMessage  frienduin:" + paramString1 + " istroop：" + paramInt + " msg:" + bbbr.a(paramString3));
    }
    long l = awzy.a();
    MessageForGrayTips localMessageForGrayTips = (MessageForGrayTips)axas.a(-5007);
    ...
    if ((!paramBoolean1) || (!akas.a(paramQQAppInterface, localMessageForGrayTips, false))) {
  ...
  {
    paramQQAppInterface = paramQQAppInterface.a().b(ajsd.H, 1001);
