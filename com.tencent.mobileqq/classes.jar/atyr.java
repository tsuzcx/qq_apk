  ...
  extends beem
{
  ...
  public static Animation a(Animation.AnimationListener paramAnimationListener, float paramFloat1, float paramFloat2)
  {
    ...
    localAnimationSet.setInterpolator(new atys());
    return localAnimationSet;
  }
  
  public void a(QQAppInterface paramQQAppInterface, HeartLayout paramHeartLayout, Bitmap paramBitmap, atyw paramatyw, int paramInt1, boolean paramBoolean, int paramInt2, float paramFloat1, float paramFloat2)
  {
    if (awnu.b())
    {
    ...
    do
    {
      ...
      {
        localPraiseManager.a(paramatyw);
      ...
      paramatyw = localPraiseManager.a(paramInt1, paramBoolean, "from_nearby_people");
      if (paramatyw != null)
      {
        if ((paramInt2 == 2) && (paramatyw.c != null))
        {
          if (this.jdField_a_of_type_Aqen != null)
          {
            paramHeartLayout.a(paramatyw, paramatyw.c, paramQQAppInterface, this.jdField_a_of_type_Aqen.a(paramInt2, paramHeartLayout.a), paramFloat1 - azvv.a(paramHeartLayout.getContext(), 20.0F), paramFloat2 - azvv.a(paramHeartLayout.getContext(), 120.0F), azvv.a(paramHeartLayout.getContext(), 75.0F), azvv.a(paramHeartLayout.getContext(), 65.0F));
            return;
          }
          paramHeartLayout.a(paramatyw, paramatyw.c, paramFloat1, paramFloat2);
          return;
        }
        paramHeartLayout.a(paramatyw, paramatyw.b, paramFloat1, paramFloat2);
        return;
      }
    } while (paramBoolean);
    paramHeartLayout.a(paramBitmap, paramFloat1, paramFloat2);
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2, Drawable paramDrawable, Resources paramResources)
  {
    ...
    if (paramBoolean2) {
      localDrawable1 = mpo.a(localDrawable2, paramResources.getColor(2131100050));
    }
    while (this.jdField_a_of_type_ArrayOfAndroidGraphicsDrawableDrawable == null)
    {
      ...
      if (paramBoolean1) {
        localDrawable1 = mpo.a(localDrawable2, paramResources.getColor(2131100053));
      }
    }
  ...
  public void onAnimationRepeat(Animation paramAnimation)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Int / 2 >= atyt.jdField_a_of_type_Int)
      {
