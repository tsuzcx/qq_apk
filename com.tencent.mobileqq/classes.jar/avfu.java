  ...
  extends avfr
{
  ...
  public avfu(Context paramContext, AppInterface paramAppInterface, View paramView, String paramString)
  {
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqRichstatusCommentWidgetCommentsView != null)
    {
      ...
      if (paramBoolean)
      {
        ...
        i = jdField_a_of_type_ArrayOfInt[12];
    ...
    label182:
    label192:
    for (Object localObject = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130846336);; localObject = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130846337))
    {
  ...
  protected int b()
  {
    return jdField_a_of_type_ArrayOfInt[11];
  }
