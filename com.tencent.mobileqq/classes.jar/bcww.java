...
public class bcww
  ...
  implements bcwp
{
  private bcwy jdField_a_of_type_Bcwy;
  private bcwz jdField_a_of_type_Bcwz;
  private bcxa jdField_a_of_type_Bcxa;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  
  public bcww(QQAppInterface paramQQAppInterface)
  {
      ...
      for (;;)
      {
        ...
        if ((localObject != null) && (paramInt1 == 1001))
        {
          ...
          if ((localalmt != null) && (localalmt.a() != null)) {
            localalmt.a().f(paramString);
          }
          if (this.jdField_a_of_type_Bcwy == null)
          {
            this.jdField_a_of_type_Bcwy = new bcwy(this, null);
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Bcwy);
          }
        }
        return localObject;
      }
  ...
  public void a(int paramInt1, String paramString, int paramInt2, long paramLong)
  {
    ...
    do
    {
      ...
      for (byte b = 1;; b = 0)
      {
        ...
        if (this.jdField_a_of_type_Bcwz == null)
        {
          this.jdField_a_of_type_Bcwz = new bcwz(this, null);
          this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Bcwz);
        }
        if (paramInt1 != 32) {
          break;
        }
  ...
  public void a(AppInterface paramAppInterface, FaceInfo paramFaceInfo)
  {
    ...
    do
    {
      ...
      if (paramAppInterface != null)
      {
        ...
        bcws.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramAppInterface);
      }
  ...
  public void a(FaceInfo paramFaceInfo, Bitmap paramBitmap)
  {
    ...
    for (int i = FaceInfo.f;; i = FaceInfo.g)
    {
      ...
      this.jdField_a_of_type_Bcwv.onDecodeTaskCompleted(this.jdField_b_of_type_Int + this.jdField_a_of_type_JavaUtilLinkedList.size(), paramFaceInfo.jdField_a_of_type_Int, paramFaceInfo.jdField_a_of_type_JavaLangString, paramBitmap);
      return;
    }
  }
  ...
  protected void a(boolean paramBoolean, int paramInt1, String paramString, int paramInt2)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        } while (this.jdField_a_of_type_Bcwv == null);
        this.jdField_a_of_type_Bcwv.onDecodeTaskCompleted(this.jdField_b_of_type_Int + this.jdField_a_of_type_JavaUtilLinkedList.size(), paramInt1, paramString, localBitmap);
        return;
  ...
  public void d()
  {
    ...
    bcwy localbcwy = this.jdField_a_of_type_Bcwy;
    bcwz localbcwz = this.jdField_a_of_type_Bcwz;
    bcxa localbcxa = this.jdField_a_of_type_Bcxa;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = null;
    this.jdField_a_of_type_Bcwy = null;
    this.jdField_a_of_type_Bcxa = null;
    this.jdField_a_of_type_Bcwz = null;
    if (localQQAppInterface != null)
    {
      if (localbcwy != null) {
        localQQAppInterface.removeObserver(localbcwy);
      }
      if (localbcwz != null) {
        localQQAppInterface.removeObserver(localbcwz);
      }
      if (localbcxa != null) {
        localQQAppInterface.removeObserver(localbcxa);
      }
    }
    super.d();
  }
  ...
  protected void e()
  {
    ...
    do
    {
      ...
      try
      {
        ...
        try
        {
          ...
          if (((((FaceInfo)localObject2).jdField_a_of_type_Int == 101) || (((FaceInfo)localObject2).jdField_a_of_type_Int == 1001)) && (this.jdField_a_of_type_Bcwy == null))
          {
            this.jdField_a_of_type_Bcwy = new bcwy(this, null);
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Bcwy);
          }
          if (((((FaceInfo)localObject2).jdField_a_of_type_Int == 4) || (((FaceInfo)localObject2).jdField_a_of_type_Int == 113)) && (!bclo.a(((FaceInfo)localObject2).jdField_a_of_type_JavaLangString)))
          {
            if (this.jdField_a_of_type_Bcxa == null) {
              this.jdField_a_of_type_Bcxa = new bcxa(this, null);
            }
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Bcxa);
          }
          this.jdField_b_of_type_Int += 1;
    ...
    ausq.a("Q.qqhead.FaceDecoderImpl", new Object[] { "runNextTask", localObject2, localObject1 });
  }
}
