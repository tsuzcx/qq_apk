  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    if (!TextUtils.isEmpty((CharSequence)localObject))
    {
      ...
      abcp.a(this.a.app, this.a, paramView, (String)localObject, bool);
    }
    for (;;)
    {
      this.a.jdField_a_of_type_Aqbe.a().putString("uin", "-1010");
      this.a.jdField_a_of_type_Aqbe.B();
      axqy.b(this.a.app, "CliOper", "", "", "friendchoose", "0X800A2D7", ForwardRecentActivity.a(this.a), 0, "", "", "", ForwardRecentActivity.a(this.a));
      ...
      bgzl.a(this.a.app, this.a, localBundle, null);
      paramView = new bgyj();
      paramView.c = "1";
      paramView.d = "0";
      paramView.b = 4;
      ...
      axrn.a(this.a.getApplicationContext()).a(this.a.app.getAccount(), "actQZSourceDataReport", true, 0L, 0L, paramView, null);
      if (this.a.jdField_a_of_type_Boolean)
      {
        bdes.a().a(this.a.app.getAccount(), "", this.a.b, "1000", "33", "0", false);
        if ((this.a.jdField_a_of_type_Aqbe instanceof aqes))
        {
          paramView = (aqes)this.a.jdField_a_of_type_Aqbe;
          localObject = new Bundle();
          ((Bundle)localObject).putString("report_type", "102");
          ((Bundle)localObject).putString("act_type", "81");
          ((Bundle)localObject).putString("intext_1", "" + bdey.a(paramView.c));
          ((Bundle)localObject).putString("intext_2", "" + bdey.a(-1, ajsd.aG));
          ((Bundle)localObject).putString("intext_3", "0");
          bdes.a().a((Bundle)localObject, "", this.a.app.getCurrentAccountUin(), false);
        }
      }
