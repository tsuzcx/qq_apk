  ...
  implements atjh
{
  ...
  public atid()
  {
    this.jdField_a_of_type_EipcEIPCResultCallback = new atie(this);
    this.jdField_b_of_type_EipcEIPCResultCallback = new atif(this);
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if ("listenTogether".equals(paramString2))
    {
      ...
      do
      {
        ...
        atje.a(paramJsBridgeListener, "isOpener", this.jdField_b_of_type_EipcEIPCResultCallback);
        return true;
        if (!"isShowAtmosphere".equals(paramString3)) {
          break;
        }
      } while (TextUtils.isEmpty(this.c));
      atje.a(paramJsBridgeListener, "isShowAtmosphere", this.jdField_a_of_type_EipcEIPCResultCallback);
      return true;
      if ("setPlayerId".equals(paramString3))
      {
        atje.a(paramJsBridgeListener, "setPlayerId", null);
        return true;
      }
      if ("setThemeEnabled".equals(paramString3))
      {
        atje.a(paramJsBridgeListener, "setThemeEnabled", null);
        return true;
      }
    }
    return false;
