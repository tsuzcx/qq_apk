  ...
  implements Manager
{
  ...
  private String jdField_b_of_type_JavaLangString = amtj.a(2131712561);
  private boolean jdField_b_of_type_Boolean;
  private String jdField_c_of_type_JavaLangString = amtj.a(2131712562);
  private boolean jdField_c_of_type_Boolean;
  
  public atid(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaUtilArrayList.clear();
    this.jdField_b_of_type_Boolean = bfyz.z(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentAccountUin());
  }
  
  public static atid a(QQAppInterface paramQQAppInterface)
  {
    return (atid)paramQQAppInterface.getManager(286);
  }
  ...
  private void a(QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface = (auen)paramQQAppInterface.getManager(219);
  ...
  {
    int j = bfyz.aK(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentAccountUin());
    if (QLog.isColorLevel()) {
      QLog.d("RichTextChatManager", 2, "last Memoried Tab:" + j);
    }
    int i;
    if (j == -1) {
      if (!bfyz.y(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentAccountUin()))
      {
        i = paramArrayList.indexOf(Integer.valueOf(a(paramQQAppInterface)));
        bfyz.r(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentAccountUin(), true);
        if (QLog.isColorLevel()) {
  ...
  public void a(QQAppInterface paramQQAppInterface, Integer paramInteger, ConfigurationService.Config paramConfig)
  {
    ...
    int j = bfyz.aI(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount());
    int m = bfyz.aJ(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount());
    int n = AppSetting.a();
    if (QLog.isColorLevel()) {
    ...
    if (m != n) {
      bfyz.Z(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), n);
    }
    for (;;)
    {
      if (k != i)
      {
        paramInteger = aqlw.b(paramConfig, i, paramInteger.intValue());
        if (QLog.isColorLevel()) {
        ...
        bfyz.f(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), k, paramInteger);
  ...
  public void a(boolean paramBoolean, QQAppInterface paramQQAppInterface)
  {
    ...
    bfyz.s(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentAccountUin(), paramBoolean);
  }
