    ...
    for (;;)
    {
      try
      {
        ...
        if (k >= paramInt)
        {
          ...
          localCanvas.drawBitmap(BitmapFactory.decodeResource(localResources, 2130841699), AIOUtils.dp2px(13.0F, localResources), AIOUtils.dp2px(25.0F, localResources) + paramInt, localPaint);
          ...
          localCanvas.drawText(localResources.getString(2131695008), AIOUtils.dp2px(60.0F, localResources), AIOUtils.dp2px(61.0F, localResources) + paramInt, localPaint);
      ...
      catch (Exception paramString1)
      {
        try
        {
          ...
          paramString1 = bgua.a(paramString2, localResources, AIOUtils.dp2px(80.0F, localResources), 0, false);
          paramString2 = paramString1;
          if (paramString1 == null)
          {
            if (QLog.isColorLevel()) {
            ...
            paramString2 = BitmapFactory.decodeResource(localResources, 2130841705);
          }
