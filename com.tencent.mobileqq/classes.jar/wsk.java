...
public class wsk
{
  ...
  public static wsk a(List<wsk> paramList, long paramLong)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if (paramLong == localwsk.jdField_a_of_type_Long) {
        return localwsk;
      }
    }
    return null;
  ...
  public void a(@NonNull JSONObject paramJSONObject)
  {
    try
    {
      ...
      if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
        this.jdField_a_of_type_ComTencentBizQqstoryModelItemStoryVideoItem = ((wpj)wpm.a(5)).a(this.jdField_a_of_type_JavaLangString);
      }
      return;
    }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    {
      return true;
      if (!(paramObject instanceof wsk)) {
        return false;
      }
      paramObject = (wsk)paramObject;
