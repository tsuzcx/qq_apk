...
public class bfiq
  extends bfhq
{
  public bfiq(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo)
  {
  ...
  public bfhr a(int paramInt1, List<Long> paramList, long paramLong1, Object paramObject, long paramLong2, long paramLong3, int paramInt2)
  {
    ...
    if (((paramList instanceof MessageForArkApp)) && (a(paramList, paramLong2, paramLong3))) {
      return new bfhr(true, this.jdField_a_of_type_AndroidContentContext.getString(2131698416), bepx.a(paramInt1, paramLong1, paramInt2), paramList.senderuin);
    }
    return null;
  }
  ...
  {
    bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800AA10", "0X800AA10", 0, 0, "", "", "", "");
  }
