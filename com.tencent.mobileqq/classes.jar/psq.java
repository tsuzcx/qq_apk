  ...
  implements View.OnClickListener
{
  ...
  public psq(Context paramContext, baxk parambaxk, rap paramrap)
  {
  ...
  private TextView a(int paramInt)
  {
    ...
    localTextView.setId(2131374775);
    localTextView.setTextSize(2, 11.0F);
    localTextView.setGravity(17);
    localTextView.setText(ajyc.a(2131704443));
    localTextView.setWidth(bawz.a(this.jdField_a_of_type_AndroidContentContext, 30.0F));
    localTextView.setHeight(bawz.a(this.jdField_a_of_type_AndroidContentContext, 17.0F));
    if (paramInt == 0)
    {
      localTextView.setTextColor(Color.argb(255, 255, 255, 255));
      localTextView.setBackgroundResource(2130848427);
      return localTextView;
    }
    localTextView.setTextColor(-89258);
    localTextView.setBackgroundResource(2130848428);
    return localTextView;
  }
  ...
  public pqt d()
  {
    ...
    View localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559987, localRelativeLayout, true);
    this.jdField_d_of_type_AndroidViewView = localView.findViewById(2131369047);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131371741));
    this.jdField_b_of_type_AndroidViewView = localView.findViewById(2131375362);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKandianUrlImageView = ((KandianUrlImageView)localView.findViewById(2131368544));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131378378));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131378284));
    this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localView.findViewById(2131368596));
    this.jdField_c_of_type_AndroidWidgetTextView = new TextView(this.jdField_a_of_type_AndroidContentContext);
    FrameLayout.LayoutParams localLayoutParams = new FrameLayout.LayoutParams(-2, -2);
    localLayoutParams.leftMargin = bawz.a(this.jdField_a_of_type_AndroidContentContext, 5.0F);
    localLayoutParams.gravity = 16;
    this.jdField_c_of_type_AndroidWidgetTextView.setTextSize(2, 12.0F);
    this.jdField_c_of_type_AndroidWidgetTextView.setId(2131374768);
    ((FrameLayout)localView.findViewById(2131366333)).addView(this.jdField_c_of_type_AndroidWidgetTextView, localLayoutParams);
    this.jdField_a_of_type_ComTencentImageURLImageView.setOnClickListener(this);
    this.jdField_c_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)localView.findViewById(2131369352));
    this.jdField_c_of_type_AndroidViewView = localView.findViewById(2131379162);
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131363389));
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)localView.findViewById(2131366338));
    this.jdField_b_of_type_AndroidWidgetFrameLayout = ((FrameLayout)localView.findViewById(2131366337));
  ...
  public pqt o()
  {
    ...
    {
      localpax = (pax)this.jdField_a_of_type_JavaLangObject;
    ...
    ((RelativeLayout.LayoutParams)localObject1).width = axli.a;
    ...
    if (localArticleInfo.mVideoCoverUrl != null)
    {
      ...
      omu.a((KandianUrlImageView)localObject2, (URL)localObject1, this.jdField_a_of_type_AndroidContentContext, true);
      if (jdField_a_of_type_AndroidGraphicsDrawableDrawable == null) {
        jdField_a_of_type_AndroidGraphicsDrawableDrawable = bbdr.b();
      }
    ...
    for (;;)
    {
      ...
      if (localpax.e() == 0)
      {
        ...
        ((FrameLayout.LayoutParams)localObject1).setMargins(bawz.a(this.jdField_a_of_type_AndroidContentContext, 5.0F), 0, 0, bawz.a(this.jdField_a_of_type_AndroidContentContext, 2.0F));
        ...
        ((ViewGroup.LayoutParams)localObject1).height = bawz.a(this.jdField_a_of_type_AndroidContentContext, 47.0F);
        this.jdField_a_of_type_AndroidWidgetLinearLayout.setLayoutParams((ViewGroup.LayoutParams)localObject1);
        this.jdField_a_of_type_AndroidWidgetLinearLayout.setBackgroundColor(this.jdField_a_of_type_AndroidWidgetLinearLayout.getResources().getColor(2131167134));
        return this;
        ...
        localObject1 = onk.a(localArticleInfo.mFirstPagePicUrl);
        break;
    ...
    for (;;)
    {
      ...
      return this;
      label766:
      this.jdField_b_of_type_AndroidWidgetTextView.setText(qol.c(localArticleInfo.mVideoPlayCount));
