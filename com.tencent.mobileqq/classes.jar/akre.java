  ...
  extends QIPCModule
{
  ...
  public akre(String paramString)
  {
    super(paramString);
  }
  
  public static akre a()
  {
    return akrf.a();
  }
  ...
  public static void a()
  {
    ...
    if (!a)
    {
      QIPCClientHelper.getInstance().register(localakre);
      a = true;
    }
  }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    try
    {
      ...
      {
        akro.a(paramBundle.getInt("gameId"));
      }
    ...
    else if ("action_set_sso_rule".equals(paramString))
    {
      ...
      akua localakua = akro.a();
      if (localakua != null) {
        localakua.a(paramString.gameId, paramBundle);
      }
    }
    else
    {
      ...
      if (bool)
      {
        try
        {
          ...
          if (l >= 0L)
          {
            ...
            azmz.a(BaseApplicationImpl.getApplication()).a(null, "cmgame_ipc_start_receive", true, l, 0L, paramBundle, "", false);
          }
          akro.a(paramString);
        }
        catch (Exception paramString)
      ...
      else if ("action_check_game_data".equals(paramString))
      {
        ...
        paramString = akro.a(paramString.gameId);
        if (paramString != null) {
