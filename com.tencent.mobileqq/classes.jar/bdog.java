...
public class bdog
{
  ...
  public final String a()
  {
    if (a())
    {
      ...
      if (bdoi.a(this.jdField_a_of_type_Int)) {
  ...
  {
    this.jdField_a_of_type_Int = bdoi.b(paramCustomOnlineStatusMsg);
    this.jdField_a_of_type_JavaLangString = bdoi.a(paramCustomOnlineStatusMsg);
    this.b = bdoi.a(paramCustomOnlineStatusMsg);
    b();
  }
  ...
  {
    int j = this.c;
    aopx localaopx = (aopx)aogj.a().a(479);
    if ((localaopx == null) || (localaopx.a)) {}
    for (int i = 1;; i = 0)
    {
      this.c = i;
      if (j != this.c) {
