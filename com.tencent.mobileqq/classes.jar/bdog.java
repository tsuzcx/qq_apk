...
public class bdog
  extends bdof
{
  private HashMap<String, bdoc> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private HashSet<String> jdField_a_of_type_JavaUtilHashSet = new HashSet();
  private List<bdod> jdField_a_of_type_JavaUtilList = new ArrayList();
  public boolean a;
  ...
  private bdoc a(String paramString1, String paramString2, bdod parambdod)
  {
    if ((TextUtils.isEmpty(paramString2)) || (parambdod == null)) {}
    ...
    do
    {
      ...
      arrayOfString = str1.split(parambdod.jdField_b_of_type_JavaLangString);
      if ((paramString2.length >= parambdod.jdField_a_of_type_Int) && (arrayOfString.length >= parambdod.d)) {
        break;
      }
    } while (!QLog.isColorLevel());
    QLog.d("WadlCommConfig", 1, "interrupt url fail, pathInfo.length=" + paramString2.length + ",fileInfo.length=" + arrayOfString.length);
    return null;
    String str2 = paramString2[parambdod.jdField_b_of_type_Int];
    if (parambdod.c > -1)
    {
      paramString2 = paramString2[parambdod.c];
      if (parambdod.e <= -1) {
        break label192;
      }
    }
    label192:
    for (String str1 = arrayOfString[parambdod.e];; str1 = "")
    {
      return new bdoc(str2, paramString2, str1, arrayOfString[parambdod.f], paramString1);
      paramString2 = "";
      break;
    }
  }
  ...
  /* Error */
  public bdoc a(String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_2
    ...
    //   3: ifne +15 -> 18
    //   6: aload_0
    //   7: getfield 39	bdog:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   10: aload_1
    //   11: invokevirtual 130	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   14: checkcast 115	bdoc
    //   17: astore_2
    //   18: aload_2
    //   19: astore_3
    //   20: aload_0
    //   21: getfield 34	bdog:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   52: checkcast 68	bdod
    //   55: astore 5
    //   57: aload_2
    //   58: astore_3
    //   59: aload 5
    //   61: getfield 147	bdod:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   92: aload 5
    //   94: invokespecial 167	bdog:a	(Ljava/lang/String;Ljava/lang/String;Lbdod;)Lbdoc;
    //   97: astore_2
    //   98: aload_2
    //   99: astore_3
    //   100: aload_3
    ...
    for (??? = ((JSONObject)localObject2).toString();; ??? = "empty")
    {
      ...
      for (;;)
      {
        if (i < j)
        {
          ...
          localObject4 = new bdod();
          ((bdod)localObject4).jdField_a_of_type_JavaLangString = ((JSONObject)localObject3).getString("pattern");
          ((bdod)localObject4).jdField_a_of_type_Int = ((JSONObject)localObject3).getInt("path_node_num");
          ((bdod)localObject4).jdField_b_of_type_Int = ((JSONObject)localObject3).getInt("appid_index");
          ((bdod)localObject4).c = ((JSONObject)localObject3).optInt("app_name_index", -1);
          ((bdod)localObject4).jdField_b_of_type_JavaLangString = ((JSONObject)localObject3).getString("split_name_char");
          ((bdod)localObject4).d = ((JSONObject)localObject3).getInt("name_node_num");
          ((bdod)localObject4).e = ((JSONObject)localObject3).optInt("channel_index", -1);
          ((bdod)localObject4).f = ((JSONObject)localObject3).getInt("pkg_name_index");
          if ((((bdod)localObject4).jdField_b_of_type_Int < ((bdod)localObject4).jdField_a_of_type_Int) && (((bdod)localObject4).c < ((bdod)localObject4).jdField_a_of_type_Int) && (((bdod)localObject4).e < ((bdod)localObject4).d) && (((bdod)localObject4).f < ((bdod)localObject4).d)) {
        ...
        else
        {
          ...
          while (i < j)
          {
            ...
            this.jdField_a_of_type_JavaUtilHashMap.put(localObject2, new bdoc((String)localObject3, (String)localObject4, str1, str2, (String)localObject5));
            i += 1;
          }
          break;
        }
