...
public class bdog
{
  private static bdog jdField_a_of_type_Bdog;
  private arbn jdField_a_of_type_Arbn;
  public boolean a;
  @Deprecated
  public boolean b;
  private boolean c;
  ...
  {
    if (jdField_a_of_type_Bdog == null) {}
    try
    {
      if (jdField_a_of_type_Bdog == null) {
        jdField_a_of_type_Bdog = new bdog();
      }
      return jdField_a_of_type_Bdog;
    }
    finally {}
  }
  ...
  private boolean b()
  {
    if (this.jdField_a_of_type_Arbn != null) {
      return this.jdField_a_of_type_Arbn.jdField_a_of_type_Boolean;
    }
    return false;
  }
  ...
  {
    if (this.jdField_a_of_type_Arbn != null) {
      return this.jdField_a_of_type_Arbn.b;
    }
    return false;
  }
  ...
  {
    if (this.jdField_a_of_type_Arbn != null) {
      return this.jdField_a_of_type_Arbn.c;
    }
    return false;
  }
  ...
  {
    if (this.jdField_a_of_type_Arbn != null) {
      return this.jdField_a_of_type_Arbn.d;
    }
    return false;
  }
  ...
  {
    paramView = (PAVideoView)paramView.findViewById(2131378094);
    if (paramView != null) {
      paramView.c();
    }
  }
  ...
  {
    this.jdField_a_of_type_Arbn = paramarbn;
  }
  ...
  public boolean a(Context paramContext, int paramInt1, int paramInt2)
  {
    ...
    if (a())
    {
      ...
      if (paramInt1 == 3)
      {
        if ((!NetworkUtils.isWifiConnected(paramContext)) || (!bnrf.e(localQQAppInterface))) {
          break label169;
        }
        bool = true;
      }
