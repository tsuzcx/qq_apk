...
public class miu
{
  static miu jdField_a_of_type_Miu;
  ...
  private kvq jdField_a_of_type_Kvq;
  private miy jdField_a_of_type_Miy;
  mjc jdField_a_of_type_Mjc = null;
  ...
  public WeakReference<mjd> c;
  private boolean jdField_c_of_type_Boolean;
  private int jdField_d_of_type_Int = 0;
  private boolean jdField_d_of_type_Boolean;
  private boolean e;
  
  public miu(Context paramContext, VideoController paramVideoController, Button paramButton)
  {
    ...
    b(paramButton);
    this.jdField_a_of_type_Mjc = new mjc(this);
    c();
  ...
  private Drawable a(Resources paramResources, int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (paramBoolean)
      {
        paramResources = mgf.a(paramResources, 2130841414);
      }
      else
      {
        paramResources = mit.a(paramResources, 2130841418, 2131100279);
        continue;
        if (paramBoolean)
        {
          paramResources = mgf.a(paramResources, 2130841415);
        }
        else
        {
          paramResources = mit.a(paramResources, 2130841417, 2131100279);
          continue;
          if (paramBoolean)
          {
            paramResources = mgf.a(paramResources, 2130841416);
          }
          else
          {
            paramResources = mit.a(paramResources, 2130841667, 2131100316);
            continue;
            if (paramBoolean)
            {
              paramResources = mgf.a(paramResources, 2130841420);
            }
            else
            {
              paramResources = mit.a(paramResources, 2130841674, 2131100316);
              continue;
              if (paramBoolean)
              {
                paramResources = mgf.a(paramResources, 2130841419);
              }
              else
              {
                paramResources = mit.a(paramResources, 2130841669, 2131100316);
                continue;
                if (paramBoolean) {
                  paramResources = mgf.a(paramResources, 2130841415);
                } else {
                  paramResources = mit.a(paramResources, 2130841672, 2131100316);
                }
              }
            }
          }
  ...
  public static miu a()
  {
    try
    {
      miu localmiu = jdField_a_of_type_Miu;
      return localmiu;
    }
    finally
    {
  ...
  public static miu a(Context paramContext, VideoController paramVideoController)
  {
    if (jdField_a_of_type_Miu == null) {}
    try
    {
      if (jdField_a_of_type_Miu == null) {
        jdField_a_of_type_Miu = new miu(paramContext, paramVideoController, null);
      }
      return jdField_a_of_type_Miu;
    }
    finally {}
  }
  ...
  private void a(String[] paramArrayOfString)
  {
    ...
    for (this.jdField_c_of_type_Boolean = Arrays.asList(paramArrayOfString).contains("DEVICE_BLUETOOTHHEADSET");; this.jdField_c_of_type_Boolean = false)
    {
      if ((this.jdField_c_of_type_Boolean != bool) && (this.jdField_c_of_type_Boolean))
      {
        if (QLog.isColorLevel()) {
          QLog.d("TraeSessionHelper", 2, "Trae_DRP 0X8008D1D at: " + System.currentTimeMillis());
        }
        awqx.b(null, "CliOper", "", "", "0X8008D1D", "0X8008D1D", 0, 0, "", "", "", "");
      }
      return;
    }
  }
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          bool1 = localSharedPreferences.getBoolean(paramVideoAppInterface.getApp().getString(2131629614), true);
          String str = paramVideoAppInterface.getCurrentAccountUin();
          if (str != null) {
            bool1 = localSharedPreferences.getBoolean(paramVideoAppInterface.getApp().getString(2131629614) + str, true);
          }
          bool2 = bool1;
        } while (baan.a() == 0);
        bool2 = bool1;
      ...
      bool2 = bool1;
    } while (mhj.d(paramVideoAppInterface.getApp()));
    return true;
  }
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            do
            {
              ...
              if (paramVideoAppInterface.getCurrentAccountUin() != null)
              {
                ...
                bool1 = bool2;
                if (str != null) {
                  bool1 = localSharedPreferences.getBoolean(paramVideoAppInterface.getApp().getString(2131629613) + str, true);
                }
              }
              bool2 = bool1;
            } while (baan.a() == 0);
          ...
          bool2 = bool1;
        } while (mhj.a(paramVideoAppInterface.getApp()));
        bool2 = bool1;
      } while (mhj.c(paramVideoAppInterface.getApp()));
      bool2 = bool1;
    } while (mhj.d(paramVideoAppInterface.getApp()));
    return true;
  }
  ...
  public int a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentSharpJniTraeAudioSession == null) {
      this.jdField_a_of_type_ComTencentSharpJniTraeAudioSession = new TraeAudioSession((Context)this.jdField_a_of_type_MqqUtilWeakReference.get(), this.jdField_a_of_type_Mjc);
    }
  ...
  public void a()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.w("TraeSessionHelper", 1, "setHFBtnStatus, deviceName[" + this.jdField_a_of_type_ComTencentAvVideoController.a().p + "], seq[" + l + "]");
    }
    this.jdField_a_of_type_ComTencentAvVideoController.a().a("setHFBtnStatus", "DEVICE_SPEAKERPHONE".equals(this.jdField_a_of_type_ComTencentAvVideoController.a().p));
  ...
  public void a(long paramLong, kvq paramkvq)
  {
    if (paramkvq == null) {
      if (QLog.isColorLevel()) {
    ...
    if (QLog.isColorLevel()) {
      QLog.w("TraeSessionHelper", 1, "switchButton_handFree, isSpeakerOn[" + paramkvq.N + "], seq[" + paramLong + "]");
    }
    this.jdField_a_of_type_Kvq = paramkvq;
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("TraeSessionHelper", 2, String.format("setLightStyle lightStyle=%s mLightBtnStyle=%s", new Object[] { Boolean.valueOf(paramBoolean), Boolean.valueOf(this.e) }));
    }
    this.e = paramBoolean;
    e();
  }
  ...
  public boolean a(long paramLong, VideoAppInterface paramVideoAppInterface, int paramInt1, int paramInt2, MediaPlayer.OnCompletionListener paramOnCompletionListener)
  {
    if ((b(paramVideoAppInterface)) && (a(paramVideoAppInterface.getApp().getApplicationContext())))
    {
      ...
      for (;;)
      {
        ...
        baan.a(paramInt1, paramInt2, paramOnCompletionListener);
      }
    }
    return false;
  }
  ...
  public void c()
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      {
        this.jdField_a_of_type_ComTencentSharpJniTraeAudioSession.a(l, this.jdField_a_of_type_ComTencentAvVideoController.a().p);
        return;
      }
  ...
  public void d()
  {
    ...
    {
      long l = AudioHelper.b();
      QLog.w("TraeSessionHelper", 1, "pressHandFreeBtn, isSpeakerOn[" + ((kvq)localObject2).N + "], seq[" + l + "]", (Throwable)localObject1);
      Object localObject3 = ((kvq)localObject2).a;
      int i;
      ...
      if (localObject3 != null) {
        if ((this.jdField_c_of_type_Boolean) && (mhr.a()))
        {
          if (this.jdField_b_of_type_MqqUtilWeakReference == null) {
            break label677;
          }
      ...
      {
        localObject3 = new mja((String[])localObject3);
        if (!TextUtils.isEmpty(((kvq)localObject2).q)) {
          ((mja)localObject3).a(((kvq)localObject2).q);
        }
        localObject2 = (begr)behe.a((Context)localObject1, null);
        ((begr)localObject2).a(2131630229);
        ListView localListView = new ListView((Context)localObject1);
        if (this.jdField_a_of_type_Miy == null) {
          this.jdField_a_of_type_Miy = new miy((Context)localObject1, (mja)localObject3);
        }
        for (;;)
        {
          localListView.setAdapter(this.jdField_a_of_type_Miy);
          ...
          localListView.setOnItemClickListener(new miv(this, localButton, l, (begr)localObject2));
          ((begr)localObject2).a(localListView);
          ((begr)localObject2).c(2131625035);
          ((begr)localObject2).a(new miw(this));
          ((begr)localObject2).setOnShowListener(new mix(this));
          ((begr)localObject2).show();
          return;
          this.jdField_a_of_type_Miy.a((Context)localObject1, (mja)localObject3);
        }
        if (((kvq)localObject2).N)
        {
          int j = 0;
          int k = 0;
          label472:
