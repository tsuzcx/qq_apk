...
public class agep
  extends Handler
{
  public agep(PressToChangeVoicePanel paramPressToChangeVoicePanel, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    else
    {
      ...
      azub.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a, (QQRecorder.RecorderParam)localObject1);
      Object localObject2 = (ListenChangeVoicePanel)this.a.f.findViewById(2131369958);
      ...
      if ((this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aidp)) {
        oat.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", "", "0X8005850", "0X8005850", 0, 0, "", "", Double.toString(this.a.jdField_a_of_type_Double), "", false);
      }
      paramMessage = (ViewGroup)((ListenChangeVoicePanel)localObject2).findViewById(2131364315);
      if (VersionUtils.isHoneycomb())
      {
        ...
        localAnimatorSet.addListener(new ageq(this, paramMessage));
