  ...
  extends aydh
{
  ...
  public int a()
  {
    ...
    if (this.jdField_g_of_type_JavaLangString != null)
    {
      ...
      ayde.b("PIC_TAG_ERROR", "PicUploadInfo.getProtocolType", "localPath == null");
    }
  ...
  public boolean a()
  {
    ...
    Object localObject = ajuc.a(this.jdField_g_of_type_JavaLangString);
    if (localObject != null)
    {
      if (this.jdField_g_of_type_Int == 1)
      {
        localObject = ((ajuc)localObject).a();
        if (localObject != null) {
  ...
  String b()
  {
    ...
    {
      ayde.b("PIC_TAG_ERROR", "PicUploadInfo.getUrlString", "protocol == null");
      return null;
    }
  ...
  public boolean c()
  {
    return (this.jdField_a_of_type_Ayea != null) && (this.jdField_a_of_type_Ayea.a);
  }
  
  public boolean d()
  {
    return (this.jdField_a_of_type_Ayea != null) && (this.jdField_a_of_type_Ayea.jdField_b_of_type_Boolean);
  }
  
  public boolean e()
  {
    return (this.jdField_a_of_type_Ayea != null) && (this.jdField_a_of_type_Ayea.c);
  }
