...
public class lfv
{
  ...
  ServiceConnection jdField_a_of_type_AndroidContentServiceConnection = new lfx(this);
  ...
  lwp jdField_a_of_type_Lwp = new lfw(this);
  public lwr a;
  boolean jdField_a_of_type_Boolean = false;
  public boolean b;
  
  public lfv(VideoAppInterface paramVideoAppInterface)
  {
  ...
  public int a(int paramInt, String paramString)
  {
    ...
    try
    {
      i = this.jdField_a_of_type_Lwr.a(paramInt, paramString);
      return i;
    }
  ...
  public int a(String paramString)
  {
    if (this.jdField_a_of_type_Lwr != null) {
      try
      {
        int i = this.jdField_a_of_type_Lwr.c(paramString);
        return i;
      }
      catch (RemoteException paramString)
      {
  ...
  public long a(String paramString)
  {
    ...
    try
    {
      l1 = this.jdField_a_of_type_Lwr.a(paramString);
      return l1;
    }
    catch (RemoteException paramString)
    {
  ...
  public Bitmap a(int paramInt, String paramString1, String paramString2, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      try
      {
        Bitmap localBitmap = this.jdField_a_of_type_Lwr.a(paramInt, paramString1, paramString2, paramBoolean1, paramBoolean2);
  ...
  public Bundle a(int paramInt1, int paramInt2, int paramInt3, Bundle paramBundle, ResultReceiver paramResultReceiver)
  {
    if (this.jdField_a_of_type_Lwr != null) {
      try
      {
        paramBundle = this.jdField_a_of_type_Lwr.a(paramInt1, paramInt2, paramInt3, null, paramBundle, paramResultReceiver);
        return paramBundle;
      }
  ...
  public String a()
  {
    ...
    while (!QLog.isColorLevel())
    {
      try
      {
        String str = this.jdField_a_of_type_Lwr.a();
        localObject = str;
      }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    try
    {
      this.jdField_a_of_type_Lwr.a(paramInt, paramString);
      return;
    }
    catch (RemoteException paramString)
    {
  ...
  public void a(int paramInt, String paramString1, String paramString2)
  {
    ...
    try
    {
      this.jdField_a_of_type_Lwr.a(paramInt, paramString1, paramString2);
      return;
    }
  ...
  public void a(long paramLong)
  {
    ...
    try
    {
      this.jdField_a_of_type_Lwr.a(paramLong);
      return;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public void a(long paramLong1, String paramString, long paramLong2)
  {
    ...
    while (!QLog.isColorLevel()) {
      try
      {
        this.jdField_a_of_type_Lwr.a(paramLong1, paramString, paramLong2);
        return;
      }
      catch (RemoteException paramString)
      {
  ...
  public void a(boolean paramBoolean)
  {
    ...
    try
    {
      this.jdField_a_of_type_Lwr.d(paramBoolean);
      return;
    }
  ...
  public boolean a(int paramInt, long paramLong)
  {
    ...
    try
    {
      bool1 = this.jdField_a_of_type_Lwr.a(paramInt, paramLong);
      return bool1;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public boolean a(long paramLong)
  {
    ...
    try
    {
      bool = this.jdField_a_of_type_Lwr.a(paramLong);
      return bool;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public boolean a(String paramString)
  {
    ...
    try
    {
      bool = this.jdField_a_of_type_Lwr.a(paramString);
      return bool;
    }
    catch (RemoteException paramString)
    {
  ...
  public boolean a(String paramString, int paramInt)
  {
    ...
    try
    {
      bool = this.jdField_a_of_type_Lwr.b(paramString, paramInt);
      return bool;
    }
    catch (RemoteException paramString)
    {
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("QQServiceProxy", 2, "getAVRedPacketConfig start mQQServiceForAV = " + this.jdField_a_of_type_Lwr);
    }
    if (this.jdField_a_of_type_Lwr != null) {
      try
      {
        this.jdField_a_of_type_Lwr.a(paramlwf);
        return true;
      }
      catch (RemoteException paramlwf)
      {
        paramlwf.printStackTrace();
        if (QLog.isColorLevel()) {
          QLog.d("QQServiceProxy", 2, "getAVRedPacketConfig error", paramlwf);
        }
      }
    }
    return false;
  ...
  public long[] a(String paramString)
  {
    ...
    try
    {
      localObject1 = this.jdField_a_of_type_Lwr.a(paramString);
      return localObject1;
    }
    catch (RemoteException paramString)
    {
  ...
  public String b(int paramInt, String paramString1, String paramString2)
  {
    ...
    try
    {
      String str1 = this.jdField_a_of_type_Lwr.a(paramInt, paramString1, paramString2);
      localObject2 = str1;
  ...
  public void b(int paramInt, String paramString)
  {
    ...
    try
    {
      this.jdField_a_of_type_Lwr.b(paramInt, paramString);
      return;
    }
    catch (RemoteException paramString)
    {
  ...
  public void b(String paramString)
  {
    ...
    {
      if (this.jdField_a_of_type_Lwr != null) {
        this.jdField_a_of_type_Lwr.d(paramString);
      }
      return;
    }
  ...
  public boolean b()
  {
    ...
    try
    {
      bool1 = this.jdField_a_of_type_Lwr.a();
      return bool1;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public boolean b(String paramString)
  {
    ...
    try
    {
      this.jdField_a_of_type_Lwr.a(paramString);
      bool1 = true;
    }
    catch (RemoteException paramString)
    {
  ...
  public boolean b(lwf paramlwf)
  {
    ...
    if (this.jdField_a_of_type_Lwr != null) {
      try
      {
        this.jdField_a_of_type_Lwr.b(paramlwf);
        return true;
      }
      catch (RemoteException paramlwf)
      {
        paramlwf.printStackTrace();
        if (QLog.isColorLevel()) {
          QLog.d("QQServiceProxy", 2, "startDownloadAVRedPacketRes error", paramlwf);
        }
      }
    }
    return false;
  ...
  public String c(String paramString)
  {
    ...
    try
    {
      localObject1 = this.jdField_a_of_type_Lwr.d(paramString);
      return localObject1;
    }
    catch (RemoteException paramString)
    {
  ...
  public void c()
  {
    ...
    if ((this.jdField_a_of_type_Lwr == null) && (!this.jdField_a_of_type_Boolean))
    {
  ...
  public void c(String paramString)
  {
    ...
    {
      if (this.jdField_a_of_type_Lwr != null) {
        this.jdField_a_of_type_Lwr.e(paramString);
      }
      return;
    }
    catch (Exception paramString)
  ...
  public boolean c()
  {
    ...
    try
    {
      bool1 = this.jdField_a_of_type_Lwr.g();
      return bool1;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public boolean c(String paramString)
  {
    if (this.jdField_a_of_type_Lwr != null) {
      try
      {
        boolean bool = this.jdField_a_of_type_Lwr.a(paramString, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin());
        return bool;
      }
      catch (RemoteException paramString)
      {
  ...
  public void d()
  {
    lcg.d("QQServiceProxy", "unbindQQService");
    if (this.jdField_a_of_type_Lwr != null) {}
    try
    {
      this.jdField_a_of_type_Lwr.a();
      this.jdField_a_of_type_Lwr.a(this.jdField_a_of_type_Lwp);
    }
    catch (RemoteException localRemoteException)
    {
      for (;;)
  ...
  public boolean d()
  {
    ...
    try
    {
      bool1 = this.jdField_a_of_type_Lwr.h();
      return bool1;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public boolean e()
  {
    ...
    try
    {
      bool1 = this.jdField_a_of_type_Lwr.b();
      return bool1;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public boolean f()
  {
    if ((this.jdField_a_of_type_Int == -1) && (this.jdField_a_of_type_Lwr != null)) {}
    for (;;)
    {
      try
      {
        if (!this.jdField_a_of_type_Lwr.c()) {
          continue;
        }
        i = 1;
  ...
  public boolean g()
  {
    ...
    try
    {
      bool1 = this.jdField_a_of_type_Lwr.d();
      if (QLog.isColorLevel()) {
        QLog.e("EffectEnable", 2, "getEffectsSoLoadIsOk  result " + this.jdField_a_of_type_Lwr + "   " + bool1);
      }
      return bool1;
    }
    catch (RemoteException localRemoteException)
    ...
    catch (NullPointerException localNullPointerException)
    {
      for (;;)
      {
        lcg.e("EffectEnable", localNullPointerException.getMessage());
        bool1 = bool2;
      }
    }
  }
  ...
  public boolean h()
  {
    ...
    try
    {
      bool1 = this.jdField_a_of_type_Lwr.e();
      if (QLog.isColorLevel()) {
        QLog.e("getEffectLibPagSoLoadIsOk", 2, "getEffectLibPagSoLoadIsOk  result " + this.jdField_a_of_type_Lwr + "   " + bool1);
      }
      return bool1;
    }
    catch (RemoteException localRemoteException)
