  ...
  extends BusinessHandler
{
  ...
  public lfv(AppInterface paramAppInterface)
  {
  ...
  private AudioTransClientTransInfo.IntHead a(int paramInt1, int paramInt2)
  {
    ...
    localIntHead.str_session_id.set(String.valueOf(this.jdField_a_of_type_Lfu.jdField_a_of_type_Long));
  ...
  private AudioTransClientTransInfo.IntReqBody a(int paramInt1, boolean paramBoolean, int paramInt2, byte[] paramArrayOfByte)
  {
    ...
    if (paramInt1 == 1)
    {
      ...
      paramArrayOfByte.uint32_client_ver.set(mum.a());
  ...
  {
    Object localObject1 = this.jdField_a_of_type_Lfq;
    localObject1 = lfq.a(paramArrayOfByte);
    paramArrayOfByte = ((lfr)localObject1).a;
    localObject1 = ((lfr)localObject1).b;
  ...
  public void a(String paramString1, long paramLong, String paramString2, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      lfq locallfq = this.jdField_a_of_type_Lfq;
      localToServiceMsg.putWupBuffer(lfq.a(localIntHead.toByteArray(), paramArrayOfByte.toByteArray()));
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (bool)
    {
      paramObject = this.jdField_a_of_type_Lfq;
      ...
      for (;;)
      {
        ...
        else if (j == 6)
        {
          ...
          this.jdField_a_of_type_Lfu.jdField_a_of_type_Int = paramFromServiceMsg.enum_channel_type.get();
          if (AudioHelper.f())
          {
            m = paramFromServiceMsg.uint32_combine_num.get();
            QLog.d("AudioTransClientInterfaceHandler", 2, "enum_channel_type = " + this.jdField_a_of_type_Lfu.jdField_a_of_type_Int);
            ...
            while (paramFromServiceMsg.hasNext())
            {
              ...
              lfq locallfq = this.jdField_a_of_type_Lfq;
              QLog.d("AudioTransClientInterfaceHandler", 2, lfq.a(paramObject.fixed32_IP.get()));
              ...
              locallfq = this.jdField_a_of_type_Lfq;
              QLog.d("AudioTransClientInterfaceHandler", 2, lfq.a(paramObject.fixed32_inner_IP.get()));
            }
          }
        }
      }
