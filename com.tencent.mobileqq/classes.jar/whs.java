  ...
  implements Handler.Callback
{
  ...
  public whs(Context paramContext, xns paramxns)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Xns = paramxns;
    this.jdField_a_of_type_Alji = alji.a();
    this.jdField_a_of_type_Alji.a(paramContext, hashCode(), "QrImageScan");
  }
  ...
  public void a()
  {
    try
    {
      ...
      if (this.jdField_a_of_type_Alji != null) {
        this.jdField_a_of_type_Alji.a(hashCode(), "QrImageScan");
      }
      this.jdField_a_of_type_Xns = null;
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (int i = whj.a((Uri)paramMessage.obj, this.jdField_a_of_type_AndroidContentContext, j, (SparseArray)localObject);; i = 0)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          if ((!whj.a(k)) || (paramMessage == null)) {
            break label350;
          }
          i = 1;
          if ((!whj.b(k)) || (paramMessage == null)) {
            break label355;
          }
          j = 1;
          if ((i == 0) && (j == 0)) {
      ...
      this.jdField_a_of_type_Xns.a(String.valueOf(paramMessage.obj), i, j);
      return true;
      i = paramMessage.arg1;
      if (this.jdField_a_of_type_Xns == null) {
        break;
      }
      this.jdField_a_of_type_Xns.a(i);
      return true;
    }
  }
}
