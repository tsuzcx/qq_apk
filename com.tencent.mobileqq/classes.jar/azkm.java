...
public class azkm
{
  ...
  public static azkn a(DataInputStream paramDataInputStream, boolean paramBoolean)
  {
  ...
  public static azkn a(String paramString, byte[] paramArrayOfByte, boolean paramBoolean)
  {
    int j = 0;
    int i = 0;
    for (;;)
    {
      ...
      try
      {
        ...
        if ((k == 5) || (k == 19))
        {
          ...
          localObject5 = new azkn();
          ((azkn)localObject5).jdField_a_of_type_JavaLangString = paramArrayOfByte;
          ((azkn)localObject5).jdField_b_of_type_JavaLangString = paramString;
          ((azkn)localObject5).jdField_c_of_type_JavaLangString = ((String)localObject3);
          ((azkn)localObject5).jdField_d_of_type_JavaLangString = ((String)localObject1);
          ((azkn)localObject5).jdField_a_of_type_Int = 1;
          if (localGroupFeedsMessage.opt_uint32_ctl_flag.has()) {
            i = localGroupFeedsMessage.opt_uint32_ctl_flag.get();
          }
          ((azkn)localObject5).jdField_e_of_type_Int = i;
          return localObject5;
        }
        if (k == 22)
        {
      ...
      localObject3 = new azkn();
      ((azkn)localObject3).jdField_b_of_type_JavaLangString = paramString;
      ((azkn)localObject3).jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
      ((azkn)localObject3).jdField_e_of_type_JavaLangString = ((String)localObject1);
      ((azkn)localObject3).jdField_a_of_type_Int = 2;
      ((azkn)localObject3).jdField_b_of_type_Long = l1;
      ((azkn)localObject3).jdField_d_of_type_Int = i;
      i = j;
      if (localGroupFeedsMessage.opt_uint32_ctl_flag.has()) {
        i = localGroupFeedsMessage.opt_uint32_ctl_flag.get();
      }
      ((azkn)localObject3).jdField_e_of_type_Int = i;
      return localObject3;
      return null;
      label727:
      label732:
  ...
  public static TroopNotificationCache a(azkn paramazkn, String paramString, int paramInt1, int paramInt2, long paramLong)
  {
    if (paramazkn != null)
    {
      if (paramazkn.jdField_a_of_type_Int == 1)
      {
        String str2 = a(paramazkn.jdField_c_of_type_JavaLangString);
        ...
        str2 = a(paramazkn.jdField_a_of_type_JavaLangString);
        if (TextUtils.isEmpty(paramazkn.jdField_a_of_type_JavaLangString))
        {
          str2 = new SimpleDateFormat("yyyy年M月d日").format(new Date(paramazkn.jdField_c_of_type_Int * 1000L));
          str2 = str2 + " 群公告";
        }
        ...
        localTroopNotificationCache.title = paramazkn.jdField_a_of_type_JavaLangString;
        localTroopNotificationCache.feedType = paramInt1;
        localTroopNotificationCache.appId = paramInt2;
        localTroopNotificationCache.userUin = paramazkn.jdField_a_of_type_Long;
        localTroopNotificationCache.troopUin = paramLong;
        localTroopNotificationCache.time = paramazkn.jdField_c_of_type_Int;
        localTroopNotificationCache.feedsId = paramazkn.jdField_b_of_type_JavaLangString;
        ...
        if (TextUtils.isEmpty(paramazkn.jdField_d_of_type_JavaLangString)) {}
        for (localTroopNotificationCache.xmlBytes = String.format("<?xml version=\"1.0\" encoding=\"utf-8\" ?><msg action=\"web\" serviceID=\"27\" templateID=\"\" actionData=\"\" url=\"%s\" flag=\"5\" brief=\"%s\"><item layout=\"1\"><title size=\"30\" color=\"#000000\">[公告] %s</title><hr /><title size=\"22\" color=\"#000000\">%s</title><summary size=\"28\" color=\"#808080\">%s</summary></item></msg>", new Object[] { paramString, "", str2, str3, str1 }).getBytes();; localTroopNotificationCache.xmlBytes = String.format("<?xml version=\"1.0\" encoding=\"utf-8\" ?><msg action=\"web\" serviceID=\"27\" templateID=\"\" actionData=\"\" url=\"%s\" flag=\"5\" brief=\"%s\"><item layout=\"6\"><title size=\"30\" color=\"#000000\">[公告] %s</title><hr /></item><item layout=\"2\"><picture cover=\"%s\"/><title size=\"22\" color=\"#000000\">%s</title><summary size=\"28\" color=\"#808080\">%s</summary></item></msg>", new Object[] { paramString, "", str2, paramazkn.jdField_d_of_type_JavaLangString, str3, str1 }).getBytes()) {
          return localTroopNotificationCache;
        }
      }
      if (paramazkn.jdField_a_of_type_Int == 2)
      {
        paramString = new TroopNotificationCache();
        paramString.feedType = paramInt1;
        paramString.appId = paramInt2;
        paramString.userUin = paramazkn.jdField_a_of_type_Long;
        paramString.troopUin = paramLong;
        paramString.time = paramazkn.jdField_c_of_type_Int;
        paramString.feedsId = paramazkn.jdField_b_of_type_JavaLangString;
        paramString.ctrlStr = paramazkn.jdField_e_of_type_JavaLangString;
        paramString.xmlBytes = paramazkn.jdField_a_of_type_ArrayOfByte;
        paramString.src = paramazkn.jdField_d_of_type_Int;
        paramString.filterID = paramazkn.jdField_b_of_type_Long;
  ...
  public static TroopNotificationCache a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d(azkm.class.getSimpleName(), 2, paramQQAppInterface.getMessage());
        }
      }
      return null;
      label274:
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface = localatmp.a(true, TroopNotificationCache.class.getSimpleName(), new String[] { "troopUin", "feedType", "serviceID" }, "read=?", new String[] { String.valueOf(0) }, "troopUin", null, null, null);
    if (paramQQAppInterface != null) {}
    for (;;)
    {
      try
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt1, long paramLong1, long paramLong2, long paramLong3, String paramString1, int paramInt2, String paramString2, short paramShort, boolean paramBoolean)
  {
    ...
    catch (Exception localException)
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d(azkm.class.getSimpleName(), 2, localException.getMessage());
        }
      }
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt1, long paramLong1, long paramLong2, long paramLong3, String paramString, int paramInt2, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      {
        paramArrayOfByte = null;
        if ((((azkn)localObject).jdField_a_of_type_Int == 1) || (((azkn)localObject).jdField_a_of_type_Int == 2)) {
          paramArrayOfByte = a((azkn)localObject, paramString, 23, paramInt1, paramLong2);
        }
        QQMessageFacade localQQMessageFacade = paramQQAppInterface.a();
        ArrayList localArrayList = new ArrayList();
        localArrayList.add(paramArrayOfByte);
        paramInt1 = (int)awao.a();
        localQQMessageFacade.a().a(paramQQAppInterface, String.valueOf(paramLong1), String.valueOf(paramLong2), localArrayList, 23, paramInt1, ((azkn)localObject).jdField_e_of_type_Int);
      }
    }
    catch (Exception paramQQAppInterface)
    {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    if ((jdField_a_of_type_JavaUtilHashMap != null) && (jdField_a_of_type_JavaUtilHashMap.containsKey(paramString)))
    {
      ...
      ((ajtg)paramQQAppInterface.a(20)).a(paramQQAppInterface, paramString, arrayOfByte, paramInt);
      return;
    }
    try
    {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, List<TroopNotificationCache> paramList, int paramInt1, int paramInt2)
  {
    ...
    if (paramList.hasNext())
    {
      ...
      ((atmp)localObject).a(localTroopNotificationCache);
    ...
    for (;;)
    {
      break;
      ((atmp)localObject).a();
      if (ariz.a().a(paramQQAppInterface, paramString))
      {
      ...
      if (paramInt2 == 1)
      {
        paramQQAppInterface = ahay.a(paramString.uin, paramString.getType());
        ahay.a().a(paramQQAppInterface);
        if (paramInt2 != 1) {
          break label365;
        }
      }
      for (i = 28;; i = 11)
      {
        ...
        paramQQAppInterface = new ahdw(BaseApplication.getContext());
        ...
        return;
        if (((paramString.msg instanceof aheb)) || ((paramString.msg instanceof ahdo)) || ((paramString.msg instanceof ahdu)) || ((paramString.msg instanceof ahdl)) || ((paramString.msg instanceof ahdk)) || ((paramString.msg instanceof ahdz))) {
          break;
        }
        if ((!(paramString.msg instanceof ahdw)) || (((ahdw)paramString.msg).jdField_c_of_type_Int != 1)) {
          break label199;
        }
        return;
      }
  ...
  public static void a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    QLog.d("TroopNotificationHelper", 2, azkm.class.getSimpleName() + "-->clearTroopNotification");
  }
  ...
  public static byte[] a(long paramLong, short paramShort, byte[] paramArrayOfByte, String paramString)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d(azkm.class.getSimpleName(), 2, paramArrayOfByte.getMessage());
      }
    }
    return null;
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(azkm.class.getSimpleName(), 2, "handGetTroopAuth");
    }
    paramQQAppInterface = new oidb_sso.OIDBSSOPkg();
    try
    {
  ...
  public static void c(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (!ariz.a().a(paramQQAppInterface, paramString))
    {
      ...
      localObject2 = ((akeu)localObject1).a(paramString, 1);
