...
public class azkm
  extends ailn
  implements View.OnClickListener, View.OnLongClickListener, asko
{
  private static final azks jdField_a_of_type_Azks = new azks(null);
  private final Context jdField_a_of_type_AndroidContentContext;
  private final SparseArray<ArrayList<auko>> jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
  private final View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new azkn(this);
  azlq jdField_a_of_type_Azlq;
  ...
  private final View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new azko(this);
  private ExpandableListView jdField_b_of_type_ComTencentWidgetExpandableListView;
  
  public azkm(NewTroopContactView paramNewTroopContactView, QQAppInterface paramQQAppInterface, ExpandableListView paramExpandableListView, boolean paramBoolean)
  {
  ...
  private View a(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      if ((AppSetting.d) && (paramViewGroup.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
      {
        ...
        paramView.setContentDescription((String)localObject + ajya.a(2131702510));
      }
      return paramView;
    ...
    label412:
    paramView.setContentDescription((String)localObject + ajya.a(2131702496));
    return paramView;
  }
  
  private void a(List<azkq> paramList)
  {
    try
    {
      Collections.sort(paramList, jdField_a_of_type_Azks);
      return;
    }
  ...
  private View b(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      if ((AppSetting.d) && (paramViewGroup.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
      {
        ...
        paramView.setContentDescription(localPhoneContact.name + ajya.a(2131702504));
      }
      return paramView;
      paramViewGroup = (azku)paramView.getTag();
      paramViewGroup.d.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
  ...
  private View c(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      if (PublicAccountInfo.isLooker(localPublicAccountInfo))
      {
        ...
        return paramView;
        paramViewGroup = (azkt)paramView.getTag();
        paramViewGroup.d.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
      }
      else
      {
  ...
  private void d()
  {
    ...
    this.jdField_a_of_type_Azlq.a(this.jdField_a_of_type_JavaUtilArrayList, this.jdField_a_of_type_AndroidUtilSparseArray);
    c();
      ...
      if (((Iterator)localObject3).hasNext())
      {
        ...
        for (localObject2 = new ArrayList();; localObject2 = new ArrayList((Collection)localObject2))
        {
          ...
          while (((Iterator)localObject5).hasNext()) {
            ((ArrayList)localObject4).add(new azkq((Friends)((Iterator)localObject5).next(), -1));
          }
        ...
        while (((Iterator)localObject4).hasNext()) {
          ((List)localObject2).add(((azkq)((Iterator)localObject4).next()).a);
        }
  ...
  {
    azkr localazkr = (azkr)paramView.getTag();
    if (localazkr == null)
    {
      localazkr = new azkr();
      paramView.findViewById(2131368567).setVisibility(0);
      localazkr.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367211));
      paramView.setTag(localazkr);
    }
    for (;;)
    {
      Groups localGroups = (Groups)getGroup(paramInt);
      localazkr.jdField_a_of_type_AndroidWidgetTextView.setText(localGroups.group_name);
  ...
  public View getChildView(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      else if (a(paramInt1, paramInt2) == 2)
      {
        ...
        paramView = this.jdField_a_of_type_Azlq.a(paramInt1, paramInt2, paramView, paramViewGroup, this.jdField_a_of_type_AndroidContentContext, this.jdField_b_of_type_AndroidViewView$OnClickListener, localRelationTroopEntity);
      }
      else
      {
  ...
  public View getGroupView(int paramInt, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView != null)
    {
      localObject = (azkr)paramView.getTag();
    ...
    for (;;)
    {
      ...
      if (AppSetting.d)
      {
        ...
        paramViewGroup.setContentDescription(((Groups)localObject).group_name + ajya.a(2131702498));
      }
    ...
    paramViewGroup.setContentDescription(((Groups)localObject).group_name + ajya.a(2131702515));
    return paramViewGroup;
  }
  ...
  {
    paramView = (azkr)paramView.getTag();
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    bbcq.a(paramView, localbbmf, this.jdField_a_of_type_AndroidViewView$OnClickListener, new azkp(this));
    return true;
  }
