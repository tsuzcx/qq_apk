  ...
  implements Handler.Callback, ayrz, aysa, Manager
{
  ...
  private bfke jdField_a_of_type_Bfke;
  ...
  public bfka(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Bfjz = new bfjz(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  }
  ...
  private String a(bfke parambfke)
  {
    parambfke = a() + parambfke.jdField_a_of_type_Long + File.separator;
    File localFile = new File(parambfke);
    if (!localFile.exists()) {
      localFile.mkdirs();
    }
    return parambfke;
  ...
  private void a(aysx paramaysx)
  {
    ...
    do
    {
      ...
      QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] http download error=%d", new Object[] { Integer.valueOf(paramaysx.jdField_a_of_type_Int) }));
      return;
      localbfkb = (bfkb)paramaysx.jdField_a_of_type_Aysw.a();
    } while (localbfkb == null);
    if (paramaysx.jdField_a_of_type_Int == 0) {}
    while (!bool)
    {
      try
      {
        if (localbfkb.jdField_d_of_type_Int >= 3) {
          break label146;
        }
        if (QLog.isColorLevel()) {
          QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] retried to download, retry=%d, result=%b, url=%s", new Object[] { Integer.valueOf(localbfkb.jdField_d_of_type_Int), Boolean.valueOf(bool), localbfkb.jdField_c_of_type_JavaLangString }));
        }
        a(localbfkb);
        return;
      }
      ...
      continue;
      label146:
      File localFile = new File(paramaysx.jdField_a_of_type_Aysw.jdField_c_of_type_JavaLangString);
      if (localFile.exists()) {
        localFile.delete();
      }
    }
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(localbfkb.jdField_d_of_type_JavaLangString.toLowerCase());
    a(bool, paramaysx.jdField_a_of_type_Aysw);
  }
  
  private void a(bfke parambfke)
  {
    if (parambfke != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] update complete: sid=%d", new Object[] { Long.valueOf(parambfke.jdField_a_of_type_Long) }));
      }
      parambfke.a();
      if (b())
      {
        this.jdField_a_of_type_JavaLangString += String.format("#%d#", new Object[] { Long.valueOf(parambfke.jdField_b_of_type_Long) });
        this.jdField_b_of_type_JavaLangString += String.format("#%d#", new Object[] { Long.valueOf(parambfke.jdField_a_of_type_Long) });
      }
      a("0X80078B4", 0, "", "");
    }
  }
  ...
  private void a(String paramString1, int paramInt, String paramString2, String paramString3)
  {
    ...
    {
      paramInt = (int)this.jdField_a_of_type_Bfke.jdField_b_of_type_Long;
      if (this.jdField_a_of_type_Bfke == null) {
        break label188;
      }
    }
    label188:
    for (paramString2 = String.format("%d", new Object[] { Long.valueOf(this.jdField_a_of_type_Bfke.jdField_a_of_type_Long) });; paramString2 = "")
    {
      if (QLog.isColorLevel()) {
      ...
      localbfhf.a(paramString1).a(paramString1).a(paramString3).a(paramString2).a(this.jdField_a_of_type_Int);
      bfhc.a(localbfhf.toString(), 105, paramInt);
      return;
      paramInt = 0;
      break;
    }
  ...
  private void a(boolean paramBoolean, aysw paramaysw)
  {
    if ((!paramBoolean) || (paramaysw == null))
    {
      a(3);
      return;
    }
    File localFile = new File(paramaysw.jdField_c_of_type_JavaLangString);
    bfkb localbfkb = (bfkb)paramaysw.a();
    if ((!localFile.exists()) || (localbfkb == null))
    {
      a(3);
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] http download complete: %s, %s", new Object[] { paramaysw.jdField_c_of_type_JavaLangString, localbfkb.jdField_c_of_type_JavaLangString }));
    }
    switch (localbfkb.jdField_a_of_type_Int)
    {
    default: 
      return;
    case 1: 
      localFile = new File(b());
      new File(paramaysw.jdField_c_of_type_JavaLangString).renameTo(localFile);
      a("0X80078AC", localbfkb.jdField_c_of_type_Int, "", "");
      if (this.jdField_a_of_type_Bfjz.a(localFile.toString()))
      {
        this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putInt("last_update_config_version", localbfkb.jdField_c_of_type_Int).commit();
        if (this.jdField_a_of_type_Bfjz.a().isEmpty())
        {
          if (QLog.isColorLevel()) {
      ...
      a("0X80078AC", localbfkb.jdField_c_of_type_Int, localbfkb.jdField_b_of_type_JavaLangString, localbfkb.jdField_c_of_type_JavaLangString);
      if (QLog.isColorLevel()) {
    ...
    a("0X80078AE", localbfkb.jdField_c_of_type_Int, "", "");
    d(7);
  }
  
  private boolean a()
  {
    Object localObject = this.jdField_a_of_type_Bfjz.a();
    int i = 0;
    if (i < ((List)localObject).size()) {
      if (((bfke)((List)localObject).get(i)).a()) {}
    }
  ...
  private boolean a(bfkb parambfkb)
  {
    if (parambfkb == null) {}
    do
    {
      return false;
      if ((parambfkb.jdField_a_of_type_Int == 2) && (parambfkb.e != 1) && (!NetworkUtils.isWifiConnected(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication())))
      {
        if (QLog.isColorLevel()) {
    ...
    } while ((parambfkb.jdField_d_of_type_Int < 3) && (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.contains(parambfkb.jdField_d_of_type_JavaLangString.toLowerCase())));
    ...
    localayrv.jdField_a_of_type_JavaLangString = parambfkb.jdField_c_of_type_JavaLangString;
    localayrv.jdField_a_of_type_Int = 0;
    localayrv.jdField_c_of_type_JavaLangString = (parambfkb.jdField_a_of_type_JavaLangString + parambfkb.jdField_b_of_type_JavaLangString);
    parambfkb.jdField_d_of_type_Int += 1;
    parambfkb.jdField_a_of_type_Long = new Date().getTime();
    localayrv.a(parambfkb);
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(parambfkb.jdField_d_of_type_JavaLangString.toLowerCase(), localayrv);
    localayry.a(localayrv);
    if (QLog.isColorLevel()) {
      QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] begin http download %s", new Object[] { parambfkb.jdField_c_of_type_JavaLangString }));
    }
    return true;
  }
  
  private boolean a(bfke parambfke)
  {
    boolean bool;
    if (parambfke != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] rollback: sid=%d", new Object[] { Long.valueOf(parambfke.jdField_a_of_type_Long) }));
      }
      if (parambfke.jdField_b_of_type_JavaUtilList.isEmpty())
      {
        if (!QLog.isColorLevel()) {
          break label355;
        }
    ...
    for (;;)
    {
      ...
      return bool;
      String str = b(parambfke);
      long l2 = 0L;
      int i = 0;
      while (i < parambfke.jdField_b_of_type_JavaUtilList.size())
      {
        Object localObject = (bfkd)parambfke.jdField_b_of_type_JavaUtilList.get(i);
        File localFile1 = new File(((bfkd)localObject).f);
        File localFile2 = new File(((bfkd)localObject).g);
        long l1 = l2;
        ...
        l2 = l1;
        if (((bfkd)localObject).jdField_a_of_type_Int == 2)
        {
          l2 = l1;
        ...
        localObject = new File(str, ((bfkd)localObject).jdField_c_of_type_JavaLangString);
        l1 = l2;
      ...
      if (l2 == parambfke.jdField_b_of_type_JavaUtilList.size())
      {
        bool = true;
      }
      else
  ...
  private String b(bfke parambfke)
  {
    parambfke = a(parambfke) + "bak" + File.separator;
    File localFile = new File(parambfke);
    if (!localFile.exists()) {
      localFile.mkdirs();
    }
  ...
  private void b(bfke parambfke)
  {
    if (parambfke != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] cleanup: sid=%d", new Object[] { Long.valueOf(parambfke.jdField_a_of_type_Long) }));
      }
      bbdj.a(a(parambfke), false);
    }
  }
  ...
  private boolean b(bfke parambfke)
  {
    return true;
  }
  
  private String c(bfke parambfke)
  {
    return a(parambfke) + parambfke.jdField_a_of_type_JavaLangString;
  }
  ...
  private void c()
  {
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      this.jdField_a_of_type_Boolean = false;
      a("0X80078B5", 0, "", "");
      this.jdField_a_of_type_Bfke = null;
      if (QLog.isColorLevel()) {
  ...
  {
    this.jdField_a_of_type_Bfke = null;
    List localList = this.jdField_a_of_type_Bfjz.a();
    int i = 0;
    label150:
    boolean bool;
    if (i < localList.size())
    {
      bfke localbfke = (bfke)localList.get(i);
      if (localbfke.a()) {}
      for (;;)
      {
        i += 1;
        break;
        if ((localbfke.jdField_b_of_type_Boolean) && (localbfke.jdField_a_of_type_Boolean) && (localbfke.jdField_c_of_type_Boolean)) {
          break label150;
        }
        if (QLog.isColorLevel()) {
          QLog.w("QQProtect.QPUpdate", 2, String.format("[SFU] not matched section: sid=%d, os: %b, qq:%b, cpu:%b", new Object[] { Long.valueOf(localbfke.jdField_a_of_type_Long), Boolean.valueOf(localbfke.jdField_b_of_type_Boolean), Boolean.valueOf(localbfke.jdField_a_of_type_Boolean), Boolean.valueOf(localbfke.jdField_c_of_type_Boolean) }));
        }
        localbfke.a();
      }
      this.jdField_a_of_type_Bfke = localbfke;
      c(0);
      if (QLog.isColorLevel())
      {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] next update: sid=%d", new Object[] { Long.valueOf(this.jdField_a_of_type_Bfke.jdField_a_of_type_Long) }));
        bool = true;
      }
    }
    for (;;)
  ...
  private boolean c(bfke parambfke)
  {
    String str;
    if (parambfke != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] verify package: sid=%d", new Object[] { Long.valueOf(parambfke.jdField_a_of_type_Long) }));
      }
      str = bfjx.a(c(parambfke));
      if (str == null) {
        return false;
      }
    }
    for (boolean bool = str.equalsIgnoreCase(parambfke.jdField_b_of_type_JavaLangString);; bool = false)
    {
      if (QLog.isColorLevel()) {
  ...
  private void d(int paramInt)
  {
    ...
    case 6: 
      do
      {
        ...
        d();
        return;
        if ((c()) && (this.jdField_a_of_type_Bfke != null))
        {
          if (!i(this.jdField_a_of_type_Bfke))
          {
            d(15);
            return;
          }
        ...
        d(16);
        return;
      } while ((this.jdField_a_of_type_Bfke != null) && (h(this.jdField_a_of_type_Bfke)));
      a(3);
      return;
    case 7: 
      if ((this.jdField_a_of_type_Bfke != null) && (c(this.jdField_a_of_type_Bfke)))
      {
        d(8);
        return;
      }
      ...
      return;
    case 8: 
      if ((this.jdField_a_of_type_Bfke != null) && (g(this.jdField_a_of_type_Bfke)))
      {
        d(9);
        return;
      }
      ...
      return;
    case 9: 
      if ((this.jdField_a_of_type_Bfke != null) && (e(this.jdField_a_of_type_Bfke)))
      {
        d(10);
        return;
      }
      ...
      return;
    case 10: 
      if ((this.jdField_a_of_type_Bfke != null) && (f(this.jdField_a_of_type_Bfke)))
      {
        d(11);
        return;
      }
      ...
      return;
    case 11: 
      if ((this.jdField_a_of_type_Bfke != null) && (d(this.jdField_a_of_type_Bfke)))
      {
        d(12);
        return;
      }
      ...
      return;
    case 12: 
      if ((this.jdField_a_of_type_Bfke != null) && (b(this.jdField_a_of_type_Bfke)))
      {
        a(0);
        return;
      }
      ...
      return;
    case 13: 
      if ((this.jdField_a_of_type_Bfke != null) && (a(this.jdField_a_of_type_Bfke)))
      {
        a(0);
        return;
      }
    ...
    case 14: 
      if (this.jdField_a_of_type_Bfke != null) {
        b(this.jdField_a_of_type_Bfke);
      }
      d(15);
      return;
    case 15: 
      a(this.jdField_a_of_type_Bfke);
      this.jdField_a_of_type_Bfke = null;
      if (a())
      {
        d(16);
  ...
  private boolean d(bfke parambfke)
  {
    boolean bool;
    if (parambfke != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] verify: sid=%d", new Object[] { Long.valueOf(parambfke.jdField_a_of_type_Long) }));
      }
      if (parambfke.jdField_c_of_type_JavaUtilList.isEmpty())
      {
        if (QLog.isColorLevel()) {
          QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] no diff: sid=%d", new Object[] { Long.valueOf(parambfke.jdField_a_of_type_Long) }));
        }
        bool = true;
      }
    }
    for (;;)
    {
      ...
      for (;;)
      {
        if (i < parambfke.jdField_c_of_type_JavaUtilList.size())
        {
          bfkd localbfkd = (bfkd)parambfke.jdField_c_of_type_JavaUtilList.get(i);
          if (TextUtils.isEmpty(localbfkd.g)) {}
          for (String str = localbfkd.f;; str = localbfkd.g)
          {
            str = bfjx.a(str);
            if ((str != null) && (str.equalsIgnoreCase(localbfkd.jdField_b_of_type_JavaLangString))) {
              break label246;
            }
            if (!QLog.isColorLevel()) {
              break label253;
            }
            QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] not matched: %s!=%s, sid=%d", new Object[] { str, localbfkd.jdField_b_of_type_JavaLangString, Long.valueOf(parambfke.jdField_a_of_type_Long) }));
            bool = false;
            break;
          }
          label246:
  ...
  private boolean e(bfke parambfke)
  {
    boolean bool;
    if (parambfke != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] backup: sid=%d", new Object[] { Long.valueOf(parambfke.jdField_a_of_type_Long) }));
      }
      if (parambfke.f == 0L)
      {
        if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if (parambfke.f > 0L)
      {
        String str1 = b(parambfke);
        long l1 = 0L;
        int i = 0;
        while (i < parambfke.jdField_c_of_type_JavaUtilList.size())
        {
          bfkd localbfkd = (bfkd)parambfke.jdField_c_of_type_JavaUtilList.get(i);
          long l2 = l1;
          if (1 == localbfkd.jdField_a_of_type_Int)
          {
            String str2 = str1 + localbfkd.jdField_c_of_type_JavaLangString;
            a(new File(localbfkd.f), new File(str2));
            l2 = l1 + 1L;
          }
          i += 1;
          l1 = l2;
        ...
        if (QLog.isColorLevel()) {
          QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] backup %d files of %d", new Object[] { Long.valueOf(l1), Integer.valueOf(parambfke.jdField_c_of_type_JavaUtilList.size()) }));
        }
        if (parambfke.f == l1) {
          bool = true;
        } else {
  ...
  private boolean f(bfke parambfke)
  {
    boolean bool1;
    if ((parambfke != null) && (!parambfke.jdField_c_of_type_JavaUtilList.isEmpty()))
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] do update files: sid=%d", new Object[] { Long.valueOf(parambfke.jdField_a_of_type_Long) }));
      }
      String str = a(parambfke);
      int i = 0;
      if (i < parambfke.jdField_c_of_type_JavaUtilList.size())
      {
        bfkd localbfkd = (bfkd)parambfke.jdField_c_of_type_JavaUtilList.get(i);
        File localFile1 = new File(str, localbfkd.jdField_b_of_type_JavaLangString);
        Object localObject = new File(localbfkd.f);
        ...
        for (;;)
        {
          ...
          if (!bool2)
          {
            localObject = localbfkd.f + ".1";
            File localFile2 = new File((String)localObject);
            localbfkd.jdField_a_of_type_Int = 3;
            localbfkd.g = ((String)localObject);
            bool2 = a(localFile1, localFile2);
            if (QLog.isColorLevel()) {
              QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] copied failed, renamed to: %s", new Object[] { localbfkd.g }));
            }
            bool1 = bool2;
            if (bool2)
            {
              this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putString(localbfkd.f, localbfkd.g).commit();
              bool1 = bool2;
            }
          }
          if (!bool1) {
          ...
          if (QLog.isColorLevel()) {
            QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] success copied: %s", new Object[] { localbfkd.f }));
          }
          parambfke.jdField_b_of_type_JavaUtilList.add(localbfkd);
          parambfke.g += 1L;
        }
        label376:
        a("0X80078B2", (int)localbfkd.jdField_b_of_type_Long, localbfkd.jdField_a_of_type_JavaLangString, localbfkd.jdField_b_of_type_JavaLangString);
        if (QLog.isColorLevel()) {
          QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] failed copied: %s", new Object[] { localbfkd.f }));
        }
      }
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] update %d files of %d", new Object[] { Long.valueOf(parambfke.g), Integer.valueOf(parambfke.jdField_c_of_type_JavaUtilList.size()) }));
      }
      if (parambfke.g == parambfke.jdField_c_of_type_JavaUtilList.size()) {
        bool1 = true;
      }
    }
    for (;;)
  ...
  private boolean g(bfke parambfke)
  {
    boolean bool;
    if (parambfke != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] unzip package: sid=%d", new Object[] { Long.valueOf(parambfke.jdField_a_of_type_Long) }));
      }
      String str = a(parambfke);
      File localFile = new File(str);
      if (!localFile.exists()) {
  ...
  private boolean h(bfke parambfke)
  {
    boolean bool = false;
    if (parambfke != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] download package: sid=%d", new Object[] { Long.valueOf(parambfke.jdField_a_of_type_Long) }));
      }
      bool = a(new bfkb(2, 0, a(parambfke), parambfke.jdField_a_of_type_JavaLangString, parambfke.jdField_c_of_type_JavaLangString, parambfke.jdField_b_of_type_JavaLangString, 0, true, 0, new Date().getTime(), parambfke.jdField_b_of_type_Int));
    }
    return bool;
  }
  
  private boolean i(bfke parambfke)
  {
    boolean bool2 = false;
    boolean bool1 = bool2;
    if (parambfke != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] get different: sid=%d", new Object[] { Long.valueOf(parambfke.jdField_a_of_type_Long) }));
      }
      List localList = parambfke.jdField_a_of_type_JavaUtilList;
      int i = 0;
      if (i < localList.size())
      {
        bfkd localbfkd = (bfkd)localList.get(i);
        if (!new File(localbfkd.f).exists())
        {
          localbfkd.jdField_a_of_type_Int = 2;
          parambfke.jdField_c_of_type_JavaUtilList.add(localbfkd);
        }
        String str;
        do
        {
          i += 1;
          break;
          str = bfjx.a(localbfkd.f);
        } while ((str != null) && (str.equalsIgnoreCase(localbfkd.jdField_b_of_type_JavaLangString)));
        localbfkd.jdField_a_of_type_Int = 1;
        if (str != null) {}
        for (;;)
        {
          localbfkd.jdField_c_of_type_JavaLangString = str;
          parambfke.jdField_c_of_type_JavaUtilList.add(localbfkd);
          parambfke.f += 1L;
          break;
          str = "";
      ...
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] need to update %d files of %d", new Object[] { Integer.valueOf(parambfke.jdField_c_of_type_JavaUtilList.size()), Integer.valueOf(parambfke.jdField_a_of_type_JavaUtilList.size()) }));
      }
      bool1 = bool2;
      if (!parambfke.jdField_c_of_type_JavaUtilList.isEmpty()) {
        bool1 = true;
      ...
      try
      {
        ...
        if (localUpdateQueryResponse != null)
        {
          ...
          if ((i1 == 0) && (k == 1))
          {
            ...
            bool1 = a(new bfkb(1, k, a(), "qp_sfu_config.dat", paramFromServiceMsg, paramToServiceMsg, m, bool1, 0, new Date().getTime(), 1));
          }
        }
        else
        {
        ...
        if (i1 == 1)
        {
          ...
          bool1 = bool2;
          if (!this.jdField_a_of_type_Bfjz.a(paramToServiceMsg.toString())) {
            continue;
          }
          if (this.jdField_a_of_type_Bfjz.a().isEmpty()) {
            d(16);
  ...
  {
    if (this.jdField_a_of_type_AndroidOsHandler != null) {
      this.jdField_a_of_type_AndroidOsHandler.obtainMessage(1052688, paramaysx).sendToTarget();
    }
  }
  
  public void onUpdateProgeress(aysw paramaysw, long paramLong1, long paramLong2)
  {
    this.jdField_a_of_type_AndroidOsHandler.obtainMessage(1052689, (int)paramLong1, (int)paramLong2, paramaysw).sendToTarget();
  }
}
