  ...
  extends unk<vcm>
{
  ...
  public vah(String paramString, List<String> paramList, List<Long> paramList1, List<Integer> paramList2, int paramInt)
  {
  ...
  public String a()
  {
    return ume.a("StoryGroupSvc.add_video");
  }
  ...
  public unf a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return new vcm(localRspAddGroupVideo);
    }
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      for (;;)
      {
        wsv.b("AddGroupVideoRequest", "decodeResponse", paramArrayOfByte);
      }
    }
  }
