...
public class azmk
{
  ...
  static
  {
    ...
    for (;;)
    {
      if (i < azmf.jdField_b_of_type_ArrayOfJavaLangString.length)
      {
        if (TextUtils.equals("2920", azmf.jdField_b_of_type_ArrayOfJavaLangString[i])) {
      ...
      {
        g = 0;
        e = aepi.a(22.0F, BaseApplicationImpl.getApplication().getApplicationContext().getResources());
        f = aepi.a(40.0F, BaseApplicationImpl.getApplication().getApplicationContext().getResources());
        return;
      }
      i += 1;
    }
  ...
  {
    int i = 0;
    while (i < azmf.jdField_b_of_type_ArrayOfJavaLangString.length)
    {
      if (TextUtils.equals(paramString, azmf.jdField_b_of_type_ArrayOfJavaLangString[i])) {
        return i;
      }
      i += 1;
    }
      ...
      if (true == jdField_a_of_type_Boolean)
      {
        ...
        for (;;)
        {
          ...
          if ((ImmersiveUtils.isSupporImmersive() != 0) && (paramImmersiveTitleBar2 != null)) {
            paramImmersiveTitleBar2.setBackgroundColor(BaseApplicationImpl.getApplication().getResources().getColor(2131166959));
          }
        }
      }
      ...
      if (true == jdField_a_of_type_Boolean)
      {
        ...
        for (;;)
        {
          ...
          if ((ImmersiveUtils.isSupporImmersive() != 0) && (paramSystemBarCompact != null)) {
            paramSystemBarCompact.setStatusBarColor(2131166959);
          }
        }
      }
  ...
  private static final void a(String paramString)
  {
    ...
    {
      localObject = (azmg)((QQAppInterface)localObject).a(154);
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      ((azmg)localObject).a(bool, i);
      ((azmg)localObject).notifyUI(4, true, new Object[] { Boolean.valueOf(bool), Integer.valueOf(i), paramString });
  ...
  {
    if ((paramInt < 0) || (paramInt >= azmf.jdField_b_of_type_ArrayOfJavaLangString.length))
    {
      if (QLog.isColorLevel()) {
  ...
  public static final int c()
  {
    ...
    for (;;)
    {
      ...
      return i;
      i = azmf.jdField_b_of_type_ArrayOfInt[i];
    }
  }
  ...
  public static int d()
  {
    ...
    for (;;)
    {
      ...
      return i;
      label155:
      i = azmf.jdField_b_of_type_ArrayOfInt[k];
    }
  }
