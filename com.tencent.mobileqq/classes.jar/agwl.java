...
public class agwl
{
  private static agwl jdField_a_of_type_Agwl;
  ...
  private bbwf jdField_a_of_type_Bbwf = new agwm(this);
  bbwi jdField_a_of_type_Bbwi;
  bbwl jdField_a_of_type_Bbwl;
  private Map<String, List<agwp>> jdField_a_of_type_JavaUtilMap = Collections.synchronizedMap(new HashMap(6));
  
  public static agwl a()
  {
    if (jdField_a_of_type_Agwl == null) {}
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      if (jdField_a_of_type_Agwl == null) {
        jdField_a_of_type_Agwl = new agwl();
      }
      return jdField_a_of_type_Agwl;
    }
  }
  ...
  private Bitmap a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    //   228: astore 6
    //   230: aload_0
    //   231: getfield 36	agwl:jdField_a_of_type_AndroidSupportV4UtilMQLruCache	Landroid/support/v4/util/MQLruCache;
    //   234: ifnull -206 -> 28
    //   237: aload_2
    //   238: astore 6
    //   240: aload_2
    //   241: ifnull -213 -> 28
    //   244: aload_0
    //   245: getfield 36	agwl:jdField_a_of_type_AndroidSupportV4UtilMQLruCache	Landroid/support/v4/util/MQLruCache;
    //   248: aload_3
    //   249: aload_2
  ...
  {
    return ahje.a + paramAppInterface.getCurrentAccountUin() + "/preload/";
  }
  
  private void a(AppInterface paramAppInterface, String paramString1, String paramString2, List<agwp> paramList)
  {
    int j = 0;
    ...
    if ((!TextUtils.isEmpty(paramString2)) && (new File(paramString2).exists()))
    {
      ...
      paramAppInterface = (agwp)paramList.get(j);
  ...
  private void a(AppInterface paramAppInterface, String paramString, List<agwp> paramList)
  {
    ...
    paramAppInterface = QWalletPicHelper.getDrawableForWallet(PreloadManager.e(paramString), BaseApplicationImpl.getApplication().getApplicationContext().getResources().getDrawable(2130842922));
    int i = 0;
    if (i < paramList.size())
    {
      agwp localagwp = (agwp)paramList.get(i);
      if (localagwp == null) {}
      for (;;)
      {
        i += 1;
  ...
  {
    return ahje.c + paramAppInterface.getCurrentAccountUin() + "/preload/";
  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Bbwl != null) {
      this.jdField_a_of_type_Bbwl.a(true, null);
    }
  }
  
  public void a(AppInterface paramAppInterface, String paramString, agwp paramagwp)
  {
    a(paramAppInterface, paramString, ".png", paramagwp);
  }
  
  public void a(AppInterface paramAppInterface, String paramString1, String paramString2, agwp paramagwp)
  {
    ...
    do
    {
      ...
      ((List)this.jdField_a_of_type_JavaUtilMap.get(paramString2)).add(paramagwp);
    } while (!QLog.isColorLevel());
    ...
    ((List)this.jdField_a_of_type_JavaUtilMap.get(paramString2)).add(paramagwp);
    ((PreloadManager)paramAppInterface.getManager(151)).c(paramString2, new agwn(this, paramAppInterface));
  }
  ...
  public void b(AppInterface paramAppInterface, Set<String> paramSet)
  {
    ...
    if ((paramSet != null) && (!paramSet.isEmpty()))
    {
      ...
      {
        this.jdField_a_of_type_Bbwi = new bbwi(paramAppInterface);
    ...
    for (String str1 = str3;; str1 = str2)
    {
      ...
      ThreadManager.post(new PreloadImgManager.3(this, paramSet, str2, str3, paramAppInterface, localArrayList, str1, localHashMap, localBundle), 8, new agwo(this, localArrayList, localHashMap, localBundle), true);
      return;
    }
  }
}
