  ...
  implements arae<String>
{
  ...
  public static oee a()
  {
    oee localoee = new oee();
    localoee.jdField_a_of_type_JavaLangString = tyi.jdField_d_of_type_JavaLangString;
    localoee.jdField_b_of_type_JavaLangString = tyi.jdField_e_of_type_JavaLangString;
    localoee.jdField_b_of_type_Boolean = tyi.jdField_a_of_type_Boolean;
    localoee.jdField_c_of_type_Boolean = tyi.p;
    localoee.jdField_a_of_type_Boolean = tyi.jdField_b_of_type_Boolean;
    localoee.jdField_d_of_type_Boolean = tyi.jdField_e_of_type_Boolean;
    localoee.jdField_e_of_type_Boolean = tyi.jdField_f_of_type_Boolean;
    localoee.jdField_f_of_type_Boolean = tyi.jdField_g_of_type_Boolean;
    localoee.jdField_g_of_type_Boolean = tyi.jdField_h_of_type_Boolean;
    localoee.jdField_h_of_type_Boolean = tyi.jdField_i_of_type_Boolean;
    localoee.jdField_i_of_type_Boolean = tyi.l;
    localoee.j = tyi.j;
    localoee.jdField_c_of_type_JavaLangString = tyi.jdField_f_of_type_JavaLangString;
    localoee.jdField_a_of_type_Long = tyi.jdField_a_of_type_Long;
    localoee.k = tyi.m;
    localoee.jdField_a_of_type_Int = tyi.jdField_b_of_type_Int;
    localoee.jdField_d_of_type_JavaLangString = tyi.jdField_i_of_type_JavaLangString;
    localoee.l = tyi.n;
    localoee.m = tyi.jdField_c_of_type_Boolean;
    localoee.n = tyi.o;
    localoee.jdField_a_of_type_JavaUtilArrayList = tyi.jdField_a_of_type_JavaUtilArrayList;
    localoee.jdField_b_of_type_Int = tyi.jdField_c_of_type_Int;
    localoee.jdField_c_of_type_Int = tyi.jdField_d_of_type_Int;
    localoee.jdField_d_of_type_Int = tyi.jdField_e_of_type_Int;
    localoee.o = tyi.k;
    Object localObject = tyi.jdField_g_of_type_JavaLangString;
    localoee.jdField_e_of_type_JavaLangString = ((String)localObject);
    localoee.jdField_f_of_type_JavaLangString = tyi.jdField_h_of_type_JavaLangString;
    try
    {
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        if (((JSONObject)localObject).has("useNewLogic")) {
          b(localoee, (JSONObject)localObject);
        }
        if (((JSONObject)localObject).has("releaseServiceMinMem")) {
          a(localoee, (JSONObject)localObject);
        }
      }
      return localoee;
    }
  ...
  private oee a(oee paramoee, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramString.has("service_folder_name")) {
          this.jdField_a_of_type_JavaLangString = paramoee.jdField_a_of_type_JavaLangString;
        }
        if (paramString.has("service_folder_icon")) {
          this.jdField_b_of_type_JavaLangString = paramoee.jdField_b_of_type_JavaLangString;
        }
        if (paramString.has("service_folder_redspots")) {
          this.jdField_a_of_type_Boolean = paramoee.jdField_a_of_type_Boolean;
        }
        if (paramString.has("service_folder_delete")) {
          this.jdField_b_of_type_Boolean = paramoee.jdField_b_of_type_Boolean;
        }
        if (paramString.has("ServiceFolder_RedClean_After_Enter")) {
          this.jdField_c_of_type_Boolean = paramoee.jdField_c_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload")) {
          this.jdField_d_of_type_Boolean = paramoee.jdField_d_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload_wifi")) {
          this.jdField_e_of_type_Boolean = paramoee.jdField_e_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload_4G")) {
          this.jdField_f_of_type_Boolean = paramoee.jdField_f_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload_3G")) {
          this.jdField_g_of_type_Boolean = paramoee.jdField_g_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload_2G")) {
          this.jdField_h_of_type_Boolean = paramoee.jdField_h_of_type_Boolean;
        }
        if (paramString.has("pub_account_bottom_bar")) {
          this.jdField_i_of_type_Boolean = paramoee.jdField_i_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_image_preload")) {
          this.j = paramoee.j;
        }
        if (paramString.has("kandian_feeds_fling_LToR_host")) {
          this.jdField_c_of_type_JavaLangString = paramoee.jdField_c_of_type_JavaLangString;
        }
        if (paramString.has("kandian_ad_background_showtime")) {
          this.jdField_a_of_type_Long = paramoee.jdField_a_of_type_Long;
        }
        ...
        {
          this.jdField_a_of_type_Int = paramoee.jdField_a_of_type_Int;
          this.jdField_d_of_type_JavaLangString = paramoee.jdField_d_of_type_JavaLangString;
        }
        ...
        if ((i1 != 0) && (paramString.has("host_white_list"))) {
          this.jdField_a_of_type_JavaUtilArrayList = paramoee.jdField_a_of_type_JavaUtilArrayList;
        }
        if (paramString.has("album_predown_enable")) {
          this.jdField_b_of_type_Int = paramoee.jdField_b_of_type_Int;
        }
        if (paramString.has("album_predown_photo_rule")) {
          this.jdField_c_of_type_Int = paramoee.jdField_c_of_type_Int;
        }
        if (paramString.has("album_predown_slide_photocounts")) {
          this.jdField_d_of_type_Int = paramoee.jdField_d_of_type_Int;
        }
        ...
        {
          this.jdField_e_of_type_JavaLangString = paramoee.jdField_e_of_type_JavaLangString;
          this.p = paramoee.p;
          this.jdField_e_of_type_Int = paramoee.jdField_e_of_type_Int;
          this.jdField_f_of_type_Int = paramoee.jdField_f_of_type_Int;
          this.jdField_g_of_type_Int = paramoee.jdField_g_of_type_Int;
          this.jdField_h_of_type_Int = paramoee.jdField_h_of_type_Int;
        }
        if (paramString.has("releaseServiceMinMem"))
        {
          this.jdField_f_of_type_JavaLangString = paramoee.jdField_f_of_type_JavaLangString;
          this.jdField_i_of_type_Int = paramoee.jdField_i_of_type_Int;
          return this;
        }
      }
      catch (JSONException paramoee)
      {
        paramoee.printStackTrace();
      }
    }
    return this;
  }
  
  public static oee a(araj[] paramArrayOfaraj)
  {
    Object localObject1 = new oee();
    ...
    if (paramArrayOfaraj != null)
    {
      ...
      if (paramArrayOfaraj.length > 0)
      {
        ...
        for (;;)
        {
          if (i1 >= paramArrayOfaraj.length) {
            break label94;
          }
          str = paramArrayOfaraj[i1].jdField_a_of_type_JavaLangString;
          try
          {
            localObject2 = ((oee)localObject1).a((oee)arax.a(str, oee.class), str);
  ...
  private static void a(oee paramoee, JSONObject paramJSONObject)
  {
    paramoee.jdField_i_of_type_Int = paramJSONObject.optInt("releaseServiceMinMem", 80);
  }
  ...
  private static void b(oee paramoee, JSONObject paramJSONObject)
  {
    paramoee.p = paramJSONObject.optBoolean("useNewLogic", false);
    paramoee.jdField_e_of_type_Int = paramJSONObject.optInt("minTotalMem", 1024);
    paramoee.jdField_f_of_type_Int = paramJSONObject.optInt("minAvailableMem", 100);
    paramoee.jdField_g_of_type_Int = paramJSONObject.optInt("minCpuNum", 2);
    paramoee.jdField_h_of_type_Int = paramJSONObject.optInt("minCpuFreq", 1000);
  }
  ...
  public void b()
  {
    tyi.jdField_d_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
    tyi.jdField_e_of_type_JavaLangString = this.jdField_b_of_type_JavaLangString;
    tyi.jdField_a_of_type_Boolean = this.jdField_b_of_type_Boolean;
    tyi.p = this.jdField_c_of_type_Boolean;
    tyi.jdField_b_of_type_Boolean = this.jdField_a_of_type_Boolean;
    tyi.jdField_e_of_type_Boolean = this.jdField_d_of_type_Boolean;
    tyi.jdField_f_of_type_Boolean = this.jdField_e_of_type_Boolean;
    tyi.jdField_g_of_type_Boolean = this.jdField_f_of_type_Boolean;
    tyi.jdField_h_of_type_Boolean = this.jdField_g_of_type_Boolean;
    tyi.jdField_i_of_type_Boolean = this.jdField_h_of_type_Boolean;
    tyi.l = this.jdField_i_of_type_Boolean;
    tyi.j = this.j;
    tyi.jdField_f_of_type_JavaLangString = this.jdField_c_of_type_JavaLangString;
    tyi.jdField_a_of_type_Long = this.jdField_a_of_type_Long;
    tyi.m = this.k;
    tyi.jdField_b_of_type_Int = this.jdField_a_of_type_Int;
    tyi.jdField_i_of_type_JavaLangString = this.jdField_d_of_type_JavaLangString;
    tyi.n = this.l;
    tyi.jdField_c_of_type_Boolean = this.m;
    tyi.o = this.n;
    tyi.jdField_a_of_type_JavaUtilArrayList = this.jdField_a_of_type_JavaUtilArrayList;
    tyi.jdField_c_of_type_Int = this.jdField_b_of_type_Int;
    tyi.jdField_d_of_type_Int = this.jdField_c_of_type_Int;
    tyi.jdField_e_of_type_Int = this.jdField_d_of_type_Int;
    tyi.k = this.o;
    tyi.jdField_g_of_type_JavaLangString = this.jdField_e_of_type_JavaLangString;
    tyi.jdField_h_of_type_JavaLangString = this.jdField_f_of_type_JavaLangString;
  }
  ...
  public void c()
  {
    ...
    if ((localAppRuntime instanceof QQAppInterface)) {
      tyi.b((QQAppInterface)localAppRuntime);
    }
  }
}
