...
public class bmri
{
  public static int a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    if (ShortVideoTrimmer.a(paramContext, 0, 0))
    {
      ...
      {
        i = j;
        if (((bcmd)localObject).jdField_a_of_type_Boolean)
        {
          ...
          localObject = new bmrj(paramString2, (int)(((bcmd)localObject).b * 1024L), (int)((bcmd)localObject).jdField_a_of_type_Long);
          if ((!new bcms().a(localFile, (bcmt)localObject, true)) || (((bmrj)localObject).a != null)) {
            break label339;
          }
          if (QLog.isColorLevel()) {
  ...
  public static int a(JSONObject paramJSONObject, String paramString1, String paramString2)
  {
    ...
    //   307: astore_1
    //   308: new 266	java/io/BufferedReader
    //   311: dup
    //   312: new 268	java/io/InputStreamReader
    //   315: dup
    //   316: aload_0
    //   317: invokevirtual 272	java/net/HttpURLConnection:getInputStream	()Ljava/io/InputStream;
    //   320: invokespecial 273	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   323: invokespecial 276	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   326: astore 4
    //   328: aload 4
    //   330: invokevirtual 279	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   333: astore 5
    //   335: aload 5
    //   337: ifnull +129 -> 466
    //   340: aload_1
    ...
    //   194	461	3	i	int
    //   7	322	4	localBufferedReader	java.io.BufferedReader
  ...
  public static String a(String paramString)
  {
    ...
    //   1: astore 5
    //   3: aload_0
    //   4: invokestatic 293	bmri:b	(Ljava/lang/String;)Ljava/lang/String;
    //   7: astore 6
  ...
  private static JSONObject a(AppRuntime paramAppRuntime, String paramString, Bundle paramBundle1, Bundle paramBundle2)
  {
    try
    {
      paramString = nlu.a(paramAppRuntime.getApplication().getApplicationContext(), paramString, paramBundle1, paramBundle2);
  ...
  public static JSONObject a(AppRuntime paramAppRuntime, String paramString1, String paramString2, String paramString3)
  {
    ...
    for (localObject = ((TicketManager)localObject).getSkey(paramAppRuntime.getAccount());; localObject = null)
    {
      ...
      localBundle.putString("bkn", String.valueOf(bfup.b((String)localObject)));
  ...
  public static String b(String paramString)
  {
    ...
    for (;;)
    {
      return bhgg.a(((StringBuilder)localObject).toString());
  ...
  private static JSONObject b(AppRuntime paramAppRuntime, String paramString, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    try
    {
      String str = nlw.a(paramAppRuntime.getApplication().getApplicationContext(), paramString, "GET", paramBundle1, paramBundle2);
