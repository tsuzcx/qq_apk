...
public class bmri
{
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, Activity paramActivity, int paramInt, List<ChatMessage> paramList, MqqHandler paramMqqHandler)
  {
    ...
    bmqx.a(localChatMessage.frienduin, localChatMessage.senderuin, localChatMessage.istroop);
    int i = 0;
    if (i < paramList.size())
    {
      ...
      for (;;)
      {
        ...
        else if (aooh.b(localChatMessage)) {
    ...
    if (((ArrayList)localObject2).size() > 0)
    {
      ...
      paramList = bgke.a(paramQQAppInterface, (MessageForTroopFile)paramList);
      if ((paramList == null) || (paramList.e == null)) {
        return false;
      }
      bgke.a(paramActivity, paramQQAppInterface, (List)localObject2);
    }
    boolean bool = false;
    if (((ArrayList)localObject1).size() > 0)
    {
      ...
      for (i = 0; paramList.hasNext(); i = j)
      {
        ...
        localObject2 = auea.a(paramQQAppInterface, (MessageForFile)localObject1);
        ...
        {
          j = i;
          if (aucx.a((FileManagerEntity)localObject2).a(false)) {
            j = 1;
          }
        }
      ...
      if (i != 0) {
        audn.a(BaseActivity.sTopActivity, 2131692476, 2131692481, new bmrj(paramActivity, paramQQAppInterface, localArrayList1, localArrayList2, localArrayList3, paramMqqHandler, paramInt));
      }
    }
    while (bool)
    {
      QQToast.a(paramQQAppInterface.getApp(), 2131692595, 0).b(paramInt);
      return true;
      paramActivity = paramActivity.iterator();
      for (bool = false; paramActivity.hasNext(); bool = auea.a(paramQQAppInterface, (MessageForFile)paramActivity.next(), BaseActivity.sTopActivity, true)) {}
      bool |= a(paramQQAppInterface, localArrayList1, localArrayList2, localArrayList3, paramMqqHandler, paramInt);
      continue;
      bool = a(paramQQAppInterface, localArrayList1, localArrayList2, localArrayList3, paramMqqHandler, paramInt);
    }
    QQToast.a(paramQQAppInterface.getApp(), 2131692647, 0).b(paramInt);
    return false;
  }
  ...
  {
    bdla.b(paramQQAppInterface, "CliOper", "", "", "0X80067F8", "0X80067F8", 0, 0, "", "", "", "");
    if (!NetworkUtil.isNetSupport(paramActivity))
    {
      QQToast.a(paramQQAppInterface.getApp(), 2131692125, 0).b(paramInt);
      return false;
    }
    List localList = axio.a().a();
    if (localList.size() == 0)
    {
      QQToast.a(paramQQAppInterface.getApp(), 2131698181, 0).b(paramInt);
      return false;
    }
    if (localList.size() == 1) {
    ...
    if (((paramArrayList != null) && (paramArrayList.size() > 0)) || ((paramArrayList1 != null) && (paramArrayList1.size() > 0)) || ((paramArrayList2 != null) && (paramArrayList2.size() > 0)))
    {
      ...
      if ((paramArrayList2 != null) && (paramArrayList2.size() > 0))
      {
        ...
        if (paramArrayList2.hasNext())
        {
          ...
          for (;;)
          {
            ...
            if (!bdnv.class.isInstance(localObject1)) {
              break;
            }
            localObject1 = ((bdnv)localObject1).a.iterator();
            while (((Iterator)localObject1).hasNext())
            {
              Object localObject2 = (bdnu)((Iterator)localObject1).next();
              if (bdqa.class.isInstance(localObject2))
              {
                localObject2 = (bdqa)localObject2;
                if ((!a(((bdqa)localObject2).a)) && (!aioi.a(((bdqa)localObject2).a))) {
                  localArrayList.add(((bdqa)localObject2).a);
                }
              }
            }
          }
      ...
      if ((paramArrayList != null) && (paramArrayList.size() > 0))
      {
        ...
        while (paramArrayList.hasNext())
        {
          ...
          if ((!a(paramArrayList2)) && (!aioi.a(paramArrayList2))) {
      ...
      paramQQAppInterface.getFileManagerEngine().a().a(localArrayList, paramArrayList1, new bmrm(paramMqqHandler, paramQQAppInterface.getApp(), paramQQAppInterface, paramInt));
      return true;
    }
    return false;
  }
  ...
  {
    return (anwf.a(paramChatMessage)) || (anud.a(paramChatMessage));
  }
  ...
  public static boolean b(QQAppInterface paramQQAppInterface, Activity paramActivity, int paramInt, List<ChatMessage> paramList, MqqHandler paramMqqHandler)
  {
    ...
    bmqx.a(paramList.frienduin, paramList.senderuin, paramList.istroop);
    if ((paramList instanceof MessageForTroopFile)) {
      bgke.b(paramActivity, paramQQAppInterface, paramList);
    }
    for (;;)
    {
      return true;
      ...
      {
        paramActivity = auea.a(paramQQAppInterface, (MessageForFile)paramList);
        ...
        if (aucx.a((MessageForFile)paramList).a(false))
        {
          if (bixr.a(BaseActivity.sTopActivity, 5, new bmrk(paramQQAppInterface, paramList))) {
            audn.a(BaseActivity.sTopActivity, 2131692476, 2131692479, new bmrl(paramQQAppInterface, paramList));
          }
        }
        else {
          auea.a(paramQQAppInterface, paramList, BaseActivity.sTopActivity);
        }
      }
      else if (((paramList instanceof MessageForPic)) || ((paramList instanceof MessageForShortVideo)))
      {
        ...
        paramQQAppInterface.getFileManagerEngine().a().a(paramList, new bmrm(paramMqqHandler, paramActivity, paramQQAppInterface, paramInt));
      ...
      else
      {
        ...
        {
          Object localObject1 = (bdnu)paramList.next();
          if (bdnv.class.isInstance(localObject1))
          {
            localObject1 = ((bdnv)localObject1).a.iterator();
            while (((Iterator)localObject1).hasNext())
            {
              ...
              {
                localObject2 = (bdqa)localObject2;
                if (!a(((bdqa)localObject2).a)) {
                  paramActivity.add(((bdqa)localObject2).a);
                }
              }
            }
          }
