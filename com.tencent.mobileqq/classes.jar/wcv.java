  ...
  implements View.OnClickListener, OnLongClickAndTouchListener, BubblePopupWindow.OnDismissListener
{
  ...
  private wcv(ChatHistoryBubbleListAdapter paramChatHistoryBubbleListAdapter) {}
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    if (((ChatItemBuilder.BaseHolder)localObject1).jdField_a_of_type_ComTencentMobileqqDataChatMessage.msgtype == -1000) {
      ((QQCustomMenu)localObject2).a(2131375342, "复制", 2130838301);
    }
    ((QQCustomMenu)localObject2).a(2131375336, this.jdField_a_of_type_ComTencentMobileqqActivityChathistoryChatHistoryBubbleListAdapter.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131433621), 2130838305);
      ...
      do
      {
        ...
        if ((localObject2 instanceof StructingMsgItemBuilder.StructingMsgViewHolder))
        {
          ...
          else
          {
            ...
            ((StructingMsgItemBuilder.StructingMsgViewHolder)localObject3).jdField_a_of_type_AndroidViewView.setBackgroundResource(2130845658);
          }
          for (;;)
          {
            ...
            break label383;
            break;
            ((StructingMsgItemBuilder.StructingMsgViewHolder)localObject3).jdField_a_of_type_AndroidViewView.setBackgroundResource(2130845494);
            continue;
