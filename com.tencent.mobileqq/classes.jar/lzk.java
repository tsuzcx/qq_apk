...
public class lzk
{
  ...
  public void a(Context paramContext, LayoutInflater paramLayoutInflater, lzl paramlzl)
  {
    ...
    this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenRelativeLayout.setFloatListener(paramlzl);
    this.jdField_a_of_type_Lzq = new lzq(paramContext, this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenRelativeLayout);
    ...
    a(this.jdField_a_of_type_Lzq.a());
  }
  ...
  public void a(boolean paramBoolean, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      if (!this.jdField_a_of_type_Lzq.b()) {
        this.jdField_a_of_type_Lzq.a();
      }
      if (!bool)
      {
