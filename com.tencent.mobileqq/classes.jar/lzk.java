  ...
  extends lgg
{
  ...
  protected void a(long paramLong)
  {
    ...
    if (this.a.jdField_a_of_type_Lzm != null) {
      this.a.jdField_a_of_type_Lzm.v();
    }
    Object localObject;
    boolean bool2;
    if (this.a.jdField_a_of_type_ComTencentAvVideoController.a().jdField_d_of_type_Int == 2)
    {
      ...
      bool1 = true;
      ((lga)localObject).a(paramLong, bool1);
      if (this.a.jdField_c_of_type_Boolean) {
    ...
    {
      this.a.jdField_a_of_type_Lzm.a((String)localObject, 1, bool2, false, bool1);
  ...
  protected void a(long paramLong, int paramInt)
  {
    ...
    {
      this.a.jdField_a_of_type_Mcf.update(null, new Object[] { Integer.valueOf(106), Long.valueOf(paramLong) });
  ...
  protected void a(long paramLong, int paramInt, String paramString)
  {
    ...
    {
      this.a.jdField_a_of_type_Lzm.a(paramString, 1, false, false, bool);
      this.a.jdField_a_of_type_Lzm.a(false, false);
      this.a.jdField_a_of_type_Lzm.s_();
      if (this.a.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI == null) {
        break;
      }
  ...
  protected void a(RecvMsg paramRecvMsg)
  {
    ...
    if ((this.a.jdField_a_of_type_Lzm != null) && (this.a.jdField_a_of_type_ComTencentAvVideoController != null)) {
      this.a.jdField_a_of_type_Lzm.a(0, 0, true);
    }
  }
  ...
  protected void b(long paramLong)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      this.a.jdField_a_of_type_Lzm.a(str, 1, true, false, bool);
      this.a.jdField_a_of_type_Lzm.a(this.a.jdField_a_of_type_ComTencentAvVideoController.a().jdField_d_of_type_JavaLangString, 1, this.a.jdField_a_of_type_AndroidGraphicsBitmap, true, false);
      return;
    }
  }
  ...
  protected void b(String paramString, boolean paramBoolean)
  {
    ...
    if ((this.a.jdField_c_of_type_Int == 1) || (this.a.jdField_c_of_type_Int == 2))
    {
      ...
      if (this.a.jdField_a_of_type_Lzm != null)
      {
        paramString = bbkb.a(this.a.jdField_a_of_type_AndroidContentContext).edit();
        paramString.putInt("video_position", this.a.jdField_a_of_type_Lzm.g());
        paramString.commit();
      }
    }
  }
  ...
  protected void b(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    lzh.a(localSmallScreenRelativeLayout);
  }
  ...
  protected void c()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      this.a.jdField_a_of_type_Lzm.a(str, 1, false, false, bool);
  ...
  protected void c(int paramInt)
  {
    ...
    int i = bbzh.a();
    Object localObject = bbzh.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, paramInt, i, null);
    if (localObject == null) {}
    do
    {
      return;
      localObject = new File((String)localObject);
      if ((localObject != null) && (((File)localObject).exists()) && (this.a.jdField_a_of_type_ComTencentAvVideoController.a().g != 4) && (this.a.jdField_c_of_type_Int == 1) && (this.a.jdField_a_of_type_Lzm != null)) {
        this.a.jdField_a_of_type_Lzm.w();
      }
  ...
  protected void c(String paramString, boolean paramBoolean)
  {
    ...
    ZimuToolbar.sendSupportionToPeer(this.a.jdField_a_of_type_ComTencentAvVideoController);
    if ((this.a.jdField_a_of_type_Lzm != null) && (this.a.jdField_a_of_type_ComTencentAvVideoController.a().k))
    {
    ...
    {
      this.a.jdField_a_of_type_Lzm.a(paramString, paramBoolean);
      min.a(this.a.jdField_a_of_type_ComTencentAvVideoController);
      return;
    }
  }
  ...
  public void f(String paramString)
  {
    ...
    if (this.a.jdField_a_of_type_Lzm != null)
    {
      this.a.jdField_a_of_type_Lzm.a(true, false);
      this.a.jdField_a_of_type_Lzm.c(l, this.a.jdField_a_of_type_ComTencentAvCameraCameraUtils.a());
    }
  }
