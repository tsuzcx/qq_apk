...
public class blhc
{
  ...
  private blhc(Context paramContext)
  {
  ...
  public blhb a()
  {
    try
    {
      ...
      for (localObject = new KandianTextView(this.jdField_a_of_type_AndroidContentContext);; localObject = new TextView(this.jdField_a_of_type_AndroidContentContext))
      {
        ...
        localObject = new blhb(this.jdField_a_of_type_AndroidContentContext, localLinearLayout.getMeasuredWidth(), this.e);
        ((blhb)localObject).d(this.jdField_b_of_type_Int);
        ((blhb)localObject).a(this.jdField_b_of_type_AndroidGraphicsDrawableDrawable);
        ((blhb)localObject).b(this.jdField_c_of_type_AndroidGraphicsDrawableDrawable);
        ((blhb)localObject).e(this.jdField_c_of_type_Int);
        ((blhb)localObject).setContentView(localLinearLayout);
        ((blhb)localObject).a(83);
        if (!this.jdField_a_of_type_Boolean) {
          ((blhb)localObject).setOutsideTouchable(false);
        }
        ((blhb)localObject).b(DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 6.0F));
        blhb.a((blhb)localObject, this.d);
        return localObject;
      }
      return null;
    }
  ...
  public blhc a(float paramFloat)
  {
    this.jdField_a_of_type_Float = paramFloat;
    return this;
  }
  
  public blhc a(int paramInt)
  {
    this.jdField_a_of_type_Int = paramInt;
    return this;
  }
  
  public blhc a(Drawable paramDrawable)
  {
    this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = paramDrawable;
    return this;
  }
  
  public blhc a(String paramString)
  {
    this.jdField_a_of_type_JavaLangString = paramString;
    return this;
  }
  
  public blhc a(boolean paramBoolean)
  {
    this.jdField_b_of_type_Boolean = paramBoolean;
    return this;
  }
  
  public blhc b(int paramInt)
  {
    this.d = paramInt;
    return this;
  }
  
  public blhc b(Drawable paramDrawable)
  {
    this.jdField_c_of_type_AndroidGraphicsDrawableDrawable = paramDrawable;
    return this;
  }
  
  public blhc c(int paramInt)
  {
    this.e = paramInt;
    return this;
  }
  
  public blhc c(Drawable paramDrawable)
  {
