...
public class oxn
  ...
  implements oxl
{
  private static oxn jdField_a_of_type_Oxn = new oxn();
  ...
  public oxn()
  {
    super(null, null, null, por.a(), null);
  }
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    {
      QLog.d("gifvideo.KandianShortContentGifStrategy", 1, new Object[] { "convertVidToUrl resp result code ", Integer.valueOf(omz.a(paramToServiceMsg, paramFromServiceMsg, paramObject, (MessageMicro)localObject1, bool)) });
      ...
      for (paramFromServiceMsg = paramObject.toString();; paramFromServiceMsg = "null")
      {
        ...
        while (paramObject.hasNext())
        {
          ...
          if (localObject2 != null)
          {
            ...
            localooa.b = ((content_vidurl_svr.UrlInfo)localObject2).vid.get();
            localooa.jdField_a_of_type_JavaLangString = ((content_vidurl_svr.UrlInfo)localObject2).url.get();
            onu.a(localooa);
          }
        }
      ...
      paramToServiceMsg = (oxm)a(Integer.valueOf(((Integer)paramToServiceMsg.getAttribute("vidToUrlSeq")).intValue()));
  ...
  {
    a(new String[] { paramString }, paramoxm);
  }
  
  public void a(String[] paramArrayOfString, oxm paramoxm)
  {
    if ((paramArrayOfString != null) && (paramArrayOfString.length > 0))
    {
      content_vidurl_svr.GetVid2UrlsReq localGetVid2UrlsReq = new content_vidurl_svr.GetVid2UrlsReq();
      Object localObject = bbdh.c();
      ...
      localObject = oxj.a(BaseApplicationImpl.getContext());
      if (!TextUtils.isEmpty((CharSequence)localObject)) {
      ...
      localObject = pot.a("OidbSvc.0xda2", 3490, 0, ((oidb_cmd0xda2.ReqBody)localObject).toByteArray());
