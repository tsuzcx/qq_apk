  ...
  extends MSFServlet
{
  ...
  private void a(MultiVideoMsg paramMultiVideoMsg)
  {
    ...
    NewIntent localNewIntent = new NewIntent(this.a.getApplication(), ktp.class);
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    paramArrayOfByte = ktk.a(paramArrayOfByte);
    ...
    kyj.a(34);
    mhx.a("VideoServlet", ksn.a(3, String.valueOf(paramArrayOfByte.c), new int[0]), this.a, paramArrayOfByte);
  }
  ...
  void a(int paramInt, Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    Object localObject = locallad;
    if (paramFromServiceMsg.isSuccess())
    {
      localObject = locallad;
      if (i > 0)
      {
    ...
    locallad = this.a.a();
    if (locallad != null) {
      locallad.a(paramInt, paramFromServiceMsg.isSuccess(), paramFromServiceMsg.getResultCode(), paramIntent, (byte[])localObject);
    }
  }
  ...
  void a(SharpVideoMsg paramSharpVideoMsg)
  {
    ...
    if (localFriends != null)
    {
      ...
      localBundle.putString("fromUin", mfy.a(l1));
  ...
  void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    //   30: iconst_4
    //   31: iload_3
    //   32: invokestatic 420	bakz:a	([BI[BII)V
    ...
    //   63: astore_2
    //   64: aload_2
    //   65: invokestatic 532	kwo:a	(Lcom/tencent/av/common$ErrorInfo;)I
    //   68: istore 4
    //   70: aload_2
    ...
    //   187: i2l
    //   188: invokespecial 577	ldv:<init>	(JJ)V
    ...
    //   210: istore 9
    //   212: aload_0
    //   213: getfield 99	ktp:a	Lcom/tencent/av/app/VideoAppInterface;
    //   216: instanceof 101
    //   219: ifeq +170 -> 389
    //   222: aload_0
    //   223: getfield 99	ktp:a	Lcom/tencent/av/app/VideoAppInterface;
    //   226: astore_1
    //   227: iload 9
    //   229: ifne +104 -> 333
    //   232: aload_1
    ...
    //   332: return
    //   333: aload_0
    //   334: getfield 99	ktp:a	Lcom/tencent/av/app/VideoAppInterface;
    //   337: iconst_4
    ...
    //   388: return
    //   389: aload_0
    //   390: getfield 99	ktp:a	Lcom/tencent/av/app/VideoAppInterface;
    //   393: iconst_4
  ...
  void a(String paramString, Packet paramPacket, Bundle paramBundle)
  {
    ...
    if (paramString != null) {
      paramPacket.putSendData(bakc.a(paramString));
    }
  }
  ...
  void b(Packet paramPacket, Bundle paramBundle)
  {
    ...
    paramPacket.putSendData(bakc.a(paramBundle.toByteArray()));
  }
  ...
  public void onCreate()
  {
    ...
    llm.a().jdField_a_of_type_Boolean = true;
    llm.a().jdField_b_of_type_Long = System.currentTimeMillis();
  }
          ...
          for (;;)
          {
            ...
            for (boolean bool = true;; bool = false)
            {
              ...
              if ("SharpSvr.c2s".equalsIgnoreCase(str)) {
                awqx.b(null, "CliOper", "", "", "0X80088B1", "0X80088B1", 0, 0, "", "", "", "");
              }
              if (paramIntent == null) {
                break;
              }
            ...
            if ("SharpSvr.s2c".equalsIgnoreCase(str))
            {
              ...
              if (i != 1013)
              {
                ...
                for (;;)
                {
                  if (!llm.a().jdField_b_of_type_Boolean) {
                    llm.a().a(paramIntent.msg_seq);
                  }
                  llm.a().a("eVideoRecvInviteMsg", 3L, paramIntent.msg_seq, ((Long)paramIntent.to_uin.get(0)).longValue(), paramIntent.from_uin, 0);
                  localObject = paramIntent.msg_seq + "-" + paramIntent.msg_uid;
                  this.a.a(paramIntent.from_uin, (String)localObject, awao.a());
                  if (this.a.c)
                  {
                    this.a.c = false;
                    this.a.d = true;
                  ...
                  try
                  {
                    localObject = ktk.a(paramIntent.video_buff);
                    QLog.w("tagSharpSvr", 1, "<-- onReceive() cmd = " + str + " , msg_type = " + paramIntent.msg_type + ", bodyType = " + ((ktl)localObject).a);
                    c(paramIntent);
            ...
            else
            {
              if ("SharpSvr.c2sack".equalsIgnoreCase(localException))
              {
                ...
                for (;;)
                {
                  ...
                  try
                  {
                    paramFromServiceMsg = ktk.a(paramIntent.video_buff);
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    do
    {
      do
      {
        ...
        return;
        awqx.b(null, "CliOper", "", "", "0X80088B0", "0X80088B0", 0, 0, "", "", "", "");
        if (QLog.isColorLevel()) {
        ...
        try
        {
          paramPacket = ktk.a(paramIntent.video_buff);
        ...
        {
          llm.a().a("eVideoSendACK", ((SharpVideoMsg)localObject3).msg_type, ((SharpVideoMsg)localObject3).msg_seq, ((Long)((SharpVideoMsg)localObject3).to_uin.get(0)).longValue(), ((SharpVideoMsg)localObject3).from_uin, 0);
          llm.a().b();
        }
        if (QLog.isColorLevel()) {
        ...
        try
        {
          localObject1 = ktk.a(((SharpVideoMsg)localObject3).video_buff);
          QLog.w("tagSharpSvr", 1, "--> onSend() cmd = SharpSvr.s2cack , msg_type = " + ((SharpVideoMsg)localObject3).msg_type + ", bodyType = " + ((ktl)localObject1).a);
        ...
        bakz.a((byte[])localObject2, 0, paramIntent.length + 4);
        bakz.a((byte[])localObject2, 4, paramIntent, paramIntent.length);
    ...
    paramPacket.putSendData(bakc.a(((Bundle)localObject2).getByteArray("vMsg")));
    return;
