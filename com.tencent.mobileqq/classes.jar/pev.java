...
public final class pev
{
  ...
  public pev(int paramInt1, int paramInt2, @Nullable Intent paramIntent, @NotNull slt paramslt, @NotNull Activity paramActivity, int paramInt3, @NotNull pdy parampdy)
  {
    ...
    {
      a(2, paramIntent);
      paramslt = Unit.INSTANCE;
      paramIntent = paramActivity;
      paramActivity[0] = TuplesKt.to(Integer.valueOf(9991), paramslt);
      paramslt = this.jdField_a_of_type_AndroidContentIntent;
      if (paramslt == null) {
        break label442;
      }
      a(0, paramslt);
      ...
      label132:
      paramslt = paramIntent;
      paramIntent[1] = TuplesKt.to(Integer.valueOf(9091), paramActivity);
      a();
      paramslt[2] = TuplesKt.to(Integer.valueOf(21), Unit.INSTANCE);
      b();
      paramslt[3] = TuplesKt.to(Integer.valueOf(19202), Unit.INSTANCE);
      b();
      paramslt[4] = TuplesKt.to(Byte.valueOf(125), Unit.INSTANCE);
      paramIntent = this.jdField_a_of_type_AndroidContentIntent;
      if (paramIntent == null) {
        break label448;
      }
      ...
      paramActivity = Unit.INSTANCE;
      label227:
      paramIntent = paramslt;
      paramslt[5] = TuplesKt.to(Integer.valueOf(2), paramActivity);
      paramslt = this.jdField_a_of_type_AndroidContentIntent;
      if (paramslt == null) {
        break label454;
      }
    ...
    label448:
    label454:
    for (paramslt = Unit.INSTANCE;; paramslt = null)
    {
      paramActivity = paramIntent;
      paramIntent[6] = TuplesKt.to(Integer.valueOf(1), paramslt);
      c();
  ...
  {
    this.jdField_a_of_type_Slt.a(paramInt, paramIntent);
  }
  ...
  private final void c()
  {
    ...
    for (Object localObject = ((Bundle)localObject).get("fast_web_article_info");; localObject = null)
    {
      ...
      if (localObject != null) {
        pay.a(this.jdField_a_of_type_AndroidAppActivity, (ArticleInfo)localObject, this.jdField_a_of_type_Slt, this.c);
      }
      return;
    }
  }
  ...
  private final void d()
  {
    ...
    if (localObject != null)
    {
      localObject = ((AppRuntime)localObject).getManager(162);
      if (localObject == null) {
    ...
    if (localObject1 != null) {
      try
      {
        ...
        try
        {
          ...
          odq.a(null, "CliOper", "", "", "0X800982D", "0X800982D", 0, 0, ((JSONObject)localObject1).optString("feedsId") + "", "2", "", ((JSONObject)localObject2).toString(), false);
          return;
        }
  ...
  private final void f()
  {
    ...
    for (Object localObject = ((Intent)localObject).getParcelableExtra("key_ad_info");; localObject = null)
    {
      ...
      if (localObject != null) {
        this.jdField_a_of_type_Slt.a((AdvertisementInfo)localObject);
      }
      return;
    }
  }
  ...
  private final void g()
  {
    ...
    {
      if (localObject != null) {
        this.jdField_a_of_type_Pdy.a(this.b, (ArticleInfo)localObject, this.jdField_a_of_type_AndroidContentIntent);
      }
      return;
    }
  }
