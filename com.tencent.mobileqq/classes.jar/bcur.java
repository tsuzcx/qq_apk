...
public class bcur
{
  ...
  public static Map<Integer, String> a(long paramLong)
  {
    ...
    Map localMap = bcut.a(LocalMultiProcConfig.getString("EXTEND_INFO" + paramLong, ""));
    if (a(paramLong)) {
  ...
  public static void a(mobile_count_rsp_new parammobile_count_rsp_new)
  {
    if ((parammobile_count_rsp_new != null) && (parammobile_count_rsp_new.vec_soft_infos != null) && (parammobile_count_rsp_new.vec_soft_infos.size() != 0))
    {
      ...
      LocalMultiProcConfig.putString("qzone_soft_infos", bhcu.encodeToString(localJceOutputStream.toByteArray(), 0));
    }
  }
  ...
  private static void a(mobile_count_rsp_new parammobile_count_rsp_new, bcvt parambcvt)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
        } while (parambcvt == null);
        if (parammobile_count_rsp_new.iNextTimeout > 0)
        {
          parambcvt.a = (parammobile_count_rsp_new.iNextTimeout * 1000L);
          if (QLog.isColorLevel()) {
            QLog.d("UndealCount.QZoneUnreadServletLogic", 2, "onReceive getFeedInterval:" + parambcvt.a);
          }
        }
      } while (parammobile_count_rsp_new.switchTimeout <= 0);
      parambcvt.b = (parammobile_count_rsp_new.switchTimeout * 1000);
    } while (!QLog.isColorLevel());
    QLog.d("UndealCount.QZoneUnreadServletLogic", 2, "onReceive getActiveAppInterval:" + parambcvt.b);
  }
  ...
  public static void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg, QQAppInterface paramQQAppInterface, bcvt parambcvt)
  {
    ...
    do
    {
      ...
      {
        return;
        paramFromServiceMsg = bcuo.a(paramIntent, paramQQAppInterface, "getUndealCount");
    ...
    awzb localawzb = (awzb)paramQQAppInterface.getManager(QQManagerFactory.QZONE_MANAGER);
    if (localawzb != null) {
      localawzb.b(0);
    }
  ...
  private static void a(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface != null)
    {
      long l = System.currentTimeMillis();
      HashMap localHashMap = new HashMap();
      StatisticCollector.getInstance(paramQQAppInterface.getApp()).collectPerformance(paramQQAppInterface.getCurrentAccountUin(), "actQzoneUnread", true, l - bcvt.c, 0L, localHashMap, "");
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, Long paramLong)
  {
    ...
    do
    {
      ...
      } while ((paramQQAppInterface == null) || (!(paramQQAppInterface instanceof bcvr)));
    ...
    ((bcvr)paramQQAppInterface).a(localHashMap);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, Intent paramIntent, FromServiceMsg paramFromServiceMsg, bcvt parambcvt)
  {
    if (QLog.isColorLevel()) {
      QLog.d("UndealCount.QZoneUnreadServletLogic", 2, "inform QZONE_GET_UNREAD isSuccess false");
    }
    if (parambcvt != null) {
      parambcvt.notifyObserver(null, 1000, false, new Bundle(), ayrb.class);
    }
    if (paramQQAppInterface != null)
    {
      ...
      StatisticCollector.getInstance(paramQQAppInterface.getApp()).collectPerformance(paramQQAppInterface.getCurrentAccountUin(), "actQzoneUnread", false, bcvt.d - bcvt.c, 0L, paramFromServiceMsg, "");
    }
  }
  
  private static void a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, bcvt parambcvt)
  {
    if (QLog.isColorLevel()) {
      QLog.d("UndealCount.QZoneUnreadServletLogic", 2, "inform QZONE_GET_UNREAD isSuccess false");
    }
    ...
    if (paramQQAppInterface != null)
    {
      ...
      parambcvt = new HashMap();
      parambcvt.put("param_FailCode", String.valueOf(9045));
      parambcvt.put("param_errorDesc", paramArrayOfByte);
      StatisticCollector.getInstance(paramQQAppInterface.getApp()).collectPerformance(paramQQAppInterface.getCurrentAccountUin(), "actQzoneUnread", false, bcvt.d - bcvt.c, 0L, parambcvt, "");
    }
  }
  
  public static void a(String paramString) {}
  
  private static void a(String paramString, bcvt parambcvt)
  {
    if (TextUtils.isEmpty(paramString)) {}
    while (parambcvt == null) {
      return;
    ...
    parambcvt.notifyObserver(null, 1003, true, localBundle, ayrb.class);
  }
  ...
  private static void a(byte[] paramArrayOfByte, mobile_count_rsp_new parammobile_count_rsp_new, QQAppInterface paramQQAppInterface, bcvt parambcvt)
  {
    HashMap localHashMap = new HashMap();
    ...
    if ((paramArrayOfByte != null) && ((paramArrayOfByte instanceof bcvr)))
    {
      ((bcvr)paramArrayOfByte).a(localHashMap);
      if (QLog.isColorLevel()) {
    ...
    label130:
    a(paramQQAppInterface, paramArrayOfByte, parambcvt);
  }
  ...
  public static boolean a(int paramInt, String paramString)
  {
    ...
    if (Build.VERSION.SDK_INT >= 21)
    {
      ...
      if (localbcus.a())
      {
        ...
        if (localbcus.jdField_a_of_type_Int <= 0) {
          break label53;
        }
        bool1 = bool2;
      }
  ...
  private static boolean a(long paramLong)
  {
    ...
    try
    {
      localObject = (stNuanNuanComment)b(stNuanNuanComment.class, bhcu.decode((String)localObject, 0));
  ...
  public static byte[] a(long paramLong, String paramString1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, Map<Integer, count_info> paramMap, String paramString2, Map<Long, Long> paramMap1)
  {
    ...
    return bcuo.a(paramString1, "getUndealCount", paramLong, paramInt1, paramInt2, paramInt4);
  }
  ...
  public static void b(int paramInt, QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface != null)
    {
      ...
      if (str != null)
      {
        ...
        paramQQAppInterface = (awzb)paramQQAppInterface.getManager(QQManagerFactory.QZONE_MANAGER);
        if ((paramInt & 0x80) == 0) {
          break label85;
        }
      }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((parammobile_count_rsp_new.snnComment != null) && (parammobile_count_rsp_new.snnComment.iStatus != 0) && (paramLong != -1L))
        {
          ...
          LocalMultiProcConfig.putString4Uin("qzone_dual_warm_comment_info", bhcu.encodeToString(localJceOutputStream.toByteArray(), 0), paramLong);
        ...
        if ((parammobile_count_rsp_new.sContentOpComment != null) && (parammobile_count_rsp_new.sContentOpComment.iStatus != 0) && (paramLong != -1L))
        {
          ...
          LocalMultiProcConfig.putString4Uin("qzone_dual_warm_operation_comment_info", bhcu.encodeToString(((JceOutputStream)localObject).toByteArray(), 0), paramLong);
          return;
        }
      }
