  ...
  extends Handler
{
  ...
  public beki(SubmitHomeWorkFragment paramSubmitHomeWorkFragment, Looper paramLooper)
  {
    super(paramLooper);
    ...
    do
    {
      do
      {
        ...
        if (paramSubmitHomeWorkFragment.jdField_a_of_type_JavaUtilLinkedList.isEmpty())
        {
          ...
          paramSubmitHomeWorkFragment.jdField_b_of_type_ComTencentMobileqqTroopHomeworkXmediaeditorXMediaEditor.setHint(paramSubmitHomeWorkFragment.getActivity().getString(2131696956));
      ...
      while (localIterator.hasNext())
      {
        ...
        paramSubmitHomeWorkFragment.jdField_a_of_type_ComTencentMobileqqTroopHomeworkXmediaeditorXMediaEditor.a(benp.a(localJSONObject));
      }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case 3: 
      ...
      localSubmitHomeWorkFragment.jdField_a_of_type_Bjnw.d(false);
      return;
    case 513: 
    ...
    if (i < 1000)
    {
      QQToast.a(localSubmitHomeWorkFragment.getActivity(), amtj.a(2131713667), 0).a();
    ...
    if (!NetworkUtil.isNetSupport(localSubmitHomeWorkFragment.getActivity()))
    {
      ...
      QQToast.a(localSubmitHomeWorkFragment.getActivity(), 2131696687, 0).a();
      localSubmitHomeWorkFragment.jdField_a_of_type_Boolean = false;
      localSubmitHomeWorkFragment.j();
      return;
    }
    ...
    {
      paramMessage = new benn(paramMessage, null, i / 1000, (int)l, localSubmitHomeWorkFragment.d);
