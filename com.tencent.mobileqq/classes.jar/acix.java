...
{
  private static volatile acix jdField_a_of_type_Acix;
  ...
  private DownloadListener jdField_a_of_type_ComTencentOpenDownloadnewDownloadListener = new aciy(this);
  ...
  {
    if (jdField_a_of_type_Acix == null) {}
    try
    {
      if (jdField_a_of_type_Acix == null) {
        jdField_a_of_type_Acix = new acix();
      }
      return jdField_a_of_type_Acix;
    }
    finally {}
  }
  ...
  private void a()
  {
    acho.a("GdtDownloadReportManager", "registerDownloadListener: ");
  ...
  public void a(GdtAd paramGdtAd, int paramInt, boolean paramBoolean)
  {
    if (paramInt == 0)
    {
      ...
      acie.a(paramGdtAd, 269);
    }
    for (;;)
    {
      acie.a(paramGdtAd, 272);
      return;
      label23:
      acie.a(paramGdtAd, 268);
    }
  }
  ...
  public void a(String paramString, GdtAd paramGdtAd, AdAppBtnData paramAdAppBtnData)
  {
    ...
    {
      acho.d("GdtDownloadReportManager", "appId isEmpty");
      return;
    }
