  ...
  extends BaseAdapter
{
  ...
  private ArrayList<ahlx> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  
  public afcx(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = paramContext.getResources().getDrawable(2130841511);
  }
  ...
  public void a(List<ahlx> paramList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt == 0)
      {
        ...
        localObject3 = (ahlx)this.jdField_a_of_type_JavaUtilArrayList.get(j);
        if (localObject3 != null) {
          ((ImageView)localObject2).setImageDrawable(a(((ahlx)localObject3).jdField_a_of_type_JavaLangString));
        }
        ((View)localObject2).setTag(Integer.valueOf(j));
        if (AppSetting.c) {
          ((View)localObject2).setContentDescription(ahly.a(((ahlx)localObject3).jdField_a_of_type_Int) + amtj.a(2131707432));
        }
      }
      for (;;)
      {
