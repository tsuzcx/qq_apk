...
public class aptv
{
  public static void a(Activity paramActivity, int paramInt1, String paramString1, String paramString2, long paramLong1, long paramLong2, int paramInt2, boolean paramBoolean)
  {
    ...
    if ((paramInt2 == 1) || (paramInt2 == 3000))
    {
      ...
      apsm.a().a().a("GalleryJumpUtils", 4, "jumpToTargetAIOPosition, className = " + (String)localObject + ", time = " + paramLong1 + " , shmsgseq = " + paramLong2 + ", isEmotion = " + paramBoolean);
    ...
    {
      apsm.a().a().a("GalleryJumpUtils", 4, "jumpToTargetAIOPosition, isFromHistory = " + bool2 + ", isEmotion = " + paramBoolean + ", sourceEntrance = " + i + ", fromHistory_picAndVideo = " + bool1 + ", fromHistory_emotion = " + bool3);
      if (!bool2) {
        break label440;
      }
      paramInt1 = paramActivity.getIntent().getIntExtra("FromChatHistoryTab", 0);
      apsm.a().a().a("GalleryJumpUtils", 4, "jumpToTargetAIOPosition, fromType = " + paramInt1);
  ...
  public static void a(Activity paramActivity, Bundle paramBundle)
  {
    ...
    apsm.a().a().a("GalleryJumpUtils", 4, "AIOGallerysence startChatAndSendMsg IS_WAIT_DEST_RESULT=true");
  ...
  public static void a(Context paramContext, String paramString, int paramInt, apsr paramapsr)
  {
    ...
    localIntent.putExtra("extra.EXTRA_CURRENT_IMAGE", aptt.a(paramapsr.a));
    localIntent.putExtra("leftViewText", paramContext.getString(2131625271));
  ...
  public static void a(Context paramContext, String paramString1, int paramInt1, boolean paramBoolean, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt2, String paramString6, String paramString7, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      {
        apsm.a().a().a("GalleryJumpUtils", 4, "onQRDecodeSucceed error:" + paramString1.getMessage());
        continue;
        continue;
        paramString1 = null;
        continue;
      ...
      localIntent.putExtra("report_params", vup.a(paramString3, paramString1, paramString5, paramString2, paramString6, paramInt1));
      paramContext.startActivity(localIntent);
      return;
      if (paramBoolean)
      {
