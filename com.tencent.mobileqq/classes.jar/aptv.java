...
public class aptv
{
  private static int jdField_a_of_type_Int = BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131298865) - (int)bbdh.a(BaseApplicationImpl.getContext(), 5.0F);
  ...
  public static void a(int paramInt)
  {
    try
    {
      ...
      if (a(paramInt))
      {
        ...
        bcpw.a(BaseApplicationImpl.getContext(), 0, paramInt, 0).b(jdField_a_of_type_Int);
      }
      return;
    }
  ...
  public static void a(int paramInt1, String paramString, int paramInt2)
  {
    ...
    bcpw.a(BaseApplicationImpl.getContext(), paramInt1, paramString, paramInt2).b(jdField_a_of_type_Int);
  }
  ...
  public static void a(String paramString)
  {
    ...
    bcpw.a(BaseApplicationImpl.getContext(), 0, paramString, 0).b(jdField_a_of_type_Int);
  }
  ...
  public static void b(int paramInt)
  {
    ...
    bcpw.a(BaseApplicationImpl.getContext(), 2, paramInt, 0).b(jdField_a_of_type_Int);
  }
  ...
  public static void b(String paramString)
  {
    ...
    bcpw.a(BaseApplicationImpl.getContext(), 2, paramString, 0).b(jdField_a_of_type_Int);
  }
  ...
  public static void c(String paramString)
  {
    ...
    bcpw.a(BaseApplicationImpl.getContext(), 2, paramString, 1).b(jdField_a_of_type_Int);
  }
