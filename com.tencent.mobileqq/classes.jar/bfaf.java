  ...
  extends benu
{
  ...
  public bfaf(FriendListOpenFrame paramFriendListOpenFrame)
  {
  ...
  protected void a()
  {
    ...
    Object localObject1 = this.jdField_a_of_type_ComTencentOpenAgentFriendListOpenFrame.jdField_a_of_type_Bfdi.a(this.jdField_a_of_type_ComTencentOpenAgentFriendListOpenFrame.jdField_a_of_type_Int);
    bfhg.c("FriendListOpenFrame", "-->start constructHashStruct()");
    ...
    bfhg.c("FriendListOpenFrame", "-->end constructHashStruct()");
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_ComTencentOpenAgentFriendListOpenFrame.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562611, paramViewGroup, false);
      paramViewGroup = new bfag();
      ...
      if (!this.jdField_a_of_type_ComTencentOpenAgentFriendListOpenFrame.jdField_a_of_type_Bfdi.a(localFriend.a)) {
        break label369;
      }
      ...
      if ((localFriend.d == null) || ("".equals(localFriend.d))) {
        localFriend.d = bfdp.a(this.jdField_a_of_type_ComTencentOpenAgentFriendListOpenFrame.jdField_a_of_type_ComTencentOpenAgentFriendChooser.a(), localFriend.a);
      }
      ...
      bfdm.a().a(localFriend.d, this.jdField_a_of_type_ComTencentOpenAgentFriendListOpenFrame);
    }
    for (;;)
    {
      ...
      return paramView;
      paramViewGroup = (bfag)paramView.getTag();
      break;
      label369:
