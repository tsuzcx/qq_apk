...
public class akhx
{
  static akhx jdField_a_of_type_Akhx;
  private axjo jdField_a_of_type_Axjo = new akhy(this);
  ShareAppLogHelper jdField_a_of_type_ComTencentMobileqqTestassisterShareAppLogHelper;
  private WeakReference<QQAppInterface> jdField_a_of_type_JavaLangRefWeakReference;
  
  akhx(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramQQAppInterface);
  }
  
  public static akhx a(QQAppInterface paramQQAppInterface)
  {
    jdField_a_of_type_Akhx = new akhx(paramQQAppInterface);
    return jdField_a_of_type_Akhx;
  }
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqTestassisterShareAppLogHelper.a(this.jdField_a_of_type_Axjo);
