  ...
  extends bhou
{
  ...
  public bhpf(Activity paramActivity)
  {
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    ...
    apcy.a().a(hashCode(), "SwiftBrowserLongClickHandler");
  }
  ...
  public void a(String paramString)
  {
    ...
    //   69: ifnull +288 -> 357
    //   72: aload_0
    //   73: getfield 112	bhpf:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   99: dup
    //   100: getstatic 135	anhk:bg	Ljava/lang/String;
    ...
    //   117: getstatic 135	anhk:bg	Ljava/lang/String;
    ...
    //   171: getstatic 135	anhk:bg	Ljava/lang/String;
    ...
    //   336: ifeq +21 -> 357
    //   339: aload_0
    //   340: getfield 30	bhpf:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   343: new 182	com/tencent/mobileqq/webview/swift/component/SwiftBrowserLongClickHandler$5
    //   346: dup
    //   347: aload_0
    //   348: aload 7
    //   350: invokespecial 183	com/tencent/mobileqq/webview/swift/component/SwiftBrowserLongClickHandler$5:<init>	(Lbhpf;Ljava/lang/String;)V
    //   353: invokevirtual 187	android/app/Activity:runOnUiThread	(Ljava/lang/Runnable;)V
    //   356: return
    //   357: aload_0
    //   358: getfield 30	bhpf:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   361: new 189	com/tencent/mobileqq/webview/swift/component/SwiftBrowserLongClickHandler$6
    //   364: dup
    //   365: aload_0
    //   366: invokespecial 192	com/tencent/mobileqq/webview/swift/component/SwiftBrowserLongClickHandler$6:<init>	(Lbhpf;)V
  ...
  void a(String paramString, int paramInt)
  {
    ...
    localIntent.putExtra("report_params", zuc.a(null, paramString, null, null, null, 5));
  ...
  public boolean a()
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        bool2 = zuc.a(this.jdField_c_of_type_Int);
        bool1 = zuc.b(this.jdField_c_of_type_Int);
        if (bool2)
        {
      ...
      QQToast.a(this.jdField_a_of_type_AndroidAppActivity.getApplicationContext(), 1, 2131690078, 1).b(this.jdField_a_of_type_Int);
      return false;
      label142:
      boolean bool1 = false;
      boolean bool2 = false;
  ...
  public boolean a(View paramView)
  {
    ...
    Object localObject;
    int i;
    if ((this.jdField_a_of_type_Bhov != null) && (this.jdField_a_of_type_Bhov.a() != null))
    {
      localObject = this.jdField_a_of_type_Bhov.a();
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_Bkho = bkho.c(this.jdField_a_of_type_AndroidAppActivity);
        if (bool1) {
          this.jdField_a_of_type_Bkho.b(2131690559);
        }
        this.jdField_a_of_type_Bkho.b(2131690558);
        this.jdField_a_of_type_Bkho.b(2131690557);
        if (i != 0) {
          this.jdField_a_of_type_Bkho.b(2131692951);
        }
        this.jdField_a_of_type_Bkho.c(2131690582);
        d(this.jdField_a_of_type_JavaLangString);
        this.jdField_a_of_type_Bkho.a(new bhpg(this));
        this.jdField_a_of_type_Bkho.setOnDismissListener(new bhph(this));
  ...
  public void b(String paramString)
  {
    ...
    aufz.a(this.jdField_a_of_type_AndroidAppActivity, paramString, 21);
  }
  ...
  public void c(String paramString)
  {
    ...
    Object localObject = this.jdField_a_of_type_Bhov.a();
    if (localObject == null)
    {
