  ...
  extends BaseShortVideoOprerator
{
  ...
  private void b(bcyj parambcyj)
  {
    ThreadManager.getSubThreadHandler().post(new DevShortVideoOperator.1(this, parambcyj));
  }
  ...
  public int a()
  {
    ...
    //   12: aconst_null
    //   13: aload_0
    //   14: getfield 47	abhs:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   147: putfield 82	abhs:jdField_b_of_type_Int	I
    //   150: aload_0
    //   151: aload 9
    //   153: invokevirtual 85	android/graphics/Bitmap:getHeight	()I
    //   156: putfield 87	abhs:jdField_c_of_type_Int	I
    //   159: new 89	java/io/File
    //   162: dup
    //   163: aload_0
    //   164: getfield 47	abhs:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   167: invokespecial 92	java/io/File:<init>	(Ljava/lang/String;)V
    //   170: astore_2
    //   171: aload_0
    //   172: aload_2
    //   173: invokevirtual 96	java/io/File:length	()J
    //   176: putfield 98	abhs:jdField_a_of_type_Long	J
    ...
    //   189: aload_3
    //   190: aload_0
    //   191: getfield 98	abhs:jdField_a_of_type_Long	J
    ...
    //   200: putfield 117	abhs:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   203: aload_0
    //   204: getfield 117	abhs:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   234: aload_0
    //   235: getfield 117	abhs:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   281: ireturn
    //   282: aload_0
    //   283: getfield 117	abhs:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   286: ldc 141
    ...
    //   433: putfield 191	abhs:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   436: aload_0
    //   437: getfield 191	abhs:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   467: aload_0
    //   468: getfield 191	abhs:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   511: aload_0
    //   512: aload_0
    //   513: getfield 191	abhs:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   516: ldc 141
    ...
    //   521: putfield 196	abhs:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    //   524: aload 10
    //   526: aload_0
    //   527: getfield 196	abhs:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   568: ireturn
    //   569: aload_0
    //   570: getfield 202	abhs:jdField_b_of_type_Long	J
    //   573: lconst_0
    //   574: lcmp
    //   575: ifne +14 -> 589
    //   578: aload_0
    //   579: aload_0
    //   580: getfield 47	abhs:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   583: invokestatic 206	com/tencent/mobileqq/shortvideo/ShortVideoUtils:getDuration	(Ljava/lang/String;)J
    //   586: putfield 202	abhs:jdField_b_of_type_Long	J
    //   589: aload_3
    //   590: ifnull +7 -> 597
    //   593: aload_3
    ...
    //   684: aload 8
    //   686: astore_3
    //   687: invokestatic 59	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   690: ifeq +23 -> 713
    //   693: aload 6
    //   695: astore 7
    //   697: aload_2
    ...
    //   706: ldc 208
    //   708: aload 5
    //   710: invokestatic 211	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   713: aload 8
    //   715: ifnull +8 -> 723
    //   718: aload 8
    ...
    //   725: ifnull +8 -> 733
    //   728: aload 6
    //   730: invokevirtual 194	java/io/FileOutputStream:close	()V
    //   733: aload_2
    //   734: ifnull -659 -> 75
    //   737: aload_2
    //   738: invokevirtual 139	java/io/FileInputStream:close	()V
    //   741: iconst_m1
    //   742: ireturn
    //   743: astore_2
    //   744: iconst_m1
    ...
    //   764: aload 8
    //   766: astore_3
    //   767: invokestatic 59	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   770: ifeq +23 -> 793
    //   773: aload 6
    //   775: astore 7
    //   777: aload_2
    ...
    //   786: ldc 213
    //   788: aload 5
    //   790: invokestatic 211	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   793: aload 8
    //   795: ifnull +8 -> 803
    //   798: aload 8
    //   800: invokevirtual 139	java/io/FileInputStream:close	()V
    //   803: aload 6
    //   805: ifnull +8 -> 813
    //   808: aload 6
    //   810: invokevirtual 194	java/io/FileOutputStream:close	()V
    //   813: aload_2
    //   814: ifnull -739 -> 75
    //   817: aload_2
    //   818: invokevirtual 139	java/io/FileInputStream:close	()V
    //   821: iconst_m1
    //   822: ireturn
    //   823: astore_2
    //   824: iconst_m1
    ...
    //   837: ifnull +7 -> 844
    //   840: aload_3
    //   841: invokevirtual 139	java/io/FileInputStream:close	()V
    //   844: aload 5
    //   846: ifnull +8 -> 854
    //   849: aload 5
    //   851: invokevirtual 194	java/io/FileOutputStream:close	()V
    //   854: aload 4
    //   856: ifnull +8 -> 864
    //   859: aload 4
    //   861: invokevirtual 139	java/io/FileInputStream:close	()V
    //   864: aload_2
    //   865: athrow
    //   866: astore_2
    //   867: goto -816 -> 51
    ...
    //   673	65	2	localObject3	Object
    //   743	1	2	localIOException6	java.io.IOException
    //   749	69	2	localObject4	Object
    ...
    //   1015	120	2	localObject9	Object
    ...
    //   682	408	4	localObject11	Object
    //   1098	1	4	localIOException32	java.io.IOException
    //   1105	17	4	localIOException33	java.io.IOException
    //   1127	1	4	localObject12	Object
    //   10	643	5	localObject13	Object
    //   670	39	5	localException1	java.lang.Exception
    //   746	43	5	localOutOfMemoryError1	java.lang.OutOfMemoryError
    //   834	174	5	localObject14	Object
    //   1012	1	5	localOutOfMemoryError2	java.lang.OutOfMemoryError
    //   1026	1	5	localOutOfMemoryError3	java.lang.OutOfMemoryError
    //   1043	1	5	localOutOfMemoryError4	java.lang.OutOfMemoryError
    //   1057	1	5	localException2	java.lang.Exception
    //   1067	1	5	localException3	java.lang.Exception
    //   1084	1	5	localException4	java.lang.Exception
    //   1111	1	5	localObject15	Object
    //   1119	7	5	localIOException34	java.io.IOException
    //   1130	1	5	localObject16	Object
    //   1	808	6	localObject17	Object
    //   968	9	6	localObject18	Object
    //   982	6	6	localObject19	Object
    //   993	6	6	localObject20	Object
    //   1018	115	6	localObject21	Object
    //   7	999	7	localObject22	Object
    //   326	768	8	localObject23	Object
    //   81	312	9	localBitmap2	android.graphics.Bitmap
    ...
    //   737	741	743	java/io/IOException
    //   12	21	746	java/lang/OutOfMemoryError
    //   25	39	746	java/lang/OutOfMemoryError
    //   77	83	746	java/lang/OutOfMemoryError
    //   88	102	746	java/lang/OutOfMemoryError
    //   141	188	746	java/lang/OutOfMemoryError
    ...
    //   718	723	929	java/io/IOException
    //   728	733	933	java/io/IOException
    ...
    //   569	589	982	finally
    //   623	639	993	finally
    //   687	693	1004	finally
    //   703	713	1004	finally
    ...
    //   392	419	1026	java/lang/OutOfMemoryError
    //   419	480	1043	java/lang/OutOfMemoryError
    //   511	534	1043	java/lang/OutOfMemoryError
    //   569	589	1043	java/lang/OutOfMemoryError
    //   188	247	1057	java/lang/Exception
    //   282	355	1057	java/lang/Exception
    //   355	360	1057	java/lang/Exception
    //   360	376	1057	java/lang/Exception
    //   376	382	1057	java/lang/Exception
    //   382	392	1057	java/lang/Exception
  ...
  public bcyj a(Object paramObject, bcxr parambcxr)
  {
    ...
    {
      a();
      localObject = new bcyj();
      ((bcyj)localObject).jdField_c_of_type_JavaLangString = this.jdField_b_of_type_JavaLangString;
      ((bcyj)localObject).h = this.jdField_a_of_type_JavaLangString;
      ((bcyj)localObject).j = this.jdField_d_of_type_JavaLangString;
      ((bcyj)localObject).jdField_b_of_type_Int = this.jdField_a_of_type_Int;
      ((bcyj)localObject).jdField_d_of_type_JavaLangString = "";
      ((bcyj)localObject).jdField_e_of_type_Int = ((int)this.jdField_a_of_type_Long);
      ((bcyj)localObject).f = ((int)this.jdField_b_of_type_Long / 1000);
      ((bcyj)localObject).jdField_e_of_type_JavaLangString = this.jdField_c_of_type_JavaLangString;
      ((bcyj)localObject).jdField_c_of_type_Int = this.jdField_b_of_type_Int;
      ((bcyj)localObject).jdField_d_of_type_Int = this.jdField_c_of_type_Int;
      ((bcyj)localObject).jdField_g_of_type_Int = parambcxr.jdField_a_of_type_Int;
      ((bcyj)localObject).jdField_a_of_type_JavaLangObject = paramObject;
      ((bcyj)localObject).jdField_g_of_type_JavaLangString = this.jdField_e_of_type_JavaLangString;
      ((bcyj)localObject).l = "";
  ...
  public MessageRecord a(bcyj parambcyj)
  {
    ...
    MessageForDevShortVideo localMessageForDevShortVideo = (MessageForDevShortVideo)bcsa.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, parambcyj.jdField_c_of_type_JavaLangString, parambcyj.jdField_d_of_type_JavaLangString, parambcyj.jdField_b_of_type_Int);
    localMessageForDevShortVideo.videoFileName = parambcyj.h;
    if (parambcyj.jdField_a_of_type_JavaLangString == null) {
      parambcyj.jdField_a_of_type_JavaLangString = "";
    }
    localMessageForDevShortVideo.uuid = parambcyj.jdField_a_of_type_JavaLangString;
    if (parambcyj.jdField_e_of_type_JavaLangString == null) {
      parambcyj.jdField_e_of_type_JavaLangString = "";
    }
    localMessageForDevShortVideo.md5 = parambcyj.jdField_e_of_type_JavaLangString;
    localMessageForDevShortVideo.videoFileFormat = 2;
    localMessageForDevShortVideo.videoFileSize = parambcyj.jdField_e_of_type_Int;
    localMessageForDevShortVideo.videoFileTime = parambcyj.f;
    localMessageForDevShortVideo.thumbWidth = parambcyj.jdField_c_of_type_Int;
    localMessageForDevShortVideo.thumbHeight = parambcyj.jdField_d_of_type_Int;
    ...
    localMessageForDevShortVideo.thumbMD5 = parambcyj.jdField_g_of_type_JavaLangString;
    localMessageForDevShortVideo.extraflag = 32772;
    if (parambcyj.l == null) {
      parambcyj.l = "";
    }
    localMessageForDevShortVideo.fileSource = parambcyj.l;
    localMessageForDevShortVideo.lastModified = 0L;
    if (parambcyj.jdField_a_of_type_Bcyk != null) {
      i = 1;
    }
    if (i != 0)
    {
      localMessageForDevShortVideo.msgseq = parambcyj.jdField_a_of_type_Bcyk.jdField_a_of_type_Long;
      localMessageForDevShortVideo.shmsgseq = parambcyj.jdField_a_of_type_Bcyk.jdField_b_of_type_Long;
      localMessageForDevShortVideo.msgUid = parambcyj.jdField_a_of_type_Bcyk.c;
    }
    localMessageForDevShortVideo.msg = localMessageForDevShortVideo.getSummary();
    localMessageForDevShortVideo.serial();
    parambcyj.jdField_a_of_type_Long = localMessageForDevShortVideo.uniseq;
    azjq.a(this.jdField_g_of_type_JavaLangString, this.f, "packmsg", "cost:" + (System.currentTimeMillis() - l));
    azjq.a(this.jdField_g_of_type_JavaLangString, this.f, "packMsg", "mr: " + localMessageForDevShortVideo.toLogString() + "-" + localMessageForDevShortVideo.toString());
  ...
  {
    azjq.a(this.jdField_g_of_type_JavaLangString, this.f, "attachRichText2Msg", "");
  ...
  {
    azjq.a(this.jdField_g_of_type_JavaLangString, this.f, "updateMsg", "resut:" + paramazlb);
    if (paramazlb != null)
    {
