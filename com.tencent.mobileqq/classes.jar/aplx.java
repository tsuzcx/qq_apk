  ...
  implements aplw
{
  ...
  public static aplw a(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("com.tencent.mobileqq.ar.aidl.IArMiniCallback");
    if ((localIInterface != null) && ((localIInterface instanceof aplw))) {
      return (aplw)localIInterface;
    }
    return new aply(paramIBinder);
  }
