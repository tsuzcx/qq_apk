  ...
  extends MSFServlet
{
  ...
  {
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApplication(), ayue.class);
  ...
  private void a(oidb_0xca6.RspBody paramRspBody, Intent paramIntent, int paramInt)
  {
    ...
    if ((getAppRuntime() instanceof QQAppInterface))
    {
      ...
      localanmw = (anmw)localQQAppInterface.getManager(51);
      localFriends = localanmw.d(localQQAppInterface.c());
    ...
    for (i = 0;; i = 1)
    {
      ...
      ((aypj)localQQAppInterface.getManager(369)).b(paramInt, paramIntent);
      return;
    }
  }
  ...
  public void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    //   203: aload_1
    //   204: iload_3
    //   205: invokespecial 364	ayue:a	(Ltencent/im/oidb/cmd0xca6/oidb_0xca6$RspBody;Landroid/content/Intent;I)V
    ...
    //   227: aload_2
    //   228: ldc_w 372
    //   231: invokevirtual 376	ayue:notifyObserver	(Landroid/content/Intent;IZLandroid/os/Bundle;Ljava/lang/Class;)V
    //   234: return
    //   235: astore 5
    //   237: aconst_null
    //   238: astore_2
    ...
    //   286: aconst_null
    //   287: ldc_w 372
    //   290: invokevirtual 376	ayue:notifyObserver	(Landroid/content/Intent;IZLandroid/os/Bundle;Ljava/lang/Class;)V
    //   293: return
