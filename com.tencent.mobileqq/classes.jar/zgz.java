  ...
  implements SurfaceTexture.OnFrameAvailableListener
{
  ...
  public zgz(int paramInt1, int paramInt2)
  {
  ...
  private void e()
  {
    this.jdField_a_of_type_Zha = new zha();
    this.jdField_a_of_type_Zha.a();
    Log.d("CodecOutputSurface", "textureID=" + this.jdField_a_of_type_Zha.a());
    this.jdField_a_of_type_AndroidGraphicsSurfaceTexture = new SurfaceTexture(this.jdField_a_of_type_Zha.a());
  ...
  {
    this.jdField_a_of_type_Zha.a(this.jdField_a_of_type_AndroidGraphicsSurfaceTexture, paramBoolean);
  }
  ...
  public void d()
  {
    this.jdField_a_of_type_Zha.a("before updateTexImage");
