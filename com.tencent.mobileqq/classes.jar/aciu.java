...
public class aciu
  implements apiu, AdArkAdapter
{
  private View jdField_a_of_type_AndroidViewView;
  private AdArkAdapter.ArkNotifyCallback jdField_a_of_type_ComTencentAdTangramArkAdArkAdapter$ArkNotifyCallback;
  
  private agpq a(ArkAppView paramArkAppView, bgou parambgou)
  {
    agpq localagpq = new agpq();
    parambgou.jdField_a_of_type_Agpq = localagpq;
    int i = paramArkAppView.getWidth();
    int j = paramArkAppView.getHeight();
    localagpq.a(parambgou.jdField_a_of_type_JavaLangString, parambgou.b, parambgou.c, parambgou.d, parambgou.jdField_a_of_type_Float, parambgou.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
    localagpq.setFixSize(i, j);
    localagpq.setMaxSize(i, j);
    localagpq.setMinSize(i, j);
    return localagpq;
  }
  ...
  private void a(ArkAppView paramArkAppView, AdArkAdapter.Params paramParams)
  {
    ...
    paramArkAppView.initArkView(a(paramArkAppView, new bgou(bgou.a(str1, str2, "0.0.0.1", paramParams.metaData, f, null, null))), false);
  ...
  private void a(ArkAppView paramArkAppView, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    paramArkAppView.initArkView(a(paramArkAppView, new bgou(bgou.a(paramString1, paramString2, "0.0.0.1", paramString4, f1, null, null))), false);
    paramArkAppView.setVisibility(0);
  }
  ...
  public View buildArkView(AdArkAdapter.Params paramParams)
  {
    if ((paramParams != null) && (paramParams.isValid()))
    {
      ...
      localArkAppView.setCallback(new aciv(this, localCallback));
      ...
      if ((paramParams.context.get() instanceof Activity))
      {
        ...
        if (localFrameLayout != null)
        {
          ...
          if (this.jdField_a_of_type_AndroidViewView != null) {
            this.jdField_a_of_type_AndroidViewView.getViewTreeObserver().addOnGlobalLayoutListener(new aciw(this, localCallback));
          }
        }
      }
      localArkAppView.setInputCallback(new acix(this, localCallback));
  ...
  public String getArkFormData(AdArkAdapter.DataParams paramDataParams)
  {
    ...
    try
    {
      ...
      localObject1 = localObject3;
      localObject4 = acqx.a((PBField)localObject4);
