  ...
  implements achq
{
  ...
  {
    return MemoryCeilingMonitor.dumpHprof(paramString, new aciv(this, paramacht));
  }
  ...
  public String b()
  {
    ...
    try
    {
      ...
      localObject = (ArrayList)acit.jdField_a_of_type_JavaUtilArrayList.clone();
  ...
  public boolean c()
  {
    return acit.a().jdField_a_of_type_Boolean;
  }
