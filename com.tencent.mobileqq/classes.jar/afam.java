...
public class afam
  implements afal, amfm, View.OnClickListener, bhyq
{
  private int jdField_a_of_type_Int;
  private amfh jdField_a_of_type_Amfh = new afan(this);
  ...
  afam(BaseChatPie paramBaseChatPie)
  {
  ...
  private boolean a(int paramInt, String paramString)
  {
    ...
    int i = ((amfi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(285)).a(paramString, paramInt);
  ...
  public void a(int paramInt)
  {
    ...
    do
    {
      do
      {
        ...
        } while (!amfl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString));
        ...
        localamfi = (amfi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(285);
        localamfi.a(this);
        localamfi.a(this.jdField_a_of_type_Amfh);
        return;
      ...
      amfi localamfi = (amfi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(285);
      localamfi.b(this);
      localamfi.e();
    ...
    amfl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString, false, this.jdField_a_of_type_Int);
  }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    if (!amfl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, i, str)) {}
    while ((TextUtils.isEmpty(str)) || (!str.equals(paramString)) || (((!paramBoolean) || (!amfl.c(i))) && ((paramBoolean) || (!amfl.b(i))) && (!amfl.d(i)))) {
      return;
    }
  ...
  {
    if (!amfl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) {}
    do
    {
      return;
      if (QLog.isColorLevel()) {
    ...
    amfl.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, true, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int);
  }
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramBoolean2)
    {
      ...
      if (amfl.b(i))
      {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqAppIcebreakingAIOIceBreakShow != null) && (localaloz.b(str)) && (!localamfi.a(str))) {
          localamfi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), 3, 1, str);
        }
      }
      do
      {
        ...
        } while (localamfi.b(str));
        localamfi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), 3, 2, str);
        return;
      } while ((!amfl.d(i)) || (localamfi.c(str)));
      localamfi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), 3, 1, str);
      return;
    }
    this.jdField_a_of_type_Amfh.a(true, null);
  }
  ...
  public void b(String paramString, boolean paramBoolean)
  {
    ...
    String str = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString;
    if (!amfl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, i, str)) {}
    while ((TextUtils.isEmpty(paramString)) || (!str.equals(paramString)) || (((!paramBoolean) || (!amfl.c(i))) && ((paramBoolean) || (!amfl.b(i))) && (!amfl.d(i)))) {
      return;
    }
  ...
  {
    if ((paramView.getId() == 2131368332) && (this.jdField_a_of_type_ComTencentMobileqqAppIcebreakingAIOIceBreakShow != null))
    {
      if (QLog.isColorLevel()) {
