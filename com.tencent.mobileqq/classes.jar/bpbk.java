...
public class bpbk
{
  private static final String jdField_a_of_type_JavaLangString = bpbk.class.getSimpleName();
  private FragmentManager jdField_a_of_type_AndroidSupportV4AppFragmentManager;
  private HashMap<Class<? extends AEEditorBaseFragment>, AEEditorBaseFragment> jdField_a_of_type_JavaUtilHashMap;
  
  public bpbk(FragmentManager paramFragmentManager)
  {
  ...
  private void a(AEEditorBaseFragment paramAEEditorBaseFragment, Class<? extends AEEditorBaseFragment> paramClass, String paramString, Bundle paramBundle, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        bpam.d(jdField_a_of_type_JavaLangString, "replaceFragment: " + Log.getStackTraceString(paramAEEditorBaseFragment));
        return;
      }
    ...
    if (this.jdField_a_of_type_AndroidSupportV4AppFragmentManager.findFragmentByTag(paramClass.getName()) == null) {
      paramBundle.add(2131362289, localAEEditorBaseFragment, paramClass.getName()).commit();
    }
    for (;;)
    {
  ...
  public void a(Activity paramActivity, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      {
        bpam.d(jdField_a_of_type_JavaLangString, Log.getStackTraceString(paramActivity));
        return;
      }
    ...
    bpam.b(jdField_a_of_type_JavaLangString, "goBack finish activity");
    b(paramActivity);
  ...
  {
    bpam.b(jdField_a_of_type_JavaLangString, "enter");
    if (bpbj.a(paramBundle))
    {
      a(null, paramBundle);
      return;
    }
    if (bpbj.b(paramBundle))
    {
      b(null, paramBundle);
      return;
    }
  ...
  {
    bpam.b(jdField_a_of_type_JavaLangString, "gotoVideoClipModule from " + paramString);
    a(paramAEEditorBaseFragment, AEEditorVideoClipFragment.class, paramString, paramBundle, paramBoolean);
  }
  
  public void a(String paramString, Bundle paramBundle)
  {
    bpam.b(jdField_a_of_type_JavaLangString, "gotoImageEditModule from " + paramString);
  ...
  {
    bpam.b(jdField_a_of_type_JavaLangString, "gotoVideoEditModule from " + paramString);
