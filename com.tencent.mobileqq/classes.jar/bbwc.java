  ...
  extends Handler
{
  ...
  public bbwc(PublishHomeWorkFragment paramPublishHomeWorkFragment, Looper paramLooper)
  {
    super(paramLooper);
  ...
  void a()
  {
    ...
    localObject = localPublishHomeWorkFragment.getString(2131697874, new Object[] { Integer.valueOf(i), Integer.valueOf(j), localPublishHomeWorkFragment.jdField_a_of_type_JavaLangString }).trim();
    String str1 = localPublishHomeWorkFragment.getString(2131697874, new Object[] { Integer.valueOf(i), Integer.valueOf(j), "" }).trim();
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      case 3: 
        ...
        localPublishHomeWorkFragment.jdField_a_of_type_Bhpy.c(false);
        return;
      case 515: 
      ...
      case 102: 
        ...
        if (i < 1000)
        {
          QQToast.a(localPublishHomeWorkFragment.getActivity(), alpo.a(2131709216), 0).a();
          localPublishHomeWorkFragment.jdField_a_of_type_ComTencentMobileqqActivityAioAudiopanelCommonRecordSoundPanel.b();
          return;
        }
        if (!bdee.d(localPublishHomeWorkFragment.getActivity()))
        {
          if (QLog.isColorLevel()) {
            QLog.d("PublishHomeWorkFragment", 2, "no network toast");
          }
          QQToast.a(localPublishHomeWorkFragment.getActivity(), 2131697659, 0).a();
          localPublishHomeWorkFragment.f = false;
          localPublishHomeWorkFragment.m();
          return;
        }
        ...
        {
          paramMessage = new bbzo(paramMessage, null, i / 1000, (int)l, localPublishHomeWorkFragment.b);
