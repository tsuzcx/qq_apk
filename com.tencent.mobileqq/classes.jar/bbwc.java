...
public class bbwc
{
  ...
  public static bbwd a(String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    bbwd localbbwd = new bbwd();
    localbbwd.jdField_a_of_type_JavaLangString = a(paramString);
    String str;
    if (!localSharedPreferences.getBoolean("guideEnable", false))
    {
      ...
      localbbwd.jdField_a_of_type_Int = 4;
      switch (localbbwd.jdField_a_of_type_Int)
      {
      case 3: 
      default: 
        str = "P3";
    ...
    for (;;)
    {
      ...
      if (localSharedPreferences.getInt("guideToastOpen", 0) == 1)
      {
        ...
        for (;;)
        {
          ...
          bcpw.a(BaseApplicationImpl.getContext(), 2, str, i * 1000).a();
          localbbwd.jdField_a_of_type_Int = 1;
          break;
          label258:
      ...
      if (localSharedPreferences.getInt("guidePopupOpen", 0) == 1)
      {
        ...
        if ((i == 0) || (i == 1))
        {
          ...
          {
            localbbwd.jdField_a_of_type_Int = 3;
          ...
          for (str = "lastTipTime_";; str = "lastDialogTime_")
          {
            ...
            if (localbbwd.jdField_a_of_type_Int == 4) {
              break;
            }
            localSharedPreferences.edit().putLong(str, l).commit();
            break;
            localbbwd.jdField_a_of_type_Int = 2;
            break label365;
          }
        }
        localbbwd.jdField_a_of_type_Int = 4;
  ...
  public static void a(TrafficResultInfo paramTrafficResultInfo, Bundle paramBundle)
  {
    ...
    boolean bool1 = paramBundle.getBoolean(akjo.h);
    boolean bool3 = paramBundle.getBoolean(akjo.i);
    String str2 = paramBundle.getString(akjo.j);
    String str1 = paramBundle.getString(akjo.k);
  ...
  public static boolean a(Activity paramActivity, int paramInt, bbwe parambbwe, String paramString)
  {
    boolean bool = true;
    ...
    {
      return bool;
      localbbwd = a(paramString, false, true);
      if (QLog.isColorLevel()) {
        QLog.i("CUKingCardHelper", 2, "shouldOverrideDialog, popUpType: " + localbbwd.jdField_a_of_type_Int);
      }
    } while (localbbwd.jdField_a_of_type_Int == 4);
    if (localbbwd.jdField_a_of_type_Int == 1)
    {
      if (parambbwe != null) {
        parambbwe.callback(2);
      }
      return false;
    }
    new bbwb(paramActivity, parambbwe, paramInt, paramString, localbbwd.jdField_a_of_type_Int).show();
    return false;
  }
