  ...
  extends IArkDelegateNet
{
  public void download(String paramString, boolean paramBoolean1, boolean paramBoolean2, HashMap<String, String> paramHashMap, File paramFile, IArkDelegateNetCallback paramIArkDelegateNetCallback)
  {
    ...
    for (paramFile = paramFile.getAbsolutePath();; paramFile = "")
    {
      ...
      anqp.a().a("callDownload", (Bundle)localObject, new anrh(this, paramString, paramIArkDelegateNetCallback));
      return;
      str = "";
      break;
      paramHashMap = "";
    ...
    label175:
    Object localObject = ((beag)BaseApplicationImpl.getApplication().getRuntime().getManager(47)).a(1);
    paramFile = new beae(paramString, new File(paramFile));
    ...
    ((beaj)localObject).a(paramFile, new anri(this, paramString, paramIArkDelegateNetCallback), paramHashMap);
  }
  ...
  public void sendAppMsg(String paramString1, String paramString2, int paramInt1, int paramInt2, IArkDelegateNetCallback paramIArkDelegateNetCallback)
  {
    ...
    if (1 != BaseApplicationImpl.sProcessId)
    {
      ...
      anqp.a().a("callSendAppMsg", (Bundle)localObject, new anrf(this, paramString1, paramString2, paramIArkDelegateNetCallback, paramInt2));
      return;
    }
    ...
    ((anoo)localObject).a(paramString1, paramString2, paramInt1, paramInt2, new anrg(this, paramIArkDelegateNetCallback));
  }
}
