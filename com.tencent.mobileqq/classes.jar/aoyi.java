...
class aoyi
{
  ...
  void b(boolean paramBoolean)
  {
    if ((paramBoolean) && (this.jdField_c_of_type_Int < 3))
    {
      ...
      if (this.jdField_c_of_type_Int == 3)
      {
        this.jdField_a_of_type_Aoyg.a.a("hw_video_time_used_msg", "videoEncodeTime:cnt20=" + this.jdField_a_of_type_ArrayOfLong[0] + " cnt1=" + this.jdField_a_of_type_ArrayOfLong[1] + " cnt2" + this.jdField_a_of_type_ArrayOfLong[2]);
        ...
        this.jdField_a_of_type_Aoyg.a.a("hw_video_time_used_msg", "videoEncodeTime:timeout=" + this.jdField_a_of_type_ArrayOfLong[0]);
      }
    }
    do
    {
    ...
    this.jdField_a_of_type_Aoyg.a.a("hw_video_time_used_msg", "audioEncodeTime:cnt20=" + this.jdField_b_of_type_ArrayOfLong[0] + " cnt1=" + this.jdField_b_of_type_ArrayOfLong[1] + " cnt2" + this.jdField_b_of_type_ArrayOfLong[2]);
    ...
    this.jdField_a_of_type_Aoyg.a.a("hw_video_time_used_msg", "audioEncodeTime:timeout=" + this.jdField_b_of_type_ArrayOfLong[0]);
  }
