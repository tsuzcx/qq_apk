...
{
  public luz(RedPacketRollTextView paramRedPacketRollTextView, boolean paramBoolean) {}
  ...
  public View makeView()
  {
    ...
    try
    {
      localStrokeTextView.setLayoutParams(new FrameLayout.LayoutParams(afur.a(42.0F, this.jdField_a_of_type_ComTencentAvRedpacketUiRedPacketRollTextView.getResources()), -1));
      ...
      for (String str = "0";; str = "")
      {
        ...
        localStrokeTextView.setStrokeSize(afur.a(6.0F, this.jdField_a_of_type_ComTencentAvRedpacketUiRedPacketRollTextView.getResources()));
