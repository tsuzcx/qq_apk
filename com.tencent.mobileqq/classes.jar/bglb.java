...
public class bglb
{
  private static bglb jdField_a_of_type_Bglb;
  ...
  private bglb(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    a();
  }
  
  public static final bglb a(Context paramContext)
  {
    if (jdField_a_of_type_Bglb == null) {}
    try
    {
      if (jdField_a_of_type_Bglb == null) {
        jdField_a_of_type_Bglb = new bglb(paramContext);
      }
      return jdField_a_of_type_Bglb;
    }
    finally {}
  }
  ...
  void b()
  {
    ...
    //   9: dup
    //   10: aload_0
    //   11: getfield 36	bglb:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    ...
    //   150: aload_0
    //   151: getfield 34	bglb:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   154: aload_3
    //   155: aload 4
