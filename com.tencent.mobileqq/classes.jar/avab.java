  ...
  extends BaseAdapter
{
  ...
  public avab(Context paramContext, Comments paramComments, VideoData paramVideoData, avcr paramavcr, Paint paramPaint, int paramInt)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewLayoutInflater = LayoutInflater.from(paramContext);
    this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments = paramComments;
    this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelVideoData = paramVideoData;
    this.jdField_a_of_type_Avcr = paramavcr;
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    Object localObject;
    if ((this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments.a != null) && (this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments.a.size() > 0)) {
      if ((paramView == null) || (!(paramView.getTag() instanceof avaf)))
      {
        paramView = new avaf();
        localObject = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561060, paramViewGroup, false);
        paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)((View)localObject).findViewById(2131368737));
        paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)((View)localObject).findViewById(2131378839));
        paramView.jdField_b_of_type_AndroidWidgetTextView = ((TextView)((View)localObject).findViewById(2131378668));
        paramView.jdField_c_of_type_AndroidWidgetTextView = ((TextView)((View)localObject).findViewById(2131378877));
        paramView.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)((View)localObject).findViewById(2131367724));
        paramView.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)((View)localObject).findViewById(2131365997));
        paramView.d = ((ImageView)((View)localObject).findViewById(2131378103));
        ((View)localObject).setTag(2131364554, paramView);
        ...
        localObject = bcxb.a((AppInterface)localObject, 32, str2, 3, paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.getResources().getDrawable(2130844950), paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.getResources().getDrawable(2130844950));
        ...
        paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new avac(this, l1, l2, l3));
        ...
        paramView.setTag(2131364545, this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments.a.get(paramInt));
        paramView.setTag(2131364597, this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments);
    ...
    {
      return localObject;
      paramViewGroup = (avaf)paramView.getTag();
      break;
      ...
      break label318;
      auzw.a().a(paramViewGroup.jdField_a_of_type_AndroidWidgetImageView, ((Comments.Comment)this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments.a.get(paramInt)).jdField_c_of_type_JavaLangString, paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.getResources().getDrawable(2130844950), paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.getResources().getDrawable(2130844950), null, true);
      break label469;
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        for (;;)
        {
          ...
          paramView.findViewById(2131369687).setOnClickListener(new avad(this));
          paramView.setTag("badnet");
          return paramView;
          paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561050, paramViewGroup, false);
        }
      }
    ...
    label910:
    paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561051, paramViewGroup, false);
