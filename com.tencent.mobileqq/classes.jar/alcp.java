  ...
  implements View.OnClickListener
{
  ...
  private static final int[] jdField_b_of_type_ArrayOfInt = { 2131691111, 2130839513 };
  private static final int[] jdField_c_of_type_ArrayOfInt = { 2131691115, 2130839500 };
  private static final int[] jdField_d_of_type_ArrayOfInt = { 2131691113, 2130839518 };
  private static final int[] jdField_e_of_type_ArrayOfInt = { 2131691122, 2130839517 };
  private static final int[] jdField_f_of_type_ArrayOfInt = { 2131691120, 2130839525 };
  private static final int[] jdField_g_of_type_ArrayOfInt = { 2131691114, 2130839519 };
  private static final int[] h = { 2131691118, 2130839524 };
  private static final int[] i = { 2131691117, 2130839523 };
  private static final int[] j = { 2131698256, 2130839526 };
  private static final int[] k = { 2131691116, 2130839521 };
  private static final int[] l = { 2131691123, 2130839517 };
  private static final int[] m = { 2131691112, 2130839514 };
  ...
  static
  {
    jdField_a_of_type_ArrayOfInt = new int[] { 2131691121, 2130839527 };
  }
  
  public alcp(BaseActivity paramBaseActivity)
  {
  ...
  public static Intent a(BaseActivity paramBaseActivity, long paramLong1, long paramLong2, int paramInt)
  {
    ...
    localIntent.putExtra("leftViewText", paramBaseActivity.getString(2131690563));
    localIntent.putExtra("selfSet_leftViewText", paramBaseActivity.getString(2131690563));
  ...
  public static void a(Intent paramIntent, FrameHelperActivity paramFrameHelperActivity)
  {
    ...
    aldk.a(paramFrameHelperActivity, paramIntent);
  }
  ...
  public static boolean a(BaseActivity paramBaseActivity)
  {
    ...
    {
      QQToast.a(paramBaseActivity, anni.a(2131711974), 0).a();
      return false;
    }
    return true;
  }
  ...
  private void o()
  {
    ...
    {
      bknl localbknl = a(j);
      String str2 = blen.a("drawer_plus_text");
      String str1 = str2;
      if (TextUtils.isEmpty(str2)) {
        str1 = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getString(2131698256);
      }
      localbknl.jdField_a_of_type_JavaLangString = str1;
      this.jdField_b_of_type_JavaLangString = localbknl.jdField_a_of_type_JavaLangString;
      this.jdField_a_of_type_JavaUtilList.add(localbknl);
    }
  }
  
  private void p()
  {
    bleu.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, "add");
  }
  
  private void q()
  {
    if (((this.jdField_g_of_type_Boolean) && (!akms.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getCurrentAccountUin(), "F2FRedpackEntry", false))) || ((!this.jdField_g_of_type_Boolean) && (akms.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getCurrentAccountUin(), "F2FRedpackEntry", false))))
    {
      a();
    ...
    if (akms.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getCurrentAccountUin()))
    {
      ...
      if (this.jdField_a_of_type_AndroidWidgetImageView != null) {
        this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130839519);
      }
    }
    for (;;)
    {
      ...
      return;
      if (this.jdField_a_of_type_AndroidWidgetTextView != null) {
        this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidWidgetTextView.getResources().getColor(2131166986));
      }
      if (this.jdField_a_of_type_AndroidWidgetImageView != null) {
        this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130839520);
      }
    }
  }
  ...
  private void r()
  {
    ...
    {
      localObject1 = (LinearLayout)this.jdField_a_of_type_Bkni.getContentView().findViewById(2131364999);
      n = 0;
    }
    for (;;)
    {
      if (n < ((LinearLayout)localObject1).getChildCount())
      {
        try
        {
          ...
          if (((bknl)((View)localObject2).getTag()).jdField_a_of_type_Int == 2131691111)
          {
            localObject2 = (TextView)((View)localObject2).findViewById(2131378613);
          ...
          else if (((bknl)((View)localObject2).getTag()).jdField_a_of_type_Int == 2131691122)
          {
            localObject2 = ((View)localObject2).findViewById(2131368503);
        ...
        if (((bknl)localException.getTag()).jdField_a_of_type_Int == 2131691114)
        {
          this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localException.findViewById(2131378613));
          this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localException.findViewById(2131368503));
          if (akms.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getCurrentAccountUin()))
          {
            this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidWidgetTextView.getResources().getColor(2131165585));
            this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130839519);
      ...
      else
      {
        ...
        {
          localObject1 = ((baif)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app.getManager(36)).a("101210.101211");
  ...
  private void s()
  {
    if (!VideoEnvironment.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app)) {
      bglp.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 230).setMessage(anni.a(2131711976)).setPositiveButton(2131694081, new alct(this)).show();
    }
    do
    {
      return;
      ...
      {
        QQToast.a(BaseApplicationImpl.getContext(), 2131695235, 1).b(BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131298998));
        return;
      }
  ...
  public bknl a(int[] paramArrayOfInt)
  {
    bknl localbknl = new bknl();
    localbknl.jdField_a_of_type_Int = paramArrayOfInt[0];
    localbknl.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getString(paramArrayOfInt[0]);
    localbknl.c = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getString(paramArrayOfInt[0]);
    localbknl.b = paramArrayOfInt[1];
    return localbknl;
  }
  ...
  public void a()
  {
    ...
    Object localObject;
    if (asli.c(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app))
    {
      this.jdField_d_of_type_Boolean = true;
      localObject = a(k);
      this.jdField_a_of_type_JavaLangString = asli.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app);
      if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))
      {
        ((bknl)localObject).jdField_a_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
        ((bknl)localObject).c = this.jdField_a_of_type_JavaLangString;
      }
    ...
    for (this.jdField_f_of_type_Boolean = true;; this.jdField_f_of_type_Boolean = false)
    {
      ...
      localObject = aqpv.a();
      if ((localObject != null) && (((aqpu)localObject).c())) {
      ...
      if ((akms.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getCurrentAccountUin(), "F2FRedpackEntry", false)) && (c()))
      {
        this.jdField_a_of_type_JavaUtilList.add(a(jdField_g_of_type_ArrayOfInt));
        this.jdField_g_of_type_Boolean = true;
        bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "hongbaocaidan.show", 0, 0, "", "", "", "");
      }
      o();
      if (AudioHelper.e()) {
      ...
      this.jdField_a_of_type_Bkni = bkni.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_JavaUtilList, new alcq(this), new alcr(this));
      return;
  ...
  protected void a(int paramInt)
  {
    ...
    bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "CliOper", "", "", "0X8005ED3", "0X8005ED3", 0, 0, "", "", "", "");
  }
  
  public void a(View paramView, int paramInt1, int paramInt2)
  {
    if ((this.jdField_a_of_type_Bkni != null) && (this.jdField_a_of_type_Bkni.jdField_a_of_type_Boolean)) {
    ...
    for (;;)
    {
      ...
      r();
      bncl.a(BaseApplicationImpl.getContext(), "peak_preload_plus_panel");
      b();
      if (this.jdField_d_of_type_Boolean) {
        bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "dc00898", "", "", "0X800A69B", "0X800A69B", 0, 0, "", "", "", "");
      }
      return;
      if (this.jdField_d_of_type_Boolean)
      {
        String str = asli.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app);
      ...
      if (((this.jdField_d_of_type_Boolean) && (!asli.c(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app))) || ((!this.jdField_d_of_type_Boolean) && (asli.c(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app)))) {
        this.jdField_a_of_type_Boolean = true;
      }
      if (((this.jdField_f_of_type_Boolean) && (!nga.a())) || ((!this.jdField_f_of_type_Boolean) && (nga.a()))) {
        this.jdField_a_of_type_Boolean = true;
      }
  ...
  public bknl b(int[] paramArrayOfInt)
  {
    bknl localbknl = new bknl();
    localbknl.jdField_a_of_type_Int = paramArrayOfInt[0];
    localbknl.c = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getString(paramArrayOfInt[0]);
    ...
    {
      localbknl.jdField_a_of_type_JavaLangString = localDItemInfo.showName;
      localbknl.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable = localDItemInfo.drawable;
      return localbknl;
    }
    localbknl.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getString(paramArrayOfInt[0]);
    localbknl.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable = null;
    return localbknl;
  }
  ...
  protected void c()
  {
    ...
    bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "CliOper", "", "", "0X8004077", "0X8004077", 0, 0, "", "", "", "");
  }
  ...
  protected void d()
  {
    ...
    localIntent.putExtra("leftViewText", this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131690563));
    localIntent.putExtra("selfSet_leftViewText", this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131690563));
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.startActivity(localIntent);
    bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "CliOper", "", "", "0X8004839", "0X8004839", 0, 0, "", "", "", "");
    try
    {
      ((baif)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app.getManager(36)).b(String.valueOf("101210.101211"));
      return;
    }
    catch (Exception localException) {}
  }
  ...
  protected void f()
  {
    blhj.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 8, null);
    bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "CliOper", "", "", "0X80053AD", "0X80053AD", 0, 0, "", "", "", "");
  }
  ...
  protected void g()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.startActivity(localIntent);
    bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "jiahao.hongbao.click", 0, 0, "", "", "", "");
  }
  ...
  protected void h()
  {
    ...
    bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "CliOper", "", "", "0X8004074", "0X8004074", 0, 0, "", "", "", "");
    bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "dc00899", "Grp_create", "", "msg_page", "exp_creategrp", 0, 0, "", "", "", "");
  }
  
  protected void i()
  {
    bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "CliOper", "", "", "0X800780A", "0X800780A", 0, 0, "", "", "", "");
    yqu.a("plus_shoot", "clk_entry", 0, 0, new String[] { "", "", "", "" });
    yqu.a("plus_shoot", "exp_shoot", 0, 0, new String[] { "", "", "", "" });
  ...
  {
    if (!VideoEnvironment.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app)) {
      bglp.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 230).setMessage(anni.a(2131711977)).setPositiveButton(2131694081, new alcs(this)).show();
    }
  }
  ...
  protected void k()
  {
    ...
    {
      return;
      boolean bool = bchd.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app);
      RecentDanceConfigMgr.a("showDanceCategoryPanel: videoUsable=" + bool);
      banm.h();
      localObject = bnbe.a(null, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getClass().getName(), 10004, 8, ((RecentDanceConfigMgr.DItemInfo)localObject).unfold, ((RecentDanceConfigMgr.DItemInfo)localObject).categoryID, ((RecentDanceConfigMgr.DItemInfo)localObject).itemID);
      ziv.a().a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, (Bundle)localObject, 9010);
  ...
  protected void m()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity != null) && (this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app != null))
    {
      ...
      asmj.a().b(4);
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "dc00898", "", "", "0X800A69C", "0X800A69C", 0, 0, "", "", "", "");
      return;
    }
  ...
  protected void n()
  {
    bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "dc00898", "", "", "0X800B010", "0X800B010", 0, 0, "", "", "", "");
    if (this.jdField_a_of_type_Net == null) {
      this.jdField_a_of_type_Net = new net(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity);
    }
    this.jdField_a_of_type_Net.onClick(null);
    mwd.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app);
  }
