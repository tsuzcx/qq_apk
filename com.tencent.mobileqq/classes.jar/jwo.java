...
public class jwo
  implements Runnable
{
  public jwo(MultiVideoCtrlLayerUI4Discussion paramMultiVideoCtrlLayerUI4Discussion, int paramInt1, String paramString, int paramInt2, int paramInt3) {}
  ...
  public void run()
  {
    ...
    String str2 = null;
    String str1;
    if (this.jdField_a_of_type_Int == 2131428963)
    {
    ...
    for (;;)
    {
      float f = this.jdField_a_of_type_ComTencentAvUiMultiVideoCtrlLayerUI4Discussion.jdField_a_of_type_AndroidContentResResources.getDimensionPixelSize(2131559815);
