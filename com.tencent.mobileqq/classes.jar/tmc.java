      ...
      for (;;)
      {
        ...
        if ("getCache".equals(paramString))
        {
          try
          {
            ...
            rvd.a().a(paramJSONObject.getString("url"), paramJSONObject.toString(), new tmd(paramOnInovkeCallback));
            return;
          }
          catch (JSONException paramString)
          {
        ...
        else if ("writeCache".equals(paramString))
        {
          try
          {
            ...
            {
              paramJSONObject.put("callid", 0);
              rvd.a().a(paramJSONObject.getString("url"), paramJSONObject.toString(), null, paramJSONObject);
              return;
            }
          }
          catch (JSONException paramString)
