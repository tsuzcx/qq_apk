...
public class awmx
  implements awis
{
  public awmx(MapWidget paramMapWidget) {}
  ...
  {
    Object localObject = (arbn)aqxe.a().a(575);
    if (localObject != null) {}
    for (localObject = ((arbn)localObject).a();; localObject = null)
    {
      if (TextUtils.isEmpty((CharSequence)localObject)) {}
      for (localObject = this.a.jdField_a_of_type_ComTencentTencentmapMapsdkMapsTencentMap.addMarker(new MarkerOptions(paramVenue.jdField_a_of_type_ComTencentTencentmapMapsdkMapsModelLatLng).anchor(0.5F, 0.8F).zIndex(2.147484E+009F).icon(BitmapDescriptorFactory.fromResource(2130840652)));; localObject = this.a.jdField_a_of_type_ComTencentTencentmapMapsdkMapsTencentMap.addMarker(new MarkerOptions(paramVenue.jdField_a_of_type_ComTencentTencentmapMapsdkMapsModelLatLng).anchor(0.5F, 0.8F).zIndex(2.147484E+009F).icon(BitmapDescriptorFactory.fromBitmap((Bitmap)localObject))))
      {
        if (localObject != null)
        {
        ...
        localObject = bheg.b((Drawable)localObject);
      }
    }
  }
