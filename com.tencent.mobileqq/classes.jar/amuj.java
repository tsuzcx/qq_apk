  ...
  implements Handler.Callback
{
  ...
  amuj(QQAppInterface paramQQAppInterface, Context paramContext, amul paramamul)
  {
    super(paramContext);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    if (paramMessage.what == f) {
      if (this.i == c)
      {
        ...
        j = Math.min(j, 99);
        paramMessage = String.format(ajjy.a(2131637084), new Object[] { Integer.valueOf(j) });
        this.jdField_a_of_type_AndroidWidgetTextView.setText(paramMessage);
        this.jdField_a_of_type_Beez.sendEmptyMessageDelayed(f, 500L);
      }
    }
      ...
      do
      {
        ...
        if (this.i == d)
        {
          ...
          if (!this.jdField_b_of_type_JavaIoFile.renameTo(this.jdField_a_of_type_JavaIoFile))
          {
            ...
            boolean bool = bace.a(this.jdField_b_of_type_JavaIoFile, this.jdField_a_of_type_JavaIoFile);
            bace.d(this.jdField_b_of_type_JavaIoFile.getPath());
            if (!bool)
            {
              QLog.d(jdField_a_of_type_JavaLangString, 1, "db fix succ but copy fail final");
              paramMessage = new HashMap();
              awrn.a(BaseApplication.getContext()).a(null, DBFixManager.m, true, -1L, 0L, paramMessage, null, false);
            }
          }
          this.jdField_a_of_type_AndroidWidgetTextView.setText(ajjy.a(2131637085));
          this.jdField_a_of_type_Beez.sendEmptyMessageDelayed(g, 100L);
          return false;
        }
      } while (this.i != e);
      dismiss();
      this.jdField_a_of_type_Amul.a(this.i);
      return false;
    }
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    super.setContentView(2131493639);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131299371));
    ...
    for (int j = 1;; j = 2)
    {
      ...
      super.setOnKeyListener(new amuk(this));
      return;
    }
  }
  ...
  {
    super.onStart();
    this.jdField_a_of_type_Beez.sendEmptyMessage(f);
  }
}
