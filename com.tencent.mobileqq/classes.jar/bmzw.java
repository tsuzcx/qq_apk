  ...
  implements Handler.Callback
{
  ...
  public bmzw(bmzx parambmzx, ReleaseLooperHandler paramReleaseLooperHandler)
  {
  ...
  private void b(bmzc parambmzc)
  {
    ...
    do
    {
        ...
        do
        {
          do
          {
            ...
            do
            {
              ...
              {
                this.jdField_a_of_type_Bmzx.a(parambmzc.a(), true, false, false, str2);
                return;
              }
            } while (parambmzc.d());
            if (!IOUtils.ensureStorageSpace(str4, l1 - l2))
            {
              this.jdField_a_of_type_Bmzx.a(parambmzc.a(), false, false, true, "");
              return;
            }
          } while (parambmzc.d());
          if (!IOUtils.ensureWritable(str4))
          {
            this.jdField_a_of_type_Bmzx.a(parambmzc.a(), false, true, false, "");
            return;
          }
        } while (parambmzc.d());
        localObject = IOUtils.ensureFilePath(str4, parambmzc.a().b);
      } while (parambmzc.d());
      String str1 = a(str3);
      if ((!TextUtils.isEmpty(str1)) && (!TextUtils.equals(str2, str1)) && (TextUtils.equals(str3, IOUtils.getFileSha1(str1))))
      {
        ...
        for (;;)
        {
          this.jdField_a_of_type_Bmzx.a(parambmzc.a(), bool, false, false, (String)localObject);
          return;
          bool = IOUtils.copyFileAndNotifyOS(WeiyunTransmissionGlobal.getInstance().getContext(), str1, (String)localObject);
        }
      }
    } while (parambmzc.d());
    this.jdField_a_of_type_Bmzx.a(parambmzc.a(), false, false, false, (String)localObject);
  }
  
  public void a(bmzc parambmzc)
  {
    if (parambmzc == null) {
      return;
    }
    this.jdField_a_of_type_ComTencentWeiyunTransmissionUtilsHandlerReleaseLooperHandler.sendMessage(Message.obtain(null, 11, parambmzc));
  }
