...
public class srm
{
  ...
  public static srm a(qqstory_service.PromoteTask paramPromoteTask)
  {
    srm localsrm = new srm();
    localsrm.jdField_a_of_type_Long = paramPromoteTask.uint64_taskid.get();
    localsrm.jdField_a_of_type_Int = paramPromoteTask.uint32_promote_type.get();
    localsrm.jdField_a_of_type_JavaLangString = paramPromoteTask.bytes_union_id.get().toStringUtf8();
    localsrm.jdField_b_of_type_JavaLangString = paramPromoteTask.bytes_feed_id.get().toStringUtf8();
    localsrm.jdField_b_of_type_Long = paramPromoteTask.uint64_limit_count.get();
    localsrm.c = paramPromoteTask.uint64_minimal_video_count.get();
    localsrm.d = paramPromoteTask.uint64_expire_time.get();
    return localsrm;
  }
