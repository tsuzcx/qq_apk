  ...
  extends sro
{
  ...
  public srm(float paramFloat)
  {
    this.jdField_a_of_type_Float = paramFloat;
    this.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
    this.b = 500;
    this.jdField_a_of_type_Srp = new srp((int)paramFloat);
    a(this.jdField_a_of_type_Srp);
  }
  
  private void c()
  {
    int i = (int)(Math.sqrt(this.jdField_a_of_type_Srp.a) * this.jdField_a_of_type_Float);
    if (i > 0) {
      this.b = i;
    }
  }
