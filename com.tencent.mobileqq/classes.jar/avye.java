  ...
  extends avym
{
  ...
  public avye(ViewGroup paramViewGroup, int paramInt)
  {
    this.jdField_a_of_type_Int = paramInt;
    switch (this.jdField_a_of_type_Int)
    {
    default: 
      this.jdField_c_of_type_Int = 2131494072;
    }
    for (;;)
    {
      ...
      a();
      return;
      this.jdField_c_of_type_Int = 2131494563;
      continue;
      this.jdField_c_of_type_Int = 2131494038;
      continue;
      this.jdField_c_of_type_Int = 2131495331;
      continue;
      this.jdField_c_of_type_Int = 2131495332;
    }
  }
  ...
  {
    super.a();
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131302061));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131299248));
    switch (this.jdField_a_of_type_Int)
    {
    }
    for (;;)
    {
      this.jdField_a_of_type_AndroidViewView = this.jdField_b_of_type_AndroidViewView.findViewById(2131299168);
      if (this.jdField_a_of_type_AndroidViewView != null) {
        this.jdField_a_of_type_AndroidViewView.setTag("ActiveEntitySearchResultPresenter_add_troop");
      }
      this.e = this.jdField_b_of_type_AndroidViewView.findViewById(2131306251);
      if (this.e != null)
      {
        this.e.setTag("ActiveEntitySearchResultPresenter_pay_troop");
        if ((this.e instanceof ThemeImageView)) {
          ((ThemeImageView)this.e).setMaskShape(beog.jdField_c_of_type_Int);
        }
      }
      this.jdField_a_of_type_ComTencentMobileqqTroopWidgetTroopActiveLayout = ((TroopActiveLayout)this.jdField_b_of_type_AndroidViewView.findViewById(2131296411));
      ...
      this.jdField_a_of_type_ComTencentMobileqqWidgetFolderTextView = ((FolderTextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131300897));
      ...
      return;
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_b_of_type_AndroidViewView.findViewById(2131309433));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131309443));
      this.jdField_b_of_type_ComTencentMobileqqTroopWidgetTroopLabelLayout = ((TroopLabelLayout)this.jdField_b_of_type_AndroidViewView.findViewById(2131312004));
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131304161));
      this.f = this.jdField_b_of_type_AndroidViewView.findViewById(2131312503);
      continue;
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131311924));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131311887));
      this.jdField_a_of_type_ComTencentMobileqqTroopWidgetTroopLabelLayout = ((TroopLabelLayout)this.jdField_b_of_type_AndroidViewView.findViewById(2131312004));
      if (this.h != null)
      {
        TextView localTextView = this.h;
        int j = awmc.jdField_a_of_type_Int - awmc.a(187.0F);
        int i = j;
        if (j <= 0) {
          i = awmc.a(220.0F);
        }
