  ...
  extends bdsh
{
  ...
  public bduc(BaseApplicationImpl paramBaseApplicationImpl)
  {
  ...
  /* Error */
  protected File a(DownloadParams paramDownloadParams, aror paramaror)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 5
    ...
    //   26: getstatic 55	bduc:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    ...
    //   125: getstatic 108	bdnh:c	[Ljava/lang/String;
    //   128: astore 8
    //   130: aload 8
    //   132: arraylength
    //   133: istore 4
    ...
    //   172: getstatic 55	bduc:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    ...
    //   214: pop
    //   215: aload_0
    //   216: getfield 22	bduc:jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl	Lcom/tencent/common/app/BaseApplicationImpl;
    ...
    //   358: invokestatic 170	bctj:a	(Landroid/content/Context;)Lbctj;
    //   361: aconst_null
    //   362: ldc 172
    //   364: iconst_1
    //   365: lconst_0
    ...
    //   367: aconst_null
    //   368: ldc 24
    //   370: invokevirtual 175	bctj:a	(Ljava/lang/String;Ljava/lang/String;ZJJLjava/util/HashMap;Ljava/lang/String;)V
    //   373: aload 7
    //   375: areturn
    //   376: aload_2
    //   377: ifnull -4 -> 373
    ...
    //   398: invokevirtual 190	aror:b	(Ljava/lang/String;)V
    //   401: aload_2
    //   402: iconst_0
    //   403: invokevirtual 193	aror:c	(Z)V
    //   406: aload_2
    //   407: iconst_0
    //   408: invokevirtual 196	aror:d	(Z)V
    //   411: aload 7
    //   413: areturn
    //   414: aload_2
    //   415: ifnull -42 -> 373
    //   418: aload_2
    //   419: iconst_1
    //   420: invokevirtual 196	aror:d	(Z)V
    //   423: aload 7
    //   425: areturn
    //   426: astore_2
    //   427: aconst_null
    ...
    for (;;)
    {
      try
      {
        ...
        try
        {
          ...
          paramOutputStream = (arno)paramOutputStream.getManager(77);
          if (paramOutputStream == null) {
            break label278;
          }
          paramOutputStream = (aror)paramOutputStream.a("qq.android.system.face.gifv14");
      ...
      catch (Exception paramOutputStream)
      {
        ...
        paramDownloadParams.put("param_FailMsg", bdsi.a(paramOutputStream));
        bctj.a(BaseApplication.getContext()).a(null, "system_face_decode_copyfile", false, 0L, 0L, paramDownloadParams, "");
        if (!QLog.isColorLevel()) {
          continue;
        }
      ...
      bctj.a(BaseApplication.getContext()).a(null, "system_face_decode_copyfile", false, 0L, 0L, paramOutputStream, "");
