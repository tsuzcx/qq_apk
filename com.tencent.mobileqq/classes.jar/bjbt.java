  ...
  implements InputFilter
{
  ...
  public bjbt(ExtendEditText paramExtendEditText, int paramInt)
  {
  ...
  {
    ahoe localahoe = ExtendEditText.a(this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewExtendEditText);
    if (localahoe == null)
    {
