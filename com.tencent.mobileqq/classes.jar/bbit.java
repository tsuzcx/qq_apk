...
public class bbit
  implements Manager
{
  private static final String d = amtj.a(2131712794);
  private static final String e = amtj.a(2131712793);
  public Handler a;
  public bfmf a;
  public bfmn a;
  ...
  public bbit(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(String paramString1, String paramString2, long paramLong, String paramString3)
  {
    ...
    //   0: aload_0
    //   1: aload_0
    //   2: getfield 101	bbit:jdField_a_of_type_Bfmf	Lbfmf;
    //   5: aload_1
    //   6: invokevirtual 106	bfmf:b	(Ljava/lang/String;)Ljava/lang/String;
    //   9: invokevirtual 109	bbit:a	(Ljava/lang/String;)Ljava/io/File;
    //   12: astore 9
    //   14: aload 9
    //   16: ifnull +651 -> 667
    //   19: aload 9
    ...
    //   52: aastore
    //   53: invokevirtual 131	bbit:a	(JI[Ljava/lang/Object;)V
    //   56: aload_0
    //   57: lload_3
    //   58: iconst_3
    //   59: iconst_1
    ...
    //   70: aastore
    //   71: invokevirtual 131	bbit:a	(JI[Ljava/lang/Object;)V
    ...
    //   158: dup
    //   159: aload_0
    //   160: getfield 43	bbit:b	Ljava/lang/String;
    ...
    //   321: aastore
    //   322: invokevirtual 131	bbit:a	(JI[Ljava/lang/Object;)V
    //   325: aload_2
    //   326: ifnull +7 -> 333
    //   329: aload_2
    ...
    //   448: aastore
    //   449: invokevirtual 131	bbit:a	(JI[Ljava/lang/Object;)V
    //   452: aload 5
    //   454: ifnull +8 -> 462
    //   457: aload 5
    ...
    //   518: invokevirtual 131	bbit:a	(JI[Ljava/lang/Object;)V
    //   521: aload 7
    //   523: ifnull +8 -> 531
    //   526: aload 7
    ...
    //   644: aastore
    //   645: invokevirtual 131	bbit:a	(JI[Ljava/lang/Object;)V
    //   648: goto -127 -> 521
    //   651: astore_1
    //   652: aload_1
    ...
    //   676: ldc_w 300
    //   679: aastore
    //   680: invokevirtual 131	bbit:a	(JI[Ljava/lang/Object;)V
    //   683: return
    //   684: astore_2
    //   685: aconst_null
    //   686: astore_1
  ...
  {
    this.jdField_a_of_type_Bfmf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), paramLong);
  }
  ...
  public void a(long paramLong, int paramInt, Object... paramVarArgs)
  {
    ...
    case 1: 
      try
      {
        this.jdField_a_of_type_Bfmn.a(paramLong, paramInt, null);
        return;
      }
    ...
    case 2: 
      ...
      this.jdField_a_of_type_Bfmn.a(paramLong, paramInt, localJSONObject);
      return;
    case 3: 
      localJSONObject = new JSONObject();
      if (paramVarArgs.length > 0) {
  ...
  public void a(long paramLong, String paramString, Map<String, Object> paramMap, List<bfmr> paramList)
  {
    JSONObject localJSONObject = new JSONObject();
    JSONArray localJSONArray = new JSONArray();
    int i = 0;
    ...
    {
      localJSONArray.put(((bfmr)paramList.get(i)).a());
      i += 1;
    }
    try
    {
    ...
    {
      return;
      localJSONObject.put("dns", this.jdField_a_of_type_Bfmf.a());
      localJSONObject.put("ip", this.jdField_a_of_type_Bfmf.d(paramString));
  ...
  {
    this.jdField_a_of_type_Bfmn.a(paramLong, 0, paramJSONObject);
  }
  
  public void a(String paramString1, int paramInt, long paramLong1, long paramLong2, String paramString2)
  {
    this.jdField_a_of_type_Bfmf.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), paramString1, paramInt, paramLong1, paramLong2, paramString2);
  }
  ...
  {
    if (this.jdField_a_of_type_Bfmf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), paramLong)) {
  ...
  public void a(submsgtype0x7c.MsgBody paramMsgBody, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_AndroidOsHandler == null)
    {
      ...
      this.jdField_a_of_type_Bfmf = new bfmf(new SnapshotResultReceiver(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidOsHandler));
    }
    if (this.jdField_a_of_type_Bfmn == null) {
      this.jdField_a_of_type_Bfmn = new bfmn(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    }
  ...
  public boolean a(File paramFile)
  {
    ...
    //   39: aload_0
    //   40: getfield 47	bbit:c	Ljava/lang/String;
    ...
    //   49: invokevirtual 109	bbit:a	(Ljava/lang/String;)Ljava/io/File;
    //   52: astore_1
    //   53: aload_1
  ...
  public boolean a(String paramString1, long paramLong, String paramString2, boolean paramBoolean)
  {
    ...
    //   21: dup
    //   22: aload_0
    //   23: invokespecial 573	bbiu:<init>	(Lbbit;)V
    //   26: astore 18
    //   28: aload_0
    //   29: aload_1
    //   30: invokevirtual 109	bbit:a	(Ljava/lang/String;)Ljava/io/File;
    //   33: astore 16
    //   35: aload 16
    //   37: ifnull +19 -> 56
    //   40: aload 16
    ...
    //   63: dup
    //   64: iconst_0
    //   65: getstatic 30	bbit:e	Ljava/lang/String;
    //   68: aastore
    //   69: invokevirtual 131	bbit:a	(JI[Ljava/lang/Object;)V
    ...
    //   157: aload_0
    //   158: getfield 47	bbit:c	Ljava/lang/String;
    ...
    //   167: invokevirtual 109	bbit:a	(Ljava/lang/String;)Ljava/io/File;
    //   170: astore_1
    //   171: aload_1
    //   172: ifnull +15 -> 187
    //   175: aload_1
    ...
    //   187: aload 18
    //   189: iconst_1
    //   190: invokestatic 578	bbiu:a	(Lbbiu;Z)Z
    //   193: pop
    //   194: iconst_0
    //   195: ireturn
    //   196: astore_1
    ...
    //   249: dup
    //   250: iconst_0
    //   251: getstatic 27	bbit:d	Ljava/lang/String;
    //   254: aastore
    //   255: invokevirtual 131	bbit:a	(JI[Ljava/lang/Object;)V
    ...
    //   347: aload_0
    //   348: getfield 47	bbit:c	Ljava/lang/String;
    ...
    //   357: invokevirtual 109	bbit:a	(Ljava/lang/String;)Ljava/io/File;
    //   360: astore_1
    //   361: aload_1
    //   362: ifnull +15 -> 377
    //   365: aload_1
    ...
    //   377: aload 18
    //   379: iconst_1
    //   380: invokestatic 578	bbiu:a	(Lbbiu;Z)Z
    //   383: pop
    //   384: iconst_0
    //   385: ireturn
    //   386: astore_1
    ...
    //   467: aload_0
    //   468: aload 16
    //   470: invokevirtual 599	bbit:a	(Ljava/io/File;)Z
    //   473: ifeq +209 -> 682
    //   476: aload_0
    ...
    //   488: aload_0
    //   489: getfield 47	bbit:c	Ljava/lang/String;
    ...
    //   498: invokevirtual 109	bbit:a	(Ljava/lang/String;)Ljava/io/File;
    //   501: astore 16
    //   503: aload 16
    //   505: ifnull +23 -> 528
    //   508: aload 16
    ...
    //   554: aload_0
    //   555: getfield 47	bbit:c	Ljava/lang/String;
    ...
    //   620: aload_0
    //   621: getfield 47	bbit:c	Ljava/lang/String;
    ...
    //   630: invokevirtual 109	bbit:a	(Ljava/lang/String;)Ljava/io/File;
    //   633: astore_1
    //   634: aload_1
    //   635: ifnull +15 -> 650
    //   638: aload_1
    ...
    //   650: aload 18
    //   652: iconst_1
    //   653: invokestatic 578	bbiu:a	(Lbbiu;Z)Z
    //   656: pop
    //   657: iconst_0
    //   658: ireturn
    //   659: astore_1
    ...
    //   735: aload_0
    //   736: getfield 47	bbit:c	Ljava/lang/String;
    ...
    //   745: invokevirtual 109	bbit:a	(Ljava/lang/String;)Ljava/io/File;
    //   748: astore_1
    //   749: aload_1
    //   750: ifnull +15 -> 765
    //   753: aload_1
    ...
    //   765: aload 18
    //   767: iconst_1
    //   768: invokestatic 578	bbiu:a	(Lbbiu;Z)Z
    //   771: pop
    //   772: iconst_0
    //   773: ireturn
    //   774: astore_1
    ...
    //   878: aload 16
    //   880: aload 4
    //   882: invokevirtual 619	bbit:a	(Ljava/util/TreeMap;Ljava/lang/String;)Ljava/lang/String;
    //   885: invokevirtual 605	java/util/TreeMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   888: pop
    //   889: aload_0
    //   890: getfield 39	bbit:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   893: astore 4
    //   895: aload 16
    ...
    //   1064: aload_0
    //   1065: getfield 49	bbit:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1068: iconst_2
    ...
    //   1095: aload_0
    //   1096: getfield 49	bbit:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   1111: aload 11
    //   1113: aload_0
    //   1114: getfield 49	bbit:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   1319: iload 6
    //   1321: i2f
    //   1322: invokestatic 682	bbiu:a	(Lbbiu;F)F
    //   1325: pop
    //   1326: aload_0
    //   1327: getfield 101	bbit:jdField_a_of_type_Bfmf	Lbfmf;
    //   1330: invokevirtual 685	bfmf:a	()Landroid/os/Handler;
    //   1333: new 687	com/tencent/mobileqq/secspy/SecSpyFileManager$3
    //   1336: dup
    //   1337: aload_0
    //   1338: aload 18
    //   1340: lload_2
    //   1341: invokespecial 690	com/tencent/mobileqq/secspy/SecSpyFileManager$3:<init>	(Lbbit;Lbbiu;J)V
    //   1344: ldc2_w 691
    ...
    //   1378: aload 18
    //   1380: aload 18
    //   1382: invokestatic 700	bbiu:a	(Lbbiu;)F
    //   1385: iload 6
    //   1387: i2f
    //   1388: fadd
    //   1389: invokestatic 702	bbiu:b	(Lbbiu;F)F
    //   1392: pop
    //   1393: aload 12
    ...
    //   1600: aload_0
    //   1601: getfield 47	bbit:c	Ljava/lang/String;
    ...
    //   1610: invokevirtual 109	bbit:a	(Ljava/lang/String;)Ljava/io/File;
    //   1613: astore_1
    //   1614: aload_1
    //   1615: ifnull +15 -> 1630
    //   1618: aload_1
    ...
    //   1630: aload 18
    //   1632: iconst_1
    //   1633: invokestatic 578	bbiu:a	(Lbbiu;Z)Z
    //   1636: pop
    //   1637: iload 10
    //   1639: ireturn
    //   1640: astore_1
    ...
    //   1706: aastore
    //   1707: invokevirtual 131	bbit:a	(JI[Ljava/lang/Object;)V
    //   1710: aload 11
    //   1712: ifnull +8 -> 1720
    //   1715: aload 11
    ...
    //   1757: aload_0
    //   1758: getfield 47	bbit:c	Ljava/lang/String;
    ...
    //   1767: invokevirtual 109	bbit:a	(Ljava/lang/String;)Ljava/io/File;
    //   1770: astore_1
    //   1771: aload_1
    //   1772: ifnull +15 -> 1787
    //   1775: aload_1
    ...
    //   1787: aload 18
    //   1789: iconst_1
    //   1790: invokestatic 578	bbiu:a	(Lbbiu;Z)Z
    //   1793: pop
    //   1794: iconst_0
    //   1795: ireturn
    //   1796: astore_1
    ...
    //   1876: aload_0
    //   1877: getfield 47	bbit:c	Ljava/lang/String;
    ...
    //   1886: invokevirtual 109	bbit:a	(Ljava/lang/String;)Ljava/io/File;
    //   1889: astore_1
    //   1890: aload_1
    //   1891: ifnull +15 -> 1906
    //   1894: aload_1
    ...
    //   1906: aload 18
    //   1908: iconst_1
    //   1909: invokestatic 578	bbiu:a	(Lbbiu;Z)Z
    //   1912: pop
    //   1913: aload 4
    //   1915: athrow
    //   1916: astore_1
  ...
  {
    a(this.jdField_a_of_type_Bfmf.a(paramList), paramLong, paramString, false);
    bfmp.a(paramList);
    paramList.clear();
  }
