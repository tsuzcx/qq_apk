    ...
    if ((paramFile.exists()) && (paramFile.isDirectory()))
    {
      ...
      if (i < j)
      {
        ...
        for (;;)
        {
          ...
          {
            localObject2 = paramFile.getAbsolutePath() + "/" + anws.a((String)localObject2);
            FileUtils.createFileIfNotExits((String)localObject2 + "/.moveflag");
            anws.a(((File)localObject1).getAbsolutePath(), (String)localObject2);
          }
        }
      }
    }
      ...
      while (k < n)
      {
        ...
        if (arrayOfFile.isDirectory())
        {
          ...
          if (((String)localObject1).length() > 4)
          {
            ...
            {
              if (anws.a(arrayOfFile).length > 0)
              {
                localObject2 = anws.a(arrayOfFile);
                ...
                for (;;)
                {
                  ...
                  if (((File)localObject3).isDirectory())
                  {
                    ...
                    {
                      localObject3 = anws.a((File)localObject3);
                      ...
                      while (i < j)
                      {
                        ...
                        {
                          FileUtils.createFileIfNotExits(ThemeDiyStyleLogic.getSdcardDIYDir() + anws.a((String)localObject1) + "/.moveflag");
                          FileUtils.quickMove(localObject4.getAbsolutePath(), ThemeDiyStyleLogic.getSdcardDIYDir() + anws.a((String)localObject1) + "/" + localObject4.getName());
                        }
                        i += 1;
                      }
                      j = 1;
