...
public class anwv
{
  ...
  public static int a(anvz paramanvz, int paramInt1, int paramInt2)
  {
    int i = paramInt2;
    if (paramInt2 == -1) {
      i = 0;
    }
    Camera.CameraInfo localCameraInfo = paramanvz.a()[paramInt1];
    if (localCameraInfo.facing == 1) {
      return (paramanvz.a().a(paramInt1, localCameraInfo.orientation) - i + 360) % 360;
    }
    return (paramanvz.a().a(paramInt1, localCameraInfo.orientation) + i) % 360;
  }
  ...
  public static Bitmap a(Bitmap paramBitmap)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.i("Q.camera.CameraUtils", 4, "clipBitmapToScreenRatio bmpWidth=" + j + " bmpHeight=" + i + " screenWidth=" + azgq.a + " screenHeight=" + azgq.b);
    }
    if (i < j) {
      return paramBitmap;
    }
    double d = azgq.b * 1.0D / azgq.a;
    if (d > i * 1.0D / j)
    {
      k = (int)(i / d);
      if (QLog.isColorLevel()) {
  ...
  public static boolean a()
  {
    ...
    for (;;)
    {
      ...
      azmz.a(BaseApplication.getContext()).a(null, "qcamera_choice_type", false, 0L, 0L, (HashMap)localObject, "");
  ...
  private static boolean a(SharedPreferences paramSharedPreferences, String paramString, int paramInt)
  {
    ...
    //   115: aload 6
    //   117: astore 5
    //   119: invokestatic 282	anwu:a	()Lanwu;
    //   122: invokevirtual 284	anwu:a	()Ljava/lang/String;
    //   125: astore 9
    //   127: aload 6
    //   129: astore 5
  ...
  {
    return Build.VERSION.SDK_INT >= anwt.a().a();
  }
