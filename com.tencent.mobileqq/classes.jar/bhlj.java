  ...
  extends DynamicTextItem
{
  ...
  public bhlj(int paramInt, @NonNull List<String> paramList, Typeface paramTypeface, Bitmap paramBitmap1, Bitmap paramBitmap2, Bitmap paramBitmap3)
  {
    ...
    this.jdField_b_of_type_Int = aciy.a(this.jdField_b_of_type_Int, this.jdField_a_of_type_AndroidContentResResources);
    this.jdField_d_of_type_Int = aciy.a(this.jdField_d_of_type_Int, this.jdField_a_of_type_AndroidContentResResources);
    this.jdField_c_of_type_Int = aciy.a(this.jdField_c_of_type_Int, this.jdField_a_of_type_AndroidContentResResources);
    this.e = aciy.a(this.e, this.jdField_a_of_type_AndroidContentResResources);
    this.f = aciy.a(this.f, this.jdField_a_of_type_AndroidContentResResources);
    this.g = aciy.a(this.g, this.jdField_a_of_type_AndroidContentResResources);
  ...
  private void a(Typeface paramTypeface)
  {
    ...
    this.jdField_b_of_type_AndroidTextTextPaint.setStrokeWidth(aciy.a(2.0F, this.jdField_a_of_type_AndroidContentResResources));
    if (Build.VERSION.SDK_INT >= 21) {
      this.jdField_b_of_type_AndroidTextTextPaint.setShadowLayer(aciy.a(1.0F, this.jdField_a_of_type_AndroidContentResResources), aciy.a(1.0F, this.jdField_a_of_type_AndroidContentResResources), aciy.a(1.0F, this.jdField_a_of_type_AndroidContentResResources), Color.parseColor("#33000000"));
    }
  }
  ...
  public InputFilter a()
  {
    if (this.jdField_a_of_type_AndroidTextInputFilter == null) {
      this.jdField_a_of_type_AndroidTextInputFilter = new bhll(this, 20);
    }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    paramString = azjg.b(super.a(paramInt, new bhlk(this))).replaceAll("\n", "");
