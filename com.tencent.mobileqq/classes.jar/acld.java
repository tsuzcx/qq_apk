...
class acld
  extends nmf
{
  acld(aclb paramaclb, acjr paramacjr) {}
  
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    if (QLog.isColorLevel()) {
      QLog.i(aclb.jdField_a_of_type_JavaLangString, 2, "onResult appid=" + aclb.a(this.jdField_a_of_type_Aclb).jdField_a_of_type_JavaLangString + ", openid=" + this.jdField_a_of_type_Aclb.jdField_a_of_type_Acle.jdField_a_of_type_JavaLangString + ", openkey=" + this.jdField_a_of_type_Aclb.jdField_a_of_type_Acle.b + ", code=" + paramInt);
    }
    if ((paramInt != 0) || (paramArrayOfByte == null))
    {
      acmy.a(this.jdField_a_of_type_Acjr, paramInt, "getappfriends result error, try again");
      return;
    }
    ...
    catch (InvalidProtocolBufferMicroException paramBundle)
    {
      ...
      try
      {
        ...
        acmy.a(this.jdField_a_of_type_Acjr, paramBundle);
        return;
      }
      catch (JSONException paramArrayOfByte)
      {
        ...
        {
          if (QLog.isColorLevel()) {
            QLog.e(aclb.jdField_a_of_type_JavaLangString, 2, paramArrayOfByte.getMessage(), paramArrayOfByte);
          }
        }
      }
      acmy.a(this.jdField_a_of_type_Acjr, -1, "parse result error, try again");
    }
