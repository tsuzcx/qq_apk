  ...
  protected Boolean a(Void... paramVarArgs)
  {
    for (;;)
    {
      try
      {
        ...
        ammy.a((QQAppInterface)localObject);
        if ((!ammy.jdField_a_of_type_Boolean) || (ammy.jdField_c_of_type_Boolean) || (ammy.jdField_a_of_type_AndroidContentIntent == null)) {
          return Boolean.valueOf(false);
        }
        if ((ammy.b != 0) && (Build.VERSION.SDK_INT > ammy.b)) {
          return Boolean.valueOf(false);
        }
        ...
        if (QQToast.a() == 0)
        {
          ...
          if (i != 0)
          {
            if (!ammy.a((QQAppInterface)localObject)) {
              return Boolean.valueOf(false);
            }
            localObject = PreferenceManager.getDefaultSharedPreferences(((QQAppInterface)localObject).getApp());
            long l3 = System.currentTimeMillis();
            if (ammy.a() == -1L) {
              ammy.a(((SharedPreferences)localObject).getLong("push_open_notify_lasttime", l3));
            }
            long l1 = 0L;
            i = 0;
            ...
            if (n == 1)
            {
              l1 = ammy.jdField_c_of_type_Int * ammy.jdField_a_of_type_Long;
              i = ammy.d;
              j = i;
              m = i1;
              l2 = l1;
              ...
              if (i1 >= i)
              {
                ...
                if (n == 1)
                {
                  l2 = ammy.jdField_c_of_type_Int * ammy.jdField_a_of_type_Long;
                  j = ammy.d;
                  k = n;
                  m = i1;
                }
              ...
              else
              {
                if (QLog.isColorLevel()) {
                  QLog.d("PushOpenNotify", 2, new Object[] { "PopOpenMsgNotifation, stage:", Integer.valueOf(k), " stagecount:", Integer.valueOf(m), " count:", Integer.valueOf(i2), " countMax:", Integer.valueOf(j), " pushInteral:", Long.valueOf(l2), " timeDiff:", Long.valueOf(l3 - ammy.a()) });
                }
                if ((l3 - ammy.a() <= l2) && (i2 != 0)) {
                  break label754;
                }
                ammy.a(l3);
            ...
            else
            {
              if (n == 2)
              {
                l1 = ammy.e * ammy.jdField_a_of_type_Long;
                i = ammy.f;
                continue;
              }
              if (n != 3) {
              ...
              l1 = ammy.g * ammy.jdField_a_of_type_Long;
              i = 2147483647;
              continue;
            }
            if (n == 2)
            {
              l2 = ammy.e * ammy.jdField_a_of_type_Long;
              j = ammy.f;
              m = i1;
              k = n;
              continue;
            ...
            l1 = ammy.g;
            l2 = ammy.jdField_a_of_type_Long;
            l2 = l1 * l2;
            j = 2147483647;
            m = i1;
            k = n;
