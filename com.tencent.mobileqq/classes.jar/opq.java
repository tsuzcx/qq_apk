...
{
  public opq(EcshopNewPageFragment paramEcshopNewPageFragment) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.i("Ecshop_EcshopNewPageFragment", 2, "redpoint info: " + opg.a(localQQAdGetRsp.red_point.get()));
        }
        EcshopNewPageFragment.a(this.a, opg.a(localQQAdGetRsp.red_point.get()));
