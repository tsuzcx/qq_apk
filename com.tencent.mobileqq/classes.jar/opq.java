...
public class opq
{
  ...
  private static opr jdField_a_of_type_Opr = new opr(null);
  private static ops jdField_a_of_type_Ops = new ops(null);
  ...
  private static void b(Context paramContext, String paramString)
  {
    ...
    {
      a(ors.a(), "sp_key_local_apk_path", paramString);
      a(ors.a(), "sp_key_current_app_md5", paramContext);
  ...
  {
    paramContext = b(ors.a(), "sp_key_current_app_version_name");
    String str1 = b(ors.a(), "sp_key_latest_app_version_name");
    String str2 = b(ors.a(), "sp_key_current_app_md5");
    String str3 = b(ors.a(), "sp_key_latest_app_md5");
