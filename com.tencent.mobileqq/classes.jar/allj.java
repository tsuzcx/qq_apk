  ...
  implements Manager
{
  ...
  private alox jdField_a_of_type_Alox = new alll(this);
  ...
  static
  {
    ...
    jdField_a_of_type_ArrayOfInt = new int[] { 2130845413, 2130844453, 2130844453, 2130844453, 2130845172, 2130845172, 2130845430, 2130845430, 2130844954, 2130844954, 2130844954, 2130845413, 2130845413, 2130845233, 2130845413 };
  ...
  public allj(QQAppInterface paramQQAppInterface)
  {
  ...
  public int a(int paramInt, boolean paramBoolean)
  {
    ...
    if (paramInt == 1)
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        {
          bool = true;
          QLog.d("ConditionSearch.Manager", 2, bool + " | isNetAvaiable = " + bdee.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()));
        }
      }
      else
      {
        ...
        localObject = ((bavr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(193)).a(this.jdField_a_of_type_JavaLangString);
        if (QLog.isColorLevel()) {
          QLog.d("ConditionSearch.Manager", 2, "update, find task=" + localObject);
        }
        if ((localObject != null) && ((localObject instanceof allm))) {
          ((allm)localObject).realStart();
        }
      }
    }
    label246:
    while (paramInt != 2)
    {
      ...
      for (paramBoolean = true;; paramBoolean = false)
      {
        ...
        localObject = (allq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(4);
        ((allq)localObject).a(null, new GetResourceReqInfo[] { ((allq)localObject).e() });
        return 0;
      }
    }
    label264:
  ...
  public List<BaseAddress> a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqConditionsearchDataAddressData != null)
    {
      ...
      Collections.sort(localArrayList, new allk(this));
    }
  ...
  public void a(GetResourceRespInfo paramGetResourceRespInfo)
  {
    ...
    do
    {
      ...
      paramGetResourceRespInfo = new allm(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject, paramGetResourceRespInfo, localFile);
      ...
      bool = ((bavr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(193)).a(10023, "prd", (String)localObject, 0, (String)localObject, localFile.getAbsolutePath(), 2, 0, false, paramGetResourceRespInfo);
      if (QLog.isColorLevel()) {
  ...
  void a(boolean paramBoolean1, List<CondFitUser> paramList, boolean paramBoolean2, int paramInt)
  {
    ...
    if (this.jdField_b_of_type_JavaUtilLinkedList != null)
    {
      ...
      while (((Iterator)localObject).hasNext()) {
        ((allp)((Iterator)localObject).next()).a(paramBoolean1, paramList, paramBoolean2, paramInt);
      }
    }
  }
  ...
  public String c(String paramString)
  {
    ...
    {
      String[] arrayOfString = bdje.a(paramString, '-');
      str = paramString;
      if (arrayOfString.length >= 2)
      {
  ...
  public void c(Object paramObject)
  {
    ...
    do
    {
      this.jdField_a_of_type_JavaUtilLinkedList.add((alln)paramObject);
      do
      {
        return;
      } while (!(paramObject instanceof allp));
      if (this.jdField_b_of_type_JavaUtilLinkedList == null) {
    ...
    this.jdField_b_of_type_JavaUtilLinkedList.add((allp)paramObject);
  }
  ...
  public int d()
  {
    if (this.jdField_g_of_type_Boolean)
    {
      Card localCard = ((aloz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      if (localCard == null) {
        break label134;
      }
      if (localCard.shGender != 0) {
  ...
  public void d(Object paramObject)
  {
    ...
    while ((!(paramObject instanceof allp)) || (this.jdField_b_of_type_JavaUtilLinkedList == null)) {
      return;
    }
