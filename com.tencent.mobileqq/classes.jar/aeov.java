...
{
  public aeov(GameRoomTransActivity paramGameRoomTransActivity, int paramInt) {}
  ...
  public void a(int paramInt, oidb_0x8e4.RspBody paramRspBody)
  {
    ...
    for (Object localObject1 = null;; localObject1 = null)
    {
      ...
      for (;;)
      {
        ...
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqNearbyGameroomGameRoomTransActivity, 1, "加入游戏失败", 1).a();
        if (QLog.isColorLevel()) {
