...
public class apnu
{
  public static String a(QQAppInterface paramQQAppInterface, bdvv parambdvv, boolean paramBoolean)
  {
    ArrayList localArrayList = null;
    if ((paramQQAppInterface == null) && (parambdvv == null)) {}
    EmoticonPackage localEmoticonPackage;
    do
    {
      return null;
      localObject = parambdvv.a();
      localEmoticonPackage = (EmoticonPackage)((Bundle)localObject).getSerializable("emoticonPackage");
    } while (localEmoticonPackage == null);
    int i = ((Bundle)localObject).getInt("jsonType", apnf.c);
    File localFile = (File)parambdvv.jdField_a_of_type_JavaUtilMap.get(parambdvv.jdField_a_of_type_JavaLangString);
    Object localObject = new apoh();
    parambdvv = localArrayList;
    if (localFile != null)
    {
      if (localFile.exists()) {
        parambdvv = bdcs.a(localFile);
      }
    }
    else
    {
    ...
    label162:
    for (paramQQAppInterface = a(paramQQAppInterface, localEmoticonPackage, i, parambdvv, localArrayList);; paramQQAppInterface = a(paramQQAppInterface, localEmoticonPackage, i, parambdvv, localArrayList, (apoh)localObject))
    {
  ...
  public static String a(QQAppInterface paramQQAppInterface, EmoticonPackage paramEmoticonPackage, int paramInt, byte[] paramArrayOfByte, ArrayList<Emoticon> paramArrayList)
  {
    ...
    aube localaube = (aube)paramQQAppInterface.getManager(14);
    Object localObject1;
    Object localObject2;
    String str1;
    try
    ...
    catch (JSONException paramQQAppInterface)
    {
      for (;;)
      {
        ...
        paramArrayOfByte = localaube.b(paramEmoticonPackage.epId);
    ...
    localaube.a(paramEmoticonPackage);
    if (QLog.isColorLevel()) {
    ...
    if (j < m)
    {
      ...
      paramQQAppInterface = localaube.a(str1, (String)localObject1);
      if (paramQQAppInterface == null)
      {
        if (paramInt == apnf.d) {
          break label1013;
  ...
  public static String a(QQAppInterface paramQQAppInterface, EmoticonPackage paramEmoticonPackage, int paramInt, byte[] paramArrayOfByte, ArrayList<Emoticon> paramArrayList, apoh paramapoh)
  {
    if (QLog.isColorLevel()) {
    ...
    if ((paramArrayList == null) || (paramapoh == null))
    {
      if (QLog.isColorLevel()) {
    ...
    if ((paramArrayOfByte.has("type")) && (1 == j))
    {
      ...
      if (paramEmoticonPackage.copywritingType != aubd.a)
      {
      ...
      paramQQAppInterface = localaube.b(str1);
      if (paramQQAppInterface != null)
      {
      ...
      if ((paramEmoticonPackage.mobileFeetype == 1) || ((str1 != null) && ("10278".equals(str1))) || (paramEmoticonPackage.jobType == 1))
      {
        ...
        localObject2 = localaube.a(str1, str2);
