...
{
  private static auzc jdField_a_of_type_Auzc;
  public static final String a;
  private static ConcurrentHashMap<Integer, ConcurrentHashMap<Integer, auze>> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bhgg.a(anhk.ba + ".hiboom_font/");
  ...
  public static auzc a()
  {
    if (jdField_a_of_type_Auzc == null) {
      jdField_a_of_type_Auzc = new auzc();
    }
    return jdField_a_of_type_Auzc;
  }
  ...
  private auze b(int paramInt1, int paramInt2, auzd paramauzd)
  {
    paramauzd = new auze(paramInt1, paramauzd);
    ((ConcurrentHashMap)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt2))).put(Integer.valueOf(paramInt1), paramauzd);
    return paramauzd;
  }
  
  public auze a(int paramInt1, int paramInt2, @Nonnull auzd paramauzd)
  {
    try
    {
      ...
      auze localauze2 = (auze)((ConcurrentHashMap)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt2))).get(Integer.valueOf(paramInt1));
      auze localauze1 = localauze2;
      if (localauze2 == null) {
        localauze1 = b(paramInt1, paramInt2, paramauzd);
      }
      return localauze1;
    }
    finally {}
  ...
  public void a()
  {
    ...
    while (localIterator1.hasNext())
    {
      ...
      while (localIterator2.hasNext()) {
        ((auze)((Map.Entry)localIterator2.next()).getValue()).a(false);
      }
    }
  }
  ...
  public void c()
  {
    for (;;)
    {
      ...
      try
      {
        ...
        i = bgtl.a(bgtl.a(), "libFounderColorFont_818.so");
        if (!QLog.isColorLevel()) {
          break label131;
        }
