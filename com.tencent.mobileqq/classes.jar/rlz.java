...
public class rlz
{
  ...
  private static rlz jdField_a_of_type_Rlz;
  public static int b;
  ...
  private static final String k = "QQ/8.4.5 Android/0.17 Android/" + Build.VERSION.RELEASE;
  ...
  {
    if ((paramBoolean) && (paramArticleInfo.mSocialFeedInfo != null) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qxr != null)) {
      return paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qxr.jdField_a_of_type_JavaLangLong;
    }
  ...
  private JSONArray a(List<qyh> paramList)
  {
    JSONArray localJSONArray = new JSONArray();
    Iterator localIterator = paramList.iterator();
    while (localIterator.hasNext())
    {
      qyh localqyh = (qyh)localIterator.next();
      if ((localqyh.jdField_b_of_type_JavaLangString != null) || (localqyh.c != null))
      {
        JSONObject localJSONObject = new JSONObject();
        if (localqyh.jdField_b_of_type_JavaLangString != null)
        {
          paramList = localqyh.jdField_b_of_type_JavaLangString;
          label74:
        ...
        label154:
        for (paramList = localqyh.c;; paramList = localqyh.jdField_b_of_type_JavaLangString)
        {
          localJSONObject.put("thumbnail_url", paramList);
          localJSONObject.put("pic_width", localqyh.jdField_a_of_type_Int);
          localJSONObject.put("pic_height", localqyh.jdField_b_of_type_Int);
          localJSONArray.put(localJSONObject);
          break;
          paramList = localqyh.c;
          break label74;
        }
      }
    }
  ...
  public static rlz a()
  {
    if (jdField_a_of_type_Rlz == null) {
      jdField_a_of_type_Rlz = new rlz();
    }
    return jdField_a_of_type_Rlz;
  }
  ...
  private void a(ArticleInfo paramArticleInfo, JSONObject paramJSONObject)
  {
    if (ozs.a(paramArticleInfo))
    {
      ...
      paramJSONObject.put("videoTimeTips", qrc.a(paramArticleInfo.mVideoDuration));
    }
  }
  ...
  private void a(ArticleInfo paramArticleInfo, JSONObject paramJSONObject, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    if (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qxt != null)
    {
      ...
      if (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qxt.jdField_a_of_type_Int != 1) {
        break label372;
      }
      i1 = 1;
    ...
    for (;;)
    {
      if ((paramBoolean2) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qxr != null))
      {
        paramJSONObject.put("originFeedsId", String.valueOf(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qxr.jdField_a_of_type_JavaLangLong));
        paramJSONObject.put("originFeedsType", paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qxr.jdField_b_of_type_JavaLangLong);
        localObject = new JSONArray();
        paramArticleInfo = paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qxr.jdField_a_of_type_JavaUtilList.iterator();
        while (paramArticleInfo.hasNext())
        {
          ...
          localJSONObject.put("biuLevel_uin", new String(bhkv.encode(Long.toString(localBiuCommentInfo.jdField_a_of_type_JavaLangLong.longValue()).getBytes(), 0)));
          localJSONObject.put("biuLevel_nick", "");
          localJSONObject.put("biuLevel_remark", "");
          if (ozs.a() != null)
          {
            String str = bhlg.b((QQAppInterface)ozs.a(), Long.toString(localBiuCommentInfo.jdField_a_of_type_JavaLangLong.longValue()), true);
        ...
        if (paramBoolean2)
        {
          localObject = Long.valueOf(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qxt.jdField_a_of_type_Long);
          paramJSONObject.put("uin", new String(bhkv.encode(Long.toString(((Long)localObject).longValue()).getBytes(), 0)));
          paramJSONObject.put("nick", "");
          paramJSONObject.put("remark", "");
          if (ozs.a() != null)
          {
            localObject = bhlg.b((QQAppInterface)ozs.a(), Long.toString(((Long)localObject).longValue()), true);
  ...
  private void a(String paramString1, JSONObject paramJSONObject, String paramString2, rme paramrme)
  {
    ThreadManager.post(new ReadInJoyWebDataManager.5(this, paramString1, paramString2, paramrme, paramJSONObject), 5, null, true);
  }
  
  /* Error */
  private void a(String paramString1, rmd paramrmd, JSONObject paramJSONObject, String paramString2)
  {
    // Byte code:
    //   0: invokestatic 191	ozs:a	()Lmqq/app/AppRuntime;
    ...
    //   142: aload 4
    //   144: aload_1
    //   145: invokespecial 484	rlz:a	(Ljava/lang/String;Ljava/lang/String;)Z
    //   148: ifeq +45 -> 193
    //   151: aload 4
    //   153: astore_1
    //   154: aload_1
    ...
    //   204: aload 5
    //   206: aload_1
    //   207: invokespecial 490	rlz:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   210: astore 7
    //   212: aload 7
    ...
    //   256: invokestatic 501	bhml:b	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   279: aload 5
    //   281: invokestatic 501	bhml:b	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   293: aload_1
    //   294: invokestatic 501	bhml:b	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   383: aload 7
    //   385: invokespecial 524	rlz:b	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   388: astore 5
    //   390: aload 5
  ...
  private void a(URL paramURL, String paramString1, String paramString2, JSONObject paramJSONObject)
  {
    ...
    //   78: pop
    //   79: getstatic 119	rlz:jdField_a_of_type_Long	J
    //   82: ldc2_w 536
    //   85: lcmp
    //   86: ifle +20 -> 106
    ...
    //   96: aload_3
    //   97: aload 4
    //   99: invokespecial 542	com/tencent/biz/pubaccount/readinjoy/video/ReadInJoyWebDataManager$3:<init>	(Lrlz;Ljava/net/URL;Ljava/lang/String;Ljava/lang/String;Lorg/json/JSONObject;)V
    ...
    //   180: aload_2
    //   181: aload_1
    //   182: invokespecial 484	rlz:a	(Ljava/lang/String;Ljava/lang/String;)Z
    //   185: ifeq +357 -> 542
    //   188: aload_2
    //   189: astore_1
    //   190: aload_1
    ...
    //   203: aload_0
    //   204: aload 7
    //   206: invokespecial 547	rlz:b	(Ljava/lang/String;)Ljava/lang/String;
    //   209: astore_1
    //   210: aload_0
    //   211: aload_2
    //   212: aload_3
    //   213: aload 4
    //   215: aload_1
    //   216: invokespecial 549	rlz:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   219: aload_0
    //   220: aload 7
    //   222: aload_1
    //   223: invokespecial 550	rlz:a	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   226: astore 7
    //   228: new 492	java/io/File
    //   231: dup
    //   232: new 33	java/lang/StringBuilder
    ...
    //   307: aload_1
    //   308: aload_3
    //   309: invokestatic 501	bhml:b	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   345: aload 8
    //   347: aload 4
    //   349: invokestatic 501	bhml:b	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   393: getstatic 119	rlz:jdField_a_of_type_Long	J
    //   396: lstore 5
    //   398: aload 4
    //   400: invokevirtual 516	java/io/File:length	()J
    //   403: lload 5
    //   405: ladd
    //   406: putstatic 119	rlz:jdField_a_of_type_Long	J
    //   409: aload_0
    //   410: monitorexit
    //   411: aload_1
    //   412: ifnull +130 -> 542
  ...
  public static boolean a(ArticleInfo paramArticleInfo)
  {
    ...
    {
      return false;
      if ((sel.f(paramArticleInfo)) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qxr != null))
      {
        switch ((int)paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qxr.jdField_b_of_type_JavaLangLong.longValue())
        {
        case 11: 
        default: 
          return false;
    ...
    } while ((!sel.a(paramArticleInfo)) && (!sel.h(paramArticleInfo)));
    return true;
  }
  ...
  {
    if ((paramBoolean) && (paramArticleInfo.mSocialFeedInfo != null) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qxr != null)) {
      return paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qxr.jdField_b_of_type_JavaLangLong;
    }
  ...
  private void b(ArticleInfo paramArticleInfo, JSONObject paramJSONObject)
  {
    ...
    {
      paramJSONObject.put("timeTips", ozr.a(paramArticleInfo.mSocialFeedInfo.e, true));
    ...
    } while ((paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qyg == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qyg.a == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qyg.a.size() <= 0));
    paramJSONObject.put("multiPicUrls", a(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qyg.a));
  }
  ...
  public void a(ArticleInfo paramArticleInfo, boolean paramBoolean, String paramString)
  {
    ...
    Boolean localBoolean1 = Boolean.valueOf(sel.f(paramArticleInfo));
    if ((sel.a(paramArticleInfo)) || (sel.h(paramArticleInfo))) {}
    ...
    for (;;)
    {
      try
      {
        ...
        localJSONObject.put("timeTips", ozr.a(paramArticleInfo.mTime));
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramInt == 1)
        {
          localrmc = new rmc(this);
          paramString = str + "&ispreload=1";
        }
        str = c;
        if (paramInt == 1)
        {
          a("get", paramString, localJSONObject, str, localrmc, Boolean.valueOf(bool));
          if (!QLog.isColorLevel()) {
            break;
          }
  ...
  {
    ocd.a(null, "", "0X8008221", "0X8008221", 0, 0, paramString1, paramString2, "", "", false);
  }
  
  public void a(String paramString1, String paramString2, String paramString3)
  {
    ocd.a(null, "", "0X8008220", "0X8008220", 0, 0, paramString1, paramString2, paramString3, "", false);
  }
  ...
  public void a(String paramString1, String paramString2, JSONObject paramJSONObject, String paramString3, rme paramrme, Boolean paramBoolean)
  {
    ...
    while (!QLog.isColorLevel()) {
      for (;;)
      {
        ...
        {
          a(paramString2, paramJSONObject, paramString3, paramrme);
          return;
        }
      }
    }
  ...
  public void a(String paramString1, String paramString2, rmd paramrmd)
  {
    JSONObject localJSONObject = new JSONObject();
    if (TextUtils.isEmpty(paramString2)) {
      return;
    }
    new Thread(new ReadInJoyWebDataManager.4(this, paramString2, paramrmd, localJSONObject, paramString1)).start();
  }
  
  public void a(String paramString, JSONObject paramJSONObject)
  {
    if ((BaseApplication.getContext() == null) || (!pcd.a())) {}
    do
    {
      return;
      if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaViewViolaBaseView == null)
      {
        ...
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaViewViolaBaseView.a(jdField_a_of_type_JavaLangString, null, new tjq(jdField_a_of_type_JavaLangString, new JSONObject(), null, null));
      }
      try
      {
        JSONObject localJSONObject = new JSONObject();
  ...
  public boolean a()
  {
    ...
    if ((b()) && (bnrf.z(localQQAppInterface))) {}
    for (boolean bool = true;; bool = false) {
      return bool;
    }
  }
