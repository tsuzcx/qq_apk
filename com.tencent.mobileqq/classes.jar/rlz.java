...
public class rlz
{
  ...
  rlz(Context paramContext, ViewGroup paramViewGroup)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewViewGroup = paramViewGroup;
    this.jdField_a_of_type_ComTencentMobileqqWidgetRoundImageView = ((RoundImageView)paramViewGroup.findViewById(2131365196));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131378800));
    this.b = ((TextView)paramViewGroup.findViewById(2131380518));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131378990));
  }
  
  void a(ColumnInfo paramColumnInfo, int paramInt)
  {
    Object localObject = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843060);
    ...
    localObject = this.jdField_a_of_type_AndroidContentContext.getString(2131717540);
    ...
    if (paramInt == paramColumnInfo.columnID)
    {
      ...
      this.jdField_a_of_type_AndroidViewViewGroup.setTag(2131365915, Boolean.valueOf(true));
      return;
    }
    this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
    this.jdField_a_of_type_AndroidViewViewGroup.setTag(2131365915, Boolean.valueOf(false));
  }
}
