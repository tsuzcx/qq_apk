  ...
  implements Manager
{
  ...
  private ConcurrentHashMap<String, aozt> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
  private long jdField_b_of_type_Long = -1L;
  private ConcurrentHashMap<String, String> jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap;
  
  public aozr(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    Object localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getQQHeadSetting(5, paramString, 0);
    int j;
    int i;
    ...
    for (;;)
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          ((StringBuilder)localObject1).append(((aozt)localEntry.getValue()).jdField_a_of_type_Int);
          ((StringBuilder)localObject1).append(",type=");
          ((StringBuilder)localObject1).append(((aozt)localEntry.getValue()).b);
          ((StringBuilder)localObject1).append(",isRequest=");
          ((StringBuilder)localObject1).append(((aozt)localEntry.getValue()).jdField_a_of_type_Boolean);
          ((StringBuilder)localObject1).append(",saveTime=");
          ((StringBuilder)localObject1).append(((aozt)localEntry.getValue()).jdField_a_of_type_Long);
      ...
      {
        localObject1 = (aozt)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
        if (localObject1 != null)
        {
          int k = ((aozt)localObject1).jdField_a_of_type_Int;
          int m = ((aozt)localObject1).b;
          if (((m == 0) && (k != j)) || ((m != i) && (!((aozt)localObject1).jdField_a_of_type_Boolean)))
          {
            ((aozt)localObject1).jdField_a_of_type_Boolean = true;
            if (QLog.isColorLevel())
            {
            ...
            ((FriendListHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.FRIENDLIST_HANDLER)).getCustomHead(paramString);
            this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString, localObject1);
          }
          if ((k == j) && (m == i) && (((aozt)localObject1).jdField_a_of_type_Boolean))
          {
            if (QLog.isColorLevel()) {
  ...
  public long a()
  {
    long l = PreferenceManager.getDefaultSharedPreferences(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()).getLong("classic_head_activity_switch_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin(), -1L);
    if (QLog.isColorLevel()) {
  ...
  public void a()
  {
    Object localObject = bhhr.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    if (!TextUtils.isEmpty((CharSequence)localObject))
    {
      localObject = ((String)localObject).split("\\|");
      if ((localObject != null) && (localObject.length == 2))
      {
        this.jdField_a_of_type_Long = aqcn.a(localObject[0]);
        this.jdField_b_of_type_Long = aqcn.a(localObject[1]);
        if (QLog.isColorLevel()) {
  ...
  public void a(aozs paramaozs)
  {
    ...
    if ((a()) && (paramaozs != null))
    {
      ...
      localStringBuilder.append(" uin=").append(StringUtil.getSimpleUinForPrint(paramaozs.jdField_a_of_type_JavaLangString));
      localStringBuilder.append(" sysId=").append(paramaozs.jdField_b_of_type_Long);
      localStringBuilder.append(" headType=").append(paramaozs.c);
      localStringBuilder.append(" qq18Switch=").append(paramaozs.jdField_a_of_type_Long);
      if ((!TextUtils.isEmpty(paramaozs.jdField_a_of_type_JavaLangString)) && (paramaozs.jdField_a_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())) && (paramaozs.jdField_a_of_type_Long != -1L)) {
        a(paramaozs.jdField_a_of_type_Long);
      }
      localFriendListHandler = (FriendListHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.FRIENDLIST_HANDLER);
      localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getQQHeadSetting(1, paramaozs.jdField_a_of_type_JavaLangString, 0);
      if ((localObject == null) || (!((Boolean)((Pair)localObject).first).booleanValue())) {
        break label223;
      }
      localFriendListHandler.getCustomHead(paramaozs.jdField_a_of_type_JavaLangString);
      localFriendListHandler.notifyUI(3, true, paramaozs.jdField_a_of_type_JavaLangString);
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
      ...
      if ((localObject != null) && (((Pair)localObject).second != null))
      {
        ...
        if (((paramaozs.jdField_a_of_type_Long == 1L) && (paramaozs.c != -1L) && (paramaozs.c != l2)) || ((paramaozs.jdField_b_of_type_Long != -1L) && (paramaozs.jdField_b_of_type_Long != l1) && (l2 == 0L)))
        {
          localStringBuilder.append(" fetch userHead");
          localFriendListHandler.getCustomHead(paramaozs.jdField_a_of_type_JavaLangString);
          localFriendListHandler.notifyUI(3, true, paramaozs.jdField_a_of_type_JavaLangString);
  ...
  public void a(String paramString)
  {
    ...
    {
      aozt localaozt = (aozt)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
      if ((localaozt != null) && (localaozt.jdField_a_of_type_Boolean))
      {
        QLog.d("ClassicHeadActivityManager", 2, " QQ 18 handle handleGetHeadError uin=" + paramString + ",HeadID=" + localaozt.jdField_a_of_type_Int + ",Type=" + localaozt.b + ",IsRequest=" + localaozt.jdField_a_of_type_Boolean);
        this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(paramString);
      }
    }
  }
  ...
  public void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    {
      localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getQQHeadSetting(5, paramString, 0);
      if ((localObject == null) || (((Pair)localObject).second == null)) {
        break label350;
      }
      localObject = (Setting)((Pair)localObject).second;
      ...
      do
      {
        do
        {
          ...
          do
          {
            ...
            {
              return;
              localObject = new aozt(paramString, paramInt1, paramInt2);
              if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(paramString)) {
                break;
              }
            ...
            return;
            localaozt = (aozt)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
          } while (localaozt == null);
          i = localaozt.jdField_a_of_type_Int;
          j = localaozt.b;
