  ...
  extends JceStruct
{
  ...
  public s_user(long paramLong1, String paramString1, int paramInt1, long paramLong2, String paramString2, String paramString3, boolean paramBoolean1, int paramInt2, String paramString4, boolean paramBoolean2, String paramString5, String paramString6, String paramString7, boolean paramBoolean3, String paramString8, boolean paramBoolean4, boolean paramBoolean5, long paramLong3, String paramString9, boolean paramBoolean6, byte paramByte1, String paramString10, boolean paramBoolean7, byte paramByte2, int paramInt3, String paramString11, String paramString12, String paramString13, boolean paramBoolean8, boolean paramBoolean9, int paramInt4, int paramInt5, int paramInt6, int paramInt7)
  {
    this.uin = paramLong1;
    ...
    this.is_in_hidelist = paramBoolean8;
    this.is_in_fromhidelist = paramBoolean9;
    this.vip_flag = paramInt4;
    this.vip_level = paramInt5;
    this.is_annual_vip = paramInt6;
    this.is_isolate_user = paramInt7;
  }
  ...
  public void readFrom(JceInputStream paramJceInputStream)
  {
    ...
    this.is_in_hidelist = paramJceInputStream.read(this.is_in_hidelist, 28, false);
    this.is_in_fromhidelist = paramJceInputStream.read(this.is_in_fromhidelist, 29, false);
    this.vip_flag = paramJceInputStream.read(this.vip_flag, 30, false);
    this.vip_level = paramJceInputStream.read(this.vip_level, 31, false);
    this.is_annual_vip = paramJceInputStream.read(this.is_annual_vip, 32, false);
    this.is_isolate_user = paramJceInputStream.read(this.is_isolate_user, 33, false);
  }
  ...
  public void writeTo(JceOutputStream paramJceOutputStream)
  {
    ...
    paramJceOutputStream.write(this.vip_flag, 30);
    paramJceOutputStream.write(this.vip_level, 31);
    paramJceOutputStream.write(this.is_annual_vip, 32);
    paramJceOutputStream.write(this.is_isolate_user, 33);
  }
}
