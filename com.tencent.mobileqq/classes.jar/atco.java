      ...
      if (i < j)
      {
        ...
        for (;;)
        {
          ...
          if ((!Modifier.isStatic(k)) || (!Modifier.isFinal(k)))
          {
            ...
            localObject4 = (atcn)localField.getAnnotation(atcn.class);
            if (localObject4 != null) {
              paramClass = ((atcn)localObject4).a();
            }
  ...
  public static <T> JSONObject a(T paramT)
  {
    ...
    if (i < j)
    {
      ...
      for (;;)
      {
        i += 1;
        break;
        Object localObject2 = (atcn)((Field)localObject1).getAnnotation(atcn.class);
        if (localObject2 != null)
        {
          localObject2 = ((atcn)localObject2).a();
