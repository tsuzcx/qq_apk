...
public class atco
{
  ...
  private Map<String, atcp> jdField_a_of_type_JavaUtilMap = new HashMap();
  private Executor jdField_a_of_type_JavaUtilConcurrentExecutor;
  
  private atcp a(atcr paramatcr)
  {
    if ((paramatcr == null) || (paramatcr.jdField_a_of_type_JavaLangString == null)) {
      return null;
    }
    synchronized (this.jdField_a_of_type_JavaUtilMap)
    {
      paramatcr = (atcp)this.jdField_a_of_type_JavaUtilMap.get(paramatcr.jdField_a_of_type_JavaLangString);
      return paramatcr;
    }
  }
  
  private void a(atcr paramatcr, atcp paramatcp)
  {
    synchronized (this.jdField_a_of_type_JavaUtilMap)
    {
      this.jdField_a_of_type_JavaUtilMap.put(paramatcr.jdField_a_of_type_JavaLangString, paramatcp);
      return;
    }
  }
  ...
  private void a(boolean paramBoolean, String paramString1, String paramString2, int paramInt)
  {
    ...
    for (paramInt = k;; paramInt = 1)
    {
      ...
      bctj.a(BaseApplication.getContext()).a(this.jdField_a_of_type_JavaLangString, "actFAIPConnect", true, 0L, 0L, localHashMap, null);
  ...
  private boolean a(atcr paramatcr, atcs paramatcs)
  {
    if ((paramatcr == null) || (TextUtils.isEmpty(paramatcr.jdField_a_of_type_JavaLangString)) || (paramatcs == null) || (TextUtils.isEmpty(paramatcs.jdField_a_of_type_JavaLangString))) {
    ...
    do
    {
      ...
      QLog.i("FileIPv6Detecter<FileAssistant>", 1, "[IPv6-File] start delectIP [" + paramatcr.jdField_a_of_type_JavaLangString + ":" + paramatcr.jdField_a_of_type_Int + "] ipInfo[" + paramatcs.jdField_a_of_type_JavaLangString + ":" + paramatcs.jdField_a_of_type_Int + "]");
      c();
    } while (this.jdField_a_of_type_JavaUtilConcurrentExecutor == null);
    this.jdField_a_of_type_JavaUtilConcurrentExecutor.execute(new FileIPv6Detecter.1(this, paramatcs, l, paramatcr));
    return true;
  }
  ...
  private void c()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 164	atco:jdField_a_of_type_JavaUtilConcurrentExecutor	Ljava/util/concurrent/Executor;
    //   6: ifnonnull +38 -> 44
    //   9: ldc 100
    //   11: iconst_1
    //   12: ldc 183
    ...
    //   41: putfield 164	atco:jdField_a_of_type_JavaUtilConcurrentExecutor	Ljava/util/concurrent/Executor;
    //   44: aload_0
    //   45: monitorexit
    //   46: return
    //   47: astore_1
  ...
  public void a(QQAppInterface paramQQAppInterface, atcr paramatcr, atcs paramatcs)
  {
    if ((paramatcr == null) || (TextUtils.isEmpty(paramatcr.jdField_a_of_type_JavaLangString)) || (paramatcs == null) || (TextUtils.isEmpty(paramatcs.jdField_a_of_type_JavaLangString))) {
    ...
    paramQQAppInterface = a(paramatcr);
    if (paramQQAppInterface != null)
    {
    ...
    if (a(paramatcr, paramatcs))
    {
      paramQQAppInterface = new atcp(this);
      paramQQAppInterface.b = true;
      paramQQAppInterface.jdField_a_of_type_Atcs = paramatcs;
      paramQQAppInterface.jdField_a_of_type_Long = l;
      a(paramatcr, paramQQAppInterface);
      return;
    }
    QLog.e("FileIPv6Detecter<FileAssistant>", 1, "[IPv6-File] delectIP err");
  }
  
  public boolean a(atcr paramatcr)
  {
    paramatcr = a(paramatcr);
    if (paramatcr != null) {
      return paramatcr.jdField_a_of_type_Boolean;
    }
    return false;
  }
}
