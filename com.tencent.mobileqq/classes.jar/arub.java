...
public class arub
{
  ...
  private ITMAssistantDownloadClientListener jdField_a_of_type_ComTencentTmdownloaderITMAssistantDownloadClientListener = new aruc(this);
  private TMAssistantDownloadClient jdField_a_of_type_ComTencentTmdownloaderTMAssistantDownloadClient;
  private Map<String, arud> jdField_a_of_type_JavaUtilMap = new HashMap();
  ...
  private int a(String paramString, arud paramarud)
  {
    if ((paramarud == null) || (paramString == null)) {
      return -1;
    }
    ...
    this.jdField_a_of_type_JavaUtilMap.put(paramString, paramarud);
    QLog.i(jdField_a_of_type_JavaLangString, 1, "[UniformDL][" + paramarud.jdField_a_of_type_Long + "] addDownloadCtx...total:[" + this.jdField_a_of_type_JavaUtilMap.size() + "] add it. url:[ " + paramString + "]");
    return 0;
  }
  ...
  private arud a(String paramString)
  {
    synchronized (this.jdField_a_of_type_JavaUtilMap)
    {
      paramString = (arud)this.jdField_a_of_type_JavaUtilMap.get(paramString);
      return paramString;
    }
  }
  ...
  private void a(arud paramarud, int paramInt, String paramString)
  {
    ...
    {
      paramInt = 2;
      paramString = artu.a(paramInt);
      if (paramarud != null)
      {
        a(paramarud.b(), paramarud.jdField_b_of_type_Int);
        paramarud.b(0L);
        if (paramarud.jdField_a_of_type_Arua != null)
        {
          Bundle localBundle = new arue(paramarud.a(), paramarud.a()).a();
          paramarud.jdField_a_of_type_Arua.a(paramInt, paramString, localBundle);
        }
      }
      return;
    }
    ...
    for (long l = bdep.a() * 1024L;; l = bdep.b() * 1024L)
    {
      ...
      paramInt = i;
      if (l >= paramarud.jdField_b_of_type_Long - paramarud.a()) {
        break;
      }
      QLog.e(jdField_a_of_type_JavaLangString, 1, "[UniformDL][" + paramarud.jdField_a_of_type_Long + "] write file failed.  space is no enough:[" + paramarud.jdField_b_of_type_Long + " " + paramarud.a() + " " + l + "]");
      paramInt = 9;
      break;
      if (702 == paramInt)
      {
  ...
  private void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentTmdownloaderTMAssistantDownloadClient == null)
      {
        ...
        if (((arud)localObject2).jdField_a_of_type_Arua != null)
        {
          paramString = new arue(0L, ((arud)localObject2).a()).a();
          ((arud)localObject2).jdField_a_of_type_Arua.a(41, artu.a(41), paramString);
        }
      }
      else
      {
        ...
        if (localObject1 != null) {
          ((arud)localObject2).jdField_b_of_type_Int = ((NetworkInfo)localObject1).getType();
        }
        int i;
        int j;
        try
        ...
        if (localObject2 != null)
        {
          a(((arud)localObject2).b(), ((arud)localObject2).jdField_b_of_type_Int);
          ((arud)localObject2).b(0L);
          if (((arud)localObject2).jdField_a_of_type_Arua != null)
          {
            paramString = new arue(0L, ((arud)localObject2).a()).a();
            ((arud)localObject2).jdField_a_of_type_Arua.a(20, artu.a(20), paramString);
            return;
            label420:
            Bundle localBundle;
            if (4 == j)
            {
              ...
              for (;;)
              {
                ...
                try
                {
                  ...
                  ((arud)localObject2).a(((arud)localObject2).jdField_b_of_type_Long);
                  if (((arud)localObject2).jdField_a_of_type_Arua == null) {
                    break;
                  }
                  localBundle = new arue(0L, ((arud)localObject2).a()).a();
                  localObject2 = ((arud)localObject2).jdField_a_of_type_Arua;
                  if (localTMAssistantDownloadTaskInfo2 != null) {
                    break label614;
                  }
                  paramString = null;
                  ((arua)localObject2).a(paramString, localBundle);
                  return;
                }
                catch (Exception paramString)
                {
            ...
            while ((localObject2 != null) && (((arud)localObject2).jdField_a_of_type_Arua != null))
            {
              localBundle = new arue(0L, ((arud)localObject2).a()).a();
              ((arud)localObject2).jdField_a_of_type_Arua.a(i, paramString, localBundle);
              return;
              if (1 == j)
              {
                i = 17;
  ...
  private void a(String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          } while ((localarud == null) || (localarud.jdField_a_of_type_Arua == null));
          localarud.jdField_a_of_type_Arua.c(null);
          return;
        ...
        localarud.jdField_a_of_type_Arua.a(null);
        return;
        ...
        localarud.a(2);
        a(localarud.b(), localarud.jdField_b_of_type_Int);
        localarud.b(0L);
        a(localarud, paramInt2, paramString2);
        return;
      ...
      paramString1 = new arue(localarud.a(), localarud.a()).a();
      localarud.jdField_a_of_type_Arua.a(paramString3, paramString1);
      return;
    ...
    localarud.jdField_a_of_type_Arua.b(null);
  }
  ...
  private void a(String paramString1, int paramInt, String paramString2)
  {
    ...
    do
    {
      ...
      a(localarud.b(), localarud.jdField_b_of_type_Int);
      localarud.b(0L);
    } while (localarud.jdField_a_of_type_Arua == null);
    paramString1 = new arue(localarud.a(), localarud.a()).a();
    localarud.jdField_a_of_type_Arua.a(paramInt, paramString2, paramString1);
  }
  
  private void a(String paramString, long paramLong1, long paramLong2)
  {
    int i = (int)((float)paramLong1 / (float)paramLong2 * 100.0F);
    arud localarud = a(paramString);
    if (localarud != null)
    {
      localarud.b(paramLong1 - localarud.a() + localarud.b());
      localarud.a(paramLong1);
      if (localarud.jdField_a_of_type_Arua != null) {
        localarud.jdField_a_of_type_Arua.a(i, null);
      }
      return;
    }
  ...
  private void b(String paramString)
  {
    ...
    if (this.jdField_a_of_type_ComTencentTmdownloaderTMAssistantDownloadClient == null)
    {
      ...
      if ((localarud != null) && (localarud.jdField_a_of_type_Arua != null))
      {
        paramString = new arue(0L, localarud.a()).a();
        localarud.jdField_a_of_type_Arua.a(41, artu.a(41), paramString);
      }
    }
    do
    {
      for (;;)
      {
        ...
        try
        {
          ...
          if (localTMAssistantDownloadTaskInfo != null)
          {
            ...
            paramString = new arue(localarud.a(), localarud.a()).a();
            localarud.jdField_a_of_type_Arua.a(21, artu.a(21), paramString);
          }
        }
        catch (Exception localException)
        {
          for (;;)
          {
            ...
            if (localarud != null)
            {
              ...
              if (localarud.jdField_a_of_type_Arua != null)
              {
                localBundle = new arue(localarud.a(), localarud.a()).a();
                localarud.jdField_a_of_type_Arua.a(20, artu.a(20), localBundle);
              }
            }
  ...
  private int d(String paramString)
  {
    synchronized (this.jdField_a_of_type_JavaUtilMap)
    {
      arud localarud = (arud)this.jdField_a_of_type_JavaUtilMap.remove(paramString);
      int i = this.jdField_a_of_type_JavaUtilMap.size();
      QLog.i(jdField_a_of_type_JavaLangString, 1, "[UniformDL][" + localarud.jdField_a_of_type_Long + "] delDownloadCtx...total:[" + i + "] add it. url:[ " + paramString + "]");
      return i;
    }
  }
  ...
  private void f()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilMap)
    {
      ...
      if (((Iterator)localObject3).hasNext()) {
        localArrayList.add((arud)((Iterator)localObject3).next());
      }
    }
    ...
    {
      arud localarud = (arud)((Iterator)???).next();
      if (localarud != null)
      {
        a(localarud.b(), localarud.jdField_b_of_type_Int);
        localarud.b(0L);
        if (localarud.jdField_a_of_type_Arua != null)
        {
          localObject3 = new arue(localarud.a(), localarud.a()).a();
          localarud.jdField_a_of_type_Arua.a(10, artu.a(10), (Bundle)localObject3);
        }
      }
    }
  }
  
  public int a(long paramLong1, String paramString, long paramLong2, arua paramarua)
  {
    if (paramString == null)
    {
    ...
    arud localarud = new arud(this, paramLong1, paramString, paramLong2);
    localarud.jdField_a_of_type_Arua = paramarua;
    int i = a(paramString, localarud);
    if (i != 0)
    {
