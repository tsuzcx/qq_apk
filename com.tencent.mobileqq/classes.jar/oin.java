  ...
  extends ReplacementSpan
{
  ...
  private TextPaint a(Paint paramPaint)
  {
    ...
    paramPaint.setTextSize(bbkx.d(9.0F));
    return paramPaint;
  }
  ...
  public void draw(@NotNull Canvas paramCanvas, CharSequence paramCharSequence, int paramInt1, int paramInt2, float paramFloat, int paramInt3, int paramInt4, int paramInt5, @NotNull Paint paramPaint)
  {
    ...
    paramPaint.setTextSize(bbkx.b(9.0F));
    ...
    oii.a(paramCanvas, paramPaint, (int)a(paramPaint, paramCharSequence, paramInt1, paramInt2), i, bbkx.b(1.0F), bbkx.b(1.0F), bbkx.b(1.0F), bbkx.b(1.0F), bbkx.b(1.0F), paramFloat, paramInt4 - i);
  }
