  ...
  extends WebViewPlugin
{
  ...
  public aipt()
  {
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new aipu(this);
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if ("bless".equals(paramString2))
    {
      ...
      for (;;)
      {
        ...
        else if ("sendBlessText".equals(paramString3))
        {
          ...
          if ((paramVarArgs != null) && (paramVarArgs.length > 0)) {
            try
            {
              ...
              aipv.a(this.mRuntime.a(), paramString1, paramJsBridgeListener);
            }
            catch (JSONException paramJsBridgeListener)
            {
              paramJsBridgeListener.printStackTrace();
        ...
        {
          if (QLog.isColorLevel()) {
            QLog.d("BlessJsApiPlugin", 2, "Call sendBlessPtv, args:" + paramVarArgs);
          }
          if ((paramVarArgs != null) && (paramVarArgs.length > 0)) {
            try
            {
              ...
              aipv.a(localActivity, paramString1, paramString2, paramString3, paramVarArgs, str1, str2, str3, (String)localObject, paramJsBridgeListener);
            }
            catch (JSONException paramJsBridgeListener)
            {
