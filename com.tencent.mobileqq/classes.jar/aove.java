  ...
  extends MSFServlet
{
  ...
  private void a(QQAppInterface paramQQAppInterface, Intent paramIntent, int[] paramArrayOfInt, Packet paramPacket)
  {
    ...
    if (i < j)
    {
      ...
      for (;;)
      {
        ...
        k = bdiv.M(paramQQAppInterface.getApp(), str);
  ...
  {
    long l = System.currentTimeMillis();
    paramQQAppInterface = (Boolean)bjxj.a("local_kd_tab_has_set");
    ...
    if (paramAppRuntime != null)
    {
      ...
      if ((paramAppRuntime instanceof AppInterface))
      {
        ...
        if (localBaseApplication != null)
        {
          ...
          {
            i = bdiv.M(localBaseApplication, str);
            if (i != 0) {
              break label251;
            }
            jdField_a_of_type_JavaLangClass = paramClass;
            paramClass = new NewIntent(localBaseApplication, aove.class);
