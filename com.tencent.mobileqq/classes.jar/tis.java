...
public class tis
{
  ...
  public tis(FragmentActivity paramFragmentActivity, FragmentManager paramFragmentManager, int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidViewViewGroup.setId(2131364852);
  ...
  private void a(VVideoView paramVVideoView, View paramView, int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidViewViewGroup.setVisibility(8);
    this.jdField_a_of_type_AndroidViewView.setVisibility(8);
    rpt.a(this.jdField_a_of_type_AndroidViewView, 0, 300);
    rpt.a(this.jdField_a_of_type_AndroidViewViewGroup, 0, 300);
    if (paramView != null)
    {
      ...
      b(paramVVideoView, paramView);
      paramInt = rpt.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)[0];
      ...
      rpt.a(paramView, this.jdField_a_of_type_ArrayOfInt, this.jdField_b_of_type_ArrayOfInt, new int[] { 0, ImmersiveUtils.getStatusBarHeight(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity) }, new int[] { paramInt, i }, 300L, true);
      ...
      arrayOfInt1 = this.c;
      j = rpt.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)[1];
      int k = this.c[1];
      int[] arrayOfInt2 = this.c;
      rpt.a(paramVVideoView, new int[] { 0, paramInt + i }, arrayOfInt1, new int[] { 0, j - k }, arrayOfInt2, 300L, true);
      paramView.addOnLayoutChangeListener(new tit(this));
      return;
    }
    paramVVideoView = this.jdField_a_of_type_AndroidViewViewGroup;
    paramInt = rpt.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)[1];
    paramView = this.c;
    int i = rpt.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)[1];
    int j = this.c[1];
    int[] arrayOfInt1 = this.c;
    rpt.a(paramVVideoView, new int[] { 0, paramInt }, paramView, new int[] { 0, i - j }, arrayOfInt1, 300L, true);
  }
  ...
  private void a(VVideoView paramVVideoView, View paramView, boolean paramBoolean)
  {
    ...
    rpt.a(this.jdField_a_of_type_AndroidViewView, 8, 300);
    rpt.a(this.jdField_a_of_type_AndroidViewViewGroup, 8, 300);
    ...
    if ((paramBoolean) || (paramView == null))
    {
      ...
      localObject[0] = 0;
      localObject[1] = rpt.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)[1];
    }
    for (;;)
    {
      rpt.a(this.jdField_a_of_type_AndroidViewViewGroup, new int[] { 0, rpt.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)[1] - this.jdField_a_of_type_AndroidViewViewGroup.getHeight() }, arrayOfInt, (int[])localObject, arrayOfInt, 300L, true);
      if (paramView == null) {
        break;
      }
      ...
      localObject = rpt.a(paramView, new int[] { 0, i }, new int[] { j, k }, (int[])localObject, arrayOfInt, 300L, false);
      ((Animator)localObject).addListener(new tiu(this, paramVVideoView, paramView));
  ...
  private void a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if (this.jdField_a_of_type_Tiy != null) {
        this.jdField_a_of_type_Tiy.a(false);
      }
    }
  }
  ...
  private void d()
  {
    ...
    {
      int i;
      if (bdep.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getApplicationContext()))
      {
        i = bdep.d(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getApplicationContext());
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_AndroidViewViewGroup$LayoutParams.height = rpt.c(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity);
    ...
    b();
    this.c = new int[] { rpt.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)[0], this.jdField_a_of_type_AndroidViewViewGroup$LayoutParams.height };
  }
  ...
  public void a(View paramView, float paramFloat)
  {
    ...
    if (this.jdField_a_of_type_AndroidViewViewGroup$LayoutParams != null)
    {
      if (paramView != null)
      {
        ...
        i = (int)(rpt.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)[0] * f);
      }
      this.jdField_a_of_type_AndroidViewViewGroup$LayoutParams.height = ((int)(rpt.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)[1] - i - paramFloat - ImmersiveUtils.getStatusBarHeight(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)));
  ...
  public void a(VVideoView paramVVideoView, View paramView, ArticleInfo paramArticleInfo, AnchorData paramAnchorData, int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_AndroidViewViewGroup.getWidth() <= 0) || (this.jdField_a_of_type_AndroidViewViewGroup.getHeight() != this.c[1]))
    {
      ...
      this.jdField_a_of_type_AndroidViewViewGroup.addOnLayoutChangeListener(new tiw(this, paramVVideoView, paramView, paramArticleInfo, paramAnchorData, paramInt));
    }
    do
    {
      do
    ...
    } while (this.jdField_a_of_type_Tiy == null);
    this.jdField_a_of_type_Tiy.a(true);
  }
  
  public void a(tiy paramtiy)
  {
    this.jdField_a_of_type_Tiy = paramtiy;
  }
  ...
  public void b()
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListFragment == null)
    {
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListFragment.a((Bundle)localObject, new tiv(this), this.jdField_a_of_type_AndroidViewViewGroup);
  ...
  public void b(VVideoView paramVVideoView, View paramView, ArticleInfo paramArticleInfo, AnchorData paramAnchorData, int paramInt)
  {
    if (paramArticleInfo != null)
    {
      ...
      if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListFragment == null)
      {
        ...
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListFragment.a(new tix(this));
      }
    }
    else
    {
