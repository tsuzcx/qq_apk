  ...
  implements tgs, tgx
{
  ...
  public tis(Context paramContext)
  {
  ...
  private PTSItemData a(BaseData paramBaseData)
  {
    ...
    this.jdField_a_of_type_JavaUtilHashMap.put(paramBaseData.U, paramBaseData);
  ...
  private void g()
  {
    this.jdField_a_of_type_ComTencentPtsCoreLiteIPTSLiteEventListener = new tit(this);
  }
  
  public int a(BaseData paramBaseData)
  {
    paramBaseData = (ProteusItemData)paramBaseData;
    Integer localInteger = (Integer)this.b.get(paramBaseData.V);
    if (localInteger != null) {
      return localInteger.intValue();
    }
    QLog.e("WebPtsLiteViewCreator", 1, "[getViewType] error, pageName = " + paramBaseData.V);
    return -1;
  }
  ...
  public tgr a(Context paramContext, BaseData paramBaseData, ViewGroup paramViewGroup)
  {
    ...
    return new tiu(this, paramContext, paramBaseData, null);
  }
  ...
  public void f()
  {
    ...
    tgr.a += this.b.size() + 1;
    QLog.i("WebPtsLiteViewCreator", 1, "[initPtsLiteTypeCount], view type count = " + tgr.a);
  }
}
