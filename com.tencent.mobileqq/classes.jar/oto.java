  ...
  implements bfob
{
  ...
  private HashMap<Long, otb> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private otj jdField_a_of_type_Otj;
  public boolean a;
  private int jdField_b_of_type_Int;
  public long b;
  public ArrayList<Long> b;
  private HashMap<Long, Float> jdField_b_of_type_JavaUtilHashMap = new HashMap();
  private otj jdField_b_of_type_Otj;
  private int jdField_c_of_type_Int;
  public long c;
  private ArrayList<otn> jdField_c_of_type_JavaUtilArrayList = new ArrayList();
  private int d;
  public long d;
  private int e;
  public long e;
  ...
  private otj a(AbsListView paramAbsListView)
  {
    ...
    paramAbsListView = new otj(this.jdField_a_of_type_Ota, null);
    ...
    for (long l = System.currentTimeMillis() - this.jdField_d_of_type_Long;; l = System.currentTimeMillis() - this.jdField_a_of_type_Otj.jdField_a_of_type_Long)
    {
      paramAbsListView.jdField_b_of_type_Long = l;
      this.jdField_a_of_type_Otj = paramAbsListView;
      QLog.d("ReadinjoySPEventReport", 2, new Object[] { paramAbsListView });
      return paramAbsListView;
    }
  }
  
  private otn a(AbsListView paramAbsListView)
  {
    otn localotn = new otn();
    localotn.jdField_e_of_type_Int = this.jdField_b_of_type_Int;
    localotn.f = this.jdField_c_of_type_Int;
    if (this.jdField_d_of_type_Int - this.f > 0) {}
    for (int i = this.jdField_d_of_type_Int - this.f;; i = 0)
    {
      localotn.g = i;
      localotn.jdField_a_of_type_Int = this.jdField_e_of_type_Int;
      localotn.jdField_a_of_type_Long = (this.jdField_c_of_type_Long - this.jdField_b_of_type_Long);
      localotn.h = this.f;
      localotn.i = paramAbsListView.getWidth();
      localotn.jdField_a_of_type_ArrayOfFloat = ((float[])((ReadInJoyXListView)paramAbsListView).jdField_a_of_type_ArrayOfFloat.clone());
      localotn.b = ((float[])((ReadInJoyXListView)paramAbsListView).b.clone());
      return localotn;
    }
  }
  ...
  public String a()
  {
    ...
    while (((Iterator)localObject).hasNext()) {
      localStringBuilder.append((otb)((Iterator)localObject).next()).append("|");
    }
  ...
  public void a(int paramInt, AbsListView paramAbsListView)
  {
    ...
    //   44: ifle +14 -> 58
    //   47: aload_0
    //   48: getfield 138	oto:jdField_d_of_type_Long	J
    //   51: lstore_3
    //   52: lload_3
    //   53: lconst_0
    //   54: lcmp
    ...
    //   60: return
    //   61: aload_0
    //   62: getfield 46	oto:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   65: invokevirtual 265	java/util/ArrayList:size	()I
    //   68: ifle +12 -> 80
    //   71: aload_0
    //   72: getfield 266	oto:jdField_a_of_type_Int	I
    //   75: iload_1
    //   76: iand
    //   77: ifne -19 -> 58
    //   80: iload_1
    ...
    //   83: ifeq +15 -> 98
    //   86: aload_0
    //   87: getfield 268	oto:jdField_a_of_type_Boolean	Z
    //   90: ifeq -32 -> 58
    //   93: aload_0
    //   94: iconst_0
    //   95: putfield 268	oto:jdField_a_of_type_Boolean	Z
    //   98: aload_0
    //   99: aload_0
    //   100: getfield 266	oto:jdField_a_of_type_Int	I
    //   103: iload_1
    //   104: ior
    //   105: putfield 266	oto:jdField_a_of_type_Int	I
    //   108: aload_0
    //   109: aload_2
    //   110: invokespecial 270	oto:a	(Lcom/tencent/widget/AbsListView;)Lotj;
    //   113: astore_2
    //   114: aload_2
    //   115: ifnull -57 -> 58
    //   118: aload_0
    //   119: aload_2
    //   120: invokevirtual 273	oto:a	(Lotj;)V
    //   123: aload_0
    //   124: aload_2
    //   125: invokevirtual 276	otj:a	()Ljava/util/ArrayList;
    //   128: putfield 46	oto:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   131: ldc 142
    //   133: iconst_2
    //   134: iconst_1
  ...
  {
    if ((paramotj == null) || (this.jdField_d_of_type_Long == 0L)) {
      return;
    }
    Iterator localIterator = paramotj.jdField_a_of_type_JavaUtilArrayList.iterator();
    label23:
    Object localObject;
    long l1;
    float f1;
    ...
    if (localIterator.hasNext())
    {
      ...
      l1 = paramotj.jdField_b_of_type_Long;
      f1 = ((Float)((Pair)localObject).second).floatValue();
      otb localotb = (otb)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(localBaseArticleInfo.mArticleID));
      localObject = localotb;
      if (localotb == null)
      {
        localObject = new otb(this.jdField_a_of_type_Ota, null);
        ((otb)localObject).jdField_a_of_type_Long = localBaseArticleInfo.mRecommendSeq;
        ((otb)localObject).jdField_b_of_type_Long = localBaseArticleInfo.mArticleID;
        ((otb)localObject).jdField_a_of_type_JavaLangString = localBaseArticleInfo.mTitle;
        this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(localBaseArticleInfo.mArticleID), localObject);
      }
      l2 = ((otb)localObject).jdField_c_of_type_Long;
      if (f1 <= 0.8F) {
        break label204;
      }
    }
    for (;;)
    {
      ((otb)localObject).jdField_c_of_type_Long = (l1 + l2);
      ((otb)localObject).jdField_a_of_type_Float = Math.max(((otb)localObject).jdField_a_of_type_Float, f1);
      break label23;
      break;
      label204:
      l1 = 0L;
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Otj != null)
    {
      localArrayList1 = this.jdField_a_of_type_Otj.a();
      if (this.jdField_b_of_type_Otj == null) {
        break label267;
      }
      localArrayList2 = this.jdField_b_of_type_Otj.a();
      ...
      do
      {
        ...
        localotb = (otb)this.jdField_a_of_type_JavaUtilHashMap.get(localLong);
      } while (localotb == null);
      localotb.jdField_a_of_type_Int = 1;
      if (!this.jdField_a_of_type_JavaUtilArrayList.contains(localLong)) {
        break label273;
      }
    }
    for (localotb.jdField_a_of_type_Int = 0;; localotb.jdField_a_of_type_Int = 2) {
      label267:
      label273:
      do
      {
        if (this.jdField_b_of_type_JavaUtilArrayList.contains(localLong)) {
          localotb.jdField_a_of_type_Boolean = true;
        }
        if ((localArrayList2 != null) && (localArrayList2.contains(localLong))) {
          localotb.jdField_b_of_type_Boolean = true;
        }
        if (this.jdField_b_of_type_JavaUtilHashMap.containsKey(localLong)) {
          localotb.jdField_b_of_type_JavaLangString = String.format("%.2f", new Object[] { this.jdField_b_of_type_JavaUtilHashMap.get(localLong) });
        }
        localStringBuilder.append(localotb.toString()).append("\n");
        break label96;
    ...
    this.jdField_a_of_type_Ota.b = this;
    this.jdField_a_of_type_Ota.a = new oto(this.jdField_a_of_type_Ota);
  }
  ...
  public String b()
  {
    ...
    {
      localStringBuilder.append(((otn)this.jdField_c_of_type_JavaUtilArrayList.get(i)).a()).append("|");
      i += 1;
    }
    if (localStringBuilder.length() == 0) {
      return "nil";
  ...
  public void onScrollStateChanged(AbsListView paramAbsListView, int paramInt)
  {
    ...
    case 0: 
      ...
      localotn = a(paramAbsListView);
      this.jdField_c_of_type_JavaUtilArrayList.add(localotn);
      this.jdField_a_of_type_Otj = a(paramAbsListView);
    ...
    case 1: 
      while ((paramInt <= i) && (paramInt < paramAbsListView.getCount()))
      {
        ...
        this.jdField_a_of_type_Otj = a(paramAbsListView);
        this.jdField_b_of_type_Otj = this.jdField_a_of_type_Otj;
        a(this.jdField_a_of_type_Otj);
        return;
      }
      QLog.d("ReadinjoySPEventReport", 2, "one scroll " + localotn.a());
      return;
    }
    this.jdField_a_of_type_Otj = a(paramAbsListView);
    a(this.jdField_a_of_type_Otj);
