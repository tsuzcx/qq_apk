...
public class bhch
{
  private static final bhch jdField_a_of_type_Bhch = new bhch();
  ...
  {
    return jdField_a_of_type_Bhch;
  }
  
  private void a(byte[] paramArrayOfByte, List<APP_REPORT_TRANSFER.SingleDcData> paramList)
  {
    if ((paramArrayOfByte != null) && (paramArrayOfByte.length > 0)) {
      ((ChannelProxy)ProxyManager.get(ChannelProxy.class)).dataReport(paramArrayOfByte, new bhcj(this, paramList));
    }
  }
  ...
  {
    if ((paramArrayOfByte != null) && (paramArrayOfByte.length > 0)) {
      ((ChannelProxy)ProxyManager.get(ChannelProxy.class)).report(paramArrayOfByte, paramString1, paramString2, new bhci(this, paramList));
    }
  }
  ...
  private void d()
  {
    if (!this.d.isEmpty())
    {
      ...
      this.d.clear();
      byte[] arrayOfByte = bhcg.a(localArrayList).toByteArray();
  ...
  private void f()
  {
    ...
    if (!this.jdField_b_of_type_JavaUtilList.isEmpty())
    {
      ...
      localObject2 = bhcg.a(localArrayList);
    ...
    for (;;)
    {
      ...
      while (i <= localArrayList.size())
      {
        if ((j < i) && (j >= 0) && (i <= localArrayList.size()))
        {
          ...
          APP_REPORT_TRANSFER.StDataReportReq localStDataReportReq = bhcg.a((List)localObject1);
  ...
  private void g()
  {
    ...
    for (;;)
    {
      ...
      while (i <= localArrayList.size())
      {
        ...
        {
          localObject1 = localArrayList.subList(j, i);
          REPORT.StDcReportReq localStDcReportReq = bhcg.a((List)localObject1);
  ...
  public void a()
  {
    ...
    try
    {
      j = bgpx.a("qqminiapp", "mini_app_report_time_threshold", 10);
      i = j;
      int m = bgpx.a("qqminiapp", "mini_app_report_count_threshold", 64);
      i = m;
      k = j;
      j = i;
    }
