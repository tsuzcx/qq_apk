...
public class aqbq
{
  ...
  public static Pair<StringBuilder, StringBuilder> a(Context paramContext, File paramFile)
  {
    ...
    a = true;
    paramContext = vup.a(Uri.parse("file://" + paramFile.getAbsolutePath()), paramContext);
    a = false;
    return paramContext;
  }
  ...
  {
    // Byte code:
    //   0: new 116	java/io/BufferedInputStream
    //   3: dup
    //   4: new 118	java/io/FileInputStream
    //   7: dup
    //   8: aload_0
    //   9: invokespecial 121	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   12: invokespecial 124	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   15: astore_0
    //   16: sipush 10240
    //   19: newarray byte
    //   21: astore_3
    //   22: ldc 126
    //   24: invokestatic 132	java/security/MessageDigest:getInstance	(Ljava/lang/String;)Ljava/security/MessageDigest;
    //   27: astore_2
    //   28: aload_0
    //   29: aload_3
    ...
    //   40: iconst_0
    //   41: iload_1
    //   42: invokevirtual 142	java/security/MessageDigest:update	([BII)V
    //   45: goto -17 -> 28
    //   48: astore_2
    //   49: aload_0
    //   50: ifnull +7 -> 57
    //   53: aload_0
    //   54: invokevirtual 145	java/io/InputStream:close	()V
    //   57: aconst_null
    //   58: areturn
    //   59: astore_2
    //   60: aload_2
    //   61: invokevirtual 148	java/security/NoSuchAlgorithmException:printStackTrace	()V
    //   64: aconst_null
    //   65: astore_2
    //   66: goto -38 -> 28
    //   69: aload_0
    //   70: ifnull +7 -> 77
    //   73: aload_0
    //   74: invokevirtual 145	java/io/InputStream:close	()V
    //   77: aload_2
    //   78: ifnull +52 -> 130
    //   81: aload_2
    //   82: invokevirtual 152	java/security/MessageDigest:digest	()[B
    //   85: invokestatic 157	bach:a	([B)Ljava/lang/String;
    //   88: astore_2
    //   89: invokestatic 82	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   92: ifeq +28 -> 120
    //   95: ldc 84
    //   97: iconst_2
    ...
    //   105: ldc 159
    //   107: invokevirtual 32	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   110: aload_2
    //   111: invokevirtual 32	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   114: invokevirtual 41	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   117: invokestatic 95	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   120: aload_0
    //   121: ifnull +7 -> 128
    //   124: aload_0
    ...
    //   147: ifnull -90 -> 57
    //   150: aload_0
    //   151: invokevirtual 145	java/io/InputStream:close	()V
    //   154: aconst_null
    //   155: areturn
    //   156: astore_0
    //   157: aconst_null
    ...
    //   163: ifnull +7 -> 170
    //   166: aload_0
    //   167: invokevirtual 145	java/io/InputStream:close	()V
    //   170: aload_2
    //   171: athrow
    //   172: astore_3
    //   173: goto -96 -> 77
  ...
  public static msg_ctrl.MsgCtrl a(String paramString)
  {
    ...
    Object localObject2;
    long l2;
    if ((aqcb.a().f()) && (!TextUtils.isEmpty(paramString)))
    {
      ...
      if (new File(paramString).exists())
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject1))
        {
          ...
          if ((JpegExifReader.isCrashJpeg(paramString)) || (!PhotoUtils.b(paramString))) {}
        }
      }
    }
    for (;;)
    ...
    for (;;)
    {
      ...
      awrn.a(BaseApplicationImpl.getContext()).a(null, "act_getMsgCtrlForPicMsg", true, 0L, 0L, localHashMap, "");
      return localMsgCtrl;
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  {
    Object localObject = aqcb.a();
    if (!((aqcb)localObject).e()) {}
    String str;
    do
    {
      return false;
      str = ((aqcb)localObject).a();
      localObject = ((aqcb)localObject).b();
