...
public class amav
{
  ...
  public amav(amau paramamau)
  {
    this.jdField_a_of_type_Amau = paramamau;
  }
  
  private amax a(QQAppInterface paramQQAppInterface, String paramString)
  {
    int j = 0;
    ...
    {
      localObject1 = (alnr)paramQQAppInterface.getManager(153);
      localObject2 = ((alnr)localObject1).a(paramQQAppInterface, paramString);
    ...
    for (;;)
    {
      try
      {
        ...
        {
          i = j;
          localObject2 = new amax();
          localObject3 = ((JSONArray)localObject3).getJSONObject(i);
          ((amax)localObject2).jdField_b_of_type_Int = ((JSONObject)localObject3).getInt("type");
          ((amax)localObject2).jdField_a_of_type_Int = ((JSONObject)localObject3).getInt("id");
          localObject3 = ((alnr)localObject1).b(paramString);
          if (localObject3 == null) {
            return null;
          }
          if ((((amax)localObject2).jdField_b_of_type_Int == 4) && (!((ApolloBaseInfo)localObject3).hasPet))
          {
            ((ApolloBaseInfo)localObject3).appearAction = null;
            ((alnr)localObject1).a((ApolloBaseInfo)localObject3);
            return null;
          }
          if (QLog.isColorLevel()) {
            QLog.d("cmshow_scripted_SpriteRscBuilder", 2, new Object[] { "[hasAppearAction] index:", Integer.valueOf(i), ",id:", Integer.valueOf(((amax)localObject2).jdField_a_of_type_Int), ",standType:", Integer.valueOf(((amax)localObject2).jdField_b_of_type_Int) });
          }
          if (((amax)localObject2).jdField_a_of_type_Int <= 0)
          {
            QLog.e("cmshow_scripted_SpriteRscBuilder", 1, new Object[] { "appearAction not correct,actionId:", Integer.valueOf(((amax)localObject2).jdField_a_of_type_Int) });
            return null;
          }
          if (!ApolloUtil.a(((amax)localObject2).jdField_a_of_type_Int, 0))
          {
            if (QLog.isColorLevel()) {
              QLog.i("cmshow_scripted_SpriteRscBuilder", 2, "hasAppearAction isActionResDone is false.");
            }
            paramString = new ApolloActionData();
            paramString.actionId = ((amax)localObject2).jdField_a_of_type_Int;
            localObject1 = ApolloUtil.a(paramString, 5);
            amdp.a(paramQQAppInterface, ApolloUtil.a(paramString, 4), (String)localObject1);
            return null;
          }
  ...
  private SpriteTaskParam a(amax paramamax)
  {
    ...
    do
    {
      ...
      localSpriteTaskParam.f = paramamax.jdField_a_of_type_Int;
      localSpriteTaskParam.k = 12;
      localSpriteTaskParam.g = 5;
      localSpriteTaskParam.jdField_a_of_type_Long = 1000000L;
    } while (paramamax.jdField_b_of_type_Int != 4);
  ...
  private String a(int paramInt)
  {
    ...
    paramInt = ((alnr)this.jdField_a_of_type_Amau.a().getManager(153)).a(paramInt);
    if ((paramInt != -1) && (!ApolloUtil.a(paramInt, 0)))
    {
      ...
      amdp.a(this.jdField_a_of_type_Amau.a(), (String)localObject, str);
    }
    for (;;)
    {
  ...
  public static String a(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    return amge.a(paramInt1, paramInt2, paramInt3);
  }
  ...
  {
    if ((paramSpriteTaskParam == null) || (this.jdField_a_of_type_Amau == null)) {
      return null;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        JSONObject localJSONObject2 = a(paramSpriteTaskParam.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Amau, paramSpriteTaskParam, true, false);
        if ((this.jdField_a_of_type_Amau.jdField_a_of_type_Int == 0) || (paramSpriteTaskParam.e == 1))
        {
          localJSONObject1 = a(paramSpriteTaskParam.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Amau, paramSpriteTaskParam, false, false);
          if (localJSONObject2 != null)
          {
            localJSONArray.put(localJSONObject2);
            JSONObject localJSONObject3 = a(paramSpriteTaskParam.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Amau, true);
          ...
          if (localJSONObject1 != null)
          {
            ...
            paramSpriteTaskParam = a(paramSpriteTaskParam.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Amau, false);
  ...
  public static JSONArray a(QQAppInterface paramQQAppInterface, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        amir localamir = (amir)paramQQAppInterface.getManager(155);
        int i = 0;
        j = 0;
        if (j < localJSONArray2.length())
        {
          ...
          else
          {
            ...
            bool1 = ((alnr)localObject).a(paramJSONObject, 4, null);
            if (!QLog.isColorLevel()) {
              break label514;
            }
            ...
            String[] arrayOfString = amge.a(1, k, 0, true);
            ((JSONObject)localObject).put("actionId", k);
            ((JSONObject)localObject).put("actionPath", amge.a(arrayOfString[0], 3));
            if (paramJSONObject.personNum == 1) {
              ((JSONObject)localObject).put("peerPath", amge.a(amge.a(1, k, 0, false)[0], 3));
            }
  ...
  private JSONObject a(int paramInt1, int paramInt2)
  {
    try
    {
      ...
      ((SpriteTaskParam)localObject).h = this.jdField_a_of_type_Amau.jdField_a_of_type_Int;
      ((SpriteTaskParam)localObject).jdField_c_of_type_Int = 1;
      if (!a((SpriteTaskParam)localObject)) {
        return null;
      }
      localObject = ((amir)this.jdField_a_of_type_Amau.a().getManager(155)).a(paramInt1);
      if (localObject == null) {
        return null;
      }
      localJSONObject.put("actionId", paramInt1);
      localJSONObject.put("action", amge.a(paramInt1, paramInt2, true, this.jdField_a_of_type_Amau.a())[0]);
      if (((ApolloActionData)localObject).personNum == 1) {
        localJSONObject.put("actionPeer", amge.a(paramInt1, paramInt2, false, this.jdField_a_of_type_Amau.a())[0]);
      }
      if (this.jdField_a_of_type_Amau.jdField_a_of_type_Int == 0)
      {
  ...
  private JSONObject a(String paramString, amau paramamau, SpriteTaskParam paramSpriteTaskParam, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localJSONObject = a(paramString, paramamau, ambc.a(paramString, paramSpriteTaskParam, paramamau, paramBoolean1), (String)localObject);
        if (!a(paramSpriteTaskParam)) {
          return localJSONObject;
        }
        j = alnr.a(paramamau.a(), paramString);
        int k = ((Integer)amge.a(paramString, j, paramamau.a(), true)[0]).intValue();
        localObject = paramString;
        if (alnr.b(paramamau.a(), paramString, false) == 0)
        {
          localObject = paramString;
          if (paramamau.g())
          {
            if (!b(paramamau.a(), paramString)) {
              break label528;
            }
            paramString = "-2";
            break label520;
        ...
        paramString = amge.a((String)localObject, paramamau.a(), true);
        ...
        if ((paramBoolean1) && (!TextUtils.isEmpty(paramSpriteTaskParam.jdField_c_of_type_JavaLangString)))
        {
          ...
          if ((j == 1) && (paramSpriteTaskParam.f > amip.jdField_a_of_type_Int) && (alnr.a(paramamau.a())))
          {
            i = 2;
        ...
        else
        {
          ...
          paramString = amge.a(n, i1, i, paramBoolean1, j);
          if (paramString == null) {
            break label535;
          }
        ...
        if ((j != 2) || (paramSpriteTaskParam.f >= amip.jdField_a_of_type_Int)) {
          break label513;
        }
        i = 1;
        continue;
      ...
      label403:
      if ((paramamau.jdField_a_of_type_Int == 0) && (!paramBoolean1) && (!paramBoolean2)) {
        break;
      }
      label430:
      paramamau = paramString[0];
      paramString = paramamau;
      if (8 == paramSpriteTaskParam.jdField_c_of_type_Int)
      {
        ...
        if (!TextUtils.isEmpty(paramSpriteTaskParam.jdField_d_of_type_JavaLangString))
        {
          ...
          if (!TextUtils.isEmpty(paramSpriteTaskParam)) {
            paramString = paramamau + paramSpriteTaskParam;
          }
        }
      }
  ...
  private JSONObject a(String paramString1, amau paramamau, boolean paramBoolean, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        amge.a(paramString1, paramamau.a(), localJSONObject, paramString2);
        if ((alnr.b(paramamau.a(), paramString1, false) == 0) && (paramamau.g()))
        {
          if (!b(paramamau.a(), paramString1)) {
            break label474;
          }
          paramString2 = "-2";
          paramString2 = amge.a(paramString2, paramamau.a(), true);
          ...
          if (i < k)
          {
            localJSONArray.put(amge.a(1, Integer.valueOf(paramString2[i]).intValue()));
            i += 1;
            continue;
          }
          localJSONObject.put("dress", localJSONArray);
          localJSONObject.put("role", amge.a(0, j));
          if (((paramamau.jdField_a_of_type_Int == 1) || (paramamau.jdField_a_of_type_Int == 3000)) && (!"-1".equals(paramString1)) && (!"-2".equals(paramString1)))
          {
            localJSONObject.put("nameplate", a(paramamau.a(), paramString1, j, paramBoolean));
            paramString2 = paramamau.jdField_b_of_type_JavaLangString;
            if ((TextUtils.isEmpty(paramString2)) || (!paramString2.equals(paramString1))) {
              continue;
            }
            paramString1 = amtj.a(2131713356);
            if (!TextUtils.isEmpty(paramString1)) {
              localJSONObject.put("nickname", ambc.a(bfuc.encodeToString(paramString1.getBytes("utf-8"), 0)));
            }
          }
          if (this.jdField_a_of_type_Amau.jdField_a_of_type_Alsk == null) {
            break;
          }
          localJSONObject.put("scale", this.jdField_a_of_type_Amau.jdField_a_of_type_Alsk.jdField_a_of_type_Float);
          localJSONObject.put("xPos", this.jdField_a_of_type_Amau.jdField_a_of_type_Alsk.b);
          localJSONObject.put("yPos", this.jdField_a_of_type_Amau.jdField_a_of_type_Alsk.c);
          break;
          paramString1 = ambc.a(paramamau.a(), paramamau.jdField_a_of_type_Int, paramString1, paramamau.jdField_a_of_type_JavaLangString, true);
          continue;
        }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, int[] paramArrayOfInt, amjf paramamjf)
  {
    ...
    for (;;)
    {
      if (i != 0)
      {
        amja.a(-1L, paramQQAppInterface, paramString, "", 0, "", paramamjf);
        return;
        i = 0;
        for (;;)
        {
      ...
      paramamjf.a(-1L, paramQQAppInterface, paramString, "", "", paramInt, paramArrayOfInt, 10);
      return;
      label156:
      i = 0;
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, ameb paramameb)
  {
    int i;
    if (!ApolloUtil.d(paramString))
    {
      ...
      amdp.a(paramQQAppInterface, paramString, paramameb);
    }
    label25:
    while (paramameb == null)
    {
      return;
      i = 0;
      break;
  ...
  private JSONArray b(SpriteTaskParam paramSpriteTaskParam)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localamir = (amir)this.jdField_a_of_type_Amau.a().getManager(155);
        i = 0;
        k = 0;
        j = -1;
      ...
      catch (Throwable paramSpriteTaskParam)
      {
        ...
        if (i != 0) {
          anwk.a(this.jdField_a_of_type_Amau.a(), 1);
        }
        return localJSONArray;
      }
      finally
  ...
  private JSONObject b(String paramString, amau paramamau, boolean paramBoolean)
  {
    return a(paramString, paramamau, paramBoolean, null);
  }
  
  public static void b(QQAppInterface paramQQAppInterface, String paramString, int paramInt, int[] paramArrayOfInt, amjf paramamjf)
  {
    int k = 0;
    if (paramArrayOfInt == null) {}
    do
    {
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          c(paramQQAppInterface, paramString, paramInt, paramArrayOfInt, paramamjf);
          return;
        }
        i += 1;
      }
    } while (paramamjf == null);
    paramamjf.a(-1L, paramQQAppInterface, paramString, "", "", paramInt, paramArrayOfInt, 10);
  }
  ...
  private JSONArray c(SpriteTaskParam paramSpriteTaskParam)
  {
    ...
    //   1: ifnull +10 -> 11
    //   4: aload_0
    //   5: getfield 43	amav:jdField_a_of_type_Amau	Lamau;
    //   8: ifnonnull +7 -> 15
    //   11: aconst_null
    //   12: astore_1
    //   13: aload_1
    ...
    //   26: astore 6
    //   28: aload_0
    //   29: getfield 43	amav:jdField_a_of_type_Amau	Lamau;
    //   32: getfield 373	amau:jdField_a_of_type_Int	I
    //   35: ifne +163 -> 198
    //   38: aload_0
    //   39: aload_0
    //   40: getfield 43	amav:jdField_a_of_type_Amau	Lamau;
    //   43: getfield 591	amau:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   46: aload_0
    //   47: getfield 43	amav:jdField_a_of_type_Amau	Lamau;
    //   50: iconst_1
    //   51: invokespecial 715	amav:b	(Ljava/lang/String;Lamau;Z)Lorg/json/JSONObject;
    //   54: astore_1
    //   55: aload_0
    //   56: aload_0
    //   57: getfield 43	amav:jdField_a_of_type_Amau	Lamau;
    //   60: getfield 616	amau:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   63: aload_0
    //   64: getfield 43	amav:jdField_a_of_type_Amau	Lamau;
    //   67: iconst_0
    //   68: invokespecial 715	amav:b	(Ljava/lang/String;Lamau;Z)Lorg/json/JSONObject;
    //   71: astore 7
    //   73: aload_0
    //   74: aload_0
    //   75: getfield 43	amav:jdField_a_of_type_Amau	Lamau;
    //   78: getfield 591	amau:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   81: aload_0
    //   82: getfield 43	amav:jdField_a_of_type_Amau	Lamau;
    //   85: iconst_1
    //   86: invokevirtual 383	amav:a	(Ljava/lang/String;Lamau;Z)Lorg/json/JSONObject;
    //   89: astore 8
    //   91: aload_0
    //   92: aload_0
    //   93: getfield 43	amav:jdField_a_of_type_Amau	Lamau;
    //   96: getfield 616	amau:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   99: aload_0
    //   100: getfield 43	amav:jdField_a_of_type_Amau	Lamau;
    //   103: iconst_0
    //   104: invokevirtual 383	amav:a	(Ljava/lang/String;Lamau;Z)Lorg/json/JSONObject;
    //   107: astore 9
    //   109: aload 8
    //   111: ifnull +13 -> 124
    //   114: aload_1
    ...
    //   203: aload_0
    //   204: getfield 43	amav:jdField_a_of_type_Amau	Lamau;
    //   207: iconst_1
    //   208: invokespecial 715	amav:b	(Ljava/lang/String;Lamau;Z)Lorg/json/JSONObject;
    //   211: astore_1
    //   212: aload_0
    //   213: aload_0
    //   214: getfield 43	amav:jdField_a_of_type_Amau	Lamau;
    //   217: getfield 591	amau:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   220: aload_0
    //   221: getfield 43	amav:jdField_a_of_type_Amau	Lamau;
    //   224: iconst_1
    //   225: invokevirtual 383	amav:a	(Ljava/lang/String;Lamau;Z)Lorg/json/JSONObject;
    //   228: astore 7
    //   230: aload 7
    //   232: ifnull +13 -> 245
    //   235: aload_1
  ...
  public static void c(QQAppInterface paramQQAppInterface, String paramString, int paramInt, int[] paramArrayOfInt, amjf paramamjf)
  {
    if ((amge.a(paramString, paramInt, paramArrayOfInt, paramQQAppInterface, new amaw(paramamjf, paramQQAppInterface, paramInt, paramArrayOfInt))) && (paramamjf != null)) {
      paramamjf.a(-1L, paramQQAppInterface, paramString, "", "", paramInt, paramArrayOfInt, 22);
    }
  }
  ...
  public Pair<String, Integer> a(String paramString)
  {
    ...
    if ((alnr.a(this.jdField_a_of_type_Amau.a(), paramString) != 2) && (a(this.jdField_a_of_type_Amau.a(), paramString)))
    {
      localStringBuilder = new StringBuilder();
      localStringBuilder.append(this.jdField_b_of_type_Int).append("/action/action");
      SharedPreferences localSharedPreferences = this.jdField_a_of_type_Amau.a().getApp().getSharedPreferences("apollo_sp", 0);
      if (!localSharedPreferences.getBoolean("stand_type_" + this.jdField_a_of_type_Int, false)) {}
      switch (this.jdField_a_of_type_Int)
      {
      default: 
        localObject = null;
        amal localamal = ambc.a(this.jdField_a_of_type_Amau.a());
        ...
        if (this.jdField_a_of_type_Amau.jdField_a_of_type_Int == 3000)
        {
          label297:
    ...
    for (i = 7;; i = 0)
    {
      ...
      break;
      i = this.jdField_a_of_type_Amau.jdField_a_of_type_Int;
      break label297;
      return localObject;
    }
  }
  ...
  public String a()
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Amau.jdField_a_of_type_Int == 0)
      {
        localJSONObject2 = b(this.jdField_a_of_type_Amau.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Amau, true);
        localJSONObject3 = b(this.jdField_a_of_type_Amau.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Amau, false);
        JSONObject localJSONObject4;
        if (alnr.a(this.jdField_a_of_type_Amau.a(), this.jdField_a_of_type_Amau.jdField_b_of_type_JavaLangString) != 2)
        {
          localJSONObject4 = a(this.jdField_a_of_type_Amau.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Amau, true);
          if (localJSONObject4 != null) {
            localJSONObject2.put("pet", localJSONObject4);
          }
        }
        if (alnr.a(this.jdField_a_of_type_Amau.a(), this.jdField_a_of_type_Amau.jdField_a_of_type_JavaLangString) != 2)
        {
          localJSONObject4 = a(this.jdField_a_of_type_Amau.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Amau, false);
          if (localJSONObject4 != null) {
      ...
      for (;;)
      {
        ...
        if (alnr.a(this.jdField_a_of_type_Amau.a(), this.jdField_a_of_type_Amau.jdField_b_of_type_JavaLangString) != 2)
        {
          localJSONObject3 = a(this.jdField_a_of_type_Amau.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Amau, true);
          if (localJSONObject3 != null) {
            localJSONObject2.put("pet", localJSONObject3);
          }
        }
  ...
  {
    int i = 0;
    if ((this.jdField_a_of_type_Amau == null) || (this.jdField_a_of_type_Amau.a() == null) || (TextUtils.isEmpty(paramString))) {
      return null;
    }
    ...
    localObject = (alnr)this.jdField_a_of_type_Amau.a().getManager(153);
    if (TextUtils.isEmpty(((alnr)localObject).j)) {
      return null;
    }
    for (;;)
    {
      try
      {
        JSONArray localJSONArray = new JSONArray(((alnr)localObject).j);
        ...
        if (i < j)
        {
          ...
          ((alnr)localObject).a(paramString, 4);
        }
      }
      catch (Exception paramString)
      {
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Amau.e == 0)
        {
          ...
          if (!ambc.a(this.jdField_a_of_type_Amau.a())) {
            break label349;
          }
          i = 1;
        ...
        else
        {
          ...
          localObject = amge.a(paramSpriteTaskParam.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Amau.a());
          continue;
        }
  ...
  {
    JSONArray localJSONArray = new JSONArray();
    if ((this.jdField_a_of_type_Amau == null) || (this.jdField_a_of_type_Amau.a() == null) || (paramJSONArray == null)) {
      return localJSONArray;
    }
    StringBuilder localStringBuilder = new StringBuilder();
  ...
  public JSONObject a(SpriteTaskParam paramSpriteTaskParam)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          localObject2 = (alnr)this.jdField_a_of_type_Amau.a().getManager(153);
          ApolloActionData localApolloActionData = ((amir)this.jdField_a_of_type_Amau.a().getManager(155)).a(paramSpriteTaskParam.f);
          ...
          if (paramSpriteTaskParam.i > 0)
          {
            ...
            amdp.a(this.jdField_a_of_type_Amau.a(), null, paramSpriteTaskParam.i, false);
            localObject1 = localObject2;
            continue;
          }
          return null;
  ...
  /* Error */
  public JSONObject a(String paramString, amau paramamau, boolean paramBoolean)
  {
    // Byte code:
    ...
    //   24: dup
    //   25: invokespecial 895	java/util/ArrayList:<init>	()V
    //   28: astore 15
    //   30: aload_2
    //   31: invokevirtual 234	amau:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   34: sipush 153
    //   37: invokevirtual 74	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   40: checkcast 76	alnr
    //   43: astore 13
    //   45: iload 5
    //   47: istore 9
    //   49: iload 11
    ...
    //   61: aload 13
    //   63: aload_1
    //   64: invokevirtual 109	alnr:b	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/ApolloBaseInfo;
    //   67: astore 16
    //   69: aload 16
    //   71: ifnonnull +5 -> 76
    //   74: aconst_null
    ...
    //   90: istore 8
    //   92: aload 16
    //   94: invokevirtual 899	com/tencent/mobileqq/data/ApolloBaseInfo:getApolloPetDress	()Lalsg;
    //   97: astore 17
    //   99: aload 17
    //   101: ifnull +988 -> 1089
    //   104: iload 5
    ...
    //   142: istore 8
    //   144: aload 17
    //   146: getfield 904	alsg:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   149: ifnull +940 -> 1089
    //   152: iload 5
    //   154: istore 9
    //   156: iload 11
    ...
    //   166: istore 8
    //   168: aload 17
    //   170: getfield 904	alsg:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   173: invokevirtual 906	java/util/HashMap:isEmpty	()Z
    //   176: ifne +913 -> 1089
    //   179: iload 5
    //   181: istore 9
    //   183: iload 11
    ...
    //   200: iconst_0
    //   201: aload 17
    //   203: getfield 907	alsg:jdField_a_of_type_Int	I
    //   206: invokestatic 582	amge:a	(II)Ljava/lang/String;
    ...
    //   233: iconst_1
    //   234: aload 17
    //   236: getfield 907	alsg:jdField_a_of_type_Int	I
    //   239: invokestatic 909	com/tencent/mobileqq/apollo/utils/ApolloUtil:b	(II)Z
    //   242: ifne +27 -> 269
    //   245: iconst_0
    //   246: istore 7
    //   248: iconst_0
    ...
    //   260: istore 10
    //   262: aload 17
    //   264: getfield 907	alsg:jdField_a_of_type_Int	I
    //   267: istore 4
    //   269: iload 4
    //   271: istore 9
    //   273: iload 6
    ...
    //   283: istore 8
    //   285: aload 17
    //   287: getfield 904	alsg:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   290: invokevirtual 910	java/util/HashMap:size	()I
    //   293: newarray int
    //   295: astore 18
    //   297: iload 4
    //   299: istore 9
    ...
    //   311: istore 8
    //   313: aload 17
    //   315: getfield 904	alsg:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   318: invokevirtual 914	java/util/HashMap:entrySet	()Ljava/util/Set;
    //   321: invokeinterface 920 1 0
    //   326: astore 19
    //   328: iconst_0
    //   329: istore 5
    //   331: iload 4
    ...
    //   375: iload 5
    //   377: aload 19
    //   379: invokeinterface 929 1 0
    //   384: checkcast 931	java/util/Map$Entry
    //   387: invokeinterface 934 1 0
    ...
    //   485: iconst_1
    //   486: iload 9
    //   488: invokestatic 582	amge:a	(II)Ljava/lang/String;
    ...
    //   503: iconst_2
    //   504: iload 9
    //   506: invokestatic 909	com/tencent/mobileqq/apollo/utils/ApolloUtil:b	(II)Z
    //   509: ifne +937 -> 1446
    //   512: iconst_0
    //   513: istore 7
    //   515: iconst_0
    ...
    //   566: ldc_w 308
    //   569: aload 17
    //   571: getfield 907	alsg:jdField_a_of_type_Int	I
    ...
    //   586: aload_0
    //   587: aload 17
    //   589: getfield 907	alsg:jdField_a_of_type_Int	I
    //   592: ldc_w 941
    //   595: invokevirtual 943	amav:a	(ILjava/lang/String;)Ljava/lang/String;
    //   598: astore 18
    //   600: iload 5
    //   602: istore 6
    //   604: iload 5
    ...
    //   608: aload_0
    //   609: aload 17
    //   611: getfield 907	alsg:jdField_a_of_type_Int	I
    //   614: ldc_w 945
    //   617: invokevirtual 943	amav:a	(ILjava/lang/String;)Ljava/lang/String;
    //   620: astore 19
    //   622: iload 5
    //   624: istore 6
    //   626: iload 5
    ...
    //   700: aload_0
    //   701: aload 17
    //   703: getfield 907	alsg:jdField_a_of_type_Int	I
    //   706: invokespecial 950	amav:a	(I)Ljava/lang/String;
    //   709: astore 18
    //   711: iload 5
    //   713: istore 6
    //   715: iload 5
    ...
    //   752: istore 7
    //   754: aload 16
    //   756: getfield 955	com/tencent/mobileqq/data/ApolloBaseInfo:petNick	Ljava/lang/String;
    ...
    //   790: ldc_w 598
    //   793: aload 16
    //   795: getfield 955	com/tencent/mobileqq/data/ApolloBaseInfo:petNick	Ljava/lang/String;
    //   798: ldc_w 530
    //   801: invokevirtual 534	java/lang/String:getBytes	(Ljava/lang/String;)[B
    //   804: iconst_0
    //   805: invokestatic 540	bfuc:encodeToString	([BI)Ljava/lang/String;
    //   808: invokestatic 542	ambc:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   825: ldc_w 588
    //   828: aload 13
    //   830: getfield 797	alnr:j	Ljava/lang/String;
    //   833: aload 17
    //   835: getfield 907	alsg:jdField_a_of_type_Int	I
    //   838: iload_3
    //   839: invokestatic 957	amav:a	(Ljava/lang/String;IZ)Ljava/lang/String;
    ...
    //   852: istore 7
    //   854: aload_0
    //   855: getfield 43	amav:jdField_a_of_type_Amau	Lamau;
    //   858: getfield 601	amau:jdField_a_of_type_Alsk	Lalsk;
    //   861: ifnull +87 -> 948
    //   864: iload 5
    //   866: istore 6
    //   868: iload 5
    ...
    //   874: ldc_w 603
    //   877: aload_0
    //   878: getfield 43	amav:jdField_a_of_type_Amau	Lamau;
    //   881: getfield 601	amau:jdField_a_of_type_Alsk	Lalsk;
    //   884: getfield 607	alsk:jdField_a_of_type_Float	F
    //   887: f2d
    ...
    //   902: ldc_w 609
    //   905: aload_0
    //   906: getfield 43	amav:jdField_a_of_type_Amau	Lamau;
    //   909: getfield 601	amau:jdField_a_of_type_Alsk	Lalsk;
    //   912: getfield 611	alsk:b	F
    //   915: f2d
    ...
    //   930: ldc_w 613
    //   933: aload_0
    //   934: getfield 43	amav:jdField_a_of_type_Amau	Lamau;
    //   937: getfield 601	amau:jdField_a_of_type_Alsk	Lalsk;
    //   940: getfield 615	alsk:c	F
    //   943: f2d
    ...
    //   959: ifnull +484 -> 1443
    //   962: aload_2
    //   963: invokevirtual 234	amau:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   966: ifnull +477 -> 1443
    //   969: ldc 242
    //   971: iconst_1
    ...
    //   997: ifnull +446 -> 1443
    //   1000: aload 15
    //   1002: invokeinterface 960 1 0
    //   1007: newarray int
    //   1009: astore 16
    //   1011: aload 15
    //   1013: invokeinterface 961 1 0
    //   1018: astore 15
    //   1020: iconst_0
    //   1021: istore 5
    //   1023: aload 15
    //   1025: invokeinterface 925 1 0
    //   1030: ifeq +36 -> 1066
    //   1033: aload 16
    //   1035: iload 5
    //   1037: aload 15
    //   1039: invokeinterface 929 1 0
    ...
    //   1063: goto -110 -> 953
    //   1066: aload_2
    //   1067: invokevirtual 234	amau:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1070: aload_1
    //   1071: aload 13
    //   1073: invokevirtual 964	alnr:a	()Lamdy;
    //   1076: iload 4
    //   1078: aload 16
    //   1080: iconst_m1
    //   1081: iconst_m1
    //   1082: iconst_1
    //   1083: invokestatic 967	amdp:a	(Lcom/tencent/common/app/AppInterface;Ljava/lang/String;Lamdy;I[IIIZ)V
    //   1086: aload 14
    //   1088: areturn
    //   1089: aconst_null
    //   1090: areturn
    ...
    //   1128: aload_2
    //   1129: invokevirtual 234	amau:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   1163: ifnull +83 -> 1246
    //   1166: aload 15
    //   1168: invokeinterface 960 1 0
    //   1173: newarray int
    //   1175: astore 14
    //   1177: aload 15
    //   1179: invokeinterface 961 1 0
    //   1184: astore 15
    //   1186: iconst_0
    //   1187: istore 5
    //   1189: aload 15
    //   1191: invokeinterface 925 1 0
    //   1196: ifeq +30 -> 1226
    //   1199: aload 14
    //   1201: iload 5
    //   1203: aload 15
    //   1205: invokeinterface 929 1 0
    ...
    //   1223: goto -34 -> 1189
    //   1226: aload_2
    //   1227: invokevirtual 234	amau:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1230: aload_1
    //   1231: aload 13
    //   1233: invokevirtual 964	alnr:a	()Lamdy;
    //   1236: iload 4
    //   1238: aload 14
    //   1240: iconst_m1
    //   1241: iconst_m1
    //   1242: iconst_1
    //   1243: invokestatic 967	amdp:a	(Lcom/tencent/common/app/AppInterface;Ljava/lang/String;Lamdy;I[IIIZ)V
    //   1246: aconst_null
    //   1247: areturn
    //   1248: astore 14
    //   1250: aconst_null
    ...
    //   1273: aload_2
    //   1274: invokevirtual 234	amau:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   1308: ifnull +83 -> 1391
    //   1311: aload 15
    //   1313: invokeinterface 960 1 0
    //   1318: newarray int
    //   1320: astore 16
    //   1322: aload 15
    //   1324: invokeinterface 961 1 0
    //   1329: astore 15
    //   1331: iconst_0
    //   1332: istore 5
    //   1334: aload 15
    //   1336: invokeinterface 925 1 0
    //   1341: ifeq +30 -> 1371
    //   1344: aload 16
    //   1346: iload 5
    //   1348: aload 15
    //   1350: invokeinterface 929 1 0
    ...
    //   1368: goto -34 -> 1334
    //   1371: aload_2
    //   1372: invokevirtual 234	amau:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1375: aload_1
    //   1376: aload 13
    //   1378: invokevirtual 964	alnr:a	()Lamdy;
    //   1381: iload 4
    //   1383: aload 16
    //   1385: iconst_m1
    //   1386: iconst_m1
    //   1387: iconst_1
    //   1388: invokestatic 967	amdp:a	(Lcom/tencent/common/app/AppInterface;Ljava/lang/String;Lamdy;I[IIIZ)V
    //   1391: aload 14
    //   1393: athrow
    //   1394: astore 14
    //   1396: iload 7
  ...
  public void a(List<String> paramList)
  {
    ...
    do
    {
      ...
      if (localIterator.hasNext())
      {
        ...
        paramList = a(this.jdField_a_of_type_Amau.a(), str);
        if (str.equals(this.jdField_a_of_type_Amau.jdField_b_of_type_JavaLangString)) {}
      ...
      ambc.a(this.jdField_a_of_type_Amau, (List)localObject3);
    } while (localObject1 == null);
    Object localObject2 = this.jdField_a_of_type_Amau.a().getApp().getSharedPreferences("apollo_sp", 0);
    if (!((SharedPreferences)localObject2).getBoolean("stand_type_" + ((amax)localObject1).jdField_b_of_type_Int, false)) {}
    switch (((amax)localObject1).jdField_b_of_type_Int)
    {
    default: 
      paramList = null;
      localObject3 = ambc.a(this.jdField_a_of_type_Amau.a());
      if ((!TextUtils.isEmpty(paramList)) && (localObject3 != null)) {
        ((amal)localObject3).a(this.jdField_a_of_type_Amau.jdField_b_of_type_JavaLangString, paramList);
      }
      ((SharedPreferences)localObject2).edit().putBoolean("stand_type_" + ((amax)localObject1).jdField_b_of_type_Int, true).commit();
      if (this.jdField_a_of_type_Amau.jdField_a_of_type_Int != 3000) {
        break;
      }
    }
    for (int i = 2;; i = this.jdField_a_of_type_Amau.jdField_a_of_type_Int)
    {
      VipUtils.a(null, "cmshow", "Apollo", "appearanceaction", i, ((amax)localObject1).jdField_b_of_type_Int, new String[] { String.valueOf(((amax)localObject1).jdField_a_of_type_Int) });
      return;
      paramList = amtj.a(2131713359);
      break;
      paramList = amtj.a(2131713355);
      break;
      paramList = amtj.a(2131713362);
      break;
    }
  }
  ...
  {
    if ((paramSpriteTaskParam == null) || (this.jdField_a_of_type_Amau == null) || (this.jdField_a_of_type_Amau.a() == null)) {
      return false;
    }
    ...
    if (paramSpriteTaskParam.k == 6)
    {
      ...
      {
        amdp.a(this.jdField_a_of_type_Amau.a(), ApolloUtil.c(paramSpriteTaskParam.f) + "/d.zip", ApolloUtil.d(paramSpriteTaskParam.f));
        return false;
      }
    }
    else if (paramSpriteTaskParam.k == 12)
    {
      if (!ApolloUtil.a(paramSpriteTaskParam.f, 0))
      {
        ...
        localObject = ApolloUtil.a((ApolloActionData)localObject, 4);
        amdp.a(this.jdField_a_of_type_Amau.a(), (String)localObject, paramSpriteTaskParam);
        return false;
      }
    }
    else if ((paramSpriteTaskParam.k == 11) || (paramSpriteTaskParam.k == 7))
    {
      ...
      {
        amdp.a(this.jdField_a_of_type_Amau.a(), this.jdField_a_of_type_Amau.a().getCurrentAccountUin(), null, 0, null, -1, -1, true);
        return false;
      }
    }
    return true;
  ...
  public boolean b(SpriteTaskParam paramSpriteTaskParam)
  {
    ...
    {
      Object localObject = ((amaz)this.jdField_a_of_type_Amau.a().getManager(249)).a();
      if (!bool1)
      {
        if (localObject != null) {
