...
public class benb
{
  ...
  public benb()
  {
    this.jdField_a_of_type_AndroidOsHandler = new benc(this, Looper.getMainLooper());
  }
  ...
  public void a(float paramFloat1, float paramFloat2, boolean paramBoolean)
  {
    ...
    if (paramBoolean == true) {
      localTranslateAnimation.setAnimationListener(new bend(this));
    }
  ...
  public boolean a(String paramString)
  {
    ...
    {
      this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561672, null);
      if (this.jdField_a_of_type_AndroidViewView != null)
      {
