  ...
  implements apyu
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new apxc(this);
  private apxx jdField_a_of_type_Apxx;
  private int b;
  private int c;
  private int d;
  
  public apxb(Context paramContext, FullPopData paramFullPopData, String paramString1, String paramString2, boolean paramBoolean)
  {
  ...
  private void e()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqGamecenterDataFullPopData != null)
    {
      ...
      ((ObjectAnimator)localObject2).addListener(new apxd(this));
  ...
  private void f()
  {
    int i = this.jdField_a_of_type_AndroidWidgetRelativeLayout.getTop() + aciy.a(4.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    int j = this.jdField_a_of_type_AndroidWidgetRelativeLayout.getBottom() - aciy.a(4.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.jdField_a_of_type_Apxx = new apxx(i, j, this.jdField_a_of_type_AndroidWidgetRelativeLayout.getLeft(), this.jdField_a_of_type_AndroidWidgetRelativeLayout.getRight());
    this.jdField_a_of_type_ComTencentMobileqqGamecenterViewFullPopVideoView.setOutlineProvider(this.jdField_a_of_type_Apxx);
  ...
  private void g()
  {
    ...
    {
      apxx localapxx = this.jdField_a_of_type_Apxx;
      localapxx.jdField_a_of_type_Int -= this.jdField_a_of_type_Int;
      localapxx = this.jdField_a_of_type_Apxx;
      localapxx.jdField_b_of_type_Int += this.jdField_b_of_type_Int;
      if (Build.VERSION.SDK_INT >= 21)
      {
        this.jdField_a_of_type_ComTencentMobileqqGamecenterViewFullPopVideoView.setOutlineProvider(this.jdField_a_of_type_Apxx);
        this.jdField_a_of_type_ComTencentMobileqqGamecenterViewFullPopVideoView.setClipToOutline(true);
      }
      if (this.jdField_a_of_type_Apxx.jdField_a_of_type_Int <= 0) {
  ...
  private void h()
  {
    ...
    this.jdField_d_of_type_AndroidWidgetImageView.setOnClickListener(new apxe(this));
  }
  ...
  private void i()
  {
    if (this.jdField_a_of_type_Apxx != null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqGamecenterViewFullPopVideoView.setOutlineProvider(this.jdField_a_of_type_Apxx);
      this.jdField_a_of_type_ComTencentMobileqqGamecenterViewFullPopVideoView.setClipToOutline(true);
      if (this.jdField_a_of_type_Apxx.jdField_a_of_type_Int > this.jdField_a_of_type_Apxx.jdField_b_of_type_Int)
      {
  ...
  private void j()
  {
    ...
    localObjectAnimator.addListener(new apxf(this));
  }
