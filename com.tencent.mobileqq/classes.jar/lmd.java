...
public class lmd
{
  private final ArrayList<lme> a = new ArrayList(1);
  ...
  public void a(android.content.Context paramContext, int paramInt1, int paramInt2)
  {
    ...
    //   4: astore 6
    //   6: aload_0
    //   7: getfield 18	lmd:a	Ljava/util/ArrayList;
    ...
    //   52: dup
    //   53: aload 5
    //   55: invokespecial 65	lme:<init>	(Ljava/io/BufferedReader;)V
    //   58: astore 8
    //   60: aload 5
    //   62: astore_1
    //   63: aload 5
    ...
    //   143: aload 8
    //   145: aload 10
    //   147: invokevirtual 87	lme:a	([Landroid/graphics/drawable/BitmapDrawable;)V
    //   150: aload 5
    //   152: astore_1
    //   153: aload 9
    ...
    //   160: astore_1
    //   161: aload_0
    //   162: getfield 18	lmd:a	Ljava/util/ArrayList;
    //   165: aload 8
  ...
  public void a(Canvas paramCanvas)
  {
    ...
    while (i < j)
    {
      ((lme)this.a.get(i)).a(paramCanvas);
      i += 1;
    }
  }
  ...
  public void a(PathMeasure paramPathMeasure)
  {
    ...
    while (i < j)
    {
      ((lme)this.a.get(i)).a(paramPathMeasure);
      i += 1;
    }
  }
}
