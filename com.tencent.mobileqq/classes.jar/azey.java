  ...
  extends AsyncTask<Void, Void, Integer>
{
  ...
  public azey(QQAppInterface paramQQAppInterface, Context paramContext, MessageForShortVideo paramMessageForShortVideo, azfb paramazfb)
  {
  ...
  private int a(String paramString1, String paramString2)
  {
    ...
    Object localObject1 = azet.a((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get());
    azew localazew = azet.a(paramString1);
    azex.a(localazew);
    boolean bool = azet.a(localazew, (azev)localObject1);
    this.jdField_b_of_type_Boolean = bool;
    if (QLog.isColorLevel()) {
      QLog.d("VideoCompressProcessor", 1, "CompressTask, isNeedCompress = " + bool);
    }
    if (this.jdField_a_of_type_Azfb != null) {
      bhta.a(new VideoCompressProcessor.CompressTask.1(this, bool));
    }
    if (!bool) {
      return -1;
    }
    localObject1 = azet.a(localazew, (azev)localObject1, this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo.sendRawVideo);
    int i = azhc.a((Context)this.jdField_b_of_type_JavaLangRefWeakReference.get());
    Object localObject2;
    label290:
    label380:
    long l1;
    ...
    if ((Build.VERSION.SDK_INT >= 18) && ((i & 0x1) > 0) && ((i & 0x2) > 0))
    {
      ...
      localObject2 = new azfc(this.jdField_a_of_type_JavaLangRefWeakReference, paramString1, paramString2, (azeu)localObject1, new azez(this));
      this.jdField_a_of_type_Azlu = new azlu();
      if ((!this.jdField_a_of_type_Azlu.a(new File(paramString1), (azlv)localObject2, true)) || (((azfc)localObject2).a != null)) {
        break label567;
      }
      if (QLog.isColorLevel()) {
      ...
      localObject2 = new azfa(this);
      i = ShortVideoTrimmer.a((Context)this.jdField_b_of_type_JavaLangRefWeakReference.get(), paramString1, paramString2, (QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), (azlg)localObject2, (azeu)localObject1, localazew);
      if (i != 0) {
        break label626;
      }
    ...
    {
      azex.a(bool, l3, localazew, (azeu)localObject1, l2);
      if (QLog.isColorLevel()) {
      ...
      label586:
      if (this.jdField_a_of_type_Azfb != null) {
        this.jdField_a_of_type_Azfb.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, 1.0F);
      }
      if (QLog.isColorLevel()) {
      ...
      azri.a(BaseApplication.getContext()).a(null, "initVideoTrimError", true, 0L, 0L, null, "", false);
      break label380;
  ...
  protected Integer a(Void... paramVarArgs)
  {
    ...
    if ((TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo.videoFileName)) || (!bdhb.b(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo.videoFileName)))
    {
      if (QLog.isColorLevel()) {
    ...
    if ((TextUtils.isEmpty(this.c)) || (!bdhb.b(this.c)))
    {
    ...
    for (;;)
    {
      ...
      try
      {
        this.jdField_b_of_type_JavaLangString = bdhe.a(MD5.toMD5Byte(new FileInputStream(paramVarArgs), this.jdField_a_of_type_Long));
      ...
      catch (Exception paramVarArgs)
      {
        ...
        if (this.jdField_a_of_type_Long < 104345600L)
        {
          ...
          bdhb.a(new File(this.c), new File(ShortVideoUtils.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, "mp4")));
        }
      }
    }
  ...
  public void a(azfb paramazfb)
  {
    ...
    do
    {
      do
      {
        ...
        } while (this.jdField_a_of_type_Azfb == null);
        this.jdField_a_of_type_Azfb.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, 1);
        return;
        if (!isCancelled()) {
          break;
        }
      } while (this.jdField_a_of_type_Azfb == null);
      this.jdField_a_of_type_Azfb.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, 3);
      return;
    } while (this.jdField_a_of_type_Azfb == null);
    this.jdField_a_of_type_Azfb.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, this.jdField_b_of_type_Boolean);
  }
  ...
  protected void a(Integer paramInteger)
  {
    ...
    if (this.jdField_a_of_type_Azfb != null)
    {
      azfb localazfb = this.jdField_a_of_type_Azfb;
      MessageForShortVideo localMessageForShortVideo = this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo;
      if (paramInteger.intValue() == 1) {
        i = 1;
      }
      localazfb.a(localMessageForShortVideo, i);
    }
    while (paramInteger.intValue() == 1)
    {
      agai.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, (QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), (Context)this.jdField_b_of_type_JavaLangRefWeakReference.get());
      return;
      if (QLog.isColorLevel()) {
        QLog.d("VideoCompressProcessor", 2, "onPostExecute, mListener is null ," + b());
      }
    }
    agai.b(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, (QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), (Context)this.jdField_b_of_type_JavaLangRefWeakReference.get());
  }
  
  public boolean a()
  {
    if (this.jdField_a_of_type_Azlu != null) {}
    for (boolean bool = this.jdField_a_of_type_Azlu.b();; bool = false) {
      try
      {
        if (this.jdField_a_of_type_JavaLangProcess != null) {
          this.jdField_a_of_type_JavaLangProcess.destroy();
  ...
  protected void onCancelled()
  {
    ...
    if (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)
    {
      ...
      if (!TextUtils.isEmpty(localMessageForShortVideo.md5)) {
        bdhb.d(ShortVideoUtils.a(localMessageForShortVideo, "mp4"));
      }
      ...
      axwx.a((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), localMessageForShortVideo.frienduin, localMessageForShortVideo.uniseq);
    ...
    for (Object localObject = ShortVideoUtils.d(this.jdField_a_of_type_JavaLangString, "mp4");; localObject = ShortVideoUtils.c(this.jdField_a_of_type_JavaLangString, "mp4"))
    {
      if (!TextUtils.isEmpty((CharSequence)localObject)) {
        bdhb.d((String)localObject);
      }
      azex.a().a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo.uniseq);
      if (QLog.isColorLevel()) {
