...
public class bkur
{
  ...
  static
  {
    ...
    jdField_f_of_type_Int = bbkx.a(66.0F);
  }
  ...
  public static void a(Activity paramActivity)
  {
    ...
    {
      jdField_b_of_type_Int = muf.b(BaseApplicationImpl.getApplication());
      jdField_c_of_type_Int = muf.a(BaseApplicationImpl.getApplication());
      jdField_a_of_type_Boolean = false;
    }
    try
    {
  ...
  public static int[] a(Context paramContext)
  {
    ...
    boolean bool = bfxo.a(paramContext);
    if (bool) {}
    for (int i = bfxo.a(paramContext);; i = 0)
    {
      if (QLog.isColorLevel()) {
