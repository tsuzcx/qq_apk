...
public class bbzw
  extends bcft
{
  public static final bcfu<bbzw> a;
  public int a;
  public String a;
  ...
  static
  {
    jdField_a_of_type_Bcfu = new bbzx();
  }
  ...
  public static final List<bbzw> a(JSONObject paramJSONObject)
  {
    ...
    while (i < n)
    {
      ...
      if (j < i1)
      {
        ...
        for (localObject = ((JSONObject)localObject).getString("label");; localObject = null)
        {
          ...
          localFriend.jdField_b_of_type_JavaLangString = bcdy.a(paramJSONObject);
          localFriend.jdField_c_of_type_JavaLangString = bcdy.a((String)localObject);
      ...
      paramJSONObject = new bbzw();
      paramJSONObject.jdField_a_of_type_Int = i;
      paramJSONObject.jdField_a_of_type_JavaLangString = bcdy.a(localJSONObject.getString("label"));
  ...
  public static final List<bbzw> b(JSONObject paramJSONObject)
  {
    ...
    bbzw localbbzw = new bbzw();
    localbbzw.jdField_a_of_type_Int = 0;
    localbbzw.jdField_a_of_type_JavaLangString = ajjy.a(2131639083);
    localbbzw.jdField_a_of_type_JavaUtilList = localArrayList2;
    localArrayList1.add(localbbzw);
    int j = 0;
    int i = 1;
    while (j < m)
    {
      ...
      while (k < i2)
      {
        ...
        else
        {
          ...
          for (String str1 = localJSONObject2.getString("remark");; str1 = null)
          {
            ...
            localFriend.jdField_b_of_type_JavaLangString = bcdy.a((String)localObject);
            localFriend.jdField_c_of_type_JavaLangString = bcdy.a(str1);
      ...
      Object localObject = new bbzw();
      ((bbzw)localObject).jdField_a_of_type_Int = i;
      ((bbzw)localObject).jdField_a_of_type_JavaLangString = bcdy.a(localJSONObject1.getString("groupname"));
      ((bbzw)localObject).jdField_a_of_type_JavaUtilList = localArrayList3;
    ...
    if (localArrayList2.size() == 0)
    {
      ...
      {
        paramJSONObject = (bbzw)localArrayList1.get(i);
  ...
  public static final List<bbzw> c(JSONObject paramJSONObject)
  {
    JSONArray localJSONArray1 = paramJSONObject.getJSONArray("qqlist");
    int m = localJSONArray1.length();
    int n = paramJSONObject.optInt("app_tid", -1);
    ...
    ArrayList localArrayList2 = new ArrayList();
    bbzw localbbzw2 = new bbzw();
    localbbzw2.jdField_a_of_type_Int = 0;
    localbbzw2.jdField_a_of_type_JavaLangString = ajjy.a(2131639082);
    localbbzw2.jdField_a_of_type_JavaUtilList = localArrayList2;
    localArrayList1.add(localbbzw2);
    int i = 0;
    bbzw localbbzw1 = null;
    int j = 1;
    if (i < m)
    {
      ...
      if (ajjy.a(2131639081).equals(localJSONObject1.getString("label")))
      {
        localbbzw1 = new bbzw();
        localbbzw1.jdField_a_of_type_Int = 0;
        localbbzw1.jdField_a_of_type_JavaLangString = bcdy.a(localJSONObject1.getString("label"));
        localbbzw1.jdField_a_of_type_JavaUtilList = localArrayList3;
      }
      for (;;)
      {
        i += 1;
        ...
        ((bbzw)localObject).jdField_a_of_type_Int = j;
        ((bbzw)localObject).jdField_a_of_type_JavaLangString = bcdy.a(localJSONObject1.getString("label"));
        ((bbzw)localObject).jdField_a_of_type_JavaUtilList = localArrayList3;
        localArrayList1.add(localObject);
        j += 1;
      }
    ...
    if (paramJSONObject.getInt("only") == 1)
    {
      ...
      paramJSONObject.add(localbbzw2);
      return paramJSONObject;
    }
    if (localArrayList2.size() == 0)
    {
      if ((localbbzw1 == null) || (localbbzw1.jdField_a_of_type_JavaUtilList == null) || (localbbzw1.jdField_a_of_type_JavaUtilList.size() <= 0)) {
        break label493;
      }
      localArrayList1.remove(0);
      localArrayList1.add(0, localbbzw1);
    }
    for (;;)
    {
      return localArrayList1;
