  ...
  implements TextWatcher, View.OnClickListener, View.OnTouchListener
{
  ...
  public akdg(CountryActivity paramCountryActivity, Context paramContext)
  {
    super(paramContext);
    ...
    this.jdField_a_of_type_Akdf = new akdf(paramCountryActivity, null);
    this.jdField_a_of_type_ComTencentWidgetListView.setAdapter(this.jdField_a_of_type_Akdf);
  ...
  void a(String paramString)
  {
    ...
    this.jdField_a_of_type_Akdf.a(paramString);
    if (this.jdField_a_of_type_Akdf.getCount() == 0) {
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    }
    for (;;)
    {
      this.jdField_a_of_type_Akdf.notifyDataSetChanged();
      return;
  ...
  public void dismiss()
  {
    ...
    //   4: aload_0
    //   5: invokestatic 205	adbo:a	(Landroid/app/Dialog;)V
    //   8: return
    //   9: astore_1
    //   10: aload_0
    //   11: invokestatic 205	adbo:a	(Landroid/app/Dialog;)V
    //   14: return
    //   15: astore_1
    //   16: aload_0
    //   17: invokestatic 205	adbo:a	(Landroid/app/Dialog;)V
    //   20: aload_1
    //   21: athrow
