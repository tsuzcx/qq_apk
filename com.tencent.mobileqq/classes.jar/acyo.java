  ...
  extends aczg
{
    ...
    for (;;)
    {
      ...
      if (localResvAttr.uint32_holiday_flag.has())
      {
        ...
        if (k == 1)
        {
          ...
          {
            j = i;
            ((MessageRecord)paramList.get(0)).saveExtInfoToExtStr(bbyw.c, String.valueOf(k));
          }
        }
        j = i;
        if (QLog.isColorLevel())
      ...
      if (localResvAttr.uint32_service_msg_type.has())
      {
        ...
        {
          j = i;
          ((MessageRecord)paramList.get(0)).saveExtInfoToExtStr(bbyw.z, String.valueOf(k));
        }
        j = i;
      ...
      if (localResvAttr.uint32_service_msg_remind_type.has())
      {
        ...
        {
          j = i;
          ((MessageRecord)paramList.get(0)).saveExtInfoToExtStr(bbyw.A, String.valueOf(k));
        }
        j = i;
      ...
      if (localResvAttr.bytes_service_msg_name.has())
      {
        ...
        {
          j = i;
          ((MessageRecord)paramList.get(0)).saveExtInfoToExtStr(bbyw.B, (String)localObject);
        }
        j = i;
  ...
  public boolean a(List<im_msg_body.Elem> paramList, msg_comm.Msg paramMsg, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, boolean paramBoolean1, boolean paramBoolean2, bepr parambepr, bbzl parambbzl, bbyn parambbyn)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      a(paramList1, paramStringBuilder, parambepr);
      a(paramList1, paramMsg, parambepr);
    }
    return false;
  }
