...
public class mop
{
  ...
  public mop(mou parammou)
  {
    this.jdField_a_of_type_Mou = parammou;
  }
      ...
      do
      {
        ...
        if (j == -2)
        {
          ...
          if ((!this.jdField_c_of_type_Boolean) && ((this.jdField_b_of_type_Boolean) || (this.jdField_d_of_type_Boolean)))
          {
            ...
            if (this.jdField_a_of_type_Mou.a != null) {
              this.jdField_a_of_type_Mou.a.j();
            }
          }
  ...
  protected void a(mog parammog, boolean paramBoolean)
  {
    if (AudioHelper.f()) {
      QLog.w("QavRecordEncoder", 1, "handleAudioFrame, frame[" + parammog + "], endOfStream[" + paramBoolean + "], mNoAudio[" + this.jdField_d_of_type_Boolean + "]");
    }
    if (this.jdField_d_of_type_Boolean) {
      return;
    }
    this.jdField_a_of_type_JavaNioByteBuffer.clear();
    this.jdField_a_of_type_JavaNioByteBuffer.put(parammog.a);
    this.jdField_a_of_type_JavaNioByteBuffer.position(parammog.a.length);
    ...
    if (j >= 0)
    {
      ...
      this.jdField_b_of_type_AndroidMediaMediaCodec.queueInputBuffer(j, 0, parammog.a.length, parammog.jdField_b_of_type_Long, 0);
      if (QLog.isColorLevel()) {
        QLog.d("QavRecordEncoder", 2, "encode, write to codec, size=" + parammog.a.length);
      }
      label217:
      parammog = this.jdField_b_of_type_AndroidMediaMediaCodec.getOutputBuffers();
      i = 0;
    }
    for (;;)
    {
  ...
  public void a(byte[] paramArrayOfByte, long paramLong)
  {
    ...
    paramArrayOfByte = new mog(paramArrayOfByte, l);
  ...
  public void b()
  {
    ...
    long l = this.jdField_a_of_type_Long;
    this.jdField_a_of_type_Long = (1L + l);
    mog localmog = new mog(new byte[0], l);
    localmog.jdField_b_of_type_Long = this.jdField_b_of_type_Long;
    a(localmog, true);
    a(true);
    c();
    if (this.jdField_a_of_type_JavaNioByteBuffer != null)
