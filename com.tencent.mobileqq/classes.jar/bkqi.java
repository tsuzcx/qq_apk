  ...
  implements wam
{
  ...
  bkqi(bkqf parambkqf, PublishVideoEntry paramPublishVideoEntry, String paramString1, String paramString2)
  {
  ...
  public void onFinish(boolean paramBoolean)
  {
    ...
    ((HashMap)localObject).put("generate_video_cost", this.jdField_a_of_type_Bkqf.a + "");
    ((HashMap)localObject).put("watermark_cost", d + "");
    axrl.a(BaseApplication.getContext()).a(null, "qq_ptv_save_time", true, 0L, 0L, (HashMap)localObject, null);
    bbdj.d(this.jdField_a_of_type_JavaLangString);
    SaveVideoActivity.a(false);
    int i;
    Intent localIntent;
    if (bkqf.a(this.jdField_a_of_type_Bkqf).get() != null)
    {
      localObject = (Activity)bkqf.a(this.jdField_a_of_type_Bkqf).get();
      if (bkqf.b(this.jdField_a_of_type_Bkqf).get() != null) {
        SaveVideoActivity.a((AppInterface)bkqf.b(this.jdField_a_of_type_Bkqf).get(), this.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry);
      }
      if (!paramBoolean) {
        break label340;
      }
      i = bkqf.b(this.jdField_a_of_type_Bkqf, -1);
      if (!birc.e(((Activity)localObject).getIntent())) {
        break label353;
      }
    ...
    bkqf.a(this.jdField_a_of_type_Bkqf, bkqf.a(this.jdField_a_of_type_Bkqf));
  }
  ...
  public void onSuccess(String paramString)
  {
    ...
    vyi.a(BaseApplication.getContext(), new File(this.b));
    bbdj.d(new File(this.jdField_a_of_type_JavaLangString).getParent());
  }
}
