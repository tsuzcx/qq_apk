...
public final class mjb
{
  ...
  private List<lqn> jdField_a_of_type_JavaUtilList = new ArrayList();
  private volatile lqk jdField_a_of_type_Lqk;
  private boolean jdField_a_of_type_Boolean;
  private float[] jdField_a_of_type_ArrayOfFloat;
  private mec[] jdField_a_of_type_ArrayOfMec = new mec[16];
  ...
  public mjb(VideoController paramVideoController)
  {
    this.jdField_a_of_type_ComTencentAvVideoController = paramVideoController;
    int i = 0;
    while (i < 16)
    {
      this.jdField_a_of_type_ArrayOfMec[i] = new mec();
      i += 1;
    }
  }
  
  private lqk a(int paramInt1, int paramInt2)
  {
    ...
    for (int i = 1;; i = 0)
    {
      if (this.jdField_a_of_type_Lqk == null)
      {
        this.d = paramInt1;
        this.e = paramInt2;
        this.jdField_a_of_type_Lqk = new lqk(paramInt1, paramInt2);
  ...
  private void d()
  {
    if (this.jdField_a_of_type_Lqk != null)
    {
      ...
      this.jdField_a_of_type_Lqk = null;
  ...
  public Frame a(int paramInt1, int paramInt2)
  {
    if (this.jdField_a_of_type_Int >= 2)
    {
      ...
      localObject = ((lqk)localObject).a(this.jdField_a_of_type_JavaUtilList, System.currentTimeMillis());
  ...
  {
    int i = 1;
    this.jdField_a_of_type_ArrayOfMec[this.jdField_a_of_type_Int].jdField_a_of_type_Int = paramInt1;
    this.jdField_a_of_type_ArrayOfMec[this.jdField_a_of_type_Int].jdField_b_of_type_Int = paramInt2;
    this.jdField_a_of_type_ArrayOfMec[this.jdField_a_of_type_Int].jdField_c_of_type_Int = paramInt3;
    this.jdField_a_of_type_Int += 1;
    lqn locallqn = new lqn();
    locallqn.jdField_a_of_type_Int = paramInt1;
    locallqn.jdField_b_of_type_Int = paramInt2;
    locallqn.jdField_c_of_type_Int = paramInt3;
    locallqn.jdField_a_of_type_JavaUtilList = paramList;
    locallqn.d = paramInt4;
    locallqn.e = paramInt5;
    locallqn.jdField_a_of_type_Boolean = paramBoolean1;
    ...
    for (paramInt1 = i;; paramInt1 = 0)
    {
      ...
      this.jdField_a_of_type_JavaUtilList.add(0, locallqn);
      return;
      paramBoolean1 = false;
      break;
    }
    label187:
    this.jdField_a_of_type_JavaUtilList.add(locallqn);
  }
  
  public boolean a(mis parammis)
  {
    int j = 1;
    this.jdField_a_of_type_JavaLangString = "";
    if (this.jdField_a_of_type_ComTencentAvVideoController.a.a(3))
    {
      parammis = ((lgr)this.jdField_a_of_type_ComTencentAvVideoController.a.a(3)).a();
      if (parammis != null) {
        this.jdField_a_of_type_JavaLangString = parammis.getDesc();
      }
    }
    for (int i = 1;; i = 0)
    {
      ...
      for (i = j;; i = 0)
      {
        ...
        return log.c(VideoController.a().a());
      }
    }
  }
