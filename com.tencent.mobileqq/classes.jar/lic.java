...
public abstract class lic
{
  ...
  public lic(String paramString1, String paramString2, String paramString3)
  {
    lcg.c("AVMagicfaceData", "init|config=" + paramString2 + "|" + paramString3 + "|" + paramString1);
    ...
    try
    {
      ...
      this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicfaceDataVideoJason = ((MagicfaceDataVideoJason)bazp.a(paramString2, MagicfaceDataVideoJason.class));
      int i;
      ...
      if (paramString1.has("audio")) {
        this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicfaceDataAudioJason = ((MagicfaceDataAudioJason)bazp.a(paramString1.getJSONObject("audio"), MagicfaceDataAudioJason.class));
      }
      ...
      if (paramString1.has("pendant"))
      {
        ...
        {
          paramString2 = (MagicfaceDataPendantJason)bazp.a((JSONObject)paramString1.get(i), MagicfaceDataPendantJason.class);
          if ((paramString2 != null) && (!TextUtils.isEmpty(paramString2.name)))
          {
            lcg.e("AVMagicfaceData", "Pendant: " + paramString2.toString());
    ...
    catch (JSONException paramString1)
    {
      ...
      if (this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicfaceDataVideoJason == null)
      {
        lcg.e("AVMagicfaceData", "MagicfaceData error!");
      ...
      lcg.e("AVMagicfaceData", "MagicfaceData:: " + this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicfaceDataVideoJason.toString());
  ...
  public boolean a(lic paramlic)
  {
    ...
    if (paramlic != null)
    {
      ...
      if (!TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {
        if ((!TextUtils.isEmpty(paramlic.jdField_b_of_type_JavaLangString)) && (!paramlic.jdField_b_of_type_JavaLangString.equalsIgnoreCase("face")))
        {
          bool1 = bool2;
          if (!paramlic.jdField_b_of_type_JavaLangString.equalsIgnoreCase("voicesticker")) {}
        }
        else
        {
          bool1 = bool2;
