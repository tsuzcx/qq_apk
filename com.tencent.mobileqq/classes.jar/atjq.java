...
public abstract class atjq
  implements IExcitingTransferRecvListener
{
  protected final int a;
  protected long a;
  protected final atjr a;
  private atjt a;
  ...
  public atjq(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, int paramInt, atjr paramatjr)
  {
    ...
    this.d = paramLong1;
    this.jdField_a_of_type_Atjr = paramatjr;
    this.c = paramLong2;
  ...
  public void OnOneSlotComplete(int paramInt, ExcitingTransferOneSlotComplete paramExcitingTransferOneSlotComplete)
  {
    ...
    for (String str = paramExcitingTransferOneSlotComplete.m_strIp;; str = "")
    {
      ...
      if (this.jdField_a_of_type_Atjt == null) {
        break;
      }
      this.jdField_a_of_type_Atjt.a(paramInt, paramExcitingTransferOneSlotComplete);
      return;
      str = "";
      break label52;
    }
  ...
  protected ExcitingTransferDownloadReqInfo a()
  {
    ...
    if (this.jdField_a_of_type_Atjr != null)
    {
      localExcitingTransferDownloadReqInfo.fileSize = this.jdField_a_of_type_Atjr.a();
      localExcitingTransferDownloadReqInfo.md5 = this.jdField_a_of_type_Atjr.a();
      localExcitingTransferDownloadReqInfo.isSupportHttps = this.jdField_a_of_type_Atjr.b();
      localExcitingTransferDownloadReqInfo.sslCName = this.jdField_a_of_type_Atjr.d();
      localExcitingTransferDownloadReqInfo.strFileName = this.jdField_a_of_type_Atjr.a();
      if (this.jdField_a_of_type_Atjr.a() != null) {
        localExcitingTransferDownloadReqInfo.mHosts = ((ExcitingTransferHostInfo[])this.jdField_a_of_type_Atjr.a().toArray(new ExcitingTransferHostInfo[this.jdField_a_of_type_Atjr.a().size()]));
      }
      localExcitingTransferDownloadReqInfo.strFileName = this.jdField_a_of_type_Atjr.a();
      localExcitingTransferDownloadReqInfo.serverPath = this.jdField_a_of_type_Atjr.b();
    }
    for (;;)
    {
  ...
  public void a(int paramInt, ExcitingTransferDownloadCompletedInfo paramExcitingTransferDownloadCompletedInfo)
  {
    ...
    if (this.jdField_a_of_type_Atjt != null) {
      this.jdField_a_of_type_Atjt.a(paramInt, paramExcitingTransferDownloadCompletedInfo);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Atjt != null) {
      this.jdField_a_of_type_Atjt.a(paramLong1, paramLong2, paramLong3);
    }
  }
  
  public void a(atjt paramatjt)
  {
    this.jdField_a_of_type_Atjt = paramatjt;
  }
  ...
  public void a(ExcitingTransferDownloadCompletedInfo paramExcitingTransferDownloadCompletedInfo)
  {
    ...
    if (this.jdField_a_of_type_Atjt != null) {
      this.jdField_a_of_type_Atjt.a(0, paramExcitingTransferDownloadCompletedInfo);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Atjr != null) {
      return "Cookie:t=0;v=" + AppSetting.a() + ";" + this.jdField_a_of_type_Atjr.c() + ";\r\n";
    }
    return "";
  }
  ...
  public void onRecvComplete(int paramInt, ExcitingTransferDownloadCompletedInfo paramExcitingTransferDownloadCompletedInfo)
  {
    ...
    if (paramInt == 0)
    {
      ...
      label70:
      QLog.i("ExcitingTransfer.BaseDownloader<FileAssistant>", 1, str);
      if ((bool) && (this.jdField_a_of_type_Atjr != null)) {
        this.jdField_b_of_type_Long = this.jdField_a_of_type_Atjr.a();
      }
  ...
  public void onRecvStart()
  {
    ...
    } while (this.jdField_a_of_type_Atjt == null);
    this.jdField_a_of_type_Atjt.a();
  }
}
