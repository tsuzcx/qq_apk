...
import com.tencent.mobileqq.identification.IdentificationActivityHelper.4;
  ...
  implements Handler.Callback, EIPCResultCallback
{
  ...
  @RequiresApi(api=18)
  public avpw(QQIdentiferActivity paramQQIdentiferActivity, int paramInt)
  {
    this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
    this.jdField_a_of_type_ComTencentMobileqqActivityQQIdentiferActivity = paramQQIdentiferActivity;
    this.jdField_a_of_type_Avpy = avpy.a(paramInt, paramQQIdentiferActivity.getIntent(), paramQQIdentiferActivity);
  ...
  public static boolean a()
  {
    ...
    if ((!TextUtils.isEmpty(str)) && (!a("new_qq_android_native_short_new_other_", bhhr.b())) && (b())) {
      return false;
    }
    bhhr.c("");
    bhhr.b(0);
  ...
  private static boolean b(String paramString, int paramInt)
  {
    ...
    if (!TextUtils.isEmpty((CharSequence)localObject1))
    {
      ...
      if (((List)localObject2).size() > 0)
      {
        ...
        } while (!((ShortVideoResourceManager.SVConfigItem)localObject1).name.startsWith(paramString));
      }
    }
    for (;;)
    {
      try
      {
        i = Integer.parseInt(((ShortVideoResourceManager.SVConfigItem)localObject1).name.substring(paramString.length()));
        QLog.d("qq_Identification.Helper", 1, new Object[] { "aes newVersion is ", Integer.valueOf(i), " localVersion is ", Integer.valueOf(paramInt), " res is ", paramString });
        if (paramInt != i) {
          return true;
        }
      }
      ...
      {
        i = ((ShortVideoResourceManager.SVConfigItem)localObject1).versionCode;
        continue;
      }
      return false;
      int i = -1;
  ...
  {
    String str1 = a();
    String str2 = bnky.a(bnkt.c) + "libYTCommon.so";
    File localFile = new File(str2);
    if ((TextUtils.isEmpty(str1)) || (!localFile.exists()))
    {
      QLog.d("qq_Identification.Helper", 1, new Object[] { "no res,need download , commonSo exists : ", Boolean.valueOf(localFile.exists()), " resPath : ", str1, " aesPath : ", str2 });
      a(this);
      return;
    }
    if (!a(str1))
    {
      QLog.d("qq_Identification.Helper", 1, new Object[] { "check so files error, path is ", str1 });
      d();
      return;
    }
    if ((a("new_qq_android_native_short_new_other_", bhhr.b())) || (b(bnkt.jdField_b_of_type_Bnkt.jdField_b_of_type_JavaLangString, bnky.a(bnkt.jdField_b_of_type_Bnkt.jdField_a_of_type_Int))))
    {
    ...
    if (bhhr.b() < 6)
    {
      QLog.d("qq_Identification.Helper", 1, new Object[] { "local version : ", Integer.valueOf(bhhr.b()), " min version : ", Integer.valueOf(6) });
      d();
      return;
    }
    if (!b())
    ...
    QLog.d("qq_Identification.Helper", 1, new Object[] { "preCheck is pass, so version is ", Integer.valueOf(bhhr.b()), " current bits is : ", Integer.valueOf(b()) });
  ...
  public void b()
  {
    ...
    {
      jdField_a_of_type_Boolean = this.jdField_a_of_type_Avpy.a(bnky.a(bnkt.c), avpy.b);
      jdField_a_of_type_Boolean &= this.jdField_a_of_type_Avpy.a(this.jdField_a_of_type_JavaLangString + "identification/so/", avpy.a);
    }
    int i;
    if (jdField_a_of_type_Boolean)
    {
    ...
    for (;;)
    {
      ...
      YtLogger.setLoggerListener(new avpx(this));
      return;
      i = this.jdField_a_of_type_Avpy.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQIdentiferActivity, this.jdField_a_of_type_JavaLangString);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (paramMessage.arg1 == 0)
    {
      ...
      if (paramMessage.arg1 == 0)
      {
        ...
        this.jdField_a_of_type_Avpy.a(true, this.jdField_a_of_type_ComTencentMobileqqActivityQQIdentiferActivity);
      }
      if (paramMessage.arg1 != 0) {
        break label238;
      }
