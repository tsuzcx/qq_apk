  ...
  extends aztc
{
  ...
  public azum()
  {
    this.jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new azun(this);
  }
  ...
  public static String a(AbsShareMsg paramAbsShareMsg, String paramString)
  {
    ...
    } while ((!(localObject1 instanceof azqk)) || (((azqk)localObject1).a == null) || (((azqk)localObject1).a.isEmpty()));
    Object localObject1 = ((azqk)localObject1).a.iterator();
    label191:
    if (((Iterator)localObject1).hasNext())
    {
      localObject2 = (azqj)((Iterator)localObject1).next();
      if ((paramString.equals("cover")) && ((localObject2 instanceof azsm)))
      {
        paramAbsShareMsg = StructMsgForGeneralShare.getCoverForChatHistory((azqj)localObject2);
        label231:
    ...
    for (;;)
    {
      if (!TextUtils.isEmpty(paramAbsShareMsg))
      {
        ...
        {
          paramAbsShareMsg = StructMsgForGeneralShare.getTitleForChatHistory((azqj)localObject2);
          break label231;
        }
        if ((!paramString.equals("summary")) || (!(localObject2 instanceof azvd))) {
          break label301;
        }
        paramAbsShareMsg = StructMsgForGeneralShare.getSummary((azqj)localObject2);
        break label231;
        label295:
        break label191;
      }
  ...
  void a()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg != null) && (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.message != null))
    {
      ...
      {
        localObject = (AbsShareMsg)azqu.a(((MessageRecord)localObject).msgData);
  ...
  {
    Object localObject = new azup(this);
    Resources localResources = paramContext.getResources();
    View localView;
    int i;
    label122:
    int j;
    if ((paramView != null) && ((paramView instanceof RelativeLayout)) && (paramView.findViewById(2131363764) != null) && ((paramView.getTag() instanceof azup)))
    {
      localObject = (azup)paramView.getTag();
      localView = paramView;
      paramView = (View)localObject;
      a();
      boolean bool = paramBundle.getBoolean("isSend", true);
      paramBundle = (BubbleViewLayout)localView.findViewById(2131363764);
      i = 19;
      ...
      paramView.jdField_a_of_type_AndroidWidgetTextView.setPadding(aekt.a(9.0F, localResources), 0, aekt.a(i, localResources), 0);
      paramView.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setPadding(aekt.a(9.0F, localResources), aekt.a(3.0F, localResources), aekt.a(i, localResources), 0);
      paramBundle = (ViewGroup.MarginLayoutParams)paramView.jdField_a_of_type_AndroidWidgetRelativeLayout.getLayoutParams();
      if (j == 0) {
        break label925;
      }
      paramBundle.setMargins(aekt.a(18.0F, localResources), 0, 0, 0);
      ...
      paramBundle.setMargins(aekt.a(18.0F, localResources), 0, 0, 0);
      paramView.jdField_a_of_type_AndroidWidgetLinearLayout.setPadding(aekt.a(19.5F, localResources), 0, aekt.a(10.0F, localResources), 0);
      label339:
      paramBundle = localResources.getDrawable(2130849786);
    ...
    try
    {
      localObject = URLDrawable.getDrawable(new URL(this.T), aekt.a(249.0F, localResources), aekt.a(139.0F, localResources), paramBundle, paramBundle, true);
    ...
    for (;;)
    {
      ...
      i = (int)(BaseChatItemLayout.A * 0.8F) - aekt.a(19.5F, localResources) - aekt.a(10.0F, localResources) - aekt.a(13.0F, localResources);
      paramView.jdField_b_of_type_AndroidWidgetTextView.setMaxWidth(i);
      i /= aekt.a(14.0F, localResources);
      ...
      paramView.jdField_b_of_type_AndroidWidgetTextView.setText(new baiq(paramBundle, 3, 15));
      paramView.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
      paramContext = new azuo(this, paramContext, new String(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.mMsgActionData), this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.mMsgUrl);
      ...
      return localView;
      localView = LayoutInflater.from(paramContext).inflate(2131559496, null);
      ((azup)localObject).jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localView.findViewById(2131364879));
      ((azup)localObject).jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131377884));
      ((azup)localObject).jdField_a_of_type_ComTencentWidgetSingleLineTextView = ((SingleLineTextView)localView.findViewById(2131377222));
      ((azup)localObject).jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localView.findViewById(2131363764));
      ((azup)localObject).jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localView.findViewById(2131362232));
      ((azup)localObject).jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)localView.findViewById(2131364539));
      ((azup)localObject).jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131362231));
      ((azup)localObject).c = ((RelativeLayout)localView.findViewById(2131363813));
      ((azup)localObject).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131363805));
      ...
      break label339;
      paramView.jdField_a_of_type_AndroidWidgetTextView.setPadding(aekt.a(i, localResources), 0, aekt.a(9.0F, localResources), 0);
      paramView.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setPadding(aekt.a(i, localResources), aekt.a(3.0F, localResources), aekt.a(9.0F, localResources), 0);
      paramBundle = (ViewGroup.MarginLayoutParams)paramView.jdField_a_of_type_AndroidWidgetRelativeLayout.getLayoutParams();
      if (j != 0)
      {
        paramBundle.setMargins(0, 0, aekt.a(18.0F, localResources), 0);
        ((RelativeLayout.LayoutParams)paramView.c.getLayoutParams()).addRule(11);
        paramBundle = (RelativeLayout.LayoutParams)paramView.jdField_a_of_type_AndroidWidgetLinearLayout.getLayoutParams();
        paramBundle.addRule(11);
        paramBundle.setMargins(0, 0, aekt.a(18.0F, localResources), 0);
        paramView.jdField_a_of_type_AndroidWidgetLinearLayout.setPadding(aekt.a(10.0F, localResources), 0, aekt.a(19.5F, localResources), 0);
        break label339;
      }
      paramBundle.setMargins(0, 0, 0, 0);
      break label339;
