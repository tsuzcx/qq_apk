  ...
  implements bgnx
{
  ...
  public azbw(HWReciteItem paramHWReciteItem, azac paramazac)
  {
  ...
  public void a(String paramString)
  {
    if (QLog.isColorLevel()) {
      QLog.i("HWReciteItem", 2, "upload onComplete " + this.jdField_a_of_type_Azac.b);
    }
    this.jdField_a_of_type_Azac.b(paramString);
    this.jdField_a_of_type_Azac.g = 3;
  }
  ...
  public void b(int paramInt)
  {
    ...
    this.jdField_a_of_type_Azac.g = 2;
