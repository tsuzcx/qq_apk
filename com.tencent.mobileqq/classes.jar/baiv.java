...
public class baiv
{
  private static volatile baiv jdField_a_of_type_Baiv;
  ...
  public static baiv a()
  {
    if (jdField_a_of_type_Baiv == null) {}
    try
    {
      if (jdField_a_of_type_Baiv == null) {
        jdField_a_of_type_Baiv = new baiv();
      }
      return jdField_a_of_type_Baiv;
    }
    finally {}
  }
  ...
  private void a(long paramLong1, long paramLong2, submsgtype0x122.MsgBody paramMsgBody)
  {
    ...
    try
    {
      ...
      paramMsgBody = avia.a(paramMsgBody);
    }
    catch (UnsupportedEncodingException paramMsgBody)
    {
      do
      {
        ...
        localObject6 = "";
        localObject3 = "";
        localObject9 = ((avhs)localObject9).a();
    ...
    if (paramMsgBody != null)
    {
      ...
      if (((avhs)localObject9).a() != 6) {
        QLog.e("PushDialogHandler", 1, new Object[] { "error note type:", Integer.valueOf(((avhs)localObject9).a()) });
      }
    }
    else
    {
    ...
    for (;;)
    {
      ...
      {
        localavhs = (avhs)localIterator.next();
        localObject9 = localavhs.a();
        localObject15 = localavhs.a();
        if (localavhs.a() == 7)
        {
    ...
    for (;;)
    {
      ...
      {
        localObject10 = (avhs)((Iterator)localObject12).next();
        localObject9 = ((avhs)localObject10).a();
        if (((avhs)localObject10).a() == 2)
        {
      ...
      {
        break label435;
        if ((((avhs)localObject10).a() != 3) || (localObject9 == null)) {
          break label1073;
        }
        ...
        if (localavhs.a() == 9)
        {
          ...
          if (localObject15 != null)
          {
            ...
            {
              localObject9 = (avhs)((Iterator)localObject15).next();
              if (((avhs)localObject9).a() == 10)
              {
                localObject9 = ((avhs)localObject9).a();
              ...
              for (;;)
              {
                ...
                aeow.a((Intent)localObject9, PublicTransFragmentActivity.class, RiskHintDlgFragment.class);
                return;
              }
            }
          }
  ...
  public void a(submsgtype0x122.MsgBody paramMsgBody, MsgInfo paramMsgInfo, QQAppInterface paramQQAppInterface)
  {
    ...
    bait.a().b(this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager, paramMsgBody);
  }
  
  public boolean a(QQAppInterface paramQQAppInterface, MsgInfo paramMsgInfo)
  {
    boolean bool2 = false;
    paramQQAppInterface = paramQQAppInterface.getMessageProxy(0).f(String.valueOf(paramMsgInfo.lFromUin), 0);
    boolean bool1 = bool2;
