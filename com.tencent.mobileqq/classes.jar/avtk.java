...
class avtk
  extends ntf
{
  avtk(avti paramavti, int paramInt1, int paramInt2, boolean paramBoolean, avtl paramavtl) {}
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    for (Object localObject = "null";; localObject = paramBundle.toString())
    {
      ...
      avti.b(this.jdField_a_of_type_Avti, this.c, paramArrayOfByte, this.b, this.jdField_a_of_type_Int, this.jdField_a_of_type_Avtl);
      return;
    }
    ...
    try
    {
      ...
      if (((CommProtocolProto.commResponse)localObject).code.get() == 1008)
      {
        ...
        avti.a(this.jdField_a_of_type_Avti, this.c, paramArrayOfByte, this.b, this.jdField_a_of_type_Int - 1, this.jdField_a_of_type_Avtl);
        return;
      }
    }
    catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException)
    {
      ...
      if ((((CommProtocolProto.commResponse)localObject).code.get() != 0) && (this.jdField_a_of_type_Int > 0))
      {
        ...
        avti.b(this.jdField_a_of_type_Avti, this.c, paramArrayOfByte, this.b, this.jdField_a_of_type_Int - 1, this.jdField_a_of_type_Avtl);
        return;
      }
