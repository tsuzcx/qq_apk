...
public class asko
{
  ...
  public asko(String paramString, int paramInt)
  {
  ...
  public static Drawable a(Context paramContext, asku paramasku)
  {
    Object localObject = paramasku.a;
    ...
    for (paramContext = paramContext.getLoadingDrawable("fromAIO", true);; paramContext = null)
    {
      ...
      do
      {
        ...
        localURL = ahcj.a((MessageForPic)localObject);
  ...
  private static URLDrawable.URLDrawableOptions a(Context paramContext, int paramInt1, int paramInt2)
  {
    ...
    localURLDrawableOptions.mLoadingDrawable = new asbg(paramInt1, paramInt2);
    return localURLDrawableOptions;
  }
  
  public static EmoticonPackage a(String paramString)
  {
    return ((awyr)((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime()).getManager(QQManagerFactory.EMOTICON_MANAGER)).a(paramString);
  }
  
  public static PicEmoticonInfo a(MessageForMarketFace paramMessageForMarketFace)
  {
    return ((awyr)((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime()).getManager(QQManagerFactory.EMOTICON_MANAGER)).a(paramMessageForMarketFace.mMarkFaceMessage);
  }
  ...
  private List<MessageRecord> a(List<MessageRecord> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if ((localObject1 instanceof MessageForPic))
      {
        ...
        if ((!a((MessageForPic)localObject2)) && (ahcj.a((MessageForPic)localObject2))) {
        ...
        if (((MessageForMixedMsg)localObject1).msgElemList != null)
        {
          ...
          while (((Iterator)localObject1).hasNext())
          {
            ...
            if ((localObject2 instanceof MessageForPic))
            {
              ...
              ((MessageForPic)localObject2).parse();
              if (ahcj.a((MessageForPic)localObject2)) {
    ...
    for (;;)
    {
      try
      {
        ...
        if (!this.jdField_a_of_type_Boolean)
        {
          ...
          {
            localList1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().getAllMessages(paramString, paramInt, tmp181_175, 60);
        ...
        if (acnh.a(paramInt))
        {
          ...
          localList1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().getMessagesFromDB(paramString, paramInt, this.jdField_a_of_type_Long, this.jdField_b_of_type_Int, this.jdField_b_of_type_Long, tmp181_175, 60);
          this.jdField_c_of_type_Int = localList1.size();
          continue;
        }
        List localList1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().getMessagesFromDB(paramString, paramInt, this.jdField_a_of_type_Long, this.jdField_b_of_type_Int, this.jdField_c_of_type_Long, tmp181_175, 60);
      }
  ...
  {
    return aioi.a(paramMessageForPic);
  }
}
