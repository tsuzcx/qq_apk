...
public class awsr
{
  ...
  public awsr(int paramInt)
  {
    this.jdField_a_of_type_Int = paramInt;
  }
  
  public static awsr a(int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        awsr localawsr = new awsr(paramInt);
        localawsr.jdField_a_of_type_JavaLangString = paramString.optString("name");
        localawsr.jdField_b_of_type_JavaLangString = paramString.optString("text");
        ...
        try
        {
          localawsr.jdField_b_of_type_Int = Color.parseColor("#" + paramString);
          return localawsr;
        }
