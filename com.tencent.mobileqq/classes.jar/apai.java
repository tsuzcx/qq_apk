...
public class apai
{
  static apai jdField_a_of_type_Apai;
  private bego jdField_a_of_type_Bego = new apaj(this);
  ShareAppLogHelper jdField_a_of_type_ComTencentMobileqqTestassisterShareAppLogHelper;
  private WeakReference<QQAppInterface> jdField_a_of_type_JavaLangRefWeakReference;
  
  apai(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramQQAppInterface);
  }
  
  public static apai a(QQAppInterface paramQQAppInterface)
  {
    jdField_a_of_type_Apai = new apai(paramQQAppInterface);
    return jdField_a_of_type_Apai;
  }
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqTestassisterShareAppLogHelper.a(this.jdField_a_of_type_Bego);
