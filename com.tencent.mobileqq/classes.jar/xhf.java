...
public class xhf
{
  ...
  private static xhf jdField_a_of_type_Xhf;
  ...
  public static xhf a()
  {
    if (jdField_a_of_type_Xhf == null) {}
    try
    {
      if (jdField_a_of_type_Xhf == null) {
        jdField_a_of_type_Xhf = new xhf();
      }
      return jdField_a_of_type_Xhf;
    }
    finally {}
  }
  
  private void a(String paramString1, String paramString2, String paramString3, xhh paramxhh)
  {
    xhi localxhi = new xhi(0, "success");
    try
    {
      wan.b(this.jdField_a_of_type_AndroidContentContext, paramString1, paramString2, paramString3, new xhg(this, paramxhh, localxhi));
      return;
    }
    catch (FFmpegCommandAlreadyRunningException paramString1)
    {
      do
      {
        ...
        {
          localxhi.a(943004);
          localxhi.a(paramString1.getMessage());
          paramxhh.b(localxhi);
        }
  ...
  private void b(String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3, xhh paramxhh)
  {
    // Byte code:
    //   0: new 91	xhi
    //   3: dup
    //   4: iconst_0
    //   5: ldc 93
    //   7: invokespecial 96	xhi:<init>	(ILjava/lang/String;)V
    //   10: astore 19
    //   12: aconst_null
    //   13: astore 18
    ...
    //   41: iload 4
    //   43: iload 5
    //   45: invokestatic 152	bawu:a	(Ljava/io/InputStream;Landroid/graphics/Rect;II)Landroid/graphics/Bitmap;
    //   48: astore 18
    //   50: aload 16
    //   52: ifnull +16 -> 68
    //   55: iload 4
    ...
    //   120: iload 4
    //   122: iload 5
    //   124: invokestatic 159	bawu:a	(Ljava/lang/String;II)Landroid/graphics/Bitmap;
    //   127: astore 17
    //   129: aload 17
    ...
    //   155: aload 19
    //   157: ldc 160
    //   159: invokevirtual 113	xhi:a	(I)V
    //   162: iload 4
    //   164: istore 11
    //   166: iload 5
    //   168: istore 13
    ...
    //   178: aload 19
    //   180: ldc 162
    //   182: invokevirtual 118	xhi:a	(Ljava/lang/String;)V
    //   185: iload 4
    //   187: istore 11
    //   189: iload 5
    //   191: istore 13
    ...
    //   356: aload 19
    //   358: ldc 160
    //   360: invokevirtual 113	xhi:a	(I)V
    //   363: aload 19
    //   365: ldc 162
    //   367: invokevirtual 118	xhi:a	(Ljava/lang/String;)V
    //   370: aload 8
    //   372: aload 19
    ...
    //   394: istore 14
    //   396: aload_1
    //   397: invokestatic 168	bbdr:b	(Ljava/lang/String;)I
    //   400: istore 15
    //   402: aload 17
    //   404: astore_1
    //   405: iload 4
    ...
    //   615: iload 4
    //   617: iload 5
    //   619: invokestatic 198	avto:a	()Lavto;
    //   622: iconst_1
    //   623: invokevirtual 201	avto:a	(I)I
    //   626: iconst_4
    //   627: imul
    //   628: sipush 1000
    //   631: imul
    ...
    //   644: iload 6
    //   646: iload 7
    //   648: invokespecial 213	xhn:<init>	(Ljava/lang/String;IIIJZI)V
    //   651: putfield 215	xhf:jdField_a_of_type_Xhn	Lxhn;
    //   654: aload_0
    //   655: getfield 215	xhf:jdField_a_of_type_Xhn	Lxhn;
    //   658: bipush 16
    //   660: invokevirtual 216	xhn:a	(I)V
    ...
    //   676: pop
    //   677: aload_0
    //   678: getfield 215	xhf:jdField_a_of_type_Xhn	Lxhn;
    //   681: aload_2
    //   682: aload 8
    //   684: invokevirtual 226	xhn:a	(Ljava/util/List;Lxhh;)V
    //   687: return
    //   688: astore 16
    //   690: goto -622 -> 68
    //   693: astore 16
  ...
  public void a(String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3, xhh paramxhh)
  {
    xhi localxhi = new xhi(0, "success");
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)) || (TextUtils.isEmpty(paramString3)))
    {
      localxhi.a(940007);
      localxhi.a("Invalid argument");
      paramxhh.b(localxhi);
    }
    do
    {
      ...
      {
        localxhi.a(941003);
        localxhi.a("duration is 0");
        paramxhh.b(localxhi);
        return;
      }
      if (!apvb.b(paramString2)) {
        break;
      }
    } while (paramxhh == null);
    localxhi.a(0);
    ...
    {
      ThreadManager.newFreeThread(new VideoStoryPicToVideo.1(this, paramString1, paramString2, paramString3, paramInt1, paramInt2, paramBoolean, paramInt3, paramxhh), "videoStoryPicToVideo", 5).start();
      return;
    }
    a(paramString1, paramString2, paramString3, paramxhh);
  }
}
