...
public class bmwe
  extends PopupWindow
{
  private static final Drawable jdField_a_of_type_AndroidGraphicsDrawableDrawable = a(2130850789);
  ...
  private static final Drawable jdField_b_of_type_AndroidGraphicsDrawableDrawable = a(2130850790);
  ...
  private View.OnKeyListener jdField_a_of_type_AndroidViewView$OnKeyListener = new bmwh(this);
  private View.OnTouchListener jdField_a_of_type_AndroidViewView$OnTouchListener = new bmwi(this);
  ...
  public bmwe(Activity paramActivity)
  {
    super(paramActivity);
  ...
  private void a(int paramInt)
  {
    ...
    bgtn.a(this.jdField_a_of_type_AndroidWidgetRelativeLayout, jdField_c_of_type_AndroidGraphicsDrawableDrawable);
  ...
  private int c()
  {
    ...
    return bgtn.b() - localRect.height();
  }
  ...
  private void f()
  {
    ...
    setWidth(-1);
    setHeight(-1);
    this.jdField_a_of_type_ComTencentComponentAnimationReboundSpring = SpringSystem.create().createSpring().setSpringConfig(jdField_a_of_type_ComTencentComponentAnimationReboundSpringConfig).addListener(new bmwf(this));
    this.jdField_a_of_type_Bmwj = new bmwj(this, this.jdField_a_of_type_AndroidAppActivity);
    this.jdField_a_of_type_AndroidWidgetListView = ((ListView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131365734));
    ...
    this.jdField_a_of_type_AndroidWidgetListView.setOnTouchListener(new bmwg(this));
  }
  ...
  private void h()
  {
    ...
    for (;;)
    {
      ...
      bgtn.b(this.jdField_a_of_type_AndroidWidgetListView, f3);
      bgtn.c(this.jdField_a_of_type_AndroidWidgetListView, f3);
      if (this.jdField_c_of_type_Boolean)
      {
        bgtn.e(this.jdField_a_of_type_AndroidWidgetListView, 0.0F);
        bgtn.d(this.jdField_a_of_type_AndroidWidgetListView, this.jdField_c_of_type_Int);
      }
      for (;;)
      {
        ...
        f3 = f2;
        break;
        bgtn.e(this.jdField_a_of_type_AndroidWidgetListView, this.d);
        bgtn.d(this.jdField_a_of_type_AndroidWidgetListView, this.jdField_c_of_type_Int);
      }
      label221:
      break;
  ...
  public void a()
  {
    ...
    a(this.jdField_a_of_type_AndroidWidgetRelativeLayout, 0.0F);
    bgtn.a(this.jdField_a_of_type_AndroidWidgetListView, jdField_a_of_type_AndroidGraphicsDrawableDrawable);
  ...
  public void a(bmwk parambmwk)
  {
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (parambmwk != null)) {
      this.jdField_a_of_type_JavaUtilArrayList.add(parambmwk);
    }
  }
  ...
  public boolean a(int paramInt1, int paramInt2)
  {
    ...
    paramInt1 = bgtn.a() - this.jdField_a_of_type_AndroidWidgetRelativeLayout.getPaddingRight() * 2;
    ...
    localLayoutParams1.topMargin = (paramInt2 - i - bgtn.b(5.0F));
  ...
  public int b()
  {
    ...
    {
      i = bgtn.b() - this.jdField_a_of_type_AndroidWidgetRelativeLayout.getHeight();
      if (i > bgtn.b(25.0F)) {}
    }
    int j;
    do
  ...
  public void b()
  {
    ...
    a(this.jdField_a_of_type_AndroidWidgetRelativeLayout, 0.0F);
    bgtn.a(this.jdField_a_of_type_AndroidWidgetListView, jdField_b_of_type_AndroidGraphicsDrawableDrawable);
    if (this.jdField_a_of_type_AndroidWidgetListView != null) {
      this.jdField_a_of_type_AndroidWidgetListView.setPadding(this.jdField_a_of_type_AndroidWidgetListView.getPaddingLeft(), this.jdField_a_of_type_AndroidWidgetListView.getPaddingTop() + bgtn.b(9.0F), this.jdField_a_of_type_AndroidWidgetListView.getPaddingRight(), this.jdField_a_of_type_AndroidWidgetListView.getPaddingBottom());
    }
    super.showAtLocation(a(), 17, 0, 0);
    c();
  }
  ...
  public void e()
  {
    int i = 0;
    int j = 0;
    while (i < this.jdField_a_of_type_Bmwj.getCount())
    {
      View localView = this.jdField_a_of_type_Bmwj.getView(i, null, this.jdField_a_of_type_AndroidWidgetListView);
      localView.measure(View.MeasureSpec.makeMeasureSpec(0, 0), View.MeasureSpec.makeMeasureSpec(0, 0));
      j += localView.getMeasuredHeight();
      i += 1;
    }
    this.jdField_b_of_type_Int = (bgtn.b(9.0F) + j);
  }
}
