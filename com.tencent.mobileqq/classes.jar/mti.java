...
public class mti
{
  private static BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new mtj();
  static String jdField_a_of_type_JavaLangString = "actAVGSensorCaseReport";
  int jdField_a_of_type_Int = 0;
  private long jdField_a_of_type_Long;
  ArrayList<mtk> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  private void a(int paramInt, ArrayList<mtk> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          mtk localmtk = (mtk)paramArrayList.next();
          JSONObject localJSONObject = new JSONObject();
          localJSONObject.put("i", localmtk.jdField_a_of_type_Int);
          localJSONObject.put("off", localmtk.jdField_a_of_type_Long);
          localJSONObject.put("on", localmtk.jdField_b_of_type_Long);
          localJSONObject.put("why", localmtk.jdField_c_of_type_Long);
  ...
  void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, int paramInt, boolean paramBoolean4, VideoController paramVideoController)
  {
    ...
    long l = System.currentTimeMillis();
    paramVideoController = this.jdField_a_of_type_Mtk;
    this.jdField_a_of_type_Mtk = null;
    if (paramVideoController != null)
    {
  ...
  void c()
  {
    this.jdField_a_of_type_Mtk = new mtk(this);
    this.jdField_a_of_type_Mtk.jdField_a_of_type_Int = this.h;
    this.h += 1;
    this.jdField_a_of_type_Mtk.jdField_a_of_type_Long = System.currentTimeMillis();
    this.jdField_a_of_type_JavaUtilArrayList.add(this.jdField_a_of_type_Mtk);
  }
