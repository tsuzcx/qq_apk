...
public class aywg
{
  ...
  {
    this.jdField_a_of_type_Float = paramaywg.jdField_a_of_type_Float;
    this.b = paramaywg.b;
    this.c = paramaywg.c;
    this.d = paramaywg.d;
    this.jdField_a_of_type_AndroidGraphicsMatrix.set(paramaywg.jdField_a_of_type_AndroidGraphicsMatrix);
  }
