  ...
  implements Handler.Callback
{
  ...
  apcd(QQAppInterface paramQQAppInterface, Context paramContext, apcf paramapcf)
  {
    super(paramContext);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    if (paramMessage.what == f) {
      if (this.i == c)
      {
        ...
        j = Math.min(j, 99);
        paramMessage = String.format(alpo.a(2131703251), new Object[] { Integer.valueOf(j) });
        this.jdField_a_of_type_AndroidWidgetTextView.setText(paramMessage);
        this.jdField_a_of_type_Bhoe.sendEmptyMessageDelayed(f, 500L);
      }
    }
      ...
      do
      {
        ...
        if (this.i == d)
        {
          ...
          if (!this.jdField_b_of_type_JavaIoFile.renameTo(this.jdField_a_of_type_JavaIoFile))
          {
            ...
            boolean bool = bdcs.a(this.jdField_b_of_type_JavaIoFile, this.jdField_a_of_type_JavaIoFile);
            bdcs.d(this.jdField_b_of_type_JavaIoFile.getPath());
            if (!bool)
            {
              QLog.d(jdField_a_of_type_JavaLangString, 1, "db fix succ but copy fail final");
              paramMessage = new HashMap();
              azmz.a(BaseApplication.getContext()).a(null, DBFixManager.m, true, -1L, 0L, paramMessage, null, false);
            }
          }
          this.jdField_a_of_type_AndroidWidgetTextView.setText(alpo.a(2131703252));
          this.jdField_a_of_type_Bhoe.sendEmptyMessageDelayed(g, 100L);
          return false;
        }
      } while (this.i != e);
      dismiss();
      this.jdField_a_of_type_Apcf.a(this.i);
      return false;
    }
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131365021));
    ...
    for (int j = 1;; j = 2)
    {
      ...
      super.setOnKeyListener(new apce(this));
      return;
    }
  }
  ...
  {
    super.onStart();
    this.jdField_a_of_type_Bhoe.sendEmptyMessage(f);
  }
}
