...
public class nga
{
  ...
  public boolean a(Context paramContext, MessageRecord paramMessageRecord, TextView paramTextView, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        boolean bool = baip.a(paramString);
        if (bool) {
          return false;
        }
        try
        {
          ...
          {
            paramTextView.setBackgroundResource(2130846009);
            paramTextView.setVisibility(0);
            paramTextView.setText(ajjy.a(2131637826));
            localObject1 = paramContext.getResources().getDrawable(2130846012);
            ((Drawable)localObject1).setBounds(0, 0, 24, 16);
            paramTextView.setCompoundDrawables(null, null, (Drawable)localObject1, null);
            i = vms.a(paramContext, 6.0F);
            paramTextView.setPadding(i, 0, i, 0);
            paramTextView.setCompoundDrawablePadding(vms.a(paramContext, 2.0F));
            ...
            localObject1 = LayoutInflater.from(paramContext).inflate(2131493827, null);
            LinearLayout localLinearLayout = (LinearLayout)((View)localObject1).findViewById(2131303701);
            ...
            if (i < paramString.length())
            {
              ...
              ((LinearLayout)localObject3).setOnClickListener(new ngb(this, j, (JSONObject)localObject2, paramContext, paramMessageRecord));
              ...
              ((LinearLayout.LayoutParams)localObject4).height = vms.a(paramContext, 50.0F);
              ...
              ((LinearLayout.LayoutParams)localObject5).width = vms.a(paramContext, 20.0F);
              ((LinearLayout.LayoutParams)localObject5).height = vms.a(paramContext, 18.0F);
              ((LinearLayout.LayoutParams)localObject5).leftMargin = vms.a(paramContext, 15.0F);
              localObject5 = ((JSONObject)localObject2).optString("icon_url", "");
              if (!baip.a((String)localObject5))
              {
                URLDrawable.URLDrawableOptions localURLDrawableOptions = URLDrawable.URLDrawableOptions.obtain();
                localURLDrawableOptions.mRequestHeight = vms.a(paramContext, 20.0F);
                localURLDrawableOptions.mRequestWidth = vms.a(paramContext, 18.0F);
              ...
              ((LinearLayout.LayoutParams)localObject3).leftMargin = vms.a(paramContext, 10.0F);
              ...
              ((LinearLayout.LayoutParams)localObject3).height = vms.a(paramContext, 1.0F);
        ...
        catch (JSONException paramString)
        {
          ...
          paramTextView.setOnClickListener(new ngc(this, paramContext, paramTextView, paramMessageRecord));
          return true;
        }
        return false;
      }
