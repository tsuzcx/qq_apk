...
public class bjbk
  extends QIPCModule
{
  private static bjbk jdField_a_of_type_Bjbk;
  private final AtomicReference<bjbr> jdField_a_of_type_JavaUtilConcurrentAtomicAtomicReference = new AtomicReference();
  
  public bjbk(String paramString)
  {
    super(paramString);
  }
  
  public static bjbk a()
  {
    if (jdField_a_of_type_Bjbk == null) {}
    try
    {
      if (jdField_a_of_type_Bjbk == null) {
        jdField_a_of_type_Bjbk = new bjbk("QzoneIPCModule");
      }
      return jdField_a_of_type_Bjbk;
    }
    finally {}
  }
  
  private static List<agua> a(String paramString1, String paramString2, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      localLinkedList.add(localagua);
      i += 1;
      paramString2 = paramString1;
    }
  }
  
  public static JSONObject a(List<agtk> paramList)
  {
    ...
    {
      Object localObject2 = (agtk)paramList.next();
      if ((localObject2 != null) && ((localObject2 instanceof agua)))
      {
        localObject2 = (agua)localObject2;
        try
        {
          JSONObject localJSONObject = new JSONObject();
          localJSONObject.put("url", ((agua)localObject2).a()).put("thumbUrl", ((agua)localObject2).e()).put("md5", ((agua)localObject2).b());
  ...
  private void a(Bundle paramBundle, QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      paramBundle = (akji)paramQQAppInterface.getManager(153);
  ...
  private void b(Bundle paramBundle, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        VSNetworkHelper.a().a(paramBundle, new bjbn(this, paramInt));
        return;
      }
  ...
  public void a()
  {
    QIPCServerHelper.getInstance().callClient("com.tencent.mobileqq:qzone", "QQCirCleClientIPCModule", "cooperation.qzone.ACTION_QCIRCLE_GET_TASK_LIST", null, new bjbp(this));
  }
  ...
  public void a(Bundle paramBundle, int paramInt)
  {
      ...
      if (localObject1 != null)
      {
        ...
        if (paramBundle != null)
        {
          ...
          while (paramBundle.hasNext()) {
            ((FeedCloudCommon.StCommonExt)localObject2).mapInfo.add(tym.a((Map.Entry)paramBundle.next()));
          }
        }
      }
      else
    ...
    VSNetworkHelper.a().a(paramBundle, new bjbo(this, str, paramInt));
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    do
    {
      ...
      localbjbr = (bjbr)this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicReference.get();
    } while ((localbjbr == null) || (!paramString1.equals(bjbr.b(localbjbr))) || (!this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicReference.compareAndSet(localbjbr, null)));
    bjbr.a(localbjbr, paramString2);
    bjbr.b(localbjbr, paramString3);
    bjbr.a(localbjbr).countDown();
  }
  
  public void b()
  {
    QIPCServerHelper.getInstance().callClient("com.tencent.mobileqq:qzone", "PubAccountIPCModule", "cooperation.qzone.ACTION_PUBLIC_ACCOUNT_GET_TASK_LIST", null, new bjbq(this));
  }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if ("getHostInfo".equals(paramString)) {
      try
      {
        paramString = ((aloz)localQQAppInterface.getManager(51)).c(localQQAppInterface.getCurrentAccountUin());
    ...
    for (;;)
    {
      ...
      if ("isFriend".equals(paramString))
      {
        ...
        try
        {
          ...
          bool1 = ((aloz)localQQAppInterface.getManager(51)).b(String.valueOf(l));
      ...
      else
      {
        if ("startDownloadVoicechangeSo".equals(paramString)) {
          for (;;)
          {
            ...
            try
            {
              paramString = ((apgj)localQQAppInterface.getManager(77)).a(aphj.e());
              if (paramString == null) {
                continue;
              }
              paramString.a(false);
        ...
        if ("action_qzone_pic_pre_send".equals(paramString))
        {
          try
          {
            aweo.a(localQQAppInterface, paramBundle);
            paramString = new Bundle();
        ...
        else
        {
          ...
          if ("action_qzone_get_sticker_rec_gif".equals(paramString))
          {
            ...
            localObject2 = agug.a(localQQAppInterface);
            ((agug)localObject2).a();
            if (!((agug)localObject2).b())
            {
              QLog.i("QzoneIPCModule", 1, "emo rec is not open");
              return null;
            }
            paramBundle = new bjbr((String)localObject1, null);
            this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicReference.set(paramBundle);
            if (!((agug)localObject2).a((String)localObject1, 0, paramString, true))
            {
            ...
            try
            {
              bjbr.a(paramBundle).await(2L, TimeUnit.SECONDS);
              if (TextUtils.isEmpty(bjbr.a(paramBundle)))
              {
            ...
            catch (InterruptedException paramString)
            {
              ...
              paramString = new Bundle();
              paramString.putString("analyze_text", bjbr.b(paramBundle));
              paramString.putString("resp_data", bjbr.a(paramBundle));
              paramString.putString("resp_pass", bjbr.c(paramBundle));
          ...
          if ("action_qzone_report_sticker_gif".equals(paramString))
          {
            ...
            localObject1 = agug.a(localQQAppInterface);
            ((agug)localObject1).a();
            ((agug)localObject1).a(Collections.singletonList(paramBundle), true, 11000, paramString);
          ...
          if ("action_save_customenotion".equals(paramString))
          {
            if (paramBundle != null)
            {
              ...
              {
                paramInt = agem.a(localQQAppInterface, paramString);
                paramString = new Bundle();
          ...
          else if ("action_pre_pull_mini_app".equals(paramString))
          {
            if (paramBundle != null)
            {
              ...
              MiniAppPrePullManager.getInstance().prePullAppinfoByLink(paramString, paramInt, bool1, new bjbl(this));
            }
          }
          else if ("cooperation.qzone.ACTION_PUBLIC_ACCOUNT_FAKE_FEED_CREATE".equalsIgnoreCase(paramString))
          {
            ...
            if ((paramString instanceof CertifiedFakeFeed))
            {
              ...
              yej.a().a(new SubscribeFeedsEvent(paramString, 1));
            }
          }
          else if ("cooperation.qzone.ACTION_PUBLIC_ACCOUNT_FAKE_FEED_UPDATE".equalsIgnoreCase(paramString))
          {
            ...
            {
              paramString = (CertifiedFakeFeed)paramString;
              yej.a().a(new SubscribeFeedsEvent(paramString, 2));
            }
          }
          else if ("cooperation.qzone.ACTION_PUBLIC_ACCOUNT_FAKE_FEED_DELETE".equalsIgnoreCase(paramString))
          {
            ...
            {
              paramString = (CertifiedFakeFeed)paramString;
              yej.a().a(new SubscribeFeedsEvent(paramString, 3));
            }
          }
          else if ("cooperation.qzone.ACTION_PUBLIC_ACCOUNT_QUEUE_CHANGED".equalsIgnoreCase(paramString))
          {
            ...
            yej.a().a(new PublishBoxStatusEvent(paramBundle));
            yej.a().a(new SubscribeFeedsEvent(4));
          }
          ...
          else if ("cooperation.qzone.ACTION_PUBLIC_ACCOUNT_UNFOLLOW".equalsIgnoreCase(paramString))
          {
            if (paramBundle != null)
            {
              ...
              if (paramString != null)
              {
                ...
                bjqz.a(localQQAppInterface.getApp().getApplicationContext(), paramString, 0);
              }
            }
          }
          ...
          else
          {
            ...
            if ("cooperation.qzone.ACTION_PUBLIC_ACCOUNT_FEED_PUBLISH".equalsIgnoreCase(paramString))
            {
              ...
              try
              {
                ...
                yej.a().a(new SubscribePublishFeedsEvent(paramString, 1));
              }
              catch (Exception paramString)
              {
            ...
            else
            {
              ...
              {
                paramString = new Bundle();
                paramBundle = anxf.a(localQQAppInterface);
                if (paramBundle == null)
                {
                ...
                if (bool1)
                {
                  ...
                  paramBundle = ((aokl)localObject1).a();
                  localObject1 = ((aokl)localObject1).b();
              ...
              {
                paramString = anxf.a(localQQAppInterface);
                if (paramString == null)
                {
              ...
              else
              {
                ...
                if ("cooperation.qzone.ACTION_QQCIRCLE_FAKE_FEED_CREATE".equalsIgnoreCase(paramString))
                {
                  ...
                  if ((paramString instanceof QCircleFakeFeed))
                  {
                    ...
                    yej.a().a(new QCircleFeedEvent(paramString, 1));
                    yej.a().a(new QCircleSelectTabEvent(1).needScrollTop());
                  }
                  else
                  {
                ...
                else if ("cooperation.qzone.ACTION_QCIRCLE_FAKE_FEED_DELETE".equalsIgnoreCase(paramString))
                {
                  ...
                  {
                    paramString = (QCircleFakeFeed)paramString;
                    yej.a().a(new QCircleFeedEvent(paramString, 3));
                  }
                }
                else
                {
                  if ("action_qzone_follow_qq_circle".equalsIgnoreCase(paramString))
                  {
                    ...
                    {
                      ((VSNetworkHelper)localObject3).a(new QCircleDoFollowRequest(paramBundle, paramInt, null), new bjbm(this, (boolean[])localObject1, (CountDownLatch)localObject2));
                      bool1 = false;
                      try
                      {
                  ...
                  else if (("cooperation.qzone.ACTION_QCIRCLE_PUBLISH_REPORT".equalsIgnoreCase(paramString)) && (paramBundle != null))
                  {
                    ...
                    tyj.a(BaseApplicationImpl.getApplication().getRuntime().getAccount(), paramInt, i, j, paramString, "", paramBundle, "", "");
                  }
                }
              }
            }
