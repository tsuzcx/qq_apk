...
public class qiz
{
  ...
  private static qiz jdField_a_of_type_Qiz;
  ...
  private WeakReference<qjc> jdField_a_of_type_JavaLangRefWeakReference;
  private boolean jdField_a_of_type_Boolean;
  
  static
  {
    jdField_a_of_type_JavaLangString = qiz.class.getSimpleName();
  }
  
  public static qiz a()
  {
    if (jdField_a_of_type_Qiz == null) {}
    try
    {
      if (jdField_a_of_type_Qiz == null) {
        jdField_a_of_type_Qiz = new qiz();
      }
      return jdField_a_of_type_Qiz;
    }
    finally {}
  }
  ...
  public void a()
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$UGCVoiceInfo != null)
      {
        ...
        {
          qjc localqjc = (qjc)this.jdField_a_of_type_JavaLangRefWeakReference.get();
          if (localqjc != null)
          {
            localqjc.b(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$UGCVoiceInfo);
  ...
  public void a(qjc paramqjc, SocializeFeedsInfo.UGCVoiceInfo paramUGCVoiceInfo)
  {
    if (this.jdField_a_of_type_AndroidMediaMediaPlayer == null) {
    ...
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramqjc);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructSocializeFeedsInfo$UGCVoiceInfo = paramUGCVoiceInfo;
    this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnPreparedListener(new qja(this));
    this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnCompletionListener(new qjb(this));
    try
    {
  ...
  public void a(boolean paramBoolean, String paramString)
  {
    ...
    //   2: aload_0
    //   3: iload_1
    //   4: putfield 85	qiz:jdField_a_of_type_Boolean	Z
    //   7: aload_0
    //   8: getfield 42	qiz:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   11: ifnull +81 -> 92
    //   14: aload_0
    //   15: getfield 49	qiz:jdField_a_of_type_JavaLangRunnable	Ljava/lang/Runnable;
    //   18: ifnull +74 -> 92
    //   21: invokestatic 158	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   24: ifeq +38 -> 62
    //   27: getstatic 25	qiz:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   30: iconst_2
    ...
    //   62: aload_0
    //   63: getfield 42	qiz:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   66: aload_0
    //   67: getfield 49	qiz:jdField_a_of_type_JavaLangRunnable	Ljava/lang/Runnable;
    //   70: invokevirtual 183	android/os/Handler:removeCallbacks	(Ljava/lang/Runnable;)V
    //   73: aload_0
    //   74: getfield 85	qiz:jdField_a_of_type_Boolean	Z
    //   77: ifeq +18 -> 95
    //   80: aload_0
    //   81: getfield 42	qiz:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   84: aload_0
    //   85: getfield 49	qiz:jdField_a_of_type_JavaLangRunnable	Ljava/lang/Runnable;
    ...
    //   94: return
    //   95: aload_0
    //   96: getfield 42	qiz:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   99: aload_0
    //   100: getfield 49	qiz:jdField_a_of_type_JavaLangRunnable	Ljava/lang/Runnable;
    //   103: ldc2_w 188
