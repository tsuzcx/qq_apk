...
public class yqx
  extends bdzm
{
  public yqx(CommonPicUploadFragment paramCommonPicUploadFragment) {}
  
  public void handleMessage(Message paramMessage)
  {
    bduk localbduk = (bduk)paramMessage.obj;
    if ((localbduk == null) || (localbduk.b != 24) || (localbduk.c != CommonPicUploadFragment.a(this.a, CommonPicUploadFragment.a(this.a)))) {}
    do
    {
      do
      {
        return;
      } while (localbduk.f.equals(CommonPicUploadFragment.b(this.a)));
    ...
    try
    {
      ...
      CommonPicUploadFragment.b(this.a, localbduk.f);
    ...
    if (QLog.isColorLevel()) {
      QLog.d("CommonPicUploadFragment", 2, "mPicTransProcessorHandler send error:" + localbduk.g);
    }
