  ...
  extends ScanningData
{
  ...
  public alds(Context paramContext)
  {
    super(paramContext);
    l();
    a();
  ...
  private void l()
  {
    ...
    this.i = (bbll.a(1.5F) * this.jdField_c_of_type_Float);
  ...
  public void g()
  {
    ...
    {
      this.jdField_g_of_type_AndroidAnimationObjectAnimator = ObjectAnimator.ofFloat(this, "fCPositionY", new float[] { -bbll.a(25.0F), 0.0F });
