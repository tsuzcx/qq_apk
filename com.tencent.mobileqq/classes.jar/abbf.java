...
public class abbf
{
  ...
  public static abbf a()
  {
    if (jdField_a_of_type_Abbf == null) {}
    try
    {
      if (jdField_a_of_type_Abbf == null) {
        jdField_a_of_type_Abbf = new abbf();
      }
      return jdField_a_of_type_Abbf;
    }
    finally {}
  }
  
  private void a(String paramString1, String paramString2, String paramString3, abbh paramabbh)
  {
    abbi localabbi = new abbi(0, "success");
    try
    {
      zqr.b(this.jdField_a_of_type_AndroidContentContext, paramString1, paramString2, paramString3, new abbg(this, paramabbh, localabbi));
      return;
    }
    catch (FFmpegCommandAlreadyRunningException paramString1)
    {
      do
      {
        ...
        {
          localabbi.a(943004);
          localabbi.a(paramString1.getMessage());
          paramabbh.b(localabbi);
        }
  ...
  private void b(String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3, abbh paramabbh)
  {
    // Byte code:
    //   0: new 95	abbi
    //   3: dup
    //   4: iconst_0
    //   5: ldc 97
    //   7: invokespecial 100	abbi:<init>	(ILjava/lang/String;)V
    //   10: astore 19
    //   12: aconst_null
    //   13: astore 18
    ...
    //   41: iload 4
    //   43: iload 5
    //   45: invokestatic 152	bhgm:a	(Ljava/io/InputStream;Landroid/graphics/Rect;II)Landroid/graphics/Bitmap;
    //   48: astore 18
    //   50: aload 16
    //   52: ifnull +16 -> 68
    //   55: iload 4
    ...
    //   120: iload 4
    //   122: iload 5
    //   124: invokestatic 159	bhgm:a	(Ljava/lang/String;II)Landroid/graphics/Bitmap;
    //   127: astore 17
    //   129: aload 17
    ...
    //   155: aload 19
    //   157: ldc 160
    //   159: invokevirtual 117	abbi:a	(I)V
    //   162: iload 4
    //   164: istore 11
    //   166: iload 5
    //   168: istore 13
    ...
    //   178: aload 19
    //   180: ldc 162
    //   182: invokevirtual 122	abbi:a	(Ljava/lang/String;)V
    //   185: iload 4
    //   187: istore 11
    //   189: iload 5
    //   191: istore 13
    ...
    //   356: aload 19
    //   358: ldc 160
    //   360: invokevirtual 117	abbi:a	(I)V
    //   363: aload 19
    //   365: ldc 162
    //   367: invokevirtual 122	abbi:a	(Ljava/lang/String;)V
    //   370: aload 8
    //   372: aload 19
    //   374: invokeinterface 127 2 0
    //   379: return
    //   380: iload 4
    //   382: istore 11
    //   384: iload 5
    ...
    //   394: istore 14
    //   396: aload_1
    //   397: invokestatic 168	bhmq:b	(Ljava/lang/String;)I
    //   400: istore 15
    //   402: aload 17
    //   404: astore_1
    //   405: iload 4
    ...
    //   615: iload 4
    //   617: iload 5
    //   619: invokestatic 198	bbgs:a	()Lbbgs;
    //   622: iconst_1
    //   623: invokevirtual 201	bbgs:a	(I)I
    //   626: iconst_4
    //   627: imul
    //   628: sipush 1000
    //   631: imul
    ...
    //   644: iload 6
    //   646: iload 7
    //   648: invokespecial 213	abbn:<init>	(Ljava/lang/String;IIIJZI)V
    //   651: putfield 215	abbf:jdField_a_of_type_Abbn	Labbn;
    //   654: aload_0
    //   655: getfield 215	abbf:jdField_a_of_type_Abbn	Labbn;
    //   658: bipush 16
    //   660: invokevirtual 216	abbn:a	(I)V
    ...
    //   676: pop
    //   677: aload_0
    //   678: getfield 215	abbf:jdField_a_of_type_Abbn	Labbn;
    //   681: aload_2
    //   682: aload 8
    //   684: invokevirtual 226	abbn:a	(Ljava/util/List;Labbh;)V
    //   687: return
    //   688: astore 16
    //   690: goto -622 -> 68
    //   693: astore 16
  ...
  public void a(String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3, abbh paramabbh)
  {
    abbi localabbi = new abbi(0, "success");
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)) || (TextUtils.isEmpty(paramString3)))
    {
      localabbi.a(940007);
      localabbi.a("Invalid argument");
      paramabbh.b(localabbi);
    }
    do
    {
      ...
      {
        localabbi.a(941003);
        localabbi.a("duration is 0");
        paramabbh.b(localabbi);
        return;
      }
      if (!auog.b(paramString2)) {
        break;
      }
    } while (paramabbh == null);
    localabbi.a(0);
    localabbi.a("success");
    paramabbh.a(localabbi);
    return;
    if (Build.VERSION.SDK_INT >= 17)
    {
      ThreadManager.newFreeThread(new VideoStoryPicToVideo.1(this, paramString1, paramString2, paramString3, paramInt1, paramInt2, paramBoolean, paramInt3, paramabbh), "videoStoryPicToVideo", 5).start();
      return;
    }
    a(paramString1, paramString2, paramString3, paramabbh);
  }
}
