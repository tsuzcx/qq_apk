  ...
  extends amiz
{
  ...
  public abor(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager, aboq paramaboq)
  {
  ...
  private QQMessageFacade.Message a(String paramString, awbw paramawbw, int paramInt1, int paramInt2)
  {
    if (a(paramString, true)) {
      this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.a(paramawbw);
    }
    int i;
    String str;
    if ((paramString.startsWith("mr_discusssion")) || (paramString.startsWith("mr_troop")))
    {
      ...
      str = "select * from (select count() as unReadNum from %s mr where mr.isread=0),(select count() as hasReply from %s mr where mr.issend=0),%s m where m.isValid=1 and m.msgtype " + abot.a() + " and m.longMsgId='%d' and m.issend='%d' order by %s limit 1";
      if (!bool) {
        break label177;
      }
      if (i == 0) {
      ...
      paramawbw = "longMsgIndex asc , shmsgseq desc , _id desc";
    }
    for (;;)
    {
      paramString = String.format(str, new Object[] { paramString, paramString, paramString, Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), paramawbw });
      ...
      break;
      label171:
      paramawbw = "longMsgIndex asc , time desc , _id desc";
      continue;
      label177:
      paramawbw = "_id desc";
    }
    ...
    do
    {
      do
      {
        do
        {
          ...
          if (!abot.a(paramMessageRecord1, paramMessageRecord2)) {
            break;
          }
  ...
  private List<MessageRecord> a(String paramString1, int paramInt, String paramString2)
  {
    ...
    if (localList2 == null)
    {
      ...
      localList1 = b(paramString1, paramInt, new aznf());
  ...
  private List<MessageRecord> a(String paramString, int paramInt, List<MessageRecord> paramList1, List<MessageRecord> paramList2)
  {
    if (paramList1.size() > 15)
    {
      ...
      if ((!abot.a(paramString, paramInt, paramList2)) && (!abot.c(paramList2))) {
        break label207;
      }
      paramInt = 1;
      label60:
  ...
  private void a(aznf paramaznf)
  {
    if ((paramaznf.jdField_b_of_type_Int != 0) && (azmz.a()) && (azmz.a(1)))
    {
      HashMap localHashMap = new HashMap();
      localHashMap.put("param_IsMainThread", String.valueOf(paramaznf.jdField_a_of_type_Int));
      localHashMap.put("param_OptType", paramaznf.jdField_a_of_type_JavaLangString);
      localHashMap.put("param_OptTotalCost", String.valueOf(paramaznf.jdField_a_of_type_Long));
      localHashMap.put("param_OptCount", String.valueOf(paramaznf.jdField_b_of_type_Int));
      localHashMap.put("param_OptMsgCount", String.valueOf(paramaznf.c));
      localHashMap.put("param_OptOneCost", String.valueOf(paramaznf.jdField_b_of_type_Long));
      localHashMap.put("param_OptScene", paramaznf.jdField_b_of_type_JavaLangString);
      localHashMap.put("param_WalSwitch", String.valueOf(alxk.jdField_a_of_type_Boolean));
      azmz.a(BaseApplication.getContext()).a(null, "actSqliteOptCost", true, paramaznf.c, 0L, localHashMap, null, false);
    }
  }
  ...
  private void a(String paramString, int paramInt, aznf paramaznf, long paramLong)
  {
    if (TextUtils.equals(paramaznf.jdField_b_of_type_JavaLangString, "launch"))
    {
      paramLong = (System.nanoTime() - paramLong) / 1000L;
      paramaznf.jdField_a_of_type_Long += paramLong;
      paramaznf.jdField_b_of_type_Int += 1;
      paramaznf.c += 1;
      paramaznf.jdField_b_of_type_Long = (paramaznf.jdField_a_of_type_Long / paramaznf.jdField_b_of_type_Int);
      if ((azmz.c) && (QLog.isColorLevel()) && (abot.a(paramString, paramInt))) {
    ...
    {
      return;
      if (TextUtils.equals(paramaznf.jdField_b_of_type_JavaLangString, "AIO"))
      {
        paramLong = (System.nanoTime() - paramLong) / 1000L;
        paramaznf.jdField_a_of_type_Long = paramLong;
        paramaznf.jdField_b_of_type_Int = 1;
      ...
      else
      {
        ...
        for (paramInt = 1; (paramInt != 0) && (azmz.a()) && (azmz.a(2)); paramInt = 0)
        {
          paramaznf.jdField_a_of_type_Int = 1;
          paramaznf.jdField_a_of_type_JavaLangString = "select";
          paramaznf.jdField_b_of_type_JavaLangString = "mainThread";
          paramaznf.jdField_a_of_type_Long = paramLong;
          paramaznf.jdField_b_of_type_Int = 1;
          paramaznf.c = 1;
          paramaznf.jdField_b_of_type_Long = (paramaznf.jdField_a_of_type_Long / paramaznf.jdField_b_of_type_Int);
          paramString = new HashMap();
          paramString.put("param_IsMainThread", String.valueOf(paramaznf.jdField_a_of_type_Int));
          paramString.put("param_OptType", paramaznf.jdField_a_of_type_JavaLangString);
          paramString.put("param_OptTotalCost", String.valueOf(paramaznf.jdField_a_of_type_Long));
          paramString.put("param_OptCount", String.valueOf(paramaznf.jdField_b_of_type_Int));
          paramString.put("param_OptMsgCount", String.valueOf(paramaznf.c));
          paramString.put("param_OptOneCost", String.valueOf(paramaznf.jdField_b_of_type_Long));
          paramString.put("param_OptScene", paramaznf.jdField_b_of_type_JavaLangString);
          paramString.put("param_WalSwitch", String.valueOf(alxk.jdField_a_of_type_Boolean));
          azmz.a(BaseApplication.getContext()).a(null, "actSqliteOptCost", true, paramaznf.c, 0L, paramString, null, false);
          return;
        }
      }
    }
  ...
  private void a(List<MessageRecord> paramList)
  {
    ...
    if (i >= 0)
    {
      String str = abot.a((MessageRecord)paramList.get(i));
  ...
  {
    Object localObject = e(aljq.Y, 4001);
    int i;
    if (localObject != null)
    {
      ...
      a(String.valueOf(aljq.Y), 4001, c(String.valueOf(aljq.Y), 4001), "msgtype=?", new String[] { String.valueOf(paramInt) }, null);
    }
    for (;;)
    {
      if ((localObject != null) && (((List)localObject).size() == 0) && (baba.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) <= 0))
      {
        localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a();
        RecentUser localRecentUser = ((amjk)localObject).a(aljq.W, 9000);
  ...
  {
    Object localObject = new aznf();
    if (Looper.myLooper() == Looper.getMainLooper()) {}
    for (int i = 1;; i = 0)
    {
      ((aznf)localObject).jdField_a_of_type_Int = i;
      ((aznf)localObject).jdField_a_of_type_JavaLangString = "select";
      ((aznf)localObject).jdField_b_of_type_JavaLangString = "AIO";
      localList = a(paramString, paramInt, (aznf)localObject);
      a((aznf)localObject);
      if ((localList == null) || (localList.isEmpty())) {
        break label292;
      }
  ...
  private void b(List<MessageRecord> paramList, amji paramamji)
  {
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      ...
      if (localMessageRecord.versionCode > 0)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.c(localMessageRecord.frienduin, localMessageRecord.istroop, c(localMessageRecord.frienduin, localMessageRecord.istroop), localMessageRecord, 0, paramamji);
      }
    }
  ...
  private MessageRecord c(String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (Object localObject2 = localObject1;; localObject2 = null)
    {
      ...
      if (localObject2 == null)
      {
        ...
        amgj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, paramInt1);
  ...
  private List<MessageRecord> c(String paramString, int paramInt, aznf paramaznf)
  {
    ...
    {
      long l = System.nanoTime();
      localList1 = b(paramString, paramInt, paramaznf);
      a(paramString, paramInt, localList1);
      a(paramString, str, localList1, l);
    }
    if (QLog.isColorLevel())
    {
      paramaznf = new StringBuilder();
      paramaznf.append("getMsgList2 uin ").append(paramString).append(" , type = ").append(paramInt).append(" itemList size=").append(localList1.size());
      if ((jdField_b_of_type_Int % 20 == 0) && (jdField_b_of_type_Int > 100)) {
        paramaznf.append("\n").append(QLog.getStackTraceString(new Throwable("MsgProxy_getMsgList1")));
      }
      QLog.d("Q.msg.MsgProxy", 2, paramaznf.toString());
      jdField_b_of_type_Int += 1;
    }
    return localList1;
  }
  ...
  private void c(String paramString, int paramInt, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if ((!localMessageRecord.isread) && (a(paramInt, paramLong, localMessageRecord)) && ((!abot.b(paramInt)) || (!abot.n(localMessageRecord.msgtype)))) {
          localMessageRecord.isread = true;
        }
      }
      ...
      if ((paramString != null) && (!paramString.isEmpty()))
      {
        ...
        {
          localObject = (MessageRecord)paramString.next();
          if ((!((MessageRecord)localObject).isread) && (a(paramInt, paramLong, (MessageRecord)localObject)) && ((!abot.b(paramInt)) || (!abot.n(((MessageRecord)localObject).msgtype)))) {
            ((MessageRecord)localObject).isread = true;
          }
        }
      }
  ...
  private void c(String paramString, int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    if (localList != null)
    {
      abot.a(localList, paramMessageRecord, true);
      if (localList.size() > 40)
      {
        localList.remove(0);
        paramMessageRecord = a(paramString, paramInt);
        MsgLruCache localMsgLruCache = a();
        if (localMsgLruCache.getCacheType(paramMessageRecord) == amid.d) {
          localMsgLruCache.changeCacheType(paramMessageRecord, amid.c);
        }
      }
  ...
  private List<MessageRecord> d(String paramString, int paramInt, aznf paramaznf)
  {
    ...
    do
    {
      ...
      a(paramString, paramInt, paramaznf, l2);
      if (localObject1 != null)
      {
        ...
        while (i < j)
        {
          paramaznf = (MessageRecord)((List)localObject1).get(i);
          ((List)localObject1).set(i, ((List)localObject1).get(paramInt));
          ((List)localObject1).set(paramInt, paramaznf);
          i += 1;
          paramInt -= 1;
        }
      }
      for (paramaznf = (aznf)localObject1;; paramaznf = new ArrayList())
      {
        localObject1 = abot.a(paramaznf, localList).iterator();
        while (((Iterator)localObject1).hasNext()) {
          abot.a(paramaznf, (MessageRecord)((Iterator)localObject1).next(), true);
        }
      }
      localObject1 = paramaznf;
    } while (!QLog.isColorLevel());
    QLog.d("Q.msg.MsgProxy", 2, new Object[] { "init from db, uin=", paramString, ", isSaveToDatabase=", Boolean.valueOf(bool), ", cost=", Long.valueOf(System.currentTimeMillis() - l1), " sqlStr = ", localObject2, " size =", Integer.valueOf(paramaznf.size()) });
    return paramaznf;
  }
  ...
  private List<MessageRecord> g(String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      localObject1 = abot.a(paramString, (List)localObject1).iterator();
      while (((Iterator)localObject1).hasNext()) {
        abot.a(paramString, (MessageRecord)((Iterator)localObject1).next(), true);
      }
      label348:
  ...
  private void g()
  {
    aipw localaipw = (aipw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(125);
    localaipw.e = null;
    localaipw.f = null;
  }
  ...
  {
    Lock localLock = a(aljq.Y, paramInt);
    localLock.lock();
    try
    {
      paramInt = b(paramInt);
  ...
  public int a(String paramString, int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    if (abot.d(paramInt))
    {
      paramString = "( msgtype " + abot.b() + " and isValid=1 ) and ( time < ? or (time = ? and longMsgIndex <= ? and _id <= ?))";
  ...
  protected int a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      localawdi = (awdi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(201);
      Looper localLooper = Looper.getMainLooper();
      if (Thread.currentThread() != localLooper.getThread()) {
        break label95;
      }
      ThreadManager.post(new MsgProxy.1(this, localawdi, paramString, paramInt), 10, null, false);
    }
    label95:
    while (localawdi == null) {
      return i;
    }
    localawdi.a(c(paramString, paramInt), null, null);
    return i;
  }
  ...
  public aboq a()
  {
    return this.jdField_a_of_type_Aboq;
  }
  ...
  public Cursor a(String paramString, int paramInt)
  {
    ...
    if (paramString.equals(String.valueOf(aljq.G)))
    {
      ArrayList localArrayList = new ArrayList();
      int i = 0;
      ...
      return new abop(this, localArrayList);
    }
    return new abop(this, (List)((ArrayList)localList).clone());
  }
  ...
  public QQMessageFacade.Message a(String paramString, awbw paramawbw)
  {
    return a(paramString, paramawbw, 0);
  }
  
  protected QQMessageFacade.Message a(String paramString, awbw paramawbw, int paramInt)
  {
    Object localObject2 = null;
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().jdField_a_of_type_JavaLangObject)
      {
        ...
        ((StringBuilder)localObject1).append(abot.a());
            ...
            if (localObject2 != null)
            {
              ...
              if (((QQMessageFacade.Message)localObject2).isLongMsg())
              {
                ...
                if (((QQMessageFacade.Message)localObject2).longMsgIndex > 0) {
                  localObject1 = a(paramString, paramawbw, ((QQMessageFacade.Message)localObject2).longMsgId, ((QQMessageFacade.Message)localObject2).issend);
                }
              }
            }
          }
        ...
        if (localObject1 == null)
        {
          ...
          if (paramString.hasNext())
          {
            ...
            i = 0;
            paramawbw = a(paramawbw, (MessageRecord)localObject2, bool1);
            paramInt = i + paramInt;
            continue;
          }
        }
        ...
        if (localObject1 == null)
        {
          ...
          MessageRecord.copyMessageRecordBaseField(paramString, paramawbw);
  ...
  public FullMessageSearchResult.SearchResultItem a(String paramString1, int paramInt1, String paramString2, int paramInt2, amel paramamel)
  {
    ...
    for (;;)
    {
      ...
      long l2 = ameq.jdField_a_of_type_Long;
      ...
      try
      {
        paramString2 = a(paramString1, paramInt1, paramString2, paramamel, (Cursor)localObject);
  ...
  protected FullMessageSearchResult.SearchResultItem a(String paramString1, int paramInt, String paramString2, amel paramamel, Cursor paramCursor)
  {
    return amen.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Awce, paramCursor, paramString1, paramInt, paramString2, paramamel);
  }
  
  protected MsgLruCache a()
  {
    return this.jdField_a_of_type_Aboq.a();
  }
  ...
  protected ChatHistorySearchData a(Cursor paramCursor, SessionInfo paramSessionInfo, String paramString)
  {
    ...
    while (paramString.hasNext())
    {
      ...
      if (str1 != null)
      {
        localObject = bdbt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramSessionInfo, str1.equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()), str1);
  ...
  public ChatHistorySearchData a(SessionInfo paramSessionInfo, String paramString)
  {
    ...
    //   44: invokevirtual 494	abor:c	(Ljava/lang/String;I)Ljava/lang/String;
    //   47: astore_3
    //   48: aload_0
    //   49: invokevirtual 181	abor:a	()Lawce;
    //   52: iconst_0
    //   53: aload_3
    //   54: aconst_null
    //   55: ldc_w 1117
    ...
    //   73: ldc_w 1006
    //   76: aconst_null
    //   77: invokevirtual 863	awce:a	(ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   80: astore 5
    //   82: aload_0
    //   83: aload 5
    //   85: aload_1
    //   86: aload_2
    //   87: invokevirtual 1119	abor:a	(Landroid/database/Cursor;Lcom/tencent/mobileqq/activity/aio/SessionInfo;Ljava/lang/String;)Lcom/tencent/mobileqq/data/ChatHistorySearchData;
    //   90: astore_1
    //   91: aload_1
    //   92: astore_3
    //   93: aload 5
  ...
  public MessageRecord a(String paramString1, int paramInt, long paramLong, String paramString2, Object paramObject)
  {
    ...
    try
    {
      ...
      if (((Field)localObject).isAnnotationPresent(awdg.class)) {
        return localMessageRecord;
      }
      localObject = new ContentValues();
  ...
  protected String a(Cursor paramCursor, SessionInfo paramSessionInfo, int paramInt)
  {
    ...
    if (bdec.a(paramCursor.getInt(paramCursor.getColumnIndex("issend")))) {
  ...
  {
    return bauj.b(paramString1, paramString2, paramString3, paramLong, paramInt);
  }
  ...
  protected List<MessageRecord> a(String paramString)
  {
    ...
    synchronized (this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.a())
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        amjh localamjh = (amjh)((Iterator)localObject2).next();
        if ((localamjh.jdField_a_of_type_Awbv instanceof MessageRecord))
        {
          MessageRecord localMessageRecord = (MessageRecord)localamjh.jdField_a_of_type_Awbv;
          if ((TextUtils.equals(paramString, localamjh.jdField_b_of_type_JavaLangString)) && (localamjh.jdField_b_of_type_Int == 0)) {
            localArrayList.add(localMessageRecord);
          }
        }
      }
    ...
    for (;;)
    {
      ...
      if ((localObject1 != null) && (!((List)localObject1).isEmpty()))
      {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          if ((!abot.a(paramInt1)) || (((MessageRecord)localObject2).versionCode != 3) || (((MessageRecord)localObject2).shmsgseq != l3) || (l3 == 0L)) {
            for (;;)
            {
              int j;
              long l5;
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MsgProxy", 2, "queryMessagesByMsgUniseqFromDB, peerUin[" + arni.e(paramString) + "] type[" + paramInt + "] uniseq[" + paramLong + "]");
    }
    if (paramLong == 0L)
    {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      localObject = ((awce)localObject).a(paramString, new String[] { String.valueOf(paramLong) }, localQQAppInterface);
  ...
  protected List<MessageRecord> a(String paramString1, int paramInt1, long paramLong1, int paramInt2, long paramLong2, int paramInt3, String paramString2)
  {
    ...
    paramString2 = bddy.a(d(paramString1, paramInt1), c(paramString1, paramInt1), paramLong1, paramInt2, paramLong2, paramInt3, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.b(), paramString2);
    if (paramString2 != null)
    {
      if (a(paramString1, paramInt1, true)) {
        this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.a(a());
  ...
  public List<MessageRecord> a(String paramString, int paramInt1, long paramLong1, long paramLong2, int paramInt2)
  {
    ...
    for (int i = aoep.a(paramInt1, paramInt2) << 3;; i = 0)
    {
      ...
      if (i == 0)
      {
        ...
        localObject1 = ((awce)localObject2).a((String)localObject1, new String[] { String.valueOf(paramLong1), String.valueOf(paramLong2) }, (QQAppInterface)localObject3);
        if (QLog.isColorLevel())
        {
      ...
      for (paramInt1 = 0;; paramInt1 = ((List)localObject1).size())
      {
        ...
        localObject1 = ((StringBuilder)localObject1).toString();
        localObject3 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
        localObject1 = ((awce)localObject2).a((String)localObject1, new String[] { String.valueOf(paramLong1), String.valueOf(paramLong2), String.valueOf(i) }, (QQAppInterface)localObject3);
        break;
      }
    }
  }
  ...
  protected List<MessageRecord> a(String paramString, int paramInt, aznf paramaznf)
  {
    ...
    try
    {
      paramString = c(paramString, paramInt, paramaznf);
      return paramString;
    }
    finally
    {
  ...
  public List<MessageRecord> a(String paramString, int paramInt, int[] paramArrayOfInt)
  {
    ...
    for (;;)
    {
      ...
      while (paramArrayOfInt.hasNext())
      {
        ...
        if (((!abot.a(paramInt)) || (((MessageRecord)localObject).versionCode != 3) || (((MessageRecord)localObject).shmsgseq != l) || (l == 0L)) && ((paramString.contains(Integer.valueOf(((MessageRecord)localObject).msgtype))) || (paramString.isEmpty()))) {
  ...
  {
    return this.jdField_a_of_type_Aboq.a(paramString, paramInt);
  }
  ...
  protected void a(String paramString, int paramInt)
  {
    ...
    if ((localList != null) && (localList.size() == 0))
    {
      ...
      a().remove(a(paramString, paramInt));
      a(paramString, paramInt, b(paramString, paramInt, new aznf()));
    }
  }
  
  protected void a(String paramString1, int paramInt1, int paramInt2, ContentValues paramContentValues, String paramString2, String[] paramArrayOfString, amji paramamji)
  {
    if (paramInt2 > 0)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.a(paramString1, paramInt1, c(paramString1, paramInt1), paramContentValues, paramString2, paramArrayOfString, 1, paramamji);
      return;
    }
    this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.a(paramString1, paramInt1, d(paramString1, paramInt1), paramContentValues, paramString2, paramArrayOfString, 1, paramamji);
  }
  ...
  protected void a(String paramString, int paramInt, long paramLong)
  {
    ...
    for (String str1 = "shmsgseq";; str1 = "time")
    {
      ...
      a(paramString, paramInt, str3, localContentValues, String.format("isread=? and %s<=? and " + abot.d(), new Object[] { str1 }), new String[] { "0", str2 }, null);
      return;
    }
  ...
  protected void a(String paramString, int paramInt, awbv paramawbv, amji paramamji)
  {
    if (((paramawbv instanceof MessageRecord)) && (((MessageRecord)paramawbv).versionCode > 0)) {
      this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.a(paramString, paramInt, c(paramString, paramInt), paramawbv, 0, paramamji);
    }
  }
  ...
  protected void a(String paramString, int paramInt1, MessageRecord paramMessageRecord, int paramInt2)
  {
    ...
    if (((paramInt1 == 1001) || (paramInt1 == 10002)) && (paramMessageRecord.msgtype != -1003) && (paramMessageRecord.msgtype != -1031) && (paramMessageRecord.msgtype != -1032) && (paramMessageRecord.msgtype != 201)) {
      ...
      {
        str = c(String.valueOf(aljq.H), 1001);
    ...
    do
    {
      for (;;)
      {
        ...
        return;
        str = d(String.valueOf(aljq.H), 1001);
        break;
        if (paramInt1 == 1009)
        {
          a(paramString, paramInt1, c(aljq.w, 1009), localContentValues, "senderuin=? and isread=?", new String[] { paramString, "0" }, null);
        }
        else if (paramInt1 == 1010)
        {
          a(paramString, paramInt1, c(aljq.ab, 1010), localContentValues, "senderuin=? and isread=?", new String[] { paramString, "0" }, null);
        }
        else
        {
          if ((paramInt1 != 0) || (!TextUtils.equals(paramString, aljq.M))) {
            break label315;
          }
          a(paramString, paramInt1, c(aljq.M, 0), localContentValues, "senderuin=? and isread=?", new String[] { paramString, "0" }, null);
        }
      }
      if ((paramInt1 == 1032) && (TextUtils.equals(paramString, aljq.aN)))
      {
    ...
    paramInt2 = aoep.a(paramInt1, paramInt2) << 3;
    a(paramString, paramInt1, c(aljq.aN, 1032), localContentValues, "senderuin=? and isread=? and (extLong & 4194296)=? ", new String[] { paramString, "0", Integer.toString(paramInt2) }, null);
  ...
  protected void a(String paramString, int paramInt, MessageRecord paramMessageRecord, amji paramamji)
  {
    if (paramMessageRecord.versionCode > 0) {
      this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.c(paramString, paramInt, c(paramString, paramInt), paramMessageRecord, 0, paramamji);
    }
    this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.d();
  }
  
  protected void a(String paramString, int paramInt, MessageRecord paramMessageRecord, amji paramamji, boolean paramBoolean1, boolean paramBoolean2)
  {
    if ((abot.o(paramMessageRecord.msgtype)) && (!abot.b(paramMessageRecord.frienduin, paramMessageRecord.istroop))) {}
    while (!paramBoolean2) {
      return;
    }
    if (paramBoolean1)
    {
      a(paramString, paramInt, paramMessageRecord, paramamji);
      return;
    }
    a(paramString, paramInt, paramMessageRecord, paramamji);
  }
  ...
  protected void a(String paramString1, int paramInt, String paramString2, String paramString3, String[] paramArrayOfString, amji paramamji)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.a(paramString1, paramInt, paramString2, paramString3, paramArrayOfString, 2, paramamji);
  }
  ...
  protected void a(String paramString1, String paramString2, List<MessageRecord> paramList, long paramLong)
  {
    ...
    if (bdjd.a())
    {
      ayve localayve2 = (ayve)ayvc.b.get(paramString2);
      ayve localayve1 = localayve2;
      if (localayve2 == null) {
        localayve1 = new ayve();
      }
      localayve1.jdField_a_of_type_JavaLangString = paramString1;
      localayve1.jdField_a_of_type_Boolean = false;
      if (!paramList.isEmpty()) {
        bool = true;
      }
      localayve1.b = bool;
      localayve1.jdField_a_of_type_Long = ((System.nanoTime() - paramLong) / 1000000L);
      ayvc.b.put(paramString2, localayve1);
    }
  }
  
  public void a(List<MessageRecord> paramList, amji paramamji)
  {
    b(abot.a(paramList), paramamji);
  }
  ...
  {
    return bddy.a(c(paramString, paramInt), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.b());
  }
  ...
  protected boolean a(String paramString1, int paramInt, String paramString2, List<MessageRecord> paramList)
  {
    ...
    if ((!a().containsKey(paramString2)) && (localaxso.a(paramString1)))
    {
      if (QLog.isColorLevel()) {
  ...
  public boolean a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.a())
      {
        ...
        {
          amjh localamjh = (amjh)localVector.get(i);
          if ((abot.a(localamjh.jdField_a_of_type_JavaLangString, paramString, localamjh.jdField_a_of_type_Int, paramInt)) && ((localamjh.jdField_b_of_type_Int == 1) || (localamjh.jdField_b_of_type_Int == 2) || ((paramBoolean) && (localamjh.jdField_b_of_type_Int == 0))))
          {
            if (QLog.isColorLevel()) {
  ...
  protected boolean a(String paramString, boolean paramBoolean)
  {
    ...
    synchronized (this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.a())
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (TextUtils.isEmpty(localamjh.jdField_b_of_type_JavaLangString)) {
          return true;
        }
        if ((paramString.equals(localamjh.jdField_b_of_type_JavaLangString)) && ((localamjh.jdField_b_of_type_Int == 1) || (localamjh.jdField_b_of_type_Int == 2) || ((paramBoolean) && (localamjh.jdField_b_of_type_Int == 0))))
        {
          if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.a())
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          {
            MessageRecord localMessageRecord = (MessageRecord)localamjh.jdField_a_of_type_Awbv;
            if ((abot.a(localMessageRecord.frienduin, paramString, localMessageRecord.istroop, paramInt)) && (localamjh.jdField_b_of_type_Int == 0) && (localMessageRecord.time > paramLong) && (!localMessageRecord.isread) && (!localMessageRecord.isSend())) {
              i += 1;
            }
          }
        }
  ...
  public MessageRecord b(String paramString, int paramInt)
  {
    ...
    if (a(str1, false)) {
      this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.a(this.jdField_a_of_type_Awce);
    }
    String str2 = abot.b();
    if (abot.a(paramInt)) {}
  ...
  public MessageRecord b(String paramString1, int paramInt, String paramString2)
  {
    ...
    if (abot.a(paramInt))
    {
      localStringBuilder = new StringBuilder().append("select * from ").append(c(paramString1, paramInt)).append(" where isValid=1 and msgtype ").append(abot.a()).append(" ");
      if (paramString2 != null) {}
    ...
    StringBuilder localStringBuilder = new StringBuilder().append("select * from ").append(c(paramString1, paramInt)).append(" where isValid=1 and msgtype ").append(abot.a()).append(" ");
    if (paramString2 != null) {}
    for (paramString1 = "and " + paramString2;; paramString1 = "")
    {
  ...
  protected List<MessageRecord> b(String paramString, int paramInt, aznf paramaznf)
  {
    Lock localLock = a(paramString, paramInt);
    localLock.lock();
    try
    {
      paramString = d(paramString, paramInt, paramaznf);
      return paramString;
    }
    finally
    {
  ...
  protected List<MessageRecord> b(String paramString, int paramInt, List<Long> paramList)
  {
    ...
    if (QLog.isColorLevel())
    {
      localObject = new StringBuilder().append("queryMessagesByMsgUniseqFromDB, peerUin[").append(arni.e(paramString)).append("] type[").append(paramInt).append("] uniseqList[");
      if (paramList == null)
      {
        i = 0;
  ...
  protected List<MessageRecord> b(List<MessageRecord> paramList)
  {
    ...
    if (i >= 0)
    {
      if (localHashSet.contains(abot.a((MessageRecord)paramList.get(i)))) {
      ...
      for (;;)
      {
        i -= 1;
        break;
        localHashSet.add(abot.a((MessageRecord)paramList.get(i)));
      }
    }
  ...
  protected void b(String paramString, int paramInt, long paramLong, List<MessageRecord> paramList)
  {
    ...
    if (a().containsKey(str))
    {
      ...
      while (localList.size() > 40)
      {
        ...
        paramList = a();
        if (paramList.getCacheType(str) == amid.d) {
          paramList.changeCacheType(str, amid.c);
        }
      }
      a(paramString, paramInt, localList);
    }
  ...
  protected List<MessageRecord> c(String paramString, int paramInt1, int paramInt2)
  {
    ...
    synchronized (this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.a())
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        {
          MessageRecord localMessageRecord = (MessageRecord)localamjh.jdField_a_of_type_Awbv;
          if ((abot.a(localMessageRecord.frienduin, paramString, localMessageRecord.istroop, paramInt1)) && (localamjh.jdField_b_of_type_Int == 0) && ((paramInt2 <= 0) || (localMessageRecord.getConfessTopicId() == paramInt2))) {
            localArrayList.add(localMessageRecord);
          }
        }
      }
  ...
  protected List<MessageRecord> c(String paramString1, int paramInt1, long paramLong, int paramInt2, String paramString2)
  {
    ...
    for (;;)
    {
      localObject = a();
      QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
      paramString2 = ((awce)localObject).a(paramString2, new String[] { String.valueOf(paramLong), String.valueOf(l) }, localQQAppInterface);
      if (paramString2 == null) {
        break label299;
      }
      if (QLog.isColorLevel()) {
  ...
  public List<MessageRecord> c(String paramString, int paramInt, long paramLong1, long paramLong2)
  {
    ...
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    localObject = ((awce)localObject).a(paramString, new String[] { String.valueOf(paramLong1), String.valueOf(paramLong2) }, localQQAppInterface);
    paramString = (String)localObject;
    if (localObject == null) {
      paramString = new ArrayList();
    }
  ...
  protected void c(String paramString, int paramInt, List<MessageRecord> paramList)
  {
    ...
    for (;;)
    {
      List localList = abot.a((List)localObject1, paramList);
      Iterator localIterator = localList.iterator();
      while (localIterator.hasNext())
      {
      ...
      if (aipw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt, paramString)) {
      ...
      if ((paramInt == 0) && (((List)localObject1).size() > 0) && (aslq.a((MessageRecord)((List)localObject1).get(0)))) {
        paramInt = localList.size() - 1;
      }
      while (paramInt >= 0)
      {
        abot.a((List)localObject1, (MessageRecord)localList.get(paramInt), true);
        paramInt -= 1;
        continue;
  ...
  public MessageRecord d(String paramString, int paramInt, long paramLong)
  {
    ...
    if (localObject != null)
    {
      ...
      {
        MessageRecord localMessageRecord = (MessageRecord)((Iterator)localObject).next();
        if ((localMessageRecord.shmsgseq == paramLong) && (!abot.a(localMessageRecord))) {
          return localMessageRecord;
        }
      }
    }
  ...
  public List<MessageRecord> d(String paramString, int paramInt1, long paramLong, int paramInt2)
  {
    ...
    Object localObject1 = "select * from " + paramString + " where (shmsgseq < ? and msgtype " + abot.b() + " and isValid=1) order by shmsgseq desc limit ";
    ...
    for (;;)
    {
      ...
      if (paramString.size() < paramInt2)
      {
        ...
        if (localawdi != null)
        {
          localObject1 = localawdi.a().a((String)localObject1 + (paramInt2 - paramString.size()), (String[])localObject2, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          if (QLog.isColorLevel())
          {
  ...
  protected List<MessageRecord> e(String paramString, int paramInt1, int paramInt2)
  {
    ...
    awce localawce = a();
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    localObject = localawce.a((String)localObject, new String[] { String.valueOf(-2006), String.valueOf(paramInt2) }, localQQAppInterface);
    if (localObject != null)
    {
      if (QLog.isColorLevel()) {
  ...
  public List<MessageRecord> e(String paramString, int paramInt1, long paramLong, int paramInt2)
  {
    ...
    paramString = "select * from " + (String)localObject2 + " where (shmsgseq >= ? and msgtype " + abot.b() + " and isValid=1) order by shmsgseq asc limit " + (paramInt2 + 1);
    ...
    for (;;)
    {
      ...
      if (localawdi != null)
      {
        localObject2 = "select * from " + (String)localObject2 + " where (shmsgseq > ? and msgtype " + abot.b() + " and isValid=1) order by shmsgseq asc limit " + paramInt2;
        localObject1 = localawdi.a().a((String)localObject2, (String[])localObject1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        if (QLog.isColorLevel())
        {
  ...
  protected List<MessageRecord> e(String paramString, int paramInt, long paramLong1, long paramLong2)
  {
    int i = 0;
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MsgProxy", 2, "queryMessagesByTimeFromDB, peerUin[" + arni.e(paramString) + "] type[" + paramInt + "] time[" + paramLong1 + "] uid[" + paramLong2 + "]");
    }
    ...
    awce localawce = a();
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    localObject = localawce.a((String)localObject, new String[] { String.valueOf(paramLong1), String.valueOf(paramLong2) }, localQQAppInterface);
    if (QLog.isColorLevel())
    {
      paramString = new StringBuilder().append("queryMessagesByTimeFromDB, peerUin[").append(arni.e(paramString)).append("] type[").append(paramInt).append("] time[").append(paramLong1).append("] uid[").append(paramLong2).append("], list.size():");
      if (localObject != null) {
        break label287;
      }
    }
  ...
  public void e()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 141	abor:jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager	Lcom/tencent/mobileqq/app/proxy/ProxyManager;
    //   4: invokevirtual 644	com/tencent/mobileqq/app/proxy/ProxyManager:d	()V
    //   7: aload_0
    //   8: getfield 141	abor:jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager	Lcom/tencent/mobileqq/app/proxy/ProxyManager;
    //   11: invokevirtual 1974	com/tencent/mobileqq/app/proxy/ProxyManager:e	()V
    //   14: aload_0
    //   15: invokevirtual 181	abor:a	()Lawce;
    //   18: invokevirtual 1977	awce:a	()Lawby;
    //   21: astore 11
    //   23: aload_0
    //   24: getfield 277	abor:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   44: return
    //   45: aload_0
    //   46: getfield 277	abor:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   49: sipush 201
    //   52: invokevirtual 776	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   55: checkcast 878	awdi
    //   58: astore 14
    //   60: iconst_0
    //   61: istore_1
    //   62: iload_1
    ...
    //   302: astore 8
    //   304: iload_2
    //   305: invokestatic 835	abot:a	(I)Z
    //   308: ifne +20 -> 328
    //   311: lload 6
    //   313: lstore 4
    //   315: iload_3
    ...
    //   330: astore 8
    //   332: aload_0
    //   333: getfield 277	abor:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   336: invokevirtual 282	com/tencent/mobileqq/app/QQAppInterface:a	()Layvc;
    //   339: aload 10
    //   341: iload_2
    //   342: lload 4
    //   344: invokevirtual 2010	ayvc:a	(Ljava/lang/String;IJ)V
    //   347: aload 9
    //   349: ifnull +10 -> 359
    //   352: aload 9
    ...
    //   361: ifnull +8 -> 369
    //   364: aload 11
    //   366: invokevirtual 2013	awby:a	()V
    //   369: aload 12
    //   371: aload 15
    //   373: aconst_null
    //   374: aconst_null
    ...
    //   381: ifnull +8 -> 389
    //   384: aload 11
    //   386: invokevirtual 2016	awby:c	()V
    //   389: aload 11
    //   391: ifnull +8 -> 399
    //   394: aload 11
    //   396: invokevirtual 2018	awby:b	()V
    //   399: aload 14
    //   401: ifnull +13 -> 414
    //   404: aload 14
    //   406: aload 15
    //   408: aconst_null
    //   409: aconst_null
    //   410: invokevirtual 901	awdi:a	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    //   413: pop
    //   414: iload_1
    //   415: iconst_1
    //   416: iadd
    ...
    //   496: ifnull -97 -> 399
    //   499: aload 11
    //   501: invokevirtual 2018	awby:b	()V
    //   504: goto -105 -> 399
    //   507: astore 8
    //   509: aload 11
    //   511: ifnull +8 -> 519
    //   514: aload 11
    //   516: invokevirtual 2018	awby:b	()V
    //   519: aload 8
    //   521: athrow
    //   522: astore 9
    //   524: goto -69 -> 455
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MsgProxy", 2, "queryMessagesByShmsgseqFromDB, peerUin[" + arni.e(paramString) + "] type[" + paramInt + "] shmsgseq[" + paramLong1 + "] msgUid[" + paramLong2 + "]");
    }
    ...
    awce localawce = a();
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    paramString = localawce.a(paramString, new String[] { String.valueOf(paramLong1), String.valueOf(paramLong2) }, localQQAppInterface);
    if (paramString != null) {
      return paramString;
    }
    return new ArrayList();
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MsgProxy", 2, "queryMessagesByShmsgseqFromDB, peerUin[" + arni.e(paramString) + "] type[" + paramInt + "] shmsgseq[" + paramLong + "]");
    }
    ...
    awce localawce = a();
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    localObject = localawce.a((String)localObject, new String[] { String.valueOf(paramLong) }, localQQAppInterface);
    if (QLog.isColorLevel())
    {
      paramString = new StringBuilder().append("queryMessagesByShmsgseqFromDB, peerUin[").append(arni.e(paramString)).append("] type[").append(paramInt).append("] shmsgseq[").append(paramLong).append("], list.size():");
      if (localObject != null) {
        break label261;
      }
    }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MsgProxy", 2, "queryMessagesByShmsgseqFromDB4Troop, peerUin[" + arni.e(paramString) + "] type[" + paramInt + "] shmsgseq[" + paramLong + "]");
    }
    if ((paramLong == 0L) && (QLog.isColorLevel())) {
    ...
    paramString = "select * from " + c(paramString, paramInt) + " where shmsgseq=? and msgtype " + abot.c();
    awce localawce = a();
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    paramString = localawce.a(paramString, new String[] { String.valueOf(paramLong) }, localQQAppInterface);
    if ((paramString != null) && (paramString.size() > 0)) {
      return (MessageRecord)paramString.get(0);
    }
    return null;
  ...
  public MessageRecord j(String paramString, int paramInt, long paramLong)
  {
    ...
    Object localObject2 = (awdi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(201);
    if (localObject2 != null)
    {
      if (QLog.isColorLevel()) {
      ...
      localObject2 = ((awdi)localObject2).a();
      QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
      localObject1 = ((awce)localObject2).a((String)localObject1, new String[] { String.valueOf(paramLong) }, localQQAppInterface);
      if (QLog.isColorLevel())
      {
        paramString = new StringBuilder().append("queryMsgItemHistoryByShmsgseq, slow db return peerUin[").append(arni.e(paramString)).append("] type[").append(paramInt).append("] shmsgseq[").append(paramLong).append("], list.size():");
        if (localObject1 != null) {
          break label211;
        }
      }
