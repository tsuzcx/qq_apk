...
public class bgri
{
  ...
  static
  {
    ...
    for (;;)
    {
      ...
      {
        if (bgri.class.getName().equals(arrayOfStackTraceElement[i].getClassName())) {
  ...
  public bgri a(String paramString)
  {
    this.jdField_a_of_type_JavaLangString = paramString;
    return this;
  }
  
  public bgri a(String paramString1, int paramInt, String paramString2)
  {
  ...
  public bgri b(String paramString1, int paramInt, String paramString2)
  {
    a(paramString1, paramInt, 4, paramString2, this.b);
    return this;
  }
  
  public bgri c(String paramString1, int paramInt, String paramString2)
  {
