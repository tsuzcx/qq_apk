...
public class bgri
{
  ...
  public static Drawable a(int paramInt1, int paramInt2, bgrm parambgrm)
  {
    if (a.containsKey(Integer.valueOf(paramInt1))) {
      return bgrj.a().a("http://qzonestyle.gtimg.cn/qzone/phone/n/QQ-Qzone-Android/qzone_yellow_icon_v6.zip", paramInt2, (String)a.get(Integer.valueOf(paramInt1)), parambgrm);
    }
    switch (paramInt1)
    {
    default: 
    ...
    return BaseApplicationImpl.getContext().getResources().getDrawable(2130848105);
  }
  
  public static Drawable a(String paramString, int paramInt1, int paramInt2, int paramInt3, bgrm parambgrm)
  {
    return a(paramString, paramInt1, paramInt2, paramInt3, parambgrm, 0);
  }
  
  public static Drawable a(String paramString, int paramInt1, int paramInt2, int paramInt3, bgrm parambgrm, int paramInt4)
  {
    switch (paramInt4)
    {
    }
    ...
    {
      return null;
      bgrj.a().a(paramString, paramInt1, "border", parambgrm);
      continue;
      switch (paramInt3)
      {
      }
    }
    return bgrj.a().a(paramString, paramInt1, "head", parambgrm);
    return bgrj.a().a(paramString, paramInt1, "bottom_lv" + paramInt2, parambgrm);
    return bgrj.a().a(paramString, paramInt1, "right", parambgrm);
  }
  
  public static Drawable a(String paramString, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean, int paramInt4, bgrm parambgrm)
  {
    String str = a(paramInt1, paramInt3, paramBoolean, paramInt4);
    if (!TextUtils.isEmpty(str)) {
      return bgrj.a().a(paramString, paramInt2, str, true, parambgrm);
    }
    return null;
  }
