...
public class aahg
  extends akim
{
  public aahg(AddFriendVerifyActivity paramAddFriendVerifyActivity) {}
  ...
  protected void a(int paramInt1, int paramInt2, String paramString)
  {
    ...
    default: 
      AddFriendVerifyActivity.b(this.a, 1002);
      this.a.jdField_a_of_type_Bcpq.dismiss();
      bcpw.a(this.a, 1, 2131718741, 1).b(this.a.getTitleBarHeight());
    case -2: 
      do
      {
        return;
      ...
      ((akhq)this.a.app.a(20)).b(Long.parseLong(this.a.jdField_a_of_type_JavaLangString), Long.parseLong(this.a.app.getAccount()));
    ...
    case 1: 
      ...
      if (localObject != null) {
        bcpw.a(this.a, 2, 2131718742, 1).b(this.a.getTitleBarHeight());
      }
      for (;;)
      {
        try
        {
          ...
          armk.a("closeJoinWebView", null, paramString, null);
          return;
        }
    ...
    AddFriendVerifyActivity.b(this.a, 1002);
    this.a.jdField_a_of_type_Bcpq.dismiss();
    bcpw.a(this.a, 1, 2131720495, 1).b(this.a.getTitleBarHeight());
  }
  ...
  protected void a(boolean paramBoolean, TroopInfo paramTroopInfo, String paramString)
  {
    if (paramBoolean)
    {
      ...
      if (i == 4) {
        ...
        {
          paramString = actn.a(new Intent(this.a, SplashActivity.class), null);
  ...
  protected void a(boolean paramBoolean, String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (!paramBoolean)
    {
      bcpw.a(this.a, this.a.getString(2131696490), 0).b(this.a.getTitleBarHeight());
  ...
  {
    if (!bbbd.a(String.valueOf(paramLong), this.a.jdField_a_of_type_JavaLangString)) {}
    label262:
    do
    {
      do
      ...
      paramTroopInfo = this.a.getString(2131697786, new Object[] { this.a.app.getCurrentNickname() }) + paramTroopInfo;
