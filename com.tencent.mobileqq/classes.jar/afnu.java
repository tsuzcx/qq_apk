...
public class afnu
{
  ...
  {
    int i = 0 + aydb.a().a(paramQQAppInterface) + akfd.b(paramQQAppInterface);
  ...
  {
    if ((parambaxk == null) || (paramString == null) || (paramInt == -1)) {
      return null;
    }
    if (parambaxk.a()) {
      parambaxk.b();
    }
    Bitmap localBitmap2 = parambaxk.a(paramInt, paramString);
    Bitmap localBitmap1 = localBitmap2;
    if (localBitmap2 == null)
    {
      parambaxk.a(paramString, paramInt, true);
      if (paramInt != 4) {
        break label68;
      }
    }
    label68:
    for (localBitmap1 = bbdr.f();; localBitmap1 = bbdr.a()) {
