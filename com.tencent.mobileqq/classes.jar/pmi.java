  ...
  extends pmb
{
  ...
  public pmi(@NotNull pmc parampmc, QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    super(parampmc, "RIJMsgBoxPopupStep");
  ...
  private boolean a(int paramInt)
  {
    ...
    boolean bool = ((Boolean)bkwm.a("sp_key_kandian_msg_box_show_float_window", Boolean.valueOf(false))).booleanValue();
    ...
    if (localObject != null) {
      ...
      {
        bool = true;
        bkwm.a("sp_key_kandian_msg_box_show_float_window", Boolean.valueOf(bool));
  ...
  protected void g()
  {
    ...
    if (((Intent)localObject).hasExtra("notification_message_id"))
    {
      ...
      else
      {
        ...
        bool = true;
        label117:
        localObject = new pbg().a("uin", localQQAppInterface.getCurrentAccountUin()).a("push_type", Integer.valueOf(9));
        if (bool) {
          i = 3;
        }
        odq.a("0X80081DB", ((pbg)localObject).a("load_mode", Integer.valueOf(i)).a());
      }
    }
    for (;;)
    {
