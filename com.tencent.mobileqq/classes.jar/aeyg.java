...
public class aeyg
  implements Runnable
{
  public aeyg(NearbyMomentManager paramNearbyMomentManager, NearbyMomentManager.GetLocalUnPiblishListCallback paramGetLocalUnPiblishListCallback) {}
  ...
  public void run()
  {
    ...
    ThreadManager.getUIHandler().post(new aeyh(this, localArrayList));
  }
}
