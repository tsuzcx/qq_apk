...
public class mfg
  extends ldy
{
  public mfg(MultiVideoCtrlLayerUI4NewGroupChat paramMultiVideoCtrlLayerUI4NewGroupChat) {}
  ...
  protected void a(long paramLong1, long paramLong2)
  {
    ...
    QLog.w(this.a.jdField_d_of_type_JavaLangString, 1, "onCreateRoomSuc, GroupID[" + paramLong2 + "], seq[" + paramLong1 + "], sessionId[" + ((ley)localObject).c + "]");
