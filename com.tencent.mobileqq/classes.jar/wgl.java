...
public class wgl
  implements Runnable
{
  public wgl(ChatHistoryByDateFragment paramChatHistoryByDateFragment, int paramInt1, int paramInt2) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      if (localArrayList.size() > 0) {
        ThreadManager.getUIHandler().post(new wgm(this, localArrayList));
      }
