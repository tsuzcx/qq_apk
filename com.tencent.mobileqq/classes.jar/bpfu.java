...
public class bpfu
  extends botu
  implements View.OnClickListener, bovh, bpfh, bpfi, bpfj
{
  ...
  public bpfu(@NonNull botw parambotw)
  {
    super(parambotw);
  }
  ...
  private void b(List<bpfr> paramList)
  {
    if ((paramList != null) && (paramList.size() > 0))
    {
      paramList = paramList.iterator();
      while (paramList.hasNext()) {
        ((bpfr)paramList.next()).a();
      }
    }
  }
  ...
  private void i()
  {
    this.jdField_a_of_type_AndroidViewView = ((ViewStub)a(2131377372)).inflate();
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoSendpanelSlideBottomPanel = ((SlideBottomPanel)this.jdField_a_of_type_AndroidViewView.findViewById(2131377834));
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131365191);
    this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)this.jdField_a_of_type_AndroidViewView.findViewById(2131370180));
    this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131377384);
    this.d = this.jdField_a_of_type_AndroidViewView.findViewById(2131363339);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379314));
    this.jdField_a_of_type_ComTencentWidgetXListView.addFooterView(a());
    this.jdField_a_of_type_Bpfl = new bpfl(a(), this);
    this.jdField_a_of_type_Bpfl.a(this);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Bpfl);
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoSendpanelSlideBottomPanel.setSlidePanelListener(this);
    this.jdField_c_of_type_AndroidViewView.findViewById(2131377339).setOnClickListener(this);
  }
  ...
  private void k()
  {
    ...
    bpfs.a().a(this);
    List localList = bpfs.a().a();
    if ((localList != null) && (this.jdField_a_of_type_Bpfl != null))
    {
      b(localList);
      this.jdField_a_of_type_Bpfl.a(localList);
    }
    bovf.a().a(this);
  }
  ...
  private void l()
  {
    if ((this.jdField_c_of_type_AndroidViewView != null) && (this.jdField_c_of_type_AndroidViewView.getVisibility() == 8) && (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoSendpanelSlideBottomPanel.b()) && (this.jdField_a_of_type_Bpfl != null) && (this.jdField_a_of_type_Bpfl.a()))
    {
      this.jdField_c_of_type_Boolean = true;
      a(0, 1, 0);
      bbhl.b(this.jdField_a_of_type_Botw);
    }
  }
  ...
  public void a(int paramInt, bpfr parambpfr)
  {
    ...
    {
      this.jdField_a_of_type_Bpfl.a(paramInt, parambpfr);
      if (this.jdField_a_of_type_ComTencentWidgetXListView != null)
      {
        ...
        if ((paramInt >= i) && (paramInt <= j))
        {
          ...
          if ((((View)localObject).getTag() instanceof bpfq))
          {
            localObject = (bpfq)((View)localObject).getTag();
            ((bpfq)localObject).a = parambpfr;
            this.jdField_a_of_type_Bpfl.a(paramInt, (bpfq)localObject);
          }
        }
      }
    ...
    do
    {
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          bpfr localbpfr = (bpfr)localList.get(i);
          if ((!TextUtils.isEmpty(localbpfr.jdField_a_of_type_JavaLangString)) && (localbpfr.jdField_a_of_type_JavaLangString.equals(paramString1)) && (a(paramInt, localbpfr.jdField_a_of_type_Int)))
          {
            localbpfr.jdField_a_of_type_AndroidGraphicsBitmap = paramBitmap;
            localbpfr.d = paramString2;
            if (this.jdField_a_of_type_AndroidOsHandler == null) {
              break;
            }
            this.jdField_a_of_type_AndroidOsHandler.post(new SendPanelPart.2(this, i, localbpfr));
            return;
          }
          i += 1;
        }
  ...
  {
    if (this.jdField_a_of_type_Bpfl != null) {
      this.jdField_a_of_type_Bpfl.a(paramList);
    }
  }
  ...
  {
    super.aI_();
    if (bpfs.a().jdField_a_of_type_Boolean)
    {
      bpfs.a().jdField_a_of_type_Boolean = false;
      n();
      bpfs.a().a(false);
    }
  }
  ...
  public void b()
  {
    if ((this.jdField_a_of_type_Bpfl != null) && (this.jdField_a_of_type_AndroidOsHandler != null))
    {
  ...
  public void displayPanel()
  {
    ...
    bbhl.d(this.jdField_a_of_type_Botw);
  }
  
  public void displayPanelFinish()
  {
    if (this.jdField_a_of_type_AndroidWidgetImageView != null) {
      this.jdField_a_of_type_AndroidWidgetImageView.setBackgroundResource(2130849681);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_AndroidWidgetImageView != null) {
      this.jdField_a_of_type_AndroidWidgetImageView.setBackgroundResource(2130849680);
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      return;
      if (this.jdField_a_of_type_Botw.a.i()) {
        this.jdField_a_of_type_Boolean = true;
      }
      this.jdField_a_of_type_Botw.e();
      bbhl.a(this.jdField_a_of_type_Botw);
      bnqq.a().d();
    }
  }
}
