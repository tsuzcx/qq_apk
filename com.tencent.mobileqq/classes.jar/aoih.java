  ...
  implements aoga<String>
{
  ...
  public ConcurrentHashMap<String, anke> a;
  public boolean a;
  public String b;
    ...
    try
    {
      ...
      if ((localObject1 != null) && (((JSONArray)localObject1).length() > 0))
      {
        ...
        if (i < ((JSONArray)localObject1).length())
        {
          ...
          if (!TextUtils.isEmpty((CharSequence)localObject2))
          {
            localObject3 = new anke();
            ((anke)localObject3).jdField_a_of_type_JavaLangString = ((String)localObject2);
            ((anke)localObject3).jdField_a_of_type_Int = j;
