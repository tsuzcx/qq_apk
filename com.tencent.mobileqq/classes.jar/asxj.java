  ...
  extends anke
{
  ...
  public asxj(QfileBaseRecentFileTabView paramQfileBaseRecentFileTabView) {}
  ...
  FileManagerEntity a(long paramLong)
  {
    ...
    FileManagerEntity localFileManagerEntity = QfileBaseRecentFileTabView.e(this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityRecentfileQfileBaseRecentFileTabView).a().a(paramLong, anhk.z, 6000, -1L);
  ...
  protected void a(long paramLong, float paramFloat)
  {
    ...
    QfileBaseRecentFileTabView.l(this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityRecentfileQfileBaseRecentFileTabView).a().a(localFileManagerEntity.uniseq, localFileManagerEntity.nSessionId, anhk.z, 6000, 16, null, 0, null);
  }
  ...
  protected void a(long paramLong1, String paramString, int paramInt, boolean paramBoolean1, boolean paramBoolean2, long paramLong2)
  {
    ...
    QfileBaseRecentFileTabView.f(this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityRecentfileQfileBaseRecentFileTabView).a().a(paramString.uniseq, paramString.nSessionId, anhk.z, 6000, 10, null, 0, null);
  }
  ...
  protected void b(long paramLong1, String paramString, int paramInt, boolean paramBoolean1, boolean paramBoolean2, long paramLong2)
  {
    ...
    paramString.status = 2;
    QfileBaseRecentFileTabView.g(this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityRecentfileQfileBaseRecentFileTabView).a().a(paramString.uniseq, paramString.nSessionId, anhk.z, 6000, 10, null, 0, null);
  }
