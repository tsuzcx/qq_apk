...
{
  public aqva(QQAppInterface paramQQAppInterface)
  {
      ...
      try
      {
        ...
        if (n == 0)
        {
          ...
          if (localRspBody.uint32_result.has())
          {
            ...
            aqvh.a(this.app, str, aquz.e, k, m, paramToServiceMsg);
            label169:
          ...
          while (QLog.isColorLevel())
          {
            ...
            break label141;
            label280:
            aqvh.a(this.app, str, k, m, paramToServiceMsg);
            break label169;
            label297:
  ...
  private void b(QQAppInterface paramQQAppInterface, aquz paramaquz)
  {
    long l1 = bcrg.a();
    ...
    aquz.a(paramQQAppInterface, "redpoint_box_show", l1);
    aqvh.a(paramQQAppInterface, false, true);
    paramQQAppInterface.getMessageFacade().getConversationFacade().d(AppConstants.CONFESS_UIN, 1032);
    aoxz localaoxz = paramQQAppInterface.getProxyManager().a();
    paramQQAppInterface = (RecentUser)localaoxz.findRecentUser(AppConstants.CONFESS_UIN, 1032);
    int i;
    if (paramQQAppInterface == null)
    {
      paramQQAppInterface = new RecentUser(AppConstants.CONFESS_UIN, 1032);
    ...
    for (;;)
    {
      if (i != 0)
      {
        localaoxz.saveRecentUser(paramQQAppInterface);
        paramQQAppInterface = this.mApp.getHandler(Conversation.class);
        if (paramQQAppInterface != null) {
          paramQQAppInterface.sendEmptyMessage(1009);
        }
      }
      notifyUI(4, true, paramaquz);
      return;
  ...
  private void c(QQAppInterface paramQQAppInterface, aquz paramaquz)
  {
    if (QLog.isColorLevel()) {
      QLog.i("ConfessHandler", 2, "onNeedShowLebaRedPoint");
    }
    aquz.a(paramQQAppInterface, "redpoint_leba_show", bcrg.a());
  }
  ...
  public void a(aqvp paramaqvp)
  {
    ...
    if ((RecentUser)this.app.getProxyManager().a().findRecentUser(AppConstants.CONFESS_UIN, 1032) != null)
    {
    ...
    notifyUI(2, true, paramaqvp);
  }
  
  public void a(QQAppInterface paramQQAppInterface, aquz paramaquz)
  {
    if (QLog.isColorLevel()) {
      QLog.i("ConfessHandler", 2, String.format("onGetNewConfig boxEntry:%d contactEntry:%d", new Object[] { Integer.valueOf(paramaquz.h), Integer.valueOf(paramaquz.i) }));
    }
    if (paramaquz.h == 2) {
      b(paramQQAppInterface, paramaquz);
    }
    if (paramaquz.i == 2) {
      c(paramQQAppInterface, paramaquz);
    }
  }
  ...
  public void a(String paramString, int paramInt1, int paramInt2, ConfessInfo paramConfessInfo, int paramInt3)
  {
    ...
    if (paramInt3 == -1)
    {
      ...
      bdla.b(this.app, "dc00898", "", "", (String)localObject, (String)localObject, 0, 0, "", "", "", "");
  ...
  public void b(aqvp paramaqvp)
  {
    ...
    int i;
    if ((paramaqvp != null) && (paramaqvp.a()))
    {
      localaoxz = this.app.getProxyManager().a();
      localRecentUser = (RecentUser)localaoxz.findRecentUser(AppConstants.CONFESS_UIN, 1032);
      ...
      localRecentUser.lastmsgtime = paramaqvp.a;
      paramaqvp = localRecentUser;
      i = 1;
    }
    for (;;)
    {
      if (i != 0)
      {
        localaoxz.saveRecentUser(paramaqvp);
        paramaqvp = this.mApp.getHandler(Conversation.class);
        if (paramaqvp != null) {
          paramaqvp.sendEmptyMessage(1009);
        }
      }
      notifyUI(1, true, null);
      return;
      label124:
      if (localRecentUser.lastmsgtime < paramaqvp.a)
      {
        localRecentUser.lastmsgtime = paramaqvp.a;
        paramaqvp = localRecentUser;
        i = 1;
