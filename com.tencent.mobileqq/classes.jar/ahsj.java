...
public class ahsj
  ...
  implements blau
{
  private ahtm jdField_a_of_type_Ahtm;
  ...
  public ahsj(Activity paramActivity, aavo paramaavo, ahtp paramahtp, String paramString)
  {
    super(paramActivity, paramaavo, paramahtp, paramString);
  }
  ...
  private void a(ahtm paramahtm, AIOImageData paramAIOImageData, boolean paramBoolean)
  {
    StructMsgForImageShare localStructMsgForImageShare = (StructMsgForImageShare)bdof.a((byte[])paramAIOImageData.a);
    ...
    if (arrayOfString != null)
    {
      ...
      if (arrayOfString.length >= 8)
      {
        ...
        localObject1 = arrayOfString[3] + anvx.a(2131699563) + arrayOfString[5] + anvx.a(2131699578);
    ...
    for (;;)
    {
      if (!this.jdField_a_of_type_JavaUtilSet.contains(Integer.valueOf(paramahtm.hashCode())))
      {
        blrb.a(null, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_AndroidAppActivity, "3008", "1", "30004", arrayOfString[0], new String[] { arrayOfString[2], arrayOfString[4], a(localStructMsgForImageShare.mMsgActionData) });
        this.jdField_a_of_type_JavaUtilSet.add(Integer.valueOf(paramahtm.hashCode()));
      }
      ...
      {
        if (this.f != null) {
          this.f.setText(anvx.a(2131699538));
        }
  ...
  {
    paramAIOImageData = (StructMsgForImageShare)bdof.a((byte[])paramAIOImageData.a);
    b(paramAIOImageData);
    ...
    olh.a(null, "", "0X8007130", "0X8007130", 0, 0, (String)localObject1, paramAIOImageData, "", "");
  }
  ...
  private void a(AIOImageData paramAIOImageData, StructMsgForImageShare paramStructMsgForImageShare)
  {
    ...
    olh.a(null, "", "0X8007131", "0X8007131", 0, 0, paramStructMsgForImageShare, paramAIOImageData, "", "");
  }
  ...
  private void a(AIOImageData paramAIOImageData, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if ((arrayOfString != null) && (arrayOfString.length > 2))
    {
      ...
      olh.a(null, "", "0X8007153", "0X8007153", 0, 0, (String)localObject, paramAIOImageData, "", "");
      olh.a("0X8007153", "", (String)localObject, paramAIOImageData, "", "");
    }
    for (;;)
    {
      this.jdField_b_of_type_AndroidWidgetButton.setVisibility(8);
  ...
  private void a(boolean paramBoolean, String[] paramArrayOfString, StructMsgForImageShare paramStructMsgForImageShare, File paramFile)
  {
    if (paramBoolean)
    {
      ...
      String str2 = paramArrayOfString[3] + anvx.a(2131699546) + paramArrayOfString[5] + anvx.a(2131699558);
    ...
    for (;;)
    {
      blrb.a(null, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_AndroidAppActivity, "100008", "2", "40058", paramArrayOfString[0], new String[] { "2", "", paramStructMsgForImageShare });
      return;
      label426:
  ...
  private void a(String[] paramArrayOfString, StructMsgForImageShare paramStructMsgForImageShare)
  {
    ...
    if (localObject != null)
    {
      if (((bdqa)localObject).a == null) {
        ((bdqa)localObject).a = paramStructMsgForImageShare;
      }
      AIOImageData localAIOImageData = ahsl.a(((bdqa)localObject).a());
    ...
    bmad.a(str).c(this.jdField_b_of_type_JavaLangString).a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_b_of_type_JavaLangString);
    bman.a(null, 6, 2);
    paramStructMsgForImageShare = "";
    ...
    olh.a(null, "", "0X8007132", "0X8007132", 0, 0, (String)localObject, paramStructMsgForImageShare, "", "");
  }
  ...
  {
    String str;
    if ((this.jdField_a_of_type_Ahsn.b.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOImageData)) {
      str = "0X8009AB2";
    }
    for (;;)
    {
      if (!TextUtils.isEmpty(str)) {
        bdla.b(null, "dc00898", "", "", str, str, this.k, 0, "", "", "", "");
      }
      if (this.jdField_a_of_type_Aawb.a() == null)
      {
        this.jdField_a_of_type_AndroidAppActivity.finish();
        return;
        if ((this.jdField_a_of_type_Ahsn.b.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOShortVideoData)) {
          str = "0X8009AB3";
        }
      }
      else
      {
        this.jdField_a_of_type_Aawb.a();
        return;
      }
      str = null;
    }
  ...
  public void G()
  {
    ...
    this.jdField_a_of_type_Ahsi.e = false;
    u();
  }
  ...
  public ahtm a()
  {
    return this.jdField_a_of_type_Ahtm;
  }
  ...
  public void a(float paramFloat)
  {
    ...
    if (paramFloat < 0.8F)
    {
      this.jdField_a_of_type_Ahsi.e = true;
      u();
    }
  }
  ...
  protected void a(ahtm paramahtm, Activity paramActivity, int paramInt)
  {
    ...
    if ((this.k == 1) || (this.k == 2) || (this.k == 3) || (this.k == 5) || (this.k == 6))
    {
      ...
      localAIOImageData = (AIOImageData)paramahtm.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
    ...
    for (paramInt = 0;; paramInt = 1)
    {
      ...
      for (;;)
      {
        localBundle.putString("forward_urldrawable_big_url", paramahtm.a(i));
        if (localFile == null) {
          break;
        }
        try
        {
          ...
          aupt.a(paramActivity, paramahtm, 19005);
          return;
        }
      ...
      return;
      super.a(paramahtm, paramActivity, paramInt);
      return;
    }
  }
  ...
  public void a(ViewGroup paramViewGroup)
  {
    ...
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2131563050, null);
    ...
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131381229));
    this.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
    this.jdField_b_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131381230));
    this.jdField_b_of_type_AndroidWidgetButton.setVisibility(8);
    this.c = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131381227));
    this.f = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131381231));
    this.jdField_a_of_type_JavaUtilSet = new HashSet();
    localObject = new ahsk(this);
    ...
    this.g = avek.a(this.jdField_a_of_type_AndroidAppActivity, paramViewGroup);
    this.g.setVisibility(4);
    this.jdField_a_of_type_ComTencentWidgetDragView = ((DragView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131365898));
    ...
    this.jdField_a_of_type_ComTencentWidgetDragView.setOriginRect(this.jdField_a_of_type_Ahsn.b.getThumbRect());
  }
  ...
  protected void a(StructMsgForImageShare paramStructMsgForImageShare)
  {
    ...
    do
    {
      ...
      if (((bdqa)localObject2).a == null) {
        ((bdqa)localObject2).a = paramStructMsgForImageShare;
      }
      localObject1 = ((bdqa)localObject2).a();
      ...
      ((bdqa)localObject2).ac = ((MessageForPic)localObject1).path;
      if (!TextUtils.isEmpty(((bdqa)localObject2).ac)) {
        break label173;
      }
    ...
    for (;;)
    {
      ((bdqa)localObject2).ac = ((String)localObject1);
      break label66;
      localObject1 = URLDrawableHelper.getURL((azkl)localObject1, 65537);
      if (localObject1 != null)
      {
        ...
        if ((localObject1 != null) && (((File)localObject1).exists()))
        {
          ...
          aupt.a(this.jdField_a_of_type_AndroidAppActivity, (Intent)localObject2, 0);
          ...
          for (;;)
          {
            blrb.a(null, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_AndroidAppActivity, "100008", "2", "40058", localObject1[0], new String[] { "1", "", paramStructMsgForImageShare });
            return;
            label369:
            if (!QLog.isColorLevel()) {
              break;
  ...
  protected void a(StructMsgForImageShare paramStructMsgForImageShare, String paramString)
  {
    ...
    try
    {
      ...
      localJSONObject.put("leftViewText", anvx.a(2131699557));
      ...
      if ((paramStructMsgForImageShare != null) && (paramStructMsgForImageShare.length >= 8))
      {
        if (paramStructMsgForImageShare[7].equals("link"))
        {
          ...
          blrb.a(null, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_AndroidAppActivity, "100008", "2", "40057", localObject1, new String[] { "", "", paramStructMsgForImageShare });
        }
        label251:
        ...
        blrb.a(null, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_AndroidAppActivity, "100008", "2", "40058", localObject1, new String[] { "4", "", paramStructMsgForImageShare });
        return;
      }
    }
    catch (Exception localException)
  ...
  boolean a(ahtm paramahtm)
  {
    ...
    if ((this.jdField_a_of_type_Ahtm != null) && (this.jdField_a_of_type_Ahtm.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long == paramahtm.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long) && (this.jdField_a_of_type_Ahtm.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Int == paramahtm.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Int)) {}
    for (boolean bool1 = false;; bool1 = true)
    {
      this.jdField_a_of_type_Ahtm = paramahtm;
      boolean bool2;
      AIOImageData localAIOImageData;
      if ((this.jdField_b_of_type_AndroidWidgetImageButton.getVisibility() != 4) || (this.jdField_a_of_type_AndroidViewView.getVisibility() != 4))
      {
        ...
        if (AIOImageData.class.isInstance(paramahtm.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData))
        {
          ...
          a(paramahtm, localAIOImageData, bool2);
        }
      }
      for (;;)
      {
        ...
        else if (localAIOImageData.b == 5)
        {
          avek.a(this.g, this.jdField_a_of_type_AndroidAppActivity, localAIOImageData, this);
        }
        else if (bool2)
        {
          this.jdField_a_of_type_AndroidViewView.setVisibility(4);
  ...
  {
    if ((parambkzi == null) || (paramAIOImageData == null)) {}
    do
    {
      return false;
      if (paramAIOImageData.b == 1)
      {
        ...
        parambkzi.b(2131693149);
        parambkzi.b(2131693148);
        return true;
      }
    } while (paramAIOImageData.b != 2);
    parambkzi.b(2131693151);
    parambkzi.b(2131693153);
    parambkzi.b(2131693146);
    Object localObject = b(((StructMsgForImageShare)bdof.a((byte[])paramAIOImageData.a)).mMsgActionData);
    if ((localObject != null) && (localObject.length > 2))
    {
      parambkzi = "";
    ...
    olh.a(null, "", "0X8007154", "0X8007154", 0, 0, paramAIOImageData, parambkzi, "", "");
    return true;
  }
  ...
  boolean a(String paramString, AIOImageData paramAIOImageData, File paramFile)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return false;
          if (!paramString.equals(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131693153))) {
            break;
          }
        } while ((paramAIOImageData.b != 1) && (paramAIOImageData.b != 2));
        paramString = (StructMsgForImageShare)bdof.a((byte[])paramAIOImageData.a);
        a(paramString);
        a(paramAIOImageData, paramString);
        return true;
        if (!paramString.equals(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131693151))) {
          break;
        }
        if (paramAIOImageData.b == 1)
        {
    ...
    {
      return true;
      if (paramString.equals(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131693149)))
      {
        if (paramAIOImageData.b != 1) {
          break;
        }
        b((StructMsgForImageShare)bdof.a((byte[])paramAIOImageData.a), "6");
        return true;
      }
      if (paramString.equals(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131693148)))
      {
        if (paramAIOImageData.b != 1) {
          break;
        }
        a((StructMsgForImageShare)bdof.a((byte[])paramAIOImageData.a), "6");
        return true;
      }
      if ((!paramString.equals(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131693146))) || (paramAIOImageData.b != 2)) {
        break;
      }
      a(paramAIOImageData);
    }
  ...
  protected void b(StructMsgForImageShare paramStructMsgForImageShare, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localJSONObject.put("leftViewText", anvx.a(2131699556));
        ...
        if (arrayOfString.length >= 8)
        {
          ...
          {
            blrb.a(null, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_AndroidAppActivity, "100008", "2", "40055", arrayOfString[0], new String[] { "", "", paramStructMsgForImageShare });
            return;
          ...
          blrb.a(null, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_AndroidAppActivity, "100008", "2", "40058", arrayOfString[0], new String[] { "3", "", paramStructMsgForImageShare });
          return;
        }
      }
      catch (Exception localException)
  ...
  protected void c(StructMsgForImageShare paramStructMsgForImageShare, String paramString)
  {
    ...
    try
    {
      ...
      if (i != 0)
      {
        ...
        blrb.a(null, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_AndroidAppActivity, "100008", "2", "40056", arrayOfString[0], new String[] { "", paramStructMsgForImageShare, paramString });
      }
    }
    catch (Exception paramStructMsgForImageShare)
    {
  ...
  boolean g()
  {
    Object localObject = this.jdField_a_of_type_Ahsn.b();
    if ((localObject != null) && (AIOImageData.class.isInstance(((ahtm)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData)))
    {
  ...
  public void onItemSelected(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    if (this.jdField_a_of_type_Aawb.a() != null) {
      this.jdField_a_of_type_ComTencentWidgetDragView.setOriginRect(this.jdField_a_of_type_Ahsn.b.thubmRect);
    }
    while ((this.jdField_a_of_type_Ahsn.b.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOShortVideoData))
    {
      this.jdField_a_of_type_ComTencentWidgetGallery.a(false);
      this.jdField_a_of_type_ComTencentWidgetGallery.b(false);
      return;
      this.jdField_a_of_type_ComTencentWidgetDragView.setOriginRect(this.jdField_a_of_type_Ahsn.b.jdField_a_of_type_AndroidGraphicsRect);
    }
  ...
  public void q()
  {
    ...
    {
      this.jdField_a_of_type_Aawb.a().i();
      return;
    }
    super.q();
  }
  ...
  {
    super.u();
    if ((this.jdField_a_of_type_Ahsi.a) || (this.jdField_a_of_type_Ahsi.d) || (this.jdField_a_of_type_Ahsi.e) || (this.jdField_a_of_type_Ahsi.f))
    {
      if (QLog.isColorLevel()) {
    ...
    while ((this.jdField_a_of_type_Ahsn == null) || (this.jdField_a_of_type_Ahsn.a() == null) || (!(this.jdField_a_of_type_Ahsn.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOImageData)) || (((AIOImageData)this.jdField_a_of_type_Ahsn.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).b != 5)) {
      return;
    }
