...
public class bbqc
{
  public static bbqe a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    Object localObject = ajsf.bV + paramInt + File.separator + "config.json";
    ...
    try
    {
      paramQQAppInterface = bbdj.a(paramQQAppInterface, -1);
    ...
    localObject = new bbqe(Integer.toString(paramInt));
    a(paramQQAppInterface, (bbqe)localObject);
    return localObject;
  }
  ...
  public static String a(String paramString1, String paramString2)
  {
    ...
    StringBuilder localStringBuilder = new StringBuilder(ajsf.bV);
  ...
  public static void a(String paramString, bbqe parambbqe)
  {
    Object localObject;
    try
    {
      ...
      parambbqe.jdField_f_of_type_JavaLangString = ((JSONObject)localObject).optString("qqVer", "0.0.0");
      if (AppSetting.a(parambbqe.jdField_f_of_type_JavaLangString) < 0)
      {
        parambbqe.a();
        return;
      }
    ...
    parambbqe.jdField_b_of_type_JavaLangString = ((JSONObject)localObject).optString("name", ajyc.a(2131714124));
    parambbqe.jdField_b_of_type_Int = ((JSONObject)localObject).optInt("type", -1);
    parambbqe.jdField_a_of_type_Int = ((JSONObject)localObject).optInt("feeType", 1);
    parambbqe.jdField_c_of_type_JavaLangString = ((JSONObject)localObject).optString("actUrl", null);
    parambbqe.jdField_c_of_type_Int = ((JSONObject)localObject).optInt("newOrHot", 0);
    parambbqe.jdField_d_of_type_Int = ((JSONObject)localObject).optInt("platId");
    parambbqe.jdField_e_of_type_JavaLangString = ((JSONObject)localObject).optString("fontColor", "");
    parambbqe.jdField_g_of_type_Int = ((JSONObject)localObject).optInt("signType", 0);
    for (;;)
    {
      int j;
      int i;
      try
      {
        Color.parseColor(parambbqe.jdField_e_of_type_JavaLangString);
        parambbqe.n = ((JSONObject)localObject).optString("defText", "");
        parambbqe.o = ((JSONObject)localObject).optString("defTextColor", "");
      }
      catch (Exception localException2)
      {
        try
        {
          Color.parseColor(parambbqe.o);
          parambbqe.p = ((JSONObject)localObject).optString("timeAndLocation", "");
        }
        catch (Exception localException2)
        {
          try
          {
            Color.parseColor(parambbqe.p);
            parambbqe.jdField_e_of_type_Int = ((JSONObject)localObject).optInt("isLimited", 1);
            parambbqe.q = ((JSONObject)localObject).optString("startTime");
            parambbqe.r = ((JSONObject)localObject).optString("endTime");
            parambbqe.s = ((JSONObject)localObject).optString("dot9png");
            parambbqe.jdField_d_of_type_JavaLangString = ((JSONObject)localObject).optString("cover");
            parambbqe.jdField_g_of_type_JavaLangString = ((JSONObject)localObject).optString("aio_2");
            parambbqe.h = ((JSONObject)localObject).optString("aio_3");
            parambbqe.i = ((JSONObject)localObject).optString("aio_4");
            parambbqe.j = ((JSONObject)localObject).optString("icon");
            parambbqe.k = ((JSONObject)localObject).optString("view");
            parambbqe.l = ((JSONObject)localObject).optString("action_off");
            parambbqe.m = ((JSONObject)localObject).optString("action_on");
            parambbqe.t = ((JSONObject)localObject).optString("backgroundColor");
            parambbqe.u = ((JSONObject)localObject).optString("shadowColor");
            parambbqe.jdField_f_of_type_Int = ((JSONObject)localObject).optInt("materialVersion");
            if (paramString.has("dynamicItem"))
            {
              ...
              if (j < ((JSONArray)localObject).length())
              {
                ...
                bbqf[] arrayOfbbqf = parambbqe.jdField_a_of_type_ArrayOfBbqf;
                if (i != 0) {
                  break label891;
                }
                k = i;
                arrayOfbbqf[k].jdField_a_of_type_Int = i;
                arrayOfbbqf = parambbqe.jdField_a_of_type_ArrayOfBbqf;
                if (i != 0) {
                  break label899;
                }
                k = i;
                arrayOfbbqf[k].jdField_a_of_type_JavaLangString = localJSONObject.optString("pngZip");
                arrayOfbbqf = parambbqe.jdField_a_of_type_ArrayOfBbqf;
                if (i != 0) {
                  break label907;
                }
                k = i;
                arrayOfbbqf[k].jdField_a_of_type_Float = ((float)localJSONObject.optDouble("posX", 0.0D));
                arrayOfbbqf = parambbqe.jdField_a_of_type_ArrayOfBbqf;
                if (i != 0) {
                  break label915;
                }
                k = i;
                arrayOfbbqf[k].jdField_b_of_type_Float = ((float)localJSONObject.optDouble("posY", 0.0D));
                arrayOfbbqf = parambbqe.jdField_a_of_type_ArrayOfBbqf;
                if (i != 0) {
                  break label923;
                }
                k = i;
                arrayOfbbqf[k].jdField_c_of_type_Float = ((float)localJSONObject.optDouble("width", 0.0D));
                arrayOfbbqf = parambbqe.jdField_a_of_type_ArrayOfBbqf;
                if (i != 0) {
                  break label931;
                }
                k = i;
                arrayOfbbqf[k].d = ((float)localJSONObject.optDouble("height", 0.0D));
                arrayOfbbqf = parambbqe.jdField_a_of_type_ArrayOfBbqf;
                if (i != 0) {
                  break label939;
                }
                k = i;
                arrayOfbbqf[k].jdField_b_of_type_Int = localJSONObject.optInt("repeatTimes", 0);
                arrayOfbbqf = parambbqe.jdField_a_of_type_ArrayOfBbqf;
                if (i != 0) {
                  break label947;
                }
                arrayOfbbqf[i].jdField_c_of_type_Int = localJSONObject.optInt("interval", 0);
                break label884;
                localException1 = localException1;
                parambbqe.jdField_e_of_type_JavaLangString = "";
                continue;
          ...
          catch (Exception localException3)
          {
            ...
            if ((paramString != null) && (paramString.length() > 0))
            {
              ...
              parambbqe.getClass();
              localObject = new bbqg(parambbqe);
              ((bbqg)localObject).jdField_b_of_type_JavaLangString = paramString.optString("content");
              ((bbqg)localObject).jdField_a_of_type_JavaLangString = paramString.optString("img");
              ((bbqg)localObject).jdField_a_of_type_Int = paramString.optInt("imgWidth");
              ((bbqg)localObject).jdField_b_of_type_Int = paramString.optInt("imgHeight");
              ((bbqg)localObject).jdField_c_of_type_JavaLangString = paramString.optString("imgCover");
              parambbqe.jdField_a_of_type_Bbqg = ((bbqg)localObject);
            }
          }
        }
      }
  ...
  /* Error */
  public static bbqd[] a(QQAppInterface paramQQAppInterface)
  {
    // Byte code:
    ...
    //   20: aload_0
    //   21: iconst_m1
    //   22: invokestatic 55	bbdj:a	(Ljava/io/File;I)Ljava/lang/String;
    //   25: astore_0
    //   26: aload_0
    //   27: ifnonnull +24 -> 51
    //   30: aconst_null
    ...
    //   110: new 389	bbqd
    //   113: dup
    //   114: invokespecial 390	bbqd:<init>	()V
    //   117: astore 10
    //   119: aload 10
    //   121: aload 9
    //   123: ldc_w 392
    //   126: invokevirtual 395	org/json/JSONObject:getInt	(Ljava/lang/String;)I
    //   129: putfield 396	bbqd:jdField_a_of_type_Int	I
    //   132: aload 10
    //   134: aload 9
    //   136: ldc_w 398
    //   139: invokevirtual 401	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   142: putfield 402	bbqd:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   145: aload 7
    //   147: aload 10
    //   149: getfield 396	bbqd:jdField_a_of_type_Int	I
    ...
    //   247: invokespecial 80	bbqe:<init>	(Ljava/lang/String;)V
    //   250: astore 11
    //   252: aload 12
    //   254: ldc 101
    ...
    //   303: putfield 133	bbqe:jdField_f_of_type_JavaLangString	Ljava/lang/String;
    //   306: aload 11
    //   308: getfield 133	bbqe:jdField_f_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   335: aload 11
    //   337: aload_0
    //   338: putfield 152	bbqe:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   341: aload 14
    //   343: ldc 154
    ...
    //   360: aload 11
    //   362: iload 5
    //   364: putfield 160	bbqe:jdField_b_of_type_Int	I
    //   367: aload 14
    //   369: ldc 162
    ...
    //   386: aload 11
    //   388: iload 5
    //   390: putfield 164	bbqe:jdField_a_of_type_Int	I
    //   393: aload 14
    //   395: ldc 166
    ...
    //   411: aload 11
    //   413: aload_0
    //   414: putfield 169	bbqe:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   417: aload 14
    //   419: ldc 171
    ...
    //   436: aload 11
    //   438: iload 5
    //   440: putfield 173	bbqe:jdField_c_of_type_Int	I
    //   443: aload 11
    //   445: aload 14
    //   447: ldc 117
    //   449: invokevirtual 395	org/json/JSONObject:getInt	(Ljava/lang/String;)I
    //   452: putfield 176	bbqe:jdField_d_of_type_Int	I
    //   455: aload 14
    //   457: ldc 178
    ...
    //   473: aload 11
    //   475: aload_0
    //   476: putfield 182	bbqe:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   479: aload 11
    //   481: getfield 182	bbqe:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   506: aload 11
    //   508: aload_0
    //   509: putfield 197	bbqe:n	Ljava/lang/String;
    //   512: aload 14
    //   514: ldc 199
    ...
    //   530: aload 11
    //   532: aload_0
    //   533: putfield 202	bbqe:o	Ljava/lang/String;
    //   536: aload 11
    //   538: getfield 202	bbqe:o	Ljava/lang/String;
    ...
    //   563: aload 11
    //   565: aload_0
    //   566: putfield 207	bbqe:p	Ljava/lang/String;
    //   569: aload 11
    //   571: getfield 207	bbqe:p	Ljava/lang/String;
    ...
    //   597: aload 11
    //   599: iload 5
    //   601: putfield 211	bbqe:jdField_e_of_type_Int	I
    //   604: aload 14
    //   606: ldc 213
    ...
    //   622: aload 11
    //   624: aload_0
    //   625: putfield 219	bbqe:q	Ljava/lang/String;
    //   628: aload 14
    //   630: ldc 221
    ...
    //   646: aload 11
    //   648: aload_0
    //   649: putfield 224	bbqe:r	Ljava/lang/String;
    //   652: aload 14
    //   654: ldc 226
    ...
    //   670: aload 11
    //   672: aload_0
    //   673: putfield 229	bbqe:s	Ljava/lang/String;
    //   676: aload 14
    //   678: ldc_w 269
    ...
    //   696: aload 11
    //   698: aload_0
    //   699: putfield 272	bbqe:t	Ljava/lang/String;
    //   702: aload 14
    //   704: ldc 231
    ...
    //   721: putfield 233	bbqe:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    //   724: aload 14
    //   726: ldc 235
    ...
    //   743: putfield 237	bbqe:jdField_g_of_type_JavaLangString	Ljava/lang/String;
    //   746: aload 14
    //   748: ldc 239
    ...
    //   765: putfield 242	bbqe:h	Ljava/lang/String;
    //   768: aload 14
    //   770: ldc 244
    ...
    //   787: putfield 247	bbqe:i	Ljava/lang/String;
    //   790: aload 14
    //   792: ldc 249
    ...
    //   809: putfield 252	bbqe:j	Ljava/lang/String;
    //   812: aload 14
    //   814: ldc 254
    ...
    //   831: putfield 257	bbqe:k	Ljava/lang/String;
    //   834: aload 14
    //   836: ldc_w 259
    ...
    //   855: putfield 262	bbqe:l	Ljava/lang/String;
    //   858: aload 14
    //   860: ldc_w 264
    ...
    //   879: putfield 267	bbqe:m	Ljava/lang/String;
    //   882: goto +750 -> 1632
    //   885: astore_0
    ...
    //   956: areturn
    //   957: ldc_w 444
    //   960: invokestatic 149	ajyc:a	(I)Ljava/lang/String;
    //   963: astore_0
    //   964: goto -629 -> 335
    //   967: astore_0
    //   968: aload 11
    //   970: ldc 180
    //   972: putfield 182	bbqe:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   975: goto -487 -> 488
    //   978: astore_0
    //   979: aload 11
    //   981: ldc 180
    //   983: putfield 202	bbqe:o	Ljava/lang/String;
    //   986: goto -441 -> 545
    //   989: astore_0
    //   990: aload 11
    //   992: ldc 180
    //   994: putfield 207	bbqe:p	Ljava/lang/String;
    //   997: goto -419 -> 578
    //   1000: aload 12
    //   1002: ldc_w 283
    ...
    //   1063: goto +653 -> 1716
    //   1066: aload 11
    //   1068: getfield 295	bbqe:jdField_a_of_type_ArrayOfBbqf	[Lbbqf;
    //   1071: astore_0
    //   1072: iload_3
    //   1073: ifne +675 -> 1748
    //   1076: iload_3
    ...
    //   1082: aaload
    //   1083: iload_3
    //   1084: putfield 298	bbqf:jdField_a_of_type_Int	I
    //   1087: aload 11
    //   1089: getfield 295	bbqe:jdField_a_of_type_ArrayOfBbqf	[Lbbqf;
    //   1092: astore_0
    //   1093: iload_3
    //   1094: ifne +662 -> 1756
    //   1097: iload_3
    ...
    //   1126: aload 15
    //   1128: aload_0
    //   1129: putfield 302	bbqf:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   1132: aload 11
    //   1134: getfield 295	bbqe:jdField_a_of_type_ArrayOfBbqf	[Lbbqf;
    //   1137: astore_0
    //   1138: iload_3
    //   1139: ifne +631 -> 1770
    //   1142: iload_3
    ...
    //   1171: dload_1
    //   1172: d2f
    //   1173: putfield 311	bbqf:jdField_a_of_type_Float	F
    //   1176: aload 11
    //   1178: getfield 295	bbqe:jdField_a_of_type_ArrayOfBbqf	[Lbbqf;
    //   1181: astore_0
    //   1182: iload_3
    //   1183: ifne +600 -> 1783
    //   1186: iload_3
    ...
    //   1215: dload_1
    //   1216: d2f
    //   1217: putfield 315	bbqf:jdField_b_of_type_Float	F
    //   1220: aload 11
    //   1222: getfield 295	bbqe:jdField_a_of_type_ArrayOfBbqf	[Lbbqf;
    //   1225: astore_0
    //   1226: iload_3
    //   1227: ifne +569 -> 1796
    //   1230: iload_3
    ...
    //   1259: dload_1
    //   1260: d2f
    //   1261: putfield 319	bbqf:jdField_c_of_type_Float	F
    //   1264: aload 11
    //   1266: getfield 295	bbqe:jdField_a_of_type_ArrayOfBbqf	[Lbbqf;
    //   1269: astore_0
    //   1270: iload_3
    //   1271: ifne +538 -> 1809
    //   1274: iload_3
    ...
    //   1303: dload_1
    //   1304: d2f
    //   1305: putfield 323	bbqf:d	F
    //   1308: aload 11
    //   1310: getfield 295	bbqe:jdField_a_of_type_ArrayOfBbqf	[Lbbqf;
    //   1313: astore_0
    //   1314: iload_3
    //   1315: ifne +507 -> 1822
    //   1318: iload_3
    ...
    //   1347: aload_0
    //   1348: iload 6
    //   1350: putfield 326	bbqf:jdField_b_of_type_Int	I
    //   1353: aload 11
    //   1355: getfield 295	bbqe:jdField_a_of_type_ArrayOfBbqf	[Lbbqf;
    //   1358: astore_0
    //   1359: iload_3
    //   1360: ifne +476 -> 1836
    //   1363: aload_0
    ...
    //   1387: aload_0
    //   1388: iload_3
    //   1389: putfield 329	bbqf:jdField_c_of_type_Int	I
    //   1392: goto +342 -> 1734
    //   1395: aload 12
    //   1397: ldc_w 331
    ...
    //   1430: dup
    //   1431: aload 11
    //   1433: invokespecial 340	bbqg:<init>	(Lbbqe;)V
    //   1436: astore 12
    //   1438: aload 12
    //   1440: aload_0
    //   1441: ldc_w 342
    //   1444: invokevirtual 216	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   1447: putfield 343	bbqg:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   1450: aload 12
    //   1452: aload_0
    //   1453: ldc_w 345
    //   1456: invokevirtual 216	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   1459: putfield 346	bbqg:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   1462: aload 12
    //   1464: aload_0
    //   1465: ldc_w 348
    //   1468: invokevirtual 121	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   1471: putfield 349	bbqg:jdField_a_of_type_Int	I
    //   1474: aload 12
    //   1476: aload_0
    //   1477: ldc_w 351
    //   1480: invokevirtual 121	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   1483: putfield 352	bbqg:jdField_b_of_type_Int	I
    //   1486: aload 12
    //   1488: aload_0
    //   1489: ldc_w 354
    //   1492: invokevirtual 216	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   1495: putfield 355	bbqg:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   1498: aload 11
    //   1500: aload 12
    //   1502: putfield 358	bbqe:jdField_a_of_type_Bbqg	Lbbqg;
    //   1505: aload 7
    //   1507: aload 11
    //   1509: getfield 160	bbqe:jdField_b_of_type_Int	I
    //   1512: invokestatic 406	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   1515: invokeinterface 452 2 0
    //   1520: checkcast 389	bbqd
    //   1523: astore_0
    //   1524: aload_0
    //   1525: ifnull +323 -> 1848
    //   1528: aload_0
    //   1529: getfield 455	bbqd:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   1532: aload 11
    ...
    //   1577: checkcast 389	bbqd
    //   1580: getfield 455	bbqd:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
