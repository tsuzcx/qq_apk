  ...
  extends BaseBubbleBuilder
{
  ...
  public aefd(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo, paramAIOAnimationConatiner);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new aefe(this);
    this.b = paramContext;
  ...
  private RelativeLayout a(Context paramContext)
  {
    ...
    localQQWalletTransferBubbleView.setId(2131379267);
    ...
    ((ImageView)localObject1).setId(2131379263);
    localQQWalletTransferBubbleView.addView((View)localObject1);
    localObject1 = new LinearLayout(paramContext);
    localObject2 = new RelativeLayout.LayoutParams(-2, -2);
    ((RelativeLayout.LayoutParams)localObject2).addRule(0, 2131379263);
    ...
    ((TextView)localObject2).setId(2131379266);
    ...
    ((TextView)localObject2).setId(2131379265);
    ((LinearLayout)localObject1).addView((View)localObject2);
    localQQWalletTransferBubbleView.addView((View)localObject1);
    ...
    ((RelativeLayout.LayoutParams)localObject1).addRule(3, 2131379267);
    localQQWalletTransferBubbleView.setLayoutParams((ViewGroup.LayoutParams)localObject1);
    localQQWalletTransferBubbleView.setBackgroundResource(2130846330);
  ...
  {
    boolean bool2 = true;
    paramView = (aeff)paramacuj;
    if (paramView.a == null) {
      paramView.a = a(this.b);
    }
    if ((paramChatMessage instanceof MessageForVIPDonate)) {}
    for (paramacuj = (MessageForVIPDonate)paramChatMessage;; paramacuj = null)
    {
      if (paramacuj == null)
      {
      ...
      paramacuj.parse();
      paramacuj = paramacuj.donateMsg;
      if (paramacuj == null)
      {
        QLog.e("VIPDonateMsgItemBuilder", 1, "donateMsg empty");
        return null;
      }
      paramBaseChatItemLayout = (TextView)paramView.a.findViewById(2131379266);
      paramBaseChatItemLayout.setText(paramacuj.title);
      paramBaseChatItemLayout.setTextColor(-1);
      paramBaseChatItemLayout = (TextView)paramView.a.findViewById(2131379265);
      paramBaseChatItemLayout.setText(paramacuj.subTitle);
      paramBaseChatItemLayout.setTextColor(-1);
      ((TextView)paramView.a.findViewById(2131379264)).setText(paramacuj.footer);
      ((ImageView)paramView.a.findViewById(2131379263)).setImageResource(2130849678);
      paramBaseChatItemLayout = (QQWalletTransferBubbleView)paramView.a.findViewById(2131379262);
      QQWalletTransferBubbleView localQQWalletTransferBubbleView = (QQWalletTransferBubbleView)paramView.a.findViewById(2131379267);
      int m = Color.rgb(255, 170, 57);
      if (!paramChatMessage.isSend())
      {
        bool1 = true;
        localQQWalletTransferBubbleView.setBubbleBackground(2130846329, m, bool1);
      ...
      {
        paramBaseChatItemLayout.setBubbleBackground(2130846330, m, bool1);
        if (jdField_e_of_type_Boolean) {
          paramView.a.setContentDescription(paramacuj.subTitle + paramacuj.title);
        }
        paramView.a.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
        paramView.a.setOnLongClickListener(paramacxj);
        paramView.a.setOnTouchListener(paramacxj);
        return paramView.a;
        bool1 = false;
        break;
      }
  ...
  public void a(int paramInt, Context paramContext, ChatMessage paramChatMessage)
  {
    ...
    default: 
      ...
      return;
    case 2131364984: 
      aanz.b(this.b, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage);
      return;
    }
  ...
  public bbmh[] a(View paramView)
  {
    ...
    aanz.a(localbbmf, this.b, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a);
