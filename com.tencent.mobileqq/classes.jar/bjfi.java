...
public class bjfi
{
  private static volatile bjfi jdField_a_of_type_Bjfi;
  public static boolean a;
  private long jdField_a_of_type_Long;
  private String jdField_a_of_type_JavaLangString;
  private WeakReference<View> jdField_a_of_type_JavaLangRefWeakReference;
  private WtloginObserver jdField_a_of_type_MqqObserverWtloginObserver = new bjfk(this);
  ...
  public static bjfi a()
  {
    if (jdField_a_of_type_Bjfi == null) {}
    try
    {
      if (jdField_a_of_type_Bjfi == null) {
        jdField_a_of_type_Bjfi = new bjfi();
      }
      return jdField_a_of_type_Bjfi;
    }
    finally {}
  }
  ...
  private void a()
  {
    ...
    {
      if (i != 0) {
        QIPCServerHelper.getInstance().register(new bjfj(this, "QR_LOGIN_QIPC_MODULE_NAME"));
      }
      return;
      i = 0;
    }
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    for (paramArrayOfByte = new String(paramArrayOfByte);; paramArrayOfByte = anvx.a(2131710647))
    {
