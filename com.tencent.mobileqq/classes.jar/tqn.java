...
public class tqn
{
  ...
  public tqq a()
  {
    return this.jdField_a_of_type_Tqq;
  }
  ...
  public void a(ReadInjoyCutImageView paramReadInjoyCutImageView, tth paramtth1, tth paramtth2, int paramInt1, int paramInt2, long paramLong)
  {
    ...
    int j;
    int i;
    if (paramtth1.a == paramtth2.a)
    {
      paramtth1.b = Math.abs(paramtth1.b);
      paramtth2.b = Math.abs(paramtth2.b);
      if (paramtth1.b > paramtth2.b) {
        paramtth1.a(paramtth2);
      }
      localArrayList1.add(new tth(0.0F, 0.0F));
      localArrayList1.add(paramtth1);
      localArrayList1.add(paramtth2);
      localArrayList1.add(new tth(0.0F, 1.0F));
      localArrayList1.add(new tth(0.0F, 0.0F));
      localArrayList2.add(paramtth1);
      localArrayList2.add(new tth(1.0F, 0.0F));
      localArrayList2.add(new tth(1.0F, 1.0F));
      localArrayList2.add(paramtth2);
      localArrayList2.add(paramtth1);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new tqo(this, f1, f2, f3, f4, paramReadInjoyCutImageView));
        this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new tqp(this, paramReadInjoyCutImageView));
        return;
        if (paramtth1.b == paramtth2.b)
        {
          paramtth1.b = Math.abs(paramtth1.b);
          ...
          localArrayList1.add(new tth(0.0F, 0.0F));
          localArrayList1.add(new tth(1.0F, 0.0F));
          localArrayList1.add(paramtth2);
          localArrayList1.add(paramtth1);
          localArrayList1.add(new tth(0.0F, 0.0F));
          localArrayList2.add(paramtth1);
          localArrayList2.add(paramtth2);
          localArrayList2.add(new tth(1.0F, 1.0F));
          localArrayList2.add(new tth(0.0F, 1.0F));
          localArrayList2.add(paramtth1);
          if ((paramInt1 != 5) || (paramInt2 != 5)) {
            break label2147;
          }
        ...
        f2 = (paramtth2.b - paramtth1.b) / (paramtth2.a - paramtth1.a);
        f3 = (paramtth2.b + paramtth1.b - (paramtth2.a + paramtth1.a) * f2) / 2.0F;
        paramtth1.b = Math.abs(paramtth1.b);
        paramtth2.b = Math.abs(paramtth2.b);
        if (f2 > 0.0F)
        {
          ...
          localArrayList1.add(new tth(0.0F, 0.0F));
          localArrayList2.add(new tth(paramtth1));
          localtth = new tth(1.0F, 0.0F);
          if (localtth.b > localtth.a * f2 + f3)
          {
            localArrayList1.add(localtth);
            label795:
            localArrayList1.add(paramtth1);
            localArrayList2.add(new tth(1.0F, 1.0F));
            localArrayList1.add(paramtth2);
            localtth = new tth(0.0F, 1.0F);
            if (-localtth.b <= localtth.a * f2 + f3) {
              break label1133;
            }
            localArrayList1.add(localtth);
          ...
          {
            localArrayList2.add(paramtth2);
            localArrayList1.add(new tth((tth)localArrayList1.get(0)));
            localArrayList2.add(new tth((tth)localArrayList2.get(0)));
            i = i1;
            j = n;
            f1 = f2;
            m = paramInt1;
        ...
        localArrayList2.add(paramtth1);
        tth localtth = new tth(0.0F, 0.0F);
        if (localtth.b < localtth.a * f2 + f3)
        {
          localArrayList1.add(localtth);
          label1207:
        ...
        localPoint1.x = ((int)(Math.max(paramtth1.a, paramtth2.a) * paramReadInjoyCutImageView.getWidth()));
        localPoint1.y = 0;
        localPoint2.x = 0;
        localPoint2.y = 0;
        break label280;
        f2 = Math.max(paramtth1.a, paramtth2.a);
        localPoint1.x = 0;
        localPoint1.y = 0;
        localPoint2.x = ((int)(f2 * paramReadInjoyCutImageView.getWidth()));
        localPoint2.y = 0;
        break label280;
        f2 = Math.min(paramtth1.b, paramtth2.b);
        f3 = Math.max(paramtth1.b, paramtth2.b);
        if ((i != 0) || (j != 0) || (f1 > 0.0F)) {}
        ...
        f2 = Math.min(paramtth1.b, paramtth2.b);
        localPoint1.y = ((int)(Math.max(paramtth1.b, paramtth2.b) * paramReadInjoyCutImageView.getHeight()));
        localPoint1.x = 0;
        if ((i != 0) || (j != 0) || (f1 > 0.0F)) {}
        for (paramInt1 = 0;; paramInt1 = (int)(f2 * paramReadInjoyCutImageView.getHeight()))
        {
        ...
        f1 = Math.min(paramtth1.a, paramtth2.a);
        localPoint3.x = paramReadInjoyCutImageView.getWidth();
        localPoint3.y = 0;
        localPoint4.x = ((int)(f1 * paramReadInjoyCutImageView.getWidth()));
        localPoint4.y = 0;
        continue;
        localPoint3.x = ((int)(Math.min(paramtth1.a, paramtth2.a) * paramReadInjoyCutImageView.getWidth()));
        localPoint3.y = 0;
        localPoint4.x = paramReadInjoyCutImageView.getWidth();
        localPoint4.y = 0;
      }
      float f2 = Math.min(paramtth1.b, paramtth2.b);
      float f3 = Math.max(paramtth1.b, paramtth2.b);
