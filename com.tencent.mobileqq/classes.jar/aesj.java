...
public abstract class aesj
{
  public aese a;
  protected aesm a;
  protected ajqt a;
  private ajuc jdField_a_of_type_Ajuc = new aesl(this);
  protected Context a;
  protected TextView a;
  private begh jdField_a_of_type_Begh = new aesk(this);
  ...
  public aesj(QQAppInterface paramQQAppInterface, Context paramContext, XListView paramXListView, aesm paramaesm)
  {
    this.jdField_a_of_type_Boolean = true;
  ...
  {
    g();
    this.jdField_a_of_type_Aese = a();
    this.jdField_a_of_type_Aese.a(null);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Aese);
  ...
  private void g()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(ajjy.a(2131647470));
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131101336));
  ...
  private void h()
  {
    ...
    if (a()) {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(ajjy.a(2131647471));
    }
  }
  
  protected abstract aese a();
  ...
  {
    Object localObject = akfu.a("recommend_troop");
    double d1;
    int k;
    double d2;
    String str;
    ...
    ((oidb_0x935.GPS)localObject).bytes_client_version.set(ByteStringMicro.copyFromUtf8("8.2.6"));
  ...
  {
    this.jdField_a_of_type_Ajqt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getLongAccountUin(), a());
  }
  ...
  protected boolean a()
  {
    return this.jdField_a_of_type_Ajqt.a == 1;
  }
  ...
  protected void c()
  {
    this.jdField_a_of_type_Aese.a(this.jdField_a_of_type_Ajqt.b);
