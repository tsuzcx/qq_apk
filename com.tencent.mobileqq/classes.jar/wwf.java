...
class wwf
  implements xro
{
  wwf(wwe paramwwe, wlc paramwlc) {}
  
  public void a(String paramString, Bitmap paramBitmap)
  {
    paramString = BaseApplicationImpl.getContext();
    Object localObject = new PollContainerLayout(paramString);
    ((PollContainerLayout)localObject).a(this.jdField_a_of_type_Wlc, -1, null);
    ...
    if (zdr.a((Bitmap)localObject, paramString)) {
      this.jdField_a_of_type_Wwe.a("result", new File(paramString).toURI().toString());
    }
    for (;;)
    {
      ((Bitmap)localObject).recycle();
      wwe.a(this.jdField_a_of_type_Wwe, true);
      return;
      this.jdField_a_of_type_Wwe.a("result", this.jdField_a_of_type_Wwe.a.mVideoThumbnailUrl);
    }
  }
  ...
  {
    this.jdField_a_of_type_Wwe.a("result", this.jdField_a_of_type_Wwe.a.mVideoThumbnailUrl);
    wwe.b(this.jdField_a_of_type_Wwe, true);
  }
}
