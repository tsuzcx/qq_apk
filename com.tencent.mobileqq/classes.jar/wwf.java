  ...
  extends wwi
{
  ...
  private View.OnFocusChangeListener jdField_a_of_type_AndroidViewView$OnFocusChangeListener = new wwh(this);
  View jdField_a_of_type_AndroidViewView;
  private CompoundButton.OnCheckedChangeListener jdField_a_of_type_AndroidWidgetCompoundButton$OnCheckedChangeListener = new wwg(this);
  ...
  public wwf(GoldMsgSettingActivity paramGoldMsgSettingActivity, Context paramContext, Intent paramIntent, String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    this.jdField_a_of_type_JavaLangString = String.format(paramContext.getString(2131432285), new Object[] { NumAnim.formatNumber(this.jdField_b_of_type_Long / 100.0D, false) });
    this.jdField_b_of_type_JavaLangString = String.format(paramContext.getString(2131432284), new Object[] { NumAnim.formatNumber(this.jdField_a_of_type_Long / 100.0D, false) });
  ...
  private void a(boolean paramBoolean)
  {
    ...
    label82:
    label87:
    for (int i = 2131432292;; i = 2131432289)
    {
  ...
  private boolean b()
  {
    ...
    if ((!this.jdField_b_of_type_Boolean) && (bool)) {
      localQQToast1 = QQToast.a(this.jdField_a_of_type_AndroidContentContext, 2131432297, 0);
    }
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        {
          localQQToast2 = QQToast.a(this.jdField_a_of_type_AndroidContentContext, 2131432271, 0);
        }
        break;
  ...
  {
    long l2 = 1L;
    this.jdField_a_of_type_ComTencentMobileqqActivityQwalletWidgetValueSelector = ((ValueSelector)this.jdField_a_of_type_ComTencentMobileqqActivityQwalletGoldMsgSettingActivity.findViewById(2131364716));
    ...
    for (long l1 = paramView.jdField_a_of_type_Long;; l1 = 1L)
    {
      ...
      this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqActivityQwalletGoldMsgSettingActivity.findViewById(2131364717);
      this.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem = ((FormSwitchItem)this.jdField_a_of_type_ComTencentMobileqqActivityQwalletGoldMsgSettingActivity.findViewById(2131364719));
      this.jdField_a_of_type_ComTencentMobileqqWidgetFormEditItem = ((FormEditItem)this.jdField_a_of_type_ComTencentMobileqqActivityQwalletGoldMsgSettingActivity.findViewById(2131364720));
      ...
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_ComTencentMobileqqActivityQwalletGoldMsgSettingActivity.findViewById(2131364722));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_ComTencentMobileqqActivityQwalletGoldMsgSettingActivity.findViewById(2131364721));
      if (this.e)
      {
  ...
  void a(boolean paramBoolean, GoldMsgSetReq paramGoldMsgSetReq, GoldMsgSetRsp paramGoldMsgSetRsp)
  {
    ...
    if (paramBoolean)
    {
      ...
      label139:
      for (int i = 2131432298;; i = 2131432299)
      {
    ...
    QQToast.a(this.jdField_a_of_type_AndroidContentContext, 2131432272, 0).a();
  }
