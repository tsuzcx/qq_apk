  ...
  extends bjbv
{
  ...
  private bjcz jdField_a_of_type_Bjcz;
  ...
  public List<bjcz> a;
  private bjcz jdField_b_of_type_Bjcz;
  protected Object b;
  String d;
  String e;
  ...
  static
  {
    ...
    File localFile = new File(ahvy.d);
    h = localFile.getPath();
  ...
  private ArrayList<bjcz> a(ArrayList<bjcz> paramArrayList)
  {
    ArrayList localArrayList = new ArrayList();
    paramArrayList = paramArrayList.iterator();
    while (paramArrayList.hasNext())
    {
      bjcz localbjcz = b((bjcz)paramArrayList.next());
      if ((localbjcz != null) && (localbjcz.jdField_a_of_type_JavaUtilList.size() > 0)) {
        localArrayList.add(localbjcz);
  ...
  public static List<bjcz> a(bkzp parambkzp, String paramString)
  {
      ...
      try
      {
        ...
        if (parambkzp != null)
        {
          if (((JSONObject)localObject).has("guide_video_url")) {
            parambkzp.d = ((JSONObject)localObject).getString("guide_video_url");
          }
          if (((JSONObject)localObject).has("guide_video_md5")) {
            parambkzp.e = ((JSONObject)localObject).getString("guide_video_md5");
          }
        }
        ...
        parambkzp = paramString.optString("bighead_model_resurl", "");
        ...
        a((List)localObject, str, parambkzp, paramString);
        return localObject;
      }
      catch (JSONException parambkzp) {}
      if (!QLog.isColorLevel()) {
        break;
      }
      parambkzp.printStackTrace();
      return null;
      label152:
      String str = "";
      paramString = "";
  ...
  static List<bjcz> a(JSONArray paramJSONArray)
  {
      ...
      if (j < k) {
        try
        {
          ...
          if (((JSONObject)localObject).has("content")) {
            localbjcz.jdField_a_of_type_JavaUtilList = PtvTemplateManager.PtvTemplateInfo.convertFrom(((JSONObject)localObject).getJSONArray("content"));
          }
          if (((JSONObject)localObject).has("categoryName")) {
            localbjcz.jdField_a_of_type_JavaLangString = ((JSONObject)localObject).getString("categoryName");
          }
          if ((((JSONObject)localObject).has("TipsVer")) && (((JSONObject)localObject).has("Tips")))
          {
            localbjcz.jdField_b_of_type_Int = ((JSONObject)localObject).getInt("TipsVer");
            localbjcz.jdField_b_of_type_JavaLangString = ((JSONObject)localObject).getString("Tips");
          }
          localbjcz.jdField_b_of_type_Boolean = "1".equals(((JSONObject)localObject).optString("random_position"));
          if (((JSONObject)localObject).has("categoryId"))
          {
            localbjcz.jdField_a_of_type_Int = ((JSONObject)localObject).getInt("categoryId");
            if ((localbjcz.jdField_a_of_type_JavaUtilList != null) && (!localbjcz.jdField_a_of_type_JavaUtilList.isEmpty()))
            {
              localObject = localbjcz.jdField_a_of_type_JavaUtilList.iterator();
              while (((Iterator)localObject).hasNext())
              {
                ((PtvTemplateManager.PtvTemplateInfo)((Iterator)localObject).next()).categoryId = localbjcz.jdField_a_of_type_Int;
                continue;
                return localArrayList;
              }
            }
  ...
  private static void a(List<bjcz> paramList, String paramString1, String paramString2, String paramString3)
  {
    ...
    {
      Object localObject = (bjcz)paramList.next();
      if ((((bjcz)localObject).jdField_a_of_type_JavaUtilList == null) || (((bjcz)localObject).jdField_a_of_type_JavaUtilList.size() <= 0)) {
        break;
      }
      localObject = ((bjcz)localObject).jdField_a_of_type_JavaUtilList.iterator();
      while (((Iterator)localObject).hasNext())
      {
        ...
        for (;;)
        {
          ...
          if (((File)localObject).exists()) {
            ...
            catch (UnsatisfiedLinkError paramString1)
            {
              try
              {
                nav.a(new File(jdField_b_of_type_JavaIoFile, paramString1), jdField_a_of_type_JavaLangString);
                return true;
              }
  ...
  private boolean b()
  {
    return (this.jdField_a_of_type_Bjcz != null) && (this.jdField_a_of_type_Bjcz.jdField_a_of_type_JavaUtilList.size() >= 100);
  }
  ...
  public bjcz a(bjcz parambjcz)
  {
    ...
    for (;;)
    {
      ...
      {
        parambjcz.jdField_a_of_type_JavaUtilList.clear();
        ...
        if (parambjcz.jdField_a_of_type_JavaUtilList.size() >= 100) {
          return parambjcz;
        }
      }
      parambjcz.jdField_a_of_type_JavaUtilList.add(localObject2);
      break label216;
      label212:
      return parambjcz;
      label216:
    ...
    do
    {
      ...
      while (!((Iterator)localObject).hasNext())
      {
        do
        {
          ...
          localObject = (bjcz)localIterator.next();
        } while ((localObject == null) || (((bjcz)localObject).jdField_a_of_type_JavaUtilList == null) || (((bjcz)localObject).jdField_a_of_type_Int != bjbe.jdField_b_of_type_Int));
        localObject = ((bjcz)localObject).jdField_a_of_type_JavaUtilList.iterator();
      }
      localPtvTemplateInfo = (PtvTemplateManager.PtvTemplateInfo)((Iterator)localObject).next();
    } while (!localPtvTemplateInfo.id.equals(bjbe.jdField_b_of_type_JavaLangString));
    if (QLog.isColorLevel()) {
  ...
  public PtvTemplateManager.PtvTemplateInfo a(String paramString)
  {
    ...
    do
    {
      ...
      while (!localIterator2.hasNext())
      {
        ...
        localIterator2 = ((bjcz)localIterator1.next()).jdField_a_of_type_JavaUtilList.iterator();
      }
  ...
  public ArrayList<bjcz> a(boolean paramBoolean)
  {
    ArrayList localArrayList = a(a());
    synchronized (this.jdField_b_of_type_JavaLangObject)
    {
      if (this.jdField_a_of_type_Bjcz == null)
      {
        this.jdField_a_of_type_Bjcz = new bjcz(ajya.a(2131709830));
        this.jdField_a_of_type_Bjcz.jdField_a_of_type_JavaUtilList = new ArrayList(100);
      }
      if (paramBoolean) {
        a(this.jdField_a_of_type_Bjcz);
      }
      jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(true);
      this.jdField_b_of_type_Bjcz = b(this.jdField_a_of_type_Bjcz);
      localArrayList.add(0, this.jdField_b_of_type_Bjcz);
      if (QLog.isColorLevel()) {
  ...
  public List<bjcz> a()
  {
    ...
    {
      bjcz localbjcz = (bjcz)localIterator.next();
      if (localbjcz.jdField_a_of_type_Boolean) {
        localArrayList.add(localbjcz);
      }
    }
    return localArrayList;
  ...
  public List<bjcz> a(File paramFile)
  {
    if (QLog.isColorLevel()) {
    ...
    while (localIterator.hasNext())
    {
      Object localObject = (bjcz)localIterator.next();
      if ((((bjcz)localObject).jdField_a_of_type_JavaUtilList != null) && (((bjcz)localObject).jdField_a_of_type_JavaUtilList.size() != 0))
      {
        localObject = ((bjcz)localObject).jdField_a_of_type_JavaUtilList.iterator();
        while (((Iterator)localObject).hasNext())
  ...
  public void a(AppInterface paramAppInterface, PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo, bkzm parambkzm)
  {
    ...
    b(paramAppInterface, paramPtvTemplateInfo, parambkzm);
  }
  ...
  public void a(PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo, int paramInt)
  {
    for (;;)
    {
      ...
      synchronized (this.jdField_b_of_type_JavaLangObject)
      {
        if (this.jdField_a_of_type_Bjcz == null)
        {
          this.jdField_a_of_type_Bjcz = new bjcz(ajya.a(2131709833));
          this.jdField_a_of_type_Bjcz.jdField_a_of_type_JavaUtilList = new ArrayList(100);
          a(this.jdField_a_of_type_Bjcz);
        }
        if (this.jdField_b_of_type_Bjcz == null) {
          this.jdField_b_of_type_Bjcz = this.jdField_a_of_type_Bjcz.a();
        }
        j = a(this.jdField_a_of_type_Bjcz.jdField_a_of_type_JavaUtilList, paramPtvTemplateInfo.id);
        if (j == -1)
        {
          if (!b())
          {
            this.jdField_a_of_type_Bjcz.jdField_a_of_type_JavaUtilList.add(0, paramPtvTemplateInfo);
            this.jdField_b_of_type_Bjcz.jdField_a_of_type_JavaUtilList.add(0, paramPtvTemplateInfo);
            if (this.jdField_a_of_type_Axgj != null) {
              this.jdField_a_of_type_Axgj.a(paramInt, new Object[] { this.jdField_b_of_type_Bjcz });
            }
            if (QLog.isColorLevel()) {
          ...
          PtvTemplateManager.PtvTemplateInfo localPtvTemplateInfo = (PtvTemplateManager.PtvTemplateInfo)this.jdField_a_of_type_Bjcz.jdField_a_of_type_JavaUtilList.remove(99);
          this.jdField_a_of_type_Bjcz.jdField_a_of_type_JavaUtilList.add(0, paramPtvTemplateInfo);
          this.jdField_b_of_type_Bjcz.jdField_a_of_type_JavaUtilList.remove(localPtvTemplateInfo);
          this.jdField_b_of_type_Bjcz.jdField_a_of_type_JavaUtilList.add(0, paramPtvTemplateInfo);
          if (this.jdField_a_of_type_Axgj == null) {
            continue;
          }
      ...
      if (j != 0)
      {
        this.jdField_a_of_type_Bjcz.jdField_a_of_type_JavaUtilList.remove(j);
        this.jdField_a_of_type_Bjcz.jdField_a_of_type_JavaUtilList.add(0, paramPtvTemplateInfo);
      }
    }
  }
  ...
  {
    bjbe.jdField_b_of_type_JavaLangString = paramString1;
    bjbe.jdField_b_of_type_Int = paramInt;
    bjbe.jdField_a_of_type_JavaLangString = paramString2;
  ...
  public void a(List<bjcz> paramList)
  {
    ...
    Object localObject = (bjcz)paramList.next();
    ArrayList localArrayList = new ArrayList();
    localArrayList.addAll(((bjcz)localObject).jdField_a_of_type_JavaUtilList);
    int j = 0;
    label63:
  ...
  protected bjcz b(bjcz parambjcz)
  {
    if (parambjcz == null) {
      return null;
    }
    Object localObject = (bigy)bjav.a().c(13);
    parambjcz = parambjcz.a();
    if ((localObject == null) || (!((bigy)localObject).a())) {
      return parambjcz;
    }
    localObject = parambjcz.jdField_a_of_type_JavaUtilList.iterator();
    while (((Iterator)localObject).hasNext())
    {
      PtvTemplateManager.PtvTemplateInfo localPtvTemplateInfo = (PtvTemplateManager.PtvTemplateInfo)((Iterator)localObject).next();
  ...
  public void b()
  {
    this.jdField_a_of_type_Bjcz = null;
    if (QLog.isColorLevel()) {
      QLog.d("QIMPtvTemplateManager", 2, "QIMPtvTemplateManager onDestroy");
    }
  }
  
  public void b(AppInterface paramAppInterface, PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo, bkzm parambkzm)
  {
    ...
    for (;;)
    {
      ...
      localayrx.jdField_a_of_type_Aysc = new bkzr(this, paramPtvTemplateInfo, parambkzm);
      ...
      localayrx.jdField_c_of_type_JavaLangString = new File(jdField_b_of_type_JavaIoFile, paramPtvTemplateInfo.name).getPath();
  ...
  public void f()
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
        } while ((this.jdField_a_of_type_Bjcz.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_Bjcz.jdField_a_of_type_JavaUtilList.isEmpty()));
        localStringBuilder = new StringBuilder();
        localObject1 = this.jdField_a_of_type_Bjcz.jdField_a_of_type_JavaUtilList.iterator();
