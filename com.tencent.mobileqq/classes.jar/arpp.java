  ...
  implements arpn
{
  ...
  private void a()
  {
    ...
    {
      arni.a(localQQAppInterface, this.jdField_c_of_type_Long, "actFileUfAppBabySdkDownload", this.jdField_a_of_type_Long, "", "", "", "", 1, str, 0L, h() * this.b, this.b, this.jdField_c_of_type_JavaLangString, "", 0, str, null);
      arni.a(localQQAppInterface, this.jdField_c_of_type_Long, "actFileUfAppBabySdkDownloadDetail", this.jdField_a_of_type_Long, "", "", "", "", 1, str, 0L, h() * this.b, this.b, this.jdField_c_of_type_JavaLangString, "", 0, str, null);
  ...
  private int i()
  {
    int i = arps.a().a(this.jdField_c_of_type_Long, this.jdField_c_of_type_JavaLangString, this.b, new arpq(this));
    if (i == 0) {
      a(true);
    }
    return i;
  ...
  public int a()
  {
    ...
    QQAppInterface localQQAppInterface = aqwa.a().a();
    if (localQQAppInterface != null) {
      azmy.a(localQQAppInterface.getApplication().getApplicationContext(), localQQAppInterface.getCurrentAccountUin(), "Start_download_2-3_3-0");
    }
    if (!a())
    {
    ...
    if (!bdee.d(BaseApplication.getContext()))
    {
      ...
      if (localQQAppInterface != null)
      {
        arni.a(localQQAppInterface, this.jdField_c_of_type_Long, "actFileUfAppBabySdkDownload", this.jdField_a_of_type_Long, "", "", "", "", 2, str, 0L, h() * this.b, this.b, this.jdField_c_of_type_JavaLangString, "", 0, str, null);
        arni.a(localQQAppInterface, this.jdField_c_of_type_Long, "actFileUfAppBabySdkDownloadDetail", this.jdField_a_of_type_Long, "", "", "", "", 2, str, 0L, h() * this.b, this.b, this.jdField_c_of_type_JavaLangString, "", 0, str, null);
        azmy.a(localQQAppInterface.getApplication().getApplicationContext(), localQQAppInterface.getCurrentAccountUin(), "Stop_download_2-0_3-0");
      }
      for (;;)
      {
        if (this.jdField_a_of_type_Arpo != null) {
          this.jdField_a_of_type_Arpo.a(2, str, null);
        }
        return -1;
    ...
    for (;;)
    {
      j = arps.a().a(this.jdField_c_of_type_JavaLangString);
      if (j != 0) {
        break;
      }
      ...
      c(2);
      return j;
      if ((6 == i) && (!arps.a().a(this.jdField_c_of_type_JavaLangString)))
      {
    ...
    if (localQQAppInterface != null)
    {
      arni.a(localQQAppInterface, this.jdField_c_of_type_Long, "actFileUfAppBabySdkDownload", this.jdField_a_of_type_Long, "", "", "", "", 5, str, 0L, h() * this.b, this.b, this.jdField_c_of_type_JavaLangString, "", 0, str, null);
      arni.a(localQQAppInterface, this.jdField_c_of_type_Long, "actFileUfAppBabySdkDownloadDetail", this.jdField_a_of_type_Long, "", "", "", "", 5, str, 0L, h() * this.b, this.b, this.jdField_c_of_type_JavaLangString, "", 0, str, null);
      azmy.a(localQQAppInterface.getApplication().getApplicationContext(), localQQAppInterface.getCurrentAccountUin(), "Stop_download_2-0_3-0");
    }
    for (;;)
    {
      ...
      this.jdField_a_of_type_Arpo.a(5, null, null);
      return j;
      QLog.w(jdField_a_of_type_JavaLangString, 1, "[UniformDL][" + this.jdField_c_of_type_Long + "].report failed - 8");
    }
  }
  ...
  public int b()
  {
    ...
    c(7);
    return arps.a().c(this.jdField_c_of_type_JavaLangString);
  }
  ...
  public int c()
  {
    ...
    int j = arps.a().b(this.jdField_c_of_type_JavaLangString);
    if (j == 0)
    {
    ...
    c(5);
    String str = arpl.a(15);
    QQAppInterface localQQAppInterface = aqwa.a().a();
    if (localQQAppInterface != null)
    {
      arni.a(localQQAppInterface, this.jdField_c_of_type_Long, "actFileUfAppBabySdkDownload", this.jdField_a_of_type_Long, "", "", "", "", 15, str, 0L, h() * this.b, this.b, this.jdField_c_of_type_JavaLangString, "", 0, str, null);
      arni.a(localQQAppInterface, this.jdField_c_of_type_Long, "actFileUfAppBabySdkDownloadDetail", this.jdField_a_of_type_Long, "", "", "", "", 15, str, 0L, h() * this.b, this.b, this.jdField_c_of_type_JavaLangString, "", 0, str, null);
      azmy.a(localQQAppInterface.getApplication().getApplicationContext(), localQQAppInterface.getCurrentAccountUin(), "Stop_download_2-0_3-0");
    }
    for (;;)
    {
      ...
      this.jdField_a_of_type_Arpo.a(15, null, null);
      return j;
      QLog.w(jdField_a_of_type_JavaLangString, 1, "[UniformDL][" + this.jdField_c_of_type_Long + "].report failed - 8");
    }
  }
