...
public class aggi
{
  ...
  /* Error */
  public static aggc a(java.lang.String paramString)
  {
    // Byte code:
    //   0: aload_0
    ...
    //   212: aload 9
    //   214: iconst_0
    //   215: invokestatic 129	aggi:a	([BI)I
    //   218: istore_3
    //   219: iload_3
    //   220: ifle +10 -> 230
    //   223: iload_3
    ...
    //   555: new 149	aggc
    //   558: dup
    //   559: invokespecial 150	aggc:<init>	()V
    //   562: astore_0
    //   563: aload 7
    //   565: astore 6
    //   567: aload_0
    //   568: aload 8
    //   570: invokestatic 153	aggi:a	(Laggc;Lmsg/aio_doodle/DoodleMsgProto$DoodleHeader;)V
    //   573: aconst_null
    //   574: astore 8
    //   576: iconst_m1
    //   577: istore_3
    ...
    //   597: aload 9
    //   599: iconst_0
    //   600: invokestatic 129	aggi:a	([BI)I
    //   603: istore 4
    //   605: iload 4
    //   607: ifle +11 -> 618
    //   610: iload 4
    ...
    //   670: iconst_1
    //   671: iconst_0
    //   672: invokevirtual 158	aggc:a	(Laghm;ZZ)V
    //   675: aload 7
    //   677: astore 6
    //   679: aload 7
    ...
    //   713: ifnull -703 -> 10
    //   716: aload_0
    //   717: invokevirtual 163	aggc:a	()Laggv;
    //   720: invokevirtual 168	aggv:d	()F
    //   723: fstore_1
    //   724: aload_0
    //   725: invokevirtual 163	aggc:a	()Laggv;
    //   728: invokevirtual 171	aggv:c	()F
    //   731: fstore_2
    //   732: fload_1
    //   733: fload_2
    //   734: fcmpl
    //   735: ifle +19 -> 754
    //   738: aload_0
    //   739: invokevirtual 163	aggc:a	()Laggv;
    //   742: fload_1
    //   743: invokevirtual 174	aggv:c	(F)V
    //   746: aload_0
    //   747: invokevirtual 163	aggc:a	()Laggv;
    //   750: fload_2
    //   751: invokevirtual 176	aggv:d	(F)V
    //   754: aload_0
    //   755: invokestatic 179	aggi:a	(Laggc;)V
    //   758: aload_0
    //   759: areturn
    //   760: aload 7
    //   762: astore 6
    ...
    //   989: astore 6
    //   991: aload 10
    //   993: invokestatic 188	aggi:a	(Lmsg/aio_doodle/DoodleMsgProto$DoodleData;)I
    //   996: istore 4
    //   998: aload 7
    //   1000: astore 6
    //   1002: ldc 76
    ...
    //   1159: aload 10
    //   1161: iload 5
    //   1163: invokestatic 197	aggi:a	(Laghm;Lmsg/aio_doodle/DoodleMsgProto$DoodleData;Z)V
    //   1166: goto -588 -> 578
    //   1169: aload 8
    //   1171: ifnull +15 -> 1186
    //   1174: aload 7
    ...
    //   1181: iconst_1
    //   1182: iconst_0
    //   1183: invokevirtual 158	aggc:a	(Laghm;ZZ)V
    //   1186: aload 7
    //   1188: astore 6
    //   1190: new 199	aghm
    //   1193: dup
    //   1194: invokespecial 200	aghm:<init>	()V
    //   1197: astore 8
    //   1199: aload 7
    //   1201: astore 6
    //   1203: aload 8
    //   1205: iload 4
    //   1207: putfield 203	aghm:a	I
    //   1210: iconst_1
    //   1211: istore 5
    //   1213: iload 4
    //   1215: istore_3
  ...
  private static DoodleMsgProto.DoodleData a(int paramInt, aghm paramaghm)
  {
  ...
  private static void a(aggc paramaggc)
  {
    if (paramaggc == null) {}
    ...
    {
      return;
      Iterator localIterator1 = paramaggc.a().iterator();
      while (localIterator1.hasNext())
      {
        aghm localaghm = (aghm)localIterator1.next();
        if (localaghm.c() >= 500)
        {
          if (QLog.isColorLevel()) {
            QLog.d("DoodleMsgTranslator", 2, "reduce point before:" + localaghm.c());
          }
          paramaggc = null;
          localIterator2 = localaghm.a().iterator();
          if (localIterator2.hasNext())
          {
            localaghn = (aghn)localIterator2.next();
            if (localIterator2.hasNext()) {
              break label157;
            }
          }
          if (QLog.isColorLevel()) {
            QLog.d("DoodleMsgTranslator", 2, "reduce point end:" + localaghm.c());
          }
        }
      }
    }
    ...
    {
      break;
      if ((Math.abs(localaghn.a() - paramaggc.a()) < 10.0F) && (Math.abs(localaghn.b() - paramaggc.b()) < 10.0F)) {
        localIterator2.remove();
      }
    }
  }
  
  private static void a(aggc paramaggc, DoodleMsgProto.DoodleHeader paramDoodleHeader)
  {
    if ((paramaggc == null) || (paramDoodleHeader == null)) {}
    do
    {
      return;
      BaseApplication localBaseApplication = BaseApplicationImpl.getContext();
      if ((paramDoodleHeader.float_draw_area_width.has()) && (paramDoodleHeader.float_draw_area_height.has())) {
        paramaggc.a().a((int)mue.a(localBaseApplication, paramDoodleHeader.float_draw_area_width.get()), (int)mue.a(localBaseApplication, paramDoodleHeader.float_draw_area_height.get()));
      }
      if (paramDoodleHeader.float_line_width_max.has()) {
        paramaggc.a().a(mue.a(localBaseApplication, paramDoodleHeader.float_line_width_max.get()));
      }
      if (paramDoodleHeader.float_line_width_min.has()) {
        paramaggc.a().b(mue.a(localBaseApplication, paramDoodleHeader.float_line_width_min.get()));
      }
      if (paramDoodleHeader.float_comp_factor_max.has()) {
        paramaggc.a().c(paramDoodleHeader.float_comp_factor_max.get());
      }
      if (paramDoodleHeader.float_comp_factor_min.has()) {
        paramaggc.a().d(paramDoodleHeader.float_comp_factor_min.get());
      }
    } while (!paramDoodleHeader.uint32_time.has());
    paramaggc.a(paramDoodleHeader.uint32_time.get());
  }
  
  private static void a(aghm paramaghm, DoodleMsgProto.DoodleData paramDoodleData, boolean paramBoolean)
  {
    if ((paramaghm == null) || (paramDoodleData == null)) {}
    for (;;)
    {
      return;
      if (paramBoolean)
      {
        if (paramDoodleData.uint32_rgba.has()) {
          paramaghm.b(paramDoodleData.uint32_rgba.get());
        }
        if (paramDoodleData.uint32template_id.has())
        {
          paramaghm.a(paramDoodleData.uint32template_id.get());
          if (paramaghm.a() > 0) {
            paramaghm.b(-1);
          }
        }
        ...
        if (paramDoodleData != null)
        {
          ...
          while (paramDoodleData.hasNext())
          {
            ...
            if ((localLineData.float_X.has()) && (localLineData.float_Y.has()) && (localLineData.uint64_tickcount.has())) {
              paramaghm.a(mue.a(localBaseApplication, localLineData.float_X.get()), mue.a(localBaseApplication, localLineData.float_Y.get()), -1.0F, localLineData.uint64_tickcount.get());
            }
          }
        }
      }
  ...
  private static boolean a(int paramInt, aghm paramaghm, aggj paramaggj)
  {
    QLog.d("DoodleMsgTranslator", 2, "formatHeader line begin :" + paramInt);
    boolean bool;
    if ((paramaggj == null) || (paramaghm == null))
    {
      bool = false;
      return bool;
    }
    ...
    for (int i = localArrayList.size();; i = 0)
    {
      ...
      bool = true;
      int j = 0;
      DoodleMsgProto.DoodleData localDoodleData = a(paramInt, paramaghm);
      if (localDoodleData == null)
      {
        if (paramaggj == null) {
          break;
        }
        return paramaggj.a(null);
      }
      int k = 0;
      while ((k + j < i) && (k < 1000))
      {
        DoodleMsgProto.LineData localLineData = new DoodleMsgProto.LineData();
        aghn localaghn = (aghn)localArrayList.get(j + k);
        localLineData.float_X.set(a(localBaseApplication, localaghn.a()));
        localLineData.float_X.setHasFlag(true);
        localLineData.float_Y.set(a(localBaseApplication, localaghn.b()));
        localLineData.float_Y.setHasFlag(true);
        localLineData.uint64_tickcount.set(localaghn.a());
      ...
      if (paramaggj != null) {
        if ((paramaggj.a(localDoodleData)) && (bool)) {
          bool = true;
        }
      }
      for (;;)
  ...
  public static boolean a(aggc paramaggc, aggj paramaggj)
  {
    if ((paramaggc == null) || (paramaggj == null)) {}
    do
    {
      do
      {
        return false;
      } while (paramaggc.a() == null);
      try
      {
        boolean bool1 = b(paramaggc, paramaggj);
        paramaggc = paramaggc.a().iterator();
        int i = 0;
        if (paramaggc.hasNext())
        {
          boolean bool2 = a(i, (aghm)paramaggc.next(), paramaggj);
          if ((bool2) && (bool1)) {}
      ...
      catch (Exception paramaggc)
      {
        paramaggc.printStackTrace();
      }
    } while (!QLog.isColorLevel());
    QLog.e("DoodleMsgTranslator", 2, "translate data exception:" + paramaggc);
    return false;
  }
  ...
  public static boolean b(aggc paramaggc, aggj paramaggj)
  {
    boolean bool = false;
    if (paramaggc == null)
    {
      if (paramaggj != null) {
        bool = paramaggj.a(null);
      }
      return bool;
    }
    BaseApplication localBaseApplication = BaseApplicationImpl.getContext();
    ...
    localDoodleHeader.uint32_time.set((int)paramaggc.a());
    localDoodleHeader.uint32_time.setHasFlag(true);
    ArrayList localArrayList = paramaggc.a();
    if (localArrayList != null) {}
    for (int i = localArrayList.size();; i = 0)
    {
      paramaggc = paramaggc.a();
      localDoodleHeader.uint32_line_count.set(i);
      localDoodleHeader.uint32_line_count.setHasFlag(true);
      localDoodleHeader.float_line_width_max.set(a(localBaseApplication, paramaggc.a()));
      localDoodleHeader.float_line_width_max.setHasFlag(true);
      localDoodleHeader.float_line_width_min.set(a(localBaseApplication, paramaggc.b()));
      localDoodleHeader.float_line_width_min.setHasFlag(true);
      localDoodleHeader.float_comp_factor_max.set(paramaggc.c());
      localDoodleHeader.float_comp_factor_max.setHasFlag(true);
      localDoodleHeader.float_comp_factor_min.set(paramaggc.d());
      localDoodleHeader.float_comp_factor_min.setHasFlag(true);
      localDoodleHeader.float_draw_area_width.set(a(localBaseApplication, paramaggc.a().width()));
      localDoodleHeader.float_draw_area_width.setHasFlag(true);
      localDoodleHeader.float_draw_area_height.set(a(localBaseApplication, paramaggc.a().height()));
      localDoodleHeader.float_draw_area_height.setHasFlag(true);
      if (paramaggj == null) {
        break;
      }
      return paramaggj.a(localDoodleHeader);
    }
  }
}
