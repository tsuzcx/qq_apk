...
{
  public aggi(QCallDetailActivity paramQCallDetailActivity, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, int paramInt, ActionSheet paramActionSheet) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        QCallDetailActivity.a(this.jdField_a_of_type_ComTencentMobileqqQcallQCallDetailActivity).a(2131433086, 1);
        return;
      }
      ...
      for (;;)
      {
        ...
        catch (Exception paramView)
        {
          for (;;)
          {
            try
            {
              ...
              paramView.setTitle(2131437791);
              paramView.setMessage(2131437792);
              paramView.setCanceledOnTouchOutside(false);
              localObject = new aggj(this, paramView, l);
              paramView.setNegativeButton(2131437794, (DialogInterface.OnClickListener)localObject);
              paramView.setPositiveButton(2131437793, (DialogInterface.OnClickListener)localObject);
              paramView.show();
            }
            catch (Exception paramView)
            {
        ...
        if (paramInt != 0)
        {
          ...
          if (this.jdField_a_of_type_Boolean)
          {
            if (!this.c)
            {
              ...
              paramView.setMessage(2131437792);
              paramView.setCanceledOnTouchOutside(false);
              localObject = new aggk(this, paramView);
              paramView.setNegativeButton(2131437794, (DialogInterface.OnClickListener)localObject);
              paramView.setPositiveButton(2131437793, (DialogInterface.OnClickListener)localObject);
              paramView.show();
            }
        ...
        else
        {
          ...
          try
          {
            ...
            paramView.setMessage(2131437792);
            paramView.setCanceledOnTouchOutside(false);
            localObject = new aggl(this, paramView, (ShieldMsgManger)localObject, localArrayList);
            paramView.setNegativeButton(2131437794, (DialogInterface.OnClickListener)localObject);
            paramView.setPositiveButton(2131437793, (DialogInterface.OnClickListener)localObject);
            paramView.show();
          }
