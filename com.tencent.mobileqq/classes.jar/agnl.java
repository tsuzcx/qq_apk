...
public class agnl
  implements bfpt
{
  public agnl(PhotoListActivity paramPhotoListActivity) {}
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    Object localObject3;
    Object localObject4;
    switch (this.a.jdField_a_of_type_Agnt.getItemViewType(paramInt))
    {
    default: 
      return;
    case 0: 
      ...
      {
        paramAdapterView = this.a.jdField_a_of_type_Agnt.a(paramInt);
        if ((this.a.I) && (paramAdapterView.mediaWidth > 0) && (paramAdapterView.mediaHeight > 0))
        {
          ...
          {
            bcql.a(this.a, this.a.getResources().getString(2131695167), 0).b(this.a.getResources().getDimensionPixelSize(2131298865));
            return;
          }
          if ((this.a.p > 0) && (paramAdapterView.fileSize > this.a.p))
          {
            bcql.a(this.a, this.a.getResources().getString(2131695172, new Object[] { Integer.valueOf(this.a.p / 1048576) }), 0).b(this.a.getResources().getDimensionPixelSize(2131298865));
            return;
          }
        }
        ...
        {
          this.a.e();
          agmg.a(BaseApplicationImpl.getContext()).a(new agnm(this, paramInt), paramAdapterView);
          return;
        }
      ...
      if ((PhotoListActivity.d(this.a)) && (!PhotoListActivity.jdField_a_of_type_Boolean) && (PhotoListActivity.jdField_a_of_type_JavaUtilHashMap != null))
      {
        ...
        if (k < m)
        {
          ...
          if (bbbx.a((LocalMediaInfo)localObject4) != 0) {
            break label4547;
          }
    ...
    for (;;)
    {
      ...
      paramView.putExtra("PhotoConst.editPathMap", agpk.a(PhotoListActivity.a(this.a)));
      ...
      if (PhotoListActivity.f(this.a))
      {
        ...
        axqy.b(null, "dc00898", "", "", "0X800A06C", "0X800A06C", 3, 0, this.a.jdField_c_of_type_JavaUtilArrayList.size() + "", "", "", "");
      }
      ...
      if ((this.a.jdField_c_of_type_JavaUtilArrayList != null) && (this.a.jdField_c_of_type_JavaUtilArrayList.size() > 0)) {
        axqy.b(null, "CliOper", "", this.a.e, "0X8005674", "0X8005674", 0, this.a.jdField_c_of_type_JavaUtilArrayList.size(), 0, "", "", "", "");
      }
      if (this.a.P) {
      ...
      if (!bbbr.a())
      {
        bcql.a(this.a, this.a.getResources().getString(2131719055), 0).a();
        return;
      }
      paramView = this.a.jdField_a_of_type_Agnt.a(paramInt);
      if (paramView == null) {
        break;
      }
      ...
      while (i != 0)
      {
        ...
        {
          paramAdapterView = ajya.a(2131708093) + paramLong / 60L / 1000L + ajya.a(2131708101);
          bcql.a(this.a, paramAdapterView, 0).b(this.a.e());
          return;
          label1760:
          i = 0;
        }
        else
        {
          ...
          {
            bcql.a(this.a, ajya.a(2131708078) + (float)paramLong / 1024.0F / 1024.0F / 1024.0F + "G的视频", 0).b(this.a.e());
            return;
          }
        }
      }
      ...
      {
        paramAdapterView = bbdj.a(this.a, ajya.a(2131708125));
      ...
      {
        paramAdapterView = bbdj.a(this.a, ajya.a(2131708119));
        paramAdapterView.setPositiveButton(2131694794, new bbdt());
        paramAdapterView.show();
        paramAdapterView = this.a.getIntent().getStringExtra("PhotoConst.INIT_ACTIVITY_CLASS_NAME");
        if (!this.a.H) {
      ...
      localObject3 = bbbx.jdField_c_of_type_JavaUtilHashMap;
      ...
      {
        paramAdapterView = ajya.a(2131708131) + this.a.jdField_d_of_type_Long / 1000L + ajya.a(2131708079);
        bcql.a(this.a, paramAdapterView, 0).b(this.a.e());
      ...
      {
        paramAdapterView = ajya.a(2131708091) + this.a.jdField_c_of_type_Long / 1000L + ajya.a(2131708118);
        bcql.a(this.a, paramAdapterView, 0).b(this.a.e());
        return;
      }
      if (this.a.jdField_b_of_type_Boolean) {
        if ("qzone_plugin.apk".equals(localObject1))
        {
          ...
          if ((this.a.jdField_c_of_type_JavaUtilArrayList != null) && (this.a.jdField_c_of_type_JavaUtilArrayList.size() > 0))
          {
            bcql.a(this.a, ajya.a(2131708111), 0).a();
            this.a.g = false;
            return;
          }
      ...
      while (!this.a.g)
      {
        ...
        {
          this.a.e();
          agmg.a(BaseApplicationImpl.getContext()).a(new agnn(this, paramAdapterView, (ArrayList)localObject1), paramView);
          return;
          label2677:
          this.a.g = false;
          ...
          for (;;)
          {
            ...
            bcql.a(this.a, paramAdapterView.toString(), 0).a();
            return;
        ...
        else
        {
          ...
          {
            this.a.e();
            agmg.a(BaseApplicationImpl.getContext()).a(new agnp(this, paramAdapterView, (ArrayList)localObject1), paramView);
            return;
          }
      ...
      if (((PhotoListActivity.f(this.a)) || (PhotoListActivity.e(this.a)) || (PhotoListActivity.d(this.a)) || (PhotoListActivity.j(this.a)) || (PhotoListActivity.s(this.a)) || (PhotoListActivity.g(this.a)) || (PhotoListActivity.a(this.a))) && ((this.a.K) || (this.a.jdField_b_of_type_Boolean)))
      {
        ...
        paramView.putExtra("ALBUM_ID", this.a.jdField_b_of_type_JavaLangString);
        paramView.putExtra("PhotoConst.IS_OVERLOAD", this.a.y);
        localObject1 = this.a.jdField_a_of_type_Agnt.a(paramInt);
        ...
        if (!this.a.y)
        {
          ...
          {
            paramInt = i;
            if (bbbx.a((LocalMediaInfo)localObject1) == 1)
            {
      ...
      if (this.a.M)
      {
        ...
        {
          paramAdapterView = ajya.a(2131708106);
          bcql.a(this.a, paramAdapterView, 0).b(this.a.e());
          return;
        }
      }
