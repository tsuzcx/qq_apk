...
public class apoe
  extends BaseAdapter
{
  public apoe(LangSettingFragment paramLangSettingFragment) {}
  
  private View.OnClickListener a(int paramInt)
  {
    return new apof(this, paramInt);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramInt == LangSettingFragment.a(this.a)) {
      paramView.setRightIcon(this.a.getResources().getDrawable(2130843825));
    }
    for (;;)
    {
