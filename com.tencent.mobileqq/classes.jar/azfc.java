...
public class azfc
{
  ...
  public azfc(double paramDouble1, double paramDouble2, String paramString1, String paramString2)
  {
  ...
  public static boolean a(azfc paramazfc, double paramDouble1, double paramDouble2, String paramString)
  {
    boolean bool2 = false;
    boolean bool1;
    if (paramazfc == null) {
    ...
    do
    {
      do
      {
        do
        {
          ...
          if (!paramString.equals(paramazfc.jdField_c_of_type_JavaLangString)) {
            return true;
          }
          bool1 = bool2;
      ...
      if (Math.abs(paramazfc.jdField_a_of_type_Double - paramDouble1) > 0.001D) {
        break;
      }
      bool1 = bool2;
    } while (Math.abs(paramazfc.jdField_b_of_type_Double - paramDouble2) <= 0.001D);
    return true;
  }
