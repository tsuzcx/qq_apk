  ...
  extends Drawable
{
  ...
  public aera(Resources paramResources)
  {
  ...
  {
    if ((this.jdField_a_of_type_JavaLangObject != null) && ((this.jdField_a_of_type_JavaLangObject instanceof aerc)) && (((aerc)this.jdField_a_of_type_JavaLangObject).a != null) && (this.jdField_a_of_type_Int == 1) && (((aerc)this.jdField_a_of_type_JavaLangObject).a.equals(paramString))) {
      return;
    }
    a();
    this.jdField_a_of_type_Int = 1;
    this.jdField_a_of_type_JavaLangObject = new aerc(this, paramString);
  }
  ...
  public void a(String[] paramArrayOfString, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        if ((this.jdField_a_of_type_Int == 0) && (this.jdField_a_of_type_JavaLangObject != null) && (!(this.jdField_a_of_type_JavaLangObject instanceof aerc)))
        {
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    do
    {
      ...
      {
        return;
      } while (this.jdField_a_of_type_Aerb == null);
      localBitmap = this.jdField_a_of_type_Aerb.a();
