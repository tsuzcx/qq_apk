...
{
  public rjy(DoraemonAPIReporterProxy paramDoraemonAPIReporterProxy) {}
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    do
    {
      ...
      if ("com.tencent.mobileqq.Doraemon.monitor.update".equals(str1))
      {
        ...
        ThreadManager.getUIHandler().post(new rjz(this, paramContext, str1, i, str2, str3, l1, l2));
        return;
      }
    ...
    try
    {
      ...
      ThreadManager.getUIHandler().post(new rka(this, paramContext, str1, paramIntent));
      return;
    }
