  ...
  extends bdur
{
  ...
  public bduy(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(long paramLong1, PubAccountNavigationMenu paramPubAccountNavigationMenu, long paramLong2)
  {
    ...
    try
    {
      ...
      for (int i = 0;; i = paramPubAccountNavigationMenu.version)
      {
        ...
        ((subcmd0x519.CRMMsgHead)localObject1).uint32_ver_no.set(bdvi.a("8.2.8"));
  ...
  private void a(aukn paramaukn)
  {
    if (paramaukn != null)
    {
      paramaukn = paramaukn.a(PubAccountNavigationMenu.class);
      if (paramaukn != null)
      {
        paramaukn = paramaukn.iterator();
        while (paramaukn.hasNext())
        {
          PubAccountNavigationMenu localPubAccountNavigationMenu = (PubAccountNavigationMenu)paramaukn.next();
          if (QLog.isColorLevel()) {
  ...
  public void a(long paramLong)
  {
    if (!jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())
    {
      ...
      if (localObject != null)
      {
        localObject = (PubAccountNavigationMenu)((aukn)localObject).a(PubAccountNavigationMenu.class, new String[] { String.valueOf(paramLong) });
        if (localObject != null) {
