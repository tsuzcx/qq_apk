  ...
  implements avar
{
  ...
  Application.ActivityLifecycleCallbacks jdField_a_of_type_AndroidAppApplication$ActivityLifecycleCallbacks = new avba(this);
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new avbb(this);
  protected auzh a;
  ...
  public avau(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Avas = new avas();
    this.jdField_b_of_type_Boolean = false;
    this.jdField_c_of_type_Boolean = false;
    this.jdField_a_of_type_Int = -1;
    this.jdField_d_of_type_Int = 0;
    this.jdField_e_of_type_Int = 0;
    this.jdField_a_of_type_Auzh = new avaz(this);
    this.jdField_h_of_type_Int = 0;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Auzh);
    j();
    this.jdField_a_of_type_Avas.jdField_a_of_type_Boolean = true;
    ...
    this.jdField_a_of_type_Avas.jdField_a_of_type_Int = -1000;
    this.jdField_a_of_type_Avas.jdField_b_of_type_Int = -1000;
  ...
  private void a(String paramString)
  {
    ...
    if (!bftf.a(paramString, this.jdField_b_of_type_JavaLangString))
    {
    ...
    avat localavat = a();
    if ((localavat != null) && (!bftf.a(localavat.a(), paramString)))
    {
      localavat.setSongId(paramString);
      localavat.setLyric(null, 1);
    }
  }
  ...
  private boolean a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    do
    {
      return false;
      localavat = a();
    } while ((localavat == null) || (!paramString1.equals(localavat.a())) || (localavat.a() == 2));
    paramString1 = paramString2;
    if (!TextUtils.isEmpty(paramString2)) {
      paramString1 = paramString2.replace("&apos;", "'").replace("&quot;", "\"").replace("&nbsp;", " ").replace("&lt;", "<").replace("&gt;", ">").replace("&amp;", "&");
    }
    avjt localavjt = avkb.a(paramString1, true);
    paramString2 = localavjt;
    if (localavjt == null) {
      paramString2 = avkb.a(paramString1, false);
    }
    boolean bool;
    int j;
    if (QLog.isColorLevel())
    ...
    {
      localavat.c();
      localavat.setLyric(paramString2, j);
      return true;
      bool = false;
      break;
      label225:
  ...
  private void b(String paramString, int paramInt)
  {
    int j = 0;
    if (QLog.isColorLevel()) {
      QLog.i("LyricsController", 2, String.format("updateLyricState [%s, %s]", new Object[] { avbf.a(paramInt), paramString }));
    }
    avat localavat = a();
    if (localavat == null) {
      return;
  ...
  {
    boolean bool2 = false;
    if ((this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Avas.a(paramInt, paramString))) {
      return true;
    }
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_Avas.jdField_b_of_type_Boolean = this.jdField_a_of_type_JavaUtilSet.contains(paramInt + "_" + paramString);
        if (this.jdField_a_of_type_Avas.b(paramInt, paramString))
        {
          bool1 = false;
          if (bool1 != this.jdField_a_of_type_Avas.jdField_c_of_type_Boolean)
          {
            this.jdField_a_of_type_Avas.jdField_c_of_type_Boolean = bool1;
            this.jdField_a_of_type_Avas.jdField_d_of_type_Boolean = true;
          }
          if (this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout == null)
          {
            ...
            bday.a().a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout);
          }
          if (this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout == null)
          {
          ...
          if (this.jdField_a_of_type_Avas.jdField_c_of_type_Boolean) {
            break;
          }
          if (!this.jdField_a_of_type_Avas.jdField_a_of_type_Boolean) {
            break label478;
          }
          this.jdField_a_of_type_Avas.jdField_a_of_type_Int = (this.jdField_f_of_type_Int / 2 - this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.d() / 2 - this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.d() / 2);
          if (this.jdField_a_of_type_Avas.jdField_b_of_type_Int == -1000) {
            this.jdField_a_of_type_Avas.jdField_b_of_type_Int = (this.jdField_g_of_type_Int - this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.e() / 2 - AIOUtils.dp2px(110.0F, BaseApplicationImpl.getContext().getResources()));
          }
          this.jdField_a_of_type_Avas.jdField_e_of_type_Boolean = true;
          if (QLog.isColorLevel()) {
            QLog.d("LyricsController", 2, "showLyricsInner mFloatParams: " + this.jdField_a_of_type_Avas);
          }
          this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_Avas);
          this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_Avas);
          this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_Avas), this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.b(this.jdField_a_of_type_Avas));
          this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_Avas), this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.b(this.jdField_a_of_type_Avas));
          boolean bool3 = this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_Avas);
          bool1 = this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_Avas);
          this.jdField_a_of_type_Avas.jdField_d_of_type_Boolean = false;
          if (bool1)
          {
            bool1 = bool2;
            if (bool3) {}
    ...
    if (this.jdField_a_of_type_Avas.jdField_a_of_type_Boolean) {}
    for (this.jdField_a_of_type_Avas.jdField_a_of_type_Int = (this.jdField_d_of_type_Int + this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.d() / 2);; this.jdField_a_of_type_Avas.jdField_a_of_type_Int = (this.jdField_f_of_type_Int - this.jdField_b_of_type_Int - this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.d() / 2))
    {
      if (this.jdField_a_of_type_Avas.jdField_b_of_type_Int == -1000) {
        this.jdField_a_of_type_Avas.jdField_b_of_type_Int = (AIOUtils.dp2px(70.0F, BaseApplicationImpl.getContext().getResources()) + this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.e() / 2);
      }
      this.jdField_a_of_type_Avas.jdField_e_of_type_Boolean = false;
      break;
    }
  }
  ...
  private void c(String paramString, int paramInt)
  {
    avat localavat = a();
    if (localavat == null) {}
    while (!bftf.a(localavat.a(), paramString)) {
      return;
    }
    localavat.a(paramInt);
  }
  ...
  private void n()
  {
    ...
    this.jdField_a_of_type_Avas.jdField_h_of_type_Boolean = false;
    boolean bool1;
    if (this.jdField_b_of_type_Boolean) {
      if ((this.jdField_a_of_type_Avas.jdField_f_of_type_Boolean) && (!this.jdField_a_of_type_Avas.jdField_g_of_type_Boolean))
      {
        j = this.jdField_a_of_type_Avas.jdField_a_of_type_Int;
        k = this.jdField_a_of_type_Avas.jdField_b_of_type_Int;
        bool1 = this.jdField_a_of_type_Avas.jdField_a_of_type_Boolean;
        if (!this.jdField_a_of_type_Avas.jdField_c_of_type_Boolean) {
          break label473;
        }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        this.jdField_a_of_type_Avas.jdField_a_of_type_Boolean = bool1;
        this.jdField_a_of_type_Avas.jdField_a_of_type_Int = j;
        this.jdField_a_of_type_Avas.jdField_b_of_type_Int = k;
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_Avas);
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_Avas);
        if ((this.jdField_a_of_type_Avas.jdField_f_of_type_Boolean) && (!this.jdField_a_of_type_Avas.jdField_g_of_type_Boolean)) {
          h();
        ...
        break label251;
        label473:
        if (this.jdField_a_of_type_Avas.jdField_d_of_type_Boolean)
        {
          if (bool1) {}
  ...
  private void o()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilSet)
    {
      if (!this.jdField_a_of_type_JavaUtilSet.isEmpty())
      {
        ...
        localEditor.putInt("listen_together_float_loc_icon_cx", this.jdField_a_of_type_Avas.jdField_a_of_type_Int);
        localEditor.putInt("listen_together_float_loc_icon_cy", this.jdField_a_of_type_Avas.jdField_b_of_type_Int);
        localEditor.putBoolean("listen_together_float_align_right", this.jdField_a_of_type_Avas.jdField_a_of_type_Boolean);
        localEditor.apply();
        return;
      }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("LyricsController", 2, "onPositionChangeEnd mFloatParams:" + this.jdField_a_of_type_Avas + " mScreenWidth:" + this.jdField_f_of_type_Int + " mScreenHeight:" + this.jdField_g_of_type_Int);
    }
    n();
    o();
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    {
      j = this.jdField_a_of_type_Avas.jdField_a_of_type_Int;
      m = this.jdField_a_of_type_Avas.jdField_b_of_type_Int;
      k = j - paramInt1;
      j = this.jdField_f_of_type_Int;
      if (!this.jdField_a_of_type_Avas.jdField_a_of_type_Boolean) {
        break label231;
      }
      if ((!this.jdField_a_of_type_Avas.jdField_c_of_type_Boolean) || (this.jdField_a_of_type_Avas.jdField_b_of_type_Boolean)) {
        break label198;
      }
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_Avas.jdField_e_of_type_Boolean = false;
        this.jdField_a_of_type_Avas.jdField_a_of_type_Int = paramInt1;
        this.jdField_a_of_type_Avas.jdField_b_of_type_Int = paramInt2;
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_Avas), this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.b(this.jdField_a_of_type_Avas));
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_Avas), this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.b(this.jdField_a_of_type_Avas));
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_Avas);
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_Avas);
        return;
        label198:
        if (this.jdField_a_of_type_Avas.jdField_b_of_type_Boolean) {
          break label331;
        }
        paramInt1 = 0 - this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.d();
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    this.jdField_a_of_type_Avas.a(paramInt, paramString);
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("LyricsController", 2, "onExitAIO, type:" + paramInt + " uin:" + paramString + ", isForeground: " + this.jdField_a_of_type_Boolean + " mFloatParams:" + this.jdField_a_of_type_Avas);
    }
    int k;
    int m;
    int j;
    if (this.jdField_a_of_type_Avas.b(paramInt, paramString))
    {
      this.jdField_a_of_type_Avas.b(0, null);
      if (!this.jdField_a_of_type_Avas.jdField_c_of_type_Boolean)
      {
        this.jdField_a_of_type_Avas.jdField_c_of_type_Boolean = true;
        this.jdField_a_of_type_Avas.jdField_d_of_type_Boolean = true;
        this.jdField_a_of_type_Avas.jdField_h_of_type_Boolean = false;
    ...
    for (paramInt = -this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.d();; paramInt = this.jdField_f_of_type_Int)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.b();
      this.jdField_a_of_type_Avas.jdField_h_of_type_Boolean = true;
      this.jdField_a_of_type_Avas.jdField_g_of_type_Int = k;
      this.jdField_a_of_type_Avas.jdField_h_of_type_Int = m;
      this.jdField_a_of_type_Avas.jdField_a_of_type_AndroidGraphicsPaint$Align = Paint.Align.CENTER;
      ThreadManager.getUIHandlerV2().removeCallbacks(this.jdField_b_of_type_JavaLangRunnable);
      paramInt = 300;
      if (paramBoolean) {
        paramInt = 500;
      ...
      bday.a().a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout, this.jdField_a_of_type_Avas.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Avas.jdField_e_of_type_Int);
      return;
      label360:
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      return;
      this.jdField_a_of_type_Avas.jdField_f_of_type_Boolean = paramBoolean;
    } while (!this.jdField_b_of_type_Boolean);
    n();
  }
  ...
  public void b()
  {
    ...
    if ((this.jdField_a_of_type_Avas.a()) && (BaseActivity.sTopActivity != null))
    {
      localObject = bjnw.a(BaseActivity.sTopActivity);
      boolean bool = auzn.a();
      if (bool) {
        ((bjnw)localObject).b(2131693381);
      }
      ((bjnw)localObject).b(2131693356);
      ((bjnw)localObject).c(2131690620);
      ((bjnw)localObject).a(new avbc(this));
      ((bjnw)localObject).setOnCancelListener(new avbd(this));
      ((bjnw)localObject).a(new avav(this, (bjnw)localObject, bool));
    ...
    adxr.a(BaseApplicationImpl.getContext(), (Intent)localObject, PublicTransFragmentActivity.class, ListenTogetherOverlayFragment.class);
  }
  ...
  public void b(int paramInt1, int paramInt2)
  {
    if ((this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout != null))
    {
      ...
      if ((this.jdField_a_of_type_Avas.jdField_e_of_type_Boolean) && (!this.jdField_a_of_type_Avas.jdField_c_of_type_Boolean)) {
        if (!this.jdField_a_of_type_Avas.jdField_a_of_type_Boolean) {
          break label172;
        }
      }
    ...
    label172:
    for (this.jdField_a_of_type_Avas.jdField_a_of_type_Int = (this.jdField_f_of_type_Int / 2 - this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.d() / 2 - this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.d() / 2);; this.jdField_a_of_type_Avas.jdField_a_of_type_Int = (this.jdField_f_of_type_Int / 2 + this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.d() / 2 + this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.d() / 2))
    {
      this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_Avas), this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.b(this.jdField_a_of_type_Avas));
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("LyricsController", 2, "hideLyrics,  type:" + paramInt + " uin:" + paramString + " mFloatParams:" + this.jdField_a_of_type_Avas);
    }
    if (!this.jdField_a_of_type_Avas.a(paramInt, paramString)) {
      return;
    }
    ThreadManager.getUIHandlerV2().removeCallbacks(this.jdField_b_of_type_JavaLangRunnable);
    ...
    m();
    this.jdField_b_of_type_Boolean = false;
    this.jdField_a_of_type_Avas.a(0, null);
    this.jdField_a_of_type_Int = -1;
    this.jdField_a_of_type_JavaLangString = null;
    this.jdField_c_of_type_Boolean = false;
    this.jdField_h_of_type_Int = 0;
  ...
  public void b(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Avas.jdField_g_of_type_Boolean != paramBoolean)
    {
      this.jdField_a_of_type_Avas.jdField_g_of_type_Boolean = paramBoolean;
      if (this.jdField_b_of_type_Boolean) {
        n();
      }
    }
  ...
  {
    int k = 1;
    if ((!this.jdField_b_of_type_Boolean) || (TextUtils.isEmpty(this.jdField_a_of_type_Avas.jdField_b_of_type_JavaLangString)) || ((this.jdField_a_of_type_Avas.jdField_e_of_type_Int != 2) && (this.jdField_a_of_type_Avas.jdField_e_of_type_Int != 1)) || (this.jdField_a_of_type_Avas.a())) {
      return;
    }
    BaseApplication localBaseApplication = BaseApplicationImpl.getContext();
    Object localObject = this.jdField_a_of_type_Avas.jdField_e_of_type_Int + "_" + this.jdField_a_of_type_Avas.jdField_b_of_type_JavaLangString;
    if (((BaseActivity.sTopActivity instanceof SplashActivity)) && (SplashActivity.jdField_a_of_type_Int == 1))
    {
      ...
      label178:
      ((Intent)localObject).putExtra("uin", this.jdField_a_of_type_Avas.jdField_b_of_type_JavaLangString);
      if (this.jdField_a_of_type_Avas.jdField_e_of_type_Int != 2) {
        break label328;
      }
    ...
    for (int j = k;; j = 2)
    {
      bcef.b((QQAppInterface)localObject, "dc00898", "", "", "qq_vip", "0X800A5C0", j, 0, "", "", VipUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), "");
      return;
      j = 0;
      break;
      j = 2;
      ...
      ((Intent)localObject).putExtra("troop_uin", this.jdField_a_of_type_Avas.jdField_b_of_type_JavaLangString);
      break label213;
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("LyricsController", 2, "onEnterAIO, type:" + paramInt + " uin:" + paramString + " mFloatParams:" + this.jdField_a_of_type_Avas + " mIsForeground:" + this.jdField_a_of_type_Boolean);
    }
    this.jdField_a_of_type_Avas.b(paramInt, paramString);
    if (this.jdField_a_of_type_Avas.a(paramInt, paramString)) {}
    for (boolean bool = false;; bool = true)
    {
      if (bool != this.jdField_a_of_type_Avas.jdField_c_of_type_Boolean)
      {
        this.jdField_a_of_type_Avas.jdField_c_of_type_Boolean = bool;
  ...
  public void d()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      int j = this.jdField_a_of_type_Avas.jdField_e_of_type_Int;
      String str = this.jdField_a_of_type_Avas.jdField_b_of_type_JavaLangString;
      this.jdField_a_of_type_Auzr = new avaw(this);
      ListenTogetherManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(j, str, this.jdField_a_of_type_Auzr);
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("LyricsController", 2, "onDestroyAIO, type:" + paramInt + " uin:" + paramString + ", isForeground: " + this.jdField_a_of_type_Boolean + " mFloatParams:" + this.jdField_a_of_type_Avas);
    }
  ...
  public void e()
  {
    b(this.jdField_a_of_type_Avas.jdField_e_of_type_Int, this.jdField_a_of_type_Avas.jdField_b_of_type_JavaLangString);
    if (this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout != null) {
      this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.b();
    }
    if (this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout != null) {
  ...
  public void f()
  {
    ...
    if (!bool)
    {
      ...
      if (!this.jdField_d_of_type_Boolean)
      {
        ...
        adxr.a(BaseApplicationImpl.getContext(), localIntent, PublicTransFragmentActivity.class, ListenTogetherOverlayFragment.class);
  ...
  public void g()
  {
    ...
    this.jdField_a_of_type_Avas.jdField_g_of_type_Boolean = false;
    n();
    int j = this.jdField_a_of_type_Avas.jdField_e_of_type_Int;
    String str3 = this.jdField_a_of_type_Avas.jdField_b_of_type_JavaLangString;
    b(j, str3, true);
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ((auyv)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(156)).notifyUI(14, true, new Object[] { Integer.valueOf(j), str3 });
      ...
      bcef.b(null, "dc00899", "c2c_AIO", "", "music_tab", "clk_close", 0, 0, str3, "", "", "");
    }
    label156:
    ...
    for (;;)
    {
      bcef.b(null, "dc00899", "Grp_AIO", "", "music_tab", "clk_close", 0, 0, str3, "", str1, "");
      return;
      label249:
      str1 = str2;
  ...
  public void h()
  {
    ...
    int j = this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_Avas);
    int k = this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.b(this.jdField_a_of_type_Avas);
    int m = this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_Avas);
    int n = this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.b(this.jdField_a_of_type_Avas);
    ...
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new avax(this, i1, j, i2, k, i3, m, i4, n));
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new avay(this, j, k, m, n));
  ...
  public void i()
  {
    ...
    this.jdField_a_of_type_Avas.jdField_a_of_type_Int = ((SharedPreferences)localObject2).getInt("listen_together_float_loc_icon_cx", this.jdField_a_of_type_Avas.jdField_a_of_type_Int);
    this.jdField_a_of_type_Avas.jdField_b_of_type_Int = ((SharedPreferences)localObject2).getInt("listen_together_float_loc_icon_cy", this.jdField_a_of_type_Avas.jdField_b_of_type_Int);
    this.jdField_a_of_type_Avas.jdField_a_of_type_Boolean = ((SharedPreferences)localObject2).getBoolean("listen_together_float_align_right", this.jdField_a_of_type_Avas.jdField_a_of_type_Boolean);
