...
public class avau
{
  ...
  public avau(int paramInt)
  {
    this.jdField_a_of_type_JavaUtilArrayList = new ArrayList(2);
    this.jdField_a_of_type_Int = paramInt;
  }
  
  public static avau a(appoint_define.InterestTag paramInterestTag)
  {
    avau localavau = null;
    if (paramInterestTag != null)
    {
      localavau = new avau(paramInterestTag.uint32_tag_type.get());
  ...
  public static avau a(JSONObject paramJSONObject)
  {
    int j = 0;
    ...
    for (;;)
    {
      ...
      if (i < paramJSONObject.length())
      {
        ...
        if (localObject != null)
        {
          ...
          if (localObject != null)
          {
            localavau.jdField_a_of_type_JavaUtilArrayList.add(localObject);
            break label140;
            label114:
            localObject = null;
          }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (!bdeu.a(this.jdField_a_of_type_JavaUtilArrayList.get(i), paramObject.jdField_a_of_type_JavaUtilArrayList.get(i))) {
        break;
      }
      i += 1;
    }
