...
{
  public adyt(ForwardRecentActivity paramForwardRecentActivity) {}
  ...
  public void onChanged()
  {
    ...
    if (i < j)
    {
      ...
      if ((localObject2 instanceof amhe)) {
        break label227;
      }
    }
    label227:
    do
    {
      ...
      break label197;
      break;
      localObject2 = (amhe)localObject2;
    } while ((((amhe)localObject2).a == null) || (!TextUtils.equals(((amhe)localObject2).a.uin, str)) || (k != ((amhe)localObject2).a.getType()));
