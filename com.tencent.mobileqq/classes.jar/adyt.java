  ...
  implements awcd, awfp, awft
{
  ...
  HashSet<adyu> jdField_a_of_type_JavaUtilHashSet = new HashSet();
  long b;
  long c;
  
  adyt(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo);
    this.jdField_a_of_type_ComTencentMobileqqDataMessageForRichState = null;
    this.jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
    this.jdField_a_of_type_Adyv.a = new WeakReference(this);
    this.jdField_a_of_type_ComTencentMobileqqDataMessageForRichState = null;
    ...
    if (this.jdField_a_of_type_Aweo != null) {
      this.jdField_a_of_type_Aweo.a(this.jdField_a_of_type_Adyv);
    }
  }
  ...
  private void b()
  {
    ...
    abtu.a(this.jdField_a_of_type_AndroidContentContext, localIntent, PublicFragmentActivity.class, SignatureHistoryFragment.class);
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "signiture", "aio_clk_his", 0, 0, "", "", "", "");
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0x8009434", "0x8009434", 0, 0, "", "1", "", "");
  ...
  private void c()
  {
    if (System.currentTimeMillis() - this.b > 2000L)
    {
      ...
      axqw.b(null, "dc00898", "", "", "0X800A4EB", "0X800A4EB", 0, 0, "0", "0", "", "");
    }
  }
  
  protected actr a()
  {
    adyu localadyu = new adyu();
    this.jdField_a_of_type_JavaUtilHashSet.add(localadyu);
    return localadyu;
  }
  ...
  protected View a(MessageRecord paramMessageRecord, actr paramactr, View paramView, LinearLayout paramLinearLayout, acxn paramacxn)
  {
    ...
    paramLinearLayout = (adyu)paramactr;
    ...
    if (paramView == null)
    {
      ...
      paramactr = new ViewGroup.MarginLayoutParams(-1, -2);
      int i = actn.a(6.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      paramactr.leftMargin = i;
      paramactr.rightMargin = i;
      paramMessageRecord.setLayoutParams(paramactr);
      paramLinearLayout.a = new awfj(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord, this.jdField_a_of_type_ComTencentMobileqqDataMessageForRichState.frienduin);
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Acuv.a != null) {
      paramLinearLayout.a.jdField_a_of_type_Int = this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Acuv.a.getDefaultColor();
    }
    paramactr = this.jdField_a_of_type_ComTencentMobileqqDataMessageForRichState.ver;
    if ((paramactr != null) && (paramactr.equals("1.0"))) {
    ...
    label576:
    label608:
    for (paramactr = bbkb.a(this.jdField_a_of_type_AndroidContentContext, 3, this.jdField_a_of_type_ComTencentMobileqqDataMessageForRichState.time * 1000L);; paramactr = null)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.d != null)
      {
        ...
        paramView = aynn.a(20, paramView);
        paramacxn = paramView + ajyc.a(2131713445);
        paramLinearLayout.a.jdField_a_of_type_JavaLangString = paramacxn;
        if (e)
        {
          paramacxn = jdField_a_of_type_ComTencentMobileqqRichstatusRichStatus.getPlainText();
      ...
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqDataMessageForRichState.time > 0L) {
          paramLinearLayout.b.append("于").append(paramactr);
        }
        paramLinearLayout.b.append("更新了签名，内容是：").append(paramacxn);
  ...
  public void a()
  {
    ...
    {
      adyu localadyu = (adyu)((Iterator)localObject).next();
      if (localadyu.a != null) {
        localadyu.a.k();
      }
    }
    if (this.jdField_a_of_type_Aweo != null) {
      this.jdField_a_of_type_Aweo.b(this.jdField_a_of_type_Adyv);
    }
    localObject = (VasQuickUpdateManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(184);
    this.jdField_a_of_type_Aweo = null;
  ...
  public void a(View paramView, int paramInt, awfo paramawfo)
  {
    ...
    for (;;)
    {
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A98E", "0X800A98E", paramInt, 0, "0", "0", "", "");
      return;
      if (paramInt == 4)
      {
        a(paramawfo);
  ...
  public void a(awfo paramawfo)
  {
    ...
    if (!TextUtils.isEmpty(jdField_a_of_type_ComTencentMobileqqRichstatusRichStatus.feedsId))
    {
      ...
      bcpw.a(this.jdField_a_of_type_AndroidContentContext, localResources.getString(2131692321), 0).b(((BaseActivity)this.jdField_a_of_type_AndroidContentContext).getTitleBarHeight());
    }
    label62:
    int i;
    int j;
    do
    {
      ...
      {
        bcpw.a(this.jdField_a_of_type_AndroidContentContext, localResources.getString(2131690829), 0).b(((BaseActivity)this.jdField_a_of_type_AndroidContentContext).getTitleBarHeight());
        return;
      }
      this.c = l;
      try
      {
        paramawfo = (awfj)paramawfo;
        i = paramawfo.d;
        if (paramawfo.f != 0) {
          break;
        }
        paramawfo.f = 1;
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "signiture", "aio_act_on", 0, 0, "", "", "", "");
        i += 1;
        j = 1;
        paramawfo.d = i;
        paramawfo.j();
        ((SignatureHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(41)).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, paramawfo.jdField_b_of_type_JavaLangString, 255, j);
        return;
      }
      catch (Exception paramawfo) {}
    } while (!QLog.isColorLevel());
    QLog.i("ChatItemBuilder", 2, paramawfo.getMessage(), paramawfo);
    return;
    paramawfo.f = 0;
    i -= 1;
    if (i > 0) {}
    for (;;)
    {
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "signiture", "aio_act_off", 0, 0, "", "", "", "");
      j = 0;
      break;
      i = 0;
    }
  ...
  {
    QLog.d("ChatItemBuilder", 1, new Object[] { "onClick topic=", paramawfs });
    paramawfs = paramawfs.a();
    if ((paramawfs instanceof Pair))
    {
      paramawfs = (Pair)paramawfs;
      if (QLog.isColorLevel()) {
        QLog.i("ChatItemBuilder", 2, String.format("aio onTopicClick [%d,%s]", new Object[] { paramawfs.first, paramawfs.second }));
      }
      awfy.a(this.jdField_a_of_type_AndroidContentContext, awfy.a(((Integer)paramawfs.first).intValue(), (String)paramawfs.second), -1);
    }
  }
