  ...
  extends rkg
{
  ...
  public nyu(nyt paramnyt, View paramView, BaseData paramBaseData)
  {
  ...
  private void a(BaseData paramBaseData, Context paramContext, JSONObject paramJSONObject)
  {
    ...
    ViewFactory.findClickableViewListener(paramJSONObject, new nyv(this, paramBaseData, paramContext, paramJSONObject));
  }
  ...
  private void a(Container paramContainer, ProteusItemData paramProteusItemData)
  {
    if (paramContainer != null)
    {
      ...
      if (((paramProteusItemData instanceof AdData)) && (((AdData)paramProteusItemData).a != null) && (oai.a((AdData)paramProteusItemData)))
      {
        ...
        if ((localViewBase != null) && ((localViewBase instanceof pme)) && (!TextUtils.isEmpty(((AdData)paramProteusItemData).J)))
        {
          int i = actj.a(40.0F, paramContainer.getContext().getResources());
          oai.a(paramContainer.getContext(), localViewBase, ((AdData)paramProteusItemData).J, 10, i, i);
        }
      }
    }
  }
  ...
  public void a(BaseData paramBaseData1, BaseData paramBaseData2, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      a(paramBaseData2, nyt.a(this.jdField_a_of_type_Nyt), this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataProteusItemData.b);
