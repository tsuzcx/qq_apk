  ...
  extends bdon
{
  ...
  public bdqi()
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new bdql(this);
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    paramContext.setBackgroundResource(2130838311);
    if (i > 1) {
      if (j == 0)
      {
        paramContext.setBackgroundResource(2130838304);
        i = 0;
      }
    }
    for (;;)
    {
      paramContext.setTag(2131378072, Integer.valueOf(i));
      ...
      if ((!b()) || ((b()) && (a())))
      {
        ...
        paramContext.setOnLongClickListener(new bdqj(this));
        paramContext.setOnTouchListener(new bdqk(this));
        return paramContext;
        if (j == i - 1)
        {
  ...
  public void a(String paramString, MessageRecord paramMessageRecord, StructMsgForGeneralShare paramStructMsgForGeneralShare)
  {
    ...
    try
    {
      ...
      if ((i != 23001027) && (i != 0) && (i != -4) && (i != -6))
      {
        ...
        if (!((alao)paramString.getManager(245)).a(paramMessageRecord.frienduin))
        {
          j = 1;
          i = -4;
          if (j != 0) {
