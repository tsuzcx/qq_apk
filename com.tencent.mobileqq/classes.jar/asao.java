  ...
  implements ajfe
{
  ...
  public asao(MusicPlayerActivity paramMusicPlayerActivity)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException)
      {
        try
        {
          ...
          String str5;
          localObject1 = ((arzh)localObject1).a();
          if (!bool2) {
            continue;
          }
          awqx.b(localMusicPlayerActivity.app, "CliOper", "", "", "0X8006827", "0X8006827", 0, 0, "", "", "", "");
          ...
          paramObject = new asaq(l2, (String)localObject4, (String)localObject3, (String)localObject8, (String)localObject6, (String)localObject5, paramBoolean);
          ...
          paramObject = new asap((String)localObject4, (String)localObject3, (String)localObject5, (String)localObject6, (String)localObject8, "http://qzonestyle.gtimg.cn/ac/qzone/applogo/16/308/100497308_16.gif");
        ...
        for (;;)
        {
          try
          {
            ...
            if ((paramObject instanceof Integer))
            {
              ...
              Message.obtain(MusicPlayerActivity.a(localMusicPlayerActivity), 54, 2131628814, paramInt, MusicPlayerActivity.a(localMusicPlayerActivity)).sendToTarget();
              return;
            }
          }
