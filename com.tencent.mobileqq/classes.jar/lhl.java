...
public class lhl
{
  ...
  public lhl(VideoAppInterface paramVideoAppInterface)
  {
  ...
  void a(int paramInt, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      {
        String str3 = ((lid)localObject2).d;
        localObject2 = ((lid)localObject2).c;
  ...
  public void b()
  {
    ...
    try
    {
      if (this.jdField_a_of_type_AndroidContentComponentCallbacks == null)
      {
        this.jdField_a_of_type_AndroidContentComponentCallbacks = new lhm(this);
