  ...
  private void c(lgc paramlgc)
  {
    ...
    if (localBitmap != null) {
      try
      {
        ...
        this.jdField_a_of_type_ArrayOfInt[0] = paramlgc.a().a();
        paramlgc.a(this);
        if ((i == m) && (j == n)) {
          paramlgc.a(this, localBitmap);
        }
        for (;;)
        {
          e();
          ...
          paramlgc.a(this, i, j);
          paramlgc.a(this, 0, 0, localBitmap, i, j);
        }
        this.jdField_b_of_type_Int = -1;
      }
      finally
        ...
        if (!this.jdField_b_of_type_Boolean)
        {
          ...
          if (localBitmap != null) {
            try
            {
              ...
              {
                paramlgc.a(this, 0, 0, localBitmap, GLUtils.getInternalFormat(localBitmap), GLUtils.getType(localBitmap));
                e();
                this.jdField_b_of_type_Boolean = true;
                return;
              }
            }
            catch (IllegalArgumentException paramlgc) {}
          }
        }
      }
    } while (!QLog.isColorLevel());
    QLog.e("UploadedTexture", 2, "WL_DEBUG updateContent e = " + paramlgc);
  }
