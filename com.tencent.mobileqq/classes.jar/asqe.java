...
public class asqe
{
  ...
  asqw jdField_a_of_type_Asqw = null;
  ...
  List<Integer> jdField_f_of_type_JavaUtilList = Arrays.asList(new Integer[] { Integer.valueOf(2131367097), Integer.valueOf(2131367099), Integer.valueOf(2131367100), Integer.valueOf(2131367101), Integer.valueOf(2131367102), Integer.valueOf(2131367103), Integer.valueOf(2131367104), Integer.valueOf(2131367105), Integer.valueOf(2131367106), Integer.valueOf(2131367098) });
  int g;
  int h = 0;
  int i = 0;
  int j = 0;
  ...
  public asqe(QQAppInterface paramQQAppInterface, Context paramContext)
  {
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    ...
    for (long l = a(800, 1500);; l = 750L)
    {
      ...
      localRotateAnimation.setInterpolator(new asqj(this));
      this.jdField_a_of_type_AndroidWidgetImageView.startAnimation(localRotateAnimation);
      localRotateAnimation.setAnimationListener(new asqh(this, paramInt, paramBoolean));
      return;
    }
  }
  
  public void a(asqw paramasqw, boolean paramBoolean)
  {
    if ((paramasqw == null) || (this.jdField_a_of_type_AndroidContentContext == null))
    {
      if (QLog.isColorLevel()) {
        QLog.d(Face2FaceAddFriendActivity.a, 2, "startFriendDisappearAnimation disappear data is " + paramasqw + " mContext " + this.jdField_a_of_type_AndroidContentContext);
      }
      return;
    }
    Object localObject = paramasqw.e;
    if ((paramasqw instanceof asqt)) {
      localObject = paramasqw.e + "_" + ((asqt)paramasqw).b;
    }
    ...
    for (int m = ((Integer)this.jdField_a_of_type_JavaUtilMap.get(localObject)).intValue();; m = -1)
    {
      if (m == -1)
      {
        ...
        QLog.d(Face2FaceAddFriendActivity.a, 2, "startFriendDisappearAnimation disappear uin " + paramasqw.e.substring(0, 4) + " is not in the hole");
        QLog.d(Face2FaceAddFriendActivity.b, 2, "startFriendDisappearAnimation disappear uin " + paramasqw.e.substring(0, 4) + " is not in the hole");
        this.h += 1;
        return;
      }
      ...
      if (paramBoolean)
      {
        ...
        localAnimationSet.setInterpolator(new asqk(this));
        localAnimationSet.setAnimationListener(new asqg(this));
        if (localObject != null) {
      ...
      if (QLog.isColorLevel()) {
        QLog.d(Face2FaceAddFriendActivity.a, 2, "startFriendDisappearAnimation disappear uin " + paramasqw.e.substring(0, 4));
      }
      ...
      a(m);
      ((Face2FaceAddFriendActivity)this.jdField_a_of_type_AndroidContentContext).c(paramasqw);
  ...
  public void a(asqw paramasqw, boolean paramBoolean1, int paramInt, boolean paramBoolean2, boolean paramBoolean3)
  {
    if ((paramasqw == null) || (this.jdField_a_of_type_AndroidContentContext == null)) {
      if (QLog.isColorLevel()) {
        QLog.d(Face2FaceAddFriendActivity.a, 2, "startFriendInAnimation  data is " + paramasqw + " mContext " + this.jdField_a_of_type_AndroidContentContext);
      }
    }
    int n;
    int m;
    ...
    ((Face2FaceFriendBubbleView)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramasqw);
    ...
    if (QLog.isColorLevel())
    {
      if (!TextUtils.isEmpty(paramasqw.e)) {
        QLog.d(Face2FaceAddFriendActivity.a, 2, "startFriendInAnimation get ( currentUin= " + paramasqw.e.substring(0, 4) + " , index = " + m + " )");
      }
    }
    else
    {
    ...
    for (;;)
    {
      ...
      default: 
        ...
        ((TranslateAnimation)localObject2).setInterpolator(new asqk(this));
        ((TranslateAnimation)localObject2).setAnimationListener(new asqf(this, paramasqw, m, d1, bool, paramBoolean3, paramasqw, paramBoolean1, paramBoolean2, (Face2FaceFriendBubbleView)localObject1, paramInt));
        ((Face2FaceFriendBubbleView)localObject1).startAnimation((Animation)localObject2);
        localObject1 = paramasqw.e;
        if ((paramasqw instanceof asqt)) {
          localObject1 = paramasqw.e + "_" + ((asqt)paramasqw).b;
        }
        break;
      }
      for (;;)
      {
        ...
        ((Face2FaceAddFriendActivity)this.jdField_a_of_type_AndroidContentContext).a(paramasqw, paramBoolean1, paramBoolean2);
        if (QLog.isColorLevel()) {
        ...
        {
          QLog.d(Face2FaceAddFriendActivity.a, 2, "startFriendInAnimation currentUIn= " + paramasqw.e.substring(0, 4) + " startAnimation OK");
          return;
          m = n;
          if (this.jdField_c_of_type_JavaUtilList.size() <= 1) {
            break label91;
  ...
  public void a(QQAppInterface paramQQAppInterface, View paramView, int paramInt, String paramString)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131364872));
    if ((paramInt == 1) && (!TextUtils.isEmpty(paramString)))
    {
      ((ImageView)paramView.findViewById(2131364873)).setVisibility(4);
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130840079);
      paramQQAppInterface = paramQQAppInterface.a(paramString, (byte)3, false, false);
      if (paramQQAppInterface != null) {
        break label476;
      }
      paramQQAppInterface = bgmo.f();
    }
    label476:
    for (;;)
    {
      paramString = (ImageView)paramView.findViewById(2131379219);
  ...
  public void b()
  {
    ...
    for (this.jdField_b_of_type_Float = (this.jdField_a_of_type_Float - m);; this.jdField_b_of_type_Float = (m + f2))
    {
      ...
      this.jdField_a_of_type_AndroidViewAnimationRotateAnimation.setInterpolator(new asqj(this));
      this.jdField_a_of_type_AndroidWidgetImageView.startAnimation(this.jdField_a_of_type_AndroidViewAnimationRotateAnimation);
      this.jdField_a_of_type_AndroidViewAnimationRotateAnimation.setAnimationListener(new asqi(this));
      return;
