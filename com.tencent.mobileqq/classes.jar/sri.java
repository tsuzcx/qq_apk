  ...
  extends slu
{
  ...
  public sri(byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (((qqstory_service.RspGetFilterList)localObject1).is_end.get() != 0)
        {
          ...
          sra localsra = new sra();
          localsra.jdField_a_of_type_Long = ((qqstory_struct.FilterListPack)localObject2).filter_id.get();
          localsra.jdField_a_of_type_JavaLangString = ((qqstory_struct.FilterListPack)localObject2).filter_name.get().toStringUtf8();
          localsra.jdField_a_of_type_Int = ((qqstory_struct.FilterListPack)localObject2).filter_type.get();
          localsra.jdField_b_of_type_JavaLangString = ((qqstory_struct.FilterListPack)localObject2).filter_config_file.get().toStringUtf8();
          localsra.c = ((qqstory_struct.FilterListPack)localObject2).filter_config_md5.get().toStringUtf8();
          try
          {
            localObject2 = localsra.a();
            paramArrayOfByte.add(localObject2);
            urk.d("VideoFilterManager", "GET Filter : id=%d, name=%s, type=%d, url=%s, md5=%s", new Object[] { Long.valueOf(((FilterItem)localObject2).filterId), ((FilterItem)localObject2).filterName, Integer.valueOf(((FilterItem)localObject2).filterType), ((FilterItem)localObject2).filterConfigUrl, ((FilterItem)localObject2).filterConfigMd5 });
          }
          catch (FilterItem.FilterItemIllegalException localFilterItemIllegalException)
          {
            urk.c("VideoFilterManager", "GET Filter error : ", localFilterItemIllegalException);
          }
          continue;
        }
        bool = false;
      ...
      {
        urk.e("VideoFilterManager", "GetEmojiPackInfoListRequest error : " + paramArrayOfByte);
        this.jdField_a_of_type_Int = -1;
        this.jdField_b_of_type_JavaLangString = ajjy.a(2131650470);
