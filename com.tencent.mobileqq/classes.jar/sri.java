  ...
  implements spj, spo
{
  ...
  public sri(Context paramContext)
  {
  ...
  private void g()
  {
    this.jdField_a_of_type_ComTencentPtsCoreLiteIPTSLiteEventListener = new srj(this);
  }
  ...
  public spi a(Context paramContext, BaseData paramBaseData, ViewGroup paramViewGroup)
  {
    ...
    return new srk(this, paramContext, paramBaseData, null);
  }
  ...
  public void f()
  {
    ...
    spi.a += this.b.size() + 1;
    QLog.i("WebPtsLiteViewCreator", 1, "[initPtsLiteTypeCount], view type count = " + spi.a);
  }
}
