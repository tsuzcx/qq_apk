...
public class vpo
  implements Runnable
{
  public vpo(PhotoListPanel paramPhotoListPanel) {}
  ...
  public void run()
  {
    ...
    if ((localObject2 == null) || (((List)localObject2).size() == 0))
    {
      ...
      PhotoListPanel.g = 0;
      this.a.jdField_a_of_type_AndroidOsHandler.post(new vpp(this));
      return;
    }
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      this.a.jdField_a_of_type_AndroidOsHandler.post(new vpq(this, (List)localObject2));
