  ...
  implements View.OnClickListener
{
  ...
  private acjw jdField_a_of_type_Acjw;
  ...
  public vpo(Context paramContext, vrn paramvrn)
  {
    super(paramContext);
    if (paramvrn != null) {
  ...
  protected void b()
  {
    ...
    do
    {
      ...
      localObject = vpk.a(((vpj)localObject).a());
    } while (TextUtils.isEmpty((CharSequence)localObject));
    this.jdField_a_of_type_Acju = new acju((String)localObject, new WeakReference(this.jdField_a_of_type_Acjw));
    this.jdField_a_of_type_Acju.a();
    this.b.setImageDrawable(this.jdField_a_of_type_Acju.a());
  ...
  protected void e()
  {
    this.jdField_a_of_type_ComTencentBizPubaccountWeishi_newViewRoundImageView = ((RoundImageView)a(2131367577));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)a(2131367580));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)a(2131367568));
    this.b = ((ImageView)a(2131367571));
  ...
  public void onClick(View paramView)
  {
    ...
    {
      localObject = new vln();
      ((vln)localObject).jdField_a_of_type_UserGrowthStSimpleMetaFeed = this.jdField_a_of_type_UserGrowthStSimpleMetaFeed;
      ((vln)localObject).jdField_a_of_type_Int = 2;
      ((vln)localObject).jdField_b_of_type_Int = this.jdField_a_of_type_Int;
      ...
      ((vln)localObject).c = "more_operations";
    ...
    for (;;)
    {
      ...
      {
        vmp.b("GdtAdWSVerticalItemBottomUserController", "跳转到广告落地页");
        ...
        localObject = new GdtAd(vpk.a(this.jdField_a_of_type_UserGrowthStSimpleMetaFeed));
        if (this.jdField_a_of_type_ComTencentAdTangramUtilAdExposureChecker$ExposureCallback == null) {
          this.jdField_a_of_type_ComTencentAdTangramUtilAdExposureChecker$ExposureCallback = new vpp(this);
        }
        ...
        if ((this.jdField_a_of_type_Vnw != null) && (this.jdField_a_of_type_Vnw.a() != null))
        {
          ...
          {
            vpk.a(a(), this.jdField_a_of_type_UserGrowthStSimpleMetaFeed, jdField_a_of_type_ComTencentGdtadAditemGdtAppReceiver, ((vrn)localObject).jdField_a_of_type_Vgb, false);
