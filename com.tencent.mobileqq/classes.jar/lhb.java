  ...
  extends EffectConfigBase<FilterItem>
{
  ...
  public lhb(VideoAppInterface paramVideoAppInterface)
  {
  ...
  public static boolean a(Context paramContext)
  {
    ...
    do
    {
      do
      {
        ...
        if (!lph.g())
        {
          lbd.f("EffectFilterTools", "isSupport Error: 1");
          return false;
        }
        bool1 = bool2;
      } while (!lph.a(4, 1400000L));
      if (paramContext == null) {
        break;
      }
      bool1 = bool2;
    } while (TextUtils.isEmpty(lbt.b(132).a));
    paramContext = lom.a();
    if ((paramContext != null) && (!paramContext.a()))
    {
      lbd.f("EffectFilterTools", "  isSupportFilter false");
      return false;
    }
