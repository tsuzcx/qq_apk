...
public class amkv
  extends absp
{
  public Comparator b = new amkw(this);
  
  public amkv(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
  ...
  private ArrayList<MessageRecord> a(ArrayList<msg_comm.Msg> paramArrayList, String paramString)
  {
    ...
    if (QLog.isColorLevel()) {
      auwz.a("HCTopicMsgProc", new Object[] { "<---groupMsgRecordHandle_PB", paramString, Integer.valueOf(paramArrayList.size()) });
    }
    ArrayList localArrayList1 = new ArrayList();
    ArrayList localArrayList2 = new ArrayList();
    azai localazai = new azai();
    localazai.e = Long.valueOf(paramString).longValue();
    localazai.c = 1026;
    ...
    while (paramArrayList.hasNext())
    {
      ...
      if (paramString != null)
      {
        ...
        localazai.d = ((msg_comm.GroupInfo)((msg_comm.MsgHead)localObject).group_info.get()).group_type.get();
        try
        {
          a(paramString, localArrayList1, localazai, false, null);
          if (localArrayList1.size() != 0)
          {
            alww.a(localArrayList1);
            if (localArrayList1.size() > 0)
            {
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    ...
    //   60: aload 9
    //   62: aload_2
    //   63: invokevirtual 225	amkv:a	(Lmsf/msgcomm/msg_comm$Msg;Ljava/lang/String;)V
    //   66: return
    //   67: astore 10
    //   69: aconst_null
    //   70: astore 9
    ...
    //   92: iload_1
    //   93: invokevirtual 240	amkv:a	(Ljava/lang/String;I)V
    //   96: return
    //   97: aconst_null
    //   98: astore 12
    //   100: lconst_0
    ...
    //   119: aload 10
    //   121: invokespecial 242	amkv:a	(Ljava/util/List;Ljava/util/List;)V
    //   124: aload_2
    //   125: iconst_1
    //   126: aaload
    ...
    //   214: aastore
    //   215: invokestatic 51	auwz:a	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   218: iload 8
    //   220: ifeq +55 -> 275
    //   223: iload_1
    //   224: sipush 1002
    ...
    //   239: aload 11
    //   241: lload 4
    //   243: invokevirtual 253	amkv:a	(ZLjava/lang/String;Ljava/util/ArrayList;Ljava/lang/String;J)V
    //   246: return
    //   247: astore 9
    //   249: aconst_null
    //   250: astore_2
    ...
    //   283: iload_1
    //   284: invokevirtual 240	amkv:a	(Ljava/lang/String;I)V
    //   287: return
    //   288: astore 9
    //   290: aconst_null
    //   291: astore_2
  ...
  protected void a(List<MessageRecord> paramList)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        astd localastd = this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.a(true).a(true);
        paramList = paramList.iterator();
        while (paramList.hasNext()) {
          localastd.a((MessageRecord)paramList.next());
        }
        return;
      }
  ...
  {
    auwz.a("HCTopicMsgProc", "processPush", new Object[] { paramString, paramMsg });
    if ((paramMsg == null) || (!paramMsg.msg_head.has())) {
      if (QLog.isColorLevel()) {
        auwz.a("HCTopicMsgProc", new Object[] { "processPush invalidate params" });
      }
    }
    Object localObject1;
    Object localObject2;
    ...
    for (;;)
    {
      ...
      {
        if (QLog.isColorLevel()) {
          auwz.a("HCTopicMsgProc", new Object[] { "<---handleMsgPush_PB_Group: no groupInfo." });
        }
      }
      else
      {
        ...
        if (((ayzr)localObject1).a(paramString) == 2) {}
        for (i = 1; i == 0; i = 0)
        {
          ((ayzr)localObject1).a(paramString, new Object[] { paramMsg, paramString });
          return;
        }
        localObject2 = new ArrayList();
        ArrayList localArrayList = new ArrayList();
        Object localObject3 = new azai();
        ((azai)localObject3).e = l3;
        ((azai)localObject3).c = 1026;
        ((azai)localObject3).d = j;
        try
        {
          a(paramMsg, (ArrayList)localObject2, (azai)localObject3, false, null);
          a((List)localObject2);
        ...
        catch (Exception paramMsg)
        {
          ...
          bool = alww.a((ArrayList)localObject2);
          i = abti.a((List)localObject2, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      {
        auud.a((ayzr)localObject1, l1, paramString, 1);
        ((ayzr)localObject1).a(1, paramString, l1, 2);
      }
      if (j == 127) {
        break;
      }
  ...
  protected void a(boolean paramBoolean, String paramString1, ArrayList<msg_comm.Msg> paramArrayList, String paramString2, long paramLong)
  {
    if (paramArrayList != null)
    {
      ...
      auwz.a("HCTopicMsgProc", "processGetMsgs", new Object[] { Boolean.valueOf(paramBoolean), paramString1, paramString2 });
      if (paramArrayList == null) {
        break label599;
      }
    }
    ...
    for (paramArrayList = a(paramArrayList, paramString1);; paramArrayList = null)
    {
      ...
      ayzr localayzr = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a();
      int i;
      if ((paramArrayList != null) && (paramArrayList.size() > 0))
      {
        ...
        {
          l3 = localayzr.a(2, paramString1);
          paramArrayList = (absl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(1026);
          ...
          paramBoolean = alww.a(paramString2);
          j = abti.a(paramString2, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          ...
          if ((paramBoolean) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackground_Pause))
          {
            ...
            if (l2 != -9223372036854775808L) {
              auud.a(localayzr, l2, paramString1, 3);
            }
            if (l1 != 9223372036854775807L)
            {
              localayzr.a(1, paramString1, l1, 2);
              if (paramLong == 0L) {
                localayzr.a(3, paramString1, l1, 1);
              }
            }
            i = 0;
            label506:
      ...
      for (;;)
      {
        if ((i != 0) && (localayzr.a(paramString1) == 1))
        {
          paramLong = localayzr.a(2, paramString1);
          ((absl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(1026)).b(paramString1, 1026, paramLong);
        }
  ...
  protected boolean a(MessageRecord paramMessageRecord)
  {
    ...
    if (localMessageRecord != null)
    {
      ...
      auud.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(), paramMessageRecord.shmsgseq, paramMessageRecord.frienduin, 2);
      bool = true;
    }
    return bool;
  }
