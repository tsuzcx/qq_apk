...
public class auaa
  extends atzb
  implements atmj, atmk, atxg, VideoPlayerCallback
{
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private AudioManager.OnAudioFocusChangeListener jdField_a_of_type_AndroidMediaAudioManager$OnAudioFocusChangeListener = new auah(this);
  protected AudioManager a;
  private Handler jdField_a_of_type_AndroidOsHandler;
  private PowerManager.WakeLock jdField_a_of_type_AndroidOsPowerManager$WakeLock;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new auac(this);
  private View.OnLongClickListener jdField_a_of_type_AndroidViewView$OnLongClickListener = new auab(this);
  private SeekBar.OnSeekBarChangeListener jdField_a_of_type_AndroidWidgetSeekBar$OnSeekBarChangeListener = new auaf(this);
  private atml jdField_a_of_type_Atml;
  ...
  private long c = auea.a().longValue();
  private boolean d;
  private boolean e;
  private boolean f;
  
  public auaa(atxa paramatxa, Activity paramActivity)
  {
    super(paramatxa, paramActivity);
    this.jdField_a_of_type_JavaLangRunnable = new VideoFilePresenter.10(this);
    this.jdField_a_of_type_Aubg = new aubg(paramActivity);
    this.jdField_a_of_type_AndroidOsHandler = new Handler();
    a(this.jdField_a_of_type_Aubg);
    s();
  }
  ...
  private String b()
  {
    ...
    if (auea.c(this.jdField_a_of_type_Atxa.d())) {
      localObject = this.jdField_a_of_type_Atxa.d();
    }
    String str;
    do
    {
      return localObject;
      if (this.jdField_a_of_type_Atvt == null) {
        break;
      }
      str = this.jdField_a_of_type_Atvt.b();
      localObject = str;
    } while (auea.c(str));
    return null;
  }
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_Aubg.f();
  }
  
  private void q()
  {
    String str = b();
    if ((str == null) && (this.jdField_a_of_type_Atxa.d() == 1))
    {
      this.jdField_a_of_type_Aubg.h(true);
      if (this.jdField_a_of_type_Atxa.b() == 16)
      {
        this.jdField_a_of_type_Aubg.a(this.jdField_a_of_type_Atxa.d(), this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131692655));
        this.jdField_a_of_type_Atxa.a(true);
    ...
    while (this.jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView == null)
    {
      return;
      r();
      this.jdField_a_of_type_Aubg.b(true);
  ...
  private void r()
  {
    this.jdField_a_of_type_Atvt = this.jdField_a_of_type_Atxa.a();
    if (this.jdField_a_of_type_Atvt == null)
    {
      QLog.w("FileBrowserPresenter<FileAssistant>", 1, "get video biz, data is null!");
      return;
    }
    this.jdField_a_of_type_Atml = atma.a(this.jdField_a_of_type_Atvt);
    this.jdField_a_of_type_Atml.a(this);
    this.jdField_a_of_type_Atml.a(this);
    this.jdField_a_of_type_Atml.a(true);
    this.jdField_a_of_type_Atml.a();
    this.jdField_a_of_type_Aubg.f(false);
    this.jdField_a_of_type_Aubg.b(true);
  }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Aubg.b(this.jdField_a_of_type_AndroidViewView$OnClickListener);
    this.jdField_a_of_type_Aubg.d(10000);
    this.jdField_a_of_type_Aubg.a(this.jdField_a_of_type_AndroidWidgetSeekBar$OnSeekBarChangeListener);
    this.jdField_a_of_type_Aubg.d();
    this.jdField_a_of_type_Atxa.a(this);
    this.jdField_a_of_type_Aubg.f(false);
    b();
    this.jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView = this.jdField_a_of_type_Aubg.a();
    q();
    if (this.jdField_a_of_type_Atux != null) {
      this.jdField_a_of_type_Atux.a(true);
    }
    if ((auea.c(this.jdField_a_of_type_Atxa.d())) && (this.jdField_a_of_type_Atxa.i() == 2)) {
      this.jdField_a_of_type_Aubg.f(true);
    }
    int i = this.jdField_a_of_type_Atxa.i();
    int j = this.jdField_a_of_type_Atxa.h();
    if ((i == 6) && (j == 1))
    {
      this.jdField_a_of_type_Aubg.b(false);
      this.jdField_a_of_type_Aubg.f(false);
      this.jdField_a_of_type_Aubg.c(false);
    }
    this.jdField_a_of_type_Aubg.e(this.jdField_a_of_type_Atxa.l());
    u();
    biwn.a(this.jdField_a_of_type_AndroidAppActivity, 53);
  }
  ...
  public void a(ArrayList<ShareActionSheetBuilder.ActionSheetItem>[] paramArrayOfArrayList, String paramString)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetShareShareActionSheet.setOnDismissListener(new auad(this));
    ...
    for (;;)
    {
      if (((paramArrayOfArrayList != null) && (!paramArrayOfArrayList.isEmpty())) || ((localObject1 != null) && (!((ArrayList)localObject1).isEmpty())))
      {
        ...
        paramString = this.jdField_a_of_type_Atxa.a();
        localObject2 = this.jdField_a_of_type_Atxa.a();
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqWidgetShareShareActionSheet.setItemClickListenerV2(new auae(this));
  ...
  protected void b()
  {
    try
    {
      audy.a("0X8007426");
      audy.a("0X8007427");
      this.jdField_a_of_type_Aubg.a(this.c, this.jdField_a_of_type_AndroidViewView$OnLongClickListener);
      this.jdField_a_of_type_Aubg.h(true);
      if (this.jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView != null)
      {
        this.jdField_a_of_type_Aubg.d(this.jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView.isPlaying());
        return;
      }
      this.jdField_a_of_type_Aubg.d(false);
      return;
    }
  ...
  public void f()
  {
    this.jdField_a_of_type_Aubg.f(true);
    this.jdField_a_of_type_Aubg.b(false);
    if ((this.jdField_a_of_type_Atxa != null) && ((this.jdField_a_of_type_Atxa instanceof aujv))) {
      q();
    }
  }
  ...
  public void i()
  {
    ...
    if (this.jdField_a_of_type_Atml != null) {
      this.jdField_a_of_type_Atml.a(null);
    }
    ...
    if (this.jdField_a_of_type_Atml != null) {
      this.jdField_a_of_type_Atml.a(false);
    }
    int i = 5;
    String str2 = "";
    String str1 = "4";
    String str4 = "";
    int j = this.jdField_a_of_type_Atxa.l();
    String str3;
    if ((j == 3) || (j == 4))
    {
      str3 = this.jdField_a_of_type_Atxa.b();
      str1 = "3";
      i = 2;
    }
    for (;;)
    {
      ...
      bdla.b(null, "dc00898", "", str2, "0X8009AA6", "0X8009AA6", i, 0, str1, "3", str4 + ";" + (String)localObject, str3);
      super.i();
      return;
      if ((j == 5) || (j == 6))
      {
      ...
      {
        str1 = "3";
        str2 = this.jdField_a_of_type_Atxa.b();
        i = 1;
        str3 = str4;
      }
    }
  ...
  public void k()
  {
    super.k();
    aubg localaubg;
    if ((this.jdField_a_of_type_Aubg != null) && (this.jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView != null))
    {
      localaubg = this.jdField_a_of_type_Aubg;
  ...
  protected void n()
  {
    this.jdField_a_of_type_Atxa.a("0X8009D60", null);
    super.n();
    this.jdField_a_of_type_AndroidAppActivity.overridePendingTransition(17432576, 17432577);
  }
  ...
  public void onStateChange(long paramLong, int paramInt)
  {
    ...
    case 4: 
      ...
      this.jdField_a_of_type_Aubg.a(this.jdField_a_of_type_Long);
      if (b() != null)
      {
        paramInt = 1;
        if (paramInt == 0) {
      ...
      for (;;)
      {
        this.jdField_a_of_type_Aubg.h(false);
        return;
        paramInt = 0;
        break;
        label130:
    ...
    this.jdField_a_of_type_AndroidOsPowerManager$WakeLock.release();
    this.jdField_a_of_type_Aubg.c(0);
    this.jdField_a_of_type_Aubg.b(0L);
    this.jdField_a_of_type_Aubg.d(false);
  }
  ...
  public void p()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqWidgetShareShareActionSheet != null)
    {
      arrayOfArrayList = this.jdField_a_of_type_Atxa.b();
