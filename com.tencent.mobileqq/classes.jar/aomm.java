...
public class aomm
{
  private static aomm jdField_a_of_type_Aomm;
  ...
  private aomo jdField_a_of_type_Aomo;
  ...
  private aomm()
  {
    try
    {
      ...
      this.jdField_a_of_type_Aomo = new aomo(this, BaseApplicationImpl.getContext());
  ...
  {
    if (jdField_a_of_type_Aomm == null) {
      jdField_a_of_type_Aomm = new aomm();
    }
    return jdField_a_of_type_Aomm;
  }
  ...
  public int a(apen paramapen, Bundle paramBundle, long paramLong, int paramInt)
  {
    if (-1 == paramInt)
    {
      paramInt = a();
    ...
    while (paramapen != null)
    {
      paramapen.a(new aomn(this, ThreadManager.getSubThreadHandler().getLooper(), paramInt, paramBundle, paramLong), false);
      return paramInt;
  ...
  public Notification a(Bundle paramBundle)
  {
    ...
    if (paramBundle != null)
    {
      ...
      ((Notification)localObject1).icon = 2130843464;
      paramBundle = new RemoteViews(BaseApplication.getContext().getPackageName(), 2131494924);
      paramBundle.setImageViewResource(2131305274, 2130843460);
      paramBundle.setTextViewText(2131305283, (CharSequence)localObject2);
      paramBundle.setProgressBar(2131305268, 100, 0, false);
      paramBundle.setViewVisibility(2131305273, 8);
      paramBundle.setViewVisibility(2131305269, 8);
      paramBundle.setTextColor(2131305283, -7829368);
      paramBundle.setTextColor(2131305273, -7829368);
      paramBundle.setTextColor(2131305270, -7829368);
      float f1 = this.jdField_a_of_type_Aomo.a();
      if (this.jdField_a_of_type_Aomo.a() <= 0.0F)
      {
        QLog.w(jdField_a_of_type_JavaLangString, 1, "[UniformDL]. initNotification param error. getTextSize failed. set defualt value:14");
        f1 = 14.0F;
      }
      paramBundle.setFloat(2131305273, "setTextSize", f1);
      paramBundle.setFloat(2131305270, "setTextSize", f1);
      float f2 = this.jdField_a_of_type_Aomo.b();
      f1 = f2;
      if (f2 <= 0.0F)
      {
      ...
      paramBundle.setFloat(2131305283, "setTextSize", f1);
      ...
      try
      {
        int i = this.jdField_a_of_type_Aomo.a().intValue();
        paramBundle.setInt(2131305275, "setBackgroundColor", (i & 0xFF000000) + (-1 - i));
  ...
  protected void a(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    {
      return;
      paramNotification.tickerText = (BaseApplication.getContext().getString(2131654720) + " " + paramBundle1.getString("_notify_param_Filename"));
      paramNotification.contentView.setImageViewResource(2131305274, 2130843460);
      int i = paramBundle2.getInt("_START_WAITING_");
      if (1 == i)
      {
        paramNotification.contentView.setTextViewText(2131305270, BaseApplication.getContext().getString(2131654721));
        paramNotification.contentView.setViewVisibility(2131305269, 0);
        paramNotification.contentView.setViewVisibility(2131305273, 8);
        paramNotification.contentView.setProgressBar(2131305268, 100, 0, false);
      ...
      for (;;)
      {
        ...
        paramNotification.contentView.setTextViewText(2131305270, "0%");
        break;
        paramNotification.when = a(3);
        break label243;
        paramNotification.contentView.setOnClickPendingIntent(2131305275, paramBundle1);
      }
    }
  }
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    ...
    if (localNotification != null)
    {
      ...
      aome.a().b(paramBundle.getString("_notify_param_Url"));
      return;
    }
  ...
  protected void a(int paramInt, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    localNotification.tickerText = (BaseApplication.getContext().getString(2131654714) + " " + paramBundle1.getString("_notify_param_Filename"));
    ...
    localObject = BaseApplication.getContext().getString(2131654716);
    if (apei.a(str1) != null)
    {
      localBitmap = apei.a(str1);
      localObject = BaseApplication.getContext().getString(2131654715);
    }
    if (localBitmap == null)
    {
      int j = apck.b(str1);
      if (j != 0)
      {
        localNotification.contentView.setImageViewResource(2131305274, j);
        label236:
        localNotification.contentView.setImageViewResource(2131305274, 2130843462);
      }
    }
    for (;;)
    {
      localNotification.contentView.setViewVisibility(2131305273, 0);
      localNotification.contentView.setViewVisibility(2131305269, 8);
      localNotification.contentView.setTextViewText(2131305273, (CharSequence)localObject);
      ...
      localNotification.contentView.setImageViewResource(2131305274, 2130843462);
      break label236;
      localNotification.contentView.setImageViewBitmap(2131305274, localBitmap);
    }
  }
  ...
  protected void b(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    for (;;)
    {
      ...
      paramNotification.contentView.setProgressBar(2131305268, 100, i, false);
      paramNotification.contentView.setTextViewText(2131305270, "" + i + "%");
      paramNotification.flags = 34;
      paramBundle2 = new Intent("com.tencent.mobileqq.UniformDownloadNfn.PAUSE");
      paramBundle2.setPackage(MobileQQ.getContext().getPackageName());
      paramBundle2.putExtra("_PARAM_EXTRA", paramBundle1);
  ...
  public void b(int paramInt, Bundle paramBundle)
  {
    ...
    if (localNotification != null)
    {
      ...
      aome.a().a(paramBundle.getString("_notify_param_Url"), paramBundle.getString("_notify_param_Filename"), paramBundle.getString("_notify_param_ContentTitle", ""), paramBundle.getLong("_notify_param_Filesize"), paramBundle.getBundle("_notify_param_userdata"), paramInt, true);
      return;
    }
  ...
  protected void c(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    paramNotification.tickerText = null;
    int i = paramBundle2.getInt("_FILE_PROGRESS_");
    paramNotification.contentView.setImageViewResource(2131305274, 2130843463);
    paramNotification.contentView.setViewVisibility(2131305273, 0);
    paramNotification.contentView.setViewVisibility(2131305269, 8);
    paramNotification.contentView.setTextViewText(2131305273, BaseApplication.getContext().getString(2131654719));
    paramNotification.contentView.setProgressBar(2131305268, 100, i, false);
    paramNotification.contentView.setTextViewText(2131305270, "" + i + "%");
    ...
    for (;;)
    {
      ...
      paramNotification.contentView.setOnClickPendingIntent(2131305275, paramBundle2);
    }
  }
  ...
  protected void d(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    if (2 == i)
    {
      paramNotification.tickerText = BaseApplication.getContext().getString(2131654718);
      paramNotification.contentView.setTextViewText(2131305273, BaseApplication.getContext().getString(2131654718));
      label115:
      paramNotification.contentView.setImageViewResource(2131305274, 2130843461);
      paramNotification.contentView.setViewVisibility(2131305273, 0);
      paramNotification.contentView.setTextViewText(2131305270, " ");
      paramNotification.flags = 16;
    ...
    for (;;)
    {
      ...
      paramNotification.tickerText = (BaseApplication.getContext().getString(2131654717) + " " + paramBundle1.getString("_notify_param_Filename"));
      paramNotification.contentView.setTextViewText(2131305273, apen.a(i) + ajjy.a(2131650091));
      break label115;
      label397:
      paramNotification.contentView.setOnClickPendingIntent(2131305275, paramBundle2);
    }
