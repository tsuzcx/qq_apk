...
public class bdyn
{
  ...
  public static void a(Window paramWindow)
  {
    ...
    {
      bdnw.b("DisplayUtil", "反射修改状态栏颜色失败");
    }
  }
  ...
  public static void a(Window paramWindow, boolean paramBoolean)
  {
    if (paramBoolean)
    {
      ...
      bdnw.b("DisplayUtil", "MANUFACTURER = " + Build.MANUFACTURER + ", MODEL = " + Build.MODEL);
  ...
  public static boolean a(Context paramContext)
  {
    ...
    for (;;)
    {
      bdnw.a("XPanelContainer", "hasNavbar=" + bool);
      if (bool) {}
  ...
  private static boolean a(Window paramWindow, boolean paramBoolean)
  {
    ...
    if (paramWindow != null) {
      for (;;)
      {
        ...
        {
          int j;
          bdnw.d("DisplayUtil", "setStatusBarDarkModeForFlyme: failed");
          bool = false;
          continue;
          int i = j & 0xFFFFDFFF;
          continue;
  ...
  public static int b(Context paramContext)
  {
    ...
    try
    {
      ...
      {
        bdnw.d("DisplayUtil", paramContext.getMessage());
        return -1;
      }
  ...
  private static void b(Window paramWindow)
  {
    ...
    {
      bdnw.d("DisplayUtil", "", paramWindow);
    }
  }
  ...
  private static boolean b(Activity paramActivity)
  {
    try
    {
      ...
      if (bdnw.a()) {
        bdnw.b("Window", "enableXiaoMiNotch true");
      }
      return true;
    }
    ...
    {
      if (bdnw.a()) {
        bdnw.d("Window", "enableXiaoMiNotch Exception", paramActivity);
      }
    }
    return false;
  }
