  ...
  extends aauq
{
  ...
  private bcux jdField_a_of_type_Bcux;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  
  public bcqo(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Bcux = new bcux(paramQQAppInterface);
  }
  ...
  private boolean g(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    for (;;)
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        ((StringBuilder)localObject1).append("handleAddFriend [uin: ").append(bhbx.b(paramToServiceMsg)).append(", source_id: ").append(i).append(", sub_source_id: ").append(j);
        if (i == 3004)
        {
  ...
  private boolean q(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    //   13: new 840	friendlist/SetGroupReq
    //   16: dup
    //   17: invokespecial 841	friendlist/SetGroupReq:<init>	()V
    //   20: astore 4
    //   22: aload 4
    //   24: aload_1
    ...
    //   31: putfield 842	friendlist/SetGroupReq:uin	J
    //   34: aload 4
    //   36: aload_1
    ...
    //   46: putfield 845	friendlist/SetGroupReq:reqtype	I
    //   49: new 624	java/io/ByteArrayOutputStream
    //   52: dup
    //   53: bipush 10
    //   55: invokespecial 625	java/io/ByteArrayOutputStream:<init>	(I)V
    //   58: astore 5
    //   60: new 627	java/io/DataOutputStream
    //   63: dup
    //   64: aload 5
    //   66: invokespecial 630	java/io/DataOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   69: astore 6
    //   71: aload 4
    //   73: getfield 845	friendlist/SetGroupReq:reqtype	I
    //   76: tableswitch	default:+371 -> 447, 0:+32->108, 1:+140->216, 2:+225->301, 3:+262->338
    //   109: iconst_0
    //   110: iastore
    //   111: dup
    //   112: invokespecial 848	friendlist/AddGroup:<init>	()V
    //   115: astore 7
    //   117: aload 7
    //   119: aload_1
    ...
    //   129: putfield 853	friendlist/AddGroup:cSortId	B
    //   132: aload 7
    //   134: aload_1
    ...
    //   144: putfield 858	friendlist/AddGroup:sGroupName	Ljava/lang/String;
    //   147: aload 7
    //   149: getfield 858	friendlist/AddGroup:sGroupName	Ljava/lang/String;
    //   152: invokevirtual 332	java/lang/String:getBytes	()[B
    //   155: astore_1
    //   156: aload 7
    //   158: aload_1
    //   159: arraylength
    //   160: i2b
    //   161: putfield 861	friendlist/AddGroup:cLen	B
    //   164: aload 6
    //   166: aload 7
    //   168: getfield 853	friendlist/AddGroup:cSortId	B
    //   171: invokevirtual 633	java/io/DataOutputStream:writeByte	(I)V
    //   174: aload 6
    //   176: aload 7
    //   178: getfield 861	friendlist/AddGroup:cLen	B
    //   181: invokevirtual 633	java/io/DataOutputStream:writeByte	(I)V
    //   184: aload 6
    //   186: aload_1
    //   187: invokevirtual 864	java/io/DataOutputStream:write	([B)V
    //   190: aload 6
    //   192: invokevirtual 642	java/io/DataOutputStream:close	()V
    //   195: aload 4
    //   197: aload 5
    //   199: invokevirtual 643	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   202: putfield 865	friendlist/SetGroupReq:vecBody	[B
    //   205: aload_2
    //   206: ldc_w 838
    //   209: aload 4
    ...
    //   214: iconst_1
    //   215: ireturn
    //   216: new 867	friendlist/RenameGroup
    //   219: dup
    //   220: invokespecial 868	friendlist/RenameGroup:<init>	()V
    //   223: astore 7
    //   225: aload 7
    //   227: aload_1
    ...
    //   237: putfield 871	friendlist/RenameGroup:cGroupId	B
    //   240: aload 7
    //   242: aload_1
    ...
    //   252: putfield 872	friendlist/RenameGroup:sGroupName	Ljava/lang/String;
    //   255: aload 7
    //   257: getfield 872	friendlist/RenameGroup:sGroupName	Ljava/lang/String;
    //   260: invokevirtual 332	java/lang/String:getBytes	()[B
    //   263: astore_1
    //   264: aload 7
    //   266: aload_1
    //   267: arraylength
    //   268: i2b
    //   269: putfield 873	friendlist/RenameGroup:cLen	B
    //   272: aload 6
    //   274: aload 7
    //   276: getfield 871	friendlist/RenameGroup:cGroupId	B
    //   279: invokevirtual 875	java/io/DataOutputStream:write	(I)V
    //   282: aload 6
    //   284: aload 7
    //   286: getfield 873	friendlist/RenameGroup:cLen	B
    //   289: invokevirtual 633	java/io/DataOutputStream:writeByte	(I)V
    //   292: aload 6
    //   294: aload_1
    //   295: invokevirtual 864	java/io/DataOutputStream:write	([B)V
    //   298: goto -108 -> 190
    //   301: new 877	friendlist/DelGroup
    //   304: dup
    //   305: invokespecial 878	friendlist/DelGroup:<init>	()V
    //   308: astore 7
    //   310: aload 7
    //   312: aload_1
    ...
    //   322: putfield 879	friendlist/DelGroup:cGroupId	B
    //   325: aload 6
    //   327: aload 7
    //   329: getfield 879	friendlist/DelGroup:cGroupId	B
    //   332: invokevirtual 633	java/io/DataOutputStream:writeByte	(I)V
    //   335: goto -145 -> 190
    //   338: new 881	friendlist/ReSortGroup
    //   341: dup
    //   342: invokespecial 882	friendlist/ReSortGroup:<init>	()V
    //   345: astore 7
    //   347: aload 7
    //   349: aload_1
    ...
    //   359: putfield 886	friendlist/ReSortGroup:cGroupId	[B
    //   362: aload 7
    //   364: aload_1
    ...
    //   374: putfield 890	friendlist/ReSortGroup:cSortId	[B
    //   377: aload 7
    //   379: aload 7
    //   381: getfield 886	friendlist/ReSortGroup:cGroupId	[B
    //   384: arraylength
    //   385: i2b
    //   386: putfield 893	friendlist/ReSortGroup:cNum	B
    //   389: aload 6
    //   391: aload 7
    //   393: getfield 893	friendlist/ReSortGroup:cNum	B
    //   396: invokevirtual 633	java/io/DataOutputStream:writeByte	(I)V
    //   399: aload 7
    //   401: getfield 886	friendlist/ReSortGroup:cGroupId	[B
    //   404: astore_1
    //   405: aload 7
    //   407: getfield 890	friendlist/ReSortGroup:cSortId	[B
    //   410: astore 7
    //   412: iconst_0
    //   413: istore_3
    //   414: iload_3
    ...
    //   423: iload_3
    //   424: baload
    //   425: invokevirtual 633	java/io/DataOutputStream:writeByte	(I)V
    //   428: aload 6
    //   430: aload 7
    //   432: iload_3
    //   433: baload
    //   434: invokevirtual 633	java/io/DataOutputStream:writeByte	(I)V
    //   437: iload_3
    //   438: iconst_1
    //   439: iadd
    //   440: istore_3
  ...
  public Object a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (("friendlist.GetTroopListReqV2".equalsIgnoreCase(paramFromServiceMsg.getServiceCmd())) || ("friendlist.GetMultiTroopInfoReq".equalsIgnoreCase(paramFromServiceMsg.getServiceCmd())) || ("friendlist.getTroopRemark".equalsIgnoreCase(paramFromServiceMsg.getServiceCmd())) || ("friendlist.getTroopMemberList".equalsIgnoreCase(paramFromServiceMsg.getServiceCmd())) || ("friendlist.ModifyGroupCardReq".equalsIgnoreCase(paramFromServiceMsg.getServiceCmd())) || ("friendlist.ModifyGroupInfoReq".equalsIgnoreCase(paramFromServiceMsg.getServiceCmd())) || ("friendlist.GetTroopAppointRemarkReq".equalsIgnoreCase(paramFromServiceMsg.getServiceCmd()))) {
      return this.jdField_a_of_type_Bcux.a(paramToServiceMsg, paramFromServiceMsg);
    }
    return null;
  }
  ...
  public boolean a(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    if ((paramToServiceMsg.getServiceCmd().equalsIgnoreCase("friendlist.GetTroopListReqV2")) || (paramToServiceMsg.getServiceCmd().equalsIgnoreCase("friendlist.getTroopMemberList")) || (paramToServiceMsg.getServiceCmd().equalsIgnoreCase("friendlist.getTroopRemark")) || (paramToServiceMsg.getServiceCmd().equalsIgnoreCase("friendlist.GetMultiTroopInfoReq")) || (paramToServiceMsg.getServiceCmd().equalsIgnoreCase("friendlist.ModifyGroupCardReq")) || (paramToServiceMsg.getServiceCmd().equalsIgnoreCase("friendlist.GetTroopAppointRemarkReq")) || (paramToServiceMsg.getServiceCmd().equalsIgnoreCase("friendlist.ModifyGroupInfoReq"))) {
      return this.jdField_a_of_type_Bcux.a(paramToServiceMsg, paramUniPacket);
    }
    return false;
  }
