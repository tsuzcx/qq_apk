  ...
  extends abiv
{
  ...
  public bcqo(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Bcut = new bcut(paramQQAppInterface);
  }
  ...
  private boolean g(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    for (;;)
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        ((StringBuilder)localObject1).append("handleAddFriend [uin: ").append(bhjx.b(paramToServiceMsg)).append(", source_id: ").append(i).append(", sub_source_id: ").append(j);
        if (i == 3004)
        {
  ...
  private boolean q(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    //   13: new 839	friendlist/SetGroupReq
    //   16: dup
    //   17: invokespecial 840	friendlist/SetGroupReq:<init>	()V
    //   20: astore 4
    //   22: aload 4
    //   24: aload_1
    ...
    //   31: putfield 841	friendlist/SetGroupReq:uin	J
    //   34: aload 4
    //   36: aload_1
    ...
    //   46: putfield 844	friendlist/SetGroupReq:reqtype	I
    ...
    //   69: astore 6
    //   71: aload 4
    //   73: getfield 844	friendlist/SetGroupReq:reqtype	I
    //   76: tableswitch	default:+371 -> 447, 0:+32->108, 1:+140->216, 2:+225->301, 3:+262->338
    //   109: iconst_0
    //   110: astore_3
    //   111: dup
    //   112: invokespecial 847	friendlist/AddGroup:<init>	()V
    //   115: astore 7
    //   117: aload 7
    //   119: aload_1
    ...
    //   129: putfield 852	friendlist/AddGroup:cSortId	B
    //   132: aload 7
    //   134: aload_1
    ...
    //   144: putfield 857	friendlist/AddGroup:sGroupName	Ljava/lang/String;
    //   147: aload 7
    //   149: getfield 857	friendlist/AddGroup:sGroupName	Ljava/lang/String;
    ...
    //   214: iconst_1
    //   215: ireturn
    //   216: new 866	friendlist/RenameGroup
    //   219: dup
    //   220: invokespecial 867	friendlist/RenameGroup:<init>	()V
    //   223: astore 7
    //   225: aload 7
    //   227: aload_1
    ...
    //   237: putfield 870	friendlist/RenameGroup:cGroupId	B
    //   240: aload 7
    //   242: aload_1
    ...
    //   252: putfield 871	friendlist/RenameGroup:sGroupName	Ljava/lang/String;
    //   255: aload 7
    //   257: getfield 871	friendlist/RenameGroup:sGroupName	Ljava/lang/String;
    ...
    //   267: arraylength
    //   268: i2b
    //   269: putfield 872	friendlist/RenameGroup:cLen	B
    //   272: aload 6
    //   274: aload 7
    //   276: getfield 870	friendlist/RenameGroup:cGroupId	B
    //   279: invokevirtual 874	java/io/DataOutputStream:write	(I)V
    //   282: aload 6
    //   284: aload 7
    //   286: getfield 872	friendlist/RenameGroup:cLen	B
    //   289: invokevirtual 632	java/io/DataOutputStream:writeByte	(I)V
    //   292: aload 6
    //   294: aload_1
    //   295: invokevirtual 863	java/io/DataOutputStream:write	([B)V
    //   298: goto -108 -> 190
    //   301: new 876	friendlist/DelGroup
    //   304: dup
    //   305: invokespecial 877	friendlist/DelGroup:<init>	()V
    //   308: astore 7
    //   310: aload 7
    //   312: aload_1
    ...
    //   322: putfield 878	friendlist/DelGroup:cGroupId	B
    //   325: aload 6
    //   327: aload 7
    //   329: getfield 878	friendlist/DelGroup:cGroupId	B
    //   332: invokevirtual 632	java/io/DataOutputStream:writeByte	(I)V
    //   335: goto -145 -> 190
    //   338: new 880	friendlist/ReSortGroup
    //   341: dup
    //   342: invokespecial 881	friendlist/ReSortGroup:<init>	()V
    //   345: astore 7
    //   347: aload 7
    //   349: aload_1
    ...
    //   359: putfield 885	friendlist/ReSortGroup:cGroupId	[B
    //   362: aload 7
    //   364: aload_1
    ...
    //   374: putfield 889	friendlist/ReSortGroup:cSortId	[B
    //   377: aload 7
    //   379: aload 7
    //   381: getfield 885	friendlist/ReSortGroup:cGroupId	[B
    //   384: arraylength
    //   385: i2b
    //   386: putfield 892	friendlist/ReSortGroup:cNum	B
    //   389: aload 6
    //   391: aload 7
    //   393: getfield 892	friendlist/ReSortGroup:cNum	B
    //   396: invokevirtual 632	java/io/DataOutputStream:writeByte	(I)V
    //   399: aload 7
    //   401: getfield 885	friendlist/ReSortGroup:cGroupId	[B
    //   404: astore_1
    //   405: aload 7
    //   407: getfield 889	friendlist/ReSortGroup:cSortId	[B
    //   410: astore 7
    //   412: iconst_0
    //   413: istore_3
    //   414: iload_3
  ...
  public Object a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (("friendlist.GetTroopListReqV2".equalsIgnoreCase(paramFromServiceMsg.getServiceCmd())) || ("friendlist.GetMultiTroopInfoReq".equalsIgnoreCase(paramFromServiceMsg.getServiceCmd())) || ("friendlist.getTroopRemark".equalsIgnoreCase(paramFromServiceMsg.getServiceCmd())) || ("friendlist.getTroopMemberList".equalsIgnoreCase(paramFromServiceMsg.getServiceCmd())) || ("friendlist.ModifyGroupCardReq".equalsIgnoreCase(paramFromServiceMsg.getServiceCmd())) || ("friendlist.ModifyGroupInfoReq".equalsIgnoreCase(paramFromServiceMsg.getServiceCmd())) || ("friendlist.GetTroopAppointRemarkReq".equalsIgnoreCase(paramFromServiceMsg.getServiceCmd()))) {
      return this.jdField_a_of_type_Bcut.a(paramToServiceMsg, paramFromServiceMsg);
    }
    return null;
  }
  ...
  public boolean a(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    if ((paramToServiceMsg.getServiceCmd().equalsIgnoreCase("friendlist.GetTroopListReqV2")) || (paramToServiceMsg.getServiceCmd().equalsIgnoreCase("friendlist.getTroopMemberList")) || (paramToServiceMsg.getServiceCmd().equalsIgnoreCase("friendlist.getTroopRemark")) || (paramToServiceMsg.getServiceCmd().equalsIgnoreCase("friendlist.GetMultiTroopInfoReq")) || (paramToServiceMsg.getServiceCmd().equalsIgnoreCase("friendlist.ModifyGroupCardReq")) || (paramToServiceMsg.getServiceCmd().equalsIgnoreCase("friendlist.GetTroopAppointRemarkReq")) || (paramToServiceMsg.getServiceCmd().equalsIgnoreCase("friendlist.ModifyGroupInfoReq"))) {
      return this.jdField_a_of_type_Bcut.a(paramToServiceMsg, paramUniPacket);
    }
    return false;
  }
