  ...
  extends Drawable
{
  ...
  public beqn(Bitmap paramBitmap)
  {
  ...
  {
    if ((paramDrawable == null) || ((paramDrawable instanceof beqn))) {}
    Object localObject;
    do
    {
    ...
    return new beqn((Bitmap)localObject);
  }
  
  public static beqn a(Bitmap paramBitmap)
  {
    if (paramBitmap != null) {
      return new beqn(paramBitmap);
    }
    return null;
  }
  ...
  {
    float f1 = 0.0F;
    switch (beqo.a[this.jdField_a_of_type_AndroidWidgetImageView$ScaleType.ordinal()])
    {
    case 4: 
    default: 
      this.d.set(this.c);
  ...
  public beqn a(float paramFloat)
  {
  ...
  public beqn a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    int j = 1;
  ...
  public beqn a(ColorStateList paramColorStateList)
  {
  ...
  public beqn a(Shader.TileMode paramTileMode)
  {
  ...
  public beqn a(ImageView.ScaleType paramScaleType)
  {
  ...
  public beqn a(boolean paramBoolean)
  {
    this.jdField_b_of_type_Boolean = paramBoolean;
    return this;
  }
  
  public beqn b(Shader.TileMode paramTileMode)
  {
