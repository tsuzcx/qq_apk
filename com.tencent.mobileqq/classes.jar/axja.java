...
public class axja
  extends axis
{
  private static final String b = bfcj.a(axjg.jdField_a_of_type_JavaLangString + "shortvideo" + File.separator);
  ...
  public axja(MsgBackupResEntity paramMsgBackupResEntity)
  {
  ...
  public axgr a()
  {
    ...
    localaxgr.jdField_a_of_type_JavaLangString = str1;
    if ((!bool1) && (!bool2)) {}
