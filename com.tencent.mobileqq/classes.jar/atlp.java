...
public class atlp
{
  ...
  public static URLDrawable a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    localURLDrawableOptions.mLoadingDrawable = new apkp(-10065297, 100, 100);
    localURLDrawableOptions.mFailedDrawable = new apkp(-10065297, 100, 100);
  ...
  public static URLDrawable a(String paramString1, String paramString2, long paramLong, int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, int paramInt3, QQLiveDrawable.OnStateListener paramOnStateListener, URLDrawable paramURLDrawable)
  {
    ...
    localQQLiveDrawableParams.mCoverLoadingDrawable = new apkp(-10065297, 100, 100);
    ...
    for (paramString1.mLoadingDrawable = paramURLDrawable;; paramString1.mLoadingDrawable = new apkp(-10065297, 100, 100))
    {
      paramString1.mRequestWidth = paramInt1;
      paramString1.mRequestHeight = paramInt2;
      return URLDrawable.getDrawable(agai.a(paramLong), paramString1);
    }
  }
  ...
  public void a(atlq paramatlq)
  {
    this.jdField_a_of_type_Atlq = paramatlq;
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Atlq != null) {
      this.jdField_a_of_type_Atlq.a(paramBoolean);
    }
  }
