  ...
  implements blih
{
  ...
  private Object a()
  {
    ...
    try
    {
      ...
      bnix localbnix = new bnix(this);
      this.jdField_b_of_type_JavaLangObject = Proxy.newProxyInstance(localClassLoader, new Class[] { localClass }, localbnix);
      return this.jdField_b_of_type_JavaLangObject;
    }
  ...
  private void c()
  {
    ...
    try
    {
      localClass.getDeclaredMethod("setStickyNoteComponent", new Class[] { bahq.class }).invoke(this.jdField_a_of_type_AndroidWidgetBaseAdapter, new Object[] { this.jdField_a_of_type_Bahq });
      return;
    }
    catch (Exception localException)
    {
  ...
  public void a()
  {
    if ((this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_ComTencentWidgetListView != null)) {
      this.jdField_a_of_type_ComTencentWidgetListView.setAdapter(new blrq(null));
    }
  }
  ...
  public void a(Activity paramActivity, QQAppInterface paramQQAppInterface, Card paramCard, ListView paramListView, View paramView, bahq parambahq)
  {
    ...
    bmww.a(new bniw(this, paramActivity, paramQQAppInterface, paramListView, paramCard));
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, Activity paramActivity, ListView paramListView, Card paramCard)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramQQAppInterface != bmww.a()) {
          bmww.a(paramActivity, paramQQAppInterface);
        }
