...
public class aqth
  implements bemm
{
  public aqth(UiApiPlugin paramUiApiPlugin, JSONObject paramJSONObject, Activity paramActivity) {}
  ...
  public void a(beml parambeml)
  {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_AndroidAppActivity instanceof BasePluginActivity))
      {
        ...
        ((Intent)localObject2).putExtras(parambeml);
