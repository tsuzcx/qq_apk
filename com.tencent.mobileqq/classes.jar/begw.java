  ...
  extends ReplacementSpan
{
  ...
  public begw(int paramInt1, int paramInt2, int paramInt3)
  {
  ...
  protected Drawable b()
  {
    ...
    {
      localDrawable2 = askx.a(this.jdField_a_of_type_Int);
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          localDrawable2 = behh.a(this.jdField_a_of_type_Int, false);
          localDrawable1 = localDrawable2;
        ...
        localDrawable2 = behh.a(i, false);
        localDrawable1 = localDrawable2;
      } while (localDrawable2 == null);
      localDrawable2.setBounds(0, 0, this.jdField_b_of_type_Int, this.jdField_b_of_type_Int);
      return localDrawable2;
      localDrawable2 = behh.a(i, true);
      localDrawable1 = localDrawable2;
    } while (localDrawable2 == null);
    localDrawable2.setBounds(0, 0, this.jdField_b_of_type_Int, this.jdField_b_of_type_Int);
    return localDrawable2;
