...
public class aovb
{
  ...
  private aovd jdField_a_of_type_Aovd;
  private aptf jdField_a_of_type_Aptf;
  private aptj jdField_a_of_type_Aptj = new aovc(this);
  ...
  public static boolean a()
  {
    ...
    if (!TextUtils.isEmpty(str))
    {
      ...
      arrayOfString[0] = "";
      int i = DeviceProfileManager.a(str, arrayOfString, new ankn());
      if (i >= 1) {
  ...
  public void a(Context paramContext, aovd paramaovd)
  {
    long l = System.currentTimeMillis();
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Aovd = paramaovd;
    b();
    jdField_a_of_type_Boolean = this.jdField_a_of_type_Aptf.b();
    apcf.a().c(System.currentTimeMillis() - l);
  }
  ...
  public void b()
  {
    ...
    label57:
    for (this.jdField_a_of_type_Aptf = new aptf(this.jdField_a_of_type_AndroidContentContext, 5);; this.jdField_a_of_type_Aptf = new aptf(this.jdField_a_of_type_AndroidContentContext, 4))
    {
      if (QLog.isColorLevel()) {
        QLog.d("SensorTrackManager", 2, "startupSensor");
      }
      this.jdField_a_of_type_Aptf.a(this.jdField_a_of_type_Aptj, 1);
      return;
    }
  }
  ...
  public void c()
  {
    ...
    if (this.jdField_a_of_type_Aptf != null)
    {
      this.jdField_a_of_type_Aptf.a();
      this.jdField_a_of_type_Aptf = null;
    }
  }
