...
public class bfeg
{
  ...
  private OnPluginInstallListener jdField_a_of_type_ComTencentMobileqqPluginsdkOnPluginInstallListener = new bfeh(this);
  
  public bfeg(Context paramContext, bfcz parambfcz, QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Bfcz = parambfcz;
  ...
  private List<String> a()
  {
    ...
    if (badq.a(this.jdField_a_of_type_AndroidContentContext))
    {
      ...
      if (i < k)
      {
        ...
        if ((str.equals("Photoplus.apk")) && (befo.d())) {}
        for (;;)
        {
          i += 1;
          break;
    ...
    if ((babp.e()) || (bace.a() <= 1.048576E+008F))
    {
  ...
  private void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    localEditor.commit();
    this.jdField_a_of_type_Bfcz.a(paramString, this.jdField_a_of_type_ComTencentMobileqqPluginsdkOnPluginInstallListener, true);
    if (("qqreaderplugin.apk".equals(paramString)) && (bflo.a(this.jdField_a_of_type_AndroidContentContext) == -1))
    {
    ...
    bezd.a(1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  }
  ...
  private void c()
  {
    if (!PreferenceManager.getDefaultSharedPreferences(this.jdField_a_of_type_AndroidContentContext).getString("plugin_pre_install_qq_version", "").equals(babp.c()))
    {
      SharedPreferences.Editor localEditor = PreferenceManager.getDefaultSharedPreferences(this.jdField_a_of_type_AndroidContentContext).edit();
  ...
  public void a()
  {
    try
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        try
        {
          if (this.jdField_a_of_type_Bfcz.isPlugininstalled(str)) {
            continue;
          }
          int i = a(str);
          if (i >= 10) {
