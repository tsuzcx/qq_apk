  ...
  extends bfed
{
  ...
  public bfeg(JSONObject paramJSONObject)
  {
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      while (i1 < paramJSONObject.length())
      {
        ...
        {
          localObject = new bfee(l1, ((JSONObject)localObject).optString("name") + anzj.a(2131713883), this.jdField_e_of_type_JavaLangString.replace("${bid}", String.valueOf(l1)));
  ...
  public static ArrayList<bfeg> a(JSONArray paramJSONArray)
  {
    ...
    for (;;)
    {
      if (i1 < paramJSONArray.length()) {
        try
        {
          bfeg localbfeg = new bfeg(paramJSONArray.optJSONObject(i1));
          if (localbfeg != null) {
            localArrayList.add(new bfeg(paramJSONArray.optJSONObject(i1)));
          }
          i1 += 1;
        }
