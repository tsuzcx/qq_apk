  ...
  implements slk
{
  ...
  public static int a(Context paramContext)
  {
    ...
    sne.b("wifiInfo", paramContext.toString());
    sne.b("SSID", "" + paramContext.getIpAddress());
  ...
  public static stReportItem a()
  {
    ...
    if (TextUtils.isEmpty((CharSequence)localObject))
    {
      ...
      localstReportItem.qua = bgxr.a();
      localstReportItem.vendor = bbct.h();
      localObject = new stDevice();
      ((stDevice)localObject).encrypted_deviceid = skb.a().e();
      ...
      if (!vzz.a(BaseApplicationImpl.getContext())) {
        break label200;
      }
    }
    label200:
  ...
  public static stReportItem a(stSimpleMetaFeed paramstSimpleMetaFeed, int paramInt)
  {
    ...
    {
      sne.d("weishi-report", "convertFeedToReport feed == null");
      return localstReportItem;
    }
  ...
  private static String a()
  {
    ...
    if ((c.endsWith(ajyc.a(2131715973))) && (c.length() > 1)) {
  ...
  private static String a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      default: 
        return str;
        str = ajyc.a(2131715969);
        continue;
        str = ajyc.a(2131715946);
        continue;
        str = ajyc.a(2131715956);
        continue;
        str = ajyc.a(2131715963);
        continue;
        str = ajyc.a(2131715953);
        continue;
        str = ajyc.a(2131715957);
        continue;
        str = ajyc.a(2131715972);
        continue;
        str = ajyc.a(2131715940);
        continue;
        str = ajyc.a(2131715943);
        continue;
        str = ajyc.a(2131715948);
        continue;
        str = ajyc.a(2131715970);
        continue;
        str = ajyc.a(2131715965);
        continue;
        str = ajyc.a(2131715959);
        switch (paramInt2)
        {
        default: 
          break;
        case 12: 
          str = ajyc.a(2131715935);
          continue;
          str = ajyc.a(2131715967);
          continue;
          str = ajyc.a(2131715974);
          continue;
          str = ajyc.a(2131715947);
          continue;
          str = ajyc.a(2131715968);
          continue;
          str = ajyc.a(2131715942);
          continue;
          str = ajyc.a(2131715938);
          continue;
          str = ajyc.a(2131715958);
          continue;
          str = ajyc.a(2131715936);
          continue;
          str = ajyc.a(2131715962);
          switch (paramInt2)
          {
          default: 
            break;
          case 12: 
            str = ajyc.a(2131715950);
            continue;
            str = ajyc.a(2131715944);
            switch (paramInt2)
            {
            default: 
              break;
            case 12: 
              str = ajyc.a(2131715952);
              continue;
              str = ajyc.a(2131715939);
              continue;
              str = ajyc.a(2131715949);
              continue;
              str = ajyc.a(2131715954);
              switch (paramInt2)
              {
              default: 
                break;
              case 2: 
                str = ajyc.a(2131715971);
                break;
              case 6: 
                str = ajyc.a(2131715960);
                continue;
                str = ajyc.a(2131715961);
                switch (paramInt2)
                {
                default: 
                  break;
                case 2: 
                  str = ajyc.a(2131715964);
                  break;
                case 14: 
                  str = ajyc.a(2131715941);
                  break;
                case 12: 
                  str = ajyc.a(2131715937);
                  break;
                case 6: 
                  str = ajyc.a(2131715945);
                  continue;
                  str = ajyc.a(2131715951);
                  switch (paramInt2)
                  {
                  case 10: 
                  case 11: 
  ...
  public static String a(Context paramContext)
  {
    ...
    try
    {
      jdField_a_of_type_JavaLangString = bfmw.a("1d76c6");
    ...
    catch (Throwable paramContext)
    {
      for (;;)
      {
        sne.d("weishi-810", "telephonyManager.getDeviceId encounter error:" + paramContext);
      }
    }
  }
  ...
  public static void a(stReportItem paramstReportItem)
  {
    if (paramstReportItem == null)
    {
      sne.d("weishi-report", "report error item = null");
      return;
    }
  ...
  public static void a(ArrayList<stReportItem> paramArrayList)
  {
    ...
    {
      sne.d("weishi-report", "report error items: " + paramArrayList);
      return;
    }
    ...
    while (localIterator.hasNext())
    {
      ...
      sne.b("weishi-report", "report " + str + " stReportItem:" + localstReportItem.toString());
    }
    paramArrayList = new slv(new smz(paramArrayList), null, new smr(str), 2001);
    slo.a().a(paramArrayList);
  }
  ...
  public static String b(Context paramContext)
  {
    ...
    try
    {
      sne.b("weishi-810", "try get QIMei from UserAction.getQIMEI!");
      b = UserAction.getQIMEI();
      if (b == null)
      {
        sne.d("weishi-810", "getImei finally encounter error and return empty");
        b = "";
      }
      return b;
    }
    catch (Throwable paramContext)
    {
      for (;;)
      {
        sne.d("weishi-810", "UserAction.getQIMEI encounter error:" + paramContext);
      }
    }
  }
