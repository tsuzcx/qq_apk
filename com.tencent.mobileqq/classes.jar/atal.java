...
public class atal
{
  ...
  public static atam a(int paramInt1, int paramInt2, atan paramatan, boolean paramBoolean)
  {
    ...
    default: 
      ...
      if (i > j)
      {
        i3 = i;
        n = j;
        switch (paramatan.jdField_a_of_type_Int)
        {
        default: 
          paramatan = new atam();
          paramatan.jdField_a_of_type_Int = paramInt1;
          paramatan.b = paramInt2;
          return paramatan;
        }
      }
      break;
  ...
  public static atam a(int paramInt1, int paramInt2, String paramString)
  {
    int i = g;
    int j = h;
    ...
    if (FileUtils.fileExistsAndNotEmpty(paramString))
    {
      ...
      localatam.jdField_a_of_type_Int = localOptions.outWidth;
      localatam.b = localOptions.outHeight;
      paramString = localatam;
  ...
  public static atam a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    int i;
    if (paramInt1 > paramInt2) {
      i = paramInt2;
    ...
    {
      atan localatan = a(i, j);
      i = a(paramInt1, paramInt2, jdField_a_of_type_Int);
      return a(paramInt1 * i, i * paramInt2, localatan, false);
      i = paramInt1;
    }
  }
  
  public static atam a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    if (FileUtils.fileExistsAndNotEmpty(paramFileManagerEntity.strMiddleThumPath))
    {
      ...
      localatam.jdField_a_of_type_Int = localOptions.outWidth;
      localatam.b = localOptions.outHeight;
      paramFileManagerEntity = localatam;
  ...
  private static atan a(int paramInt1, int paramInt2)
  {
    int i = 0;
    int j = 1;
    ...
    for (;;)
    {
      atan localatan = new atan();
      localatan.jdField_a_of_type_Int = paramInt2;
      localatan.b = paramInt1;
      return localatan;
      paramInt1 = 2;
      paramInt2 = 2;
      continue;
  ...
  public static String a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    if (!TextUtils.isEmpty(paramFileManagerEntity.strFileMd5)) {
      paramFileManagerEntity = bjkz.a(paramFileManagerEntity.strFileMd5);
    }
    for (;;)
    {
      ...
      {
        paramFileManagerEntity = bjkz.a(paramFileManagerEntity.Uuid);
      }
      else if (FileUtil.fileExistsAndNotEmpty(paramFileManagerEntity.getFilePath()))
      {
        localObject = aszt.e(paramFileManagerEntity.getFilePath());
        if ((localObject != null) && (localObject.length > 0)) {
          paramFileManagerEntity = HexUtil.bytes2HexStr((byte[])localObject).toUpperCase();
        } else {
          paramFileManagerEntity = bjkz.a(paramFileManagerEntity.fileName);
        }
      }
      else
      {
  ...
  public static String a(String paramString)
  {
    ...
    {
      return null;
      String str1 = HexUtil.bytes2HexStr(aszt.e(paramString));
      a();
      str1 = asyy.a().d() + a(5, str1);
        ...
        for (;;)
        {
          ...
          try
          {
            if (!FileUtils.fileExistsAndNotEmpty(str2)) {
              ayfc.a(paramString, str2, true, "", 1);
            }
            if ((!FileUtils.fileExistsAndNotEmpty(str2)) || (FileUtils.renameFile(new File(str2), new File(str1)) != true)) {
              break;
            }
            return str1;
          }
  ...
  private static String a(String paramString1, String paramString2, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ayfc.a(paramString1, str, true, "", paramInt);
      ...
      continue;
      label220:
      if (!FileUtils.renameFile(new File(str), new File(paramString2)))
      {
  ...
  public static URL a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    if (TextUtils.isEmpty((CharSequence)localObject1)) {
      localObject2 = HexUtil.bytes2HexStr(aszt.e(paramFileManagerEntity.getFilePath())).toUpperCase();
    }
    localObject1 = asyy.a().d() + a(5, bjkz.a((String)localObject2));
    if ((FileUtils.fileExistsAndNotEmpty(str)) && (!FileUtil.fileExistsAndNotEmpty(paramFileManagerEntity.strMiddleThumPath)) && (FileUtils.renameFile(new File(str), new File((String)localObject1)) == true)) {
  ...
  private static void a(FileManagerEntity paramFileManagerEntity, String paramString)
  {
    ...
    paramString = a(paramString, asyy.a().d() + a(5, str), 1);
    if (paramString == null) {
  ...
  {
    if ((paramFileManagerEntity.status == 16) && (!aszt.e(paramFileManagerEntity))) {}
    while ((paramFileManagerEntity.cloudType == 1) && (aszt.a(paramFileManagerEntity))) {
      return true;
    }
    return false;
  }
