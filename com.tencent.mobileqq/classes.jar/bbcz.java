...
public class bbcz
{
  private static bbcz jdField_a_of_type_Bbcz;
  public static final Object a;
  public int a;
  final bbcq jdField_a_of_type_Bbcq = new bbcq(new bbda(this));
  public boolean a;
  public int b = 0;
  ...
  public static bbcz a()
  {
    if (jdField_a_of_type_Bbcz == null) {}
    try
    {
      if (jdField_a_of_type_Bbcz == null) {
        jdField_a_of_type_Bbcz = new bbcz();
      }
      return jdField_a_of_type_Bbcz;
    }
    finally {}
  }
  ...
  public int a(Bundle paramBundle)
  {
    ...
    for (boolean bool = BaseApplicationImpl.sApplication.getSharedPreferences("sp_x5_config_" + (String)localObject, 4).getBoolean("key_x5_init_sub_thread", true);; bool = true)
    {
      ...
      bbdb.b();
      bbca.X = System.currentTimeMillis() - l;
      QLog.i("WebLog_SwiftWebAccelerator", 1, "initX5Environment on main thread, cost " + bbca.X + "ms.");
      return 1;
    }
  }
  ...
  public void a(Bundle paramBundle)
  {
    if (Looper.getMainLooper() == Looper.myLooper())
    {
      if (!this.jdField_a_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_Bbcq.b();
        this.jdField_a_of_type_Bbcq.a(localBundle);
  ...
  public int b(Bundle paramBundle)
  {
    ...
    bbca.Y = System.currentTimeMillis() - l;
    QLog.i("WebLog_SwiftWebAccelerator", 1, "doMainStep_CreateWebView:create webview cost " + bbca.Y + "ms.");
    return 1;
  }
  ...
  public int c(Bundle paramBundle)
  {
    ...
    bbca.Z = System.currentTimeMillis() - l;
    QLog.i("WebLog_SwiftWebAccelerator", 1, "tendocpreload doMainStep_WarnUpWebView:load " + paramBundle + ", cost " + bbca.Z + "ms.");
    return 1;
  }
  ...
  public int e(Bundle paramBundle)
  {
    ...
    if (WebAccelerateHelper.preloadBrowserView == null)
    {
      ...
      bbca.aa = System.currentTimeMillis() - l;
      QLog.i("WebLog_SwiftWebAccelerator", 1, "doMainStep_CreateBrowserView, cost = " + bbca.aa + "ms.");
      return 1;
    }
    return 0;
  }
