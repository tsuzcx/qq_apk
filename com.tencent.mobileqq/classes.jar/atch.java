...
public class atch
{
  ...
  public String a;
  List<atco> jdField_a_of_type_JavaUtilList = new ArrayList();
  public boolean a;
  public byte[] a;
  public String b;
  public boolean b;
  ...
  void a(AppInterface paramAppInterface)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localJSONObject.put("openid", this.jdField_a_of_type_Aszh.a().jdField_b_of_type_JavaLangString);
        localJSONObject.put("accesstoken", this.jdField_a_of_type_Aszh.a().jdField_a_of_type_JavaLangString);
  ...
  public void a(AppInterface paramAppInterface, atcp paramatcp)
  {
    if (!bdne.d(paramAppInterface.getApp().getApplicationContext())) {
      return;
    }
    if (this.jdField_a_of_type_Long == 0L)
    {
      b(paramAppInterface);
      paramAppInterface = new atcl(this, paramAppInterface, paramatcp);
      this.jdField_a_of_type_JavaUtilList.add(paramAppInterface);
      return;
    }
    b(paramAppInterface, paramatcp);
  }
  ...
  public void a(AppInterface paramAppInterface, String paramString)
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Long == 0L)
      {
        this.jdField_a_of_type_JavaUtilList.add(new atci(this, paramAppInterface));
        b(paramAppInterface);
        return;
      }
    }
  ...
  public void b(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_Aszh.a(paramAppInterface, "", paramAppInterface.getApplication(), "101462571", new atcj(this, paramAppInterface));
  }
  
  void b(AppInterface paramAppInterface, atcp paramatcp)
  {
    if (this.jdField_a_of_type_Boolean) {
      return;
    }
    ...
    ((NewIntent)localObject).setObserver(new atcm(this, paramatcp));
  ...
  public void b(AppInterface paramAppInterface, String paramString)
  {
    ...
    try
    {
      ...
      paramString.put("openid", this.jdField_a_of_type_Aszh.a().jdField_b_of_type_JavaLangString);
      paramString.put("accesstoken", this.jdField_a_of_type_Aszh.a().jdField_a_of_type_JavaLangString);
  ...
  public void c(AppInterface paramAppInterface)
  {
    ...
    ((NewIntent)localObject).putExtra("data", localiLiveRequest.toByteArray());
    ((NewIntent)localObject).setObserver(new atcn(this));
    paramAppInterface.startServlet((NewIntent)localObject);
  }
}
