  ...
  implements ampc<String>
{
  ...
  private ArrayList<sff> jdField_a_of_type_JavaUtilArrayList = new ArrayList(0);
  private boolean jdField_a_of_type_Boolean;
  
  public static nqf a(String paramString)
  {
    try
    {
      nqf localnqf = (nqf)ampv.a(paramString, nqf.class);
      return localnqf;
    }
  ...
  public static nqf a(amph[] paramArrayOfamph)
  {
    nqf localnqf = null;
    int i = 0;
    while (i < paramArrayOfamph.length)
    {
      localnqf = a(paramArrayOfamph[i].jdField_a_of_type_JavaLangString);
      i += 1;
    }
    return localnqf;
  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if ((localAppRuntime instanceof QQAppInterface)) {
        bbkb.f(((QQAppInterface)localAppRuntime).getApplication(), this.jdField_a_of_type_JavaLangString);
      }
    }
  ...
  {
    if (this.jdField_a_of_type_Boolean) {
      sfe.a(this.jdField_a_of_type_JavaUtilArrayList);
    }
  }
}
