...
class amuu
  implements Runnable
{
  amuu(amut paramamut, PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo, boolean paramBoolean) {}
  
  public void run()
  {
    int j = this.jdField_a_of_type_Amut.a.jdField_a_of_type_ComTencentWidgetGridView.getFirstVisiblePosition();
    int k = this.jdField_a_of_type_Amut.a.jdField_a_of_type_ComTencentWidgetGridView.getLastVisiblePosition();
    int i = j;
    if (i <= k)
    {
      if (i < 0) {}
      do
      {
        i += 1;
        break;
        localObject1 = (PtvTemplateManager.PtvTemplateInfo)this.jdField_a_of_type_Amut.a.jdField_a_of_type_JavaUtilArrayList.get(i);
      ...
      Object localObject2 = this.jdField_a_of_type_Amut.a.jdField_a_of_type_ComTencentWidgetGridView.getChildAt(i - j);
    ...
    if ((QIMPtvTemplateAdapter.a(this.jdField_a_of_type_Amut.a) < 0) || (QIMPtvTemplateAdapter.a(this.jdField_a_of_type_Amut.a) >= this.jdField_a_of_type_Amut.a.jdField_a_of_type_JavaUtilArrayList.size())) {}
    label214:
    while ((!((PtvTemplateManager.PtvTemplateInfo)this.jdField_a_of_type_Amut.a.jdField_a_of_type_JavaUtilArrayList.get(QIMPtvTemplateAdapter.a(this.jdField_a_of_type_Amut.a))).id.equals(this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.id)) || (!this.jdField_a_of_type_Boolean) || (QIMPtvTemplateAdapter.a(this.jdField_a_of_type_Amut.a) == null))
    {
      return;
      i = -1;
      break;
    ...
    if (this.jdField_a_of_type_Amut.a.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.kind == 3)
    {
      QIMPtvTemplateAdapter.jdField_a_of_type_JavaLangString = "";
      QIMPtvTemplateAdapter.a(this.jdField_a_of_type_Amut.a).a((String)localObject1);
      QIMPtvTemplateAdapter.a(this.jdField_a_of_type_Amut.a).a("", false, false);
    }
    for (;;)
    {
      i = AdvancedProviderView.b();
      QIMPtvTemplateAdapter.a(this.jdField_a_of_type_Amut.a).c(i);
      i = AdvancedProviderView.c();
      QIMPtvTemplateAdapter.a(this.jdField_a_of_type_Amut.a).b(i, false);
      ...
      QIMPtvTemplateAdapter.a(this.jdField_a_of_type_Amut.a).a(101, new Object[0]);
      return;
      QIMPtvTemplateAdapter.a(this.jdField_a_of_type_Amut.a).a((String)localObject1, false, false);
      QIMPtvTemplateAdapter.a(this.jdField_a_of_type_Amut.a).a(null);
    }
  }
}
