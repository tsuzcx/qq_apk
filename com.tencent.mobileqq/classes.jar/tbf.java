...
public class tbf
{
  ...
  private static long a(String paramString)
  {
    ...
    catch (Exception localException)
    {
      ...
      bctj.a(BaseApplicationImpl.getApplication()).a(null, "actKandianFastWebCost", false, 0L, 0L, localHashMap, null);
    }
    return -1L;
  }
  ...
  public static Map<String, String> a(Context paramContext)
  {
    ...
    HashMap localHashMap = new HashMap();
    Object localObject1 = teh.a("native_article", true);
    if (localObject1 == null) {
      return localHashMap;
    }
    localObject1 = ((teh)localObject1).getTemplate("ReadInjoy_article_text_cell");
    if (localObject1 == null) {
      return localHashMap;
    }
    ...
    try
    {
      ...
      int m = bclx.a(paramContext);
      int n = bclx.b(paramContext);
  ...
  public static void a(ArticleInfo paramArticleInfo, ProteusItemData paramProteusItemData, int paramInt, SparseArray<Float> paramSparseArray)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        return;
        float f1 = tba.b(paramSparseArray);
        continue;
        f1 = tba.c(paramSparseArray);
        continue;
        float f2 = -1000.0F;
        f1 = f2;
        switch (paramInt)
  ...
  public static void a(ArticleInfo paramArticleInfo, tht paramtht)
  {
    if (paramArticleInfo == null) {
      return;
    }
    QLog.d("FastWebRequestUtil", 2, "deleteFeeds.");
    ThreadManager.excute(new FastWebRequestUtil.6(paramArticleInfo, paramtht), 128, null, true);
  }
  ...
  public static void a(String paramString, FastWebArticleInfo paramFastWebArticleInfo)
  {
    ...
    try
    {
      ...
      nlw.a(localBundle);
      paramString = new String(nlw.a(BaseApplicationImpl.getContext(), "https://c.mp.qq.com/review/img-txt-comment/list?source=1", "POST", paramString, localBundle));
    }
  ...
  private static void a(String paramString1, String paramString2, String paramString3, String paramString4, boolean paramBoolean, String paramString5, String paramString6, String paramString7, int paramInt1, long paramLong, tbk paramtbk, int paramInt2)
  {
    ThreadManager.executeOnNetWorkThread(new FastWebRequestUtil.4(paramString1, paramString2, paramString3, paramString4, paramString6, paramString7, paramBoolean, paramInt1, paramLong, paramString5, paramInt2, paramtbk));
  }
  
  public static void a(String paramString1, String paramString2, String paramString3, String paramString4, boolean paramBoolean, String paramString5, String paramString6, String paramString7, tbj paramtbj, int paramInt1, int paramInt2, long paramLong)
  {
    paramtbj = new tbi(paramString1, paramtbj);
    a(paramString1, paramString2, paramString3, new tbg(paramtbj), paramInt2);
    a(paramString1, paramString2, paramString3, paramString4, paramBoolean, paramString5, paramString6, paramString7, paramInt1, paramLong, new tbh(paramtbj), paramInt2);
  }
  
  private static void a(String paramString1, String paramString2, String paramString3, tbk paramtbk, int paramInt)
  {
    ThreadManager.executeOnNetWorkThread(new FastWebRequestUtil.3(paramString1, paramString2, paramInt, paramtbk));
  }
  ...
  private static String b(Map<String, String> paramMap, JSONObject paramJSONObject)
  {
    try
    {
      ...
      paramMap = ((QQAppInterface)pha.a()).getAccount();
      if (QLog.isColorLevel()) {
      ...
      paramMap = nlw.a(BaseApplicationImpl.getContext(), paramJSONObject, "GET", null, paramMap);
      if (paramMap == null)
      {
  ...
  private static List<BaseData> b(int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i < localJSONArray.length())
        {
          ...
          try
          {
            ...
            else
            {
              ...
              localObject2 = ((teh)localObject2).getTemplateBean(localJSONObject);
              if (localObject2 != null)
              {
        ...
        localObject4 = bisa.a().b((String)localObject4);
      }
  ...
  {
    paramString5 = (QQAppInterface)pha.a();
    ...
    for (paramString1 = "";; paramString1 = rvd.a(paramString6))
    {
      paramString5.put("token", paramString1);
      paramString5.put("cookie", nxw.a());
  ...
  private static JSONObject b(String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localObject1 = new acry();
        ((acry)localObject1).jdField_a_of_type_JavaLangString = "ce2d9f";
        ...
        if (localObject1 != null)
        {
          ...
          localJSONObject.put("carrier", acsa.a(BaseApplicationImpl.getContext()));
          ...
          if (localObject1 != null)
          {
            ...
            localObject2 = "";
            localJSONObject.put("muid", localObject2);
            localJSONObject.put("bytes_wx_ver", opp.a(BaseApplication.getContext()));
            if (QLog.isColorLevel()) {
  ...
  public static void b(ArticleInfo paramArticleInfo, tht paramtht)
  {
    if (paramArticleInfo == null) {
      return;
    }
    QLog.d("FastWebRequestUtil", 2, "shieldFeedSource");
    ThreadManager.excute(new FastWebRequestUtil.7(paramArticleInfo, paramtht), 128, null, true);
  }
  ...
  private static boolean b(String paramString1, String paramString2, List<BaseData> paramList, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        nxw.a(((JSONObject)localObject).optString("cookie"));
        ...
        if (j < localJSONArray.length())
        {
          ...
          if (((JSONObject)localObject).isNull("ad_pos_type"))
          {
            ...
            localObject = a(oqg.a((JSONObject)localObject, paramJSONObject), 1, false, str, i, k);
            oqj.a((AdData)localObject);
            if (localObject != null)
            {
              ((AdData)localObject).f = false;
          ...
          else
          {
            ...
            {
              ((JSONObject)localObject).put("rowkey", paramString2);
              localObject = a(oqg.a((JSONObject)localObject, paramJSONObject), 1, true, str, -1, k);
              oqj.a((AdData)localObject);
              if (localObject == null) {
                break label439;
              }
    ...
    {
      ((JSONObject)localObject).put("rowkey", paramString2);
      localObject = a(oqg.a((JSONObject)localObject, paramJSONObject), 2, false, str, -1, k);
      if (localObject != null)
      {
