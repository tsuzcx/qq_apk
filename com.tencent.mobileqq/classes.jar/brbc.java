  ...
  implements brba
{
  ...
  private brbb jdField_a_of_type_Brbb;
  private brbe jdField_a_of_type_Brbe;
  private brbf jdField_a_of_type_Brbf;
  ...
  private void b()
  {
    if ((this.jdField_a_of_type_Braz == null) || (this.jdField_a_of_type_Braz.a())) {}
    int i;
    do
    {
      return;
  ...
  private void c()
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetScroller.computeScrollOffset())
    {
      ...
      b();
      if (this.jdField_a_of_type_Brbb != null) {
        this.jdField_a_of_type_Brbb.invalidate();
      }
    ...
    label157:
    while (this.jdField_a_of_type_Brbe == null)
    {
      return;
      this.jdField_a_of_type_Brbf.a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
      break;
    }
    this.jdField_a_of_type_Brbe.a(this.jdField_d_of_type_Float, -this.jdField_d_of_type_Float, this.f - this.jdField_d_of_type_Float);
  }
  
  public void a()
  {
    this.jdField_a_of_type_Brbb.postInvalidate();
  }
  ...
  {
    if (this.jdField_a_of_type_Braz == null) {
      return;
    }
    c();
    ...
    while (i < k)
    {
      brbd localbrbd = this.jdField_a_of_type_Braz.a(i);
      if (localbrbd != null)
      {
        ...
        this.jdField_a_of_type_AndroidGraphicsCanvas.drawBitmap(localbrbd.jdField_a_of_type_AndroidGraphicsBitmap, this.jdField_c_of_type_AndroidGraphicsRect, this.jdField_c_of_type_AndroidGraphicsRect, this.jdField_a_of_type_AndroidGraphicsPaint);
      }
