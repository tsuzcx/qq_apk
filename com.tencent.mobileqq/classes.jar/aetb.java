...
public class aetb
  extends aniz
{
  public aetb(PermisionPrivacyActivity paramPermisionPrivacyActivity) {}
  ...
  protected void onGetAllowStrangerInviteToGroupSwitch(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    if (!paramBoolean1)
    {
      ...
      Card localCard = ((anmw)this.a.app.getManager(51)).c(this.a.app.getCurrentAccountUin());
  ...
  protected void onGetCalReactiveDays(boolean paramBoolean1, boolean paramBoolean2)
  {
    if ((paramBoolean1) && (!this.a.isFinishing()))
    {
      ...
      this.a.jdField_a_of_type_ComTencentMobileqqWidgetFormSimpleItem.setRightText(anni.a(2131698269));
    }
    for (;;)
    {
      ...
      return;
      label106:
      this.a.jdField_a_of_type_ComTencentMobileqqWidgetFormSimpleItem.setRightText(anni.a(2131698270));
    }
  }
  ...
  protected void onGetTroopHonorSwitch(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      if (paramBoolean2) {
        this.a.b.setRightText(anni.a(2131698269));
      }
    }
    else {
      return;
    }
    this.a.b.setRightText(anni.a(2131698270));
  }
  ...
  protected void onSetMedal(boolean paramBoolean)
  {
    ...
    Object localObject1 = ((anmw)this.a.app.getManager(51)).c(this.a.app.getCurrentAccountUin());
    ...
    for (;;)
    {
      bcst.b((QQAppInterface)localObject2, "dc00898", "", "", "0X80073A0", "0X80073A0", i, 0, "", "", "", "");
      return;
      label260:
      paramBoolean = false;
      break;
