...
{
  aetb(aesy paramaesy, View paramView, ActionSheet paramActionSheet) {}
  
  private void a()
  {
    ReportController.b(this.jdField_a_of_type_Aesy.a.app, "CliOper", "", "", "0X800682D", "0X800682D", 0, 0, "", "", "", "");
    long l = 0L;
    for (;;)
    {
      try
    ...
    ((Bundle)localObject).putString("_filename_from_dlg", this.jdField_a_of_type_Aesy.a.getResources().getString(2131435123));
    ...
    if ((localObject instanceof Integer))
    {
      ...
      Message.obtain(MusicPlayerActivity.a(this.jdField_a_of_type_Aesy.a), 54, 2131438500, i, this.jdField_a_of_type_AndroidViewView).sendToTarget();
      return;
    }
  }
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (!UniformDownloadMgr.a().a("http://misc.wcd.qq.com/app?packageName=com.tencent.qqmusic&channelId=10000435")) {
        ThreadManager.post(new aetc(this), 5, null, true);
      }
    }
  }
}
