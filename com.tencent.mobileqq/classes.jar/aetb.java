...
public class aetb
{
  ...
  private Set<aetf> jdField_a_of_type_JavaUtilSet;
  private Set<Integer> jdField_b_of_type_JavaUtilSet;
  
  static
  {
    jdField_a_of_type_JavaLangString = bduw.a(aljq.aW + "/Tencent/MobileQQ/pttPanelAnimations/");
    jdField_b_of_type_JavaLangString = bduw.a(aljq.aW + "/Tencent/MobileQQ/pttPanelAnimations/qq_android_ptt_transition_anim_res/");
  }
  ...
  private void a(Animator paramAnimator, int paramInt)
  {
    ...
    {
      aetf localaetf = (aetf)localIterator.next();
      if (localaetf != null) {
        localaetf.a(paramAnimator, paramInt);
      }
    }
  }
  ...
  private void a(LottieDrawable paramLottieDrawable, int paramInt)
  {
    ...
    while (localIterator.hasNext())
    {
      aetf localaetf = (aetf)localIterator.next();
      if (localaetf != null) {
        localaetf.a(paramLottieDrawable, paramInt);
      }
    }
  }
  ...
  {
    this.jdField_a_of_type_JavaUtilSet.add(paramaetf);
  }
  ...
  public void a(LottieDrawable paramLottieDrawable, int paramInt, ImageView paramImageView, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      paramLottieDrawable.addAnimatorListener(new aetd(this, paramLottieDrawable, paramInt, paramImageView));
    } while (!paramBoolean);
