...
public class rmb
{
  ...
  public static String a()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localJSONObject.put("osVersion", babp.e());
        localJSONObject.put("appName", babp.c());
        localJSONObject.put("appVersion", "8.2.6.4370");
        ...
        bjeh.a(BaseActivity.sTopActivity);
        if (!bjeh.b()) {
          continue;
        }
        i = 1;
        ...
        localJSONObject.put("netType", mpl.a());
      }
  ...
  {
    String str = mol.a(paramString1);
    if (TextUtils.isEmpty(str)) {}
    do
    {
      return null;
      paramString1 = str + paramString1;
      paramString2 = mof.d(paramString2);
  ...
  public static String c(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      localSharedPreferences = bgmq.a(BaseApplicationImpl.getApplication().getRuntime(), true, true);
