...
public class akhu
  extends PhotoListLogicBase<NewPhotoListActivity, akib>
  implements PhotoListLogic.IadapterCallback, PhotoListLogic.IcheckBoxCallback, PhotoListLogic.IitemClickCallback, zgr
{
  public akht a;
  
  public akhu(NewPhotoListActivity paramNewPhotoListActivity)
  {
    super(paramNewPhotoListActivity);
    this.mPhotoListData = new akht();
    this.a = ((akht)this.mPhotoListData);
  }
  ...
  int a(List<LocalMediaInfo> paramList)
  {
    ...
    if (this.a.photoListStartPos == -1)
    {
      ...
      Object localObject = (LinkedHashMap)bgkc.sSelectItemPosMap.get(this.mPhotoCommonData.albumId);
      k = i;
      if (localObject != null)
      {
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if ((paramInt1 >= 0) && (paramInt1 < localArrayList.size()) && (paramInt2 >= 0) && (paramInt2 < localArrayList.size()))
    {
      ...
      zgl.a().b(localArrayList, this.mPhotoCommonData.allMediaInfoHashMap);
    }
  ...
  protected void a(Intent paramIntent, boolean paramBoolean, ArrayList<String> paramArrayList)
  {
    ...
    for (i = 1;; i = 0)
    {
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        localObject1 = ((NewPhotoListActivity)this.mActivity).getResources().getString(2131717742);
        ...
        if (bigl.a(this.mActivity, 4, new akhw(this, paramIntent))) {
          bglp.a(this.mActivity, 232, null, (String)localObject1, new akhx(this, paramIntent), new akhy(this)).show();
        }
        if (QLog.isColorLevel()) {
  ...
  public void a(SlideItemInfo paramSlideItemInfo)
  {
    ...
    for (;;)
    {
      if ((i >= 0) && (i < ((List)localObject2).size()))
      {
        ...
        akgm.a(((NewPhotoListActivity)this.mActivity).getIntent(), "param_cancelSelNum");
        localObject2 = (HashMap)bgkc.sSelectItemPosMap.get(this.mPhotoCommonData.albumId);
        if (localObject2 != null) {
      ...
      akgm.a(((NewPhotoListActivity)this.mActivity).getIntent(), "param_cancelSelNum");
      localObject1 = (HashMap)bgkc.sSelectItemPosMap.get(this.mPhotoCommonData.albumId);
  ...
  protected void a(LocalMediaInfo paramLocalMediaInfo, int paramInt)
  {
    ...
    for (;;)
    {
      bgkc.a(localIntent, this.mPhotoCommonData.albumId, str, this.a.isRecodeLastAlbumPath);
  ...
  boolean a(LocalMediaInfo paramLocalMediaInfo, CheckBox paramCheckBox)
  {
    ...
    if ((this.a.jdField_a_of_type_Int == 9501) && (((NewPhotoListActivity)this.mActivity).getIntent().getBooleanExtra("PhotoConst.IS_SEND_FILESIZE_LIMIT", false)) && (paramLocalMediaInfo.selectStatus != 1))
    {
      ...
      for (l = 0L; localIterator.hasNext(); l = bgmg.a((String)localIterator.next()) + l) {}
      if (bgmg.a(paramLocalMediaInfo.path) + l > 52428800L)
      {
    ...
    if ((((NewPhotoListActivity)this.mActivity).getIntent().getBooleanExtra("PhotoConst.IS_SEND_GIF_SIZE_LIMIT", false)) && (((NewPhotoListActivity)this.mActivity).isGif(paramLocalMediaInfo)) && (bgmg.a(paramLocalMediaInfo.path) > 3145728L))
    {
      QQToast.a(this.mActivity, "图片文件过大", 0).b(((NewPhotoListActivity)this.mActivity).mTitleBarHeight);
      paramCheckBox.setChecked(false);
      return false;
    }
    return (!((akib)this.mOtherCommonData).a()) || (bpwu.a(this.mActivity, paramLocalMediaInfo));
  }
  ...
  protected void b()
  {
    ...
    {
      akgm.a(((NewPhotoListActivity)this.mActivity).getIntent(), this.mPhotoCommonData.selectedPhotoList.size());
      akgm.a(((NewPhotoListActivity)this.mActivity).getIntent(), this.mPhotoCommonData.selectedPhotoList.size(), this.mPhotoCommonData.currentQualityType);
    }
    Intent localIntent = ((NewPhotoListActivity)this.mActivity).getIntent();
  ...
  public Intent caseNoSingModeImage(View paramView, int paramInt)
  {
    ...
    paramView.putExtra("PhotoConst.editPathMap", akft.a(this.a.jdField_c_of_type_JavaUtilHashMap));
  ...
  public void d()
  {
    ...
    bgkc.a(((NewPhotoListActivity)this.mActivity).b, localPhotoCommonBaseData.selectedPhotoList, localPhotoCommonBaseData.allMediaInfoHashMap, this.a.j, this.mActivity, this.a.jdField_a_of_type_JavaUtilHashMap, localPhotoCommonBaseData.selectedMediaInfoHashMap);
  ...
  public void doOnDestroy()
  {
    if (this.mPhotoCommonData.isShowQzoneAlbum) {
      BaseApplicationImpl.getApplication().getRuntime().unRegistObserver(((NewPhotoListActivity)this.mActivity).jdField_a_of_type_Akhq);
    }
    if (((akib)this.mOtherCommonData).a()) {
      zgl.a().f();
    }
  ...
  public void doOnResume()
  {
    ...
    } while (!((akib)this.mOtherCommonData).a());
    zgl.a().c();
    zgl.a().a(this.a.jdField_a_of_type_Zgp);
  }
  
  void e()
  {
    Object localObject = zgl.a().a();
    if (this.a.k) {
      zgl.a().b((List)localObject);
    }
    ...
    if (this.mPhotoCommonData.selectedPhotoList.size() > 0) {
      zgl.a().a(this.mPhotoCommonData.selectedPhotoList, this.mPhotoCommonData.allMediaInfoHashMap, false);
    }
  }
  ...
  protected void e(LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    {
      localObject = this.a;
      ((akht)localObject).videoSelectedCnt += 1;
      if (this.a.videoSelectedCnt == 1) {
    ...
    {
      localObject = this.a;
      ((akht)localObject).gifSelectedCount += 1;
    }
    ...
    akgm.a(((NewPhotoListActivity)this.mActivity).getIntent(), "param_totalSelNum");
    ...
    paramLocalMediaInfo = (LinkedHashMap)bgkc.sSelectItemPosMap.get(this.mPhotoCommonData.albumId);
    if (paramLocalMediaInfo == null)
    {
      paramLocalMediaInfo = new LinkedHashMap();
      bgkc.sSelectItemPosMap.put(this.mPhotoCommonData.albumId, paramLocalMediaInfo);
    }
    for (;;)
    {
  ...
  public void enterAlbumListFragment(Intent paramIntent)
  {
    ...
    paramIntent.putExtra("PhotoConst.PHOTO_INFOS", ((akib)this.mOtherCommonData).jdField_a_of_type_JavaUtilHashMap);
  ...
  public void enterPhotoPreviewActivity(boolean paramBoolean, Intent paramIntent)
  {
    ...
    if (!paramBoolean)
    {
      ...
      if ((localArrayList != null) && (localArrayList.size() > 0)) {
        bcst.b(null, "CliOper", "", this.mPhotoCommonData.myUin, "0X8004072", "0X8004072", 0, localArrayList.size(), 0, "", "", "", "");
      }
      if ((((akib)this.mOtherCommonData).jdField_a_of_type_JavaUtilHashMap == null) || (((akib)this.mOtherCommonData).jdField_a_of_type_JavaUtilHashMap.size() <= 0)) {
        break label355;
      }
      paramIntent.putExtra("PhotoConst.PHOTO_INFOS", ((akib)this.mOtherCommonData).jdField_a_of_type_JavaUtilHashMap);
  ...
  protected void f(LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    akgm.a(((NewPhotoListActivity)this.mActivity).getIntent(), "param_cancelSelNum");
    paramLocalMediaInfo = (HashMap)bgkc.sSelectItemPosMap.get(this.mPhotoCommonData.albumId);
    if (paramLocalMediaInfo != null) {
  ...
  public String getExceedMaxSelectNumStr(LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    if (paramLocalMediaInfo != null)
    {
      ...
      if ((((akib)this.mOtherCommonData).a()) && (!this.a.isSupportVideoCheckbox)) {
        return ((NewPhotoListActivity)this.mActivity).getResources().getString(2131694276, new Object[] { Integer.valueOf(i) });
      }
      if ((this.a.isSupportVideoCheckbox) && (paramLocalMediaInfo != null) && ("video".equals(paramLocalMediaInfo[0])))
      {
        if (((akib)this.mOtherCommonData).a()) {
          return ((NewPhotoListActivity)this.mActivity).getResources().getString(2131694277, new Object[] { Integer.valueOf(i) });
        }
        return ((NewPhotoListActivity)this.mActivity).getResources().getString(2131694275, new Object[] { Integer.valueOf(i) });
      }
    }
    return str;
  }
  ...
  public void handleVideoCapture(Intent paramIntent)
  {
    ...
    wip localwip = new wip();
    localwip.a(true);
    localObject = wip.a((String)localObject);
    String str = alvn.a(((PublishVideoEntry)localObject).mLocalRawVideoDir);
    if (TextUtils.isEmpty(str))
    {
      QZLog.i("PhotoListActivity", 1, "get target path fail");
      return;
    }
    localwip.a((PublishVideoEntry)localObject, str, false, true, new akia(this, l, str, (PublishVideoEntry)localObject, paramIntent));
  }
  ...
  public void handleVideoEncodeSucceed(Message paramMessage)
  {
    ...
    if ((paramMessage.obj instanceof String))
    {
      ...
      QQToast.a(this.mActivity, String.format(((NewPhotoListActivity)this.mActivity).getResources().getString(2131694275), new Object[] { Integer.valueOf(PhotoCommonBaseData.getInstance().maxSelectNum) }), 0).a();
    }
    for (;;)
    {
  ...
  public void initData(Intent paramIntent)
  {
    ...
    akft.a(this.mActivity, paramIntent, false, this.a.jdField_c_of_type_JavaUtilHashMap);
    ...
    ((akib)this.mOtherCommonData).jdField_a_of_type_JavaUtilHashMap = ((HashMap)paramIntent.getSerializableExtra("PhotoConst.PHOTO_INFOS"));
    ...
    try
    {
      ...
      if (this.mPhotoCommonData.isShowQzoneAlbum)
      {
        ...
        BaseApplicationImpl.getApplication().getRuntime().registObserver(((NewPhotoListActivity)this.mActivity).jdField_a_of_type_Akhq);
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      if (zgl.a().a().isEmpty())
      {
        ...
        if ((paramView != null) && (((NewPhotoListActivity)this.mActivity).mGridView.getHeight() - paramView.getY() < ((NewPhotoListActivity)this.mActivity).mImageHeight)) {
          ((NewPhotoListActivity)this.mActivity).mGridView.smoothScrollBy(zgl.jdField_a_of_type_Int, 500);
        }
      }
      ...
      if (i < this.mPhotoCommonData.selectedPhotoList.size())
      {
        ...
        for (;;)
        {
          ...
          if (!new File(str).exists()) {
            if ((str.startsWith("http")) && (((akib)this.mOtherCommonData).jdField_a_of_type_JavaUtilHashMap != null))
            {
              j = i;
              if (((akib)this.mOtherCommonData).jdField_a_of_type_JavaUtilHashMap.containsKey(str)) {}
            }
            else
            {
  ...
  public void onSendBtnClick(View paramView)
  {
    ...
    if (((NewPhotoListActivity)this.mActivity).getIntent().getBooleanExtra("PhotoConst.IS_SEND_FILESIZE_LIMIT", false))
    {
      ...
      if (atvo.a())
      {
        atvb.a(this.mActivity, 2131692321, 2131692326, new akhz(this));
        return;
      }
    }
    b();
  ...
  public void postInitUI()
  {
    ...
    int i;
    if ((this.a.isSingleMode) || (this.mPhotoCommonData.showMediaType == 2) || (((akib)this.mOtherCommonData).a()))
    {
      i = 8;
  ...
  {
    if (akft.a(paramLocalMediaInfo.path, this.a.jdField_c_of_type_JavaUtilHashMap))
    {
      if (Build.VERSION.SDK_INT >= 21) {
        paramHolder.mPhotoFlagView.setImageDrawable(((NewPhotoListActivity)this.mActivity).getDrawable(2130839353));
      }
      for (;;)
      {
        paramHolder.mPhotoFlagView.setVisibility(0);
        return;
        paramHolder.mPhotoFlagView.setImageResource(2130839353);
      }
    }
  ...
  {
    if (paramList != null) {
      akft.a(paramList, paramInt, null, this.a.jdField_c_of_type_JavaUtilHashMap);
    }
  ...
  public void updateButton()
  {
    ...
    if (localArrayList.size() > 0)
    {
      ...
      if ((localArrayList.size() != 1) || ((((akib)this.mOtherCommonData).jdField_a_of_type_JavaUtilHashMap != null) && (((akib)this.mOtherCommonData).jdField_a_of_type_JavaUtilHashMap.size() > 0)) || (((NewPhotoListActivity)this.mActivity).a((String)localArrayList.get(0)) != 0)) {
        break label363;
      }
