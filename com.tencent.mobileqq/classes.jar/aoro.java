...
{
  aoro(FileManagerEntity paramFileManagerEntity, Activity paramActivity, boolean paramBoolean) {}
  ...
  public void onClick(View paramView)
  {
    ...
    {
      if ((bool1) && (!bace.b(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.getFilePath())))
      {
        bbmy.a(BaseApplicationImpl.getApplication(), 1, BaseApplicationImpl.getApplication().getString(2131654233), 0).b(BaseApplicationImpl.getApplication().getResources().getDimensionPixelSize(2131167766));
        return;
        awqx.b(paramView, "dc00898", "", "", "0X8009063", "0X8009063", 0, 0, "", "", "", "");
        break;
        label232:
      ...
      axea.a(localTeamWorkFileImportInfo, this.jdField_a_of_type_AndroidAppActivity, paramView, localTeamWorkFileImportInfo.jdField_d_of_type_Int);
      return;
