  ...
  extends PopupWindow
{
  ...
  private qwu jdField_a_of_type_Qwu;
  private int b;
  private int c = 80;
  private int d = 49;
  
  public qwt(Context paramContext)
  {
    super(-2, -2);
  ...
  private void a()
  {
    ...
    qwu localqwu = new qwu(this, this.jdField_a_of_type_AndroidContentContext);
    FrameLayout.LayoutParams localLayoutParams = new FrameLayout.LayoutParams(-2, -2);
    this.jdField_a_of_type_Qwu = localqwu;
  ...
  private void b()
  {
    ...
    qwu.a(this.jdField_a_of_type_Qwu).setColor(this.jdField_a_of_type_Int);
    this.jdField_a_of_type_AndroidWidgetFrameLayout.addView(this.jdField_a_of_type_Qwu, this.jdField_a_of_type_AndroidWidgetFrameLayout$LayoutParams);
    FrameLayout.LayoutParams localLayoutParams = new FrameLayout.LayoutParams(-2, -2);
    ...
    for (;;)
    {
      ...
      return;
      localLayoutParams.rightMargin = qwu.a(this.jdField_a_of_type_Qwu);
      this.jdField_a_of_type_Qwu.setRotation(90.0F);
      continue;
      localLayoutParams.bottomMargin = qwu.b(this.jdField_a_of_type_Qwu);
      this.jdField_a_of_type_Qwu.setRotation(180.0F);
      continue;
      localLayoutParams.leftMargin = qwu.a(this.jdField_a_of_type_Qwu);
      this.jdField_a_of_type_Qwu.setRotation(270.0F);
      continue;
      localLayoutParams.topMargin = qwu.b(this.jdField_a_of_type_Qwu);
      this.jdField_a_of_type_Qwu.setRotation(0.0F);
    }
  }
  ...
  {
    qwu.c(this.jdField_a_of_type_Qwu, paramInt);
  }
  
  public void a(int paramInt1, int paramInt2)
  {
    qwu.a(this.jdField_a_of_type_Qwu, paramInt1);
    qwu.b(this.jdField_a_of_type_Qwu, paramInt2);
  }
  ...
  public int c()
  {
    return qwu.b(this.jdField_a_of_type_Qwu);
  }
