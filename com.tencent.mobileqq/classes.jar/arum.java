...
public class arum
{
  ...
  public arum(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqVasVasQuickUpdateManager$CallBacker = new arun(this);
    this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(paramQQAppInterface);
  }
  
  public static awfr a(JSONObject paramJSONObject)
  {
  ...
  public arum a(String paramString1, String paramString2)
  {
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    } while (localSharedPreferences.getInt("magic_promotion_old_ver_" + arno.a(), -1) >= paramJSONObject.jdField_b_of_type_Int);
    localSharedPreferences.edit().putBoolean("magic_promotion_is_new_content_" + arno.a(), true).commit();
    localSharedPreferences.edit().putInt("magic_promotion_old_ver_" + arno.a(), paramJSONObject.jdField_b_of_type_Int).commit();
  }
}
