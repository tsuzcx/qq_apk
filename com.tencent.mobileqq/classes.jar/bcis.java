  ...
  extends bcgw
{
  ...
  public bcis(int paramInt, String paramString1, String paramString2)
  {
    this();
    this.o = paramInt;
  ...
  public View a(Context paramContext, View paramView, int paramInt, Bundle paramBundle)
  {
    ...
    if ((paramView != null) && ((paramView instanceof LinearLayout)))
    {
      ...
      localObject1 = (ImageView)localLinearLayout.findViewById(2131379480);
      paramBundle = (ImageView)localLinearLayout.findViewById(2131379483);
      paramView = (TextView)localLinearLayout.findViewById(2131379481);
      localObject3 = bfvo.a();
      ...
      if (paramBundle != null)
      {
        ...
        paramBundle.setImageResource(2130850377);
      }
    }
    for (;;)
    {
      ...
      localLinearLayout.setId(2131379482);
      ...
      for (int j = 53;; j = 135)
      {
        ...
        ((ImageView)localObject1).setId(2131379480);
      ...
      label594:
      if (paramInt == 1) {
        paramBundle.setImageResource(2130850379);
      } else if (paramInt == 3) {
        paramBundle.setImageResource(2130850378);
      } else if (paramInt == 4) {
        paramBundle.setImageResource(2130850376);
      }
    }
  }
  ...
  public boolean a(bcin parambcin)
  {
    ...
    String str2 = parambcin.a("uin");
    String str1 = str2;
    if (str2 == null) {
      str1 = "";
    }
    this.ac = str1;
    str1 = parambcin.a("nick");
    parambcin = str1;
    if (str1 == null) {
      parambcin = "";
    }
