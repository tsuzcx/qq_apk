...
public class ppe
{
  ...
  {
    return szf.a.a(paramArticleInfo, paramInt);
  }
          ...
          do
          {
            do
            {
              do
              {
                ...
                l1 = l2;
              } while (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq == null);
              return paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.jdField_a_of_type_Long;
              if (paramInt != 76) {
                break;
              }
              l1 = l2;
            ...
            l1 = l2;
          } while (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqy == null);
          return paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqy.jdField_a_of_type_Long;
  ...
  public static int d(ArticleInfo paramArticleInfo)
  {
    ...
    do
    {
      do
      {
        ...
        if (pqw.q(paramArticleInfo)) {
          return 10;
        }
      } while (!pqw.p(paramArticleInfo));
      return 8;
  ...
  {
    if ((!f(paramArticleInfo)) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqw == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqw.b == null)) {
      return false;
    }
    switch (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqw.b.intValue())
    {
    default: 
      return false;
    }
  ...
  {
    return (f(paramArticleInfo)) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqw != null);
  }
  
  public static boolean e(BaseArticleInfo paramBaseArticleInfo)
  {
    return (paramBaseArticleInfo != null) && (paramBaseArticleInfo.mSocialFeedInfo != null) && (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqy != null) && (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqy.c == 1);
  }
  ...
  {
    return (paramBaseArticleInfo != null) && (paramBaseArticleInfo.mSocialFeedInfo != null) && (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqy != null) && (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqy.c == 0) && (b((ArticleInfo)paramBaseArticleInfo));
  }
  ...
  {
    return (paramBaseArticleInfo.mFeedType == 1) && (paramBaseArticleInfo.mSocialFeedInfo != null) && (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqw != null) && (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqw.b != null) && (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqw.b.longValue() == 11L);
  }
  
  public static boolean i(ArticleInfo paramArticleInfo)
  {
    if ((paramArticleInfo == null) || (paramArticleInfo.mSocialFeedInfo == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqw == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqw.b == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq == null)) {
      return false;
    }
    switch (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqw.b.intValue())
    {
  ...
  {
    if ((paramArticleInfo == null) || (paramArticleInfo.mSocialFeedInfo == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqw == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqw.b == null)) {
      return false;
    }
    switch (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqw.b.intValue())
    {
  ...
  {
    return (paramBaseArticleInfo.mFeedType != 30) && ((paramBaseArticleInfo.mSocialFeedInfo == null) || (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq == null) || (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.c.isEmpty()));
  }
  
  public static boolean l(ArticleInfo paramArticleInfo)
  {
    return (k(paramArticleInfo)) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.jdField_a_of_type_Int == 1);
  }
  
  public static boolean l(BaseArticleInfo paramBaseArticleInfo)
  {
    return (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rsh == null) || (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rsh.jdField_a_of_type_JavaUtilArrayList == null) || (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rsh.jdField_a_of_type_JavaUtilArrayList.isEmpty());
  }
  
  public static boolean m(ArticleInfo paramArticleInfo)
  {
    return (i(paramArticleInfo)) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.jdField_a_of_type_Int == 1);
  }
  ...
  {
    return (paramArticleInfo.mSocialFeedInfo == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq == null);
  }
  
  public static boolean p(ArticleInfo paramArticleInfo)
  {
    return (paramArticleInfo.mSocialFeedInfo == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.jdField_a_of_type_JavaUtilArrayList.size() == 0);
  }
  
  public static boolean q(ArticleInfo paramArticleInfo)
  {
    return (paramArticleInfo.mSocialFeedInfo == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.b.size() == 0);
  }
}
