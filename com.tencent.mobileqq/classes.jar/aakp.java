  ...
  extends Dialog
{
  ...
  public aakp(@NonNull Context paramContext)
  {
  ...
  private void b()
  {
    this.jdField_a_of_type_Aall = new aall(new aakq(this), this.jdField_a_of_type_Aakx, true);
    ...
    if (Build.VERSION.SDK_INT >= 19) {
      ((ViewGroup)localObject1).setOnSystemUiVisibilityChangeListener(new aakr(this, (ViewGroup)localObject1));
    }
    Object localObject2 = this.jdField_a_of_type_Aall.a(LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity), (ViewGroup)localObject1);
    setContentView((View)localObject2);
    setOnDismissListener(new aaks(this));
    ((ViewGroup)localObject1).getViewTreeObserver().addOnGlobalLayoutListener(new aakt(this, (ViewGroup)localObject1, (View)localObject2));
    this.jdField_a_of_type_AndroidAppApplication$ActivityLifecycleCallbacks = new aaku(this);
  ...
  {
    if (this.jdField_a_of_type_Aall.c()) {
      return;
    }
    super.onBackPressed();
  }
  ...
  public void onWindowFocusChanged(boolean paramBoolean)
  {
    ...
    aanp.a("GdtMotiveVideoDialog", "onWindowFocusChanged() called with: hasFocus = [" + paramBoolean + "]");
