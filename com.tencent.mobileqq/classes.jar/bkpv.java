...
public class bkpv
{
        ...
        if (paramInt4 == 10004)
        {
          ...
          if ((TextUtils.isEmpty(paramLocalMediaInfo.path)) || (paramLocalMediaInfo.path.equalsIgnoreCase("null")))
          {
            ...
            if (paramInt7 == 11)
            {
              bool2 = false;
              bool1 = false;
              localObject = azcf.a(paramActivity.getIntent().getExtras());
              if (localObject == null) {
                break label1531;
              }
            ...
            break label1734;
            label639:
            if (birt.a(paramActivity.getIntent(), paramInt7)) {
              break label1757;
            }
            if (!birt.c(paramActivity.getIntent())) {
              break label1764;
            }
            break label1757;
            label664:
            ...
            paramString1.f = paramActivity.getIntent().getIntExtra("VIDEO_STORY_FROM_TYPE", birt.a.a());
            if (paramActivity.getIntent().getBooleanExtra("is_video_forward", false)) {
              paramString1.e = 4;
            }
            if (l4 != 0L) {
            ...
            if ((paramInt1 / paramInt2 >= axlk.jdField_a_of_type_Int / axlk.jdField_b_of_type_Int) && (!paramActivity.getIntent().getBooleanExtra("is_video_forward", false)))
            {
              paramString1.a.putBoolean("extra_is_fit_center", true);
              if (vzu.a(paramInt1, paramInt2, axlk.jdField_a_of_type_Int, axlk.jdField_b_of_type_Int)) {
            ...
            paramLocalMediaInfo.putExtra("VIDEO_STORY_FROM_TYPE", birt.a(paramActivity.getIntent()));
            if (paramInt7 == 14)
            {
              paramLocalMediaInfo.putExtra("VIDEO_STORY_JUMP_TO_TYPE", birt.b(paramActivity.getIntent()));
              paramLocalMediaInfo.putExtra("VIDEO_STORY_MEDIA_TYPE", birt.c(paramActivity.getIntent()));
            }
            if (paramBundle != null) {
  ...
  public static boolean a()
  {
    ...
    if (localtcs == null)
    {
      ved.e("Q.qqstory.publish.QQStoryFlowCallback", "StoryConfigManager(CONFIG_MANAGER) is null!");
      return false;
    }
    int i = localtcs.b();
    if (i == h) {
    ...
    jdField_a_of_type_Int = ((Integer)localtcs.b("localUploadVideoSizeLimit", Integer.valueOf(jdField_a_of_type_Int))).intValue();
    jdField_b_of_type_Int = ((Integer)localtcs.b("localUploadVideoMinResolutionLimit", Integer.valueOf(jdField_b_of_type_Int))).intValue();
    c = ((Integer)localtcs.b("localUploadVideoDurationLimit", Integer.valueOf(c))).intValue();
    e = ((Integer)localtcs.b("localUploadVideoRatioLimit", Integer.valueOf(e))).intValue();
    f = ((Integer)localtcs.b("localUploadImageSizeLimit", Integer.valueOf(f))).intValue();
    g = ((Integer)localtcs.b("localUploadImageMinResolutionLimit", Integer.valueOf(g))).intValue();
    jdField_a_of_type_Float = e / 10000 / 1000.0F;
    jdField_b_of_type_Float = e % 10000 / 1000.0F;
    ved.d("Q.qqstory.publish.QQStoryFlowCallback", "Update Limit Config %d|%d|%d|%d|%d|%d", new Object[] { Integer.valueOf(jdField_a_of_type_Int), Integer.valueOf(jdField_b_of_type_Int), Integer.valueOf(c), Integer.valueOf(e), Integer.valueOf(f), Integer.valueOf(g) });
    ved.d("Q.qqstory.publish.QQStoryFlowCallback", "Update Limit Config from %d to %d", new Object[] { Integer.valueOf(h), Integer.valueOf(i) });
    h = localtcs.b();
    return true;
  }
  ...
  public static boolean a(Activity paramActivity, Intent paramIntent, int paramInt)
  {
    ...
    if (localLocalMediaInfo == null) {
      throw new IllegalArgumentException(ajya.a(2131710891));
    }
  ...
  public static boolean a(@NonNull Activity paramActivity, @NonNull LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    if (paramLocalMediaInfo.mMimeType.contains("video")) {
      ...
      {
        localObject = bcql.a(paramActivity, 1, "暂不支持选择超过3分钟的视频", 0);
        ved.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
        k = 5;
        j = 4;
        i = 1;
      }
    ...
    for (;;)
    {
      vei.b("upload_local_video", "choose_media_info", 0, j, new String[] { a(paramLocalMediaInfo) });
      String str1;
      label197:
      String str3;
      if (i != 0)
      {
        ...
        vei.a("video_shoot", "chose_video", 0, 0, new String[] { str1, String.valueOf(k), String.valueOf(f1) });
        if ((i != 0) && (paramLocalMediaInfo.mDuration >= 20500L)) {
          vei.a("video_shoot", "local_over", 0, 0, new String[0]);
        }
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          vei.a("pic_choose_toast", str1, i, 0, new String[] { str3 });
          if (paramLocalMediaInfo.addedDate == 0L)
          {
            ...
            if (paramLocalMediaInfo.addedDate != 0L)
            {
              i = 0;
              label372:
              vei.b("upload_local_video", "media_info_missing", 0, i, new String[] { a(paramLocalMediaInfo) });
            }
          }
          else
          {
            if (localObject != null) {
              paramActivity.runOnUiThread(new QQStoryFlowCallback.1((bcql)localObject));
            }
            if (j != 0) {
              break label1074;
            }
          ...
          for (;;)
          {
            ...
            {
              localObject = bcql.a(paramActivity, 1, "请选择时长大于2秒的视频", 0);
              ved.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
              j = 5;
              k = 6;
              i = 1;
            ...
            {
              localObject = bcql.a(paramActivity, 1, ajya.a(2131710881), 0);
              ved.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
              k = 1;
              j = 1;
              i = 1;
            ...
            {
              localObject = bcql.a(paramActivity, 1, ajya.a(2131710869), 0);
              ved.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
              k = 3;
              j = 2;
              i = 1;
            ...
            if ((f1 < 0.4F) || (f1 > 2.2F))
            {
              localObject = bcql.a(paramActivity, 1, ajya.a(2131710874), 0);
              ved.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
              k = 4;
              j = 3;
              i = 1;
            ...
            localObject = bcql.a(paramActivity, 1, ajya.a(2131710860), 0);
            ved.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
            j = 6;
            k = 8;
            i = 1;
            ...
            {
              localObject = bcql.a(paramActivity, 1, ajya.a(2131710876), 0);
              ved.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
              k = 1;
              j = 1;
              i = 0;
            ...
            {
              localObject = bcql.a(paramActivity, 1, ajya.a(2131710875), 0);
              ved.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
              k = 3;
              j = 2;
              i = 0;
            ...
            localObject = bcql.a(paramActivity, 1, ajya.a(2131710873), 0);
            ved.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
            k = 4;
            j = 3;
            i = 0;
