...
public class onq
{
  public static int a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    if (onh.d(paramBaseArticleInfo)) {
      return 3;
    }
    if (onh.a(paramBaseArticleInfo)) {
      return 2;
    }
    return 0;
  }
  ...
  public static Intent a(Context paramContext, ArticleInfo paramArticleInfo)
  {
    ...
    for (;;)
    {
      ...
      paramContext.putExtra("req_create_time", ong.a(paramArticleInfo.mTime));
  ...
  {
    // Byte code:
    //   0: invokestatic 213	onh:a	()Lmqq/app/AppRuntime;
  ...
  public static Intent b(Context paramContext, ArticleInfo paramArticleInfo)
  {
    if (onh.a(paramArticleInfo.mArticleContentUrl, paramArticleInfo.mChannelID, paramArticleInfo))
    {
      ...
      if (localObject1 != null) {
        ((paf)localObject1).a(paramArticleInfo.mArticleContentUrl, String.valueOf(paramArticleInfo.innerUniqueID), paramArticleInfo.mSubscribeID, 1, null);
      }
    ...
    if (ram.b(paramArticleInfo))
    {
      ...
      if (!ram.f(paramArticleInfo)) {
        localObject1 = ((qds)paramArticleInfo.mSocialFeedInfo.a.a.get(0)).b;
      }
    }
    ...
    else
    {
      ...
      localBundle.putBoolean("preload_tool_white_list", onh.f());
      ...
      if ((bbdx.b(ajsd.cG + paramContext)) && (PreloadManager.a().b(paramContext) != null))
      {
        ...
        if (!osg.a().a(paramArticleInfo.mArticleID))
        {
          ...
          {
            ThreadManager.post(new ReadinjoyJumpUtils.1(paramArticleInfo, (seu)paramContext.get(0)), 5, null, false);
            if (paramContext.size() <= 1) {
              break label742;
            }
            localBundle.putString("preload_iamge_url", ((seu)paramContext.get(1)).a);
          }
        }
      }
    }
    for (;;)
    {
      ...
      paramContext = paramArticleInfo.a(paramContext);
      if ((paramContext != null) && (paramContext.size() > 0)) {
        localBundle.putString("preload_iamge_url", ((seu)paramContext.get(0)).a);
      } else {
        localBundle.putString("preload_iamge_url", null);
      }
    }
