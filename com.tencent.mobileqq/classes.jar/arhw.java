...
public class arhw
{
  ...
  private arhv jdField_a_of_type_Arhv = new arhx(this);
  private Downloader jdField_a_of_type_ComTencentHlyybDownloaderDownloader;
  private HashMap<String, arhu> jdField_a_of_type_JavaUtilHashMap;
  Map<String, arhy> jdField_a_of_type_JavaUtilMap = new HashMap();
  private boolean jdField_a_of_type_Boolean;
  
  static
  {
    jdField_a_of_type_Arhw = new arhw();
  }
  ...
  private void b(String paramString)
  {
    try
    {
      ...
      if (this.jdField_a_of_type_JavaUtilMap.size() > 0)
      {
        ...
        {
          arhy localarhy = (arhy)((Map.Entry)paramString.next()).getValue();
          if (localarhy != null)
          {
            QLog.d("DownloadManager_Now_for_qq", 1, String.format("removeNowDownloadTask next task url=%s", new Object[] { localarhy.b }));
            b(localarhy);
          }
        }
      }
  ...
  private void c(arhy paramarhy)
  {
    DownloaderTask localDownloaderTask = this.jdField_a_of_type_ComTencentHlyybDownloaderDownloader.createNewTask(paramarhy.b, paramarhy.g, paramarhy.h, this.jdField_a_of_type_Arht);
    localDownloaderTask.setCategory(DownloaderTaskCategory.Cate_CustomMass1);
    localDownloaderTask.setAppScene(paramarhy.d);
    if (!TextUtils.isEmpty(paramarhy.e)) {
      localDownloaderTask.setApkId(paramarhy.e);
    }
    localDownloaderTask.setNotUseTempFile();
    paramarhy.a(localDownloaderTask);
  }
  ...
  public void a(Context paramContext)
  {
    ...
    b(paramContext);
    this.jdField_a_of_type_Arht = new arht(this.jdField_a_of_type_Arhv);
  }
  ...
  public void a(arhy paramarhy)
  {
    ...
    //   12: iconst_0
    //   13: aload_1
    //   14: getfield 160	arhy:b	Ljava/lang/String;
    //   17: aastore
    //   18: dup
    //   19: iconst_1
    //   20: aload_0
    //   21: getfield 29	arhw:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    ...
    //   39: aload_0
    //   40: getfield 29	arhw:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   43: invokeinterface 141 1 0
    //   48: ifne +26 -> 74
    //   51: aload_0
    //   52: getfield 29	arhw:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   55: aload_1
    //   56: getfield 160	arhy:b	Ljava/lang/String;
    //   59: aload_1
    //   60: invokeinterface 239 3 0
    //   65: pop
    //   66: aload_0
    //   67: aload_1
    //   68: invokevirtual 163	arhw:b	(Larhy;)V
    //   71: aload_0
    //   72: monitorexit
    //   73: return
    //   74: aload_0
    //   75: getfield 29	arhw:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   78: aload_1
    //   79: getfield 160	arhy:b	Ljava/lang/String;
    //   82: aload_1
  ...
  public void a(String paramString, arhu paramarhu)
  {
    if (this.jdField_a_of_type_JavaUtilHashMap == null) {
      this.jdField_a_of_type_JavaUtilHashMap = new HashMap();
    }
    this.jdField_a_of_type_JavaUtilHashMap.put(paramString, paramarhu);
  }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    bdot.b("DownloadManager_Now_for_qq", "removeDownloadTask---delete unactive halley task, Id:" + localDownloaderTask.getId());
    this.jdField_a_of_type_ComTencentHlyybDownloaderDownloader.deleteTask(localDownloaderTask, paramBoolean);
  }
  
  public void b(arhy paramarhy)
  {
    DownloaderTask localDownloaderTask = a(paramarhy.b);
    try
    {
      str = paramarhy.b;
      if (TextUtils.isEmpty(str))
      {
        ...
        if ((this.jdField_a_of_type_JavaUtilHashMap != null) && (this.jdField_a_of_type_JavaUtilHashMap.containsKey(str))) {
          ((arhu)this.jdField_a_of_type_JavaUtilHashMap.get(str)).a(-1000, -1, "url is invalid");
        }
      }
      else if ((localDownloaderTask == null) || (!str.equals(localDownloaderTask.getUrl())))
      {
        QLog.i("DownloadManager_Now_for_qq", 4, "startDownload: url is changed, thread = " + Thread.currentThread().getId() + "," + str + "path = " + paramarhy.h);
        if (localDownloaderTask != null) {}
        c(paramarhy);
        this.jdField_a_of_type_ComTencentHlyybDownloaderDownloader.addNewTask(paramarhy.a());
    ...
    catch (Exception localException)
    {
      ...
      if (this.jdField_a_of_type_Int < 3)
      {
        ...
        {
          if ((this.jdField_a_of_type_JavaUtilHashMap != null) && (this.jdField_a_of_type_JavaUtilHashMap.containsKey(str))) {
            ((arhu)this.jdField_a_of_type_JavaUtilHashMap.get(str)).a();
          }
