...
public class aspe
  extends anqq
{
  public aspe(Face2FaceAddFriendActivity paramFace2FaceAddFriendActivity) {}
  ...
  public void a(asqt paramasqt)
  {
    ...
    else if ((this.a.jdField_b_of_type_Int == 0) && (paramasqt != null) && (!this.a.jdField_b_of_type_JavaUtilList.contains(paramasqt)))
    {
      this.a.jdField_b_of_type_JavaUtilList.add(paramasqt);
      if (this.a.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size() != this.a.jdField_d_of_type_JavaUtilList.size()) {
        break label162;
      }
      Face2FaceAddFriendActivity.a(this.a, paramasqt);
    }
    for (;;)
    {
      paramasqt = this.a;
      ...
      ((Message)localObject).obj = paramasqt;
  ...
  public void a(asqx paramasqx)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        if ((this.a.jdField_f_of_type_Long == 0L) || (l2 >= 1000L) || (paramasqx.a != 0L)) {
          break label269;
        }
        localObject = Message.obtain();
        ((Message)localObject).what = 16;
        ((Message)localObject).obj = paramasqx;
        l3 = 1000L - l2;
    ...
    } while ((this.a.jdField_b_of_type_Int != 1) || (this.a.jdField_a_of_type_JavaUtilList.contains(paramasqx)));
    label269:
    this.a.jdField_a_of_type_JavaUtilList.add(paramasqx);
    if ((this.a.l) && (this.a.jdField_a_of_type_Asqu != null))
    {
      this.a.jdField_a_of_type_AndroidWidgetTextView.setText(String.valueOf(this.a.jdField_a_of_type_JavaUtilList.size()));
      this.a.jdField_a_of_type_Asqu.a(paramasqx);
      return;
    }
    Face2FaceAddFriendActivity.a(this.a, paramasqx);
    this.a.e();
  }
  ...
  public void a(nearfield_group.BusiRespHead paramBusiRespHead, String paramString)
  {
    ...
    if (i == 0)
    {
      Iterator localIterator = this.a.jdField_a_of_type_Asqe.jdField_a_of_type_JavaUtilList.iterator();
      while (localIterator.hasNext())
      {
        ...
        if ((paramBusiRespHead != null) && (paramBusiRespHead.a() == 2) && (paramString.equals(paramBusiRespHead.b())))
        {
          ...
          if (!(paramBusiRespHead instanceof asqt)) {
            break label477;
          }
        }
      }
    ...
    label477:
    for (paramBusiRespHead = paramBusiRespHead.e + "_" + ((asqt)paramBusiRespHead).jdField_b_of_type_JavaLangString;; paramBusiRespHead = paramString)
    {
      this.a.jdField_a_of_type_Asqe.a(paramBusiRespHead);
      ...
      break;
      bcst.b(null, "P_CliOper", "Grp_set", "", "Radar_grp_guest", "suc_join", 0, 0, paramString, "8.4.1", "", this.a.app.getCurrentAccountUin());
  ...
  public void a(nearfield_group.BusiRespHead paramBusiRespHead, List<asqt> paramList)
  {
    ...
    if (paramList == null)
    {
      ...
      if (this.a.jdField_b_of_type_Int == 1) {
        bglp.a(this.a, 230, this.a.getString(2131718563), anni.a(2131703081), 2131690582, 2131691891, new aspf(this), null).show();
      }
    }
    label179:
    label185:
    do
    {
      ...
      for (;;)
      {
        ...
        {
          paramList = (asqw)paramBusiRespHead.next();
    ...
    label421:
    bglp.a(this.a, 230, this.a.getString(2131718563), anni.a(2131703074), 2131690582, 2131691891, new aspg(this), null).show();
  }
}
