...
public class bggy
{
  ...
  public bggy a()
  {
    bggy localbggy = new bggy();
    localbggy.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.putAll(this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap);
    return localbggy;
  }
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    bggu.a = a("mod", paramJSONObject.optString("from", bggu.a));
    bggu.d = a("land_page", paramJSONObject.optString("land_page_id", bggu.d));
    bggu.b = a("obj_ownerid", paramJSONObject.optString("obj_ownerid", bggu.b));
    bggu.e = a("obj_pos", paramJSONObject.optString("pos", ""));
    bggu.f = a("detailpage_from", bggu.a(paramJSONObject.optString("detailpage_from"), paramJSONObject.optString("prepage")));
    bggu.g = a("algo_id", paramJSONObject.optString("algo_id", "0"));
  }
