...
public class swu
{
  ...
  public static void a(Activity paramActivity, AdData paramAdData)
  {
    ...
    for (;;)
    {
      paramActivity = (QQAppInterface)pay.a();
      if (paramActivity != null) {
        obb.a(paramActivity, paramAdData);
      }
      return;
  ...
  public static void a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    label70:
    for (str = paramString2 + "?"; obb.a(paramContext, paramString1); str = paramString2 + "&")
    {
      pay.a(paramContext, str + "_wv=33554437");
      return;
    }
  ...
  public static void a(BaseData paramBaseData, View paramView, Context paramContext)
  {
    ...
    {
      if (a == null) {
        a = new bjrq((Activity)paramContext);
      }
      if (!a.a()) {
        a.a();
      }
      paramBaseData = new swv(paramContext, paramBaseData, (AdData)localObject);
      if (a.a(0, ((AdData)localObject).jdField_b_of_type_JavaUtilArrayList))
      {
        a.a(paramView, paramBaseData);
        a.a(new sww(paramContext, (AdData)localObject));
      }
      return;
      label147:
