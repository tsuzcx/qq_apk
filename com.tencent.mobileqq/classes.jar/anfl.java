  ...
  extends anff
{
  ...
  public anfl(String paramString)
  {
    ...
    if ((this.jdField_a_of_type_AndroidGraphicsDrawableDrawable == null) || (this.jdField_b_of_type_AndroidGraphicsDrawableDrawable == null)) {
      try
      {
        ...
        if (paramString != null)
        {
          ...
          while (localBitmap2 != null)
          {
            ...
            BaseApplicationImpl.sImageHashMap.put("apolloMainInfoDef", BitmapFactory.decodeResource(paramString, 2130838001));
          }
        }
        return;
      }
      catch (Exception paramString)
      {
        if (QLog.isColorLevel())
        {
          ...
          BaseApplicationImpl.sImageHashMap.put("apolloMainInfoFail", BitmapFactory.decodeResource(paramString, 2130843701));
          return;
        }
      }
  ...
  public Drawable a(Context paramContext, float paramFloat)
  {
    ...
    do
    {
      do
      {
        ...
        ((amxa)localObject).jdField_a_of_type_JavaLangString = (ancb.d + this.jdField_a_of_type_ComTencentMobileqqDataApolloActionData.actionId + File.separator + "txtImg.png");
        ((amxa)localObject).jdField_b_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqDataApolloActionData.textImg;
        ...
        localObject = amwz.a(true, ((amxa)localObject).jdField_a_of_type_JavaLangString, paramContext, this.jdField_a_of_type_ComTencentMobileqqDataApolloActionData.textImg);
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext, EditText paramEditText, SessionInfo paramSessionInfo)
  {
    ...
    adrm.a(paramQQAppInterface, paramContext, paramSessionInfo, this);
    paramContext = "";
