  ...
  extends aare
{
  ...
  public void a(boolean paramBoolean, int paramInt1, String paramString1, String paramString2, int paramInt2, int paramInt3, String paramString3, ByteStringMicro paramByteStringMicro1, String paramString4, ByteStringMicro paramByteStringMicro2, Bundle paramBundle)
  {
    if (!paramBoolean)
    {
      bevx.a("TroopZipInnerFileDownloadWorker", bevx.a, "[" + this.a.jdField_a_of_type_JavaLangString + "] onReqDownloadResult isSuccess:false  errCode:" + paramInt1);
      this.a.jdField_a_of_type_Bevi.c = 2;
      this.a.a(true, bfuj.b, bfuj.A, 103);
      return;
    }
    bevx.c("TroopZipInnerFileDownloadWorker", bevx.a, "[" + this.a.jdField_a_of_type_JavaLangString + "] onReqDownloadResult isSuccess:true  int32_ret_code:" + paramInt1);
    if ((paramInt1 == 0) || ((TextUtils.isEmpty(paramString3)) && (paramInt2 == 0)))
    {
      bevx.a("TroopZipInnerFileDownloadWorker", bevx.a, "[" + this.a.jdField_a_of_type_JavaLangString + "] onReqDownloadResult. no host");
      this.a.jdField_a_of_type_Bevi.c = 1;
      this.a.jdField_a_of_type_Bevi.d = 101;
      this.a.a(true, bfuj.c, bfuj.x, 1);
      return;
    }
    paramString1 = atvo.a(paramByteStringMicro1);
    if (TextUtils.isEmpty(paramString1))
    {
      bevx.a("TroopZipInnerFileDownloadWorker", bevx.a, "[" + this.a.jdField_a_of_type_JavaLangString + "] onReqDownloadResult. no string_download_url");
      this.a.jdField_a_of_type_Bevi.c = 1;
      this.a.jdField_a_of_type_Bevi.d = 102;
      this.a.a(true, bfuj.b, bfuj.w, 1);
      return;
    }
    paramString2 = bkgj.a(this.a.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.zipInnerPath);
    paramByteStringMicro1 = (QQAppInterface)this.b.get();
    if ((paramByteStringMicro1 != null) && (bfsj.b(paramByteStringMicro1)) && (bfsj.c(paramByteStringMicro1)) && (paramBundle != null))
    {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          try
          {
            ...
            bevx.c("TroopZipInnerFileDownloadWorker", bevx.a, "[" + this.a.jdField_a_of_type_JavaLangString + "] onReqDownloadResult. str_download_dns:" + paramString3 + " int32_server_ip:" + paramInt2 + " int32_server_port:" + paramInt3 + " mUrlParm:" + this.a.f + " port:" + paramInt1 + " isHttps:" + this.a.jdField_a_of_type_Boolean + " httpsDomain:" + this.a.g);
            this.a.g();
            return;
