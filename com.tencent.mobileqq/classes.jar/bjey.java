...
{
  private bjez jdField_a_of_type_Bjez;
  ...
  public void a(bjez parambjez)
  {
    this.jdField_a_of_type_Bjez = parambjez;
  }
  ...
  {
    yqp.b("TextEffectModule", "handleJsRequest method = " + paramString);
    try
    {
      if ("wordSplit".equals(paramString))
      {
        ...
        paramJSONObject = apmp.a((AppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), paramJSONObject);
      ...
      {
        paramJSONObject = ((bolb)bojv.a(5)).a.b;
        if (!TextUtils.isEmpty(paramJSONObject)) {
          paramInvokeCallback.exec(0, "success", new JSONObject(paramJSONObject));
        }
        while (this.jdField_a_of_type_Bjez != null)
        {
          this.jdField_a_of_type_Bjez.a();
          break;
