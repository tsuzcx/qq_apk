  ...
  extends poz
{
  ...
  private List<qvr> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  public pox(AppInterface paramAppInterface, EntityManager paramEntityManager, ExecutorService paramExecutorService, qfo paramqfo, Handler paramHandler)
  {
  ...
  private void a(List<qvr> paramList1, List<qvr> paramList2)
  {
    ...
    {
      localObject1 = ((qvr)paramList2.next()).jdField_a_of_type_JavaUtilList.iterator();
    ...
    {
      localObject1 = (qvr)paramList2.next();
      localObject2 = ((qvr)localObject1).jdField_a_of_type_JavaUtilList.iterator();
      label272:
      label285:
      label291:
      label296:
      ...
      for (;;)
      {
        ...
        if (((Iterator)localObject2).hasNext())
        {
          ...
          i = 11;
          label214:
          if ((paramList1.indexOf(localObject1) != 0) || (((qvr)localObject1).jdField_a_of_type_JavaUtilList.indexOf(localTabChannelCoverInfo1) >= i)) {
            break label291;
          }
          i = 1;
          label243:
  ...
  private boolean a()
  {
    ...
    bnrf.a("UPDATE_CHANNEL_LIST_KEY_0xBBC", Boolean.valueOf(false));
    return false;
  }
  
  public static boolean a(int paramInt)
  {
    if (!((Boolean)bnrf.a("sp_key_channel_list_dynamic_order_switch", Boolean.valueOf(false))).booleanValue())
    {
      QLog.d("ChannelCoverInfoModule", 1, "isSupportChannelDynamicOrder, switch is off.");
      return false;
    }
    Object localObject1 = (QQAppInterface)ozs.a();
    if (localObject1 != null)
    {
      localObject1 = (pfg)((QQAppInterface)localObject1).getManager(163);
      if (localObject1 != null)
      {
        localObject1 = ((pfg)localObject1).a().a();
          ...
          do
          {
            ...
            while (!((Iterator)localObject2).hasNext())
            {
              do
              {
                ...
                localObject2 = ((qvr)((Iterator)localObject1).next()).jdField_a_of_type_JavaUtilList;
  ...
  private List<TabChannelCoverInfo> b(List<qvr> paramList)
  {
    ArrayList localArrayList = new ArrayList();
    if (paramList != null)
    {
      ...
      {
        qvr localqvr = (qvr)paramList.next();
        if ((localqvr.jdField_a_of_type_JavaUtilList == null) || (localqvr.jdField_a_of_type_JavaUtilList.isEmpty())) {
          break label133;
        }
        Iterator localIterator = localqvr.jdField_a_of_type_JavaUtilList.iterator();
        while (localIterator.hasNext())
        {
          TabChannelCoverInfo localTabChannelCoverInfo = (TabChannelCoverInfo)localIterator.next();
          localTabChannelCoverInfo.channelConfigType = localqvr.jdField_a_of_type_Long;
          localTabChannelCoverInfo.seq = i;
          localArrayList.add(localTabChannelCoverInfo);
          i += 1;
        }
  ...
  private void b(boolean paramBoolean, List<TabChannelCoverInfo> paramList)
  {
    if (Looper.getMainLooper() == Looper.myLooper()) {
      pfd.a().e(paramBoolean, paramList);
    }
  ...
  private List<qvr> c(List<qvr> paramList)
  {
    ArrayList localArrayList = new ArrayList();
    if (paramList != null)
    {
      ...
      while (paramList.hasNext())
      {
        Object localObject = (qvr)paramList.next();
        qvr localqvr = new qvr(((qvr)localObject).jdField_a_of_type_Long, ((qvr)localObject).jdField_a_of_type_JavaLangString, ((qvr)localObject).b);
        localObject = ((qvr)localObject).jdField_a_of_type_JavaUtilList.iterator();
        while (((Iterator)localObject).hasNext())
        {
          ...
          localqvr.jdField_a_of_type_JavaUtilList.add(localTabChannelCoverInfo2);
          i += 1;
        }
  ...
  private List<TabChannelCoverInfo> d(List<TabChannelCoverInfo> paramList)
  {
    ...
    for (;;)
    {
      ...
      label275:
      for (paramList = a();; paramList = anzj.a(2131700424))
      {
        if (!bool2) {
        ...
        if (!bool1)
        {
          ...
          ((List)localObject2).add(0, new TabChannelCoverInfo(70, anzj.a(2131700447), 4, "https://p.qpic.cn/kandianac/0/993c416b9d2b9.png/0"));
        }
  ...
  private void e()
  {
    for (;;)
    {
      try
      {
        ...
        {
          str = bjtz.d(str.toLowerCase()).toLowerCase();
      ...
      catch (Throwable localThrowable)
      {
        ...
        int i;
        int j;
        QLog.e("ChannelCoverInfoModule", 2, "requestWeiShiChannelCoverListFromServer failed for param error:" + ozs.a(localThrowable));
        return;
      }
      try
      {
      ...
      a(qfq.a("OidbSvc.0xbe6", 3046, 1, localReqBody.toByteArray()));
      return;
      str = bhlo.c(BaseApplication.getContext());
      if (!TextUtils.isEmpty(str))
      {
        str = bjtz.d(str.replaceAll(":", "").toUpperCase()).toLowerCase();
        localPhoneInfo.bytes_muid.set(ByteStringMicro.copyFromUtf8(str));
  ...
  private void g(List<qvr> paramList)
  {
    if (paramList != null) {
      try
      {
        ...
        while (paramList.hasNext())
        {
          ...
          if (localObject != null)
          {
            localObject = ((qvr)localObject).jdField_a_of_type_JavaUtilList;
            if (localObject != null)
            {
  ...
  {
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(new TabChannelCoverInfo(51, anzj.a(2131700453)));
    localArrayList.add(new TabChannelCoverInfo(58, anzj.a(2131700440)));
    localArrayList.add(new TabChannelCoverInfo(59, anzj.a(2131700439)));
    localArrayList.add(new TabChannelCoverInfo(10, anzj.a(2131700442)));
    localArrayList.add(new TabChannelCoverInfo(52, anzj.a(2131700455)));
    localArrayList.add(new TabChannelCoverInfo(53, anzj.a(2131700436)));
    localArrayList.add(new TabChannelCoverInfo(9, anzj.a(2131700446)));
    localArrayList.add(new TabChannelCoverInfo(54, anzj.a(2131700431)));
    localArrayList.add(new TabChannelCoverInfo(55, anzj.a(2131700433)));
    localArrayList.add(new TabChannelCoverInfo(40007, anzj.a(2131700435)));
    return localArrayList;
  }
  ...
  public List<TabChannelCoverInfo> a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 49	pox:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   6: ifnull +36 -> 42
    //   9: aload_0
    //   10: getfield 49	pox:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   13: invokeinterface 403 1 0
    //   18: ifne +24 -> 42
    //   21: aload_0
    //   22: getfield 49	pox:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   25: iconst_0
    //   26: invokeinterface 250 2 0
    //   31: checkcast 263	qvr
    //   34: getfield 264	qvr:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   37: astore_1
    //   38: aload_0
    //   39: monitorexit
    //   40: aload_1
  ...
  public List<TabChannelCoverInfo> a(int paramInt)
  {
    ...
    //   19: checkcast 263	qvr
    //   22: getfield 264	qvr:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   25: astore_2
    //   26: aload_0
    //   27: monitorexit
    //   28: aload_2
  ...
  public void a(TabChannelCoverInfo paramTabChannelCoverInfo)
  {
    ...
    for (Object localObject = paramTabChannelCoverInfo.toString();; localObject = "null")
    {
      ...
      while (((Iterator)localObject).hasNext()) {
        if (a(paramTabChannelCoverInfo, ((qvr)((Iterator)localObject).next()).jdField_a_of_type_JavaUtilList)) {
  ...
  public void a(List<channel_button.Section> paramList)
  {
    ...
    try
    {
      ...
      while (paramList.hasNext())
      {
        ...
        qvr localqvr = new qvr(localSection);
        localJSONArray.put(localqvr.a());
        localqvr.jdField_a_of_type_JavaUtilList = qfn.b(localSection.rpt_msg_channel.get());
        this.jdField_a_of_type_JavaUtilList.add(localqvr);
      }
  ...
  public void a(List<qvr> paramList, int paramInt)
  {
    ...
    if (QLog.isColorLevel())
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        localObject2 = (qvr)((Iterator)localObject1).next();
        a(((qvr)localObject2).jdField_a_of_type_JavaUtilList, "0xbbc update sectionId=" + ((qvr)localObject2).jdField_a_of_type_Long);
      }
    }
    ...
    {
      qvr localqvr = (qvr)localIterator1.next();
      channel_button.Section localSection = new channel_button.Section();
      ArrayList localArrayList = new ArrayList();
      if (localqvr.jdField_a_of_type_JavaUtilList != null)
      {
        Iterator localIterator2 = localqvr.jdField_a_of_type_JavaUtilList.iterator();
      ...
      {
        localSection.uint64_section_id.set(localqvr.jdField_a_of_type_Long);
        localSection.str_section_name.set(localqvr.jdField_a_of_type_JavaLangString);
        localSection.str_note_text.set(localqvr.b);
    ...
    {
      localObject2 = bjtz.d(((String)localObject2).toLowerCase()).toLowerCase();
    ...
    for (;;)
    {
      ...
      a(qfq.a("OidbSvc.0xbbc", 3004, 1, ((oidb_cmd0xbbc.ReqBody)localObject1).toByteArray()));
      bnrf.a("UPDATE_CHANNEL_LIST_KEY_0xBBC", Boolean.valueOf(true));
      return;
      localObject2 = bhlo.c(BaseApplication.getContext());
      if (!TextUtils.isEmpty((CharSequence)localObject2))
      {
        localObject2 = bjtz.d(((String)localObject2).replaceAll(":", "").toUpperCase()).toLowerCase();
        paramList.bytes_muid.set(ByteStringMicro.copyFromUtf8((String)localObject2));
  ...
  public void a(List<qvr> paramList1, List<qvr> paramList2, boolean paramBoolean)
  {
    if (paramList1 == null) {}
    try
    {
      ...
      ((qvr)paramList2.get(0)).jdField_a_of_type_JavaUtilList = d(((qvr)paramList2.get(0)).jdField_a_of_type_JavaUtilList);
      this.jdField_a_of_type_JavaUtilList = c(paramList2);
      paramList2 = b(this.jdField_a_of_type_JavaUtilList);
      if (paramBoolean) {
        b(true, ((qvr)this.jdField_a_of_type_JavaUtilList.get(0)).jdField_a_of_type_JavaUtilList);
      }
      if (!QLog.isColorLevel()) {
        break label216;
      }
  ...
  {
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(new TabChannelCoverInfo(70, anzj.a(2131700438), 4, "https://p.qpic.cn/kandianac/0/993c416b9d2b9.png/0"));
    localArrayList.add(new TabChannelCoverInfo(0, anzj.a(2131700437), 4, "https://p.qpic.cn/kandianac/0/9558fc75932c5.png/0"));
    TabChannelCoverInfo localTabChannelCoverInfo = new TabChannelCoverInfo(56, anzj.a(2131700448));
    localTabChannelCoverInfo.reason = 4;
    localTabChannelCoverInfo.mChannelType = 3;
    localArrayList.add(localTabChannelCoverInfo);
    localArrayList.add(new TabChannelCoverInfo(40531, anzj.a(2131700450)));
    localArrayList.add(new TabChannelCoverInfo(14, anzj.a(2131700434)));
    localArrayList.add(new TabChannelCoverInfo(8, anzj.a(2131700452)));
    localArrayList.add(new TabChannelCoverInfo(1, anzj.a(2131700441)));
    localArrayList.add(new TabChannelCoverInfo(13, anzj.a(2131700427)));
    localArrayList.add(new TabChannelCoverInfo(5, anzj.a(2131700457)));
    localArrayList.add(new TabChannelCoverInfo(11, anzj.a(2131700426)));
    localArrayList.add(new TabChannelCoverInfo(40466, anzj.a(2131700451)));
    localArrayList.add(new TabChannelCoverInfo(40013, anzj.a(2131700449)));
    localArrayList.add(new TabChannelCoverInfo(16, anzj.a(2131700444)));
    localArrayList.add(new TabChannelCoverInfo(15, anzj.a(2131700430)));
    return localArrayList;
  }
  ...
  public void b()
  {
    ...
    //   22: invokestatic 324	bnrf:a	(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    //   25: checkcast 310	java/lang/Boolean
    //   28: invokevirtual 327	java/lang/Boolean:booleanValue	()Z
    //   31: ifeq +29 -> 60
    //   34: aload_0
    //   35: invokespecial 956	pox:a	()Z
    //   38: ifeq +22 -> 60
    //   41: ldc 57
    //   43: iconst_2
    //   44: ldc_w 958
    ...
    //   50: aload_0
    //   51: aload_0
    //   52: getfield 49	pox:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   55: iconst_3
    //   56: invokevirtual 960	pox:a	(Ljava/util/List;I)V
    //   59: return
    //   60: getstatic 963	ohp:a	Z
    //   63: ifeq +13 -> 76
    //   66: ldc 57
    //   68: iconst_2
    //   69: ldc_w 965
    ...
    //   82: ldiv
    //   83: aload_0
    //   84: getfield 973	pox:jdField_a_of_type_Long	J
    //   87: lcmp
    //   88: iflt -29 -> 59
    ...
    //   103: invokestatic 982	apch:a	()Ljava/lang/String;
    //   106: invokestatic 552	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   109: invokevirtual 557	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   112: aload_2
    //   113: getfield 985	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$ReqBody:str_city	Lcom/tencent/mobileqq/pb/PBStringField;
    //   116: invokestatic 987	apch:b	()Ljava/lang/String;
    //   119: invokevirtual 631	com/tencent/mobileqq/pb/PBStringField:set	(Ljava/lang/String;)V
    //   122: aload_0
    //   123: getfield 619	pox:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    //   126: bipush 51
    //   128: invokevirtual 990	com/tencent/common/app/AppInterface:getManager	(I)Lmqq/manager/Manager;
    //   131: checkcast 992	anyw
    //   134: aload_0
    //   135: getfield 619	pox:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    ...
    //   144: invokevirtual 996	anyw:c	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/Friends;
    //   147: astore_3
    //   148: aload_3
    //   149: ifnull +25 -> 174
    //   152: aload_2
    ...
    //   160: invokevirtual 566	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   163: aload_2
    ...
    //   171: invokevirtual 566	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    ...
    //   181: astore_3
    //   182: invokestatic 534	ozs:h	()Ljava/lang/String;
    //   185: astore 4
    //   187: aload 4
    //   189: invokestatic 482	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   192: ifne +329 -> 521
    //   195: aload 4
    //   197: invokevirtual 537	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   200: astore 4
    //   202: aload 4
    //   204: invokestatic 542	bjtz:d	(Ljava/lang/String;)Ljava/lang/String;
    //   207: invokevirtual 537	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   210: astore 4
    //   212: aload_3
    //   213: getfield 1015	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:bytes_muid	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   216: aload 4
    //   218: invokestatic 552	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   221: invokevirtual 557	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   224: aload_3
    ...
    //   228: iconst_1
    //   229: invokevirtual 566	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   232: invokestatic 569	nwy:a	()I
    //   235: istore_1
    //   236: aload_3
    //   237: getfield 1017	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:uint32_conn	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   240: iload_1
    //   241: invokevirtual 566	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   244: invokestatic 576	bhlo:e	()I
    //   247: istore_1
    //   248: aload_3
    //   249: getfield 1018	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:uint32_carrier	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   252: iload_1
    //   253: invokevirtual 566	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   256: invokestatic 581	bhlo:e	()Ljava/lang/String;
    //   259: astore 4
    //   261: aload_3
    //   262: getfield 1019	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:bytes_os_ver	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   265: aload 4
    //   267: invokestatic 552	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   270: invokevirtual 557	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   273: invokestatic 586	bhlo:c	()Ljava/lang/String;
    //   276: astore 4
    //   278: aload_3
    //   279: getfield 1020	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:bytes_qq_ver	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   282: aload 4
    //   284: invokestatic 552	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   287: invokevirtual 557	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   290: invokestatic 592	com/tencent/common/config/AppSetting:a	()I
    //   293: istore_1
    //   294: aload_3
    ...
    //   302: invokestatic 552	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   305: invokevirtual 557	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   308: invokestatic 600	dw:a	()J
    //   311: invokestatic 603	dw:a	(J)Ljava/lang/String;
    //   314: astore 4
    //   316: aload_3
    //   317: getfield 1022	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:bytes_client_ip	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   320: aload 4
    //   322: invokestatic 552	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   325: invokevirtual 557	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   328: aload_3
    //   329: getfield 1023	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:uint32_os_type	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   332: iconst_2
    //   333: invokevirtual 566	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   336: aload_2
    ...
    //   345: invokestatic 1028	pfa:a	()Lpfa;
    //   348: invokevirtual 1031	pfa:a	()Lcom/tencent/biz/pubaccount/readinjoy/model/SelectPositionModule;
    //   351: astore_3
    //   352: aload_3
    //   353: ifnull +132 -> 485
    //   356: aload_3
    ...
    //   425: invokestatic 552	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   428: invokevirtual 557	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   431: aload 4
    ...
    //   440: invokestatic 552	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   443: invokevirtual 557	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   446: aload 4
    ...
    //   455: invokestatic 552	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   458: invokevirtual 557	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   461: aload 4
    ...
    //   470: invokestatic 552	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   473: invokevirtual 557	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   476: aload_2
    ...
    //   497: invokestatic 642	qfq:a	(Ljava/lang/String;II[B)Lcom/tencent/qphone/base/remote/ToServiceMsg;
    //   500: invokevirtual 645	pox:a	(Lcom/tencent/qphone/base/remote/ToServiceMsg;)V
    //   503: return
    //   504: astore 4
    //   506: aload_3
    //   507: getfield 1015	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:bytes_muid	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   510: ldc 179
    //   512: invokestatic 552	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   515: invokevirtual 557	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   518: goto -294 -> 224
    //   521: invokestatic 651	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   524: invokestatic 654	bhlo:c	(Landroid/content/Context;)Ljava/lang/String;
    //   527: astore 4
    //   529: aload 4
    ...
    //   539: ldc_w 656
    //   542: ldc 179
    //   544: invokevirtual 659	java/lang/String:replaceAll	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   547: invokevirtual 662	java/lang/String:toUpperCase	()Ljava/lang/String;
    //   550: invokestatic 542	bjtz:d	(Ljava/lang/String;)Ljava/lang/String;
    //   553: invokevirtual 537	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   556: astore 4
    //   558: aload_3
    //   559: getfield 1015	tencent/im/oidb/cmd0xbbb/oidb_cmd0xbbb$PhoneInfo:bytes_muid	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   562: aload 4
    //   564: invokestatic 552	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   567: invokevirtual 557	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   570: aload_3
    ...
    //   574: iconst_3
    //   575: invokevirtual 566	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   578: goto -346 -> 232
    //   581: astore 4
    //   583: iconst_0
    //   584: istore_1
  ...
  public void b(int paramInt)
  {
    ...
    if (paramInt == 0)
    {
      ...
      localObject = qfq.a("OidbSvc.0x69f", 1695, 0, ((oidb_cmd0x69f.ReqBody)localObject).toByteArray());
      if (paramInt != 0) {
        break label247;
      }
  ...
  public void b(List<oidb_cmd0x69f.ChannelInfo> paramList, int paramInt)
  {
    ...
    for (StringBuilder localStringBuilder = new StringBuilder("saveChannelCoverList channelID=" + paramInt + "\n");; localStringBuilder = null)
    {
      ...
      while (paramList.hasNext())
      {
        ChannelCoverInfo localChannelCoverInfo1 = qfn.a((oidb_cmd0x69f.ChannelInfo)paramList.next(), paramInt);
  ...
  public List<qvr> c()
  {
    ...
    {
      ArrayList localArrayList = new ArrayList();
      Object localObject2 = bhmi.a(new File(BaseApplicationImpl.getApplication().getDir("readinjoy", 0).getAbsolutePath() + "/channel_section_data"));
        ...
        try
        {
          ...
          while (i < ((JSONArray)localObject2).length())
          {
            ...
            if (localJSONObject != null) {
              localArrayList.add(new qvr(localJSONObject));
            }
            i += 1;
          }
        }
  ...
  public void c()
  {
    try
    {
      if (this.jdField_a_of_type_JavaUtilList == null)
      {
        ...
        this.jdField_a_of_type_JavaUtilList.add(new qvr(TabChannelCoverInfo.TYPE_CHANNEL_MY_CONFIG, anzj.a(2131700425), anzj.a(2131700429)));
        this.jdField_a_of_type_JavaUtilList.add(new qvr(TabChannelCoverInfo.TYPE_CHANNEL_RECOMMEND_CONFIG, anzj.a(2131700432), anzj.a(2131700443)));
      }
  ...
  {
    int i = qfq.a(paramFromServiceMsg, paramObject, new oidb_cmd0xbbc.RspBody());
  ...
  public void c(List<oidb_cmd0xbe6.MsgChannelInfo> paramList, int paramInt)
  {
    ...
    for (StringBuilder localStringBuilder = new StringBuilder("saveChannelCoverList channelID=" + paramInt + "\n");; localStringBuilder = null)
    {
      ...
      while (paramList.hasNext())
      {
        ChannelCoverInfo localChannelCoverInfo = qfn.a((oidb_cmd0xbe6.MsgChannelInfo)paramList.next(), paramInt);
