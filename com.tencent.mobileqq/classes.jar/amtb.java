...
public class amtb
{
  ...
  public amtb(String paramString)
  {
    this.jdField_a_of_type_Amth = new ApolloGameInterfaceProxy(this, paramString);
  ...
  {
    if (amta.a(this.jdField_a_of_type_JavaLangString))
    {
      paramString2 = amta.b(paramString2);
      if (QLog.isColorLevel()) {
        QLog.d("ApolloJSContext", 1, "[notifyJSEVent] " + paramString1 + " " + paramString2);
      }
      a(String.format("if(window.__dispatchEvent){window.__dispatchEvent(%s,'%s','%s')}", new Object[] { Integer.valueOf(paramInt), paramString1, paramString2 }), new amtc(this));
      return;
    }
  ...
  {
    if ((paramCustomWebView != null) && (this.jdField_a_of_type_Amth != null))
    {
      if (QLog.isColorLevel()) {
      ...
      {
        paramCustomWebView.addJavascriptInterface(this.jdField_a_of_type_Amth, "__browserMsg");
        return;
      }
  ...
  {
    if ((this.jdField_a_of_type_Amth != null) && ((this.jdField_a_of_type_Amth instanceof ApolloGameInterfaceProxy))) {
      ((ApolloGameInterfaceProxy)this.jdField_a_of_type_Amth).send(paramString2, paramString1);
    }
  }
  ...
  public void b()
  {
    ...
    if ((this.jdField_a_of_type_Amth != null) && ((this.jdField_a_of_type_Amth instanceof ApolloGameInterfaceProxy))) {
      ((ApolloGameInterfaceProxy)this.jdField_a_of_type_Amth).h();
    }
  ...
  public void b(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Amth != null)
    {
      ...
      for (;;)
      {
        this.jdField_a_of_type_Amth.a(this);
        return;
        label36:
        d();
      }
